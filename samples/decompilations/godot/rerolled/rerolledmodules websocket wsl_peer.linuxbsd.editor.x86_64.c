/* WSLPeer::_wsl_recv_start_callback(wslay_event_context*, wslay_event_on_frame_recv_start_arg
   const*, void*) */void WSLPeer::_wsl_recv_start_callback(wslay_event_context *param_1, wslay_event_on_frame_recv_start_arg *param_2, void *param_3) {
...
/* WSLPeer::get_available_packet_count() const */undefined4 WSLPeer::get_available_packet_count(WSLPeer *this) {
   undefined4 uVar1;
   uVar1 = 0;
   if (*(int*)( this + 0x1e0 ) == 1) {
...
/* WSLPeer::_wsl_genmask_callback(wslay_event_context*, unsigned char*, unsigned long, void*) */undefined8 WSLPeer::_wsl_genmask_callback(wslay_event_context *param_1, uchar *param_2, ulong param_3, void *param_4) {
   int iVar1;
   if (_static_rng == (uchar*)0x0) {
      _err_print_error("_wsl_genmask_callback", "modules/websocket/wsl_peer.cpp", 0x27b, "Parameter \"_static_rng\" is null.", 0, 0);
   }
 else {
      ...
      _err_print_error("_wsl_genmask_callback", "modules/websocket/wsl_peer.cpp", 0x27d, "Condition \"err != OK\" is true. Returning: WSLAY_ERR_CALLBACK_FAILURE", 0, 0);
   }

   return 0xfffffe70;
}
/* WSLPeer::get_connected_host() const */void WSLPeer::get_connected_host(void) {
   long lVar1;
   long in_RSI;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   if (*(long*)( in_RSI + 0x1e8 ) == 0) {
      _err_print_error("get_connected_host", "modules/websocket/wsl_peer.cpp", 0x368, "Condition \"tcp.is_null()\" is true. Returning: IPAddress()", 0, 0);
      IPAddress::clear();
   }
 else {
...
/* WSLPeer::get_connected_port() const */undefined8 WSLPeer::get_connected_port(WSLPeer *this) {
   undefined8 uVar1;
   ...
   _err_print_error("get_connected_port", "modules/websocket/wsl_peer.cpp", 0x36d, "Condition \"tcp.is_null()\" is true. Returning: 0", 0, 0);
   return 0;
}
/* WSLPeer::set_no_delay(bool) */void WSLPeer::set_no_delay(bool param_1) {
   long lVar1;
   ...
   _err_print_error("set_no_delay", "modules/websocket/wsl_peer.cpp", 0x37a, "Condition \"tcp.is_null()\" is true.", 0, 0);
   return;
}
/* WSLPeer::get_current_outbound_buffered_amount() const */undefined8 WSLPeer::get_current_outbound_buffered_amount(WSLPeer *this) {
   undefined8 uVar1;
   if (*(int*)( this + 0x1e0 ) != 1) {
      return 0;
   }
...
/* WSLPeer::_wsl_send_callback(wslay_event_context*, unsigned char const*, unsigned long, int,
   void*) */long WSLPeer::_wsl_send_callback(wslay_event_context *param_1, uchar *param_2, ulong param_3, int param_4, void *param_5) {
   Object *pOVar1;
   char cVar2;
   int iVar3;
   long lVar4;
   ...
   LAB_001002e4:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return lVar4;
   }
...
/* CowData<PacketBuffer<unsigned char>::_Packet>::_copy_on_write() [clone .isra.0] */void CowData<PacketBuffer<unsigned_char>::_Packet>::_copy_on_write(CowData<PacketBuffer<unsigned_char>::_Packet> *this) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   undefined8 *puVar4;
...
/* WSLPeer::get_selected_protocol() const */void WSLPeer::get_selected_protocol(void) {
   long in_RSI;
...
/* WSLPeer::get_requested_url() const */void WSLPeer::get_requested_url(void) {
   long in_RSI;
   CowData<char32_t> *in_RDI;
   *(undefined8*)in_RDI = 0;
...
/* WSLPeer::_wsl_msg_recv_callback(wslay_event_context*, wslay_event_on_msg_recv_arg const*, void*)
    */void WSLPeer::_wsl_msg_recv_callback(wslay_event_context *param_1, wslay_event_on_msg_recv_arg *param_2, void *param_3) {
   undefined4 *puVar1;
   ...
   if (wVar2 == (wslay_event_on_msg_recv_arg)0x8) {
      ...
      *(uint*)( (long)param_3 + 0x230 ) = ( uint ) * (ushort*)( param_2 + 0x18 );
      ...
      if (2 < uVar7) {
         String::parse_utf8((char*)( (long)param_3 + 0x238 ), (int)*(undefined8*)( param_2 + 8 ) + 2, (bool)( (char)uVar7 + -2 ));
      }
      ...
      *(undefined1*)( (long)param_3 + 0x250 ) = 0;
      ...
      if (wVar3 != wVar2) {
         if (lVar5 == *(long*)( in_FS_OFFSET + 0x28 )) {
            _err_print_error("_wsl_msg_recv_callback", "modules/websocket/wsl_peer.cpp", 0x297, "Condition \"pm.opcode != op\" is true.", 0, 0);
            return;
         }
      ...
      if (*(long*)( (long)param_3 + 0x290 ) == 0) {
         ...
         lVar9 = 0;
         LAB_001005d3:lVar10 = (long)iVar4;
         if (lVar9 < lVar10) {
            _err_print_error("write_packet", "modules/websocket/packet_buffer.h", 0x39, "Condition \"_write_pos > _packets.size()\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
         }
 else {
            if (( lVar10 < 0 ) || ( lVar9 == lVar10 )) {
               _err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar10, lVar9, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
            ...
            CowData<PacketBuffer<unsigned_char>::_Packet>::_copy_on_write((CowData<PacketBuffer<unsigned_char>::_Packet>*)( (long)param_3 + 0x290 ));
            iVar11 = _LC23._4_4_;
            iVar4 = (int)_LC23;
            ...
            *(ulong*)( (long)param_3 + 0x298 ) = CONCAT44(iVar11, (int)*(undefined8*)( (long)param_3 + 0x298 ) + iVar4);
            if (lVar9 == 0) {
               lVar9 = 0;
            }
 else {
         ...
         LAB_001007e7:_err_print_error("write_packet", "modules/websocket/packet_buffer.h", 0x35, "Condition \"p_info && _queued >= _packets.size()\" is true. Returning: ERR_OUT_OF_MEMORY", "Too many packets in queue! Dropping data.", 0, 0);
      }
   ...
   LAB_0010081d:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* WSLPeer::get_packet(unsigned char const**, int&) */undefined8 WSLPeer::get_packet(WSLPeer *this, uchar **param_1, int *param_2) {
   int *piVar1;
   WSLPeer WVar2;
   uchar *puVar3;
   code *pcVar4;
   ...
   *param_2 = 0;
   if (iVar13 != 1) {
      _err_print_error("get_packet", "modules/websocket/wsl_peer.cpp", 0x32b, "Condition \"ready_state != STATE_OPEN\" is true. Returning: FAILED", 0, 0);
      return 1;
   }
   ...
   if (*(int*)( this + 0x298 ) < 1) {
      _err_print_error("read_packet", "modules/websocket/packet_buffer.h", 0x4e, "Condition \"_queued < 1\" is true. Returning: ERR_UNAVAILABLE", 0, 0);
      goto LAB_00100c01;
   }
   ...
   if (lVar9 < 0) {
      ...
      *(int*)( this + 0x2a0 ) = iVar5;
      ...
      if (lVar7 == 0) {
         ...
         LAB_00100b9b:iVar11 = iVar11 - ( iVar12 + -1 );
      }
 else {
         iVar11 = (int)*(undefined8*)( lVar7 + -8 );
         iVar12 = iVar11 + iVar5;
         if (iVar5 < 0) goto LAB_00100b9b;
         LAB_00100a28:iVar11 = iVar11 - ( iVar5 + -1 );
         if (iVar5 == 0) {
            iVar11 = 1;
         }
      ...
      if (iVar14 < iVar11) {
         if (iVar14 <= iVar13) {
            ...
            if (lVar7 == 0) {
               ...
               if (iVar5 < 0) {
                  iVar5 = iVar5 + iVar13;
                  LAB_00100b02:iVar5 = iVar13 - iVar5;
               }
 else if (iVar5 != 0) {
                  iVar5 = iVar13 - iVar5;
               }
...
;
 ...
 while ( true );
            ...
            LAB_00100b67:*(uint*)( this + 0x2b8 ) = iVar13 + iVar8 & *(uint*)( this + 0x2c0 );
            goto LAB_00100b78;
         }

         _err_print_error("read_packet", "modules/websocket/packet_buffer.h", 0x57, "Condition \"p_bytes < (int)p.size\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      }
 else {
         _err_print_error("read_packet", "modules/websocket/packet_buffer.h", 0x56, "Condition \"_payload.data_left() < (int)p.size\" is true. Returning: ERR_BUG", 0, 0);
      }

      LAB_00100c01:iVar14 = 0;
      LAB_00100b78:*param_1 = puVar3;
      *param_2 = iVar14;
      return 0;
   }

   lVar6 = 0;
   LAB_00100b18:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar9, lVar6, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
...
/* WSLPeer::_wsl_frame_recv_chunk_callback(wslay_event_context*, wslay_event_on_frame_recv_chunk_arg
   const*, void*) */ulong WSLPeer::_wsl_frame_recv_chunk_callback(wslay_event_context *param_1, wslay_event_on_frame_recv_chunk_arg *param_2, void *param_3) {
   code *pcVar1;
   ulong in_RAX;
   long lVar2;
   int iVar3;
   ...
   if (iVar3 < 0) {
      ...
      joined_r0x00100eca:local_3c = iVar3 - 1;
      if (uVar6 <= local_3c) {
            ...
            do {
               ...
               if (lVar2 == 0) {
                  ...
                  if (0 < local_48) {
                     ...
                     LAB_00100df0:lVar2 = 0;
                     LAB_00100df8:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar7, lVar2, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
                     _err_flush_stdout();
                     /* WARNING: Does not return */
                  ...
                  if (0 < local_48) {
                     ...
                     if (lVar7 < 0) {
                        LAB_00100e40:lVar2 = *(long*)( lVar2 + -8 );
                        goto LAB_00100df8;
                     }
                     ...
                     while (true) {
                        ...
                        CowData<unsigned_char>::_copy_on_write((CowData<unsigned_char>*)( (long)param_3 + 0x2b0 ));
...
;
 ...
 while ( true );
   ...
   uVar10 = 0;
   _err_print_error("write_packet", "modules/websocket/packet_buffer.h", 0x34, "Condition \"p_payload && (uint32_t)_payload.space_left() < p_size\" is true. Returning: ERR_OUT_OF_MEMORY", "Buffer payload full! Dropping data.", 0);
   lVar2 = *(long*)( param_2 + 8 );
   LAB_00100cc5:*(long*)( (long)param_3 + 600 ) = *(long*)( (long)param_3 + 600 ) + lVar2;
   return uVar10;
   LAB_00100f20:local_4c = local_3c + *(int*)( (long)param_3 + 700 );
   lVar2 = *(long*)( param_2 + 8 );
   LAB_00100f33:local_4c = local_4c & *(uint*)( (long)param_3 + 0x2c0 );
   uVar10 = (ulong)local_4c;
   *(uint*)( (long)param_3 + 700 ) = local_4c;
   goto LAB_00100cc5;
}
/* WSLPeer::initialize() */void WSLPeer::initialize(void) {
...
/* WSLPeer::deinitialize() */void WSLPeer::deinitialize(void) {
...
/* WSLPeer::Resolver::start(String const&, int) */void WSLPeer::Resolver::start(Resolver *this, String *param_1, int param_2) {
   char cVar1;
   int iVar2;
   undefined8 uVar3;
   long in_FS_OFFSET;
   ...
   *(int*)( this + 0xc ) = param_2;
      ...
      *(int*)( this + 8 ) = iVar2;
      if (iVar2 == -1) {
         if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
            _err_print_error("start", "modules/websocket/wsl_peer.cpp", 0x40, "Condition \"resolver_id == IP::RESOLVER_INVALID_ID\" is true.", 0, 0);
            return;
         }
   ...
   LAB_0010116d:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* WSLPeer::Resolver::stop() */void WSLPeer::Resolver::stop(Resolver *this) {
   int iVar1;
   if (*(int*)( this + 8 ) != -1) {
...
/* WSLPeer::Resolver::try_next_candidate(Ref<StreamPeerTCP>&) */void WSLPeer::Resolver::try_next_candidate(Resolver *this, Ref *param_1) {
   IPAddress *pIVar1;
   int iVar2;
   long in_FS_OFFSET;
   Array local_80[8];
   ...
   if (*(int*)( this + 8 ) == -1) {
      LAB_00101217:iVar2 = StreamPeerTCP::get_status();
...
;
 ...
 while ( iVar2 != 0 );
   ...
   LAB_00101354:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* WSLPeer::_compute_key_response(String) */WSLPeer * __thiscall WSLPeer::_compute_key_response(WSLPeer *this,String *param_2){
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   long local_58;
...
/* WSLPeer::_send(unsigned char const*, int, wslay_opcode) */undefined8 WSLPeer::_send(WSLPeer *this, undefined8 param_1, int param_2, undefined1 param_4) {
   long *plVar1;
   code *pcVar2;
   int iVar3;
   ulong uVar4;
   ...
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   if (*(int*)( this + 0x1e0 ) != 1) {
      _err_print_error("_send", "modules/websocket/wsl_peer.cpp", 0x30e, "Condition \"ready_state != STATE_OPEN\" is true. Returning: FAILED", 0, 0);
      uVar5 = 1;
      goto LAB_00101557;
   }
   ...
   if (uVar4 < *(uint*)( this + 0x1c0 )) {
      ...
      if (0 < *(int*)( this + 0x1b8 )) {
         ...
         if (( ulong ) * (uint*)( this + 0x1b8 ) < ( ulong )(lVar6 + param_2)) {
            _err_print_error("_send", "modules/websocket/wsl_peer.cpp", 0x310, "Condition \"outbound_buffer_size > 0 && (wslay_event_get_queued_msg_length(wsl_ctx) + p_buffer_size > (uint32_t)outbound_buffer_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
            goto LAB_00101665;
         }
      ...
      _err_print_error("_send", "modules/websocket/wsl_peer.cpp", 0x30f, "Condition \"wslay_event_get_queued_msg_count(wsl_ctx) >= (uint32_t)max_queued_packets\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      LAB_00101665:uVar5 = 6;
   }

   LAB_00101557:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar5;
   }
...
/* WSLPeer::send(unsigned char const*, int, WebSocketPeer::WriteMode) */void WSLPeer::send(void) {
   _send();
   return;
}
/* WSLPeer::put_packet(unsigned char const*, int) */void WSLPeer::put_packet(uchar *param_1, int param_2) {
   _send();
   return;
}
/* WSLPeer::_wsl_recv_callback(wslay_event_context*, unsigned char*, unsigned long, int, void*) */long WSLPeer::_wsl_recv_callback(wslay_event_context *param_1, uchar *param_2, ulong param_3, int param_4, void *param_5) {
   long *plVar1;
   Object *pOVar2;
   char cVar3;
   int iVar4;
   ...
   if (pOVar2 != (Object*)0x0) {
      ...
      if (cVar3 != '\0') {
         ...
         if (uVar7 == 0) {
            LAB_001018a0:wslay_event_set_error(param_1);
            LAB_001018ad:lVar8 = -1;
         }
 else {
            local_94 = 0;
            ...
            if (iVar5 != 0) {
               ...
               if (cVar3 != '\0') {
                  ...
                  itos((long)local_90);
                  operator+((char *)
                  local_88,(String*)"Websocket get data error: ";
   ...
   lVar8 = -1;
   wslay_event_set_error(param_1, 0xfffffe70);
   LAB_00101814:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return lVar8;
   }
...
/* WSLPeer::_parse_client_request() */char WSLPeer::_parse_client_request(WSLPeer *this) {
   long *plVar1;
   int *piVar2;
   uint uVar3;
   void *pvVar4;
 ...
 while ( iVar18 != iVar23 );
   ...
   LAB_00101aaf:String::parse_latin1((StrRange*)&local_98);
   ...
   if (local_a0 != 0) {
      ...
      if (3 < iVar18) {
         ...
         if (( local_90 == (String*)0x0 ) || ( *(long*)( local_90 + -8 ) < 2 )) {
            _err_print_error("_parse_client_request", "modules/websocket/wsl_peer.cpp", 0x9f, "Condition \"req.size() < 2\" is true. Returning: false", "Invalid protocol or status code.", 0, 0);
         }
 else {
            ...
            if (cVar15 == '\0') {
               if (local_90 == (String*)0x0) {
                  ...
                  if (2 < lVar31) {
                     ...
                     do {
                        if (local_a0 == 0) {
                           LAB_00102430:lVar31 = 0;
                           goto LAB_00102451;
                        }

                        lVar31 = *(long*)( local_a0 + -8 );
                        if (lVar31 <= lVar30) goto LAB_00102451;
                        String::split((char*)&local_88, (bool)( (char)local_a0 + (char)lVar30 * '\b' ), 0x10a200);
                        cVar15 = '\0';
                        if (( local_80 == (char*)0x0 ) || ( *(long*)( local_80 + -8 ) != 2 )) {
                           ...
                           if (lVar31 <= lVar30) goto LAB_00102451;
                           operator+((char *)&
                           local_b0,(String*)"Invalid header -> ";
                           _err_print_error("_parse_client_request", "modules/websocket/wsl_peer.cpp", 0xa7, "Condition \"header.size() != 2\" is true. Returning: false", (CowData<char32_t>*)&local_b0, 0, 0);
                        ...
                        if (( local_70._0_8_ != 0 ) && ( local_50._4_4_ != 0 )) {
                           ...
                           if (uVar19 != 0) {
                              uVar32 = 0;
                              do {
                                 if (( uVar19 == uVar24 ) && ( cVar16 = String::operator ==((String*)( *(long*)( uVar26 + lVar25 * 8 ) + 0x10 ), (String*)&local_c0) ),cVar16 != '\0') {
                                    operator+((char *)&
                                    local_b0,(String*)&_LC98;
                                    pSVar20 = (String*)HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>::operator []((HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>*)&local_78, (String*)&local_c0);
 ...
 while ( ( uVar19 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar19 * lVar31,auVar11._8_8_ = 0,auVar11._0_8_ = uVar22,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar3 + iVar23 ) - SUB164(auVar7 * auVar11, 8)) * lVar31,auVar12._8_8_ = 0,auVar12._0_8_ = uVar22,uVar32 <= SUB164(auVar8 * auVar12, 8) );
                           }

                        }

                        this_00 = (CowData<char32_t>*)HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>::operator []((HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>*)&local_78, (String*)&local_c0);
                        if (*(long*)this_00 != local_b8) {
                           CowData<char32_t>::_ref(this_00, (CowData*)&local_b8);
                        }

                        LAB_00101e99:lVar31 = local_b8;
                        if (local_b8 != 0) {
                           LOCK();
 ...
 while ( ( ulong )(iVar18 - 2) + 2 != lVar30 );
                     ...
                     cVar16 = HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>::_lookup_pos((HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>*)&local_78, (String*)&local_b8, (uint*)&local_88);
                     if (cVar16 == '\0') {
                        local_88 = (char*)0x0;
                        ...
                        local_88 = (char*)( (ulong)local_88 & 0xffffffff00000000 );
                        cVar16 = HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>::_lookup_pos((HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>*)&local_78, (String*)&local_b0, (uint*)&local_88);
                        if (cVar16 == '\0') {
                           _err_print_error(&_LC33, "./core/templates/hash_map.h", 0x140, "FATAL: Condition \"!exists\" is true.", "HashMap key not found.", 0, 0);
                           _err_flush_stdout();
                           /* WARNING: Does not return */
                        ...
                        if (*(long*)( lVar31 + 0x18 ) == 0) {
                           ...
                           LAB_0010285d:CowData<char32_t>::_unref((CowData<char32_t>*)( this + 0x208 ));
                           pcVar29 = local_88;
                           local_88 = (char*)0x0;
                           *(char**)( this + 0x208 ) = pcVar29;
                           CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
                           ...
                           LAB_00102b18:CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
                        }
                     ...
                     if (local_90 == (String*)0x0) {
                        ...
                        if (1 < lVar31) {
                           ...
                           if (cVar16 == '\0') {
                              CowData<char32_t>::_unref((CowData<char32_t>*)&local_b8);
                              LAB_001028a7:pSVar20 = (String*)&local_e0;
                              local_b0 = 0;
                              ...
                              operator+((char *)
                              local_d8,(String*)"Missing or invalid header \'";
                              ...
                              _err_print_error("_parse_client_request", "modules/websocket/wsl_peer.cpp", 0xb7, "Condition \"!headers.has(\"upgrade\") || headers[\"upgrade\"].to_lower() != \"websocket\"\" is true. Returning: false", (StrRange*)&local_88, 0, 0);
                              CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
                              CowData<char32_t>::_unref((CowData<char32_t>*)&local_b8);
                              CowData<char32_t>::_unref((CowData<char32_t>*)local_c8);
                              CowData<char32_t>::_unref(local_d8);
                              LAB_001029a8:CowData<char32_t>::_unref((CowData<char32_t>*)pSVar20);
                           }
 else {
                              local_b0 = 0;
                              local_88 = "upgrade";
                              local_80 = (char*)0x7;
                              String::parse_latin1((StrRange*)&local_b0);
                              HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>::operator []((HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>*)&local_78, (String*)&local_b0);
                              String::to_lower();
                              ...
                              if (cVar16 != '\0') {
                                 ...
                                 cVar16 = HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>::_lookup_pos((HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>*)&local_78, (String*)&local_88, (uint*)&local_b0);
                                 CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
                                 if (cVar16 == '\0') {
                                    local_b0 = 0;
                                    String::parse_latin1((String*)&local_b0, "\'.");
                                    ...
                                    operator+((char *)&
                                    local_b8,(String*)"Missing header \'";
                                    String::operator +((String*)&local_88, (String*)&local_b8);
                                    pcVar29 = "Condition \"!headers.has(\"sec-websocket-key\")\" is true. Returning: false";
                                    uVar26 = 0xb9;
                                 }
 else {
                                    local_88 = (char*)0x0;
                                    ...
                                    local_b0 = local_b0 & 0xffffffff00000000;
                                    local_f9 = HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>::_lookup_pos((HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>*)&local_78, (String*)&local_88, (uint*)&local_b0);
                                    CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
                                    if (local_f9 != '\0') {
                                       local_88 = (char*)0x0;
                                       String::parse_latin1((String*)&local_88, "sec-websocket-key");
                                       pCVar21 = (CowData*)HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>::operator []((HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>*)&local_78, (String*)&local_88);
                                       ...
                                       if (cVar16 != '\0') {
                                          ...
                                          bVar17 = (bool)HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>::operator []((HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>*)&local_78, (String*)&local_b0);
                                          String::split((char*)&local_88, bVar17, 0x10a2d4);
                                          CowData<char32_t>::_unref((CowData<char32_t>*)&local_b0);
                                          do {
                                             if (( local_80 == (char*)0x0 ) || ( *(long*)( local_80 + -8 ) <= lVar31 )) goto LAB_00102c3d;
                                             lVar25 = 0;
                                             String::strip_edges(SUB81((CowData<char32_t>*)&local_b0, 0), (bool)( (char)local_80 + (char)lVar31 * '\b' ));
                                             lVar30 = *(long*)( this + 0x1a0 );
                                             if (lVar30 != 0) {
                                                while (lVar25 < *(long*)( lVar30 + -8 )) {
                                                   cVar16 = String::operator !=((String*)&local_b0, (String*)( lVar30 + lVar25 * 8 ));
                                                   if (cVar16 == '\0') {
                                                      uVar22 = local_b0;
                                                      if (*(ulong*)( this + 0x220 ) != local_b0) {
                                                         CowData<char32_t>::_ref((CowData<char32_t>*)( this + 0x220 ), (CowData*)&local_b0);
...
;
                                             ...
                                             uVar22 = *(ulong*)( this + 0x220 );
                                             LAB_00102bb1:if (( uVar22 != 0 ) && ( 1 < *(uint*)( uVar22 - 8 ) )) goto LAB_00102c60;
                                             lVar31 = lVar31 + 1;
                                             CowData<char32_t>::_unref((CowData<char32_t>*)&local_b0);
                                          }
 while ( true );
                                    ...
                                    local_b8,(String*)"Missing header \'";
                                    String::operator +((String*)&local_88, (String*)&local_b8);
                                    pcVar29 = "Condition \"!headers.has(\"connection\")\" is true. Returning: false";
                                    uVar26 = 0xba;
                                 }

                                 _err_print_error("_parse_client_request", "modules/websocket/wsl_peer.cpp", uVar26, pcVar29, (StrRange*)&local_88, 0, 0);
                              ...
                              String::operator +((String*)&local_b8, local_c8);
                              String::operator +((String*)&local_88, (String*)&local_b8);
                              _err_print_error("_parse_client_request", "modules/websocket/wsl_peer.cpp", 0xb8, "Condition \"!headers.has(\"sec-websocket-version\") || headers[\"sec-websocket-version\"].to_lower() != \"13\"\" is true. Returning: false", (StrRange*)&local_88, 0, 0);
                              CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
                              CowData<char32_t>::_unref((CowData<char32_t>*)&local_b8);
                              CowData<char32_t>::_unref((CowData<char32_t>*)local_c8);
                              CowData<char32_t>::_unref(local_d8);
               ...
               lVar30 = 2;
               LAB_00102451:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar30, lVar31, "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar13 = (code*)invalidInstructionException();
               ( *pcVar13 )();
            ...
            LAB_00102620:_err_print_error("_parse_client_request", "modules/websocket/wsl_peer.cpp", 0xa2, "Condition \"req[0] != \"GET\" || req[2] != \"HTTP/1.1\"\" is true. Returning: false", "Invalid method or HTTP version.", 0, 0);
         }
   ...
   itos((long)&local_b0);
   operator+((char *)&
   local_98,(String*)"Not enough response headers, got: ";
   String::operator +((String*)&local_78, (String*)&local_98);
   _err_print_error("_parse_client_request", "modules/websocket/wsl_peer.cpp", 0x9c, "Condition \"len < 4\" is true. Returning: false", (String*)&local_78, 0, 0);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_78);
   ...
   local_f9 = '\0';
   goto LAB_001025b2;
   LAB_00102c60:CowData<char32_t>::_unref((CowData<char32_t>*)&local_b0);
   LAB_00102c3d:if (( *(long*)( this + 0x220 ) == 0 ) || ( *(uint*)( *(long*)( this + 0x220 ) + -8 ) < 2 )) {
      CowData<String>::_unref((CowData<String>*)&local_80);
      local_f9 = cVar15;
   }
 else {
   ...
   LAB_00102504:uVar26 = local_70._0_8_;
 ...
 while ( piVar27 != piVar2 );
   ...
   LAB_001025a5:CowData<String>::_unref((CowData<String>*)&local_90);
   LAB_001025b2:CowData<String>::_unref((CowData<String>*)&local_a0);
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return local_f9;
   }
...
/* WSLPeer::_verify_server_response() */undefined4 WSLPeer::_verify_server_response(WSLPeer *this) {
   long *plVar1;
   int *piVar2;
   uint uVar3;
   void *pvVar4;
 ...
 while ( iVar16 != iVar23 );
   ...
   LAB_00102e5f:String::parse_latin1((StrRange*)&local_98);
   ...
   if (local_b0 != 0) {
      ...
      if (3 < iVar16) {
         ...
         if (( local_a0 == (String*)0x0 ) || ( *(long*)( local_a0 + -8 ) < 2 )) {
            ...
            String::parse_latin1((StrRange*)&local_88);
            if (local_b0 == 0) {
               LAB_00103d3e:uVar28 = 0;
            }
 else {
               uVar28 = *(ulong*)( local_b0 + -8 );
               if (0 < (long)uVar28) {
                  operator+((char *)&
                  local_98,(String*)"Invalid protocol or status code. Got \'";
                  String::operator +((String*)&local_78, (String*)&local_98);
            ...
            if (local_a0 == (String*)0x0) {
               ...
               if (1 < (long)uVar28) {
                  ...
                  if (cVar15 == '\0') {
                     ...
                     do {
                        if (local_b0 == 0) {
                           LAB_001036d0:uVar28 = 0;
                           goto LAB_001036a3;
                        }

                        uVar28 = *(ulong*)( local_b0 + -8 );
                        if ((long)uVar28 <= lVar29) goto LAB_001036a3;
                        String::split((char*)&local_98, (bool)( (char)local_b0 + (char)lVar29 * '\b' ), 0x10a200);
                        if (( local_90 == 0 ) || ( *(long*)( local_90 + -8 ) != 2 )) {
                           ...
                           if ((long)uVar28 <= lVar29) goto LAB_001036a3;
                           operator+((char *)&
                           local_c8,(String*)"Invalid header -> ";
                           String::operator +((String*)&local_88, (String*)&local_c8);
                           _err_print_error("_verify_server_response", "modules/websocket/wsl_peer.cpp", 0x1b1, "Condition \"header.size() != 2\" is true. Returning: false", (StrRange*)&local_88, 0, 0);
                           CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
                           CowData<char32_t>::_unref((CowData<char32_t>*)&local_c8);
                           CowData<char32_t>::_unref((CowData<char32_t>*)&local_c0);
                        ...
                        if (( local_70._0_8_ != 0 ) && ( local_50._4_4_ != 0 )) {
                           ...
                           if (uVar17 != 0) {
                              uVar32 = 0;
                              do {
                                 if (( uVar17 == uVar24 ) && ( cVar15 = String::operator ==((String*)( *(long*)( uVar25 + lVar21 * 8 ) + 0x10 ), (String*)&local_c8) ),cVar15 != '\0') {
                                    operator+((char *)&
                                    local_88,(String*)&_LC98;
                                    pSVar19 = (String*)HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>::operator []((HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>*)&local_78, (String*)&local_c8);
 ...
 while ( ( uVar17 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar17 * lVar31,auVar11._8_8_ = 0,auVar11._0_8_ = uVar27,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar3 + iVar23 ) - SUB164(auVar7 * auVar11, 8)) * lVar31,auVar12._8_8_ = 0,auVar12._0_8_ = uVar27,uVar32 <= SUB164(auVar8 * auVar12, 8) );
                           }

                        }

                        this_00 = (CowData<char32_t>*)HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>::operator []((HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>*)&local_78, (String*)&local_c8);
                        if (*(long*)this_00 != local_c0) {
                           CowData<char32_t>::_ref(this_00, (CowData*)&local_c0);
                        }

                        LAB_00103246:lVar31 = local_c0;
                        if (local_c0 != 0) {
                           LOCK();
                           plVar1 = (long*)( local_c0 + -0x10 );
                           *plVar1 = *plVar1 + -1;
 ...
 while ( lVar29 != ( ulong )(iVar16 - 2) + 2 );
                     ...
                     String::parse_latin1((StrRange*)&local_c0);
                     local_88 = (char*)( (ulong)local_88 & 0xffffffff00000000 );
                     cVar15 = HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>::_lookup_pos((HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>*)&local_78, (String*)&local_c0, (uint*)&local_88);
                     if (cVar15 == '\0') {
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_c0);
                        LAB_00103bf0:local_98 = 0;
                        ...
                        operator+((char *)&
                        local_e0,(String*)"Missing or invalid header \'";
                        ...
                        _err_print_error("_verify_server_response", "modules/websocket/wsl_peer.cpp", 0x1c1, "Condition \"!headers.has(\"connection\") || headers[\"connection\"].to_lower() != \"upgrade\"\" is true. Returning: false", (StrRange*)&local_88, 0, 0);
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_c0);
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_d0);
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_e0);
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_e8);
                        LAB_00103d1c:CowData<char32_t>::_unref((CowData<char32_t>*)&local_d8);
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_c8);
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_98);
                        uVar18 = uVar33;
                     }
                        ...
                        HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>::operator []((HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>*)&local_78, (String*)&local_98);
                        String::to_lower();
                        ...
                        if (cVar15 == '\0') {
                           ...
                           String::operator +((String*)&local_c0, (String*)&local_d0);
                           String::operator +((String*)&local_88, (String*)&local_c0);
                           _err_print_error("_verify_server_response", "modules/websocket/wsl_peer.cpp", 0x1c2, "Condition \"!headers.has(\"upgrade\") || headers[\"upgrade\"].to_lower() != \"websocket\"\" is true. Returning: false", (StrRange*)&local_88, 0, 0);
                           CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
                           CowData<char32_t>::_unref((CowData<char32_t>*)&local_c0);
                           CowData<char32_t>::_unref((CowData<char32_t>*)&local_d0);
                           CowData<char32_t>::_unref((CowData<char32_t>*)&local_e0);
                        ...
                        local_88 = (char*)( (ulong)local_88 & 0xffffffff00000000 );
                        uVar18 = HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>::_lookup_pos((HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>*)&local_78, (String*)&local_c8, (uint*)&local_88);
                        if ((char)uVar18 == '\0') {
                           CowData<char32_t>::_unref((CowData<char32_t>*)&local_c8);
                           LAB_00103d6d:local_98 = 0;
                           String::parse_latin1((String*)&local_98, "\'.");
                           local_d0 = 0;
                           if (*(long*)( this + 0x228 ) != 0) {
                              CowData<char32_t>::_ref((CowData<char32_t>*)&local_d0, (CowData*)( this + 0x228 ));
                           }
                           ...
                           operator+((char *)&
                           local_e8,(String*)"Missing or invalid header \'";
                           String::operator +((String*)&local_d8, (String*)&local_e8);
                           String::operator +((String*)&local_c0, (String*)&local_d8);
                           String::operator +((String*)&local_88, (String*)&local_c0);
                           _err_print_error("_verify_server_response", "modules/websocket/wsl_peer.cpp", 0x1c3, "Condition \"!headers.has(\"sec-websocket-accept\") || headers[\"sec-websocket-accept\"] != _compute_key_response(session_key)\" is true. Returning: false", (StrRange*)&local_88, 0, 0);
                           CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
                           CowData<char32_t>::_unref((CowData<char32_t>*)&local_c0);
                           ...
                           local_98 = 0;
                           if (*(long*)( this + 0x228 ) != 0) {
                              CowData<char32_t>::_ref((CowData<char32_t>*)&local_98, (CowData*)( this + 0x228 ));
                           }

                           _compute_key_response((WSLPeer*)&local_88, (StrRange*)&local_98);
                           local_c0 = 0;
                           String::parse_latin1((String*)&local_c0, "sec-websocket-accept");
                           pSVar19 = (String*)HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>::operator []((HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>*)&local_78, (String*)&local_c0);
                           ...
                           if (( *(long*)( this + 0x1a0 ) == 0 ) || ( *(long*)( *(long*)( this + 0x1a0 ) + -8 ) == 0 )) {
                              ...
                              cVar15 = HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>::_lookup_pos((HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>*)&local_78, (String*)&local_88, (uint*)&local_98);
                              CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
                              if (cVar15 != '\0') {
                                 local_98 = 0;
                                 ...
                                 HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>::operator []((HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>*)&local_78, (String*)&local_98);
                                 operator+((char *)&
                                 local_88,(String*)"Received unrequested sub-protocol -> ";
                                 _err_print_error("_verify_server_response", "modules/websocket/wsl_peer.cpp", 0x1c8, "Condition \"headers.has(\"sec-websocket-protocol\")\" is true. Returning: false", (StrRange*)&local_88, 0, 0);
                                 CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
                                 CowData<char32_t>::_unref((CowData<char32_t>*)&local_98);
                                 uVar18 = uVar33;
                              }
                              ...
                              CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
                              if (cVar15 == '\0') {
                                 _err_print_error("_verify_server_response", "modules/websocket/wsl_peer.cpp", 0x1cb, "Condition \"!headers.has(\"sec-websocket-protocol\")\" is true. Returning: false", "Requested sub-protocol(s) but received none.", 0, 0, uVar28);
                                 uVar18 = uVar33;
                              }
 else {
                                 local_88 = (char*)0x0;
                                 String::parse_latin1((String*)&local_88, "sec-websocket-protocol");
                                 pCVar20 = (CowData*)HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>::operator []((HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>*)&local_78, (String*)&local_88);
                                 ...
                                 for (lVar31 = 0; ( lVar29 != 0 && ( lVar31 < *(long*)( lVar29 + -8 ) ) ); lVar31 = lVar31 + 1) {
                                    cVar15 = String::operator !=((String*)( lVar29 + lVar31 * 8 ), (String*)( this + 0x220 ));
                                 ...
                                 operator+((char *)&
                                 local_88,(String*)"Received unrequested sub-protocol -> ";
                                 _err_print_error("_verify_server_response", "modules/websocket/wsl_peer.cpp", 0x1d7, "Method/function failed. Returning: false", (StrRange*)&local_88, 0, 0, lVar21);
                                 CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
                                 uVar18 = uVar33;
                              }
                     ...
                     LAB_001037ed:uVar25 = local_70._0_8_;
                     if ((undefined8*)local_70._0_8_ != (undefined8*)0x0) {
                        uVar14 = local_70._8_8_;
                        if (( local_50._4_4_ != 0 ) && ( *(uint*)( hash_table_size_primes + ( local_50 & 0xffffffff ) * 4 ) != 0 )) {
                           piVar2 = (int*)( local_70._8_8_ + ( ulong ) * (uint*)( hash_table_size_primes + ( local_50 & 0xffffffff ) * 4 ) * 4 );
 ...
 while ( piVar2 != piVar26 );
                  ...
                  if (1 < (long)uVar28) {
                     operator+((char *)&
                     local_98,(String*)"Invalid status code. Got: \'";
                     String::operator +((String*)&local_78, (String*)&local_98);
            ...
            LAB_00103683:lVar29 = 1;
            LAB_001036a3:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar29, uVar28, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar13 = (code*)invalidInstructionException();
            ( *pcVar13 )();
         ...
         operator+((char *)&
         local_98,(String*)"Invalid protocol. Got: \'";
         String::operator +((String*)&local_78, (String*)&local_98);
         pcVar22 = "Condition \"req[0] != \"HTTP/1.1\"\" is true. Returning: false";
         uVar25 = 0x1ab;
         LAB_00103a6c:_err_print_error("_verify_server_response", "modules/websocket/wsl_peer.cpp", uVar25, pcVar22, (String*)&local_78, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_78);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_98);
         uVar18 = 0;
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
         LAB_00103892:CowData<String>::_unref((CowData<String>*)&local_a0);
         goto LAB_0010389f;
      }
   ...
   local_98,(String*)"Not enough response headers. Got: ";
   String::operator +((String*)&local_78, (String*)&local_98);
   _err_print_error("_verify_server_response", "modules/websocket/wsl_peer.cpp", 0x1a5, "Condition \"len < 4\" is true. Returning: false", (String*)&local_78, 0, 0);
   uVar18 = 0;
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_78);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_98);
   CowData<char32_t>::_unref(local_a8);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
   LAB_0010389f:CowData<String>::_unref((CowData<String>*)&local_b0);
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar18;
   }
...
/* Error CowData<unsigned char>::resize<false>(long) [clone .isra.0] */void CowData<unsigned_char>::resize<false>(CowData<unsigned_char> *this, long param_1) {
   ...
   LAB_0010431c:puVar8[-1] = param_1;
   return;
}
/* WSLPeer::_generate_key() */WSLPeer * __thiscall WSLPeer::_generate_key(WSLPeer *this){
   long *plVar1;
   uchar *puVar2;
   long in_FS_OFFSET;
   uchar *local_30[2];
...
/* WSLPeer::_clear() */void WSLPeer::_clear(WSLPeer *this) {
   long *plVar1;
   undefined1 uVar2;
   undefined8 uVar3;
   long lVar4;
   ...
   *(undefined4*)( this + 0x1dc ) = 0;
   ...
   if (*(long*)( this + 0x2b0 ) == 0) {
      ...
      LAB_00104758:if (*(int*)( this + 700 ) < *(int*)( this + 0x2b8 )) {
         if (0 < *(int*)( this + 700 )) {
            lVar9 = 0;
            do {
               ...
               if (lVar4 == 0) {
                  lVar10 = 0;
                  LAB_001047bf:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar9, lVar10, "p_index", "size()", "", false, true);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
 ...
 while ( (int)lVar9 < *(int*)( this + 700 ) );
   ...
   *(undefined4*)( this + 0x2b8 ) = 0;
   LAB_001046a3:lVar9 = *(long*)( this + 0x290 );
...
/* WSLPeer::accept_stream(Ref<StreamPeer>) */undefined8 WSLPeer::accept_stream(WSLPeer *this, long *param_2) {
   Object *pOVar1;
   code *pcVar2;
   char cVar3;
   Object *pOVar4;
   ...
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   if (*param_2 == 0) {
      _err_print_error("accept_stream", "modules/websocket/wsl_peer.cpp", 0x80, "Condition \"p_stream.is_null()\" is true. Returning: ERR_INVALID_PARAMETER", 0, 0);
   }
 else {
      if (1 < *(int*)( this + 0x1e0 ) - 2U) {
         _err_print_error("accept_stream", "modules/websocket/wsl_peer.cpp", 0x81, "Condition \"ready_state != STATE_CLOSED && ready_state != STATE_CLOSING\" is true. Returning: ERR_ALREADY_IN_USE", 0, 0);
         uVar6 = 0x16;
         goto LAB_00104a3b;
      }
      ...
      if (cVar3 == '\0') {
         cVar3 = ( **(code**)( *(long*)*param_2 + 0x60 ) )((long*)*param_2, &StreamPeerTLS::get_class_ptr_static(), ::ptr);
         if (cVar3 != '\0') {
            if (( *param_2 == 0 ) || ( pOVar5 = (Object*)__dynamic_cast(*param_2, &Object::typeinfo, &StreamPeerTLS::typeinfo, 0) ),pOVar5 == (Object*)0x0) {
               /* WARNING: Does not return */
            ...
            if (( local_38 == (Object*)0x0 ) || ( cVar3 = ( **(code**)( *(long*)local_38 + 0x60 ) )() ),cVar3 == '\0') {
               _err_print_error("accept_stream", "modules/websocket/wsl_peer.cpp", 0x8b, "Condition \"base_stream.is_null() || !base_stream->is_class_ptr(StreamPeerTCP::get_class_ptr_static())\" is true. Returning: ERR_INVALID_PARAMETER", 0, 0);
               if (( local_38 != (Object*)0x0 ) && ( ( cVar3 = RefCounted::unreference() ),cVar3 != '\0' && ( cVar3 = predelete_handler(local_38) ),cVar3 != '\0' )) {
            ...
            if (( ( local_38 == (Object*)0x0 ) || ( pOVar5 = (Object*)__dynamic_cast(local_38, &Object::typeinfo, &StreamPeerTCP::typeinfo, 0) ),pOVar5 == (Object*)0x0 )) {
               pOVar5 = *(Object**)( this + 0x1e8 );
            ...
            cVar3 = RefCounted::unreference();
            joined_r0x00104e15:if (( cVar3 != '\0' ) && ( cVar3 = cVar3 != '\0' )) {
               ( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
               Memory::free_static(pOVar5, false);
            }
...
pOVar4 = *(Object**)( this + 0x1f0 );LAB_001049e3:if (pOVar4 != (Object*)0x0) {
   pOVar5 = *(Object**)( this + 0x1e8 );
   LAB_001049f3:if (pOVar5 != (Object*)0x0) {
   ...
   if (pOVar1 != (Object*)0x0) {
      ...
      if (pOVar1 != pOVar4) {
         *(Object**)( this + 0x1f0 ) = pOVar1;
         LAB_00104d67:cVar3 = RefCounted::reference();
         if (cVar3 == '\0') {
            *(undefined8*)( this + 0x1f0 ) = 0;
         }
   ...
   if (pOVar5 != (Object*)0x0) {
      *(undefined8*)( this + 0x1e8 ) = 0;
      LAB_00104d14:cVar3 = RefCounted::unreference();
      if (( cVar3 != '\0' ) && ( cVar3 = cVar3 != '\0' )) {
         ( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
         Memory::free_static(pOVar5, false);
      }

      LAB_00104ac1:pOVar5 = (Object*)*param_2;
      pOVar4 = *(Object**)( this + 0x1f0 );
      if (pOVar5 != pOVar4) {
         *(Object**)( this + 0x1f0 ) = pOVar5;
         if (pOVar5 != (Object*)0x0) goto LAB_00104d67;
         LAB_00104ae1:if (pOVar4 != (Object*)0x0) goto LAB_00104ae6;
         goto LAB_00104af6;
      }

      LAB_00104afd:this[0x268] = (WSLPeer)0x0;
      goto LAB_001049e3;
   }
   ...
   if (pOVar4 != (Object*)0x0) {
      *(undefined8*)( this + 0x1f0 ) = 0;
      LAB_00104ae6:cVar3 = RefCounted::unreference();
      if (( cVar3 != '\0' ) && ( cVar3 = cVar3 != '\0' )) {
         ( **(code**)( *(long*)pOVar4 + 0x140 ) )(pOVar4);
         Memory::free_static(pOVar4, false);
      }

      LAB_00104af6:pOVar4 = *(Object**)( this + 0x1f0 );
      goto LAB_00104afd;
   }

   this[0x268] = (WSLPeer)0x0;
}
_err_print_error("accept_stream", "modules/websocket/wsl_peer.cpp", 0x90, "Condition \"connection.is_null() || tcp.is_null()\" is true. Returning: ERR_INVALID_PARAMETER", 0, 0);}LAB_00104cf5:uVar6 = 0x1f;LAB_00104a3b:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return uVar6;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* WSLPeer::connect_to_url(String const&, Ref<TLSOptions>) */int WSLPeer::connect_to_url(WSLPeer *this, String *param_1, long *param_3) {
   long *plVar1;
   code *pcVar2;
   char cVar3;
   int iVar4;
   ...
   if (( *(long*)param_1 == 0 ) || ( *(uint*)( *(long*)param_1 + -8 ) < 2 )) {
      _err_print_error("connect_to_url", "modules/websocket/wsl_peer.cpp", 0x1de, "Condition \"p_url.is_empty()\" is true. Returning: ERR_INVALID_PARAMETER", 0, 0);
   }
 else {
      if (( *param_3 == 0 ) || ( *(int*)( *param_3 + 0x17c ) != 2 )) {
         if (1 < *(int*)( this + 0x1e0 ) - 2U) {
            _err_print_error("connect_to_url", "modules/websocket/wsl_peer.cpp", 0x1e0, "Condition \"ready_state != STATE_CLOSED && ready_state != STATE_CLOSING\" is true. Returning: ERR_ALREADY_IN_USE", 0, 0);
            local_c4 = 0x16;
            goto LAB_00105a54;
         }
         ...
         local_88 = 0;
         local_a4 = 0;
         local_c4 = String::parse_url(param_1, (String*)&local_90, (int*)&local_a0, (String*)&local_a4, (String*)&local_98);
         if (local_c4 == 0) {
            ...
            if (( cVar3 == '\0' ) || ( cVar3 = String::operator !=((String*)&local_90, "wss://") ),cVar3 == '\0') {
               this[0x268] = (WSLPeer)0x0;
               ...
               if (( this[0x268] == (WSLPeer)0x0 ) || ( cVar3 = cVar3 != '\0' )) {
                  ...
                  if (pOVar9 == (Object*)0x0) {
                     ...
                     pOVar5 = pOVar9;
                     if (local_58 == pOVar9) {
                        LAB_00105bf5:if (( ( pOVar5 != (Object*)0x0 ) && ( cVar3 = RefCounted::unreference() ),pOVar9 = local_58,cVar3 != '\0' )) &&( cVar3 = cVar3 != '\0' )(**(code**)( *(long*)pOVar9 + 0x140 ))(pOVar9);
                     ...
                     *(Object**)( this + 0x270 ) = local_58;
                     ...
                     if (pOVar9 != (Object*)0x0) {
                        LAB_00105bdd:cVar3 = RefCounted::unreference();
                        pOVar5 = local_58;
                        if (( cVar3 != '\0' ) && ( cVar3 = predelete_handler(pOVar9) ),pOVar5 = local_58,cVar3 != '\0') {
                  ...
                  if (( ( local_68 != (Object*)0x0 ) && ( cVar3 = RefCounted::unreference() ),pOVar9 = local_68,cVar3 != '\0' )) &&( cVar3 = cVar3 != '\0' )(**(code**)( *(long*)pOVar9 + 0x140 ))(pOVar9);
                  Memory::free_static(pOVar9, false);
               }
            ...
            if (this_00 != (StreamPeerTCP*)pOVar9) {
               *(StreamPeerTCP**)( this + 0x1e8 ) = this_00;
               ...
               if (( ( pOVar9 != (Object*)0x0 ) && ( cVar3 = RefCounted::unreference() ),cVar3 != '\0' )) {
                  LAB_00105ca3:( **(code**)( *(long*)pOVar9 + 0x140 ) )(pOVar9);
                  Memory::free_static(pOVar9, false);
                  pOVar5 = (Object*)this_00;
         ...
         LAB_00105243:Resolver::start((Resolver*)( this + 0x1d0 ), (String*)&local_a0, local_a4);
         Resolver::try_next_candidate((Resolver*)( this + 0x1d0 ), (Ref*)( this + 0x1e8 ));
         iVar4 = StreamPeerTCP::get_status();
         if (( ( iVar4 == 1 ) || ( iVar4 = iVar4 == 2 ) ) || ( ( iVar4 = Array::size() ),0 < iVar4 || ( *(int*)( this + 0x1d8 ) != -1 ) )) {
            pOVar9 = *(Object**)( this + 0x1f0 );
            if (*(long*)( this + 0x1e8 ) == 0) {
               if (pOVar9 != (Object*)0x0) {
                  *(undefined8*)( this + 0x1f0 ) = 0;
                  LAB_00105a9c:cVar3 = RefCounted::unreference();
                  if (( cVar3 != '\0' ) && ( cVar3 = cVar3 != '\0' )) {
                     ( **(code**)( *(long*)pOVar9 + 0x140 ) )(pOVar9);
                     Memory::free_static(pOVar9, false);
                  }
               ...
               pOVar5 = (Object*)__dynamic_cast(*(long*)( this + 0x1e8 ), &Object::typeinfo, &StreamPeer::typeinfo, 0);
               if (pOVar9 != pOVar5) {
                  *(Object**)( this + 0x1f0 ) = pOVar5;
                  if (( pOVar5 != (Object*)0x0 ) && ( cVar3 = cVar3 == '\0' )) {
                     *(undefined8*)( this + 0x1f0 ) = 0;
            ...
            if (local_a4 == 0x50) {
               ...
               LAB_00105476:itos((long)&local_60);
               operator+((char *)&
            ...
            String::parse_latin1((StrRange*)&local_60);
            operator+((char *)&
            local_68,(String*)"Sec-WebSocket-Key: ";
            String::operator +((String*)&local_58, (String*)&local_68);
            String::operator +=(local_80, (String*)&local_58);
            pOVar9 = local_58;
            if (local_58 != (Object*)0x0) {
            ...
            for (lVar10 = 0; ( lVar7 != 0 && ( lVar10 < *(long*)( lVar7 + -8 ) ) ); lVar10 = lVar10 + 1) {
               ...
               lVar7 = *(long*)( this + 0x1b0 );
               if (lVar7 == 0) {
                  LAB_00105860:lVar8 = 0;
                  LAB_00105863:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar10, lVar8, "p_index", "size()", "", false, true);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
                  pcVar2 = (code*)invalidInstructionException();
                  ( *pcVar2 )();
            ...
            if (local_58 == (Object*)0x0) {
               ...
               iVar4 = (int)*(undefined8*)( local_58 + -8 ) + -1 + ( uint )((int)*(undefined8*)( local_58 + -8 ) == 0);
            }
         ...
         _err_print_error("connect_to_url", "modules/websocket/wsl_peer.cpp", 0x1fb, "Condition \"use_tls && !StreamPeerTLS::is_available()\" is true. Returning: ERR_UNAVAILABLE", "WSS is not available in this build.", 0, 0);
         local_c4 = 2;
      }
   ...
   local_68 = (Object*)0x0;
   String::parse_latin1((String*)&local_68, "Invalid protocol: \"%s\" (must be either \"ws://\" or \"wss://\").");
   vformat<String>((CowData<char32_t>*)&local_58, (String*)&local_68, (CowData<char32_t>*)&local_60);
   _err_print_error("connect_to_url", "modules/websocket/wsl_peer.cpp", 0x1ee, "Condition \"scheme != \"ws://\" && scheme != \"wss://\"\" is true. Returning: ERR_INVALID_PARAMETER", (CowData<char32_t>*)&local_58, 0, 0);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   local_c4 = 0x1f;
   ...
   operator+((char *)&
   local_58,(String*)_LC131;
   _err_print_error("connect_to_url", "modules/websocket/wsl_peer.cpp", 0x1ea, "Condition \"err != OK\" is true. Returning: err", (CowData<char32_t>*)&local_58, 0, 0);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
}
CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);CowData<char32_t>::_unref((CowData<char32_t>*)&local_90);CowData<char32_t>::_unref((CowData<char32_t>*)&local_98);CowData<char32_t>::_unref((CowData<char32_t>*)&local_a0);goto LAB_00105a54;}_err_print_error("connect_to_url", "modules/websocket/wsl_peer.cpp", 0x1df, "Condition \"p_options.is_valid() && p_options->is_server()\" is true. Returning: ERR_INVALID_PARAMETER", 0, 0);}local_c4 = 0x1f;LAB_00105a54:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return local_c4;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* WSLPeer::WSLPeer() */void WSLPeer::WSLPeer(WSLPeer *this) {
   long *plVar1;
   ...
   *(undefined4*)( this + 0x230 ) = 0xffffffff;
   for (int i = 0; i < 3; i++) {
      *(undefined8*)( this + ( 16*i + 568 ) ) = 0;
      this[( 16*i + 576 )] = (WSLPeer)0;
   }
 ...
 while ( (int)lVar7 < *(int*)( this + 700 ) );
   ...
   *(undefined8*)( this + 700 ) = 0;
   if (*(long*)( this + 0x2b0 ) == 0) {
      CowData<unsigned_char>::resize<false>(this_00, 1);
      LAB_00106310:if (*(int*)( this + 0x2b8 ) <= *(int*)( this + 700 )) goto LAB_0010618c;
      lVar7 = 0;
      if (0 < *(int*)( this + 700 )) {
         do {
            lVar4 = *(long*)( this + 0x2b0 );
            if (lVar4 == 0) {
               LAB_001062ac:lVar8 = 0;
               LAB_001062af:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar7, lVar8, "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
 ...
 while ( (int)lVar7 < *(int*)( this + 700 ) );
      ...
      LAB_0010618c:*(undefined4*)( this + 0x2b8 ) = 0;
   }
   ...
   *(undefined4*)( this_01 + 400 ) = 0;
   ...
   if (cVar6 == '\0') {
      ...
      *(RefCounted**)( this + 0x218 ) = this_01;
      ...
      if (( ( pOVar10 == (Object*)0x0 ) || ( cVar6 = RefCounted::unreference() ),cVar6 == '\0' )) goto LAB_001063ba;
   }
   ...
   LAB_001063ba:cVar6 = RefCounted::unreference();
...
/* WSLPeer::close(int, String) */void WSLPeer::close(long param_1, uint param_2) {
   long *plVar1;
   undefined1 uVar2;
   long lVar3;
   Object *pOVar4;
   ...
   if ((int)param_2 < 0) {
      LAB_00106510:*(undefined4*)( param_1 + 0x1e0 ) = 3;
      if (( *(long*)( param_1 + 0x1f0 ) != 0 ) && ( cVar9 = cVar9 != '\0' )) {
      ...
      *(undefined8*)( param_1 + 0x1f0 ) = 0;
      if (*(long*)( param_1 + 0x1e8 ) != 0) {
         StreamPeerTCP::disconnect_from_host();
         if (( *(long*)( param_1 + 0x1e8 ) != 0 ) && ( cVar9 = cVar9 != '\0' )) {
      ...
      LAB_001065a0:iVar10 = *(int*)( param_1 + 0x1e0 );
   }
 else {
      iVar10 = *(int*)( param_1 + 0x1e0 );
      if (iVar10 != 1) {
         bVar8 = iVar10 == 0 || iVar10 == 3;
         LAB_001064bd:if (!bVar8) goto LAB_001064c1;
         goto LAB_00106510;
      }
   ...
   *(undefined1*)( param_1 + 0x250 ) = 0;
   if (*(long*)( param_1 + 0x2b0 ) == 0) {
      ...
      LAB_00106708:if (*(int*)( param_1 + 0x2b8 ) <= *(int*)( param_1 + 700 )) goto LAB_001065e6;
      lVar11 = 0;
      if (0 < *(int*)( param_1 + 700 )) {
         do {
            ...
            if (lVar6 == 0) {
               lVar12 = 0;
               LAB_00106767:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar11, lVar12, "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
 ...
 while ( (int)lVar11 < *(int*)( param_1 + 700 ) );
      ...
      LAB_001065e6:*(undefined4*)( param_1 + 0x2b8 ) = 0;
   }
   ...
   *(undefined8*)( param_1 + 600 ) = 0;
   LAB_001064c1:if (lVar3 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WSLPeer::~WSLPeer() */void WSLPeer::~WSLPeer(WSLPeer *this) {
   long *plVar1;
   undefined1 uVar2;
   undefined8 uVar3;
   long lVar4;
   ...
   *(undefined***)this = &PTR__initialize_classv_0010d898;
   ...
   if (*(long*)( this + 0x2b0 ) == 0) {
      CowData<unsigned_char>::resize<false>((CowData<unsigned_char>*)( this + 0x2b0 ), 1);
      LAB_00106a98:if (*(int*)( this + 0x2b8 ) <= *(int*)( this + 700 )) goto LAB_001068d1;
      if (0 < *(int*)( this + 700 )) {
         lVar8 = 0;
         do {
            lVar4 = *(long*)( this + 0x2b0 );
            if (lVar4 == 0) {
               lVar9 = 0;
               LAB_00106aff:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar8, lVar9, "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar6 = (code*)invalidInstructionException();
               ( *pcVar6 )();
 ...
 while ( (int)lVar8 < *(int*)( this + 700 ) );
      ...
      LAB_001068d1:*(undefined4*)( this + 0x2b8 ) = 0;
   }
   ...
   *(undefined8*)( this + 0x298 ) = 0;
   ...
   if (*(long*)( this + 0x280 ) == 0) {
      LAB_0010696d:lVar8 = *(long*)( this + 0x270 );
   }
 else {
      LOCK();
   ...
   if (*(long*)( this + 0x220 ) == 0) {
      LAB_001069ce:lVar8 = *(long*)( this + 0x218 );
   }
 else {
      LOCK();
   ...
   lVar8 = *(long*)( this + 0x1f0 );
   joined_r0x00106a21:if (( lVar8 != 0 ) && ( cVar7 = cVar7 != '\0' )) {
      pOVar5 = *(Object**)( this + 0x1f0 );
      cVar7 = predelete_handler(pOVar5);
      if (cVar7 != '\0') {
         ( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
   ...
   if (( *(long*)( this + 0x1e8 ) != 0 ) && ( cVar7 = cVar7 != '\0' )) {
      pOVar5 = *(Object**)( this + 0x1e8 );
      cVar7 = predelete_handler(pOVar5);
      if (cVar7 != '\0') {
         ( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
...
/* Error CowData<PacketBuffer<unsigned char>::_Packet>::resize<false>(long) [clone .isra.0] */void CowData<PacketBuffer<unsigned_char>::_Packet>::resize<false>(CowData<PacketBuffer<unsigned_char>::_Packet> *this, long param_1) {
   long *plVar1;
   long lVar2;
   int iVar3;
   ...
   LAB_00107012:_err_print_error("resize", "./core/templates/cowdata.h", uVar9, pcVar7, 0, 0);
   return;
}
/* WSLPeer::_do_client_handshake() */void WSLPeer::_do_client_handshake(WSLPeer *this) {
   int iVar1;
   code *pcVar2;
   uint uVar3;
   long lVar4;
   ...
   iVar6 = Array::size();
   if (( ( 0 < iVar6 ) || ( *(int*)( this + 0x1d8 ) != -1 ) ) || ( iVar6 = iVar6 == 1 )) {
      Resolver::try_next_candidate((Resolver*)( this + 0x1d0 ), (Ref*)( this + 0x1e8 ));
      iVar6 = Array::size();
      ...
      if (iVar6 == 2) {
         if (this[0x268] != (WSLPeer)0x0) {
            if (*(long*)( this + 0x1e8 ) == 0) {
               ...
               pOVar9 = (Object*)__dynamic_cast(*(long*)( this + 0x1e8 ), &Object::typeinfo, &StreamPeer::typeinfo, 0);
            ...
            if (pOVar9 == pOVar10) {
               ...
               if (( pOVar10 != (Object*)0x0 ) && ( cVar5 = cVar5 != '\0' )) {
                  ...
                  if (cVar5 != '\0') {
                     ...
                     local_58 = (Object*)0x0;
                     if (( *(Object**)( this + 0x270 ) != (Object*)0x0 ) && ( local_58 = *(Object**)( this + 0x270 ) ),cVar5 = RefCounted::reference(),cVar5 == '\0') {
                        local_58 = (Object*)0x0;
                     }

                     local_68 = (Object*)0x0;
                     if (( ( *(long*)( this + 0x1e8 ) != 0 ) && ( pOVar9 = (Object*)__dynamic_cast(*(long*)( this + 0x1e8 ), &Object::typeinfo, &StreamPeer::typeinfo, 0) ),pOVar9 != (Object*)0x0 )) {
                        local_68 = (Object*)0x0;
                     }

                     iVar6 = ( *pcVar2 )(pOVar10, &local_68, this + 0x208, (String*)&local_58);
                     if (( ( local_68 != (Object*)0x0 ) && ( cVar5 = RefCounted::unreference() ),pOVar9 = local_68,cVar5 != '\0' )) &&( cVar5 = cVar5 != '\0' )(**(code**)( *(long*)pOVar9 + 0x140 ))(pOVar9);
                     Memory::free_static(pOVar9, false);
                  }

                  if (( ( local_58 != (Object*)0x0 ) && ( cVar5 = RefCounted::unreference() ),pOVar9 = local_58,cVar5 != '\0' )) &&( cVar5 = cVar5 != '\0' )(**(code**)( *(long*)pOVar9 + 0x140 ))(pOVar9);
                  Memory::free_static(pOVar9, false);
               }

               if (iVar6 == 0) {
                  pOVar11 = (Object*)__dynamic_cast(pOVar10, &Object::typeinfo, &StreamPeer::typeinfo, 0);
                  pOVar9 = *(Object**)( this + 0x1f0 );
                  if (pOVar9 != pOVar11) {
                     *(Object**)( this + 0x1f0 ) = pOVar11;
                     if (( pOVar11 != (Object*)0x0 ) && ( cVar5 = cVar5 == '\0' )) {
                        *(undefined8*)( this + 0x1f0 ) = 0;
                     }
   ...
   if (( ( *(long*)( this + 0x1f0 ) != 0 ) && ( pOVar9 = (Object*)__dynamic_cast(*(long*)( this + 0x1f0 ), &Object::typeinfo, &StreamPeerTLS::typeinfo, 0) ),pOVar9 != (Object*)0x0 )) {
      cVar5 = RefCounted::reference();
      if (cVar5 != '\0') {
         cVar5 = RefCounted::unreference();
         pOVar10 = pOVar9;
         if (( cVar5 != '\0' ) && ( cVar5 = cVar5 != '\0' )) goto LAB_00107593;
         LAB_001075b6:( **(code**)( *(long*)pOVar10 + 0x178 ) )(pOVar10);
         LAB_001075c3:iVar6 = ( **(code**)( *(long*)pOVar10 + 400 ) )(pOVar10);
         if (iVar6 != 1) {
         ...
         LAB_001077a0:cVar5 = RefCounted::unreference();
         if (( cVar5 != '\0' ) && ( cVar5 = cVar5 != '\0' )) {
            ( **(code**)( *(long*)pOVar10 + 0x140 ) )(pOVar10);
            if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
               Memory::free_static(pOVar10, false);
      ...
      if (( cVar5 != '\0' ) && ( cVar5 = cVar5 != '\0' )) {
         pOVar10 = (Object*)0x0;
         LAB_00107593:( **(code**)( *(long*)pOVar9 + 0x140 ) )(pOVar9);
         Memory::free_static(pOVar9, false);
   ...
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      uVar13 = 0x158;
      pcVar12 = "Condition \"tls.is_null()\" is true.";
      LAB_0010744e:_err_print_error("_do_client_handshake", "modules/websocket/wsl_peer.cpp", uVar13, pcVar12, 0, 0);
      return;
   }

   goto LAB_00107b1b;
}
LAB_00107139:plVar15 = *(long**)( this + 0x218 );if (this[0x210] == (WSLPeer)0x0) {
   ...
   while (true) {
      ...
      lVar14 = (long)iVar7;
      if (iVar6 == 0) break;
      iVar6 = ( **(code**)( **(long**)( this + 0x1f0 ) + 0x168 ) )(*(long**)( this + 0x1f0 ), &local_74, 1);
      ...
      if (( ( ( 3 < iVar7 ) && ( *(char*)( lVar4 + lVar14 ) == '\n' ) ) && ( *(char*)( lVar4 + -1 + lVar14 ) == '\r' ) ) && ( ( *(char*)( lVar4 + -2 + lVar14 ) == '\n' && ( *(char*)( lVar4 + -3 + lVar14 ) == '\r' ) ) )) {
         ...
         if (cVar5 == '\0') {
            ...
            ( *pcVar2 )(this, 0xffffffff, (String*)&local_58);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
            _err_print_error("_do_client_handshake", "modules/websocket/wsl_peer.cpp", 0x194, "Method/function failed.", "Invalid response headers.", 0, 0, uVar13);
            goto LAB_001070b5;
         }
         ...
         wslay_event_config_set_max_recv_msg_length(*(undefined8*)( this + 0x1f8 ), (long)*(int*)( this + 0x1bc ));
...
;
   ...
   ( *pcVar2 )(this, 0xffffffff, (StrRange*)&local_68);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
   _err_print_error("_do_client_handshake", "modules/websocket/wsl_peer.cpp", 0x17e, "Method/function failed.", "Response headers too big.", 0, 0);
}
 else {
   ...
   StreamPeerBuffer::get_data_array();
   local_74 = 0;
   iVar6 = ( **(code**)( **(long**)( this + 0x1f0 ) + 0x158 ) )(*(long**)( this + 0x1f0 ), iVar6 + local_60, uVar8, &local_74);
   if (iVar6 == 0) {
      StreamPeerBuffer::seek((int)*(undefined8*)( this + 0x218 ));
   ...
   LAB_001073d0:pcVar2 = *(code**)( *(long*)this + 0x1b0 );
   local_68 = (Object*)0x0;
   local_58 = (Object*)&_LC15;
   local_50 = 0;
   String::parse_latin1((StrRange*)&local_68);
...
}goto LAB_001070b5;joined_r0x001072b8:if (uVar3 != 0) goto LAB_001072cc;bVar16 = iVar7 == 0;iVar7 = iVar7 + -1;iVar1 = 0;if (bVar16) goto LAB_001072d0;uVar3 = 1 << ( (byte)iVar7 & 0x1f ) & *(uint*)( this + 0x1bc );goto joined_r0x001072b8;LAB_001072cc:iVar1 = iVar7 + 1;LAB_001072d0:RingBuffer<unsigned_char>::resize((RingBuffer<unsigned_char>*)( this + 0x2a8 ), iVar1);CowData<PacketBuffer<unsigned_char>::_Packet>::resize<false>((CowData<PacketBuffer<unsigned_char>::_Packet>*)( this + 0x290 ), (long)iVar6);*(undefined4*)( this + 0x2a0 ) = 0;*(undefined8*)( this + 0x298 ) = 0;CowData<unsigned_char>::resize<false>((CowData<unsigned_char>*)( this + 0x280 ), (long)*(int*)( this + 0x1bc ));*(undefined4*)( this + 0x1e0 ) = 1;LAB_001070b5:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return;
}
LAB_00107b1b:/* WARNING: Subroutine does not return */__stack_chk_fail();}/* WSLPeer::_do_server_handshake() */int WSLPeer::_do_server_handshake(WSLPeer *this) {
   long *plVar1;
   code *pcVar2;
   char *pcVar3;
   char cVar4;
   ...
   if (this[0x268] != (WSLPeer)0x0) {
      if (( ( *(long*)( this + 0x1f0 ) == 0 ) || ( pOVar9 = (Object*)__dynamic_cast(*(long*)( this + 0x1f0 ), &Object::typeinfo, &StreamPeerTLS::typeinfo, 0) ),pOVar9 == (Object*)0x0 )) {
         iVar5 = 0x2f;
         _err_print_error("_do_server_handshake", "modules/websocket/wsl_peer.cpp", 0xdc, "Method/function failed. Returning: ERR_BUG", "Couldn\'t get StreamPeerTLS for WebSocket handshake.", 0, 0);
         goto LAB_00107fd0;
      }
   ...
   LAB_00107bc5:if (this[0x210] == (WSLPeer)0x0) {
      LAB_00107fb0:iVar6 = ( **(code**)( **(long**)( this + 0x218 ) + 0x170 ) )();
      if (iVar6 != 0) {
         StreamPeerBuffer::get_data_array();
         iVar5 = StreamPeerBuffer::get_position();
         local_90 = local_90 & 0xffffffff00000000;
         iVar5 = ( **(code**)( **(long**)( this + 0x1f0 ) + 0x158 ) )(*(long**)( this + 0x1f0 ), iVar5 + local_70, iVar6, &local_90);
         if (iVar5 != 0) {
            cVar4 = is_print_verbose_enabled();
            if (cVar4 != '\0') {
               local_88 = 0;
               String::parse_latin1((String*)&local_88, "WebSocket error while putting partial data (StreamPeer error code %d).");
 ...
 while ( ( 1 << ( (byte)iVar11 & 0x1f ) & *(uint*)( this + 0x1bc ) ) == 0 );
            ...
            CowData<PacketBuffer<unsigned_char>::_Packet>::resize<false>((CowData<PacketBuffer<unsigned_char>::_Packet>*)( this + 0x290 ), (long)iVar5);
            *(undefined4*)( this + 0x2a0 ) = 0;
            *(undefined8*)( this + 0x298 ) = 0;
            CowData<unsigned_char>::resize<false>((CowData<unsigned_char>*)( this + 0x280 ), (long)*(int*)( this + 0x1bc ));
      ...
      do {
         ...
         if (iVar5 < 1) {
            iVar5 = 6;
            _err_print_error("_do_server_handshake", "modules/websocket/wsl_peer.cpp", 0xed, "Condition \"handshake_buffer->get_available_bytes() < 1\" is true. Returning: ERR_OUT_OF_MEMORY", "WebSocket response headers are too big.", 0, 0);
            goto LAB_00107fd0;
         }
 ...
 while ( ( ( ( iVar6 < 4 ) || ( *(char*)( lVar14 + lVar12 ) != '\n' ) ) || ( *(char*)( lVar14 + -1 + lVar12 ) != '\r' ) ) || ( ( *(char*)( lVar14 + -2 + lVar12 ) != '\n' || ( *(char*)( lVar14 + -3 + lVar12 ) != '\r' ) ) ) );
      ...
      operator+((char *)&
      local_80,(String*)"Sec-WebSocket-Accept: ";
      ...
      if (( *(long*)( this + 0x220 ) != 0 ) && ( 1 < *(uint*)( *(long*)( this + 0x220 ) + -8 ) )) {
         ...
         String::parse_latin1((String*)&local_78, "\r\n");
         operator+((char *)&
         local_80,(String*)"Sec-WebSocket-Protocol: ";
         String::operator +((String*)&local_68, (String*)&local_80);
         String::operator +=((String*)&local_98, (String*)&local_68);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_80);
      ...
      for (lVar14 = 0; ( lVar12 != 0 && ( lVar14 < *(long*)( lVar12 + -8 ) ) ); lVar14 = lVar14 + 1) {
         ...
         if (lVar12 == 0) {
            lVar13 = 0;
            LAB_00107eb8:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar14, lVar13, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar2 = (code*)invalidInstructionException();
            ( *pcVar2 )();
      ...
      if (local_68 == (undefined*)0x0) {
         ...
         iVar5 = (int)*(undefined8*)( local_68 + -8 ) + -1 + ( uint )((int)*(undefined8*)( local_68 + -8 ) == 0);
      }
   ...
   iVar5 = 0;
   LAB_00107fd0:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar5;
   }
...
/* WSLPeer::poll() */void WSLPeer::poll(WSLPeer *this) {
   long *plVar1;
   code *pcVar2;
   undefined *puVar3;
   char cVar4;
   ...
   if (iVar6 != 3) {
      ...
      if (iVar6 - 1U < 2) {
         if (*(long*)( this + 0x1f8 ) == 0) {
            if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
               _err_print_error(&_LC165, "modules/websocket/wsl_peer.cpp", 0x2c8, "Parameter \"wsl_ctx\" is null.", 0, 0);
               return;
            }
         ...
         if (( ( *(ulong*)( this + 0x1c8 ) != 0 ) && ( *(ulong*)( this + 0x1c8 ) < ( ulong )(lVar7 - *(long*)( this + 0x248 )) ) ) && ( *(int*)( this + 0x1e0 ) == 1 )) {
            if (this[0x250] == (WSLPeer)0x0) {
               ...
               if (iVar6 != 0) {
                  ...
                  if (cVar4 != '\0') {
                     itos((long)&local_80);
                     operator+((char *)
                     aSStack_88,(String*)"Websocket (wslay) failed to send ping: ";
         ...
         LAB_00108765:iVar6 = wslay_event_recv(uVar8);
         if (( iVar6 == 0 ) && ( iVar6 = iVar6 == 0 )) {
               ...
               if (iVar6 == 0) {
                  ...
                  *(uint*)( this + 0x230 ) = (uint)uVar5;
                  if (uVar5 == 0x3ef) {
                     ...
                     LAB_00108bfe:String::parse_latin1((String*)( this + 0x238 ), "Unknown");
                  }

                  uVar8 = *(undefined8*)( this + 0x1f8 );
               }

               LAB_00108818:wslay_event_context_free(uVar8);
               *(undefined8*)( this + 0x1f8 ) = 0;
               pcVar2 = *(code**)( *(long*)this + 0x1b0 );
            ...
            if (cVar4 != '\0') {
               itos((long)&local_78);
               operator+((char *)&
               local_80,(String*)"Websocket (wslay) poll error: ";
   ...
   LAB_00108c46:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* WebSocketPeer::is_class_ptr(void*) const */uint WebSocketPeer::is_class_ptr(WebSocketPeer *this, void *param_1) {
   return (uint)CONCAT71(0x10db, (undefined4*)param_1 == &PacketPeer::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10db, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10db, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10db, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* WebSocketPeer::_getv(StringName const&, Variant&) const */undefined8 WebSocketPeer::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* WebSocketPeer::_setv(StringName const&, Variant const&) */undefined8 WebSocketPeer::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* WebSocketPeer::_validate_propertyv(PropertyInfo&) const */void WebSocketPeer::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* WebSocketPeer::_property_can_revertv(StringName const&) const */undefined8 WebSocketPeer::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* WebSocketPeer::_property_get_revertv(StringName const&, Variant&) const */undefined8 WebSocketPeer::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* WebSocketPeer::_notificationv(int, bool) */void WebSocketPeer::_notificationv(int param_1, bool param_2) {
   return;
}
/* WSLPeer::get_max_packet_size() const */undefined4 WSLPeer::get_max_packet_size(WSLPeer *this) {
   if (*(long*)( this + 0x280 ) != 0) {
...
/* WSLPeer::get_ready_state() const */undefined4 WSLPeer::get_ready_state(WSLPeer *this) {
   return *(undefined4*)( this + 0x1e0 );
}
/* WSLPeer::get_close_code() const */undefined4 WSLPeer::get_close_code(WSLPeer *this) {
   return *(undefined4*)( this + 0x230 );
}
/* WSLPeer::was_string_packet() const */bool WSLPeer::was_string_packet(WSLPeer *this) {
   return this[0x240] != (WSLPeer)0x0;
}
/* WebSocketPeer::_get_class_namev() const */undefined8 *WebSocketPeer::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_0010a593:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_0010a593;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "WebSocketPeer");
         goto LAB_0010a5fe;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "WebSocketPeer");
   LAB_0010a5fe:return &_get_class_namev();
}
/* CowData<PacketBuffer<unsigned char>::_Packet>::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<PacketBuffer<unsigned_char>::_Packet>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void FUN_0010a654(void) {
   code *pcVar1;
   _DAT_00000000 = 0;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
...
/* WSLPeer::accept_stream(Ref<StreamPeer>) [clone .cold] */void WSLPeer::accept_stream(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<PacketBuffer<unsigned char>::_Packet>::resize<false>(long) [clone .isra.0] [clone
   .cold] */void CowData<PacketBuffer<unsigned_char>::_Packet>::resize<false>(long param_1) {
   code *pcVar1;
   _DAT_00000000 = 0;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void FUN_0010a676(void) {
   code *pcVar1;
   _DAT_00000000 = 0;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
...
/* WSLPeer::get_close_reason() const */void WSLPeer::get_close_reason(void) {
   long in_RSI;
   CowData<char32_t> *in_RDI;
   *(undefined8*)in_RDI = 0;
...
/* WebSocketPeer::get_class() const */void WebSocketPeer::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* WebSocketPeer::_initialize_classv() */void WebSocketPeer::_initialize_classv(void) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   long local_70;
...
/* WebSocketPeer::is_class(String const&) const */undefined8 WebSocketPeer::is_class(WebSocketPeer *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
 ...
 while ( !bVar9 );
      ...
      LAB_0010af5f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
         ...
         LAB_0010b0d3:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_0010b17c:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* WebSocketPeer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void WebSocketPeer::_get_property_listv(WebSocketPeer *this, List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   undefined1(*pauVar4)[16];
...
::operator[](HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>
 ...
 while ( uVar45 != uVar38 );
         ...
         LAB_0010c464:iVar42 = *(int*)( this + 0x2c );
         if (iVar42 != 0) {
            LAB_0010c470:uVar36 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
 ...
 while ( ( uVar50 != 0 ) && ( auVar17._8_8_ = 0 ),auVar17._0_8_ = (ulong)uVar50 * lVar48,auVar33._8_8_ = 0,auVar33._0_8_ = uVar38,auVar18._8_8_ = 0,auVar18._0_8_ = ( ulong )(( uVar36 + uVar49 ) - SUB164(auVar17 * auVar33, 8)) * lVar48,auVar34._8_8_ = 0,auVar34._0_8_ = uVar38,uVar54 <= SUB164(auVar18 * auVar34, 8) );
      ...
      LAB_0010bf56:uVar55 = *(uint*)( this + 0x28 );
      if (uVar55 == 0x1c) {
...
;
 ...
 while ( ( uVar37 != 0 ) && ( auVar13._8_8_ = 0 ),auVar13._0_8_ = (ulong)uVar37 * lVar48,auVar29._8_8_ = 0,auVar29._0_8_ = uVar38,auVar14._8_8_ = 0,auVar14._0_8_ = ( ulong )(( uVar50 + uVar55 ) - SUB164(auVar13 * auVar29, 8)) * lVar48,auVar30._8_8_ = 0,auVar30._0_8_ = uVar38,uVar49 <= SUB164(auVar14 * auVar30, 8) );
      ...
      uVar45 = (ulong)uVar55;
      iVar42 = 0;
      LAB_0010bf30:if ((float)uVar45 * __LC48 < (float)( iVar42 + 1 )) goto LAB_0010bf56;
   }
 ...
 while ( uVar37 != 0 );
   ...
   *(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;
   ...
   LAB_0010c330:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return local_a0[1] + 8;
   }
...
/* WARNING: Removing unreachable block (ram,0x0010c918) *//* WARNING: Removing unreachable block (ram,0x0010ca66) *//* WARNING: Removing unreachable block (ram,0x0010cb60) *//* WARNING: Removing unreachable block (ram,0x0010ca72) *//* WARNING: Removing unreachable block (ram,0x0010ca7c) *//* WARNING: Removing unreachable block (ram,0x0010cb40) *//* WARNING: Removing unreachable block (ram,0x0010ca88) *//* WARNING: Removing unreachable block (ram,0x0010ca92) *//* WARNING: Removing unreachable block (ram,0x0010cb20) *//* WARNING: Removing unreachable block (ram,0x0010ca9e) *//* WARNING: Removing unreachable block (ram,0x0010cabc) *//* WARNING: Removing unreachable block (ram,0x0010cac8) *//* String vformat<StreamPeerTLS::Status>(String const&, StreamPeerTLS::Status const) */undefined8 *vformat<StreamPeerTLS::Status>(undefined8 *param_1, bool *param_2, int param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* WARNING: Removing unreachable block (ram,0x0010cca8) *//* WARNING: Removing unreachable block (ram,0x0010cddf) *//* WARNING: Removing unreachable block (ram,0x0010cf20) *//* WARNING: Removing unreachable block (ram,0x0010cdeb) *//* WARNING: Removing unreachable block (ram,0x0010cdfd) *//* WARNING: Removing unreachable block (ram,0x0010cf00) *//* WARNING: Removing unreachable block (ram,0x0010ce09) *//* WARNING: Removing unreachable block (ram,0x0010ce1d) *//* WARNING: Removing unreachable block (ram,0x0010cee0) *//* WARNING: Removing unreachable block (ram,0x0010ce29) *//* WARNING: Removing unreachable block (ram,0x0010ce33) *//* WARNING: Removing unreachable block (ram,0x0010cec0) *//* WARNING: Removing unreachable block (ram,0x0010ce3f) *//* WARNING: Removing unreachable block (ram,0x0010ce5d) *//* WARNING: Removing unreachable block (ram,0x0010ce69) *//* String vformat<Error>(String const&, Error const) */undefined8 *vformat<Error>(undefined8 *param_1, bool *param_2, int param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* WARNING: Removing unreachable block (ram,0x0010d068) *//* WARNING: Removing unreachable block (ram,0x0010d198) *//* WARNING: Removing unreachable block (ram,0x0010d2d0) *//* WARNING: Removing unreachable block (ram,0x0010d1a4) *//* WARNING: Removing unreachable block (ram,0x0010d1c0) *//* WARNING: Removing unreachable block (ram,0x0010d2b0) *//* WARNING: Removing unreachable block (ram,0x0010d1cc) *//* WARNING: Removing unreachable block (ram,0x0010d1d6) *//* WARNING: Removing unreachable block (ram,0x0010d290) *//* WARNING: Removing unreachable block (ram,0x0010d1e2) *//* WARNING: Removing unreachable block (ram,0x0010d1f6) *//* WARNING: Removing unreachable block (ram,0x0010d270) *//* WARNING: Removing unreachable block (ram,0x0010d1fe) *//* WARNING: Removing unreachable block (ram,0x0010d214) *//* WARNING: Removing unreachable block (ram,0x0010d220) *//* String vformat<String>(String const&, String const) */undefined8 *vformat<String>(undefined8 *param_1, bool *param_2, String *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* RingBuffer<unsigned char>::resize(int) */void RingBuffer<unsigned_char>::resize(RingBuffer<unsigned_char> *this, int param_1) {
   uint uVar1;
   undefined1 uVar2;
   code *pcVar3;
   uint uVar4;
   ...
   CowData<unsigned_char>::resize<false>((CowData<unsigned_char>*)( this + 8 ), 1L << ( (byte)param_1 & 0x3f ));
   uVar1 = iVar5 - 1;
   ...
   if (( iVar8 < iVar5 ) && ( (int)uVar4 < (int)*(uint*)( this + 0x10 ) )) {
      if (0 < (int)uVar4) {
         ...
         do {
            ...
            if (lVar6 == 0) {
               lVar7 = 0;
               LAB_0010d6cb:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar9, lVar7, "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar3 = (code*)invalidInstructionException();
               ( *pcVar3 )();
            ...
            if (( lVar6 < 0 ) || ( lVar7 <= lVar6 )) {
               _err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar6, lVar7, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar3 = (code*)invalidInstructionException();
               ( *pcVar3 )();
...
/* WSLPeer::_create(bool) */WSLPeer *WSLPeer::_create(bool param_1) {
   WSLPeer *this;
...
/* CowData<PacketBuffer<unsigned char>::_Packet>::_realloc(long) */undefined8 CowData<PacketBuffer<unsigned_char>::_Packet>::_realloc(CowData<PacketBuffer<unsigned_char>::_Packet> *this, long param_1) {
   undefined8 *puVar1;
   puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
   if (puVar1 != (undefined8*)0x0) {
      *puVar1 = 1;

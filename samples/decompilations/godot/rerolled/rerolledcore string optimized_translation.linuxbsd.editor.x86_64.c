/* OptimizedTranslation::get_plural_message(StringName const&, StringName const&, int, StringName
   const&) const */StringName *OptimizedTranslation::get_plural_message(StringName *param_1, StringName *param_2, int param_3, StringName *param_4) {
   long lVar1;
   long in_FS_OFFSET;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<int>::resize<false>(long) [clone .isra.0] */void CowData<int>::resize<false>(CowData<int> *this, long param_1) {
         ...
         if (param_1 <= lVar10) {
            ...
            if (uVar4 + 1 == lVar3) {
               ...
               if (puVar6 == (undefined8*)0x0) {
                  LAB_001005e0:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
                  return;
               }
   ...
   LAB_001005c2:_err_print_error("resize", "./core/templates/cowdata.h", uVar8, pcVar7, 0, 0);
   return;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<char>::resize<false>(long) [clone .isra.0] */void CowData<char>::resize<false>(CowData<char> *this, long param_1) {
   ...
   if (param_1 <= lVar7) {
      ...
      if (uVar3 + 1 == lVar4) {
         ...
         if (puVar6 == (undefined8*)0x0) {
            LAB_00100940:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
            return;
         }
...
/* OptimizedTranslation::get_message(StringName const&, StringName const&) const */OptimizedTranslation * __thiscall
OptimizedTranslation::get_message
   ...
   if (( *(long*)( param_1 + 0x2b0 ) == 0 ) || ( uVar5 = *(ulong*)( *(long*)( param_1 + 0x2b0 ) + -8 ) ),(int)uVar5 == 0) {
      *(undefined8*)this = 0;
      goto LAB_00100bd7;
   }
...
;
         ...
         do {
            if (*puVar12 == uVar8) {
               ...
               if (piVar2[(long)iVar9 * 4 + 4] == iVar4) {
                  local_58 = (char*)0x0;
                  String::parse_utf8((char*)&local_58, piVar2[(long)iVar9 * 4 + 3] + (int)lVar6, SUB41(iVar4, 0));
                  ...
                  smaz_decompress((ulong)(uint)piVar2[(long)iVar9 * 4 + 3] + lVar6, piVar2[(long)iVar9 * 4 + 4], local_60, iVar4);
                  local_58 = (char*)0x0;
 ...
 while ( iVar9 != *piVar2 );
   ...
   *(undefined8*)this = 0;
   ...
   LAB_00100bd7:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* OptimizedTranslation::_get(StringName const&, Variant&) const */undefined4 OptimizedTranslation::_get(OptimizedTranslation *this, StringName *param_1, Variant *param_2) {
   long *plVar1;
   long lVar2;
   char *__s;
   long lVar3;
...
/* OptimizedTranslation::_get_property_list(List<PropertyInfo, DefaultAllocator>*) const */void OptimizedTranslation::_get_property_list(OptimizedTranslation *this, List *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   ...
   local_58 = 0;
   if (local_90 == 0) {
      LAB_001010dd:local_50 = 6;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
      LAB_001010ef:lVar2 = *(long*)param_1;
   }
 else {
   ...
   *(int*)( plVar1 + 2 ) = (int)plVar1[2] + 1;
   ...
   local_58 = 0;
   if (local_90 == 0) {
      LAB_00101398:local_50 = 6;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
      LAB_001013a5:lVar2 = *(long*)param_1;
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_58, (CowData*)&local_90);
      local_50 = 6;
   ...
   *(int*)( plVar1 + 2 ) = (int)plVar1[2] + 1;
   ...
   local_58 = 0;
   if (local_90 == 0) {
      LAB_00101648:local_50 = 6;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
      LAB_00101655:lVar2 = *(long*)param_1;
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_58, (CowData*)&local_90);
      local_50 = 6;
...
/* OptimizedTranslation::_bind_methods() */void OptimizedTranslation::_bind_methods(void) {
   long lVar1;
   code *pcVar2;
   long *plVar3;
   MethodBind *pMVar4;
...
/* OptimizedTranslation::get_translated_message_list() const */Vector<String> *OptimizedTranslation::get_translated_message_list(void) {
   long *plVar1;
   int *piVar2;
   uint uVar3;
   long lVar4;
   ...
   if (lVar6 != 0) {
      ...
      do {
         while (true) {
            ...
            if (( uVar3 == 0xffffffff ) || ( piVar2 = (int*)( lVar4 + (ulong)uVar3 * 4 ) * piVar2 < 1 )) break;
...
;
 ...
 while ( iVar11 < *piVar2 );
            LAB_00102400:lVar12 = *(long*)( in_RSI + 0x2b0 );
            lVar9 = lVar9 + 1;
...
/* CowData<Pair<int, CharString> >::_copy_on_write() [clone .isra.0] */void CowData<Pair<int,CharString>>::_copy_on_write(CowData<Pair<int,CharString>> *this) {
   undefined4 uVar1;
   long lVar2;
   long lVar3;
   code *pcVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* OptimizedTranslation::generate(Ref<Translation> const&) */void OptimizedTranslation::generate(OptimizedTranslation *this, Ref *param_1) {
   ...
   uint *puVar41;
   CowData *pCVar42;
   HashMap<unsigned_int,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,int>>> *this_02;
   long *plVar43;
   long lVar44;
   size_t sVar45;
   int *piVar46;
   ...
   if (*(long**)param_1 == (long*)0x0) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         _err_print_error("generate", "core/string/optimized_translation.cpp", 0x31, "Condition \"p_from.is_null()\" is true.", 0, 0);
         return;
      }
   ...
   if (lVar44 < 0) {
      for (int i = 0; i < 3; i++) {
         _err_print_error("resize", "./core/templates/cowdata.h", 343, "Condition \"p_size < 0\" is true. Returning: ERR_INVALID_PARAMETER", 0, 0);
      }
      ...
      if (lVar44 == 0) {
         LAB_0010273f:if (local_c8 == (long*)0x0) {
            if (local_60 != (undefined8*)0x0) {
               LAB_0010323d:if (local_60[-1] != 0) {
                  LAB_00102771:CowData<CompressedString>::_unref((CowData<CompressedString>*)&local_60);
                  goto LAB_0010277e;
               }

            }

            LAB_00103248:local_118 = 0;
         }
 else {
            LAB_0010274d:lVar34 = (long)(int)local_c8[2];
            if (lVar34 < 0) {
               _err_print_error("resize", "./core/templates/cowdata.h", 0x157, "Condition \"p_size < 0\" is true. Returning: ERR_INVALID_PARAMETER", 0, 0);
               LAB_0010277e:if (local_c8 == (long*)0x0) goto LAB_00103248;
            }
...
;
 ...
 while ( !bVar48 );
                  ...
                  LAB_00102e10:lVar34 = puVar20[uVar27 * 2 + 1];
                  if (lVar34 == 0) goto LAB_00102e25;
                  LAB_00102962:lVar34 = *(long*)( lVar34 + -8 ) + 1;
               }

               puVar15 = local_50;
               iVar17 = CowData<Pair<int,CharString>>::resize<false>((CowData<Pair<int,CharString>>*)( puVar20 + uVar27 * 2 + 1 ), lVar34);
               if (iVar17 == 0) {
                  if (puVar20[uVar27 * 2 + 1] == 0) {
                     ...
                     lVar40 = lVar34 + -1;
                     if (-1 < lVar40) {
                        CowData<Pair<int,CharString>>::_copy_on_write((CowData<Pair<int,CharString>>*)( puVar20 + uVar27 * 2 + 1 ));
                  ...
                  _err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar40, lVar34, "p_index", "size()", "", false, false);
               }
 else {
                  _err_print_error("push_back", "./core/templates/vector.h", 0x142, "Condition \"err\" is true. Returning: true", 0, 0);
               }

               LAB_001029e0:if (puVar15 != (undefined1*)0x0) {
                  LOCK();
 ...
 while ( !bVar48 );
               ...
               if (( StringName::configured != '\0' ) && ( ( ( local_a8 == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) && ( local_b0 != 0 ) ) )) {
                  StringName::unref();
               }

               local_50 = (undefined1*)0x0;
               if (local_b8 == 0) {
                  LAB_00102d68:local_48 = local_118;
                  ...
                  if (local_b8 == 0) {
                     ...
                     LAB_00102ec0:CowData<char>::resize<false>((CowData<char>*)local_a0, (long)iVar17);
                     lVar34 = local_a0[0];
                     puVar20 = local_60;
                     if (local_a0[0] != 0) {
                     ...
                     LAB_00102bfb:puVar20 = local_60;
                     if (lVar34 != 0) goto LAB_00102c00;
                  }

               }

               joined_r0x00102c27:uVar27 = uVar19;
               local_60 = puVar20;
               if (puVar20 == (undefined8*)0x0) {
                  lVar34 = 0;
                  goto LAB_00102f16;
 ...
 while ( plVar43 != (long*)0x0 );
         ...
         if ((int)uVar16 < 1) goto LAB_001038c4;
      }
 else {
         uVar27 = (ulong)uVar16;
         ...
         if (puVar20 == (undefined8*)0x0) {
            _err_print_error("resize", "./core/templates/cowdata.h", 0x171, "Parameter \"mem_new\" is null.", 0, 0);
            LAB_001034e5:uVar19 = uVar27 * 4 - 1;
            uVar19 = uVar19 | uVar19 >> 1;
            uVar19 = uVar19 | uVar19 >> 2;
            uVar19 = uVar19 | uVar19 >> 4;
            uVar19 = uVar19 | uVar19 >> 8;
 ...
 while ( (int*)( puVar20 + uVar27 * 6 + 2 ) != piVar46 );
            puVar20[1] = uVar27;
            if (local_70[0] == (undefined8*)0x0) goto LAB_001034e5;
         }
         ...
         if (puVar20 != (undefined8*)0x0) {
            ...
            *puVar20 = 1;
            puVar26 = local_90[0];
            if (( (int)( puVar20 + ( uVar27 + 1 ) * 2 ) - (int)local_90[0] & 0x10U ) == 0) goto LAB_00103478;
            puVar20[3] = 0;
            puVar26 = puVar20;
            while (puVar26 = puVar26 + 4,puVar26 != puVar20 + ( uVar27 + 1 ) * 2) {
               LAB_00103478:puVar26[1] = 0;
               puVar26[3] = 0;
            }
;
            puVar20[1] = uVar27;
            if (local_c8 == (long*)0x0) goto LAB_001034a3;
            goto LAB_0010274d;
         }

         _err_print_error("resize", "./core/templates/cowdata.h", 0x171, "Parameter \"mem_new\" is null.", 0, 0);
         if (local_c8 != (long*)0x0) goto LAB_0010274d;
         LAB_001034a3:if (local_60 != (undefined8*)0x0) goto LAB_0010323d;
         local_118 = 0;
      }
      ...
      do {
         ...
         lVar34 = local_90[0][-1];
         if ((long)local_90[0][-1] <= (long)uVar27) goto LAB_00103a9b;
         if (local_80[0] == (int*)0x0) {
            LAB_00103abe:lVar34 = 0;
            LAB_00102f16:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, uVar27, lVar34, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
 ...
 while ( lVar32 != 0x1d );
                     ...
                     LAB_00103cb9:if (( *(int*)( (long)plVar43 + 0x14 ) != 0 ) && ( plVar47 = (long*)*plVar43 ),plVar47 != (long*)0x0) {
                        do {
                           HashMap<unsigned_int,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,int>>>::insert((uint*)&local_58, piVar46, (bool)( (char)plVar47 + '\x10' ));
 ...
 while ( lVar34 != lVar40 );
               ...
               CowData<HashMap<unsigned_int,int,HashMapHasherDefault,HashMapComparatorDefault < unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,int>>> > ::_unref(( CowData<HashMap<unsigned_int,int,HashMapHasherDefault,HashMapComparatorDefault < unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,int>>> > *)local_80 ));
               local_80[0] = piVar30;
            }

         }

         if (( puVar20[uVar27 * 2 + 1] != 0 ) && ( lVar34 = lVar34 != 0 )) {
            uVar19 = 0;
            iVar36 = 0;
            uVar2 = 1;
            this_02 = (HashMap<unsigned_int,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,int>>>*)( piVar30 + uVar27 * 0xc );
...
;
               ...
               if (( lVar34 != 0 ) && ( *(int*)( this_02 + 0x2c ) != 0 )) {
                  ...
                  if (uVar18 != 0) {
                     uVar18 = 0;
                     LAB_0010372a:if (( uVar35 != (uint)uVar31 ) || ( uVar14 != *(uint*)( *(long*)( lVar34 + lVar32 * 8 ) + 0x10 ) )) goto LAB_001036e0;
                     lVar32 = 0;
                     if (uVar28 != 0) {
                        while (true) {
...
;
               ...
               LAB_001037c9:lVar40 = puVar20[uVar27 * 2 + 1];
               if (lVar40 == 0) goto LAB_00103af3;
               lVar34 = *(long*)( lVar40 + -8 );
               if (*(long*)( lVar40 + -8 ) <= (long)uVar19) goto LAB_00103a9b;
               uVar37 = *(undefined4*)( lVar40 + (long)iVar36 * 0x10 );
               puVar24 = (undefined4*)HashMap<unsigned_int,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,int>>>::operator [](this_02, (uint*)&local_58);
               iVar36 = iVar36 + 1;
               uVar19 = (ulong)iVar36;
               *puVar24 = uVar37;
               LAB_001037a9:if (puVar20[uVar27 * 2 + 1] == 0) break;
               lVar34 = *(long*)( puVar20[uVar27 * 2 + 1] + -8 );
            }
;
            puVar26 = local_70[0];
            if (local_70[0] == (undefined8*)0x0) goto LAB_00103abe;
            lVar34 = local_70[0][-1];
            if (lVar34 <= (long)uVar27) goto LAB_00102f16;
            puVar33 = local_70[0];
            if (1 < (ulong)local_70[0][-2]) {
               if (local_70[0] == (undefined8*)0x0) {
                  OptimizedTranslation_generate:/* WARNING: Does not return */pcVar5 = (code*)invalidInstructionException();
                  ( *pcVar5 )();
               }
               ...
               do {
                  if (*piVar30 == 0) {
                     ...
                     *(int*)( lVar40 + (long)iVar36 * 4 ) = *piVar30;
                     uVar19 = uVar27;
                     if (local_70[0] == (undefined8*)0x0) goto LAB_00103af3;
                     lVar34 = local_70[0][-1];
                     if ((long)local_70[0][-1] <= (long)uVar27) break;
                     plVar43 = *(long**)( piVar30 + -5 );
                     *(undefined4*)( lVar40 + 4 + (long)iVar36 * 4 ) = *(undefined4*)( (long)local_70[0] + uVar27 * 4 );
                     if (plVar43 == (long*)0x0) {
                        iVar36 = iVar36 + 2;
                     }
 else {
                        *(int*)( lVar40 + -0x10 + (long)( iVar36 + 6 ) * 4 ) = (int)plVar43[2];
                        ...
                        if ((long)uVar19 < 0) {
                           LAB_00104310:if (local_60 == (undefined8*)0x0) {
                              LAB_00103af3:lVar34 = 0;
                           }
 else {
                              lVar34 = local_60[-1];
                           }
                        ...
                        if (local_60 == (undefined8*)0x0) goto LAB_00103af3;
                        lVar34 = local_60[-1];
                        lVar23 = (long)( iVar36 + 6 );
                        while (true) {
                           if (lVar34 <= (long)uVar19) goto LAB_00103a9b;
                           *(undefined4*)( lVar40 + -0xc + lVar23 * 4 ) = *(undefined4*)( local_60 + uVar19 * 3 + 2 );
                           uVar19 = ( ulong ) * (int*)( (long)plVar43 + 0x14 );
                           if (( (long)uVar19 < 0 ) || ( lVar34 <= (long)uVar19 )) goto LAB_00103a9b;
                           ...
                           *(undefined4*)( lVar40 + -8 + lVar23 * 4 ) = uVar37;
                           uVar19 = ( ulong ) * (int*)( (long)plVar43 + 0x14 );
                           if (( lVar34 <= (long)uVar19 ) || ( (long)uVar19 < 0 )) goto LAB_00103a9b;
                           ...
                           *(undefined4*)( lVar40 + -0x10 + ( lVar23 + 4 ) * 4 ) = *(undefined4*)( plVar43 + 2 );
                           uVar19 = ( ulong ) * (int*)( (long)plVar43 + 0x14 );
                           lVar23 = lVar23 + 4;
                           if ((long)uVar19 < 0) goto LAB_00104310;
                        }
;
                        iVar36 = (int)lVar23;
                     }
                  ...
                  if (uVar27 == uVar16 - 1) {
                     ...
                     if (lVar44 < 0) {
                        ...
                        if (lVar34 == 0) {
                           if (lVar44 != 0) {
                              ...
                              LAB_001040b4:puVar20 = (undefined8*)Memory::alloc_static(uVar19 + 0x11, false);
                              if (puVar20 == (undefined8*)0x0) {
                                 _err_print_error("resize", "./core/templates/cowdata.h", 0x171, "Parameter \"mem_new\" is null.", 0, 0);
                              }
 else {
                                 *puVar20 = 1;
                                 puVar20[1] = 0;
                                 LAB_001040d5:puVar20 = puVar20 + 2;
                                 *(undefined8**)( this + 0x2d0 ) = puVar20;
                                 LAB_001040dc:puVar20[-1] = lVar44;
                              }
                           ...
                           if (lVar44 != lVar40) {
                              if (lVar44 == 0) {
                                 ...
                                 *plVar43 = *plVar43 + -1;
                                 ...
                                 if (lVar40 < lVar44) {
                                    if (uVar27 != uVar19) {
                                       puVar20 = (undefined8*)Memory::realloc_static((void*)( *(long*)( this + 0x2d0 ) + -0x10 ), uVar19 + 0x11, false);
                                       if (puVar20 == (undefined8*)0x0) goto LAB_001042ac;
                                       *puVar20 = 1;
                                       goto LAB_001040d5;
                                    }
                                 ...
                                 if (uVar27 == uVar19) {
                                    ...
                                    puVar26 = (undefined8*)Memory::realloc_static(puVar20 + -2, uVar19 + 0x11, false);
                                    if (puVar26 == (undefined8*)0x0) {
                                       LAB_001042ac:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
                                       goto LAB_00103fef;
                                    }
                     ...
                     LAB_00103fef:CowData<unsigned_char>::_copy_on_write(this_00);
                     puVar20 = local_60;
                     lVar44 = *(long*)( this + 0x2d0 );
                     if (local_60 == (undefined8*)0x0) goto LAB_00104377;
                     uVar19 = 0;
                     plVar43 = local_60 + 1;
                     goto LAB_00104056;
                  }
 ...
 while ( (long)uVar19 < lVar32 );
         ...
         LAB_00103a9b:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar19, lVar34, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar5 = (code*)invalidInstructionException();
         ( *pcVar5 )();
   ...
   LAB_001038c4:_err_print_error("generate", "core/string/optimized_translation.cpp", 0x88, "Condition \"bucket_table_size == 0\" is true.", 0, 0);
   goto LAB_001038e9;
   LAB_001036e0:uVar18 = uVar18 + 1;
   auVar7._8_8_ = 0;
   ...
   if (( uVar4 == 0 ) || ( auVar8._8_8_ = 0 ),auVar8._0_8_ = uVar31 * uVar38,auVar12._8_8_ = 0,auVar12._0_8_ = uVar39,auVar9._8_8_ = 0,auVar9._0_8_ = ( ( uVar28 + iVar29 ) - SUB164(auVar8 * auVar12, 8) ) * uVar38,auVar13._8_8_ = 0,auVar13._0_8_ = uVar39,SUB164(auVar9 * auVar13, 8) < uVar18) goto LAB_001037c9;
   goto LAB_0010372a;
   LAB_00104056:if ((long)puVar20[-1] <= (long)uVar19) goto LAB_00104377;
   if (*plVar43 == 0) {
      iVar29 = 0;
   }
 else {
   ...
   LAB_00104377:if (iVar17 == iVar36) {
      ...
      _err_print_error("generate", "core/string/optimized_translation.cpp", 0xaf, "Condition \"btindex != bucket_table_size\" is true.", 0, 0);
   }

   LAB_001038e9:CowData<CompressedString>::_unref((CowData<CompressedString>*)&local_60);
   ...
   LAB_00103ef8:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* OptimizedTranslation::_set(StringName const&, Variant const&) */undefined4 OptimizedTranslation::_set(StringName *param_1, Variant *param_2) {
   long *plVar1;
   long lVar2;
   size_t sVar3;
   char cVar4;
   ...
   if (lVar8 == 0) {
      ...
      if (pOVar9 == (Object*)0x0) {
         ...
         if (*(long*)( lVar8 + 0x10 ) == 0) goto LAB_00104589;
         do {
            lVar2 = *plVar1;
            if (lVar2 == 0) goto LAB_00104589;
            LOCK();
            lVar6 = *plVar1;
            bVar10 = lVar2 == lVar6;
            if (bVar10) {
 ...
 while ( !bVar10 );
   ...
   if (cVar4 == '\0') {
      ...
      if (cVar4 == '\0') {
         ...
         if (cVar4 == '\0') {
            ...
            if ((char)uVar5 == '\0') goto LAB_001044f4;
            local_38 = (Object*)0x0;
            lVar8 = Variant::get_validated_object();
            if (( lVar8 != 0 ) && ( pOVar9 = (Object*)__dynamic_cast(lVar8, &Object::typeinfo, &Translation::typeinfo, 0) ),pOVar9 != (Object*)0x0) {
               local_38 = pOVar9;
            ...
            if (sVar7 == local_30) goto LAB_001045cd;
            if (sVar7 != 0) {
               LOCK();
   ...
   LAB_001044ee:uVar5 = 1;
   LAB_001044f4:lVar8 = local_40;
   if (local_40 != 0) {
      LOCK();
...
/* OptimizedTranslation::is_class_ptr(void*) const */uint OptimizedTranslation::is_class_ptr(OptimizedTranslation *this, void *param_1) {
   return (uint)CONCAT71(0x10a3, (undefined4*)param_1 == &Translation::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10a2, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10a3, (undefined4*)param_1 == &Resource::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10a3, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10a3, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* OptimizedTranslation::_validate_propertyv(PropertyInfo&) const */void OptimizedTranslation::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* OptimizedTranslation::_property_can_revertv(StringName const&) const */undefined8 OptimizedTranslation::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* OptimizedTranslation::_property_get_revertv(StringName const&, Variant&) const */undefined8 OptimizedTranslation::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* OptimizedTranslation::_notificationv(int, bool) */void OptimizedTranslation::_notificationv(int param_1, bool param_2) {
   return;
}
...
/* OptimizedTranslation::_get_class_namev() const */undefined8 *OptimizedTranslation::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00104a73:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00104a73;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "OptimizedTranslation");
         goto LAB_00104ade;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "OptimizedTranslation");
   LAB_00104ade:return &_get_class_namev();
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void FUN_00104c34(void) {
   code *pcVar1;
   _DAT_00000000 = 0;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
...
/* OptimizedTranslation::_bind_methods() [clone .cold] */void OptimizedTranslation::_bind_methods(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* CowData<Pair<int, CharString> >::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<Pair<int,CharString>>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* OptimizedTranslation::generate(Ref<Translation> const&) [clone .cold] */void OptimizedTranslation::generate(Ref *param_1) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void FUN_00104c68(void) {
   code *pcVar1;
   _DAT_00000000 = 0;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
...
/* OptimizedTranslation::get_class() const */void OptimizedTranslation::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* OptimizedTranslation::~OptimizedTranslation() */void OptimizedTranslation::~OptimizedTranslation(OptimizedTranslation *this) {
   long *plVar1;
   uint uVar2;
   long lVar3;
   void *pvVar4;
   ...
   *(undefined***)this = &PTR__initialize_classv_0010a070;
   for (int i = 0; i < 3; i++) {
      if (*(long*)( this + ( -16*i + 720 ) ) != 0) {
         LOCK();
         plVar1 = (long*)( *(long*)( this + ( -16*i + 720 ) ) + -16 );
         *plVar1 = *plVar1 + -1;
         UNLOCK();
         if (*plVar1 == 0) {
            lVar3 = *(long*)( this + ( -16*i + 720 ) );
            *(undefined8*)( this + ( -16*i + 720 ) ) = 0;
   ...
   *(code**)this = StringName::operator =;
   if (bVar5) {
      if (*(long*)( this + 0x290 ) != 0) {
         StringName::unref();
         if (StringName::configured == '\0') goto LAB_00104ff9;
      }
   ...
   LAB_00104ff9:pvVar4 = *(void**)( this + 0x250 );
   if (pvVar4 != (void*)0x0) {
      if (*(int*)( this + 0x274 ) != 0) {
                  ...
                  *(int*)( *(long*)( this + 600 ) + lVar3 ) = 0;
                  ...
                  if (bVar5) {
                     if (*(long*)( (long)pvVar4 + 0x18 ) != 0) {
                        StringName::unref();
                        if (StringName::configured == '\0') goto LAB_00105095;
                     }
                  ...
                  LAB_00105095:Memory::free_static(pvVar4, false);
 ...
 while ( lVar3 != (ulong)uVar2 << 2 );
            *(undefined4*)( this + 0x274 ) = 0;
            *(undefined1(*) [16])( this + 0x260 ) = (undefined1[16])0x0;
            if (pvVar4 == (void*)0x0) goto LAB_001050d1;
         }
   ...
   LAB_001050d1:if (*(long*)( this + 0x240 ) != 0) {
      LOCK();
...
/* OptimizedTranslation::~OptimizedTranslation() */void OptimizedTranslation::~OptimizedTranslation(OptimizedTranslation *this) {
   ...
   *(code**)this = StringName::operator =;
   if (bVar5) {
      if (*(long*)( this + 0x290 ) != 0) {
         StringName::unref();
         if (StringName::configured == '\0') goto LAB_00105289;
      }
   ...
   LAB_00105289:pvVar4 = *(void**)( this + 0x250 );
   if (pvVar4 != (void*)0x0) {
      if (*(int*)( this + 0x274 ) != 0) {
         uVar2 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x270 ) * 4 );
         if (uVar2 == 0) {
               ...
               if (*(int*)( *(long*)( this + 600 ) + lVar3 ) != 0) {
                  ...
                  *(int*)( *(long*)( this + 600 ) + lVar3 ) = 0;
                  ...
                  if (bVar5) {
                     if (*(long*)( (long)pvVar4 + 0x18 ) != 0) {
                        StringName::unref();
                        if (StringName::configured == '\0') goto LAB_00105325;
                     }
                  ...
                  LAB_00105325:Memory::free_static(pvVar4, false);
                  pvVar4 = *(void**)( this + 0x250 );
                  *(undefined8*)( (long)pvVar4 + lVar3 * 2 ) = 0;
               }
 ...
 while ( lVar3 != (ulong)uVar2 << 2 );
            *(undefined4*)( this + 0x274 ) = 0;
            *(undefined1(*) [16])( this + 0x260 ) = (undefined1[16])0x0;
            if (pvVar4 == (void*)0x0) goto LAB_00105361;
         }
   ...
   LAB_00105361:if (*(long*)( this + 0x240 ) != 0) {
      LOCK();
      plVar1 = (long*)( *(long*)( this + 0x240 ) + -0x10 );
      *plVar1 = *plVar1 + -1;
      UNLOCK();
...
/* MethodBindT<Ref<Translation> const&>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<Ref<Translation>const&>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar7 + 2 ) = (undefined1[16])0x0;
   ...
   if (local_70 == 0) {
      ...
      local_30 = 6;
      if (local_40 == 0x11) goto LAB_001056bd;
   ...
   *puVar7 = local_58._0_4_;
   ...
   LAB_001054b7:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* Resource::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Resource::_get_property_listv(Resource *this, List *param_1, bool param_2) {
   ...
   local_58 = 0;
   if (local_90 == 0) {
      LAB_00105d28:local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_58, (CowData*)&local_90);
      local_50 = 0x80;
      if (local_60 != 0x11) goto LAB_00105d28;
      StringName::StringName((StringName*)&local_80, (CowData<char32_t>*)&local_58, false);
      if (local_68 != local_80) {
         StringName::unref();
         lVar2 = *(long*)param_1;
         local_68 = local_80;
         goto joined_r0x00105d45;
      }
...
/* Translation::is_class(String const&) const */undefined8 Translation::is_class(Translation *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_0010606f:cVar6 = String::operator ==((String*)param_1, (StrRange*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
         ...
         LAB_00106293:cVar6 = String::operator ==((String*)param_1, (StrRange*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
            ...
            LAB_00106373:cVar6 = String::operator ==((String*)param_1, (StrRange*)&local_60);
            lVar4 = local_60;
            if (local_60 != 0) {
               LOCK();
               plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
               ...
               LAB_001061fb:cVar6 = String::operator ==((String*)param_1, (StrRange*)&local_60);
               lVar4 = local_60;
               if (local_60 != 0) {
                  LOCK();
                  plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_00106123:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_00106489:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* OptimizedTranslation::is_class(String const&) const */undefined8 OptimizedTranslation::is_class(OptimizedTranslation *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *__s;
   long lVar3;
 ...
 while ( !bVar8 );
      ...
      LAB_001064ff:cVar5 = String::operator ==((String*)param_1, (StrRange*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_001065b3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* OptimizedTranslation::_getv(StringName const&, Variant&) const */void OptimizedTranslation::_getv(OptimizedTranslation *this, StringName *param_1, Variant *param_2) {
   _get(this, param_1, param_2);
   return;
}
/* OptimizedTranslation::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void OptimizedTranslation::_get_property_listv(OptimizedTranslation *this, List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   undefined1(*pauVar4)[16];
   ...
   local_58 = 0;
   if (local_90 == 0) {
      LAB_00106bf8:local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_58, (CowData*)&local_90);
      local_50 = 0x80;
      if (local_60 != 0x11) goto LAB_00106bf8;
      StringName::StringName((StringName*)&local_80, (CowData<char32_t>*)&local_58, false);
      if (local_68 != local_80) {
         StringName::unref();
         lVar2 = *(long*)param_1;
         local_68 = local_80;
         goto joined_r0x00106c1a;
      }
...
/* MethodBind* create_method_bind<OptimizedTranslation, Ref<Translation> const&>(void
   (OptimizedTranslation::*)(Ref<Translation> const&)) */MethodBind *create_method_bind<OptimizedTranslation,Ref<Translation>const&>(_func_void_Ref_ptr *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* OptimizedTranslation::_initialize_classv() */void OptimizedTranslation::_initialize_classv(void) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   long local_70;
   ...
   if (initialize_class() == '\0') {
      if (Translation::initialize_class() == '\0') {
         ...
         Translation::initialize_class()::initialized =
         '\x01';
      }
...
/* Error CowData<String>::resize<false>(long) */undefined8 CowData<String>::resize<false>(CowData<String> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_00107a90:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (uVar6 == 0xffffffffffffffff) goto LAB_00107a90;
   if (param_1 <= lVar9) {
      puVar7 = *(undefined8**)this;
      uVar8 = param_1;
      while (puVar7 != (undefined8*)0x0) {
         if ((ulong)puVar7[-1] <= uVar8) {
            LAB_00107919:if (uVar6 + 1 != lVar5) {
               puVar4 = (undefined8*)Memory::realloc_static(puVar7 + -2, uVar6 + 0x11, false);
               if (puVar4 == (undefined8*)0x0) goto LAB_00107abf;
               puVar7 = puVar4 + 2;
               *puVar4 = 1;
         ...
         while (true) {
            ...
            if (*plVar2 != 0) break;
            uVar8 = uVar8 + 1;
            if ((ulong)puVar7[-1] <= uVar8) goto LAB_00107919;
         }
;
         LOCK();
...
;
      LAB_00107b0d:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
      ( *pcVar3 )();
   }

   if (uVar6 + 1 == lVar5) {
      puVar7 = *(undefined8**)this;
      if (puVar7 == (undefined8*)0x0) goto LAB_00107b0d;
      lVar9 = puVar7[-1];
      LAB_001079f0:if (param_1 <= lVar9) goto LAB_001079a5;
   }
 else {
      if (lVar9 != 0) {
         puVar4 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), uVar6 + 0x11, false);
         if (puVar4 == (undefined8*)0x0) {
            LAB_00107abf:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
            return 6;
         }
...
/* CowData<HashMap<unsigned int, int, HashMapHasherDefault, HashMapComparatorDefault<unsigned int>,
   DefaultTypedAllocator<HashMapElement<unsigned int, int> > > >::_unref() */void CowData<HashMap<unsigned_int,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,int>>>>::_unref(CowData<HashMap<unsigned_int,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,int>>>> *this) {
   long *plVar1;
   uint uVar2;
   long lVar3;
   long lVar4;
 ...
 while ( lVar7 != (ulong)uVar2 * 4 );
                  *(undefined4*)( lVar8 + 0x2c ) = 0;
                  *(undefined1(*) [16])( lVar8 + 0x18 ) = (undefined1[16])0x0;
                  if (pvVar9 == (void*)0x0) goto LAB_00107c37;
               }
...
/* CowData<CompressedString>::_unref() */void CowData<CompressedString>::_unref(CowData<CompressedString> *this) {
   long *plVar1;
   long lVar2;
   long lVar3;
   long lVar4;
...
/* CowData<HashMap<unsigned int, int, HashMapHasherDefault, HashMapComparatorDefault<unsigned int>,
   DefaultTypedAllocator<HashMapElement<unsigned int, int> > > >::_realloc(long) */undefined8 CowData<HashMap<unsigned_int,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,int>>>>::_realloc(CowData<HashMap<unsigned_int,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,int>>>> *this, long param_1) {
   undefined8 *puVar1;
...
/* HashMap<unsigned int, int, HashMapHasherDefault, HashMapComparatorDefault<unsigned int>,
   DefaultTypedAllocator<HashMapElement<unsigned int, int> > >::_resize_and_rehash(unsigned int) */void HashMap<unsigned_int,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,int>>>::_resize_and_rehash(HashMap<unsigned_int,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,int>>> *this, uint param_1) {
   uint *puVar1;
   undefined8 *puVar2;
   uint uVar3;
   uint uVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<unsigned int, int, HashMapHasherDefault, HashMapComparatorDefault<unsigned int>,
   DefaultTypedAllocator<HashMapElement<unsigned int, int> > >::operator[](unsigned int const&) */undefined1[16];HashMap<unsigned_int,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,int>>>::operator [](HashMap<unsigned_int,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,int>>>
             *this,uint*param_1)

{
 ...
 while ( uVar41 != uVar38 );
      ...
      LAB_00108549:if (iVar39 == 0) goto LAB_00108600;
   ...
   uVar31 = *param_1;
   iVar39 = *(int*)( this + 0x2c );
   if (__s_00 != (void*)0x0) goto LAB_00108549;
}
else{iVar39 = *(int*)( this + 0x2c );if (iVar39 == 0) {
   LAB_00108600:iVar39 = 0;
}
 else {
 ...
 while ( ( uVar29 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = uVar29 * uVar2,auVar18._8_8_ = 0,auVar18._0_8_ = uVar41,auVar7._8_8_ = 0,auVar7._0_8_ = ( ( uVar44 + uVar30 ) - SUB164(auVar6 * auVar18, 8) ) * uVar2,auVar19._8_8_ = 0,auVar19._0_8_ = uVar41,lVar37 = SUB168(auVar7 * auVar19, 8),uVar40 <= SUB164(auVar7 * auVar19, 8) );
   ...
   LAB_00108214:uVar35 = CONCAT44(0, *(uint*)( hash_table_size_primes + uVar38 * 4 ));
   uVar2 = *(ulong*)( hash_table_size_primes_inv + uVar38 * 8 );
...
uVar31 = *param_1;pauVar32 = (undefined1(*) [16])operator_new(0x18, "");*(uint*)pauVar32[1] = uVar31;*(undefined4*)( pauVar32[1] + 4 ) = 0;*pauVar32 = (undefined1[16])0x0;puVar3 = *(undefined8**)( this + 0x20 );if (puVar3 == (undefined8*)0x0) {
...
;*(undefined1(**) [16])( lVar37 + lStack_70 * 8 ) = pauVar28;*puVar1 = uVar31;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_001082e6:auVar47._8_8_ = lStack_70;auVar47._0_8_ = pauVar32[1] + 4;return auVar47;}/* CowData<Pair<int, CharString> >::_unref() */void CowData<Pair<int,CharString>>::_unref(CowData<Pair<int,CharString>> *this) {
   long *plVar1;
   long lVar2;
   long lVar3;
   long lVar4;
...
/* CowData<Vector<Pair<int, CharString> > >::_unref() */void CowData<Vector<Pair<int,CharString>>>::_unref(CowData<Vector<Pair<int,CharString>>> *this) {
   long *plVar1;
   long lVar2;
   long lVar3;
   code *pcVar4;
...
/* Error CowData<Pair<int, CharString> >::resize<false>(long) */undefined8 CowData<Pair<int,CharString>>::resize<false>(CowData<Pair<int,CharString>> *this, long param_1) {
   long *plVar1;
   code *pcVar2;
   undefined8 *puVar3;
   undefined8 *puVar4;
   ...
   if (param_1 * 0x10 == 0) {
      LAB_00108a78:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (uVar9 == 0xffffffffffffffff) goto LAB_00108a78;
   if (param_1 <= lVar7) {
      puVar5 = *(undefined8**)this;
      uVar6 = param_1;
      while (puVar5 != (undefined8*)0x0) {
         if ((ulong)puVar5[-1] <= uVar6) {
            LAB_001088e2:if (uVar9 + 1 != lVar8) {
               puVar4 = (undefined8*)Memory::realloc_static(puVar5 + -2, uVar9 + 0x11, false);
               if (puVar4 == (undefined8*)0x0) goto LAB_00108aa7;
               puVar5 = puVar4 + 2;
               *puVar4 = 1;
               *(undefined8**)this = puVar5;
            }
         ...
         while (puVar5[uVar6 * 2 + 1] == 0) {
            uVar6 = uVar6 + 1;
            if ((ulong)puVar5[-1] <= uVar6) goto LAB_001088e2;
         }
;
         LOCK();
...
;
      LAB_00108af5:/* WARNING: Does not return */pcVar2 = (code*)invalidInstructionException();
      ( *pcVar2 )();
   }

   if (uVar9 + 1 == lVar8) {
      puVar5 = *(undefined8**)this;
      if (puVar5 == (undefined8*)0x0) goto LAB_00108af5;
      lVar7 = puVar5[-1];
      LAB_001089d0:if (param_1 <= lVar7) goto LAB_0010897f;
   }
 else {
      if (lVar7 != 0) {
         puVar4 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), uVar9 + 0x11, false);
         if (puVar4 == (undefined8*)0x0) {
            LAB_00108aa7:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
            return 6;
         }
 ...
 while ( puVar3 != puVar5 + param_1 * 2 );
   LAB_0010897f:puVar5[-1] = param_1;
   return 0;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<unsigned int, int, HashMapHasherDefault, HashMapComparatorDefault<unsigned int>,
   DefaultTypedAllocator<HashMapElement<unsigned int, int> > >::insert(unsigned int const&, int
   const&, bool) */void HashMap<unsigned_int,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,int>>>::insert(uint *param_1, int *param_2, bool param_3) {
   undefined4 uVar1;
   undefined8 *puVar2;
   long lVar3;
   long lVar4;
 ...
 while ( uVar30 != uVar33 );
      ...
      iVar28 = param_2[0xb];
      uVar24 = *puVar29;
      if (__s_00 != (void*)0x0) goto LAB_00108b51;
   }
 else {
      LAB_00108b46:iVar28 = param_2[0xb];
      uVar24 = *puVar29;
      LAB_00108b51:if (iVar28 != 0) {
         ...
         if (uVar22 != 0) {
            uVar36 = 0;
            do {
               if (( uVar34 == uVar22 ) && ( *(uint*)( *(long*)( (long)__s_00 + lVar31 * 8 ) + 0x10 ) == uVar24 )) {
 ...
 while ( ( uVar22 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = uVar22 * uVar33,auVar15._8_8_ = 0,auVar15._0_8_ = uVar35,auVar8._8_8_ = 0,auVar8._0_8_ = ( ( *(uint*)( hash_table_size_primes + (ulong)(uint)param_2[10] * 4 ) + uVar25 ) - SUB164(auVar7 * auVar15, 8) ) * uVar33,auVar16._8_8_ = 0,auVar16._0_8_ = uVar35,uVar36 <= SUB164(auVar8 * auVar16, 8) );
         }
   ...
   if ((float)uVar23 * __LC38 < (float)( iVar28 + 1 )) {
      ...
      _resize_and_rehash((HashMap<unsigned_int,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,int>>>*)param_2, param_2[10] + 1);
   }
...
;
   ...
   *puVar29 = uVar23;
   ...
   LAB_00108dd8:*(undefined1(**) [16])param_1 = pauVar26;
   return;
}
/* OptimizedTranslation::_setv(StringName const&, Variant const&) */void OptimizedTranslation::_setv(StringName *param_1, Variant *param_2) {
   _set(param_1, param_2);
   return;
}
/* WARNING: Removing unreachable block (ram,0x001090b8) *//* WARNING: Removing unreachable block (ram,0x001091e8) *//* WARNING: Removing unreachable block (ram,0x001093b0) *//* WARNING: Removing unreachable block (ram,0x001091f4) *//* WARNING: Removing unreachable block (ram,0x001091fe) *//* WARNING: Removing unreachable block (ram,0x00109390) *//* WARNING: Removing unreachable block (ram,0x0010920a) *//* WARNING: Removing unreachable block (ram,0x00109214) *//* WARNING: Removing unreachable block (ram,0x00109370) *//* WARNING: Removing unreachable block (ram,0x00109220) *//* WARNING: Removing unreachable block (ram,0x0010922a) *//* WARNING: Removing unreachable block (ram,0x00109350) *//* WARNING: Removing unreachable block (ram,0x00109236) *//* WARNING: Removing unreachable block (ram,0x00109240) *//* WARNING: Removing unreachable block (ram,0x00109330) *//* WARNING: Removing unreachable block (ram,0x0010924c) *//* WARNING: Removing unreachable block (ram,0x00109256) *//* WARNING: Removing unreachable block (ram,0x00109310) *//* WARNING: Removing unreachable block (ram,0x00109262) *//* WARNING: Removing unreachable block (ram,0x0010926c) *//* WARNING: Removing unreachable block (ram,0x001092f0) *//* WARNING: Removing unreachable block (ram,0x00109274) *//* WARNING: Removing unreachable block (ram,0x0010928a) *//* WARNING: Removing unreachable block (ram,0x00109296) *//* String vformat<StringName>(String const&, StringName const) */undefined8 *vformat<StringName>(undefined8 *param_1, bool *param_2, StringName *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* MethodBindT<Ref<Translation> const&>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<Ref<Translation>const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   if (( ( param_2 != (Variant**)0x0 ) && ( param_2[1] != (Variant*)0x0 ) ) && ( param_2[1][0x2e] != (Variant)0x0 )) {
      ...
      if (local_58 == (Object*)*(long*)pVVar6) {
         ...
         MethodBind::get_name();
         local_58 = (Object*)0x1093d8;
         local_60 = 0;
         local_50 = 0x35;
         String::parse_latin1((StrRange*)&local_60);
         vformat<StringName>((StringName*)&local_58, (StrRange*)&local_60, &local_68);
         _err_print_error("validated_call", "./core/object/method_bind.h", 0x160, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true.", (StringName*)&local_58, 0);
         pOVar3 = local_58;
   ...
   if (pOVar5 != local_58) {
      if (pOVar5 == (Object*)0x0) {
         if (local_58 != (Object*)0x0) {
            local_58 = (Object*)0x0;
            LAB_00109576:cVar4 = RefCounted::unreference();
            if (cVar4 != '\0') {
         ...
         if (pOVar3 != pOVar5) {
            ...
            if (pOVar3 != (Object*)0x0) goto LAB_00109576;
         }
   ...
   LAB_001095b8:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<Ref<Translation> const&>::ptrcall(Object*, void const**, void*) const */void MethodBindT<Ref<Translation>const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   if (( *param_3 == (long*)0x0 ) || ( local_48 = (Object*)**param_3 ),local_48 == (Object*)0x0) {
      LAB_001098a8:local_48 = (Object*)0x0;
   }
 else {
      cVar4 = RefCounted::init_ref();
      if (cVar4 == '\0') goto LAB_001098a8;
   }
   ...
   LAB_001098cc:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<Ref<Translation> const&>::call(Object*, Variant const**, int, Callable::CallError&)
   ...
   if (( ( plVar11 != (long*)0x0 ) && ( plVar11[1] != 0 ) ) && ( *(char*)( plVar11[1] + 0x2e ) != '\0' )) {
      ...
      if (local_48 == (Object*)*plVar9) {
         ...
         String::parse_latin1((StrRange*)&local_50);
         vformat<StringName>((StringName*)&local_48, (StrRange*)&local_50, &local_58);
         _err_print_error(&_LC68, "./core/object/method_bind.h", 0x154, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: Variant()", (StringName*)&local_48, 0);
         pOVar5 = local_48;
         if (local_48 != (Object*)0x0) {
            LOCK();
   ...
   if (pVVar12 == (Variant*)0x0) {
      if (in_R8D != 1) goto LAB_00109d40;
      LAB_00109d30:pVVar12 = *(Variant**)param_4;
   }
 else {
      lVar2 = *(long*)( pVVar12 + -8 );
      if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
         LAB_00109d40:uVar7 = 4;
         goto LAB_00109ce5;
      }
   ...
   *in_R9 = 0;
   ...
   if (pOVar8 != local_48) {
      if (pOVar8 == (Object*)0x0) {
         if (local_48 != (Object*)0x0) {
            local_48 = (Object*)0x0;
            LAB_00109e5d:cVar6 = RefCounted::unreference();
            if (cVar6 != '\0') {
         ...
         if (pOVar5 != pOVar8) {
            ...
            if (pOVar5 != (Object*)0x0) goto LAB_00109e5d;
         }
   ...
   LAB_00109cf0:*(undefined4*)param_1 = 0;
...
/* WARNING: Control flow encountered bad instruction data *//* OptimizedTranslation::~OptimizedTranslation() */void OptimizedTranslation::~OptimizedTranslation(OptimizedTranslation *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

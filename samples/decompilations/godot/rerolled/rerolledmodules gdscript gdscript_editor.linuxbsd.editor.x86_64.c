            ...
            do {
               if (*(int*)( (long)local_a98 + lVar24 ) != 0) {
                  ...
                  *(int*)( (long)local_a98 + lVar24 ) = 0;
                  if (( *(long*)( (long)pvVar28 + 0x18 ) != 0 ) && ( cVar13 = cVar13 != '\0' )) {
            ...
            do {
               if (*(int*)( (long)local_d98 + lVar11 ) != 0) {
                  ...
                  *(int*)( (long)local_d98 + lVar11 ) = 0;
                  if (( *(long*)( (long)pvVar19 + 0x18 ) != 0 ) && ( cVar9 = cVar9 != '\0' )) {
            ...
            do {
               if (*(int*)( (long)local_eb8 + lVar26 ) != 0) {
                  ...
                  *(int*)( (long)local_eb8 + lVar26 ) = 0;
                  if (( *(long*)( (long)pvVar31 + 0x18 ) != 0 ) && ( cVar18 = cVar18 != '\0' )) {
...
/* GDScriptLanguage::get_built_in_templates(StringName const&) */StringName *GDScriptLanguage::get_built_in_templates(StringName *param_1) {
   long *plVar1;
   CowData<char32_t> *this;
   undefined4 uVar2;
   undefined4 uVar3;
...
/* TLS init function for GDScriptLanguage::_debug_parse_err_file */void GDScriptLanguage::_debug_parse_err_file(void) {
   undefined8 uVar1;
   char *in_FS_OFFSET;
   if (*in_FS_OFFSET != '\0') {
      return;
...
/* CowData<GDScriptParser::ClassNode::Member>::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<GDScriptParser::ClassNode::Member>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* GDScriptParser::MemberDocData::~MemberDocData() */void GDScriptParser::MemberDocData::~MemberDocData(MemberDocData *this) {
   long *plVar1;
   long lVar2;
   if (*(long*)( this + 0x20 ) != 0) {
      LOCK();
...
/* GDScriptParser::ClassNode::get_member(StringName const&) const */StringName *GDScriptParser::ClassNode::get_member(StringName *param_1) {
   StringName SVar1;
   uint uVar2;
   undefined4 uVar3;
   long lVar4;
...
/* GDScriptParser::ClassNode::has_function(StringName const&) const */undefined8 GDScriptParser::ClassNode::has_function(ClassNode *this, StringName *param_1) {
   uint uVar1;
   long lVar2;
...
/* ProjectSettings::AutoloadInfo::~AutoloadInfo() */void ProjectSettings::AutoloadInfo::~AutoloadInfo(AutoloadInfo *this) {
   long *plVar1;
   long lVar2;
   if (*(long*)( this + 8 ) != 0) {
      LOCK();
...
/* GDScriptParser::ClassNode::Member::get_name() const */void GDScriptParser::ClassNode::Member::get_name(void) {
   long lVar1;
   char *pcVar2;
   undefined4 *in_RSI;
   long lVar3;
...
/* List<GDScriptParser::LambdaNode*, DefaultAllocator>::~List() */undefined8 List<GDScriptParser::LambdaNode*,DefaultAllocator>::~List(List<GDScriptParser::LambdaNode*,DefaultAllocator> *this) {
   void *pvVar1;
   long lVar2;
   long lVar3;
   undefined8 uVar4;
...
/* List<Pair<StringName, int>, DefaultAllocator>::~List() */void List<Pair<StringName,int>,DefaultAllocator>::~List(List<Pair<StringName,int>,DefaultAllocator> *this) {
   long *plVar1;
   long lVar2;
   long lVar3;
   long *plVar4;
...
/* GDScriptNativeClass const* Object::cast_to<GDScriptNativeClass>(Object const*) */GDScriptNativeClass *Object::cast_to<GDScriptNativeClass>(Object *param_1) {
...
;*(undefined8**)( lVar45 + lVar47 * 8 ) = puVar41;*puVar1 = uVar37;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_00128d4b:if (( &Variant::needs_deinit )[local_98[0]] != '\0') {
   Variant::_clear_internal();
}
LAB_001287c4:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return local_c8;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* HashMap<String, ScriptLanguage::CodeCompletionOption, HashMapHasherDefault,
         ...
         do {
            if (*(int*)( *(long*)( this + 0x10 ) + lVar6 ) != 0) {
               ...
               *(int*)( *(long*)( this + 0x10 ) + lVar6 ) = 0;
               ...
               if (( *(long*)( (long)pvVar7 + 0x40 ) != 0 ) && ( cVar5 = cVar5 != '\0' )) {
...
/* HashMap<StringName, Ref<GDScript>, HashMapHasherDefault, HashMapComparatorDefault<StringName>,
   ...
   const */long HashMap<StringName,Ref<GDScript>,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Ref<GDScript>>>>::getptr(HashMap<StringName,Ref<GDScript>,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Ref<GDScript>>>> *this, StringName *param_1) {
   uint uVar1;
   long lVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<String, ScriptLanguage::CodeCompletionOption, HashMapHasherDefault,
   HashMapComparatorDefault<String>, DefaultTypedAllocator<HashMapElement<String,
   ScriptLanguage::CodeCompletionOption> > >::insert(String const&,
   ScriptLanguage::CodeCompletionOption const&, bool) */String * HashMap<String,ScriptLanguage::CodeCompletionOption,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ScriptLanguage::CodeCompletionOption>>>
...
/* Ref<GDScriptParserRef>::unref() */void Ref<GDScriptParserRef>::unref(Ref<GDScriptParserRef> *this) {
   Object *pOVar1;
   char cVar2;
   if (*(long*)this != 0) {
      cVar2 = RefCounted::unreference();
...
/* GDScriptCompletionIdentifier::~GDScriptCompletionIdentifier() */void GDScriptCompletionIdentifier::~GDScriptCompletionIdentifier(GDScriptCompletionIdentifier *this) {
   long *plVar1;
   long lVar2;
   if (( &Variant::needs_deinit )[*(int*)( this + 0xf8 )] != '\0') {
      Variant::_clear_internal();
...
return;}/* GDScriptParser::DataType::DataType(GDScriptParser::DataType const&) */void GDScriptParser::DataType::DataType(DataType *this, DataType *param_1) {
   *(undefined8*)( this + 8 ) = 0;
   *(undefined8*)( this + 0x10 ) = 7;
   *(undefined4*)( this + 0x18 ) = 0;
   this[0x1c] = (DataType)0x0;

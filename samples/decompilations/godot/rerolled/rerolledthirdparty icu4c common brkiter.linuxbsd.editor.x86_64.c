/* icu_76_godot::BreakIterator::getRuleStatus() const */undefined8 icu_76_godot::BreakIterator::getRuleStatus(void) {
   return 0;
}
/* icu_76_godot::BreakIterator::getRuleStatusVec(int*, int, UErrorCode&) */undefined8 icu_76_godot::BreakIterator::getRuleStatusVec(BreakIterator *this, int *param_1, int param_2, UErrorCode *param_3) {
   undefined8 uVar1;
   uVar1 = 0;
   if (*(int*)param_3 < 1) {
      if (param_2 < 1) {
...
/* icu_76_godot::BreakIterator::buildInstance(icu_76_godot::Locale const&, char const*, UErrorCode&)
    */RuleBasedBreakIterator *icu_76_godot::BreakIterator::buildInstance(Locale *param_1, char *param_2, UErrorCode *param_3) {
   int iVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   ...
   if ((int)*(uint*)param_3 < 1) {
      pRVar4 = (RuleBasedBreakIterator*)icu_76_godot::UMemory::operator_new((UMemory*)0x2f0, ( ulong ) * (uint*)param_3);
      ...
      icu_76_godot::RuleBasedBreakIterator::RuleBasedBreakIterator(pRVar4, uVar3, pcVar5 != (char*)0x0, param_3);
      if (*(int*)param_3 < 1) {
      ...
      ures_close_76_godot(uVar2);
      LAB_001001b1:pRVar4 = (RuleBasedBreakIterator*)0x0;
   }
   ...
   LAB_001001c5:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return pRVar4;
   }
...
/* icu_76_godot::BreakIterator::getAvailableLocales(int&) */void icu_76_godot::BreakIterator::getAvailableLocales(int *param_1) {
   icu_76_godot::Locale::getAvailableLocales(param_1);
   return;
}
/* icu_76_godot::BreakIterator::BreakIterator() */void icu_76_godot::BreakIterator::BreakIterator(BreakIterator *this) {
...
/* icu_76_godot::BreakIterator::BreakIterator(icu_76_godot::BreakIterator const&) */void icu_76_godot::BreakIterator::BreakIterator(BreakIterator *this, BreakIterator *param_1) {
   *(undefined**)this = &DAT_001013b8;
   for (int i = 0; i < 3; i++) {
      strncpy((char*)( this + ( 157*i + 8 ) ), (char*)( param_1 + ( 157*i + 8 ) ), 157);
   }

   return;
}
/* icu_76_godot::BreakIterator::TEMPNAMEPLACEHOLDERVALUE(icu_76_godot::BreakIterator const&) */BreakIterator * __thiscall
...
/* icu_76_godot::BreakIterator::makeInstance(icu_76_godot::Locale const&, int, UErrorCode&) */undefined8 icu_76_godot::BreakIterator::makeInstance(Locale *param_1, int param_2, UErrorCode *param_3) {
   char *pcVar1;
   int iVar2;
   long *plVar3;
   undefined8 uVar4;
   ...
   LAB_001008d1:uVar4 = 0;
   LAB_001006ac:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* icu_76_godot::BreakIterator::createInstance(icu_76_godot::Locale const&, int, UErrorCode&) */undefined8 icu_76_godot::BreakIterator::createInstance(Locale *param_1, int param_2, UErrorCode *param_3) {
   undefined8 uVar1;
   if (*(int*)param_3 < 1) {
...
/* icu_76_godot::BreakIterator::createWordInstance(icu_76_godot::Locale const&, UErrorCode&) */undefined8 icu_76_godot::BreakIterator::createWordInstance(Locale *param_1, UErrorCode *param_2) {
   undefined8 uVar1;
   if (*(int*)param_2 < 1) {
...
/* icu_76_godot::BreakIterator::createLineInstance(icu_76_godot::Locale const&, UErrorCode&) */undefined8 icu_76_godot::BreakIterator::createLineInstance(Locale *param_1, UErrorCode *param_2) {
   undefined8 uVar1;
   if (*(int*)param_2 < 1) {
...
/* icu_76_godot::BreakIterator::createCharacterInstance(icu_76_godot::Locale const&, UErrorCode&) */undefined8 icu_76_godot::BreakIterator::createCharacterInstance(Locale *param_1, UErrorCode *param_2) {
   undefined8 uVar1;
   if (*(int*)param_2 < 1) {
...
/* icu_76_godot::BreakIterator::createSentenceInstance(icu_76_godot::Locale const&, UErrorCode&) */undefined8 icu_76_godot::BreakIterator::createSentenceInstance(Locale *param_1, UErrorCode *param_2) {
   undefined8 uVar1;
   if (*(int*)param_2 < 1) {
...
/* icu_76_godot::BreakIterator::createTitleInstance(icu_76_godot::Locale const&, UErrorCode&) */undefined8 icu_76_godot::BreakIterator::createTitleInstance(Locale *param_1, UErrorCode *param_2) {
   undefined8 uVar1;
   if (*(int*)param_2 < 1) {
...
/* icu_76_godot::BreakIterator::getLocale(ULocDataLocaleType, UErrorCode&) const */BreakIterator * __thiscall
icu_76_godot::BreakIterator::getLocale(BreakIterator *this,long param_2,int param_3){
   ...
   if (param_3 == 2) {
      icu_76_godot::Locale::Locale((Locale*)this, (char*)( param_2 + 0x142 ), (char*)0x0, (char*)0x0, (char*)0x0);
   }
 else {
...
/* icu_76_godot::BreakIterator::getLocaleID(ULocDataLocaleType, UErrorCode&) const */long icu_76_godot::BreakIterator::getLocaleID(long param_1, int param_2) {
   long lVar1;
   long in_FS_OFFSET;
   long local_28;
   long local_20;
...
/* icu_76_godot::BreakIterator::BreakIterator(icu_76_godot::Locale const&, icu_76_godot::Locale
   const&) */void icu_76_godot::BreakIterator::BreakIterator(BreakIterator *this, Locale *param_1, Locale *param_2) {
   long in_FS_OFFSET;
...
/* icu_76_godot::StringByteSink<icu_76_godot::CharString>::~StringByteSink() */void icu_76_godot::StringByteSink<icu_76_godot::CharString>::~StringByteSink(StringByteSink<icu_76_godot::CharString> *this) {
...
/* WARNING: Control flow encountered bad instruction data *//* icu_76_godot::StringByteSink<icu_76_godot::CharString>::~StringByteSink() */void icu_76_godot::StringByteSink<icu_76_godot::CharString>::~StringByteSink(StringByteSink<icu_76_godot::CharString> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

...
/* pv_png::png_decoder::adam7_pass_size(int, int, int) */undefined1  [16] __thiscallpv_png::png_decoder::adam7_pass_size(png_decoder *this, int param_1, int param_2, int param_3) {
   int iVar1;
   ulong uVar2;
   undefined4 in_register_00000014;
   ulong uVar3;

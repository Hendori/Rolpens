/* GodotBroadPhase3DBVH::_pair_callback(void*, unsigned int, GodotCollisionObject3D*, int, unsigned
   int, GodotCollisionObject3D*, int) */undefined8 GodotBroadPhase3DBVH::_pair_callback(void *param_1, uint param_2, GodotCollisionObject3D *param_3, int param_4, uint param_5, GodotCollisionObject3D *param_6, int param_7) {
   undefined8 uVar1;
...
/* GodotBroadPhase3DBVH::_unpair_callback(void*, unsigned int, GodotCollisionObject3D*, int,
   unsigned int, GodotCollisionObject3D*, int, void*) */void GodotBroadPhase3DBVH::_unpair_callback(void *param_1, uint param_2, GodotCollisionObject3D *param_3, int param_4, uint param_5, GodotCollisionObject3D *param_6, int param_7, void *param_8) {
...
/* GodotBroadPhase3DBVH::set_pair_callback(void* (*)(GodotCollisionObject3D*, int,
   GodotCollisionObject3D*, int, void*), void*) */void GodotBroadPhase3DBVH::set_pair_callback(GodotBroadPhase3DBVH *this, _func_void_ptr_GodotCollisionObject3D_ptr_int_GodotCollisionObject3D_ptr_int_void_ptr *param_1, void *param_2) {
   *(_func_void_ptr_GodotCollisionObject3D_ptr_int_GodotCollisionObject3D_ptr_int_void_ptr**)( this + 0x188 ) = param_1;
   *(void**)( this + 400 ) = param_2;
   return;
}
/* GodotBroadPhase3DBVH::set_unpair_callback(void (*)(GodotCollisionObject3D*, int,
   GodotCollisionObject3D*, int, void*, void*), void*) */void GodotBroadPhase3DBVH::set_unpair_callback(GodotBroadPhase3DBVH *this, _func_void_GodotCollisionObject3D_ptr_int_GodotCollisionObject3D_ptr_int_void_ptr_void_ptr *param_1, void *param_2) {
   *(_func_void_GodotCollisionObject3D_ptr_int_GodotCollisionObject3D_ptr_int_void_ptr_void_ptr**)( this + 0x198 ) = param_1;
...
/* LocalVector<BVH_Tree<GodotCollisionObject3D, 2, 2, 128,
   ...
   [clone .part.0] */void LocalVector<BVH_Tree<GodotCollisionObject3D,2,2,128,GodotBroadPhase3DBVH::UserPairTestFunction<GodotCollisionObject3D>,GodotBroadPhase3DBVH::UserCullTestFunction < GodotCollisionObject3D>,true,AABB,Vector3>::_cull_aabb_iterative(unsigned_int, BVH_Tree<GodotCollisionObject3D,2,2,128,GodotBroadPhase3DBVH::UserPairTestFunction<GodotCollisionObject3D>,GodotBroadPhase3DBVH::UserCullTestFunction<GodotCollisionObject3D>,true,AABB,Vector3>::CullParams &, bool)_err_print_error("resize", "./core/templates/local_vector.h", 0xa3, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0);_err_flush_stdout();/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException();( *pcVar1 )();}/* GodotBroadPhase3DBVH::get_subindex(unsigned int) const */undefined4 GodotBroadPhase3DBVH::get_subindex(GodotBroadPhase3DBVH *this, uint param_1) {
   code *pcVar1;
   uint uVar2;
   if (param_1 == 0) {
      _err_print_error("get_subindex", "modules/godot_physics_3d/godot_broad_phase_3d_bvh.cpp", 0x49, "Condition \"!p_id\" is true. Returning: 0", 0, 0);
      return 0;
   }
...
/* GodotBroadPhase3DBVH::is_static(unsigned int) const */undefined4 GodotBroadPhase3DBVH::is_static(GodotBroadPhase3DBVH *this, uint param_1) {
   int iVar1;
   code *pcVar2;
   uint uVar3;
   if (param_1 == 0) {
      _err_print_error("is_static", "modules/godot_physics_3d/godot_broad_phase_3d_bvh.cpp", 0x43, "Condition \"!p_id\" is true. Returning: false", 0, 0);
      return 0;
   }
...
/* GodotBroadPhase3DBVH::get_object(unsigned int) const */long GodotBroadPhase3DBVH::get_object(GodotBroadPhase3DBVH *this, uint param_1) {
   long lVar1;
   code *pcVar2;
   uint uVar3;
   if (param_1 == 0) {
      _err_print_error("get_object", "modules/godot_physics_3d/godot_broad_phase_3d_bvh.cpp", 0x3c, "Condition \"!p_id\" is true. Returning: nullptr", 0, 0);
      return 0;
   }
   ...
   if (uVar3 < *(uint*)( this + 0x60 )) {
      ...
      if (lVar1 == 0) {
         _err_print_error("get_object", "modules/godot_physics_3d/godot_broad_phase_3d_bvh.cpp", 0x3e, "Parameter \"it\" is null.", 0, 0);
      }
...
/* BVH_Manager<GodotCollisionObject3D, 2, true, 128,
   ...
   true>::_add_changed_item(BVHHandle, AABB const&, bool) [clone .isra.0] */void BVH_Manager<GodotCollisionObject3D,2,true,128,GodotBroadPhase3DBVH::UserPairTestFunction<GodotCollisionObject3D>,GodotBroadPhase3DBVH::UserCullTestFunction<GodotCollisionObject3D>,AABB,Vector3,true>::_add_changed_item(long param_1, uint param_2) {
   uint *puVar1;
   float fVar2;
   uint uVar3;
   code *pcVar4;
      ...
      if (param_2 < *(uint*)( param_1 + 0x30 )) {
         ...
         if (uVar8 < uVar3) {
            ...
            if (uVar8 < uVar3) {
               ...
               pfVar9 = (float*)( uVar14 * 0xe04 + 0x204 + (ulong)puVar1[1] * 0x18 + *(long*)( param_1 + 0xd8 ) );
               fVar2 = *pfVar9;
               fVar16 = (float)( (uint)pfVar9[3] ^ _LC20 );
               fVar5 = *pfVar9;
               fVar6 = pfVar9[1];
               fVar7 = pfVar9[2];
               *(ulong*)( pfVar13 + 4 ) = CONCAT44((float)( ( uint )(( ulong ) * (undefined8*)( pfVar9 + 4 ) >> 0x20) ^ _LC16._4_4_ ) - (float)( ( ulong ) * (undefined8*)( pfVar9 + 1 ) >> 0x20 ), (float)( ( uint ) * (undefined8*)( pfVar9 + 4 ) ^ (uint)_LC16 ) - (float)*(undefined8*)( pfVar9 + 1 ));
               *pfVar13 = fVar5;
               pfVar13[1] = fVar6;
               pfVar13[2] = fVar7;
   ...
   LAB_00100452:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar14, uVar15, "p_index", "count", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar4 = (code*)invalidInstructionException();
   ( *pcVar4 )();
}
/* WARNING: Removing unreachable block (ram,0x0010052c) *//* BVH_Tree<GodotCollisionObject3D, 2, 2, 128,
   GodotBroadPhase3DBVH::UserPairTestFunction<GodotCollisionObject3D>,
   GodotBroadPhase3DBVH::UserCullTestFunction<GodotCollisionObject3D>, true, AABB,
   Vector3>::_cull_point_iterative(unsigned int, BVH_Tree<GodotCollisionObject3D, 2, 2, 128,
   GodotBroadPhase3DBVH::UserPairTestFunction<GodotCollisionObject3D>,
   GodotBroadPhase3DBVH::UserCullTestFunction<GodotCollisionObject3D>, true, AABB,
   Vector3>::CullParams&) [clone .isra.0] */void __thiscall
...

{
  ...
  *(undefined ***)this = &PTR_create_00108480;
...

{
  ...
  do {
    ...
    *(undefined4 *)((long)puVar18 + 0x24) = 0;
    uVar26 = *puVar40;
    *(uint *)((long)puVar18 + 0x1c) = local_8c;
    *(undefined8 *)((long)puVar18 + 0xc) = uVar3;
    *(undefined8 *)((long)puVar18 + 0x14) = 0x7f7fffff;
    *puVar18 = 0x7f7fffff7f7fffff;
    *(undefined4 *)(puVar18 + 1) = 0x7f7fffff;
    puVar19 = (undefined4 *)
              PooledList<BVH_Tree<GodotCollisionObject3D,2,2,128,GodotBroadPhase3DBVH::UserPairTestFunction<GodotCollisionObject3D>,GodotBroadPhase3DBVH::UserCullTestFunction<GodotCollisionObject3D>,true,AABB,Vector3>::TLeaf,unsigned_int,true,false>
              ::request((PooledList<BVH_Tree<GodotCollisionObject3D,2,2,128,GodotBroadPhase3DBVH::UserPairTestFunction<GodotCollisionObject3D>,GodotBroadPhase3DBVH::UserCullTestFunction<GodotCollisionObject3D>,true,AABB,Vector3>::TLeaf,unsigned_int,true,false>
                         *)local_80,(uint *)local_88);
    puVar13 = local_a8;
    uVar15 = *(uint *)(this + 0x78);
    uVar22 = (ulong)uVar15;
    *puVar19 = 0;
    if (uVar15 <= uVar26) {
      uVar24 = (ulong)uVar26;
    ...
    puVar40 = puVar40 + 1;
    *(int *)(lVar23 + 0x18 + (ulong)uVar26 * 0x28) = -local_6c;
  } while (local_98 != puVar40);
  if (local_8c < uVar15) {
    uVar26 = *(uint *)(this + 0xa0);
    puVar18 = (undefined8 *)(lVar23 + (ulong)local_8c * 0x28);
    uVar15 = -*(int *)(puVar18 + 3);
    local_a8 = (uint *)CONCAT44(local_a8._4_4_,uVar15);
    if (uVar15 < uVar26) {
      local_d0 = (ulong)uVar15;
      lVar23 = *(long *)(this + 0xa8);
      *(undefined4 *)(puVar18 + 3) = 2;
      uVar34 = *puVar13;
      *(short *)(puVar18 + 4) = (short)uVar34;
      local_b0 = (ushort *)(lVar23 + local_d0 * 0xe04);
      uVar15 = puVar13[1];
      *(short *)((long)puVar18 + 0x22) = (short)uVar15;
      uVar14 = *local_b0;
      uVar26 = uVar14 + 1;
      local_98 = (uint *)CONCAT62(local_98._2_6_,uVar14);
      lVar23 = (long)(int)uVar26;
      uVar38 = (uint)uVar14;
      local_80 = (BVH_ABB *)CONCAT44(local_80._4_4_,uVar38);
      uVar36 = uVar26 * 2 + 0x17;
      puVar32 = auStack_e8;
      while (puVar29 != auStack_e8 + -(ulong)(uVar36 & 0x7f000)) {
        puVar28 = puVar32 + -0x1000;
        *(undefined8 *)(puVar32 + -8) = *(undefined8 *)(puVar32 + -8);
        puVar29 = puVar32 + -0x1000;
        puVar32 = puVar32 + -0x1000;
      }
      lVar8 = -(ulong)(uVar36 & 0xff0);
      puVar30 = puVar28 + lVar8;
      if ((ulong)(uVar36 & 0xff0) != 0) {
        *(undefined8 *)(puVar28 + -8) = *(undefined8 *)(puVar28 + -8);
      }
      puVar37 = (ushort *)((ulong)(puVar28 + lVar8 + 0xf) & 0xfffffffffffffff0);
      for (; puVar30 != puVar28 + (lVar8 - (ulong)(uVar36 & 0x7f000)); puVar30 = puVar30 + -0x1000)
      {
        *(undefined8 *)(puVar30 + -8) = *(undefined8 *)(puVar30 + -8);
      }
      lVar8 = -(ulong)(uVar36 & 0xff0);
      puVar31 = puVar30 + lVar8;
      if ((ulong)(uVar36 & 0xff0) != 0) {
        *(undefined8 *)(puVar30 + -8) = *(undefined8 *)(puVar30 + -8);
      }
      local_88 = (BVH_ABB *)((ulong)(puVar30 + lVar8 + 0xf) & 0xfffffffffffffff0);
      uVar22 = lVar23 * 0x18 + 0x17;
      for (; puVar31 != puVar30 + (lVar8 - (uVar22 & 0xfffffffffffff000));
          puVar31 = puVar31 + -0x1000) {
        *(undefined8 *)(puVar31 + -8) = *(undefined8 *)(puVar31 + -8);
      }
      uVar22 = (ulong)((uint)uVar22 & 0xff0);
      lVar8 = -uVar22;
      puVar33 = puVar31 + lVar8;
      puVar28 = puVar31 + lVar8;
      if (uVar22 != 0) {
        *(undefined8 *)(puVar31 + -8) = *(undefined8 *)(puVar31 + -8);
      }
      pvVar39 = (void *)((ulong)(puVar31 + lVar8 + 0xf) & 0xfffffffffffffff0);
      pBVar35 = local_a0;
      if (uVar38 != 0) {
        lVar20 = 1;
        *puVar37 = 0;
        if (1 < uVar38) {
          if ((uVar38 - 1 & 1) != 0) {
            puVar37[1] = 1;
            lVar20 = 2;
            if (uVar38 < 3) goto LAB_00106156;
          }
          do {
            puVar37[lVar20] = (ushort)lVar20;
            lVar1 = lVar20 + 1;
            lVar20 = lVar20 + 2;
            puVar37[lVar1] = (ushort)lVar1;
          } while ((int)lVar20 < (int)uVar38);
        }
LAB_00106156:
        local_c0 = local_a0;
        local_a0 = (BVH_ABB *)CONCAT44(local_a0._4_4_,uVar34);
        *(undefined8 *)(puVar31 + lVar8 + -8) = 0x1061a0;
        local_c8 = lVar23;
        local_b8 = (BVH_ABB *)this;
        local_90 = uVar15;
        memcpy(pvVar39,local_b0 + 0x102,(ulong)uVar14 * 0x18);
        lVar23 = local_c8;
        this = (BVH_Tree<GodotCollisionObject3D,2,2,128,GodotBroadPhase3DBVH::UserPairTestFunction<GodotCollisionObject3D>,GodotBroadPhase3DBVH::UserCullTestFunction<GodotCollisionObject3D>,true,AABB,Vector3>
                *)local_b8;
        pBVar35 = local_c0;
        uVar15 = local_90;
        uVar34 = (uint)local_a0;
      }
      uVar9 = *(undefined8 *)pBVar35;
      uVar10 = *(undefined8 *)(pBVar35 + 8);
      uVar3 = *(undefined8 *)((long)puVar18 + 0xc);
      uVar4 = *puVar18;
      local_60 = *(float *)(puVar18 + 1);
      uVar5 = *(undefined8 *)(pBVar35 + 0x10);
      puVar37[uVar14] = (ushort)local_98;
      fVar12 = _UNK_0010851c;
      fVar44 = _LC26;
      puVar2 = (undefined8 *)((long)pvVar39 + (ulong)uVar14 * 0x18);
      uVar38 = *(uint *)((long)puVar18 + 0x14);
      *puVar2 = uVar9;
      puVar2[1] = uVar10;
      uVar11 = _LC16._4_4_;
      uVar36 = (uint)_LC16;
      fVar45 = (float)(uVar38 ^ _LC20);
      puVar2[2] = uVar5;
      fVar45 = fVar45 - local_60;
      fVar43 = (float)uVar4;
      fVar41 = (float)((uint)uVar3 ^ uVar36) - fVar43;
      fVar46 = (float)((ulong)uVar4 >> 0x20);
      fVar42 = (float)((uint)((ulong)uVar3 >> 0x20) ^ uVar11) - fVar46;
      fVar46 = fVar12 * fVar42 + fVar46;
      local_68 = CONCAT44(fVar46,fVar44 * fVar41 + fVar43);
      local_60 = _LC26 * fVar45 + local_60;
      if (fVar42 <= fVar41) {
        uVar38 = (uint)(fVar41 < fVar45);
        local_58[0] = uVar38 * 2;
        if (fVar45 <= fVar42) {
          local_58[2] = 2;
          lVar20 = (long)local_58[0];
          local_58[1] = uVar38 * -2 + 1;
          fVar44 = *(float *)((long)&local_68 + lVar20 * 4);
        }
        else {
          local_58[2] = 1;
          lVar20 = (long)local_58[0];
          local_58[1] = uVar38 * -2 + 2;
          fVar44 = *(float *)((long)&local_68 + lVar20 * 4);
        }
      }
      else {
        ...
        local_58[0] = (int)lVar20;
        local_58[2] = (uint)(fVar45 <= fVar41) * 2;
        local_58[1] = 3 - (local_58[2] + (int)lVar20);
      }
      uVar38 = 0;
      iVar16 = 0;
      do {
        while( true ) {
          uVar14 = puVar37[iVar16];
          if (*(float *)((long)pvVar39 + lVar20 * 4 + (ulong)uVar14 * 0x18) <= fVar44) break;
          lVar23 = (long)(int)uVar38;
          uVar26 = uVar26 - 1;
          uVar38 = uVar38 + 1;
          *(ushort *)(local_88 + lVar23 * 2) = uVar14;
          lVar23 = (long)(int)uVar26;
          puVar37[iVar16] = puVar37[lVar23];
          if ((int)uVar26 <= iVar16) goto LAB_001062d8;
        }
        iVar16 = iVar16 + 1;
...
LAB_001062d8:
      ...
      local_a0 = (BVH_ABB *)CONCAT44(local_a0._4_4_,uVar36);
      if ((int)uVar36 < 0x20) {
        if (0 < (int)uVar38) {
          uVar26 = uVar26 + uVar38;
          local_98 = (uint *)CONCAT44(local_98._4_4_,uVar34);
          *(undefined8 *)(puVar31 + lVar8 + -8) = 0x106320;
          local_b8 = (BVH_ABB *)this;
          local_90 = uVar15;
          memcpy(puVar37 + lVar23,local_88,(ulong)uVar38 * 2);
          lVar23 = (long)(int)uVar26;
          this = (BVH_Tree<GodotCollisionObject3D,2,2,128,GodotBroadPhase3DBVH::UserPairTestFunction<GodotCollisionObject3D>,GodotBroadPhase3DBVH::UserCullTestFunction<GodotCollisionObject3D>,true,AABB,Vector3>
                  *)local_b8;
          uVar15 = local_90;
          uVar34 = (uint)local_98;
        }
        ...
        while( true ) {
          if ((int)uVar26 < 1) {
            ...
            do {
              uVar14 = *puVar21;
              puVar21 = puVar21 + 1;
              uVar38 = uVar38 + (*(float *)((long)&local_68 +
                                           (long)*(int *)((long)local_58 + lVar20) * 4) <
                                *(float *)((long)pvVar39 +
                                          (long)*(int *)((long)local_58 + lVar20) * 4 +
                                          (ulong)uVar14 * 0x18));
            } while (puVar21 != puVar37 + lVar23);
            uVar36 = uVar26 - uVar38;
          }
          if ((int)uVar36 < (int)uVar38) {
            uVar38 = uVar36;
          }
          *(uint *)((long)local_98 + lVar20) = uVar38;
          if (lVar20 == 8) break;
          lVar20 = 8;
        }
        bVar6 = (int)(uint)local_a0 < local_58[4];
        if (!bVar6) {
          local_58[4] = (uint)local_a0;
        }
        uVar22 = (ulong)bVar6;
        ...
        if ((0 < local_58[4]) && (iVar16 = local_58[uVar22], 0 < (int)uVar26)) {
          fVar44 = *(float *)((long)&local_68 + (long)iVar16 * 4);
          uVar38 = 0;
          iVar17 = 0;
          do {
            uVar14 = puVar37[iVar17];
            if (*(float *)((long)pvVar39 + (long)iVar16 * 4 + (ulong)uVar14 * 0x18) <= fVar44) {
              iVar17 = iVar17 + 1;
            }
            else {
              lVar23 = (long)(int)uVar38;
              ...
              uVar38 = uVar38 + 1;
              *(ushort *)(local_88 + lVar23 * 2) = uVar14;
              puVar37[iVar17] = puVar37[(int)uVar26];
            }
...
LAB_001063f4:
          ...
          local_90 = uVar38;
          while( true ) {
            uVar14 = puVar37[lVar23];
            if ((uint)local_80 == uVar14) {
              local_98 = (uint *)CONCAT44(local_98._4_4_,uVar34);
              this = (BVH_Tree<GodotCollisionObject3D,2,2,128,GodotBroadPhase3DBVH::UserPairTestFunction<GodotCollisionObject3D>,GodotBroadPhase3DBVH::UserCullTestFunction<GodotCollisionObject3D>,true,AABB,Vector3>
                      *)local_a0;
              uVar38 = local_90;
              ...
              uVar15 = *(uint *)(puVar21 + (ulong)uVar14 * 2 + 2);
              *(undefined8 *)(puVar31 + lVar8 + -8) = 0x106453;
              _node_add_item((BVH_Tree<GodotCollisionObject3D,2,2,128,GodotBroadPhase3DBVH::UserPairTestFunction<GodotCollisionObject3D>,GodotBroadPhase3DBVH::UserCullTestFunction<GodotCollisionObject3D>,true,AABB,Vector3>
                              *)local_a0,uVar34,uVar15,
                             (BVH_ABB *)(puVar21 + (ulong)uVar14 * 0xc + 0x102));
              this = (BVH_Tree<GodotCollisionObject3D,2,2,128,GodotBroadPhase3DBVH::UserPairTestFunction<GodotCollisionObject3D>,GodotBroadPhase3DBVH::UserCullTestFunction<GodotCollisionObject3D>,true,AABB,Vector3>
                      *)local_a0;
              uVar38 = local_90;
            }
            local_a0 = (BVH_ABB *)this;
            local_90 = uVar38;
            if ((int)uVar26 <= (int)lVar23 + 1) break;
            lVar23 = lVar23 + 1;
            uVar34 = (uint)*(ushort *)(puVar18 + 4);
          }
          uVar36 = (uint)local_98;
          if (0 < (int)uVar38) {
            uVar15 = (uint)*(ushort *)((long)puVar18 + 0x22);
            goto LAB_00106498;
          }
        }
        else {
          uVar36 = 0xffffffff;
          uVar38 = 1;
          if (0 < (int)uVar26) goto LAB_001063f4;
LAB_00106498:
          puVar37 = local_b0;
          uVar15 = uVar15 & 0xffff;
          pBVar35 = local_88 + (long)(int)uVar38 * 2;
          pBVar27 = local_88;
          local_88 = (BVH_ABB *)this;
          while( true ) {
            uVar14 = *(ushort *)pBVar27;
            this = (BVH_Tree<GodotCollisionObject3D,2,2,128,GodotBroadPhase3DBVH::UserPairTestFunction<GodotCollisionObject3D>,GodotBroadPhase3DBVH::UserCullTestFunction<GodotCollisionObject3D>,true,AABB,Vector3>
                    *)local_88;
            if ((uint)local_80 != uVar14) {
              uVar26 = *(uint *)(puVar37 + (ulong)uVar14 * 2 + 2);
              *(undefined8 *)(puVar31 + lVar8 + -8) = 0x1064e0;
              _node_add_item((BVH_Tree<GodotCollisionObject3D,2,2,128,GodotBroadPhase3DBVH::UserPairTestFunction<GodotCollisionObject3D>,GodotBroadPhase3DBVH::UserCullTestFunction<GodotCollisionObject3D>,true,AABB,Vector3>
                              *)local_88,uVar15,uVar26,
                             (BVH_ABB *)(puVar37 + (ulong)uVar14 * 0xc + 0x102));
              uVar15 = uVar36;
              this = (BVH_Tree<GodotCollisionObject3D,2,2,128,GodotBroadPhase3DBVH::UserPairTestFunction<GodotCollisionObject3D>,GodotBroadPhase3DBVH::UserCullTestFunction<GodotCollisionObject3D>,true,AABB,Vector3>
                      *)local_88;
            }
            uVar36 = uVar15;
            local_88 = (BVH_ABB *)this;
            if (pBVar27 + 2 == pBVar35) break;
            pBVar27 = pBVar27 + 2;
            uVar15 = (uint)*(ushort *)((long)puVar18 + 0x22);
          }
        }
        uVar26 = *(uint *)((BVH_ABB *)this + 0xa0);
        if ((uint)local_a8 < uVar26) goto LAB_00106516;
        *(undefined8 *)(puVar31 + lVar8 + -8) = 0;
        *(undefined8 *)(puVar31 + lVar8 + -0x10) = 0;
        *(undefined **)(puVar31 + lVar8 + -0x18) = &_LC9;
        *(char **)(puVar31 + lVar8 + -0x20) = "list.size()";
        *(undefined8 *)(puVar31 + lVar8 + -0x28) = 0x1067e6;
        local_80 = (BVH_ABB *)this;
        _err_print_index_error
                  ("free","./core/templates/pooled_list.h",0x7b,local_d0,(ulong)uVar26,"p_id",
                   *(char **)(puVar31 + lVar8 + -0x20),*(char **)(puVar31 + lVar8 + -0x18),
                   (bool)puVar31[lVar8 + -0x10],(bool)puVar31[lVar8 + -8]);
        this = (BVH_Tree<GodotCollisionObject3D,2,2,128,GodotBroadPhase3DBVH::UserPairTestFunction<GodotCollisionObject3D>,GodotBroadPhase3DBVH::UserCullTestFunction<GodotCollisionObject3D>,true,AABB,Vector3>
                *)local_80;
      }
      else {
LAB_001063c0:
        if (uVar38 == 0) goto LAB_001066c0;
        if (uVar26 == 0) {
          uVar38 = uVar38 - 1;
          uVar14 = *(ushort *)local_88;
          uVar25 = *(ushort *)(local_88 + (long)(int)uVar38 * 2);
          goto LAB_001063e3;
        }
        if (0 < (int)uVar26) goto LAB_001063f4;
        uVar36 = 0xffffffff;
        if (0 < (int)uVar38) goto LAB_00106498;
LAB_00106516:
        uVar26 = *(uint *)((BVH_ABB *)this + 0xb0);
        pvVar39 = *(void **)((BVH_ABB *)this + 0xb8);
        if (uVar26 == *(uint *)((BVH_ABB *)this + 0xb4)) {
          uVar22 = (ulong)(uVar26 * 2);
          if (uVar26 * 2 == 0) {
            uVar22 = 1;
          }
          *(int *)((BVH_ABB *)this + 0xb4) = (int)uVar22;
          *(undefined8 *)(puVar31 + lVar8 + -8) = 0x10683e;
          local_80 = (BVH_ABB *)this;
          pvVar39 = (void *)Memory::realloc_static(pvVar39,uVar22 * 4,false);
          *(void **)(local_80 + 0xb8) = pvVar39;
          if (pvVar39 == (void *)0x0) {
            *(undefined8 *)(puVar31 + lVar8 + -0x10) = 0;
            *(undefined8 *)(puVar31 + lVar8 + -0x18) = 0x1068ca;
            _err_print_error("push_back","./core/templates/local_vector.h",0x41,
                             "FATAL: Condition \"!data\" is true.","Out of memory",0);
            *(undefined8 *)(puVar31 + lVar8 + -0x18) = 0x1068cf;
            _err_flush_stdout();
                    /* WARNING: Does not return */
            pcVar7 = (code *)invalidInstructionException();
            (*pcVar7)();
          }
          uVar26 = *(uint *)(local_80 + 0xb0);
          this = (BVH_Tree<GodotCollisionObject3D,2,2,128,GodotBroadPhase3DBVH::UserPairTestFunction<GodotCollisionObject3D>,GodotBroadPhase3DBVH::UserCullTestFunction<GodotCollisionObject3D>,true,AABB,Vector3>
                  *)local_80;
        }
        *(uint *)((BVH_ABB *)this + 0xb0) = uVar26 + 1;
        *(uint *)((long)pvVar39 + (ulong)uVar26 * 4) = (uint)local_a8;
        if (*(int *)((BVH_ABB *)this + 0xc0) == 0) {
          *(undefined8 *)(puVar31 + lVar8 + -0x10) = 0;
          *(undefined8 *)(puVar31 + lVar8 + -0x18) = 0x106890;
          local_80 = (BVH_ABB *)this;
      ...
      uVar34 = *(uint *)(this + 0x78);
      lVar23 = 0;
      while( true ) {
        uVar14 = *(ushort *)((long)puVar18 + lVar23 + 0x20);
        uVar24 = (ulong)uVar14;
        if (uVar34 <= uVar14) break;
        uVar26 = *(uint *)(this + 0xa0);
        uVar15 = -*(int *)(*(long *)(this + 0x80) + uVar24 * 0x28 + 0x18);
        if (uVar26 <= uVar15) goto LAB_001060c8;
        puVar37 = (ushort *)((ulong)uVar15 * 0xe04 + *(long *)(this + 0xa8));
        uVar25 = *puVar37;
        if (uVar25 != 0) {
          uVar26 = *(uint *)this;
          uVar22 = (ulong)uVar26;
          lVar20 = 0;
          do {
            uVar15 = *(uint *)(puVar37 + lVar20 * 2 + 2);
            uVar24 = (ulong)uVar15;
            puVar32 = puVar31 + lVar8;
            if (uVar26 <= uVar15) goto LAB_00106083;
            puVar40 = (uint *)(*(long *)(this + 8) + uVar24 * 8);
            puVar40[1] = (uint)lVar20;
            lVar20 = lVar20 + 1;
            *puVar40 = (uint)uVar14;
          } while ((int)lVar20 < (int)(uint)uVar25);
        }
        if (lVar23 == 2) {
          *(undefined8 *)(puVar31 + lVar8 + -8) = 0x10670e;
          refit_upward(this,local_8c);
          if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
            *(undefined8 *)(puVar31 + lVar8 + -8) = 0x1068e3;
            __stack_chk_fail();
          }
          return uVar36;
        }
      ...
      *(undefined8 *)(puVar31 + lVar8 + -8) = 1;
      uVar22 = (ulong)uVar34;
      *(undefined8 *)(puVar31 + lVar8 + -0x10) = 0;
      *(undefined **)(puVar31 + lVar8 + -0x18) = &_LC9;
      *(char **)(puVar31 + lVar8 + -0x20) = "count";
      goto LAB_0010609e;
    }
LAB_001060c8:
    uVar22 = (ulong)uVar26;
    ...
    uVar24 = (ulong)local_8c;
    puVar32 = auStack_e8;
  }
LAB_00106083:
  *(undefined8 *)(puVar32 + -8) = 1;
  *(undefined8 *)(puVar32 + -0x10) = 0;
  *(undefined **)(puVar32 + -0x18) = &_LC9;
  *(char **)(puVar32 + -0x20) = "count";
  puVar28 = puVar32;
LAB_0010609e:
  *(undefined8 *)(puVar28 + -0x28) = 0x1060b6;
  _err_print_index_error
            ("operator[]","./core/templates/local_vector.h",0xb2,uVar24,uVar22,"p_index",
             *(char **)(puVar28 + -0x20),*(char **)(puVar28 + -0x18),(bool)puVar28[-0x10],
             (bool)puVar28[-8]);
  *(undefined8 *)(puVar28 + -8) = 0x1060bf;
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar7 = (code *)invalidInstructionException();
  (*pcVar7)();
  ...
  if (param_1 < *(uint *)(this + 0x78)) {
    do {
      ...
      if (iVar8 == 1) {
        ...
        uVar4 = *(ushort *)(lVar1 + 0x20);
        uVar7 = (ulong)uVar4;
        if ((uint)uVar10 <= (uint)uVar4) goto LAB_001069aa;
        uVar7 = (ulong)*(ushort *)(lVar1 + 0x22);
        pfVar2 = (float *)(lVar5 + (ulong)uVar4 * 0x28);
        if ((uint)uVar10 <= (uint)*(ushort *)(lVar1 + 0x22)) goto LAB_001069aa;
    ...
    if (uVar4 < *(uint *)(this + 0xa0)) {
      ...
      if (uVar2 == *(uint *)(this + 0xb4)) {
        ...
        *(void **)(this + 0xb8) = pvVar5;
        if (pvVar5 == (void *)0x0) goto LAB_00106e70;
        uVar2 = *(uint *)(this + 0xb0);
      }
...
LAB_001070a0:
    ...
    uVar6 = *(uint *)(this + 0x78);
    if (uVar6 <= param_2) goto LAB_0010702d;
      ...
      if (uVar6 < *(uint *)(this + 0xa0)) {
        ...
        if (uVar10 == *(uint *)(this + 0xb4)) {
          ...
          *(void **)(this + 0xb8) = pvVar7;
          if (pvVar7 == (void *)0x0) goto LAB_00107306;
          uVar10 = *(uint *)(this + 0xb0);
        }
...
LAB_00107176:
    ...
    uVar14 = (ulong)uVar10;
    if (uVar6 <= uVar10) goto LAB_0010702d;
...
LAB_00107246:
      ...
      if (*(int *)(lVar11 + 0x18) == 1) goto LAB_00107246;
      ...
      if (uVar14 < *(uint *)(this + 0xa0)) {
        ...
        *(uint *)(puVar13 + uVar16 * 2 + 2) = uVar6;
        if (uVar17 == 0) {
          ...
          uVar11 = uVar4;
          if (uVar4 <= uVar6) goto LAB_00107628;
      ...
      *(int *)(this + 200) = iVar5;
      ...
      if (uVar3 < uVar1) {
        ...
        *(uint *)((ulong)uVar3 * 0x20 + *(long *)(this + 0x30) + 0x18) = uVar2;
        if (uVar1 <= param_2) goto LAB_001076f7;
...
LAB_001077d3:
          ...
          if (uVar6 == *(uint *)(this + 0x14)) {
            ...
            *(void **)(this + 0x18) = pvVar8;
            if (pvVar8 == (void *)0x0) goto LAB_00107b50;
            uVar6 = *(uint *)(this + 0x10);
          }
          ...
          *(uint *)((long)pvVar8 + (ulong)uVar6 * 4) = param_2;
          ...
          if (param_2 < *(uint *)this) goto LAB_001077d3;
          _err_print_index_error
        ...
        if (((((fStack_3c < pfVar2[3]) || (fVar13 < pfVar2[4])) || (fVar14 < pfVar2[5])) ||
          ...
          *puVar1 = uVar6;
          ...
          if (cVar5 != '\0') {
            uVar7 = (ulong)*puVar1;
            uVar12 = (ulong)*(uint *)(this + 0x78);
            if (*(uint *)(this + 0x78) <= *puVar1) goto LAB_00107f7a;

/* hb_vector_size_t<unsigned long long, 64u> hb_bit_set_t::op_<._anon_134>(hb_vector_size_t<unsigned
   long long, 64u> const&, hb_vector_size_t<unsigned long long, 64u> const&) */void hb_bit_set_t::op_<__anon_134>(hb_bit_set_t *this, hb_vector_size_t_conflict *param_1, hb_vector_size_t_conflict *param_2) {
   ulong uVar1;
   ulong uVar2;
   long lVar3;
   long lVar4;
...
/* hb_vector_size_t<unsigned long long, 64u> hb_bit_set_t::op_<._anon_133>(hb_vector_size_t<unsigned
   long long, 64u> const&, hb_vector_size_t<unsigned long long, 64u> const&) */void hb_bit_set_t::op_<__anon_133>(hb_bit_set_t *this, hb_vector_size_t_conflict *param_1, hb_vector_size_t_conflict *param_2) {
   ulong uVar1;
   ulong uVar2;
   long lVar3;
   long lVar4;
...
/* hb_vector_size_t<unsigned long long, 64u> hb_bit_set_t::op_<._anon_135>(hb_vector_size_t<unsigned
   long long, 64u> const&, hb_vector_size_t<unsigned long long, 64u> const&) */void hb_bit_set_t::op_<__anon_135>(hb_bit_set_t *this, hb_vector_size_t_conflict *param_1, hb_vector_size_t_conflict *param_2) {
   ulong uVar1;
   ulong uVar2;
   long lVar3;
   long lVar4;
...
/* hb_vector_size_t<unsigned long long, 64u> hb_bit_set_t::op_<._anon_136>(hb_vector_size_t<unsigned
   long long, 64u> const&, hb_vector_size_t<unsigned long long, 64u> const&) */void hb_bit_set_t::op_<__anon_136>(hb_bit_set_t *this, hb_vector_size_t_conflict *param_1, hb_vector_size_t_conflict *param_2) {
...
/* hb_vector_size_t<unsigned long long, 64u> hb_bit_set_t::op_<._anon_137>(hb_vector_size_t<unsigned
   long long, 64u> const&, hb_vector_size_t<unsigned long long, 64u> const&) */void hb_bit_set_t::op_<__anon_137>(hb_bit_set_t *this, hb_vector_size_t_conflict *param_1, hb_vector_size_t_conflict *param_2) {
   hb_vector_size_t_conflict *phVar1;
   uint uVar2;
   uint uVar3;
   uint uVar4;
...
;
 ...
 while ( true );
   ...
   __mutex[1].__align = 0;
   *(undefined8*)( (long)__mutex + 0x30 ) = 0;
   LAB_00100213:pthread_mutex_destroy(__mutex);
   free(__mutex);
...
undefined1[16];hb_set_create(void) {
   ...
   if (auVar1._0_8_ != (undefined4*)0x0) {
      ...
      *(undefined1*)( auVar1._0_8_ + 4 ) = 1;
      ...
      auVar1._0_8_[6] = 0;
      for (int i = 0; i < 4; i++) {
         *(undefined8*)( auVar1._0_8_ + ( 2*i + 8 ) ) = 0;
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */bool hb_set_set_user_data(int *param_1, long param_2, long param_3, long param_4, int param_5) {
   uint uVar1;
   long lVar2;
   code *pcVar3;
   long lVar4;
...
;
 ...
 while ( uVar8 != uVar5 );
   ...
   if (uVar8 == 0) {
      ...
      if (__mutex[1].__data.__lock < 1) {
         ...
         uVar9 = 8;
         LAB_0010069c:plVar6 = (long*)realloc(plVar6, uVar9 * 0x18);
         if (plVar6 == (long*)0x0) {
 ...
 while ( uVar8 < uVar5 );
         ...
         LAB_00100708:uVar11 = __hb_CrapPool;
         _memmove = _malloc;
   ...
   LAB_00100663:*(uint*)( (long)__mutex + 0x2c ) = uVar5;
   plVar10 = plVar6 + uVar7 * 3;
   *plVar10 = param_2;
   plVar10[1] = param_3;
   plVar10[2] = param_4;
   LAB_0010067a:pthread_mutex_unlock(__mutex);
   LAB_001004b5:return -1 < __mutex[1].__data.__lock && plVar10 != (long*)0x0;
}
...
undefined4 *hb_set_copy(long param_1) {
   ...
   if (uVar7 < uVar12) {
      if (uVar12 < 0x20000000) {
         ...
         LAB_00100ae4:pvVar10 = realloc(pvVar10, (ulong)uVar12 << 3);
      ...
      if (uVar12<uVar7> > 2) {
         ...
         free(pvVar10);
         pvVar10 = (void*)0x0;
         LAB_00100af9:puVar11[8] = uVar12;
         uVar12 = *(uint*)( param_1 + 0x24 );
         *(void**)( puVar11 + 10 ) = pvVar10;
      }

      LAB_00100a67:lVar3 = *(long*)( param_1 + 0x28 );
      puVar11[9] = uVar12;
      if (uVar12 != 0) {
 ...
 while ( (ulong)uVar12 << 3 != lVar9 );
   ...
   LAB_00100a1a:uVar7 = puVar11[0xc];
   if ((int)uVar7 < 0) {
      uVar7 = ~uVar7;
      puVar11[0xc] = uVar7;
   }
   ...
   if (uVar7 < uVar12) {
      if (uVar12 < 0x38e38e4) {
         ...
         LAB_00100aad:pvVar10 = realloc(pvVar10, (ulong)uVar12 * 0x48);
         if (pvVar10 != (void*)0x0) {
            LAB_00100ac6:puVar11[0xc] = uVar12;
      ...
      if (uVar7 >> 2 <= uVar12) {
         LAB_0010098b:lVar3 = *(long*)( param_1 + 0x38 );
         ...
         if ((int)uVar13 != 0) {
            ...
            do {
               ...
               *(undefined8*)( lVar4 + lVar9 ) = *(undefined8*)( lVar3 + lVar9 );
               ...
               for (int i = 0; i < 3; i++) {
                  puVar1 = (undefined8*)( lVar3 + ( 16*i + 16 ) + lVar9 );
                  uVar5 = puVar1[1];
                  puVar2 = (undefined8*)( lVar4 + ( 16*i + 16 ) + lVar9 );
                  *puVar2 = *puVar1;
                  puVar2[1] = uVar5;
               }
 ...
 while ( uVar13 * 0x48 != lVar9 );
   ...
   puVar11[0xc] = ~uVar7;
   LAB_001009ed:if (*(char*)( puVar11 + 4 ) != '\0') {
...
bool hb_set_is_empty(long param_1) {
 ...
 while ( local_24 == uVar3 );
   ...
   LAB_00100bd3:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
byte hb_set_has(long param_1, uint param_2) {
   ...
   uint uVar8;
   uVar8 = param_2 >> 9;
   if (( *(uint*)( param_1 + 0x18 ) < *(uint*)( param_1 + 0x24 ) ) && ( puVar1 = (uint*)( *(long*)( param_1 + 0x28 ) + ( ulong ) * (uint*)( param_1 + 0x18 ) * 8 ) ),uVar8 == *puVar1) {
      lVar6 = *(long*)( param_1 + 0x38 ) + (ulong)puVar1[1] * 0x48;
      LAB_00100d27:if (lVar6 != 0) {
         return ( 1L << ( (byte)param_2 & 0x3f ) & *(ulong*)( lVar6 + 8 + ( ulong )(param_2 >> 6 & 7) * 8 ) ) != 0 ^ *(byte*)( param_1 + 0x40 );
      }
...
;
 ...
 while ( iVar7 <= iVar5 );
   ...
   LAB_00100cf5:return *(byte*)( param_1 + 0x40 );
}
void hb_set_add(long param_1, uint param_2) {
   ...
   if (*(char*)( param_1 + 0x40 ) == '\0') {
      if (( param_2 != 0xffffffff ) && ( *this == (hb_bit_set_t)0x1 )) {
         *(undefined4*)( param_1 + 0x14 ) = 0xffffffff;
         ...
         if (puVar2 != (undefined4*)0x0) {
            *(ulong*)( puVar2 + ( ulong )(param_2 >> 6 & 7) * 2 + 2 ) = *(ulong*)( puVar2 + ( ulong )(param_2 >> 6 & 7) * 2 + 2 ) | 1L << ( (byte)param_2 & 0x3f );
            *puVar2 = 0xffffffff;
         }
      ...
      if (puVar2 != (undefined4*)0x0) {
         ...
         *(ulong*)( puVar2 + ( ulong )(param_2 >> 6 & 7) * 2 + 2 ) = *(ulong*)( puVar2 + ( ulong )(param_2 >> 6 & 7) * 2 + 2 ) & ( -2L << bVar1 | 0xfffffffffffffffeU >> 0x40 - bVar1 );
         *puVar2 = 0xffffffff;
      }
      ...
      if (bVar1 == 0 && param_3 != 0) {
         *(undefined4*)( param_1 + 0x14 ) = 0xffffffff;
         ...
         while (true) {
            ...
            while (true) {
               *(ulong*)( puVar2 + ( ulong )(uVar4 >> 6 & 7) * 2 + 2 ) = *(ulong*)( puVar2 + ( ulong )(uVar4 >> 6 & 7) * 2 + 2 ) | 1L << ( (byte)uVar4 & 0x3f );
               *puVar2 = 0xffffffff;
               uVar5 = uVar4;
               LAB_00100f4b:param_3 = param_3 + -1;
               if (param_3 == 0) {
                  return;
               }
      ...
      do {
         ...
         do {
            ...
            if (( puVar2 != (undefined4*)0x0 ) && ( uVar5 != 0xffffffff )) {
               *(ulong*)( puVar2 + ( ulong )(uVar5 >> 6 & 7) * 2 + 2 ) = *(ulong*)( puVar2 + ( ulong )(uVar5 >> 6 & 7) * 2 + 2 ) | 1L << ( (byte)uVar5 & 0x3f );
               *puVar2 = 0xffffffff;
            }
...
void hb_set_add_range(long param_1, uint param_2, uint param_3) {
   ...
   if (( ( *(char*)( param_1 + 0x10 ) != '\0' ) && ( param_2 <= param_3 && param_2 != 0xffffffff ) ) && ( param_3 != 0xffffffff )) {
      this(hb_bit_set_t * )(param_1 + 0x10);
      uVar11 = param_3 >> 9;
      *(undefined4*)( param_1 + 0x14 ) = 0xffffffff;
      if (param_2 >> 9 == uVar11) {
         ...
         if (puVar6 != (undefined4*)0x0) {
            ...
            *(ulong*)( puVar6 + (ulong)uVar5 * 2 + 2 ) = -(1L << ((byte)param_2 & 0x3f)) | *(ulong*)( puVar6 + (ulong)uVar5 * 2 + 2 );
         ...
         if (param_2 >> 9 == uVar14) {
            ...
            if (puVar5 != (undefined4*)0x0) {
               ...
               if (puVar11 == puVar5 + uVar6 * 2 + 2) {
                  *(ulong*)( puVar5 + uVar10 * 2 + 2 ) = lVar13 - lVar9 | *(ulong*)( puVar5 + uVar10 * 2 + 2 );
               }
 else {
                  iVar3 = (int)( puVar11 + 2 );
            ...
            if (puVar5 != (undefined4*)0x0) {
               ...
               *(ulong*)( puVar5 + (ulong)uVar17 * 2 + 2 ) = -(1L << (bVar8 & 0x3f)) | *(ulong*)( puVar5 + (ulong)uVar17 * 2 + 2 );
 ...
 while ( uVar14 << 9 != uVar17 );
   ...
   *(undefined4*)( param_1 + 0x14 ) = 0xffffffff;
   ...
   if (param_3 + 1 == ( uVar14 + 1 ) * 0x200) {
      ...
      LAB_00101402:puVar5 = (undefined4*)hb_bit_set_t::page_for(phVar1, param_2, false);
      if (puVar5 != (undefined4*)0x0) {
         bVar8 = bVar8 & 0x3f;
   ...
   if (( ( (int)uVar16 < (int)uVar14 ) && ( uVar17 != uVar14 ) ) && ( puVar5 = (undefined4*)hb_bit_set_t::page_for(phVar1, param_3, false) ),puVar5 != (undefined4*)0x0) {
      uVar6 = ( ulong )(param_3 >> 6 & 7);
   ...
   LAB_001013d1:hb_bit_set_t::del_pages(phVar1, iVar12, uVar16);
   return;
}
undefined1 hb_set_is_equal(long param_1, long param_2) {
 ...
 while ( uVar6 == local_6c );
      ...
      local_68 = phVar8;
      LAB_00101b30:if ((uint)local_a0 != 0xffffffff) {
         do {
            phVar8 = local_68;
 ...
 while ( true );
   ...
   LAB_001017e1:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
uint hb_set_hash(long param_1) {
 ...
 while ( plVar8 != (long*)( piVar2 + 0x12 ) );
         ...
         LAB_00101f13:puVar4 = (ulong*)( piVar2 + 2 );
...
undefined1 hb_set_is_subset(long param_1, long param_2) {
   ...
   if (*(char*)( param_1 + 0x40 ) == *(char*)( param_2 + 0x40 )) {
      if (*(char*)( param_1 + 0x40 ) == '\0') {
         uVar5 = hb_bit_set_t::is_subset((hb_bit_set_t*)( param_1 + 0x10 ), (hb_bit_set_t*)( param_2 + 0x10 ));
      }
 else {
         uVar5 = hb_bit_set_t::is_subset((hb_bit_set_t*)( param_2 + 0x10 ), (hb_bit_set_t*)( param_1 + 0x10 ));
      }
 ...
 while ( puVar2 != puVar11 );
      ...
      while (uVar9 != 0xffffffff) {
         uVar14 = uVar9 >> 9;
         if (( *(uint*)( local_48 + 0x14 ) <= *(uint*)( local_48 + 8 ) ) || ( puVar1 = (uint*)( *(long*)( local_48 + 0x18 ) + ( ulong ) * (uint*)( local_48 + 8 ) * 8 ) ),uVar14 != *puVar1) {
...
;
            ...
            LAB_00102165:uVar5 = 0;
            goto LAB_00102056;
         }

         lVar13 = *(long*)( local_48 + 0x28 ) + (ulong)puVar1[1] * 0x48;
         LAB_00102193:if (( lVar13 == 0 ) || ( ( 1L << ( (byte)uVar9 & 0x3f ) & *(ulong*)( lVar13 + 8 + ( ulong )(uVar9 >> 6 & 7) * 8 ) ) == 0 )) goto LAB_00102165;
         hb_bit_set_t::next((hb_bit_set_t*)( param_1 + 0x10 ), (uint*)&local_50);
         if (local_50._4_4_ != 0) {
...
;
   ...
   LAB_00102056:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar5;
   }
...
void hb_set_set(long param_1, long param_2) {
   ...
   cVar6 = hb_bit_set_t::resize((hb_bit_set_t*)( param_1 + 0x10 ), *(uint*)( param_2 + 0x34 ), false, false);
   ...
   *(undefined4*)( param_1 + 0x24 ) = 0;
   ...
   if (uVar7 < uVar10) {
      if (uVar10 < 0x20000000) {
         ...
         LAB_00102484:pvVar9 = realloc(pvVar9, (ulong)uVar10 << 3);
      ...
      *(uint*)( param_1 + 0x20 ) = ~uVar7;
      ...
      if (uVar10<uVar7> > 2) {
         ...
         free(pvVar9);
         pvVar9 = (void*)0x0;
         LAB_00102499:*(uint*)( param_1 + 0x20 ) = uVar10;
         uVar10 = *(uint*)( param_2 + 0x24 );
         *(void**)( param_1 + 0x28 ) = pvVar9;
      }

      LAB_00102407:lVar3 = *(long*)( param_2 + 0x28 );
 ...
 while ( (ulong)uVar10 << 3 != lVar8 );
   ...
   LAB_001023b2:uVar7 = *(uint*)( param_1 + 0x30 );
   if ((int)uVar7 < 0) {
      uVar7 = ~uVar7;
   ...
   *(undefined4*)( param_1 + 0x34 ) = 0;
   ...
   if (uVar7 < uVar10) {
      if (uVar10 < 0x38e38e4) {
         ...
         LAB_0010244d:pvVar9 = realloc(pvVar9, (ulong)uVar10 * 0x48);
         if (pvVar9 != (void*)0x0) {
            LAB_00102466:*(uint*)( param_1 + 0x30 ) = uVar10;
      ...
      if (uVar7 >> 2 <= uVar10) {
         LAB_0010232e:lVar3 = *(long*)( param_2 + 0x38 );
 ...
 while ( lVar8 != uVar11 * 0x48 );
   ...
   *(uint*)( param_1 + 0x30 ) = ~uVar7;
   LAB_0010238d:if (*(char*)( param_1 + 0x10 ) != '\0') {
...
void hb_set_symmetric_difference(long param_1, long param_2) {
   hb_bit_set_t::process_((hb_bit_set_t*)( param_1 + 0x10 ), hb_bit_set_t::op_<__anon_135>, true, true, (hb_bit_set_t*)( param_2 + 0x10 ));
   if (*(char*)( param_1 + 0x10 ) != '\0') {
...
undefined8 hb_set_next_range(long param_1, uint *param_2, uint *param_3) {
   ...
   if (*(char*)( param_1 + 0x40 ) == '\0') {
      ...
      if (cVar1 == '\0') {
         LAB_00102df8:*param_2 = 0xffffffff;
         uVar3 = 0;
         *param_3 = 0xffffffff;
         goto LAB_00102d61;
      }
 ...
 while ( local_34 == uVar4 );
   ...
   uVar3 = 1;
   LAB_00102d61:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 hb_set_previous_range(long param_1, uint *param_2, uint *param_3) {
   ...
   if (*(char*)( param_1 + 0x40 ) == '\0') {
      ...
      if (cVar1 == '\0') {
         LAB_00102f60:*param_2 = 0xffffffff;
         uVar2 = 0;
         *param_3 = 0xffffffff;
         goto LAB_00102ec1;
      }
      ...
      *param_2 = local_34;
      *param_3 = local_34;
      while (( cVar1 = hb_bit_set_t::previous((hb_bit_set_t*)( param_1 + 0x10 ), &local_34) ),cVar1 != '\0' && ( *param_2 - 1 == local_34 )) {
         *param_2 = *param_2 - 1;
      }
;
   }
 ...
 while ( uVar4 == local_34 );
   ...
   uVar2 = 1;
   LAB_00102ec1:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* hb_bit_set_t::resize(unsigned int, bool, bool) */hb_bit_set_t hb_bit_set_t::resize(hb_bit_set_t *this, uint param_1, bool param_2, bool param_3) {
 ...
 while ( uVar8 < param_1 );
      ...
      LAB_001030f7:*(uint*)( this + 0x20 ) = ~uVar5;
      goto LAB_001030fc;
   }
   ...
   if (uVar5 == 0) {
      param_1 = 1;
      uVar8 = 1;
      LAB_00103289:pvVar2 = *(void**)( this + 0x28 );
      param_3 = (bool)hVar1;
      LAB_00103290:pvVar2 = realloc(pvVar2, (ulong)uVar8 * 0x48);
      if (pvVar2 == (void*)0x0) {
         uVar5 = *(uint*)( this + 0x20 );
         if (uVar5 < uVar8) goto LAB_001030f7;
      }
 else {
         LAB_001032ac:*(void**)( this + 0x28 ) = pvVar2;
   ...
   LAB_00103043:if (( (uint)uVar7 < param_1 ) && ( param_2 )) {
 ...
 while ( uVar5 < param_1 );
      ...
      LAB_0010310f:if (( (uint)uVar6 < param_1 ) && ( param_2 )) {
 ...
 while ( uVar8 < uVar4 );
      ...
      LAB_001031b4:uVar8 = *(uint*)( this + 0x24 );
   }
 else {
      LAB_001031f6:uVar8 = *(uint*)( this + 0x24 );
      uVar4 = (uint)uVar6;
      if (uVar4 <= uVar8) {
         uVar6 = (ulong)uVar8;
      }
      ...
      uVar9 = (uint)uVar6;
      if (uVar5 < uVar9) {
         LAB_00103180:if (0x38e38e3 < (uint)uVar6) goto LAB_001030f7;
         pvVar2 = *(void**)( this + 0x28 );
         LAB_00103191:uVar8 = (uint)uVar6;
         ...
         if (pvVar2 == (void*)0x0) {
            ...
            LAB_001031ad:*(void**)( this + 0x28 ) = pvVar2;
            *(uint*)( this + 0x20 ) = uVar8;
         }
   ...
   *(uint*)( this + 0x24 ) = uVar4;
   LAB_001030fc:*this = (hb_bit_set_t)0x0;
   return (hb_bit_set_t)0x0;
}
/* hb_bit_set_t::is_equal(hb_bit_set_t const&) const */undefined8 hb_bit_set_t::is_equal(hb_bit_set_t *this, hb_bit_set_t *param_1) {
   int *piVar1;
   int *piVar2;
   uint uVar3;
   uint uVar4;
   ...
   int *piVar10;
   int *piVar11;
   if (( ( *(int*)( this + 4 ) != -1 ) && ( *(int*)( param_1 + 4 ) != -1 ) ) && ( *(int*)( this + 4 ) != *(int*)( param_1 + 4 ) )) {
      return 0;
   }
 ...
 while ( plVar5 != (long*)( piVar2 + 0x12 ) );
            LAB_001034e7:uVar7 = uVar7 + 1;
         }
 else {
            if (*piVar2 == 0) goto LAB_001034e7;
            LAB_00103474:piVar11 = (int*)( *(long*)( param_1 + 0x18 ) + uVar9 * 8 );
 ...
 while ( plVar5 != (long*)( piVar1 + 0x12 ) );
               ...
               LAB_00103593:if (*(uint*)( this + 0x14 ) <= uVar7) {
 ...
 while ( *(long*)( param_1 + 0x18 ) + 8 + ( ( ulong )(( uVar4 - 1 ) - uVar8) + (ulong)uVar8 ) * 8 != lVar6 );
   }

   return 1;
}
/* hb_bit_set_t::is_subset(hb_bit_set_t const&) const */undefined8 hb_bit_set_t::is_subset(hb_bit_set_t *this, hb_bit_set_t *param_1) {
   uint *puVar1;
   int *piVar2;
   uint uVar3;
   ulong *puVar4;
 ...
 while ( puVar4 != &local_70 );
               ...
               local_68[0] = *puVar4;
               for (int i = 0; i < 8; i++) {
                  local_68[( i + 1 )] = puVar4[( i + 1 )];
               }

               LAB_0010377d:lVar10 = 8;
               do {
                  if (( ~*(ulong *)((long)local_68 + lVar10) & *(ulong*)( (long)local_b8 + lVar10 ) ) != 0) goto LAB_00103870;
                  lVar10 = lVar10 + 8;
               }
 while ( lVar10 != 0x48 );
               ...
               local_68[6] = puVar4[6];
               local_68[7] = puVar4[7];
               if (( (uint)local_b8[0] == 0xffffffff ) || ( (uint)local_b8[0] <= ( uint ) * puVar4 )) goto LAB_0010377d;
               goto LAB_00103870;
            }
 ...
 while ( (uint)uVar8 < uVar3 );
      ...
      uVar7 = (uint)uVar8;
      while (uVar7 < uVar3) {
         piVar2 = (int*)( *(long*)( this + 0x28 ) + ( ulong ) * (uint*)( *(long*)( this + 0x18 ) + 4 + lVar11 ) * 0x48 );
         if (*piVar2 == -1) {
      ...
      do {
         ...
         if (uVar5 < *(uint*)( param_1 + 4 )) {
            ...
            if (*__s != 0xffffffff) {
               puVar12 = __s;
               if (uVar11 < uVar5) {
                  LAB_001039a7:lVar3 = *(long*)( this + 0x28 );
               ...
               LAB_001039ec:if ((uint)uVar8 < *(uint*)( this + 0x14 )) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* hb_bit_set_t::del_pages(int, int) */void hb_bit_set_t::del_pages(hb_bit_set_t *this, int param_1, int param_2) {
   ...
   if (param_1 <= param_2) {
      ...
      if (iVar8 < 1) {
         ...
         LAB_00103b15:piVar1 = *(int**)( this + 0x18 );
         uVar7 = 0;
         piVar3 = piVar1;
         do {
            while (true) {
...
;
 ...
 while ( piVar1 + (ulong)uVar5 * 2 != piVar3 );
         LAB_00103b6a:compact(this, (hb_vector_t*)local_48, uVar6);
         resize(this, uVar6, true, false);
         if (iVar8 != 0) {
            LAB_00103b93:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
               free(local_40);
               return;
            }
   ...
   LAB_00103c9c:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* hb_bit_set_t::process_(hb_vector_size_t<unsigned long long, 64u> (*)(hb_vector_size_t<unsigned
   long long, 64u> const&, hb_vector_size_t<unsigned long long, 64u> const&), bool, bool,
   hb_bit_set_t const&) */void hb_bit_set_t::process_(hb_bit_set_t *this, _func_hb_vector_size_t_hb_vector_size_t_ptr_hb_vector_size_t_ptr *param_1, bool param_2, bool param_3, hb_bit_set_t *param_4) {
   hb_bit_set_t hVar1;
   uint uVar2;
   long lVar3;
   long lVar4;
   ...
   hVar1 = *this;
   if (hVar1 == (hb_bit_set_t)0x0) {
      LAB_00104100:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
      ...
      *(undefined4*)( this + 4 ) = 0xffffffff;
      ...
      if (param_2) {
         ...
         if (( uVar9 == 0 ) || ( local_a0 = !(bool)hVar27 )) {
            uVar14 = 0;
            local_a0 = 0;
            uVar21 = uVar9;
         }
 else {
            LAB_00103d47:uVar17 = *(uint*)( this + 0x14 );
 ...
 while ( ( uVar8 < uVar9 ) && ( uVar14 < uVar15 ) );
         ...
         LAB_00103e30:uVar22 = (ulong)uVar21;
               ...
               do {
                  ...
                  if (*puVar19 == uVar2) {
                     ...
                     *(undefined8*)( lVar20 + uVar22 * 8 ) = *(undefined8*)puVar19;
                     ( *param_1 )((hb_vector_size_t_conflict*)&local_88, (hb_vector_size_t_conflict*)( *(long*)( this + 0x28 ) + 8 + (ulong)puVar19[1] * 0x48 ), (hb_vector_size_t_conflict*)( *(long*)( param_4 + 0x28 ) + 8 + (ulong)puVar11[1] * 0x48 ));
                     lVar20 = *(long*)( this + 0x18 );
                     puVar12 = (undefined4*)( *(long*)( this + 0x28 ) + ( ulong ) * (uint*)( lVar20 + 4 + uVar22 * 8 ) * 0x48 );
...
/* hb_bit_set_t::next(unsigned int*) const */undefined8 hb_bit_set_t::next(hb_bit_set_t *this, uint *param_1) {
 ...
 while ( uVar3 != uVar8 );
   ...
   if (uVar9 < uVar2) {
      ...
      LAB_0010430a:uVar2 = uVar3 + 1 & 0x1ff;
      if (uVar2 != 0) {
         uVar4 = ( ulong )(uVar2 >> 6);
      ...
      if ((int)( uVar2 - 1 ) < 0) {
         ...
         do {
            while (true) {
               ...
               uVar9 = uVar10;
               if (( uVar16 == uVar3 ) || ( uVar9 = iVar12 < (int)uVar9 )) goto LAB_001044db;
            }
;
            iVar12 = uVar10 - 1;
         }
 while ( (int)uVar9 <= iVar12 );
      ...
      LAB_001044db:if (uVar2 <= uVar9) goto LAB_001043c8;
      LAB_001044e4:*(uint*)( this + 8 ) = uVar9;
      puVar13 = (uint*)( lVar5 + (ulong)uVar9 * 8 );
      lVar14 = *(long*)( this + 0x28 );
      if (*puVar13 == uVar16) {
         uVar3 = *param_1;
 ...
 while ( uVar9 != *(uint*)( this + 0x14 ) );
   ...
   LAB_001043c8:*param_1 = 0xffffffff;
   return 0;
   LAB_00104487:uVar4 = *(ulong*)( piVar11 + uVar8 * 2 + 2 );
   if (uVar4 != 0) {
      iVar12 = 0;
      ...
      uVar8 = (ulong)uVar3;
      iVar12 = uVar3 + iVar12;
      LAB_0010449f:uVar3 = iVar12 + *piVar15 * 0x200;
...
/* hb_bit_set_t::previous(unsigned int*) const */undefined4 hb_bit_set_t::previous(hb_bit_set_t *this, uint *param_1) {
 ...
 while ( uVar5 != 0xffffffff );
   ...
   if (iVar14 < 0) {
      ...
      uVar9 = 0;
      puVar15 = puVar1;
      LAB_0010461d:puVar12 = &_hb_NullPool;
...
;
      ...
      LAB_001047c1:*param_1 = 0xffffffff;
   }
 else {
      uVar9 = 0;
      do {
         while (true) {
            ...
            uVar9 = uVar3;
            if (( uVar11 == puVar1[(ulong)uVar3 * 2] ) || ( uVar9 = iVar14 < (int)uVar9 )) goto joined_r0x001046f5;
         }
;
         iVar14 = uVar3 - 1;
      }
 while ( (int)uVar9 <= iVar14 );
      joined_r0x001046f5:if (( uVar9 < uVar16 ) && ( puVar15 = puVar1 + (ulong)uVar9 * 2 ),puVar1[(ulong)uVar9 * 2] == uVar11) goto LAB_0010461d;
   }

   if (-1 < (int)( uVar9 - 1 )) {
      lVar6 = 7;
      LAB_001045d0:uVar13 = *(ulong*)( *(long*)( this + 0x28 ) + ( ulong )(puVar1 + ( ulong )(uVar9 - 1) * 2)[1] * 0x48 + 8 + lVar6 * 8 );
   ...
   LAB_001046e8:*param_1 = 0xffffffff;
   return 0;
   code_r0x001045da:bVar18 = lVar6 == 0;
   lVar6 = lVar6 + -1;
   if (bVar18) goto code_r0x001045e0;
   goto LAB_001045d0;
   code_r0x001045e0:iVar14 = 0;
   LAB_001045e2:uVar5 = puVar1[( ulong )(uVar9 - 1) * 2] * 0x200 + iVar14;
   uVar4 = 1;
   goto LAB_001045ef;
   while (bVar18 = lVar6 != 0,lVar6 = lVar6 + -1,bVar18) {
      LAB_00104796:uVar13 = *(ulong*)( piVar10 + lVar6 * 2 + 2 );
      if (uVar13 != 0) {
         lVar2 = 0x3f;
         if (uVar13 != 0) {
            for (; uVar13 >> lVar2 == 0; lVar2 = lVar2 + -1) {}
...
;
   LAB_001046d9:uVar4 = 1;
   LAB_001045ef:*param_1 = uVar5;
   return uVar4;
}
/* hb_bit_set_t::next_many(unsigned int, unsigned int*, unsigned int) const */uint hb_bit_set_t::next_many(hb_bit_set_t *this, uint param_1, uint *param_2, uint param_3) {
   ulong uVar1;
   uint uVar2;
   ulong uVar3;
   uint uVar4;
 ...
 while ( ( uVar2 < 0x40 ) && ( puVar11 = uVar6 < uVar9 ) );
            uVar7 = (int)uVar3 + 1;
            uVar3 = (ulong)uVar7;
            uVar2 = 0;
...
/* hb_bit_set_t::next_many_inverted(unsigned int, unsigned int*, unsigned int) const */uint hb_bit_set_t::next_many_inverted(hb_bit_set_t *this, uint param_1, uint *param_2, uint param_3) {
   ulong uVar1;
   uint uVar2;
   uint uVar3;
   uint *puVar4;
...
;
 ...
 while ( ( uVar3 + 1 < 0x40 ) && ( uVar8 = bVar14 ) );
            uVar7 = uVar7 + 1;
            uVar8 = 0;
...
;
 ...
 while ( uVar3 != 0 );
      if (uVar2 == 0xffffffff) {
         LAB_00104b43:param_3 = param_3 + ( uVar6 - uVar5 );
      }
   ...
   LAB_00104c8c:if (param_2) {
      ...
      if (cVar6 != '\0') {
         ...
         *(ulong*)( *(long*)( this + 0x18 ) + (ulong)uVar8 * 8 ) = CONCAT44(uVar4, uVar9);
         uVar7 = uVar8;
         LAB_00104d25:*(uint*)( this + 8 ) = uVar7;
...
/* hb_bit_set_t::del_range(unsigned int, unsigned int) */void hb_bit_set_t::del_range(hb_bit_set_t *this, uint param_1, uint param_2) {
   ...
   *(undefined4*)( this + 4 ) = 0xffffffff;
   ...
   if (param_2 + 1 == ( uVar14 + 1 ) * 0x200) {
      ...
      uVar8 = uVar14;
      if (( iVar11 <= (int)uVar4 ) || ( puVar5 = (undefined4*)page_for(this, param_1, false) ),puVar5 == (undefined4*)0x0) goto LAB_00104e9d;
      LAB_00104f07:bVar7 = (byte)param_1 & 0x3f;
      ...
      *puVar5 = 0xffffffff;
      ...
      if (( (int)uVar4 < iVar11 ) && ( puVar5 = (undefined4*)page_for(this, param_1, false) ),puVar5 != (undefined4*)0x0) goto LAB_00104f07;
   }
   ...
   LAB_00104e9d:del_pages(this, iVar11, uVar8);
   return;
}

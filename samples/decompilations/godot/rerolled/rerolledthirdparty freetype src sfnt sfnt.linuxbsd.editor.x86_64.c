         ...
         if (uVar5 == 0) {
            ...
            if (uVar14 < uVar13) {
               ...
               do {
                  ...
                  puVar1 = puVar9 + 1;
                  puVar9 = puVar9 + 2;
                  if (( CONCAT11(uVar2, *puVar1) != 0 ) && ( uVar3 = uVar3 != 0 )) goto LAB_0010053c;
 ...
 while ( uVar11 <= uVar3 );
         ...
         if (puVar10 <= (undefined1*)( lVar5 + lVar6 )) {
            do {
               ...
               puVar1 = puVar10 + 1;
               puVar10 = puVar10 + 2;
               if (( CONCAT11(uVar2, *puVar1) != 0 ) && ( uVar8 = uVar8 != 0 )) {
                  *(uint*)( param_1 + 5 ) = uVar11;
                  *(uint*)( (long)param_1 + 0x2c ) = uVar8;
                  return;
               }
...
;
 ...
 while ( uVar7 < uVar4 );
   ...
   if (( param_3 != 0 ) && ( ( uVar8 <= uVar6 || ( uVar5 = uVar2 != uVar5 ) ) )) {
      *(undefined1*)( param_1 + 5 ) = 1;
      param_1[6] = (ulong)uVar8;
      param_1[8] = (ulong)uVar5;
...
;
 ...
 while ( uVar7 < uVar6 );
   ...
   if (( param_3 != 0 ) && ( ( uVar8 <= uVar5 || ( uVar4 = uVar3 != uVar4 ) ) )) {
      *(undefined1*)( param_1 + 5 ) = 1;
      param_1[6] = (ulong)uVar8;
      param_1[8] = (ulong)uVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int sfnt_init_face(ulong param_1, ulong *param_2, uint param_3) {
 ...
 while ( (int)uVar14 < (int)(uint)local_b0 );
                        ...
                        if (local_b0 == 0) {
                           ...
                           do {
                              lVar29 = *plVar23;
                              if (( ( *(ulong*)( lVar29 + 8 ) != uVar14 ) || ( uVar1 = local_b8 < uVar1 ) ) || ( ( local_b8 - uVar1 < uVar14 || ( ( ( uVar2 = *(ulong*)( lVar29 + 0x18 ) ),local_a8 < uVar2 || ( local_a8 - uVar2 < uVar27 ) ) || ( uVar2 < uVar1 ) ) ) )) goto LAB_0010f5bc;
                              plVar23 = plVar23 + 1;

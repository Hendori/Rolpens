/* load_texel_f32(void const*, int) */undefined8 load_texel_f32(void *param_1, int param_2) {
   return *(undefined8*)( (long)param_1 + (long)param_2 * 4 );
}
/* swz_texel_skip(vfloat4, astcenc_swizzle const&) */void swz_texel_skip(void) {
   return;
}
/* swz_texel(vfloat4, astcenc_swizzle const&) */void swz_texel(undefined4 param_1, int *param_2) {
   long in_FS_OFFSET;
...
/* encode_texel_unorm(vfloat4, vmask4) */undefined8 encode_texel_unorm(undefined8 param_1) {
   return CONCAT44((float)( (ulong)param_1 >> 0x20 ) * _LC2, (float)param_1 * _LC2);
}
/* load_texel_u8(void const*, int) */undefined8 load_texel_u8(void *param_1, int param_2) {
   uint uVar1;
...
/* load_texel_f16(void const*, int) */void load_texel_f16(void *param_1, int param_2) {
   undefined8 uVar1;
   uVar1 = *(undefined8*)( (long)param_1 + (long)param_2 * 2 );
   for (int i = 0; i < 3; i++) {
      sf16_to_float(( ushort )((ulong)uVar1 >> ( -16*i + 48 )));
   }

   sf16_to_float((ushort)uVar1);
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* encode_texel_lns(vfloat4, vmask4) */ulong encode_texel_lns(undefined8 param_1, undefined8 param_2) {
   float fVar1;
   float fVar2;
   uint uVar3;
   float fVar4;
   ...
   fVar4 = (float)( ( uint )(_LC20 * fVar1) & uVar8 | ~uVar8 & ( uint )(( (float)( _LC13 & (uint)fVar1 | _LC57 ) + _LC16 ) * _LC18) );
   fVar5 = (float)( ( uint )(_LC20 * fVar2) & uVar9 | ~uVar9 & ( uint )(( (float)( _LC13 & (uint)fVar2 | _UNK_00101804 ) + _LC16 ) * _LC18) );
   return CONCAT44(~(-(uint)(_LC7 < fVar2) ^ 0xffffffff) & ( -(uint)(_LC9 <= fVar2) & (uint)_LC2 | ~-(uint)(_LC9 <= fVar2) & ( uint )((float)(int)( ~uVar9 & uVar7 + _UNK_00101814 ) * _LC35 + (float)( -(uint)(fVar5 < _LC23) & ( uint )(_LC33 * fVar5) | ~-(uint)(fVar5 < _LC23) & ( -(uint)(fVar5 <= _LC25) & ( uint )(_LC31 + fVar5) | ~-(uint)(fVar5 <= _LC25) & ( uint )(( _LC27 + fVar5 ) * _LC29) ) ) + _LC0._4_4_) ) & uVar3, ~(-(uint)(_LC7 < fVar1) ^ 0xffffffff) & ( -(uint)(_LC9 <= fVar1) & (uint)_LC2 | ~-(uint)(_LC9 <= fVar1) & ( uint )((float)(int)( ~uVar8 & uVar6 + __LC21 ) * _LC35 + (float)( -(uint)(fVar4 < _LC23) & ( uint )(_LC33 * fVar4) | ~-(uint)(fVar4 < _LC23) & ( -(uint)(fVar4 <= _LC25) & ( uint )(_LC31 + fVar4) | ~-(uint)(fVar4 <= _LC25) & ( uint )(( _LC27 + fVar4 ) * _LC29) ) ) + _LC0._4_4_) ) & (uint)param_2) | CONCAT44(~uVar3 & ( uint )(_LC2 * fVar2), ~(uint)param_2 & ( uint )(_LC2 * fVar1));
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* load_image_block(astcenc_profile, astcenc_image const&, image_block&, block_size_descriptor
   const&, unsigned int, unsigned int, unsigned int, astcenc_swizzle const&) */void load_image_block(int param_1, int *param_2, float *param_3, byte *param_4, float param_5, float param_6, float param_7, int *param_8) {
   undefined8 uVar1;
   bool bVar2;
   undefined1 auVar3[16];
   ushort uVar4;
   ...
   if (( param_2[3] != 1 ) && ( pcVar20 = param_2[3] != 2 )) {
 ...
 while ( uVar13 < param_4[2] );
   ...
   if (bVar2) {
      ...
      uVar25 = ( auVar35._0_4_ >> 0xb ) << 10 | ( -(uint)(iVar12 < __LC45) & iVar12 * _LC44 | ~-(uint)(iVar12 < __LC45) & ( iVar12 * _LC47 + __LC52 & -(uint)(iVar12 < __LC48) | ~-(uint)(iVar12 < __LC48) & iVar12 * _LC50 + __LC51 ) ) >> 3;
      uVar26 = ( auVar35._4_4_ >> 0xb ) << 10 | ( -(uint)(iVar39 < _UNK_00101844) & _UNK_00101834 * iVar39 | ~-(uint)(iVar39 < _UNK_00101844) & ( _UNK_00101854 * iVar39 + _UNK_00101894 & -(uint)(iVar39 < _UNK_00101864) | ~-(uint)(iVar39 < _UNK_00101864) & iVar39 * _UNK_00101874 + _UNK_00101884 ) ) >> 3;
      uVar19 = ( auVar35._8_4_ >> 0xb ) << 10 | ( uVar13 & ( uint )(( uVar38 & 0xffffffff ) * (ulong)DAT_00101838) | ~uVar13 & ( (int)( ( uVar38 & 0xffffffff ) * (ulong)DAT_00101858 ) + _UNK_00101898 & uVar19 | ~uVar19 & (int)( ( uVar38 & 0xffffffff ) * (ulong)DAT_00101878 ) + _UNK_00101888 ) ) >> 3;
      uVar13 = ( auVar35._12_4_ >> 0xb ) << 10 | ( -(uint)(iVar40 < _UNK_0010184c) & _UNK_0010183c * iVar40 | ~-(uint)(iVar40 < _UNK_0010184c) & ( _UNK_0010185c * iVar40 + _UNK_0010189c & -(uint)(iVar40 < _UNK_0010186c) | ~-(uint)(iVar40 < _UNK_0010186c) & iVar40 * _UNK_0010187c + _UNK_0010188c ) ) >> 3;
...
/* load_image_block_fast_ldr(astcenc_profile, astcenc_image const&, image_block&,
    ...
    */void load_image_block_fast_ldr(undefined8 param_1, int *param_2, undefined4 *param_3, byte *param_4, uint param_5, uint param_6, undefined4 param_7) {
   uint uVar1;
   byte bVar2;
   int iVar3;
   long *plVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* store_image_block(astcenc_image&, image_block const&, block_size_descriptor const&, unsigned int,
   unsigned int, unsigned int, astcenc_swizzle const&) */void store_image_block(astcenc_image *param_1, image_block *param_2, block_size_descriptor *param_3, uint param_4, uint param_5, uint param_6, astcenc_swizzle *param_7) {
   image_block *piVar1;
   ulong uVar2;
   uint uVar3;
   float fVar4;
   ...
   if (*(int*)param_7 == 0) {
      ...
      iVar24 = *(int*)( param_7 + 8 );
      LAB_00100cee:bVar36 = true;
      bVar35 = true;
      if (iVar24 == 6) goto LAB_00100d08;
   }

   bVar35 = *(int*)( param_7 + 0xc ) == 6;
   LAB_00100d08:if (*(int*)( param_1 + 0xc ) == 0) {
      if (param_6 < uVar29) {
                  ...
                  if (uVar27 != 0) {
                     ...
                     do {
                        while (true) {
                           ...
                           iVar24 = auVar50._0_4_ * 0x10000 + auVar52._0_4_ * 0x1000000 + auVar54._0_4_ * 0x100 + auVar53._0_4_;
                           iVar44 = auVar50._4_4_ * 0x10000 + auVar52._4_4_ * 0x1000000 + auVar54._4_4_ * 0x100 + auVar53._4_4_;
                           iVar46 = auVar50._8_4_ * 0x10000 + auVar52._8_4_ * 0x1000000 + auVar54._8_4_ * 0x100 + auVar53._8_4_;
                           if ((float)( (float)-(uint)(iVar13 < (int)uVar17) != 0.0 ) == 0.0) break;
                           uVar20 = uVar20 + 4;
                           *piVar31 = iVar24;
                           piVar31[1] = iVar44;
                           piVar31[2] = iVar46;
                           piVar31[3] = auVar50._12_4_ * 0x10000 + auVar52._12_4_ * 0x1000000 + auVar54._12_4_ * 0x100 + auVar53._12_4_;
                           piVar31 = piVar31 + 4;
...
;
 ...
 while ( uVar20 < uVar27 );
                     LAB_001010de:iVar24 = uVar17 + iVar25;
                  }
               ...
               do {
                  if (uVar27 != 0) {
                     ...
                     do {
                        ...
                        *(ulong*)( lVar5 + ( (ulong)uVar32 + ( ulong )(param_4 * 4) ) * 2 + lVar33 + uVar26 * 8 ) = ( ( (ulong)auVar9._12_2_ << 0x10 | ( ulong )(auVar9._8_4_ & 0xffff) ) << 0x10 | (ulong)auVar9._4_4_ ) << 0x10 | (ulong)auVar9._0_4_;
                        uVar26 = uVar26 + 1;
                     }
 while ( uVar26 != uVar2 );

/* Quaternion::angle_to(Quaternion const&) const */undefined8 Quaternion::angle_to(Quaternion *this, Quaternion *param_1) {
   float fVar1;
   undefined1 auVar2[16];
   undefined1 extraout_var[12];
   fVar1 = *(float*)this * *(float*)param_1 + *(float*)( this + 4 ) * *(float*)( param_1 + 4 ) + *(float*)( this + 8 ) * *(float*)( param_1 + 8 ) + *(float*)( this + 0xc ) * *(float*)( param_1 + 0xc );
   fVar1 = fVar1 * fVar1;
...
/* Quaternion::TEMPNAMEPLACEHOLDERVALUE(Quaternion const&) */void Quaternion::operator *=(Quaternion *this, Quaternion *param_1) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
...
/* Quaternion::TEMPNAMEPLACEHOLDERVALUE(Quaternion const&) const */void Quaternion::operator *(Quaternion *this, Quaternion *param_1) {
   undefined8 uVar1;
   Quaternion *in_RDX;
...
/* Quaternion::is_equal_approx(Quaternion const&) const */undefined4 Quaternion::is_equal_approx(Quaternion *this, Quaternion *param_1) {
   float fVar1;
   float fVar2;
   undefined4 uVar3;
   float fVar4;
   ...
   if (*(float*)param_1 == fVar1) {
      LAB_0010014f:fVar1 = *(float*)( this + 4 );
      ...
      LAB_00100230:uVar3 = 0;
   }

   return uVar3;
}
/* Quaternion::is_finite() const */bool Quaternion::is_finite(Quaternion *this) {
   bool bVar1;
   bVar1 = false;
   if (( ( (float)( *(uint*)this & _LC3 ) <= _LC4 ) && ( (float)( *(uint*)( this + 4 ) & _LC3 ) <= _LC4 ) ) && ( (float)( *(uint*)( this + 8 ) & _LC3 ) <= _LC4 )) {
      bVar1 = (float)( *(uint*)( this + 0xc ) & _LC3 ) <= _LC4;
   }

   return bVar1;
}
/* Quaternion::length() const */float Quaternion::length(Quaternion *this) {
   return SQRT(*(float*)( this + 0xc ) * *(float*)( this + 0xc ) + *(float*)this * *(float*)this + *(float*)( this + 4 ) * *(float*)( this + 4 ) + *(float*)( this + 8 ) * *(float*)( this + 8 ));
}
/* Quaternion::normalize() */void Quaternion::normalize(Quaternion *this) {
   float fVar1;
   fVar1 = _LC1 / SQRT(*(float*)this * *(float*)this + *(float*)( this + 4 ) * *(float*)( this + 4 ) + *(float*)( this + 8 ) * *(float*)( this + 8 ) + *(float*)( this + 0xc ) * *(float*)( this + 0xc ));
   *(float*)this = fVar1 * *(float*)this;
   for (int i = 0; i < 3; i++) {
      *(float*)( this + ( 4*i + 4 ) ) = fVar1 * *(float*)( this + ( 4*i + 4 ) );
   }

   return;
}
/* Quaternion::normalized() const */void Quaternion::normalized(void) {
   float fVar1;
   float fVar2;
   float fVar3;
   float *in_RSI;
   ...
   fVar2 = in_RSI[2];
   fVar3 = in_RSI[3];
   fVar4 = _LC1 / SQRT(*in_RSI * *in_RSI + in_RSI[1] * in_RSI[1] + in_RSI[2] * in_RSI[2] + in_RSI[3] * in_RSI[3]);
   *in_RDI = fVar4 * *in_RSI;
...
/* Quaternion::is_normalized() const */undefined4 Quaternion::is_normalized(Quaternion *this) {
   undefined4 uVar1;
   float fVar2;
   fVar2 = *(float*)this * *(float*)this + *(float*)( this + 4 ) * *(float*)( this + 4 ) + *(float*)( this + 8 ) * *(float*)( this + 8 ) + *(float*)( this + 0xc ) * *(float*)( this + 0xc );
   uVar1 = 1;
   if (fVar2 != _LC1) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Quaternion::log() const */void Quaternion::log(void) {
   undefined8 *in_RSI;
   undefined8 *in_RDI;
   float fVar1;
   float fVar2;
   ...
   fVar1 = _LC6;
   if (( fVar2 < _LC7 ) || ( fVar1 = _LC1 < fVar2 )) {
   ...
   LAB_0010045e:*(undefined4*)( (long)in_RDI + 0xc ) = 0;
   *(float*)( in_RDI + 1 ) = fVar1 * fVar5;
   *in_RDI = CONCAT44(fVar1 * (float)( (ulong)uVar4 >> 0x20 ), fVar1 * (float)uVar4);
   return;
}
/* Quaternion::operator String() const */Quaternion * __thiscall Quaternion::operator_cast_to_String(Quaternion *this){
   long *plVar1;
   long lVar2;
   undefined *puVar3;
   float *in_RSI;
...
/* Quaternion::get_euler(EulerOrder) const */undefined1  [16] __thiscallQuaternion::get_euler(Quaternion *this, undefined4 param_2) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long in_FS_OFFSET;
   ...
   fVar4 = *(float*)this * *(float*)this + *(float*)( this + 4 ) * *(float*)( this + 4 ) + *(float*)( this + 8 ) * *(float*)( this + 8 ) + *(float*)( this + 0xc ) * *(float*)( this + 0xc );
   if (( fVar4 == _LC1 ) || ( ABS(fVar4 - _LC1) < _LC5 )) {
      ...
      operator+((char *)&
      local_88,"The quaternion ";
      String::operator +((String*)&local_78, (String*)&local_88);
      _err_print_error("get_euler", "core/math/quaternion.cpp", 0x2c, "Condition \"!is_normalized()\" is true. Returning: Vector3(0, 0, 0)", (String*)&local_78, 0, 0);
      pcVar3 = local_78;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Quaternion::inverse() const */void Quaternion::inverse(void) {
   long *plVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   if (( fVar9 == _LC1 ) || ( ABS(fVar9 - _LC1) < _LC5 )) {
      ...
      *in_RDI = (uint)fVar2 ^ _LC27;
      ...
      operator+((char *)&
      local_58,"The quaternion ";
      String::operator +((String*)&local_48, (String*)&local_58);
      _err_print_error("inverse", "core/math/quaternion.cpp", 0x5b, "Condition \"!is_normalized()\" is true. Returning: Quaternion()", (String*)&local_48, 0, 0);
      pcVar8 = local_48;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Quaternion::slerp(Quaternion const&, float) const */Quaternion *Quaternion::slerp(Quaternion *param_1, float param_2) {
   long *plVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   if (( fVar13 == _LC1 ) || ( ABS(fVar13 - _LC1) < _LC5 )) {
      ...
      if (( fVar14 == _LC1 ) || ( ABS(fVar14 - _LC1) < _LC5 )) {
         ...
         if (fVar15 < 0.0) {
            ...
            LAB_001011d6:fVar16 = acosf(fVar15);
            fVar17 = sinf(fVar16);
            ...
            LAB_00101171:fVar15 = _LC1 - param_2;
         }
   ...
   *(undefined8*)( param_1 + 8 ) = uVar12;
   LAB_00101189:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Quaternion::slerpni(Quaternion const&, float) const */Quaternion *Quaternion::slerpni(Quaternion *param_1, float param_2) {
   long *plVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   *(undefined8*)( param_1 + 8 ) = uVar17;
   LAB_001015c2:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Quaternion::get_axis() const */void Quaternion::get_axis(Quaternion *this) {
   long lVar1;
   long in_FS_OFFSET;
   float fVar2;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   fVar2 = *(float*)( this + 0xc );
   if (( (double)ABS(fVar2) <= __LC8 ) && ( fVar2 = fVar2 < 0.0 )) {
      sqrtf(fVar2);
   }
...
/* Quaternion::get_angle() const */ulong Quaternion::get_angle(Quaternion *this) {
   float fVar1;
   ulong uVar2;
   undefined1 extraout_var[12];
   ...
   fVar1 = *(float*)( this + 0xc );
   uVar2 = (ulong)_LC6;
   if (( _LC7 <= fVar1 ) && ( uVar2 = fVar1 <= _LC1 )) {
      fVar1 = acosf(fVar1);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Quaternion::Quaternion(Vector3 const&, float) */void Quaternion::Quaternion(Quaternion *this, Vector3 *param_1, float param_2) {
   long *plVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   *(undefined8*)( this + 8 ) = uVar5;
   ...
   if (fVar8 != _LC1) {
      if (_LC5 <= ABS(fVar8 - _LC1)) {
         ...
         _err_print_error("Quaternion", "core/math/quaternion.cpp", 0x129, "Condition \"!p_axis.is_normalized()\" is true.", (String*)&local_60, 0, 0);
         lVar6 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
   ...
   *(float*)( this + 0xc ) = local_70;
   LAB_00101ac1:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Quaternion::exp() const */void Quaternion::exp(void) {
   ulong uVar1;
   undefined8 uVar2;
   ulong *in_RSI;
   Quaternion *in_RDI;
   ...
   if (( (double)fVar7 < _LC38 ) || ( ( fVar4 = (float)( (ulong)local_20 >> 0x20 ) ),fVar4 = (float)local_20 * (float)local_20 + fVar4 * fVar4 + local_18 * local_18,fVar4 != _LC1 && ( _LC5 <= ABS(fVar4 - _LC1) ) )) {
      *(undefined8*)in_RDI = __LC20;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Quaternion::spherical_cubic_interpolate(Quaternion const&, Quaternion const&, Quaternion const&,
   float) const */Quaternion *Quaternion::spherical_cubic_interpolate(Quaternion *param_1, Quaternion *param_2, Quaternion *param_3, float param_4) {
   long *plVar1;
   long lVar2;
   undefined8 *in_RCX;
   char *pcVar3;
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   fVar5 = *(float*)param_2 * *(float*)param_2 + *(float*)( param_2 + 4 ) * *(float*)( param_2 + 4 ) + *(float*)( param_2 + 8 ) * *(float*)( param_2 + 8 ) + *(float*)( param_2 + 0xc ) * *(float*)( param_2 + 0xc );
   if (( fVar5 == _LC1 ) || ( ABS(fVar5 - _LC1) < _LC5 )) {
      fVar5 = *(float*)param_3 * *(float*)param_3 + *(float*)( param_3 + 4 ) * *(float*)( param_3 + 4 ) + *(float*)( param_3 + 8 ) * *(float*)( param_3 + 8 ) + *(float*)( param_3 + 0xc ) * *(float*)( param_3 + 0xc );
      if (( fVar5 == _LC1 ) || ( ABS(fVar5 - _LC1) < _LC5 )) {
         local_108 = *in_RCX;
         uStack_100 = in_RCX[1];
         ...
         Basis::set_quaternion((Quaternion*)local_68);
         Basis::get_rotation_quaternion();
         if ((int)( local_108._4_4_ * local_118._4_4_ + (float)local_108 * (float)local_118 + (float)uStack_100 * (float)uStack_110 + uStack_100._4_4_ * uStack_110._4_4_ ) < 0) {
         ...
         if ((int)( (float)local_118 * (float)local_f8 + local_118._4_4_ * local_f8._4_4_ + (float)uStack_110 * (float)uStack_f0 + uStack_110._4_4_ * uStack_f0._4_4_ ) < 0) {
            ...
            if (uStack_f0._4_4_ * uStack_70._4_4_ + (float)local_f8 * (float)local_78 + local_78._4_4_ * local_f8._4_4_ + (float)uStack_70 * (float)uStack_f0 <= 0.0) goto LAB_001021e0;
         }
 else if ((int)( (float)local_78 * (float)local_f8 + local_f8._4_4_ * local_78._4_4_ + (float)uStack_f0 * (float)uStack_70 + uStack_f0._4_4_ * uStack_70._4_4_ ) < 0) {
            LAB_001021e0:fVar5 = (float)( (uint)(float)local_78 ^ _LC27 );
         ...
         inverse();
         operator*=((Quaternion *)
         local_68,(Quaternion*)&local_f8;
         log();
         inverse();
         operator*=((Quaternion *)
         local_68,(Quaternion*)&local_108;
         log();
         inverse();
         uStack_60 = uStack_70;
         local_68 = (undefined1[8])local_78;
         operator*=((Quaternion *)
         local_68,(Quaternion*)&local_e8;
         log();
         ...
         local_a8 = CONCAT44(( ( ( fVar8 + fVar8 + _UNK_00103a04 * fVar12 ) - fVar6 ) * fVar11 + ( fVar12 - fVar8 ) * param_4 + 0.0 + ( ( ( 0.0 - fVar8 ) - fVar12 * _LC45._4_4_ ) + fVar6 ) * fVar10 ) * _UNK_00103a14, ( ( ( fVar7 + fVar7 + _LC44 * fVar5 ) - (float)local_b8 ) * fVar11 + ( fVar5 - fVar7 ) * param_4 + 0.0 + ( ( ( 0.0 - fVar7 ) - fVar5 * (float)_LC45 ) + (float)local_b8 ) * fVar10 ) * _LC36);
         local_a0 = ( ( ( local_c0 + local_c0 + _LC44 * local_d0 ) - local_b0 ) * fVar11 + ( local_d0 - local_c0 ) * param_4 + 0.0 + ( ( ( 0.0 - local_c0 ) - local_d0 * (float)_LC45 ) + local_b0 ) * fVar10 ) * _LC36;
         exp();
         local_98 = local_118;
         uStack_90 = uStack_110;
         operator*=((Quaternion *)&
         local_98,(Quaternion*)local_68;
         inverse();
         local_78 = local_88;
         uStack_70 = uStack_80;
         operator*=((Quaternion *)&
         local_78,(Quaternion*)&local_118;
         log();
         ...
         uStack_70 = uStack_80;
         operator*=((Quaternion *)&
         local_78,(Quaternion*)&local_e8;
         log();
         local_a8 = CONCAT44(( ( ( ( ( fVar9 + fVar9 ) - fVar16 ) + 0.0 ) - SUB124(_local_68, 4) ) * fVar11 + ( 0.0 - fVar9 ) * param_4 + fVar8 + fVar8 + ( SUB124(_local_68, 4) + ( fVar14 - fVar9 ) ) * fVar10 ) * _UNK_00103a14, ( ( ( ( ( fVar7 + fVar7 ) - fVar15 ) + 0.0 ) - SUB124(_local_68, 0) ) * fVar11 + ( 0.0 - fVar7 ) * param_4 + fVar6 + fVar6 + ( SUB124(_local_68, 0) + ( fVar13 - fVar7 ) ) * fVar10 ) * _LC36);
         local_a0 = ( ( ( ( ( fVar12 + fVar12 ) - _LC47 * fVar5 ) + 0.0 ) - (float)uStack_60 ) * fVar11 + ( 0.0 - fVar12 ) * param_4 + fVar5 + fVar5 + ( ( fVar5 * (float)_LC45 - fVar12 ) + (float)uStack_60 ) * fVar10 ) * _LC36;
         exp();
         local_78 = local_f8;
         uStack_70 = uStack_f0;
         operator*=((Quaternion *)&
         local_78,(Quaternion*)local_68;
      ...
      operator_cast_to_String((Quaternion*)&local_140);
      operator+((char *)&
      local_138,"The start quaternion ";
      String::operator +((String*)&local_128, (String*)&local_138);
      pcVar3 = "Condition \"!is_normalized()\" is true. Returning: Quaternion()";
      uVar4 = 0xb4;
   }

   _err_print_error("spherical_cubic_interpolate", "core/math/quaternion.cpp", uVar4, pcVar3, &local_128, 0, 0);
   pcVar3 = local_128;
   ...
   *(undefined8*)( param_1 + 8 ) = uVar4;
   LAB_0010268d:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Quaternion::spherical_cubic_interpolate_in_time(Quaternion const&, Quaternion const&, Quaternion
   const&, float, float, float, float) const */Quaternion *Quaternion::spherical_cubic_interpolate_in_time(Quaternion *param_1, Quaternion *param_2, Quaternion *param_3, float param_4, float param_5, float param_6, float param_7) {
   long *plVar1;
   long lVar2;
   undefined8 *in_RCX;
   char *pcVar3;
   ...
   if (( fVar5 == _LC1 ) || ( ABS(fVar5 - _LC1) < _LC5 )) {
      ...
      if (( fVar5 == _LC1 ) || ( ABS(fVar5 - _LC1) < _LC5 )) {
         ...
         if ((int)( (float)local_118 * (float)local_f8 + local_118._4_4_ * local_f8._4_4_ + (float)uStack_110 * (float)uStack_f0 + uStack_110._4_4_ * uStack_f0._4_4_ ) < 0) {
            ...
            uStack_f0._0_4_ = (float)( (uint)(float)uStack_f0 ^ _LC27 );
            uStack_f0._4_4_ = (float)( (uint)uStack_f0._4_4_ ^ _LC27 );
            if (uStack_f0._4_4_ * uStack_70._4_4_ + (float)local_f8 * (float)local_78 + local_f8._4_4_ * local_78._4_4_ + (float)uStack_f0 * (float)uStack_70 <= 0.0) goto LAB_00102d41;
         }
 else if ((int)( (float)local_f8 * (float)local_78 + local_f8._4_4_ * local_78._4_4_ + (float)uStack_f0 * (float)uStack_70 + uStack_70._4_4_ * uStack_f0._4_4_ ) < 0) {
            LAB_00102d41:fVar5 = (float)( (uint)(float)local_78 ^ _LC27 );
         ...
         local_a8 = CONCAT44(( ( ( ( ( local_b4 - local_d4 ) * fVar6 + local_d4 ) - fVar15 ) * fVar12 + fVar15 ) - local_c4 ) * fVar13 + local_c4, local_c8 + ( ( ( ( ( local_b8 - local_d8 ) * fVar6 + local_d8 ) - fVar11 ) * fVar12 + fVar11 ) - local_c8 ) * fVar13);
         fVar15 = local_d0 * fVar13 + 0.0;
         local_c0 = ( fVar15 - local_c0 ) * fVar14 + local_c0;
         local_a0 = ( ( ( ( ( local_b0 - local_d0 ) * fVar6 + local_d0 ) - fVar15 ) * fVar12 + fVar15 ) - local_c0 ) * fVar13 + local_c0;
         exp();
         local_98 = local_118;
         uStack_90 = uStack_110;
         operator*=((Quaternion *)&
         ...
         local_78,(Quaternion*)&local_e8;
         log();
         local_a8 = CONCAT44(( ( ( ( fVar6 * SUB124(_local_68, 4) + 0.0 ) - fVar10 ) * fVar12 + fVar10 ) - fVar8 ) * fVar13 + fVar8, ( ( ( ( fVar6 * SUB124(_local_68, 0) + 0.0 ) - fVar9 ) * fVar12 + fVar9 ) - fVar7 ) * fVar13 + fVar7);
         fVar11 = ( fVar15 - fVar11 ) * fVar5 + fVar11;
         fVar15 = ( 0.0 - fVar15 ) * fVar13 + fVar15;
         fVar11 = ( fVar15 - fVar11 ) * fVar14 + fVar11;
         local_a0 = ( ( ( ( (float)uStack_60 * fVar6 + 0.0 ) - fVar15 ) * fVar12 + fVar15 ) - fVar11 ) * fVar13 + fVar11;
         exp();
         local_78 = local_f8;
         uStack_70 = uStack_f0;
         operator*=((Quaternion *)&
   ...
   _err_print_error("spherical_cubic_interpolate_in_time", "core/math/quaternion.cpp", uVar4, pcVar3, &local_128, 0, 0);
   pcVar3 = local_128;
   if (local_128 != (char*)0x0) {
      LOCK();
      plVar1 = (long*)( local_128 + -0x10 );
   ...
   *(undefined8*)param_1 = __LC20;
   *(undefined8*)( param_1 + 8 ) = uVar4;
   LAB_00103344:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* Quaternion::from_euler(Vector3 const&) */Quaternion * __thiscall Quaternion::from_euler(Quaternion *this,Vector3 *param_1){
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;

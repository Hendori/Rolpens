/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::TaperedCylinderShape::GetLocalBounds() const */void JPH::TaperedCylinderShape::GetLocalBounds(void) {
   uint uVar1;
   uint uVar2;
   long in_RSI;
   uint *in_RDI;
...
/* JPH::TaperedCylinderShape::CollidePoint(JPH::Vec3, JPH::SubShapeIDCreator const&,
   ...
   JPH::ShapeFilter const&) const */void JPH::TaperedCylinderShape::CollidePoint(undefined8 param_1, float param_2, long param_3, undefined4 *param_4, long *param_5, long *param_6) {
   char cVar1;
   long in_FS_OFFSET;
   float fVar2;
   float fVar3;
   ...
   if (cVar1 != '\0') {
      ...
      if (( fVar2 <= fVar3 ) && ( fVar3 <= *(float*)( param_3 + 0x2c ) )) {
         fVar2 = ( ( fVar3 - fVar2 ) * ( *(float*)( param_3 + 0x34 ) - *(float*)( param_3 + 0x38 ) ) ) / ( *(float*)( param_3 + 0x2c ) - fVar2 ) + *(float*)( param_3 + 0x38 );
...
/* JPH::TaperedCylinderShape::GetTrianglesNext(JPH::Shape::GetTrianglesContext&, int, JPH::Float3*,
   JPH::PhysicsMaterial const**) const */int JPH::TaperedCylinderShape::GetTrianglesNext(TaperedCylinderShape *this, GetTrianglesContext *param_1, int param_2, Float3 *param_3, PhysicsMaterial **param_4) {
   Float3 *pFVar1;
   ...
   if (( ( uVar8 & 4 ) == 0 ) && ( iVar10 + 0x10 < param_2 )) {
      ...
      while (true) {
         ...
         *(float*)( param_3 + 0x20 ) = fVar26;
         ...
         fVar29 = fVar21 * *(float*)param_1 + fVar24 * *(float*)( param_1 + 0x10 ) + fVar19 * *(float*)( param_1 + 0x20 ) + *(float*)( param_1 + 0x30 );
         fVar15 = fVar21 * *(float*)( param_1 + 4 ) + fVar24 * *(float*)( param_1 + 0x14 ) + fVar19 * *(float*)( param_1 + 0x24 ) + *(float*)( param_1 + 0x34 );
         fVar16 = fVar21 * *(float*)( param_1 + 8 ) + fVar24 * *(float*)( param_1 + 0x18 ) + fVar19 * *(float*)( param_1 + 0x28 ) + *(float*)( param_1 + 0x38 );
...
;
   ...
   LAB_001002a8:if (param_4 != (PhysicsMaterial**)0x0) {
...
/* JPH::TaperedCylinderShape::GetVolume() const */float JPH::TaperedCylinderShape::GetVolume(TaperedCylinderShape *this) {
   float fVar1;
   float fVar2;
   fVar1 = *(float*)( this + 0x34 );
   fVar2 = *(float*)( this + 0x38 );
   return ( fVar1 * fVar2 + fVar1 * fVar1 + fVar2 * fVar2 ) * ( *(float*)( this + 0x2c ) - *(float*)( this + 0x30 ) ) * _LC2;
}
/* JPH::TaperedCylinderShapeSettings::sCreateRTTI(JPH::RTTI&) */void JPH::TaperedCylinderShapeSettings::sCreateRTTI(RTTI *param_1) {
   int iVar1;
   iVar1 = JPH::GetRTTIOfType((ConvexShapeSettings*)0x0);
   JPH::RTTI::AddBaseClass(param_1, iVar1);
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::TaperedCylinderShape::GetSurfaceNormal(JPH::SubShapeID const&, JPH::Vec3) const */undefined1  [16] __thiscallJPH::TaperedCylinderShape::GetSurfaceNormal(undefined8 param_1, undefined8 param_2, TaperedCylinderShape *this) {
   ...
   fVar6 = auVar5._8_4_ * auVar5._8_4_ + auVar5._0_4_ * auVar5._0_4_ + 0.0 + auVar5._4_4_ * auVar5._4_4_;
   if (_LC10 < fVar6) {
   ...
   fVar2 = ( *(float*)( this + 0x38 ) - *(float*)( this + 0x34 ) ) / ( *(float*)( this + 0x2c ) - *(float*)( this + 0x30 ) );
   auVar4._4_4_ = fVar2;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::TaperedCylinderShape::GetSupportingFace(JPH::SubShapeID const&, JPH::Vec3, JPH::Vec3,
   JPH::Mat44 const&, JPH::StaticArray<JPH::Vec3, 32u>&) const */void JPH::TaperedCylinderShape::GetSupportingFace(undefined8 param_1_00, undefined8 param_2, undefined8 param_3, undefined8 param_4, long param_1, undefined8 param_6, float *param_7, uint *param_8) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   fVar31 = auVar33._8_4_ * auVar33._8_4_ + auVar33._0_4_ * auVar33._0_4_ + 0.0 + auVar33._4_4_ * auVar33._4_4_;
   if (_LC10 < fVar31) {
   ...
   if ((float)( ( uint )(auVar27._8_4_ * fStack_20 + auVar27._4_4_ * fStack_24 + auVar27._0_4_ * local_28 + 0.0) & _LC11 ) <= (float)( _LC11 & (uint)fStack_24 )) {
      if (fStack_24 < 0.0) {
         if (fVar36 <= _LC12) {
            return;
         }
...
/* JPH::TaperedCylinderShape::SaveBinaryState(JPH::StreamOut&) const */void JPH::TaperedCylinderShape::SaveBinaryState(TaperedCylinderShape *this, StreamOut *param_1) {
   JPH::ConvexShape::SaveBinaryState((StreamOut*)this);
   for (int i = 0; i < 4; i++) {
      ( **(code**)( *(long*)param_1 + 16 ) )(param_1, this + ( 4*i + 44 ), 4);
   }
...
/* JPH::TaperedCylinderShape::RestoreBinaryState(JPH::StreamIn&) */void JPH::TaperedCylinderShape::RestoreBinaryState(TaperedCylinderShape *this, StreamIn *param_1) {
...
/* JPH::TaperedCylinderShape::IsValidScale(JPH::Vec3) const */char JPH::TaperedCylinderShape::IsValidScale(undefined8 param_1, undefined8 param_2) {
   char cVar1;
   float fVar2;
   float fVar5;
   float fVar6;
...
/* JPH::TaperedCylinderShape::MakeScaleValid(JPH::Vec3) const */undefined1  [16] __thiscallJPH::TaperedCylinderShape::MakeScaleValid(undefined8 param_1, undefined8 param_2) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::TaperedCylinderShape::GetTrianglesStart(JPH::Shape::GetTrianglesContext&, JPH::AABox const&,
   JPH::Vec3, JPH::Quat, JPH::Vec3) const */void JPH::TaperedCylinderShape::GetTrianglesStart(undefined8 param_1_00, float param_2_00, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, long param_1, undefined8 *param_2) {
   bool bVar1;
   bool bVar2;
   float fVar3;
   float fVar4;
   ...
   do {
      ...
      *(float*)( (long)&local_58 + lVar9 ) = fVar6 * local_a8 + fVar3 * ( ( _LC4 - fVar17 * fVar18 ) - fVar19 ) + fVar4 * ( fVar17 * fVar16 - fVar14 ) + fVar5 * ( fVar10 * fVar16 + fVar18 * fVar13 );
      *(float*)( (long)&local_58 + lVar9 + 4 ) = fVar6 * fStack_a4 + fVar3 * ( fVar17 * fVar16 + fVar14 ) + fVar4 * ( ( _LC4 - fVar19 ) - fVar15 * fVar16 ) + fVar5 * ( fVar10 * fVar18 - fVar16 * fVar13 );
      *(float*)( (long)&uStack_50 + lVar9 ) = fVar6 * param_2_00 + fVar3 * ( fVar10 * fVar16 - fVar18 * fVar13 ) + fVar4 * ( fVar16 * fVar13 + fVar10 * fVar18 ) + fVar5 * ( ( _LC4 - fVar15 * fVar16 ) - fVar17 * fVar18 );
...
/* _FUN() */void JPH::TaperedCylinderShape::sRegister()::{lambda()#1}::_FUN(void)

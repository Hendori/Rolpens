...
/* RemoteDebugger::_print_handler(void*, String const&, bool, bool) */void RemoteDebugger::_print_handler(void *param_1, String *param_2, bool param_3, bool param_4) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   char *pcVar4;
   ...
   if (*(char*)( (long)param_1 + 0xb0 ) != '\0') {
      ...
      if (*(long*)( (long)param_1 + 0xb8 ) == *(long*)( in_FS_OFFSET + lRam00000000001001ed )) goto LAB_00100322;
   }

   local_70 = (char*)0x0;
   plVar1 = (long*)( *(long*)param_2 + -0x10 );
   if (*(long*)param_2 == 0) {
      LAB_001002d0:iVar11 = 0;
   }
 else {
      do {
         lVar2 = *plVar1;
 ...
 while ( !bVar12 );
      ...
      LAB_00100242:pcVar3 = local_70;
      if (( local_70 == (char*)0x0 ) || ( iVar6 = iVar6 == 0 )) goto LAB_001002d0;
 ...
 while ( !bVar12 );
      ...
      LAB_0010038b:local_60 = (uint)param_4 * 2;
      if (param_3) {
         local_60 = 1;
      }
   ...
   LAB_00100322:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* RemoteDebugger::_put_msg(String const&, Array const&) */int RemoteDebugger::_put_msg(RemoteDebugger *this, String *param_1, Array *param_2) {
   int iVar1;
   long in_FS_OFFSET;
   Array local_50[8];
   int local_48[6];
...
/* RemoteDebugger::send_message(String const&, Array const&) */void RemoteDebugger::send_message(RemoteDebugger *this, String *param_1, Array *param_2) {
   char cVar1;
   int iVar2;
...
/* RemoteDebugger::_create_overflow_error(String const&, String const&) */String *RemoteDebugger::_create_overflow_error(String *param_1, String *param_2) {
   int iVar1;
   long lVar2;
   ulong uVar3;
   CowData *in_RCX;
   ...
   *(undefined4*)param_1 = 0xffffffff;
   for (int i = 0; i < 3; i++) {
      *(undefined4*)( param_1 + ( 4*i + 4 ) ) = 4294967295;
   }
...
/* RemoteDebugger::_send_stack_vars(List<String, DefaultAllocator>&, List<Variant,
   DefaultAllocator>&, int) */void RemoteDebugger::_send_stack_vars(RemoteDebugger *this, List *param_1, List *param_2, int param_3) {
   long *plVar1;
   code *pcVar2;
   long lVar3;
   CowData *pCVar4;
...
/* RemoteDebugger::_try_capture(String const&, Array const&, bool&) */ulong RemoteDebugger::_try_capture(RemoteDebugger *this, String *param_1, Array *param_2, bool *param_3) {
   long *plVar1;
   long lVar2;
   char cVar3;
   int iVar4;
   ...
   *param_3 = false;
   ...
   if (-1 < iVar4) {
      ...
      if (cVar3 != '\0') {
         ...
         StringName::StringName((StringName*)&local_48, (String*)&local_58, false);
         uVar5 = EngineDebugger::capture_parse((StringName*)this, (String*)&local_48, (Array*)&local_50, (bool*)param_2);
         if (( StringName::configured != '\0' ) && ( local_48 != 0 )) {
            StringName::unref();
...
/* RemoteDebugger::_core_capture(String const&, Array const&, bool&) */undefined8 RemoteDebugger::_core_capture(RemoteDebugger *this, String *param_1, Array *param_2, bool *param_3) {
   ...
   *param_3 = true;
   ...
   if (cVar2 == '\0') {
      ...
      if (cVar2 == '\0') {
         ...
         if (cVar2 == '\0') {
            ...
            if (cVar2 == '\0') {
               ...
               if (cVar2 == '\0') {
                  *param_3 = false;
                  ...
                  ScriptDebugger::debug(EngineDebugger::script_debugger, SUB81(*(undefined8*)( in_FS_OFFSET + lRam0000000000100e57 ), 0), true);
               }
               ...
               if (cVar2 != '\0') {
                  _err_print_error("_core_capture", "core/debugger/remote_debugger.cpp", 0x29e, "Condition \"p_data.is_empty()\" is true. Returning: ERR_INVALID_DATA", 0, 0);
                  goto LAB_00100f2f;
               }
            ...
            iVar4 = Array::size();
            if (iVar4 < 3) {
               _err_print_error("_core_capture", "core/debugger/remote_debugger.cpp", 0x295, "Condition \"p_data.size() < 3\" is true. Returning: ERR_INVALID_DATA", 0, 0);
               LAB_00100f2f:uVar7 = 0x1e;
               goto LAB_00100d21;
            }
   ...
   uVar7 = 0;
   LAB_00100d21:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar7;
   }
...
/* _FUN(void*, String const&, Array const&, bool&) */void RemoteDebugger::RemoteDebugger(Ref<RemoteDebuggerPeer>)::{
   lambda(void*,String_const&,Array_const&,bool&)#1
}
::_FUN(void *param_1, String *param_2, Array *param_3, bool *param_4) {
   _core_capture((RemoteDebugger*)param_1, param_2, param_3, param_4);
   return;
}
/* RemoteDebugger::_profiler_capture(String const&, Array const&, bool&) */undefined8 RemoteDebugger::_profiler_capture(RemoteDebugger *this, String *param_1, Array *param_2, bool *param_3) {
   char cVar1;
   bool bVar2;
   int iVar3;
   int *piVar4;
   ...
   *param_3 = false;
   ...
   if (cVar1 == '\0') {
      ...
      if (*piVar4 == 1) {
         ...
         if (cVar1 == '\0') {
            uVar5 = 2;
            _err_print_error("_profiler_capture", "core/debugger/remote_debugger.cpp", 0x2ac, "Condition \"!has_profiler(p_cmd)\" is true. Returning: ERR_UNAVAILABLE", 0, 0);
            goto LAB_001010c8;
         }
         ...
         iVar3 = Array::size();
         if (iVar3 < 2) {
            LAB_0010106e:*param_3 = true;
            this_00 = (Variant*)Array::operator [](iVar6);
            bVar2 = Variant::operator_cast_to_bool(this_00);
            StringName::StringName((StringName*)&local_48, param_1, false);
            EngineDebugger::profiler_enable((StringName*)this, SUB81((StringName*)&local_48, 0), (Array*)(ulong)bVar2);
            if (( StringName::configured != '\0' ) && ( local_48 != 0 )) {
               StringName::unref();
            }
            ...
            uVar5 = 0x1e;
            _err_print_error("_profiler_capture", "core/debugger/remote_debugger.cpp", 0x2af, "Condition \"p_data[1].get_type() != Variant::ARRAY\" is true. Returning: ERR_INVALID_DATA", 0, 0);
         }
      ...
      _err_print_error("_profiler_capture", "core/debugger/remote_debugger.cpp", 0x2ab, "Condition \"p_data[0].get_type() != Variant::BOOL\" is true. Returning: ERR_INVALID_DATA", 0, 0);
   }
 else {
      _err_print_error("_profiler_capture", "core/debugger/remote_debugger.cpp", 0x2aa, "Condition \"p_data.is_empty()\" is true. Returning: ERR_INVALID_DATA", 0, 0);
   }

   uVar5 = 0x1e;
   LAB_001010c8:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar5;
   }
...
/* _FUN(void*, String const&, Array const&, bool&) */void RemoteDebugger::RemoteDebugger(Ref<RemoteDebuggerPeer>)::{
   lambda(void*,String_const&,Array_const&,bool&)#2
}
::_FUN(void *param_1, String *param_2, Array *param_3, bool *param_4) {
...
/* RemoteDebugger::_err_handler(void*, char const*, char const*, int, char const*, char const*,
   bool, ErrorHandlerType) */void RemoteDebugger::_err_handler(long param_1, int param_2, int param_3, undefined4 param_4, int param_5, int param_6, undefined1 param_7, int param_8) {
   undefined8 uVar1;
   long lVar2;
   long *plVar3;
   int iVar4;
   ...
   if (param_8 != 2) {
      if (*(char*)( param_1 + 0xb0 ) != '\0') {
         ...
         if (*(long*)( param_1 + 0xb8 ) == *(long*)( in_FS_OFFSET + lRam00000000001016a6 )) goto LAB_0010166d;
      }
 ...
 while ( ( ( local_60 == 0 ) || ( *(long*)( local_60 + -8 ) == 0 ) ) && ( iVar4 = iVar4 + 1 ),iVar4 < (int)ScriptServer::_language_count );
      }
      ...
      ScriptDebugger::send_error(uVar1, &local_80, &local_78, param_4, &local_70, &local_58, param_7, param_8, local_68);
      lVar2 = local_80;
      if (local_80 != 0) {
         LOCK();
   ...
   LAB_0010166d:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* List<DebuggerMarshalls::OutputError, DefaultAllocator>::push_back(DebuggerMarshalls::OutputError
   const&) [clone .isra.0] */void List<DebuggerMarshalls::OutputError,DefaultAllocator>::push_back(List<DebuggerMarshalls::OutputError,DefaultAllocator> *this, OutputError *param_1) {
   long *plVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 *puVar4;
   ...
   *(OutputError*)( puVar4 + 7 ) = param_1[0x38];
   if (puVar4[9] != *(long*)( param_1 + 0x48 )) {
      CowData<ScriptLanguage::StackInfo>::_ref((CowData<ScriptLanguage::StackInfo>*)( puVar4 + 9 ), (CowData*)( param_1 + 0x48 ));
   }
...
/* RemoteDebugger::~RemoteDebugger() */void RemoteDebugger::~RemoteDebugger(RemoteDebugger *this) {
   long *plVar1;
   long *plVar2;
   uint uVar3;
   long lVar4;
            ...
            do {
               if (*(int*)( *(long*)( this + 0xd0 ) + lVar7 ) != 0) {
                  ...
                  *(int*)( *(long*)( this + 0xd0 ) + lVar7 ) = 0;
                  List<RemoteDebugger::Message,DefaultAllocator>::~List((List<RemoteDebugger::Message,DefaultAllocator>*)( (long)pvVar8 + 0x18 ));
 ...
 while ( lVar7 != (ulong)uVar3 << 2 );
   ...
   LAB_00101945:Array::~Array((Array*)( this + 0x80 ));
      ...
      do {
         ...
         if (plVar9 == *(long**)( (long)pvVar8 + 0x60 )) {
            ...
            *plVar9 = lVar7;
            ...
            CowData<ScriptLanguage::StackInfo>::_unref((CowData<ScriptLanguage::StackInfo>*)( (long)pvVar8 + 0x48 ));
 ...
 while ( (int)plVar9[2] != 0 );
   ...
   LAB_00101a2a:plVar9 = *(long**)( this + 0x40 );
   if (plVar9 != (long*)0x0) {
      do {
         plVar1 = (long*)*plVar9;
         if (plVar1 == (long*)0x0) {
 ...
 while ( (int)plVar9[2] != 0 );
   ...
   LAB_00101ab7:if (*(long*)( this + 0x38 ) != 0) {
...
/* RemoteDebugger::RemoteDebugger(Ref<RemoteDebuggerPeer>) */void RemoteDebugger::RemoteDebugger(RemoteDebugger *this, long *param_2) {
   long *plVar1;
   char cVar2;
   int iVar3;
   StringName *pSVar4;
...
ProjectSettings::get_singleton();StringName::StringName((StringName*)&local_58, "network/limits/debugger/max_chars_per_second", false);ProjectSettings::get_setting_with_override((StringName*)local_48);iVar3 = Variant::operator_cast_to_int((Variant*)local_48);*(int*)( this + 0x58 ) = iVar3;if (Variant::needs_deinit[local_48[0]] != '\0') {
   Variant::_clear_internal();
}
if (( StringName::configured != '\0' ) && ( local_58 != (char*)0x0 )) {
   StringName::unref();
}
ProjectSettings::get_singleton();StringName::StringName((StringName*)&local_58, "network/limits/debugger/max_errors_per_second", false);ProjectSettings::get_setting_with_override((StringName*)local_48);iVar3 = Variant::operator_cast_to_int((Variant*)local_48);*(int*)( this + 0x54 ) = iVar3;if (Variant::needs_deinit[local_48[0]] != '\0') {
   Variant::_clear_internal();
}
if (( StringName::configured != '\0' ) && ( local_58 != (char*)0x0 )) {
   StringName::unref();
}
ProjectSettings::get_singleton();StringName::StringName((StringName*)&local_58, "network/limits/debugger/max_warnings_per_second", false);ProjectSettings::get_setting_with_override((StringName*)local_48);iVar3 = Variant::operator_cast_to_int((Variant*)local_48);*(int*)( this + 0x5c ) = iVar3;if (Variant::needs_deinit[local_48[0]] != '\0') {
   Variant::_clear_internal();
}
if (( StringName::configured != '\0' ) && ( local_58 != (char*)0x0 )) {
   StringName::unref();
}
pSVar4 = (StringName*)Engine::get_singleton();StringName::StringName((StringName*)&local_58, "Performance", false);lVar5 = Engine::get_singleton_object(pSVar4);if (( StringName::configured != '\0' ) && ( local_58 != (char*)0x0 )) {
   StringName::unref();
}
if (lVar5 == 0) goto LAB_0010219e;this_00 = (RefCounted*)operator_new(0x1e8, "");RefCounted::RefCounted(this_00);*(undefined8*)( this_00 + 0x180 ) = 0;*(code**)this_00 = RefCounted::init_ref;StringName::StringName((StringName*)( this_00 + 0x188 ), "_toggle", false);this_00[400] = (RefCounted)0x0;*(undefined8*)( this_00 + 0x198 ) = 0;StringName::StringName((StringName*)( this_00 + 0x1a0 ), "_add_frame", false);this_00[0x1a8] = (RefCounted)0x0;*(undefined8*)( this_00 + 0x1b0 ) = 0;StringName::StringName((StringName*)( this_00 + 0x1b8 ), "_tick", false);*(long*)( this_00 + 0x1d0 ) = lVar5;this_00[0x1c0] = (RefCounted)0x0;*(undefined8*)( this_00 + 0x1c8 ) = 0;*(undefined***)this_00 = &PTR__initialize_classv_0010ca90;*(undefined4*)( this_00 + 0x1d8 ) = 0;*(undefined8*)( this_00 + 0x1e0 ) = 0;postinitialize_handler((Object*)this_00);cVar2 = RefCounted::init_ref();if (cVar2 == '\0') {
   ...
   if (this_00 != (RefCounted*)pOVar6) {
      *(RefCounted**)( this + 0x30 ) = this_00;
      ...
      if (( ( pOVar6 != (Object*)0x0 ) && ( cVar2 = RefCounted::unreference() ),cVar2 != '\0' )) {
         LAB_001023a3:( **(code**)( *(long*)pOVar6 + 0x140 ) )(pOVar6);
   ...
   LAB_00102102:pOVar6 = *(Object**)( this + 0x30 );
}
local_60 = 0;local_58 = "performance";local_50 = 0xb;String::parse_latin1((StrRange*)&local_60);EngineProfiler::bind((String*)pOVar6);lVar5 = local_60;if (local_60 != 0) {
   LOCK();
...
Array::Array((Array*)&local_58);StringName::StringName((StringName*)&local_60, "performance", false);EngineDebugger::profiler_enable((StringName*)this, SUB81((StrRange*)&local_60, 0), (Array*)0x1);if (( StringName::configured != '\0' ) && ( local_60 != 0 )) {
   StringName::unref();
}
Array::~Array((Array*)&local_58);LAB_0010219e:StringName::StringName((StringName*)&local_58, "core", false);EngineDebugger::register_message_capture
            ((StringName *)&local_58,

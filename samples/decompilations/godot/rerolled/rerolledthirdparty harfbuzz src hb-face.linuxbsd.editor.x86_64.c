/* void hb_object_fini<hb_sparseset_t<hb_bit_set_invertible_t>
   >(hb_sparseset_t<hb_bit_set_invertible_t>*) */void hb_object_fini<hb_sparseset_t<hb_bit_set_invertible_t>>(hb_sparseset_t *param_1) {
   long lVar1;
   int iVar2;
...
;
 ...
 while ( true );
   ...
   __mutex[1].__align = 0;
   *(undefined8*)( (long)__mutex + 0x30 ) = 0;
   LAB_001000c3:pthread_mutex_destroy(__mutex);
   free(__mutex);
   *(undefined8*)( param_1 + 8 ) = 0;
   return;
}
/* hb_bit_set_t::add_range(unsigned int, unsigned int) [clone .isra.0] */void hb_bit_set_t::add_range(hb_bit_set_t *this, uint param_1, uint param_2) {
   undefined4 *puVar1;
   int iVar2;
   int iVar3;
   long lVar4;
      ...
      *(undefined4*)( this + 4 ) = 0xffffffff;
      ...
      if (param_1 >> 9 == uVar11) {
         ...
         if (puVar6 != (undefined4*)0x0) {
            ...
            *(ulong*)( puVar6 + (ulong)uVar5 * 2 + 2 ) = -(1L << ((byte)param_1 & 0x3f)) | *(ulong*)( puVar6 + (ulong)uVar5 * 2 + 2 );
...
;
   hb_blob_destroy(lVar5);
   LAB_001007c8:hb_blob_destroy(lVar4);
   lVar4 = hb_blob_get_empty();
   LAB_00100703:puVar7 = (uint*)&_hb_NullPool;
...
;
 ...
 else if (( 0xff < uVar2 ) && ( ( uVar2 = 1 ),uVar3 == 0x100 || ( uVar3 == 0x4f54544f ) )) goto LAB_00100762;
      LAB_00100760:uVar2 = 0;
   }
   ...
   LAB_00100762:hb_blob_destroy(lVar4);
   LAB_0010076a:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
   ...
   if (param_1 != 0) {
      ...
      if (puVar1 != (undefined4*)0x0) {
         ...
         *(undefined1(*) [16])( puVar1 + 0x16 ) = (undefined1[16])0x0;
         for (int i = 0; i < 10; i++) {
            *(undefined1(*) [16])( puVar1 + ( 8*i + 30 ) ) = (undefined1[16])0;
            *(undefined1(*) [16])( puVar1 + ( 8*i + 34 ) ) = (undefined1[16])0;
         }
...
;
   hb_blob_destroy(lVar3);
   LAB_00100c48:hb_blob_destroy(lVar2);
   lVar2 = hb_blob_get_empty();
   LAB_00100bab:plVar4 = (long*)calloc(1, 0x10);
   if (plVar4 == (long*)0x0) {
      ...
      *(short*)( plVar4 + 1 ) = (short)param_2;
      puVar5 = (undefined1*)hb_face_create_for_tables(_hb_face_for_data_reference_table, plVar4, 0x100000);
...
long hb_face_create_from_file_or_fail(undefined8 param_1, uint param_2) {
   ...
   lVar3 = 0;
   LAB_00100d99:hb_blob_destroy(lVar2);
   return lVar3;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */bool hb_face_set_user_data(int *param_1, long param_2, long param_3, long param_4, int param_5) {
   uint uVar1;
   long lVar2;
   code *pcVar3;
   long lVar4;
...
;
 ...
 while ( uVar8 != uVar5 );
   ...
   if (uVar8 == 0) {
      ...
      if (__mutex[1].__data.__lock < 1) {
         ...
         uVar9 = 8;
         LAB_001011ac:plVar6 = (long*)realloc(plVar6, uVar9 * 0x18);
         if (plVar6 == (long*)0x0) {
 ...
 while ( uVar8 < uVar5 );
         ...
         LAB_00101218:uVar11 = __hb_CrapPool;
   ...
   LAB_00101173:*(uint*)( (long)__mutex + 0x2c ) = uVar5;
   plVar10 = plVar6 + uVar7 * 3;
   *plVar10 = param_2;
   plVar10[1] = param_3;
   plVar10[2] = param_4;
   LAB_0010118a:pthread_mutex_unlock(__mutex);
   LAB_00100fc5:return -1 < __mutex[1].__data.__lock && plVar10 != (long*)0x0;
}
...
void hb_face_reference_table(long param_1, int param_2) {
   long lVar1;
   if (( ( param_2 != 0 ) && ( *(code**)( param_1 + 0x20 ) != (code*)0x0 ) ) && ( lVar1 = ( **(code**)( param_1 + 0x20 ) )(param_1, param_2, *(undefined8*)( param_1 + 0x28 )) ),lVar1 != 0) {
      return;
   }
...
void hb_face_reference_blob(long param_1) {
   long lVar1;
   if (( *(code**)( param_1 + 0x20 ) != (code*)0x0 ) && ( lVar1 = ( **(code**)( param_1 + 0x20 ) )(param_1, 0, *(undefined8*)( param_1 + 0x28 )) ),lVar1 != 0) {
      return;
   }
...
void hb_face_set_get_table_tags_func(long param_1, undefined8 param_2, undefined8 param_3, code *param_4) {
...
;
 ...
 while ( lVar27 != 0 );
   LAB_00101d36:this_00 = (accelerator_t*)&_hb_NullPool;
   LAB_00101591:puVar26 = *(undefined**)( this_00 + 8 );
...
;
 ...
 while ( iVar21 <= iVar19 );
      LAB_001015fc:pbVar16 = &_hb_NullPool;
   }

   LAB_00101603:uVar6 = *(uint*)( pbVar16 + 3 );
   puVar25 = (uint*)&_hb_NullPool;
   if (uVar6 != 0) {
      puVar25 = (uint*)( puVar26 + ( uVar6 >> 0x18 | ( uVar6 & 0xff0000 ) >> 8 | ( uVar6 & 0xff00 ) << 8 | uVar6 << 0x18 ) );
   }
   ...
   if (uVar6 != 0) {
      do {
         while (true) {
            uVar14 = (uint)(byte)puVar25[lVar27 + 1] * 0x10000 + ( uint ) * (byte*)( (long)puVar25 + lVar27 * 4 + 5 ) * 0x100 + ( uint ) * (byte*)( (long)puVar25 + lVar27 * 4 + 6 );
            ...
            if (bVar5 == 0 && uVar6 >= uVar14) {
               *(undefined4*)( param_3 + 0x14 ) = 0xffffffff;
               ...
               if (uVar6 + 1 == ( uVar23 + 1 ) * 0x200) {
                  ...
                  if ((int)uVar8 < iVar19) {
                     LAB_00101b62:puVar9 = (undefined4*)hb_bit_set_t::page_for(this, uVar14, false);
                     if (puVar9 != (undefined4*)0x0) {
                        ...
                        if (uVar7 == uVar23) {
                           ...
                           if (puVar10 == puVar9 + uVar15 * 2 + 2) {
                              *(ulong*)( puVar9 + uVar20 * 2 + 2 ) = ( 1L << local_60 ) + -1 + lVar24 * -2 & uVar18;
                           }
 else {
                              ...
                              *(ulong*)( puVar9 + uVar15 * 2 + 2 ) = *(ulong*)( puVar9 + uVar15 * 2 + 2 ) & lVar24 * -2;
                           }
                  ...
                  if (( ( (int)uVar13 < (int)uVar23 ) && ( uVar7 != uVar23 ) ) && ( puVar9 = (undefined4*)hb_bit_set_t::page_for(this, uVar6, false) ),puVar9 != (undefined4*)0x0) {
               ...
               LAB_00101aca:hb_bit_set_t::del_pages(this, iVar19, uVar13);
            }

            joined_r0x00101ae0:iVar19 = (int)lVar27;
            lVar27 = lVar27 + 1;
...
;
         ...
         if (uVar14 >> 9 == uVar23) {
            ...
            if (puVar9 != (undefined4*)0x0) {
               ...
               if (puVar10 == puVar9 + uVar20 * 2 + 2) {
                  *(ulong*)( puVar9 + uVar18 * 2 + 2 ) = lVar24 - lVar22 | *(ulong*)( puVar9 + uVar18 * 2 + 2 );
               }
 else {
         ...
         *(ulong*)( puVar9 + (ulong)uVar7 * 2 + 2 ) = -(1L << (local_60 & 0x3f)) | *(ulong*)( puVar9 + (ulong)uVar7 * 2 + 2 );
 ...
 while ( (uint)lVar27 < uVar12 );
   ...
   LAB_001017de:uVar6 = *(uint*)( pbVar16 + 7 );
   puVar25 = (uint*)&_hb_NullPool;
   if (uVar6 != 0) {
      puVar25 = (uint*)( puVar26 + ( uVar6 >> 0x18 | ( uVar6 & 0xff0000 ) >> 8 | ( uVar6 & 0xff00 ) << 8 | uVar6 << 0x18 ) );
   }
   ...
   uVar6 = *puVar25;
   puVar25 = puVar25 + 1;
   puVar17 = (uint*)( ( ulong )(uVar6 >> 0x18 | ( uVar6 & 0xff0000 ) >> 8 | ( uVar6 & 0xff00 ) << 8 | uVar6 << 0x18) * 5 + (long)puVar25 );
   if (uVar6 != 0) {
      do {
         uVar6 = ( uint )(byte) * puVar25 * 0x10000 + ( uint ) * (byte*)( (long)puVar25 + 1 ) * 0x100 + ( uint ) * (byte*)( (long)puVar25 + 2 );
         if (*(char*)( param_3 + 0x40 ) == '\0') {
            if (*(char*)( param_3 + 0x10 ) != '\0') {
               *(undefined4*)( param_3 + 0x14 ) = 0xffffffff;
               puVar9 = (undefined4*)hb_bit_set_t::page_for((hb_bit_set_t*)( param_3 + 0x10 ), uVar6, true);
               if (puVar9 != (undefined4*)0x0) {
                  *(ulong*)( puVar9 + ( ulong )(uVar6 >> 6 & 7) * 2 + 2 ) = *(ulong*)( puVar9 + ( ulong )(uVar6 >> 6 & 7) * 2 + 2 ) | 1L << ( (byte)uVar6 & 0x3f );
                  *puVar9 = 0xffffffff;
               }
 ...
 else if (( *(char*)( param_3 + 0x10 ) != '\0' ) && ( puVar9 = (undefined4*)hb_bit_set_t::page_for((hb_bit_set_t*)( param_3 + 0x10 ), uVar6, false) ),puVar9 != (undefined4*)0x0) {
            *(undefined4*)( param_3 + 0x14 ) = 0xffffffff;
            bVar5 = (byte)uVar6 & 0x3f;
            *(ulong*)( puVar9 + ( ulong )(uVar6 >> 6 & 7) * 2 + 2 ) = *(ulong*)( puVar9 + ( ulong )(uVar6 >> 6 & 7) * 2 + 2 ) & ( -2L << bVar5 | 0xfffffffffffffffeU >> 0x40 - bVar5 );
            *puVar9 = 0xffffffff;
         }
...
;
 ...
 while ( lVar2 != 0 );
   LAB_00101e62 = (accelerator_t*)&_hb_NullPool;
   LAB_00101d9b:uVar4 = *(uint*)( param_1 + 0x18 );
   if (uVar4 == 0xffffffff) {
...
;
 ...
 while ( lVar2 != 0 );
   LAB_0010201d = (accelerator_t*)&_hb_NullPool;
   LAB_00101e9f:puVar8 = *(undefined**)( this + 8 );
   ...
   uVar6 = *(uint*)( puVar8 + 6 );
   pbVar9 = puVar8 + 10;
   pbVar7 = pbVar9 + ( ulong )(uVar6 >> 0x18 | ( uVar6 & 0xff0000 ) >> 8 | ( uVar6 & 0xff00 ) << 8 | uVar6 << 0x18) * 0xb;
   if (uVar6 != 0) {
      do {
            ...
            if (*(char*)( param_2 + 0x10 ) != '\0') {
               *(undefined4*)( param_2 + 0x14 ) = 0xffffffff;
               ...
               if (puVar5 != (undefined4*)0x0) {
                  *(ulong*)( puVar5 + ( ulong )(uVar6 >> 6 & 7) * 2 + 2 ) = *(ulong*)( puVar5 + ( ulong )(uVar6 >> 6 & 7) * 2 + 2 ) | 1L << ( (byte)uVar6 & 0x3f );
                  *puVar5 = 0xffffffff;
               }
 ...
 else if (( *(char*)( param_2 + 0x10 ) != '\0' ) && ( puVar5 = (undefined4*)hb_bit_set_t::page_for((hb_bit_set_t*)( param_2 + 0x10 ), uVar6, false) ),puVar5 != (undefined4*)0x0) {
            *(undefined4*)( param_2 + 0x14 ) = 0xffffffff;
            bVar4 = (byte)uVar6 & 0x3f;
            *(ulong*)( puVar5 + ( ulong )(uVar6 >> 6 & 7) * 2 + 2 ) = *(ulong*)( puVar5 + ( ulong )(uVar6 >> 6 & 7) * 2 + 2 ) & ( -2L << bVar4 | 0xfffffffffffffffeU >> 0x40 - bVar4 );
            *puVar5 = 0xffffffff;
         }
...
;
 ...
 while ( lVar2 != 0 );
   LAB_00102249 = (accelerator_t*)&_hb_NullPool;
   LAB_001020df:uVar4 = *(uint*)( param_1 + 0x18 );
   if (uVar4 == 0xffffffff) {
      uVar4 = hb_face_t::load_num_glyphs();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* bool OT::cmap::accelerator_t::get_glyph_from<OT::CmapSubtableFormat12>(void const*, unsigned int,
   ...
   if (-1 < iVar3) {
      ...
      do {
         ...
         if (param_2 < uVar4) {
            ...
            uVar1 = puVar5[1];
            if (param_2 <= ( uVar1 >> 0x18 | ( uVar1 & 0xff0000 ) >> 8 | ( uVar1 & 0xff00 ) << 8 | uVar1 << 0x18 )) goto LAB_00102485;
            iVar6 = uVar2 + 1;
         }
 ...
 while ( iVar6 <= iVar3 );
   ...
   if (uVar4 <= ( _DAT_0010a02c >> 0x18 | ( _DAT_0010a02c & 0xff0000 ) >> 8 | ( _DAT_0010a02c & 0xff00 ) << 8 | _DAT_0010a02c << 0x18 )) {
      puVar5 = (uint*)&_hb_Null_OT_CmapSubtableLongGroup;
      LAB_00102485:uVar2 = puVar5[2];
...
/* hb_bit_set_t::resize(unsigned int, bool, bool) */hb_bit_set_t hb_bit_set_t::resize(hb_bit_set_t *this, uint param_1, bool param_2, bool param_3) {
 ...
 while ( uVar8 < param_1 );
      ...
      LAB_001025f7:*(uint*)( this + 0x20 ) = ~uVar5;
      goto LAB_001025fc;
   }
   ...
   if (uVar5 == 0) {
      param_1 = 1;
      uVar8 = 1;
      LAB_00102789:pvVar2 = *(void**)( this + 0x28 );
      param_3 = (bool)hVar1;
      LAB_00102790:pvVar2 = realloc(pvVar2, (ulong)uVar8 * 0x48);
      if (pvVar2 == (void*)0x0) {
         uVar5 = *(uint*)( this + 0x20 );
         if (uVar5 < uVar8) goto LAB_001025f7;
      }
 else {
         LAB_001027ac:*(void**)( this + 0x28 ) = pvVar2;
   ...
   LAB_00102543:if (( (uint)uVar7 < param_1 ) && ( param_2 )) {
 ...
 while ( uVar5 < param_1 );
      ...
      LAB_0010260f:if (( (uint)uVar6 < param_1 ) && ( param_2 )) {
 ...
 while ( uVar8 < uVar4 );
      ...
      LAB_001026b4:uVar8 = *(uint*)( this + 0x24 );
   }
 else {
      LAB_001026f6:uVar8 = *(uint*)( this + 0x24 );
      uVar4 = (uint)uVar6;
      if (uVar4 <= uVar8) {
         uVar6 = (ulong)uVar8;
      }
      ...
      uVar9 = (uint)uVar6;
      if (uVar5 < uVar9) {
         LAB_00102680:if (0x38e38e3 < (uint)uVar6) goto LAB_001025f7;
         pvVar2 = *(void**)( this + 0x28 );
         LAB_00102691:uVar8 = (uint)uVar6;
         ...
         if (pvVar2 == (void*)0x0) {
            ...
            LAB_001026ad:*(void**)( this + 0x28 ) = pvVar2;
            *(uint*)( this + 0x20 ) = uVar8;
         }
   ...
   *(uint*)( this + 0x24 ) = uVar4;
   LAB_001025fc:*this = (hb_bit_set_t)0x0;
   return (hb_bit_set_t)0x0;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* hb_bit_set_t::compact(hb_vector_t<unsigned int, false>&, unsigned int) */void hb_bit_set_t::compact(hb_bit_set_t *this, hb_vector_t *param_1, uint param_2) {
   undefined8 *puVar1;
   undefined8 *puVar2;
   long lVar3;
   undefined8 uVar4;
      ...
      do {
         ...
         if (uVar5 < *(uint*)( param_1 + 4 )) {
            ...
            if (*__s != 0xffffffff) {
               ...
               LAB_001029fc:if ((uint)uVar8 < *(uint*)( this + 0x14 )) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* hb_bit_set_t::del_pages(int, int) */void hb_bit_set_t::del_pages(hb_bit_set_t *this, int param_1, int param_2) {
   int *piVar1;
   undefined8 uVar2;
   int *piVar3;
   void *__s;
   ...
   if (param_1 <= param_2) {
      ...
      if (iVar8 < 1) {
         ...
         LAB_00102b25:piVar1 = *(int**)( this + 0x18 );
         uVar7 = 0;
         piVar3 = piVar1;
         do {
            while (true) {
...
;
 ...
 while ( piVar1 + (ulong)uVar5 * 2 != piVar3 );
         LAB_00102b7a:compact(this, (hb_vector_t*)local_48, uVar6);
         resize(this, uVar6, true, false);
         if (iVar8 != 0) {
            LAB_00102ba3:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
               free(local_40);
               return;
            }
   ...
   LAB_00102cac:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
   ...
   LAB_00102d3c:if (param_2) {
      ...
      if (cVar6 != '\0') {
         ...
         *(ulong*)( *(long*)( this + 0x18 ) + (ulong)uVar8 * 8 ) = CONCAT44(uVar4, uVar9);
         uVar7 = uVar8;
         LAB_00102dd5:*(uint*)( this + 8 ) = uVar7;
...
/* hb_bit_set_t::del_range(unsigned int, unsigned int) */void hb_bit_set_t::del_range(hb_bit_set_t *this, uint param_1, uint param_2) {
   undefined4 *puVar1;
   int iVar2;
   int iVar3;
   uint uVar4;
   ...
   *(undefined4*)( this + 4 ) = 0xffffffff;
   ...
   if (param_2 + 1 == ( uVar14 + 1 ) * 0x200) {
      ...
      uVar8 = uVar14;
      if (( iVar11 <= (int)uVar4 ) || ( puVar5 = (undefined4*)page_for(this, param_1, false) ),puVar5 == (undefined4*)0x0) goto LAB_00102f4d;
      LAB_00102fb7:bVar7 = (byte)param_1 & 0x3f;
      ...
      *puVar5 = 0xffffffff;
      ...
      if (( (int)uVar4 < iVar11 ) && ( puVar5 = (undefined4*)page_for(this, param_1, false) ),puVar5 != (undefined4*)0x0) goto LAB_00102fb7;
   }

   if (( ( (int)uVar8 < (int)uVar14 ) && ( uVar10 != uVar14 ) ) && ( puVar5 = (undefined4*)page_for(this, param_2, false) ),puVar5 != (undefined4*)0x0) {
   ...
   LAB_00102f4d:del_pages(this, iVar11, uVar8);
   return;
}
/* OT::ResourceMap::sanitize(hb_sanitize_context_t*, void const*) const */undefined8 OT::ResourceMap::sanitize(ResourceMap *this, hb_sanitize_context_t *param_1, void *param_2) {
   long lVar1;
   uint *puVar2;
   ushort uVar3;
   ushort uVar4;
   ...
   uint uVar14;
   ResourceMap *pRVar15;
   if (( this + ( 0x1c - *(long*)( param_1 + 8 ) ) <= (ResourceMap*)( ulong ) * (uint*)( param_1 + 0x18 ) ) && ( uVar3 = *(ushort*)( this + 0x18 ) ),this + ( 0x1a - *(long*)( param_1 + 8 ) ) <= (ResourceMap*)( ulong ) * (uint*)( param_1 + 0x18 )) {
      pRVar8 = this + ( ushort )(*(ushort*)( this + 0x18 ) << 8 | *(ushort*)( this + 0x18 ) >> 8);
      pRVar7 = pRVar8 + 2;
      if (( ( ulong )((long)pRVar7 - *(long*)( param_1 + 8 )) <= ( ulong ) * (uint*)( param_1 + 0x18 ) ) && ( ( ( ( ulong )((long)pRVar7 - *(long*)( param_1 + 8 )) <= ( ulong ) * (uint*)( param_1 + 0x18 ) && ( uVar14 = ( uint )(ushort)(*(ushort*)pRVar8 << 8 | *(ushort*)pRVar8 >> 8) * 8 + 8 ),uVar14 <= ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - (int)pRVar7) ) ) && ( iVar6 = *(int*)( param_1 + 0x1c ) - uVar14 ),*(int*)( param_1 + 0x1c ) = iVar6,0 < iVar6 )) {
         uVar4 = *(ushort*)pRVar8;
         pRVar7 = pRVar8 + 10;
         if (( ulong )((long)pRVar7 - *(long*)( param_1 + 8 )) <= ( ulong ) * (uint*)( param_1 + 0x18 )) {
            do {
               ...
               pRVar9 = this + ( ulong )(ushort)(*(ushort*)( pRVar7 + -2 ) << 8 | *(ushort*)( pRVar7 + -2 ) >> 8) + ( ulong )(ushort)(uVar3 << 8 | uVar3 >> 8);
               ...
               *(int*)( param_1 + 0x1c ) = iVar11;
               ...
               if (iVar6 != 0) {
                  ...
                  do {
                     ...
                     puVar10 = (uint*)( (long)(int)( (uint)(byte)pRVar15[-7] * 0x10000 + (uint)(byte)pRVar15[-6] * 0x100 + (uint)(byte)pRVar15[-5] ) + (long)param_2 );
                     puVar2 = puVar10 + 1;
                     ...
                     *(int*)( param_1 + 0x1c ) = iVar11;
                     ...
                     iVar11 = (uint)(byte)pRVar15[-7] * 0x10000 + (uint)(byte)pRVar15[-6] * 0x100 + (uint)(byte)pRVar15[-5];
...
/* OT::OpenTypeFontFile::get_face(unsigned int, unsigned int*) const */OpenTypeFontFile * __thiscall
OT::OpenTypeFontFile::get_face(OpenTypeFontFile *this,uint param_1,uint *param_2){
   ...
   if (uVar4 < 0x74727566) {
      if (uVar2 == 0x10000) {
         ...
         uVar1 = ( ulong )(ushort)(*(ushort*)( this + (ulong)uVar6 + 0x18 ) << 8 | *(ushort*)( this + (ulong)uVar6 + 0x18 ) >> 8);
         ...
         while (true) {
            ...
            if (( *(int*)pOVar5 == 0x746e6673 ) && ( param_1 < ( ushort )(*(ushort*)( pOVar5 + 4 ) << 8 | *(ushort*)( pOVar5 + 4 ) >> 8) + 1 )) break;
            lVar7 = lVar7 + 8;
            if (uVar2 == uVar4) {
               pOVar5 = (OpenTypeFontFile*)&_hb_NullPool;
               LAB_0010359f:if (param_2 != (uint*)0x0) {
...
;
         lVar7 = (ulong)param_1 * 0xc + ( ulong )(ushort)(*(ushort*)( this + (ulong)uVar6 + 0x18 ) << 8 | *(ushort*)( this + (ulong)uVar6 + 0x18 ) >> 8) + ( ulong )(ushort)(*(ushort*)( pOVar5 + 6 ) << 8 | *(ushort*)( pOVar5 + 6 ) >> 8) + (ulong)uVar6;
         pOVar5 = this + (long)(int)( (uint)(byte)this[lVar7 + 5] * 0x10000 + (uint)(byte)this[lVar7 + 6] * 0x100 + 0x100 + (uint)(byte)this[lVar7 + 7] ) + 4;
         goto LAB_0010359f;
      }
      ...
      if (( ushort )(*(ushort*)( this + 4 ) << 8 | *(ushort*)( this + 4 ) >> 8) - 1 < 2) {
         ...
         uVar2 = *(uint*)pOVar5;
         if (uVar2 != 0) {
            return this + ( uVar2 >> 0x18 | ( uVar2 & 0xff0000 ) >> 8 | ( uVar2 & 0xff00 ) << 8 | uVar2 << 0x18 );
         }
...
/* OT::OpenTypeFontFile::sanitize(hb_sanitize_context_t*) const */undefined8 OT::OpenTypeFontFile::sanitize(OpenTypeFontFile *this, hb_sanitize_context_t *param_1) {
   ...
   if (uVar9 != 0x65757274) {
      if (uVar5 < 0x74727566) {
         if (uVar9 == 0x10000) {
            if ((OpenTypeFontFile*)( ulong ) * (uint*)( param_1 + 0x18 ) < this + ( 0x10 - *(long*)( param_1 + 8 ) )) {
               return 0;
            }
            ...
            uVar9 = *(uint*)this;
            uVar5 = *(uint*)( this + 8 );
            pOVar8 = this + ( uVar9 >> 0x18 | ( uVar9 & 0xff0000 ) >> 8 | ( uVar9 & 0xff00 ) << 8 | uVar9 << 0x18 );
            ...
            *(int*)( param_1 + 0x1c ) = iVar7;
            ...
            if ((OpenTypeFontFile*)( ulong ) * (uint*)( param_1 + 0x18 ) < this + ( 8 - *(long*)( param_1 + 8 ) )) {
               return 0;
            }

            uVar9 = *(uint*)( this + 4 );
            uVar3 = ResourceMap::sanitize((ResourceMap*)( this + ( uVar9 >> 0x18 | ( uVar9 & 0xff0000 ) >> 8 | ( uVar9 & 0xff00 ) << 8 | uVar9 << 0x18 ) ), param_1, pOVar8);
            return uVar3;
         }
            ...
            *(int*)( param_1 + 0x1c ) = iVar7;
            ...
            do {
               ...
               if (uVar6 != 0) {
                  ...
                  if (( ( ( ( ulong ) * (uint*)( param_1 + 0x18 ) < ( ulong )((long)pOVar1 - *(long*)( param_1 + 8 )) ) || ( ( ulong ) * (uint*)( param_1 + 0x18 ) < ( ulong )((long)pOVar1 - *(long*)( param_1 + 8 )) ) ) || ( uVar6 = ( uint )(ushort)(*(ushort*)( this + (ulong)uVar6 + 4 ) << 8 | *(ushort*)( this + (ulong)uVar6 + 4 ) >> 8)(uint)((int)*(undefined8*)( param_1 + 0x10 ) - (int)pOVar1) < uVar6 * 0x10 ) ) || ( iVar7 = *(int*)( param_1 + 0x1c ) + uVar6 * -0x10 ),*(int*)( param_1 + 0x1c ) = iVar7,iVar7 < 1) {
               ...
               uVar9 = uVar9 + 1;
               pOVar8 = pOVar8 + 4;
               if (( uVar5 >> 0x18 | ( uVar5 & 0xff0000 ) >> 8 | ( uVar5 & 0xff00 ) << 8 | uVar5 << 0x18 ) <= uVar9) {
                  return 1;
               }
 ...
 while ( true );
   ...
   pOVar8 = this + 0xc;
   if (( ( ulong )((long)pOVar8 - *(long*)( param_1 + 8 )) <= ( ulong ) * (uint*)( param_1 + 0x18 ) ) && ( ( ulong )((long)pOVar8 - *(long*)( param_1 + 8 )) <= ( ulong ) * (uint*)( param_1 + 0x18 ) )) {
...
/* OT::CmapSubtableFormat4::accelerator_t::collect_unicodes(hb_set_t*) const */void OT::CmapSubtableFormat4::accelerator_t::collect_unicodes(accelerator_t *this, hb_set_t *param_1) {
   hb_bit_set_t *phVar1;
   undefined4 *puVar2;
   ushort uVar3;
   ushort uVar4;
   ...
   if (local_4c != 0) {
      lVar26 = *(long*)( this + 8 );
      uVar18 = local_4c - 1;
      if (( *(short*)( lVar26 + (ulong)uVar18 * 2 ) != -1 ) || ( local_4c = uVar18 != 0 )) {
         lVar20 = 0;
         do {
            ...
            if (param_1[0x40] == (hb_set_t)0x0) {
               ...
               *(undefined4*)( param_1 + 0x14 ) = 0xffffffff;
               ...
               if (uVar23 == bVar21) {
                  ...
                  if (puVar11 + uVar24 * 2 + 2 == puVar19) {
                     *(ulong*)( puVar11 + uVar24 * 2 + 2 ) = lVar26 - lVar12 | *(ulong*)( puVar11 + uVar24 * 2 + 2 );
                  }
 else {
                     ...
                     *(ulong*)( puVar11 + uVar13 * 2 + 2 ) = *(ulong*)( puVar11 + uVar13 * 2 + 2 ) | lVar26 - 1U;
                  }
               ...
               *(ulong*)( puVar11 + (ulong)uVar9 * 2 + 2 ) = -(1L << (bVar15 & 0x3f)) | *(ulong*)( puVar11 + (ulong)uVar9 * 2 + 2 );
 ...
 while ( uVar23 < bVar21 );
               ...
               *puVar11 = 0xffffffff;
               ...
               LAB_00103e48:uVar23 = (uint)uVar17;
               do {
                  uVar3 = *(ushort*)( *(long*)( this + 0x10 ) + lVar20 * 2 );
                  if (( ushort )(( uVar3 << 8 | uVar3 >> 8 ) + (short)uVar23) == 0) {
                     if (param_1[0x40] == (hb_set_t)0x0) {
                        if (( param_1[0x10] != (hb_set_t)0x0 ) && ( puVar11 = (undefined4*)hb_bit_set_t::page_for((hb_bit_set_t*)( param_1 + 0x10 ), uVar23, false) ),puVar11 != (undefined4*)0x0) {
                           *(undefined4*)( param_1 + 0x14 ) = 0xffffffff;
                           bVar14 = (byte)uVar23 & 0x3f;
                           *(ulong*)( puVar11 + ( ulong )(uVar23 >> 6 & 7) * 2 + 2 ) = *(ulong*)( puVar11 + ( ulong )(uVar23 >> 6 & 7) * 2 + 2 ) & ( -2L << bVar14 | 0xfffffffffffffffeU >> 0x40 - bVar14 );
                           *puVar11 = 0xffffffff;
                        }
                        ...
                        *(undefined4*)( param_1 + 0x14 ) = 0xffffffff;
                        puVar11 = (undefined4*)hb_bit_set_t::page_for((hb_bit_set_t*)( param_1 + 0x10 ), uVar23, true);
                        if (puVar11 != (undefined4*)0x0) {
                           *(ulong*)( puVar11 + ( ulong )(uVar23 >> 6 & 7) * 2 + 2 ) = *(ulong*)( puVar11 + ( ulong )(uVar23 >> 6 & 7) * 2 + 2 ) | 1L << ( (byte)uVar23 & 0x3f );
                           *puVar11 = 0xffffffff;
                        }
 ...
 while ( uVar23 <= uVar18 );
               ...
               LAB_00103b96:if (uVar8 == 0) {
                  LAB_00103e3f:if (uVar17 <= uVar18) goto LAB_00103e48;
               }
 else {
                  LAB_00103ba1:if (uVar17 <= uVar18) {
                     LAB_00103baa:uVar18 = (uint)uVar17;
                     LAB_00103bdb:do {
                        uVar3 = *(ushort*)( *(long*)( this + 8 ) + lVar20 * 2 );
                        uVar23 = ( ( ( ( uint )(uVar8 >> 1) + (int)lVar20 ) - *(int*)( this + 0x28 ) ) + uVar18 ) - ( uint )(ushort)(uVar3 << 8 | uVar3 >> 8);
                        uVar9 = (uint)uVar7;
                        bVar15 = (byte)uVar18;
                                 ...
                                 *(undefined4*)( param_1 + 0x14 ) = 0xffffffff;
                                 ...
                                 if (uVar7 + 1 == ( local_70 + 1 ) * 0x200) {
                                    ...
                                    if ((int)uVar10 < iVar22) {
                                       LAB_00104082:puVar11 = (undefined4*)hb_bit_set_t::page_for(phVar1, uVar18, false);
                                       if (puVar11 != (undefined4*)0x0) {
                                          bVar15 = bVar15 & 0x3f;
                                          ...
                                          if (uVar9 == local_70) {
                                             ...
                                             if (puVar11 + uVar25 * 2 + 2 == puVar19) {
                                                *(ulong*)( puVar11 + uVar13 * 2 + 2 ) = ( ( 1L << bVar15 ) + lVar26 * -2 ) - 1U & uVar24;
                                             }
 else {
                                                ...
                                                *(ulong*)( puVar11 + uVar25 * 2 + 2 ) = *(ulong*)( puVar11 + uVar25 * 2 + 2 ) & lVar26 * -2;
                                             }
                                    ...
                                    uVar16 = uVar27;
                                    if (( ( (int)uVar27 < (int)uVar23 ) && ( uVar9 != uVar23 ) ) && ( puVar11 = (undefined4*)hb_bit_set_t::page_for(phVar1, (uint)uVar7, false) ),puVar11 != (undefined4*)0x0) {
                                       uVar13 = ( ulong )(uVar7 >> 6 & 7);
                                 ...
                                 LAB_00103d33:hb_bit_set_t::del_pages(phVar1, iVar22, uVar16);
                              }
                        ...
                        if (*(short*)( *(long*)( this + 0x20 ) + (ulong)uVar23 * 2 ) == 0) {
                           if (param_1[0x40] == (hb_set_t)0x0) {
                              if (( param_1[0x10] != (hb_set_t)0x0 ) && ( puVar11 = (undefined4*)hb_bit_set_t::page_for((hb_bit_set_t*)( param_1 + 0x10 ), uVar18, false) ),puVar11 != (undefined4*)0x0) {
                                 uVar23 = uVar18 + 1;
                                 *(undefined4*)( param_1 + 0x14 ) = 0xffffffff;
                                 *(ulong*)( puVar11 + ( ulong )(uVar18 >> 6 & 7) * 2 + 2 ) = *(ulong*)( puVar11 + ( ulong )(uVar18 >> 6 & 7) * 2 + 2 ) & ( -2L << ( bVar15 & 0x3f ) | 0xfffffffffffffffeU >> 0x40 - ( bVar15 & 0x3f ) );
                                 *puVar11 = 0xffffffff;
                                 uVar18 = uVar23;
                              ...
                              *(undefined4*)( param_1 + 0x14 ) = 0xffffffff;
                              puVar11 = (undefined4*)hb_bit_set_t::page_for((hb_bit_set_t*)( param_1 + 0x10 ), uVar18, true);
                              if (puVar11 != (undefined4*)0x0) {
                                 *(ulong*)( puVar11 + ( ulong )(uVar18 >> 6 & 7) * 2 + 2 ) = *(ulong*)( puVar11 + ( ulong )(uVar18 >> 6 & 7) * 2 + 2 ) | 1L << ( bVar15 & 0x3f );
                                 *puVar11 = 0xffffffff;
                              }
...
/* OT::VariationSelectorRecord::sanitize(hb_sanitize_context_t*, void const*) const */undefined8 OT::VariationSelectorRecord::sanitize(VariationSelectorRecord *this, hb_sanitize_context_t *param_1, void *param_2) {
   ...
   if (uVar3 == 0) {
      ...
      if (( ulong )((long)puVar1 - *(long*)( param_1 + 8 )) <= ( ulong ) * (uint*)( param_1 + 0x18 )) {
         ...
         if (( uVar3 << 0x18 ) >> 0x1e == 0) {
            lVar7 = *(long*)( param_1 + 8 );
            pVVar4 = (VariationSelectorRecord*)( ulong ) * (uint*)( param_1 + 0x18 );
            if (( ( (VariationSelectorRecord*)( (long)puVar1 - lVar7 ) <= pVVar4 ) && ( uVar2 * 4 <= ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - (int)puVar1) ) ) && ( iVar6 = *(int*)( param_1 + 0x1c ) + uVar2 * -4 ),*(int*)( param_1 + 0x1c ) = iVar6,0 < iVar6) goto LAB_00104332;
         }
   ...
   LAB_00104332:if (pVVar4 < this + ( 0xb - lVar7 )) {
      return 0;
   }
...
joined_r0x00104681:
   ...
   uVar2 = 0;
   LAB_001044f2:if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* OT::cmap::find_subtable(unsigned int, unsigned int) const */cmap * __thiscall OT::cmap::find_subtable(cmap *this,uint param_1,uint param_2){
   ...
   uVar2 = *(ushort*)( this + 2 ) << 8 | *(ushort*)( this + 2 ) >> 8;
   if (uVar2 == 0) {
      LAB_00104d45:uVar3 = *(uint*)( pcVar4 + 4 );
      if (*(uint*)( pcVar4 + 4 ) == 0) {
         return (cmap*)0x0;
      }
...
;
 ...
 while ( iVar5 <= iVar6 );
      LAB_00104d69:uVar3 = _DAT_0010a044;
      if (_DAT_0010a044 == 0) {
         return (cmap*)0x0;
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* OT::cmap::find_best_subtable(bool*, bool*, bool*) const */cmap * __thiscall OT::cmap::find_best_subtable(cmap *this,bool *param_1,bool *param_2,bool *param_3){
   ...
   if (uVar1 == 0) {
      if (_DAT_0010a044 == 0) {
         LAB_00104ff9:pcVar4 = (cmap*)find_subtable(this, 0, 2);
         if (pcVar4 != (cmap*)0x0) {
            return pcVar4;
         }
...
;
 ...
 while ( iVar5 <= iVar6 );
         LAB_00105083:pcVar4 = (cmap*)&_hb_NullPool;
         LAB_00104ea1:uVar3 = *(uint*)( pcVar4 + 4 );
         if (uVar3 == 0) {
            iVar5 = 0;
            iVar6 = iVar7;
            do {
 ...
 while ( iVar5 <= iVar6 );
            pcVar4 = (cmap*)&_hb_NullPool;
            LAB_00104ef2:uVar3 = *(uint*)( pcVar4 + 4 );
            if (uVar3 == 0) {
               iVar5 = 0;
               iVar6 = iVar7;
               do {
 ...
 while ( iVar5 <= iVar6 );
               pcVar4 = (cmap*)&_hb_NullPool;
               LAB_00104f42:uVar3 = *(uint*)( pcVar4 + 4 );
               if (uVar3 == 0) {
                  iVar5 = 0;
                  iVar6 = iVar7;
                  do {
                     ...
                     if (( ushort )(uVar1 << 8 | uVar1 >> 8) < 4) {
                        ...
                        LAB_00104f54:iVar6 = uVar3 - 1;
                     }

                  }
 while ( iVar5 <= iVar6 );
                  pcVar4 = (cmap*)&_hb_NullPool;
                  LAB_00104fa5:uVar3 = *(uint*)( pcVar4 + 4 );
                  if (uVar3 == 0) {
                     iVar5 = 0;
                     do {
 ...
 while ( iVar5 <= iVar7 );
                     pcVar4 = (cmap*)&_hb_NullPool;
                     LAB_00104fee:uVar3 = *(uint*)( pcVar4 + 4 );
   ...
   LAB_00104e1a:return this + ( uVar3 >> 0x18 | ( uVar3 & 0xff0000 ) >> 8 | ( uVar3 & 0xff00 ) << 8 | uVar3 << 0x18 );
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* hb_hashmap_t<unsigned int, unsigned int, true>::alloc(unsigned int) */hb_hashmap_t<unsigned_int,unsigned_int,true> hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc(hb_hashmap_t<unsigned_int,unsigned_int,true> *this, uint param_1) {
   ...
   if (hVar10 == (hb_hashmap_t<unsigned_int,unsigned_int,true>)0x0) {
      LAB_001055a3:hVar10 = (hb_hashmap_t<unsigned_int,unsigned_int,true>)0x0;
   }
 else {
      if (param_1 == 0) {
      ...
      if (uVar14 == 0) {
         ...
         iVar7 = 0xc;
         __size = 0xc;
         LAB_001052e9:pvVar4 = (void*)__memset_chk(pvVar4, 0, iVar7, __size);
      }
 else {
         iVar7 = 0x1f;
         if (uVar14 != 0) {
         ...
         if (pvVar4 == (void*)0x0) {
            LAB_0010559f:this[0x10] = (hb_hashmap_t<unsigned_int,unsigned_int,true>)0x0;
            goto LAB_001055a3;
         }
 ...
 while ( ( bVar1 & 2 ) != 0 );
                  if (uVar12 == 0xffffffff) {
                     LAB_0010554a:uVar13 = uVar13 + 1;
                  }
 else {
                     LAB_00105464:lVar5 = (ulong)uVar12 * 0xc;
                     LAB_0010546f:piVar6 = (int*)( lVar2 + lVar5 );
            ...
            LAB_001053b0:piVar15 = piVar15 + 3;
         }
 while ( __ptr + (ulong)uVar14 * 3 != piVar15 );
   ...
   LAB_0010550d:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* OT::CmapSubtableFormat4::accelerator_t::collect_mapping(hb_set_t*, hb_map_t*) const */void OT::CmapSubtableFormat4::accelerator_t::collect_mapping(accelerator_t *this, hb_set_t *param_1, hb_map_t *param_2) {
   ...
   uVar10 = uVar2 - 1;
   lVar7 = *(long*)( this + 8 );
   if (( *(short*)( lVar7 + (ulong)uVar10 * 2 ) == -1 ) && ( uVar2 = uVar10 == 0 )) {
      return;
   }
               ...
               if (uVar14 != 0) {
                     ...
                     if (param_1[0x10] != (hb_set_t)0x0) {
                        *(undefined4*)( param_1 + 0x14 ) = 0xffffffff;
                        ...
                        if (puVar8 != (undefined4*)0x0) {
                           *(ulong*)( puVar8 + ( ulong )(( uint )(uVar11 >> 6) & 7) * 2 + 2 ) = *(ulong*)( puVar8 + ( ulong )(( uint )(uVar11 >> 6) & 7) * 2 + 2 ) | 1L << ( (byte)uVar11 & 0x3f );
                           *puVar8 = 0xffffffff;
                        }
 ...
 else if (( param_1[0x10] != (hb_set_t)0x0 ) && ( puVar8 = (undefined4*)hb_bit_set_t::page_for(this_00, uVar6, false) ),puVar8 != (undefined4*)0x0) {
                     *(undefined4*)( param_1 + 0x14 ) = 0xffffffff;
                     bVar3 = (byte)uVar11 & 0x3f;
                     *(ulong*)( puVar8 + ( ulong )(( uint )(uVar11 >> 6) & 7) * 2 + 2 ) = *(ulong*)( puVar8 + ( ulong )(( uint )(uVar11 >> 6) & 7) * 2 + 2 ) & ( -2L << bVar3 | 0xfffffffffffffffeU >> 0x40 - bVar3 );
                     *puVar8 = 0xffffffff;
                  }
                  ...
                  if (param_2[0x10] != (hb_map_t)0x0) {
                     ...
                     if (*(uint*)( param_2 + 0x1c ) <= ( uVar19 >> 1 ) + uVar19) {
                        cVar4 = hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc((hb_hashmap_t<unsigned_int,unsigned_int,true>*)param_2, 0);
 ...
 while ( ( bVar3 & 2 ) != 0 );
                        if (uVar18 == 0xffffffff) {
                           LAB_00105a09:uVar19 = uVar19 + 1;
                        }
 else {
                           LAB_00105983:lVar9 = (ulong)uVar18 * 0xc;
                           LAB_0010598d:puVar16 = (uint*)( lVar7 + lVar9 );
                        ...
                        *(int*)( param_2 + 0x14 ) = iVar20 + 1;
                        if (( uVar5 < uVar17 ) && ( *(uint*)( param_2 + 0x1c ) < uVar19 << 3 )) {
                           hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc((hb_hashmap_t<unsigned_int,unsigned_int,true>*)param_2, *(uint*)( param_2 + 0x1c ) - 8);
                        }
               ...
               LAB_001059c8:uVar11 = ( ulong )(uVar6 + 1);
 ...
 while ( uVar6 + 1 <= uVar10 );
         ...
         while (true) {
            uVar14 = (uint)uVar13;
            uVar6 = ( ( ( ( uint )(uVar5 >> 1) + (int)lVar15 ) - *(int*)( this + 0x28 ) ) + uVar14 ) - (int)uVar11;
               ...
               if (param_1[0x40] == (hb_set_t)0x0) {
                  if (param_1[0x10] != (hb_set_t)0x0) {
                     *(undefined4*)( param_1 + 0x14 ) = 0xffffffff;
                     ...
                     if (puVar8 != (undefined4*)0x0) {
                        *(ulong*)( puVar8 + ( ulong )(( uint )(uVar13 >> 6) & 7) * 2 + 2 ) = *(ulong*)( puVar8 + ( ulong )(( uint )(uVar13 >> 6) & 7) * 2 + 2 ) | 1L << ( (byte)uVar13 & 0x3f );
                        *puVar8 = 0xffffffff;
                     }
 ...
 else if (( param_1[0x10] != (hb_set_t)0x0 ) && ( puVar8 = (undefined4*)hb_bit_set_t::page_for(this_00, uVar14, false) ),puVar8 != (undefined4*)0x0) {
                  *(undefined4*)( param_1 + 0x14 ) = 0xffffffff;
                  bVar3 = (byte)uVar13 & 0x3f;
                  *(ulong*)( puVar8 + ( ulong )(( uint )(uVar13 >> 6) & 7) * 2 + 2 ) = *(ulong*)( puVar8 + ( ulong )(( uint )(uVar13 >> 6) & 7) * 2 + 2 ) & ( -2L << bVar3 | 0xfffffffffffffffeU >> 0x40 - bVar3 );
                  *puVar8 = 0xffffffff;
               }
 ...
 while ( ( bVar3 & 2 ) != 0 );
                     if (uVar19 == 0xffffffff) {
                        LAB_00105835:uVar6 = uVar6 + 1;
                     }
 else {
                        LAB_001057bb:lVar9 = (ulong)uVar19 * 0xc;
                        LAB_001057c5:puVar16 = (uint*)( lVar7 + lVar9 );
            ...
            LAB_00105801:uVar13 = ( ulong )(uVar14 + 1);
            uVar21 = uVar21 + 0x9e3779b1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* OT::CmapSubtableLongSegmented<OT::CmapSubtableFormat12>::collect_unicodes(hb_set_t*, unsigned
   int) const */void OT::CmapSubtableLongSegmented<OT::CmapSubtableFormat12>::collect_unicodes(CmapSubtableLongSegmented<OT::CmapSubtableFormat12> *this, hb_set_t *param_1, uint param_2) {
   hb_bit_set_t *this_00;
   undefined4 *puVar1;
   int iVar2;
   int iVar3;
   ...
   if (*(int*)( this + 0xc ) != 0) {
      ...
      do {
         ...
         if (uVar12 < ( uVar11 >> 0x18 | ( uVar11 & 0xff0000 ) >> 8 | ( uVar11 & 0xff00 ) << 8 | uVar11 << 0x18 )) {
            ...
            uVar5 = *(uint*)( this + 0xc );
            if (( uVar5 >> 0x18 | ( uVar5 & 0xff0000 ) >> 8 | ( uVar5 & 0xff00 ) << 8 | uVar5 << 0x18 ) <= uVar12) goto LAB_00105dee;
            uVar5 = *(uint*)( pCVar15 + 8 );
            if (*(uint*)( pCVar15 + 8 ) != 0) goto LAB_00105e00;
            uVar5 = *(uint*)( this + 0xc );
            pCVar10 = pCVar15;
            if (( uVar5 >> 0x18 | ( uVar5 & 0xff0000 ) >> 8 | ( uVar5 & 0xff00 ) << 8 | uVar5 << 0x18 ) <= uVar12) goto LAB_00105f37;
            LAB_00105bff:uVar5 = *(uint*)pCVar10;
            uVar6 = *(uint*)( pCVar10 + 4 );
            uVar5 = uVar5 >> 0x18 | ( uVar5 & 0xff0000 ) >> 8 | ( uVar5 & 0xff00 ) << 8 | uVar5 << 0x18;
            if (( uVar5 <= ( uVar6 >> 0x18 | ( uVar6 & 0xff0000 ) >> 8 | ( uVar6 & 0xff00 ) << 8 | uVar6 << 0x18 ) ) && ( uVar6 = *(uint*)( pCVar10 + 8 )(uVar11 - uVar5) + ( uVar6 >> 0x18 | ( uVar6 & 0xff0000 ) >> 8 | ( uVar6 & 0xff00 ) << 8 | uVar6 << 0x18 ) != 0 )) {
               uVar13 = uVar13 + 1;
               uVar5 = 1;
               goto LAB_00105c29;
            }
            ...
            uVar11 = _DAT_0010a02c >> 0x18 | ( _DAT_0010a02c & 0xff0000 ) >> 8 | ( _DAT_0010a02c & 0xff00 ) << 8 | _DAT_0010a02c << 0x18;
            if (0x10ffff < uVar11) {
               uVar11 = 0x10ffff;
            }

            LAB_00105dee:uVar5 = _realloc;
            if (_realloc == 0) {
               LAB_00105f37:pCVar10 = (CmapSubtableLongSegmented<OT::CmapSubtableFormat12>*)&_hb_Null_OT_CmapSubtableLongGroup;
               goto LAB_00105bff;
            }

            LAB_00105e00:uVar5 = uVar5 >> 0x18 | ( uVar5 & 0xff0000 ) >> 8 | ( uVar5 & 0xff00 ) << 8 | uVar5 << 0x18;
            LAB_00105c29:if (uVar5 < param_2) {
                     ...
                     if (uVar13 >> 9 == uVar5) {
                        ...
                        if (puVar7 != (undefined4*)0x0) {
                           ...
                           if (puVar1 == puVar7 + uVar16 * 2 + 2) {
                              *(ulong*)( puVar7 + uVar9 * 2 + 2 ) = lVar4 - lVar8 | *(ulong*)( puVar7 + uVar9 * 2 + 2 );
                           }
 else {
                              ...
                              *(ulong*)( puVar7 + uVar16 * 2 + 2 ) = *(ulong*)( puVar7 + uVar16 * 2 + 2 ) | lVar4 - 1U;
                           }

                           LAB_00105ea1:*puVar7 = 0xffffffff;
                        }
                        ...
                        if (puVar7 != (undefined4*)0x0) {
                           ...
                           *(ulong*)( puVar7 + (ulong)uVar6 * 2 + 2 ) = -(1L << ((byte)uVar13 & 0x3f)) | *(ulong*)( puVar7 + (ulong)uVar6 * 2 + 2 );
 ...
 while ( uVar13 != uVar5 << 9 );
                           ...
                           if (puVar7 != (undefined4*)0x0) {
                              ...
                              if (uVar16 == 0) {
                                 ...
                                 *(ulong*)( puVar7 + uVar16 * 2 + 2 ) = *(ulong*)( puVar7 + uVar16 * 2 + 2 ) | uVar9;
                              }
         ...
         LAB_00105db8:uVar13 = *(uint*)( this + 0xc );
         uVar12 = uVar12 + 1;
         pCVar15 = pCVar15 + 0xc;
      }
 while ( uVar12 < ( uVar13 >> 0x18 | ( uVar13 & 0xff0000 ) >> 8 | ( uVar13 & 0xff00 ) << 8 | uVar13 << 0x18 ) );
   }

   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* OT::CmapSubtable::collect_unicodes(hb_set_t*, unsigned int) const */void OT::CmapSubtable::collect_unicodes(CmapSubtable *this, hb_set_t *param_1, uint param_2) {
   byte bVar1;
   ushort uVar2;
   uint uVar3;
   undefined4 *puVar4;
...
LAB_00106079:
   ...
   LAB_0010644f:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* OT::CmapSubtableLongSegmented<OT::CmapSubtableFormat12>::collect_mapping(hb_set_t*, hb_map_t*,
   unsigned int) const */void OT::CmapSubtableLongSegmented<OT::CmapSubtableFormat12>::collect_mapping(CmapSubtableLongSegmented<OT::CmapSubtableFormat12> *this, hb_set_t *param_1, hb_map_t *param_2, uint param_3) {
   hb_bit_set_t *this_00;
   undefined4 *__s;
   undefined4 *puVar1;
   byte bVar2;
      ...
      do {
         ...
         if (( uVar15 <= uVar16 ) && ( uVar12 <= uVar15 )) {
            ...
            if (uVar7 < param_3) {
               ...
               hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc((hb_hashmap_t<unsigned_int,unsigned_int,true>*)param_2, ( uVar5 - uVar15 ) + 1 + *(int*)( param_2 + 0x14 ));
               if (param_1[0x40] == (hb_set_t)0x0) {
                  ...
                  if (uVar15 >> 9 == uVar16) {
                     ...
                     if (puVar9 != (undefined4*)0x0) {
                        ...
                        if (puVar9 + uVar13 * 2 + 2 == puVar1) {
                           *(ulong*)( puVar9 + uVar13 * 2 + 2 ) = lVar4 - lVar10 | *(ulong*)( puVar9 + uVar13 * 2 + 2 );
                        }
 else {
                           *(ulong*)( puVar9 + uVar13 * 2 + 2 ) = -lVar10 | *(ulong*)( puVar9 + uVar13 * 2 + 2 );
                           __s = puVar9 + uVar13 * 2 + 2 + 2;
                           if ((int)puVar1 != (int)__s) {
                              memset(__s, 0xff, (long)puVar1 - (long)__s & 0xffffffff);
                           }

                           *(ulong*)( puVar9 + uVar19 * 2 + 2 ) = *(ulong*)( puVar9 + uVar19 * 2 + 2 ) | lVar4 - 1U;
                        }

                        LAB_00106973:*puVar9 = 0xffffffff;
                     }
                     ...
                     if (puVar9 != (undefined4*)0x0) {
                        ...
                        *(ulong*)( puVar9 + (ulong)uVar8 * 2 + 2 ) = -(1L << ((byte)uVar15 & 0x3f)) | *(ulong*)( puVar9 + (ulong)uVar8 * 2 + 2 );
 ...
 while ( uVar8 != uVar16 * 0x200 );
                        ...
                        if (puVar9 != (undefined4*)0x0) {
                           ...
                           if (uVar19 == 0) {
                              ...
                              *(ulong*)( puVar9 + uVar19 * 2 + 2 ) = *(ulong*)( puVar9 + uVar19 * 2 + 2 ) | uVar13;
                           }
                  ...
                  LAB_001068b0:if (uVar5 < uVar15) goto LAB_001067ed;
               }

               LAB_001066d6:uVar16 = uVar15 * -0x61c8864f;
               iVar20 = uVar7 - uVar15;
               do {
                  uVar7 = uVar15 + iVar20;
                  if (param_2[0x10] != (hb_map_t)0x0) {
                     ...
                     if (*(uint*)( param_2 + 0x1c ) <= ( uVar8 >> 1 ) + uVar8) {
                        cVar6 = hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc((hb_hashmap_t<unsigned_int,unsigned_int,true>*)param_2, 0);
 ...
 while ( ( bVar2 & 2 ) != 0 );
                        if (uVar17 == 0xffffffff) {
                           LAB_00106825:uVar8 = uVar8 + 1;
                        }
 else {
                           LAB_0010678b:lVar10 = (ulong)uVar17 * 0xc;
                           LAB_00106796:puVar11 = (uint*)( lVar10 + lVar4 );
                        ...
                        *(int*)( param_2 + 0x14 ) = iVar18 + 1;
                        if (( *(ushort*)( param_2 + 0x12 ) < uVar14 ) && ( *(uint*)( param_2 + 0x1c ) < uVar8 << 3 )) {
                           hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc((hb_hashmap_t<unsigned_int,unsigned_int,true>*)param_2, *(uint*)( param_2 + 0x1c ) - 8);
                        }
 ...
 while ( uVar15 <= uVar5 );
         ...
         LAB_001067ed:local_64 = local_64 + 1;
         pCVar21 = pCVar21 + 0xc;
      }
 while ( local_64 < ( uVar3 >> 0x18 | ( uVar3 & 0xff0000 ) >> 8 | ( uVar3 & 0xff00 ) << 8 | uVar3 << 0x18 ) );
   }

   return;
}
/* OT::CmapSubtableLongSegmented<OT::CmapSubtableFormat13>::collect_mapping(hb_set_t*, hb_map_t*,
   unsigned int) const */void OT::CmapSubtableLongSegmented<OT::CmapSubtableFormat13>::collect_mapping(CmapSubtableLongSegmented<OT::CmapSubtableFormat13> *this, hb_set_t *param_1, hb_map_t *param_2, uint param_3) {
   hb_bit_set_t *this_00;
   undefined4 *__s;
   undefined4 *puVar1;
   uint uVar2;
      ...
      do {
         ...
         if (( uVar15 <= uVar21 ) && ( uVar13 <= uVar15 )) {
            ...
            if (( uVar20 < param_3 ) && ( uVar3 != 0 )) {
               ...
               hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc((hb_hashmap_t<unsigned_int,unsigned_int,true>*)param_2, ( uVar3 - uVar15 ) + 1 + *(int*)( param_2 + 0x14 ));
               if (param_1[0x40] == (hb_set_t)0x0) {
                  if (( ( param_1[0x10] == (hb_set_t)0x0 ) || ( uVar3 < uVar15 || uVar8 == 0xffffffff ) ) || ( uVar3 == 0xffffffff )) goto LAB_00106e4d;
                  this_00 = (hb_bit_set_t*)( param_1 + 0x10 );
                  uVar21 = uVar3 >> 9;
                  *(undefined4*)( param_1 + 0x14 ) = 0xffffffff;
                  ...
                  if (uVar15 >> 9 == uVar21) {
                     ...
                     if (puVar9 != (undefined4*)0x0) {
                        ...
                        if (puVar9 + uVar14 * 2 + 2 == puVar1) {
                           *(ulong*)( puVar9 + uVar14 * 2 + 2 ) = lVar4 - lVar10 | *(ulong*)( puVar9 + uVar14 * 2 + 2 );
                        }
 else {
                           *(ulong*)( puVar9 + uVar14 * 2 + 2 ) = -lVar10 | *(ulong*)( puVar9 + uVar14 * 2 + 2 );
                        ...
                        LAB_00106f14:*puVar9 = 0xffffffff;
                     }
                     ...
                     if (puVar9 != (undefined4*)0x0) {
                        ...
                        uVar7 = ( uVar15 >> 9 ) + 1;
                        puVar1 = puVar9 + ( ulong )(uVar8 + 1) * 2;
                        *(ulong*)( puVar9 + (ulong)uVar8 * 2 + 2 ) = -(1L << (bVar12 & 0x3f)) | *(ulong*)( puVar9 + (ulong)uVar8 * 2 + 2 );
                        if (puVar1 != puVar9 + 0x10) {
                           iVar5 = (int)( puVar1 + 2 );
 ...
 while ( uVar8 != uVar21 * 0x200 );
                        ...
                        if (puVar9 != (undefined4*)0x0) {
                           ...
                           if (uVar19 == 0) {
                              ...
                              *(ulong*)( puVar9 + uVar19 * 2 + 2 ) = *(ulong*)( puVar9 + uVar19 * 2 + 2 ) | uVar14;
                           }
                  ...
                  LAB_00106e4d:if (uVar3 < uVar15) goto LAB_00106d9d;
               }

               LAB_00106c97:uVar21 = uVar15 * -0x61c8864f;
               do {
                  if (param_2[0x10] != (hb_map_t)0x0) {
                     uVar8 = *(uint*)( param_2 + 0x18 );
                     if (*(uint*)( param_2 + 0x1c ) <= ( uVar8 >> 1 ) + uVar8) {
 ...
 while ( ( bVar12 & 2 ) != 0 );
                        if (uVar7 == 0xffffffff) {
                           LAB_00106dd5:uVar8 = uVar8 + 1;
                        }
 else {
                           LAB_00106d3e:lVar10 = (ulong)uVar7 * 0xc;
                           LAB_00106d49:puVar11 = (uint*)( lVar10 + lVar4 );
                        ...
                        *(uint*)( param_2 + 0x18 ) = uVar8;
                        *(int*)( param_2 + 0x14 ) = iVar17 + 1;
                        if (( *(ushort*)( param_2 + 0x12 ) < uVar16 ) && ( *(uint*)( param_2 + 0x1c ) < uVar8 << 3 )) {
                           hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc((hb_hashmap_t<unsigned_int,unsigned_int,true>*)param_2, *(uint*)( param_2 + 0x1c ) - 8);
                        }
 ...
 while ( uVar15 <= uVar3 );
         ...
         LAB_00106d9d:local_70 = local_70 + 1;
         pCVar18 = pCVar18 + 0xc;
      }
 while ( local_70 < ( uVar2 >> 0x18 | ( uVar2 & 0xff0000 ) >> 8 | ( uVar2 & 0xff00 ) << 8 | uVar2 << 0x18 ) );
   }

   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* OT::CmapSubtable::collect_mapping(hb_set_t*, hb_map_t*, unsigned int) const */void OT::CmapSubtable::collect_mapping(CmapSubtable *this, hb_set_t *param_1, hb_map_t *param_2, uint param_3) {
   CmapSubtable CVar1;
   byte bVar2;
   char cVar3;
   ushort uVar4;
...
LAB_00107492:
   ...
   switchD_0010702f_caseD_1:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

   LAB_0010793f:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* hb_table_lazy_loader_t<OT::OS2, 6u, true>::create(hb_face_t*) */long hb_table_lazy_loader_t<OT::OS2,6u,true>::create(hb_face_t *param_1) {
   uint uVar1;
   long lVar2;
   long lVar3;
   ushort uVar4;
   if (( *(code**)( param_1 + 0x20 ) == (code*)0x0 ) || ( lVar2 = ( **(code**)( param_1 + 0x20 ) )(param_1, 0x4f532f32, *(undefined8*)( param_1 + 0x28 )) ),lVar2 == 0) {
      lVar2 = hb_blob_get_empty();
   }
   ...
   if (( 0x4d < uVar1 ) && ( ( uVar4 = **(ushort**)( lVar3 + 0x10 ) ),uVar4 = uVar4 << 8 | uVar4 >> 8,uVar4 == 0 || ( ( 0x55 < uVar1 && ( ( uVar4 == 1 || ( ( 0x5f < uVar1 && ( ( uVar4 < 5 || ( 99 < uVar1 ) ) ) ) ) ) ) ) ) )) {
      hb_blob_destroy(lVar3);
      hb_blob_make_immutable(lVar2);
      return lVar2;
   }
...
/* OT::cmap::accelerator_t::accelerator_t(hb_face_t*) */void OT::cmap::accelerator_t::accelerator_t(accelerator_t *this, hb_face_t *param_1) {
   hb_face_t *phVar1;
   char cVar2;
   ushort uVar3;
   uint uVar4;
   ...
   *(undefined1(*) [16])this = (undefined1[16])0x0;
   ...
   local_50 = iVar17;
   if (( *(code**)( param_1 + 0x20 ) == (code*)0x0 ) || ( puVar5 = (undefined*)( **(code**)( param_1 + 0x20 ) )(param_1, 0x636d6170, *(undefined8*)( param_1 + 0x28 )) ),puVar5 == (undefined*)0x0) {
 ...
 while ( local_80 != (cmap*)0x0 );
   hb_blob_destroy(lVar6);
   LAB_00107dc8:hb_blob_destroy(puVar5);
   puVar5 = (undefined*)hb_blob_get_empty();
   LAB_00107bfa:*(undefined**)( this + 0x50 ) = puVar5;
   ...
   if (uVar3 != 0) {
      ...
      do {
         while (true) {
            ...
            if (( *(short*)pcVar16 != 0 ) || ( uVar3 = *(ushort*)( pcVar16 + 2 ) ),5 < ( ushort )(uVar3 << 8 | uVar3 >> 8)) break;
...
;
 ...
 while ( iVar12 <= iVar17 );
      LAB_00107d43:pcVar16 = (cmap*)&_hb_NullPool;
   }

   LAB_00107c9a:uVar4 = *(uint*)( pcVar16 + 4 );
   if (( uVar4 != 0 ) && ( *(short*)( pcVar7 + ( uVar4 >> 0x18 | ( uVar4 & 0xff0000 ) >> 8 | ( uVar4 & 0xff00 ) << 8 | uVar4 << 0x18 ) ) == 0xe00 )) {
      *(cmap**)( this + 8 ) = pcVar7 + ( uVar4 >> 0x18 | ( uVar4 & 0xff0000 ) >> 8 | ( uVar4 & 0xff00 ) << 8 | uVar4 << 0x18 );
   }
   ...
   *(short**)( this + 0x18 ) = psVar8;
   if (local_8a == false) {
      ...
      if (( local_88._0_1_ != (hb_sanitize_context_t)0x0 ) || ( pcVar9 = local_89 != false )) goto LAB_00107d0e;
      if (*psVar8 == 0x400) {
         uVar3 = psVar8[3];
         psVar10 = psVar8 + 7;
         ...
         *(uint*)( this + 0x4c ) = ( ( ushort )(psVar8[1] << 8 | (ushort)psVar8[1] >> 8) - 0x10 ) + uVar4 * -8 >> 1;
      ...
      phVar1 = param_1 + 0xa0;
      LAB_00107e27:lVar6 = *(long*)phVar1;
      if (lVar6 == 0) {
      ...
      if (( ( sVar15 == -0x4e00 ) || ( pcVar9 = get_glyph_from_symbol<OT::CmapSubtable,&( _hb_arabic_pua_trad_map(unsigned_int) )> ),sVar15 == -0x4d00 )) goto LAB_00107d0e;
   }

   pcVar9 = get_glyph_from<OT::CmapSubtable>;
   LAB_00107d0e:*(code**)( this + 0x10 ) = pcVar9;
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   ...
   return;
   code_r0x00107f70:if (lVar6 != 0) {
      LAB_00107f2d:lVar11 = hb_blob_get_empty();
      if (lVar6 != lVar11) {
         hb_blob_destroy(lVar6);
      }
...
/* WARNING: Control flow encountered bad instruction data *//* OT::cmap::accelerator_t::accelerator_t(hb_face_t*) */void OT::cmap::accelerator_t::accelerator_t(accelerator_t *this, hb_face_t *param_1) {

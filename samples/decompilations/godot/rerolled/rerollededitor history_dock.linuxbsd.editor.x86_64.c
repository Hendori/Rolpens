/* HistoryDock::seek_history(int) */void HistoryDock::seek_history(HistoryDock *this, int param_1) {
   char cVar1;
   char cVar2;
   int iVar3;
   undefined8 uVar4;
...
/* HistoryDock::refresh_version() */void HistoryDock::refresh_version(HistoryDock *this) {
   undefined8 uVar1;
   long *plVar2;
   char cVar3;
   char cVar4;
   ...
   if (cVar3 == '\0') {
      ...
      if (( plVar2 == (long*)0x0 ) || ( (int)plVar2[2] == 0 )) {
         ...
         LAB_001002f0:plVar2 = *(long**)( lVar6 + 0x18 );
         if (( plVar2 == (long*)0x0 ) || ( (int)plVar2[2] == 0 )) {
         ...
         LAB_00100261:plVar8 = *(long**)( lVar5 + 0x20 );
         dVar9 = dVar10;
         if (plVar8 == (long*)0x0) goto LAB_001002d0;
         LAB_0010026a:iVar7 = 0;
         for (lVar5 = *plVar8; ( lVar5 != 0 && ( *(double*)( lVar5 + 8 ) <= dVar9 && dVar9 != *(double*)( lVar5 + 8 ) ) ); lVar5 = *(long*)( lVar5 + 0x20 )) {
            iVar7 = iVar7 + 1;
         }
   ...
   LAB_0010029d:plVar2 = *(long**)( lVar6 + 0x20 );
   if (plVar2 != (long*)0x0) {
      iVar7 = 0;
      for (lVar5 = *plVar2; ( lVar5 != 0 && ( *(double*)( lVar5 + 8 ) <= dVar10 && dVar10 != *(double*)( lVar5 + 8 ) ) ); lVar5 = *(long*)( lVar5 + 0x20 )) {
         iVar7 = iVar7 + 1;
      }
   ...
   LAB_001002d0:*(int*)( this + 0xa34 ) = (int)plVar8;
   ItemList::set_current((int)*(undefined8*)( this + 0xa18 ));
   return;
}
/* HistoryDock::on_version_changed() */void HistoryDock::on_version_changed(HistoryDock *this) {
   char cVar1;
...
/* HistoryDock::_save_layout_to_config(Ref<ConfigFile>, String const&) const */void HistoryDock::_save_layout_to_config(undefined8 param_1, undefined8 *param_2, String *param_3) {
   String *pSVar1;
   bool bVar2;
   long in_FS_OFFSET;
   undefined8 local_70;
...
/* HistoryDock::HistoryDock() */void HistoryDock::HistoryDock(HistoryDock *this) {
   code *pcVar1;
   String *pSVar2;
   undefined8 uVar3;
   long *plVar4;
   ...
   *(long**)( this + 0xa10 ) = plVar4;
   ...
   create_custom_callable_function_pointer<HistoryDock>((HistoryDock*)&local_58, (char*)this, (_func_void*)"&HistoryDock::on_history_changed");
   ...
   pcVar1 = *(code**)( *plVar4 + 0x108 );
   create_custom_callable_function_pointer<HistoryDock>((HistoryDock*)&local_58, (char*)this, (_func_void*)"&HistoryDock::on_version_changed");
   ...
   *(CheckBox**)( this + 0xa20 ) = pCVar5;
   ...
   pcVar1 = *(code**)( *plVar4 + 0x108 );
   create_custom_callable_function_pointer<HistoryDock>((HistoryDock*)&local_58, (char*)this, (_func_void*)"&HistoryDock::refresh_history");
...
/* HistoryDock::_bind_methods() */void HistoryDock::_bind_methods(void) {
   long lVar1;
   code *pcVar2;
   long *plVar3;
   MethodBind *pMVar4;
...
/* CowData<EditorUndoRedoManager::Action>::_copy_on_write() [clone .isra.0] */void CowData<EditorUndoRedoManager::Action>::_copy_on_write(CowData<EditorUndoRedoManager::Action> *this) {
   undefined8 uVar1;
   undefined4 uVar2;
   long lVar3;
   long lVar4;
...
/* HistoryDock::refresh_history() */void HistoryDock::refresh_history(void) {
   int *piVar1;
   String *pSVar2;
   undefined8 uVar3;
   code *pcVar4;
   ...
   if (( cVar6 == '\0' ) && ( cVar7 == '\0' )) {
      ...
      if (( local_68 != (Object*)0x0 ) && ( ( cVar6 = RefCounted::unreference() ),pOVar5 = local_68,cVar6 != '\0' && ( cVar6 = predelete_handler(local_68) ),cVar6 != '\0' )) {
   ...
   if (cVar6 == '\0') {
      ...
      if (lVar17 < 0) {
         LAB_001018c0:_err_print_error("resize", "./core/templates/cowdata.h", 0x157, "Condition \"p_size < 0\" is true. Returning: ERR_INVALID_PARAMETER", 0, 0);
      }
 else if (lVar17 != 0) {
         LAB_0010122b:CowData<EditorUndoRedoManager::Action>::_copy_on_write((CowData<EditorUndoRedoManager::Action>*)&local_60);
 ...
 while ( piVar16 != (int*)( puVar11 + lVar17 * 4 + 2 ) );
      ...
      LAB_001012e9:if (( *(undefined8**)( lVar10 + 0x20 ) != (undefined8*)0x0 ) && ( piVar13 = (int*)**(undefined8**)( lVar10 + 0x20 ) ),piVar13 != (int*)0x0) {
         lVar9 = (long)iVar14;
         piVar16 = local_60;
         do {
            lVar12 = lVar9;
            ...
            CowData<EditorUndoRedoManager::Action>::_copy_on_write((CowData<EditorUndoRedoManager::Action>*)&local_60);
            piVar16 = local_60;
 ...
 while ( piVar13 != (int*)0x0 );
      ...
      if (( *(undefined8**)( lVar10 + 0x18 ) != (undefined8*)0x0 ) && ( piVar13 = (int*)**(undefined8**)( lVar10 + 0x18 ) ),piVar13 != (int*)0x0) {
         lVar12 = (long)iVar14;
         piVar16 = local_60;
         do {
            if (piVar16 == (int*)0x0) {
 ...
 while ( piVar13 != (int*)0x0 );
      ...
      LAB_00101421:if (( puVar11 == (undefined8*)0x0 ) || ( piVar13 = (int*)*puVar11 ),piVar13 == (int*)0x0) {
         iVar14 = 0;
      }
 else {
         lVar17 = 0;
 ...
 while ( piVar13 != (int*)0x0 );
      ...
      if (( *(undefined8**)( lVar9 + 0x18 ) != (undefined8*)0x0 ) && ( piVar13 = (int*)**(undefined8**)( lVar9 + 0x18 ) ),piVar13 != (int*)0x0) {
         lVar9 = (long)iVar14;
         piVar16 = local_60;
         do {
            lVar12 = lVar9;
 ...
 while ( piVar13 != (int*)0x0 );
   ...
   Vector<EditorUndoRedoManager::Action>::sort_custom<SortActionsByTimestamp,true>((Vector<EditorUndoRedoManager::Action>*)&local_68);
   CowData<EditorUndoRedoManager::Action>::_copy_on_write((CowData<EditorUndoRedoManager::Action>*)&local_60);
   piVar13 = local_60;
   CowData<EditorUndoRedoManager::Action>::_copy_on_write((CowData<EditorUndoRedoManager::Action>*)&local_60);
   piVar16 = local_60;
...
;
      ...
      if ((refresh_history()::{lambda()
      #1
      ( iVar14 = __cxa_guard_acquire(&refresh_history()::{lambda()#1}::operator()()::sname),
         iVar14 != 0) );
      {
         _scs_create((char *)&refresh_history()::{lambda()
         #1
         __cxa_atexit(StringName::~StringName, &refresh_history()::, {
               lambda()
               #1
               &__dso_handle;
...
LAB_00101681:
  pSVar2 = *(String **)(in_RDI + 0xa18);
      ...
      LAB_00101178:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }

      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
      LAB_0010138f:lVar17 = 0;
      LAB_001013b0:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar12, lVar17, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
      _err_flush_stdout();
      /* WARNING: Does not return */
   ...
   void HistoryDock::on_history_changed(HistoryDock *this) {
      char cVar1;
      cVar1 = CanvasItem::is_visible_in_tree();
      if (cVar1 == '\0') {
         this[0xa30] = (HistoryDock)0x1;
   ...
   void HistoryDock::_load_layout_from_config(HistoryDock *this, undefined8 *param_2, Variant *param_3) {
      String *pSVar1;
      undefined8 uVar2;
      long in_FS_OFFSET;
      undefined8 local_90;
   ...
   void HistoryDock::_notification(HistoryDock *this, int param_1) {
      code *pcVar1;
      long *plVar2;
      char cVar3;
      long in_FS_OFFSET;
      ...
      if (param_1 == 0xd) {
         ...
         create_custom_callable_function_pointer<HistoryDock>(local_48, (char*)this, (_func_void*)"&HistoryDock::on_history_changed");
      ...
      LAB_00101c9d:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   void CallableCustomMethodPointer<HistoryDock,void,int>::~CallableCustomMethodPointer(CallableCustomMethodPointer<HistoryDock,void,int> *this) {
      return;
   }

   /* CallableCustomMethodPointer<HistoryDock, void>::~CallableCustomMethodPointer() */
   void CallableCustomMethodPointer<HistoryDock,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<HistoryDock,void> *this) {
      return;
   }

   /* MethodBindT<Ref<ConfigFile>, String const&>::_gen_argument_type(int) const */
   char MethodBindT<Ref<ConfigFile>,String_const&>::_gen_argument_type(MethodBindT<Ref<ConfigFile>,String_const&> *this, int param_1) {
      char cVar1;
      cVar1 = '\0';
      if ((uint)param_1 < 2) {
   ...
   char MethodBindTC<Ref<ConfigFile>,String_const&>::_gen_argument_type(MethodBindTC<Ref<ConfigFile>,String_const&> *this, int param_1) {
      char cVar1;
      cVar1 = '\0';
      if ((uint)param_1 < 2) {
         cVar1 = ( -(param_1 == 0) & 0x14U ) + 4;
   ...
   undefined8 CallableCustomMethodPointer<HistoryDock,void,int>::get_argument_count(CallableCustomMethodPointer<HistoryDock,void,int> *this, bool *param_1) {
      *param_1 = true;
      return 1;
   }

   /* CallableCustomMethodPointer<HistoryDock, void>::get_argument_count(bool&) const */
   undefined8 CallableCustomMethodPointer<HistoryDock,void>::get_argument_count(CallableCustomMethodPointer<HistoryDock,void> *this, bool *param_1) {
      *param_1 = true;
      return 0;
   }
   ...
   void MethodBindTC<Ref<ConfigFile>,String_const&>::~MethodBindTC(MethodBindTC<Ref<ConfigFile>,String_const&> *this) {
   ...
   void MethodBindT<Ref<ConfigFile>,String_const&>::~MethodBindT(MethodBindT<Ref<ConfigFile>,String_const&> *this) {
   ...
   undefined8 CallableCustomMethodPointer<HistoryDock,void,int>::get_object(CallableCustomMethodPointer<HistoryDock,void,int> *this) {
      long lVar1;
      undefined8 uVar2;
      uint uVar3;
      ulong *puVar4;
...
;
      ...
      uVar2 = 0;
      LAB_0010211d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
   ...
   undefined8 CallableCustomMethodPointer<HistoryDock,void>::get_object(CallableCustomMethodPointer<HistoryDock,void> *this) {
      long lVar1;
      undefined8 uVar2;
      uint uVar3;
      ulong *puVar4;
...
;
   ...
   uint HBoxContainer::is_class_ptr(void *param_1) {
      ...
      if (in_RSI != &get_class_ptr_static()::ptr) {
         uVar1 = (uint)CONCAT71(0x10a2, in_RSI == &Container::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10a2, in_RSI == &BoxContainer::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10a2, in_RSI == &Control::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10a2, in_RSI == &CanvasItem::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10a2, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr);
      }
   ...
   ulong HistoryDock::is_class_ptr(void *param_1) {
      ...
      if (in_RSI == &VBoxContainer::get_class_ptr_static() || in_RSI == &get_class_ptr_static()::ptr) {
         return CONCAT71(0x10a2, in_RSI == &VBoxContainer::get_class_ptr_static() || in_RSI == &get_class_ptr_static(), ::ptr);
      }

      return ( ulong )((uint)CONCAT71(0x10a2, in_RSI == &Container::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10a2, in_RSI == &BoxContainer::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10a2, in_RSI == &Control::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10a2, in_RSI == &CanvasItem::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10a2, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr));
   }

   /* HistoryDock::~HistoryDock() */
   void HistoryDock::~HistoryDock(HistoryDock *this) {
      bool bVar1;
      ...
      *(code**)this = strlen;
      ...
      LAB_001026c0:Control::~Control((Control*)this);
      return;
   }
   ...
   void HBoxContainer::~HBoxContainer(HBoxContainer *this) {
      ...
      *(code**)this = strlen;
      ...
      LAB_00102720:Control::~Control((Control*)this);
      return;
   }
   ...
   void HBoxContainer::~HBoxContainer(HBoxContainer *this) {
      ...
      *(code**)this = strlen;
      ...
      LAB_00102780:Control::~Control((Control*)this);
   ...
   void HistoryDock::~HistoryDock(HistoryDock *this) {
      ...
      *(code**)this = strlen;
      ...
      LAB_001027f0:Control::~Control((Control*)this);
   ...
   undefined8 *HBoxContainer::_get_class_namev(void) {
      ...
      if (_get_class_namev()::_class_name_static != 0) {
         if (*(long*)( _get_class_namev() ) != 0) {
            LAB_001028c3:return &_get_class_namev();
         }

         if (*(long*)( _get_class_namev() ) != 0) {
            if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001028c3;
      ...
      StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "HBoxContainer");
      LAB_0010292e:return &_get_class_namev();
   }
   ...
   undefined8 *HistoryDock::_get_class_namev(void) {
      ...
      if (_get_class_namev()::_class_name_static != 0) {
         ...
         if (*(long*)( _get_class_namev() ) != 0) {
            ...
            StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "HistoryDock");
            goto LAB_00102a0e;
         }
   ...
   (HistoryDock::*)()) */
   HistoryDock *create_custom_callable_function_pointer<HistoryDock>(HistoryDock *param_1, char *param_2, _func_void *param_3) {
      undefined8 uVar1;
      CallableCustom *this;
      undefined8 in_RCX;
      undefined8 in_R8;
   ...
   void CallableCustomMethodPointer<HistoryDock,void>::call(CallableCustomMethodPointer<HistoryDock,void> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
      long lVar1;
      long lVar2;
      uint uVar3;
      ulong *puVar4;
...
;
         ...
         *(undefined4*)( param_4 + 8 ) = 0;
         ...
         _err_print_error("get_instance", "./core/object/object.h", 0x418, "Condition \"slot >= slot_max\" is true. Returning: nullptr", 0, 0);
         LAB_001032df:local_40 = 0;
         String::parse_latin1((String*)&local_40, "\', can\'t call method.");
         uitos((ulong)local_50);
         operator+((char *)
         local_48,(String*)"Invalid Object id \'";
         String::operator +(local_38, (String*)local_48);
         _err_print_error(&_LC22, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", local_38, 0, 0);
      ...
      LAB_00103390:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }

   /* CallableCustomMethodPointer<HistoryDock, void, int>::call(Variant const**, int, Variant&,
   Callable::CallError&) const */
   void CallableCustomMethodPointer<HistoryDock,void,int>::call(CallableCustomMethodPointer<HistoryDock,void,int> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
      long lVar1;
      long lVar2;
      undefined8 uVar3;
      char cVar4;
...
;
      ...
      LAB_00103609:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   void SortArray<EditorUndoRedoManager::Action,SortActionsByTimestamp,true>::adjust_heap(long param_1, long param_2, long param_3, undefined4 *param_4, long param_5) {
      double dVar1;
      undefined8 uVar2;
      undefined1 uVar3;
      undefined4 uVar4;
...
;
   ...
   void SortArray<EditorUndoRedoManager::Action,SortActionsByTimestamp,true>::introsort(long param_1, long param_2, Action_conflict *param_3, long param_4) {
      long *plVar1;
      double dVar2;
      double dVar3;
      double dVar4;
      ...
      if (0x10 < lVar16) {
         if (param_4 != 0) {
            ...
            local_a8 = param_2;
            local_a0 = param_4;
            LAB_001039dc:local_a0 = local_a0 + -1;
               ...
               if (dVar2 < *(double*)( pAVar18 + 8 )) {
                  ...
                  if (*(double*)( pAVar14 + 8 ) <= dVar2 && dVar2 != *(double*)( pAVar14 + 8 )) {
                     ...
                     while (param_1 != lVar16) {
                        lVar16 = lVar16 + -1;
                        pAVar14 = pAVar15;
                        if (dVar2 < *(double*)( pAVar15 + 8 ) || dVar2 == *(double*)( pAVar15 + 8 )) goto LAB_00103b2a;
...
;
                  ...
                  LAB_00103b2a:if (lVar16 <= param_2) goto LAB_00103ba0;
 ...
 while ( true );
         ...
         LAB_00103c8b:lVar13 = lVar16 + -2 >> 1;
...
;
         ...
         do {
            ...
            *(Action_conflict*)( (CowData<char32_t>*)pAVar18 + 0xc ) = pAVar12[0x1c];
            ...
            LAB_00103e4b:pAVar18 = (Action_conflict*)( (CowData<char32_t>*)pAVar18 + -0x20 );
            bVar11 = 1 < lVar16;
            lVar16 = lVar16 + -1;
         }
 while ( bVar11 );
      ...
      LAB_00103c3f:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }

      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
      LAB_00103ba0:lVar16 = param_2 - param_1;
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   ...
   undefined8 CanvasItem::is_class(CanvasItem *this, String *param_1) {
      ...
      LAB_0010406b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }

      LAB_00104248:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   undefined8 Container::is_class(Container *this, String *param_1) {
      ...
      LAB_0010435b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }

      LAB_0010445e:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   undefined8 HistoryDock::is_class(HistoryDock *this, String *param_1) {
      long *plVar1;
      long lVar2;
      char *pcVar3;
      long lVar4;
      ...
      LAB_001046cb:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }

      LAB_001047ce:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
            ...
            if (Container::initialize_class() == '\0') {
               if (Control::initialize_class() == '\0') {
                  if (CanvasItem::initialize_class() == '\0') {
                     ...
                     if ((code*)PTR__bind_compatibility_methods_0010d030 != Object::_bind_compatibility_methods) {
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
      ...
      LAB_00104ecf:CowData<char32_t>::_unref((CowData<char32_t>*)this);
      return;
   }
   ...
   void Node::_get_property_listv(List *param_1, bool param_2) {
      ...
      LAB_0010508c:List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)CONCAT71(in_register_00000031, param_2), (PropertyInfo*)&local_78);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
      if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
         StringName::unref();
      }
   ...
   void CanvasItem::_get_property_listv(CanvasItem *this, List *param_1, bool param_2) {
      ...
      local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
      LAB_001052f1:local_b0 = (CowData<char32_t>*)&local_58;
   ...
   void Control::_get_property_listv(Control *this, List *param_1, bool param_2) {
      ...
      local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
      LAB_001055c1:local_b0 = (CowData<char32_t>*)&local_58;
      List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
      CowData<char32_t>::_unref(local_b0);
      if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
         StringName::unref();
   ...
   void Container::_get_property_listv(Container *this, List *param_1, bool param_2) {
      ...
      local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
      LAB_00105891:local_b0 = (CowData<char32_t>*)&local_58;
      List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
      CowData<char32_t>::_unref(local_b0);
      if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
         StringName::unref();
   ...
   void BoxContainer::_get_property_listv(BoxContainer *this, List *param_1, bool param_2) {
      ...
      local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
      LAB_00105b41:local_b0 = (CowData<char32_t>*)&local_58;
      List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
      CowData<char32_t>::_unref(local_b0);
      if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
         StringName::unref();
   ...
   void VBoxContainer::_get_property_listv(VBoxContainer *this, List *param_1, bool param_2) {
      ...
      local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
      LAB_00105df1:local_b0 = (CowData<char32_t>*)&local_58;
      List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
      CowData<char32_t>::_unref(local_b0);
      if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
         StringName::unref();
   ...
   void HistoryDock::_get_property_listv(HistoryDock *this, List *param_1, bool param_2) {
      long in_FS_OFFSET;
      CowData<char32_t> *local_b0;
      long local_98;
      long local_90;
      ...
      local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
      LAB_001060a1:local_b0 = (CowData<char32_t>*)&local_58;
      List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
      CowData<char32_t>::_unref(local_b0);
      if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
         StringName::unref();
   ...
   void HBoxContainer::_get_property_listv(HBoxContainer *this, List *param_1, bool param_2) {
      ...
      local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
      LAB_00106351:local_b0 = (CowData<char32_t>*)&local_58;
      List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
      CowData<char32_t>::_unref(local_b0);
      if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
         StringName::unref();
   ...
   undefined8 HBoxContainer::is_class(HBoxContainer *this, String *param_1) {
      ...
      LAB_0010658b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }

      LAB_0010668e:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }

   /* MethodBind* create_method_bind<HistoryDock, Ref<ConfigFile>, String const&>(void
   (HistoryDock::*)(Ref<ConfigFile>, String const&) const) */
   MethodBind *create_method_bind<HistoryDock,Ref<ConfigFile>,String_const&>(_func_void_Ref_String_ptr *param_1) {
      MethodBind *this;
      undefined8 in_RSI;
      long in_FS_OFFSET;
      undefined8 local_40;
 ...
 while ( lVar3 != lVar7 );
   ...
   void Vector<EditorUndoRedoManager::Action>::sort_custom<SortActionsByTimestamp,true>(Vector<EditorUndoRedoManager::Action> *this) {
      double dVar1;
      ...
      long local_40;
      local_40 = *(long*)( in_FS_OFFSET + 0x28 );
      if (( *(long*)( this + 8 ) != 0 ) && ( lVar5 = lVar5 != 0 )) {
         CowData<EditorUndoRedoManager::Action>::_copy_on_write((CowData<EditorUndoRedoManager::Action>*)( this + 8 ));
         pAVar6 = *(Action_conflict**)( this + 8 );
         if (lVar5 == 1) {
            if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
               SortArray<EditorUndoRedoManager::Action,SortActionsByTimestamp,true>::introsort(0, 1, pAVar6, 0);
               return;
            }
 ...
 while ( lVar14 != 1 );
         SortArray<EditorUndoRedoManager::Action,SortActionsByTimestamp,true>::introsort(0, lVar5, pAVar6, lVar10 * 2);
         pAVar15 = pAVar6 + 0x30;
         if (lVar5 < 0x11) {
            lVar14 = 1;
            do {
...
;
                  ...
                  LAB_001077ea:*(double*)( pAVar11 + 8 ) = dVar18;
                  ...
                  *(undefined4*)( pAVar11 + 0x18 ) = uVar3;
                  ...
                  do {
                     *(undefined4*)( (CowData<char32_t>*)pCVar12 + -0x10 ) = *(undefined4*)( (CowData<char32_t>*)pCVar12 + -0x30 );
                     *(undefined8*)( (CowData<char32_t>*)pCVar12 + -8 ) = *(undefined8*)( (CowData<char32_t>*)pCVar12 + -0x28 );
                     if (*(long*)pCVar12 != *(long*)( (CowData<char32_t>*)pCVar12 + -0x20 )) {
                        CowData<char32_t>::_ref((CowData<char32_t>*)pCVar12, (CowData*)( (CowData<char32_t>*)pCVar12 + -0x20 ));
                     }

                     *(undefined4*)( (CowData<char32_t>*)pCVar12 + 8 ) = *(undefined4*)( (CowData<char32_t>*)pCVar12 + -0x18 );
...
;
                  ...
                  LAB_0010750b:*(double*)( pAVar11 + 8 ) = dVar18;
                  *(undefined4*)pAVar11 = uVar8;
                  CowData<char32_t>::_ref((CowData<char32_t>*)( pAVar11 + 0x10 ), (CowData*)&local_78);
                  *(undefined4*)( pAVar11 + 0x18 ) = uVar3;
                  pAVar11[0x1c] = AVar2;
 ...
 while ( lVar10 != 0 );
               ...
               LAB_0010739a:*(undefined4*)pAVar11 = uVar8;
 ...
 while ( lVar5 != lVar14 );
      ...
      LAB_001078a5:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }

   /* CowData<EditorUndoRedoManager::Action>::_realloc(long) */
   undefined8 CowData<EditorUndoRedoManager::Action>::_realloc(CowData<EditorUndoRedoManager::Action> *this, long param_1) {
      undefined8 *puVar1;
   ...
   void HistoryDock::_notificationv(HistoryDock *this, int param_1, bool param_2) {
      if (param_2) {
   ...
   void call_get_argument_type_info<Ref<ConfigFile>,String_const&>(int param_1, PropertyInfo *param_2) {
      ...
      if (param_1 == 0) {
         ...
         if (( local_80 != 0 ) && ( CowData<char32_t>::_ref((CowData<char32_t>*)&local_48, (CowData*)&local_80),local_50 != 0x11 )) goto LAB_00107a5f;
         LAB_00107b0a:local_40 = 6;
         ...
         local_48 = 0;
         local_60 = (undefined1[16])0x0;
         if (( local_80 != 0 ) && ( CowData<char32_t>::_ref((CowData<char32_t>*)&local_48, (CowData*)&local_80),local_50 == 0x11 )) goto LAB_00107b0a;
         LAB_00107a5f:local_40 = 6;
      ...
      *(undefined4*)( param_2 + 0x28 ) = local_40;
      ...
      CowData<char32_t>::_unref((CowData<char32_t>*)local_60);
      LAB_001079be:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
   ...
   const */
   void MethodBindTC<Ref<ConfigFile>,String_const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
      long lVar1;
      long lVar2;
      Object *pOVar3;
      char cVar4;
      ...
      if (( ( param_2 != (Variant**)0x0 ) && ( param_2[1] != (Variant*)0x0 ) ) && ( param_2[1][0x2e] != (Variant)0x0 )) {
         ...
         if (local_68 == (Object*)*(long*)pVVar6) {
            ...
            _err_print_error("validated_call", "./core/object/method_bind.h", 0x1b4, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true.", (StringName*)&local_68, 0, 0);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);
            if (( StringName::configured != '\0' ) && ( local_78 != 0 )) {
               StringName::unref();
      ...
      if (pOVar5 != local_68) {
         if (pOVar5 == (Object*)0x0) {
            if (local_68 != (Object*)0x0) {
               local_68 = (Object*)0x0;
               LAB_001081c4:cVar4 = RefCounted::unreference();
               if (cVar4 != '\0') {
      ...
      LAB_00108209:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   const */
   void MethodBindT<Ref<ConfigFile>,String_const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
      long lVar1;
      long lVar2;
      Object *pOVar3;
      char cVar4;
      ...
      if (pOVar5 != local_68) {
         if (pOVar5 == (Object*)0x0) {
            if (local_68 != (Object*)0x0) {
               local_68 = (Object*)0x0;
               LAB_00108504:cVar4 = RefCounted::unreference();
               if (cVar4 != '\0') {
                  cVar4 = predelete_handler(pOVar3);
                  if (cVar4 != '\0') {
                     ( **(code**)( *(long*)pOVar3 + 0x140 ) )(pOVar3);
      ...
      LAB_00108549:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   void MethodBindTC<Ref<ConfigFile>,String_const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
      long lVar1;
      undefined8 uVar2;
      Object *pOVar3;
      char cVar4;
      ...
      if (( *param_3 == (long*)0x0 ) || ( local_48 = (Object*)**param_3 ),local_48 == (Object*)0x0) {
         LAB_001087fc:local_48 = (Object*)0x0;
      }
 else {
   ...
   void MethodBindT<Ref<ConfigFile>,String_const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
      long lVar1;
      undefined8 uVar2;
      Object *pOVar3;
      char cVar4;
      ...
      uVar2 = *(undefined8*)( (long)param_3 + 8 );
      if (( *param_3 == (long*)0x0 ) || ( local_48 = (Object*)**param_3 ),local_48 == (Object*)0x0) {
         LAB_00108a4c:local_48 = (Object*)0x0;
      }
 else {
         cVar4 = RefCounted::init_ref();
      ...
      LAB_00108a73:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   Callable::CallError&) const */
   Object *MethodBindTC<Ref<ConfigFile>,String_const&>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      Variant *pVVar1;
      long lVar2;
      code *pcVar3;
      undefined8 uVar4;
      ...
      if (( ( plVar12 != (long*)0x0 ) && ( plVar12[1] != 0 ) ) && ( *(char*)( plVar12[1] + 0x2e ) != '\0' )) {
         ...
         if (local_58 == (Object*)*plVar10) {
            ...
            _err_print_error(&_LC22, "./core/object/method_bind.h", 0x1a8, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: Variant()", (StringName*)&local_58, 0, 0);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
            if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
               StringName::unref();
      ...
      if (pVVar13 == (Variant*)0x0) {
         ...
         LAB_00108efd:pVVar13 = *(Variant**)( param_4 + 8 );
      }
 else {
         lVar2 = *(long*)( pVVar13 + -8 );
         iVar15 = (int)lVar2;
         if (iVar15 < iVar7) {
            LAB_00108ee0:uVar8 = 4;
            goto LAB_00108e9d;
         }
         ...
         if (lVar2 <= lVar11) {
            LAB_00109060:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar11, lVar2, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
      ...
      *in_R9 = 0;
      ...
      if (pOVar9 != local_58) {
         if (pOVar9 == (Object*)0x0) {
            if (local_58 != (Object*)0x0) {
               local_58 = (Object*)0x0;
               LAB_00108e53:cVar6 = RefCounted::unreference();
               if (cVar6 != '\0') {
      ...
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
      LAB_00108ea8:*(undefined4*)param_1 = 0;
   ...
   Callable::CallError&) const */
   Object *MethodBindT<Ref<ConfigFile>,String_const&>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      Variant *pVVar1;
      long lVar2;
      code *pcVar3;
      undefined8 uVar4;
      ...
      if (( ( plVar12 != (long*)0x0 ) && ( plVar12[1] != 0 ) ) && ( *(char*)( plVar12[1] + 0x2e ) != '\0' )) {
         ...
         if (local_58 == (Object*)*plVar10) {
            ...
            String::parse_latin1((StrRange*)&local_60);
            vformat<StringName>((StringName*)&local_58, (StrRange*)&local_60, &local_68);
            _err_print_error(&_LC22, "./core/object/method_bind.h", 0x154, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: Variant()", (StringName*)&local_58, 0, 0);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
            if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
               StringName::unref();
      ...
      if (pVVar13 == (Variant*)0x0) {
         ...
         pVVar14 = *(Variant**)param_4;
         LAB_001093cd:pVVar13 = *(Variant**)( param_4 + 8 );
      }
 else {
         lVar2 = *(long*)( pVVar13 + -8 );
         iVar15 = (int)lVar2;
         if (iVar15 < iVar7) {
            LAB_001093b0:uVar8 = 4;
            goto LAB_0010936d;
         }
         ...
         lVar11 = (long)(int)( ( in_R8D ^ 1 ) + ( iVar15 - iVar7 ) );
         if (lVar2 <= lVar11) {
            LAB_00109530:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar11, lVar2, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar3 = (code*)invalidInstructionException();
            ( *pcVar3 )();
      ...
      *in_R9 = 0;
      ...
      if (pOVar9 != local_58) {
         if (pOVar9 == (Object*)0x0) {
            if (local_58 != (Object*)0x0) {
               local_58 = (Object*)0x0;
               LAB_00109323:cVar6 = RefCounted::unreference();
               if (cVar6 != '\0') {
                  cVar6 = predelete_handler(pOVar5);
                  if (cVar6 != '\0') {
                     ( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
      ...
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
      LAB_00109378:*(undefined4*)param_1 = 0;
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }

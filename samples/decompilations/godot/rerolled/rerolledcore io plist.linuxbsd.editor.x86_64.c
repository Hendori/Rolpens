...
/* PListNode::get_type() const */undefined4 PListNode::get_type(PListNode *this) {
   return *(undefined4*)( this + 0x17c );
}
/* PListNode::get_asn1_size(unsigned char) const */long PListNode::get_asn1_size(PListNode *this, uchar param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   int iVar4;
   ...
   lVar6 = 0;
   LAB_00100345:if (lVar3 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return lVar6;
   }
...
/* PListNode::_asn1_size_len(unsigned char) */int PListNode::_asn1_size_len(uchar param_1) {
   int iVar1;
   iVar1 = param_1 + 1;
   if (param_1 < 2) {
      iVar1 = 1;
...
/* PListNode::store_text(String&, unsigned char) const */void PListNode::store_text(PListNode *this, String *param_1, uchar param_2) {
   long *plVar1;
   long lVar2;
   undefined8 *puVar3;
   undefined *puVar4;
...
/* PList::read_bplist_var_size_int(Ref<FileAccess>, unsigned char) */ulong PList::read_bplist_var_size_int(undefined8 param_1, undefined8 *param_2, byte param_3) {
   byte bVar1;
   ushort uVar2;
   uint uVar3;
   long lVar4;
...
/* PList::save_text() const */void PList::save_text(void) {
   long in_RSI;
   undefined8 *in_RDI;
   long in_FS_OFFSET;
   undefined8 local_28;
   ...
   if (*(long*)( in_RSI + 0x1a0 ) == 0) {
      _err_print_error("save_text", "core/io/plist.cpp", 0x357, "Method/function failed. Returning: String()", "PList: Invalid PList, no root node.", 0, 0);
      *in_RDI = 0;
   }
 else {
      local_28 = 0;
      String::operator +=((String*)&local_28, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n");
      String::operator +=((String*)&local_28, "<!DOCTYPE plist PUBLIC \"-//Apple//DTD PLIST 1.0//EN\" \"http://www.apple.com/DTDs/PropertyList-1.0.dtd\">\n");
...
/* PListNode::get_value() const */void PListNode::get_value(void) {
   long *plVar1;
   undefined8 *puVar2;
   uchar *puVar3;
   char *pcVar4;
...
/* PListNode::store_asn1_size(Vector<unsigned char>&, unsigned char) const */void PListNode::store_asn1_size(PListNode *this, Vector *param_1, uchar param_2) {
   uint uVar1;
   int iVar2;
   bool bVar3;
   ...
   do {
      Vector<unsigned_char>::push_back((Vector<unsigned_char>*)param_1, ( uchar )(uVar1 >> ( (char)iVar2 * '\b' & 0x1fU )));
      bVar3 = iVar2 != 0;
      iVar2 = iVar2 + -1;
   }
 while ( bVar3 );
...
/* PListNode::store_asn1(Vector<unsigned char>&, unsigned char) const */undefined4 PListNode::store_asn1(PListNode *this, Vector *param_1, uchar param_2) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   char cVar4;
...
LAB_00101ea0:
   ...
   uVar7 = 1;
   LAB_00101c7c:if (lVar2 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar7;
   }
...
/* PList::save_asn1() const */void PList::save_asn1(void) {
   long *plVar1;
   long lVar2;
   char cVar3;
   ulong uVar4;
   ...
   if (*(PListNode**)( in_RSI + 0x1a0 ) == (PListNode*)0x0) {
      ...
      uVar6 = 0x335;
      LAB_001022bc:_err_print_error("save_asn1", "core/io/plist.cpp", uVar6, "Method/function failed. Returning: PackedByteArray()", pcVar7, 0, 0);
      *(undefined8*)( in_RDI + 8 ) = 0;
      ...
      if (cVar3 == '\0') {
         _err_print_error("save_asn1", "core/io/plist.cpp", 0x350, "Method/function failed. Returning: PackedByteArray()", "PList: ASN.1 serializer error.", 0);
         lVar2 = local_30;
         *(undefined8*)( in_RDI + 8 ) = 0;
         if (local_30 != 0) {
            LOCK();
...
/* PList::get_root() */void PList::get_root(void) {
   char cVar1;
   long in_RSI;
   long *in_RDI;
   *in_RDI = 0;
...
/* Ref<PListNode>::TEMPNAMEPLACEHOLDERVALUE(Ref<PListNode> const&) [clone .isra.0] */void Ref<PListNode>::operator =(Ref<PListNode> *this, Ref *param_1) {
   PListNode *pPVar1;
   char cVar2;
...
/* CowData<Ref<PListNode> >::_copy_on_write() [clone .isra.0] */void CowData<Ref<PListNode>>::_copy_on_write(CowData<Ref<PListNode>> *this) {
   long lVar1;
   long lVar2;
   code *pcVar3;
   char cVar4;
...
/* PListNode::new_array() */PListNode * __thiscall PListNode::new_array(PListNode *this){
   char cVar1;
   RefCounted *this_00;
   ...
   *(undefined1(*) [16])( this_00 + 0x1b0 ) = (undefined1[16])0x0;
   ...
   if (cVar1 == '\0') {
      _err_print_error("new_array", "core/io/plist.cpp", 0x97, "Condition \"node.is_null()\" is true. Returning: Ref<PListNode>()", 0, 0);
      *(undefined8*)this = 0;
   }
 else {
...
/* PListNode::new_dict() */PListNode * __thiscall PListNode::new_dict(PListNode *this){
   char cVar1;
   RefCounted *this_00;
   this_00 = (RefCounted*)operator_new(0x1d0, "");
   RefCounted::RefCounted(this_00);
   ...
   *(undefined1(*) [16])( this_00 + 0x1b0 ) = (undefined1[16])0x0;
   ...
   cVar1 = RefCounted::init_ref();
   if (cVar1 == '\0') {
      _err_print_error("new_dict", "core/io/plist.cpp", 0x9e, "Condition \"node.is_null()\" is true. Returning: Ref<PListNode>()", 0, 0);
      *(undefined8*)this = 0;
   }
 else {
   ...
   *(undefined***)this = &PTR__initialize_classv_0010ad38;
   ...
   if (local_28 == pPVar1) {
      ...
      *(PListNode**)( this + 0x1a0 ) = local_28;
      if (local_28 == (PListNode*)0x0) {
         if (( pPVar1 != (PListNode*)0x0 ) && ( cVar2 = cVar2 != '\0' )) {
            if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
               memdelete<PListNode>(pPVar1);
               return;
            }
   ...
   LAB_00102851:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* PListNode::new_real(double) */PListNode * __thiscall PListNode::new_real(PListNode *this,double param_1){
   char cVar1;
   RefCounted *this_00;
   this_00 = (RefCounted*)operator_new(0x1d0, "");
   RefCounted::RefCounted(this_00);
   ...
   *(undefined1(*) [16])( this_00 + 0x1b0 ) = (undefined1[16])0x0;
   ...
   cVar1 = RefCounted::init_ref();
   if (cVar1 == '\0') {
      _err_print_error("new_real", "core/io/plist.cpp", 0xce, "Condition \"node.is_null()\" is true. Returning: Ref<PListNode>()", 0, 0);
      *(undefined8*)this = 0;
   }
 else {
...
/* PListNode::new_int(long) */PListNode * __thiscall PListNode::new_int(PListNode *this,long param_1){
   char cVar1;
   RefCounted *this_00;
   this_00 = (RefCounted*)operator_new(0x1d0, "");
   RefCounted::RefCounted(this_00);
   ...
   *(undefined1(*) [16])( this_00 + 0x1b0 ) = (undefined1[16])0x0;
   ...
   cVar1 = RefCounted::init_ref();
   if (cVar1 == '\0') {
      _err_print_error("new_int", "core/io/plist.cpp", 0xc6, "Condition \"node.is_null()\" is true. Returning: Ref<PListNode>()", 0, 0);
      *(undefined8*)this = 0;
   }
 else {
...
/* PListNode::new_bool(bool) */PListNode * __thiscall PListNode::new_bool(PListNode *this,bool param_1){
   char cVar1;
   RefCounted *this_00;
   this_00 = (RefCounted*)operator_new(0x1d0, "");
   RefCounted::RefCounted(this_00);
   ...
   *(undefined1(*) [16])( this_00 + 0x1b0 ) = (undefined1[16])0x0;
   ...
   cVar1 = RefCounted::init_ref();
   if (cVar1 == '\0') {
      _err_print_error("new_bool", "core/io/plist.cpp", 0xbe, "Condition \"node.is_null()\" is true. Returning: Ref<PListNode>()", 0, 0);
      *(undefined8*)this = 0;
   }
 else {
...
/* PListNode::new_string(String const&) */String *PListNode::new_string(String *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   char cVar4;
   ...
   *(undefined1(*) [16])( this + 0x1b0 ) = (undefined1[16])0x0;
   ...
   if (cVar4 == '\0') {
      _err_print_error("new_string", "core/io/plist.cpp", 0xa5, "Condition \"node.is_null()\" is true. Returning: Ref<PListNode>()", 0, 0);
      *(undefined8*)param_1 = 0;
   }
 else {
...
/* PListNode::new_data(String const&) */String *PListNode::new_data(String *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   char cVar4;
   ...
   *(undefined1(*) [16])( this + 0x1b0 ) = (undefined1[16])0x0;
   ...
   cVar4 = RefCounted::init_ref();
   if (cVar4 == '\0') {
      _err_print_error("new_data", "core/io/plist.cpp", 0xad, "Condition \"node.is_null()\" is true. Returning: Ref<PListNode>()", 0, 0);
      *(undefined8*)param_1 = 0;
   }
 else {
...
/* PListNode::new_date(String const&) */String *PListNode::new_date(String *param_1) {
   long *plVar1;
   long lVar2;
   char cVar3;
   RefCounted *this;
   ...
   *(undefined1(*) [16])( this + 0x1b0 ) = (undefined1[16])0x0;
   ...
   if (cVar3 == '\0') {
      _err_print_error("new_date", "core/io/plist.cpp", 0xb5, "Condition \"node.is_null()\" is true. Returning: Ref<PListNode>()", 0, 0);
      *(undefined8*)param_1 = 0;
   }
 else {
...
/* Vector<Ref<PListNode> >::push_back(Ref<PListNode>) [clone .isra.0] */void Vector<Ref<PListNode>>::push_back(Vector<Ref<PListNode>> *this, long *param_2) {
   long *plVar1;
   PListNode *pPVar2;
   PListNode *pPVar3;
   char cVar4;
   ...
   if (*(long*)( this + 8 ) == 0) {
      ...
      if (-1 < lVar7) {
         ...
         *plVar1 = (long)pPVar2;
         if (( pPVar2 != (PListNode*)0x0 ) && ( cVar4 = cVar4 == '\0' )) {
            *plVar1 = 0;
         }
...
/* PList::read_bplist_obj(Ref<FileAccess>, unsigned long) */undefined8 *PList::read_bplist_obj(undefined8 *param_1, PList *param_2, undefined8 *param_3, long param_4) {
   Object *pOVar1;
   PList PVar2;
   Object *pOVar3;
   long *plVar4;
   ...
   *(undefined1(*) [16])( this + 0x1b0 ) = (undefined1[16])0x0;
   ...
   ( **(code**)( *(long*)*param_3 + 0x1b8 ) )((long*)*param_3, (ulong)(byte)param_2[0x180] * param_4 + *(long*)( param_2 + 0x198 ));
   pOVar3 = (Object*)*param_3;
   PVar2 = param_2[0x180];
   if (( pOVar3 == (Object*)0x0 ) || ( local_58 = pOVar3 ),cVar7 = RefCounted::reference(),cVar7 == '\0') {
      local_58 = (Object*)0x0;
      lVar12 = read_bplist_var_size_int(param_2, &local_58, PVar2);
      if (lVar12 == 0) goto LAB_00103540;
      LAB_00103391:local_98 = (String*)&local_58;
      ...
      if (bVar19 == 0x50) {
         if (cVar7 == '\x0f') {
            ...
            *(undefined4*)( local_a8 + 0x17c ) = 1;
            if (*(long*)( local_a8 + 0x180 ) == 0) {
               ...
               LAB_00103fe0:CowData<char>::_copy_on_write((CowData<char>*)( local_a8 + 0x180 ));
               if (uVar24 == 0) {
                  uVar24 = 0;
                  lVar12 = 0;
               }
            ...
            if ((long)uVar24 < (long)uVar16) {
               if (lVar25 == lVar12) {
                  LAB_00104c27:puVar15 = *(undefined8**)( local_a8 + 0x180 );
                  if (puVar15 == (undefined8*)0x0) {
                     puVar15 = (undefined8*)read_bplist_obj();
                     return puVar15;
                  }

                  LAB_001040ba:puVar15[-1] = uVar16;
               }
 else if (uVar24 == 0) {
 ...
 else if (( lVar25 == lVar12 ) || ( iVar11 = CowData<char>::_realloc((CowData<char>*)( local_a8 + 0x180 ), lVar25) ),iVar11 == 0) {
               if (*(long*)( local_a8 + 0x180 ) == 0) {
         ...
         LAB_001040be:plVar4 = (long*)*param_3;
         ...
         if (bVar19 == 0x20) {
            *(undefined4*)( local_a8 + 0x17c ) = 6;
            LAB_00103616:dVar27 = pow(_LC90, (double)uVar21);
            pOVar3 = (Object*)*param_3;
            uVar21 = (int)dVar27 & 0xff;
            if (( pOVar3 == (Object*)0x0 ) || ( local_58 = pOVar3 ),cVar7 = RefCounted::reference(),cVar7 == '\0') goto LAB_00103669;
            ...
            *(undefined8*)( local_a8 + 0x1c8 ) = uVar13;
            ...
            if (cVar7 == '\0') {
               ...
               *(undefined4*)( local_a8 + 0x17c ) = 4;
               ...
               if (cVar7 != '\t') {
                  _err_print_error("read_bplist_obj", "core/io/plist.cpp", 0x209, "Method/function failed. Returning: Ref<PListNode>()", "Invalid nil/bool marker value.", 0, 0);
                  goto LAB_00103573;
               }
            ...
            *(ulong*)( local_a8 + 0x1c8 ) = uVar16 >> 0x38 | ( uVar16 & 0xff000000000000 ) >> 0x28 | ( uVar16 & 0xff0000000000 ) >> 0x18 | ( uVar16 & 0xff00000000 ) >> 8 | ( uVar16 & 0xff000000 ) << 8 | ( uVar16 & 0xff0000 ) << 0x18 | ( uVar16 & 0xff00 ) << 0x28 | uVar16 << 0x38;
                  ...
                  if (cVar7 == '\x0f') {
                     ...
                     do {
                        ...
                        if (lVar12 < 0) {
                           ...
                           lVar25 = puVar15[-1];
                           LAB_0010444b:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar12, lVar25, "p_index", "size()", "", false, false);
                        }
 else {
                           if (puVar15 == (undefined8*)0x0) {
                              LAB_00104448:lVar25 = 0;
                              goto LAB_0010444b;
                           }
 ...
 while ( uVar16 != local_90 );
                     *(undefined4*)( local_a8 + 0x17c ) = 1;
                     if (puVar15 == (undefined8*)0x0) {
                        LAB_00104439:puVar15 = (undefined8*)0x0;
                     }

                  }
 else {
                     uVar16 = ( ulong )(uVar21 + 1);
                     LAB_00104146:uVar24 = uVar16 * 2 - 1;
               ...
               *(undefined4*)( local_a8 + 0x17c ) = 5;
               ...
               LAB_00103669:local_58 = (Object*)0x0;
               uVar13 = read_bplist_var_size_int(param_2, local_98, uVar21);
               *(undefined8*)( local_a8 + 0x1c8 ) = uVar13;
               goto LAB_00103688;
            }
               ...
               if (bVar19 == 0xd0) {
                  ...
                  *(undefined4*)( local_a8 + 0x17c ) = 3;
                  if (local_90 != 0) {
                     uVar16 = 0;
                     do {
                        ( **(code**)( *(long*)*param_3 + 0x1b8 ) )((long*)*param_3, (byte)param_2[0x181] * uVar16 + lVar12);
                        pOVar3 = (Object*)*param_3;
                        PVar2 = param_2[0x181];
                        if (( pOVar3 == (Object*)0x0 ) || ( local_58 = pOVar3 ),cVar7 = RefCounted::reference(),cVar7 == '\0') {
                           local_58 = (Object*)0x0;
                        ...
                        ( **(code**)( *(long*)*param_3 + 0x1b8 ) )((long*)*param_3, (ulong)(byte)param_2[0x181] * ( local_90 + uVar16 ) + lVar12);
                        pOVar3 = (Object*)*param_3;
                        PVar2 = param_2[0x181];
                        if (( pOVar3 == (Object*)0x0 ) || ( local_58 = pOVar3 ),cVar7 = RefCounted::reference(),cVar7 == '\0') {
                           local_58 = (Object*)0x0;
                        ...
                        if (local_68 == (PListNode*)0x0) {
                           uVar13 = 0x260;
                           pcVar20 = "Condition \"element_key.is_null() || element_key->data_type != PL_NODE_TYPE_STRING\" is true. Returning: Ref<PListNode>()";
                           LAB_001045ca:_err_print_error("read_bplist_obj", "core/io/plist.cpp", uVar13, pcVar20, 0, 0);
                           *param_1 = 0;
                           goto LAB_001036a7;
                        }
                        ...
                        if (*(int*)( local_68 + 0x17c ) != 1) {
                           uVar13 = 0x260;
                           pcVar20 = "Condition \"element_key.is_null() || element_key->data_type != PL_NODE_TYPE_STRING\" is true. Returning: Ref<PListNode>()";
                           LAB_00104b42:_err_print_error("read_bplist_obj", "core/io/plist.cpp", uVar13, pcVar20, 0, 0);
                           *param_1 = 0;
                           cVar7 = RefCounted::unreference();
                           if (cVar7 != '\0') {
                        ...
                        puVar15 = (undefined8*)HashMap<String,Ref<PListNode>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<PListNode>>>>::operator []((HashMap<String,Ref<PListNode>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<PListNode>>>>*)( local_a8 + 0x198 ), local_98);
                        ...
                        if (pPVar26 != pPVar6) {
                           *puVar15 = pPVar26;
                           ...
                           if (( pPVar6 != (PListNode*)0x0 ) && ( cVar7 = cVar7 != '\0' )) {
                        ...
                        if (local_58 == (Object*)0x0) {
                           ...
                           LAB_00103c00:cVar7 = RefCounted::unreference();
                           if (cVar7 != '\0') {
                              memdelete<PListNode>(pPVar22);
                           }
                           ...
                           *(long*)pOVar1 = *(long*)pOVar1 + -1;
                           ...
                           pPVar26 = local_60;
                           pPVar22 = local_68;
                           if (( local_60 != (PListNode*)0x0 ) && ( cVar7 = cVar7 != '\0' )) {
                              LAB_001043d0:memdelete<PListNode>(pPVar26);
                           }
 ...
 while ( local_90 != uVar16 );
               ...
               LAB_001040f0:_err_print_error("read_bplist_obj", "core/io/plist.cpp", 0x267, "Method/function failed. Returning: Ref<PListNode>()", "Invalid marker type.", 0, 0);
               goto LAB_00103573;
            }
 ...
 while ( local_90 != uVar16 );
      ...
      LAB_00103540:_err_print_error("read_bplist_obj", "core/io/plist.cpp", 0x1f7, "Condition \"marker_off == 0\" is true. Returning: Ref<PListNode>()", "Invalid marker size.", 0, 0);
      LAB_00103573:*param_1 = 0;
      if (local_a8 == (PListNode*)0x0) goto LAB_001036b8;
   }

   LAB_001036a7:cVar7 = RefCounted::unreference();
   if (cVar7 != '\0') {
      memdelete<PListNode>(local_a8);
   }

   LAB_001036b8:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* PListNode::push_subnode(Ref<PListNode> const&, String const&) */undefined8 PListNode::push_subnode(PListNode *this, Ref *param_1, String *param_2) {
   uint uVar1;
   PListNode *pPVar2;
   PListNode *pPVar3;
   long lVar4;
   ...
   if (pPVar2 == (PListNode*)0x0) {
      _err_print_error("push_subnode", "core/io/plist.cpp", 0xd5, "Condition \"p_node.is_null()\" is true. Returning: false", 0, 0);
      uVar16 = 0;
   }
 else {
      if (*(int*)( this + 0x17c ) == 3) {
         if (( *(long*)param_2 == 0 ) || ( *(uint*)( *(long*)param_2 + -8 ) < 2 )) {
            _err_print_error("push_subnode", "core/io/plist.cpp", 0xd7, "Condition \"p_key.is_empty()\" is true. Returning: false", 0, 0);
            uVar16 = 0;
            goto LAB_00104e35;
         }
         ...
         if (( *(long*)( this + 0x1a0 ) != 0 ) && ( *(int*)( this + 0x1c4 ) != 0 )) {
            ...
            if (uVar15 != 0) {
               ...
               do {
                  if (uVar18 == uVar15) {
                     cVar14 = String::operator ==((String*)( *(long*)( *(long*)( this + 0x1a0 ) + lVar20 * 8 ) + 0x10 ), param_2);
                     if (cVar14 != '\0') {
                        _err_print_error("push_subnode", "core/io/plist.cpp", 0xd8, "Condition \"data_dict.has(p_key)\" is true. Returning: false", 0, 0);
                        uVar16 = 0;
                        goto LAB_00104e35;
                     }
 ...
 while ( ( uVar15 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar15 * lVar4,auVar11._8_8_ = 0,auVar11._0_8_ = uVar13,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar1 + iVar19 ) - SUB164(auVar7 * auVar11, 8)) * lVar4,auVar12._8_8_ = 0,auVar12._0_8_ = uVar13,uVar22 <= SUB164(auVar8 * auVar12, 8) );
            }

         }

         plVar17 = (long*)HashMap<String,Ref<PListNode>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<PListNode>>>>::operator []((HashMap<String,Ref<PListNode>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<PListNode>>>>*)( this + 0x198 ), param_2);
         pPVar2 = *(PListNode**)param_1;
         pPVar3 = (PListNode*)*plVar17;
         if (pPVar2 != pPVar3) {
            *plVar17 = (long)pPVar2;
            if (( pPVar2 != (PListNode*)0x0 ) && ( cVar14 = cVar14 == '\0' )) {
               *plVar17 = 0;
            }

            if (( pPVar3 != (PListNode*)0x0 ) && ( cVar14 = cVar14 != '\0' )) {
               memdelete<PListNode>(pPVar3);
            }
         ...
         if (*(int*)( this + 0x17c ) != 2) {
            _err_print_error("push_subnode", "core/io/plist.cpp", 0xdf, "Method/function failed. Returning: false", "PList: Invalid parent node type, should be DICT or ARRAY.", 0, 0);
            uVar16 = 0;
            goto LAB_00104e35;
         }
   ...
   LAB_00104e35:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* PList::load_string(String const&, String&) */undefined4 PList::load_string(PList *this, String *param_1, String *param_2) {
   PListNode *pPVar1;
   long *plVar2;
   ...
   LAB_00105142:do {
      ...
      if (( *(int*)local_88 == 0x21 ) || ( *(int*)local_88 == 0x3f )) {
         ...
         if (cVar5 != '\0') {
            if (local_98 == (undefined1(*) [16])0x0) {
               if (*(long*)( this + 0x1a0 ) == 0) {
                  ...
                  *pauVar9 = (undefined1[16])0x0;
                  local_98 = pauVar9;
                  LAB_001056c3:pauVar10 = (undefined1(*) [16])operator_new(0x20, DefaultAllocator::alloc);
                  pPVar1 = local_58;
                  ...
                  *(int*)pauVar9[1] = *(int*)pauVar9[1] + 1;
                  if (pPVar16 == pPVar1) {
                     ...
                     *(PListNode**)( this + 0x1a0 ) = pPVar1;
                     if (pPVar1 == (PListNode*)0x0) {
                        LAB_001055c9:if (pPVar16 != (PListNode*)0x0) goto LAB_001059c6;
                        goto LAB_001055d8;
                     }
                     ...
                     if (( pPVar16 != (PListNode*)0x0 ) && ( cVar5 = cVar5 != '\0' )) {
                        memdelete<PListNode>(pPVar16);
                     }
               ...
               if (*(int*)local_98[1] != 0) {
                  ...
                  *(undefined4*)( local_60 + 0x17c ) = 3;
                  cVar5 = PListNode::push_subnode((PListNode*)**(undefined8**)( *pauVar9 + 8 ), (PListNode*)&local_60, (String*)&local_90);
                  if (cVar5 != '\0') {
            ...
            LAB_001055f0:local_50 = 0x16;
            local_58 = (PListNode*)0x1079b7;
            String::parse_latin1((StrRange*)param_2);
            LAB_001052b8:pPVar16 = local_80;
            if (local_80 != (PListNode*)0x0) {
               LOCK();
               pPVar1 = local_80 + -0x10;
               *(long*)pPVar1 = *(long*)pPVar1 + -1;
         ...
         if (cVar5 == '\0') {
            ...
            if (cVar5 == '\0') {
               cVar5 = String::operator ==((String*)&local_88, "/array");
               if (cVar5 != '\0') {
                  if (( ( local_98 == (undefined1(*) [16])0x0 ) || ( *(int*)local_98[1] == 0 ) ) || ( *(int*)( **(long**)( *local_98 + 8 ) + 0x17c ) != 2 )) {
                     local_50 = 0x18;
                  ...
                  List<Ref<PListNode>,DefaultAllocator>::pop_back((List<Ref<PListNode>,DefaultAllocator>*)&local_98);
                  goto LAB_001055d8;
               }
               ...
               if (local_88 == (PListNode*)0x0) {
                  lVar13 = -1;
                  lVar12 = 0;
                  LAB_00105585:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar13, lVar12, "p_index", "size()", "", false, true);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
                  pcVar3 = (code*)invalidInstructionException();
                  ( *pcVar3 )();
               ...
               if (lVar12 == lVar13) {
                  LAB_00105c3b:iVar6 = String::find((char*)param_1, 0x107a12);
                  if (iVar6 == -1) {
                     local_60 = (PListNode*)0x0;
                     if (local_88 != (PListNode*)0x0) {
                     ...
                     vformat<String>((CowData*)&local_58, (String*)&local_68, (CowData<char32_t>*)&local_60);
                     ...
                     vformat<String,String>((CowData*)&local_58, (String*)&local_70, (CowData<char32_t>*)&local_68, (CowData<char32_t>*)&local_60);
                     if (*(PListNode**)param_2 != local_58) {
                        CowData<char32_t>::operator =((CowData<char32_t>*)param_2, (CowData*)&local_58);
                     }
                  ...
                  CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
                  LAB_00105d3e:local_b0 = (PListNode*)&local_58;
                  ...
                  if (cVar5 == '\0') {
                     ...
                     LAB_00105ed7:Ref<PListNode>::operator =((Ref<PListNode>*)&local_70, local_58);
                     Ref<PListNode>::unref((Ref<PListNode>*)local_b0);
                     if (( ( local_98 != (undefined1(*) [16])0x0 ) && ( *(int*)local_98[1] != 0 ) ) && ( cVar5 = PListNode::push_subnode((PListNode*)**(undefined8**)( *local_98 + 8 ), (Ref<PListNode>*)&local_70, (String*)&local_90) ),cVar5 != '\0') {
            ...
            if (local_98 == (undefined1(*) [16])0x0) {
               ...
               *(undefined4*)pauVar9[1] = 0;
               local_98 = pauVar9;
               LAB_001058ea:pauVar10 = (undefined1(*) [16])operator_new(0x20, DefaultAllocator::alloc);
               pPVar16 = local_58;
               *pauVar10 = (undefined1[16])0x0;
               pauVar10[1] = (undefined1[16])0x0;
               if (local_58 != (PListNode*)0x0) {
               ...
               *(PListNode**)( this + 0x1a0 ) = pPVar16;
               if (pPVar16 == (PListNode*)0x0) {
                  if (( pPVar1 == (PListNode*)0x0 ) || ( cVar5 = cVar5 == '\0' )) goto LAB_001055d8;
                  LAB_001055c1:memdelete<PListNode>(pPVar1);
                  goto LAB_001055c9;
               }
               ...
               if (( pPVar1 != (PListNode*)0x0 ) && ( cVar5 = cVar5 != '\0' )) goto LAB_001055c1;
               LAB_001059c6:cVar5 = RefCounted::unreference();
            }
 else {
               if (*(int*)local_98[1] == 0) {
                  if (*(long*)( this + 0x1a0 ) == 0) {
               ...
               if (cVar5 == '\0') {
                  ...
                  String::parse_latin1((StrRange*)param_2);
                  pPVar16 = local_60;
                  if (( local_60 != (PListNode*)0x0 ) && ( cVar5 = cVar5 != '\0' )) {
                     memdelete<PListNode>(pPVar16);
                  }
            ...
            if (( ( local_98 == (undefined1(*) [16])0x0 ) || ( *(int*)local_98[1] == 0 ) ) || ( this_00 = *(Ref<PListNode>**)( *local_98 + 8 ) * (int*)( *(long*)this_00 + 0x17c ) != 3 )) {
               local_50 = 0x17;
         ...
         LAB_001055d8:bVar4 = true;
      }

      LAB_00105422:pPVar16 = local_80;
      if (local_80 != (PListNode*)0x0) {
         LOCK();
         pPVar1 = local_80 + -0x10;
         *(long*)pPVar1 = *(long*)pPVar1 + -1;
 ...
 while ( -1 < iVar6 );
   ...
   String::parse_latin1((StrRange*)param_2);
   LAB_00105335:uVar8 = 0;
   LAB_00105338:pPVar16 = local_90;
...
;
 ...
 while ( *(int*)pauVar9[1] != 0 );
      LAB_001053d5:Memory::free_static(pauVar9, false);
   }

   LAB_001053df:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar8;
   }
...
/* PList::PList(String const&) */void PList::PList(PList *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   char cVar4;
...
/* PList::load_file(String const&) */ulong PList::load_file(PList *this, String *param_1) {
   Object *pOVar1;
   long *plVar2;
   PListNode *pPVar3;
   undefined8 uVar4;
 ...
 while ( local_40 != 8 );
   ...
   if (local_50 == (Object*)0x0) {
      LAB_001065e1:if ((char)uVar10 != '\0') goto LAB_001065ea;
      LAB_0010679a:FileAccess::get_file_as_bytes((String*)&local_48, param_1);
      if (local_6c == 0) {
         local_60 = 0;
         if (local_40 == 0) {
            uVar12 = false;
         ...
         if ((char)uVar10 == '\0') {
            operator+((char *)&
            local_50,(String*)"PList: ";
            _err_print_error("load_file", "core/io/plist.cpp", 0x28c, "Condition \"!ok\" is true. Returning: false", (StrRange*)&local_50, 0, 0);
            pOVar6 = local_50;
            if (local_50 != (Object*)0x0) {
               LOCK();
         ...
         _err_print_error("load_file", "core/io/plist.cpp", 0x286, "Condition \"err != OK\" is true. Returning: false", 0, 0);
      }
      ...
      *(long*)pOVar1 = *(long*)pOVar1 + -1;
      ...
      LAB_001065ea:( **(code**)( *(long*)local_68 + 0x1c0 ) )(local_68, 0xffffffffffffffe6);
      PVar9 = ( PList )(**(code**)( *(long*)local_68 + 0x1e0 ))();
      this[0x180] = PVar9;
      PVar9 = ( PList )(**(code**)( *(long*)local_68 + 0x1e0 ))();
      this[0x181] = PVar9;
      uVar11 = ( **(code**)( *(long*)local_68 + 0x1f8 ) )();
      *(ulong*)( this + 0x188 ) = uVar11 >> 0x38 | ( uVar11 & 0xff000000000000 ) >> 0x28 | ( uVar11 & 0xff0000000000 ) >> 0x18 | ( uVar11 & 0xff00000000 ) >> 8 | ( uVar11 & 0xff000000 ) << 8 | ( uVar11 & 0xff0000 ) << 0x18 | ( uVar11 & 0xff00 ) << 0x28 | uVar11 << 0x38;
      uVar11 = ( **(code**)( *(long*)local_68 + 0x1f8 ) )();
      *(ulong*)( this + 400 ) = uVar11 >> 0x38 | ( uVar11 & 0xff000000000000 ) >> 0x28 | ( uVar11 & 0xff0000000000 ) >> 0x18 | ( uVar11 & 0xff00000000 ) >> 8 | ( uVar11 & 0xff000000 ) << 8 | ( uVar11 & 0xff0000 ) << 0x18 | ( uVar11 & 0xff00 ) << 0x28 | uVar11 << 0x38;
      uVar11 = ( **(code**)( *(long*)local_68 + 0x1f8 ) )();
      local_50 = (Object*)0x0;
      uVar4 = *(undefined8*)( this + 400 );
      *(ulong*)( this + 0x198 ) = uVar11 >> 0x38 | ( uVar11 & 0xff000000000000 ) >> 0x28 | ( uVar11 & 0xff0000000000 ) >> 0x18 | ( uVar11 & 0xff00000000 ) >> 8 | ( uVar11 & 0xff000000 ) << 8 | ( uVar11 & 0xff0000 ) << 0x18 | ( uVar11 & 0xff00 ) << 0x28 | uVar11 << 0x38;
      if (local_68 != (Object*)0x0) {
         local_50 = local_68;
      ...
      if (local_48 == pPVar3) {
         ...
         *(PListNode**)( this + 0x1a0 ) = local_48;
         if (local_48 == (PListNode*)0x0) {
            if (( pPVar3 != (PListNode*)0x0 ) && ( cVar8 = cVar8 != '\0' )) {
               memdelete<PListNode>(pPVar3);
            }
            ...
            LAB_00106702:cVar8 = RefCounted::unreference();
            if (cVar8 != '\0') {
      ...
      pOVar6 = local_50;
      if (( ( local_50 != (Object*)0x0 ) && ( cVar8 = RefCounted::unreference() ),cVar8 != '\0' )) &&( cVar8 = cVar8 != '\0' )(**(code**)( *(long*)pOVar6 + 0x140 ))(pOVar6);
      Memory::free_static(pOVar6, false);
   }

   uVar11 = CONCAT71(( int7 )((ulong)pOVar6 >> 8), *(long*)( this + 0x1a0 ) != 0);
}
if (( ( local_68 != (Object*)0x0 ) && ( cVar8 = RefCounted::unreference() ),cVar8 != '\0' )) &&( cVar8 = cVar8 != '\0' )(**(code**)( *(long*)local_68 + 0x140 ))(local_68);Memory::free_static(local_68, false);}LAB_0010674f:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return uVar11 & 0xffffffff;}/* PListNode::new_node(Variant const&) */PListNode * __thiscall PListNode::new_node(PListNode *this,Variant *param_1){
   long *plVar1;
   PListNode *pPVar2;
   PListNode *pPVar3;
   long lVar4;
   ...
   *(RefCounted**)this = pRVar11;
   ...
   if (cVar5 == '\0') {
      *(undefined8*)this = 0;
      ...
      LAB_00106c3a:cVar5 = RefCounted::unreference();
   }

   if (cVar5 != '\0') {
      LAB_00106c50:memdelete<PListNode>((PListNode*)pRVar11);
   }

   LAB_00106b4a:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* RefCounted::is_class_ptr(void*) const */uint RefCounted::is_class_ptr(RefCounted *this, void *param_1) {
   return (uint)CONCAT71(0x10b0, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10af, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
}
...
/* RefCounted::_get_class_namev() const */undefined8 *RefCounted::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00107343:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00107343;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "RefCounted");
   LAB_001073ae:return &_get_class_namev();
}
...
/* RefCounted::is_class(String const&) const */undefined8 RefCounted::is_class(RefCounted *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_0010753f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
         ...
         LAB_001076a3:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
      ...
      LAB_001075f3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* CowData<Ref<PListNode> >::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<Ref<PListNode>>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* PList::read_bplist_obj(Ref<FileAccess>, unsigned long) [clone .cold] */void PList::read_bplist_obj(void) {
   code *pcVar1;
   _DAT_00000000 = 0;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void FUN_00107b04(void) {
   code *pcVar1;
   _DAT_00000000 = 0;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
...
/* WARNING: Removing unreachable block (ram,0x00108b28) *//* WARNING: Removing unreachable block (ram,0x00108c58) *//* WARNING: Removing unreachable block (ram,0x00108e20) *//* WARNING: Removing unreachable block (ram,0x00108c64) *//* WARNING: Removing unreachable block (ram,0x00108c6e) *//* WARNING: Removing unreachable block (ram,0x00108e00) *//* WARNING: Removing unreachable block (ram,0x00108c7a) *//* WARNING: Removing unreachable block (ram,0x00108c84) *//* WARNING: Removing unreachable block (ram,0x00108de0) *//* WARNING: Removing unreachable block (ram,0x00108c90) *//* WARNING: Removing unreachable block (ram,0x00108c9a) *//* WARNING: Removing unreachable block (ram,0x00108dc0) *//* WARNING: Removing unreachable block (ram,0x00108ca6) *//* WARNING: Removing unreachable block (ram,0x00108cb0) *//* WARNING: Removing unreachable block (ram,0x00108da0) *//* WARNING: Removing unreachable block (ram,0x00108cbc) *//* WARNING: Removing unreachable block (ram,0x00108cc6) *//* WARNING: Removing unreachable block (ram,0x00108d80) *//* WARNING: Removing unreachable block (ram,0x00108cd2) *//* WARNING: Removing unreachable block (ram,0x00108cdc) *//* WARNING: Removing unreachable block (ram,0x00108d60) *//* WARNING: Removing unreachable block (ram,0x00108ce4) *//* WARNING: Removing unreachable block (ram,0x00108cfa) *//* WARNING: Removing unreachable block (ram,0x00108d06) *//* String vformat<String>(String const&, String const) */undefined8 *vformat<String>(undefined8 *param_1, bool *param_2, String *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* WARNING: Removing unreachable block (ram,0x00108fa0) *//* WARNING: Removing unreachable block (ram,0x001090d0) *//* WARNING: Removing unreachable block (ram,0x00109249) *//* WARNING: Removing unreachable block (ram,0x001090dc) *//* WARNING: Removing unreachable block (ram,0x001090e6) *//* WARNING: Removing unreachable block (ram,0x0010922b) *//* WARNING: Removing unreachable block (ram,0x001090f2) *//* WARNING: Removing unreachable block (ram,0x001090fc) *//* WARNING: Removing unreachable block (ram,0x0010920d) *//* WARNING: Removing unreachable block (ram,0x00109108) *//* WARNING: Removing unreachable block (ram,0x00109112) *//* WARNING: Removing unreachable block (ram,0x001091ef) *//* WARNING: Removing unreachable block (ram,0x0010911e) *//* WARNING: Removing unreachable block (ram,0x00109128) *//* WARNING: Removing unreachable block (ram,0x001091d1) *//* WARNING: Removing unreachable block (ram,0x00109134) *//* WARNING: Removing unreachable block (ram,0x0010913e) *//* WARNING: Removing unreachable block (ram,0x001091b3) *//* WARNING: Removing unreachable block (ram,0x00109146) *//* WARNING: Removing unreachable block (ram,0x00109150) *//* WARNING: Removing unreachable block (ram,0x00109198) *//* WARNING: Removing unreachable block (ram,0x00109158) *//* WARNING: Removing unreachable block (ram,0x0010916e) *//* WARNING: Removing unreachable block (ram,0x0010917a) *//* String vformat<String, String>(String const&, String const, String const) */undefined8 *vformat<String,String>(undefined8 *param_1, bool *param_2, String *param_3, String *param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   long in_FS_OFFSET;
...
/* CowData<char16_t>::_realloc(long) */undefined8 CowData<char16_t>::_realloc(CowData<char16_t> *this, long param_1) {
   undefined8 *puVar1;
...
/* void memdelete<PListNode>(PListNode*) */void memdelete<PListNode>(PListNode *param_1) {
   long *plVar1;
   uint uVar2;
   long lVar3;
   char cVar4;
 ...
 while ( lVar5 != (ulong)uVar2 << 2 );
   ...
   LAB_001097a1:CowData<Ref<PListNode>>::_unref((CowData<Ref<PListNode>>*)( param_1 + 400 ));
   ...
   *(undefined***)param_1 = &PTR__initialize_classv_0010abd8;
   ...
   LAB_001097d3:Memory::free_static(param_1, false);
   return;
}
...
/* CowData<Ref<PListNode> >::_unref() */void CowData<Ref<PListNode>>::_unref(CowData<Ref<PListNode>> *this) {
   long *plVar1;
   long lVar2;
   PListNode *pPVar3;
   code *pcVar4;
...
/* PListNode::~PListNode() */void PListNode::~PListNode(PListNode *this) {
   long *plVar1;
   uint uVar2;
   long lVar3;
   char cVar4;
 ...
 while ( lVar5 != (ulong)uVar2 << 2 );
   ...
   LAB_00109b20:CowData<Ref<PListNode>>::_unref((CowData<Ref<PListNode>>*)( this + 400 ));
   if (*(long*)( this + 0x180 ) != 0) {
      LOCK();
...
/* PListNode::~PListNode() */void PListNode::~PListNode(PListNode *this) {
 ...
 while ( lVar5 != (ulong)uVar2 << 2 );
   ...
   LAB_00109cd0:CowData<Ref<PListNode>>::_unref((CowData<Ref<PListNode>>*)( this + 400 ));
   if (*(long*)( this + 0x180 ) != 0) {
      LOCK();
      plVar1 = (long*)( *(long*)( this + 0x180 ) + -0x10 );
      *plVar1 = *plVar1 + -1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<String, Ref<PListNode>, HashMapHasherDefault, HashMapComparatorDefault<String>,
 ...
 while ( uVar40 != uVar45 );
      ...
      LAB_0010a3c6:if (iVar46 != 0) {
         LAB_0010a3ce:uVar38 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
 ...
 while ( ( uVar53 != 0 ) && ( auVar19._8_8_ = 0 ),auVar19._0_8_ = (ulong)uVar53 * lVar3,auVar35._8_8_ = 0,auVar35._0_8_ = uVar40,auVar20._8_8_ = 0,auVar20._0_8_ = ( ulong )(( uVar38 + uVar52 ) - SUB164(auVar19 * auVar35, 8)) * lVar3,auVar36._8_8_ = 0,auVar36._0_8_ = uVar40,uVar55 <= SUB164(auVar20 * auVar36, 8) );
   ...
   LAB_00109eaa:uVar56 = *(uint*)( this + 0x28 );
   if (uVar56 == 0x1c) {
...
;
 ...
 while ( ( uVar39 != 0 ) && ( auVar15._8_8_ = 0 ),auVar15._0_8_ = (ulong)uVar39 * lVar3,auVar31._8_8_ = 0,auVar31._0_8_ = uVar40,auVar16._8_8_ = 0,auVar16._0_8_ = ( ulong )(( uVar53 + uVar56 ) - SUB164(auVar15 * auVar31, 8)) * lVar3,auVar32._8_8_ = 0,auVar32._0_8_ = uVar40,uVar52 <= SUB164(auVar16 * auVar32, 8) );
      ...
      LAB_0010a3c2:iVar46 = *(int*)( this + 0x2c );
      goto LAB_0010a3c6;
   }

   LAB_00109e84:if ((float)uVar40 * __LC76 < (float)( iVar46 + 1 )) goto LAB_00109eaa;
}
local_58[0] = 0;if (*(long*)param_1 == 0) {
   pauVar42 = (undefined1(*) [16])operator_new(0x20, "");
   *(undefined8*)pauVar42[1] = 0;
   *pauVar42 = (undefined1[16])0x0;
   LAB_0010a4eb:*(undefined8*)( pauVar42[1] + 8 ) = 0;
   LAB_0010a133:puVar43 = *(undefined8**)( this + 0x20 );
   if (puVar43 != (undefined8*)0x0) goto LAB_0010a140;
   LAB_0010a37d:*(undefined1(**) [16])( this + 0x18 ) = pauVar42;
}
 else {
...
*(undefined1(**) [16])( lVar47 + lVar48 * 8 ) = pauVar58;*puVar51 = uVar56;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0010a24b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return pauVar42[1] + 8;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* List<Ref<PListNode>, DefaultAllocator>::pop_back() */void List<Ref<PListNode>,DefaultAllocator>::pop_back(List<Ref<PListNode>,DefaultAllocator> *this) {
   long *plVar1;
   long *plVar2;
   long lVar3;
   char cVar4;
...
/* CowData<Ref<PListNode> >::_realloc(long) */undefined8 CowData<Ref<PListNode>>::_realloc(CowData<Ref<PListNode>> *this, long param_1) {
   undefined8 *puVar1;
   puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
   if (puVar1 != (undefined8*)0x0) {
      *puVar1 = 1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Ref<PListNode> >::resize<false>(long) */undefined8 CowData<Ref<PListNode>>::resize<false>(CowData<Ref<PListNode>> *this, long param_1) {
   long *plVar1;
   code *pcVar2;
   char cVar3;
   undefined8 uVar4;
   ...
   if (param_1 * 8 == 0) {
      LAB_0010ab00:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar10 == lVar7) {
      LAB_0010aa7b:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         LAB_0010a990:/* WARNING: Does not return */pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
      }
   ...
   LAB_0010aa5b:puVar9[-1] = param_1;
   return 0;
}
/* WARNING: Control flow encountered bad instruction data *//* PListNode::~PListNode() */void PListNode::~PListNode(PListNode *this) {

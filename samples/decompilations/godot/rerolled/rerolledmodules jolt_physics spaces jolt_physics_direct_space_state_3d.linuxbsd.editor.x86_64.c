/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JoltPhysicsDirectSpaceState3D::intersect_point(PhysicsDirectSpaceState3D::PointParameters const&,
   PhysicsDirectSpaceState3D::ShapeResult*, int) */int JoltPhysicsDirectSpaceState3D::intersect_point(JoltPhysicsDirectSpaceState3D *this, PointParameters *param_1, ShapeResult *param_2, int param_3) {
   SubShapeID SVar1;
   SubShapeID *pSVar2;
   int iVar3;
   undefined8 uVar4;
   ...
   if (*(char*)( *(long*)( this + 0x178 ) + 0x89 ) == '\0') {
      if (param_3 != 0) {
         ...
         JoltQueryFilter3D::JoltQueryFilter3D(local_208, this, *(uint*)( param_1 + 0x38 ), (bool)param_1[0x3c], (bool)param_1[0x3d], (HashSet*)( param_1 + 0x10 ), false);
         local_188 = &PTR__JoltQueryCollectorAnyMulti_0010f028;
         local_70 = __LC14;
         uStack_68 = _UNK_0010f1a8;
         ...
         local_218 = &PTR__ShapeFilter_0010ece0;
         local_210 = 0xffffffff;
         JPH::NarrowPhaseQuery::CollidePoint(*(undefined8*)param_1, CONCAT44(*(undefined4*)( param_1 + 8 ), *(undefined4*)( param_1 + 8 )), uVar4, &local_188, local_208, local_200, local_1f8, &local_218);
         local_238 = (int)uStack_68;
         if (0 < local_238) {
            lVar5 = 0;
            do {
               JoltSpace3D::read_body((BodyID*)local_1d8);
               if (( local_198 == 0 ) || ( pSVar2 = *(SubShapeID**)( local_198 + 0x50 ) ),pSVar2 == (SubShapeID*)0x0) {
                  _err_print_error("intersect_point", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x22b, "Parameter \"object\" is null.", 0, 0);
                  LAB_001002d5:JoltBodyAccessor3D::release();
               ...
               *(undefined4*)( param_2 + lVar5 * 4 + 0x18 ) = 0;
               if (SVar1 != (SubShapeID)0x2) {
                  ...
                  if (iVar3 == -1) {
                     _err_print_error("intersect_point", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x233, "Condition \"shape_index == -1\" is true. Returning: 0", 0, 0);
                     goto LAB_001002d5;
                  }
 ...
 while ( ( ulong )(local_238 - 1) * 8 + 8 != lVar5 );
      ...
      _err_print_error("intersect_point", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x218, "Condition \"space->is_stepping()\" is true. Returning: false", "intersect_point must not be called while the physics space is being stepped.", 0, 0);
   }

   local_238 = 0;
   LAB_0010004d:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return local_238;
   }
...
/* JoltPhysicsDirectSpaceState3D::_try_get_face_index(JPH::Body const&, JPH::SubShapeID const&) */undefined8 JoltPhysicsDirectSpaceState3D::_try_get_face_index(JoltPhysicsDirectSpaceState3D *this, Body *param_1, SubShapeID *param_2) {
   char cVar1;
   SubShapeID *pSVar2;
   undefined8 uVar3;
   long in_FS_OFFSET;
   ...
   if (cVar1 != '\0') {
      local_24 = 0xffffffff;
      pSVar2 = (SubShapeID*)( **(code**)( **(long**)( param_1 + 0x40 ) + 0x48 ) )(*(long**)( param_1 + 0x40 ), param_2, &local_24);
   ...
   uVar3 = 0xffffffff;
   LAB_00100447:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar3;
   }
...
/* JoltPhysicsDirectSpaceState3D::intersect_ray(PhysicsDirectSpaceState3D::RayParameters const&,
   PhysicsDirectSpaceState3D::RayResult&) */char JoltPhysicsDirectSpaceState3D::intersect_ray(JoltPhysicsDirectSpaceState3D *this, RayParameters *param_1, RayResult *param_2) {
   SubShapeID SVar1;
   SubShapeID *pSVar2;
   int iVar3;
   undefined4 uVar4;
   ...
   if (*(char*)( *(long*)( this + 0x178 ) + 0x89 ) == '\0') {
      JoltSpace3D::try_optimize();
      JoltQueryFilter3D::JoltQueryFilter3D(local_d8, this, *(uint*)( param_1 + 0x40 ), (bool)param_1[0x44], (bool)param_1[0x45], (HashSet*)( param_1 + 0x18 ), (bool)param_1[0x48]);
      ...
      local_f8 = 0;
      local_108 = &PTR__JoltQueryCollectorClosest_0010ee50;
      ...
      local_118 = &PTR__ShapeFilter_0010ece0;
      JPH::NarrowPhaseQuery::CastRay(pRVar5, (RayCastSettings*)&local_a8, (CollisionCollector*)&local_11b, (BroadPhaseLayerFilter*)&local_108, (ObjectLayerFilter*)local_d8, local_d0, local_c8);
      cVar8 = local_e4;
      if (local_e4 != '\0') {
         JoltSpace3D::read_body((BodyID*)local_88);
         if (( local_48 == (Body*)0x0 ) || ( pSVar2 = *(SubShapeID**)( local_48 + 0x50 ) ),pSVar2 == (SubShapeID*)0x0) {
            _err_print_error("intersect_ray", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x1f7, "Parameter \"object\" is null.", 0, 0);
            LAB_00100835:cVar8 = '\0';
         }
 else {
            ...
            if (( param_1[0x46] == (RayParameters)0x0 ) || ( 0.0 < local_f0._4_4_ )) {
               auVar16 = JPH::Body::GetWorldSpaceSurfaceNormal((Body*)CONCAT44(fVar11, fVar9), CONCAT44(local_f0._4_4_ * fStack_8c + fStack_9c, fVar12), local_48, &local_e8);
            ...
            *(undefined8*)( param_2 + 0x28 ) = uVar7;
            if (SVar1 != (SubShapeID)0x2) {
               iVar3 = JoltShapedObject3D::find_shape_index(pSVar2);
               if (iVar3 == -1) {
                  _err_print_error("intersect_ray", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x20f, "Condition \"shape_index == -1\" is true. Returning: false", 0, 0);
                  goto LAB_00100835;
               }
      ...
      _err_print_error("intersect_ray", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x1d8, "Condition \"space->is_stepping()\" is true. Returning: false", "intersect_ray must not be called while the physics space is being stepped.", 0, 0);
   }

   cVar8 = '\0';
   LAB_001005e0:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* JoltPhysicsDirectSpaceState3D::_generate_manifold(JPH::CollideShapeResult const&,
   JPH::StaticArray<JPH::Vec3, 64u>&, JPH::StaticArray<JPH::Vec3, 64u>&, JPH::Vec3) const */undefined8 JoltPhysicsDirectSpaceState3D::_generate_manifold(undefined8 param_1_00, undefined8 param_2_00, long param_1, undefined8 *param_2, uint *param_3, undefined8 param_6) {
   undefined8 uVar1;
   undefined1 auVar2[16];
   undefined8 local_48;
   undefined8 uStack_40;
   auVar2._0_4_ = SQRT(*(float*)( param_2 + 5 ) * *(float*)( param_2 + 5 ) + *(float*)( param_2 + 4 ) * *(float*)( param_2 + 4 ) + 0.0 + *(float*)( (long)param_2 + 0x24 ) * *(float*)( (long)param_2 + 0x24 ));
   ...
   JPH::ManifoldBetweenTwoFaces(*param_2, param_2[1], param_2[2], param_2[3], local_48, uStack_40, *(undefined4*)( *(long*)( *(long*)( param_1 + 0x178 ) + 0x68 ) + 0x1c8 ), param_2 + 8, param_2 + 0x4a, param_3);
   if (*param_3 < 5) {
      return param_1_00;
   }

   uVar1 = JPH::PruneContactPoints(local_48, uStack_40, param_1_00, param_2_00, param_3, param_6, param_2_00);
   return uVar1;
}
/* JoltPhysicsDirectSpaceState3D::_collide_shape_queries(JPH::Shape const*, JPH::Vec3, JPH::Mat44
   ...
   JPH::ShapeFilter const&) const */void JoltPhysicsDirectSpaceState3D::_collide_shape_queries(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7, undefined8 param_8, undefined8 param_9, undefined8 param_10) {
   undefined8 uVar1;
   char cVar2;
   cVar2 = JoltProjectSettings::use_enhanced_internal_edge_removal_for_queries();
   if (cVar2 != '\0') {
      uVar1 = JoltSpace3D::get_narrow_phase_query();
      JPH::NarrowPhaseQuery::CollideShapeWithInternalEdgeRemoval(param_1, param_2, param_3, param_4, uVar1, param_6, param_7, param_8, param_9, param_10);
      return;
   }

   uVar1 = JoltSpace3D::get_narrow_phase_query();
   JPH::NarrowPhaseQuery::CollideShape(param_1, param_2, param_3, param_4, uVar1, param_6, param_7, param_8, param_9, param_10);
   return;
}
/* JoltPhysicsDirectSpaceState3D::_collide_shape_kinematics(JPH::Shape const*, JPH::Vec3, JPH::Mat44
   ...
   JPH::CollisionCollector<JPH::CollideShapeResult, JPH::CollisionCollectorTraitsCollideShape>&,
   JPH::BroadPhaseLayerFilter const&, JPH::ObjectLayerFilter const&, JPH::BodyFilter const&,
   JPH::ShapeFilter const&) const */void JoltPhysicsDirectSpaceState3D::_collide_shape_kinematics(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7, undefined8 param_8, undefined8 param_9, undefined8 param_10) {
   undefined8 uVar1;
   char cVar2;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JoltPhysicsDirectSpaceState3D::_body_motion_collide(JoltBody3D const&, Transform3D const&,
   ...
   PhysicsServer3D::MotionResult*) const [clone .part.0] */ulong JoltPhysicsDirectSpaceState3D::_body_motion_collide(JoltBody3D *param_1, Transform3D *param_2, Vector3 *param_3, float param_4, int param_5, HashSet *param_6, HashSet *param_7, MotionResult *param_8) {
   long lVar1;
 ...
 while ( puVar19 + -0x1000 != local_9030 );
   ...
   *(undefined8*)( puVar19 + 0x7fc0 ) = _UNK_0010f1c8;
   uVar27 = SUB164(*(undefined1(*) [16])( puVar19 + -0x1978 ), 0xc);
   *(undefined1**)( puVar19 + -0x1a30 ) = puVar19 + -0x14d8;
   *(undefined***)( puVar19 + -0x10c8 ) = &PTR__JoltQueryCollectorClosestMulti_0010ee10;
   ...
   *(undefined4*)( puVar19 + -0x149c ) = 0x3f800000;
   for (int i = 0; i < 3; i++) {
      *(undefined1**)( puVar19 + ( -8*i + -6840 ) ) = puVar19 + ( -8*i + -6656 );
   }

   *(undefined8*)( puVar19 + -0x1ad0 ) = 0x100e90;
   _collide_shape_kinematics(0x3f8000003f800000, *(undefined8*)( puVar19 + -0x1a58 ), plVar6, puVar19 + -0x14d8, puVar19 + -0x1968, puVar19 + -0x10c8, this);
         ...
         do {
            ...
            *(float*)( puVar19 + -0x1a98 ) = *(float*)( puVar19 + -0x1a20 ) + fVar2;
            if (0.0 < *(float*)( puVar19 + -0x1a20 ) + fVar2) {
               ...
               fVar2 = pfVar9[1];
               fVar3 = pfVar9[2];
               auVar26._0_4_ = SQRT(*(float*)( lVar1 + 0x28 ) * *(float*)( lVar1 + 0x28 ) + *(float*)( lVar1 + 0x20 ) * *(float*)( lVar1 + 0x20 ) + 0.0 + *(float*)( lVar1 + 0x24 ) * *(float*)( lVar1 + 0x24 ));
               ...
               *(float*)( puVar19 + -0x19b0 ) = fVar34;
               ...
               if (0.0 < fVar28) {
                  fVar28 = SQRT(fVar28);
                  if (__LC31 <= (double)( ( fVar4 / fVar28 ) * fVar31 + ( fVar2 / fVar28 ) * fVar33 + ( fVar3 / fVar28 ) * fVar34 )) goto LAB_00100f92;
               }
               ...
               *(undefined4*)( puVar19 + -0x14d8 ) = 0;
               if (*(int*)( puVar19 + -0x1a9c ) < 2) {
                  ...
                  *(undefined8*)( puVar19 + -0x1ab0 ) = 0x1012d6;
                  _generate_manifold(*(undefined8*)( puVar19 + -0x1a68 ), *(undefined8*)( puVar19 + -0x1a60 ), *(undefined8*)( puVar19 + -0x1a58 ), lVar1, puVar19 + -0x18e8, *(undefined8*)( puVar19 + -0x1a30 ));
               }

               *(BodyID**)( puVar19 + -0x1a48 ) = (BodyID*)( puVar19 + -0x1938 );
               *(undefined8*)( puVar19 + -0x1ab0 ) = 0x1010c8;
               JoltSpace3D::read_body((BodyID*)( puVar19 + -0x1938 ));
               if (( ( *(long*)( puVar19 + -0x18f8 ) == 0 ) || ( pSVar10 = *(SubShapeID**)( *(long*)( puVar19 + -0x18f8 ) + 0x50 ) ),pSVar10 == (SubShapeID*)0x0 )) {
                  pJVar17 = (JoltBodyAccessor3D*)(ulong)(byte)puVar19[-0x1a19];
                  puVar23 = *(undefined1**)( puVar19 + -0x1a28 );
                  *(undefined8*)( puVar19 + -0x1ab0 ) = 0x101365;
                  _err_print_error("_body_motion_collide", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x16c, "Parameter \"collider\" is null.", 0, 0);
               }
 else {
                  *(undefined8*)( puVar19 + -0x1ab0 ) = 0x101100;
                  ...
                  if (iVar12 == -1) {
                     ...
                     *(undefined8*)( puVar19 + -0x1ab0 ) = 0x1013d6;
                     _err_print_error("_body_motion_collide", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x16f, "Condition \"local_shape == -1\" is true. Returning: false", 0, 0);
                  }
 else {
                     *(undefined8*)( puVar19 + -0x1ab0 ) = 0x101117;
                     ...
                     if (iVar13 != -1) {
                        ...
                        if (( ulong ) * (uint*)( puVar19 + -0x14d8 ) != 0) {
                           ...
                           *(undefined8**)( puVar19 + -0x1a78 ) = puVar22 + ( ulong ) * (uint*)( puVar19 + -0x14d8 ) * 2;
                           *(undefined1**)( puVar19 + -0x1a88 ) = puVar19 + -0x19a8;
                           do {
                              uVar16 = uVar16 + 1;
                              uVar25 = *puVar22;
                              uVar11 = *(undefined8*)( puVar19 + -0x1a88 );
                              *(float*)( puVar19 + -0x19a0 ) = *(float*)( puVar19 + -0x1a80 ) + *(float*)( puVar22 + 1 );
                              uVar25 = CONCAT44((float)( (ulong)uVar25 >> 0x20 ) + (float)( ( ulong ) * (undefined8*)( puVar19 + -0x1a90 ) >> 0x20 ), (float)uVar25 + (float)*(undefined8*)( puVar19 + -0x1a90 ));
 ...
 while ( *(undefined8**)( puVar19 + -0x1a78 ) != puVar22 );
                        ...
                        puVar23 = *(undefined1**)( puVar19 + -0x1a28 );
                        LAB_00101265:pJVar17 = *(JoltBodyAccessor3D**)( puVar19 + -0x1a48 );
                     ...
                     *(undefined8*)( puVar19 + -0x1ab0 ) = 0x10140d;
                     _err_print_error("_body_motion_collide", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x172, "Condition \"collider_shape == -1\" is true. Returning: false", 0, 0);
                  }
            ...
            LAB_00100f92:*(int*)( puVar19 + -0x1a94 ) = *(int*)( puVar19 + -0x1a94 ) + 1;
 ...
 while ( *(int*)( puVar19 + -0x1a94 ) < (int)lVar14 );
      ...
      LAB_00101296:*(int*)( *(long*)( puVar19 + -0x1a38 ) + 0xa28 ) = (int)uVar20;
   }
 else {
      lVar21 = *(long*)( puVar19 + 0x7fd0 );
   ...
   LAB_00100ebe:*(undefined***)( puVar19 + -0x10c8 ) = &PTR__JoltQueryCollectorClosestMulti_0010ee10;
   if (lVar21 != 0) {
...
/* JoltPhysicsDirectSpaceState3D::_body_motion_collide(JoltBody3D const&, Transform3D const&,
   Vector3 const&, float, int, HashSet<RID, HashMapHasherDefault, HashMapComparatorDefault<RID> >
   const&, HashSet<ObjectID, HashMapHasherDefault, HashMapComparatorDefault<ObjectID> > const&,
   PhysicsServer3D::MotionResult*) const */undefined8 JoltPhysicsDirectSpaceState3D::_body_motion_collide(JoltBody3D *param_1, Transform3D *param_2, Vector3 *param_3, float param_4, int param_5, HashSet *param_6, HashSet *param_7, MotionResult *param_8) {
   undefined8 uVar1;
   if ((int)param_6 != 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JoltPhysicsDirectSpaceState3D::_body_motion_recover(JoltBody3D const&, Transform3D const&, float,
   HashSet<RID, HashMapHasherDefault, HashMapComparatorDefault<RID> > const&, HashSet<ObjectID,
   HashMapHasherDefault, HashMapComparatorDefault<ObjectID> > const&, Vector3&) const */undefined4 JoltPhysicsDirectSpaceState3D::_body_motion_recover(JoltPhysicsDirectSpaceState3D *this, JoltBody3D *param_1, Transform3D *param_2, float param_3, HashSet *param_4, HashSet *param_5, Vector3 *param_6) {
   JoltBodyAccessor3D *this_00;
   undefined4 uVar1;
   undefined8 uVar2;
   long *plVar3;
 ...
 while ( puVar12 + -0x1000 != local_8030 );
   ...
   *(ulong*)( puVar12 + -0x1e10 ) = CONCAT44(*(undefined4*)( puVar12 + -0x1cec ), *(undefined4*)( puVar12 + -0x1cec ));
   ...
   *(undefined8*)( puVar12 + -0x1e80 ) = 0x1015d8;
   JoltMotionFilter3D::JoltMotionFilter3D((JoltMotionFilter3D*)( puVar12 + -0x1d78 ), param_1, param_4, param_5, true);
   *(undefined4*)( puVar12 + -0x1c60 ) = 0x7f7fffff;
   *(undefined8*)( puVar12 + -0x1c58 ) = 0;
   *(undefined***)( puVar12 + -0x1c68 ) = &PTR__JoltQueryCollectorAnyMulti_0010edd0;
   ...
   *(undefined8*)( puVar12 + 0x6fc0 ) = _UNK_0010f1a8;
   if (iVar8 < 1) {
      uVar17 = 0;
   }
 else {
      ...
      *(undefined1(*) [16])( puVar12 + -0x1df8 ) = auVar27;
      ...
      do {
         ...
         *(undefined8*)( puVar12 + -0x1ea0 ) = 0x10183f;
         _collide_shape_kinematics(0x3f8000003f800000, 0x3f8000003f800000, this, *(undefined8*)( puVar12 + -0x1d98 ), this_00, *(undefined8*)( puVar12 + -0x1db0 ), *(undefined8*)( puVar12 + -0x1da8 ), *(undefined8*)( puVar12 + -0x1dc8 ));
         ...
         *(undefined4*)( puVar12 + -0x1e58 ) = uVar1;
         do {
            *(undefined8*)( puVar12 + -0x1e80 ) = 0x1018ec;
            ...
            if (( ( *(long*)( puVar12 + -0x1c78 ) == 0 ) || ( lVar5 = *(long*)( *(long*)( puVar12 + -0x1c78 ) + 0x50 ) ),lVar5 == 0 )) {
               *(undefined8*)( puVar12 + -0x1e80 ) = 0x101929;
               _err_print_error("_body_motion_recover", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0xd3, "Condition \"other_body == nullptr\" is true. Continuing.", 0, 0);
            }
 else {
         ...
         *(undefined4*)( puVar12 + -0x1e40 ) = 0;
         do {
            while (true) {
               ...
               auVar20._0_4_ = SQRT(pfVar11[10] * pfVar11[10] + pfVar11[8] * pfVar11[8] + 0.0 + pfVar11[9] * pfVar11[9]);
               ...
               *(undefined1(*) [16])( puVar12 + -0x1e38 ) = auVar22;
               fVar19 = ( ( fVar19 + *(float*)( puVar12 + -0x1e1c ) + fVar18 * fVar21 + *(float*)( puVar12 + -0x1e40 ) ) * fVar21 + ( pfVar11[1] + *(float*)( puVar12 + -0x1e20 ) + fVar18 * fVar23 + *(float*)( puVar12 + -0x1e44 ) ) * fVar23 + ( pfVar11[2] + *(float*)( puVar12 + -0x1e28 ) + fVar18 * fVar24 + *(float*)( puVar12 + -0x1e58 ) ) * fVar24 ) - ( ( *(float*)( puVar12 + -0x1e1c ) + fVar25 ) * fVar21 + fVar23 * ( pfVar11[5] + *(float*)( puVar12 + -0x1e20 ) ) + fVar24 * ( pfVar11[6] + *(float*)( puVar12 + -0x1e28 ) ) );
               *(float*)( puVar12 + -0x1e3c ) = fVar19;
               if (fVar19 <= 0.0) break;
               *(float*)( puVar12 + -0x1e24 ) = fVar18;
               *(undefined8*)( puVar12 + -0x1e80 ) = 0x101b7f;
               JoltSpace3D::read_body((BodyID*)this_00);
               if (( *(long*)( puVar12 + -0x1c78 ) != 0 ) && ( lVar5 = lVar5 != 0 )) {
                  fVar18 = *(float*)( puVar12 + -0x1e3c );
                  if (*(char*)( lVar5 + 0x3c ) == '\x01') {
                     *(undefined4*)( puVar12 + -0x1e3c ) = *(undefined4*)( puVar12 + -0x1e24 );
                     fVar18 = fVar18 * *(float*)( puVar12 + -0x1e04 ) * ( *(float*)( lVar5 + 500 ) / *(float*)( puVar12 + -0x1e08 ) );
                     *(ulong*)( puVar12 + -0x1e60 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( puVar12 + -0x1e60 ) >> 0x20 ) - fVar18 * *(float*)( puVar12 + -0x1e34 ), (float)*(undefined8*)( puVar12 + -0x1e60 ) - fVar18 * *(float*)( puVar12 + -0x1e38 ));
                     *(float*)( puVar12 + -0x1e78 ) = *(float*)( puVar12 + -0x1e78 ) - *(float*)( puVar12 + -0x1e38 ) * fVar18;
                     *(float*)( puVar12 + -0x1e74 ) = *(float*)( puVar12 + -0x1e74 ) - *(float*)( puVar12 + -0x1e34 ) * fVar18;
                     *(float*)( puVar12 + -0x1e70 ) = *(float*)( puVar12 + -0x1e70 ) - *(float*)( puVar12 + -0x1e30 ) * fVar18;
                     *(float*)( puVar12 + -0x1e6c ) = *(float*)( puVar12 + -0x1e6c ) - *(float*)( puVar12 + -0x1e30 ) * fVar18;
               ...
               *(undefined8*)( puVar12 + -0x1e80 ) = 0x101bde;
               _err_print_error("_body_motion_recover", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0xf2, "Condition \"other_body == nullptr\" is true. Continuing.", 0, 0);
...
;
 ...
 while ( lVar16 - lVar15 != 0 );
         LAB_00101c05:uVar14 = (uint)CONCAT71(0x1073, !NAN(*(float *)(puVar12 + -0x1e40)));
         ...
         *(int*)( puVar12 + -0x1d90 ) = *(int*)( puVar12 + -0x1d90 ) + 1;
         ...
         for (int i = 0; i < 4; i++) {
            *(float*)( puVar12 + ( 4*i + -7704 ) ) = *(float*)( puVar12 + ( 4*i + -7800 ) ) + *(float*)( puVar12 + ( 4*i + -7704 ) );
         }

         *(float*)( puVar6 + 1 ) = *(float*)( puVar12 + -0x1e58 ) + fVar19;
         *(ulong*)( puVar12 + -0x1e00 ) = CONCAT44((float)( (ulong)uVar10 >> 0x20 ) + fVar21, (float)uVar10 + fVar25);
         *puVar6 = CONCAT44((float)( (ulong)uVar2 >> 0x20 ) + fVar21, (float)uVar2 + fVar25);
      }
 while ( *(int*)( puVar12 + -0x1d8c ) != *(int*)( puVar12 + -0x1d90 ) );
      lVar16 = *(long*)( puVar12 + -0x1d80 );
      lVar15 = *(long*)( puVar12 + 0x6fd0 );
      LAB_00101cc9:*(undefined***)( puVar12 + -0x1c68 ) = &PTR__JoltQueryCollectorAnyMulti_0010edd0;
...
/* JoltPhysicsDirectSpaceState3D::JoltPhysicsDirectSpaceState3D(JoltSpace3D*) */void JoltPhysicsDirectSpaceState3D::JoltPhysicsDirectSpaceState3D(JoltPhysicsDirectSpaceState3D *this, JoltSpace3D *param_1) {
...
/* JoltPhysicsDirectSpaceState3D::_cast_motion_impl(JPH::Shape const&, Transform3D const&, Vector3
   ...
   float) const */_func__cast_motion_impl_Shape_const_ptr_Transform3D_const_ptr_Vector3_const_ptr_Vector3_const_ptr_bool_bool_CollideShapeSettings_const_ptr_BroadPhaseLayerFilter_const_ptr_ObjectLayerFilter_const_ptr_BodyFilter_const_ptr_ShapeFilter_const_ptr_float_ptr_float_ptr * __thiscallconst::{lambda(JPH::Body_const&,float)#1}::operator()
      ...
      float fVar21;
      undefined1 *puVar22;
      _func__cast_motion_impl_Shape_const_ptr_Transform3D_const_ptr_Vector3_const_ptr_Vector3_const_ptr_bool_bool_CollideShapeSettings_const_ptr_BroadPhaseLayerFilter_const_ptr_ObjectLayerFilter_const_ptr_BodyFilter_const_ptr_ShapeFilter_const_ptr_float_ptr_float_ptr *p_Var23;
      undefined1 *puVar24;
      long lVar25;
      long in_FS_OFFSET;
 ...
 while ( puVar24 + -0x1000 != local_9010 );
      ...
      *(undefined***)( puVar24 + -0x1908 ) = &PTR__JoltQueryCollectorAny_0010ed90;
      ...
      *(undefined4*)( puVar24 + -0x1900 ) = _LC0;
      if (*pcVar15 == '\0') {
         ...
         *(undefined8*)( puVar24 + -0x1990 ) = 0x10202d;
         JPH::TransformedShape::CollideShape(uVar3, uVar5, uVar2, uVar4, puVar24 + -0x1948, lVar25, uVar12, puVar11, puVar24 + -0x1908, uVar10);
      }
 else {
         uVar2 = *puVar11;
         uVar3 = puVar11[1];
         ...
         *(undefined***)( puVar24 + -0x1478 ) = &PTR__InternalEdgeRemovingCollector_0010ed10;
         ...
         *(undefined8*)( puVar24 + -0x1990 ) = 0x101f41;
         JPH::TransformedShape::CollideShape(uVar5, uVar4, uVar2, uVar3, puVar24 + -0x1948, lVar25, uVar12, puVar24 + -0x1978, (InternalEdgeRemovingCollector*)( puVar24 + -0x1478 ), uVar10);
         *(undefined8*)( puVar24 + -0x1990 ) = 0x101f49;
         JPH::InternalEdgeRemovingCollector::Flush((InternalEdgeRemovingCollector*)( puVar24 + -0x1478 ));
         *(undefined***)( puVar24 + -0x1478 ) = &PTR__InternalEdgeRemovingCollector_0010ed10;
         if (( *(long*)( puVar24 + 0x7fe0 ) != 0 ) && ( *(undefined8*)( puVar24 + 0x7fd0 ) = 0 ),0x87a0 < ( ulong )(*(long*)( puVar24 + 0x7fe0 ) - (long)( puVar24 + -0xc38 ))) {
            *(undefined8*)( puVar24 + -0x1990 ) = 0x10204e;
            ( *JPH::Free )();
         }

         if (( *(long*)( puVar24 + -0xc40 ) != 0 ) && ( *(undefined8*)( puVar24 + -0xc50 ) = 0 ),0x7f0 < ( ulong )(*(long*)( puVar24 + -0xc40 ) - (long)( puVar24 + -0x1458 ))) {
      ...
      p_Var23 = (_func__cast_motion_impl_Shape_const_ptr_Transform3D_const_ptr_Vector3_const_ptr_Vector3_const_ptr_bool_bool_CollideShapeSettings_const_ptr_BroadPhaseLayerFilter_const_ptr_ObjectLayerFilter_const_ptr_BodyFilter_const_ptr_ShapeFilter_const_ptr_float_ptr_float_ptr*)(ulong)bVar6;
      if (plVar16 != (long*)0x0) {
         LOCK();
         plVar1 = plVar16 + 1;
         *(int*)plVar1 = (int)*plVar1 + -1;
         ...
         if ((int)*plVar1 == 0) {
            ...
            *(undefined8*)( puVar24 + -0x1990 ) = 0x10203a;
            ( *pcVar17 )();
            p_Var23 = (_func__cast_motion_impl_Shape_const_ptr_Transform3D_const_ptr_Vector3_const_ptr_Vector3_const_ptr_bool_bool_CollideShapeSettings_const_ptr_BroadPhaseLayerFilter_const_ptr_ObjectLayerFilter_const_ptr_BodyFilter_const_ptr_ShapeFilter_const_ptr_float_ptr_float_ptr*)(ulong)(byte)puVar24[-0x1979];
         }
...
, /* WARNING: Globals starting with '_' overlap smaller symbols at the same address */, /* JoltPhysicsDirectSpaceState3D::_cast_motion_impl(JPH::Shape const&, Transform3D const&, Vector3
   const&, Vector3 const&, bool, bool, JPH::CollideShapeSettings const&, JPH::BroadPhaseLayerFilter
   const&, JPH::ObjectLayerFilter const&, JPH::BodyFilter const&, JPH::ShapeFilter const&, float&,
   float&) const */, byte __thiscall
JoltPhysicsDirectSpaceState3D::_cast_motion_impl
          (JoltPhysicsDirectSpaceState3D *this, Shape * param_1, Transform3D * param_2, Vector3 * param_3, Vector3 * param_4, bool, param_5, bool, param_6, CollideShapeSettings * param_7, BroadPhaseLayerFilter * param_8, ObjectLayerFilter * param_9, BodyFilter * param_10, ShapeFilter * param_11, float, *param_12, float, *param_13){
  Shape SVar1;
  undefined1 auVar2[16] ;int iVar3float fVar4float fVar5char cVar6long *plVar7_func__cast_motion_impl_Shape_const_ptr_Transform3D_const_ptr_Vector3_const_ptr_Vector3_const_ptr_bool_bool_CollideShapeSettings_const_ptr_BroadPhaseLayerFilter_const_ptr_ObjectLayerFilter_const_ptr_BodyFilter_const_ptr_ShapeFilter_const_ptr_float_ptr_float_ptr *p_Var8byte bVar9int iVar10long lVar11ulong uVar12long in_FS_OFFSETfloat fVar13float fVar14float fVar15undefined1 auVar16[16]float fVar17float fVar18undefined1 local_224c[16]undefined4 local_223ccode **local_2238float *pfStack_2230undefined1 *local_2228CollideShapeSettings *local_2220undefined4 *local_2218undefined1 *local_2210undefined8 *local_2208ShapeFilter *local_2200undefined4 local_21f8undefined4 uStack_21f4undefined4 uStack_21f0undefined4 uStack_21ecfloat local_21e8float fStack_21e4float fStack_21e0float fStack_21dcundefined8 local_21d8undefined8 uStack_21d0undefined1 local_21c8[8]float fStack_21c0float fStack_21bcundefined1 local_21b8[8]float fStack_21b0float fStack_21acundefined1 local_21a8[16]undefined1 local_2198[16]undefined1 local_2188[16]undefined8 local_2178undefined4 uStack_2170undefined4 uStack_216ccode *local_2168[8]Body *local_2128undefined **local_2118undefined4 local_2110undefined8 local_2108undefined1 local_2100[4096]undefined8 local_1100long lStack_10f8undefined8 local_10f0undefined1 *local_10e8undefined4 local_10e0code *local_10d8undefined4 local_10d0undefined8 local_10c8undefined2 local_10c0long *local_10b8float local_10b0undefined1 local_68[16]Shape *local_58long local_40local_40 = *(long*)( in_FS_OFFSET + 0x28 );SVar1 = param_1[0x18];*param_12 = 1.0;*param_13 = 1.0;local_224c[0] = param_5;if (SVar1 == (Shape)0x0) {
   ...
   if (fVar18 != 0.0 || !param_6) {
      ...
      local_21e8 = *(float*)param_2 * fVar13 + *(float*)( param_2 + 0xc ) * fVar15 + *(float*)( param_2 + 0x18 ) * fVar17;
      fStack_21e4 = *(float*)( param_2 + 4 ) * fVar13 + *(float*)( param_2 + 0x10 ) * fVar15 + *(float*)( param_2 + 0x1c ) * fVar17;
      fStack_21e0 = *(float*)( param_2 + 8 ) * fVar13 + *(float*)( param_2 + 0x14 ) * fVar15 + *(float*)( param_2 + 0x20 ) * fVar17;
      fStack_21dc = fVar13 * 0.0 + fVar15 * 0.0 + fVar17 * 0.0;
      uStack_21ec = uStack_21f0;
      ( **(code**)( *(long*)param_1 + 0x30 ) )(*(undefined8*)param_3, CONCAT44(uStack_21f0, uStack_21f0), local_21c8, param_1, local_21a8);
      ...
      local_2108 = 0;
      local_2118 = &PTR__JoltQueryCollectorAnyMulti_0010ed50;
      local_10e0 = 0x400;
         ...
         if (0 < (int)lVar11) {
            ...
            do {
               ...
               if (cVar6 != '\0') {
                  ...
                  if (cVar6 != '\0') {
                     p_Var8 = const::{lambda(JPH::Body_const & ::operator ()((_lambda_JPH__Body_const__float__1_*)&local_2238, local_2128, _LC20));
                     if (( (char)p_Var8 != '\0' ) && ( ( !param_6 || ( p_Var8 = const::{lambda(JPH::Body_const & ::operator ()((_lambda_JPH__Body_const__float__1_*)&local_2238, local_2128, 0.0), (char)p_Var8 == '\0') ) ) ) {
                        iVar10 = 0;
                        uVar12 = (ulong)bVar9;
                        fVar13 = _LC20;
                        fVar15 = _LC50;
                        ...
                        LAB_0010271c:do {
                           ...
                           p_Var8 = const::{lambda(JPH::Body_const & ::operator ()((_lambda_JPH__Body_const__float__1_*)&local_2238, local_2128, fVar14));
                           fVar15 = _LC50;
                           if ((char)p_Var8 == '\0') {
                              fVar17 = fVar14;
                              if (iVar10 == 0) {
                              ...
                              LAB_0010270c:bVar9 = (byte)uVar12;
                              fVar13 = fVar14;
                              fVar14 = fVar17;
                           }
 ...
 while ( (int)lVar11 < (int)lStack_10f8 );
      ...
      local_2118 = &PTR__JoltQueryCollectorAnyMulti_0010ed50;
      if (( local_10e8 != (undefined1*)0x0 ) && ( lStack_10f8 = 0 ),0xffc < ( ulong )((long)local_10e8 - (long)local_2100)) {
         ( *JPH::Free )();
      }
   ...
   _err_print_error("_cast_motion_impl", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x3e, "Condition \"p_jolt_shape.GetType() != JPH::EShapeType::Convex\" is true. Returning: false", "Shape-casting with non-convex shapes is not supported.", 0, 0);
}
bVar9 = 0;LAB_00102404:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return bVar9;}/* JoltPhysicsDirectSpaceState3D::_body_motion_cast(JoltBody3D const&, Transform3D const&, Vector3
   const&, Vector3 const&, bool, HashSet<RID, HashMapHasherDefault, HashMapComparatorDefault<RID> >
   const&, HashSet<ObjectID, HashMapHasherDefault, HashMapComparatorDefault<ObjectID> > const&,
   float&, float&) const */byte JoltPhysicsDirectSpaceState3D::_body_motion_cast(JoltPhysicsDirectSpaceState3D *this, JoltBody3D *param_1, Transform3D *param_2, Vector3 *param_3, Vector3 *param_4, bool param_5, HashSet *param_6, HashSet *param_7, float *param_8, float *param_9) {
   Shape *pSVar1;
   float fVar2;
   long lVar3;
   char *pcVar4;
      ...
      do {
         ...
         if (cVar5 == '\0') {
            ...
            if (cVar5 != '\0') {
               ...
               if (cVar5 == '\0') {
                  local_1d0 = 0;
                  local_1c8 = "%s A scale of %v is not supported by Jolt Physics for this shape/body. The scale will instead be treated as %v.";
                  local_1c0 = 0x6f;
                  String::parse_latin1((StrRange*)&local_1d0);
                  vformat<char_const*,Vector3,Vector3>(local_150._0_8_, local_150._8_4_, local_144._0_8_, local_144._8_4_, &local_1c8, (StrRange*)&local_1d0, "body_test_motion was passed an invalid transform along with body \'%s\'. This results in invalid scaling for shape at index %d.");
                  _err_print_error("_body_motion_cast", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x126, &local_1c8, 0, 0);
                  pcVar4 = local_1c8;
               ...
               bVar7 = _cast_motion_impl(this, local_1d8, local_78, (Vector3*)local_150, param_4, bVar6, false, (CollideShapeSettings*)local_108, (BroadPhaseLayerFilter*)local_1b8, local_1b0, local_1a8, local_1a0, (float*)&local_1d0, (float*)&local_1c8);
...
/* JoltPhysicsDirectSpaceState3D::rest_info(PhysicsDirectSpaceState3D::ShapeParameters const&,
   PhysicsDirectSpaceState3D::ShapeRestInfo*) */char JoltPhysicsDirectSpaceState3D::rest_info(JoltPhysicsDirectSpaceState3D *this, ShapeParameters *param_1, ShapeRestInfo *param_2) {
   Shape *pSVar1;
   undefined **ppuVar2;
   SubShapeID SVar3;
   ulong uVar4;
   ...
   if (*(char*)( *(long*)( this + 0x178 ) + 0x89 ) == '\0') {
      ...
      if (( uVar4 != 0 ) && ( (uint)uVar4 < *(uint*)( JoltPhysicsServer3D::singleton + 0x2f4 ) )) {
         plVar14 = (long*)( ( ( uVar4 & 0xffffffff ) % ( ulong ) * (uint*)( JoltPhysicsServer3D::singleton + 0x2f0 ) ) * 0x10 + *(long*)( *(long*)( JoltPhysicsServer3D::singleton + 0x2e0 ) + ( ( uVar4 & 0xffffffff ) / ( ulong ) * (uint*)( JoltPhysicsServer3D::singleton + 0x2f0 ) ) * 8 ) );
         ...
         if (iVar13 == (int)( uVar4 >> 0x20 )) {
            if (*plVar14 != 0) {
               ...
               if (local_630 == (Shape*)0x0) {
                  cVar12 = '\0';
                  _err_print_error("rest_info", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x2ed, "Parameter \"jolt_shape\" is null.", 0, 0);
               }
 else {
                  ...
                  fVar15 = ( ( (float)local_598 * (float)local_5a8._0_4_ - (float)local_5a8._4_4_ * fStack_59c ) * (float)local_5b8._0_4_ - ( (float)local_598 * (float)local_5b8._4_4_ - fStack_59c * fStack_5b0 ) * fStack_5ac ) + ( (float)local_5b8._4_4_ * (float)local_5a8._4_4_ - (float)local_5a8._0_4_ * fStack_5b0 ) * fStack_5a0;
                  _local_5b8 = auVar17;
                  _local_5a8 = auVar18;
                  if (NAN(fVar15)) {
                     local_658 = _LC20;
                     ...
                     local_618 = "%s The basis of the transform was singular, which is not supported by Jolt Physics. This is likely caused by one or more axes having a scale of zero. The basis (and thus its scale) will be treated as identity.";
                     local_610 = 0xd1;
                     String::parse_latin1((StrRange*)&local_628);
                     vformat<char_const*>((String*)&local_618, (char*)&local_628);
                     _err_print_error("rest_info", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x2f0, (String*)&local_618, 0, 1);
                     pcVar11 = local_618;
                  ...
                  if (cVar12 == '\0') {
                     local_628 = (undefined**)0x0;
                     local_618 = "%s A scale of %v is not supported by Jolt Physics for this shape/body. The scale will instead be treated as %v.";
                     local_610 = 0x6f;
                     String::parse_latin1(local_648);
                     vformat<char_const*,Vector3,Vector3>(local_5c4._0_8_, local_5c4._8_4_, local_4d8._0_8_, local_4d8._8_4_, (JoltQueryFilter3D*)&local_618, local_648, "get_rest_info (maybe from ShapeCast3D?) was passed an invalid transform.");
                     _err_print_error("rest_info", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x2f4, (JoltQueryFilter3D*)&local_618, 0, 0);
                     pcVar11 = local_618;
                     if (local_618 != (char*)0x0) {
                        LOCK();
                        plVar14 = (long*)( local_618 + -0x10 );
                  ...
                  local_554 = _LC92;
                  local_534 = 0;
                  JoltQueryFilter3D::JoltQueryFilter3D((JoltQueryFilter3D*)&local_618, this, *(uint*)( param_1 + 0x70 ), (bool)param_1[0x74], (bool)param_1[0x75], (HashSet*)( param_1 + 0x48 ), false);
                  local_4d8._8_4_ = 0x7f7fffff;
                  local_484 = _LC48;
                  uStack_47c = _LC47;
                  local_4d8._0_8_ = &PTR__JoltQueryCollectorClosest_0010f068;
                  local_508._4_4_ = local_574;
                  local_508._0_4_ = local_580;
                  local_628 = &PTR__ShapeFilter_0010ece0;
                  ...
                  _collide_shape_queries(local_5c4._0_8_, CONCAT44(local_5c4._8_4_, local_5c4._8_4_), uStack_564, uStack_660, this, local_630, (BodyID*)local_528, local_558, (Vector3*)local_4d8, (JoltQueryFilter3D*)&local_618, &local_610, local_608, local_648);
                  cVar12 = local_58;
                  if (local_58 != '\0') {
                     JoltSpace3D::read_body((BodyID*)local_528);
                     if (( local_4e8 == 0 ) || ( pSVar5 = *(SubShapeID**)( local_4e8 + 0x50 ) ),pSVar5 == (SubShapeID*)0x0) {
                        _err_print_error("rest_info", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x309, "Parameter \"object\" is null.", 0, 0);
                        LAB_001035ad:cVar12 = '\0';
                     }
 else {
                        SVar3 = pSVar5[0x3c];
                        *(undefined4*)( param_2 + 0x28 ) = 0;
                        if (SVar3 != (SubShapeID)0x2) {
                           ...
                           if (iVar13 == -1) {
                              _err_print_error("rest_info", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x30f, "Condition \"shape_index == -1\" is true. Returning: false", 0, 0);
                              goto LAB_001035ad;
                           }
                        ...
                        local_5d0 = CONCAT44(local_4a4 + (float)( (ulong)uStack_564 >> 0x20 ), local_4a8 + (float)uStack_564);
                        ...
                        *(float*)( param_2 + 8 ) = local_5c8;
                        ...
                        auVar16._0_4_ = SQRT(fStack_490 * fStack_490 + local_498 * local_498 + 0.0 + fStack_494 * fStack_494);
      ...
      _err_print_error("rest_info", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x2ea, "Parameter \"shape\" is null.", 0, 0);
   }
 else {
      _err_print_error("rest_info", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x2e5, "Condition \"space->is_stepping()\" is true. Returning: false", "get_rest_info must not be called while the physics space is being stepped.", 0, 0);
   }

   cVar12 = '\0';
   LAB_00103110:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JoltPhysicsDirectSpaceState3D::intersect_shape(PhysicsDirectSpaceState3D::ShapeParameters const&,
   PhysicsDirectSpaceState3D::ShapeResult*, int) */undefined4 JoltPhysicsDirectSpaceState3D::intersect_shape(JoltPhysicsDirectSpaceState3D *this, ShapeParameters *param_1, ShapeResult *param_2, int param_3) {
   long *plVar1;
   Vector3 *pVVar2;
   BodyID *this_00;
      ...
      if (param_3 != 0) {
         *(undefined8*)( puVar22 + -0x1e00 ) = 0x1036b3;
         ...
         if (( uVar7 != 0 ) && ( (uint)uVar7 < *(uint*)( JoltPhysicsServer3D::singleton + 0x2f4 ) )) {
            plVar20 = (long*)( ( ( uVar7 & 0xffffffff ) % ( ulong ) * (uint*)( JoltPhysicsServer3D::singleton + 0x2f0 ) ) * 0x10 + *(long*)( *(long*)( JoltPhysicsServer3D::singleton + 0x2e0 ) + ( ( uVar7 & 0xffffffff ) / ( ulong ) * (uint*)( JoltPhysicsServer3D::singleton + 0x2f0 ) ) * 8 ) );
                  ...
                  *(undefined8*)( puVar22 + -0x1e00 ) = 0x103714;
                  ...
                  if (*(long*)( puVar22 + -0x1db0 ) == 0) {
                     *(undefined8*)( puVar22 + -0x1e00 ) = 0x103d87;
                     _err_print_error("intersect_shape", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x24c, "Parameter \"jolt_shape\" is null.", 0, 0);
                     ...
                     *(undefined8*)( puVar22 + -0x1d40 ) = uVar15;
                     fVar23 = ( ( *(float*)( puVar22 + -0x1d28 ) * *(float*)( puVar22 + -0x1d38 ) - *(float*)( puVar22 + -0x1d34 ) * *(float*)( puVar22 + -0x1d2c ) ) * *(float*)( puVar22 + -0x1d48 ) - ( *(float*)( puVar22 + -0x1d28 ) * *(float*)( puVar22 + -0x1d44 ) - *(float*)( puVar22 + -0x1d2c ) * *(float*)( puVar22 + -0x1d40 ) ) * *(float*)( puVar22 + -0x1d3c ) ) + ( *(float*)( puVar22 + -0x1d44 ) * *(float*)( puVar22 + -0x1d34 ) - *(float*)( puVar22 + -0x1d38 ) * *(float*)( puVar22 + -0x1d40 ) ) * *(float*)( puVar22 + -0x1d30 );
                     if (NAN(fVar23)) {
                        ...
                        *(char**)( puVar22 + -0x1d98 ) = "%s The basis of the transform was singular, which is not supported by Jolt Physics. This is likely caused by one or more axes having a scale of zero. The basis (and thus its scale) will be treated as identity.";
                        ...
                        *(undefined8*)( puVar22 + -0x1e00 ) = 0x103eec;
                        _err_print_error("intersect_shape", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x24f, (String*)( puVar22 + -0x1d98 ), 0, 1);
                     ...
                     *(undefined8*)( puVar22 + -0x1e00 ) = 0x103872;
                     ...
                     if (cVar17 == '\0') {
                        ...
                        *(undefined8*)( puVar22 + -0x1da8 ) = 0;
                        *(char**)( puVar22 + -0x1d98 ) = "%s A scale of %v is not supported by Jolt Physics for this shape/body. The scale will instead be treated as %v.";
                        *(undefined8*)( puVar22 + -0x1d90 ) = 0x6f;
                        *(undefined8*)( puVar22 + -0x1e00 ) = 0x103dc1;
                        String::parse_latin1(pSVar10);
                        *(undefined8*)( puVar22 + -0x1e00 ) = 0x103df7;
                        vformat<char_const*,Vector3,Vector3>(*(undefined8*)( puVar22 + -0x1d54 ), *(undefined4*)( puVar22 + -0x1d4c ), *(undefined8*)( puVar22 + -0x1c68 ), *(undefined4*)( puVar22 + -0x1c60 ), this_01, pSVar10, "intersect_shape was passed an invalid transform.");
                        *(undefined8*)( puVar22 + -0x1e00 ) = 0x103e18;
                        _err_print_error("intersect_shape", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x253, this_01, 0, 0);
                        if (*(long*)( puVar22 + -0x1d98 ) != 0) {
                           LOCK();
                           plVar20 = (long*)( *(long*)( puVar22 + -0x1d98 ) + -0x10 );
                           *plVar20 = *plVar20 + -1;
                     ...
                     *(undefined8*)( puVar22 + -0x1e10 ) = 0x10393f;
                     JoltQueryFilter3D::JoltQueryFilter3D(this_01, this, uVar6, (bool)SVar3, (bool)SVar4, (HashSet*)( param_1 + 0x48 ), (bool)puVar22[-0x1e08]);
                     *(int*)( puVar22 + 0x6fd8 ) = param_3;
                     *(undefined8*)( puVar22 + 0x6fb8 ) = __LC14;
                     *(undefined8*)( puVar22 + 0x6fc0 ) = _UNK_0010f1a8;
                     ...
                     auVar25._12_4_ = 0;
                     *(undefined***)( puVar22 + -0x1c68 ) = &PTR__JoltQueryCollectorAnyMulti_0010edd0;
                     ...
                     *(undefined***)( puVar22 + -0x1da8 ) = &PTR__ShapeFilter_0010ece0;
                     ...
                     *(ulong*)( puVar22 + -0x1de8 ) = CONCAT44(*(undefined4*)( puVar22 + -0x1d50 ), *(undefined4*)( puVar22 + -0x1d54 ));
                     *(ulong*)( puVar22 + -0x1de0 ) = CONCAT44(*(undefined4*)( puVar22 + -0x1d4c ), *(undefined4*)( puVar22 + -0x1d4c ));
                     ...
                     *(undefined8*)( puVar22 + -0x1e20 ) = 0x103af0;
                     _collide_shape_queries(*(undefined8*)( puVar22 + -0x1de8 ), *(undefined8*)( puVar22 + -0x1de0 ), *(undefined8*)( puVar22 + -0x1df8 ), *(undefined8*)( puVar22 + -0x1df0 ), this, *(undefined8*)( puVar22 + -0x1db0 ), this_00, puVar22 + -0x1ce8, *(undefined8*)( puVar22 + -0x1dc8 ), this_01);
                        ...
                        *(ShapeResult**)( puVar22 + -0x1de8 ) = param_2 + ( ( ulong )(iVar18 - 1) + 1 ) * 0x20;
                        do {
                           *(undefined8*)( puVar22 + -0x1e00 ) = 0x103b3c;
                           ...
                           if (( *(long*)( puVar22 + -0x1c78 ) == 0 ) || ( pSVar9 = *(SubShapeID**)( *(long*)( puVar22 + -0x1c78 ) + 0x50 ) ),pSVar9 == (SubShapeID*)0x0) {
                              *(undefined8*)( puVar22 + -0x1e00 ) = 0x103c65;
                              _err_print_error("intersect_shape", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x266, "Parameter \"object\" is null.", 0, 0);
                              LAB_00103c65:*(undefined8*)( puVar22 + -0x1e00 ) = 0x103c6d;
                              JoltBodyAccessor3D::release();
                              ...
                              *(undefined8*)( puVar22 + -0x1e00 ) = 0x103b78;
                              ...
                              if (iVar18 == -1) {
                                 *(undefined8*)( puVar22 + -0x1e00 ) = 0x103cb5;
                                 _err_print_error("intersect_shape", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x26e, "Condition \"shape_index == -1\" is true. Returning: 0", 0, 0);
                                 goto LAB_00103c65;
                              }
 ...
 while ( pSVar21 != *(ShapeResult**)( puVar22 + -0x1de8 ) );
         ...
         *(undefined8*)( puVar22 + -0x1e00 ) = 0x103d5d;
         _err_print_error("intersect_shape", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x249, "Parameter \"shape\" is null.", 0, 0);
      }
      ...
      *(undefined8*)( puVar22 + -0x1e10 ) = 0x103cef;
      _err_print_error("intersect_shape", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x240, "Condition \"space->is_stepping()\" is true. Returning: false", "intersect_shape must not be called while the physics space is being stepped.", 0);
   }

   *(undefined4*)( puVar22 + -0x1df8 ) = 0;
   LAB_00103676:if (*(long*)( puVar22 + 0x6ff0 ) == *(long*)( in_FS_OFFSET + 0x28 )) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JoltPhysicsDirectSpaceState3D::collide_shape(PhysicsDirectSpaceState3D::ShapeParameters const&,
   Vector3*, int, int&) */undefined1 JoltPhysicsDirectSpaceState3D::collide_shape(JoltPhysicsDirectSpaceState3D *this, ShapeParameters *param_1, Vector3 *param_2, int param_3, int *param_4) {
   long *plVar1;
   Vector3 *pVVar2;
   undefined4 uVar3;
   undefined4 uVar4;
      ...
      if (param_3 != 0) {
         *(undefined8*)( puVar33 + -0x1600 ) = 0x104050;
         ...
         if (( uVar19 != 0 ) && ( (uint)uVar19 < *(uint*)( JoltPhysicsServer3D::singleton + 0x2f4 ) )) {
            plVar30 = (long*)( ( ( uVar19 & 0xffffffff ) % ( ulong ) * (uint*)( JoltPhysicsServer3D::singleton + 0x2f0 ) ) * 0x10 + *(long*)( *(long*)( JoltPhysicsServer3D::singleton + 0x2e0 ) + ( ( uVar19 & 0xffffffff ) / ( ulong ) * (uint*)( JoltPhysicsServer3D::singleton + 0x2f0 ) ) * 8 ) );
                  ...
                  *(undefined8*)( puVar33 + -0x1600 ) = 0x1040b5;
                  ...
                  if (*(long*)( puVar33 + -0x1580 ) == 0) {
                     *(undefined8*)( puVar33 + -0x1600 ) = 0x10483f;
                     _err_print_error("collide_shape", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x2a8, "Parameter \"jolt_shape\" is null.", 0, 0);
                  }
 else {
                     ...
                     *(undefined8*)( puVar33 + -0x1500 ) = uVar25;
                     fVar39 = ( ( *(float*)( puVar33 + -0x1508 ) * *(float*)( puVar33 + -0x14f8 ) - *(float*)( puVar33 + -0x1504 ) * *(float*)( puVar33 + -0x14fc ) ) * *(float*)( puVar33 + -0x1518 ) - ( *(float*)( puVar33 + -0x14f8 ) * *(float*)( puVar33 + -0x1514 ) - *(float*)( puVar33 + -0x14fc ) * *(float*)( puVar33 + -0x1510 ) ) * *(float*)( puVar33 + -0x150c ) ) + ( *(float*)( puVar33 + -0x1514 ) * *(float*)( puVar33 + -0x1504 ) - *(float*)( puVar33 + -0x1510 ) * *(float*)( puVar33 + -0x1508 ) ) * *(float*)( puVar33 + -0x1500 );
                     if (NAN(fVar39)) {
                        ...
                        *(char**)( puVar33 + -0x1568 ) = "%s The basis of the transform was singular, which is not supported by Jolt Physics. This is likely caused by one or more axes having a scale of zero. The basis (and thus its scale) will be treated as identity.";
                        ...
                        *(undefined8*)( puVar33 + -0x1600 ) = 0x1049c7;
                        _err_print_error("collide_shape", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x2ab, (String*)( puVar33 + -0x1568 ), 0, 1);
                     ...
                     *(undefined8*)( puVar33 + -0x1600 ) = 0x104219;
                     ...
                     if (cVar27 == '\0') {
                        ...
                        *(undefined8*)( puVar33 + -0x1578 ) = 0;
                        *(char**)( puVar33 + -0x1568 ) = "%s A scale of %v is not supported by Jolt Physics for this shape/body. The scale will instead be treated as %v.";
                        *(undefined8*)( puVar33 + -0x1560 ) = 0x6f;
                        *(undefined8*)( puVar33 + -0x1600 ) = 0x10487b;
                        String::parse_latin1(pSVar21);
                        *(undefined8*)( puVar33 + -0x1600 ) = 0x1048b1;
                        vformat<char_const*,Vector3,Vector3>(*(undefined8*)( puVar33 + -0x1524 ), *(undefined4*)( puVar33 + -0x151c ), *(undefined8*)( puVar33 + -0xc68 ), *(undefined4*)( puVar33 + -0xc60 ), this_00, pSVar21, "collide_shape was passed an invalid transform.");
                        *(undefined8*)( puVar33 + -0x1600 ) = 0x1048d2;
                        _err_print_error("collide_shape", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x2af, this_00, 0, 0);
                        if (*(long*)( puVar33 + -0x1568 ) != 0) {
                           LOCK();
                           plVar30 = (long*)( *(long*)( puVar33 + -0x1568 ) + -0x10 );
                           *plVar30 = *plVar30 + -1;
                     ...
                     *(undefined8*)( puVar33 + -0x1610 ) = 0x1042e3;
                     JoltQueryFilter3D::JoltQueryFilter3D(this_00, this, uVar17, (bool)SVar15, (bool)SVar16, (HashSet*)( param_1 + 0x48 ), (bool)puVar33[-0x1608]);
                     ...
                     *(undefined8*)( puVar33 + 0x7fc0 ) = _UNK_0010f1a8;
                     *(undefined***)( puVar33 + -0xc68 ) = &PTR__JoltQueryCollectorAnyMulti_0010edd0;
                     ...
                     *(undefined***)( puVar33 + -0x1578 ) = &PTR__ShapeFilter_0010ece0;
                     ...
                     *(undefined8*)( puVar33 + -0x1620 ) = 0x1044cc;
                     _collide_shape_queries(*(undefined8*)( puVar33 + -0x15d8 ), *(undefined8*)( puVar33 + -0x15d0 ), *(undefined8*)( puVar33 + -0x15f8 ), *(undefined8*)( puVar33 + -0x15f0 ), this, *(undefined8*)( puVar33 + -0x1580 ), puVar33 + -0x1078, puVar33 + -0x14b8, *(undefined8*)( puVar33 + -0x15b8 ), this_00);
                           ...
                           *(undefined4*)( puVar33 + -0x15a4 ) = uVar3;
                           ...
                           do {
                              ...
                              *(undefined8*)( puVar33 + -0x1600 ) = 0x1045de;
                              _generate_manifold(*(undefined8*)( puVar33 + -0x15f8 ), *(undefined8*)( puVar33 + -0x15f0 ), *(undefined8*)( puVar33 + -0x15b0 ), lVar34, *(undefined8*)( puVar33 + -0x15b8 ), *(undefined8*)( puVar33 + -0x15c0 ));
 ...
 while ( iVar37 < *(int*)( puVar33 + 0x7fc0 ) );
                     ...
                     *(undefined***)( puVar33 + -0xc68 ) = &PTR__JoltQueryCollectorAnyMulti_0010edd0;
                     if (( *(long*)( puVar33 + 0x7fd0 ) != 0 ) && ( *(undefined8*)( puVar33 + 0x7fc0 ) = 0 ),0x87a0 < ( ulong )(*(long*)( puVar33 + 0x7fd0 ) - *(long*)( puVar33 + -0x1590 ))) {
         ...
         *(undefined8*)( puVar33 + -0x1600 ) = 0x104815;
         _err_print_error("collide_shape", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x2a5, "Parameter \"shape\" is null.", 0, 0);
      }
      ...
      *(undefined8*)( puVar33 + -0x1610 ) = 0x10479e;
      _err_print_error("collide_shape", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x29c, "Condition \"space->is_stepping()\" is true. Returning: false", "collide_shape must not be called while the physics space is being stepped.", 0);
   }

   uVar36 = 0;
   LAB_00104016:if (*(long*)( puVar33 + 0x7ff0 ) != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
...
/* JoltPhysicsDirectSpaceState3D::cast_motion(PhysicsDirectSpaceState3D::ShapeParameters const&,
   float&, float&, PhysicsDirectSpaceState3D::ShapeRestInfo*) */undefined1 JoltPhysicsDirectSpaceState3D::cast_motion(JoltPhysicsDirectSpaceState3D *this, ShapeParameters *param_1, float *param_2, float *param_3, ShapeRestInfo *param_4) {
   Shape *pSVar1;
   undefined **ppuVar2;
   int iVar3;
   ulong uVar4;
   ...
   if (*(char*)( *(long*)( this + 0x178 ) + 0x89 ) == '\0') {
      if (param_4 == (ShapeRestInfo*)0x0) {
         ...
         uVar4 = *(ulong*)param_1;
         if (( uVar4 != 0 ) && ( (uint)uVar4 < *(uint*)( JoltPhysicsServer3D::singleton + 0x2f4 ) )) {
            plVar13 = (long*)( ( ( uVar4 & 0xffffffff ) % ( ulong ) * (uint*)( JoltPhysicsServer3D::singleton + 0x2f0 ) ) * 0x10 + *(long*)( *(long*)( JoltPhysicsServer3D::singleton + 0x2e0 ) + ( ( uVar4 & 0xffffffff ) / ( ulong ) * (uint*)( JoltPhysicsServer3D::singleton + 0x2f0 ) ) * 8 ) );
            iVar3 = (int)plVar13[1];
            if (iVar3 == (int)( uVar4 >> 0x20 )) {
               if (*plVar13 != 0) {
                  JoltShape3D::try_build();
                  if (local_140 == (Shape*)0x0) {
                     _err_print_error("cast_motion", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x284, "Parameter \"jolt_shape\" is null.", 0, 0);
                     uVar14 = 0;
                  }
 else {
                     ...
                     fVar15 = ( (float)local_b8 * (float)local_c8._0_4_ - (float)local_c8._4_4_ * fStack_bc ) * (float)local_d8._0_4_;
                     ...
                     fVar16 = ( (float)local_c8._4_4_ * (float)local_d8._4_4_ - (float)local_c8._0_4_ * fStack_d0 ) * fStack_c0;
                     _local_d8 = auVar8;
                     _local_c8 = auVar7;
                     if (( fVar15 - fVar17 ) + fVar16 == 0.0) {
                        local_138 = (undefined**)0x0;
                        local_128 = "%s The basis of the transform was singular, which is not supported by Jolt Physics. This is likely caused by one or more axes having a scale of zero. The basis (and thus its scale) will be treated as identity.";
                        local_120 = 0xd1;
                        String::parse_latin1((StrRange*)&local_138);
                        vformat<char_const*>((String*)&local_128, (char*)&local_138);
                        _err_print_error("cast_motion", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x287, (String*)&local_128, 0, 1);
                        pcVar10 = local_128;
                     ...
                     if (cVar11 == '\0') {
                        local_138 = (undefined**)0x0;
                        local_128 = "%s A scale of %v is not supported by Jolt Physics for this shape/body. The scale will instead be treated as %v.";
                        local_120 = 0x6f;
                        String::parse_latin1(local_158);
                        vformat<char_const*,Vector3,Vector3>(local_e4, local_dc, CONCAT44(uStack_74, CONCAT22(uStack_76, local_78)), local_70, (JoltQueryFilter3D*)&local_128, local_158, "cast_motion (maybe from ShapeCast3D?) was passed an invalid transform.");
                        _err_print_error("cast_motion", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x28b, (JoltQueryFilter3D*)&local_128, 0, 0);
                        pcVar10 = local_128;
                        if (local_128 != (char*)0x0) {
                           LOCK();
                           plVar13 = (long*)( local_128 + -0x10 );
                     ...
                     local_54 = 0;
                     JoltQueryFilter3D::JoltQueryFilter3D((JoltQueryFilter3D*)&local_128, this, *(uint*)( param_1 + 0x70 ), (bool)param_1[0x74], (bool)param_1[0x75], (HashSet*)( param_1 + 0x48 ), false);
                     local_130 = 0xffffffff;
                     local_138 = &PTR__ShapeFilter_0010ece0;
                     bVar12 = (bool)JoltProjectSettings::use_enhanced_internal_edge_removal_for_queries();
                     uVar14 = 1;
                     _cast_motion_impl(this, local_140, (Transform3D*)local_a8, (Vector3*)&local_e4, (Vector3*)( param_1 + 0x38 ), bVar12, true, (CollideShapeSettings*)&local_78, (BroadPhaseLayerFilter*)&local_128, (ObjectLayerFilter*)&local_120, local_118, (ShapeFilter*)local_158, param_2, param_3);
                  }
         ...
         _err_print_error("cast_motion", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x281, "Parameter \"shape\" is null.", 0, 0);
      }
 else {
         _err_print_error("cast_motion", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x27c, "Condition \"r_info != nullptr\" is true. Returning: false", "Providing rest info as part of cast_motion is not supported when using Jolt Physics.", 0, 0);
      }

   }
 else {
      _err_print_error("cast_motion", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x27b, "Condition \"space->is_stepping()\" is true. Returning: false", "cast_motion must not be called while the physics space is being stepped.", 0, 0);
   }

   uVar14 = 0;
   LAB_00104ddd:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar14;
   }
...
/* JoltPhysicsDirectSpaceState3D::body_test_motion(JoltBody3D const&,
   PhysicsServer3D::MotionParameters const&, PhysicsServer3D::MotionResult*) const */undefined8 JoltPhysicsDirectSpaceState3D::body_test_motion(JoltPhysicsDirectSpaceState3D *this, JoltBody3D *param_1, MotionParameters *param_2, MotionResult *param_3) {
   HashSet *pHVar1;
   HashSet *pHVar2;
   long *plVar3;
   float fVar4;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (*(char*)( *(long*)( this + 0x178 ) + 0x89 ) != '\0') {
      _err_print_error("body_test_motion", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x370, "Condition \"space->is_stepping()\" is true. Returning: false", "body_test_motion (maybe from move_and_slide?) must not be called while the physics space is being stepped.", 0, 0);
      uVar15 = 0;
      goto LAB_001054ea;
   }
   ...
   fVar17 = ( ( local_88 * (float)local_98._0_4_ - fStack_8c * (float)local_98._4_4_ ) * (float)local_a8._0_4_ - ( local_88 * (float)local_a8._4_4_ - fStack_8c * fStack_a0 ) * fStack_9c ) + ( (float)local_98._4_4_ * (float)local_a8._4_4_ - (float)local_98._0_4_ * fStack_a0 ) * fStack_90;
   _local_a8 = auVar9;
   _local_98 = auVar10;
   if (NAN(fVar17)) {
      local_120 = _LC20;
      ...
      local_100 = 0;
      local_e8 = "body_test_motion (maybe from move_and_slide?) was passed an invalid transform along with body \'%s\'.";
      local_e0 = 99;
      String::parse_latin1((StrRange*)&local_100);
      vformat<String>(&local_f8, (StrRange*)&local_100, &local_108);
      local_f0 = 0;
      local_e8 = "%s The basis of the transform was singular, which is not supported by Jolt Physics. This is likely caused by one or more axes having a scale of zero. The basis (and thus its scale) will be treated as identity.";
      local_e0 = 0xd1;
      String::parse_latin1((StrRange*)&local_f0);
      vformat<String>(&local_e8, (StrRange*)&local_f0, &local_f8);
      _err_print_error("body_test_motion", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 0x376, &local_e8, 0, 1);
      pcVar12 = local_e8;
   ...
   local_d0 = 0;
   local_c8 = 0.0;
   cVar13 = _body_motion_recover(this, param_1, (Transform3D*)local_a8, local_13c, pHVar2, pHVar1, (Vector3*)&local_d0);
   fVar17 = local_c8;
   ...
   cVar14 = _body_motion_cast(this, param_1, (Transform3D*)local_a8, (Vector3*)&local_b4, (Vector3*)( param_2 + 0x30 ), (bool)param_2[0x44], pHVar2, pHVar1, local_128, (float*)local_138);
   if (( cVar14 == '\0' ) && ( ( cVar13 == '\0' || ( param_2[0x98] == (MotionParameters)0x0 ) ) )) {
      LAB_00105518:if (param_3 != (MotionResult*)0x0) goto LAB_0010551d;
   }
 else {
      fVar6 = local_e8._0_4_;
      local_b8 = *(float*)( param_2 + 0x38 ) * local_e8._0_4_;
      local_c0 = CONCAT44((float)( ( ulong ) * (undefined8*)( param_2 + 0x30 ) >> 0x20 ) * local_e8._0_4_, (float)*(undefined8*)( param_2 + 0x30 ) * local_e8._0_4_);
      ...
      uVar15 = _body_motion_collide((JoltBody3D*)this, (Transform3D*)param_1, local_78, local_13c, (int)(Vector3*)( param_2 + 0x30 ), pHVar16, pHVar2, (MotionResult*)pHVar1);
      ...
      if ((char)uVar15 != '\0') {
         ...
         *(ulong*)( param_3 + 0x10 ) = CONCAT44(fVar18 - (float)local_f0 * fVar18, fVar17 - (float)local_f0 * fVar17);
         *(ulong*)( param_3 + 0x18 ) = CONCAT44((float)local_f0, *(undefined4*)( param_3 + 0x58 ));
         goto LAB_001054ea;
      }

      LAB_0010551d:uVar7 = _LC96;
   ...
   uVar15 = 0;
   LAB_001054ea:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar15;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JoltPhysicsDirectSpaceState3D::get_closest_point_to_object_volume(RID, Vector3) const */undefined1[16];JoltPhysicsDirectSpaceState3D::get_closest_point_to_object_volume(undefined8 param_1, float param_2, long param_3, ulong param_4) {
   long *plVar1;
   int iVar2;
   bool bVar3;
   long lVar4;
   ...
   if (*(char*)( *(long*)( param_3 + 0x178 ) + 0x89 ) != '\0') {
      _err_print_error("get_closest_point_to_object_volume", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", 799, "Condition \"space->is_stepping()\" is true. Returning: Vector3()", "get_closest_point_to_object_volume must not be called while the physics space is being stepped.", 0, 0);
   ...
   if (param_4 == 0) {
      LAB_001060a0:uVar11 = 0x32a;
      pcVar8 = "Parameter \"object\" is null.";
   }
 else {
      iVar6 = (int)( param_4 >> 0x20 );
      if (*(uint*)( JoltPhysicsServer3D::singleton + 0x1ec ) <= (uint)param_4) {
         LAB_00106053:if ((uint)param_4 < *(uint*)( lVar4 + 0x244 )) {
            plVar9 = (long*)( ( ( param_4 & 0xffffffff ) % ( ulong ) * (uint*)( lVar4 + 0x240 ) ) * 0x10 + *(long*)( *(long*)( lVar4 + 0x230 ) + ( ( param_4 & 0xffffffff ) / ( ulong ) * (uint*)( lVar4 + 0x240 ) ) * 8 ) );
            iVar2 = (int)plVar9[1];
            if (iVar2 == iVar6) {
               lVar10 = *plVar9;
      ...
      plVar9 = (long*)( ( ( param_4 & 0xffffffff ) % ( ulong ) * (uint*)( JoltPhysicsServer3D::singleton + 0x1e8 ) ) * 0x10 + *(long*)( *(long*)( JoltPhysicsServer3D::singleton + 0x1d8 ) + ( ( param_4 & 0xffffffff ) / ( ulong ) * (uint*)( JoltPhysicsServer3D::singleton + 0x1e8 ) ) * 8 ) );
      iVar2 = (int)plVar9[1];
      if (iVar2 != iVar6) {
      ...
      LAB_001058d3:if (*(long*)( param_3 + 0x178 ) == *(long*)( lVar10 + 0x28 )) {
         ...
         local_1a80 = _LC46;
         local_1a70 = _LC47;
         local_18c8 = &PTR__JoltQueryCollectorAll_0010f0a8;
         local_10a8 = __LC14;
         lStack_10a0 = _UNK_0010f1a8;
         local_18c0 = 0x7f7fffff;
         local_18b8 = 0;
         local_1098 = 0x20;
         local_1090 = local_18a8;
         JPH::TransformedShape::CollectTransformedShapes((AABox*)&local_1aa8, (CollisionCollector*)( local_19a8 + 0x20 ), (ShapeFilter*)&local_18c8);
         local_1b08 = (float)param_1;
         fStack_1b04 = (float)( (ulong)param_1 >> 0x20 );
         if ((int)lStack_10a0 < 1) {
            LAB_00106010:auVar33 = JPH::Body::GetPosition(local_19a8);
         }
 else {
            lVar14 = 0;
            ...
            do {
               while (true) {
                  ...
                  local_18d8 = 0;
                  pSVar5 = (Support*)( **(code**)( *plVar9 + 0x130 ) )(*(undefined8*)( pfVar7 + 10 ), *(undefined8*)( pfVar7 + 0xc ), plVar9, 1, local_1088);
                  ...
                  fVar15 = ( *pfVar7 - ( (float)local_1bb8 * fVar30 + local_1bb8._4_4_ * fVar18 + fVar16 * fVar29 ) ) + __LC104;
                  fVar20 = ( pfVar7[1] - ( (float)local_1bb8 * fVar21 + local_1bb8._4_4_ * fVar28 + fVar16 * fVar26 ) ) + _UNK_0010f204;
                  local_1a38 = CONCAT44(fVar20, fVar15);
                  fVar17 = ( pfVar7[2] - ( (float)local_1bb8 * fVar22 + local_1bb8._4_4_ * fVar24 + fVar16 * fVar25 ) ) + (float)_LC96;
                  ...
                  fStack_1ae4 = fStack_1b04 * fVar28 + local_1b08 * fVar18 + param_2 * fVar24 + fStack_1ae4;
                  fStack_1ae0 = fStack_1b04 * fVar26 + local_1b08 * fVar29 + param_2 * fVar25 + fStack_19f0;
                  ...
                  fStack_1a30 = fVar17;
                  fVar16 = JPH::GJKClosestPoint::GetClosestPoints<JPH::ConvexShape::Support,JPH::PointConvexSupport>(local_1998, pSVar5, (PointConvexSupport*)&local_1ae8, (float)_LC92, _LC0, local_1ad8, local_1ac8, local_1ab8);
                  if (fVar16 == 0.0) goto LAB_00105ec3;
                  local_1bb8 = lVar10;
                  if (fVar16 < local_1b4c) {
                     bVar3 = true;
                     fVar19 = fStack_1ac0 * fVar25 + (float)local_1ac8._0_4_ * fVar22 + (float)local_1ac8._4_4_ * fVar24 + fVar17;
                     local_1bb8 = CONCAT44(fStack_1ac0 * fVar26 + (float)local_1ac8._0_4_ * fVar21 + (float)local_1ac8._4_4_ * fVar28 + fVar20, fStack_1ac0 * fVar29 + (float)local_1ac8._0_4_ * fVar30 + (float)local_1ac8._4_4_ * fVar18 + fVar15);
                     local_1b4c = fVar16;
                  }
...
;
 ...
 while ( (int)lVar14 < (int)lVar4 );
            LAB_00105e82:auVar33._8_4_ = fVar19;
            auVar33._0_8_ = lVar10;
            if (!bVar3) goto LAB_00106010;
         }

         LAB_00105ec3:local_18c8 = &PTR__JoltQueryCollectorAll_0010f0a8;
...
;
   ...
   _err_print_error("get_closest_point_to_object_volume", "modules/jolt_physics/spaces/jolt_physics_direct_space_state_3d.cpp", uVar11, pcVar8, 0, 0);
   local_1088[0] = ZEXT812(0);
   LAB_00105f4f:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* JoltPhysicsDirectSpaceState3D::is_class_ptr(void*) const */uint JoltPhysicsDirectSpaceState3D::is_class_ptr(JoltPhysicsDirectSpaceState3D *this, void *param_1) {
   return (uint)CONCAT71(0x10f1, (undefined4*)param_1 == &PhysicsDirectSpaceState3D::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10f0, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10f1, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* JoltPhysicsDirectSpaceState3D::_getv(StringName const&, Variant&) const */undefined8 JoltPhysicsDirectSpaceState3D::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* JoltPhysicsDirectSpaceState3D::_setv(StringName const&, Variant const&) */undefined8 JoltPhysicsDirectSpaceState3D::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* JoltPhysicsDirectSpaceState3D::_validate_propertyv(PropertyInfo&) const */void JoltPhysicsDirectSpaceState3D::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* JoltPhysicsDirectSpaceState3D::_property_can_revertv(StringName const&) const */undefined8 JoltPhysicsDirectSpaceState3D::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* JoltPhysicsDirectSpaceState3D::_property_get_revertv(StringName const&, Variant&) const */undefined8 JoltPhysicsDirectSpaceState3D::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* JoltPhysicsDirectSpaceState3D::_notificationv(int, bool) */void JoltPhysicsDirectSpaceState3D::_notificationv(int param_1, bool param_2) {
   return;
}
...
/* JoltQueryCollectorAny<JPH::CollisionCollector<JPH::CollideShapeResult,
   JPH::CollisionCollectorTraitsCollideShape> >::~JoltQueryCollectorAny() */void JoltQueryCollectorAny<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>>::~JoltQueryCollectorAny(JoltQueryCollectorAny<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>> *this) {
   return;
}
...
/* JoltQueryCollectorClosest<JPH::CollisionCollector<JPH::CollideShapeResult,
   JPH::CollisionCollectorTraitsCollideShape> >::~JoltQueryCollectorClosest() */void JoltQueryCollectorClosest<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>>::~JoltQueryCollectorClosest(JoltQueryCollectorClosest<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>> *this) {
   return;
}
/* JPH::CollisionCollector<JPH::CollideShapeResult,
...
/* JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollideShapeResult,
   JPH::CollisionCollectorTraitsCollideShape>, 32>::Reset() */void JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>,32>::Reset(JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>,32> *this) {
   *(undefined4*)( this + 8 ) = 0x7f7fffff;
...
/* JoltQueryCollectorClosest<JPH::CollisionCollector<JPH::CollideShapeResult,
   JPH::CollisionCollectorTraitsCollideShape> >::Reset() */void JoltQueryCollectorClosest<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>>::Reset(JoltQueryCollectorClosest<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>> *this) {
   *(undefined4*)( this + 8 ) = 0x7f7fffff;
   this[0x480] = (JoltQueryCollectorClosest<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>>)0x0;
   return;
}
/* JPH::CollisionCollector<JPH::CollideShapeResult,
...
/* JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollidePointResult,
   JPH::CollisionCollectorTraitsCollideShape>, 32>::Reset() */void JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollidePointResult,JPH::CollisionCollectorTraitsCollideShape>,32>::Reset(JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollidePointResult,JPH::CollisionCollectorTraitsCollideShape>,32> *this) {
   *(undefined4*)( this + 8 ) = 0x7f7fffff;
   *(undefined8*)( this + 0x120 ) = 0;
   return;
}
/* JPH::CollisionCollector<JPH::CollidePointResult,
   JPH::CollisionCollectorTraitsCollideShape>::OnBody(JPH::Body const&) */void JPH::CollisionCollector<JPH::CollidePointResult,JPH::CollisionCollectorTraitsCollideShape>::OnBody(Body *param_1) {
   return;
}
/* JPH::CollisionCollector<JPH::CollidePointResult,
   JPH::CollisionCollectorTraitsCollideShape>::SetUserData(unsigned long) */void JPH::CollisionCollector<JPH::CollidePointResult,JPH::CollisionCollectorTraitsCollideShape>::SetUserData(ulong param_1) {
   return;
}
/* JoltQueryCollectorClosest<JPH::CollisionCollector<JPH::RayCastResult,
...
/* JoltQueryCollectorClosestMulti<JPH::CollisionCollector<JPH::CollideShapeResult,
   JPH::CollisionCollectorTraitsCollideShape>, 32>::Reset() */void JoltQueryCollectorClosestMulti<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>,32>::Reset(JoltQueryCollectorClosestMulti<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>,32> *this) {
   *(undefined4*)( this + 8 ) = 0x7f7fffff;
   *(undefined8*)( this + 37000 ) = 0;
   return;
}
/* JoltQueryCollectorAny<JPH::CollisionCollector<JPH::CollideShapeResult,
   JPH::CollisionCollectorTraitsCollideShape> >::Reset() */void JoltQueryCollectorAny<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>>::Reset(JoltQueryCollectorAny<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>> *this) {
   *(undefined4*)( this + 8 ) = 0x7f7fffff;
   this[0x480] = (JoltQueryCollectorAny<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>>)0x0;
   return;
}
/* JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::BodyID,
   JPH::CollisionCollectorTraitsCollideShape>, 1024>::Reset() */void JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::BodyID,JPH::CollisionCollectorTraitsCollideShape>,1024>::Reset(JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::BodyID,JPH::CollisionCollectorTraitsCollideShape>,1024> *this) {
   *(undefined4*)( this + 8 ) = 0x7f7fffff;
...
/* JoltCustomMotionShape::GetSurfaceNormal(JPH::SubShapeID const&, JPH::Vec3) const */undefined1[16];JoltCustomMotionShape::GetSurfaceNormal(void) {
   _err_print_error("GetSurfaceNormal", "modules/jolt_physics/spaces/../shapes/jolt_custom_motion_shape.h", 0x46, "Method/function failed. Returning: JPH::Vec3::sZero()", "Not implemented.", 0, 0);
   return ZEXT816(0);
}
/* JPH::ShapeFilter::~ShapeFilter() */void JPH::ShapeFilter::~ShapeFilter(ShapeFilter *this) {
...
/* JoltPhysicsDirectSpaceState3D::~JoltPhysicsDirectSpaceState3D() */void JoltPhysicsDirectSpaceState3D::~JoltPhysicsDirectSpaceState3D(JoltPhysicsDirectSpaceState3D *this) {
   *(undefined***)this = &PTR__initialize_classv_0010eb48;
...
/* JoltQueryCollectorClosest<JPH::CollisionCollector<JPH::CollideShapeResult,
   JPH::CollisionCollectorTraitsCollideShape> >::AddHit(JPH::CollideShapeResult const&) */void JoltQueryCollectorClosest<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>>::AddHit(JoltQueryCollectorClosest<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>> *this, CollideShapeResult *param_1) {
   float fVar1;
   undefined4 uVar2;
   undefined4 uVar3;
   uint uVar4;
   ...
   if (( this[0x480] == (JoltQueryCollectorClosest<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>>)0x0 ) || ( *(float*)( this + 0x50 ) <= fVar1 && fVar1 != *(float*)( this + 0x50 ) )) {
      ...
      *(undefined4*)( this + 0x5c ) = *(undefined4*)( param_1 + 0x3c );
      ...
      if (( param_1 + 0x40 != (CollideShapeResult*)( this + 0x60 ) ) && ( *(undefined4*)( this + 0x60 ) = uVar4 != 0 )) {
         lVar6 = 0;
         do {
 ...
 while ( (ulong)uVar4 << 4 != lVar6 );
      ...
      if (( param_1 + 0x250 != (CollideShapeResult*)( this + 0x270 ) ) && ( *(undefined4*)( this + 0x270 ) = uVar4 != 0 )) {
         lVar6 = 0;
         do {
 ...
 while ( lVar6 != (ulong)uVar4 << 4 );
      ...
      this[0x480] = (JoltQueryCollectorClosest<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>>)0x1;
   }
...
/* PhysicsDirectSpaceState3D::_get_class_namev() const */undefined8 *PhysicsDirectSpaceState3D::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001068b3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001068b3;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "PhysicsDirectSpaceState3D");
   LAB_0010691e:return &_get_class_namev();
}
/* JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::BodyID,
   JPH::CollisionCollectorTraitsCollideShape>, 1024>::AddHit(JPH::BodyID const&) */void JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::BodyID,JPH::CollisionCollectorTraitsCollideShape>,1024>::AddHit(JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::BodyID,JPH::CollisionCollectorTraitsCollideShape>,1024> *this, BodyID *param_1) {
   JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::BodyID,JPH::CollisionCollectorTraitsCollideShape>,1024> *pJVar1;
   ulong uVar2;
   long lVar3;
   ulong uVar4;
   void *__dest;
   JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::BodyID,JPH::CollisionCollectorTraitsCollideShape>,1024> *pJVar5;
   JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::BodyID,JPH::CollisionCollectorTraitsCollideShape>,1024> *__src;
   int iVar6;
   ulong uVar7;
   ulong uVar8;
   ulong uVar9;
   ...
   if ((int)uVar9 < iVar6) {
      ...
      uVar4 = uVar9 + 1;
      __src = *(JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::BodyID,JPH::CollisionCollectorTraitsCollideShape>,1024>**)( this + 0x1030 );
      if (uVar2 < uVar4) {
         uVar7 = uVar2 * 2;
         if (uVar2 * 2 < uVar4) {
            uVar7 = uVar4;
         ...
         if (__src == (JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::BodyID,JPH::CollisionCollectorTraitsCollideShape>,1024>*)0x0) {
            ...
            if (uVar2 < 0x401) {
               *(ulong*)( this + 0x1018 ) = uVar2;
               ...
               __src = (JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::BodyID,JPH::CollisionCollectorTraitsCollideShape>,1024>*)( *JPH::Allocate )(uVar7 * 4);
               uVar9 = *(ulong*)( this + 0x1020 );
               uVar4 = uVar9 + 1;
            }
            ...
            if (( ulong )((long)__src - (long)pJVar1) < 0xffd) {
               if (( pJVar1 + ( *(long*)( this + 0x1018 ) - uVar2 ) * 4 == __src ) && ( uVar8 = uVar8 < 0x401 )) {
                  *(ulong*)( this + 0x1018 ) = uVar8;
               }
 else {
                  __dest = (void*)( *JPH::Allocate )(uVar7 * 4);
                  pJVar5 = (JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::BodyID,JPH::CollisionCollectorTraitsCollideShape>,1024>*)memcpy(__dest, __src, uVar2 * 4);
               ...
               __src = (JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::BodyID,JPH::CollisionCollectorTraitsCollideShape>,1024>*)( *JPH::Reallocate )(__src, uVar2 * 4, uVar7 * 4);
               uVar9 = *(ulong*)( this + 0x1020 );
               uVar4 = uVar9 + 1;
            }
         ...
         *(JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::BodyID,JPH::CollisionCollectorTraitsCollideShape>,1024>**)( this + 0x1030 ) = __src;
         *(ulong*)( this + 0x1028 ) = uVar7;
      }

      *(ulong*)( this + 0x1020 ) = uVar4;
      if (__src + uVar9 * 4 != (JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::BodyID,JPH::CollisionCollectorTraitsCollideShape>,1024>*)0x0) {
...
/* JoltQueryCollectorAny<JPH::CollisionCollector<JPH::CollideShapeResult,
   JPH::CollisionCollectorTraitsCollideShape> >::AddHit(JPH::CollideShapeResult const&) */void JoltQueryCollectorAny<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>>::AddHit(JoltQueryCollectorAny<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>> *this, CollideShapeResult *param_1) {
   undefined4 uVar1;
   undefined4 uVar2;
   uint uVar3;
   undefined8 uVar4;
   ...
   *(undefined4*)( this + 0x5c ) = *(undefined4*)( param_1 + 0x3c );
   ...
   if (( param_1 + 0x40 != (CollideShapeResult*)( this + 0x60 ) ) && ( *(undefined4*)( this + 0x60 ) = uVar3 != 0 )) {
      lVar5 = 0;
      do {
 ...
 while ( (ulong)uVar3 << 4 != lVar5 );
   ...
   if (( param_1 + 0x250 != (CollideShapeResult*)( this + 0x270 ) ) && ( *(undefined4*)( this + 0x270 ) = uVar3 != 0 )) {
      lVar5 = 0;
      do {
 ...
 while ( lVar5 != (ulong)uVar3 << 4 );
   ...
   this[0x480] = (JoltQueryCollectorAny<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>>)0x1;
   *(undefined4*)( this + 8 ) = 0xff7fffff;
   return;
}
/* JoltPhysicsDirectSpaceState3D::_get_class_namev() const */undefined8 *JoltPhysicsDirectSpaceState3D::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      ...
      if (*(long*)( _get_class_namev() ) != 0) {
         ...
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "JoltPhysicsDirectSpaceState3D");
         goto LAB_00106cce;
      }
...
/* JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::BodyID,
   JPH::CollisionCollectorTraitsCollideShape>, 1024>::~JoltQueryCollectorAnyMulti() */void JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::BodyID,JPH::CollisionCollectorTraitsCollideShape>,1024>::~JoltQueryCollectorAnyMulti(JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::BodyID,JPH::CollisionCollectorTraitsCollideShape>,1024> *this) {
   long lVar1;
   *(undefined***)this = &PTR__JoltQueryCollectorAnyMulti_0010ed50;
...
/* JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollideShapeResult,
   JPH::CollisionCollectorTraitsCollideShape>, 32>::~JoltQueryCollectorAnyMulti() */void JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>,32>::~JoltQueryCollectorAnyMulti(JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>,32> *this) {
   long lVar1;
   *(undefined***)this = &PTR__JoltQueryCollectorAnyMulti_0010edd0;
...
/* JoltQueryCollectorClosestMulti<JPH::CollisionCollector<JPH::CollideShapeResult,
   JPH::CollisionCollectorTraitsCollideShape>, 32>::~JoltQueryCollectorClosestMulti() */void JoltQueryCollectorClosestMulti<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>,32>::~JoltQueryCollectorClosestMulti(JoltQueryCollectorClosestMulti<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>,32> *this) {
   long lVar1;
   *(undefined***)this = &PTR__JoltQueryCollectorClosestMulti_0010ee10;
...
/* JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollidePointResult,
   JPH::CollisionCollectorTraitsCollideShape>, 32>::~JoltQueryCollectorAnyMulti() */void JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollidePointResult,JPH::CollisionCollectorTraitsCollideShape>,32>::~JoltQueryCollectorAnyMulti(JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollidePointResult,JPH::CollisionCollectorTraitsCollideShape>,32> *this) {
   long lVar1;
   *(undefined***)this = &PTR__JoltQueryCollectorAnyMulti_0010f028;
...
/* JPH::InternalEdgeRemovingCollector::~InternalEdgeRemovingCollector() */void JPH::InternalEdgeRemovingCollector::~InternalEdgeRemovingCollector(InternalEdgeRemovingCollector *this) {
   *(undefined***)this = &PTR__InternalEdgeRemovingCollector_0010ed10;
...
/* JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,
   JPH::CollisionCollectorTraitsCollideShape>, 32>::Reset() */void JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,JPH::CollisionCollectorTraitsCollideShape>,32>::Reset(JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,JPH::CollisionCollectorTraitsCollideShape>,32> *this) {
   long *plVar1;
   long *plVar2;
   ulong uVar3;
   ulong uVar4;
...
/* JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,
   JPH::CollisionCollectorTraitsCollideShape>, 32>::~JoltQueryCollectorAll() */void JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,JPH::CollisionCollectorTraitsCollideShape>,32>::~JoltQueryCollectorAll(JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,JPH::CollisionCollectorTraitsCollideShape>,32> *this) {
   long *plVar1;
   long *plVar2;
   ulong uVar3;
   ulong uVar4;
   uVar3 = *(ulong*)( this + 0x838 );
   *(undefined***)this = &PTR__JoltQueryCollectorAll_0010f0a8;
   if (uVar3 != 0) {
      if (( *(long*)( this + 0x828 ) != 0 ) && ( uVar4 = uVar3 < uVar4 )) {
         do {
            while (plVar2 = *(long**)( uVar3 + 0x20 ),plVar2 == (long*)0x0) {
               LAB_001071f0:uVar3 = uVar3 + 0x40;
...
;
 ...
 while ( uVar3 < uVar4 );
         LAB_00107220:uVar3 = *(ulong*)( this + 0x838 );
      }
...
;
 ...
 while ( uVar3 < uVar4 );
         LAB_001072d0:uVar3 = *(ulong*)( this + 0x838 );
      }
...
/* JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollidePointResult,
   JPH::CollisionCollectorTraitsCollideShape>, 32>::AddHit(JPH::CollidePointResult const&) */void JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollidePointResult,JPH::CollisionCollectorTraitsCollideShape>,32>::AddHit(JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollidePointResult,JPH::CollisionCollectorTraitsCollideShape>,32> *this, CollidePointResult *param_1) {
   JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollidePointResult,JPH::CollisionCollectorTraitsCollideShape>,32> *pJVar1;
   ulong uVar2;
   long lVar3;
   ulong uVar4;
   void *__dest;
   JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollidePointResult,JPH::CollisionCollectorTraitsCollideShape>,32> *pJVar5;
   JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollidePointResult,JPH::CollisionCollectorTraitsCollideShape>,32> *__src;
   int iVar6;
   ulong uVar7;
   ulong uVar8;
   ulong uVar9;
   ...
   if ((int)uVar9 < iVar6) {
      ...
      uVar4 = uVar9 + 1;
      __src = *(JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollidePointResult,JPH::CollisionCollectorTraitsCollideShape>,32>**)( this + 0x130 );
      if (uVar2 < uVar4) {
         uVar7 = uVar2 * 2;
         if (uVar2 * 2 < uVar4) {
            uVar7 = uVar4;
         ...
         if (__src == (JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollidePointResult,JPH::CollisionCollectorTraitsCollideShape>,32>*)0x0) {
            ...
            if (uVar2 < 0x21) {
               *(ulong*)( this + 0x118 ) = uVar2;
               ...
               __src = (JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollidePointResult,JPH::CollisionCollectorTraitsCollideShape>,32>*)( *JPH::Allocate )(uVar7 * 8);
               uVar9 = *(ulong*)( this + 0x120 );
               uVar4 = uVar9 + 1;
            }
            ...
            if (( ulong )((long)__src - (long)pJVar1) < 0xf9) {
               if (( pJVar1 + ( *(long*)( this + 0x118 ) - uVar2 ) * 8 == __src ) && ( uVar8 = uVar8 < 0x21 )) {
                  *(ulong*)( this + 0x118 ) = uVar8;
               }
 else {
                  __dest = (void*)( *JPH::Allocate )(uVar7 * 8);
                  pJVar5 = (JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollidePointResult,JPH::CollisionCollectorTraitsCollideShape>,32>*)memcpy(__dest, __src, uVar2 * 8);
               ...
               __src = (JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollidePointResult,JPH::CollisionCollectorTraitsCollideShape>,32>*)( *JPH::Reallocate )(__src, uVar2 * 8, uVar7 * 8);
               uVar9 = *(ulong*)( this + 0x120 );
               uVar4 = uVar9 + 1;
            }
         ...
         *(JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollidePointResult,JPH::CollisionCollectorTraitsCollideShape>,32>**)( this + 0x130 ) = __src;
         *(ulong*)( this + 0x128 ) = uVar7;
      }

      *(ulong*)( this + 0x120 ) = uVar4;
      if (__src + uVar9 * 8 != (JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollidePointResult,JPH::CollisionCollectorTraitsCollideShape>,32>*)0x0) {
...
/* JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,
   JPH::CollisionCollectorTraitsCollideShape>, 32>::AddHit(JPH::TransformedShape const&) */void JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,JPH::CollisionCollectorTraitsCollideShape>,32>::AddHit(JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,JPH::CollisionCollectorTraitsCollideShape>,32> *this, TransformedShape *param_1) {
   long *plVar1;
   ulong uVar2;
   JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,JPH::CollisionCollectorTraitsCollideShape>,32> *pJVar3;
   undefined8 uVar4;
   long *plVar5;
   long lVar6;
   undefined8 uVar7;
   ...
   undefined8 uVar9;
   undefined8 uVar10;
   JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,JPH::CollisionCollectorTraitsCollideShape>,32> *pJVar11;
   ulong uVar12;
   long lVar13;
   ulong uVar14;
   ulong uVar15;
   JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,JPH::CollisionCollectorTraitsCollideShape>,32> *pJVar16;
   JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,JPH::CollisionCollectorTraitsCollideShape>,32> *pJVar17;
   JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,JPH::CollisionCollectorTraitsCollideShape>,32> *pJVar18;
   lVar13 = *(long*)( this + 0x828 );
   uVar2 = *(ulong*)( this + 0x830 );
   pJVar3 = *(JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,JPH::CollisionCollectorTraitsCollideShape>,32>**)( this + 0x838 );
   uVar12 = lVar13 + 1;
   pJVar11 = pJVar3;
   if (uVar2 < uVar12) {
      uVar14 = uVar2 * 2;
      ...
      if (pJVar3 == (JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,JPH::CollisionCollectorTraitsCollideShape>,32>*)0x0) {
         ...
         if (uVar2 < 0x21) {
            *(ulong*)( this + 0x820 ) = uVar2;
            ...
            pJVar11 = (JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,JPH::CollisionCollectorTraitsCollideShape>,32>*)( *JPH::Allocate )(uVar14 << 6);
            lVar13 = *(long*)( this + 0x828 );
            uVar12 = lVar13 + 1;
         }
         ...
         if (( ulong )((long)pJVar3 - (long)pJVar17) < 0x7c1) {
            if (( pJVar3 == pJVar17 + ( *(long*)( this + 0x820 ) - uVar2 ) * 0x40 ) && ( uVar15 = uVar15 < 0x21 )) {
               *(ulong*)( this + 0x820 ) = uVar15;
               ...
               if (uVar2 != 0) {
                  do {
                     if (pJVar18 == (JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,JPH::CollisionCollectorTraitsCollideShape>,32>*)0x0) {
 ...
 while ( uVar2 != uVar12 );
            ...
            if (uVar2 != 0) {
               do {
                  if (pJVar16 == (JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,JPH::CollisionCollectorTraitsCollideShape>,32>*)0x0) {
 ...
 while ( uVar2 != uVar12 );
      ...
      *(JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,JPH::CollisionCollectorTraitsCollideShape>,32>**)( this + 0x838 ) = pJVar11;
      *(ulong*)( this + 0x830 ) = uVar14;
   }

   *(ulong*)( this + 0x828 ) = uVar12;
   pJVar11 = pJVar11 + lVar13 * 0x40;
   if (pJVar11 != (JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,JPH::CollisionCollectorTraitsCollideShape>,32>*)0x0) {
      uVar4 = *(undefined8*)( param_1 + 8 );
...
/* JoltPhysicsDirectSpaceState3D::get_class() const */void JoltPhysicsDirectSpaceState3D::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* PhysicsDirectSpaceState3D::is_class(String const&) const */undefined8 PhysicsDirectSpaceState3D::is_class(PhysicsDirectSpaceState3D *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_0010857f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
 ...
 while ( !bVar9 );
         ...
         LAB_001086e3:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
      ...
      LAB_00108633:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* JoltPhysicsDirectSpaceState3D::is_class(String const&) const */undefined8 JoltPhysicsDirectSpaceState3D::is_class(JoltPhysicsDirectSpaceState3D *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *__s;
   long lVar3;
 ...
 while ( !bVar8 );
      ...
      LAB_0010880f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_001088c3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* JoltPhysicsDirectSpaceState3D::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool)
   const */void JoltPhysicsDirectSpaceState3D::_get_property_listv(JoltPhysicsDirectSpaceState3D *this, List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   undefined1(*pauVar4)[16];
...
/* JoltPhysicsDirectSpaceState3D::_initialize_classv() */void JoltPhysicsDirectSpaceState3D::_initialize_classv(void) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   long local_60;
   ...
   if (initialize_class() != '\0') goto LAB_00109454;
   if (PhysicsDirectSpaceState3D::initialize_class() == '\0') {
      ...
      lVar2 = local_58;
      if (local_58 == 0) {
         LAB_0010955e:if ((code*)_GLOBAL_OFFSET_TABLE_ != Object::_bind_methods) {
            LAB_0010956e:PhysicsDirectSpaceState3D::_bind_methods();
         }
   ...
   initialize_class()::initialized =
   '\x01';
   LAB_00109454:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::Body::GetPosition() const */undefined1  [16] __thiscallJPH::Body::GetPosition(Body *this) {
   ...
   fVar10 = (float)( *(uint*)( this + 0x14 ) ^ _UNK_0010f1b4 );
   fVar11 = (float)( *(uint*)( this + 0x18 ) ^ _UNK_0010f1b8 );
   fVar12 = (float)( *(uint*)( this + 0x1c ) ^ _UNK_0010f1bc );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::Body::GetWorldSpaceSurfaceNormal(JPH::SubShapeID const&, JPH::Vec3) const */undefined8 JPH::Body::GetWorldSpaceSurfaceNormal(undefined8 param_1, float param_2, Body *this) {
   float fVar1;
   float fVar2;
   undefined8 uVar3;
   float fVar4;
   ...
   fVar7 = (float)( _UNK_0010f1b4 ^ *(uint*)( this + 0x14 ) );
   fVar8 = (float)( _UNK_0010f1b8 ^ *(uint*)( this + 0x18 ) );
   fVar9 = (float)( _UNK_0010f1bc ^ *(uint*)( this + 0x1c ) );
   fVar11 = *(float*)this;
   fVar1 = *(float*)( this + 4 );
   fVar2 = *(float*)( this + 8 );
   fVar18 = fVar7 + fVar7;
   ...
   local_58 = CONCAT44(fVar5 * (float)local_58 + local_58._4_4_ * fVar19 + param_2 * fVar15 + ( 0.0 - ( fVar11 * fVar5 + fVar1 * fVar19 + fVar2 * fVar15 ) ), fVar18 * (float)local_58 + local_58._4_4_ * fVar20 + param_2 * fVar17 + ( 0.0 - ( fVar11 * fVar18 + fVar1 * fVar20 + fVar2 * fVar17 ) ));
   uStack_50._0_4_ = fVar4 + fVar8 + param_2 * fVar16 + ( 0.0 - ( fVar11 * fVar12 + fVar1 * fVar14 + fVar2 * fVar16 ) );
   uStack_50._4_4_ = fVar7 + fVar9 + param_2 * 0.0 + 1.0;
   if (*(code**)( **(long**)( this + 0x40 ) + 0x58 ) == JoltCustomMotionShape::GetSurfaceNormal) {
      _err_print_error("GetSurfaceNormal", "modules/jolt_physics/spaces/../shapes/jolt_custom_motion_shape.h", 0x46, "Method/function failed. Returning: JPH::Vec3::sZero()", "Not implemented.", 0);
      uVar3 = 0;
      fVar11 = 0.0;
      local_58._4_4_ = 0.0;
      local_58._0_4_ = 0.0;
   ...
   auVar10._0_4_ = SQRT(auVar6._8_4_ * auVar6._8_4_ + auVar6._4_4_ * auVar6._4_4_ + auVar6._0_4_ * auVar6._0_4_ + 0.0);
            ...
            if (__src == (InternalEdgeRemovingCollector*)0x0) {
               ...
               *(ulong*)( this + 0x820 ) = uVar3;
               ...
               if (( ulong )((long)__src - (long)pIVar7) < 0x7f1) {
                  ...
                  LAB_00109d0f:uVar8 = *(long*)( this + 0x828 ) + 1;
                  lVar12 = *(long*)( this + 0x828 ) << 4;
                  fVar15 = _LC21;
               }
...
/* JPH::Array<JPH::CollideShapeResult, JPH::STLLocalAllocator<JPH::CollideShapeResult, 32ul>
   >::push_back(JPH::CollideShapeResult const&) */void JPH::Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,32ul>>::push_back(Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,32ul>> *this, CollideShapeResult *param_1) {
   undefined4 uVar1;
   undefined4 uVar2;
   uint uVar3;
   ulong uVar4;
   ...
   pAVar5 = *(Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,32ul>>**)( this + 0x8c18 );
   uVar14 = lVar17 + 1;
   pAVar13 = pAVar5;
   if (uVar4 < uVar14) {
      uVar18 = uVar4 * 2;
      ...
      if (pAVar5 == (Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,32ul>>*)0x0) {
         ...
         if (uVar4 < 0x21) {
            *(ulong*)( this + 0x8c00 ) = uVar4;
            ...
            pAVar13 = (Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,32ul>>*)( *Allocate )(uVar18 * 0x460);
            lVar17 = *(long*)( this + 0x8c08 );
            uVar14 = lVar17 + 1;
         }
         ...
         if (( this + ( *(long*)( this + 0x8c00 ) - uVar4 ) * 0x460 == pAVar5 ) && ( uVar15 = uVar15 < 0x21 )) {
            *(ulong*)( this + 0x8c00 ) = uVar15;
            ...
            if (uVar4 != 0) {
               ...
               pAVar16 = pAVar13;
               do {
                  if (pAVar16 != (Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,32ul>>*)0x0) {
 ...
 while ( pAVar5 + uVar4 * 0x460 + 0x260 != pAVar19 );
      ...
      *(Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,32ul>>**)( this + 0x8c18 ) = pAVar13;
      *(ulong*)( this + 0x8c10 ) = uVar18;
   }

   *(ulong*)( this + 0x8c08 ) = uVar14;
   pAVar13 = pAVar13 + lVar17 * 0x460;
   if (pAVar13 != (Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,32ul>>*)0x0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::InternalEdgeRemovingCollector::AddHit(JPH::CollideShapeResult const&) */void JPH::InternalEdgeRemovingCollector::AddHit(InternalEdgeRemovingCollector *this, CollideShapeResult *param_1) {
   ...
   if (2 < *(uint*)( param_1 + 0x250 )) {
      fVar2 = ( *(float*)( param_1 + 0x284 ) - *(float*)( param_1 + 0x264 ) ) * ( *(float*)( param_1 + 0x270 ) - *(float*)( param_1 + 0x260 ) ) - ( *(float*)( param_1 + 0x274 ) - *(float*)( param_1 + 0x264 ) ) * ( *(float*)( param_1 + 0x280 ) - *(float*)( param_1 + 0x260 ) );
      fVar3 = ( *(float*)( param_1 + 0x288 ) - *(float*)( param_1 + 0x268 ) ) * ( *(float*)( param_1 + 0x274 ) - *(float*)( param_1 + 0x264 ) ) - ( *(float*)( param_1 + 0x278 ) - *(float*)( param_1 + 0x268 ) ) * ( *(float*)( param_1 + 0x284 ) - *(float*)( param_1 + 0x264 ) );
      fVar4 = ( *(float*)( param_1 + 0x280 ) - *(float*)( param_1 + 0x260 ) ) * ( *(float*)( param_1 + 0x278 ) - *(float*)( param_1 + 0x268 ) ) - ( *(float*)( param_1 + 0x270 ) - *(float*)( param_1 + 0x260 ) ) * ( *(float*)( param_1 + 0x288 ) - *(float*)( param_1 + 0x268 ) );
      fVar5 = SQRT(fVar2 * fVar2 + fVar4 * fVar4 + fVar3 * fVar3 + 0.0);
      if (( _LC41 <= fVar5 ) && ( fVar2 * ( 0.0 - *(float*)( param_1 + 0x28 ) ) + fVar4 * ( 0.0 - *(float*)( param_1 + 0x24 ) ) + fVar3 * ( 0.0 - *(float*)( param_1 + 0x20 ) ) + 0.0 <= SQRT(*(float*)( param_1 + 0x28 ) * *(float*)( param_1 + 0x28 ) + *(float*)( param_1 + 0x20 ) * *(float*)( param_1 + 0x20 ) + 0.0 + *(float*)( param_1 + 0x24 ) * *(float*)( param_1 + 0x24 )) * __LC42 * fVar5 )) {
         Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,32ul>>::push_back((Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,32ul>>*)( this + 0x840 ), param_1);
         return;
      }
...
/* JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollideShapeResult,
   JPH::CollisionCollectorTraitsCollideShape>, 32>::AddHit(JPH::CollideShapeResult const&) */void JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>,32>::AddHit(JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>,32> *this, CollideShapeResult *param_1) {
   int iVar1;
   int iVar2;
   iVar1 = *(int*)( this + 0x8c40 );
   iVar2 = (int)*(undefined8*)( this + 0x8c28 );
   if (iVar2 < iVar1) {
      JPH::Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,32ul>>::push_back((Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,32ul>>*)( this + 0x20 ), param_1);
...
/* JPH::InternalEdgeRemovingCollector::Flush() */void JPH::InternalEdgeRemovingCollector::Flush(InternalEdgeRemovingCollector *this) {
   ...
   if (uVar4 == 0) {
      ...
      if (( uVar14 & 1 ) != 0) {
         *puVar7 = 0;
         uVar8 = 1;
         if (( uVar14 & 0xffffffff ) == 1) goto LAB_0010abc1;
      }
 ...
 while ( ( uVar14 & 0xffffffff ) != uVar8 );
   ...
   if (*(int*)( this + 0x9448 ) == 0) {
      LAB_0010af06:*(undefined8*)( this + 0x828 ) = 0;
      *(undefined8*)( this + 0x9448 ) = 0;
   ...
   LAB_0010abf0:pCVar13 = (CollideShapeResult*)( (ulong)(uint)local_40[lVar15] * 0x460 + *(long*)( this + 0x9458 ) );
   ...
   if (uVar2 == 0) {
      ...
      do {
         ...
         if (fVar21 < _LC43) {
            ...
            fVar21 = (float)( ( uint )(fVar19 * fStack_e0 + fVar18 * fStack_e4 + fVar17 * local_e8 + 0.0) ^ _LC6 ) / fVar21;
            if (fVar21 < _LC41) {
               fVar21 = fStack_e0 * fStack_e0 + fStack_e4 * fStack_e4 + local_e8 * local_e8 + 0.0;
               if (fVar21 < fVar24) {
                  uVar14 = uVar4;
 ...
 else if (( fVar21 < _LC44 ) && ( local_e8 = fVar21 * fVar17 + local_e8 ),fStack_e4 = fVar21 * fVar18 + fStack_e4,fStack_e0 = fVar21 * fVar19 + fStack_e0,fVar21 = fStack_e0 * fStack_e0 + fStack_e4 * fStack_e4 + local_e8 * local_e8 + 0.0,fVar21 < fVar24) {
               uVar14 = (ulong)uVar9;
               uVar8 = uVar4;
               fVar24 = fVar21;
            }
 ...
 while ( uVar16 != uVar2 );
   ...
   for (pfVar6 = pfVar12; pfVar6 != pfVar10; pfVar6 = pfVar6 + 4) {
      if (( *(float*)( pCVar13 + 0x34 ) == pfVar6[3] ) && ( ( pfVar6[2] - *(float*)( pCVar1 + 8 ) ) * ( pfVar6[2] - *(float*)( pCVar1 + 8 ) ) + ( pfVar6[1] - *(float*)( pCVar1 + 4 ) ) * ( pfVar6[1] - *(float*)( pCVar1 + 4 ) ) + ( *pfVar6 - *(float*)pCVar1 ) * ( *pfVar6 - *(float*)pCVar1 ) + 0.0 <= _LC21 )) {
   ...
   while (pfVar12 = pfVar12 + 4,pfVar10 != pfVar12) {
      LAB_0010ae9d:if (( *(float*)( pCVar13 + 0x34 ) == pfVar12[3] ) && ( ( pfVar12[2] - *(float*)( pCVar1 + 8 ) ) * ( pfVar12[2] - *(float*)( pCVar1 + 8 ) ) + ( pfVar12[1] - *(float*)( pCVar1 + 4 ) ) * ( pfVar12[1] - *(float*)( pCVar1 + 4 ) ) + ( *pfVar12 - *(float*)pCVar1 ) * ( *pfVar12 - *(float*)pCVar1 ) + 0.0 <= _LC21 )) goto LAB_0010aed8;
   }
;
   LAB_0010af70:plVar3 = *(long**)( this + 0x18 );
   plVar3[2] = *(long*)( this + 0x10 );
   ( **(code**)( *plVar3 + 0x28 ) )(plVar3, pCVar13);
   *(undefined4*)( this + 8 ) = *(undefined4*)( *(long*)( this + 0x18 ) + 8 );
   LAB_0010aed8:lVar15 = lVar15 + 1;
...
/* String vformat<char const*, Vector3, Vector3>(String const&, char const* const, Vector3 const,
   Vector3 const) */long *vformat<char_const*,Vector3,Vector3>(undefined8 param_1_00, undefined4 param_2_00, undefined8 param_3, undefined4 param_4, long *param_1, bool *param_2, char *param_7) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   Variant *pVVar4;
 ...
 while ( iVar5 != 3 );
   ...
   if (local_f9 == '\0') {
      *param_1 = local_f0;
      ...
      _err_print_error("vformat", "./core/variant/variant.h", 0x3b1, "Condition \"error\" is true. Returning: String()", (String*)&local_b8, 0, 0);
      pcVar3 = local_b8;
...
/* WARNING: Removing unreachable block (ram,0x0010b668) *//* WARNING: Removing unreachable block (ram,0x0010b798) *//* WARNING: Removing unreachable block (ram,0x0010b960) *//* WARNING: Removing unreachable block (ram,0x0010b7a4) *//* WARNING: Removing unreachable block (ram,0x0010b7ae) *//* WARNING: Removing unreachable block (ram,0x0010b940) *//* WARNING: Removing unreachable block (ram,0x0010b7ba) *//* WARNING: Removing unreachable block (ram,0x0010b7c4) *//* WARNING: Removing unreachable block (ram,0x0010b920) *//* WARNING: Removing unreachable block (ram,0x0010b7d0) *//* WARNING: Removing unreachable block (ram,0x0010b7da) *//* WARNING: Removing unreachable block (ram,0x0010b900) *//* WARNING: Removing unreachable block (ram,0x0010b7e6) *//* WARNING: Removing unreachable block (ram,0x0010b7f0) *//* WARNING: Removing unreachable block (ram,0x0010b8e0) *//* WARNING: Removing unreachable block (ram,0x0010b7fc) *//* WARNING: Removing unreachable block (ram,0x0010b806) *//* WARNING: Removing unreachable block (ram,0x0010b8c0) *//* WARNING: Removing unreachable block (ram,0x0010b812) *//* WARNING: Removing unreachable block (ram,0x0010b81c) *//* WARNING: Removing unreachable block (ram,0x0010b8a0) *//* WARNING: Removing unreachable block (ram,0x0010b824) *//* WARNING: Removing unreachable block (ram,0x0010b83a) *//* WARNING: Removing unreachable block (ram,0x0010b846) *//* String vformat<char const*>(String const&, char const* const) */String *vformat<char_const*>(String *param_1, char *param_2) {
   char cVar1;
   Variant *this;
   char *in_RDX;
   int iVar2;
...
/* WARNING: Removing unreachable block (ram,0x0010baa8) *//* WARNING: Removing unreachable block (ram,0x0010bbd8) *//* WARNING: Removing unreachable block (ram,0x0010bda0) *//* WARNING: Removing unreachable block (ram,0x0010bbe4) *//* WARNING: Removing unreachable block (ram,0x0010bbee) *//* WARNING: Removing unreachable block (ram,0x0010bd80) *//* WARNING: Removing unreachable block (ram,0x0010bbfa) *//* WARNING: Removing unreachable block (ram,0x0010bc04) *//* WARNING: Removing unreachable block (ram,0x0010bd60) *//* WARNING: Removing unreachable block (ram,0x0010bc10) *//* WARNING: Removing unreachable block (ram,0x0010bc1a) *//* WARNING: Removing unreachable block (ram,0x0010bd40) *//* WARNING: Removing unreachable block (ram,0x0010bc26) *//* WARNING: Removing unreachable block (ram,0x0010bc30) *//* WARNING: Removing unreachable block (ram,0x0010bd20) *//* WARNING: Removing unreachable block (ram,0x0010bc3c) *//* WARNING: Removing unreachable block (ram,0x0010bc46) *//* WARNING: Removing unreachable block (ram,0x0010bd00) *//* WARNING: Removing unreachable block (ram,0x0010bc52) *//* WARNING: Removing unreachable block (ram,0x0010bc5c) *//* WARNING: Removing unreachable block (ram,0x0010bce0) *//* WARNING: Removing unreachable block (ram,0x0010bc64) *//* WARNING: Removing unreachable block (ram,0x0010bc7a) *//* WARNING: Removing unreachable block (ram,0x0010bc86) *//* String vformat<String>(String const&, String const) */undefined8 *vformat<String>(undefined8 *param_1, bool *param_2, String *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* JPH::Array<JPH::CollideShapeResult, JPH::STLLocalAllocator<JPH::CollideShapeResult, 33ul>
   >::reallocate(unsigned long) */void JPH::Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,33ul>>::reallocate(Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,33ul>> *this, ulong param_1) {
   ...
   pAVar5 = *(Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,33ul>>**)( this + 0x9078 );
   if (pAVar5 == (Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,33ul>>*)0x0) {
      ...
      if (uVar14 < 0x22) {
         *(ulong*)( this + 0x9060 ) = uVar14;
         ...
         local_48 = (Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,33ul>>*)( *Allocate )(param_1 * 0x460);
      }
      ...
      if (( pAVar5 == local_48 ) && ( lVar12 + param_1 < 0x22 )) {
         *(ulong*)( this + 0x9060 ) = ( *(long*)( this + 0x9060 ) + param_1 ) - uVar14;
         ...
         if (uVar16 != 0) {
            ...
            pAVar15 = local_48;
            do {
               if (pAVar15 != (Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,33ul>>*)0x0) {
 ...
 while ( pAVar13 != pAVar1 );
   ...
   *(Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,33ul>>**)( this + 0x9078 ) = local_48;
   return;
}
/* JoltQueryCollectorClosestMulti<JPH::CollisionCollector<JPH::CollideShapeResult,
   JPH::CollisionCollectorTraitsCollideShape>, 32>::AddHit(JPH::CollideShapeResult const&) */void JoltQueryCollectorClosestMulti<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>,32>::AddHit(JoltQueryCollectorClosestMulti<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>,32> *this, CollideShapeResult *param_1) {
   undefined4 uVar1;
   undefined4 uVar2;
   uint uVar3;
   long lVar4;
   ...
   pAVar14 = *(Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,33ul>>**)( this + 0x9098 );
   ...
   if (pAVar14 != pAVar12) {
      ...
      do {
         pAVar21 = pAVar11;
         if (*(float*)( pAVar11 + 0x30 ) <= *(float*)( param_1 + 0x30 ) && *(float*)( param_1 + 0x30 ) != *(float*)( pAVar11 + 0x30 )) break;
 ...
 while ( pAVar11 != pAVar12 );
   ...
   pAVar11 = (Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,33ul>>*)( this + 0x20 );
   ...
   if (uVar16 < uVar19) {
      ...
      if (pAVar14 == (Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,33ul>>*)0x0) {
         ...
         if (uVar16 < 0x22) {
            *(ulong*)( this + 0x9080 ) = uVar16;
            ...
            pAVar12 = (Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,33ul>>*)( *JPH::Allocate )(uVar17 * 0x460);
            lVar18 = *(long*)( this + 37000 );
            uVar19 = lVar18 + 1;
         }
         ...
         if (( pAVar14 == pAVar11 + ( *(long*)( this + 0x9080 ) - uVar16 ) * 0x460 ) && ( uVar13 = uVar13 < 0x22 )) {
 ...
 while ( pAVar14 + uVar16 * 0x460 + 0x260 != pAVar21 );
      ...
      *(Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,33ul>>**)( this + 0x9098 ) = pAVar12;
   ...
   if (pAVar21 != (Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,33ul>>*)0x0) {
   ...
   *(ulong*)( this + 37000 ) = uVar19;
   ...
   if (*(ulong*)( this + 0x9090 ) < uVar16) {
      JPH::Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,33ul>>::reallocate(pAVar11, uVar16);
      pAVar12 = *(Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,33ul>>**)( this + 0x9098 );
      uVar19 = *(ulong*)( this + 37000 );
   }

   pAVar21 = pAVar12 + uVar19 * 0x460;
   if (pAVar21 < pAVar12 + uVar16 * 0x460) {
      if (pAVar21 == (Array<JPH::CollideShapeResult,JPH::STLLocalAllocator<JPH::CollideShapeResult,33ul>>*)0x0) goto LAB_0010c666;
      do {
         uVar6 = _LC47;
         uVar5 = _LC48;
         *(undefined4*)( pAVar21 + 0x250 ) = 0;
         ...
         *(undefined8*)( pAVar21 + 0x3c ) = uVar6;
         LAB_0010c666:pAVar21 = pAVar21 + 0x460;
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::Vec3 JPH::ClosestPoint::GetClosestPointOnTriangle<true>(JPH::Vec3, JPH::Vec3, JPH::Vec3,
   unsigned int&) */undefined1[16];JPH::ClosestPoint::GetClosestPointOnTriangle<true>(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, int *param_7) {
   int iVar1;
   float fVar2;
   uint uVar3;
   float fVar4;
   ...
   fVar2 = ( fVar29 - (float)uStack_50 ) * ( fVar29 - (float)uStack_50 ) + ( (float)local_78._0_4_ - (float)local_58 ) * ( (float)local_78._0_4_ - (float)local_58 ) + 0.0 + ( (float)local_78._4_4_ - local_58._4_4_ ) * ( (float)local_78._4_4_ - local_58._4_4_ );
   ...
   if (fVar31 < _LC97) {
      iVar1 = 4;
      fVar31 = fVar29 * fVar29 + (float)local_78._4_4_ * (float)local_78._4_4_ + (float)local_78._0_4_ * (float)local_78._0_4_ + 0.0;
      ...
      fVar9 = fVar31;
      if (_LC43 < fVar15) {
         fVar15 = (float)( ( uint )(fVar24 * fVar13 + fVar12 * fVar22 + fVar20 * fVar4 + 0.0) ^ _LC6 ) / fVar15;
         if (fVar15 < 0.0) {
            fVar16 = 0.0;
         }
 else {
      ...
      if (_LC43 < fVar30) {
         fVar30 = (float)( ( uint )(fVar28 * fStack_60 + fVar27 * fStack_64 + fVar26 * local_68 + 0.0) ^ _LC6 ) / fVar30;
         if (fVar30 < 0.0) {
            fVar4 = 0.0;
         }
 else {
   ...
   if (fVar26 < 0.0) {
      if (( fVar29 * fVar18 <= fVar30 * fVar26 ) && ( 0.0 <= fVar29 )) goto LAB_0010cefe;
   }
 else {
      if (fVar18 <= fVar26) {
         *param_7 = 2;
      ...
      if (( ( fVar29 * fVar18 <= fVar30 * fVar26 ) && ( 0.0 <= fVar29 ) ) && ( fVar26 == 0.0 )) {
         LAB_0010cefe:*param_7 = ( -(uint)(iVar1 == 0) & 0xfffffffd ) + 6;
   ...
   if (fVar27 < 0.0) {
      if (( fVar30 * fVar15 <= fVar29 * fVar27 ) && ( 0.0 <= fVar30 )) goto LAB_0010d0b4;
   }
 else {
      if (fVar15 <= fVar27) {
         uStack_70 = uStack_50;
   ...
   *param_7 = 7;
   ...
   fVar30 = ( fVar13 + fStack_60 + fVar23 ) * fVar2 + ( fVar12 + fStack_64 + fVar21 ) * fVar9 + ( fVar4 + local_68 + fVar19 ) * fVar7 + 0.0;
...
/* JPH::Vec3 JPH::ClosestPoint::GetClosestPointOnTetrahedron<true>(JPH::Vec3, JPH::Vec3, JPH::Vec3,
   JPH::Vec3, unsigned int&) */undefined1[16];JPH::ClosestPoint::GetClosestPointOnTetrahedron<true>(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7, undefined8 param_8, uint *param_9) {
   uint uVar1;
   long in_FS_OFFSET;
   float fVar2;
   float fVar3;
   ...
   if (auVar6._0_8_ >> 0x20 != 0) {
      auVar4 = GetClosestPointOnTriangle<true>(param_1, param_2, param_5, param_6, param_7, param_8, &local_24);
      fVar2 = auVar4._8_4_ * auVar4._8_4_ + auVar4._4_4_ * auVar4._4_4_ + auVar4._0_4_ * auVar4._0_4_ + 0.0;
      if (fVar2 < fVar3) {
         uVar1 = local_24 * 2 & 0xc | local_24 & 1;
         goto joined_r0x0010d1cd;
      }
   ...
   fVar2 = fVar3;
   joined_r0x0010d1cd:if (local_90 != 0) {
      auVar5 = GetClosestPointOnTriangle<true>(param_1, param_2, param_3, param_4, param_7, param_8, &local_24);
      fVar3 = auVar5._8_4_ * auVar5._8_4_ + auVar5._4_4_ * auVar5._4_4_ + auVar5._0_4_ * auVar5._0_4_ + 0.0;
      if (fVar3 < fVar2) {
   ...
   if (( auVar6._8_8_ >> 0x20 != 0 ) && ( auVar6 = GetClosestPointOnTriangle<true>(param_3, param_4, param_5, param_6, param_7, param_8, &local_24) ),auVar6._8_4_ * auVar6._8_4_ + auVar6._4_4_ * auVar6._4_4_ + auVar6._0_4_ * auVar6._0_4_ + 0.0 < fVar2) {
      uVar1 = local_24 * 2;
      auVar4 = auVar6;
   }
...
/* float JPH::GJKClosestPoint::GetClosestPoints<JPH::ConvexShape::Support,
   ...
   float, JPH::Vec3&, JPH::Vec3&, JPH::Vec3&) */float JPH::GJKClosestPoint::GetClosestPoints<JPH::ConvexShape::Support,JPH::PointConvexSupport>(GJKClosestPoint *this, Support *param_1, PointConvexSupport *param_2, float param_3, float param_4, Vec3 *param_5, Vec3 *param_6, Vec3 *param_7) {
   int iVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   int iVar4;
   ...
   *(undefined4*)( this + 0xc0 ) = 0;
   local_88 = *(float*)( param_5 + 8 ) * *(float*)( param_5 + 8 ) + *(float*)( param_5 + 4 ) * *(float*)( param_5 + 4 ) + fVar11 * fVar11 + 0.0;
   LAB_0010d4b8:auVar26 = ( **(code**)( *(long*)param_1 + 0x10 ) )(*(undefined8*)param_5, *(undefined8*)( param_5 + 8 ), param_1);
   ...
   fVar10 = (float)uStack_a0 * *(float*)( param_5 + 8 ) + local_a8._4_4_ * *(float*)( param_5 + 4 ) + *(float*)param_5 * (float)local_a8 + 0.0;
   if (( fVar10 < 0.0 ) && ( fVar14 = param_4 * local_88 < fVar10 * fVar10 )) goto LAB_0010d712;
   iVar1 = *(int*)( this + 0xc0 );
   iVar9 = iVar1 + 1;
   ...
   *(int*)( this + 0xc0 ) = iVar9;
   if (iVar9 == 3) {
      auVar26 = ClosestPoint::GetClosestPointOnTriangle<true>(*(undefined8*)this, *(undefined8*)( this + 8 ), *(undefined8*)( this + 0x10 ), *(undefined8*)( this + 0x18 ), *(undefined8*)( this + 0x20 ), *(undefined8*)( this + 0x28 ), &local_44);
      uStack_a0._0_4_ = auVar26._8_4_;
   }
 else if (iVar9 < 4) {
      if (iVar9 == 1) {
         ...
         if (fVar16 < _LC43) {
            if (fStack_90 * fStack_90 + fStack_94 * fStack_94 + local_98 * local_98 + 0.0 < fStack_60 * fStack_60 + fStack_64 * fStack_64 + local_68 * local_68 + 0.0) goto LAB_0010da05;
            LAB_0010da0f:local_44 = 2;
            local_a8 = uVar2;
            uStack_a0 = uVar3;
         }
 else {
            fVar16 = (float)( ( uint )(fVar13 * fStack_90 + fVar12 * fStack_94 + fVar11 * local_98 + 0.0) ^ _LC6 ) / fVar16;
            if (fVar16 <= 0.0) {
               LAB_0010da05:local_44 = 1;
            }
 else {
               fVar11 = _LC20 - fVar16;
               if (fVar11 <= 0.0) goto LAB_0010da0f;
               fStack_5c = (float)( (ulong)uVar3 >> 0x20 );
               local_44 = 3;
               local_a8 = CONCAT44(fVar16 * fStack_64 + fVar11 * fStack_94, fVar16 * local_68 + fVar11 * local_98);
               uStack_a0 = CONCAT44(fVar16 * fStack_5c + fVar11 * fStack_8c, fVar16 * fStack_60 + fVar11 * fStack_90);
            }
      ...
      if (iVar9 != 4) {
         LAB_0010de90:*(int*)( this + 0xc0 ) = iVar1;
         fVar14 = local_88;
         goto LAB_0010d712;
      }

      auVar26 = ClosestPoint::GetClosestPointOnTetrahedron<true>(*(undefined8*)this, *(undefined8*)( this + 8 ), *(undefined8*)( this + 0x10 ), *(undefined8*)( this + 0x18 ), *(undefined8*)( this + 0x20 ), *(undefined8*)( this + 0x28 ), *(undefined8*)( this + 0x30 ), *(undefined8*)( this + 0x38 ), &local_44);
      uStack_a0._0_4_ = auVar26._8_4_;
   }

   fVar14 = (float)uStack_a0 * (float)uStack_a0 + auVar26._0_4_ * auVar26._0_4_ + 0.0 + auVar26._4_4_ * auVar26._4_4_;
   if (fVar14 < fVar19) {
      ...
      *(ulong*)( param_5 + 8 ) = auVar26._8_8_ & 0xffffffff00000000 | (ulong)(uint)(float)uStack_a0;
      ...
      pGVar8 = this;
      iVar4 = 0;
      if (( local_44 & 1 ) == 0) goto joined_r0x0010d7ad;
      LAB_0010d776:lVar6 = (long)iVar9;
      ...
      *(undefined8*)( pGVar7 + 0x88 ) = uVar2;
      iVar4 = iVar5;
      joined_r0x0010d7ad:if (iVar4 < iVar1) goto LAB_0010d7af;
      *(int*)( this + 0xc0 ) = iVar9;
      ...
      fVar11 = *(float*)( this + 8 ) * *(float*)( this + 8 ) + *(float*)( this + 4 ) * *(float*)( this + 4 ) + *(float*)this * *(float*)this + 0.0;
      if (1 < iVar9) {
         pGVar8 = this + 0x10;
         fVar16 = fVar11;
         do {
            pGVar7 = pGVar8 + 0x10;
            fVar11 = *(float*)( pGVar8 + 8 ) * *(float*)( pGVar8 + 8 ) + *(float*)pGVar8 * *(float*)pGVar8 + 0.0 + *(float*)( pGVar8 + 4 ) * *(float*)( pGVar8 + 4 );
            if (fVar11 <= fVar16) {
               fVar11 = fVar16;
            }
 ...
 while ( this + ( ulong )(iVar9 - 2) * 0x10 + 0x20 != pGVar7 );
      ...
      if (fVar14 <= fVar11 * _LC25) {
         *(undefined1(*) [16])param_5 = (undefined1[16])0x0;
         LAB_0010dea7:fVar14 = 0.0;
         goto LAB_0010d6d5;
      }

      *(float*)param_5 = 0.0 - *(float*)param_5;
      for (int i = 0; i < 3; i++) {
         *(float*)( param_5 + ( 4*i + 4 ) ) = 0 - *(float*)( param_5 + ( 4*i + 4 ) );
      }
      ...
      fVar19 = fVar14;
      local_88 = fVar14;
      if (fVar11 <= fVar16) goto LAB_0010d6d5;
      goto LAB_0010d4b8;
   }
   ...
   *(int*)( this + 0xc0 ) = iVar1;
   ...
   LAB_0010d6d5:if (iVar9 == 2) {
      ...
      if (fVar11 < _LC43) {
         if (fStack_90 * fStack_90 + fStack_94 * fStack_94 + local_98 * local_98 + 0.0 <= (float)local_a8 * (float)local_a8 + 0.0 + local_a8._4_4_ * local_a8._4_4_ + (float)uStack_a0 * (float)uStack_a0) {
            fVar19 = 0.0;
            fVar11 = _LC20;
         }
 else {
         ...
         fVar11 = (float)( ( uint )(fVar12 * (float)uStack_a0 + fVar16 * local_a8._4_4_ + fVar19 * (float)local_a8 + 0.0) ^ _LC6 ) / fVar11;
         fVar19 = _LC20 - fVar11;
      }
   ...
   if (fVar25 <= fVar15) {
      ...
      if (fVar13 < _LC99) {
         if (fVar25 <= fVar17) {
            if (_LC43 <= fVar17) goto LAB_0010df7e;
            if (fStack_90 * fStack_90 + fStack_94 * fStack_94 + local_98 * local_98 + 0.0 <= local_a8._4_4_ * local_a8._4_4_ + (float)local_a8 * (float)local_a8 + 0.0 + (float)uStack_a0 * (float)uStack_a0) goto LAB_0010e21a;
            LAB_0010e127:fVar11 = 0.0;
            goto LAB_0010dfc0;
         }

         if (fVar25 < _LC43) {
            if (fStack_80 * fStack_80 + fStack_84 * fStack_84 + local_88 * local_88 + 0.0 <= local_a8._4_4_ * local_a8._4_4_ + (float)local_a8 * (float)local_a8 + 0.0 + (float)uStack_a0 * (float)uStack_a0) {
               fVar16 = 0.0;
            }
 else {
               fVar19 = 0.0;
            ...
            fVar19 = (float)( ( uint )((float)uStack_a0 * fVar24 + local_a8._4_4_ * fVar23 + fVar22 * (float)local_a8 + 0.0) ^ _LC6 ) / fVar25;
            fVar16 = _LC20 - fVar19;
         }
      ...
      if (fVar22 < _LC99) {
         if (fVar17 <= fVar15) {
            if (fVar15 < _LC43) {
               if (fStack_90 * fStack_90 + fStack_94 * fStack_94 + local_98 * local_98 + 0.0 <= fStack_84 * fStack_84 + local_88 * local_88 + 0.0 + fStack_80 * fStack_80) {
                  fVar19 = 0.0;
               }
 else {
                  fVar11 = 0.0;
               ...
               fVar11 = (float)( ( uint )(fStack_80 * fVar10 + fStack_84 * fVar13 + local_88 * fVar12 + 0.0) ^ _LC6 ) / fVar15;
               fVar19 = _LC20 - fVar11;
            }
            ...
            if (fVar17 < _LC43) {
               if (local_a8._4_4_ * local_a8._4_4_ + (float)local_a8 * (float)local_a8 + 0.0 + (float)uStack_a0 * (float)uStack_a0 < fStack_90 * fStack_90 + fStack_94 * fStack_94 + local_98 * local_98 + 0.0) goto LAB_0010e127;
               LAB_0010e21a:fVar16 = 0.0;
            }
 else {
               LAB_0010df7e:fVar11 = (float)( ( uint )((float)uStack_a0 * fVar21 + local_a8._4_4_ * fVar20 + (float)local_a8 * fVar18 + 0.0) ^ _LC6 ) / fVar17;
               fVar16 = _LC20 - fVar11;
            }

            LAB_0010dfc0:fVar19 = 0.0;
         }
   ...
   *(float*)param_6 = *(float*)( this + 0x50 ) * fVar19 + *(float*)( this + 0x40 ) * fVar16 + *(float*)( this + 0x60 ) * fVar11;
   ...
   *(float*)param_7 = fVar11 * *(float*)( this + 0xa0 ) + fVar19 * *(float*)( this + 0x90 ) + fVar16 * *(float*)( this + 0x80 );
   ...
   *(float*)( param_7 + 0xc ) = fVar11 * fVar22 + fVar19 * fVar10 + fVar16 * fVar18;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   LAB_0010d7af:pGVar8 = pGVar8 + 0x10;
   iVar5 = iVar4 + 1;
   iVar4 = iVar5;
   if (( 1 << ( (byte)iVar5 & 0x1f ) & local_44 ) != 0) goto LAB_0010d776;
   goto joined_r0x0010d7ad;
}
/* JoltPhysicsDirectSpaceState3D::_cast_motion_impl(JPH::Shape const&, Transform3D const&, Vector3
   const&, Vector3 const&, bool, bool, JPH::CollideShapeSettings const&, JPH::BroadPhaseLayerFilter
   const&, JPH::ObjectLayerFilter const&, JPH::BodyFilter const&, JPH::ShapeFilter const&, float&,
   float&) const */void JoltPhysicsDirectSpaceState3D::_GLOBAL__sub_I__cast_motion_impl(void) {
...
/* WARNING: Control flow encountered bad instruction data *//* JoltPhysicsDirectSpaceState3D::~JoltPhysicsDirectSpaceState3D() */void JoltPhysicsDirectSpaceState3D::~JoltPhysicsDirectSpaceState3D(JoltPhysicsDirectSpaceState3D *this) {
...
/* WARNING: Control flow encountered bad instruction data *//* JoltQueryCollectorClosest<JPH::CollisionCollector<JPH::CollideShapeResult,
   JPH::CollisionCollectorTraitsCollideShape> >::~JoltQueryCollectorClosest() */void JoltQueryCollectorClosest<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>>::~JoltQueryCollectorClosest(JoltQueryCollectorClosest<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* JoltQueryCollectorAny<JPH::CollisionCollector<JPH::CollideShapeResult,
   JPH::CollisionCollectorTraitsCollideShape> >::~JoltQueryCollectorAny() */void JoltQueryCollectorAny<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>>::~JoltQueryCollectorAny(JoltQueryCollectorAny<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,
   JPH::CollisionCollectorTraitsCollideShape>, 32>::~JoltQueryCollectorAll() */void JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,JPH::CollisionCollectorTraitsCollideShape>,32>::~JoltQueryCollectorAll(JoltQueryCollectorAll<JPH::CollisionCollector<JPH::TransformedShape,JPH::CollisionCollectorTraitsCollideShape>,32> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollidePointResult,
   JPH::CollisionCollectorTraitsCollideShape>, 32>::~JoltQueryCollectorAnyMulti() */void JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollidePointResult,JPH::CollisionCollectorTraitsCollideShape>,32>::~JoltQueryCollectorAnyMulti(JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollidePointResult,JPH::CollisionCollectorTraitsCollideShape>,32> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* JoltQueryCollectorClosestMulti<JPH::CollisionCollector<JPH::CollideShapeResult,
   JPH::CollisionCollectorTraitsCollideShape>, 32>::~JoltQueryCollectorClosestMulti() */void JoltQueryCollectorClosestMulti<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>,32>::~JoltQueryCollectorClosestMulti(JoltQueryCollectorClosestMulti<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>,32> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollideShapeResult,
   JPH::CollisionCollectorTraitsCollideShape>, 32>::~JoltQueryCollectorAnyMulti() */void JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>,32>::~JoltQueryCollectorAnyMulti(JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape>,32> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::BodyID,
   JPH::CollisionCollectorTraitsCollideShape>, 1024>::~JoltQueryCollectorAnyMulti() */void JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::BodyID,JPH::CollisionCollectorTraitsCollideShape>,1024>::~JoltQueryCollectorAnyMulti(JoltQueryCollectorAnyMulti<JPH::CollisionCollector<JPH::BodyID,JPH::CollisionCollectorTraitsCollideShape>,1024> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

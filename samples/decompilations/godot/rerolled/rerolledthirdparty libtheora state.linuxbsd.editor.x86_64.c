void oc_set_chroma_mvs00(ushort *param_1, short *param_2) {
   int iVar1;
   int iVar2;
   iVar2 = (int)(char)*param_2 + (int)(char)param_2[1] + (int)(char)param_2[2] + (int)(char)param_2[3];
   iVar1 = (int)( *param_2 >> 8 ) + (int)( param_2[1] >> 8 ) + (int)( param_2[2] >> 8 ) + (int)( param_2[3] >> 8 );
   *param_1 = ( ushort )(iVar2 + ( iVar2 >> 0x1f ) + 2 >> 2) & 0xff | ( ushort )(( iVar1 + ( iVar1 >> 0x1f ) + 2 >> 2 ) << 8);
   return;
}
void oc_set_chroma_mvs01(ushort *param_1, short *param_2) {
   ...
   *param_1 = ( ushort )(iVar2 + ( iVar2 >> 0x1f ) + 1 >> 1) & 0xff | ( ushort )(( iVar1 + ( iVar1 >> 0x1f ) + 1 >> 1 ) << 8);
   iVar2 = (int)(char)param_2[1] + (int)(char)param_2[3];
   iVar1 = (int)( param_2[1] >> 8 ) + (int)( param_2[3] >> 8 );
   param_1[1] = ( ushort )(iVar2 + ( iVar2 >> 0x1f ) + 1 >> 1) & 0xff | ( ushort )(( iVar1 + ( iVar1 >> 0x1f ) + 1 >> 1 ) << 8);
   return;
}
void oc_set_chroma_mvs10(ushort *param_1, short *param_2) {
   ...
   *param_1 = ( ushort )(iVar2 + ( iVar2 >> 0x1f ) + 1 >> 1) & 0xff | ( ushort )(( iVar1 + ( iVar1 >> 0x1f ) + 1 >> 1 ) << 8);
   ...
   param_1[2] = ( ushort )(iVar2 + ( iVar2 >> 0x1f ) + 1 >> 1) & 0xff | ( ushort )(( iVar1 + ( iVar1 >> 0x1f ) + 1 >> 1 ) << 8);
   return;
}
void oc_set_chroma_mvs11(undefined2 *param_1, undefined2 *param_2) {
   *param_1 = *param_2;
   for (int i = 0; i < 3; i++) {
      param_1[( i + 1 )] = param_2[( i + 1 )];
   }
...
void loop_filter_h(long param_1, int param_2, long param_3) {
   ...
   do {
      bVar4 = pbVar2[2];
      bVar3 = pbVar2[1];
      cVar1 = *(char*)( param_3 + ( (int)( ( ( uint ) * pbVar2 - (uint)pbVar2[3] ) + 4 + ( (uint)bVar4 - (uint)bVar3 ) * 3 ) >> 3 ) );
...
void loop_filter_v(long param_1, int param_2, long param_3) {
   ...
   do {
      bVar5 = pbVar3[lVar4];
      cVar2 = *(char*)( param_3 + ( (int)( ( ( uint ) * pbVar3 - (uint)pbVar3[lVar4 * 3] ) + 4 + ( (uint)pbVar3[lVar4 * 2] - (uint)bVar5 ) * 3 ) >> 3 ) );
...
void oc_state_loop_filter_frag_rows_c(long param_1, long param_2, int param_3, int param_4, int param_5, int param_6) {
   long lVar1;
   int *piVar2;
   int iVar3;
   long lVar4;
         ...
         if (lVar10 < lVar12) {
            do {
               ...
               if (( *(byte*)( lVar6 + lVar9 * 4 ) & 1 ) == 0) {
                  joined_r0x001005ab:if (lVar12 == lVar1) break;
               }
 else {
                  ...
                  if (lVar12 <= lVar1) {
                     if (lVar13 < lVar4 + lVar5) {
                        LAB_00100587:if (( *(byte*)( lVar6 + lVar13 * 4 ) & 1 ) == 0) {
...
void oc_loop_filter_init_c(undefined8 *param_1, int param_2) {
   ...
   *param_1 = 0;
   ...
   for (uVar3 = ( ulong )(( (int)param_1 - (int)(undefined8*)( ( ulong )(param_1 + 1) & 0xfffffffffffffff8 ) ) + 0x100U >> 3); uVar3 != 0; uVar3 = uVar3 - 1) {
      *puVar6 = 0;
      puVar6 = puVar6 + 1;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 oc_state_init(undefined8 *param_1, byte *param_2, int param_3) {
   int *piVar1;
   ulong uVar2;
   size_t __nmemb;
   size_t __nmemb_00;
   ...
   if (param_2 == (byte*)0x0) {
      ...
      if (( ( ( ( ( uVar11 & 0xf ) == 0 ) && ( uVar26 = *(uint*)( param_2 + 8 )(uVar26 & 0xf) == 0 && uVar11 - 1 < 0xfffff ) ) && ( uVar26 - 1 < 0xfffff ) ) && ( ( *(int*)( param_2 + 0xc ) + *(uint*)( param_2 + 0x14 ) <= uVar11 && ( ( uint )(*(int*)( param_2 + 0x10 ) + *(int*)( param_2 + 0x18 )) <= uVar26 ) ) ) ) && ( ( ( ( ( uVar26 - ( *(int*)( param_2 + 0x10 ) + *(int*)( param_2 + 0x18 ) ) | *(uint*)( param_2 + 0x14 ) ) < 0x100 && ( ( *(uint*)( param_2 + 0x2c ) < 3 && ( *(uint*)( param_2 + 0x30 ) < 4 ) ) ) ) && ( *(int*)( param_2 + 0x1c ) != 0 ) ) && ( *(int*)( param_2 + 0x20 ) != 0 ) ) )) {
         memset(param_1, 0, 0xd110);
         uVar39 = *(undefined8*)( param_2 + 8 );
         *param_1 = *(undefined8*)param_2;
         param_1[1] = uVar39;
         for (int i = 0; i < 3; i++) {
            uVar39 = *(undefined8*)( param_2 + ( 16*i + 24 ) );
            param_1[( 2*i + 2 )] = *(undefined8*)( param_2 + ( 16*i + 16 ) );
            param_1[( 2*i + 3 )] = uVar39;
         }
         ...
         *(int*)( param_1 + 3 ) = iVar31 - ( iVar47 + iVar48 );
         ...
         uVar26 = ( (int)( ( *(uint*)( (long)param_1 + 4 ) >> 3 ) + 3 ) >> 2 ) * ( (int)( ( *(uint*)( param_1 + 1 ) >> 3 ) + 3 ) >> 2 );
         uVar52 = iVar31 * iVar57;
         __nmemb = lVar42 + lVar44 * 2;
         uVar11 = uVar52 * 2;
         uVar63 = uVar26 + uVar11;
         __nmemb_00 = (ulong)uVar26 * 4;
         if (( ( lVar44 != 0 && SBORROW8(lVar44, lVar44 * 2) == 0 < lVar44 ) || ( uVar11 < uVar52 || uVar26 / uVar65 != uVar66 ) ) || ( CARRY4(uVar26, uVar11) )) {
            LAB_001015f0:uVar39 = 0xffffffe9;
         }
 else {
            ...
            *(uint*)( param_1 + 0x29 ) = uVar63;
            ...
            if (( ( ( ( ( pvVar12 != (void*)0x0 && pvVar13 != (void*)0x0 ) && local_b0 != (void*)0x0 ) && pvVar14 != (void*)0x0 ) && pvVar15 != (void*)0x0 ) && pvVar16 != (void*)0x0 ) && ( pvVar17 != (void*)0x0 )) {
               piVar18 = piVar30;
               LAB_00100bad:iVar31 = *piVar18;
               uVar11 = piVar18[8];
               local_98 = 0;
               iVar47 = piVar18[1];
 ...
 while ( piVar61 != &SB_MAP_2 + lVar44 * 8 );
                           ...
                           do {
                              ...
                              bVar23 = (byte)uVar26;
                              uVar26 = uVar26 + 1;
                              uVar52 = uVar52 | ( ~(uint)((ulong)*puVar34 >> 0x20) >> 0x1f ) << ( bVar23 & 0x1f ) & 0xf;
                           }
 while ( uVar26 != 4 );
                           iVar48 = iVar48 + -4;
...
;
                     ...
                     if (4 < iVar47) break;
                     LAB_00100d4e:lVar44 = (long)iVar47;
                     if (iVar47 < 1) {
                        piVar18 = piVar18 + 10;
                                       ...
                                       do {
                                          ...
                                          while (true) {
                                             ...
                                             *(undefined4*)( (long)plVar46 + 4 ) = 0xffffffff;
                                             for (int i = 0; i < 11; i++) {
                                                *(undefined4*)( plVar46 + ( i + 1 ) ) = 4294967295;
                                                *(undefined4*)( (long)plVar46 + ( 8*i + 12 ) ) = 4294967295;
                                             }

                                             iVar47 = *(int*)( param_1 + 0x14 );
                                             if (( (int)uVar63 < iVar47 ) && ( (int)uVar52 < *(int*)( (long)param_1 + 0xa4 ) )) {
                              ...
                              if (pbVar38 < pbVar59) {
                                 ...
                                 do {
                                    if (pbVar38 < pbVar38 + (long)iVar4 * 4) {
                                       ...
                                       pbVar33 = pbVar38;
                                       do {
                                          if (( ( ( iVar58 < iVar49 ) && ( iVar57 <= iVar41 ) ) && ( iVar48 <= iVar55 ) ) && ( ( iVar57 < iVar49 && iVar60 < (int)local_c0 && ( iVar48 < (int)local_c0 ) ) )) {
                                             if (( iVar58 < iVar57 || ( iVar60 < iVar48 || (int)local_c0 <= iVar55 ) ) || ( iVar49 <= iVar41 )) {
                                                iVar3 = 0;
                                                iVar40 = 0;
                                                uVar37 = 0;
                                                iVar50 = iVar60;
                                                do {
                                                   ...
                                                   iVar54 = iVar58;
                                                   do {
                                                      while (( ( ( iVar54 < iVar57 || ( iVar49 <= iVar54 ) ) || ( iVar50 < iVar48 ) ) || ( (int)local_c0 <= iVar50 ) )) {
                                                         iVar32 = iVar32 + 1;
                                                         iVar54 = iVar54 + 1;
...
;
 ...
 while ( iVar54 != iVar50 );
                                                ...
                                                *(int*)( param_1 + (long)iVar40 * 2 + 0x76 ) = iVar3;
                                                LAB_001011d7:pbVar33[1] = pbVar33[1] & 7 | ( byte )(uVar11 << 3);
                                             }
 else {
 ...
 while ( pbVar38 < pbVar59 );
                              ...
                              if (local_b8 == 3) {
                                 if (param_3 - 3U < 4) {
                                    ...
                                    if (( ( SUB168(auVar6 * auVar8, 8) != 0 ) || ( uVar2 = uVar37 < uVar20 ) ) || ( ( uVar2 < uVar29 || ( SUB168(auVar7 * auVar9, 8) != 0 ) ) )) goto LAB_001015f0;
                                    ...
                                    if (( lVar44 != 0 ) && ( pvVar14 != (void*)0x0 )) {
                                       ...
                                       *(uint*)( param_1 + 0x37 ) = uVar11;
                                       param_1[0x33] = uVar39;
                                       uVar39 = CONCAT44(( uint )((ulong)uVar39 >> 0x20) >> ( ( bVar10 ^ 1 ) & 1 ), (uint)uVar39 >> ( bVar23 & 1 ));
                                       param_1[0x39] = uVar39;
                                       param_1[0x36] = uVar39;
                                       ...
                                       do {
                                          ...
                                          *puVar34 = param_1[0x33];
                                          puVar34[1] = uVar39;
                                          for (int i = 0; i < 3; i++) {
                                             uVar39 = param_1[( 2*i + 54 )];
                                             puVar34[( 2*i + 2 )] = param_1[( 2*i + 53 )];
                                             puVar34[( 2*i + 3 )] = uVar39;
                                          }
 ...
 while ( piVar30 != (int*)( param_1 + 0x23 ) );
                                       ...
                                       *(undefined4*)( (long)param_1 + 0x354 ) = 0xffffffff;
                                       ...
                                       for (int i = 0; i < 3; i++) {
                                          *(undefined1(*) [16])( param_1 + ( 2*i + 108 ) ) = (undefined1[16])0;
                                       }
                                       ...
                                       if (( *param_2 < 4 ) && ( bVar64 = false * param_2 == 3 )) {
                                          bVar64 = true;
                                          if (( param_2[1] < 3 ) && ( bVar64 = param_2[1] == 2 )) {
                                             bVar64 = param_2[2] != 0;
                                          }
...
;
 ...
 while ( true );
            ...
            LAB_00101639:uVar39 = 0xffffffff;
         }

         LAB_001015f5:oc_state_frarray_clear(param_1);
      }
 else {
         uVar39 = 0xfffffff6;
      }
...
void oc_state_frag_recon_c(long param_1, long param_2, int param_3, short *param_4, int param_5, ushort param_6) {
   short *psVar1;
   byte bVar2;
   int iVar3;
   short *psVar4;
   ...
   if (param_5 < 2) {
      ...
      do {
         *(undefined4*)psVar4 = uVar9;
         for (int i = 0; i < 3; i++) {
            *(undefined4*)( psVar4 + ( 2*i + 2 ) ) = uVar9;
         }

         psVar5 = psVar4 + 0x10;
         for (int i = 0; i < 4; i++) {
            *(undefined4*)( psVar4 + ( 2*i + 8 ) ) = uVar9;
         }
...
double th_granule_time(long param_1, long param_2) {
   ...
   return ( (double)*(uint*)( param_1 + 0x20 ) / (double)*(uint*)( param_1 + 0x1c ) ) * (double)( lVar1 + 1 );
}

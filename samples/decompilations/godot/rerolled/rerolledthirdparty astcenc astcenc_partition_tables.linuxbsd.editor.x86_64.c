/* generate_one_partition_info_entry(block_size_descriptor&, unsigned int, unsigned int, unsigned
   int, partition_info&) */ulong generate_one_partition_info_entry(block_size_descriptor *param_1, uint param_2, uint param_3, uint param_4, partition_info *param_5) {
               ...
               if (*param_1 != (block_size_descriptor)0x0) {
                  do {
                     if ((byte)bVar1 < 0x20) {
                        ...
                        LAB_00100426:cVar38 = -((uVar20 & 2) != 0);
                        cVar3 = param_2 == 3;
                     }
 else {
                        uVar25 = local_84;
                     ...
                     uVar21 = ( (int)( uint )(byte)(bVar9 * bVar9) >> ( bVar23 & 0x1f ) ) * uVar31 + ( (int)( ( uVar15 & 0xf ) * ( uVar15 & 0xf ) ) >> ( bVar26 & 0x1f ) ) * uVar18 + ( (int)( uVar24 * uVar24 ) >> ( bVar2 & 0x1f ) ) * uVar25 + ( uVar15 >> 0xe ) & 0x3f;
                     uVar6 = ( (int)( uVar28 * uVar28 ) >> ( bVar23 & 0x1f ) ) * uVar31 + ( (int)( uVar27 * uVar27 ) >> ( bVar26 & 0x1f ) ) * uVar18 + ( (int)( uint )(byte)(bVar35 * bVar35) >> ( bVar2 & 0x1f ) ) * uVar25 + ( uVar15 >> 10 ) & 0x3f;
                     uVar16 = ( (int)( uVar29 * uVar29 ) >> ( bVar26 & 0x1f ) ) * uVar18 + ( (int)( uVar30 * uVar30 ) >> ( bVar23 & 0x1f ) ) * uVar31 + ( (int)( uVar34 * uVar34 ) >> ( bVar2 & 0x1f ) ) * uVar25 + ( uVar15 >> 6 ) & 0x3f;
                     if (param_2 == 4) {
                        uVar25 = ( (int)( ( uVar5 >> 0x1c ) * ( uVar5 >> 0x1c ) ) >> ( bVar23 & 0x1f ) ) * uVar31 + ( (int)( uVar17 * uVar17 ) >> ( bVar26 & 0x1f ) ) * uVar18 + ( (int)(uint)bVar10 >> ( bVar2 & 0x1f ) ) * uVar25 + ( uVar15 >> 2 ) & 0x3f;
                        LAB_0010037e:uVar31 = uVar25;
                        if (uVar25 <= uVar16) {
                           uVar31 = uVar16;
                        }
 ...
 while ( local_84 < (byte)param_1[2] );
      uVar5 = ( ( ( local_58._12_4_ & 0xff ) << 8 | local_58._8_4_ & 0xff ) << 8 | local_58._4_4_ & 0xff ) << 8 | local_58._0_4_ & 0xff;
   }
   ...
   while (true) {
      ...
      if ((int)uVar15 < (int)uVar17) {
         do {
            ppVar36[lVar7 + 0xf0] = param_5[(long)(int)( uVar15 - 1 ) + ( uVar22 & 0xffffffff ) * 0xd8 + 0xf0];
            lVar7 = lVar7 + 1;
         }
 ...
 while ( uVar17 < uVar5 );
   ...
   if (bVar1 != (block_size_descriptor)0x0) {
      do {
         ...
         bVar10 = (byte)lVar7;
         lVar7 = lVar7 + 1;
         *(ulong*)( pbVar8 + (ulong)(byte)param_5[(ulong)(byte)param_1[lVar4] + 0x10] * 8 ) = *(ulong*)( pbVar8 + (ulong)(byte)param_5[(ulong)(byte)param_1[lVar4] + 0x10] * 8 ) | 1L << ( bVar10 & 0x3f );
      }
 while ( (uint)lVar7 < uVar5 );
   }

   LAB_001005d9:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
...
/* build_partition_table_for_one_partition_count(block_size_descriptor&, bool, unsigned int,
   unsigned int, partition_info*, unsigned long*) */void build_partition_table_for_one_partition_count(block_size_descriptor *param_1, bool param_2, uint param_3, uint param_4, partition_info *param_5, ulong *param_6) {
   uint uVar1;
   ...
   *(undefined4*)( param_1 + (ulong)uVar1 * 4 + 0x30 ) = 0;
   if (( param_3 < param_4 ) && ( param_2 )) {
      LAB_00100783:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
            ...
            *pauVar2 = (undefined1[16])0x0;
            ...
            if (bVar4 != (block_size_descriptor)0x0) {
               do {
                  ...
                  uVar11 = uVar10 + 1;
                  *(ulong*)( *pauVar2 + ( uVar10 >> 5 & 0x7ffffff ) * 8 ) = *(ulong*)( *pauVar2 + ( uVar10 >> 5 & 0x7ffffff ) * 8 ) | (long)iVar6 << ( (byte)uVar10 & 0x1f ) * '\x02';
                  uVar10 = uVar11;
               }
 while ( (uint)uVar11 < (uint)(byte)bVar4 );
            ...
            if (iVar5 != 0) {
               ...
               do {
                  ...
                  if (( ( ( *(ulong*)*pauVar2 == *puVar3 ) && ( *(ulong*)( *pauVar2 + 8 ) == puVar3[1] ) ) && ( *(ulong*)pauVar2[1] == puVar3[2] ) ) && ( ( ( *(ulong*)( pauVar2[1] + 8 ) == puVar3[3] && ( *(ulong*)pauVar2[2] == puVar3[4] ) ) && ( ( *(ulong*)( pauVar2[2] + 8 ) == puVar3[5] && ( *(ulong*)pauVar2[3] == puVar3[6] ) ) ) ) )) goto LAB_00100928;
                  uVar8 = uVar8 + 7;
               }
 while ( iVar5 * 7 != uVar8 );
            }
            ...
            if (cVar7 == '\0') {
               LAB_00100928:if (local_460 == 1) {
                  *(short*)( param_1 + uVar12 * 2 + ( ulong )(param_4 - 2) * 0x800 + 0xe079b0 ) = (short)uVar16;
                  uVar16 = ( ulong )(iVar5 + 1);
                  *(int*)( param_1 + (ulong)uVar1 * 4 + 0x30 ) = *(int*)( param_1 + (ulong)uVar1 * 4 + 0x30 ) + 1;
                  break;
               }
               ...
               *(short*)( param_1 + uVar12 * 2 + ( ulong )(param_4 - 2) * 0x800 + 0xe079b0 ) = (short)uVar16;
               uVar16 = ( ulong )(iVar5 + 1);
               *(int*)( param_1 + (ulong)uVar1 * 4 + 0x20 ) = *(int*)( param_1 + (ulong)uVar1 * 4 + 0x20 ) + 1;
               *(int*)( param_1 + (ulong)uVar1 * 4 + 0x30 ) = *(int*)( param_1 + (ulong)uVar1 * 4 + 0x30 ) + 1;
            ...
            LAB_00100942:ppVar15 = param_5 + local_488 * 0x450;
            while (cVar7 = generate_one_partition_info_entry(param_1, param_4, (uint)uVar10, (uint)uVar16, ppVar15),cVar7 == '\0') {
               uVar12 = uVar12 + 1;
               if (uVar12 == 0x400) goto LAB_00100980;
               uVar10 = uVar12 & 0xffffffff;
            }
;
 ...
 while ( true );
   LAB_00100980:local_460 = local_460 + 1;
   if (local_460 == 2 - (uint)param_2) goto LAB_00100783;
   goto LAB_001007ee;
}
/* init_partition_tables(block_size_descriptor&, bool, unsigned int) */void init_partition_tables(block_size_descriptor *param_1, bool param_2, uint param_3) {
   ulong *puVar1;
   ...
   *(undefined4*)( param_1 + 0x30 ) = 1;
   ...
   for (int i = 0; i < 3; i++) {
      build_partition_table_for_one_partition_count(param_1, param_2, param_3, ( i + 2 ), (partition_info*)( param_1 + ( 1130496*i + 11318624 ) ), puVar1);
   }

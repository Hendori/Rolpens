/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* basisu::calc_mean(unsigned int, basisu::vec<4u, float> const*) */void basisu::calc_mean(basisu *this, uint param_1, vec *param_2) {
   undefined8 uVar1;
   vec *pvVar2;
   ulong uVar3;
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* void std::__adjust_heap<unsigned int*, long, unsigned int,
   __gnu_cxx::__ops::_Iter_less_iter>(unsigned int*, long, long, unsigned int,
   __gnu_cxx::__ops::_Iter_less_iter) [clone .isra.0] */void std::__adjust_heap<unsigned_int*,long,unsigned_int,__gnu_cxx::__ops::_Iter_less_iter>(long param_1, long param_2, ulong param_3, uint param_4) {
   uint *puVar1;
   long lVar2;
   uint *puVar3;
   long lVar4;
 ...
 while ( lVar2 < lVar7 );
      ...
      LAB_00100140:if (lVar2 == (long)( param_3 - 2 ) / 2) {
         lVar6 = lVar2 * 2;
         lVar2 = lVar6 + 1;
...
;
   ...
   LAB_00100121:*puVar3 = param_4;
   return;
}
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* void std::__insertion_sort<unsigned int*, __gnu_cxx::__ops::_Iter_less_iter>(unsigned int*,
   unsigned int*, __gnu_cxx::__ops::_Iter_less_iter) [clone .isra.0] */void std::__insertion_sort<unsigned_int*,__gnu_cxx::__ops::_Iter_less_iter>(uint *param_1, uint *param_2) {
   uint uVar1;
   uint uVar2;
   size_t __n;
   uint *puVar3;
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* void std::__introsort_loop<unsigned int*, long, __gnu_cxx::__ops::_Iter_less_iter>(unsigned int*,
   unsigned int*, long, __gnu_cxx::__ops::_Iter_less_iter) [clone .isra.0] */void std::__introsort_loop<unsigned_int*,long,__gnu_cxx::__ops::_Iter_less_iter>(ulong *param_1, uint *param_2, long param_3) {
   uint *puVar1;
   uint *puVar2;
   uint uVar3;
   uint uVar4;
   ...
   if (0x40 < lVar5) {
      ...
      if (param_3 != 0) {
         do {
            ...
            if (uVar11 < uVar4) {
               if (uVar4 < uVar3) {
                  LAB_00100357:*(uint*)param_1 = uVar4;
                  *puVar1 = uVar10;
                  ...
                  LAB_00100313:*(uint*)param_1 = uVar3;
                  puVar8[-1] = uVar10;
                  uVar11 = ( uint ) * param_1;
                  uVar7 = ( ulong ) * (uint*)( (long)param_1 + 4 );
               }
               ...
               LAB_001002bb:*param_1 = CONCAT44(uVar10, uVar11);
               uVar10 = puVar8[-1];
            }
...
;
            __introsort_loop<unsigned_int*,long,__gnu_cxx::__ops::_Iter_less_iter>(param_2, puVar8, param_3);
            lVar5 = (long)param_2 - (long)param_1;
            if (lVar5 < 0x41) {
               return;
            }
 ...
 while ( param_3 != 0 );
      ...
      for (lVar9 = ( lVar5 >> 2 ) + -2 >> 1; __adjust_heap<unsigned_int*,long,unsigned_int,__gnu_cxx::__ops::_Iter_less_iter>(param_1, lVar9, lVar5 >> 2, *(undefined4*)( (long)param_1 + lVar9 * 4 )),lVar9 != 0; lVar9 = lVar9 + -1) {}
      do {
         param_2 = param_2 + -1;
         uVar3 = *param_2;
         *param_2 = ( uint ) * param_1;
         __adjust_heap<unsigned_int*,long,unsigned_int,__gnu_cxx::__ops::_Iter_less_iter>(param_1, 0, (long)param_2 - (long)param_1 >> 2, uVar3);
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* basisu::astc_hdr_codec_options::astc_hdr_codec_options() */void basisu::astc_hdr_codec_options::astc_hdr_codec_options(astc_hdr_codec_options *this) {
   undefined8 uVar1;
   uVar1 = __LC3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* basisu::astc_hdr_codec_options::init() */void basisu::astc_hdr_codec_options::init(astc_hdr_codec_options *this) {
   undefined8 uVar1;
   uVar1 = __LC3;
   *(undefined4*)this = 0x3f59999a;
   this[0x60] = (astc_hdr_codec_options)0x0;
...
/* basisu::astc_hdr_codec_options::set_quality_best() */void basisu::astc_hdr_codec_options::set_quality_best(astc_hdr_codec_options *this) {
   undefined8 uVar1;
   undefined8 uVar2;
   uVar1 = _LC5;
   this[0x10] = (astc_hdr_codec_options)0x0;
...
/* basisu::astc_hdr_codec_options::set_quality_normal() */void basisu::astc_hdr_codec_options::set_quality_normal(astc_hdr_codec_options *this) {
   undefined8 uVar1;
   this[6] = (astc_hdr_codec_options)0x1;
   *(undefined2*)( this + 4 ) = 0x101;
   uVar1 = _LC12;
...
/* basisu::astc_hdr_codec_options::set_quality_fastest() */void basisu::astc_hdr_codec_options::set_quality_fastest(astc_hdr_codec_options *this) {
   undefined8 uVar1;
...
/* basisu::astc_hdr_codec_options::set_quality_level(int) */void basisu::astc_hdr_codec_options::set_quality_level(astc_hdr_codec_options *this, int param_1) {
   undefined8 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
...
/* basisu::interpolate_qlog12_colors(int const (*) [3], unsigned short*, basisu::vec<3u, float>*,
   unsigned int, unsigned int) */void basisu::interpolate_qlog12_colors(int *param_1, ushort *param_2, vec *param_3, uint param_4, uint param_5) {
   byte bVar1;
   int iVar2;
   int iVar3;
   int iVar4;
 ...
 while ( ( uVar18 & 0x400 ) == 0 );
               ...
               LAB_001009c5:uVar14 = ( uVar14 + 0x70 ) * 0x800000 | uVar18 << 0xd;
            }
 ...
 while ( ( uVar10 & 0x400 ) == 0 );
               ...
               LAB_00100a0d:uVar18 = ( uVar18 + 0x70 ) * 0x800000 | uVar10 << 0xd;
            }
 ...
 while ( ( uVar10 & 0x400 ) == 0 );
               uVar10 = uVar10 & 0xfffffbff;
               LAB_00100a4f:uVar13 = ( uVar13 + 0x70 ) * 0x800000 | uVar10 << 0xd;
            }
...
/* basisu::get_astc_hdr_mode_11_block_colors(unsigned char const*, unsigned short*, basisu::vec<3u,
   float>*, unsigned int, unsigned int, unsigned int) */undefined4 basisu::get_astc_hdr_mode_11_block_colors(uchar *param_1, ushort *param_2, vec *param_3, uint param_4, uint param_5, uint param_6) {
   undefined4 uVar1;
   long in_FS_OFFSET;
   int aiStack_58[6];
   long local_40;
...
/* basisu::get_astc_hdr_mode_7_block_colors(unsigned char const*, unsigned short*, basisu::vec<3u,
   float>*, unsigned int, unsigned int, unsigned int) */undefined4 basisu::get_astc_hdr_mode_7_block_colors(uchar *param_1, ushort *param_2, vec *param_3, uint param_4, uint param_5, uint param_6) {
   undefined4 uVar1;
   long in_FS_OFFSET;
   int aiStack_58[6];
   long local_40;
...
/* basisu::eval_selectors(unsigned int, unsigned char*, unsigned short const*, unsigned int,
   unsigned short const*, basisu::astc_hdr_codec_options const&, unsigned int) */double basisu::eval_selectors(uint param_1, uchar *param_2, ushort *param_3, uint param_4, ushort *param_5, astc_hdr_codec_options *param_6, uint param_7) {
   byte *pbVar1;
   ushort *puVar2;
   float fVar3;
   float fVar4;
...
;
      ...
      do {
         iVar9 = (int)uVar10;
         if (( ( 1 << ( (byte)uVar8 & 0x1f ) & param_7 ) != 0 ) && ( dVar12 = (double)( uint )((float)( (uint)param_5[uVar10] << 0xd ) * fVar6 + fVar7) - (double)( uint )((float)( ( uint ) * puVar2 << 0xd ) * fVar6 + fVar7) ),dVar16 = (double)( uint )((float)( (uint)param_5[iVar9 + 1] << 0xd ) * fVar6 + fVar7) - (double)( uint )((float)( (uint)puVar2[1] << 0xd ) * fVar6 + fVar7),dVar13 = (double)( uint )((float)( (uint)param_5[iVar9 + 2] << 0xd ) * fVar6 + fVar7) - (double)( uint )((float)( (uint)puVar2[2] << 0xd ) * fVar6 + fVar7),dVar12 = dVar12 * dVar12 * (double)fVar3 + dVar16 * dVar16 * (double)fVar4 + dVar13 * dVar13,dVar12 < dVar14) {
            *param_2 = (byte)uVar8;
            dVar14 = dVar12;
         }
...
/* basisu::try_mode7(unsigned int, unsigned char*, unsigned char*, double&, unsigned int&,
   ...
   basisu::astc_hdr_codec_options const&, unsigned int) */char basisu::try_mode7(uint param_1, uchar *param_2, uchar *param_3, double *param_4, uint *param_5, vec *param_6, float param_7, unsigned_short *param_8, uint param_9, uint param_10, astc_hdr_codec_options *param_11, uint param_12) {
   bool bVar1;
   bool bVar2;
   char cVar3;
   int iVar4;
   ...
   local_261 = '\0';
   do {
      bVar25 = ( &pack_astc_mode7_submode(unsigned_int,unsigned_char*,basisu::vec<int,float>const&,float,int&,unsigned_int)::s_r_bits )[uVar26];
      ...
      do {
         ...
         if (lVar6 != 0) {
            local_238[lVar6] = ( uint )(byte)(&pack_astc_mode7_submode(unsigned_int, unsigned_char * basisu::vec<int,float>, const&,float,int&, unsigned_int), ::s_g_b_bits)[uVar26];
         }
 ...
 while ( lVar7 != 3 );
      local_238[3] = ( uint )(byte)(&pack_astc_mode7_submode(unsigned_int, unsigned_char * basisu::vec<int,float>, const&,float,int&, unsigned_int), ::s_s_bits)[uVar26];
      ...
      if (uVar26 == 5) {
         ...
         bVar2 = false;
         uVar24 = local_248;
         switchD_00101170_caseD_5:bVar8 = 0x80;
         bVar14 = 0x80;
      ...
      if ((int)uVar5 < (int)(uint)local_244) {
         ...
         LAB_001010b0:( &local_248 )[uVar23] = local_248;
      }
 else {
 ...
 while ( lVar6 != 0x10 );
      ...
      if ((uint)uVar26 < 6) {
        ...
        goto switchD_00101170_caseD_5;
         ...
         switchD_00101170_caseD_0:uVar16 = (int)uVar24 >> 10 & 1;
         uVar18 = uVar15 & 1;
         uVar11 = uVar11 & 1;
         uVar12 = uVar12 & 1;
         uVar5 = uVar5 & 1;
      ...
      LAB_00101200:local_60 = CONCAT13(( byte )(uVar13 << 5) | ( byte )(uVar5 << 7) | ( byte )(uVar19 << 6) | local_288, CONCAT12(bVar8 | local_28c | ( byte )(uVar12 << 6) | ( byte )(uVar16 << 5), CONCAT11(bVar14 | local_290 | ( byte )(uVar18 << 6) | ( byte )(uVar11 << 5), bVar17 | bVar20 | bVar25)));
      if (!bVar1) {
         if (param_12 == 0x14) {
            local_5c = local_60;
         }
 ...
 while ( lVar7 != 4 );
         ...
         cVar3 = basist::decode_mode7_to_qlog12((uchar*)&local_5c, (int*)local_238, (int*)0x0, param_12);
         if (cVar3 != '\0') {
            interpolate_qlog12_colors((int*)local_238, local_218, local_188, param_9, param_10);
            dVar28 = (double)eval_selectors(param_1, local_58, (ushort*)param_8, param_9, local_218, param_11, 0xffffffff);
            if (dVar28 < *param_4) {
               *param_4 = dVar28;
...
/* WARNING: Type propagation algorithm not settling *//* basisu::try_mode11(unsigned int, unsigned char*, unsigned char*, double&, unsigned int&,
   basisu::vec<3u, float>&, basisu::vec<3u, float> const&, unsigned short (*) [3], unsigned int,
   unsigned int, basisu::astc_hdr_codec_options const&, bool, unsigned int, bool, int, int) */ulong basisu::try_mode11(uint param_1, uchar *param_2, uchar *param_3, double *param_4, uint *param_5, vec *param_6, vec *param_7, unsigned_short *param_8, uint param_9, uint param_10, astc_hdr_codec_options *param_11, bool param_12, uint param_13, bool param_14, int param_15, int param_16) {
   int iVar1;
   float fVar2;
   undefined *puVar3;
   bool bVar4;
   ...
   if (param_12) {
      ...
      local_301 = 0;
      LAB_00102038:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
   ...
   local_301 = 0;
   LAB_00101710:if (param_16 == 0xffffffff) {
      lVar33 = 0;
      do {
         ...
         if (( uVar16 & 0x600 ) == 0) {
            iVar13 = uVar15 * 3;
            LAB_001023c7:uVar23 = ( ulong )(uint)(( (int)uVar16 >> 0xb ) * 0x400 + ( iVar13 >> 3 ));
            if (lVar33 == 2) goto LAB_00102465;
            LAB_001023d9:uVar10 = *(ushort*)( g_half_to_qlog8 + uVar17 * 2 );
            if (0xf7 < uVar10) {
               uVar10 = 0xf7;
            }
            ...
            LAB_00102465:uVar11 = ( &g_half_to_qlog7 )[uVar17];
            if (0x7b < uVar11) {
               uVar11 = 0x7b;
            }
 ...
 while ( true );
   ...
   do {
      ...
      uVar10 = *(ushort*)( puVar3 + (long)(int)( ( (int)uVar15 >> 0xb & 0x1fU ) * 0x400 + ( iVar24 >> 3 ) ) * 2 );
      *puVar35 = (uint)uVar10;
      fVar38 = roundf(fVar37);
      ...
      uVar21 = *(ushort*)( puVar3 + (long)(int)( ( (int)uVar15 >> 0xb & 0x1fU ) * 0x400 + ( iVar24 >> 3 ) ) * 2 );
      uVar15 = (uint)uVar21;
 ...
 while ( (uint*)( local_2e8 + 0xc ) != puVar36 );
   ...
   if ((int)uVar14 < (int)(uint)local_2d8) {
      ...
      LAB_0010198a:local_2e8._0_4_ = uVar15;
   ...
   while (true) {
      ...
      uVar30 = ( uVar30 - local_2d8._4_4_ ) * ( uVar30 - local_2d8._4_4_ ) + ( uVar19 - (uint)local_2d8 ) * ( uVar19 - (uint)local_2d8 ) + uVar31 + ( uVar27 - uVar5 ) * ( uVar27 - uVar5 ) + ( uVar22 - uVar25 ) * ( uVar22 - uVar25 ) + ( uVar32 - local_2e8._8_4_ ) * ( uVar32 - local_2e8._8_4_ );
      if (uVar30 < local_370) {
         local_370 = uVar30;
      }
...
;
   ...
   uVar17 = ( *(code*)( &DAT_0018a1b8 + *(int*)( &DAT_0018a1b8 + uVar17 * 4 ) ) )(uVar31, uVar22, &DAT_0018a1b8 + *(int*)( &DAT_0018a1b8 + uVar17 * 4 ));
   return uVar17;
   LAB_00102491:uStack_78 = CONCAT11((char)uVar21, (char)uVar11) | 0x8080;
   if (param_13 == 0x14) {
      uStack_76 = uStack_7c;
      uStack_72 = uStack_78;
   }
      ...
      lVar28 = 0;
      do {
         *(undefined1*)( (long)&uStack_76 + lVar28 ) = *(undefined1*)( lVar33 + ( ulong ) * (byte*)( (long)&uStack_7c + lVar28 ) );
         lVar28 = lVar28 + 1;
      }
 while ( lVar28 != 6 );
   }
   ...
   if (bVar9 != 0) {
      ...
      dVar39 = (double)eval_selectors(param_1, local_70 + 0x18, (ushort*)param_8, param_9, auStack_2c8, param_11, -(uint)(param_10 != 8 || !param_14) | 0xcc33);
      if (dVar39 < *param_4) {
         *param_4 = dVar39;
...
ulong FUN_00101e68(void) {
   ...
   uVar12 = ( ( ( ( uVar31 & 4 ) << 5 | uStack0000000000000040 & 0x3f | unaff_R13D ) << 8 | ( uVar31 & 2 ) << 6 | uStack000000000000003c & 0x3f | in_R10D ) << 8 | uStack0000000000000030 >> 2 & 0x40 | ( uVar31 & 1 ) << 7 | uStack0000000000000044 & 0x3f ) << 8 | uStack0000000000000030 & 0xff;
   uVar37 = CONCAT11(bStack0000000000000038 & 0x1f | in_stack_00000070 | unaff_BL | in_R11B, bStack0000000000000034 & 0x1f | in_R9B | in_R8B | unaff_BPL);
   ...
   LAB_00101f29:lVar29 = *(long*)( ( ulong )(in_stack_000003f0 - 4) * 0x40 + 0x18c328 );
   lVar14 = 0;
   do {
 ...
 while ( lVar14 != 6 );
   LAB_00101f75:in_stack_00000346 = uVar37;
   in_stack_00000342 = uVar31;
   uVar31 = (uint)unaff_R15;
   bVar9 = basist::decode_mode11_to_qlog12(&stack0x00000342, (int*)in_stack_00000068, in_stack_000003f0);
   if (bVar9 != 0) {
      basisu::interpolate_qlog12_colors((int*)in_stack_00000068, (ushort*)&stack0x000000f0, (vec*)&stack0x000001b0, in_stack_000003d0, in_stack_000003d8);
      dVar35 = (double)basisu::eval_selectors(in_stack_00000090._4_4_, &stack0x00000360, in_stack_000000a0, in_stack_000003d0, (ushort*)&stack0x000000f0, in_stack_000000a8, uStack00000000000000b0);
   ...
   LAB_00102026:uVar31 = uVar31 - 1;
   unaff_R15 = (ulong)uVar31;
   if ((int)uVar31 < in_stack_00000400) {
      LAB_00102038:if (in_stack_00000378 == *(long*)( in_FS_OFFSET + 0x28 )) {
   ...
   if (uVar31 == 0xffffffff) {
      ...
      do {
         ...
         if (( uVar31 & 0x600 ) == 0) {
            iVar15 = uVar20 * 3;
            LAB_001023c7:uVar21 = ( ulong )(uint)(( (int)uVar31 >> 0xb ) * 0x400 + ( iVar15 >> 3 ));
            if (lVar29 != 2) goto LAB_001023d9;
            LAB_00102465:uVar37 = ( &basisu::g_half_to_qlog7 )[uVar13];
            if (0x7b < uVar37) {
               uVar37 = 0x7b;
            }
            ...
            LAB_001023d9:uVar10 = *(ushort*)( basisu::g_half_to_qlog8 + uVar13 * 2 );
            if (0xf7 < uVar10) {
               uVar10 = 0xf7;
            }
 ...
 while ( true );
   ...
   do {
      ...
      uVar37 = *(ushort*)( puVar3 + (long)(int)( ( (int)uVar12 >> 0xb & 0x1fU ) * 0x400 + ( iVar22 >> 3 ) ) * 2 );
      *in_stack_00000068 = (uint)uVar37;
      ...
      uVar10 = *(ushort*)( puVar3 + (long)(int)( ( (int)uVar25 >> 0xb & 0x1fU ) * 0x400 + ( iVar22 >> 3 ) ) * 2 );
      uVar25 = (uint)uVar10;
 ...
 while ( (uint*)( (long)&stack0x000000d0 + 0xc ) != puVar32 );
   ...
   if ((int)uStack0000000000000064 < (int)uStack00000000000000e0) {
      ...
      LAB_0010198a:uStack00000000000000d0 = uVar20;
      ...
      *(uint*)( (long)&stack0x000000d0 + lVar14 * 4 + 0xc ) = uVar17;
      ...
      uStack000000000000002c = *(uint*)( (long)&stack0x000000d0 + ( (long)(int)( uVar26 ^ 1 ) * 3 + lVar29 ) * 4 );
   ...
   while (true) {
      ...
      uVar28 = ( uStack000000000000004c - uStack00000000000000e4 ) * ( uStack000000000000004c - uStack00000000000000e4 ) + ( uVar16 - uStack00000000000000e0 ) * ( uVar16 - uStack00000000000000e0 ) + uVar26 + ( uVar19 - uVar5 ) * ( uVar19 - uVar5 ) + ( uVar28 - uVar23 ) * ( uVar28 - uVar23 ) + ( uVar30 - uStack00000000000000d8 ) * ( uVar30 - uStack00000000000000d8 );
...
;
   if (uVar31 < 8) {
      /* WARNING: Could not recover jumptable at 0x00101e20. Too many branches */
      /* WARNING: Treating indirect jump as call */
      uVar13 = ( *(code*)( &DAT_0018a1b8 + *(int*)( &DAT_0018a1b8 + unaff_R15 * 4 ) ) )(uVar26, uVar28, &DAT_0018a1b8 + *(int*)( &DAT_0018a1b8 + unaff_R15 * 4 ));
      return uVar13;
   }

   uVar13 = FUN_00101e68();
   return uVar13;
   LAB_00102491:uVar37 = CONCAT11((char)uVar18, (char)uVar37) | 0x8080;
   LAB_001024a4:cStack00000000000000b6 = '\0';
   uVar31 = uVar12;
   if (in_stack_000003f0 != 0x14) goto LAB_00101f29;
   goto LAB_00101f75;
}
/* basisu::compute_block_error(unsigned short const*, unsigned short const*,
   basisu::astc_hdr_codec_options const&) */double basisu::compute_block_error(ushort *param_1, ushort *param_2, astc_hdr_codec_options *param_3) {
   ushort *puVar1;
   ushort *puVar2;
   double dVar3;
   double dVar4;
   ...
   do {
      puVar2 = puVar1 + 3;
      dVar3 = (double)( uint )((float)( ( uint ) * puVar1 << 0xd ) * _LC19 + _LC20) - (double)( uint )((float)( ( uint ) * param_2 << 0xd ) * _LC19 + _LC20);
      dVar6 = (double)( uint )((float)( (uint)puVar1[1] << 0xd ) * _LC19 + _LC20) - (double)( uint )((float)( (uint)param_2[1] << 0xd ) * _LC19 + _LC20);
      dVar4 = (double)( uint )((float)( (uint)puVar1[2] << 0xd ) * _LC19 + _LC20) - (double)( uint )((float)( (uint)param_2[2] << 0xd ) * _LC19 + _LC20);
      dVar5 = dVar5 + dVar3 * dVar3 * (double)*(float*)( param_3 + 0x48 ) + dVar6 * dVar6 * (double)*(float*)( param_3 + 0x4c ) + dVar4 * dVar4;
      param_2 = param_2 + 3;
      puVar1 = puVar2;
   }
...
/* basisu::astc_hdr_refine_weights(unsigned short const*, basisu::astc_hdr_pack_results&,
   basisu::astc_hdr_codec_options const&, float, bool*) [clone .part.0] */void basisu::astc_hdr_refine_weights(ushort *param_1, astc_hdr_pack_results *param_2, astc_hdr_codec_options *param_3, float param_4, bool *param_5) {
   int iVar1;
   undefined4 uVar2;
   byte bVar3;
   ulong uVar4;
   ...
   local_1b8 = _LC18;
   dStack_1b0 = _LC18;
   iVar1 = *(char*)( (long)&astc_helpers::g_ise_range_table + lVar17 + 2 ) * 4 + 1 + *(char*)( (long)&astc_helpers::g_ise_range_table + lVar17 + 1 ) * 2;
   local_1a8 = _LC18;
   dStack_1a0 = _LC18;
         ...
         do {
            ...
            do {
               ...
               do {
                  ...
                  dVar27 = (double)( uint )((float)( ( uint ) * (ushort*)( lVar12 + lVar8 ) << 0xd ) * _LC19 + _LC20);
                  ...
                  dVar25 = dVar25 + dVar19 * dVar19 * dVar26 * (double)( _LC23 - param_4 ) + dVar27 * dVar27 * dVar26 * (double)param_4;
               }
 while ( lVar8 != 6 );
               if (dVar25 < *pdVar13) {
                  *puVar15 = uVar22;
 ...
 while ( iVar14 != iVar1 << bVar3 );
   ...
   uVar4 = 0;
   while (param_2[uVar4 + 0x4c] == *(astc_hdr_pack_results*)( local_298 + ( ulong )((uint)uVar4 & 3) + ( ulong )(uint)((int)( uVar4 >> 2 ) * 4) )) {
      uVar4 = uVar4 + 1;
...
;
   ...
   *(undefined8*)( param_2 + 0x54 ) = local_298._8_8_;
   basist::astc_hdr_transcode_to_bc6h((log_astc_block*)( param_2 + 0x10 ), (bc6h_block*)( param_2 + 0xbe ));
   ...
   do {
      ...
      do {
         ...
         *(undefined4*)puVar9 = *(undefined4*)puVar6;
         ...
         auVar21._4_4_ = (int)( CONCAT26((short)( (uint)uVar2 >> 0x10 ), CONCAT24((short)( (uint)uVar23 >> 0x10 ), uVar23)) >> 0x20 );
         auVar21._8_8_ = 0;
 ...
 while ( puVar5 != &local_118 );
   ...
   *(undefined8*)param_2 = uVar20;
   ...
   LAB_00102c2d:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* basisu::astc_hdr_enc_init() */void basisu::astc_hdr_enc_init(void) {
   uint *puVar1;
   byte bVar2;
   float fVar3;
   uint uVar4;
   ...
   if (g_astc_hdr_enc_initialized == '\0') {
      ...
      local_d8 = (void*)0x0;
      local_d0 = 0;
      basisu::elemental_vector::increase_capacity(( uint ) & local_d8, false, 0, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
      memset((void*)( (long)local_d8 + ( local_d0 & 0xffffffff ) * 4 ), 0, ( ulong )(0x10000 - (int)local_d0) << 2);
      uVar16 = 0;
      do {
 ...
 while ( ( uVar12 & 0x400 ) == 0 );
               ...
               LAB_00102e4d:uVar15 = ( uVar15 + 0x70 ) * 0x800000 | uVar12 << 0xd;
            }
 ...
 while ( ( uVar6 & 0x400 ) == 0 );
                     ...
                     LAB_00102ee7:fVar14 = (float)( ( uVar15 + 0x70 ) * 0x800000 | uVar6 << 0xd );
                  }
               ...
               do {
                  ...
                  if (( !NAN(fVar26) ) && ( fVar26 = fVar26 < fVar27 )) {
                     fVar27 = fVar26;
                     iVar13 = iVar7;
                  }
 ...
 while ( (uint)lVar9 < uVar12 );
            ...
            std::__introsort_loop<unsigned_int*,long,__gnu_cxx::__ops::_Iter_less_iter>(local_c8, puVar1, (long)(int)lVar9 * 2);
            if (uVar10 < 0x41) {
               std::__insertion_sort<unsigned_int*,__gnu_cxx::__ops::_Iter_less_iter>(local_c8, puVar1);
            }
 else {
               std::__insertion_sort<unsigned_int*,__gnu_cxx::__ops::_Iter_less_iter>(local_c8, auStack_88);
               puVar19 = auStack_88;
               do {
                  while (true) {
                     uVar6 = *puVar19;
...
/* basisu::astc_hdr_refine_weights(unsigned short const*, basisu::astc_hdr_pack_results&,
   basisu::astc_hdr_codec_options const&, float, bool*) */undefined8 basisu::astc_hdr_refine_weights(ushort *param_1, astc_hdr_pack_results *param_2, astc_hdr_codec_options *param_3, float param_4, bool *param_5) {
   if (param_5 != (bool*)0x0) {
      *param_5 = false;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* basisu::astc_hdr_block_stats::update(basisu::astc_hdr_pack_results const&) */undefined8 *basisu::astc_hdr_block_stats::update(astc_hdr_pack_results *param_1) {
   ray *prVar1;
   float fVar2;
   uint uVar3;
   int iVar4;
      ...
      *(int*)( param_1 + 0x28 ) = *(int*)( param_1 + 0x28 ) + 1;
      ...
      if (*(char*)( (long)in_RSI + 0xce ) == '\0') {
         ...
         if (*(int*)( (long)in_RSI + 0x3c ) != 7) {
            *(int*)( param_1 + ( ulong ) * (uint*)( in_RSI + 0x14 ) * 4 + 0x110 ) = *(int*)( param_1 + ( ulong ) * (uint*)( in_RSI + 0x14 ) * 4 + 0x110 ) + 1;
            ...
            *(int*)( param_1 + ( ulong ) * (uint*)( (long)in_RSI + 0xa4 ) * 4 + 0x110 ) = *(int*)( param_1 + ( ulong ) * (uint*)( (long)in_RSI + 0xa4 ) * 4 + 0x110 ) + 1;
            *(int*)( param_1 + 0x2c ) = *(int*)( param_1 + 0x2c ) + 1;
            *(int*)( param_1 + lVar5 * 4 + 0xe4 ) = *(int*)( param_1 + lVar5 * 4 + 0xe4 ) + 1;
            *(int*)( param_1 + ( ulong ) * (uint*)( in_RSI + 0x15 ) * 4 + 0x134 ) = *(int*)( param_1 + ( ulong ) * (uint*)( in_RSI + 0x15 ) * 4 + 0x134 ) + 1;
            uVar3 = pthread_mutex_unlock((pthread_mutex_t*)param_1);
            return (undefined8*)(ulong)uVar3;
         }

         *(int*)( param_1 + ( ulong ) * (uint*)( in_RSI + 0x14 ) * 4 + 0xa0 ) = *(int*)( param_1 + ( ulong ) * (uint*)( in_RSI + 0x14 ) * 4 + 0xa0 ) + 1;
         ...
         *(int*)( param_1 + ( ulong ) * (uint*)( (long)in_RSI + 0xa4 ) * 4 + 0xa0 ) = *(int*)( param_1 + ( ulong ) * (uint*)( (long)in_RSI + 0xa4 ) * 4 + 0xa0 ) + 1;
         *(int*)( param_1 + 0x2c ) = *(int*)( param_1 + 0x2c ) + 1;
   ...
   if (uVar3 == 0) {
      if (__mutex[1].__data.__lock != 0) {
         ...
         __printf_chk((double)( ( (float)*(uint*)( (long)__mutex + 0x30 ) * __LC30 ) / (float)(uint)__mutex[1].__data.__lock ), 2, "Total solid: %u %3.2f%%\n", *(uint*)( (long)__mutex + 0x30 ));
         paStack_38 = (astc_hdr_pack_results*)0x103486;
         __printf_chk((double)( ( (float)*(uint*)( (long)__mutex + 0x1b4 ) * __LC30 ) / (float)(uint)__mutex[1].__data.__lock ), 2, "Total refined: %u %3.2f%%\n", *(uint*)( (long)__mutex + 0x1b4 ));
         paStack_38 = (astc_hdr_pack_results*)0x1034c7;
         __printf_chk((double)( ( (float)*(uint*)( (long)__mutex + 0x3c ) * __LC30 ) / (float)(uint)__mutex[1].__data.__lock ), 2, "Total mode 11, 1 partition: %u %3.2f%%\n", *(uint*)( (long)__mutex + 0x3c ));
         paStack_38 = (astc_hdr_pack_results*)0x103508;
         __printf_chk((double)( ( (float)*(uint*)( (long)__mutex + 0x44 ) * __LC30 ) / (float)(uint)__mutex[1].__data.__lock ), 2, "Total mode 11, 1 partition, constrained weights: %u %3.2f%%\n", *(uint*)( (long)__mutex + 0x44 ));
         paStack_38 = (astc_hdr_pack_results*)0x103549;
         __printf_chk((double)( ( (float)*(uint*)( (long)__mutex + 0x40 ) * __LC30 ) / (float)(uint)__mutex[1].__data.__lock ), 2, "Total mode 11, 2 partition: %u %3.2f%%\n", *(uint*)( (long)__mutex + 0x40 ));
         paStack_38 = (astc_hdr_pack_results*)0x10358a;
         __printf_chk((double)( ( (float)*(uint*)( (long)__mutex + 0x34 ) * __LC30 ) / (float)(uint)__mutex[1].__data.__lock ), 2, "Total mode 7, 1 partition: %u %3.2f%%\n", *(uint*)( (long)__mutex + 0x34 ));
         paStack_38 = (astc_hdr_pack_results*)0x1035cb;
         __printf_chk((double)( ( (float)*(uint*)( (long)__mutex + 0x38 ) * __LC30 ) / (float)(uint)__mutex[1].__data.__lock ), 2, "Total mode 7, 2 partition: %u %3.2f%%\n", *(uint*)( (long)__mutex + 0x38 ));
         paStack_38 = (astc_hdr_pack_results*)0x10360c;
         __printf_chk((double)( ( (float)*(uint*)( (long)__mutex + 0x2c ) * __LC30 ) / (float)(uint)__mutex[1].__data.__lock ), 2, "Total 2 partitions: %u %3.2f%%\n", *(uint*)( (long)__mutex + 0x2c ));
 ...
 while ( uVar7 != 0x1e );
   ...
   uVar12 = CONCAT44((float)( ( ulong ) * extraout_RDX >> 0x20 ) * fVar10 + (float)( ( ulong ) * puVar8 >> 0x20 ), fVar11);
   uStack_78 = uVar12;
   fStack_70 = fVar16;
   while (( fVar2 = *(float*)( (long)&uStack_78 + lVar5 ) ),paStack_38 = param_1,*(float*)( in_RCX + lVar5 ) <= fVar2 && ( prVar1 = (ray*)&uStack_58 + lVar5 ),fVar2 < *(float*)prVar1 || fVar2 == *(float*)prVar1) {
      lVar5 = lVar5 + 4;
      if (lVar5 == 0xc) {
         if (in_R9 != (undefined1*)0x0) {
            *in_R9 = 1;
...
;
   ...
   fStack_7c = 0.0;
   uStack_58 = CONCAT44(*(float*)( (long)extraout_RDX + 4 ) * fVar10 + *(float*)( (long)puVar8 + 4 ), fVar11);
   fStack_50 = fVar16;
   iVar4 = intersection::ray_aabb<basisu::vec<3u,float>,float,basisu::ray<basisu::vec<3u,float>>,basisu::vec_interval<basisu::vec<3u,float>>>((vec*)&uStack_68, &fStack_7c, (ray*)&uStack_58, in_R8);
   if (iVar4 == 1) {
      fVar16 = fStack_60;
      uVar12 = uStack_68;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* basisu::astc_hdr_block_stats::print() */undefined8 *basisu::astc_hdr_block_stats::print(void) {
   ray *prVar1;
   float fVar2;
   uint uVar3;
   int iVar4;
   ...
   if (uVar3 == 0) {
      if (in_RDI[1].__data.__lock != 0) {
         ...
         __printf_chk((double)( ( (float)*(uint*)( (long)in_RDI + 0x30 ) * __LC30 ) / (float)(uint)in_RDI[1].__data.__lock ), 2, "Total solid: %u %3.2f%%\n", *(uint*)( (long)in_RDI + 0x30 ));
         __printf_chk((double)( ( (float)*(uint*)( (long)in_RDI + 0x1b4 ) * __LC30 ) / (float)(uint)in_RDI[1].__data.__lock ), 2, "Total refined: %u %3.2f%%\n", *(uint*)( (long)in_RDI + 0x1b4 ));
         __printf_chk((double)( ( (float)*(uint*)( (long)in_RDI + 0x3c ) * __LC30 ) / (float)(uint)in_RDI[1].__data.__lock ), 2, "Total mode 11, 1 partition: %u %3.2f%%\n", *(uint*)( (long)in_RDI + 0x3c ));
         __printf_chk((double)( ( (float)*(uint*)( (long)in_RDI + 0x44 ) * __LC30 ) / (float)(uint)in_RDI[1].__data.__lock ), 2, "Total mode 11, 1 partition, constrained weights: %u %3.2f%%\n", *(uint*)( (long)in_RDI + 0x44 ));
         __printf_chk((double)( ( (float)*(uint*)( (long)in_RDI + 0x40 ) * __LC30 ) / (float)(uint)in_RDI[1].__data.__lock ), 2, "Total mode 11, 2 partition: %u %3.2f%%\n", *(uint*)( (long)in_RDI + 0x40 ));
         __printf_chk((double)( ( (float)*(uint*)( (long)in_RDI + 0x34 ) * __LC30 ) / (float)(uint)in_RDI[1].__data.__lock ), 2, "Total mode 7, 1 partition: %u %3.2f%%\n", *(uint*)( (long)in_RDI + 0x34 ));
         __printf_chk((double)( ( (float)*(uint*)( (long)in_RDI + 0x38 ) * __LC30 ) / (float)(uint)in_RDI[1].__data.__lock ), 2, "Total mode 7, 2 partition: %u %3.2f%%\n", *(uint*)( (long)in_RDI + 0x38 ));
         __printf_chk((double)( ( (float)*(uint*)( (long)in_RDI + 0x2c ) * __LC30 ) / (float)(uint)in_RDI[1].__data.__lock ), 2, "Total 2 partitions: %u %3.2f%%\n", *(uint*)( (long)in_RDI + 0x2c ));
         putchar(10);
         puts("ISE texel weight range histogram mode 11:");
         do {
            lVar5 = uVar7 * 4;
 ...
 while ( uVar7 != 0x1e );
   ...
   uVar11 = CONCAT44((float)( ( ulong ) * extraout_RDX >> 0x20 ) * fVar9 + (float)( ( ulong ) * in_RSI >> 0x20 ), fVar10);
   uStack_60 = uVar11;
   fStack_58 = fVar15;
   while (( fVar2 = *(float*)( (long)&uStack_60 + lVar5 ) * (float*)( in_RCX + lVar5 ) <= fVar2 && ( prVar1 = fVar2 < *(float*)prVar1 || fVar2 == *(float*)prVar1 ) )) {
      lVar5 = lVar5 + 4;
      if (lVar5 == 0xc) {
         if (in_R9 != (undefined1*)0x0) {
            *in_R9 = 1;
...
;
   ...
   fStack_64 = 0.0;
   uStack_40 = CONCAT44(*(float*)( (long)extraout_RDX + 4 ) * fVar9 + *(float*)( (long)in_RSI + 4 ), fVar10);
   fStack_38 = fVar15;
   iVar4 = intersection::ray_aabb<basisu::vec<3u,float>,float,basisu::ray<basisu::vec<3u,float>>,basisu::vec_interval<basisu::vec<3u,float>>>((vec*)&uStack_50, &fStack_64, (ray*)&uStack_40, in_R8);
   if (iVar4 == 1) {
      fVar15 = fStack_48;
      uVar11 = uStack_50;
   }
...
basisu::interp_color
   ...
   uVar6 = CONCAT44((float)( ( ulong ) * (undefined8*)param_2 >> 0x20 ) * param_3 + (float)( ( ulong ) * (undefined8*)param_1 >> 0x20 ), fVar5);
   local_48 = uVar6;
   local_40 = fVar10;
   while (( fVar2 = *(float*)( (long)&local_48 + lVar4 ) * (float*)( param_4 + lVar4 ) <= fVar2 && ( prVar1 = fVar2 < *(float*)prVar1 || fVar2 == *(float*)prVar1 ) )) {
      lVar4 = lVar4 + 4;
      if (lVar4 == 0xc) {
         if (param_6 != (bool*)0x0) {
            *param_6 = true;
         ...
         LAB_001038b9:*(undefined8*)this = uVar6;
         *(float*)( this + 8 ) = fVar10;
...
;
   ...
   fStack_20 = fVar10;
   iVar3 = intersection::ray_aabb<basisu::vec<3u,float>,float,basisu::ray<basisu::vec<3u,float>>,basisu::vec_interval<basisu::vec<3u,float>>>((vec*)&local_38, &local_4c, (ray*)&local_28, param_5);
   if (iVar3 == 1) {
      fVar10 = local_30;
      uVar6 = local_38;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* basisu::compute_least_squares_endpoints_rgb(unsigned int, unsigned char const*, basisu::vec<4u,
   float> const*, basisu::vec<3u, float>*, basisu::vec<3u, float>*, basisu::vec<4u, float> const*,
   basisu::vec_interval<basisu::vec<3u, float> > const&) */undefined8 basisu::compute_least_squares_endpoints_rgb(uint param_1, uchar *param_2, vec *param_3, vec *param_4, vec *param_5, vec *param_6, vec_interval *param_7) {
   uint uVar1;
   byte bVar2;
   vec *pvVar3;
   undefined8 uVar4;
      ...
      if (fVar9 != 0.0) {
         ...
         *(float*)( param_5 + 8 ) = fVar10 * fVar14 + ( fVar19 - fVar14 ) * fVar9;
         do {
            ...
            *(uint*)( param_4 + lVar5 ) = ( uint ) * (float*)( param_7 + lVar5 ) & uVar8 | ~uVar8 & *(uint*)( param_4 + lVar5 );
 ...
 while ( lVar5 != 0xc );
         ...
         if (fVar11 != 0.0) {
            ...
            local_58 = __LC55;
            interp_color((basisu*)&local_78, (vec*)&local_98, (vec*)&local_88, ( *(float*)( param_4 + 8 ) - local_90 ) * fStack_80 + ( fVar20 - fVar15 ) * fStack_84 + ( fVar18 - fVar14 ) * local_88, (vec_interval*)&local_58, param_7, &local_9a);
            if (local_9a == false) {
            ...
            local_99 = false;
            interp_color((basisu*)&local_68, (vec*)&local_98, (vec*)&local_88, fVar10 + fVar17 + fVar16, (vec_interval*)&local_58, param_7, &local_99);
            if (local_99 == false) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* basisu::encode_astc_hdr_block_mode_11(unsigned int, basisu::vec<4u, float> const*, unsigned int,
   unsigned int&, double, unsigned char*, unsigned char*, basisu::astc_hdr_codec_options const&,
   bool, unsigned int, bool, bool, int, int) [clone .constprop.0] */void basisu::encode_astc_hdr_block_mode_11(uint param_1, vec *param_2, uint param_3, uint *param_4, double param_5, uchar *param_6, uchar *param_7, astc_hdr_codec_options *param_8, bool param_9, uint param_10, bool param_11, bool param_12, int param_13, int param_14) {
   byte bVar1;
   char cVar2;
   uint uVar3;
   uint uVar4;
 ...
 while ( pvVar20 != param_2 );
   ...
   uVar6 = (ulong)param_3;
   lVar5 = uVar6 * 3;
   uVar16 = *(char*)( (long)&astc_helpers::g_ise_range_table + lVar5 + 2 ) * 4 + 1 + *(char*)( (long)&astc_helpers::g_ise_range_table + lVar5 + 1 ) * 2 << ( *(byte*)( (long)&astc_helpers::g_ise_range_table + lVar5 ) & 0x1f );
 ...
 while ( iVar19 != 0 );
   ...
   fVar33 = _LC59;
   fVar30 = _LC59;
   LAB_001045d0:local_208 = CONCAT44(_UNK_0018a9d4, _LC25);
 ...
 while ( pfVar7 != (float*)( (long)&uStack_200 + 4 ) );
         fVar32 = ( local_210 - local_260 ) * fVar33 + ( fVar31 - fStack_264 ) * fVar30 + ( (float)local_218 - local_268 ) * fVar26;
         if (fVar32 < fVar36) {
 ...
 while ( lVar5 != 0xc );
   ...
   uStack_80._2_4_ = 0;
   uStack_80._6_2_ = 0;
   cVar2 = try_mode11(param_1, (uchar*)( (long)&uStack_80 + 2 ), puVar12, &local_270, &local_27c, (vec*)local_23c, (vec*)local_230, local_2e8, uVar16, param_3, param_8, param_9, param_10, param_12, param_13, param_14);
   if (cVar2 != '\0') {
      if (local_270 < _LC18) {
         local_278 = local_270;
         ...
         if (param_1 < 8) {
            if (( param_1 & 4 ) == 0) {
               if (param_1 != 0) {
                  *param_7 = local_78[0];
                  if (( param_1 & 2 ) != 0) {
                     *(undefined2*)( param_7 + ( (ulong)param_1 - 2 ) ) = *(undefined2*)( local_78 + ( (ulong)param_1 - 2 ) );
                  }
               ...
               *(undefined4*)( param_7 + ( (ulong)param_1 - 4 ) ) = *(undefined4*)( local_78 + ( (ulong)param_1 - 4 ) );
            }

         }
 else {
            *(undefined8*)param_7 = local_78._0_8_;
            *(undefined8*)( param_7 + ( (ulong)param_1 - 8 ) ) = *(undefined8*)( (long)&uStack_80 + (ulong)param_1 );
            ...
            if (7 < uVar4) {
               ...
               do {
                  uVar9 = (ulong)uVar3;
                  uVar3 = uVar3 + 8;
                  *(undefined8*)( ( ( ulong )(param_7 + 8) & 0xfffffffffffffff8 ) + uVar9 ) = *(undefined8*)( puVar12 + ( uVar9 - lVar5 ) );
               }
 while ( uVar3 < uVar4 );
            }
      ...
      do {
         cVar2 = compute_least_squares_endpoints_rgb(param_1, puVar12, pvVar14, local_224, (vec*)&local_218, local_320, (vec_interval*)&local_208);
         if (( cVar2 == '\0' ) || ( cVar2 = try_mode11(param_1, param_6, param_7, &local_278, param_4, local_224, (vec*)&local_218, local_2e8, uVar16, param_3, param_8, param_9, param_10, param_12, param_13, param_14) ),cVar2 == '\0') break;
         puVar8 = param_7;
         puVar15 = puVar12;
         if (7 < param_1) {
            uVar4 = 0;
 ...
 while ( (ulong)param_1 != uVar11 + 1 );
            if (( cVar2 != '\0' ) && ( cVar2 = compute_least_squares_endpoints_rgb(param_1, local_58, pvVar14, local_224, (vec*)&local_218, local_320, (vec_interval*)&local_208) ),cVar2 != '\0') {
               try_mode11(param_1, param_6, param_7, &local_278, param_4, local_224, (vec*)&local_218, local_2e8, uVar16, param_3, param_8, param_9, param_10, param_12, param_13, param_14);
            }
 ...
 while ( bVar24 );
            if (( bVar25 ) && ( cVar2 = compute_least_squares_endpoints_rgb(param_1, local_58, pvVar14, local_224, (vec*)&local_218, local_320, (vec_interval*)&local_208) ),cVar2 != '\0') {
               try_mode11(param_1, param_6, param_7, &local_278, param_4, local_224, (vec*)&local_218, local_2e8, uVar16, param_3, param_8, param_9, param_10, param_12, param_13, param_14);
            }
 ...
 while ( bVar25 );
            if (( cVar13 != '\0' ) && ( cVar2 = compute_least_squares_endpoints_rgb(param_1, local_58, pvVar14, local_224, (vec*)&local_218, local_320, (vec_interval*)&local_208) ),cVar2 != '\0') {
               try_mode11(param_1, param_6, param_7, &local_278, param_4, local_224, (vec*)&local_218, local_2e8, uVar16, param_3, param_8, param_9, param_10, param_12, param_13, param_14);
            }
...
/* basisu::pack_mode11(basisu::vec<4u, float> const*,
   ...
   int, unsigned int, bool) */void basisu::pack_mode11(vec *param_1, vector *param_2, astc_hdr_codec_options *param_3, uint param_4, uint param_5, bool param_6) {
   ...
   if (param_4 <= param_5) {
      LAB_0010524c:do {
         if (param_4 == 8) {
            ...
            LAB_0010555e:aVar4 = param_3[0x60];
         }

         dVar8 = (double)encode_astc_hdr_block_mode_11(0x10, param_1, param_4, &local_16c, dVar8, (uchar*)&local_5e, local_58, param_3, (bool)param_3[0x10], uVar6, (bool)aVar4, param_6, *(int*)( param_3 + 0x14 ), *(int*)( param_3 + 0x18 ));
         auVar1 = local_58;
         if (dVar8 < _LC18) {
            dStack_130 = _LC18;
            ...
            local_168 = CONCAT62(CONCAT42(CONCAT22(( &g_qlog16_to_half )[( uint )(local_148 << 4)], ( &g_qlog16_to_half )[( uint )(local_154 << 4)]), ( &g_qlog16_to_half )[( uint )(local_14c << 4)]), ( &g_qlog16_to_half )[( uint )(local_158 << 4)]);
            local_160 = CONCAT22(( &g_qlog16_to_half )[( uint )(local_144 << 4)], ( &g_qlog16_to_half )[( uint )(local_150 << 4)]);
            dVar8 = (double)basist::transcode_bc6h_1subset((unsigned_short*)&local_168, (log_astc_block*)&local_128, (bc6h_block*)&local_7a);
            uVar6 = *(uint*)( param_2 + 8 );
            if (*(uint*)( param_2 + 0xc ) <= uVar6) {
               dVar8 = (double)basisu::elemental_vector::increase_capacity((uint)param_2, (bool)( (char)uVar6 + '\x01' ), 1, (_func_void_void_ptr_void_ptr_uint*)0xd0, false);
               uVar6 = *(uint*)( param_2 + 8 );
            }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* basisu::encode_astc_hdr_block_mode_7(unsigned int, basisu::vec<4u, float> const*, unsigned int,
   unsigned int&, double, unsigned char*, unsigned char*, basisu::astc_hdr_codec_options const&,
   unsigned int) [clone .constprop.0] */void basisu::encode_astc_hdr_block_mode_7(uint param_1, vec *param_2, uint param_3, uint *param_4, double param_5, uchar *param_6, uchar *param_7, astc_hdr_codec_options *param_8, uint param_9) {
   uchar *puVar1;
   byte bVar2;
   uint uVar3;
   char cVar4;
   ...
   *param_4 = 0;
   ...
   uVar9 = (ulong)param_3;
   lVar10 = uVar9 * 3;
   uVar17 = *(char*)( (long)&astc_helpers::g_ise_range_table + lVar10 + 2 ) * 4 + 1 + *(char*)( (long)&astc_helpers::g_ise_range_table + lVar10 + 1 ) * 2 << ( *(byte*)( (long)&astc_helpers::g_ise_range_table + lVar10 ) & 0x1f );
   if (param_1 == 0) {
 ...
 while ( pfVar12 != (float*)( (long)&uStack_200 + 4 ) );
         ...
         fVar27 = ( local_1e0 - local_260 ) * _LC59 + ( (float)( (ulong)local_1e8 >> 0x20 ) - fStack_264 ) * _LC59 + ( (float)local_1e8 - local_268 ) * _LC59;
         if (fVar27 <= fVar30) {
            fVar30 = fVar27;
         }
 ...
 while ( pvVar22 + lVar10 != pvVar25 );
   ...
   local_250 = _LC59;
   interp_color(pbVar24, (vec*)&local_268, (vec*)&local_258, fVar30, (vec_interval*)&local_208, (vec_interval*)&local_208, (bool*)0x0);
   interp_color((basisu*)&local_238, (vec*)&local_268, (vec*)&local_258, fVar31, (vec_interval*)&local_208, (vec_interval*)&local_208, (bool*)0x0);
   do {
 ...
 while ( pbVar24 != local_22c );
   ...
   local_270 = _LC18;
   local_58 = (undefined1[16])0x0;
   fVar27 = ( ( local_230 - local_240 ) * fVar27 + ( (float)( (ulong)local_238 >> 0x20 ) - (float)( (ulong)local_248 >> 0x20 ) ) * fVar27 + ( (float)local_238 - (float)local_248 ) * fVar27 ) * fVar27;
   if ((float)( (uint)fVar27 & uVar3 ) < _LC69) {
      fVar27 = (float)( ( uint )((float)(int)fVar27 + (float)( -(uint)((float)(int)fVar27 < fVar27) & (uint)_LC23 )) | ~uVar3 & (uint)fVar27 );
   }

   puVar1 = (uchar*)( (long)&uStack_60 + 4 );
   cVar4 = try_mode7(param_1, puVar1, local_58, &local_270, &local_280, (vec*)&local_238, fVar27, local_2f8, uVar17, param_3, param_8, param_9);
   if (cVar4 != '\0') {
      if (local_270 < _LC18) {
         local_278 = local_270;
         ...
         if (param_1 < 8) {
            if (( param_1 & 4 ) == 0) {
               if (param_1 != 0) {
                  *param_7 = local_58[0];
                  if (( param_1 & 2 ) != 0) {
                     *(undefined2*)( param_7 + ( (ulong)param_1 - 2 ) ) = *(undefined2*)( local_58 + ( (ulong)param_1 - 2 ) );
                  }
               ...
               *(undefined4*)( param_7 + ( (ulong)param_1 - 4 ) ) = *(undefined4*)( local_58 + ( (ulong)param_1 - 4 ) );
            }

         }
 else {
            *(undefined8*)param_7 = local_58._0_8_;
            *(undefined8*)( param_7 + ( (ulong)param_1 - 8 ) ) = *(undefined8*)( (long)&uStack_60 + (ulong)param_1 );
            ...
            if (7 < uVar8) {
               ...
               do {
                  uVar15 = (ulong)uVar7;
                  uVar7 = uVar7 + 8;
                  *(undefined8*)( ( ( ulong )(param_7 + 8) & 0xfffffffffffffff8 ) + uVar15 ) = *(undefined8*)( local_58 + ( uVar15 - lVar10 ) );
               }
 while ( uVar7 < uVar8 );
            }
      ...
      while (true) {
         ...
         if (param_1 == 0) {
            cVar4 = try_mode7(0, param_6, param_7, &local_278, param_4, (vec*)&local_228, fVar31, local_2f8, uVar17, param_3, param_8, param_9);
            fVar31 = 0.0;
            if (cVar4 != '\0') {
            ...
            do {
               bVar2 = *pbVar13;
               pbVar13 = pbVar13 + 1;
               fVar28 = ( _LC23 - (float)(byte)g_ise_weight_lerps[(ulong)bVar2 + 1 + uVar9 * 0x20] * _LC27 ) * fVar31 * fVar30;
 ...
 while ( pbVar13 != local_58 + param_1 );
            ...
            cVar4 = try_mode7(param_1, param_6, param_7, &local_278, param_4, (vec*)&local_228, fVar31, local_2f8, uVar17, param_3, param_8, param_9);
            if (cVar4 != '\0') {
               uStack_60._4_4_ = *(undefined4*)param_6;
               puVar14 = param_7;
               pbVar13 = local_58;
 ...
 while ( uVar8 < ( param_1 & 0xfffffff8 ) );
            ...
            do {
               bVar2 = *pbVar13;
               pbVar13 = pbVar13 + 1;
               fVar31 = fVar31 + ( _LC23 - (float)(byte)g_ise_weight_lerps[(ulong)bVar2 + 1 + uVar9 * 0x20] * _LC27 );
            }
 while ( local_58 + param_1 != pbVar13 );
         ...
         if (_LC52 < (float)( uVar3 & (uint)fVar31 )) {
            ...
            if ((float)( (uint)fVar28 & uVar3 ) < _LC69) {
               fVar27 = (float)( ( uint )((float)( -(uint)((float)(int)fVar28 < fVar28) & (uint)_LC23 ) + (float)(int)fVar28) | ~uVar3 & (uint)fVar28 );
            }

            cVar5 = try_mode7(param_1, param_6, param_7, local_2c0, param_4, (vec*)&local_218, fVar27, local_2f8, uVar17, param_3, param_8, param_9);
            if (cVar5 == '\0') {
               cVar5 = cVar4;
            }
            ...
            if ((float)( (uint)fVar29 & uVar3 ) < _LC69) {
               fVar27 = (float)( ( uint )((float)( -(uint)((float)(int)fVar29 < fVar29) & (uint)_LC23 ) + (float)(int)fVar29) | ~uVar3 & (uint)fVar29 );
            }

            cVar6 = try_mode7(param_1, param_6, param_7, local_2c0, param_4, (vec*)&local_218, fVar27, local_2f8, uVar17, param_3, param_8, param_9);
            if (cVar6 == '\0') {
               cVar6 = cVar5;
            }
            ...
            if ((float)( (uint)fVar31 & uVar3 ) < _LC69) {
               fVar27 = (float)( ( uint )((float)( -(uint)((float)(int)fVar31 < fVar31) & (uint)_LC23 ) + (float)(int)fVar31) | ~uVar3 & (uint)fVar31 );
            }

            cVar4 = try_mode7(param_1, param_6, param_7, local_2c0, param_4, (vec*)&local_218, fVar27, local_2f8, uVar17, param_3, param_8, param_9);
            ...
            if ((float)( (uint)fVar31 & uVar3 ) < _LC69) {
               fVar31 = (float)( ( uint )((float)(int)fVar31 + (float)( -(uint)((float)(int)fVar31 < fVar31) & (uint)_LC23 )) | ~uVar3 & (uint)fVar31 );
            }

            cVar5 = try_mode7(param_1, param_6, param_7, local_2c0, param_4, (vec*)&local_218, fVar31, local_2f8, uVar17, param_3, param_8, param_9);
            if (cVar5 == '\0') goto LAB_0010604a;
         }
 else {
            LAB_0010604a:if (cVar4 == '\0') break;
         }
...
/* basisu::pack_mode7_2part(basisu::vec<4u, float> const*,
   ...
   const*, unsigned int, unsigned int) */void basisu::pack_mode7_2part(basisu *this, vec *param_1, vector *param_2, astc_hdr_codec_options *param_3, int param_4, int *param_5, uint param_6, uint param_7) {
   char cVar1;
   byte bVar2;
   ushort uVar3;
   int iVar4;
...
;
      ...
      if ((uint)param_5 <= param_6) {
         ...
         do {
            while (true) {
               ...
               local_418 = 0.0;
               dVar21 = (double)encode_astc_hdr_block_mode_7(local_428[0], local_248, uVar20, (uint*)&local_418, in_XMM0_Qa, local_420, local_408, (astc_hdr_codec_options*)param_2, uVar7);
               dVar22 = (double)encode_astc_hdr_block_mode_7(local_428[1], local_148, uVar20, (uint*)( (long)&local_418 + 4 ), 0.0, local_420 + 4, local_3f8, (astc_hdr_codec_options*)param_2, uVar7);
               ...
               do {
                  ...
                  do {
                     ...
                     *(uint*)( local_408 + uVar10 * 4 + -8 ) = uVar7 + 1;
                     iVar4 = (int)lVar12;
                     lVar12 = lVar12 + 1;
                     *(undefined1*)( (long)&uStack_370 + ( ulong )(uint)(iVar17 + iVar4) + 4 ) = local_408[(ulong)uVar7 + uVar10 * 0x10];
                  }
 while ( lVar12 != 4 );
                  iVar17 = iVar17 + 4;
                  puVar18 = puVar18 + 0x10;
 ...
 while ( iVar17 != 0x10 );
               ...
               uStack_270 = uVar13;
               in_XMM0_Qa = (double)basist::transcode_bc6h_2subsets(uVar13, (log_astc_block*)&local_308, (bc6h_block*)&local_25a);
               uVar7 = *(uint*)( param_1 + 8 );
               if (*(uint*)( param_1 + 0xc ) <= uVar7) {
                  in_XMM0_Qa = (double)basisu::elemental_vector::increase_capacity((uint)param_1, (bool)( (char)uVar7 + '\x01' ), 1, (_func_void_void_ptr_void_ptr_uint*)0xd0, false);
                  uVar7 = *(uint*)( param_1 + 8 );
               }
...
;
 ...
 while ( uVar20 <= param_6 );
      ...
      LAB_00106c4a:uVar14 = uVar14 + 1;
      if (uVar8 == uVar14) {
         LAB_00106c59:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            return;
         }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WARNING: Restarted to delay deadcode elimination for space: stack *//* basisu::astc_hdr_enc_block(float const*, basisu::astc_hdr_codec_options const&,
   basisu::vector<basisu::astc_hdr_pack_results>&) */char basisu::astc_hdr_enc_block(float *param_1, astc_hdr_codec_options *param_2, vector *param_3) {
   undefined8 uVar1;
   double dVar2;
   ...
   do {
      ...
      do {
         ...
         if (( ( __LC77 < (float)( (uint)fVar53 & _LC26 ) || NAN(fVar53) ) || ( fVar53 < 0.0 ) ) || ( _LC50 < fVar53 )) goto LAB_00106d0a;
 ...
 while ( (vec*)&local_268 != pvVar21 );
   ...
   if (aVar26 == (astc_hdr_codec_options)0x0) {
      LAB_00106df2:if (param_2[5] != (astc_hdr_codec_options)0x0) {
         iVar27 = *(int*)( param_3 + 8 );
         in_stack_fffffffffffff990 = 0x10849a;
         auVar56._0_8_ = (double)pack_mode11((vec*)local_368, param_3, param_2, *(uint*)( param_2 + 8 ), *(uint*)( param_2 + 0xc ), false);
      ...
      if (param_2[0x1c] != (astc_hdr_codec_options)0x0) {
         ...
         if (uVar41 <= *(uint*)( param_2 + 0x24 )) {
            do {
               ...
               auVar56._0_8_ = (double)encode_astc_hdr_block_mode_7(0x10, (vec*)local_368, uVar41, &local_5dc, auVar56._0_8_, (uchar*)&local_5c, local_58, param_2, 0x14);
               ...
               if (auVar56._0_8_ < _LC18) {
                  ...
                  uStack_240 = uVar41;
                  cVar9 = basist::decode_mode7_to_qlog12((uchar*)&uStack_1dc, (int*)&local_438, (int*)0x0, 0x14);
                  auVar56._8_8_ = extraout_XMM0_Qb_04;
                  auVar56._0_8_ = (double)extraout_XMM0_Qa;
                  if (cVar9 != '\0') {
                     local_4c8 = (double)CONCAT62(CONCAT42(CONCAT22(( &g_qlog16_to_half )[( uint )((int)local_428 << 4)], ( &g_qlog16_to_half )[( uint )(local_438._4_4_ << 4)]), ( &g_qlog16_to_half )[( uint )(uStack_430._4_4_ << 4)]), ( &g_qlog16_to_half )[( uint )((int)local_438 << 4)]);
                     uStack_4c0 = CONCAT22(( &g_qlog16_to_half )[( uint )(local_428._4_4_ << 4)], ( &g_qlog16_to_half )[( uint )((int)uStack_430 << 4)]);
                     in_stack_fffffffffffff990 = 0x10839b;
                     auVar56._0_8_ = (double)basist::transcode_bc6h_1subset((unsigned_short*)&local_4c8, (log_astc_block*)&local_258, (bc6h_block*)&uStack_1aa);
                     auVar56._8_8_ = extraout_XMM0_Qb_05;
                     uVar40 = *(uint*)( param_3 + 8 );
                     if (*(uint*)( param_3 + 0xc ) <= uVar40) {
                        in_stack_fffffffffffff990 = 0x108a9d;
                        auVar56._0_8_ = (double)basisu::elemental_vector::increase_capacity(uVar11, (bool)( (char)uVar40 + '\x01' ), 1, (_func_void_void_ptr_void_ptr_uint*)0xd0, false);
 ...
 while ( uVar41 <= *(uint*)( param_2 + 0x24 ) );
      ...
      if (aVar26 == (astc_hdr_codec_options)0x0) {
         ...
         LAB_00107084:pdVar16 = &local_4c8;
         for (lVar12 = 0x12; lVar12 != 0; lVar12 = lVar12 + -1) {
            *pdVar16 = 0.0;
         ...
         if (param_2[0x58] == (astc_hdr_codec_options)0x0) {
            ...
            cVar9 = '\0';
            LAB_00108545:auVar56._0_8_ = (double)pack_mode7_2part((basisu*)local_368, (vec*)param_3, (vector*)param_2, paVar22, (int)local_538, piVar33, uVar40, uVar41);
            ...
            if (( *(int*)( param_3 + 8 ) == iVar27 ) && ( 2 < *(uint*)( param_2 + 0x30 ) )) {
               ...
               auVar56._0_8_ = (double)pack_mode7_2part((basisu*)local_368, (vec*)param_3, (vector*)param_2, paVar22, (int)local_538, (int*)0x2, 2, uVar41);
            ...
            LAB_00106e24:uVar40 = *(uint*)( param_2 + 0x5c );
            local_5c8[2] = 0.0;
            local_5c8[0] = 0.0;
            local_5c8[1] = 0.0;
 ...
 while ( pvVar21 != avStack_1a8 );
            ...
            auVar55._8_4_ = _LC23;
            local_5a8 = CONCAT44(local_5c8[2] * _UNK_0018a934 + _LC86._4_4_, local_5c8[1] * _LC78 + (float)_LC86);
 ...
 while ( lVar12 != 0xc );
                  ...
                  do {
                     ...
                     lVar30 = lVar12 + 0xc;
                     lVar12 = lVar12 + 4;
                     fVar54 = fVar54 + ( *(float*)pvVar37 - *(float*)( local_5b8 + lVar30 ) ) * ( *(float*)pvVar37 - *(float*)( local_5b8 + lVar30 ) );
                  }
 while ( lVar12 != 0xc );
                  if (fVar54 <= fVar44) {
                     ...
                     *(int*)( (long)&local_438 + uVar25 * 4 ) = iVar20;
                     ...
                     local_598 = CONCAT44((float)( (ulong)local_598 >> 0x20 ) + (float)( (ulong)uVar1 >> 0x20 ), (float)local_598 + (float)uVar1);
                     cVar35 = cVar39;
                  }
            ...
            do {
               ...
               do {
                  ...
                  do {
                     ...
                     uVar41 = ( uint ) * (byte*)( (long)&basist::g_bc7_partition2 + ( ulong )(uint)((int)uVar25 + (int)lVar30) );
 ...
 while ( lVar12 != 0x1b );
            std::__introsort_loop<unsigned_int*,long,__gnu_cxx::__ops::_Iter_less_iter>(&local_4c8, auStack_460 + 4, 8);
            pdVar16 = &local_488;
            uVar41 = 0x108938;
...
;
         ...
         do {
            ...
            do {
               ...
               bVar42 = *(byte*)( (long)&basist::g_bc7_partition2 + ( ulong )(uint)((int)uVar15 + (int)lVar12) );
               uVar13 = (ulong)bVar42;
               if (cVar9 != '\0') {
         ...
         if (uVar40 <= *(uint*)( param_2 + 0x44 )) {
            do {
               ...
               do {
                  ...
                  lVar30 = lVar12 * 4;
                  lVar12 = lVar12 + 4;
                  auVar56._0_8_ = (double)encode_astc_hdr_block_mode_11(*puVar17, (vec*)&local_268 + lVar28, uVar40, puVar18, auVar56._0_8_, puVar38, (uchar*)( (long)&local_598 + lVar30 ), param_2, false, uVar10, (bool)aVar26, false, *(int*)( param_2 + 0x14 ), *(int*)( param_2 + 0x18 ));
               ...
               if (auVar50._0_8_ < _LC18) {
                  ...
                  do {
                     ...
                     do {
                        ...
                        iVar20 = (int)lVar12;
                        lVar12 = lVar12 + 1;
                        *(undefined1*)( (long)&uStack_490 + ( ulong )(uint)(iVar27 + iVar20) + 4 ) = *(undefined1*)( (long)&local_598 + (ulong)(uint)fVar53 + uVar15 * 0x10 );
                     }
 while ( lVar12 != 4 );
                     iVar27 = iVar27 + 4;
                     puVar17 = puVar17 + 4;
 ...
 while ( iVar27 != 0x10 );
                  ...
                  uStack_390 = uVar41;
                  auVar56._0_8_ = (double)basist::transcode_bc6h_2subsets(uVar41, (log_astc_block*)&local_428, (bc6h_block*)&local_37a);
                  auVar56._8_8_ = extraout_XMM0_Qb_00;
                  uVar10 = *(uint*)( param_3 + 8 );
                  if (*(uint*)( param_3 + 0xc ) <= uVar10) {
                     auVar56._0_8_ = (double)basisu::elemental_vector::increase_capacity(uVar11, (bool)( (char)uVar10 + '\x01' ), 1, (_func_void_void_ptr_void_ptr_uint*)0xd0, false);
 ...
 while ( uVar25 != uVar14 );
      ...
      pvVar21 = (vec*)local_368;
      do {
         if (( ( *(float*)pvVar21 != local_368[0] ) || ( local_368[1] != *(float*)( pvVar21 + 4 ) ) ) || ( local_368[2] != *(float*)( pvVar21 + 8 ) )) {
            aVar26 = (astc_hdr_codec_options)0x0;
         }
 ...
 while ( (vec*)&local_268 != pvVar37 );
      if (aVar26 == (astc_hdr_codec_options)0x0) {
         ...
         uVar40 = 0x8e;
         fVar44 = 0.0;
         LAB_00108bd6:iVar27 = uVar40 - 0x70;
         lVar12 = lrintf((float)uVar10 * __LC62);
         uVar40 = (uint)lVar12;
         LAB_00108c19:if (uVar40 == 0x400) {
            uVar23 = 0;
         ...
         fVar54 = local_368[1];
         LAB_00107a27:uVar36 = (uint)local_368[2] & 0x7fffff;
         uVar24 = (int)local_368[2] >> 0x17 & 0xff;
         fVar44 = local_368[2];
         LAB_00107a3b:if (uVar40 == 0) {
            local_660 = 0;
            uVar23 = 0;
            local_638 = 0;
         }
      ...
      local_268 = 0.0;
      uStack_1b0 = ( uint6 )(( ( ( ( uVar14 << 8 | uVar15 ) << 8 | uVar25 ) << 8 | (ulong)(byte)uVar40 ) << 8 | local_650 ) << 8) | (uint6)local_658;
      ...
      if (aVar26 == (astc_hdr_codec_options)0x0) {
         ...
         do {
            ...
            pvVar21 = pvVar21 + 0x10;
            dVar47 = (double)( uint )((float)( (uint)local_638 << 0xd ) * fVar44 + _LC20) - (double)( uint )(fVar54 * fVar44 + _LC20);
            dVar49 = (double)( uint )((float)( ( uVar41 & 0xffff ) << 0xd ) * fVar44 + _LC20) - (double)( uint )(fVar46 * fVar44 + _LC20);
            dVar57 = (double)( uint )((float)( ( uVar10 & 0xffff ) << 0xd ) * fVar44 + _LC20) - dVar57;
            local_268 = dVar2 + dVar47 * dVar47 * (double)fVar53 + dVar49 * dVar49 * (double)fVar43 + dVar57 * dVar57;
         }
 while ( (vec*)&local_268 != pvVar21 );
      }

      local_438 = (double)CONCAT62(CONCAT24(local_438._6_2_, CONCAT22((short)uVar10, (short)uVar41)), local_638);
      in_stack_fffffffffffff990 = 0x10802e;
      auVar56._0_8_ = (double)basist::bc6h_enc_block_solid_color((bc6h_block*)&uStack_1aa, (ushort*)&local_438);
      auVar56._8_8_ = extraout_XMM0_Qb_02;
      uVar41 = *(uint*)( param_3 + 8 );
      if (*(uint*)( param_3 + 0xc ) <= uVar41) {
         in_stack_fffffffffffff990 = 0x108ad4;
         auVar56._0_8_ = (double)basisu::elemental_vector::increase_capacity(uVar11, (bool)( (char)uVar41 + '\x01' ), 1, (_func_void_void_ptr_void_ptr_uint*)0xd0, false);
   ...
   LAB_0010733f:if (param_2[0x50] != (astc_hdr_codec_options)0x0) {
      pvVar21 = (vec*)&local_268;
      do {
         fVar53 = *param_1;
         uVar23 = 0;
      ...
      if (*(int*)( param_3 + 8 ) != 0) {
         do {
            ...
            if (paVar29[0xce] == (astc_hdr_pack_results)0x0) {
               astc_hdr_refine_weights((ushort*)&local_268, paVar29, param_2, fVar53, (bool*)( paVar29 + 0xad ));
            }
...
/* basisu::try_mode11(unsigned int, unsigned char*, unsigned char*, double&, unsigned int&,
   ...
   .cold] */void basisu::try_mode11(uint param_1, uchar *param_2, uchar *param_3, double *param_4, uint *param_5, vec *param_6, vec *param_7, unsigned_short *param_8, uint param_9, uint param_10, astc_hdr_codec_options *param_11, bool param_12, uint param_13, bool param_14, int param_15, int param_16) {
   FUN_00101e68();
   return;
}
/* basisu::intersection::result basisu::intersection::ray_aabb<basisu::vec<3u, float>, float,
   ...
   basisu::vec_interval<basisu::vec<3u, float> > const&) */undefined8 basisu::intersection::ray_aabb<basisu::vec<3u,float>,float,basisu::ray<basisu::vec<3u,float>>,basisu::vec_interval<basisu::vec<3u,float>>>(vec *param_1, float *param_2, ray *param_3, vec_interval *param_4) {
   bool bVar1;
   long lVar2;
   undefined8 uVar3;
   uint uVar4;
   ...
   do {
      ...
      if (fVar6 <= *(float*)( param_3 + lVar2 )) {
         ...
         *piVar5 = 1;
         LAB_0018a695:*(float*)( (long)afStack_28 + lVar2 ) = fVar6;
         bVar1 = false;
      }
      ...
      *param_2 = 0.0;
      ...
      do {
         ...
         if (( *(int*)( (long)local_34 + lVar2 ) != 2 ) && ( *(float*)( param_3 + lVar2 + 0xc ) != 0.0 )) {
            fVar6 = ( *(float*)( (long)afStack_28 + lVar2 ) - *(float*)( param_3 + lVar2 ) ) / *(float*)( param_3 + lVar2 + 0xc );
         }
         ...
         do {
            if (uVar4 == (uint)lVar2) {
               ...
               *(float*)( param_1 + lVar2 * 4 ) = fVar7;
               if (( fVar7 < *(float*)( param_4 + lVar2 * 4 ) ) || ( *(float*)( param_4 + lVar2 * 4 + 0xc ) <= fVar7 && fVar7 != *(float*)( param_4 + lVar2 * 4 + 0xc ) )) goto LAB_0018a7e4;
            }
...
/* basisu::astc_hdr_codec_options::astc_hdr_codec_options() */void basisu::astc_hdr_codec_options::_GLOBAL__sub_I_astc_hdr_codec_options(void) {
   return;
}

/* MovieWriterMJPEG::get_audio_mix_rate() const */undefined4 MovieWriterMJPEG::get_audio_mix_rate(MovieWriterMJPEG *this) {
   return *(undefined4*)( this + 600 );
}
/* MovieWriterMJPEG::get_audio_speaker_mode() const */undefined4 MovieWriterMJPEG::get_audio_speaker_mode(MovieWriterMJPEG *this) {
   return *(undefined4*)( this + 0x25c );
}
/* MovieWriterMJPEG::write_end() */void MovieWriterMJPEG::write_end(MovieWriterMJPEG *this) {
   long *plVar1;
   long lVar2;
   Object *pOVar3;
   code *pcVar4;
   ...
   if (plVar1 != (long*)0x0) {
      ...
      ( **(code**)( **(long**)( this + 0x2b0 ) + 0x278 ) )(*(long**)( this + 0x2b0 ), *(int*)( this + 0x268 ) << 5);
      if (*(int*)( this + 0x268 ) != 0) {
         lVar8 = 0;
         iVar6 = 4;
         do {
            ...
            if (lVar2 == 0) {
               LAB_00100368:lVar7 = 0;
               LAB_0010036b:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar8, lVar7, "p_index", "size()", "", false, true);
               _err_flush_stdout();
            ...
            ( **(code**)( **(long**)( this + 0x2b0 ) + 0x278 ) )(*(long**)( this + 0x2b0 ), *(undefined4*)( lVar2 + lVar8 * 4 ));
            lVar2 = *(long*)( this + 0x280 );
            ...
            ( **(code**)( **(long**)( this + 0x2b0 ) + 0x278 ) )(*(long**)( this + 0x2b0 ), 0x10);
            ( **(code**)( **(long**)( this + 0x2b0 ) + 0x278 ) )(*(long**)( this + 0x2b0 ), iVar6);
            ( **(code**)( **(long**)( this + 0x2b0 ) + 0x278 ) )(*(long**)( this + 0x2b0 ), *(undefined4*)( this + 0x274 ));
 ...
 while ( (uint)lVar8 < *(uint*)( this + 0x268 ) );
      ...
      ( **(code**)( **(long**)( this + 0x2b0 ) + 0x1b8 ) )(*(long**)( this + 0x2b0 ), *(undefined8*)( this + 0x288 ));
      for (int i = 0; i < 3; i++) {
         ( **(code**)( **(long**)( this + 688 ) + 632 ) )(*(long**)( this + 688 ), *(undefined4*)( this + 616 ));
         ( **(code**)( **(long**)( this + 688 ) + 440 ) )(*(long**)( this + 688 ), *(undefined8*)( this + ( 8*i + 656 ) ));
      }

      ( **(code**)( **(long**)( this + 0x2b0 ) + 0x278 ) )(*(long**)( this + 0x2b0 ), ( ulong )(uint)(*(int*)( this + 0x268 ) * *(int*)( this + 600 )) / ( ulong ) * (uint*)( this + 0x26c ));
      ( **(code**)( **(long**)( this + 0x2b0 ) + 0x1b8 ) )(*(long**)( this + 0x2b0 ), *(undefined8*)( this + 0x2a8 ));
...
/* MovieWriterMJPEG::handles_file(String const&) const */undefined4 MovieWriterMJPEG::handles_file(String *param_1) {
   long *plVar1;
   long lVar2;
   undefined4 uVar3;
   long in_FS_OFFSET;
...
/* MovieWriterMJPEG::get_supported_extensions(List<String, DefaultAllocator>*) const */void MovieWriterMJPEG::get_supported_extensions(MovieWriterMJPEG *this, List *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
...
/* MovieWriterMJPEG::write_begin(Vector2i const&, unsigned int, String const&) */undefined4 MovieWriterMJPEG::write_begin(Vector2i *param_1, uint param_2, String *param_3) {
   Object *pOVar1;
   long lVar2;
   long *plVar3;
   char cVar4;
   ...
   pOVar8 = pOVar1;
   if (local_48 == pOVar1) {
      LAB_0010087d:if (( ( pOVar8 != (Object*)0x0 ) && ( cVar4 = RefCounted::unreference() ),pOVar1 = local_48,cVar4 != '\0' )) &&( cVar4 = cVar4 != '\0' )(**(code**)( *(long*)pOVar1 + 0x140 ))(pOVar1);
   ...
   *(int*)( param_1 + 0x26c ) = (int)param_3;
   if (plVar3 != (long*)0x0) {
      ...
      ( **(code**)( **(long**)( param_1 + 0x2b0 ) + 0x278 ) )(*(long**)( param_1 + 0x2b0 ), 1000000 / ( (ulong)param_3 & 0xffffffff ));
 ...
 while ( iVar6 != 0 );
      ...
      ( **(code**)( **(long**)( param_1 + 0x2b0 ) + 0x278 ) )(*(long**)( param_1 + 0x2b0 ), 0);
      ( **(code**)( **(long**)( param_1 + 0x2b0 ) + 0x278 ) )(*(long**)( param_1 + 0x2b0 ), 1);
      ( **(code**)( **(long**)( param_1 + 0x2b0 ) + 0x278 ) )(*(long**)( param_1 + 0x2b0 ), (ulong)param_3 & 0xffffffff);
      ( **(code**)( **(long**)( param_1 + 0x2b0 ) + 0x278 ) )(*(long**)( param_1 + 0x2b0 ), 0);
      uVar5 = ( **(code**)( **(long**)( param_1 + 0x2b0 ) + 0x1c8 ) )();
      *(undefined8*)( param_1 + 0x290 ) = uVar5;
      for (int i = 0; i < 4; i++) {
         ( **(code**)( **(long**)( param_1 + 688 ) + 632 ) )(*(long**)( param_1 + 688 ), 0);
      }
      ...
      ( **(code**)( **(long**)( param_1 + 0x2b0 ) + 0x2d0 ) )(*(long**)( param_1 + 0x2b0 ), &_LC28, 4);
      ( **(code**)( **(long**)( param_1 + 0x2b0 ) + 0x278 ) )(*(long**)( param_1 + 0x2b0 ), ( *piVar9 * 3 + 3U & 0xfffffffc ) * piVar9[1]);
      for (int i = 0; i < 4; i++) {
         ( **(code**)( **(long**)( param_1 + 688 ) + 632 ) )(*(long**)( param_1 + 688 ), 0);
      }
      ...
      *(undefined8*)( param_1 + 0x298 ) = uVar5;
      ...
      ( **(code**)( **(long**)( param_1 + 0x2b0 ) + 0x278 ) )(*(long**)( param_1 + 0x2b0 ), *(int*)( param_1 + 600 ) * local_50);
      ( **(code**)( **(long**)( param_1 + 0x2b0 ) + 0x278 ) )(*(long**)( param_1 + 0x2b0 ), 0);
      uVar5 = ( **(code**)( **(long**)( param_1 + 0x2b0 ) + 0x1c8 ) )();
      *(undefined8*)( param_1 + 0x2a0 ) = uVar5;
      ...
      ( **(code**)( **(long**)( param_1 + 0x2b0 ) + 0x278 ) )(*(long**)( param_1 + 0x2b0 ), local_50);
      *(uint*)( param_1 + 0x274 ) = ( *(uint*)( param_1 + 600 ) / *(uint*)( param_1 + 0x26c ) ) * local_50;
      ( **(code**)( **(long**)( param_1 + 0x2b0 ) + 0x2d0 ) )(*(long**)( param_1 + 0x2b0 ), &_LC29, 4);
      ( **(code**)( **(long**)( param_1 + 0x2b0 ) + 0x278 ) )(*(long**)( param_1 + 0x2b0 ), 0x10);
      ( **(code**)( **(long**)( param_1 + 0x2b0 ) + 0x270 ) )(*(long**)( param_1 + 0x2b0 ), 1);
      ( **(code**)( **(long**)( param_1 + 0x2b0 ) + 0x270 ) )(*(long**)( param_1 + 0x2b0 ), local_4c);
      ( **(code**)( **(long**)( param_1 + 0x2b0 ) + 0x278 ) )(*(long**)( param_1 + 0x2b0 ), *(undefined4*)( param_1 + 600 ));
      ( **(code**)( **(long**)( param_1 + 0x2b0 ) + 0x278 ) )(*(long**)( param_1 + 0x2b0 ), *(int*)( param_1 + 600 ) * local_50);
...
else{*(Object**)( param_1 + 0x2b0 ) = local_48;if (local_48 != (Object*)0x0) {
...
if (pOVar1 != (Object*)0x0) {
   LAB_00100868:cVar4 = RefCounted::unreference();
   pOVar8 = local_48;
...
*(int*)( param_1 + 0x26c ) = (int)param_3;}uVar7 = 0x13;_err_print_error("write_begin", "servers/movie_writer/movie_writer_mjpeg.cpp", 0x3f, "Condition \"f.is_null()\" is true. Returning: ERR_CANT_OPEN", 0, 0);LAB_0010109e:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return uVar7;}/* MovieWriterMJPEG::MovieWriterMJPEG() */void MovieWriterMJPEG::MovieWriterMJPEG(MovieWriterMJPEG *this) {
   uint uVar1;
   int iVar2;
   long in_FS_OFFSET;
   float fVar3;
...
/* MovieWriterMJPEG::write_frame(Ref<Image> const&, int const*) */undefined8 MovieWriterMJPEG::write_frame(MovieWriterMJPEG *this, Ref *param_1, int *param_2) {
   long *plVar1;
   long lVar2;
   int iVar3;
   undefined8 uVar4;
   ...
   if (*(long*)( this + 0x2b0 ) == 0) {
      _err_print_error("write_frame", "servers/movie_writer/movie_writer_mjpeg.cpp", 0xc2, "Condition \"f.is_null()\" is true. Returning: ERR_UNCONFIGURED", 0, 0);
      uVar4 = 3;
      goto LAB_0010178d;
   }
   ...
   LAB_00101727:( **(code**)( **(long**)( this + 0x2b0 ) + 0x2d0 ) )(*(long**)( this + 0x2b0 ), &_LC7, 4);
   ( **(code**)( **(long**)( this + 0x2b0 ) + 0x278 ) )(*(long**)( this + 0x2b0 ), *(undefined4*)( this + 0x274 ));
   ( **(code**)( **(long**)( this + 0x2b0 ) + 0x2d0 ) )(*(long**)( this + 0x2b0 ), param_2, *(undefined4*)( this + 0x274 ));
   *(int*)( this + 0x268 ) = *(int*)( this + 0x268 ) + 1;
   ...
   uVar4 = 0;
   LAB_0010178d:if (lVar2 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
...
/* MovieWriterMJPEG::is_class_ptr(void*) const */uint MovieWriterMJPEG::is_class_ptr(MovieWriterMJPEG *this, void *param_1) {
   return (uint)CONCAT71(0x1036, (undefined4*)param_1 == &MovieWriter::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1036, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1036, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* MovieWriterMJPEG::_getv(StringName const&, Variant&) const */undefined8 MovieWriterMJPEG::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* MovieWriterMJPEG::_setv(StringName const&, Variant const&) */undefined8 MovieWriterMJPEG::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* MovieWriterMJPEG::_validate_propertyv(PropertyInfo&) const */void MovieWriterMJPEG::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* MovieWriterMJPEG::_property_can_revertv(StringName const&) const */undefined8 MovieWriterMJPEG::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* MovieWriterMJPEG::_property_get_revertv(StringName const&, Variant&) const */undefined8 MovieWriterMJPEG::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* MovieWriterMJPEG::_notificationv(int, bool) */void MovieWriterMJPEG::_notificationv(int param_1, bool param_2) {
   return;
}
...
/* MovieWriterMJPEG::_get_class_namev() const */undefined8 *MovieWriterMJPEG::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      ...
      if (*(long*)( _get_class_namev() ) != 0) {
         ...
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "MovieWriterMJPEG");
         goto LAB_00101c1e;
      }
...
/* MovieWriterMJPEG::get_class() const */void MovieWriterMJPEG::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* MovieWriterMJPEG::_initialize_classv() */void MovieWriterMJPEG::_initialize_classv(void) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   long local_60;
   ...
   long local_30;
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   if (initialize_class() != '\0') goto LAB_00101e94;
   if (MovieWriter::initialize_class() == '\0') {
      ...
      lVar2 = local_58;
      if (local_58 == 0) {
         LAB_00101f9e:if ((code*)_GLOBAL_OFFSET_TABLE_ != Object::_bind_methods) {
            LAB_00101fae:MovieWriter::_bind_methods();
         }
      ...
      MovieWriter::initialize_class()::initialized =
      '\x01';
   }
   ...
   '\x01';
   LAB_00101e94:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MovieWriterMJPEG::is_class(String const&) const */undefined8 MovieWriterMJPEG::is_class(MovieWriterMJPEG *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
 ...
 while ( !bVar9 );
      ...
      LAB_0010208f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
         ...
         LAB_0010221b:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
            ...
            LAB_001022fb:cVar6 = String::operator ==(param_1, (String*)&local_60);
            lVar4 = local_60;
            if (local_60 != 0) {
               LOCK();
               plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_00102143:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_001023a4:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* MovieWriterMJPEG::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void MovieWriterMJPEG::_get_property_listv(MovieWriterMJPEG *this, List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   undefined1(*pauVar4)[16];
...
/* MovieWriter::~MovieWriter() */void MovieWriter::~MovieWriter(MovieWriter *this) {
   ...
   *(code**)this = operator_delete;
   ...
   LAB_00102e17:if (*(void**)( this + 0x1a8 ) != (void*)0x0) {
      if (*(int*)( this + 0x1a0 ) != 0) {
...
/* MovieWriterMJPEG::~MovieWriterMJPEG() */void MovieWriterMJPEG::~MovieWriterMJPEG(MovieWriterMJPEG *this) {
   long *plVar1;
   long lVar2;
   Object *pOVar3;
   char cVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<unsigned int>::resize<false>(long) */undefined8 CowData<unsigned_int>::resize<false>(CowData<unsigned_int> *this, long param_1) {
   ...
   if (param_1 * 4 == 0) {
      LAB_001033f0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
/* WARNING: Control flow encountered bad instruction data *//* MovieWriterMJPEG::~MovieWriterMJPEG() */void MovieWriterMJPEG::~MovieWriterMJPEG(MovieWriterMJPEG *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* MovieWriter::~MovieWriter() */void MovieWriter::~MovieWriter(MovieWriter *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

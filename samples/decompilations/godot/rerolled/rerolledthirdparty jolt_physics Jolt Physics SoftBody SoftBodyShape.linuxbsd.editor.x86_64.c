/* JPH::SoftBodyShape::GetLocalBounds() const */void JPH::SoftBodyShape::GetLocalBounds(void) {
   long lVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
...
/* JPH::SoftBodyShape::CollideSoftBodyVertices(JPH::Mat44 const&, JPH::Vec3,
   JPH::CollideSoftBodyVertexIterator const&, unsigned int, int) const */void JPH::SoftBodyShape::CollideSoftBodyVertices(void) {
   return;
}
/* JPH::SoftBodyShape::Draw(JPH::DebugRenderer*, JPH::Mat44 const&, JPH::Vec3, JPH::Color, bool,
   bool) const */void JPH::SoftBodyShape::Draw(long param_1, long *param_2, float *param_3, undefined4 param_4) {
   float *pfVar1;
   long lVar2;
   long lVar3;
   float fVar4;
   ...
   for (; puVar30 != puVar29; puVar29 = puVar29 + 4) {
      ...
      fVar27 = pfVar1[1];
      fVar28 = pfVar1[2];
      ( **(code**)( *param_2 + 0x18 ) )(CONCAT44(fVar22 * fVar13 + fVar20 * fVar9 + fVar21 * fVar5 + fVar17, fVar22 * fVar12 + fVar20 * fVar8 + fVar21 * fVar4 + fVar16), CONCAT44(fVar22 * fVar15 + fVar20 * fVar11 + fVar21 * fVar7 + fVar19, fVar22 * fVar14 + fVar20 * fVar10 + fVar21 * fVar6 + fVar18), CONCAT44(fVar25 * fVar13 + fVar23 * fVar9 + fVar24 * fVar5 + fVar17, fVar25 * fVar12 + fVar23 * fVar8 + fVar24 * fVar4 + fVar16), CONCAT44(fVar25 * fVar15 + fVar23 * fVar11 + fVar24 * fVar7 + fVar19, fVar25 * fVar14 + fVar23 * fVar10 + fVar24 * fVar6 + fVar18), CONCAT44(fVar28 * fVar13 + fVar27 * fVar5 + fVar9 * fVar26 + fVar17, fVar28 * fVar12 + fVar27 * fVar4 + fVar8 * fVar26 + fVar16), CONCAT44(fVar28 * fVar15 + fVar27 * fVar7 + fVar11 * fVar26 + fVar19, fVar28 * fVar14 + fVar27 * fVar6 + fVar10 * fVar26 + fVar18), param_2, param_4, 0);
   }

   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::SoftBodyShape::GetTrianglesStart(JPH::Shape::GetTrianglesContext&, JPH::AABox const&,
   JPH::Vec3, JPH::Quat, JPH::Vec3) const */void JPH::SoftBodyShape::GetTrianglesStart(undefined8 param_1, float param_2_00, undefined8 param_3, undefined8 param_4, undefined8 param_5, uint param_6, undefined8 param_7, undefined8 *param_2) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   do {
      ...
      *(float*)( (long)&local_58 + lVar7 ) = fVar4 * local_a8 + fVar1 * ( ( _LC2 - fVar6 * fVar12 ) - fVar13 ) + fVar2 * ( fVar6 * fVar8 - fVar11 ) + fVar3 * ( fVar9 * fVar8 + fVar12 * fVar10 );
      *(float*)( (long)&local_58 + lVar7 + 4 ) = fVar4 * fStack_a4 + fVar1 * ( fVar6 * fVar8 + fVar11 ) + fVar2 * ( ( _LC2 - fVar13 ) - fVar5 * fVar8 ) + fVar3 * ( fVar9 * fVar12 - fVar8 * fVar10 );
      *(float*)( (long)&uStack_50 + lVar7 ) = fVar4 * param_2_00 + fVar1 * ( fVar9 * fVar8 - fVar12 * fVar10 ) + fVar2 * ( fVar8 * fVar10 + fVar9 * fVar12 ) + fVar3 * ( ( _LC2 - fVar5 * fVar8 ) - fVar6 * fVar12 );
...
/* JPH::SoftBodyShape::GetTrianglesNext(JPH::Shape::GetTrianglesContext&, int, JPH::Float3*,
   JPH::PhysicsMaterial const**) const */int JPH::SoftBodyShape::GetTrianglesNext(SoftBodyShape *this, GetTrianglesContext *param_1, int param_2, Float3 *param_3, PhysicsMaterial **param_4) {
   float *pfVar1;
   int iVar2;
   long lVar3;
   long lVar4;
...
/* JPH::SoftBodyShape::GetStats() const */undefined1  [16] __thiscallJPH::SoftBodyShape::GetStats(SoftBodyShape *this) {
...
/* JPH::SoftBodyShape::GetMaterial(JPH::SubShapeID const&) const */undefined8 JPH::SoftBodyShape::GetMaterial(SoftBodyShape *this, SubShapeID *param_1) {
   long lVar1;
   int iVar2;
   uint uVar3;
   ...
   return *(undefined8*)( *(long*)( lVar1 + 0xd8 ) + ( ulong ) * (uint*)( ( ulong )(uVar3 & *(uint*)param_1) * 0x10 + *(long*)( lVar1 + 0x30 ) + 0xc ) * 8 );
}
/* JPH::SoftBodyShape::GetSupportingFace(JPH::SubShapeID const&, JPH::Vec3, JPH::Vec3, JPH::Mat44
   const&, JPH::StaticArray<JPH::Vec3, 32u>&) const */void JPH::SoftBodyShape::GetSupportingFace(undefined8 param_1_00, undefined8 param_2, undefined8 param_3, float param_4, long param_1, uint *param_6, float *param_7, uint *param_8) {
   uint *puVar1;
   float *pfVar2;
   uint uVar3;
   long lVar4;
...
/* JPH::SoftBodyShape::CastRay(JPH::RayCast const&, JPH::SubShapeIDCreator const&,
   JPH::RayCastResult&) const */undefined8 JPH::SoftBodyShape::CastRay(SoftBodyShape *this, RayCast *param_1, SubShapeIDCreator *param_2, RayCastResult *param_3) {
   float *pfVar1;
   long lVar2;
   long lVar3;
   uint *puVar4;
 ...
 while ( puVar15 != puVar4 + lVar3 * 4 );
      if ((int)lVar17 != -1) {
         *(uint*)( param_3 + 8 ) = ~((int)(1L << ((byte)uVar16 & 0x3f)) + -1 << ((byte)*(undefined4 *)(param_2 + 4) & 0x1f)) & *(uint*)param_2 | (int)lVar17 << ( ( byte ) * (undefined4*)( param_2 + 4 ) & 0x1f );
         return 1;
      }
...
/* JPH::SoftBodyShape::CollidePoint(JPH::Vec3, JPH::SubShapeIDCreator const&,
   ...
   JPH::ShapeFilter const&) const */void JPH::SoftBodyShape::CollidePoint(void) {
   JPH::Shape::sCollidePointUsingRayCast();
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::SoftBodyShape::GetSurfaceNormal(JPH::SubShapeID const&, JPH::Vec3) const */undefined1[16];JPH::SoftBodyShape::GetSurfaceNormal(long param_1, uint *param_2) {
   float *pfVar1;
   float *pfVar2;
   float *pfVar3;
   long lVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::SoftBodyShape::GetSubmergedVolume(JPH::Mat44 const&, JPH::Vec3, JPH::Plane const&, float&,
   float&, JPH::Vec3&, JPH::Vec3) const */void JPH::SoftBodyShape::GetSubmergedVolume(void) {
   float *in_RCX;
   undefined4 *in_R8;
   undefined1(*in_R9)[16];
   float fVar1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::SoftBodyShape::GetVolume() const */float JPH::SoftBodyShape::GetVolume(void) {
   float fVar1;
   fVar1 = (float)JPH::SoftBodyMotionProperties::GetVolumeTimesSix();
   return fVar1 / __LC10;
}
/* JPH::SoftBodyShape::sCollideConvexVsSoftBody(JPH::Shape const*, JPH::Shape const*, JPH::Vec3,
   ...
   JPH::ShapeFilter const&) */void JPH::SoftBodyShape::sCollideConvexVsSoftBody(undefined8 param_1, long param_2) {
   uint *puVar1;
   uint *puVar2;
   uint *puVar3;
   uint uVar4;
   ...
   if (puVar11 != puVar3) {
      ...
      while (true) {
         ...
         uStack_21f0 = (int)( lVar9 >> 4 ) << ( bVar10 & 0x1f ) | ~((int)(1L << ((byte)uVar12 & 0x3f)) + -1 << (bVar10 & 0x1f)) & *in_R9;
         JPH::CollideConvexVsTriangles::Collide(*(undefined8*)( lVar7 + 0x10 + (ulong)uVar4 * 0x50 ), *(undefined8*)( lVar7 + 0x18 + (ulong)uVar4 * 0x50 ), *(undefined8*)( lVar7 + 0x10 + ( ulong ) * puVar1 * 0x50 ), *(undefined8*)( lVar7 + 0x18 + ( ulong ) * puVar1 * 0x50 ), *(undefined8*)( lVar7 + 0x10 + ( ulong ) * puVar2 * 0x50 ), *(undefined8*)( lVar7 + 0x18 + ( ulong ) * puVar2 * 0x50 ), aCStack_21e8, 7, &uStack_21f0);
...
/* JPH::SoftBodyShape::sCollideSphereVsSoftBody(JPH::Shape const*, JPH::Shape const*, JPH::Vec3,
   ...
   JPH::SubShapeIDCreator const&, JPH::CollideShapeSettings const&,
   JPH::CollisionCollector<JPH::CollideShapeResult, JPH::CollisionCollectorTraitsCollideShape>&,
   JPH::ShapeFilter const&) */void JPH::SoftBodyShape::sCollideSphereVsSoftBody(undefined8 param_1, long param_2) {
   uint *puVar1;
   uint *puVar2;
   uint *puVar3;
   uint uVar4;
   ...
   if (puVar11 != puVar3) {
      ...
      while (true) {
         ...
         uStack_e0 = (int)( lVar9 >> 4 ) << ( bVar10 & 0x1f ) | ~((int)(1L << ((byte)uVar12 & 0x3f)) + -1 << (bVar10 & 0x1f)) & *in_R9;
         JPH::CollideSphereVsTriangles::Collide(*(undefined8*)( lVar7 + 0x10 + (ulong)uVar4 * 0x50 ), *(undefined8*)( lVar7 + 0x18 + (ulong)uVar4 * 0x50 ), *(undefined8*)( lVar7 + 0x10 + ( ulong ) * puVar1 * 0x50 ), *(undefined8*)( lVar7 + 0x18 + ( ulong ) * puVar1 * 0x50 ), *(undefined8*)( lVar7 + 0x10 + ( ulong ) * puVar2 * 0x50 ), *(undefined8*)( lVar7 + 0x18 + ( ulong ) * puVar2 * 0x50 ), aCStack_d8, 7, &uStack_e0);
         if (puVar3 == puVar11) break;
         puVar13 = *(uint**)( lVar6 + 0x30 );
      }
;
...
/* JPH::SoftBodyShape::sCastConvexVsSoftBody(JPH::ShapeCast const&, JPH::ShapeCastSettings const&,
   ...
   JPH::CollisionCollectorTraitsCastShape>&) */void JPH::SoftBodyShape::sCastConvexVsSoftBody(undefined8 param_1, undefined8 param_2, long param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, uint *param_7, undefined8 param_8) {
   uint *puVar1;
   uint *puVar2;
   uint *puVar3;
   uint uVar4;
   ...
   JPH::CastConvexVsTriangles::CastConvexVsTriangles(aCStack_10d8, param_1, param_2, param_5, param_6, param_8);
   puVar11 = *(uint**)( lVar6 + 0x30 );
   puVar3 = puVar11 + *(long*)( lVar6 + 0x20 ) * 4;
   if (puVar11 != puVar3) {
      puVar13 = puVar11;
      while (true) {
         ...
         uStack_10e0 = (int)( lVar9 >> 4 ) << ( bVar10 & 0x1f ) | ~((int)(1L << ((byte)uVar12 & 0x3f)) + -1 << (bVar10 & 0x1f)) & *param_7;
         JPH::CastConvexVsTriangles::Cast(*(undefined8*)( lVar7 + 0x10 + (ulong)uVar4 * 0x50 ), *(undefined8*)( lVar7 + 0x18 + (ulong)uVar4 * 0x50 ), *(undefined8*)( lVar7 + 0x10 + ( ulong ) * puVar1 * 0x50 ), *(undefined8*)( lVar7 + 0x18 + ( ulong ) * puVar1 * 0x50 ), *(undefined8*)( lVar7 + 0x10 + ( ulong ) * puVar2 * 0x50 ), *(undefined8*)( lVar7 + 0x18 + ( ulong ) * puVar2 * 0x50 ), aCStack_10d8, 7, &uStack_10e0);
         if (puVar3 == puVar11) break;
         puVar13 = *(uint**)( lVar6 + 0x30 );
      }
;
...
/* JPH::SoftBodyShape::sCastSphereVsSoftBody(JPH::ShapeCast const&, JPH::ShapeCastSettings const&,
   JPH::Shape const*, JPH::Vec3, JPH::ShapeFilter const&, JPH::Mat44 const&, JPH::SubShapeIDCreator
   const&, JPH::SubShapeIDCreator const&, JPH::CollisionCollector<JPH::ShapeCastResult,
   JPH::CollisionCollectorTraitsCastShape>&) */void JPH::SoftBodyShape::sCastSphereVsSoftBody(undefined8 param_1, undefined8 param_2, long param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, uint *param_7, undefined8 param_8) {
   uint *puVar1;
   uint *puVar2;
   uint *puVar3;
   uint uVar4;
   ...
   JPH::CastSphereVsTriangles::CastSphereVsTriangles(aCStack_b8, param_1, param_2, param_5, param_6, param_8);
   puVar11 = *(uint**)( lVar6 + 0x30 );
   puVar3 = puVar11 + *(long*)( lVar6 + 0x20 ) * 4;
   if (puVar11 != puVar3) {
      puVar13 = puVar11;
      while (true) {
         ...
         uStack_c0 = (int)( lVar9 >> 4 ) << ( bVar10 & 0x1f ) | ~((int)(1L << ((byte)uVar12 & 0x3f)) + -1 << (bVar10 & 0x1f)) & *param_7;
         JPH::CastSphereVsTriangles::Cast(*(undefined8*)( lVar7 + 0x10 + (ulong)uVar4 * 0x50 ), *(undefined8*)( lVar7 + 0x18 + (ulong)uVar4 * 0x50 ), *(undefined8*)( lVar7 + 0x10 + ( ulong ) * puVar1 * 0x50 ), *(undefined8*)( lVar7 + 0x18 + ( ulong ) * puVar1 * 0x50 ), *(undefined8*)( lVar7 + 0x10 + ( ulong ) * puVar2 * 0x50 ), *(undefined8*)( lVar7 + 0x18 + ( ulong ) * puVar2 * 0x50 ), aCStack_b8, 7, &uStack_c0);
         if (puVar3 == puVar11) break;
         puVar13 = *(uint**)( lVar6 + 0x30 );
      }
;
...
/* JPH::SoftBodyShape::CastRay(JPH::RayCast const&, JPH::RayCastSettings const&,
   ...
   JPH::CollisionCollectorTraitsCastRay>&, JPH::ShapeFilter const&) const */void JPH::SoftBodyShape::CastRay(SoftBodyShape *this, RayCast *param_1, RayCastSettings *param_2, SubShapeIDCreator *param_3, CollisionCollector *param_4, ShapeFilter *param_5) {
   float *pfVar1;
   long lVar2;
   long lVar3;
   long lVar4;
   ...
   if (cVar7 != '\0') {
      ...
      if (puVar10 != puVar9) {
         LAB_00101232:do {
            ...
            if (( *param_2 != (RayCastSettings)0x0 ) || ( ( fVar33 * fVar13 - fVar12 * fVar34 ) * *(float*)( param_1 + 0x18 ) + ( fVar35 * fVar12 - fVar14 * fVar33 ) * *(float*)( param_1 + 0x14 ) + ( fVar34 * fVar14 - fVar13 * fVar35 ) * *(float*)( param_1 + 0x10 ) + 0.0 <= 0.0 )) {
               ...
               auVar21._0_4_ = (float)*(undefined8*)( param_1 + 0x18 ) * fVar24 + (float)( ( ulong ) * (undefined8*)( param_1 + 0x10 ) >> 0x20 ) * fVar33 + (float)*(undefined8*)( param_1 + 0x10 ) * fVar34 + 0.0;
               ...
               uVar28 = (int)-(uint)(auVar23._0_4_ < 0.0 ||
                               ...
                               (auVar22._0_4_ < 0.0 || _LC2 < auVar27._0_4_ + auVar22._0_4_))) >> 0x1f;
               ...
               if (fVar16 < *(float*)( param_4 + 8 )) {
                  ...
                  puVar11 = puVar10 + 4;
                  uStack_44 = (int)( (long)puVar10 - *(long*)( *(long*)( *(long*)( this + 0x20 ) + 0x100 ) + 0x30 ) >> 4 ) << ( ( byte ) * (undefined4*)( param_3 + 4 ) & 0x1f ) | ~((int)(1L << ((byte)uVar8 & 0x3f)) + -1 <<
...
/* JPH::SoftBodyShape::GetSubShapeIDBits() const */uint JPH::SoftBodyShape::GetSubShapeIDBits(SoftBodyShape *this) {
   int iVar1;
   uint uVar2;
...
/* JPH::SoftBodyShape::GetFaceIndex(JPH::SubShapeID const&) const */uint JPH::SoftBodyShape::GetFaceIndex(SoftBodyShape *this, SubShapeID *param_1) {
   int iVar1;
   uint uVar2;
   uVar2 = (int)*(undefined8*)( *(long*)( *(long*)( this + 0x20 ) + 0x100 ) + 0x20 ) - 1;
   if (uVar2 != 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::SoftBodyShape::sRegister() */void JPH::SoftBodyShape::sRegister(void) {
   byte bVar1;
   byte *pbVar2;
...
/* JPH::SoftBodyShape::MustBeStatic() const */undefined8 JPH::SoftBodyShape::MustBeStatic(void) {
   return 0;
}
/* JPH::SoftBodyShape::GetCenterOfMass() const */undefined1[16];JPH::SoftBodyShape::GetCenterOfMass(void) {
   return ZEXT816(0);
}
/* JPH::SoftBodyShape::GetInnerRadius() const */undefined8 JPH::SoftBodyShape::GetInnerRadius(void) {
   return 0;
}
/* JPH::SoftBodyShape::GetMassProperties() const */SoftBodyShape * __thiscall JPH::SoftBodyShape::GetMassProperties(SoftBodyShape *this){
...
/* JPH::SoftBodyShape::~SoftBodyShape() */void JPH::SoftBodyShape::~SoftBodyShape(SoftBodyShape *this) {
   return;
}
/* JPH::SoftBodyShape::~SoftBodyShape() */void JPH::SoftBodyShape::~SoftBodyShape(SoftBodyShape *this) {
...
/* JPH::SoftBodyShape::GetSubShapeIDBitsRecursive() const */uint JPH::SoftBodyShape::GetSubShapeIDBitsRecursive(SoftBodyShape *this) {
   int iVar1;
   uint uVar2;
   uVar2 = (int)*(undefined8*)( *(long*)( *(long*)( this + 0x20 ) + 0x100 ) + 0x20 ) - 1;
   if (uVar2 != 0) {
...
/* JPH::SoftBodyShape::GetSubShapeIDBits() const */void JPH::SoftBodyShape::_GLOBAL__sub_I_GetSubShapeIDBits(void) {
   if (DVec3::cTrue == '\0') {
      DVec3::cTrue = '\x01';
      DVec3::cTrue = _LC12;
   }
...
/* WARNING: Control flow encountered bad instruction data *//* JPH::SoftBodyShape::~SoftBodyShape() */void JPH::SoftBodyShape::~SoftBodyShape(SoftBodyShape *this) {

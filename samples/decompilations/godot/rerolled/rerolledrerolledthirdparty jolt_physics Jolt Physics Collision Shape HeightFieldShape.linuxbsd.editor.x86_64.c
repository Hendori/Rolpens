/* JPH::HeightFieldShape::GetMassProperties() const */HeightFieldShape * __thiscall JPH::HeightFieldShape::GetMassProperties(HeightFieldShape *this){
...
/* JPH::HeightFieldShape::CollidePoint(JPH::Vec3, JPH::SubShapeIDCreator const&,
   ...
   JPH::ShapeFilter const&) const */void JPH::HeightFieldShape::CollidePoint(void) {
   return;
}
/* JPH::HeightFieldShape::GetStats() const */undefined1[16];__thiscallJPH::HeightFieldShape::GetStats(HeightFieldShape *this) {
   ulong uVar1;
   ...
   auVar2._8_8_ = uVar1;
   auVar2._0_8_ = ( ulong ) * (uint*)( this + 0x50 ) + ( ulong ) * (uint*)( this + 0x48 ) + *(long*)( this + 0x90 ) + ( *(long*)( this + 0x78 ) + 0x1a + ( ulong ) * (uint*)( this + 0x4c ) * 2 ) * 8;
   return auVar2;
}
/* JPH::HeightFieldShapeSettings::sCreateRTTI(JPH::RTTI&) */void JPH::HeightFieldShapeSettings::sCreateRTTI(RTTI *param_1) {
   int iVar1;
   iVar1 = JPH::GetRTTIOfType((ShapeSettings*)0x0);
   JPH::RTTI::AddBaseClass(param_1, iVar1);
   return;
}
/* JPH::HeightFieldShape::SaveBinaryState(JPH::StreamOut&) const */void JPH::HeightFieldShape::SaveBinaryState(HeightFieldShape *this, StreamOut *param_1) {
   char cVar1;
   long in_FS_OFFSET;
   int local_24;
   long local_20;
   ...
   if (*(long*)( this + 0x60 ) == 0) {
      ...
      if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
         ...
         ( **(code**)( *(long*)param_1 + 0x10 ) )(param_1, *(undefined8*)( this + 0x60 ), ( ulong ) * (uint*)( this + 0x48 ) + ( ulong ) * (uint*)( this + 0x50 ) + ( ulong ) * (uint*)( this + 0x4c ) * 0x10);
         return;
      }
...
/* JPH::HeightFieldShape::GetLocalBounds() const */void JPH::HeightFieldShape::GetLocalBounds(void) {
   ushort uVar1;
   ushort uVar2;
   float fVar3;
   float fVar4;
...
/* _FUN() */void JPH::GetRTTIOfType(JPH::HeightFieldShapeSettings *) {
   lambda()
   #1
   {
      undefined4 uVar1;
      ...
      *(undefined4*)( puVar2 + 0x18 ) = 0x3f7f06a3;
      for (int i = 0; i < 3; i++) {
         *(undefined1(*) [16])( puVar2 + ( 3 * i + 15 ) ) = (undefined1[16])0;
      }
   ...
   void JPH::HeightFieldShape::HSGetTrianglesContext::VisitRangeBlock(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7, undefined8 param_8, long param_9, undefined1 (*param_10)[16]) {
      float fVar1;
      float fVar2;
      float fVar3;
      float fVar4;
      ...
      for (int i = 0; i < 3; i++) {
         local_a8[( 4 * i + 3 )] = *(float*)( param_9 + ( 4 * i + 592 ) );
      }
 ...
 while ( local_a8 + 0x18 != pfVar19 );
      ...
      auVar72._0_4_ = -(uint)(auVar39._0_4_ <=
      ...
      auVar34._0_4_ = -(uint)(auVar32._0_4_ <=
      ...
      auVar8._8_4_ = -(uint)(auVar68._8_4_ <=
                        ...
                        local_a8[0xc] * fVar12 + local_a8[0x14] * fVar10);
      auVar8._12_4_ = -(uint)(auVar68._12_4_ <=
   ...
   /* _FUN() */
   void JPH::HeightFieldShape::sRegister() {
      lambda()
      #1
      {
         undefined8 uVar1;
      ...
      void JPH::HeightFieldShape::~HeightFieldShape(HeightFieldShape *this) {
         long *plVar1;
         undefined8 *puVar2;
         long *plVar3;
         int *piVar4;
         ...
         *(undefined***)this = &PTR__HeightFieldShape_00116440;
         ...
         if (puVar6 != (undefined8*)0x0) {
            if (( *(long*)( this + 0xb0 ) != 0 ) && ( puVar2 = puVar6 < puVar2 )) {
               do {
                  while (piVar4 = (int*)*puVar6,piVar4 == (int*)0x0) {
                     LAB_00100e00:puVar6 = puVar6 + 1;
...
;
                  ...
                  *piVar4 = *piVar4 + -1;
                  ...
                  if (plVar5 != (long*)0x0) {
                     if (( *(long*)( piVar4 + 2 ) != 0 ) && ( plVar7 = plVar5 < plVar7 )) {
                        do {
 ...
 while ( puVar6 < puVar2 );
               LAB_00100e88:puVar6 = *(undefined8**)( this + 0xc0 );
            }
         ...
         if (( *(long*)( this + 0x78 ) != 0 ) && ( plVar7 = plVar5 < plVar7 )) {
            do {
               while (plVar3 = (long*)*plVar5,plVar3 == (long*)0x0) {
                  LAB_00100d80:plVar5 = plVar5 + 1;
...
;
 ...
 while ( plVar5 < plVar7 );
            LAB_00100dc0:plVar5 = *(long**)( this + 0x88 );
         }
      ...
      undefined1 *JPH::HeightFieldShapeSettings::GetRTTI(void) {
         ...
         if (GetRTTIOfType(JPH::HeightFieldShapeSettings * ::rtti == '\0') {
            ...
            if (iVar1 != 0) {
               JPH::RTTI::RTTI((RTTI*)GetRTTIOfType(JPH::HeightFieldShapeSettings * ::rtti, "HeightFieldShapeSettings", 0xd0, GetRTTIOfType(JPH::HeightFieldShapeSettings * ::_FUN, GetRTTIOfType(JPH::HeightFieldShapeSettings*)::, {
                              lambda(void*)
                              #1
                              sCreateRTTI;
...
, }
  return, GetRTTIOfType(JPH::HeightFieldShapeSettings * ::rtti, ;
   ...
   long) const [clone .part.0] */, void __thiscall, JPH::HeightFieldShape::GetHeights(HeightFieldShape * this, uint, param_1, uint, param_2, uint, param_3, uint, param_4, float, *param_5, long, param_6), {
                                 float fVar1;
                                 float fVar2;
                                 float fVar3;
                                       ...
                                       do {
                                          if (uVar5 <= param_3) {
                                             ...
                                             do {
                                                ...
                                                lVar21 = ( ulong )(( uVar19 >> 1 ) + (int)( uVar22 >> 1 ) * ( uVar12 / uVar5 + 1 >> 1 ) + uVar17) * 0x10 + lVar6;
                                                uVar19 = ( uint ) * (ushort*)( lVar21 + uVar11 * 2 );
                                                fVar3 = *(float*)( this + 0x24 );
                                                fVar26 = ( (float)(int)( *(ushort*)( lVar21 + 8 + uVar11 * 2 ) - uVar19 ) / (float)(byte)HVar4 ) * fVar2;
                                                if (uVar5 != 0) {
                                                   ...
                                                   while (true) {
                                                      ...
                                                      while (true) {
                                                         ...
                                                         uVar13 = (int)( uint ) * (ushort*)( lVar21 + ( ulong )(uVar13 >> 3) ) >> ( (byte)uVar13 & 7 ) & (uint)(byte)HVar4;
                                                         fVar25 = fVar7;
...
, /* _FUN(void*) */, , void, JPH::GetRTTIOfType(JPH::HeightFieldShapeSettings * *::_FUN(void,, *param_1) * plVar1 * pHVar2 * plVar3 * plVar4 * this * plVar5(param_1 == (void*)0x0) = *(long**)( (long)param_1 + 0xb8 ) * (undefined***)param_1 = &PTR_GetRTTI_00116408(plVar5 != (long*)0x0)(( *(long*)( (long)param_1 + 0xa8 ) != 0 ) && ( plVar3 = plVar5 + *(long*)( (long)param_1 + 0xa8 ) ), plVar5 < plVar3))(plVar4 = (long*)*plVar5, plVar4 == (long*)0x0) = plVar5 + 1(plVar3 <= plVar5), goto LAB_00101310;
        }, LOCK() + 1 * (int*)plVar1 = (int)*plVar1 + -1, ;, UNLOCK())((int)*plVar1 != 0)(*(code**)( *plVar4 + 0x18 ) != PhysicsMaterial::~PhysicsMaterial)(**(code**)( *plVar4 + 0x18 ))()(*Free)() + 1(plVar5 < plVar3) * (long**)( (long)param_1 + 0xb8 ) * (undefined8*)( (long)param_1 + 0xa8 ) = 0(*Free)(plVar5)(*(long*)( (long)param_1 + 0xa0 ) != 0) * (undefined8*)( (long)param_1 + 0x90 ) = 0(*Free)()(*(long*)( (long)param_1 + 0x88 ) != 0) * (undefined8*)( (long)param_1 + 0x78 ) = 0(*Free)() * (undefined8**)param_1 = &Reallocate(*(char*)( (long)param_1 + 0x38 ) == '\x01') * (HeightFieldShape**)( (long)param_1 + 0x18 )(this != (HeightFieldShape*)0x0), {
            LOCK() + 8 * (int*)pHVar2 = *(int*)pHVar2 + -1, ;
            UNLOCK()(*(int*)pHVar2 == 0)(*(code**)( *(long*)this + 8 ) == HeightFieldShape::~HeightFieldShape), {
   ...
   else if = (( *(char*)( (long)param_1 + 0x38 ) == '\x02' ) && ( *(long*)( (long)param_1 + 0x18 ) != (long)param_1 + 0x28 ));
   {
      ( *Free )();
   }
...
/* JPH::HeightFieldShape::RestoreMaterialState(JPH::RefConst<JPH::PhysicsMaterial> const*, unsigned
   int) */void JPH::HeightFieldShape::RestoreMaterialState(HeightFieldShape *this, RefConst *param_1, uint param_2) {
   long *plVar1;
   RefConst *pRVar2;
   long *plVar3;
   long lVar4;
...
/* JPH::HeightFieldShape::SaveMaterialState(JPH::Array<JPH::RefConst<JPH::PhysicsMaterial>,
   JPH::STLAllocator<JPH::RefConst<JPH::PhysicsMaterial> > >&) const */void JPH::HeightFieldShape::SaveMaterialState(HeightFieldShape *this, Array *param_1) {
   long *plVar1;
   long *plVar2;
   long *plVar3;
   long *plVar4;
...
;
   ...
   LAB_00101620:*(undefined8*)param_1 = 0;
   uVar13 = lVar14 >> 3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* void JPH::HeightFieldShape::WalkHeightField<JPH::HeightFieldShape::CastRay(JPH::RayCast const&,
   ...
   JPH::RayCastSettings const&, JPH::SubShapeIDCreator const&,
   JPH::CollisionCollector<JPH::RayCastResult, JPH::CollisionCollectorTraitsCastRay>&,
   JPH::ShapeFilter const&) const::Visitor&) const */void JPH::HeightFieldShape::WalkHeightField<JPH::HeightFieldShape::CastRay(JPH::RayCast_const &, JPH::RayCastSettings_const &, JPH::SubShapeIDCreator_const &, JPH::CollisionCollector<JPH::RayCastResult,JPH::CollisionCollectorTraitsCastRay> &, JPH::ShapeFilter_const &)const::Visitor(HeightFieldShape *this, Visitor *param_1) {
...
;
      ...
      do {
         ...
         if (uVar38 < local_400) {
            ...
            auVar128 = *(undefined1(*) [16])( ( ulong )(uVar36 * uVar37 + ( &sGridOffsets )[uVar38] + uVar64) * 0x10 + *(long*)( local_258 + 0x60 ) );
            iVar47 = uVar64 * 2;
            auVar9._10_2_ = 0;
            ...
            fVar120 = (float)(int)( ( auVar99._8_8_ & 0xffffffff ) * (ulong)uVar81 ) * fStack_490 + fStack_460;
            ...
            fVar80 = (float)(int)( ~uVar36 & auVar89._0_4_ * uVar81 | local_428 & uVar36 ) * fStack_498 + fStack_468;
            fVar132 = (float)(int)( ~uVar37 & auVar89._4_4_ * uVar81 | uStack_424 & uVar37 ) * fStack_494 + fStack_464;
            ...
            fVar115 = (float)(int)( ( auVar124._8_8_ & 0xffffffff ) * (ulong)uVar81 ) * fStack_4b0 + fStack_480;
            ...
            fVar84 = (float)(int)( ~uVar36 & uVar81 * auVar90._0_4_ | local_428 & uVar36 ) * fStack_4b8 + fStack_488;
            fVar93 = (float)(int)( ~uVar37 & uVar81 * auVar90._4_4_ | uStack_424 & uVar37 ) * fStack_4b4 + fStack_484;
            ...
            auVar128 = ( auVar77 | auVar100 ) & auVar22 | ( auVar131 | auVar107 ) & auVar20 | auVar142 | auVar159 | auVar146 | auVar126 | ( auVar91 | auVar103 ) & auVar18 | auVar164;
            ...
            if (uVar38 < (uint)auStack_378._0_4_) {
               ...
               do {
                  ...
                  if (uVar50 < uVar36) {
                     ...
                     do {
                        iVar56 = (int)uVar48;
                        uVar39 = (int)( uint ) * (ushort*)( lVar42 + ( ulong )(uVar55 >> 3) ) >> ( (byte)uVar55 & 7 ) & uVar81;
                        *(bool*)uVar48 = HVar1 == SUB41(uVar39, 0);
                        uVar48 = uVar48 + 1;
                        uVar55 = uVar55 + (byte)HVar2;
                        auVar85._0_4_ = (float)( ( uVar50 - iVar46 ) + iVar56 ) * auVar128._0_4_ + auVar140._0_4_;
                        auVar85._4_4_ = ( ( (float)uVar39 + fVar69 ) * ( (float)(int)( uVar3 - uVar44 ) / fVar71 ) + (float)uVar44 ) * auVar128._4_4_ + auVar140._4_4_;
            ...
            if (uVar64 < local_404) {
               ...
               if (uVar38 < (uint)auStack_378._0_4_) {
                  ...
                  do {
                     ...
                     *(float*)( *pauVar63 + 4 ) = ( ( (float)uVar39 + fVar69 ) * ( (float)(int)( uVar3 - uVar44 ) / fVar71 ) + (float)uVar44 ) * fVar79 + fVar136;
 ...
 while ( auStack_378._0_4_ != uVar67 );
            ...
            if (uVar37 < local_404) {
               ...
               if (uVar50 < uVar36) {
                  ...
                  pauVar49 = pauVar63;
                  do {
                     uVar55 = (int)( uint ) * (ushort*)( lVar5 + ( ulong )(uVar67 >> 3) ) >> ( (byte)uVar67 & 7 ) & uVar81;
                     *(bool*)lVar40 = HVar1 == SUB41(uVar55, 0);
                     iVar56 = (int)lVar40;
                     lVar40 = lVar40 + 1;
                     uVar67 = uVar67 + (byte)HVar2;
                     *(float*)*pauVar49 = (float)( ( uVar50 - iVar46 ) + iVar56 ) * fVar66 + fVar134;
                     *(float*)( *pauVar49 + 4 ) = ( ( (float)uVar55 + fVar69 ) * ( (float)(int)( uVar3 - uVar37 ) / fVar71 ) + (float)uVar37 ) * fVar79 + fVar136;
 ...
 while ( lVar40 != lVar42 );
               ...
               if (uVar64 < local_404) {
                  ...
                  uVar37 = ( *(int*)( local_258 + 0x40 ) * auStack_378._0_4_ + uVar36 ) * (uint)(byte)local_258[0x54];
                  uVar81 = (int)( uint ) * (ushort*)( *(long*)( local_258 + 0x68 ) + ( ulong )(uVar37 >> 3) ) >> ( (byte)uVar37 & 7 ) & uVar81;
                  ...
                  *(float*)*pauVar63 = (float)uVar36 * *(float*)( local_258 + 0x30 ) + *(float*)( local_258 + 0x20 );
                  *(float*)( *pauVar63 + 4 ) = ( ( (float)uVar81 + fVar69 ) * ( (float)(int)( uVar3 - uVar64 ) / fVar71 ) + (float)uVar64 ) * fVar66 + fVar132;
...
;
 ...
 while ( lVar68 != 0x40 );
            ...
            fStack_37c = *(float*)( local_3e0 + 0x34 );
            fStack_38c = *(float*)( local_3e0 + 0x38 );
            auVar148._0_8_ = CONCAT44(( fVar82 - fVar71 ) * fStack_37c, ( (float)auStack_2d8._4_4_ - fVar71 ) * fStack_37c);
            ...
            auVar139._0_8_ = CONCAT44(( fVar95 - fVar69 ) * fVar79, ( (float)auStack_2d8._0_4_ - fVar69 ) * fVar79);
            ...
            auVar128 = ( auVar73 | auVar143 ) & auVar21 | ( auVar104 | auVar110 ) & auVar19 | auVar130 | auVar153 | auVar123 | auVar97 | ( auVar87 | auVar101 ) & auVar17 | auVar162;
            uVar36 = auVar128._0_4_ >> 0x1f;
            uVar37 = auVar128._4_4_ >> 0x1f;
                           ...
                           do {
                              ...
                              if (( *pcVar41 == '\0' ) && ( pcVar41[uVar65] == '\0' )) {
                                 ...
                                 while (true) {
                                    ...
                                    if (( pVVar62[0x50] != (Visitor)0x0 ) || ( 0.0 <= ( fVar69 * fVar134 - fVar132 * fVar79 ) * *(float*)( pVVar62 + 0x28 ) + ( fVar80 * fVar132 - fVar136 * fVar69 ) * *(float*)( pVVar62 + 0x24 ) + ( fVar79 * fVar136 - fVar134 * fVar80 ) * *(float*)( pVVar62 + 0x20 ) + 0.0 )) {
                                       fVar82 = fVar79 * *(float*)( pVVar62 + 0x20 ) - *(float*)( pVVar62 + 0x24 ) * fVar69;
                                       fVar92 = fVar80 * *(float*)( pVVar62 + 0x24 ) - *(float*)( pVVar62 + 0x28 ) * fVar79;
                                       fVar94 = fVar69 * *(float*)( pVVar62 + 0x28 ) - *(float*)( pVVar62 + 0x20 ) * fVar80;
                                       ...
                                       auVar102._0_4_ = (float)*(long*)( pVVar62 + 0x28 ) * fVar83 + (float)( ( ulong ) * (long*)( pVVar62 + 0x20 ) >> 0x20 ) * fVar132 + (float)*(long*)( pVVar62 + 0x20 ) * fVar134 + 0.0;
                                       auVar102._4_4_ = auVar102._0_4_;
                                       auVar102._8_4_ = auVar102._0_4_;
                                       auVar102._12_4_ = auVar102._0_4_;
                                       auVar75._0_4_ = fVar80 * fVar83 + fVar79 * fVar132 + fVar134 * fVar69 + 0.0;
                                       ...
                                       if (fVar69 < fVar160) {
                                          ...
                                          uStack_34c = iVar46 + ( *(int*)( *(long*)( pVVar62 + 0x58 ) + 0x40 ) * auStack_378._0_4_ + (int)fVar66 ) * 2 << ( ( byte ) * (undefined4*)( pVVar62 + 100 ) & 0x1f ) | ~(iVar56 << ((byte)*(undefined4 *)(pVVar62 + 100) & 0x1f)) & *(uint*)( pVVar62 + 0x60 );
                                    ...
                                    if (iVar46 == 1) break;
                                    LAB_00102582:if (pcVar41[1] != '\0') break;
                                    auVar128 = *pauVar63;
...
;
 ...
 while ( fVar160 < *(float*)( pVVar62 + lVar40 + ( (long)(int)( ( uVar64 - 1 ) + iStack_3fc ) - (long)(int)uVar64 ) * 4 + 0x6c ) || fVar160 == *(float*)( pVVar62 + lVar40 + ( (long)(int)( ( uVar64 - 1 ) + iStack_3fc ) - (long)(int)uVar64 ) * 4 + 0x6c ) );
               }
 while ( true );
            }
         ...
         LAB_00102624:piVar51 = (int*)( puVar53 + lVar7 );
 ...
 while ( fVar160 < *(float*)( local_3e0 + lVar40 + 0x68 ) || fVar160 == *(float*)( local_3e0 + lVar40 + 0x68 ) );
         local_250 = iVar47;
 ...
 while ( true );
   ...
   LAB_00101768:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
...
/* JPH::HeightFieldShape::CastRay(JPH::RayCast const&, JPH::RayCastSettings const&,
   ...
   .isra.0] */void JPH::HeightFieldShape::CastRay(RayCast *param_1, RayCastSettings *param_2, SubShapeIDCreator *param_3, CollisionCollector *param_4, ShapeFilter *param_5) {
   ...
   local_230 = param_1;
   local_228 = param_4;
   WalkHeightField<JPH::HeightFieldShape::CastRay(JPH::RayCast_const &, JPH::RayCastSettings_const &, JPH::SubShapeIDCreator_const &, JPH::CollisionCollector<JPH::RayCastResult,JPH::CollisionCollectorTraitsCastRay> &, JPH::ShapeFilter_const &)const::Visitor > ( (HeightFieldShape*)param_1,(Visitor*)local_288 );
   if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* JPH::HeightFieldShape::CastRay(JPH::RayCast const&, JPH::RayCastSettings const&,
   JPH::SubShapeIDCreator const&, JPH::CollisionCollector<JPH::RayCastResult,
   JPH::CollisionCollectorTraitsCastRay>&, JPH::ShapeFilter const&) const */void JPH::HeightFieldShape::CastRay(HeightFieldShape *this, RayCast *param_1, RayCastSettings *param_2, SubShapeIDCreator *param_3, CollisionCollector *param_4, ShapeFilter *param_5) {
   char cVar1;
   ...
   CastRay((RayCast*)this, (RayCastSettings*)param_1, (SubShapeIDCreator*)( ulong )(byte) * param_2, *(CollisionCollector**)param_3, (ShapeFilter*)param_4);
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* void JPH::HeightFieldShape::WalkHeightField<JPH::HeightFieldShape::CastRay(JPH::RayCast const&,
   ...
   const&, JPH::RayCastResult&) const::Visitor&) const [clone .constprop.0] */void JPH::HeightFieldShape::WalkHeightField<JPH::HeightFieldShape::CastRay(JPH::RayCast_const&,JPH::SubShapeIDCreator_const&,JPH::RayCastResult&)const::Visitor>(HeightFieldShape *this, Visitor *param_1) {
   Visitor *pVVar1;
   HeightFieldShape HVar2;
   ...
   local_3d0 = param_1;
   if (*(int*)( this + 0x48 ) == 0) {
      LAB_00103338:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
...
;
   ...
   do {
      ...
      if (uVar28 < local_3b8) {
         ...
         auVar120 = *(undefined1(*) [16])( ( ulong )(uVar26 * uVar27 + ( &sGridOffsets )[uVar28] + uVar55) * 0x10 + *(long*)( local_258 + 0x60 ) );
         iVar61 = uVar55 * 2;
         auVar7._10_2_ = 0;
         ...
         fVar72 = (float)(int)( ~uVar27 & auVar80._0_4_ * uVar26 | local_3f8 & uVar27 ) * fStack_4c8 + fStack_498;
         fVar73 = (float)(int)( ~uVar28 & auVar80._4_4_ * uVar26 | uStack_3f4 & uVar28 ) * fStack_4c4 + fStack_494;
         ...
         fVar100 = (float)(int)( ( auVar110._8_8_ & 0xffffffff ) * (ulong)uVar26 ) * fStack_4e0 + fStack_4b0;
         ...
         fVar91 = (float)(int)( ~uVar27 & uVar26 * auVar81._0_4_ | local_3f8 & uVar27 ) * fStack_4e8 + fStack_4b8;
         fVar84 = (float)(int)( ~uVar28 & uVar26 * auVar81._4_4_ | uStack_3f4 & uVar28 ) * fStack_4e4 + fStack_4b4;
         ...
         uVar26 = (int)( -(uint)(fVar65 < fVar102 || fVar72 < fVar65) & uStack_390 | -(uint)(fVar64 < fVar118 || fVar90 < fVar64) & uStack_3a0 | -(uint)((auVar120._0_4_ < auVar131._0_4_ || auVar120._0_4_ < 0.0) ||
                            (fVar72 < fVar102 || fVar90 < fVar118)) | -(uint)(fVar35 < fVar97 || fVar91 < fVar35) & uStack_3c0 | -(uint)(fVar91 < fVar97) ) >> 0x1f;
         uVar27 = (int)( -(uint)(fVar65 < fVar104 || fVar73 < fVar65) & uStack_390 | -(uint)(fVar64 < fVar124 || fVar107 < fVar64) & uStack_3a0 | -(uint)((auVar120._4_4_ < auVar131._4_4_ || auVar120._4_4_ < 0.0) ||
                            (fVar73 < fVar104 || fVar107 < fVar124)) | -(uint)(fVar35 < fVar99 || fVar84 < fVar35) & uStack_3c0 | -(uint)(fVar84 < fVar99) ) >> 0x1f;
         uVar28 = (int)( -(uint)(fVar65 < fVar105 || fVar86 < fVar65) & uStack_390 | -(uint)(fVar64 < fVar125 || fVar113 < fVar64) & uStack_3a0 | -(uint)((auVar120._8_4_ < auVar131._8_4_ || auVar120._8_4_ < 0.0) ||
                            (fVar86 < fVar105 || fVar113 < fVar125)) | -(uint)(fVar35 < fVar100 || fVar85 < fVar35) & uStack_3c0 | -(uint)(fVar85 < fVar100) ) >> 0x1f;
         uVar55 = (int)( -(uint)(fVar65 < fVar106 || fVar89 < fVar65) & uStack_390 | -(uint)(fVar64 < fVar126 || fVar114 < fVar64) & uStack_3a0 | -(uint)((auVar120._12_4_ < auVar131._12_4_ || auVar120._12_4_ < 0.0) ||
                            (fVar89 < fVar106 || fVar114 < fVar126)) | -(uint)(fVar35 < fVar101 || fVar88 < fVar35) & uStack_3c0 | -(uint)(fVar88 < fVar101) ) >> 0x1f;
         ...
         if (uStack_474 < uVar123) {
            do {
               ...
               if (uStack_3e8 < uVar28) {
                  ...
                  do {
                     iVar58 = (int)uVar38;
                     uVar30 = (int)( uint ) * (ushort*)( lVar32 + ( ulong )(uVar51 >> 3) ) >> ( (byte)uVar51 & 7 ) & uVar31;
                     *(bool*)uVar38 = HVar2 == SUB41(uVar30, 0);
                     uVar38 = uVar38 + 1;
                     uVar51 = uVar51 + (byte)HVar3;
                     *pfVar54 = (float)( ( uStack_3e8 - iVar52 ) + iVar58 ) * fVar86 + fVar35;
                     pfVar54[1] = ( ( (float)uVar30 + fVar65 ) * ( (float)(int)( uVar4 - uVar36 ) / fVar64 ) + (float)uVar36 ) * fVar89 + fVar66;
 ...
 while ( uVar123 != uVar59 );
         ...
         if (uVar55 < local_3d4) {
            ...
            if (uStack_474 < uVar123) {
               ...
               do {
                  uVar38 = (ulong)uVar29;
                  uVar51 = (int)( uint ) * (ushort*)( lVar40 + ( ulong )(uVar36 >> 3) ) >> ( (byte)uVar36 & 7 ) & uVar31;
                  ...
                  *pfVar46 = (float)uVar28 * fVar35 + fVar86;
                  pfVar46[1] = ( ( (float)uVar51 + fVar65 ) * ( (float)(int)( uVar4 - uVar59 ) / fVar64 ) + (float)uVar59 ) * fVar66 + fVar89;
 ...
 while ( uVar123 != uVar29 );
         ...
         if (uVar27 < local_3d4) {
            ...
            if (uStack_3e8 < uVar28) {
               ...
               pfVar54 = pfVar46;
               do {
                  uVar29 = (int)( uint ) * (ushort*)( lVar32 + ( ulong )(uVar27 >> 3) ) >> ( (byte)uVar27 & 7 ) & uVar31;
                  *(bool*)lVar40 = HVar2 == SUB41(uVar29, 0);
                  iVar52 = (int)lVar40;
                  lVar40 = lVar40 + 1;
                  uVar27 = uVar27 + (byte)HVar3;
                  *pfVar54 = (float)( ( uStack_3e8 - (int)lStack_4f8 ) + iVar52 ) * fVar35 + fVar86;
                  pfVar54[1] = ( ( (float)uVar29 + fVar65 ) * ( (float)(int)( uVar4 - uVar26 ) / fVar64 ) + (float)uVar26 ) * fVar66 + fVar89;
 ...
 while ( lVar40 != lStack_470 );
            ...
            if (uVar55 < local_3d4) {
               ...
               uVar31 = (int)( uint ) * (ushort*)( *(long*)( local_258 + 0x68 ) + ( ulong )(uVar26 >> 3) ) >> ( (byte)uVar26 & 7 ) & uVar31;
               ...
               *pfVar46 = (float)uVar28 * *(float*)( local_258 + 0x30 ) + *(float*)( local_258 + 0x20 );
               pfVar46[1] = ( ( (float)uVar31 + fVar65 ) * ( (float)(int)( uVar4 - uVar27 ) / fVar64 ) + (float)uVar27 ) * fVar35 + fVar73;
 ...
 while ( lVar60 != 0x40 );
         ...
         uStack_3a8 = CONCAT44(uStack_3a0, uStack_3a0);
         _uStack_398 = CONCAT44(uStack_390, uStack_390);
         auVar76._0_8_ = CONCAT44(( fVar89 - fStack_488 ) * fVar65, ( (float)auStack_2d8._0_4_ - fStack_488 ) * fVar65);
         auVar76._8_4_ = ( fStack_2b8 - fStack_488 ) * fVar65;
         auVar76._12_4_ = ( fVar64 - fStack_488 ) * fVar65;
         auStack_428._0_8_ = CONCAT44(( fVar91 - fStack_484 ) * fStack_36c, ( (float)auStack_2d8._4_4_ - fStack_484 ) * fStack_36c);
         ...
         uVar26 = (int)( -(uint)(fStack_484 < (float)auStack_2d8._4_4_ ||
                            (float)auStack_298._4_4_ < fStack_484) & uStack_3a0 | -(uint)(fStack_488 < (float)auStack_2d8._0_4_ ||
                            (float)auStack_298._0_4_ < fStack_488) & uStack_390 | -(uint)(((float)auStack_298._0_4_ < (float)auStack_2d8._0_4_ ||
                             (float)auStack_298._4_4_ < (float)auStack_2d8._4_4_) ||
                            (auVar120._0_4_ < auVar131._0_4_ || auVar120._0_4_ < 0.0)) | uStack_3c0 & -(uint)(fStack_480 < fStack_2d0 || fStack_290 < fStack_480) | -(uint)(fStack_290 < fStack_2d0) ) >> 0x1f;
         uVar27 = (int)( -(uint)(fStack_484 < fVar91 || fVar86 < fStack_484) & uStack_3a0 | -(uint)(fStack_488 < fVar89 || fVar73 < fStack_488) & uStack_390 | -(uint)((fVar73 < fVar89 || fVar86 < fVar91) ||
                            (auVar120._4_4_ < auVar131._4_4_ || auVar120._4_4_ < 0.0)) | uStack_3c0 & -(uint)(fStack_480 < fStack_2c0 || fStack_280 < fStack_480) | -(uint)(fStack_280 < fStack_2c0) ) >> 0x1f;
         uVar28 = (int)( -(uint)(fStack_484 < fStack_2b4 || fStack_274 < fStack_484) & uStack_3a0 | -(uint)(fStack_488 < fStack_2b8 || fStack_278 < fStack_488) & uStack_390 | -(uint)((fStack_278 < fStack_2b8 || fStack_274 < fStack_2b4) ||
                            (auVar120._8_4_ < auVar131._8_4_ || auVar120._8_4_ < 0.0)) | uStack_3c0 & -(uint)(fStack_480 < fStack_2b0 || fStack_270 < fStack_480) | -(uint)(fStack_270 < fStack_2b0) ) >> 0x1f;
         uVar55 = (int)( -(uint)(fStack_484 < fVar66 || fVar72 < fStack_484) & uStack_3a0 | -(uint)(fStack_488 < fVar64 || fVar35 < fStack_488) & uStack_390 | -(uint)((fVar35 < fVar64 || fVar72 < fVar66) ||
                            (auVar120._12_4_ < auVar131._12_4_ || auVar120._12_4_ < 0.0)) | uStack_3c0 & -(uint)(fStack_480 < fStack_2a0 || fStack_260 < fStack_480) | -(uint)(fStack_260 < fStack_2a0) ) >> 0x1f;
         fVar65 = (float)( uVar26 & _LC13 | ~uVar26 & (uint)auVar131._0_4_ );
         fVar64 = (float)( uVar27 & _UNK_00116654 | ~uVar27 & (uint)auVar131._4_4_ );
         fVar35 = (float)( uVar28 & _UNK_00116658 | ~uVar28 & (uint)auVar131._8_4_ );
         fVar66 = (float)( uVar55 & _UNK_0011665c | ~uVar55 & (uint)auVar131._12_4_ );
                        ...
                        do {
                           ...
                           if (( *pcVar33 == '\0' ) && ( pcVar33[uVar38] == '\0' )) {
                              ...
                              do {
                                 ...
                                 LAB_00103ff0:fVar66 = fVar66 - fVar86;
                                 ...
                                 fVar84 = fVar72 * *(float*)( local_3d0 + 0x20 ) - *(float*)( local_3d0 + 0x24 ) * fVar66;
                                 fVar88 = fVar73 * *(float*)( local_3d0 + 0x24 ) - *(float*)( local_3d0 + 0x28 ) * fVar72;
                                 fVar90 = fVar66 * *(float*)( local_3d0 + 0x28 ) - *(float*)( local_3d0 + 0x20 ) * fVar73;
                                 ...
                                 auVar109._0_4_ = (float)*(long*)( local_3d0 + 0x28 ) * fVar85 + (float)( ( ulong ) * (long*)( local_3d0 + 0x20 ) >> 0x20 ) * fVar107 + (float)*(long*)( local_3d0 + 0x20 ) * fVar113 + 0.0;
                                 ...
                                 if (fVar72 < *(float*)( uVar92 + 4 )) {
                                    ...
                                    *(uint*)( uVar92 + 8 ) = iVar58 + ( *(int*)( lVar60 + 0x40 ) * uVar27 + (int)fVar35 ) * 2 << ( ( byte ) * (undefined4*)( local_3d0 + 0x5c ) & 0x1f ) | ~(iVar57 << ((byte)*(undefined4 *)(local_3d0 + 0x5c) & 0x1f)) & *(uint*)( local_3d0 + 0x58 );
 ...
 while ( uVar28 != uVar27 );
               ...
               while (true) {
                  ...
                  if (*(float*)( local_3d0 + lVar60 * 4 + ( (long)iVar52 - (long)(int)uVar26 ) * 4 + 0x68 ) <= *(float*)( uVar92 + 4 ) && *(float*)( uVar92 + 4 ) != *(float*)( local_3d0 + lVar60 * 4 + ( (long)iVar52 - (long)(int)uVar26 ) * 4 + 0x68 )) break;
                  iVar61 = (int)( lVar60 + -1 );
                  lVar60 = lVar60 + -1;
               }
;
 ...
 while ( true );
      ...
      LAB_00104261:fVar56 = *(float*)( *(long*)local_3d0 + 4 );
 ...
 while ( fVar56 < *(float*)( local_3d0 + lVar32 + 100 ) || fVar56 == *(float*)( local_3d0 + lVar32 + 100 ) );
      local_250 = iVar61;
...
/* JPH::HeightFieldShape::CastRay(JPH::RayCast const&, JPH::SubShapeIDCreator const&,
   JPH::RayCastResult&) const */undefined1 JPH::HeightFieldShape::CastRay(HeightFieldShape *this, RayCast *param_1, SubShapeIDCreator *param_2, RayCastResult *param_3) {
   undefined1 auVar1[16];
   long in_FS_OFFSET;
   undefined1 auVar2[16];
   undefined1 auVar3[16];
   ...
   local_288[0] = param_3;
   local_238 = this;
   WalkHeightField<JPH::HeightFieldShape::CastRay(JPH::RayCast_const &, JPH::SubShapeIDCreator_const &, JPH::RayCastResult &)const::Visitor > ( this,(Visitor*)local_288 );
   if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return local_228;
   }
...
/* JPH::GetRTTIOfType(JPH::HeightFieldShapeSettings*) */undefined1 *JPH::GetRTTIOfType(HeightFieldShapeSettings *param_1) {
   int iVar1;
   if (GetRTTIOfType(JPH::HeightFieldShapeSettings * ::rtti == '\0') {
      iVar1 = __cxa_guard_acquire(&GetRTTIOfType(JPH::HeightFieldShapeSettings * ::rtti));
      if (iVar1 != 0) {
         JPH::RTTI::RTTI((RTTI*)GetRTTIOfType(JPH::HeightFieldShapeSettings * ::rtti, "HeightFieldShapeSettings", 0xd0, GetRTTIOfType(JPH::HeightFieldShapeSettings * ::_FUN, GetRTTIOfType(JPH::HeightFieldShapeSettings*)::{lambda(void*)#1}::_FUN,
  ...
  return, GetRTTIOfType(JPH::HeightFieldShapeSettings*)::rtti;
}, /* JPH::HeightFieldShapeSettings::CastTo(JPH::RTTI const*) const */, void JPH::HeightFieldShapeSettings::CastTo(RTTI *param_1)
...
JPH::HeightFieldShapeSettings::HeightFieldShapeSettings
          ...
          HeightFieldShapeSettings *param_9), {
                           ...
                           *(undefined8*)( this + 0x58 ) = param_4;
                           for (int j = 0; j < 3; j++) {
                              *(undefined1(*) [16])( this + ( 24*j + 120 ) ) = (undefined1[16])0;
                           }
...
, /* JPH::HeightFieldShapeSettings::DetermineMinAndMaxSample(float&, float&, float&) const */, void __thiscall
JPH::HeightFieldShapeSettings::DetermineMinAndMaxSample
          (HeightFieldShapeSettings *this, float, *param_1, float, *param_2, float, *param_3) * pfVar1 * pfVar2 * (float**)( this + 0x88 ) * param_1 = *(float*)( this + 100 ) * (float*)( this + 0x68 ) + *(long*)( this + 0x78 ) * param_2 = fVar3(pfVar1 != pfVar2) = *pfVar2(fVar3 != _LC13) = fVar3(*param_1 <= fVar3) = *param_1 * param_1 = fVar4(fVar3 <= *param_2) = *param_2 * param_2 = fVar3 + 1(pfVar1 != pfVar2) * param_2(_LC9 <= fVar3 - *param_1) * param_3 = _LC41 / ( fVar3 - *param_1 ) * param_3 = _LC40(HeightFieldShapeSettings * this, float, param_1), {
                        uint uVar1;
                        int iVar2;
                        int iVar3;
                        uint uVar4;
                        ...
                        if (( local_48 <= local_4c ) || ( uVar1 = uVar1 == 0 )) {
                           local_68 = 1;
                        }
 else {
                           iVar2 = *(int*)( this + 0x70 );
 ...
 while ( uVar7 + uVar12 != uVar8 );
                                    if (fVar18 < fVar15) {
                                       ...
                                       if ((float)( (uint)fVar18 & _LC44 ) < _LC42) {
                                          fVar18 = (float)( ( uint )((float)(int)fVar18 - (float)( -(uint)(fVar18 < (float)(int)fVar18) & _LC4 )) | ~_LC44 & (uint)fVar18 );
                                       }

                                       fVar15 = ( fVar15 - local_4c ) * local_44;
                                       fVar18 = fVar18 / local_44 + local_4c;
                                       if ((float)( (uint)fVar15 & _LC44 ) < _LC42) {
                                          fVar15 = (float)( ( uint )((float)(int)fVar15 + (float)( -(uint)((float)(int)fVar15 < fVar15) & _LC4 )) | ~_LC44 & (uint)fVar15 );
                                       }
                                                   ...
                                                   if (fVar17 != _LC13) {
                                                      while (true) {
                                                         ...
                                                         if ((float)( (uint)fVar20 & _LC44 ) < _LC42) {
                                                            fVar20 = (float)( ( uint )((float)(int)fVar20 - (float)( -(uint)(fVar20 < (float)(int)fVar20) & _LC4 )) | ~_LC44 & (uint)fVar20 );
                                                         }
                                                         ...
                                                         if ((float)( ( uint )(( ( fVar16 * fVar15 ) / fVar19 + fVar18 ) - fVar17) & _LC44 ) <= param_1) break;
                                                         local_68 = local_68 + 1;
...
;
 ...
 while ( uVar14 < uVar1 );
                        ...
                        LAB_001054f5:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                           return local_68;
                        }
...
, /* JPH::HeightFieldShape::CalculateActiveEdges(unsigned int, unsigned int, unsigned int, unsigned
   int, float const*, unsigned int, unsigned int, long, float, float, JPH::TempAllocator&) */, , void __thiscall
JPH::HeightFieldShape::CalculateActiveEdges
          (HeightFieldShape *this, uint, param_1, uint, param_2, uint, param_3, uint, param_4, float, *param_5, uint, param_6, uint, param_7, long, param_8, float, param_9, float, param_10, TempAllocator * param_11) * pfVar1;
  undefined1 auVar2[16](*pauVar8)[16](*pauVar10)[16] * puVar17(*pauVar18)[16];
  uint uVar19;
  int iVar20;
  float fVar21;
  float fVar22;
  ...
  float fVar28;
  float fVar29;
  undefined1 auVar30[16] * param_4 * 0x20(undefined1(*)[16])(**(code**)( *(long*)param_11 + 0x10 ))(param_11, iVar4)(param_4 != 0) = param_2 - param_7(ulong)(param_3 - 1) + 1(param_3 == 0) = uVar16 + 1(uVar16 != param_4 + uVar12) - param_6 + (ulong)uVar19 + (ulong)uVar16 * param_8 * pfVar1;, fVar23 = pfVar1[param_8 + 1](( fVar21 == _LC13 ) || ( fVar23 == _LC13 )) * pauVar10 = (undefined1[16])0x0(undefined1[16]) = pfVar1[param_8](undefined1[16])(fVar27 != _LC13) = (float)( *(uint*)( this + 0x38 ) ^ uVar15 )(fVar23 - fVar27) * param_9(fVar21 - fVar27) * param_9 * *(float*)( this + 0x30 ) - fVar32 * 0.0 * fVar32 - fVar29 * 0.0 - *(float*)( this + 0x30 ) * fVar31._4_4_ = fVar32._0_4_ = fVar29._8_4_ = fVar27._12_4_ = fVar27._0_4_ = SQRT(fVar27 * fVar27 + fVar32 * fVar32 + fVar29 * fVar29 + 0.0)._4_4_ = auVar24._0_4_._8_4_ = auVar24._0_4_._12_4_ = auVar24._0_4_, ;
              auVar24 = divps(auVar30, auVar24) * pauVar10 = auVar24;, fVar27 = pfVar1[1](fVar27 == _LC13) = (float)( *(uint*)( this + 0x30 ) ^ uVar15 )(fVar23 - fVar27) * param_9(fVar21 - fVar27) * param_9 * fVar29 - fVar21 * 0.0 * (float*)( this + 0x38 ) * fVar21 - fVar32 * 0.0 - *(float*)( this + 0x38 ) * fVar29._4_4_ = fVar27._0_4_ = fVar21._8_4_ = fVar23._12_4_ = fVar23 * fVar23 + fVar21 * fVar21 + 0.0 + fVar27 * fVar27))._4_4_ = fVar21._0_4_ = fVar21._8_4_ = fVar21._12_4_ = fVar21, ;
...
while (uVar16 != param_4 + uVar12) ;;;;;
}fVar21 = _LC46;iVar20 = *(int*)( this + 0x40 );uVar16 = 0;uVar15 = ( ( iVar20 + -1 ) * param_2 + param_1 ) * 3;pauVar18 = pauVar8;do {
   uVar19 = uVar15;
   if (param_3 != 0) {
      iVar20 = 0;
      ...
      pauVar10 = pauVar18;
      do {
         pfVar1 = param_5 + ( ulong )(iVar20 + ( param_1 - param_6 )) + ( ulong )(uVar12 + uVar16) * param_8;
         fVar23 = *pfVar1;
         ...
         if (iVar20 == 0) {
            ...
            if (( fVar23 == _LC13 ) || ( fVar27 == _LC13 )) {
               ...
               if (( fVar21 <= fVar28 ) && ( uVar13 = 0 ),0.0 <= ( fVar26 * fVar32 - fVar31 * fVar22 ) * *(float*)( this + 0x38 ) + ( fVar27 - fVar23 ) * param_9 * ( fVar22 * fVar5 - fVar32 * fVar6 ) + ( fVar6 * fVar31 - fVar5 * fVar26 ) * 0.0 + 0.0) {
            ...
            LAB_00105af6:if (( fVar27 != _LC13 ) && ( fVar29 != _LC13 )) {
               ...
               if (( fVar28 < fVar21 ) || ( ( 0.0 <= ( fVar26 * fVar31 - fVar5 * fVar32 ) * 0.0 + ( fVar29 - fVar27 ) * param_9 * ( fVar32 * fVar6 - fVar31 * fVar22 ) + *(float*)( this + 0x30 ) * ( fVar22 * fVar5 - fVar6 * fVar26 ) + 0.0 && ( fVar28 < param_10 ) ) )) {
                  uVar13 = uVar13 | 2;
               }
         ...
         if (( fVar23 != _LC13 ) && ( fVar29 != _LC13 )) {
            ...
            if (( fVar22 < fVar21 ) || ( ( 0.0 <= ( ( fVar23 - fVar29 ) * param_9 * ( fVar6 * fVar31 - fVar27 * fVar5 ) + ( 0.0 - *(float*)( this + 0x30 ) * ( fVar5 * fVar32 - fVar31 * fVar26 ) ) ) - *(float*)( this + 0x38 ) * ( fVar26 * fVar27 - fVar32 * fVar6 ) && ( fVar22 < param_10 ) ) )) {
               uVar13 = uVar13 | 4;
            }
 ...
 while ( param_4 != uVar16 );}/* WARNING: Could not recover jumptable at 0x00105f9d. Too many branches *//* WARNING: Treating indirect jump as call */( **(code**)( *(long*)param_11 + 0x18 ) )(param_11 pauVar8return;}/* JPH::HeightFieldShape::CalculateActiveEdges(JPH::HeightFieldShapeSettings const&) */void JPH::HeightFieldShape::CalculateActiveEdges(HeightFieldShape *this, HeightFieldShapeSettings *param_1) {
   uint uVar1;
   long in_FS_OFFSET;
   undefined **local_28;
   long local_20;
   ...
   CalculateActiveEdges(this, 0, 0, uVar1, uVar1, *(float**)( param_1 + 0x88 ), 0, 0, ( ulong ) * (uint*)( param_1 + 0x60 ), *(float*)( param_1 + 0x54 ), *(float*)( param_1 + 0xc0 ), (TempAllocator*)&local_28);
   if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* JPH::HeightFieldShape::StoreMaterialIndices(JPH::HeightFieldShapeSettings const&) */void JPH::HeightFieldShape::StoreMaterialIndices(HeightFieldShape *this, HeightFieldShapeSettings *param_1) {
   uint uVar1;
   void *__s;
   int iVar2;
   uint uVar3;
...
/* JPH::HeightFieldShape::CacheValues() */void JPH::HeightFieldShape::CacheValues(HeightFieldShape *this) {
   this[0x55] = ( HeightFieldShape )((char)( 1 << ( (byte)this[0x54] & 0x1f ) ) + -1);
   return;
}
/* JPH::HeightFieldShape::AllocateBuffers() */void JPH::HeightFieldShape::AllocateBuffers(HeightFieldShape *this) {
   uint uVar1;
   uint uVar2;
   long lVar3;
   uint uVar4;
...
/* JPH::HeightFieldShape::RestoreBinaryState(JPH::StreamIn&) */void JPH::HeightFieldShape::RestoreBinaryState(HeightFieldShape *this, StreamIn *param_1) {
   long lVar1;
   char cVar2;
   undefined8 *puVar3;
   undefined8 uVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::HeightFieldShape::Clone() const */void JPH::HeightFieldShape::Clone(void) {
   long *plVar1;
   long *plVar2;
   undefined1 *puVar3;
   HeightFieldShape *this;
   ...
   *(undefined4*)( this + 0x56 ) = *(undefined4*)( in_RSI + 0x56 );
   AllocateBuffers(this);
   memcpy(*(void**)( *in_RDI + 0x60 ), *(void**)( in_RSI + 0x60 ), ( ulong ) * (uint*)( in_RSI + 0x48 ) + ( ulong ) * (uint*)( in_RSI + 0x50 ) + ( ulong ) * (uint*)( in_RSI + 0x4c ) * 0x10);
   lVar21 = *in_RDI;
 ...
 while ( puVar15 <= puVar14 );
   ...
   if (in_RSI + 0x78 != lVar21 + 0x78) {
      ...
      if (*(long*)( lVar21 + 0x78 ) != 0) {
         ...
         joined_r0x0010669d:if (plVar24 < plVar2) {
            do {
               plVar4 = (long*)*plVar24;
               if (plVar4 != (long*)0x0) {
                  LOCK();
                  ...
                  *(int*)plVar1 = (int)*plVar1 + -1;
                  UNLOCK();
                  if ((int)*plVar1 == 0) {
                     if (*(code**)( *plVar4 + 0x18 ) == PhysicsMaterial::~PhysicsMaterial) goto code_r0x001066e1;
                     ( **(code**)( *plVar4 + 0x18 ) )();
                  }
   ...
   *(undefined4*)( lVar21 + 0xa8 ) = *(undefined4*)( in_RSI + 0xa8 );
   if (in_RSI + 0xb0 != lVar21 + 0xb0) {
      ...
      if (*(long*)( lVar21 + 0xb0 ) != 0) {
         ...
         joined_r0x0010682b:if (puVar14 < puVar17) {
            do {
               piVar6 = (int*)*puVar14;
               if (piVar6 != (int*)0x0) {
                  LOCK();
 ...
 while ( puVar14 <= puVar19 );
   ...
   *(undefined1*)( lVar21 + 200 ) = *(undefined1*)( in_RSI + 200 );
   return;
   code_r0x001066e1:( *Free )();
   plVar24 = plVar24 + 1;
   goto joined_r0x0010669d;
   code_r0x00106853:plVar20 = *(long**)( piVar6 + 6 );
   if (plVar20 != (long*)0x0) {
      if (( *(long*)( piVar6 + 2 ) != 0 ) && ( plVar22 = plVar20 < plVar22 )) {
         do {
...
/* JPH::HeightFieldShape::GetPosition(unsigned int, unsigned int) const */undefined1[16];__thiscallJPH::HeightFieldShape::GetPosition(HeightFieldShape *this, uint param_1, uint param_2) {
   ulong uVar1;
   undefined1 auVar2[16];
   uint uVar3;
   ulong uVar4;
   ...
   if (*(int*)( this + 0x48 ) == 0) {
      ...
      lVar8 = ( ulong )(uVar7 + ( uVar3 + 1 >> 1 ) * (int)( uVar1 >> 1 ) + ( param_1 / uVar6 >> 1 )) * 0x10 + *(long*)( this + 0x60 );
      uVar6 = ( uint ) * (ushort*)( lVar8 + uVar4 * 2 );
      fStack_24 = ( ( (float)( (int)( uint ) * (ushort*)( *(long*)( this + 0x68 ) + ( ulong )(uVar5 >> 3) ) >> ( (byte)uVar5 & 7 ) & (uint)(byte)this[0x55] ) + _LC2 ) * ( (float)(int)( *(ushort*)( lVar8 + 8 + uVar4 * 2 ) - uVar6 ) / (float)(byte)this[0x55] ) + (float)uVar6 ) * *(float*)( this + 0x34 );
   }
...
/* JPH::HeightFieldShape::GetSurfaceNormal(JPH::SubShapeID const&, JPH::Vec3) const */undefined1[16];JPH::HeightFieldShape::GetSurfaceNormal(HeightFieldShape *param_1, uint *param_2) {
   uint uVar1;
   uint uVar2;
   int iVar3;
   uint uVar4;
...
/* JPH::HeightFieldShape::GetSupportingFace(JPH::SubShapeID const&, JPH::Vec3, JPH::Vec3, JPH::Mat44
   const&, JPH::StaticArray<JPH::Vec3, 32u>&) const */void JPH::HeightFieldShape::GetSupportingFace(undefined8 param_1_00, undefined8 param_2, undefined8 param_3, undefined8 param_4, HeightFieldShape *param_1, uint *param_6, float *param_7, undefined4 *param_8) {
   uint uVar1;
   uint uVar2;
   int iVar3;
   float fVar4;
   ...
   *(undefined1(*) [16])( param_8 + 4 ) = auVar32;
   ...
   do {
      ...
      fVar22 = pfVar28[2];
      pfVar29 = pfVar28 + 4;
      *pfVar28 = fVar22 * fVar31 * fVar12 + fVar20 * local_68 * fVar4 + fVar21 * fStack_64 * fVar16 + fVar8;
      pfVar28[1] = fVar22 * fVar31 * fVar13 + fVar20 * local_68 * fVar5 + fVar21 * fStack_64 * fVar17 + fVar9;
      pfVar28[2] = fVar22 * fVar31 * fVar14 + fVar20 * local_68 * fVar6 + fVar21 * fStack_64 * fVar18 + fVar10;
      pfVar28[3] = fVar22 * fVar31 * fVar15 + fVar20 * local_68 * fVar7 + fVar21 * fStack_64 * fVar19 + fVar11;
      pfVar28 = pfVar29;
   }
 while ( (float*)( param_8 + 0x10 ) != pfVar29 );
   return;
}
/* JPH::HeightFieldShape::IsNoCollision(unsigned int, unsigned int) const */undefined4 JPH::HeightFieldShape::IsNoCollision(HeightFieldShape *this, uint param_1, uint param_2) {
   undefined4 uVar1;
   uint uVar2;
   uVar1 = 1;
   if (*(int*)( this + 0x48 ) != 0) {
...
/* JPH::HeightFieldShape::ProjectOntoSurface(JPH::Vec3, JPH::Vec3&, JPH::SubShapeID&) const */int JPH::HeightFieldShape::ProjectOntoSurface(undefined8 param_1, undefined8 param_2, HeightFieldShape *param_3, float *param_4, uint *param_5) {
   HeightFieldShape HVar1;
   HeightFieldShape HVar2;
   int iVar3;
   long lVar4;
   ...
   if (*(int*)( param_3 + 0x48 ) != 0) {
      ...
      if (0.0 <= fVar17) {
         ...
         uVar10 = iVar3 - 1;
         if (( ( fVar17 < (float)uVar10 ) && ( iVar5 = 0 ),0.0 <= fVar15 )) {
            if ((float)( (uint)fVar17 & _LC44 ) < _LC42) {
               auVar21._0_4_ = ~_LC44 & (uint)fVar17;
               auVar21._4_4_ = 0;
               auVar21._8_4_ = fVar15;
               auVar21._12_4_ = auVar16._12_4_;
               auVar16 = ZEXT416(( uint )((float)(int)fVar17 - (float)( -(uint)(fVar17 < (float)(int)fVar17) & _LC4 ))) | auVar21;
            }

            uVar6 = (uint)(long)auVar16._0_4_;
            fVar18 = fVar15;
            if ((float)( (uint)fVar15 & _LC44 ) < _LC42) {
               fVar18 = (float)( ( uint )((float)(int)fVar15 - (float)( -(uint)(fVar15 < (float)(int)fVar15) & _LC4 )) | ~_LC44 & (uint)fVar15 );
            }
            ...
            bVar7 = (byte)uVar8 & 7;
            iVar5 = 0 >> bVar7;
            if (( ~(byte)((int)(uint)*(ushort *)(lVar4 + (ulong)(uVar8 >> 3)) >> bVar7) & (byte)HVar2 ) != 0) {
               uVar14 = uVar6 + 1;
               uVar8 = ( iVar3 + iVar12 + uVar14 ) * (uint)(byte)HVar1;
               if (( ~(byte)((int)(uint)*(ushort *)(lVar4 + (ulong)(uVar8 >> 3)) >> ((byte)uVar8 & 7)) & (byte)HVar2 ) != 0) {
                  uVar8 = uVar11 + 1;
                  ...
                  if (fVar15 < fVar17) {
                     ...
                     if (( ~(byte)((int)(uint)*(ushort *)(lVar4 + (ulong)(uVar9 >> 3)) >> ((byte)uVar9 & 7)) & (byte)HVar2 ) != 0) {
                        ...
                        *param_4 = fVar15 * ( local_58 - local_68 ) + local_78 + fVar17 * ( local_68 - local_78 );
                        param_4[1] = fVar15 * ( fStack_54 - fStack_64 ) + fStack_74 + fVar17 * ( fStack_64 - fStack_74 );
                        param_4[2] = fVar15 * ( fStack_50 - fStack_60 ) + fStack_70 + fVar17 * ( fStack_60 - fStack_70 );
                        param_4[3] = fVar15 * ( fStack_4c - fStack_5c ) + fStack_6c + fVar17 * ( fStack_5c - fStack_6c );
                        if (uVar10 != 0) {
                           iVar5 = 0x1f;
                           if (uVar10 != 0) {
                     ...
                     if (( ~(byte)((int)(uint)*(ushort *)(lVar4 + (ulong)(uVar9 >> 3)) >> ((byte)uVar9 & 7)) & (byte)HVar2 ) != 0) {
                        ...
                        *param_4 = ( local_78 - local_68 ) * fVar15 + local_68 + fVar17 * ( local_58 - local_78 );
                        param_4[1] = ( fStack_74 - fStack_64 ) * fVar18 + fStack_64 + fVar17 * ( fStack_54 - fStack_74 );
                        param_4[2] = ( fStack_70 - fStack_60 ) * fVar19 + fStack_60 + fVar17 * ( fStack_50 - fStack_70 );
                        param_4[3] = ( fStack_6c - fStack_5c ) * fVar20 + fStack_5c + fVar17 * ( fStack_4c - fStack_6c );
                        if (uVar10 != 0) {
                           iVar5 = 0x1f;
                           if (uVar10 != 0) {
                              for (; uVar10 >> iVar5 == 0; iVar5 = iVar5 + -1) {}
...
/* JPH::HeightFieldShape::GetHeights(unsigned int, unsigned int, unsigned int, unsigned int, float*,
   long) const */void JPH::HeightFieldShape::GetHeights(HeightFieldShape *this, uint param_1, uint param_2, uint param_3, uint param_4, float *param_5, long param_6) {
...
/* JPH::HeightFieldShape::SetHeights(unsigned int, unsigned int, unsigned int, unsigned int, float
   const*, long, JPH::TempAllocator&, float) */void JPH::HeightFieldShape::SetHeights(HeightFieldShape *this, uint param_1, uint param_2, uint param_3, uint param_4, float *param_5, long param_6, TempAllocator *param_7, float param_8) {
   ushort *puVar1;
   uint uVar2;
   undefined8 *puVar3;
   long *plVar4;
   ...
   if (param_1 == 0) {
      ...
      LAB_001074af:local_b0 = param_2 - *(int*)( this + 0x44 );
   ...
   if (uVar33 < uVar16) {
      ...
      if (uVar41 < uVar16) {
         LAB_00107502:local_8c = iVar51 + local_f0;
      }
 else {
         local_8c = local_f0;
      }
                     ...
                     do {
                        if (*pfVar43 != _LC13) {
                           ...
                           if ((float)( (uint)fVar55 & uVar52 ) < fVar13) {
                              fVar55 = (float)( ( uint )((float)(int)fVar55 - (float)( -(uint)(fVar55 < (float)(int)fVar55) & (uint)fVar15 )) | ~uVar52 & (uint)fVar55 );
                           }
 ...
 while ( uVar36 != uVar23 );
            ...
            lVar28 = ( ulong )(( uVar18 + uVar7 >> 1 ) + (int)( uVar44 >> 1 ) * uVar17 + local_7c) * 0x10 + *(long*)( this + 0x60 );
               ...
               do {
                  ...
                  if (uVar35 < uVar2) {
                     do {
                        ...
                        HVar39 = HVar9;
                        if (*pfVar49 != _LC13) {
                           fVar56 = ( *pfVar49 - ( fVar55 * fVar6 + fVar5 ) ) / ( ( fVar57 / (float)(byte)HVar8 ) * fVar6 );
                           if ((float)( (uint)fVar56 & uVar52 ) < fVar14) {
                              fVar56 = (float)( ( uint )((float)(int)fVar56 - (float)( -(uint)(fVar56 < (float)(int)fVar56) & (uint)fVar15 )) | ~uVar52 & (uint)fVar56 );
                           }
                        ...
                        *puVar30 = ~((ushort)(byte)HVar9 << bVar26) & *puVar30 | (ushort)(byte)HVar39 << bVar26;
                        uVar16 = *(uint*)( this + 0x40 );
                     }
 while ( uVar2 != uVar48 );
                  }
 ...
 while ( uVar7 < uVar19 );
         while (true) {
            ...
            LAB_00107b89:uVar21 = local_ec + uVar48;
         }
;
         ;;
      }
 while ( true );
   ...
   CalculateActiveEdges(this, param_1 - 2, uVar46 - 2, uVar41 - ( param_1 - 2 ), uVar52 - ( uVar46 - 2 ), local_e0, local_94, local_b0, param_6, fVar15, param_8, param_7);
      ...
      for (; puVar53 < puVar3; puVar53 = puVar53 + 1) {
         while (piVar11 = (int*)*puVar53,piVar11 != (int*)0x0) {
            ...
            *piVar11 = *piVar11 + -1;
            ...
            if (plVar37 != (long*)0x0) {
               if (( *(long*)( piVar11 + 2 ) != 0 ) && ( plVar4 = plVar37 < plVar4 )) {
                  do {
...
;
   ...
   LAB_00107f1f:*(undefined8*)( this + 0xb0 ) = 0;
   return;
}
/* JPH::HeightFieldShape::GetMaterials(unsigned int, unsigned int, unsigned int, unsigned int,
   unsigned char*, long) const */void JPH::HeightFieldShape::GetMaterials(HeightFieldShape *this, uint param_1, uint param_2, uint param_3, uint param_4, uchar *param_5, long param_6) {
   int iVar1;
   void *pvVar2;
   byte bVar3;
   long lVar4;
 ...
 while ( uVar6 < param_4 );
      ...
      do {
         ...
         do {
            param_5[lVar4] = ( byte )((int)( uint ) * puVar5 >> ( sbyte )(uVar8 & 7)) & (char)( 1 << ( bVar3 & 0x1f ) ) - 1U;
            iVar9 = *(int*)( this + 0xa8 );
            lVar4 = lVar4 + 1;
            uVar8 = ( uVar8 & 7 ) + iVar9;
...
/* JPH::HeightFieldShape::SetMaterials(unsigned int, unsigned int, unsigned int, unsigned int,
   ...
   JPH::STLAllocator<JPH::RefConst<JPH::PhysicsMaterial> > > const*, JPH::TempAllocator&) */bool JPH::HeightFieldShape::SetMaterials(HeightFieldShape *this, uint param_1, uint param_2, uint param_3, uint param_4, uchar *param_5, long param_6, Array *param_7, TempAllocator *param_8) {
   int iVar1;
   long *plVar2;
   byte *pbVar3;
   void *__s;
 ...
 while ( plVar8 != plVar4 + ( lVar22 >> 5 ) * 4 );
         ...
         lVar22 = lVar22 >> 3;
         if (lVar22 == 2) {
            LAB_001084bf:if (lVar5 != *plVar8) {
               plVar8 = plVar8 + 1;
               LAB_001083a4:if (lVar5 != *plVar8) goto LAB_001083ad;
            }

            LAB_00108230:if (plVar4 + uVar14 == plVar8) goto LAB_001083ad;
            *puVar21 = (char)( (long)plVar8 - (long)plVar4 >> 3 );
            ...
            LAB_001083ad:if (0xff < uVar14) goto LAB_0010834d;
            *puVar21 = (char)uVar14;
            if (lVar5 != 0) {
               LOCK();
               *(int*)( lVar5 + 8 ) = *(int*)( lVar5 + 8 ) + 1;
 ...
 while ( uVar10 != ( uVar14 & 0xffffffff ) );
   ...
   LAB_00108525:uVar14 = *(ulong*)( this + 0x78 );
   LAB_00108269:if (uVar14 != 1) {
            ...
            *(ulong*)( this + 0x90 ) = uVar14;
            ...
            if (!CARRY8((long)((int)uVar18 >> 3),(ulong)puVar20)) {
               do {
                  ...
                  sVar13 = (sbyte)uVar19;
                  *puVar24 = ( ushort )(( (int)( uint ) * puVar26 >> ( sbyte )(uVar27 & 7) & ( 1 << ( (byte)iVar25 & 0x1f ) ) - 1U ) << sVar13) | ~(ushort)(uVar17 << sVar13) & *puVar24;
...
;
   ...
   bVar16 = true;
   LAB_0010834d:( **(code**)( *(long*)param_8 + 0x18 ) )(param_8, puVar7, local_5c);
   return bVar16;
}
/* JPH::HeightFieldShape::GetMaterial(unsigned int, unsigned int) const */undefined8 JPH::HeightFieldShape::GetMaterial(HeightFieldShape *this, uint param_1, uint param_2) {
   uint uVar1;
   if (*(long*)( this + 0x78 ) == 0) {
   ...
   if (*(long*)( this + 0x78 ) != 1) {
      ...
      return ( *(undefined8**)( this + 0x88 ) )[( 1 << ( ( byte ) * (int*)( this + 0xa8 ) & 0x1f ) ) - 1U & (int)( uint ) * (ushort*)( *(long*)( this + 0xa0 ) + ( ulong )(uVar1 >> 3) ) >> ( (byte)uVar1 & 7 ) & 0xffff];
   }

   return **(undefined8**)( this + 0x88 );
}
/* JPH::HeightFieldShape::GetMaterial(JPH::SubShapeID const&) const */void JPH::HeightFieldShape::GetMaterial(HeightFieldShape *this, SubShapeID *param_1) {
   uint uVar1;
   int iVar2;
   uint uVar3;
   uint uVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::HeightFieldShape::GetTrianglesNext(JPH::Shape::GetTrianglesContext&, int, JPH::Float3*,
   JPH::PhysicsMaterial const**) const */int JPH::HeightFieldShape::GetTrianglesNext(HeightFieldShape *this, GetTrianglesContext *param_1, int param_2, Float3 *param_3, PhysicsMaterial **param_4) {
   long lVar1;
   byte bVar2;
   byte bVar3;
...
;
         ...
         do {
            ...
            if (uVar29 < local_1ac) {
               ...
               auVar53 = *(undefined1(*) [16])( ( ulong )(uVar22 * uVar41 + ( &sGridOffsets )[uVar29] + uVar46) * 0x10 + *(long*)( uStack_178 + 0x60 ) );
               auVar9._10_2_ = 0;
               ...
               uStack_178 = CONCAT44((float)auVar53._10_2_ * fStack_1f4 + fStack_254, (float)auVar53._8_2_ * fStack_1f8 + fStack_258);
               iVar6 = uVar46 * 2;
               uStack_138 = (undefined8*)CONCAT44((float)(int)CONCAT82(SUB148(auVar19 << 0x40, 6), auVar53._2_2_) * fStack_1f4 + fStack_254, (float)auVar53._0_2_ * fStack_1f8 + fStack_258);
               ...
               fStack_140 = (float)(int)( ( auVar58._8_8_ & 0xffffffff ) * (ulong)uVar22 ) * fStack_1e0 + fStack_240;
               fStack_13c = (float)(int)( ( auVar58._8_8_ >> 0x20 ) * (ulong)uVar22 ) * fStack_1dc + fStack_23c;
               uStack_148 = CONCAT44((float)(int)( auVar58._4_4_ * uVar22 ) * fStack_1e4 + fStack_244, (float)(int)( auVar58._0_4_ * uVar22 ) * fStack_1e8 + fStack_248);
               ...
               fStack_150 = (float)(int)( ~uVar48 & uVar30 | uStack_230 & uVar48 ) * fStack_1e0 + fStack_240;
               fStack_14c = (float)(int)( ~uVar28 & uVar41 | uStack_22c & uVar28 ) * fStack_1dc + fStack_23c;
               uStack_158 = CONCAT44((float)(int)( ~uVar29 & auVar56._4_4_ * uVar22 | uStack_234 & uVar29 ) * fStack_1e4 + fStack_244, (float)(int)( ~uVar46 & auVar56._0_4_ * uVar22 | uStack_238 & uVar46 ) * fStack_1e8 + fStack_248);
               ...
               fStack_160 = (float)(int)( ( auVar63._8_8_ & 0xffffffff ) * (ulong)uVar22 ) * fStack_200 + fStack_260;
               fStack_15c = (float)(int)( ( auVar63._8_8_ >> 0x20 ) * (ulong)uVar22 ) * fStack_1fc + fStack_25c;
               uStack_168 = (float*)CONCAT44((float)(int)( auVar63._4_4_ * uVar22 ) * fStack_204 + fStack_264, (float)(int)( auVar63._0_4_ * uVar22 ) * fStack_208 + fStack_268);
               fStack_180 = (float)(int)( ~uVar28 & uVar48 | uStack_230 & uVar28 ) * fStack_200 + fStack_260;
               fStack_17c = (float)(int)( ~uVar30 & uVar23 | uStack_22c & uVar30 ) * fStack_1fc + fStack_25c;
               uStack_188 = CONCAT44((float)(int)( ~uVar41 & uVar47 | uStack_234 & uVar41 ) * fStack_204 + fStack_264, (float)(int)( ~uVar29 & uVar46 | uStack_238 & uVar29 ) * fStack_208 + fStack_268);
               ...
               *(undefined8*)( puVar35 + lVar8 + -0x28 ) = 0x1096a4;
               iVar49 = HSGetTrianglesContext::VisitRangeBlock(uStack_148, CONCAT44(fStack_13c, fStack_140), uStack_138, CONCAT44(fStack_12c, fStack_130), uStack_168, CONCAT44(fStack_15c, fStack_160), uStack_158, CONCAT44(fStack_14c, fStack_150), param_1, piStack_1a8);
               ...
               if (uStack_1a0 < uVar29) {
                  ...
                  do {
                     ...
                     if (uStack_1b8 < uVar28) {
                        ...
                        do {
                           iVar49 = (int)uVar32;
                           uVar23 = (int)( uint ) * (ushort*)( lVar27 + ( ulong )(uVar46 >> 3) ) >> ( (byte)uVar46 & 7 ) & uVar48;
                           *(bool*)uVar32 = bVar2 == (byte)uVar23;
                           uVar32 = uVar32 + 1;
                           uVar46 = uVar46 + bVar3;
                           *pfVar42 = (float)( ( uStack_1b8 - iVar37 ) + iVar49 ) * fVar57 + auVar53._0_4_;
                           pfVar42[1] = ( ( (float)uVar23 + fVar54 ) * ( (float)(int)( uVar5 - uVar30 ) / fVar51 ) + (float)uVar30 ) * fVar59 + auVar53._4_4_;
 ...
 while ( uVar29 != uVar22 );
               ...
               if (uVar46 < local_1b0) {
                  ...
                  if (uStack_1a0 < uVar29) {
                     ...
                     do {
                        uVar32 = (ulong)uVar30;
                        uVar23 = (int)( uint ) * (ushort*)( lVar27 + ( ulong )(uVar47 >> 3) ) >> ( (byte)uVar47 & 7 ) & uVar48;
                        ...
                        *pfVar45 = (float)uVar28 * fVar57 + fVar62;
                        pfVar45[1] = ( ( (float)uVar23 + fVar54 ) * ( (float)(int)( uVar5 - uVar22 ) / fVar51 ) + (float)uVar22 ) * fVar59 + fVar64;
 ...
 while ( uVar29 != uVar30 );
               ...
               if (uVar41 < local_1b0) {
                  ...
                  if (uStack_1b8 < uVar28) {
                     ...
                     do {
                        iVar49 = (int)lVar24;
                        uVar30 = (int)( uint ) * (ushort*)( lVar7 + ( ulong )(uVar41 >> 3) ) >> ( (byte)uVar41 & 7 ) & uVar48;
                        *(bool*)lVar24 = bVar2 == (byte)uVar30;
                        lVar24 = lVar24 + 1;
                        uVar41 = uVar41 + bVar3;
                        *pfVar45 = (float)( ( uStack_1b8 - iVar37 ) + iVar49 ) * fVar57 + fVar62;
                        pfVar45[1] = ( ( (float)uVar30 + fVar54 ) * ( (float)(int)( uVar5 - uVar22 ) / fVar51 ) + (float)uVar22 ) * fVar59 + fVar64;
 ...
 while ( lVar24 != lVar1 );
                  ...
                  if (uVar46 < local_1b0) {
                     ...
                     uVar22 = ( *(int*)( uStack_178 + 0x40 ) * uVar29 + uVar28 ) * ( uint ) * (byte*)( uStack_178 + 0x54 );
                     uVar48 = (int)( uint ) * (ushort*)( *(long*)( uStack_178 + 0x68 ) + ( ulong )(uVar22 >> 3) ) >> ( (byte)uVar22 & 7 ) & uVar48;
                     ...
                     *uStack_168 = (float)uVar28 * *(float*)( uStack_178 + 0x30 ) + *(float*)( uStack_178 + 0x20 );
                     uStack_168[1] = ( ( (float)uVar48 + fVar54 ) * ( (float)(int)( uVar5 - uVar46 ) / fVar51 ) + (float)uVar46 ) * fVar57 + fVar61;
...
;
 ...
 while ( lVar50 != 0x40 );
               ...
               *(undefined8*)( puVar35 + lVar8 + -0x28 ) = 0x10902e;
               iVar37 = HSGetTrianglesContext::VisitRangeBlock(uStack_168, CONCAT44(fStack_15c, fStack_a8), uStack_158, CONCAT44(fStack_14c, fStack_a4), uStack_148, CONCAT44(fStack_90, fStack_a0), uStack_138, CONCAT44(fStack_12c, fStack_68), param_1, &uStack_118);
               uVar22 = iVar37 - 1;
               if (-1 < (int)uVar22) {
                              ...
                              do {
                                 ...
                                 if (( *pcVar25 == '\0' ) && ( pcVar25[uVar32] == '\0' )) {
                                    ...
                                    if (*(int*)( param_1 + 0x2c0 ) <= iVar49) {
                                       LAB_00109315:local_190[0x2e0] = (GetTrianglesContext)0x1;
                                       pfVar33 = (float*)( puVar35 + lVar8 );
                                       goto LAB_001088e0;
                                    }
                                    ...
                                    while (true) {
                                       ...
                                       *pfVar42 = fVar54 * *(float*)( param_1 + 0x280 ) + fVar51 * *(float*)( param_1 + 0x290 ) + fVar57 * *(float*)( param_1 + 0x2a0 ) + *(float*)( param_1 + 0x2b0 );
                                       ...
                                       if (GVar4 == (GetTrianglesContext)0x0) {
                                          ...
                                          pfVar42[3] = fVar62 * *(float*)( param_1 + 0x280 ) + fVar64 * *(float*)( param_1 + 0x290 ) + fVar65 * *(float*)( param_1 + 0x2a0 ) + *(float*)( param_1 + 0x2b0 );
                                          pfVar42[4] = fVar62 * fVar54 + fVar64 * fVar57 + fVar65 * fVar12 + fVar14;
                                          pfVar42[5] = fVar62 * fVar51 + fVar64 * fVar11 + fVar65 * fVar13 + fVar15;
                                          uVar26 = CONCAT44(fVar59 * *(float*)( param_1 + 0x284 ) + fVar60 * *(float*)( param_1 + 0x294 ) + fVar61 * *(float*)( param_1 + 0x2a4 ) + *(float*)( param_1 + 0x2b4 ), fVar59 * *(float*)( param_1 + 0x280 ) + fVar60 * *(float*)( param_1 + 0x290 ) + fVar61 * *(float*)( param_1 + 0x2a0 ) + *(float*)( param_1 + 0x2b0 ));
                                          fVar54 = fVar59 * *(float*)( param_1 + 0x288 ) + fVar60 * *(float*)( param_1 + 0x298 ) + fVar61 * *(float*)( param_1 + 0x2a8 ) + *(float*)( param_1 + 0x2b8 );
                                       }
 else {
                                          fVar54 = *(float*)( param_1 + 0x284 );
                                          fVar51 = *(float*)( param_1 + 0x288 );
                                          ...
                                          fVar14 = *(float*)( param_1 + 0x2b4 );
                                          fVar15 = *(float*)( param_1 + 0x2b8 );
                                          pfVar42[3] = fVar59 * *(float*)( param_1 + 0x280 ) + fVar60 * *(float*)( param_1 + 0x290 ) + fVar61 * *(float*)( param_1 + 0x2a0 ) + *(float*)( param_1 + 0x2b0 );
                                          *(ulong*)( pfVar42 + 4 ) = CONCAT44(fVar59 * fVar51 + fVar60 * fVar11 + fVar61 * fVar13 + fVar15, fVar59 * fVar54 + fVar60 * fVar57 + fVar61 * fVar12 + fVar14);
                                          uVar26 = CONCAT44(*(float*)( param_1 + 0x284 ) * fVar62 + fVar64 * *(float*)( param_1 + 0x294 ) + fVar65 * *(float*)( param_1 + 0x2a4 ) + *(float*)( param_1 + 0x2b4 ), *(float*)( param_1 + 0x280 ) * fVar62 + fVar64 * *(float*)( param_1 + 0x290 ) + fVar65 * *(float*)( param_1 + 0x2a0 ) + *(float*)( param_1 + 0x2b0 ));
                                          fVar54 = *(float*)( param_1 + 0x288 ) * fVar62 + fVar64 * *(float*)( param_1 + 0x298 ) + fVar65 * *(float*)( param_1 + 0x2a8 ) + *(float*)( param_1 + 0x2b8 );
                                       }
                                       ...
                                       *(int*)( param_1 + 0x2d0 ) = iVar49;
                                       ...
                                       if (iVar37 == 1) break;
                                       LAB_001092db:uVar46 = (uint)uVar40;
...
;
 ...
 while ( true );
   ...
   LAB_001088e0:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
   ...
   return iVar49;
   LAB_00109a9b:iVar49 = *(int*)( local_190 + 0x2d0 );
   pfVar33 = (float*)( puVar35 + lVar8 );
   goto LAB_001088e0;
}
/* JPH::HeightFieldShape::GetSubShapeIDBits() const */int JPH::HeightFieldShape::GetSubShapeIDBits(HeightFieldShape *this) {
   uint uVar1;
   int iVar2;
   iVar2 = 1;
   uVar1 = *(int*)( this + 0x40 ) - 1;
...
/* JPH::HeightFieldShape::GetSubShapeCoordinates(JPH::SubShapeID const&, unsigned int&, unsigned
   int&, unsigned int&) const */void JPH::HeightFieldShape::GetSubShapeCoordinates(HeightFieldShape *this, SubShapeID *param_1, uint *param_2, uint *param_3, uint *param_4) {
   int iVar1;
   uint uVar2;
   uint uVar3;
   uVar2 = 1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* void JPH::HeightFieldShape::WalkHeightField<JPH::HeightFieldShape::Draw(JPH::DebugRenderer*,
   ...
   JPH::Color, bool, bool) const::Visitor&) const */void JPH::HeightFieldShape::WalkHeightField<JPH::HeightFieldShape::Draw(JPH::DebugRenderer*,JPH::Mat44_const&,JPH::Vec3,JPH::Color,bool,bool)const::Visitor>(HeightFieldShape *this, Visitor *param_1) {
   uint uVar1;
   HeightFieldShape HVar2;
   HeightFieldShape HVar3;
   ushort uVar4;
   ...
   local_448 = param_1;
   if (*(int*)( this + 0x48 ) == 0) {
      LAB_00109b83:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
...
;
   ...
   do {
      ...
      if (uVar32 < local_408) {
         ...
         auVar58 = *(undefined1(*) [16])( ( ulong )(uVar35 * uVar24 + ( &sGridOffsets )[uVar32] + uVar41) * 0x10 + *(long*)( local_258 + 0x60 ) );
         auVar8._10_2_ = 0;
         ...
         auVar62._12_4_ = -(uint)((float)(auVar8._10_4_ >> 0x10) * fStack_42c + fStack_41c <=
         ...
         if (uStack_3f0 < uVar1) {
            ...
            do {
               ...
               if (uStack_3fc < uVar32) {
                  ...
                  do {
                     iVar54 = (int)puVar38;
                     uVar25 = (int)( uint ) * (ushort*)( lVar28 + ( ulong )(uVar24 >> 3) ) >> ( (byte)uVar24 & 7 ) & uVar27;
                     *puVar38 = HVar2 == SUB41(uVar25, 0);
                     puVar38 = puVar38 + 1;
                     uVar24 = uVar24 + (byte)HVar3;
                     auVar63._0_4_ = (float)( ( uStack_3fc - iVar53 ) + iVar54 ) * auVar58._0_4_ + auVar59._0_4_;
                     auVar63._4_4_ = ( ( (float)uVar25 + fVar10 ) * ( (float)(int)( uVar4 - uVar46 ) / fVar55 ) + (float)uVar46 ) * auVar58._4_4_ + auVar59._4_4_;
 ...
 while ( uVar1 != uVar35 );
         ...
         if (uVar41 < local_400) {
            ...
            if (uStack_3f0 < uVar1) {
               ...
               do {
                  uVar34 = (ulong)uVar46;
                  uVar26 = (int)( uint ) * (ushort*)( lVar28 + ( ulong )(uVar25 >> 3) ) >> ( (byte)uVar25 & 7 ) & uVar27;
                  *puVar38 = HVar2 == SUB41(uVar26, 0);
                  puVar38 = puVar38 + uVar37;
                  uVar46 = uVar46 + 1;
                  uVar25 = uVar25 + iVar36;
                  *(float*)*pauVar48 = (float)uVar32 * fVar15 + fVar11;
                  *(float*)( *pauVar48 + 4 ) = ( ( (float)uVar26 + fVar10 ) * ( (float)(int)( uVar4 - uVar35 ) / fVar55 ) + (float)uVar35 ) * fVar16 + fVar12;
 ...
 while ( uVar1 != uVar46 );
         ...
         if (uVar24 < local_400) {
            ...
            if (uStack_3fc < uVar32) {
               ...
               do {
                  uVar33 = (int)( uint ) * (ushort*)( lVar28 + ( ulong )(uVar24 >> 3) ) >> ( (byte)uVar24 & 7 ) & uVar27;
                  *puVar38 = HVar2 == SUB41(uVar33, 0);
                  iVar54 = (int)puVar38;
                  puVar38 = puVar38 + 1;
                  uVar24 = uVar24 + (byte)HVar3;
                  *(float*)*pauVar48 = (float)( ( uStack_3fc - iVar53 ) + iVar54 ) * fVar15 + fVar11;
                  *(float*)( *pauVar48 + 4 ) = ( ( (float)uVar33 + fVar10 ) * ( (float)(int)( uVar4 - uVar35 ) / fVar55 ) + (float)uVar35 ) * fVar16 + fVar12;
 ...
 while ( puVar38 != puVar49 );
            ...
            if (uVar41 < local_400) {
               ...
               uVar27 = (int)( uint ) * (ushort*)( *(long*)( local_258 + 0x68 ) + ( ulong )(uVar35 >> 3) ) >> ( (byte)uVar35 & 7 ) & uVar27;
               ...
               *(float*)*pauStack_388 = (float)uVar32 * *(float*)( local_258 + 0x30 ) + *(float*)( local_258 + 0x20 );
               *(float*)( *pauStack_388 + 4 ) = ( ( (float)uVar27 + fVar10 ) * ( (float)(int)( uVar4 - uVar24 ) / fVar55 ) + (float)uVar24 ) * fVar11 + fVar14;
...
;
 ...
 while ( lVar51 != 0x40 );
         ...
         auVar61._12_4_ = -(uint)((float)((ulong)uStack_2a8 >> 0x20) <= (float)((ulong)uStack_268 >> 0x20));
                  ...
                  do {
                     ...
                     if (uStack_398 < uVar31) {
                        do {
                           ...
                           if (( *pcVar29 == '\0' ) && ( uVar37 = uStack_380 & 0xffffffff ),pcVar29[uVar37] == '\0') {
                              ...
                              do {
                                 ...
                                 LAB_0010a392:this_00 = *(HeightFieldShape**)pVVar22;
                                 pfVar50 = afStack_348;
                                 ...
                                 *(undefined8*)( puVar44 + lVar7 + -8 ) = 0x10a3d0;
                                 ...
                                 do {
                                    ...
                                    auStack_368._4_4_ = fVar11 * *(float*)( pVVar22 + 0x34 ) + fVar10 * *(float*)( pVVar22 + 0x14 ) + fVar55 * *(float*)( pVVar22 + 0x24 ) + *(float*)( pVVar22 + 0x44 );
                                    auStack_368._0_4_ = fVar11 * *(float*)( pVVar22 + 0x30 ) + fVar10 * *(float*)( pVVar22 + 0x10 ) + fVar55 * *(float*)( pVVar22 + 0x20 ) + *(float*)( pVVar22 + 0x40 );
                                    uStack_360._0_4_ = fVar11 * *(float*)( pVVar22 + 0x38 ) + fVar10 * *(float*)( pVVar22 + 0x18 ) + fVar55 * *(float*)( pVVar22 + 0x28 ) + *(float*)( pVVar22 + 0x48 );
                                    uStack_360._4_4_ = fVar11 * *(float*)( pVVar22 + 0x3c ) + fVar10 * *(float*)( pVVar22 + 0x1c ) + fVar55 * *(float*)( pVVar22 + 0x2c ) + *(float*)( pVVar22 + 0x4c );
                                    fVar10 = afStack_348[uVar37 * 4];
                                    fVar55 = afStack_348[uVar37 * 4 + 1];
                                    fVar11 = afStack_348[uVar37 * 4 + 2];
                                    auStack_378._4_4_ = fVar11 * *(float*)( pVVar22 + 0x34 ) + fVar10 * *(float*)( pVVar22 + 0x14 ) + fVar55 * *(float*)( pVVar22 + 0x24 ) + *(float*)( pVVar22 + 0x44 );
                                    auStack_378._0_4_ = fVar11 * *(float*)( pVVar22 + 0x30 ) + fVar10 * *(float*)( pVVar22 + 0x10 ) + fVar55 * *(float*)( pVVar22 + 0x20 ) + *(float*)( pVVar22 + 0x40 );
                                    fStack_370 = fVar11 * *(float*)( pVVar22 + 0x38 ) + fVar10 * *(float*)( pVVar22 + 0x18 ) + fVar55 * *(float*)( pVVar22 + 0x28 ) + *(float*)( pVVar22 + 0x48 );
                                    fStack_36c = fVar11 * *(float*)( pVVar22 + 0x3c ) + fVar10 * *(float*)( pVVar22 + 0x1c ) + fVar55 * *(float*)( pVVar22 + 0x2c ) + *(float*)( pVVar22 + 0x4c );
                                    if (( bVar23 >> ( uVar35 & 0x1f ) & 1 ) == 0) {
                                       pcVar6 = *(code**)( *plVar5 + 0x10 );
                                       *(undefined8*)( puVar44 + lVar7 + -8 ) = 0x10a50a;
                                       ( *pcVar6 )(auStack_368, uStack_360, auStack_378, plVar5, (undefined4)Color::sGrey);
                                    }
 else {
                                       *(undefined8*)( puVar44 + lVar7 + -8 ) = 0x10a613;
                                       JPH::DebugRenderer::DrawArrow(auStack_368, uStack_360, auStack_378, plVar5, (undefined4)Color::sGreen);
                                    }
...
/* JPH::HeightFieldShape::Draw(JPH::DebugRenderer*, JPH::Mat44 const&, JPH::Vec3, JPH::Color, bool,
   bool) const */void JPH::HeightFieldShape::Draw(undefined8 param_1_00, undefined8 param_2_00, HeightFieldShape *param_1, long *param_2, float *param_5, undefined4 param_6, HeightFieldShape param_7, undefined1 param_8) {
   uint uVar1;
   undefined8 uVar2;
   ulong uVar3;
   uint uVar4;
   ...
   if (param_1[200] == param_7) {
      ...
      if (lVar6 != 0) {
         ...
         joined_r0x0010b71f:if (puVar10 < puVar13) {
            do {
               piVar9 = (int*)*puVar10;
               if (piVar9 != (int*)0x0) {
                  LOCK();
 ...
 while ( true );
      ...
      *(undefined8*)( param_1 + 0xb0 ) = 0;
      param_1[200] = param_7;
      LAB_0010aeda:uVar29 = *(uint*)( param_1 + 0x40 );
      uVar15 = 0x40;
      if (uVar29 < 0x41) {
         uVar15 = uVar29;
      }
      ...
      if (uVar29 != 0) {
         ...
         lVar6 = uVar5 * 0x6c;
         uVar29 = 0;
         LAB_0010af2d:uVar30 = uVar29 + uVar15;
         uVar32 = 0;
         LAB_0010af48:pfVar7 = (float*)( *Reallocate )(0, 0, lVar6);
         ...
         if (uVar29 < uVar23) {
            do {
               ...
               joined_r0x0010afc0:uVar4 = uVar22;
               if (uVar4 < uVar27) {
                  uVar22 = uVar4 + 1;
                  if (*(int*)( param_1 + 0x48 ) != 0) {
                     ...
                     if (( ( ~(byte)((int)(uint)*(ushort *)(lVar16 + (ulong)(uVar11 >> 3)) >>
                           ((byte)uVar11 & 7)) & (byte)HVar28 ) != 0 ) && ( iVar25 = uVar24 * iVar31 + iVar31 ),uVar11 = ( iVar25 + uVar22 ) * (uint)(byte)param_1[0x54],( ~(byte)((int)(uint)*(ushort *)(lVar16 + (ulong)(uVar11 >> 3)) >>
                        ...
                        if (( ~(byte)((int)(uint)*(ushort *)(lVar16 + (ulong)(uVar11 >> 3)) >>
                           ...
                           *(undefined1(*) [12])( pfVar19 + 9 ) = auVar60;
                           ...
                           pfVar19[0x14] = fVar58;
                           fVar37 = ( fVar41 - fStack_1d4 ) * ( fVar56 - local_1d8 ) - ( fVar57 - fStack_1d4 ) * ( fVar43 - local_1d8 );
 ...
 while ( pfVar19 + 0x1e != pfVar18 );
                        ...
                        if (( ~(byte)((int)(uint)*(ushort *)(lVar16 + (ulong)(uVar12 >> 3)) >>
                           ...
                           *pfVar34 = fVar48;
                           ...
                           pfVar34[10] = fVar55;
                           pfVar34[0x14] = fVar43;
                           fVar48 = ( fStack_1a4 - fStack_1d4 ) * ( local_198 - local_1d8 ) - ( fStack_194 - fStack_1d4 ) * ( local_1a8 - local_1d8 );
                           fVar42 = ( fVar47 - fVar43 ) * ( fStack_194 - fStack_1d4 ) - ( fVar46 - fVar43 ) * ( fStack_1a4 - fStack_1d4 );
                           fVar46 = ( local_1a8 - local_1d8 ) * ( fVar46 - fVar43 ) - ( local_198 - local_1d8 ) * ( fVar47 - fVar43 );
 ...
 while ( true );
      ...
      LAB_0010b44d:lVar6 = *(long*)( param_1 + 0xb0 );
   }
   ...
   for (int i = 0; i < 4; i++) {
      local_118[( i + 8 )] = param_5[( i + 8 )] * fStack_140;
   }

   local_118[0] = *param_5 * local_148;
   for (int i = 0; i < 3; i++) {
      local_118[( i + 1 )] = param_5[( i + 1 )] * local_148;
   }

   for (int i = 0; i < 4; i++) {
      local_118[( i + 4 )] = param_5[( i + 4 )] * fStack_144;
   }
 ...
 while ( lVar16 != 0xc );
         ...
         ( **(code**)( *param_2 + 0x30 ) )(param_2, local_118, &local_98, param_6, plVar35, ( POPCOUNT((byte)uVar14 & 7) & 1U ) != 0, 0, param_8);
         plVar35 = plVar36;
      }
 while ( plVar8 + lVar6 != plVar36 );
   ...
   if (sDrawTriangleOutlines != '\0') {
      ...
      local_98 = param_1;
      uStack_90 = param_2;
      WalkHeightField<JPH::HeightFieldShape::Draw(JPH::DebugRenderer *, JPH::Mat44_const &, JPH::Vec3, JPH::Color, bool, bool)const::Visitor > ( param_1,(Visitor*)&local_98 );
   }

   LAB_0010ae96:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   code_r0x0010b743:plVar8 = *(long**)( piVar9 + 6 );
   if (plVar8 != (long*)0x0) {
      if (( *(long*)( piVar9 + 2 ) != 0 ) && ( plVar35 = plVar8 < plVar35 )) {
         do {
 ...
 while ( plVar8 < plVar35 );
   ...
   LAB_0010b3d8:uVar26 = ( (long)pfVar19 - (long)pfVar7 >> 2 ) * -0x7b425ed097b425ed;
   if (uVar5 < uVar26) {
   ...
   *(ulong*)( piVar9 + 0xe ) = CONCAT44(fStack_7c, fStack_80);
   if (local_120 == (long*)0x0) {
      lVar16 = 0x10;
      uVar26 = 1;
      LAB_0010b622:puVar10 = (undefined8*)( *Allocate )(lVar16);
 ...
 while ( puVar10 <= puVar20 );
   ...
   *(ulong*)( param_1 + 0xb0 ) = uVar26;
   ...
   LAB_0010b40f:if (pfVar7 != (float*)0x0) {
      ( *Free )();
   }
   ...
   goto LAB_0010af48;
   code_r0x0010b42a:uVar29 = uVar30;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* void 
   ...
   JPH::Mat44 const&, JPH::SubShapeIDCreator const&, JPH::SubShapeIDCreator const&,
   JPH::CollisionCollector<JPH::ShapeCastResult,
   JPH::CollisionCollectorTraitsCastShape>&)::Visitor&) const */void JPH::HeightFieldShape::WalkHeightField<JPH::HeightFieldShape::sCastConvexVsHeightField(JPH::ShapeCast_const &, JPH::ShapeCastSettings_const &, JPH::Shape_const *, JPH::Vec3, JPH::ShapeFilter_const &, JPH::Mat44_const &, JPH::SubShapeIDCreator_const &, JPH::SubShapeIDCreator_const &, JPH::CollisionCollector<JPH::ShapeCastResult,JPH::CollisionCollectorTraitsCastShape> &)::Visitor>(HeightFieldShape *this, Visitor *param_1) {
   HeightFieldShape HVar1;
   HeightFieldShape HVar2;
   ushort uVar3;
   HeightFieldShape *this_00;
...
;
      ...
      do {
         ...
         if (uVar26 < local_454) {
            ...
            auVar71 = *(undefined1(*) [16])( ( ulong )(uVar24 * uVar25 + ( &sGridOffsets )[uVar26] + uVar40) * 0x10 + *(long*)( local_258 + 0x60 ) );
            iVar37 = uVar40 * 2;
            auVar7._10_2_ = 0;
            ...
            fStack_3c4 = (float)(int)CONCAT82(SUB148(auVar19 << 0x40, 6), auVar71._2_2_) * fStack_4d4 + fStack_4a4;
            ...
            auVar90._0_8_ = CONCAT44(( (float)(int)( auVar89._4_4_ * uVar56 ) * fStack_4c4 + fStack_494 ) * fVar55, ( (float)(int)( auVar89._0_4_ * uVar56 ) * fStack_4c8 + fStack_498 ) * fVar55);
            auVar90._8_4_ = ( (float)(int)( ( auVar89._8_8_ & 0xffffffff ) * (ulong)uVar56 ) * fStack_4c0 + fStack_490 ) * fVar55;
            auVar90._12_4_ = ( (float)(int)( ( auVar89._8_8_ >> 0x20 ) * (ulong)uVar56 ) * fStack_4bc + fStack_48c ) * fVar55;
            auVar73._0_4_ = ( (float)(int)( ~uVar79 & auVar72._0_4_ * uVar56 | local_478 & uVar79 ) * fStack_4c8 + fStack_498 ) * fVar55;
            auVar73._4_4_ = ( (float)(int)( ~uVar57 & auVar72._4_4_ * uVar56 | uStack_474 & uVar57 ) * fStack_4c4 + fStack_494 ) * fVar55;
            auVar73._8_4_ = ( (float)(int)( ~uVar28 & uVar94 | uStack_470 & uVar28 ) * fStack_4c0 + fStack_490 ) * fVar55;
            auVar73._12_4_ = ( (float)(int)( ~uVar82 & uVar46 | uStack_46c & uVar82 ) * fStack_4bc + fStack_48c ) * fVar55;
            ...
            auVar75._0_8_ = CONCAT44(( (float)(int)( auVar99._4_4_ * uVar56 ) * fStack_4e4 + fStack_4b4 ) * fVar97, ( (float)(int)( auVar99._0_4_ * uVar56 ) * fStack_4e8 + fStack_4b8 ) * fVar97);
            auVar75._8_4_ = ( (float)(int)( ( auVar99._8_8_ & 0xffffffff ) * (ulong)uVar56 ) * fStack_4e0 + fStack_4b0 ) * fVar97;
            auVar75._12_4_ = ( (float)(int)( ( auVar99._8_8_ >> 0x20 ) * (ulong)uVar56 ) * fStack_4dc + fStack_4ac ) * fVar97;
            auVar65._0_4_ = ( (float)(int)( ~uVar25 & uVar24 | local_478 & uVar25 ) * fStack_4e8 + fStack_4b8 ) * fVar97;
            auVar65._4_4_ = ( (float)(int)( ~uVar26 & uVar84 | uStack_474 & uVar26 ) * fStack_4e4 + fStack_4b4 ) * fVar97;
            auVar65._8_4_ = ( (float)(int)( ~uVar27 & uVar40 | uStack_470 & uVar27 ) * fStack_4e0 + fStack_4b0 ) * fVar97;
            auVar65._12_4_ = ( (float)(int)( ~uVar77 & uVar95 | uStack_46c & uVar77 ) * fStack_4dc + fStack_4ac ) * fVar97;
            ...
            auStack_3f8._0_8_ = CONCAT44(( fVar130 - fVar60 ) * fStack_36c, ( fVar129 - fVar60 ) * fStack_36c);
            ...
            uVar24 = (int)( -(uint)(fVar60 < fVar129 || fVar111 < fVar60) & uStack_3a0 | -(uint)(fVar55 < fVar136 || fVar93 < fVar55) & uStack_390 | -(uint)((fVar93 < fVar136 || fVar111 < fVar129) ||
                              (auVar71._0_4_ < auVar88._0_4_ || auVar71._0_4_ < 0.0)) | -(uint)(fVar81 < fVar123 || fVar78 < fVar81) & uStack_3b0 | -(uint)(fVar78 < fVar123) ) >> 0x1f;
            uVar25 = (int)( -(uint)(fVar60 < fVar130 || fVar112 < fVar60) & uStack_3a0 | -(uint)(fVar55 < fVar137 || fVar92 < fVar55) & uStack_390 | -(uint)((fVar92 < fVar137 || fVar112 < fVar130) ||
                              (auVar71._4_4_ < auVar88._4_4_ || auVar71._4_4_ < 0.0)) | -(uint)(fVar81 < fVar124 || fVar83 < fVar81) & uStack_3b0 | -(uint)(fVar83 < fVar124) ) >> 0x1f;
            uVar26 = (int)( -(uint)(fVar60 < fVar131 || fVar122 < fVar60) & uStack_3a0 | -(uint)(fVar55 < fVar138 || fVar107 < fVar55) & uStack_390 | -(uint)((fVar107 < fVar138 || fVar122 < fVar131) ||
                              (auVar71._8_4_ < auVar88._8_4_ || auVar71._8_4_ < 0.0)) | -(uint)(fVar81 < fVar125 || fVar91 < fVar81) & uStack_3b0 | -(uint)(fVar91 < fVar125) ) >> 0x1f;
            uVar40 = (int)( -(uint)(fVar60 < fVar132 || fVar113 < fVar60) & uStack_3a0 | -(uint)(fVar55 < fVar139 || fVar97 < fVar55) & uStack_390 | -(uint)((fVar97 < fVar139 || fVar113 < fVar132) ||
                              (auVar71._12_4_ < auVar88._12_4_ || auVar71._12_4_ < 0.0)) | -(uint)(fVar81 < fVar126 || fVar96 < fVar81) & uStack_3b0 | -(uint)(fVar96 < fVar126) ) >> 0x1f;
            ...
            fVar60 = (float)( ( uVar25 & _UNK_00116654 | ~uVar25 & (uint)auVar88._4_4_ ) & uVar27 | ~uVar27 & _UNK_00116654 );
            fVar97 = (float)( ( uVar26 & _UNK_00116658 | ~uVar26 & (uint)auVar88._8_4_ ) & uVar77 | ~uVar77 & _UNK_00116658 );
            fVar81 = (float)( ( uVar40 & _UNK_0011665c | ~uVar40 & (uint)auVar88._12_4_ ) & uVar79 | ~uVar79 & _UNK_0011665c );
            if (fVar41 <= _LC52) {
               fVar41 = _LC52;
            }
            ...
            if (uVar56 < (uint)auStack_368._0_4_) {
               ...
               do {
                  ...
                  if (uStack_460 < uVar26) {
                     ...
                     do {
                        iVar29 = (int)uVar38;
                        uVar28 = (int)( uint ) * (ushort*)( lVar33 + ( ulong )(uVar46 >> 3) ) >> ( (byte)uVar46 & 7 ) & uVar77;
                        *(bool*)uVar38 = HVar1 == SUB41(uVar28, 0);
                        uVar38 = uVar38 + 1;
                        uVar46 = uVar46 + (byte)HVar2;
                        *pfVar50 = (float)( ( uStack_460 - iVar36 ) + iVar29 ) * fVar97 + auVar71._0_4_;
                        pfVar50[1] = ( ( (float)uVar28 + fVar55 ) * ( (float)(int)( uVar3 - uVar79 ) / fVar60 ) + (float)uVar79 ) * fVar81 + auVar71._4_4_;
 ...
 while ( auStack_368._0_4_ != uVar57 );
            ...
            if (uVar40 < local_458) {
               ...
               if (uVar56 < (uint)auStack_368._0_4_) {
                  ...
                  do {
                     uVar38 = (ulong)uVar79;
                     uVar46 = (int)( uint ) * (ushort*)( lVar33 + ( ulong )(uVar57 >> 3) ) >> ( (byte)uVar57 & 7 ) & uVar77;
                     ...
                     *pfVar53 = (float)uVar26 * fVar97 + fVar13;
                     pfVar53[1] = ( ( (float)uVar46 + fVar55 ) * ( (float)(int)( uVar3 - uVar27 ) / fVar60 ) + (float)uVar27 ) * fVar81 + fVar67;
 ...
 while ( auStack_368._0_4_ != uVar79 );
            ...
            if (uVar25 < local_458) {
               ...
               if (uStack_460 < uVar26) {
                  ...
                  fVar78 = *(float*)( local_258 + 0x2c );
                  iVar36 = (int)lVar30;
                  uVar25 = ( auStack_368._0_4_ * *(int*)( local_258 + 0x40 ) + uStack_460 ) * (uint)(byte)HVar2;
                  lVar34 = ( ulong )(local_420 - 1) + 1;
                  lVar33 = lVar30 + lVar34;
                  pfVar53 = uStack_398;
                  do {
                     uVar79 = (int)( uint ) * (ushort*)( lVar4 + ( ulong )(uVar25 >> 3) ) >> ( (byte)uVar25 & 7 ) & uVar77;
                     *(bool*)lVar30 = HVar1 == SUB41(uVar79, 0);
                     iVar29 = (int)lVar30;
                     lVar30 = lVar30 + 1;
                     uVar25 = uVar25 + (byte)HVar2;
                     *pfVar53 = (float)( ( uStack_460 - iVar36 ) + iVar29 ) * fVar97 + fVar13;
                     pfVar53[1] = ( ( (float)uVar79 + fVar55 ) * ( (float)(int)( uVar3 - uVar24 ) / fVar60 ) + (float)uVar24 ) * fVar81 + fVar67;
 ...
 while ( lVar30 != lVar33 );
               ...
               if (uVar40 < local_458) {
                  ...
                  uVar24 = ( *(int*)( local_258 + 0x40 ) * auStack_368._0_4_ + uVar26 ) * (uint)(byte)local_258[0x54];
                  uVar77 = (int)( uint ) * (ushort*)( *(long*)( local_258 + 0x68 ) + ( ulong )(uVar24 >> 3) ) >> ( (byte)uVar24 & 7 ) & uVar77;
                  ...
                  *uStack_398 = (float)uVar26 * *(float*)( local_258 + 0x30 ) + *(float*)( local_258 + 0x20 );
                  uStack_398[1] = ( ( (float)uVar77 + fVar55 ) * ( (float)(int)( uVar3 - uVar25 ) / fVar60 ) + (float)uVar25 ) * fVar97 + fVar96;
...
;
 ...
 while ( lVar58 != 0x40 );
            ...
            uStack_398 = (float*)CONCAT44(uStack_390, uStack_390);
            uStack_3a8 = CONCAT44(uStack_3a0, uStack_3a0);
            auStack_3e8._0_8_ = CONCAT44(( fVar129 - fVar60 ) * fStack_36c, ( fVar126 - fVar60 ) * fStack_36c);
            ...
            uVar24 = (int)( -(uint)(fVar55 < fVar132 || fVar67 < fVar55) & uStack_390 | -(uint)(fVar60 < fVar126 || fVar107 < fVar60) & uStack_3a0 | -(uint)((fVar67 < fVar132 || fVar107 < fVar126) ||
                              (auVar71._0_4_ < auVar88._0_4_ || auVar71._0_4_ < 0.0)) | -(uint)(fVar97 < fVar122 || fVar83 < fVar97) & uStack_3b0 | -(uint)(fVar83 < fVar122) ) >> 0x1f;
            uVar25 = (int)( -(uint)(fVar55 < fVar136 || fVar76 < fVar55) & uStack_390 | -(uint)(fVar60 < fVar129 || fVar111 < fVar60) & uStack_3a0 | -(uint)((fVar76 < fVar136 || fVar111 < fVar129) ||
                              (auVar71._4_4_ < auVar88._4_4_ || auVar71._4_4_ < 0.0)) | -(uint)(fVar97 < fVar123 || fVar91 < fVar97) & uStack_3b0 | -(uint)(fVar91 < fVar123) ) >> 0x1f;
            uVar26 = (int)( -(uint)(fVar55 < fVar137 || fVar78 < fVar55) & uStack_390 | -(uint)(fVar60 < fVar130 || fVar112 < fVar60) & uStack_3a0 | -(uint)((fVar78 < fVar137 || fVar112 < fVar130) ||
                              (auVar71._8_4_ < auVar88._8_4_ || auVar71._8_4_ < 0.0)) | -(uint)(fVar97 < fVar124 || fVar93 < fVar97) & uStack_3b0 | -(uint)(fVar93 < fVar124) ) >> 0x1f;
            uVar40 = (int)( -(uint)(fVar55 < fVar138 || fVar81 < fVar55) & uStack_390 | -(uint)(fVar60 < fVar131 || fVar113 < fVar60) & uStack_3a0 | -(uint)((fVar81 < fVar138 || fVar113 < fVar131) ||
                              (auVar71._12_4_ < auVar88._12_4_ || auVar71._12_4_ < 0.0)) | -(uint)(fVar97 < fVar125 || fVar96 < fVar97) & uStack_3b0 | -(uint)(fVar96 < fVar125) ) >> 0x1f;
            ...
            fVar60 = (float)( ( uVar25 & _UNK_00116654 | ~uVar25 & (uint)auVar88._4_4_ ) & uVar77 | ~uVar77 & _UNK_00116654 );
            fVar97 = (float)( ( uVar26 & _UNK_00116658 | ~uVar26 & (uint)auVar88._8_4_ ) & uVar79 | ~uVar79 & _UNK_00116658 );
            fVar81 = (float)( ( uVar40 & _UNK_0011665c | ~uVar40 & (uint)auVar88._12_4_ ) & uVar57 | ~uVar57 & _UNK_0011665c );
            if (fVar41 <= _LC52) {
               fVar41 = _LC52;
            }
                              ...
                              if (*pcVar31 == '\0') {
                                 ...
                                 if (pcVar31[uVar35] == '\0') {
                                    ...
                                    while (true) {
                                       ...
                                       uStack_34c = uVar24 + ( iVar36 * (int)fStack_378 + (int)fVar60 ) * 2 << ( ( byte ) * (undefined4*)( pVVar54 + 0x10e4 ) & 0x1f ) | ~(iVar29 << ((byte)*(undefined4 *)(pVVar54 + 0x10e4) & 0x1f)) & *(uint*)( pVVar54 + 0x10e0 );
                                       ...
                                       *(undefined8*)( puVar44 + lVar5 + -8 ) = 0x10c5d3;
                                       JPH::CastConvexVsTriangles::Cast(auStack_3e8._0_8_, auStack_3f8._0_8_, uStack_3a8, auStack_408._0_8_, uStack_3b8, CONCAT44(uStack_414, uStack_418), CONCAT44(fStack_384, fStack_388), uVar23, &uStack_34c);
                                       ...
                                       LAB_0010c60f:if (pcVar31[1] != '\0') break;
...
;
 ...
 while ( fStack_444 != fStack_378 );
                  ...
                  fVar55 = (float)( ~-(uint)(_LC52 < fVar41) & (uint)_LC52 | (uint)fVar41 & -(uint)(_LC52 < fVar41) );
                  do {
                     uVar24 = (uint)lVar58;
 ...
 while ( fVar55 < *(float*)( pVVar54 + lVar30 + ( (long)(int)( ( uVar25 - 1 ) + iStack_448 ) - (long)(int)uVar25 ) * 4 + 0x10ec ) || fVar55 == *(float*)( pVVar54 + lVar30 + ( (long)(int)( ( uVar25 - 1 ) + iStack_448 ) - (long)(int)uVar25 ) * 4 + 0x10ec ) );
               }
 while ( true );
            }
         ...
         LAB_0010c706:piVar42 = (int*)( puVar44 + lVar5 );
 ...
 while ( fVar55 < *(float*)( local_440 + lVar30 + 0x10e8 ) || fVar55 == *(float*)( local_440 + lVar30 + 0x10e8 ) );
         local_250 = iVar37;
 ...
 while ( true );
   ...
   LAB_0010b818:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
...
/* JPH::HeightFieldShape::sCastConvexVsHeightField(JPH::ShapeCast const&, JPH::ShapeCastSettings
   ...
   JPH::CollisionCollector<JPH::ShapeCastResult, JPH::CollisionCollectorTraitsCastShape>&) */void JPH::HeightFieldShape::sCastConvexVsHeightField(long param_1, undefined8 param_2, HeightFieldShape *param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, undefined8 *param_7, undefined8 param_8) {
   undefined1 auVar1[16];
   long in_FS_OFFSET;
   undefined1 auVar2[16];
   undefined1 auVar3[16];
   ...
   long local_30;
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   JPH::CastConvexVsTriangles::CastConvexVsTriangles((CastConvexVsTriangles*)aVStack_1328, param_1, param_2, param_5, param_6, param_8);
   ...
   local_298 = param_3;
   WalkHeightField<JPH::HeightFieldShape::sCastConvexVsHeightField(JPH::ShapeCast_const &, JPH::ShapeCastSettings_const &, JPH::Shape_const *, JPH::Vec3, JPH::ShapeFilter_const &, JPH::Mat44_const &, JPH::SubShapeIDCreator_const &, JPH::SubShapeIDCreator_const &, JPH::CollisionCollector<JPH::ShapeCastResult,JPH::CollisionCollectorTraitsCastShape> &)::Visitor>(param_3, aVStack_1328);
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
;
      ...
      do {
         ...
         if (uVar26 < local_454) {
            ...
            auVar72 = *(undefined1(*) [16])( ( ulong )(uVar24 * uVar25 + ( &sGridOffsets )[uVar26] + uVar40) * 0x10 + *(long*)( local_258 + 0x60 ) );
            iVar37 = uVar40 * 2;
            auVar7._10_2_ = 0;
            ...
            fStack_3c4 = (float)(int)CONCAT82(SUB148(auVar18 << 0x40, 6), auVar72._2_2_) * fStack_4d4 + fStack_4a4;
            fStack_3c0 = (float)auVar8._8_4_ * fStack_4d0 + fStack_4a0;
            fStack_3bc = (float)( auVar7._10_4_ >> 0x10 ) * fStack_4cc + fStack_49c;
            iVar36 = uVar25 * 2;
            ...
            auVar91._0_8_ = CONCAT44(( (float)(int)( auVar90._4_4_ * uVar55 ) * fStack_4c4 + fStack_494 ) * fVar97, ( (float)(int)( auVar90._0_4_ * uVar55 ) * fStack_4c8 + fStack_498 ) * fVar97);
            auVar91._8_4_ = ( (float)(int)( ( auVar90._8_8_ & 0xffffffff ) * (ulong)uVar55 ) * fStack_4c0 + fStack_490 ) * fVar97;
            auVar91._12_4_ = ( (float)(int)( ( auVar90._8_8_ >> 0x20 ) * (ulong)uVar55 ) * fStack_4bc + fStack_48c ) * fVar97;
            auVar74._0_4_ = ( (float)(int)( ~uVar80 & auVar73._0_4_ * uVar55 | local_478 & uVar80 ) * fStack_4c8 + fStack_498 ) * fVar97;
            auVar74._4_4_ = ( (float)(int)( ~uVar56 & auVar73._4_4_ * uVar55 | uStack_474 & uVar56 ) * fStack_4c4 + fStack_494 ) * fVar97;
            auVar74._8_4_ = ( (float)(int)( ~uVar28 & uVar94 | uStack_470 & uVar28 ) * fStack_4c0 + fStack_490 ) * fVar97;
            auVar74._12_4_ = ( (float)(int)( ~uVar83 & uVar46 | uStack_46c & uVar83 ) * fStack_4bc + fStack_48c ) * fVar97;
            ...
            auVar76._0_8_ = CONCAT44(( (float)(int)( auVar100._4_4_ * uVar55 ) * fStack_4e4 + fStack_4b4 ) * fVar66, ( (float)(int)( auVar100._0_4_ * uVar55 ) * fStack_4e8 + fStack_4b8 ) * fVar66);
            auVar76._8_4_ = ( (float)(int)( ( auVar100._8_8_ & 0xffffffff ) * (ulong)uVar55 ) * fStack_4e0 + fStack_4b0 ) * fVar66;
            auVar76._12_4_ = ( (float)(int)( ( auVar100._8_8_ >> 0x20 ) * (ulong)uVar55 ) * fStack_4dc + fStack_4ac ) * fVar66;
            uStack_3b8 = CONCAT44(fStack_3b0, fStack_3b0);
            auVar64._0_4_ = ( (float)(int)( ~uVar25 & uVar24 | local_478 & uVar25 ) * fStack_4e8 + fStack_4b8 ) * fVar66;
            auVar64._4_4_ = ( (float)(int)( ~uVar26 & uVar85 | uStack_474 & uVar26 ) * fStack_4e4 + fStack_4b4 ) * fVar66;
            auVar64._8_4_ = ( (float)(int)( ~uVar27 & uVar40 | uStack_470 & uVar27 ) * fStack_4e0 + fStack_4b0 ) * fVar66;
            auVar64._12_4_ = ( (float)(int)( ~uVar78 & uVar95 | uStack_46c & uVar78 ) * fStack_4dc + fStack_4ac ) * fVar66;
            ...
            auStack_3f8._0_8_ = CONCAT44(( fVar131 - fVar66 ) * fStack_36c, ( fVar130 - fVar66 ) * fStack_36c);
            ...
            uVar24 = (int)( -(uint)(fVar66 < fVar130 || fVar112 < fVar66) & (uint)fStack_3a0 | -(uint)(fVar59 < fVar137 || fVar92 < fVar59) & (uint)fStack_390 | -(uint)((fVar92 < fVar137 || fVar112 < fVar130) ||
                              (auVar72._0_4_ < auVar89._0_4_ || auVar72._0_4_ < 0.0)) | -(uint)(fVar67 < fVar124 || fVar79 < fVar67) & (uint)fStack_3b0 | -(uint)(fVar79 < fVar124) ) >> 0x1f;
            uVar25 = (int)( -(uint)(fVar66 < fVar131 || fVar113 < fVar66) & (uint)fStack_3a0 | -(uint)(fVar59 < fVar138 || fVar93 < fVar59) & (uint)fStack_390 | -(uint)((fVar93 < fVar138 || fVar113 < fVar131) ||
                              (auVar72._4_4_ < auVar89._4_4_ || auVar72._4_4_ < 0.0)) | -(uint)(fVar67 < fVar125 || fVar82 < fVar67) & (uint)fStack_3b0 | -(uint)(fVar82 < fVar125) ) >> 0x1f;
            uVar26 = (int)( -(uint)(fVar66 < fVar132 || fVar114 < fVar66) & (uint)fStack_3a0 | -(uint)(fVar59 < fVar139 || fVar96 < fVar59) & (uint)fStack_390 | -(uint)((fVar96 < fVar139 || fVar114 < fVar132) ||
                              (auVar72._8_4_ < auVar89._8_4_ || auVar72._8_4_ < 0.0)) | -(uint)(fVar67 < fVar126 || fVar84 < fVar67) & (uint)fStack_3b0 | -(uint)(fVar84 < fVar126) ) >> 0x1f;
            uVar40 = (int)( -(uint)(fVar66 < fVar133 || fVar123 < fVar66) & (uint)fStack_3a0 | -(uint)(fVar59 < fVar140 || fVar108 < fVar59) & (uint)fStack_390 | -(uint)((fVar108 < fVar140 || fVar123 < fVar133) ||
                              (auVar72._12_4_ < auVar89._12_4_ || auVar72._12_4_ < 0.0)) | -(uint)(fVar67 < fVar127 || fVar97 < fVar67) & (uint)fStack_3b0 | -(uint)(fVar97 < fVar127) ) >> 0x1f;
            lVar30 = (long)local_250;
            lVar57 = lVar30 * 4;
            ...
            fVar59 = (float)( ( uVar25 & _UNK_00116654 | ~uVar25 & (uint)auVar89._4_4_ ) & uVar27 | ~uVar27 & _UNK_00116654 );
            fVar66 = (float)( ( uVar26 & _UNK_00116658 | ~uVar26 & (uint)auVar89._8_4_ ) & uVar78 | ~uVar78 & _UNK_00116658 );
            fVar67 = (float)( ( uVar40 & _UNK_0011665c | ~uVar40 & (uint)auVar89._12_4_ ) & uVar80 | ~uVar80 & _UNK_0011665c );
            if (fVar41 <= _LC52) {
               fVar41 = _LC52;
            }
            ...
            if (uVar55 < (uint)auStack_368._0_4_) {
               ...
               do {
                  ...
                  if (uStack_460 < uVar26) {
                     ...
                     do {
                        iVar29 = (int)uVar38;
                        uVar28 = (int)( uint ) * (ushort*)( lVar33 + ( ulong )(uVar46 >> 3) ) >> ( (byte)uVar46 & 7 ) & uVar78;
                        *(bool*)uVar38 = HVar1 == SUB41(uVar28, 0);
                        uVar38 = uVar38 + 1;
                        uVar46 = uVar46 + (byte)HVar2;
                        *pfVar50 = (float)( ( uStack_460 - iVar36 ) + iVar29 ) * fVar66 + auVar72._0_4_;
                        pfVar50[1] = ( ( (float)uVar28 + fVar97 ) * ( (float)(int)( uVar3 - uVar80 ) / fVar59 ) + (float)uVar80 ) * fVar67 + auVar72._4_4_;
 ...
 while ( auStack_368._0_4_ != uVar56 );
            ...
            if (uVar40 < local_458) {
               ...
               if (uVar55 < (uint)auStack_368._0_4_) {
                  ...
                  do {
                     uVar38 = (ulong)uVar80;
                     uVar46 = (int)( uint ) * (ushort*)( lVar33 + ( ulong )(uVar56 >> 3) ) >> ( (byte)uVar56 & 7 ) & uVar78;
                     *(bool*)lVar30 = HVar1 == SUB41(uVar46, 0);
                     lVar30 = lVar30 + (ulong)local_41c;
                     uVar80 = uVar80 + 1;
                     uVar56 = uVar56 + iVar37 * (uint)(byte)HVar2;
                     *pfVar53 = (float)uVar26 * fVar66 + fVar77;
                     pfVar53[1] = ( ( (float)uVar46 + fVar97 ) * ( (float)(int)( uVar3 - uVar27 ) / fVar59 ) + (float)uVar27 ) * fVar67 + fVar79;
 ...
 while ( auStack_368._0_4_ != uVar80 );
            ...
            if (uVar25 < local_458) {
               ...
               if (uStack_460 < uVar26) {
                  ...
                  pfVar53 = uStack_398;
                  do {
                     uVar80 = (int)( uint ) * (ushort*)( lVar4 + ( ulong )(uVar25 >> 3) ) >> ( (byte)uVar25 & 7 ) & uVar78;
                     *(bool*)lVar30 = HVar1 == SUB41(uVar80, 0);
                     iVar29 = (int)lVar30;
                     lVar30 = lVar30 + 1;
                     uVar25 = uVar25 + (byte)HVar2;
                     *pfVar53 = (float)( ( uStack_460 - iVar36 ) + iVar29 ) * fVar66 + fVar77;
                     pfVar53[1] = ( ( (float)uVar80 + fVar97 ) * ( (float)(int)( uVar3 - uVar24 ) / fVar59 ) + (float)uVar24 ) * fVar67 + fVar79;
 ...
 while ( lVar30 != lVar33 );
               ...
               if (uVar40 < local_458) {
                  ...
                  uVar24 = ( *(int*)( local_258 + 0x40 ) * auStack_368._0_4_ + uVar26 ) * (uint)(byte)local_258[0x54];
                  uVar78 = (int)( uint ) * (ushort*)( *(long*)( local_258 + 0x68 ) + ( ulong )(uVar24 >> 3) ) >> ( (byte)uVar24 & 7 ) & uVar78;
                  ...
                  *uStack_398 = (float)uVar26 * *(float*)( local_258 + 0x30 ) + *(float*)( local_258 + 0x20 );
                  uStack_398[1] = ( ( (float)uVar78 + fVar97 ) * ( (float)(int)( uVar3 - uVar25 ) / fVar59 ) + (float)uVar25 ) * fVar66 + fVar68;
...
;
 ...
 while ( lVar57 != 0x40 );
            ...
            auStack_3e8._0_8_ = CONCAT44(( fVar130 - fVar66 ) * fStack_36c, ( fVar127 - fVar66 ) * fStack_36c);
            ...
            uVar24 = (int)( -(uint)(fVar59 < fVar133 || fVar68 < fVar59) & (uint)fStack_390 | -(uint)(fVar66 < fVar127 || fVar108 < fVar66) & (uint)fStack_3a0 | -(uint)((fVar68 < fVar133 || fVar108 < fVar127) ||
                              (auVar72._0_4_ < auVar89._0_4_ || auVar72._0_4_ < 0.0)) | -(uint)(fVar67 < fVar123 || fVar84 < fVar67) & (uint)fStack_3b0 | -(uint)(fVar84 < fVar123) ) >> 0x1f;
            uVar25 = (int)( -(uint)(fVar59 < fVar137 || fVar77 < fVar59) & (uint)fStack_390 | -(uint)(fVar66 < fVar130 || fVar112 < fVar66) & (uint)fStack_3a0 | -(uint)((fVar77 < fVar137 || fVar112 < fVar130) ||
                              (auVar72._4_4_ < auVar89._4_4_ || auVar72._4_4_ < 0.0)) | -(uint)(fVar67 < fVar124 || fVar92 < fVar67) & (uint)fStack_3b0 | -(uint)(fVar92 < fVar124) ) >> 0x1f;
            uVar26 = (int)( -(uint)(fVar59 < fVar138 || fVar79 < fVar59) & (uint)fStack_390 | -(uint)(fVar66 < fVar131 || fVar113 < fVar66) & (uint)fStack_3a0 | -(uint)((fVar79 < fVar138 || fVar113 < fVar131) ||
                              (auVar72._8_4_ < auVar89._8_4_ || auVar72._8_4_ < 0.0)) | -(uint)(fVar67 < fVar125 || fVar93 < fVar67) & (uint)fStack_3b0 | -(uint)(fVar93 < fVar125) ) >> 0x1f;
            uVar40 = (int)( -(uint)(fVar59 < fVar139 || fVar82 < fVar59) & (uint)fStack_390 | -(uint)(fVar66 < fVar132 || fVar114 < fVar66) & (uint)fStack_3a0 | -(uint)((fVar82 < fVar139 || fVar114 < fVar132) ||
                              (auVar72._12_4_ < auVar89._12_4_ || auVar72._12_4_ < 0.0)) | -(uint)(fVar67 < fVar126 || fVar97 < fVar67) & (uint)fStack_3b0 | -(uint)(fVar97 < fVar126) ) >> 0x1f;
            uVar27 = (int)-(uint)((float)auStack_2d8._4_4_ <= (float)auStack_298._4_4_) >> 0x1f;
            ...
            fVar59 = (float)( ( uVar25 & _UNK_00116654 | ~uVar25 & (uint)auVar89._4_4_ ) & uVar78 | ~uVar78 & _UNK_00116654 );
            fVar66 = (float)( ( uVar26 & _UNK_00116658 | ~uVar26 & (uint)auVar89._8_4_ ) & uVar80 | ~uVar80 & _UNK_00116658 );
            fVar67 = (float)( ( uVar40 & _UNK_0011665c | ~uVar40 & (uint)auVar89._12_4_ ) & uVar56 | ~uVar56 & _UNK_0011665c );
            if (fVar41 <= _LC52) {
               fVar41 = _LC52;
            }
                              ...
                              if (*pcVar31 == '\0') {
                                 ...
                                 if (pcVar31[uVar35] == '\0') {
                                    ...
                                    while (true) {
                                       ...
                                       fStack_384 = (float)( (ulong)pVVar54 >> 0x20 );
                                       uStack_398 = (float*)CONCAT44(uStack_398._4_4_, uVar24);
                                       uStack_34c = uVar24 + ( iVar36 * (int)fStack_378 + (int)fVar59 ) * 2 << ( SUB41(*(float*)( pVVar54 + 0x94 ), 0) & 0x1f ) | ~(iVar29 << (SUB41(*(float *)(pVVar54 + 0x94),0) & 0x1f)) & ( uint ) * (float*)( pVVar54 + 0x90 );
                                       ...
                                       *(undefined8*)( puVar44 + lVar5 + -8 ) = 0x10e1f8;
                                       JPH::CastSphereVsTriangles::Cast(auStack_3e8._0_8_, auStack_3f8._0_8_, uStack_3a8, auStack_408._0_8_, uStack_3b8, CONCAT44(uStack_414, uStack_418), CONCAT44(fStack_384, fStack_388), uVar23, &uStack_34c);
                                       pVVar54 = (Visitor*)CONCAT44(fStack_384, fStack_388);
                                       piVar42 = (int*)( puVar44 + lVar5 );
                                       ...
                                       fVar97 = fStack_3c8;
                                       if ((int)uStack_398 == 1) break;
                                       LAB_0010e234:if (pcVar31[1] != '\0') break;
                                       uStack_3b8 = *(undefined8*)( pfVar53 + 4 );
                                       uVar24 = 1;
                                       auStack_3e8._0_8_ = *(undefined8*)pfVar53;
                                       auStack_3f8._0_8_ = *(undefined8*)( pfVar53 + 2 );
...
;
 ...
 while ( fStack_444 != fStack_378 );
                  ...
                  fVar97 = (float)( ~-(uint)(_LC52 < fVar41) & (uint)_LC52 | (uint)fVar41 & -(uint)(_LC52 < fVar41) );
                  do {
                     uVar24 = (uint)lVar57;
 ...
 while ( fVar97 < *(float*)( pVVar54 + lVar30 + ( (long)(int)( ( uVar25 - 1 ) + iStack_448 ) - (long)(int)uVar25 ) * 4 + 0x9c ) || fVar97 == *(float*)( pVVar54 + lVar30 + ( (long)(int)( ( uVar25 - 1 ) + iStack_448 ) - (long)(int)uVar25 ) * 4 + 0x9c ) );
               }
 while ( true );
            }
         ...
         LAB_0010e326:piVar42 = (int*)( puVar44 + lVar5 );
         if (fVar41 <= _LC19) break;
 ...
 while ( fVar97 < *(float*)( local_440 + lVar30 + 0x98 ) || fVar97 == *(float*)( local_440 + lVar30 + 0x98 ) );
         local_250 = iVar37;
         uVar24 = auStack_24c[iVar37];
      }
 while ( true );
   ...
   LAB_0010d458:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
...
/* JPH::HeightFieldShape::sCastSphereVsHeightField(JPH::ShapeCast const&, JPH::ShapeCastSettings
   const&, JPH::Shape const*, JPH::Vec3, JPH::ShapeFilter const&, JPH::Mat44 const&,
   JPH::SubShapeIDCreator const&, JPH::SubShapeIDCreator const&,
   JPH::CollisionCollector<JPH::ShapeCastResult, JPH::CollisionCollectorTraitsCastShape>&) */void JPH::HeightFieldShape::sCastSphereVsHeightField(long param_1, undefined8 param_2, HeightFieldShape *param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, undefined8 *param_7, undefined8 param_8) {
   undefined1 auVar1[16];
   long in_FS_OFFSET;
   undefined1 auVar2[16];
   undefined1 auVar3[16];
   ...
   long local_30;
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   JPH::CastSphereVsTriangles::CastSphereVsTriangles((CastSphereVsTriangles*)aVStack_2d8, param_1, param_2, param_5, param_6, param_8);
   auVar1 = *(undefined1(*) [16])( param_1 + 0x60 );
   local_248 = *param_7;
   auVar2._0_4_ = 0.0 - auVar1._0_4_;
   auVar2._4_4_ = 0.0 - auVar1._4_4_;
   ...
   local_270 = param_3;
   WalkHeightField<JPH::HeightFieldShape::sCastSphereVsHeightField(JPH::ShapeCast_const &, JPH::ShapeCastSettings_const &, JPH::Shape_const *, JPH::Vec3, JPH::ShapeFilter_const &, JPH::Mat44_const &, JPH::SubShapeIDCreator_const &, JPH::SubShapeIDCreator_const &, JPH::CollisionCollector<JPH::ShapeCastResult,JPH::CollisionCollectorTraitsCastShape> &)::Visitor>(param_3, aVStack_2d8);
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* void 
   ...
   local_3c8 = param_1;
   if (*(int*)( this + 0x48 ) == 0) {
      LAB_0010f003:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
...
;
   ...
   do {
      ...
      if (uVar17 < local_3c0) {
         ...
         auVar54 = *(undefined1(*) [16])( ( ulong )(uVar15 * uVar16 + ( &sGridOffsets )[uVar17] + uVar46) * 0x10 + *(long*)( local_258 + 0x60 ) );
         auVar6._10_2_ = 0;
         ...
         uVar51 = CONCAT44(( (float)(int)( auVar75._4_4_ * uVar15 ) * fStack_424 + fStack_3f4 ) * fVar9, ( (float)(int)( auVar75._0_4_ * uVar15 ) * fStack_428 + fStack_3f8 ) * fVar9);
         fVar57 = ( (float)(int)( ( auVar75._8_8_ & 0xffffffff ) * (ulong)uVar15 ) * fStack_420 + fStack_3f0 ) * fVar9;
         fVar61 = ( (float)(int)( ( auVar75._8_8_ >> 0x20 ) * (ulong)uVar15 ) * fStack_41c + fStack_3ec ) * fVar9;
         auVar78._0_4_ = ( (float)(int)( ~uVar46 & auVar65._0_4_ * uVar15 | uStack_468 & uVar46 ) * fStack_428 + fStack_3f8 ) * fVar9;
         auVar78._4_4_ = ( (float)(int)( ~uVar21 & auVar65._4_4_ * uVar15 | uStack_464 & uVar21 ) * fStack_424 + fStack_3f4 ) * fVar9;
         auVar78._8_4_ = ( (float)(int)( ~uVar45 & uVar105 | uStack_460 & uVar45 ) * fStack_420 + fStack_3f0 ) * fVar9;
         auVar78._12_4_ = ( (float)(int)( ~uVar58 & uVar38 | uStack_45c & uVar58 ) * fStack_41c + fStack_3ec ) * fVar9;
         ...
         auVar80._0_8_ = CONCAT44(( (float)(int)( auVar103._4_4_ * uVar15 ) * fStack_444 + fStack_414 ) * fVar10, ( (float)(int)( auVar103._0_4_ * uVar15 ) * fStack_448 + fStack_418 ) * fVar10);
         auVar80._8_4_ = ( (float)(int)( ( auVar103._8_8_ & 0xffffffff ) * (ulong)uVar15 ) * fStack_440 + fStack_410 ) * fVar10;
         auVar80._12_4_ = ( (float)(int)( ( auVar103._8_8_ >> 0x20 ) * (ulong)uVar15 ) * fStack_43c + fStack_40c ) * fVar10;
         auVar112._8_4_ = auVar80._8_4_;
         auVar112._0_8_ = auVar80._0_8_;
         auVar112._12_4_ = auVar80._12_4_;
         auVar70._0_4_ = fVar10 * ( (float)(int)( ~uVar48 & uVar62 | uStack_468 & uVar48 ) * fStack_448 + fStack_418 );
         auVar70._4_4_ = fVar10 * ( (float)(int)( ~uVar28 & uVar17 | uStack_464 & uVar28 ) * fStack_444 + fStack_414 );
         auVar70._8_4_ = fVar10 * ( (float)(int)( ~uVar22 & uVar72 | uStack_460 & uVar22 ) * fStack_440 + fStack_410 );
         auVar70._12_4_ = fVar10 * ( (float)(int)( ~uVar59 & uVar18 | uStack_45c & uVar59 ) * fStack_43c + fStack_40c );
         ...
         if (uVar45 < uVar48) {
            ...
            do {
               ...
               if (uStack_3d4 < uVar17) {
                  ...
                  do {
                     iVar19 = (int)uVar30;
                     uVar18 = (int)( uint ) * (ushort*)( lVar23 + ( ulong )(uVar46 >> 3) ) >> ( (byte)uVar46 & 7 ) & uVar21;
                     *(bool*)uVar30 = HVar1 == SUB41(uVar18, 0);
                     uVar30 = uVar30 + 1;
                     uVar46 = uVar46 + (byte)HVar2;
                     *pfVar42 = (float)( ( uStack_3d4 - iVar29 ) + iVar19 ) * auVar54._0_4_ + auVar65._0_4_;
                     pfVar42[1] = ( ( (float)uVar18 + fVar9 ) * ( (float)(int)( uVar3 - uVar38 ) / fVar50 ) + (float)uVar38 ) * auVar54._4_4_ + auVar65._4_4_;
 ...
 while ( uVar48 != uVar15 );
         ...
         if (uVar46 < local_3cc) {
            ...
            if (uVar45 < uVar48) {
               ...
               do {
                  uVar40 = (ulong)uVar38;
                  uVar22 = (int)( uint ) * (ushort*)( pVStack_358 + ( uVar18 >> 3 ) ) >> ( (byte)uVar18 & 7 ) & uVar21;
                  ...
                  *pfVar32 = (float)uVar17 * fVar10 + fVar90;
                  pfVar32[1] = ( ( (float)uVar22 + fVar9 ) * ( (float)(int)( uVar3 - uVar15 ) / fVar50 ) + (float)uVar15 ) * fVar57 + fVar91;
 ...
 while ( uVar48 != uVar38 );
         ...
         if (uVar16 < local_3cc) {
            ...
            if (uStack_3d4 < uVar17) {
               ...
               do {
                  iVar19 = (int)lVar23;
                  uVar28 = (int)( uint ) * (ushort*)( lStack_350 + ( ulong )(uVar16 >> 3) ) >> ( (byte)uVar16 & 7 ) & uVar21;
                  *(bool*)lVar23 = HVar1 == SUB41(uVar28, 0);
                  lVar23 = lVar23 + 1;
                  uVar16 = uVar16 + (byte)HVar2;
                  *(float*)pVVar44 = (float)( ( uStack_3d4 - iVar29 ) + iVar19 ) * fVar10 + fVar90;
                  *(float*)( pVVar44 + 4 ) = ( ( (float)uVar28 + fVar9 ) * ( (float)(int)( uVar3 - uVar15 ) / fVar50 ) + (float)uVar15 ) * fVar57 + fVar91;
 ...
 while ( lVar23 != lVar26 );
            ...
            if (uVar46 < local_3cc) {
               ...
               uVar21 = (int)( uint ) * (ushort*)( *(long*)( local_258 + 0x68 ) + ( ulong )(uVar15 >> 3) ) >> ( (byte)uVar15 & 7 ) & uVar21;
               ...
               *(float*)pVStack_358 = (float)uVar17 * *(float*)( local_258 + 0x30 ) + *(float*)( local_258 + 0x20 );
               *(float*)( pVStack_358 + 4 ) = ( ( (float)uVar21 + fVar9 ) * ( (float)(int)( uVar3 - uVar46 ) / fVar50 ) + (float)uVar46 ) * fVar10 + fVar86;
                           ...
                           if (*pcVar24 == '\0') {
                              ...
                              if (pcVar24[uVar40] == '\0') {
                                 ...
                                 while (true) {
                                    ...
                                    uStack_32c = uVar46 + ( iVar47 * (uint)lStack_350 + uVar15 ) * 2 << ( ( byte ) * (undefined4*)( pVVar44 + 0x21ac ) & 0x1f ) | ~(iVar19 << ((byte)*(undefined4 *)(pVVar44 + 0x21ac) & 0x1f)) & *(uint*)( pVVar44 + 0x21a8 );
                                    ...
                                    *(undefined8*)( puVar36 + lVar4 + -8 ) = 0x10fa04;
                                    JPH::CollideConvexVsTriangles::Collide(uStack_388, uStack_390, lStack_368, uStack_398, uStack_370, uStack_3a0, pVStack_358, uVar14, &uStack_32c);
                                    ...
                                    LAB_0010fa40:if (pcVar24[1] != '\0') break;
                                    uStack_388 = *(undefined8*)pfVar32;
...
/* JPH::HeightFieldShape::sCollideConvexVsHeightField(JPH::Shape const*, JPH::Shape const*,
   ...
   JPH::CollisionCollector<JPH::CollideShapeResult, JPH::CollisionCollectorTraitsCollideShape>&,
   JPH::ShapeFilter const&) */void JPH::HeightFieldShape::sCollideConvexVsHeightField(undefined8 param_1, HeightFieldShape *param_2) {
   undefined8 *in_R9;
   long in_FS_OFFSET;
   ...
   long local_20;
   local_20 = *(long*)( in_FS_OFFSET + 0x28 );
   JPH::CollideConvexVsTriangles::CollideConvexVsTriangles((CollideConvexVsTriangles*)aVStack_21d8, param_1);
   local_30 = *in_R9;
   local_38 = param_2;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* void 
   ...
   local_3c8 = param_1;
   if (*(int*)( this + 0x48 ) == 0) {
      LAB_00110373:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
...
;
   ...
   do {
      ...
      if (uVar16 < local_3c0) {
         ...
         auVar53 = *(undefined1(*) [16])( ( ulong )(uVar14 * uVar15 + ( &sGridOffsets )[uVar16] + uVar45) * 0x10 + *(long*)( local_258 + 0x60 ) );
         auVar7._10_2_ = 0;
         ...
         auVar87._0_8_ = CONCAT44(( (float)(int)( auVar69._4_4_ * uVar14 ) * fStack_424 + fStack_3f4 ) * fVar1, ( (float)(int)( auVar69._0_4_ * uVar14 ) * fStack_428 + fStack_3f8 ) * fVar1);
         auVar87._8_4_ = ( (float)(int)( ( auVar69._8_8_ & 0xffffffff ) * (ulong)uVar14 ) * fStack_420 + fStack_3f0 ) * fVar1;
         auVar87._12_4_ = ( (float)(int)( ( auVar69._8_8_ >> 0x20 ) * (ulong)uVar14 ) * fStack_41c + fStack_3ec ) * fVar1;
         auVar70._0_4_ = ( (float)(int)( ~uVar17 & auVar93._0_4_ * uVar14 | uStack_468 & uVar17 ) * fStack_428 + fStack_3f8 ) * fVar1;
         auVar70._4_4_ = ( (float)(int)( ~uVar63 & auVar93._4_4_ * uVar14 | uStack_464 & uVar63 ) * fStack_424 + fStack_3f4 ) * fVar1;
         auVar70._8_4_ = ( (float)(int)( ~uVar65 & uVar84 | uStack_460 & uVar65 ) * fStack_420 + fStack_3f0 ) * fVar1;
         auVar70._12_4_ = ( (float)(int)( ~uVar67 & uVar64 | uStack_45c & uVar67 ) * fStack_41c + fStack_3ec ) * fVar1;
         ...
         auVar79._0_8_ = CONCAT44(( (float)(int)( auVar78._4_4_ * uVar14 ) * fStack_444 + fStack_414 ) * fVar58, ( (float)(int)( auVar78._0_4_ * uVar14 ) * fStack_448 + fStack_418 ) * fVar58);
         auVar79._8_4_ = ( (float)(int)( ( auVar78._8_8_ & 0xffffffff ) * (ulong)uVar14 ) * fStack_440 + fStack_410 ) * fVar58;
         auVar79._12_4_ = ( (float)(int)( ( auVar78._8_8_ >> 0x20 ) * (ulong)uVar14 ) * fStack_43c + fStack_40c ) * fVar58;
         auVar108._0_4_ = ( (float)(int)( ~uVar16 & uVar45 | uStack_468 & uVar16 ) * fStack_448 + fStack_418 ) * fVar58;
         auVar108._4_4_ = ( (float)(int)( ~uVar47 & uVar21 | uStack_464 & uVar47 ) * fStack_444 + fStack_414 ) * fVar58;
         auVar108._8_4_ = ( (float)(int)( ~uVar27 & uVar20 | uStack_460 & uVar27 ) * fStack_440 + fStack_410 ) * fVar58;
         auVar108._12_4_ = ( (float)(int)( ~uVar37 & uVar66 | uStack_45c & uVar37 ) * fStack_43c + fStack_40c ) * fVar58;
         ...
         auVar104._0_4_ = -(uint)(fVar50 * fVar50 + fVar95 * fVar95 + fVar86 * fVar86 <= fVar1 && fVar101 <= fVar83
                  );
         auVar104._4_4_ = -(uint)(fVar56 * fVar56 + fVar99 * fVar99 + fVar72 * fVar72 <= fVar1 && fVar105 <= fVar89
                  );
         auVar104._8_4_ = -(uint)(fVar57 * fVar57 + fVar100 * fVar100 + fVar82 * fVar82 <= fVar1 &&
                  fVar106 <= fVar90);
         auVar104._12_4_ = -(uint)(fVar58 * fVar58 + fVar49 * fVar49 + fVar85 * fVar85 <= fVar1 && fVar94 <= fVar91);
         ...
         if (uVar44 < uVar47) {
            ...
            do {
               ...
               if (uStack_3d4 < uVar16) {
                  ...
                  do {
                     iVar18 = (int)uVar29;
                     uVar17 = (int)( uint ) * (ushort*)( lVar22 + ( ulong )(uVar45 >> 3) ) >> ( (byte)uVar45 & 7 ) & uVar20;
                     ...
                     *pfVar41 = (float)( ( uStack_3d4 - iVar28 ) + iVar18 ) * auVar53._0_4_ + auVar97._0_4_;
                     pfVar41[1] = ( ( (float)uVar17 + fVar1 ) * ( (float)(int)( uVar4 - uVar37 ) / fVar49 ) + (float)uVar37 ) * auVar53._4_4_ + auVar97._4_4_;
 ...
 while ( uVar47 != uVar14 );
         ...
         if (uVar45 < local_3cc) {
            ...
            if (uVar44 < uVar47) {
               ...
               do {
                  uVar39 = (ulong)uVar37;
                  uVar21 = (int)( uint ) * (ushort*)( pVStack_358 + ( uVar17 >> 3 ) ) >> ( (byte)uVar17 & 7 ) & uVar20;
                  ...
                  *pfVar31 = (float)uVar16 * fVar58 + fVar57;
                  pfVar31[1] = ( ( (float)uVar21 + fVar1 ) * ( (float)(int)( uVar4 - uVar14 ) / fVar49 ) + (float)uVar14 ) * fVar85 + fVar86;
 ...
 while ( uVar47 != uVar37 );
         ...
         if (uVar15 < local_3cc) {
            ...
            if (uStack_3d4 < uVar16) {
               ...
               do {
                  iVar18 = (int)lVar22;
                  uVar27 = (int)( uint ) * (ushort*)( lStack_350 + ( ulong )(uVar15 >> 3) ) >> ( (byte)uVar15 & 7 ) & uVar20;
                  *(bool*)lVar22 = HVar2 == SUB41(uVar27, 0);
                  lVar22 = lVar22 + 1;
                  uVar15 = uVar15 + (byte)HVar3;
                  *(float*)pVVar43 = (float)( ( uStack_3d4 - iVar28 ) + iVar18 ) * fVar58 + fVar57;
                  *(float*)( pVVar43 + 4 ) = ( ( (float)uVar27 + fVar1 ) * ( (float)(int)( uVar4 - uVar14 ) / fVar49 ) + (float)uVar14 ) * fVar85 + fVar86;
 ...
 while ( lVar22 != lVar25 );
            ...
            if (uVar45 < local_3cc) {
               ...
               uVar20 = (int)( uint ) * (ushort*)( *(long*)( local_258 + 0x68 ) + ( ulong )(uVar14 >> 3) ) >> ( (byte)uVar14 & 7 ) & uVar20;
               ...
               *(float*)pVStack_358 = (float)uVar16 * *(float*)( local_258 + 0x30 ) + *(float*)( local_258 + 0x20 );
               *(float*)( pVStack_358 + 4 ) = ( ( (float)uVar20 + fVar1 ) * ( (float)(int)( uVar4 - uVar45 ) / fVar49 ) + (float)uVar45 ) * fVar58 + fVar56;
 ...
 while ( lVar22 != 0x40 );
         ...
         fVar1 = *(float*)( local_3c8 + 0x8c );
         auVar55._0_4_ = -(uint)(fStack_2d4 <= fStack_294 &&
                  fVar50 * fVar50 + fVar101 * fVar101 + fVar72 * fVar72 <= fVar1);
         auVar55._4_4_ = -(uint)(fVar89 <= fVar86 &&
                  fVar56 * fVar56 + fVar105 * fVar105 + fVar82 * fVar82 <= fVar1);
         auVar55._8_4_ = -(uint)(fStack_2b4 <= fStack_274 &&
                  fVar57 * fVar57 + fVar106 * fVar106 + fVar83 * fVar83 <= fVar1);
         auVar55._12_4_ = -(uint)(fVar91 <= fVar90 && fVar58 * fVar58 + fVar49 * fVar49 + fVar85 * fVar85 <= fVar1);
                           ...
                           if (*pcVar23 == '\0') {
                              ...
                              if (pcVar23[uVar39] == '\0') {
                                 ...
                                 while (true) {
                                    ...
                                    uStack_32c = uVar45 + ( iVar46 * (uint)lStack_350 + uVar14 ) * 2 << ( ( byte ) * (undefined4*)( pVVar43 + 0x9c ) & 0x1f ) | ~(iVar18 << ((byte)*(undefined4 *)(pVVar43 + 0x9c) & 0x1f)) & *(uint*)( pVVar43 + 0x98 );
                                    ...
                                    *(undefined8*)( puVar35 + lVar5 + -8 ) = 0x110d74;
                                    JPH::CollideSphereVsTriangles::Collide(uStack_388, uStack_390, lStack_368, uStack_398, uStack_370, uStack_3a0, pVStack_358, uVar13, &uStack_32c);
                                    ...
                                    uVar16 = uStack_374;
                                    if ((uint)uStack_360 == 1) break;
                                    LAB_00110db0:if (pcVar23[1] != '\0') break;
                                    uStack_388 = *(undefined8*)pfVar31;
...
/* JPH::HeightFieldShape::sCollideSphereVsHeightField(JPH::Shape const*, JPH::Shape const*,
   ...
   JPH::SubShapeIDCreator const&, JPH::CollideShapeSettings const&,
   JPH::CollisionCollector<JPH::CollideShapeResult, JPH::CollisionCollectorTraitsCollideShape>&,
   JPH::ShapeFilter const&) */void JPH::HeightFieldShape::sCollideSphereVsHeightField(undefined8 param_1, HeightFieldShape *param_2) {
   undefined8 *in_R9;
   long in_FS_OFFSET;
   ...
   long local_20;
   local_20 = *(long*)( in_FS_OFFSET + 0x28 );
   JPH::CollideSphereVsTriangles::CollideSphereVsTriangles((CollideSphereVsTriangles*)aVStack_c8, param_1);
   local_30 = *in_R9;
   local_38 = param_2;
   WalkHeightField<JPH::HeightFieldShape::sCollideSphereVsHeightField(JPH::Shape_const *, JPH::Shape_const *, JPH::Vec3, JPH::Vec3, JPH::Mat44_const &, JPH::Mat44_const &, JPH::SubShapeIDCreator_const &, JPH::SubShapeIDCreator_const &, JPH::CollideShapeSettings_const &, JPH::CollisionCollector<JPH::CollideShapeResult,JPH::CollisionCollectorTraitsCollideShape> &, JPH::ShapeFilter_const &)::Visitor>(param_2, aVStack_c8);
   if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
...
/* JPH::HeightFieldShape::GetTrianglesStart(JPH::Shape::GetTrianglesContext&, JPH::AABox const&,
   JPH::Vec3, JPH::Quat, JPH::Vec3) const */void JPH::HeightFieldShape::GetTrianglesStart(undefined8 param_1, HSGetTrianglesContext *param_2) {
   HSGetTrianglesContext::HSGetTrianglesContext(param_2, param_1);
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::HeightFieldShape::sRegister() */void JPH::HeightFieldShape::sRegister(void) {
   byte bVar1;
   long lVar2;
   byte *pbVar3;
   long lVar4;
   pbVar3 = &sConvexSubShapeTypes;
   _DAT_001181e8 = {lambda()
   #1_DAT_001181f0 = (undefined4)Color::sPurple;
   do {
      bVar1 = *pbVar3;
      pbVar3 = pbVar3 + 1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* void 
   ...
   .constprop.0] */void JPH::HeightFieldShape::WalkHeightField<JPH::HeightFieldShape::CollideSoftBodyVertices(JPH::Mat44_const&,JPH::Vec3,JPH::CollideSoftBodyVertexIterator_const&,unsigned_int,int)const::Visitor>(HeightFieldShape *this, Visitor *param_1) {
   Visitor *pVVar1;
   HeightFieldShape HVar2;
   HeightFieldShape HVar3;
   ushort uVar4;
...
;
      ...
      do {
         ...
         if (uVar37 < local_42c) {
            ...
            auVar83 = *(undefined1(*) [16])( ( ulong )(uVar20 * uVar22 + ( &sGridOffsets )[uVar37] + uVar49) * 0x10 + *(long*)( local_258 + 0x60 ) );
            iVar48 = uVar49 * 2;
            auVar9._10_2_ = 0;
            ...
            auVar98._8_4_ = (float)(int)( ( auVar70._8_8_ & 0xffffffff ) * (ulong)uVar20 ) * fStack_490 + fStack_460;
            auVar98._12_4_ = (float)(int)( ( auVar70._8_8_ >> 0x20 ) * (ulong)uVar20 ) * fStack_48c + fStack_45c;
            ...
            auVar71._0_4_ = (float)(int)( ~uVar49 & auVar101._0_4_ * uVar20 | local_458 & uVar49 ) * fStack_498 + fStack_468;
            auVar71._4_4_ = (float)(int)( ~uVar27 & auVar101._4_4_ * uVar20 | uStack_454 & uVar27 ) * fStack_494 + fStack_464;
            auVar71._8_4_ = (float)(int)( ~uVar43 & uVar95 | uStack_450 & uVar43 ) * fStack_490 + fStack_460;
            auVar71._12_4_ = (float)(int)( ~uVar25 & uVar38 | uStack_44c & uVar25 ) * fStack_48c + fStack_45c;
            ...
            auVar92._8_4_ = (float)(int)( ( auVar91._8_8_ & 0xffffffff ) * (ulong)uVar20 ) * fStack_4b0 + fStack_480;
            auVar92._12_4_ = (float)(int)( ( auVar91._8_8_ >> 0x20 ) * (ulong)uVar20 ) * fStack_4ac + fStack_47c;
            ...
            auVar93._0_4_ = (float)(int)( ~uVar49 & uVar26 | local_458 & uVar49 ) * fStack_4b8 + fStack_488;
            auVar93._4_4_ = (float)(int)( ~uVar27 & uVar22 | uStack_454 & uVar27 ) * fStack_4b4 + fStack_484;
            auVar93._8_4_ = (float)(int)( ~uVar38 & uVar25 | uStack_450 & uVar38 ) * fStack_4b0 + fStack_480;
            auVar93._12_4_ = (float)(int)( ~uVar43 & uVar47 | uStack_44c & uVar43 ) * fStack_4ac + fStack_47c;
            ...
            fVar63 = (float)( ( uint )(fVar63 * fVar63 + fVar73 * fVar73 + fVar80 * fVar80) & uVar20 | ~uVar20 & _LC13 );
            fVar64 = (float)( ( uint )(fVar64 * fVar64 + fVar74 * fVar74 + fVar86 * fVar86) & uVar49 | ~uVar49 & _UNK_00116654 );
            fVar65 = (float)( ( uint )(fVar65 * fVar65 + fVar75 * fVar75 + fVar87 * fVar87) & uVar22 | ~uVar22 & _UNK_00116658 );
            fVar88 = (float)( ( uint )(fVar54 * fVar54 + fVar88 * fVar88 + fVar55 * fVar55) & uVar27 | ~uVar27 & _UNK_0011665c );
            ...
            *(undefined8*)( (long)auStack_244 + lVar51 ) = uVar81;
            ...
            uVar4 = *(ushort*)( pcStack_3a0 + ( ulong )(uStack_3bc | uStack_3c0) * 2 + ( ulong )(uVar43 + iVar48) * 0x10 );
            uVar5 = *(ushort*)( pcStack_3a0 + ( ulong )(uStack_3bc | uStack_3c0) * 2 + ( ulong )(uVar43 + iVar48) * 0x10 + 8 );
            ...
            if (uStack_418 < uVar38) {
               ...
               do {
                  ...
                  if (uVar47 < uVar37) {
                     ...
                     do {
                        iVar50 = (int)uVar28;
                        uVar25 = (int)( uint ) * (ushort*)( lVar51 + ( ulong )(uVar49 >> 3) ) >> ( (byte)uVar49 & 7 ) & uVar27;
                        *(bool*)uVar28 = HVar2 == SUB41(uVar25, 0);
                        uVar28 = uVar28 + 1;
                        uVar49 = uVar49 + (byte)HVar3;
                        auVar66._0_4_ = (float)( ( uVar47 - iVar52 ) + iVar50 ) * auVar83._0_4_ + fVar55;
                        auVar66._4_4_ = ( ( (float)uVar25 + fVar88 ) * ( (float)(int)( (uint)uVar5 - (uint)uVar4 ) / fVar54 ) + (float)uVar4 ) * auVar83._4_4_ + fVar63;
 ...
 while ( uVar38 != uVar20 );
            ...
            if (uVar49 < local_430) {
               ...
               if (uStack_418 < uVar38) {
                  ...
                  do {
                     uVar24 = (ulong)uVar20;
                     uVar26 = (int)( uint ) * (ushort*)( uStack_3b0 + ( uVar25 >> 3 ) ) >> ( (byte)uVar25 & 7 ) & uVar27;
                     *(bool*)lVar51 = HVar2 == SUB41(uVar26, 0);
                     uVar20 = uVar20 + 1;
                     uVar25 = uVar25 + iVar48 * (uint)(byte)HVar3;
                     *(float*)*pauVar44 = (float)uVar37 * fVar55 + fVar73;
                     *(float*)( *pauVar44 + 4 ) = ( ( (float)uVar26 + fVar88 ) * ( (float)(int)( (uint)uVar5 - (uint)uVar4 ) / fVar54 ) + (float)uVar4 ) * fVar63 + fVar74;
 ...
 while ( uVar38 != uVar20 );
            ...
            if (uVar22 < local_430) {
               ...
               uVar5 = *(ushort*)( pcStack_3a0 + (ulong)uVar20 * 2 + ( ulong )(uVar43 + uStack_3c0) * 0x10 + 8 );
               if (uVar47 < uVar37) {
                  ...
                  do {
                     iVar52 = (int)lVar51;
                     uVar43 = (int)( uint ) * (ushort*)( lVar6 + ( ulong )(uVar22 >> 3) ) >> ( (byte)uVar22 & 7 ) & uVar27;
                     *(bool*)lVar51 = HVar2 == SUB41(uVar43, 0);
                     lVar51 = lVar51 + 1;
                     uVar22 = uVar22 + uVar20;
                     *(float*)*pauVar23 = (float)( ( uVar47 - iVar48 ) + iVar52 ) * fVar55 + fVar73;
                     *(float*)( *pauVar23 + 4 ) = ( ( (float)uVar43 + fVar88 ) * ( (float)(int)( (uint)uVar5 - (uint)uVar4 ) / fVar54 ) + (float)uVar4 ) * fVar63 + fVar74;
 ...
 while ( lVar51 != lVar29 );
               ...
               if (uVar49 < local_430) {
                  ...
                  uVar27 = (int)( uint ) * (ushort*)( *(long*)( local_258 + 0x68 ) + ( ulong )(uVar20 >> 3) ) >> ( (byte)uVar20 & 7 ) & uVar27;
                  ...
                  *(float*)*pauVar44 = (float)uVar37 * *(float*)( local_258 + 0x30 ) + *(float*)( local_258 + 0x20 );
                  *(float*)( *pauVar44 + 4 ) = ( ( (float)uVar27 + fVar88 ) * ( (float)(int)( (uint)uVar4 - (uint)uVar5 ) / fVar54 ) + (float)uVar5 ) * fVar55 + fVar65;
...
;
 ...
 while ( lVar51 != 0x40 );
            ...
            fVar55 = (float)( ( uint )(fVar55 * fVar55 + fVar80 * fVar80 + fVar65 * fVar65) & uVar20 | ~uVar20 & _LC13 );
            fVar63 = (float)( ( uint )(fVar63 * fVar63 + fVar86 * fVar86 + fVar73 * fVar73) & uVar49 | ~uVar49 & _UNK_00116654 );
            fVar64 = (float)( ( uint )(fVar64 * fVar64 + fVar87 * fVar87 + fVar74 * fVar74) & uVar22 | ~uVar22 & _UNK_00116658 );
            fVar88 = (float)( ( uint )(fVar54 * fVar54 + fVar88 * fVar88 + fVar75 * fVar75) & uVar37 | ~uVar37 & _UNK_0011665c );
                        ...
                        if (uVar37 < uStack_404) {
                           ...
                           do {
                              while (true) {
                                 ...
                                 while (true) {
                                    auStack_378._0_8_ = CONCAT44(auStack_3e8._4_4_ - fVar88, auStack_3e8._0_4_ - fVar56);
                                    ...
                                    *(undefined8*)( puVar35 + lVar7 + -8 ) = 0x112272;
                                    ...
                                    fStack_390 = fVar54;
                                    fStack_38c = fVar55;
                                    auVar83 = ClosestPoint::GetClosestPointOnTriangle<false>(uStack_388, CONCAT44(fStack_37c, fStack_380), auStack_378._0_8_, auStack_378._8_8_, auStack_368, uStack_360, &uStack_34c);
                                    uVar24 = (ulong)uStack_3bc;
                                    fVar56 = auVar83._8_4_ * auVar83._8_4_ + auVar83._4_4_ * auVar83._4_4_ + auVar83._0_4_ * auVar83._0_4_ + 0.0;
                                    ...
                                    LAB_0011233e:if (pcVar21[1] != '\0') break;
                                    auStack_3d8 = *pauVar44;
...
;
 ...
 while ( uStack_408 != uVar22 );
                  ...
                  while (true) {
                     ...
                     if (*(float*)( (undefined8)param_1 + lVar51 * 4 + ( (long)iVar50 - (long)(int)uVar49 ) * 4 + 0xe0 ) <= *(float*)( (undefined8)param_1 + 0xd4 ) && *(float*)( (undefined8)param_1 + 0xd4 ) != *(float*)( (undefined8)param_1 + lVar51 * 4 + ( (long)iVar50 - (long)(int)uVar49 ) * 4 + 0xe0 )) break;
                     iVar52 = (int)( lVar51 + -1 );
                     lVar51 = lVar51 + -1;
                  }
;
 ...
 while ( true );
         ...
         LAB_001123de:lVar51 = (long)( iVar31 + -1 );
         do {
            iVar31 = (int)lVar51;
 ...
 while ( fVar56 < *(float*)( param_1 + lVar29 + 0xdc ) || fVar56 == *(float*)( param_1 + lVar29 + 0xdc ) );
 ...
 while ( true );
   ...
   LAB_00111770:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::HeightFieldShape::CollideSoftBodyVertices(JPH::Mat44 const&, JPH::Vec3,
   JPH::CollideSoftBodyVertexIterator const&, unsigned int, int) const */void JPH::HeightFieldShape::CollideSoftBodyVertices(HeightFieldShape *param_1, undefined8 param_2, undefined8 *param_3, int param_4, undefined4 param_5) {
   int iVar1;
   int iVar2;
   int iVar3;
   int iVar4;
   ...
   if (pauVar8 != (undefined1(*) [16])( puVar6 + param_4 * iVar1 )) {
      do {
         if (0.0 < *pfVar9) {
            ...
            WalkHeightField<JPH::HeightFieldShape::CollideSoftBodyVertices(JPH::Mat44_const &, JPH::Vec3, JPH::CollideSoftBodyVertexIterator_const &, unsigned_int, int)const::Visitor > ( param_1,(Visitor*)&local_328 );
            uVar13 = _LC45;
            if (local_254 < _LC13) {
               fVar21 = local_298 * local_328 + fStack_294 * local_318 + fStack_290 * local_308 + local_2f8;
               fVar24 = local_298 * fStack_324 + fStack_294 * fStack_314 + fStack_290 * fStack_304 + fStack_2f4;
               fVar25 = local_298 * fStack_320 + fStack_294 * fStack_310 + fStack_290 * fStack_300 + fStack_2f0;
               fVar12 = ( local_288 * local_328 + fStack_284 * local_318 + fStack_280 * local_308 + local_2f8 ) - fVar21;
               fVar14 = ( local_288 * fStack_324 + fStack_284 * fStack_314 + fStack_280 * fStack_304 + fStack_2f4 ) - fVar24;
               fVar15 = ( local_288 * fStack_320 + fStack_284 * fStack_310 + fStack_280 * fStack_300 + fStack_2f0 ) - fVar25;
               fVar26 = ( local_278 * local_328 + fStack_274 * local_318 + fStack_270 * local_308 + local_2f8 ) - fVar21;
               fVar29 = ( local_278 * fStack_324 + fStack_274 * fStack_314 + fStack_270 * fStack_304 + fStack_2f4 ) - fVar24;
               fVar30 = ( local_278 * fStack_320 + fStack_274 * fStack_310 + fStack_270 * fStack_300 + fStack_2f0 ) - fVar25;
               ...
               if (local_250 == 7) {
                  fVar16 = ( fVar25 - fVar20 ) * fVar12 + ( fVar24 - fVar19 ) * fVar15 + ( fVar21 - fVar16 ) * fVar14 + 0.0;
                  if (_LC58 < fVar16) {
                     fVar16 = _LC58;
                     if (*pfVar10 < _LC58) goto LAB_0011313d;
                  }
 else if (*pfVar10 < fVar16) {
                     LAB_0011313d:*pfVar10 = fVar16;
                  ...
                  auVar17._12_4_ = fStack_34c - ( fVar26 * fStack_31c + fVar29 * fStack_30c + fVar30 * fStack_2fc + fStack_2ec );
                  if (0.0 < fVar12 * auVar17._8_4_ + fVar15 * auVar17._4_4_ + fVar14 * auVar17._0_4_ + 0.0) {
                     auVar22._0_4_ = SQRT(auVar17._8_4_ * auVar17._8_4_ + auVar17._4_4_ * auVar17._4_4_ + auVar17._0_4_ * auVar17._0_4_ + 0.0);
                     if (*pfVar10 < (float)( (uint)auVar22._0_4_ ^ _LC45 )) {
                        *pfVar10 = (float)( (uint)auVar22._0_4_ ^ _LC45 );
                        ...
                        auVar23._12_4_ = ( uint )(fVar25 * fVar12 + fVar24 * (float)( (ulong)local_388 >> 0x20 ) + fVar21 * (float)local_388 + 0.0) ^ uVar13;
...
/* JPH::HeightFieldShape::HeightFieldShape(JPH::HeightFieldShapeSettings const&,
   JPH::Result<JPH::Ref<JPH::Shape> >&) */void JPH::HeightFieldShape::HeightFieldShape(HeightFieldShape *this, HeightFieldShapeSettings *param_1, Result *param_2) {
   long *plVar1;
   ...
   *(undefined1(*) [16])( this + 0xb0 ) = (undefined1[16])0x0;
   if (uVar35 == 0) {
      if ((HeightFieldShapeSettings*)( this + 0x78 ) != param_1 + 0xa8) {
         ...
         LAB_00113996:*(undefined8*)( this + 0x78 ) = 0;
 ...
 while ( plVar25 <= plVar30 );
      ...
      *(ulong*)( this + 0x80 ) = uVar49;
      if ((HeightFieldShapeSettings*)( this + 0x78 ) != param_1 + 0xa8) {
         ...
         lVar22 = *(long*)( param_1 + 0xa8 ) * 8;
         plVar37 = plVar29 + *(long*)( param_1 + 0xa8 );
         if (( *(long*)( this + 0x78 ) != 0 ) && ( plVar30 = plVar25 < plVar30 )) {
            LAB_00113af7:do {
 ...
 while ( plVar25 < plVar30 );
      ...
      LAB_001139e0:uVar20 = *(uint*)( this + 0x44 );
   }

   if (6 < uVar20 - 2) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         pcVar50 = "HeightFieldShape: Block size must be in the range [2, 8]!";
         LAB_00113a0e:Result<JPH::Ref<JPH::Shape>>::SetError((Result<JPH::Ref<JPH::Shape>>*)param_2, pcVar50);
         return;
      }
   ...
   if (uVar49 == 0) {
      ...
      if (pbVar42 != pbVar38) {
         LAB_00113b7d:if (*pbVar42 < uVar49) goto LAB_00113b70;
         JPH::StringFormat_abi_cxx11_((char*)&pRStack_68, "Material %u is beyond material list (size: %u)", ( ulong ) * pbVar42, uVar49 & 0xffffffff);
            ...
            if (uVar35 < 8) {
               if (( uVar49 & 4 ) == 0) {
                  if (( uVar35 != 0 ) && ( param_2[0x10] = *pRStack_68(uVar49 & 2) != 0 )) {
                     *(undefined2*)( param_2 + ( uVar49 & 0xffffffff ) + 0xe ) = *(undefined2*)( pRStack_68 + ( ( uVar49 & 0xffffffff ) - 2 ) );
                  }

               }
 else {
                  *(undefined4*)( param_2 + 0x10 ) = *(undefined4*)pRStack_68;
                  *(undefined4*)( param_2 + ( uVar49 & 0xffffffff ) + 0xc ) = *(undefined4*)( pRStack_68 + ( ( uVar49 & 0xffffffff ) - 4 ) );
               }

            }
 else {
               *(undefined8*)( param_2 + 0x10 ) = *(undefined8*)pRStack_68;
               *(undefined8*)( param_2 + ( uVar49 & 0xffffffff ) + 8 ) = *(undefined8*)( pRStack_68 + ( ( uVar49 & 0xffffffff ) - 8 ) );
               ...
               if (7 < uVar35) {
                  ...
                  do {
                     uVar49 = (ulong)uVar20;
                     uVar20 = uVar20 + 8;
                     *(undefined8*)( ( ( ulong )(param_2 + 0x18) & 0xfffffffffffffff8 ) + uVar49 ) = *(undefined8*)( pRStack_68 + ( uVar49 - lVar22 ) );
                  }
 while ( uVar20 < uVar35 );
               }
...
;
            ...
            if ((float)( _LC44 & (uint)fVar63 ) < _LC42) {
               fVar63 = (float)( ( uint )((float)(int)fVar63 - (float)( -(uint)(fVar63 < (float)(int)fVar63) & _LC4 )) | ~_LC44 & (uint)fVar63 );
            }
 ...
 while ( uVar35 < uVar52 );
   ...
   *(float*)( this + 0x34 ) = *(float*)( this + 0x34 ) / fStack_6c;
   ...
   for (pauVar24 = pauVar23; pauVar24 < (undefined1(*) [16])( (long)pauVar23 + lVar61 ); pauVar24 = (undefined1(*) [16])( pauVar24[1] + 8 )) {
               ...
               do {
                  ...
                  do {
                     while (true) {
                        ...
                        if (( uVar40 <= uVar46 ) || ( uVar19 = uVar19 == 0xffff )) break;
                        uVar45 = *puVar54;
                        if (uVar19 < *puVar54) {
                           uVar45 = uVar19;
                        }
...
;
   ...
   do {
      ...
      do {
         ...
         do {
            ...
            *puVar31 = CONCAT44(CONCAT22(*(undefined2*)( lVar12 + uVar28 * 4 ), *puVar4), CONCAT22(*(undefined2*)( lVar12 + uVar51 * 4 ), *puVar3));
   ...
   if (*(int*)( this + 0x40 ) != 0) {
      ...
      do {
         ...
         do {
            ...
            if (( uVar36 < *(uint*)( param_1 + 0x60 ) ) && ( fVar63 = *(float*)( *(long*)( param_1 + 0x88 ) + ( ulong )(*(uint*)( param_1 + 0x60 ) * uVar57 + uVar52) * 4 ) ),fVar63 != _LC13) {
               puVar33 = (ushort*)( *(long*)( (long)pauVar23 + lVar61 + -8 ) + ( ulong )(( uVar57 / *(uint*)( this + 0x44 ) << ( bVar34 & 0x1f ) ) + uVar52 / *(uint*)( this + 0x44 )) * 4 );
               uVar36 = ( uint ) * puVar33;
               fVar63 = ( ( fVar63 - ( (float)uVar36 / fStack_6c + fStack_74 ) ) * (float)(byte)HVar7 ) / ( (float)(int)( puVar33[1] - uVar36 ) / fStack_6c );
               if ((float)( (uint)fVar63 & uVar20 ) < fVar18) {
                  fVar63 = (float)( ( uint )((float)(int)fVar63 - (float)( -(uint)(fVar63 < (float)(int)fVar63) & uVar35 )) | ~uVar20 & (uint)fVar63 );
               }
 ...
 while ( uVar57 < *(uint*)( this + 0x40 ) );
   ...
   *(HeightFieldShape**)param_2 = this;
   ...
   pcVar17 = Free;
   for (pauVar27 = pauVar23; Free = pcVar17,pauVar27 < pauVar24; pauVar27 = (undefined1(*) [16])( pauVar27[1] + 8 )) {
   ...
   goto LAB_00113c09;
   LAB_00113b70:pbVar42 = pbVar42 + 1;
   if (pbVar38 == pbVar42) goto LAB_00114287;
   goto LAB_00113b7d;
   LAB_00114287:HeightFieldShapeSettings::DetermineMinAndMaxSample(param_1, &fStack_74, &fStack_70, &fStack_6c);
   local_e8 = fStack_70;
   if (fStack_74 <= fStack_70) goto LAB_001133d4;
   LAB_001142cd:plVar25 = *(long**)( this + 0x88 );
   ...
   LAB_00114249:*(undefined8*)( this + 0x78 ) = 0;
   LOCK();
   *(int*)( this + 8 ) = *(int*)( this + 8 ) + 1;
   UNLOCK();
   if (param_2[0x20] == (Result)0x1) {
   ...
   *(HeightFieldShape**)param_2 = this;
   param_2[0x20] = (Result)0x1;
   LAB_00113c09:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

   LAB_0011445c:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* WARNING: Control flow encountered bad instruction data *//* JPH::HeightFieldShapeSettings::Create() const */void JPH::HeightFieldShapeSettings::Create(void) {
   ...
   LAB_00114649:*(HeightFieldShapeSettings*)( in_RDI + 4 ) = HVar3;
...
/* JPH::HeightFieldShape::MustBeStatic() const */undefined8 JPH::HeightFieldShape::MustBeStatic(void) {
   return 1;
}
/* JPH::HeightFieldShape::GetInnerRadius() const */undefined8 JPH::HeightFieldShape::GetInnerRadius(void) {
   return 0;
}
/* JPH::HeightFieldShape::GetSubmergedVolume(JPH::Mat44 const&, JPH::Vec3, JPH::Plane const&,
   float&, float&, JPH::Vec3&, JPH::Vec3) const */void JPH::HeightFieldShape::GetSubmergedVolume(void) {
   return;
}
/* JPH::HeightFieldShape::GetVolume() const */undefined8 JPH::HeightFieldShape::GetVolume(void) {
   return 0;
}
/* JPH::TempAllocatorMalloc::Allocate(unsigned int) */undefined8 JPH::TempAllocatorMalloc::Allocate(TempAllocatorMalloc *this, uint param_1) {
   undefined8 uVar1;
   if (param_1 != 0) {
...
/* JPH::TempAllocatorMalloc::Free(void*, unsigned int) */void JPH::TempAllocatorMalloc::Free(void *param_1, uint param_2) {
...
/* JPH::TempAllocatorMalloc::~TempAllocatorMalloc() */void JPH::TempAllocatorMalloc::~TempAllocatorMalloc(TempAllocatorMalloc *this) {
   return;
}
/* JPH::TempAllocatorMalloc::~TempAllocatorMalloc() */void JPH::TempAllocatorMalloc::~TempAllocatorMalloc(TempAllocatorMalloc *this) {
...
/* JPH::RTTI::~RTTI() */void JPH::RTTI::~RTTI(RTTI *this) {
   return;
}
...
/* JPH::HeightFieldShape::GetSubShapeIDBitsRecursive() const */int JPH::HeightFieldShape::GetSubShapeIDBitsRecursive(HeightFieldShape *this) {
   uint uVar1;
   int iVar2;
   iVar2 = 1;
   uVar1 = *(int*)( this + 0x40 ) - 1;
...
/* JPH::HeightFieldShapeSettings::~HeightFieldShapeSettings() */void JPH::HeightFieldShapeSettings::~HeightFieldShapeSettings(HeightFieldShapeSettings *this) {
   long *plVar1;
   HeightFieldShape *pHVar2;
   long *plVar3;
   long *plVar4;
   ...
   *(undefined***)this = &PTR_GetRTTI_00116408;
   if (plVar5 != (long*)0x0) {
      if (( *(long*)( this + 0xa8 ) != 0 ) && ( plVar3 = plVar5 < plVar3 )) {
         do {
            while (plVar4 = (long*)*plVar5,plVar4 == (long*)0x0) {
               LAB_00114b30:plVar5 = plVar5 + 1;
...
;
 ...
 while ( plVar5 < plVar3 );
         LAB_00114b68:plVar5 = *(long**)( this + 0xb8 );
      }
 ...
 else if (( this[0x38] == (HeightFieldShapeSettings)0x2 ) && ( this_00 = *(HeightFieldShape**)( this + 0x18 ) ),this_00 != (HeightFieldShape*)( this + 0x28 )) {
      LAB_00114ae5:/* WARNING: Could not recover jumptable at 0x00114aef. Too many branches *//* WARNING: Treating indirect jump as call */( *Free )(this_00);
      return;
   }
...
;
 ...
 while ( plVar5 < plVar3 );
         LAB_00114ce8:plVar5 = *(long**)( this + 0xb8 );
      }
 ...
 else if (( this[0x38] == (HeightFieldShapeSettings)0x2 ) && ( *(HeightFieldShapeSettings**)( this + 0x18 ) != this + 0x28 )) {
      ( *Free )();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::CollideSoftBodyVerticesVsTriangles::CollideSoftBodyVerticesVsTriangles(JPH::Mat44 const&,
   JPH::Vec3) */void JPH::CollideSoftBodyVerticesVsTriangles::CollideSoftBodyVerticesVsTriangles(undefined8 param_1_00, undefined8 param_2, CollideSoftBodyVerticesVsTriangles *this, float *param_1) {
 ...
 while ( lVar16 != 0x40 );
   ...
   fVar24 = ( ( ( ( fVar29 * fVar13 - fVar25 * fVar13 ) + fVar36 * fVar9 ) - fVar40 * fVar9 ) + fVar18 * fVar8 ) - fVar8 * fVar22;
   fVar26 = ( ( ( ( fVar27 * fVar32 - fVar23 * fVar32 ) + fVar34 * fVar2 ) - fVar38 * fVar2 ) + fVar17 * fVar4 ) - fVar4 * fVar20;
   fVar28 = ( ( ( ( fVar25 * fVar11 - fVar29 * fVar11 ) + fVar40 * fVar7 ) - fVar36 * fVar7 ) + fVar22 * fVar6 ) - fVar6 * fVar18;
   fVar30 = ( ( ( ( fVar23 * fVar21 - fVar27 * fVar21 ) + fVar38 * fVar15 ) - fVar34 * fVar15 ) + fVar20 * fVar3 ) - fVar3 * fVar17;
   fVar35 = fVar10 * fVar8;
   fVar37 = fVar19 * fVar4;
   fVar39 = fVar12 * fVar6;
   fVar41 = fVar31 * fVar3;
   ...
   *(float*)( this + 0x50 ) = ( ( ( ( fVar12 * fVar25 - fVar12 * fVar29 ) - fVar8 * fVar47 ) + fVar8 * fVar49 + fVar9 * fVar37 ) - fVar9 * fVar41 ) * fVar33;
   *(float*)( this + 0x54 ) = ( ( ( ( fVar31 * fVar23 - fVar31 * fVar27 ) - fVar4 * fVar46 ) + fVar4 * fVar48 + fVar2 * fVar35 ) - fVar2 * fVar39 ) * fVar33;
   *(float*)( this + 0x58 ) = ( ( ( ( fVar10 * fVar29 - fVar10 * fVar25 ) - fVar6 * fVar49 ) + fVar6 * fVar47 + fVar7 * fVar41 ) - fVar7 * fVar37 ) * fVar33;
   *(float*)( this + 0x5c ) = ( ( ( ( fVar19 * fVar27 - fVar19 * fVar23 ) - fVar3 * fVar48 ) + fVar3 * fVar46 + fVar15 * fVar39 ) - fVar15 * fVar35 ) * fVar33;
   *(float*)( this + 0x60 ) = ( ( fVar47 * fVar13 + ( fVar9 * fVar45 - ( ( fVar18 * fVar12 - fVar22 * fVar12 ) + fVar9 * fVar43 ) ) ) - fVar49 * fVar13 ) * fVar33;
   *(float*)( this + 100 ) = ( ( fVar46 * fVar32 + ( fVar2 * fVar44 - ( ( fVar17 * fVar31 - fVar20 * fVar31 ) + fVar2 * fVar42 ) ) ) - fVar48 * fVar32 ) * fVar33;
   *(float*)( this + 0x68 ) = ( ( fVar49 * fVar11 + ( fVar7 * fVar43 - ( ( fVar22 * fVar10 - fVar18 * fVar10 ) + fVar7 * fVar45 ) ) ) - fVar47 * fVar11 ) * fVar33;
   *(float*)( this + 0x6c ) = ( ( fVar48 * fVar21 + ( fVar15 * fVar42 - ( ( fVar20 * fVar19 - fVar17 * fVar19 ) + fVar15 * fVar44 ) ) ) - fVar46 * fVar21 ) * fVar33;
   *(float*)( this + 0x70 ) = ( ( ( ( fVar43 * fVar8 - ( fVar12 * fVar36 - fVar12 * fVar40 ) ) - fVar8 * fVar45 ) - fVar37 * fVar13 ) + fVar13 * fVar41 ) * fVar33;
   *(float*)( this + 0x74 ) = ( ( ( ( fVar42 * fVar4 - ( fVar31 * fVar34 - fVar31 * fVar38 ) ) - fVar4 * fVar44 ) - fVar35 * fVar32 ) + fVar32 * fVar39 ) * fVar33;
   *(float*)( this + 0x78 ) = ( ( ( ( fVar45 * fVar6 - ( fVar10 * fVar40 - fVar10 * fVar36 ) ) - fVar6 * fVar43 ) - fVar41 * fVar11 ) + fVar11 * fVar37 ) * fVar33;
   *(float*)( this + 0x7c ) = ( ( ( ( fVar44 * fVar3 - ( fVar19 * fVar38 - fVar19 * fVar34 ) ) - fVar3 * fVar42 ) - fVar39 * fVar21 ) + fVar21 * fVar35 ) * fVar33;
...
/* JPH::HeightFieldShape::GetEdgeFlags(unsigned int, unsigned int, unsigned int) const */uint JPH::HeightFieldShape::GetEdgeFlags(HeightFieldShape *this, uint param_1, uint param_2, uint param_3) {
   int iVar1;
   long lVar2;
   uint uVar3;
   uint uVar4;
   ...
   if (param_2 != 0) {
      ...
      return uVar4 | uVar6 | ( (int)( uint ) * (ushort*)( lVar2 + ( ulong )(uVar3 >> 3) ) >> ( (byte)uVar3 & 7 ) ) * 2 & 4U;
   }

   return uVar4 | uVar6 | 4;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::HeightFieldShape::HSGetTrianglesContext::HSGetTrianglesContext(JPH::HeightFieldShape const*,
   JPH::AABox const&, JPH::Vec3, JPH::Quat, JPH::Vec3) */void JPH::HeightFieldShape::HSGetTrianglesContext::HSGetTrianglesContext(undefined8 param_1_00, float param_2_00, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, HSGetTrianglesContext *this, undefined8 param_1, float *param_2) {
   ...
   *(ulong*)( this + 0x250 ) = CONCAT44(fVar17 * fVar12 + fVar18 * fVar25 + fVar19 * fVar33 + ( 0.0 - ( local_98 * fVar12 + fStack_94 * fVar25 + param_2_00 * fVar33 ) ), fVar17 * fVar32 + fVar18 * fVar34 + fVar19 * fVar27 + ( 0.0 - ( local_98 * fVar32 + fStack_94 * fVar34 + param_2_00 * fVar27 ) ));
   *(float*)( this + 600 ) = fVar17 * fVar29 + fVar18 * fVar16 + fVar19 * fVar24 + ( 0.0 - ( local_98 * fVar29 + fStack_94 * fVar16 + param_2_00 * fVar24 ) );
   ...
   *(float*)( this + 0x25c ) = fVar8;
   ...
   do {
      ...
      *(float*)pHVar1 = fVar6 * local_98 + fVar23 * ( ( fVar8 - fVar21 * fVar14 ) - fVar15 ) + fVar30 * ( fVar21 * fVar13 - fVar11 ) + fVar5 * ( fVar22 * fVar13 + fVar14 * fVar26 );
      *(float*)( pHVar1 + 4 ) = fVar6 * fStack_94 + fVar23 * ( fVar21 * fVar13 + fVar11 ) + fVar30 * ( ( fVar8 - fVar15 ) - fVar20 * fVar13 ) + fVar5 * ( fVar22 * fVar14 - fVar13 * fVar26 );
      *(float*)( pHVar1 + 8 ) = fVar6 * param_2_00 + fVar23 * ( fVar22 * fVar13 - fVar14 * fVar26 ) + fVar30 * ( fVar13 * fVar26 + fVar22 * fVar14 ) + fVar5 * ( ( fVar8 - fVar20 * fVar13 ) - fVar21 * fVar14 );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::Vec3 JPH::ClosestPoint::GetClosestPointOnTriangle<false>(JPH::Vec3, JPH::Vec3, JPH::Vec3,
   ...
   if (fVar34 < _LC54) {
      ...
      if (__LC55 < fVar22) {
         fVar22 = (float)( ( uint )(fVar33 * fVar26 + fVar32 * fVar24 + fVar20 * fVar2 + 0.0) ^ _LC45 ) / fVar22;
         if (fVar22 < 0.0) {
            fVar10 = 0.0;
         }
 else {
      ...
      if (__LC55 < fVar18) {
         fVar18 = (float)( ( uint )(fVar17 * fVar11 + fVar16 * fStack_74 + fVar14 * local_78 + 0.0) ^ _LC45 ) / fVar18;
         if (fVar18 < 0.0) {
            fVar2 = 0.0;
         }
 else {
      ...
      if (__LC55 < fVar2) {
         fVar2 = (float)( ( uint )(fVar11 * fVar4 + fStack_74 * fStack_84 + local_78 * local_88 + 0.0) ^ _LC45 ) / fVar2;
         if (fVar2 < 0.0) {
            fVar18 = 0.0;
         }
 else {
   ...
   if (fVar14 < 0.0) {
      ...
      if (( ( fVar4 * fVar6 <= fVar18 * fVar14 ) && ( 0.0 <= fVar4 ) ) && ( fVar14 == 0.0 )) {
         LAB_00115d4c:*param_7 = ( -(uint)(iVar1 == 0) & 0xfffffffd ) + 6;
...
/* WARNING: Control flow encountered bad instruction data *//* JPH::Result<JPH::Ref<JPH::Shape> >::SetError(char const*) */void JPH::Result<JPH::Ref<JPH::Shape>>::SetError(Result<JPH::Ref<JPH::Shape>> *this, char *param_1) {
   HeightFieldShape *pHVar1;
   HeightFieldShape *this_00;
   size_t __n;
 ...
 else if (( this[0x20] == (Result<JPH::Ref<JPH::Shape>>)0x2 ) && ( *(Result<JPH::Ref<JPH::Shape>>**)this != this + 0x10 )) {
      ( *Free )();
   }
   ...
   *(Result<JPH::Ref<JPH::Shape>>**)this = __dest;
   ...
   LAB_00115fc8:*(size_t*)( this + 8 ) = __n;
...
/* JPH::HeightFieldShape::sDrawTriangleOutlines */void JPH::HeightFieldShape::_GLOBAL__sub_I_sDrawTriangleOutlines(void) {
   if (DVec3::cTrue == '\0') {
      DVec3::cTrue = '\x01';
      DVec3::cTrue = _LC70;
   }
...
/* WARNING: Control flow encountered bad instruction data *//* JPH::HeightFieldShape::HSGetTrianglesContext::HSGetTrianglesContext(JPH::HeightFieldShape const*,
   JPH::AABox const&, JPH::Vec3, JPH::Quat, JPH::Vec3) */void JPH::HeightFieldShape::HSGetTrianglesContext::HSGetTrianglesContext(void) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* JPH::CollideSoftBodyVerticesVsTriangles::CollideSoftBodyVerticesVsTriangles(JPH::Mat44 const&,
   JPH::Vec3) */void JPH::CollideSoftBodyVerticesVsTriangles::CollideSoftBodyVerticesVsTriangles(void) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* JPH::HeightFieldShapeSettings::~HeightFieldShapeSettings() */void JPH::HeightFieldShapeSettings::~HeightFieldShapeSettings(HeightFieldShapeSettings *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* JPH::RTTI::~RTTI() */void JPH::RTTI::~RTTI(RTTI *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* JPH::TempAllocatorMalloc::~TempAllocatorMalloc() */void JPH::TempAllocatorMalloc::~TempAllocatorMalloc(TempAllocatorMalloc *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

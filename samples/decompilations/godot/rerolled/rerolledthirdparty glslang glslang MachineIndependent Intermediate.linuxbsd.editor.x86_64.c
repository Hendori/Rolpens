/* glslang::canSignedIntTypeRepresentAllUnsignedValues(glslang::TBasicType, glslang::TBasicType) */bool glslang::canSignedIntTypeRepresentAllUnsignedValues(int param_1, ulong param_2) {
   uint uVar1;
   bool bVar2;
   uVar1 = (uint)param_2;
   if (param_1 == 8) {
...
/* WARNING: Type propagation algorithm not settling *//* glslang::TIntermediate::mapTypeToConstructorOp(glslang::TType const&) const [clone .part.0] */int glslang::TIntermediate::mapTypeToConstructorOp(TType *param_1) {
   byte bVar1;
   char cVar2;
   uint uVar3;
   int iVar4;
...
/* glslang::TIntermTyped::propagatePrecision(glslang::TPrecisionQualifier) */void glslang::TIntermTyped::propagatePrecision(TIntermTyped *this, undefined4 param_2) {
   int iVar1;
   uint uVar2;
   long *plVar3;
   ulong uVar4;
   ...
   if (*(code**)( lVar10 + 0x100 ) == getBasicType) {
      ...
      if (TVar11 != (TIntermTyped)0x8) {
         LAB_00100c56:if (TVar11 != (TIntermTyped)0x9) {
            LAB_00100c60:uVar2 = (uint)(byte)TVar11;
            if (TVar11 != (TIntermTyped)0x1) {
               LAB_00100c6a:if (uVar2 != 3) {
                  return;
               }
 ...
 while ( uVar4 < ( ulong )(lVar10 >> 3) );
   ...
   LAB_00100cff:/* WARNING: Could not recover jumptable at 0x00100d15. Too many branches *//* WARNING: Treating indirect jump as call */( **(code**)( *plVar3 + 0x128 ) )(plVar3, param_2);
   return;
}
/* glslang::TIntermAggregate::updatePrecision() */void glslang::TIntermAggregate::updatePrecision(TIntermAggregate *this) {
   byte bVar1;
   int iVar2;
   uint uVar3;
   ulong uVar4;
   ...
   if (*(code**)( lVar10 + 0x100 ) == TIntermTyped::getBasicType) {
      ...
      if (TVar9 != (TIntermAggregate)0x8) {
         LAB_00101000:uVar3 = (uint)(byte)TVar9;
         if (TVar9 != (TIntermAggregate)0x9) {
            LAB_00101008:if (uVar3 != 1) {
               return;
            }
 ...
 while ( uVar7 < uVar4 );
   ...
   LAB_00101137:if (*(code**)( *(long*)this + 0x108 ) == TIntermTyped::getQualifier) {
      pTVar13 = this + 0x30;
   }
 else {
...
/* std::_Rb_tree<std::__cxx11::basic_string<char, std::char_traits<char>,
   ...
   glslang::std::allocator<char> > const, std::__cxx11::basic_string<char, std::char_traits<char>,
   glslang::std::allocator<char> > > >*) [clone .isra.0] */void std::_Rb_tree<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::_Select1st<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>>,std::less<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>>>::_M_erase(_Rb_tree_node *param_1) {
   long lVar1;
   long lVar2;
   long lVar3;
   long lVar4;
...
std::vector<TIntermNode*,glslang::pool_allocator<TIntermNode*>>::emplace_back<TIntermNode*>
   ...
   if (puVar1 == puVar3) {
      ...
      lVar10 = uVar9 * 8;
      LAB_00101457:ppTVar6 = (TIntermNode**)glslang::TPoolAllocator::allocate(*(ulong*)this);
      ...
      *(TIntermNode**)( (long)ppTVar6 + (long)puVar11 ) = *param_1;
      ...
      uVar9 = uVar5 * 2;
      if (uVar9 < uVar5) {
         LAB_00101480:lVar10 = 0x7ffffffffffffff8;
         goto LAB_00101457;
      }
 ...
 while ( lVar7 + 8 != (long)puVar1 - (long)puVar3 );
   ...
   LAB_00101417:*(TIntermNode***)( this + 8 ) = ppTVar6;
...
/* __gnu_cxx::__normal_iterator<glslang::TTypeLoc*, std::vector<glslang::TTypeLoc,
   ...
   if (0 < lVar5 >> 7) {
      ...
      do {
         ...
         if (*(code**)( lVar5 + 0xf8 ) == glslang::TType::isUnsizedArray) {
            ...
            lVar4 = plVar1[0xc];
            if (lVar4 != 0) {
               LAB_001015db:if (**(int**)( *(long*)( lVar4 + 8 ) + 8 ) == 0) {
                  return param_1;
               }
            ...
            LAB_00101609:lVar5 = *plVar1;
         }

         if (*(code**)( lVar5 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar1[1] - 0xfU) < 2) {
               LAB_001017cd:lVar5 = *(long*)( plVar1[0xd] + 0x10 );
               lVar4 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsUnsizedArray()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsUnsizedArray ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar5 ));
               if (lVar5 != lVar4) {
                  return param_1;
               }
         ...
         if (*(code**)( lVar5 + 0xf8 ) == glslang::TType::isUnsizedArray) {
            ...
            lVar4 = plVar1[0xc];
            if (lVar4 != 0) {
               LAB_00101658:if (**(int**)( *(long*)( lVar4 + 8 ) + 8 ) == 0) goto LAB_00101666;
               goto LAB_00101679;
            }
            ...
            LAB_00101679:lVar5 = *plVar1;
         }

         if (*(code**)( lVar5 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar1[1] - 0xfU) < 2) {
               LAB_001017fd:lVar5 = *(long*)( plVar1[0xd] + 0x10 );
               lVar4 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsUnsizedArray()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsUnsizedArray ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar5 ));
               if (lVar5 != lVar4) {
                  LAB_00101666:return param_1 + 4;
               }
         ...
         if (*(code**)( lVar5 + 0xf8 ) == glslang::TType::isUnsizedArray) {
            ...
            lVar4 = plVar1[0xc];
            if (lVar4 != 0) {
               LAB_001016c8:if (**(int**)( *(long*)( lVar4 + 8 ) + 8 ) == 0) goto LAB_001016d6;
               goto LAB_001016e9;
            }
            ...
            LAB_001016e9:lVar5 = *plVar1;
         }

         if (*(code**)( lVar5 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar1[1] - 0xfU) < 2) {
               LAB_0010182d:lVar5 = *(long*)( plVar1[0xd] + 0x10 );
               lVar4 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsUnsizedArray()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsUnsizedArray ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar5 ));
               if (lVar5 != lVar4) {
                  LAB_001016d6:return param_1 + 8;
               }
         ...
         if (*(code**)( lVar5 + 0xf8 ) == glslang::TType::isUnsizedArray) {
            ...
            lVar4 = plVar1[0xc];
            if (lVar4 != 0) {
               LAB_00101738:if (**(int**)( *(long*)( lVar4 + 8 ) + 8 ) == 0) goto LAB_00101746;
               goto LAB_00101759;
            }
            ...
            LAB_00101759:lVar5 = *plVar1;
         }

         if (*(code**)( lVar5 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar1[1] - 0xfU) < 2) {
               LAB_0010185d:lVar5 = *(long*)( plVar1[0xd] + 0x10 );
               lVar4 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsUnsizedArray()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsUnsizedArray ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar5 ));
               if (lVar5 != lVar4) {
                  LAB_00101746:return param_1 + 0xc;
               }
 ...
 while ( param_1 != plVar6 );
   ...
   if (lVar5 != 2) {
      ...
      bVar3 = glslang::TType::contains<glslang::TType::containsUnsizedArray()const::_lambda(glslang::TType_const*)_1_>(*param_1);
      if (bVar3) {
         return param_1;
      }
   ...
   param_1 = param_1 + 4;
   LAB_0010191e:bVar3 = glslang::TType::contains<glslang::TType::containsUnsizedArray()const::_lambda(glslang::TType_const*)_1_>(*param_1);
   if (!bVar3) {
      return param_2;
   }
...
/* bool glslang::TType::contains<glslang::TType::containsUnsizedArray()
   const::{lambda(glslang::TType const*)#1}>(glslang::TType::containsUnsizedArray()
   const::{lambda(glslang::TType const*)#1}) const [clone .isra.0] */bool glslang::TType::contains<glslang::TType::containsUnsizedArray()const::_lambda(glslang::TType_const *)_1_ > ( long *param_1)
...
LAB_001019d9: ) ;p_Var8 = *(_Rb_tree_node_base**)( p_Var9 + 0x28 );}*(ulong*)( p_Var9 + 0x30 ) = uVar3;p_Var8[uVar3] = (_Rb_tree_node_base)0x0;uVar5 = glslang::GetThreadPoolAllocator();uVar3 = *(ulong*)( param_1 + 0x58 );p_Var8 = p_Var9 + 0x60;*(_Rb_tree_node_base**)( p_Var9 + 0x50 ) = p_Var8;p_Var12 = *(_Rb_tree_node_base**)( param_1 + 0x50 );*(ulong*)( p_Var9 + 0x48 ) = uVar5;if (uVar3 < 0x10) {
   if (uVar3 == 1) {
      p_Var9[0x60] = *p_Var12;
      goto LAB_00101ac4;
   }
   ...
   if ((long)uVar3 < 0) {
      LAB_00101e6e:/* WARNING: Subroutine does not return */std::__throw_length_error("basic_string::_M_create");
   }
...
memcpy(p_Var8, p_Var12, uVar3);p_Var8 = *(_Rb_tree_node_base**)( p_Var9 + 0x50 );LAB_00101ac4:*(ulong*)( p_Var9 + 0x58 ) = uVar3;p_Var8[uVar3] = (_Rb_tree_node_base)0x0;uVar1 = *(undefined4*)param_1;*(undefined8*)( p_Var9 + 0x10 ) = 0;*(undefined8*)( p_Var9 + 0x18 ) = 0;*(_Rb_tree_node_base**)( p_Var9 + 8 ) = param_2;p_Var6 = *(_Rb_tree_node**)( param_1 + 0x18 );*(undefined4*)p_Var9 = uVar1;if (p_Var6 != (_Rb_tree_node*)0x0) {
   p_Var6 = _M_copy<false,std::_Rb_tree<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::_Select1st<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>>,std::less<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>>>::_Reuse_or_alloc_node>(p_Var6, p_Var9, param_3);
   *(_Rb_tree_node**)( p_Var9 + 0x18 ) = p_Var6;
}
puVar11 = *(undefined4**)( param_1 + 0x10 );if (puVar11 == (undefined4*)0x0) {
   return (_Rb_tree_node*)p_Var9;
}
p_Var8 = *(_Rb_tree_node_base**)( param_3 + 8 );p_Var12 = p_Var9;if (p_Var8 == (_Rb_tree_node_base*)0x0) goto LAB_00101c14;LAB_00101b21:lVar2 = *(long*)( p_Var8 + 8 );*(long*)( param_3 + 8 ) = lVar2;p_Var7 = p_Var8;if (lVar2 == 0) {
...
do {
   ...
   *(ulong*)( p_Var7 + 0x20 ) = uVar5;
   if (uVar3 < 0x10) {
      ...
      *(_Rb_tree_node_base**)( p_Var7 + 0x28 ) = p_Var8;
      LAB_00101cba:memcpy(p_Var8, p_Var4, uVar3);
   ...
   *(ulong*)( p_Var7 + 0x48 ) = uVar5;
   if (uVar3 < 0x10) {
      ...
      *(_Rb_tree_node_base**)( p_Var7 + 0x50 ) = p_Var8;
      LAB_00101c7a:memcpy(p_Var8, p_Var4, uVar3);
   ...
   *(_Rb_tree_node_base**)( p_Var7 + 8 ) = p_Var12;
   if (*(_Rb_tree_node**)( puVar11 + 6 ) != (_Rb_tree_node*)0x0) {
      p_Var6 = _M_copy<false,std::_Rb_tree<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::_Select1st<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>>,std::less<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>>>::_Reuse_or_alloc_node>(*(_Rb_tree_node**)( puVar11 + 6 ), p_Var7, param_3);
   ...
   LAB_00101c14:p_Var7 = (_Rb_tree_node_base*)glslang::TPoolAllocator::allocate(**(ulong**)( param_3 + 0x10 ));
}
 while ( true );}/* glslang::TIntermediate::addBinaryNode(glslang::TOperator, glslang::TIntermTyped*,
   glslang::TIntermTyped*, glslang::TSourceLoc const&) const */undefined8 * __thiscall
glslang::TIntermediate::addBinaryNode
   ...
   *(undefined1(*) [16])( puVar5 + 0x12 ) = (undefined1[16])0x0;
   puVar5[6] = 0;
   *(ulong*)( (long)puVar5 + 0x4d ) = ( ulong )(( uint ) * (undefined8*)( (long)puVar5 + 0x4d ) & 0xffc00f) | 0xffffffffff001fc0;
   iVar1 = *(int*)( (long)param_5 + 0xc );
   *(uint*)( puVar5 + 0x14 ) = *(uint*)( puVar5 + 0x14 ) & 0x9fc00000;
   *(ulong*)( (long)puVar5 + 0x55 ) = *(ulong*)( (long)puVar5 + 0x55 ) & 0xfe000000800000 | 0x1ffffff7fffff;
   ...
   *puVar5 = &TIntermMethod::vtable;
   ...
   puVar5[0x18] = param_3;
   LAB_00101fdd:if (*(code**)( puVar7 + 0x188 ) == TIntermBinary::setRight) {
      puVar5[0x19] = param_4;
      return puVar5;
   }
...
/* glslang::TIntermediate::addBinaryNode(glslang::TOperator, glslang::TIntermTyped*,
   glslang::TIntermTyped*, glslang::TSourceLoc const&, glslang::TType const&) const */long *glslang::TIntermediate::addBinaryNode(void) {
   undefined1 uVar1;
   undefined4 uVar2;
   long lVar3;
   long lVar4;
   ...
   if (*(code**)( *plVar6 + 0xe8 ) == TIntermTyped::setType) {
      ...
      *(byte*)( (long)plVar6 + 0x2a ) = bVar8 & 0x80 | bVar9 | bVar10 | bVar7 | *(byte*)( in_R9 + 10 ) & 0x40;
      *(ushort*)( (long)plVar6 + 0x2a ) = *(ushort*)( (long)plVar6 + 0x2a ) & 0xfc7f | *(ushort*)( in_R9 + 10 ) & 0x380;
      *(byte*)( (long)plVar6 + 0x2b ) = *(byte*)( (long)plVar6 + 0x2b ) & 0xfb | *(byte*)( in_R9 + 0xb ) & 4;
      return plVar6;
   }
...
/* glslang::TIntermediate::addIndex(glslang::TOperator, glslang::TIntermTyped*,
   glslang::TIntermTyped*, glslang::TSourceLoc const&) */void glslang::TIntermediate::addIndex(void) {
   addBinaryNode();
   return;
}
/* glslang::TIntermediate::isConversionAllowed(glslang::TOperator, glslang::TIntermTyped*) const */ulong glslang::TIntermediate::isConversionAllowed(undefined8 param_1, int param_2, long *param_3) {
   uint uVar1;
   long lVar2;
   long *plVar3;
   ulong uVar4;
   ...
   LAB_001021f7:return uVar4 & 0xffffffff;
}
/* glslang::TIntermediate::buildConvertOp(glslang::TBasicType, glslang::TBasicType,
   glslang::TOperator&) const */undefined8 glslang::TIntermediate::buildConvertOp(undefined8 param_1, undefined4 param_2, undefined4 param_3, undefined4 *param_4) {
   switch (param_2) {
      default:
...
/* glslang::TIntermediate::addUniShapeConversion(glslang::TOperator, glslang::TType const&,
   glslang::TIntermTyped*) */undefined8 glslang::TIntermediate::addUniShapeConversion(void) {
   undefined8 in_RCX;
   return in_RCX;
}
/* glslang::TIntermediate::addBiShapeConversion(glslang::TOperator, glslang::TIntermTyped*&,
   glslang::TIntermTyped*&) */void glslang::TIntermediate::addBiShapeConversion(void) {
   return;
}
/* glslang::TIntermediate::isIntegralPromotion(glslang::TBasicType, glslang::TBasicType) const */bool glslang::TIntermediate::isIntegralPromotion(undefined8 param_1, int param_2, int param_3) {
   if (param_3 != 8) {
      return false;
   }
...
/* glslang::TIntermediate::isFPPromotion(glslang::TBasicType, glslang::TBasicType) const */bool glslang::TIntermediate::isFPPromotion(undefined8 param_1, uint param_2, int param_3) {
   if (param_3 != 2) {
      return false;
   }
...
/* glslang::TIntermediate::isIntegralConversion(glslang::TBasicType, glslang::TBasicType) const */long glslang::TIntermediate::isIntegralConversion(TIntermediate *this, int param_2, uint param_3) {
   long lVar1;
   undefined7 uVar2;
   if (6 < param_2 - 4U) {
      return 0;
   ...
   lVar1 = (long)&switchD_00102a4e::switchdataD_001121b4 + (long)(int)( &switchD_00102a4e::switchdataD_001121b4 )[param_2 - 4U];
...
/* glslang::TIntermediate::isFPConversion(glslang::TBasicType, glslang::TBasicType) const */uint glslang::TIntermediate::isFPConversion(undefined8 param_1, int param_2, int param_3) {
   undefined8 in_RAX;
   return (uint)CONCAT71(( int7 )((ulong)in_RAX >> 8), param_3 == 1) & CONCAT31(( int3 )((uint)param_3 >> 8), param_2 == 3);
}
/* glslang::TIntermediate::isFPIntegralConversion(glslang::TBasicType, glslang::TBasicType) const */bool glslang::TIntermediate::isFPIntegralConversion(undefined8 param_1, uint param_2, int param_3) {
   if (9 < param_2) {
      if (param_2 - 10 < 2) {
         return param_3 == 2;
      }
...
/* glslang::TIntermediate::canImplicitlyPromote(glslang::TBasicType, glslang::TBasicType,
   glslang::TOperator) const */ulong glslang::TIntermediate::canImplicitlyPromote(TIntermediate *param_1, uint param_2, uint param_3) {
   ulong uVar1;
   ulong uVar2;
   int iVar3;
   uint uVar4;
   ...
   if (param_3 == 8) {
      ...
      switchD_00102d36_caseD_7:if (param_2 != 6) {
         return 0;
      }

      LAB_00102d5e:return ( ulong )(*(uint*)( param_1 + 0x5c8 ) >> 10 & 1);
   }
   ...
   if (param_3 == 2) {
      ...
      LAB_00102c2d:uVar1 = isIntegralConversion(param_1, param_2, uVar2);
      if ((char)uVar1 == '\0') {
         if (9 < param_2) {
            if (1 < param_2 - 10) {
               if (iVar6 == 8) {
...
switchD_00102d36_caseD_9:
         ...
         LAB_00102cb0:if (param_1[0x5c8] != (TIntermediate)0x0) {
            return 1;
         }
      ...
      if (( param_2 == 3 ) && ( (int)uVar2 == 1 )) {
         ...
         LAB_00102c00:return ( ulong )(uVar4 >> 0xb & 1);
      }

      if (param_2 < 10) goto LAB_00102cf2;
      if (param_2 - 10 < 2) goto LAB_00102e4f;
      LAB_00102cbe:if (iVar6 != 8) {
         LAB_00102cc8:if (0xb < (uint)uVar2) {
            return 0;
         }
   ...
   LAB_00102ebd:return ( ulong )(*(uint*)( param_1 + 0x5c8 ) >> 8 & 1);
}
/* glslang::TIntermediate::getConversionDestinationType(glslang::TBasicType, glslang::TBasicType,
   glslang::TOperator) const */undefined8 *glslang::TIntermediate::getConversionDestinationType(undefined8 *param_1, long param_2, uint param_3, uint param_4, undefined4 param_5) {
   char cVar1;
   uint uVar2;
   ulong uVar3;
   ulong uVar4;
   ...
   if (*(int*)( param_2 + 0x60 ) == 8) {
      if (( *(int*)( param_2 + 100 ) < 0x136 ) || ( ( *(byte*)( param_2 + 0x5c9 ) & 1 ) == 0 )) goto LAB_001030d7;
   }
 else if (*(int*)( param_2 + 100 ) == 0x6e) {
      LAB_001030d7:*param_1 = _LC10;
      return param_1;
   }
   ...
   if (param_3 == 2) {
      ...
      if (param_4 == 2) {
         ...
         if (cVar1 != '\0') goto LAB_00103236;
         LAB_00103150:if (( 0x550UL >> ( uVar4 & 0x3f ) & 1 ) == 0) goto LAB_001031f8;
         if (0xb < param_4) goto LAB_00103210;
         LAB_00103168:if (( 0xaa0UL >> ( uVar3 & 0x3f ) & 1 ) != 0) goto LAB_0010306a;
      }
 else {
         if (param_4 == 1) {
            LAB_00103262:cVar1 = canImplicitlyPromote(param_2, param_3, 1, param_5);
            if (cVar1 != '\0') goto LAB_00103116;
            goto LAB_00103150;
         }

         if (param_4 == 3) goto LAB_001031a5;
         LAB_001031f8:if (( 0xaa0UL >> ( uVar4 & 0x3f ) & 1 ) != 0) goto LAB_00103052;
      }
      ...
      if (param_4 == 2) {
         ...
         if (cVar1 == '\0') {
            if (param_3 == 1) {
               ...
               LAB_00103140:if (param_3 == 3) goto LAB_00103180;
               if (param_3 < 0xb) goto LAB_00103150;
               LAB_001032e8:if (param_3 < 0xc) goto LAB_00103052;
            }

            goto LAB_00103210;
         }

         LAB_00103236:uVar2 = 2;
         goto LAB_0010311b;
      }
      ...
      if (param_3 == 1) {
         ...
         LAB_001031a0:if (param_4 != 3) goto LAB_00103210;
         LAB_001031a5:cVar1 = canImplicitlyPromote(param_2, param_3, 3, param_5);
         if (cVar1 != '\0') goto LAB_00103195;
         if (param_3 < 0xb) goto LAB_00103150;
         if (0xb < param_3) goto LAB_00103210;
         LAB_0010305b:if (( 0x550UL >> ( uVar3 & 0x3f ) & 1 ) == 0) goto LAB_00103168;
      }
 else {
         if (param_4 == 1) {
            cVar1 = canImplicitlyPromote(param_2, param_3, 1, param_5);
            if (cVar1 == '\0') goto LAB_00103140;
            LAB_00103116:uVar2 = 1;
            goto LAB_0010311b;
         }

         if (param_3 == 3) {
            LAB_00103180:cVar1 = canImplicitlyPromote(param_2, uVar3, 3, param_5);
            if (cVar1 == '\0') goto LAB_001031a0;
            LAB_00103195:uVar2 = 3;
            goto LAB_0010311b;
         }
         ...
         LAB_00103052:if (param_4 < 0xb) goto LAB_0010305b;
         if (0xb < param_4) goto LAB_00103210;
      }

      LAB_0010306a:cVar1 = canImplicitlyPromote(param_2, param_3, uVar3, param_5);
      if (( cVar1 != '\0' ) || ( cVar1 = canImplicitlyPromote(param_2, uVar3, param_3, param_5) ),cVar1 != '\0') {
         if (param_3 < 0xb) {
            ...
            bVar5 = false;
            LAB_001032b5:if (( 0xaa0UL >> ( uVar3 & 0x3f ) & 1 ) == 0) {
               uVar2 = param_3;
               if (*(int*)( CSWTCH_1144 + ( ulong )(param_4 - 4) * 4 ) < *(int*)( CSWTCH_1144 + ( ulong )(param_3 - 4) * 4 )) goto LAB_0010311b;
               LAB_0010332b:if (( ( 0xaa0UL >> ( uVar3 & 0x3f ) & 1 ) != 0 ) && ( uVar2 = param_4 * (int*)( CSWTCH_1144 + ( ulong )(param_3 - 4) * 4 ) < *(int*)( CSWTCH_1144 + ( ulong )(param_4 - 4) * 4 ) )) goto LAB_0010311b;
               if (bVar5) {
         ...
         uVar2 = param_4;
         if (*(int*)( CSWTCH_1144 + ( ulong )(param_4 - 4) * 4 ) <= *(int*)( CSWTCH_1144 + ( ulong )(param_3 - 4) * 4 )) {
            uVar2 = param_3;
         }
   ...
   LAB_00103210:uVar2 = 0x18;
   LAB_0010311b:*param_1 = CONCAT44(uVar2, uVar2);
   return param_1;
}
/* glslang::TIntermediate::mapTypeToConstructorOp(glslang::TType const&) const */undefined8 glslang::TIntermediate::mapTypeToConstructorOp(TIntermediate *this, TType *param_1) {
   undefined8 uVar1;
   TType *pTVar2;
...
/* glslang::TIntermediate::addSelection(glslang::TIntermTyped*, glslang::TIntermNodePair,
   glslang::TSourceLoc const&) */void glslang::TIntermediate::addSelection(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 *param_5) {
   undefined8 uVar1;
   ulong uVar2;
   undefined8 *puVar3;
   ...
   *(uint*)( puVar3 + 5 ) = CONCAT22((short)( ( uint ) * (undefined4*)( puVar3 + 5 ) >> 0x10 ), 0x100) & 0xf800ffff;
   puVar3[7] = puVar3[7] & 0x8000000400000000;
   *(uint*)( puVar3 + 0x14 ) = *(uint*)( puVar3 + 0x14 ) & 0x9fc00000;
   puVar3[1] = 0;
   puVar3[2] = 0;
   *(ulong*)( (long)puVar3 + 0x4d ) = ( ulong )(( uint ) * (undefined8*)( (long)puVar3 + 0x4d ) & 0xffc00f) | 0xffffffffff001fc0;
   *(undefined4*)( puVar3 + 3 ) = 0;
   *(ulong*)( (long)puVar3 + 0x55 ) = *(ulong*)( (long)puVar3 + 0x55 ) & 0xfe000000800000 | 0x1ffffff7fffff;
...
/* glslang::TIntermediate::addMethod(glslang::TIntermTyped*, glslang::TType const&,
   ...
   glslang::TSourceLoc const&) */long *__thiscallglslang::TIntermediate::addMethod(TIntermediate *this, TIntermTyped *param_1, TType *param_2, basic_string *param_3, TSourceLoc *param_4) {
   TType TVar1;
   byte bVar2;
   undefined4 uVar3;
   long lVar4;
   ...
   *(ulong*)( (long)plVar8 + 0x4d ) = *(ulong*)( (long)plVar8 + 0x4d ) & 0xffffff0000ffc07f | 0xffff001f80;
   ...
   *(undefined2*)( plVar8 + 0xf ) = 0;
   plVar8[6] = 0;
   *(ulong*)( (long)plVar8 + 0x4c ) = *(ulong*)( (long)plVar8 + 0x4c ) & 0xffffffff8000 | 0xffff000000004fff;
   ...
   *(undefined4*)( plVar8 + 0x14 ) = uVar3;
   ...
   plVar8[9] = lVar5;
   for (int i = 0; i < 3; i++) {
      lVar4 = *(long*)( param_2 + ( 16*i + 56 ) );
      plVar8[( 2*i + 10 )] = *(long*)( param_2 + ( 16*i + 48 ) );
      plVar8[( 2*i + 11 )] = lVar4;
   }
   ...
   *(byte*)( (long)plVar8 + 0x2a ) = bVar2 & 0x80 | bVar10 | bVar11 | (byte)TVar1 & 0x20 | (byte)param_2[10] & 0x40;
   *(ushort*)( (long)plVar8 + 0x2a ) = *(ushort*)( (long)plVar8 + 0x2a ) & 0xfc7f | *(ushort*)( param_2 + 10 ) & 0x380;
   TVar1 = param_2[0xb];
   ...
   *plVar8 = (long)frexp;
   ...
   LAB_0010385a:plVar8[0x1a] = uVar7;
...
/* glslang::TIntermediate::addConstantUnion(glslang::TConstUnionArray const&, glslang::TType const&,
   glslang::TSourceLoc const&, bool) const */void glslang::TIntermediate::addConstantUnion(TIntermediate *this, TConstUnionArray *param_1, TType *param_2, TSourceLoc *param_3, bool param_4) {
   TType TVar1;
   byte bVar2;
   undefined4 uVar3;
   undefined8 uVar4;
   ...
   *(uint*)( puVar8 + 5 ) = CONCAT22((short)( ( uint ) * (undefined4*)( puVar8 + 5 ) >> 0x10 ), 0x100) & 0xf800ffff;
   puVar8[1] = 0;
   *(ulong*)( (long)puVar8 + 0x4d ) = *(ulong*)( (long)puVar8 + 0x4d ) & 0xffffff0000ffc07f | 0xffff001f80;
   puVar8[2] = 0;
   ...
   *(ulong*)( (long)puVar8 + 0x4c ) = *(ulong*)( (long)puVar8 + 0x4c ) & 0xffffffff8000 | 0xffff000000004fff;
   puVar8[6] = 0;
   ...
   *(byte*)( (long)puVar8 + 0x2a ) = bVar2 & 0x80 | bVar9 | bVar10 | (byte)TVar1 & 0x20 | (byte)param_2[10] & 0x40;
   *(ushort*)( (long)puVar8 + 0x2a ) = *(ushort*)( (long)puVar8 + 0x2a ) & 0xfc7f | *(ushort*)( param_2 + 10 ) & 0x380;
   TVar1 = param_2[0xb];
...
/* glslang::TIntermediate::addConstantUnion(signed char, glslang::TSourceLoc const&, bool) const */void glslang::TIntermediate::addConstantUnion(TIntermediate *this, undefined1 param_2, TSourceLoc *param_3, bool param_4) {
   ulong uVar1;
   ulong *puVar2;
   undefined4 *puVar3;
   long in_FS_OFFSET;
...
/* glslang::TIntermediate::addConstantUnion(unsigned char, glslang::TSourceLoc const&, bool) const
    */void glslang::TIntermediate::addConstantUnion(TIntermediate *this, uchar param_1, TSourceLoc *param_2, bool param_3) {
   ulong uVar1;
   ulong *puVar2;
   uint *puVar3;
   long in_FS_OFFSET;
...
/* glslang::TIntermediate::addConstantUnion(short, glslang::TSourceLoc const&, bool) const */void glslang::TIntermediate::addConstantUnion(TIntermediate *this, short param_1, TSourceLoc *param_2, bool param_3) {
   ulong uVar1;
   ulong *puVar2;
   short *psVar3;
   long in_FS_OFFSET;
...
/* glslang::TIntermediate::addConstantUnion(unsigned short, glslang::TSourceLoc const&, bool) const
    */void glslang::TIntermediate::addConstantUnion(TIntermediate *this, ushort param_1, TSourceLoc *param_2, bool param_3) {
   ulong uVar1;
   ulong *puVar2;
   ushort *puVar3;
   long in_FS_OFFSET;
...
/* glslang::TIntermediate::addConstantUnion(int, glslang::TSourceLoc const&, bool) const */void glslang::TIntermediate::addConstantUnion(TIntermediate *this, int param_1, TSourceLoc *param_2, bool param_3) {
   ulong uVar1;
   ulong *puVar2;
   int *piVar3;
   long in_FS_OFFSET;
...
/* glslang::TIntermediate::addConstantUnion(unsigned int, glslang::TSourceLoc const&, bool) const */void glslang::TIntermediate::addConstantUnion(TIntermediate *this, uint param_1, TSourceLoc *param_2, bool param_3) {
   ulong uVar1;
   ulong *puVar2;
   uint *puVar3;
   long in_FS_OFFSET;
...
/* glslang::TIntermediate::addConstantUnion(long long, glslang::TSourceLoc const&, bool) const */void glslang::TIntermediate::addConstantUnion(TIntermediate *this, longlong param_1, TSourceLoc *param_2, bool param_3) {
   ulong uVar1;
   ulong *puVar2;
   longlong *plVar3;
   long in_FS_OFFSET;
...
/* glslang::TIntermediate::addConstantUnion(unsigned long long, glslang::TSourceLoc const&, bool)
   const */void glslang::TIntermediate::addConstantUnion(TIntermediate *this, ulonglong param_1, TSourceLoc *param_2, bool param_3) {
   ulong uVar1;
   ulong *puVar2;
   ulonglong *puVar3;
   long in_FS_OFFSET;
...
/* glslang::TIntermediate::addConstantUnion(bool, glslang::TSourceLoc const&, bool) const */void glslang::TIntermediate::addConstantUnion(TIntermediate *this, bool param_1, TSourceLoc *param_2, bool param_3) {
   ulong uVar1;
   ulong *puVar2;
   undefined4 *puVar3;
   long in_FS_OFFSET;
...
/* glslang::TIntermediate::addConstantUnion(double, glslang::TBasicType, glslang::TSourceLoc const&,
   bool) const */void glslang::TIntermediate::addConstantUnion(double param_1, TIntermediate *this, uint param_3, TSourceLoc *param_4, bool param_5) {
   int iVar1;
   ulong uVar2;
   ulong *puVar3;
   double *pdVar4;
   ...
   *pdVar4 = local_f0;
   ...
   local_d0 = CONCAT22((short)( ( local_d0 & 0xf80000ff ) >> 0x10 ), CONCAT11(1, (char)( local_d0 & 0xf80000ff )));
   local_94 = 0xfffff800;
   local_80 = 0;
   local_98 = 0;
   local_c8 = 0;
...
/* glslang::TIntermediate::addConstantUnion(std::__cxx11::basic_string<char, std::char_traits<char>,
   glslang::std::allocator<char> > const*, glslang::TSourceLoc const&, bool) const */void glslang::TIntermediate::addConstantUnion(TIntermediate *this, basic_string *param_1, TSourceLoc *param_2, bool param_3) {
   ulong uVar1;
   ulong *puVar2;
   undefined8 *puVar3;
   long in_FS_OFFSET;
...
/* glslang::TIntermediate::pushSelector(glslang::TVector<TIntermNode*>&, int const&,
   glslang::TSourceLoc const&) */void glslang::TIntermediate::pushSelector(TIntermediate *this, TVector *param_1, int *param_2, TSourceLoc *param_3) {
   long in_FS_OFFSET;
   TIntermNode *local_18;
   long local_10;
   local_10 = *(long*)( in_FS_OFFSET + 0x28 );
   local_18 = (TIntermNode*)addConstantUnion(this, *param_2, param_3, false);
   std::vector<TIntermNode*,glslang::pool_allocator<TIntermNode*>>::emplace_back<TIntermNode*>((vector<TIntermNode*,glslang::pool_allocator<TIntermNode*>>*)param_1, &local_18);
...
/* glslang::TIntermediate::pushSelector(glslang::TVector<TIntermNode*>&, glslang::TMatrixSelector
   const&, glslang::TSourceLoc const&) */void glslang::TIntermediate::pushSelector(TIntermediate *this, TVector *param_1, TMatrixSelector *param_2, TSourceLoc *param_3) {
   long in_FS_OFFSET;
   TIntermNode *local_38;
   long local_30;
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   local_38 = (TIntermNode*)addConstantUnion(this, *(int*)param_2, param_3, false);
   std::vector<TIntermNode*,glslang::pool_allocator<TIntermNode*>>::emplace_back<TIntermNode*>((vector<TIntermNode*,glslang::pool_allocator<TIntermNode*>>*)param_1, &local_38);
...
/* glslang::TIntermediate::traverseLValueBase(glslang::TIntermTyped const*, bool, bool,
   std::function<bool (TIntermNode const&)>) */long *glslang::TIntermediate::traverseLValueBase(long *param_1, char param_2, char param_3, long param_4) {
   int iVar1;
   char cVar2;
   byte bVar3;
   long *plVar4;
   ...
   do {
      ...
      if (param_2 == '\0') {
         ...
         if (iVar1 - 0xb6U != 2) {
            ...
            if (*(code**)( *plVar5 + 0xd8 ) == TType::isVector) {
               ...
               LAB_001052b5:lVar6 = *plVar4;
            }
 else {
               bVar3 = ( **(code**)( *plVar5 + 0xd8 ) )();
               LAB_0010538a:lVar6 = *plVar4;
               if (bVar3 == 0) {
      ...
      LAB_00105318:if (( *(long*)( param_4 + 0x10 ) != 0 ) && ( cVar2 = ( **(code**)( param_4 + 0x18 ) )(param_4, param_1) ),cVar2 == '\0') {
         return param_1;
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* glslang::TIntermediate::addLoop(TIntermNode*, glslang::TIntermTyped*, glslang::TIntermTyped*,
   bool, glslang::TSourceLoc const&) */void glslang::TIntermediate::addLoop(TIntermediate *this, TIntermNode *param_1, TIntermTyped *param_2, TIntermTyped *param_3, bool param_4, TSourceLoc *param_5) {
   undefined8 uVar1;
   undefined8 uVar2;
   ulong uVar3;
   undefined8 *puVar4;
...
/* glslang::TIntermediate::addBranch(glslang::TOperator, glslang::TSourceLoc const&) */void glslang::TIntermediate::addBranch(undefined8 param_1, undefined4 param_2, undefined8 *param_3) {
   undefined8 uVar1;
   undefined8 uVar2;
   ulong uVar3;
   undefined8 *puVar4;
...
/* glslang::TIntermediate::addBranch(glslang::TOperator, glslang::TIntermTyped*, glslang::TSourceLoc
   const&) */void glslang::TIntermediate::addBranch(undefined8 param_1, undefined4 param_2, undefined8 param_3, undefined8 *param_4) {
   undefined8 uVar1;
   undefined8 uVar2;
   ulong uVar3;
   undefined8 *puVar4;
...
/* glslang::TIntermBranch::updatePrecision(glslang::TPrecisionQualifier) */void glslang::TIntermBranch::updatePrecision(TIntermBranch *this, int param_2) {
   long *plVar1;
   int iVar2;
   uint uVar3;
   long *plVar4;
...
/* glslang::TIntermediate::postProcess(TIntermNode*, EShLanguage) */undefined8 glslang::TIntermediate::postProcess(TIntermediate *param_1, long *param_2) {
   long *plVar1;
   long in_FS_OFFSET;
   undefined **local_58;
   undefined4 local_50;
...
/* glslang::TIntermediate::addToCallGraph(TInfoSink&, std::__cxx11::basic_string<char,
   std::char_traits<char>, glslang::std::allocator<char> > const&, std::__cxx11::basic_string<char,
   std::char_traits<char>, glslang::std::allocator<char> > const&) */void glslang::TIntermediate::addToCallGraph(TIntermediate *this, TInfoSink *param_1, basic_string *param_2, basic_string *param_3) {
   size_t __n;
   ...
   if (pTVar7 != this + 0x48) {
      ...
      do {
         ...
         if (( __n != 0 ) && ( iVar3 = memcmp(*(void**)( pTVar7 + 0x18 ), *(void**)( param_2 + 8 ), __n) ),iVar3 != 0) break;
         __n_00 = *(size_t*)( pTVar7 + 0x48 );
         if (__n_00 == *(size_t*)( param_3 + 0x10 )) {
            if (( __n_00 == 0 ) || ( iVar3 = memcmp(*(void**)( pTVar7 + 0x40 ), *(void**)( param_3 + 8 ), __n_00) ),iVar3 == 0) {
               return;
            }
 ...
 while ( pTVar7 != this + 0x48 );
   ...
   *(_List_node_base**)( p_Var4 + 0x18 ) = p_Var6;
   if (uVar2 < 0x10) {
      ...
      *(_List_node_base**)( p_Var4 + 0x18 ) = p_Var6;
      LAB_00105979:memcpy(p_Var6, p_Var1, uVar2);
   ...
   *(_List_node_base**)( p_Var4 + 0x40 ) = p_Var6;
   if (uVar2 < 0x10) {
      ...
      if ((long)uVar2 < 0) {
         LAB_001059e0:/* WARNING: Subroutine does not return */std::__throw_length_error("basic_string::_M_create");
      }
   ...
   LAB_001058c6:*(ulong*)( p_Var4 + 0x48 ) = uVar2;
   p_Var6[uVar2] = (_List_node_base)0x0;
   std::__detail::_List_node_base::_M_hook(p_Var4);
   *(long*)( this + 0x58 ) = *(long*)( this + 0x58 ) + 1;
   return;
}
/* glslang::TIntermediate::removeTree() */void glslang::TIntermediate::removeTree(TIntermediate *this) {
...
/* WARNING: Type propagation algorithm not settling *//* glslang::TIntermediate::isSpecializationOperation(glslang::TIntermOperator const&) const */undefined8 glslang::TIntermediate::isSpecializationOperation(TIntermediate *this, TIntermOperator *param_1) {
   uint uVar1;
   ulong uVar2;
   char cVar3;
   long *plVar4;
   ...
   if (*(code**)( *(long*)pTVar5 + 0x130 ) == TType::isFloatingDomain) {
      if (2 < ( byte )((char)pTVar5[8] - 1U)) {
         LAB_00105aa6:plVar4 = (long*)( **(code**)( *(long*)param_1 + 0xa0 ) )(param_1);
         if (plVar4 != (long*)0x0) {
            if (*(code**)( *plVar4 + 400 ) == TIntermBinary::getLeft) {
   ...
   joined_r0x00105bd1:if (( uVar2 & 1 ) == 0) {
      return 0;
   }

   return 1;
}
/* glslang::TIntermediate::isNonuniformPropagating(glslang::TOperator) const */bool glslang::TIntermediate::isNonuniformPropagating(undefined8 param_1, uint param_2) {
   if (0xf < param_2) {
...
/* glslang::TIntermOperator::modifiesState() const */undefined4 glslang::TIntermOperator::modifiesState(TIntermOperator *this) {
   uint uVar1;
...
/* glslang::TIntermOperator::isConstructor() const */undefined4 glslang::TIntermOperator::isConstructor(TIntermOperator *this) {
   return CONCAT31(( int3 )(*(int*)( this + 0xb8 ) - 0x1dbU >> 8), *(int*)( this + 0xb8 ) - 0x1dbU < 0x6d);
}
/* glslang::TIntermUnary::updatePrecision() */void glslang::TIntermUnary::updatePrecision(TIntermUnary *this) {
   byte bVar1;
   code *pcVar2;
   int iVar3;
   uint uVar4;
   ...
   if (*(code**)( *(long*)this + 0x100 ) == TIntermTyped::getBasicType) {
      ...
      LAB_00105d1d:uVar4 = (uint)(byte)TVar6;
   ...
   LAB_00105d40:pcVar2 = *(code**)( **(long**)( this + 0xc0 ) + 0x108 );
...
/* glslang::TIntermediate::promoteBinary(glslang::TIntermBinary&) */ulong glslang::TIntermediate::promoteBinary(TIntermediate *this, TIntermBinary *param_1) {
   TIntermBinary TVar1;
   TType TVar2;
   long lVar3;
   long lVar4;
   ...
   if (*(code**)( *plVar21 + 0x150 ) != TIntermTyped::isArray) {
      ...
      LAB_0010635d:lVar22 = *plVar16;
      LAB_00105f10:if (*(code**)( lVar22 + 0xf0 ) == TIntermTyped::getType) {
   ...
   LAB_001061d9:if (*(code**)( lVar22 + 0x150 ) == TIntermTyped::isArray) {
   ...
   LAB_00105f4f:pTVar20 = (TType*)( plVar21 + 4 );
   pcVar24 = *(code**)( *(long*)param_1 + 0xe8 );
   if (*(code**)( *plVar21 + 0xf0 ) == TIntermTyped::getType) {
      if (pcVar24 == TIntermTyped::setType) goto LAB_00105f80;
      LAB_00106410:in_stack_ffffffffffffff10 = 0x106415;
      ( *pcVar24 )(param_1);
   }
 else {
      ...
      LAB_00105f80:lVar22 = *(long*)( pTVar20 + 0x18 );
      ...
      *(long*)( param_1 + 0xb0 ) = lVar22;
      ...
      param_1[0x2a] = ( TIntermBinary )((byte)TVar1 & 0x80 | bVar6 | bVar23 | (byte)TVar2 & 0x20 | (byte)pTVar20[10] & 0x40);
      *(ushort*)( param_1 + 0x2a ) = *(ushort*)( param_1 + 0x2a ) & 0xfc7f | *(ushort*)( pTVar20 + 10 ) & 0x380;
   ...
   *(ulong*)( pTVar14 + 8 ) = *(ulong*)( pTVar14 + 8 ) & 0x8000000400000000;
   ...
   if (*(code**)( lVar22 + 0x150 ) != TIntermTyped::isArray) {
      ...
      LAB_0010627e:uVar15 = 1;
      goto LAB_00106283;
   }

   if (plVar21[0x10] != 0) goto LAB_00106268;
   LAB_00106159:if (*(code**)( lVar22 + 0x100 ) != TIntermTyped::getBasicType) {
   ...
   LAB_0010617d:if (uVar12 == 0xe) goto LAB_00106268;
   if (0xb5 < uVar9) {
      if (uVar9 == 0x251) {
         switchD_001061c0_caseD_0:if (*(code**)( *plVar21 + 0x100 ) == TIntermTyped::getBasicType) {
            uVar12 = ( uint ) * (byte*)( plVar21 + 5 );
         }
 else {
            uVar12 = ( **(code**)( *plVar21 + 0x100 ) )(plVar21);
         ...
         if (uVar12 != 0xc) {
            ...
            if (uVar12 != 0xc) {
               ...
               LAB_0010656f:if (*(code**)( *plVar21 + 0x100 ) == TIntermTyped::getBasicType) {
                  uVar12 = ( uint ) * (byte*)( plVar21 + 5 );
               }
 else {
                  uVar12 = ( **(code**)( *plVar21 + 0x100 ) )(plVar21);
      ...
      LAB_001065a8:if (*(code**)( *plVar21 + 0xf0 ) != TIntermTyped::getType) {
         lVar22 = ( **(code**)( *plVar21 + 0xf0 ) )(plVar21);
         if (( ( *(byte*)( lVar22 + 10 ) & 0x20 ) != 0 ) || ( ( *(byte*)( lVar22 + 10 ) & 0x40 ) != 0 )) {
            lVar22 = *plVar21;
            LAB_00106f5e:if (*(code**)( lVar22 + 0xf0 ) == TIntermTyped::getType) {
         ...
         LAB_001065d0:if (*(code**)( *plVar16 + 0xf0 ) == TIntermTyped::getType) {
            plVar18 = plVar16 + 4;
         }
 else {
         ...
         lVar22 = *plVar21;
         if (( ( *(byte*)( (long)plVar18 + 10 ) & 0x20 ) != 0 ) || ( ( *(byte*)( (long)plVar18 + 10 ) & 0x40 ) != 0 )) goto LAB_00106f5e;
         ...
         if (*(code**)( *plVar21 + 0x158 ) == TIntermTyped::isVector) {
            ...
            LAB_00106682:cVar5 = ( **(code**)( *plVar16 + 0x158 ) )(plVar16);
            if (cVar5 != '\0') {
               iVar7 = ( **(code**)( *plVar21 + 0x130 ) )(plVar21);
               iVar8 = ( **(code**)( *plVar16 + 0x130 ) )(plVar16);
               if (( iVar7 != iVar8 ) && ( iVar7 = 1 < iVar7 )) goto switchD_00106721_caseD_24d;
            }

         }
 else {
            bVar6 = ( **(code**)( *plVar21 + 0x158 ) )(plVar21);
            LAB_0010734c:if (bVar6 != 0) goto LAB_00106682;
         }
...
LAB_00106c44:
      ...
      if (( bVar6 & 0x20 ) == 0) {
         ...
         LAB_00106d8f:plVar18 = plVar21 + 4;
         LAB_00106d99:if (( ( bVar6 >> 5 & 1 ) != 0 ) || ( ( *(byte*)( (long)plVar18 + 10 ) & 0x40 ) != 0 )) goto LAB_00106da3;
      }
 else {
         LAB_00106da3:if (*(code**)( *plVar16 + 0xf0 ) == TIntermTyped::getType) {
            if (( ( *(byte*)( (long)plVar16 + 0x2a ) & 0x20 ) != 0 ) || ( ( *(byte*)( (long)plVar16 + 0x2a ) & 0x40 ) != 0 )) {
               LAB_00106dc3:pTVar20 = (TType*)( plVar16 + 4 );
               LAB_00106dc7:if (*(code**)( *plVar21 + 0xf0 ) == TIntermTyped::getType) {
                  pTVar19 = (TType*)( plVar21 + 4 );
               }
 else {
                  pTVar19 = (TType*)( **(code**)( *plVar21 + 0xf0 ) )(plVar21);
      ...
      if (uVar9 == 0x9f) {
         LAB_00106f92:if (*(code**)( *plVar21 + 0xf0 ) == TIntermTyped::getType) {
            plVar21 = plVar21 + 4;
         }
 else {
         ...
         if (( ( *(byte*)( (long)plVar21 + 10 ) & 0x20 ) == 0 ) && ( ( *(byte*)( (long)plVar21 + 10 ) & 0x40 ) == 0 )) goto switchD_00106721_caseD_24d;
         ...
         LAB_00106e0b:if (*(code**)( *plVar21 + 0xf0 ) == TIntermTyped::getType) {
            plVar18 = plVar21 + 4;
         }
 else {
         ...
         if (( ( *(byte*)( (long)plVar18 + 10 ) & 0x20 ) == 0 ) && ( ( *(byte*)( (long)plVar18 + 10 ) & 0x40 ) == 0 )) {
            LAB_00106eab:uVar11 = 0xb2;
            if (uVar9 == 0x24c) {
               uVar11 = 0x24f;
            }

            *(undefined4*)( param_1 + 0xb8 ) = uVar11;
            LAB_00106ec5:if (pcVar24 == TIntermTyped::getType) {
               bVar6 = *(byte*)( (long)plVar16 + 0x2a );
               LAB_00106ed2:if (( bVar6 & 0x20 ) != 0) goto LAB_00107163;
               plVar21 = plVar16 + 4;
               LAB_00106ede:if (( *(byte*)( (long)plVar21 + 10 ) & 0x40 ) == 0) goto LAB_0010627e;
            }
 else {
            ...
            LAB_00107163:pcVar24 = *(code**)( *(long*)param_1 + 0xe8 );
            LAB_00106f06:pTVar20 = (TType*)( plVar16 + 4 );
         }
...
LAB_0010692e:
   ...
   switchD_00106721_caseD_24d:uVar15 = 0;
   LAB_00106283:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar15;
   }

   LAB_00106c7c:/* WARNING: Subroutine does not return */__stack_chk_fail();
   switchD_0010728d_caseD_9e:cVar5 = ( **(code**)( *plVar21 + 0x148 ) )(plVar21);
   if (( cVar5 == '\0' ) && ( cVar5 = ( **(code**)( *plVar16 + 0x148 ) )(plVar16) ),cVar5 != '\0') {
      cVar5 = ( **(code**)( *plVar21 + 0x158 ) )(plVar21);
      if (cVar5 == '\0') {
         *(undefined4*)( param_1 + 0xb8 ) = 0xb2;
         ...
         lVar22 = *plVar16;
         plVar21 = plVar16;
         LAB_00107568:uVar11 = ( **(code**)( lVar22 + 0x140 ) )(plVar21);
         ...
         *(undefined4*)( param_1 + 0xb8 ) = 0xb0;
         ...
         LAB_00107313:TType::TType(local_d8, uVar12, 0, uVar11, 0, 0, 0, pTVar20);
         ( *pcVar24 )(param_1, local_d8);
      }
...
/* glslang::TIntermediate::promoteAggregate(glslang::TIntermAggregate&) */undefined8 glslang::TIntermediate::promoteAggregate(TIntermediate *this, TIntermAggregate *param_1) {
...
/* glslang::TIntermBinary::updatePrecision() */void glslang::TIntermBinary::updatePrecision(TIntermBinary *this) {
   byte bVar1;
   int iVar2;
   uint uVar3;
   long lVar4;
   ...
   if (*(code**)( *(long*)this + 0x100 ) == TIntermTyped::getBasicType) {
      ...
      if (TVar6 != (TIntermBinary)0x8) {
         LAB_001077b3:uVar3 = (uint)(byte)TVar6;
         if (TVar6 != (TIntermBinary)0x9) {
            LAB_001077b8:if (uVar3 != 1) {
               return;
            }
   ...
   if (*(code**)( *(long*)this + 0x108 ) == TIntermTyped::getQualifier) {
      ...
      LAB_00107876:if (( (byte)this[0x3b] & 0xe ) == 0) {
         return;
      }
   ...
   pTVar7 = this + 0x30;
   LAB_00107896:( *UNRECOVERED_JUMPTABLE )(plVar5, (byte)pTVar7[0xb] >> 1 & 7);
...
/* glslang::TIntermediate::promoteConstantUnion(glslang::TBasicType, glslang::TIntermConstantUnion*)
   const */long *__thiscallglslang::TIntermediate::promoteConstantUnion(TIntermediate *this, undefined4 param_2, long *param_3) {
   double dVar1;
   byte bVar2;
   undefined1 uVar3;
   char cVar4;
...
switchD_00107cee_caseD_0:
 ...
 while ( iVar27 < iVar13 );
   ...
   LAB_00107bc3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_3;
   }
...
/* glslang::TIntermAggregate::setPragmaTable(glslang::TPragmaTable const&) */void glslang::TIntermAggregate::setPragmaTable(TIntermAggregate *this, TPragmaTable *param_1) {
   ...
   if (param_1 != pTVar4) {
      ...
      *(undefined8*)( pTVar4 + 0x30 ) = 0;
      ...
      if (p_Var2 != (_Rb_tree_node*)0x0) {
         p_Var6 = std::_Rb_tree<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::_Select1st<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>>,std::less<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>>>::_M_copy<false,std::_Rb_tree<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::_Select1st<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>>,std::less<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>>>::_Reuse_or_alloc_node>(p_Var2, p_Var1, (_Reuse_or_alloc_node*)local_38);
         p_Var2 = p_Var6;
         do {
            p_Var7 = p_Var2;
 ...
 while ( p_Var2 != (_Rb_tree_node*)0x0 );
         ...
         *(undefined8*)( pTVar4 + 0x30 ) = uVar5;
         for (lVar8 = local_38._0_8_; lVar8 != 0; lVar8 = *(long*)( lVar8 + 0x10 )) {
            std::_Rb_tree<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::_Select1st<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>>,std::less<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>>>::_M_erase(*(_Rb_tree_node**)( lVar8 + 0x18 ));
         }
...
/* glslang::TIntermediate::specConstantPropagates(glslang::TIntermTyped const&,
   glslang::TIntermTyped const&) */byte glslang::TIntermediate::specConstantPropagates(TIntermediate *this, TIntermTyped *param_1, TIntermTyped *param_2) {
   long lVar1;
   code *pcVar2;
   TIntermTyped *pTVar3;
   if (*(code**)( *(long*)param_1 + 0xf0 ) == TIntermTyped::getType) {
   ...
   lVar1 = *(long*)param_2;
   LAB_00109b52:pTVar3 = param_2 + 0x20;
   if (*(code**)( lVar1 + 0xf0 ) != TIntermTyped::getType) {
      pTVar3 = (TIntermTyped*)( **(code**)( lVar1 + 0xf0 ) )(param_2);
   }
...
/* glslang::TIntermediate::performTextureUpgradeAndSamplerRemovalTransformation(TIntermNode*) */void glslang::TIntermediate::performTextureUpgradeAndSamplerRemovalTransformation(TIntermediate *this, TIntermNode *param_1) {
   long in_FS_OFFSET;
   undefined **local_48;
   undefined4 local_40;
   undefined8 local_3c;
...
/* glslang::TIntermediate::getResourceName(glslang::TResourceType) */char *glslang::TIntermediate::getResourceName(undefined4 param_1) {
   switch (param_1) {
      case 0:
...
/* __gnu_cxx::__normal_iterator<glslang::TTypeLoc*, std::vector<glslang::TTypeLoc,
         ...
         do {
            ...
            if (*(code**)( *plVar1 + 0x128 ) == glslang::TType::isStruct) {
               if (( byte )(*(byte*)( plVar1 + 1 ) - 0xf) < 2) {
                  LAB_00109ead:lVar5 = *(long*)( plVar1[0xd] + 0x10 );
            ...
            if (*(code**)( *plVar1 + 0x128 ) == glslang::TType::isStruct) {
               if (( byte )(*(byte*)( plVar1 + 1 ) - 0xf) < 2) {
                  LAB_00109edd:lVar5 = *(long*)( plVar1[0xd] + 0x10 );
                  lVar4 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsBasicType(glslang::TBasicType)const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsBasicType (glslang::TBasicType)const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar5,param_3 ));
                  if (lVar5 != lVar4) {
                     LAB_00109efc:return param_1 + 4;
                  }
            ...
            if (*(code**)( *plVar1 + 0x128 ) == glslang::TType::isStruct) {
               if (( byte )(*(byte*)( plVar1 + 1 ) - 0xf) < 2) {
                  LAB_00109f15:lVar5 = *(long*)( plVar1[0xd] + 0x10 );
                  lVar4 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsBasicType(glslang::TBasicType)const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsBasicType (glslang::TBasicType)const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar5,param_3 ));
                  if (lVar5 != lVar4) {
                     LAB_00109f34:return param_1 + 8;
                  }
            ...
            if (*(code**)( *plVar1 + 0x128 ) == glslang::TType::isStruct) {
               if (( byte )(*(byte*)( plVar1 + 1 ) - 0xf) < 2) {
                  LAB_00109f4d:lVar5 = *(long*)( plVar1[0xd] + 0x10 );
                  lVar4 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsBasicType(glslang::TBasicType)const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsBasicType (glslang::TBasicType)const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar5,param_3 ));
                  if (lVar5 != lVar4) {
                     LAB_00109f6c:return param_1 + 0xc;
                  }
 ...
 while ( param_1 != puVar6 );
      ...
      param_1 = param_1 + 4;
      LAB_00109fc8:bVar3 = glslang::TType::contains<glslang::TType::containsBasicType(glslang::TBasicType)const::_lambda(glslang::TType_const*)_1_>((TType*)*param_1, param_3);
      if (!bVar3) {
         return param_2;
      }
...
, /* glslang::TIntermediate::addSymbol(glslang::TType const&, glslang::TSourceLoc const&) */, void __thiscall
glslang::TIntermediate::addSymbol(TIntermediate *this, TType * param_1, TSourceLoc * param_2) * *local_68 ;undefined8 local_60undefined8 local_58undefined1 *local_50undefined1 local_40[16]long local_30local_30 = *(long*)( in_FS_OFFSET + 0x28 );local_60 = 0;local_68 = &PTR__TConstUnionArray_00117de8;local_58 = glslang::GetThreadPoolAllocator();local_50 = local_40;std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_construct<char_const*>((basic_string*)&local_58, &_LC25, &_LC25);addSymbol(this, 0, (basic_string*)&local_58, param_1, (TConstUnionArray*)&local_68, (TIntermTyped*)0x0, param_2);if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* glslang::TIntermediate::addUnaryNode(glslang::TOperator, glslang::TIntermTyped*,
   glslang::TSourceLoc const&) const */long *__thiscallglslang::TIntermediate::addUnaryNode(undefined8 param_1, undefined4 param_2, undefined8 *param_3, long *param_4) {
   long lVar1;
   ulong uVar2;
   long *plVar3;
   uVar2 = glslang::GetThreadPoolAllocator();
   ...
   *(ulong*)( (long)plVar3 + 0x4d ) = ( ulong )(( uint ) * (undefined8*)( (long)plVar3 + 0x4d ) & 0xffc00f) | 0xffffffffff001fc0;
   *(undefined4*)( (long)plVar3 + 100 ) = 0xfffff800;
   *(ulong*)( (long)plVar3 + 0x55 ) = *(ulong*)( (long)plVar3 + 0x55 ) & 0xfe000000800000 | 0x1ffffff7fffff;
...
/* glslang::TIntermediate::addUnaryNode(glslang::TOperator, glslang::TIntermTyped*,
   glslang::TSourceLoc const&, glslang::TType const&) const */long *glslang::TIntermediate::addUnaryNode(void) {
   undefined1 uVar1;
   undefined4 uVar2;
   long lVar3;
   long lVar4;
   ...
   if (*(code**)( *plVar6 + 0xe8 ) == TIntermTyped::setType) {
      ...
      *(byte*)( (long)plVar6 + 0x2a ) = bVar8 & 0xc0 | bVar9 | bVar10 | bVar7;
      *(byte*)( (long)plVar6 + 0x2a ) = bVar8 & 0x80 | bVar9 | bVar10 | bVar7 | *(byte*)( in_R8 + 10 ) & 0x40;
      *(ushort*)( (long)plVar6 + 0x2a ) = *(ushort*)( (long)plVar6 + 0x2a ) & 0xfc7f | *(ushort*)( in_R8 + 10 ) & 0x380;
      *(byte*)( (long)plVar6 + 0x2b ) = *(byte*)( (long)plVar6 + 0x2b ) & 0xfb | *(byte*)( in_R8 + 0xb ) & 4;
      return plVar6;
   }
...
/* glslang::TIntermediate::createConversion(glslang::TBasicType, glslang::TIntermTyped*) const */TIntermOperator * __thiscall
glslang::TIntermediate::createConversion(TIntermediate *this,int param_2,long *param_3){
   ...
   if (*(code**)( lVar8 + 0x100 ) == TIntermTyped::getBasicType) {
      ...
      if ((char)param_3[5] != '\x04') {
         LAB_0010b154:if ((char)param_3[5] != '\x05') {
            LAB_0010b15b:if ((char)param_3[5] != '\x06') {
               LAB_0010b162:if ((char)param_3[5] != '\a') {
                  LAB_0010b169:if ((char)param_3[5] != '\b') {
                     LAB_0010b170:if ((char)param_3[5] != '\t') {
                        LAB_0010b177:uVar5 = ( uint ) * (byte*)( param_3 + 5 );
                        if (*(byte*)( param_3 + 5 ) != 10) {
                           LAB_0010b184:bVar15 = uVar5 == 0xb;
      ...
      LAB_0010b1b7:uVar5 = ( uint ) * (byte*)( param_3 + 5 );
   ...
   bVar15 = true;
   bVar14 = true;
   LAB_0010b58b:if (pcVar11 == TIntermTyped::getBasicType) {
      bVar1 = *(byte*)( param_3 + 5 );
      if (bVar1 == 3) goto LAB_0010b652;
      LAB_0010b64d:uVar5 = (uint)bVar1;
      if (bVar1 == 1) goto LAB_0010b652;
      LAB_0010b5db:bVar16 = uVar5 == 2;
   }
 else {
      iVar4 = ( *pcVar11 )(param_3);
      if (iVar4 != 3) {
      ...
      LAB_0010b652:bVar16 = true;
   }

   if (bVar14) {
      pcVar11 = *(code**)( *param_3 + 0x100 );
      if (pcVar11 == TIntermTyped::getBasicType) goto LAB_0010b1b7;
      LAB_0010b5fe:iVar4 = ( *pcVar11 )(param_3);
      if (iVar4 == 4) {
         LAB_0010b3a8:if (7 < uVar13) goto LAB_0010b3b2;
      }
 else {
         if (*(code**)( *param_3 + 0x100 ) == TIntermTyped::getBasicType) {
            uVar5 = ( uint ) * (byte*)( param_3 + 5 );
         ...
         LAB_0010b1c4:if (uVar5 == 5) goto LAB_0010b3a8;
      }

      if (( 1 < param_2 - 6U ) || ( bVar15 )) {
         LAB_0010b3c3:if (*(code**)( *param_3 + 0x100 ) != TIntermTyped::getBasicType) {
            iVar4 = ( **(code**)( *param_3 + 0x100 ) )(param_3);
            ...
            LAB_0010b3df:if (uVar5 == 7) goto LAB_0010b3e8;
            goto LAB_0010b1f6;
         }

         uVar5 = ( uint ) * (byte*)( param_3 + 5 );
         if (*(byte*)( param_3 + 5 ) != 6) goto LAB_0010b3df;
         LAB_0010b3e8:if (7 < uVar13) goto LAB_0010b1e6;
         if (!bVar16) goto LAB_0010b1ff;
         goto LAB_0010b400;
      }

      LAB_0010b1e6:if (( *(uint*)( this + 0x5c8 ) & 0x405 ) == 0) goto LAB_0010b488;
      LAB_0010b1f6:if (bVar16) {
         LAB_0010b400:if (*(code**)( *param_3 + 0x100 ) == TIntermTyped::getBasicType) {
            uVar5 = ( uint ) * (byte*)( param_3 + 5 );
         }
 else {
            uVar5 = ( **(code**)( *param_3 + 0x100 ) )(param_3);
         ...
         LAB_0010b1ff:if (param_2 != 3) goto LAB_0010b400;
         LAB_0010b209:if (( *(uint*)( this + 0x5c8 ) & 0x821 ) == 0) goto LAB_0010b488;
      }
      ...
      if (cVar3 != '\0') {
         ...
         if (( lVar8 != 0 ) && ( ( uVar5 = *(uint*)( this + 0x5c8 )(uVar5 & 1) != 0 || ( ( ( ( ( uVar5 & 2 ) != 0 || ( 1 < uVar13 ) ) && ( ( ( uVar5 & 0x404 ) != 0 || ( 1 < param_2 - 6U ) ) ) ) && ( ( ( uVar5 & 0x820 ) != 0 || ( param_2 != 3 ) ) ) ) ) ) )) {
         ...
         pTVar10 = pTVar7;
         if (( ( *(byte*)( (long)plVar9 + 0xc ) & 1 ) != 0 ) && ( cVar3 = isSpecializationOperation(this, pTVar7) ),cVar3 != '\0') {
      ...
      LAB_0010b3b2:if (( (byte)this[0x5c8] & 3 ) != 0) goto LAB_0010b3c3;
   }

   LAB_0010b488:pTVar10 = (TIntermOperator*)0x0;
   LAB_0010b37c:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* glslang::TIntermediate::addConversion(glslang::TBasicType, glslang::TIntermTyped*) const */void glslang::TIntermediate::addConversion(void) {
   createConversion();
   return;
}
/* glslang::TIntermediate::addPairConversion(glslang::TOperator, glslang::TIntermTyped*,
   glslang::TIntermTyped*) */undefined1(*)[16];glslang::TIntermediate::addPairConversion(undefined1 (*param_1)[16], TIntermediate *param_2, int param_3, long *param_4, long *param_5) {
   char cVar1;
   uint uVar2;
   uint uVar3;
   ulong uVar4;
   ...
   if (( cVar1 == '\0' ) || ( cVar1 = isConversionAllowed(param_2, param_3, param_5) ),cVar1 == '\0') goto LAB_0010b873;
   ...
   if (cVar1 == '\0') {
      if (*(code**)( *param_4 + 0x168 ) == TIntermTyped::isStruct) {
         if (1 < ( byte )((char)param_4[5] - 0xfU)) {
            LAB_0010b91f:if (*(code**)( *param_5 + 0x168 ) == TIntermTyped::isStruct) {
               if (1 < ( byte )((char)param_5[5] - 0xfU)) {
                  LAB_0010b942:plVar9 = param_4 + 4;
                  if (*(code**)( *param_4 + 0xf0 ) != TIntermTyped::getType) {
                  ...
                  if (*(code**)( *plVar9 + 0xe8 ) == TType::isArray) {
                     if (plVar9[0xc] == 0) {
                        LAB_0010b97f:if (*(code**)( *param_5 + 0xf0 ) == TIntermTyped::getType) {
                           plVar9 = param_5 + 4;
                        }
 else {
                        ...
                        if (*(code**)( *plVar9 + 0xe8 ) == TType::isArray) {
                           if (plVar9[0xc] == 0) {
                              LAB_0010b9b4:plVar9 = param_4 + 4;
                              if (*(code**)( *param_4 + 0xf0 ) != TIntermTyped::getType) {
                                 plVar9 = (long*)( **(code**)( *param_4 + 0xf0 ) )(param_4);
                              }

                              if (( ( *(byte*)( (long)plVar9 + 10 ) & 0x20 ) == 0 ) && ( ( *(byte*)( (long)plVar9 + 10 ) & 0x40 ) == 0 )) {
                                 if (*(code**)( *param_5 + 0xf0 ) == TIntermTyped::getType) {
                                    plVar9 = param_5 + 4;
                                 }
 else {
                                 ...
                                 if (( ( *(byte*)( (long)plVar9 + 10 ) & 0x20 ) == 0 ) && ( ( *(byte*)( (long)plVar9 + 10 ) & 0x40 ) == 0 )) goto LAB_0010ba10;
                              }
      ...
      LAB_0010b873:*param_1 = (undefined1[16])0x0;
   }
 else {
      LAB_0010ba10:if (param_3 == 1) {
         LAB_0010bab8:if (*(code**)( *param_4 + 0x100 ) == TIntermTyped::getBasicType) {
         ...
         if (*(code**)( *param_5 + 0x100 ) == TIntermTyped::getBasicType) {
            ...
            if (uVar3 != *(byte*)( param_5 + 5 )) {
               LAB_0010baf3:if (*(code**)( *param_4 + 0x100 ) == TIntermTyped::getBasicType) {
                  uVar3 = ( uint ) * (byte*)( param_4 + 5 );
               }
 else {
                  uVar3 = ( **(code**)( *param_4 + 0x100 ) )(param_4);
         ...
         LAB_0010bc38:if (*(code**)( *param_5 + 0xf0 ) == TIntermTyped::getType) {
            pTVar8 = (TType*)( param_5 + 4 );
         }
 else {
            pTVar8 = (TType*)( **(code**)( *param_5 + 0xf0 ) )(param_5);
         ...
         cVar1 = TType::operator ==(pTVar7, pTVar8);
         joined_r0x0010ba9c:if (cVar1 == '\0') goto LAB_0010b873;
      }

      LAB_0010baa8:*(long**)*param_1 = param_5;
...
/* WARNING: Type propagation algorithm not settling *//* glslang::TIntermediate::addConversion(glslang::TOperator, glslang::TType const&,
   glslang::TIntermTyped*) */long *__thiscallglslang::TIntermediate::addConversion(TIntermediate *this, ulong param_2, TType *param_3, long *param_4) {
   byte bVar1;
   char cVar2;
   uint uVar3;
   uint uVar4;
   ...
   if (( ( *(byte*)( (long)plVar8 + 10 ) & 0x20 ) == 0 ) && ( ( *(byte*)( (long)plVar8 + 10 ) & 0x40 ) == 0 )) {
      ...
      if (uVar3 < 0x1db) {
         ...
         if (( uVar5 & 1 ) == 0) {
            LAB_0010bfcd:if (*(code**)( *(long*)param_3 + 0x38 ) == TType::getBasicType) {
               uVar3 = (uint)(byte)param_3[8];
            }
 else {
               uVar3 = ( **(code**)( *(long*)param_3 + 0x38 ) )(param_3);
      ...
      if (uVar3 < 0x1e1) {
         ...
         joined_r0x0010c34f:if (bVar1 == 0) goto LAB_0010c268;
      }
      ...
      LAB_0010c05d:if (*(code**)( *(long*)param_3 + 0x38 ) == TType::getBasicType) {
         uVar3 = (uint)(byte)param_3[8];
      }
 else {
         uVar3 = ( **(code**)( *(long*)param_3 + 0x38 ) )(param_3);
      ...
      lVar6 = *param_4;
      if (uVar3 == 0x12) {
         LAB_0010c313:if (*(code**)( lVar6 + 0xf0 ) == TIntermTyped::getType) {
            pTVar9 = (TType*)( param_4 + 4 );
         }
 else {
   ...
   LAB_0010c144:lVar6 = ( **(code**)( *param_4 + 0x28 ) )(param_4);
   if (lVar6 != 0) {
   ...
   LAB_0010c268:if (*(code**)( *(long*)param_3 + 0x38 ) == TType::getBasicType) {
      uVar3 = (uint)(byte)param_3[8];
   }
 else {
      uVar3 = ( **(code**)( *(long*)param_3 + 0x38 ) )(param_3);
...
/* glslang::TIntermediate::promoteUnary(glslang::TIntermUnary&) */undefined8 glslang::TIntermediate::promoteUnary(TIntermediate *this, TIntermUnary *param_1) {
   TIntermUnary TVar1;
   code *pcVar2;
   long lVar3;
   uint uVar4;
   ...
   if (uVar4 == 0xb) {
      ...
      LAB_0010c5f1:lVar6 = *(long*)param_1;
      lVar13 = *plVar8;
   }
 else {
      if (0xb < uVar4) {
         if (uVar4 - 0xc < 4) goto LAB_0010c81a;
         LAB_0010c850:if (pcVar2 == TIntermTyped::getBasicType) {
      ...
      if (uVar4 == 8) {
         LAB_0010c81a:if (pcVar2 == TIntermTyped::getBasicType) {
            uVar10 = ( ulong ) * (byte*)( plVar8 + 5 );
         }
 else {
            uVar10 = ( *pcVar2 )(plVar8);
         ...
         if ((uint)uVar10 < 0xb) {
            if (( ( 0x550UL >> ( uVar10 & 0x3f ) & 1 ) == 0 ) && ( ( 0xaa0UL >> ( uVar10 & 0x3f ) & 1 ) == 0 )) {
               LAB_0010c949:if (*(code**)( lVar13 + 0x100 ) == TIntermTyped::getBasicType) {
                  bVar11 = *(byte*)( plVar8 + 5 );
                  if (bVar11 == 1) goto LAB_0010c846;
                  LAB_0010c96b:uVar4 = (uint)bVar11;
                  if (bVar11 == 3) {
                     lVar6 = *(long*)param_1;
                     goto LAB_0010c5f8;
                  }

                  LAB_0010c975:if (uVar4 != 2) {
                     uVar7 = 0;
                     goto LAB_0010c7e2;
                  }
         ...
         LAB_0010c846:lVar6 = *(long*)param_1;
      }
 else {
   ...
   if (*(code**)( lVar13 + 0xf0 ) == TIntermTyped::getType) {
      ...
      *(long*)( param_1 + 0xb0 ) = lVar13;
      ...
      param_1[0x2a] = ( TIntermUnary )((byte)TVar1 & 0x80 | bVar11 | bVar12 | bVar14 | *(byte*)( (long)plVar8 + 10 ) & 0x40);
      *(ushort*)( param_1 + 0x2a ) = *(ushort*)( param_1 + 0x2a ) & 0xfc7f | *(ushort*)( (long)plVar8 + 10 ) & 0x380;
   ...
   *(ulong*)( pTVar9 + 8 ) = *(ulong*)( pTVar9 + 8 ) & 0x800000141fff0000;
   uVar7 = 1;
   LAB_0010c7e2:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* glslang::TIntermediate::promote(glslang::TIntermOperator*) */undefined8 glslang::TIntermediate::promote(TIntermediate *this, TIntermOperator *param_1) {
   long lVar1;
   TIntermUnary *pTVar2;
   undefined8 uVar3;
...
/* glslang::TIntermediate::addUnaryMath(glslang::TOperator, glslang::TIntermTyped*,
   glslang::TSourceLoc const&) */TIntermOperator * __thiscall
glslang::TIntermediate::addUnaryMath
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (param_3 == (long*)0x0) {
      LAB_0010cdc0:pTVar5 = (TIntermOperator*)0x0;
   }
 else {
      if (*(code**)( *param_3 + 0xf0 ) == TIntermTyped::getType) {
         plVar7 = param_3 + 4;
      ...
      LAB_0010cc39:if (*(code**)( *param_3 + 0xf0 ) == TIntermTyped::getType) {
         plVar7 = param_3 + 4;
      }
 else {
         plVar7 = (long*)( **(code**)( *param_3 + 0xf0 ) )(param_3);
      ...
      LAB_0010cf00:bVar2 = ( *UNRECOVERED_JUMPTABLE )();
      LAB_0010cf02:if (bVar2 != 0) goto LAB_0010cdc0;
      switchD_0010cedd_caseD_1e6:pTVar5 = (TIntermOperator*)addUnaryNode(this, param_2, param_3, param_4);
      ...
      if (( ( *(byte*)( (long)plVar7 + 0xc ) & 1 ) != 0 ) && ( cVar1 = isSpecializationOperation(this, pTVar5) ),cVar1 != '\0') {
      ...
      if (( *(byte*)( (long)plVar7 + 0xc ) & 2 ) != 0) {
         ...
         if (uVar3 < 0x10) {
            ...
            LAB_0010d20a:if (*(code**)( *(long*)pTVar5 + 0xf8 ) == TIntermTyped::getWritableType) {
               pTVar8 = pTVar5 + 0x20;
            }
 else {
               pTVar8 = (TIntermOperator*)( **(code**)( *(long*)pTVar5 + 0xf8 ) )(pTVar5);
   ...
   LAB_0010cdc2:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return pTVar5;
   }

   LAB_0010d3ae:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* glslang::TIntermediate::setAggregateOperator(TIntermNode*, glslang::TOperator, glslang::TType
   const&, glslang::TSourceLoc const&) */void glslang::TIntermediate::setAggregateOperator(TIntermediate *this, long *param_1, undefined4 param_3, long param_4, long *param_5) {
   ...
   if (param_1 == (long*)0x0) {
      ...
      if (( this_00 == (TIntermAggregate*)0x0 ) || ( *(int*)( this_00 + 0xb8 ) != 0 )) {
         ...
         if (puVar4 == *(undefined8**)( this_00 + 0xd8 )) {
            std::vector<TIntermNode*,glslang::pool_allocator<TIntermNode*>>::_M_realloc_insert<TIntermNode*const&>((vector<TIntermNode*,glslang::pool_allocator<TIntermNode*>>*)( this_00 + 0xc0 ), puVar4, local_40);
         }
 else {
            *puVar4 = param_1;
   ...
   LAB_0010d467:if (*(code**)( lVar7 + 0xe8 ) == TIntermTyped::setType) {
      ...
      *(long*)( this_00 + 0xb0 ) = lVar7;
      ...
      this_00[0x2a] = ( TIntermAggregate )((byte)TVar1 & 0x80 | bVar9 | bVar10 | bVar11 | *(byte*)( param_4 + 10 ) & 0x40);
      *(ushort*)( this_00 + 0x2a ) = *(ushort*)( this_00 + 0x2a ) & 0xfc7f | *(ushort*)( param_4 + 10 ) & 0x380;
...
/* glslang::TIntermediate::addBuiltInFunctionCall(glslang::TSourceLoc const&, glslang::TOperator,
   bool, TIntermNode*, glslang::TType const&) */long glslang::TIntermediate::addBuiltInFunctionCall(TIntermediate *this, undefined8 param_1, ulong param_3, char param_4, long *param_5, undefined8 param_6) {
   long *plVar1;
   long lVar2;
   long *plVar3;
   if (param_4 == '\0') {
...
/* glslang::TIntermediate::addBinaryMath(glslang::TOperator, glslang::TIntermTyped*,
   glslang::TIntermTyped*, glslang::TSourceLoc const&) */TIntermOperator * __thiscall
glslang::TIntermediate::addBinaryMath
   ...
   do {
      ...
      if (1 < param_2 - 0x9cU) {
         LAB_0010d838:if (cVar1 != '\x12') {
            LAB_0010df56:if ((char)param_4[5] != '\x12') {
               LAB_0010df61:addPairConversion(&local_d8, this, param_2, param_3, param_4);
               if (( local_d0 != 0 ) && ( local_d8 != 0 )) {
                  ...
                  if (cVar1 != '\0') {
                     ...
                     if (( ( plVar7 != (long*)0x0 ) && ( lVar8 != 0 ) ) && ( pTVar9 = (TIntermOperator*)( **(code**)( *plVar7 + 0x180 ) )(plVar7, *(undefined4*)( pTVar6 + 0xb8 ), lVar8) ),pTVar9 != (TIntermOperator*)0x0) goto LAB_0010d84a;
                     lVar8 = *(long*)pTVar6;
 ...
 else if (( 0x1d < uVar2 - 0x9c ) || ( ( 0x3ffbcfffUL >> ( ( ulong )(uVar2 - 0x9c) & 0x3f ) & 1 ) == 0 )) goto LAB_0010d84a;
                     if (*(code**)( *(long*)pTVar6 + 0xf8 ) == TIntermTyped::getWritableType) {
                        pTVar6 = pTVar6 + 0x20;
                     }
 else {
      ...
      if (cVar1 == '\x12') {
         ...
         if (*(code**)( lVar8 + 0x1a8 ) == TType::containsUnsizedArray) {
            if (*(code**)( lVar8 + 0xf8 ) == TType::isUnsizedArray) {
               if (*(code**)( lVar8 + 0xe8 ) == TType::isArray) {
                  ...
                  LAB_0010d9c6:if (**(int**)( *(long*)( lVar4 + 8 ) + 8 ) == 0) goto LAB_0010d848;
               }
 else {
            ...
            LAB_0010d9dd:if (*(code**)( lVar8 + 0x128 ) == TType::isStruct) {
               if (( byte )((char)plVar7[1] - 0xfU) < 2) {
                  LAB_0010def1:lVar8 = *(long*)( plVar7[0xd] + 0x10 );
                  lVar4 = std::__find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsUnsizedArray()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsUnsizedArray ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar7[0xd] + 8 ),lVar8 ));
         ...
         if ((char)param_4[5] != '\x12') {
            LAB_0010d88c:if (param_2 != 0x9c) {
               LAB_0010df50:param_2 = 0x9d;
               goto LAB_0010df56;
            }

            if ((char)param_4[5] == '\x12') {
               LAB_0010d8ab:if (*(code**)( *param_3 + 0x100 ) == TIntermTyped::getBasicType) {
               ...
               if ((uint)uVar5 < 0xb) {
                  if (( ( 0x550UL >> ( uVar5 & 0x3f ) & 1 ) != 0 ) || ( ( 0xaa0UL >> ( uVar5 & 0x3f ) & 1 ) != 0 )) {
                     LAB_0010e209:if (*(code**)( *param_4 + 0xf0 ) == TIntermTyped::getType) {
            ...
            LAB_0010e45b:param_2 = 0x9c;
            goto LAB_0010df61;
         }

         LAB_0010db6e:if (*(code**)( *param_4 + 0xf0 ) == TIntermTyped::getType) {
            plVar7 = param_4 + 4;
         }
 else {
            plVar7 = (long*)( **(code**)( *param_4 + 0xf0 ) )(param_4);
         ...
         if (*(code**)( lVar8 + 0x1a8 ) == TType::containsUnsizedArray) {
            if (*(code**)( lVar8 + 0xf8 ) == TType::isUnsizedArray) {
               if (*(code**)( lVar8 + 0xe8 ) == TType::isArray) {
                  ...
                  LAB_0010dbe6:if (**(int**)( *(long*)( lVar4 + 8 ) + 8 ) == 0) goto LAB_0010d848;
               }
 else {
                  cVar1 = ( **(code**)( lVar8 + 0xe8 ) )(plVar7);
                  if (cVar1 != '\0') {
            ...
            LAB_0010dbfb:if (*(code**)( lVar8 + 0x128 ) == TType::isStruct) {
               if (1 < ( byte )((char)plVar7[1] - 0xfU)) goto LAB_0010da0f;
               LAB_0010dc22:lVar8 = *(long*)( plVar7[0xd] + 0x10 );
               lVar4 = std::__find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsUnsizedArray()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsUnsizedArray ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar7[0xd] + 8 ),lVar8 ));
               if (lVar8 != lVar4) goto LAB_0010d848;
            }
 else {
      ...
      LAB_0010da0f:if ((char)param_3[5] != '\x12') goto LAB_0010d88c;
      if (*(code**)( *param_4 + 0x100 ) == TIntermTyped::getBasicType) {
      ...
      if ((uint)uVar5 < 0xb) {
         if (( ( 0x550UL >> ( uVar5 & 0x3f ) & 1 ) == 0 ) && ( ( 0xaa0UL >> ( uVar5 & 0x3f ) & 1 ) == 0 )) goto LAB_0010dc57;
         LAB_0010da50:if (*(code**)( *param_3 + 0xf0 ) == TIntermTyped::getType) {
         ...
         LAB_0010db0f:uVar11 = addBinaryMath(this, param_2, uVar12, uVar11, param_5);
         if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      ...
      LAB_0010dc57:if (param_2 == 0x9c) {
         if ((char)param_4[5] == '\x12') goto LAB_0010d8ab;
         if ((char)param_3[5] != '\x12') goto LAB_0010e45b;
         LAB_0010d848:pTVar9 = (TIntermOperator*)0x0;
         LAB_0010d84a:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            return pTVar9;
         }

         LAB_0010e438:/* WARNING: Subroutine does not return */__stack_chk_fail();
      }
...
glslang::TIntermediate::addAssign
   ...
   do {
      ...
      while (true) {
         ...
         LAB_0010e6ac:plVar6 = (long*)( *pcVar5 )(param_3);
         pcVar5 = *(code**)( *plVar6 + 0x38 );
         if (pcVar5 == TType::getBasicType) break;
         LAB_0010e6c4:uVar3 = ( *pcVar5 )();
      }
;
   }
 while ( true );
}
/* glslang::TIntermediate::makeAggregate(glslang::TSourceLoc const&) */undefined8 * __thiscall
...
/* glslang::TIntermediate::makeAggregate(TIntermNode*, glslang::TSourceLoc const&) */long *__thiscallglslang::TIntermediate::makeAggregate(TIntermediate *this, TIntermNode *param_1, TSourceLoc *param_2) {
   undefined8 *puVar1;
   ulong uVar2;
   long *plVar3;
   long lVar4;
   ...
   *(undefined1(*) [16])( plVar3 + 0x10 ) = (undefined1[16])0x0;
   *(undefined1(*) [16])( plVar3 + 0x12 ) = (undefined1[16])0x0;
   *(uint*)( plVar3 + 5 ) = CONCAT22((short)( ( *(uint*)( plVar3 + 5 ) & 0xf80000ff ) >> 0x10 ), CONCAT11(1, (char)( *(uint*)( plVar3 + 5 ) & 0xf80000ff )));
   plVar3[0x17] = 0;
   ...
   *(undefined4*)( plVar3 + 0x2d ) = 0;
   if (puVar1 == (undefined8*)plVar3[0x1b]) {
      std::vector<TIntermNode*,glslang::pool_allocator<TIntermNode*>>::_M_realloc_insert<TIntermNode*const&>((vector<TIntermNode*,glslang::pool_allocator<TIntermNode*>>*)( plVar3 + 0x18 ), puVar1, &local_20, 0x10ea52);
   }
 else {
      *puVar1 = param_1;
...
/* glslang::TIntermediate::makeAggregate(TIntermNode*) */long *__thiscallglslang::TIntermediate::makeAggregate(TIntermediate *this, TIntermNode *param_1) {
   undefined8 *puVar1;
   code *pcVar2;
   ulong uVar3;
   long *plVar4;
   ...
   *(uint*)( plVar4 + 5 ) = CONCAT22((short)( ( *(uint*)( plVar4 + 5 ) & 0xf80000ff ) >> 0x10 ), CONCAT11(1, (char)( *(uint*)( plVar4 + 5 ) & 0xf80000ff )));
   plVar4[0x17] = 0;
   ...
   *(undefined4*)( plVar4 + 0x2d ) = 0;
   if (puVar1 == (undefined8*)plVar4[0x1b]) {
      std::vector<TIntermNode*,glslang::pool_allocator<TIntermNode*>>::_M_realloc_insert<TIntermNode*const&>((vector<TIntermNode*,glslang::pool_allocator<TIntermNode*>>*)( plVar4 + 0x18 ), puVar1, &local_20, 0x10eccf);
   }
 else {
      *puVar1 = param_1;
...
/* glslang::TIntermediate::addShapeConversion(glslang::TType const&, glslang::TIntermTyped*) */TIntermTyped * __thiscall
glslang::TIntermediate::addShapeConversion(TIntermediate *this,TType *param_1,TIntermTyped *param_2){
   ...
   if (pcVar1 == TType::isScalarOrVec1) {
      ...
      LAB_0010f258:if (*(code**)( *(long*)param_1 + 0xd8 ) == TType::isVector) {
      ...
      bVar3 = ( *pcVar1 )(pTVar7);
      LAB_0010f0e7:if (bVar3 != 0) goto LAB_0010f258;
   }
   ...
   if (*(code**)( *(long*)pTVar7 + 0xd8 ) == TType::isVector) {
      ...
      LAB_0010f12f:cVar2 = ( **(code**)( *(long*)param_1 + 0xc0 ) )(param_1);
      if (cVar2 != '\0') goto LAB_0010f282;
   }
 else {
      bVar3 = ( **(code**)( *(long*)pTVar7 + 0xd8 ) )();
      LAB_0010f2fa:if (bVar3 != 0) goto LAB_0010f12f;
   }
...
/* glslang::TIntermediate::growAggregate(TIntermNode*, TIntermNode*) */long *__thiscallglslang::TIntermediate::growAggregate(TIntermediate *this, TIntermNode *param_1, TIntermNode *param_2) {
   long *plVar1;
   ulong uVar2;
   long lVar3;
   ...
   if (param_1 == (TIntermNode*)0x0) {
      ...
      LAB_0010f4c9:uVar2 = glslang::GetThreadPoolAllocator();
      ...
      *(ushort*)( (long)plVar1 + 0x2a ) = *(ushort*)( (long)plVar1 + 0x2a ) & 0xf81f | local_b0._2_2_ & 0x7e0;
      ...
      *(undefined4*)( plVar1 + 0x2d ) = 0;
      if (param_1 != (TIntermNode*)0x0) {
         ...
         if (puVar5 == (undefined8*)plVar1[0x1b]) {
            std::vector<TIntermNode*,glslang::pool_allocator<TIntermNode*>>::_M_realloc_insert<TIntermNode*const&>((vector<TIntermNode*,glslang::pool_allocator<TIntermNode*>>*)( plVar1 + 0x18 ), puVar5, &local_c0);
         }
 else {
            *puVar5 = param_1;
   ...
   if (*(code**)( *plVar1 + 400 ) == TIntermAggregate::getSequence) {
      ...
      puVar5 = (undefined8*)plVar1[0x1a];
      if (puVar5 == (undefined8*)plVar1[0x1b]) {
         LAB_0010f6f6:std::vector<TIntermNode*,glslang::pool_allocator<TIntermNode*>>::_M_realloc_insert<TIntermNode*const&>(pvVar4, puVar5, &local_c8);
         goto LAB_0010f494;
      }

   }
 else {
      pvVar4 = (vector<TIntermNode*,glslang::pool_allocator<TIntermNode*>>*)( **(code**)( *plVar1 + 400 ) )(plVar1);
   ...
   *(undefined8**)( pvVar4 + 0x10 ) = puVar5 + 1;
   LAB_0010f494:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return plVar1;
   }
...
/* glslang::TIntermediate::growAggregate(TIntermNode*, TIntermNode*, glslang::TSourceLoc const&) */long *__thiscallglslang::TIntermediate::growAggregate(TIntermediate *this, TIntermNode *param_1, TIntermNode *param_2, TSourceLoc *param_3) {
   long lVar1;
   long *plVar2;
...
/* glslang::TIntermediate::addSymbolLinkageNode(glslang::TIntermAggregate*&, glslang::TSymbol
   const&) */void glslang::TIntermediate::addSymbolLinkageNode(TIntermediate *this, TIntermAggregate **param_1, TSymbol *param_2) {
   TVariable *pTVar1;
   TIntermNode *pTVar2;
...
/* glslang::TIntermediate::addSymbolLinkageNode(glslang::TIntermAggregate*&, glslang::TSymbolTable&,
   std::__cxx11::basic_string<char, std::char_traits<char>, glslang::std::allocator<char> > const&)
    */void glslang::TIntermediate::addSymbolLinkageNode(TIntermediate *this, TIntermAggregate **param_1, TSymbolTable *param_2, basic_string *param_3) {
   long *plVar1;
   long lVar2;
   void *__s2;
   ulong uVar3;
      ...
      if (plVar12 == (long*)0x0) {
         ...
         do {
            while (true) {
               ...
               if (uVar9 != 0) break;
               LAB_0010f8fc:lVar11 = uVar4 - uVar3;
               ...
               LAB_0010f91a:plVar5 = (long*)plVar12[2];
               plVar10 = plVar12;
               plVar12 = plVar5;
...
;
            ...
            LAB_0010f916:if (-1 < iVar6) goto LAB_0010f91a;
            LAB_0010f8d0:plVar12 = (long*)plVar12[3];
         }
 while ( plVar12 != (long*)0x0 );
         LAB_0010f926:bVar13 = true;
         if (plVar1 != plVar10) {
            uVar4 = plVar10[6];
            uVar9 = uVar3;
            if (uVar4 <= uVar3) {
            ...
            if (uVar9 == 0) {
               LAB_0010f960:lVar11 = uVar3 - uVar4;
               if (lVar11 < 0x80000000) {
               ...
               LAB_0010f97d:if (iVar6 < 0) goto LAB_0010f981;
            }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* glslang::TIntermediate::addSymbolLinkageNodes(glslang::TIntermAggregate*&, EShLanguage,
   glslang::TSymbolTable&) */void glslang::TIntermediate::addSymbolLinkageNodes(TIntermediate *this, TIntermAggregate **param_1, int param_3, TSymbolTable *param_4) {
   undefined1 *puVar1;
   undefined1 *puVar2;
   int iVar3;
   undefined8 uVar4;
   ...
   local_60 = local_50;
   std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_construct<char_const*>((basic_string*)&local_68, "gl_VertexID");
      ...
      *(undefined1*)( (long)__s2 + (long)local_70 ) = 0;
      ...
      if (pTVar10 == (TIntermediate*)0x0) {
         ...
         do {
            ...
            if (( puVar5 == (undefined1*)0x0 ) || ( iVar3 = iVar3 == 0 )) {
               ...
               LAB_0010fbe0:pTVar9 = *(TIntermediate**)( pTVar10 + 0x18 );
            }
 else {
               LAB_0010fc2d:if (iVar3 < 0) goto LAB_0010fbe0;
               LAB_0010fc31:pTVar9 = *(TIntermediate**)( pTVar10 + 0x10 );
               pTVar8 = pTVar10;
            }
 ...
 while ( pTVar9 != (TIntermediate*)0x0 );
         ...
         if (( puVar5 == (undefined1*)0x0 ) || ( iVar3 = iVar3 == 0 )) {
            ...
            LAB_0010fc9f:if (iVar3 < 0) goto LAB_0010fcd0;
         }
   ...
   local_68 = (undefined1**)glslang::GetThreadPoolAllocator();
   local_60 = local_50;
   std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_construct<char_const*>((basic_string*)&local_68, "gl_InstanceID");
   addSymbolLinkageNode(this, param_1, param_4, (basic_string*)&local_68);
   LAB_0010fa1f:pTVar7 = (TIntermNode*)*param_1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* glslang::TIntermediate::addForLoop(TIntermNode*, TIntermNode*, glslang::TIntermTyped*,
   glslang::TIntermTyped*, bool, glslang::TSourceLoc const&, glslang::TIntermLoop*&) */long *__thiscallglslang::TIntermediate::addForLoop(TIntermediate *this, TIntermNode *param_1, TIntermNode *param_2, TIntermTyped *param_3, TIntermTyped *param_4, bool param_5, TSourceLoc *param_6, TIntermLoop **param_7) {
   undefined8 uVar1;
   undefined8 uVar2;
   ulong uVar3;
   TIntermLoop *pTVar4;
   ...
   *(undefined8*)( pTVar4 + 0x18 ) = *(undefined8*)( param_6 + 0x10 );
   ...
   LAB_0010fdea:if (( pTVar6 != (TIntermNode*)0x0 ) && ( *(int*)( pTVar6 + 0xb8 ) - 1U < 2 )) {
...
/* glslang::TIntermediate::addSelection(glslang::TIntermTyped*, glslang::TIntermTyped*,
   glslang::TIntermTyped*, glslang::TSourceLoc const&) */TIntermNode * __thiscall
glslang::TIntermediate::addSelection
   ...
   if (( local_e0 == (TIntermNode*)0x0 ) || ( local_e8 == (TIntermNode*)0x0 )) {
      LAB_0011005f:local_e8 = (TIntermNode*)0x0;
   }
 else {
      if (*(code**)( *(long*)param_1 + 0xf0 ) == TIntermTyped::getType) {
      ...
      if (pcVar4 == TType::isScalarOrVec1) {
         ...
         LAB_00110090:if (*(code**)( *(long*)local_e0 + 0xf0 ) == TIntermTyped::getType) {
         ...
         if (( ( lVar10 == 0 ) || ( lVar10 = ( **(code**)( *(long*)local_e0 + 0x28 ) )(local_e0) ),lVar10 == 0 )) {
            ...
            *(long*)( pTVar11 + 0xb0 ) = lVar10;
            ...
            pTVar11[0x2a] = ( TIntermNode )((byte)TVar1 & 0x80 | bVar8 | bVar18 | (byte)TVar2 & 0x20 | (byte)pTVar13[10] & 0x40);
            *(ushort*)( pTVar11 + 0x2a ) = *(ushort*)( pTVar11 + 0x2a ) & 0xfc7f | *(ushort*)( pTVar13 + 10 ) & 0x380;
            TVar1 = pTVar13[0xb];
            ...
            *(long*)( pTVar11 + 0x18 ) = *(long*)( param_4 + 0x10 );
            if (*(code**)( *(long*)local_e8 + 0x108 ) == TIntermTyped::getQualifier) {
               ...
               pTVar13 = (TIntermNode*)( **(code**)( *(long*)local_e8 + 0x108 ) )(local_e8, uStack_100, (byte)TVar1 & 4, 0);
            }
            ...
            if (( ( ( (byte)pTVar16[8] & 0x7f ) == 2 ) || ( ( (byte)pTVar16[0xc] & 1 ) != 0 ) ) && ( cVar7 = specConstantPropagates(this, (TIntermTyped*)local_e0, (TIntermTyped*)local_e8) ),cVar7 != '\0') {
               LAB_001106cf:pTVar13 = pTVar11 + 0x30;
               if (*(code**)( *(long*)pTVar11 + 0x108 ) != TIntermTyped::getQualifier) {
               ...
               *(ulong*)( pTVar13 + 8 ) = *(ulong*)( pTVar13 + 8 ) & 0xfffffffeffffff80 | 0x100000002;
               ...
               if (( (byte)pTVar16[0xc] & 1 ) != 0) {
                  ...
                  if (( ( (byte)local_e0[8] & 0x7f ) == 2 ) || ( ( (byte)local_e0[0xc] & 1 ) != 0 )) {
                     ...
                     if (( ( (byte)local_e8[8] & 0x7f ) == 2 ) || ( ( (byte)local_e8[0xc] & 1 ) != 0 )) goto LAB_001106cf;
                  }
               ...
               *(long*)( pTVar13 + 0x40 ) = 0;
               *(long*)pTVar13 = 0;
               *(ulong*)( pTVar13 + 0x28 ) = ( ulong )(( uint ) * (long*)( pTVar13 + 0x28 ) & 0xfe000000) | 0x1ffffff;
         ...
         LAB_0010ff92:if (bVar8 != 0) goto LAB_00110090;
         if (*(code**)( *(long*)param_1 + 0xf0 ) == TIntermTyped::getType) {
            pTVar16 = param_1 + 0x20;
         }
 else {
         ...
         *(undefined8*)( this_00 + 0x18 ) = *(undefined8*)( param_4 + 0x10 );
         ...
         if (*(code**)( *(long*)local_e8 + 0xe8 ) == TIntermTyped::setType) {
            ...
            *(ushort*)( local_e8 + 0x2a ) = *(ushort*)( local_e8 + 0x2a ) & 0xf81f | local_d0._2_2_ & 0x7e0;
         }
 else {
   ...
   LAB_0011086a:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* glslang::TIntermediate::addComma(glslang::TIntermTyped*, glslang::TIntermTyped*,
   glslang::TSourceLoc const&) */long *__thiscallglslang::TIntermediate::addComma(TIntermediate *this, TIntermTyped *param_1, TIntermTyped *param_2, TSourceLoc *param_3) {
   TIntermTyped TVar1;
   byte bVar2;
   undefined4 uVar3;
   code *pcVar4;
   ...
   if (pcVar4 == TIntermTyped::setType) {
      ...
      *(byte*)( (long)plVar7 + 0x2a ) = bVar2 & 0x80 | bVar11 | bVar12 | (byte)TVar1 & 0x20 | (byte)pTVar10[10] & 0x40;
      *(ushort*)( (long)plVar7 + 0x2a ) = *(ushort*)( (long)plVar7 + 0x2a ) & 0xfc7f | *(ushort*)( pTVar10 + 10 ) & 0x380;
...
/* glslang::TIntermediate::mergeAggregate(TIntermNode*, TIntermNode*) */long *__thiscallglslang::TIntermediate::mergeAggregate(TIntermediate *this, TIntermNode *param_1, TIntermNode *param_2) {
   undefined8 *__src;
   undefined8 *__dest;
   undefined8 *puVar1;
   undefined8 *puVar2;
   ...
   if (param_1 == (TIntermNode*)0x0) {
      ...
      LAB_00110d59:uVar10 = glslang::GetThreadPoolAllocator();
      ...
      *(ushort*)( (long)plVar3 + 0x2a ) = *(ushort*)( (long)plVar3 + 0x2a ) & 0xf81f | local_d0._2_2_ & 0x7e0;
      *plVar3 = (long)&PTR_getLoc_00117e70;
      ...
      *(undefined4*)( plVar3 + 0x2d ) = 0;
      if (param_1 != (TIntermNode*)0x0) {
         ...
         if (puVar9 == (undefined8*)plVar3[0x1b]) {
            std::vector<TIntermNode*,glslang::pool_allocator<TIntermNode*>>::_M_realloc_insert<TIntermNode*const&>((vector<TIntermNode*,glslang::pool_allocator<TIntermNode*>>*)( plVar3 + 0x18 ), puVar9, &local_e0);
         }
 else {
            *puVar9 = param_1;
   ...
   if (( plVar4 == (long*)0x0 ) || ( (int)plVar4[0x17] != 0 )) {
      if (*(code**)( *plVar3 + 400 ) == TIntermAggregate::getSequence) {
         ...
         puVar9 = (undefined8*)plVar3[0x1a];
         if (puVar9 == (undefined8*)plVar3[0x1b]) {
            LAB_00111096:std::vector<TIntermNode*,glslang::pool_allocator<TIntermNode*>>::_M_realloc_insert<TIntermNode*const&>(pvVar5, puVar9, &local_e8);
            goto LAB_00110d1a;
         }

      }
 else {
         pvVar5 = (vector<TIntermNode*,glslang::pool_allocator<TIntermNode*>>*)( **(code**)( *plVar3 + 400 ) )(plVar3);
   ...
   if (*(code**)( *plVar4 + 400 ) == TIntermAggregate::getSequence) {
      ...
      LAB_00110c14:plVar4 = plVar4 + 0x18;
   }
 else {
 ...
 while ( lVar7 != (long)puVar2 - (long)__dest );
   ...
   if (( ulong )((long)puVar2 - (long)puVar1) < uVar8) {
      ...
      LAB_00110fb3:uVar8 = glslang::TPoolAllocator::allocate(*puVar6);
      uVar10 = uVar8 + lVar7;
   }
 ...
 while ( (long)puVar2 - (long)__dest != lVar7 );
   ...
   puVar6[2] = uVar12;
   puVar6[3] = uVar10;
   LAB_00110d1a:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* glslang::TIntermediate::mergeAggregate(TIntermNode*, TIntermNode*, glslang::TSourceLoc const&) */long *__thiscallglslang::TIntermediate::mergeAggregate(TIntermediate *this, TIntermNode *param_1, TIntermNode *param_2, TSourceLoc *param_3) {
   long lVar1;
   long *plVar2;
...
/* TIntermNode::setLoc(glslang::TSourceLoc const&) */void TIntermNode::setLoc(TIntermNode *this, TSourceLoc *param_1) {
   undefined8 uVar1;
   uVar1 = *(undefined8*)( param_1 + 8 );
...
/* TIntermNode::getAsOperator() */undefined8 TIntermNode::getAsOperator(void) {
   return 0;
}
/* TIntermNode::getAsConstantUnion() */undefined8 TIntermNode::getAsConstantUnion(void) {
   return 0;
}
/* TIntermNode::getAsAggregate() */undefined8 TIntermNode::getAsAggregate(void) {
   return 0;
}
/* TIntermNode::getAsUnaryNode() */undefined8 TIntermNode::getAsUnaryNode(void) {
   return 0;
}
/* TIntermNode::getAsBinaryNode() */undefined8 TIntermNode::getAsBinaryNode(void) {
   return 0;
}
/* TIntermNode::getAsSelectionNode() */undefined8 TIntermNode::getAsSelectionNode(void) {
   return 0;
}
/* TIntermNode::getAsSwitchNode() */undefined8 TIntermNode::getAsSwitchNode(void) {
   return 0;
}
/* TIntermNode::getAsMethodNode() */undefined8 TIntermNode::getAsMethodNode(void) {
   return 0;
}
/* TIntermNode::getAsSymbolNode() */undefined8 TIntermNode::getAsSymbolNode(void) {
   return 0;
}
/* TIntermNode::getAsBranchNode() */undefined8 TIntermNode::getAsBranchNode(void) {
   return 0;
}
/* TIntermNode::getAsLoopNode() */undefined8 TIntermNode::getAsLoopNode(void) {
   return 0;
}
/* TIntermNode::getAsOperator() const */undefined8 TIntermNode::getAsOperator(void) {
   return 0;
}
/* TIntermNode::getAsConstantUnion() const */undefined8 TIntermNode::getAsConstantUnion(void) {
   return 0;
}
/* TIntermNode::getAsAggregate() const */undefined8 TIntermNode::getAsAggregate(void) {
   return 0;
}
/* TIntermNode::getAsUnaryNode() const */undefined8 TIntermNode::getAsUnaryNode(void) {
   return 0;
}
/* TIntermNode::getAsBinaryNode() const */undefined8 TIntermNode::getAsBinaryNode(void) {
   return 0;
}
/* TIntermNode::getAsSelectionNode() const */undefined8 TIntermNode::getAsSelectionNode(void) {
   return 0;
}
/* TIntermNode::getAsSwitchNode() const */undefined8 TIntermNode::getAsSwitchNode(void) {
   return 0;
}
/* TIntermNode::getAsMethodNode() const */undefined8 TIntermNode::getAsMethodNode(void) {
   return 0;
}
/* TIntermNode::getAsSymbolNode() const */undefined8 TIntermNode::getAsSymbolNode(void) {
   return 0;
}
/* TIntermNode::getAsBranchNode() const */undefined8 TIntermNode::getAsBranchNode(void) {
   return 0;
}
/* TIntermNode::getAsLoopNode() const */undefined8 TIntermNode::getAsLoopNode(void) {
   return 0;
}
/* glslang::TIntermTyped::getAsTyped() */TIntermTyped * __thiscall glslang::TIntermTyped::getAsTyped(TIntermTyped *this){
   return this;
}
/* glslang::TIntermTyped::getAsTyped() const */TIntermTyped * __thiscall glslang::TIntermTyped::getAsTyped(TIntermTyped *this){
   return this;
}
...
/* glslang::TIntermTyped::getArraySizes() */undefined8 glslang::TIntermTyped::getArraySizes(TIntermTyped *this) {
   return *(undefined8*)( this + 0x80 );
}
/* glslang::TIntermTyped::getArraySizes() const */undefined8 glslang::TIntermTyped::getArraySizes(TIntermTyped *this) {
   return *(undefined8*)( this + 0x80 );
}
/* glslang::TIntermTyped::getVectorSize() const */byte glslang::TIntermTyped::getVectorSize(TIntermTyped *this) {
   return (byte)this[0x29] & 0xf;
}
/* glslang::TIntermTyped::getMatrixCols() const */byte glslang::TIntermTyped::getMatrixCols(TIntermTyped *this) {
   return (byte)this[0x29] >> 4;
}
/* glslang::TIntermTyped::getMatrixRows() const */byte glslang::TIntermTyped::getMatrixRows(TIntermTyped *this) {
   return (byte)this[0x2a] & 0xf;
}
/* glslang::TIntermTyped::isMatrix() const */bool glslang::TIntermTyped::isMatrix(TIntermTyped *this) {
...
/* glslang::TIntermTyped::isVector() const */byte glslang::TIntermTyped::isVector(TIntermTyped *this) {
...
/* glslang::TIntermTyped::isStruct() const */undefined4 glslang::TIntermTyped::isStruct(TIntermTyped *this) {
   return CONCAT31(( int3 )((byte)this[0x28] - 0xf >> 8), ( byte )((byte)this[0x28] - 0xf) < 2);
}
/* glslang::TIntermTyped::isFloatingDomain() const */undefined4 glslang::TIntermTyped::isFloatingDomain(TIntermTyped *this) {
   return CONCAT31(( int3 )((byte)this[0x28] - 1 >> 8), ( byte )((byte)this[0x28] - 1) < 3);
}
/* glslang::TIntermTyped::isIntegerDomain() const */bool glslang::TIntermTyped::isIntegerDomain(TIntermTyped *this) {
   TIntermTyped TVar1;
   TVar1 = this[0x28];
   if ((byte)TVar1 < 0xc) {
      return 3 < (byte)TVar1;
...
/* glslang::TIntermOperator::getAsOperator() const */TIntermOperator * __thiscall glslang::TIntermOperator::getAsOperator(TIntermOperator *this){
   return this;
}
/* glslang::TIntermBinary::setLeft(glslang::TIntermTyped*) */void glslang::TIntermBinary::setLeft(TIntermBinary *this, TIntermTyped *param_1) {
   *(TIntermTyped**)( this + 0xc0 ) = param_1;
   return;
}
/* glslang::TIntermBinary::setRight(glslang::TIntermTyped*) */void glslang::TIntermBinary::setRight(TIntermBinary *this, TIntermTyped *param_1) {
...
/* glslang::TIntermUnary::setOperand(glslang::TIntermTyped*) */void glslang::TIntermUnary::setOperand(TIntermUnary *this, TIntermTyped *param_1) {
   *(TIntermTyped**)( this + 0xc0 ) = param_1;
   return;
}
...
/* glslang::TIntermAggregate::getAsAggregate() */TIntermAggregate * __thiscall glslang::TIntermAggregate::getAsAggregate(TIntermAggregate *this){
   return this;
}
/* glslang::TIntermAggregate::getAsAggregate() const */TIntermAggregate * __thiscall glslang::TIntermAggregate::getAsAggregate(TIntermAggregate *this){
   return this;
}
/* glslang::TIntermAggregate::setOperator(glslang::TOperator) */void glslang::TIntermAggregate::setOperator(TIntermAggregate *this, undefined4 param_2) {
...
/* glslang::TIntermAggregate::getSequence() const */TIntermAggregate * __thiscall glslang::TIntermAggregate::getSequence(TIntermAggregate *this){
   return this + 0xc0;
}
...
/* glslang::TIntermAggregate::setUserDefined() */void glslang::TIntermAggregate::setUserDefined(TIntermAggregate *this) {
   this[0x128] = (TIntermAggregate)0x1;
   return;
}
/* glslang::TIntermAggregate::isUserDefined() */TIntermAggregate glslang::TIntermAggregate::isUserDefined(TIntermAggregate *this) {
   return this[0x128];
}
/* glslang::TIntermAggregate::getQualifierList() */TIntermAggregate * __thiscall glslang::TIntermAggregate::getQualifierList(TIntermAggregate *this){
   return this + 0xe0;
}
/* glslang::TIntermAggregate::getQualifierList() const */TIntermAggregate * __thiscall glslang::TIntermAggregate::getQualifierList(TIntermAggregate *this){
   return this + 0xe0;
}
...
/* glslang::TextureUpgradeAndSamplerRemovalTransform::~TextureUpgradeAndSamplerRemovalTransform() */void glslang::TextureUpgradeAndSamplerRemovalTransform::~TextureUpgradeAndSamplerRemovalTransform(TextureUpgradeAndSamplerRemovalTransform *this) {
   return;
}
...
/* glslang::TextureUpgradeAndSamplerRemovalTransform::visitSymbol(glslang::TIntermSymbol*) */void glslang::TextureUpgradeAndSamplerRemovalTransform::visitSymbol(TextureUpgradeAndSamplerRemovalTransform *this, TIntermSymbol *param_1) {
   uint uVar1;
   ...
   if (bVar1 == 0) {
      ...
      if (*(code**)( lVar4 + 0x128 ) == isStruct) {
         if (1 < ( byte )((char)this[8] - 0xfU)) {
            LAB_00112921:if (*(code**)( lVar4 + 0xe8 ) == isArray) {
...
/* glslang::TIntermTyped::setType(glslang::TType const&) */void glslang::TIntermTyped::setType(TIntermTyped *this, TType *param_1) {
   TType TVar1;
   TIntermTyped TVar2;
   undefined4 uVar3;
   undefined8 uVar4;
...
/* glslang::TIntermAggregate::~TIntermAggregate() */void glslang::TIntermAggregate::~TIntermAggregate(TIntermAggregate *this) {
   long lVar1;
   *(undefined***)this = &PTR_getLoc_00117e70;
   if (( *(long*)( this + 0x130 ) != 0 ) && ( lVar1 = lVar1 != 0 )) {
      do {
...
/* __gnu_cxx::__normal_iterator<glslang::TTypeLoc*, std::vector<glslang::TTypeLoc,
   ...
   if (0 < lVar6 >> 7) {
      ...
      do {
         ...
         if (*(code**)( *plVar2 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )(bVar1 - 0xf) < 2) {
               LAB_00112f5d:lVar6 = *(long*)( plVar2[0xd] + 0x10 );
         ...
         if (*(code**)( *plVar2 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )(bVar1 - 0xf) < 2) {
               LAB_00112f9d:lVar6 = *(long*)( plVar2[0xd] + 0x10 );
               lVar5 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsNonOpaque()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsNonOpaque ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar2[0xd] + 8 ),lVar6 ));
               if (lVar6 != lVar5) {
                  LAB_00112e5f:return param_1 + 4;
               }
         ...
         if (*(code**)( *plVar2 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )(bVar1 - 0xf) < 2) {
               LAB_00112fcd:lVar6 = *(long*)( plVar2[0xd] + 0x10 );
               lVar5 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsNonOpaque()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsNonOpaque ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar2[0xd] + 8 ),lVar6 ));
               if (lVar6 != lVar5) {
                  LAB_00112e9f:return param_1 + 8;
               }
         ...
         if (*(code**)( *plVar2 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )(bVar1 - 0xf) < 2) {
               LAB_00112ffd:lVar6 = *(long*)( plVar2[0xd] + 0x10 );
               lVar5 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsNonOpaque()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsNonOpaque ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar2[0xd] + 8 ),lVar6 ));
               if (lVar6 != lVar5) {
                  LAB_00112edf:return param_1 + 0xc;
               }
 ...
 while ( param_1 != plVar7 );
   ...
   param_1 = param_1 + 4;
   LAB_00113047:bVar4 = glslang::TType::contains<glslang::TType::containsNonOpaque()const::_lambda(glslang::TType_const*)_1_>(*param_1);
   if (!bVar4) {
      return param_2;
   }
...

{
  ...
  if (*(code **)(*param_1 + 0x128) == isStruct) {
    if ((byte)(bVar1 - 0xf) < 2) {
LAB_001130b8: ) = *(int**)( lVar2 + 8 ) ;iVar13 = (int)( *(long*)( lVar2 + 0x10 ) - (long)piVar17 >> 4 );if (iVar13 < 1) {
   iVar18 = 1;
}
 else {
   piVar1 = piVar17 + 4;
   iVar18 = 1;
   if (( (int)( piVar1 + ( ulong )(iVar13 - 1) * 4 ) - (int)piVar17 & 0x10U ) == 0) goto LAB_001146ed;
   iVar18 = *piVar17;
   for (piVar17 = piVar1; piVar17 != piVar1 + ( ulong )(iVar13 - 1) * 4; piVar17 = piVar17 + 8) {
      LAB_001146ed:iVar18 = iVar18 * *piVar17 * piVar17[4];
   }

}
uVar11 = uVar11 * iVar18;}uVar10 = uVar10 + uVar11;plVar21 = plVar21 + 4;}while (*(long**)( *(long*)( this + 0x68 ) + 0x10 ) != plVar21) ;;;}LAB_001145a4:if (( *(long*)( this + 0x60 ) != 0 ) && ( lVar2 = lVar2 != 0 )) {
   piVar17 = *(int**)( lVar2 + 8 );
   ...
   if (iVar13 < 1) {
      ...
      iVar18 = *piVar17;
      for (piVar17 = piVar1; piVar17 != piVar1 + ( ulong )(iVar13 - 1) * 4; piVar17 = piVar17 + 8) {
         LAB_001145f5:iVar18 = iVar18 * *piVar17 * piVar17[4];
      }
...
return uVar10;}/* glslang::TType::TEMPNAMEPLACEHOLDERVALUE(glslang::TType const&) const */ulong glslang::TType::operator ==(TType *this, TType *param_1) {
   TType TVar1;
   TType TVar2;
   long lVar3;
   int *piVar4;
   ...
   if (uVar11 == 0x12) {
      LAB_0011530c:if (( *(TType**)( this + 0x68 ) != *(TType**)( param_1 + 0x68 ) ) && ( cVar8 = operator == ( *(TType**)( this + 0x68 ),*(TType**)( param_1 + 0x68 ) ) ),cVar8 == '\0') {
         return 0;
      }
   ...
   if (lVar12 == 0) {
      ...
      if (lVar3 == 0) {
         ...
         if ((long)piVar4 - (long)piVar19 == *(long*)( lVar16 + 0x10 ) - (long)piVar20) {
            for (; piVar19 != piVar4; piVar19 = piVar19 + 4) {
               if (*piVar19 != *piVar20) {
                  LAB_001156e0:lVar12 = *(long*)( this + 0x60 );
                  goto LAB_00115378;
               }
               ...
               if (plVar14 != (long*)0x0) {
                  if (( ( plVar13 != (long*)0x0 ) && ( lVar12 = ( **(code**)( *plVar14 + 0x60 ) )(plVar14) ),lVar12 != 0 )) {
               ...
               LAB_001156ee:piVar20 = piVar20 + 4;
            }
      ...
      LAB_00115378:if (*(char*)( lVar12 + 0x14 ) == '\0') {
         return 0;
      }
   ...
   LAB_001153a8:piVar4 = *(int**)( this + 0x88 );
   ...
   if (piVar4 == (int*)0x0) {
      ...
      if (( *piVar4 == 0x16 ) && ( cVar8 = TSpirvType::operator ==(*(TSpirvType**)( piVar4 + 4 ), *(TSpirvType**)( piVar19 + 4 )) ),cVar8 == '\0') {
         return 0;
      }
   ...
   if (( ( *(ushort*)( this + 10 ) ^ *(ushort*)( param_1 + 10 ) ) & 0x380 ) == 0) {
      ...
      if (lVar16 == 0) {
         return (ulong)CONCAT11((char)( ( *(ushort*)( this + 10 ) ^ *(ushort*)( param_1 + 10 ) ) >> 8 ), lVar12 == 0);
      }

      if (( lVar12 != 0 ) && ( __n = *(size_t*)( lVar16 + 0x10 ) ),__n == *(size_t*)( lVar12 + 0x10 )) {
         if (( ( __n == 0 ) || ( iVar9 = memcmp(*(void**)( lVar16 + 8 ), *(void**)( lVar12 + 8 ), __n) ),iVar9 == 0 )) {
...
/* WARNING: Type propagation algorithm not settling *//* glslang::TType::sameStructType(glslang::TType const&, int*, int*) const */undefined8 glslang::TType::sameStructType(TType *this, TType *param_1, int *param_2, int *param_3) {
   size_t sVar1;
   bool bVar2;
   TType TVar3;
   char cVar4;
   ...
   if (*(code**)( *(long*)this + 0x128 ) != isStruct) {
      ...
      if (cVar4 == '\0') {
         ...
         LAB_0011583a:if (1 < ( byte )((char)param_1[8] - 0xfU)) {
            return 1;
         }

      }

      LAB_0011584a:if (*(code**)( *(long*)this + 0x128 ) == isStruct) {
         TVar3 = this[8];
         goto LAB_00115862;
      }
   ...
   if (1 < ( byte )((char)TVar3 - 0xfU)) {
      ...
      LAB_00115b88:cVar4 = ( *pcVar6 )(param_1);
      if (cVar4 == '\0') {
         return 1;
      }
   ...
   LAB_00115862:if (( byte )((char)TVar3 - 0xfU) < 2) {
      LAB_0011586a:if (*(code**)( *(long*)param_1 + 0x128 ) == isStruct) {
         if (( byte )((char)param_1[8] - 0xfU) < 2) {
            LAB_001158f0:if (*(long*)( this + 0x68 ) == *(long*)( param_1 + 0x68 )) {
               return 1;
            }
      ...
      LAB_00115885:if (*(code**)( *(long*)this + 0x128 ) == isStruct) {
         TVar3 = this[8];
         goto LAB_0011589d;
      }
      ...
      LAB_0011589d:if (1 < ( byte )((char)TVar3 - 0xfU)) {
         return 0;
      }

      pcVar6 = *(code**)( *(long*)param_1 + 0x128 );
      if (pcVar6 != isStruct) {
         LAB_00115b70:cVar4 = ( *pcVar6 )(param_1);
         if (cVar4 == '\0') {
            return 0;
         }
   ...
   LAB_001158c3:sVar1 = *(size_t*)( *(long*)( this + 0x78 ) + 0x10 );
   if (sVar1 == *(size_t*)( *(long*)( param_1 + 0x78 ) + 0x10 )) {
      ...
      if (( ( param_2 != (int*)0x0 ) || ( lVar16 - lVar8 == lVar7 - lVar12 ) ) || ( bVar2 )) {
         uVar10 = 0;
         uVar11 = 0;
         LAB_001159a0:uVar13 = lVar16 - lVar8 >> 5;
         if (uVar11 < ( ulong )(lVar7 - lVar12 >> 5)) {
            ...
            if (uVar13 <= uVar10) {
               ...
               if (pcVar6 == hiddenMember) {
                  ...
                  LAB_00115c7f:lVar9 = plVar14[0xe];
                  lVar12 = *(long*)( lVar9 + 0x10 );
               }

               if (lVar12 == 0x16) {
                  plVar14 = *(long**)( lVar9 + 8 );
                  if (( *plVar14 != 0x6e6f6365535f6c67 || plVar14[1] != 0x69736f5079726164 ) || ( *(long*)( (long)plVar14 + 0xe ) != 0x564e6e6f69746973 )) goto LAB_00115cc0;
               }
                  ...
                  LAB_00115cc0:if (param_2 == (int*)0x0) {
                     return 0;
                  }
            ...
            if (*(code**)( *(long*)this_00 + 0x18 ) == hiddenMember) {
               ...
               LAB_00115f20:lVar7 = *(long*)( lVar9 + 0x10 );
               uVar11 = uVar11 + 1;
               lVar16 = *(long*)( *(long*)( param_1 + 0x68 ) + 0x10 );
               lVar8 = *(long*)( *(long*)( param_1 + 0x68 ) + 8 );
               goto LAB_001159a0;
            ...
            LAB_00115a4e:lVar12 = *(long*)( param_1 + 0x68 );
            lVar8 = *(long*)( lVar12 + 8 );
            pcVar6 = *(code**)( **(long**)( lVar8 + lVar16 ) + 0x18 );
            if (pcVar6 == hiddenMember) {
               if ((char)( *(long**)( lVar8 + lVar16 ) )[1] == '\0') {
                  LAB_00115fe0:lVar9 = *(long*)( this + 0x68 );
            ...
            if (*(long*)( lVar9 + 0x10 ) == 0x16) {
               plVar14 = *(long**)( lVar9 + 8 );
               if (( *plVar14 == 0x6e6f6365535f6c67 && plVar14[1] == 0x69736f5079726164 ) && ( *(long*)( (long)plVar14 + 0xe ) == 0x564e6e6f69746973 )) goto LAB_00115d6a;
               LAB_00115ae8:lVar12 = *(long*)( param_1 + 0x68 );
               lVar8 = *(long*)( lVar12 + 8 );
               pcVar6 = *(code**)( **(long**)( lVar8 + lVar16 ) + 0x30 );
               if (pcVar6 == getFieldName_abi_cxx11_) {
               ...
               if (*(long*)( lVar15 + 0x10 ) == 0x16) {
                  ...
                  if (( *plVar14 == 0x6e6f6365535f6c67 && plVar14[1] == 0x69736f5079726164 ) && ( *(long*)( (long)plVar14 + 0xe ) == 0x564e6e6f69746973 )) goto LAB_001159a0;
               }
 else if (( *(long*)( lVar15 + 0x10 ) == 0x14 ) && ( ( plVar14 = *(long**)( lVar15 + 8 ) * plVar14 == 0x7469736f505f6c67 && plVar14[1] == 0x69567265506e6f69 && ( (int)plVar14[2] == 0x564e7765 ) ) )) goto LAB_001159a0;
               uVar11 = uVar11 + 1;
               goto LAB_001159a0;
            }

            if (( ( *(long*)( lVar9 + 0x10 ) != 0x14 ) || ( plVar14 = *(long**)( lVar9 + 8 ) * plVar14 != 0x7469736f505f6c67 || plVar14[1] != 0x69567265506e6f69 ) ) || ( (int)plVar14[2] != 0x564e7765 )) goto LAB_00115ae8;
         }
 else {
            if (uVar13 <= uVar10) {
               return 1;
            ...
            if (pcVar6 == hiddenMember) {
               ...
               LAB_00115bf1:lVar9 = plVar14[0xe];
               lVar12 = *(long*)( lVar9 + 0x10 );
            }

            if (lVar12 == 0x16) {
               plVar14 = *(long**)( lVar9 + 8 );
               if (( *plVar14 != 0x6e6f6365535f6c67 || plVar14[1] != 0x69736f5079726164 ) || ( *(long*)( (long)plVar14 + 0xe ) != 0x564e6e6f69746973 )) goto LAB_00115c38;
            }
 else if (( lVar12 != 0x14 ) || ( ( plVar14 = *(long**)( lVar9 + 8 ) * plVar14 != 0x7469736f505f6c67 || plVar14[1] != 0x69567265506e6f69 || ( (int)plVar14[2] != 0x564e7765 ) ) )) {
               LAB_00115c38:if (param_2 == (int*)0x0) {
                  return 0;
               }
            ...
            LAB_00115d62:uVar10 = uVar10 + 1;
         }

         LAB_00115d6a:uVar11 = uVar11 + 1;
         lVar9 = *(long*)( this + 0x68 );
         lVar7 = *(long*)( lVar9 + 0x10 );
         lVar16 = *(long*)( *(long*)( param_1 + 0x68 ) + 0x10 );
         lVar12 = *(long*)( lVar9 + 8 );
...
/* glslang::TIntermediate::IsRequestedExtension(char const*) const */uint glslang::TIntermediate::IsRequestedExtension(TIntermediate *this, char *param_1) {
   ...
   if (__n < 0x10) {
      ...
      local_58[0] = local_70;
      psVar7 = local_68;
      LAB_001163a6:memcpy(psVar7, param_1, __n);
      psVar7 = local_68;
   }
   ...
   if (pTVar10 == (TIntermediate*)0x0) {
      ...
      do {
         while (true) {
            ...
            if (( uVar8 != 0 ) && ( iVar4 = iVar4 != 0 )) break;
            lVar6 = uVar2 - uVar3;
            if (lVar6 < 0x80000000) {
               if (-0x80000001 < lVar6) {
                  iVar4 = (int)lVar6;
            ...
            LAB_001162bc:pTVar1 = pTVar10 + 0x10;
            pTVar9 = pTVar10;
...
;
         ...
         LAB_00116270:pTVar10 = *(TIntermediate**)( pTVar10 + 0x18 );
      }
 while ( pTVar10 != (TIntermediate*)0x0 );
      LAB_001162c8:uVar5 = 0;
      if (this + 0x90 != pTVar9) {
   ...
   LAB_00116323:if (local_68 != local_58) {
   ...
   LAB_001163d4:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* glslang::TIntermediate::isIntegralConversion(glslang::TBasicType, glslang::TBasicType) const
   [clone .cold] */undefined8 glslang::TIntermediate::isIntegralConversion(void) {
   return 0;
}
/* bool glslang::TType::contains<glslang::TType::containsBasicType(glslang::TBasicType)
   ...
   if (*(code**)( *(long*)this + 0x128 ) == isStruct) {
      if (( byte )((char)this[8] - 0xfU) < 2) {
         LAB_00116476:lVar1 = *(long*)( *(long*)( this + 0x68 ) + 0x10 );
...
/* glslang::TType::containsBasicType(glslang::TBasicType) const */ulong glslang::TType::containsBasicType(TType *this, uint param_2) {
   ...
   if (*(code**)( *(long*)this + 0x128 ) == isStruct) {
      if (( byte )((char)this[8] - 0xfU) < 2) {
         LAB_00116506:lVar1 = *(long*)( *(long*)( this + 0x68 ) + 0x10 );
...
/* bool glslang::TType::contains<glslang::TType::containsStructure() const::{lambda(glslang::TType
   ...
   if (this == param_2) {
      LAB_00116590:if (pcVar4 != isStruct) {
         cVar3 = ( *pcVar4 )(this);
         if (cVar3 == '\0') {
            return false;
         }
   ...
   LAB_001165b9:lVar2 = *(long*)( *(long*)( this + 0x68 ) + 0x10 );
...
/* glslang::TType::containsStructure() const */bool glslang::TType::containsStructure(TType *this) {
   ...
   if (*(code**)( *(long*)this + 0x128 ) == isStruct) {
      if (( byte )((char)this[8] - 0xfU) < 2) {
         LAB_00116626:lVar1 = *(long*)( *(long*)( this + 0x68 ) + 0x10 );
...

{
  ...
  } ) < std::char_traits<char> < ::_M_assign((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>*)( this + 0x100 ), param_1) ;return;}/* std::__cxx11::basic_string<char, std::char_traits<char>, glslang::std::allocator<char>
...
/* glslang::TSpirvInstruction::TSpirvInstruction() */void glslang::TSpirvInstruction::TSpirvInstruction(TSpirvInstruction *this) {
   undefined8 uVar1;
   ...
   *(undefined8*)( this + 0x10 ) = 0;
   if (pTVar2 == (TSpirvInstruction*)&_LC25) {
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_replace_cold((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>*)this, "", 0, "", 0, 0);
...
/* glslang::TIntermAggregate::TIntermAggregate() */void glslang::TIntermAggregate::TIntermAggregate(TIntermAggregate *this) {
   ...
   *(ulong*)( this + 0x4d ) = ( ulong )(( uint ) * (undefined8*)( this + 0x4d ) & 0xffc00f) | 0xffffffffff001fc0;
...
/* glslang::TIntermTyped* glslang::TIntermediate::addSwizzle<int>(glslang::TSwizzleSelectors<int>&,
   glslang::TSourceLoc const&) */TIntermTyped * __thiscall
glslang::TIntermediate::addSwizzle<int>
   ...
   *(ulong*)( pTVar5 + 0x4d ) = ( ulong )(( uint ) * (undefined8*)( pTVar5 + 0x4d ) & 0xffc00f) | 0xffffffffff001fc0;
   ...
   *(undefined8*)( pTVar5 + 0x18 ) = *(undefined8*)( param_2 + 0x10 );
   if (0 < iVar2) {
      ...
      do {
         ...
         std::vector<TIntermNode*,glslang::pool_allocator<TIntermNode*>>::emplace_back<TIntermNode*>((vector<TIntermNode*,glslang::pool_allocator<TIntermNode*>>*)( pTVar5 + 0xc0 ), &local_48);
      }
...
glslang::TIntermediate::addSwizzle<glslang::TMatrixSelector>
   ...
   *(ulong*)( pTVar4 + 0x4d ) = ( ulong )(( uint ) * (undefined8*)( pTVar4 + 0x4d ) & 0xffc00f) | 0xffffffffff001fc0;
...
/* WARNING: Control flow encountered bad instruction data *//* glslang::TIntermAggregate::TIntermAggregate() */void glslang::TIntermAggregate::TIntermAggregate(TIntermAggregate *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* glslang::TSpirvInstruction::TSpirvInstruction() */void glslang::TSpirvInstruction::TSpirvInstruction(TSpirvInstruction *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* glslang::TType::TType(glslang::TBasicType, glslang::TStorageQualifier, int, int, int, bool) */void glslang::TType::TType(void) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* glslang::TIntermAggregate::~TIntermAggregate() */void glslang::TIntermAggregate::~TIntermAggregate(TIntermAggregate *this) {
...
/* WARNING: Control flow encountered bad instruction data *//* glslang::TextureUpgradeAndSamplerRemovalTransform::~TextureUpgradeAndSamplerRemovalTransform() */void glslang::TextureUpgradeAndSamplerRemovalTransform::~TextureUpgradeAndSamplerRemovalTransform(TextureUpgradeAndSamplerRemovalTransform *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

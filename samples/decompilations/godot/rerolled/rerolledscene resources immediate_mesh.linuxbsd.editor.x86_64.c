/* ImmediateMesh::get_surface_count() const */undefined4 ImmediateMesh::get_surface_count(ImmediateMesh *this) {
   return *(undefined4*)( this + 0x470 );
}
/* ImmediateMesh::surface_get_array_index_len(int) const */undefined8 ImmediateMesh::surface_get_array_index_len(int param_1) {
   return 0;
}
/* ImmediateMesh::get_blend_shape_count() const */undefined8 ImmediateMesh::get_blend_shape_count(void) {
   return 0;
}
/* ImmediateMesh::get_blend_shape_name(int) const */undefined8 ImmediateMesh::get_blend_shape_name(int param_1) {
   undefined4 in_register_0000003c;
   *(undefined8*)CONCAT44(in_register_0000003c, param_1) = 0;
   return CONCAT44(in_register_0000003c, param_1);
}
/* ImmediateMesh::set_blend_shape_name(int, StringName const&) */void ImmediateMesh::set_blend_shape_name(int param_1, StringName *param_2) {
   return;
}
/* ImmediateMesh::get_rid() const */undefined8 ImmediateMesh::get_rid(ImmediateMesh *this) {
   return *(undefined8*)( this + 0x3c0 );
}
/* ImmediateMesh::surface_add_vertex(Vector3 const&) */void ImmediateMesh::surface_add_vertex(ImmediateMesh *this, Vector3 *param_1) {
   undefined8 *puVar1;
   undefined4 uVar2;
   long lVar3;
   undefined8 uVar4;
   ...
   if (this[0x480] == (ImmediateMesh)0x0) {
      _err_print_error("surface_add_vertex", "scene/resources/immediate_mesh.cpp", 0x66, "Condition \"!surface_active\" is true.", "Not creating any surface. Use surface_begin() to do it.", 0, 0);
   }
 else {
      if (( *(int*)( this + 0x460 ) != 0 ) && ( this[0x498] != (ImmediateMesh)0x0 )) {
         _err_print_error("surface_add_vertex", "scene/resources/immediate_mesh.cpp", 0x67, "Condition \"vertices.size() && active_surface_data.vertex_2d\" is true.", "Can\'t mix 2D and 3D vertices in a surface.", 0, 0);
         goto LAB_001001fe;
      }
      ...
      if (uVar8 == *(uint*)( this + 0x464 )) {
         ...
         *(void**)( this + 0x468 ) = pvVar7;
         if (pvVar7 == (void*)0x0) {
            LAB_00100470:_err_print_error("push_back", "./core/templates/local_vector.h", 0x41, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0);
            _err_flush_stdout();
   ...
   LAB_001001fe:if (lVar3 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* ImmediateMesh::surface_add_vertex_2d(Vector2 const&) */void ImmediateMesh::surface_add_vertex_2d(ImmediateMesh *this, Vector2 *param_1) {
   undefined8 *puVar1;
   undefined4 uVar2;
   long lVar3;
   undefined8 uVar4;
   ...
   lVar3 = *(long*)( in_FS_OFFSET + 0x28 );
   if (this[0x480] == (ImmediateMesh)0x0) {
      _err_print_error("surface_add_vertex_2d", "scene/resources/immediate_mesh.cpp", 0x7c, "Condition \"!surface_active\" is true.", "Not creating any surface. Use surface_begin() to do it.", 0, 0);
   }
 else {
      if (( *(int*)( this + 0x460 ) != 0 ) && ( this[0x498] == (ImmediateMesh)0x0 )) {
         _err_print_error("surface_add_vertex_2d", "scene/resources/immediate_mesh.cpp", 0x7d, "Condition \"vertices.size() && !active_surface_data.vertex_2d\" is true.", "Can\'t mix 2D and 3D vertices in a surface.", 0, 0);
         goto LAB_00100644;
      }
      ...
      if (uVar8 == *(uint*)( this + 0x464 )) {
         ...
         *(void**)( this + 0x468 ) = pvVar7;
         if (pvVar7 == (void*)0x0) {
            LAB_001008c0:_err_print_error("push_back", "./core/templates/local_vector.h", 0x41, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar5 = (code*)invalidInstructionException();
            ( *pcVar5 )();
   ...
   LAB_00100644:if (lVar3 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* ImmediateMesh::surface_get_array_len(int) const */undefined4 ImmediateMesh::surface_get_array_len(ImmediateMesh *this, int param_1) {
   uint uVar1;
   code *pcVar2;
   ...
   _err_print_index_error("surface_get_array_len", "scene/resources/immediate_mesh.cpp", 0x156, (long)param_1, (long)(int)uVar1, "p_idx", "int(surfaces.size())", "", false, false);
   return 0xffffffff;
}
/* ImmediateMesh::surface_get_format(int) const */undefined8 ImmediateMesh::surface_get_format(ImmediateMesh *this, int param_1) {
   uint uVar1;
   code *pcVar2;
   uVar1 = *(uint*)( this + 0x470 );
   if (( -1 < param_1 ) && ( param_1 < (int)uVar1 )) {
   ...
   _err_print_index_error("surface_get_format", "scene/resources/immediate_mesh.cpp", 0x167, (long)param_1, (long)(int)uVar1, "p_idx", "int(surfaces.size())", "", false, false);
   return 0;
}
/* ImmediateMesh::surface_get_primitive_type(int) const */undefined4 ImmediateMesh::surface_get_primitive_type(ImmediateMesh *this, int param_1) {
   uint uVar1;
   code *pcVar2;
   uVar1 = *(uint*)( this + 0x470 );
   if (( -1 < param_1 ) && ( param_1 < (int)uVar1 )) {
   ...
   _err_print_index_error("surface_get_primitive_type", "scene/resources/immediate_mesh.cpp", 0x16b, (long)param_1, (long)(int)uVar1, "p_idx", "int(surfaces.size())", "", false, false);
   return 5;
}
/* ImmediateMesh::surface_get_arrays(int) const */Array *ImmediateMesh::surface_get_arrays(int param_1) {
   long lVar1;
   undefined8 uVar2;
   int in_EDX;
   long in_RSI;
   ...
   if (( in_EDX < 0 ) || ( *(int*)( in_RSI + 0x470 ) <= in_EDX )) {
      _err_print_index_error("surface_get_arrays", "scene/resources/immediate_mesh.cpp", 0x15d, (long)in_EDX, (long)*(int*)( in_RSI + 0x470 ), "p_surface", "int(surfaces.size())", "", false, false);
      Array::Array(this);
   }
 else {
...
/* ImmediateMesh::surface_get_blend_shape_arrays(int) const */Array *ImmediateMesh::surface_get_blend_shape_arrays(int param_1) {
   undefined4 in_register_0000003c;
   long in_FS_OFFSET;
   long local_40;
   undefined8 local_38;
...
/* ImmediateMesh::surface_get_lods(int) const */undefined8 ImmediateMesh::surface_get_lods(int param_1) {
   undefined4 in_register_0000003c;
   Dictionary::Dictionary((Dictionary*)CONCAT44(in_register_0000003c, param_1));
   return CONCAT44(in_register_0000003c, param_1);
}
/* ImmediateMesh::get_aabb() const */void ImmediateMesh::get_aabb(void) {
   int iVar1;
   long lVar2;
   undefined8 uVar3;
   undefined8 uVar4;
...
;
 ...
 while ( 1 < *(uint*)( in_RSI + 0x470 ) );
   ...
   LAB_00100dce:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* LocalVector<Plane, unsigned int, false, false>::resize(unsigned int) [clone .part.0] */void LocalVector<Plane,unsigned_int,false,false>::resize(uint param_1) {
   code *pcVar1;
...
/* ImmediateMesh::surface_begin(Mesh::PrimitiveType, Ref<Material> const&) */undefined8 ImmediateMesh::surface_begin(ImmediateMesh *this, undefined4 param_2, long *param_3) {
   Object *pOVar1;
   Object *pOVar2;
   undefined8 in_RAX;
   if (this[0x480] == (ImmediateMesh)0x0) {
   ...
   _err_print_error("surface_begin", "scene/resources/immediate_mesh.cpp", 0x22, "Condition \"surface_active\" is true.", "Already creating a new surface.", 0);
   return 0;
}
/* ImmediateMesh::surface_get_material(int) const */long *ImmediateMesh::surface_get_material(int param_1) {
   uint uVar1;
   long lVar2;
   code *pcVar3;
   char cVar4;
   ...
   _err_print_index_error("surface_get_material", "scene/resources/immediate_mesh.cpp", 0x178, (long)(int)in_EDX, (long)(int)uVar1, "p_idx", "int(surfaces.size())", "", false, false);
   *plVar5 = 0;
   return plVar5;
}
/* ImmediateMesh::surface_set_material(int, Ref<Material> const&) */void ImmediateMesh::surface_set_material(ImmediateMesh *this, int param_1, Ref *param_2) {
   long lVar1;
   uint uVar2;
   Object *pOVar3;
   code *pcVar4;
   ...
   if (( -1 < param_1 ) && ( param_1 < (int)uVar2 )) {
      ...
      _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, (long)param_1, (ulong)uVar2, "p_index", "count", "", false, true);
      _err_flush_stdout();
      /* WARNING: Does not return */
   ...
   _err_print_index_error("surface_set_material", "scene/resources/immediate_mesh.cpp", 0x16f, (long)param_1, (long)(int)uVar2, "p_idx", "int(surfaces.size())", "", false, false);
   return;
}
...
/* ImmediateMesh::surface_set_tangent(Plane const&) */undefined1[16];ImmediateMesh::surface_set_tangent(Plane *param_1) {
   uint uVar1;
   undefined8 uVar2;
   ...
   if (param_1[0x480] == (Plane)0x0) {
      _err_print_error("surface_set_tangent", "scene/resources/immediate_mesh.cpp", 0x42, "Condition \"!surface_active\" is true.", "Not creating any surface. Use surface_begin() to do it.", 0);
      auVar3._8_8_ = 0;
   ...
   if (uVar1 < uVar4) {
      LAB_0010135e:*(uint*)( param_1 + 0x430 ) = uVar1;
      uVar4 = uVar1;
   }
 else if (uVar4 < uVar1) {
      uVar7 = uVar1 - 1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ImmediateMesh::surface_set_color(Color const&) */undefined1[16];ImmediateMesh::surface_set_color(Color *param_1) {
   uint uVar1;
   undefined8 uVar2;
   undefined1 auVar3[16];
   undefined8 uVar4;
   ...
   if (param_1[0x480] == (Color)0x0) {
      _err_print_error("surface_set_color", "scene/resources/immediate_mesh.cpp", 0x28, "Condition \"!surface_active\" is true.", "Not creating any surface. Use surface_begin() to do it.", 0);
      auVar3._8_8_ = 0;
   ...
   if (uVar1 < uVar5) {
      LAB_001014a1:*(uint*)( param_1 + 0x410 ) = uVar1;
      uVar5 = uVar1;
   }
 else if (uVar5 < uVar1) {
      if (*(uint*)( param_1 + 0x414 ) < uVar1) {
         ...
         *(undefined8**)( param_1 + 0x418 ) = in_RAX;
         if (in_RAX == (undefined8*)0x0) {
            /* WARNING: Subroutine does not return */
            LocalVector<Plane,unsigned_int,false,false>::resize((uint)puVar8);
         }

         uVar5 = *(uint*)( param_1 + 0x410 );
         if (uVar1 <= uVar5) goto LAB_001014a1;
      }

      uVar4 = _UNK_0010b618;
      uVar2 = __LC34;
      puVar6 = in_RAX + (ulong)uVar5 * 2;
      puVar8 = puVar6 + ( ulong )(uVar1 - uVar5) * 2;
      if (( ( ulong )(uVar1 - uVar5) * 0x10 & 0x10 ) != 0) {
         *puVar6 = __LC34;
         puVar6[1] = uVar4;
         puVar6 = puVar6 + 2;
         if (puVar8 == puVar6) goto LAB_001014a1;
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ImmediateMesh::ImmediateMesh() */void ImmediateMesh::ImmediateMesh(ImmediateMesh *this) {
   undefined8 uVar1;
   long *plVar2;
   undefined8 uVar3;
   Mesh::Mesh((Mesh*)this);
   ...
   *(undefined***)this = &PTR__initialize_classv_0010b100;
   ...
   *(undefined8*)( this + 0x404 ) = 0;
   for (int i = 0; i < 4; i++) {
      *(undefined8*)( this + ( 24*i + 1040 ) ) = 0;
      *(undefined8*)( this + ( 24*i + 1048 ) ) = 0;
      *(undefined8*)( this + ( 24*i + 1056 ) ) = 0;
   }
...
/* ImmediateMesh::surface_set_normal(Vector3 const&) */undefined1[16];ImmediateMesh::surface_set_normal(Vector3 *param_1) {
   undefined8 *puVar1;
   ...
   if (param_1[0x480] == (Vector3)0x0) {
      _err_print_error("surface_set_normal", "scene/resources/immediate_mesh.cpp", 0x35, "Condition \"!surface_active\" is true.", "Not creating any surface. Use surface_begin() to do it.", 0);
      auVar2._8_8_ = 0;
   ...
   if (param_1[0x3c9] == (Vector3)0x0) {
      LocalVector<Vector3,unsigned_int,false,false>::resize((LocalVector<Vector3,unsigned_int,false,false>*)( param_1 + 0x420 ), *(uint*)( param_1 + 0x460 ));
...
/* ImmediateMesh::clear_surfaces() */void ImmediateMesh::clear_surfaces(ImmediateMesh *this) {
   long lVar1;
   Object *pOVar2;
   char cVar3;
   long *plVar4;
 ...
 while ( (uint)lVar5 < *(uint*)( this + 0x470 ) );
   ...
   LocalVector<Vector3,unsigned_int,false,false>::resize((LocalVector<Vector3,unsigned_int,false,false>*)( this + 0x420 ), 0);
   if (*(int*)( this + 0x430 ) != 0) {
      *(undefined4*)( this + 0x430 ) = 0;
   }

   LocalVector<Vector2,unsigned_int,false,false>::resize((LocalVector<Vector2,unsigned_int,false,false>*)( this + 0x440 ), 0);
   LocalVector<Vector2,unsigned_int,false,false>::resize((LocalVector<Vector2,unsigned_int,false,false>*)( this + 0x450 ), 0);
   LocalVector<Vector3,unsigned_int,false,false>::resize((LocalVector<Vector3,unsigned_int,false,false>*)( this + 0x460 ), 0);
   this[0x3cc] = (ImmediateMesh)0x0;
   *(undefined4*)( this + 0x3c8 ) = 0;
   return;
}
/* ImmediateMesh::surface_set_uv(Vector2 const&) */undefined1[16];ImmediateMesh::surface_set_uv(Vector2 *param_1) {
   ulong *puVar1;
   ulong uVar2;
   undefined1 auVar3[16];
   ulong *puVar4;
   ...
   if (param_1[0x480] == (Vector2)0x0) {
      _err_print_error("surface_set_uv", "scene/resources/immediate_mesh.cpp", 0x4e, "Condition \"!surface_active\" is true.", "Not creating any surface. Use surface_begin() to do it.", 0);
      auVar3._8_8_ = 0;
      auVar3._0_8_ = uStack_20;
      return auVar3 << 0x40;
   }
   ...
   if (param_1[0x3cb] == (Vector2)0x0) {
      LocalVector<Vector2,unsigned_int,false,false>::resize((LocalVector<Vector2,unsigned_int,false,false>*)( param_1 + 0x440 ), *(uint*)( param_1 + 0x460 ));
...
/* ImmediateMesh::surface_set_uv2(Vector2 const&) */undefined1[16];ImmediateMesh::surface_set_uv2(Vector2 *param_1) {
   ulong *puVar1;
   ulong uVar2;
   undefined1 auVar3[16];
   ulong *puVar4;
   ...
   ulong uStack_20;
   if (param_1[0x480] == (Vector2)0x0) {
      _err_print_error("surface_set_uv2", "scene/resources/immediate_mesh.cpp", 0x5a, "Condition \"!surface_active\" is true.", "Not creating any surface. Use surface_begin() to do it.", 0);
      auVar3._8_8_ = 0;
      auVar3._0_8_ = uStack_20;
      return auVar3 << 0x40;
   }
   ...
   if (param_1[0x3cc] == (Vector2)0x0) {
      LocalVector<Vector2,unsigned_int,false,false>::resize((LocalVector<Vector2,unsigned_int,false,false>*)( param_1 + 0x450 ), *(uint*)( param_1 + 0x460 ));
...
/* ImmediateMesh::_bind_methods() */void ImmediateMesh::_bind_methods(void) {
   char cVar1;
   long lVar2;
   code *pcVar3;
   long *plVar4;
...
/* ImmediateMesh::~ImmediateMesh() */void ImmediateMesh::~ImmediateMesh(ImmediateMesh *this) {
   Object *pOVar1;
   char cVar2;
   long lVar3;
   long *plVar4;
   ...
   *(undefined***)this = &PTR__initialize_classv_0010b100;
   ...
   if (lVar3 == 0) {
      _err_print_error("~ImmediateMesh", "scene/resources/immediate_mesh.cpp", 0x1a6, "Parameter \"RenderingServer::get_singleton()\" is null.", 0, 0);
      ...
      if (*(long*)( this + 0x478 ) != 0) {
         LocalVector<ImmediateMesh::Surface,unsigned_int,false,false>::resize((LocalVector<ImmediateMesh::Surface,unsigned_int,false,false>*)( this + 0x470 ), 0);
      ...
      if (*(long*)( this + 0x438 ) == 0) goto LAB_00102a5f;
      LocalVector<Plane,unsigned_int,false,false>::resize((LocalVector<Plane,unsigned_int,false,false>*)( this + 0x430 ), 0);
      pvVar6 = *(void**)( this + 0x438 );
      if (pvVar6 == (void*)0x0) goto LAB_00102a5f;
   }
 else {
      plVar4 = (long*)RenderingServer::get_singleton();
      ...
      CowData<unsigned_char>::_unref((CowData<unsigned_char>*)( this + 0x4d8 ));
      CowData<unsigned_char>::_unref((CowData<unsigned_char>*)( this + 0x4c8 ));
      if (( *(long*)( this + 0x490 ) == 0 ) || ( cVar2 = cVar2 == '\0' )) {
         LAB_00102922:pvVar6 = *(void**)( this + 0x478 );
      }
 else {
 ...
 while ( uVar5 < *(uint*)( this + 0x470 ) );
            *(undefined4*)( this + 0x470 ) = 0;
            if (pvVar6 == (void*)0x0) goto LAB_001029b7;
         }

         Memory::free_static(pvVar6, false);
      }

      LAB_001029b7:if (*(long*)( this + 0x468 ) != 0) {
         LocalVector<Vector3,unsigned_int,false,false>::resize((LocalVector<Vector3,unsigned_int,false,false>*)( this + 0x460 ), 0);
         if (*(void**)( this + 0x468 ) != (void*)0x0) {
            Memory::free_static(*(void**)( this + 0x468 ), false);
         }
   ...
   Memory::free_static(pvVar6, false);
   LAB_00102a5f:if (*(long*)( this + 0x428 ) != 0) {
      LocalVector<Vector3,unsigned_int,false,false>::resize((LocalVector<Vector3,unsigned_int,false,false>*)( this + 0x420 ), 0);
   ...
   if (*(long*)( this + 0x418 ) != 0) {
      LocalVector<Color,unsigned_int,false,false>::resize((LocalVector<Color,unsigned_int,false,false>*)( this + 0x410 ), 0);
...
/* Error CowData<unsigned char>::resize<false>(long) [clone .isra.0] */void CowData<unsigned_char>::resize<false>(CowData<unsigned_char> *this, long param_1) {
   ...
   LAB_00102e4c:puVar6[-1] = param_1;
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ImmediateMesh::surface_end() */void ImmediateMesh::surface_end(ImmediateMesh *this) {
   float fVar1;
   ImmediateMesh IVar2;
   undefined4 uVar3;
   undefined4 uVar4;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (this[0x480] == (ImmediateMesh)0x0) {
      _err_print_error("surface_end", "scene/resources/immediate_mesh.cpp", 0x95, "Condition \"!surface_active\" is true.", "Not creating any surface. Use surface_begin() to do it.", 0, 0);
      goto LAB_00103ca2;
   }

   iVar19 = *(int*)( this + 0x460 );
   if (iVar19 == 0) {
      _err_print_error("surface_end", "scene/resources/immediate_mesh.cpp", 0x96, "Condition \"vertices.is_empty()\" is true.", "No vertices were added, surface can\'t be created.", 0, 0);
      goto LAB_00103ca2;
   }
   ...
   if (*(int*)( this + 0x460 ) == 0) {
      ...
      do {
         ...
         *pfVar16 = *pfVar27;
         ...
         if (this[0x3c9] == (ImmediateMesh)0x0) {
            if (this[0x3ca] != (ImmediateMesh)0x0) {
               LAB_0010337f:uVar25 = ( ulong ) * (uint*)( this + 0x430 );
               if (*(uint*)( this + 0x430 ) <= uVar11) goto LAB_001034f8;
               Vector3::octahedron_tangent_encode(*(float*)( uVar20 * 0x10 + *(long*)( this + 0x438 ) + 0xc ));
               fVar1 = _LC75;
            ...
            if (*(uint*)( this + 0x420 ) <= uVar11) {
               LAB_001034f8:uVar20 = uVar20 & 0xffffffff;
               goto LAB_001034fa;
            }
            ...
            if (( 0.0 <= fVar29 ) && ( uVar15 = fVar29 <= _LC75 )) {
            ...
            *(uint*)( ( ulong )(( local_190 - uVar12 ) + uVar28) + lVar10 ) = uVar15;
            if (IVar2 != (ImmediateMesh)0x0) goto LAB_0010337f;
            if (this[0x3c9] == (ImmediateMesh)0x0) goto LAB_001032a9;
            uVar25 = ( ulong ) * (uint*)( this + 0x420 );
            if (*(uint*)( this + 0x420 ) <= uVar11) goto LAB_001034f8;
            ...
            LAB_00103251:fVar31 = fVar31 * fVar1;
            uVar11 = 0;
            if (( 0.0 <= fVar31 ) && ( uVar11 = fVar31 <= _LC75 )) {
         ...
         LAB_001032a9:uVar11 = *(uint*)( this + 0x460 );
         uVar20 = uVar20 + 1;
 ...
 while ( (uint)uVar20 < uVar11 );
   ...
   if (this[0x3c8] == (ImmediateMesh)0x0) {
      ...
      LAB_00103628:iVar7 = 0;
      if (this[0x3cc] != (ImmediateMesh)0x0) {
         LAB_00103d44:iVar7 = iVar19;
         uVar8 = uVar8 | 0x20;
         iVar19 = iVar7 + 8;
      }

      CowData<unsigned_char>::resize<false>((CowData<unsigned_char>*)( this + 0x4d8 ), ( ulong )(uVar11 * iVar19));
      ...
      if (*(int*)( this + 0x460 ) != 0) {
         ...
         do {
            ...
            if (this[0x3c8] != (ImmediateMesh)0x0) {
               ...
               if (*(uint*)( this + 0x410 ) <= uVar11) goto LAB_00103d30;
               lVar18 = lVar17 * 2;
               dVar32 = (double)*(float*)( *(long*)( this + 0x418 ) + lVar17 * 2 ) * dVar6;
               uVar24 = 0;
               if (( 0.0 <= dVar32 ) && ( uVar24 = dVar32 <= dVar6 )) {
                  uVar24 = (undefined1)(int)dVar32;
               }

               *puVar22 = uVar24;
               for (int i = 0; i < 3; i++) {
                  uVar25 = ( ulong ) * (uint*)( this + 1040 );
                  if (*(uint*)( this + 1040 ) <= uVar11) goto LAB_00103d30;
                  dVar32 = (double)*(float*)( *(long*)( this + 1048 ) + ( 4*i + 4 ) + lVar18 ) * dVar6;
                  uVar24 = 0;
                  if (( 0 <= dVar32 ) && ( uVar24 = dVar32 <= dVar6 )) {
                     uVar24 = (undefined1)(int)dVar32;
                  }
            ...
            if (this[0x3cb] != (ImmediateMesh)0x0) {
               ...
               if (*(uint*)( this + 0x440 ) <= uVar11) goto LAB_00103d30;
            ...
            if (this[0x3cc] != (ImmediateMesh)0x0) {
               ...
               if (*(uint*)( this + 0x450 ) <= uVar11) {
                  LAB_00103d30:uVar20 = (ulong)uVar11;
                  LAB_001034fa:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar20, uVar25, "p_index", "count", "", false, true);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
                  pcVar5 = (code*)invalidInstructionException();
                  ( *pcVar5 )();
 ...
 while ( uVar11 < *(uint*)( this + 0x460 ) );
   ...
   if (( ( ( this[0x3c8] != (ImmediateMesh)0x0 ) || ( this[0x3cb] != (ImmediateMesh)0x0 ) ) || ( this[0x3cc] != (ImmediateMesh)0x0 ) ) && ( local_110[0] != *(long*)( this + 0x4d8 ) )) {
 ...
 while ( lVar17 != lVar18 );
   ...
   LAB_00103ca2:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* ImmediateMesh::is_class_ptr(void*) const */uint ImmediateMesh::is_class_ptr(ImmediateMesh *this, void *param_1) {
   return (uint)CONCAT71(0x10b5, (undefined4*)param_1 == &Mesh::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10b5, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10b5, (undefined4*)param_1 == &Resource::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10b5, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10b5, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* ImmediateMesh::_getv(StringName const&, Variant&) const */undefined8 ImmediateMesh::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* ImmediateMesh::_setv(StringName const&, Variant const&) */undefined8 ImmediateMesh::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* ImmediateMesh::_validate_propertyv(PropertyInfo&) const */void ImmediateMesh::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* ImmediateMesh::_property_can_revertv(StringName const&) const */undefined8 ImmediateMesh::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* ImmediateMesh::_property_get_revertv(StringName const&, Variant&) const */undefined8 ImmediateMesh::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* ImmediateMesh::_notificationv(int, bool) */void ImmediateMesh::_notificationv(int param_1, bool param_2) {
   return;
}
...
/* MethodBindT<Mesh::PrimitiveType, Ref<Material> const&>::_gen_argument_type(int) const */int MethodBindT<Mesh::PrimitiveType,Ref<Material>const&>::_gen_argument_type(MethodBindT<Mesh::PrimitiveType,Ref<Material>const&> *this, int param_1) {
   int iVar1;
   iVar1 = 0;
   if ((uint)param_1 < 2) {
...
/* MethodBindT<Mesh::PrimitiveType, Ref<Material> const&>::get_argument_meta(int) const */undefined8 MethodBindT<Mesh::PrimitiveType,Ref<Material>const&>::get_argument_meta(int param_1) {
   return 0;
}
/* MethodBindT<Mesh::PrimitiveType, Ref<Material> const&>::~MethodBindT() */void MethodBindT<Mesh::PrimitiveType,Ref<Material>const&>::~MethodBindT(MethodBindT<Mesh::PrimitiveType,Ref<Material>const&> *this) {
...
/* MethodBindT<>::~MethodBindT() */void MethodBindT<>::~MethodBindT(MethodBindT<> *this) {
   *(undefined***)this = &PTR__gen_argument_type_0010b540;
   MethodBind::~MethodBind((MethodBind*)this);
   return;
}
/* MethodBindT<>::~MethodBindT() */void MethodBindT<>::~MethodBindT(MethodBindT<> *this) {
...
/* ImmediateMesh::_get_class_namev() const */undefined8 *ImmediateMesh::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00104843:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00104843;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "ImmediateMesh");
         goto LAB_001048ae;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "ImmediateMesh");
   LAB_001048ae:return &_get_class_namev();
}
/* ImmediateMesh::get_class() const */void ImmediateMesh::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* Mesh::~Mesh() */void Mesh::~Mesh(Mesh *this) {
   long *plVar1;
   long lVar2;
   Object *pOVar3;
   code *pcVar4;
   ...
   *(code**)this = Mesh::Mesh;
   if (( ( ( ( ( ( bVar8 ) && ( ( *(long*)( this + 0x3a8 ) == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) ) ) && ( ( *(long*)( this + 0x390 ) == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) ) ) && ( ( ( ( *(long*)( this + 0x378 ) == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) && ( ( *(long*)( this + 0x360 ) == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) ) ) && ( ( *(long*)( this + 0x348 ) == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) ) ) ) ) && ( ( *(long*)( this + 0x330 ) == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) ) ) && ( ( ( ( *(long*)( this + 0x318 ) == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) && ( ( *(long*)( this + 0x300 ) == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) ) ) && ( ( ( *(long*)( this + 0x2e8 ) == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) && ( ( *(long*)( this + 0x2d0 ) == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) ) ) ) ) ) ) && ( ( ( ( *(long*)( this + 0x2b8 ) == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) && ( ( *(long*)( this + 0x2a0 ) == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) ) ) && ( ( ( *(long*)( this + 0x288 ) == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) && ( *(long*)( this + 0x270 ) != 0 ) ) ) ) )) {
      StringName::unref();
   }
         ...
         if (lVar2 != 0) {
            do {
               while (( *plVar6 == 0 || ( cVar5 = RefCounted::unreference() ),cVar5 == '\0' )) {
                  LAB_00104c80:lVar7 = lVar7 + 1;
                  plVar6 = plVar6 + 1;
                  if (lVar2 == lVar7) goto LAB_00104cd8;
               }
;
               pOVar3 = (Object*)*plVar6;
               cVar5 = predelete_handler(pOVar3);
               if (cVar5 == '\0') goto LAB_00104c80;
               lVar7 = lVar7 + 1;
               plVar6 = plVar6 + 1;
 ...
 while ( lVar2 != lVar7 );
         ...
         LAB_00104cd8:Memory::free_static(plVar1 + -2, false);
      }

   }

   if (( *(long*)( this + 0x240 ) != 0 ) && ( cVar5 = cVar5 != '\0' )) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* LocalVector<Color, unsigned int, false, false>::resize(unsigned int) */void LocalVector<Color,unsigned_int,false,false>::resize(LocalVector<Color,unsigned_int,false,false> *this, uint param_1) {
   undefined8 uVar1;
   undefined8 uVar2;
   uint uVar3;
   undefined8 *puVar4;
   ...
   if (uVar3 <= param_1) {
      ...
      if (*(uint*)( this + 4 ) < param_1) {
         ...
         *(uint*)( this + 4 ) = uVar3;
         lVar7 = Memory::realloc_static(pvVar8, (ulong)uVar3 << 4, false);
         *(long*)( this + 8 ) = lVar7;
         if (lVar7 == 0) {
            /* WARNING: Subroutine does not return */
            LocalVector<Plane,unsigned_int,false,false>::resize((uint)pvVar8);
         }

         uVar3 = *(uint*)this;
         if (param_1 <= uVar3) goto LAB_00104df0;
      }
      ...
      puVar5 = puVar4;
      if (( ( ulong )(param_1 - uVar3) * 0x10 & 0x10 ) != 0) {
         *puVar4 = __LC34;
         puVar4[1] = uVar2;
         puVar5 = puVar4 + 2;
         if (puVar4 + 2 == puVar4 + ( ulong )(param_1 - uVar3) * 2) goto LAB_00104df0;
      }
 ...
 while ( puVar6 != puVar4 + ( ulong )(param_1 - uVar3) * 2 );
   }

   LAB_00104df0:*(uint*)this = param_1;
   return;
}
/* LocalVector<Vector3, unsigned int, false, false>::resize(unsigned int) */void LocalVector<Vector3,unsigned_int,false,false>::resize(LocalVector<Vector3,unsigned_int,false,false> *this, uint param_1) {
   code *pcVar1;
   uint uVar2;
   long lVar3;
   uint uVar4;
   ...
   if (uVar2 <= param_1) {
      ...
      if (*(uint*)( this + 4 ) < param_1) {
         ...
         *(long*)( this + 8 ) = lVar3;
         ...
         uVar2 = *(uint*)this;
         if (param_1 <= uVar2) goto LAB_00104ea1;
      }

      memset((void*)( *(long*)( this + 8 ) + (ulong)uVar2 * 0xc ), 0, ( ( ulong )(uVar4 - uVar2) * 3 + 3 ) * 4);
   }

   LAB_00104ea1:*(uint*)this = param_1;
   return;
}
/* LocalVector<Plane, unsigned int, false, false>::resize(unsigned int) */void LocalVector<Plane,unsigned_int,false,false>::resize(LocalVector<Plane,unsigned_int,false,false> *this, uint param_1) {
   code *pcVar1;
   uint uVar2;
   undefined8 *puVar3;
   undefined8 *puVar4;
   ...
   if (uVar2 <= param_1) {
      ...
      if (*(uint*)( this + 4 ) < param_1) {
         ...
         *(long*)( this + 8 ) = lVar5;
         ...
         uVar2 = *(uint*)this;
         if (param_1 <= uVar2) goto LAB_00104f9e;
      }
 ...
 while ( puVar4 != (undefined8*)( lVar5 + 0x10 + ( ( ulong )(uVar6 - uVar2) + (ulong)uVar2 ) * 0x10 ) );
   ...
   LAB_00104f9e:*(uint*)this = param_1;
   return;
}
/* LocalVector<Vector2, unsigned int, false, false>::resize(unsigned int) */void LocalVector<Vector2,unsigned_int,false,false>::resize(LocalVector<Vector2,unsigned_int,false,false> *this, uint param_1) {
   code *pcVar1;
   uint uVar2;
   long lVar3;
   uint uVar4;
   ...
   if (uVar2 <= param_1) {
      ...
      if (*(uint*)( this + 4 ) < param_1) {
         ...
         *(long*)( this + 8 ) = lVar3;
         ...
         uVar2 = *(uint*)this;
         if (param_1 <= uVar2) goto LAB_0010507a;
      }

      memset((void*)( *(long*)( this + 8 ) + (ulong)uVar2 * 8 ), 0, ( ulong )(uVar4 - uVar2) * 8 + 8);
   }

   LAB_0010507a:*(uint*)this = param_1;
   return;
}
...
godot::details::enum_qualified_name_to_class_info_name(details *this,String *param_1){
   ...
   long local_30;
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   String::split(local_58, SUB81(param_1, 0), 0x10515d);
...
/* RefCounted::is_class(String const&) const */undefined8 RefCounted::is_class(RefCounted *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_0010542f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar5 = local_60;
      if (local_60 != 0) {
         LOCK();
...
/* ImmediateMesh::is_class(String const&) const */undefined8 ImmediateMesh::is_class(ImmediateMesh *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
   ...
   LAB_001056fb:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_001058f0:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* RefCounted::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void RefCounted::_get_property_listv(List *param_1, bool param_2) {
   ...
   LAB_00105a5c:List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)CONCAT71(in_register_00000031, param_2), (PropertyInfo*)&local_78);
...
/* Resource::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Resource::_get_property_listv(Resource *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00105cc1:local_b0 = (CowData<char32_t>*)&local_58;
...
/* Mesh::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Mesh::_get_property_listv(Mesh *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00105f71:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* ImmediateMesh::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void ImmediateMesh::_get_property_listv(ImmediateMesh *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00106221:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* MethodBindT<Color const&>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<Color_const&>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar5 + 2 ) = (undefined1[16])0x0;
   ...
   local_60 = (undefined1[16])0x0;
   if (local_80 == 0) {
      LAB_001064a5:local_40 = 6;
      StringName::operator =((StringName*)( local_60 + 8 ), (StringName*)&local_78);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_48, (CowData*)&local_80);
      local_40 = 6;
      if (local_50 != 0x11) goto LAB_001064a5;
   ...
   *puVar5 = local_68._0_4_;
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)local_60);
   LAB_001063a9:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBindT<Vector3 const&>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<Vector3_const&>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar5 + 2 ) = (undefined1[16])0x0;
   ...
   local_60 = (undefined1[16])0x0;
   if (local_80 == 0) {
      LAB_00106715:local_40 = 6;
      StringName::operator =((StringName*)( local_60 + 8 ), (StringName*)&local_78);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_48, (CowData*)&local_80);
      local_40 = 6;
      if (local_50 != 0x11) goto LAB_00106715;
      StringName::StringName((StringName*)&local_70, (String*)&local_48, false);
      if (local_60._8_8_ == local_70) {
         if (( StringName::configured != '\0' ) && ( local_70 != 0 )) {
            StringName::unref();
   ...
   *puVar5 = local_68._0_4_;
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)local_60);
   LAB_00106619:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBindT<Plane const&>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<Plane_const&>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar5 + 2 ) = (undefined1[16])0x0;
   ...
   local_60 = (undefined1[16])0x0;
   if (local_80 == 0) {
      LAB_00106985:local_40 = 6;
      StringName::operator =((StringName*)( local_60 + 8 ), (StringName*)&local_78);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_48, (CowData*)&local_80);
      local_40 = 6;
      if (local_50 != 0x11) goto LAB_00106985;
      StringName::StringName((StringName*)&local_70, (String*)&local_48, false);
      if (local_60._8_8_ == local_70) {
         if (( StringName::configured != '\0' ) && ( local_70 != 0 )) {
            StringName::unref();
   ...
   *puVar5 = local_68._0_4_;
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)local_60);
   LAB_00106889:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBindT<Vector2 const&>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<Vector2_const&>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar5 + 2 ) = (undefined1[16])0x0;
   ...
   local_60 = (undefined1[16])0x0;
   if (local_80 == 0) {
      LAB_00106bf5:local_40 = 6;
      StringName::operator =((StringName*)( local_60 + 8 ), (StringName*)&local_78);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_48, (CowData*)&local_80);
      local_40 = 6;
      if (local_50 != 0x11) goto LAB_00106bf5;
      StringName::StringName((StringName*)&local_70, (String*)&local_48, false);
      if (local_60._8_8_ == local_70) {
         if (( StringName::configured != '\0' ) && ( local_70 != 0 )) {
            StringName::unref();
   ...
   *puVar5 = local_68._0_4_;
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)local_60);
   LAB_00106af9:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBindT<Mesh::PrimitiveType, Ref<Material> const&>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<Mesh::PrimitiveType,Ref<Material>const&>::_gen_argument_type_info(int param_1) {
   undefined1 auVar1[16];
   undefined1 auVar2[16];
   undefined8 uVar3;
   long lVar4;
   ...
   *(undefined1(*) [16])( puVar5 + 2 ) = (undefined1[16])0x0;
   if (in_EDX == 0) {
      ...
      *puVar5 = local_78._0_4_;
      ...
      if (local_90 == 0) {
         ...
         CowData<char32_t>::_ref((CowData<char32_t>*)&local_58, (CowData*)&local_90);
         local_50 = 6;
         if ((int)local_60 == 0x11) goto LAB_001070ed;
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)local_70);
   LAB_00106d9a:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* LocalVector<ImmediateMesh::Surface, unsigned int, false, false>::resize(unsigned int) */void LocalVector<ImmediateMesh::Surface,unsigned_int,false,false>::resize(LocalVector<ImmediateMesh::Surface,unsigned_int,false,false> *this, uint param_1) {
   Object *pOVar1;
   char cVar2;
   long lVar3;
   long lVar4;
   ...
   if (param_1 < uVar8) {
      ...
      LAB_00107206:do {
         lVar3 = *(long*)( this + 8 );
         if (( *(long*)( lVar3 + lVar6 + 8 ) != 0 ) && ( cVar2 = cVar2 != '\0' )) {
 ...
 while ( uVar8 < *(uint*)this );
      ...
      if (*(uint*)( this + 4 ) < param_1) {
         ...
         *(long*)( this + 8 ) = lVar6;
         ...
         uVar8 = *(uint*)this;
         if (param_1 <= uVar8) goto LAB_00107258;
      }
 ...
 while ( lVar4 != lVar6 + 0x38 + ( ( ulong )(uVar5 - uVar8) + (ulong)uVar8 ) * 0x38 );
   ...
   LAB_00107258:*(uint*)this = param_1;
   return;
}
/* MethodBind* create_method_bind<ImmediateMesh, Mesh::PrimitiveType, Ref<Material> const&>(void
   (ImmediateMesh::*)(Mesh::PrimitiveType, Ref<Material> const&)) */MethodBind *create_method_bind<ImmediateMesh,Mesh::PrimitiveType,Ref<Material>const&>(_func_void_PrimitiveType_Ref_ptr *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
...
/* MethodBind* create_method_bind<ImmediateMesh, Color const&>(void (ImmediateMesh::*)(Color
   const&)) */MethodBind *create_method_bind<ImmediateMesh,Color_const&>(_func_void_Color_ptr *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
...
/* MethodBind* create_method_bind<ImmediateMesh, Vector3 const&>(void (ImmediateMesh::*)(Vector3
   const&)) */MethodBind *create_method_bind<ImmediateMesh,Vector3_const&>(_func_void_Vector3_ptr *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
...
/* MethodBind* create_method_bind<ImmediateMesh, Plane const&>(void (ImmediateMesh::*)(Plane
   const&)) */MethodBind *create_method_bind<ImmediateMesh,Plane_const&>(_func_void_Plane_ptr *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
...
/* MethodBind* create_method_bind<ImmediateMesh, Vector2 const&>(void (ImmediateMesh::*)(Vector2
   const&)) */MethodBind *create_method_bind<ImmediateMesh,Vector2_const&>(_func_void_Vector2_ptr *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
...
/* MethodBind* create_method_bind<ImmediateMesh>(void (ImmediateMesh::*)()) */MethodBind *create_method_bind<ImmediateMesh>(_func_void *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
...
/* ImmediateMesh::_bind_methods() [clone .cold] */void ImmediateMesh::_bind_methods(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void FUN_001079ba(void) {
   code *pcVar1;
   _DAT_00000000 = 0;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
...
/* ImmediateMesh::surface_end() [clone .cold] */void ImmediateMesh::surface_end(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* ImmediateMesh::_initialize_classv() */void ImmediateMesh::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_70;
   long local_68;
   long local_60;
   ...
   if (initialize_class() == '\0') {
      if (Mesh::initialize_class() == '\0') {
         ...
         Mesh::initialize_class()::initialized =
         '\x01';
      }
...
/* WARNING: Removing unreachable block (ram,0x00108058) *//* String vformat<StringName>(String const&, StringName const) */undefined8 *vformat<StringName>(undefined8 *param_1, bool *param_2, StringName *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* MethodBindT<>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   LAB_00108350:*(undefined4*)param_1 = 0;
...
/* MethodBindT<>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x00108606. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ));
      return;
   }

   LAB_0010875f:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<>::ptrcall(Object*, void const**, void*) const */void MethodBindT<>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x001087c6. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ));
      return;
   }

   LAB_0010891f:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<Vector2 const&>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<Vector2_const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x0010898d. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *(long*)param_3 + 8);
      return;
   }

   LAB_00108b01:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<Vector2 const&>::ptrcall(Object*, void const**, void*) const */void MethodBindT<Vector2_const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x00108b69. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *param_3);
      return;
   }

   LAB_00108ce1:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<Plane const&>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<Plane_const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x00108d4d. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *(long*)param_3 + 8);
      return;
   }

   LAB_00108ec1:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<Plane const&>::ptrcall(Object*, void const**, void*) const */void MethodBindT<Plane_const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x00108f29. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *param_3);
      return;
   }

   LAB_001090a1:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<Vector3 const&>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<Vector3_const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x0010910d. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *(long*)param_3 + 8);
      return;
   }

   LAB_00109281:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<Vector3 const&>::ptrcall(Object*, void const**, void*) const */void MethodBindT<Vector3_const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x001092e9. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *param_3);
      return;
   }

   LAB_00109461:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<Color const&>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<Color_const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x001094cd. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *(long*)param_3 + 8);
      return;
   }

   LAB_00109641:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<Color const&>::ptrcall(Object*, void const**, void*) const */void MethodBindT<Color_const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x001096a9. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *param_3);
      return;
   }

   LAB_00109821:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<Mesh::PrimitiveType, Ref<Material> const&>::validated_call(Object*, Variant const**,
   Variant*) const */void MethodBindT<Mesh::PrimitiveType,Ref<Material>const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   long lVar1;
   Object *pOVar2;
   char cVar3;
   Object *pOVar4;
   ...
   if (pOVar4 != local_68) {
      if (pOVar4 == (Object*)0x0) {
         if (local_68 != (Object*)0x0) {
            local_68 = (Object*)0x0;
            LAB_001098f0:cVar3 = RefCounted::unreference();
            if (cVar3 != '\0') {
               cVar3 = predelete_handler(pOVar2);
               if (cVar3 != '\0') {
                  ( **(code**)( *(long*)pOVar2 + 0x140 ) )(pOVar2);
         ...
         if (pOVar2 != pOVar4) {
            ...
            if (pOVar2 != (Object*)0x0) goto LAB_001098f0;
         }
   ...
   LAB_00109939:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<Mesh::PrimitiveType, Ref<Material> const&>::ptrcall(Object*, void const**, void*)
   const */void MethodBindT<Mesh::PrimitiveType,Ref<Material>const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   long lVar1;
   Object *pOVar2;
   char cVar3;
   long *plVar4;
   ...
   if (( *(long**)( (long)param_3 + 8 ) == (long*)0x0 ) || ( local_48 = (Object*)**(long**)( (long)param_3 + 8 ) ),local_48 == (Object*)0x0) {
      LAB_00109bbd:local_48 = (Object*)0x0;
   }
 else {
      cVar3 = RefCounted::init_ref();
      if (cVar3 == '\0') goto LAB_00109bbd;
   }
   ...
   LAB_00109be8:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<Vector2 const&>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<Vector2_const&>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   if (in_R8D < 2) {
      ...
      if (pVVar10 == (Variant*)0x0) {
         if (in_R8D != 1) goto LAB_00109ed0;
         LAB_00109ec0:pVVar10 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar10 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_00109ed0:uVar6 = 4;
            goto LAB_00109e75;
         }

         if (in_R8D == 1) goto LAB_00109ec0;
      ...
      *in_R9 = 0;
      ...
      uVar6 = 3;
      LAB_00109e75:*in_R9 = uVar6;
      in_R9[2] = 1;
   }

   LAB_00109e80:*(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindT<Plane const&>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<Plane_const&>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   if (( ( plVar9 != (long*)0x0 ) && ( plVar9[1] != 0 ) ) && ( *(char*)( plVar9[1] + 0x2e ) != '\0' )) {
      ...
      if (local_88 == (char*)*plVar7) {
         ...
         _err_print_error(&_LC92, "./core/object/method_bind.h", 0x154, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: Variant()", (StringName*)&local_88, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_90);
   ...
   if (in_R8D < 2) {
      ...
      if (pVVar10 == (Variant*)0x0) {
         ...
         LAB_0010a1f0:pVVar10 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar10 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_0010a200:uVar6 = 4;
            goto LAB_0010a1a5;
         }
      ...
      *in_R9 = 0;
      ...
      uVar6 = 3;
      LAB_0010a1a5:*in_R9 = uVar6;
      in_R9[2] = 1;
   }

   LAB_0010a1b0:*(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindT<Vector3 const&>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<Vector3_const&>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   if (in_R8D < 2) {
      ...
      if (pVVar11 == (Variant*)0x0) {
         ...
         LAB_0010a520:pVVar11 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar11 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_0010a530:uVar7 = 4;
            goto LAB_0010a4cd;
         }
      ...
      *in_R9 = 0;
      ...
      uVar7 = 3;
      LAB_0010a4cd:*in_R9 = uVar7;
      in_R9[2] = 1;
   }

   LAB_0010a4d8:*(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
...
/* MethodBindT<Color const&>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<Color_const&>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   if (( ( plVar9 != (long*)0x0 ) && ( plVar9[1] != 0 ) ) && ( *(char*)( plVar9[1] + 0x2e ) != '\0' )) {
      ...
      if (local_58 == (char*)*plVar7) {
         ...
         _err_print_error(&_LC92, "./core/object/method_bind.h", 0x154, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: Variant()", (StringName*)&local_58, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
         if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
            StringName::unref();
   ...
   if (in_R8D < 2) {
      pVVar10 = param_2[5];
      if (pVVar10 == (Variant*)0x0) {
         if (in_R8D != 1) goto LAB_0010a860;
         LAB_0010a850:pVVar10 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar10 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_0010a860:uVar6 = 4;
            goto LAB_0010a7fd;
         }

         if (in_R8D == 1) goto LAB_0010a850;
         lVar8 = (long)( (int)lVar2 + -1 );
         if (lVar2 <= lVar8) {
            _err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar8, lVar2, "p_index", "size()", "", false, true);
            _err_flush_stdout();
      ...
      *in_R9 = 0;
      ...
      uVar6 = 3;
      LAB_0010a7fd:*in_R9 = uVar6;
      in_R9[2] = 1;
   }

   LAB_0010a808:*(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
...
/* WARNING: Removing unreachable block (ram,0x0010ac59) *//* WARNING: Removing unreachable block (ram,0x0010ac61) *//* WARNING: Removing unreachable block (ram,0x0010ac71) *//* WARNING: Removing unreachable block (ram,0x0010ac81) *//* void call_with_variant_args_dv<__UnexistingClass, Mesh::PrimitiveType, Ref<Material>
   const&>(__UnexistingClass*, void (__UnexistingClass::*)(Mesh::PrimitiveType, Ref<Material>
   const&), Variant const**, int, Callable::CallError&, Vector<Variant> const&) */void call_with_variant_args_dv<__UnexistingClass,Mesh::PrimitiveType,Ref<Material>const&>(__UnexistingClass *param_1, _func_void_PrimitiveType_Ref_ptr *param_2, Variant **param_3, int param_4, CallError *param_5, Vector *param_6) {
   long lVar1;
   long lVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   if (uVar13 < 3) {
      ...
      iVar6 = 2 - uVar13;
      if (lVar8 == 0) {
         if (iVar6 != 0) goto LAB_0010abf0;
         this(Variant * ) * plVar11;
         LAB_0010ac3d:puVar15 = (undefined4*)plVar11[1];
      }
 else {
         lVar2 = *(long*)( lVar8 + -8 );
         iVar14 = (int)lVar2;
         if (iVar14 < iVar6) {
            LAB_0010abf0:uVar7 = 4;
            goto LAB_0010abf5;
         }

         if (uVar13 == 0) {
            lVar12 = (long)( iVar14 + -2 );
            if (lVar2 <= lVar12) goto LAB_0010aca8;
            this(Variant * )(lVar8 + lVar12 * 0x18);
         }
 else {
            this(Variant * ) * plVar11;
            if (uVar13 == 2) goto LAB_0010ac3d;
         }

         lVar12 = (long)(int)( ( uVar13 ^ 1 ) + ( iVar14 - iVar6 ) );
         if (lVar2 <= lVar12) {
            LAB_0010aca8:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar12, lVar2, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar3 = (code*)invalidInstructionException();
            ( *pcVar3 )();
      ...
      *(undefined4*)param_6 = 0;
      if (( (ulong)param_2 & 1 ) != 0) {
         param_2 = *(_func_void_PrimitiveType_Ref_ptr**)( param_2 + *(long*)( param_1 + (long)param_3 ) + -1 );
      }
...
else{uVar7 = 3;LAB_0010abf5:*(undefined4*)param_6 = uVar7;*(undefined4*)( param_6 + 8 ) = 2;}if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return;}/* MethodBindT<Mesh::PrimitiveType, Ref<Material> const&>::call(Object*, Variant const**, int,
   Callable::CallError&) const */Object *MethodBindT<Mesh::PrimitiveType,Ref<Material>const&>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   long *plVar1;
   undefined4 in_register_00000014;
   ...
   call_with_variant_args_dv<__UnexistingClass,Mesh::PrimitiveType,Ref<Material>const&>(p_Var2, (_func_void_PrimitiveType_Ref_ptr*)param_2[0xb], (Variant**)param_2[0xc], (int)param_4, in_R8, in_R9);
   *(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   LAB_0010ad46:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* WARNING: Control flow encountered bad instruction data *//* Mesh::~Mesh() */void Mesh::~Mesh(Mesh *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* MethodBindT<Mesh::PrimitiveType, Ref<Material> const&>::~MethodBindT() */void MethodBindT<Mesh::PrimitiveType,Ref<Material>const&>::~MethodBindT(MethodBindT<Mesh::PrimitiveType,Ref<Material>const&> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

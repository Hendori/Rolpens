...
int sort32a(undefined8 *param_1, undefined8 *param_2) {
   return ( uint )(*(uint*)*param_2 < *(uint*)*param_1) - ( uint )(*(uint*)*param_1 < *(uint*)*param_2);
}
...
void vorbis_book_clear(undefined8 *param_1) {
   ...
   bVar3 = 0;
   for (int i = 0; i < 5; i++) {
      if ((void*)param_1[( i + 4 )] != (void*)0) {
         free((void*)param_1[( i + 4 )]);
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 vorbis_book_init_encode(undefined8 *param_1, undefined8 *param_2) {
   undefined8 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined4 uVar4;
   ...
   *param_1 = 0;
   ...
   for (uVar6 = ( ulong )(( (int)param_1 - (int)(undefined8*)( ( ulong )(param_1 + 1) & 0xfffffffffffffff8 ) ) + 0x60U >> 3); uVar6 != 0; uVar6 = uVar6 - 1) {
      *puVar8 = 0;
      puVar8 = puVar8 + 1;
   }
...
undefined8 vorbis_book_init_decode(undefined8 *param_1, undefined8 *param_2) {
   ...
   *param_1 = 0;
   ...
   for (uVar16 = ( ulong )(( (int)param_1 - (int)(undefined8*)( ( ulong )(param_1 + 1) & 0xfffffffffffffff8 ) ) + 0x60U >> 3); uVar16 != 0; uVar16 = uVar16 - 1) {
      *puVar14 = 0;
      puVar14 = puVar14 + 1;
   }
...
;
         ...
         *(undefined8*)( puVar26 + lVar4 + -8 ) = 0x100cf3;
         ...
         param_1[5] = pvVar32;
         do {
            *(int*)( local_58 + (long)(int)( *(long*)( (long)local_60 + sVar18 * 8 ) - (long)__ptr >> 2 ) * 4 ) = (int)sVar18;
            sVar18 = sVar18 + 1;
         }
 while ( sVar18 != sVar37 );
         sVar37 = 0;
            ...
            *(undefined4*)( (long)param_1 + 0x4c ) = 0;
            ...
            while (true) {
               if ('\0' < *(char*)( lVar31 + lVar12 )) {
                  *(char*)( param_1[7] + (long)*(int*)( (long)local_50 + (long)iVar35 * 4 ) ) = *(char*)( lVar31 + lVar12 );
...
;
               ...
               *(undefined8*)( puVar26 + lVar4 + -8 ) = 0x100ec5;
               ...
               do {
                  iVar9 = iVar8 + 1;
                  *(int*)( (long)pvVar32 + ( ulong )(iVar8 << ( (byte)uVar16 & 0x1f ) | uVar7) * 4 ) = (int)lVar31 + 1;
 ...
 while ( iVar35 != lVar31 );
            LAB_00100f15:iVar35 = (int)local_58;
         }
 ...
 while ( iVar28 != iVar36 );
   ...
   LAB_00100ba2:uVar11 = 0;
   LAB_00100ba4:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar11;
   }

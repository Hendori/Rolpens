...
/* ViewPanner::release_pan_key() */void ViewPanner::release_pan_key(ViewPanner *this) {
   *(undefined2*)( this + 0x188 ) = 0;
   return;
}
/* ViewPanner::set_callbacks(Callable, Callable) */void ViewPanner::set_callbacks(ViewPanner *this, Callable *param_2, Callable *param_3) {
   Callable::operator =((Callable*)( this + 0x198 ), param_2);
   Callable::operator =((Callable*)( this + 0x1a8 ), param_3);
   return;
}
/* ViewPanner::set_control_scheme(ViewPanner::ControlScheme) */void ViewPanner::set_control_scheme(ViewPanner *this, undefined4 param_2) {
   *(undefined4*)( this + 0x1b8 ) = param_2;
   return;
}
/* ViewPanner::set_enable_rmb(bool) */void ViewPanner::set_enable_rmb(ViewPanner *this, bool param_1) {
   this[0x18b] = (ViewPanner)param_1;
   return;
}
/* ViewPanner::set_pan_shortcut(Ref<Shortcut>) */void ViewPanner::set_pan_shortcut(ViewPanner *this, long *param_2) {
   Object *pOVar1;
   Object *pOVar2;
   char cVar3;
...
/* ViewPanner::set_simple_panning_enabled(bool) */void ViewPanner::set_simple_panning_enabled(ViewPanner *this, bool param_1) {
   this[0x18c] = (ViewPanner)param_1;
   return;
}
/* ViewPanner::set_scroll_speed(int) */void ViewPanner::set_scroll_speed(ViewPanner *this, int param_1) {
   if (0 < param_1) {
      *(int*)( this + 0x17c ) = param_1;
      return;
   }

   _err_print_error("set_scroll_speed", "scene/gui/view_panner.cpp", 0xc5, "Condition \"p_scroll_speed <= 0\" is true.", 0, 0);
   return;
}
/* ViewPanner::set_scroll_zoom_factor(float) */void ViewPanner::set_scroll_zoom_factor(ViewPanner *this, float param_1) {
   if (_LC9 < param_1) {
      *(float*)( this + 0x180 ) = param_1;
      return;
   }

   _err_print_error("set_scroll_zoom_factor", "scene/gui/view_panner.cpp", 0xca, "Condition \"p_scroll_zoom_factor <= 1.0\" is true.", 0, 0);
   return;
}
/* ViewPanner::set_pan_axis(ViewPanner::PanAxis) */void ViewPanner::set_pan_axis(ViewPanner *this, undefined4 param_2) {
   *(undefined4*)( this + 0x184 ) = param_2;
   return;
}
/* ViewPanner::setup(ViewPanner::ControlScheme, Ref<Shortcut>, bool) */void ViewPanner::setup(ViewPanner *this, undefined4 param_2, long *param_3, ViewPanner param_4) {
   char cVar1;
   Object *pOVar2;
   Object *pOVar3;
   ...
   *(undefined4*)( this + 0x1b8 ) = param_2;
   if (( pOVar3 == (Object*)0x0 ) || ( cVar1 = cVar1 == '\0' )) {
      ...
      if (pOVar2 != (Object*)0x0) {
         *(undefined8*)( this + 400 ) = 0;
         ...
         if (cVar1 != '\0') {
            ...
            if (cVar1 != '\0') {
               LAB_00100345:( **(code**)( *(long*)pOVar2 + 0x140 ) )(pOVar2);
               Memory::free_static(pOVar2, false);
               this[0x189] = (ViewPanner)0x0;
         ...
         *(Object**)( this + 400 ) = pOVar3;
         ...
         if (cVar1 == '\0') {
            *(undefined8*)( this + 400 ) = 0;
            if (pOVar2 != (Object*)0x0) {
               cVar1 = RefCounted::unreference();
               joined_r0x0010032f:if (( cVar1 != '\0' ) && ( cVar1 = cVar1 != '\0' )) goto LAB_00100345;
            }
      ...
      this[0x189] = (ViewPanner)0x0;
      LAB_001002af:cVar1 = RefCounted::unreference();
   ...
   LAB_0010030a:this[0x18c] = param_4;
   return;
}
/* ViewPanner::setup_warped_panning(Viewport*, bool) */void ViewPanner::setup_warped_panning(ViewPanner *this, Viewport *param_1, bool param_2) {
   if (!param_2) {
...
/* ViewPanner::is_panning() const */ViewPanner ViewPanner::is_panning(ViewPanner *this) {
   ViewPanner VVar1;
   VVar1 = this[0x188];
...
/* ViewPanner::set_force_drag(bool) */void ViewPanner::set_force_drag(ViewPanner *this, bool param_1) {
   this[0x18a] = (ViewPanner)param_1;
   return;
}
/* ViewPanner::ViewPanner() */void ViewPanner::ViewPanner(ViewPanner *this) {
   char cVar1;
   Resource *this_00;
   long lVar2;
   Resource *pRVar3;
   ...
   *(undefined1(*) [16])( this + 400 ) = (undefined1[16])0x0;
   ...
   if (( ( local_50 != (Object*)0x0 ) && ( cVar1 = RefCounted::unreference() ),cVar1 != '\0' )) &&( cVar1 = cVar1 != '\0' )(**(code**)( *(long*)local_50 + 0x140 ))(local_50);
   Memory::free_static(local_50, false);
}
this_00 = (Resource*)operator_new(0x248, "");pRVar3 = this_00;for (lVar2 = 0x49; lVar2 != 0; lVar2 = lVar2 + -1) {
   *(undefined8*)pRVar3 = 0;
   pRVar3 = pRVar3 + (ulong)bVar6 * -0x10 + 8;
}
Resource::Resource(this_00);*(undefined***)this_00 = &PTR__initialize_classv_00104838;Array::Array((Array*)( this_00 + 0x240 ));postinitialize_handler((Object*)this_00);cVar1 = RefCounted::init_ref();if (cVar1 == '\0') {
   ...
   *(undefined8*)( this + 400 ) = 0;
   ...
   if (cVar1 != '\0') {
      ...
      if (cVar1 != '\0') {
         LAB_0010068b:( **(code**)( *(long*)pOVar4 + 0x140 ) )(pOVar4);
      ...
      if (cVar1 == '\0') {
         *(undefined8*)( this + 400 ) = 0;
         if (pOVar4 != (Object*)0x0) {
            cVar1 = RefCounted::unreference();
            joined_r0x0010062f:if (( cVar1 != '\0' ) && ( cVar1 = cVar1 != '\0' )) goto LAB_0010068b;
         }
   ...
   LAB_001005da:cVar1 = RefCounted::unreference();
   if (( cVar1 != '\0' ) && ( cVar1 = cVar1 != '\0' )) {
...
pOVar4 = *(Object**)( this + 400 );LAB_0010055e:Shortcut::set_events((Array*)pOVar4);Array::~Array(aAStack_58);if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ViewPanner::gui_input(Ref<InputEvent> const&, Rect2) */uint ViewPanner::gui_input(undefined8 param_1_00, undefined8 param_2, long param_1, long *param_4) {
   Ref *pRVar1;
   char cVar2;
   undefined1 uVar3;
   uint uVar4;
   ...
   if (pOVar8 == (Object*)0x0) {
      pOVar7 = (Object*)0x0;
      LAB_00100ec3:local_98 = (Object*)0x0;
      LAB_00100ecb:uVar4 = 0;
      LAB_00100aed:if (local_98 != (Object*)0x0) {
         LAB_00100e48:cVar2 = RefCounted::unreference();
      ...
      if (pOVar7 == (Object*)0x0) {
         LAB_00100764:local_98 = (Object*)__dynamic_cast(pOVar8, &Object::typeinfo, &InputEventMouseMotion::typeinfo, 0);
         if (local_98 == (Object*)0x0) {
            LAB_001007b0:local_90 = (Object*)__dynamic_cast(pOVar8, &Object::typeinfo, &InputEventMagnifyGesture::typeinfo, 0);
            if (local_90 != (Object*)0x0) {
               ...
               pOVar8 = (Object*)*param_4;
               if (( pOVar8 != (Object*)0x0 ) && ( local_68 = pOVar8 ),cVar2 = RefCounted::reference(),cVar2 != '\0') {
                  uVar14 = InputEventGesture::get_position();
                  uVar15 = InputEventMagnifyGesture::get_factor();
                  Callable::call<float,Vector2,Ref<InputEvent>>(uVar15, uVar14, local_58, param_1 + 0x1a8, &local_68);
               ...
               LAB_00100aba:Callable::call<float,Vector2,Ref<InputEvent>>(uVar10, uVar14, local_58, param_1 + 0x1a8, &local_68);
               if (Variant::needs_deinit[local_58[0]] != '\0') {
                  Variant::_clear_internal();
               }
            ...
            LAB_001007ed:local_90 = (Object*)__dynamic_cast(pOVar8, &Object::typeinfo, &InputEventPanGesture::typeinfo, 0);
            if (local_90 == (Object*)0x0) {
               LAB_0010081f:if (pOVar8 == (Object*)0x0) goto LAB_00100ecb;
               local_90 = (Object*)0x0;
               LAB_00100831:local_88 = (Object*)__dynamic_cast(pOVar8, &Object::typeinfo, &InputEventScreenDrag::typeinfo, 0);
               if (local_88 == (Object*)0x0) {
                  LAB_00100879:pOVar8 = (Object*)__dynamic_cast(pOVar8, &Object::typeinfo, &InputEventKey::typeinfo, 0);
                  if (( pOVar8 == (Object*)0x0 ) || ( cVar2 = cVar2 == '\0' )) {
                     ...
                     if (pRVar1 == (Ref*)0x0) {
                        LAB_00101300:uVar4 = 0;
                     }
 else {
                        local_68 = (Object*)0x0;
                        pOVar9 = (Object*)__dynamic_cast(pOVar8, &Object::typeinfo, &InputEvent::typeinfo, 0);
                        if (( pOVar9 != (Object*)0x0 ) && ( local_68 = pOVar9 ),cVar2 = RefCounted::reference(),cVar2 == '\0') {
                           local_68 = (Object*)0x0;
                        }
                     ...
                     *(undefined1*)( param_1 + 0x189 ) = uVar3;
                     if (*(char*)( param_1 + 0x18c ) == '\0') {
                        ...
                        LAB_00100d43:*(undefined1*)( param_1 + 0x188 ) = uVar3;
                     }
               ...
               if (local_88 != (Object*)0x0) {
                  LAB_001008ac:cVar2 = RefCounted::unreference();
                  if (( cVar2 != '\0' ) && ( cVar2 = cVar2 != '\0' )) {
         ...
         uVar14 = InputEventGesture::get_position();
         Callable::call<float,Vector2,Ref<InputEvent>>(uVar11, uVar14, local_58, param_1 + 0x1a8, &local_68);
         if (Variant::needs_deinit[local_58[0]] != '\0') {
            Variant::_clear_internal();
         }
      ...
      LAB_00100adb:cVar2 = RefCounted::unreference();
      if (( cVar2 != '\0' ) && ( cVar2 = cVar2 != '\0' )) {
   ...
   if (cVar2 == '\0') {
      local_98 = (Object*)0x0;
      pOVar8 = (Object*)*param_4;
      LAB_001007a7:if (pOVar8 == (Object*)0x0) goto LAB_00100ecb;
      goto LAB_001007b0;
   }
   ...
   local_68 = pOVar8;
   if (( ( pVVar12 == (Vector2*)0x0 ) || ( local_70 = local_70 <= 0.0 ) ) || ( fStack_6c = fStack_6c <= 0.0 )) {
      if (( pOVar8 == (Object*)0x0 ) || ( cVar2 = cVar2 == '\0' )) {
         local_68 = (Object*)0x0;
         ...
         LAB_00100e14:cVar2 = RefCounted::unreference();
         if (( cVar2 != '\0' ) && ( cVar2 = cVar2 != '\0' )) {
            ( **(code**)( *(long*)pOVar8 + 0x140 ) )(pOVar8);
            Memory::free_static(pOVar8, false);
         }
...
uVar4 = RefCounted::reference();if ((char)uVar4 == '\0') {
   pOVar8 = (Object*)*param_4;
   pOVar7 = (Object*)0x0;
   LAB_0010075b:if (pOVar8 == (Object*)0x0) goto LAB_00100ec3;
   goto LAB_00100764;
}
iVar5 = InputEventMouseButton::get_button_index();iVar6 = InputEventMouseButton::get_button_index();fVar13 = (float)(int)( ( uint )(iVar5 == 5) - ( uint )(iVar6 == 4) );iVar5 = InputEventMouseButton::get_button_index();iVar6 = InputEventMouseButton::get_button_index();if (( ( (float)(int)( ( uint )(iVar5 == 7) - ( uint )(iVar6 == 6) ) == 0.0 ) && ( fVar13 == 0.0 ) ) || ( cVar2 = cVar2 == '\0' )) {
   LAB_001009b0:cVar2 = InputEventWithModifiers::is_alt_pressed();
   if (cVar2 == '\0') {
      iVar5 = InputEventMouseButton::get_button_index();
      if (( ( ( iVar5 != 3 ) && ( ( *(char*)( param_1 + 0x18b ) == '\0' || ( iVar5 = InputEventMouseButton::get_button_index() ),iVar5 != 2 ) ) ) ) && ( ( *(char*)( param_1 + 0x18c ) != '\0' || ( ( iVar5 = InputEventMouseButton::get_button_index() ),iVar5 != 1 || ( ( *(char*)( param_1 + 0x188 ) == '\0' && ( *(char*)( param_1 + 0x189 ) == '\0' ) ) ) ) ) )) {
         pOVar8 = (Object*)*param_4;
         goto LAB_0010075b;
      }
   ...
   if (cVar2 == '\0') {
      ...
      LAB_00100b7a:pOVar8 = (Object*)*param_4;
      if (( pOVar8 != (Object*)0x0 ) && ( local_68 = pOVar8 ),cVar2 = RefCounted::reference(),cVar2 != '\0') {
      ...
      LAB_00100fc3:InputEventMouseButton::get_factor();
      ...
      if (( pOVar8 == (Object*)0x0 ) || ( local_68 = pOVar8 ),cVar2 = RefCounted::reference(),cVar2 == '\0') {
         ...
         LAB_00101488:cVar2 = RefCounted::unreference();
         if (( cVar2 != '\0' ) && ( cVar2 = cVar2 != '\0' )) {
            ( **(code**)( *(long*)pOVar8 + 0x140 ) )(pOVar8);
            Memory::free_static(pOVar8, false);
         }
...
LAB_001009ce:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return uVar4;
}
...
/* RefCounted::is_class_ptr(void*) const */uint RefCounted::is_class_ptr(RefCounted *this, void *param_1) {
   return (uint)CONCAT71(0x104a, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x104a, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
}
...
/* ViewPanner::is_class_ptr(void*) const */uint ViewPanner::is_class_ptr(ViewPanner *this, void *param_1) {
   return (uint)CONCAT71(0x104a, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x104a, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x104a, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* ViewPanner::_getv(StringName const&, Variant&) const */undefined8 ViewPanner::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* ViewPanner::_setv(StringName const&, Variant const&) */undefined8 ViewPanner::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* ViewPanner::_validate_propertyv(PropertyInfo&) const */void ViewPanner::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* ViewPanner::_property_can_revertv(StringName const&) const */undefined8 ViewPanner::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* ViewPanner::_property_get_revertv(StringName const&, Variant&) const */undefined8 ViewPanner::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* ViewPanner::_notificationv(int, bool) */void ViewPanner::_notificationv(int param_1, bool param_2) {
   return;
}
...
/* Shortcut::is_class_ptr(void*) const */uint Shortcut::is_class_ptr(Shortcut *this, void *param_1) {
   return (uint)CONCAT71(0x104a, (undefined4*)param_1 == &Resource::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x104a, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x104a, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x104a, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
...
/* RefCounted::_get_class_namev() const */undefined8 *RefCounted::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00101ac3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00101ac3;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "RefCounted");
   LAB_00101b2e:return &_get_class_namev();
}
/* Shortcut::~Shortcut() */void Shortcut::~Shortcut(Shortcut *this) {
   *(undefined***)this = &PTR__initialize_classv_00104838;
   Array::~Array((Array*)( this + 0x240 ));
...
/* ViewPanner::_get_class_namev() const */undefined8 *ViewPanner::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00101cd3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00101cd3;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "ViewPanner");
         goto LAB_00101d3e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "ViewPanner");
   LAB_00101d3e:return &_get_class_namev();
}
/* ViewPanner::~ViewPanner() */void ViewPanner::~ViewPanner(ViewPanner *this) {
   Object *pOVar1;
   char cVar2;
...
/* ViewPanner::get_class() const */void ViewPanner::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* RefCounted::is_class(String const&) const */undefined8 RefCounted::is_class(RefCounted *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_001021ff:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
 ...
 while ( !bVar9 );
         ...
         LAB_00102363:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
      ...
      LAB_001022b3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* ViewPanner::is_class(String const&) const */undefined8 ViewPanner::is_class(ViewPanner *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *__s;
   long lVar3;
 ...
 while ( !bVar8 );
      ...
      LAB_0010248f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_00102543:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* Shortcut::is_class(String const&) const */undefined8 Shortcut::is_class(Shortcut *this, String *param_1) {
 ...
 while ( !bVar9 );
   ...
   LAB_0010283c:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* ViewPanner::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void ViewPanner::_get_property_listv(ViewPanner *this, List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   undefined1(*pauVar4)[16];
...
/* ViewPanner::_initialize_classv() */void ViewPanner::_initialize_classv(void) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   long local_60;
   ...
   long local_30;
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   if (initialize_class() != '\0') goto LAB_00103384;
   if (RefCounted::initialize_class() == '\0') {
      ...
      lVar2 = local_58;
      if (local_58 == 0) {
         LAB_0010348e:if ((code*)_GLOBAL_OFFSET_TABLE_ != Object::_bind_methods) {
            LAB_0010349e:RefCounted::_bind_methods();
         }
   ...
   initialize_class()::initialized =
   '\x01';
   LAB_00103384:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* Variant Callable::call<float, Vector2, Ref<InputEvent> >(float, Vector2, Ref<InputEvent>) const
    */CallError *Callable::call<float,Vector2,Ref<InputEvent>>(float param_1, undefined8 param_2, CallError *param_3, Variant **param_4, undefined8 *param_5) {
   Variant *pVVar1;
   Variant *pVVar2;
   long in_FS_OFFSET;
   undefined8 local_d0;
...
/* Variant Callable::call<Vector2, Ref<InputEvent> >(Vector2, Ref<InputEvent>) const */CallError *Callable::call<Vector2,Ref<InputEvent>>(undefined8 param_1, CallError *param_2, Variant **param_3, undefined8 *param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   long in_FS_OFFSET;
   undefined8 local_b0;
...
/* WARNING: Control flow encountered bad instruction data *//* ViewPanner::~ViewPanner() */void ViewPanner::~ViewPanner(ViewPanner *this) {

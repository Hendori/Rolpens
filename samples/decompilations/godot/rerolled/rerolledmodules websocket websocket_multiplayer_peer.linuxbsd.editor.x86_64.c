...
/* WebSocketMultiplayerPeer::_clear() */void WebSocketMultiplayerPeer::_clear(WebSocketMultiplayerPeer *this) {
         ...
         do {
            if (*(int*)( *(long*)( this + 0x218 ) + lVar6 ) != 0) {
               *(int*)( *(long*)( this + 0x218 ) + lVar6 ) = 0;
               ...
               if (( *(long*)( (long)pvVar2 + 0x18 ) != 0 ) && ( cVar5 = cVar5 != '\0' )) {
 ...
 while ( lVar6 != (ulong)uVar1 << 2 );
   ...
   if (( *(long*)( this + 0x1e8 ) != 0 ) && ( cVar5 = cVar5 != '\0' )) {
         ...
         do {
            if (*(int*)( *(long*)( this + 0x1c8 ) + lVar6 ) != 0) {
               *(int*)( *(long*)( this + 0x1c8 ) + lVar6 ) = 0;
               ...
               for (int i = 0; i < 3; i++) {
                  if (( *(long*)( (long)pvVar2 + ( -8*i + 48 ) ) != 0 ) && ( cVar5 = cVar5 != '\0' )) {
 ...
 while ( lVar6 != (ulong)uVar1 << 2 );
   ...
   if (( *(long*)( this + 0x1f0 ) != 0 ) && ( cVar5 = cVar5 != '\0' )) {
...
return iVar4;}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WebSocketMultiplayerPeer::_poll_server() */void WebSocketMultiplayerPeer::_poll_server(WebSocketMultiplayerPeer *this) {
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (*(int*)( this + 0x1f8 ) == 2) {
      if (( *(long*)( this + 0x1e8 ) != 0 ) && ( cVar27 = cVar27 != '\0' )) {
         ...
         if (( cVar27 == '\0' ) && ( cVar27 = TCPServer::is_connection_available() ),cVar27 != '\0') {
            ...
            *puVar37 = local_b8;
            if (pRStack_b0 != (Ref*)pOVar48) {
               ...
               if (( pRStack_b0 != (Ref*)0x0 ) && ( cVar27 = cVar27 == '\0' )) {
                  puVar37[1] = 0;
               }
         ...
         if (local_a8 != pOVar48) {
            puVar37[2] = local_a8;
            if (( local_a8 != (Object*)0x0 ) && ( cVar27 = cVar27 == '\0' )) {
               puVar37[2] = 0;
            }
...
if (( ( pRVar49 != (Ref*)0x0 ) && ( cVar27 = RefCounted::unreference() ),cVar27 != '\0' )) &&( cVar27 = cVar27 != '\0' )(**(code**)( *(long*)pRVar49 + 0x140 ))(pRVar49);Memory::free_static(pRVar49, false);}
   ...
   do if (cVar27 == '\0') if (( cVar27 != '\0' ) && ( cVar27 = cVar27 != '\0' )) {
...
;
            ...
            *(undefined4*)( lVar6 + uVar47 * 4 ) = 0;
            ...
            for (int i = 0; i < 3; i++) {
               if (( plVar38[( 6 - i )] != 0 ) && ( cVar27 = cVar27 != '\0' )) {
...
LAB_00104bca:
            ...
            plVar46 = *(long **)(this + 0x220);local_98 = local_98 & 0xffffffff;
            pRVar49 = pRStack_a0;
            if (plVar46 != (long*)0x0) goto LAB_00104a11;
         }
;
...
;
 ...
 while ( iVar29 != 0 );
         ...
         if (( cVar27 != '\0' ) && ( cVar27 = cVar27 != '\0' )) goto code_r0x00104b80;
...
/* Ref<StreamPeer>::unref() */void Ref<StreamPeer>::unref(Ref<StreamPeer> *this) {
   Object *pOVar1;
   char cVar2;
   if (*(long*)this != 0) {
      cVar2 = RefCounted::unreference();
...
/* Ref<StreamPeerTLS>::unref() */void Ref<StreamPeerTLS>::unref(Ref<StreamPeerTLS> *this) {
   Object *pOVar1;
   char cVar2;
   if (*(long*)this != 0) {
      cVar2 = RefCounted::unreference();
...
GetTypeInfo<Error,void>::get_class_info(GetTypeInfo<Error,void> *this){
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);
   LAB_0010c6e5:CowData<String>::_unref((CowData<String>*)&local_60);
...
/* WebSocketMultiplayerPeer::_poll_server() [clone .cold] */void WebSocketMultiplayerPeer::_poll_server(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* WARNING: Removing unreachable block (ram,0x0010c9b8) *//* String vformat<StringName>(String const&, StringName const) */undefined8 *vformat<StringName>(undefined8 *param_1, bool *param_2, StringName *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* MethodBindT<float>::ptrcall(Object*, void const**, void*) const */void MethodBindT<float>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   LAB_0010cfe9:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (( ( plVar4 != (long*)0x0 ) && ( plVar4[1] != 0 ) ) && ( *(char*)( plVar4[1] + 0x2e ) != '\0' )) {
      ...
      if (local_58 == (char*)*plVar3) {
         ...
         _err_print_error(&_LC115, "./core/object/method_bind.h", 0x267, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_58, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
         if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
            StringName::unref();
   ...
   LAB_0010d140:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTRC<float>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTRC<float>::validated_call(MethodBindTRC<float> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   *(double*)( param_3 + 8 ) = (double)fVar3;
   LAB_0010d358:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<float>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<float>::ptrcall(MethodBindTRC<float> *this, Object *param_1, void **param_2, void *param_3) {
   ...
   *(double*)param_3 = (double)fVar3;
   LAB_0010d517:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<int>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<int>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   LAB_0010d861:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<int>::ptrcall(Object*, void const**, void*) const */void MethodBindT<int>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   LAB_0010da41:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindTRC<int>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindTRC<int>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   LAB_0010db10:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTRC<int>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTRC<int>::validated_call(MethodBindTRC<int> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   *(long*)( param_3 + 8 ) = (long)iVar1;
   LAB_0010dd24:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<int>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<int>::ptrcall(MethodBindTRC<int> *this, Object *param_1, void **param_2, void *param_3) {
   ...
   *(long*)param_3 = (long)iVar1;
   LAB_0010ded3:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<Vector<String> const&>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<Vector<String>const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   LAB_0010e219:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<Vector<String> const&>::ptrcall(Object*, void const**, void*) const */void MethodBindT<Vector<String>const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   LAB_0010e3f1:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindTRC<Vector<String>>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindTRC<Vector<String>>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   LAB_0010e4d0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTRC<Vector<String>>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTRC<Vector<String>>::validated_call(MethodBindTRC<Vector<String>> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   LAB_0010e717:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<Vector<String>>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<Vector<String>>::ptrcall(MethodBindTRC<Vector<String>> *this, Object *param_1, void **param_2, void *param_3) {
   ...
   CowData<String>::_unref((CowData<String>*)local_40);
   LAB_0010e8f3:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<int, int>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTRC<int,int>::validated_call(MethodBindTRC<int,int> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   *(long*)( param_3 + 8 ) = (long)iVar1;
   LAB_0010ea9a:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<int, int>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<int,int>::ptrcall(MethodBindTRC<int,int> *this, Object *param_1, void **param_2, void *param_3) {
   ...
   *(long*)param_3 = (long)iVar1;
   LAB_0010ec78:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<IPAddress, int>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTRC<IPAddress,int>::validated_call(MethodBindTRC<IPAddress,int> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_78);
   LAB_0010eeb7:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<IPAddress, int>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<IPAddress,int>::ptrcall(MethodBindTRC<IPAddress,int> *this, Object *param_1, void **param_2, void *param_3) {
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   LAB_0010f0cf:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<Ref<WebSocketPeer>, int>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<Ref<WebSocketPeer>,int>::ptrcall(MethodBindTRC<Ref<WebSocketPeer>,int> *this, Object *param_1, void **param_2, void *param_3) {
   char cVar1;
   code *pcVar2;
   Object *pOVar3;
   long *plVar4;
      ...
      *(Object**)param_3 = pOVar3;
      if (pOVar3 == (Object*)0x0) {
         ...
         if (pOVar5 != (Object*)0x0) {
            LAB_0010f351:cVar1 = RefCounted::unreference();
            if (cVar1 != '\0') {
   ...
   LAB_0010f309:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTR<Error, String const&, Ref<TLSOptions> >::validated_call(Object*, Variant const**,
   Variant*) const */void MethodBindTR<Error,String_const&,Ref<TLSOptions>>::validated_call(MethodBindTR<Error,String_const&,Ref<TLSOptions>> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   long lVar1;
   Object *pOVar2;
   char cVar3;
   uint uVar4;
   ...
   if (pOVar5 != local_68) {
      if (pOVar5 == (Object*)0x0) {
         if (local_68 != (Object*)0x0) {
            local_68 = (Object*)0x0;
            LAB_0010f5fb:cVar3 = RefCounted::unreference();
            if (cVar3 != '\0') {
   ...
   *(ulong*)( param_3 + 8 ) = (ulong)uVar4;
   ...
   LAB_0010f64c:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTR<Error, int, IPAddress, Ref<TLSOptions> >::validated_call(Object*, Variant const**,
   Variant*) const */void MethodBindTR<Error,int,IPAddress,Ref<TLSOptions>>::validated_call(MethodBindTR<Error,int,IPAddress,Ref<TLSOptions>> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   long lVar1;
   Object *pOVar2;
   char cVar3;
   uint uVar4;
   ...
   if (pOVar5 != local_68) {
      if (pOVar5 == (Object*)0x0) {
         if (local_68 != (Object*)0x0) {
            local_68 = (Object*)0x0;
            LAB_0010f925:cVar3 = RefCounted::unreference();
            if (cVar3 != '\0') {
               cVar3 = predelete_handler(pOVar2);
               if (cVar3 != '\0') {
                  ( **(code**)( *(long*)pOVar2 + 0x140 ) )(pOVar2);
   ...
   *(ulong*)( param_3 + 8 ) = (ulong)uVar4;
   ...
   LAB_0010f9a4:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTR<Error, String const&, Ref<TLSOptions> >::ptrcall(Object*, void const**, void*) const
    */void MethodBindTR<Error,String_const&,Ref<TLSOptions>>::ptrcall(MethodBindTR<Error,String_const&,Ref<TLSOptions>> *this, Object *param_1, void **param_2, void *param_3) {
   long lVar1;
   Object *pOVar2;
   char cVar3;
   uint uVar4;
   ...
   if (( (long*)param_2[1] == (long*)0x0 ) || ( local_58 = *param_2[1] ),local_58 == (Object*)0x0) {
      LAB_0010fc32:local_58 = (Object*)0x0;
   }
 else {
   ...
   *(ulong*)param_3 = (ulong)uVar4;
   ...
   LAB_0010fc61:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTR<Error, int, IPAddress, Ref<TLSOptions> >::ptrcall(Object*, void const**, void*)
   const */void MethodBindTR<Error,int,IPAddress,Ref<TLSOptions>>::ptrcall(MethodBindTR<Error,int,IPAddress,Ref<TLSOptions>> *this, Object *param_1, void **param_2, void *param_3) {
   long lVar1;
   Object *pOVar2;
   char cVar3;
   uint uVar4;
   ...
   if (( (long*)param_2[2] == (long*)0x0 ) || ( local_68 = *param_2[2] ),local_68 == (Object*)0x0) {
      LAB_0010fe72:local_68 = (Object*)0x0;
   }
 else {
      cVar3 = RefCounted::init_ref();
   ...
   *(ulong*)param_3 = (ulong)uVar4;
   ...
   LAB_0010fecb:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<Ref<WebSocketPeer>, int>::call(Object*, Variant const**, int, Callable::CallError&)
   const */Object *MethodBindTRC<Ref<WebSocketPeer>,int>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   long lVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (( ( plVar10 != (long*)0x0 ) && ( plVar10[1] != 0 ) ) && ( *(char*)( plVar10[1] + 0x2e ) != '\0' )) {
      ...
      if (local_68 == (Object*)*plVar8) {
         ...
         String::parse_latin1((StrRange*)&local_70);
         vformat<StringName>((StringName*)&local_68, (StrRange*)&local_70, &local_78);
         _err_print_error(&_LC115, "./core/object/method_bind.h", 0x267, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_68, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);
         if (( StringName::configured != '\0' ) && ( local_78 != 0 )) {
            StringName::unref();
   ...
   if (in_R8D < 2) {
      ...
      if (pVVar11 == (Variant*)0x0) {
         ...
         LAB_001101e0:pVVar11 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar11 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_001101f0:uVar7 = 4;
            goto LAB_00110195;
         }
      ...
      *in_R9 = 0;
      ...
      ( *(code*)pVVar12 )((Ref<WebSocketPeer>*)&local_68, (Variant*)( (long)plVar10 + (long)pVVar1 ), iVar6);
      ...
      *(undefined8*)( param_1 + 0x10 ) = uStack_48;
      ...
      uVar7 = 3;
      LAB_00110195:*in_R9 = uVar7;
      in_R9[2] = 1;
   }

   LAB_001101a0:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (( ( plVar10 != (long*)0x0 ) && ( plVar10[1] != 0 ) ) && ( *(char*)( plVar10[1] + 0x2e ) != '\0' )) {
      ...
      if (local_78 == (char*)*plVar8) {
         ...
         _err_print_error(&_LC115, "./core/object/method_bind.h", 0x267, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_78, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_78);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_80);
         if (( StringName::configured != '\0' ) && ( local_88 != 0 )) {
            StringName::unref();
   ...
   if (in_R8D < 2) {
      ...
      if (pVVar11 == (Variant*)0x0) {
         ...
         LAB_00110560:pVVar11 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar11 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_00110570:uVar7 = 4;
            goto LAB_00110525;
         }
      ...
      *(undefined8*)( param_1 + 0x10 ) = uStack_38;
      ...
      uVar7 = 3;
      LAB_00110525:*in_R9 = uVar7;
      in_R9[2] = 1;
   }

   LAB_00110530:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   if (in_R8D < 2) {
      ...
      if (pVVar11 == (Variant*)0x0) {
         ...
         LAB_001108e0:pVVar11 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar11 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_001108f0:uVar7 = 4;
            goto LAB_001108a5;
         }
      ...
      *(undefined8*)( param_1 + 0x10 ) = uStack_38;
      ...
      uVar7 = 3;
      LAB_001108a5:*in_R9 = uVar7;
      in_R9[2] = 1;
   }

   LAB_001108b0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindT<Vector<String> const&>::call(Object*, Variant const**, int, Callable::CallError&)
   ...
   if (( ( plVar9 != (long*)0x0 ) && ( plVar9[1] != 0 ) ) && ( *(char*)( plVar9[1] + 0x2e ) != '\0' )) {
      ...
      if (local_48 == (char*)*plVar7) {
         ...
         String::parse_latin1((StrRange*)&local_50);
         vformat<StringName>((StringName*)&local_48, (StrRange*)&local_50, &local_58);
         _err_print_error(&_LC115, "./core/object/method_bind.h", 0x154, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: Variant()", (StringName*)&local_48, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_48);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
         if (( StringName::configured != '\0' ) && ( local_58 != 0 )) {
            StringName::unref();
   ...
   if (in_R8D < 2) {
      ...
      if (pVVar10 == (Variant*)0x0) {
         ...
         LAB_00110ce0:pVVar10 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar10 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_00110cf0:uVar6 = 4;
            goto LAB_00110c95;
         }
      ...
      *in_R9 = 0;
      ...
      uVar6 = 3;
      LAB_00110c95:*in_R9 = uVar6;
      in_R9[2] = 1;
   }

   LAB_00110ca0:*(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTR<Error, int, IPAddress, Ref<TLSOptions> >::call(Object*, Variant const**, int,
   Callable::CallError&) const */Object *MethodBindTR<Error,int,IPAddress,Ref<TLSOptions>>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (( ( plVar13 != (long*)0x0 ) && ( plVar13[1] != 0 ) ) && ( *(char*)( plVar13[1] + 0x2e ) != '\0' )) {
      ...
      if (local_a8 == (Object*)*plVar11) {
         ...
         _err_print_error(&_LC115, "./core/object/method_bind.h", 0x207, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_a8, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_a8);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_b0);
 ...
 while ( lVar9 != 3 );
         ...
         if (pOVar10 != local_a8) {
            if (pOVar10 == (Object*)0x0) {
               if (local_a8 != (Object*)0x0) {
                  local_a8 = (Object*)0x0;
                  LAB_0011100d:cVar6 = RefCounted::unreference();
                  if (cVar6 != '\0') {
   ...
   *in_R9 = uVar7;
   in_R9[2] = 3;
   LAB_00111132:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTR<Error, String const&, Ref<TLSOptions> >::call(Object*, Variant const**, int,
   Callable::CallError&) const */Object *MethodBindTR<Error,String_const&,Ref<TLSOptions>>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   long lVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (( ( plVar12 != (long*)0x0 ) && ( plVar12[1] != 0 ) ) && ( *(char*)( plVar12[1] + 0x2e ) != '\0' )) {
      ...
      if (local_68 == (char*)*plVar10) {
         ...
         String::parse_latin1((StrRange*)&local_70);
         vformat<StringName>((StringName*)&local_68, (StrRange*)&local_70, &local_78);
         _err_print_error(&_LC115, "./core/object/method_bind.h", 0x207, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_68, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);
         if (( StringName::configured != '\0' ) && ( local_78 != 0 )) {
            StringName::unref();
   ...
   if (pVVar16 == (Variant*)0x0) {
      ...
      LAB_0011162d:pVVar16 = *(Variant**)( param_4 + 8 );
   }
 else {
      lVar2 = *(long*)( pVVar16 + -8 );
      iVar14 = (int)lVar2;
      if (iVar14 < iVar7) {
         LAB_00111610:uVar8 = 4;
         goto LAB_001115d5;
      }
      ...
      if (lVar2 <= lVar11) {
         LAB_00111750:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar11, lVar2, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
   ...
   *in_R9 = 0;
   ...
   if (pOVar9 != local_70) {
      if (pOVar9 == (Object*)0x0) {
         if (local_70 != (Object*)0x0) {
            local_70 = (Object*)0x0;
            LAB_00111507:cVar6 = RefCounted::unreference();
            if (cVar6 != '\0') {
               cVar6 = predelete_handler(pOVar5);
               if (cVar6 != '\0') {
                  ( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
   ...
   iVar7 = ( *(code*)pVVar15 )((Variant*)( (long)plVar12 + (long)pVVar1 ), (Variant*)&local_68, &local_70);
   ...
   *(undefined8*)( param_1 + 0x10 ) = uStack_48;
   ...
   LAB_001115e0:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTRC<Ref<WebSocketPeer>, int>::validated_call(Object*, Variant const**, Variant*) const
    */void MethodBindTRC<Ref<WebSocketPeer>,int>::validated_call(MethodBindTRC<Ref<WebSocketPeer>,int> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   Object *pOVar1;
   char cVar2;
   code *pcVar3;
   long *plVar4;
...
/* void call_with_variant_args_dv<__UnexistingClass, float>(__UnexistingClass*, void
   ...
   if (lVar1 == 0) {
      ...
      if ((int)lVar2 < (int)( uVar8 ^ 1 )) {
         LAB_00111c40:uVar6 = 4;
         LAB_00111bdd:*(undefined4*)param_6 = uVar6;
   ...
   LAB_00111b5b:*(undefined4*)param_6 = 0;
...
/* MethodBindT<float>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<float>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   *(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   LAB_00111ca6:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* void call_with_variant_args_dv<__UnexistingClass, int>(__UnexistingClass*, void
   ...
   if (lVar1 == 0) {
      ...
      lVar2 = *(long*)( lVar1 + -8 );
      if ((int)lVar2 < (int)( uVar8 ^ 1 )) {
         LAB_00111fd0:uVar6 = 4;
         LAB_00111f6d:*(undefined4*)param_6 = uVar6;
         *(undefined4*)( param_6 + 8 ) = 1;
         return;
      }
   ...
   this * (Variant**)CONCAT44(in_register_0000000c, param_4);
   LAB_00111eeb:*(undefined4*)param_6 = 0;
   if (( (ulong)param_2 & 1 ) != 0) {
...
/* MethodBindT<int>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<int>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   *(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   LAB_00112036:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* void call_get_argument_type_info_helper<Ref<TLSOptions> >(int, int&, PropertyInfo&) */void call_get_argument_type_info_helper<Ref<TLSOptions>>(int param_1, int *param_2, PropertyInfo *param_3) {
   long lVar1;
   int iVar2;
   long in_FS_OFFSET;
   undefined8 local_90;
...
/* void call_get_argument_type_info<String const&, Ref<TLSOptions> >(int, PropertyInfo&) */void call_get_argument_type_info<String_const&,Ref<TLSOptions>>(int param_1, PropertyInfo *param_2) {
   long lVar1;
   long in_FS_OFFSET;
   int local_94;
   undefined8 local_90;
...
/* MethodBindTR<Error, String const&, Ref<TLSOptions> >::_gen_argument_type_info(int) const */GetTypeInfo<Error,void> *MethodBindTR<Error,String_const&,Ref<TLSOptions>>::_gen_argument_type_info(int param_1) {
   undefined1 auVar1[16];
   undefined8 uVar2;
   undefined8 uVar3;
   uint in_EDX;
...
/* MethodBindTR<Error, int, IPAddress, Ref<TLSOptions> >::_gen_argument_type_info(int) const */GetTypeInfo<Error,void> *MethodBindTR<Error,int,IPAddress,Ref<TLSOptions>>::_gen_argument_type_info(int param_1) {
   undefined1 auVar1[16];
   undefined1 auVar2[16];
   undefined1 auVar3[16];
   undefined8 uVar4;
   ...
   if (in_EDX == 0) {
      ...
      LAB_00112887:local_a8 = CONCAT44(local_a8._4_4_, local_78._0_4_);
      ...
      if (in_EDX == 1) {
         ...
         local_c0 = 0;
         PropertyInfo::PropertyInfo((PropertyInfo*)&local_78, 4, (CowData<char32_t>*)&local_c0, 0, (String*)&local_b8, 6, &local_b0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_c0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_b8);
         if (( StringName::configured != '\0' ) && ( local_b0 != 0 )) {
            StringName::unref();
   ...
   *(undefined4*)( this + 0x28 ) = local_80;
   CowData<char32_t>::_unref((CowData<char32_t>*)local_a0);
   LAB_00112739:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Control flow encountered bad instruction data *//* MethodBindTRC<Ref<WebSocketPeer>, int>::~MethodBindTRC() */void MethodBindTRC<Ref<WebSocketPeer>,int>::~MethodBindTRC(MethodBindTRC<Ref<WebSocketPeer>,int> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* MethodBindTR<Error, int, IPAddress, Ref<TLSOptions> >::~MethodBindTR() */void MethodBindTR<Error,int,IPAddress,Ref<TLSOptions>>::~MethodBindTR(MethodBindTR<Error,int,IPAddress,Ref<TLSOptions>> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* MethodBindTR<Error, String const&, Ref<TLSOptions> >::~MethodBindTR() */void MethodBindTR<Error,String_const&,Ref<TLSOptions>>::~MethodBindTR(MethodBindTR<Error,String_const&,Ref<TLSOptions>> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

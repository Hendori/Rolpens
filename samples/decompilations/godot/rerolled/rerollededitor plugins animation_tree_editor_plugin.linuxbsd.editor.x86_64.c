/* AnimationTreeEditor::_animation_list_changed() */void AnimationTreeEditor::_animation_list_changed(void) {
...
/* AnimationTreeEditorPlugin::make_visible(bool) */void AnimationTreeEditorPlugin::make_visible(AnimationTreeEditorPlugin *this, bool param_1) {
   char cVar1;
   if (param_1) {
      CanvasItem::show();
...
/* CowData<AnimationTreeNodeEditorPlugin*>::_copy_on_write() [clone .isra.0] */void CowData<AnimationTreeNodeEditorPlugin*>::_copy_on_write(CowData<AnimationTreeNodeEditorPlugin*> *this) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   undefined8 *puVar4;
...
/* AnimationTreeEditor::can_edit(Ref<AnimationNode> const&) const */undefined8 AnimationTreeEditor::can_edit(AnimationTreeEditor *this, Ref *param_1) {
   long *plVar1;
   long lVar2;
   undefined8 uVar3;
   long lVar4;
...
/* AnimationTreeEditorPlugin::~AnimationTreeEditorPlugin() */void AnimationTreeEditorPlugin::~AnimationTreeEditorPlugin(AnimationTreeEditorPlugin *this) {
...
/* AnimationTreeEditorPlugin::handles(Object*) const */undefined4 AnimationTreeEditorPlugin::handles(AnimationTreeEditorPlugin *this, Object *param_1) {
   code *pcVar1;
   undefined4 uVar2;
   long in_FS_OFFSET;
   undefined8 local_40;
...
/* AnimationTreeEditor::get_base_path() */void AnimationTreeEditor::get_base_path(void) {
   long lVar1;
   code *pcVar2;
   long lVar3;
   long in_RSI;
...
;
   lVar4 = 0;
   LAB_0010045c:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar3, lVar4, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
...
/* WARNING: Removing unreachable block (ram,0x00100697) *//* WARNING: Removing unreachable block (ram,0x00100a80) *//* WARNING: Removing unreachable block (ram,0x00100a31) *//* WARNING: Removing unreachable block (ram,0x00100ab5) *//* WARNING: Removing unreachable block (ram,0x00100ac5) *//* WARNING: Removing unreachable block (ram,0x00100a93) *//* WARNING: Removing unreachable block (ram,0x00100ab3) *//* AnimationTreeEditor::_update_path() */void AnimationTreeEditor::_update_path(AnimationTreeEditor *this) {
   code *pcVar1;
   char cVar2;
   int iVar3;
   Object *pOVar4;
...
;
   ...
   if (cVar2 != '\0') {
      pBVar6 = local_78;
      if (( this_00 != (ButtonGroup*)0x0 ) && ( cVar2 = RefCounted::reference() ),pBVar6 = this_00,local_78 = this_00,cVar2 == '\0') {
         local_78 = (ButtonGroup*)0x0;
      }
   ...
   create_custom_callable_function_pointer<AnimationTreeEditor,int>((AnimationTreeEditor*)local_68, (char*)this, (_func_void_int*)"&AnimationTreeEditor::_path_button_pressed");
   ...
   while (true) {
      if (( lVar5 == 0 ) || ( *(long*)( lVar5 + -8 ) <= lVar7 )) {
         if (( ( local_78 != (ButtonGroup*)0x0 ) && ( cVar2 = RefCounted::unreference() ),cVar2 != '\0' )) &&( cVar2 = cVar2 != '\0' )(**(code**)( *(long*)local_78 + 0x140 ))(local_78);
...
lVar5 = 0;LAB_00100956:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar7, lVar5, "p_index", "size()", "", false, true);_err_flush_stdout();/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException();( *pcVar1 )();}/* CowData<String>::_ref(CowData<String> const&) [clone .part.0] */void CowData<String>::_ref(CowData<String> *this, CowData *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   bool bVar4;
...
/* AnimationTreeEditor::get_edited_path() const */void AnimationTreeEditor::get_edited_path(void) {
   long in_RSI;
   long in_RDI;
...
/* WARNING: Removing unreachable block (ram,0x00100d75) *//* WARNING: Removing unreachable block (ram,0x00100d7e) *//* WARNING: Removing unreachable block (ram,0x00100d92) *//* WARNING: Removing unreachable block (ram,0x00100db8) *//* AnimationTreeEditor::_clear_editors() */void AnimationTreeEditor::_clear_editors(AnimationTreeEditor *this) {
   long lVar1;
   code *pcVar2;
   long lVar3;
   long lVar4;
...
;
   lVar3 = 0;
   LAB_00100dc3:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar4, lVar3, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar2 = (code*)invalidInstructionException();
   ( *pcVar2 )();
}
/* AnimationTreeEditor::_node_removed(Node*) */void AnimationTreeEditor::_node_removed(AnimationTreeEditor *this, Node *param_1) {
...
/* AnimationTreeEditor::edit_path(Vector<String> const&) */void AnimationTreeEditor::edit_path(AnimationTreeEditor *this, Vector *param_1) {
   ...
   if (local_48 != (Object*)0x0) {
      ...
      if (pOVar5 == (Object*)0x0) {
         LAB_00101015:cVar4 = RefCounted::unreference();
         pOVar5 = local_48;
...
;
         ...
         if (( ( local_50 != (Object*)0x0 ) && ( cVar4 = RefCounted::unreference() ),pOVar5 = local_50,cVar4 != '\0' )) &&( cVar4 = cVar4 != '\0' )(**(code**)( *(long*)pOVar5 + 0x140 ))(pOVar5);
         Memory::free_static(pOVar5, false);
      }
   ...
   _err_print_error("edit_path", "editor/plugins/animation_tree_editor_plugin.cpp", 0x80, "Condition \"child.is_null()\" is true. Breaking.", 0, 0);
   Ref<AnimationNode>::unref((Ref<AnimationNode>*)&local_50);
   LAB_00101178:if (*(long*)( this + 0xa48 ) != *(long*)( this + 0xa38 )) {
   ...
   else{if (lVar1 == 0) goto LAB_00101260;lVar7 = *(long*)( lVar1 + -8 );
   if (lVar7 <= lVar8) goto LAB_00101263;
   plVar3 = *(long**)( lVar1 + lVar8 * 8 );
...
lVar1 = *(long*)( this + 0xa58 );}goto LAB_0010122a;}
  }*(undefined8*)( this + 0xa60 ) = 0;if (*(long*)( this + 0xa48 ) != *(long*)( this + 0xa38 )) {
   CowData<String>::_ref((CowData<String>*)( this + 0xa48 ), (CowData*)this_00);
}
lVar1 = *(long*)( this + 0xa58 );for (lVar8 = 0; ( lVar1 != 0 && ( lVar8 < *(long*)( lVar1 + -8 ) ) ); lVar8 = lVar8 + 1) {
   local_48 = (Object*)0x0;
   ( **(code**)( **(long**)( lVar1 + lVar8 * 8 ) + 0x370 ) )();
   if (( local_48 != (Object*)0x0 ) && ( ( cVar4 = RefCounted::unreference() ),pOVar5 = local_48,cVar4 != '\0' && ( cVar4 = predelete_handler(local_48) ),cVar4 != '\0' )) {
      ( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
      Memory::free_static(pOVar5, false);
   }

   if (*(long*)( this + 0xa58 ) == 0) {
      LAB_00101260:lVar7 = 0;
      LAB_00101263:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar8, lVar7, "p_index", "size()", "", false, true);
      _err_flush_stdout();
      /* WARNING: Does not return */
      pcVar2 = (code*)invalidInstructionException();
      ( *pcVar2 )();
...
LAB_0010122a:_update_path(this);Ref<AnimationNode>::unref((Ref<AnimationNode>*)&local_58);if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return;}/* AnimationTreeEditor::edit(AnimationTree*) */void AnimationTreeEditor::edit(AnimationTreeEditor *this, AnimationTree *param_1) {
   code *pcVar1;
   long *plVar2;
   char cVar3;
   ...
   if (param_1 == (AnimationTree*)0x0) {
      ...
      LAB_001016f0:pcVar1 = *(code**)( *(long*)pAVar4 + 0x118 );
      create_custom_callable_function_pointer<AnimationTreeEditor>(local_58, (char*)this, (_func_void*)"&AnimationTreeEditor::_animation_list_changed");
   ...
   LAB_00101695:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* AnimationTreeEditorPlugin::edit(Object*) */void AnimationTreeEditorPlugin::edit(AnimationTreeEditorPlugin *this, Object *param_1) {
...
/* AnimationTreeEditor::enter_editor(String const&) */void AnimationTreeEditor::enter_editor(AnimationTreeEditor *this, String *param_1) {
   long in_FS_OFFSET;
   undefined8 local_50;
   Vector local_48[8];
...
/* AnimationTreeEditor::_notification(int) */void AnimationTreeEditor::_notification(AnimationTreeEditor *this, int param_1) {
   long *plVar1;
   code *pcVar2;
   Object *pOVar3;
   char cVar4;
   ...
   if (param_1 == 0xb) {
      ...
      if (plVar1 == (long*)0x0) {
         AnimationTreeEditor__notification:_err_print_error("get_tree", "./scene/main/node.h", 0x1e5, "Parameter \"data.tree\" is null.", 0, 0);
         /* WARNING: Does not return */
         pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
      }
      ...
      create_custom_callable_function_pointer<AnimationTreeEditor,Node*>((AnimationTreeEditor*)&local_48, (char*)this, (_func_void_Node_ptr*)"&AnimationTreeEditor::_node_removed");
      ...
      joined_r0x00101b25:if (( StringName::configured != '\0' ) && ( local_50 != 0 )) {
         StringName::unref();
      }
      ...
      if (( *(long*)( this + 0xa20 ) == 0 ) || ( AnimationTree::get_root_animation_node(),local_48 == (Object*)0x0 )) {
         lVar6 = 0;
      }
 else {
      ...
      if (*(long*)( this + 0xa38 ) == 0) {
         ...
         LAB_00101a80:lVar6 = *(long*)( lVar6 + -8 );
      }
 else {
         lVar5 = *(long*)( *(long*)( this + 0xa38 ) + -8 );
   ...
   LAB_001019bd:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

   LAB_00101bd1:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* AnimationTreeEditor::get_animation_list() */AnimationTreeEditor * __thiscall AnimationTreeEditor::get_animation_list(AnimationTreeEditor *this){
   long lVar1;
   char cVar2;
   long *plVar3;
   long *plVar4;
   ...
   if (*(long*)( singleton + 0xa20 ) != 0) {
      ...
      if (( ( *(long*)( in_FS_OFFSET + lRam0000000000101c28 ) == 1 ) && ( cVar2 = CanvasItem::is_visible() ),cVar2 != '\0' )) {
         local_58 = (long*)0x0;
 ...
 while ( plVar3 != (long*)0x0 );
   ...
   *(undefined8*)( this + 8 ) = 0;
   LAB_00101c37:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* AnimationTreeEditor::_path_button_pressed(int) */void AnimationTreeEditor::_path_button_pressed(AnimationTreeEditor *this, int param_1) {
   CowData *pCVar1;
   long lVar2;
   code *pcVar3;
   long lVar4;
   ...
   if (-1 < param_1) {
      ...
      do {
         ...
         if (lVar2 == 0) {
            lVar5 = 0;
            LAB_00101dff:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar4, lVar5, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar3 = (code*)invalidInstructionException();
            ( *pcVar3 )();
...
/* AnimationTreeEditor::remove_plugin(AnimationTreeNodeEditorPlugin*) */void AnimationTreeEditor::remove_plugin(AnimationTreeEditor *this, AnimationTreeNodeEditorPlugin *param_1) {
   long lVar1;
   Node *pNVar2;
   long lVar3;
   long lVar4;
   ...
   if (pNVar2 != *(Node**)( this + 0xa28 )) {
      _err_print_error("remove_plugin", "editor/plugins/animation_tree_editor_plugin.cpp", 0xd6, "Condition \"p_editor->get_parent() != editor_base\" is true.", 0, 0);
      return;
   }
   ...
   if (( lVar1 != 0 ) && ( lVar4= *(long *)(lVar1 + -8),0 < lVar4 )) {
      ...
      do {
         if (*(AnimationTreeNodeEditorPlugin**)( lVar1 + lVar3 * 8 ) == param_1) {
            if (lVar4 <= lVar3) {
               _err_print_index_error("remove_at", "./core/templates/cowdata.h", 0xe4, lVar3, lVar4, "p_index", "size()", "", false, false);
               return;
            }

            CowData<AnimationTreeNodeEditorPlugin*>::_copy_on_write((CowData<AnimationTreeNodeEditorPlugin*>*)( this + 0xa58 ));
            lVar1 = *(long*)( this + 0xa58 );
            if (lVar1 == 0) {
               lVar4 = -1;
            }
            ...
            CowData<AnimationTreeNodeEditorPlugin*>::resize<false>((CowData<AnimationTreeNodeEditorPlugin*>*)( this + 0xa58 ), lVar4);
            return;
         }
...
/* AnimationTreeEditor::add_plugin(AnimationTreeNodeEditorPlugin*) */void AnimationTreeEditor::add_plugin(AnimationTreeEditor *this, AnimationTreeNodeEditorPlugin *param_1) {
   int iVar1;
   long lVar2;
   long lVar3;
   lVar2 = Node::get_parent();
   if (lVar2 != 0) {
      _err_print_error("add_plugin", "editor/plugins/animation_tree_editor_plugin.cpp", 0xcd, "Condition \"p_editor->get_parent()\" is true.", 0, 0);
      return;
   }
   ...
   iVar1 = CowData<AnimationTreeNodeEditorPlugin*>::resize<false>((CowData<AnimationTreeNodeEditorPlugin*>*)( this + 0xa58 ), lVar2);
   if (iVar1 == 0) {
      if (*(long*)( this + 0xa58 ) == 0) {
         lVar3 = -1;
         lVar2 = 0;
   ...
   LAB_0010205b:Control::set_h_size_flags(param_1, 3);
   Control::set_v_size_flags(param_1, 3);
   CanvasItem::hide();
   return;
}
/* AnimationTreeEditor::AnimationTreeEditor() */void AnimationTreeEditor::AnimationTreeEditor(AnimationTreeEditor *this) {
   undefined8 uVar1;
...
/* AnimationTreeEditorPlugin::is_class_ptr(void*) const */uint AnimationTreeEditorPlugin::is_class_ptr(AnimationTreeEditorPlugin *this, void *param_1) {
   return (uint)CONCAT71(0x109e, (undefined4*)param_1 == &EditorPlugin::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x109e, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x109f, (undefined4*)param_1 == &Node::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x109f, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* AnimationTreeEditorPlugin::_getv(StringName const&, Variant&) const */undefined8 AnimationTreeEditorPlugin::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* AnimationTreeEditorPlugin::_setv(StringName const&, Variant const&) */undefined8 AnimationTreeEditorPlugin::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* AnimationTreeEditorPlugin::_property_can_revertv(StringName const&) const */undefined8 AnimationTreeEditorPlugin::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* AnimationTreeEditorPlugin::_property_get_revertv(StringName const&, Variant&) const */undefined8 AnimationTreeEditorPlugin::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* AnimationTreeEditorPlugin::has_main_screen() const */undefined8 AnimationTreeEditorPlugin::has_main_screen(void) {
   return 0;
}
/* CallableCustomMethodPointer<AnimationTreeEditor, void, Node*>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<AnimationTreeEditor,void,Node*>::~CallableCustomMethodPointer(CallableCustomMethodPointer<AnimationTreeEditor,void,Node*> *this) {
   return;
}
/* CallableCustomMethodPointer<AnimationTreeEditor, void, int>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<AnimationTreeEditor,void,int>::~CallableCustomMethodPointer(CallableCustomMethodPointer<AnimationTreeEditor,void,int> *this) {
   return;
}
/* CallableCustomMethodPointer<AnimationTreeEditor, void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<AnimationTreeEditor,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<AnimationTreeEditor,void> *this) {
   return;
}
/* CallableCustomMethodPointer<AnimationTreeEditor, void, Node*>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<AnimationTreeEditor,void,Node*>::get_argument_count(CallableCustomMethodPointer<AnimationTreeEditor,void,Node*> *this, bool *param_1) {
   *param_1 = true;
   return 1;
}
/* CallableCustomMethodPointer<AnimationTreeEditor, void, int>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<AnimationTreeEditor,void,int>::get_argument_count(CallableCustomMethodPointer<AnimationTreeEditor,void,int> *this, bool *param_1) {
   *param_1 = true;
   return 1;
}
/* CallableCustomMethodPointer<AnimationTreeEditor, void>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<AnimationTreeEditor,void>::get_argument_count(CallableCustomMethodPointer<AnimationTreeEditor,void> *this, bool *param_1) {
   *param_1 = true;
   return 0;
}
...
/* AnimationTreeEditor::_property_get_revertv(StringName const&, Variant&) const */undefined8 AnimationTreeEditor::_property_get_revertv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   if ((code*)PTR__property_get_revert_0010d008 != Object::_property_get_revert) {
      uVar1 = Control::_property_get_revert(param_1, param_2);
      return uVar1;
...
/* AnimationTreeEditor::_property_can_revertv(StringName const&) const */undefined8 AnimationTreeEditor::_property_can_revertv(StringName *param_1) {
   undefined8 uVar1;
   if ((code*)PTR__property_can_revert_0010d010 != Object::_property_can_revert) {
      uVar1 = Control::_property_can_revert(param_1);
      return uVar1;
...
/* AnimationTreeEditorPlugin::_validate_propertyv(PropertyInfo&) const */void AnimationTreeEditorPlugin::_validate_propertyv(PropertyInfo *param_1) {
...
/* CowData<AnimationTreeNodeEditorPlugin*>::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<AnimationTreeNodeEditorPlugin*>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
...
/* AnimationTreeEditor::_notification(int) [clone .cold] */void AnimationTreeEditor::_notification(int param_1) {
   code *pcVar1;
...
/* CallableCustomMethodPointer<AnimationTreeEditor, void>::get_object() const */undefined8 CallableCustomMethodPointer<AnimationTreeEditor,void>::get_object(CallableCustomMethodPointer<AnimationTreeEditor,void> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_0010318d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallableCustomMethodPointer<AnimationTreeEditor, void, Node*>::get_object() const */undefined8 CallableCustomMethodPointer<AnimationTreeEditor,void,Node*>::get_object(CallableCustomMethodPointer<AnimationTreeEditor,void,Node*> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_0010328d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallableCustomMethodPointer<AnimationTreeEditor, void, int>::get_object() const */undefined8 CallableCustomMethodPointer<AnimationTreeEditor,void,int>::get_object(CallableCustomMethodPointer<AnimationTreeEditor,void,int> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_0010338d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* AnimationTreeEditorPlugin::_notificationv(int, bool) */void AnimationTreeEditorPlugin::_notificationv(AnimationTreeEditorPlugin *this, int param_1, bool param_2) {
   int iVar1;
   iVar1 = (int)this;
   if (param_2) {
...
/* HBoxContainer::is_class_ptr(void*) const */uint HBoxContainer::is_class_ptr(void *param_1) {
   ...
   if (in_RSI != &get_class_ptr_static()::ptr) {
      uVar1 = (uint)CONCAT71(0x109e, in_RSI == &Container::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x109e, in_RSI == &BoxContainer::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x109e, in_RSI == &Control::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x109f, in_RSI == &CanvasItem::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x109f, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr);
   }

   return uVar1;
}
/* AnimationTreeEditor::is_class_ptr(void*) const */ulong AnimationTreeEditor::is_class_ptr(void *param_1) {
   undefined4 in_EDX;
   undefined4 *in_RSI;
   if (in_RSI == &VBoxContainer::get_class_ptr_static() || in_RSI == &get_class_ptr_static()::ptr) {
      return CONCAT71(0x109e, in_RSI == &VBoxContainer::get_class_ptr_static() || in_RSI == &get_class_ptr_static(), ::ptr);
   }

   return ( ulong )((uint)CONCAT71(0x109e, in_RSI == &Container::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x109e, in_RSI == &BoxContainer::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x109e, in_RSI == &Control::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x109f, in_RSI == &CanvasItem::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x109f, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr));
}
...
/* AnimationTreeEditor::_validate_propertyv(PropertyInfo&) const */void AnimationTreeEditor::_validate_propertyv(PropertyInfo *param_1) {
   for (int i = 0; i < 3; i++) {
      Node::_validate_property(param_1);
   }
...
/* AnimationTreeEditor::_setv(StringName const&, Variant const&) */undefined8 AnimationTreeEditor::_setv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
...
/* WARNING: Removing unreachable block (ram,0x001037c8) *//* AnimationTreeEditor::_getv(StringName const&, Variant&) const */undefined8 AnimationTreeEditor::_getv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   if (( (code*)PTR__get_0010d038 != CanvasItem::_get ) && ( uVar1 = Control::_get(param_1, param_2) ),(char)uVar1 != '\0') {
      return uVar1;
   }
...
/* WARNING: Removing unreachable block (ram,0x00103838) *//* HBoxContainer::_getv(StringName const&, Variant&) const */undefined8 HBoxContainer::_getv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   if (( (code*)PTR__get_0010d038 != CanvasItem::_get ) && ( uVar1 = Control::_get(param_1, param_2) ),(char)uVar1 != '\0') {
      return uVar1;
   }
...
/* AnimationTreeEditorPlugin::get_plugin_name() const */AnimationTreeEditorPlugin * __thiscall
...
/* HBoxContainer::~HBoxContainer() */void HBoxContainer::~HBoxContainer(HBoxContainer *this) {
   ...
   *(code**)this = __cxa_guard_acquire;
   ...
   LAB_00103910:Control::~Control((Control*)this);
   return;
}
/* HBoxContainer::~HBoxContainer() */void HBoxContainer::~HBoxContainer(HBoxContainer *this) {
   bool bVar1;
   ...
   *(code**)this = __cxa_guard_acquire;
   ...
   LAB_00103970:Control::~Control((Control*)this);
...
/* HBoxContainer::_get_class_namev() const */undefined8 *HBoxContainer::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001039d3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001039d3;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "HBoxContainer");
   LAB_00103a3e:return &_get_class_namev();
}
/* AnimationTreeEditorPlugin::_get_class_namev() const */undefined8 *AnimationTreeEditorPlugin::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      ...
      if (*(long*)( _get_class_namev() ) != 0) {
         ...
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "AnimationTreeEditorPlugin");
         goto LAB_00103b2e;
      }
...
/* AnimationTreeEditor::_get_class_namev() const */undefined8 *AnimationTreeEditor::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      ...
      if (*(long*)( _get_class_namev() ) != 0) {
         ...
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "AnimationTreeEditor");
         goto LAB_00103c1e;
      }
...
/* WARNING: Removing unreachable block (ram,0x00103f30) *//* BoxContainer::_notificationv(int, bool) */void BoxContainer::_notificationv(BoxContainer *this, int param_1, bool param_2) {
   int iVar1;
   iVar1 = (int)this;
   if (param_2) {
      if ((code*)PTR__notification_0010d040 != Container::_notification) {
...
/* Callable create_custom_callable_function_pointer<AnimationTreeEditor>(AnimationTreeEditor*, char
   const*, void (AnimationTreeEditor::*)()) */AnimationTreeEditor *create_custom_callable_function_pointer<AnimationTreeEditor>(AnimationTreeEditor *param_1, char *param_2, _func_void *param_3) {
   undefined8 uVar1;
   CallableCustom *this;
   undefined8 in_RCX;
   undefined8 in_R8;
...
/* Callable create_custom_callable_function_pointer<AnimationTreeEditor, int>(AnimationTreeEditor*,
   char const*, void (AnimationTreeEditor::*)(int)) */AnimationTreeEditor *create_custom_callable_function_pointer<AnimationTreeEditor,int>(AnimationTreeEditor *param_1, char *param_2, _func_void_int *param_3) {
   undefined8 uVar1;
   CallableCustom *this;
   undefined8 in_RCX;
   undefined8 in_R8;
...
/* Callable Callable::bind<int>(int) const */Variant **Callable::bind<int>(int param_1) {
   char cVar1;
   int in_EDX;
   int in_ESI;
...
/* Callable create_custom_callable_function_pointer<AnimationTreeEditor,
   Node*>(AnimationTreeEditor*, char const*, void (AnimationTreeEditor::*)(Node*)) */AnimationTreeEditor *create_custom_callable_function_pointer<AnimationTreeEditor,Node*>(AnimationTreeEditor *param_1, char *param_2, _func_void_Node_ptr *param_3) {
   undefined8 uVar1;
   CallableCustom *this;
   undefined8 in_RCX;
   undefined8 in_R8;
...
/* EditorPlugin::~EditorPlugin() */void EditorPlugin::~EditorPlugin(EditorPlugin *this) {
   ...
   *(code**)this = Node::_bind_methods;
   ...
   LAB_001047aa:CowData<char32_t>::_unref((CowData<char32_t>*)( this + 0x418 ));
...
/* AnimationTreeEditor::_initialize_classv() */void AnimationTreeEditor::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   long local_58;
   undefined8 local_50;
            ...
            if (Container::initialize_class() == '\0') {
               if (Control::initialize_class() == '\0') {
                  if (CanvasItem::initialize_class() == '\0') {
                     ...
                     if ((code*)PTR__bind_compatibility_methods_0010d048 != Object::_bind_compatibility_methods) {
...
/* AnimationTreeEditorPlugin::get_class() const */void AnimationTreeEditorPlugin::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* AnimationTreeEditor::get_class() const */void AnimationTreeEditor::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* CallableCustomMethodPointer<AnimationTreeEditor, void>::call(Variant const**, int, Variant&,
   Callable::CallError&) const */void CallableCustomMethodPointer<AnimationTreeEditor,void>::call(CallableCustomMethodPointer<AnimationTreeEditor,void> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   uint uVar3;
   ulong *puVar4;
...
;
      ...
      *(undefined4*)( param_4 + 8 ) = 0;
      ...
      _err_print_error("get_instance", "./core/object/object.h", 0x418, "Condition \"slot >= slot_max\" is true. Returning: nullptr", 0, 0);
      LAB_001056ef:local_40 = 0;
      String::parse_latin1((String*)&local_40, "\', can\'t call method.");
      uitos((ulong)local_50);
      operator+((char *)
      local_48,(String*)"Invalid Object id \'";
      String::operator +(local_38, (String*)local_48);
      _err_print_error(&_LC34, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", local_38, 0, 0);
      CowData<char32_t>::_unref((CowData<char32_t>*)local_38);
   ...
   LAB_001057a0:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* CallableCustomMethodPointer<AnimationTreeEditor, void, Node*>::call(Variant const**, int,
   Variant&, Callable::CallError&) const */void CallableCustomMethodPointer<AnimationTreeEditor,void,Node*>::call(CallableCustomMethodPointer<AnimationTreeEditor,void,Node*> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   Variant *this_00;
   undefined8 uVar3;
...
;
            ...
            *(undefined4*)param_4 = 0;
            ...
            if (cVar4 == '\0') {
               ...
               *(undefined8*)( param_4 + 4 ) = uVar3;
               ...
               if (( ( pOVar6 == (Object*)0x0 ) || ( lVar7 = __dynamic_cast(pOVar6, &Object::typeinfo, &Node::typeinfo, 0) ),lVar7 == 0 )) goto LAB_001058f0;
            }
      ...
      _err_print_error(&_LC34, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", local_48, 0, 0);
      CowData<char32_t>::_unref((CowData<char32_t>*)local_48);
   ...
   LAB_00105a96:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* CallableCustomMethodPointer<AnimationTreeEditor, void, int>::call(Variant const**, int, Variant&,
   Callable::CallError&) const */void CallableCustomMethodPointer<AnimationTreeEditor,void,int>::call(CallableCustomMethodPointer<AnimationTreeEditor,void,int> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   undefined8 uVar3;
   char cVar4;
...
;
   ...
   LAB_00105d09:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* Object::is_class(String const&) const */ulong Object::is_class(Object *this, String *param_1) {
   ...
   do {
      if (lVar1 == 0) {
         ...
         LAB_00105e27:/* WARNING: Subroutine does not return */__stack_chk_fail();
      }
...
/* Node::is_class(String const&) const */undefined8 Node::is_class(Node *this, String *param_1) {
   ...
   if (cVar3 == '\0') {
      ...
      LAB_00105f03:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* AnimationTreeEditorPlugin::is_class(String const&) const */undefined8 AnimationTreeEditorPlugin::is_class(AnimationTreeEditorPlugin *this, String *param_1) {
   long lVar1;
   char *__s;
   long lVar2;
   char cVar3;
   ...
   LAB_00106043:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_00106136:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* Control::is_class(String const&) const */undefined8 Control::is_class(Control *this, String *param_1) {
   ...
   LAB_00106306:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* Container::is_class(String const&) const */undefined8 Container::is_class(Container *this, String *param_1) {
   ...
   if (cVar3 == '\0') {
      ...
      LAB_001063eb:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* AnimationTreeEditorPlugin::_initialize_classv() */void AnimationTreeEditorPlugin::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   long local_58;
   undefined8 local_50;
...
/* PropertyListHelper::~PropertyListHelper() */void PropertyListHelper::~PropertyListHelper(PropertyListHelper *this) {
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
   ...
   LAB_00106ddf:CowData<char32_t>::_unref((CowData<char32_t>*)this);
   return;
}
/* VBoxContainer::is_class(String const&) const */undefined8 VBoxContainer::is_class(VBoxContainer *this, String *param_1) {
   ...
   LAB_00106f13:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010701e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* AnimationTreeEditor::is_class(String const&) const */undefined8 AnimationTreeEditor::is_class(AnimationTreeEditor *this, String *param_1) {
   long lVar1;
   char *__s;
   long lVar2;
   char cVar3;
...
/* HBoxContainer::is_class(String const&) const */undefined8 HBoxContainer::is_class(HBoxContainer *this, String *param_1) {
   ...
   LAB_00107233:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010733e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* AnimationTreeEditorPlugin::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const
    */void AnimationTreeEditorPlugin::_get_property_listv(AnimationTreeEditorPlugin *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   undefined8 local_90;
   undefined8 local_88;
   long local_80;
...
/* AnimationTreeEditor::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void AnimationTreeEditor::_get_property_listv(AnimationTreeEditor *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   undefined8 local_90;
   undefined8 local_88;
   long local_80;
...
/* AnimationTreeEditor::~AnimationTreeEditor() */void AnimationTreeEditor::~AnimationTreeEditor(AnimationTreeEditor *this) {
   ...
   *(code**)this = __cxa_guard_acquire;
   ...
   LAB_001086a6:Control::~Control((Control*)this);
   return;
}
/* AnimationTreeEditor::~AnimationTreeEditor() */void AnimationTreeEditor::~AnimationTreeEditor(AnimationTreeEditor *this) {
   long *plVar1;
   ...
   *(code**)this = __cxa_guard_acquire;
   ...
   LAB_00108766:Control::~Control((Control*)this);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<String>::resize<false>(long) */undefined8 CowData<String>::resize<false>(CowData<String> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_00108b20:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar9 == lVar5) {
      LAB_00108a9b:puVar7 = *(undefined8**)this;
      if (puVar7 == (undefined8*)0x0) {
         LAB_00108b76:/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException();
         ( *pcVar1 )();
      }
   ...
   LAB_00108a0f:puVar7[-1] = param_1;
   return 0;
}
/* AnimationTreeEditor::_notificationv(int, bool) */void AnimationTreeEditor::_notificationv(AnimationTreeEditor *this, int param_1, bool param_2) {
   if (param_2) {
...
/* CowData<AnimationTreeNodeEditorPlugin*>::_realloc(long) */undefined8 CowData<AnimationTreeNodeEditorPlugin*>::_realloc(CowData<AnimationTreeNodeEditorPlugin*> *this, long param_1) {
   undefined8 *puVar1;
   puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
   if (puVar1 != (undefined8*)0x0) {
      *puVar1 = 1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<AnimationTreeNodeEditorPlugin*>::resize<false>(long) */undefined8 CowData<AnimationTreeNodeEditorPlugin*>::resize<false>(CowData<AnimationTreeNodeEditorPlugin*> *this, long param_1) {
   long *plVar1;
   code *pcVar2;
   long lVar3;
   ulong uVar4;
   ...
   if (param_1 * 8 == 0) {
      LAB_00108e50:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
/* AnimationTreeEditor::edit(AnimationTree*) */void AnimationTreeEditor::_GLOBAL__sub_I_edit(void) {
...
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<AnimationTreeEditor, void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<AnimationTreeEditor,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<AnimationTreeEditor,void> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<AnimationTreeEditor, void, int>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<AnimationTreeEditor,void,int>::~CallableCustomMethodPointer(CallableCustomMethodPointer<AnimationTreeEditor,void,int> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<AnimationTreeEditor, void, Node*>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<AnimationTreeEditor,void,Node*>::~CallableCustomMethodPointer(CallableCustomMethodPointer<AnimationTreeEditor,void,Node*> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* AnimationTreeEditor::~AnimationTreeEditor() */void AnimationTreeEditor::~AnimationTreeEditor(AnimationTreeEditor *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

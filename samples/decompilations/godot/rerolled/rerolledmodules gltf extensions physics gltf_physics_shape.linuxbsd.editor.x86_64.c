...
/* GLTFPhysicsShape::_bind_methods() */void GLTFPhysicsShape::_bind_methods(void) {
   char cVar1;
   MethodBind *pMVar2;
   uint uVar3;
   long in_FS_OFFSET;
...
/* GLTFPhysicsShape::to_resource(bool) */Ref<Shape3D> *GLTFPhysicsShape::to_resource(bool param_1) {
   String *this;
   Object *pOVar1;
   char cVar2;
   BoxShape3D *this_00;
...
else{local_48 = (SphereShape3D*)0x0;pSVar4 = (SphereShape3D*)operator_new(0x278, "");SphereShape3D::SphereShape3D(pSVar4);postinitialize_handler((Object*)pSVar4);local_38 = (Object*)0x0;local_40 = pSVar4;cVar2 = RefCounted::init_ref();if (cVar2 == '\0') {
   local_40 = (SphereShape3D*)0x0;
...
Ref<SphereShape3D>::unref((Ref<SphereShape3D>*)&local_40);SphereShape3D::set_radius(*(float*)( in_RSI + 0x254 ));pOVar3 = (Object*)__dynamic_cast(pSVar4, &Object::typeinfo, &Shape3D::typeinfo, 0);pOVar1 = *(Object**)( in_RSI + 0x270 );if (pOVar1 != pOVar3) {
   *(Object**)( in_RSI + 0x270 ) = pOVar3;
   local_38 = pOVar1;
   if (( pOVar3 != (Object*)0x0 ) && ( cVar2 = cVar2 == '\0' )) {
      *(undefined8*)( in_RSI + 0x270 ) = 0;

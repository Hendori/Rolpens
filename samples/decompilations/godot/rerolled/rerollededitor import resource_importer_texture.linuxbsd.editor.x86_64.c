/* ResourceImporterTexture::get_preset_count() const */undefined8 ResourceImporterTexture::get_preset_count(void) {
   return 3;
}
/* ResourceImporterTexture::get_recognized_extensions(List<String, DefaultAllocator>*) const */void ResourceImporterTexture::get_recognized_extensions(ResourceImporterTexture *this, List *param_1) {
   ImageLoader::get_recognized_extensions(param_1);
   return;
}
/* ResourceImporterTexture::get_importer_name() const */ResourceImporterTexture * __thiscall
...
/* ResourceImporterTexture::get_save_extension() const */ResourceImporterTexture * __thiscall
...
/* ResourceImporterTexture::get_visible_name() const */ResourceImporterTexture * __thiscall
...
/* ResourceImporterTexture::get_resource_type() const */ResourceImporterTexture * __thiscall
...
/* ResourceImporterTexture::~ResourceImporterTexture() */void ResourceImporterTexture::~ResourceImporterTexture(ResourceImporterTexture *this) {
   long *plVar1;
   uint uVar2;
   long lVar3;
   long lVar4;
 ...
 while ( lVar4 != (ulong)uVar2 << 2 );
   ...
   LAB_001002ac:*(undefined***)this = &PTR__initialize_classv_0010c8c0;
...
/* ResourceImporterTexture::_save_editor_meta(Dictionary const&, String const&) */void ResourceImporterTexture::_save_editor_meta(ResourceImporterTexture *this, Dictionary *param_1, String *param_2) {
   Variant *pVVar1;
   char cVar2;
   long in_FS_OFFSET;
   Variant *local_40;
   ...
   if (local_40 == (Variant*)0x0) {
      _err_print_error("_save_editor_meta", "editor/import/resource_importer_texture.cpp", 0x1b1, "Condition \"f.is_null()\" is true.", 0, 0);
   }
 else {
   ...
   if (( ( local_40 != (Variant*)0x0 ) && ( cVar2 = RefCounted::unreference() ),cVar2 != '\0' )) &&( cVar2 = cVar2 != '\0' )(**(code**)( *(long*)local_40 + 0x140 ))(local_40);
...
return;}/* ResourceImporterTexture::ResourceImporterTexture(bool) */void ResourceImporterTexture::ResourceImporterTexture(ResourceImporterTexture *this, bool param_1) {
...
/* ResourceImporterTexture::get_option_visibility(String const&, String const&, HashMap<StringName,
   ...
   DefaultTypedAllocator<HashMapElement<StringName, Variant> > > const&) const */bool ResourceImporterTexture::get_option_visibility(ResourceImporterTexture *this, String *param_1, String *param_2, HashMap *param_3) {
   char cVar1;
   int iVar2;
   Variant *pVVar3;
   long in_FS_OFFSET;
            ...
            if (cVar1 == '\0') {
               ...
               if (cVar1 == '\0') {
                  ...
                  if (cVar1 != '\0') {
                     ...
                     pVVar3 = (Variant*)HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::operator []((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_3, (StringName*)&local_28);
   ...
   bVar4 = iVar2 == 2;
   LAB_00100912:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return bVar4;
   }
...
/* ResourceImporterTexture::get_preset_name(int) const */String *ResourceImporterTexture::get_preset_name(int param_1) {
   long *plVar1;
   char *__s;
   long lVar2;
   size_t sVar3;
...
/* ResourceImporterTexture::get_import_settings_string() const */ResourceImporterTexture * __thiscall
...
/* ResourceImporterTexture::_load_editor_meta(String const&) const */String *ResourceImporterTexture::_load_editor_meta(String *param_1) {
   char cVar1;
   CowData *in_RDX;
   long in_FS_OFFSET;
   Object *local_70;
   ...
   if (local_70 == (Object*)0x0) {
      ...
      local_58 = "Missing required editor-specific import metadata for a texture (please reimport it using the \'Import\' tab): \'%s\'";
      local_68 = 0;
      local_50 = 0x70;
      String::parse_latin1((StrRange*)&local_68);
      vformat<String>((CowData<char32_t>*)&local_58, (StrRange*)&local_68, (CowData<char32_t>*)&local_60);
      _err_print_error("_load_editor_meta", "editor/import/resource_importer_texture.cpp", 0x1b8, "Condition \"f.is_null()\" is true. Returning: Dictionary()", (CowData<char32_t>*)&local_58, 0, 0);
...
/* ResourceImporterTexture::_texture_reimport_roughness(Ref<CompressedTexture2D> const&, String
   const&, RenderingServer::TextureDetectRoughnessChannel) */void ResourceImporterTexture::_texture_reimport_roughness(long *param_1, CowData *param_2, undefined4 param_3) {
   uint uVar1;
   long lVar2;
   long lVar3;
   ...
   if (*param_1 == 0) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         _err_print_error("_texture_reimport_roughness", "editor/import/resource_importer_texture.cpp", 0x2d, "Condition \"p_tex.is_null()\" is true.", 0, 0);
         return;
      }
      ...
      if (iVar12 == 0) {
         ...
         if (( *(long*)( singleton + 0x1b0 ) != 0 ) && ( *(int*)( singleton + 0x1d4 ) != 0 )) {
            ...
            if (uVar18 != 0) {
               uVar20 = 0;
               do {
                  if (( uVar18 == uVar13 ) && ( *(long*)( *(long*)( *(long*)( lVar16 + 0x1b0 ) + lVar17 * 8 ) + 0x10 ) == local_60 )) goto LAB_00101181;
                  uVar20 = uVar20 + 1;
                  auVar5._8_8_ = 0;
 ...
 while ( ( uVar18 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar18 * lVar2,auVar10._8_8_ = 0,auVar10._0_8_ = uVar19,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( uVar1 + iVar12 ) - SUB164(auVar6 * auVar10, 8)) * lVar2,auVar11._8_8_ = 0,auVar11._0_8_ = uVar19,uVar20 <= SUB164(auVar7 * auVar11, 8) );
            }
         ...
         local_48 = 0;
         local_50 = 0;
         puVar14 = (undefined4*)HashMap<StringName,ResourceImporterTexture::MakeInfo,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ResourceImporterTexture::MakeInfo>>>::operator []((HashMap<StringName,ResourceImporterTexture::MakeInfo,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ResourceImporterTexture::MakeInfo>>>*)( singleton + 0x1a8 ), (StringName*)&local_60);
         *puVar14 = 0;
         if (*(long*)( puVar14 + 2 ) != 0) {
         ...
         puVar14[4] = 0;
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
         LAB_00101181:puVar15 = (uint*)HashMap<StringName,ResourceImporterTexture::MakeInfo,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ResourceImporterTexture::MakeInfo>>>::operator []((HashMap<StringName,ResourceImporterTexture::MakeInfo,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ResourceImporterTexture::MakeInfo>>>*)( singleton + 0x1a8 ), (StringName*)&local_60);
         *puVar15 = *puVar15 | 2;
         lVar16 = HashMap<StringName,ResourceImporterTexture::MakeInfo,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ResourceImporterTexture::MakeInfo>>>::operator []((HashMap<StringName,ResourceImporterTexture::MakeInfo,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ResourceImporterTexture::MakeInfo>>>*)( singleton + 0x1a8 ), (StringName*)&local_60);
...
/* ResourceImporterTexture::_texture_reimport_normal(Ref<CompressedTexture2D> const&) */void ResourceImporterTexture::_texture_reimport_normal(Ref *param_1) {
   uint uVar1;
   long lVar2;
   long lVar3;
   undefined1 auVar4[16];
   ...
   if (*(long*)param_1 == 0) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         _err_print_error("_texture_reimport_normal", "editor/import/resource_importer_texture.cpp", 0x49, "Condition \"p_tex.is_null()\" is true.", 0, 0);
         return;
      }
      ...
      if (iVar13 == 0) {
         ...
         if (( *(long*)( singleton + 0x1b0 ) != 0 ) && ( *(int*)( singleton + 0x1d4 ) != 0 )) {
            ...
            if (uVar18 != 0) {
               uVar20 = 0;
               do {
                  if (( uVar18 == uVar14 ) && ( *(long*)( *(long*)( *(long*)( lVar12 + 0x1b0 ) + lVar17 * 8 ) + 0x10 ) == local_60 )) goto LAB_0010147a;
                  uVar20 = uVar20 + 1;
                  auVar5._8_8_ = 0;
 ...
 while ( ( uVar18 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar18 * lVar2,auVar10._8_8_ = 0,auVar10._0_8_ = uVar19,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( uVar1 + iVar13 ) - SUB164(auVar6 * auVar10, 8)) * lVar2,auVar11._8_8_ = 0,auVar11._0_8_ = uVar19,uVar20 <= SUB164(auVar7 * auVar11, 8) );
            }
         ...
         local_48 = 0;
         local_50 = 0;
         puVar15 = (undefined4*)HashMap<StringName,ResourceImporterTexture::MakeInfo,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ResourceImporterTexture::MakeInfo>>>::operator []((HashMap<StringName,ResourceImporterTexture::MakeInfo,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ResourceImporterTexture::MakeInfo>>>*)( singleton + 0x1a8 ), (StringName*)&local_60);
         *puVar15 = 0;
         if (*(long*)( puVar15 + 2 ) != 0) {
         ...
         puVar15[4] = 0;
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
         LAB_0010147a:puVar16 = (uint*)HashMap<StringName,ResourceImporterTexture::MakeInfo,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ResourceImporterTexture::MakeInfo>>>::operator []((HashMap<StringName,ResourceImporterTexture::MakeInfo,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ResourceImporterTexture::MakeInfo>>>*)( singleton + 0x1a8 ), (StringName*)&local_60);
         *puVar16 = *puVar16 | 4;
         if (( StringName::configured != '\0' ) && ( local_60 != 0 )) {
            StringName::unref();
         }
...
/* ResourceImporterTexture::_texture_reimport_3d(Ref<CompressedTexture2D> const&) */void ResourceImporterTexture::_texture_reimport_3d(Ref *param_1) {
   uint uVar1;
   long lVar2;
   long lVar3;
   undefined1 auVar4[16];
   ...
   if (*(long*)param_1 == 0) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         _err_print_error("_texture_reimport_3d", "editor/import/resource_importer_texture.cpp", 0x3c, "Condition \"p_tex.is_null()\" is true.", 0, 0);
         return;
      }
      ...
      if (iVar13 == 0) {
         ...
         if (( *(long*)( singleton + 0x1b0 ) != 0 ) && ( *(int*)( singleton + 0x1d4 ) != 0 )) {
            ...
            if (uVar18 != 0) {
               uVar20 = 0;
               do {
                  if (( uVar18 == uVar14 ) && ( *(long*)( *(long*)( *(long*)( lVar12 + 0x1b0 ) + lVar17 * 8 ) + 0x10 ) == local_60 )) goto LAB_0010172a;
                  uVar20 = uVar20 + 1;
                  auVar5._8_8_ = 0;
                  auVar5._0_8_ = ( ulong )(iVar13 + 1) * lVar2;
                  auVar9._8_8_ = 0;
 ...
 while ( ( uVar18 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar18 * lVar2,auVar10._8_8_ = 0,auVar10._0_8_ = uVar19,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( uVar1 + iVar13 ) - SUB164(auVar6 * auVar10, 8)) * lVar2,auVar11._8_8_ = 0,auVar11._0_8_ = uVar19,uVar20 <= SUB164(auVar7 * auVar11, 8) );
         ...
         *puVar15 = 0;
         ...
         puVar15[4] = 0;
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
         LAB_0010172a:puVar16 = (uint*)HashMap<StringName,ResourceImporterTexture::MakeInfo,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ResourceImporterTexture::MakeInfo>>>::operator []((HashMap<StringName,ResourceImporterTexture::MakeInfo,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ResourceImporterTexture::MakeInfo>>>*)( singleton + 0x1a8 ), (StringName*)&local_60);
         *puVar16 = *puVar16 | 1;
         if (( StringName::configured != '\0' ) && ( local_60 != 0 )) {
            StringName::unref();
         }
...
/* ResourceImporterTexture::get_import_options(String const&, List<ResourceImporter::ImportOption,
   DefaultAllocator>*, int) const */void ResourceImporterTexture::get_import_options(ResourceImporterTexture *this, String *param_1, List *param_2, int param_3) {
   char cVar1;
   long in_FS_OFFSET;
   undefined8 local_f0;
   undefined8 local_e8;
   ...
   local_e0 = 0;
   local_e8 = 0;
   String::parse_latin1((String*)&local_e8, "Lossless,Lossy,VRAM Compressed,VRAM Uncompressed,Basis Universal");
   local_f0 = 0;
   local_d8 = "compress/mode";
   local_d0 = 0xd;
   String::parse_latin1((StrRange*)&local_f0);
   PropertyInfo::PropertyInfo((PropertyInfo*)&local_d8, 2, (StrRange*)&local_f0, 2, (String*)&local_e8, 0x4006, &local_e0);
   ...
   PropertyInfo::PropertyInfo((PropertyInfo*)&local_d8, 1, (StrRange*)&local_f0, 0, (String*)&local_e8, 6, &local_e0);
   PropertyInfo::PropertyInfo(local_88, (PropertyInfo*)&local_d8);
   Variant::Variant(local_58, (Variant*)local_a8);
   List<ResourceImporter::ImportOption,DefaultAllocator>::push_back((List<ResourceImporter::ImportOption,DefaultAllocator>*)param_2, (ImportOption*)local_88);
   ResourceImporter::ImportOption::~ImportOption((ImportOption*)local_88);
   ...
   local_d0 = 0x16;
   String::parse_latin1((StrRange*)&local_f0);
   PropertyInfo::PropertyInfo((PropertyInfo*)&local_d8, 3, (StrRange*)&local_f0, 1, (String*)&local_e8, 6, &local_e0);
   PropertyInfo::PropertyInfo(local_88, (PropertyInfo*)&local_d8);
   Variant::Variant(local_58, (Variant*)local_a8);
   List<ResourceImporter::ImportOption,DefaultAllocator>::push_back((List<ResourceImporter::ImportOption,DefaultAllocator>*)param_2, (ImportOption*)local_88);
   ResourceImporter::ImportOption::~ImportOption((ImportOption*)local_88);
   ...
   local_d0 = 0x18;
   String::parse_latin1((StrRange*)&local_f0);
   PropertyInfo::PropertyInfo((PropertyInfo*)&local_d8, 2, (StrRange*)&local_f0, 2, (String*)&local_e8, 6, &local_e0);
   PropertyInfo::PropertyInfo(local_88, (PropertyInfo*)&local_d8);
   Variant::Variant(local_58, (Variant*)local_a8);
   List<ResourceImporter::ImportOption,DefaultAllocator>::push_back((List<ResourceImporter::ImportOption,DefaultAllocator>*)param_2, (ImportOption*)local_88);
   ResourceImporter::ImportOption::~ImportOption((ImportOption*)local_88);
   ...
   local_d0 = 0xd;
   String::parse_latin1((StrRange*)&local_f0);
   PropertyInfo::PropertyInfo((PropertyInfo*)&local_d8, 2, (StrRange*)&local_f0, 1, (String*)&local_e8, 6, &local_e0);
   PropertyInfo::PropertyInfo(local_88, (PropertyInfo*)&local_d8);
   Variant::Variant(local_58, (Variant*)local_a8);
   List<ResourceImporter::ImportOption,DefaultAllocator>::push_back((List<ResourceImporter::ImportOption,DefaultAllocator>*)param_2, (ImportOption*)local_88);
   ResourceImporter::ImportOption::~ImportOption((ImportOption*)local_88);
   ...
   PropertyInfo::PropertyInfo((PropertyInfo*)&local_d8, 4, (StrRange*)&local_f0, 0xd, (String*)&local_e8, 6, &local_e0);
   PropertyInfo::PropertyInfo(local_88, (PropertyInfo*)&local_d8);
   Variant::Variant(local_58, (Variant*)local_a8);
   List<ResourceImporter::ImportOption,DefaultAllocator>::push_back((List<ResourceImporter::ImportOption,DefaultAllocator>*)param_2, (ImportOption*)local_88);
   ResourceImporter::ImportOption::~ImportOption((ImportOption*)local_88);
   ...
   LAB_00102b1e:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* ResourceImporterTexture::are_import_settings_valid(String const&, Dictionary const&) const */uint ResourceImporterTexture::are_import_settings_valid(ResourceImporterTexture *this, String *param_1, Dictionary *param_2) {
   size_t sVar1;
   char cVar2;
   bool bVar3;
   bool bVar4;
   ...
   if (cVar2 == '\0') {
      LAB_00102e60:Variant::Variant((Variant*)local_58, "vram_texture");
         ...
         if (bVar3) {
            ...
            if (compression_formats != (undefined*)0x0) {
               ...
               do {
                  ...
                  operator+((char *)
                  local_a8,(String*)"rendering/textures/vram_compression/import_";
                  CowData<char32_t>::_unref((CowData<char32_t>*)&local_a0);
                  pSVar7 = (String*)ProjectSettings::get_singleton();
                  cVar2 = ProjectSettings::has_setting(pSVar7);
                  if (cVar2 == '\0') {
                     operator+((char *)&
                     local_88,(String*)"Setting for imported format not found: ";
                     _err_print_error("are_import_settings_valid", "editor/import/resource_importer_texture.cpp", 0x345, (CowData<char32_t>*)&local_88, 0, 1);
                     ...
                     if (bVar4) {
                        ...
                        sVar1 = local_90;
                        if (( ( local_90 != 0 ) && ( *(long*)( local_90 - 8 ) != 0 ) ) && ( 0 < *(long*)( local_90 - 8 ) )) {
                           lVar9 = 0;
                           do {
 ...
 while ( __s != (char*)0x0 );
            ...
            uVar5 = (uint)bVar3;
            LAB_001031cf:CowData<String>::_unref((CowData<String>*)&local_90);
         }
      ...
      if (cVar2 == '\0') {
         ...
         if (cVar2 == '\0') {
            ...
            LAB_00102e0e:Variant::Variant((Variant*)local_78, "editor_dark_theme");
            cVar2 = Dictionary::has((Variant*)&local_88);
            if (cVar2 == '\0') {
               if (Variant::needs_deinit[local_78[0]] != '\0') {
                  Variant::_clear_internal();
         ...
         LAB_001030f2:Dictionary::~Dictionary((Dictionary*)&local_88);
         CowData<char32_t>::_unref(local_98);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_a0);
      }
   ...
   uVar5 = 0;
   LAB_00102d6d:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar5;
   }
...
/* ResourceImporterTexture::update_imports() */void ResourceImporterTexture::update_imports(void) {
   ...
   if (uVar6 != 0) {
      ...
      if (pIVar2 != in_RSI) {
         *puVar13 = in_RSI;
         if (( in_RSI != (Image*)0x0 ) && ( cVar4 = cVar4 == '\0' )) {
            *puVar13 = 0;
         }
      ...
      do {
         while (true) {
            ...
            *(undefined1(*) [16])( this_00 + 0x198 ) = (undefined1[16])0x0;
            ...
            if (iVar7 == 0) break;
            _err_print_error("update_imports", "editor/import/resource_importer_texture.cpp", 0x6e, "Condition \"err != OK\" is true. Continuing.", 0, 0);
            CowData<char32_t>::_unref((CowData<char32_t>*)local_d8);
            cVar4 = RefCounted::unreference();
            ...
            LAB_001036b0:plVar14 = (long*)*plVar14;
            if (plVar14 == (long*)0x0) goto LAB_00104030;
         }
;
         uVar6 = *(uint*)( plVar14 + 3 );
         if (( uVar6 & 4 ) == 0) {
            LAB_00103674:bVar3 = false;
         }
 else {
            local_78 = 0;
            ...
            local_c0 = 0;
            local_88 = "%s: Texture detected as used as a normal map in 3D. Enabling red-green texture compression to reduce memory usage (blue channel is discarded).";
            local_80 = 0x8e;
            String::parse_latin1((StrRange*)&local_c0);
            TTR((String*)&local_b0, (String*)&local_c0);
            vformat<String>((CowData<char32_t>*)local_a0, (String*)&local_b0, (CowData<char32_t>*)&local_a8);
         ...
         if (( uVar6 & 2 ) == 0) {
            LAB_00103681:if (( uVar6 & 1 ) != 0) {
               LAB_00103b68:local_78 = 0;
               local_70 = (undefined1[16])0x0;
               local_88 = (char*)0x0;
               ...
               if (bVar5) {
                  ...
                  if (iVar7 == 1) {
                     ...
                     LAB_00104771:local_100 = (CowData<char32_t>*)&local_d0;
                     local_a8 = 0;
                     if (local_d0 != 0) {
                  ...
                  local_c8 = 0;
                  String::parse_latin1((String*)&local_c8, "%s: Texture detected as used in 3D. Enabling mipmap generation and setting the texture compression mode to %s.");
                  TTR((String*)&local_b8, (String*)&local_c8);
                  vformat<String,String>((CowData<char32_t>*)local_a0, (String*)&local_b8, local_118, (CowData<char32_t>*)&local_a8);
                  uVar8 = EditorToaster::get_singleton();
                  local_88 = (char*)0x0;
                  EditorToaster::popup_str(uVar8, (CowData<char32_t>*)local_a0, 0, (String*)&local_88);
                  CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
            ...
            String::parse_latin1((StrRange*)&local_c0);
            local_c8 = 0;
            local_88 = "%s: Texture detected as used as a roughness map in 3D. Enabling roughness limiter based on the detected associated normal map at %s.";
            local_80 = 0x84;
            ...
            LAB_00103f1e:ConfigFile::save(local_140);
            lVar10 = plVar14[2];
            if (lVar10 == 0) {
               local_88 = (char*)0x0;
               if (local_90 == 0) goto LAB_00104481;
               LAB_00103f6b:iVar7 = CowData<String>::resize<false>((CowData<String>*)&local_90, *(long*)( local_90 + -8 ) + 1);
               if (iVar7 == 0) goto LAB_00103f85;
               LAB_001044a0:_err_print_error("push_back", "./core/templates/vector.h", 0x142, "Condition \"err\" is true. Returning: true", 0, 0);
            }
 else {
               local_88 = (char*)0x0;
               if (*(char**)( lVar10 + 8 ) == (char*)0x0) {
               ...
               LAB_00104481:iVar7 = CowData<String>::resize<false>((CowData<String>*)&local_90, 1);
               if (iVar7 != 0) goto LAB_001044a0;
               LAB_00103f85:if (local_90 == 0) {
                  lVar11 = -1;
                  lVar10 = 0;
               }
 else {
            ...
            LAB_00103fd2:CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
            CowData<char32_t>::_unref((CowData<char32_t>*)local_d8);
            cVar4 = RefCounted::unreference();
         }

         if (( cVar4 == '\0' ) || ( cVar4 = predelete_handler((Object*)local_140) ),cVar4 == '\0') goto LAB_001036b0;
         lVar10 = *(long*)local_140;
         LAB_0010400e:( **(code**)( lVar10 + 0x140 ) )(local_140);
         Memory::free_static(local_140, false);
         plVar14 = (long*)*plVar14;
      }
 while ( plVar14 != (long*)0x0 );
      LAB_00104030:if (( *(long*)( in_RDI + 0x1b0 ) != 0 ) && ( *(int*)( in_RDI + 0x1d4 ) != 0 )) {
         LAB_00104056:lVar10 = 0;
 ...
 while ( lVar10 != (ulong)uVar6 << 2 );
   ...
   CowData<String>::_unref((CowData<String>*)&local_90);
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      LAB_00104142:pthread_mutex_unlock((pthread_mutex_t*)( in_RDI + 0x180 ));
      return;
   }

   LAB_00104964:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* ResourceImporterTexture::save_to_ctex_format(Ref<FileAccess>, Ref<Image> const&,
   ResourceImporterTexture::CompressMode, Image::UsedChannels, Image::CompressMode, float) */void ResourceImporterTexture::save_to_ctex_format(undefined4 param_1, undefined8 *param_2, long *param_3, ulong param_4, undefined4 param_5, undefined4 param_6) {
   Vector *pVVar1;
   Object *pOVar2;
   char cVar3;
   undefined2 uVar4;
...
/* ResourceImporterTexture::_save_ctex(Ref<Image> const&, String const&,
   ...
   bool, bool, bool, unsigned int, Ref<Image> const&, Image::RoughnessChannel) */void ResourceImporterTexture::_save_ctex(undefined4 param_1_00, undefined8 param_2, undefined8 *param_1, int param_4, uint param_5, undefined4 param_6, byte param_7, uint param_8, uint param_9, uint param_10, uint param_11, char param_12, undefined1 param_13, char param_14, undefined4 param_15, long *param_16, undefined4 param_17) {
   code *pcVar1;
   char cVar2;
   undefined4 uVar3;
   int iVar4;
   ...
   if (local_58 == (Object*)0x0) {
      _err_print_error("_save_ctex", "editor/import/resource_importer_texture.cpp", 0x15e, "Condition \"f.is_null()\" is true.", 0, 0);
   ...
   ( *pcVar1 )(pOVar5, uVar3);
   ( **(code**)( *(long*)local_58 + 0x278 ) )(local_58, -(param_10 & 0xff) & 0x8000000 | -(param_11 & 0xff) & 0x4000000 | -(param_9 & 0xff) & 0x1000000 | ( param_8 & 0xff ) << 0x16 | -(uint)param_7 & 0x800000);
   ( **(code**)( *(long*)local_58 + 0x278 ) )(local_58, param_15);
   for (int i = 0; i < 3; i++) {
      ( **(code**)( *(long*)local_58 + 632 ) )(local_58, 0);
   }

   if (( param_5 < 2 ) && ( iVar4 = 7 < iVar4 )) {
      uVar6 = 1;
      param_5 = 3;
   }
 else {
   ...
   pOVar5 = local_58;
   if (local_58 == (Object*)0x0) {
      LAB_001056ab:local_48 = (Object*)0x0;
   ...
   if (( local_50 != (Object*)0x0 ) && ( cVar2 = cVar2 != '\0' )) {
...
LAB_001056f7:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return;}/* WARNING: Type propagation algorithm not settling *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ResourceImporterTexture::import(long, String const&, String const&, HashMap<StringName, Variant,
   ...
   DefaultAllocator>*, List<String, DefaultAllocator>*, Variant*) */int ResourceImporterTexture::import(long param_1, String *param_2, String *param_3, HashMap *param_4, List *param_5, List *param_6, Variant *param_7) {
   bool bVar1;
   code *pcVar2;
   Ref *pRVar3;
   Ref *pRVar4;
   ...
   pVVar26 = (Variant*)HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::operator []((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_5, (StringName*)&local_90);
   ...
   cVar12 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_5, (StringName*)&local_98, (uint*)&local_90);
   if (cVar12 == '\0') {
      local_1b4 = _LC0;
      LAB_00105dec:if (StringName::configured != '\0') {
         LAB_00105df0:if (local_98 != (Ref*)0x0) {
            StringName::unref();
         }
   ...
   local_145 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_5, (StringName*)&local_98, (uint*)&local_90);
   if (local_145 == '\0') {
      LAB_00105e48:if (StringName::configured != '\0') {
         LAB_00105e53:if (local_98 != (Ref*)0x0) {
            StringName::unref();
         }
   ...
   local_90 = (Object*)( (ulong)local_90 & 0xffffffff00000000 );
   local_146 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_5, (StringName*)&local_98, (uint*)&local_90);
   if (local_146 == 0) {
      LAB_00105eab:if (StringName::configured != '\0') {
         LAB_00105eb6:if (local_98 != (Ref*)0x0) {
            StringName::unref();
         }
   ...
   local_d8 = (Image*)0x0;
   if (( ( iVar19 < 2 ) || ( !bVar6 ) ) || ( cVar12 = FileAccess::exists((String*)local_e0) ),cVar12 == '\0') {
      LAB_00105eec:local_14c = 0;
   }
 else {
      ...
      iVar21 = ImageLoader::load_image(_LC0, local_e0, (StringName*)&local_98, (StringName*)&local_90, 0);
   ...
   iVar21 = ImageLoader::load_image(local_1b4, param_3, (StringName*)&local_98, (StringName*)&local_90, bVar10);
   if (( local_98 != (Ref*)0x0 ) && ( cVar12 = cVar12 != '\0' )) {
      memdelete<Image>((Image*)local_98);
   }

   if (( ( local_90 != (Object*)0x0 ) && ( cVar12 = RefCounted::unreference() ),pOVar5 = local_90,cVar12 != '\0' )) &&( cVar12 = cVar12 != '\0' )(**(code**)( *(long*)pOVar5 + 0x140 ))(pOVar5);
   Memory::free_static(pOVar5, false);
}
if (iVar21 == 0) {
   local_98 = (Ref*)0x0;
   ...
   *(undefined8*)this = 0;
   ...
   if (local_146 == 0) {
      if (local_145 != '\0') {
         LAB_00107245:fVar30 = (float)EditorScale::get_scale();
      ...
      LAB_00107094:Ref<Image>::instantiate<>((Ref<Image>*)&local_c8);
      pRVar4 = local_c8;
      local_90 = (Object*)0x0;
      local_98 = (Ref*)0x0;
      Ref<Image>::operator =((Ref<Image>*)&local_98, local_c8);
      iVar22 = ImageLoader::load_image(local_1b4, param_3, (StringName*)&local_98, (StringName*)&local_90, (uint)local_146 * 2 | (uint)bVar10);
      Ref<Image>::unref((Ref<Image>*)&local_98);
      Ref<FileAccess>::unref((Ref<FileAccess>*)&local_90);
      if (iVar22 == 0) {
         local_90 = (Object*)0x0;
         ...
         if (this == (Ref<Image>*)0x0) {
            LAB_0010725b:_err_print_error("push_back", "./core/templates/local_vector.h", 0x41, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0);
            _err_flush_stdout();
            /* WARNING: Does not return */
         ...
         *(long*)( this + 8 ) = 0;
         ...
         local_a0 = 0;
         String::parse_latin1((String*)&local_a0, "Failed to import an image resource for editor use from \'%s\'.");
         vformat<String>((StringName*)&local_90, (String*)&local_a0, (StringName*)&local_98);
         _err_print_error("import", "editor/import/resource_importer_texture.cpp", 0x24f, (StringName*)&local_90, 0, 1);
      ...
      if (0 < iVar20) {
         ...
         if (iVar22 < iVar23) {
            ...
            if (bVar1) {
               ...
               local_a0 = 0;
               String::parse_latin1((String*)&local_a0, "%s: Texture was downsized on import as its height (%d pixels) exceeded the importable size limit (%d pixels).");
               vformat<String,int,int>((StringName*)&local_90, (String*)&local_a0, (StringName*)&local_98, uVar25);
               _err_print_error("import", "editor/import/resource_importer_texture.cpp", 0x267, (StringName*)&local_90, 0, 1);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_90);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_a0);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_98);
            }

            Image::resize(*(long*)pRVar27, (long)( iVar22 * iVar20 ) / (long)iVar23 & 0xffffffff, iVar20, 2);
         }
 else {
            iVar22 = Image::get_height();
            ...
            if (bVar1) {
               ...
               local_a0 = 0;
               String::parse_latin1((String*)&local_a0, "%s: Texture was downsized on import as its width (%d pixels) exceeded the importable size limit (%d pixels).");
               vformat<String,int,int>((StringName*)&local_90, (String*)&local_a0, (StringName*)&local_98, uVar25);
               _err_print_error("import", "editor/import/resource_importer_texture.cpp", 0x25e, (StringName*)&local_90, 0, 1);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_90);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_a0);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_98);
            }

            Image::resize(*(long*)pRVar27, iVar20, (long)( iVar22 * iVar20 ) / (long)iVar23 & 0xffffffff, 2);
         }
 ...
 while ( iVar22 != iVar23 );
      ...
      if (!bVar11) {
         LAB_0010622c:pRVar27 = pRVar27 + 8;
      ...
      do {
         ...
         do {
            ...
            fVar30 = _LC115 * (float)uVar31 + _LC116 * (float)( (ulong)uVar31 >> 0x20 ) + _LC117 * in_XMM1_Da;
 ...
 while ( local_198 != pRVar27 );
   ...
   if (iVar14 == 2) {
      ...
      if (cVar12 == '\0') {
         if (cVar13 == '\0') {
            ...
            if (bVar1) {
               ...
               LAB_00106fdd:iVar15 = Image::get_format();
               if (iVar15 != 0x10) {
               ...
               joined_r0x00107a1a:if (cVar12 != '\0') goto LAB_0010734f;
         ...
         LAB_001076f7:Variant::Variant((Variant*)&local_58, "etc2_astc");
         ...
         if (iVar15 != 0) {
            LAB_001077ce:if (iVar17 != 2) goto LAB_00106fdd;
            iVar15 = Image::get_format();
            if (iVar15 == 0xb) {
         ...
         if (bVar1) {
            if (iVar15 != 0) goto LAB_001077ce;
            if (iVar17 < 1) goto LAB_00106fdd;
            LAB_0010734f:local_b8 = 0;
            String::parse_latin1((String*)&local_b8, "bptc");
            uVar25 = 3;
         }
 else {
            LAB_001078e0:local_b8 = 0;
         ...
         _save_ctex(pRVar33._0_4_, param_1, (Ref<Image>*)&local_d0, (StringName*)&local_90, 2, uVar25, bVar6, 0, bVar7, bVar8, bVar9, bVar10, bVar11, 0, local_150, &local_d8, local_14c);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_90);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_a0);
         CowData<char32_t>::_unref((CowData<char32_t>*)local_a8);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_b0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_98);
         List<String,DefaultAllocator>::push_back((List<String,DefaultAllocator>*)param_6, (String*)&local_b8);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_b8);
         if (cVar13 == '\0') goto LAB_001066be;
         LAB_0010753d:local_b8 = 0;
      ...
      String::operator +((String*)&local_90, (String*)param_4);
      iVar15 = iVar14;
      LAB_00106692:_save_ctex(pRVar33._0_4_, param_1, (Ref<Image>*)&local_d0, (StringName*)&local_90, iVar15, 0, bVar6, 0, bVar7, bVar8, bVar9, bVar10, bVar11, 0, local_150, &local_d8, local_14c);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_90);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_98);
   }

   LAB_001066be:pRVar4 = local_c8;
   if (local_c8 != (Ref*)0x0) {
      local_98 = (Ref*)0x0;
      String::parse_latin1((String*)&local_98, ".editor.ctex");
      String::operator +((String*)&local_90, (String*)param_4);
      _save_ctex(pRVar33._0_4_, param_1, local_118, (StringName*)&local_90, iVar14, 0, bVar6, 0, bVar7, bVar8, bVar9, bVar10, bVar11, 0, local_150, &local_d8, local_14c);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_90);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_98);
      ...
      String::operator +((String*)&local_90, (String*)param_4);
      _save_editor_meta((ResourceImporterTexture*)param_1, (Dictionary*)&local_a0, (String*)&local_90);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_90);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_98);
      Dictionary::~Dictionary((Dictionary*)&local_a0);
   }
 ...
 while ( this + (ulong)local_f0 * 8 != pRVar27 );
   ...
   if (pRVar3 == (Ref*)0x0) {
      ...
      this(Ref<Image> * 0x0);
      cVar12 = RefCounted::unreference();
      joined_r0x00106121:if (cVar12 != '\0') {
      ...
      local_f0 = 0;
      this(Ref<Image> * 0x0);
      LAB_00105fd3:cVar12 = RefCounted::unreference();
      if (cVar12 != '\0') {
         memdelete<Image>((Image*)pRVar3);
      }

      if (local_d8 != (Image*)0x0) {
         LAB_00105ff0:cVar12 = RefCounted::unreference();
...
Memory::free_static(this, false);LAB_0010601b:CowData<char32_t>::_unref((CowData<char32_t>*)local_e0);if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return iVar21;}/* DefaultAllocator::alloc(unsigned long) */void DefaultAllocator::alloc(ulong param_1) {
...
/* RefCounted::is_class_ptr(void*) const */uint RefCounted::is_class_ptr(RefCounted *this, void *param_1) {
   return (uint)CONCAT71(0x10ce, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10ce, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
}
...
/* ResourceImporterTexture::is_class_ptr(void*) const */uint ResourceImporterTexture::is_class_ptr(ResourceImporterTexture *this, void *param_1) {
   return (uint)CONCAT71(0x10cd, (undefined4*)param_1 == &ResourceImporter::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10cd, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10ce, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10ce, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* ResourceImporterTexture::_getv(StringName const&, Variant&) const */undefined8 ResourceImporterTexture::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* ResourceImporterTexture::_setv(StringName const&, Variant const&) */undefined8 ResourceImporterTexture::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* ResourceImporterTexture::_validate_propertyv(PropertyInfo&) const */void ResourceImporterTexture::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* ResourceImporterTexture::_property_can_revertv(StringName const&) const */undefined8 ResourceImporterTexture::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* ResourceImporterTexture::_property_get_revertv(StringName const&, Variant&) const */undefined8 ResourceImporterTexture::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* ResourceImporterTexture::_notificationv(int, bool) */void ResourceImporterTexture::_notificationv(int param_1, bool param_2) {
   return;
}
/* ResourceImporterTexture::can_import_threaded() const */undefined8 ResourceImporterTexture::can_import_threaded(void) {
   return 1;
}
/* ConfigFile::is_class_ptr(void*) const */uint ConfigFile::is_class_ptr(ConfigFile *this, void *param_1) {
   return (uint)CONCAT71(0x10ce, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10cd, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10ce, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
...
/* ResourceImporterTexture::_get_class_namev() const */undefined8 *ResourceImporterTexture::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      ...
      if (*(long*)( _get_class_namev() ) != 0) {
         ...
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "ResourceImporterTexture");
         goto LAB_0010826e;
      }
...
/* ConfigFile::_get_class_namev() const */undefined8 *ConfigFile::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001082e3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001082e3;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "ConfigFile");
   LAB_0010834e:return &_get_class_namev();
}
/* RefCounted::_get_class_namev() const */undefined8 *RefCounted::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001083c3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001083c3;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "RefCounted");
   LAB_0010842e:return &_get_class_namev();
}
...
/* ResourceImporterTexture::get_class() const */void ResourceImporterTexture::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* WARNING: Removing unreachable block (ram,0x00109428) *//* String vformat<String>(String const&, String const) */undefined8 *vformat<String>(undefined8 *param_1, bool *param_2, String *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* WARNING: Removing unreachable block (ram,0x00109760) *//* String vformat<String, String>(String const&, String const, String const) */undefined8 *vformat<String,String>(undefined8 *param_1, bool *param_2, String *param_3, String *param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   long in_FS_OFFSET;
...
/* WARNING: Removing unreachable block (ram,0x00109a50) *//* String vformat<String, int, int>(String const&, String const, int const, int const) */undefined8 *vformat<String,int,int>(undefined8 *param_1, bool *param_2, String *param_3, int param_4, int param_5) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   int iVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<StringName, ResourceImporterTexture::MakeInfo, HashMapHasherDefault,
   HashMapComparatorDefault<StringName>, DefaultTypedAllocator<HashMapElement<StringName,
   ResourceImporterTexture::MakeInfo> > >::operator[](StringName const&) */undefined8 * __thiscallHashMap<StringName,ResourceImporterTexture::MakeInfo,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ResourceImporterTexture::MakeInfo>>>::operator [](HashMap<StringName,ResourceImporterTexture::MakeInfo,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ResourceImporterTexture::MakeInfo>>> * this, StringName * param_1) * puVar1 ;undefined8 *puVar2void *pvVar3void *__sundefined8 *puVar4undefined1 auVar5[16]undefined1 auVar6[16]undefined1 auVar7[16]undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1 auVar15[16]undefined1 auVar16[16]undefined1 auVar17[16]undefined1 auVar18[16]undefined1 auVar19[16]undefined1 auVar20[16]undefined1 auVar21[16]undefined1 auVar22[16]undefined1 auVar23[16]undefined1 auVar24[16]undefined1 auVar25[16]undefined1 auVar26[16]undefined1 auVar27[16]undefined1 auVar28[16]undefined1 auVar29[16]undefined1 auVar30[16]undefined1 auVar31[16]undefined1 auVar32[16]undefined1 auVar33[16]undefined1 auVar34[16]undefined1 auVar35[16]undefined1 auVar36[16]uint uVar37uint uVar38uint uVar39ulong uVar40undefined8 uVar41void *__s_00undefined8 *puVar42long lVar43void *pvVar44ulong uVar45int iVar46long lVar47long lVar48long lVar49ulong uVar50undefined8 uVar51uint uVar52uint uVar53uint uVar54undefined8 *puVar55long in_FS_OFFSETundefined8 local_90undefined4 local_88undefined1 local_78[16]long local_68undefined8 local_60long local_58undefined4 local_50long local_40lVar43 = *(long*)( this + 8 );local_40 = *(long*)( in_FS_OFFSET + 0x28 );uVar38 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );uVar40 = CONCAT44(0, uVar38);if (lVar43 == 0) {
   LAB_0010a339:local_88 = 0;
   local_90 = 0;
   uVar45 = uVar40 * 4;
   uVar50 = uVar40 * 8;
 ...
 while ( uVar40 != uVar45 );
   ...
   LAB_00109f0d:uVar38 = *(uint*)( this + 0x28 );
   if (uVar38 == 0x1c) {
...
;
 ...
 while ( uVar39 != uVar40 );
   ...
   if (*(int*)( this + 0x2c ) == 0) {
      ...
      if (uVar52 != 0) {
         uVar54 = 0;
         do {
            if (( uVar52 == uVar39 ) && ( *(long*)( *(long*)( lVar43 + lVar47 * 8 ) + 0x10 ) == *(long*)param_1 )) {
 ...
 while ( ( uVar52 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar52 * lVar48,auVar23._8_8_ = 0,auVar23._0_8_ = uVar40,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar53 + uVar38 ) - SUB164(auVar7 * auVar23, 8)) * lVar48,auVar24._8_8_ = 0,auVar24._0_8_ = uVar40,uVar54 <= SUB164(auVar8 * auVar24, 8) );
   ...
   LAB_00109de1:iVar46 = *(int*)( this + 0x2c );
   if (iVar46 != 0) {
      LAB_00109ded:uVar38 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
 ...
 while ( ( uVar52 != 0 ) && ( auVar11._8_8_ = 0 ),auVar11._0_8_ = (ulong)uVar52 * lVar43,auVar27._8_8_ = 0,auVar27._0_8_ = uVar45,auVar12._8_8_ = 0,auVar12._0_8_ = ( ulong )(( uVar38 + uVar53 ) - SUB164(auVar11 * auVar27, 8)) * lVar43,auVar28._8_8_ = 0,auVar28._0_8_ = uVar45,uVar54 <= SUB164(auVar12 * auVar28, 8) );
   ...
   LAB_00109ee7:if ((float)uVar40 * __LC36 < (float)( iVar46 + 1 )) goto LAB_00109f0d;
}
local_78 = (undefined1[16])0x0;StringName::StringName((StringName*)&local_68, param_1);local_60 = 0;local_58 = 0;local_50 = 0;puVar42 = (undefined8*)operator_new(0x30, "");*puVar42 = local_78._0_8_;puVar42[1] = local_78._8_8_;StringName::StringName((StringName*)( puVar42 + 2 ), (StringName*)&local_68);puVar42[4] = 0;*(undefined4*)( puVar42 + 3 ) = (undefined4)local_60;if (local_58 != 0) {
   CowData<char32_t>::_ref((CowData<char32_t>*)( puVar42 + 4 ), (CowData*)&local_58);
}
*(undefined4*)( puVar42 + 5 ) = local_50;CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
   StringName::unref();
}
puVar4 = *(undefined8**)( this + 0x20 );if (puVar4 == (undefined8*)0x0) {
   ...
   *(undefined8**)( this + 0x20 ) = puVar42;
   ...
   LAB_0010a201:uVar38 = *(uint*)( lVar43 + 0x20 );
}
 else {
   *puVar4 = puVar42;
   puVar42[1] = puVar4;
   ...
   *(undefined8**)( this + 0x20 ) = puVar42;
   ...
   LAB_0010a3e5:uVar38 = StringName::get_empty_hash();
}
...
;*(undefined8**)( lVar47 + lVar49 * 8 ) = puVar4;*puVar1 = uVar38;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0010a2f4:CowData<char32_t>::_unref((CowData<char32_t>*)&local_90);LAB_00109d7c:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return puVar42 + 3;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* RefCounted::is_class(String const&) const */undefined8 RefCounted::is_class(RefCounted *this, String *param_1) {
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0010a5db:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* ConfigFile::is_class(String const&) const */undefined8 ConfigFile::is_class(ConfigFile *this, String *param_1) {
 ...
 while ( !bVar8 );
      ...
      LAB_0010a74f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0010a803:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* ResourceImporterTexture::is_class(String const&) const */undefined8 ResourceImporterTexture::is_class(ResourceImporterTexture *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
   ...
   LAB_0010a96b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010aa6e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* ResourceImporterTexture::_initialize_classv() */void ResourceImporterTexture::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_70;
   undefined8 local_68;
   long local_60;
...
/* RefCounted::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void RefCounted::_get_property_listv(List *param_1, bool param_2) {
   ...
   LAB_0010b32c:List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)CONCAT71(in_register_00000031, param_2), (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
   }
...
/* ResourceImporterTexture::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const
    */void ResourceImporterTexture::_get_property_listv(ResourceImporterTexture *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<String>::resize<false>(long) */undefined8 CowData<String>::resize<false>(CowData<String> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_0010c240:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar9 == lVar5) {
      LAB_0010c1bb:puVar7 = *(undefined8**)this;
      if (puVar7 == (undefined8*)0x0) {
         LAB_0010c296:/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException();
         ( *pcVar1 )();
      }
...
/* void Ref<Image>::instantiate<>() */void Ref<Image>::instantiate<>(Ref<Image> *this) {
   ...
   *(undefined8*)( this_00 + 600 ) = 0;
   ...
   LAB_0010c458:cVar2 = RefCounted::unreference();
   if (cVar2 == '\0') {
      return;
   }
...
/* void memdelete<HashMapElement<String, HashMap<String, Variant, HashMapHasherDefault,
 ...
 while ( lVar4 != (ulong)uVar2 << 2 );
   ...
   LAB_0010c5a1:CowData<char32_t>::_unref((CowData<char32_t>*)( param_1 + 0x10 ));
   Memory::free_static(param_1, false);
   return;
}
/* ConfigFile::~ConfigFile() */void ConfigFile::~ConfigFile(ConfigFile *this) {
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
   ...
   LAB_0010c6b1:*(undefined***)this = &PTR__initialize_classv_0010c8c0;
   Object::~Object((Object*)this);
   return;
}
/* ConfigFile::~ConfigFile() */void ConfigFile::~ConfigFile(ConfigFile *this) {
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
   ...
   LAB_0010c7a1:*(undefined***)this = &PTR__initialize_classv_0010c8c0;
   Object::~Object((Object*)this);

/* TexturePreview::on_selected_channels_changed() */void TexturePreview::on_selected_channels_changed(void) {
   StringName *pSVar1;
   long in_RDI;
   long in_FS_OFFSET;
   long local_50;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* TexturePreview::_draw_outline() */void TexturePreview::_draw_outline(TexturePreview *this) {
   long in_FS_OFFSET;
   float fVar1;
   undefined8 uVar2;
   float local_28;
   ...
   CanvasItem::draw_rect(*(Rect2**)( this + 0xa20 ), (Color*)&local_28, (bool)( (char)this + 'X' ), fVar1, false);
...
/* EditorInspectorPluginTexture::can_handle(Object*) */bool EditorInspectorPluginTexture::can_handle(EditorInspectorPluginTexture *this, Object *param_1) {
   long lVar1;
   bool bVar2;
...
/* get_texture_2d_format(Ref<Texture2D> const&) */undefined4 get_texture_2d_format(Ref *param_1) {
   char cVar1;
   undefined4 uVar2;
   Object *pOVar3;
   long lVar4;
   ...
   if (lVar4 != 0) {
      ...
      if (( pOVar3 != (Object*)0x0 ) && ( cVar1 = cVar1 != '\0' )) {
         ...
         LAB_00100318:cVar1 = RefCounted::unreference();
...
/* TexturePreview::_update_texture_display_ratio() */void TexturePreview::_update_texture_display_ratio(void) {
   long lVar1;
   char cVar2;
   long in_FS_OFFSET;
   float fVar3;
...
/* TexturePreview::_notification(int) [clone .part.0] */void TexturePreview::_notification(int param_1) {
   Color *pCVar1;
   Ref *pRVar2;
   Object *pOVar3;
   char cVar4;
   ...
   if (*(long*)( pSVar6 + 0xa40 ) != 0) {
    ...
    Control::get_theme_font((StringName *)&local_60,pSVar6);, Control::add_theme_font_override(*(StringName**)( pSVar6 + 0xa40 ), (Ref*)( SceneStringNames::singleton + 0xa0 ))(( ( local_60 != (Object*)0x0 ) && ( cVar4 = RefCounted::unreference() ),pOVar3 = local_60,cVar4 != '\0' )) && ( cVar4 = predelete_handler(local_60) ), cVar4 != '\0'))(**(code**)( *(long*)pOVar3 + 0x140 ))(pOVar3);
         Memory::free_static(pOVar3, false);
      }
  ...
  Control::get_editor_theme_icon((StringName *)&local_60);, TextureRect::set_texture(pRVar2)(( ( local_60 != (Object*)0x0 ) && ( cVar4 = RefCounted::unreference() ),cVar4 != '\0' )) && ( cVar4 = predelete_handler(local_60) ), cVar4 != '\0'))(**(code**)( *(long*)local_60 + 0x140 ))(local_60);
  ...
  *(undefined8 *)(pSVar6 + 0xa60) = in_XMM1_Qa;
  ...
  return;
}, /* TexturePreview::get_texture_display() */, undefined8 __thiscall TexturePreview::get_texture_display(TexturePreview *this)
...
void __thiscall TextureEditorPlugin::TextureEditorPlugin(TextureEditorPlugin *this), {
               ...
               *(undefined***)this = &PTR__initialize_classv_0010a478;
               ...
               if (local_30 == (Object*)0x0) {
                  ...
                  if (( ( local_28 != (Object*)0x0 ) && ( cVar2 = RefCounted::unreference() ),pOVar3 = local_28,cVar2 != '\0' )) goto LAB_00100cc4;
               }
 else {
                  ...
                  if (( ( local_28 != (Object*)0x0 ) && ( cVar2 = RefCounted::unreference() ),pOVar3 = local_28,cVar2 != '\0' )) {
                     LAB_00100cc4:( **(code**)( *(long*)pOVar3 + 0x140 ) )(pOVar3);
                     Memory::free_static(pOVar3, false);
               ...
               LAB_00100cdf:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
                  return;
               }

               LAB_00100d86:/* WARNING: Subroutine does not return */__stack_chk_fail();
            }
, /* CowData<char32_t>::_ref(CowData<char32_t> const&) [clone .part.0] */, void __thiscall CowData<char32_t>::_ref(CowData<char32_t> *this, CowData * param_1) * plVar1);
 ...
 while ( !bVar4 );
   ...
   void TexturePreview::_update_metadata_label_text(TexturePreview *this) {
      ...
      if (local_c8 == (Object*)0x0) {
         _err_print_error("_update_metadata_label_text", "editor/plugins/texture_editor_plugin.cpp", 0x9e, "Condition \"texture.is_null()\" is true.", 0, 0);
      ...
      if (cVar2 == '\0') {
         ...
         LAB_00100f63:if (iVar3 != 0x27) goto LAB_001013c8;
         LAB_00100f6c:( **(code**)( *(long*)local_c8 + 0x48 ) )(local_c0);
         ...
         _err_print_error("get_texture_mipmaps_count", "editor/plugins/texture_editor_plugin.cpp", 0x86, "Condition \"p_texture.is_null()\" is true. Returning: -1", 0, 0);
         goto LAB_00101819;
      }

      iVar3 = get_texture_2d_format((Ref*)&local_50);
      cVar2 = RefCounted::unreference();
      if (( cVar2 == '\0' ) || ( cVar2 = cVar2 == '\0' )) goto LAB_00100f63;
      ( **(code**)( *(long*)pOVar8 + 0x140 ) )(pOVar8);
      Memory::free_static(pOVar8, false);
      if (iVar3 == 0x27) goto LAB_00100f6c;
      LAB_001013c8:Image::get_format_name(local_c0, iVar3);
      local_48 = ( **(code**)( *(long*)local_c8 + 0x1d8 ) )();
      Vector2::operator_cast_to_Vector2i((Vector2*)&local_48);
      if (local_c8 == (Object*)0x0) {
         _err_print_error("get_texture_mipmaps_count", "editor/plugins/texture_editor_plugin.cpp", 0x86, "Condition \"p_texture.is_null()\" is true. Returning: -1", 0, 0);
         ...
         LAB_00101467:local_128 = (CowData<char32_t>*)&local_58;
         local_120 = local_c0;
         ...
         vformat<int,int,String,String>((CowData<char32_t>*)&local_50, local_68, uVar6, uVar5, local_128, local_60);
         ...
         LAB_00100fb9:pOVar8 = local_c8;
         local_120 = local_c0;
         pOVar7 = (Object*)__dynamic_cast(local_c8, &Object::typeinfo, &AtlasTexture::typeinfo, 0);
         if (( pOVar7 == (Object*)0x0 ) || ( cVar2 = RefCounted::reference() ),pOVar8 = local_c8,cVar2 == '\0') {
            ...
            LAB_00101810:if (iVar3 == 0x27) goto LAB_00101819;
            Image::get_format_pixel_size(iVar3);
            Image::get_format_pixel_rshift(iVar3);
            goto LAB_00101467;
         }
         ...
         if (local_58 == (Object*)0x0) {
            LAB_00101800:cVar2 = RefCounted::unreference();
            if (( cVar2 == '\0' ) || ( cVar2 = cVar2 == '\0' )) goto LAB_00101810;
            ...
            pIVar9 = local_50;
            if (local_50 == (Image*)0x0) {
               if (( local_58 == (Object*)0x0 ) || ( cVar2 = cVar2 == '\0' )) goto LAB_00101800;
               LAB_00101a90:cVar2 = predelete_handler(local_58);
               if (cVar2 != '\0') {
                  ( **(code**)( *(long*)local_58 + 0x140 ) )();
                  Memory::free_static(local_58, false);
               }

               LAB_0010177d:if (pIVar9 == (Image*)0x0) goto LAB_00101800;
            }
 else {
               cVar2 = RefCounted::reference();
               if (cVar2 == '\0') {
                  ...
                  LAB_00101756:cVar2 = RefCounted::unreference();
                  if (cVar2 != '\0') {
                     memdelete<Image>(local_50);
                  }

                  if (local_58 != (Object*)0x0) {
                     LAB_00101770:cVar2 = RefCounted::unreference();
            ...
            LAB_0010104f:cVar2 = RefCounted::unreference();
            if (cVar2 != '\0') {
         ...
         if (iVar3 == 0x27) {
            LAB_00101819:local_128 = (CowData<char32_t>*)&local_58;
            local_120 = local_c0;
            local_58 = (Object*)0x0;
            pSVar1 = *(String_conflict**)( this + 0xa40 );
            CowData<char32_t>::_ref(local_128, local_120);
 ...
 while ( iVar3 != iVar4 );
            ...
            String::operator +(local_88, local_98);
            String::operator +(local_68, local_88);
            vformat<int,int,String,int,String>((CowData<char32_t>*)&local_50, local_68, uVar6, uVar5, local_128, iVar4, local_60);
            Label::set_text(pSVar1);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
            CowData<char32_t>::_unref((CowData<char32_t>*)local_68);
            CowData<char32_t>::_unref((CowData<char32_t>*)local_88);
      ...
      if (( ( local_c8 != (Object*)0x0 ) && ( cVar2 = RefCounted::unreference() ),cVar2 != '\0' )) &&( cVar2 = cVar2 != '\0' )(**(code**)( *(long*)local_c8 + 0x140 ))(local_c8);
      Memory::free_static(local_c8, false);
   }

   LAB_001018d3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* TexturePreview::TexturePreview(Ref<Texture2D>, bool) */void TexturePreview::TexturePreview(TexturePreview *this, long *param_2, char param_3) {
   StringName *pSVar1;
   long lVar2;
   long *plVar3;
   code *pcVar4;
   ...
   *(TextureRect**)( this + 0xa38 ) = pTVar12;
   ...
   if (cVar8 == '\0') {
      if (local_80 != (Object*)0x0) {
         ...
         if (cVar8 != '\0') {
            ...
            local_a0 = (Shader*)0x0;
            if (cVar8 != '\0') {
               LAB_001027ba:( **(code**)( *(long*)pOVar13 + 0x140 ) )(pOVar13);
      ...
      if (this_02 != (Shader*)local_80) {
         ...
         if (cVar8 == '\0') {
            ...
            if (pOVar13 != (Object*)0x0) {
               cVar8 = RefCounted::unreference();
               joined_r0x00102724:if (( cVar8 != '\0' ) && ( cVar8 = cVar8 != '\0' )) goto LAB_001027ba;
            }
      ...
      LAB_001026af:cVar8 = RefCounted::unreference();
   ...
   if (cVar8 == '\0') {
      ...
      if (pOVar13 != (Object*)0x0) {
         *(undefined8*)( this + 0xa48 ) = 0;
         cVar8 = RefCounted::unreference();
         if (( cVar8 == '\0' ) || ( cVar8 = cVar8 == '\0' )) goto LAB_00101faa;
      ...
      if (this_03 != (ShaderMaterial*)pOVar13) {
         *(ShaderMaterial**)( this + 0xa48 ) = this_03;
         ...
         if (( ( pOVar13 != (Object*)0x0 ) && ( cVar8 = RefCounted::unreference() ),cVar8 != '\0' )) &&( cVar8 = cVar8 != '\0' )(**(code**)( *(long*)pOVar13 + 0x140 ))(pOVar13);
         Memory::free_static(pOVar13, false);
      }
   ...
   if (( cVar8 == '\0' ) || ( cVar8 = cVar8 == '\0' )) {
      LAB_00101faa:pOVar13 = *(Object**)( this + 0xa48 );
   }
 else {
...
ShaderMaterial::set_shader((Ref*)pOVar13);pSVar1 = *(StringName**)( this + 0xa48 );local_68 = __LC82;uStack_60 = _UNK_0010af08;Variant::Variant((Variant*)&local_58, (Vector4*)&local_68);StringName::StringName((StringName*)local_78, "u_channel_factors", false);ShaderMaterial::set_shader_parameter(pSVar1, (Variant*)local_78);if (( StringName::configured != '\0' ) && ( local_78[0] != (Object*)0x0 )) {
   StringName::unref();
}
if (Variant::needs_deinit[(int)local_58] != '\0') {
   Variant::_clear_internal();
}
if (( ( local_80 != (Object*)0x0 ) && ( cVar8 = RefCounted::unreference() ),pOVar13 = local_80,cVar8 != '\0' )) &&( cVar8 = cVar8 != '\0' )(**(code**)( *(long*)pOVar13 + 0x140 ))(pOVar13);Memory::free_static(pOVar13, false);}pTVar12 = (TextureRect*)operator_new(0x9e0, "");TextureRect::TextureRect(pTVar12);postinitialize_handler((Object*)pTVar12);lVar2 = *(long*)pTVar12;*(TextureRect**)( this + 0xa10 ) = pTVar12;( **(code**)( lVar2 + 0x2c8 ) )(pTVar12, 3);TextureRect::set_texture(*(Ref**)( this + 0xa10 ));TextureRect::set_expand_mode(*(undefined8*)( this + 0xa10 ), 1);plVar3 = *(long**)( this + 0xa10 );pcVar4 = *(code**)( *plVar3 + 0x2b8 );local_78[0] = (Object*)0x0;if (( ( *(long*)( this + 0xa48 ) != 0 ) && ( pOVar13 = (Object*)__dynamic_cast(*(long*)( this + 0xa48 ), &Object::typeinfo, &Material::typeinfo, 0) ),pOVar13 != (Object*)0x0 )) {
   local_78[0] = (Object*)0x0;
}
( *pcVar4 )(plVar3);if (( ( local_78[0] != (Object*)0x0 ) && ( cVar8 = RefCounted::unreference() ),pOVar13 = local_78[0],cVar8 != '\0' )) &&( cVar8 = cVar8 != '\0' )(**(code**)( *(long*)pOVar13 + 0x140 ))(pOVar13);Memory::free_static(pOVar13, false);}Node::add_child(*(undefined8*)( this + 0xa28 ), *(undefined8*)( this + 0xa10 ), 0, 0);pCVar11 = (Control*)operator_new(0x9c8, "");Control::Control(pCVar11);postinitialize_handler((Object*)pCVar11);*(Control**)( this + 0xa20 ) = pCVar11;Node::add_child(*(undefined8*)( this + 0xa28 ), pCVar11, 0, 0);plVar3 = *(long**)( this + 0xa20 );pcVar4 = *(code**)( *plVar3 + 0x108 );create_custom_callable_function_pointer<TexturePreview>((TexturePreview*)local_78, (char*)this, (_func_void*)"&TexturePreview::_draw_outline");( *pcVar4 )(plVar3, SceneStringNames::singleton + 8, (StringName*)local_78, 0);Callable::~Callable((Callable*)local_78);if (*param_2 == 0) {
   LAB_00102290:if (param_3 == '\0') {
      LAB_001025a8:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   LAB_001022a2:this_04 = (ColorChannelSelector*)operator_new(0xa40, "");
   ColorChannelSelector::ColorChannelSelector(this_04);
   postinitialize_handler((Object*)this_04);
   lVar2 = *(long*)this_04;
   *(ColorChannelSelector**)( this + 0xa50 ) = this_04;
   pcVar4 = *(code**)( lVar2 + 0x108 );
   create_custom_callable_function_pointer<TexturePreview>((TexturePreview*)local_78, (char*)this, (_func_void*)"&TexturePreview::on_selected_channels_changed");
   ...
   create_custom_callable_function_pointer<TexturePreview>((TexturePreview*)local_78, (char*)this, (_func_void*)"&TexturePreview::_update_texture_display_ratio");
...
this_05 = (Label*)operator_new(0xad8, "");local_78[0] = (Object*)0x0;Label::Label(this_05, (String_conflict*)local_78);postinitialize_handler((Object*)this_05);*(Label**)( this + 0xa40 ) = this_05;CowData<char32_t>::_unref((CowData<char32_t>*)local_78);if (*param_2 != 0) {
   _update_metadata_label_text(this);
   pCVar5 = (Callable*)*param_2;
   create_custom_callable_function_pointer<TexturePreview>((TexturePreview*)local_78, (char*)this, (_func_void*)"&TexturePreview::_update_metadata_label_text");
   Resource::connect_changed(pCVar5, uVar14);
   Callable::~Callable((Callable*)local_78);
}
local_58 = __LC82;uStack_50 = _UNK_0010af08;Control::add_theme_color_override(*(StringName**)( this + 0xa40 ), (Color*)( SceneStringNames::singleton + 0xb0 ));pSVar1 = *(StringName**)( this + 0xa40 );local_58 = __LC80;uStack_50 = _UNK_0010aef8;StringName::StringName((StringName*)local_78, "font_shadow_color", false);Control::add_theme_color_override(pSVar1, (Color*)local_78);if (( StringName::configured != '\0' ) && ( local_78[0] != (Object*)0x0 )) {
   StringName::unref();
}
pSVar1 = *(StringName**)( this + 0xa40 );EditorScale::get_scale();Control::add_theme_font_size_override(pSVar1, (int)SceneStringNames::singleton + 0xa8);pSVar1 = *(StringName**)( this + 0xa40 );local_58 = __LC80;uStack_50 = _UNK_0010aef8;StringName::StringName((StringName*)local_78, "font_outline_color", false);Control::add_theme_color_override(pSVar1, (Color*)local_78);if (( StringName::configured != '\0' ) && ( local_78[0] != (Object*)0x0 )) {
   StringName::unref();
}
pSVar1 = *(StringName**)( this + 0xa40 );EditorScale::get_scale();StringName::StringName((StringName*)local_78, "outline_size", false);Control::add_theme_constant_override(pSVar1, uVar14);if (( StringName::configured != '\0' ) && ( local_78[0] != (Object*)0x0 )) {
   StringName::unref();
}
Control::set_h_size_flags(*(undefined8*)( this + 0xa40 ), 8);Control::set_v_size_flags(*(undefined8*)( this + 0xa40 ), 8);if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   Node::add_child(this, *(undefined8*)( this + 0xa40 ), 0, 0);
   return;
}
LAB_0010289d:/* WARNING: Subroutine does not return */__stack_chk_fail();}/* EditorInspectorPluginTexture::parse_begin(Object*) */void EditorInspectorPluginTexture::parse_begin(EditorInspectorPluginTexture *this, Object *param_1) {
   char cVar1;
   Object *pOVar2;
   Object *pOVar3;
   Object *pOVar4;
   ...
   if (param_1 == (Object*)0x0) {
      LAB_00102ad0:local_40 = (Image*)0x0;
      LAB_00102a0a:ImageTexture::create_from_image((Ref*)&local_38);
      if (local_38 != (Object*)0x0) {
         ...
         if (pOVar2 == (Object*)0x0) {
            ...
            if (cVar1 != '\0') {
               ...
               joined_r0x00102c42:if (cVar1 != '\0') {
                  LAB_00102b91:( **(code**)( *(long*)pOVar3 + 0x140 ) )(pOVar3);
                  Memory::free_static(pOVar3, false);
            ...
            cVar1 = RefCounted::reference();
            if (cVar1 != '\0') {
               if (( ( local_38 != (Object*)0x0 ) && ( cVar1 = RefCounted::unreference() ),pOVar3 = local_38,cVar1 != '\0' )) goto LAB_00102b91;
               LAB_00102a78:if (( local_40 != (Image*)0x0 ) && ( cVar1 = cVar1 != '\0' )) {
            ...
            if (( local_38 != (Object*)0x0 ) && ( cVar1 = RefCounted::unreference() ),pOVar3 = local_38,cVar1 != '\0') {
               pOVar2 = (Object*)0x0;
               cVar1 = predelete_handler(local_38);
      ...
      _err_print_error("parse_begin", "editor/plugins/texture_editor_plugin.cpp", 0x139, "Condition \"texture.is_null()\" is true.", "Failed to create the texture from an invalid image.", 0, 0);
      if (( local_40 != (Image*)0x0 ) && ( cVar1 = cVar1 != '\0' )) {
         memdelete<Image>(local_40);
      }
      ...
      if (( pOVar2 == (Object*)0x0 ) || ( cVar1 = cVar1 == '\0' )) {
         ...
         if (( local_40 == (Image*)0x0 ) || ( cVar1 = cVar1 == '\0' )) goto LAB_00102ad0;
         goto LAB_00102a0a;
      }

      pOVar3 = (Object*)operator_new(0xa68, "");
      LAB_00102938:local_38 = (Object*)0x0;
      pOVar4 = (Object*)__dynamic_cast(pOVar2, &Object::typeinfo, &Texture2D::typeinfo, 0);
      if (( pOVar4 != (Object*)0x0 ) && ( local_38 = pOVar4 ),cVar1 = RefCounted::reference(),cVar1 == '\0') {
         local_38 = (Object*)0x0;
      }
   ...
   LAB_00102c4d:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* RefCounted::is_class_ptr(void*) const */uint RefCounted::is_class_ptr(RefCounted *this, void *param_1) {
   return (uint)CONCAT71(0x10ae, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10ad, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
}
...
/* EditorInspectorPluginTexture::is_class_ptr(void*) const */uint EditorInspectorPluginTexture::is_class_ptr(EditorInspectorPluginTexture *this, void *param_1) {
   return (uint)CONCAT71(0x10ad, (undefined4*)param_1 == &EditorInspectorPlugin::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10ac, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10ad, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10ae, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* EditorInspectorPluginTexture::_getv(StringName const&, Variant&) const */undefined8 EditorInspectorPluginTexture::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorInspectorPluginTexture::_setv(StringName const&, Variant const&) */undefined8 EditorInspectorPluginTexture::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorInspectorPluginTexture::_validate_propertyv(PropertyInfo&) const */void EditorInspectorPluginTexture::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* EditorInspectorPluginTexture::_property_can_revertv(StringName const&) const */undefined8 EditorInspectorPluginTexture::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* EditorInspectorPluginTexture::_property_get_revertv(StringName const&, Variant&) const */undefined8 EditorInspectorPluginTexture::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorInspectorPluginTexture::_notificationv(int, bool) */void EditorInspectorPluginTexture::_notificationv(int param_1, bool param_2) {
   return;
}
/* TextureEditorPlugin::is_class_ptr(void*) const */uint TextureEditorPlugin::is_class_ptr(TextureEditorPlugin *this, void *param_1) {
   return (uint)CONCAT71(0x10ad, (undefined4*)param_1 == &EditorPlugin::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10ac, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10ad, (undefined4*)param_1 == &Node::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10ae, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* TextureEditorPlugin::_getv(StringName const&, Variant&) const */undefined8 TextureEditorPlugin::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* TextureEditorPlugin::_setv(StringName const&, Variant const&) */undefined8 TextureEditorPlugin::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* TextureEditorPlugin::_property_can_revertv(StringName const&) const */undefined8 TextureEditorPlugin::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* TextureEditorPlugin::_property_get_revertv(StringName const&, Variant&) const */undefined8 TextureEditorPlugin::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* ColorRect::is_class_ptr(void*) const */uint ColorRect::is_class_ptr(ColorRect *this, void *param_1) {
   return (uint)CONCAT71(0x10ad, (undefined4*)param_1 == &Control::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10ac, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10ad, (undefined4*)param_1 == &CanvasItem::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10ad, (undefined4*)param_1 == &Node::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10ae, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* CallableCustomMethodPointer<TexturePreview, void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<TexturePreview,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<TexturePreview,void> *this) {
   return;
}
/* CallableCustomMethodPointer<TexturePreview, void>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<TexturePreview,void>::get_argument_count(CallableCustomMethodPointer<TexturePreview,void> *this, bool *param_1) {
   *param_1 = true;
   return 0;
}
/* CallableCustomMethodPointer<TexturePreview, void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<TexturePreview,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<TexturePreview,void> *this) {
...
/* ColorRect::~ColorRect() */void ColorRect::~ColorRect(ColorRect *this) {
...
/* TexturePreview::_property_get_revertv(StringName const&, Variant&) const */undefined8 TexturePreview::_property_get_revertv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
...
/* ColorRect::_property_get_revertv(StringName const&, Variant&) const */undefined8 ColorRect::_property_get_revertv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   if ((code*)_GLOBAL_OFFSET_TABLE_ != Object::_property_get_revert) {
      uVar1 = Control::_property_get_revert(param_1, param_2);
      return uVar1;
...
/* TexturePreview::_property_can_revertv(StringName const&) const */undefined8 TexturePreview::_property_can_revertv(StringName *param_1) {
   undefined8 uVar1;
...
/* ColorRect::_property_can_revertv(StringName const&) const */undefined8 ColorRect::_property_can_revertv(StringName *param_1) {
   undefined8 uVar1;
   if ((code*)PTR__property_can_revert_0010e008 != Object::_property_can_revert) {
      uVar1 = Control::_property_can_revert(param_1);
      return uVar1;
...
/* TextureEditorPlugin::_validate_propertyv(PropertyInfo&) const */void TextureEditorPlugin::_validate_propertyv(PropertyInfo *param_1) {
...
/* ColorRect::_get_class_namev() const */undefined8 *ColorRect::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001034c3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001034c3;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "ColorRect");
         goto LAB_0010352e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "ColorRect");
   LAB_0010352e:return &_get_class_namev();
}
/* CallableCustomMethodPointer<TexturePreview, void>::get_object() const */undefined8 CallableCustomMethodPointer<TexturePreview,void>::get_object(CallableCustomMethodPointer<TexturePreview,void> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_0010365d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* TexturePreview::_validate_propertyv(PropertyInfo&) const */void TexturePreview::_validate_propertyv(PropertyInfo *param_1) {
   Node::_validate_property(param_1);
...
/* ColorRect::_validate_propertyv(PropertyInfo&) const */void ColorRect::_validate_propertyv(PropertyInfo *param_1) {
   Node::_validate_property(param_1);
   CanvasItem::_validate_property(param_1);
   if ((code*)PTR__validate_property_0010e018 == CanvasItem::_validate_property) {
      return;
...
/* TexturePreview::is_class_ptr(void*) const */uint TexturePreview::is_class_ptr(void *param_1) {
   uint uVar1;
   undefined4 in_EDX;
   undefined4 *in_RSI;
   uVar1 = 1;
   if (in_RSI != &get_class_ptr_static()::ptr) {
      uVar1 = (uint)CONCAT71(0x10ad, in_RSI == &Container::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10ad, in_RSI == &MarginContainer::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10ad, in_RSI == &Control::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10ad, in_RSI == &CanvasItem::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10ad, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr);
   }

   return uVar1;
}
/* TextureEditorPlugin::_notificationv(int, bool) */void TextureEditorPlugin::_notificationv(TextureEditorPlugin *this, int param_1, bool param_2) {
   int iVar1;
   iVar1 = (int)this;
   if (param_2) {
...
/* TexturePreview::_setv(StringName const&, Variant const&) */undefined8 TexturePreview::_setv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
...
/* ColorRect::_setv(StringName const&, Variant const&) */undefined8 ColorRect::_setv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   uVar1 = CanvasItem::_set(param_1, param_2);
   if ((char)uVar1 == '\0') {
      if ((code*)PTR__set_0010e028 != CanvasItem::_set) {
...
/* WARNING: Removing unreachable block (ram,0x001039e8) *//* TexturePreview::_getv(StringName const&, Variant&) const */undefined8 TexturePreview::_getv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   if (( (code*)PTR__get_0010e030 != CanvasItem::_get ) && ( uVar1 = Control::_get(param_1, param_2) ),(char)uVar1 != '\0') {
      return uVar1;
   }
...
/* WARNING: Removing unreachable block (ram,0x00103a58) *//* ColorRect::_getv(StringName const&, Variant&) const */undefined8 ColorRect::_getv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   if (( (code*)PTR__get_0010e030 != CanvasItem::_get ) && ( uVar1 = Control::_get(param_1, param_2) ),(char)uVar1 != '\0') {
      return uVar1;
   }
...
/* TexturePreview::~TexturePreview() */void TexturePreview::~TexturePreview(TexturePreview *this) {
   Object *pOVar1;
   char cVar2;
   bool bVar3;
   *(undefined***)this = &PTR__initialize_classv_0010a100;
   ...
   *(code**)this = Control::_notification;
   ...
   LAB_00103ae4:Control::~Control((Control*)this);
   return;
}
/* TexturePreview::~TexturePreview() */void TexturePreview::~TexturePreview(TexturePreview *this) {
   Object *pOVar1;
   ...
   *(code**)this = Control::_notification;
   ...
   LAB_00103ba4:Control::~Control((Control*)this);
   operator_delete(this, 0xa68);
   return;
}
/* WARNING: Removing unreachable block (ram,0x00103caa) *//* ColorRect::_notificationv(int, bool) */void ColorRect::_notificationv(ColorRect *this, int param_1, bool param_2) {
   int iVar1;
   iVar1 = (int)this;
   if (param_2) {
...
/* TextureEditorPlugin::get_plugin_name() const */TextureEditorPlugin * __thiscall TextureEditorPlugin::get_plugin_name(TextureEditorPlugin *this){
   long lVar1;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   *(undefined8*)this = 0;
...
/* RefCounted::_get_class_namev() const */undefined8 *RefCounted::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00103da3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00103da3;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "RefCounted");
   LAB_00103e0e:return &_get_class_namev();
}
/* TexturePreview::_get_class_namev() const */undefined8 *TexturePreview::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00103e93:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00103e93;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "TexturePreview");
         goto LAB_00103efe;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "TexturePreview");
   LAB_00103efe:return &_get_class_namev();
}
/* EditorInspectorPluginTexture::_get_class_namev() const */undefined8 *EditorInspectorPluginTexture::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00103f93:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00103f93;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorInspectorPluginTexture");
         goto LAB_00103ffe;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorInspectorPluginTexture");
   LAB_00103ffe:return &_get_class_namev();
}
/* TextureEditorPlugin::_get_class_namev() const */undefined8 *TextureEditorPlugin::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      ...
      if (*(long*)( _get_class_namev() ) != 0) {
         ...
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "TextureEditorPlugin");
         goto LAB_001040ee;
      }
...
/* TexturePreview::_notificationv(int, bool) */void TexturePreview::_notificationv(TexturePreview *this, int param_1, bool param_2) {
   int iVar1;
   iVar1 = (int)this;
   if (param_2) {
      if (( ( param_1 == 10 ) || ( param_1 == 0x2d ) ) && ( ( (byte)this[0x2fa] & 0x40 ) != 0 )) {
...
/* Callable create_custom_callable_function_pointer<TexturePreview>(TexturePreview*, char const*,
   void (TexturePreview::*)()) */TexturePreview *create_custom_callable_function_pointer<TexturePreview>(TexturePreview *param_1, char *param_2, _func_void *param_3) {
   undefined8 uVar1;
   CallableCustom *this;
   undefined8 in_RCX;
   undefined8 in_R8;
...
/* void Ref<EditorInspectorPluginTexture>::instantiate<>() */void Ref<EditorInspectorPluginTexture>::instantiate<>(Ref<EditorInspectorPluginTexture> *this) {
   char cVar1;
   RefCounted *this_00;
   long lVar2;
   RefCounted *pRVar3;
   ...
   *(undefined***)this_00 = &PTR__initialize_classv_0010aa88;
   ...
   if (cVar1 == '\0') {
      ...
      *(RefCounted**)this = this_00;
      ...
      if (( ( pOVar5 == (Object*)0x0 ) || ( cVar1 = RefCounted::unreference() ),cVar1 == '\0' )) goto LAB_001046a5;
   }
   ...
   LAB_001046a5:cVar1 = RefCounted::unreference();
   if (( cVar1 != '\0' ) && ( cVar1 = cVar1 != '\0' )) {
...
/* EditorPlugin::~EditorPlugin() */void EditorPlugin::~EditorPlugin(EditorPlugin *this) {
   ...
   *(code**)this = EditorPlugin::add_inspector_plugin;
   ...
   LAB_00104fea:CowData<char32_t>::_unref((CowData<char32_t>*)( this + 0x418 ));
...
/* TextureEditorPlugin::~TextureEditorPlugin() */void TextureEditorPlugin::~TextureEditorPlugin(TextureEditorPlugin *this) {
   *(undefined***)this = &PTR__initialize_classv_0010a478;
...
/* TexturePreview::_initialize_classv() */void TexturePreview::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   long local_58;
   undefined8 local_50;
   ...
   if (initialize_class() == '\0') {
      if (MarginContainer::initialize_class() == '\0') {
         ...
         MarginContainer::initialize_class()::initialized =
         '\x01';
      }
...
/* WARNING: Removing unreachable block (ram,0x00105890) *//* String vformat<int, int, String, int, String>(String const&, int const, int const, String const,
   int const, String const) */undefined8 *vformat<int,int,String,int,String>(undefined8 *param_1, bool *param_2, int param_3, int param_4, String_conflict *param_5, int param_6, String_conflict *param_7) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   int iVar4;
...
/* WARNING: Removing unreachable block (ram,0x00105b68) *//* String vformat<int, int, String, String>(String const&, int const, int const, String const,
   String const) */undefined8 *vformat<int,int,String,String>(undefined8 *param_1, bool *param_2, int param_3, int param_4, String_conflict *param_5, String_conflict *param_6) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   int iVar4;
...
/* WARNING: Removing unreachable block (ram,0x00105e20) *//* String vformat<int, int, String>(String const&, int const, int const, String const) */undefined8 *vformat<int,int,String>(undefined8 *param_1, bool *param_2, int param_3, int param_4, String_conflict *param_5) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   int iVar4;
...
/* TextureEditorPlugin::get_class() const */void TextureEditorPlugin::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* ColorRect::get_class() const */void ColorRect::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* TexturePreview::get_class() const */void TexturePreview::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* EditorInspectorPluginTexture::get_class() const */void EditorInspectorPluginTexture::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* CallableCustomMethodPointer<TexturePreview, void>::call(Variant const**, int, Variant&,
   Callable::CallError&) const */void CallableCustomMethodPointer<TexturePreview,void>::call(CallableCustomMethodPointer<TexturePreview,void> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   LAB_00106770:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* EditorInspectorPluginTexture::_initialize_classv() */void EditorInspectorPluginTexture::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_70;
   long local_68;
   long local_60;
...
/* TextureEditorPlugin::_initialize_classv() */void TextureEditorPlugin::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_70;
   long local_68;
   long local_60;
...
/* ColorRect::_initialize_classv() */void ColorRect::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_70;
   long local_68;
   long local_60;
...
/* Node::is_class(String const&) const */undefined8 Node::is_class(Node *this, String_conflict *param_1) {
   ...
   if (cVar4 == '\0') {
      ...
      LAB_00107403:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* Control::is_class(String const&) const */undefined8 Control::is_class(Control *this, String_conflict *param_1) {
   ...
   LAB_001075e3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_001076ee:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* ColorRect::is_class(String const&) const */undefined8 ColorRect::is_class(ColorRect *this, String_conflict *param_1) {
   long *plVar1;
   long lVar2;
   char *__s;
   long lVar3;
   ...
   if (cVar4 == '\0') {
      ...
      LAB_001077fb:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* TexturePreview::is_class(String const&) const */undefined8 TexturePreview::is_class(TexturePreview *this, String_conflict *param_1) {
   long lVar1;
   char *pcVar2;
   long lVar3;
   char cVar4;
   ...
   LAB_00107abe:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* TextureEditorPlugin::is_class(String const&) const */undefined8 TextureEditorPlugin::is_class(TextureEditorPlugin *this, String_conflict *param_1) {
   long lVar1;
   char *pcVar2;
   long lVar3;
   char cVar4;
   ...
   LAB_00107ba3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_00107cae:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* RefCounted::is_class(String const&) const */undefined8 RefCounted::is_class(RefCounted *this, String_conflict *param_1) {
   ...
   if (cVar4 == '\0') {
      ...
      LAB_00107d93:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* EditorInspectorPluginTexture::is_class(String const&) const */undefined8 EditorInspectorPluginTexture::is_class(EditorInspectorPluginTexture *this, String_conflict *param_1) {
   long lVar1;
   char *pcVar2;
   long lVar3;
   char cVar4;
   ...
   LAB_00107f73:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010807e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* PropertyListHelper::~PropertyListHelper() */void PropertyListHelper::~PropertyListHelper(PropertyListHelper *this) {
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
   ...
   LAB_0010817f:CowData<char32_t>::_unref((CowData<char32_t>*)this);
   return;
}
...
/* EditorInspectorPluginTexture::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool)
   const */void EditorInspectorPluginTexture::_get_property_listv(EditorInspectorPluginTexture *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   undefined8 local_90;
   undefined8 local_88;
   long local_80;
...
/* TextureEditorPlugin::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void TextureEditorPlugin::_get_property_listv(TextureEditorPlugin *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   undefined8 local_90;
   undefined8 local_88;
   long local_80;
...
/* MarginContainer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void MarginContainer::_get_property_listv(MarginContainer *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   undefined8 local_90;
   undefined8 local_88;
   long local_80;
...
/* TexturePreview::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void TexturePreview::_get_property_listv(TexturePreview *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   undefined8 local_90;
   undefined8 local_88;
   long local_80;
...
/* ColorRect::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void ColorRect::_get_property_listv(ColorRect *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   undefined8 local_90;
   undefined8 local_88;
   long local_80;
...
/* EditorInspectorPlugin::~EditorInspectorPlugin() */void EditorInspectorPlugin::~EditorInspectorPlugin(EditorInspectorPlugin *this) {
   ...
   *(code**)this = RefCounted::init_ref;
   ...
   LAB_00109bc9:plVar4 = *(long**)( this + 0x180 );
   if (plVar4 != (long*)0x0) {
      do {
 ...
 while ( (int)plVar4[2] != 0 );
   ...
   LAB_00109c35:*(undefined***)this = &PTR__initialize_classv_00109fa0;
   Object::~Object((Object*)this);
   return;
}
/* EditorInspectorPlugin::~EditorInspectorPlugin() */void EditorInspectorPlugin::~EditorInspectorPlugin(EditorInspectorPlugin *this) {
...
/* EditorInspectorPluginTexture::~EditorInspectorPluginTexture() */void EditorInspectorPluginTexture::~EditorInspectorPluginTexture(EditorInspectorPluginTexture *this) {
...
/* TexturePreview::get_texture_display() */void TexturePreview::_GLOBAL__sub_I_get_texture_display(void) {
   undefined8 uStack_8;
...
/* WARNING: Control flow encountered bad instruction data *//* TextureEditorPlugin::~TextureEditorPlugin() */void TextureEditorPlugin::~TextureEditorPlugin(TextureEditorPlugin *this) {
...
/* WARNING: Control flow encountered bad instruction data *//* TexturePreview::~TexturePreview() */void TexturePreview::~TexturePreview(TexturePreview *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* ColorRect::~ColorRect() */void ColorRect::~ColorRect(ColorRect *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<TexturePreview, void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<TexturePreview,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<TexturePreview,void> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* EditorInspectorPluginTexture::~EditorInspectorPluginTexture() */void EditorInspectorPluginTexture::~EditorInspectorPluginTexture(EditorInspectorPluginTexture *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

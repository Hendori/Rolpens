/* GPUParticlesCollision3DGizmoPlugin::get_priority() const */undefined8 GPUParticlesCollision3DGizmoPlugin::get_priority(void) {
   return 0xffffffff;
}
/* GPUParticlesCollision3DGizmoPlugin::begin_handle_action(EditorNode3DGizmo const*, int, bool) */void GPUParticlesCollision3DGizmoPlugin::begin_handle_action(GPUParticlesCollision3DGizmoPlugin *this, EditorNode3DGizmo *param_1, int param_2, bool param_3) {
   Variant *pVVar1;
   long in_FS_OFFSET;
   int local_98[22];
   long local_40;
...
/* GPUParticlesCollision3DGizmoPlugin::has_gizmo(Node3D*) */bool GPUParticlesCollision3DGizmoPlugin::has_gizmo(GPUParticlesCollision3DGizmoPlugin *this, Node3D *param_1) {
   long lVar1;
...
/* GPUParticlesCollision3DGizmoPlugin::~GPUParticlesCollision3DGizmoPlugin() */void GPUParticlesCollision3DGizmoPlugin::~GPUParticlesCollision3DGizmoPlugin(GPUParticlesCollision3DGizmoPlugin *this) {
   Object *pOVar1;
   char cVar2;
...
/* GPUParticlesCollision3DGizmoPlugin::get_gizmo_name() const */GPUParticlesCollision3DGizmoPlugin * __thiscall
...
/* GPUParticlesCollision3DGizmoPlugin::set_handle(EditorNode3DGizmo const*, int, bool, Camera3D*,
   Vector2 const&) */void GPUParticlesCollision3DGizmoPlugin::set_handle(EditorNode3DGizmo *param_1, int param_2, bool param_3, Camera3D *param_4, Vector2 *param_5) {
   long *plVar1;
   ...
   if (plVar1 != (long*)0x0) {
      ...
      if (( lVar3 != 0 ) || ( lVar3 = __dynamic_cast(plVar1, &Object::typeinfo, &GPUParticlesAttractorSphere3D::typeinfo, 0) ),lVar3 != 0) {
         local_100 = 0;
         local_f8 = 0;
         local_f4 = 0;
         local_ec = 0;
         ...
         Geometry3D::get_closest_points_between_segments((Variant*)local_78, (Variant*)local_98, (Vector3*)&local_d8, (Vector3*)&local_cc, (Vector3*)&local_100, (Vector3*)&local_f4);
         ...
         ( **(code**)( *plVar1 + 0x68 ) )((Variant*)local_98, plVar1, (StringName*)&local_120, local_e8, 1, local_118);
         if (local_118[0] == 0) {
      ...
      if (( ( ( lVar3 != 0 ) || ( lVar3 = __dynamic_cast(plVar1, &Object::typeinfo, &GPUParticlesAttractorBox3D::typeinfo, 0) ),lVar3 != 0 ) ) || ( lVar3 = __dynamic_cast(plVar1, &Object::typeinfo, &GPUParticlesAttractorVectorField3D::typeinfo, 0) ),lVar3 != 0) {
         ...
         ( **(code**)( *plVar1 + 0x68 ) )((Variant*)local_78, plVar1, (StringName*)&local_120, 0, 0, local_118);
         if (local_118[0] == 0) {
         ...
         local_100 = 0;
         local_f8 = 0;
         Gizmo3DHelper::box_set_handle(*(Vector3**)( param_1 + 0x450 ), (int)&local_d8, (Vector3*)( CONCAT71(in_register_00000011, param_3) & 0xffffffff ), (Vector3*)&local_10c);
...
/* GPUParticlesCollision3DGizmoPlugin::get_handle_name(EditorNode3DGizmo const*, int, bool) const */EditorNode3DGizmo *GPUParticlesCollision3DGizmoPlugin::get_handle_name(EditorNode3DGizmo *param_1, int param_2, bool param_3) {
   long lVar1;
   long lVar2;
   long lVar3;
   undefined7 in_register_00000011;
   ...
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   if (lVar3 == 0) {
      LAB_00100e08:*(undefined8*)param_1 = 0;
      ...
      if (lVar2 == 0) {
         ...
         if (lVar2 == 0) {
            ...
            if (lVar2 == 0) {
               ...
               if (lVar2 == 0) {
                  lVar2 = __dynamic_cast(lVar3, &Object::typeinfo, &GPUParticlesAttractorVectorField3D::typeinfo, 0);
                  if (lVar2 == 0) {
                     lVar2 = __dynamic_cast(lVar3, &Object::typeinfo, &GPUParticlesCollisionSDF3D::typeinfo, 0);
                     if (lVar2 == 0) {
                        lVar3 = __dynamic_cast(lVar3, &Object::typeinfo, &GPUParticlesCollisionHeightField3D::typeinfo, 0);
   ...
   LAB_00100d2f:if (lVar1 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* GPUParticlesCollision3DGizmoPlugin::get_handle_value(EditorNode3DGizmo const*, int, bool) const
    */EditorNode3DGizmo *GPUParticlesCollision3DGizmoPlugin::get_handle_value(EditorNode3DGizmo *param_1, int param_2, bool param_3) {
   long *plVar1;
   long lVar2;
   undefined7 in_register_00000011;
   long in_FS_OFFSET;
   ...
   if (plVar1 == (long*)0x0) {
      LAB_001010c4:*(undefined4*)param_1 = 0;
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   }
 else {
      lVar2 = __dynamic_cast(plVar1, &Object::typeinfo, &GPUParticlesCollisionSphere3D::typeinfo, 0);
      if (( lVar2 == 0 ) && ( lVar2 = __dynamic_cast(plVar1, &Object::typeinfo, &GPUParticlesAttractorSphere3D::typeinfo, 0) ),lVar2 == 0) {
         lVar2 = __dynamic_cast(plVar1, &Object::typeinfo, &GPUParticlesCollisionBox3D::typeinfo, 0);
         if (( ( ( lVar2 == 0 ) && ( lVar2 = __dynamic_cast(plVar1, &Object::typeinfo, &GPUParticlesAttractorBox3D::typeinfo, 0) ),lVar2 == 0 ) ) && ( lVar2 = __dynamic_cast(plVar1, &Object::typeinfo, &GPUParticlesAttractorVectorField3D::typeinfo, 0) ),lVar2 == 0) goto LAB_001010c4;
         ...
         uStack_74 = 0;
         uStack_70 = 0;
         ( **(code**)( *plVar1 + 0x68 ) )((Variant*)local_48, plVar1, (StringName*)&local_80, 0, 0, &local_78);
         if (local_78 == 0) {
   ...
   LAB_00100f37:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* GPUParticlesCollision3DGizmoPlugin::commit_handle(EditorNode3DGizmo const*, int, bool, Variant
   const&, bool) */void GPUParticlesCollision3DGizmoPlugin::commit_handle(GPUParticlesCollision3DGizmoPlugin *this, EditorNode3DGizmo *param_1, int param_2, bool param_3, Variant *param_4, bool param_5) {
   StringName *pSVar1;
   String *pSVar2;
   long lVar3;
   Object *pOVar4;
   ...
   if (pSVar1 != (StringName*)0x0) {
      ...
      if (( lVar3 != 0 ) || ( lVar3 = __dynamic_cast(pSVar1, &Object::typeinfo, &GPUParticlesAttractorSphere3D::typeinfo, 0) ),lVar3 != 0) {
         if (param_5) {
            ...
            local_f0 = 0;
            local_e8[0] = (Variant*)local_78;
            ( **(code**)( *(long*)pSVar1 + 0x68 ) )((Variant*)local_98, pSVar1, (StringName*)&local_100, local_e8, 1, &local_f8);
            if (local_f8 == 0) {
               Variant::Variant((Variant*)&local_b8, (Variant*)local_98);
            }
 else {
      ...
      if (( ( ( lVar3 != 0 ) || ( lVar3 = __dynamic_cast(pSVar1, &Object::typeinfo, &GPUParticlesAttractorBox3D::typeinfo, 0) ),lVar3 != 0 ) ) || ( lVar3 = __dynamic_cast(pSVar1, &Object::typeinfo, &GPUParticlesAttractorVectorField3D::typeinfo, 0) ),lVar3 != 0) {
         ...
         Gizmo3DHelper::box_commit_handle(pSVar2, SUB81((StrRange*)&local_110, 0), (Object*)(ulong)param_5, (Object*)pSVar1, (StringName*)0x0, (StringName*)&local_108);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_110);
         if (( ( StringName::configured != '\0' ) && ( ( local_108 == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) ) ) && ( local_100 != 0 )) {
            StringName::unref();
         }
   ...
   LAB_001014b8:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   ...
   *(undefined1(*) [16])( this_00 + 0x1a8 ) = auVar7;
   ...
   if (cVar1 == '\0') {
      ...
      *(undefined8*)( this + 0x450 ) = 0;
      ...
      if (cVar1 == '\0') goto LAB_001018cc;
      LAB_00101c23:( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
      ...
      if (this_00 != (RefCounted*)pOVar5) {
         *(RefCounted**)( this + 0x450 ) = this_00;
         ...
         pOVar4 = (Object*)this_00;
         if (( ( pOVar5 != (Object*)0x0 ) && ( cVar1 = RefCounted::unreference() ),cVar1 != '\0' )) goto LAB_00101c23;
      }
   ...
   LAB_001018cc:local_90 = (Object*)0x0;
   ...
   local_80 = 0x18;
   String::parse_latin1((StrRange*)&local_90);
   EditorNode3DGizmoPlugin::create_material((String*)this, (StrRange*)&local_90, SUB81(&local_78, 0), false, false);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_90);
...
return;}/* Vector<Vector3>::push_back(Vector3) [clone .isra.0] */void Vector<Vector3>::push_back(undefined8 param_1, undefined4 param_2, long param_3) {
   undefined8 *puVar1;
   int iVar2;
   long lVar3;
   long lVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GPUParticlesCollision3DGizmoPlugin::redraw(EditorNode3DGizmo*) */void GPUParticlesCollision3DGizmoPlugin::redraw(GPUParticlesCollision3DGizmoPlugin *this, EditorNode3DGizmo *param_1) {
   long *plVar1;
   ...
   local_d8 = (Object*)0x0;
   local_a8 = param_1;
   if (( lVar8 == 0 ) || ( lVar5 = __dynamic_cast(lVar8, &Object::typeinfo, &GPUParticlesAttractor3D::typeinfo, 0) ),lVar5 == 0) {
         ...
         if (local_e0 != pOVar6) {
            if (pOVar6 == (Object*)0x0) {
               ...
               if (pOVar7 != (Object*)0x0) {
                  LAB_001032c1:cVar3 = RefCounted::unreference();
      ...
      LAB_001030cd:CowData<char32_t>::_unref((CowData<char32_t>*)&local_b8);
      if (( ( local_a8 != (EditorNode3DGizmo*)0x0 ) && ( cVar3 = RefCounted::unreference() ),pEVar2 = local_a8,cVar3 != '\0' )) &&( cVar3 = cVar3 != '\0' )(**(code**)( *(long*)pEVar2 + 0x140 ))(pEVar2);
   ...
   if (local_98 != (Object*)0x0) {
      ...
      if (local_d8 != pOVar6) {
         if (pOVar6 == (Object*)0x0) {
            ...
            if (pOVar7 != (Object*)0x0) {
               LAB_0010344b:cVar3 = RefCounted::unreference();
               if (( cVar3 != '\0' ) && ( cVar3 = cVar3 != '\0' )) {
                  ( **(code**)( *(long*)pOVar7 + 0x140 ) )(pOVar7);
                  Memory::free_static(pOVar7, false);
               }
...
else{cVar3 = RefCounted::init_ref();if (cVar3 == '\0') {
   local_a8 = (EditorNode3DGizmo*)0x0;
}
local_b8 = 0;local_98 = (Object*)0x103ca5;local_90 = 0x18;String::parse_latin1((StrRange*)&local_b8);EditorNode3DGizmoPlugin::get_material((String*)&local_98, (Ref*)this);pOVar7 = local_e0;if (local_98 == (Object*)0x0) {
   if (local_e0 != (Object*)0x0) {
      local_e0 = (Object*)0x0;
      goto LAB_00102cb4;
   }
   ...
   if (local_e0 != pOVar6) {
      if (pOVar6 == (Object*)0x0) {
         ...
         if (pOVar7 != (Object*)0x0) {
            LAB_00102cb4:cVar3 = RefCounted::unreference();
            if (( cVar3 != '\0' ) && ( cVar3 = cVar3 != '\0' )) {
               ( **(code**)( *(long*)pOVar7 + 0x140 ) )(pOVar7);
               Memory::free_static(pOVar7, false);
            }
...
LAB_00101f31:CowData<char32_t>::_unref((CowData<char32_t>*)&local_b8);if (( ( local_a8 != (EditorNode3DGizmo*)0x0 ) && ( cVar3 = RefCounted::unreference() ),pEVar2 = local_a8,cVar3 != '\0' )) &&( cVar3 = cVar3 != '\0' )(**(code**)( *(long*)pEVar2 + 0x140 ))(pEVar2);Memory::free_static(pEVar2, false);}local_a8 = param_1;cVar3 = RefCounted::init_ref();if (cVar3 == '\0') {
   local_a8 = (EditorNode3DGizmo*)0x0;
}
local_b8 = 0;local_98 = (Object*)0x104b78;local_90 = 0x21;String::parse_latin1((StrRange*)&local_b8);EditorNode3DGizmoPlugin::get_material((String*)&local_98, (Ref*)this);pOVar7 = local_d8;if (local_98 == (Object*)0x0) {
   if (local_d8 != (Object*)0x0) {
      local_d8 = (Object*)0x0;
      goto LAB_00102c5b;
   }
   ...
   if (local_d8 != pOVar6) {
      if (pOVar6 == (Object*)0x0) {
         ...
         if (pOVar7 != (Object*)0x0) {
            LAB_00102c5b:cVar3 = RefCounted::unreference();
            if (( cVar3 != '\0' ) && ( cVar3 = cVar3 != '\0' )) {
               ( **(code**)( *(long*)pOVar7 + 0x140 ) )(pOVar7);
               Memory::free_static(pOVar7, false);
            }
   ...
   cVar3 = RefCounted::unreference();
   pOVar7 = local_98;
   joined_r0x001031c9:local_98 = pOVar7;
   if (( cVar3 != '\0' ) && ( cVar3 = cVar3 != '\0' )) {
      ( **(code**)( *(long*)pOVar7 + 0x140 ) )(pOVar7);
      Memory::free_static(pOVar7, false);
   }
...
}LAB_0010203f:local_108 = (Ref*)&local_a8;local_120 = (String*)&local_98;CowData<char32_t>::_unref((CowData<char32_t>*)&local_b8);if (( ( local_a8 != (EditorNode3DGizmo*)0x0 ) && ( cVar3 = RefCounted::unreference() ),pEVar2 = local_a8,cVar3 != '\0' )) &&( cVar3 = cVar3 != '\0' )(**(code**)( *(long*)pEVar2 + 0x140 ))(pEVar2);Memory::free_static(pEVar2, false);}local_a8 = (EditorNode3DGizmo*)0x0;local_98 = (Object*)0x103cd7;local_b8 = 0;local_90 = 7;String::parse_latin1((StrRange*)&local_b8);EditorNode3DGizmoPlugin::get_material(local_120, (Ref*)this);local_d0 = (Object*)0x0;if (local_98 != (Object*)0x0) {
...
LAB_0010212c:CowData<char32_t>::_unref((CowData<char32_t>*)&local_b8);if (( ( local_a8 != (EditorNode3DGizmo*)0x0 ) && ( cVar3 = RefCounted::unreference() ),pEVar2 = local_a8,cVar3 != '\0' )) &&( cVar3 = cVar3 != '\0' )(**(code**)( *(long*)pEVar2 + 0x140 ))(pEVar2);Memory::free_static(pEVar2, false);}if (lVar8 != 0) {
   lVar5 = __dynamic_cast(lVar8, &Object::typeinfo, &GPUParticlesCollisionSphere3D::typeinfo);
   if (( lVar5 != 0 ) || ( lVar5 = __dynamic_cast(lVar8, &Object::typeinfo, &GPUParticlesAttractorSphere3D::typeinfo) ),lVar5 != 0) {
...
;
      ...
      while (true) {
         ...
         local_58[1] = fVar17;
         local_58[2] = fVar19;
         Vector<Vector3>::push_back((ulong)(uint)fVar17 << 0x20, fVar19, (CowData<char32_t>*)&local_b8);
         local_58[0] = 0.0;
         local_58[1] = fVar21;
         local_58[2] = fVar20;
         Vector<Vector3>::push_back((ulong)(uint)fVar21 << 0x20, fVar20, (CowData<char32_t>*)&local_b8);
         local_58[2] = 0.0;
         local_58[0] = fVar17;
         local_58[1] = fVar19;
...
;
      ...
      local_90 = 0;
      EditorNode3DGizmo::add_handles((Vector*)param_1, local_108, (Vector*)&local_d0, SUB81(local_120, 0), false);
      lVar5 = local_90;
      if (local_90 != 0) {
         LOCK();
   ...
   if (( ( ( lVar5 == 0 ) && ( lVar5 = __dynamic_cast(lVar8, &Object::typeinfo, &GPUParticlesAttractorBox3D::typeinfo, 0) ),lVar5 == 0 ) ) && ( lVar5 = __dynamic_cast(lVar8, &Object::typeinfo, &GPUParticlesAttractorVectorField3D::typeinfo, 0) ),lVar5 == 0) {
   ...
   do {
      ...
      Vector<Vector3>::push_back(CONCAT44(local_58[1], local_58[0]), local_58[2], (CowData<char32_t>*)&local_b8);
 ...
 while ( uVar12 != 0xc );
   ...
   if (lVar8 != 0) {
      ...
      iVar9 = *(int*)( redraw(EditorNode3DGizmo*):: );
      fVar18 = local_64;
      if (local_64 <= fVar15) {
         fVar18 = fVar15;
      }
               ...
               if (fVar15 < ( &local_70 )[uVar10] || fVar15 == ( &local_70 )[uVar10]) {
                  ...
                  LAB_00102dae:do {
                     ...
                     if (( uVar4 & 1 ) == 0) {
                        ...
                        LAB_00102e2f:lVar5 = (long)(int)uVar12;
                        *(float*)( (long)&local_84 + lVar8 * 4 ) = *(float*)( (long)&local_84 + lVar8 * 4 ) + *(float*)( local_6c + lVar8 * 4 );
                        *(float*)( (long)&local_84 + lVar5 * 4 ) = *(float*)( (long)&local_84 + lVar5 * 4 ) + *(float*)( local_6c + lVar5 * 4 );
                     }
 else {
 ...
 while ( iVar9 != iVar11 );
      ...
      local_58[2] = (float)_UNK_00106fa8;
      local_58[3] = (float)( (ulong)_UNK_00106fa8 >> 0x20 );
      EditorNode3DGizmo::add_lines((Vector*)param_1, (Ref*)&local_b8, SUB81(&local_d8, 0), (Color*)0x0);
   }
...
LAB_00102bc7:if (local_d0 != (Object*)0x0) {
   cVar3 = RefCounted::unreference();
   pOVar7 = local_d0;
   if (cVar3 != '\0') {
...
/* RefCounted::is_class_ptr(void*) const */uint RefCounted::is_class_ptr(RefCounted *this, void *param_1) {
   return (uint)CONCAT71(0x106e, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x106e, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
}
...
/* GPUParticlesCollision3DGizmoPlugin::is_class_ptr(void*) const */uint GPUParticlesCollision3DGizmoPlugin::is_class_ptr(GPUParticlesCollision3DGizmoPlugin *this, void *param_1) {
   return (uint)CONCAT71(0x106e, (undefined4*)param_1 == &EditorNode3DGizmoPlugin::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x106e, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x106e, (undefined4*)param_1 == &Resource::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x106e, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x106e, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* GPUParticlesCollision3DGizmoPlugin::_getv(StringName const&, Variant&) const */undefined8 GPUParticlesCollision3DGizmoPlugin::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* GPUParticlesCollision3DGizmoPlugin::_setv(StringName const&, Variant const&) */undefined8 GPUParticlesCollision3DGizmoPlugin::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* GPUParticlesCollision3DGizmoPlugin::_validate_propertyv(PropertyInfo&) const */void GPUParticlesCollision3DGizmoPlugin::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* GPUParticlesCollision3DGizmoPlugin::_property_can_revertv(StringName const&) const */undefined8 GPUParticlesCollision3DGizmoPlugin::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* GPUParticlesCollision3DGizmoPlugin::_property_get_revertv(StringName const&, Variant&) const */undefined8 GPUParticlesCollision3DGizmoPlugin::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* GPUParticlesCollision3DGizmoPlugin::_notificationv(int, bool) */void GPUParticlesCollision3DGizmoPlugin::_notificationv(int param_1, bool param_2) {
   return;
}
/* Gizmo3DHelper::is_class_ptr(void*) const */uint Gizmo3DHelper::is_class_ptr(Gizmo3DHelper *this, void *param_1) {
   return (uint)CONCAT71(0x106e, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x106e, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x106e, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
...
/* GPUParticlesCollision3DGizmoPlugin::_get_class_namev() const */undefined8 *GPUParticlesCollision3DGizmoPlugin::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      ...
      if (*(long*)( _get_class_namev() ) != 0) {
         ...
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "GPUParticlesCollision3DGizmoPlugin");
         goto LAB_001038fe;
      }
...
/* RefCounted::_get_class_namev() const */undefined8 *RefCounted::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001039e3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001039e3;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "RefCounted");
   LAB_00103a4e:return &_get_class_namev();
}
/* Gizmo3DHelper::_get_class_namev() const */undefined8 *Gizmo3DHelper::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00103ad3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00103ad3;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "Gizmo3DHelper");
   LAB_00103b3e:return &_get_class_namev();
}
...
/* GPUParticlesCollision3DGizmoPlugin::get_class() const */void GPUParticlesCollision3DGizmoPlugin::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* RefCounted::is_class(String const&) const */undefined8 RefCounted::is_class(RefCounted *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_0010400f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
 ...
 while ( !bVar9 );
         ...
         LAB_00104173:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
      ...
      LAB_001040c3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* Gizmo3DHelper::is_class(String const&) const */undefined8 Gizmo3DHelper::is_class(Gizmo3DHelper *this, String *param_1) {
 ...
 while ( !bVar8 );
      ...
      LAB_0010429f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_00104353:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* Resource::is_class(String const&) const */undefined8 Resource::is_class(Resource *this, String *param_1) {
 ...
 while ( !bVar8 );
      ...
      LAB_0010449f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
...
/* GPUParticlesCollision3DGizmoPlugin::is_class(String const&) const */undefined8 GPUParticlesCollision3DGizmoPlugin::is_class(GPUParticlesCollision3DGizmoPlugin *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
 ...
 while ( !bVar9 );
      ...
      LAB_0010463f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
         ...
         LAB_001047b3:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_001046f3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010485c:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* PropertyListHelper::~PropertyListHelper() */void PropertyListHelper::~PropertyListHelper(PropertyListHelper *this) {
 ...
 while ( lVar4 != (ulong)uVar2 << 2 );
   ...
   LAB_00104ae4:CowData<char32_t>::_unref((CowData<char32_t>*)this);
   return;
}
...
/* GPUParticlesCollision3DGizmoPlugin::_initialize_classv() */void GPUParticlesCollision3DGizmoPlugin::_initialize_classv(void) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   long local_70;
...
/* Resource::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Resource::_get_property_listv(Resource *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00105901:local_b0 = (CowData<char32_t>*)&local_58;
...
/* Gizmo3DHelper::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Gizmo3DHelper::_get_property_listv(Gizmo3DHelper *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00105bb1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* GPUParticlesCollision3DGizmoPlugin::_get_property_listv(List<PropertyInfo, DefaultAllocator>*,
   bool) const */void GPUParticlesCollision3DGizmoPlugin::_get_property_listv(GPUParticlesCollision3DGizmoPlugin *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00106241:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Vector3>::resize<false>(long) */undefined8 CowData<Vector3>::resize<false>(CowData<Vector3> *this, long param_1) {
   ...
   if (param_1 * 0xc == 0) {
      LAB_00106700:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (lVar7 == lVar3) {
      LAB_0010666c:puVar9 = *(undefined8**)this;
   ...
   LAB_001065fb:puVar9[-1] = param_1;
   return 0;
}
/* GPUParticlesCollision3DGizmoPlugin::GPUParticlesCollision3DGizmoPlugin() */void GPUParticlesCollision3DGizmoPlugin::_GLOBAL__sub_I_GPUParticlesCollision3DGizmoPlugin(void) {

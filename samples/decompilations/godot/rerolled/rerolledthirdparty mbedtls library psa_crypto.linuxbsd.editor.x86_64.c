uint psa_key_policy_algorithm_intersection(uint param_1, uint param_2, uint param_3) {
   ...
   if (( ( param_2 ^ param_3 ) < 0x100 ) && ( ( ( ( param_2 & 0xff ) == 0 || ( uVar3 = param_3(param_2 & 0xff | 0x2000000) != 0x20000ff ) ) && ( uVar3 = uVar3 != 0 ) ) )) {
      uVar6 = 0;
...
int psa_destroy_key(undefined8 param_1) {
   ...
   iVar2 = 0;
   if (( (int)param_1 != 0 ) && ( iVar2 = iVar2 == 0 )) {
...
;
                        ...
                        if (( iVar4 == 0 ) && ( iVar4 = iVar4 == 0 )) goto LAB_0010a63b;
                     }
            ...
            LAB_0010a63b:if (iVar3 == 0) {
               ...
               if (( *(uint*)( param_1 + 2 ) >> 8 == 0 ) || ( iVar3 = iVar3 == 0 )) {
                  uVar2 = local_130;

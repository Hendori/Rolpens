/* CallableCustom::rpc(int, Variant const**, int, Callable::CallError&) const */undefined8 CallableCustom::rpc(int param_1, Variant **param_2, int param_3, CallError *param_4) {
   undefined4 *in_R8;
   *in_R8 = 1;
   *(undefined8*)( in_R8 + 1 ) = 0;
   return 3;
}
/* CallableCustom::get_base_comparator() const */undefined8 CallableCustom::get_base_comparator(void) {
   return 0;
}
/* CallableCustom::get_argument_count(bool&) const */undefined8 CallableCustom::get_argument_count(CallableCustom *this, bool *param_1) {
   *param_1 = false;
   return 0;
}
/* CallableCustom::get_unbound_arguments_count() const */undefined8 CallableCustom::get_unbound_arguments_count(void) {
   return 0;
}
/* CallableCustom::is_valid() const */undefined8 CallableCustom::is_valid(CallableCustom *this) {
   long lVar1;
   ulong uVar2;
   undefined8 uVar3;
   uint uVar4;
...
/* Callable::call_deferredp(Variant const**, int) const */void Callable::call_deferredp(Callable *this, Variant **param_1, int param_2) {
   long lVar1;
   Callable *pCVar2;
   long in_FS_OFFSET;
...
/* Callable::rpcp(int, Variant const**, int, Callable::CallError&) const */ulong Callable::rpcp(Callable *this, int param_1, Variant **param_2, int param_3, CallError *param_4) {
   long *plVar1;
   long *plVar2;
   long lVar3;
   uint uVar4;
...
;
                  ...
                  *(undefined8*)( puVar10 + lVar3 + -8 ) = 0x1005cd;
                  local_e0 = pVVar15;
                  local_c0 = pcVar16;
                  iVar6 = __cxa_guard_acquire(&const::{lambda()
                  #1
                  pVVar15 = local_e0;
                  pcVar16 = local_c0;
                  uVar13 = (int)local_c8;
               ...
               *(undefined8*)( puVar10 + lVar3 + -8 ) = 0x10044a;
               ( *pcVar16 )((Variant*)local_98, plVar2, &const::{lambda()#1}::operator()()::sname, puVar17, uVar13, pVVar15);
   ...
   else{_err_print_error("get_instance", "./core/object/object.h", 0x418, "Condition \"slot >= slot_max\" is true. Returning: nullptr", 0, 0);} * (undefined4*)param_4 = 5;
   uVar7 = 3;
   *(undefined8*)( param_4 + 4 ) = 0;
   puVar12 = auStack_e8;
}
LAB_001004eb:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return uVar7;
}
/* WARNING: Subroutine does not return */*(undefined**)( puVar12 + -8 ) = &UNK_00100694;__stack_chk_fail();}/* Callable::get_object() const */ulong Callable::get_object(Callable *this) {
   long *plVar1;
   long lVar2;
   ulong uVar3;
   uint uVar4;
...
;
      ...
      if ((uint)ObjectDB::slot_max <= uVar4) {
         LAB_00100807:_err_print_error("get_instance", "./core/object/object.h", 0x418, "Condition \"slot >= slot_max\" is true. Returning: nullptr", 0, 0);
         uVar3 = 0;
         goto LAB_0010072e;
      }
...
;
      ...
      if (( (ulong)plVar1 >> 0x18 & 0x7fffffffff ) == ( *puVar5 & 0x7fffffffff )) {
         LAB_00100723:uVar3 = puVar5[1];
         ObjectDB::spin_lock._0_1_ = '\0';
         goto LAB_0010072e;
      }

      LAB_001007da:ObjectDB::spin_lock._0_1_ = '\0';
   }

   uVar3 = 0;
   LAB_0010072e:if (lVar2 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* Callable::get_object_id() const */void Callable::get_object_id(void) {
   long *plVar1;
   undefined8 in_RSI;
   long *in_RDI;
...
/* Callable::get_bound_arguments_count() const */undefined8 Callable::get_bound_arguments_count(Callable *this) {
   code *UNRECOVERED_JUMPTABLE;
   undefined8 uVar1;
   if (( ( *(long*)this == 0 ) && ( *(long**)( this + 8 ) != (long*)0x0 ) ) && ( UNRECOVERED_JUMPTABLE = *(code**)( **(long**)( this + 8 ) + 0x58 ) ),UNRECOVERED_JUMPTABLE != CallableCustom::get_unbound_arguments_count) {
...
/* Callable::get_unbound_arguments_count() const */undefined8 Callable::get_unbound_arguments_count(Callable *this) {
   code *UNRECOVERED_JUMPTABLE;
   undefined8 uVar1;
   if (( ( *(long*)this == 0 ) && ( *(long**)( this + 8 ) != (long*)0x0 ) ) && ( UNRECOVERED_JUMPTABLE = *(code**)( **(long**)( this + 8 ) + 0x68 ) ),UNRECOVERED_JUMPTABLE != CallableCustom::get_unbound_arguments_count) {
...
/* Callable::get_base_comparator() const */Callable * __thiscall Callable::get_base_comparator(Callable *this){
   code *pcVar1;
   Callable *pCVar2;
   if (( ( *(long*)this == 0 ) && ( *(long**)( this + 8 ) != (long*)0x0 ) ) && ( pcVar1 = *(code**)( **(long**)( this + 8 ) + 0x48 ) ),pcVar1 != CallableCustom::get_base_comparator) {
...
/* Callable::hash() const */ulong Callable::hash(Callable *this) {
   uint uVar1;
   ulong uVar2;
   int iVar3;
   int iVar4;
   ...
   uVar1 = ( uVar1 << 0xd | uVar1 >> 0x13 ) * 5 + 0xe6546b64 ^ ( iVar4 * 0x16a88000 | ( uint )(iVar4 * -0x3361d2af) >> 0x11 ) * 0x1b873593;
...
/* Callable::TEMPNAMEPLACEHOLDERVALUE(Callable const&) const */ulong Callable::operator ==(Callable *this, Callable *param_1) {
   long lVar1;
   long lVar2;
   long *plVar3;
   code *UNRECOVERED_JUMPTABLE;
   ...
   if (( *(long*)this == 0 ) && ( plVar3 = *(long**)( this + 8 ) ),plVar3 != (long*)0x0) {
      ...
      if (( lVar1 != 0 ) || ( lVar2 == 0 )) {
         return ( ulong )((uint)CONCAT71(( int7 )((ulong)lVar2 >> 8), lVar2 == *(long*)( this + 8 )) & (uint)CONCAT71(( int7 )((ulong)lVar1 >> 8), *(long*)this == lVar1));
      }
...
/* Callable::TEMPNAMEPLACEHOLDERVALUE(Callable const&) const */uint Callable::operator !=(Callable *this, Callable *param_1) {
   uint uVar1;
...
/* Callable::TEMPNAMEPLACEHOLDERVALUE(Callable const&) const */ulong Callable::operator <(Callable *this, Callable *param_1) {
   ...
   if (( *(ulong*)this == 0 ) && ( plVar1 = *(long**)( this + 8 ) ),plVar1 != (long*)0x0) {
      uVar4 = 0;
      if (( uVar3 == 0 ) && ( ( *(long**)( param_1 + 8 ) != (long*)0x0 && ( plVar1 != *(long**)( param_1 + 8 ) ) ) )) {
...
/* Callable::TEMPNAMEPLACEHOLDERVALUE(Callable const&) */void Callable::operator =(Callable *this, Callable *param_1) {
   int *piVar1;
   long *plVar2;
   int iVar3;
   long lVar4;
   ...
   if (*(long*)this == 0) {
      ...
      if (lVar4 != 0) {
         *(undefined8*)( this + 8 ) = 0;
         LAB_00100b8a:StringName::operator =((StringName*)this, (StringName*)param_1);
      ...
      *(undefined8*)( this + 8 ) = 0;
      ...
      if (( lVar4 != 0 ) || ( *(long*)( param_1 + 8 ) == 0 )) {
         LAB_00100b50:StringName::operator =((StringName*)this, (StringName*)param_1);
         *(undefined8*)( this + 8 ) = *(undefined8*)( param_1 + 8 );
         return;
      }
 ...
 while ( !bVar7 );
   ...
   LAB_00100c0c:if (plVar6 == (long*)0x0) {
      return;
   }
...
/* Callable::create(Variant const&, StringName const&) */Callable * __thiscall Callable::create(Callable *this,Variant *param_1,StringName *param_2){
   VariantCallable VVar1;
   long lVar2;
   undefined8 uVar3;
   VariantCallable *this_00;
   if (*(long*)param_2 == 0) {
      _err_print_error("create", "core/variant/callable.cpp", 0x17b, "Condition \"p_method == StringName()\" is true. Returning: Callable()", "Method argument to Callable::create method must be a non-empty string.", 0, 0);
      *(undefined8*)this = 0;
      *(undefined8*)( this + 8 ) = 0;
      return this;
   }
   ...
   if (*(int*)param_1 == 0) {
      ...
      if (*(int*)param_1 != 0x18) {
         ...
         *(undefined8*)( this + 8 ) = 0;
         if (VVar1 != (VariantCallable)0x0) {
            _err_print_error("Callable", "core/variant/callable.cpp", 0x1a2, "Method/function failed.", "Callable custom is already referenced.", 0, 0);
            return this;
         }
      ...
      *(undefined8*)( this + 8 ) = 0;
      if (lVar2 == 0) {
         LAB_00100d41:_err_print_error("Callable", "core/variant/callable.cpp", 0x198, "Method/function failed.", "Method argument to Callable constructor must be a non-empty string.", 0, 0);
         return this;
      }
...
/* Callable::Callable(Object const*, StringName const&) */undefined8 Callable::Callable(Callable *this, Object *param_1, StringName *param_2) {
   long lVar1;
   undefined8 uVar2;
   *(undefined8*)this = 0;
   lVar1 = *(long*)param_2;
   *(undefined8*)( this + 8 ) = 0;
   if (lVar1 == 0) {
      uVar2 = _err_print_error("Callable", "core/variant/callable.cpp", 0x18a, "Method/function failed.", "Method argument to Callable constructor must be a non-empty string.", 0, 0);
   }
 else {
      ...
      uVar2 = 0;
      _err_print_error("Callable", "core/variant/callable.cpp", 0x18e, "Method/function failed.", "Object argument to Callable constructor must be non-null.", 0);
   }

   return uVar2;
}
/* Callable::Callable(ObjectID, StringName const&) */void Callable::Callable(Callable *this, undefined8 param_2, StringName *param_3) {
   long lVar1;
   *(undefined8*)this = 0;
   lVar1 = *(long*)param_3;
   *(undefined8*)( this + 8 ) = 0;
   ...
   _err_print_error("Callable", "core/variant/callable.cpp", 0x198, "Method/function failed.", "Method argument to Callable constructor must be a non-empty string.", 0, 0);
   return;
}
/* Callable::Callable(CallableCustom*) */void Callable::Callable(Callable *this, CallableCustom *param_1) {
...
/* Callable::Callable(Callable const&) */void Callable::Callable(Callable *this, Callable *param_1) {
   int *piVar1;
   int iVar2;
   long lVar3;
   int iVar4;
 ...
 while ( !bVar5 );
   ...
   LAB_00101010:*(undefined8*)( this + 8 ) = 0;
   return;
}
/* Callable::unbind(int) const */Callable *Callable::unbind(int param_1) {
   ...
   _err_print_error("unbind", "core/variant/callable.cpp", 0x94, "Condition \"p_argcount <= 0\" is true. Returning: Callable(*this)", "Amount of unbind() arguments must be 1 or greater.", 0, 0);
   Callable(this_00, in_RSI);
   return this_00;
}
/* Callable::~Callable() */void Callable::~Callable(Callable *this) {
   int *piVar1;
   long *plVar2;
   if (*(long*)this == 0) {
      if (*(long*)( this + 8 ) != 0) {
      ...
      LAB_0010113c:StringName::unref();
      return;
   }

   return;
}
/* CallableCustom::CallableCustom() */void CallableCustom::CallableCustom(CallableCustom *this) {
...
/* Signal::get_object() const */ulong Signal::get_object(Signal *this) {
   long lVar1;
   ulong uVar2;
   uint uVar3;
   ulong *puVar4;
...
/* Signal::get_object_id() const */undefined8 Signal::get_object_id(Signal *this) {
   return *(undefined8*)( this + 8 );
}
/* Signal::get_name() const */void Signal::get_name(void) {
   StringName *in_RSI;
   StringName *in_RDI;
   StringName::StringName(in_RDI, in_RSI);
   return;
}
/* Signal::TEMPNAMEPLACEHOLDERVALUE(Signal const&) const */undefined8 Signal::operator ==(Signal *this, Signal *param_1) {
...
/* Signal::TEMPNAMEPLACEHOLDERVALUE(Signal const&) const */bool Signal::operator <(Signal *this, Signal *param_1) {
   bool bVar1;
...
/* Signal::emit(Variant const**, int) const */undefined8 Signal::emit(Signal *this, Variant **param_1, int param_2) {
   long lVar1;
   long *plVar2;
   undefined8 uVar3;
   uint uVar4;
...
;
   ...
   LAB_001014a2:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* Signal::connect(Callable const&, unsigned int) */undefined8 Signal::connect(Signal *this, Callable *param_1, uint param_2) {
   long *plVar1;
   undefined8 uVar2;
...
/* Signal::disconnect(Callable const&) */void Signal::disconnect(Signal *this, Callable *param_1) {
   long *plVar1;
   plVar1 = (long*)get_object(this);
   if (plVar1 != (long*)0x0) {
...
/* Signal::is_connected(Callable const&) const */undefined8 Signal::is_connected(Signal *this, Callable *param_1) {
   long *plVar1;
   undefined8 uVar2;
   plVar1 = (long*)get_object(this);
   if (plVar1 != (long*)0x0) {
...
/* Signal::has_connections() const */undefined8 Signal::has_connections(Signal *this) {
   long *plVar1;
   undefined8 uVar2;
   plVar1 = (long*)get_object(this);
   if (plVar1 != (long*)0x0) {
   ...
   _err_print_error("has_connections", "core/variant/callable.cpp", 0x234, "Parameter \"obj\" is null.", 0, 0);
   return 0;
}
/* Signal::Signal(Object const*, StringName const&) */void Signal::Signal(Signal *this, Object *param_1, StringName *param_2) {
   *(undefined8*)this = 0;
   *(undefined8*)( this + 8 ) = 0;
   if (param_1 != (Object*)0x0) {
      *(undefined8*)( this + 8 ) = *(undefined8*)( param_1 + 0x60 );
   ...
   _err_print_error("Signal", "core/variant/callable.cpp", 0x24a, "Parameter \"p_object\" is null.", "Object argument to Signal constructor must be non-null.", 0, 0);
   return;
}
/* Signal::Signal(ObjectID, StringName const&) */void Signal::Signal(Signal *this, undefined8 param_2, StringName *param_3) {
   *(undefined8*)this = 0;
   *(undefined8*)( this + 8 ) = param_2;
   StringName::operator =((StringName*)this, param_3);
   return;
}
/* Callable::operator String() const */Callable * __thiscall Callable::operator_cast_to_String(Callable *this){
   char *pcVar1;
   char cVar2;
   long *plVar3;
   long lVar4;
   ...
   if (lVar4 == 0) {
      LAB_00101af0:cVar2 = Variant::needs_deinit[local_58[0]];
      joined_r0x00101e68:if (cVar2 != '\0') {
         Variant::_clear_internal();
      }
...
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* Signal::operator String() const */Signal * __thiscall Signal::operator_cast_to_String(Signal *this){
   char *pcVar1;
   char cVar2;
   long *plVar3;
   long lVar4;
   ...
   lVar4 = Variant::get_validated_object();
   if (lVar4 == 0) {
      LAB_001022c8:cVar2 = Variant::needs_deinit[local_58[0]];
      joined_r0x001023f0:if (cVar2 != '\0') {
         Variant::_clear_internal();
      }
      ...
      LAB_00102164:pcVar1 = *(char**)( lVar4 + 8 );
      local_70 = 0;
      if (pcVar1 == (char*)0x0) {
         CowData<char32_t>::_ref((CowData<char32_t>*)&local_70, (CowData*)( lVar4 + 0x10 ));
      }
...
LAB_0010229e:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return this;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* CallableCustom::get_method() const */void CallableCustom::get_method(void) {
   long *plVar1;
   char *pcVar2;
   long lVar3;
   long *in_RSI;
   ...
   _err_print_error("get_method", "core/variant/callable.cpp", 0x1c6, "Method/function failed. Returning: StringName()", &local_48, 0);
   pcVar2 = local_48;
...
/* Callable::get_custom() const */long Callable::get_custom(Callable *this) {
   long *plVar1;
   char *pcVar2;
   long lVar3;
   long in_FS_OFFSET;
   ...
   if (( *(long*)this != 0 ) || ( lVar3 = lVar3 == 0 )) {
      ...
      _err_print_error("get_custom", "core/variant/callable.cpp", 0xed, "Condition \"!is_custom()\" is true. Returning: nullptr", &local_38, 0, 0);
      pcVar2 = local_38;
   ...
   LAB_0010274d:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return lVar3;
   }
...
/* Callable::get_method() const */void Callable::get_method(void) {
   long lVar1;
   long *plVar2;
   StringName *in_RSI;
   StringName *in_RDI;
...
/* Callable::is_valid() const */ulong Callable::is_valid(Callable *this) {
   long lVar1;
   long lVar2;
   StringName *pSVar3;
   ulong uVar4;
...
/* Callable::callp(Variant const**, int, Variant&, Callable::CallError&) const */void Callable::callp(Callable *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   int iVar1;
   ulong uVar2;
   long *plVar3;
   char cVar4;
         ...
         *(undefined8*)( param_3 + 0x10 ) = local_40._8_8_;
         ...
         if (cVar4 != '\0') {
            if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
               ...
               /* WARNING: Treating indirect jump as call */
               ( **(code**)( **(long**)( this + 8 ) + 0x38 ) )(*(long**)( this + 8 ), param_1, param_2, param_3, param_4);
               return;
            }
...
;
   ...
   LAB_00102a0c:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

   LAB_00102bbc:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* Callable::callv(Array const&) const */Array *Callable::callv(Array *param_1) {
   long lVar1;
   Variant *pVVar2;
   int in_EDX;
   ulong uVar3;
...
/* CallableComparator::TEMPNAMEPLACEHOLDERVALUE(Variant const&, Variant const&) const */bool CallableComparator::operator ()(CallableComparator *this, Variant *param_1, Variant *param_2) {
   long *plVar1;
   long lVar2;
   bool bVar3;
   long in_FS_OFFSET;
   ...
   if (local_68[0] == 0) {
      ...
      Variant::get_callable_error_text((Callable*)&local_78, *(Variant***)this, (int)&local_58, (CallError*)0x2);
      operator+((char *)&
      local_70,"Error calling compare method: ";
      _err_print_error("operator()", "core/variant/callable.cpp", 0x25a, "Condition \"err.error != Callable::CallError::CALL_OK\" is true. Returning: false", &local_70, 0, 0);
      lVar2 = local_70;
      if (local_70 != 0) {
         LOCK();
   ...
   LAB_00102d85:if (Variant::needs_deinit[local_48[0]] != '\0') {
      Variant::_clear_internal();
   }
...
/* Callable::get_argument_count(bool*) const */undefined8 Callable::get_argument_count(Callable *this, bool *param_1) {
   long *plVar1;
   char cVar2;
   StringName *pSVar3;
   undefined8 uVar4;
   ...
   LAB_00102f82:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* Signal::get_connections() const */void Signal::get_connections(void) {
   long *plVar1;
   long lVar2;
   Signal *in_RSI;
   Array *in_RDI;
   ...
   if (plVar1 == (long*)0x0) {
      ...
      if (( local_68 != (long*)0x0 ) && ( lVar2 = lVar2 != 0 )) {
         do {
 ...
 while ( lVar2 != 0 );
      ...
      Array::~Array(local_60);
      List<Object::Connection,DefaultAllocator>::~List((List<Object::Connection,DefaultAllocator>*)&local_68);
   }
...
/* CallableCustom::get_bound_arguments(Vector<Variant>&) const */void CallableCustom::get_bound_arguments(CallableCustom *this, Vector *param_1) {
...
/* Callable::get_bound_arguments_ref(Vector<Variant>&) const */void Callable::get_bound_arguments_ref(Callable *this, Vector *param_1) {
   code *UNRECOVERED_JUMPTABLE;
   if (( ( *(long*)this == 0 ) && ( *(long**)( this + 8 ) != (long*)0x0 ) ) && ( UNRECOVERED_JUMPTABLE = *(code**)( **(long**)( this + 8 ) + 0x60 ) ),UNRECOVERED_JUMPTABLE != CallableCustom::get_bound_arguments) {
...
/* Callable::get_bound_arguments() const */void Callable::get_bound_arguments(void) {
   Variant *pVVar1;
   Variant *this;
   long lVar2;
   Callable *in_RSI;
...
;
         ...
         if (lVar11 == lVar9) {
            LAB_0010353b:puVar5 = *(undefined8**)this;
            if (puVar5 == (undefined8*)0x0) {
               /* WARNING: Does not return */
               pcVar1 = (code*)invalidInstructionException();
               ( *pcVar1 )();
 ...
 while ( param_1 != lVar9 );
   ...
   LAB_001035c2:_err_print_error("resize", "./core/templates/cowdata.h", uVar8, pcVar6, 0, 0);
   return;
}
/* Callable::bindv(Array const&) */Array *Callable::bindv(Array *param_1) {
   ...
   if (cVar3 == '\0') {
      ...
      while (true) {
         ...
         if (local_50[0] == 0) {
            lVar7 = 0;
            LAB_001036fa:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar6, lVar7, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar2 = (code*)invalidInstructionException();
            ( *pcVar2 )();
...
/* Callable::bindp(Variant const**, int) const */Variant **Callable::bindp(Variant **param_1, int param_2) {
   CallableCustomBind CVar1;
   Variant *pVVar2;
   code *pcVar3;
   CallableCustomBind *this;
   ...
   if (0 < in_ECX) {
      ...
      do {
         ...
         if (local_50[0] == 0) {
            lVar4 = 0;
            LAB_00103871:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar5, lVar4, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
 ...
 while ( lVar4 != in_ECX );
   ...
   this(CallableCustomBind * operator_new(0x30, ""));
   CallableCustomBind::CallableCustomBind(this, (Callable*)CONCAT44(in_register_00000034, param_2), local_58);
   CVar1 = this[0xc];
   *param_1 = (Variant*)0x0;
...
/* WARNING: Removing unreachable block (ram,0x00104218) *//* WARNING: Removing unreachable block (ram,0x00104348) *//* WARNING: Removing unreachable block (ram,0x00104510) *//* WARNING: Removing unreachable block (ram,0x00104354) *//* WARNING: Removing unreachable block (ram,0x0010435e) *//* WARNING: Removing unreachable block (ram,0x001044f0) *//* WARNING: Removing unreachable block (ram,0x0010436a) *//* WARNING: Removing unreachable block (ram,0x00104374) *//* WARNING: Removing unreachable block (ram,0x001044d0) *//* WARNING: Removing unreachable block (ram,0x00104380) *//* WARNING: Removing unreachable block (ram,0x0010438a) *//* WARNING: Removing unreachable block (ram,0x001044b0) *//* WARNING: Removing unreachable block (ram,0x00104396) *//* WARNING: Removing unreachable block (ram,0x001043a0) *//* WARNING: Removing unreachable block (ram,0x00104490) *//* WARNING: Removing unreachable block (ram,0x001043ac) *//* WARNING: Removing unreachable block (ram,0x001043b6) *//* WARNING: Removing unreachable block (ram,0x00104470) *//* WARNING: Removing unreachable block (ram,0x001043c2) *//* WARNING: Removing unreachable block (ram,0x001043cc) *//* WARNING: Removing unreachable block (ram,0x00104450) *//* WARNING: Removing unreachable block (ram,0x001043d4) *//* WARNING: Removing unreachable block (ram,0x001043ea) *//* WARNING: Removing unreachable block (ram,0x001043f6) *//* String vformat<String>(String const&, String const) */undefined8 *vformat<String>(undefined8 *param_1, bool *param_2, String *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* List<Object::Connection, DefaultAllocator>::~List() */void List<Object::Connection,DefaultAllocator>::~List(List<Object::Connection,DefaultAllocator> *this) {
   long *plVar1;
   long lVar2;
   long lVar3;
   long *plVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void FUN_0010478a(void) {
   code *pcVar1;
   _DAT_00000000 = 0;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
...
/* WARNING: Control flow encountered bad instruction data *//* List<Object::Connection, DefaultAllocator>::~List() */void List<Object::Connection,DefaultAllocator>::~List(List<Object::Connection,DefaultAllocator> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

...
/* WARNING: Removing unreachable block (ram,0x00107c98) *//* String vformat<StringName>(String const&, StringName const) */undefined8 *vformat<StringName>(undefined8 *param_1, bool *param_2, StringName *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* MethodBindT<Ref<Shape3D> const&>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<Ref<Shape3D>const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   long lVar1;
   Object *pOVar2;
   char cVar3;
   Object *pOVar4;
...
/* MethodBindT<Ref<Shape3D> const&>::ptrcall(Object*, void const**, void*) const */void MethodBindT<Ref<Shape3D>const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   long lVar1;
   Object *pOVar2;
   char cVar3;
   long *plVar4;
...
/* MethodBindT<Ref<Resource> >::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<Ref<Resource>>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   long lVar1;
   Object *pOVar2;
   char cVar3;
   Object *pOVar4;
...
/* MethodBindT<Ref<Resource> >::ptrcall(Object*, void const**, void*) const */void MethodBindT<Ref<Resource>>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   long lVar1;
   Object *pOVar2;
   char cVar3;
   long *plVar4;
...
LAB_0010af18:*(undefined4*)param_1 = 0;*(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return param_1;}/* MethodBindT<Ref<Resource> >::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<Ref<Resource>>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   long lVar2;
   code *pcVar3;
   undefined8 uVar4;
...
/* WARNING: Control flow encountered bad instruction data *//* MethodBindT<Ref<Shape3D> const&>::~MethodBindT() */void MethodBindT<Ref<Shape3D>const&>::~MethodBindT(MethodBindT<Ref<Shape3D>const&> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* MethodBindT<Ref<Resource> >::~MethodBindT() */void MethodBindT<Ref<Resource>>::~MethodBindT(MethodBindT<Ref<Resource>> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<CollisionShape3D, void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<CollisionShape3D,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<CollisionShape3D,void> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

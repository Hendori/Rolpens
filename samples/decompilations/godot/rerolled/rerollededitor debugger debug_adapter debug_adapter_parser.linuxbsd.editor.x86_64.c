/* Ref<DAPeer>::TEMPNAMEPLACEHOLDERVALUE(Ref<DAPeer> const&) [clone .isra.0] */void Ref<DAPeer>::operator =(Ref<DAPeer> *this, Ref *param_1) {
   Object *pOVar1;
   char cVar2;
   pOVar1 = *(Object**)this;
...
/* DebugAdapterParser::prepare_base_event() const */DebugAdapterParser * __thiscall DebugAdapterParser::prepare_base_event(DebugAdapterParser *this){
   char cVar1;
   Variant *pVVar2;
   long in_FS_OFFSET;
   int local_68[8];
...
/* DebugAdapterParser::prepare_success_response(Dictionary const&) const */Dictionary *DebugAdapterParser::prepare_success_response(Dictionary *param_1) {
   char cVar1;
   Variant *pVVar2;
   Variant *pVVar3;
   Variant *in_RDX;
...
/* DebugAdapterParser::req_terminate(Dictionary const&) const */Dictionary *DebugAdapterParser::req_terminate(Dictionary *param_1) {
   long lVar1;
   long in_FS_OFFSET;
...
/* DebugAdapterParser::req_pause(Dictionary const&) const */Dictionary *DebugAdapterParser::req_pause(Dictionary *param_1) {
   long lVar1;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
...
/* DebugAdapterParser::req_continue(Dictionary const&) const */Dictionary *DebugAdapterParser::req_continue(Dictionary *param_1) {
   long lVar1;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   BaseButton::set_pressed(SUB81(*(undefined8*)( EditorRunBar::singleton + 0xa58 ), 0));
...
/* DebugAdapterParser::req_breakpointLocations(Dictionary const&) const */Dictionary *DebugAdapterParser::req_breakpointLocations(Dictionary *param_1) {
   char cVar1;
   int iVar2;
   Variant *pVVar3;
   Variant *in_RDX;
...
/* DebugAdapterParser::req_next(Dictionary const&) const */Dictionary *DebugAdapterParser::req_next(Dictionary *param_1) {
   long lVar1;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
...
/* DebugAdapterParser::req_stepIn(Dictionary const&) const */Dictionary *DebugAdapterParser::req_stepIn(Dictionary *param_1) {
   long lVar1;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   EditorDebuggerNode::get_default_debugger();
...
/* DebugAdapterParser::req_disconnect(Dictionary const&) const */Dictionary *DebugAdapterParser::req_disconnect(Dictionary *param_1) {
   Object OVar1;
   long lVar2;
   code *pcVar3;
   char cVar4;
...
/* DebugAdapterParser::ev_initialized() const */DebugAdapterParser * __thiscall DebugAdapterParser::ev_initialized(DebugAdapterParser *this){
   char cVar1;
   Variant *pVVar2;
   long in_FS_OFFSET;
   int local_68[8];
...
/* DebugAdapterParser::ev_terminated() const */DebugAdapterParser * __thiscall DebugAdapterParser::ev_terminated(DebugAdapterParser *this){
   char cVar1;
   Variant *pVVar2;
   long in_FS_OFFSET;
   int local_68[8];
...
/* DebugAdapterParser::ev_exited(int const&) const */int *DebugAdapterParser::ev_exited(int *param_1) {
   char cVar1;
   Variant *pVVar2;
   int *in_RDX;
   long in_FS_OFFSET;
...
/* DebugAdapterParser::ev_stopped() const */DebugAdapterParser * __thiscall DebugAdapterParser::ev_stopped(DebugAdapterParser *this){
   char cVar1;
   Variant *pVVar2;
   long in_FS_OFFSET;
   Dictionary local_80[8];
...
/* DebugAdapterParser::ev_stopped_paused() const */DebugAdapterParser * __thiscall DebugAdapterParser::ev_stopped_paused(DebugAdapterParser *this){
   char cVar1;
   Variant *pVVar2;
   long in_FS_OFFSET;
   Variant local_80[8];
...
/* DebugAdapterParser::ev_stopped_exception(String const&) const */String *DebugAdapterParser::ev_stopped_exception(String *param_1) {
   char cVar1;
   Variant *pVVar2;
   String *in_RDX;
   long in_FS_OFFSET;
...
/* DebugAdapterParser::ev_stopped_breakpoint(int const&) const */int *DebugAdapterParser::ev_stopped_breakpoint(int *param_1) {
   char cVar1;
   Variant *pVVar2;
   int *in_RDX;
   long in_FS_OFFSET;
...
/* DebugAdapterParser::ev_stopped_step() const */DebugAdapterParser * __thiscall DebugAdapterParser::ev_stopped_step(DebugAdapterParser *this){
   char cVar1;
   Variant *pVVar2;
   long in_FS_OFFSET;
   Variant local_80[8];
...
/* DebugAdapterParser::ev_continued() const */DebugAdapterParser * __thiscall DebugAdapterParser::ev_continued(DebugAdapterParser *this){
   char cVar1;
   Variant *pVVar2;
   long in_FS_OFFSET;
   Dictionary local_80[8];
...
/* DebugAdapterParser::ev_breakpoint(DAP::Breakpoint const&, bool const&) const */Breakpoint *DebugAdapterParser::ev_breakpoint(Breakpoint *param_1, bool *param_2) {
   char cVar1;
   Variant *pVVar2;
   char *in_RCX;
   int *in_RDX;
...
/* DebugAdapterParser::ev_custom_data(String const&, Array const&) const */String *DebugAdapterParser::ev_custom_data(String *param_1, Array *param_2) {
   char cVar1;
   Variant *pVVar2;
   Array *in_RCX;
   String *in_RDX;
...
/* DebugAdapterParser::prepare_error_response(Dictionary const&, DAP::ErrorType, Dictionary const&)
   const */Dictionary *DebugAdapterParser::prepare_error_response(Dictionary *param_1, undefined8 param_2, Variant *param_3, int param_4, Dictionary *param_5) {
   char cVar1;
   Variant *pVVar2;
   Variant *pVVar3;
   long in_FS_OFFSET;
...
/* DebugAdapterParser::req_attach(Dictionary const&) const */Dictionary *DebugAdapterParser::req_attach(Dictionary *param_1) {
   char cVar1;
   long lVar2;
   Dictionary *pDVar3;
   Object *pOVar4;
   ...
   Dictionary::~Dictionary(aDStack_38);
   LAB_00103bf9:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* DebugAdapterParser::req_variables(Dictionary const&) const */Dictionary *DebugAdapterParser::req_variables(Dictionary *param_1) {
   Object OVar1;
   long lVar2;
   ulong uVar3;
   ...
   if (*(int*)( DebugAdapterProtocol::singleton + 0x194 ) < 1) {
      ...
      if (( lVar2 != 0 ) && ( *(int*)( DebugAdapterProtocol::singleton + 0x234 ) != 0 )) {
         uVar3 = *(ulong*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( DebugAdapterProtocol::singleton + 0x230 ) * 8 );
         ...
         uVar23 = CONCAT44(0, *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( DebugAdapterProtocol::singleton + 0x230 ) * 4 ));
         auVar4._8_8_ = 0;
         auVar4._0_8_ = uVar23;
         auVar8._8_8_ = 0;
         auVar8._0_8_ = uVar19;
         ...
         if (uVar15 != 0) {
            uVar24 = 0;
            LAB_00103e6a:if (( uVar21 != uVar15 ) || ( uVar14 != *(uint*)( *(long*)( lVar2 + lVar20 * 8 ) + 0x10 ) )) goto LAB_00103e20;
      ...
      LAB_00104088:local_88 = DebugAdapterProtocol::search_object_id((int)DebugAdapterProtocol::singleton);
      if (local_88 == 0) {
         Dictionary::Dictionary((Dictionary*)local_80);
      ...
      LAB_00103ff8:Dictionary::~Dictionary((Dictionary*)local_98);
   }
 else {
      Dictionary::Dictionary(param_1);
   }
   ...
   if (( uVar15 == 0 ) || ( auVar6._8_8_ = 0 ),auVar6._0_8_ = uVar15 * uVar3,auVar10._8_8_ = 0,auVar10._0_8_ = uVar23,auVar7._8_8_ = 0,auVar7._0_8_ = ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( DebugAdapterProtocol::singleton + 0x230 ) * 4 ) + uVar18 ) - SUB164(auVar6 * auVar10, 8) ) * uVar3,auVar11._8_8_ = 0,auVar11._0_8_ = uVar23,SUB164(auVar7 * auVar11, 8) < uVar24) goto LAB_00104088;
   goto LAB_00103e6a;
}
/* DebugAdapterParser::req_threads(Dictionary const&) const */Dictionary *DebugAdapterParser::req_threads(Dictionary *param_1) {
   char cVar1;
   Variant *pVVar2;
   long in_FS_OFFSET;
...
/* DebugAdapterParser::req_godot_put_msg(Dictionary const&) const */Dictionary *DebugAdapterParser::req_godot_put_msg(Dictionary *param_1) {
   String *pSVar1;
   Variant *in_RDX;
   long in_FS_OFFSET;
   Variant local_70[8];
...
/* DebugAdapterParser::ev_process(String const&) const */String *DebugAdapterParser::ev_process(String *param_1) {
   char cVar1;
   Variant *pVVar2;
   long *plVar3;
   String *in_RDX;
...
/* DebugAdapterParser::ev_output(String const&, RemoteDebugger::MessageType) const */DebugAdapterParser *DebugAdapterParser::ev_output(DebugAdapterParser *param_1, undefined8 param_2, String *param_3, int param_4) {
   char cVar1;
   Variant *pVVar2;
   char *pcVar3;
   long in_FS_OFFSET;
...
/* DebugAdapterParser::req_launch(Dictionary const&) const */Dictionary *DebugAdapterParser::req_launch(Dictionary *param_1) {
   Object *pOVar1;
   char cVar2;
   Object OVar3;
   int iVar4;
   ...
   if (cVar2 != '\0') {
      ...
      local_80 = (Object*)0x0;
      Ref<DAPeer>::operator =((Ref<DAPeer>*)&local_80, *(Ref**)( DebugAdapterProtocol::singleton + 0x1b8 ));
      pOVar1 = local_80;
   ...
   if (pOVar1 == (Object*)0x0) {
      LAB_001052b8:Dictionary::operator =((Dictionary*)0x4001b8, (Dictionary*)in_RDX);
   }
 else {
      cVar2 = RefCounted::reference();
   ...
   Dictionary::Dictionary(param_1);
   LAB_00105053:Dictionary::~Dictionary((Dictionary*)local_98);
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* DebugAdapterParser::_launch_process(Dictionary const&) const */Dictionary *DebugAdapterParser::_launch_process(Dictionary *param_1) {
   code *pcVar1;
   bool bVar2;
   char cVar3;
   char cVar4;
      ...
      if (cVar3 == '\0') {
         ...
         if (cVar3 != '\0') {
            for (; iVar5 = EditorExport::get_export_platform_count(),iVar7 < iVar5; iVar7 = iVar7 + 1) {
               ...
               if (( ( local_a8 != (Object*)0x0 ) && ( cVar4 = RefCounted::unreference() ),pOVar8 = local_a8,cVar4 != '\0' )) &&( cVar4 = cVar4 != '\0' )(**(code**)( *(long*)pOVar8 + 0x140 ))();
...
Dictionary::Dictionary((Dictionary*)local_a0);uVar6 = 4;goto LAB_00105940;}EditorRunBar::play_main_scene(SUB81(EditorRunBar::singleton, 0));LAB_00105646:pOVar8 = *(Object**)( DebugAdapterProtocol::singleton + 0x1b8 );if (pOVar8 == (Object*)0x0) {
   DAT_004001b5 = 0;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
cVar3 = RefCounted::reference();if (cVar3 == '\0') {
   pOVar8 = (Object*)0x0;
}
pOVar8[0x4001b5] = (Object)0x0;cVar3 = RefCounted::unreference();if (( cVar3 != '\0' ) && ( cVar3 = cVar3 != '\0' )) {
   ( **(code**)( *(long*)pOVar8 + 0x140 ) )(pOVar8);
   Memory::free_static(pOVar8, false);
}
DebugAdapterProtocol::notify_process();prepare_success_response(param_1);LAB_001056a7:CowData<char32_t>::_unref((CowData<char32_t>*)local_b0);Dictionary::~Dictionary((Dictionary*)local_b8);if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return param_1;LAB_001058e2:uVar6 = EditorRunBar::singleton;cVar3 = String::operator ==((String*)local_b0, "android");if (cVar3 == '\0') {
...
if (iVar7 != 0) {
   ...
   LAB_00105940:prepare_error_response(param_1, in_RSI, in_RDX, uVar6, local_a0);
   Dictionary::~Dictionary((Dictionary*)local_a0);
   goto LAB_001056a7;
}
goto LAB_00105646;}/* DebugAdapterParser::req_restart(Dictionary const&) const */Dictionary *DebugAdapterParser::req_restart(Dictionary *param_1) {
   code *pcVar1;
   char cVar2;
   bool bVar3;
   Variant *pVVar4;
...
/* DebugAdapterParser::req_configurationDone(Dictionary const&) const */Dictionary *DebugAdapterParser::req_configurationDone(Dictionary *param_1) {
   long *plVar1;
   long lVar2;
   char cVar3;
   Dictionary *pDVar4;
   ...
   if (pOVar6 == (Object*)0x0) {
      ...
      LAB_00105fb2:prepare_success_response(param_1);
      goto LAB_00105f76;
   }
   ...
   if (cVar3 == '\0') {
      ...
      pOVar6 = (Object*)0x0;
      LAB_00105eb7:_launch_process(local_48);
   ...
   LAB_00105f76:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* WARNING: Type propagation algorithm not settling *//* DebugAdapterParser::req_initialize(Dictionary const&) const */Dictionary *DebugAdapterParser::req_initialize(Dictionary *param_1) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   undefined2 uVar4;
 ...
 while ( !bVar12 );
            ...
            LAB_001069d8:wVar10 = (wchar32)(CowData<char32_t>*)&local_c8;
            ...
            DebugAdapterProtocol::on_debug_breakpoint_toggled(DebugAdapterProtocol::singleton, (int*)local_c0, (bool*)&local_dc);
            CowData<char32_t>::_unref((CowData<char32_t>*)local_c0);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_c8);
...
/* DebugAdapterParser::req_evaluate(Dictionary const&) const */Dictionary *DebugAdapterParser::req_evaluate(Dictionary *param_1) {
   undefined8 *puVar1;
   undefined8 *puVar2;
   long *plVar3;
   uint *puVar4;
   ...
   if (( *(long*)( DebugAdapterProtocol::singleton + 0x298 ) != 0 ) && ( *(int*)( DebugAdapterProtocol::singleton + 700 ) != 0 )) {
      uVar5 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( DebugAdapterProtocol::singleton + 0x2b8 ) * 4 );
      lVar6 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( DebugAdapterProtocol::singleton + 0x2b8 ) * 8 );
      uVar38 = String::hash();
      ...
      if (uVar38 != 0) {
         do {
            if (uVar40 == uVar38) {
               cVar37 = String::operator ==((String*)( *(long*)( *(long*)( pSVar36 + 0x298 ) + lVar42 * 8 ) + 0x10 ), (String*)local_b0);
               if (cVar37 != '\0') {
                  ...
                  if (lVar6 != 0) {
                     ...
                     pSVar36 = DebugAdapterProtocol::singleton;
                     if (( *(long*)( DebugAdapterProtocol::singleton + 0x298 ) == 0 ) || ( *(int*)( DebugAdapterProtocol::singleton + 700 ) == 0 )) goto LAB_0010776f;
                     uVar5 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( DebugAdapterProtocol::singleton + 0x2b8 ) * 4 );
                     uVar45 = CONCAT44(0, uVar5);
                     lVar46 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( DebugAdapterProtocol::singleton + 0x2b8 ) * 8 );
                     uVar38 = String::hash();
                     uVar40 = 1;
                     if (uVar38 != 0) {
                        uVar40 = uVar38;
            ...
            if (( uVar38 == 0 ) || ( auVar10._8_8_ = 0 ),auVar10._0_8_ = (ulong)uVar38 * lVar6,auVar24._8_8_ = 0,auVar24._0_8_ = uVar45,auVar11._8_8_ = 0,auVar11._0_8_ = ( ulong )(( uVar5 + uVar41 ) - SUB164(auVar10 * auVar24, 8)) * lVar6,auVar25._8_8_ = 0,auVar25._0_8_ = uVar45,SUB164(auVar11 * auVar25, 8) < uVar48) break;
         }
 while ( true );
      }
   ...
   while (true) {
      ...
      if (( uVar38 == 0 ) || ( auVar14._8_8_ = 0 ),auVar14._0_8_ = (ulong)uVar38 * lVar46,auVar28._8_8_ = 0,auVar28._0_8_ = uVar45,auVar15._8_8_ = 0,auVar15._0_8_ = ( ulong )(( uVar5 + uVar41 ) - SUB164(auVar14 * auVar28, 8)) * lVar46,auVar29._8_8_ = 0,auVar29._0_8_ = uVar45,SUB164(auVar15 * auVar29, 8) < uVar48) break;
      LAB_001075a7:if (uVar38 == uVar40) {
         cVar37 = String::operator ==((String*)( *(long*)( *(long*)( pSVar36 + 0x298 ) + lVar43 * 8 ) + 0x10 ), (String*)( lVar6 + 0x10 ));
         if (cVar37 != '\0') {
            ...
            uVar40 = *puVar47;
            if (( uVar40 == 0 ) || ( auVar17._8_8_ = 0 ),auVar17._0_8_ = (ulong)uVar40 * lVar42,auVar31._8_8_ = 0,auVar31._0_8_ = uVar45,auVar18._8_8_ = 0,auVar18._0_8_ = ( ulong )(( uVar5 + uVar38 ) - SUB164(auVar17 * auVar31, 8)) * lVar42,auVar32._8_8_ = 0,auVar32._0_8_ = uVar45,uVar48 = uVar41,SUB164(auVar18 * auVar32, 8) == 0) goto LAB_001076ce;
            goto LAB_00107685;
         }
...
;
   goto LAB_0010776f;
   while (auVar19._8_8_ = 0,auVar19._0_8_ = (ulong)uVar40 * lVar42,auVar33._8_8_ = 0,auVar33._0_8_ = uVar45,auVar20._8_8_ = 0,auVar20._0_8_ = ( ulong )(( uVar38 + uVar5 ) - SUB164(auVar19 * auVar33, 8)) * lVar42,auVar34._8_8_ = 0,auVar34._0_8_ = uVar45,uVar48 = uVar41,SUB164(auVar20 * auVar34, 8) != 0) {
      LAB_00107685:uVar41 = uVar38;
...
;
   LAB_001076ce:uVar45 = (ulong)uVar41;
   *(undefined4*)( lVar6 + uVar45 * 4 ) = 0;
   ...
   for (int i = 0; i < 4; i++) {
      CowData<char32_t>::_unref((CowData<char32_t>*)( plVar44 + ( 5 - i ) ));
   }

   Memory::free_static(plVar44, false);
   *(undefined8*)( *(long*)( pSVar36 + 0x298 ) + uVar45 * 8 ) = 0;
   *(int*)( pSVar36 + 700 ) = *(int*)( pSVar36 + 700 ) + -1;
   LAB_0010776f:Dictionary::Dictionary(param_1, local_a8);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_90);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_98);
   Dictionary::~Dictionary(local_a0);
   Dictionary::~Dictionary(local_a8);
   LAB_001070fb:CowData<char32_t>::_unref((CowData<char32_t>*)local_b0);
...
/* DebugAdapterParser::req_setBreakpoints(Dictionary const&) const */Dictionary *DebugAdapterParser::req_setBreakpoints(Dictionary *param_1) {
   Object OVar1;
   code *pcVar2;
   char cVar3;
   int iVar4;
   ...
   if (iVar4 == -1) {
      ...
      if (iVar4 != -1) {
         LAB_00107e89:iVar4 = String::find_char(wVar7, 0x5c);
         if (iVar4 != -1) {
            String::replace((char*)&local_a0, (char*)alStack_88);
            if (alStack_88[0] != local_a0) {
               CowData<char32_t>::_unref((CowData<char32_t>*)alStack_88);
...
;
   ...
   prepare_error_response(param_1, in_RSI);
   Dictionary::~Dictionary((Dictionary*)local_a8);
   LAB_00107de6:CowData<char32_t>::_unref((CowData<char32_t>*)alStack_88);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_90);
   Array::~Array(local_98);
...
/* DebugAdapterParser::req_stackTrace(Dictionary const&) const */Dictionary *DebugAdapterParser::req_stackTrace(Dictionary *param_1) {
   Object OVar1;
   Object OVar2;
   Object *pOVar3;
   char cVar4;
   ...
   if (*(char*)( DebugAdapterProtocol::singleton + 0x193 ) == '\0') {
      ...
      local_a8 = (Object*)0x0;
      Ref<DAPeer>::operator =((Ref<DAPeer>*)&local_a8, *(Ref**)( DebugAdapterProtocol::singleton + 0x1b8 ));
      pOVar3 = local_a8;
...
/* DebugAdapterParser::req_scopes(Dictionary const&) const */Dictionary *DebugAdapterParser::req_scopes(Dictionary *param_1) {
   StrRange *this;
   long lVar1;
   long lVar2;
   undefined8 *puVar3;
   ...
   if (( lVar1 != 0 ) && ( *(int*)( DebugAdapterProtocol::singleton + 0x204 ) != 0 )) {
      uVar18 = CONCAT44(0, *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( DebugAdapterProtocol::singleton + 0x200 ) * 4 ));
      lVar2 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( DebugAdapterProtocol::singleton + 0x200 ) * 8 );
      ...
      if (uVar13 != 0) {
         ...
         while (( (uint)uVar20 != uVar13 || ( iVar12 != *(int*)( *(long*)( lVar1 + lVar17 * 8 ) + 0x10 ) ) )) {
            ...
            if (( uVar13 == 0 ) || ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar13 * lVar2,auVar10._8_8_ = 0,auVar10._0_8_ = uVar18,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( DebugAdapterProtocol::singleton + 0x200 ) * 4 ) + uVar16 ) - SUB164(auVar6 * auVar10, 8)) * lVar2,auVar11._8_8_ = 0,auVar11._0_8_ = uVar18,SUB164(auVar7 * auVar11, 8) < uVar19) goto LAB_001093d2;
         }
;
         ...
         if (lVar1 != 0) {
            ...
            if (( puVar3 == (undefined8*)0x0 ) || ( *(int*)( puVar3 + 2 ) != 3 )) {
               _err_print_error("req_scopes", "editor/debugger/debug_adapter/debug_adapter_parser.cpp", 0x19a, "Condition \"E->value.size() != 3\" is true. Returning: prepare_error_response(p_params, DAP::ErrorType::UNKNOWN)", 0, 0);
   ...
   LAB_001093d2:piVar15 = (int*)EditorDebuggerNode::get_default_debugger();
   ...
   *(int*)( DebugAdapterProtocol::singleton + 0x198 ) = iVar12;
   ...
   LAB_0010949a:CowData<char32_t>::_unref(local_90 + 8);
   ...
   return param_1;
   LAB_001090c1:local_b8 = *piVar15;
   local_b4 = false;
   for (int i = 0; i < 16; i++) {
      local_c8[i] = (StrRange)0;
   }

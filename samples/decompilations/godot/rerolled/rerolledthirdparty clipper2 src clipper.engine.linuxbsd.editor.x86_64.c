      ...
      do {
         if (*(long*)( param_1 + 0x20 ) != 0) {
            ...
            if (local_78 != (OutPt*)0x0) {
               ...
               if (( ( local_78 == pOVar2 ) || ( pOVar2 == pOVar22 ) ) || ( cVar7 = cVar7 != '\0' )) {
...
;
                     ...
                     *(OutPt**)( pOVar23 + 0x18 ) = pOVar22;
                     operator_delete(local_78, 0x30);
                     pOVar2 = *(OutPt**)( pOVar23 + 0x10 );
                     if (( ( pOVar2 == pOVar23 ) || ( pOVar22 = pOVar2 == pOVar22 ) ) || ( cVar7 = cVar7 != '\0' )) break;
...
/* Clipper2Lib::BuildPathD(Clipper2Lib::OutPt*, bool, bool, std::vector<Clipper2Lib::Point<double>,
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( ( param_1 == (OutPt*)0x0 ) || ( pOVar1 = pOVar1 == param_1 ) ) || ( ( !param_3 && ( pOVar1 == *(OutPt**)( param_1 + 0x18 ) ) ) )) {
      uVar4 = 0;
   }
 else {

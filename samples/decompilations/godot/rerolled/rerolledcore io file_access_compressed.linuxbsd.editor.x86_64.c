/* FileAccessCompressed::is_open() const */bool FileAccessCompressed::is_open(FileAccessCompressed *this) {
   return *(long*)( this + 0x220 ) != 0;
}
/* FileAccessCompressed::get_error() const */byte FileAccessCompressed::get_error(FileAccessCompressed *this) {
   return -(this[0x1bc] != (FileAccessCompressed)0x0) & 0x12;
}
/* FileAccessCompressed::seek_end(long) */void FileAccessCompressed::seek_end(FileAccessCompressed *this, long param_1) {
   if (*(long*)( this + 0x220 ) == 0) {
      _err_print_error("seek_end", "core/io/file_access_compressed.cpp", 0xd6, "Condition \"f.is_null()\" is true.", "File must be opened before use.", 0, 0);
      return;
   }
...
/* FileAccessCompressed::eof_reached() const */FileAccessCompressed FileAccessCompressed::eof_reached(FileAccessCompressed *this) {
   if (*(long*)( this + 0x220 ) == 0) {
      _err_print_error("eof_reached", "core/io/file_access_compressed.cpp", 0xf1, "Condition \"f.is_null()\" is true. Returning: false", "File must be opened before use.", 0, 0);
...
/* FileAccessCompressed::_get_modified_time(String const&) */undefined8 FileAccessCompressed::_get_modified_time(FileAccessCompressed *this, String *param_1) {
   undefined8 uVar1;
   if (*(long*)( this + 0x220 ) != 0) {
...
/* FileAccessCompressed::get_position() const */long FileAccessCompressed::get_position(FileAccessCompressed *this) {
   if (*(long*)( this + 0x220 ) == 0) {
      _err_print_error("get_position", "core/io/file_access_compressed.cpp", 0xdf, "Condition \"f.is_null()\" is true. Returning: 0", "File must be opened before use.", 0, 0);
      return 0;
   }
...
/* FileAccessCompressed::get_length() const */undefined8 FileAccessCompressed::get_length(FileAccessCompressed *this) {
   if (*(long*)( this + 0x220 ) == 0) {
      _err_print_error("get_length", "core/io/file_access_compressed.cpp", 0xe8, "Condition \"f.is_null()\" is true. Returning: 0", "File must be opened before use.", 0, 0);
      return 0;
   }
...
/* FileAccessCompressed::flush() */void FileAccessCompressed::flush(FileAccessCompressed *this) {
   if (*(long*)( this + 0x220 ) != 0) {
      if (this[0x194] == (FileAccessCompressed)0x0) {
         _err_print_error("flush", "core/io/file_access_compressed.cpp", 0x125, "Condition \"!writing\" is true.", "File has not been opened in write mode.", 0, 0);
      }

      return;
   }

   _err_print_error("flush", "core/io/file_access_compressed.cpp", 0x124, "Condition \"f.is_null()\" is true.", "File must be opened before use.", 0, 0);
   return;
}
/* CowData<FileAccessCompressed::ReadBlock>::_copy_on_write() [clone .isra.0] */void CowData<FileAccessCompressed::ReadBlock>::_copy_on_write(CowData<FileAccessCompressed::ReadBlock> *this) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   undefined8 *puVar4;
...
/* FileAccessCompressed::get_buffer(unsigned char*, unsigned long) const */ulong FileAccessCompressed::get_buffer(FileAccessCompressed *this, uchar *param_1, ulong param_2) {
   undefined4 uVar1;
   long lVar2;
   long *plVar3;
   code *pcVar4;
   ...
   if (( param_1 == (uchar*)0x0 ) && ( param_2 != 0 )) {
      _err_print_error("get_buffer", "core/io/file_access_compressed.cpp", 0xfa, "Condition \"!p_dst && p_length > 0\" is true. Returning: -1", 0, 0);
   }
 else if (*(long*)( this + 0x220 ) == 0) {
      _err_print_error("get_buffer", "core/io/file_access_compressed.cpp", 0xfb, "Condition \"f.is_null()\" is true. Returning: -1", "File must be opened before use.", 0, 0);
   }
 else {
      if (this[0x194] == (FileAccessCompressed)0x0) {
...
;
               ...
               *(uint*)( this + 0x1d8 ) = uVar8;
               ...
               if (lVar2 != 0) {
                  ...
                  if (lVar2 != 0) {
                     ...
                     if (iVar6 == -1) {
                        _err_print_error("get_buffer", "core/io/file_access_compressed.cpp", 0x10d, "Condition \"ret == -1\" is true. Returning: -1", "Compressed file is corrupt.", 0, 0);
               ...
               lVar10 = 0;
               LAB_00100703:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar7, lVar10, "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
      ...
      _err_print_error("get_buffer", "core/io/file_access_compressed.cpp", 0xfc, "Condition \"writing\" is true. Returning: -1", "File has not been opened in read mode.", 0, 0);
   }

   return 0xffffffffffffffff;
}
/* FileAccessCompressed::seek(unsigned long) */ulong FileAccessCompressed::seek(ulong param_1) {
   undefined4 uVar1;
   undefined4 uVar2;
   long *plVar3;
   long lVar4;
   ...
   if (plVar3 == (long*)0x0) {
      uVar8 = _err_print_error(&_LC28, "core/io/file_access_compressed.cpp", 0xb8, "Condition \"f.is_null()\" is true.", "File must be opened before use.", 0, 0);
      return uVar8;
   }
      ...
      if (in_RSI <= *(ulong*)( param_1 + 0x200 )) {
         ...
         *(undefined2*)( param_1 + 0x1bc ) = 0;
         ...
         if (*(int*)( param_1 + 0x1d8 ) == iVar7) {
            LAB_00100a38:*(ulong*)( param_1 + 0x1e8 ) = in_RSI % uVar8;
            return in_RSI / uVar8;
         }
         ...
         *(int*)( param_1 + 0x1d8 ) = iVar7;
               ...
               if (lVar4 != 0) {
                  ...
                  if (lVar4 != 0) {
                     ...
                     if ((long)uVar8 < lVar12) {
                        ...
                        iVar7 = Compression::decompress(*(undefined8*)( param_1 + 0x218 ), uVar13, uVar11, uVar2, uVar1);
                        if (iVar7 == -1) {
                           uVar8 = 0;
                           _err_print_error(&_LC28, "core/io/file_access_compressed.cpp", 0xcc, "Condition \"ret == -1\" is true.", "Compressed file is corrupt.", 0);
                           return uVar8;
                        }
         ...
         LAB_00100b3e:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar8, lVar12, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
...
/* FileAccessCompressed::get_path_absolute() const */void FileAccessCompressed::get_path_absolute(void) {
   long lVar1;
   long in_RSI;
   StrRange *in_RDI;
   long in_FS_OFFSET;
...
/* FileAccessCompressed::get_path() const */void FileAccessCompressed::get_path(void) {
   long lVar1;
   long in_RSI;
   StrRange *in_RDI;
   long in_FS_OFFSET;
...
/* FileAccessCompressed::file_exists(String const&) */undefined8 FileAccessCompressed::file_exists(FileAccessCompressed *this, String *param_1) {
   char cVar1;
   undefined8 uVar2;
   long in_FS_OFFSET;
   Object *local_18;
...
/* FileAccessCompressed::_get_hidden_attribute(String const&) */undefined8 FileAccessCompressed::_get_hidden_attribute(String *param_1) {
   long *plVar1;
   undefined8 uVar2;
   ...
   if (plVar1 != (long*)0x0) {
      ...
      if (UNRECOVERED_JUMPTABLE != _get_hidden_attribute) {
         LAB_00100de0:/* WARNING: Could not recover jumptable at 0x00100de0. Too many branches *//* WARNING: Treating indirect jump as call */uVar2 = ( *UNRECOVERED_JUMPTABLE )();
         return uVar2;
      }
...
/* FileAccessCompressed::_get_read_only_attribute(String const&) */undefined8 FileAccessCompressed::_get_read_only_attribute(String *param_1) {
   long *plVar1;
   undefined8 uVar2;
   code *UNRECOVERED_JUMPTABLE;
   plVar1 = *(long**)( param_1 + 0x220 );
   if (plVar1 != (long*)0x0) {
      ...
      if (UNRECOVERED_JUMPTABLE != _get_read_only_attribute) {
         LAB_00100e70:/* WARNING: Could not recover jumptable at 0x00100e70. Too many branches *//* WARNING: Treating indirect jump as call */uVar2 = ( *UNRECOVERED_JUMPTABLE )();
         return uVar2;
      }
...
/* FileAccessCompressed::_get_unix_permissions(String const&) */undefined8 FileAccessCompressed::_get_unix_permissions(String *param_1) {
   long *plVar1;
   undefined8 uVar2;
   plVar1 = *(long**)( param_1 + 0x220 );
   if (plVar1 == (long*)0x0) {
...
/* FileAccessCompressed::_set_unix_permissions(String const&,
   BitField<FileAccess::UnixPermissionFlags>) */undefined8 FileAccessCompressed::_set_unix_permissions(long param_1) {
   long *plVar1;
   undefined8 uVar2;
   code *UNRECOVERED_JUMPTABLE;
   plVar1 = *(long**)( param_1 + 0x220 );
   if (plVar1 != (long*)0x0) {
      ...
      if (UNRECOVERED_JUMPTABLE != _set_unix_permissions) {
         LAB_00100fb0:/* WARNING: Could not recover jumptable at 0x00100fb0. Too many branches *//* WARNING: Treating indirect jump as call */uVar2 = ( *UNRECOVERED_JUMPTABLE )();
         return uVar2;
      }
...
/* FileAccessCompressed::_set_hidden_attribute(String const&, bool) */undefined8 FileAccessCompressed::_set_hidden_attribute(FileAccessCompressed *this, String *param_1, bool param_2) {
   long *plVar1;
   undefined8 uVar2;
   code *UNRECOVERED_JUMPTABLE;
   ...
   if (plVar1 != (long*)0x0) {
      ...
      if (UNRECOVERED_JUMPTABLE != _set_hidden_attribute) {
         LAB_00101040:/* WARNING: Could not recover jumptable at 0x00101040. Too many branches *//* WARNING: Treating indirect jump as call */uVar2 = ( *UNRECOVERED_JUMPTABLE )();
         return uVar2;
      }
...
/* FileAccessCompressed::_set_read_only_attribute(String const&, bool) */undefined8 FileAccessCompressed::_set_read_only_attribute(FileAccessCompressed *this, String *param_1, bool param_2) {
   long *plVar1;
   undefined8 uVar2;
   code *UNRECOVERED_JUMPTABLE;
   plVar1 = *(long**)( this + 0x220 );
   if (plVar1 != (long*)0x0) {
      ...
      if (UNRECOVERED_JUMPTABLE != _set_read_only_attribute) {
         LAB_001010d0:/* WARNING: Could not recover jumptable at 0x001010d0. Too many branches *//* WARNING: Treating indirect jump as call */uVar2 = ( *UNRECOVERED_JUMPTABLE )();
         return uVar2;
      }
...
/* FileAccessCompressed::configure(String const&, Compression::Mode, unsigned int) */void FileAccessCompressed::configure(FileAccessCompressed *this, undefined8 param_2, undefined4 param_3, undefined4 param_4) {
   long *plVar1;
   char *pcVar2;
   long lVar3;
   char *pcVar4;
...
/* FileAccessCompressed::store_buffer(unsigned char const*, unsigned long) */FileAccessCompressed FileAccessCompressed::store_buffer(FileAccessCompressed *this, uchar *param_1, ulong param_2) {
   ...
   long lVar6;
   if (*(long*)( this + 0x220 ) == 0) {
      _err_print_error("store_buffer", "core/io/file_access_compressed.cpp", 299, "Condition \"f.is_null()\" is true. Returning: false", "File must be opened before use.", 0, 0);
   }
 else {
      FVar1 = this[0x194];
      if (FVar1 != (FileAccessCompressed)0x0) {
         ...
         if (*(uint*)( this + 0x1a8 ) < uVar4) {
            ...
            *(uint*)( this + 0x1a8 ) = uVar2;
            iVar3 = CowData<unsigned_char>::resize<false>((CowData<unsigned_char>*)( this + 0x218 ), uVar5);
            if (iVar3 != 0) {
               _err_print_error("store_buffer", "core/io/file_access_compressed.cpp", 0x133, "Condition \"buffer.resize(write_buffer_size) != OK\" is true. Returning: false", 0, 0);
               return (FileAccessCompressed)0x0;
            }
      ...
      _err_print_error("store_buffer", "core/io/file_access_compressed.cpp", 300, "Condition \"!writing\" is true. Returning: false", "File has not been opened in write mode.", 0, 0);
   }

   return (FileAccessCompressed)0x0;
}
/* FileAccessCompressed::open_after_magic(Ref<FileAccess>) */long FileAccessCompressed::open_after_magic(FileAccessCompressed *this, long *param_2) {
   ...
   if (pOVar3 != pOVar17) {
      *(Object**)( this + 0x220 ) = pOVar3;
      if (( pOVar3 != (Object*)0x0 ) && ( cVar9 = cVar9 == '\0' )) {
         *(undefined8*)( this + 0x220 ) = 0;
      }

      if (( ( pOVar17 != (Object*)0x0 ) && ( cVar9 = RefCounted::unreference() ),cVar9 != '\0' )) &&( cVar9 = cVar9 != '\0' )(**(code**)( *(long*)pOVar17 + 0x140 ))(pOVar17);
      Memory::free_static(pOVar17, false);
   }

   pOVar17 = *(Object**)( this + 0x220 );
}
uVar10 = ( **(code**)( *(long*)pOVar17 + 0x1f0 ) )(pOVar17);*(undefined4*)( this + 400 ) = uVar10;iVar11 = ( **(code**)( **(long**)( this + 0x220 ) + 0x1f0 ) )();*(int*)( this + 0x1b8 ) = iVar11;if (iVar11 != 0) {
   ...
   *(ulong*)( this + 0x200 ) = (ulong)uVar12;
   ...
   if (iVar11 == 0) {
      ...
      do {
         ...
         iVar14 = CowData<FileAccessCompressed::ReadBlock>::resize<false>((CowData<FileAccessCompressed::ReadBlock>*)( this + 0x1f8 ), lVar21);
         if (iVar14 == 0) {
            if (*(long*)( this + 0x1f8 ) == 0) {
               lVar18 = -1;
               lVar21 = 0;
               ...
               lVar18 = lVar21 + -1;
               if (-1 < lVar18) {
                  CowData<FileAccessCompressed::ReadBlock>::_copy_on_write((CowData<FileAccessCompressed::ReadBlock>*)( this + 0x1f8 ));
            ...
            _err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar18, lVar21, "p_index", "size()", "", false, false);
         }
 else {
            _err_print_error("push_back", "./core/templates/vector.h", 0x142, "Condition \"err\" is true. Returning: true", 0, 0);
         }

         LAB_0010184b:bVar24 = uVar12 / uVar1 != uVar23;
 ...
 while ( bVar24 );
   ...
   *(undefined8*)( this + 0x1d0 ) = *(undefined8*)( this + 0x218 );
   ...
   LAB_00101ba5:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, 0, lVar15, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar5 = (code*)invalidInstructionException();
   ( *pcVar5 )();
}
if (( *(long**)( this + 0x220 ) != (long*)0x0 ) && ( cVar9 = cVar9 != '\0' )) {
...
*(undefined8*)( this + 0x220 ) = 0;( **(code**)( *(long*)*param_2 + 0x1a8 ) )(&local_68);local_58 = "Can\'t open compressed file \'%s\' with block size 0, it is corrupted.";local_60 = 0;local_50 = 0x43;String::parse_latin1((StrRange*)&local_60);vformat<String>(&local_58, (StrRange*)&local_60, &local_68);_err_print_error("open_after_magic", "core/io/file_access_compressed.cpp", 0x2f, "Method/function failed. Returning: ERR_FILE_CORRUPT", &local_58, 0, 0);pcVar8 = local_58;if (local_58 != (char*)0x0) {
   LOCK();
...
lVar15 = 0x10;LAB_0010197d:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return lVar15;}/* FileAccessCompressed::_close() */void FileAccessCompressed::_close(FileAccessCompressed *this) {
   uint uVar1;
   Object *pOVar2;
   ...
   if (*(long*)( this + 0x220 ) != 0) {
      if (this[0x194] == (FileAccessCompressed)0x0) {
         ...
         CowData<FileAccessCompressed::ReadBlock>::resize<false>((CowData<FileAccessCompressed::ReadBlock>*)( this + 0x1f8 ), 0);
      }
 else {
         String::utf8();
         ...
         ( **(code**)( **(long**)( this + 0x220 ) + 0x278 ) )(*(long**)( this + 0x220 ), *(undefined4*)( this + 400 ));
         ( **(code**)( **(long**)( this + 0x220 ) + 0x278 ) )(*(long**)( this + 0x220 ), *(undefined4*)( this + 0x1b8 ));
         ( **(code**)( **(long**)( this + 0x220 ) + 0x278 ) )(*(long**)( this + 0x220 ), *(undefined4*)( this + 0x1b0 ));
         auVar3._8_8_ = 0;
...
;
            ...
            _err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar12, lVar16, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
         ...
         local_60[0] = 0;
         ( **(code**)( **(long**)( this + 0x220 ) + 0x1b8 ) )(*(long**)( this + 0x220 ), 0x10, *(ulong*)( this + 0x1b0 ) % CONCAT44(0, *(uint*)( this + 0x1b8 )));
         ...
         if (local_70 == 0) {
            ...
            lVar14 = 0;
            LAB_00102061:iVar7 = (int)*(undefined8*)( local_70 + -8 );
            lVar16 = (long)( iVar7 + -1 );
            if (iVar7 == 0) {
               lVar16 = 0;
            }
      ...
      if (( *(long*)( this + 0x220 ) != 0 ) && ( cVar6 = cVar6 != '\0' )) {
...
/* FileAccessCompressed::open_internal(String const&, int) */int FileAccessCompressed::open_internal(FileAccessCompressed *this, String *param_1, int param_2) {
   CowData<unsigned_char> *this_00;
   Object *pOVar1;
   char cVar2;
   int iVar3;
   ...
   if (param_2 == 3) {
      iVar3 = 2;
      _err_print_error("open_internal", "core/io/file_access_compressed.cpp", 0x4f, "Condition \"p_mode_flags == READ_WRITE\" is true. Returning: ERR_UNAVAILABLE", 0, 0);
      goto LAB_00102483;
   }
   ...
   pOVar4 = pOVar1;
   if (local_40 == pOVar1) {
      LAB_00102343:if (( ( pOVar4 != (Object*)0x0 ) && ( cVar2 = RefCounted::unreference() ),pOVar1 = local_40,cVar2 != '\0' )) &&( cVar2 = cVar2 != '\0' )(**(code**)( *(long*)pOVar1 + 0x140 ))(pOVar1);
      Memory::free_static(pOVar1, false);
   }

}
else{*(Object**)( this + 0x220 ) = local_40;if (local_40 != (Object*)0x0) {
...
if (pOVar1 != (Object*)0x0) {
   cVar2 = RefCounted::unreference();
   joined_r0x001023f3:pOVar4 = local_40;
   ...
   if (( param_2 & 2U ) == 0) {
      ...
      if (cVar2 == '\0') {
         pOVar1 = *(Object**)( this + 0x220 );
         if (( pOVar1 == (Object*)0x0 ) || ( local_40 = pOVar1 ),cVar2 = RefCounted::reference(),cVar2 == '\0') {
            local_40 = (Object*)0x0;
      ...
      if (( *(long*)( this + 0x220 ) != 0 ) && ( cVar2 = cVar2 != '\0' )) {
         pOVar1 = *(Object**)( this + 0x220 );
...
LAB_00102483:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return iVar3;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* FileAccessCompressed::close() */void FileAccessCompressed::close(FileAccessCompressed *this) {
   _close(this);
   return;
}
/* FileAccessCompressed::~FileAccessCompressed() */void FileAccessCompressed::~FileAccessCompressed(FileAccessCompressed *this) {
   long *plVar1;
   long lVar2;
   Object *pOVar3;
   char cVar4;
   *(undefined***)this = &PTR__initialize_classv_00104d80;
   ...
   for (int i = 0; i < 3; i++) {
      if (*(long*)( this + ( -16*i + 536 ) ) != 0) {
         LOCK();
         plVar1 = (long*)( *(long*)( this + ( -16*i + 536 ) ) + -16 );
         *plVar1 = *plVar1 + -1;
         UNLOCK();
         if (*plVar1 == 0) {
            lVar2 = *(long*)( this + ( -16*i + 536 ) );
            *(undefined8*)( this + ( -16*i + 536 ) ) = 0;
...
/* FileAccessCompressed::resize(long) */undefined8 FileAccessCompressed::resize(long param_1) {
   return 2;
}
/* CowData<FileAccessCompressed::ReadBlock>::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<FileAccessCompressed::ReadBlock>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
...
/* FileAccess::_initialize_classv() */void FileAccess::_initialize_classv(void) {
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (initialize_class() != '\0') goto LAB_00103230;
   if (RefCounted::initialize_class() == '\0') {
      ...
      lVar2 = local_68;
      if (local_68 == 0) {
         LAB_0010333e:if ((code*)PTR__bind_methods_00107010 != RefCounted::_bind_methods) {
            LAB_0010334e:RefCounted::_bind_methods();
         }
   ...
   '\x01';
   LAB_00103230:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* FileAccess::is_class(String const&) const */undefined8 FileAccess::is_class(FileAccess *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_0010342f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
         ...
         LAB_001035bb:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
            ...
            LAB_0010369b:cVar6 = String::operator ==(param_1, (String*)&local_60);
            lVar4 = local_60;
            if (local_60 != 0) {
               LOCK();
               plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_001034e3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_00103744:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* WARNING: Removing unreachable block (ram,0x00104118) *//* WARNING: Removing unreachable block (ram,0x00104248) *//* WARNING: Removing unreachable block (ram,0x00104410) *//* WARNING: Removing unreachable block (ram,0x00104254) *//* WARNING: Removing unreachable block (ram,0x0010425e) *//* WARNING: Removing unreachable block (ram,0x001043f0) *//* WARNING: Removing unreachable block (ram,0x0010426a) *//* WARNING: Removing unreachable block (ram,0x00104274) *//* WARNING: Removing unreachable block (ram,0x001043d0) *//* WARNING: Removing unreachable block (ram,0x00104280) *//* WARNING: Removing unreachable block (ram,0x0010428a) *//* WARNING: Removing unreachable block (ram,0x001043b0) *//* WARNING: Removing unreachable block (ram,0x00104296) *//* WARNING: Removing unreachable block (ram,0x001042a0) *//* WARNING: Removing unreachable block (ram,0x00104390) *//* WARNING: Removing unreachable block (ram,0x001042ac) *//* WARNING: Removing unreachable block (ram,0x001042b6) *//* WARNING: Removing unreachable block (ram,0x00104370) *//* WARNING: Removing unreachable block (ram,0x001042c2) *//* WARNING: Removing unreachable block (ram,0x001042cc) *//* WARNING: Removing unreachable block (ram,0x00104350) *//* WARNING: Removing unreachable block (ram,0x001042d4) *//* WARNING: Removing unreachable block (ram,0x001042ea) *//* WARNING: Removing unreachable block (ram,0x001042f6) *//* String vformat<String>(String const&, String const) */undefined8 *vformat<String>(undefined8 *param_1, bool *param_2, String *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* CowData<FileAccessCompressed::ReadBlock>::_realloc(long) */undefined8 CowData<FileAccessCompressed::ReadBlock>::_realloc(CowData<FileAccessCompressed::ReadBlock> *this, long param_1) {
   undefined8 *puVar1;
   puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
   if (puVar1 != (undefined8*)0x0) {
      *puVar1 = 1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<FileAccessCompressed::ReadBlock>::resize<false>(long) */undefined8 CowData<FileAccessCompressed::ReadBlock>::resize<false>(CowData<FileAccessCompressed::ReadBlock> *this, long param_1) {
   long *plVar1;
   code *pcVar2;
   long lVar3;
   ulong uVar4;
   ...
   if (param_1 * 0x10 == 0) {
      LAB_00104a00:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<int>::resize<false>(long) */undefined8 CowData<int>::resize<false>(CowData<int> *this, long param_1) {
   ...
   if (param_1 * 4 == 0) {
      LAB_00104ce0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }

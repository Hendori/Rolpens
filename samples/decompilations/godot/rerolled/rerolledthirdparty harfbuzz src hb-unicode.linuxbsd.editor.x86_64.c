/* hb_unicode_combining_class_nil(hb_unicode_funcs_t*, unsigned int, void*) */undefined8 hb_unicode_combining_class_nil(hb_unicode_funcs_t *param_1, uint param_2, void *param_3) {
   return 0;
}
/* hb_unicode_eastasian_width_nil(hb_unicode_funcs_t*, unsigned int, void*) */undefined8 hb_unicode_eastasian_width_nil(hb_unicode_funcs_t *param_1, uint param_2, void *param_3) {
   return 1;
}
/* hb_unicode_general_category_nil(hb_unicode_funcs_t*, unsigned int, void*) */undefined8 hb_unicode_general_category_nil(hb_unicode_funcs_t *param_1, uint param_2, void *param_3) {
   return 7;
}
/* hb_unicode_mirroring_nil(hb_unicode_funcs_t*, unsigned int, void*) */uint hb_unicode_mirroring_nil(hb_unicode_funcs_t *param_1, uint param_2, void *param_3) {
   return param_2;
}
/* hb_unicode_script_nil(hb_unicode_funcs_t*, unsigned int, void*) */undefined8 hb_unicode_script_nil(hb_unicode_funcs_t *param_1, uint param_2, void *param_3) {
   return 0x5a7a7a7a;
}
/* hb_unicode_compose_nil(hb_unicode_funcs_t*, unsigned int, unsigned int, unsigned int*, void*) */undefined8 hb_unicode_compose_nil(hb_unicode_funcs_t *param_1, uint param_2, uint param_3, uint *param_4, void *param_5) {
   return 0;
}
/* hb_unicode_decompose_nil(hb_unicode_funcs_t*, unsigned int, unsigned int*, unsigned int*, void*)
    */undefined8 hb_unicode_decompose_nil(hb_unicode_funcs_t *param_1, uint param_2, uint *param_3, uint *param_4, void *param_5) {
   return 0;
}
/* hb_unicode_decompose_compatibility_nil(hb_unicode_funcs_t*, unsigned int, unsigned int*, void*)
    */undefined8 hb_unicode_decompose_compatibility_nil(hb_unicode_funcs_t *param_1, uint param_2, uint *param_3, void *param_4) {
   return 0;
}
...
;
 ...
 while ( true );
            ...
            __mutex[1].__align = 0;
            *(undefined8*)( (long)__mutex + 0x30 ) = 0;
            LAB_00100308:pthread_mutex_destroy(__mutex);
            free(__mutex);
            param_1[2] = 0;
            param_1[3] = 0;
         }
         ...
         for (int i = 0; i < 8; i++) {
            if (*(code**)( param_1 + ( 2*i + 38 ) ) != (code*)0) {
               ( **(code**)( param_1 + ( 2*i + 38 ) ) )(*(undefined8*)( param_1 + ( 2*i + 22 ) ));
            }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */bool hb_unicode_funcs_set_user_data(int *param_1, long param_2, long param_3, long param_4, int param_5) {
   uint uVar1;
   long lVar2;
   code *pcVar3;
   long lVar4;
...
;
 ...
 while ( uVar8 != uVar5 );
   ...
   if (uVar8 == 0) {
      ...
      if (__mutex[1].__data.__lock < 1) {
         ...
         uVar9 = 8;
         LAB_0010062c:plVar6 = (long*)realloc(plVar6, uVar9 * 0x18);
         if (plVar6 == (long*)0x0) {
 ...
 while ( uVar8 < uVar5 );
         ...
         LAB_00100698:uVar11 = __hb_CrapPool;
   ...
   LAB_001005f3:*(uint*)( (long)__mutex + 0x2c ) = uVar5;
   plVar10 = plVar6 + uVar7 * 3;
   *plVar10 = param_2;
   plVar10[1] = param_3;
   plVar10[2] = param_4;
   LAB_0010060a:pthread_mutex_unlock(__mutex);
   LAB_00100445:return -1 < __mutex[1].__data.__lock && plVar10 != (long*)0x0;
}
...
void hb_unicode_funcs_set_combining_class_func(long param_1, long param_2, undefined8 param_3, code *UNRECOVERED_JUMPTABLE) {
   long lVar1;
   if (*(int*)( param_1 + 4 ) == 0) {
...
void hb_unicode_funcs_set_eastasian_width_func(long param_1, long param_2, undefined8 param_3, code *UNRECOVERED_JUMPTABLE) {
   long lVar1;
   if (*(int*)( param_1 + 4 ) == 0) {
      if (UNRECOVERED_JUMPTABLE != (code*)0x0) {
...
void hb_unicode_funcs_set_general_category_func(long param_1, long param_2, undefined8 param_3, code *UNRECOVERED_JUMPTABLE) {
   long lVar1;
   if (*(int*)( param_1 + 4 ) == 0) {
      if (UNRECOVERED_JUMPTABLE != (code*)0x0) {
...
void hb_unicode_funcs_set_mirroring_func(long param_1, long param_2, undefined8 param_3, code *UNRECOVERED_JUMPTABLE) {
   long lVar1;
   if (*(int*)( param_1 + 4 ) == 0) {
      if (UNRECOVERED_JUMPTABLE != (code*)0x0) {
...
void hb_unicode_funcs_set_script_func(long param_1, long param_2, undefined8 param_3, code *UNRECOVERED_JUMPTABLE) {
   long lVar1;
   if (*(int*)( param_1 + 4 ) == 0) {
      if (UNRECOVERED_JUMPTABLE != (code*)0x0) {
...
void hb_unicode_funcs_set_compose_func(long param_1, long param_2, undefined8 param_3, code *UNRECOVERED_JUMPTABLE) {
   long lVar1;
   if (*(int*)( param_1 + 4 ) == 0) {
      if (UNRECOVERED_JUMPTABLE != (code*)0x0) {
...
void hb_unicode_funcs_set_decompose_func(long param_1, long param_2, undefined8 param_3, code *UNRECOVERED_JUMPTABLE) {
   long lVar1;
   if (*(int*)( param_1 + 4 ) == 0) {
      if (UNRECOVERED_JUMPTABLE != (code*)0x0) {
...
void hb_unicode_funcs_set_decompose_compatibility_func(long param_1, long param_2, undefined8 param_3, code *UNRECOVERED_JUMPTABLE) {
   long lVar1;
   if (*(int*)( param_1 + 4 ) == 0) {
      if (UNRECOVERED_JUMPTABLE != (code*)0x0) {

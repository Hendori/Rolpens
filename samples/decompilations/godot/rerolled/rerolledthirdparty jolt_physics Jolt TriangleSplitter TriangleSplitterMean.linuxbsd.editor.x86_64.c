/* JPH::TriangleSplitterMean::Split(JPH::TriangleSplitter::Range const&,
   JPH::TriangleSplitter::Range&, JPH::TriangleSplitter::Range&) */void JPH::TriangleSplitterMean::Split(Range *param_1, Range *param_2, Range *param_3) {
   uint *puVar1;
   uint uVar2;
   long lVar3;
   uint *puVar4;
   ...
   if (uVar2 < uVar6) {
      ...
      puVar1 = (uint*)( *(long*)( param_1 + 0x40 ) + 4 + ( ( ulong )(( uVar6 - 1 ) - uVar2) + (ulong)uVar2 ) * 4 );
      puVar4 = puVar7;
      do {
         uVar5 = ( ulong ) * puVar4;
         puVar4 = puVar4 + 1;
 ...
 while ( puVar7 != puVar1 );
   ...
   if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      JPH::TriangleSplitter::SplitInternal(param_1, (uint)param_2, local_28[(long)(ulong)uVar6], (Range*)(ulong)uVar6, param_3);
      return;
   }
...
/* JPH::TriangleSplitterMean::TriangleSplitterMean(JPH::Array<JPH::Float3,
   ...
   JPH::STLAllocator<JPH::IndexedTriangle> > const&) */void JPH::TriangleSplitterMean::TriangleSplitterMean(TriangleSplitterMean *this, Array *param_1, Array *param_2) {
...
/* JPH::TriangleSplitterMean::GetStats(JPH::TriangleSplitter::Stats&) const */void JPH::TriangleSplitterMean::GetStats(TriangleSplitterMean *this, Stats *param_1) {
   *(char**)param_1 = "TriangleSplitterMean";
   return;
}
/* JPH::TriangleSplitterMean::~TriangleSplitterMean() */void JPH::TriangleSplitterMean::~TriangleSplitterMean(TriangleSplitterMean *this) {
...
/* JPH::TriangleSplitterMean::TriangleSplitterMean(JPH::Array<JPH::Float3,
   JPH::STLAllocator<JPH::Float3> > const&, JPH::Array<JPH::IndexedTriangle,
   JPH::STLAllocator<JPH::IndexedTriangle> > const&) */void JPH::TriangleSplitterMean::_GLOBAL__sub_I_TriangleSplitterMean(void) {
   if (DVec3::cTrue == '\0') {
      DVec3::cTrue = '\x01';
      DVec3::cTrue = _LC3;
   }
...
/* WARNING: Control flow encountered bad instruction data *//* JPH::TriangleSplitterMean::~TriangleSplitterMean() */void JPH::TriangleSplitterMean::~TriangleSplitterMean(TriangleSplitterMean *this) {

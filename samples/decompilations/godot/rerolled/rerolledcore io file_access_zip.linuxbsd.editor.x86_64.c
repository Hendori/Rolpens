...
/* FileAccess::_initialize_classv() */void FileAccess::_initialize_classv(void) {
   ...
   '\x01';
   LAB_00102ce0:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Removing unreachable block (ram,0x00103bc8) *//* WARNING: Removing unreachable block (ram,0x00103cf8) *//* WARNING: Removing unreachable block (ram,0x00103ec0) *//* WARNING: Removing unreachable block (ram,0x00103d04) *//* WARNING: Removing unreachable block (ram,0x00103d0e) *//* WARNING: Removing unreachable block (ram,0x00103ea0) *//* WARNING: Removing unreachable block (ram,0x00103d1a) *//* WARNING: Removing unreachable block (ram,0x00103d24) *//* WARNING: Removing unreachable block (ram,0x00103e80) *//* WARNING: Removing unreachable block (ram,0x00103d30) *//* WARNING: Removing unreachable block (ram,0x00103d3a) *//* WARNING: Removing unreachable block (ram,0x00103e60) *//* WARNING: Removing unreachable block (ram,0x00103d46) *//* WARNING: Removing unreachable block (ram,0x00103d50) *//* WARNING: Removing unreachable block (ram,0x00103e40) *//* WARNING: Removing unreachable block (ram,0x00103d5c) *//* WARNING: Removing unreachable block (ram,0x00103d66) *//* WARNING: Removing unreachable block (ram,0x00103e20) *//* WARNING: Removing unreachable block (ram,0x00103d72) *//* WARNING: Removing unreachable block (ram,0x00103d7c) *//* WARNING: Removing unreachable block (ram,0x00103e00) *//* WARNING: Removing unreachable block (ram,0x00103d84) *//* WARNING: Removing unreachable block (ram,0x00103d9a) *//* WARNING: Removing unreachable block (ram,0x00103da6) *//* String vformat<String>(String const&, String const) */undefined8 *vformat<String>(undefined8 *param_1, bool *param_2, String *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<String, ZipArchive::File, HashMapHasherDefault, HashMapComparatorDefault<String>,
   DefaultTypedAllocator<HashMapElement<String, ZipArchive::File> > >::operator[](String const&) */undefined1 * __thiscallHashMap<String,ZipArchive::File,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ZipArchive::File>>>::operator [](HashMap<String,ZipArchive::File,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ZipArchive::File>>> * this, String * param_1) * plVar1 ;void *pvVar2void *__slong lVar3undefined1 auVar4[16]undefined1 auVar5[16]undefined1 auVar6[16]undefined1 auVar7[16]undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1 auVar15[16]undefined1 auVar16[16]undefined1 auVar17[16]undefined1 auVar18[16]undefined1 auVar19[16]undefined1 auVar20[16]undefined1 auVar21[16]undefined1 auVar22[16]undefined1 auVar23[16]undefined1 auVar24[16]undefined1 auVar25[16]undefined1 auVar26[16]undefined1 auVar27[16]undefined1 auVar28[16]undefined1 auVar29[16]undefined1 auVar30[16]undefined1 auVar31[16]undefined1 auVar32[16]undefined1 auVar33[16]undefined1 auVar34[16]undefined1 auVar35[16]char cVar36uint uVar37uint uVar38ulong uVar39undefined8 uVar40void *__s_00undefined1(*pauVar41)[16];undefined8 *puVar42void *pvVar43ulong uVar44int iVar45long lVar46long lVar47ulong uVar48undefined8 uVar49uint *puVar50uint uVar51uint uVar52long lVar53uint uVar54uint uVar55undefined1(*pauVar56)[16];undefined1(*pauVar57)[16];long in_FS_OFFSETlong local_68undefined4 local_60undefined4 uStack_5cundefined8 uStack_58undefined8 local_50long local_40local_40 = *(long*)( in_FS_OFFSET + 0x28 );uVar55 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );if (*(long*)( this + 8 ) == 0) {
...
*(undefined1(**) [16])( lVar46 + lVar47 * 8 ) = pauVar57;*puVar50 = uVar55;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_001043bb:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return pauVar41[1] + 8;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* void memdelete<FileAccess>(FileAccess*) */void memdelete<FileAccess>(FileAccess *param_1) {
   char cVar1;
...
/* CowData<ZipArchive::Package>::_unref() */void CowData<ZipArchive::Package>::_unref(CowData<ZipArchive::Package> *this) {
   long *plVar1;
   long *plVar2;
   long lVar3;
   long lVar4;
...
/* CowData<ZipArchive::Package>::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<ZipArchive::Package>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* CowData<ZipArchive::Package>::_realloc(long) */undefined8 CowData<ZipArchive::Package>::_realloc(CowData<ZipArchive::Package> *this, long param_1) {
   undefined8 *puVar1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<ZipArchive::Package>::resize<false>(long) */undefined8 CowData<ZipArchive::Package>::resize<false>(CowData<ZipArchive::Package> *this, long param_1) {
   long *plVar1;
   code *pcVar2;
   long *plVar3;
   undefined8 uVar4;

/* Gradient::get_interpolation_mode() */undefined4 Gradient::get_interpolation_mode(Gradient *this) {
   return *(undefined4*)( this + 0x254 );
}
/* Gradient::get_interpolation_color_space() */undefined4 Gradient::get_interpolation_color_space(Gradient *this) {
   return *(undefined4*)( this + 600 );
}
/* Gradient::get_point_count() const */undefined4 Gradient::get_point_count(Gradient *this) {
   return *(undefined4*)( this + 0x240 );
}
/* Gradient::set_interpolation_color_space(Gradient::ColorSpace) */void Gradient::set_interpolation_color_space(Gradient *this, int param_2) {
...
/* Gradient::remove_point(int) */void Gradient::remove_point(Gradient *this, int param_1) {
   undefined8 *puVar1;
   uint uVar2;
   long lVar3;
   undefined8 uVar4;
   ...
   if (uVar2 <= (uint)param_1) {
      _err_print_index_error("remove_point", "scene/resources/gradient.cpp", 0xac, (ulong)(uint)param_1, (ulong)uVar2, "(uint32_t)p_index", "points.size()", "", false, false);
      return;
   }
      ...
      *(uint*)( this + 0x240 ) = uVar2 - 1;
      if ((uint)param_1 < uVar2 - 1) {
         ...
         do {
            ...
            *puVar1 = *puVar5;
            puVar1[1] = uVar4;
            *(undefined4*)( (long)puVar5 + (ulong)(uint)param_1 * 0x14 + uVar7 * -0x14 + 0x10 ) = *(undefined4*)( puVar5 + 2 );
            puVar5 = puVar6;
         }
 while ( puVar6 != (undefined8*)( lVar3 + 0x14 + ( ( ( uVar2 - param_1 ) - 2 ) + uVar7 ) * 0x14 ) );
   ...
   _err_print_error("remove_point", "scene/resources/gradient.cpp", 0xad, "Condition \"points.size() <= 1\" is true.", 0, 0);
   return;
}
/* Gradient::add_point(float, Color const&) */void Gradient::add_point(Gradient *this, float param_1, Color *param_2) {
   float *pfVar1;
   float fVar2;
   float fVar3;
   float fVar4;
...
/* Gradient::set_interpolation_mode(Gradient::InterpolationMode) */void Gradient::set_interpolation_mode(Gradient *this, int param_2) {
...
/* Gradient::~Gradient() */void Gradient::~Gradient(Gradient *this) {
   *(undefined***)this = &PTR__initialize_classv_00115458;
...
/* SortArray<Gradient::Point, _DefaultComparator<Gradient::Point>, true>::introsort(long, long,
   Gradient::Point*, long) const [clone .isra.0] */void SortArray<Gradient::Point,_DefaultComparator<Gradient::Point>,true>::introsort(long param_1, long param_2, Point *param_3, long param_4) {
   Point *pPVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   if (0x10 < lVar14) {
      if (param_4 != 0) {
         ...
         if (fVar3 <= fVar2) {
            ...
            fVar23 = fVar3;
            if (( fVar4 <= fVar3 ) && ( fVar23 = fVar4 <= fVar2 )) {
               fVar23 = fVar2;
            }
...
;
               ...
               LAB_0010045c:if (lVar14 <= param_2) goto LAB_001004a0;
 ...
 while ( true );
      ...
      LAB_00100706:lVar20 = lVar14 + -2 >> 1;
      lVar21 = lVar20 * 2 + 2;
 ...
 while ( lVar20 < lVar18 );
            ...
            *(undefined8*)( pPVar13 + 8 ) = uStack_50;
            ...
            pPVar13 = pPVar17;
            LAB_00100912:auVar10 = stack0xffffffffffffffac;
            local_58._0_4_ = local_78;
 ...
 while ( true );
   ...
   goto LAB_001006bc;
   LAB_001004a0:introsort(param_2, lVar21, param_3, local_b8);
   lVar14 = param_2 - param_1;
   if (lVar14 < 0x11) goto LAB_001006bc;
   lVar21 = param_2;
   if (local_b8 == 0) goto LAB_00100706;
   goto LAB_00100361;
   LAB_0010053a:pPVar17 = param_3 + param_1 * 0x14;
 ...
 while ( lVar21 < lVar14 );
         if (lVar21 == lVar14) {
            LAB_0010089a:uVar7 = *(undefined8*)( pPVar19 + 8 );
 ...
 while ( bVar22 );
      ...
      LAB_0010068c:auVar10 = stack0xffffffffffffffac;
 ...
 while ( bVar22 );
   LAB_001006bc:if (lVar6 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* SortArray<Gradient::Point, _DefaultComparator<Gradient::Point>, true>::sort_range(long, long,
   Gradient::Point*) const [clone .part.0] [clone .constprop.0] [clone .isra.0] */void SortArray<Gradient::Point,_DefaultComparator<Gradient::Point>,true>::sort_range(long param_1, long param_2, Point *param_3) {
   float *__dest;
   undefined8 *puVar1;
   float fVar2;
   float fVar3;
               ...
               *(undefined8*)( param_2 + 8 ) = uVar7;
               ...
               if (fVar2 < pfVar15[-5]) {
                  ...
                  while (lVar9 != 0) {
                     ...
                     *(undefined4*)( param_2 + 0x10 + sVar10 ) = *(undefined4*)( (long)pfVar15 + sVar10 + -sVar17 + -4 );
                     if (fVar3 <= fVar2) {
...
;
               ...
               LAB_00100c8c:*(undefined8*)pfVar16 = uVar6;
...
;
               ...
               LAB_00100aa0:pfVar15 = pfVar15 + 5;
               pfVar16[4] = fVar4;
...
;
 ...
 while ( lVar11 != 0xf );
         LAB_00100ac2:pfVar15 = (float*)( param_2 + 0x140 );
         lVar11 = -0x140;
         lVar9 = 0x10;
         do {
            fVar4 = pfVar15[4];
            ...
            if (fVar2 < pfVar15[-5]) {
               do {
                  ...
                  *(undefined4*)( param_2 + 0x10 + lVar14 ) = *(undefined4*)( (long)pfVar15 + lVar14 + lVar11 + -4 );
                  lVar13 = lVar12 + -1;
                  if (fVar3 <= fVar2) {
...
/* Gradient::get_offset(int) */undefined4 Gradient::get_offset(int param_1) {
   uint uVar1;
   code *pcVar2;
   Point *in_RDX;
   uint in_ESI;
   ...
   if (uVar1 <= in_ESI) {
      _err_print_index_error("get_offset", "scene/resources/gradient.cpp", 0xc5, (ulong)in_ESI, (ulong)uVar1, "(uint32_t)pos", "points.size()", "", false, false);
      return 0;
   }

   lVar3 = *(long*)( lVar4 + 0x248 );
   if (*(char*)( lVar4 + 0x250 ) == '\0') {
      SortArray<Gradient::Point,_DefaultComparator<Gradient::Point>,true>::sort_range((ulong)uVar1, lVar3, in_RDX);
      *(undefined1*)( lVar4 + 0x250 ) = 1;
      if (*(uint*)( lVar4 + 0x240 ) <= in_ESI) {
         _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, (ulong)in_ESI, ( ulong ) * (uint*)( lVar4 + 0x240 ), "p_index", "count", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
...
/* Gradient::set_offset(int, float) */void Gradient::set_offset(int param_1, float param_2) {
   uint uVar1;
   code *pcVar2;
   Point *in_RDX;
   uint in_ESI;
   ...
   uVar1 = *(uint*)( lVar4 + 0x240 );
   if (uVar1 <= in_ESI) {
      _err_print_index_error("set_offset", "scene/resources/gradient.cpp", 0xbd, (ulong)in_ESI, (ulong)uVar1, "(uint32_t)pos", "points.size()", "", false, false);
      return;
   }
...
/* Gradient::set_color(int, Color const&) */void Gradient::set_color(Gradient *this, int param_1, Color *param_2) {
   undefined8 *puVar1;
   uint uVar2;
   code *pcVar3;
   ulong uVar4;
   ...
   if (uVar2 <= (uint)param_1) {
      _err_print_index_error("set_color", "scene/resources/gradient.cpp", 0xcb, uVar4, (ulong)uVar2, "(uint32_t)pos", "points.size()", "", false, false);
      return;
   }

   lVar6 = *(long*)( this + 0x248 );
   if (this[0x250] == (Gradient)0x0) {
      SortArray<Gradient::Point,_DefaultComparator<Gradient::Point>,true>::sort_range((ulong)uVar2, lVar6, (Point*)param_2);
      this[0x250] = (Gradient)0x1;
      if (*(uint*)( this + 0x240 ) <= (uint)param_1) {
         _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar4, ( ulong ) * (uint*)( this + 0x240 ), "p_index", "count", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
...
/* Gradient::get_color(int) */undefined1[16];Gradient::get_color(int param_1) {
   uint uVar1;
   code *pcVar2;
   undefined8 uVar3;
   Point *in_RDX;
   ...
   if (in_ESI < uVar1) {
      ...
      if (*(char*)( lVar6 + 0x250 ) == '\0') {
         SortArray<Gradient::Point,_DefaultComparator<Gradient::Point>,true>::sort_range((ulong)uVar1, lVar5, in_RDX);
         *(undefined1*)( lVar6 + 0x250 ) = 1;
         if (*(uint*)( lVar6 + 0x240 ) <= in_ESI) {
            _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, (ulong)in_ESI, ( ulong ) * (uint*)( lVar6 + 0x240 ), "p_index", "count", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar2 = (code*)invalidInstructionException();
            ( *pcVar2 )();
      ...
      _err_print_index_error("get_color", "scene/resources/gradient.cpp", 0xd2, (ulong)in_ESI, (ulong)uVar1, "(uint32_t)pos", "points.size()", "", false, false);
      uVar4 = 0;
...
/* Gradient::reverse() */void Gradient::reverse(Gradient *this) {
   float fVar1;
   float fVar2;
   float fVar3;
   long lVar4;
 ...
 while ( uVar17 != 1 );
         SortArray<Gradient::Point,_DefaultComparator<Gradient::Point>,true>::introsort(0, uVar15, __src, lVar13 * 2);
         if (uVar15 < 0x11) {
            pPVar9 = __src + 0x14;
            sVar18 = 0x14;
            uVar17 = 1;
                  ...
                  *(undefined8*)( __src + 8 ) = uVar6;
                  ...
                  if (fVar1 < *(float*)( pPVar10 + -0x14 )) {
                     ...
                     while (uVar8 = uVar8 - 1,uVar8 != 0) {
                        ...
                        *(undefined8*)( __src + sVar11 ) = *(undefined8*)( pPVar10 + sVar11 + -sVar18 + -0x14 );
                        *(undefined8*)( __src + sVar11 + 8 ) = uVar7;
                        *(undefined4*)( __src + sVar11 + 0x10 ) = *(undefined4*)( pPVar10 + sVar11 + -sVar18 + -4 );
                        if (fVar2 <= fVar1) {
...
;
                  ...
                  LAB_001014f4:*(undefined8*)pPVar16 = uVar5;
...
;
                  ...
                  LAB_001012c0:pPVar10 = pPVar10 + 0x14;
                  *(float*)( pPVar16 + 0x10 ) = fVar3;
            ...
            do {
               ...
               if (fVar1 < *(float*)( pPVar10 + -0x14 )) {
                  do {
                     ...
                     *(undefined4*)( __src + lVar12 + 0x10 ) = *(undefined4*)( pPVar10 + lVar12 + lVar13 + -4 );
                     lVar14 = lVar19 + -1;
                     if (fVar2 <= fVar1) {
...
/* Gradient::set_offsets(Vector<float> const&) */void Gradient::set_offsets(Gradient *this, Vector *param_1) {
   long lVar1;
   ulong uVar2;
   code *pcVar3;
   ...
   if (uVar12 < uVar14) {
      *(uint*)( this + 0x240 ) = uVar12;
      ...
      LAB_001016a5:if ((int)uVar10 == 0) goto LAB_001016ed;
   }
 else {
 ...
 while ( (undefined1(*) [16])( *pauVar4 + 4 ) != (undefined1(*) [16])( lVar9 + 0x14 + ( ( uVar14 - (int)uVar10 ) + uVar10 ) * 0x14 ) );
      }
      ...
      *(uint*)( this + 0x240 ) = uVar12;
      ...
      lVar13 = 0;
      if (lVar9 == 0) {
         LAB_00101786:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar7, lVar13, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
 ...
 while ( uVar7 != uVar10 );
   LAB_001016ed:this[0x250] = (Gradient)0x0;
   Resource::emit_changed();
   return;
}
/* Gradient::set_colors(Vector<Color> const&) */void Gradient::set_colors(Gradient *this, Vector *param_1) {
   undefined8 *puVar1;
   undefined8 *puVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   if (uVar14 < uVar7) {
      *(uint*)( this + 0x240 ) = uVar14;
      ...
      LAB_001018d7:if ((int)uVar11 == 0) goto LAB_00101925;
   }
 else {
 ...
 while ( (undefined1(*) [16])( lVar10 + 0x14 + ( ( uVar16 - uVar7 ) + uVar11 ) * 0x14 ) != (undefined1(*) [16])( *pauVar5 + 4 ) );
      }
      ...
      *(uint*)( this + 0x240 ) = uVar14;
      ...
      lVar15 = 0;
      if (lVar10 == 0) {
         LAB_001019ae:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar12, lVar15, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
 ...
 while ( uVar8 != uVar11 );
   LAB_00101925:Resource::emit_changed();
   return;
}
/* Gradient::~Gradient() */void Gradient::~Gradient(Gradient *this) {
   *(undefined***)this = &PTR__initialize_classv_00115458;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Gradient::Gradient() */void Gradient::Gradient(Gradient *this) {
   uint uVar1;
   code *pcVar2;
   undefined8 uVar3;
   undefined4 uVar4;
   ...
   *(undefined1(**) [16])( this + 0x248 ) = pauVar5;
   ...
   if (pauVar5 != (undefined1(*) [16])0x0) {
      ...
      uVar3 = CONCAT44(_UNK_00115dcc, _LC45);
      ...
      *(undefined4*)pauVar5[1] = uVar4;
      for (int i = 0; i < 3; i++) {
         *(undefined4*)( pauVar5[1] + ( 4*i + 4 ) ) = uVar4;
      }
...
/* Gradient::_validate_property(PropertyInfo&) const */void Gradient::_validate_property(Gradient *this, PropertyInfo *param_1) {
   char cVar1;
...
/* Gradient::_bind_methods() */void Gradient::_bind_methods(void) {
   long lVar1;
   code *pcVar2;
   undefined *puVar3;
   undefined *puVar4;
   ...
   long local_40;
   puVar4 = PTR__LC95_00115e00;
   puVar3 = PTR__LC94_00115df8;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   local_68 = 0;
   local_78 = PTR__LC95_00115e00;
   pcStack_70 = "color";
 ...
 while ( lVar1 != lVar8 );
   ...
   if (( ( ( StringName::configured != '\0' ) && ( ( local_110 == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) ) ) && ( ( local_108 == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) ) ) && ( local_100 != (char*)0x0 )) {
      StringName::unref();
   }
   ...
   local_e0 = 0x1b;
   String::parse_latin1((StrRange*)&local_108);
   GetTypeInfo<Gradient::InterpolationMode,void>::get_class_info((GetTypeInfo<Gradient::InterpolationMode,void>*)&local_e8);
   ...
   local_e0 = 0x19;
   String::parse_latin1((StrRange*)&local_108);
   GetTypeInfo<Gradient::ColorSpace,void>::get_class_info((GetTypeInfo<Gradient::ColorSpace,void>*)&local_e8);
   local_100 = (char*)local_d8;
   local_d8 = (long*)0x0;
   PropertyInfo::~PropertyInfo((PropertyInfo*)&local_e8);
   local_e8 = "Gradient";
...
/* Gradient::get_offsets() const */void Gradient::get_offsets(void) {
   undefined4 uVar1;
   uint uVar2;
   code *pcVar3;
   undefined8 *puVar4;
   ...
   if (uVar2 != 0) {
      ...
      if (*(int*)( in_RSI + 0x240 ) != 0) {
         ...
         do {
            ...
            if (lVar5 == 0) {
               lVar5 = 0;
               LAB_001048de:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar6, lVar5, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar3 = (code*)invalidInstructionException();
               ( *pcVar3 )();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Gradient::get_colors() const */void Gradient::get_colors(void) {
   long lVar1;
   uint uVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   if (uVar2 != 0) {
      ...
      if (puVar6 == (undefined8*)0x0) {
         ...
         *(undefined8**)( in_RDI + 8 ) = puVar6 + 2;
         ...
         uVar4 = __LC128;
         puVar8 = puVar6;
         if (( uVar10 * 0x10 & 0x10 ) == 0) goto LAB_00104a20;
         puVar6[2] = __LC128;
         puVar6[3] = uVar5;
         puVar8 = puVar6 + 2;
         while (puVar6 + uVar10 * 2 != puVar8) {
            LAB_00104a20:puVar8[2] = uVar4;
            puVar8[3] = uVar5;
            puVar8[4] = uVar4;
            puVar8[5] = uVar5;
            puVar8 = puVar8 + 4;
...
;
      ...
      if (*(int*)( in_RSI + 0x240 ) != 0) {
         ...
         do {
            ...
            if (lVar9 == 0) {
               lVar9 = 0;
               LAB_00104a9a:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar11, lVar9, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar3 = (code*)invalidInstructionException();
               ( *pcVar3 )();
            ...
            lVar9 = *(long*)( lVar9 + -8 );
            if (lVar9 <= lVar11) goto LAB_00104a9a;
            CowData<Color>::_copy_on_write((CowData<Color>*)( in_RDI + 8 ));
            lVar9 = *(long*)( in_RDI + 8 );
...
/* Gradient::is_class_ptr(void*) const */uint Gradient::is_class_ptr(Gradient *this, void *param_1) {
   return (uint)CONCAT71(0x115c, (undefined4*)param_1 == &Resource::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x115c, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x115c, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x115c, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* Gradient::_getv(StringName const&, Variant&) const */undefined8 Gradient::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* Gradient::_setv(StringName const&, Variant const&) */undefined8 Gradient::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* Gradient::_property_can_revertv(StringName const&) const */undefined8 Gradient::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* Gradient::_property_get_revertv(StringName const&, Variant&) const */undefined8 Gradient::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* Gradient::_notificationv(int, bool) */void Gradient::_notificationv(int param_1, bool param_2) {
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Gradient::get_color_at_offset(float) */undefined1  [16] __thiscallGradient::get_color_at_offset(Gradient *this, float param_1) {
   float *pfVar1;
   float *pfVar2;
   undefined8 *puVar3;
   code *pcVar4;
   ...
   if (this[0x250] == (Gradient)0x0) {
      LocalVector<Gradient::Point,unsigned_int,false,false>::sort_custom<_DefaultComparator<Gradient::Point>>((LocalVector<Gradient::Point,unsigned_int,false,false>*)( this + 0x240 ));
      uVar17 = ( ulong ) * (uint*)( this + 0x240 );
      this[0x250] = (Gradient)0x1;
      iVar14 = 0;
      iVar9 = *(uint*)( this + 0x240 ) - 1;
      if (iVar9 < 0) goto LAB_00104d1a;
      LAB_00104d87:do {
         while (true) {
            uVar11 = ( iVar14 + iVar9 ) / 2;
            uVar8 = (ulong)uVar11;
            uVar18 = (ulong)uVar11;
            if ((uint)uVar17 <= uVar11) goto LAB_00104ffb;
            ...
            iVar14 = uVar11 + 1;
            if (iVar9 < iVar14) goto LAB_00104dcc;
         }
;
         iVar9 = uVar11 - 1;
      }
 while ( iVar14 <= iVar9 );
      ...
      iVar14 = 0;
      iVar9 = uVar11 - 1;
      if (-1 < iVar9) goto LAB_00104d87;
      LAB_00104d1a:_err_print_error("get_color_at_offset", "scene/resources/gradient.h", 0xa6, "low > high, this may be a bug", 0);
      uVar17 = ( ulong ) * (uint*)( this + 0x240 );
      if (*(uint*)( this + 0x240 ) == 0) {
         uVar17 = 0;
         uVar8 = 0;
   ...
   LAB_00104dcc:fVar21 = _LC8;
   uVar16 = (uint)uVar17;
   if (param_1 < *(float*)( lVar7 + uVar18 * 0x14 )) {
      if ((int)uVar16 <= (int)uVar11) goto LAB_00105065;
      uVar10 = uVar11 - 1;
      uVar15 = uVar11;
      if (uVar11 == 0) {
      ...
      if ((int)uVar16 <= (int)( uVar11 + 1 )) {
         LAB_00105065:puVar3 = (undefined8*)( lVar7 + 4 + ( ulong )(uVar16 - 1) * 0x14 );
         uVar5 = *puVar3;
         uStack_a0 = puVar3[1];
   ...
   if (uVar10 < uVar16) {
      ...
      if ((int)( uVar10 + 2 ) < (int)uVar16) {
         ...
         if (uVar11 == 0xffffffff) {
            ...
            LAB_001050d9:if (uVar16 <= uVar11) {
               uVar8 = (ulong)(int)uVar11;
               goto LAB_00104ffb;
            }

            lVar12 = lVar7 + -0x14 + lVar12 * 0x14;
            if (uVar16 <= uVar10) goto LAB_00104fd9;
         }
         ...
         pfVar13 = pfVar2;
         uVar10 = uVar15;
         if (uVar11 != 0xffffffff) goto LAB_001050d9;
      }
      ...
      local_a8 = ( ( ( ( ( local_a8 + local_a8 ) - _LC21 * local_74 ) + _LC22 * fVar22 ) - local_44 ) * fVar24 + ( fVar22 - local_a8 ) * fVar25 + local_74 + local_74 + ( ( ( local_74 * _LC23 - local_a8 ) - fVar22 * _LC23 ) + local_44 ) * fVar19 ) * _LC24;
      fStack_a4 = ( ( ( ( ( local_90 + local_90 ) - _UNK_00115d74 * local_70 ) + _UNK_00115d7c * local_80 ) - fStack_40 ) * fVar24 + ( local_80 - local_90 ) * fVar25 + local_70 + local_70 + ( ( ( local_70 * _UNK_00115d84 - local_90 ) - local_80 * _UNK_00115d84 ) + fStack_40 ) * fVar19 ) * _UNK_00115d8c;
      fVar22 = ( ( ( local_7c * _LC22 + ( ( local_8c + local_8c ) - local_6c * _LC21 ) ) - fVar20 ) * fVar24 + ( local_7c - local_8c ) * fVar25 + local_6c + local_6c + ( ( ( local_6c * _LC23 - local_8c ) - local_7c * _LC23 ) + fVar20 ) * fVar19 ) * _LC24;
      fVar25 = ( ( ( ( local_68 * _LC23 - fVar23 ) - _LC23 * local_78 ) + local_84 ) * fVar19 + fVar24 * ( ( ( ( fVar23 + fVar23 ) - _LC21 * local_68 ) + _LC22 * local_78 ) - local_84 ) + ( local_78 - fVar23 ) * fVar25 + local_68 + local_68 ) * _LC24;
      if (iVar9 == 1) {
         if (_LC13 <= fVar22) {
      ...
      LAB_00104ce3:auVar6._4_4_ = fStack_a4;
      auVar6._0_4_ = local_a8;
      auVar6._8_8_ = uStack_a0;
      return auVar6;
   }

   LAB_00104fd9:uVar8 = (ulong)(int)uVar10;
   LAB_00104ffb:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar8, uVar17, "p_index", "count", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar4 = (code*)invalidInstructionException();
   ( *pcVar4 )();
}
/* MethodBindTR<Gradient::ColorSpace>::_gen_argument_type(int) const */undefined8 MethodBindTR<Gradient::ColorSpace>::_gen_argument_type(int param_1) {
   return 2;
}
/* MethodBindTR<Gradient::ColorSpace>::get_argument_meta(int) const */undefined8 MethodBindTR<Gradient::ColorSpace>::get_argument_meta(int param_1) {
   return 0;
}
/* MethodBindT<Gradient::ColorSpace>::_gen_argument_type(int) const */char MethodBindT<Gradient::ColorSpace>::_gen_argument_type(MethodBindT<Gradient::ColorSpace> *this, int param_1) {
   return ( param_1 == 0 ) * '\x02';
}
/* MethodBindT<Gradient::ColorSpace>::get_argument_meta(int) const */undefined8 MethodBindT<Gradient::ColorSpace>::get_argument_meta(int param_1) {
   return 0;
}
/* MethodBindTR<Gradient::InterpolationMode>::_gen_argument_type(int) const */undefined8 MethodBindTR<Gradient::InterpolationMode>::_gen_argument_type(int param_1) {
   return 2;
}
/* MethodBindTR<Gradient::InterpolationMode>::get_argument_meta(int) const */undefined8 MethodBindTR<Gradient::InterpolationMode>::get_argument_meta(int param_1) {
   return 0;
}
/* MethodBindT<Gradient::InterpolationMode>::_gen_argument_type(int) const */char MethodBindT<Gradient::InterpolationMode>::_gen_argument_type(MethodBindT<Gradient::InterpolationMode> *this, int param_1) {
   return ( param_1 == 0 ) * '\x02';
}
/* MethodBindT<Gradient::InterpolationMode>::get_argument_meta(int) const */undefined8 MethodBindT<Gradient::InterpolationMode>::get_argument_meta(int param_1) {
   return 0;
}
...
/* MethodBindTR<Color, float>::_gen_argument_type(int) const */int MethodBindTR<Color,float>::_gen_argument_type(MethodBindTR<Color,float> *this, int param_1) {
   return ( -(uint)(param_1 == 0) & 0xffffffef ) + 0x14;
}
/* MethodBindTR<Color, float>::get_argument_meta(int) const */byte MethodBindTR<Color,float>::get_argument_meta(MethodBindTR<Color,float> *this, int param_1) {
   return -(param_1 == 0) & 9;
}
...
/* MethodBindTR<float, int>::_gen_argument_type(int) const */int MethodBindTR<float,int>::_gen_argument_type(MethodBindTR<float,int> *this, int param_1) {
   return 3 - ( uint )(param_1 == 0);
}
/* MethodBindTR<float, int>::get_argument_meta(int) const */byte MethodBindTR<float,int>::get_argument_meta(MethodBindTR<float,int> *this, int param_1) {
   if (-1 < param_1) {
      return -(param_1 == 0) & 3;
   }
...
/* MethodBindT<float, Color const&>::_gen_argument_type(int) const */int MethodBindT<float,Color_const&>::_gen_argument_type(MethodBindT<float,Color_const&> *this, int param_1) {
   int iVar1;
   iVar1 = 0;
   if ((uint)param_1 < 2) {
...
/* MethodBindT<float, Color const&>::get_argument_meta(int) const */byte MethodBindT<float,Color_const&>::get_argument_meta(MethodBindT<float,Color_const&> *this, int param_1) {
   return -(param_1 == 0) & 9;
}
/* MethodBindT<float, Color const&>::~MethodBindT() */void MethodBindT<float,Color_const&>::~MethodBindT(MethodBindT<float,Color_const&> *this) {
   *(undefined***)this = &PTR__gen_argument_type_00115630;
...
/* MethodBindT<int>::~MethodBindT() */void MethodBindT<int>::~MethodBindT(MethodBindT<int> *this) {
   *(undefined***)this = &PTR__gen_argument_type_00115690;
   MethodBind::~MethodBind((MethodBind*)this);
   return;
}
/* MethodBindT<int>::~MethodBindT() */void MethodBindT<int>::~MethodBindT(MethodBindT<int> *this) {
...
/* MethodBindT<int, float>::~MethodBindT() */void MethodBindT<int,float>::~MethodBindT(MethodBindT<int,float> *this) {
   *(undefined***)this = &PTR__gen_argument_type_001156f0;
   MethodBind::~MethodBind((MethodBind*)this);
   return;
}
/* MethodBindT<int, float>::~MethodBindT() */void MethodBindT<int,float>::~MethodBindT(MethodBindT<int,float> *this) {
...
/* MethodBindTR<float, int>::~MethodBindTR() */void MethodBindTR<float,int>::~MethodBindTR(MethodBindTR<float,int> *this) {
   *(undefined***)this = &PTR__gen_argument_type_00115750;
   MethodBind::~MethodBind((MethodBind*)this);
   return;
}
/* MethodBindTR<float, int>::~MethodBindTR() */void MethodBindTR<float,int>::~MethodBindTR(MethodBindTR<float,int> *this) {
...
/* MethodBindT<>::~MethodBindT() */void MethodBindT<>::~MethodBindT(MethodBindT<> *this) {
   *(undefined***)this = &PTR__gen_argument_type_001157b0;
   MethodBind::~MethodBind((MethodBind*)this);
   return;
}
/* MethodBindT<>::~MethodBindT() */void MethodBindT<>::~MethodBindT(MethodBindT<> *this) {
...
/* MethodBindT<int, Color const&>::~MethodBindT() */void MethodBindT<int,Color_const&>::~MethodBindT(MethodBindT<int,Color_const&> *this) {
   *(undefined***)this = &PTR__gen_argument_type_00115810;
   MethodBind::~MethodBind((MethodBind*)this);
   return;
}
/* MethodBindT<int, Color const&>::~MethodBindT() */void MethodBindT<int,Color_const&>::~MethodBindT(MethodBindT<int,Color_const&> *this) {
...
/* MethodBindTR<Color, int>::~MethodBindTR() */void MethodBindTR<Color,int>::~MethodBindTR(MethodBindTR<Color,int> *this) {
   *(undefined***)this = &PTR__gen_argument_type_00115870;
   MethodBind::~MethodBind((MethodBind*)this);
   return;
}
/* MethodBindTR<Color, int>::~MethodBindTR() */void MethodBindTR<Color,int>::~MethodBindTR(MethodBindTR<Color,int> *this) {
...
/* MethodBindTR<Color, float>::~MethodBindTR() */void MethodBindTR<Color,float>::~MethodBindTR(MethodBindTR<Color,float> *this) {
   *(undefined***)this = &PTR__gen_argument_type_001158d0;
   MethodBind::~MethodBind((MethodBind*)this);
   return;
}
/* MethodBindTR<Color, float>::~MethodBindTR() */void MethodBindTR<Color,float>::~MethodBindTR(MethodBindTR<Color,float> *this) {
...
/* MethodBindTRC<int>::~MethodBindTRC() */void MethodBindTRC<int>::~MethodBindTRC(MethodBindTRC<int> *this) {
   *(undefined***)this = &PTR__gen_argument_type_00115930;
   MethodBind::~MethodBind((MethodBind*)this);
   return;
}
/* MethodBindTRC<int>::~MethodBindTRC() */void MethodBindTRC<int>::~MethodBindTRC(MethodBindTRC<int> *this) {
...
/* MethodBindT<Vector<float> const&>::~MethodBindT() */void MethodBindT<Vector<float>const&>::~MethodBindT(MethodBindT<Vector<float>const&> *this) {
   *(undefined***)this = &PTR__gen_argument_type_00115990;
   MethodBind::~MethodBind((MethodBind*)this);
   return;
}
/* MethodBindT<Vector<float> const&>::~MethodBindT() */void MethodBindT<Vector<float>const&>::~MethodBindT(MethodBindT<Vector<float>const&> *this) {
...
/* MethodBindTRC<Vector<float>>::~MethodBindTRC() */void MethodBindTRC<Vector<float>>::~MethodBindTRC(MethodBindTRC<Vector<float>> *this) {
   *(undefined***)this = &PTR__gen_argument_type_001159f0;
   MethodBind::~MethodBind((MethodBind*)this);
   return;
}
/* MethodBindTRC<Vector<float>>::~MethodBindTRC() */void MethodBindTRC<Vector<float>>::~MethodBindTRC(MethodBindTRC<Vector<float>> *this) {
...
/* MethodBindT<Vector<Color> const&>::~MethodBindT() */void MethodBindT<Vector<Color>const&>::~MethodBindT(MethodBindT<Vector<Color>const&> *this) {
   *(undefined***)this = &PTR__gen_argument_type_00115a50;
   MethodBind::~MethodBind((MethodBind*)this);
   return;
}
/* MethodBindT<Vector<Color> const&>::~MethodBindT() */void MethodBindT<Vector<Color>const&>::~MethodBindT(MethodBindT<Vector<Color>const&> *this) {
...
/* MethodBindTRC<Vector<Color>>::~MethodBindTRC() */void MethodBindTRC<Vector<Color>>::~MethodBindTRC(MethodBindTRC<Vector<Color>> *this) {
   *(undefined***)this = &PTR__gen_argument_type_00115ab0;
   MethodBind::~MethodBind((MethodBind*)this);
   return;
}
/* MethodBindTRC<Vector<Color>>::~MethodBindTRC() */void MethodBindTRC<Vector<Color>>::~MethodBindTRC(MethodBindTRC<Vector<Color>> *this) {
...
/* MethodBindT<Gradient::InterpolationMode>::~MethodBindT() */void MethodBindT<Gradient::InterpolationMode>::~MethodBindT(MethodBindT<Gradient::InterpolationMode> *this) {
   *(undefined***)this = &PTR__gen_argument_type_00115b10;
   MethodBind::~MethodBind((MethodBind*)this);
   return;
}
/* MethodBindT<Gradient::InterpolationMode>::~MethodBindT() */void MethodBindT<Gradient::InterpolationMode>::~MethodBindT(MethodBindT<Gradient::InterpolationMode> *this) {
...
/* MethodBindTR<Gradient::InterpolationMode>::~MethodBindTR() */void MethodBindTR<Gradient::InterpolationMode>::~MethodBindTR(MethodBindTR<Gradient::InterpolationMode> *this) {
   *(undefined***)this = &PTR__gen_argument_type_00115b70;
   MethodBind::~MethodBind((MethodBind*)this);
   return;
}
/* MethodBindTR<Gradient::InterpolationMode>::~MethodBindTR() */void MethodBindTR<Gradient::InterpolationMode>::~MethodBindTR(MethodBindTR<Gradient::InterpolationMode> *this) {
...
/* MethodBindT<Gradient::ColorSpace>::~MethodBindT() */void MethodBindT<Gradient::ColorSpace>::~MethodBindT(MethodBindT<Gradient::ColorSpace> *this) {
   *(undefined***)this = &PTR__gen_argument_type_00115bd0;
   MethodBind::~MethodBind((MethodBind*)this);
   return;
}
/* MethodBindT<Gradient::ColorSpace>::~MethodBindT() */void MethodBindT<Gradient::ColorSpace>::~MethodBindT(MethodBindT<Gradient::ColorSpace> *this) {
...
/* MethodBindTR<Gradient::ColorSpace>::~MethodBindTR() */void MethodBindTR<Gradient::ColorSpace>::~MethodBindTR(MethodBindTR<Gradient::ColorSpace> *this) {
   *(undefined***)this = &PTR__gen_argument_type_00115c30;
   MethodBind::~MethodBind((MethodBind*)this);
   return;
}
/* MethodBindTR<Gradient::ColorSpace>::~MethodBindTR() */void MethodBindTR<Gradient::ColorSpace>::~MethodBindTR(MethodBindTR<Gradient::ColorSpace> *this) {
...
/* Gradient::_validate_propertyv(PropertyInfo&) const */void Gradient::_validate_propertyv(Gradient *this, PropertyInfo *param_1) {
   char cVar1;
   cVar1 = String::operator ==((String*)( param_1 + 8 ), "interpolation_color_space");
   if (( cVar1 != '\0' ) && ( *(int*)( this + 0x254 ) == 1 )) {
      *(undefined4*)( param_1 + 0x28 ) = 2;
...
/* Gradient::_get_class_namev() const */undefined8 *Gradient::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      ...
      if (*(long*)( _get_class_namev() ) != 0) {
         ...
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "Gradient");
         goto LAB_001074ee;
      }
...
/* Gradient::get_save_class() const */Gradient * __thiscall Gradient::get_save_class(Gradient *this){
   long lVar1;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   *(undefined8*)this = 0;
...
/* Gradient::get_class() const */void Gradient::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* Gradient::_bind_methods() [clone .cold] */void Gradient::_bind_methods(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* RefCounted::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void RefCounted::_get_property_listv(List *param_1, bool param_2) {
   ...
   local_58 = 0;
   if (local_90 == 0) {
      LAB_00107df8:local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_58, (CowData*)&local_90);
      local_50 = 0x80;
      if (local_60 != 0x11) goto LAB_00107df8;
      StringName::StringName((StringName*)&local_80, (String*)&local_58, false);
      if (local_68 != local_80) {
         StringName::unref();
         lVar2 = *(long*)pLVar6;
         local_68 = local_80;
         goto joined_r0x00107e16;
      }
...
/* Resource::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Resource::_get_property_listv(Resource *this, List *param_1, bool param_2) {
   ...
   local_58 = 0;
   if (local_90 == 0) {
      LAB_001081f8:local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_58, (CowData*)&local_90);
      local_50 = 0x80;
      if (local_60 != 0x11) goto LAB_001081f8;
      StringName::StringName((StringName*)&local_80, (String*)&local_58, false);
      if (local_68 != local_80) {
         StringName::unref();
         lVar2 = *(long*)param_1;
         local_68 = local_80;
         goto joined_r0x00108215;
      }
...
/* Gradient::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Gradient::_get_property_listv(Gradient *this, List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   undefined1(*pauVar4)[16];
   ...
   local_58 = 0;
   if (local_90 == 0) {
      LAB_00108648:local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_58, (CowData*)&local_90);
      local_50 = 0x80;
      if (local_60 != 0x11) goto LAB_00108648;
      StringName::StringName((StringName*)&local_80, (String*)&local_58, false);
      if (local_68 != local_80) {
         StringName::unref();
         lVar2 = *(long*)param_1;
         local_68 = local_80;
         goto joined_r0x00108665;
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ok_color::linear_srgb_to_oklab(ok_color::RGB) */undefined8 ok_color::linear_srgb_to_oklab(undefined8 param_1, float param_2) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ok_color::oklab_to_linear_srgb(ok_color::Lab) */undefined8 ok_color::oklab_to_linear_srgb(undefined8 param_1, float param_2) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   return CONCAT44(( fVar1 * _LC79._4_4_ + fVar4 * _LC80._4_4_ ) - fVar3 * _LC81._4_4_, ( fVar1 * (float)_LC79 - fVar4 * (float)_LC80 ) + fVar3 * (float)_LC81);
}
...
godot::details::enum_qualified_name_to_class_info_name(details *this,String *param_1){
   ...
   long local_30;
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   String::split(local_58, SUB81(param_1, 0), 0x108bed);
...
/* GetTypeInfo<Gradient::InterpolationMode, void>::get_class_info() */GetTypeInfo<Gradient::InterpolationMode,void> * __thiscall
...
/* GetTypeInfo<Gradient::ColorSpace, void>::get_class_info() */GetTypeInfo<Gradient::ColorSpace,void> * __thiscall
...
/* MethodBindTR<Gradient::ColorSpace>::_gen_argument_type_info(int) const */undefined4 *MethodBindTR<Gradient::ColorSpace>::_gen_argument_type_info(int param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   undefined4 in_register_0000003c;
...
/* MethodBindTR<Gradient::InterpolationMode>::_gen_argument_type_info(int) const */undefined4 *MethodBindTR<Gradient::InterpolationMode>::_gen_argument_type_info(int param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   undefined4 in_register_0000003c;
...
/* Gradient::is_class(String const&) const */undefined8 Gradient::is_class(Gradient *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
 ...
 while ( !bVar9 );
      ...
      LAB_001093ef:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
         ...
         LAB_001095eb:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
            ...
            LAB_001096c7:cVar6 = String::operator ==(param_1, (String*)&local_60);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
            if (cVar6 != '\0') goto LAB_001094a3;
         }
 ...
 while ( !bVar9 );
               ...
               LAB_00109573:cVar6 = String::operator ==(param_1, (String*)&local_60);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
               if (cVar6 != '\0') goto LAB_001094a3;
            }
   ...
   LAB_001094a3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_001097ae:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<int, float>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<int,float>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar8 + 2 ) = (undefined1[16])0x0;
   ...
   if (local_80 == 0) {
      LAB_00109910:local_40 = 6;
      StringName::operator =((StringName*)( local_60 + 8 ), (StringName*)&local_78);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_48, (CowData*)&local_80);
      local_40 = 6;
      if (local_50 != 0x11) goto LAB_00109910;
   ...
   *puVar8 = local_68._0_4_;
   ...
   LAB_00109818:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBindTR<Color, float>::_gen_argument_type_info(int) const */undefined4 *MethodBindTR<Color,float>::_gen_argument_type_info(int param_1) {
   ...
   if (in_EDX != 0) {
      ...
      *(undefined1(*) [16])( puVar7 + 2 ) = (undefined1[16])0x0;
      if (local_a0 == 0) {
         puVar7[10] = 6;
         LAB_00109cc7:StringName::operator =((StringName*)( puVar7 + 4 ), (StringName*)&local_98);
      }
 else {
         CowData<char32_t>::_ref((CowData<char32_t>*)( puVar7 + 8 ), (CowData*)&local_a0);
         puVar7[10] = 6;
         if (puVar7[6] != 0x11) goto LAB_00109cc7;
   ...
   if (local_b0 == 0) {
      ...
      local_40 = 6;
      if (local_50 != 0x11) goto LAB_00109d38;
   ...
   *(long*)( puVar7 + 8 ) = local_78;
   puVar7[10] = local_70;
   CowData<char32_t>::_unref((CowData<char32_t>*)local_90);
   LAB_00109d02:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBindT<Gradient::ColorSpace>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<Gradient::ColorSpace>::_gen_argument_type_info(int param_1) {
   long lVar1;
   int in_EDX;
   undefined4 in_register_0000003c;
   undefined4 *puVar2;
   ...
   *(undefined1(*) [16])( puVar2 + 2 ) = (undefined1[16])0x0;
   if (in_EDX == 0) {
      GetTypeInfo<Gradient::ColorSpace,void>::get_class_info((GetTypeInfo<Gradient::ColorSpace,void>*)local_48);
      *puVar2 = local_48[0];
...
/* MethodBindT<Gradient::InterpolationMode>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<Gradient::InterpolationMode>::_gen_argument_type_info(int param_1) {
   long lVar1;
   int in_EDX;
   undefined4 in_register_0000003c;
   undefined4 *puVar2;
   ...
   *(undefined1(*) [16])( puVar2 + 2 ) = (undefined1[16])0x0;
   if (in_EDX == 0) {
      GetTypeInfo<Gradient::InterpolationMode,void>::get_class_info((GetTypeInfo<Gradient::InterpolationMode,void>*)local_48);
      *puVar2 = local_48[0];
      if (*(long*)( puVar2 + 2 ) != local_40) {
         CowData<char32_t>::_unref((CowData<char32_t>*)( puVar2 + 2 ));
         lVar1 = local_40;
...
/* MethodBindT<int>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<int>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar5 + 2 ) = (undefined1[16])0x0;
   ...
   local_60 = (undefined1[16])0x0;
   if (local_80 == 0) {
      LAB_0010a245:local_40 = 6;
      StringName::operator =((StringName*)( local_60 + 8 ), (StringName*)&local_78);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_48, (CowData*)&local_80);
      local_40 = 6;
      if (local_50 != 0x11) goto LAB_0010a245;
      StringName::StringName((StringName*)&local_70, (String*)&local_48, false);
      if (local_60._8_8_ == local_70) {
         if (( StringName::configured != '\0' ) && ( local_70 != 0 )) {
            StringName::unref();
   ...
   *puVar5 = local_68._0_4_;
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)local_60);
   LAB_0010a149:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBindT<Vector<Color> const&>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<Vector<Color>const&>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar5 + 2 ) = (undefined1[16])0x0;
   ...
   local_60 = (undefined1[16])0x0;
   if (local_80 == 0) {
      LAB_0010a4b5:local_40 = 6;
      StringName::operator =((StringName*)( local_60 + 8 ), (StringName*)&local_78);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_48, (CowData*)&local_80);
      local_40 = 6;
      if (local_50 != 0x11) goto LAB_0010a4b5;
      StringName::StringName((StringName*)&local_70, (String*)&local_48, false);
      if (local_60._8_8_ == local_70) {
         if (( StringName::configured != '\0' ) && ( local_70 != 0 )) {
            StringName::unref();
   ...
   *puVar5 = local_68._0_4_;
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)local_60);
   LAB_0010a3b9:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBindT<Vector<float> const&>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<Vector<float>const&>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar5 + 2 ) = (undefined1[16])0x0;
   ...
   local_60 = (undefined1[16])0x0;
   if (local_80 == 0) {
      LAB_0010a725:local_40 = 6;
      StringName::operator =((StringName*)( local_60 + 8 ), (StringName*)&local_78);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_48, (CowData*)&local_80);
      local_40 = 6;
      if (local_50 != 0x11) goto LAB_0010a725;
      StringName::StringName((StringName*)&local_70, (String*)&local_48, false);
      if (local_60._8_8_ == local_70) {
         if (( StringName::configured != '\0' ) && ( local_70 != 0 )) {
            StringName::unref();
   ...
   *puVar5 = local_68._0_4_;
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)local_60);
   LAB_0010a629:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* void LocalVector<Gradient::Point, unsigned int, false,
   false>::sort_custom<_DefaultComparator<Gradient::Point> >() */void LocalVector<Gradient::Point,unsigned_int,false,false>::sort_custom<_DefaultComparator<Gradient::Point>>(LocalVector<Gradient::Point,unsigned_int,false,false> *this) {
   Point *__dest;
   float fVar1;
   float fVar2;
   uint uVar3;
 ...
 while ( uVar14 != 1 );
      SortArray<Gradient::Point,_DefaultComparator<Gradient::Point>,true>::introsort(0, uVar17, __src, lVar11 * 2);
      __dest = __src + 0x14;
      if (uVar17 < 0x11) {
         sVar19 = 0x14;
         uVar14 = 1;
               ...
               *(undefined8*)( __src + 8 ) = uVar7;
               ...
               if (fVar1 < *(float*)( pPVar15 + -0x14 )) {
                  ...
                  while (uVar9 = uVar9 - 1,uVar9 != 0) {
                     ...
                     *(undefined4*)( __src + sVar10 + 0x10 ) = *(undefined4*)( pPVar15 + sVar10 + -sVar19 + -4 );
                     if (fVar2 <= fVar1) {
...
;
               ...
               LAB_0010abac:*(undefined8*)pPVar16 = uVar6;
...
;
               ...
               LAB_0010a9d0:pPVar15 = pPVar15 + 0x14;
               *(float*)( pPVar16 + 0x10 ) = fVar4;
               *(undefined8*)pPVar16 = uVar6;
               *(undefined8*)( pPVar16 + 8 ) = uVar7;
               lVar11 = lVar18;
               sVar19 = sVar19 + 0x14;
               if (lVar18 == 0xf) goto LAB_0010a9f2;
            }
;
            memmove(__dest, __src, sVar19);
            pPVar15 = pPVar15 + 0x14;
 ...
 while ( lVar18 != 0xf );
         LAB_0010a9f2:pPVar15 = __src + 0x140;
         lVar11 = -0x140;
         uVar14 = 0x10;
         do {
            fVar4 = *(float*)( pPVar15 + 0x10 );
 ...
 while ( uVar17 != uVar14 );
   ...
   LAB_0010ac24:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBind* create_method_bind<Gradient, float, Color const&>(void (Gradient::*)(float, Color
   const&)) */MethodBind *create_method_bind<Gradient,float,Color_const&>(_func_void_float_Color_ptr *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<Gradient, int>(void (Gradient::*)(int)) */MethodBind *create_method_bind<Gradient,int>(_func_void_int *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<Gradient, int, float>(void (Gradient::*)(int, float)) */MethodBind *create_method_bind<Gradient,int,float>(_func_void_int_float *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<Gradient, float, int>(float (Gradient::*)(int)) */MethodBind *create_method_bind<Gradient,float,int>(_func_float_int *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<Gradient>(void (Gradient::*)()) */MethodBind *create_method_bind<Gradient>(_func_void *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<Gradient, int, Color const&>(void (Gradient::*)(int, Color
   const&)) */MethodBind *create_method_bind<Gradient,int,Color_const&>(_func_void_int_Color_ptr *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<Gradient, Color, int>(Color (Gradient::*)(int)) */MethodBind *create_method_bind<Gradient,Color,int>(_func_Color_int *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<Gradient, Color, float>(Color (Gradient::*)(float)) */MethodBind *create_method_bind<Gradient,Color,float>(_func_Color_float *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<Gradient, int>(int (Gradient::*)() const) */MethodBind *create_method_bind<Gradient,int>(_func_int *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<Gradient, Vector<float> const&>(void (Gradient::*)(Vector<float>
   const&)) */MethodBind *create_method_bind<Gradient,Vector<float>const&>(_func_void_Vector_ptr *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<Gradient, Vector<float>>(Vector<float> (Gradient::*)() const) */MethodBind *create_method_bind<Gradient,Vector<float>>(_func_Vector *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<Gradient, Vector<Color> const&>(void (Gradient::*)(Vector<Color>
   const&)) */MethodBind *create_method_bind<Gradient,Vector<Color>const&>(_func_void_Vector_ptr *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<Gradient, Vector<Color>>(Vector<Color> (Gradient::*)() const) */MethodBind *create_method_bind<Gradient,Vector<Color>>(_func_Vector *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<Gradient, Gradient::InterpolationMode>(void
   (Gradient::*)(Gradient::InterpolationMode)) */MethodBind *create_method_bind<Gradient,Gradient::InterpolationMode>(_func_void_InterpolationMode *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<Gradient, Gradient::InterpolationMode>(Gradient::InterpolationMode
   (Gradient::*)()) */MethodBind *create_method_bind<Gradient,Gradient::InterpolationMode>(_func_InterpolationMode *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<Gradient, Gradient::ColorSpace>(void
   (Gradient::*)(Gradient::ColorSpace)) */MethodBind *create_method_bind<Gradient,Gradient::ColorSpace>(_func_void_ColorSpace *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<Gradient, Gradient::ColorSpace>(Gradient::ColorSpace
   (Gradient::*)()) */MethodBind *create_method_bind<Gradient,Gradient::ColorSpace>(_func_ColorSpace *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* Gradient::_initialize_classv() */void Gradient::_initialize_classv(void) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   undefined8 local_70;
...
/* WARNING: Removing unreachable block (ram,0x0010c5a8) *//* WARNING: Removing unreachable block (ram,0x0010c73d) *//* WARNING: Removing unreachable block (ram,0x0010c749) *//* String vformat<StringName>(String const&, StringName const) */undefined8 *vformat<StringName>(undefined8 *param_1, bool *param_2, StringName *param_3) {
   Variant *this;
   int iVar1;
   long in_FS_OFFSET;
   Array local_c8[8];
...
/* MethodBindTR<Gradient::ColorSpace>::call(Object*, Variant const**, int, Callable::CallError&)
   const */Object *MethodBindTR<Gradient::ColorSpace>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   int iVar2;
   long *plVar4;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   LAB_0010c940:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTR<Gradient::ColorSpace>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTR<Gradient::ColorSpace>::validated_call(MethodBindTR<Gradient::ColorSpace> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   uint uVar1;
   long *plVar3;
   long in_FS_OFFSET;
   long local_58;
   ...
   *(ulong*)( param_3 + 8 ) = (ulong)uVar1;
   LAB_0010cbe4:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTR<Gradient::ColorSpace>::ptrcall(Object*, void const**, void*) const */void MethodBindTR<Gradient::ColorSpace>::ptrcall(MethodBindTR<Gradient::ColorSpace> *this, Object *param_1, void **param_2, void *param_3) {
   uint uVar1;
   long *plVar3;
   long in_FS_OFFSET;
   long local_58;
   ...
   *(ulong*)param_3 = (ulong)uVar1;
   LAB_0010cda3:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<Gradient::ColorSpace>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<Gradient::ColorSpace>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   LAB_0010d0e1:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<Gradient::ColorSpace>::ptrcall(Object*, void const**, void*) const */void MethodBindT<Gradient::ColorSpace>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   code *UNRECOVERED_JUMPTABLE;
   long *plVar1;
   long in_FS_OFFSET;
   long local_58;
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x0010d14b. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), **param_3);
      return;
   }

   LAB_0010d2c1:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindTR<Gradient::InterpolationMode>::call(Object*, Variant const**, int,
   Callable::CallError&) const */Object *MethodBindTR<Gradient::InterpolationMode>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   int iVar2;
   long *plVar4;
   undefined4 in_register_00000014;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   LAB_0010d390:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTR<Gradient::InterpolationMode>::validated_call(Object*, Variant const**, Variant*)
   const */void MethodBindTR<Gradient::InterpolationMode>::validated_call(MethodBindTR<Gradient::InterpolationMode> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   uint uVar1;
   long *plVar3;
   long in_FS_OFFSET;
   long local_58;
   ...
   uVar1 = ( *pcVar2 )(param_1 + *(long*)( this + 0x60 ));
   *(ulong*)( param_3 + 8 ) = (ulong)uVar1;
   LAB_0010d5a4:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTR<Gradient::InterpolationMode>::ptrcall(Object*, void const**, void*) const */void MethodBindTR<Gradient::InterpolationMode>::ptrcall(MethodBindTR<Gradient::InterpolationMode> *this, Object *param_1, void **param_2, void *param_3) {
   uint uVar1;
   long *plVar3;
   long in_FS_OFFSET;
   long local_58;
   ...
   uVar1 = ( *pcVar2 )(param_1 + *(long*)( this + 0x60 ));
   *(ulong*)param_3 = (ulong)uVar1;
   LAB_0010d753:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<Gradient::InterpolationMode>::validated_call(Object*, Variant const**, Variant*)
   const */void MethodBindT<Gradient::InterpolationMode>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   code *UNRECOVERED_JUMPTABLE;
   Variant *pVVar1;
   long in_FS_OFFSET;
   long local_58;
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x0010d91c. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *(undefined4*)( *(long*)param_3 + 8 ));
      return;
   }

   LAB_0010da91:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<Gradient::InterpolationMode>::ptrcall(Object*, void const**, void*) const */void MethodBindT<Gradient::InterpolationMode>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   code *UNRECOVERED_JUMPTABLE;
   long *plVar1;
   long in_FS_OFFSET;
   long local_58;
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x0010dafb. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), **param_3);
      return;
   }

   LAB_0010dc71:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindTRC<Vector<Color>>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindTRC<Vector<Color>>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   LAB_0010dd80:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTRC<Vector<Color>>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTRC<Vector<Color>>::validated_call(MethodBindTRC<Vector<Color>> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   LAB_0010dfeb:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<Vector<Color>>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<Vector<Color>>::ptrcall(MethodBindTRC<Vector<Color>> *this, Object *param_1, void **param_2, void *param_3) {
   ...
   LAB_0010e1e7:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<Vector<Color> const&>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<Vector<Color>const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x0010e3b1. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *(long*)( *(long*)param_3 + 8 ) + 0x10);
      return;
   }

   LAB_0010e529:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<Vector<Color> const&>::ptrcall(Object*, void const**, void*) const */void MethodBindT<Vector<Color>const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x0010e589. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *param_3);
      return;
   }

   LAB_0010e701:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindTRC<Vector<float>>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindTRC<Vector<float>>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   LAB_0010e810:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTRC<Vector<float>>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<Vector<float>>::ptrcall(MethodBindTRC<Vector<float>> *this, Object *param_1, void **param_2, void *param_3) {
   ...
   LAB_0010ec77:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<Vector<float> const&>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<Vector<float>const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x0010ee41. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *(long*)( *(long*)param_3 + 8 ) + 0x10);
      return;
   }

   LAB_0010efb9:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<Vector<float> const&>::ptrcall(Object*, void const**, void*) const */void MethodBindT<Vector<float>const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x0010f019. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *param_3);
      return;
   }

   LAB_0010f191:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindTRC<int>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindTRC<int>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   LAB_0010f260:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTRC<int>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTRC<int>::validated_call(MethodBindTRC<int> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   *(long*)( param_3 + 8 ) = (long)iVar1;
   LAB_0010f474:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<int>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<int>::ptrcall(MethodBindTRC<int> *this, Object *param_1, void **param_2, void *param_3) {
   ...
   *(long*)param_3 = (long)iVar1;
   LAB_0010f623:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTR<Color, float>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTR<Color,float>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   code *pcVar1;
   Variant *pVVar2;
   long in_RCX;
   long in_FS_OFFSET;
   ...
   *(undefined8*)( in_RCX + 0x10 ) = in_XMM1_Qa;
   LAB_0010f7e7:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTR<Color, float>::ptrcall(Object*, void const**, void*) const */void MethodBindTR<Color,float>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   code *pcVar1;
   long *plVar2;
   undefined8 *in_RCX;
   long in_FS_OFFSET;
   ...
   *in_RCX = uVar3;
   in_RCX[1] = in_XMM1_Qa;
   LAB_0010f9d5:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTR<Color, int>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTR<Color,int>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   *(undefined8*)( in_RCX + 8 ) = uVar3;
   *(undefined8*)( in_RCX + 0x10 ) = in_XMM1_Qa;
   LAB_0010fbb1:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTR<Color, int>::ptrcall(Object*, void const**, void*) const */void MethodBindTR<Color,int>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   *in_RCX = uVar3;
   in_RCX[1] = in_XMM1_Qa;
   LAB_0010fd8f:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<int, Color const&>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<int,Color_const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x0010ff89. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *(undefined4*)( *(long*)param_3 + 8 ), *(long*)( param_3 + 8 ) + 8);
      return;
   }

   LAB_001100df:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<int, Color const&>::ptrcall(Object*, void const**, void*) const */void MethodBindT<int,Color_const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Load size is inaccurate */
      /* WARNING: Could not recover jumptable at 0x00110152. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), **param_3, *(undefined8*)( (long)param_3 + 8 ));
      return;
   }

   LAB_001102c9:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   LAB_001103f0:*(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindT<>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x00110616. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ));
      return;
   }

   LAB_0011076f:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<>::ptrcall(Object*, void const**, void*) const */void MethodBindT<>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x001107d6. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ));
      return;
   }

   LAB_0011092f:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindTR<float, int>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTR<float,int>::validated_call(MethodBindTR<float,int> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   code *pcVar1;
   long *plVar2;
   long in_FS_OFFSET;
   float fVar3;
   ...
   *(double*)( param_3 + 8 ) = (double)fVar3;
   LAB_0011098e:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTR<float, int>::ptrcall(Object*, void const**, void*) const */void MethodBindTR<float,int>::ptrcall(MethodBindTR<float,int> *this, Object *param_1, void **param_2, void *param_3) {
   code *pcVar1;
   long *plVar2;
   long in_FS_OFFSET;
   float fVar3;
   ...
   *(double*)param_3 = (double)fVar3;
   LAB_00110b6c:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<int, float>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<int,float>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      ...
      /* WARNING: Could not recover jumptable at 0x00110d69. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )(auVar2._0_8_, (long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *(undefined4*)( *(long*)param_3 + 8 ));
      return;
   }

   LAB_00110ee1:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<int, float>::ptrcall(Object*, void const**, void*) const */void MethodBindT<int,float>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      ...
      /* WARNING: Could not recover jumptable at 0x00110f57. Too many branches */
      /* WARNING: Treating indirect jump as call */
...
/* MethodBindT<int>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<int>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x0011113c. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *(undefined4*)( *(long*)param_3 + 8 ));
      return;
   }
...
/* MethodBindT<int>::ptrcall(Object*, void const**, void*) const */void MethodBindT<int>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x0011131b. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), **param_3);
      return;
   }

   LAB_00111491:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<float, Color const&>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<float,Color_const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   code *UNRECOVERED_JUMPTABLE;
   Variant *pVVar1;
   long in_FS_OFFSET;
   undefined1 auVar2[16];
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      auVar2._4_12_ = SUB1612((undefined1[16])0x0, 4);
      auVar2._0_4_ = (float)*(double*)( *(long*)param_3 + 8 );
      /* WARNING: Could not recover jumptable at 0x0011150a. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )(auVar2._0_8_, (long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *(long*)( param_3 + 8 ) + 8);
      return;
   }

   LAB_00111681:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<float, Color const&>::ptrcall(Object*, void const**, void*) const */void MethodBindT<float,Color_const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   code *UNRECOVERED_JUMPTABLE;
   long *plVar1;
   long in_FS_OFFSET;
   undefined1 auVar2[16];
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      ...
      /* WARNING: Could not recover jumptable at 0x001116f5. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )(auVar2._0_8_, (long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *(undefined8*)( (long)param_3 + 8 ));
      return;
   }

   LAB_00111871:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* MethodBindT<Vector<float> const&>::call(Object*, Variant const**, int, Callable::CallError&)
   ...
   if (in_R8D < 2) {
      pVVar10 = param_2[5];
      if (pVVar10 == (Variant*)0x0) {
         if (in_R8D != 1) goto LAB_00111d50;
         LAB_00111d40:pVVar10 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar10 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_00111d50:uVar6 = 4;
            goto LAB_00111cf5;
         }
      ...
      *in_R9 = 0;
      ...
      uVar6 = 3;
      LAB_00111cf5:*in_R9 = uVar6;
      in_R9[2] = 1;
   }

   LAB_00111d00:*(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTR<Color, float>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindTR<Color,float>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   long lVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   if (in_R8D < 2) {
      pVVar10 = param_2[5];
      if (pVVar10 == (Variant*)0x0) {
         if (in_R8D != 1) goto LAB_001120c0;
         LAB_001120b0:pVVar10 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar10 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_001120c0:uVar6 = 4;
            goto LAB_0011206d;
         }
      ...
      *(undefined8*)( param_1 + 0x10 ) = uStack_38;
      ...
      uVar6 = 3;
      LAB_0011206d:*in_R9 = uVar6;
      in_R9[2] = 1;
   }

   LAB_00112078:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBindTR<float, int>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindTR<float,int>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   long lVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   if (in_R8D < 2) {
      ...
      if (pVVar11 == (Variant*)0x0) {
         if (in_R8D != 1) goto LAB_00112440;
         LAB_00112430:pVVar11 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar11 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_00112440:uVar7 = 4;
            goto LAB_001123ed;
         }
      ...
      *(undefined8*)( param_1 + 0x10 ) = uStack_38;
      ...
      uVar7 = 3;
      LAB_001123ed:*in_R9 = uVar7;
      in_R9[2] = 1;
   }

   LAB_001123f8:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBindTR<Color, int>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindTR<Color,int>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   if (in_R8D < 2) {
      pVVar11 = param_2[5];
      if (pVVar11 == (Variant*)0x0) {
         if (in_R8D != 1) goto LAB_001127d0;
         LAB_001127c0:pVVar11 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar11 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_001127d0:uVar7 = 4;
            goto LAB_0011277d;
         }
      ...
      *(undefined8*)( param_1 + 0x10 ) = uStack_38;
      ...
      uVar7 = 3;
      LAB_0011277d:*in_R9 = uVar7;
      in_R9[2] = 1;
   }

   LAB_00112788:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* void call_with_variant_args_dv<__UnexistingClass, Gradient::ColorSpace>(__UnexistingClass*, void
   ...
   Vector<Variant> const&) */void call_with_variant_args_dv<__UnexistingClass,Gradient::ColorSpace>(__UnexistingClass *param_1, _func_void_ColorSpace *param_2, Variant **param_3, int param_4, CallError *param_5, Vector *param_6) {
   long lVar1;
   long lVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   if (lVar1 == 0) {
      if (uVar8 != 1) goto LAB_00112b30;
   }
 else {
      lVar2 = *(long*)( lVar1 + -8 );
      if ((int)lVar2 < (int)( uVar8 ^ 1 )) {
         LAB_00112b30:uVar6 = 4;
         LAB_00112acd:*(undefined4*)param_6 = uVar6;
   ...
   LAB_00112a4b:*(undefined4*)param_6 = 0;
   ...
   /* WARNING: Could not recover jumptable at 0x00112aa6. Too many branches */
   /* WARNING: Treating indirect jump as call */
   ( *param_2 )((char)( param_1 + (long)param_3 ));
   return;
}
/* MethodBindT<Gradient::ColorSpace>::call(Object*, Variant const**, int, Callable::CallError&)
   const */Object *MethodBindT<Gradient::ColorSpace>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   long lVar1;
   char *pcVar2;
   long *plVar3;
   undefined4 in_register_00000014;
   ...
   call_with_variant_args_dv<__UnexistingClass,Gradient::ColorSpace>(p_Var4, (_func_void_ColorSpace*)param_2[0xb], (Variant**)param_2[0xc], (int)param_4, in_R8, in_R9);
   *(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   LAB_00112b96:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* void call_with_variant_args_dv<__UnexistingClass,
   ...
   Vector<Variant> const&) */void call_with_variant_args_dv<__UnexistingClass,Gradient::InterpolationMode>(__UnexistingClass *param_1, _func_void_InterpolationMode *param_2, Variant **param_3, int param_4, CallError *param_5, Vector *param_6) {
   long lVar1;
   long lVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   lVar1 = *(long*)( in_stack_00000008 + 8 );
   if (lVar1 == 0) {
      if (uVar8 != 1) goto LAB_00112f00;
   }
 else {
      lVar2 = *(long*)( lVar1 + -8 );
      if ((int)lVar2 < (int)( uVar8 ^ 1 )) {
         LAB_00112f00:uVar6 = 4;
         LAB_00112e9d:*(undefined4*)param_6 = uVar6;
         *(undefined4*)( param_6 + 8 ) = 1;
         return;
      }
   ...
   this * (Variant**)CONCAT44(in_register_0000000c, param_4);
   LAB_00112e1b:*(undefined4*)param_6 = 0;
   if (( (ulong)param_2 & 1 ) != 0) {
   ...
   Variant::operator_cast_to_long(this);
   /* WARNING: Could not recover jumptable at 0x00112e76. Too many branches */
   /* WARNING: Treating indirect jump as call */
   ( *param_2 )((char)( param_1 + (long)param_3 ));
   return;
}
/* MethodBindT<Gradient::InterpolationMode>::call(Object*, Variant const**, int,
   Callable::CallError&) const */Object *MethodBindT<Gradient::InterpolationMode>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   long lVar1;
   char *pcVar2;
   long *plVar3;
   undefined4 in_register_00000014;
   ...
   call_with_variant_args_dv<__UnexistingClass,Gradient::InterpolationMode>(p_Var4, (_func_void_InterpolationMode*)param_2[0xb], (Variant**)param_2[0xc], (int)param_4, in_R8, in_R9);
   *(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   LAB_00112f66:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* void call_with_variant_args_dv<__UnexistingClass, int, Color const&>(__UnexistingClass*, void
   ...
   if (uVar11 < 3) {
      ...
      iVar7 = 2 - uVar11;
      if (lVar2 == 0) {
         if (iVar7 != 0) goto LAB_001132b0;
         this(Variant * ) * plVar9;
         LAB_001132fd:this_00 = (Variant*)plVar9[1];
      }
 else {
         lVar3 = *(long*)( lVar2 + -8 );
         iVar12 = (int)lVar3;
         if (iVar12 < iVar7) {
            LAB_001132b0:uVar8 = 4;
            goto LAB_001132b5;
         }

         if (uVar11 == 0) {
            lVar10 = (long)( iVar12 + -2 );
            if (lVar3 <= lVar10) goto LAB_00113318;
            this(Variant * )(lVar2 + lVar10 * 0x18);
         }
 else {
            this(Variant * ) * plVar9;
            if (uVar11 == 2) goto LAB_001132fd;
         }

         lVar10 = (long)(int)( ( uVar11 ^ 1 ) + ( iVar12 - iVar7 ) );
         if (lVar3 <= lVar10) {
            LAB_00113318:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar10, lVar3, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar4 = (code*)invalidInstructionException();
            ( *pcVar4 )();
      ...
      *(undefined4*)param_6 = 0;
      ...
      uVar8 = 3;
      LAB_001132b5:*(undefined4*)param_6 = uVar8;
...
/* MethodBindT<int, Color const&>::call(Object*, Variant const**, int, Callable::CallError&) const
   ...
   *(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   LAB_001133b6:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* void call_with_variant_args_dv<__UnexistingClass, int, float>(__UnexistingClass*, void
   ...
   if (lVar1 == 0) {
      if (iVar6 == 0) {
         this(Variant * ) * plVar8;
         LAB_0011372d:this_00 = (Variant*)plVar8[1];
         goto LAB_00113655;
      }
      ...
      if (iVar6 <= iVar11) {
         if (uVar10 == 0) {
            lVar9 = (long)( iVar11 + -2 );
            if (lVar2 <= lVar9) goto LAB_00113748;
            this(Variant * )(lVar1 + lVar9 * 0x18);
         }
 else {
            this(Variant * ) * plVar8;
            if (uVar10 == 2) goto LAB_0011372d;
         }

         lVar9 = (long)(int)( ( uVar10 ^ 1 ) + ( iVar11 - iVar6 ) );
         if (lVar2 <= lVar9) {
            LAB_00113748:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar9, lVar2, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar3 = (code*)invalidInstructionException();
            ( *pcVar3 )();
         ...
         LAB_00113655:*(undefined4*)param_6 = 0;
         if (( (ulong)param_2 & 1 ) != 0) {
         ...
         /* WARNING: Could not recover jumptable at 0x001136df. Too many branches */
         /* WARNING: Treating indirect jump as call */
   ...
   uVar7 = 4;
   LAB_001136f5:*(undefined4*)param_6 = uVar7;
   *(undefined4*)( param_6 + 8 ) = 2;
   return;
}
/* MethodBindT<int, float>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<int,float>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   call_with_variant_args_dv<__UnexistingClass,int,float>(p_Var3, (_func_void_int_float*)param_2[0xb], (Variant**)param_2[0xc], (int)param_4, in_R8, in_R9);
   *(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   LAB_001137e6:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* void call_with_variant_args_dv<__UnexistingClass, int>(__UnexistingClass*, void
   ...
   lVar1 = *(long*)( in_stack_00000008 + 8 );
   if (lVar1 == 0) {
      if (uVar8 != 1) goto LAB_00113b30;
   }
 else {
      lVar2 = *(long*)( lVar1 + -8 );
      if ((int)lVar2 < (int)( uVar8 ^ 1 )) {
         LAB_00113b30:uVar6 = 4;
         LAB_00113acd:*(undefined4*)param_6 = uVar6;
         *(undefined4*)( param_6 + 8 ) = 1;
         return;
      }
   ...
   this * (Variant**)CONCAT44(in_register_0000000c, param_4);
   LAB_00113a4b:*(undefined4*)param_6 = 0;
   if (( (ulong)param_2 & 1 ) != 0) {
   ...
   Variant::operator_cast_to_int(this);
   /* WARNING: Could not recover jumptable at 0x00113aa6. Too many branches */
   /* WARNING: Treating indirect jump as call */
...
/* MethodBindT<int>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<int>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   *(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   LAB_00113b96:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* void call_with_variant_args_dv<__UnexistingClass, float, Color const&>(__UnexistingClass*, void
   ...
   Vector<Variant> const&) */void call_with_variant_args_dv<__UnexistingClass,float,Color_const&>(__UnexistingClass *param_1, _func_void_float_Color_ptr *param_2, Variant **param_3, int param_4, CallError *param_5, Vector *param_6) {
   long lVar1;
   long lVar2;
   long lVar3;
   code *pcVar4;
   ...
   if (uVar11 < 3) {
      ...
      iVar7 = 2 - uVar11;
      if (lVar2 == 0) {
         if (iVar7 != 0) goto LAB_00113ed8;
         this(Variant * ) * plVar9;
         LAB_00113f2d:this_00 = (Variant*)plVar9[1];
      }
 else {
         lVar3 = *(long*)( lVar2 + -8 );
         iVar12 = (int)lVar3;
         if (iVar12 < iVar7) {
            LAB_00113ed8:uVar8 = 4;
            goto LAB_00113edd;
         }

         if (uVar11 == 0) {
            lVar10 = (long)( iVar12 + -2 );
            if (lVar3 <= lVar10) goto LAB_00113f48;
            this(Variant * )(lVar2 + lVar10 * 0x18);
         }
 else {
            this(Variant * ) * plVar9;
            if (uVar11 == 2) goto LAB_00113f2d;
         }

         lVar10 = (long)(int)( ( uVar11 ^ 1 ) + ( iVar12 - iVar7 ) );
         if (lVar3 <= lVar10) {
            LAB_00113f48:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar10, lVar3, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar4 = (code*)invalidInstructionException();
            ( *pcVar4 )();
      ...
      *(undefined4*)param_6 = 0;
      ...
      uVar8 = 3;
      LAB_00113edd:*(undefined4*)param_6 = uVar8;
      *(undefined4*)( param_6 + 8 ) = 2;
   }
...
/* MethodBindT<float, Color const&>::call(Object*, Variant const**, int, Callable::CallError&) const
    */Object *MethodBindT<float,Color_const&>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   long lVar1;
   char *pcVar2;
   long *plVar3;
   undefined4 in_register_00000014;
   ...
   call_with_variant_args_dv<__UnexistingClass,float,Color_const&>(p_Var4, (_func_void_float_Color_ptr*)param_2[0xb], (Variant**)param_2[0xc], (int)param_4, in_R8, in_R9);
   *(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   LAB_00113fe6:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* void call_get_argument_type_info_helper<int>(int, int&, PropertyInfo&) */void call_get_argument_type_info_helper<int>(int param_1, int *param_2, PropertyInfo *param_3) {
   ...
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   iVar5 = *param_2;
   if (iVar5 != param_1) goto LAB_00114227;
   local_78 = 0;
   local_68 = &_LC6;
   local_80 = 0;
   auVar1._8_8_ = 0;
   ...
   local_60 = (undefined1[16])0x0;
   if (local_80 == 0) {
      LAB_00114325:local_40 = 6;
      StringName::operator =((StringName*)( local_60 + 8 ), (StringName*)&local_78);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_48, (CowData*)&local_80);
      local_40 = 6;
      if (local_50 != 0x11) goto LAB_00114325;
      StringName::StringName((StringName*)&local_70, (String*)&local_48, false);
      if (local_60._8_8_ == local_70) {
         if (( StringName::configured != '\0' ) && ( local_70 != 0 )) {
            StringName::unref();
...
/* MethodBindTR<float, int>::_gen_argument_type_info(int) const */undefined4 *MethodBindTR<float,int>::_gen_argument_type_info(int param_1) {
   undefined1 auVar1[16];
   undefined1 auVar2[16];
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   *(undefined1(*) [16])( puVar5 + 2 ) = (undefined1[16])0x0;
   if (local_78 == 0) {
      puVar5[10] = 6;
      LAB_001145df:StringName::operator =((StringName*)( puVar5 + 4 ), (StringName*)&local_70);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)( puVar5 + 8 ), (CowData*)&local_78);
      puVar5[10] = 6;
      if (puVar5[6] != 0x11) goto LAB_001145df;
   ...
   LAB_001144f8:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar5;
   }
...
/* MethodBindTR<Color, int>::_gen_argument_type_info(int) const */undefined4 *MethodBindTR<Color,int>::_gen_argument_type_info(int param_1) {
   undefined1 auVar1[16];
   undefined1 auVar2[16];
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   *(undefined1(*) [16])( puVar5 + 2 ) = (undefined1[16])0x0;
   if (local_78 == 0) {
      puVar5[10] = 6;
      LAB_001147df:StringName::operator =((StringName*)( puVar5 + 4 ), (StringName*)&local_70);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)( puVar5 + 8 ), (CowData*)&local_78);
      puVar5[10] = 6;
      if (puVar5[6] != 0x11) goto LAB_001147df;
      StringName::StringName((StringName*)&local_68, (String*)( puVar5 + 8 ), false);
      if (*(undefined**)( puVar5 + 4 ) == local_68) {
         if (( StringName::configured != '\0' ) && ( local_68 != (undefined*)0x0 )) {
            StringName::unref();
   ...
   LAB_001146f8:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar5;
   }
...
/* void call_get_argument_type_info_helper<Color const&>(int, int&, PropertyInfo&) */void call_get_argument_type_info_helper<Color_const&>(int param_1, int *param_2, PropertyInfo *param_3) {
   ...
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   iVar5 = *param_2;
   if (iVar5 != param_1) goto LAB_00114877;
   local_78 = 0;
   local_68 = &_LC6;
   local_80 = 0;
   auVar1._8_8_ = 0;
   ...
   local_60 = (undefined1[16])0x0;
   if (local_80 == 0) {
      LAB_00114975:local_40 = 6;
      StringName::operator =((StringName*)( local_60 + 8 ), (StringName*)&local_78);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_48, (CowData*)&local_80);
      local_40 = 6;
      if (local_50 != 0x11) goto LAB_00114975;
      StringName::StringName((StringName*)&local_70, (String*)&local_48, false);
      if (local_60._8_8_ == local_70) {
         if (( StringName::configured != '\0' ) && ( local_70 != 0 )) {
            StringName::unref();
...
/* MethodBindT<float, Color const&>::_gen_argument_type_info(int) const */PropertyInfo *MethodBindT<float,Color_const&>::_gen_argument_type_info(int param_1) {
   undefined1 auVar1[16];
   undefined1 auVar2[16];
   undefined8 uVar3;
   long lVar4;
   ...
   *(undefined1(*) [16])( pPVar5 + 8 ) = (undefined1[16])0x0;
   ...
   local_60 = (undefined1[16])0x0;
   if (local_80 == 0) {
      LAB_00114c05:local_40 = 6;
      StringName::operator =((StringName*)( local_60 + 8 ), (StringName*)&local_78);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_48, (CowData*)&local_80);
      local_40 = 6;
      if (local_50 != 0x11) goto LAB_00114c05;
      StringName::StringName((StringName*)&local_70, (String*)&local_48, false);
      if (local_60._8_8_ == local_70) {
         if (( StringName::configured != '\0' ) && ( local_70 != 0 )) {
            StringName::unref();
...
/* MethodBindT<int, Color const&>::_gen_argument_type_info(int) const */PropertyInfo *MethodBindT<int,Color_const&>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( pPVar5 + 8 ) = (undefined1[16])0x0;
   ...
   local_60 = (undefined1[16])0x0;
   if (local_80 == 0) {
      LAB_00114e95:local_40 = 6;
      StringName::operator =((StringName*)( local_60 + 8 ), (StringName*)&local_78);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_48, (CowData*)&local_80);
      local_40 = 6;
      if (local_50 != 0x11) goto LAB_00114e95;
      StringName::StringName((StringName*)&local_70, (String*)&local_48, false);
      if (local_60._8_8_ == local_70) {
         if (( StringName::configured != '\0' ) && ( local_70 != 0 )) {
            StringName::unref();
...
/* WARNING: Control flow encountered bad instruction data *//* MethodBindTR<Gradient::ColorSpace>::~MethodBindTR() */void MethodBindTR<Gradient::ColorSpace>::~MethodBindTR(MethodBindTR<Gradient::ColorSpace> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* MethodBindT<Gradient::ColorSpace>::~MethodBindT() */void MethodBindT<Gradient::ColorSpace>::~MethodBindT(MethodBindT<Gradient::ColorSpace> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* MethodBindTR<Gradient::InterpolationMode>::~MethodBindTR() */void MethodBindTR<Gradient::InterpolationMode>::~MethodBindTR(MethodBindTR<Gradient::InterpolationMode> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* MethodBindT<Gradient::InterpolationMode>::~MethodBindT() */void MethodBindT<Gradient::InterpolationMode>::~MethodBindT(MethodBindT<Gradient::InterpolationMode> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* MethodBindTR<Color, float>::~MethodBindTR() */void MethodBindTR<Color,float>::~MethodBindTR(MethodBindTR<Color,float> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* MethodBindTR<float, int>::~MethodBindTR() */void MethodBindTR<float,int>::~MethodBindTR(MethodBindTR<float,int> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* MethodBindT<float, Color const&>::~MethodBindT() */void MethodBindT<float,Color_const&>::~MethodBindT(MethodBindT<float,Color_const&> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

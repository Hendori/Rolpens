/* icu_76_godot::ICU_Utility::appendNumber(icu_76_godot::UnicodeString&, int, int, int) */UnicodeString *icu_76_godot::ICU_Utility::appendNumber(UnicodeString *param_1, int param_2, int param_3, int param_4) {
   ulong uVar1;
   ulong uVar2;
   int iVar3;
   ulong uVar4;
   ...
   if (0x22 < param_3 - 2U) {
      local_42 = 0x3f;
      param_1 = (UnicodeString*)icu_76_godot::UnicodeString::doAppend((wchar16*)param_1, (int)&local_42, 0);
      goto LAB_001000ed;
   }
 ...
 while ( iVar3 != 0 );
   LAB_001000ed:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
...
/* icu_76_godot::ICU_Utility::isUnprintable(int) */bool icu_76_godot::ICU_Utility::isUnprintable(int param_1) {
   return 0x5e < param_1 - 0x20U;
}
/* icu_76_godot::ICU_Utility::shouldAlwaysBeEscaped(int) */uint icu_76_godot::ICU_Utility::shouldAlwaysBeEscaped(int param_1) {
   uint uVar1;
   undefined4 in_EDX;
   uVar1 = 1;
   if (( ( ( 0x1f < param_1 ) && ( uVar1 = 0 ),0x7e < param_1 ) ) && ( uVar1 = 0x9f < param_1 )) {
      if (( 0x1f < param_1 - 0xfdd0U ) && ( 0xdfff < param_1 )) {
         return CONCAT31(( int3 )((uint)~param_1 >> 8), ( ~param_1 & 0xfffeU ) != 0) & CONCAT31(( int3 )((uint)in_EDX >> 8), param_1 < 0x110000) ^ 1;
      }
...
/* icu_76_godot::ICU_Utility::escape(icu_76_godot::UnicodeString&, int) */UnicodeString *icu_76_godot::ICU_Utility::escape(UnicodeString *param_1, int param_2) {
   int iVar1;
   long in_FS_OFFSET;
   undefined2 local_32;
   long local_30;
   ...
   if ((uint)param_2 < 0x10000) {
      ...
      icu_76_godot::UnicodeString::doAppend((wchar16*)param_1, iVar1, 0);
      for (int i = 0; i < 3; i++) {
         local_32 = *(undefined2*)( DIGITS + ( ulong )(param_2 >> ( -4*i + 24 ) & 15) * 2 );
         icu_76_godot::UnicodeString::doAppend((wchar16*)param_1, iVar1, 0);
      }
   ...
   for (int i = 0; i < 3; i++) {
      local_32 = *(undefined2*)( DIGITS + ( ulong )(param_2 >> ( -4*i + 12 ) & 15) * 2 );
      icu_76_godot::UnicodeString::doAppend((wchar16*)param_1, iVar1, 0);
   }
...
/* icu_76_godot::ICU_Utility::escapeUnprintable(icu_76_godot::UnicodeString&, int) */undefined8 icu_76_godot::ICU_Utility::escapeUnprintable(UnicodeString *param_1, int param_2) {
...
/* icu_76_godot::ICU_Utility::skipWhitespace(icu_76_godot::UnicodeString const&, int&, signed char)
   ...
   lVar2 = icu_76_godot::PatternProps::skipWhiteSpace((wchar16*)( lVar5 + (long)*param_2 * 2 ), iVar4 - *param_2);
   uVar3 = lVar2 - lVar5 >> 1;
   if (param_3 != '\0') {
      *param_2 = (int)uVar3;
   }
...
/* icu_76_godot::ICU_Utility::parseChar(icu_76_godot::UnicodeString const&, int&, char16_t) */undefined8 icu_76_godot::ICU_Utility::parseChar(UnicodeString *param_1, int *param_2, wchar16 param_3) {
   ushort uVar1;
   uint uVar2;
   uint uVar3;
...
/* icu_76_godot::ICU_Utility::parsePattern(icu_76_godot::UnicodeString const&,
   icu_76_godot::Replaceable const&, int, int) */int icu_76_godot::ICU_Utility::parsePattern(UnicodeString *param_1, Replaceable *param_2, int param_3, int param_4) {
   char cVar1;
   short sVar2;
   int iVar3;
   uint uVar4;
         ...
         do {
            while (uVar6 = ( **(code**)( *(long*)param_2 + 0x50 ) )(param_2, param_3),uVar4 != 0x7e) {
               ...
               if (sVar2 < 0) {
                  ...
                  LAB_001005bd:iVar5 = (int)( sVar2 >> 5 );
               }

               LAB_001005c2:if (iVar3 == iVar5) {
                  return param_3;
               }
...
;
 ...
 while ( param_3 < param_4 );
      ...
      LAB_00100658:param_3 = -1;
   }

   return param_3;
}
/* icu_76_godot::ICU_Utility::parseAsciiInteger(icu_76_godot::UnicodeString const&, int&) */int icu_76_godot::ICU_Utility::parseAsciiInteger(UnicodeString *param_1, int *param_2) {
   ushort uVar1;
   uint uVar2;
   uint uVar3;
   UnicodeString *pUVar4;
...
/* icu_76_godot::ICU_Utility::appendToRule(icu_76_godot::UnicodeString&, int, signed char, signed
   char, icu_76_godot::UnicodeString&) */void icu_76_godot::ICU_Utility::appendToRule(UnicodeString *param_1, uint param_2, char param_3, char param_4, UnicodeString *param_5) {
   ushort uVar1;
   char cVar2;
   wchar16 *pwVar3;
   UnicodeString *pUVar4;
 ...
 while ( true );
   ...
   if ((short)*(ushort*)( param_5 + 8 ) < 0) {
      ...
      LAB_00100745:if (param_2 - 0x21 < 0x5e) {
         if (( ( 0x19 < ( param_2 & 0xffffffdf ) - 0x41 ) && ( 9 < param_2 - 0x30 ) ) || ( cVar2 = icu_76_godot::PatternProps::isWhiteSpace(param_2) ),cVar2 != '\0') goto LAB_00100773;
      }
 else {
      ...
      LAB_00100805:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) goto LAB_0010081f;
      goto LAB_00100c62;
   }

   if (*(ushort*)( param_5 + 8 ) >> 5 == 0) {
      LAB_00100731:if (( param_2 != 0x27 ) && ( param_2 != 0x5c )) goto LAB_00100745;
      local_42 = 0x5c;
      icu_76_godot::UnicodeString::doAppend((wchar16*)param_1, (int)&local_42, 0);
      goto LAB_00100805;
   }

   LAB_00100773:icu_76_godot::UnicodeString::append(iVar9);
   if (param_2 == 0x27) {
      param_1 = param_5;
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) goto LAB_0010081f;
      goto LAB_00100c62;
   ...
   goto LAB_00100788;
   code_r0x001009e0:iVar10 = iVar10 + 1;
   uVar8 = uVar8 & 0x1f | uVar6 * 0x20;
   *(short*)( param_5 + 8 ) = (short)uVar8;
   LAB_001008e0:sVar5 = (short)uVar8 >> 5;
   uVar7 = (uint)sVar5;
   if (sVar5 < 2) goto LAB_00100952;
   goto LAB_001008ef;
   LAB_001008d0:iVar10 = 0;
   LAB_00100945:if (-1 < (short)uVar8) goto LAB_001008e0;
   uVar7 = *(uint*)( param_5 + 0xc );
   if (1 < (int)uVar7) {
      LAB_001008ef:if (1 < uVar7) {
         do {
            uVar6 = uVar7 - 2;
            pUVar4 = param_5 + 10;
            if (( uVar8 & 2 ) == 0) {
            ...
            if (( ( *(short*)( pUVar4 + (long)(int)uVar6 * 2 ) != 0x27 ) || ( uVar7 == 0 ) ) || ( *(short*)( pUVar4 + (long)(int)( uVar7 - 1 ) * 2 ) != 0x27 )) break;
            if (( uVar6 == 0 ) && ( ( uVar8 & 1 ) != 0 )) {
               icu_76_godot::UnicodeString::unBogus();
               uVar8 = ( uint ) * (ushort*)( param_5 + 8 );
               LAB_00100941:iVar10 = iVar10 + 1;
               goto LAB_00100945;
            }
 ...
 while ( true );
   ...
   LAB_00100952:if (uVar7 == 1) {
      LAB_00100a18:local_42 = 0x27;
      icu_76_godot::UnicodeString::doAppend((wchar16*)param_1, (int)&local_42, 0);
 ...
 while ( iVar10 != 0 );
   ...
   joined_r0x001009b1:if (param_2 != 0xffffffff) {
      if (param_2 != 0x20) {
      ...
      if ((short)uVar1 < 0) {
         ...
         if ((short)uVar1 >> 5 != 0) {
            ...
            if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
               LAB_0010081f:icu_76_godot::UnicodeString::append((int)param_1);
               return;
            }
   ...
   LAB_00100788:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

   LAB_00100c62:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* icu_76_godot::ICU_Utility::appendToRule(icu_76_godot::UnicodeString&, icu_76_godot::UnicodeString
   const&, signed char, signed char, icu_76_godot::UnicodeString&) */void icu_76_godot::ICU_Utility::appendToRule(undefined8 param_1, long param_2, char param_3, char param_4, undefined8 param_5) {
   ushort uVar1;
   uint uVar2;
   long lVar3;
   long lVar4;
...
/* icu_76_godot::ICU_Utility::appendToRule(icu_76_godot::UnicodeString&,
   icu_76_godot::UnicodeMatcher const*, signed char, icu_76_godot::UnicodeString&) */void icu_76_godot::ICU_Utility::appendToRule(undefined8 param_1, long *param_2, char param_3, undefined8 param_4) {
   undefined8 uVar1;
   long in_FS_OFFSET;
   undefined8 local_78;
   undefined2 local_70;

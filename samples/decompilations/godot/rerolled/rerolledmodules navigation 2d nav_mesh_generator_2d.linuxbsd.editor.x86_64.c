/* HashSet<Ref<NavigationPolygon>, HashMapHasherDefault,
   ...
   unsigned int&) const [clone .isra.0] */undefined8 HashSet<Ref<NavigationPolygon>,HashMapHasherDefault,HashMapComparatorDefault<Ref<NavigationPolygon>>>::_lookup_pos(HashSet<Ref<NavigationPolygon>,HashMapHasherDefault,HashMapComparatorDefault<Ref<NavigationPolygon>>> *this, Ref *param_1, uint *param_2) {
   long lVar1;
...
/* double Clipper2Lib::Area<double>(std::vector<Clipper2Lib::Point<double>,
   std::allocator<Clipper2Lib::Point<double> > > const&) [clone .isra.0] */double Clipper2Lib::Area<double>(Clipper2Lib *this, vector *param_1) {
   ulong uVar1;
   vector *pvVar2;
   vector *pvVar3;
   double dVar4;
 ...
 while ( this != (Clipper2Lib*)pvVar2 );
   ...
   dVar6 = *(double*)this;
   LAB_001001e9:return _LC1 * ( ( dVar5 + dVar4 ) * ( dVar7 - dVar6 ) + dVar8 );
}
/* generator_recursive_process_polytree_items(List<TPPLPoly, DefaultAllocator>&,
   Clipper2Lib::PolyPathD const*) */void generator_recursive_process_polytree_items(List *param_1, PolyPathD *param_2) {
   double *pdVar1;
   long *plVar2;
   double *pdVar3;
   long lVar4;
   ...
   *(int*)( plVar2 + 2 ) = (int)plVar2[2] + 1;
   ...
   while (uVar9 < ( ulong )(*(long*)( param_2 + 0x18 ) - *(long*)( param_2 + 0x10 ) >> 3)) {
      while (true) {
         lVar4 = uVar9 * 8;
         uVar9 = uVar9 + 1;
         generator_recursive_process_polytree_items(param_1, *(PolyPathD**)( *(long*)( param_2 + 0x10 ) + lVar4 ));
         pcVar5 = *(code**)( *(long*)param_2 + 0x20 );
         if (pcVar5 == Clipper2Lib::PolyPathD::Count) break;
         LAB_001003b0:uVar6 = ( *pcVar5 )(param_2);
         if (uVar6 <= uVar9) goto LAB_001003ba;
      }
;
   }
;
   LAB_001003ba:TPPLPoly::~TPPLPoly((TPPLPoly*)local_48);
...
/* Clipper2Lib::Point<double>& std::vector<Clipper2Lib::Point<double>,
   ...
   const&, float const&) [clone .isra.0] */Point * __thiscallstd::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>::emplace_back<float_const&,float_const&>(vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>> * this, float, *param_1, float, *param_2)(*pauVar1)[16] ;undefined1 auVar2[16]undefined1 auVar3[16]undefined1 auVar4[16]undefined8 uVar5void *pvVar6Point *in_RAXulong uVar7Point *pPVar8Point *pPVar9Point *extraout_RAXundefined1(*pauVar10)[16];undefined1(*pauVar11)[16];Point *pPVar12ulong uVar13Point *pPVar14Point *pPVar15undefined1(*pauVar16)[16];pauVar11 = *(undefined1(**) [16])( this + 8 );pauVar10 = *(undefined1(**) [16])( this + 0x10 );if (pauVar11 != pauVar10) {
...
pauVar1 = *(undefined1(**) [16])this;pauVar16 = (undefined1(*) [16])( (long)pauVar11 - (long)pauVar1 );uVar7 = (long)pauVar16 >> 4;if (uVar7 == 0x7ffffffffffffff) {
   /* WARNING: Subroutine does not return */
...
if (pauVar11 == pauVar1) {
   ...
   uVar13 = uVar13 << 4;
   LAB_0010056e:pPVar9 = (Point*)operator_new(uVar13);
   ...
   *(undefined1(*) [16])( pPVar9 + (long)pauVar16 ) = auVar4;
   ...
   uVar13 = uVar7 * 2;
   if (uVar13 < uVar7) {
      LAB_001005c0:uVar13 = 0x7ffffffffffffff0;
      goto LAB_0010056e;
   }
...
pPVar12 = pPVar15 + ( (long)pauVar11 - (long)pauVar1 );pPVar8 = pPVar15;pauVar11 = pauVar1;do {
 ...
 while ( pPVar12 != pPVar9 );LAB_00100519:if (pauVar1 != (undefined1(*) [16])0x0) {
   operator_delete(pauVar1, (long)pauVar10 - (long)pauVar1);
   pPVar9 = extraout_RAX;
}
*(Point**)this = pPVar15;*(Point**)( this + 8 ) = pPVar12 + 0x10;*(Point**)( this + 0x10 ) = pPVar14;return pPVar9;}/* std::vector<Clipper2Lib::Point<double>, std::allocator<Clipper2Lib::Point<double> > >&
...
if (puVar1 == puVar2) {
   ...
   uVar13 = uVar13 * 0x18;
   LAB_0010075f:pvVar9 = (vector*)operator_new(uVar13);
   ...
   *(undefined8*)( pvVar15 + 8 ) = uVar6;
   ...
   if (uVar4 < uVar7) {
      LAB_001007b0:uVar13 = 0x7ffffffffffffff8;
      goto LAB_0010075f;
   }
...
do {
 ...
 while ( puVar1 != puVar10 );pvVar8 = pvVar15 + ( (long)puVar1 + ( -0x18 - (long)puVar2 ) & 0xfffffffffffffff8U ) + 0x30;LAB_0010070d:if (puVar2 != (undefined8*)0x0) {
   operator_delete(puVar2, (long)puVar11 - (long)puVar2);
   pvVar9 = extraout_RAX;
}
*(vector**)this = pvVar15;*(vector**)( this + 8 ) = pvVar8;*(vector**)( this + 0x10 ) = pvVar12;return pvVar9;}/* std::vector<std::vector<Clipper2Lib::Point<double>, std::allocator<Clipper2Lib::Point<double> >
   >, std::allocator<std::vector<Clipper2Lib::Point<double>,
   std::allocator<Clipper2Lib::Point<double> > > >
   ...
   > > > >&&, std::integral_constant<bool, true>) [clone .isra.0] */void std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::_M_move_assign(undefined8 *param_1, undefined1 (*param_2)[16]) {
   undefined8 *puVar1;
   undefined8 *puVar2;
   long lVar3;
   void *pvVar4;
...
/* Ref<NavigationPolygon>::TEMPNAMEPLACEHOLDERVALUE(Ref<NavigationPolygon> const&) [clone .isra.0]
    */void Ref<NavigationPolygon>::operator =(Ref<NavigationPolygon> *this, Ref *param_1) {
   Object *pOVar1;
   char cVar2;
   pOVar1 = *(Object**)this;
...
/* NavMeshGenerator2D::get_singleton() */undefined8 NavMeshGenerator2D::get_singleton(void) {
   return singleton;
}
/* NavMeshGenerator2D::NavMeshGenerator2D() */void NavMeshGenerator2D::NavMeshGenerator2D(NavMeshGenerator2D *this) {
   long in_FS_OFFSET;
   bool bVar1;
   long local_50;
   int local_48[6];
   ...
   *(undefined***)this = &PTR__initialize_classv_0010e6c8;
   if (bVar1) {
      ...
      StringName::StringName((StringName*)&local_50, "navigation/baking/thread_model/baking_use_multiple_threads", false);
      ...
      ProjectSettings::get_singleton();
      StringName::StringName((StringName*)&local_50, "navigation/baking/thread_model/baking_use_high_priority_threads", false);
      ProjectSettings::get_setting_with_override((StringName*)local_48);
      ...
      _err_print_error("NavMeshGenerator2D", "modules/navigation/2d/nav_mesh_generator_2d.cpp", 0x3a, "Condition \"singleton != nullptr\" is true.", 0, 0);
      return;
   }
...
/* NavMeshGenerator2D::is_baking(Ref<NavigationPolygon>) */undefined8 NavMeshGenerator2D::is_baking(long *param_1) {
   long lVar1;
   undefined1 auVar2[16];
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   if (( baking_navmeshes != 0 ) && ( DAT_00105224 != 0 )) {
      ...
      if (uVar13 != 0) {
         uVar15 = 0;
         do {
            if (( uVar13 == (uint)uVar16 ) && ( *param_1 == *(long*)( baking_navmeshes + ( ulong ) * (uint*)( DAT_00105208 + lVar12 * 4 ) * 8 ) )) {
               uVar17 = 1;
               goto LAB_00100c7d;
            }
 ...
 while ( ( uVar13 != 0 ) && ( auVar4._8_8_ = 0 ),auVar4._0_8_ = (ulong)uVar13 * lVar1,auVar8._8_8_ = 0,auVar8._0_8_ = uVar14,auVar5._8_8_ = 0,auVar5._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + (ulong)DAT_00105220 * 4 ) + iVar10 ) - SUB164(auVar4 * auVar8, 8)) * lVar1,auVar9._8_8_ = 0,auVar9._0_8_ = uVar14,uVar15 <= SUB164(auVar5 * auVar9, 8) );
         uVar17 = 0;
      }

   }

   LAB_00100c7d:pthread_mutex_unlock((pthread_mutex_t*)baking_navmesh_mutex);
   return uVar17;
}
/* NavMeshGenerator2D::set_generator_parsers(LocalVector<NavMeshGeometryParser2D*, unsigned int,
   false, false>) */void NavMeshGenerator2D::set_generator_parsers(uint *param_1) {
   uint uVar1;
   long lVar2;
   code *pcVar3;
   void *pvVar4;
   ...
   uVar7 = uVar1;
   uVar5 = uVar1;
   if (( generator_parsers <= uVar1 ) && ( uVar5 = generator_parsers < uVar1 )) {
...
/* NavMeshGenerator2D::generator_emit_callback(Callable const&) */undefined4 NavMeshGenerator2D::generator_emit_callback(Callable *param_1) {
   char cVar1;
   undefined4 uVar2;
   long in_FS_OFFSET;
   int local_38[2];
   ...
   if (cVar1 == '\0') {
      _err_print_error("generator_emit_callback", "modules/navigation/2d/nav_mesh_generator_2d.cpp", 0x127, "Condition \"!p_callback.is_valid()\" is true. Returning: false", 0, 0);
      uVar2 = 0;
   }
 else {
...
/* Ref<NavigationMeshSourceGeometryData2D>::TEMPNAMEPLACEHOLDERVALUE(Ref<NavigationMeshSourceGeometryData2D>
   const&) [clone .isra.0] */void Ref<NavigationMeshSourceGeometryData2D>::operator =(Ref<NavigationMeshSourceGeometryData2D> *this, Ref *param_1) {
   long *plVar1;
   Object *this_00;
   long lVar2;
   long lVar3;
      ...
      *(Ref**)this = param_1;
      ...
      if (this_00 != (Object*)0x0) {
         ...
         if (cVar6 != '\0') {
            ...
            if (cVar6 != '\0') {
               if (*(code**)( *(long*)this_00 + 0x140 ) == NavigationMeshSourceGeometryData2D::~NavigationMeshSourceGeometryData2D) {
...
/* NavMeshGenerator2D::cleanup() */void NavMeshGenerator2D::cleanup(void) {
   long *plVar1;
   long *plVar2;
   uint uVar3;
   Object *pOVar4;
   ...
   bool bVar15;
   iVar10 = pthread_mutex_lock((pthread_mutex_t*)baking_navmesh_mutex);
   if (( iVar10 != 0 ) || ( iVar10 = pthread_mutex_lock((pthread_mutex_t*)generator_task_mutex) ),lVar14 = baking_navmeshes,iVar10 != 0) {
      /* WARNING: Subroutine does not return */
      std::__throw_system_error(iVar10);
   }

   if (( baking_navmeshes != 0 ) && ( DAT_00105224 != 0 )) {
      if (( *(uint*)( hash_table_size_primes + (ulong)DAT_00105220 * 4 ) == 0 ) || ( memset(DAT_00105218, 0, ( ulong ) * (uint*)( hash_table_size_primes + (ulong)DAT_00105220 * 4 ) * 4),DAT_00105224 != 0 )) {
         lVar13 = 0;
         do {
            plVar2 = (long*)( lVar14 + lVar13 * 8 );
            if (( *plVar2 == 0 ) || ( cVar9 = cVar9 == '\0' )) {
               LAB_00101530:if (DAT_00105224 <= (int)lVar13 + 1U) break;
            }
 else {
 ...
 while ( true );
   ...
   for (puVar5 = (undefined8*)generator_tasks._24_8_; puVar5 != (undefined8*)0x0; puVar5 = (undefined8*)*puVar5) {
      ...
      if (( plVar2[1] != 0 ) && ( cVar9 = cVar9 != '\0' )) {
         pOVar4 = (Object*)plVar2[1];
         cVar9 = predelete_handler(pOVar4);
         if (cVar9 != '\0') {
            if (*(code**)( *(long*)pOVar4 + 0x140 ) == NavigationMeshSourceGeometryData2D::~NavigationMeshSourceGeometryData2D) {
         ...
         if (cVar9 != '\0') {
            if (*(code**)( *(long*)pOVar4 + 0x140 ) == NavigationPolygon::~NavigationPolygon) {
               ...
               *(undefined***)pOVar4 = &PTR__initialize_classv_0010e498;
               ...
               if (( *(long*)( pOVar4 + 0x2f8 ) != 0 ) && ( cVar9 = cVar9 != '\0' )) {
...
/* NavMeshGenerator2D::finish() */void NavMeshGenerator2D::finish(void) {
   cleanup();
   return;
}
/* HashSet<Ref<NavigationPolygon>, HashMapHasherDefault,
   HashMapComparatorDefault<Ref<NavigationPolygon> > >::erase(Ref<NavigationPolygon> const&) [clone
   .isra.0] */void HashSet<Ref<NavigationPolygon>,HashMapHasherDefault,HashMapComparatorDefault<Ref<NavigationPolygon>>>::erase(HashSet<Ref<NavigationPolygon>,HashMapHasherDefault,HashMapComparatorDefault<Ref<NavigationPolygon>>> *this, Ref *param_1) {
   uint *puVar1;
   undefined4 *puVar2;
   undefined4 *puVar3;
   ...
   if (cVar22 != '\0') {
      ...
      if (( *puVar32 == 0 ) || ( auVar10._8_8_ = 0 ),auVar10._0_8_ = ( ulong ) * puVar32 * lVar7,auVar16._8_8_ = 0,auVar16._0_8_ = uVar28,auVar11._8_8_ = 0,auVar11._0_8_ = ( ulong )(( uVar23 + uVar26 ) - SUB164(auVar10 * auVar16, 8)) * lVar7,auVar17._8_8_ = 0,auVar17._0_8_ = uVar28,SUB164(auVar11 * auVar17, 8) == 0) {
         ...
         while (true) {
            ...
            *puVar1 = uVar26;
            ...
            lVar24 = uVar27 * 4;
            puVar32 = (uint*)( lVar6 + lVar24 );
            if (( *puVar32 == 0 ) || ( auVar12._8_8_ = 0 ),auVar12._0_8_ = ( ulong ) * puVar32 * lVar7,auVar18._8_8_ = 0,auVar18._0_8_ = uVar28,auVar13._8_8_ = 0,auVar13._0_8_ = ( ulong )(( SUB164(auVar14 * auVar20, 8) + uVar23 ) - SUB164(auVar12 * auVar18, 8)) * lVar7,auVar19._8_8_ = 0,auVar19._0_8_ = uVar28,SUB164(auVar13 * auVar19, 8) == 0) break;
            uVar30 = uVar33;
      ...
      *(undefined4*)( lVar6 + uVar33 * 4 ) = 0;
      ...
      if (uVar21 < uVar23) {
         ...
         *(undefined8*)this_00 = 0;
         ...
         Ref<NavigationPolygon>::unref((Ref<NavigationPolygon>*)( *(long*)this + ( ulong ) * (uint*)( this + 0x24 ) * 8 ));
         lVar24 = *(long*)( this + 0x10 );
         *(undefined4*)( lVar24 + uVar34 * 4 ) = *(undefined4*)( lVar24 + ( ulong ) * (uint*)( this + 0x24 ) * 4 );
...
/* NavMeshGenerator2D::sync() */void NavMeshGenerator2D::sync(void) {
   uint *puVar1;
   undefined8 *puVar2;
   undefined8 *puVar3;
   long *plVar4;
   ...
   if (generator_tasks._24_8_ != 0) {
      do {
         while (cVar28 = WorkerThreadPool::is_task_completed(WorkerThreadPool::singleton),cVar28 == '\0') {
...
;
         ...
         HashSet<Ref<NavigationPolygon>,HashMapHasherDefault,HashMapComparatorDefault<Ref<NavigationPolygon>>>::erase((HashSet<Ref<NavigationPolygon>,HashMapHasherDefault,HashMapComparatorDefault<Ref<NavigationPolygon>>>*)&baking_navmeshes, pRVar5);
         ...
         if (( *(long*)( pRVar5 + 8 ) != 0 ) && ( cVar28 = cVar28 != '\0' )) {
            memdelete<NavigationMeshSourceGeometryData2D>(*(NavigationMeshSourceGeometryData2D**)( pRVar5 + 8 ));
         }

         if (( *(long*)pRVar5 != 0 ) && ( cVar28 = cVar28 != '\0' )) {
 ...
 while ( plVar43 != (long*)0x0 );
      LAB_00101d46:lVar44 = generator_tasks._8_8_;
      lVar27 = generator_tasks._16_8_;
      for (plVar43 = plVar31; generator_tasks._16_8_ = lVar27,plVar31 + uVar35 != plVar43; plVar43 = plVar43 + 1) {
         if (( lVar44 != 0 ) && ( generator_tasks._44_4_ != 0 )) {
            ...
            if (uVar34 != 0) {
               uVar40 = 0;
               LAB_00101e5c:auVar11._8_8_ = 0;
               auVar11._0_8_ = ( ulong )((int)uVar37 + 1) * lVar6;
               auVar20._8_8_ = 0;
               auVar20._0_8_ = uVar39;
               uVar33 = SUB168(auVar11 * auVar20, 8);
               uVar32 = SUB164(auVar11 * auVar20, 8);
               if (( (uint)uVar36 != uVar34 ) || ( *plVar43 != *(long*)( *(long*)( lVar44 + uVar30 * 8 ) + 0x10 ) )) goto LAB_00101e20;
               puVar42 = (uint*)( lVar27 + uVar33 * 4 );
               uVar34 = *puVar42;
               if (( uVar34 != 0 ) && ( auVar12._8_8_ = 0 ),auVar12._0_8_ = (ulong)uVar34 * lVar6,auVar21._8_8_ = 0,auVar21._0_8_ = uVar39,auVar13._8_8_ = 0,auVar13._0_8_ = ( ulong )(( uVar32 + uVar41 ) - SUB164(auVar12 * auVar21, 8)) * lVar6,auVar22._8_8_ = 0,auVar22._0_8_ = uVar39,uVar30 = (ulong)uVar32,uVar36 = uVar37,SUB164(auVar13 * auVar22, 8) != 0) {
                  while (true) {
                     uVar37 = uVar30;
                     ...
                     *puVar3 = uVar7;
                     ...
                     puVar42 = (uint*)( lVar27 + uVar33 * 4 );
                     uVar34 = *puVar42;
                     if (( uVar34 == 0 ) || ( auVar14._8_8_ = 0 ),auVar14._0_8_ = (ulong)uVar34 * lVar6,auVar23._8_8_ = 0,auVar23._0_8_ = uVar39,auVar15._8_8_ = 0,auVar15._0_8_ = ( ulong )(( SUB164(auVar16 * auVar25, 8) + uVar41 ) - SUB164(auVar14 * auVar23, 8)) * lVar6,auVar24._8_8_ = 0,auVar24._0_8_ = uVar39,SUB164(auVar15 * auVar24, 8) == 0) break;
...
;
         ...
         LAB_00101f9f:lVar27 = generator_tasks._16_8_;
      }
   ...
   pthread_mutex_unlock((pthread_mutex_t*)baking_navmesh_mutex);
   return;
   LAB_00101e20:uVar34 = *(uint*)( lVar27 + uVar33 * 4 );
   uVar37 = uVar33 & 0xffffffff;
   uVar40 = uVar40 + 1;
   if (( uVar34 == 0 ) || ( auVar9._8_8_ = 0 ),auVar9._0_8_ = (ulong)uVar34 * lVar6,auVar18._8_8_ = 0,auVar18._0_8_ = uVar39,auVar10._8_8_ = 0,auVar10._0_8_ = ( ulong )(( uVar41 + uVar32 ) - SUB164(auVar9 * auVar18, 8)) * lVar6,auVar19._8_8_ = 0,auVar19._0_8_ = uVar39,uVar30 = uVar33,SUB164(auVar10 * auVar19, 8) < uVar40) goto LAB_00101f9f;
   goto LAB_00101e5c;
}
/* NavMeshGenerator2D::generator_parse_geometry_node(Ref<NavigationPolygon>,
   Ref<NavigationMeshSourceGeometryData2D>, Node*, bool) */void NavMeshGenerator2D::generator_parse_geometry_node(long *param_1, long *param_2, Object *param_3, char param_4) {
   Variant *pVVar1;
   long *plVar2;
   long *plVar3;
   long lVar4;
 ...
 while ( iVar11 == 0xb );
   ...
   for (plVar14 = DAT_001051a8; plVar3 != plVar14; plVar14 = plVar14 + 1) {
      ...
      if (cVar10 != '\0') {
         this(Object * ) * param_2;
         if (( this != (Object*)0x0 ) && ( cVar10 = cVar10 == '\0' )) {
            this(Object * 0x0);
         }

         pOVar17 = (Object*)*param_1;
         if (( pOVar17 != (Object*)0x0 ) && ( cVar10 = cVar10 == '\0' )) {
            pOVar17 = (Object*)0x0;
         }
 ...
 while ( pVVar15 != local_a8 );
         ...
         if (( ( pOVar17 != (Object*)0x0 ) && ( cVar10 = RefCounted::unreference() ),cVar10 != '\0' )) &&( cVar10 = cVar10 != '\0' )(**(code**)( *(long*)pOVar17 + 0x140 ))(pOVar17);
         Memory::free_static(pOVar17, false);
      }

      if (( ( this != (Object*)0x0 ) && ( cVar10 = RefCounted::unreference() ),cVar10 != '\0' )) {
         if (*(code**)( *(long*)this + 0x140 ) == NavigationMeshSourceGeometryData2D::~NavigationMeshSourceGeometryData2D) {
...
pthread_rwlock_unlock((pthread_rwlock_t*)generator_parsers_rwlock);if (param_4 != '\0') {
   for (iVar11 = 0; iVar12 = Node::get_child_count(SUB81(param_3, 0)),iVar11 < iVar12; iVar11 = iVar11 + 1) {
      uVar13 = Node::get_child((int)param_3, SUB41(iVar11, 0));
      local_f8 = 0;
      uStack_f4 = 0;
      Ref<NavigationMeshSourceGeometryData2D>::operator =((Ref<NavigationMeshSourceGeometryData2D>*)&local_f8, (Ref*)*param_2);
      local_100 = (NavigationPolygon*)0x0;
      Ref<NavigationPolygon>::operator =((Ref<NavigationPolygon>*)&local_100, (Ref*)*param_1);
      generator_parse_geometry_node((Ref<NavigationPolygon>*)&local_100, (Ref<NavigationMeshSourceGeometryData2D>*)&local_f8, uVar13, 1);
      pNVar9 = local_100;
      if (( local_100 != (NavigationPolygon*)0x0 ) && ( cVar10 = cVar10 != '\0' )) {
         memdelete<NavigationPolygon>(pNVar9);
      }

      pNVar8 = (NavigationMeshSourceGeometryData2D*)CONCAT44(uStack_f4, local_f8);
      if (( pNVar8 != (NavigationMeshSourceGeometryData2D*)0x0 ) && ( cVar10 = cVar10 != '\0' )) {
...
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* NavMeshGenerator2D::generator_parse_source_geometry_data(Ref<NavigationPolygon>,
   Ref<NavigationMeshSourceGeometryData2D>, Node*) */void NavMeshGenerator2D::generator_parse_source_geometry_data(undefined8 *param_1, long *param_2, long param_3) {
   StringName *pSVar1;
   undefined8 uVar2;
   Object *this;
   void *pvVar3;
   ...
   LAB_0010269b:NavigationMeshSourceGeometryData2D::clear();
   lVar11 = *param_2;
   ...
   if (local_90 != (undefined1(*) [16])0x0) {
      ...
      if (puVar14 != (undefined8*)0x0) {
         do {
            ...
            uVar2 = *puVar14;
            if (( this_00 == (Object*)0x0 ) || ( local_80 = this_00 ),cVar8 = RefCounted::reference(),cVar8 == '\0') {
               local_80 = (Object*)0x0;
               this_00 = (Object*)0x0;
            }

            this(Object * ) * param_1;
            if (( this == (Object*)0x0 ) || ( local_88 = this ),cVar8 = RefCounted::reference(),cVar8 == '\0') {
               local_88 = (Object*)0x0;
               ...
               if (( cVar8 != '\0' ) && ( cVar8 = cVar8 != '\0' )) {
                  if (*(code**)( *(long*)this + 0x140 ) == NavigationPolygon::~NavigationPolygon) {
                     ...
                     *(undefined***)this = &PTR__initialize_classv_0010e498;
                     ...
                     if (( *(long*)( this + 0x2f8 ) != 0 ) && ( cVar8 = cVar8 != '\0' )) {
 ...
 while ( *(int*)local_90[1] != 0 );
   ...
   LAB_0010282f:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* NavMeshGenerator2D::parse_source_geometry_data(Ref<NavigationPolygon>,
   Ref<NavigationMeshSourceGeometryData2D>, Node*, Callable const&) */void NavMeshGenerator2D::parse_source_geometry_data(long *param_1, undefined8 *param_2, long param_3, Callable *param_4) {
   ...
   if (*(long*)( in_FS_OFFSET + lRam0000000000102c40 ) != 1) {
      if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         ...
         LAB_00102d96:_err_print_error("parse_source_geometry_data", "modules/navigation/2d/nav_mesh_generator_2d.cpp", uVar5, pcVar4, 0, 0);
         return;
      }
   ...
   Ref<NavigationMeshSourceGeometryData2D>::operator =((Ref<NavigationMeshSourceGeometryData2D>*)&local_38, (Ref*)*param_2);
   local_40 = (NavigationPolygon*)0x0;
   Ref<NavigationPolygon>::operator =((Ref<NavigationPolygon>*)&local_40, (Ref*)*param_1);
   generator_parse_source_geometry_data((Ref<NavigationPolygon>*)&local_40, (Ref<NavigationMeshSourceGeometryData2D>*)&local_38, param_3);
   pNVar1 = local_40;
   if (( local_40 == (NavigationPolygon*)0x0 ) || ( cVar3 = cVar3 == '\0' )) {
      if (local_38 != (NavigationMeshSourceGeometryData2D*)0x0) goto LAB_00102cd7;
      LAB_00102ce3:cVar3 = Callable::is_valid();
   }
 else {
      memdelete<NavigationPolygon>(pNVar1);
      if (local_38 == (NavigationMeshSourceGeometryData2D*)0x0) goto LAB_00102ce3;
      LAB_00102cd7:pNVar2 = local_38;
   ...
   LAB_00102e57:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* std::back_insert_iterator<std::vector<std::vector<Clipper2Lib::Point<long>,
   ...
   if (param_1 != param_2) {
      do {
         ...
         vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>::reserve(( vector<Clipper2Lib::Point<long>,std::allocator < Clipper2Lib::Point < long> >> *)local_58,param_1[1] - *param_1 >> 4 ));
         ...
         for (pdVar14 = (double*)*param_1; pdVar1 != pdVar14; pdVar14 = pdVar14 + 2) {
            while (true) {
               ...
               pdVar14 = pdVar14 + 2;
               vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>::_M_realloc_insert<Clipper2Lib::Point<long>>((vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>*)local_58, local_58._8_8_, &local_68);
...
;
         ...
         LAB_00103018:puVar2 = (undefined8*)param_3[1];
         ...
         if (puVar2 == puVar13) {
            ...
            if (puVar2 == puVar3) {
               ...
               uVar9 = uVar9 * 0x18;
               LAB_001031c1:puVar8 = (undefined8*)operator_new(uVar9);
               ...
               *puVar11 = uVar4;
               ...
               if (uVar9 < uVar6) {
                  LAB_00103238:uVar9 = 0x7ffffffffffffff8;
                  goto LAB_001031c1;
               }
 ...
 while ( puVar2 != puVar11 );
               puVar11 = (undefined8*)( (long)puVar12 + ( (long)puVar2 + ( -0x18 - (long)puVar3 ) & 0xfffffffffffffff8U ) + 0x30 );
               puVar8 = puVar12;
            }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* NavMeshGenerator2D::generator_bake_from_source_geometry_data(Ref<NavigationPolygon>,
   Ref<NavigationMeshSourceGeometryData2D>) */void NavMeshGenerator2D::generator_bake_from_source_geometry_data(long *param_1, long *param_2) {
   ...
   vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>> *local_338;
   PolyPathD *local_330;
   vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>> *local_318;
   vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>> *local_308;
   CowData<Vector2> *local_300;
   vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>> *local_2f8;
   ...
   long local_260;
   vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>> local_258[16];
   undefined8 local_248;
   undefined1 local_238[16];
   undefined8 local_228;
   vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>> local_218[16];
   ...
   local_228 = 0;
   for (int i = 0; i < 16; i++) {
      local_258[i] = (vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>)0;
   }
 ...
 while ( iVar10 == 0xb );
   ...
   if (iVar10 == 0) {
      ...
      if (( cVar9 != '\0' ) && ( lVar26 = lVar26 != 0 )) {
         uVar27 = 0;
         local_318 = (vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>*)*param_2;
         goto LAB_00103361;
      }
      ...
      if (lVar26 != 0) {
         LAB_00103361:uVar27 = uVar27 + *(long*)( lVar26 + -8 );
      }

      std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::reserve(local_258, uVar27);
      ...
      if (0 < iVar10) {
         ...
         do {
            ...
            std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>::reserve((vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>*)local_158, uVar27);
            if (local_1a0 != (float*)0x0) {
               pfVar30 = local_1a0 + *(long*)( local_1a0 + -2 ) * 2;
               for (pfVar29 = local_1a0; pfVar29 != pfVar30; pfVar29 = pfVar29 + 2) {
                  std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>::emplace_back<float_const&,float_const&>((vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>*)local_158, pfVar29, pfVar29 + 1);
               }

            }

            std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator < Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>> > ::emplace_back<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>(local_258, (vector*)local_158);
 ...
 while ( iVar10 != iVar21 );
      ...
      local_308 = (vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>*)local_158;
      ...
      if (lVar24 != 0) {
         ...
         for (; lVar24 != lVar26; lVar24 = lVar24 + 0x10) {
            ...
            std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>::reserve(local_308, uVar27);
            pfVar30 = *(float**)( lVar24 + 8 );
            if (pfVar30 != (float*)0x0) {
               pfVar29 = pfVar30 + *(long*)( pfVar30 + -2 ) * 2;
               for (; pfVar30 != pfVar29; pfVar30 = pfVar30 + 2) {
                  std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>::emplace_back<float_const&,float_const&>(local_308, pfVar30, pfVar30 + 1);
               }

            }

            std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator < Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>> > ::emplace_back<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>(local_258, (vector*)local_308);
            if ((void*)local_158._0_8_ != (void*)0x0) {
               operator_delete((void*)local_158._0_8_, (long)local_148 - local_158._0_8_);
            }
         ...
         for (lVar25 = lVar24; lVar25 != lVar24 + lVar26 * 0x18; lVar25 = lVar25 + 0x18) {
            if (( *(char*)( lVar25 + 0x10 ) == '\0' ) && ( *(long*)( lVar25 + 8 ) != 0 )) {
               ...
               if (( uVar27 & 1 ) == 0) {
                  ...
                  local_158 = (undefined1[16])0x0;
                  local_148 = 0.0;
                  std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>::reserve(local_308, (long)uVar27 / 2);
                  lVar33 = *(long*)( lVar25 + 8 );
                  for (; ( lVar33 != 0 && ( lVar28 = *(long*)( lVar33 + -8 ) ),(long)uVar38 < lVar28 / 2 ); uVar38 = uVar38 + 1) {
                     lVar15 = lVar34;
                     ...
                     lVar34 = lVar34 + 2;
                     std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>::emplace_back<float_const&,float_const&>(local_308, (float*)( lVar33 + uVar38 * 8 ), (float*)( lVar33 + lVar1 ));
                     lVar33 = *(long*)( lVar25 + 8 );
                  }

                  pCVar13 = (Clipper2Lib*)local_158._8_8_;
                  pCVar16 = (Clipper2Lib*)local_158._0_8_;
                  dVar40 = Clipper2Lib::Area<double>((Clipper2Lib*)local_158._0_8_, (vector*)local_158._8_8_);
                  if (( ( dVar40 < 0.0 ) && ( pCVar16 != pCVar13 ) ) && ( pCVar13 = pCVar16 < pCVar13 )) {
                     do {
 ...
 while ( pCVar20 < pCVar14 );
                  ...
                  std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::emplace_back<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>((vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>*)local_238, (vector*)local_308);
                  std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>::~vector(local_308);
               }
      ...
      if (( 0.0 < fVar4 ) && ( 0.0 < fVar11 )) {
         ...
         std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::_M_move_assign(local_258, (Clipper2Lib*)&local_1a8);
         std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::~vector((vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>*)&local_1a8);
         Clipper2Lib::RectClip((Clipper2Lib*)&local_1a8, (Rect*)local_308, (vector*)local_238, 2);
         std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::_M_move_assign((vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>*)local_238, (Clipper2Lib*)&local_1a8);
         std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::~vector((vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>*)&local_1a8);
      }

      for (int i = 0; i < 16; i++) {
         local_218[i] = (vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>)0;
      }

      local_208 = 0;
      Clipper2Lib::BooleanOp((Clipper2Lib*)local_308, 2, 1, local_258, local_218, 2);
      std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::_M_move_assign(local_258, local_308);
      std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::~vector((vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>*)local_308);
      Clipper2Lib::BooleanOp((Clipper2Lib*)local_308, 2, 1, (vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>*)local_238, local_218, 2);
      std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::_M_move_assign((vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>*)local_238, local_308);
      std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::~vector((vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>*)local_308);
      Clipper2Lib::BooleanOp((Clipper2Lib*)&local_1f8, 3, 1, local_258, (vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>*)local_238, 2);
      fVar39 = (float)NavigationPolygon::get_agent_radius();
      if (0.0 < fVar39) {
         Clipper2Lib::InflatePaths((Clipper2Lib*)(double)(float)( (uint)fVar39 ^ __LC78 ), _LC13, local_308, (Clipper2Lib*)&local_1f8, 3, 0);
         std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::_M_move_assign((Clipper2Lib*)&local_1f8, local_308);
         std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::~vector((vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>*)local_308);
      }

      local_2f8 = (vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>*)local_238;
      if (lVar24 != 0) {
         lVar24 = *param_2;
         do {
 ...
 while ( iVar10 == 0xb );
         if (iVar10 == 0x23) {
            LAB_0010483e:/* WARNING: Subroutine does not return */std::__throw_system_error(0x23);
         }

         uVar41 = local_238._8_8_;
         pvVar19 = (vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>*)local_238._0_8_;
         lVar26 = *param_2;
         pvVar31 = (vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>*)local_238._0_8_;
         if (local_238._8_8_ == local_238._0_8_) {
            ...
            do {
               ...
               std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>::~vector(pvVar31);
               pvVar31 = pvVar32;
            }
 while ( (vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>*)uVar41 != pvVar32 );
            lVar26 = *(long*)( lVar26 + 0x2b8 );
            local_238._8_8_ = pvVar19;
            if (lVar26 != 0) {
               LAB_00103aca:lVar25 = lVar26 + *(long*)( lVar26 + -8 ) * 0x18;
               if (lVar25 != lVar26) {
                  do {
                     if (( *(char*)( lVar26 + 0x10 ) != '\0' ) && ( *(long*)( lVar26 + 8 ) != 0 )) {
                        ...
                        if (( uVar27 & 1 ) == 0) {
                           ...
                           for (; ( lVar33 != 0 && ( lVar28 = *(long*)( lVar33 + -8 ) ),(long)uVar38 < lVar28 / 2 ); uVar38 = uVar38 + 1) {
                              lVar15 = lVar34;
                              if (lVar28 <= lVar34) {
                                 LAB_00103c06:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar15, lVar28, "p_index", "size()", "", false, true);
                                 _err_flush_stdout();
                                 /* WARNING: Does not return */
                                 pcVar5 = (code*)invalidInstructionException();
                                 ( *pcVar5 )();
                              ...
                              std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>::emplace_back<float_const&,float_const&>(local_308, (float*)( lVar33 + uVar38 * 8 ), (float*)( lVar33 + lVar34 * 4 ));
                              lVar33 = *(long*)( lVar26 + 8 );
                              lVar34 = lVar34 + 2;
                           }
 ...
 while ( pCVar20 < pCVar14 );
                           ...
                           std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::emplace_back<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>(local_2f8, (vector*)local_308);
                           std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>::~vector(local_308);
                        }
 ...
 while ( lVar25 != lVar26 );
            ...
            if (pvVar19 != (vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>*)local_238._8_8_) {
      ...
      if (( ( 0.0 < fVar4 ) && ( 0.0 < fVar11 ) ) && ( 0.0 < fVar39 )) {
         ...
         std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::_M_move_assign((Clipper2Lib*)&local_1f8, (Clipper2Lib*)&local_1a8);
         std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::~vector((vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>*)&local_1a8);
      }
      ...
      if (local_1f0 == local_1f8) {
         ...
         local_1c8 = (int*)0x0;
         local_1d8 = (vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>*)0x0;
         pvStack_1d0 = (vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>*)0x0;
         cVar9 = Clipper2Lib::ClipperBase::ExecuteInternal(local_308, 2, 1, 1);
         if (cVar9 != '\0') {
            std::vector<std::unique_ptr<Clipper2Lib::PolyPathD,std::default_delete<Clipper2Lib::PolyPathD>>,std::allocator<std::unique_ptr<Clipper2Lib::PolyPathD,std::default_delete<Clipper2Lib::PolyPathD>>>>::resize((vector<std::unique_ptr<Clipper2Lib::PolyPathD,std::default_delete<Clipper2Lib::PolyPathD>>,std::allocator<std::unique_ptr<Clipper2Lib::PolyPathD,std::default_delete<Clipper2Lib::PolyPathD>>>>*)&local_198, 0);
            pvVar31 = pvStack_1d0;
            pvVar19 = local_1d8;
            local_180 = local_50;
            pvVar32 = local_1d8;
            if (local_1d8 != pvStack_1d0) {
               do {
                  ...
                  std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>::~vector(pvVar32);
                  pvVar32 = pvVar22;
               }
 while ( pvVar31 != pvVar22 );
         ...
         local_318 = (vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>*)&local_1d8;
         local_330 = (PolyPathD*)&local_1a8;
         uVar27 = 0;
         Clipper2Lib::ClipperBase::CleanUp();
         std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::~vector(local_318);
         if (local_198 != local_190) {
            do {
               lVar24 = uVar27 * 8;
               uVar27 = uVar27 + 1;
               generator_recursive_process_polytree_items((List*)&local_2a8, *(PolyPathD**)( local_198 + lVar24 ));
            }
 while ( uVar27 < ( ulong )(local_190 - local_198 >> 3) );
         ...
         if (iVar10 == 0) {
            ...
            uVar41 = 0x1df;
            pcVar17 = "NavigationPolygon polygon convex partition failed. Unable to create a valid navigation mesh polygon layout from provided source geometry.";
            LAB_00104753:_err_print_error("generator_bake_from_source_geometry_data", "modules/navigation/2d/nav_mesh_generator_2d.cpp", uVar41, pcVar17, 0, 0);
            pvStack_1d0 = (vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>*)0x0;
            ...
            if (iVar10 == 0) {
               uVar41 = 0x1e7;
               pcVar17 = "NavigationPolygon polygon triangulation failed. Unable to create a valid navigation mesh polygon layout from provided source geometry.";
               goto LAB_00104753;
            }

            LAB_001041a5:local_290[0] = 0;
            local_280[0] = 0;
            local_1b0 = 2;
            pvStack_1d0 = (vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>*)0x0;
            local_1c8 = (int*)0x0;
                  ...
                  if (plVar35[1] < 1) {
                     ...
                     do {
                        while (true) {
                           ...
                           cVar9 = HashMap<Vector2,int,HashMapHasherDefault,HashMapComparatorDefault<Vector2>,DefaultTypedAllocator<HashMapElement<Vector2,int>>>::_lookup_pos((HashMap<Vector2,int,HashMapHasherDefault,HashMapComparatorDefault<Vector2>,DefaultTypedAllocator<HashMapElement<Vector2,int>>>*)local_318, pVVar2, &local_268);
                           if (( cVar9 == '\0' ) || ( *(long*)( (long)pvStack_1d0 + (ulong)local_268 * 8 ) == 0 )) break;
                           uVar23 = *(undefined4*)( *(long*)( (long)pvStack_1d0 + (ulong)local_268 * 8 ) + 0x18 );
                           if (lVar24 != 0) goto LAB_00104334;
                           LAB_001043ee:iVar10 = CowData<int>::resize<false>((CowData<int>*)&local_270, 1);
                           if (iVar10 == 0) goto LAB_0010434f;
                           LAB_00104405:lVar26 = lVar26 + 1;
...
;
                        ...
                        HashMap<Vector2,int,HashMapHasherDefault,HashMapComparatorDefault<Vector2>,DefaultTypedAllocator<HashMapElement<Vector2,int>>>::insert((Vector2*)&local_268, (int*)local_318, SUB81(pVVar2, 0));
                        ...
                        if (iVar10 == 0) {
                           ...
                           _err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar34, lVar33, "p_index", "size()", "", false, false);
                        }
 else {
                           _err_print_error("push_back", "./core/templates/vector.h", 0x142, "Condition \"err\" is true. Returning: true", 0, 0);
                        }

                        LAB_00104327:uVar23 = *(undefined4*)( lVar25 + 0x18 );
                        if (lVar24 == 0) goto LAB_001043ee;
                        LAB_00104334:iVar10 = CowData<int>::resize<false>((CowData<int>*)&local_270, *(long*)( lVar24 + -8 ) + 1);
                        if (iVar10 != 0) goto LAB_00104405;
                        LAB_0010434f:lVar24 = local_270;
                        if (local_270 == 0) {
                           lVar33 = -1;
                           lVar25 = 0;
                           LAB_001045c8:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar33, lVar25, "p_index", "size()", "", false, false);
                        }
 else {
 ...
 while ( lVar26 < plVar35[1] );
                  ...
                  if (iVar10 == 0) {
                     ...
                     _err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar26, lVar24, "p_index", "size()", "", false, false);
                  }
 else {
                     _err_print_error("push_back", "./core/templates/vector.h", 0x142, "Condition \"err\" is true. Returning: true", 0, 0);
                  }

                  LAB_001044df:CowData<int>::_unref((CowData<int>*)&local_260);
 ...
 while ( plVar35 != (long*)0x0 );
               NavigationPolygon::set_data((Vector*)*param_1, local_298);
               piVar8 = local_1c8;
               if (pvVar19 != (vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>*)0x0) {
                  if (( local_1b0._4_4_ != 0 ) && ( *(uint*)( hash_table_size_primes + ( local_1b0 & 0xffffffff ) * 4 ) != 0 )) {
                     ...
                     do {
                        ...
                        piVar36 = piVar36 + 1;
                        pvVar31 = (vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>*)( (long)pvVar31 + 8 );
                     }
 while ( piVar3 != piVar36 );
            ...
            _err_print_error("generator_bake_from_source_geometry_data", "modules/navigation/2d/nav_mesh_generator_2d.cpp", 0x1ee, "NavigationPolygon polygon partitioning failed. Unrecognized partition type.", 0, 0);
            pvStack_1d0 = (vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>*)0x0;
            NavigationPolygon::set_vertices((Vector*)*param_1);
            CowData<Vector2>::_unref((CowData<Vector2>*)&pvStack_1d0);
            NavigationPolygon::clear_polygons();
      ...
      std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::~vector((vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>*)&local_1f8);
      std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::~vector(local_218);
   }

   local_2f8 = (vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>*)local_238;
   local_338 = local_258;
   std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::~vector(local_2f8);
   std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::~vector(local_338);
   LAB_001036ff:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* NavMeshGenerator2D::bake_from_source_geometry_data(Ref<NavigationPolygon>,
   Ref<NavigationMeshSourceGeometryData2D>, Callable const&) */void NavMeshGenerator2D::bake_from_source_geometry_data(Ref *param_1, long *param_2, Callable *param_3) {
   NavigationPolygon *pNVar1;
   char cVar2;
   char cVar3;
   int iVar4;
   ...
   if (*(long*)param_1 == 0) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         ...
         LAB_00104ac2:_err_print_error("bake_from_source_geometry_data", "modules/navigation/2d/nav_mesh_generator_2d.cpp", uVar6, pcVar5, 0, 0);
         return;
      }
   ...
   if (( iVar4 == 0 ) && ( cVar2 = NavigationMeshSourceGeometryData2D::has_data() ),cVar2 == '\0') {
      ...
      pNVar1 = local_58[0];
      if (( local_58[0] != (NavigationPolygon*)0x0 ) && ( cVar3 = cVar3 != '\0' )) {
         memdelete<NavigationPolygon>(pNVar1);
      }
      ...
      if (cVar2 == '\0') {
         ...
         if (iVar4 != 0) {
            LAB_00104b0c:/* WARNING: Subroutine does not return */std::__throw_system_error(iVar4);
         }

         HashSet<Ref<NavigationPolygon>,HashMapHasherDefault,HashMapComparatorDefault<Ref<NavigationPolygon>>>::insert((Ref*)local_58);
         pthread_mutex_unlock((pthread_mutex_t*)baking_navmesh_mutex);
         local_58[0] = (NavigationPolygon*)0x0;
         Ref<NavigationMeshSourceGeometryData2D>::operator =((Ref<NavigationMeshSourceGeometryData2D>*)local_58, (Ref*)*param_2);
         local_60 = (NavigationPolygon*)0x0;
         Ref<NavigationPolygon>::operator =((Ref<NavigationPolygon>*)&local_60, *(Ref**)param_1);
         generator_bake_from_source_geometry_data((Ref<NavigationPolygon>*)&local_60, (Ref<NavigationPolygon>*)local_58);
         pNVar1 = local_60;
         if (( local_60 != (NavigationPolygon*)0x0 ) && ( cVar2 = cVar2 != '\0' )) {
            memdelete<NavigationPolygon>(pNVar1);
         }

         pNVar1 = local_58[0];
         if (( local_58[0] != (NavigationPolygon*)0x0 ) && ( cVar2 = cVar2 != '\0' )) {
            memdelete<NavigationMeshSourceGeometryData2D>((NavigationMeshSourceGeometryData2D*)pNVar1);
         }

         iVar4 = pthread_mutex_lock((pthread_mutex_t*)baking_navmesh_mutex);
         if (iVar4 != 0) goto LAB_00104b0c;
         HashSet<Ref<NavigationPolygon>,HashMapHasherDefault,HashMapComparatorDefault<Ref<NavigationPolygon>>>::erase((HashSet<Ref<NavigationPolygon>,HashMapHasherDefault,HashMapComparatorDefault<Ref<NavigationPolygon>>>*)&baking_navmeshes, param_1);
         pthread_mutex_unlock((pthread_mutex_t*)baking_navmesh_mutex);
         cVar2 = Callable::is_valid();
         goto joined_r0x001049c0;
      }

      _err_print_error("bake_from_source_geometry_data", "modules/navigation/2d/nav_mesh_generator_2d.cpp", 0x9d, "Method/function failed.", "NavigationPolygon is already baking. Wait for current bake to finish.", 0, 0);
   }
   ...
   LAB_00104b13:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* NavMeshGenerator2D::bake_from_source_geometry_data_async(Ref<NavigationPolygon>,
   Ref<NavigationMeshSourceGeometryData2D>, Callable const&) */void NavMeshGenerator2D::bake_from_source_geometry_data_async(long *param_1, long *param_2, Callable *param_3) {
   ...
   if (*param_1 == 0) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         ...
         LAB_00104e56:_err_print_error("bake_from_source_geometry_data_async", "modules/navigation/2d/nav_mesh_generator_2d.cpp", uVar6, pcVar7, 0, 0);
         return;
      }
   ...
   if (iVar5 == 0) {
      ...
      LAB_00104b6e:if (use_threads == '\0') {
         local_58[0] = (NavigationPolygon*)0x0;
         Ref<NavigationMeshSourceGeometryData2D>::operator =((Ref<NavigationMeshSourceGeometryData2D>*)local_58, (Ref*)*param_2);
         local_60 = (Ref<NavigationPolygon>*)0x0;
         Ref<NavigationPolygon>::operator =((Ref<NavigationPolygon>*)&local_60, (Ref*)*param_1);
         bake_from_source_geometry_data((Ref<NavigationPolygon>*)&local_60, (Ref<NavigationMeshSourceGeometryData2D>*)local_58, param_3);
         ...
         if (local_58[0] != (NavigationPolygon*)0x0) {
            ...
            if (cVar3 != '\0') {
               if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                  memdelete<NavigationMeshSourceGeometryData2D>((NavigationMeshSourceGeometryData2D*)pNVar2);
                  return;
               }
            ...
            if (iVar5 == 0) {
               ...
               if (iVar5 == 0) {
                  ...
                  *(undefined1(*) [16])this = (undefined1[16])0x0;
                  ...
                  Ref<NavigationMeshSourceGeometryData2D>::operator =((Ref<NavigationMeshSourceGeometryData2D>*)( this + 8 ), (Ref*)*param_2);
                  ...
                  *(undefined4*)( this + 0x28 ) = 0;
                  ...
                  uVar6 = WorkerThreadPool::add_native_task(p_Var1, generator_thread_bake, SUB81(this, 0), (String*)(ulong)baking_use_high_priority_threads);
                  *(undefined8*)( this + 0x20 ) = uVar6;
                  CowData<char32_t>::_unref((CowData<char32_t>*)local_58);
                  HashMap<long,NavMeshGenerator2D::NavMeshGeneratorTask2D*,HashMapHasherDefault,HashMapComparatorDefault<long>,DefaultTypedAllocator<HashMapElement<long,NavMeshGenerator2D::NavMeshGeneratorTask2D*>>>::insert((long*)local_58, (NavMeshGeneratorTask2D**)generator_tasks, (bool)( SUB81(this, 0) + ' ' ));
                  if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                     pthread_mutex_unlock((pthread_mutex_t*)generator_task_mutex);
                     return;
                  }
         ...
         _err_print_error("bake_from_source_geometry_data_async", "modules/navigation/2d/nav_mesh_generator_2d.cpp", 0xc0, "Method/function failed.", "NavigationPolygon is already baking. Wait for current bake to finish.", 0, 0);
      }
   ...
   LAB_00104ece:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* NavMeshGenerator2D::generator_thread_bake(void*) */void NavMeshGenerator2D::generator_thread_bake(void *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   long lVar4;
   ...
   pOVar6 = local_50;
   if (( ( local_50 != (Object*)0x0 ) && ( cVar7 = RefCounted::unreference() ),cVar7 != '\0' )) &&( cVar7 = cVar7 != '\0' )(**(code**)( *(long*)pOVar6 + 0x140 ))(pOVar6);
   Memory::free_static(pOVar6, false);
}
...
*(undefined4*)( (long)param_1 + 0x28 ) = 1;if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
...
/* NavigationMeshSourceGeometryData2D::is_class_ptr(void*) const */uint NavigationMeshSourceGeometryData2D::is_class_ptr(NavigationMeshSourceGeometryData2D *this, void *param_1) {
   return (uint)CONCAT71(0x10e8, (undefined4*)param_1 == &Resource::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10e8, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10e8, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10e8, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
...
/* NavigationPolygon::is_class_ptr(void*) const */uint NavigationPolygon::is_class_ptr(NavigationPolygon *this, void *param_1) {
   return (uint)CONCAT71(0x10e8, (undefined4*)param_1 == &Resource::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10e8, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10e8, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10e8, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* NavigationPolygon::_getv(StringName const&, Variant&) const */undefined8 NavigationPolygon::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* NavigationPolygon::_setv(StringName const&, Variant const&) */undefined8 NavigationPolygon::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* NavigationPolygon::_property_can_revertv(StringName const&) const */undefined8 NavigationPolygon::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* NavigationPolygon::_property_get_revertv(StringName const&, Variant&) const */undefined8 NavigationPolygon::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* NavigationPolygon::_notificationv(int, bool) */void NavigationPolygon::_notificationv(int param_1, bool param_2) {
   return;
}
/* Clipper2Lib::PolyPathD::Count() const */long Clipper2Lib::PolyPathD::Count(PolyPathD *this) {
   return *(long*)( this + 0x18 ) - *(long*)( this + 0x10 ) >> 3;
}
/* LocalVector<NavMeshGeometryParser2D*, unsigned int, false, false>::~LocalVector() */void LocalVector<NavMeshGeometryParser2D*,unsigned_int,false,false>::~LocalVector(LocalVector<NavMeshGeometryParser2D*,unsigned_int,false,false> *this) {
...
/* NavigationPolygon::_validate_propertyv(PropertyInfo&) const */void NavigationPolygon::_validate_propertyv(PropertyInfo *param_1) {
...
/* Clipper2Lib::ClipperD::~ClipperD() */void Clipper2Lib::ClipperD::~ClipperD(ClipperD *this) {
...
/* HashMap<long, NavMeshGenerator2D::NavMeshGeneratorTask2D*, HashMapHasherDefault,
   ...
   NavMeshGenerator2D::NavMeshGeneratorTask2D*> > >::~HashMap() */void HashMap<long,NavMeshGenerator2D::NavMeshGeneratorTask2D*,HashMapHasherDefault,HashMapComparatorDefault<long>,DefaultTypedAllocator<HashMapElement<long,NavMeshGenerator2D::NavMeshGeneratorTask2D*>>>::~HashMap(HashMap<long,NavMeshGenerator2D::NavMeshGeneratorTask2D*,HashMapHasherDefault,HashMapComparatorDefault<long>,DefaultTypedAllocator<HashMapElement<long,NavMeshGenerator2D::NavMeshGeneratorTask2D*>>> *this) {
   uint uVar1;
   long lVar2;
   void *pvVar3;
   pvVar3 = *(void**)( this + 8 );
...
/* NavigationMesh::_get_class_namev() const */undefined8 *NavigationMesh::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00105a63:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00105a63;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "NavigationMesh");
   LAB_00105ace:return &_get_class_namev();
}
/* NavigationPolygon::_get_class_namev() const */undefined8 *NavigationPolygon::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00105b53:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00105b53;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "NavigationPolygon");
         goto LAB_00105bbe;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "NavigationPolygon");
   LAB_00105bbe:return &_get_class_namev();
}
/* Object::_get_class_namev() const */undefined8 *Object::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00105c33:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00105c33;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "Object");
   LAB_00105c9e:return &_get_class_namev();
}
...
/* Clipper2Lib::ClipperD::ClipperD(int) */void Clipper2Lib::ClipperD::ClipperD(ClipperD *this, int param_1) {
   int iVar1;
   long lVar2;
   ClipperD *pCVar3;
   double dVar4;
...
/* std::vector<Clipper2Lib::Point<double>, std::allocator<Clipper2Lib::Point<double> > >::~vector()
    */void std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>::~vector(vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>> *this) {
   void *pvVar1;
   pvVar1 = *(void**)this;
   if (pvVar1 != (void*)0x0) {
...
/* std::vector<std::vector<Clipper2Lib::Point<double>, std::allocator<Clipper2Lib::Point<double> >
   >, std::allocator<std::vector<Clipper2Lib::Point<double>,
   std::allocator<Clipper2Lib::Point<double> > > > >::~vector() */void std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::~vector(vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>> *this) {
   undefined8 *puVar1;
   void *pvVar2;
   undefined8 *puVar3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashSet<Ref<NavigationPolygon>, HashMapHasherDefault,
   HashMapComparatorDefault<Ref<NavigationPolygon> > >::insert(Ref<NavigationPolygon> const&) */Ref * HashSet<Ref<NavigationPolygon>,HashMapHasherDefault,HashMapComparatorDefault<Ref<NavigationPolygon>>>
      ::insert(Ref *param_1){
   Ref<NavigationPolygon> *this;
   uint uVar1;
   uint uVar2;
   ...
   Ref *pRVar31;
   ulong uVar32;
   HashSet<Ref<NavigationPolygon>,HashMapHasherDefault,HashMapComparatorDefault<Ref<NavigationPolygon>>> *in_RSI;
   uint uVar33;
   ulong uVar34;
   undefined4 uVar35;
   ulong uVar36;
 ...
 while ( uVar2 != 0 );
   ...
   LAB_00106a5b:*(undefined8*)param_1 = *(undefined8*)in_RSI;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<long, NavMeshGenerator2D::NavMeshGeneratorTask2D*, HashMapHasherDefault,
   HashMapComparatorDefault<long>, DefaultTypedAllocator<HashMapElement<long,
   NavMeshGenerator2D::NavMeshGeneratorTask2D*> > >::insert(long const&,
   NavMeshGenerator2D::NavMeshGeneratorTask2D* const&, bool) */void HashMap<long,NavMeshGenerator2D::NavMeshGeneratorTask2D*,HashMapHasherDefault,HashMapComparatorDefault<long>,DefaultTypedAllocator<HashMapElement<long,NavMeshGenerator2D::NavMeshGeneratorTask2D*>>>::insert(long *param_1, NavMeshGeneratorTask2D **param_2, bool param_3) {
 ...
 while ( uVar45 != uVar31 );
      ...
      LAB_00106c6b:iVar34 = *(int*)( (long)param_2 + 0x2c );
      lVar39 = *plVar35;
      LAB_00106c77:if (iVar34 != 0) {
...
;
   ...
   *(uint*)pNVar1 = uVar30;
   *(int*)( (long)param_2 + 0x2c ) = *(int*)( (long)param_2 + 0x2c ) + 1;
   LAB_00107111:*param_1 = (long)pNVar33;
   return;
}
/* std::vector<std::vector<Clipper2Lib::Point<double>, std::allocator<Clipper2Lib::Point<double> >
   >, std::allocator<std::vector<Clipper2Lib::Point<double>,
...
/* std::vector<Clipper2Lib::Point<double>, std::allocator<Clipper2Lib::Point<double> >
   >::reserve(unsigned long) */void std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>::reserve(vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>> *this, ulong param_1) {
   long lVar1;
   long lVar2;
   undefined8 *puVar3;
   undefined8 *puVar4;
...
/* NavigationPolygon::get_class() const */void NavigationPolygon::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* Object::is_class(String const&) const */ulong Object::is_class(Object *this, String *param_1) {
   ...
   do {
      if (lVar1 == 0) {
         ...
         LAB_00107d47:/* WARNING: Subroutine does not return */__stack_chk_fail();
      }
...
/* Resource::is_class(String const&) const */undefined8 Resource::is_class(Resource *this, String *param_1) {
   ...
   LAB_00107e23:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_00107f16:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* NavigationPolygon::is_class(String const&) const */undefined8 NavigationPolygon::is_class(NavigationPolygon *this, String *param_1) {
   long lVar1;
   char *__s;
   long lVar2;
   char cVar3;
   ...
   if (cVar3 == '\0') {
      ...
      LAB_00107ff3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* NavigationMesh::is_class(String const&) const */undefined8 NavigationMesh::is_class(NavigationMesh *this, String *param_1) {
   ...
   if (cVar3 == '\0') {
      ...
      LAB_0010812b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* NavigationMeshSourceGeometryData2D::is_class(String const&) const */undefined8 NavigationMeshSourceGeometryData2D::is_class(NavigationMeshSourceGeometryData2D *this, String *param_1) {
   ...
   if (cVar3 == '\0') {
      ...
      LAB_0010825b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* NavigationPolygon::_initialize_classv() */void NavigationPolygon::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   long local_58;
   undefined8 local_50;
...
/* NavigationPolygon::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void NavigationPolygon::_get_property_listv(NavigationPolygon *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   undefined8 local_98;
   undefined8 local_90;
   long local_88;
...
;
 ...
 while ( puVar1 != puVar4 );
      LAB_00109740:*(undefined8**)( this + 0x18 ) = puVar5;
   }
...
;
 ...
 while ( puVar1 != puVar5 );
      LAB_001097c0:puVar5 = *(undefined8**)( this + 0x10 );
   }
...
/* std::vector<std::unique_ptr<Clipper2Lib::PolyPathD, std::default_delete<Clipper2Lib::PolyPathD>
   ...
   if (( param_1 < uVar7 ) && ( puVar1 = (undefined8*)( *(long*)this + param_1 * 8 ) ),puVar8 = puVar1,puVar1 != puVar2) {
      do {
         plVar3 = (long*)*puVar8;
         if (plVar3 != (long*)0x0) {
...
;
 ...
 while ( puVar4 != puVar9 );
                  LAB_001098e0:plVar3[3] = (long)puVar10;
               }
               ...
               if (puVar4 != puVar10) {
                  do {
                     while (pPVar5 = (PolyPathD*)*puVar10,pPVar5 == (PolyPathD*)0x0) {
                        LAB_00109922:puVar10 = puVar10 + 1;
...
;
 ...
 while ( puVar4 != puVar10 );
                  LAB_00109950:puVar10 = (undefined8*)plVar3[2];
               }
...
;
 ...
 while ( puVar3 != puVar8 );
               LAB_00109aa0:plVar2[3] = (long)puVar9;
            }
...
;
 ...
 while ( puVar3 != puVar9 );
               LAB_00109b10:puVar9 = (undefined8*)plVar2[2];
            }
...
;
 ...
 while ( puVar1 != puVar6 );
      LAB_00109bc0:puVar6 = *(undefined8**)( this + 0x10 );
   }
                              ...
                              if (puVar8 != puVar14) {
                                 do {
                                    while (pPVar9 = (PolyPathD*)*puVar17,pPVar9 == (PolyPathD*)0x0) {
                                       LAB_00109d52:puVar17 = puVar17 + 1;
...
;
 ...
 while ( puVar8 != puVar17 );
                                 LAB_00109d80:plVar7[3] = (long)puVar14;
                              }
                              ...
                              if (puVar8 != puVar14) {
                                 do {
                                    while (pPVar9 = (PolyPathD*)*puVar14,pPVar9 == (PolyPathD*)0x0) {
                                       LAB_00109dca:puVar14 = puVar14 + 1;
...
;
 ...
 while ( puVar8 != puVar14 );
                                 LAB_00109e00:puVar14 = (undefined8*)plVar7[2];
                              }
                     ...
                     if (puVar6 != puVar12) {
                        do {
                           while (pPVar9 = (PolyPathD*)*puVar12,pPVar9 == (PolyPathD*)0x0) {
                              LAB_00109e92:puVar12 = puVar12 + 1;
...
;
 ...
 while ( puVar6 != puVar12 );
                        LAB_00109ec0:puVar12 = (undefined8*)plVar5[2];
                     }
            ...
            if (puVar4 != puVar15) {
               do {
                  while (pPVar9 = (PolyPathD*)*puVar15,pPVar9 == (PolyPathD*)0x0) {
                     LAB_00109f4a:puVar15 = puVar15 + 1;
...
;
 ...
 while ( puVar4 != puVar15 );
               LAB_00109f78:puVar15 = (undefined8*)plVar3[2];
            }
...
/* void std::vector<std::unique_ptr<Clipper2Lib::PolyPathD,
   ...
   if (puVar2 == puVar1) {
      ...
      uVar9 = uVar9 * 8;
      LAB_0010a130:puVar6 = (undefined8*)operator_new(uVar9);
 ...
 while ( param_2 != puVar7 );
      ...
      uVar4 = uVar5 * 2;
      if (uVar4 < uVar5) {
         LAB_0010a126:uVar9 = 0x7ffffffffffffff8;
         goto LAB_0010a130;
      }
   ...
   LAB_0010a0f2:if (puVar2 != (undefined8*)0x0) {
      operator_delete(puVar2, *(long*)( this + 0x10 ) - (long)puVar2);
   }
...
/* std::vector<std::vector<Clipper2Lib::Point<double>, std::allocator<Clipper2Lib::Point<double> >
   >, std::allocator<std::vector<Clipper2Lib::Point<double>,
   std::allocator<Clipper2Lib::Point<double> > > > >::_M_default_append(unsigned long) */void std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::_M_default_append(vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>> *this, ulong param_1) {
   ulong uVar1;
...
/* HashMap<Vector2, int, HashMapHasherDefault, HashMapComparatorDefault<Vector2>,
   ...
   uVar13 = 0x3413905a;
   if (fVar1 == 0.0) {
      LAB_0010a3d1:fVar19 = *(float*)( param_1 + 4 );
      if (fVar19 != 0.0) {
         LAB_0010a51c:if (NAN(fVar19)) {
      ...
      LAB_0010a536:uVar13 = ( uVar13 << 0xd | uVar13 >> 0x13 ) * 5 + 0xe6546b64;
      uVar13 = ( uVar13 >> 0x10 ^ uVar13 ) * -0x7a143595;
   ...
   uVar15 = uVar13 * uVar3;
   LAB_0010a41a:uVar17 = CONCAT44(0, *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 ));
   auVar4._8_8_ = 0;
   auVar4._0_8_ = uVar17;
   auVar8._8_8_ = 0;
   auVar8._0_8_ = uVar15;
...
;
 ...
 while ( uVar29 != uVar28 );
   ...
   *(undefined8*)pauVar31[1] = local_58;
   ...
   uVar27 = 0x3413905a;
   if (fVar3 == 0.0) {
      LAB_0010a995:fVar43 = *(float*)( pVVar34 + 4 );
      if (fVar43 != 0.0) {
         LAB_0010a935:if (NAN(fVar43)) {
      ...
      LAB_0010a9d1:uVar29 = (ulong)uVar27;
   }
 else {
      if (NAN(fVar3)) {
         uVar27 = 0x22afa5cc;
      ...
      LAB_0010a953:uVar27 = ( uVar27 << 0xd | uVar27 >> 0x13 ) * 5 + 0xe6546b64;
      uVar27 = ( uVar27 >> 0x10 ^ uVar27 ) * -0x7a143595;
...
;
   ...
   *puVar1 = uVar27;
   param_2[0xb] = param_2[0xb] + 1;
   LAB_0010aaaa:*(undefined1(**) [16])param_1 = pauVar31;
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* Ref<NavigationMeshSourceGeometryData2D>::TEMPNAMEPLACEHOLDERVALUE(Ref<NavigationMeshSourceGeometryData2D>
   const&) [clone .isra.0] [clone .cold] */void Ref<NavigationMeshSourceGeometryData2D>::operator =(Ref<NavigationMeshSourceGeometryData2D> *this, Ref *param_1) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* NavMeshGenerator2D::cleanup() [clone .cold] */void NavMeshGenerator2D::cleanup(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* NavMeshGenerator2D::generator_parse_geometry_node(Ref<NavigationPolygon>,
   Ref<NavigationMeshSourceGeometryData2D>, Node*, bool) [clone .cold] */void NavMeshGenerator2D::generator_parse_geometry_node(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* NavMeshGenerator2D::generator_parse_source_geometry_data(Ref<NavigationPolygon>,
   Ref<NavigationMeshSourceGeometryData2D>, Node*) [clone .cold] */void NavMeshGenerator2D::generator_parse_source_geometry_data(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* NavMeshGenerator2D::generator_thread_bake(void*) [clone .cold] */void NavMeshGenerator2D::generator_thread_bake(void *param_1) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Vector2>::resize<false>(long) */undefined8 CowData<Vector2>::resize<false>(CowData<Vector2> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_0010b010:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (lVar6 == lVar2) {
      LAB_0010af9c:puVar8 = *(undefined8**)this;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<int>::resize<false>(long) */undefined8 CowData<int>::resize<false>(CowData<int> *this, long param_1) {
   ...
   if (param_1 * 4 == 0) {
      LAB_0010b5b0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
/* HashSet<Ref<NavigationPolygon>, HashMapHasherDefault,
   HashMapComparatorDefault<Ref<NavigationPolygon> > >::~HashSet() */void HashSet<Ref<NavigationPolygon>,HashMapHasherDefault,HashMapComparatorDefault<Ref<NavigationPolygon>>>::~HashSet(HashSet<Ref<NavigationPolygon>,HashMapHasherDefault,HashMapComparatorDefault<Ref<NavigationPolygon>>> *this) {
   long *plVar1;
   Object *this_00;
   Object *pOVar2;
   char cVar3;
               ...
               if (cVar3 != '\0') {
                  if (*(code**)( *(long*)this_00 + 0x140 ) == NavigationPolygon::~NavigationPolygon) {
                     ...
                     *(undefined***)this_00 = &PTR__initialize_classv_0010e498;
                     ...
                     if (( *(long*)( this_00 + 0x2f8 ) != 0 ) && ( cVar3 = cVar3 != '\0' )) {
...
/* NavigationPolygon::~NavigationPolygon() */void NavigationPolygon::~NavigationPolygon(NavigationPolygon *this) {
   long *plVar1;
   Object *this_00;
   Object *pOVar2;
   long lVar3;
...
/* void memdelete<NavigationPolygon>(NavigationPolygon*) */void memdelete<NavigationPolygon>(NavigationPolygon *param_1) {
   Object *pOVar1;
   char cVar2;
   bool bVar3;
...
/* Ref<NavigationPolygon>::unref() */void Ref<NavigationPolygon>::unref(Ref<NavigationPolygon> *this) {
   char cVar1;
   if (*(long*)this != 0) {
...
/* void memdelete<NavigationMeshSourceGeometryData2D>(NavigationMeshSourceGeometryData2D*) */void memdelete<NavigationMeshSourceGeometryData2D>(NavigationMeshSourceGeometryData2D *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   long lVar4;
   ...
   if (*(code**)( *(long*)param_1 + 0x140 ) == NavigationMeshSourceGeometryData2D::~NavigationMeshSourceGeometryData2D) {
...
/* void std::vector<Clipper2Lib::Point<long>, std::allocator<Clipper2Lib::Point<long> >
   ...
   if (puVar2 == puVar1) {
      ...
      uVar7 = uVar7 << 4;
      LAB_0010c142:puVar6 = (undefined8*)operator_new(uVar7);
      uVar3 = param_3[1];
 ...
 while ( puVar10 + 2 != (undefined8*)( ( (long)param_2 - (long)puVar2 ) + (long)puVar6 ) );
      ...
      uVar7 = uVar5 * 2;
      if (uVar7 < uVar5) {
         LAB_0010c138:uVar7 = 0x7ffffffffffffff0;
         goto LAB_0010c142;
      }
   ...
   LAB_0010c0fc:if (puVar2 != (undefined8*)0x0) {
      operator_delete(puVar2, *(long*)( this + 0x10 ) - (long)puVar2);
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* std::vector<std::vector<Clipper2Lib::Point<long>, std::allocator<Clipper2Lib::Point<long> > >,
   std::allocator<std::vector<Clipper2Lib::Point<long>, std::allocator<Clipper2Lib::Point<long> > >
   > > Clipper2Lib::ScalePaths<long, double>(std::vector<std::vector<Clipper2Lib::Point<double>,
   std::allocator<Clipper2Lib::Point<double> > >,
   std::allocator<std::vector<Clipper2Lib::Point<double>, std::allocator<Clipper2Lib::Point<double>
   > > > > const&, double, double, int&) */Clipper2Lib * __thiscall
Clipper2Lib::ScalePaths<long,double>
   ...
   *(undefined1(*) [16])this = (undefined1[16])0x0;
   ...
   dVar5 = _LC69;
   dVar8 = _LC69;
   for (puVar10 = *(undefined8**)param_1; puVar10 != *(undefined8**)( param_1 + 8 ); puVar10 = puVar10 + 3) {
...
;
   ...
   if (( ( ( dVar5 * param_2 < _LC70 ) || ( __LC71 < dVar6 * param_2 ) ) || ( dVar8 * param_3 < _LC70 ) ) || ( __LC71 < dVar7 * param_3 )) {
      *param_4 = *param_4 | 0x40;
   }
 else {
      std::vector<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>,std::allocator<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point < long>>>> > ::reserve(( vector<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>,std::allocator<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point < long>>>> > *)this,( (long)*(undefined8**)( param_1 + 8 ) - (long)*(undefined8**)param_1 >> 3 ) * -0x5555555555555555 ));
      std::transform<__gnu_cxx::__normal_iterator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>const*,std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector < Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>>,std::back_insert_iterator<std::vector<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>,std::allocator < std::vector < Clipper2Lib::Point < long>,std::allocator<Clipper2Lib::Point<long>>> >> Clipper2Lib::ScalePaths<long,double>(std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector < Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>> > const & ::_lambda(auto:1_const&)_1_>
  ...
  return this;
   ...
   std::vector<std::vector<Clipper2Lib::Point<double>, std::allocator<Clipper2Lib::Point<double> >
   >, std::allocator<std::vector<Clipper2Lib::Point<double>,
   std::allocator<Clipper2Lib::Point<double> > > > > const&, int) */, Clipper2Lib * __thiscall
...
, /* WARNING: Globals starting with '_' overlap smaller symbols at the same address */, /* Clipper2Lib::ClipperD::AddSubject(std::vector<std::vector<Clipper2Lib::Point<double>,
   std::allocator<Clipper2Lib::Point<double> > >,
   std::allocator<std::vector<Clipper2Lib::Point<double>, std::allocator<Clipper2Lib::Point<double>
   > > > > const&) */, void __thiscall Clipper2Lib::ClipperD::AddSubject(ClipperD *this, vector * param_1) * pvVar3);
      double dVar4;
      double dVar5;
      double *pdVar6;
      double dVar7;
      ...
      dVar7 = _LC69;
      dVar10 = _LC69;
      for (puVar13 = *(undefined8**)param_1; puVar13 != *(undefined8**)( param_1 + 8 ); puVar13 = puVar13 + 3) {
...
;
      ...
      if (( ( ( dVar7 * dVar1 < _LC70 ) || ( __LC71 < dVar8 * dVar1 ) ) || ( dVar10 * dVar1 < _LC70 ) ) || ( __LC71 < dVar9 * dVar1 )) {
         *(uint*)( this + 0xdc ) = *(uint*)( this + 0xdc ) | 0x40;
      }
 else {
         std::vector<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>,std::allocator<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point < long>>>> > ::reserve(( vector<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>,std::allocator<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point < long>>>> > *)local_58,( (long)*(undefined8**)( param_1 + 8 ) - (long)*(undefined8**)param_1 >> 3 ) * -0x5555555555555555 ));
         local_38 = this + 0xdc;
         dStack_30 = dVar1;
         dStack_28 = dVar1;
         std::transform<__gnu_cxx::__normal_iterator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>const*,std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector < Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>>,std::back_insert_iterator<std::vector<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>,std::allocator < std::vector < Clipper2Lib::Point < long>,std::allocator<Clipper2Lib::Point<long>>> >> Clipper2Lib::ScalePaths<long,double>(std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector < Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>> > const & ::_lambda(auto:, 1_const & _1_ > ( *(undefined8 *)param_1,*(undefined8 *)(param_1 + 8),
  ...
  if (local_20 != *(long *)(in_FS_OFFSET + 0x28)) { ) = uVar4 * (undefined8*)( this + 8 ) = uVar5 * (undefined8*)( this + 0x10 ) = uVar6 * (undefined8*)( this + 0x18 ) = uVar7 < Clipper2Lib::Point<long>, std::allocator<Clipper2Lib::Point<long>>>::reserve(this_00,4)
  ;
  ...
  if (plVar8 == plVar14), {
                  std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>::_M_realloc_insert<Clipper2Lib::Point<long>>(this_00, plVar14, &local_38);
                  lVar15 = *(long*)( param_1 + 8 );
                  plVar14 = *(long**)( this + 0x30 );
...
, else {
 ...
 while ( pRVar12 != this + 400 );
   ...
   undefined8 CowData<Vector<int>>::_realloc(CowData<Vector<int>> *this, long param_1) {
      undefined8 *puVar1;
      puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
      if (puVar1 != (undefined8*)0x0) {
         *puVar1 = 1;
   ...
   undefined8 CowData<Vector<int>>::resize<false>(CowData<Vector<int>> *this, long param_1) {
      code *pcVar1;
      undefined8 *puVar2;
      undefined8 *puVar3;
      undefined8 uVar4;
      ...
      if (param_1 * 0x10 == 0) {
         LAB_0010ce30:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
         return 6;
      }
...
;
      ...
      if (lVar10 == lVar7) {
         LAB_0010cda3:puVar6 = *(undefined8**)this;
         if (puVar6 == (undefined8*)0x0) {
            LAB_0010ce86:/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException();
            ( *pcVar1 )();
         }
 ...
 while ( puVar3 != puVar11 );
   ...
   void std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>::_M_realloc_insert<Clipper2Lib::Point<double>>(vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>> *this, undefined8 *param_2, undefined8 *param_3) {
      undefined8 *puVar1;
      undefined8 *puVar2;
      undefined8 uVar3;
      undefined8 uVar4;
      ...
      if (puVar2 == puVar1) {
         ...
         uVar7 = uVar7 << 4;
         LAB_0010cfa2:puVar6 = (undefined8*)operator_new(uVar7);
         uVar3 = param_3[1];
         lVar11 = uVar7 + (long)puVar6;
         puVar10 = puVar6 + 2;
         *(undefined8*)( (long)puVar6 + (long)puVar8 ) = *param_3;
 ...
 while ( puVar10 + 2 != (undefined8*)( ( (long)param_2 - (long)puVar2 ) + (long)puVar6 ) );
         ...
         uVar7 = uVar5 * 2;
         if (uVar7 < uVar5) {
            LAB_0010cf98:uVar7 = 0x7ffffffffffffff0;
            goto LAB_0010cfa2;
         }
      ...
      puVar8 = (undefined8*)( (long)puVar10 + ( (long)puVar1 - (long)param_2 ) );
      memcpy(puVar10, param_2, (long)puVar1 - (long)param_2);
      LAB_0010cf5c:if (puVar2 != (undefined8*)0x0) {
         operator_delete(puVar2, *(long*)( this + 0x10 ) - (long)puVar2);
      }
   ...
   undefined8 Clipper2Lib::PolyPathD::AddChild(PolyPathD *this, vector *param_1) {
      double dVar1;
      long *plVar2;
      void *pvVar3;
      long lVar4;
      ...
      *puVar7 = &PTR__PolyPathD_0010e670;
      ...
      std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>::reserve((vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>*)local_58, *(long*)( param_1 + 8 ) - *(long*)param_1 >> 4);
      ...
      if (plVar2 != plVar9) {
         do {
            while (true) {
               ...
               plVar9 = plVar9 + 2;
               std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>::_M_realloc_insert<Clipper2Lib::Point<double>>((vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>*)local_58, pdStack_50, &local_68);
               pdVar8 = local_48;
...
;
 ...
 while ( plVar2 != plVar9 );
      ...
      LAB_0010d180:pvVar3 = (void*)puVar7[6];
      lVar4 = puVar7[8];
      puVar7[8] = pdVar8;
      puVar7[6] = local_58;
      puVar7[7] = pdStack_50;
      ...
      if (puVar11 == *(undefined8**)( this + 0x20 )) {
         std::vector<std::unique_ptr<Clipper2Lib::PolyPathD,std::default_delete<Clipper2Lib::PolyPathD>>,std::allocator<std::unique_ptr<Clipper2Lib::PolyPathD,std::default_delete<Clipper2Lib::PolyPathD>>>>::_M_realloc_insert<std::unique_ptr<Clipper2Lib::PolyPathD,std::default_delete<Clipper2Lib::PolyPathD>>>((vector<std::unique_ptr<Clipper2Lib::PolyPathD,std::default_delete<Clipper2Lib::PolyPathD>>,std::allocator<std::unique_ptr<Clipper2Lib::PolyPathD,std::default_delete<Clipper2Lib::PolyPathD>>>>*)( this + 0x10 ), puVar11, (vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>*)local_58);
         auVar6 = local_58;
            ...
            if (*(code**)( *(long*)local_58 + 8 ) == ~PolyPathD) {
               *(undefined***)local_58 = &PTR__PolyPathD_0010e670;
               ...
               if (puVar11 != puVar7) {
                  do {
                     while (pPVar5 = (PolyPathD*)*puVar10,pPVar5 == (PolyPathD*)0x0) {
                        LAB_0010d262:puVar10 = puVar10 + 1;
...
;
 ...
 while ( puVar11 != puVar10 );
                  LAB_0010d290:*(undefined8**)( (long)auVar6 + 0x18 ) = puVar7;
               }
               ...
               if (puVar7 != puVar11) {
                  do {
                     while (pPVar5 = (PolyPathD*)*puVar11,pPVar5 == (PolyPathD*)0x0) {
                        LAB_0010d302:puVar11 = puVar11 + 1;
...
;
 ...
 while ( puVar7 != puVar11 );
                  LAB_0010d330:puVar11 = *(undefined8**)( (long)auVar6 + 0x10 );
               }
   ...
   Clipper2Lib * Clipper2Lib::ScalePaths<double,long>(Clipper2Lib * this, vector * param_1, double, param_2, double, param_3, int, *param_4);
   {
      long lVar1;
      long lVar2;
      long *plVar3;
      ...
      *(undefined8*)( this + 0x10 ) = 0;
      *(undefined1(*) [16])this = (undefined1[16])0x0;
      std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::reserve((vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>*)this, ( lVar1 - lVar2 >> 3 ) * -0x5555555555555555);
      ...
      if (plVar5 != plVar3) {
         do {
            ...
            dVar8 = param_2;
            dVar7 = param_3;
            if (( ( param_2 == 0.0 || param_3 == 0.0 ) && ( *param_4 = *param_4 | 2 ),dVar8 = param_2,dVar7 = _LC11,param_2 == 0.0 )) {
               dVar7 = _LC11;
            }

            std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>::reserve((vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>*)local_58, plVar5[1] - *plVar5 >> 4);
            ...
            for (plVar6 = (long*)*plVar5; plVar4 != plVar6; plVar6 = plVar6 + 2) {
               while (true) {
                  ...
                  plVar6 = plVar6 + 2;
                  std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>::_M_realloc_insert<Clipper2Lib::Point<double>>((vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>*)local_58, local_58._8_8_, &local_68);
...
;
            ...
            LAB_0010d510:std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::emplace_back<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>((vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>*)this, (vector*)local_58);
 ...
 while ( plVar3 != plVar5 );
   ...
   Clipper2Lib * Clipper2Lib::InflatePaths(double, param_2, undefined8, param_2_00, undefined8, param_3, Clipper2Lib * this, vector * param_1, undefined4, param_6, undefined4, param_7,int param_8);
   {
      long lVar1;
      undefined8 uVar2;
      undefined8 uVar3;
      ...
      if (param_8 + 8U < 0x11) {
         ...
         Clipper2Lib::ClipperOffset::AddPaths((vector*)local_118, (Clipper2Lib*)local_138, param_6, param_7);
 ...
 while ( (long*)uVar2 != plVar11 );
         ...
         local_13c = 1;
         if (param_2 == 0.0) {
            LAB_0010d658:uVar8 = *(long*)( param_1 + 8 ) - *(long*)param_1;
            *(undefined8*)( this + 0x10 ) = 0;
            *(undefined1(*) [16])this = (undefined1[16])0x0;
            if (uVar8 == 0) {
               pauVar4 = (undefined1(*) [16])0x0;
               ...
               if (0x7ffffffffffffff8 < uVar8) {
                  LAB_0010db1c:std::__throw_bad_array_new_length();
                  LAB_0010db21:std::__throw_bad_alloc();
                  goto LAB_0010db26;
               }
 ...
 while ( lVar6 != lVar7 );
      ...
      LAB_0010db26:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   Clipper2Lib * Clipper2Lib::RectClip(Clipper2Lib * this, Rect * param_1, vector * param_2, int, param_3);
   {
      double dVar1;
      void *pvVar2;
      void **ppvVar3;
      ...
      if (dVar8 < dVar9) {
         ...
         if (( ( dVar7 < dVar1 ) && ( *(long*)( param_2 + 8 ) != *(long*)param_2 ) ) && ( local_23c = param_3 + 8U < 0x11 )) {
 ...
 while ( ppvVar4 != local_108 );
      ...
      *(undefined8*)( this + 0x10 ) = 0;
      *(undefined1(*) [16])this = (undefined1[16])0x0;
      LAB_0010db87:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
   ...
   void NavMeshGenerator2D::_GLOBAL__sub_I_singleton(void) {
      ...
      _DAT_00105220 = _LC83;
      __cxa_atexit(HashSet<Ref<NavigationPolygon>,HashMapHasherDefault,HashMapComparatorDefault<Ref<NavigationPolygon>>>::~HashSet, &baking_navmeshes, &__dso_handle);
      generator_tasks._40_8_ = uVar1;
      generator_tasks._8_16_ = (undefined1[16])0x0;
      generator_tasks._24_16_ = (undefined1[16])0x0;
      __cxa_atexit(HashMap<long,NavMeshGenerator2D::NavMeshGeneratorTask2D*,HashMapHasherDefault,HashMapComparatorDefault<long>,DefaultTypedAllocator<HashMapElement<long,NavMeshGenerator2D::NavMeshGeneratorTask2D*>>>::~HashMap, generator_tasks, &__dso_handle);
      _generator_parsers = 0;
      DAT_001051a8 = 0;
      __cxa_atexit(LocalVector<NavMeshGeometryParser2D*,unsigned_int,false,false>::~LocalVector, &generator_parsers, &__dso_handle);
      return;
   }
   ...
   void std::vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>>::~vector(vector<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>,std::allocator<std::vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>>> *this) {
   ...
   void Clipper2Lib::ClipperD::ClipperD(ClipperD *this, int param_1) {
      /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
   }
   ...
   void HashMap<long,NavMeshGenerator2D::NavMeshGeneratorTask2D*,HashMapHasherDefault,HashMapComparatorDefault<long>,DefaultTypedAllocator<HashMapElement<long,NavMeshGenerator2D::NavMeshGeneratorTask2D*>>>::~HashMap(HashMap<long,NavMeshGenerator2D::NavMeshGeneratorTask2D*,HashMapHasherDefault,HashMapComparatorDefault<long>,DefaultTypedAllocator<HashMapElement<long,NavMeshGenerator2D::NavMeshGeneratorTask2D*>>> *this) {
      /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
   }
   ...
   void Clipper2Lib::ClipperD::~ClipperD(ClipperD *this) {
      /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
   }
   ...
   void LocalVector<NavMeshGeometryParser2D*,unsigned_int,false,false>::~LocalVector(LocalVector<NavMeshGeometryParser2D*,unsigned_int,false,false> *this) {
      /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
   }
   ...
   void Clipper2Lib::RectClip64::RectClip64(RectClip64 *this, Rect *param_1) {
      /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
   }
   ...
   void NavigationPolygon::~NavigationPolygon(NavigationPolygon *this) {
      /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
   }
   ...
   void HashSet<Ref<NavigationPolygon>,HashMapHasherDefault,HashMapComparatorDefault<Ref<NavigationPolygon>>>::~HashSet(HashSet<Ref<NavigationPolygon>,HashMapHasherDefault,HashMapComparatorDefault<Ref<NavigationPolygon>>> *this) {
      /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
   }
   ...
   void NavigationMesh::~NavigationMesh(NavigationMesh *this) {
      /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
   }
   ...
   void NavigationMeshSourceGeometryData2D::~NavigationMeshSourceGeometryData2D(NavigationMeshSourceGeometryData2D *this) {
      /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
   }
   ...
   void Clipper2Lib::PolyPathD::~PolyPathD(PolyPathD *this) {
      /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
   }
   ...
   void List<TPPLPoly,DefaultAllocator>::~List(List<TPPLPoly,DefaultAllocator> *this) {
      /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
   }

long wslay_recv(void *param_1) {
   ...
   lVar1 = ( **(code**)( (long)param_1 + 0x1088 ) )(lVar1, (long)param_1 + ( 0x1000 - lVar1 ), 0, *(undefined8*)( (long)param_1 + 0x1098 ));
   if (lVar1 < 1) {
      lVar1 = -100;
   }
 else {
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked */void wslay_frame_context_free(void *__ptr) {
   free(__ptr);
   return;
}
ulong wslay_frame_send(long param_1, char *param_2) {
   ...
   if (*(ulong*)( param_2 + 8 ) < uVar10) {
      LAB_001004e8:uVar3 = 0xfffffffffffffed4;
      goto LAB_001001e2;
   }
   ...
   if (iVar2 == 0) {
      ...
      *(byte*)( param_1 + 0x1041 ) = bVar7;
      ...
      if (( param_2[2] & 8U ) == 0) {
         ...
         LAB_00100483:puVar12 = (undefined4*)( param_1 + 0x1042 );
      ...
      puVar13 = puVar12;
      if (param_2[0x10] == '\0') {
         LAB_001003eb:uVar1 = *(undefined8*)( param_2 + 8 );
      ...
      LAB_0010049a:uVar3 = 0xfffffffffffffed3;
      goto LAB_001001e2;
   }
   ...
   if (iVar2 == 2) {
      ...
      uVar6 = *(undefined8*)( param_1 + 0x1098 );
      LAB_00100423:lVar4 = ( **(code**)( param_1 + 0x1080 ) )(lVar8, (long)puVar13 - lVar8, uVar10 != 0, uVar6);
      if (0 < lVar4) {
      ...
      LAB_0010050e:uVar3 = 0xffffffffffffff9b;
      goto LAB_001001e2;
   }

   if (iVar2 != 3) goto LAB_001004e8;
   LAB_00100175:if (uVar10 == 0) {
      LAB_001002d8:lVar8 = *(long*)( param_1 + 0x1068 );
      uVar3 = 0;
   }
 else {
         ...
         *(long*)( param_1 + 0x1068 ) = lVar8;
         ...
         do {
            ...
            if (uVar11 != uVar10) {
               ...
               lVar4 = lVar8;
               do {
                  abStack_1048[lVar4 - lVar8] = *(byte*)( ( uVar11 - lVar8 ) + lVar4 ) ^ *(byte*)( param_1 + 0x1071 + ( ulong )((uint)lVar4 & 3) );
                  lVar4 = lVar4 + 1;
               }
 while ( lVar4 != uVar3 + lVar8 );
            }

            uVar5 = ( **(code**)( param_1 + 0x1080 ) )(abStack_1048, uVar3, 0, *(undefined8*)( param_1 + 0x1098 ));
            if ((long)uVar5 < 1) {
 ...
 while ( uVar11 < uVar10 );
   ...
   LAB_001001e2:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
...
long wslay_frame_write(long param_1, char *param_2, byte *param_3, ulong param_4, size_t *param_5) {
   ...
   *param_5 = 0;
   ...
   if (*(uint*)( param_1 + 0x1078 ) < 2) {
      uVar4 = 2;
      if (( 0x7d < uVar1 ) && ( uVar4 = 0xffff < uVar1 )) {
 ...
 while ( uVar3 < uVar7 );
   ...
   if (*(char*)( param_1 + 0x1070 ) == '\0') {
      ...
      LAB_001005c2:__dest = __dest + param_4;
   }
 else if (param_4 != 0) {
      sVar8 = 0;
      do {
         __dest[sVar8] = *(byte*)( param_1 + 0x1071 + ( ulong )((int)*(undefined8*)( param_1 + 0x1068 ) + (int)sVar8 & 3) ) ^ *(byte*)( *(long*)( param_2 + 0x18 ) + sVar8 );
         sVar8 = sVar8 + 1;
      }
 while ( param_4 != sVar8 );
      goto LAB_001005c2;
   ...
   *param_5 = param_4;
   LAB_001005cf:if (*(long*)( param_1 + 0x1068 ) == *(long*)( param_1 + 0x1060 )) {
      *(undefined4*)( param_1 + 0x1078 ) = 0;
   }
...
long wslay_frame_recv(long param_1, undefined2 *param_2) {
   ...
   if (iVar4 == 4) {
      ...
      *(byte**)( param_1 + 0x1000 ) = pbVar13;
      ...
      LAB_00100a58:*(undefined8*)( param_1 + 0x1020 ) = 0;
      ...
      *(undefined8*)( param_1 + 0x1038 ) = 4;
      LAB_00100a8b:puVar14 = *(undefined4**)( param_1 + 0x1000 );
      uVar16 = *(ulong*)( param_1 + 0x1038 );
      LAB_00100b7f:if (( ulong )((long)pbVar7 - (long)puVar14) < uVar16) {
      ...
      *(undefined4*)( param_1 + 0x1029 ) = uVar5;
      ...
      if (iVar4 == 6) {
         ...
         uVar16 = *(ulong*)( param_1 + 0x1038 );
         pbVar7 = *(byte**)( param_1 + 0x1008 );
         LAB_00100ab5:if (( ulong )((long)pbVar7 - (long)pbVar13) < uVar16) {
            lVar11 = wslay_recv(param_1);
            if (lVar11 < 1) {
               return lVar11;
            }
      ...
      LAB_0010089f:pbVar12 = *(byte**)( param_1 + 0x1000 );
   }
   ...
   if (pbVar7 == pbVar12) {
      ...
      LAB_001008c0:if (( ulong )((long)pbVar7 - (long)pbVar12) < uVar16) goto LAB_001008cf;
   }

   pbVar7 = pbVar12 + uVar16;
   LAB_001008cf:cVar15 = *(char*)( param_1 + 0x1028 );
   if (cVar15 == '\0') {

...
ulong crc32_z(uint param_1, ulong *param_2, ulong param_3) {
   ...
   if (0x2e < param_3) {
      if (( (ulong)param_2 & 7 ) == 0) {
         ...
         do {
            ...
            uVar10 = ( ulong ) * (uint*)( crc_table + ( ulong )(byte)((byte)uVar10 ^ ( byte ) * param_2) * 4 ) ^ uVar10 >> 8;
            param_3 = param_3 - 1;
            param_2 = puVar6;
            if (param_3 == 0) {
               lVar4 = -1;
      ...
      if (lVar4 == 0) {
         ...
         do {
            ...
            do {
               ...
               iVar9 = iVar9 + 1;
               lVar1 = lVar1 * 0x100;
               uVar10 = ( ulong )((uint)uVar10 ^ *(uint*)( crc_braid_table + ( ( uVar16 >> ( bVar3 & 0x3f ) & 0xff ) + lVar1 ) * 4 ));
               uVar5 = ( ulong )((uint)uVar5 ^ *(uint*)( crc_braid_table + ( ( uVar12 >> ( bVar3 & 0x3f ) & 0xff ) + lVar1 ) * 4 ));
               uVar2 = ( ulong )((uint)uVar2 ^ *(uint*)( crc_braid_table + ( ( uVar7 >> ( bVar3 & 0x3f ) & 0xff ) + lVar1 ) * 4 ));
               uVar11 = ( ulong )((uint)uVar11 ^ *(uint*)( crc_braid_table + ( ( uVar15 >> ( bVar3 & 0x3f ) & 0xff ) + lVar1 ) * 4 ));
               uVar13 = ( ulong )((uint)uVar13 ^ *(uint*)( crc_braid_table + ( lVar1 + ( uVar14 >> ( bVar3 & 0x3f ) & 0xff ) ) * 4 ));
            }
 while ( iVar9 != 8 );
            local_58 = local_58 + -1;
            puVar6 = puVar6 + 5;
 ...
 while ( iVar9 != 0 );
   ...
   if (7 < param_3) {
      ...
      do {
         puVar8 = param_2 + 1;
         uVar10 = uVar10 >> 8 ^ ( ulong ) * (uint*)( crc_table + ( ulong )(byte)((byte)uVar10 ^ ( byte ) * param_2) * 4 );
         for (int i = 0; i < 7; i++) {
            uVar10 = uVar10 >> 8 ^ ( ulong ) * (uint*)( crc_table + ( ulong )(byte)((byte)uVar10 ^ *(byte*)( (long)param_2 + ( i + 1 ) )) * 4 );
         }
 ...
 while ( puVar8 != puVar6 );
   ...
   if (param_3 != 0) {
      ...
      do {
         ...
         uVar10 = ( ulong ) * (uint*)( crc_table + ( ulong )(byte)((byte)uVar10 ^ ( byte ) * puVar6) * 4 ) ^ uVar10 >> 8;
         puVar6 = puVar8;
      }
...
uint crc32_combine64(uint param_1, uint param_2, ulong param_3) {
         ...
         if (uVar1 != 0) {
            ...
            do {
               if (( *(uint*)( x2n_table + ( ulong )(uVar5 & 0x1f) * 4 ) & uVar2 ) != 0) {
                  uVar4 = uVar4 ^ uVar3;
                  if (( uVar2 - 1 & *(uint*)( x2n_table + ( ulong )(uVar5 & 0x1f) * 4 ) ) == 0) goto code_r0x001004b9;
               }
 ...
 while ( true );
   code_r0x001004b9:uVar5 = uVar5 + 1;
...
uint crc32_combine(uint param_1, uint param_2, ulong param_3) {
      ...
      LAB_00100539:do {
         ...
         if (uVar1 != 0) {
            ...
            do {
               if (( *(uint*)( x2n_table + ( ulong )(uVar5 & 0x1f) * 4 ) & uVar2 ) != 0) {
                  uVar4 = uVar4 ^ uVar3;
                  if (( uVar2 - 1 & *(uint*)( x2n_table + ( ulong )(uVar5 & 0x1f) * 4 ) ) == 0) goto code_r0x00100579;
               }
 ...
 while ( true );
   code_r0x00100579:uVar5 = uVar5 + 1;
   ...
   if (param_1 != 0) {
      ...
      do {
         while (uVar1 = param_1 & 1,param_1 = (long)param_1 >> 1,uVar1 != 0) {
            uVar2 = 0;
            for (uVar4 = 0x80000000; ( ( *(uint*)( x2n_table + ( ulong )(uVar5 & 0x1f) * 4 ) & uVar4 ) == 0 || ( uVar2 = uVar2 ^ uVar3(uVar4 - 1 & *(uint*)( x2n_table + ( ulong )(uVar5 & 0x1f) * 4 )) != 0 ) ); uVar4 = uVar4 >> 1) {
               uVar3 = uVar3 >> 1 ^ -(uVar3 & 1) & 0xedb88320;
            }

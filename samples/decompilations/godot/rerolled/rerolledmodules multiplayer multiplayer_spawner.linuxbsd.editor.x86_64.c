/* MultiplayerSpawner::get_spawnable_scene_count() const */undefined4 MultiplayerSpawner::get_spawnable_scene_count(MultiplayerSpawner *this) {
   return *(undefined4*)( this + 0x408 );
}
/* MultiplayerSpawner::get_spawn_path() const */void MultiplayerSpawner::get_spawn_path(void) {
   long in_RSI;
   NodePath *in_RDI;
...
/* HashMap<ObjectID, MultiplayerSpawner::SpawnInfo, HashMapHasherDefault,
   ...
   .isra.0] */undefined8 HashMap<ObjectID,MultiplayerSpawner::SpawnInfo,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,MultiplayerSpawner::SpawnInfo>>>::_lookup_pos(HashMap<ObjectID,MultiplayerSpawner::SpawnInfo,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,MultiplayerSpawner::SpawnInfo>>> *this, ObjectID *param_1, uint *param_2) {
   long lVar1;
...
/* MultiplayerSpawner::get_spawnable_scene(int) const */CowData<char32_t> *MultiplayerSpawner::get_spawnable_scene(int param_1) {
   uint uVar1;
   long lVar2;
   code *pcVar3;
   uint in_EDX;
   ...
   if (( (int)in_EDX < 0 ) || ( (int)uVar1 <= (int)in_EDX )) {
      _err_print_index_error("get_spawnable_scene", "modules/multiplayer/multiplayer_spawner.cpp", 0x77, (long)(int)in_EDX, (long)(int)uVar1, "p_idx", "(int)spawnable_scenes.size()", "", false, false);
      *(undefined8*)this = 0;
      String::parse_latin1((StrRange*)this);
   }
 else {
      if (uVar1 <= in_EDX) {
         _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xae, (long)(int)in_EDX, (ulong)uVar1, "p_index", "count", "", false, true);
         _err_flush_stdout();
...
/* MultiplayerSpawner::_node_exit(ObjectID) */void MultiplayerSpawner::_node_exit(MultiplayerSpawner *this, ulong param_2) {
   uint *puVar1;
   undefined8 *puVar2;
   undefined8 *puVar3;
   long *plVar4;
...
;
         ...
         if (( uVar37 != 0 ) && ( lVar36 = lVar36 != 0 )) {
            ...
            if (( lVar5 != 0 ) && ( *(int*)( this + 0x47c ) != 0 )) {
               ...
               if (uVar50 != 0) {
                  ...
                  uVar41 = uVar40;
                  do {
                     if (( (uint)uVar45 == uVar47 ) && ( param_2 == *(ulong*)( *(long*)( lVar5 + uVar42 * 8 ) + 0x10 ) )) {
                        uVar42 = (ulong)uVar40;
                        uVar47 = 0;
                        goto LAB_0010066d;
                     }
 ...
 while ( ( uVar47 != 0 ) && ( auVar12._8_8_ = 0 ),auVar12._0_8_ = (ulong)uVar47 * lVar7,auVar24._8_8_ = 0,auVar24._0_8_ = uVar49,auVar13._8_8_ = 0,auVar13._0_8_ = ( ulong )(( uVar38 + uVar41 ) - SUB164(auVar12 * auVar24, 8)) * lVar7,auVar25._8_8_ = 0,auVar25._0_8_ = uVar49,uVar48 <= SUB164(auVar13 * auVar25, 8) );
               }
   ...
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      _err_print_error("_node_exit", "modules/multiplayer/multiplayer_spawner.cpp", 0x10d, "Parameter \"node\" is null.", 0, 0);
      return;
   }

   LAB_0010096b:/* WARNING: Subroutine does not return */__stack_chk_fail();
   LAB_0010066d:uVar41 = (uint)uVar42;
   auVar16._8_8_ = 0;
   ...
   if (( (uint)uVar45 != uVar50 ) || ( param_2 != *(ulong*)( *(long*)( lVar5 + uVar37 * 8 ) + 0x10 ) )) goto LAB_00100630;
   puVar46 = (uint*)( lVar6 + uVar43 * 4 );
   uVar50 = *puVar46;
   if (( uVar50 != 0 ) && ( auVar17._8_8_ = 0 ),auVar17._0_8_ = (ulong)uVar50 * lVar7,auVar29._8_8_ = 0,auVar29._0_8_ = uVar49,auVar18._8_8_ = 0,auVar18._0_8_ = ( ulong )(( uVar38 + uVar40 ) - SUB164(auVar17 * auVar29, 8)) * lVar7,auVar30._8_8_ = 0,auVar30._0_8_ = uVar49,uVar37 = (ulong)uVar40,SUB164(auVar18 * auVar30, 8) != 0) {
      while (true) {
         uVar45 = uVar37;
         ...
         *puVar3 = uVar8;
         ...
         puVar46 = (uint*)( lVar6 + uVar43 * 4 );
         uVar50 = *puVar46;
         if (( uVar50 == 0 ) || ( auVar19._8_8_ = 0 ),auVar19._0_8_ = (ulong)uVar50 * lVar7,auVar31._8_8_ = 0,auVar31._0_8_ = uVar49,auVar20._8_8_ = 0,auVar20._0_8_ = ( ulong )(( uVar38 + SUB164(auVar21 * auVar33, 8) ) - SUB164(auVar19 * auVar31, 8)) * lVar7,auVar32._8_8_ = 0,auVar32._0_8_ = uVar49,SUB164(auVar20 * auVar32, 8) == 0) break;
...
;
   ...
   *(int*)( this + 0x47c ) = *(int*)( this + 0x47c ) + -1;
   LAB_001007d5:Node::get_multiplayer();
   ...
   if (( uStack_5f != 0 ) && ( cVar35 = cVar35 != '\0' )) {
   ...
   goto LAB_00100860;
   LAB_00100630:uVar50 = *(uint*)( lVar6 + uVar43 * 4 );
   uVar42 = uVar43 & 0xffffffff;
   uVar47 = uVar47 + 1;
   if (( uVar50 == 0 ) || ( auVar14._8_8_ = 0 ),auVar14._0_8_ = (ulong)uVar50 * lVar7,auVar26._8_8_ = 0,auVar26._0_8_ = uVar49,auVar15._8_8_ = 0,auVar15._0_8_ = ( ulong )(( uVar38 + uVar40 ) - SUB164(auVar14 * auVar26, 8)) * lVar7,auVar27._8_8_ = 0,auVar27._0_8_ = uVar49,uVar37 = uVar43,SUB164(auVar15 * auVar27, 8) < uVar47) goto LAB_001007d5;
   goto LAB_0010066d;
}
/* MultiplayerSpawner::_spawn_notify(ObjectID) */void MultiplayerSpawner::_spawn_notify(MultiplayerSpawner *this, ulong param_2) {
   code *pcVar1;
   char cVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   if (( ( local_50 != (Object*)0x0 ) && ( cVar2 = RefCounted::unreference() ),cVar2 != '\0' )) &&( cVar2 = cVar2 != '\0' )(**(code**)( *(long*)local_50 + 0x140 ))(local_50);
...
return;}/* MultiplayerSpawner::find_spawnable_scene_index_from_path(String const&) const */ulong MultiplayerSpawner::find_spawnable_scene_index_from_path(MultiplayerSpawner *this, String *param_1) {
   char cVar1;
   ulong uVar2;
   if (*(int*)( this + 0x408 ) == 0) {
      return 0xff;
...
/* MultiplayerSpawner::find_spawnable_scene_index_from_object(ObjectID const&) const */undefined4 MultiplayerSpawner::find_spawnable_scene_index_from_object(MultiplayerSpawner *this, ObjectID *param_1) {
   long lVar1;
   long lVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   if (( lVar1 != 0 ) && ( *(int*)( this + 0x47c ) != 0 )) {
      ...
      if (uVar15 != 0) {
         uVar17 = 0;
         while (( (uint)uVar14 != uVar15 || ( *(long*)param_1 != *(long*)( *(long*)( lVar1 + lVar13 * 8 ) + 0x10 ) ) )) {
            uVar17 = uVar17 + 1;
            auVar4._8_8_ = 0;
            ...
            if (( uVar15 == 0 ) || ( auVar5._8_8_ = 0 ),auVar5._0_8_ = (ulong)uVar15 * lVar2,auVar9._8_8_ = 0,auVar9._0_8_ = uVar16,auVar6._8_8_ = 0,auVar6._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x478 ) * 4 ) + uVar12 ) - SUB164(auVar5 * auVar9, 8)) * lVar2,auVar10._8_8_ = 0,auVar10._0_8_ = uVar16,SUB164(auVar6 * auVar10, 8) < uVar17) {
               return 0xff;
            }
...
/* MultiplayerSpawner::get_spawn_argument(ObjectID const&) const */ObjectID *MultiplayerSpawner::get_spawn_argument(ObjectID *param_1) {
   long lVar1;
   long lVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
      ...
      if (uVar15 != 0) {
         ...
         do {
            if (( (uint)uVar14 == uVar15 ) && ( *in_RDX == *(long*)( *(long*)( lVar1 + lVar13 * 8 ) + 0x10 ) )) {
               Variant::Variant((Variant*)param_1, (Variant*)( *(long*)( lVar1 + (ulong)uVar12 * 8 ) + 0x18 ));
               return param_1;
            }
 ...
 while ( ( uVar15 != 0 ) && ( auVar5._8_8_ = 0 ),auVar5._0_8_ = (ulong)uVar15 * lVar2,auVar9._8_8_ = 0,auVar9._0_8_ = uVar16,auVar6._8_8_ = 0,auVar6._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( in_RSI + 0x478 ) * 4 ) + uVar12 ) - SUB164(auVar5 * auVar9, 8)) * lVar2,auVar10._8_8_ = 0,auVar10._0_8_ = uVar16,uVar17 <= SUB164(auVar6 * auVar10, 8) );
      }
...
/* WARNING: Removing unreachable block (ram,0x00100fa8) *//* MultiplayerSpawner::instantiate_custom(Variant const&) */undefined8 MultiplayerSpawner::instantiate_custom(MultiplayerSpawner *this, Variant *param_1) {
   char cVar1;
   Object *pOVar2;
   undefined8 uVar3;
   long in_FS_OFFSET;
   ...
   if (( *(uint*)( this + 0x480 ) == 0 ) || ( *(uint*)( this + 0x47c ) < *(uint*)( this + 0x480 ) )) {
      ...
      if (cVar1 == '\0') {
         _err_print_error("instantiate_custom", "modules/multiplayer/multiplayer_spawner.cpp", 0x134, "Condition \"!spawn_function.is_valid()\" is true. Returning: nullptr", "Custom spawn requires a valid \'spawn_function\'.", 0, 0);
         uVar3 = 0;
      }
 else {
         local_38[0] = 0;
         ...
         if (local_38[0] == 0x18) {
            ...
            _err_print_error("instantiate_custom", "modules/multiplayer/multiplayer_spawner.cpp", 0x13a, "Condition \"ret.get_type() != Variant::OBJECT\" is true. Returning: nullptr", "The spawn function must return a Node.", 0, 0);
            uVar3 = 0;
         }
      ...
      _err_print_error("instantiate_custom", "modules/multiplayer/multiplayer_spawner.cpp", 0x133, "Condition \"spawn_limit && spawn_limit <= tracked_nodes.size()\" is true. Returning: nullptr", "Spawn limit reached!", 0, 0);
      uVar3 = 0;
   }
...
/* MultiplayerSpawner::clear_spawnable_scenes() */void MultiplayerSpawner::clear_spawnable_scenes(MultiplayerSpawner *this) {
   ulong uVar1;
   code *pcVar2;
   char cVar3;
   long lVar4;
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   LocalVector<MultiplayerSpawner::SpawnableScene,unsigned_int,false,false>::resize((LocalVector<MultiplayerSpawner::SpawnableScene,unsigned_int,false,false>*)( this + 0x408 ), 0);
   lVar4 = Engine::get_singleton();
   if (( *(char*)( lVar4 + 0xc0 ) == '\0' ) && ( uVar1 = uVar1 != 0 )) {
...
;
      ...
      if (( uVar1 >> 0x18 & 0x7fffffffff ) == ( *puVar7 & 0x7fffffffff )) {
         uVar1 = puVar7[1];
         ObjectDB::spin_lock._0_1_ = '\0';
         if (( uVar1 != 0 ) && ( plVar5 = (long*)__dynamic_cast(uVar1, &Object::typeinfo, &Node::typeinfo, 0) ),plVar5 != (long*)0x0) {
            pcVar2 = *(code**)( *plVar5 + 0x118 );
            create_custom_callable_function_pointer<MultiplayerSpawner,Node*>(local_58, (char*)this, (_func_void_Node_ptr*)"&MultiplayerSpawner::_node_added");
   ...
   LAB_00101299:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MultiplayerSpawner::_update_spawn_node() [clone .part.0] */void MultiplayerSpawner::_update_spawn_node(MultiplayerSpawner *this) {
   ulong uVar1;
   code *pcVar2;
   char cVar3;
   long *plVar4;
...
;
         ...
         if (( uVar1 >> 0x18 & 0x7fffffffff ) == ( *puVar6 & 0x7fffffffff )) {
            uVar1 = puVar6[1];
            ObjectDB::spin_lock._0_1_ = '\0';
            if (( uVar1 != 0 ) && ( plVar4 = (long*)__dynamic_cast(uVar1, &Object::typeinfo, &Node::typeinfo, 0) ),plVar4 != (long*)0x0) {
   ...
   if (( ( cVar3 == '\0' ) || ( ( (byte)this[0x2fa] & 0x40 ) == 0 ) ) && ( plVar4 = (long*)Node::get_node_or_null((NodePath*)this) ),plVar4 != (long*)0x0) {
...
/* MultiplayerSpawner::_update_spawn_node() */void MultiplayerSpawner::_update_spawn_node(MultiplayerSpawner *this) {
   long lVar1;
...
/* MultiplayerSpawner::set_spawn_path(NodePath const&) */void MultiplayerSpawner::set_spawn_path(MultiplayerSpawner *this, NodePath *param_1) {
   long lVar1;
...
/* MultiplayerSpawner::_notification(int) [clone .part.0] */void MultiplayerSpawner::_notification(int param_1) {
   undefined8 *puVar1;
   ulong uVar2;
   code *pcVar3;
   void *pvVar4;
 ...
 while ( lVar8 != (ulong)uVar10 * 4 );
         ...
         _err_print_error("get_instance", "./core/object/object.h", 0x418, "Condition \"slot >= slot_max\" is true. Returning: nullptr", 0, 0);
         LAB_001018e9:_err_print_error("_notification", "modules/multiplayer/multiplayer_spawner.cpp", 0xd7, "Condition \"!node\" is true. Continuing.", 0, 0);
         LAB_00101760:puVar1 = (undefined8*)*puVar1;
      }
;
      while (true) {
...
;
      ...
      uVar2 = puVar11[1];
      ObjectDB::spin_lock._0_1_ = '\0';
      if (( uVar2 == 0 ) || ( plVar9 = (long*)__dynamic_cast(uVar2, &Object::typeinfo, &Node::typeinfo, 0) ),plVar9 == (long*)0x0) goto LAB_001018e9;
      pcVar3 = *(code**)( *plVar9 + 0x110 );
      create_custom_callable_function_pointer<MultiplayerSpawner,ObjectID>(&local_68, (char*)this, (_func_void_ObjectID*)"&MultiplayerSpawner::_node_exit");
      ...
      if (( CONCAT71(uStack_67, local_68) == 0 ) || ( cVar7 = cVar7 == '\0' )) goto LAB_00101760;
...
/* MultiplayerSpawner::_notification(int) */void MultiplayerSpawner::_notification(MultiplayerSpawner *this, int param_1) {
   long lVar1;
   if (param_1 == 0xb) {
...
/* MultiplayerSpawner::_track(Node*, Variant const&, int) */void MultiplayerSpawner::_track(MultiplayerSpawner *this, Node *param_1, Variant *param_2, int param_3) {
   long lVar1;
   code *pcVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   if (( *(long*)( this + 0x458 ) != 0 ) && ( *(int*)( this + 0x47c ) != 0 )) {
      ...
      if (uVar16 != 0) {
         uVar18 = 0;
         do {
            if (( (uint)uVar15 == uVar16 ) && ( local_c8 == *(long*)( *(long*)( *(long*)( this + 0x458 ) + lVar14 * 8 ) + 0x10 ) )) {
               if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                  return;
               }
 ...
 while ( ( uVar16 != 0 ) && ( auVar5._8_8_ = 0 ),auVar5._0_8_ = (ulong)uVar16 * lVar1,auVar9._8_8_ = 0,auVar9._0_8_ = uVar17,auVar6._8_8_ = 0,auVar6._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x478 ) * 4 ) + iVar13 ) - SUB164(auVar5 * auVar9, 8)) * lVar1,auVar10._8_8_ = 0,auVar10._0_8_ = uVar17,uVar18 <= SUB164(auVar6 * auVar10, 8) );
      }
   ...
   pVVar12 = (Variant*)HashMap<ObjectID,MultiplayerSpawner::SpawnInfo,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,MultiplayerSpawner::SpawnInfo>>>::operator []((HashMap<ObjectID,MultiplayerSpawner::SpawnInfo,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,MultiplayerSpawner::SpawnInfo>>>*)( this + 0x450 ), (ObjectID*)&local_c8);
   ...
   create_custom_callable_function_pointer<MultiplayerSpawner,ObjectID>(local_b8, (char*)this, (_func_void_ObjectID*)"&MultiplayerSpawner::_node_exit");
   ...
   LAB_00101d07:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MultiplayerSpawner::spawn(Variant const&) */Node * __thiscall MultiplayerSpawner::spawn(MultiplayerSpawner *this,Variant *param_1){
   ulong uVar1;
   Object *pOVar2;
   char cVar3;
   long lVar4;
   ...
   if (( (byte)this[0x2fa] & 0x40 ) == 0) {
      LAB_00101ee7:_err_print_error("spawn", "modules/multiplayer/multiplayer_spawner.cpp", 0x13f, "Condition \"!is_inside_tree() || !get_multiplayer()->has_multiplayer_peer() || !is_multiplayer_authority()\" is true. Returning: nullptr", 0, 0);
   }
 else {
      Node::get_multiplayer();
      ( **(code**)( *(long*)local_40 + 0x160 ) )(&local_38);
      if (CONCAT71(uStack_37, local_38) == 0) {
         joined_r0x00101ed8:if (( ( local_40 != (Object*)0x0 ) && ( cVar3 = RefCounted::unreference() ),cVar3 != '\0' )) &&( cVar3 = cVar3 != '\0' )(**(code**)( *(long*)local_40 + 0x140 ))(local_40);
   ...
   if (( ( local_40 != (Object*)0x0 ) && ( cVar3 = RefCounted::unreference() ),cVar3 != '\0' )) &&( cVar3 = cVar3 != '\0' )(**(code**)( *(long*)local_40 + 0x140 ))(local_40);
   Memory::free_static(local_40, false);
}
if (( *(uint*)( this + 0x480 ) == 0 ) || ( *(uint*)( this + 0x47c ) < *(uint*)( this + 0x480 ) )) {
   cVar3 = Callable::is_valid();
   if (cVar3 == '\0') {
      _err_print_error("spawn", "modules/multiplayer/multiplayer_spawner.cpp", 0x141, "Condition \"!spawn_function.is_valid()\" is true. Returning: nullptr", "Custom spawn requires the \'spawn_function\' property to be a valid callable.", 0, 0);
   }
 else {
      uVar1 = *(ulong*)( this + 0x448 );
      if (uVar1 != 0) {
...
;
            ...
            if (( uVar1 >> 0x18 & 0x7fffffffff ) == ( *puVar7 & 0x7fffffffff )) {
               ...
               if (( uVar1 != 0 ) && ( lVar4 = lVar4 != 0 )) {
                  ...
                  _err_print_error("spawn", "modules/multiplayer/multiplayer_spawner.cpp", 0x147, "Parameter \"node\" is null.", "The \'spawn_function\' callable must return a valid node.", 0, 0);
                  goto LAB_00101f0c;
               }
      ...
      _err_print_error("spawn", "modules/multiplayer/multiplayer_spawner.cpp", 0x144, "Parameter \"parent\" is null.", "Cannot find spawn node.", 0, 0);
   }

}
 else {
   _err_print_error("spawn", "modules/multiplayer/multiplayer_spawner.cpp", 0x140, "Condition \"spawn_limit && spawn_limit <= tracked_nodes.size()\" is true. Returning: nullptr", "Spawn limit reached!", 0, 0);
}
}LAB_00101f0c:pNVar5 = (Node*)0x0;LAB_00101ea6:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return pNVar5;}/* MultiplayerSpawner::_get(StringName const&, Variant&) const */undefined4 MultiplayerSpawner::_get(MultiplayerSpawner *this, StringName *param_1, Variant *param_2) {
   long lVar1;
   char *__s;
   undefined4 uVar2;
   uint uVar3;
      ...
      if ((char)uVar2 != '\0') {
         ...
         if (uVar3 < *(uint*)( this + 0x408 )) {
            ...
            *(undefined8*)( param_2 + 0x10 ) = uStack_48;
            ...
            uVar2 = 0;
            _err_print_index_error("_get", "modules/multiplayer/multiplayer_spawner.cpp", 0x3e, (ulong)uVar3, ( ulong ) * (uint*)( this + 0x408 ), "index", "spawnable_scenes.size()", "", false, false);
         }
...
/* MultiplayerSpawner::instantiate_scene(int) */undefined8 MultiplayerSpawner::instantiate_scene(MultiplayerSpawner *this, int param_1) {
   char cVar1;
   undefined8 uVar2;
   Object *pOVar3;
   long lVar4;
   ...
   if (( *(uint*)( this + 0x480 ) == 0 ) || ( *(uint*)( this + 0x47c ) < *(uint*)( this + 0x480 ) )) {
      if ((uint)param_1 < *(uint*)( this + 0x408 )) {
         ...
         if (lVar5 == 0) {
               ...
               if (pOVar6 != pOVar3) {
                  *(Object**)( lVar4 + 8 ) = pOVar3;
                  if (pOVar3 == (Object*)0x0) {
                     ...
                     if (pOVar6 != (Object*)0x0) {
                        LAB_001024fd:cVar1 = RefCounted::unreference();
                        if (cVar1 != '\0') {
            ...
            LAB_00102464:CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
            lVar5 = *(long*)( lVar4 + 8 );
            if (lVar5 == 0) {
               operator+((char *)&
               local_48,(String*)"Invalid spawnable scene: ";
               _err_print_error("instantiate_scene", "modules/multiplayer/multiplayer_spawner.cpp", 0x12e, "Condition \"sc.cache.is_null()\" is true. Returning: nullptr", (CowData<char32_t>*)&local_48, 0, 0);
      ...
      _err_print_index_error("instantiate_scene", "modules/multiplayer/multiplayer_spawner.cpp", 0x129, (ulong)(uint)param_1, ( ulong ) * (uint*)( this + 0x408 ), "(uint32_t)p_id", "spawnable_scenes.size()", "", false, false);
   }
 else {
      _err_print_error("instantiate_scene", "modules/multiplayer/multiplayer_spawner.cpp", 0x128, "Condition \"spawn_limit && spawn_limit <= tracked_nodes.size()\" is true. Returning: nullptr", "Spawn limit reached!", 0, 0);
   }

   LAB_001024c0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 0;
   }

   LAB_0010261a:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MultiplayerSpawner::_node_added(Node*) */void MultiplayerSpawner::_node_added(MultiplayerSpawner *this, Node *param_1) {
   Object *pOVar1;
   char cVar2;
   long lVar3;
   long lVar4;
   ...
   if (local_60 != (Object*)0x0) {
      ...
      if (cVar2 != '\0') {
         if (( ( local_68 != (Object*)0x0 ) && ( cVar2 = RefCounted::unreference() ),pOVar1 = local_68,cVar2 != '\0' )) &&( cVar2 = cVar2 != '\0' )(**(code**)( *(long*)pOVar1 + 0x140 ))(pOVar1);
         Memory::free_static(pOVar1, false);
      }

      cVar2 = HashMap<ObjectID,MultiplayerSpawner::SpawnInfo,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,MultiplayerSpawner::SpawnInfo>>>::_lookup_pos((HashMap<ObjectID,MultiplayerSpawner::SpawnInfo,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,MultiplayerSpawner::SpawnInfo>>>*)( this + 0x450 ), *(ObjectID**)( param_1 + 0x60 ), (uint*)&local_60);
      if (( ( cVar2 == '\0' ) && ( lVar3 = get_spawn_node(this) ),lVar3 != 0 )) {
         Node::get_scene_file_path();
         if (*(int*)( this + 0x408 ) != 0) {
            lVar3 = 0;
            do {
               cVar2 = String::operator ==((String*)( lVar3 * 0x10 + *(long*)( this + 0x410 ) ), (String*)&local_60);
               if (cVar2 != '\0') {
                  ...
                  if ((int)lVar3 != 0xff) {
                     ...
                     if (local_60 == (Object*)0x0) {
                        ...
                        if (*(char**)( local_60 + 8 ) == (char*)0x0) {
                           if (*(long*)( local_60 + 0x10 ) != 0) {
                              CowData<char32_t>::_ref((CowData<char32_t>*)&local_78, (CowData*)( local_60 + 0x10 ));
                              goto LAB_00102791;
                           }
                           ...
                           LAB_00102791:if (( StringName::configured == '\0' ) || ( local_60 == (Object*)0x0 )) goto LAB_001027aa;
                        }

                        StringName::unref();
                     }

                     LAB_001027aa:String::validate_node_name();
                     ...
                     if (cVar2 == '\0') {
                        ...
                        local_70 = 0;
                        String::parse_latin1((String*)&local_70, "Unable to auto-spawn node with reserved name: %s. Make sure to add your replicated scenes via \'add_child(node, true)\' to produce valid names.");
                        vformat<String>((String*)&local_60, (String*)&local_70, (CowData<char32_t>*)&local_68);
                        _err_print_error("_node_added", "modules/multiplayer/multiplayer_spawner.cpp", 0xf0, "Condition \"name.validate_node_name() != name\" is true.", (String*)&local_60, 0, 0);
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_78);
...
if (( ( local_68 != (Object*)0x0 ) && ( cVar2 = RefCounted::unreference() ),pOVar1 = local_68,cVar2 != '\0' )) &&( cVar2 = cVar2 != '\0' )(**(code**)( *(long*)pOVar1 + 0x140 ))(pOVar1);Memory::free_static(pOVar1, false);}LAB_00102833:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return;}/* MultiplayerSpawner::_set(StringName const&, Variant const&) */undefined4 MultiplayerSpawner::_set(MultiplayerSpawner *this, StringName *param_1, Variant *param_2) {
   long lVar1;
   char *__s;
   code *pcVar2;
   undefined4 uVar3;
   ...
   if ((char)uVar3 == '\0') {
      ...
      if ((char)uVar3 != '\0') {
         ...
         if (uVar4 < *(uint*)( this + 0x408 )) {
            ...
            if (*(uint*)( this + 0x408 ) <= uVar4) {
               _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, (ulong)uVar4, ( ulong ) * (uint*)( this + 0x408 ), "p_index", "count", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
            ...
            uVar3 = 0;
            _err_print_index_error("_set", "modules/multiplayer/multiplayer_spawner.cpp", 0x2e, (ulong)uVar4, ( ulong ) * (uint*)( this + 0x408 ), "index", "spawnable_scenes.size()", "", false, false);
         }
      ...
      LocalVector<MultiplayerSpawner::SpawnableScene,unsigned_int,false,false>::resize((LocalVector<MultiplayerSpawner::SpawnableScene,unsigned_int,false,false>*)( this + 0x408 ), uVar4);
...
/* MultiplayerSpawner::add_spawnable_scene(String const&) */void MultiplayerSpawner::add_spawnable_scene(String *param_1) {
   CowData<char32_t> *this;
   code *pcVar1;
   undefined8 uVar2;
   undefined *puVar3;
   ...
   if (*(char*)( lVar6 + 0xc0 ) == '\0') {
      LAB_00102d5f:local_58 = (undefined*)0x0;
      if (local_68._0_8_ != 0) {
      ...
      *(undefined8*)( this + 8 ) = 0;
      ...
      if (( *(int*)( param_1 + 0x408 ) == 1 ) && ( plVar7 != (long*)0x0 )) {
         ...
         create_custom_callable_function_pointer<MultiplayerSpawner,Node*>((MultiplayerSpawner*)&local_58, (char*)param_1, (_func_void_Node_ptr*)"&MultiplayerSpawner::_node_added");
      ...
      _err_print_error("add_spawnable_scene", "modules/multiplayer/multiplayer_spawner.cpp", 100, "Condition \"!ResourceLoader::exists(sc.path)\" is true.", 0, 0);
      LAB_00102e3d:if (local_68._8_8_ == 0) goto LAB_00102e50;
      cVar5 = RefCounted::unreference();
   }
   ...
   LAB_00102e50:CowData<char32_t>::_unref((CowData<char32_t>*)local_68);
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MultiplayerSpawner::_set_spawnable_scenes(Vector<String> const&) */void MultiplayerSpawner::_set_spawnable_scenes(MultiplayerSpawner *this, Vector *param_1) {
   long lVar1;
   long lVar2;
...
/* MultiplayerSpawner::_get_property_list(List<PropertyInfo, DefaultAllocator>*) const */void MultiplayerSpawner::_get_property_list(MultiplayerSpawner *this, List *param_1) {
   long lVar1;
   long *plVar2;
   char *pcVar3;
   long lVar4;
   ...
   LAB_001032ff:local_c0 = (StrRange*)&local_80;
...
/* MultiplayerSpawner::_bind_methods() */void MultiplayerSpawner::_bind_methods(void) {
   long *plVar1;
   char cVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   PropertyInfo::PropertyInfo((PropertyInfo*)&local_118, 0x22, (StrRange*)&local_178, 0, (StrRange*)&local_170, 10, &local_168);
   ...
   local_110 = 10;
   String::parse_latin1((StrRange*)&local_178);
   PropertyInfo::PropertyInfo((PropertyInfo*)&local_118, 0x16, (StrRange*)&local_178, 0, (StrRange*)&local_170, 6, &local_168);
   local_148 = "MultiplayerSpawner";
   local_180 = 0;
   local_140 = 0x12;
   String::parse_latin1((StrRange*)&local_180);
   ...
   local_110 = 0xb;
   String::parse_latin1((StrRange*)&local_178);
   PropertyInfo::PropertyInfo((PropertyInfo*)&local_118, 2, (StrRange*)&local_178, 1, (StrRange*)&local_170, 6, &local_168);
   local_148 = "MultiplayerSpawner";
   local_180 = 0;
   local_140 = 0x12;
   String::parse_latin1((StrRange*)&local_180);
   ...
   local_110 = 0xe;
   String::parse_latin1((StrRange*)&local_178);
   PropertyInfo::PropertyInfo((PropertyInfo*)&local_118, 0x19, (StrRange*)&local_178, 0, (StrRange*)&local_170, 0, &local_168);
   local_148 = "MultiplayerSpawner";
   local_180 = 0;
   local_140 = 0x12;
   String::parse_latin1((StrRange*)&local_180);
   ...
   local_110 = 4;
   String::parse_latin1((StrRange*)&local_178);
   PropertyInfo::PropertyInfo((PropertyInfo*)&local_148, 0x18, (StrRange*)&local_178, 0x11, (StrRange*)&local_170, 6, &local_168);
   local_118 = "despawned";
   local_160 = 0;
   local_110 = 9;
   String::parse_latin1((StrRange*)&local_160);
   for (int i = 0; i < 16; i++) {
      local_108[i] = (CowData<StringName>)0;
   }
...
/* MultiplayerSpawner::_get_spawnable_scenes() const */void MultiplayerSpawner::_get_spawnable_scenes(void) {
   long *plVar1;
   long *plVar2;
   uint uVar3;
   long lVar4;
...
;
   uVar11 = 0;
   LAB_00105133:iVar7 = 0x38;
   pcVar10 = "./core/templates/vector.h";
   pcVar12 = "((Vector<T> *)(this))->_cowdata.size()";
   LAB_00105112:_err_print_index_error("operator[]", pcVar10, iVar7, lVar9, uVar11, "p_index", pcVar12, "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar5 = (code*)invalidInstructionException();
   ( *pcVar5 )();
}
/* MultiplayerSpawner::get_configuration_warnings() const */void MultiplayerSpawner::get_configuration_warnings(void) {
   CowData<char32_t> *this;
   char cVar1;
   int iVar2;
   long lVar3;
   ...
   local_58 = "A valid NodePath must be set in the \"Spawn Path\" property in order for MultiplayerSpawner to be able to spawn Nodes.";
   local_68 = 0;
   local_50 = 0x74;
   String::parse_latin1((StrRange*)&local_68);
   ...
   LAB_001052a5:CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   LAB_001052bd:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MultiplayerSpawner::is_class_ptr(void*) const */uint MultiplayerSpawner::is_class_ptr(MultiplayerSpawner *this, void *param_1) {
   return (uint)CONCAT71(0x1126, (undefined4*)param_1 == &Node::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1126, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1126, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* MultiplayerSpawner::_property_can_revertv(StringName const&) const */undefined8 MultiplayerSpawner::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* MultiplayerSpawner::_property_get_revertv(StringName const&, Variant&) const */undefined8 MultiplayerSpawner::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* MultiplayerSpawner::get_spawn_limit() const */undefined4 MultiplayerSpawner::get_spawn_limit(MultiplayerSpawner *this) {
   return *(undefined4*)( this + 0x480 );
}
/* MultiplayerSpawner::set_spawn_limit(unsigned int) */void MultiplayerSpawner::set_spawn_limit(MultiplayerSpawner *this, uint param_1) {
   *(uint*)( this + 0x480 ) = param_1;
   return;
}
/* CallableCustomMethodPointer<MultiplayerSpawner, void, ObjectID>::~CallableCustomMethodPointer()
    */void CallableCustomMethodPointer<MultiplayerSpawner,void,ObjectID>::~CallableCustomMethodPointer(CallableCustomMethodPointer<MultiplayerSpawner,void,ObjectID> *this) {
   return;
}
/* CallableCustomMethodPointer<MultiplayerSpawner, void, Node*>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<MultiplayerSpawner,void,Node*>::~CallableCustomMethodPointer(CallableCustomMethodPointer<MultiplayerSpawner,void,Node*> *this) {
   return;
}
...
/* MethodBindTRC<Callable>::_gen_argument_type(int) const */undefined8 MethodBindTRC<Callable>::_gen_argument_type(int param_1) {
   return 0x19;
}
/* MethodBindTRC<Callable>::get_argument_meta(int) const */undefined8 MethodBindTRC<Callable>::get_argument_meta(int param_1) {
   return 0;
}
...
/* MethodBindTR<Node*, Variant const&>::_gen_argument_type(int) const */byte MethodBindTR<Node*,Variant_const&>::_gen_argument_type(MethodBindTR<Node*,Variant_const&> *this, int param_1) {
   return -(param_1 != 0) & 0x18;
}
/* MethodBindTR<Node*, Variant const&>::get_argument_meta(int) const */undefined8 MethodBindTR<Node*,Variant_const&>::get_argument_meta(int param_1) {
   return 0;
}
...
/* CallableCustomMethodPointer<MultiplayerSpawner, void, ObjectID>::get_argument_count(bool&) const
    */undefined8 CallableCustomMethodPointer<MultiplayerSpawner,void,ObjectID>::get_argument_count(CallableCustomMethodPointer<MultiplayerSpawner,void,ObjectID> *this, bool *param_1) {
   *param_1 = true;
   return 1;
}
/* CallableCustomMethodPointer<MultiplayerSpawner, void, Node*>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<MultiplayerSpawner,void,Node*>::get_argument_count(CallableCustomMethodPointer<MultiplayerSpawner,void,Node*> *this, bool *param_1) {
   *param_1 = true;
   return 1;
}
...
/* MultiplayerSpawner::set_spawn_function(Callable) */void MultiplayerSpawner::set_spawn_function(MultiplayerSpawner *this, Callable *param_2) {
   Callable::operator =((Callable*)( this + 0x488 ), param_2);
   return;
}
/* MultiplayerSpawner::get_spawn_function() const */void MultiplayerSpawner::get_spawn_function(void) {
   long in_RSI;
   Callable *in_RDI;
...
/* MethodBindTR<Node*, Variant const&>::~MethodBindTR() */void MethodBindTR<Node*,Variant_const&>::~MethodBindTR(MethodBindTR<Node*,Variant_const&> *this) {
...
/* MethodBindTRC<Callable>::~MethodBindTRC() */void MethodBindTRC<Callable>::~MethodBindTRC(MethodBindTRC<Callable> *this) {
...
/* MultiplayerSpawner::_validate_propertyv(PropertyInfo&) const */void MultiplayerSpawner::_validate_propertyv(PropertyInfo *param_1) {
...
/* CallableCustomMethodPointer<MultiplayerSpawner, void, ObjectID>::get_object() const */undefined8 CallableCustomMethodPointer<MultiplayerSpawner,void,ObjectID>::get_object(CallableCustomMethodPointer<MultiplayerSpawner,void,ObjectID> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_00105c3d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallableCustomMethodPointer<MultiplayerSpawner, void, Node*>::get_object() const */undefined8 CallableCustomMethodPointer<MultiplayerSpawner,void,Node*>::get_object(CallableCustomMethodPointer<MultiplayerSpawner,void,Node*> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_00105d3d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MultiplayerSpawner::_get_class_namev() const */undefined8 *MultiplayerSpawner::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00105e63:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00105e63;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "MultiplayerSpawner");
         goto LAB_00105ece;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "MultiplayerSpawner");
   LAB_00105ece:return &_get_class_namev();
}
/* MultiplayerSpawner::get_class() const */void MultiplayerSpawner::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* MultiplayerSpawner::get_spawn_node() const */undefined8 MultiplayerSpawner::get_spawn_node(MultiplayerSpawner *this) {
   ulong uVar1;
   long lVar2;
   undefined8 uVar3;
   uint uVar4;
...
;
   ...
   LAB_00106c27:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* LocalVector<MultiplayerSpawner::SpawnableScene, unsigned int, false, false>::resize(unsigned int)
    */void LocalVector<MultiplayerSpawner::SpawnableScene,unsigned_int,false,false>::resize(LocalVector<MultiplayerSpawner::SpawnableScene,unsigned_int,false,false> *this, uint param_1) {
   long *plVar1;
 ...
 while ( uVar12 < *(uint*)this );
      ...
      pauVar2 = (undefined1(*) [16])( *(long*)( this + 8 ) + 0x10 + ( ( ulong )(uVar9 - uVar12) + (ulong)uVar12 ) * 0x10 );
 ...
 while ( pauVar2 != pauVar8 );
   ...
   LAB_00106d90:*(uint*)this = param_1;
   return;
}
/* MultiplayerSpawner::~MultiplayerSpawner() */void MultiplayerSpawner::~MultiplayerSpawner(MultiplayerSpawner *this) {
   uint uVar1;
   long lVar2;
   void *pvVar3;
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
   ...
   LAB_00106f37:NodePath::~NodePath((NodePath*)( this + 0x440 ));
   pvVar3 = *(void**)( this + 0x418 );
   if (pvVar3 != (void*)0x0) {
      if (*(int*)( this + 0x43c ) != 0) {
         if (*(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x438 ) * 4 ) != 0) {
            memset(*(void**)( this + 0x430 ), 0, ( ulong ) * (uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x438 ) * 4 ) << 2);
         }
...
/* Callable create_custom_callable_function_pointer<MultiplayerSpawner, Node*>(MultiplayerSpawner*,
   char const*, void (MultiplayerSpawner::*)(Node*)) */MultiplayerSpawner *create_custom_callable_function_pointer<MultiplayerSpawner,Node*>(MultiplayerSpawner *param_1, char *param_2, _func_void_Node_ptr *param_3) {
   undefined8 uVar1;
   CallableCustom *this;
   undefined8 in_RCX;
   undefined8 in_R8;
...
/* Callable create_custom_callable_function_pointer<MultiplayerSpawner,
   ObjectID>(MultiplayerSpawner*, char const*, void (MultiplayerSpawner::*)(ObjectID)) */MultiplayerSpawner *create_custom_callable_function_pointer<MultiplayerSpawner,ObjectID>(MultiplayerSpawner *param_1, char *param_2, _func_void_ObjectID *param_3) {
   undefined8 uVar1;
   CallableCustom *this;
   undefined8 in_RCX;
   undefined8 in_R8;
...
/* MultiplayerSpawner::_notificationv(int, bool) */void MultiplayerSpawner::_notificationv(MultiplayerSpawner *this, int param_1, bool param_2) {
   long lVar1;
   int iVar2;
   iVar2 = (int)this;
   if (param_2) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<ObjectID, MultiplayerSpawner::SpawnInfo, HashMapHasherDefault,
   HashMapComparatorDefault<ObjectID>, DefaultTypedAllocator<HashMapElement<ObjectID,
   MultiplayerSpawner::SpawnInfo> > >::operator[](ObjectID const&) */Variant * __thiscallHashMap<ObjectID,MultiplayerSpawner::SpawnInfo,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,MultiplayerSpawner::SpawnInfo>>>::operator [](HashMap<ObjectID,MultiplayerSpawner::SpawnInfo,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,MultiplayerSpawner::SpawnInfo>>> * this, ObjectID * param_1) * puVar1 ;undefined8 *puVar2uint uVar3void *pvVar4void *__slong lVar5long lVar6undefined1 auVar7[16]undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1 auVar15[16]undefined1 auVar16[16]undefined1 auVar17[16]undefined1 auVar18[16]undefined1 auVar19[16]undefined1 auVar20[16]undefined1 auVar21[16]undefined1 auVar22[16]char cVar23ulong uVar24undefined8 uVar25void *__s_00undefined8 *puVar26void *pvVar27int iVar28long lVar29long lVar30uint uVar31ObjectID *pOVar32ulong uVar33uint uVar34undefined8 uVar35ulong uVar36uint uVar37uint uVar38undefined8 *puVar39long in_FS_OFFSETuint local_f8Variant *local_d8uint local_a0uint local_9cint local_98[2]undefined1 local_90[16]undefined4 local_80undefined1 local_78[16]undefined8 local_68int local_60[6]undefined4 local_48long local_40pOVar32 = *(ObjectID**)param_1;local_40 = *(long*)( in_FS_OFFSET + 0x28 );local_a0 = 0;cVar23 = _lookup_pos(this, pOVar32, &local_a0);if (cVar23 != '\0') {
   local_d8 = (Variant*)( *(long*)( *(long*)( this + 8 ) + (ulong)local_a0 * 8 ) + 0x18 );
   goto LAB_00107852;
}
local_98[0] = 0;local_98[1] = 0;local_80 = 0xff;uVar31 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );local_90 = (undefined1[16])0x0;if (*(long*)( this + 8 ) == 0) {
   uVar33 = (ulong)uVar31;
   uVar24 = uVar33 * 4;
   uVar36 = uVar33 * 8;
...
local_9c = 0;cVar23 = _lookup_pos(this, pOVar32, &local_9c);if (cVar23 == '\0') {
...
LAB_0010783d:if (Variant::needs_deinit[local_98[0]] != '\0') {
   Variant::_clear_internal();
}
...
/* MethodBindTRC<NodePath>::_gen_argument_type_info(int) const */undefined4 *MethodBindTRC<NodePath>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar3 + 2 ) = (undefined1[16])0x0;
   ...
   StringName::operator =((StringName*)( puVar3 + 4 ), (StringName*)&local_50);
   LAB_00107d25:CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   lVar2 = local_58;
   if (local_58 != 0) {
      LOCK();
      plVar1 = (long*)( local_58 + -0x10 );
...
/* MultiplayerSpawner::_getv(StringName const&, Variant&) const */void MultiplayerSpawner::_getv(MultiplayerSpawner *this, StringName *param_1, Variant *param_2) {
   _get(this, param_1, param_2);
   return;
}
/* WARNING: Removing unreachable block (ram,0x00107f78) *//* String vformat<String>(String const&, String const) */undefined8 *vformat<String>(undefined8 *param_1, bool *param_2, String *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* CallableCustomMethodPointer<MultiplayerSpawner, void, ObjectID>::call(Variant const**, int,
   Variant&, Callable::CallError&) const */void CallableCustomMethodPointer<MultiplayerSpawner,void,ObjectID>::call(CallableCustomMethodPointer<MultiplayerSpawner,void,ObjectID> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   ulong uVar3;
   char cVar4;
...
;
   ...
   LAB_001085db:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* CallableCustomMethodPointer<MultiplayerSpawner, void, Node*>::call(Variant const**, int,
   Variant&, Callable::CallError&) const */void CallableCustomMethodPointer<MultiplayerSpawner,void,Node*>::call(CallableCustomMethodPointer<MultiplayerSpawner,void,Node*> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   Variant *this_00;
   ulong uVar3;
...
;
            ...
            *(undefined4*)param_4 = 0;
            ...
            if (cVar5 == '\0') {
               ...
               *(undefined8*)( param_4 + 4 ) = uVar4;
               ...
               if (( ( pOVar7 == (Object*)0x0 ) || ( lVar8 = __dynamic_cast(pOVar7, &Object::typeinfo, &Node::typeinfo, 0) ),lVar8 == 0 )) goto LAB_00108720;
            }
   ...
   LAB_001088d7:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MultiplayerSpawner::_setv(StringName const&, Variant const&) */void MultiplayerSpawner::_setv(MultiplayerSpawner *this, StringName *param_1, Variant *param_2) {
   _set(this, param_1, param_2);
   return;
}
/* MultiplayerSpawner::is_class(String const&) const */undefined8 MultiplayerSpawner::is_class(MultiplayerSpawner *this, String *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   char *pcVar4;
 ...
 while ( !bVar9 );
      ...
      LAB_0010896f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar5 = local_60;
      if (local_60 != 0) {
         LOCK();
   ...
   LAB_00108a23:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_00108c10:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindTRC<unsigned int>::_gen_argument_type_info(int) const */undefined4 *MethodBindTRC<unsigned_int>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar3 + 2 ) = (undefined1[16])0x0;
   ...
   StringName::operator =((StringName*)( puVar3 + 4 ), (StringName*)&local_50);
   LAB_00108d15:CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   lVar2 = local_58;
   if (local_58 != 0) {
      LOCK();
      plVar1 = (long*)( local_58 + -0x10 );
...
/* MethodBindTRC<int>::_gen_argument_type_info(int) const */undefined4 *MethodBindTRC<int>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar1 + 2 ) = (undefined1[16])0x0;
   ...
   LAB_00108ea5:CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   if (( StringName::configured != '\0' ) && ( local_50 != 0 )) {
      StringName::unref();
   }
...
/* MethodBindTRC<Callable>::_gen_argument_type_info(int) const */undefined4 *MethodBindTRC<Callable>::_gen_argument_type_info(int param_1) {
   long *plVar1;
   long lVar2;
   undefined4 in_register_0000003c;
   undefined4 *puVar3;
   ...
   *(undefined1(*) [16])( puVar3 + 2 ) = (undefined1[16])0x0;
   ...
   StringName::operator =((StringName*)( puVar3 + 4 ), (StringName*)&local_50);
   LAB_00109005:CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   lVar2 = local_58;
   if (local_58 != 0) {
      LOCK();
      plVar1 = (long*)( local_58 + -0x10 );
...
/* MethodBindT<NodePath const&>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<NodePath_const&>::_gen_argument_type_info(int param_1) {
   ...
   *puVar5 = local_68._0_4_;
   ...
   LAB_001090fb:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBindT<String const&>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<String_const&>::_gen_argument_type_info(int param_1) {
   ...
   *puVar5 = local_68._0_4_;
   ...
   puVar5[10] = local_40;
   PropertyInfo::~PropertyInfo((PropertyInfo*)&local_68);
   LAB_0010933b:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBindT<Callable>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<Callable>::_gen_argument_type_info(int param_1) {
   ...
   *puVar5 = local_68._0_4_;
   ...
   puVar5[10] = local_40;
   PropertyInfo::~PropertyInfo((PropertyInfo*)&local_68);
   LAB_0010957b:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBindT<unsigned int>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<unsigned_int>::_gen_argument_type_info(int param_1) {
   ...
   *puVar5 = local_68._0_4_;
   ...
   puVar5[10] = local_40;
   PropertyInfo::~PropertyInfo((PropertyInfo*)&local_68);
   LAB_001097bb:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBindT<Vector<String> const&>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<Vector<String>const&>::_gen_argument_type_info(int param_1) {
   ...
   *puVar5 = local_68._0_4_;
   ...
   puVar5[10] = local_40;
   PropertyInfo::~PropertyInfo((PropertyInfo*)&local_68);
   LAB_001099fb:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBindTR<Node*, Variant const&>::_gen_argument_type_info(int) const */undefined4 *MethodBindTR<Node*,Variant_const&>::_gen_argument_type_info(int param_1) {
   undefined1 auVar1[16];
   undefined8 uVar2;
   undefined8 uVar3;
   int in_EDX;
   ...
   if (in_EDX == 0) {
      ...
      local_a8 = 0;
      local_b0 = 0;
      PropertyInfo::PropertyInfo((PropertyInfo*)&local_68, 0, (CowData<char32_t>*)&local_b0, 0, (CowData<char32_t>*)&local_a8, 0x20006, &local_a0);
...
/* MultiplayerSpawner::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void MultiplayerSpawner::_get_property_listv(MultiplayerSpawner *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010a0ef:List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
...
/* MethodBindTRC<String, int>::_gen_argument_type_info(int) const */undefined4 *MethodBindTRC<String,int>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar4 + 2 ) = (undefined1[16])0x0;
   if (local_a0 == 0) {
      puVar4[10] = 6;
      LAB_0010a70f:StringName::operator =((StringName*)( puVar4 + 4 ), (StringName*)&local_98);
   }
 else {
   ...
   LAB_0010a74a:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar4;
   }
...
/* MethodBind* create_method_bind<MultiplayerSpawner, String const&>(void
   (MultiplayerSpawner::*)(String const&)) */MethodBind *create_method_bind<MultiplayerSpawner,String_const&>(_func_void_String_ptr *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<MultiplayerSpawner, int>(int (MultiplayerSpawner::*)() const) */MethodBind *create_method_bind<MultiplayerSpawner,int>(_func_int *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<MultiplayerSpawner, String, int>(String
   (MultiplayerSpawner::*)(int) const) */MethodBind *create_method_bind<MultiplayerSpawner,String,int>(_func_String_int *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<MultiplayerSpawner>(void (MultiplayerSpawner::*)()) */MethodBind *create_method_bind<MultiplayerSpawner>(_func_void *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<MultiplayerSpawner, Vector<String>>(Vector<String>
   (MultiplayerSpawner::*)() const) */MethodBind *create_method_bind<MultiplayerSpawner,Vector<String>>(_func_Vector *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<MultiplayerSpawner, Vector<String> const&>(void
   (MultiplayerSpawner::*)(Vector<String> const&)) */MethodBind *create_method_bind<MultiplayerSpawner,Vector<String>const&>(_func_void_Vector_ptr *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<MultiplayerSpawner, Node*, Variant const&>(Node*
   (MultiplayerSpawner::*)(Variant const&)) */MethodBind *create_method_bind<MultiplayerSpawner,Node*,Variant_const&>(_func_Node_ptr_Variant_ptr *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<MultiplayerSpawner, NodePath>(NodePath (MultiplayerSpawner::*)()
   const) */MethodBind *create_method_bind<MultiplayerSpawner,NodePath>(_func_NodePath *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<MultiplayerSpawner, NodePath const&>(void
   (MultiplayerSpawner::*)(NodePath const&)) */MethodBind *create_method_bind<MultiplayerSpawner,NodePath_const&>(_func_void_NodePath_ptr *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<MultiplayerSpawner, unsigned int>(unsigned int
   (MultiplayerSpawner::*)() const) */MethodBind *create_method_bind<MultiplayerSpawner,unsigned_int>(_func_uint *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<MultiplayerSpawner, unsigned int>(void
   (MultiplayerSpawner::*)(unsigned int)) */MethodBind *create_method_bind<MultiplayerSpawner,unsigned_int>(_func_void_uint *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<MultiplayerSpawner, Callable>(Callable (MultiplayerSpawner::*)()
   const) */MethodBind *create_method_bind<MultiplayerSpawner,Callable>(_func_Callable *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<MultiplayerSpawner, Callable>(void
   (MultiplayerSpawner::*)(Callable)) */MethodBind *create_method_bind<MultiplayerSpawner,Callable>(_func_void_Callable *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MultiplayerSpawner::_initialize_classv() */void MultiplayerSpawner::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   undefined8 local_58;
   long local_50;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<String>::resize<false>(long) */undefined8 CowData<String>::resize<false>(CowData<String> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_0010be50:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar9 == lVar5) {
      LAB_0010bdcb:puVar7 = *(undefined8**)this;
      if (puVar7 == (undefined8*)0x0) {
         LAB_0010bea6:/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException();
         ( *pcVar1 )();
      }
   ...
   LAB_0010bd3f:puVar7[-1] = param_1;
   return 0;
}
/* WARNING: Removing unreachable block (ram,0x0010bfd8) *//* String vformat<StringName>(String const&, StringName const) */undefined8 *vformat<StringName>(undefined8 *param_1, bool *param_2, StringName *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* MethodBindT<Callable>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<Callable>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   long lVar1;
   Variant *pVVar2;
   code *pcVar3;
   long in_FS_OFFSET;
   ...
   LAB_0010c2ec:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<Callable>::ptrcall(Object*, void const**, void*) const */void MethodBindT<Callable>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   long lVar1;
   long *plVar2;
   code *pcVar3;
   long in_FS_OFFSET;
   ...
   ( *pcVar3 )((long*)( (long)param_2 + lVar1 ), (Callable*)&local_48);
   Callable::~Callable((Callable*)&local_48);
   LAB_0010c4d9:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<Callable>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindTRC<Callable>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   long *plVar3;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   LAB_0010c7d0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTRC<Callable>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTRC<Callable>::validated_call(MethodBindTRC<Callable> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   code *pcVar1;
   long *plVar2;
   ...
   if (( ( param_1 != (Object*)0x0 ) && ( *(long*)( param_1 + 8 ) != 0 ) ) && ( *(char*)( *(long*)( param_1 + 8 ) + 0x2e ) != '\0' )) {
      ...
      if (local_48 == (Variant**)*plVar2) {
         ...
         String::parse_latin1((StrRange*)&local_50);
         vformat<StringName>((Callable*)&local_48, (StrRange*)&local_50, &local_58);
         _err_print_error("validated_call", "./core/object/method_bind.h", 0x273, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true.", (Callable*)&local_48, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_48);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
         if (( StringName::configured != '\0' ) && ( local_58 != 0 )) {
            StringName::unref();
   ...
   Callable::~Callable((Callable*)&local_48);
   LAB_0010c9f9:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<Callable>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<Callable>::ptrcall(MethodBindTRC<Callable> *this, Object *param_1, void **param_2, void *param_3) {
   code *pcVar1;
   long *plVar2;
   void **extraout_RDX;
   long in_FS_OFFSET;
   ...
   Callable::~Callable((Callable*)&local_48);
   LAB_0010cbca:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<unsigned int>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<unsigned_int>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   LAB_0010cf11:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<unsigned int>::ptrcall(Object*, void const**, void*) const */void MethodBindT<unsigned_int>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   LAB_0010d0f1:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindTRC<unsigned int>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindTRC<unsigned_int>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   LAB_0010d1c0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTRC<unsigned int>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTRC<unsigned_int>::validated_call(MethodBindTRC<unsigned_int> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   *(ulong*)( param_3 + 8 ) = (ulong)uVar1;
   LAB_0010d3d4:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<unsigned int>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<unsigned_int>::ptrcall(MethodBindTRC<unsigned_int> *this, Object *param_1, void **param_2, void *param_3) {
   ...
   *(ulong*)param_3 = (ulong)uVar1;
   LAB_0010d583:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<NodePath const&>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<NodePath_const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   LAB_0010d8c1:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<NodePath const&>::ptrcall(Object*, void const**, void*) const */void MethodBindT<NodePath_const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   LAB_0010daa1:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindTRC<NodePath>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindTRC<NodePath>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   LAB_0010db80:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTRC<NodePath>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTRC<NodePath>::validated_call(MethodBindTRC<NodePath> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   LAB_0010dda9:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<NodePath>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<NodePath>::ptrcall(MethodBindTRC<NodePath> *this, Object *param_1, void **param_2, void *param_3) {
   ...
   NodePath::~NodePath((NodePath*)&local_48);
   LAB_0010df7a:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<Vector<String> const&>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<Vector<String>const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   code *UNRECOVERED_JUMPTABLE;
   Variant *pVVar1;
   long in_FS_OFFSET;
   long local_58;
   ...
   LAB_0010e2c9:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<Vector<String> const&>::ptrcall(Object*, void const**, void*) const */void MethodBindT<Vector<String>const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   code *UNRECOVERED_JUMPTABLE;
   long *plVar1;
   long in_FS_OFFSET;
   long local_58;
   ...
   LAB_0010e4a1:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindTRC<Vector<String>>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindTRC<Vector<String>>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   LAB_0010e580:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTRC<Vector<String>>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTRC<Vector<String>>::validated_call(MethodBindTRC<Vector<String>> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   LAB_0010e7c7:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   LAB_0010ec20:*(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindT<>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   LAB_0010ef9f:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<>::ptrcall(Object*, void const**, void*) const */void MethodBindT<>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   LAB_0010f15f:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindTRC<String, int>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTRC<String,int>::validated_call(MethodBindTRC<String,int> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_48);
   LAB_0010f1e2:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<String, int>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<String,int>::ptrcall(MethodBindTRC<String,int> *this, Object *param_1, void **param_2, void *param_3) {
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_48);
   LAB_0010f3d0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTR<Node*, Variant const&>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTR<Node*,Variant_const&>::validated_call(MethodBindTR<Node*,Variant_const&> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   code *pcVar1;
   long *plVar2;
   long in_FS_OFFSET;
   long local_58;
...
/* MethodBindTR<Node*, Variant const&>::ptrcall(Object*, void const**, void*) const */void MethodBindTR<Node*,Variant_const&>::ptrcall(MethodBindTR<Node*,Variant_const&> *this, Object *param_1, void **param_2, void *param_3) {
   undefined8 uVar1;
   long *plVar3;
   long in_FS_OFFSET;
   long local_58;
   ...
   *(undefined8*)param_3 = uVar1;
   LAB_00110136:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<Callable>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<Callable>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   long lVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   if (in_R8D < 2) {
      ...
      if (pVVar10 == (Variant*)0x0) {
         ...
         LAB_00110420:pVVar10 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar10 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_00110430:uVar6 = 4;
            goto LAB_001103d5;
         }
      ...
      *in_R9 = 0;
      ...
      uVar6 = 3;
      LAB_001103d5:*in_R9 = uVar6;
      in_R9[2] = 1;
   }

   LAB_001103e0:*(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindT<NodePath const&>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<NodePath_const&>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   if (in_R8D < 2) {
      ...
      if (pVVar10 == (Variant*)0x0) {
         ...
         LAB_00110750:pVVar10 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar10 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_00110760:uVar6 = 4;
            goto LAB_00110705;
         }
      ...
      *in_R9 = 0;
      ...
      uVar6 = 3;
      LAB_00110705:*in_R9 = uVar6;
      in_R9[2] = 1;
   }

   LAB_00110710:*(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTR<Node*, Variant const&>::call(Object*, Variant const**, int, Callable::CallError&)
   const */Object *MethodBindTR<Node*,Variant_const&>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   long lVar2;
   code *pcVar3;
   char cVar4;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (( ( plVar9 != (long*)0x0 ) && ( plVar9[1] != 0 ) ) && ( *(char*)( plVar9[1] + 0x2e ) != '\0' )) {
      ...
      if (local_78 == (char*)*plVar7) {
         ...
         _err_print_error(&_LC72, "./core/object/method_bind.h", 0x207, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_78, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_78);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_80);
         if (( StringName::configured != '\0' ) && ( local_88 != 0 )) {
            StringName::unref();
   ...
   if (in_R8D < 2) {
      ...
      if (pVVar10 == (Variant*)0x0) {
         ...
         LAB_00110aa0:pVVar10 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar10 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_00110ab0:uVar5 = 4;
            goto LAB_00110a65;
         }
      ...
      *in_R9 = 0;
      ...
      pOVar6 = (Object*)( *(code*)pVVar11 )((Variant*)( (long)plVar9 + (long)pVVar1 ), (Variant*)local_48);
      ...
      *(undefined8*)( param_1 + 0x10 ) = uStack_58;
      ...
      uVar5 = 3;
      LAB_00110a65:*in_R9 = uVar5;
      in_R9[2] = 1;
   }

   LAB_00110a70:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindT<Vector<String> const&>::call(Object*, Variant const**, int, Callable::CallError&)
   const */Object *MethodBindT<Vector<String>const&>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   long lVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   if (in_R8D < 2) {
      ...
      if (pVVar10 == (Variant*)0x0) {
         ...
         LAB_00110e00:pVVar10 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar10 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_00110e10:uVar6 = 4;
            goto LAB_00110db5;
         }
      ...
      *in_R9 = 0;
      ...
      uVar6 = 3;
      LAB_00110db5:*in_R9 = uVar6;
      in_R9[2] = 1;
   }

   LAB_00110dc0:*(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   if (in_R8D < 2) {
      ...
      if (pVVar11 == (Variant*)0x0) {
         ...
         LAB_00111160:pVVar11 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar11 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_00111170:uVar7 = 4;
            goto LAB_00111115;
         }
      ...
      *(undefined8*)( param_1 + 0x10 ) = uStack_48;
      ...
      uVar7 = 3;
      LAB_00111115:*in_R9 = uVar7;
      in_R9[2] = 1;
   }

   LAB_00111120:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBindT<String const&>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<String_const&>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   if (in_R8D < 2) {
      ...
      if (pVVar10 == (Variant*)0x0) {
         ...
         LAB_001114d0:pVVar10 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar10 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_001114e0:uVar6 = 4;
            goto LAB_00111485;
         }
      ...
      *in_R9 = 0;
      ...
      uVar6 = 3;
      LAB_00111485:*in_R9 = uVar6;
      in_R9[2] = 1;
   }

   LAB_00111490:*(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* void call_with_variant_args_dv<__UnexistingClass, unsigned int>(__UnexistingClass*, void
   ...
   if (lVar1 == 0) {
      ...
      if ((int)lVar2 < (int)( uVar8 ^ 1 )) {
         LAB_00111800:uVar6 = 4;
         LAB_0011179d:*(undefined4*)param_6 = uVar6;
   ...
   LAB_0011171b:*(undefined4*)param_6 = 0;
...
/* MethodBindT<unsigned int>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<unsigned_int>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   *(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   LAB_00111866:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* WARNING: Control flow encountered bad instruction data *//* MultiplayerSpawner::~MultiplayerSpawner() */void MultiplayerSpawner::~MultiplayerSpawner(MultiplayerSpawner *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* MethodBindT<Callable>::~MethodBindT() */void MethodBindT<Callable>::~MethodBindT(MethodBindT<Callable> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* MethodBindTRC<Callable>::~MethodBindTRC() */void MethodBindTRC<Callable>::~MethodBindTRC(MethodBindTRC<Callable> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* MethodBindTR<Node*, Variant const&>::~MethodBindTR() */void MethodBindTR<Node*,Variant_const&>::~MethodBindTR(MethodBindTR<Node*,Variant_const&> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* MethodBindT<Vector<String> const&>::~MethodBindT() */void MethodBindT<Vector<String>const&>::~MethodBindT(MethodBindT<Vector<String>const&> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<MultiplayerSpawner, void, Node*>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<MultiplayerSpawner,void,Node*>::~CallableCustomMethodPointer(CallableCustomMethodPointer<MultiplayerSpawner,void,Node*> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<MultiplayerSpawner, void, ObjectID>::~CallableCustomMethodPointer()
    */void CallableCustomMethodPointer<MultiplayerSpawner,void,ObjectID>::~CallableCustomMethodPointer(CallableCustomMethodPointer<MultiplayerSpawner,void,ObjectID> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

...
;
         ...
         if (pOVar17 == (Object*)0x0) {
            ...
            cVar11 = RefCounted::unreference();
            joined_r0x001019e4:if (( cVar11 != '\0' ) && ( cVar11 = cVar11 != '\0' )) {
      ...
      for (lVar2 = *local_98; lVar2 != 0; lVar2 = *(long*)( lVar2 + 0x30 )) {
         if (( *(byte*)( lVar2 + 0x28 ) & 2 ) != 0) {
            ...
            if (local_68._4_4_ != 0) {
               ...
               lVar22 = 0;
               do if (( cVar15 != '\0' ) && ( cVar15 = cVar15 != '\0' )) lVar22 = lVar22 + 1; while ( true );
            }
...
/* Resource::duplicate(bool) const */undefined8 *Resource::duplicate(bool param_1) {
   ...
   if (( pSVar3 == (StringName*)0x0 ) || ( cVar2 = cVar2 == '\0' )) {
...
/* Resource::setup_local_to_scene() */void __thiscall Resource::setup_local_to_scene(Resource *this)

...
/* GodotPhysicsServer2D::space_get_direct_state(RID) */undefined8 GodotPhysicsServer2D::space_get_direct_state(GodotPhysicsServer2D *this, ulong param_2) {
   ...
   if (( param_2 != 0 ) && ( (uint)param_2 < *(uint*)( this + 0x22c ) )) {
      ...
      if (iVar1 == (int)( param_2 >> 0x20 )) {
         if (*plVar4 != 0) {
            if (( ( this[0x180] == (GodotPhysicsServer2D)0x0 ) || ( this[0x172] != (GodotPhysicsServer2D)0x0 ) ) && ( cVar2 = cVar2 == '\0' )) {
...
/* GodotPhysicsServer2D::_initialize_classv() */void GodotPhysicsServer2D::_initialize_classv(void) {
   ...
   if (PhysicsServer2D::initialize_class() == '\0') {
      ...
      PhysicsServer2D::initialize_class()::initialized =
      '\x01';
   }
   ...
   '\x01';
   LAB_0010e624:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* GodotPhysicsServer2D::is_class(String const&) const */undefined8 GodotPhysicsServer2D::is_class(GodotPhysicsServer2D *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
...
/* PhysicsServer2D::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void PhysicsServer2D::_get_property_listv(List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
...
/* GodotPhysicsServer2D::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void GodotPhysicsServer2D::_get_property_listv(GodotPhysicsServer2D *this, List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   undefined1(*pauVar4)[16];
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashSet<GodotSpace2D*, HashMapHasherDefault, HashMapComparatorDefault<GodotSpace2D*>
   >::insert(GodotSpace2D* const&) */undefined1[16];HashSet<GodotSpace2D*,HashMapHasherDefault,HashMapComparatorDefault<GodotSpace2D*>>::insert(GodotSpace2D **param_1) {
   uint *puVar1;
   long lVar2;
   long lVar3;
   void *pvVar4;
...
/* WARNING: Removing unreachable block (ram,0x0010fc10) *//* WARNING: Removing unreachable block (ram,0x0010fd40) *//* WARNING: Removing unreachable block (ram,0x0010feb9) *//* WARNING: Removing unreachable block (ram,0x0010fd4c) *//* WARNING: Removing unreachable block (ram,0x0010fd56) *//* WARNING: Removing unreachable block (ram,0x0010fe9b) *//* WARNING: Removing unreachable block (ram,0x0010fd62) *//* WARNING: Removing unreachable block (ram,0x0010fd6c) *//* WARNING: Removing unreachable block (ram,0x0010fe7d) *//* WARNING: Removing unreachable block (ram,0x0010fd78) *//* WARNING: Removing unreachable block (ram,0x0010fd82) *//* WARNING: Removing unreachable block (ram,0x0010fe5f) *//* WARNING: Removing unreachable block (ram,0x0010fd8e) *//* WARNING: Removing unreachable block (ram,0x0010fd98) *//* WARNING: Removing unreachable block (ram,0x0010fe41) *//* WARNING: Removing unreachable block (ram,0x0010fda4) *//* WARNING: Removing unreachable block (ram,0x0010fdae) *//* WARNING: Removing unreachable block (ram,0x0010fe23) *//* WARNING: Removing unreachable block (ram,0x0010fdb6) *//* WARNING: Removing unreachable block (ram,0x0010fdc0) *//* WARNING: Removing unreachable block (ram,0x0010fe08) *//* WARNING: Removing unreachable block (ram,0x0010fdc8) *//* WARNING: Removing unreachable block (ram,0x0010fdde) *//* WARNING: Removing unreachable block (ram,0x0010fdea) *//* String vformat<unsigned int, char const*>(String const&, unsigned int const, char const* const)
...
/* RID_Alloc<GodotShape2D*, true>::~RID_Alloc() */void RID_Alloc<GodotShape2D*,true>::~RID_Alloc(RID_Alloc<GodotShape2D*,true> *this) {
   long *plVar1;
   long lVar2;
   uint uVar3;
   uint uVar4;
...
/* RID_Alloc<GodotSpace2D*, true>::~RID_Alloc() */void RID_Alloc<GodotSpace2D*,true>::~RID_Alloc(RID_Alloc<GodotSpace2D*,true> *this) {
   long *plVar1;
   long lVar2;
   uint uVar3;
   uint uVar4;
...
/* RID_Alloc<GodotArea2D*, true>::~RID_Alloc() */void RID_Alloc<GodotArea2D*,true>::~RID_Alloc(RID_Alloc<GodotArea2D*,true> *this) {
   long *plVar1;
   long lVar2;
   uint uVar3;
   uint uVar4;
...
/* RID_Alloc<GodotBody2D*, true>::~RID_Alloc() */void RID_Alloc<GodotBody2D*,true>::~RID_Alloc(RID_Alloc<GodotBody2D*,true> *this) {
   long *plVar1;
   long lVar2;
   uint uVar3;
   uint uVar4;
...
/* RID_Alloc<GodotJoint2D*, true>::~RID_Alloc() */void RID_Alloc<GodotJoint2D*,true>::~RID_Alloc(RID_Alloc<GodotJoint2D*,true> *this) {
   long *plVar1;
   long lVar2;
   uint uVar3;
   uint uVar4;
...
/* GodotPhysicsServer2D::~GodotPhysicsServer2D() */void GodotPhysicsServer2D::~GodotPhysicsServer2D(GodotPhysicsServer2D *this) {
   long *plVar1;
   long lVar2;
   uint uVar3;
   uint uVar4;
...
/* CowData<GodotBody2D::Contact>::_realloc(long) */undefined8 CowData<GodotBody2D::Contact>::_realloc(CowData<GodotBody2D::Contact> *this, long param_1) {
   undefined8 *puVar1;
   puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
   if (puVar1 != (undefined8*)0x0) {
      *puVar1 = 1;
...
/* WARNING: Removing unreachable block (ram,0x001128c8) *//* WARNING: Removing unreachable block (ram,0x001129f8) *//* WARNING: Removing unreachable block (ram,0x00112bc0) *//* WARNING: Removing unreachable block (ram,0x00112a04) *//* WARNING: Removing unreachable block (ram,0x00112a0e) *//* WARNING: Removing unreachable block (ram,0x00112ba0) *//* WARNING: Removing unreachable block (ram,0x00112a1a) *//* WARNING: Removing unreachable block (ram,0x00112a24) *//* WARNING: Removing unreachable block (ram,0x00112b80) *//* WARNING: Removing unreachable block (ram,0x00112a30) *//* WARNING: Removing unreachable block (ram,0x00112a3a) *//* WARNING: Removing unreachable block (ram,0x00112b60) *//* WARNING: Removing unreachable block (ram,0x00112a46) *//* WARNING: Removing unreachable block (ram,0x00112a50) *//* WARNING: Removing unreachable block (ram,0x00112b40) *//* WARNING: Removing unreachable block (ram,0x00112a5c) *//* WARNING: Removing unreachable block (ram,0x00112a66) *//* WARNING: Removing unreachable block (ram,0x00112b20) *//* WARNING: Removing unreachable block (ram,0x00112a72) *//* WARNING: Removing unreachable block (ram,0x00112a7c) *//* WARNING: Removing unreachable block (ram,0x00112b00) *//* WARNING: Removing unreachable block (ram,0x00112a84) *//* WARNING: Removing unreachable block (ram,0x00112a9a) *//* WARNING: Removing unreachable block (ram,0x00112aa6) *//* String vformat<String>(String const&, String const) */undefined8 *vformat<String>(undefined8 *param_1, bool *param_2, String *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* RID_Alloc<GodotSpace2D*, true>::make_rid(GodotSpace2D* const&) */ulong RID_Alloc<GodotSpace2D*,true>::make_rid(RID_Alloc<GodotSpace2D*,true> *this, GodotSpace2D **param_1) {
   pthread_mutex_t *__mutex;
   long *plVar1;
   uint uVar2;
   long lVar3;
...
/* RID_Alloc<GodotShape2D*, true>::make_rid(GodotShape2D* const&) */ulong RID_Alloc<GodotShape2D*,true>::make_rid(RID_Alloc<GodotShape2D*,true> *this, GodotShape2D **param_1) {
   pthread_mutex_t *__mutex;
   long *plVar1;
   uint uVar2;
   long lVar3;
...
/* RID_Alloc<GodotArea2D*, true>::make_rid(GodotArea2D* const&) */ulong RID_Alloc<GodotArea2D*,true>::make_rid(RID_Alloc<GodotArea2D*,true> *this, GodotArea2D **param_1) {
   pthread_mutex_t *__mutex;
   long *plVar1;
   uint uVar2;
   long lVar3;
...
/* RID_Alloc<GodotBody2D*, true>::make_rid(GodotBody2D* const&) */ulong RID_Alloc<GodotBody2D*,true>::make_rid(RID_Alloc<GodotBody2D*,true> *this, GodotBody2D **param_1) {
   pthread_mutex_t *__mutex;
   long *plVar1;
   uint uVar2;
   long lVar3;
...
/* RID_Alloc<GodotJoint2D*, true>::make_rid(GodotJoint2D* const&) */ulong RID_Alloc<GodotJoint2D*,true>::make_rid(RID_Alloc<GodotJoint2D*,true> *this, GodotJoint2D **param_1) {
   pthread_mutex_t *__mutex;
   long *plVar1;
   uint uVar2;
   long lVar3;
...
/* WARNING: Control flow encountered bad instruction data *//* GodotPhysicsServer2D::~GodotPhysicsServer2D() */void GodotPhysicsServer2D::~GodotPhysicsServer2D(GodotPhysicsServer2D *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* RID_Alloc<GodotJoint2D*, true>::~RID_Alloc() */void RID_Alloc<GodotJoint2D*,true>::~RID_Alloc(RID_Alloc<GodotJoint2D*,true> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* RID_Alloc<GodotBody2D*, true>::~RID_Alloc() */void RID_Alloc<GodotBody2D*,true>::~RID_Alloc(RID_Alloc<GodotBody2D*,true> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* RID_Alloc<GodotArea2D*, true>::~RID_Alloc() */void RID_Alloc<GodotArea2D*,true>::~RID_Alloc(RID_Alloc<GodotArea2D*,true> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* RID_Alloc<GodotSpace2D*, true>::~RID_Alloc() */void RID_Alloc<GodotSpace2D*,true>::~RID_Alloc(RID_Alloc<GodotSpace2D*,true> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* RID_Alloc<GodotShape2D*, true>::~RID_Alloc() */void RID_Alloc<GodotShape2D*,true>::~RID_Alloc(RID_Alloc<GodotShape2D*,true> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

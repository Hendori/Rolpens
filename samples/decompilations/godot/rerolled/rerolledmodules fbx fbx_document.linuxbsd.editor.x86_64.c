/* FBXDocument::generate_buffer(Ref<GLTFState>) */long FBXDocument::generate_buffer(long param_1) {
   *(undefined8*)( param_1 + 8 ) = 0;
   return param_1;
}
/* FBXDocument::write_to_filesystem(Ref<GLTFState>, String const&) */undefined8 FBXDocument::write_to_filesystem(void) {
   return 2;
}
/* FBXDocument::append_from_scene(Node*, Ref<GLTFState>, unsigned int) */undefined8 FBXDocument::append_from_scene(void) {
   return 2;
}
/* CowData<Vector2>::_realloc(long) [clone .part.0] */undefined8 CowData<Vector2>::_realloc(long param_1) {
   _err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
   return 6;
}
/* CowData<Quaternion>::_copy_on_write() [clone .isra.0] */void CowData<Quaternion>::_copy_on_write(CowData<Quaternion> *this) {
   long *plVar1;
   undefined8 *puVar2;
   long lVar3;
   code *pcVar4;
 ...
 while ( lVar8 != lVar7 );
   ...
   *plVar1 = *plVar1 + -1;
   ...
   LAB_0010029f:*(undefined8**)this = puVar6 + 2;
   return;
}
...
/* HashMap<int, Node*, HashMapHasherDefault, HashMapComparatorDefault<int>,
   ...
   const [clone .isra.0] */undefined8 HashMap<int,Node*,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Node*>>>::_lookup_pos(HashMap<int,Node*,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Node*>>> *this, int *param_1, uint *param_2) {
   ulong uVar1;
...
/* Ref<Material>::TEMPNAMEPLACEHOLDERVALUE(Ref<Material> const&) [clone .isra.0] */void Ref<Material>::operator =(Ref<Material> *this, Ref *param_1) {
   Object *pOVar1;
   char cVar2;
   pOVar1 = *(Object**)this;
...
/* Ref<GLTFMesh>::TEMPNAMEPLACEHOLDERVALUE(Ref<GLTFMesh> const&) [clone .isra.0] */void Ref<GLTFMesh>::operator =(Ref<GLTFMesh> *this, Ref *param_1) {
   Object *pOVar1;
   char cVar2;
   pOVar1 = *(Object**)this;
   if (pOVar1 != (Object*)param_1) {
...
/* Ref<GLTFNode>::TEMPNAMEPLACEHOLDERVALUE(Ref<GLTFNode> const&) [clone .isra.0] */void Ref<GLTFNode>::operator =(Ref<GLTFNode> *this, Ref *param_1) {
   Object *pOVar1;
   char cVar2;
   pOVar1 = *(Object**)this;
   if (pOVar1 != (Object*)param_1) {
...
/* Ref<FBXState>::TEMPNAMEPLACEHOLDERVALUE(Ref<FBXState> const&) [clone .isra.0] */void Ref<FBXState>::operator =(Ref<FBXState> *this, Ref *param_1) {
   Object *pOVar1;
   char cVar2;
   pOVar1 = *(Object**)this;
   if (pOVar1 != (Object*)param_1) {
...
/* FBXDocument::_sanitize_animation_name(String const&) */String *FBXDocument::_sanitize_animation_name(String *param_1) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   undefined8 local_28;
...
/* FBXDocument::_as_vec3(ufbx_vec3 const&) */undefined1[16];FBXDocument::_as_vec3(ufbx_vec3 *param_1) {
   long in_FS_OFFSET;
...
/* FBXDocument::_as_string(ufbx_string const&) */FBXDocument * __thiscall FBXDocument::_as_string(FBXDocument *this,ufbx_string *param_1){
   long lVar1;
   long in_FS_OFFSET;
...
/* FBXDocument::_as_xform(ufbx_matrix const&) */FBXDocument * __thiscall FBXDocument::_as_xform(FBXDocument *this,ufbx_matrix *param_1){
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;
...
/* FBXDocument::_gen_unique_name(HashSet<String, HashMapHasherDefault,
   HashMapComparatorDefault<String> >&, String const&) */HashSet *FBXDocument::_gen_unique_name(HashSet *param_1, String *param_2) {
   long *plVar1;
   uint uVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   *(undefined8*)param_1 = 0;
   lVar14 = 0;
   local_88 = 1;
   LAB_00100ff0:if (local_60 != lVar14) {
 ...
 while ( true );
   ...
   return param_1;
   LAB_00101167:local_88 = local_88 + 1;
   lVar14 = *(long*)param_1;
   goto LAB_00100ff0;
}
/* FBXDocument::_assign_node_names(Ref<FBXState>) */void FBXDocument::_assign_node_names(undefined8 param_1, long *param_2) {
   long *plVar1;
   long lVar2;
   undefined8 uVar3;
   code *pcVar4;
   ...
   do {
      ...
      if (*(int*)( pSVar7 + 0x28c ) < 0) {
         ...
         if (local_58 == (char*)0x0) {
            LAB_00101239:if (*(int*)( pSVar7 + 0x280 ) < 0) {
...
/* FBXDocument::_gen_unique_animation_name(Ref<FBXState>, String const&) */FBXDocument * __thiscall
FBXDocument::_gen_unique_animation_name(FBXDocument *this,undefined8 param_2,long *param_3){
   ...
   *(undefined8*)this = 0;
   lVar15 = 0;
   LAB_00101500:if (local_60 != lVar15) {
   ...
   if (( *(long*)( lVar15 + 0x418 ) != 0 ) && ( *(int*)( lVar15 + 0x43c ) != 0 )) {
      ...
      if (uVar14 != 0) {
         ...
         do {
            if (uVar14 == uVar16) {
               cVar13 = String::operator ==((String*)( *(long*)( lVar15 + 0x418 ) + ( ulong ) * (uint*)( *(long*)( lVar15 + 0x420 ) + lVar18 * 4 ) * 8 ), (String*)this);
            ...
            if (( uVar14 == 0 ) || ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar14 * lVar3,auVar10._8_8_ = 0,auVar10._0_8_ = uVar12,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( uVar2 + iVar17 ) - SUB164(auVar6 * auVar10, 8)) * lVar3,auVar11._8_8_ = 0,auVar11._0_8_ = uVar12,SUB164(auVar7 * auVar11, 8) < uVar21) break;
         }
 while ( true );
      }
...
/* FBXDocument::_generate_spatial(Ref<FBXState>, int) */Node3D * __thiscall FBXDocument::_generate_spatial(undefined8 param_1,long *param_2,int param_3){
   long lVar1;
   code *pcVar2;
   char cVar3;
   Node3D *this;
   ...
   if (lVar4 < 0) {
      ...
      if (lVar4 < lVar6) {
         ...
         if (cVar3 != '\0') {
            Resource::get_name();
            operator+((char *)
            local_68,(String*)"FBX: Converting spatial: ";
   ...
   lVar6 = 0;
   LAB_00101ae9:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar4, lVar6, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar2 = (code*)invalidInstructionException();
   ( *pcVar2 )();
}
/* FBXDocument::_generate_bone_attachment(Ref<FBXState>, Skeleton3D*, int, int) */BoneAttachment3D * __thiscall
FBXDocument::_generate_bone_attachment
   ...
   if (lVar4 < 0) {
      ...
      if (pOVar5 == (Object*)0x0) {
         ...
         LAB_00101be4:lVar7 = *(long*)( lVar3 + -8 );
         if (lVar4 < lVar7) {
            ...
            if (cVar2 != '\0') {
               Resource::get_name();
               operator+((char *)
               local_68,(String*)"FBX: Creating bone attachment for: ";
               ::Variant::Variant((Variant*)local_58, (String*)local_68);
            ...
            if (pOVar6[0x290] == (Object)0x0) {
               ...
               _err_print_error("_generate_bone_attachment", "modules/fbx/fbx_document.cpp", 0x5c9, "Condition \"!bone_node->joint\" is true. Returning: nullptr", 0, 0);
            }
 else {
               Resource::get_name();
...
lVar7 = 0;LAB_00101dd0:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar4, lVar7, "p_index", "size()", "", false, true);_err_flush_stdout();/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException();( *pcVar1 )();}/* FBXDocument::_generate_camera(Ref<FBXState>, int) */undefined8 FBXDocument::_generate_camera(undefined8 param_1, long *param_2, int param_3) {
   int iVar1;
   code *pcVar2;
   char cVar3;
   undefined8 uVar4;
   ...
   if (lVar6 < 0) {
      ...
      if (iVar1 < 0) {
         ...
         if (iVar1 < lVar5) {
            ...
            if (cVar3 != '\0') {
               Resource::get_name();
               operator+((char *)
               local_68,(String*)"FBX: Creating camera for: ";
               ::Variant::Variant((Variant*)local_58, (String*)local_68);
               stringify_variants(local_60);
               __print_line((String*)local_60);
               CowData<char32_t>::_unref((CowData<char32_t>*)local_60);
      ...
      uVar4 = 0;
      _err_print_index_error("_generate_camera", "modules/fbx/fbx_document.cpp", 0x5e8, (long)iVar1, lVar5, "fbx_node->camera", "p_state->cameras.size()", "", false, false);
      cVar3 = RefCounted::unreference();
      joined_r0x00102139:if (( cVar3 != '\0' ) && ( cVar3 = cVar3 != '\0' )) {
   ...
   LAB_00102170:lVar9 = 0;
   LAB_00102075:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar6, lVar9, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar2 = (code*)invalidInstructionException();
   ( *pcVar2 )();
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FBXDocument::_generate_light(Ref<FBXState>, int) */String * __thiscall
FBXDocument::_generate_light
      ...
      if (iVar1 < 0) {
         ...
         if (lVar6 != 0) {
            ...
            if (cVar3 != '\0') {
               Resource::get_name();
               operator+((char *)
               local_88,(String*)"FBX: Creating light for: ";
            ...
            if (cVar3 == '\0') {
               ...
               this(String * 0x0);
               _err_print_error("_generate_light", "modules/fbx/fbx_document.cpp", 0x601, "Parameter \"light\" is null.", 0, 0);
            }
 else {
               this(String * operator_new(0x620, ""));
               OmniLight3D::OmniLight3D((OmniLight3D*)this);
               postinitialize_handler((Object*)this);
               LAB_001022fe:Resource::get_name();
               Node::set_name(this);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_80);
               ...
               local_4c = 0;
               local_68 = local_78;
               pTVar4 = (Transform3D*)__dynamic_cast(this, &Object::typeinfo, &DirectionalLight3D::typeinfo, 0);
               ...
               if (pTVar4 == (Transform3D*)0x0) {
                  ...
                  LAB_001026c5:fVar12 = (float)GLTFLight::get_inner_cone_angle();
                  ...
                  pTVar4 = pTVar5;
                  LAB_001024bd:if (( pTVar4 != (Transform3D*)0x0 || lVar6 != 0 ) && ( Light3D::set_param(this),pTVar5 != (Transform3D*)0x0 )) goto LAB_001026c5;
               }
         ...
         LAB_001028e8:lVar6 = 0;
      }

      LAB_0010283d = (String*)0x0;
      _err_print_index_error("_generate_light", "modules/fbx/fbx_document.cpp", 0x5f3, (long)iVar1, lVar6, "fbx_node->light", "p_state->lights.size()", "", false, false);
      cVar3 = RefCounted::unreference();
      joined_r0x00102880:if (( cVar3 != '\0' ) && ( cVar3 = cVar3 != '\0' )) {
   ...
   LAB_001028b8:lVar10 = 0;
   LAB_00102635:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar8, lVar10, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar2 = (code*)invalidInstructionException();
   ( *pcVar2 )();
...
/* FBXDocument::_process_uv_set(Vector<Vector2>&) */void FBXDocument::_process_uv_set(FBXDocument *this, Vector *param_1) {
   long lVar1;
   code *pcVar2;
   long lVar3;
   int iVar4;
...
;
   lVar3 = 0;
   LAB_00102eb0:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, uVar5, lVar3, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar2 = (code*)invalidInstructionException();
   ( *pcVar2 )();
...
/* FBXDocument::_parse_scenes(Ref<FBXState>) */undefined8 FBXDocument::_parse_scenes(undefined8 param_1, long *param_2) {
   long *plVar1;
   long lVar2;
   long *plVar3;
   long in_FS_OFFSET;
...
/* FBXDocument::_zero_unused_elements(Vector<float>&, int, int, int) */void FBXDocument::_zero_unused_elements(FBXDocument *this, Vector *param_1, int param_2, int param_3, int param_4) {
   long lVar1;
   code *pcVar2;
   long lVar3;
   long lVar4;
...
;
            if (lVar4 == 0) {
               LAB_0010361b:lVar4 = 0;
            }
 else {
               LAB_00103625:lVar4 = *(long*)( lVar4 + -8 );
            }
...
/* FBXDocument::_import_animation(Ref<FBXState>, AnimationPlayer*, int, bool, bool) */void FBXDocument::_import_animation(undefined8 param_1, undefined4 param_2, undefined8 param_3, long *param_4, StringName *param_5, int param_6, char param_7, char param_8) {
   undefined8 *puVar1;
   int iVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   if (lVar28 < 0) {
      LAB_00104270:if (lVar26 != 0) {
         LAB_00104279:lVar34 = *(long*)( lVar26 + -8 );
         goto LAB_00104298;
      }
      ...
      if (( local_138 == 0 ) || ( cVar22 = cVar22 == '\0' )) {
         local_138 = 0;
      }
      ...
      if (cVar22 == '\0') {
         ...
         if (cVar22 == '\0') goto LAB_00103983;
         LAB_001042fa:( **(code**)( *(long*)pOVar20 + 0x140 ) )(pOVar20);
         ...
         if (( ( pOVar20 != (Object*)0x0 ) && ( cVar22 = RefCounted::unreference() ),cVar22 != '\0' )) goto LAB_001042fa;
      }
      ...
      LAB_00103983:Resource::set_name((String*)local_128);
      ...
      if (plVar39 != (long*)0x0) {
         LAB_00103a9d:uVar25 = *(uint*)( plVar39 + 2 );
         local_e8 = 0;
         local_e0 = 0;
         ...
         if (lVar26 != 0) {
            ...
            if (( lVar34 != 0 ) && ( *(int*)( lVar28 + 0x48c ) != 0 )) {
               ...
               uVar36 = CONCAT44(0, *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( lVar28 + 0x488 ) * 4 ));
               auVar3._8_8_ = 0;
               auVar3._0_8_ = uVar36;
               auVar11._8_8_ = 0;
               ...
               if (uVar24 != 0) {
                  ...
                  while (( uVar33 != uVar24 || ( uVar25 != *(uint*)( *(long*)( lVar34 + lVar30 * 8 ) + 0x10 ) ) )) {
                     ...
                     if (( uVar24 == 0 ) || ( auVar5._8_8_ = 0 ),auVar5._0_8_ = uVar24 * uVar38,auVar13._8_8_ = 0,auVar13._0_8_ = uVar36,auVar6._8_8_ = 0,auVar6._0_8_ = ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( lVar28 + 0x488 ) * 4 ) + uVar35 ) - SUB164(auVar5 * auVar13, 8) ) * uVar38,auVar14._8_8_ = 0,auVar14._0_8_ = uVar36,SUB164(auVar6 * auVar14, 8) < uVar37) goto LAB_00104540;
                  }
;
                  if (*(long*)( lVar34 + (ulong)uVar35 * 8 ) != 0) {
                     ...
                     if (*(int*)( local_d8 + 0x28c ) < 0) {
                        ...
                        if (*(long*)( *(long*)( lVar30 + lVar28 * 8 ) + 0x260 ) == 0) {
                           _err_print_error("_import_animation", "modules/fbx/fbx_document.cpp", 0x70b, "Parameter \"sk\" is null.", 0, 0);
                     ...
                     if (( ( *(int*)( lVar26 + 0x28c ) < 0 ) && ( -1 < *(int*)( lVar26 + 0x288 ) ) ) || ( ( ( ( plVar39[0xc] == 0 || ( *(long*)( plVar39[0xc] + -8 ) == 0 ) ) && ( ( plVar39[7] == 0 || ( *(long*)( plVar39[7] + -8 ) == 0 ) ) ) ) && ( ( plVar39[0x11] == 0 || ( *(long*)( plVar39[0x11] + -8 ) == 0 ) ) ) ) )) goto LAB_00103e80;
         ...
         _err_print_error("_import_animation", "modules/fbx/fbx_document.cpp", 0x702, "Parameter \"root\" is null.", 0, 0);
         LAB_001044bf:NodePath::~NodePath((NodePath*)&local_e0);
         NodePath::~NodePath((NodePath*)&local_e8);
         goto LAB_001044d6;
      }

      LAB_00103ebd:StringName::StringName(local_1d0, "GODOT_blend_shape_animations", false);
      GLTFAnimation::get_additional_data((StringName*)&local_58);
      ...
      for (uVar38 = 0; ( lVar26 != 0 && ( (long)uVar38 < *(long*)( lVar26 + -8 ) ) ); uVar38 = uVar38 + 1) {
         ...
         if (-1 < *(int*)( local_110 + 0x280 )) {
            ...
            if (lVar28 == 0) {
               _err_print_error("_import_animation", "modules/fbx/fbx_document.cpp", 0x783, "Parameter \"root\" is null.", 0, 0);
            ...
            lVar34 = *param_4;
            cVar22 = HashMap<int,Node*,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Node*>>>::_lookup_pos((HashMap<int,Node*,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Node*>>>*)( lVar34 + 0x460 ), (int*)( uVar38 & 0xffffffff ), (uint*)local_1d0);
            if (( cVar22 == '\0' ) || ( *(long*)( *(long*)( lVar34 + 0x468 ) + ( (ulong)local_98[0] & 0xffffffff ) * 8 ) == 0 )) {
               local_a8 = 0;
               String::parse_latin1((String*)&local_a8, "Unable to find node %d for animation.");
               vformat<int>((String*)local_1d0, (int)(String*)&local_a8);
               _err_print_error("_import_animation", "modules/fbx/fbx_document.cpp", 0x785, "Condition \"!node_element\" is true. Continuing.", local_1d0, 0, 0);
               CowData<char32_t>::_unref((CowData<char32_t>*)local_1d0);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_a8);
            }
 else {
               ...
               if (( lVar30 != 0 ) && ( *(int*)( lVar34 + 0x4bc ) != 0 )) {
                  uVar36 = CONCAT44(0, *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( lVar34 + 0x4b8 ) * 4 ));
                  ...
                  if (uVar25 != 0) {
                     uVar35 = 0;
                     while (( uVar25 != uVar24 || ( *(uint*)( *(long*)( lVar30 + lVar32 * 8 ) + 0x10 ) != (uint)uVar38 ) )) {
                        uVar35 = uVar35 + 1;
                        auVar8._8_8_ = 0;
                        ...
                        if (( uVar25 == 0 ) || ( auVar9._8_8_ = 0 ),auVar9._0_8_ = uVar25 * uVar29,auVar17._8_8_ = 0,auVar17._0_8_ = uVar36,auVar10._8_8_ = 0,auVar10._0_8_ = ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( lVar34 + 0x4b8 ) * 4 ) + uVar33 ) - SUB164(auVar9 * auVar17, 8) ) * uVar29,auVar18._8_8_ = 0,auVar18._0_8_ = uVar36,SUB164(auVar10 * auVar18, 8) < uVar35) goto LAB_0010546a;
                     }
;
               ...
               LAB_0010546a:NodePath::operator =((NodePath*)&local_108, (NodePath*)local_100);
               LAB_00104eb4:lVar28 = (long)*(int*)( lVar26 + 0x280 );
               ...
               if (local_f8 == 0) {
                  _err_print_error("_import_animation", "modules/fbx/fbx_document.cpp", 0x78f, "Condition \"mesh.is_null()\" is true. Continuing.", 0, 0);
               }
 else {
                  GLTFMesh::get_mesh();
                  pSVar21 = local_98[0];
                  ...
                  if (pSVar21 == (StringName*)0x0) {
                     _err_print_error("_import_animation", "modules/fbx/fbx_document.cpp", 0x790, "Condition \"mesh->get_mesh().is_null()\" is true. Continuing.", 0, 0);
                  }
 else {
                     GLTFMesh::get_mesh();
                     local_a8 = 0;
                     ...
                     if (pSVar21 == (StringName*)0x0) {
                        _err_print_error("_import_animation", "modules/fbx/fbx_document.cpp", 0x791, "Condition \"mesh->get_mesh()->get_mesh().is_null()\" is true. Continuing.", 0, 0);
                     }
 else {
                        ...
                        for (lVar26 = 0; ( local_b0 != 0 && ( lVar26 < *(long*)( local_b0 + -8 ) ) ); lVar26 = lVar26 + 1) {
                           ...
                           if (cVar22 != '\0') {
                              ...
                              if (local_88[0] != 0) {
                                 for (; lVar28 < *(long*)( lVar30 + -8 ); lVar28 = lVar28 + 1) {
                                    ...
                                    if (lVar34 <= lVar28) goto LAB_00104298;
                                    Animation::blend_shape_track_insert_key((int)local_128, *(double*)( lVar30 + lVar28 * 8 ) - local_1a0, *(float*)( local_78[0] + lVar28 * 4 ));
                                 }
      ...
      if (cVar22 == '\0') {
         ...
         if (local_98[0] != local_b8) {
            local_b8 = local_98[0];
            if (( local_98[0] != (StringName*)0x0 ) && ( cVar22 = cVar22 == '\0' )) {
               local_b8 = (StringName*)0x0;
            }

            if (( ( pSVar21 != (StringName*)0x0 ) && ( cVar22 = RefCounted::unreference() ),cVar22 != '\0' )) &&( cVar22 = cVar22 != '\0' )(**(code**)( *(long*)pSVar21 + 0x140 ))(pSVar21);
   ...
   Dictionary::~Dictionary((Dictionary*)local_118);
   LAB_001044d6:Dictionary::~Dictionary((Dictionary*)local_120);
   if (( ( local_128 != (Object*)0x0 ) && ( cVar22 = RefCounted::unreference() ),pOVar20 = local_128,cVar22 != '\0' )) &&( cVar22 = cVar22 != '\0' )(**(code**)( *(long*)pOVar20 + 0x140 ))(pOVar20);
   Memory::free_static(pOVar20, false);
}
CowData<char32_t>::_unref((CowData<char32_t>*)&local_130);Ref<GLTFAnimation>::unref((Ref<GLTFAnimation>*)&local_138);if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}LAB_001043b0:lVar34 = 0;LAB_00104298:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar28, lVar34, "p_index", "size()", "", false, true);_err_flush_stdout();/* WARNING: Does not return */pcVar19 = (code*)invalidInstructionException();( *pcVar19 )();joined_r0x00104a69:if (( lVar26 == 0 ) || ( *(long*)( lVar26 + -8 ) <= lVar30 )) goto LAB_001047f8;lVar28 = lVar30;if ((int)plVar39[3] == 3) {
   lVar28 = (long)( (int)lVar30 * 3 + 1 );
}
lVar26 = plVar39[7];if (lVar26 == 0) goto LAB_001043b0;lVar34 = *(long*)( lVar26 + -8 );if (lVar34 <= lVar28) goto LAB_00104298;puVar1 = (undefined8*)( lVar26 + lVar28 * 0xc );local_58 = *puVar1;uStack_50._4_4_ = ( undefined4 )((ulong)uStack_50 >> 0x20);uStack_50 = CONCAT44(uStack_50._4_4_, *(undefined4*)( puVar1 + 1 ));cVar22 = Vector3::is_equal_approx((Vector3*)&local_58);if (cVar22 == '\0') goto LAB_00103dfa;lVar26 = plVar39[5];lVar30 = lVar30 + 1;goto joined_r0x00104a69;LAB_001047f8:lVar26 = plVar39[0xc];if (lVar26 != 0) {
   uVar33 = 0xffffffff;
   uVar24 = uVar25;
   goto LAB_00103e48;
}
if (( plVar39[0x11] == 0 ) || ( *(long*)( plVar39[0x11] + -8 ) == 0 )) goto LAB_00103e80;uVar24 = 0xffffffff;uVar33 = 0xffffffff;uVar35 = uVar25;LAB_00104644:if (param_8 == '\0') {
   LAB_0010464f:Animation::add_track(local_128, 3, 0xffffffff);
   ...
   if (uVar33 != 0xffffffff) {
      LAB_00104996:Animation::track_set_interpolation_type(local_128, uVar25, 1);
      lVar26 = plVar39[5];
...
LAB_00104bf7:lVar28 = (long)(int)plVar39[2];lVar26 = *(long*)( *param_4 + 0x2a8 );if (lVar28 < 0) goto LAB_00104270;if (lVar26 == 0) goto LAB_001043b0;if (*(long*)( lVar26 + -8 ) <= lVar28) goto LAB_00104279;local_68 = Basis::get_scale();lVar26 = plVar39[0xf];local_60 = param_2;for (lVar30 = 0; ( lVar26 != 0 && ( lVar30 < *(long*)( lVar26 + -8 ) ) ); lVar30 = lVar30 + 1) {
   lVar28 = lVar30;
...
joined_r0x0010481f:if (uVar24 == 0xffffffff) goto LAB_00103e80;Animation::track_set_interpolation_type(local_128, uVar24, 1);lVar26 = plVar39[10];if (lVar26 == 0) goto LAB_00103e80;uVar35 = 0xffffffff;LAB_0010484c:lVar28 = 0;do {
   ...
   local_58 = *puVar1;
   uStack_50 = puVar1[1];
   Animation::rotation_track_insert_key((int)local_128, (double)(float)( *(double*)( lVar26 + lVar28 * 8 ) - local_1a0 ), (Quaternion*)(ulong)uVar24);
   lVar26 = plVar39[10];
   lVar28 = lVar28 + 1;
}
 while ( lVar26 != 0 );goto LAB_001046ab;LAB_00103dfa:Animation::add_track(local_128, 1, 0xffffffff);Animation::track_set_path((int)local_128, (NodePath*)(ulong)uVar25);Animation::track_set_imported((int)local_128, SUB41(uVar25, 0));lVar26 = plVar39[0xc];uVar24 = uVar25 + 1;uVar33 = uVar25;if (lVar26 == 0) {
   ...
   if (*(long*)( lVar26 + -8 ) != 0) {
      ...
      LAB_001045e3:Animation::add_track(local_128, 2, 0xffffffff);
   ...
   if (( plVar39[0x11] != 0 ) && ( uVar24 = 0xffffffff * (long*)( plVar39[0x11] + -8 ) != 0 )) goto LAB_00104644;
}
LAB_00103e70:if (uVar25 == 0xffffffff) goto LAB_00103e80;Animation::track_set_interpolation_type(local_128, uVar25, 1);lVar26 = plVar39[5];if (lVar26 == 0) goto LAB_00103e80;uVar35 = 0xffffffff;uVar24 = 0xffffffff;LAB_001048f4:lVar28 = 0;do {
   if (*(long*)( lVar26 + -8 ) <= lVar28) break;
   lVar30 = plVar39[7];
   if (lVar30 == 0) {
      lVar34 = 0;
   ...
   local_58 = *puVar1;
   uStack_50 = CONCAT44(uStack_50._4_4_, *(undefined4*)( puVar1 + 1 ));
   Animation::position_track_insert_key((int)local_128, (double)(float)( *(double*)( lVar26 + lVar28 * 8 ) - local_1a0 ), (Vector3*)(ulong)uVar25);
   lVar26 = plVar39[5];
   lVar28 = lVar28 + 1;
}
 while ( lVar26 != 0 );LAB_001046a1:if (uVar24 != 0xffffffff) {
   Animation::track_set_interpolation_type(local_128, uVar24, 1);
   lVar26 = plVar39[10];
   if (lVar26 != 0) goto LAB_0010484c;
}
LAB_001046ab:if (uVar35 != 0xffffffff) {
   ...
   if (lVar26 != 0) {
      ...
      do {
         ...
         local_58 = *puVar1;
         uStack_50 = CONCAT44(uStack_50._4_4_, *(undefined4*)( puVar1 + 1 ));
         Animation::scale_track_insert_key((int)local_128, (double)(float)( *(double*)( lVar26 + lVar28 * 8 ) - local_1a0 ), (Vector3*)(ulong)uVar35);
         lVar26 = plVar39[0xf];
         lVar28 = lVar28 + 1;
      }
 while ( lVar26 != 0 );
...
LAB_00103e80:Ref<GLTFNode>::unref((Ref<GLTFNode>*)&local_d8);NodePath::~NodePath((NodePath*)&local_e0);NodePath::~NodePath((NodePath*)&local_e8);LAB_00103e9c:plVar39 = (long*)*plVar39;if (plVar39 == (long*)0x0) goto LAB_00103ebd;goto LAB_00103a9d;LAB_00104754:lVar34 = 0;goto LAB_00104298;}/* CowData<double>::_copy_on_write() [clone .isra.0] */void CowData<double>::_copy_on_write(CowData<double> *this) {
   long lVar1;
   code *pcVar2;
   undefined8 *puVar3;
   ulong uVar4;
...
/* FBXDocument::_get_texture_path(String const&, String const&) const */String *FBXDocument::_get_texture_path(String *param_1, String *param_2) {
   long *plVar1;
   code *pcVar2;
   char cVar3;
   undefined8 *puVar4;
   ...
   if (cVar3 == '\0') {
      ...
      if (puVar4 == (undefined8*)0x0) {
         ...
         *puVar4 = 1;
         ...
         for (uVar5 = ( ulong )(( (int)local_a0 - (int)(undefined8*)( ( ulong )(puVar4 + 3) & 0xfffffffffffffff8 ) ) + 0x58U >> 3); uVar5 != 0; uVar5 = uVar5 - 1) {
            *puVar10 = 0;
         ...
         do {
            ...
            if (local_a0 == (CowData<char32_t>*)0x0) {
               lVar11 = 0;
               LAB_00105ea3:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar12, lVar11, "p_index", "size()", "", false, false);
            }
 else {
 ...
 while ( local_d0 != 0 );
      ...
      *(undefined8*)param_1 = 0;
      LAB_00105d00:CowData<char32_t>::_unref((CowData<char32_t>*)&local_c8);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_d0);
      CowData<String>::_unref((CowData<String>*)&local_a0);
      CowData<char32_t>::_unref((CowData<char32_t>*)local_d8);
   }
...
/* FBXDocument::_parse_image_bytes_into_image(Ref<FBXState>, Vector<unsigned char> const&, String
   const&, int) */undefined8 *FBXDocument::_parse_image_bytes_into_image(undefined8 *param_1) {
   Image *pIVar1;
   char cVar2;
   Resource *this;
   long lVar3;
   ...
   *(undefined8*)( this + 600 ) = 0;
   ...
   if (cVar2 != '\0') {
      ...
      _err_print_error("_parse_image_bytes_into_image", "modules/fbx/fbx_document.cpp", 0x3ae, (String*)&local_58, 0, 0);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   }
...
/* Vector<double>::push_back(double) [clone .isra.0] */void Vector<double>::push_back(Vector<double> *this, double param_1) {
   int iVar1;
   long lVar2;
   long lVar3;
   if (*(long*)( this + 8 ) == 0) {
...
/* CowData<Ref<GLTFNode> >::_copy_on_write() [clone .isra.0] */void CowData<Ref<GLTFNode>>::_copy_on_write(CowData<Ref<GLTFNode>> *this) {
   long lVar1;
   long lVar2;
   code *pcVar3;
   char cVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FBXDocument::_parse_skins(Ref<FBXState>) */int FBXDocument::_parse_skins(undefined8 param_1, long *param_2) {
   long *plVar1;
   long *plVar2;
   Vector *pVVar3;
   Vector *pVVar4;
      ...
      do {
         ...
         if (( puVar9[0x12] == 0 ) || ( puVar9[0x16] == 0 )) {
            ...
            if (lVar32 != 0) {
               ...
               CowData<Transform3D>::_copy_on_write(this);
               lVar34 = 0;
               LAB_001073c8:if (lVar32 * 0x30 == 0) {
                  LAB_001079b8:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
                  lVar32 = puVar9[0x12];
               }
 else {
                  ...
                  if (lVar33 < lVar32) {
                     if (uVar22 + 1 == lVar34) {
                        LAB_00107860:puVar26 = *(undefined8**)( pSVar16 + 0x260 );
 ...
 while ( (undefined1(*) [16])( puVar26 + lVar32 * 6 ) != pauVar25 );
                     ...
                     if (uVar22 + 1 == lVar34) {
                        LAB_001077d5:if (puVar23 == (undefined8*)0x0) {
                           _DAT_00000000 = 0;
                           /* WARNING: Does not return */
                           pcVar10 = (code*)invalidInstructionException();
                           ( *pcVar10 )();
                        ...
                        if (puVar26 == (undefined8*)0x0) {
                           ...
                           if (iVar20 != 0) {
                              LAB_001078d5:lVar32 = puVar9[0x12];
                              goto LAB_001074d0;
                           }
               ...
               LAB_001074d0:if (0 < (int)lVar32) {
                  ...
                  do {
                     ...
                     local_f8 = CONCAT44((float)*(double*)( lVar34 + 0xa0 ), (float)*(double*)( lVar34 + 0x88 ));
                     local_118 = CONCAT44((float)*(double*)( lVar34 + 0xd0 ), (float)*(double*)( lVar34 + 200 ));
                     CowData<Transform3D>::_copy_on_write(this);
                     ...
                     *puVar23 = local_f8;
                     ...
                     if (lVar33 < 0) {
                        if (lVar31 == 0) {
                           LAB_001077c0:lVar31 = 0;
                        }
 else {
                           LAB_0010774d:lVar31 = *(long*)( lVar31 + -8 );
                        }
 ...
 while ( (int)lVar32 < *(int*)( puVar9 + 0x12 ) );
            ...
            if (pSVar17 == (String*)0x0) {
               LAB_00107717:local_98 = (String*)0x0;
            }
 else {
               local_98 = pSVar17;
 ...
 while ( plVar1 != plVar28 );
   ...
   for (; plVar1 != plVar28; plVar28 = plVar28 + 1) {
      ...
      for (; plVar2 != plVar29; plVar29 = plVar29 + 1) {
         ...
         if (lVar33 < 0) {
            if (lVar34 == 0) {
               LAB_00107980:lVar31 = 0;
            }
 else {
               LAB_00107889:lVar31 = *(long*)( lVar34 + -8 );
            }
         ...
         if (*(char*)( *(long*)( *(long*)( lVar32 + 0x2a8 ) + (ulong)uVar8 * 8 ) + 0x290 ) == '\0') {
            ...
            *(undefined1*)( *(long*)( *(long*)( lVar32 + 0x2a8 ) + (ulong)uVar8 * 8 ) + 0x290 ) = 1;
            ...
            if (pSVar16 == (String*)0x0) {
               LAB_00106e9d:local_98 = (String*)0x0;
            }
 else {
               local_98 = pSVar16;
               cVar19 = RefCounted::reference();
            ...
            Vector<Ref<GLTFSkin>>::push_back((Vector<Ref<GLTFSkin>>*)( lVar30 + 0x3c0 ), (CowData<char32_t>*)&local_98);
            Ref<GLTFSkin>::unref((Ref<GLTFSkin>*)&local_98);
            Ref<GLTFSkin>::unref((Ref<GLTFSkin>*)&local_b8);
         }

         LAB_00106ec6:lVar32 = *param_2;
      }
 ...
 while ( !bVar35 );
      ...
      LAB_00107013:lVar30 = *param_2;
   }

   iVar20 = SkinTool::_asset_parse_skins((Vector*)( lVar30 + 0x5d8 ), (Vector*)&local_a8, (Vector*)&local_98, pVVar4, pVVar3, local_88);
   ...
   if (iVar20 == 0) {
      ...
      if (lVar32 != 0) {
         ...
         do {
            ...
            local_a8 = (Ref*)0x0;
            Ref<GLTFSkin>::operator =((Ref<GLTFSkin>*)&local_a8, *(Ref**)( *(long*)( lVar30 + 0x3c8 ) + lVar34 * 8 ));
            pRVar18 = local_a8;
            if (local_a8 == (Ref*)0x0) {
               _err_print_error("_parse_skins", "modules/fbx/fbx_document.cpp", 0x984, "Condition \"skin.is_null()\" is true. Returning: ERR_PARSE_ERROR", 0, 0);
               LAB_00107ab7:iVar20 = 0x2b;
            ...
            Ref<GLTFSkin>::unref((Ref<GLTFSkin>*)&local_98);
            if (iVar21 != 0) {
               _err_print_error("_parse_skins", "modules/fbx/fbx_document.cpp", 0x986, "Condition \"SkinTool::_expand_skin(p_state->nodes, skin)\" is true. Returning: ERR_PARSE_ERROR", 0, 0);
               goto LAB_00107ab7;
            }
            ...
            Ref<GLTFSkin>::unref((Ref<GLTFSkin>*)&local_98);
            if (iVar21 != 0) {
               _err_print_error("_parse_skins", "modules/fbx/fbx_document.cpp", 0x987, "Condition \"SkinTool::_verify_skin(p_state->nodes, skin)\" is true. Returning: ERR_PARSE_ERROR", 0, 0);
               goto LAB_00107ab7;
            }
 ...
 while ( lVar32 != 0 );
      ...
      if (cVar19 != '\0') {
         itos((long)&local_a8);
         operator+((char *)&
         local_98,(String*)"FBX: Total skins: ";
      ...
      for (puVar9 = (undefined8*)local_70._0_8_; puVar9 != (undefined8*)0x0; puVar9 = (undefined8*)*puVar9) {
         ...
         if (*(char*)( (long)puVar9 + 0x14 ) != '\0') {
            ...
            if (*(long*)( lVar30 + 0x2a8 ) == 0) {
               if (lVar33 < 0) {
                  lVar31 = 0;
                  LAB_0010776f:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar33, lVar31, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
                  pcVar10 = (code*)invalidInstructionException();
                  ( *pcVar10 )();
   ...
   LAB_0010723e:if ((void*)local_80._0_8_ != (void*)0x0) {
 ...
 while ( lVar30 != (ulong)uVar8 * 4 );
   ...
   LAB_001072dc:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FBXDocument::_parse_nodes(Ref<FBXState>) */undefined8 FBXDocument::_parse_nodes(undefined8 param_1, long *param_2) {
   long *plVar1;
   long lVar2;
   undefined8 *puVar3;
   Object *pOVar4;
   ...
   if (0 < *(int*)( lVar10 + 0x2b8 )) {
      ...
      do {
         ...
         *(undefined4*)( pSVar17 + 0x24c ) = *(undefined4*)( puVar3 + 0x89 );
         ...
         local_a8 = CONCAT44((float)SUB168(*(undefined1(*) [16])( puVar3 + 0x21 ), 8), (float)SUB168(*(undefined1(*) [16])( puVar3 + 0x21 ), 0));
         ...
         *(ulong*)( pSVar17 + 0x278 ) = CONCAT44(fStack_1bc, fStack_1c0);
         local_238 = local_248;
         if (lVar15 == 0) {
            LAB_00107e89:local_a8 = *(undefined8*)( pSVar17 + 0x250 );
            ...
            do {
               ...
               if (lVar26 != 0) {
                  ...
                  joined_r0x001081cc:if (lVar25 != lVar27) {
 ...
 while ( extraout_RDX != lVar12 );
                                          ...
                                          if (__LC148 <= fVar30) {
                                             Resource::get_name();
                                             local_278 = "FBX: Node \'%s\' has multiple bind poses, using initial pose as rest pose.";
                                             local_280 = 0;
                                             local_270 = 0x48;
                                             String::parse_latin1((StrRange*)&local_280);
                                             vformat<String>((CowData<char32_t>*)&local_278, (StrRange*)&local_280, local_288);
                                             _err_print_error("_parse_nodes", "modules/fbx/fbx_document.cpp", 0x19d, (CowData<char32_t>*)&local_278, 0, 1);
                                             CowData<char32_t>::_unref((CowData<char32_t>*)&local_278);
                                             CowData<char32_t>::_unref((CowData<char32_t>*)&local_280);
 ...
 while ( lVar18 != lVar15 );
         ...
         iVar9 = CowData<Ref<GLTFNode>>::resize<false>((CowData<Ref<GLTFNode>>*)( lVar15 + 0x2a8 ), lVar18);
         if (iVar9 == 0) {
            if (*(long*)( lVar15 + 0x2a8 ) != 0) {
               ...
               *puVar3 = pOVar24;
               if (pOVar24 == (Object*)0x0) {
                  if (( ( pOVar4 == (Object*)0x0 ) || ( cVar7 = RefCounted::unreference() ),cVar7 == '\0' )) goto LAB_00108029;
                  LAB_001085ec:( **(code**)( *(long*)pOVar4 + 0x140 ) )(pOVar4);
               ...
               if (cVar7 == '\0') {
                  *puVar3 = 0;
                  ...
                  cVar7 = RefCounted::unreference();
                  joined_r0x001087af:if (( cVar7 != '\0' ) && ( cVar7 = cVar7 != '\0' )) goto LAB_001085ec;
               }
            ...
            lVar26 = -1;
            lVar18 = 0;
            LAB_0010880f:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar26, lVar18, "p_index", "size()", "", false, false);
            joined_r0x00108606:if (pOVar24 != (Object*)0x0) goto LAB_00108507;
            LAB_00108029:cVar7 = RefCounted::unreference();
         }
 else {
            _err_print_error("push_back", "./core/templates/vector.h", 0x142, "Condition \"err\" is true. Returning: true", 0, 0);
            LAB_001084fe:if (pOVar24 == (Object*)0x0) goto LAB_00108029;
            LAB_00108507:cVar7 = RefCounted::unreference();
            joined_r0x00108023:if (( cVar7 == '\0' ) || ( cVar7 = cVar7 == '\0' )) goto LAB_00108029;
 ...
 while ( (int)lVar16 < *(int*)( lVar10 + 0x2b8 ) );
   ...
   if (lVar10 != 0) {
      ...
      while (lVar15 < *(long*)( lVar10 + -8 )) {
         lVar10 = *(long*)( lVar16 + 0x2a8 );
         if (lVar10 == 0) {
            LAB_0010811c:lVar26 = 0;
            LAB_0010811f:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar15, lVar26, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar5 = (code*)invalidInstructionException();
            ( *pcVar5 )();
         ...
         while (true) {
            ...
            if (( iVar9 < 0 ) || ( lVar26 <= lVar27 )) {
               _err_print_index_error("_parse_nodes", "modules/fbx/fbx_document.cpp", 0x1b8, lVar27, lVar26, "child_i", "p_state->nodes.size()", "", false, false);
               uVar14 = 0x10;
               goto LAB_001088a0;
            }
            ...
            if (*(int*)( *(long*)( lVar10 + lVar27 * 8 ) + 0x248 ) == -1) {
               ...
               *(int*)( *(long*)( *(long*)( lVar16 + 0x2a8 ) + lVar27 * 8 ) + 0x248 ) = (int)lVar15;
               ...
               _err_print_error("_parse_nodes", "modules/fbx/fbx_document.cpp", 0x1b9, "Condition \"p_state->nodes[child_i]->parent != -1\" is true. Continuing.", 0, 0);
            }
...
;
   ...
   uVar14 = 0;
   LAB_001088a0:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

   return uVar14;
   LAB_001081d8:lVar25 = lVar25 + 0x30;
   goto joined_r0x001081cc;
}
/* CowData<Ref<GLTFMesh> >::_copy_on_write() [clone .isra.0] */void CowData<Ref<GLTFMesh>>::_copy_on_write(CowData<Ref<GLTFMesh>> *this) {
   long lVar1;
   long lVar2;
   code *pcVar3;
   char cVar4;
...
/* FBXDocument::_generate_mesh_instance(Ref<FBXState>, int) */Node3D * __thiscall
FBXDocument::_generate_mesh_instance(undefined8 param_1,long *param_2,int param_3){
   ...
   if (lVar6 < 0) {
         ...
         if (iVar1 < lVar8) {
            ...
            *(undefined1(*) [16])( this + 0x558 ) = (undefined1[16])0x0;
            ...
            if (cVar5 != '\0') {
               Resource::get_name();
               operator+((char *)
               local_68,(String*)"FBX: Creating mesh for: ";
               ::Variant::Variant((Variant*)local_58, (String*)local_68);
               stringify_variants((Variant*)&local_60);
               __print_line((String*)&local_60);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
            ...
            HashMap<int,ImporterMeshInstance3D*,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,ImporterMeshInstance3D*>>>::insert((int*)&local_60, (ImporterMeshInstance3D**)( *param_2 + 0x490 ), SUB81(&local_7c, 0));
            lVar8 = *param_2;
            ...
            if (lVar9 < 0) {
               ...
               if (( pOVar2 != (Object*)0x0 ) && ( cVar5 = cVar5 != '\0' )) {
                  GLTFMesh::get_mesh();
                  if (( local_60 != (Object*)0x0 ) && ( ( ( ImporterMeshInstance3D::set_mesh(this),local_60 != (Object*)0x0 && ( cVar5 = RefCounted::unreference() ),cVar5 != '\0' ) ) && ( cVar5 = predelete_handler(local_60) ),cVar5 != '\0' )) {
            ...
            lVar6 = 0;
            LAB_00108e59:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar9, lVar6, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar3 = (code*)invalidInstructionException();
            ( *pcVar3 )();
      ...
      this(Node3D * 0x0);
      _err_print_index_error("_generate_mesh_instance", "modules/fbx/fbx_document.cpp", 0x5d3, (long)iVar1, lVar8, "fbx_node->mesh", "p_state->meshes.size()", "", false, false);
      cVar5 = RefCounted::unreference();
      joined_r0x00108e18:if (( cVar5 != '\0' ) && ( cVar5 = cVar5 != '\0' )) {
         ( **(code**)( *(long*)pOVar7 + 0x140 ) )(pOVar7);
         Memory::free_static(pOVar7, false);
      }
   ...
   lVar9 = 0;
   LAB_00108d85:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar6, lVar9, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar3 = (code*)invalidInstructionException();
   ( *pcVar3 )();
}
/* FBXDocument::_generate_skeleton_bone_node(Ref<FBXState>, int, Node*, Node*) */void FBXDocument::_generate_skeleton_bone_node(FBXDocument *this, long *param_2, int param_3, Node *param_4, Object *param_5) {
   uint uVar1;
   uint uVar2;
   undefined4 uVar3;
   Node *pNVar4;
   ...
   if (lVar12 < 0) {
      ...
      if ((int)uVar2 < 0) {
         if (*(int*)( pOVar13 + 0x284 ) < 0) {
            ...
            if (param_4 == (Node*)0x0) {
               ...
               LAB_00109613:lVar10 = Node::get_parent();
               if (lVar10 == 0) {
                  param_4 = (Node*)0x0;
                  LAB_001095c0:Node::add_child(param_4, pNVar4, 1, 0);
                  Node::set_owner(pNVar4);
                  goto LAB_00109142;
               }

               pRVar15 = (Ref*)*param_2;
               LAB_0010914b:param_4 = pNVar4;
            }
 else {
               LAB_00108fbf:local_90 = bVar7;
               ...
               if (pNVar4 != pNVar9) {
                  if (pNVar9 != (Node*)0x0) {
                     ...
                     _err_print_error("_generate_skeleton_bone_node", "modules/fbx/fbx_document.cpp", 0x698, (String*)&local_68, 0, 0);
                     CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
                     CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);
                     uVar3 = *(undefined4*)( pOVar13 + 0x248 );
                     local_68 = (Object*)0x0;
                     Ref<FBXState>::operator =((Ref<FBXState>*)&local_68, (Ref*)*param_2);
                     pNVar9 = (Node*)_generate_bone_attachment(this, (String*)&local_68, pNVar9, param_3, uVar3);
                  ...
                  LAB_00109142:pRVar15 = (Ref*)*param_2;
               }
         ...
         LAB_001093e8:local_68 = (Object*)0x0;
         Ref<FBXState>::operator =((Ref<FBXState>*)&local_68, pRVar15);
         pNVar11 = (Node*)_generate_bone_attachment(this, (Ref<FBXState>*)&local_68, pNVar4, param_3, param_3);
         Ref<FBXState>::unref((Ref<FBXState>*)&local_68);
         ...
         LAB_00109470:local_68 = (Object*)0x0;
         Ref<FBXState>::operator =((Ref<FBXState>*)&local_68, pRVar15);
         ...
         if (param_4 != (Node*)0x0) goto LAB_00108fbf;
         if (pNVar4 != (Node*)0x0) goto LAB_00109613;
         LAB_0010915c:if ((int)( uVar1 | uVar2 ) < 0) goto LAB_001093e8;
         pNVar11 = param_4;
         if (-1 < *(int*)( pOVar13 + 0x280 )) goto LAB_00109470;
         LAB_00109178:local_68 = (Object*)0x0;
         if (*(int*)( pOVar13 + 0x284 ) < 0) {
            Ref<FBXState>::operator =((Ref<FBXState>*)&local_68, pRVar15);
      ...
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
      pRVar15 = (Ref*)*param_2;
      LAB_0010927d:lVar12 = 0;
      local_70 = pNVar9;
      HashMap<int,Node*,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Node*>>>::insert((int*)&local_68, (Node**)( pRVar15 + 0x460 ), SUB81(local_7c, 0));
      ...
      while (lVar10 != 0) {
         while (true) {
            ...
            local_68 = (Object*)0x0;
            if (( (Object*)*param_2 != (Object*)0x0 ) && ( local_68 = (Object*)*param_2 ),cVar8 = RefCounted::reference(),cVar8 == '\0') {
               local_68 = (Object*)0x0;
            }

            _generate_scene_node(this, &local_68, uVar3, pNVar4, param_5);
            if (( ( local_68 != (Object*)0x0 ) && ( cVar8 = RefCounted::unreference() ),pOVar6 = local_68,cVar8 != '\0' )) &&( cVar8 = cVar8 != '\0' );
            lVar10 = *(long*)( pOVar13 + 0x2a0 );
            lVar12 = lVar12 + 1;
...
;
      LAB_00109378:cVar8 = RefCounted::unreference();
   ...
   LAB_00109570:lVar14 = 0;
   LAB_001094b5:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar12, lVar14, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar5 = (code*)invalidInstructionException();
   ( *pcVar5 )();
}
/* FBXDocument::_generate_scene_node(Ref<FBXState>, int, Node*, Node*) */void FBXDocument::_generate_scene_node(FBXDocument *this, long *param_2, int param_3, Node *param_4, Object *param_5) {
   int iVar1;
   undefined4 uVar2;
   code *pcVar3;
   Object *pOVar4;
   ...
   if (lVar10 < 0) {
      ...
      if (pOVar11 == (Object*)0x0) {
         LAB_00109709:local_70 = (Object*)0x0;
         if (*(int*)( pOVar11 + 0x28c ) < 0) goto LAB_00109717;
         LAB_00109832:local_60 = (Object*)0x0;
         ...
         LAB_00109717:iVar1 = *(int*)( pOVar11 + 0x288 );
         pNVar9 = param_4;
         if (param_4 == (Node*)0x0) {
            LAB_00109905:if (-1 < *(int*)( pOVar11 + 0x288 )) goto LAB_00109765;
            if (-1 < *(int*)( pOVar11 + 0x280 )) goto LAB_00109921;
            LAB_00109af8:if (*(int*)( pOVar11 + 0x284 ) < 0) {
               local_60 = (Object*)0x0;
            ...
            if (iVar1 < 0) {
               ...
               local_60 = (Object*)0x0;
               Ref<FBXState>::operator =((Ref<FBXState>*)&local_60, pRVar13);
               pNVar9 = (Node*)_generate_bone_attachment(this, (Ref<FBXState>*)&local_60, lVar6, param_3, uVar2);
               Ref<FBXState>::unref((Ref<FBXState>*)&local_60);
               Node::add_child(param_4, pNVar9, 1, 0);
               Node::set_owner(pNVar9);
               Resource::get_name();
            ...
            LAB_00109765:if (*(int*)( pOVar11 + 0x280 ) < 0) goto LAB_00109af8;
            if (*(long*)( pOVar11 + 0x2a0 ) == 0) {
               LAB_00109921:local_60 = (Object*)0x0;
               Ref<FBXState>::operator =((Ref<FBXState>*)&local_60, pRVar13);
         ...
         if (pSVar7 != (StringName*)0x0) {
            ...
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
            local_68 = pSVar7;
            HashMap<int,Node*,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Node*>>>::insert((int*)&local_60, (Node**)( *param_2 + 0x460 ), SUB81(local_7c, 0));
            ...
            for (lVar10 = 0; ( lVar6 != 0 && ( lVar10 < *(long*)( lVar6 + -8 ) ) ); lVar10 = lVar10 + 1) {
               ...
               if (( local_60 != (Object*)0x0 ) && ( ( cVar5 = RefCounted::unreference() ),pOVar4 = local_60,cVar5 != '\0' && ( cVar5 = predelete_handler(local_60) ),cVar5 != '\0' )) {
         ...
         _err_print_error("_generate_scene_node", "modules/fbx/fbx_document.cpp", 0x678, "Parameter \"current_node\" is null.", 0, 0);
      }

      Ref<GLTFNode>::unref((Ref<GLTFNode>*)&local_70);
      LAB_00109ace:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
   ...
   lVar12 = 0;
   LAB_00109bc1:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar10, lVar12, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar3 = (code*)invalidInstructionException();
   ( *pcVar3 )();
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FBXDocument::_parse_meshes(Ref<FBXState>) */undefined8 FBXDocument::_parse_meshes(FBXDocument *this, long *param_2) {
   uint uVar1;
   long *plVar2;
   uint *puVar3;
   long *plVar4;
   ...
   if (uVar42 == 0) {
      ...
      local_21c = 0;
      lVar50 = 0;
      LAB_00109da7:lVar13 = *(long*)( lVar48 + -8 );
      if (0 < lVar13) {
         lVar31 = 0;
         do {
   ...
   if (plVar2 != local_218) {
      do {
         ...
         if (cVar22 != '\0') {
            itos((long)&local_98);
            operator+((char *)&
            local_88,(String*)"FBX: Parsing mesh: ";
         ...
         *(undefined1(*) [16])( pRVar32 + 0x268 ) = (undefined1[16])0x0;
         ...
         if (puVar14[1] == 0) {
            ...
            uVar42 = (ulong)uVar25;
            lVar41 = *param_2;
            if (( *(long*)( lVar41 + 0x2a8 ) != 0 ) && ( uVar57 = *(ulong*)( *(long*)( lVar41 + 0x2a8 ) + -8 ) ),uVar25 < (uint)uVar57) {
               if (local_21c <= uVar25) {
                  iVar26 = 0xb2;
                  pcVar51 = "./core/templates/local_vector.h";
                  pcVar73 = "count";
                  uVar49 = (ulong)local_21c;
                  LAB_0010af4d:_err_print_index_error("operator[]", pcVar51, iVar26, uVar42, uVar49, "p_index", pcVar73, "", false, true);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
                  pcVar15 = (code*)invalidInstructionException();
                  ( *pcVar15 )();
               ...
               if (iVar26 != -1) {
                  ...
                  if (( (long)uVar57 <= (long)uVar42 ) || ( (long)uVar42 < 0 )) {
                     LAB_0010b6b7:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar42, uVar57, "p_index", "size()", "", false, true);
                     _err_flush_stdout();
                     /* WARNING: Does not return */
                     pcVar15 = (code*)invalidInstructionException();
                     ( *pcVar15 )();
            ...
            for (; plVar4 != plVar36; plVar36 = plVar36 + 1) {
               ...
               for (; plVar5 != plVar61; plVar61 = plVar61 + 1) {
                  ...
                  if (puVar34[0x12] != 0) {
                     ...
                     Vector<int>::push_back((Vector<int>*)local_e8, (int)(float)*(uint*)( (long)puVar34 + 0x34 ));
                     CowData<char32_t>::_unref((CowData<char32_t>*)&local_b8);
                  }
         ...
         if (puVar3 != local_268) {
            LAB_0010a12d:local_278= &_parse_meshes(Ref<FBXState>)::primitive_types;
            LAB_0010a138:iVar26 = *local_278;
            if (iVar26 != 1) {
               if (iVar26 == 3) {
            ...
            LAB_0010a15d:if (uVar25 == 0) goto LAB_0010a166;
            LAB_0010a786:local_d0 = (undefined8*)0x0;
                     ...
                     while (true) {
                        ...
                        if (uVar28 == 2) {
                           if (local_d0 == (undefined8*)0x0) {
                              LAB_0010af20:uVar42 = (ulong)uVar25;
                              goto LAB_0010af23;
                           }

                           uVar49 = local_d0[-1];
                           if ((long)uVar49 <= (long)(ulong)uVar25) {
                              LAB_0010bdf9:uVar42 = (ulong)uVar25;
                              goto LAB_0010af41;
                           }
                        ...
                        LAB_0010a849:puVar54 = puVar54 + 1;
...
;
 ...
 while ( puVar55 != puVar54 );
                  LAB_0010a908:uVar42 = (ulong)uVar25;
               ...
               LAB_0010bba8:Array::Array(local_128);
               ...
               iVar27 = 0;
               LAB_0010bd42:local_1f8 = (CowData<float>*)&local_80;
               local_210 = local_128;
               ...
               *puVar34 = 1;
               ...
               LAB_0010add9:uVar42 = 0;
               LAB_0010a921:puVar34 = local_d0;
               if (uVar42 != local_d0[-1]) {
                  LAB_0010baa7:_err_print_error("_parse_meshes", "modules/fbx/fbx_document.cpp", 0x24d, "Condition \"(uint64_t)offset != (uint64_t)indices.size()\" is true. Continuing.", 0, 0);
               ...
               if (bVar63) {
                  ...
                  if (0 < iVar52) {
                     ...
                     do {
                        ...
                        *(ulong*)( local_80 + uVar42 * 3 ) = CONCAT44((float)( uVar25 >> 0x10 ), (float)( uVar25 & 0xffff ));
 ...
 while ( bVar64 );
               ...
               LAB_0010a97a:local_210 = local_128;
            ...
            if (*(char*)( puVar14 + 0x4c ) != '\0') {
               ...
               if (puVar34 == (undefined8*)0x0) {
                  ...
                  if (0 < iVar59) {
                     ...
                     while (true) {
                        pdVar44 = (double*)( puVar14[0x4d] + ( ulong ) * (uint*)( puVar14[0x4f] + ( ulong ) * (uint*)( (long)puVar34 + uVar60 ) * 4 ) * 0x18 );
                        dVar8 = pdVar44[2];
                        dVar9 = pdVar44[1];
                        dVar10 = *pdVar44;
                        uVar42 = uVar60;
...
;
               ...
               if (( *(char*)( puVar14 + 0x55 ) != '\0' ) && ( 0 < iVar27 )) {
                  ...
                  do {
                     ...
                     uVar42 = uVar45 + 1;
                     if (( (long)uVar49 <= (long)( uVar45 + 1 ) ) || ( uVar42 = uVar45 ),(long)uVar49 <= (long)uVar45) goto LAB_0010b6b7;
                     uVar42 = uVar60;
                     if (puVar34 == (undefined8*)0x0) {
                        LAB_0010c636:uVar57 = 0;
                        goto LAB_0010b6b7;
                     }

                     uVar57 = puVar34[-1];
                     if ((long)uVar57 <= (long)uVar60) goto LAB_0010b6b7;
                     pdVar44 = (double*)( puVar14[0x56] + ( ulong ) * (uint*)( puVar14[0x58] + ( ulong ) * (uint*)( (long)puVar34 + uVar45 ) * 4 ) * 0x18 );
                     if (local_c0 == 0) goto LAB_0010c636;
                     uVar57 = *(ulong*)( local_c0 + -8 );
                     if ((long)uVar57 <= (long)uVar60) goto LAB_0010b6b7;
                     pfVar35 = (float*)( local_c0 + uVar45 * 3 );
                     if (( pfVar38[uVar56] * pfVar35[1] - pfVar38[uVar60 * 4 + 1] * pfVar35[2] ) * (float)*pdVar44 + ( pfVar35[2] * pfVar38[uVar60 * 4] - pfVar38[uVar56] * *pfVar35 ) * (float)pdVar44[1] + ( pfVar38[uVar60 * 4 + 1] * *pfVar35 - pfVar38[uVar60 * 4] * pfVar35[1] ) * (float)pdVar44[2] < 0.0) {
 ...
 while ( (long)iVar27 != uVar60 );
            ...
            if (( 1 < uVar42 ) && ( *(char*)( puVar14[0x70] + 0x108 ) != '\0' )) {
               _decode_vertex_attrib_vec2((ufbx_vertex_vec2*)&local_88, (Vector*)( puVar14[0x70] + 0x108 ));
               _process_uv_set(this, (Vector*)&local_88);
               ::Variant::Variant(local_230, (Vector*)&local_88);
               pVVar33 = (Variant*)Array::operator [](iVar52);
               ::Variant::operator =(pVVar33, local_230);
            ...
            while (true) {
               ...
               pfVar38 = local_a0;
               if (( (int)local_1b8 < *(int*)( puVar14 + 0x71 ) ) && ( *(char*)( local_1b0 + puVar14[0x70] + 0x18 ) != '\0' )) {
                  _decode_vertex_attrib_vec2((ufbx_vertex_vec2*)&local_88, (Vector*)( local_1b0 + puVar14[0x70] + 0x18 ));
                  if (local_80 != (float*)0x0) {
                     LAB_0010bc7a:pfVar35 = local_80;
                  ...
                  if (( ( pfVar38 == (float*)0x0 ) || ( *(long*)( pfVar38 + -2 ) < 1 ) ) || ( iVar27 < 1 )) goto LAB_0010b98a;
                  local_1c0 = 4;
                  LAB_0010b32a:iVar59 = 0;
                  uVar45 = 0;
                  do {
 ...
 while ( ( (long)uVar45 < lVar41 ) && ( iVar59 < iVar27 ) );
                  ...
                  LAB_0010b431:iVar43 = (int)lVar41;
               }
 else {
               ...
               LAB_0010b45b:if (local_b0 != (undefined8*)0x0) {
                  ...
                  uVar25 = uVar25 | ( iVar59 != 2 ) + 5 + ( uint )(iVar59 != 2) << ( (char)( (int)local_1b8 + -3 >> 1 ) * '\x03' + 0xdU & 0x1f );
               }
...
;
            if ((int)local_1b8 < iVar59) {
               ...
               cVar22 = *(char*)( lVar41 + 0x18 );
               joined_r0x0010bc4b:if (cVar22 != '\0') {
                  _decode_vertex_attrib_vec2((ufbx_vertex_vec2*)&local_88, (Vector*)( lVar41 + 0x18 ));
                  if (local_80 != (float*)0x0) {
                     pfVar38 = (float*)0x0;
                     goto LAB_0010bc7a;
 ...
 while ( ( (long)uVar42 < lVar41 ) && ( uVar45= uVar42,(int)uVar42 < iVar27 ) );
            ...
            LAB_0010b7b3:CowData<Vector2>::_unref((CowData<Vector2>*)&local_90);
            CowData<Vector2>::_unref((CowData<Vector2>*)&local_a0);
            CowData<float>::_unref((CowData<float>*)&local_b0);
            LAB_0010b7ff:local_190 = (CowData<Vector3>*)&local_a0;
            local_1c8 = (CowData<int>*)&local_90;
            cVar22 = *(char*)( puVar14 + 0x5e );
            if (cVar22 != '\0') {
               local_80 = (float*)0x0;
               if (puVar34 == (undefined8*)0x0) {
                  LAB_0010c33d:::Variant::Variant(local_230, (Vector*)&local_88);
                  pVVar33 = (Variant*)Array::operator [](iVar52);
                  ::Variant::operator =(pVVar33, local_230);
                  if (::Variant::needs_deinit[(int)local_58] != '\0') {
                     ::Variant::_clear_internal();
               ...
               if (pfVar38 == (float*)0x0) {
                  ...
                  *(undefined8*)( pfVar38 + 6 ) = uVar18;
                  ...
                  while (pfVar35 != pfVar38 + lVar41 * 4) {
                     LAB_0010c26c:*(undefined8*)( pfVar35 + 4 ) = uVar17;
...
;
               ...
               if (local_d0 != (undefined8*)0x0) {
                  ...
                  do {
                     uVar57 = puVar20[-1];
                     if ((long)uVar57 <= (long)uVar42) goto LAB_0010b6b7;
                     pdVar44 = (double*)( ( ulong ) * (uint*)( puVar14[0x61] + ( ulong ) * (uint*)( (long)puVar20 + uVar42 * 4 ) * 4 ) * 0x20 + puVar14[0x5f] );
                     dVar8 = *pdVar44;
                     dVar9 = pdVar44[1];
                     dVar10 = pdVar44[2];
                     dVar16 = pdVar44[3];
 ...
 while ( (int)uVar57 < (int)uVar46 );
            ...
            LAB_0010b81a:plVar36 = (long*)puVar14[0x91];
...
;
         ...
         LAB_0010a18d:local_b8 = (String*)0x0;
 ...
 while ( !bVar63 );
         ...
         LAB_0010a2e3:GLTFMesh::set_blend_weights(pSVar21, (String*)&local_88);
         ...
         iVar26 = CowData<Ref<GLTFMesh>>::resize<false>((CowData<Ref<GLTFMesh>>*)( lVar41 + 0x2e8 ), lVar50);
         if (iVar26 == 0) {
            if (*(long*)( lVar41 + 0x2e8 ) == 0) {
               lVar48 = -1;
               lVar50 = 0;
               ...
               if (-1 < lVar48) {
                  ...
                  if (local_98 != pRVar53) {
                     *plVar4 = (long)local_98;
                     local_88 = pRVar53;
                     if (( local_98 != (Resource*)0x0 ) && ( cVar22 = cVar22 == '\0' )) {
                        *plVar4 = 0;
                     }
            ...
            _err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar48, lVar50, "p_index", "size()", "", false, false);
         }
 else {
            _err_print_error("push_back", "./core/templates/vector.h", 0x142, "Condition \"err\" is true. Returning: true", 0, 0);
         }

         LAB_0010a48e:Ref<GLTFMesh>::unref((Ref<GLTFMesh>*)&local_98);
         Dictionary::~Dictionary((Dictionary*)&local_a8);
 ...
 while ( plVar2 != local_218 );
   ...
   LAB_0010a4fa:cVar22 = is_print_verbose_enabled();
   if (cVar22 != '\0') {
      itos((long)&local_98);
      operator+((char *)&
      local_88,(String*)"FBX: Total meshes: ";
      ::Variant::Variant((Variant*)&local_58, (String*)&local_88);
      print_line((Variant*)&local_58);
      if (::Variant::needs_deinit[(int)local_58] != '\0') {
         ::Variant::_clear_internal();
   ...
   uVar46 = 0;
   LAB_0010a511:if (pvVar30 != (void*)0x0) {
   ...
   return uVar46;
   LAB_0010be78:if ((long)uVar57 <= (long)uVar42) goto LAB_0010b6b7;
   plVar36 = plVar36 + 1;
   *(int*)( *(long*)( lVar50 + uVar42 * 8 ) + 0x288 ) = iVar59;
   if (plVar4 == plVar36) goto LAB_0010be94;
   uVar42 = ( ulong ) * (uint*)( *plVar36 + 0x34 );
   goto LAB_0010be78;
   LAB_0010be94:local_90 = (float*)0x0;
   local_80 = (float*)0x0;
   ...
   if (0 < iVar27) {
      if (puVar34 != (undefined8*)0x0) {
         ...
         do {
            uVar57 = puVar34[-1];
            if ((long)uVar57 <= (long)uVar42) goto LAB_0010b6b7;
            piVar37 = (int*)( ( ulong ) * (uint*)( puVar14[0x2b] + ( ulong ) * (uint*)( (long)puVar34 + (long)iVar59 * 4 ) * 4 ) * 0x10 + *(long*)( lVar41 + 0x98 ) );
            iVar43 = piVar37[1];
            iVar12 = *piVar37;
            if (local_1d8 <= iVar43) {
               iVar43 = local_1d8;
            ...
            if (iVar43 < 1) {
               ...
               LAB_0010c7be:if (local_90 == (float*)0x0) {
                  LAB_0010af23:uVar49 = 0;
               }
 else {
                  LAB_0010c7d2:uVar49 = *(ulong*)( local_90 + -2 );
               }

               LAB_0010af41:pcVar73 = "((Vector<T> *)(this))->_cowdata.size()";
               iVar26 = 0x38;
            ...
            uVar42 = uVar57;
            do {
               pfVar38 = (float*)( ( ulong )(uint)(( iVar12 - iVar29 ) + (int)uVar42) * 0x10 + *(long*)( lVar41 + 0xa8 ) );
               fVar70 = (float)*(double*)( pfVar38 + 2 );
               fVar67 = *pfVar38;
               if (local_90 == (float*)0x0) {
                  LAB_0010c44c:uVar49 = 0;
                  goto LAB_0010af41;
               }
 ...
 while ( uVar49 != (long)iVar43 + uVar57 );
            ...
            if (iVar43 < local_1d8) {
               uVar42 = ( ulong )(iVar29 + iVar43);
               LAB_0010c6e3:local_1a0 = (long)iVar43;
               lVar50 = uVar42 * 4;
               uVar57 = local_1a0 + iVar29;
               do {
                  if (local_90 == (float*)0x0) {
                     LAB_0010da59:uVar49 = 0;
                     goto LAB_0010af41;
                  }
 ...
 while ( true );
      ...
      LAB_0010c5fe:uVar57 = 0;
      uVar42 = 0;
      goto LAB_0010b6b7;
   }

   LAB_0010c88f:::Variant::Variant(local_230, (Vector*)&local_98);
   pVVar33 = (Variant*)Array::operator [](iVar52);
   ::Variant::operator =(pVVar33, local_230);
   if (::Variant::needs_deinit[(int)local_58] != '\0') {
      ::Variant::_clear_internal();
   ...
   LAB_0010c94a:bVar64 = local_1d8 == 8;
   if (iVar26 == 3) {
      pVVar33 = (Variant*)Array::operator [](iVar52);
 ...
 while ( iVar59 != 0xd );
               ...
               if (( local_90 == (float*)0x0 ) || ( iVar59 = iVar59 == 0 )) {
                  _err_print_error("_parse_meshes", "modules/fbx/fbx_document.cpp", 799, "Condition \"size == 0\" is true. Returning: ERR_PARSE_ERROR", 0, 0);
                  CowData<Vector3>::_unref((CowData<Vector3>*)local_1f8);
                  ...
                  do {
                     ...
                     if (uVar28 == 0xffffffff) {
                        ...
                        *(float*)( puVar34 + 1 ) = fVar67;
                        LAB_0010d4ba:*(ulong*)pfVar35 = uVar42;
                        pfVar35[2] = fVar66;
                     }
 else {
                        uVar57 = (ulong)uVar28;
                        ...
                        fVar66 = auVar68._0_4_ * auVar68._0_4_ + auVar68._4_4_ * auVar68._4_4_ + fVar70 * fVar70;
                        uVar46 = 0;
                        fVar67 = 0.0;
                        if (fVar66 != 0.0) {
                           fVar66 = SQRT(fVar66);
 ...
 while ( iVar59 != 0xd );
      ...
      for (iVar59 = 0; iVar59 < iVar27; iVar59 = iVar59 + 1) {
         pdVar44 = (double*)( ( ulong )((int)(long)pfVar38[1] << 0x10 | ( uint )(long) * pfVar38) * 0x18 + puVar14[0x2d] );
         dVar8 = *pdVar44;
         dVar9 = pdVar44[1];
   ...
   if (( ( ulong ) * local_268 < (ulong)puVar14[0x75] ) && ( lVar41 = lVar41 != 0 )) {
      ...
      if ((int)uVar28 < 0) {
         if (lVar41 == 0) {
            ...
            LAB_0010ceb0:lVar41 = *(long*)( lVar41 + -8 );
         }
         ...
         if (lVar41 != 0) {
            ...
            pRVar32 = local_88;
            if (local_88 == (Resource*)0x0) {
               _err_print_error("_parse_meshes", "modules/fbx/fbx_document.cpp", 0x36c, "Condition \"mat3d.is_null()\" is true. Returning: ERR_FILE_CORRUPT", 0, 0);
            ...
            if (pOVar39 == (Object*)0x0) {
               ...
               LAB_0010cd55:Ref<Material>::operator =((Ref<Material>*)&local_100, pRVar32);
            }
 else {
               ...
               if (cVar22 == '\0') {
                  LAB_0010cd93:Ref<Material>::operator =((Ref<Material>*)&local_100, pRVar32);
            ...
            LAB_0010cb3a:Ref<Material>::unref((Ref<Material>*)&local_88);
            goto LAB_0010cb4c;
         }
      ...
      _err_print_index_error("_parse_meshes", "modules/fbx/fbx_document.cpp", 0x36a, (long)(int)uVar28, lVar41, "material", "p_state->materials.size()", "", false, false);
   }
 else {
      local_88 = (Resource*)0x0;
      ...
      if (local_88 == (Resource*)0x0) {
         if (local_100 != (Object*)0x0) {
            local_100 = (Object*)0x0;
            LAB_0010cff8:cVar22 = RefCounted::unreference();
            if (( cVar22 != '\0' ) && ( cVar22 = cVar22 != '\0' )) {
               ( **(code**)( *(long*)pOVar39 + 0x140 ) )(pOVar39);
               Memory::free_static(pOVar39, false);
            }
         ...
         if (pOVar40 != pOVar39) {
            local_100 = pOVar40;
            if (( pOVar40 != (Object*)0x0 ) && ( cVar22 = cVar22 == '\0' )) {
               local_100 = (Object*)0x0;
            }
         ...
         LAB_0010cfc3:cVar22 = RefCounted::unreference();
         ...
         LAB_0010cb4c:if (local_100 != (Object*)0x0) {
            Resource::get_name();
            pSVar21 = local_b8;
            if (local_b8 != (String*)local_88) {
            ...
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
            LAB_0010cbc3:Dictionary::Dictionary((Dictionary*)&local_a8);
            ...
            ImporterMesh::add_surface(pRVar53, iVar26, local_210, (Ref<GLTFMesh>*)&local_98, (Dictionary*)&local_a8, (Ref<Material>*)&local_100, (CowData<char32_t>*)&local_b8, uVar25);
            Array::~Array((Array*)&local_98);
            Dictionary::~Dictionary((Dictionary*)&local_a8);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_b8);
            ...
            CowData<unsigned_int>::_unref((CowData<unsigned_int>*)&local_d0);
            LAB_0010a166:local_278 = local_278 + 1;
      ...
      _err_print_error("_parse_meshes", "modules/fbx/fbx_document.cpp", 0x37c, "Condition \"mat.is_null()\" is true. Returning: ERR_FILE_CORRUPT", 0, 0);
   }

   LAB_0010ce00:CowData<char32_t>::_unref((CowData<char32_t>*)&local_b8);
   uVar46 = 0x10;
   Ref<Material>::unref((Ref<Material>*)&local_100);
   LAB_0010ce22:Array::~Array(local_118);
   Ref<SurfaceTool>::unref(local_1b8);
   CowData<Vector3>::_unref((CowData<Vector3>*)&local_c0);
   Array::~Array(local_210);
   CowData<unsigned_int>::_unref((CowData<unsigned_int>*)&local_d0);
   ...
   Ref<ImporterMesh>::unref((Ref<ImporterMesh>*)&local_140);
   goto LAB_0010a511;
   code_r0x0010a17b:local_268 = local_268 + 0x10;
   if (puVar3 == local_268) goto LAB_0010a18d;
   goto LAB_0010a12d;
}
/* CowData<Ref<Texture2D> >::_copy_on_write() [clone .isra.0] */void CowData<Ref<Texture2D>>::_copy_on_write(CowData<Ref<Texture2D>> *this) {
   long lVar1;
   long lVar2;
   code *pcVar3;
   char cVar4;
...
/* Vector<Ref<Texture2D> >::push_back(Ref<Texture2D>) [clone .isra.0] */void Vector<Ref<Texture2D>>::push_back(Vector<Ref<Texture2D>> *this, long *param_2) {
   long *plVar1;
   Object *pOVar2;
   Object *pOVar3;
   char cVar4;
...
/* FBXDocument::_get_texture(Ref<FBXState>, int, int) */long *FBXDocument::_get_texture(long *param_1, undefined8 param_2, long *param_3, int param_4, int param_5) {
   Object *pOVar1;
   code *pcVar2;
   Object *pOVar3;
   char cVar4;
   ...
   if (param_4 < 0) {
      ...
      LAB_0010e1ed:pcVar13 = "p_texture";
      iVar5 = 0x45a;
      pcVar16 = "p_state->textures.size()";
   }
 else {
      if (lVar12 == 0) {
         LAB_0010e288:lVar12 = 0;
         goto LAB_0010e1ed;
      }
      ...
      if (iVar5 < 0) {
         ...
         LAB_0010e24e:lVar10 = (long)iVar5;
         iVar5 = 0x45c;
         pcVar13 = "image";
         ...
         if (*(long*)( lVar11 + 0x3b8 ) == 0) {
            ...
            if (lVar10 < lVar12) {
               local_58 = (Object*)0x0;
               Ref<PortableCompressedTexture2D>::instantiate<>((Ref<PortableCompressedTexture2D>*)&local_58);
               pOVar3 = local_58;
               PortableCompressedTexture2D::set_keep_compressed_buffer(SUB81(local_58, 0));
               lVar12 = *(long*)( *param_3 + 0x3b8 );
               if (lVar12 == 0) {
                  LAB_0010e1d8:lVar11 = 0;
                  LAB_0010e191:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar10, lVar11, "p_index", "size()", "", false, true);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
                  pcVar2 = (code*)invalidInstructionException();
                  ( *pcVar2 )();
               ...
               LAB_0010e022:if (local_50 == (Image*)0x0) {
                  _err_print_error("_get_texture", "modules/fbx/fbx_document.cpp", 0x463, "Condition \"new_img.is_null()\" is true. Returning: Ref<Texture2D>()", 0, 0);
                  *param_1 = 0;
               ...
               if (*(long*)( lVar12 + 0x388 ) != 0) {
                  ...
                  if (pOVar1 != pOVar9) {
                     *plVar8 = (long)pOVar9;
                     local_48 = pOVar1;
                     if (( pOVar9 != (Object*)0x0 ) && ( cVar4 = cVar4 == '\0' )) {
                        *plVar8 = 0;
                     }
                  ...
                  if (*(long*)( lVar12 + 0x3b8 ) != 0) {
                     ...
                     if (local_50 != pIVar7) {
                        *puVar15 = local_50;
                        if (( local_50 != (Image*)0x0 ) && ( cVar4 = cVar4 == '\0' )) {
                           *puVar15 = 0;
                        }

                        pIVar14 = local_50;
                        if (( pIVar7 != (Image*)0x0 ) && ( cVar4 = RefCounted::unreference() ),pIVar14 = local_50,cVar4 != '\0') {
                     ...
                     if (( pIVar14 != (Image*)0x0 ) && ( cVar4 = cVar4 != '\0' )) {
               ...
               lVar11 = 0;
               LAB_0010e37b:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar10, lVar11, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar2 = (code*)invalidInstructionException();
               ( *pcVar2 )();
   ...
   _err_print_index_error("_get_texture", "modules/fbx/fbx_document.cpp", iVar5, lVar10, lVar12, pcVar13, pcVar16, "", false, false);
   *param_1 = 0;
   LAB_0010df00:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* FBXDocument::_parse_image_save_image(Ref<FBXState>, Vector<unsigned char> const&, String const&,
   int, Ref<Image>) */int FBXDocument::_parse_image_save_image(FBXDocument *this, long *param_2, undefined8 param_3, CowData *param_4, int param_5, undefined8 *param_6) {
   Object *pOVar1;
   char cVar2;
   char cVar3;
   long lVar4;
   ...
   if (( iVar8 == 0 ) || ( cVar2 != '\0' )) {
      ...
      if (( *(char*)( lVar4 + 0xc0 ) == '\0' ) || ( iVar8 != 1 )) {
         if (iVar8 == 2) {
            local_e0 = (String*)0x0;
            Ref<PortableCompressedTexture2D>::instantiate<>((Ref<PortableCompressedTexture2D>*)&local_e0);
            pSVar9 = local_e0;
            Resource::get_name();
         ...
         Vector<Ref<Texture2D>>::push_back((Vector<Ref<Texture2D>>*)( lVar4 + 0x380 ), (Ref<Texture2D>*)&local_d8);
      ...
      if (( lVar4 == 0 ) || ( *(uint*)( lVar4 + -8 ) < 2 )) {
         ...
         if (( local_c8 == (Object*)0x0 ) || ( lVar4 = *(long*)( local_c8 + -8 ) ),(int)lVar4 == 0) {
            ...
            if ((int)lVar4 != 1) {
               ...
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_e0);
               if (cVar2 == '\0') {
                  LAB_0010eb42:local_168 = (Variant*)local_78;
                  ...
                  if (( *(long*)param_4 == 0 ) || ( *(uint*)( *(long*)param_4 + -8 ) < 2 )) {
                     ...
                     _err_print_error("_parse_image_save_image", "modules/fbx/fbx_document.cpp", 0x3ec, "Condition \"err != OK\" is true. Returning: -1", 0, 0);
                  }
 else {
                        ...
                        ( iVar8 = __cxa_guard_acquire(&_parse_image_save_image(Ref<FBXState>,Vector<unsigned_char>const&,String_const&,int,Ref<Image>)
                              ...
                              #1
                              {
                                 _scs_create((char *)&_parse_image_save_image(Ref<FBXState>,Vector<unsigned_char>const&,String_const&,int,Ref<Image>)
                                       ::{lambda()
                                 #1
                                 __cxa_atexit(StringName::~StringName, &_parse_image_save_image(Ref<FBXState>,Vector<unsigned_char>const&,String_const&,int,Ref<Image>)
                                ::, {
                                       lambda()
                                       #1
...
, pVVar6 = (Variant *) < StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>> > ::operator []((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)&local_c8, (StringName*)&_parse_image_save_image(Ref<FBXState>,Vector<unsigned_char>const&,String_const&,int,Ref<Image>)
                                       ::{lambda()#1}, ::operator()();
                                 ::Variant::operator =(pVVar6, local_168);
                                 if (::Variant::needs_deinit[local_78[0]] != '\0') {
                                    ::Variant::_clear_internal();
                                 ...
                                 local_e0 = (String*)0x0;
                                 EditorFileSystem::reimport_append(pSVar9, local_108, (CowData<char32_t>*)&local_c8, (CowData<char32_t>*)&local_e0, local_168);
                                 CowData<char32_t>::_unref((CowData<char32_t>*)&local_e0);
                                 if (::Variant::needs_deinit[local_78[0]] != '\0') {
                                    ::Variant::_clear_internal();
                                 }

                                 HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::~HashMap((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)&local_c8);
                                 goto LAB_0010ec5a;
                              }

                              _err_print_error("_parse_image_save_image", "modules/fbx/fbx_document.cpp", 0x3f0, "Condition \"err != OK\" is true. Returning: -1", 0, 0);
                              Ref<FileAccess>::unref((Ref<FileAccess>*)&local_c8);
                           }
, LAB_0010f450:
            CowData<char32_t>::_unref((CowData<char32_t> *) );
                     ...
                     LAB_0010ec5a:local_e0 = (String*)0x0;
                     String::parse_latin1((String*)&local_e0, "Texture2D");
                     GLTFState::get_base_path();
                     _get_texture_path((String*)&local_e8, (String*)this);
                     ResourceLoader::load((CowData<char32_t>*)&local_c8, (String*)&local_e8, (CowData<char32_t>*)&local_e0, 1, 0);
                     local_f8 = (long*)0x0;
                     ...
                     LAB_0010ed28:CowData<char32_t>::_unref((CowData<char32_t>*)&local_e8);
                     CowData<char32_t>::_unref((CowData<char32_t>*)&local_f0);
                     CowData<char32_t>::_unref((CowData<char32_t>*)&local_e0);
                     plVar7 = local_f8;
                     if (local_f8 == (long*)0x0) {
                        ...
                        Resource::get_name();
                        local_e0 = (String*)0x0;
                        String::parse_latin1((String*)&local_e0, "FBX: Image index \'%d\' couldn\'t be loaded with the name: %s. Skipping it.");
                        vformat<int,String>((CowData<char32_t>*)&local_c8, (CowData<char32_t>*)&local_e0, param_5, (String*)&local_e8);
                        _err_print_error("_parse_image_save_image", "modules/fbx/fbx_document.cpp", 0x402, (CowData<char32_t>*)&local_c8, 0, 1);
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_c8);
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_e0);
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_e8);
                        local_c8 = (Object*)0x0;
                        Vector<Ref<Texture2D>>::push_back((Vector<Ref<Texture2D>>*)( *param_2 + 0x380 ), (CowData<char32_t>*)&local_c8);
                        local_c8 = (Object*)0x0;
                        Vector<Ref<Image>>::push_back((Vector<Ref<Image>>*)( *param_2 + 0x3b0 ), (CowData<char32_t>*)&local_c8);
                     }
 else {
                        lVar4 = *param_2;
                        local_c8 = (Object*)0x0;
                        Ref<Texture2D>::operator =((Ref<Texture2D>*)&local_c8, (Ref*)local_f8);
                        Vector<Ref<Texture2D>>::push_back((Vector<Ref<Texture2D>>*)( lVar4 + 0x380 ), (CowData<char32_t>*)&local_c8);
                        Ref<Texture2D>::unref((Ref<Texture2D>*)&local_c8);
                        lVar4 = *param_2;
                        ( **(code**)( *plVar7 + 0x210 ) )((CowData<char32_t>*)&local_c8, plVar7);
                        Vector<Ref<Image>>::push_back((Vector<Ref<Image>>*)( lVar4 + 0x3b0 ), (CowData<char32_t>*)&local_c8);
                        Ref<Image>::unref((Ref<Image>*)&local_c8);
                     }
               ...
               if (param_5 < 0) goto LAB_0010e888;
               local_d8 = 0;
               String::parse_latin1((String*)&local_d8, "FBX: Image index \'%d\' couldn\'t be named. Skipping it.");
               vformat<int>((String*)&local_c8, (int)(String*)&local_d8);
               _err_print_error("_parse_image_save_image", "modules/fbx/fbx_document.cpp", 0x3c9, (CowData<char32_t>*)&local_c8, 0, 1);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_c8);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_d8);
               local_c8 = (Object*)0x0;
               Vector<Ref<Texture2D>>::push_back((Vector<Ref<Texture2D>>*)( *param_2 + 0x380 ), (CowData<char32_t>*)&local_c8);
            ...
            LAB_0010e86e:lVar4 = *(long*)( *param_2 + 0x388 );
            joined_r0x0010e87b:if (lVar4 != 0) {
         ...
         LAB_0010e888:iVar8 = -1;
         LAB_0010e65e:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            return iVar8;
         }
      ...
      void CowData<Ref<GLTFTexture>>::_copy_on_write(CowData<Ref<GLTFTexture>> *this) {
         long lVar1;
         long lVar2;
         code *pcVar3;
         char cVar4;
 ...
 while ( lVar1 != lVar8 );
      ...
      void Vector<Ref<GLTFTexture>>::push_back(Vector<Ref<GLTFTexture>> *this, long *param_2) {
         long *plVar1;
         Object *pOVar2;
         Object *pOVar3;
         char cVar4;
      ...
      undefined8 FBXDocument::_parse_materials(FBXDocument *this, ulong *param_2) {
         long *plVar1;
         long lVar2;
         undefined8 *puVar3;
         long lVar4;
...
LAB_00110921:
         ...
         LAB_0010fe80:if (*(char*)( puVar3 + 0x21d ) != '\0') {
            ...
            if (lVar35 != 0) {
               ...
               for (; plVar23 != plVar1; plVar23 = plVar23 + 1) {
                  if (*(int*)( *plVar23 + 0x100 ) != -1) {
                     ...
                     if (( ( local_88 != (Object*)0x0 ) && ( cVar18 = RefCounted::unreference() ),pOVar26 = local_88,cVar18 != '\0' )) &&( cVar18 = cVar18 != '\0' )(**(code**)( *(long*)pOVar26 + 0x140 ))(pOVar26);
                     Memory::free_static(pOVar26, false);
                  }
   ...
   if (lVar35 != 0) {
      ...
      for (; plVar23 != plVar1; plVar23 = plVar23 + 1) {
         if (*(int*)( *plVar23 + 0x100 ) != -1) {
            ...
            if (( pOVar26 == (Object*)0x0 ) || ( local_98 = pOVar26 ),cVar18 = RefCounted::reference(),cVar18 == '\0') {
               local_98 = (Object*)0x0;
               pOVar26 = (Object*)0x0;
            }
            ...
            if (( ( local_88 != (Object*)0x0 ) && ( cVar18 = RefCounted::unreference() ),pOVar5 = local_88,cVar18 != '\0' )) &&( cVar18 = cVar18 != '\0' )(**(code**)( *(long*)pOVar5 + 0x140 ))(pOVar5);
            Memory::free_static(pOVar5, false);
         }

         if (( ( pOVar26 != (Object*)0x0 ) && ( cVar18 = RefCounted::unreference() ),cVar18 != '\0' )) &&( cVar18 = cVar18 != '\0' )(**(code**)( *(long*)pOVar26 + 0x140 ))(pOVar26);
         Memory::free_static(pOVar26, false);
      }
...
}lVar35 = puVar3[0x206];if (lVar35 != 0) {
   plVar23 = *(long**)( lVar35 + 0x120 );
   plVar1 = plVar23 + *(long*)( lVar35 + 0x128 );
   for (; plVar23 != plVar1; plVar23 = plVar23 + 1) {
      if (*(int*)( *plVar23 + 0x100 ) != -1) {
...
lVar35 = puVar3[0x1c7];if (lVar35 != 0) {
   plVar23 = *(long**)( lVar35 + 0x120 );
   plVar1 = plVar23 + *(long*)( lVar35 + 0x128 );
   for (; plVar23 != plVar1; plVar23 = plVar23 + 1) {
      if (*(int*)( *plVar23 + 0x100 ) != -1) {
   ...
   LAB_00110b20:lVar35 = *(long*)( uVar34 + 0x338 );
   pOVar26 = (Object*)0x0;
   if (lVar35 == 0) goto LAB_00110b32;
   LAB_0011043c:lVar35 = *(long*)( lVar35 + -8 ) + 1;
}
 else {
   BaseMaterial3D::set_cull_mode(pSVar16, 2);
   uVar34 = *param_2;
   if (pSVar16 == (String*)0x0) goto LAB_00110b20;
   LAB_001103f9:pOVar26 = (Object*)__dynamic_cast(pSVar16, &Object::typeinfo, &Material::typeinfo, 0);
   if (( pOVar26 != (Object*)0x0 ) && ( cVar18 = cVar18 == '\0' )) {
      pOVar26 = (Object*)0x0;
   }

   lVar35 = *(long*)( uVar34 + 0x338 );
   if (lVar35 != 0) goto LAB_0011043c;
   LAB_00110b32:lVar35 = 1;
}
iVar19 = CowData<Ref<Material>>::resize<false>((CowData<Ref<Material>>*)( uVar34 + 0x338 ), lVar35);if (iVar19 == 0) {
   if (*(long*)( uVar34 + 0x338 ) == 0) {
      lVar39 = -1;
      lVar35 = 0;
      LAB_00110e1b:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar39, lVar35, "p_index", "size()", "", false, false);
   ...
   *puVar3 = pOVar26;
   if (pOVar26 != (Object*)0x0) {
      ...
      if (cVar18 == '\0') {
         *puVar3 = 0;
         ...
         cVar18 = RefCounted::unreference();
         joined_r0x0011099b:if (( cVar18 != '\0' ) && ( cVar18 = cVar18 != '\0' )) goto LAB_00110809;
      }
   ...
   if (( ( pOVar5 != (Object*)0x0 ) && ( cVar18 = RefCounted::unreference() ),cVar18 != '\0' )) {
      LAB_00110809:( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
      Memory::free_static(pOVar5, false);
      goto joined_r0x001106b0;
   }
   ...
   _err_print_error("push_back", "./core/templates/vector.h", 0x142, "Condition \"err\" is true. Returning: true", 0, 0);
   joined_r0x001106b0:if (pOVar26 != (Object*)0x0) {
      cVar18 = RefCounted::unreference();
      joined_r0x001106c0:if (( cVar18 != '\0' ) && ( cVar18 = cVar18 != '\0' )) {
         ( **(code**)( *(long*)pOVar26 + 0x140 ) )(pOVar26);
         Memory::free_static(pOVar26, false);
      }
...
Dictionary::~Dictionary(local_d0);if (( ( pSVar16 != (String*)0x0 ) && ( cVar18 = RefCounted::unreference() ),cVar18 != '\0' )) &&( cVar18 = cVar18 != '\0' )(**(code**)( *(long*)pSVar16 + 0x140 ))(pSVar16);Memory::free_static(pSVar16, false);}local_170 = local_170 + 1;}while ((int)local_170 < *(int*)( lVar2 + 0x428 )) ;;;}cVar18 = is_print_verbose_enabled();if (cVar18 != '\0') {
   itos((long)&local_a0);
   operator+((char *)&
   local_98,(String*)"Total materials: ";
   ::Variant::Variant((Variant*)local_58, (String*)&local_98);
...
/* WARNING: Subroutine does not return */__stack_chk_fail();LAB_0010f9c0:plVar23 = plVar23 + 1;if (plVar1 == plVar23) goto LAB_0010fe80;goto LAB_0010f9cd;}/* FBXDocument::_parse_images(Ref<FBXState>, String const&) */undefined8 FBXDocument::_parse_images(FBXDocument *this, long *param_2, long *param_3) {
   ulong *puVar1;
   long lVar2;
   ulong uVar3;
   size_t __n;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (*param_2 == 0) {
      _err_print_error("_parse_images", "modules/fbx/fbx_document.cpp", 0x421, "Condition \"p_state.is_null()\" is true. Returning: ERR_INVALID_PARAMETER", 0, 0);
      uVar12 = 0x1f;
   }
 else {
      lVar2 = *(long*)( *param_2 + 0x558 );
            ...
            if (uVar15 < 0x7fffffff) {
               ...
               if (puVar9 == (ulong*)0x0) {
                  ...
                  *puVar9 = 1;
                  ...
                  __src = *(void**)( lVar14 + 0x68 );
                  uVar15 = *puVar9;
                  joined_r0x00111c43:if (1 < uVar15) {
                     if (local_70 == (ulong*)0x0) {
                        /* WARNING: Does not return */
                        pcVar4 = (code*)invalidInstructionException();
                        ( *pcVar4 )();
               ...
               LAB_0011174e:local_d0 = &local_80;
               local_90 = (Object*)0x0;
               pOVar10 = (Object*)*param_2;
               if (( pOVar10 == (Object*)0x0 ) || ( local_68 = pOVar10 ),cVar7 = RefCounted::reference(),cVar7 == '\0') {
                  _parse_image_bytes_into_image(&local_88, this, (CowData<char32_t>*)&local_68, &local_78, (CowData<char32_t>*)&local_a0, iVar13);
               }
 else {
                  _parse_image_bytes_into_image(&local_88, this, (CowData<char32_t>*)&local_68, &local_78, (CowData<char32_t>*)&local_a0, iVar13);
                  cVar7 = RefCounted::unreference();
               ...
               if (pSVar5 == (String*)0x0) {
                  LAB_001117dd:local_68 = (Object*)0x0;
               }
 else {
               ...
               pOVar10 = (Object*)*param_2;
               if (( pOVar10 == (Object*)0x0 ) || ( local_80 = pOVar10 ),cVar7 = RefCounted::reference(),cVar7 == '\0') {
                  local_80 = (Object*)0x0;
               ...
               if (( local_68 != (Object*)0x0 ) && ( cVar7 = cVar7 != '\0' )) {
                  memdelete<Image>((Image*)local_68);
               }

               if (( pSVar5 != (String*)0x0 ) && ( cVar7 = cVar7 != '\0' )) {
               ...
               ResourceLoader::load((CowData<char32_t>*)&local_68, (String*)&local_88, (StrRange*)&local_80, 1);
               local_90 = (Object*)0x0;
               if (local_68 == (Object*)0x0) {
                  CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
                  CowData<char32_t>::_unref((CowData<char32_t>*)&local_80);
                  LAB_00111da2:FileAccess::get_file_as_bytes((String*)&local_68, (CowData<char32_t>*)&local_a0);
                  puVar9 = local_60;
                  if (local_70 == local_60) {
                     ...
                     CowData<unsigned_char>::_unref((CowData<unsigned_char>*)&local_70);
                     local_70 = local_60;
                     joined_r0x00111e94:if (( local_70 != (ulong*)0x0 ) && ( local_70[-1] != 0 )) {
                  ...
                  local_60 = (ulong*)0x66;
                  String::parse_latin1((StrRange*)&local_88);
                  vformat<int,String>((CowData<char32_t>*)&local_68, (String*)&local_88, iVar13, (StrRange*)&local_80);
                  _err_print_error("_parse_images", "modules/fbx/fbx_document.cpp", 0x43e, (CowData<char32_t>*)&local_68);
                  CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
                  CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
                  CowData<char32_t>::_unref((CowData<char32_t>*)&local_80);
                  local_68 = (Object*)0x0;
                  Vector<Ref<Texture2D>>::push_back((Vector<Ref<Texture2D>>*)( *param_2 + 0x380 ), (CowData<char32_t>*)&local_68);
                  local_68 = (Object*)0x0;
                  ...
                  if (pOVar10 == (Object*)0x0) {
                     LAB_00111a58:cVar7 = RefCounted::unreference();
                     pOVar6 = local_68;
                     pOVar10 = local_90;
                     if (( cVar7 != '\0' ) && ( cVar7 = predelete_handler(local_68) ),pOVar10 = local_90,cVar7 != '\0') {
                        ( **(code**)( *(long*)pOVar6 + 0x140 ) )(pOVar6);
                        Memory::free_static(pOVar6, false);
                     }
                  ...
                  if (cVar7 == '\0') {
                     local_68 = (Object*)0x0;
                     Vector<Ref<Texture2D>>::push_back((Vector<Ref<Texture2D>>*)( lVar14 + 0x380 ), (CowData<char32_t>*)&local_68);
                  }
 else {
                  ...
                  LAB_00111b14:cVar7 = RefCounted::unreference();
                  if (( cVar7 != '\0' ) && ( cVar7 = cVar7 != '\0' )) {
                     ( **(code**)( *(long*)pOVar10 + 0x140 ) )(pOVar10);
                     Memory::free_static(pOVar10, false);
                  }
         ...
         if (0 < iVar8) {
            ...
            do {
               ...
               if (cVar7 == '\0') {
                  ...
                  LAB_001120b8:cVar7 = RefCounted::unreference();
               }
 else {
                  Vector<Ref<GLTFTexture>>::push_back((Vector<Ref<GLTFTexture>>*)( lVar14 + 0x358 ));
                  cVar7 = RefCounted::unreference();
                  if (( cVar7 == '\0' ) || ( cVar7 = cVar7 == '\0' )) goto LAB_001120b8;
                  ( **(code**)( *(long*)pOVar10 + 0x140 ) )(pOVar10);
                  Memory::free_static(pOVar10, false);
                  cVar7 = RefCounted::unreference();
               }
 ...
 while ( iVar13 < *(int*)( lVar2 + 0x548 ) );
      ...
      if (cVar7 != '\0') {
         itos((long)&local_80);
         operator+((char *)&
         local_78,(String*)"FBX: Total images: ";
...
/* CowData<Ref<GLTFCamera> >::_copy_on_write() [clone .isra.0] */void CowData<Ref<GLTFCamera>>::_copy_on_write(CowData<Ref<GLTFCamera>> *this) {
   long lVar1;
   long lVar2;
   code *pcVar3;
   char cVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FBXDocument::_parse_cameras(Ref<FBXState>) */undefined8 FBXDocument::_parse_cameras(undefined8 param_1, long *param_2) {
   long *plVar1;
   double dVar2;
   double dVar3;
   long lVar4;
   ...
   if (0 < *(int*)( lVar4 + 0x2e8 )) {
      ...
      do {
         ...
         *(undefined8*)( this + 0x24c ) = uVar8;
         ...
         iVar10 = CowData<Ref<GLTFCamera>>::resize<false>((CowData<Ref<GLTFCamera>>*)( lVar11 + 0x3d8 ), lVar15);
         if (iVar10 == 0) {
            if (*(long*)( lVar11 + 0x3d8 ) != 0) {
               ...
               *puVar5 = pOVar14;
               if (pOVar14 == (Object*)0x0) {
                  if (( ( pOVar6 == (Object*)0x0 ) || ( cVar9 = RefCounted::unreference() ),cVar9 == '\0' )) goto LAB_00112663;
                  LAB_00112861:( **(code**)( *(long*)pOVar6 + 0x140 ) )(pOVar6);
                  Memory::free_static(pOVar6, false);
               ...
               if (cVar9 == '\0') {
                  *puVar5 = 0;
                  ...
                  cVar9 = RefCounted::unreference();
                  joined_r0x001128aa:if (( cVar9 != '\0' ) && ( cVar9 = cVar9 != '\0' )) goto LAB_00112861;
               }
            ...
            lVar12 = -1;
            lVar15 = 0;
            LAB_00112902:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar12, lVar15, "p_index", "size()", "", false, false);
            joined_r0x0011287b:if (pOVar14 != (Object*)0x0) goto LAB_001127be;
            LAB_00112663:cVar9 = RefCounted::unreference();
         }
 else {
            _err_print_error("push_back", "./core/templates/vector.h", 0x142, "Condition \"err\" is true. Returning: true", 0, 0);
            LAB_001127b5:if (pOVar14 == (Object*)0x0) goto LAB_00112663;
            LAB_001127be:cVar9 = RefCounted::unreference();
            joined_r0x0011265d:if (( cVar9 == '\0' ) || ( cVar9 = cVar9 == '\0' )) goto LAB_00112663;
 ...
 while ( (int)lVar17 < *(int*)( lVar4 + 0x2e8 ) );
   ...
   if (cVar9 != '\0') {
      itos((long)local_70);
      operator+((char *)
      local_68,(String*)"FBX: Total cameras: ";
      ::Variant::Variant((Variant*)local_58, (String*)local_68);
      stringify_variants((Variant*)&local_60);
      __print_line((String*)&local_60);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
...
/* CowData<Ref<GLTFAnimation> >::_copy_on_write() [clone .isra.0] */void CowData<Ref<GLTFAnimation>>::_copy_on_write(CowData<Ref<GLTFAnimation>> *this) {
   long lVar1;
   long lVar2;
   code *pcVar3;
   char cVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FBXDocument::_parse_animations(Ref<FBXState>) */undefined8 FBXDocument::_parse_animations(FBXDocument *this, long *param_2) {
   long *plVar1;
   undefined4 *puVar2;
   double *pdVar3;
   uint *puVar4;
   ...
   Variant *pVVar14;
   undefined8 *puVar15;
   HashMap<int,GLTFAnimation::NodeTrack,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,GLTFAnimation::NodeTrack>>> *this_01;
   undefined8 uVar16;
   long lVar17;
   double *pdVar18;
   undefined8 *puVar19;
   ...
   if (0 < *(int*)( lVar5 + 0x478 )) {
      local_690 = 0;
      do if (( cVar3 != '\0' ) && ( cVar3 = cVar3 != '\0' )) BaseMaterial3D::_can_do_next_pass(void)
...
void, CowData<Ref<Material>>::_copy_on_write(void){code *pcVar1;/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException()(*pcVar1)();} < GLTFSkin >> ::_copy_on_write(void){code *pcVar1;/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException()(*pcVar1)();} < GLTFNode >> ::_copy_on_write(void){code *pcVar1;/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException()(*pcVar1)();}, /* WARNING: Globals starting with '_' overlap smaller symbols at the same address */, /* FBXDocument::_parse_skins(Ref<FBXState>) [clone .cold] */, void FBXDocument::_parse_skins(void) * pcVar1(code *)invalidInstructionException();
  (*pcVar1)();
}, /* WARNING: Globals starting with '_' overlap smaller symbols at the same address */, /* FBXDocument::_parse_nodes(Ref<FBXState>) [clone .cold] */, void, FBXDocument::_parse_nodes(void){code *pcVar1;
  
  _DAT_0000024c = 0;/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException()(*pcVar1)();} < GLTFMesh >> ::_copy_on_write(void){code *pcVar1;/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException()(*pcVar1)();}, /* FBXDocument::_generate_mesh_instance(Ref<FBXState>, int) [clone .cold] */, void FBXDocument::_generate_mesh_instance(void) * pcVar1(code *)invalidInstructionException();
  (*pcVar1)();
}, /* FBXDocument::_generate_skeleton_bone_node(Ref<FBXState>, int, Node*, Node*) [clone .cold] */, void, FBXDocument::_generate_skeleton_bone_node(void){code *pcVar1;/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException()(*pcVar1)();} < Texture2D >> ::_copy_on_write(void){code *pcVar1;/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException()(*pcVar1)();} < Image >> ::_copy_on_write(void){code *pcVar1;/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException()(*pcVar1)();} < GLTFTexture >> ::_copy_on_write(void){code *pcVar1;/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException()(*pcVar1)();}, /* FBXDocument::_parse_images(Ref<FBXState>, String const&) [clone .cold] */, void FBXDocument::_parse_images(void) * pcVar1(code *)invalidInstructionException();
  (*pcVar1)();
}, /* CowData<Ref<GLTFCamera> >::_copy_on_write() [clone .isra.0] [clone .cold] */, void, CowData<Ref<GLTFCamera>>::_copy_on_write(void){code *pcVar1;/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException()(*pcVar1)();} < GLTFAnimation >> ::_copy_on_write(void){code *pcVar1;/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException()(*pcVar1)();}, /* FBXDocument::_process_mesh_instances(Ref<FBXState>, Node*) [clone .cold] */, void FBXDocument::_process_mesh_instances(void) * pcVar1(code *)invalidInstructionException();
  (*pcVar1)();
}, /* CowData<Ref<GLTFLight> >::_copy_on_write() [clone .isra.0] [clone .cold] */, void CowData<Ref<GLTFLight>>::_copy_on_write(void)
...

{
  ...
  pcVar1 = (code *)invalidInstructionException();
  (*pcVar1)();
}, /* ConfigFile::_get_class_namev() const */, undefined8 * ConfigFile::_get_class_namev(void){int iVar1;
...
LAB_001183f3:
  ...
  StringName::assign_static_unique_class_name
            ((StringName *)&_get_class_namev()::_class_name_static,"ConfigFile");LAB_0011845e:
  return &_get_class_namev()::_class_name_static;} * param_1), {
  Material::_validate_property(param_1)((code*)PTR__validate_property_00137028 == Material::_validate_property), {
    return;
  }
  BaseMaterial3D::_validate_property(param_1) * param_1), {
  Node::_validate_property(param_1)((code*)PTR__validate_property_00137030 == Node::_validate_property), {
    return;
  }
  Node3D::_validate_property(param_1) * this, int, param_1, bool, param_2) = (int)this(param_2)((code*)PTR__notification_00137038 != Node::_notification), {
      Node3D::_notification(iVar1), ;
    }
    Node::_notification(iVar1), ;
    return;
  }
  Node::_notification(iVar1)((code*)PTR__notification_00137038 == Node::_notification), {
    return;
  }
  Node3D::_notification(iVar1) * __thiscallMaterial::get_save_class(Material * this) = *(long*)( in_FS_OFFSET + 0x28 ) * (undefined8*)this) = 0 * this)(lVar1 == *(long*)( in_FS_OFFSET + 0x28 )), {
    return this;
  }
                    /* WARNING: Subroutine does not return */
  __stack_chk_fail() * __thiscallResource::get_base_extension(Resource * this) = *(long*)( in_FS_OFFSET + 0x28 ) * (undefined8*)this) = 0 * this)(lVar1 == *(long*)( in_FS_OFFSET + 0x28 )), {
    return this;
  }
                    /* WARNING: Subroutine does not return */
  __stack_chk_fail() * __thiscallMaterial::get_base_extension(Material * this) = *(long*)( in_FS_OFFSET + 0x28 ) * (undefined8*)this) = 0 * this)(lVar1 == *(long*)( in_FS_OFFSET + 0x28 )), {
    return this;
  }
                    /* WARNING: Subroutine does not return */
  __stack_chk_fail() * this, CowData * param_1) * plVar1; else {
         *(undefined8*)this = 0;
      }
 while ( !bVar4 );
      if (lVar3 != -1) {
...
/* GLTFState::_get_class_namev() const */undefined8 *GLTFState::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001187c3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001187c3;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "GLTFState");
   LAB_0011882e:return &_get_class_namev();
}
/* GLTFTexture::_get_class_namev() const */undefined8 *GLTFTexture::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001188a3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001188a3;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "GLTFTexture");
   LAB_0011890e:return &_get_class_namev();
}
/* GLTFSkin::_get_class_namev() const */undefined8 *GLTFSkin::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00118983:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00118983;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "GLTFSkin");
   LAB_001189ee:return &_get_class_namev();
}
/* GLTFLight::_get_class_namev() const */undefined8 *GLTFLight::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00118a63:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00118a63;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "GLTFLight");
   LAB_00118ace:return &_get_class_namev();
}
/* FBXDocument::_get_class_namev() const */undefined8 *FBXDocument::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00118b43:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00118b43;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "FBXDocument");
         goto LAB_00118bae;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "FBXDocument");
   LAB_00118bae:return &_get_class_namev();
}
/* GLTFMesh::_get_class_namev() const */undefined8 *GLTFMesh::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00118c23:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00118c23;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "GLTFMesh");
   LAB_00118c8e:return &_get_class_namev();
}
/* StandardMaterial3D::_get_class_namev() const */undefined8 *StandardMaterial3D::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00118d13:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00118d13;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "StandardMaterial3D");
   LAB_00118d7e:return &_get_class_namev();
}
/* ImporterMesh::_get_class_namev() const */undefined8 *ImporterMesh::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00118e03:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00118e03;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "ImporterMesh");
   LAB_00118e6e:return &_get_class_namev();
}
/* GLTFNode::_get_class_namev() const */undefined8 *GLTFNode::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00118ee3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00118ee3;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "GLTFNode");
   LAB_00118f4e:return &_get_class_namev();
}
/* ImporterMeshInstance3D::_get_class_namev() const */undefined8 *ImporterMeshInstance3D::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00118fd3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00118fd3;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "ImporterMeshInstance3D");
         goto LAB_0011903e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "ImporterMeshInstance3D");
   LAB_0011903e:return &_get_class_namev();
}
/* RefCounted::_get_class_namev() const */undefined8 *RefCounted::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001190b3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001190b3;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "RefCounted");
   LAB_0011911e:return &_get_class_namev();
}
...
/* CowData<double>::_ref(CowData<double> const&) [clone .part.0] */void CowData<double>::_ref(CowData<double> *this, CowData *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   bool bVar4;
...
/* CowData<ImporterMesh::Surface>::_unref() [clone .part.0] */void CowData<ImporterMesh::Surface>::_unref(CowData<ImporterMesh::Surface> *this) {
 ...
 while ( lVar3 != lVar11 );
   ...
   LAB_00119400:/* WARNING: Does not return */pcVar8 = (code*)invalidInstructionException();
   ( *pcVar8 )();
}
...
/* ImporterMesh::get_class() const */void ImporterMesh::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* ImporterMeshInstance3D::get_class() const */void ImporterMeshInstance3D::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* FBXDocument::get_class() const */void FBXDocument::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* RefCounted::is_class(String const&) const */undefined8 RefCounted::is_class(RefCounted *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_0011a11f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar5 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar6 == '\0') {
      ...
      LAB_0011a1d3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* ConfigFile::is_class(String const&) const */undefined8 ConfigFile::is_class(ConfigFile *this, String *param_1) {
 ...
 while ( !bVar8 );
      ...
      LAB_0011a37f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0011a433:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* Object::is_class(String const&) const */ulong Object::is_class(Object *this, String *param_1) {
   ...
   do {
      if (lVar2 == 0) {
         ...
         LAB_0011aa0f:/* WARNING: Subroutine does not return */__stack_chk_fail();
      }
 ...
 while ( !bVar8 );
      ...
      LAB_0011a923:uVar5 = String::operator ==(param_1, (String*)&local_50);
      lVar3 = local_50;
      if (local_50 != 0) {
         LOCK();
         plVar1 = (long*)( local_50 + -0x10 );
...
/* print_line(Variant const&) */void print_line(Variant *param_1) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   long local_18;
...
/* Resource::is_class(String const&) const */undefined8 Resource::is_class(Resource *this, String *param_1) {
 ...
 while ( !bVar8 );
      ...
      LAB_0011ab1f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0011abd3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* GLTFNode::is_class(String const&) const */undefined8 GLTFNode::is_class(GLTFNode *this, String *param_1) {
 ...
 while ( !bVar8 );
      ...
      LAB_0011ac9f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0011ad53:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* ImporterMesh::is_class(String const&) const */undefined8 ImporterMesh::is_class(ImporterMesh *this, String *param_1) {
 ...
 while ( !bVar8 );
      ...
      LAB_0011ae1f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0011aed3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* GLTFMesh::is_class(String const&) const */undefined8 GLTFMesh::is_class(GLTFMesh *this, String *param_1) {
 ...
 while ( !bVar8 );
      ...
      LAB_0011af9f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0011b053:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* GLTFState::is_class(String const&) const */undefined8 GLTFState::is_class(GLTFState *this, String *param_1) {
 ...
 while ( !bVar8 );
      ...
      LAB_0011b11f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0011b1d3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* GLTFTexture::is_class(String const&) const */undefined8 GLTFTexture::is_class(GLTFTexture *this, String *param_1) {
 ...
 while ( !bVar8 );
      ...
      LAB_0011b29f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0011b353:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* GLTFSkin::is_class(String const&) const */undefined8 GLTFSkin::is_class(GLTFSkin *this, String *param_1) {
 ...
 while ( !bVar8 );
      ...
      LAB_0011b41f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0011b4d3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* GLTFLight::is_class(String const&) const */undefined8 GLTFLight::is_class(GLTFLight *this, String *param_1) {
 ...
 while ( !bVar8 );
      ...
      LAB_0011b59f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0011b653:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* FBXDocument::is_class(String const&) const */undefined8 FBXDocument::is_class(FBXDocument *this, String *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   char *pcVar4;
 ...
 while ( !bVar9 );
      ...
      LAB_0011b72f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar5 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_0011b7e3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0011b928:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* Image::~Image() */void Image::~Image(Image *this) {
   long *plVar1;
   long lVar2;
...
/* BaseMaterial3D::is_class(String const&) const */undefined8 BaseMaterial3D::is_class(BaseMaterial3D *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_0011ba0f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar5 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_0011bac3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0011bc08:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* StandardMaterial3D::is_class(String const&) const */undefined8 StandardMaterial3D::is_class(StandardMaterial3D *this, String *param_1) {
 ...
 while ( !bVar8 );
      ...
      LAB_0011bc7f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0011bd33:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashSet<String, HashMapHasherDefault, HashMapComparatorDefault<String> >::insert(String const&)
 ...
 while ( uVar44 != 0 );
   ...
   *(int*)( (long)in_RSI + 0x24 ) = iVar35;
   LAB_0011c32b:lVar32 = *in_RSI;
   *(int*)( param_1 + 0xc ) = iVar30;
   *(long*)param_1 = lVar32;
   *(int*)( param_1 + 8 ) = iVar35;
   return param_1;
}
/* void Ref<SurfaceTool>::instantiate<>() */void Ref<SurfaceTool>::instantiate<>(Ref<SurfaceTool> *this) {
   char cVar1;
   SurfaceTool *this_00;
   Object *pOVar2;
   Object *pOVar3;
   ...
   if (cVar1 == '\0') {
      ...
      *(SurfaceTool**)this = this_00;
      ...
      if (( ( pOVar3 == (Object*)0x0 ) || ( cVar1 = RefCounted::unreference() ),cVar1 == '\0' )) goto LAB_0011c675;
   }
   ...
   LAB_0011c675:cVar1 = RefCounted::unreference();
   ...
   *(undefined***)this_00 = &PTR__initialize_classv_0012de98;
   ...
   if (cVar1 == '\0') {
      ...
      *(BaseMaterial3D**)this = this_00;
      ...
      pOVar2 = (Object*)this_00;
      if (( ( pOVar3 == (Object*)0x0 ) || ( cVar1 = RefCounted::unreference() ),cVar1 == '\0' )) goto LAB_0011c7b5;
   }
   ...
   LAB_0011c7b5:cVar1 = RefCounted::unreference();
   if (( cVar1 != '\0' ) && ( cVar1 = cVar1 != '\0' )) {
      ( **(code**)( *(long*)pOVar2 + 0x140 ) )(pOVar2);
      Memory::free_static(pOVar2, false);
      return;
   ...
   *(undefined1(*) [16])( this_00 + 0x198 ) = (undefined1[16])0x0;
   ...
   if (cVar1 == '\0') {
      ...
      *(RefCounted**)this = this_00;
      ...
      if (( ( pOVar5 == (Object*)0x0 ) || ( cVar1 = RefCounted::unreference() ),cVar1 == '\0' )) goto LAB_0011c915;
   }
   ...
   LAB_0011c915:cVar1 = RefCounted::unreference();
   if (( cVar1 != '\0' ) && ( cVar1 = cVar1 != '\0' )) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<StringName, Variant, HashMapHasherDefault, HashMapComparatorDefault<StringName>,
   ...
   LAB_0011d168:local_90 = (undefined1[16])0x0;
   local_98[0] = 0;
   local_98[1] = 0;
   uVar43 = uVar39 * 4;
   uVar48 = uVar39 * 8;
 ...
 while ( uVar39 != uVar43 );
      ...
      LAB_0011cb7e:iVar44 = *(int*)( this + 0x2c );
      if (iVar44 != 0) {
         LAB_0011cb8e:uVar37 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
 ...
 while ( ( uVar50 != 0 ) && ( auVar10._8_8_ = 0 ),auVar10._0_8_ = (ulong)uVar50 * lVar53,auVar26._8_8_ = 0,auVar26._0_8_ = uVar43,auVar11._8_8_ = 0,auVar11._0_8_ = ( ulong )(( uVar37 + uVar51 ) - SUB164(auVar10 * auVar26, 8)) * lVar53,auVar27._8_8_ = 0,auVar27._0_8_ = uVar43,uVar52 <= SUB164(auVar11 * auVar27, 8) );
   ...
   LAB_0011ccdb:uVar37 = *(uint*)( this + 0x28 );
   if (uVar37 == 0x1c) {
...
;
 ...
 while ( ( uVar50 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar50 * lVar46,auVar22._8_8_ = 0,auVar22._0_8_ = uVar39,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( uVar51 + uVar37 ) - SUB164(auVar6 * auVar22, 8)) * lVar46,auVar23._8_8_ = 0,auVar23._0_8_ = uVar39,uVar52 <= SUB164(auVar7 * auVar23, 8) );
   ...
   local_90 = (undefined1[16])0x0;
   iVar44 = 0;
   LAB_0011ccb5:if ((float)uVar39 * __LC29 < (float)( iVar44 + 1 )) goto LAB_0011ccdb;
}
...
;*(undefined8**)( lVar45 + lVar47 * 8 ) = puVar41;*puVar1 = uVar37;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0011d0ab:if (::Variant::needs_deinit[local_98[0]] != '\0') {
   ::Variant::_clear_internal();
}
LAB_0011cb24:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return local_c8;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* void Ref<PortableCompressedTexture2D>::instantiate<>() */void Ref<PortableCompressedTexture2D>::instantiate<>(Ref<PortableCompressedTexture2D> *this) {
   char cVar1;
   ...
   if (cVar1 == '\0') {
      ...
      *(PortableCompressedTexture2D**)this = this_00;
      ...
      pOVar2 = (Object*)this_00;
      if (( ( pOVar3 == (Object*)0x0 ) || ( cVar1 = RefCounted::unreference() ),cVar1 == '\0' )) goto LAB_0011d355;
   }
   ...
   LAB_0011d355:cVar1 = RefCounted::unreference();
   if (( cVar1 != '\0' ) && ( cVar1 = cVar1 != '\0' )) {
      ( **(code**)( *(long*)pOVar2 + 0x140 ) )(pOVar2);
      Memory::free_static(pOVar2, false);
      return;
...
/* void Ref<ImageTexture>::instantiate<>() */void Ref<ImageTexture>::instantiate<>(Ref<ImageTexture> *this) {
   ...
   if (cVar1 == '\0') {
      ...
      *(ImageTexture**)this = this_00;
      ...
      pOVar2 = (Object*)this_00;
      if (( ( pOVar3 == (Object*)0x0 ) || ( cVar1 = RefCounted::unreference() ),cVar1 == '\0' )) goto LAB_0011d485;
   }
   ...
   LAB_0011d485:cVar1 = RefCounted::unreference();
   if (( cVar1 != '\0' ) && ( cVar1 = cVar1 != '\0' )) {
      ( **(code**)( *(long*)pOVar2 + 0x140 ) )(pOVar2);
      Memory::free_static(pOVar2, false);
      return;
...
/* void Ref<GLTFTexture>::instantiate<>() */void Ref<GLTFTexture>::instantiate<>(Ref<GLTFTexture> *this) {
   char cVar1;
   Resource *this_00;
   long lVar2;
   Resource *pRVar3;
   ...
   *(undefined***)this_00 = &PTR__initialize_classv_0012e7f8;
   ...
   if (cVar1 == '\0') {
      ...
      *(Resource**)this = this_00;
      ...
      pOVar4 = (Object*)this_00;
      if (( ( pOVar5 == (Object*)0x0 ) || ( cVar1 = RefCounted::unreference() ),cVar1 == '\0' )) goto LAB_0011d5d5;
   }
   ...
   LAB_0011d5d5:cVar1 = RefCounted::unreference();
   if (( cVar1 != '\0' ) && ( cVar1 = cVar1 != '\0' )) {
      ( **(code**)( *(long*)pOVar4 + 0x140 ) )(pOVar4);
      Memory::free_static(pOVar4, false);
      return;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<unsigned long, Image::AlphaMode, HashMapHasherDefault, HashMapComparatorDefault<unsigned
   long>, DefaultTypedAllocator<HashMapElement<unsigned long, Image::AlphaMode> >
   >::operator[](unsigned long const&) */undefined1[16];HashMap<unsigned_long,Image::AlphaMode,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>,DefaultTypedAllocator<HashMapElement<unsigned_long,Image::AlphaMode>>>::operator [](HashMap<unsigned_long,Image::AlphaMode,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>,DefaultTypedAllocator<HashMapElement<unsigned_long,Image::AlphaMode>>>
             *this,ulong *param_1)

{
 ...
 while ( ( uVar44 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar44 * lVar3,auVar23._8_8_ = 0,auVar23._0_8_ = uVar48,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar54 + uVar47 ) - SUB164(auVar7 * auVar23, 8)) * lVar3,auVar24._8_8_ = 0,auVar24._0_8_ = uVar48,lVar46 = SUB168(auVar8 * auVar24, 8),uVar51 <= SUB164(auVar8 * auVar24, 8) );
   ...
   LAB_0011db63:uVar52 = CONCAT44(0, *(uint*)( hash_table_size_primes + uVar56 * 4 ));
   lVar3 = *(long*)( hash_table_size_primes_inv + uVar56 * 8 );
   uVar39 = uVar40 * 0x3ffff - 1;
   uVar39 = ( uVar39 ^ uVar39 >> 0x1f ) * 0x15;
   uVar39 = ( uVar39 ^ uVar39 >> 0xb ) * 0x41;
...
}LAB_0011d7bb:if ((float)uVar48 * __LC29 < (float)( iVar43 + 1 )) {
...
uVar40 = *param_1;pauVar42 = (undefined1(*) [16])operator_new(0x20, "");*(ulong*)pauVar42[1] = uVar40;*(undefined4*)( pauVar42[1] + 8 ) = 0;*pauVar42 = (undefined1[16])0x0;puVar2 = *(undefined8**)( this + 0x20 );if (puVar2 == (undefined8*)0x0) {
...
lVar53 = *(long*)( this + 0x10 );*(undefined1(**) [16])( this + 0x20 ) = pauVar42;uVar40 = *param_1 * 0x3ffff - 1;uVar40 = ( uVar40 ^ uVar40 >> 0x1f ) * 0x15;uVar40 = ( uVar40 ^ uVar40 >> 0xb ) * 0x41;uVar40 = uVar40 >> 0x16 ^ uVar40;uVar56 = uVar40 & 0xffffffff;if ((int)uVar40 == 0) {
   uVar56 = 1;
}
uVar51 = 0;lVar3 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( this + 0x28 ) * 8 );uVar54 = (uint)uVar56;uVar47 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );uVar40 = CONCAT44(0, uVar47);auVar13._8_8_ = 0;auVar13._0_8_ = uVar56 * lVar3;auVar29._8_8_ = 0;auVar29._0_8_ = uVar40;lStack_90 = SUB168(auVar13 * auVar29, 8);lVar45 = *(long*)( this + 8 );puVar1 = (uint*)( lVar53 + lStack_90 * 4 );iVar43 = SUB164(auVar13 * auVar29, 8);uVar44 = *puVar1;pauVar37 = pauVar42;while (uVar44 != 0) {
   auVar14._8_8_ = 0;
...
;*(undefined1(**) [16])( lVar45 + lStack_90 * 8 ) = pauVar37;*puVar1 = uVar54;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0011db44:auVar59._8_8_ = lStack_90;auVar59._0_8_ = pauVar42[1] + 8;return auVar59;}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<int, ImporterMeshInstance3D*, HashMapHasherDefault, HashMapComparatorDefault<int>,
   DefaultTypedAllocator<HashMapElement<int, ImporterMeshInstance3D*> > >::insert(int const&,
   ImporterMeshInstance3D* const&, bool) */void HashMap<int,ImporterMeshInstance3D*,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,ImporterMeshInstance3D*>>>::insert(int *param_1, ImporterMeshInstance3D **param_2, bool param_3) {
 ...
 while ( uVar40 != uVar32 );
      ...
      LAB_0011de2b:uVar31 = *puVar36;
      iVar35 = *(int*)( (long)param_2 + 0x2c );
      LAB_0011de3b:if (iVar35 != 0) {
...
;
   ...
   *(uint*)pIVar33 = uVar30;
   *(int*)( (long)param_2 + 0x2c ) = *(int*)( (long)param_2 + 0x2c ) + 1;
   LAB_0011e2b8:*(ImporterMeshInstance3D**)param_1 = pIVar34;
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<int, Node*, HashMapHasherDefault, HashMapComparatorDefault<int>,
 ...
 while ( uVar40 != uVar32 );
      ...
      LAB_0011e4bb:uVar31 = *puVar36;
      iVar35 = *(int*)( (long)param_2 + 0x2c );
      LAB_0011e4cb:if (iVar35 != 0) {
         uVar32 = *(ulong*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( param_2 + 5 ) * 8 );
         uVar29 = ( uVar31 >> 0x10 ^ uVar31 ) * -0x7a143595;
         uVar29 = ( uVar29 ^ uVar29 >> 0xd ) * -0x3d4d51cb;
         uVar44 = uVar29 ^ uVar29 >> 0x10;
...
;
   ...
   *(uint*)pNVar33 = uVar30;
   *(int*)( (long)param_2 + 0x2c ) = *(int*)( (long)param_2 + 0x2c ) + 1;
   LAB_0011e948:*(Node**)param_1 = pNVar34;
   return;
}
/* void Ref<AnimationLibrary>::instantiate<>() */void Ref<AnimationLibrary>::instantiate<>(Ref<AnimationLibrary> *this) {
   ...
   if (cVar1 == '\0') {
      ...
      *(AnimationLibrary**)this = this_00;
      ...
      pOVar2 = (Object*)this_00;
      if (( ( pOVar3 == (Object*)0x0 ) || ( cVar1 = RefCounted::unreference() ),cVar1 == '\0' )) goto LAB_0011eba5;
   }
   ...
   LAB_0011eba5:cVar1 = RefCounted::unreference();
   if (( cVar1 != '\0' ) && ( cVar1 = cVar1 != '\0' )) {
      ( **(code**)( *(long*)pOVar2 + 0x140 ) )(pOVar2);
      Memory::free_static(pOVar2, false);
      return;
   ...
   *(undefined1(*) [16])( this_00 + 0x538 ) = (undefined1[16])0x0;
   ...
   if (cVar2 == '\0') {
      ...
      *(Resource**)this = this_00;
      ...
      pOVar4 = (Object*)this_00;
      if (( ( pOVar6 == (Object*)0x0 ) || ( cVar2 = RefCounted::unreference() ),cVar2 == '\0' )) goto LAB_0011eee5;
   }
   ...
   LAB_0011eee5:cVar2 = RefCounted::unreference();
   if (( cVar2 != '\0' ) && ( cVar2 = cVar2 != '\0' )) {
      ( **(code**)( *(long*)pOVar4 + 0x140 ) )(pOVar4);
      Memory::free_static(pOVar4, false);
      return;
...
/* void Ref<GLTFSkin>::instantiate<>() */void Ref<GLTFSkin>::instantiate<>(Ref<GLTFSkin> *this) {
   undefined8 uVar1;
   char cVar2;
   Resource *this_00;
   long lVar3;
   ...
   *(undefined1(*) [16])( this_00 + 0x2e8 ) = (undefined1[16])0x0;
   ...
   if (cVar2 == '\0') {
      ...
      *(Resource**)this = this_00;
      ...
      if (( ( pOVar6 == (Object*)0x0 ) || ( cVar2 = RefCounted::unreference() ),cVar2 == '\0' )) goto LAB_0011f0b5;
   }
   ...
   LAB_0011f0b5:cVar2 = RefCounted::unreference();
   if (( cVar2 != '\0' ) && ( cVar2 = cVar2 != '\0' )) {
      ( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
      Memory::free_static(pOVar5, false);
      return;
...
/* ImporterMeshInstance3D::_initialize_classv() */void ImporterMeshInstance3D::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_70;
   undefined8 local_68;
   long local_60;
...
/* WARNING: Removing unreachable block (ram,0x0011f698) *//* String vformat<String>(String const&, String const) */undefined8 *vformat<String>(undefined8 *param_1, bool *param_2, String *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* WARNING: Removing unreachable block (ram,0x0011f998) *//* String vformat<int>(String const&, int const) */String *vformat<int>(String *param_1, int param_2) {
   char cVar1;
   Variant *this;
   int in_EDX;
...
/* WARNING: Removing unreachable block (ram,0x0011fcd0) *//* String vformat<int, String>(String const&, int const, String const) */undefined8 *vformat<int,String>(undefined8 *param_1, bool *param_2, int param_3, String *param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   long in_FS_OFFSET;
...
/* WARNING: Removing unreachable block (ram,0x0011ff88) *//* String vformat<unsigned int>(String const&, unsigned int const) */String *vformat<unsigned_int>(String *param_1, uint param_2) {
   char cVar1;
   Variant *this;
   uint in_EDX;
   undefined4 in_register_00000034;
...
/* WARNING: Removing unreachable block (ram,0x001202c0) *//* String vformat<unsigned long, unsigned long>(String const&, unsigned long const, unsigned long
...
/* WARNING: Removing unreachable block (ram,0x001205b0) *//* String vformat<int, StringName>(String const&, int const, StringName const) */undefined8 *vformat<int,StringName>(undefined8 *param_1, bool *param_2, int param_3, StringName *param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   long in_FS_OFFSET;
...
/* WARNING: Removing unreachable block (ram,0x001208a0) *//* String vformat<int, int>(String const&, int const, int const) */String *vformat<int,int>(String *param_1, int param_2, int param_3) {
   Variant *pVVar1;
   Variant *pVVar2;
   int in_ECX;
   undefined4 in_register_00000034;
...
/* WARNING: Removing unreachable block (ram,0x00120b90) *//* String vformat<String, int>(String const&, String const, int const) */undefined8 *vformat<String,int>(undefined8 *param_1, bool *param_2, String *param_3, int param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   long in_FS_OFFSET;
...
/* WARNING: Removing unreachable block (ram,0x00120e80) *//* String vformat<String, String>(String const&, String const, String const) */undefined8 *vformat<String,String>(undefined8 *param_1, bool *param_2, String *param_3, String *param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   long in_FS_OFFSET;
...
/* void Ref<GLTFMesh>::instantiate<>() */void Ref<GLTFMesh>::instantiate<>(Ref<GLTFMesh> *this) {
   char cVar1;
   Resource *this_00;
   long lVar2;
   Resource *pRVar3;
   ...
   *(undefined1(*) [16])( this_00 + 0x240 ) = (undefined1[16])0x0;
      ...
      if (this_00 != (Resource*)pOVar4) {
         *(Resource**)this = this_00;
         ...
         if (( ( pOVar4 != (Object*)0x0 ) && ( cVar1 = RefCounted::unreference() ),cVar1 != '\0' )) {
            LAB_00121233:( **(code**)( *(long*)pOVar4 + 0x140 ) )(pOVar4);
            Memory::free_static(pOVar4, false);
            pRVar3 = this_00;
   ...
   LAB_0012116f:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

   LAB_00121280:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* PropertyListHelper::~PropertyListHelper() */void PropertyListHelper::~PropertyListHelper(PropertyListHelper *this) {
 ...
 while ( lVar4 != (ulong)uVar2 << 2 );
   ...
   LAB_001213e4:CowData<char32_t>::_unref((CowData<char32_t>*)this);
   return;
}
...
/* FBXDocument::_initialize_classv() */void FBXDocument::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   undefined8 local_58;
   long local_50;
...
/* ImporterMeshInstance3D::is_class(String const&) const */undefined8 ImporterMeshInstance3D::is_class(ImporterMeshInstance3D *this, String *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   char *pcVar4;
 ...
 while ( !bVar9 );
      ...
      LAB_001223bf:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar5 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_00122473:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0012263e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* Resource::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Resource::_get_property_listv(Resource *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00123991:local_b0 = (CowData<char32_t>*)&local_58;
...
/* ImporterMesh::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void ImporterMesh::_get_property_listv(ImporterMesh *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00123c41:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* GLTFDocument::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void GLTFDocument::_get_property_listv(GLTFDocument *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00123ef1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* GLTFLight::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void GLTFLight::_get_property_listv(GLTFLight *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00124581:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* ConfigFile::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void ConfigFile::_get_property_listv(ConfigFile *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00124831:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* GLTFMesh::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void GLTFMesh::_get_property_listv(GLTFMesh *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00124ec1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* FBXDocument::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void FBXDocument::_get_property_listv(FBXDocument *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00125171:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* GLTFState::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void GLTFState::_get_property_listv(GLTFState *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00125421:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* GLTFNode::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void GLTFNode::_get_property_listv(GLTFNode *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_001256d1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* Material::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Material::_get_property_listv(Material *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00125981:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* BaseMaterial3D::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void BaseMaterial3D::_get_property_listv(BaseMaterial3D *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00125c31:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* StandardMaterial3D::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void StandardMaterial3D::_get_property_listv(StandardMaterial3D *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00125ee1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* Node3D::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Node3D::_get_property_listv(Node3D *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0012618f:List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
...
/* ImporterMeshInstance3D::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void ImporterMeshInstance3D::_get_property_listv(ImporterMeshInstance3D *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00126681:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* Ref<GLTFNode>::unref() */void Ref<GLTFNode>::unref(Ref<GLTFNode> *this) {
   Object *pOVar1;
   char cVar2;
   if (*(long*)this != 0) {
      cVar2 = RefCounted::unreference();
...
/* Ref<GLTFTexture>::unref() */void Ref<GLTFTexture>::unref(Ref<GLTFTexture> *this) {
   Object *pOVar1;
   char cVar2;
   if (*(long*)this != 0) {
      cVar2 = RefCounted::unreference();
...
/* Ref<SurfaceTool>::unref() */void Ref<SurfaceTool>::unref(Ref<SurfaceTool> *this) {
   Object *pOVar1;
   char cVar2;
   if (*(long*)this != 0) {
      cVar2 = RefCounted::unreference();
...
/* Ref<GLTFMesh>::unref() */void Ref<GLTFMesh>::unref(Ref<GLTFMesh> *this) {
   Object *pOVar1;
   char cVar2;
   if (*(long*)this != 0) {
      cVar2 = RefCounted::unreference();
...
/* Ref<FBXState>::unref() */void Ref<FBXState>::unref(Ref<FBXState> *this) {
   Object *pOVar1;
   char cVar2;
   if (*(long*)this != 0) {
      cVar2 = RefCounted::unreference();
...
/* HashMap<Pair<unsigned long, unsigned long>, int, PairHash<unsigned long, unsigned long>,
   ...
   >::_lookup_pos(Pair<unsigned long, unsigned long> const&, unsigned int&) const */undefined8 HashMap<Pair<unsigned_long,unsigned_long>,int,PairHash<unsigned_long,unsigned_long>,HashMapComparatorDefault<Pair<unsigned_long,unsigned_long>>,DefaultTypedAllocator<HashMapElement<Pair<unsigned_long,unsigned_long>,int>>>::_lookup_pos(HashMap<Pair<unsigned_long,unsigned_long>,int,PairHash<unsigned_long,unsigned_long>,HashMapComparatorDefault<Pair<unsigned_long,unsigned_long>>,DefaultTypedAllocator<HashMapElement<Pair<unsigned_long,unsigned_long>,int>>> *this, Pair *param_1, uint *param_2) {
   long lVar1;
   undefined1 auVar2[16];
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   if (( *(long*)( this + 8 ) != 0 ) && ( *(int*)( this + 0x2c ) != 0 )) {
      ...
      uVar10 = ( ( ulong )(( uint )(uVar11 >> 0x16) ^ (uint)uVar11) | ( uVar10 >> 0x16 ^ uVar10 ) << 0x20 ) * 0x3ffff - 1;
      uVar10 = ( uVar10 ^ uVar10 >> 0x1f ) * 0x15;
      uVar10 = ( uVar10 ^ uVar10 >> 0xb ) * 0x41;
      ...
      if (uVar14 != 0) {
         uVar16 = 0;
         while (( ( (uint)uVar11 != uVar14 || ( lVar13 = *(long*)( *(long*)( this + 8 ) + lVar13 * 8 ) * (long*)( lVar13 + 0x10 ) != *(long*)param_1 ) ) || ( *(long*)( lVar13 + 0x18 ) != *(long*)( param_1 + 8 ) ) )) {
            uVar16 = uVar16 + 1;
            auVar3._8_8_ = 0;
            ...
            if (( uVar14 == 0 ) || ( auVar4._8_8_ = 0 ),auVar4._0_8_ = (ulong)uVar14 * lVar1,auVar8._8_8_ = 0,auVar8._0_8_ = uVar15,auVar5._8_8_ = 0,auVar5._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 ) + uVar12 ) - SUB164(auVar4 * auVar8, 8)) * lVar1,auVar9._8_8_ = 0,auVar9._0_8_ = uVar15,SUB164(auVar5 * auVar9, 8) < uVar16) {
               return 0;
            }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<Pair<unsigned long, unsigned long>, int, PairHash<unsigned long, unsigned long>,
   HashMapComparatorDefault<Pair<unsigned long, unsigned long> >,
   DefaultTypedAllocator<HashMapElement<Pair<unsigned long, unsigned long>, int> >
   >::operator[](Pair<unsigned long, unsigned long> const&) */undefined1(*)[16];HashMap<Pair<unsigned_long,unsigned_long>,int,PairHash<unsigned_long,unsigned_long>,HashMapComparatorDefault<Pair<unsigned_long,unsigned_long>>,DefaultTypedAllocator<HashMapElement<Pair<unsigned_long,unsigned_long>,int>>>::operator [](HashMap<Pair<unsigned_long,unsigned_long>,int,PairHash<unsigned_long,unsigned_long>,HashMapComparatorDefault<Pair<unsigned_long,unsigned_long>>,DefaultTypedAllocator<HashMapElement<Pair<unsigned_long,unsigned_long>,int>>>
             *this,Pair*param_1)

{
  ...
  undefined1 auVar20[16];
  undefined1 auVar21[16];
  undefined1 auVar22[16](*, pauVar23)[16](*, pauVar27)[16](*, pauVar39)[16];
  long in_FS_OFFSET;
  uint local_c8;
  uint local_70;
  uint local_6c[5](cVar24 = = '\0') {
   ...
   if (*(long*)( this + 8 ) == 0) {
      ...
      *(void**)( this + 8 ) = pvVar29;
      if (uVar33 != 0) {
         pvVar4 = *(void**)( this + 0x10 );
         if (( pvVar4 < (void*)( (long)pvVar29 + uVar28 ) ) && ( pvVar29 < (void*)( (long)pvVar4 + uVar25 ) )) {
            uVar25 = 0;
            do {
...
;
 ...
 while ( uVar25 != uVar3 );
      ...
      *(undefined1(**) [16])( this + 0x20 ) = pauVar27;
      ...
      uVar25 = ( ( ulong )(( uint )(uVar28 >> 0x16) ^ (uint)uVar28) | ( uVar25 >> 0x16 ^ uVar25 ) << 0x20 ) * 0x3ffff - 1;
      uVar25 = ( uVar25 ^ uVar25 >> 0x1f ) * 0x15;
      uVar25 = ( uVar25 ^ uVar25 >> 0xb ) * 0x41;
...
else{pauVar27 = *(undefined1(**) [16])( *(long*)( this + 8 ) + (ulong)local_70 * 8 );};LAB_001272d7:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return pauVar27 + 2;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* Ref<GLTFAnimation>::unref() */void Ref<GLTFAnimation>::unref(Ref<GLTFAnimation> *this) {
   Object *pOVar1;
   char cVar2;
   if (*(long*)this != 0) {
      cVar2 = RefCounted::unreference();
...
/* HashMap<ObjectID, HashMap<ObjectID, int, HashMapHasherDefault,
 ...
 while ( lVar4 != (ulong)uVar2 * 4 );
               ...
               LAB_0012760b:Memory::free_static(pvVar6, false);
               pvVar6 = *(void**)( this + 8 );
...
/* Ref<GLTFSkin>::unref() */void Ref<GLTFSkin>::unref(Ref<GLTFSkin> *this) {
   Object *pOVar1;
   char cVar2;
   if (*(long*)this != 0) {
      cVar2 = RefCounted::unreference();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Vector3>::resize<false>(long) */undefined8 CowData<Vector3>::resize<false>(CowData<Vector3> *this, long param_1) {
   ...
   if (param_1 * 0xc == 0) {
      LAB_00127aa0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (param_1 <= lVar8) {
      ...
      LAB_001279a2:puVar4[-1] = param_1;
      return 0;
   }

   if (uVar3 + 1 == lVar2) {
      LAB_001279e8:puVar5 = *(undefined8**)this;
      if (puVar5 == (undefined8*)0x0) {
         /* WARNING: Does not return */
         pcVar1 = (code*)invalidInstructionException();
         ( *pcVar1 )();
      ...
      lVar8 = puVar5[-1];
      LAB_001279f9:if (param_1 <= lVar8) goto LAB_0012796f;
   }
 else {
      if (lVar8 != 0) {
...
/* GLTFSkin::~GLTFSkin() */void GLTFSkin::~GLTFSkin(GLTFSkin *this) {
 ...
 while ( (ulong)uVar2 << 2 != lVar5 );
   ...
   LAB_00127ca2:pvVar6 = *(void**)( this + 0x2a8 );
   if (pvVar6 != (void*)0x0) {
      if (*(int*)( this + 0x2cc ) != 0) {
 ...
 while ( lVar5 != (ulong)uVar2 << 2 );
   ...
   LAB_00127d37:CowData<int>::_unref((CowData<int>*)( this + 0x290 ));
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<int>::resize<false>(long) */undefined8 CowData<int>::resize<false>(CowData<int> *this, long param_1) {
   ...
   if (param_1 * 4 == 0) {
      LAB_001280b0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (uVar3 + 1 == lVar2) {
      LAB_00128010:puVar4 = *(undefined8**)this;
      if (puVar4 == (undefined8*)0x0) {
         LAB_00128019:_DAT_00000000 = 0;
         /* WARNING: Does not return */
         pcVar1 = (code*)invalidInstructionException();
         ( *pcVar1 )();
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<float>::resize<false>(long) */undefined8 CowData<float>::resize<false>(CowData<float> *this, long param_1) {
   ...
   if (param_1 * 4 == 0) {
      LAB_001283d0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (uVar3 + 1 == lVar2) {
      LAB_00128330:puVar4 = *(undefined8**)this;
      if (puVar4 == (undefined8*)0x0) {
         LAB_00128339:_DAT_00000000 = 0;
         /* WARNING: Does not return */
         pcVar1 = (code*)invalidInstructionException();
         ( *pcVar1 )();
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<double>::resize<false>(long) */undefined8 CowData<double>::resize<false>(CowData<double> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_00128a70:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (uVar3 + 1 == lVar2) {
      LAB_001289d0:puVar4 = *(undefined8**)this;
      if (puVar4 == (undefined8*)0x0) {
         LAB_001289d9:_DAT_00000000 = 0;
         /* WARNING: Does not return */
         pcVar1 = (code*)invalidInstructionException();
         ( *pcVar1 )();
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Quaternion>::resize<false>(long) */undefined8 CowData<Quaternion>::resize<false>(CowData<Quaternion> *this, long param_1) {
   long *plVar1;
   code *pcVar2;
   undefined8 uVar3;
   long lVar4;
   ...
   if (param_1 * 0x10 == 0) {
      LAB_00128da0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (param_1 <= lVar12) {
      ...
      LAB_00128c72:puVar6[-1] = param_1;
      return 0;
   }

   if (uVar5 + 1 == lVar4) {
      LAB_00128cd0:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         /* WARNING: Does not return */
         pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
      ...
      lVar4 = puVar9[-1];
      LAB_00128ce1:if (param_1 <= lVar4) goto LAB_00128c50;
   }
 else {
      if (lVar12 != 0) {
...
/* ImporterMeshInstance3D::~ImporterMeshInstance3D() */void ImporterMeshInstance3D::~ImporterMeshInstance3D(ImporterMeshInstance3D *this) {
   Object *pOVar1;
   char cVar2;
   *(undefined***)this = &PTR__initialize_classv_0012e9d0;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Ref<Material> >::resize<false>(long) */undefined8 CowData<Ref<Material>>::resize<false>(CowData<Ref<Material>> *this, long param_1) {
   Object *pOVar1;
   code *pcVar2;
   char cVar3;
   undefined8 *puVar4;
   ...
   if (param_1 * 8 == 0) {
      LAB_001292e8:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (uVar8 + 1 == lVar7) {
      LAB_00129230:puVar4 = *(undefined8**)this;
      if (puVar4 == (undefined8*)0x0) {
         LAB_0012912a:/* WARNING: Does not return */pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
      }

      lVar11 = puVar4[-1];
      LAB_00129240:if (param_1 <= lVar11) goto LAB_00129213;
   }
 else {
      if (lVar11 != 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Ref<GLTFSkin> >::resize<false>(long) */undefined8 CowData<Ref<GLTFSkin>>::resize<false>(CowData<Ref<GLTFSkin>> *this, long param_1) {
   Object *pOVar1;
   code *pcVar2;
   char cVar3;
   undefined8 *puVar4;
   ...
   if (param_1 * 8 == 0) {
      LAB_00129828:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (uVar8 + 1 == lVar7) {
      LAB_00129770:puVar4 = *(undefined8**)this;
      if (puVar4 == (undefined8*)0x0) {
         LAB_0012966a:/* WARNING: Does not return */pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
      }

      lVar11 = puVar4[-1];
      LAB_00129780:if (param_1 <= lVar11) goto LAB_00129753;
   }
 else {
      if (lVar11 != 0) {
         pvVar9 = (void*)( *(long*)this + -0x10 );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Ref<GLTFNode> >::resize<false>(long) */undefined8 CowData<Ref<GLTFNode>>::resize<false>(CowData<Ref<GLTFNode>> *this, long param_1) {
   Object *pOVar1;
   code *pcVar2;
   char cVar3;
   undefined8 *puVar4;
   ...
   if (param_1 * 8 == 0) {
      LAB_00129c88:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (uVar8 + 1 == lVar7) {
      LAB_00129bd0:puVar4 = *(undefined8**)this;
      if (puVar4 == (undefined8*)0x0) {
         LAB_00129aca:/* WARNING: Does not return */pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
      }

      lVar11 = puVar4[-1];
      LAB_00129be0:if (param_1 <= lVar11) goto LAB_00129bb3;
   }
 else {
      if (lVar11 != 0) {
         pvVar9 = (void*)( *(long*)this + -0x10 );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Ref<GLTFMesh> >::resize<false>(long) */undefined8 CowData<Ref<GLTFMesh>>::resize<false>(CowData<Ref<GLTFMesh>> *this, long param_1) {
   Object *pOVar1;
   code *pcVar2;
   char cVar3;
   undefined8 *puVar4;
   ...
   if (param_1 * 8 == 0) {
      LAB_0012a0e8:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (uVar8 + 1 == lVar7) {
      LAB_0012a030:puVar4 = *(undefined8**)this;
      if (puVar4 == (undefined8*)0x0) {
         LAB_00129f2a:/* WARNING: Does not return */pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
      }

      lVar11 = puVar4[-1];
      LAB_0012a040:if (param_1 <= lVar11) goto LAB_0012a013;
   }
 else {
      if (lVar11 != 0) {
         pvVar9 = (void*)( *(long*)this + -0x10 );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Ref<Texture2D> >::resize<false>(long) */undefined8 CowData<Ref<Texture2D>>::resize<false>(CowData<Ref<Texture2D>> *this, long param_1) {
   Object *pOVar1;
   code *pcVar2;
   char cVar3;
   undefined8 *puVar4;
   ...
   if (param_1 * 8 == 0) {
      LAB_0012a548:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (uVar8 + 1 == lVar7) {
      LAB_0012a490:puVar4 = *(undefined8**)this;
      if (puVar4 == (undefined8*)0x0) {
         LAB_0012a38a:/* WARNING: Does not return */pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
      }

      lVar11 = puVar4[-1];
      LAB_0012a4a0:if (param_1 <= lVar11) goto LAB_0012a473;
   }
 else {
      if (lVar11 != 0) {
         pvVar9 = (void*)( *(long*)this + -0x10 );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Ref<Image> >::resize<false>(long) */undefined8 CowData<Ref<Image>>::resize<false>(CowData<Ref<Image>> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_0012a958:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (uVar7 + 1 == lVar6) {
      LAB_0012a8a0:puVar3 = *(undefined8**)this;
      if (puVar3 == (undefined8*)0x0) {
         LAB_0012a7ba:/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException();
         ( *pcVar1 )();
      }

      lVar10 = puVar3[-1];
      LAB_0012a8b0:if (param_1 <= lVar10) goto LAB_0012a883;
   }
 else {
      if (lVar10 != 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Ref<GLTFTexture> >::resize<false>(long) */undefined8 CowData<Ref<GLTFTexture>>::resize<false>(CowData<Ref<GLTFTexture>> *this, long param_1) {
   Object *pOVar1;
   code *pcVar2;
   char cVar3;
   undefined8 *puVar4;
   ...
   if (param_1 * 8 == 0) {
      LAB_0012adb8:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (uVar8 + 1 == lVar7) {
      LAB_0012ad00:puVar4 = *(undefined8**)this;
      if (puVar4 == (undefined8*)0x0) {
         LAB_0012abfa:/* WARNING: Does not return */pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
      }

      lVar11 = puVar4[-1];
      LAB_0012ad10:if (param_1 <= lVar11) goto LAB_0012ace3;
   }
 else {
      if (lVar11 != 0) {
         pvVar9 = (void*)( *(long*)this + -0x10 );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Ref<GLTFCamera> >::resize<false>(long) */undefined8 CowData<Ref<GLTFCamera>>::resize<false>(CowData<Ref<GLTFCamera>> *this, long param_1) {
   Object *pOVar1;
   code *pcVar2;
   char cVar3;
   undefined8 *puVar4;
   ...
   if (param_1 * 8 == 0) {
      LAB_0012b218:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (uVar8 + 1 == lVar7) {
      LAB_0012b160:puVar4 = *(undefined8**)this;
      if (puVar4 == (undefined8*)0x0) {
         LAB_0012b05a:/* WARNING: Does not return */pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
      }

      lVar11 = puVar4[-1];
      LAB_0012b170:if (param_1 <= lVar11) goto LAB_0012b143;
   }
 else {
      if (lVar11 != 0) {
         pvVar9 = (void*)( *(long*)this + -0x10 );
   ...
   memset(puVar4 + lVar11, 0, ( param_1 - lVar11 ) * 8);
   LAB_0012b143:puVar4[-1] = param_1;
   return 0;
}
/* CowData<GLTFAnimation::Channel<float> >::_unref() */void CowData<GLTFAnimation::Channel<float>>::_unref(CowData<GLTFAnimation::Channel<float>> *this) {
   long *plVar1;
   long lVar2;
   long lVar3;
   long lVar4;
...
/* CowData<GLTFAnimation::Channel<float> >::_ref(CowData<GLTFAnimation::Channel<float> > const&)
   [clone .part.0] */void CowData<GLTFAnimation::Channel<float>>::_ref(CowData<GLTFAnimation::Channel<float>> *this, CowData *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   bool bVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<int, GLTFAnimation::NodeTrack, HashMapHasherDefault, HashMapComparatorDefault<int>,
   DefaultTypedAllocator<HashMapElement<int, GLTFAnimation::NodeTrack> > >::operator[](int const&)
    */undefined1 * __thiscallHashMap<int,GLTFAnimation::NodeTrack,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,GLTFAnimation::NodeTrack>>>::operator [](HashMap<int,GLTFAnimation::NodeTrack,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,GLTFAnimation::NodeTrack>>> * this, int, *param_1) * plVar1 ;uint *puVar2void *pvVar3void *__slong lVar4undefined1 auVar5[16]undefined1 auVar6[16]undefined1 auVar7[16]undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1 auVar15[16]undefined1 auVar16[16]undefined1 auVar17[16]undefined1 auVar18[16]undefined1 auVar19[16]undefined1 auVar20[16]undefined1 auVar21[16]undefined1 auVar22[16]undefined1 auVar23[16]undefined1 auVar24[16]undefined1 auVar25[16]undefined1 auVar26[16]undefined1 auVar27[16]undefined1 auVar28[16]undefined1 auVar29[16]undefined1 auVar30[16]undefined1 auVar31[16]undefined1 auVar32[16]undefined1 auVar33[16]undefined1 auVar34[16]undefined1 auVar35[16]undefined1 auVar36[16]undefined1(*pauVar37)[16];uint uVar38uint uVar39uint uVar40ulong uVar41undefined8 uVar42void *__s_00undefined1(*pauVar43)[16];ulong uVar44ulong uVar45int iVar46long lVar47long lVar48long lVar49undefined8 uVar50undefined8 *puVar51uint uVar52ulong uVar53uint uVar54uint uVar55undefined1(*pauVar56)[16];long in_FS_OFFSETvoid *local_1a0undefined8 local_178[2]CowData local_168[16]CowData local_158[24]CowData local_140[16]long local_130[3]undefined8 local_118[2]undefined8 local_108[2]undefined8 local_f8[2]undefined1 local_e8[16]int local_d8undefined4 local_d0undefined8 local_c0[2]undefined8 local_b0undefined4 local_a8undefined8 local_98[2]long local_88undefined4 local_80undefined8 local_70[2]undefined8 local_60[2]undefined8 local_50[2]long local_40local_1a0 = *(void**)( this + 8 );uVar40 = *param_1;local_40 = *(long*)( in_FS_OFFSET + 0x28 );uVar39 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );uVar41 = CONCAT44(0, uVar39);if (( local_1a0 != (void*)0x0 ) && ( *(int*)( this + 0x2c ) != 0 )) {
   ...
   if (uVar38 != 0) {
      uVar54 = 0;
      do {
         if (( uVar55 == uVar38 ) && ( uVar40 == *(uint*)( *(long*)( (long)local_1a0 + lVar47 * 8 ) + 0x10 ) )) {
 ...
 while ( ( uVar38 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = uVar38 * uVar44,auVar23._8_8_ = 0,auVar23._0_8_ = uVar41,auVar8._8_8_ = 0,auVar8._0_8_ = ( ( uVar52 + uVar39 ) - SUB164(auVar7 * auVar23, 8) ) * uVar44,auVar24._8_8_ = 0,auVar24._0_8_ = uVar41,uVar54 <= SUB164(auVar8 * auVar24, 8) );
   }

}
puVar51 = local_178;for (lVar47 = 0xb; lVar47 != 0; lVar47 = lVar47 + -1) {
   *puVar51 = 0;
   puVar51 = puVar51 + 1;
}
local_118[0] = 0;local_108[0] = 0;local_f8[0] = 0;if (local_1a0 == (void*)0x0) {
   uVar44 = uVar41 * 4;
   uVar45 = uVar41 * 8;
   ...
   *(void**)( this + 8 ) = local_1a0;
   if (uVar39 != 0) {
      pvVar3 = *(void**)( this + 0x10 );
      if (( pvVar3 < (void*)( (long)local_1a0 + uVar45 ) ) && ( local_1a0 < (void*)( (long)pvVar3 + uVar44 ) )) {
         uVar44 = 0;
         do {
 ...
 while ( uVar41 != uVar44 );
   ...
   LAB_0012b557:iVar46 = *(int*)( this + 0x2c );
   LAB_0012b560:if (iVar46 != 0) {
      uVar44 = *(ulong*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( this + 0x28 ) * 8 );
      ...
      if (uVar39 != 0) {
         do {
            if (( uVar38 == uVar39 ) && ( *(uint*)( *(long*)( (long)local_1a0 + lVar47 * 8 ) + 0x10 ) == uVar40 )) {
               ...
               *(undefined4*)( lVar47 + 0x68 ) = 0;
               ...
               if (*(long*)( lVar47 + 0x98 ) != 0) {
                  CowData<GLTFAnimation::Channel<float>>::_ref((CowData<GLTFAnimation::Channel<float>>*)( lVar47 + 0x98 ), (CowData*)local_f8);
               }
 ...
 while ( ( uVar39 != 0 ) && ( auVar11._8_8_ = 0 ),auVar11._0_8_ = uVar39 * uVar44,auVar27._8_8_ = 0,auVar27._0_8_ = uVar53,auVar12._8_8_ = 0,auVar12._0_8_ = ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 ) + uVar55 ) - SUB164(auVar11 * auVar27, 8) ) * uVar44,auVar28._8_8_ = 0,auVar28._0_8_ = uVar53,uVar52 <= SUB164(auVar12 * auVar28, 8) );
      }
...
local_e8 = (undefined1[16])0x0;local_d0 = 0;iVar46 = *param_1;local_c0[0] = 0;local_b0 = 0;local_a8 = 0;local_98[0] = 0;local_88 = 0;local_80 = 0;local_70[0] = 0;local_60[0] = 0;local_50[0] = 0;local_d8 = iVar46;pauVar43 = (undefined1(*) [16])operator_new(0xa0, "");*(int*)pauVar43[1] = iVar46;*(undefined4*)( pauVar43[1] + 8 ) = 0;*(undefined8*)( pauVar43[2] + 8 ) = 0;*(undefined8*)( pauVar43[3] + 8 ) = 0;*(undefined4*)pauVar43[4] = 0;*(undefined8*)pauVar43[5] = 0;*(undefined8*)pauVar43[6] = 0;*(undefined4*)( pauVar43[6] + 8 ) = 0;*(undefined8*)( pauVar43[7] + 8 ) = 0;*(undefined8*)( pauVar43[8] + 8 ) = 0;*(undefined8*)( pauVar43[9] + 8 ) = 0;*pauVar43 = (undefined1[16])0x0;CowData<GLTFAnimation::Channel<float>>::_unref((CowData<GLTFAnimation::Channel<float>>*)local_50);CowData<Vector3>::_unref((CowData<Vector3>*)local_60);CowData<double>::_unref((CowData<double>*)local_70);if (local_88 != 0) {
   LOCK();
...
CowData<double>::_unref((CowData<double>*)local_98);CowData<Vector3>::_unref((CowData<Vector3>*)&local_b0);CowData<double>::_unref((CowData<double>*)local_c0);puVar51 = *(undefined8**)( this + 0x20 );if (puVar51 == (undefined8*)0x0) {
...
*(undefined1(**) [16])( this + 0x20 ) = pauVar43;uVar40 = ( ( uint ) * param_1 >> 0x10 ^ *param_1 ) * -0x7a143595;uVar39 = ( uVar40 ^ uVar40 >> 0xd ) * -0x3d4d51cb;uVar40 = uVar39 ^ uVar39 >> 0x10;if (uVar39 == uVar39 >> 0x10) {
   uVar41 = 1;
   uVar40 = 1;
}
 else {
...
uVar55 = 0;lVar47 = *(long*)( this + 0x10 );uVar39 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );uVar44 = CONCAT44(0, uVar39);lVar4 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( this + 0x28 ) * 8 );auVar17._8_8_ = 0;auVar17._0_8_ = uVar41 * lVar4;auVar33._8_8_ = 0;auVar33._0_8_ = uVar44;lVar49 = SUB168(auVar17 * auVar33, 8);lVar48 = *(long*)( this + 8 );puVar2 = (uint*)( lVar47 + lVar49 * 4 );iVar46 = SUB164(auVar17 * auVar33, 8);uVar38 = *puVar2;pauVar37 = pauVar43;while (uVar38 != 0) {
   auVar18._8_8_ = 0;
...
;*(undefined1(**) [16])( lVar48 + lVar49 * 8 ) = pauVar37;*puVar2 = uVar40;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0012bc30:CowData<GLTFAnimation::Channel<float>>::_unref((CowData<GLTFAnimation::Channel<float>>*)local_f8);CowData<Vector3>::_unref((CowData<Vector3>*)local_108);CowData<double>::_unref((CowData<double>*)local_118);if (local_130[0] != 0) {
   LOCK();
...
CowData<double>::_unref((CowData<double>*)local_140);CowData<Vector3>::_unref((CowData<Vector3>*)local_158);CowData<double>::_unref((CowData<double>*)local_168);LAB_0012bc8c:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return pauVar43[1] + 8;}/* CowData<Ref<GLTFAnimation> >::_unref() */void CowData<Ref<GLTFAnimation>>::_unref(CowData<Ref<GLTFAnimation>> *this) {
   long *plVar1;
   long lVar2;
   Object *pOVar3;
   code *pcVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Ref<GLTFAnimation> >::resize<false>(long) */undefined8 CowData<Ref<GLTFAnimation>>::resize<false>(CowData<Ref<GLTFAnimation>> *this, long param_1) {
   Object *pOVar1;
   code *pcVar2;
   char cVar3;
   undefined8 *puVar4;
   ...
   if (param_1 * 8 == 0) {
      LAB_0012c248:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (uVar8 + 1 == lVar7) {
      LAB_0012c190:puVar4 = *(undefined8**)this;
      if (puVar4 == (undefined8*)0x0) {
         LAB_0012c08a:/* WARNING: Does not return */pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
      }

      lVar11 = puVar4[-1];
      LAB_0012c1a0:if (param_1 <= lVar11) goto LAB_0012c173;
   }
 else {
      if (lVar11 != 0) {
         pvVar9 = (void*)( *(long*)this + -0x10 );
...
/* GLTFState::~GLTFState() */void GLTFState::~GLTFState(GLTFState *this) {
 ...
 while ( (ulong)uVar2 << 2 != lVar7 );
   ...
   LAB_0012c567:pvVar10 = *(void**)( this + 0x4c8 );
   if (pvVar10 != (void*)0x0) {
      if (*(int*)( this + 0x4ec ) != 0) {
            ...
            do {
               if (*(int*)( *(long*)( this + 0x4d0 ) + lVar7 ) != 0) {
                  ...
                  *(int*)( *(long*)( this + 0x4d0 ) + lVar7 ) = 0;
                  if (( *(long*)( (long)pvVar10 + 0x18 ) != 0 ) && ( cVar6 = cVar6 != '\0' )) {
 ...
 while ( lVar7 != (ulong)uVar2 << 2 );
   ...
   LAB_0012c62a:pvVar10 = *(void**)( this + 0x498 );
   if (pvVar10 != (void*)0x0) {
      if (*(int*)( this + 0x4bc ) != 0) {
 ...
 while ( (ulong)uVar2 << 2 != lVar7 );
   ...
   LAB_0012c6c9:pvVar10 = *(void**)( this + 0x468 );
   if (pvVar10 != (void*)0x0) {
      if (*(int*)( this + 0x48c ) != 0) {
 ...
 while ( (ulong)uVar2 << 2 != lVar7 );
   ...
   LAB_0012c769:CowData<Ref<GLTFAnimation>>::_unref((CowData<Ref<GLTFAnimation>>*)( this + 0x458 ));
 ...
 while ( (uint)lVar7 < *(uint*)( this + 0x43c ) );
   ...
   LAB_0012c807:pvVar10 = *(void**)( this + 0x3f0 );
   if (pvVar10 != (void*)0x0) {
 ...
 while ( (uint)lVar7 < *(uint*)( this + 0x414 ) );
   ...
   LAB_0012c88f:CowData<Ref<GLTFLight>>::_unref((CowData<Ref<GLTFLight>>*)( this + 1000 ));
   ...
   if (( *(long*)( this + 0x378 ) != 0 ) && ( cVar6 = cVar6 != '\0' )) {
...
;
 ...
 while ( lVar7 != lVar11 );
         ...
         LAB_0012c9a0:Memory::free_static(plVar1 + -2, false);
      }
            ...
            do {
               if (*(int*)( *(long*)( this + 0x310 ) + lVar7 ) != 0) {
                  ...
                  *(int*)( *(long*)( this + 0x310 ) + lVar7 ) = 0;
                  if (( *(long*)( (long)pvVar10 + 0x10 ) != 0 ) && ( cVar6 = cVar6 != '\0' )) {
 ...
 while ( (ulong)uVar2 << 2 != lVar7 );
   ...
   LAB_0012ca95:if (*(long*)( this + 0x2f8 ) != 0) {
      LOCK();
...
;
 ...
 while ( lVar7 != lVar11 );
         ...
         LAB_0012cb60:Memory::free_static(plVar1 + -2, false);
      }
...
;
 ...
 while ( lVar7 != lVar11 );
         ...
         LAB_0012cc10:Memory::free_static(plVar1 + -2, false);
      }
   ...
   if (*(long*)( this + 0x2b8 ) != 0) {
      ...
      *plVar1 = *plVar1 + -1;
      ...
      if (*plVar1 == 0) {
         ...
         if (lVar7 == 0) {
            LAB_0012cf73:/* WARNING: Does not return */pcVar5 = (code*)invalidInstructionException();
            ( *pcVar5 )();
         }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Ref<GLTFLight> >::resize<false>(long) */undefined8 CowData<Ref<GLTFLight>>::resize<false>(CowData<Ref<GLTFLight>> *this, long param_1) {
   Object *pOVar1;
   code *pcVar2;
   char cVar3;
   undefined8 *puVar4;
   ...
   if (param_1 * 8 == 0) {
      LAB_0012d298:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (uVar8 + 1 == lVar7) {
      LAB_0012d1e0:puVar4 = *(undefined8**)this;
      if (puVar4 == (undefined8*)0x0) {
         LAB_0012d0da:/* WARNING: Does not return */pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
      }

      lVar11 = puVar4[-1];
      LAB_0012d1f0:if (param_1 <= lVar11) goto LAB_0012d1c3;
   }
 else {
      if (lVar11 != 0) {
         pvVar9 = (void*)( *(long*)this + -0x10 );
...
/* void memdelete<HashMapElement<String, HashMap<String, Variant, HashMapHasherDefault,
 ...
 while ( lVar4 != (ulong)uVar2 << 2 );
   ...
   LAB_0012d421:CowData<char32_t>::_unref((CowData<char32_t>*)( param_1 + 0x10 ));
   Memory::free_static(param_1, false);
   return;
}
/* ConfigFile::~ConfigFile() */void ConfigFile::~ConfigFile(ConfigFile *this) {
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
   ...
   LAB_0012d531:*(undefined***)this = &PTR__initialize_classv_0012db60;
   Object::~Object((Object*)this);
   return;
}
/* ConfigFile::~ConfigFile() */void ConfigFile::~ConfigFile(ConfigFile *this) {
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
   ...
   LAB_0012d621:*(undefined***)this = &PTR__initialize_classv_0012db60;
   Object::~Object((Object*)this);
   operator_delete(this, 0x1b0);
   return;
}
/* GLTFDocument::~GLTFDocument() */void GLTFDocument::~GLTFDocument(GLTFDocument *this) {
   long *plVar1;
   long lVar2;
   Object *pOVar3;
   code *pcVar4;
...
/* FBXDocument::~FBXDocument() */void FBXDocument::~FBXDocument(FBXDocument *this) {
...
/* FBXDocument::_gen_unique_name(HashSet<String, HashMapHasherDefault,
   HashMapComparatorDefault<String> >&, String const&) */void FBXDocument::_GLOBAL__sub_I__gen_unique_name(void) {
...
/* WARNING: Control flow encountered bad instruction data *//* FBXDocument::~FBXDocument() */void FBXDocument::~FBXDocument(FBXDocument *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* GLTFDocument::~GLTFDocument() */void GLTFDocument::~GLTFDocument(GLTFDocument *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* ImporterMeshInstance3D::~ImporterMeshInstance3D() */void ImporterMeshInstance3D::~ImporterMeshInstance3D(ImporterMeshInstance3D *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

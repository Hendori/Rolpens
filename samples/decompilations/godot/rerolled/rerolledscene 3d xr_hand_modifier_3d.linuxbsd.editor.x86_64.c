/* XRHandModifier3D::get_bone_update() const */undefined4 XRHandModifier3D::get_bone_update(XRHandModifier3D *this) {
   return *(undefined4*)( this + 0x558 );
}
/* XRHandModifier3D::get_hand_tracker() const */void XRHandModifier3D::get_hand_tracker(void) {
   long in_RSI;
   StringName *in_RDI;
   StringName::StringName(in_RDI, (StringName*)( in_RSI + 0x550 ));
   return;
}
/* XRHandModifier3D::set_hand_tracker(StringName const&) */void XRHandModifier3D::set_hand_tracker(XRHandModifier3D *this, StringName *param_1) {
   StringName::operator =((StringName*)( this + 0x550 ), param_1);
   return;
}
/* XRHandModifier3D::set_bone_update(XRHandModifier3D::BoneUpdate) */void XRHandModifier3D::set_bone_update(XRHandModifier3D *this, uint param_2) {
   if (param_2 < 2) {
      *(uint*)( this + 0x558 ) = param_2;
      return;
   }

   _err_print_index_error("set_bone_update", "scene/3d/xr_hand_modifier_3d.cpp", 0x3c, (ulong)param_2, 2, "p_bone_update", "BONE_UPDATE_MAX", "", false, false);
   return;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* XRHandModifier3D::_get_joint_data() */void XRHandModifier3D::_get_joint_data(XRHandModifier3D *this) {
   Object *pOVar1;
   char cVar2;
   int iVar3;
   int iVar4;
   ...
   if (( (byte)this[0x2fa] & 0x40 ) != 0) {
      if (this[0x62c] == (XRHandModifier3D)0x0) {
         if (_get_joint_data() == '\0') {
            LAB_00100678:iVar3 = __cxa_guard_acquire(&_get_joint_data(), ::bone_names);
            if (iVar3 != 0) {
               _get_joint_data()
         ...
         if (_get_joint_data() == '\0') goto LAB_00100678;
      }

      if (( _get_joint_data() ) && ( iVar3 = iVar3 != 0 )) {
         _get_joint_data()
      ...
      *(int*)pXVar11 = -1;
      for (int i = 0; i < 3; i++) {
         *(undefined4*)( this + ( 4*i + 1376 ) ) = 4294967295;
      }
      ...
      do {
         *(undefined4*)pXVar5 = 0xffffffff;
         for (int i = 0; i < 3; i++) {
            *(undefined4*)( pXVar5 + ( 4*i + 4 ) ) = 4294967295;
         }

         pXVar6 = pXVar5 + 0x20;
         for (int i = 0; i < 4; i++) {
            *(undefined4*)( pXVar5 + ( 4*i + 16 ) ) = 4294967295;
         }
 ...
 while ( this + 0x62c != pXVar6 );
      ...
      if (( pSVar7 != (String*)0x0 ) && ( lVar8 = lVar8 != 0 )) {
         ...
         if (local_b8 != (Object*)0x0) {
            ...
            if (local_100 == (Object*)0x0) {
               LAB_00100420:cVar2 = RefCounted::unreference();
               pOVar1 = local_b8;
            ...
            if (iVar3 - 1U < 2) {
               ...
               do {
                  ...
                  String::replace((String*)local_d0, (String*)( &_get_joint_data()::bone_name_format + ( iVar3 != 1 ) ));
                  ...
                  *(int*)plVar10 = iVar4;
                  if (iVar4 == -1) {
                     ...
                     _err_print_error("_get_joint_data", "scene/3d/xr_hand_modifier_3d.cpp", 0x99, (StringName*)&local_b8, 0, 1);
 ...
 while ( local_40 != plVar10 );
   ...
   LAB_001005d0:if (local_40[0] == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

   LAB_00100b4d:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* XRHandModifier3D::_tracker_changed(StringName, XRServer::TrackerType) */void XRHandModifier3D::_tracker_changed(XRHandModifier3D *param_1, long *param_2) {
...
/* XRHandModifier3D::_skeleton_changed(Skeleton3D*, Skeleton3D*) */void XRHandModifier3D::_skeleton_changed(Skeleton3D *param_1, Skeleton3D *param_2) {
   _get_joint_data((XRHandModifier3D*)param_1);
   return;
}
/* XRHandModifier3D::_notification(int) */void XRHandModifier3D::_notification(XRHandModifier3D *this, int param_1) {
   code *pcVar1;
   long *plVar2;
   ...
   if (param_1 == 10) {
      ...
      if (plVar2 != (long*)0x0) {
         ...
         create_custom_callable_function_pointer<XRHandModifier3D,StringName,XRServer::TrackerType>(local_58, (char*)this, (_func_void_StringName_TrackerType*)"&XRHandModifier3D::_tracker_changed");
      ...
      if (param_1 == 0xb) {
         ...
         for (int i = 0; i < 4; i++) {
            *(undefined4*)( this + ( 4*i + 1372 ) ) = 4294967295;
         }
...
/* XRHandModifier3D::_bind_methods() */void XRHandModifier3D::_bind_methods(void) {
   long lVar1;
   code *pcVar2;
   long *plVar3;
   MethodBind *pMVar4;
 ...
 while ( lVar1 != lVar5 );
   ...
   local_70 = 6;
   StringName::operator =((StringName*)&local_88, (StringName*)&local_c0);
   LAB_001017ab:local_a8 = "XRHandModifier3D";
   local_d8 = 0;
   local_a0 = 0x10;
   String::parse_latin1((StrRange*)&local_d8);
   StringName::StringName((StringName*)&local_a8, (String*)&local_d8, false);
   ...
   GetTypeInfo<XRHandModifier3D::BoneUpdate,void>::get_class_info((GetTypeInfo<XRHandModifier3D::BoneUpdate,void>*)&local_98);
...
/* XRHandModifier3D::get_configuration_warnings() const */XRHandModifier3D * __thiscall XRHandModifier3D::get_configuration_warnings(XRHandModifier3D *this){
   CowData<char32_t> *this_00;
   bool bVar1;
   int iVar2;
   long lVar3;
   ...
   LAB_00102025:CowData<char32_t>::_unref((CowData<char32_t>*)&local_90);
   LAB_00101ec6:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* XRHandModifier3D::_process_modification() */void XRHandModifier3D::_process_modification(XRHandModifier3D *this) {
   ...
   if (( lVar7 == 0 ) || ( lVar8 = lVar8 == 0 )) goto LAB_00102340;
   ...
   if (local_af0 == (Object*)0x0) {
      LAB_001021df:cVar4 = RefCounted::unreference();
      local_af0 = local_a78;
      pOVar2 = local_a70[0];
      joined_r0x00102398:local_a78 = local_af0;
      if (cVar4 != '\0') {
            ...
            if (*(uint*)( this + lVar7 * 8 + 0x55c ) != 0xffffffff) {
               ...
               if (*(int*)( this + 0x558 ) == 0) {
                  if (lVar8 != 0) {
                     ...
                     Skeleton3D::set_bone_pose_position(iVar18, (Vector3*)( ulong ) * (uint*)( this + lVar7 * 8 + 0x55c ));
                     lVar8 = *(long*)( this + 0x638 );
                     goto LAB_001022bb;
                  }
                  ...
                  LAB_001022bb:if (lVar8 != 0) {
                     lVar8 = *(long*)( lVar8 + -8 );
                     if (lVar8 <= lVar7) goto LAB_001022c3;
                     Basis::get_quaternion();
                     Skeleton3D::set_bone_pose_rotation(iVar18, (Quaternion*)( ulong ) * (uint*)( this + lVar7 * 8 + 0x55c ));
                     goto LAB_00102267;
                  }
               ...
               lVar8 = 0;
               LAB_001022c3:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar7, lVar8, "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
 ...
 while ( pTVar9 != local_48 );
      ...
      do {
         while (true) {
            ...
            *(ulong*)( pTVar10 + 0x24 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( pTVar10 + 0x24 ) >> 0x20 ) * fVar19, (float)*(undefined8*)( pTVar10 + 0x24 ) * fVar19);
            Transform3D::inverse();
...
;
            ...
            if (*(long*)( this + 0x638 ) == 0) {
               ...
               if (puVar13 == (undefined8*)0x0) {
                  ...
                  *(undefined8**)( this + 0x638 ) = puVar14;
                  LAB_00102776:pauVar11 = (undefined1(*) [16])( puVar14 + lVar7 * 6 );
                  do {
 ...
 while ( (undefined1(*) [16])( puVar14 + 0x9c ) != pauVar12 );
               ...
               if (lVar7 != 0x1a) {
                  ...
                  if (lVar7 * 0x30 == 0) {
                     if (lVar7 < 0x1a) {
                        LAB_00102810:if (lVar7 == 0) goto LAB_00102850;
                        iVar6 = CowData<Transform3D>::_realloc(this_00, 0x800);
                        if (iVar6 == 0) goto LAB_0010275c;
                     }
 else {
                        LAB_001027f3:iVar6 = CowData<Transform3D>::_realloc(this_00, 0x800);
                     ...
                     if (lVar7 < 0x1a) {
                        ...
                        LAB_0010275c:puVar14 = *(undefined8**)( this + 0x638 );
                     ...
                     LAB_001027d3:if (*(long*)( this + 0x638 ) == 0) {
         ...
         do {
            if (*(uint*)pXVar17 != 0xffffffff) {
               Transform3D::operator *((Transform3D*)&local_a38, local_528 + (long)(int)*(uint*)( pXVar17 + 4 ) * 0x30);
               *puVar13 = local_a38;
 ...
 while ( this + 0x62c != pXVar17 );
   ...
   LAB_00102340:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* XRHandModifier3D::is_class_ptr(void*) const */uint XRHandModifier3D::is_class_ptr(XRHandModifier3D *this, void *param_1) {
   return (uint)CONCAT71(0x1092, (undefined4*)param_1 == &SkeletonModifier3D::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1091, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1092, (undefined4*)param_1 == &Node3D::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1092, (undefined4*)param_1 == &Node::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1092, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* XRHandModifier3D::_getv(StringName const&, Variant&) const */undefined8 XRHandModifier3D::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* XRHandModifier3D::_setv(StringName const&, Variant const&) */undefined8 XRHandModifier3D::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* CallableCustomMethodPointer<XRHandModifier3D, void, StringName,
   XRServer::TrackerType>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<XRHandModifier3D,void,StringName,XRServer::TrackerType>::~CallableCustomMethodPointer(CallableCustomMethodPointer<XRHandModifier3D,void,StringName,XRServer::TrackerType> *this) {
   return;
}
/* MethodBindTRC<XRHandModifier3D::BoneUpdate>::_gen_argument_type(int) const */undefined8 MethodBindTRC<XRHandModifier3D::BoneUpdate>::_gen_argument_type(int param_1) {
   return 2;
}
/* MethodBindTRC<XRHandModifier3D::BoneUpdate>::get_argument_meta(int) const */undefined8 MethodBindTRC<XRHandModifier3D::BoneUpdate>::get_argument_meta(int param_1) {
   return 0;
}
/* MethodBindT<XRHandModifier3D::BoneUpdate>::_gen_argument_type(int) const */char MethodBindT<XRHandModifier3D::BoneUpdate>::_gen_argument_type(MethodBindT<XRHandModifier3D::BoneUpdate> *this, int param_1) {
   return ( param_1 == 0 ) * '\x02';
}
/* MethodBindT<XRHandModifier3D::BoneUpdate>::get_argument_meta(int) const */undefined8 MethodBindT<XRHandModifier3D::BoneUpdate>::get_argument_meta(int param_1) {
   return 0;
}
...
/* CallableCustomMethodPointer<XRHandModifier3D, void, StringName,
   XRServer::TrackerType>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<XRHandModifier3D,void,StringName,XRServer::TrackerType>::get_argument_count(CallableCustomMethodPointer<XRHandModifier3D,void,StringName,XRServer::TrackerType> *this, bool *param_1) {
   *param_1 = true;
   return 2;
}
...
/* MethodBindT<XRHandModifier3D::BoneUpdate>::~MethodBindT() */void MethodBindT<XRHandModifier3D::BoneUpdate>::~MethodBindT(MethodBindT<XRHandModifier3D::BoneUpdate> *this) {
...
/* MethodBindTRC<XRHandModifier3D::BoneUpdate>::~MethodBindTRC() */void MethodBindTRC<XRHandModifier3D::BoneUpdate>::~MethodBindTRC(MethodBindTRC<XRHandModifier3D::BoneUpdate> *this) {
...
/* XRHandModifier3D::_property_get_revertv(StringName const&, Variant&) const */undefined8 XRHandModifier3D::_property_get_revertv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
...
/* XRHandModifier3D::_property_can_revertv(StringName const&) const */undefined8 XRHandModifier3D::_property_can_revertv(StringName *param_1) {
   undefined8 uVar1;
...
/* XRHandModifier3D::_bind_methods() [clone .cold] */void XRHandModifier3D::_bind_methods(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* XRHandModifier3D::_process_modification() [clone .cold] */void XRHandModifier3D::_process_modification(void) {
   code *pcVar1;
   _DAT_00000000 = 0;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
...
/* CallableCustomMethodPointer<XRHandModifier3D, void, StringName,
   XRServer::TrackerType>::get_object() const */undefined8 CallableCustomMethodPointer<XRHandModifier3D,void,StringName,XRServer::TrackerType>::get_object(CallableCustomMethodPointer<XRHandModifier3D,void,StringName,XRServer::TrackerType> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_0010339d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* XRHandModifier3D::_validate_propertyv(PropertyInfo&) const */void XRHandModifier3D::_validate_propertyv(PropertyInfo *param_1) {
...
/* XRHandModifier3D::~XRHandModifier3D() */void XRHandModifier3D::~XRHandModifier3D(XRHandModifier3D *this) {
   long *plVar1;
   long lVar2;
   bool bVar3;
   *(undefined***)this = &PTR__initialize_classv_00108de0;
   ...
   LAB_00103502:Node3D::~Node3D((Node3D*)this);
   return;
}
/* XRHandModifier3D::~XRHandModifier3D() */void XRHandModifier3D::~XRHandModifier3D(XRHandModifier3D *this) {
   long *plVar1;
   ...
   *(undefined***)this = &PTR__initialize_classv_00108de0;
   ...
   LAB_001035d2:Node3D::~Node3D((Node3D*)this);
...
/* XRHandModifier3D::_get_class_namev() const */undefined8 *XRHandModifier3D::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001036f3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001036f3;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "XRHandModifier3D");
         goto LAB_0010375e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "XRHandModifier3D");
   LAB_0010375e:return &_get_class_namev();
}
/* XRHandModifier3D::get_class() const */void XRHandModifier3D::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* Object::is_class(String const&) const */ulong Object::is_class(Object *this, String *param_1) {
   ...
   do {
      if (lVar2 == 0) {
         ...
         LAB_00103a3f:/* WARNING: Subroutine does not return */__stack_chk_fail();
      }
 ...
 while ( !bVar8 );
      ...
      LAB_00103953:uVar5 = String::operator ==(param_1, (String*)&local_50);
      lVar3 = local_50;
      if (local_50 != 0) {
         LOCK();
...
/* Callable create_custom_callable_function_pointer<XRHandModifier3D, StringName,
   ...
   XRServer::TrackerType)) */XRHandModifier3D *create_custom_callable_function_pointer<XRHandModifier3D,StringName,XRServer::TrackerType>(XRHandModifier3D *param_1, char *param_2, _func_void_StringName_TrackerType *param_3) {
   undefined8 uVar1;
   CallableCustom *this;
   undefined8 in_RCX;
   undefined8 in_R8;
...
/* MethodBindTRC<StringName>::_gen_argument_type_info(int) const */undefined4 *MethodBindTRC<StringName>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar1 + 2 ) = (undefined1[16])0x0;
   ...
   LAB_00103c65:CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
...
/* WARNING: Removing unreachable block (ram,0x00103e78) *//* String vformat<String>(String const&, String const) */undefined8 *vformat<String>(undefined8 *param_1, bool *param_2, String *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* WARNING: Removing unreachable block (ram,0x001040c0) *//* XRHandModifier3D::_notificationv(int, bool) */void XRHandModifier3D::_notificationv(XRHandModifier3D *this, int param_1, bool param_2) {
   int iVar1;
   iVar1 = (int)this;
   if (param_2) {
...
/* CallableCustomMethodPointer<XRHandModifier3D, void, StringName,
   XRServer::TrackerType>::call(Variant const**, int, Variant&, Callable::CallError&) const */void CallableCustomMethodPointer<XRHandModifier3D,void,StringName,XRServer::TrackerType>::call(CallableCustomMethodPointer<XRHandModifier3D,void,StringName,XRServer::TrackerType> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   undefined8 uVar3;
   char cVar4;
...
;
   ...
   _err_print_error(&_LC59, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", &local_48, 0, 0);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_48);
   CowData<char32_t>::_unref(local_58);
   CowData<char32_t>::_unref(local_60);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
   LAB_00104295:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* SkeletonModifier3D::is_class(String const&) const */undefined8 SkeletonModifier3D::is_class(SkeletonModifier3D *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_0010450f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar5 = local_60;
      if (local_60 != 0) {
         LOCK();
   ...
   LAB_001045c3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010475e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* XRHandModifier3D::is_class(String const&) const */undefined8 XRHandModifier3D::is_class(XRHandModifier3D *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *__s;
   long lVar3;
 ...
 while ( !bVar8 );
      ...
      LAB_001047df:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_00104893:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* XRHandModifier3D::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void XRHandModifier3D::_get_property_listv(XRHandModifier3D *this, List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   undefined1(*pauVar3)[16];
   undefined4 *puVar4;
...
/* MethodBind* create_method_bind<XRHandModifier3D, StringName const&>(void
   (XRHandModifier3D::*)(StringName const&)) */MethodBind *create_method_bind<XRHandModifier3D,StringName_const&>(_func_void_StringName_ptr *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<XRHandModifier3D, StringName>(StringName (XRHandModifier3D::*)()
   const) */MethodBind *create_method_bind<XRHandModifier3D,StringName>(_func_StringName *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
...
/* MethodBind* create_method_bind<XRHandModifier3D, XRHandModifier3D::BoneUpdate>(void
   (XRHandModifier3D::*)(XRHandModifier3D::BoneUpdate)) */MethodBind *create_method_bind<XRHandModifier3D,XRHandModifier3D::BoneUpdate>(_func_void_BoneUpdate *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<XRHandModifier3D,
   XRHandModifier3D::BoneUpdate>(XRHandModifier3D::BoneUpdate (XRHandModifier3D::*)() const) */MethodBind *create_method_bind<XRHandModifier3D,XRHandModifier3D::BoneUpdate>(_func_BoneUpdate *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* CowData<String>::_unref() */void CowData<String>::_unref(void) {
   long *plVar1;
   long *plVar2;
   long lVar3;
   long lVar4;
...
/* GetTypeInfo<XRHandModifier3D::BoneUpdate, void>::get_class_info() */GetTypeInfo<XRHandModifier3D::BoneUpdate,void> * __thiscall
GetTypeInfo<XRHandModifier3D::BoneUpdate,void>::get_class_info
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);
   LAB_00106095:CowData<String>::_unref();
...
/* MethodBindTRC<XRHandModifier3D::BoneUpdate>::_gen_argument_type_info(int) const */undefined8 MethodBindTRC<XRHandModifier3D::BoneUpdate>::_gen_argument_type_info(int param_1) {
   long lVar1;
   undefined4 in_register_0000003c;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   GetTypeInfo<XRHandModifier3D::BoneUpdate,void>::get_class_info((GetTypeInfo<XRHandModifier3D::BoneUpdate,void>*)CONCAT44(in_register_0000003c, param_1));
   if (lVar1 == *(long*)( in_FS_OFFSET + 0x28 )) {
...
/* MethodBindT<XRHandModifier3D::BoneUpdate>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<XRHandModifier3D::BoneUpdate>::_gen_argument_type_info(int param_1) {
   long lVar1;
   int in_EDX;
   undefined4 in_register_0000003c;
   undefined4 *puVar2;
   ...
   *(undefined1(*) [16])( puVar2 + 2 ) = (undefined1[16])0x0;
   if (in_EDX == 0) {
      GetTypeInfo<XRHandModifier3D::BoneUpdate,void>::get_class_info((GetTypeInfo<XRHandModifier3D::BoneUpdate,void>*)local_48);
      *puVar2 = local_48[0];
...
/* XRHandModifier3D::_initialize_classv() */void XRHandModifier3D::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_70;
   long local_68;
   long local_60;
   ...
   if (initialize_class() == '\0') {
      if (SkeletonModifier3D::initialize_class() == '\0') {
         ...
         SkeletonModifier3D::initialize_class()::initialized =
         '\x01';
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<String>::resize<false>(long) */undefined8 CowData<String>::resize<false>(CowData<String> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_00106b40:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar9 == lVar5) {
      LAB_00106abb:puVar7 = *(undefined8**)this;
      if (puVar7 == (undefined8*)0x0) {
         LAB_00106b96:/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException();
         ( *pcVar1 )();
      }
...
/* WARNING: Removing unreachable block (ram,0x00106d38) *//* String vformat<StringName>(String const&, StringName const) */undefined8 *vformat<StringName>(undefined8 *param_1, bool *param_2, StringName *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* MethodBindTRC<XRHandModifier3D::BoneUpdate>::call(Object*, Variant const**, int,
   Callable::CallError&) const */Object *MethodBindTRC<XRHandModifier3D::BoneUpdate>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   int iVar2;
   long *plVar4;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   LAB_001070b0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTRC<XRHandModifier3D::BoneUpdate>::validated_call(Object*, Variant const**, Variant*)
   const */void MethodBindTRC<XRHandModifier3D::BoneUpdate>::validated_call(MethodBindTRC<XRHandModifier3D::BoneUpdate> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   uint uVar1;
   long *plVar3;
   long in_FS_OFFSET;
   long local_58;
   ...
   *(ulong*)( param_3 + 8 ) = (ulong)uVar1;
   LAB_00107354:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<XRHandModifier3D::BoneUpdate>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<XRHandModifier3D::BoneUpdate>::ptrcall(MethodBindTRC<XRHandModifier3D::BoneUpdate> *this, Object *param_1, void **param_2, void *param_3) {
   uint uVar1;
   long *plVar3;
   long in_FS_OFFSET;
   long local_58;
   ...
   *(ulong*)param_3 = (ulong)uVar1;
   LAB_00107513:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<XRHandModifier3D::BoneUpdate>::validated_call(Object*, Variant const**, Variant*)
   const */void MethodBindT<XRHandModifier3D::BoneUpdate>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   LAB_00107851:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<XRHandModifier3D::BoneUpdate>::ptrcall(Object*, void const**, void*) const */void MethodBindT<XRHandModifier3D::BoneUpdate>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   code *UNRECOVERED_JUMPTABLE;
   long *plVar1;
   long in_FS_OFFSET;
   long local_58;
   ...
   LAB_00107a31:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindTRC<StringName>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindTRC<StringName>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   LAB_00107b20:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTRC<StringName>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTRC<StringName>::validated_call(MethodBindTRC<StringName> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   LAB_00107d5a:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<StringName>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<StringName>::ptrcall(MethodBindTRC<StringName> *this, Object *param_1, void **param_2, void *param_3) {
   ...
   LAB_00107f3b:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<StringName const&>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<StringName_const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   LAB_00108281:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<StringName const&>::ptrcall(Object*, void const**, void*) const */void MethodBindT<StringName_const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   LAB_00108461:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<StringName const&>::call(Object*, Variant const**, int, Callable::CallError&) const
   ...
   if (in_R8D < 2) {
      ...
      if (pVVar10 == (Variant*)0x0) {
         ...
         LAB_00108650:pVVar10 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar10 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_00108660:uVar6 = 4;
            goto LAB_00108605;
         }
      ...
      *in_R9 = 0;
      ...
      uVar6 = 3;
      LAB_00108605:*in_R9 = uVar6;
      in_R9[2] = 1;
   }

   LAB_00108610:*(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* void call_with_variant_args_dv<__UnexistingClass,
   ...
   Vector<Variant> const&) */void call_with_variant_args_dv<__UnexistingClass,XRHandModifier3D::BoneUpdate>(__UnexistingClass *param_1, _func_void_BoneUpdate *param_2, Variant **param_3, int param_4, CallError *param_5, Vector *param_6) {
   long lVar1;
   long lVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   if (lVar1 == 0) {
      ...
      if ((int)lVar2 < (int)( uVar8 ^ 1 )) {
         LAB_001089a0:uVar6 = 4;
         LAB_0010893d:*(undefined4*)param_6 = uVar6;
   ...
   LAB_001088bb:*(undefined4*)param_6 = 0;
...
/* MethodBindT<XRHandModifier3D::BoneUpdate>::call(Object*, Variant const**, int,
   Callable::CallError&) const */Object *MethodBindT<XRHandModifier3D::BoneUpdate>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   long *plVar1;
   undefined4 in_register_00000014;
   ...
   call_with_variant_args_dv<__UnexistingClass,XRHandModifier3D::BoneUpdate>(p_Var2, (_func_void_BoneUpdate*)param_2[0xb], (Variant**)param_2[0xc], (int)param_4, in_R8, in_R9);
   *(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   LAB_00108a06:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* WARNING: Control flow encountered bad instruction data *//* XRHandModifier3D::~XRHandModifier3D() */void XRHandModifier3D::~XRHandModifier3D(XRHandModifier3D *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* MethodBindTRC<XRHandModifier3D::BoneUpdate>::~MethodBindTRC() */void MethodBindTRC<XRHandModifier3D::BoneUpdate>::~MethodBindTRC(MethodBindTRC<XRHandModifier3D::BoneUpdate> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* MethodBindT<XRHandModifier3D::BoneUpdate>::~MethodBindT() */void MethodBindT<XRHandModifier3D::BoneUpdate>::~MethodBindT(MethodBindT<XRHandModifier3D::BoneUpdate> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<XRHandModifier3D, void, StringName,
   XRServer::TrackerType>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<XRHandModifier3D,void,StringName,XRServer::TrackerType>::~CallableCustomMethodPointer(CallableCustomMethodPointer<XRHandModifier3D,void,StringName,XRServer::TrackerType> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

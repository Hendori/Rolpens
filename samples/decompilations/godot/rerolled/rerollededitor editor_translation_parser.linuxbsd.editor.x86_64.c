...
/* EditorTranslationParserPlugin::_initialize_classv() */void EditorTranslationParserPlugin::_initialize_classv(void) {
   ...
   initialize_class()::initialized =
   '\x01';
   LAB_00108bb9:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CowData<Ref<EditorTranslationParserPlugin> >::_realloc(long) */undefined8 CowData<Ref<EditorTranslationParserPlugin>>::_realloc(CowData<Ref<EditorTranslationParserPlugin>> *this, long param_1) {
   undefined8 *puVar1;
   puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
   if (puVar1 != (undefined8*)0x0) {
      *puVar1 = 1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Ref<EditorTranslationParserPlugin> >::resize<false>(long) */undefined8 CowData<Ref<EditorTranslationParserPlugin>>::resize<false>(CowData<Ref<EditorTranslationParserPlugin>> *this, long param_1) {
   long *plVar1;
   Object *pOVar2;
   code *pcVar3;
   char cVar4;
...
/* Vector<Ref<EditorTranslationParserPlugin> >::remove_at(long) */void Vector<Ref<EditorTranslationParserPlugin>>::remove_at(Vector<Ref<EditorTranslationParserPlugin>> *this, long param_1) {
   Object *pOVar1;
   Object *pOVar2;
   char cVar3;
   long lVar4;
...
/* WARNING: Control flow encountered bad instruction data *//* EditorTranslationParserPlugin::~EditorTranslationParserPlugin() */void EditorTranslationParserPlugin::~EditorTranslationParserPlugin(EditorTranslationParserPlugin *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

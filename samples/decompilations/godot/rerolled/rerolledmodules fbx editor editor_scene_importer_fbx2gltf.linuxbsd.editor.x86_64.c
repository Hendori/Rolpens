/* EditorSceneFormatImporterFBX2GLTF::get_import_options(String const&,
   List<ResourceImporter::ImportOption, DefaultAllocator>*) */void EditorSceneFormatImporterFBX2GLTF::get_import_options(String *param_1, List *param_2) {
   return;
}
...
/* EditorSceneFormatImporterFBX2GLTF::get_extensions(List<String, DefaultAllocator>*) const */void EditorSceneFormatImporterFBX2GLTF::get_extensions(EditorSceneFormatImporterFBX2GLTF *this, List *param_1) {
   long *plVar1;
   long lVar2;
   CowData<char32_t> *this_00;
   undefined1(*pauVar3)[16];
...
/* EditorSceneFormatImporterFBX2GLTF::handle_compatibility_options(HashMap<StringName, Variant,
   HashMapHasherDefault, HashMapComparatorDefault<StringName>,
   DefaultTypedAllocator<HashMapElement<StringName, Variant> > >&) const */void EditorSceneFormatImporterFBX2GLTF::handle_compatibility_options(EditorSceneFormatImporterFBX2GLTF *this, HashMap *param_1) {
   char cVar1;
   Variant *pVVar2;
   long in_FS_OFFSET;
   uint local_54;
...
/* EditorSceneFormatImporterFBX2GLTF::get_option_visibility(String const&, String const&, String
   const&, HashMap<StringName, Variant, HashMapHasherDefault, HashMapComparatorDefault<StringName>,
   DefaultTypedAllocator<HashMapElement<StringName, Variant> > > const&) */String *EditorSceneFormatImporterFBX2GLTF::get_option_visibility(String *param_1, String *param_2, String *param_3, HashMap *param_4) {
   code *pcVar1;
   char cVar2;
   int iVar3;
   String *in_R8;
   ...
   long local_30;
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   cVar2 = String::begins_with((char*)in_R8);
   if (cVar2 != '\0') {
      cVar2 = String::operator !=(in_R8, "fbx/importer");
      if (cVar2 != '\0') {
         StringName::StringName((StringName*)&local_40, "fbx/importer", false);
         local_38 = 0;
         cVar2 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::_lookup_pos(in_R9, (StringName*)&local_40, (uint*)&local_38);
         if (cVar2 == '\0') {
            LAB_00100537:if (StringName::configured != '\0') {
               LAB_00100544:if (local_40 != 0) {
                  StringName::unref();
               }
            ...
            StringName::StringName((StringName*)&local_38, "fbx/importer", false);
            local_44 = 0;
            cVar2 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::_lookup_pos(in_R9, (StringName*)&local_38, &local_44);
            if (cVar2 == '\0') {
            ...
            iVar3 = Variant::operator_cast_to_int((Variant*)( *(long*)( *(long*)( in_R9 + 8 ) + (ulong)local_44 * 8 ) + 0x18 ));
            if (iVar3 == 1) {
               if (StringName::configured != '\0') {
                  if (CONCAT44(uStack_34, local_38) != 0) {
                     StringName::unref();
                     if (StringName::configured == '\0') goto LAB_001005f2;
                  }
               ...
               LAB_001005f2:Variant::Variant((Variant*)param_1, false);
               goto LAB_001004c9;
            }
   ...
   LAB_001004c9:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* EditorSceneFormatImporterFBX2GLTF::import_scene(String const&, unsigned int, HashMap<StringName,
   ...
   DefaultAllocator>*, Error*) */undefined8 EditorSceneFormatImporterFBX2GLTF::import_scene(EditorSceneFormatImporterFBX2GLTF *this, String *param_1, uint param_2, HashMap *param_3, List *param_4, Error *param_5) {
   code *pcVar1;
   Object *pOVar2;
   char cVar3;
   bool bVar4;
   ...
   if (cVar3 == '\0') {
      joined_r0x0010103b:if (StringName::configured != '\0') {
         LAB_001006e4:if (local_68 != (Object*)0x0) {
            StringName::unref();
         }
      ...
      StringName::StringName((StringName*)&local_60, "fbx/importer", false);
      local_70 = local_70 & 0xffffffff00000000;
      cVar3 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_3, (StringName*)&local_60, (uint*)&local_70);
      if (cVar3 == '\0') {
         _err_print_error("operator[]", "./core/templates/hash_map.h", 0x245, "FATAL: Condition \"!exists\" is true.", 0, 0);
         _err_flush_stdout();
         /* WARNING: Does not return */
      ...
      iVar5 = Variant::operator_cast_to_int((Variant*)( *(long*)( *(long*)( param_3 + 8 ) + ( local_70 & 0xffffffff ) * 8 ) + 0x18 ));
      if (iVar5 == 0) {
         if (( StringName::configured != '\0' ) && ( ( ( local_60 == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) && ( local_68 != (Object*)0x0 ) ) )) {
            StringName::unref();
         }
         ...
         *(undefined**)this_00 = &__dso_handle;
         StringName::StringName((StringName*)( this_00 + 0x188 ), "_get_extensions", false);
         this_00[400] = (RefCounted)0x0;
         *(undefined8*)( this_00 + 0x198 ) = 0;
         StringName::StringName((StringName*)( this_00 + 0x1a0 ), "_import_scene", false);
         this_00[0x1a8] = (RefCounted)0x0;
         *(undefined8*)( this_00 + 0x1b0 ) = 0;
         StringName::StringName((StringName*)( this_00 + 0x1b8 ), "_get_import_options", false);
         this_00[0x1c0] = (RefCounted)0x0;
         *(undefined8*)( this_00 + 0x1c8 ) = 0;
         StringName::StringName((StringName*)( this_00 + 0x1d0 ), "_get_option_visibility", false);
         ...
         *(code**)this_00 = stringify_variants;
         ...
         uVar8 = ( **(code**)( *(long*)pOVar10 + 0x158 ) )(pOVar10, param_1, param_2, param_3, param_4, param_5);
   ...
   ProjectSettings::globalize_path((String*)&local_60);
   ...
   String::get_basename();
   local_68 = (Object*)0x0;
   String::parse_latin1((String*)&local_68, "%s-%s.glb");
   vformat<String,String>((String*)&local_60, (StringName*)&local_68, (CowData<char32_t>*)&local_78, (CowData<char32_t>*)&local_70);
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   local_60 = 0;
   String::parse_latin1((String*)&local_60, "filesystem/import/fbx/fbx2gltf_path");
   ...
   local_90 = 0;
   local_60 = 0;
   String::parse_latin1((String*)&local_60, "--pbr-metallic-roughness");
   List<String,DefaultAllocator>::push_back((List<String,DefaultAllocator>*)&local_90, (String*)&local_60);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   local_60 = 0;
   String::parse_latin1((String*)&local_60, "--input");
   List<String,DefaultAllocator>::push_back((List<String,DefaultAllocator>*)&local_90, (String*)&local_60);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   List<String,DefaultAllocator>::push_back((List<String,DefaultAllocator>*)&local_90, local_b0);
   local_60 = 0;
   String::parse_latin1((String*)&local_60, "--output");
   List<String,DefaultAllocator>::push_back((List<String,DefaultAllocator>*)&local_90, (String*)&local_60);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   List<String,DefaultAllocator>::push_back((List<String,DefaultAllocator>*)&local_90, local_a0);
   local_60 = 0;
   String::parse_latin1((String*)&local_60, "--binary");
   List<String,DefaultAllocator>::push_back((List<String,DefaultAllocator>*)&local_90, (String*)&local_60);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   local_88 = 0;
   plVar6 = (long*)OS::get_singleton();
   ( **(code**)( *plVar6 + 0x108 ) )(plVar6, local_98, (List<String,DefaultAllocator>*)&local_90, (CowData<char32_t>*)&local_88, &local_b4, 1, 0, 0);
   ...
   local_c4 = local_b4;
   if (local_b4 == 0) {
      this_01 = (Resource*)operator_new(0x278, "");
      pRVar11 = this_01;
      ...
      *(undefined8*)( this_01 + 0x248 ) = 0;
      *(code**)this_01 = __print_line;
      *(undefined8*)( this_01 + 0x240 ) = _LC47;
      String::parse_latin1((String*)( this_01 + 0x248 ), "PNG");
      *(undefined4*)( this_01 + 0x250 ) = 0x3f400000;
      *(undefined8*)( this_01 + 600 ) = 0;
      *(undefined4*)( this_01 + 0x260 ) = 0;
      *(undefined8*)( this_01 + 0x270 ) = 0;
      postinitialize_handler((Object*)this_01);
      cVar3 = RefCounted::init_ref();
      local_d8 = (Object*)0x0;
      if (cVar3 != '\0') {
         cVar3 = RefCounted::reference();
         local_d8 = (Object*)(Resource*)0x0;
         if (cVar3 != '\0') {
            local_d8 = (Object*)this_01;
         }
      ...
      local_80 = (Object*)0x0;
      Ref<GLTFState>::instantiate<>((Ref<GLTFState>*)&local_80);
      if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
         ::{lambda()
      #1
      (iVar5 = __cxa_guard_acquire(&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                                     ::{lambda()
      #1
   ...
   cVar3 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
   ...
   #1
   if (cVar3 == '\0') {
      LAB_00100e16:pOVar10 = local_80;
      cVar3 = is_print_verbose_enabled();
      if (cVar3 != '\0') {
         LAB_00100e23:local_70 = 0;
         if (local_a8 != 0) {
            CowData<char32_t>::_ref((CowData<char32_t>*)&local_70, (CowData*)&local_a8);
         }

         local_78 = 0;
         String::parse_latin1((String*)&local_78, "glTF path: %s");
         vformat<String>((StringName*)&local_68, (CowData<char32_t>*)&local_78, (CowData<char32_t>*)&local_70);
      ...
      local_110 = *(code**)( *(long*)local_d8 + 0x1c8 );
      String::get_base_dir();
      local_68 = (Object*)0x0;
      if (pOVar10 != (Object*)0x0) goto LAB_00100efe;
   }
 else {
      if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
           ::{lambda()
   ...
   bVar4 = Variant::operator_cast_to_bool(pVVar7);
   pOVar10 = local_80;
   if (!bVar4) goto LAB_00100e16;
   GLTFState::set_import_as_skeleton_bones(SUB81(local_80, 0));
   cVar3 = is_print_verbose_enabled();
   if (cVar3 != '\0') goto LAB_00100e23;
   local_110 = *(code**)( *(long*)local_d8 + 0x1c8 );
   String::get_base_dir();
   LAB_00100efe:local_60 = 0;
   local_68 = pOVar10;
   cVar3 = RefCounted::reference();
   if (cVar3 == '\0') {
      local_68 = (Object*)0x0;
   ...
   Ref<GLTFState>::unref((Ref<GLTFState>*)&local_60);
}
local_60 = 0;if (local_a8 != 0) {
   CowData<char32_t>::_ref((CowData<char32_t>*)&local_60, (CowData*)&local_a8);
}
iVar5 = ( *local_110 )(local_d8, (String*)&local_60, (StringName*)&local_68, param_2, (CowData<char32_t>*)&local_70);CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);if (( ( local_68 != (Object*)0x0 ) && ( cVar3 = RefCounted::unreference() ),pOVar2 = local_68,cVar3 != '\0' )) &&( cVar3 = cVar3 != '\0' )(**(code**)( *(long*)pOVar2 + 0x140 ))();Memory::free_static(pOVar2, false);}CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);if (iVar5 == 0) {
   StringName::StringName((StringName*)&local_68, "animation/trimming", false);
   local_60 = local_60 & 0xffffffff00000000;
   cVar3 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_3, (StringName*)&local_68, (uint*)&local_60);
   if (cVar3 == '\0') {
      LAB_00101225:if (StringName::configured != '\0') {
         LAB_00101229:if (local_68 != (Object*)0x0) {
            StringName::unref();
         }
      ...
      StringName::StringName((StringName*)&local_60, "animation/trimming", false);
   ...
   pcVar1 = *(code**)( *(long*)local_d8 + 0x1e0 );
   StringName::StringName((StringName*)&local_70, "animation/fps", false);
   pVVar7 = (Variant*)HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::operator []((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_3, (StringName*)&local_70);
   fVar13 = Variant::operator_cast_to_float(pVVar7);
   local_68 = (Object*)0x0;
   ...
   uVar8 = ( *pcVar1 )(fVar13, local_d8, (StringName*)&local_68, local_c4, 0);
...
if (( ( pOVar10 != (Object*)0x0 ) && ( cVar3 = RefCounted::unreference() ),cVar3 != '\0' )) &&( cVar3 = cVar3 != '\0' )(**(code**)( *(long*)pOVar10 + 0x140 ))(pOVar10);Memory::free_static(pOVar10, false);}cVar3 = RefCounted::unreference();if (( cVar3 != '\0' ) && ( cVar3 = cVar3 != '\0' )) {
   ...
   local_68 = (Object*)0x0;
   String::parse_latin1((String*)&local_68, "FBX conversion to glTF failed with error: %d.");
   vformat<int>((String*)&local_60, (int)(StringName*)&local_68);
   _err_print_error("import_scene", "modules/fbx/editor/editor_scene_importer_fbx2gltf.cpp", 0x5c, (String*)&local_60, 0, 0);
   uVar8 = 0;
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
}
CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);List<String,DefaultAllocator>::~List((List<String,DefaultAllocator>*)&local_90);CowData<char32_t>::_unref((CowData<char32_t>*)local_98);CowData<char32_t>::_unref((CowData<char32_t>*)local_a0);CowData<char32_t>::_unref((CowData<char32_t>*)&local_a8);CowData<char32_t>::_unref((CowData<char32_t>*)local_b0);LAB_00100a87:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return uVar8;}/* DefaultAllocator::alloc(unsigned long) */void DefaultAllocator::alloc(ulong param_1) {
...
/* RefCounted::is_class_ptr(void*) const */uint RefCounted::is_class_ptr(RefCounted *this, void *param_1) {
   return (uint)CONCAT71(0x1074, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1074, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
}
...
/* EditorSceneFormatImporterFBX2GLTF::is_class_ptr(void*) const */uint EditorSceneFormatImporterFBX2GLTF::is_class_ptr(EditorSceneFormatImporterFBX2GLTF *this, void *param_1) {
   return (uint)CONCAT71(0x1074, (undefined4*)param_1 == &EditorSceneFormatImporter::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1074, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1074, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1074, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* EditorSceneFormatImporterFBX2GLTF::_getv(StringName const&, Variant&) const */undefined8 EditorSceneFormatImporterFBX2GLTF::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorSceneFormatImporterFBX2GLTF::_setv(StringName const&, Variant const&) */undefined8 EditorSceneFormatImporterFBX2GLTF::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorSceneFormatImporterFBX2GLTF::_validate_propertyv(PropertyInfo&) const */void EditorSceneFormatImporterFBX2GLTF::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* EditorSceneFormatImporterFBX2GLTF::_property_can_revertv(StringName const&) const */undefined8 EditorSceneFormatImporterFBX2GLTF::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* EditorSceneFormatImporterFBX2GLTF::_property_get_revertv(StringName const&, Variant&) const */undefined8 EditorSceneFormatImporterFBX2GLTF::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorSceneFormatImporterFBX2GLTF::_notificationv(int, bool) */void EditorSceneFormatImporterFBX2GLTF::_notificationv(int param_1, bool param_2) {
   return;
}
/* GLTFState::is_class_ptr(void*) const */uint GLTFState::is_class_ptr(GLTFState *this, void *param_1) {
   return (uint)CONCAT71(0x1074, (undefined4*)param_1 == &Resource::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1073, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1074, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1074, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
...
/* RefCounted::~RefCounted() */void RefCounted::~RefCounted(RefCounted *this) {
   *(undefined***)this = &PTR__initialize_classv_00106ef8;
...
/* EditorSceneFormatImporterFBX2GLTF::~EditorSceneFormatImporterFBX2GLTF() */void EditorSceneFormatImporterFBX2GLTF::~EditorSceneFormatImporterFBX2GLTF(EditorSceneFormatImporterFBX2GLTF *this) {
   bool bVar1;
   ...
   *(undefined**)this = &__dso_handle;
   if (bVar1) {
      if (*(long*)( this + 0x1d0 ) != 0) {
         StringName::unref();
         if (StringName::configured == '\0') goto LAB_0010193e;
      }
   ...
   LAB_0010193e:*(undefined***)this = &PTR__initialize_classv_00106ef8;
   Object::~Object((Object*)this);
   return;
}
/* EditorSceneFormatImporterFBX2GLTF::_get_class_namev() const */undefined8 *EditorSceneFormatImporterFBX2GLTF::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001019b3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001019b3;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorSceneFormatImporterFBX2GLTF");
         goto LAB_00101a1e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorSceneFormatImporterFBX2GLTF");
   LAB_00101a1e:return &_get_class_namev();
}
...
/* GLTFState::_get_class_namev() const */undefined8 *GLTFState::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00101b73:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00101b73;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "GLTFState");
   LAB_00101bde:return &_get_class_namev();
}
/* EditorSceneFormatImporterFBX2GLTF::~EditorSceneFormatImporterFBX2GLTF() */void EditorSceneFormatImporterFBX2GLTF::~EditorSceneFormatImporterFBX2GLTF(EditorSceneFormatImporterFBX2GLTF *this) {
   bool bVar1;
   bVar1 = StringName::configured != '\0';
   *(undefined**)this = &__dso_handle;
   if (bVar1) {
      if (*(long*)( this + 0x1d0 ) != 0) {
         StringName::unref();
         if (StringName::configured == '\0') goto LAB_00101cae;
      }
   ...
   LAB_00101cae:*(undefined***)this = &PTR__initialize_classv_00106ef8;
   Object::~Object((Object*)this);
...
/* void Ref<GLTFState>::instantiate<>() */void Ref<GLTFState>::instantiate<>(Ref<GLTFState> *this) {
   ...
   *(undefined***)this_00 = &PTR__initialize_classv_00107058;
   ...
   *(undefined1(*) [16])( this_00 + 0x538 ) = (undefined1[16])0x0;
   ...
   if (cVar2 == '\0') {
      ...
      *(undefined8*)this = 0;
      ...
      pOVar6 = *(Object**)this;
      pOVar4 = pOVar6;
      if (this_00 == (Resource*)pOVar6) goto LAB_00102205;
      *(Resource**)this = this_00;
      ...
      if (( ( pOVar6 == (Object*)0x0 ) || ( cVar2 = RefCounted::unreference() ),cVar2 == '\0' )) goto LAB_00102205;
   }
   ...
   LAB_00102205:cVar2 = RefCounted::unreference();
...
/* EditorSceneFormatImporterFBX2GLTF::_initialize_classv() */void EditorSceneFormatImporterFBX2GLTF::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_70;
   undefined8 local_68;
   long local_60;
   ...
   if (initialize_class() == '\0') {
      ...
      String::parse_latin1((StrRange*)&local_68);
      StringName::StringName((StringName*)&local_60, (String*)&local_68, false);
      local_58 = "EditorSceneFormatImporterFBX2GLTF";
      local_70 = 0;
      local_50 = 0x21;
      String::parse_latin1((StrRange*)&local_70);
      StringName::StringName((StringName*)&local_58, (String*)&local_70, false);
...
/* WARNING: Removing unreachable block (ram,0x001027f0) *//* String vformat<String, String>(String const&, String const, String const) */undefined8 *vformat<String,String>(undefined8 *param_1, bool *param_2, String *param_3, String *param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   long in_FS_OFFSET;
...
/* WARNING: Removing unreachable block (ram,0x00102a68) *//* String vformat<int>(String const&, int const) */String *vformat<int>(String *param_1, int param_2) {
   char cVar1;
   Variant *this;
   int in_EDX;
...
/* WARNING: Removing unreachable block (ram,0x00102d18) *//* String vformat<String>(String const&, String const) */undefined8 *vformat<String>(undefined8 *param_1, bool *param_2, String *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* EditorSceneFormatImporterFBX2GLTF::get_class() const */void EditorSceneFormatImporterFBX2GLTF::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* RefCounted::is_class(String const&) const */undefined8 RefCounted::is_class(RefCounted *this, String *param_1) {
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0010348b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* Resource::is_class(String const&) const */undefined8 Resource::is_class(Resource *this, String *param_1) {
   ...
   if (cVar4 == '\0') {
      ...
      LAB_0010368b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* GLTFState::is_class(String const&) const */undefined8 GLTFState::is_class(GLTFState *this, String *param_1) {
   ...
   if (cVar4 == '\0') {
      ...
      LAB_001037db:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* EditorSceneFormatImporterFBX2GLTF::is_class(String const&) const */undefined8 EditorSceneFormatImporterFBX2GLTF::is_class(EditorSceneFormatImporterFBX2GLTF *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
   ...
   for (lVar2 = *(long*)( this + 8 ); lVar2 != 0; lVar2 = *(long*)( lVar2 + 8 )) {
      ...
      if (cVar5 != '\0') goto LAB_0010392b;
   }

   cVar5 = String::operator ==(param_1, "EditorSceneFormatImporterFBX2GLTF");
   if (cVar5 == '\0') {
      for (lVar2 = *(long*)( this + 8 ); lVar2 != 0; lVar2 = *(long*)( lVar2 + 8 )) {
         lVar4 = *(long*)( lVar2 + 0x20 );
         if (lVar4 == 0) {
   ...
   LAB_0010392b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_00103a2e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* RefCounted::_initialize_classv() */void RefCounted::_initialize_classv(void) {
   ...
   if (initialize_class() == '\0') {
      ...
      if ((code*)PTR__bind_methods_0010a010 != Object::_bind_methods) {
         RefCounted::_bind_methods();
      }
...
/* PropertyListHelper::~PropertyListHelper() */void PropertyListHelper::~PropertyListHelper(PropertyListHelper *this) {
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
            *(undefined4*)( this + 0x3c ) = 0;
            *(undefined1(*) [16])( this + 0x28 ) = (undefined1[16])0x0;
            if (pvVar3 == (void*)0x0) goto LAB_00103fdf;
         }
   ...
   LAB_00103fdf:CowData<char32_t>::_unref((CowData<char32_t>*)this);
   return;
}
/* RefCounted::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void RefCounted::_get_property_listv(List *param_1, bool param_2) {
   ...
   LAB_0010419c:List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)CONCAT71(in_register_00000031, param_2), (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
...
/* EditorSceneFormatImporter::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00104401:local_b0 = (CowData<char32_t>*)&local_58;
...
/* EditorSceneFormatImporterFBX2GLTF::_get_property_listv(List<PropertyInfo, DefaultAllocator>*,
   bool) const */void EditorSceneFormatImporterFBX2GLTF::_get_property_listv(EditorSceneFormatImporterFBX2GLTF *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_88 = 0;
   local_90 = 0;
   local_78 = "EditorSceneFormatImporterFBX2GLTF";
   local_70 = 0x21;
   String::parse_latin1((StrRange*)&local_90);
   local_78 = "EditorSceneFormatImporterFBX2GLTF";
   local_98 = 0;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_001046b1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
   ...
   StringName::StringName((StringName*)&local_78, "EditorSceneFormatImporterFBX2GLTF", false);
   ClassDB::get_property_list((StringName*)&local_78, param_1, true, (Object*)this);
   if (( StringName::configured != '\0' ) && ( local_78 != (char*)0x0 )) {
      StringName::unref();
   }
...
/* Resource::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Resource::_get_property_listv(Resource *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00104961:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* GLTFState::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void GLTFState::_get_property_listv(GLTFState *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00104c11:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
LAB_0010542b:if (Variant::needs_deinit[local_98[0]] != '\0') {
   Variant::_clear_internal();
}
LAB_00105440:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return local_e0;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* EditorSceneFormatImporterFBX2GLTF::import_scene(String const&, unsigned int, HashMap<StringName,
   Variant, HashMapHasherDefault, HashMapComparatorDefault<StringName>,
   DefaultTypedAllocator<HashMapElement<StringName, Variant> > > const&, List<String,
   DefaultAllocator>*, Error*) [clone .cold] */void EditorSceneFormatImporterFBX2GLTF::import_scene(String *param_1, uint param_2, HashMap *param_3, List *param_4, Error *param_5) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* GLTFState::~GLTFState() */void GLTFState::~GLTFState(GLTFState *this) {
   ...
   long lVar15;
   long lVar16;
   *(undefined***)this = &PTR__initialize_classv_00107058;
 ...
 while ( lVar10 != (ulong)uVar4 * 4 );
                           *(undefined4*)( (long)pvVar14 + 0x44 ) = 0;
                           *(undefined1(*) [16])( (long)pvVar14 + 0x30 ) = (undefined1[16])0x0;
                           if (pvVar13 == (void*)0x0) goto LAB_00105e21;
                        }
                  ...
                  LAB_00105e21:Memory::free_static(pvVar14, false);
                  pvVar14 = *(void**)( this + 0x528 );
 ...
 while ( lVar16 != (ulong)uVar3 << 2 );
            *(undefined4*)( this + 0x54c ) = 0;
            *(undefined1(*) [16])( this + 0x538 ) = (undefined1[16])0x0;
            if (pvVar14 == (void*)0x0) goto LAB_00105e6a;
         }
   ...
   LAB_00105e6a:pvVar14 = *(void**)( this + 0x4f8 );
   if (pvVar14 != (void*)0x0) {
      if (*(int*)( this + 0x51c ) != 0) {
 ...
 while ( (ulong)uVar3 << 2 != lVar16 );
            *(undefined4*)( this + 0x51c ) = 0;
            *(undefined1(*) [16])( this + 0x508 ) = (undefined1[16])0x0;
            if (pvVar14 == (void*)0x0) goto LAB_00105f07;
         }
   ...
   LAB_00105f07:pvVar14 = *(void**)( this + 0x4c8 );
   if (pvVar14 != (void*)0x0) {
      if (*(int*)( this + 0x4ec ) != 0) {
 ...
 while ( lVar16 != (ulong)uVar3 << 2 );
            *(undefined4*)( this + 0x4ec ) = 0;
            *(undefined1(*) [16])( this + 0x4d8 ) = (undefined1[16])0x0;
            if (pvVar14 == (void*)0x0) goto LAB_00105fca;
         }
   ...
   LAB_00105fca:pvVar14 = *(void**)( this + 0x498 );
   if (pvVar14 != (void*)0x0) {
      if (*(int*)( this + 0x4bc ) != 0) {
 ...
 while ( lVar16 != (ulong)uVar3 << 2 );
            *(undefined4*)( this + 0x4bc ) = 0;
            *(undefined1(*) [16])( this + 0x4a8 ) = (undefined1[16])0x0;
            if (pvVar14 == (void*)0x0) goto LAB_00106069;
         }
   ...
   LAB_00106069:pvVar14 = *(void**)( this + 0x468 );
   if (pvVar14 != (void*)0x0) {
      if (*(int*)( this + 0x48c ) != 0) {
 ...
 while ( (ulong)uVar3 << 2 != lVar16 );
            *(undefined4*)( this + 0x48c ) = 0;
            *(undefined1(*) [16])( this + 0x478 ) = (undefined1[16])0x0;
            if (pvVar14 == (void*)0x0) goto LAB_00106109;
         }
   ...
   LAB_00106109:if (*(long*)( this + 0x458 ) != 0) {
      LOCK();
      ...
      *plVar1 = *plVar1 + -1;
      ...
      if (*plVar1 == 0) {
         ...
         if (plVar1 == (long*)0x0) goto LAB_00106d54;
         lVar16 = plVar1[-1];
         lVar10 = 0;
         ...
         if (lVar16 != 0) {
            do {
               while (( *plVar12 == 0 || ( cVar8 = RefCounted::unreference() ),cVar8 == '\0' )) {
                  LAB_00106158:lVar10 = lVar10 + 1;
                  plVar12 = plVar12 + 1;
                  if (lVar16 == lVar10) goto LAB_001061b0;
               }
;
               pOVar6 = (Object*)*plVar12;
               cVar8 = predelete_handler(pOVar6);
               if (cVar8 == '\0') goto LAB_00106158;
               lVar10 = lVar10 + 1;
               plVar12 = plVar12 + 1;
               ( **(code**)( *(long*)pOVar6 + 0x140 ) )(pOVar6);
               Memory::free_static(pOVar6, false);
 ...
 while ( lVar16 != lVar10 );
         ...
         LAB_001061b0:Memory::free_static(plVar1 + -2, false);
      }
 ...
 while ( (uint)lVar16 < *(uint*)( this + 0x43c ) );
         *(undefined4*)( this + 0x43c ) = 0;
         if (pvVar14 == (void*)0x0) goto LAB_0010624f;
      }
   ...
   LAB_0010624f:pvVar14 = *(void**)( this + 0x3f0 );
   if (pvVar14 != (void*)0x0) {
 ...
 while ( (uint)lVar16 < *(uint*)( this + 0x414 ) );
         *(undefined4*)( this + 0x414 ) = 0;
         if (pvVar14 == (void*)0x0) goto LAB_001062d7;
      }
   ...
   LAB_001062d7:if (*(long*)( this + 1000 ) != 0) {
      LOCK();
      ...
      if (*plVar1 == 0) {
         ...
         *(undefined8*)( this + 1000 ) = 0;
         ...
         if (lVar16 != 0) {
            do {
               while (( *plVar12 == 0 || ( cVar8 = RefCounted::unreference() ),cVar8 == '\0' )) {
                  LAB_00106320:lVar10 = lVar10 + 1;
                  plVar12 = plVar12 + 1;
                  if (lVar16 == lVar10) goto LAB_00106378;
               }
;
               pOVar6 = (Object*)*plVar12;
               cVar8 = predelete_handler(pOVar6);
               if (cVar8 == '\0') goto LAB_00106320;
               lVar10 = lVar10 + 1;
               plVar12 = plVar12 + 1;
               ( **(code**)( *(long*)pOVar6 + 0x140 ) )(pOVar6);
               Memory::free_static(pOVar6, false);
 ...
 while ( lVar16 != lVar10 );
         ...
         LAB_00106378:Memory::free_static(plVar1 + -2, false);
      }
      ...
      if (*plVar1 == 0) {
         ...
         *(undefined8*)( this + 0x3b8 ) = 0;
         ...
         if (lVar16 != 0) {
            do {
               while (( *plVar12 == 0 || ( cVar8 = RefCounted::unreference() ),cVar8 == '\0' )) {
                  LAB_001063f0:lVar10 = lVar10 + 1;
                  plVar12 = plVar12 + 1;
                  if (lVar16 == lVar10) goto LAB_00106480;
               }
;
               pOVar6 = (Object*)*plVar12;
               cVar8 = predelete_handler(pOVar6);
               if (cVar8 == '\0') goto LAB_001063f0;
 ...
 while ( lVar16 != lVar10 );
         ...
         LAB_00106480:Memory::free_static(plVar1 + -2, false);
      }
      ...
      if (*plVar1 == 0) {
         ...
         *(undefined8*)( this + 0x370 ) = 0;
         ...
         if (lVar16 != 0) {
            do {
               while (( *plVar12 == 0 || ( cVar8 = RefCounted::unreference() ),cVar8 == '\0' )) {
                  LAB_00106510:lVar10 = lVar10 + 1;
                  plVar12 = plVar12 + 1;
                  if (lVar16 == lVar10) goto LAB_00106568;
               }
;
               pOVar6 = (Object*)*plVar12;
               cVar8 = predelete_handler(pOVar6);
               if (cVar8 == '\0') goto LAB_00106510;
               lVar10 = lVar10 + 1;
               plVar12 = plVar12 + 1;
               ( **(code**)( *(long*)pOVar6 + 0x140 ) )(pOVar6);
               Memory::free_static(pOVar6, false);
 ...
 while ( lVar16 != lVar10 );
         ...
         LAB_00106568:Memory::free_static(plVar1 + -2, false);
      }
      ...
      if (*plVar1 == 0) {
         ...
         *(undefined8*)( this + 0x338 ) = 0;
         ...
         if (lVar16 != 0) {
            do {
               while (( *plVar12 == 0 || ( cVar8 = RefCounted::unreference() ),cVar8 == '\0' )) {
                  LAB_001065f0:lVar10 = lVar10 + 1;
                  plVar12 = plVar12 + 1;
                  if (lVar16 == lVar10) goto LAB_00106648;
               }
;
               pOVar6 = (Object*)*plVar12;
               cVar8 = predelete_handler(pOVar6);
               if (cVar8 == '\0') goto LAB_001065f0;
               lVar10 = lVar10 + 1;
               plVar12 = plVar12 + 1;
               ( **(code**)( *(long*)pOVar6 + 0x140 ) )(pOVar6);
               Memory::free_static(pOVar6, false);
 ...
 while ( lVar16 != lVar10 );
         ...
         LAB_00106648:Memory::free_static(plVar1 + -2, false);
      }
 ...
 while ( (ulong)uVar3 << 2 != lVar16 );
            *(undefined4*)( this + 0x32c ) = 0;
            *(undefined1(*) [16])( this + 0x318 ) = (undefined1[16])0x0;
            if (pvVar14 == (void*)0x0) goto LAB_0010670d;
         }
   ...
   LAB_0010670d:if (*(long*)( this + 0x2f8 ) != 0) {
      LOCK();
      ...
      if (*plVar1 == 0) {
         ...
         *(undefined8*)( this + 0x2e8 ) = 0;
         ...
         if (lVar16 != 0) {
            do {
               while (( *plVar12 == 0 || ( cVar8 = RefCounted::unreference() ),cVar8 == '\0' )) {
                  LAB_00106770:lVar10 = lVar10 + 1;
                  plVar12 = plVar12 + 1;
                  if (lVar16 == lVar10) goto LAB_001067c8;
               }
;
               pOVar6 = (Object*)*plVar12;
               cVar8 = predelete_handler(pOVar6);
               if (cVar8 == '\0') goto LAB_00106770;
               lVar10 = lVar10 + 1;
               plVar12 = plVar12 + 1;
               ( **(code**)( *(long*)pOVar6 + 0x140 ) )(pOVar6);
               Memory::free_static(pOVar6, false);
 ...
 while ( lVar16 != lVar10 );
         ...
         LAB_001067c8:Memory::free_static(plVar1 + -2, false);
      }
      ...
      if (*plVar1 == 0) {
         ...
         *(undefined8*)( this + 0x2d8 ) = 0;
         ...
         if (lVar16 != 0) {
            do {
               while (( *plVar12 == 0 || ( cVar8 = RefCounted::unreference() ),cVar8 == '\0' )) {
                  LAB_00106820:lVar10 = lVar10 + 1;
                  plVar12 = plVar12 + 1;
                  if (lVar16 == lVar10) goto LAB_00106878;
               }
;
               pOVar6 = (Object*)*plVar12;
               cVar8 = predelete_handler(pOVar6);
               if (cVar8 == '\0') goto LAB_00106820;
               lVar10 = lVar10 + 1;
               plVar12 = plVar12 + 1;
               ( **(code**)( *(long*)pOVar6 + 0x140 ) )(pOVar6);
               Memory::free_static(pOVar6, false);
 ...
 while ( lVar16 != lVar10 );
         ...
         LAB_00106878:Memory::free_static(plVar1 + -2, false);
      }
   ...
   if (*(long*)( this + 0x2a8 ) != 0) {
      ...
      *plVar1 = *plVar1 + -1;
      ...
      if (*plVar1 == 0) {
         ...
         if (plVar1 == (long*)0x0) {
            LAB_00106d54:/* WARNING: Does not return */pcVar7 = (code*)invalidInstructionException();
            ( *pcVar7 )();
         }
         ...
         *(undefined8*)( this + 0x2a8 ) = 0;
         ...
         if (lVar16 != 0) {
            do {
               while (( *plVar12 == 0 || ( cVar8 = RefCounted::unreference() ),cVar8 == '\0' )) {
                  LAB_00106960:lVar10 = lVar10 + 1;
                  plVar12 = plVar12 + 1;
                  if (lVar16 == lVar10) goto LAB_001069b8;
               }
;
               pOVar6 = (Object*)*plVar12;
               cVar8 = predelete_handler(pOVar6);
               if (cVar8 == '\0') goto LAB_00106960;
               lVar10 = lVar10 + 1;
               plVar12 = plVar12 + 1;
               ( **(code**)( *(long*)pOVar6 + 0x140 ) )(pOVar6);
               Memory::free_static(pOVar6, false);
 ...
 while ( lVar16 != lVar10 );
         ...
         LAB_001069b8:Memory::free_static(plVar1 + -2, false);
      }
...
/* EditorSceneFormatImporterFBX2GLTF::get_extensions(List<String, DefaultAllocator>*) const */void EditorSceneFormatImporterFBX2GLTF::_GLOBAL__sub_I_get_extensions(void) {
...
/* WARNING: Control flow encountered bad instruction data *//* EditorSceneFormatImporterFBX2GLTF::~EditorSceneFormatImporterFBX2GLTF() */void EditorSceneFormatImporterFBX2GLTF::~EditorSceneFormatImporterFBX2GLTF(EditorSceneFormatImporterFBX2GLTF *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

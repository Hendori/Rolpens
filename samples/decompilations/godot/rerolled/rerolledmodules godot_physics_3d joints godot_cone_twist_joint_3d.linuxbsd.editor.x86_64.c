/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotConeTwistJoint3D::solve(float) */void GodotConeTwistJoint3D::solve(GodotConeTwistJoint3D *this, float param_1) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   if (this[0x1b8] == (GodotConeTwistJoint3D)0x0) {
      ...
      fVar22 = *(float*)( lVar12 + 0x60 ) * fVar20 + *(float*)( lVar12 + 100 ) * fVar28 + *(float*)( lVar12 + 0x68 ) * fVar27 + *(float*)( lVar12 + 0x74 );
      fVar19 = *(float*)( this + 0x164 );
      fVar31 = *(float*)( this + 0x168 );
      fVar23 = *(float*)( lVar12 + 0x54 ) * fVar20 + *(float*)( lVar12 + 0x58 ) * fVar28 + *(float*)( lVar12 + 0x5c ) * fVar27 + *(float*)( lVar12 + 0x70 );
      fVar17 = fVar20 * *(float*)( lVar12 + 0x48 ) + fVar28 * *(float*)( lVar12 + 0x4c ) + fVar27 * *(float*)( lVar12 + 0x50 ) + *(float*)( lVar12 + 0x6c );
      fVar20 = *(float*)( this + 0x160 );
      fVar32 = *(float*)( lVar14 + 100 ) * fVar19 + *(float*)( lVar14 + 0x60 ) * fVar20 + *(float*)( lVar14 + 0x68 ) * fVar31 + *(float*)( lVar14 + 0x74 );
      ...
      fVar35 = *(float*)( lVar14 + 0x54 ) * fVar20 + *(float*)( lVar14 + 0x58 ) * fVar19 + *(float*)( lVar14 + 0x5c ) * fVar31 + *(float*)( lVar14 + 0x70 );
      fVar27 = *(float*)( lVar12 + 0xe8 );
      fVar1 = *(float*)( lVar14 + 0xe4 );
      fVar21 = fVar31 * *(float*)( lVar14 + 0x50 ) + fVar20 * *(float*)( lVar14 + 0x48 ) + fVar19 * *(float*)( lVar14 + 0x4c ) + *(float*)( lVar14 + 0x6c );
      ...
      do {
         ...
         fVar25 = ( ( (float)( ( uint )(( fVar23 - fVar35 ) * fVar30 + ( fVar17 - fVar21 ) * fVar26 + ( fVar22 - fVar32 ) * fVar34) ^ uVar15 ) * __LC3 ) / param_1 ) * ( _LC42._4_4_ / *(float*)( pGVar16 + 0x3c ) ) - ( ( ( ( fVar18 * fVar20 - fVar28 * fVar29 ) + fVar4 ) - ( ( fVar33 * fVar31 - fVar1 * fVar24 ) + fVar8 ) ) * fVar30 + ( ( ( fVar29 * fVar27 - fVar37 * fVar20 ) + fVar2 ) - ( ( fVar24 * fVar6 - fVar36 * fVar5 ) + fVar9 ) ) * fVar26 + ( ( ( fVar37 * fVar28 - fVar18 * fVar27 ) + fVar3 ) - ( ( fVar36 * fVar1 - fVar19 * fVar33 ) + fVar7 ) ) * fVar34 ) * ( _LC42._4_4_ / *(float*)( pGVar16 + 0x3c ) );
         ...
         *(float*)( this + 0x108 ) = *(float*)( this + 0x108 ) + fVar25;
         if (GVar10 != (GodotConeTwistJoint3D)0x0) {
            ...
            *(ulong*)( lVar12 + 0xd8 ) = CONCAT44(fVar30 * fVar25 + *(float*)( lVar12 + 0xdc ), fVar26 * fVar25 + *(float*)( lVar12 + 0xd8 ));
            *(ulong*)( lVar12 + 0xe0 ) = CONCAT44(fVar38 * *(float*)( lVar12 + 0x1b0 ) + fVar40 * *(float*)( lVar12 + 0x1b4 ) + fVar41 * *(float*)( lVar12 + 0x1b8 ) + *(float*)( lVar12 + 0xe4 ), fVar25 * fVar34 + *(float*)( lVar12 + 0xe0 ));
            *(ulong*)( lVar12 + 0xe8 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( lVar12 + 0xe8 ) >> 0x20 ) + *(float*)( lVar12 + 0x1cc ) * fVar40 + fVar38 * (float)( ( ulong ) * (undefined8*)( lVar12 + 0x1c4 ) >> 0x20 ) + (float)( ( ulong ) * (undefined8*)( lVar12 + 0x1cc ) >> 0x20 ) * fVar41, (float)*(undefined8*)( lVar12 + 0xe8 ) + *(float*)( lVar12 + 0x1c0 ) * fVar40 + fVar38 * (float)*(undefined8*)( lVar12 + 0x1bc ) + (float)*(undefined8*)( lVar12 + 0x1c4 ) * fVar41);
         }
         ...
         if (GVar11 != (GodotConeTwistJoint3D)0x0) {
            ...
            *(ulong*)( lVar14 + 0xd8 ) = CONCAT44(fVar30 * fVar25 + *(float*)( lVar14 + 0xdc ), fVar26 * fVar25 + *(float*)( lVar14 + 0xd8 ));
            *(ulong*)( lVar14 + 0xe0 ) = CONCAT44(*(float*)( lVar14 + 0x1b4 ) * fVar38 + fVar39 * *(float*)( lVar14 + 0x1b0 ) + fVar42 * *(float*)( lVar14 + 0x1b8 ) + *(float*)( lVar14 + 0xe4 ), fVar25 * fVar34 + *(float*)( lVar14 + 0xe0 ));
            *(ulong*)( lVar14 + 0xe8 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( lVar14 + 0xe8 ) >> 0x20 ) + (float)( ( ulong ) * (undefined8*)( lVar14 + 0x1cc ) >> 0x20 ) * fVar42 + fVar38 * *(float*)( lVar14 + 0x1cc ) + fVar39 * (float)( ( ulong ) * (undefined8*)( lVar14 + 0x1c4 ) >> 0x20 ), (float)*(undefined8*)( lVar14 + 0xe8 ) + (float)*(undefined8*)( lVar14 + 0x1c4 ) * fVar42 + fVar38 * *(float*)( lVar14 + 0x1c0 ) + fVar39 * (float)*(undefined8*)( lVar14 + 0x1bc ));
         }
 ...
 while ( pGVar16 != this + 0x108 );
   ...
   if (this[0x1ba] != (GodotConeTwistJoint3D)0x0) {
      ...
      fVar19 = ( ( ( local_28 - local_1c ) * *(float*)( this + 0x184 ) + ( fStack_24 - fStack_18 ) * *(float*)( this + 0x188 ) + ( fVar28 - fVar20 ) * *(float*)( this + 0x18c ) ) * *(float*)( this + 0x174 ) * *(float*)( this + 0x174 ) + ( _LC42._4_4_ / param_1 ) * *(float*)( this + 0x1a8 ) * *(float*)( this + 0x170 ) ) * *(float*)( this + 0x19c ) + fVar27;
      if (fVar19 <= 0.0) {
         fVar19 = 0.0;
      }
      ...
      *(float*)( this + 0x1b0 ) = fVar19;
      ...
      if (this[0x30] != (GodotConeTwistJoint3D)0x0) {
         *(float*)( lVar12 + 0xec ) = *(float*)( lVar12 + 0x1d0 ) * fVar27 + *(float*)( lVar12 + 0x1c8 ) * fVar19 + *(float*)( lVar12 + 0x1cc ) * fVar31 + *(float*)( lVar12 + 0xec );
         *(ulong*)( lVar12 + 0xe4 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( lVar12 + 0x1bc ) >> 0x20 ) * fVar31 + *(float*)( lVar12 + 0x1bc ) * fVar19 + *(float*)( lVar12 + 0x1c4 ) * fVar27 + (float)( ( ulong ) * (undefined8*)( lVar12 + 0xe4 ) >> 0x20 ), (float)*(undefined8*)( lVar12 + 0x1b4 ) * fVar31 + *(float*)( lVar12 + 0x1b0 ) * fVar19 + *(float*)( lVar12 + 0x1b8 ) * fVar27 + (float)*(undefined8*)( lVar12 + 0xe4 ));
      }
      ...
      if (this[0x31] != (GodotConeTwistJoint3D)0x0) {
         ...
         *(float*)( lVar14 + 0xec ) = *(float*)( lVar14 + 0x1d0 ) * fVar27 + *(float*)( lVar14 + 0x1c8 ) * fVar19 + *(float*)( lVar14 + 0x1cc ) * fVar31 + *(float*)( lVar14 + 0xec );
         *(ulong*)( lVar14 + 0xe4 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( lVar14 + 0x1bc ) >> 0x20 ) * fVar31 + fVar19 * *(float*)( lVar14 + 0x1bc ) + *(float*)( lVar14 + 0x1c4 ) * fVar27 + (float)( ( ulong ) * (undefined8*)( lVar14 + 0xe4 ) >> 0x20 ), (float)*(undefined8*)( lVar14 + 0x1b4 ) * fVar31 + fVar19 * *(float*)( lVar14 + 0x1b0 ) + *(float*)( lVar14 + 0x1b8 ) * fVar27 + (float)*(undefined8*)( lVar14 + 0xe4 ));
      }
   ...
   if (this[0x1b9] != (GodotConeTwistJoint3D)0x0) {
      ...
      fVar20 = ( ( ( local_28 - local_1c ) * *(float*)( this + 400 ) + ( fStack_24 - fStack_18 ) * *(float*)( this + 0x194 ) + ( fVar28 - fVar20 ) * *(float*)( this + 0x198 ) ) * *(float*)( this + 0x174 ) * *(float*)( this + 0x174 ) + ( _LC42._4_4_ / param_1 ) * *(float*)( this + 0x1ac ) * *(float*)( this + 0x170 ) ) * *(float*)( this + 0x1a0 ) + fVar27;
      if (fVar20 <= 0.0) {
         fVar20 = 0.0;
      }
      ...
      *(float*)( this + 0x1b4 ) = fVar20;
      ...
      if (this[0x30] != (GodotConeTwistJoint3D)0x0) {
         *(float*)( lVar12 + 0xec ) = *(float*)( lVar12 + 0x1d0 ) * fVar28 + *(float*)( lVar12 + 0x1c8 ) * fVar20 + *(float*)( lVar12 + 0x1cc ) * fVar27 + *(float*)( lVar12 + 0xec );
         *(ulong*)( lVar12 + 0xe4 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( lVar12 + 0x1bc ) >> 0x20 ) * fVar27 + *(float*)( lVar12 + 0x1bc ) * fVar20 + *(float*)( lVar12 + 0x1c4 ) * fVar28 + (float)( ( ulong ) * (undefined8*)( lVar12 + 0xe4 ) >> 0x20 ), (float)*(undefined8*)( lVar12 + 0x1b4 ) * fVar27 + *(float*)( lVar12 + 0x1b0 ) * fVar20 + *(float*)( lVar12 + 0x1b8 ) * fVar28 + (float)*(undefined8*)( lVar12 + 0xe4 ));
      }
      ...
      if (this[0x31] != (GodotConeTwistJoint3D)0x0) {
         ...
         *(float*)( lVar14 + 0xec ) = *(float*)( lVar14 + 0x1d0 ) * fVar28 + *(float*)( lVar14 + 0x1c8 ) * fVar20 + *(float*)( lVar14 + 0x1cc ) * fVar27 + *(float*)( lVar14 + 0xec );
         *(ulong*)( lVar14 + 0xe4 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( lVar14 + 0x1bc ) >> 0x20 ) * fVar27 + fVar20 * *(float*)( lVar14 + 0x1bc ) + *(float*)( lVar14 + 0x1c4 ) * fVar28 + (float)( ( ulong ) * (undefined8*)( lVar14 + 0xe4 ) >> 0x20 ), (float)*(undefined8*)( lVar14 + 0x1b4 ) * fVar27 + fVar20 * *(float*)( lVar14 + 0x1b0 ) + *(float*)( lVar14 + 0x1b8 ) * fVar28 + (float)*(undefined8*)( lVar14 + 0xe4 ));
      }
...
;
               ...
               *(undefined4*)( lVar7 + uVar33 * 4 ) = 0;
               ...
               if (*(long**)( this + 0x18 ) == plVar34) {
                  *(long*)( this + 0x18 ) = *plVar34;
                  ...
                  LAB_00100dd9:plVar10 = (long*)plVar34[1];
               ...
               *(long*)( this + 0x20 ) = plVar34[1];
               ...
               joined_r0x00100de0:if (plVar10 != (long*)0x0) {
                  *plVar10 = *plVar34;
                  plVar34 = (long*)*plVar4;
               }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotConeTwistJoint3D::setup(float) */byte GodotConeTwistJoint3D::setup(float param_1) {
   long *plVar1;
   undefined8 uVar2;
   long lVar3;
   undefined8 uVar4;
   ...
   *(undefined8*)( in_RDI + 0x1b0 ) = 0;
   if (*(char*)( in_RDI + 0x1b8 ) == '\0') {
      ...
      fVar25 = *(float*)( lVar14 + 0x60 ) * fVar26 + *(float*)( lVar14 + 100 ) * fVar17 + *(float*)( lVar14 + 0x68 ) * fVar15 + fVar32;
      fVar22 = *(float*)( in_RDI + 0x168 );
      fVar28 = *(float*)( lVar14 + 0x6c );
      fVar23 = *(float*)( in_RDI + 0x164 );
      fVar27 = *(float*)( lVar14 + 0x54 ) * fVar26 + *(float*)( lVar14 + 0x58 ) * fVar17 + *(float*)( lVar14 + 0x5c ) * fVar15 + fVar34;
      fVar15 = fVar26 * *(float*)( lVar14 + 0x48 ) + fVar17 * *(float*)( lVar14 + 0x4c ) + fVar15 * *(float*)( lVar14 + 0x50 ) + fVar28;
      fVar17 = *(float*)( lVar13 + 0x70 );
      fVar44 = *(float*)( lVar13 + 100 ) * fVar23 + *(float*)( lVar13 + 0x60 ) * fVar21 + *(float*)( lVar13 + 0x68 ) * fVar22 + fVar16;
      fVar26 = *(float*)( lVar13 + 0x6c );
      fVar42 = *(float*)( lVar13 + 0x58 ) * fVar23 + *(float*)( lVar13 + 0x54 ) * fVar21 + *(float*)( lVar13 + 0x5c ) * fVar22 + fVar17;
      fVar43 = fVar42 - fVar27;
      local_11c = 0.0;
      local_114 = 0.0;
      local_120 = fVar44 - fVar25;
      fVar21 = fVar23 * *(float*)( lVar13 + 0x4c ) + fVar21 * *(float*)( lVar13 + 0x48 ) + fVar22 * *(float*)( lVar13 + 0x50 ) + fVar26;
      ...
      if (_LC19 <= ABS(fVar23)) {
         ...
         LAB_00101120:local_120 = 0.0;
         local_110 = _LC17;
         LAB_00101135:local_108 = (float)local_128 * (float)local_128 + local_128._4_4_ * local_128._4_4_;
      ...
      while (true) {
         ...
         *(undefined8*)pfVar9 = uVar29;
         ...
         pfVar9[4] = fVar36;
         pfVar9[3] = fVar16;
         fVar40 = fVar38 * (float)( (uint)fVar32 ^ (uint)fVar22 ) - fVar43 * (float)( (uint)fVar23 ^ (uint)fVar22 );
         fVar34 = (float)( (uint)fVar23 ^ (uint)fVar22 ) * fVar37 - fVar38 * (float)( (uint)fVar28 ^ (uint)fVar22 );
         fVar23 = fVar43 * (float)( (uint)fVar28 ^ (uint)fVar22 ) - fVar37 * (float)( (uint)fVar32 ^ (uint)fVar22 );
         ...
         *(ulong*)( pfVar9 + 0xd ) = CONCAT44(fVar34, fVar28);
         pfVar9[0xc] = fVar32;
         fVar26 = fVar23 * fVar32 + fVar28 * fVar43 + fVar34 * fVar35 + fVar16 * fVar39 + fVar36 * fVar38 + fVar41 * fVar37 + fVar17 + fVar26;
         pfVar9[0xf] = fVar26;
         if (fVar26 <= 0.0) {
            _err_print_error("GodotJacobianEntry3D", "modules/godot_physics_3d/joints/godot_jacobian_entry_3d.h", 0x4b, "Condition \"m_Adiag <= real_t(0.0)\" is true.", 0, 0, fVar22, uVar24);
         }
...
;
   ...
   fVar16 = *(float*)( lVar14 + 0x4c ) * fVar32 + fVar21 * fVar37 + fVar15 * (float)*(undefined8*)( lVar14 + 0x50 );
   fVar43 = *(float*)( lVar14 + 0x58 ) * fVar32 + fVar21 * (float)( ( ulong ) * (undefined8*)( lVar14 + 0x50 ) >> 0x20 ) + fVar15 * (float)( ( ulong ) * (undefined8*)( lVar14 + 0x58 ) >> 0x20 );
   ...
   fVar27 = *(float*)( lVar13 + 0x4c ) * fVar42 + fVar38 * fVar25 + (float)*(undefined8*)( lVar13 + 0x50 ) * fVar34;
   fVar44 = *(float*)( lVar13 + 0x58 ) * fVar42 + (float)( ( ulong ) * (undefined8*)( lVar13 + 0x50 ) >> 0x20 ) * fVar25 + (float)( (ulong)uVar29 >> 0x20 ) * fVar34;
   ...
   if (__LC24 <= fVar22) {
      ...
      local_1b8 = *(float*)( lVar14 + 0x54 ) * fVar46 + fVar41 * fVar18 + *(float*)( lVar14 + 0x5c ) * fVar10;
   ...
   if (fVar18 < __LC24) {
      ...
      local_1cc = *(float*)( lVar14 + 0x54 ) * fVar40 + fVar41 * fVar20 + *(float*)( lVar14 + 0x5c ) * fVar46;
   ...
   if (local_1e8 < fVar26) {
      ...
      *(float*)( in_RDI + 0x1a8 ) = fVar26 - local_1e8;
      ...
      auVar31._0_4_ = ( fVar15 * fVar25 + (float)uVar29 * fVar42 + fVar21 * fVar34 ) * ( fVar26 * local_1d4 + fVar39 * local_1e0 ) - ( fVar22 * fVar25 + fVar28 * fVar42 + fVar23 * fVar34 ) * fVar36;
      auVar31._4_4_ = fVar35 * fVar17 - ( fVar38 * fVar25 + fVar37 * fVar42 + fVar32 * fVar34 ) * ( fVar41 * fVar26 + fStack_1b4 * fVar39 );
      ...
      *(float*)( in_RDI + 0x19c ) = local_1e8 / ( ( *(float*)( lVar13 + 0x1b0 ) * fVar15 + *(float*)( lVar13 + 0x1bc ) * fVar17 + *(float*)( lVar13 + 0x1c8 ) * fVar26 ) * fVar15 + ( *(float*)( lVar13 + 0x1b4 ) * fVar15 + *(float*)( lVar13 + 0x1c0 ) * fVar17 + *(float*)( lVar13 + 0x1cc ) * fVar26 ) * fVar17 + ( *(float*)( lVar13 + 0x1b8 ) * fVar15 + *(float*)( lVar13 + 0x1c4 ) * fVar17 + *(float*)( lVar13 + 0x1d0 ) * fVar26 ) * fVar26 + ( *(float*)( lVar14 + 0x1b0 ) * fVar15 + *(float*)( lVar14 + 0x1bc ) * fVar17 + *(float*)( lVar14 + 0x1c8 ) * fVar26 ) * fVar15 + ( *(float*)( lVar14 + 0x1b4 ) * fVar15 + *(float*)( lVar14 + 0x1c0 ) * fVar17 + *(float*)( lVar14 + 0x1cc ) * fVar26 ) * fVar17 + ( fVar15 * *(float*)( lVar14 + 0x1b8 ) + fVar17 * *(float*)( lVar14 + 0x1c4 ) + *(float*)( lVar14 + 0x1d0 ) * fVar26 ) * fVar26 );
   }
   ...
   if (0.0 <= *(float*)( in_RDI + 0x180 )) {
      ...
      fVar21 = *(float*)( lVar13 + 0x60 ) * fVar17 + *(float*)( lVar13 + 100 ) * fVar26 + *(float*)( lVar13 + 0x68 ) * fVar15;
      fVar32 = *(float*)( lVar13 + 0x54 ) * fVar17 + *(float*)( lVar13 + 0x58 ) * fVar26 + *(float*)( lVar13 + 0x5c ) * fVar15;
      fVar26 = fVar17 * *(float*)( lVar13 + 0x48 ) + fVar26 * *(float*)( lVar13 + 0x4c ) + fVar15 * *(float*)( lVar13 + 0x50 );
      ...
      if (cVar6 == '\0') {
         ...
         operator+((char *)&
         local_168,"The quaternion ";
         String::operator +((String*)&local_158, (String*)&local_168);
         _err_print_error("xform", "./core/math/quaternion.h", 0x5c, "Condition \"!is_normalized()\" is true. Returning: p_v", (String*)&local_158, 0, 0);
      ...
      if (fVar26 <= fVar32) {
         ...
         *(float*)( in_RDI + 0x1a0 ) = local_1e8 / ( ( *(float*)( lVar14 + 0x1b0 ) * fVar17 + *(float*)( lVar14 + 0x1bc ) * fVar26 + *(float*)( lVar14 + 0x1c8 ) * fVar15 ) * fVar17 + ( *(float*)( lVar14 + 0x1b4 ) * fVar17 + *(float*)( lVar14 + 0x1c0 ) * fVar26 + *(float*)( lVar14 + 0x1cc ) * fVar15 ) * fVar26 + ( *(float*)( lVar14 + 0x1b8 ) * fVar17 + *(float*)( lVar14 + 0x1c4 ) * fVar26 + *(float*)( lVar14 + 0x1d0 ) * fVar15 ) * fVar15 + ( *(float*)( lVar13 + 0x1b0 ) * fVar17 + *(float*)( lVar13 + 0x1bc ) * fVar26 + *(float*)( lVar13 + 0x1c8 ) * fVar15 ) * fVar17 + ( *(float*)( lVar13 + 0x1b4 ) * fVar17 + *(float*)( lVar13 + 0x1c0 ) * fVar26 + *(float*)( lVar13 + 0x1cc ) * fVar15 ) * fVar26 + ( fVar17 * *(float*)( lVar13 + 0x1b8 ) + fVar26 * *(float*)( lVar13 + 0x1c4 ) + *(float*)( lVar13 + 0x1d0 ) * fVar15 ) * fVar15 );
      }
         ...
         *(float*)( in_RDI + 0x194 ) = fVar17;
         ...
         lVar14 = *(long*)( in_RDI + 0x40 );
         lVar13 = *(long*)( in_RDI + 0x38 );
         *(float*)( in_RDI + 0x1a0 ) = local_1e8 / ( ( *(float*)( lVar14 + 0x1b8 ) * fVar26 + *(float*)( lVar14 + 0x1c4 ) * fVar17 + *(float*)( lVar14 + 0x1d0 ) * fVar21 ) * fVar21 + ( *(float*)( lVar14 + 0x1b0 ) * fVar26 + *(float*)( lVar14 + 0x1bc ) * fVar17 + *(float*)( lVar14 + 0x1c8 ) * fVar21 ) * fVar26 + ( *(float*)( lVar14 + 0x1b4 ) * fVar26 + *(float*)( lVar14 + 0x1c0 ) * fVar17 + *(float*)( lVar14 + 0x1cc ) * fVar21 ) * fVar17 + ( fVar26 * *(float*)( lVar13 + 0x1b8 ) + fVar17 * *(float*)( lVar13 + 0x1c4 ) + *(float*)( lVar13 + 0x1d0 ) * fVar21 ) * fVar21 + ( *(float*)( lVar13 + 0x1b0 ) * fVar26 + *(float*)( lVar13 + 0x1bc ) * fVar17 + *(float*)( lVar13 + 0x1c8 ) * fVar21 ) * fVar26 + ( *(float*)( lVar13 + 0x1b4 ) * fVar26 + *(float*)( lVar13 + 0x1c0 ) * fVar17 + *(float*)( lVar13 + 0x1cc ) * fVar21 ) * fVar17 );
      }
...
/* GodotConeTwistJoint3D::set_param(PhysicsServer3D::ConeTwistJointParam, float) */void GodotConeTwistJoint3D::set_param(undefined4 param_1, GodotConeTwistJoint3D *this, undefined4 param_3) {
   switch (param_3) {
      case 0:
...
/* GodotConeTwistJoint3D::get_param(PhysicsServer3D::ConeTwistJointParam) const */undefined4 GodotConeTwistJoint3D::get_param(GodotConeTwistJoint3D *this, undefined4 param_2) {
   switch (param_2) {
      case 0:
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotConeTwistJoint3D::GodotConeTwistJoint3D(GodotBody3D*, GodotBody3D*, Transform3D const&,
   Transform3D const&) */void GodotConeTwistJoint3D::GodotConeTwistJoint3D(GodotConeTwistJoint3D *this, GodotBody3D *param_1, GodotBody3D *param_2, Transform3D *param_3, Transform3D *param_4) {
   long lVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   *(undefined***)this = &PTR_get_soft_body_ptr_00103f10;
   ...
   do {
      ...
      *(undefined4*)( pGVar12 + 8 ) = 0;
      for (int i = 0; i < 4; i++) {
         *(undefined8*)( pGVar12 + ( 12*i + 12 ) ) = 0;
         *(undefined4*)( pGVar12 + ( 12*i + 20 ) ) = 0;
      }
...
/* GodotConeTwistJoint3D::get_type() const */undefined8 GodotConeTwistJoint3D::get_type(void) {
   return 3;
}
...
/* GodotConeTwistJoint3D::~GodotConeTwistJoint3D() */void GodotConeTwistJoint3D::~GodotConeTwistJoint3D(GodotConeTwistJoint3D *this) {
   long lVar1;
   long lVar2;
   long in_FS_OFFSET;
   GodotConeTwistJoint3D *local_28;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Quaternion::Quaternion(Vector3 const&, Vector3 const&) */void Quaternion::Quaternion(Quaternion *this, Vector3 *param_1, Vector3 *param_2) {
   ...
   *(ulong*)( this + 8 ) = CONCAT44(fVar6, fVar9 * ( fVar4 - fVar13 ));
   LAB_001032b3:if (lVar2 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* GodotConeTwistJoint3D::get_param(PhysicsServer3D::ConeTwistJointParam) const [clone .cold] */undefined8 GodotConeTwistJoint3D::get_param(void) {
   return 0;
}
...

{
 ...
 while ( ( uVar44 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar44 * lVar3,auVar23._8_8_ = 0,auVar23._0_8_ = uVar55,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar53 + uVar47 ) - SUB164(auVar7 * auVar23, 8)) * lVar3,auVar24._8_8_ = 0,auVar24._0_8_ = uVar55,lVar46 = SUB168(auVar8 * auVar24, 8),uVar50 <= SUB164(auVar8 * auVar24, 8) );
   ...
   LAB_00103bb3:uVar51 = CONCAT44(0, *(uint*)( hash_table_size_primes + uVar40 * 4 ));
   lVar3 = *(long*)( hash_table_size_primes_inv + uVar40 * 8 );
   uVar39 = (long)pGVar56 * 0x3ffff - 1;
   uVar39 = ( uVar39 ^ uVar39 >> 0x1f ) * 0x15;
   uVar39 = ( uVar39 ^ uVar39 >> 0xb ) * 0x41;
...
}LAB_0010380b:if ((float)uVar55 * __LC34 < (float)( iVar43 + 1 )) {
...
;*(undefined1(**) [16])( lVar45 + lStack_90 * 8 ) = pauVar37;*puVar1 = uVar53;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_00103b94:auVar59._8_8_ = lStack_90;auVar59._0_8_ = pauVar42[1] + 8;return auVar59;}/* WARNING: Control flow encountered bad instruction data *//* Quaternion::Quaternion(Vector3 const&, Vector3 const&) */void Quaternion::Quaternion(Quaternion *this, Vector3 *param_1, Vector3 *param_2) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* GodotConeTwistJoint3D::~GodotConeTwistJoint3D() */void GodotConeTwistJoint3D::~GodotConeTwistJoint3D(GodotConeTwistJoint3D *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

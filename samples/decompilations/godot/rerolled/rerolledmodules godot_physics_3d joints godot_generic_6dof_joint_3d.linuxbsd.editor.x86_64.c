/* GodotGeneric6DOFJoint3D::calcAnchorPos() */void GodotGeneric6DOFJoint3D::calcAnchorPos(GodotGeneric6DOFJoint3D *this) {
   float fVar1;
   float fVar2;
   if (*(float*)( *(long*)( this + 0x40 ) + 0x170 ) == 0.0) {
      ...
      fVar2 = *(float*)( *(long*)( this + 0x38 ) + 0x170 ) / ( *(float*)( *(long*)( this + 0x40 ) + 0x170 ) + *(float*)( *(long*)( this + 0x38 ) + 0x170 ) );
      fVar1 = _LC1 - fVar2;
   }

   *(float*)( this + 0x3ac ) = *(float*)( this + 0x340 ) * fVar2 + *(float*)( this + 0x370 ) * fVar1;
   *(ulong*)( this + 0x3a4 ) = CONCAT44(fVar1 * (float)( ( ulong ) * (undefined8*)( this + 0x368 ) >> 0x20 ) + fVar2 * (float)( ( ulong ) * (undefined8*)( this + 0x338 ) >> 0x20 ), fVar1 * (float)*(undefined8*)( this + 0x368 ) + fVar2 * (float)*(undefined8*)( this + 0x338 ));
   return;
}
...
;
               ...
               *(undefined4*)( lVar7 + uVar33 * 4 ) = 0;
               ...
               if (*(long**)( this + 0x18 ) == plVar34) {
                  *(long*)( this + 0x18 ) = *plVar34;
                  ...
                  LAB_00100289:plVar10 = (long*)plVar34[1];
               ...
               *(long*)( this + 0x20 ) = plVar34[1];
               ...
               joined_r0x00100290:if (plVar10 != (long*)0x0) {
                  *plVar10 = *plVar34;
                  plVar34 = (long*)*plVar4;
               }
...
/* GodotG6DOFRotationalLimitMotor3D::testLimitValue(float) */undefined8 GodotG6DOFRotationalLimitMotor3D::testLimitValue(GodotG6DOFRotationalLimitMotor3D *this, float param_1) {
   float fVar1;
   float fVar2;
   fVar1 = *(float*)this;
   fVar2 = *(float*)( this + 4 );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotG6DOFRotationalLimitMotor3D::solveAngularLimits(float, Vector3&, float, GodotBody3D*,
   GodotBody3D*, bool, bool) */undefined8 GodotG6DOFRotationalLimitMotor3D::solveAngularLimits(GodotG6DOFRotationalLimitMotor3D *this, float param_1, Vector3 *param_2, float param_3, GodotBody3D *param_4, GodotBody3D *param_5, bool param_6, bool param_7) {
   long lVar1;
   long in_FS_OFFSET;
   float fVar2;
   undefined8 uVar3;
   ...
   if (this[0x24] == (GodotG6DOFRotationalLimitMotor3D)0x0) {
      if (*(int*)( this + 0x2c ) != 0) {
         LAB_001006a0:fVar2 = *(float*)( this + 0x10 );
      ...
      LAB_0010040a:fVar11 = *(float*)( param_4 + 0xec );
      ...
      fVar7 = ( fVar7 - ( local_28 * fVar9 + fStack_24 * fVar10 + fVar11 * fVar8 ) * *(float*)( this + 0x14 ) ) * *(float*)( this + 0x18 );
      if (_LC3 <= ABS(fVar7)) {
         fVar2 = fVar2 * param_1;
         ...
         *(float*)( this + 0x30 ) = fVar2;
         ...
         if (param_6) {
            *(float*)( param_4 + 0xec ) = *(float*)( param_4 + 0x1d0 ) * fVar8 + *(float*)( param_4 + 0x1c8 ) * fVar9 + *(float*)( param_4 + 0x1cc ) * fVar10 + *(float*)( param_4 + 0xec );
            *(ulong*)( param_4 + 0xe4 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( param_4 + 0x1bc ) >> 0x20 ) * fVar10 + *(float*)( param_4 + 0x1bc ) * fVar9 + *(float*)( param_4 + 0x1c4 ) * fVar8 + (float)( ( ulong ) * (undefined8*)( param_4 + 0xe4 ) >> 0x20 ), (float)*(undefined8*)( param_4 + 0x1b4 ) * fVar10 + *(float*)( param_4 + 0x1b0 ) * fVar9 + *(float*)( param_4 + 0x1b8 ) * fVar8 + (float)*(undefined8*)( param_4 + 0xe4 ));
         }
         ...
         if (( param_5 != (GodotBody3D*)0x0 ) && ( param_7 )) {
            ...
            *(float*)( param_5 + 0xec ) = *(float*)( param_5 + 0x1d0 ) * fVar8 + *(float*)( param_5 + 0x1c8 ) * fVar9 + *(float*)( param_5 + 0x1cc ) * fVar10 + *(float*)( param_5 + 0xec );
            *(ulong*)( param_5 + 0xe4 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( param_5 + 0x1bc ) >> 0x20 ) * fVar10 + *(float*)( param_5 + 0x1bc ) * fVar9 + *(float*)( param_5 + 0x1c4 ) * fVar8 + (float)( ( ulong ) * (undefined8*)( param_5 + 0xe4 ) >> 0x20 ), (float)*(undefined8*)( param_5 + 0x1b4 ) * fVar10 + *(float*)( param_5 + 0x1b0 ) * fVar9 + *(float*)( param_5 + 0x1b8 ) * fVar8 + (float)*(undefined8*)( param_5 + 0xe4 ));
         }
   ...
   uVar3 = 0;
   LAB_001003da:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
...
/* GodotG6DOFTranslationalLimitMotor3D::solveLinearAxis(float, float, GodotBody3D*, Vector3 const&,
   GodotBody3D*, Vector3 const&, bool, bool, int, Vector3 const&, Vector3 const&) */undefined8 GodotG6DOFTranslationalLimitMotor3D::solveLinearAxis(GodotG6DOFTranslationalLimitMotor3D *this, float param_1, float param_2, GodotBody3D *param_3, Vector3 *param_4, GodotBody3D *param_5, Vector3 *param_6, bool param_7, bool param_8, int param_9, Vector3 *param_10, Vector3 *param_11) {
   ...
   fVar4 = (float)( ( uint )(( *(float*)( param_4 + 4 ) - *(float*)( param_6 + 4 ) ) * *(float*)( param_10 + 4 ) + ( *(float*)param_4 - *(float*)param_6 ) * *(float*)param_10 + ( *(float*)( param_4 + 8 ) - *(float*)( param_6 + 8 ) ) * *(float*)( param_10 + 8 )) ^ _LC2 );
   ...
   fVar5 = ( ( auVar6._0_4_ * *(float*)( pGVar1 + 0x3c ) ) / param_1 - ( ( ( ( fVar3 * *(float*)( param_3 + 0xe4 ) - fVar14 * *(float*)( param_3 + 0xe8 ) ) + *(float*)( param_3 + 0xe0 ) ) - ( ( fVar10 * *(float*)( param_5 + 0xe4 ) - fVar11 * *(float*)( param_5 + 0xe8 ) ) + *(float*)( param_5 + 0xe0 ) ) ) * *(float*)( param_10 + 8 ) + ( ( ( *(float*)( param_3 + 0xec ) * fVar14 - fVar21 * *(float*)( param_3 + 0xe4 ) ) + *(float*)( param_3 + 0xdc ) ) - ( ( *(float*)( param_5 + 0xec ) * fVar11 - fVar15 * *(float*)( param_5 + 0xe4 ) ) + *(float*)( param_5 + 0xdc ) ) ) * *(float*)( param_10 + 4 ) + ( ( ( *(float*)( param_3 + 0xe8 ) * fVar21 - *(float*)( param_3 + 0xec ) * fVar3 ) + *(float*)( param_3 + 0xd8 ) ) - ( ( *(float*)( param_5 + 0xe8 ) * fVar15 - *(float*)( param_5 + 0xec ) * fVar10 ) + *(float*)( param_5 + 0xd8 ) ) ) * *(float*)param_10 ) * *(float*)( pGVar1 + 0x30 ) ) * *(float*)( pGVar1 + 0x24 ) * param_2 + fVar8;
   ...
   *(float*)( pGVar1 + 0x18 ) = fVar5;
   ...
   if (param_7) {
      ...
      *(ulong*)( param_3 + 0xd8 ) = CONCAT44(fVar5 * fVar12 + *(float*)( param_3 + 0xdc ), fVar8 * fVar12 + *(float*)( param_3 + 0xd8 ));
      *(ulong*)( param_3 + 0xe0 ) = CONCAT44(fVar3 * *(float*)( param_3 + 0x1b0 ) + fVar10 * *(float*)( param_3 + 0x1b4 ) + fVar4 * *(float*)( param_3 + 0x1b8 ) + *(float*)( param_3 + 0xe4 ), fVar12 * fVar13 + *(float*)( param_3 + 0xe0 ));
      *(ulong*)( param_3 + 0xe8 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( param_3 + 0xe8 ) >> 0x20 ) + *(float*)( param_3 + 0x1d0 ) * fVar4 + (float)( ( ulong ) * (undefined8*)( param_3 + 0x1c8 ) >> 0x20 ) * fVar10 + *(float*)( param_3 + 0x1c8 ) * fVar3, (float)*(undefined8*)( param_3 + 0xe8 ) + *(float*)( param_3 + 0x1c4 ) * fVar4 + (float)*(undefined8*)( param_3 + 0x1c0 ) * fVar10 + *(float*)( param_3 + 0x1bc ) * fVar3);
   }
   ...
   if (param_8) {
      ...
      *(ulong*)( param_5 + 0xd8 ) = CONCAT44(fVar5 * fVar12 + *(float*)( param_5 + 0xdc ), fVar8 * fVar12 + *(float*)( param_5 + 0xd8 ));
      *(ulong*)( param_5 + 0xe0 ) = CONCAT44(fVar3 * *(float*)( param_5 + 0x1b0 ) + *(float*)( param_5 + 0x1b4 ) * fVar19 + fVar4 * *(float*)( param_5 + 0x1b8 ) + *(float*)( param_5 + 0xe4 ), fVar12 * fVar13 + *(float*)( param_5 + 0xe0 ));
      *(ulong*)( param_5 + 0xe8 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( param_5 + 0xe8 ) >> 0x20 ) + (float)( ( ulong ) * (undefined8*)( param_5 + 0x1c8 ) >> 0x20 ) * fVar19 + *(float*)( param_5 + 0x1c8 ) * fVar3 + *(float*)( param_5 + 0x1d0 ) * fVar4, (float)*(undefined8*)( param_5 + 0xe8 ) + (float)*(undefined8*)( param_5 + 0x1c0 ) * fVar19 + *(float*)( param_5 + 0x1bc ) * fVar3 + *(float*)( param_5 + 0x1c4 ) * fVar4);
   }

   return auVar6._0_8_;
}
/* GodotGeneric6DOFJoint3D::solve(float) */void GodotGeneric6DOFJoint3D::solve(GodotGeneric6DOFJoint3D *this, float param_1) {
      ...
      if (this[lVar1 + 0x270] != (GodotGeneric6DOFJoint3D)0x0) {
         if (*(float*)( this + lVar1 * 4 + 0x228 ) <= *(float*)( this + lVar1 * 4 + 0x234 )) {
            if (this[0x3b0] == (GodotGeneric6DOFJoint3D)0x0) {
               ...
               local_78 = CONCAT44((int)( ( ulong ) * (undefined8*)( this + lVar1 * 4 + 0x34c ) >> 0x20 ), (int)*(undefined8*)( this + lVar1 * 4 + 0x344 ));
            }
 else {
               local_70 = *(undefined4*)( this + lVar1 * 4 + 0x32c );
               local_78 = CONCAT44((int)( ( ulong ) * (undefined8*)( this + lVar1 * 4 + 0x31c ) >> 0x20 ), (int)*(undefined8*)( this + lVar1 * 4 + 0x314 ));
            }

            GodotG6DOFTranslationalLimitMotor3D::solveLinearAxis((GodotG6DOFTranslationalLimitMotor3D*)( this + 0x228 ), *(float*)( this + 0x310 ), _LC1 / *(float*)( this + lVar1 * 0x40 + 0xe4 ), *(GodotBody3D**)( this + 0x38 ), (Vector3*)&local_6c, *(GodotBody3D**)( this + 0x40 ), (Vector3*)&local_60, (bool)this[0x30], (bool)this[0x31], (int)lVar1, (Vector3*)&local_78, (Vector3*)( this + 0x3a4 ));
         }
 ...
 while ( lVar1 != 3 );
   ...
   do {
      if (( this_00[0x25] != (GodotG6DOFRotationalLimitMotor3D)0x0 ) && ( ( this_00[0x24] != (GodotG6DOFRotationalLimitMotor3D)0x0 || ( *(int*)( this_00 + 0x2c ) != 0 ) ) )) {
         ...
         local_3c = local_54;
         local_34 = local_4c;
         GodotG6DOFRotationalLimitMotor3D::solveAngularLimits(this_00, *(float*)( this + 0x310 ), (Vector3*)&local_54, _LC1 / *(float*)pGVar3, *(GodotBody3D**)( this + 0x38 ), *(GodotBody3D**)( this + 0x40 ), (bool)this[0x30], (bool)this[0x31]);
      }
...
/* GodotGeneric6DOFJoint3D::calculateAngleInfo() */void GodotGeneric6DOFJoint3D::calculateAngleInfo(GodotGeneric6DOFJoint3D *this) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   local_48 = *(float*)( this + 0x31c ) * fStack_20 + *(float*)( this + 0x328 ) * fStack_1c + fVar1 * local_18;
   ...
   fStack_60 = fStack_30 * fVar1 + *(float*)( this + 0x328 ) * fStack_34 + *(float*)( this + 0x31c ) * local_38;
   fStack_5c = fStack_24 * fVar2 + fVar5 * local_28 + fVar3 * fStack_2c;
   local_58 = fVar8 * fStack_24 + fVar4 * fStack_2c + fVar7 * local_28;
   fStack_54 = fVar1 * fStack_24 + *(float*)( this + 0x31c ) * fStack_2c + *(float*)( this + 0x328 ) * local_28;
...
/* GodotGeneric6DOFJoint3D::calculateTransforms() */void GodotGeneric6DOFJoint3D::calculateTransforms(GodotGeneric6DOFJoint3D *this) {
   long in_FS_OFFSET;
   undefined8 local_58;
...
/* GodotGeneric6DOFJoint3D::buildLinearJacobian(GodotJacobianEntry3D&, Vector3 const&, Vector3
   const&, Vector3 const&) */void GodotGeneric6DOFJoint3D::buildLinearJacobian(GodotGeneric6DOFJoint3D *this, GodotJacobianEntry3D *param_1, Vector3 *param_2, Vector3 *param_3, Vector3 *param_4) {
   float fVar1;
   undefined4 uVar2;
   long lVar3;
   long lVar4;
   ...
   *(ulong*)( param_1 + 0x34 ) = CONCAT44(fVar16, fVar9);
   fVar7 = fVar6 * fVar8 + fVar18 * fVar9 + fVar10 * fVar16 + fVar12 * fVar17 + fVar13 * fVar15 + fVar11 * fVar14 + fVar1 + fVar7;
...
/* GodotGeneric6DOFJoint3D::buildAngularJacobian(GodotJacobianEntry3D&, Vector3 const&) */void GodotGeneric6DOFJoint3D::buildAngularJacobian(GodotGeneric6DOFJoint3D *this, GodotJacobianEntry3D *param_1, Vector3 *param_2) {
   undefined8 uVar1;
   long lVar2;
   long lVar3;
   long lVar4;
   ...
   *(undefined8*)param_1 = 0;
   uVar6 = _LC2;
   for (int i = 0; i < 4; i++) {
      *(undefined8*)( param_1 + ( 12*i + 12 ) ) = 0;
   }

   fVar15 = *(float*)param_2;
   fVar17 = *(float*)( param_2 + 4 );
   for (int i = 0; i < 5; i++) {
      *(undefined4*)( param_1 + ( 12*i + 8 ) ) = 0;
   }
   ...
   *(float*)( param_1 + 0x30 ) = fVar15;
   fVar15 = fVar7 * fVar18 + fVar13 * fVar17 + fVar12 * fVar16 + fVar9 * fVar15 + fVar11 * fVar10 + fVar8 * fVar14;
   *(float*)( param_1 + 0x3c ) = fVar15;
   if (fVar15 <= 0.0) {
      _err_print_error("GodotJacobianEntry3D", "modules/godot_physics_3d/joints/godot_jacobian_entry_3d.h", 0x5b, "Condition \"m_Adiag <= real_t(0.0)\" is true.", 0, 0, uVar19, uVar20, uVar21, uVar22, uVar23);
   }
...
/* GodotGeneric6DOFJoint3D::testAngularLimitMotor(int) */uint GodotGeneric6DOFJoint3D::testAngularLimitMotor(GodotGeneric6DOFJoint3D *this, int param_1) {
   float fVar1;
   float fVar2;
   float fVar3;
   uint uVar4;
   ...
   *(undefined4*)( this + lVar5 * 0x34 + 0x2a0 ) = 0;
   LAB_00101a3e:uVar4 = (uint)(byte)this[lVar5 * 0x34 + 0x298];
   if (this[lVar5 * 0x34 + 0x298] == (GodotGeneric6DOFJoint3D)0x0) {
      uVar4 = CONCAT31(( int3 )(( uint ) * (int*)( this + lVar5 * 0x34 + 0x2a0 ) >> 8), *(int*)( this + lVar5 * 0x34 + 0x2a0 ) != 0);
   }

   return uVar4;
}
/* GodotGeneric6DOFJoint3D::setup(float) */ulong GodotGeneric6DOFJoint3D::setup(float param_1) {
   char cVar1;
   int iVar2;
   ...
   if (bVar5 != 0) {
      ...
      *(undefined4*)( in_RDI + 0x248 ) = 0;
      ...
      pGVar4 = in_RDI + 0x228;
      for (int i = 0; i < 3; i++) {
         *(undefined4*)( in_RDI + ( 52*i + 676 ) ) = 0;
      }

      Transform3D::operator *((Transform3D*)&local_b8, (Transform3D*)( *(long*)( in_RDI + 0x38 ) + 0x48 ));
      ...
      *(undefined8*)( in_RDI + 0x33c ) = uStack_90;
      Transform3D::operator *((Transform3D*)&local_b8, (Transform3D*)( *(long*)( in_RDI + 0x40 ) + 0x48 ));
      ...
      *(undefined8*)( in_RDI + 0x36c ) = uStack_90;
      ...
      local_5c = local_68;
      do {
         if (( *pGVar6 != (GodotGeneric6DOFJoint3D)0x0 ) && ( *(float*)pGVar4 <= *(float*)( pGVar4 + 0xc ) )) {
            if (in_RDI[0x3b0] == (GodotGeneric6DOFJoint3D)0x0) {
               local_78 = *(float*)( pGVar4 + 0x134 );
               local_80 = CONCAT44((int)( ( ulong ) * (undefined8*)( pGVar4 + 0x124 ) >> 0x20 ), (int)*(undefined8*)( pGVar4 + 0x11c ));
            }
 else {
               local_78 = *(float*)( pGVar4 + 0x104 );
               local_80 = CONCAT44((int)( ( ulong ) * (undefined8*)( pGVar4 + 0xf4 ) >> 0x20 ), (int)*(undefined8*)( pGVar4 + 0xec ));
            }

            buildLinearJacobian(in_RDI, pGVar3, (Vector3*)&local_80, (Vector3*)&local_70, (Vector3*)&local_64);
         }
...
/* GodotGeneric6DOFJoint3D::updateRHS(float) */void GodotGeneric6DOFJoint3D::updateRHS(float param_1) {
   return;
}
/* GodotGeneric6DOFJoint3D::getAxis(int) const */void GodotGeneric6DOFJoint3D::getAxis(int param_1) {
   long in_FS_OFFSET;
...
/* GodotGeneric6DOFJoint3D::getAngle(int) const */undefined4 GodotGeneric6DOFJoint3D::getAngle(GodotGeneric6DOFJoint3D *this, int param_1) {
   return *(undefined4*)( this + (long)param_1 * 4 + 0x374 );
}
/* GodotGeneric6DOFJoint3D::set_param(Vector3::Axis, PhysicsServer3D::G6DOFJointAxisParam, float) */void GodotGeneric6DOFJoint3D::set_param(undefined4 param_1, GodotGeneric6DOFJoint3D *this, uint param_3, undefined4 param_4) {
   if (param_3 < 3) {
      switch (param_4) {
         case 0:
   ...
   _err_print_index_error("set_param", "modules/godot_physics_3d/joints/godot_generic_6dof_joint_3d.cpp", 0x1c0, (ulong)param_3, 3, "p_axis", "3", "", false, false);
   return;
}
/* GodotGeneric6DOFJoint3D::get_param(Vector3::Axis, PhysicsServer3D::G6DOFJointAxisParam) const */undefined4 GodotGeneric6DOFJoint3D::get_param(GodotGeneric6DOFJoint3D *this, uint param_2, undefined4 param_3) {
   if (param_2 < 3) {
      switch (param_3) {
         case 0:
   ...
   _err_print_index_error("get_param", "modules/godot_physics_3d/joints/godot_generic_6dof_joint_3d.cpp", 0x217, (ulong)param_2, 3, "p_axis", "3", "", false, false);
   return 0;
}
/* GodotGeneric6DOFJoint3D::set_flag(Vector3::Axis, PhysicsServer3D::G6DOFJointAxisFlag, bool) */void GodotGeneric6DOFJoint3D::set_flag(GodotGeneric6DOFJoint3D *this, uint param_2, int param_3, GodotGeneric6DOFJoint3D param_4) {
   if (2 < param_2) {
      _err_print_index_error("set_flag", "modules/godot_physics_3d/joints/godot_generic_6dof_joint_3d.cpp", 0x26f, (ulong)param_2, 3, "p_axis", "3", "", false, false);
      return;
   }
...
/* GodotGeneric6DOFJoint3D::get_flag(Vector3::Axis, PhysicsServer3D::G6DOFJointAxisFlag) const */GodotGeneric6DOFJoint3D GodotGeneric6DOFJoint3D::get_flag(GodotGeneric6DOFJoint3D *this, uint param_2, int param_3) {
   if (2 < param_2) {
      _err_print_index_error("get_flag", "modules/godot_physics_3d/joints/godot_generic_6dof_joint_3d.cpp", 0x28a, (ulong)param_2, 3, "p_axis", "3", "", false, false);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotGeneric6DOFJoint3D::GodotGeneric6DOFJoint3D(GodotBody3D*, GodotBody3D*, Transform3D const&,
   Transform3D const&, bool) */void GodotGeneric6DOFJoint3D::GodotGeneric6DOFJoint3D(GodotGeneric6DOFJoint3D *this, GodotBody3D *param_1, GodotBody3D *param_2, Transform3D *param_3, Transform3D *param_4, bool param_5) {
   long lVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   *(undefined8*)( this + 0xa0 ) = uVar11;
   ...
   do {
      ...
      *(undefined4*)( pGVar14 + 8 ) = 0;
      for (int i = 0; i < 4; i++) {
         *(undefined8*)( pGVar14 + ( 12*i + 12 ) ) = 0;
         *(undefined4*)( pGVar14 + ( 12*i + 20 ) ) = 0;
      }
 ...
 while ( pGVar13 != this + 0x168 );
   do {
      ...
      *(undefined4*)( pGVar13 + 8 ) = 0;
      for (int i = 0; i < 4; i++) {
         *(undefined8*)( pGVar13 + ( 12*i + 12 ) ) = 0;
         *(undefined4*)( pGVar13 + ( 12*i + 20 ) ) = 0;
      }
 ...
 while ( this + 0x310 != pGVar13 );
   ...
   *(undefined4*)( this + 0x340 ) = 0;
   for (int i = 0; i < 3; i++) {
      *(undefined8*)( this + ( 24*i + 872 ) ) = 0;
      *(undefined4*)( this + ( 24*i + 880 ) ) = 0;
      *(undefined8*)( this + ( 24*i + 884 ) ) = 0;
      *(undefined4*)( this + ( 24*i + 892 ) ) = 0;
   }
...
/* GodotGeneric6DOFJoint3D::get_type() const */undefined8 GodotGeneric6DOFJoint3D::get_type(void) {
   return 4;
}
...
/* GodotGeneric6DOFJoint3D::~GodotGeneric6DOFJoint3D() */void GodotGeneric6DOFJoint3D::~GodotGeneric6DOFJoint3D(GodotGeneric6DOFJoint3D *this) {
   long lVar1;
   long lVar2;
   long in_FS_OFFSET;
   GodotGeneric6DOFJoint3D *local_28;
...

{
 ...
 while ( ( uVar44 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar44 * lVar3,auVar23._8_8_ = 0,auVar23._0_8_ = uVar55,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar53 + uVar47 ) - SUB164(auVar7 * auVar23, 8)) * lVar3,auVar24._8_8_ = 0,auVar24._0_8_ = uVar55,lVar46 = SUB168(auVar8 * auVar24, 8),uVar50 <= SUB164(auVar8 * auVar24, 8) );
   ...
   LAB_00102f93:uVar51 = CONCAT44(0, *(uint*)( hash_table_size_primes + uVar40 * 4 ));
   lVar3 = *(long*)( hash_table_size_primes_inv + uVar40 * 8 );
   uVar39 = (long)pGVar56 * 0x3ffff - 1;
   uVar39 = ( uVar39 ^ uVar39 >> 0x1f ) * 0x15;
   uVar39 = ( uVar39 ^ uVar39 >> 0xb ) * 0x41;
...
}LAB_00102beb:if ((float)uVar55 * __LC17 < (float)( iVar43 + 1 )) {
...
;*(undefined1(**) [16])( lVar45 + lStack_90 * 8 ) = pauVar37;*puVar1 = uVar53;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_00102f74:auVar59._8_8_ = lStack_90;auVar59._0_8_ = pauVar42[1] + 8;return auVar59;}/* WARNING: Control flow encountered bad instruction data *//* GodotGeneric6DOFJoint3D::~GodotGeneric6DOFJoint3D() */void GodotGeneric6DOFJoint3D::~GodotGeneric6DOFJoint3D(GodotGeneric6DOFJoint3D *this) {

...
/* JoypadLinux::Joypad::~Joypad() */void JoypadLinux::Joypad::~Joypad(Joypad *this) {
   long *plVar1;
   long lVar2;
   Joypad *pJVar3;
   pJVar3 = this + 0xe10;
...
/* JoypadLinux::Joypad::reset() */void JoypadLinux::Joypad::reset(Joypad *this) {
   ulong uVar1;
   undefined8 *puVar2;
   *(undefined8*)this = 0;
   for (int i = 0; i < 4; i++) {
      *(undefined4*)( this + ( 4*i + 3544 ) ) = 4294967295;
   }

   for (int i = 0; i < 8; i++) {
      for (int j = 0; j < 6; j++) {
         *(undefined4*)( this + ( 28*i + ( 4*j + 3320 ) ) ) = 4294967295;
      }

      *(undefined4*)( this + ( 28*i + 3344 ) ) = 4294967295;
   }

   for (int i = 0; i < 4; i++) {
      *(undefined4*)( this + ( 4*i + 3556 ) ) = 4294967295;
   }
   ...
   *(undefined4*)( this + 0xe00 ) = 0xffffffff;
   ...
   for (uVar1 = ( ulong )(( (int)this - (int)(undefined8*)( ( ulong )(this + 8) & 0xfffffffffffffff8 ) ) + 0xfcU >> 3); uVar1 != 0; uVar1 = uVar1 - 1) {
      *puVar2 = 0;
      puVar2 = puVar2 + 1;
   }
...
/* JoypadLinux::setup_joypad_properties(JoypadLinux::Joypad&) */void JoypadLinux::setup_joypad_properties(JoypadLinux *this, Joypad *param_1) {
   int iVar1;
   int iVar2;
   ulong uVar3;
   void *pvVar4;
...
;
 ...
 while ( uVar7 != 0x28 );
      LAB_00100373:param_1[0x1008] = (Joypad)0x0;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JoypadLinux::joypad_vibration_start(JoypadLinux::Joypad&, float, float, float, unsigned long) */void JoypadLinux::joypad_vibration_start(JoypadLinux *this, Joypad *param_1, float param_2, float param_3, float param_4, ulong param_5) {
   long *plVar1;
   long lVar2;
   char cVar3;
   int iVar4;
   ...
   if (( ( ( param_1[0x1008] != (Joypad)0x0 ) && ( iVar4 = *(int*)( param_1 + 0xe00 ) ),iVar4 != -1 ) ) && ( 0.0 <= param_2 )) {
      fVar8 = _LC2;
      ...
      if ((float)( (uint)fVar6 & _LC5 ) < _LC4) {
         fVar6 = (float)( ( uint )((float)(int)fVar6 - (float)( -(uint)(fVar6 < (float)(int)fVar6) & (uint)fVar8 )) | ~_LC5 & (uint)fVar6 );
      }

      fVar7 = param_3 * _LC3;
      local_56 = (undefined2)(int)fVar6;
      if ((float)( (uint)fVar7 & _LC5 ) < _LC4) {
         fVar7 = (float)( ( uint )((float)(int)fVar7 - (float)( -(uint)(fVar7 < (float)(int)fVar7) & (uint)fVar8 )) | ~_LC5 & (uint)fVar7 );
      }
...
/* JoypadLinux::joypad_vibration_stop(JoypadLinux::Joypad&, unsigned long) */void JoypadLinux::joypad_vibration_stop(JoypadLinux *this, Joypad *param_1, ulong param_2) {
   int iVar1;
...
/* JoypadLinux::axis_correct(input_absinfo const*, int) const */undefined8 JoypadLinux::axis_correct(JoypadLinux *this, input_absinfo *param_1, int param_2) {
   float fVar1;
...
/* JoypadLinux::process_joypads() */void JoypadLinux::process_joypads(JoypadLinux *this) {
   short *psVar1;
   ushort uVar2;
   long lVar3;
   int iVar4;
      ...
      if (*(int*)( pJVar12 + 0xc ) != -1) {
         ...
         if (*(int*)( pJVar12 + 0x224 ) != 0) {
            ...
            LAB_001008e0:do {
               ...
               uVar6 = (ulong)uVar2;
               if (0x2fe < uVar2) {
                  LAB_00100a40:pthread_mutex_unlock(local_50);
                  return;
               }

               if (*psVar1 == 1) {
                  lVar11 = lVar11 + 1;
                  Input::joy_button(*(undefined8*)( this + 8 ), iVar10, *(undefined4*)( this + ( uVar6 + 0x48 + lVar8 ) * 4 + 0x14 ), *(int*)( psVar1 + 2 ) != 0);
               ...
               if (*psVar1 == 3) {
                  if (uVar2 == 0x10) {
                     ...
                     if (uVar2 != 0x11) {
                        ...
                        if (( *(int*)( this + ( uVar6 + 0x348 + lVar8 ) * 4 + 0x10 ) != -1 ) && ( lVar3 = *(long*)( this + ( uVar6 + 0x1c8 ) * 8 + (long)iVar10 * 0x1028 + 8 ) ),lVar3 != 0) {
                           fVar13 = (float)( *(int*)( psVar1 + 2 ) - *(int*)( lVar3 + 4 ) );
                           *(float*)( this + ( (long)*(int*)( this + ( uVar6 + 0x348 + lVar8 ) * 4 + 0x10 ) + 0xc + lVar8 ) * 4 + 8 ) = ( fVar13 + fVar13 ) / (float)( *(int*)( lVar3 + 8 ) - *(int*)( lVar3 + 4 ) ) - _LC2;
                        }
               ...
               LAB_001008d0:uVar5 = *(uint*)( pJVar12 + 0x224 );
               lVar11 = lVar11 + 1;
            }
 ...
 while ( pJVar9 != pJVar12 );
         if (( pJVar12[0x214] != (JoypadLinux)0x0 ) && ( uVar6 = Input::get_joy_vibration_timestamp((int)*(undefined8*)( this + 8 )) * (ulong*)( pJVar12 + 0x21c ) < uVar6 )) {
            ...
            if (( (float)uVar15 == 0.0 ) && ( fVar13 == 0.0 )) {
               if (( ( ( pJVar12[0x214] != (JoypadLinux)0x0 ) && ( *(int*)( pJVar12 + 0xc ) != -1 ) ) && ( *(int*)( pJVar12 + 0x218 ) != -1 ) ) && ( iVar4 = -1 < iVar4 )) {
                  *(int*)( pJVar12 + 0x218 ) = -1;
               ...
               joypad_vibration_start(this, (Joypad*)( pJVar12 + -0xdf4 ), (float)uVar15, fVar13, fVar14, uVar6);
            }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JoypadLinux::JoypadLinux(Input*) */void JoypadLinux::JoypadLinux(JoypadLinux *this, Input *param_1) {
   CowData<char32_t> *this_00;
   char cVar1;
   int iVar2;
   JoypadLinux *pJVar3;
   ...
   if (iVar2 == 0) {
      ...
      do {
         if (*(long*)( this + 0x10550 ) == 0) {
            lVar11 = 0;
            LAB_00101233:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar5, lVar11, "p_index", "size()", "", false, false);
         }
 else {
 ...
 while ( bVar12 );
   ...
   if (cVar1 == '\0') {
      ...
      *this = ( JoypadLinux )(iVar2 == 0);
      if (iVar2 == 0) {
         if (( ( ( ( ( ( _udev_new_dylibloader_wrapper_libudev == 0 ) || ( _udev_unref_dylibloader_wrapper_libudev == 0 ) ) || ( _udev_enumerate_new_dylibloader_wrapper_libudev == 0 ) ) || ( ( _udev_enumerate_add_match_subsystem_dylibloader_wrapper_libudev == 0 || ( _udev_enumerate_scan_devices_dylibloader_wrapper_libudev == 0 ) ) ) ) || ( ( _udev_enumerate_get_list_entry_dylibloader_wrapper_libudev == 0 || ( ( _udev_list_entry_get_next_dylibloader_wrapper_libudev == 0 || ( _udev_list_entry_get_name_dylibloader_wrapper_libudev == 0 ) ) ) ) ) ) || ( _udev_device_new_from_syspath_dylibloader_wrapper_libudev == 0 ) ) || ( ( ( ( ( _udev_device_get_devnode_dylibloader_wrapper_libudev == 0 || ( _udev_device_get_action_dylibloader_wrapper_libudev == 0 ) ) || ( _udev_device_unref_dylibloader_wrapper_libudev == 0 ) ) || ( ( ( _udev_enumerate_unref_dylibloader_wrapper_libudev == 0 || ( _udev_monitor_new_from_netlink_dylibloader_wrapper_libudev == 0 ) ) || ( ( _udev_monitor_filter_add_match_subsystem_devtype_dylibloader_wrapper_libudev == 0 || ( ( _udev_monitor_enable_receiving_dylibloader_wrapper_libudev == 0 || ( _udev_monitor_get_fd_dylibloader_wrapper_libudev == 0 ) ) ) ) ) ) ) ) || ( ( _udev_monitor_receive_device_dylibloader_wrapper_libudev == 0 || ( _udev_monitor_unref_dylibloader_wrapper_libudev == 0 ) ) ) ) )) {
            *this = (JoypadLinux)0x0;
      ...
      pcVar9 = "JoypadLinux: udev enabled, but couldn\'t be loaded. Falling back to /dev/input to detect joypads.";
   }
 else {
      *this = (JoypadLinux)0x0;
      cVar1 = is_print_verbose_enabled();
      pcVar9 = "JoypadLinux: udev enabled, but detected incompatible sandboxed mode. Falling back to /dev/input to detect joypads.";
      joined_r0x00101222:if (cVar1 == '\0') goto LAB_00100f92;
   }
...
/* JoypadLinux::close_joypad(JoypadLinux::Joypad&, int) */void JoypadLinux::close_joypad(JoypadLinux *this, Joypad *param_1, int param_2) {
   long *plVar1;
 ...
 while ( lVar4 != lVar3 );
      ...
      _err_print_index_error("remove_at", "./core/templates/cowdata.h", 0xe4, lVar3, lVar7, "p_index", "size()", "", false, false);
   }

   LAB_0010135d:uVar2 = *(undefined8*)( this + 8 );
   ...
   local_50 = 0;
   String::parse_latin1((StrRange*)&local_70);
   Input::joy_connection_changed((int)uVar2, SUB41(param_2, 0), (String*)0x0, (String*)&local_70, (Dictionary*)&local_68);
   lVar3 = local_70;
   if (local_70 != 0) {
      LOCK();
   ...
   Dictionary::~Dictionary(local_60);
   LAB_001012e3:if (*(int*)( param_1 + 0x1018 ) != 0) {
...
/* JoypadLinux::close_joypads() */void JoypadLinux::close_joypads(JoypadLinux *this) {
   int iVar1;
...
/* JoypadLinux::~JoypadLinux() */void JoypadLinux::~JoypadLinux(JoypadLinux *this) {
   Joypad *this_00;
   Joypad *pJVar1;
...
/* JoypadLinux::close_joypad(char const*) */void JoypadLinux::close_joypad(JoypadLinux *this, char *param_1) {
   char cVar1;
   int iVar2;
   pthread_mutex_t *__mutex;
   int iVar3;
...
/* JoypadLinux::joypad_events_thread_run() */void JoypadLinux::joypad_events_thread_run(JoypadLinux *this) {
   uint uVar1;
   code *pcVar2;
   bool bVar3;
   undefined8 uVar4;
...
/* JoypadLinux::joypad_events_thread_func(void*) */void JoypadLinux::joypad_events_thread_func(void *param_1) {
   if (param_1 != (void*)0x0) {
...
/* JoypadLinux::open_joypad(char const*) */void JoypadLinux::open_joypad(JoypadLinux *this, char *param_1) {
   long *plVar1;
   CowData<char32_t> *this_00;
   undefined8 uVar2;
   ushort uVar3;
   ...
   if (iVar13 == 0) {
      ...
      _err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar18, lVar17, "p_index", "size()", "", false, false);
   }
 else {
      _err_print_error("push_back", "./core/templates/vector.h", 0x142, "Condition \"err\" is true. Returning: true", 0, 0);
   }

   LAB_00101a54:lVar17 = local_220;
   if (local_220 != 0) {
      LOCK();
   ...
   if (( ( ( iVar13 < 0 ) || ( iVar13 = ioctl(iVar12, 0x80604521, local_1b8) ),iVar13 < 0 ) ) || ( iVar13 = iVar13 < 0 )) {
      close(iVar12);
   }
 else {
      local_238 = 0;
         ...
         if (cVar10 == '\0') {
            ...
            *(int*)( this + lVar21 + 0xe38 ) = iVar12;
            ...
            if (( ( local_220._2_2_ == 0 ) || ( local_220._4_2_ == 0 ) ) || ( local_220._6_2_ == 0 )) {
               ...
               if (( local_238 != 0 ) && ( iVar12 = iVar12 != 0 )) {
                  iVar12 = iVar12 + -1;
                  iVar13 = 0xb;
                  if (iVar12 < 0xc) {
                     iVar13 = iVar12;
                  ...
                  if (0 < iVar12) {
                     ...
                     do {
                        if (local_238 == 0) {
                           if (lVar18 != 0) {
                              lVar23 = 0;
                              LAB_0010215c:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar18, lVar23, "p_index", "size()", "", false, true);
                              _err_flush_stdout();
                              /* WARNING: Does not return */
 ...
 while ( (int)lVar18 < iVar13 );
               ...
               Input::joy_connection_changed((int)uVar2, SUB41(iVar11, 0), (String*)0x1, (String*)&local_238, (Dictionary*)&local_230);
               Dictionary::~Dictionary((Dictionary*)&local_218);
               pcVar6 = local_230;
               if (local_230 != (char*)0x0) {
                  LOCK();
               ...
               __sprintf_chk(local_148 + uVar16, 2, uVar19 - uVar16, "%04x%04x%04x%04x%04x%04x", uVar14, 0, uVar3 | uVar4, 0, uVar8 << 8 | uVar8 >> 8, 0);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_228);
               if (( ( local_220._2_2_ == 0x28de ) && ( local_220._4_2_ == 0x11ff ) ) && ( cVar10 = String::begins_with((char*)&local_238) ),cVar10 != '\0') {
               ...
               local_218 = local_148;
               String::parse_latin1((StrRange*)&local_228);
               Input::joy_connection_changed((int)uVar2, SUB41(iVar11, 0), (String*)0x1, (String*)&local_238, (Dictionary*)&local_228);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_228);
               Dictionary::~Dictionary((Dictionary*)&local_230);
            }
      ...
      joined_r0x00101c52:local_238 = lVar17;
      if (lVar17 != 0) {
         LOCK();
   ...
   LAB_00101944:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JoypadLinux::enumerate_joypads(udev*) */void JoypadLinux::enumerate_joypads(JoypadLinux *this, udev *param_1) {
   long *plVar1;
   long lVar2;
   int iVar3;
   undefined8 uVar4;
   ...
   for (lVar5 = ( *_udev_enumerate_get_list_entry_dylibloader_wrapper_libudev )(uVar4); lVar5 != 0; lVar5 = ( *_udev_list_entry_get_next_dylibloader_wrapper_libudev )(lVar5)) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JoypadLinux::monitor_joypads(udev*) */void JoypadLinux::monitor_joypads(JoypadLinux *this, udev *param_1) {
   JoypadLinux JVar1;
   char *pcVar2;
   char cVar3;
   int iVar4;
   ...
   do {
      ...
      if (( ( ( 0 < iVar5 ) && ( lVar12 = __fdelt_chk((long)iVar4)(uVar14 & local_c8.fds_bits[lVar12]) != 0 ) ) && ( lVar12 = ( *_udev_monitor_receive_device_dylibloader_wrapper_libudev )(uVar6) ),lVar12 != 0 )) {
 ...
 while ( !bVar15 );
                  ...
                  LAB_0010299c:cVar3 = String::operator ==((String*)&local_d8, "remove");
                  pcVar2 = local_d8;
...
/* JoypadLinux::monitor_joypads() */void JoypadLinux::monitor_joypads(JoypadLinux *this) {
   JoypadLinux JVar1;
   long lVar2;
   int iVar3;
   DIR *__dirp;
   ...
   do {
      ...
      if (__dirp != (DIR*)0x0) {
         LAB_00102a98:pdVar4 = readdir64(__dirp);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JoypadLinux::monitor_joypads_thread_run() */void JoypadLinux::monitor_joypads_thread_run(JoypadLinux *this) {
   udev *puVar1;
   if (*this != (JoypadLinux)0x0) {
      ...
      *this = (JoypadLinux)0x0;
      _err_print_error("monitor_joypads_thread_run", "platform/linuxbsd/joypad_linux.cpp", 0x91, "Failed getting an udev context, falling back to parsing /dev/input.", 0, 0);
   }

   monitor_joypads(this);
   return;
}
/* JoypadLinux::monitor_joypads_thread_func(void*) */void JoypadLinux::monitor_joypads_thread_func(void *param_1) {
   if (param_1 != (void*)0x0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<String>::resize<false>(long) */undefined8 CowData<String>::resize<false>(CowData<String> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_00103570:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar10 == lVar7) {
      LAB_001034ef:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         LAB_001035c6:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      }

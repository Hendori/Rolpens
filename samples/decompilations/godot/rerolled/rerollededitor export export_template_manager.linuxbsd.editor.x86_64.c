...
/* ExportTemplateManager::_set_current_progress_status(String const&, bool) */void ExportTemplateManager::_set_current_progress_status(ExportTemplateManager *this, String *param_1, bool param_2) {
   ...
   if (param_2) {
      ...
      if (_set_current_progress_status(String_const&,bool)::{lambda()
      #1
      {
         iVar2 = __cxa_guard_acquire(&_set_current_progress_status(String_const & sname));
         if (iVar2 != 0) {
      ...
      pSVar3 = (StringName *)
             &_set_current_progress_status(String_const&,bool)::{lambda()
      #1
   }
 else {
      pSVar4 = *(StringName**)( this + 0xe18 );
...
/* ExportTemplateManager::_set_current_progress_value(float, String const&) */void ExportTemplateManager::_set_current_progress_value(float param_1, String *param_2) {
   CanvasItem::show();

...
JPH::CastConvexVsTriangles::CastConvexVsTriangles
          (undefined8 param_1_00,undefined8 param_2_00,CastConvexVsTriangles *this,
          undefined8 param_1,undefined8 param_2,undefined8 param_6,undefined8 *param_7,
          undefined8 param_8)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* JPH::CastConvexVsTriangles::Cast(JPH::Vec3, JPH::Vec3, JPH::Vec3, unsigned char, JPH::SubShapeID
   const&) */

void JPH::CastConvexVsTriangles::Cast
               (undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
               undefined8 param_5,undefined8 param_6,long *param_7,byte param_8,undefined4 *param_9)

{
  ...
  fVar26 = (fVar43 - fVar39) * ((float)local_768 - fVar38) -
           (local_768._4_4_ - fVar39) * (fVar42 - fVar38);
  fVar32 = *(float *)(param_7 + 0x211);
  fVar27 = ((fVar44 - fVar40) * (local_768._4_4_ - fVar39) -
           ((float)uStack_760 - fVar40) * (fVar43 - fVar39)) * fVar32;
  local_6e8 = ((fVar42 - fVar38) * ((float)uStack_760 - fVar40) -
              ((float)local_768 - fVar38) * (fVar44 - fVar40)) * fVar32;
  ...
  lVar18 = param_7[1];
  fVar32 = *(float *)(puVar2 + 0xd) * local_6d8 +
           *(float *)((long)puVar2 + 100) * local_6e8 + fVar27 * *(float *)(puVar2 + 0xc) + 0.0;
  ...
  if (plVar21 == (long *)0x0) {
    plVar21 = (long *)(**(code **)(*(long *)*puVar2 + 0x130))
                                (puVar2[2],puVar2[3],(long *)*puVar2,
                                 (uint)(*(byte *)(lVar18 + 0x22) ^ 1) * 2,param_7 + 8);
  ...
  bVar15 = GJKClosestPoint::CastShape<JPH::ConvexShape::Support,JPH::TriangleConvexSupport>
                     (uVar4,uVar5,local_588,lVar18 + 0x20,lVar3,&local_638,&local_690,&local_668,
                      &local_658,&local_648);
  fVar12 = local_690;
  if (!bVar15) goto LAB_00100cd2;
  fVar35 = fVar35 * fVar35;
  fVar33 = (float)uStack_640 * (float)uStack_640 +
           local_648._4_4_ * local_648._4_4_ + (float)local_648 * (float)local_648 + 0.0;
  if ((cVar1 == '\0') || (local_690 != 0.0)) {
    ...
    local_680 = fVar28;
    local_678 = &local_638;
    bVar15 = EPAPenetrationDepth::
             GetPenetrationDepthStepEPA<JPH::TransformedConvexObject<JPH::AddConvexRadius<JPH::ConvexShape::Support>>,JPH::AddConvexRadius<JPH::TriangleConvexSupport>>
                       (local_588,(TransformedConvexObject *)&local_4b8,
                        (AddConvexRadius *)&local_678,fVar44,(Vec3 *)&local_648,(Vec3 *)&local_668,
                        (Vec3 *)&local_658);
    if (!bVar15) goto LAB_00100cd2;
  }
  uVar5 = uStack_640;
  ...
  if ((*pcVar24 == '\0') && (param_8 != 7)) {
    ...
    if ((fVar31 * local_6d8 + fVar30 * local_6e8 + fVar29 * fVar27 + 0.0) * fVar34 <=
        (fVar25 * fVar31 + fVar30 * fVar37 + fVar26 * fVar29 + 0.0) * fVar36) {
      if (param_8 == 0) {
LAB_0010118d:
        local_648 = uVar13;
        uStack_640 = uStack_770;
      }
      else if (fVar25 * local_6d8 + fVar37 * local_6e8 + fVar26 * fVar27 + 0.0 <=
               fVar34 * __LC72 * fVar36) {
        ...
        ClosestPoint::GetBaryCentricCoordinates
                  (CONCAT44(fVar39 - fStack_654,fVar38 - local_658),
                   CONCAT44(fVar41 - fStack_64c,fVar40 - fStack_650),local_768,uStack_760,local_778,
                   &local_68c,&local_688,&local_678);
        if (__LC73 < local_68c) {
          bVar16 = 5;
        }
  ...
  local_268 = 0;
  local_498 = CONCAT44((float)local_648 * fVar9 + local_648._4_4_ * fVar35 +
                       (float)uStack_640 * fVar46,
                       (float)local_648 * fVar8 + local_648._4_4_ * fVar44 +
                       (float)uStack_640 * fVar45);
  uStack_490 = CONCAT44((float)local_648 * fVar11 + local_648._4_4_ * fVar33 +
                        (float)uStack_640 * fVar48,
                        (float)local_648 * fVar10 + local_648._4_4_ * fVar28 +
                        (float)uStack_640 * fVar47);
  local_58 = fVar12;
  fVar32 = SQRT((fStack_650 - fStack_660) * (fStack_650 - fStack_660) +
                (local_658 - local_668) * (local_658 - local_668) + 0.0 +
                (fStack_654 - fStack_664) * (fStack_654 - fStack_664));
  local_488 = CONCAT44((int)param_7[6],fVar32);
  if ((fVar12 == 0.0) && (*(float *)(plVar21 + 1) <= (float)((uint)fVar32 ^ __LC4)))
  goto LAB_00100cd2;
  if (pcVar24[1] == '\0') {
    puVar2 = (undefined8 *)*param_7;
    ...
    local_5e8 = puVar2[8];
    uStack_5e0 = puVar2[9];
    local_5d8 = CONCAT44(fVar12 * *(float *)((long)puVar2 + 100) + *(float *)((long)puVar2 + 0x54),
                         fVar12 * *(float *)(puVar2 + 0xc) + *(float *)(puVar2 + 10));
    ...
    do {
      ...
      fVar8 = pfVar23[0xe];
      fVar9 = pfVar23[0xf];
      *(float *)((long)local_5c8 + lVar18) =
           fVar44 * pfVar23[0xc] + fVar32 * *pfVar23 + fVar42 * pfVar23[4] + fVar43 * pfVar23[8];
      *(float *)((long)local_5c8 + lVar18 + 4) =
           fVar44 * fVar33 + fVar32 * fVar35 + fVar42 * fVar38 + fVar43 * fVar41;
      *(float *)((long)local_5c8 + lVar18 + 8) =
           fVar44 * fVar8 + fVar32 * fVar27 + fVar42 * fVar39 + fVar43 * fVar12;
      *(float *)((long)local_5c8 + lVar18 + 0xc) =
           fVar44 * fVar9 + fVar32 * fVar26 + fVar42 * fVar40 + fVar43 * fVar28;
      lVar18 = lVar18 + 0x10;
    } while (lVar18 != 0x40);
    ...
    local_778 = CONCAT44((float)local_5f8 * fVar32 + (float)((ulong)local_5f8 >> 0x20) * fVar42 +
                         fVar43 * (float)uStack_5f0,
                         (float)local_608 * fVar32 + local_608._4_4_ * fVar42 +
                         fVar43 * (float)uStack_600);
    uStack_770 = CONCAT44(fVar32 * 0.0 + fVar42 * 0.0 + fVar43 * 0.0,
                          (float)local_5e8 * fVar32 + (float)((ulong)local_5e8 >> 0x20) * fVar42 +
                          fVar43 * (float)uStack_5e0);
    local_608 = uVar4;
    uStack_600 = uVar5;
    uStack_5f0 = uVar13;
    uStack_5e0 = uVar14;
...
LAB_00100cc4:
  (**(code **)(*plVar21 + 0x28))(plVar21,&local_4b8);
LAB_00100cd2:
      ...
      if (0.0 < fVar23) {
        ...
        *(long *)(this + 0x54) = auVar15._0_8_;
        if (((fVar24 < auVar15._0_4_) && (__LC16 < auVar15._4_4_)) &&
           (auVar15._0_4_ + auVar15._4_4_ < _LC17)) goto LAB_00101cdc;
      }
    }
  }
  else {
...
/* JPH::Vec3
   ...
   JPH::AddConvexRadius<JPH::TriangleConvexSupport> const&, JPH::Vec3, int&) */

undefined1  [16]
JPH::EPAPenetrationDepth::SupportPoints::
Add<JPH::TransformedConvexObject<JPH::AddConvexRadius<JPH::ConvexShape::Support>>,JPH::AddConvexRadius<JPH::TriangleConvexSupport>>
...

{
  ...
  fVar8 = (float)*(undefined8 *)(param_2 + 4) * local_58 +
          (float)((ulong)*(undefined8 *)(param_2 + 4) >> 0x20) * fStack_54 + fStack_50 * param_2[6];
  fVar9 = (float)*(undefined8 *)(param_2 + 8) * local_58 +
          (float)((ulong)*(undefined8 *)(param_2 + 8) >> 0x20) * fStack_54 + fStack_50 * param_2[10]
  ;
...

{
  ...
  *(uint *)(puVar23 + -0x1058) = uVar31;
  if (uVar31 == 1) {
    ...
    *(undefined8 *)(puVar23 + -0x1510) = 0x102d7e;
    SupportPoints::
    Add<JPH::TransformedConvexObject<JPH::AddConvexRadius<JPH::ConvexShape::Support>>,JPH::AddConvexRadius<JPH::TriangleConvexSupport>>
              (0x3f80000000000000,0,puVar2,param_1,uVar35,puVar23 + -0x1478);
    *(undefined8 *)(puVar23 + -0x1510) = 0x102d9e;
    SupportPoints::
    Add<JPH::TransformedConvexObject<JPH::AddConvexRadius<JPH::ConvexShape::Support>>,JPH::AddConvexRadius<JPH::TriangleConvexSupport>>
              (0xbf800000bf800000,0xbf800000bf800000,puVar2,param_1,uVar35,puVar23 + -0x1474);
    *(undefined8 *)(puVar23 + -0x1510) = 0x102dc8;
    SupportPoints::
    Add<JPH::TransformedConvexObject<JPH::AddConvexRadius<JPH::ConvexShape::Support>>,JPH::AddConvexRadius<JPH::TriangleConvexSupport>>
              (0xbf8000003f800000,0xbf800000bf800000,puVar2,param_1,uVar35,puVar23 + -0x1470);
    *(undefined8 *)(puVar23 + -0x1510) = 0x102dfc;
    SupportPoints::
    Add<JPH::TransformedConvexObject<JPH::AddConvexRadius<JPH::ConvexShape::Support>>,JPH::AddConvexRadius<JPH::TriangleConvexSupport>>
              (0xbf80000000000000,0x3f8000003f800000,puVar2,param_1,uVar35,puVar23 + -0x146c);
    ...
    *(ulong *)(puVar23 + -0x1500) =
         *(ulong *)(puVar23 + -0x1500) & 0xffffffff00000000 | (ulong)(uint)fVar32;
    fVar50 = (float)(__LC46 & ((__LC70 & uVar31 | ~uVar31 & (uint)((float)__LC50 + __LC62)) ^
                              __LC45 & __LC50 << 0x1e ^ __LC50 << 0x1f) |
                    ~__LC46 & (uint)((float)(((uint)((float)__LC50 + __LC62) & uVar31 |
                                             ~uVar31 & __LC70) ^ (__LC44 ^ __LC50 << 0x1e) & __LC45)
                                    * *(float *)(puVar23 + -0x1508)));
    fVar40 = (float)(_UNK_00105204 &
                     ((_UNK_00105244 & uVar45 |
                      ~uVar45 & (uint)((float)_UNK_00105224 + _UNK_00105234)) ^
                     _UNK_001051f4 & _UNK_00105224 << 0x1e ^ _UNK_00105224 << 0x1f) |
                    ~_UNK_00105204 &
                    (uint)((float)(((uint)((float)_UNK_00105224 + _UNK_00105234) & uVar45 |
                                   ~uVar45 & _UNK_00105244) ^
                                  (_UNK_001051e4 ^ _UNK_00105224 << 0x1e) & _UNK_001051f4) *
                          *(float *)(puVar23 + -0x1504)));
    fVar46 = (float)((uint)_LC9 &
                     ((_UNK_00105248 & uVar47 |
                      ~uVar47 & (uint)((float)_UNK_00105228 + _UNK_00105238)) ^
                     _UNK_001051f8 & _UNK_00105228 << 0x1e ^ _UNK_00105228 << 0x1f) |
                    ~(uint)_LC9 &
                    (uint)((float)(((uint)((float)_UNK_00105228 + _UNK_00105238) & uVar47 |
                                   ~uVar47 & _UNK_00105248) ^
                                  (_UNK_001051e8 ^ _UNK_00105228 << 0x1e) & _UNK_001051f8) *
                          *(float *)(puVar23 + -0x1500)));
    fVar48 = (float)(_LC9._4_4_ &
                     ((_UNK_0010524c & uVar49 |
                      ~uVar49 & (uint)((float)_UNK_0010522c + _UNK_0010523c)) ^
                     _UNK_001051fc & _UNK_0010522c << 0x1e ^ _UNK_0010522c << 0x1f) |
                    ~_LC9._4_4_ &
                    (uint)((float)(((uint)((float)_UNK_0010522c + _UNK_0010523c) & uVar49 |
                                   ~uVar49 & _UNK_0010524c) ^
                                  (_UNK_001051ec ^ _UNK_0010522c << 0x1e) & _UNK_001051fc) *
                          *(float *)(puVar23 + -0x14fc)));
    ...
    *(float *)(puVar23 + -0x1500) =
         fVar39 * fVar33 + fVar37 * fVar55 + fVar32 * fVar54 + _UNK_00105218;
    ...
    *(float *)(puVar23 + -0x1494) =
         fVar46 * fVar39 + fVar40 * fVar50 + fVar37 * fVar48 + _UNK_00105214;
    *(float *)(puVar23 + -0x1490) =
         fVar55 * fVar39 + fVar40 * fVar33 + fVar37 * fVar54 + _UNK_00105218;
    *(float *)(puVar23 + -0x148c) = fVar39 * 0.0 + fVar40 * 0.0 + fVar37 * 0.0 + _LC3;
    *(undefined8 *)(puVar23 + -0x1510) = 0x102cde;
    SupportPoints::
    Add<JPH::TransformedConvexObject<JPH::AddConvexRadius<JPH::ConvexShape::Support>>,JPH::AddConvexRadius<JPH::TriangleConvexSupport>>
              (*(undefined8 *)(puVar23 + -0x14e8),*(undefined8 *)(puVar23 + -0x14e0),puVar2,param_1,
               uVar35,puVar23 + -0x1474);
    *(undefined8 *)(puVar23 + -0x1510) = 0x102cff;
    SupportPoints::
    Add<JPH::TransformedConvexObject<JPH::AddConvexRadius<JPH::ConvexShape::Support>>,JPH::AddConvexRadius<JPH::TriangleConvexSupport>>
              (*(undefined8 *)(puVar23 + -0x1508),*(undefined8 *)(puVar23 + -0x1500),puVar2,param_1,
               uVar35,puVar23 + -0x1470);
    *(undefined8 *)(puVar23 + -0x1510) = 0x102d21;
    SupportPoints::
    Add<JPH::TransformedConvexObject<JPH::AddConvexRadius<JPH::ConvexShape::Support>>,JPH::AddConvexRadius<JPH::TriangleConvexSupport>>
              (*(undefined8 *)(puVar23 + -0x1498),*(undefined8 *)(puVar23 + -0x1490),puVar2,param_1,
               uVar35,puVar23 + -0x146c);
    uVar31 = *(uint *)(puVar23 + -0x1058);
  ...
  *(Triangle **)(puVar23 + 0x7c8) = pTVar26;
  *(undefined4 *)(puVar23 + 2000) = 2;
  *(undefined8 *)(puVar23 + 0x848) = uVar35;
  *(undefined4 *)(puVar23 + 0x850) = 0;
  *(Triangle **)(puVar23 + 0x7d8) = pTVar26;
  *(undefined4 *)(puVar23 + 0x7e0) = 1;
  *(undefined8 *)(puVar23 + 0x838) = uVar35;
  *(undefined4 *)(puVar23 + 0x840) = 1;
  *(Triangle **)(puVar23 + 0x7e8) = pTVar26;
  *(undefined4 *)(puVar23 + 0x7f0) = 0;
  *(undefined8 *)(puVar23 + 0x828) = uVar35;
  *(undefined4 *)(puVar23 + 0x830) = 2;
  puVar23[0x827] = 1;
  ...
  *(undefined8 *)(puVar23 + 0x67f0) = *(undefined8 *)(puVar23 + -0x14d0);
  if (*(float *)(puVar23 + 0x818) < *(float *)(puVar23 + 0x878) ||
      *(float *)(puVar23 + 0x818) == *(float *)(puVar23 + 0x878)) {
...
LAB_00102605:
        do {
          ...
          if (pTVar9[0x5e] == (Triangle)0x0) {
            ...
            fVar32 = (pfVar29[2] - *(float *)(pTVar9 + 0x48)) * fVar37 +
                     (pfVar29[1] - *(float *)(pTVar9 + 0x44)) * fVar34 +
                     (*pfVar29 - *(float *)(pTVar9 + 0x40)) * fVar33 + 0.0;
            if (0.0 < fVar32) {
              fVar33 = (fVar32 * fVar32) /
                       (fVar37 * fVar37 + fVar34 * fVar34 + fVar33 * fVar33 + 0.0);
              if (fVar39 < fVar33) {
                pTVar24 = pTVar9;
                fVar39 = fVar33;
              }
        ...
        if (pTVar24 != (Triangle *)0x0) {
          ...
          *(undefined8 *)(puVar23 + -0x1510) = 0x1026bb;
          cVar15 = EPAConvexHullBuilder::AddPoint
                             ((EPAConvexHullBuilder *)(puVar23 + 0x7b8),pTVar24,uVar31,_LC10,
  ...
  do {
    ...
    if (pTVar26[0x5e] == (Triangle)0x0) {
      ...
      if (0x10 < uVar1) {
        ...
        do {
          ...
          if (fVar39 <= fVar33) {
            if ((lVar19 <= lVar20) ||
               (lVar18 = lVar20,
               fVar39 < *(float *)(*(long *)(puVar23 + lVar20 * 8 + 0x67e8) + 0x50) ||
               fVar39 == *(float *)(*(long *)(puVar23 + lVar20 * 8 + 0x67e8) + 0x50))) break;
          }
          else {
            lVar18 = lVar21;
            if ((lVar20 < lVar19) &&
               (lVar18 = lVar20,
               fVar33 < *(float *)(*(long *)(puVar23 + lVar20 * 8 + 0x67e8) + 0x50) ||
               fVar33 == *(float *)(*(long *)(puVar23 + lVar20 * 8 + 0x67e8) + 0x50))) {
              lVar18 = lVar21;
            }
          }
      ...
      *(undefined8 *)(puVar23 + -0x1510) = 0x1027fc;
      auVar58 = SupportPoints::
                Add<JPH::TransformedConvexObject<JPH::AddConvexRadius<JPH::ConvexShape::Support>>,JPH::AddConvexRadius<JPH::TriangleConvexSupport>>
                          (uVar38,uVar7,puVar2,param_1,uVar35,puVar23 + -0x146c);
      ...
      *(long *)(puVar23 + -0x1500) = auVar58._8_8_;
      if ((*(float *)(puVar23 + -0x1500) - *(float *)(pTVar26 + 0x48)) * *(float *)(pTVar26 + 0x38)
          + (*(float *)(puVar23 + -0x1504) - *(float *)(pTVar26 + 0x44)) *
            *(float *)(pTVar26 + 0x34) +
            fVar39 * (*(float *)(puVar23 + -0x1508) - *(float *)(pTVar26 + 0x40)) + 0.0 <= 0.0)
      goto LAB_001029a0;
      *(undefined8 *)(puVar23 + -0x1510) = 0x10287a;
      cVar15 = EPAConvexHullBuilder::AddPoint
                         ((EPAConvexHullBuilder *)(puVar23 + 0x7b8),pTVar26,
                          *(int *)(puVar23 + -0x146c),_LC10,(StaticArray *)(puVar23 + -0x1468));
      if (cVar15 == '\0') goto LAB_001029a0;
    ...
    do {
      ...
      if (fVar33 <= fVar34) {
        if ((lVar21 <= lVar20) ||
           (lVar18 = lVar20,
           fVar33 < *(float *)(*(long *)(puVar23 + lVar20 * 8 + 0x67e8) + 0x50) ||
           fVar33 == *(float *)(*(long *)(puVar23 + lVar20 * 8 + 0x67e8) + 0x50))) break;
      }
      else {
        lVar18 = lVar22;
        if ((lVar20 < lVar21) &&
           (lVar18 = lVar20,
           fVar34 < *(float *)(*(long *)(puVar23 + lVar20 * 8 + 0x67e8) + 0x50) ||
           fVar34 == *(float *)(*(long *)(puVar23 + lVar20 * 8 + 0x67e8) + 0x50))) {
          lVar18 = lVar22;
        }
      }
  ...
  *(uint *)(puVar23 + 0x67e0) = uVar31;
  if (pTVar26[0x5e] == (Triangle)0x0) {
    ...
    *(undefined8 *)(puVar23 + -0x1510) = 0x103177;
    auVar58 = SupportPoints::
              Add<JPH::TransformedConvexObject<JPH::AddConvexRadius<JPH::ConvexShape::Support>>,JPH::AddConvexRadius<JPH::TriangleConvexSupport>>
                        (uVar38,uVar35,puVar2,param_1,*(undefined8 *)(puVar23 + -0x14c8),
                         puVar23 + -0x146c);
    fVar39 = *(float *)(pTVar26 + 0x30);
    ...
    *(long *)(puVar23 + -0x1500) = auVar58._8_8_;
    fVar37 = auVar58._8_4_ * fVar34 +
             (float)((ulong)*(undefined8 *)(puVar23 + -0x1508) >> 0x20) * fVar33 +
             (float)*(undefined8 *)(puVar23 + -0x1508) * fVar39 + 0.0;
    if (fVar37 < 0.0) goto LAB_001029a0;
    fVar32 = (fVar37 * fVar37) / (fVar34 * fVar34 + fVar33 * fVar33 + fVar39 * fVar39 + 0.0);
    pTVar24 = pTVar26;
    if (fVar32 - *(float *)(pTVar26 + 0x50) <
        *(float *)(pTVar26 + 0x50) * *(float *)(puVar23 + -0x14b4)) goto LAB_00102f67;
    if (*(float *)(puVar23 + -0x14f8) <= fVar32) {
      fVar32 = *(float *)(puVar23 + -0x14f8);
    }
    if ((*(float *)(puVar23 + -0x1500) - *(float *)(pTVar26 + 0x48)) * fVar34 +
        (*(float *)(puVar23 + -0x1504) - *(float *)(pTVar26 + 0x44)) * fVar33 +
        (*(float *)(puVar23 + -0x1508) - *(float *)(pTVar26 + 0x40)) * fVar39 + 0.0 <= 0.0)
    goto LAB_00102f67;
    ...
    *(undefined8 *)(puVar23 + -0x1510) = 0x10329e;
    cVar15 = EPAConvexHullBuilder::AddPoint
                       ((EPAConvexHullBuilder *)(puVar23 + 0x7b8),pTVar26,
                        *(int *)(puVar23 + -0x146c),fVar32,(StaticArray *)(puVar23 + -0x1468));
    ...
    if ((ulong)*(uint *)(puVar23 + -0x1468) != 0) {
      ...
      do {
        lVar22 = *plVar17;
        if ((float)((ulong)*(undefined8 *)(lVar22 + 0x40) >> 0x20) * *(float *)(lVar22 + 0x34) +
            (float)*(undefined8 *)(lVar22 + 0x40) * *(float *)(lVar22 + 0x30) + 0.0 +
            *(float *)(lVar22 + 0x38) * *(float *)(lVar22 + 0x48) < 0.0) {
          uVar35 = *(undefined8 *)(pTVar26 + 0x38);
...
LAB_001035ea:
          ...
          fVar40 = *(float *)param_1 * fVar37 + *(float *)(param_1 + 4) * fVar32 +
                   fVar50 * *(float *)(param_1 + 8);
          *(float *)(puVar23 + -0x1508) = fVar40;
          *(float *)(puVar23 + -0x1504) =
               (float)uVar38 * fVar37 + (float)((ulong)uVar38 >> 0x20) * fVar32 + fVar50 * fVar33;
          *(float *)(puVar23 + -0x1500) =
               (float)uVar35 * fVar37 + (float)((ulong)uVar35 >> 0x20) * fVar32 + fVar50 * fVar34;
          *(float *)(puVar23 + -0x14fc) = fVar37 * 0.0 + fVar32 * 0.0 + fVar50 * 0.0;
          fVar33 = SQRT(*(float *)(puVar23 + -0x1504) * *(float *)(puVar23 + -0x1504) +
                        fVar40 * fVar40 + 0.0 +
                        *(float *)(puVar23 + -0x1500) * *(float *)(puVar23 + -0x1500));
          if (fVar33 <= 0.0) {
            *(undefined4 *)(puVar23 + -0x14e8) = uVar6;
            *(undefined8 *)(puVar23 + -0x1510) = 0x1035d1;
            auVar58 = (*pcVar10)(*(undefined8 *)(puVar23 + -0x1508),
                                 *(undefined8 *)(puVar23 + -0x1500));
            ...
            *(float *)(puVar23 + -0x14e8) = *(float *)(puVar23 + -0x1508) * fVar39;
            *(float *)(puVar23 + -0x14e4) = *(float *)(puVar23 + -0x1504) * fVar39;
            *(float *)(puVar23 + -0x14e0) = *(float *)(puVar23 + -0x1500) * fVar39;
            *(float *)(puVar23 + -0x14dc) = *(float *)(puVar23 + -0x14fc) * fVar39;
          ...
          bVar16 = (float)((uint)(((fVar33 * *(float *)(param_1 + 8) +
                                    fVar34 * *(float *)(param_1 + 0x18) +
                                    fVar37 * *(float *)(param_1 + 0x28) + *(float *)(param_1 + 0x38)
                                   ) - *(float *)(puVar23 + -0x14f0)) * *(float *)(pTVar26 + 0x38) +
                                 ((fVar33 * *(float *)(param_1 + 4) +
                                   fVar34 * *(float *)(param_1 + 0x14) +
                                   fVar37 * *(float *)(param_1 + 0x24) + *(float *)(param_1 + 0x34))
                                 - *(float *)(puVar23 + -0x14f4)) * *(float *)(pTVar26 + 0x34) +
                                 *(float *)(pTVar26 + 0x30) *
                                 ((fVar33 * *(float *)param_1 + fVar34 * *(float *)(param_1 + 0x10)
                                   + fVar37 * *(float *)(param_1 + 0x20) +
                                  *(float *)(param_1 + 0x30)) - *(float *)(puVar23 + -0x14f8)) + 0.0
                                 ) ^ __LC4) < fVar39;
          goto LAB_00102f70;
        }
        plVar17 = plVar17 + 1;
...
LAB_00102f70:
    pfVar29 = *(float **)(puVar23 + -0x14b0);
    fVar33 = (*(float *)(pTVar26 + 0x48) * *(float *)(pTVar26 + 0x38) +
             (float)((ulong)*(undefined8 *)(pTVar26 + 0x30) >> 0x20) * *(float *)(pTVar26 + 0x44) +
             (float)*(undefined8 *)(pTVar26 + 0x30) * *(float *)(pTVar26 + 0x40) + 0.0) /
             (*(float *)(pTVar26 + 0x38) * *(float *)(pTVar26 + 0x38) +
             *(float *)(pTVar26 + 0x30) * *(float *)(pTVar26 + 0x30) + 0.0 +
             *(float *)(pTVar26 + 0x34) * *(float *)(pTVar26 + 0x34));
...

{
  ...
  if (fVar34 < _LC13) {
    ...
    if (_LC2 < fVar22) {
      fVar22 = (float)((uint)(fVar33 * fVar26 + fVar32 * fVar24 + fVar20 * fVar2 + 0.0) ^ __LC4) /
               fVar22;
      if (fVar22 < 0.0) {
        fVar10 = 0.0;
      }
...

{
  ...
  if (local_88 != 0) {
    ...
    fVar1 = auVar5._8_4_ * auVar5._8_4_ +
  ...
  if (auVar4._0_8_ >> 0x20 != 0) {
    ...
    fVar3 = auVar6._8_4_ * auVar6._8_4_ +
  ...
  uVar2 = local_28;
  if ((auVar4._8_8_ >> 0x20 != 0) &&
     (auVar4 = GetClosestPointOnTriangle<false>
                         (param_3,param_4,param_5,param_6,param_7,param_8,&local_24),
     uVar2 = local_28,
     auVar4._8_4_ * auVar4._8_4_ + auVar4._4_4_ * auVar4._4_4_ + auVar4._0_4_ * auVar4._0_4_ + 0.0 <
     fVar1)) {
    uVar2 = local_24 * 2;
    auVar5 = auVar4;
  }
...
bool JPH::GJKClosestPoint::CastShape<JPH::ConvexShape::Support,JPH::TriangleConvexSupport>
               (undefined8 param_1_00,undefined8 param_2,float param_3,float param_4,float param_5,
               undefined1 (*param_1) [12],float *param_7,long *param_8,float *param_9,
...

{
  ...
  *(undefined4 *)param_1[0x10] = 0;
  auVar46 = (**(code **)(lVar15 + 0x10))
                      (CONCAT44(fVar44 * 0.0 + fVar45 * 0.0 + fVar30 * 0.0,
                                fVar40 * 0.0 + fVar41 * 0.0 + fVar42 * 0.0),
                       fVar24 * 0.0 + fVar27 * 0.0 + fVar4 * 0.0,param_8);
  ...
  local_168 = fVar40 * (float)local_178._0_4_ + (float)local_178._4_4_ * fVar44 + fVar18 * fVar24 +
              local_138 + (0.0 - param_9[8]);
  fStack_164 = fVar41 * (float)local_178._0_4_ + (float)local_178._4_4_ * fVar45 + fVar18 * fVar27 +
               fStack_134 + (0.0 - param_9[9]);
  fStack_15c = fVar43 * (float)local_178._0_4_ + (float)local_178._4_4_ * fVar20 + fVar18 * fVar5 +
               fStack_12c + (0.0 - param_9[0xb]);
  fStack_160 = fVar42 * (float)local_178._0_4_ + (float)local_178._4_4_ * fVar30 + fVar18 * fVar4 +
               fStack_130 + (0.0 - param_9[10]);
  do {
    ...
    local_178._0_4_ = auVar46._0_4_;
    local_178._4_4_ = auVar46._4_4_;
    fVar32 = (float)local_178._0_4_ * fVar40 + (float)local_178._4_4_ * fVar44 + fVar18 * fVar24 +
             local_138;
    fVar33 = (float)local_178._0_4_ * fVar41 + (float)local_178._4_4_ * fVar45 + fVar18 * fVar27 +
             fStack_134;
    fVar34 = (float)local_178._0_4_ * fVar42 + (float)local_178._4_4_ * fVar30 + fVar18 * fVar4 +
             fStack_130;
    fVar35 = (float)local_178._0_4_ * fVar43 + (float)local_178._4_4_ * fVar20 + fVar18 * fVar5 +
             fStack_12c;
...
LAB_001048b8:
    ...
    fVar19 = ((fVar38 - (fVar25 - fVar34)) * fStack_160 +
             (fVar37 - (fVar22 - fVar33)) * fStack_164 +
             (fVar36 - (fVar18 - fVar32)) * local_168 + 0.0) - SQRT(fVar39) * fVar29;
    if (0.0 < fVar19) {
      fVar31 = (float)((ulong)param_1_00 >> 0x20);
      fVar23 = fStack_160 * (float)param_2 +
               fStack_164 * fVar31 + local_168 * (float)param_1_00 + 0.0;
      if (fVar23 < 0.0) {
...
LAB_001049cd:
            ...
            do {
              ...
              pauVar10 = pauVar14 + 1;
              *(float *)*pauVar14 =
                   fVar36 - (*(float *)(pauVar14[10] + 8) - *(float *)(pauVar14[5] + 4));
            ...
            } while ((undefined1 (*) [12])((long)iVar17 * 0x10 + (long)param_1) !=
                     (undefined1 (*) [12])(*pauVar10 + 4));
            ...
            if (iVar17 == 2) {
              ...
              if (fVar30 < _LC2) {
                if (fStack_150 * fStack_150 + fStack_154 * fStack_154 + local_158 * local_158 + 0.0
                    <= (float)uStack_170 * (float)uStack_170 +
                       (float)local_178._0_4_ * (float)local_178._0_4_ + 0.0 +
                       (float)local_178._4_4_ * (float)local_178._4_4_) {
                  fVar20 = 0.0;
                  fVar30 = _LC3;
                }
                else {
                ...
                fVar30 = (float)((uint)(fVar27 * (float)uStack_170 +
                                       fVar24 * (float)local_178._4_4_ +
                                       fVar20 * (float)local_178._0_4_ + 0.0) ^ __LC4) / fVar30;
                fVar20 = _LC3 - fVar30;
              }
              fVar40 = *(float *)(param_1[10] + 8) * fVar20 + *(float *)param_1[0xc] * fVar30 +
                       fVar40;
              fVar41 = *(float *)param_1[0xb] * fVar20 + *(float *)(param_1[0xc] + 4) * fVar30 +
                       fVar41;
              fVar42 = *(float *)(param_1[0xb] + 4) * fVar20 + *(float *)(param_1[0xc] + 8) * fVar30
                       + fVar42;
              param_5 = *(float *)(param_1[0xb] + 8) * fVar20 + *(float *)param_1[0xd] * fVar30 +
                        param_5;
              *param_12 = fVar40;
              param_12[1] = fVar41;
              param_12[2] = fVar42;
              param_12[3] = param_5;
              if (local_c0 <= 0.0) {
                fVar40 = (fVar20 * *(float *)(param_1[5] + 4) + fVar30 * *(float *)(param_1[6] + 8))
                         - fVar43;
                fVar41 = (fVar20 * *(float *)(param_1[5] + 8) + fVar30 * *(float *)param_1[7]) -
                         fVar44;
                fVar42 = (fVar20 * *(float *)param_1[6] + fVar30 * *(float *)(param_1[7] + 4)) -
                         fVar45;
                param_5 = (fVar20 * *(float *)(param_1[6] + 4) + fVar30 * *(float *)(param_1[7] + 8)
                          ) - param_4;
              }
              *param_11 = fVar40;
              param_11[1] = fVar41;
              ...
              *param_11 = fVar40;
              ...
              ClosestPoint::GetBaryCentricCoordinates
                         ...
                         *(undefined8 *)(param_1[1] + 4),*(undefined8 *)param_1[2],
                         *(undefined8 *)(param_1[2] + 8),*(undefined8 *)(param_1[3] + 4),&local_4c,
                         &local_48,&local_44);
              fVar40 = *(float *)(param_1[10] + 8) * local_4c + *(float *)param_1[0xc] * local_48 +
                       *(float *)(param_1[0xd] + 4) * local_44 + fVar40;
              fVar41 = *(float *)param_1[0xb] * local_4c + *(float *)(param_1[0xc] + 4) * local_48 +
                       *(float *)(param_1[0xd] + 8) * local_44 + fVar41;
              fVar42 = *(float *)(param_1[0xb] + 4) * local_4c +
                       *(float *)(param_1[0xc] + 8) * local_48 + *(float *)param_1[0xe] * local_44 +
                       fVar42;
              param_5 = *(float *)(param_1[0xb] + 8) * local_4c + *(float *)param_1[0xd] * local_48
                        + *(float *)(param_1[0xe] + 4) * local_44 + param_5;
              *param_12 = fVar40;
              param_12[1] = fVar41;
              param_12[2] = fVar42;
              param_12[3] = param_5;
              if (local_c0 <= 0.0) {
                fVar40 = (local_4c * *(float *)(param_1[5] + 4) +
                          local_48 * *(float *)(param_1[6] + 8) + local_44 * *(float *)param_1[8]) -
                         fVar43;
                fVar41 = (local_4c * *(float *)(param_1[5] + 8) + local_48 * *(float *)param_1[7] +
                         local_44 * *(float *)(param_1[8] + 4)) - fVar44;
                fVar42 = (local_4c * *(float *)param_1[6] + local_48 * *(float *)(param_1[7] + 4) +
                         local_44 * *(float *)(param_1[8] + 8)) - fVar45;
                param_5 = (local_4c * *(float *)(param_1[6] + 4) +
                           local_48 * *(float *)(param_1[7] + 8) + local_44 * *(float *)param_1[9])
                          - param_4;
              }
              *param_11 = fVar40;
              param_11[1] = fVar41;
      ...
      *(undefined4 *)param_1[0x10] = 1;
      ...
      do {
        ...
        *(float *)pauVar14[1] = fStack_14c - (fVar31 - fVar6);
        pauVar14 = (undefined1 (*) [12])(*pauVar10 + 4);
      } while ((undefined1 (*) [12])(*pauVar10 + 4) !=
               (undefined1 (*) [12])((long)param_1 + lVar15 * 0x10 + 0x10));
      if (iVar17 == 3) {
        ClosestPoint::GetClosestPointOnTriangle<false>
                  (*(undefined8 *)*param_1,*(undefined8 *)(*param_1 + 8),
                   *(undefined8 *)(param_1[1] + 4),*(undefined8 *)param_1[2],
                   *(undefined8 *)(param_1[2] + 8),*(undefined8 *)(param_1[3] + 4),&local_44);
...
LAB_00104ff1:
            ...
            fVar31 = (float)((uint)(fVar26 * fStack_140 +
                                   fVar23 * fStack_144 + fVar19 * local_148 + 0.0) ^ __LC4) / fVar31
            ;
            if (0.0 < fVar31) {
              fVar19 = _LC3 - fVar31;
...
LAB_00104890:
        ...
        ClosestPoint::GetClosestPointOnTetrahedron<false>
                  (*(undefined8 *)*param_1,*(undefined8 *)(*param_1 + 8),
                   *(undefined8 *)(param_1[1] + 4),*(undefined8 *)param_1[2],
                   *(undefined8 *)(param_1[2] + 8),*(undefined8 *)(param_1[3] + 4),
                   *(undefined8 *)param_1[4],*(undefined8 *)(param_1[4] + 8),&local_44);
...
void JPH::CastConvexVsTriangles::_GLOBAL__sub_I_CastConvexVsTriangles(void)

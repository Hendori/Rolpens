...

{
  ...
  if (iVar3 == 0) {
    ...
    param_1[3] = *(long *)(lVar1 + 0x18);
    param_1[4] = lVar2;
    lVar2 = *(long *)(lVar1 + 0x30);
    param_1[5] = *(long *)(lVar1 + 0x28);
    param_1[6] = lVar2;
    lVar2 = *(long *)(lVar1 + 0x40);
    param_1[7] = *(long *)(lVar1 + 0x38);
    param_1[8] = lVar2;
          ...
          if (param_2[0x3f] == 0) {
            ...
            do {
              ...
              do {
                ...
                if (*pbVar7 == 0x65) {
                  if ((((pbVar7 + 3 < pbVar6) && (pbVar7[1] == 0x6e)) && (pbVar7[2] == 100)) &&
                     ((pbVar7[3] < 0x21 && ((0x100003601U >> ((ulong)pbVar7[3] & 0x3f) & 1) != 0))))
                  goto LAB_001008a8;
                }
...
LAB_00100b03:
              iVar10 = (*(code *)param_2[0x2e])(plVar2,uVar16 & 0xffffffff,pbVar7 + 1,uVar15);
              if (iVar10 != 0) goto LAB_00100a43;
...
LAB_001008a8:
            *(int *)(param_2 + 0x23) = iVar14;
            if (bVar8) {
              ...
              if ((iVar10 == 0) &&
                 (iVar10 = (*(code *)param_2[0x46])
                                     (plVar3,1,*(undefined8 *)param_2[0x35],
                                      *(undefined4 *)param_2[0x36]), iVar10 == 0)) {
                lVar13 = (long)local_5c;
                iVar10 = (*(code *)param_2[0x46])
                                   (plVar3,2,*(undefined8 *)(param_2[0x29] + lVar13 * 8),
                                    *(undefined4 *)(param_2[0x2a] + lVar13 * 4));
                if ((iVar10 == 0) &&
                   ((((iVar10 = (*(code *)param_2[0x46])
                                          (plVar3,3,*(undefined8 *)(param_2[0x35] + lVar13 * 8),
                                           *(undefined4 *)(param_2[0x36] + lVar13 * 4)), iVar10 == 0
                      && (iVar10 = (*(code *)param_2[0x2e])
                                             (plVar2,local_5c,*(undefined8 *)param_2[0x41],
                                              *(undefined4 *)param_2[0x42]), iVar10 == 0)) &&
                     (iVar10 = (*(code *)param_2[0x3a])
                                         (plVar1,local_5c,*(undefined8 *)(param_2[0x41] + 8),
                                          *(undefined4 *)(param_2[0x42] + 4)), iVar10 == 0)) &&
                    ((iVar10 = (*(code *)param_2[0x2e])
                                         (plVar2,0,*(undefined8 *)(param_2[0x41] + 0x10),
                                          *(undefined4 *)(param_2[0x42] + 8)), iVar10 == 0 &&
                     (iVar10 = (*(code *)param_2[0x3a])
                                         (plVar1,0,*(undefined8 *)(param_2[0x41] + 0x18),
                                          *(undefined4 *)(param_2[0x42] + 0xc)), iVar10 == 0)))))) {
                  return;
                }
              }
              goto LAB_00100a43;
...
long t42_get_name_index(long param_1,char *param_2)
...
LAB_001010c9:
            if (puVar10 == (undefined1 *)0x0) goto LAB_00100ffc;
          }
          uVar13 = uVar8;
          if ((((uVar8 & 1) == 0) || (uVar13 = uVar8 - 1, puVar10[uVar8 - 1] == '\0')) &&
             (uVar8 = uVar13, uVar13 == 0)) goto LAB_00100ffc;
...
LAB_00101146:
      ...
      *(undefined4 *)(param_2 + 3) = 3;
LAB_0010116f:
      ft_mem_free(lVar2,lVar9);
      *(undefined8 *)(param_1 + 0x318) = 0;
      *(undefined8 *)(param_1 + 800) = 0;
LAB_0010119e:
      if (bVar4) {
LAB_001011a6:
        ft_mem_free(lVar2,puVar10);
      }
      goto LAB_00100fc6;
    }
    *(int *)(param_2 + 3) = local_4c;
...

{
  ...
  *(long *)(param_2 + 0x310) = lVar20;
  ...
  if (iVar14 == 0) {
    ...
    if ((*plVar5 != 0x7572542d53502125 || plVar5[1] != 0x6e6f466570795465) ||
       ((char)plVar5[2] != 't')) {
      ...
      if (*pcVar25 != 'F') {
        ...
        if (local_270 == 0) {
          ...
          if (((int)((long)local_288 - (long)__s1) - 1U < 0x15) && (local_288 < pcVar24)) {
            ...
            do {
              pcVar6 = *ppuVar27;
              if ((((pcVar6 != (char *)0x0) && (pcVar25[1] == *pcVar6)) &&
                  (sVar22 = strlen(pcVar6), uVar28 == sVar22)) &&
                 (iVar16 = memcmp(__s1,pcVar6,uVar28), iVar16 == 0)) {
                ...
                if (*(int *)(&DAT_0010296c + lVar23) == 0xb) {
                  ...
                  if (*(int *)(&DAT_0010296c + lVar23) - 9U < 2) {
                    local_270 = (*local_200)(&local_288,&t42_keywords + (long)iVar14 * 6,local_2a8,0
                                             ,0);
                  }
                  else {
                    local_270 = (*local_208)();
...
LAB_00101ad3:
      ...
      if ((pcVar25 + 0x19 < pcVar24) && (iVar14 = strncmp(pcVar25,"FontDirectory",0xd), iVar14 == 0)
         ) {
        (*pcVar11)(&local_288);
        (*local_250)(&local_288);
        pcVar6 = local_288;
        ...
        while (pcVar25 < pcVar24) {
          local_288 = pcVar25;
          if (((*pcVar25 == 'k') && (pcVar25 + 5 < pcVar24)) &&
             (iVar14 = strncmp(pcVar25,"known",5), iVar14 == 0)) {
            if (pcVar25 < pcVar24) {
              (*local_248)(&local_288);
              ...
              do {
                ...
                if (iVar17 == 0) {
                  ...
                  *(char **)(lVar7 + lVar30 * 8) = pcVar24;
                  ...
                  if ((local_2c0 <= (int)lVar30) && (iVar16 = (int)lVar30 + 1, iVar18 == 0)) {
                    iVar16 = local_2c0;
                  }
                  break;
                }
...
LAB_001017f0:
  ...
  *(uint *)(param_2 + 0x92) =
       CONCAT22(*(undefined2 *)(param_2 + 0x12a),*(undefined2 *)(lVar23 + 0x92));
...

{
  ...
  if (pbVar13 < pbVar4) {
    ...
    if ((9 < (byte)(bVar2 - 0x30)) && (bVar2 != 0x5b)) {
      if ((pbVar13 + 0x11 < pbVar4) &&
         (iVar7 = strncmp((char *)pbVar13,"StandardEncoding",0x10), iVar7 == 0)) {
        *(undefined4 *)(param_1 + 0x220) = 2;
      }
      else if ((pbVar13 + 0xf < pbVar4) &&
              (iVar7 = strncmp((char *)pbVar13,"ExpertEncoding",0xe), iVar7 == 0)) {
        *(undefined4 *)(param_1 + 0x220) = 4;
      }
      else if ((pbVar13 + 0x12 < pbVar4) &&
              (iVar7 = strncmp((char *)pbVar13,"ISOLatin1Encoding",0x11), iVar7 == 0)) {
      ...
      *(undefined8 *)(param_1 + 0x238) = uVar9;
      if (local_44 == 0) {
        ...
        *(undefined8 *)(param_1 + 0x240) = uVar9;
        if ((local_44 == 0) &&
           (local_44 = (**(code **)*puVar3)(puVar1,local_74,uVar10), local_44 == 0)) {
          if (0 < local_74) {
            iVar7 = 0;
            do {
              iVar11 = iVar7 + 1;
            ...
            do {
              ...
              if (bVar2 != 100) {
                if (bVar2 != 0x5d) {
                  ...
                  if (pbVar13 != pbVar12) {
                    pbVar12 = pbVar13;
                    if (((pbVar4 <= pbVar13 + 2) || (*pbVar13 != 0x2f)) || (local_74 <= iVar7))
                    goto LAB_00102588;
                    goto LAB_001026d1;
                  }
LAB_00102740:
              ...
              pbVar13 = pbVar12 + 3;
              if (((pbVar13 < pbVar4) && (pbVar12[1] == 0x65)) &&
                 ((pbVar12[2] == 0x66 &&
                  ((pbVar12[3] < 0x21 && ((0x100003601U >> ((ulong)pbVar12[3] & 0x3f) & 1) != 0)))))
                 ) break;
LAB_001025b6:
              if (bVar6) {
LAB_001026a8:
                if (((pbVar4 <= pbVar12 + 2) || (*pbVar12 != 0x2f)) ||
                   (iVar11 = iVar7, local_74 <= iVar7)) goto LAB_00102740;
LAB_001026d1:
                pbVar12 = pbVar12 + 1;
                ...
                *(int *)(param_2 + 3) = iVar8;
                ...
                iVar7 = iVar7 + 1;
                *(undefined1 *)(*(long *)(param_2[0x1c] + (long)iVar11 * 8) + (uVar10 & 0xffffffff))
                     = 0;
              }
              else {
                (*(code *)param_2[8])(param_2);

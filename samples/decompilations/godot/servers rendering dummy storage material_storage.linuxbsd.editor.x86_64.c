...
/* RendererDummy::MaterialStorage::material_set_shader(RID, RID) */

void __thiscall
RendererDummy::MaterialStorage::material_set_shader
...

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x5b4))) {
    puVar1 = (undefined8 *)
             (*(long *)(*(long *)(this + 0x5a0) +
                       ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x5b0)) * 8) +
             ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x5b0)) * 0x18);
    iVar2 = *(int *)(puVar1 + 2);
  ...
  _err_print_error("material_set_shader","servers/rendering/dummy/storage/material_storage.cpp",0xfb
...
/* RendererDummy::MaterialStorage::material_set_next_pass(RID, RID) */

void __thiscall
RendererDummy::MaterialStorage::material_set_next_pass
          (MaterialStorage *this,ulong param_2,undefined8 param_3)

{
  ...
  _err_print_error("material_set_next_pass","servers/rendering/dummy/storage/material_storage.cpp",
                   0x102,"Parameter \"material\" is null.",0,0);
  return;
}



/* RendererDummy::MaterialStorage::material_free(RID) */

undefined1  [16] __thiscall
RendererDummy::MaterialStorage::material_free(MaterialStorage *this,ulong param_2)

{
  ...
  if (param_2 != 0) {
    if ((uint)param_2 < *(uint *)(this + 0x5b4)) {
      ...
      if (iVar1 == (int)(param_2 >> 0x20)) {
        if (iVar1 < 0) {
          lVar4 = 0;
          _err_print_error(&_LC11,"./core/templates/rid_owner.h",0x16c,"Method/function failed.",
          ...
          *(uint *)(this + 0x5b8) = uVar2;
          ...
          lVar4 = *(long *)(*(long *)(this + 0x5a8) +
                           ((ulong)uVar2 / (ulong)*(uint *)(this + 0x5b0)) * 8);
  ...
  auVar3 = _err_print_error("material_free","servers/rendering/dummy/storage/material_storage.cpp",
                            0xf4,"Parameter \"material\" is null.",0,0);
  return auVar3;
}
...
LAB_001015c6:
        if (pbVar15 != (byte *)0x0) goto LAB_001014b8;
        goto LAB_001015cf;
      }
      if (pbVar16 == (byte *)0x0) {
        puVar7 = *(uint **)(lVar8 + 0x10);
...
LAB_00101569:
        if (pbVar16 == (byte *)0x0) goto LAB_0010156e;
        goto LAB_00101516;
      }
      bVar11 = *pbVar17;
      uVar4 = (uint)(char)bVar11;
...
/* RendererDummy::MaterialStorage::material_initialize(RID) */

void __thiscall
RendererDummy::MaterialStorage::material_initialize(MaterialStorage *this,ulong param_2)
...
/* CowData<ShaderLanguage::Scalar>::_ref(CowData<ShaderLanguage::Scalar> const&) [clone .part.0] */

void __thiscall
CowData<ShaderLanguage::Scalar>::_ref(CowData<ShaderLanguage::Scalar> *this,CowData *param_1)
...
LAB_001025b4:
          if (lVar7 <= lVar12) goto LAB_00102650;
...
LAB_001026fe:
    local_70 = (StringName_conflict *)&local_68;
    lVar7 = lVar10 + -2 >> 1;
...
/* RendererDummy::MaterialStorage::global_shader_parameter_remove(StringName const&) */

void __thiscall
RendererDummy::MaterialStorage::global_shader_parameter_remove
          (MaterialStorage *this,StringName_conflict *param_1)

{
  ...
  uVar46 = 0;
  while ((uVar38 != uVar40 ||
         (lVar41 = *(long *)(*(long *)(*(long *)(this + 0x10) + lVar41 * 8) + 0x10),
         lVar41 != *(long *)param_1))) {
    uVar46 = uVar46 + 1;
    auVar10._8_8_ = 0;
  ...
  do {
    ...
    if ((uVar38 == uVar40) &&
      ...
      if ((uVar38 != 0) &&
         ...
         auVar19._0_8_ = (ulong)((uVar5 + uVar40) - SUB164(auVar18 * auVar32,8)) * lVar6,
         auVar33._8_8_ = 0, auVar33._0_8_ = uVar48, uVar37 = (ulong)uVar40, uVar44 = uVar43,
         SUB164(auVar19 * auVar33,8) != 0)) {
        while( true ) {
          uVar43 = uVar37;
          ...
          *puVar3 = uVar8;
          ...
          if ((uVar38 == 0) ||
             ...
             auVar21._0_8_ =
                  (ulong)((SUB164(auVar22 * auVar36,8) + uVar5) - SUB164(auVar20 * auVar34,8)) *
                  lVar6, auVar35._8_8_ = 0, auVar35._0_8_ = uVar48, SUB164(auVar21 * auVar35,8) == 0
             )) break;
    ...
    uVar46 = SUB164(auVar14 * auVar28,8);
          ...
          (auVar15._8_8_ = 0, auVar15._0_8_ = (ulong)uVar40 * lVar6, auVar29._8_8_ = 0,
          auVar29._0_8_ = uVar42, auVar16._8_8_ = 0,
          auVar16._0_8_ = (ulong)((uVar5 + uVar46) - SUB164(auVar15 * auVar29,8)) * lVar6,
          auVar30._8_8_ = 0, auVar30._0_8_ = uVar42, uVar47 <= SUB164(auVar16 * auVar30,8)));
  return;
}
...
/* RendererDummy::MaterialStorage::global_shader_parameter_get_type(StringName const&) const */

undefined4 __thiscall
RendererDummy::MaterialStorage::global_shader_parameter_get_type
          (MaterialStorage *this,StringName_conflict *param_1)

{
  ...
  if ((*(long *)(this + 0x10) != 0) && (*(int *)(this + 0x34) != 0)) {
    ...
    if (uVar29 != 0) {
      uVar29 = 0;
      while ((uVar22 != (uint)uVar27 ||
             (lVar25 = *(long *)(*(long *)(*(long *)(this + 0x10) + lVar25 * 8) + 0x10),
             lVar25 != *(long *)param_1))) {
        uVar29 = uVar29 + 1;
        auVar5._8_8_ = 0;
        ...
        if ((uVar24 == 0) ||
           (auVar6._8_8_ = 0, auVar6._0_8_ = uVar27 * lVar3, auVar14._8_8_ = 0,
      ...
      uVar26 = 0;
      while ((uVar22 != uVar29 ||
             (*(long *)(*(long *)(*(long *)(this + 0x10) + lVar25 * 8) + 0x10) != *(long *)param_1))
            ) {
        uVar26 = uVar26 + 1;
        auVar9._8_8_ = 0;
        ...
        if ((uVar29 == 0) ||
           (auVar10._8_8_ = 0, auVar10._0_8_ = (ulong)uVar29 * lVar3, auVar18._8_8_ = 0,
           auVar18._0_8_ = uVar28, auVar11._8_8_ = 0,
           auVar11._0_8_ = (ulong)((uVar2 + uVar24) - SUB164(auVar10 * auVar18,8)) * lVar3,
           auVar19._8_8_ = 0, auVar19._0_8_ = uVar28, SUB164(auVar11 * auVar19,8) < uVar26)) {
LAB_00103a20:
...
LAB_001039c0:
  Variant::Variant((Variant *)local_58,"don\'t have name, sorry");
...
void __thiscall
RendererDummy::MaterialStorage::material_get_instance_shader_parameters
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x5b4))) {
    puVar2 = (ulong *)(*(long *)(*(long *)(this + 0x5a0) +
                                ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x5b0)) * 8) +
                      ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x5b0)) * 0x18);
    if ((int)puVar2[2] == (int)(param_2 >> 0x20)) {
      uVar5 = *puVar2;
      if ((uVar5 != 0) && ((uint)uVar5 < *(uint *)(this + 0x54))) {
        lVar3 = *(long *)(*(long *)(this + 0x40) +
                         ((uVar5 & 0xffffffff) / (ulong)*(uint *)(this + 0x50)) * 8) +
                ((uVar5 & 0xffffffff) % (ulong)*(uint *)(this + 0x50)) * 0x38;
...
LAB_00103d77:
              ...
              ShaderLanguage::constant_value_to_variant
                        (local_b8,plVar15 + 7,(int)plVar15[5],(int)plVar15[6],
              ...
              *puVar12 = (undefined4)local_98;
              ...
              StringName::operator=
                        ((StringName_conflict *)(puVar12 + 4),(StringName_conflict *)(local_90 + 8))
              ;
...
LAB_00103fa8:
  ...
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    _err_print_error("material_get_instance_shader_parameters",
                     "servers/rendering/dummy/storage/material_storage.cpp",0x109,
                     "Parameter \"material\" is null.",0,0);
    return;
  }
LAB_001042de:
...
/* RendererDummy::MaterialStorage::global_shader_parameters_load_settings(bool) */

void RendererDummy::MaterialStorage::global_shader_parameters_load_settings(bool param_1)
...
joined_r0x00104349:
    if (lVar4 != 0) {
      ...
      if (cVar14 != '\0') {
        ...
        if (cVar14 != '\0') {
          ...
          if (cVar14 == '\0') {
            _err_print_error("global_shader_parameters_load_settings",
                             "servers/rendering/dummy/storage/material_storage.cpp",0x5c,
          ...
          uVar19 = 0;
          do {
            cVar14 = operator==((&global_shader_parameters_load_settings(bool)::
                                  global_var_type_names)[uVar19],(String *)&local_60);
            if (cVar14 != '\0') {
          ...
          _err_print_error("global_shader_parameters_load_settings",
                           "servers/rendering/dummy/storage/material_storage.cpp",0x89,
        ...
        _err_print_error("global_shader_parameters_load_settings",
                         "servers/rendering/dummy/storage/material_storage.cpp",0x5b,
  ...
  while( true ) {
    ...
    if ((uVar20 == 0) ||
       (auVar8._8_8_ = 0, auVar8._0_8_ = (ulong)uVar20 * lVar5, auVar12._8_8_ = 0,
       auVar12._0_8_ = uVar22, auVar9._8_8_ = 0,
       auVar9._0_8_ = (ulong)((uVar3 + iVar17) - SUB164(auVar8 * auVar12,8)) * lVar5,
       auVar13._8_8_ = 0, auVar13._0_8_ = uVar22, SUB164(auVar9 * auVar13,8) < uVar23)) break;
LAB_00104609:
    if ((uVar20 == uVar15) && (*(long *)(*(long *)(plVar21[2] + lVar18 * 8) + 0x10) == local_70))
    goto LAB_00104620;
  }
LAB_001046ca:
  ...
  local_58 = 0;
  (**(code **)(*plVar21 + 0x10))
            (plVar21,(StringName_conflict *)&local_70,uVar19 & 0xffffffff,
             (StringName_conflict *)&local_58);
  if (Variant::needs_deinit[(int)local_58] != '\0') {
    Variant::_clear_internal();
  }
LAB_00104620:
...
void RendererDummy::MaterialStorage::global_shader_parameter_add
               (long param_1,StringName_conflict *param_2,undefined4 param_3)

{
  ...
  if ((*(long *)(param_1 + 0x10) != 0) && (*(int *)(param_1 + 0x34) != 0)) {
    ...
    if (uVar15 != 0) {
      ...
      do {
        if ((uVar11 == uVar15) &&
           (*(long *)(*(long *)(*(long *)(param_1 + 0x10) + lVar14 * 8) + 0x10) == *(long *)param_2)
           ) {
          _err_print_error("global_shader_parameter_add",
                           "servers/rendering/dummy/storage/material_storage.cpp",0x33,
                           "Condition \"global_shader_variables.has(p_name)\" is true.",0,0);
          return;
        }
        uVar17 = uVar17 + 1;
        auVar4._8_8_ = 0;
  ...
  puVar12 = (undefined4 *)
            HashMap<StringName,RenderingServer::GlobalShaderParameterType,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,RenderingServer::GlobalShaderParameterType>>>
            ::operator[]((HashMap<StringName,RenderingServer::GlobalShaderParameterType,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,RenderingServer::GlobalShaderParameterType>>>
                          *)(param_1 + 8),param_2);
  *puVar12 = param_3;
  return;
}
...
/* RendererDummy::MaterialStorage::shader_allocate() */

void __thiscall RendererDummy::MaterialStorage::shader_allocate(MaterialStorage *this)

{
  RID_Alloc<RendererDummy::MaterialStorage::DummyShader,false>::allocate_rid
            ((RID_Alloc<RendererDummy::MaterialStorage::DummyShader,false> *)(this + 0x38));
  return;
}



/* RendererDummy::MaterialStorage::material_allocate() */

void __thiscall RendererDummy::MaterialStorage::material_allocate(MaterialStorage *this)

{
  RID_Alloc<RendererDummy::MaterialStorage::DummyMaterial,false>::allocate_rid
            ((RID_Alloc<RendererDummy::MaterialStorage::DummyMaterial,false> *)(this + 0x598));
  return;
}



/* RendererDummy::MaterialStorage::shader_set_code(RID, String const&) */

void __thiscall
RendererDummy::MaterialStorage::shader_set_code(MaterialStorage *this,ulong param_2,long *param_3)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x54))) {
    lVar3 = *(long *)(*(long *)(this + 0x40) +
            ...
            ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x50)) * 0x38;
    ...
    if (iVar5 == (int)(param_2 >> 0x20)) {
      if ((*param_3 != 0) && (1 < *(uint *)(*param_3 + -8))) {
        ...
        if (cVar4 == '\0') {
          ...
          operator+((char *)&local_1f0,(String *)"Shader type ");
          pSVar6 = (String *)&local_1d8;
          String::operator+((String *)&local_1d8,(String *)&local_1f0);
          _err_print_error("shader_set_code","servers/rendering/dummy/storage/material_storage.cpp",
                           0xb7,"Method/function failed.",(String *)&local_1d8,0,0,pSVar6);
...
LAB_00104a72:
          ...
          iVar5 = ShaderCompiler::compile
                            (lVar2,uVar7,param_3,(IdentifierActions *)&local_1d8,
                             (StrRange *)&local_1f0,local_d8);
          lVar3 = local_1f0;
          if (local_1f0 != 0) {
            LOCK();
          ...
          if (iVar5 == 0) {
            ...
            _err_print_error("shader_set_code",
                             "servers/rendering/dummy/storage/material_storage.cpp",0xbe,
  ...
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    _err_print_error("shader_set_code","servers/rendering/dummy/storage/material_storage.cpp",0xa3,
...
/* RendererDummy::MaterialStorage::shader_free(RID) */

void __thiscall RendererDummy::MaterialStorage::shader_free(MaterialStorage *this,ulong param_2)
...
LAB_001050d4:
    _err_print_error("shader_free","servers/rendering/dummy/storage/material_storage.cpp",0x9c,
                     "Parameter \"shader\" is null.",0,0);
    return;
  }
...
LAB_0010505f:
  ...
  *(uint *)(*(long *)(*(long *)(this + 0x48) + ((ulong)uVar6 / (ulong)*(uint *)(this + 0x50)) * 8) +
           ((ulong)uVar6 % (ulong)*(uint *)(this + 0x50)) * 4) = (uint)param_2;
  return;
}



/* RendererDummy::MaterialStorage::~MaterialStorage() */

void __thiscall RendererDummy::MaterialStorage::~MaterialStorage(MaterialStorage *this)

{
  ...
  *(undefined ***)(this + 0x598) = &PTR__RID_Alloc_0010caa8;
  ...
  if (*(long *)(this + 0x578) != 0) {
    LOCK();
    plVar1 = (long *)(*(long *)(this + 0x578) + -0x10);
    *plVar1 = *plVar1 + -1;
    UNLOCK();
    if (*plVar1 == 0) {
      lVar6 = *(long *)(this + 0x578);
...
LAB_00105779:
  ...
  if (pvVar7 != (void *)0x0) {
    if ((*(int *)(this + 0x4a4) != 0) &&
       ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x4a0) * 4) == 0 ||
        (memset(*(void **)(this + 0x498),0,
                (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x4a0) * 4) * 4),
        *(int *)(this + 0x4a4) != 0)))) {
      lVar6 = 0;
      do {
...
LAB_00105816:
  ...
  if (pvVar7 != (void *)0x0) {
    if ((*(int *)(this + 0x47c) != 0) &&
       ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x478) * 4) == 0 ||
        (memset(*(void **)(this + 0x470),0,
                (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x478) * 4) * 4),
        *(int *)(this + 0x47c) != 0)))) {
      lVar6 = 0;
      do {
        if ((StringName::configured != '\0') && (*(long *)((long)pvVar7 + lVar6 * 8) != 0)) {
...
LAB_001058ae:
  ...
  if (pvVar7 != (void *)0x0) {
    if ((*(int *)(this + 0x454) != 0) &&
       ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x450) * 4) == 0 ||
        (memset(*(void **)(this + 0x448),0,
                (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x450) * 4) * 4),
        *(int *)(this + 0x454) != 0)))) {
      lVar6 = 0;
      do {
        if ((StringName::configured != '\0') && (*(long *)((long)pvVar7 + lVar6 * 8) != 0)) {
...
LAB_0010594e:
  ...
  if (pvVar7 != (void *)0x0) {
    if ((*(int *)(this + 0x42c) != 0) &&
       ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x428) * 4) == 0 ||
        (memset(*(void **)(this + 0x420),0,
                (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x428) * 4) * 4),
        *(int *)(this + 0x42c) != 0)))) {
      lVar6 = 0;
      do {
        if ((StringName::configured != '\0') && (*(long *)((long)pvVar7 + lVar6 * 8) != 0)) {
...
LAB_001059ee:
  ...
  if (pvVar7 != (void *)0x0) {
    if ((*(int *)(this + 0x404) != 0) &&
       ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x400) * 4) == 0 ||
        (memset(*(void **)(this + 0x3f8),0,
                (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x400) * 4) * 4),
        *(int *)(this + 0x404) != 0)))) {
      lVar6 = 0;
      do {
        if ((StringName::configured != '\0') && (*(long *)((long)pvVar7 + lVar6 * 8) != 0)) {
...
LAB_00105a8e:
  ...
  if (pvVar7 != (void *)0x0) {
    if ((*(int *)(this + 0x3dc) != 0) &&
       ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x3d8) * 4) == 0 ||
        (memset(*(void **)(this + 0x3d0),0,
                (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x3d8) * 4) * 4),
        *(int *)(this + 0x3dc) != 0)))) {
      lVar6 = 0;
      do {
        if ((StringName::configured != '\0') && (*(long *)((long)pvVar7 + lVar6 * 8) != 0)) {
...
LAB_00105b2e:
  if ((StringName::configured != '\0') &&
     (((*(long *)(this + 0x3b0) == 0 || (StringName::unref(), StringName::configured != '\0')) &&
      (*(long *)(this + 0x3a8) != 0)))) {
    StringName::unref();
  }
  ShaderLanguage::~ShaderLanguage((ShaderLanguage *)(this + 0x90));
  RID_Alloc<RendererDummy::MaterialStorage::DummyShader,false>::~RID_Alloc
            ((RID_Alloc<RendererDummy::MaterialStorage::DummyShader,false> *)(this + 0x38));
...
/* RendererDummy::MaterialStorage::global_shader_parameter_get_list() const */

void RendererDummy::MaterialStorage::global_shader_parameter_get_list(void)
      ...
      if (iVar2 == 0) {
        if (*(long *)(in_RDI + 8) == 0) {
          ...
          if (-1 < lVar6) {
            ...
            StringName::operator=
                      ((StringName_conflict *)(*(long *)(in_RDI + 8) + lVar6 * 8),
                       (StringName_conflict *)&local_48);
            goto LAB_0010618f;
          }
        }
    ...
    if ((*(long *)(in_RDI + 8) != 0) && (lVar5 = *(long *)(*(long *)(in_RDI + 8) + -8), lVar5 != 0))
    {
      ...
      if (lVar5 != 1) {
        ...
        if (lVar5 < 0x11) {
          ...
          do {
            lVar6 = lVar6 + -1;
            pSVar3 = (StringName_conflict *)
                     SortArray<StringName,StringName::AlphCompare,true>::median_of_3
                               (pSVar1,pSVar1 + (lVar8 >> 1) * 8,pSVar1 + lVar8 * 8 + -8);
            StringName::StringName((StringName_conflict *)&local_48,pSVar3);
            lVar7 = SortArray<StringName,StringName::AlphCompare,true>::partitioner
                              (0,lVar8,(StringName_conflict *)&local_48,pSVar1);
            if ((StringName::configured != '\0') && (local_48 != 0)) {
              StringName::unref();
            }
...
LAB_00106350:
          ...
          do {
            ...
            SortArray<StringName,StringName::AlphCompare,true>::unguarded_linear_insert
                      (lVar6,(StringName_conflict *)&local_48,pSVar1);
            if ((StringName::configured != '\0') && (local_48 != 0)) {
              StringName::unref();
            }
            lVar6 = lVar6 + 1;
...
LAB_0010680f:
  if ((void *)local_c0._0_8_ != (void *)0x0) {
...
LAB_001068f6:
  if ((void *)local_f0._0_8_ != (void *)0x0) {
...
void __thiscall
RendererDummy::MaterialStorage::get_shader_parameter_list
          (MaterialStorage *this,ulong param_2,long *param_3)

{
  ...
  *this_00;
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x54))) {
    this_00 = (HashMap<StringName,ShaderLanguage::ShaderNode::Uniform,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ShaderLanguage::ShaderNode::Uniform>>>
               *)(*(long *)(*(long *)(this + 0x40) +
                           ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x50)) * 8) +
                 ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x50)) * 0x38);
    if (*(int *)(this_00 + 0x30) == (int)(param_2 >> 0x20)) {
      ...
      if (plVar17 != (long *)0x0) {
        do {
          if ((int)plVar17[9] == 0) {
            StringName::StringName
                      ((StringName_conflict *)&local_88,(StringName_conflict *)(plVar17 + 2));
            StringName::StringName
                      ((StringName_conflict *)&local_78,(StringName_conflict *)&local_88);
            ...
            StringName::StringName
                      ((StringName_conflict *)(local_f8 + uVar12 * 0x10),
                       (StringName_conflict *)&local_78);
            ...
            if (lVar8 < 0x11) {
              ...
              do {
                ...
                if (*(int *)(pSVar16 + 8) < *(int *)(local_f8 + 8)) {
                  ...
                  StringName::operator=
                            ((StringName_conflict *)local_f8,(StringName_conflict *)&local_78);
...
LAB_00107222:
                  ...
                  StringName::StringName
                            ((StringName_conflict *)&local_88,(StringName_conflict *)&local_78);
...
LAB_0010785f:
                  StringName::operator=(pSVar14,(StringName_conflict *)&local_88);
                  bVar22 = StringName::configured != '\0';
...
LAB_00107122:
                  StringName::operator=(pSVar20,(StringName_conflict *)&local_88);
                  bVar22 = StringName::configured != '\0';
...
LAB_00106fb2:
                StringName::operator=(pSVar20,(StringName_conflict *)&local_78);
                bVar22 = StringName::configured != '\0';
          ...
          pPVar18 = local_f8;
LAB_001076fe:
          lVar8 = HashMap<StringName,ShaderLanguage::ShaderNode::Uniform,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ShaderLanguage::ShaderNode::Uniform>>>
                  ::operator[](this_00,(StringName_conflict *)pPVar18);
          local_98 = 0;
...
LAB_00107746:
          if ((*(long *)(lVar8 + 0x70) != 0) && (1 < *(uint *)(*(long *)(lVar8 + 0x70) + -8))) {
            operator+((char *)local_100,(String *)&_LC96);
...
LAB_00107336:
            ...
            *puVar9 = (undefined4)local_78;
            ...
            StringName::operator=
                      ((StringName_conflict *)(puVar9 + 4),(StringName_conflict *)(local_70 + 8));
...
LAB_00107b50:
  ...
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    _err_print_error("get_shader_parameter_list",
                     "servers/rendering/dummy/storage/material_storage.cpp",0xc3,
                     "Parameter \"shader\" is null.",0,0);
    return;
  }
LAB_00107c4f:
  ...
  __stack_chk_fail();
code_r0x001076ed:
  pPVar18 = (Pair_conflict *)((StringName_conflict *)pPVar18 + 0x10);
  if (local_bc <= uVar15) {
    _err_print_index_error
              ("operator[]","./core/templates/local_vector.h",0xb2,(ulong)uVar15,(ulong)local_bc,
...
/* RendererDummy::MaterialStorage::shader_initialize(RID) */

undefined1  [16] __thiscall
RendererDummy::MaterialStorage::shader_initialize(MaterialStorage *this,ulong param_2)

{
  ...
  auVar6 = _err_print_error("initialize_rid","./core/templates/rid_owner.h",0x128,
                            "Parameter \"mem\" is null.",0,0);
  return auVar6;
}
...
/* RendererDummy::MaterialStorage::global_shader_parameter_set(StringName const&, Variant const&) */

void RendererDummy::MaterialStorage::global_shader_parameter_set
               (StringName_conflict *param_1,Variant *param_2)
...
void RendererDummy::MaterialStorage::global_shader_parameter_set_override
               (StringName_conflict *param_1,Variant *param_2)
...
/* RendererDummy::MaterialStorage::global_shader_parameter_get(StringName const&) const */

StringName_conflict *
RendererDummy::MaterialStorage::global_shader_parameter_get(StringName_conflict *param_1)
...
/* RendererDummy::MaterialStorage::global_shader_parameters_clear() */

void RendererDummy::MaterialStorage::global_shader_parameters_clear(void)
...
/* RendererDummy::MaterialStorage::global_shader_parameters_instance_allocate(RID) */

undefined8 RendererDummy::MaterialStorage::global_shader_parameters_instance_allocate(void)
...
/* RendererDummy::MaterialStorage::global_shader_parameters_instance_free(RID) */

void RendererDummy::MaterialStorage::global_shader_parameters_instance_free(void)
...
void RendererDummy::MaterialStorage::global_shader_parameters_instance_update(void)
...
/* RendererDummy::MaterialStorage::shader_set_path_hint(RID, String const&) */

void RendererDummy::MaterialStorage::shader_set_path_hint(void)
...
void RendererDummy::MaterialStorage::shader_set_default_texture_parameter(void)
...
undefined8 RendererDummy::MaterialStorage::shader_get_default_texture_parameter(void)
...
/* RendererDummy::MaterialStorage::shader_get_parameter_default(RID, StringName const&) const */

undefined4 * RendererDummy::MaterialStorage::shader_get_parameter_default(undefined4 *param_1)
...
/* RendererDummy::MaterialStorage::shader_get_native_source_code(RID) const */

long RendererDummy::MaterialStorage::shader_get_native_source_code(long param_1)
...
/* RendererDummy::MaterialStorage::material_set_render_priority(RID, int) */

void RendererDummy::MaterialStorage::material_set_render_priority(void)
...
/* RendererDummy::MaterialStorage::material_set_param(RID, StringName const&, Variant const&) */

void RendererDummy::MaterialStorage::material_set_param(void)
...
/* RendererDummy::MaterialStorage::material_get_param(RID, StringName const&) const */

undefined4 * RendererDummy::MaterialStorage::material_get_param(undefined4 *param_1)
...
/* RendererDummy::MaterialStorage::material_is_animated(RID) */

undefined8 RendererDummy::MaterialStorage::material_is_animated(void)
...
/* RendererDummy::MaterialStorage::material_casts_shadows(RID) */

undefined8 RendererDummy::MaterialStorage::material_casts_shadows(void)
...
/* RendererDummy::MaterialStorage::material_get_cull_mode(RID) const */

undefined8 RendererDummy::MaterialStorage::material_get_cull_mode(void)
...
/* RendererDummy::MaterialStorage::material_update_dependency(RID, DependencyTracker*) */

void RendererDummy::MaterialStorage::material_update_dependency(void)
...
/* RendererDummy::MaterialStorage::shader_get_code(RID) const */

StrRange * RendererDummy::MaterialStorage::shader_get_code(StrRange *param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashMap<StringName, RenderingServer::GlobalShaderParameterType, HashMapHasherDefault,
   HashMapComparatorDefault<StringName>, DefaultTypedAllocator<HashMapElement<StringName,
   RenderingServer::GlobalShaderParameterType> > >::operator[](StringName const&) */
...
LAB_00108f73:
    if ((float)uVar40 * __LC39 < (float)(iVar46 + 1)) goto LAB_00108f99;
  }
  ...
  *puVar42 = 0;
  puVar42[1] = 0;
  StringName::StringName((StringName_conflict *)(puVar42 + 2),(StringName_conflict *)&local_58);
...
/* WARNING: Removing unreachable block (ram,0x00109a59) */
/* WARNING: Removing unreachable block (ram,0x001098ec) */
/* WARNING: Removing unreachable block (ram,0x001098f6) */
/* WARNING: Removing unreachable block (ram,0x00109a3b) */
/* WARNING: Removing unreachable block (ram,0x00109902) */
/* WARNING: Removing unreachable block (ram,0x0010990c) */
/* WARNING: Removing unreachable block (ram,0x00109a1d) */
/* WARNING: Removing unreachable block (ram,0x00109918) */
/* WARNING: Removing unreachable block (ram,0x00109922) */
/* WARNING: Removing unreachable block (ram,0x001099ff) */
/* WARNING: Removing unreachable block (ram,0x0010992e) */
/* WARNING: Removing unreachable block (ram,0x00109938) */
/* WARNING: Removing unreachable block (ram,0x001099e1) */
/* WARNING: Removing unreachable block (ram,0x00109944) */
/* WARNING: Removing unreachable block (ram,0x0010994e) */
/* WARNING: Removing unreachable block (ram,0x001099c3) */
/* WARNING: Removing unreachable block (ram,0x00109956) */
/* WARNING: Removing unreachable block (ram,0x00109960) */
/* WARNING: Removing unreachable block (ram,0x001099a8) */
/* WARNING: Removing unreachable block (ram,0x00109968) */
/* WARNING: Removing unreachable block (ram,0x0010997e) */
/* WARNING: Removing unreachable block (ram,0x0010998a) */
...
/* RID_Alloc<RendererDummy::MaterialStorage::DummyMaterial, false>::~RID_Alloc() */

void __thiscall
RID_Alloc<RendererDummy::MaterialStorage::DummyMaterial,false>::~RID_Alloc
          (RID_Alloc<RendererDummy::MaterialStorage::DummyMaterial,false> *this)
...
ulong __thiscall
RID_Alloc<RendererDummy::MaterialStorage::DummyShader,false>::allocate_rid
          (RID_Alloc<RendererDummy::MaterialStorage::DummyShader,false> *this)

{
  ...
  if (uVar10 != 0x7fffffff) {
    ...
    *(uint *)(*(long *)(*(long *)(this + 8) + ((ulong)uVar3 / (ulong)uVar8) * 8) +
              ((ulong)uVar3 % (ulong)uVar8) * 0x38 + 0x30) = uVar10 | 0x80000000;
...

{
  ...
  if (uVar10 != 0x7fffffff) {
    RID_AllocBase::base_id = RID_AllocBase::base_id + 1;
    *(uint *)(*(long *)(*(long *)(this + 8) + ((ulong)uVar3 / (ulong)uVar8) * 8) +
              ((ulong)uVar3 % (ulong)uVar8) * 0x18 + 0x10) = uVar10 | 0x80000000;
    *(int *)(this + 0x20) = *(int *)(this + 0x20) + 1;
    return CONCAT44(uVar9,uVar3) & 0x7fffffffffffffff;
  }
  RID_AllocBase::base_id = RID_AllocBase::base_id + 1;
...
/* ShaderCompiler::GeneratedCode::~GeneratedCode() */

void __thiscall ShaderCompiler::GeneratedCode::~GeneratedCode(GeneratedCode *this)
...
LAB_0010a78b:
    if ((uint)uVar4 < uVar8) goto LAB_0010a7cb;
    lVar7 = 0;
    while( true ) {
    ...
    vformat<unsigned_int,char_const*>
              ((String *)&local_58,(uint)(StrRange *)&local_60,(char *)(ulong)uVar8);
...
LAB_0010b159:
    if ((float)uVar23 * __LC39 < (float)(iVar28 + 1)) goto LAB_0010b17b;
  }
...
/* HashMap<StringName, ShaderLanguage::ShaderNode::Uniform, HashMapHasherDefault,
   HashMapComparatorDefault<StringName>, DefaultTypedAllocator<HashMapElement<StringName,
   ShaderLanguage::ShaderNode::Uniform> > >::_resize_and_rehash(unsigned int) */
...
/* HashMap<StringName, ShaderLanguage::ShaderNode::Uniform, HashMapHasherDefault,
   HashMapComparatorDefault<StringName>, DefaultTypedAllocator<HashMapElement<StringName,
   ShaderLanguage::ShaderNode::Uniform> > >::operator[](StringName const&) */
...

{
  ...
  uVar46 = CONCAT44(0,uVar33);
  if ((lVar36 != 0) && (*(int *)(this + 0x2c) != 0)) {
    ...
    if (uVar32 != 0) {
      ...
      do {
        if ((uVar32 == uVar31) &&
           (*(long *)(*(long *)(lVar36 + lVar38 * 8) + 0x10) == *(long *)param_1)) {
        ...
        uVar42 = SUB164(auVar5 * auVar17,8);
              ...
              (auVar6._8_8_ = 0, auVar6._0_8_ = (ulong)uVar32 * lVar39, auVar18._8_8_ = 0,
              auVar18._0_8_ = uVar46, auVar7._8_8_ = 0,
              auVar7._0_8_ = (ulong)((uVar42 + uVar33) - SUB164(auVar6 * auVar18,8)) * lVar39,
              auVar19._8_8_ = 0, auVar19._0_8_ = uVar46, uVar44 <= SUB164(auVar7 * auVar19,8)));
    }
  }
  uVar30 = _LC88;
  local_130[2] = 0x600000000;
  local_110 = 0x3f800000;
  uStack_10c = 0x3a83126f;
  uVar33 = *(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x28) * 4);
  local_130[0] = 0;
  local_130[1] = 0;
  local_118 = 2;
...
LAB_0010bb23:
    if (*(int *)(this + 0x28) == 0x1c) {
      ...
      lVar36 = 0;
LAB_0010bab3:
      local_160 = (undefined8 *)(lVar36 + 0x18);
      goto LAB_0010babc;
    }
      ...
      if (uVar42 != 0) {
        do {
          if ((uVar42 == uVar32) &&
            ...
            *(undefined1 (*) [16])(lVar36 + 0x18) = (undefined1  [16])0x0;
            if (*(long *)(lVar36 + 0x40) != 0) {
              CowData<ShaderLanguage::Scalar>::_ref
                        ((CowData<ShaderLanguage::Scalar> *)(lVar36 + 0x40),(CowData *)local_130);
            }
            uVar30 = _LC89;
            ...
            *(undefined4 *)(lVar36 + 0x78) = 0;
            ...
            if (*(long *)(lVar36 + 0x88) != 0) {
              CowData<char32_t>::_ref
                        ((CowData<char32_t> *)(lVar36 + 0x88),(CowData *)(local_f0 + 8));
            }
            lVar36 = *(long *)(*(long *)(this + 8) + (ulong)uVar44 * 8);
            goto LAB_0010bab3;
          }
          ...
          uVar44 = SUB164(auVar9 * auVar21,8);
                ...
                (auVar10._8_8_ = 0, auVar10._0_8_ = (ulong)uVar42 * lVar36, auVar22._8_8_ = 0,
                auVar22._0_8_ = uVar46, auVar11._8_8_ = 0,
                auVar11._0_8_ = (ulong)((uVar31 + uVar44) - SUB164(auVar10 * auVar22,8)) * lVar36,
                auVar23._8_8_ = 0, auVar23._0_8_ = uVar46, uVar45 <= SUB164(auVar11 * auVar23,8)));
      }
      iVar37 = *(int *)(this + 0x2c);
    }
LAB_0010bb01:
    if ((float)uVar33 * __LC39 < (float)(iVar37 + 1)) goto LAB_0010bb23;
  }
  local_d8 = (undefined1  [16])0x0;
  StringName::StringName((StringName_conflict *)&local_c8,param_1);
  local_c0 = (undefined1  [16])0x0;
  local_84 = _LC89;
  local_7c = CONCAT44(local_110,uStack_114);
  local_58 = (undefined1  [16])0x0;
  local_b0 = uVar30;
  local_a8 = 0;
  local_98 = 0;
  ...
  local_68 = 0;
  local_60 = 0;
  puVar34 = (undefined8 *)operator_new(0x90,"");
  *puVar34 = local_d8._0_8_;
  puVar34[1] = local_d8._8_8_;
  StringName::StringName((StringName_conflict *)(puVar34 + 2),(StringName_conflict *)&local_c8);
  local_160 = puVar34 + 3;
  puVar34[8] = 0;
  puVar34[3] = local_c0._0_8_;
  puVar34[4] = local_c0._8_8_;
  puVar34[5] = local_b0;
  *(undefined4 *)(puVar34 + 6) = local_a8;
  if (local_98 != 0) {
    CowData<ShaderLanguage::Scalar>::_ref
              ((CowData<ShaderLanguage::Scalar> *)(puVar34 + 8),(CowData *)&local_98);
  }
  puVar34[0xe] = 0;
  puVar34[9] = local_90;
  *(undefined1 *)(puVar34 + 10) = local_88;
  *(undefined8 *)((long)puVar34 + 0x54) = local_84;
  *(undefined8 *)((long)puVar34 + 0x5c) = local_7c;
  *(undefined4 *)((long)puVar34 + 100) = local_74;
  if (local_68 != 0) {
    CowData<String>::_ref((CowData<String> *)(puVar34 + 0xe),(CowData *)&local_68);
  }
  puVar34[0x10] = 0;
  *(undefined4 *)(puVar34 + 0xf) = local_60;
  if (local_58._0_8_ != 0) {
...
LAB_0010bfbe:
  ...
  *(undefined8 **)(lVar38 + lVar40 * 8) = puVar34;
  *puVar2 = uVar33;
  *(int *)(this + 0x2c) = *(int *)(this + 0x2c) + 1;
  if (local_f0._8_8_ != 0) {
    LOCK();
...
/* HashMap<StringName, ShaderLanguage::ShaderNode::Uniform, HashMapHasherDefault,
   ...
   ShaderLanguage::ShaderNode::Uniform const&, bool) */
...
LAB_0010c2ea:
    ...
    _resize_and_rehash((HashMap<StringName,ShaderLanguage::ShaderNode::Uniform,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ShaderLanguage::ShaderNode::Uniform>>>
                        *)param_2,*(int *)(param_2 + 0x28) + 1);
  }
  else {
LAB_0010c126:
             ...
             (*(long *)(*(long *)(*(long *)(param_2 + 8) + lVar31 * 8) + 0x10) == *(long *)pSVar30))
          {
            ...
            *(int *)(lVar26 + 0x30) = (int)in_RCX[3];
            if (*(long *)(lVar26 + 0x40) != in_RCX[5]) {
              CowData<ShaderLanguage::Scalar>::_ref
                        ((CowData<ShaderLanguage::Scalar> *)(lVar26 + 0x40),(CowData *)(in_RCX + 5))
              ;
            }
            ...
            *(undefined8 *)(lVar26 + 0x54) = *(undefined8 *)((long)in_RCX + 0x3c);
            lVar31 = 0;
            do {
              *(undefined4 *)(lVar26 + 0x5c + lVar31) =
                   *(undefined4 *)((long)in_RCX + lVar31 + 0x44);
              lVar31 = lVar31 + 4;
            } while (lVar31 != 0xc);
            ...
            *(int *)(lVar26 + 0x78) = (int)in_RCX[0xc];
            if (*(long *)(lVar26 + 0x80) != in_RCX[0xd]) {
              CowData<char32_t>::_ref
                        ((CowData<char32_t> *)(lVar26 + 0x80),(CowData *)(in_RCX + 0xd));
            }
            if (*(long *)(lVar26 + 0x88) != in_RCX[0xe]) {
              CowData<char32_t>::_ref
                        ((CowData<char32_t> *)(lVar26 + 0x88),(CowData *)(in_RCX + 0xe));
            }
...
LAB_0010c2c8:
    if ((float)uVar23 * __LC39 < (float)(iVar29 + 1)) goto LAB_0010c2ea;
  }
  ...
  if (in_RCX[5] != 0) {
    CowData<ShaderLanguage::Scalar>::_ref
              ((CowData<ShaderLanguage::Scalar> *)&local_98,(CowData *)(in_RCX + 5));
  }
  local_90 = in_RCX[6];
  local_68 = 0;
  ...
  *(undefined4 *)(plVar25 + 6) = local_a8;
  if (local_98 != 0) {
    CowData<ShaderLanguage::Scalar>::_ref
              ((CowData<ShaderLanguage::Scalar> *)(plVar25 + 8),(CowData *)&local_98);
  }
  plVar25[0xe] = 0;
  plVar25[9] = local_90;
  ...
  *(undefined4 *)(plVar25 + 0xf) = local_60;
  ...
  plVar25[0x11] = 0;
  if ((local_50[0] != 0) &&
     (CowData<char32_t>::_ref((CowData<char32_t> *)(plVar25 + 0x11),(CowData *)local_50),
     lVar26 = local_50[0], local_50[0] != 0)) {
    LOCK();
    plVar1 = (long *)(local_50[0] + -0x10);
    *plVar1 = *plVar1 + -1;
    UNLOCK();

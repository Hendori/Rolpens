...

{
  ...
  if (((((cVar11 == 'h') && (param_3[1] == 't')) && (param_3[2] == 't')) &&
      ((param_3[3] == 'p' && (param_3[4] == ':')))) && ((param_3[5] == '/' && (param_3[6] == '/'))))
  {
...
LAB_0010009f:
    ...
    if (plVar4 != (long *)0x0) {
      ...
      puVar10 = (undefined1 *)((long)plVar4 + uVar2);
      *puVar10 = 0;
      if (((uVar2 < 0xe) || (*plVar4 != 0x5b2f2f3a70747468)) ||
         ((*(long *)((long)plVar4 + 5) != 0x3a303865665b2f2f ||
          (pcVar5 = strchr((char *)plVar4,0x5d), pcVar5 == (char *)0x0)))) {
        cVar11 = *param_3;
      }
      else {
        local_60 = pcVar5;
        ...
        if (uVar1 < 8) {
          if ((sVar7 & 4) == 0) {
            if (uVar1 != 0) {
              ...
              if ((sVar7 & 2) != 0) {
                *(undefined2 *)(pcVar5 + (sVar7 & 0xffffffff) + 1) =
                     *(undefined2 *)((long)&local_60 + (sVar7 & 0xffffffff) + 6);
              }
            }
          }
          else {
            *(undefined4 *)(pcVar5 + 3) = local_58;
            *(undefined4 *)(pcVar5 + ((sVar7 & 0xffffffff) - 1)) =
                 *(undefined4 *)((long)&local_60 + (sVar7 & 0xffffffff) + 4);
          }
        }
        else {
          *(ulong *)(pcVar5 + 3) = CONCAT44(uStack_54,local_58);
          *(undefined8 *)(pcVar5 + ((sVar7 & 0xffffffff) - 5)) =
               *(undefined8 *)((long)&local_60 + (sVar7 & 0xffffffff));
          uVar1 = (int)(pcVar5 + (3 - ((ulong)(pcVar5 + 0xb) & 0xfffffffffffffff8))) + uVar1 &
                  0xfffffff8;
          if (7 < uVar1) {
            uVar9 = 0;
            do {
              uVar8 = (ulong)uVar9;
              uVar9 = uVar9 + 8;
              *(undefined8 *)(((ulong)(pcVar5 + 0xb) & 0xfffffffffffffff8) + uVar8) =
                   *(undefined8 *)
                    ((long)&local_58 +
                    (uVar8 - (long)(pcVar5 + (3 - ((ulong)(pcVar5 + 0xb) & 0xfffffffffffffff8)))));
            } while (uVar9 < uVar1);
          }
        }
        uVar2 = uVar2 + 3 + sVar7;
...
undefined8
simpleUPnPcommand(int param_1,undefined8 param_2,undefined8 param_3,char *param_4,
...

{
  ...
  *param_6 = 0;
  ...
  if (param_5 == (undefined8 *)0x0) {
    uVar2 = __snprintf_chk(local_848,0x800,2,0x800,
...
LAB_001007a0:
        ...
        while( true ) {
          ...
          *pcVar8 = '>';
          ...
          if ((local_48 < pcVar10) || (*(undefined2 *)pcVar8 = _LC4, local_48 <= pcVar10)) break;
...
long * upnpDiscoverDevices(long *param_1,undefined4 param_2,undefined8 param_3,char *param_4,
...
LAB_001008ab:
  plVar2 = (long *)ssdpDiscoverDevices(param_1,param_2,param_3,param_5,param_6,param_7);
  return plVar2;
}



void upnpDiscover(undefined4 param_1,undefined8 param_2,undefined8 param_3,undefined4 param_4,
...
void upnpDiscoverAll(undefined4 param_1,undefined8 param_2,undefined8 param_3,undefined4 param_4,
                    undefined4 param_5,undefined1 param_6,undefined8 param_7)
...

{
  ...
  if (iVar1 != 0) {
    ...
    if ((iVar1 == 0) && (iVar1 = 0x70 - (uint)local_57, iVar1 == 0)) {
      iVar1 = -(uint)local_56;
    }
    bVar2 = iVar1 == 0;
  }
...
int UPNP_GetValidIGD(long *param_1,undefined1 (*param_2) [16],undefined8 *param_3,char *param_4,
        ...
        *(long *)(puVar12 + -2) = lVar7;
        ...
        if (lVar7 != 0) {
          ...
          *(undefined8 *)((long)param_3 + 0xb7c) = 0;
          ...
          for (uVar8 = (ulong)((iVar1 - (int)(undefined8 *)
                                             ((ulong)(param_3 + 1) & 0xfffffffffffffff8)) + 0xb84U
          ...
          *param_2 = (undefined1  [16])0x0;
          ...
          local_68 = param_3;
          parsexml(local_88);
          iVar4 = strncmp((char *)((long)param_3 + 0x304),
                          "urn:schemas-upnp-org:service:WANCommonInterfaceConfig:",0x36);
          if (iVar4 == 0) {
            puVar12[1] = 1;
          }
        }
...
LAB_001012e6:
                if (iVar4 < iVar14) goto LAB_001013dd;
                goto LAB_001012ee;
              }
            }
            else {
...
LAB_001013dd:
              ...
              if (iVar5 != 0) {
                ...
                iVar5 = UPNP_GetExternalIPAddress
                                  (*(undefined8 *)*param_2,(long)param_3 + 0x504,lVar7);
                if ((iVar5 != 0) || (iVar5 = addr_is_reserved(lVar7), iVar5 != 0))
                goto LAB_001010eb;
LAB_00101370:
                local_d0 = 1;
                goto LAB_001012e6;
...
LAB_001010eb:
      ...
      local_d0 = 0;
LAB_001012ee:
      puVar10 = (undefined8 *)((long)__ptr_00 + 0x50);
      do {
        __ptr = (void *)*puVar10;
        puVar10 = puVar10 + 0xc;
        free(__ptr);
...
undefined8
UPNP_GetIGDFromUrl(undefined8 param_1,undefined1 (*param_2) [16],undefined8 *param_3,
...

{
  ...
  if (__ptr != (void *)0x0) {
    ...
    *(undefined8 *)((long)param_3 + 0xb7c) = 0;
    ...
    for (uVar2 = (ulong)(((int)param_3 -
                         (int)(undefined8 *)((ulong)(param_3 + 1) & 0xfffffffffffffff8)) + 0xb84U >>

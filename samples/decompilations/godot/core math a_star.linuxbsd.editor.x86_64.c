...
/* AStar3D::get_point_count() const */

undefined4 __thiscall AStar3D::get_point_count(AStar3D *this)
...
/* AStar3D::get_point_capacity() const */

undefined4 __thiscall AStar3D::get_point_capacity(AStar3D *this)
...
/* AStar2D::get_point_count() const */

undefined4 __thiscall AStar2D::get_point_count(AStar2D *this)
...
/* AStar2D::get_point_capacity() const */

undefined4 __thiscall AStar2D::get_point_capacity(AStar2D *this)
...
/* LocalVector<AStar3D::Point*, unsigned int, false, false>::resize(unsigned int) [clone .part.0] */

void LocalVector<AStar3D::Point*,unsigned_int,false,false>::resize(uint param_1)
...
/* AStar3D::get_closest_point(Vector3 const&, bool) const */

long __thiscall AStar3D::get_closest_point(AStar3D *this,Vector3 *param_1,bool param_2)

{
  ...
  do {
    ...
    if ((((param_2) || (*(char *)(lVar2 + 0x18) != '\0')) &&
        (fVar11 = *(float *)(lVar2 + 0xc) - *(float *)(param_1 + 4),
        fVar9 = *(float *)(lVar2 + 8) - *(float *)param_1,
        fVar10 = *(float *)(lVar2 + 0x10) - *(float *)(param_1 + 8),
        fVar9 = fVar9 * fVar9 + fVar11 * fVar11 + fVar10 * fVar10, fVar9 <= fVar12)) &&
       ((fVar9 != fVar12 || (*(long *)(*(long *)(this + 0x198) + lVar4) <= lVar8)))) {
...
/* AStar2D::get_closest_point(Vector2 const&, bool) const */

void __thiscall AStar2D::get_closest_point(AStar2D *this,Vector2 *param_1,bool param_2)
...
void __thiscall AStar3D::clear(AStar3D *this)
...
LAB_00100640:
      if ((*(long *)(this + 0x1b0) != 0) && (*(int *)(this + 0x1d4) != 0)) {
        if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x1d0) * 4) != 0) {
          memset(*(void **)(this + 0x1c8),0,
                 (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x1d0) * 4) * 4);
        }
...
void __thiscall AStar3D::~AStar3D(AStar3D *this)
...
LAB_0010073a:
  ...
  if (pvVar1 != (void *)0x0) {
    if (*(int *)(this + 0x1d4) != 0) {
      if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x1d0) * 4) != 0) {
        memset(*(void **)(this + 0x1c8),0,
               (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x1d0) * 4) << 2);
      }
      *(undefined4 *)(this + 0x1d4) = 0;
    }
    Memory::free_static(pvVar1,false);
...
void __thiscall AStar2D::clear(AStar2D *this)
...
/* AStar3D::get_closest_position_in_segment(Vector3 const&) const */

undefined1  [16] __thiscall AStar3D::get_closest_position_in_segment(AStar3D *this,Vector3 *param_1)
...
LAB_001009a6:
    ...
    lVar4 = 0;
LAB_00100a74:
    if ((*(char *)(lVar11 + 0x18) != '\0') && (*(char *)(lVar4 + 0x18) != '\0')) {
      ...
      fVar14 = fVar16;
      if ((_LC15 <= fVar15) &&
         ((fVar15 = ((*(float *)(param_1 + 4) - fVar16) * fVar21 +
                     (*(float *)param_1 - fVar13) * fVar20 +
                    (*(float *)(param_1 + 8) - fVar12) * fVar19) / fVar15, 0.0 < fVar15 &&
          (fVar18 = *(float *)(lVar4 + 0x10), fVar17 = *(float *)(lVar4 + 8),
          fVar14 = *(float *)(lVar4 + 0xc), fVar15 < __LC16)))) {
...
/* AStar2D::get_closest_position_in_segment(Vector2 const&) const */

void __thiscall AStar2D::get_closest_position_in_segment(AStar2D *this,Vector2 *param_1)
...
/* AStar3D::has_point(long) const */

undefined8 __thiscall AStar3D::has_point(AStar3D *this,long param_1)
...
/* AStar2D::has_point(long) const */

undefined8 __thiscall AStar2D::has_point(AStar2D *this,long param_1)
...
/* AStar3D::get_available_point_id() const */

long __thiscall AStar3D::get_available_point_id(AStar3D *this)
      ...
      if (((uint)uVar8 == uVar6) && (lVar5 == *(long *)(*(long *)(this + 0x198) + uVar3 * 8))) {
        ...
        while( true ) {
          ...
          while ((uVar6 != (uint)uVar9 || (*(long *)(*(long *)(this + 0x198) + uVar8 * 8) != lVar5))
            ...
            uVar6 = *(uint *)(lVar2 + uVar8 * 4);
            if ((uVar6 == 0) || (((uVar1 + (int)uVar8) - uVar6 % uVar1) % uVar1 < uVar7))
            goto LAB_001010f0;
          }
          lVar5 = lVar5 + 1;
          uVar3 = uVar3 + 0x3ffff;
...
/* AStar2D::get_available_point_id() const */

void __thiscall AStar2D::get_available_point_id(AStar2D *this)
...
/* AStar3D::_solve(AStar3D::Point*, AStar3D::Point*, bool) */

ulong __thiscall AStar3D::_solve(AStar3D *this,Point *param_1,Point *param_2,bool param_3)
...
LAB_001014f0:
  ...
  if (((lVar10 == 0) ||
      (fVar28 = *(float *)(lVar10 + 0x84), bVar24 = *(float *)(param_1 + 0x84) <= fVar28,
      bVar24 && fVar28 != *(float *)(param_1 + 0x84))) ||
     ((bVar24 &&
      (*(float *)(param_1 + 0x80) <= *(float *)(lVar10 + 0x80) &&
       *(float *)(lVar10 + 0x80) != *(float *)(param_1 + 0x80))))) {
  ...
  if (param_2 != param_1) {
    ...
    if (lVar18 < 3) {
      ...
      do {
        ...
        lVar2 = plVar7[lVar8];
        lVar9 = lVar8;
        if ((*(float *)(lVar2 + 0x6c) <= *(float *)(lVar13 + 0x6c)) &&
           ((*(float *)(lVar2 + 0x6c) < *(float *)(lVar13 + 0x6c) ||
            (*(float *)(lVar13 + 0x68) < *(float *)(lVar2 + 0x68) ||
             *(float *)(lVar13 + 0x68) == *(float *)(lVar2 + 0x68))))) {
          lVar9 = lVar8 + 1;
          lVar13 = lVar2;
          lVar16 = lVar8;
...
LAB_001015de:
      fVar28 = *(float *)(lVar10 + 0x6c);
      do {
        lVar8 = plVar7[lVar18];
        if ((*(float *)(lVar8 + 0x6c) <= fVar28) &&
           ((*(float *)(lVar8 + 0x6c) < fVar28 ||
            (*(float *)(lVar10 + 0x68) < *(float *)(lVar8 + 0x68) ||
             *(float *)(lVar10 + 0x68) == *(float *)(lVar8 + 0x68))))) {
          plVar12 = plVar7 + lVar16;
          break;
        }
      ...
      if (puVar4[0xe] != *(long *)(this + 0x188)) {
        ...
        *(float *)((long)puVar4 + 0x6c) = fVar27;
        ...
        while (uVar14 != 0) {
          ...
          lVar10 = *plVar12;
          if ((*(float *)(lVar10 + 0x6c) <= fVar27) &&
             ((*(float *)(lVar10 + 0x6c) < fVar27 ||
              (fVar26 < *(float *)(lVar10 + 0x68) || fVar26 == *(float *)(lVar10 + 0x68))))) {
            plVar12 = plVar7 + uVar14;
            break;
          }
...
/* AStar2D::_solve(AStar3D::Point*, AStar3D::Point*, bool) */

ulong __thiscall AStar2D::_solve(AStar2D *this,Point *param_1,Point *param_2,bool param_3)
...
/* AStar3D::get_point_position(long) const */

undefined1  [16] __thiscall AStar3D::get_point_position(AStar3D *this,long param_1)

{
  ...
  _err_print_error("get_point_position","core/math/a_star.cpp",0x4a,
                   "Condition \"!p_exists\" is true. Returning: Vector3()",
...
/* AStar2D::get_point_position(long) const */

void __thiscall AStar2D::get_point_position(AStar2D *this,long param_1)
...
/* AStar3D::set_point_position(long, Vector3 const&) */

void __thiscall AStar3D::set_point_position(AStar3D *this,long param_1,Vector3 *param_2)

{
  ...
  String::parse_latin1((StrRange *)&local_50);
  vformat<long>((CowData<char32_t> *)&local_48,(long)&local_50);
  _err_print_error("set_point_position","core/math/a_star.cpp",0x52,
                   "Condition \"!p_exists\" is true.",(CowData<char32_t> *)&local_48,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_50);
LAB_0010230c:
...
/* AStar3D::get_point_weight_scale(long) const */

void __thiscall AStar3D::get_point_weight_scale(AStar3D *this,long param_1)

{
  ...
  _err_print_error("get_point_weight_scale","core/math/a_star.cpp",0x5a,
                   "Condition \"!p_exists\" is true. Returning: 0",(CowData<char32_t> *)&local_38,0,
                   0);
...
/* AStar3D::set_point_weight_scale(long, float) */

void __thiscall AStar3D::set_point_weight_scale(AStar3D *this,long param_1,float param_2)

{
    ...
    do {
      if (((uint)uVar5 == uVar3) && (*(long *)(*(long *)(this + 0x198) + uVar2 * 8) == param_1)) {
        if (param_2 < 0.0) {
          ...
          _err_print_error("set_point_weight_scale","core/math/a_star.cpp",99,
                           "Condition \"p_weight_scale < 0.0\" is true.",
  ...
  String::parse_latin1((StrRange *)&local_40);
  vformat<long>((CowData<char32_t> *)&local_38,(long)&local_40);
  _err_print_error("set_point_weight_scale","core/math/a_star.cpp",0x62,
                   "Condition \"!p_exists\" is true.",(CowData<char32_t> *)&local_38,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_38);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_40);
LAB_00102671:
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
...
/* AStar2D::set_point_weight_scale(long, float) */

void __thiscall AStar2D::set_point_weight_scale(AStar2D *this,long param_1,float param_2)
...
/* AStar3D::set_point_disabled(long, bool) */

void __thiscall AStar3D::set_point_disabled(AStar3D *this,long param_1,bool param_2)

{
  ...
  String::parse_latin1((StrRange *)&local_50);
  vformat<long>((CowData<char32_t> *)&local_48,(long)&local_50);
  _err_print_error("set_point_disabled","core/math/a_star.cpp",0x21a,
                   "Condition \"!p_exists\" is true.",(CowData<char32_t> *)&local_48,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_50);
LAB_001028b5:
...
/* AStar3D::is_point_disabled(long) const */

byte __thiscall AStar3D::is_point_disabled(AStar3D *this,long param_1)

{
  ...
  String::parse_latin1((StrRange *)&local_40);
  vformat<long>((CowData<char32_t> *)&local_38,(long)&local_40);
  _err_print_error("is_point_disabled","core/math/a_star.cpp",0x222,
                   "Condition \"!p_exists\" is true. Returning: false",
                   (CowData<char32_t> *)&local_38,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_38);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_40);
  bVar2 = 0;
...
/* AStar2D::get_point_weight_scale(long) const */

void __thiscall AStar2D::get_point_weight_scale(AStar2D *this,long param_1)
...
/* AStar2D::set_point_disabled(long, bool) */

void __thiscall AStar2D::set_point_disabled(AStar2D *this,long param_1,bool param_2)
...
/* AStar2D::is_point_disabled(long) const */

byte __thiscall AStar2D::is_point_disabled(AStar2D *this,long param_1)
...
/* AStar2D::set_point_position(long, Vector2 const&) */

void __thiscall AStar2D::set_point_position(AStar2D *this,long param_1,Vector2 *param_2)
...
/* AStar3D::_bind_compatibility_methods() */

void AStar3D::_bind_compatibility_methods(void)
...
/* AStar2D::_bind_compatibility_methods() */

void AStar2D::_bind_compatibility_methods(void)
...
/* AStar3D::are_points_connected(long, long, bool) const */

ulong __thiscall AStar3D::are_points_connected(AStar3D *this,long param_1,long param_2,bool param_3)

{
  ...
  local_38 = param_1;
  local_28 = bVar3;
  cVar1 = HashSet<AStar3D::Segment,AStar3D::Segment,HashMapComparatorDefault<AStar3D::Segment>>::
          _lookup_pos((HashSet<AStar3D::Segment,AStar3D::Segment,HashMapComparatorDefault<AStar3D::Segment>>
                       *)(this + 0x1b0),(Segment *)&local_38,&local_3c);
  if (cVar1 != '\0') {
    if (*(long *)(this + 0x1b0) != 0) {
      if ((char)uVar2 == '\0') {
        uVar2 = CONCAT71((int7)((ulong)((long)(int)local_3c * 3) >> 8),
                         (*(byte *)(*(long *)(this + 0x1b0) + 0x10 + (long)(int)local_3c * 0x18) &
                         bVar3) == bVar3);
      }
      goto LAB_00103830;
    }
...
/* AStar2D::are_points_connected(long, long, bool) const */

void __thiscall AStar2D::are_points_connected(AStar2D *this,long param_1,long param_2,bool param_3)
...
/* HashSet<AStar3D::Segment, AStar3D::Segment, HashMapComparatorDefault<AStar3D::Segment>
   >::erase(AStar3D::Segment const&) [clone .isra.0] */

void __thiscall
HashSet<AStar3D::Segment,AStar3D::Segment,HashMapComparatorDefault<AStar3D::Segment>>::erase
          (HashSet<AStar3D::Segment,AStar3D::Segment,HashMapComparatorDefault<AStar3D::Segment>>
           *this,Segment *param_1)

{
  ...
  if (cVar26 != '\0') {
    ...
    if ((*puVar35 == 0) ||
       (auVar13._8_8_ = 0, auVar13._0_8_ = (ulong)*puVar35 * lVar10, auVar19._8_8_ = 0,
       auVar19._0_8_ = uVar32, auVar14._8_8_ = 0,
       auVar14._0_8_ = (ulong)((uVar27 + uVar30) - SUB164(auVar13 * auVar19,8)) * lVar10,
       auVar20._8_8_ = 0, auVar20._0_8_ = uVar32, SUB164(auVar14 * auVar20,8) == 0)) {
      ...
      while( true ) {
        ...
        *puVar1 = uVar30;
        ...
        puVar35 = (uint *)(lVar9 + lVar28);
        if ((*puVar35 == 0) ||
           (auVar15._8_8_ = 0, auVar15._0_8_ = (ulong)*puVar35 * lVar10, auVar21._8_8_ = 0,
           auVar21._0_8_ = uVar32, auVar16._8_8_ = 0,
           auVar16._0_8_ =
                (ulong)((SUB164(auVar17 * auVar23,8) + uVar27) - SUB164(auVar15 * auVar21,8)) *
                lVar10, auVar22._8_8_ = 0, auVar22._0_8_ = uVar32, SUB164(auVar16 * auVar22,8) == 0)
           ) break;
        uVar33 = uVar36;
    ...
    *(uint *)(this + 0x24) = uVar27;
    if (uVar25 < uVar27) {
      ...
      *puVar4 = uVar30;
      *(uint *)(*(long *)(this + 8) +
               (ulong)*(uint *)(lVar8 + (ulong)*(uint *)(this + 0x24) * 4) * 4) = uVar25;
    }
  }
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
...
/* AStar3D::remove_point(long) */

void __thiscall AStar3D::remove_point(AStar3D *this,long param_1)
        ...
        while (uVar10 = uVar6, uVar10 != *(uint *)(plVar2 + 7)) {
          ...
          if (*(int *)(lVar3 + uVar10 * 4) != 0) {
            ...
            do {
              ...
              HashSet<AStar3D::Segment,AStar3D::Segment,HashMapComparatorDefault<AStar3D::Segment>>
              ::erase((HashSet<AStar3D::Segment,AStar3D::Segment,HashMapComparatorDefault<AStar3D::Segment>>
                       *)(this + 0x1b0),(Segment *)&local_58);
              OAHashMap<long,AStar3D::Point*,HashMapHasherDefault,HashMapComparatorDefault<long>>::
              remove((OAHashMap<long,AStar3D::Point*,HashMapHasherDefault,HashMapComparatorDefault<long>>
                      *)(*plVar7 + 0x20),plVar2);
              OAHashMap<long,AStar3D::Point*,HashMapHasherDefault,HashMapComparatorDefault<long>>::
              remove((OAHashMap<long,AStar3D::Point*,HashMapHasherDefault,HashMapComparatorDefault<long>>
                      *)(*plVar7 + 0x40),plVar2);
...
LAB_00103e90:
        ...
        OAHashMap<long,AStar3D::Point*,HashMapHasherDefault,HashMapComparatorDefault<long>>::remove
                  ((OAHashMap<long,AStar3D::Point*,HashMapHasherDefault,HashMapComparatorDefault<long>>
                    *)(this + 400),local_70);
  ...
  _err_print_error("remove_point","core/math/a_star.cpp",0x6b,"Condition \"!p_exists\" is true.",
...
/* AStar2D::remove_point(long) */

void __thiscall AStar2D::remove_point(AStar2D *this,long param_1)
...
/* AStar3D::reserve_space(long) */

void __thiscall AStar3D::reserve_space(AStar3D *this,long param_1)

{
  ...
  if (param_1 < 1) {
    ...
    String::parse_latin1((StrRange *)&local_50);
    vformat<long>((CowData<char32_t> *)&local_48,(long)&local_50);
    _err_print_error("reserve_space","core/math/a_star.cpp",0x106,
                     "Condition \"p_num_nodes <= 0\" is true.",(CowData<char32_t> *)&local_48,0,0);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_50);
  }
  else {
    ...
    if (uVar1 <= (uint)param_1) {
      if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
        OAHashMap<long,AStar3D::Point*,HashMapHasherDefault,HashMapComparatorDefault<long>>::
        _resize_and_rehash((OAHashMap<long,AStar3D::Point*,HashMapHasherDefault,HashMapComparatorDefault<long>>
                            *)(this + 400),(uint)param_1);
        return;
      }
      goto LAB_001040b5;
    }
    ...
    String::parse_latin1((StrRange *)&local_50);
    vformat<unsigned_int,long>
              ((CowData<char32_t> *)&local_48,(uint)(StrRange *)&local_50,(ulong)uVar1);
    _err_print_error("reserve_space","core/math/a_star.cpp",0x107,
                     "Condition \"(uint32_t)p_num_nodes < points.get_capacity()\" is true.",
                     (CowData<char32_t> *)&local_48,0,0);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_50);
  }
...
/* AStar2D::reserve_space(long) */

void __thiscall AStar2D::reserve_space(AStar2D *this,long param_1)
...
/* AStar3D::add_point(long, Vector3 const&, float) */

void __thiscall AStar3D::add_point(AStar3D *this,long param_1,Vector3 *param_2,float param_3)

{
  ...
  if (param_1 < 0) {
    ...
    if (0.0 <= param_3) {
      ...
      if (uVar10 != 0) {
        ...
        do {
          if (((uint)uVar12 == uVar10) &&
             (param_1 == *(long *)(*(long *)(this + 0x198) + uVar3 * 8))) {
      ...
      *(float *)(pPVar4 + 0x14) = param_3;
      local_48 = pPVar4;
      OAHashMap<long,AStar3D::Point*,HashMapHasherDefault,HashMapComparatorDefault<long>>::set
                ((OAHashMap<long,AStar3D::Point*,HashMapHasherDefault,HashMapComparatorDefault<long>>
                  *)(this + 400),local_60,&local_48);
      goto LAB_001041ff;
    }
    local_50 = 0;
    local_40 = 0x36;
  ...
  _err_print_error("add_point","core/math/a_star.cpp",uVar9,pcVar8,(CowData<char32_t> *)&local_48,0,
                   0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_50);
LAB_001041ff:
...
/* AStar2D::add_point(long, Vector2 const&, float) */

void __thiscall AStar2D::add_point(AStar2D *this,long param_1,Vector2 *param_2,float param_3)
...
/* AStar3D::disconnect_points(long, long, bool) */

void __thiscall AStar3D::disconnect_points(AStar3D *this,long param_1,long param_2,bool param_3)

{
  ...
  _err_print_error("disconnect_points","core/math/a_star.cpp",0xab,
                   "Condition \"!a_exists\" is true.",(CowData<char32_t> *)&local_58,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
...
LAB_00104689:
    if (((uint)uVar11 == uVar12) && (*(long *)(*(long *)(this + 0x198) + uVar7 * 8) == param_2)) {
      ...
      this_00 = (HashSet<AStar3D::Segment,AStar3D::Segment,HashMapComparatorDefault<AStar3D::Segment>>
                 *)(this + 0x1b0);
      bVar9 = local_48;
      if (param_3) {
        bVar9 = 3;
      ...
      local_70 = pPVar5;
      local_50 = param_2;
      cVar6 = HashSet<AStar3D::Segment,AStar3D::Segment,HashMapComparatorDefault<AStar3D::Segment>>
              ::_lookup_pos(this_00,(Segment *)&local_58,(uint *)local_68);
      ...
      if (param_3) {
        ...
        OAHashMap<long,AStar3D::Point*,HashMapHasherDefault,HashMapComparatorDefault<long>>::set
                  ((OAHashMap<long,AStar3D::Point*,HashMapHasherDefault,HashMapComparatorDefault<long>>
                    *)(plVar4 + 8),(long *)pPVar5,&local_70);
        HashSet<AStar3D::Segment,AStar3D::Segment,HashMapComparatorDefault<AStar3D::Segment>>::erase
                  (this_00,pSVar1);
      }
      HashSet<AStar3D::Segment,AStar3D::Segment,HashMapComparatorDefault<AStar3D::Segment>>::insert
                ((Segment *)local_68);
      goto LAB_00104806;
    }
  }
LAB_00104830:
  ...
  String::parse_latin1((StrRange *)local_68);
  vformat<long>((CowData<char32_t> *)&local_58,(long)local_68);
  _err_print_error("disconnect_points","core/math/a_star.cpp",0xaf,
                   "Condition \"!b_exists\" is true.",(CowData<char32_t> *)&local_58,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_68);
LAB_00104806:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
/* AStar2D::disconnect_points(long, long, bool) */

void __thiscall AStar2D::disconnect_points(AStar2D *this,long param_1,long param_2,bool param_3)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* AStar3D::connect_points(long, long, bool) */

void __thiscall AStar3D::connect_points(AStar3D *this,long param_1,long param_2,bool param_3)

{
  ...
  _err_print_error("connect_points","core/math/a_star.cpp",uVar12,pcVar11,
                   (CowData<char32_t> *)&local_58,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_68);
  goto LAB_00104cce;
...
LAB_00104b49:
    if ((uVar20 == (uint)uVar17) && (*(long *)(*(long *)(this + 0x198) + uVar9 * 8) == param_2)) {
...
LAB_00104e38:
  ...
  String::parse_latin1((StrRange *)&local_68);
  vformat<long>((CowData<char32_t> *)&local_58,(long)&local_68);
  _err_print_error("connect_points","core/math/a_star.cpp",0x8b,"Condition \"!to_exists\" is true.",
                   (CowData<char32_t> *)&local_58,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_68);
  goto LAB_00104cce;
...
LAB_00104c23:
    if ((uVar15 == (uint)uVar17) && (local_b8 == *(long *)(*(long *)(pPVar3 + 0x28) + uVar19 * 8)))
    {
...
LAB_00104cfd:
  if ((double)uVar10 * __LC68 < (double)(*(int *)(pPVar3 + 0x3c) + 1)) {
    OAHashMap<long,AStar3D::Point*,HashMapHasherDefault,HashMapComparatorDefault<long>>::
    _resize_and_rehash((OAHashMap<long,AStar3D::Point*,HashMapHasherDefault,HashMapComparatorDefault<long>>
                        *)(pPVar3 + 0x20),uVar14 * 2);
  ...
  plVar7 = plVar4;
  while (uVar20 != 0) {
    uVar15 = (uint)((ulong)(uint)(((int)uVar9 + (int)uVar10) - (int)((ulong)uVar20 % uVar10)) %
                   uVar10);
    plVar18 = plVar7;
    lVar21 = local_b8;
    if (uVar15 < uVar14) {
...
LAB_00104df5:
  ...
  cVar8 = HashSet<AStar3D::Segment,AStar3D::Segment,HashMapComparatorDefault<AStar3D::Segment>>::
          _lookup_pos((HashSet<AStar3D::Segment,AStar3D::Segment,HashMapComparatorDefault<AStar3D::Segment>>
                       *)(this + 0x1b0),(Segment *)&local_58,(uint *)&local_68);
  if (cVar8 != '\0') {
    if (*(long *)(this + 0x1b0) != 0) {
...
/* AStar2D::connect_points(long, long, bool) */

void __thiscall AStar2D::connect_points(AStar2D *this,long param_1,long param_2,bool param_3)
...
/* AStar3D::get_point_path(long, long, bool) */

long AStar3D::get_point_path(long param_1,long param_2,bool param_3)

{
  ...
  if (uVar14 != 0) {
    ...
    do {
      if (((uint)uVar11 == uVar14) &&
         (*(long *)(*(long *)(param_2 + 0x198) + uVar5 * 8) ==
          CONCAT71(in_register_00000011,param_3))) {
  ...
  _err_print_error("get_point_path","core/math/a_star.cpp",0x1ae,
                   "Condition \"!from_exists\" is true. Returning: Vector<Vector3>()",
...
LAB_00105271:
    if ((uVar14 == (uint)uVar11) && (*(long *)(*(long *)(param_2 + 0x198) + uVar5 * 8) == in_RCX)) {
...
LAB_00105313:
        *local_60[0] = *(undefined8 *)(pPVar2 + 8);
      ...
      if (iVar4 == 0) {
        ...
        _err_print_index_error
                  ("set","./core/templates/cowdata.h",0xcf,lVar13,lVar9,"p_index","size()","",false,
                   false);
      }
      else {
...
LAB_001053e0:
  ...
  String::parse_latin1((StrRange *)&local_70);
  vformat<long>((CowData<char32_t> *)&local_68,(long)&local_70);
  _err_print_error("get_point_path","core/math/a_star.cpp",0x1b2,
                   "Condition \"!to_exists\" is true. Returning: Vector<Vector3>()",
                   (CowData<char32_t> *)&local_68,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_68);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_70);
  *(undefined8 *)(param_1 + 8) = 0;
...
/* AStar3D::_get_point_path_bind_compat_88047(long, long) */
...
/* AStar2D::get_point_path(long, long, bool) */

long AStar2D::get_point_path(long param_1,long param_2,bool param_3)

{
  ...
  if (uVar15 != 0) {
    ...
    do {
      if ((uVar15 == (uint)uVar13) &&
         (*(long *)(*(long *)(param_2 + 0x318) + uVar6 * 8) ==
          CONCAT71(in_register_00000011,param_3))) {
  ...
  String::parse_latin1((StrRange *)&local_60);
  vformat<long>((CowData<char32_t> *)&local_58,(long)&local_60);
  _err_print_error("get_point_path","core/math/a_star.cpp",0x2ca,
                   "Condition \"!from_exists\" is true. Returning: Vector<Vector2>()",
                   (CowData<char32_t> *)&local_58,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
  *(undefined8 *)(param_1 + 8) = 0;
...
LAB_001057d1:
    if ((uVar15 == (uint)uVar13) && (*(long *)(*(long *)(param_2 + 0x318) + uVar6 * 8) == in_RCX)) {
...
LAB_00105865:
        *local_50[0] = *(undefined8 *)(pPVar2 + 8);
      ...
      if (iVar5 == 0) {
        ...
        _err_print_index_error
                  ("set","./core/templates/cowdata.h",0xcf,0,lVar11,"p_index","size()","",false,
                   false);
      }
LAB_00105a58:
...
LAB_00105930:
  ...
  String::parse_latin1((StrRange *)&local_60);
  vformat<long>((CowData<char32_t> *)&local_58,(long)&local_60);
  _err_print_error("get_point_path","core/math/a_star.cpp",0x2ce,
                   "Condition \"!to_exists\" is true. Returning: Vector<Vector2>()",
                   (CowData<char32_t> *)&local_58,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
  *(undefined8 *)(param_1 + 8) = 0;
...
/* AStar2D::_get_point_path_bind_compat_88047(long, long) */
...
/* AStar2D::_bind_methods() */

void AStar2D::_bind_methods(void)

{
  ...
  *(undefined4 *)(pMVar10 + 0x34) = 0;
  ...
  ClassDB::add_virtual_method
            ((StringName *)&local_258,(MethodInfo *)&local_228,true,(StrRange *)&local_268,false);
  if ((StringName::configured != '\0') && (local_258 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_270);
...
/* AStar3D::_bind_methods() */

void AStar3D::_bind_methods(void)
...
/* AStar2D::_compute_cost(long, long) */

void __thiscall AStar2D::_compute_cost(AStar2D *this,long param_1,long param_2)

{
  ...
  if ((*(long *)(this + 8) != 0) && (this[0x3b0] == (AStar2D)0x0)) {
    ...
    *(undefined8 *)(this + 0x3b8) = 0;
    ...
    if (((pcVar8 == (code *)0x0) || (*(long *)(lVar5 + 0xe0) == 0)) &&
       (pcVar8 = *(code **)(lVar5 + 0xd0), pcVar8 == (code *)0x0)) {
      local_158 = 0;
...
LAB_0010aceb:
        ...
        if (((pcVar8 == (code *)0x0) || (*(long *)(lVar5 + 0xe0) == 0)) &&
           (pcVar8 = *(code **)(lVar5 + 0xc0), pcVar8 == (code *)0x0)) goto LAB_0010abd7;
...
LAB_0010abd7:
  ...
  if (pcVar8 == (code *)0x0) {
    ...
    local_148 = 0;
    String::parse_latin1
              ((String *)&local_148,"Can\'t compute cost. Point with id: %d doesn\'t exist.");
    vformat<long>((CowData<char32_t> *)local_118,(long)&local_148);
    _err_print_error("_compute_cost","core/math/a_star.cpp",0x2be,
                     "Condition \"!from_exists\" is true. Returning: 0",
                     (CowData<char32_t> *)local_118,0,0);
    ...
    if (*(code **)(*(long *)(this + 8) + 0xe0) == (code *)0x0) {
      ...
      (**(code **)(*(long *)(this + 8) + 0xe0))
                (*(undefined8 *)(this + 0x10),this + 0x3a8,pcVar8,&local_78,local_118);
    }
  }
LAB_0010a6e7:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
...
LAB_0010a888:
    if (((uint)uVar11 == uVar10) && (*(long *)(*(long *)(this + 0x318) + uVar3 * 8) == param_2))
    goto LAB_0010a6e7;
  }
LAB_0010a950:
  local_148 = 0;
  String::parse_latin1
            ((String *)&local_148,"Can\'t compute cost. Point with id: %d doesn\'t exist.");
  vformat<long>((CowData<char32_t> *)local_118,(long)&local_148);
  _err_print_error("_compute_cost","core/math/a_star.cpp",0x2c2,
                   "Condition \"!to_exists\" is true. Returning: 0",(CowData<char32_t> *)local_118,0
                   ,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_118);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_148);
  goto LAB_0010a6e7;
...
/* AStar2D::_estimate_cost(long, long) */

void __thiscall AStar2D::_estimate_cost(AStar2D *this,long param_1,long param_2)
...
LAB_0010b53b:
        ...
        pcVar8 = *(code **)(lVar5 + 200);
        if (((pcVar8 == (code *)0x0) || (*(long *)(lVar5 + 0xe0) == 0)) &&
           (pcVar8 = *(code **)(lVar5 + 0xc0), pcVar8 == (code *)0x0)) goto LAB_0010b427;
...
LAB_0010b427:
  ...
  if (pcVar8 == (code *)0x0) {
    ...
    local_148 = 0;
    String::parse_latin1
              ((String *)&local_148,"Can\'t estimate cost. Point with id: %d doesn\'t exist.");
    vformat<long>((CowData<char32_t> *)local_118,(long)&local_148);
    _err_print_error("_estimate_cost","core/math/a_star.cpp",0x2ad,
                     "Condition \"!from_exists\" is true. Returning: 0",
                     (CowData<char32_t> *)local_118,0,0);
    CowData<char32_t>::_unref((CowData<char32_t> *)local_118);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_148);
    ...
    if (*(code **)(*(long *)(this + 8) + 0xe0) == (code *)0x0) {
      ...
      (**(code **)(*(long *)(this + 8) + 0xe0))
                (*(undefined8 *)(this + 0x10),this + 0x390,pcVar8,&local_78,local_118);
    }
  }
LAB_0010af37:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
...
LAB_0010b1a0:
  ...
  String::parse_latin1
            ((String *)&local_148,"Can\'t estimate cost. Point with id: %d doesn\'t exist.");
  vformat<long>((CowData<char32_t> *)local_118,(long)&local_148);
  _err_print_error("_estimate_cost","core/math/a_star.cpp",0x2b1,
                   "Condition \"!to_exists\" is true. Returning: 0",(CowData<char32_t> *)local_118,0
                   ,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_118);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_148);
...
/* AStar3D::_compute_cost(long, long) */

void __thiscall AStar3D::_compute_cost(AStar3D *this,long param_1,long param_2)
...
LAB_0010bd9b:
        ...
        pcVar8 = *(code **)(lVar5 + 200);
        if (((pcVar8 == (code *)0x0) || (*(long *)(lVar5 + 0xe0) == 0)) &&
           (pcVar8 = *(code **)(lVar5 + 0xc0), pcVar8 == (code *)0x0)) goto LAB_0010bc87;
...
LAB_0010bc87:
  ...
  if (pcVar8 == (code *)0x0) {
    ...
    vformat<long>((CowData<char32_t> *)local_118,(long)&local_148);
    _err_print_error("_compute_cost","core/math/a_star.cpp",0x1a2,
                     "Condition \"!from_exists\" is true. Returning: 0",
                     (CowData<char32_t> *)local_118,0,0);
    CowData<char32_t>::_unref((CowData<char32_t> *)local_118);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_148);
    ...
    if (*(code **)(*(long *)(this + 8) + 0xe0) == (code *)0x0) {
      ...
      (**(code **)(*(long *)(this + 8) + 0xe0))
                (*(undefined8 *)(this + 0x10),this + 0x1f8,pcVar8,&local_78,local_118);
    }
  }
LAB_0010b787:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
  ...
  while( true ) {
    ...
    if ((uVar10 == 0) || (((uVar1 + (int)uVar3) - uVar10 % uVar1) % uVar1 < uVar9)) break;
LAB_0010b928:
    if (((uint)uVar11 == uVar10) && (*(long *)(*(long *)(this + 0x198) + uVar3 * 8) == param_2))
    goto LAB_0010b787;
  }
LAB_0010ba00:
  local_148 = 0;
  String::parse_latin1
            ((String *)&local_148,"Can\'t compute cost. Point with id: %d doesn\'t exist.");
  vformat<long>((CowData<char32_t> *)local_118,(long)&local_148);
  _err_print_error("_compute_cost","core/math/a_star.cpp",0x1a6,
                   "Condition \"!to_exists\" is true. Returning: 0",(CowData<char32_t> *)local_118,0
                   ,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_118);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_148);
...
/* AStar3D::_estimate_cost(long, long) */

void __thiscall AStar3D::_estimate_cost(AStar3D *this,long param_1,long param_2)
...
LAB_0010c5fb:
        ...
        pcVar8 = *(code **)(lVar5 + 200);
        if (((pcVar8 == (code *)0x0) || (*(long *)(lVar5 + 0xe0) == 0)) &&
           (pcVar8 = *(code **)(lVar5 + 0xc0), pcVar8 == (code *)0x0)) goto LAB_0010c4e7;
...
LAB_0010c4e7:
  ...
  if (pcVar8 == (code *)0x0) {
    ...
    String::parse_latin1((StrRange *)&local_148);
    vformat<long>((CowData<char32_t> *)local_118,(long)&local_148);
    _err_print_error("_estimate_cost","core/math/a_star.cpp",0x191,
                     "Condition \"!from_exists\" is true. Returning: 0",
                     (CowData<char32_t> *)local_118,0,0);
    CowData<char32_t>::_unref((CowData<char32_t> *)local_118);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_148);
    ...
    if (*(code **)(*(long *)(this + 8) + 0xe0) == (code *)0x0) {
      ...
      (**(code **)(*(long *)(this + 8) + 0xe0))
                (*(undefined8 *)(this + 0x10),this + 0x1e0,pcVar8,&local_78,local_118);
    }
  }
LAB_0010bfe7:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
...
LAB_0010c260:
  ...
  String::parse_latin1
            ((String *)&local_148,"Can\'t estimate cost. Point with id: %d doesn\'t exist.");
  vformat<long>((CowData<char32_t> *)local_118,(long)&local_148);
  _err_print_error("_estimate_cost","core/math/a_star.cpp",0x195,
                   "Condition \"!end_exists\" is true. Returning: 0",(CowData<char32_t> *)local_118,
                   0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_118);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_148);
  goto LAB_0010bfe7;
...
/* AStar2D::get_id_path(long, long, bool) */

long AStar2D::get_id_path(long param_1,long param_2,bool param_3)

{
  ...
  if (uVar14 != 0) {
    ...
    do {
      if (((uint)uVar12 == uVar14) &&
         (*(long *)(*(long *)(param_2 + 0x318) + uVar5 * 8) ==
          CONCAT71(in_register_00000011,param_3))) {
  ...
  String::parse_latin1((StrRange *)&local_60);
  vformat<long>((CowData<char32_t> *)&local_58,(long)&local_60);
  _err_print_error("get_id_path","core/math/a_star.cpp",0x2ff,
                   "Condition \"!from_exists\" is true. Returning: Vector<int64_t>()",
                   (CowData<char32_t> *)&local_58,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
  *(undefined8 *)(param_1 + 8) = 0;
...
LAB_0010c971:
    if (((uint)uVar12 == uVar14) && (*(long *)(*(long *)(param_2 + 0x318) + uVar5 * 8) == in_RCX)) {
...
LAB_0010cac8:
  ...
  String::parse_latin1((StrRange *)&local_60);
  vformat<long>((CowData<char32_t> *)&local_58,(long)&local_60);
  _err_print_error("get_id_path","core/math/a_star.cpp",0x303,
                   "Condition \"!to_exists\" is true. Returning: Vector<int64_t>()",
                   (CowData<char32_t> *)&local_58,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
  *(undefined8 *)(param_1 + 8) = 0;
...
/* AStar2D::_get_id_path_bind_compat_88047(long, long) */
...
/* AStar3D::get_id_path(long, long, bool) */

long AStar3D::get_id_path(long param_1,long param_2,bool param_3)

{
  ...
  String::parse_latin1((StrRange *)&local_60);
  vformat<long>((CowData<char32_t> *)&local_58,(long)&local_60);
  _err_print_error("get_id_path","core/math/a_star.cpp",0x1e4,
                   "Condition \"!from_exists\" is true. Returning: Vector<int64_t>()",
                   (CowData<char32_t> *)&local_58,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
  *(undefined8 *)(param_1 + 8) = 0;
  ...
  while( true ) {
    ...
    if ((uVar14 == 0) || (((uVar1 + (int)uVar5) - uVar14 % uVar1) % uVar1 < uVar11)) break;
LAB_0010cde1:
    if (((uint)uVar12 == uVar14) && (*(long *)(*(long *)(param_2 + 0x198) + uVar5 * 8) == in_RCX)) {
      pPVar8 = *(Point **)(*(long *)(param_2 + 400) + uVar5 * 8);
      if (pPVar2 == pPVar8) {
        local_50[0] = (undefined8 *)0x0;
        Vector<long>::push_back((Vector<long> *)&local_58,*(long *)pPVar2);
...
LAB_0010cf38:
  ...
  String::parse_latin1((StrRange *)&local_60);
  vformat<long>((CowData<char32_t> *)&local_58,(long)&local_60);
  _err_print_error("get_id_path","core/math/a_star.cpp",0x1e8,
                   "Condition \"!to_exists\" is true. Returning: Vector<int64_t>()",
                   (CowData<char32_t> *)&local_58,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
...
/* AStar3D::_get_id_path_bind_compat_88047(long, long) */
...
/* AStar3D::get_point_connections(long) */

long AStar3D::get_point_connections(long param_1)
...
LAB_0010d225:
  ...
  String::parse_latin1((StrRange *)&local_50);
  vformat<long>((CowData<char32_t> *)&local_48,(long)&local_50);
  _err_print_error("get_point_connections","core/math/a_star.cpp",0xe1,
                   "Condition \"!p_exists\" is true. Returning: Vector<int64_t>()",
                   (CowData<char32_t> *)&local_48,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_50);
  *(undefined8 *)(param_1 + 8) = 0;
...
/* AStar2D::get_point_connections(long) */

long AStar2D::get_point_connections(long param_1)
...
void AStar3D::get_point_ids(void)
...
/* AStar2D::get_point_ids() */

AStar2D * __thiscall AStar2D::get_point_ids(AStar2D *this)
...
/* AStar3D::is_class_ptr(void*) const */

uint __thiscall AStar3D::is_class_ptr(AStar3D *this,void *param_1)
...
/* AStar3D::_getv(StringName const&, Variant&) const */

undefined8 AStar3D::_getv(StringName *param_1,Variant *param_2)
...
/* AStar3D::_setv(StringName const&, Variant const&) */

undefined8 AStar3D::_setv(StringName *param_1,Variant *param_2)
...
/* AStar3D::_validate_propertyv(PropertyInfo&) const */

void AStar3D::_validate_propertyv(PropertyInfo *param_1)
...
/* AStar3D::_property_can_revertv(StringName const&) const */

undefined8 AStar3D::_property_can_revertv(StringName *param_1)
...
/* AStar3D::_property_get_revertv(StringName const&, Variant&) const */

undefined8 AStar3D::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* AStar3D::_notificationv(int, bool) */

void AStar3D::_notificationv(int param_1,bool param_2)
...
/* AStar2D::is_class_ptr(void*) const */

uint __thiscall AStar2D::is_class_ptr(AStar2D *this,void *param_1)
...
/* AStar2D::_getv(StringName const&, Variant&) const */

undefined8 AStar2D::_getv(StringName *param_1,Variant *param_2)
...
/* AStar2D::_setv(StringName const&, Variant const&) */

undefined8 AStar2D::_setv(StringName *param_1,Variant *param_2)
...
/* AStar2D::_validate_propertyv(PropertyInfo&) const */

void AStar2D::_validate_propertyv(PropertyInfo *param_1)
...
/* AStar2D::_property_can_revertv(StringName const&) const */

undefined8 AStar2D::_property_can_revertv(StringName *param_1)
...
/* AStar2D::_property_get_revertv(StringName const&, Variant&) const */

undefined8 AStar2D::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* AStar2D::_notificationv(int, bool) */

void AStar2D::_notificationv(int param_1,bool param_2)
...
/* MethodBindTR<Vector<Vector2>, long, long, bool>::_gen_argument_type(int) const */

char __thiscall
MethodBindTR<Vector<Vector2>,long,long,bool>::_gen_argument_type
          (MethodBindTR<Vector<Vector2>,long,long,bool> *this,int param_1)
...
/* MethodBindTR<Vector<Vector2>, long, long, bool>::get_argument_meta(int) const */

long __thiscall
MethodBindTR<Vector<Vector2>,long,long,bool>::get_argument_meta
          (MethodBindTR<Vector<Vector2>,long,long,bool> *this,int param_1)
...
/* MethodBindTRC<long, Vector2 const&, bool>::_gen_argument_type(int) const */

char __thiscall
MethodBindTRC<long,Vector2_const&,bool>::_gen_argument_type
          (MethodBindTRC<long,Vector2_const&,bool> *this,int param_1)
...
/* MethodBindTRC<long, Vector2 const&, bool>::get_argument_meta(int) const */

int __thiscall
MethodBindTRC<long,Vector2_const&,bool>::get_argument_meta
          (MethodBindTRC<long,Vector2_const&,bool> *this,int param_1)
...
/* MethodBindT<long, Vector2 const&>::_gen_argument_type(int) const */

int __thiscall
MethodBindT<long,Vector2_const&>::_gen_argument_type
          (MethodBindT<long,Vector2_const&> *this,int param_1)
...
/* MethodBindT<long, Vector2 const&>::get_argument_meta(int) const */

long __thiscall
MethodBindT<long,Vector2_const&>::get_argument_meta
          (MethodBindT<long,Vector2_const&> *this,int param_1)
...
/* MethodBindTRC<Vector2, long>::_gen_argument_type(int) const */

int __thiscall
MethodBindTRC<Vector2,long>::_gen_argument_type(MethodBindTRC<Vector2,long> *this,int param_1)
...
/* MethodBindTRC<Vector2, long>::get_argument_meta(int) const */

long __thiscall
MethodBindTRC<Vector2,long>::get_argument_meta(MethodBindTRC<Vector2,long> *this,int param_1)
...
/* MethodBindT<long, Vector2 const&, float>::get_argument_meta(int) const */

char __thiscall
MethodBindT<long,Vector2_const&,float>::get_argument_meta
          (MethodBindT<long,Vector2_const&,float> *this,int param_1)
...
/* MethodBindTR<Vector<long>, long, long, bool>::_gen_argument_type(int) const */

char __thiscall
MethodBindTR<Vector<long>,long,long,bool>::_gen_argument_type
          (MethodBindTR<Vector<long>,long,long,bool> *this,int param_1)
...
/* MethodBindTR<Vector<long>, long, long, bool>::get_argument_meta(int) const */

long __thiscall
MethodBindTR<Vector<long>,long,long,bool>::get_argument_meta
          (MethodBindTR<Vector<long>,long,long,bool> *this,int param_1)
...
/* MethodBindTR<Vector<Vector3>, long, long, bool>::_gen_argument_type(int) const */

char __thiscall
MethodBindTR<Vector<Vector3>,long,long,bool>::_gen_argument_type
          (MethodBindTR<Vector<Vector3>,long,long,bool> *this,int param_1)
...
/* MethodBindTR<Vector<Vector3>, long, long, bool>::get_argument_meta(int) const */

long __thiscall
MethodBindTR<Vector<Vector3>,long,long,bool>::get_argument_meta
          (MethodBindTR<Vector<Vector3>,long,long,bool> *this,int param_1)
...
/* MethodBindTRC<Vector3, Vector3 const&>::_gen_argument_type(int) const */

undefined8 MethodBindTRC<Vector3,Vector3_const&>::_gen_argument_type(int param_1)
...
/* MethodBindTRC<Vector3, Vector3 const&>::get_argument_meta(int) const */

undefined8 MethodBindTRC<Vector3,Vector3_const&>::get_argument_meta(int param_1)
...
/* MethodBindTRC<long, Vector3 const&, bool>::_gen_argument_type(int) const */

char __thiscall
MethodBindTRC<long,Vector3_const&,bool>::_gen_argument_type
          (MethodBindTRC<long,Vector3_const&,bool> *this,int param_1)
...
/* MethodBindTRC<long, Vector3 const&, bool>::get_argument_meta(int) const */

int __thiscall
MethodBindTRC<long,Vector3_const&,bool>::get_argument_meta
          (MethodBindTRC<long,Vector3_const&,bool> *this,int param_1)
...
/* MethodBindTRC<bool, long, long, bool>::_gen_argument_type(int) const */

char __thiscall
MethodBindTRC<bool,long,long,bool>::_gen_argument_type
          (MethodBindTRC<bool,long,long,bool> *this,int param_1)
...
/* MethodBindTRC<bool, long, long, bool>::get_argument_meta(int) const */

long __thiscall
MethodBindTRC<bool,long,long,bool>::get_argument_meta
          (MethodBindTRC<bool,long,long,bool> *this,int param_1)
...
/* MethodBindT<long, long, bool>::get_argument_meta(int) const */

long __thiscall
MethodBindT<long,long,bool>::get_argument_meta(MethodBindT<long,long,bool> *this,int param_1)
...
/* MethodBindT<long, bool>::_gen_argument_type(int) const */

char __thiscall MethodBindT<long,bool>::_gen_argument_type(MethodBindT<long,bool> *this,int param_1)
...
/* MethodBindT<long, bool>::get_argument_meta(int) const */

long __thiscall MethodBindT<long,bool>::get_argument_meta(MethodBindT<long,bool> *this,int param_1)
...
/* MethodBindTR<Vector<long>, long>::_gen_argument_type(int) const */

int __thiscall
MethodBindTR<Vector<long>,long>::_gen_argument_type
          (MethodBindTR<Vector<long>,long> *this,int param_1)
...
/* MethodBindTR<Vector<long>, long>::get_argument_meta(int) const */

long __thiscall
MethodBindTR<Vector<long>,long>::get_argument_meta
          (MethodBindTR<Vector<long>,long> *this,int param_1)
...
/* MethodBindTRC<bool, long>::_gen_argument_type(int) const */

char __thiscall
MethodBindTRC<bool,long>::_gen_argument_type(MethodBindTRC<bool,long> *this,int param_1)
...
/* MethodBindTRC<bool, long>::get_argument_meta(int) const */

long __thiscall
MethodBindTRC<bool,long>::get_argument_meta(MethodBindTRC<bool,long> *this,int param_1)
...
/* MethodBindT<long, float>::_gen_argument_type(int) const */

int __thiscall
MethodBindT<long,float>::_gen_argument_type(MethodBindT<long,float> *this,int param_1)
...
/* MethodBindT<long, float>::get_argument_meta(int) const */

char __thiscall
MethodBindT<long,float>::get_argument_meta(MethodBindT<long,float> *this,int param_1)
...
/* MethodBindTRC<float, long>::_gen_argument_type(int) const */

int __thiscall
MethodBindTRC<float,long>::_gen_argument_type(MethodBindTRC<float,long> *this,int param_1)
...
/* MethodBindTRC<float, long>::get_argument_meta(int) const */

long __thiscall
MethodBindTRC<float,long>::get_argument_meta(MethodBindTRC<float,long> *this,int param_1)
...
/* MethodBindT<long, Vector3 const&>::_gen_argument_type(int) const */

int __thiscall
MethodBindT<long,Vector3_const&>::_gen_argument_type
          (MethodBindT<long,Vector3_const&> *this,int param_1)
...
/* MethodBindT<long, Vector3 const&>::get_argument_meta(int) const */

long __thiscall
MethodBindT<long,Vector3_const&>::get_argument_meta
          (MethodBindT<long,Vector3_const&> *this,int param_1)
...
/* MethodBindTRC<Vector3, long>::_gen_argument_type(int) const */

int __thiscall
MethodBindTRC<Vector3,long>::_gen_argument_type(MethodBindTRC<Vector3,long> *this,int param_1)
...
/* MethodBindTRC<Vector3, long>::get_argument_meta(int) const */

long __thiscall
MethodBindTRC<Vector3,long>::get_argument_meta(MethodBindTRC<Vector3,long> *this,int param_1)
...
/* MethodBindT<long, Vector3 const&, float>::get_argument_meta(int) const */

char __thiscall
MethodBindT<long,Vector3_const&,float>::get_argument_meta
          (MethodBindT<long,Vector3_const&,float> *this,int param_1)
...
/* MethodBindTR<Vector<Vector2>, long, long>::_gen_argument_type(int) const */

int __thiscall
MethodBindTR<Vector<Vector2>,long,long>::_gen_argument_type
          (MethodBindTR<Vector<Vector2>,long,long> *this,int param_1)
...
/* MethodBindTR<Vector<Vector2>, long, long>::get_argument_meta(int) const */

long __thiscall
MethodBindTR<Vector<Vector2>,long,long>::get_argument_meta
          (MethodBindTR<Vector<Vector2>,long,long> *this,int param_1)
...
/* MethodBindTR<Vector<Vector3>, long, long>::_gen_argument_type(int) const */

int __thiscall
MethodBindTR<Vector<Vector3>,long,long>::_gen_argument_type
          (MethodBindTR<Vector<Vector3>,long,long> *this,int param_1)
...
/* MethodBindTR<Vector<Vector3>, long, long>::get_argument_meta(int) const */

long __thiscall
MethodBindTR<Vector<Vector3>,long,long>::get_argument_meta
          (MethodBindTR<Vector<Vector3>,long,long> *this,int param_1)
...
/* MethodBindTR<Vector<long>, long, long>::_gen_argument_type(int) const */

int __thiscall
MethodBindTR<Vector<long>,long,long>::_gen_argument_type
          (MethodBindTR<Vector<long>,long,long> *this,int param_1)
...
/* MethodBindTR<Vector<long>, long, long>::get_argument_meta(int) const */

long __thiscall
MethodBindTR<Vector<long>,long,long>::get_argument_meta
          (MethodBindTR<Vector<long>,long,long> *this,int param_1)
...
/* MethodBindT<long, long, bool>::_gen_argument_type(int) const */

char __thiscall
MethodBindT<long,long,bool>::_gen_argument_type(MethodBindT<long,long,bool> *this,int param_1)
...
/* MethodBindT<long, Vector2 const&, float>::_gen_argument_type(int) const */

char __thiscall
MethodBindT<long,Vector2_const&,float>::_gen_argument_type
          (MethodBindT<long,Vector2_const&,float> *this,int param_1)
...
/* MethodBindT<long, Vector3 const&, float>::_gen_argument_type(int) const */

undefined8 __thiscall
MethodBindT<long,Vector3_const&,float>::_gen_argument_type
          (MethodBindT<long,Vector3_const&,float> *this,int param_1)
...
/* AStar3D::_bind_compatibility_methods() [clone .cold] */
...
/* AStar2D::_bind_compatibility_methods() [clone .cold] */
...
/* AStar2D::_bind_methods() [clone .cold] */
...
/* AStar3D::_bind_methods() [clone .cold] */
...
LAB_0010f2a0:
  AStar3D::~AStar3D((AStar3D *)(this + 0x180));
  *(undefined ***)this = &PTR__initialize_classv_00128130;
  Object::~Object((Object *)this);
  return;
}
...
/* AStar3D::_get_class_namev() const */

undefined8 * AStar3D::_get_class_namev(void)
...
LAB_0010f383:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      goto LAB_0010f383;
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"AStar3D");
      goto LAB_0010f3ee;
    }
  }
  StringName::assign_static_unique_class_name
...
/* AStar2D::_get_class_namev() const */

undefined8 * AStar2D::_get_class_namev(void)
...
LAB_0010f463:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      goto LAB_0010f463;
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"AStar2D");
      goto LAB_0010f4ce;
    }
  }
  StringName::assign_static_unique_class_name
...
/* AStar3D::get_class() const */

void AStar3D::get_class(void)
...
/* AStar2D::get_class() const */

void AStar2D::get_class(void)
...
/* AStar2D::is_class(String const&) const */

undefined8 __thiscall AStar2D::is_class(AStar2D *this,String *param_1)
...
/* AStar3D::is_class(String const&) const */

undefined8 __thiscall AStar3D::is_class(AStar3D *this,String *param_1)
...
/* AStar2D::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall AStar2D::_get_property_listv(AStar2D *this,List *param_1,bool param_2)
...
/* AStar3D::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall AStar3D::_get_property_listv(AStar3D *this,List *param_1,bool param_2)
...
ulong __thiscall
OAHashMap<long,AStar3D::Point*,HashMapHasherDefault,HashMapComparatorDefault<long>>::remove
          (OAHashMap<long,AStar3D::Point*,HashMapHasherDefault,HashMapComparatorDefault<long>> *this
          ,long *param_1)

{
  ...
  uVar11 = 0;
  while ((uVar13 = (ulong)((int)uVar12 + 1), (uint)uVar16 != uVar19 ||
         (lVar6 = *(long *)(this + 8), *param_1 != *(long *)(lVar6 + uVar12 * 8)))) {
  ...
  uVar19 = *puVar17;
  if ((uVar19 == 0) ||
     (uVar11 = ((int)uVar16 + uVar4) - uVar19 % uVar4, uVar13 = (ulong)uVar11, uVar11 % uVar4 == 0))
  {
...
/* WARNING: Removing unreachable block (ram,0x001119f8) */
/* WARNING: Removing unreachable block (ram,0x00111b8d) */
...
/* WARNING: Removing unreachable block (ram,0x00111d08) */
/* WARNING: Removing unreachable block (ram,0x00111e9d) */
/* WARNING: Removing unreachable block (ram,0x00111ea9) */
...
/* WARNING: Removing unreachable block (ram,0x00112040) */
/* WARNING: Removing unreachable block (ram,0x001121d5) */
/* WARNING: Removing unreachable block (ram,0x001121e1) */
/* String vformat<unsigned int, long>(String const&, unsigned int const, long const) */

String * vformat<unsigned_int,long>(String *param_1,uint param_2,long param_3)
...
/* MethodBindT<long, float>::_gen_argument_type_info(int) const */

undefined4 * MethodBindT<long,float>::_gen_argument_type_info(int param_1)
...
MethodBind * create_method_bind<AStar3D,Vector<long>,long,long>(_func_Vector_long_long *param_1)
...
MethodBind * create_method_bind<AStar3D,Vector<Vector3>,long,long>(_func_Vector_long_long *param_1)
...
MethodBind * create_method_bind<AStar2D,Vector<long>,long,long>(_func_Vector_long_long *param_1)
...
MethodBind * create_method_bind<AStar2D,Vector<Vector2>,long,long>(_func_Vector_long_long *param_1)
...
/* HashSet<AStar3D::Segment, AStar3D::Segment, HashMapComparatorDefault<AStar3D::Segment>
   >::_lookup_pos(AStar3D::Segment const&, unsigned int&) const */

undefined8 __thiscall
HashSet<AStar3D::Segment,AStar3D::Segment,HashMapComparatorDefault<AStar3D::Segment>>::_lookup_pos
          (HashSet<AStar3D::Segment,AStar3D::Segment,HashMapComparatorDefault<AStar3D::Segment>>
           *this,Segment *param_1,uint *param_2)

{
  ...
  if (*(int *)(this + 0x24) != 0) {
    ...
    uVar12 = (uVar12 ^ uVar12 >> 0x1f) * 0x15;
    uVar12 = (uVar12 ^ uVar12 >> 0xb) * 0x41;
    uVar11 = ((ulong)((uint)(uVar12 >> 0x16) ^ (uint)uVar12) | (uVar11 >> 0x16 ^ uVar11) << 0x20) *
             0x3ffff - 1;
    uVar11 = (uVar11 ^ uVar11 >> 0x1f) * 0x15;
    uVar11 = (uVar11 ^ uVar11 >> 0xb) * 0x41;
    ...
    if (uVar15 != 0) {
      ...
      do {
        ...
        auVar9._0_8_ = uVar16;
        auVar6._8_8_ = 0;
        auVar6._0_8_ = (ulong)((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x20) * 4
                                         ) + iVar13) - SUB164(auVar5 * auVar9,8)) * lVar2;
        auVar10._8_8_ = 0;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashSet<AStar3D::Segment, AStar3D::Segment, HashMapComparatorDefault<AStar3D::Segment>
   >::insert(AStar3D::Segment const&) */

Segment * HashSet<AStar3D::Segment,AStar3D::Segment,HashMapComparatorDefault<AStar3D::Segment>>::
          insert(Segment *param_1)

{
  ...
  if (cVar24 == '\0') {
    ...
    lVar27 = *(long *)in_RSI;
    uVar25 = ((ulong)((uint)(uVar32 >> 0x16) ^ (uint)uVar32) | (uVar25 >> 0x16 ^ uVar25) << 0x20) *
             0x3ffff - 1;
    uVar25 = (uVar25 ^ uVar25 >> 0x1f) * 0x15;
    uVar25 = (uVar25 ^ uVar25 >> 0xb) * 0x41;
  ...
  if (uVar2 != 0) {
    ...
    do {
      ...
      if (uVar14 != 0) {
        ...
        uVar9 = *local_68;
        while (uVar3 != 0) {
          uVar13 = (uint)((ulong)(uint)(((int)uVar8 + (int)uVar15) - (int)((ulong)uVar3 % uVar15)) %
                         uVar15);
          uVar20 = uVar10;
          uVar21 = uVar9;
          if (uVar13 < uVar19) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* OAHashMap<long, AStar3D::Point*, HashMapHasherDefault, HashMapComparatorDefault<long> >::set(long
   const&, AStar3D::Point* const&) */

void __thiscall
OAHashMap<long,AStar3D::Point*,HashMapHasherDefault,HashMapComparatorDefault<long>>::set
          (OAHashMap<long,AStar3D::Point*,HashMapHasherDefault,HashMapComparatorDefault<long>> *this
          ,long *param_1,Point **param_2)
...
MethodBind *
create_method_bind<AStar3D,long,Vector3_const&,float>(_func_void_long_Vector3_ptr_float *param_1)
...
/* MethodBind* create_method_bind<AStar3D, Vector3, long>(Vector3 (AStar3D::*)(long) const) */

MethodBind * create_method_bind<AStar3D,Vector3,long>(_func_Vector3_long *param_1)
...
MethodBind * create_method_bind<AStar3D,long,Vector3_const&>(_func_void_long_Vector3_ptr *param_1)
...
/* MethodBind* create_method_bind<AStar3D, long, float>(void (AStar3D::*)(long, float)) */

MethodBind * create_method_bind<AStar3D,long,float>(_func_void_long_float *param_1)
...
/* MethodBind* create_method_bind<AStar3D, long>(void (AStar3D::*)(long)) */

MethodBind * create_method_bind<AStar3D,long>(_func_void_long *param_1)
...
/* MethodBind* create_method_bind<AStar3D, Vector<long>, long>(Vector<long> (AStar3D::*)(long)) */

MethodBind * create_method_bind<AStar3D,Vector<long>,long>(_func_Vector_long *param_1)
...
/* MethodBind* create_method_bind<AStar3D, Vector<long>>(Vector<long> (AStar3D::*)()) */

MethodBind * create_method_bind<AStar3D,Vector<long>>(_func_Vector *param_1)
...
/* MethodBind* create_method_bind<AStar3D, long, bool>(void (AStar3D::*)(long, bool)) */

MethodBind * create_method_bind<AStar3D,long,bool>(_func_void_long_bool *param_1)
...
/* MethodBind* create_method_bind<AStar3D, long, long, bool>(void (AStar3D::*)(long, long, bool)) */

MethodBind * create_method_bind<AStar3D,long,long,bool>(_func_void_long_long_bool *param_1)
...
/* MethodBind* create_method_bind<AStar3D>(void (AStar3D::*)()) */

MethodBind * create_method_bind<AStar3D>(_func_void *param_1)
...
MethodBind *
create_method_bind<AStar3D,long,Vector3_const&,bool>(_func_long_Vector3_ptr_bool *param_1)
...
MethodBind * create_method_bind<AStar3D,Vector3,Vector3_const&>(_func_Vector3_Vector3_ptr *param_1)
...
/* MethodBind* create_method_bind<AStar3D, Vector<Vector3>, long, long, bool>(Vector<Vector3>
   (AStar3D::*)(long, long, bool)) */

MethodBind *
create_method_bind<AStar3D,Vector<Vector3>,long,long,bool>(_func_Vector_long_long_bool *param_1)
...
MethodBind *
create_method_bind<AStar3D,Vector<long>,long,long,bool>(_func_Vector_long_long_bool *param_1)
...
MethodBind *
create_method_bind<AStar2D,long,Vector2_const&,float>(_func_void_long_Vector2_ptr_float *param_1)
...
/* MethodBind* create_method_bind<AStar2D, Vector2, long>(Vector2 (AStar2D::*)(long) const) */

MethodBind * create_method_bind<AStar2D,Vector2,long>(_func_Vector2_long *param_1)
...
MethodBind * create_method_bind<AStar2D,long,Vector2_const&>(_func_void_long_Vector2_ptr *param_1)
...
/* MethodBind* create_method_bind<AStar2D, long, float>(void (AStar2D::*)(long, float)) */

MethodBind * create_method_bind<AStar2D,long,float>(_func_void_long_float *param_1)
...
/* MethodBind* create_method_bind<AStar2D, long>(void (AStar2D::*)(long)) */

MethodBind * create_method_bind<AStar2D,long>(_func_void_long *param_1)
...
/* MethodBind* create_method_bind<AStar2D, Vector<long>, long>(Vector<long> (AStar2D::*)(long)) */

MethodBind * create_method_bind<AStar2D,Vector<long>,long>(_func_Vector_long *param_1)
...
/* MethodBind* create_method_bind<AStar2D, Vector<long>>(Vector<long> (AStar2D::*)()) */

MethodBind * create_method_bind<AStar2D,Vector<long>>(_func_Vector *param_1)
...
/* MethodBind* create_method_bind<AStar2D, long, bool>(void (AStar2D::*)(long, bool)) */

MethodBind * create_method_bind<AStar2D,long,bool>(_func_void_long_bool *param_1)
...
/* MethodBind* create_method_bind<AStar2D, long, long, bool>(void (AStar2D::*)(long, long, bool)) */

MethodBind * create_method_bind<AStar2D,long,long,bool>(_func_void_long_long_bool *param_1)
...
/* MethodBind* create_method_bind<AStar2D>(void (AStar2D::*)()) */

MethodBind * create_method_bind<AStar2D>(_func_void *param_1)
...
MethodBind *
create_method_bind<AStar2D,long,Vector2_const&,bool>(_func_long_Vector2_ptr_bool *param_1)
...
MethodBind * create_method_bind<AStar2D,Vector2,Vector2_const&>(_func_Vector2_Vector2_ptr *param_1)
...
/* MethodBind* create_method_bind<AStar2D, Vector<Vector2>, long, long, bool>(Vector<Vector2>
   (AStar2D::*)(long, long, bool)) */

MethodBind *
create_method_bind<AStar2D,Vector<Vector2>,long,long,bool>(_func_Vector_long_long_bool *param_1)
...
MethodBind *
create_method_bind<AStar2D,Vector<long>,long,long,bool>(_func_Vector_long_long_bool *param_1)
...
/* AStar2D::_initialize_classv() */

void AStar2D::_initialize_classv(void)

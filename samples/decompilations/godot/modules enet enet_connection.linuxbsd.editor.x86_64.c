...
/* ENetConnection::get_local_port() const */

undefined2 __thiscall ENetConnection::get_local_port(ENetConnection *this)

{
  ...
  if (*(long **)(this + 0x180) == (long *)0x0) {
    _err_print_error("get_local_port","modules/enet/enet_connection.cpp",0xfe,
                     "Parameter \"host\" is null.",
                     "The ENetConnection instance isn\'t currently active.",0,0);
    local_18 = 0;
  }
  else {
    lVar1 = **(long **)(this + 0x180);
    if (lVar1 == 0) {
      _err_print_error("get_local_port","modules/enet/enet_connection.cpp",0xff,
                       "Condition \"!(host->socket)\" is true. Returning: 0",
                       "The ENetConnection instance isn\'t currently bound.",0,0);
      local_18 = 0;
    }
    else {
      iVar2 = enet_socket_get_address(lVar1,auStack_28);
      if (iVar2 != 0) {
        _err_print_error("get_local_port","modules/enet/enet_connection.cpp",0x101,
                         "Condition \"enet_socket_get_address(host->socket, &address)\" is true. Returning: 0"
                         ,"Unable to get socket address",0,0);
        local_18 = 0;
      }
    }
  }
...
/* ENetConnection::dtls_server_setup(Ref<TLSOptions> const&) */

bool __thiscall ENetConnection::dtls_server_setup(ENetConnection *this,Ref *param_1)

{
  int iVar1;
  
  if (*(long *)(this + 0x180) == 0) {
    _err_print_error("dtls_server_setup","modules/enet/enet_connection.cpp",0x116,
                     "Parameter \"host\" is null.",
                     "The ENetConnection instance isn\'t currently active.",0,0);
    return (bool)3;
  }
  ...
  _err_print_error("dtls_server_setup","modules/enet/enet_connection.cpp",0x117,
...
/* ENetConnection::socket_send(String const&, int, Vector<unsigned char> const&) */

void __thiscall
ENetConnection::socket_send(ENetConnection *this,String *param_1,int param_2,Vector *param_3)

{
  ...
  if (*(long **)(this + 0x180) == (long *)0x0) {
    _err_print_error("socket_send","modules/enet/enet_connection.cpp",0x15a,
                     "Parameter \"host\" is null.",
                     "The ENetConnection instance isn\'t currently active.",0,0);
  }
  else if (**(long **)(this + 0x180) == 0) {
    _err_print_error("socket_send","modules/enet/enet_connection.cpp",0x15b,
                     "Condition \"!(host->socket)\" is true.",
                     "The ENetConnection instance isn\'t currently bound.",0,0);
  }
    ...
    if (cVar1 == '\0') {
      ...
      local_68 = local_48;
      if ((char)local_48 == '\0') {
        _err_print_error("socket_send","modules/enet/enet_connection.cpp",0x167,
                         "Condition \"!ip.is_valid()\" is true.",
                         "Couldn\'t resolve the server IP address or domain name.",0,0);
        goto LAB_001002cb;
      }
    }
    else {
    ...
    _err_print_error("socket_send","modules/enet/enet_connection.cpp",0x15c,
                     "Condition \"p_port < 1 || p_port > 65535\" is true.",
...
long ENetConnection::Compressor::enet_decompress
               (void *param_1,uchar *param_2,ulong param_3,uchar *param_4,ulong param_5)
...
/* ENetConnection::get_max_channels() const */

undefined4 __thiscall ENetConnection::get_max_channels(ENetConnection *this)

{
  if (*(long *)(this + 0x180) != 0) {
    return *(undefined4 *)(*(long *)(this + 0x180) + 0x48);
  }
  _err_print_error("get_max_channels","modules/enet/enet_connection.cpp",0xf9,
                   "Parameter \"host\" is null.",
                   "The ENetConnection instance isn\'t currently active.",0,0);
  return 0;
}
...
void __thiscall ENetConnection::flush(ENetConnection *this)

{
  ...
  _err_print_error("flush","modules/enet/enet_connection.cpp",0xc9,"Parameter \"host\" is null.",
                   "The ENetConnection instance isn\'t currently active.",0,0);
  return;
}
...
/* ENetConnection::bandwidth_limit(int, int) */

void ENetConnection::bandwidth_limit(int param_1,int param_2)

{
  ...
  _err_print_error("bandwidth_limit","modules/enet/enet_connection.cpp",0xce,
                   "Parameter \"host\" is null.",
                   "The ENetConnection instance isn\'t currently active.",0,0);
  return;
}
...
/* ENetConnection::channel_limit(int) */

void __thiscall ENetConnection::channel_limit(ENetConnection *this,int param_1)

{
  ...
  _err_print_error("channel_limit","modules/enet/enet_connection.cpp",0xd3,
                   "Parameter \"host\" is null.",
                   "The ENetConnection instance isn\'t currently active.",0,0);
  return;
}
...
/* ENetConnection::refuse_new_connections(bool) */

void __thiscall ENetConnection::refuse_new_connections(ENetConnection *this,bool param_1)

{
  ...
  _err_print_error("refuse_new_connections","modules/enet/enet_connection.cpp",0x120,
                   "Parameter \"host\" is null.",
                   "The ENetConnection instance isn\'t currently active.",0,0);
  return;
}
...
/* ENetConnection::dtls_client_setup(String const&, Ref<TLSOptions> const&) */

undefined1 __thiscall
ENetConnection::dtls_client_setup(ENetConnection *this,String *param_1,Ref *param_2)

{
  ...
  if (*(long *)(this + 0x180) == 0) {
    uVar6 = 3;
    _err_print_error("dtls_client_setup","modules/enet/enet_connection.cpp",0x129,
                     "Parameter \"host\" is null.",
                     "The ENetConnection instance isn\'t currently active.",0,0);
  }
  else {
    ...
    if ((lVar3 == 0) || (*(int *)(lVar3 + 0x17c) == 2)) {
      uVar6 = 0x1f;
      _err_print_error("dtls_client_setup","modules/enet/enet_connection.cpp",0x12a,
                       "Condition \"p_options.is_null() || p_options->is_server()\" is true. Returning: ERR_INVALID_PARAMETER"
                       ,0,0);
    }
    else {
...
void __thiscall ENetConnection::destroy(ENetConnection *this)

{
  ...
  if (*(long *)(this + 0x180) == 0) {
    _err_print_error("destroy","modules/enet/enet_connection.cpp",0x4a,"Parameter \"host\" is null."
                     ,"Host already destroyed.",0,0);
    return;
  }
...
LAB_00100985:
  enet_host_destroy(*(undefined8 *)(this + 0x180));
...
/* ENetConnection::bandwidth_throttle() */

void __thiscall ENetConnection::bandwidth_throttle(ENetConnection *this)

{
  ...
  _err_print_error("bandwidth_throttle","modules/enet/enet_connection.cpp",0xd8,
                   "Parameter \"host\" is null.",
                   "The ENetConnection instance isn\'t currently active.",0,0);
  return;
}
...
/* ENetConnection::get_peers(List<Ref<ENetPacketPeer>, DefaultAllocator>&) */

void __thiscall ENetConnection::get_peers(ENetConnection *this,List *param_1)
...
/* ENetConnection::_create(_ENetAddress*, int, int, int, int) */

undefined8 __thiscall
ENetConnection::_create
          (ENetConnection *this,_ENetAddress *param_1,int param_2,int param_3,int param_4,
          int param_5)

{
  ...
  if (*(long *)(this + 0x180) != 0) {
    _err_print_error("_create","modules/enet/enet_connection.cpp",0x132,
                     "Condition \"host != nullptr\" is true. Returning: ERR_ALREADY_IN_USE",
                     "The ENetConnection instance is already active.",0,0);
    return 0x16;
  }
  if (param_2 - 1U < 0xfff) {
    if ((uint)param_3 < 0x100) {
      if (param_4 < 0) {
        _err_print_error("_create","modules/enet/enet_connection.cpp",0x135,
                         "Condition \"p_in_bandwidth < 0\" is true. Returning: ERR_INVALID_PARAMETER"
                         ,
                         "The incoming bandwidth limit must be greater than or equal to 0 (0 disables the limit)."
                         ,0,0);
      }
      else {
        if (-1 < param_5) {
          ...
          *(long *)(this + 0x180) = lVar1;
          ...
          _err_print_error("_create","modules/enet/enet_connection.cpp",0x13e,
                           "Parameter \"host\" is null.","Couldn\'t create an ENet host.",0,0);
          return 0x14;
        }
        _err_print_error("_create","modules/enet/enet_connection.cpp",0x136,
                         "Condition \"p_out_bandwidth < 0\" is true. Returning: ERR_INVALID_PARAMETER"
                         ,
                         "The outgoing bandwidth limit must be greater than or equal to 0 (0 disables the limit)."
                         ,0,0);
      }
    }
    else {
      _err_print_error("_create","modules/enet/enet_connection.cpp",0x134,
                       "Condition \"p_max_channels < 0 || p_max_channels > ENET_PROTOCOL_MAXIMUM_CHANNEL_COUNT\" is true. Returning: ERR_INVALID_PARAMETER"
                       ,
                       "Invalid channel count. Must be between 0 and 255 (0 means maximum, i.e. 255)"
                       ,0,0);
    }
  }
  else {
    _err_print_error("_create","modules/enet/enet_connection.cpp",0x133,
                     "Condition \"p_max_peers < 1 || p_max_peers > 4095\" is true. Returning: ERR_INVALID_PARAMETER"
                     ,"The number of clients must be set between 1 and 4095 (inclusive).",0,0);
  }
  return 0x1f;
}
...
/* ENetConnection::create_host_bound(IPAddress const&, int, int, int, int, int) */

undefined8 __thiscall
ENetConnection::create_host_bound
          (ENetConnection *this,IPAddress *param_1,int param_2,int param_3,int param_4,int param_5,
          int param_6)

{
  ...
  if (param_1[0x10] == (IPAddress)0x0) {
    ...
    _err_print_error("create_host_bound","modules/enet/enet_connection.cpp",0x2e,
    ...
    if ((uint)param_2 < 0x10000) {
      local_48[0] = (_ENetAddress)0x0;
      local_48[1] = (_ENetAddress)0x0;
      local_48[2] = (_ENetAddress)0x0;
      local_48[3] = (_ENetAddress)0x0;
      local_48[4] = (_ENetAddress)0x0;
      local_48[5] = (_ENetAddress)0x0;
      local_48[6] = (_ENetAddress)0x0;
      local_48[7] = (_ENetAddress)0x0;
      local_48[8] = (_ENetAddress)0x0;
      local_48[9] = (_ENetAddress)0x0;
      local_48[10] = (_ENetAddress)0x0;
      local_48[0xb] = (_ENetAddress)0x0;
      local_48[0xc] = (_ENetAddress)0x0;
      local_48[0xd] = (_ENetAddress)0x0;
      local_48[0xe] = (_ENetAddress)0x0;
      local_48[0xf] = (_ENetAddress)0x0;
...
LAB_001010b0:
    _err_print_error("create_host_bound","modules/enet/enet_connection.cpp",0x2f,
...
/* ENetConnection::create_host(int, int, int, int) */

void __thiscall
ENetConnection::create_host(ENetConnection *this,int param_1,int param_2,int param_3,int param_4)
...
/* ENetConnection::Compressor::setup(_ENetHost*, ENetConnection::CompressionMode) */

void ENetConnection::Compressor::setup(long param_1,uint param_2)

{
  uint *puVar1;
  
  if (param_1 == 0) {
    _err_print_error("setup","modules/enet/enet_connection.cpp",500,"Parameter \"p_host\" is null.",
                     0,0);
    return;
  }
  if (param_2 == 1) {
...
/* ENetConnection::compress(ENetConnection::CompressionMode) */

void ENetConnection::compress(long param_1)

{
  ...
  _err_print_error("compress","modules/enet/enet_connection.cpp",0xdd,"Parameter \"host\" is null.",
                   "The ENetConnection instance isn\'t currently active.",0,0);
  return;
}
...
/* ENetConnection::Compressor::Compressor(ENetConnection::CompressionMode) */

void __thiscall ENetConnection::Compressor::Compressor(Compressor *this,undefined4 param_2)
...
/* ENetConnection::pop_statistic(ENetConnection::HostStatistic) */

double __thiscall ENetConnection::pop_statistic(ENetConnection *this,uint param_2)

{
  ...
  if (lVar2 == 0) {
    _err_print_error("pop_statistic","modules/enet/enet_connection.cpp",0xe2,
                     "Parameter \"host\" is null.",
                     "The ENetConnection instance isn\'t currently active.",0,0);
LAB_0010141f:
    dVar4 = 0.0;
    ...
    if (param_2 == 2) {
      ...
      if (param_2 != 3) {
        ...
        itos((long)local_60);
        operator+((char *)local_58,(String *)"Invalid statistic: ");
        String::operator+((String *)&local_48,(String *)local_58);
        _err_print_error("pop_statistic","modules/enet/enet_connection.cpp",0xf2,
                         "Parameter \"ptr\" is null.",(String *)&local_48,0,0);
...
/* ENetConnection::broadcast(unsigned char, _ENetPacket*) */

void ENetConnection::broadcast(uchar param_1,_ENetPacket *param_2)

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  if (lVar1 == 0) {
    _err_print_error("broadcast","modules/enet/enet_connection.cpp",0x28,
                     "Parameter \"host\" is null.",
                     "The ENetConnection instance isn\'t currently active.",0,0);
  }
  else {
    ...
    String::parse_latin1((StrRange *)&local_50);
    vformat<unsigned_char,int>
              ((String *)&local_48,(uchar)(StrRange *)&local_50,(int)((ulong)param_2 & 0xff));
    _err_print_error("broadcast","modules/enet/enet_connection.cpp",0x29,
                     "Condition \"p_channel >= host->channelLimit\" is true.",(String *)&local_48,0,
                     0);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_50);
  }
...
/* ENetConnection::_broadcast(int, Vector<unsigned char>, int) */

undefined8 __thiscall
ENetConnection::_broadcast(ENetConnection *this,uint param_1,long param_3,uint param_4)

{
  ...
  if (*(long *)(this + 0x180) == 0) {
    uVar2 = _err_print_error("_broadcast","modules/enet/enet_connection.cpp",0x152,
                             "Parameter \"host\" is null.",
                             "The ENetConnection instance isn\'t currently active.",0,0);
    return uVar2;
  }
  if (((int)param_1 < 0) || (*(int *)(*(long *)(this + 0x180) + 0x48) < (int)param_1)) {
    uVar2 = _err_print_error("_broadcast","modules/enet/enet_connection.cpp",0x153,
                             "Condition \"p_channel < 0 || p_channel > (int)host->channelLimit\" is true."
                             ,"Invalid channel",0,0);
  }
  else {
    ...
    uVar2 = 0;
    _err_print_error("_broadcast","modules/enet/enet_connection.cpp",0x154,
                     "Condition \"p_flags & ~ENetPacketPeer::FLAG_ALLOWED\" is true.",
                     "Invalid flags",0);
  }
  return uVar2;
}
...
/* ENetConnection::_get_peers() */

void ENetConnection::_get_peers(void)

{
  ...
  if (*(long *)(in_RSI + 0x180) == 0) {
    _err_print_error("_get_peers","modules/enet/enet_connection.cpp",0x10c,
                     "Parameter \"host\" is null.",
                     "The ENetConnection instance isn\'t currently active.",0,0);
    ...
    if (*(undefined8 **)(in_RSI + 0x188) != (undefined8 *)0x0) {
      for (puVar2 = (undefined8 *)**(undefined8 **)(in_RSI + 0x188); puVar2 != (undefined8 *)0x0;
...
/* ENetConnection::_parse_event(_ENetEvent const&, ENetConnection::Event&) */

undefined8 __thiscall
ENetConnection::_parse_event(ENetConnection *this,_ENetEvent *param_1,Event *param_2)

{
  ...
  if (iVar1 == 2) {
    ...
    if (pOVar9 != (Object *)0x0) {
      ...
      if (plVar4 != (long *)0x0) {
        for (this_00 = (Ref<ENetPacketPeer> *)*plVar4; this_00 != (Ref<ENetPacketPeer> *)0x0;
            this_00 = *(Ref<ENetPacketPeer> **)(this_00 + 8)) {
...
LAB_00101fb2:
      ...
      *pauVar6 = (undefined1  [16])0x0;
      pauVar6[1] = (undefined1  [16])0x0;
LAB_00101f93:
      *(ENetPacketPeer **)*pauVar6 = this_01;
      cVar5 = RefCounted::reference();
      if (cVar5 == '\0') {
    ...
    if (cVar5 == '\0') {
      ...
      if (pOVar10 != pOVar9) {
        *(Object **)param_2 = pOVar9;
        ...
        if (((pOVar10 != (Object *)0x0) && (cVar5 = RefCounted::unreference(), cVar5 != '\0')) &&
           (cVar5 = predelete_handler(pOVar10), cVar5 != '\0')) goto LAB_00101dcb;
      }
LAB_00101cb6:
      cVar5 = RefCounted::unreference();
      if ((cVar5 != '\0') && (cVar5 = predelete_handler(pOVar9), cVar5 != '\0')) {
...
/* ENetConnection::check_events(ENetConnection::EventType&, ENetConnection::Event&) */

int __thiscall ENetConnection::check_events(ENetConnection *this,EventType *param_1,Event *param_2)

{
  ...
  if (*(long *)(this + 0x180) == 0) {
    iVar1 = -1;
    _err_print_error("check_events","modules/enet/enet_connection.cpp",0xbd,
                     "Parameter \"host\" is null.",
                     "The ENetConnection instance isn\'t currently active.",0,0);
  }
  else {
...
/* ENetConnection::service(int, ENetConnection::Event&) */

undefined8 __thiscall ENetConnection::service(ENetConnection *this,int param_1,Event *param_2)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (lVar7 == 0) {
    _err_print_error("service","modules/enet/enet_connection.cpp",0xa3,"Parameter \"host\" is null."
                     ,"The ENetConnection instance isn\'t currently active.",0,0);
  }
  else if (*(long *)param_2 == 0) {
    if ((*(long **)(this + 0x188) != (long *)0x0) &&
       (plVar9 = (long *)**(long **)(this + 0x188), plVar9 != (long *)0x0)) {
      do {
...
joined_r0x0010226a:
    ...
    _err_print_error("service","modules/enet/enet_connection.cpp",0xa4,
                     "Condition \"r_event.peer.is_valid()\" is true. Returning: EVENT_ERROR",0,0);
  }
  uVar8 = 0xffffffff;
LAB_00102292:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
Array * ENetConnection::_service(int param_1)
...
/* ENetConnection::connect_to_host(String const&, int, int, int) */

String * ENetConnection::connect_to_host(String *param_1,int param_2,int param_3,int param_4)

{
  ...
  if (*(long *)(lVar7 + 0x180) == 0) {
    ...
    if (param_4 - 1U < 0xffff) {
      ...
      p_Var4 = (_ENetPeer *)
               enet_host_connect(*(undefined8 *)(lVar7 + 0x180),local_58,(long)in_R8D,in_R9D);
...
LAB_001028dc:
  _err_print_error("connect_to_host","modules/enet/enet_connection.cpp",uVar3,pcVar6,pcVar8,0,0);
  *(undefined8 *)param_1 = 0;
LAB_001027fd:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return param_1;
...
void ENetConnection::_bind_methods(void)

{
  ...
  pMVar6 = create_method_bind<ENetConnection,Error,IPAddress_const&,int,int,int,int,int>
                     (create_host_bound);
  ...
  local_b8 = local_188;
  pMVar6 = create_method_bind<ENetConnection,Ref<ENetPacketPeer>,String_const&,int,int,int>
                     (connect_to_host);
  ...
  pVStack_a0 = (Variant *)0x0;
  local_138 = (Variant *)&local_b8;
  pMVar6 = create_method_bind<ENetConnection,Error,String_const&,Ref<TLSOptions>const&>
                     (dtls_client_setup);
  ClassDB::bind_methodfi(1,pMVar6,false,(MethodDefinition *)&local_368,&local_138,1);
  if (Variant::needs_deinit[(int)pVStack_a0] != '\0') {
    Variant::_clear_internal();
  ...
  auStack_b0 = (undefined1  [16])0x0;
  local_b8 = (Variant *)0x0;
  pMVar6 = create_method_bind<ENetConnection,String_const&,int,Vector<unsigned_char>const&>
                     (socket_send);
  ClassDB::bind_methodfi(1,pMVar6,false,(MethodDefinition *)&local_368,(Variant **)0x0,0);
  if (Variant::needs_deinit[(int)local_b8] != '\0') {
    Variant::_clear_internal();
  ...
  GetTypeInfo<ENetConnection::CompressionMode,void>::get_class_info
            ((GetTypeInfo<ENetConnection::CompressionMode,void> *)&local_368);
  ...
  ClassDB::bind_integer_constant
            ((StringName *)&local_368,(StringName *)&local_378,(StringName *)&local_370,0,false);
  if ((StringName::configured != '\0') && (local_368 != (char *)0x0)) {
    StringName::unref();
  }
  ...
  StringName::StringName((StringName *)&local_368,(String *)&local_388,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_368,(StringName *)&local_378,(StringName *)&local_370,1,false);
  if ((StringName::configured != '\0') && (local_368 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_388);
  ...
  StringName::StringName((StringName *)&local_368,(String *)&local_388,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_368,(StringName *)&local_378,(StringName *)&local_370,2,false);
  if ((StringName::configured != '\0') && (local_368 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_388);
  ...
  StringName::StringName((StringName *)&local_368,(String *)&local_388,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_368,(StringName *)&local_378,(StringName *)&local_370,3,false);
  if ((StringName::configured != '\0') && (local_368 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_388);
  ...
  StringName::StringName((StringName *)&local_368,(String *)&local_388,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_368,(StringName *)&local_378,(StringName *)&local_370,4,false);
  if ((StringName::configured != '\0') && (local_368 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_388);
  ...
  ClassDB::bind_integer_constant
            ((StringName *)&local_368,(StringName *)&local_370,(StringName *)&local_398,-1,false);
  if ((StringName::configured != '\0') && (local_368 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_378);
  ...
  StringName::StringName((StringName *)&local_368,(String *)&local_378,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_368,(StringName *)&local_370,(StringName *)&local_398,0,false);
  if ((StringName::configured != '\0') && (local_368 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_378);
  ...
  StringName::StringName((StringName *)&local_368,(String *)&local_378,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_368,(StringName *)&local_370,(StringName *)&local_398,2,false);
  if ((StringName::configured != '\0') && (local_368 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_378);
  ...
  StringName::StringName((StringName *)&local_368,(String *)&local_378,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_368,(StringName *)&local_370,(StringName *)&local_398,3,false);
  if ((StringName::configured != '\0') && (local_368 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_378);
  ...
  GetTypeInfo<ENetConnection::HostStatistic,void>::get_class_info
            ((GetTypeInfo<ENetConnection::HostStatistic,void> *)&local_368);
  local_378 = local_360._8_8_;
  local_360._8_8_ = 0;
  PropertyInfo::~PropertyInfo((PropertyInfo *)&local_368);
  local_388 = 0;
...
size_t ENetConnection::Compressor::enet_compress
                 (void *param_1,ENetBuffer *param_2,ulong param_3,ulong param_4,uchar *param_5,
                 ulong param_6)
...
LAB_001059e8:
      CowData<unsigned_char>::resize<false>
                ((CowData<unsigned_char> *)((long)param_1 + 0x10),param_4);
    }
...
LAB_00105994:
        ...
        _err_print_index_error
                  ("operator[]","./core/templates/vector.h",0x38,lVar9,lVar7,"p_index",
  ...
  if (uVar5 < 3) {
    ...
    if (lVar9 < iVar4) {
      CowData<unsigned_char>::resize<false>
                ((CowData<unsigned_char> *)((long)param_1 + 0x20),(long)iVar4);
    }
    ...
    if ((-1 < iVar12) && (local_78 = (int)param_6, iVar12 <= local_78)) {
      __n = (size_t)iVar12;
    ...
    String::parse_latin1((StrRange *)&local_60);
    vformat<ENetConnection::CompressionMode>
              ((CowData<char32_t> *)&local_58,(StrRange *)&local_60,iVar4);
    _err_print_error("enet_compress","modules/enet/enet_connection.cpp",0x1c5,
...
{
  return (uint)CONCAT71(0x115f,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr) |
...
/* ENetConnection::is_class_ptr(void*) const */

uint __thiscall ENetConnection::is_class_ptr(ENetConnection *this,void *param_1)

{
  return (uint)CONCAT71(0x115f,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x115f,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
...
/* ENetConnection::_getv(StringName const&, Variant&) const */

undefined8 ENetConnection::_getv(StringName *param_1,Variant *param_2)
...
/* ENetConnection::_setv(StringName const&, Variant const&) */

undefined8 ENetConnection::_setv(StringName *param_1,Variant *param_2)
...
/* ENetConnection::_validate_propertyv(PropertyInfo&) const */

void ENetConnection::_validate_propertyv(PropertyInfo *param_1)
...
/* ENetConnection::_property_can_revertv(StringName const&) const */

undefined8 ENetConnection::_property_can_revertv(StringName *param_1)
...
/* ENetConnection::_property_get_revertv(StringName const&, Variant&) const */

undefined8 ENetConnection::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* ENetConnection::_notificationv(int, bool) */

void ENetConnection::_notificationv(int param_1,bool param_2)
...
/* MethodBindT<String const&, int, Vector<unsigned char> const&>::get_argument_meta(int) const */

char __thiscall
MethodBindT<String_const&,int,Vector<unsigned_char>const&>::get_argument_meta
          (MethodBindT<String_const&,int,Vector<unsigned_char>const&> *this,int param_1)
...
/* MethodBindTR<TypedArray<ENetPacketPeer>>::_gen_argument_type(int) const */

undefined8 MethodBindTR<TypedArray<ENetPacketPeer>>::_gen_argument_type(int param_1)
...
/* MethodBindTR<TypedArray<ENetPacketPeer>>::get_argument_meta(int) const */

undefined8 MethodBindTR<TypedArray<ENetPacketPeer>>::get_argument_meta(int param_1)
...
/* MethodBindTR<double, ENetConnection::HostStatistic>::_gen_argument_type(int) const */

int __thiscall
MethodBindTR<double,ENetConnection::HostStatistic>::_gen_argument_type
          (MethodBindTR<double,ENetConnection::HostStatistic> *this,int param_1)
...
/* MethodBindTR<double, ENetConnection::HostStatistic>::get_argument_meta(int) const */

uint __thiscall
MethodBindTR<double,ENetConnection::HostStatistic>::get_argument_meta
          (MethodBindTR<double,ENetConnection::HostStatistic> *this,int param_1)
...
/* MethodBindTR<Error, String const&, Ref<TLSOptions> const&>::_gen_argument_type(int) const */

int __thiscall
MethodBindTR<Error,String_const&,Ref<TLSOptions>const&>::_gen_argument_type
          (MethodBindTR<Error,String_const&,Ref<TLSOptions>const&> *this,int param_1)
...
/* MethodBindTR<Error, String const&, Ref<TLSOptions> const&>::get_argument_meta(int) const */

undefined8 MethodBindTR<Error,String_const&,Ref<TLSOptions>const&>::get_argument_meta(int param_1)
...
/* MethodBindTR<Error, Ref<TLSOptions> const&>::_gen_argument_type(int) const */

char __thiscall
MethodBindTR<Error,Ref<TLSOptions>const&>::_gen_argument_type
          (MethodBindTR<Error,Ref<TLSOptions>const&> *this,int param_1)
...
/* MethodBindTR<Error, Ref<TLSOptions> const&>::get_argument_meta(int) const */

undefined8 MethodBindTR<Error,Ref<TLSOptions>const&>::get_argument_meta(int param_1)
...
/* MethodBindT<ENetConnection::CompressionMode>::_gen_argument_type(int) const */

char __thiscall
MethodBindT<ENetConnection::CompressionMode>::_gen_argument_type
          (MethodBindT<ENetConnection::CompressionMode> *this,int param_1)
...
/* MethodBindT<ENetConnection::CompressionMode>::get_argument_meta(int) const */

undefined8 MethodBindT<ENetConnection::CompressionMode>::get_argument_meta(int param_1)
...
/* MethodBindT<int, Vector<unsigned char>, int>::get_argument_meta(int) const */

byte __thiscall
MethodBindT<int,Vector<unsigned_char>,int>::get_argument_meta
          (MethodBindT<int,Vector<unsigned_char>,int> *this,int param_1)
...
/* MethodBindTR<Ref<ENetPacketPeer>, String const&, int, int, int>::_gen_argument_type(int) const */

char __thiscall
MethodBindTR<Ref<ENetPacketPeer>,String_const&,int,int,int>::_gen_argument_type
          (MethodBindTR<Ref<ENetPacketPeer>,String_const&,int,int,int> *this,int param_1)
...
/* MethodBindTR<Ref<ENetPacketPeer>, String const&, int, int, int>::get_argument_meta(int) const */

byte __thiscall
MethodBindTR<Ref<ENetPacketPeer>,String_const&,int,int,int>::get_argument_meta
          (MethodBindTR<Ref<ENetPacketPeer>,String_const&,int,int,int> *this,int param_1)
...
/* MethodBindTR<Error, int, int, int, int>::_gen_argument_type(int) const */

undefined8 MethodBindTR<Error,int,int,int,int>::_gen_argument_type(int param_1)
...
/* MethodBindTR<Error, int, int, int, int>::get_argument_meta(int) const */

byte __thiscall
MethodBindTR<Error,int,int,int,int>::get_argument_meta
          (MethodBindTR<Error,int,int,int,int> *this,int param_1)
...
/* MethodBindTR<Error, IPAddress const&, int, int, int, int, int>::_gen_argument_type(int) const */

char __thiscall
MethodBindTR<Error,IPAddress_const&,int,int,int,int,int>::_gen_argument_type
          (MethodBindTR<Error,IPAddress_const&,int,int,int,int,int> *this,int param_1)
...
/* MethodBindTR<Error, IPAddress const&, int, int, int, int, int>::get_argument_meta(int) const */

byte __thiscall
MethodBindTR<Error,IPAddress_const&,int,int,int,int,int>::get_argument_meta
          (MethodBindTR<Error,IPAddress_const&,int,int,int,int,int> *this,int param_1)
...
/* MethodBindTR<Error, IPAddress const&, int, int, int, int, int>::~MethodBindTR() */

void __thiscall
MethodBindTR<Error,IPAddress_const&,int,int,int,int,int>::~MethodBindTR
          (MethodBindTR<Error,IPAddress_const&,int,int,int,int,int> *this)
...
/* MethodBindTR<Error, int, int, int, int>::~MethodBindTR() */

void __thiscall
MethodBindTR<Error,int,int,int,int>::~MethodBindTR(MethodBindTR<Error,int,int,int,int> *this)
...
/* MethodBindTR<Ref<ENetPacketPeer>, String const&, int, int, int>::~MethodBindTR() */

void __thiscall
MethodBindTR<Ref<ENetPacketPeer>,String_const&,int,int,int>::~MethodBindTR
          (MethodBindTR<Ref<ENetPacketPeer>,String_const&,int,int,int> *this)
...
/* MethodBindT<int, Vector<unsigned char>, int>::~MethodBindT() */

void __thiscall
MethodBindT<int,Vector<unsigned_char>,int>::~MethodBindT
          (MethodBindT<int,Vector<unsigned_char>,int> *this)
...
/* MethodBindT<ENetConnection::CompressionMode>::~MethodBindT() */

void __thiscall
MethodBindT<ENetConnection::CompressionMode>::~MethodBindT
          (MethodBindT<ENetConnection::CompressionMode> *this)
...
/* MethodBindTR<Error, Ref<TLSOptions> const&>::~MethodBindTR() */

void __thiscall
MethodBindTR<Error,Ref<TLSOptions>const&>::~MethodBindTR
          (MethodBindTR<Error,Ref<TLSOptions>const&> *this)
...
/* MethodBindTR<Error, String const&, Ref<TLSOptions> const&>::~MethodBindTR() */

void __thiscall
MethodBindTR<Error,String_const&,Ref<TLSOptions>const&>::~MethodBindTR
          (MethodBindTR<Error,String_const&,Ref<TLSOptions>const&> *this)
...
/* MethodBindTR<double, ENetConnection::HostStatistic>::~MethodBindTR() */

void __thiscall
MethodBindTR<double,ENetConnection::HostStatistic>::~MethodBindTR
          (MethodBindTR<double,ENetConnection::HostStatistic> *this)
...
/* MethodBindTR<TypedArray<ENetPacketPeer>>::~MethodBindTR() */

void __thiscall
MethodBindTR<TypedArray<ENetPacketPeer>>::~MethodBindTR
          (MethodBindTR<TypedArray<ENetPacketPeer>> *this)
...
/* MethodBindT<String const&, int, Vector<unsigned char> const&>::~MethodBindT() */

void __thiscall
MethodBindT<String_const&,int,Vector<unsigned_char>const&>::~MethodBindT
          (MethodBindT<String_const&,int,Vector<unsigned_char>const&> *this)
...
/* MethodBindT<String const&, int, Vector<unsigned char> const&>::_gen_argument_type(int) const */

undefined8 __thiscall
MethodBindT<String_const&,int,Vector<unsigned_char>const&>::_gen_argument_type
          (MethodBindT<String_const&,int,Vector<unsigned_char>const&> *this,int param_1)

{
  ...
  uVar1 = 0;
  if ((((uint)param_1 < 3) && (uVar1 = 4, param_1 != 0)) && (uVar1 = 0x1d, param_1 == 1)) {
    uVar1 = 2;
  }
  return uVar1;
}
...
/* MethodBindT<int, Vector<unsigned char>, int>::_gen_argument_type(int) const */

undefined8 __thiscall
MethodBindT<int,Vector<unsigned_char>,int>::_gen_argument_type
          (MethodBindT<int,Vector<unsigned_char>,int> *this,int param_1)
...
/* ENetConnection::_bind_methods() [clone .cold] */
...
/* ENetConnection::_get_class_namev() const */

undefined8 * ENetConnection::_get_class_namev(void)
...
LAB_00107643:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      goto LAB_00107643;
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"ENetConnection");
      goto LAB_001076ae;
    }
  }
  StringName::assign_static_unique_class_name
...
/* ENetConnection::Compressor::enet_compressor_destroy(void*) */

void ENetConnection::Compressor::enet_compressor_destroy(void *param_1)
...
/* ENetConnection::get_class() const */

void ENetConnection::get_class(void)
...
/* ENetConnection::is_class(String const&) const */

undefined8 __thiscall ENetConnection::is_class(ENetConnection *this,String *param_1)
...
/* MethodBindTR<TypedArray<ENetPacketPeer>>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTR<TypedArray<ENetPacketPeer>>::_gen_argument_type_info(int param_1)
...
/* ENetConnection::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall ENetConnection::_get_property_listv(ENetConnection *this,List *param_1,bool param_2)
...
/* WARNING: Removing unreachable block (ram,0x00108d40) */
/* WARNING: Removing unreachable block (ram,0x00108ed5) */
/* WARNING: Removing unreachable block (ram,0x00108ee1) */
/* String vformat<unsigned char, int>(String const&, unsigned char const, int const) */

String * vformat<unsigned_char,int>(String *param_1,uchar param_2,int param_3)
...
/* WARNING: Removing unreachable block (ram,0x00109038) */
/* WARNING: Removing unreachable block (ram,0x001091cd) */
/* WARNING: Removing unreachable block (ram,0x001091d9) */
/* String vformat<ENetConnection::CompressionMode>(String const&, ENetConnection::CompressionMode
   const) */

undefined8 * vformat<ENetConnection::CompressionMode>(undefined8 *param_1,bool *param_2,int param_3)
...
GetTypeInfo<ENetConnection::CompressionMode,void> * __thiscall
GetTypeInfo<ENetConnection::CompressionMode,void>::get_class_info
...
GetTypeInfo<ENetConnection::HostStatistic,void> * __thiscall
GetTypeInfo<ENetConnection::HostStatistic,void>::get_class_info
...
/* MethodBindTR<double, ENetConnection::HostStatistic>::_gen_argument_type_info(int) const */

undefined4 *
MethodBindTR<double,ENetConnection::HostStatistic>::_gen_argument_type_info(int param_1)

{
  ...
  if (in_EDX == 0) {
    ...
    local_90._8_8_ = 0;
    GetTypeInfo<ENetConnection::HostStatistic,void>::get_class_info
              ((GetTypeInfo<ENetConnection::HostStatistic,void> *)&local_68);
...
/* MethodBindT<ENetConnection::CompressionMode>::_gen_argument_type_info(int) const */

undefined4 * MethodBindT<ENetConnection::CompressionMode>::_gen_argument_type_info(int param_1)
...
/* MethodBind* create_method_bind<ENetConnection, Error, IPAddress const&, int, int, int, int,
   int>(Error (ENetConnection::*)(IPAddress const&, int, int, int, int, int)) */

MethodBind *
create_method_bind<ENetConnection,Error,IPAddress_const&,int,int,int,int,int>
          (_func_Error_IPAddress_ptr_int_int_int_int_int *param_1)
...
/* MethodBind* create_method_bind<ENetConnection, Error, int, int, int, int>(Error
   (ENetConnection::*)(int, int, int, int)) */

MethodBind *
create_method_bind<ENetConnection,Error,int,int,int,int>(_func_Error_int_int_int_int *param_1)
...
/* MethodBind* create_method_bind<ENetConnection>(void (ENetConnection::*)()) */

MethodBind * create_method_bind<ENetConnection>(_func_void *param_1)
...
/* MethodBind* create_method_bind<ENetConnection, Ref<ENetPacketPeer>, String const&, int, int,
   int>(Ref<ENetPacketPeer> (ENetConnection::*)(String const&, int, int, int)) */

MethodBind *
create_method_bind<ENetConnection,Ref<ENetPacketPeer>,String_const&,int,int,int>
          (_func_Ref_String_ptr_int_int_int *param_1)
...
/* MethodBind* create_method_bind<ENetConnection, Array, int>(Array (ENetConnection::*)(int)) */

MethodBind * create_method_bind<ENetConnection,Array,int>(_func_Array_int *param_1)
...
/* MethodBind* create_method_bind<ENetConnection, int, int>(void (ENetConnection::*)(int, int)) */

MethodBind * create_method_bind<ENetConnection,int,int>(_func_void_int_int *param_1)
...
/* MethodBind* create_method_bind<ENetConnection, int>(void (ENetConnection::*)(int)) */

MethodBind * create_method_bind<ENetConnection,int>(_func_void_int *param_1)
...
/* MethodBind* create_method_bind<ENetConnection, int, Vector<unsigned char>, int>(void
   (ENetConnection::*)(int, Vector<unsigned char>, int)) */

MethodBind *
create_method_bind<ENetConnection,int,Vector<unsigned_char>,int>(_func_void_int_Vector_int *param_1)
...
/* MethodBind* create_method_bind<ENetConnection, ENetConnection::CompressionMode>(void
   (ENetConnection::*)(ENetConnection::CompressionMode)) */

MethodBind *
create_method_bind<ENetConnection,ENetConnection::CompressionMode>
          (_func_void_CompressionMode *param_1)
...
/* MethodBind* create_method_bind<ENetConnection, Error, Ref<TLSOptions> const&>(Error
   (ENetConnection::*)(Ref<TLSOptions> const&)) */

MethodBind *
create_method_bind<ENetConnection,Error,Ref<TLSOptions>const&>(_func_Error_Ref_ptr *param_1)
...
/* MethodBind* create_method_bind<ENetConnection, Error, String const&, Ref<TLSOptions>
   const&>(Error (ENetConnection::*)(String const&, Ref<TLSOptions> const&)) */

MethodBind *
create_method_bind<ENetConnection,Error,String_const&,Ref<TLSOptions>const&>
          (_func_Error_String_ptr_Ref_ptr *param_1)
...
/* MethodBind* create_method_bind<ENetConnection, bool>(void (ENetConnection::*)(bool)) */

MethodBind * create_method_bind<ENetConnection,bool>(_func_void_bool *param_1)
...
/* MethodBind* create_method_bind<ENetConnection, double, ENetConnection::HostStatistic>(double
   (ENetConnection::*)(ENetConnection::HostStatistic)) */

MethodBind *
create_method_bind<ENetConnection,double,ENetConnection::HostStatistic>
          (_func_double_HostStatistic *param_1)
...
/* MethodBind* create_method_bind<ENetConnection, int>(int (ENetConnection::*)() const) */

MethodBind * create_method_bind<ENetConnection,int>(_func_int *param_1)
...
/* MethodBind* create_method_bind<ENetConnection,
   TypedArray<ENetPacketPeer>>(TypedArray<ENetPacketPeer> (ENetConnection::*)()) */

MethodBind *
create_method_bind<ENetConnection,TypedArray<ENetPacketPeer>>(_func_TypedArray *param_1)
...
/* MethodBind* create_method_bind<ENetConnection, String const&, int, Vector<unsigned char>
   const&>(void (ENetConnection::*)(String const&, int, Vector<unsigned char> const&)) */

MethodBind *
create_method_bind<ENetConnection,String_const&,int,Vector<unsigned_char>const&>
          (_func_void_String_ptr_int_Vector_ptr *param_1)
...
/* ENetConnection::_initialize_classv() */

void ENetConnection::_initialize_classv(void)
...
void MethodBindT<String_const&,int,Vector<unsigned_char>const&>::validated_call
...
void MethodBindT<String_const&,int,Vector<unsigned_char>const&>::ptrcall
...
Object * MethodBindTR<TypedArray<ENetPacketPeer>>::call
  ...
  *(undefined1 (*) [16])(param_1 + 8) = (undefined1  [16])0x0;
  if (((plVar4 != (long *)0x0) && (plVar4[1] != 0)) && (*(char *)(plVar4[1] + 0x2e) != '\0')) {
    ...
    if (local_58 == (char *)*plVar3) {
      ...
      _err_print_error(&_LC152,"./core/object/method_bind.h",0x207,
...
void __thiscall
MethodBindTR<double,ENetConnection::HostStatistic>::validated_call
          (MethodBindTR<double,ENetConnection::HostStatistic> *this,Object *param_1,
...
void __thiscall
MethodBindTR<double,ENetConnection::HostStatistic>::ptrcall
          (MethodBindTR<double,ENetConnection::HostStatistic> *this,Object *param_1,void **param_2,
          void *param_3)
...
void MethodBindT<ENetConnection::CompressionMode>::validated_call
               (Object *param_1,Variant **param_2,Variant *param_3)
...
void MethodBindT<ENetConnection::CompressionMode>::ptrcall
               (Object *param_1,void **param_2,void *param_3)
...
void __thiscall
MethodBindTR<Error,int,int,int,int>::validated_call
          (MethodBindTR<Error,int,int,int,int> *this,Object *param_1,Variant **param_2,
          Variant *param_3)
...
void __thiscall
MethodBindTR<Error,int,int,int,int>::ptrcall
          (MethodBindTR<Error,int,int,int,int> *this,Object *param_1,void **param_2,void *param_3)
...
void __thiscall
MethodBindTR<Error,IPAddress_const&,int,int,int,int,int>::validated_call
          (MethodBindTR<Error,IPAddress_const&,int,int,int,int,int> *this,Object *param_1,
          Variant **param_2,Variant *param_3)
...
void __thiscall
MethodBindTR<Error,IPAddress_const&,int,int,int,int,int>::ptrcall
          (MethodBindTR<Error,IPAddress_const&,int,int,int,int,int> *this,Object *param_1,
...
void __thiscall
MethodBindTR<TypedArray<ENetPacketPeer>>::validated_call
          (MethodBindTR<TypedArray<ENetPacketPeer>> *this,Object *param_1,Variant **param_2,
          Variant *param_3)
...
void __thiscall
MethodBindTR<TypedArray<ENetPacketPeer>>::ptrcall
          (MethodBindTR<TypedArray<ENetPacketPeer>> *this,Object *param_1,void **param_2,
          void *param_3)
...
void __thiscall
MethodBindTR<Error,Ref<TLSOptions>const&>::validated_call
          (MethodBindTR<Error,Ref<TLSOptions>const&> *this,Object *param_1,Variant **param_2,
          Variant *param_3)
...
void __thiscall
MethodBindTR<Error,String_const&,Ref<TLSOptions>const&>::validated_call
          (MethodBindTR<Error,String_const&,Ref<TLSOptions>const&> *this,Object *param_1,
          Variant **param_2,Variant *param_3)
...
void __thiscall
MethodBindTR<Error,Ref<TLSOptions>const&>::ptrcall
          (MethodBindTR<Error,Ref<TLSOptions>const&> *this,Object *param_1,void **param_2,
          void *param_3)
...
void __thiscall
MethodBindTR<Error,String_const&,Ref<TLSOptions>const&>::ptrcall
          (MethodBindTR<Error,String_const&,Ref<TLSOptions>const&> *this,Object *param_1,
          void **param_2,void *param_3)
...
void MethodBindT<int,Vector<unsigned_char>,int>::ptrcall
               (Object *param_1,void **param_2,void *param_3)
...
LAB_0010fb20:
                    /* WARNING: Load size is inaccurate */
  (*pcVar7)((long *)(lVar2 + (long)param_2),**param_3,(StringName *)&local_48,uVar1);
  lVar2 = local_40;
  if (local_40 != 0) {
    LOCK();
...
void MethodBindT<int,Vector<unsigned_char>,int>::validated_call
               (Object *param_1,Variant **param_2,Variant *param_3)
...
LAB_0010fd55:
  (*pcVar8)((long *)(lVar3 + (long)param_2),*(undefined4 *)(*(long *)param_3 + 8),
            (StringName *)&local_48,uVar2);
  lVar3 = local_40;
  if (local_40 != 0) {
    LOCK();
    plVar1 = (long *)(local_40 + -0x10);
...
void __thiscall
MethodBindTR<Ref<ENetPacketPeer>,String_const&,int,int,int>::ptrcall
          (MethodBindTR<Ref<ENetPacketPeer>,String_const&,int,int,int> *this,Object *param_1,
          void **param_2,void *param_3)
...
Object * MethodBindTR<Error,int,int,int,int>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
Object * MethodBindTR<Ref<ENetPacketPeer>,String_const&,int,int,int>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
  ...
  if (in_R8D < 5) {
    ...
    if ((int)(4 - in_R8D) <= iVar8) {
      ...
      *in_R9 = 0;
      ...
      (*(code *)pVVar18)(&local_a0,(Variant *)((long)plVar15 + (long)pVVar1),(Variant *)&local_98,
                         iVar10,iVar9,iVar8);
...
Object * MethodBindT<int,Vector<unsigned_char>,int>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
Object * MethodBindT<String_const&,int,Vector<unsigned_char>const&>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
  ...
  if (in_R8D < 4) {
    ...
    if ((int)(3 - in_R8D) <= iVar7) {
      ...
      *in_R9 = 0;
      ...
      (*(code *)pVVar14)((Variant *)((long)plVar12 + (long)pVVar1),(Variant *)&local_70,iVar7,
                         (Variant *)&local_68);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_70);
      lVar13 = local_60;
      if (local_60 != 0) {
...
Object * MethodBindTR<double,ENetConnection::HostStatistic>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
Object * MethodBindTR<Error,Ref<TLSOptions>const&>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
Object * MethodBindTR<Error,String_const&,Ref<TLSOptions>const&>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
LAB_00111f77:
  ...
  iVar8 = (*(code *)pVVar16)((Variant *)((long)plVar13 + (long)pVVar1),(Variant *)&local_68,
                             &local_70);
...
Object * MethodBindTR<Error,IPAddress_const&,int,int,int,int,int>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
LAB_00112401:
      *in_R9 = 0;
      ...
      iVar6 = (*(code *)pVVar16)((Variant *)((long)plVar15 + (long)pVVar1),local_b8,iVar10,iVar9,
                                 iVar8,iVar7,iVar6);
...
void __thiscall
MethodBindTR<Ref<ENetPacketPeer>,String_const&,int,int,int>::validated_call
          (MethodBindTR<Ref<ENetPacketPeer>,String_const&,int,int,int> *this,Object *param_1,
          Variant **param_2,Variant *param_3)

{
  ...
  (*pcVar3)(&local_50,param_1 + *(long *)(this + 0x60),*param_2 + 8,*(undefined4 *)(param_2[1] + 8),
            *(undefined4 *)(param_2[2] + 8),*(undefined4 *)(param_2[3] + 8));
...
void call_with_variant_args_dv<__UnexistingClass,ENetConnection::CompressionMode>
               (__UnexistingClass *param_1,_func_void_CompressionMode *param_2,Variant **param_3,
...
Object * MethodBindT<ENetConnection::CompressionMode>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)

{
  ...
  call_with_variant_args_dv<__UnexistingClass,ENetConnection::CompressionMode>
            (p_Var4,(_func_void_CompressionMode *)param_2[0xb],(Variant **)param_2[0xc],(int)param_4
             ,in_R8,in_R9);
  *(undefined4 *)param_1 = 0;
  *(undefined1 (*) [16])(param_1 + 8) = (undefined1  [16])0x0;
LAB_00112fd6:
...
/* MethodBindTR<Error, int, int, int, int>::_gen_argument_type_info(int) const */

GetTypeInfo<Error,void> * MethodBindTR<Error,int,int,int,int>::_gen_argument_type_info(int param_1)
...
undefined4 *
MethodBindTR<Ref<ENetPacketPeer>,String_const&,int,int,int>::_gen_argument_type_info(int param_1)
...
void call_get_argument_type_info<String_const&,int,Vector<unsigned_char>const&>
...
PropertyInfo *
MethodBindT<String_const&,int,Vector<unsigned_char>const&>::_gen_argument_type_info(int param_1)
...
/* MethodBindT<int, Vector<unsigned char>, int>::_gen_argument_type_info(int) const */

PropertyInfo * MethodBindT<int,Vector<unsigned_char>,int>::_gen_argument_type_info(int param_1)
...
void call_get_argument_type_info<IPAddress_const&,int,int,int,int,int>
               (int param_1,PropertyInfo *param_2)
...
MethodBindTR<Error,IPAddress_const&,int,int,int,int,int>::_gen_argument_type_info(int param_1)

{
  ...
  if (in_EDX < 6) {
    ...
    local_20 = 6;
    local_40 = (undefined1  [16])0x0;
    call_get_argument_type_info<IPAddress_const&,int,int,int,int,int>
...
/* void call_get_argument_type_info_helper<Ref<TLSOptions> const&>(int, int&, PropertyInfo&) */

void call_get_argument_type_info_helper<Ref<TLSOptions>const&>
               (int param_1,int *param_2,PropertyInfo *param_3)
...
/* MethodBindTR<Error, Ref<TLSOptions> const&>::_gen_argument_type_info(int) const */

GetTypeInfo<Error,void> *
MethodBindTR<Error,Ref<TLSOptions>const&>::_gen_argument_type_info(int param_1)
...
/* MethodBindTR<Error, String const&, Ref<TLSOptions> const&>::_gen_argument_type_info(int) const */

GetTypeInfo<Error,void> *
MethodBindTR<Error,String_const&,Ref<TLSOptions>const&>::_gen_argument_type_info(int param_1)

{
  ...
  if (in_EDX < 2) {
    ...
    call_get_argument_type_info_helper<Ref<TLSOptions>const&>

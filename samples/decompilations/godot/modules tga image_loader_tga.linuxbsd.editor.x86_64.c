...
/* ImageLoaderTGA::get_recognized_extensions(List<String, DefaultAllocator>*) const */

void __thiscall ImageLoaderTGA::get_recognized_extensions(ImageLoaderTGA *this,List *param_1)
...
void __thiscall ImageLoaderTGA::ImageLoaderTGA(ImageLoaderTGA *this)
...
int ImageLoaderTGA::decode_tga_rle
              (uchar *param_1,ulong param_2,uchar *param_3,ulong param_4,ulong param_5)

{
  ...
  if ((iVar2 == 0) &&
     (CowData<unsigned_char>::_copy_on_write((CowData<unsigned_char> *)local_50), param_4 != 0)) {
    bVar7 = *param_1;
...
/* ImageLoaderTGA::convert_to_image(Ref<Image>, unsigned char const*, ImageLoaderTGA::tga_header_s
   const&, unsigned char const*, bool, unsigned long) */

undefined8
ImageLoaderTGA::convert_to_image
          (undefined8 *param_1,long param_2,long param_3,long param_4,char param_5,ulong param_6)

{
  ...
  CowData<unsigned_char>::resize<false>
            ((CowData<unsigned_char> *)local_50,(ulong)(uVar17 * uVar21) << 2);
      ...
      do {
        if (uVar10 != uVar23) {
          ...
          while( true ) {
            ...
            lVar16 = (long)(iVar2 * 4);
            *(ushort *)(local_50[0] + lVar16) =
                 CONCAT11(*(undefined1 *)(param_2 + 1 + lVar14),
                          *(undefined1 *)(param_2 + 2 + lVar14));
            *(undefined1 *)(local_50[0] + 2 + lVar16) = uVar8;
            *(undefined1 *)(local_50[0] + 3 + lVar16) = 0xff;
            lVar16 = lVar14 + 3;
            if (uVar23 == uVar18) break;
    ...
    do {
      if (uVar10 != uVar23) {
        ...
        while( true ) {
          ...
          iVar2 = iVar20 + uVar18;
          uVar18 = uVar18 + iVar22;
          *(uint *)(local_50[0] + iVar2 * 4) =
               CONCAT31(CONCAT21(CONCAT11(*(undefined1 *)(param_2 + 3 + lVar14),
                                          *(undefined1 *)(param_2 + lVar14)),
                                 *(undefined1 *)(param_2 + 1 + lVar14)),
                        *(undefined1 *)(param_2 + 2 + lVar14));
          lVar16 = lVar14 + 4;
          if (uVar23 == uVar18) break;
          uVar12 = lVar14 + 7;
...
uint ImageLoaderTGA::load_image(undefined8 param_1,undefined8 *param_2,undefined8 *param_3)

{
  ...
  if (uVar15 == 0) {
    _err_print_error("load_image","modules/tga/image_loader_tga.cpp",0x100,
    ...
    if (0x17 < uVar15) {
      ...
      if (((uVar11 == 0) || (uVar10 == 0)) ||
         (((bVar8 - 0x10 & 0xef) != 0 && ((bVar8 & 0xef) != 8)))) {
        uVar14 = 1;
      }
      else if (uVar14 == 0) {
        plVar1 = (long *)*param_3;
        ...
        local_70[0] = 0;
        if (bVar6 == 1) {
          iVar13 = CowData<unsigned_char>::resize<false>
                             ((CowData<unsigned_char> *)local_70,local_c8);
          if (iVar13 == 0) {
...
LAB_00100d8d:
          ...
          puVar4 = local_60;
          if ((2 < uVar12 - 9) ||
             (uVar14 = decode_tga_rle(puVar17,(ulong)(bVar8 >> 3),local_60,uVar18,uVar15),
             uVar15 = uVar18, puVar17 = puVar4, uVar14 == 0)) {
            lVar16 = local_70[0];
            pIVar3 = (Image *)*param_2;
            if ((pIVar3 == (Image *)0x0) ||
               (local_90[0] = pIVar3, cVar5 = RefCounted::reference(), cVar5 == '\0')) {
    ...
    _err_print_error("load_image","modules/tga/image_loader_tga.cpp",0x101,
                     "Condition \"src_image_len < (int64_t)sizeof(tga_header_s)\" is true. Returning: ERR_FILE_CORRUPT"
                     ,0,0);
  }
  uVar14 = 0x10;
LAB_00100c70:
...
{
  return (uint)CONCAT71(0x1035,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr) |
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialize_class()::initialized != '\0') goto LAB_00102a9b;

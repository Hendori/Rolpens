...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_0010e658;
...

{
  ...
  if ((cVar15 == '\0') &&
    ...
    String::split((char *)&local_a8,bVar21,0x10892e);
    CowData<char32_t>::_unref((CowData<char32_t> *)local_88);
    if (Variant::needs_deinit[local_58[0]] != '\0') {
      Variant::_clear_internal();
    }
    ...
    Object::get((StringName *)local_58,pbVar18);
    Variant::operator_cast_to_String((Variant *)local_88);
    String::split((char *)&local_98,bVar21,0x10892e);
    CowData<char32_t>::_unref((CowData<char32_t> *)local_88);
    if (Variant::needs_deinit[local_58[0]] != '\0') {
      Variant::_clear_internal();
    }
...
{
  *(undefined ***)this = &PTR__initialize_classv_0010e4f8;
...
/* WARNING: Removing unreachable block (ram,0x0010ae88) */
...
/* WARNING: Removing unreachable block (ram,0x0010b1c0) */
  ...
  if (pvVar5 != (void *)0x0) {
    if (*(int *)(this + 0x3c) != 0) {
      ...
      if (uVar2 == 0) {
        ...
        *(undefined4 *)(this + 0x3c) = 0;
        *(undefined1 (*) [16])(this + 0x28) = (undefined1  [16])0x0;
        if (pvVar5 == (void *)0x0) goto LAB_0010bbb4;
      }
    }
    Memory::free_static(pvVar5,false);
...
LAB_0010beed:
    ...
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_0010beed;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)pLVar5;
      local_68 = local_80;
      goto joined_r0x0010bf0f;
    }
...
LAB_0010c26d:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_0010c26d;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x0010c28f;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
LAB_0010c64d:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_0010c64d;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x0010c66f;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
LAB_0010ca2d:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_0010ca2d;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x0010ca4f;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
  ...
  if (pvVar7 != (void *)0x0) {
    if (*(int *)(this + 0x1dc) != 0) {
      ...
      if (uVar2 == 0) {
        ...
        *(undefined4 *)(this + 0x1dc) = 0;
        *(undefined1 (*) [16])(this + 0x1c8) = (undefined1  [16])0x0;
        if (pvVar7 == (void *)0x0) goto LAB_0010d254;
      }
    }
    Memory::free_static(pvVar7,false);
  ...
  if (pvVar7 != (void *)0x0) {
    if (*(int *)(this + 0x1dc) != 0) {
      ...
      if (uVar2 == 0) {
        ...
        *(undefined4 *)(this + 0x1dc) = 0;
        *(undefined1 (*) [16])(this + 0x1c8) = (undefined1  [16])0x0;
        if (pvVar7 == (void *)0x0) goto LAB_0010d4d4;
      }
    }
    Memory::free_static(pvVar7,false);
    Memory::free_static(*(void **)(this + 0x1c0),false);
...
LAB_0010da66:
    ...
    lVar5 = puVar6[-1];
    if (param_1 <= lVar5) goto LAB_0010d8d1;
  }
  else {
    if (lVar5 != 0) {
      uVar4 = _realloc(this,lVar11);
  ...
  if (((int)puVar10 - (int)puVar2 & 8U) != 0) {
    *(undefined1 (*) [16])(puVar2 + 1) = (undefined1  [16])0x0;
    puVar3 = puVar2 + 3;
    if (puVar2 + 3 == puVar10) goto LAB_0010d8d1;
  }
  do {
...
LAB_0010e346:
    ...
    lVar7 = puVar6[-1];
    if (param_1 <= lVar7) goto LAB_0010e1a5;
  }
  else {
    if (lVar7 != 0) {
      uVar5 = _realloc(this,lVar11);

...
void ssl_tls13_create_verify_structure
               (void *param_1,size_t param_2,undefined8 *param_3,long *param_4,int param_5)
...

{
  ...
  if (iVar1 != 0) {
    mbedtls_debug_print_ret
              (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x2d,"psa_crypto_init",
               iVar1);
  }
...
ulong mbedtls_ssl_tls13_fetch_handshake_msg
...

{
    ...
    if ((*(int *)(param_1 + 0xf8) == 0x16) && (**(byte **)(param_1 + 0xe8) == param_2)) {
      ...
      *param_4 = *(long *)(param_1 + 0x130) + -4;
      ...
      mbedtls_debug_print_msg
                (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x47,
                 "Receive unexpected handshake message.");
  ...
  mbedtls_debug_print_ret
            (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x41,
             "mbedtls_ssl_read_record",uVar1 & 0xffffffff);
...
mbedtls_ssl_tls13_is_supported_versions_ext_present_in_exts
          (undefined8 param_1,ushort *param_2,ushort *param_3,ulong *param_4,ulong *param_5)
...
LAB_00100358:
          ...
          puVar2 = param_2 + 3;
          if ((puVar2 <= puVar6) &&
             (uVar4 = (ulong)(ushort)(param_2[2] << 8 | param_2[2] >> 8),
             uVar4 <= (ulong)((long)puVar6 - (long)puVar2))) {
            do {
...
LAB_0010022a:
  mbedtls_debug_print_msg
            (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",uVar3,
...

{
  ...
  mbedtls_debug_print_msg
            (param_1,2,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x166,
             "=> parse certificate verify");
  iVar2 = mbedtls_ssl_tls13_fetch_handshake_msg(param_1,0xf,&local_188,&local_180);
  if (iVar2 == 0) {
    iVar2 = mbedtls_ssl_get_handshake_transcript
                      (param_1,*(undefined1 *)(*(long *)(param_1[0xe] + 0x10) + 0x11),local_168,0x40
                       ,&local_190);
    if (iVar2 != 0) {
    ...
    mbedtls_debug_print_buf
              (param_1,3,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x17c,"handshake hash",
               local_168);
    lVar1 = *param_1;
    ssl_tls13_create_verify_structure
              (local_168,local_190,local_e8,&local_198,*(char *)(lVar1 + 8) == '\0');
    puVar9 = (ushort *)((long)local_188 + local_180);
    if ((CARRY8((ulong)local_188,local_180)) || ((long)local_180 < 2)) {
      uVar6 = 0xfa;
LAB_001005ab:
      mbedtls_debug_print_msg
                (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",uVar6,
                 "missing input data in %s","ssl_tls13_parse_certificate_verify");
      mbedtls_ssl_pend_fatal_alert(param_1,0x32,0xffff8d00);
      iVar2 = -0x7300;
    }
    else {
      ...
      if (puVar5 != (ushort *)0x0) {
        for (; *puVar5 != 0; puVar5 = puVar5 + 1) {
          if (uVar8 == *puVar5) {
            ...
            mbedtls_debug_print_msg
                      (param_1,3,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x120,
                       "Certificate Verify: Signature algorithm ( %04x )",uVar4 & 0xffff);
            iVar3 = mbedtls_pk_can_do(*(long *)(param_1[0xd] + 0x70) + 0x168,iVar2);
            if (iVar3 == 0) {
              mbedtls_debug_print_msg
                        (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x127,
            ...
            puVar5 = local_188 + 2;
            if ((puVar9 < puVar5) ||
               (uVar10 = (ulong)(ushort)(local_188[1] << 8 | local_188[1] >> 8),
               local_180 - 4 < uVar10)) {
              uVar6 = 0x12e;
              goto LAB_001005ab;
            }
            puVar12 = local_128;
            iVar3 = psa_hash_compute(uVar13 & 0xffffffff,local_e8,local_198,puVar12,0x40,&local_178,
                                     puVar5,puVar12,uVar13,uVar10);
            if (iVar3 != 0) {
              mbedtls_debug_print_ret
                        (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x137,
                         "hash computation PSA error",iVar3);
              goto LAB_00100578;
            }
            mbedtls_debug_print_buf
                      (param_1,3,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x13b,
                       "verify hash",puVar12,local_178);
            puVar7 = (uint *)0x0;
            if (iVar2 == 6) {
              local_170 = local_19c;
            ...
            iVar2 = mbedtls_pk_verify_ext
                              (iVar2,puVar7,*(long *)(param_1[0xd] + 0x70) + 0x168,local_19c,puVar12
                               ,local_178,puVar5,uVar10);
            if (iVar2 != 0) {
              mbedtls_debug_print_ret
                        (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x14b,
                         "mbedtls_pk_verify_ext",iVar2);
              goto LAB_00100578;
            }
      ...
      mbedtls_debug_print_msg
                (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x110,
                 "Received signature algorithm(%04x) is not offered.",uVar4);
LAB_00100578:
      iVar2 = -0x6e00;
...
LAB_001003f9:
  mbedtls_debug_print_msg
            (param_1,2,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x192,
             "<= parse certificate verify");
  mbedtls_debug_print_ret
            (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x193,
             "mbedtls_ssl_tls13_process_certificate_verify",iVar2);
LAB_00100436:
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  mbedtls_debug_print_msg
            (param_1,2,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x33e,"=> write certificate"
            );
  ...
  if (iVar3 == 0) {
    ...
    if (((lVar9 == 0) || (plVar10 = *(long **)(lVar9 + 0x408), plVar10 == (long *)0x0)) &&
       (plVar10 = *(long **)(*param_1 + 0xd0), plVar10 == (long *)0x0)) {
      lVar11 = 0;
    }
    else {
      lVar11 = *plVar10;
      ...
      *local_50 = bVar8;
      ...
      if ((pbVar14 <= pbVar1) && (2 < (long)pbVar1 - (long)pbVar14)) {
        ...
        mbedtls_debug_print_crt
                  (param_1,3,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x319,
                   "own certificate",lVar11);
        if (lVar11 == 0) {
          bVar8 = 0;
          bVar15 = 0;
          bVar12 = 0;
LAB_00100b78:
          *pbVar14 = bVar12;
          ...
          mbedtls_ssl_print_extensions
                    (param_1,3,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x332,0xb,
                     *(undefined4 *)(param_1[0xe] + 0x668),0);
          iVar3 = mbedtls_ssl_add_hs_msg_to_checksum
                            (param_1,0xb,local_50,(long)pbVar5 - (long)pbVar2);
          if (iVar3 == 0) {
...
LAB_00100982:
  mbedtls_debug_print_msg
            (param_1,2,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x34f,"<= write certificate"
            );
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return iVar3;
  }
...

{
  ...
  *param_4 = 0;
  local_178 = 0;
  if ((((lVar4 == 0) || (lVar9 = *(long *)(lVar4 + 0x408), lVar9 == 0)) &&
      (lVar9 = *(long *)(lVar5 + 0xd0), lVar9 == 0)) || (lVar5 = *(long *)(lVar9 + 8), lVar5 == 0))
  {
    mbedtls_debug_print_msg
              (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x398,
               "should never happen");
    iVar6 = -0x6c00;
  }
  else {
    iVar6 = mbedtls_ssl_get_handshake_transcript
                      (param_1,*(undefined1 *)(*(long *)(lVar4 + 0x10) + 0x11),local_168,0x40,
                       &local_188);
    if (iVar6 == 0) {
      mbedtls_debug_print_buf
                (param_1,3,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x3a3,"handshake hash",
                 local_168,local_188);
      lVar9 = *param_1;
      ssl_tls13_create_verify_structure
                (local_168,local_188,local_e8,&local_180,*(undefined1 *)(lVar9 + 8));
      iVar6 = -0x6a00;
              ...
              while (uVar3 != 0) {
                if (uVar3 == uVar2) {
                  ...
                  if (iVar6 != 0) {
                    ...
                    if ((iVar6 == 0) || (uVar12 = uVar7 | 0x2000000, uVar7 == 0)) {
                      if (uVar2 == 0x805) {
                        uVar12 = 0x200000a;
                        uVar7 = 10;
                        iVar6 = 6;
                    ...
                    if (iVar8 != 0) {
                      iVar6 = psa_status_to_mbedtls
                                        (iVar8,&psa_to_ssl_errors,7,&psa_generic_status_to_mbedtls);
                      goto LAB_00100d4c;
                    }
                    mbedtls_debug_print_buf
                              (param_1,3,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x3da,
                               "verify hash",local_128,local_170);
                    iVar6 = mbedtls_pk_sign_ext(iVar6,lVar5,uVar7,local_128,local_170,param_2 + 2,
                                                (long)param_3 - (long)(param_2 + 2),&local_178,
                                                *(undefined8 *)(*param_1 + 0x38),
                                                *(undefined8 *)(*param_1 + 0x40));
                    if (iVar6 == 0) {
                      uVar11 = mbedtls_ssl_sig_alg_to_str(*puVar13);
                      mbedtls_debug_print_msg
                                (param_1,2,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x3ec,
                                 "CertificateVerify signature with %s",uVar11);
                      uVar2 = *puVar13;
                    ...
                    uVar11 = mbedtls_ssl_sig_alg_to_str(*puVar13);
                    mbedtls_debug_print_msg
                              (param_1,2,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x3e0,
                               "CertificateVerify signature failed with %s",uVar11);
                    mbedtls_debug_print_ret
                              (param_1,2,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x3e2,
                               "mbedtls_pk_sign_ext",iVar6);
                  }
                  break;
                }
                puVar1 = puVar10 + 1;
...
LAB_0010112a:
        mbedtls_debug_print_msg
                  (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x3f3,
...

{
  ...
  mbedtls_debug_print_msg
            (param_1,2,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x407,
  ...
  mbedtls_debug_print_msg
            (param_1,2,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x419,
             "<= write certificate verify");
...

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  mbedtls_debug_print_msg
            (param_1,2,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x46b,
             "=> parse finished message");
  iVar2 = mbedtls_ssl_tls13_fetch_handshake_msg(param_1,0x14,&local_40,&local_38);
  if (iVar2 == 0) {
    iVar2 = mbedtls_ssl_tls13_calculate_verify_data
                      (param_1,param_1[0xe] + 0x559,0x40,param_1[0xe] + 0x5a0,
                       *(char *)(*param_1 + 8) == '\0');
    if (iVar2 == 0) {
      if (local_38 == *(long *)(param_1[0xe] + 0x5a0)) {
        lVar1 = param_1[0xe] + 0x559;
        mbedtls_debug_print_buf
                  (param_1,4,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x452,
                   "verify_data (self-computed):",lVar1,local_38);
        mbedtls_debug_print_buf
                  (param_1,4,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x455,
                   "verify_data (received message):",local_40,local_38);
        ...
        if (iVar2 == 0) {
          ...
          iVar2 = -0x6e00;
          mbedtls_debug_print_msg
                    (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x45c,
        ...
        iVar2 = -0x7300;
        mbedtls_debug_print_msg
                  (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",1099,
                   "bad finished message");
        mbedtls_ssl_pend_fatal_alert(param_1,0x32,0xffff8d00);
      }
    }
      ...
      mbedtls_debug_print_ret
                (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x434,
                 "mbedtls_ssl_tls13_calculate_verify_data",iVar2);
    }
  }
  mbedtls_debug_print_msg
            (param_1,2,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x47b,
             "<= parse finished message");
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    return iVar2;
  }
...

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  mbedtls_debug_print_msg
            (param_1,2,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x4b9,
             "=> write finished message");
  iVar1 = mbedtls_ssl_tls13_calculate_verify_data
                    (param_1,param_1[0xe] + 0x559,0x40,param_1[0xe] + 0x5a0,
  ...
  if (iVar1 == 0) {
    ...
    mbedtls_debug_print_ret
              (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x496,
               "calculate_verify_data failed",iVar1);
  }
  mbedtls_debug_print_msg
            (param_1,2,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x4ca,
             "<= write finished message");
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    return iVar1;
  }
...

{
  ...
  mbedtls_debug_print_msg
            (param_1,3,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x4d1,"=> handshake wrapup")
  ;
  mbedtls_debug_print_msg
            (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x4d3,
             "Switch to application keys for inbound traffic");
  mbedtls_ssl_set_inbound_transform(param_1,*(undefined8 *)(param_1 + 0x98));
  mbedtls_debug_print_msg
            (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x4d6,
  ...
  *(undefined8 *)(param_1 + 0x60) = uVar1;
  mbedtls_debug_print_msg
            (param_1,3,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x4e3,"<= handshake wrapup")
  ;
  return;
}
...

{
  ...
  iVar1 = 0;
  mbedtls_debug_print_msg
            (param_1,2,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x4ff,
  ...
  mbedtls_debug_print_msg
            (param_1,2,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x516,
             "<= write change cipher spec");
  return iVar1;
}
...

{
  ...
  mbedtls_debug_print_msg
            (param_1,3,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x593,
             "Reset SSL session for HRR");
  iVar2 = mbedtls_ssl_get_handshake_transcript
                    (param_1,*(undefined1 *)(lVar1 + 0x11),local_74,0x40,&local_80);
  if (iVar2 == 0) {
    local_76 = 0;
    local_78 = 0xfe;
    ...
    local_80 = local_80 + 4;
    mbedtls_debug_print_buf
              (param_1,4,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x5a5,
               "Truncated handshake transcript",&local_78,local_80);
    iVar2 = mbedtls_ssl_reset_checksum(param_1);
    if (iVar2 == 0) {
      iVar2 = (**(code **)(*(long *)(param_1 + 0x70) + 0x18))(param_1,&local_78,local_80,0x1017f4);
      if (iVar2 != 0) {
        mbedtls_debug_print_ret
                  (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x5b0,
                   "update_checksum",iVar2);
      }
    }
    else {
      mbedtls_debug_print_ret
                (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x5ab,
                 "mbedtls_ssl_reset_checksum",iVar2);
    }
  }
  else {
    mbedtls_debug_print_ret
              (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x59a,
               "mbedtls_ssl_get_handshake_transcript",iVar2);
  }
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    return iVar2;
  }
...

{
  ...
  if ((CARRY8((ulong)param_2,param_3)) || (param_3 < 2)) {
    ...
    if (param_2 + 1 <= (ushort *)((long)param_2 + param_3)) {
      ...
      if (__n <= param_3 - 2) {
        ...
        mbedtls_debug_print_msg
                  (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x5cb,
                   "Invalid public key length: %u > %zu",uVar3,0x210,
                   (ushort *)((long)param_2 + param_3));
        return 0xffff9200;
      }
    }
    uVar2 = 0x5c7;
  ...
  mbedtls_debug_print_msg
            (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",uVar2,
             "missing input data in %s","mbedtls_ssl_tls13_read_public_xxdhe_share");
  mbedtls_ssl_pend_fatal_alert(param_1,0x32,0xffff8d00);
  return 0xffff8d00;
}
...
undefined4
mbedtls_ssl_tls13_generate_and_write_xxdh_key_exchange
          (long param_1,undefined2 param_2,long param_3,long param_4,undefined8 *param_5)

{
  ...
  local_60 = 0;
  mbedtls_debug_print_msg
            (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x610,
             "Perform PSA-based ECDH/FFDH computation.");
  ...
  if (local_6a == 0) {
    ...
    *(long *)(lVar2 + 0x1c0) = local_60;
    ...
    if (iVar3 == 0) {
      iVar3 = psa_export_public_key
                        (*(undefined4 *)(lVar1 + 0x1c8),param_3,param_4 - param_3,&local_68);
      if (iVar3 == 0) {
        *param_5 = local_68;
        uVar4 = 0;
      }
        ...
        mbedtls_debug_print_ret
                  (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x642,
                   "psa_export_public_key",uVar4);
      }
    }
    else {
      uVar4 = psa_status_to_mbedtls(iVar3,&psa_to_ssl_errors,7,&psa_generic_status_to_mbedtls);
      mbedtls_debug_print_ret
                (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x636,"psa_generate_key"
                 ,uVar4);
    }
  }
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
undefined8
mbedtls_ssl_tls13_check_received_extension(long param_1,int param_2,undefined4 param_3,uint param_4)

{
  ...
  mbedtls_ssl_print_extension
            (param_1,3,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x65c,param_2,param_3,
             "received",0);
  if ((uVar3 & param_4) == 0) {
    mbedtls_ssl_print_extension
              (param_1,3,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x660,param_2,param_3,
               "is illegal",0);
    ...
    *puVar1 = *puVar1 | uVar3;
    if (((param_2 + 2U < 0xe) && ((0x2411UL >> ((ulong)(param_2 + 2U) & 0x3f) & 1) != 0)) &&
       ((uVar3 & *(uint *)(lVar2 + 0x668)) == 0)) {
      mbedtls_ssl_print_extension
                (param_1,3,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x67b,param_2,param_3,
                 "is unsupported",0);
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  mbedtls_debug_print_msg
            (param_1,2,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x2c3,"=> parse certificate"
            );
...
LAB_00101e96:
      ...
      mbedtls_debug_print_crt
                (param_1,3,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x265,"peer certificate"
                 ,*(undefined8 *)(param_1[0xd] + 0x70));
      ...
      if (lVar8 == 0) {
        mbedtls_debug_print_msg
                  (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x290,
...
LAB_00101f02:
        uVar3 = mbedtls_ssl_verify_certificate(param_1,cVar2,lVar8,0,0);
        uVar10 = (ulong)uVar3;
        if (uVar3 != 0) goto LAB_00101da2;
      }
    ...
    *(void **)(lVar11 + 0x70) = pvVar5;
    if (pvVar5 == (void *)0x0) {
      uVar10 = 0xffff8100;
      mbedtls_debug_print_msg
                (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x1ec,
                 "alloc( %zu bytes ) failed",0x2e8);
    ...
    if ((local_50 + local_48 < local_88) || (local_48 - 4 < uVar6)) {
      ...
      if (2 < uVar3) {
        do {
          ...
          uVar10 = (ulong)((uint)(byte)*local_88 << 0x10 | (uint)*(byte *)((long)local_88 + 1) << 8
                          | (uint)(byte)local_88[1]);
          ...
          if (iVar4 == -0x2580) {
            ...
            mbedtls_debug_print_ret
                      (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x220,
                       " mbedtls_x509_crt_parse_der",0xffffda80);
            goto LAB_00101da2;
          }
          if (iVar4 < -0x257f) {
            if (iVar4 == -0x2880) {
              ...
              mbedtls_debug_print_ret
                        (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x21a,
                         " mbedtls_x509_crt_parse_der",0xffffd780);
              goto LAB_00101da2;
            }
...
LAB_00102166:
            ...
            mbedtls_debug_print_ret
                      (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x226,
                       " mbedtls_x509_crt_parse_der",uVar6 & 0xffffffff);
            goto LAB_00101da2;
          }
          ...
          if ((puVar9 < local_88) ||
             ...
             (ulong)((long)puVar9 - (long)local_88) < uVar10)) {
            uVar7 = 0x230;
            goto LAB_00101f4b;
          }
          ...
          *(undefined4 *)(lVar8 + 0x66c) = 0;
          while (local_88 < puVar14) {
            ...
            puVar1 = local_88 + 2;
            if ((puVar14 < puVar1) ||
               (uVar10 = (ulong)(ushort)(local_88[1] << 8 | local_88[1] >> 8),
               (ulong)((long)puVar14 - (long)puVar1) < uVar10)) {
              uVar7 = 0x244;
              goto LAB_00101f4b;
            }
            ...
            mbedtls_ssl_print_extension
                      (param_1,3,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x24f,0xb,uVar13,
                       "( ignored )",0);
            uVar6 = 0;
            local_88 = (ushort *)((long)puVar1 + uVar10);
          }
          mbedtls_ssl_print_extensions
                    (param_1,3,"thirdparty/mbedtls/library/ssl_tls13_generic.c",600,0xb,
                     *(undefined4 *)(lVar8 + 0x66c),0,uVar6);
          if (puVar9 <= local_88) {
            uVar10 = uVar6 & 0xffffffff;
            goto LAB_00101e96;
          }
...
LAB_00101f4b:
    mbedtls_debug_print_msg
              (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",uVar7,
               "missing input data in %s","mbedtls_ssl_tls13_parse_certificate");
    mbedtls_ssl_pend_fatal_alert(param_1,0x32,0xffff8d00);
  }
  else {
    pcVar12 = "bad certificate message";
...
LAB_001021c4:
    mbedtls_debug_print_msg
              (param_1,1,"thirdparty/mbedtls/library/ssl_tls13_generic.c",uVar7,pcVar12);
    mbedtls_ssl_pend_fatal_alert(param_1,0x32,0xffff8d00);
  }
  uVar10 = 0xffff8d00;
LAB_00101da2:
  mbedtls_debug_print_msg
            (param_1,2,"thirdparty/mbedtls/library/ssl_tls13_generic.c",0x2db,"<= parse certificate"
            );
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();

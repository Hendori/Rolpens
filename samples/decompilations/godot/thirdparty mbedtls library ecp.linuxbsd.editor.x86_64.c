...

{
  ...
  if (((*(short *)(param_1 + 8) < 0) && (iVar2 = mbedtls_mpi_cmp_int(param_1,0), iVar2 != 0)) ||
     (uVar3 = mbedtls_mpi_bitlen(param_1), (ulong)(*(long *)(param_2 + 0x78) * 2) < uVar3)) {
    uVar3 = 0xffffb080;
  }
  else {
...
LAB_001000d0:
    uVar1 = mbedtls_mpi_sub_abs(param_1,param_1,param_2);
  } while (uVar1 == 0);
LAB_00100100:
  return (ulong)uVar1;
}
...

{
  ...
  if (iVar1 == 0) {
    while ((*(short *)(param_2 + 8) < 0 && (iVar2 = mbedtls_mpi_cmp_int(param_2,0), iVar2 != 0))) {
...

{
  ...
  if (*(long *)(param_1 + 0x18) == 0) {
    ...
    if (iVar2 == 0) {
      ...
      while ((sVar1 < 0 && (iVar2 = mbedtls_mpi_cmp_int(param_2,0), iVar2 != 0))) {
        iVar2 = mbedtls_mpi_add_mpi(param_2,param_2,param_1 + 8);
        if (iVar2 != 0) {
          return iVar2;
        }
...
LAB_001004b3:
      iVar2 = mbedtls_mpi_mul_mpi(param_2,param_2,param_3);
      if ((iVar2 == 0) && (iVar2 = ecp_modp(param_2,param_1), iVar2 == 0)) {
        mul_count = mul_count + 1;
...

{
  ...
  if (*(long *)(param_1 + 0x18) == 0) {
    ...
    while( true ) {
      ...
      if ((-1 < *(short *)(param_4 + 0x38)) || (iVar4 = mbedtls_mpi_cmp_int(lVar6,0), iVar4 == 0))
      break;
  ...
  if ((iVar4 == 0) && (iVar4 = ecp_modp(lVar6,param_1), iVar4 == 0)) {
    mul_count = mul_count + 1;
      ...
      if (iVar5 != 0) {
        ...
        if (iVar5 == 0) {
          ...
          while( true ) {
            ...
            if ((-1 < *(short *)(param_5 + 8)) ||
               (iVar5 = mbedtls_mpi_cmp_int(param_5,0), iVar5 == 0)) break;
          ...
          while( true ) {
            ...
            if ((-1 < *(short *)(param_5 + 0x18)) ||
               (iVar5 = mbedtls_mpi_cmp_int(lVar4,0), iVar5 == 0)) break;
...
ulong ecp_mul_comb_after_precomp_isra_0
                (long param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
                undefined1 param_5,byte param_6,byte *param_7,long param_8,undefined8 param_9)
...
LAB_00101bd9:
              uVar3 = uVar7;
              if (((local_148 == param_7) ||
                  (uVar3 = ecp_double_jac(param_1,param_2,param_2,local_188), uVar3 != 0)) ||
                 (uVar3 = ecp_select_comb(param_1,local_1b8,param_4,param_5,param_7[-1]), uVar3 != 0
                 )) break;
              param_7 = param_7 + -1;
...

{
  *param_1 = 0;
  mbedtls_mpi_init();
  mbedtls_mpi_init(param_1 + 6);
  mbedtls_mpi_init(param_1 + 10);
  mbedtls_mpi_init(param_1 + 0xe);
  mbedtls_mpi_init(param_1 + 0x12);
  mbedtls_mpi_init(param_1 + 0x16);
  mbedtls_mpi_init(param_1 + 0x1a);
  param_1[0x22] = 0;
  *(undefined8 *)(param_1 + 0x28) = 0;
  *(undefined8 *)(param_1 + 0x2e) = 0;
  *(undefined1 (*) [16])(param_1 + 0x1e) = (undefined1  [16])0x0;
...

{
  ...
  mbedtls_mpi_init(param_1 + 0xc0);
  mbedtls_mpi_init(param_1 + 0xd0);
  mbedtls_mpi_init(param_1 + 0xe0);
  mbedtls_mpi_init(param_1 + 0xf0);
  return;
}
...

{
  ...
  if (param_1 != 0) {
    if (*(int *)(param_1 + 0x88) != 1) {
      mbedtls_mpi_free(param_1 + 0x18);
      mbedtls_mpi_free(param_1 + 0x28);
      mbedtls_mpi_free(param_1 + 0x38);
      mbedtls_mpi_free(param_1 + 0x48);
      mbedtls_mpi_free(param_1 + 0x58);
      mbedtls_mpi_free(param_1 + 0x68);
...

{
  if (param_1 != 0) {
    ...
    mbedtls_mpi_free(param_1 + 0xe0);
    mbedtls_mpi_free(param_1 + 0xf0);
    return;
  }
  return;
}
...
mbedtls_ecp_point_write_binary
          (long param_1,long param_2,uint param_3,ulong *param_4,char *param_5,ulong param_6)
    ...
    *param_4 = uVar1;
    if (uVar1 <= param_6) {
      *param_5 = '\x04';
      ...
      param_2 = param_2 + 0x10;
LAB_0010230d:
      uVar5 = mbedtls_mpi_write_binary(param_2,pcVar6,uVar4);
      return uVar5;
    }
  }
  else {
...
LAB_00102568:
    ...
    if (uVar5 == 0) {
      ...
      uVar9 = (ulong)uVar5;
      if (((uVar5 == 0) && (*(long *)(param_1 + 0xe) != 0)) && (*(long *)(param_1 + 0x12) != 0))
      goto LAB_001023fc;
    }
  }
  else {
      ...
      if (uVar5 == 0) {
        ...
        if (uVar5 == 0) {
          ...
          if (bVar4 == 4) {
            ...
            if ((iVar6 != 1) || (iVar6 = mbedtls_mpi_get_bit(piVar1,1), iVar6 != 1))
            goto LAB_00102568;
            mbedtls_mpi_init(local_58);
            uVar5 = mbedtls_mpi_mul_mpi(lVar3,param_2,param_2);
            if ((uVar5 == 0) && (uVar5 = ecp_modp(lVar3,param_1), uVar5 == 0)) {
              mul_count = mul_count + 1;
              uVar5 = ecp_sw_rhs_part_0(param_1,lVar3,param_2);
              if ((uVar5 == 0) &&
                 ((((uVar5 = mbedtls_mpi_add_int(local_58,piVar1,1), uVar5 == 0 &&
                    (uVar5 = mbedtls_mpi_shift_r(local_58,2), uVar5 == 0)) &&
                   (uVar5 = mbedtls_mpi_exp_mod(lVar3,lVar3,local_58,piVar1,0), uVar5 == 0)) &&
                  (uVar7 = mbedtls_mpi_get_bit(lVar3,0), (bVar4 & 1) != uVar7)))) {
...
undefined8
mbedtls_ecp_tls_read_point(undefined8 param_1,undefined8 param_2,long *param_3,ulong param_4)
...
mbedtls_ecp_tls_write_point
          (undefined8 param_1,undefined8 param_2,uint param_3,long *param_4,undefined1 *param_5,
          long param_6)
...
undefined8
mbedtls_ecp_tls_write_group(int *param_1,undefined8 *param_2,undefined1 *param_3,ulong param_4)
...

{
  ...
  if (iVar2 == 0) {
    ...
    if (*(long *)(param_1 + 0x12) == 0) {
      ...
      if ((uVar5 <= *(long *)(param_1 + 0x20) + 7U >> 3) &&
         (iVar2 = mbedtls_mpi_cmp_int(param_2,0), -1 < iVar2)) {
        iVar2 = *param_1;
        param_1 = param_1 + 2;
        ...
        while (uVar3 == 0) {
          ...
          if (iVar4 < 0) {
            ...
            if (((iVar4 < 1) ||
                ((iVar2 == 9 &&
                 ((iVar2 = mbedtls_mpi_cmp_mpi(local_48,ecp_x25519_bad_point_1), iVar2 == 0 ||
                  (iVar2 = mbedtls_mpi_cmp_mpi(local_48,ecp_x25519_bad_point_2), iVar2 == 0)))))) ||
               ((uVar3 = mbedtls_mpi_add_int(local_48,local_48,1), uVar3 == 0 &&
                (iVar2 = mbedtls_mpi_cmp_mpi(local_48,param_1), iVar2 == 0)))) {
              uVar3 = 0xffffb380;
            }
            break;
          }
...
LAB_001029c9:
      ...
      if (-1 < iVar2) {
        ...
        if (-1 < iVar2) {
          ...
          if ((iVar2 < 0) && (iVar2 = mbedtls_mpi_cmp_mpi(lVar1,param_1 + 2), iVar2 < 0)) {
            mbedtls_mpi_init(auStack_58);
            mbedtls_mpi_init(local_48);
            uVar3 = mbedtls_mpi_mul_mpi(auStack_58,lVar1,lVar1);
            if ((uVar3 == 0) && (uVar3 = ecp_modp(auStack_58,param_1), uVar3 == 0)) {
              mul_count = mul_count + 1;
              uVar3 = mbedtls_mpi_mul_mpi(local_48,param_2,param_2);
              if ((uVar3 == 0) && (uVar3 = ecp_modp(local_48,param_1), uVar3 == 0)) {
                mul_count = mul_count + 1;
...

{
  ...
  if (*(long *)(param_1 + 0x48) == 0) {
    ...
    if ((iVar1 == 0) && (iVar1 = mbedtls_mpi_get_bit(param_2,1), iVar1 == 0)) {
    ...
    if ((-1 < iVar1) && (iVar1 = mbedtls_mpi_cmp_mpi(param_2,param_1 + 0x68), iVar1 < 0)) {
      return 0;
    }
  }
  return 0xffffb380;
...
int ecp_mul_restartable_internal_isra_0
...

{
  ...
  if ((iVar6 != 0) || (iVar7 = mbedtls_ecp_check_pubkey(param_1,param_4), iVar6 = iVar7, iVar7 != 0)
     ) goto LAB_00102cb1;
  if (*(long *)(param_1 + 0x38) == 0) {
LAB_001030b0:
    iVar6 = -0x4f80;
  ...
  if (*(long *)(param_1 + 0x48) == 0) {
    ...
    if ((((iVar6 == 0) && (iVar6 = mbedtls_mpi_copy(local_f8,param_4), iVar6 == 0)) &&
        (iVar6 = mbedtls_mpi_copy(local_e8,param_4 + 0x10), iVar6 == 0)) &&
       ((iVar6 = mbedtls_mpi_copy(local_d8,param_4 + 0x20), iVar6 == 0 &&
        (iVar6 = mbedtls_mpi_lset(param_2,1), iVar6 == 0)))) {
      lVar1 = param_2 + 0x20;
...
LAB_001037f8:
    ...
    if (((iVar6 != 0) || (iVar6 = iVar7, *(long *)(param_1 + 0x38) == 0)) ||
       (*(long *)(param_1 + 0x48) == 0)) goto LAB_00102cb1;
  }
...
LAB_00102d9a:
    iVar9 = ecp_mul_comb_after_precomp_isra_0
                      (param_1,param_2,param_3,__ptr,uVar8,bVar4,uVar20,param_5,param_6);
...
LAB_00102f3e:
    ...
    if (__ptr != (void *)0x0) {
      ...
      if ((iVar9 == 0) && (iVar9 = mbedtls_mpi_copy((long)__ptr + 0x10,param_4 + 0x10), iVar9 == 0))
      {
          ...
          if ((long)iVar6 * uVar20 != 0) {
            do {
              ...
              if (uVar18 % uVar20 == 0) {
                ...
                if (((iVar9 != 0) ||
                    (iVar9 = mbedtls_mpi_copy((long)pvVar13 + 0x10,(long)pvVar22 + 0x10), iVar9 != 0
                    )) || (iVar9 = mbedtls_mpi_copy((long)pvVar13 + 0x20,(long)pvVar22 + 0x20),
                          iVar9 != 0)) goto LAB_00103060;
              }
          ...
          if (iVar9 == 0) {
            ...
            do {
              ...
              while (uVar18 = uVar18 - 1, uVar18 != 0xffffffffffffffff) {
                iVar9 = ecp_add_mixed(param_1,lVar10,lVar10 + uVar21 * -0x30,
                                      (void *)((long)__ptr + uVar21 * 0x30),puVar15);
                lVar10 = lVar10 + -0x30;
                if (iVar9 != 0) goto LAB_00103060;
              }
              bVar11 = bVar11 * '\x02';
...
LAB_001033f2:
  if (local_138 == -1) {
    ...
    if (((iVar6 == 0) && (iVar6 = mbedtls_mpi_inv_mod(lVar1,lVar1,lVar10), iVar6 == 0)) &&
       (iVar6 = mbedtls_mpi_mul_mod(param_1,param_2), iVar6 == 0)) {
  ...
  if ((iVar6 != 0) || (iVar6 = mbedtls_mpi_safe_cond_swap(lVar1,local_d8,uVar5), iVar6 != 0))
  goto LAB_001037f8;
  ...
  while( true ) {
    if (iVar6 != 0) goto LAB_001037f8;
    if ((-1 < local_70) || (iVar6 = mbedtls_mpi_cmp_int(local_78,0), iVar6 == 0)) break;
  ...
  while( true ) {
    if (iVar6 != 0) goto LAB_001037f8;
    if ((-1 < local_50) || (iVar6 = mbedtls_mpi_cmp_int(local_58,0), iVar6 == 0)) break;
    iVar6 = mbedtls_mpi_add_mpi(local_58,local_58,lVar10);
  }
  iVar6 = mbedtls_mpi_mul_mpi(local_58,local_58,local_88);
  if ((iVar6 != 0) || (iVar6 = ecp_modp(local_58,param_1), iVar6 != 0)) goto LAB_001037f8;
  mul_count = mul_count + 1;
  iVar6 = mbedtls_mpi_mul_mpi(local_68,local_68,local_78);
  if ((iVar6 != 0) || (iVar6 = ecp_modp(local_68,param_1), iVar6 != 0)) goto LAB_001037f8;
  mul_count = mul_count + 1;
  iVar6 = mbedtls_mpi_mul_mpi(local_88,local_88,local_88);
  if ((iVar6 != 0) || (iVar6 = ecp_modp(local_88,param_1), iVar6 != 0)) goto LAB_001037f8;
  mul_count = mul_count + 1;
  iVar6 = mbedtls_mpi_mul_mpi(local_78,local_78,local_78);
  if ((iVar6 != 0) || (iVar6 = ecp_modp(local_78,param_1), iVar6 != 0)) goto LAB_001037f8;
  mul_count = mul_count + 1;
  iVar6 = mbedtls_mpi_mul_mpi(param_2,local_88,local_78);
  if ((iVar6 != 0) || (iVar6 = ecp_modp(param_2,param_1), iVar6 != 0)) goto LAB_001037f8;
  mul_count = mul_count + 1;
  iVar6 = mbedtls_mpi_sub_mpi(local_88,local_88,local_78);
  while( true ) {
    if (iVar6 != 0) goto LAB_001037f8;
    if ((-1 < local_80) || (iVar6 = mbedtls_mpi_cmp_int(local_88,0), iVar6 == 0)) break;
    iVar6 = mbedtls_mpi_add_mpi(local_88,local_88,lVar10);
  }
  iVar6 = mbedtls_mpi_mul_mod(param_1,lVar1,param_1 + 0x18);
  if ((((iVar6 != 0) || (iVar6 = mbedtls_mpi_add_mod(param_1,lVar1,local_78), iVar6 != 0)) ||
      (iVar6 = mbedtls_mpi_add_mod(param_1,local_f8,local_58), iVar6 != 0)) ||
     ((((iVar6 = mbedtls_mpi_mul_mod(param_1,local_f8,local_f8), iVar6 != 0 ||
        (iVar6 = mbedtls_mpi_sub_mod(param_1,local_d8,local_58), iVar6 != 0)) ||
       ((iVar6 = mbedtls_mpi_mul_mod(param_1,local_d8,local_d8), iVar6 != 0 ||
        ((iVar6 = mbedtls_mpi_mul_mod(param_1,local_d8,local_108), iVar6 != 0 ||
         (iVar6 = mbedtls_mpi_mul_mod(param_1,lVar1,local_88), iVar6 != 0)))))) ||
      (iVar6 = mbedtls_mpi_safe_cond_swap(param_2,local_f8,uVar5), iVar6 != 0)))) goto LAB_001037f8;
...
int self_test_point_constprop_0
...

{
  ...
  if ((iVar4 == 0) &&
     (iVar4 = ecp_mul_restartable_internal_isra_0(param_2,param_3,param_4,param_5,0x100000,0),
     lVar3 = add_count, lVar2 = dbl_count, lVar1 = mul_count, iVar4 == 0)) {
    uVar5 = 1;
    do {
      add_count = 0;
      dbl_count = 0;
...
undefined8
mbedtls_ecp_gen_privkey(long param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)
...

{
  ...
  if ((int)uVar1 == 0) {
    if (param_4 != 0) {
      uVar1 = ecp_mul_restartable_internal_isra_0
                        (param_1,param_3,param_2,param_1 + 0x38,param_4,param_5);
      return uVar1;
    }
    uVar1 = 0xffffb080;
  }
...

{
  ...
  if ((int)uVar1 == 0) {
    ...
    if ((int)uVar1 == 0) {
      if (param_3 != 0) {
        uVar1 = ecp_mul_restartable_internal_isra_0
                          (param_2,param_2 + 0xd0,param_2 + 0xc0,param_2 + 0x38,param_3,param_4);
        return uVar1;
      }
      uVar1 = 0xffffb080;
    }
...

{
  ...
  if (((int)uVar1 == 0) &&
     (uVar1 = mbedtls_mpi_copy(param_2 + 0x38,param_3 + 0x10), (int)uVar1 == 0)) {
...

{
  ...
  if (*(long *)(param_2 + 0x48) == 0) {
    if (param_1 == 9) {
      ...
      if (((((int)uVar3 != 0) || (uVar3 = mbedtls_mpi_set_bit(lVar1,0,0), (int)uVar3 != 0)) ||
          (uVar3 = mbedtls_mpi_set_bit(lVar1,1,0), (int)uVar3 != 0)) ||
         ((uVar3 = mbedtls_mpi_set_bit(lVar1,2,0), (int)uVar3 != 0 ||
          (uVar3 = mbedtls_mpi_set_bit(lVar1,0xff,0), (int)uVar3 != 0)))) goto LAB_001044cc;
      ...
      if ((((int)uVar3 != 0) || (uVar3 = mbedtls_mpi_set_bit(lVar1,0,0), (int)uVar3 != 0)) ||
         (uVar3 = mbedtls_mpi_set_bit(lVar1,1,0), (int)uVar3 != 0)) goto LAB_001044cc;
...
LAB_00104490:
    uVar3 = mbedtls_mpi_read_binary(param_2 + 0xc0,param_3,param_4);
...
void mbedtls_ecp_write_public_key
               (long param_1,undefined4 param_2,undefined8 param_3,undefined8 param_4,
               undefined8 param_5)
    ...
    if (iVar1 == 0) {
      ...
      if (iVar1 == 0) {
        ...
        if (iVar1 == 0) {
          ...
          if ((param_3 == 0) ||
             ((iVar1 = ecp_mul_restartable_internal_isra_0
                                 (local_108,local_138,param_2 + 0x30,param_2 + 0xe,param_3,param_4),
              iVar1 == 0 &&
              (((iVar1 = mbedtls_mpi_cmp_mpi(local_138,param_2 + 0x34), iVar1 != 0 ||
                (iVar1 = mbedtls_mpi_cmp_mpi(local_128,param_2 + 0x38), iVar1 != 0)) ||
               (iVar1 = mbedtls_mpi_cmp_mpi(local_118,param_2 + 0x3c), iVar1 != 0)))))) {
            iVar1 = -0x4f80;
          }
...

{
  ...
  if (param_2 != 0) {
    uVar1 = ecp_mul_restartable_internal_isra_0
                      (param_1,param_1 + 0xd0,param_1 + 0xc0,param_1 + 0x38,param_2,param_3);
    return uVar1;
  }
  return 0xffffb080;
}
...

{
  ...
  if (((param_4 != 0) && (uVar1 = mbedtls_mpi_copy(param_4,param_1 + 0x34), (int)uVar1 == 0)) &&
     (uVar1 = mbedtls_mpi_copy(param_4 + 0x10,param_1 + 0x38), (int)uVar1 == 0)) {
...

{
  ...
  if (iVar1 == 0) {
    if (param_1 != 0) {
      ...
      if (iVar1 == 0) {
        iVar1 = ecp_mul_restartable_internal_isra_0
                          (local_168,local_198,local_1d8,local_130,0x100000,0);
...
LAB_00104ce3:
      ...
      if (iVar1 == 0) {
        ...
        iVar1 = self_test_point_constprop_0
                          (param_1,local_168,local_1c8,local_1d8,local_198,&local_a8);
        if (iVar1 == 0) {
          mbedtls_ecp_group_free(local_168);
          mbedtls_mpi_free(local_1c8);
          mbedtls_mpi_free(local_1b8);
...
LAB_00104dcb:
            iVar1 = self_test_point_constprop_0
                              (param_1,local_168,local_1c8,local_1d8,local_1e8,&local_78);
          }
        }
      }
      goto LAB_00104c00;

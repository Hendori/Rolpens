...
LAB_001039f2:
    ...
    do {
      ...
      do {
        ...
        *(double *)(local_78 + lVar25) = dVar31;
        ...
        dVar31 = asin((dVar35 * pdVar1[2] - dVar4 * pdVar1[1]) * (dVar34 / dVar30) + 0.0 +
                      (dVar4 * *pdVar1 - pdVar1[2] * dVar32) * (dVar33 / dVar30) +
                      (pdVar1[1] * dVar32 - dVar35 * *pdVar1) * (dVar31 / dVar30));
      ...
      dVar31 = acos((double)((ulong)((double)local_88 * (double)local_58._0_8_ + 0.0 +
      ...
      dVar33 = acos((double)((ulong)((double)auVar9 * (double)local_78._8_8_ + 0.0 +
                                     dVar30 * (double)local_68._0_8_ +
      ...
      dVar30 = (local_108 * local_f0 *
               SQRT(dVar34 * dVar34 + 0.0 + dVar32 * dVar32 + dVar30 * dVar30)) / _LC12;
      piVar24 = (int *)&local_98;
      do {
        iVar5 = *piVar24;
        lVar25 = (long)*(int *)(lVar28 + (iVar5 + lVar21) * 0xc);
        dVar34 = dVar31;
        if ((iVar5 != 0) && (dVar34 = dVar35 - dVar33, iVar5 == 1)) {
          dVar34 = dVar33;
        }
        piVar24 = piVar24 + 1;
    ...
    if (uVar13 != 0) {
      do {
        ...
        dVar31 = *(double *)((long)local_f8 + lVar19 * 8) /
                 (_LC12 * *(double *)((long)local_100 + lVar19 * 8));
    ...
    *(long *)(this + 0xd8) = lVar19;
    ...
    if (*(long *)(this + 0x130) == 0) {
      ...
      if (*(ulong *)(this + 0x138) < uVar20) {
        ...
        *(ulong *)(this + 0x138) = uVar20;
LAB_00103baa:
        lVar19 = *(long *)(this + 0x128);
        for (puVar17 = (undefined8 *)(lVar19 + uVar13 * 0xc);
            (undefined8 *)(lVar19 + uVar20 * 0xc) != puVar17;
...
LAB_00103b94:
        if (uVar13 < uVar20) goto LAB_00103baa;
      }
        ...
        do {
          ...
          do {
            ...
            *(char *)((long)local_138 + (long)iVar23) = '\x01';
            ...
            if (cVar3 != '\x01') {
              if (0 < iVar5) {
                memcpy((void *)(lVar19 + (long)(iVar23 * iVar27) * 8),local_e0 + iVar5 * iVar23,
                       (ulong)(iVar5 - 1) * 8 + 8);
              }
              if (-1 < param_1) {
              ...
              if (-1 < param_2) {
                *(undefined8 *)(lVar19 + (long)(iVar23 * iVar27 + param_2) * 8) =
...
LAB_001047c0:
        ...
        if ((uVar5 & 1) == 0) {
          ...
          if ((ulong)local_1c0._8_8_ <= uVar1) {
            ...
            if (uVar13 == 0) {
LAB_001052cc:
              if (puVar14 != (undefined1 *)0x0) goto LAB_001053fb;
            }
            else {
              if ((long)uVar13 < 2) {
          ...
          if ((pdVar22[1] <= pdVar28[4]) && (pdVar22[2] <= pdVar28[5])) {
            if ((uVar23 & 1) == 0) {
              ...
              if ((ulong)local_1c0._8_8_ <= uVar1) {
                ...
                if (uVar13 == 0) {
LAB_0010521d:
                  if (puVar14 != (undefined1 *)0x0) goto LAB_00105346;
                }
                else {
                  if ((long)uVar13 < 2) {

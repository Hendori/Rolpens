...
/* ParallaxLayer::get_motion_scale() const */

undefined8 __thiscall ParallaxLayer::get_motion_scale(ParallaxLayer *this)
...
/* ParallaxLayer::get_motion_offset() const */

undefined8 __thiscall ParallaxLayer::get_motion_offset(ParallaxLayer *this)
...
/* ParallaxLayer::get_mirroring() const */

undefined8 __thiscall ParallaxLayer::get_mirroring(ParallaxLayer *this)
...
/* ParallaxLayer::_update_mirroring() [clone .part.0] */

void __thiscall ParallaxLayer::_update_mirroring(ParallaxLayer *this)

{
  ...
  if (lVar2 != 0) {
    ...
    if (lVar2 != 0) {
      ...
      local_28 = CONCAT44((float)((ulong)*(undefined8 *)(this + 0x59c) >> 0x20) *
                          (float)((ulong)*(undefined8 *)(this + 0x584) >> 0x20),
                          (float)*(undefined8 *)(this + 0x59c) *
                          (float)*(undefined8 *)(this + 0x584));
...
/* ParallaxLayer::set_mirroring(Vector2 const&) */

void __thiscall ParallaxLayer::set_mirroring(ParallaxLayer *this,Vector2 *param_1)
...
/* ParallaxLayer::_update_mirroring() */
...
/* ParallaxLayer::_notification(int) */

void __thiscall ParallaxLayer::_notification(ParallaxLayer *this,int param_1)
...
/* ParallaxLayer::set_base_offset_and_scale(Vector2 const&, float) */

void ParallaxLayer::set_base_offset_and_scale(Vector2 *param_1,float param_2)

{
  ...
  if ((((byte)param_1[0x2fa] & 0x40) != 0) &&
     (lVar2 = Engine::get_singleton(), *(char *)(lVar2 + 0xc0) == '\0')) {
...
/* ParallaxLayer::set_motion_scale(Vector2 const&) */

void __thiscall ParallaxLayer::set_motion_scale(ParallaxLayer *this,Vector2 *param_1)
...
/* ParallaxLayer::set_motion_offset(Vector2 const&) */

void __thiscall ParallaxLayer::set_motion_offset(ParallaxLayer *this,Vector2 *param_1)
...
/* ParallaxLayer::_bind_methods() */

void ParallaxLayer::_bind_methods(void)
...
/* ParallaxLayer::get_configuration_warnings() const */

ParallaxLayer * __thiscall ParallaxLayer::get_configuration_warnings(ParallaxLayer *this)
...
/* ParallaxLayer::is_class_ptr(void*) const */

uint __thiscall ParallaxLayer::is_class_ptr(ParallaxLayer *this,void *param_1)

{
  return (uint)CONCAT71(0x1067,(undefined4 *)param_1 == &Node2D::get_class_ptr_static()::ptr) |
...
/* ParallaxLayer::_property_can_revertv(StringName const&) const */

undefined8 ParallaxLayer::_property_can_revertv(StringName *param_1)
...
/* ParallaxLayer::_property_get_revertv(StringName const&, Variant&) const */

undefined8 ParallaxLayer::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* ParallaxLayer::_getv(StringName const&, Variant&) const */

undefined8 ParallaxLayer::_getv(StringName *param_1,Variant *param_2)
...
/* ParallaxLayer::_setv(StringName const&, Variant const&) */

undefined8 ParallaxLayer::_setv(StringName *param_1,Variant *param_2)
...
/* ParallaxLayer::_validate_propertyv(PropertyInfo&) const */

void ParallaxLayer::_validate_propertyv(PropertyInfo *param_1)
...
/* ParallaxLayer::_get_class_namev() const */

undefined8 * ParallaxLayer::_get_class_namev(void)
...
LAB_00102073:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"ParallaxLayer");
      goto LAB_001020de;
    }
  }
  StringName::assign_static_unique_class_name
...
/* ParallaxLayer::get_class() const */

void ParallaxLayer::get_class(void)
...
/* ParallaxLayer::is_class(String const&) const */

undefined8 __thiscall ParallaxLayer::is_class(ParallaxLayer *this,String *param_1)
...
/* ParallaxLayer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall ParallaxLayer::_get_property_listv(ParallaxLayer *this,List *param_1,bool param_2)
...
/* ParallaxLayer::_notificationv(int, bool) */

void __thiscall ParallaxLayer::_notificationv(ParallaxLayer *this,int param_1,bool param_2)
...
MethodBind * create_method_bind<ParallaxLayer,Vector2_const&>(_func_void_Vector2_ptr *param_1)
...
/* MethodBind* create_method_bind<ParallaxLayer, Vector2>(Vector2 (ParallaxLayer::*)() const) */

MethodBind * create_method_bind<ParallaxLayer,Vector2>(_func_Vector2 *param_1)
...
/* ParallaxLayer::_bind_methods() [clone .cold] */
...
/* ParallaxLayer::_initialize_classv() */

void ParallaxLayer::_initialize_classv(void)

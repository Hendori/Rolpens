...
/* unsigned char Noise::_alpha_blend<unsigned char>(unsigned char, unsigned char, int) const */

uchar __thiscall
Noise::_alpha_blend<unsigned_char>(Noise *this,uchar param_1,uchar param_2,int param_3)

{
  return (uchar)((param_3 + 1U & 0xffff) * (uint)param_2 +
                 (0x100U - param_3 & 0xffff) * (uint)param_1 >> 8);
}
...

{
  ...
  local_278 = this;
  pMVar6 = create_method_bind<Noise,Ref<Image>,int,int,bool,bool,bool>
                     ((_func_Ref_int_int_bool_bool_bool *)0x1f1);
  ...
  pMVar6 = create_method_bind<Noise,Ref<Image>,int,int,bool,bool,float,bool>
                     ((_func_Ref_int_int_bool_bool_float_bool *)0x201);
  ...
  pMVar6 = create_method_bind<Noise,TypedArray<Image>,int,int,int,bool,bool>
                     ((_func_TypedArray_int_int_int_bool_bool *)0x1f9);
  ...
  local_a8 = local_148;
  pMVar6 = create_method_bind<Noise,TypedArray<Image>,int,int,int,bool,float,bool>
                     ((_func_TypedArray_int_int_int_bool_float_bool *)0x209);
...
/* CowData<Ref<Image> >::_ref(CowData<Ref<Image> > const&) [clone .part.0] [clone .constprop.0] */
...
/* Error CowData<Ref<Image> >::resize<false>(long) [clone .isra.0] */

void __thiscall CowData<Ref<Image>>::resize<false>(CowData<Ref<Image>> *this,long param_1)
  ...
  if (param_1 * 8 != 0) {
    ...
    if (lVar12 != 0) {
      if (param_1 <= lVar5) {
        ...
        uVar10 = param_1;
        if (lVar5 == 0) {
CowData<Ref<Image>>_resize<false>:
                    /* WARNING: Does not return */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Noise::_get_image(int, int, int, bool, bool, bool) const */

long Noise::_get_image(int param_1,int param_2,int param_3,bool param_4,bool param_5,bool param_6)

{
  ...
  if ((iVar12 < 1 || iVar17 < 1) || (param_3 < 1)) {
    _err_print_error("_get_image","modules/noise/noise.cpp",0x54,
                     "Condition \"p_width <= 0 || p_height <= 0 || p_depth <= 0\" is true. Returning: Vector<Ref<Image>>()"
                     ,0,0);
      ...
      do {
        ...
        do {
          ...
          do {
            ...
            if ((0.0 <= fVar22) && (bVar5 = 0xff, fVar22 <= _LC52)) {
        ...
        if (pIVar3 == (Image *)pOVar10) {
          ...
          *puVar2 = pOVar10;
          if (pOVar10 == (Object *)0x0) {
            if ((pIVar3 != (Image *)0x0) && (cVar6 = RefCounted::unreference(), cVar6 != '\0')) {
...
LAB_00101daf:
      ...
      uVar9 = uVar9 | uVar9 >> 4;
      uVar9 = uVar9 | uVar9 >> 8;
      pvVar11 = (void *)Memory::realloc_static
                                  ((void *)0x0,(ulong)((uVar9 | uVar9 >> 0x10) + 1) << 2,false);
      if (pvVar11 == (void *)0x0) {
        ...
        do {
          ...
          do {
            ...
            if (fVar22 != fVar26) {
              if (uVar8 <= uVar9) goto LAB_00102023;
              bVar5 = 0;
              fVar23 = ((*(float *)((long)pvVar11 + (long)(int)uVar9 * 4) - fVar22) /
                       (fVar26 - fVar22)) * _LC52;
              if ((0.0 <= fVar23) && (bVar5 = 0xff, fVar23 <= _LC52)) {
...
LAB_00101eb9:
  _err_print_index_error("operator[]",pcVar15,iVar12,uVar20,lVar18,"p_index",pcVar27,"",false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar4 = (code *)invalidInstructionException();
  (*pcVar4)();
...
/* Noise::get_image(int, int, bool, bool, bool) const */

long * Noise::get_image(int param_1,int param_2,bool param_3,bool param_4,bool param_5)

{
  ...
  _get_image((int)auStack_28,param_2,(int)CONCAT71(in_register_00000011,param_3),param_4,true,
             param_5);
  if (local_20[0] != (long *)0x0) {
    if (local_20[0][-1] < 1) {
      _err_print_index_error
                ("get","./core/templates/cowdata.h",0xdb,0,local_20[0][-1],"p_index","size()","",
                 false,true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
      pcVar1 = (code *)invalidInstructionException();
  ...
  *plVar3 = 0;
LAB_0010237a:
  CowData<Ref<Image>>::_unref((CowData<Ref<Image>> *)local_20);
...
/* Noise::get_image_3d(int, int, int, bool, bool) const */
...
/* Noise::_get_seamless_image(int, int, int, bool, bool, float, bool) const */

long Noise::_get_seamless_image
               (int param_1,int param_2,int param_3,bool param_4,bool param_5,float param_6,
               bool param_7)

{
  ...
  if ((iVar50 < 1 || iVar40 < 1) || (param_3 < 1)) {
    _err_print_error("_get_seamless_image","modules/noise/noise.cpp",0x24,
                     "Condition \"p_width <= 0 || p_height <= 0 || p_depth <= 0\" is true. Returning: Vector<Ref<Image>>()"
                     ,0,0);
...
LAB_0010487a:
    ...
    if (0 < lVar23) {
      ...
      if (iVar14 == 0) {
        ...
        if (param_6 < 0.0) {
LAB_001049e2:
          _err_print_error("_generate_seamless_image","modules/noise/noise.h",0x69,
                           "Condition \"p_blend_skirt < 0\" is true. Returning: Vector<Ref<Image>>()"
                           ,0,0);
          *(undefined8 *)(lVar37 + 8) = 0;
        }
        else {
          ...
          if (local_90[0] != 0) {
            ...
            do {
              ...
              CowData<unsigned_char>::resize<false>
                        ((CowData<unsigned_char> *)&local_60,(long)(iVar50 * param_3 * iVar18));
              lVar44 = local_a0[0];
              if (local_a0[0] == 0) {
                lVar23 = 0;
                local_128 = local_168;
              ...
              do {
                ...
                do {
                  iVar25 = iVar26 + 1;
                  *(undefined1 *)(local_60 + (iVar26 % param_3 + (iVar42 % iVar50) * param_3)) =
                       *(undefined1 *)
                        (lVar23 + ((iVar26 + iVar14) % param_3 +
                                  ((iVar42 + iVar32) % iVar50) * iVar49));
                  fVar9 = _LC68;
                  fVar8 = _LC67;
                  fVar57 = _LC52;
                  iVar26 = iVar25;
              ...
              if (iVar14 < iVar15) {
                ...
                do {
                  iVar25 = 0xff;
                  fVar55 = ((float)(iVar26 + iVar14 * -2) / (float)(int)(float)local_1a0 - _LC66) /
                           fVar8;
                  if ((0.0 <= fVar55) && (iVar25 = 0, fVar55 <= fVar7)) {
                  ...
                  do {
                    ...
                    *pbVar38 = (byte)((uint)*(byte *)(lVar23 + ((iVar27 % iVar50) * iVar49 +
                                                               iVar26 % iVar49)) *
                                      (iVar25 + 1U & 0xffff) +
                                      (uint)*pbVar38 * (0x100U - iVar25 & 0xffff) >> 8);
                  } while (iVar47 < iVar50);
LAB_00102b2e:
                  iVar42 = iVar42 + 1;
                  iVar26 = iVar26 + 1;
              ...
              if (iVar32 < iVar16) {
                ...
                do {
                  ...
                  if ((0.0 <= fVar56) && (iVar26 = 0, fVar56 <= fVar7)) {
                  ...
                  do {
                    ...
                    *pbVar38 = (byte)((uint)*(byte *)(lVar23 + (((iVar42 + iVar32) % iVar53) *
                                                                iVar49 + iVar47 % param_3)) *
                                      (iVar26 + 1U & 0xffff) +
                                      (uint)*pbVar38 * (0x100U - iVar26 & 0xffff) >> 8);
                  } while (iVar25 < param_3);
LAB_00102c86:
                  fVar11 = _LC68;
                  fVar56 = _LC52;
                    ...
                    do {
                      ...
                      if (0.0 <= fVar55) {
                        if (fVar7 < fVar55) {
                          ...
                          iVar29 = (int)((fVar7 - (fVar11 - (fVar55 + fVar55)) * fVar55 * fVar55) *
                                        fVar56);
...
LAB_00102d93:
                        if (fVar7 < fVar57) {
                          ...
                          iVar29 = (int)((fVar7 - (fVar10 - (fVar57 + fVar57)) * fVar57 * fVar57) *
                                        fVar56);
                      ...
                      *(char *)(local_60 + (iVar27 % param_3 + (iVar26 % iVar50) * param_3)) =
                           (char)((*(byte *)(lVar23 + (iVar28 + iVar47)) * uVar46 +
                                   *(byte *)(lVar23 + (iVar29 + iVar47)) * uVar41 >> 8 & 0xff) *
                                  uVar52 + (*(byte *)(lVar23 + (iVar29 + iVar42)) * uVar41 +
                                            *(byte *)(lVar23 + (iVar28 + iVar42)) * uVar46 >> 8 &
                                           0xff) * uVar45 >> 8);
...
LAB_001048d9:
              ...
              if ((*plVar48 != 0) && (cVar13 = RefCounted::unreference(), cVar13 != '\0')) {
          ...
          if (iVar40 != 1) {
            ...
            if (0 < iVar50) {
              do {
                ...
                lVar23 = local_90[0];
                Ref<Image>::operator=
                          ((Ref<Image> *)(lVar54 * 8 + local_90[0]),*(Ref **)(lVar44 + lVar35 * 8));
                if (lVar23 == 0) {
                  lVar23 = 0;
                  local_128 = lVar35;
                  goto LAB_001048fb;
                ...
                if ((pRVar12 != (Ref *)0x0) && (cVar13 = RefCounted::unreference(), cVar13 != '\0'))
                {
...
LAB_00104dad:
                ...
                CowData<unsigned_char>::resize<false>
                          ((CowData<unsigned_char> *)local_50,(long)(iVar49 * iVar14 * iVar15));
                if (local_70[0] != 0) {
                  local_128 = 0;
                  iVar49 = (int)((_LC60 - (_LC68 - ((float)local_1a0 + (float)local_1a0)) *
                                          (float)local_1a0 * (float)local_1a0) * _LC52);
                  do {
                    ...
                    local_1a0._0_1_ =
                         (undefined1)
                         ((uint)bVar31 * (uint)(ushort)((short)iVar49 + 1) +
                          (uint)bVar2 * (0x100U - iVar49 & 0xffff) >> 8);
...
LAB_001048fb:
                  _err_print_index_error
                            ("operator[]","./core/templates/vector.h",0x38,local_128,lVar23,
          ...
          do {
            ...
            do {
              ...
              do {
                iVar25 = iVar26 + 1;
                *(undefined4 *)
                 (local_60 + (long)(iVar26 % param_3 + (iVar42 % iVar50) * param_3) * 4) =
                     *(undefined4 *)
                      (lVar23 + (long)((iVar26 + iVar14) % param_3 +
                                      iVar49 * ((iVar42 + iVar32) % iVar50)) * 4);
                fVar9 = _LC68;
                fVar8 = _LC67;
                fVar57 = _LC52;
                iVar26 = iVar25;
            ...
            if (iVar14 < iVar15) {
              ...
              do {
                iVar25 = 0xff;
                fVar55 = ((float)(iVar42 + iVar14 * -2) / (float)(int)(float)local_1a0 - _LC66) /
                         fVar8;
                if ((0.0 <= fVar55) && (iVar25 = 0, fVar55 <= fVar7)) {
                  iVar25 = (int)((fVar7 - (fVar9 - (fVar55 + fVar55)) * fVar55 * fVar55) * fVar57);
                }
                ...
                do {
                  ...
                  uVar41 = *(uint *)(lVar23 + (long)(((iVar32 + iVar47) % iVar50) * iVar49 +
                                                    iVar42 % iVar49) * 4);
                  puVar1 = (uint *)(local_60 +
                                   (long)((iVar47 % iVar50) * param_3 + iVar26 % param_3) * 4);
                  ...
                  iVar47 = iVar47 + 1;
                  uVar41 = (uint)CONCAT62((int6)(uVar34 >> 0x10),
                                          CONCAT11((char)((uVar41 >> 8 & 0xff) * (uint)uVar39 +
                                                          (uVar46 >> 8 & 0xff) * uVar45 >> 8),
                                                   (char)((uVar41 & 0xff) * (uint)uVar39 +
                                                          (uVar46 & 0xff) * uVar45 >> 8))) &
                           0xff00ffff |
                           ((uVar41 >> 0x10 & 0xff) * (uint)uVar39 +
                            (uVar46 >> 0x10 & 0xff) * uVar45 >> 8 & 0xff) << 0x10 | 0xff000000;
                  uVar34 = (ulong)uVar41;
                  *puVar1 = uVar41;
                } while (iVar47 < iVar50);
LAB_0010337a:
            ...
            if (iVar32 < iVar16) {
              ...
              do {
                ...
                do {
                  ...
                  uVar41 = *(uint *)(lVar23 + (long)(iVar49 * ((iVar32 + iVar42) % iVar53) +
                                                    (iVar14 + iVar25) % param_3) * 4);
                  puVar1 = (uint *)(local_60 +
                                   (long)((iVar42 % iVar50) * param_3 + iVar25 % param_3) * 4);
              ...
              do {
                if (iVar14 < iVar15) {
                  ...
                  do {
                    ...
                    if ((0.0 <= fVar55) && (uVar41 = 0, fVar55 <= fVar7)) {
                      uVar41 = (uint)((fVar7 - (fVar11 - (fVar55 + fVar55)) * fVar55 * fVar55) *
                                     fVar56);
                    }
                    uVar46 = 0xff;
                    if ((0.0 <= fVar57) && (uVar46 = 0, fVar57 <= fVar7)) {
                      uVar46 = (uint)((fVar7 - (fVar10 - (fVar57 + fVar57)) * fVar57 * fVar57) *
                                     fVar56);
                    }
                    ...
                    uVar19 = (uint)CONCAT62((int6)(local_168 >> 0x10),
                                            CONCAT11((char)((uVar45 >> 8 & 0xff) * (uint)uVar51 +
                                                            (uVar52 >> 8 & 0xff) * uVar43 >> 8),
                                                     (char)((uVar45 & 0xff) * (uint)uVar51 +
                                                            (uVar52 & 0xff) * uVar43 >> 8)));
                    ...
                    bVar31 = (byte)((uVar33 >> 8 & 0xff) * (uint)uVar39 +
                                    (uVar3 >> 8 & 0xff) * uVar41 >> 8);
                    ...
                    iVar47 = iVar47 + 1;
                    uVar41 = CONCAT22((short)(local_198 >> 0x10),
                                      CONCAT11((char)(((uVar19 & 0xff00) >> 8) * (uint)uVar36 +
                                                      bVar31 * uVar46 >> 8),
                                               (char)((uVar19 & 0xff) * (uint)uVar36 +
                                                      (CONCAT11(bVar31,(char)((uVar33 & 0xff) *
                                                                              (uint)uVar39 +
                                                                              (uVar3 & 0xff) *
                                                                              uVar41 >> 8)) & 0xff)
                                                      * uVar46 >> 8))) & 0xff00ffff |
                             (((uVar45 >> 0x10 & 0xff) * (uint)uVar51 +
                               (uVar52 >> 0x10 & 0xff) * uVar43 >> 8 & 0xff) * (uint)uVar36 +
                              ((uVar3 >> 0x10 & 0xff) * uVar41 +
                               (uVar33 >> 0x10 & 0xff) * (uint)uVar39 >> 8 & 0xff) * uVar46 >> 8 &
                             0xff) << 0x10;
                    local_158 = uVar41 | 0xff000000;
                    local_198 = (ulong)uVar41 | 0xff000000;
                    *(uint *)(local_60 + (long)(iVar27 % param_3 + (iVar42 % iVar50) * param_3) * 4)
                         = local_158;
...
LAB_0010491e:
            ...
            *plVar48 = 0;
            ...
            if (pIVar4 == (Image *)pOVar24) {
              ...
              *puVar30 = pOVar24;
              if (pOVar24 == (Object *)0x0) {
                if ((pIVar4 != (Image *)0x0) && (cVar13 = RefCounted::unreference(), cVar13 != '\0')
                   ) {
                  memdelete<Image>(pIVar4);
                }
              }
...
LAB_00104c5d:
            ...
            if (local_70[0] != 0) {
              local_128 = 0;
              iVar49 = (int)((_LC60 - (_LC68 - (local_178 + local_178)) * local_178 * local_178) *
                            _LC52);
              do {
                if (*(long *)(local_70[0] + -8) <= local_128) break;
                if (local_60 == 0) {
                ...
                if (lVar23 <= local_128) goto LAB_001048fb;
                CowData<unsigned_char>::_copy_on_write((CowData<unsigned_char> *)local_50);
                *(char *)(local_50[0] + local_128) =
                     (char)((uint)bVar31 * (uint)(ushort)((short)iVar49 + 1) +
                            (uint)bVar2 * (0x100U - iVar49 & 0xffff) >> 8);
                local_128 = local_128 + 1;
              } while (local_70[0] != 0);
            }
...
LAB_0010489a:
  _err_print_index_error
            ("get","./core/templates/cowdata.h",0xdb,local_128,lVar23,"p_index","size()","",false,
             true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar5 = (code *)invalidInstructionException();
...
/* Noise::get_seamless_image(int, int, bool, bool, float, bool) const */

long * Noise::get_seamless_image
                 (int param_1,int param_2,bool param_3,bool param_4,float param_5,bool param_6)

{
  ...
  local_10 = *(long *)(in_FS_OFFSET + 0x28);
  _get_seamless_image((int)auStack_28,param_2,(int)CONCAT71(in_register_00000011,param_3),param_4,
                      true,param_5,param_6);
  if ((local_20[0] != (long *)0x0) && (lVar1 = local_20[0][-1], lVar1 != 0)) {
    if (lVar1 < 1) {
      _err_print_index_error
...
/* Noise::get_seamless_image_3d(int, int, int, bool, float, bool) const */
...
/* Noise::is_class_ptr(void*) const */

uint __thiscall Noise::is_class_ptr(Noise *this,void *param_1)

{
  return (uint)CONCAT71(0x1100,(undefined4 *)param_1 == &Resource::get_class_ptr_static()::ptr) |
...
/* Noise::_getv(StringName const&, Variant&) const */

undefined8 Noise::_getv(StringName *param_1,Variant *param_2)
...
/* Noise::_setv(StringName const&, Variant const&) */

undefined8 Noise::_setv(StringName *param_1,Variant *param_2)
...
/* Noise::_validate_propertyv(PropertyInfo&) const */

void Noise::_validate_propertyv(PropertyInfo *param_1)
...
/* Noise::_property_can_revertv(StringName const&) const */

undefined8 Noise::_property_can_revertv(StringName *param_1)
...
/* Noise::_property_get_revertv(StringName const&, Variant&) const */

undefined8 Noise::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* Noise::_notificationv(int, bool) */

void Noise::_notificationv(int param_1,bool param_2)
...
/* MethodBindTRC<float, Vector3>::_gen_argument_type(int) const */

char __thiscall
MethodBindTRC<float,Vector3>::_gen_argument_type(MethodBindTRC<float,Vector3> *this,int param_1)
...
/* MethodBindTRC<float, Vector3>::get_argument_meta(int) const */

uint __thiscall
MethodBindTRC<float,Vector3>::get_argument_meta(MethodBindTRC<float,Vector3> *this,int param_1)
...
/* MethodBindTRC<float, float, float, float>::_gen_argument_type(int) const */

undefined8 MethodBindTRC<float,float,float,float>::_gen_argument_type(int param_1)
...
/* MethodBindTRC<float, float, float, float>::get_argument_meta(int) const */

char __thiscall
MethodBindTRC<float,float,float,float>::get_argument_meta
          (MethodBindTRC<float,float,float,float> *this,int param_1)
...
/* MethodBindTRC<float, Vector2>::_gen_argument_type(int) const */

char __thiscall
MethodBindTRC<float,Vector2>::_gen_argument_type(MethodBindTRC<float,Vector2> *this,int param_1)
...
/* MethodBindTRC<float, Vector2>::get_argument_meta(int) const */

uint __thiscall
MethodBindTRC<float,Vector2>::get_argument_meta(MethodBindTRC<float,Vector2> *this,int param_1)
...
/* MethodBindTRC<float, float, float>::_gen_argument_type(int) const */

undefined8 MethodBindTRC<float,float,float>::_gen_argument_type(int param_1)
...
/* MethodBindTRC<float, float, float>::get_argument_meta(int) const */

char __thiscall
MethodBindTRC<float,float,float>::get_argument_meta
          (MethodBindTRC<float,float,float> *this,int param_1)
...
/* MethodBindTRC<float, float>::_gen_argument_type(int) const */

undefined8 MethodBindTRC<float,float>::_gen_argument_type(int param_1)
...
/* MethodBindTRC<float, float>::get_argument_meta(int) const */

char __thiscall
MethodBindTRC<float,float>::get_argument_meta(MethodBindTRC<float,float> *this,int param_1)
...
char __thiscall
MethodBindTRC<TypedArray<Image>,int,int,int,bool,float,bool>::_gen_argument_type
          (MethodBindTRC<TypedArray<Image>,int,int,int,bool,float,bool> *this,int param_1)
...
char __thiscall
MethodBindTRC<TypedArray<Image>,int,int,int,bool,float,bool>::get_argument_meta
          (MethodBindTRC<TypedArray<Image>,int,int,int,bool,float,bool> *this,int param_1)
...
/* MethodBindTRC<TypedArray<Image>, int, int, int, bool, bool>::_gen_argument_type(int) const */

char __thiscall
MethodBindTRC<TypedArray<Image>,int,int,int,bool,bool>::_gen_argument_type
          (MethodBindTRC<TypedArray<Image>,int,int,int,bool,bool> *this,int param_1)
...
/* MethodBindTRC<TypedArray<Image>, int, int, int, bool, bool>::get_argument_meta(int) const */

byte __thiscall
MethodBindTRC<TypedArray<Image>,int,int,int,bool,bool>::get_argument_meta
          (MethodBindTRC<TypedArray<Image>,int,int,int,bool,bool> *this,int param_1)
...
/* MethodBindTRC<Ref<Image>, int, int, bool, bool, float, bool>::_gen_argument_type(int) const */

char __thiscall
MethodBindTRC<Ref<Image>,int,int,bool,bool,float,bool>::_gen_argument_type
          (MethodBindTRC<Ref<Image>,int,int,bool,bool,float,bool> *this,int param_1)
...
/* MethodBindTRC<Ref<Image>, int, int, bool, bool, float, bool>::get_argument_meta(int) const */

char __thiscall
MethodBindTRC<Ref<Image>,int,int,bool,bool,float,bool>::get_argument_meta
          (MethodBindTRC<Ref<Image>,int,int,bool,bool,float,bool> *this,int param_1)
...
/* MethodBindTRC<Ref<Image>, int, int, bool, bool, bool>::_gen_argument_type(int) const */

char __thiscall
MethodBindTRC<Ref<Image>,int,int,bool,bool,bool>::_gen_argument_type
          (MethodBindTRC<Ref<Image>,int,int,bool,bool,bool> *this,int param_1)
...
/* MethodBindTRC<Ref<Image>, int, int, bool, bool, bool>::get_argument_meta(int) const */

byte __thiscall
MethodBindTRC<Ref<Image>,int,int,bool,bool,bool>::get_argument_meta
          (MethodBindTRC<Ref<Image>,int,int,bool,bool,bool> *this,int param_1)
...
/* MethodBindTRC<float, float>::~MethodBindTRC() */

void __thiscall MethodBindTRC<float,float>::~MethodBindTRC(MethodBindTRC<float,float> *this)
...
/* MethodBindTRC<float, float, float>::~MethodBindTRC() */

void __thiscall
MethodBindTRC<float,float,float>::~MethodBindTRC(MethodBindTRC<float,float,float> *this)
...
/* MethodBindTRC<float, Vector2>::~MethodBindTRC() */

void __thiscall MethodBindTRC<float,Vector2>::~MethodBindTRC(MethodBindTRC<float,Vector2> *this)
...
/* MethodBindTRC<float, float, float, float>::~MethodBindTRC() */

void __thiscall
MethodBindTRC<float,float,float,float>::~MethodBindTRC(MethodBindTRC<float,float,float,float> *this)
...
/* MethodBindTRC<float, Vector3>::~MethodBindTRC() */

void __thiscall MethodBindTRC<float,Vector3>::~MethodBindTRC(MethodBindTRC<float,Vector3> *this)
...
/* MethodBindTRC<Ref<Image>, int, int, bool, bool, bool>::~MethodBindTRC() */

void __thiscall
MethodBindTRC<Ref<Image>,int,int,bool,bool,bool>::~MethodBindTRC
          (MethodBindTRC<Ref<Image>,int,int,bool,bool,bool> *this)
...
/* MethodBindTRC<Ref<Image>, int, int, bool, bool, float, bool>::~MethodBindTRC() */

void __thiscall
MethodBindTRC<Ref<Image>,int,int,bool,bool,float,bool>::~MethodBindTRC
          (MethodBindTRC<Ref<Image>,int,int,bool,bool,float,bool> *this)
...
/* MethodBindTRC<TypedArray<Image>, int, int, int, bool, bool>::~MethodBindTRC() */

void __thiscall
MethodBindTRC<TypedArray<Image>,int,int,int,bool,bool>::~MethodBindTRC
          (MethodBindTRC<TypedArray<Image>,int,int,int,bool,bool> *this)
...
/* MethodBindTRC<TypedArray<Image>, int, int, int, bool, float, bool>::~MethodBindTRC() */

void __thiscall
MethodBindTRC<TypedArray<Image>,int,int,int,bool,float,bool>::~MethodBindTRC
          (MethodBindTRC<TypedArray<Image>,int,int,int,bool,float,bool> *this)
...
/* Noise::_get_class_namev() const */

undefined8 * Noise::_get_class_namev(void)
...
LAB_00105773:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"Noise");
      goto LAB_001057de;
    }
  }
  StringName::assign_static_unique_class_name
...
/* Noise::get_class() const */

void Noise::get_class(void)
...
/* MethodBindTRC<float, Vector3>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTRC<float,Vector3>::_gen_argument_type_info(int param_1)
...
/* MethodBindTRC<float, Vector2>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTRC<float,Vector2>::_gen_argument_type_info(int param_1)
...
/* MethodBind* create_method_bind<Noise, float, float>(float (Noise::*)(float) const) */

MethodBind * create_method_bind<Noise,float,float>(_func_float_float *param_1)
...
/* MethodBind* create_method_bind<Noise, float, Vector2>(float (Noise::*)(Vector2) const) */

MethodBind * create_method_bind<Noise,float,Vector2>(_func_float_Vector2 *param_1)
...
MethodBind *
create_method_bind<Noise,float,float,float,float>(_func_float_float_float_float *param_1)
...
/* MethodBind* create_method_bind<Noise, float, Vector3>(float (Noise::*)(Vector3) const) */

MethodBind * create_method_bind<Noise,float,Vector3>(_func_float_Vector3 *param_1)
...
/* MethodBind* create_method_bind<Noise, Ref<Image>, int, int, bool, bool, bool>(Ref<Image>
   (Noise::*)(int, int, bool, bool, bool) const) */

MethodBind *
create_method_bind<Noise,Ref<Image>,int,int,bool,bool,bool>
          (_func_Ref_int_int_bool_bool_bool *param_1)
...
/* MethodBind* create_method_bind<Noise, Ref<Image>, int, int, bool, bool, float, bool>(Ref<Image>
   (Noise::*)(int, int, bool, bool, float, bool) const) */

MethodBind *
create_method_bind<Noise,Ref<Image>,int,int,bool,bool,float,bool>
          (_func_Ref_int_int_bool_bool_float_bool *param_1)
...
/* MethodBind* create_method_bind<Noise, TypedArray<Image>, int, int, int, bool,
   bool>(TypedArray<Image> (Noise::*)(int, int, int, bool, bool) const) */

MethodBind *
create_method_bind<Noise,TypedArray<Image>,int,int,int,bool,bool>
          (_func_TypedArray_int_int_int_bool_bool *param_1)
...
/* MethodBind* create_method_bind<Noise, TypedArray<Image>, int, int, int, bool, float,
   bool>(TypedArray<Image> (Noise::*)(int, int, int, bool, float, bool) const) */

MethodBind *
create_method_bind<Noise,TypedArray<Image>,int,int,int,bool,float,bool>
          (_func_TypedArray_int_int_int_bool_float_bool *param_1)
...
/* Noise::_bind_methods() [clone .cold] */
...
/* Error CowData<Ref<Image> >::resize<false>(long) [clone .isra.0] [clone .cold] */

void CowData<Ref<Image>>::resize<false>(long param_1)
...
/* Noise::_initialize_classv() */

void Noise::_initialize_classv(void)
...
/* Ref<Image>::TEMPNAMEPLACEHOLDERVALUE(Image*) */

void __thiscall Ref<Image>::operator=(Ref<Image> *this,Image *param_1)
...
/* WARNING: Removing unreachable block (ram,0x00108c78) */
/* WARNING: Removing unreachable block (ram,0x00108e0d) */
/* WARNING: Removing unreachable block (ram,0x00108e19) */
...
/* MethodBindTRC<float, Vector3>::validated_call(Object*, Variant const**, Variant*) const */

void __thiscall
MethodBindTRC<float,Vector3>::validated_call
          (MethodBindTRC<float,Vector3> *this,Object *param_1,Variant **param_2,Variant *param_3)

{
  ...
  fVar5 = (float)(*pcVar3)(*(undefined8 *)(*param_2 + 8),*(undefined4 *)(*param_2 + 0x10),
...
/* MethodBindTRC<float, Vector3>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTRC<float,Vector3>::ptrcall
          (MethodBindTRC<float,Vector3> *this,Object *param_1,void **param_2,void *param_3)

{
  ...
  fVar5 = (float)(*pcVar3)(**param_2,*(undefined4 *)((long)*param_2 + 8),
                           param_1 + *(long *)(this + 0x60));
...
void __thiscall
MethodBindTRC<float,float,float,float>::validated_call
          (MethodBindTRC<float,float,float,float> *this,Object *param_1,Variant **param_2,
          Variant *param_3)
...
/* MethodBindTRC<float, float, float, float>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTRC<float,float,float,float>::ptrcall
          (MethodBindTRC<float,float,float,float> *this,Object *param_1,void **param_2,void *param_3
          )
...
/* MethodBindTRC<float, Vector2>::validated_call(Object*, Variant const**, Variant*) const */

void __thiscall
MethodBindTRC<float,Vector2>::validated_call
          (MethodBindTRC<float,Vector2> *this,Object *param_1,Variant **param_2,Variant *param_3)
...
/* MethodBindTRC<float, Vector2>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTRC<float,Vector2>::ptrcall
          (MethodBindTRC<float,Vector2> *this,Object *param_1,void **param_2,void *param_3)
...
/* MethodBindTRC<float, float, float>::validated_call(Object*, Variant const**, Variant*) const */

void __thiscall
MethodBindTRC<float,float,float>::validated_call
          (MethodBindTRC<float,float,float> *this,Object *param_1,Variant **param_2,Variant *param_3
          )
...
/* MethodBindTRC<float, float, float>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTRC<float,float,float>::ptrcall
          (MethodBindTRC<float,float,float> *this,Object *param_1,void **param_2,void *param_3)
...
/* MethodBindTRC<float, float>::validated_call(Object*, Variant const**, Variant*) const */

void __thiscall
MethodBindTRC<float,float>::validated_call
          (MethodBindTRC<float,float> *this,Object *param_1,Variant **param_2,Variant *param_3)
...
/* MethodBindTRC<float, float>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTRC<float,float>::ptrcall
          (MethodBindTRC<float,float> *this,Object *param_1,void **param_2,void *param_3)
...
void __thiscall
MethodBindTRC<TypedArray<Image>,int,int,int,bool,bool>::validated_call
          (MethodBindTRC<TypedArray<Image>,int,int,int,bool,bool> *this,Object *param_1,
...

{
  ...
  (*pcVar3)((Array *)&local_48,param_1 + *(long *)(this + 0x60),*(undefined8 *)(*param_2 + 8),
            *(undefined8 *)(param_2[1] + 8),*(undefined8 *)(param_2[2] + 8),param_2[3][8],
            param_2[4][8]);
...
void __thiscall
MethodBindTRC<TypedArray<Image>,int,int,int,bool,float,bool>::validated_call
          (MethodBindTRC<TypedArray<Image>,int,int,int,bool,float,bool> *this,Object *param_1,
          Variant **param_2,Variant *param_3)

{
  ...
  (*pcVar3)(auVar5._0_8_,(Array *)&local_48,param_1 + *(long *)(this + 0x60),
            *(undefined8 *)(*param_2 + 8),*(undefined8 *)(param_2[1] + 8),
            *(undefined8 *)(param_2[2] + 8),param_2[3][8],param_2[5][8]);
  Array::operator=((Array *)(param_3 + 8),(Array *)&local_48);
  Array::~Array((Array *)&local_48);
LAB_0010a83e:
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
...
void __thiscall
MethodBindTRC<TypedArray<Image>,int,int,int,bool,bool>::ptrcall
          (MethodBindTRC<TypedArray<Image>,int,int,int,bool,bool> *this,Object *param_1,
...

{
  ...
  if (((ulong)pcVar3 & 1) != 0) {
    pcVar3 = *(code **)(pcVar3 + *(long *)(param_1 + *(long *)(this + 0x60)) + -1);
                    ...
                    /* WARNING: Load size is inaccurate */
                    /* WARNING: Load size is inaccurate */
  (*pcVar3)((Array *)&local_48,param_1 + *(long *)(this + 0x60),**param_2,*param_2[1],*param_2[2],
...
void __thiscall
MethodBindTRC<TypedArray<Image>,int,int,int,bool,float,bool>::ptrcall
          (MethodBindTRC<TypedArray<Image>,int,int,int,bool,float,bool> *this,Object *param_1,
          void **param_2,void *param_3)

{
  ...
  auVar5._0_4_ = (float)*param_2[4];
                    ...
                    /* WARNING: Load size is inaccurate */
                    /* WARNING: Load size is inaccurate */
  (*pcVar3)(auVar5._0_8_,(Array *)&local_48,param_1 + *(long *)(this + 0x60),**param_2,*param_2[1],
            *param_2[2],*param_2[3] != '\0',*param_2[5] != '\0');
  Array::operator=((Array *)param_3,(Array *)&local_48);
  Array::~Array((Array *)&local_48);
LAB_0010ace9:
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
...
void __thiscall
MethodBindTRC<Ref<Image>,int,int,bool,bool,bool>::ptrcall
          (MethodBindTRC<Ref<Image>,int,int,bool,bool,bool> *this,Object *param_1,void **param_2,
          void *param_3)

{
  ...
  (*pcVar2)((StringName *)&local_48,param_1 + *(long *)(this + 0x60),**param_2,*param_2[1],
            *param_2[2] != '\0',*param_2[3] != '\0',*param_2[4] != '\0');
...
void __thiscall
MethodBindTRC<Ref<Image>,int,int,bool,bool,float,bool>::ptrcall
          (MethodBindTRC<Ref<Image>,int,int,bool,bool,float,bool> *this,Object *param_1,
          void **param_2,void *param_3)

{
  ...
  (*pcVar2)(auVar6._0_8_,(StringName *)&local_48,param_1 + *(long *)(this + 0x60),**param_2,
            *param_2[1],*param_2[2] != '\0',*param_2[3] != '\0',*param_2[5] != '\0');
  if (local_48 == (Image *)0x0) {
                    /* WARNING: Load size is inaccurate */
    pOVar5 = *param_3;
...
Object * MethodBindTRC<Ref<Image>,int,int,bool,bool,bool>::call
  ...
  if (in_R8D < 6) {
    ...
    if ((int)(5 - in_R8D) <= iVar11) {
      ...
      do {
        if ((int)lVar14 < (int)in_R8D) {
          ...
          if (lVar19 <= (int)uVar16) {
            _err_print_index_error
                      ("get","./core/templates/cowdata.h",0xdb,(long)(int)uVar16,lVar19,"p_index",
                       "size()","",false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
            pcVar4 = (code *)invalidInstructionException();
      ...
      *in_R9 = 0;
      ...
      (*(code *)pVVar20)(&local_98,(Variant *)((long)plVar17 + (long)pVVar2),iVar12,iVar11,bVar10,
                         bVar9,bVar8);
...
Object * MethodBindTRC<TypedArray<Image>,int,int,int,bool,bool>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
  ...
  if (in_R8D < 6) {
    ...
    if ((int)(5 - in_R8D) <= iVar9) {
      ...
      do {
        if ((int)lVar13 < (int)in_R8D) {
          ...
          if (lVar18 <= (int)uVar15) {
            _err_print_index_error
                      ("get","./core/templates/cowdata.h",0xdb,(long)(int)uVar15,lVar18,"p_index",
                       "size()","",false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
            pcVar3 = (code *)invalidInstructionException();
      ...
      *in_R9 = 0;
      ...
      (*(code *)local_b8)((Array *)&local_98,(Variant *)((long)plVar16 + (long)pVVar1),iVar11,iVar10
                          ,iVar9,bVar8,bVar7);
...
/* MethodBindTRC<float, float>::call(Object*, Variant const**, int, Callable::CallError&) const */

Object * MethodBindTRC<float,float>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
Object * MethodBindTRC<float,float,float,float>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
  ...
  if (in_R8D < 4) {
    ...
    if ((int)(3 - in_R8D) <= iVar11) {
      ...
      *in_R9 = 0;
      ...
      fVar16 = (float)(*(code *)pVVar15)(auVar18._0_8_,fVar17,fVar16,
                                         (Variant *)((long)plVar12 + (long)pVVar1));
...
Object * MethodBindTRC<Ref<Image>,int,int,bool,bool,float,bool>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
      ...
      do {
        while ((int)in_R8D <= (int)lVar14) {
          ...
          if (lVar18 <= (int)uVar16) {
            _err_print_index_error
                      ("get","./core/templates/cowdata.h",0xdb,(long)(int)uVar16,lVar18,"p_index",
                       "size()","",false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
            pcVar4 = (code *)invalidInstructionException();
...
LAB_0010c770:
      *in_R9 = 0;
      ...
      (*(code *)pVVar19)(&local_a8,(Variant *)((long)plVar17 + (long)pVVar2),iVar12,iVar11,bVar10,
                         bVar9,bVar8);
...
Object * MethodBindTRC<TypedArray<Image>,int,int,int,bool,float,bool>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
      ...
      do {
        while ((int)in_R8D <= (int)lVar13) {
          ...
          if (lVar17 <= (int)uVar15) {
            _err_print_index_error
                      ("get","./core/templates/cowdata.h",0xdb,(long)(int)uVar15,lVar17,"p_index",
                       "size()","",false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
            pcVar3 = (code *)invalidInstructionException();
...
LAB_0010cc88:
      *in_R9 = 0;
      ...
      (*(code *)local_d0)((Array *)&local_a8,(Variant *)((long)plVar16 + (long)pVVar1),iVar11,iVar10
                          ,iVar9,bVar8,bVar7);
...
/* MethodBindTRC<float, Vector3>::call(Object*, Variant const**, int, Callable::CallError&) const */

Object * MethodBindTRC<float,Vector3>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
LAB_0010d240:
    ...
    *in_R9 = 0;
    ...
    fVar13 = (float)(*(code *)pVVar12)(auVar14._0_8_,auVar14._8_8_ & 0xffffffff,
...
/* MethodBindTRC<float, Vector2>::call(Object*, Variant const**, int, Callable::CallError&) const */

Object * MethodBindTRC<float,Vector2>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
void __thiscall
MethodBindTRC<Ref<Image>,int,int,bool,bool,bool>::validated_call
          (MethodBindTRC<Ref<Image>,int,int,bool,bool,bool> *this,Object *param_1,Variant **param_2,
          Variant *param_3)

{
  ...
  (*pcVar5)(&local_50,param_1 + *(long *)(this + 0x60),*(undefined8 *)(*param_2 + 8),
            *(undefined8 *)(param_2[1] + 8),param_2[2][8],param_2[3][8],param_2[4][8]);
  if (local_50 == (Image *)0x0) {
...
void __thiscall
MethodBindTRC<Ref<Image>,int,int,bool,bool,float,bool>::validated_call
          (MethodBindTRC<Ref<Image>,int,int,bool,bool,float,bool> *this,Object *param_1,
          Variant **param_2,Variant *param_3)

{
  ...
  (*pcVar5)(auVar7._0_8_,&local_50,param_1 + *(long *)(this + 0x60),*(undefined8 *)(*param_2 + 8),
            *(undefined8 *)(param_2[1] + 8),param_2[2][8],param_2[3][8],param_2[5][8]);
  if (local_50 == (Image *)0x0) {
    Variant::ObjData::unref();
  }
  else {
...
void call_with_variant_args_retc_dv<__UnexistingClass,float,float,float>
...
Object * MethodBindTRC<float,float,float>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)

{
  ...
  *(undefined1 (*) [16])(param_1 + 8) = (undefined1  [16])0x0;
  ...
  call_with_variant_args_retc_dv<__UnexistingClass,float,float,float>
...
/* MethodBindTRC<Ref<Image>, int, int, bool, bool, bool>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTRC<Ref<Image>,int,int,bool,bool,bool>::_gen_argument_type_info(int param_1)
...
undefined4 *
MethodBindTRC<TypedArray<Image>,int,int,int,bool,bool>::_gen_argument_type_info(int param_1)
...
/* MethodBindTRC<float, float>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTRC<float,float>::_gen_argument_type_info(int param_1)
...
/* MethodBindTRC<float, float, float>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTRC<float,float,float>::_gen_argument_type_info(int param_1)
...
/* MethodBindTRC<float, float, float, float>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTRC<float,float,float,float>::_gen_argument_type_info(int param_1)
...
undefined4 *
MethodBindTRC<Ref<Image>,int,int,bool,bool,float,bool>::_gen_argument_type_info(int param_1)
...
undefined4 *
MethodBindTRC<TypedArray<Image>,int,int,int,bool,float,bool>::_gen_argument_type_info(int param_1)

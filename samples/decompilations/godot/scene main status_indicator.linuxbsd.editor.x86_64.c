...
/* StatusIndicator::is_visible() const */

StatusIndicator __thiscall StatusIndicator::is_visible(StatusIndicator *this)
...
/* StatusIndicator::get_menu() const */

void StatusIndicator::get_menu(void)

{
  long in_RSI;
  NodePath *in_RDI;
  
  NodePath::NodePath(in_RDI,(NodePath *)(in_RSI + 0x420));
  return;
}



/* StatusIndicator::get_rect() const */

undefined1  [16] __thiscall StatusIndicator::get_rect(StatusIndicator *this)

{
  ...
  if (*(int *)(this + 0x41c) != -1) {
    ...
    auVar1 = (**(code **)(*DisplayServer::singleton + 0x7a0))();
    return auVar1;
  }
  return ZEXT816(0);
}
...
/* StatusIndicator::_callback(MouseButton, Vector2i const&) */

void __thiscall StatusIndicator::_callback(StatusIndicator *this,int param_2,undefined8 *param_3)

{
  ...
  lVar2 = SceneStringNames::singleton + 0x238;
  local_90 = *param_3;
  local_68[0] = 2;
  local_58 = 0;
  Variant::Variant(local_50,(Vector2i *)&local_90);
  local_38 = 0;
  local_30 = (undefined1  [16])0x0;
  plVar3 = &local_20;
  local_88 = (long *)local_68;
  pVStack_80 = local_50;
  (**(code **)(*(long *)this + 0xd0))(this,lVar2,&local_88,2);
  do {
    plVar1 = plVar3 + -3;
    plVar3 = plVar3 + -3;
    if (Variant::needs_deinit[(int)*plVar1] != '\0') {
      Variant::_clear_internal();
    }
  } while (plVar3 != (long *)local_68);
...
/* StatusIndicator::set_menu(NodePath const&) */

void __thiscall StatusIndicator::set_menu(StatusIndicator *this,NodePath *param_1)

{
  ...
  if (lVar1 != 0) {
    lVar1 = __dynamic_cast(lVar1,&Object::typeinfo,&PopupMenu::typeinfo,0);
    if (lVar1 != 0) {
      PopupMenu::unbind_global_menu();
      if (*(int *)(this + 0x41c) != -1) {
        local_28 = 0;
        (**(code **)(*DisplayServer::singleton + 0x790))
                  (DisplayServer::singleton,*(int *)(this + 0x41c),&local_28);
      }
    }
  }
  NodePath::operator=((NodePath *)(this + 0x420),param_1);
  lVar1 = Node::get_node_or_null((NodePath *)this);
  if (lVar1 != 0) {
    lVar1 = __dynamic_cast(lVar1,&Object::typeinfo,&PopupMenu::typeinfo,0);
    if ((lVar1 != 0) && (*(int *)(this + 0x41c) != -1)) {
      local_28 = PopupMenu::bind_global_menu();
      (**(code **)(*DisplayServer::singleton + 0x790))
                (DisplayServer::singleton,*(undefined4 *)(this + 0x41c),&local_28);
    }
  }
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
...
/* StatusIndicator::get_icon() const */

void StatusIndicator::get_icon(void)
...
/* StatusIndicator::get_tooltip() const */

void StatusIndicator::get_tooltip(void)

{
  ...
  *(undefined8 *)in_RDI = 0;
  if (*(long *)(in_RSI + 0x410) != 0) {
    CowData<char32_t>::_ref(in_RDI,(CowData *)(in_RSI + 0x410));
  }
  return;
}
...
/* StatusIndicator::set_tooltip(String const&) */

void __thiscall StatusIndicator::set_tooltip(StatusIndicator *this,String *param_1)
...
LAB_001004a8:
    if (*(long *)(this + 0x410) != *(long *)param_1) {
      CowData<char32_t>::_ref((CowData<char32_t> *)(this + 0x410),(CowData *)param_1);
    }
    if (*(int *)(this + 0x41c) != -1) {
      if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00100502. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        (**(code **)(*DisplayServer::singleton + 0x788))
                  (DisplayServer::singleton,*(int *)(this + 0x41c),
                   (CowData<char32_t> *)(this + 0x410));
        return;
      }
      goto LAB_001005b9;
    }
    ...
    vformat<String>(local_28,(String *)&local_30,local_38);
    _err_print_error("set_tooltip","scene/main/status_indicator.cpp",0x6e,
...
/* StatusIndicator::_notification(int) */

void __thiscall StatusIndicator::_notification(StatusIndicator *this,int param_1)

{
  ...
  if (((byte)this[0x2fa] & 0x40) != 0) {
    ...
    if (cVar3 == '\0') {
      ...
      vformat<String>((CowData<char32_t> *)local_48,(String *)&local_50,aCStack_58);
      _err_print_error("_notification","scene/main/status_indicator.cpp",0x24,
                       "Condition \"is_inside_tree() && !is_current_thread_safe_for_nodes()\" is true."
  ...
  if (cVar3 == '\0') {
    if (param_1 == 10) {
      cVar3 = (**(code **)(*DisplayServer::singleton + 0x150))(DisplayServer::singleton,0x16);
      plVar2 = DisplayServer::singleton;
      if (((cVar3 != '\0') && (this[0x418] != (StatusIndicator)0x0)) &&
         (*(int *)(this + 0x41c) == -1)) {
        pcVar1 = *(code **)(*DisplayServer::singleton + 0x778);
        create_custom_callable_function_pointer<StatusIndicator,MouseButton,Vector2i_const&>
                  ((StatusIndicator *)local_48,(char *)this,
                   (_func_void_MouseButton_Vector2i_ptr *)"&StatusIndicator::_callback");
        uVar4 = (*pcVar1)(plVar2,this + 0x408,this + 0x410,(StatusIndicator *)local_48);
        *(undefined4 *)(this + 0x41c) = uVar4;
        Callable::~Callable((Callable *)local_48);
        lVar5 = Node::get_node_or_null((NodePath *)this);
        if (lVar5 != 0) {
          lVar5 = __dynamic_cast(lVar5,&Object::typeinfo,&PopupMenu::typeinfo,0);
          if (lVar5 != 0) {
            local_48[0] = PopupMenu::bind_global_menu();
            (**(code **)(*DisplayServer::singleton + 0x790))
                      (DisplayServer::singleton,*(undefined4 *)(this + 0x41c),
                       (StatusIndicator *)local_48);
          }
        }
      }
    }
      ...
      if ((cVar3 != '\0') && (*(int *)(this + 0x41c) != -1)) {
        ...
        if (lVar5 != 0) {
          ...
          if (lVar5 != 0) {
            ...
            local_48[0] = 0;
            (**(code **)(*DisplayServer::singleton + 0x790))
                      (DisplayServer::singleton,*(undefined4 *)(this + 0x41c),local_48);
          }
        }
        (**(code **)(*DisplayServer::singleton + 0x7a8))
                  (DisplayServer::singleton,*(undefined4 *)(this + 0x41c));
...
/* StatusIndicator::set_visible(bool) */

void __thiscall StatusIndicator::set_visible(StatusIndicator *this,bool param_1)

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  if ((((byte)this[0x2fa] & 0x40) == 0) ||
     (cVar3 = is_current_thread_safe_for_nodes(), cVar3 != '\0')) {
    if ((((this[0x418] != (StatusIndicator)param_1) &&
         (this[0x418] = (StatusIndicator)param_1, ((byte)this[0x2fa] & 0x40) != 0)) &&
        (cVar3 = Node::is_part_of_edited_scene(), cVar3 == '\0')) &&
       (cVar3 = (**(code **)(*DisplayServer::singleton + 0x150))(DisplayServer::singleton,0x16),
       plVar2 = DisplayServer::singleton, cVar3 != '\0')) {
      if (this[0x418] != (StatusIndicator)0x0) {
        if (*(int *)(this + 0x41c) != -1) goto LAB_001008b7;
        pcVar1 = *(code **)(*DisplayServer::singleton + 0x778);
        create_custom_callable_function_pointer<StatusIndicator,MouseButton,Vector2i_const&>
                  ((StatusIndicator *)local_48,(char *)this,
                   (_func_void_MouseButton_Vector2i_ptr *)"&StatusIndicator::_callback");
        ...
        *(undefined4 *)(this + 0x41c) = uVar4;
        ...
        lVar5 = Node::get_node_or_null((NodePath *)this);
        if ((lVar5 != 0) &&
           (lVar5 = __dynamic_cast(lVar5,&Object::typeinfo,&PopupMenu::typeinfo,0), lVar5 != 0)) {
          local_48[0] = PopupMenu::bind_global_menu();
          (**(code **)(*DisplayServer::singleton + 0x790))
                    (DisplayServer::singleton,*(undefined4 *)(this + 0x41c),
                     (StatusIndicator *)local_48);
        }
        if (this[0x418] != (StatusIndicator)0x0) goto LAB_001008b7;
      }
      if (*(int *)(this + 0x41c) != -1) {
        lVar5 = Node::get_node_or_null((NodePath *)this);
        if ((lVar5 != 0) &&
    ...
    vformat<String>((CowData<char32_t> *)local_48,(String *)&local_50,local_58);
    _err_print_error("set_visible","scene/main/status_indicator.cpp",0x92,
                     "Condition \"is_inside_tree() && !is_current_thread_safe_for_nodes()\" is true."
                     ,(CowData<char32_t> *)local_48,0,0);
    CowData<char32_t>::_unref((CowData<char32_t> *)local_48);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_50);
...
/* StatusIndicator::set_icon(Ref<Texture2D> const&) */

void __thiscall StatusIndicator::set_icon(StatusIndicator *this,Ref *param_1)
...
LAB_00100b4c:
    ...
    if (*(int *)(this + 0x41c) != -1) {
      if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
                    ...
                    /* WARNING: Treating indirect jump as call */
        (**(code **)(*DisplayServer::singleton + 0x780))
                  (DisplayServer::singleton,*(int *)(this + 0x41c),this + 0x408);
        return;
      }
      goto LAB_00100cc4;
    }
    ...
    vformat<String>(local_28,(String *)&local_30,local_38);
    _err_print_error("set_icon","scene/main/status_indicator.cpp",0x62,
                     "Condition \"is_inside_tree() && !is_current_thread_safe_for_nodes()\" is true."
                     ,local_28,0,0);
    CowData<char32_t>::_unref(local_28);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_30);
...
/* StatusIndicator::_bind_methods() */

void StatusIndicator::_bind_methods(void)

{
  ...
  local_58 = &local_68;
  D_METHODP((char *)&local_d8,(char ***)"set_tooltip",uVar15);
  local_50 = (undefined1  [16])0x0;
  local_58 = (char **)0x0;
  pMVar14 = create_method_bind<StatusIndicator,String_const&>(set_tooltip);
  ClassDB::bind_methodfi(1,pMVar14,false,(MethodDefinition *)&local_d8,(Variant **)0x0,0);
  ...
  if ((long *)local_c8._0_8_ != (long *)0x0) {
    LOCK();
    plVar17 = (long *)(local_c8._0_8_ + -0x10);
    *plVar17 = *plVar17 + -1;
    UNLOCK();
    if (*plVar17 == 0) {
      if ((long *)local_c8._0_8_ == (long *)0x0) {
  ...
  D_METHODP((char *)&local_d8,(char ***)"get_tooltip",0);
  local_50 = (undefined1  [16])0x0;
  local_58 = (char **)0x0;
  pMVar14 = create_method_bind<StatusIndicator,String>(get_tooltip);
  ClassDB::bind_methodfi(1,pMVar14,false,(MethodDefinition *)&local_d8,(Variant **)0x0,0);
  if (Variant::needs_deinit[(int)local_58] != '\0') {
    Variant::_clear_internal();
  }
  ...
  local_60 = 0;
  local_58 = &local_68;
  D_METHODP((char *)&local_d8,(char ***)"set_icon",uVar15);
  local_50 = (undefined1  [16])0x0;
  local_58 = (char **)0x0;
  pMVar14 = create_method_bind<StatusIndicator,Ref<Texture2D>const&>(set_icon);
  ClassDB::bind_methodfi(1,pMVar14,false,(MethodDefinition *)&local_d8,(Variant **)0x0,0);
  if (Variant::needs_deinit[(int)local_58] != '\0') {
    Variant::_clear_internal();
  }
  ...
  D_METHODP((char *)&local_d8,(char ***)"get_icon",0);
  local_50 = (undefined1  [16])0x0;
  local_58 = (char **)0x0;
  pMVar14 = create_method_bind<StatusIndicator,Ref<Texture2D>>(get_icon);
  ClassDB::bind_methodfi(1,pMVar14,false,(MethodDefinition *)&local_d8,(Variant **)0x0,0);
  if (Variant::needs_deinit[(int)local_58] != '\0') {
    Variant::_clear_internal();
  }
  ...
  local_60 = 0;
  local_58 = &local_68;
  D_METHODP((char *)&local_d8,(char ***)"set_visible",uVar15);
  local_50 = (undefined1  [16])0x0;
  local_58 = (char **)0x0;
  pMVar14 = create_method_bind<StatusIndicator,bool>(set_visible);
  ClassDB::bind_methodfi(1,pMVar14,false,(MethodDefinition *)&local_d8,(Variant **)0x0,0);
  if (Variant::needs_deinit[(int)local_58] != '\0') {
    Variant::_clear_internal();
  }
  ...
  local_50 = (undefined1  [16])0x0;
  local_58 = (char **)0x0;
  pMVar14 = create_method_bind<StatusIndicator,bool>(is_visible);
  ClassDB::bind_methodfi(1,pMVar14,false,(MethodDefinition *)&local_d8,(Variant **)0x0,0);
  if (Variant::needs_deinit[(int)local_58] != '\0') {
    Variant::_clear_internal();
  }
  ...
  local_60 = 0;
  local_58 = &local_68;
  D_METHODP((char *)&local_d8,(char ***)"set_menu",uVar15);
  local_50 = (undefined1  [16])0x0;
  local_58 = (char **)0x0;
  pMVar14 = create_method_bind<StatusIndicator,NodePath_const&>(set_menu);
  ClassDB::bind_methodfi(1,pMVar14,false,(MethodDefinition *)&local_d8,(Variant **)0x0,0);
  if (Variant::needs_deinit[(int)local_58] != '\0') {
    Variant::_clear_internal();
  }
  ...
  D_METHODP((char *)&local_d8,(char ***)"get_menu",0);
  local_50 = (undefined1  [16])0x0;
  local_58 = (char **)0x0;
  pMVar14 = create_method_bind<StatusIndicator,NodePath>(get_menu);
  ClassDB::bind_methodfi(1,pMVar14,false,(MethodDefinition *)&local_d8,(Variant **)0x0,0);
  if (Variant::needs_deinit[(int)local_58] != '\0') {
    Variant::_clear_internal();
  }
  ...
  local_50 = (undefined1  [16])0x0;
  local_58 = (char **)0x0;
  pMVar14 = create_method_bind<StatusIndicator,Rect2>(get_rect);
  ClassDB::bind_methodfi(1,pMVar14,false,(MethodDefinition *)&local_d8,(Variant **)0x0,0);
  if (Variant::needs_deinit[(int)local_58] != '\0') {
    Variant::_clear_internal();
  }
  ...
  local_188 = 0;
  local_d8 = "mouse_position";
  local_d0 = 0xe;
  String::parse_latin1((StrRange *)&local_188);
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_138,6,(StrRange *)&local_188,0,(StrRange *)&local_180,6,
             (StrRange *)&local_178);
  local_d8 = "";
  local_190 = 0;
  local_198 = 0;
  ...
  local_1a0 = 0;
  local_d8 = "mouse_button";
  local_d0 = 0xc;
  String::parse_latin1((StrRange *)&local_1a0);
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)local_168,2,(StrRange *)&local_1a0,0,(StrRange *)&local_198,6,
             &local_190);
  local_170 = 0;
  local_d8 = "pressed";
  local_d0 = 7;
  ...
  local_100 = 0;
  local_108 = (char *)CONCAT44(local_108._4_4_,local_138);
  CowData<char32_t>::_ref((CowData<char32_t> *)&local_100,local_130);
  ...
  String::parse_latin1((StrRange *)&local_180);
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_d8,4,(StrRange *)&local_180,0x12,(StrRange *)&local_178,6,
             (StrRange *)&local_170);
  local_108 = "StatusIndicator";
  local_188 = 0;
  local_100 = 0xf;
  ...
  String::parse_latin1((StrRange *)&local_180);
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_d8,0x18,(StrRange *)&local_180,0x11,(StrRange *)&local_178,6,
             (StrRange *)&local_170);
  local_108 = "StatusIndicator";
  local_188 = 0;
  local_100 = 0xf;
  ...
  String::parse_latin1((StrRange *)&local_180);
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_d8,0x16,(StrRange *)&local_180,0x1a,(StrRange *)&local_178,6,
             (StrRange *)&local_170);
  local_108 = "StatusIndicator";
  local_188 = 0;
  local_100 = 0xf;
...
/* CallableCustomMethodPointer<StatusIndicator, void, MouseButton, Vector2i
   const&>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<StatusIndicator,void,MouseButton,Vector2i_const&>::
~CallableCustomMethodPointer
          (CallableCustomMethodPointer<StatusIndicator,void,MouseButton,Vector2i_const&> *this)
...
CallableCustomMethodPointer<StatusIndicator,void,MouseButton,Vector2i_const&>::get_argument_count
          (CallableCustomMethodPointer<StatusIndicator,void,MouseButton,Vector2i_const&> *this,
          bool *param_1)
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00109d38;
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00109d98;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00109df8;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00109e58;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00109eb8;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00109f18;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00109f78;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00109fd8;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
/* CallableCustomMethodPointer<StatusIndicator, void, MouseButton, Vector2i const&>::get_object()
   const */

undefined8 __thiscall
CallableCustomMethodPointer<StatusIndicator,void,MouseButton,Vector2i_const&>::get_object
          (CallableCustomMethodPointer<StatusIndicator,void,MouseButton,Vector2i_const&> *this)
...
/* Callable create_custom_callable_function_pointer<StatusIndicator, MouseButton, Vector2i
   const&>(StatusIndicator*, char const*, void (StatusIndicator::*)(MouseButton, Vector2i const&))
    */

StatusIndicator *
create_custom_callable_function_pointer<StatusIndicator,MouseButton,Vector2i_const&>
          (StatusIndicator *param_1,char *param_2,_func_void_MouseButton_Vector2i_ptr *param_3)

{
  ...
  *(undefined ***)this = &PTR_hash_00109ca8;
  ...
  *(_func_void_MouseButton_Vector2i_ptr **)(this + 0x20) = param_3 + 1;
...
/* WARNING: Removing unreachable block (ram,0x00103348) */
  ...
  if (pvVar5 != (void *)0x0) {
    if (*(int *)(this + 0x3c) != 0) {
      ...
      if (uVar2 == 0) {
        ...
        *(undefined4 *)(this + 0x3c) = 0;
        *(undefined1 (*) [16])(this + 0x28) = (undefined1  [16])0x0;
        if (pvVar5 == (void *)0x0) goto LAB_00103824;
      }
    }
    Memory::free_static(pvVar5,false);
...
/* CallableCustomMethodPointer<StatusIndicator, void, MouseButton, Vector2i const&>::call(Variant
   const**, int, Variant&, Callable::CallError&) const */

void __thiscall
CallableCustomMethodPointer<StatusIndicator,void,MouseButton,Vector2i_const&>::call
          (CallableCustomMethodPointer<StatusIndicator,void,MouseButton,Vector2i_const&> *this,
        ...
        if ((uint)param_2 < 3) {
          if (param_2 == 2) {
            *(undefined4 *)param_4 = 0;
            ...
            cVar4 = Variant::can_convert_strict(*(undefined4 *)param_1[1],6);
            uVar3 = _LC24;
            if (cVar4 == '\0') {
              *(undefined4 *)param_4 = 2;
              *(undefined8 *)(param_4 + 4) = uVar3;
            }
            local_38 = Variant::operator_cast_to_Vector2i(param_1[1]);
            ...
            uVar5 = Variant::operator_cast_to_long(*param_1);
            (*pcVar8)((long *)(lVar1 + lVar2),uVar5 & 0xffffffff,&local_38);
          }
          else {
...
LAB_00104255:
    ...
    local_40 = 6;
    if (local_50 == 0x11) goto LAB_00104255;
...
LAB_00104405:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_48,(CowData *)&local_80);
    local_40 = 6;
    if (local_50 != 0x11) goto LAB_00104405;
    StringName::StringName((StringName *)&local_70,(String *)&local_48,false);
    if (local_60._8_8_ == local_70) {
      if ((StringName::configured != '\0') && (local_70 != 0)) {
        StringName::unref();
...
LAB_00104675:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_48,(CowData *)&local_80);
    local_40 = 6;
    if (local_50 != 0x11) goto LAB_00104675;
    StringName::StringName((StringName *)&local_70,(String *)&local_48,false);
    if (local_60._8_8_ == local_70) {
      if ((StringName::configured != '\0') && (local_70 != 0)) {
        StringName::unref();
...
LAB_001048e5:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_48,(CowData *)&local_80);
    local_40 = 6;
    if (local_50 != 0x11) goto LAB_001048e5;
    StringName::StringName((StringName *)&local_70,(String *)&local_48,false);
    if (local_60._8_8_ == local_70) {
      if ((StringName::configured != '\0') && (local_70 != 0)) {
        StringName::unref();
...
/* MethodBind* create_method_bind<StatusIndicator, String const&>(void (StatusIndicator::*)(String
   const&)) */

MethodBind * create_method_bind<StatusIndicator,String_const&>(_func_void_String_ptr *param_1)
...
/* MethodBind* create_method_bind<StatusIndicator, String>(String (StatusIndicator::*)() const) */

MethodBind * create_method_bind<StatusIndicator,String>(_func_String *param_1)
...
/* MethodBind* create_method_bind<StatusIndicator, Ref<Texture2D> const&>(void
   (StatusIndicator::*)(Ref<Texture2D> const&)) */

MethodBind * create_method_bind<StatusIndicator,Ref<Texture2D>const&>(_func_void_Ref_ptr *param_1)
...
/* MethodBind* create_method_bind<StatusIndicator, Ref<Texture2D>>(Ref<Texture2D>
   (StatusIndicator::*)() const) */

MethodBind * create_method_bind<StatusIndicator,Ref<Texture2D>>(_func_Ref *param_1)
...
/* MethodBind* create_method_bind<StatusIndicator, bool>(void (StatusIndicator::*)(bool)) */

MethodBind * create_method_bind<StatusIndicator,bool>(_func_void_bool *param_1)
...
/* MethodBind* create_method_bind<StatusIndicator, bool>(bool (StatusIndicator::*)() const) */

MethodBind * create_method_bind<StatusIndicator,bool>(_func_bool *param_1)
...
/* MethodBind* create_method_bind<StatusIndicator, NodePath const&>(void
   (StatusIndicator::*)(NodePath const&)) */

MethodBind * create_method_bind<StatusIndicator,NodePath_const&>(_func_void_NodePath_ptr *param_1)
...
/* MethodBind* create_method_bind<StatusIndicator, NodePath>(NodePath (StatusIndicator::*)() const)
    */

MethodBind * create_method_bind<StatusIndicator,NodePath>(_func_NodePath *param_1)
...
/* MethodBind* create_method_bind<StatusIndicator, Rect2>(Rect2 (StatusIndicator::*)() const) */

MethodBind * create_method_bind<StatusIndicator,Rect2>(_func_Rect2 *param_1)
...
/* StatusIndicator::_bind_methods() [clone .cold] */
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010662d. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00106809. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00106fdd. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x001071c2. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x001079dd. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
              ((long *)((long)param_2 + *(long *)(param_1 + 0x60)),*(long *)param_3 + 8);
    return;
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00107bb9. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)((long *)((long)param_2 + *(long *)(param_1 + 0x60)),*param_3);
    return;
  }
...

{
  ...
  if (local_48 == (Object *)0x0) {
                    /* WARNING: Load size is inaccurate */
    pOVar5 = *param_3;
    if (pOVar5 == (Object *)0x0) goto LAB_001080d6;
  ...
  if (pOVar5 != pOVar3) {
    *(Object **)param_3 = pOVar3;
    if (pOVar3 == (Object *)0x0) {
      if (pOVar5 != (Object *)0x0) goto LAB_00108119;
    }
    else {
      cVar1 = RefCounted::reference();
      if (cVar1 == '\0') {
...
LAB_00108119:
      ...
      if (local_48 == (Object *)0x0) goto LAB_001080d6;
    }
  }
  cVar1 = RefCounted::unreference();
  pOVar5 = local_48;
...
LAB_00108396:
      ...
      if (pOVar2 != pOVar4) {
        ...
        if (pOVar2 != (Object *)0x0) goto LAB_00108396;
      }
    }
  }
...
LAB_00108f3d:
      ...
      if (pOVar5 != pOVar8) {
        ...
        if (pOVar5 != (Object *)0x0) goto LAB_00108f3d;
      }
    }
  }
...
LAB_0010963b:
  *(undefined4 *)param_6 = 0;
  ...
  Variant::operator_cast_to_bool(this);
                    /* WARNING: Could not recover jumptable at 0x00109697. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
void StatusIndicator::_GLOBAL__sub_I__notification(void)

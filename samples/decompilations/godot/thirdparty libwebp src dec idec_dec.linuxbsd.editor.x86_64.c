...

{
  ...
  *(long *)(param_1 + 0x3a) = lVar6;
  if (lVar2 != 0) {
    if (param_1[0x1e] != 0) {
LAB_00100377:
      VP8LBitReaderSetBuffer(lVar2 + 0x28,lVar5,lVar6);
      return;
    }
    ...
    if ((((*param_1 != 0) && (param_1[0x1e] == 0)) &&
        (*(long *)(*(long *)(param_1 + 0x20) + 0xb98) != 0)) &&
       (*(int *)(*(long *)(param_1 + 0x20) + 0xba8) == 0)) {
...
LAB_00100957:
      ...
      if (iVar15 != 0) {
        uVar16 = WebPAllocateDecBuffer
                           (param_1[0x22],param_1[0x23],*(undefined8 *)(param_1 + 0xc),uVar9);
        *puVar12 = uVar16;
        if (uVar16 != 0) {
          iVar15 = *param_1;
...
LAB_0010059e:
                  ...
                  if (iVar15 < *(int *)(lVar19 + 0x198)) {
                    ...
                    do {
                      ...
                      if (iVar15 == 0) {
                        if ((*(int *)(lVar19 + 0x1b0) == 0) &&
                           (0x1000 < (ulong)(*(long *)(param_1 + 0x4e) - *(long *)(param_1 + 0x4c)))
                           ) goto LAB_0010059e;
                        if (0 < *(int *)(lVar19 + 200)) {
                      ...
                      if (uVar16 == 0) {
                        *(long *)(param_1 + 0x4c) =
                             *(long *)(lVar18 + 0x1c8) - *(long *)(param_1 + 0x52);
                      }
...
LAB_0010085f:
        ...
        if ((ulong)(*(long *)(param_1 + 0x4e) - *(long *)(param_1 + 0x4c)) <
            *(ulong *)(param_1 + 0x54)) goto LAB_00100740;
        piVar1 = param_1 + 0x22;
...
LAB_00100bb0:
      ...
      lVar19 = *(long *)(param_1 + 0x4e);
LAB_001007e5:
      uVar21 = lVar19 - *(long *)(param_1 + 0x4c);
      if (9 < uVar21) {
        ...
        if (iVar15 != 0) {
          ...
          *param_1 = 2;
          *(ulong *)(param_1 + 0x54) =
               (ulong)((((uint)bVar3 << 8 | (uint)bVar4 << 0x10 | (uint)bVar5) >> 5) + 10);
          goto LAB_0010085f;
        }
        if (*param_1 == 3) {
          VP8ExitCritical(*(undefined8 *)(param_1 + 0x20),param_1 + 0x22);
...
long WebPINewYUVA(long param_1,long param_2,int param_3,long param_4,long param_5,int param_6,
                 long param_7,long param_8,int param_9,long param_10,long param_11,int param_12)

{
  ...
  if (param_1 == 0) {
    ...
    if ((((param_4 == 0) || (param_7 == 0)) || (param_2 == 0 || param_5 == 0)) ||
       (((param_8 == 0 || (param_3 == 0 || param_6 == 0)) || (param_9 == 0)))) {
      return 0;
    }
    if (param_10 == 0) {
      uVar2 = 0xb;
...
long WebPINewYUV(long param_1,long param_2,int param_3,long param_4,long param_5,int param_6,
  ...
  if (iVar1 == 7) {
    ...
    if (iVar1 != 6) {
      ...
      if ((((iVar1 == 0) || (param_1[0x1e] != 0)) ||
          (__src = *(void **)(*(long *)(param_1 + 0x20) + 0xb98), __src == (void *)0x0)) ||
         (*(int *)(*(long *)(param_1 + 0x20) + 0xba8) != 0)) {
        if (__dest == (void *)0x0) {
          pvVar3 = (void *)0x0;
          __src = (void *)0x0;
...
long WebPIDecodedArea(uint *param_1,undefined4 *param_2,undefined4 *param_3,undefined4 *param_4,
                     uint *param_5)

{
  long lVar1;
  
  if ((((param_1 == (uint *)0x0) || (*(long *)(param_1 + 0x20) == 0)) || (*param_1 < 3)) ||
     (*(long *)(param_1 + 0x76) != 0)) {
...

{
  ...
  if (param_1 != (uint *)0x0) {
    ...
    if ((((2 < *param_1) && (puVar1 = *(uint **)(param_1 + 2), *(long *)(param_1 + 0x76) == 0)) &&
        (puVar1 != (uint *)0x0)) && (*puVar1 < 0xb)) {
      if (param_2 != (uint *)0x0) {
        *param_2 = param_1[10];
      }
      if (param_3 != (uint *)0x0) {
...
long WebPIDecGetYUVA(uint *param_1,uint *param_2,undefined8 *param_3,undefined8 *param_4,
...
undefined8
WebPISetIOHooks(int *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
               undefined8 param_5)

...
/* RendererSceneOcclusionCull::HZBuffer::is_empty() const */

undefined4 __thiscall RendererSceneOcclusionCull::HZBuffer::is_empty(HZBuffer *this)
...
void __thiscall RendererSceneOcclusionCull::HZBuffer::update_mips(HZBuffer *this)
      ...
      do {
        if (uVar26 == uVar7) {
          _err_print_index_error
                    ("operator[]","./core/templates/local_vector.h",0xb2,(ulong)uVar26,(ulong)uVar26
...
/* RendererSceneOcclusionCull::HZBuffer::get_debug_texture() */

undefined8 __thiscall RendererSceneOcclusionCull::HZBuffer::get_debug_texture(HZBuffer *this)
...
LAB_001004ac:
      ...
      Image::set_data(*(undefined8 *)(this + 0x40),**(undefined4 **)(this + 0x20),
                      (*(undefined4 **)(this + 0x20))[1],0,0,this + 0x48);
      if (*(long *)(this + 0x38) == 0) {
...
/* RendererSceneOcclusionCull::HZBuffer::resize(Vector2i const&) */

void __thiscall RendererSceneOcclusionCull::HZBuffer::resize(HZBuffer *this,Vector2i *param_1)

{
  ...
  *(undefined8 *)(this + 0x68) = *(undefined8 *)param_1;
  ...
  if ((*(int *)(this + 0x18) == 0) ||
     (cVar4 = Vector2i::operator==(param_1,*(Vector2i **)(this + 0x20)), cVar4 == '\0')) {
    iVar10 = *(int *)param_1;
...
LAB_001009f5:
        ...
        memset((void *)(*(long *)(this + 0x20) + (ulong)uVar16 * 8),0,
               (ulong)(uVar14 - uVar16) * 8 + 8);
        goto LAB_001008a0;
      }
      iVar10 = *(int *)param_1;
      iVar12 = *(int *)(param_1 + 4);
...
LAB_0010096e:
          _err_print_index_error
                    ("operator[]","./core/templates/local_vector.h",0xb2,uVar9,uVar15,"p_index",
                     "count","",false,true);
          _err_flush_stdout();
                    /* WARNING: Does not return */
          pcVar2 = (code *)invalidInstructionException();
    ...
    CowData<unsigned_char>::resize<false>
              ((CowData<unsigned_char> *)(this + 0x50),(long)(*piVar1 * piVar1[1]));
    if (*(long *)(this + 0x38) != 0) {
...
void __thiscall RendererSceneOcclusionCull::HZBuffer::clear(HZBuffer *this)

{
  ...
  *(undefined4 *)(this + 0x18) = 0;
  ...
  _err_print_error("clear","servers/rendering/renderer_scene_occlusion_cull.cpp",0x42,
...
/* RendererSceneOcclusionCull::HZBuffer::~HZBuffer() */

void __thiscall RendererSceneOcclusionCull::HZBuffer::~HZBuffer(HZBuffer *this)
...
void RendererSceneOcclusionCull::_GLOBAL__sub_I_singleton(void)

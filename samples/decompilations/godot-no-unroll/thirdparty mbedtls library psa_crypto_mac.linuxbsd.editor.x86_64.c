  ...
  if ((uVar1 & 0xffc07fff) == 0x3c00200) {
    ...
    if ((uVar1 & 0x7fc00000) != 0x3800000) {
      ...
      for (uVar2 = (ulong)(((int)param_1 -
                           (int)(undefined8 *)((ulong)(param_1 + 2) & 0xfffffffffffffff8)) + 0x188U
...
LAB_00100330:
    ...
    if (uVar1 < 0x11) {
      ...
      *(uint *)(param_1 + 8) = uVar7;
      if (param_4 <= uVar9) {
        if (param_4 == 0) goto LAB_00100510;
...
LAB_001004d8:
      iVar2 = psa_hash_compute(uVar7,param_3,param_4,local_d8,0x90,&local_e0);
      if (iVar2 == 0) {
        param_4 = local_e0;
        if (local_e0 == 0) goto LAB_00100510;
        goto LAB_001003e6;
      }
    }
    else {
...
LAB_00100510:
      ...
      uVar6 = uVar9;
LAB_00100438:
      puVar8 = (undefined8 *)(param_1 + 0xf8 + param_4);
      if (uVar6 < 8) {
        if ((uVar6 & 4) == 0) {
        ...
        *(undefined8 *)((long)puVar8 + (uVar6 - 8)) = 0x5c5c5c5c5c5c5c5c;
        uVar6 = (ulong)((long)puVar8 + (uVar6 - (long)((ulong)(puVar8 + 1) & 0xfffffffffffffff8)))
                >> 3;
...
undefined8
mbedtls_psa_mac_sign_finish(int *param_1,undefined8 param_2,undefined8 param_3,undefined8 *param_4)
...

{
  ...
  if ((iVar1 == 0) &&
     (((param_6 == 0 || (iVar1 = mbedtls_psa_mac_update(local_1c8,param_5,param_6), iVar1 == 0)) &&
      (iVar1 = psa_mac_finish_internal(local_1c8,param_7,param_8), iVar1 == 0)))) {
    *param_9 = param_8;
  }
LAB_001009ab:
  mbedtls_psa_mac_abort(local_1c8);
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
  }

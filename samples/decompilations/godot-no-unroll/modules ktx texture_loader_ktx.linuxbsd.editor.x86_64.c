...
/* ktx_read(ktxStream*, void*, unsigned long) */

undefined8 ktx_read(ktxStream *param_1,void *param_2,ulong param_3)
...
/* ktx_skip(ktxStream*, unsigned long) */

undefined8 ktx_skip(ktxStream *param_1,ulong param_2)
...
/* ktx_write(ktxStream*, void const*, unsigned long, unsigned long) */

undefined8 ktx_write(ktxStream *param_1,void *param_2,ulong param_3,ulong param_4)

{
  (**(code **)(*(long *)**(undefined8 **)(param_1 + 0x40) + 0x2d0))
            ((long *)**(undefined8 **)(param_1 + 0x40),param_2,param_3 * param_4);
  return 0;
}



/* ktx_getpos(ktxStream*, long*) */

undefined8 ktx_getpos(ktxStream *param_1,long *param_2)
...
/* ktx_setpos(ktxStream*, long) */

undefined8 ktx_setpos(ktxStream *param_1,long param_2)
...
/* ktx_getsize(ktxStream*, unsigned long*) */

undefined8 ktx_getsize(ktxStream *param_1,ulong *param_2)
...
/* ktx_destruct(ktxStream*) */

void ktx_destruct(ktxStream *param_1)
...
/* ResourceFormatKTX::handles_type(String const&) const */

undefined4 __thiscall ResourceFormatKTX::handles_type(ResourceFormatKTX *this,String *param_1)
...
/* ResourceFormatKTX::get_recognized_extensions(List<String, DefaultAllocator>*) const */

void __thiscall ResourceFormatKTX::get_recognized_extensions(ResourceFormatKTX *this,List *param_1)
...
/* ResourceFormatKTX::get_resource_type(String const&) const */

String * ResourceFormatKTX::get_resource_type(String *param_1)
...
/* load_from_file_access(Ref<FileAccess>, Error*) */

Ref<Image> * load_from_file_access(Ref<Image> *param_1,undefined8 param_2,undefined4 *param_3)
...
switchD_00100ff9_caseD_61:
                local_f8 = 0xf;
              }
            }
            else if (uVar12 == 0x8e8f) {
switchD_00100ff9_caseD_8f:
              local_f8 = 0x18;
            }
            else {
              if (0x8e8f < uVar12) {
...
LAB_00101661:
              iVar9 = ktxTexture2_TranscodeBasis(puVar6,uVar26,0);
              if (iVar9 == 0) {
                uVar12 = puVar6[0x1e];
                goto LAB_00100fe4;
              }
              uVar19 = (*(code *)**(undefined8 **)(local_d8 + 2))();
              _err_print_error("load_from_file_access","modules/ktx/texture_loader_ktx.cpp",0x142,
                               "Method/function failed. Returning: Ref<Resource>()",
                               "Failed to transcode KTX2 texture file.",0,0,uVar19);
            }
            else {
              if (uVar12 < 4) {
                if (uVar12 == 1) {
...
LAB_001019b4:
              uVar19 = (*(code *)**(undefined8 **)(local_d8 + 2))();
              _err_print_error("load_from_file_access","modules/ktx/texture_loader_ktx.cpp",0x13c,
                               "Method/function failed. Returning: Ref<Resource>()",
                               "Invalid components of KTX2 texture file.",0,0,uVar19);
            }
LAB_00100f79:
            *(undefined8 *)param_1 = 0;
...
LAB_00100fe4:
          ...
          default:
            ...
            in_R11 = uVar26;
LAB_00100f46:
            _err_print_error("load_from_file_access","modules/ktx/texture_loader_ktx.cpp",uVar19,
                             "Method/function failed. Returning: Ref<Resource>()",
...
LAB_00100d08:
          ...
          if (local_114 != 0) {
            ...
            do {
              ...
              if (uVar26 != (ulong)((long)(int)uVar11 * (long)(int)uVar18 * (long)iVar9) >>
                            (bVar7 & 0x3f)) {
                if (uVar20 == 0) {
                  (*(code *)**(undefined8 **)(local_d8 + 2))();
...
LAB_00100e5a:
                _err_print_error("load_from_file_access","modules/ktx/texture_loader_ktx.cpp",uVar19
                                 ,"Method/function failed. Returning: Ref<Resource>()",pcVar23,0,0);
                *(undefined8 *)param_1 = 0;
                goto LAB_00100e76;
              }
...
LAB_0010112c:
                      ...
                      iVar9 = CowData<unsigned_char>::_realloc
                                        ((CowData<unsigned_char> *)&local_b0,lVar1);
                      if (iVar9 == 0) goto LAB_001012fa;
                    }
                  }
                  else if ((lVar1 == lVar14) ||
                          (iVar9 = CowData<unsigned_char>::_realloc
                                             ((CowData<unsigned_char> *)&local_b0,lVar1), iVar9 == 0
                          )) {
                    if (local_b0 == (undefined8 *)0x0) {
...
LAB_00101d32:
    ...
    operator+((char *)&local_68,(String *)"Unable to open KTX texture file \'");
    String::operator+((String *)&local_58,(String *)&local_68);
    _err_print_error(&_LC51,"modules/ktx/texture_loader_ktx.cpp",0x212,
...
{
  return (uint)CONCAT71(0x1049,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1049,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
...
/* load_from_file_access(Ref<FileAccess>, Error*) [clone .cold] */

void load_from_file_access(void)
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialize_class()::initialized != '\0') goto LAB_00103a6b;

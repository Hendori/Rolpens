...

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x284))) {
    lVar30 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x280)) * 0xb8 +
             *(long *)(*(long *)(this + 0x270) +
                      ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x280)) * 8);
    pauVar21 = param_4;
...
LAB_001045f8:
          ...
          uVar23 = (ulong)*puVar3;
          lVar31 = lVar12;
          if (lVar12 <= (long)uVar23) goto LAB_001045f8;
          ...
          fVar8 = pfVar32[1];
          uVar23 = uVar28;
          if (lVar12 <= (long)uVar28) goto LAB_001045f8;
          ...
          if (lVar31 <= (long)uVar23) goto LAB_001045f8;
          ...
          fVar40 = fVar5 - fVar40;
          fVar52 = fVar4 - fVar35;
          fVar50 = _LC108 / (fVar44 * fVar41 + fVar43 * fVar46 + fVar48 * fVar37);
...
LAB_001040b6:
    _err_print_error("lightmap_tap_sh_light",
                     "servers/rendering/renderer_rd/storage_rd/light_storage.cpp",uVar27,pcVar22,0,0
                    );
    return;
  }
LAB_001046b4:

  ...
  if (iVar8 == 0) {
    ...
    if (bVar6) {
      if (local_d0 < 0x100000000) {
        ...
        Object::get((StringName *)local_58,pbVar2);
        Variant::operator_cast_to_String((Variant *)&local_68);
        iVar9 = String::find((char *)&local_68,0x106b46);
        pcVar4 = local_68;
        if (local_68 != (char *)0x0) {
          LOCK();
          plVar1 = (long *)(local_68 + -0x10);
  ...
  if (pvVar5 != (void *)0x0) {
    if (*(int *)(this + 0x3c) != 0) {
      ...
      if (uVar2 == 0) {
        ...
        *(undefined4 *)(this + 0x3c) = 0;
        *(undefined1 (*) [16])(this + 0x28) = (undefined1  [16])0x0;
        if (pvVar5 == (void *)0x0) goto LAB_001069b4;
      }
    }
    Memory::free_static(pvVar5,false);
...
LAB_00107c78:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_00107c78;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x00107c95;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
LAB_001080c8:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_001080c8;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x001080e5;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
/* WARNING: Removing unreachable block (ram,0x00108528) */
/* WARNING: Removing unreachable block (ram,0x00108658) */
/* WARNING: Removing unreachable block (ram,0x00108820) */
/* WARNING: Removing unreachable block (ram,0x00108664) */
/* WARNING: Removing unreachable block (ram,0x0010866e) */
/* WARNING: Removing unreachable block (ram,0x00108800) */
/* WARNING: Removing unreachable block (ram,0x0010867a) */
...
/* WARNING: Removing unreachable block (ram,0x001086a6) */
...
/* WARNING: Removing unreachable block (ram,0x001086e4) */
/* WARNING: Removing unreachable block (ram,0x001086fa) */
/* WARNING: Removing unreachable block (ram,0x00108706) */
...
/* WARNING: Removing unreachable block (ram,0x001089a0) */
/* WARNING: Removing unreachable block (ram,0x00108ad0) */
/* WARNING: Removing unreachable block (ram,0x00108c49) */
/* WARNING: Removing unreachable block (ram,0x00108adc) */
/* WARNING: Removing unreachable block (ram,0x00108ae6) */
/* WARNING: Removing unreachable block (ram,0x00108c2b) */
/* WARNING: Removing unreachable block (ram,0x00108af2) */
/* WARNING: Removing unreachable block (ram,0x00108afc) */
/* WARNING: Removing unreachable block (ram,0x00108c0d) */
/* WARNING: Removing unreachable block (ram,0x00108b08) */
/* WARNING: Removing unreachable block (ram,0x00108b12) */
/* WARNING: Removing unreachable block (ram,0x00108bef) */
/* WARNING: Removing unreachable block (ram,0x00108b1e) */
/* WARNING: Removing unreachable block (ram,0x00108b28) */
/* WARNING: Removing unreachable block (ram,0x00108bd1) */
/* WARNING: Removing unreachable block (ram,0x00108b34) */
/* WARNING: Removing unreachable block (ram,0x00108b3e) */
/* WARNING: Removing unreachable block (ram,0x00108bb3) */
/* WARNING: Removing unreachable block (ram,0x00108b46) */
/* WARNING: Removing unreachable block (ram,0x00108b50) */
/* WARNING: Removing unreachable block (ram,0x00108b98) */
...
LAB_001093a6:
    ...
    lVar6 = puVar7[-1];
    if (param_1 <= lVar6) goto LAB_001091d5;
  }
  else {
    if (lVar6 != 0) {
      uVar5 = _realloc(this,lVar11);
...
LAB_00109585:
  ...
  if (local_60 == 0) {
LAB_001095ac:
    if (param_2 != 2) goto LAB_001095ba;
LAB_001097c6:
    local_90 = 0;
...
LAB_00109975:
    ...
    *plVar1 = *plVar1 + -1;
    UNLOCK();
    if (*plVar1 != 0) goto LAB_001095ac;
    Memory::free_static((void *)(local_60 + -0x10),false);
    if (param_2 == 2) goto LAB_001097c6;
LAB_001095ba:
    if (param_2 == 3) {
      local_90 = 0;
      plVar1 = (long *)(alStack_78[0] + -0x10);

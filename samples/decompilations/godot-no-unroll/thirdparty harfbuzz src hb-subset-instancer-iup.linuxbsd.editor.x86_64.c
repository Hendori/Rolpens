...
bool rotate_array<int,(void*)0>(hb_array_t *param_1,int param_2,hb_vector_t *param_3)
...
LAB_00100058:
        *(uint *)(param_3 + 4) = uVar4;
        ...
        __src = *(void **)param_1;
        if ((ulong)(uVar3 * 4) != 0) {
          memcpy(__dest,(void *)((long)__src + ((ulong)uVar1 - (long)(int)uVar3) * 4),
                 (ulong)(uVar3 * 4));
          __src = *(void **)param_1;
          __dest = *(void **)(param_3 + 8);
        }
...
/* iup_delta_optimize(contour_point_vector_t const&, hb_vector_t<int, false> const&,
   hb_vector_t<int, false> const&, hb_vector_t<bool, false>&, double) */

undefined8
iup_delta_optimize(contour_point_vector_t *param_1,hb_vector_t *param_2,hb_vector_t *param_3,
                  hb_vector_t *param_4,double param_5)
...
LAB_00102034:
          ...
          if (uVar44 < uVar26) {
            ...
            if ((0x3fffffff < uVar27) ||
               (piVar19 = (int *)realloc(__ptr,(ulong)uVar27 << 2), piVar19 == (int *)0x0)) {
              uVar44 = ~uVar44;
              goto LAB_00102034;
            }
          }
...
LAB_00100c8d:
        ...
        if (-1 < (int)uVar44) {
          ...
          if (uVar44 < uVar27) {
            ...
            if ((0x3fffffff < uVar48) ||
               (piVar19 = (int *)realloc(__ptr,uVar40 << 2), piVar19 == (int *)0x0)) {
              uVar44 = ~uVar44;
              goto LAB_0010193b;
            }
          }
...
LAB_00100cd0:
        ...
        if (((uVar48 == uVar15) && (uVar48 == local_1b0)) && (local_1a0 == uVar48)) {
          if (uVar48 != 0) {
            ...
            lVar18 = 0;
            do {
              if (param_5 < SQRT((double)*(int *)((long)__src + lVar18) *
                                 (double)*(int *)((long)__src + lVar18) +
                                 (double)*(int *)((long)__src_00 + lVar18) *
                                 (double)*(int *)((long)__src_00 + lVar18))) {
...
LAB_00101765:
  ...
  return uVar21;
LAB_00100e2d:
  if ((__src[lVar18] == *__src) && (__src_00[lVar18] == *__src_00)) goto code_r0x00100e21;
  local_118 = 1;
...
LAB_00101652:
                  if ((!bVar50 && !bVar51) != iVar13 < iVar42) goto LAB_00101662;
                }
              }
            }
            goto LAB_00101002;
...
LAB_0010172e:
              if (dVar52 <= (double)iVar13 + param_5) goto LAB_00101002;
            }
          }
          ...
          if (cVar11 == '\0') {
            if (local_118._0_1_ != (hb_bit_set_t)0x0) {
              ...
              if (puVar22 != (undefined4 *)0x0) {
                *(ulong *)(puVar22 + (ulong)(uVar14 >> 6 & 7) * 2 + 2) =
                     *(ulong *)(puVar22 + (ulong)(uVar14 >> 6 & 7) * 2 + 2) |
                     1L << ((byte)uVar40 & 0x3f);
                *puVar22 = 0xffffffff;
              }
...
LAB_00101002:
  ...
  local_138 = (hb_bit_set_t *)CONCAT44(local_138._4_4_,0xffffffff);
LAB_0010125f:
  local_218 = (hb_bit_set_t *)&local_118;
...
LAB_001019bf:
      ...
      local_130 = (void *)0x0;
      cVar11 = _iup_contour_optimize_dp
                         ((contour_point_vector_t *)&local_158,(hb_vector_t *)&local_178,
                          (hb_vector_t *)&local_168,(hb_set_t *)&local_128,param_5,uVar15,
                          (hb_vector_t *)&local_148,(hb_vector_t *)&local_138);
      if (cVar11 != '\0') {
              ...
              while( true ) {
                ...
                if ((char)uVar40 == '\0') {
                  if (local_78._0_1_ != (hb_bit_set_invertible_t)0x0) {
                    ...
                    puVar22 = (undefined4 *)
                              hb_bit_set_t::page_for((hb_bit_set_t *)&local_78,(uint)uVar34,true);
                    if (puVar22 != (undefined4 *)0x0) {
                      *(ulong *)(puVar22 + (ulong)((uint)(uVar34 >> 6) & 7) * 2 + 2) =
                           *(ulong *)(puVar22 + (ulong)((uint)(uVar34 >> 6) & 7) * 2 + 2) |
                           1L << ((byte)uVar34 & 0x3f);
                      *puVar22 = 0xffffffff;
                    }
                ...
                else if ((local_78._0_1_ != (hb_bit_set_invertible_t)0x0) &&
                        (puVar22 = (undefined4 *)
                                   hb_bit_set_t::page_for
                                             ((hb_bit_set_t *)&local_78,(uint)uVar34,false),
            ...
            if (uVar12 == uVar48) {
              ...
              if (uVar48 <= uVar15) {
                hb_bit_set_invertible_t::set
                          ((hb_bit_set_invertible_t *)&local_c8,(hb_bit_set_invertible_t *)&local_78
                          );
                uVar15 = uVar48;
              }
            }
        ...
        do {
          ...
          if (((uint)local_c0 < local_b8._4_4_) &&
             (puVar1 = (uint *)(local_b0 + (local_c0 & 0xffffffff) * 8), uVar15 == *puVar1)) {
            uVar15 = puVar1[1];
LAB_00101ec2:
            lVar18 = local_a0 + (ulong)uVar15 * 0x48;
            if (lVar18 == 0) goto LAB_00101f98;
            bVar10 = (1L << ((byte)uVar40 & 0x3f) &
                     *(ulong *)(lVar18 + 8 + (ulong)((uint)(uVar40 >> 6) & 7) * 8)) != 0;
          }
          else {
            iVar17 = 0;
...
LAB_00101f98:
        ...
        hb_sparseset_t<hb_bit_set_invertible_t>::~hb_sparseset_t
                  ((hb_sparseset_t<hb_bit_set_invertible_t> *)&local_d8);
        if ((uint)local_138 != 0) {
          free(local_130);
        }
        if ((uint)local_148 != 0) {
        ...
        hb_sparseset_t<hb_bit_set_invertible_t>::~hb_sparseset_t
                  ((hb_sparseset_t<hb_bit_set_invertible_t> *)&local_128);
        goto LAB_001010c8;
      }
      if ((uint)local_138 != 0) {
        free(local_130);
...
LAB_00102654:
      ...
      if ((local_250 < 0x40000000) &&
         (pvVar20 = malloc((ulong)local_250 << 2), pvVar20 != (void *)0x0)) {
        ...
        if ((uVar14 < 0x40000000) && (pvVar23 = malloc((ulong)uVar14 << 2), pvVar23 != (void *)0x0))
        {
          ...
          local_160 = pvVar23;
          if ((uVar14 < 0x15555556) &&
             (pvVar25 = malloc((ulong)uVar14 * 0xc), pvVar25 != (void *)0x0)) {
    ...
    free(local_170);
LAB_00102292:
    local_230 = (hb_sparseset_t<hb_bit_set_invertible_t> *)&local_128;
...
LAB_001012c0:
  ...
  if (uVar27 == 0) {
LAB_0010140b:
    local_178 = CONCAT44(uVar27,(uint)local_178);
    uVar40 = (ulong)uVar14 % uVar34;
    iVar17 = (int)uVar40;
    pvVar20 = local_170;
    if ((ulong)(uint)(iVar17 * 0xc) != 0) {
      pvVar20 = memcpy(local_170,(void *)((long)pvVar24 + (__n - uVar40) * 0xc),
                       (ulong)(uint)(iVar17 * 0xc));
    }
    ...
    if (bVar10) {
      ...
      if (iVar17 == 0) {
        hb_bit_set_invertible_t::set
                  ((hb_bit_set_invertible_t *)&local_c8,(hb_bit_set_invertible_t *)local_218);
      }
      else {
        local_88 = local_218;
        local_80 = _LC0;
        ...
        phVar46 = local_88;
        local_138 = local_88;
        local_130 = (void *)CONCAT44(local_80._4_4_ + -1 + (uint)(local_80._4_4_ == 0),
                                     (uint)local_80);
        local_88 = local_218;
        local_80 = uVar21;
        if ((char)local_e8 == '\0') {
        ...
        while ((uVar26 != 0xffffffff || (phVar36 != phVar46))) {
          ...
          if ((char)local_98 == '\0') {
            if (local_c8._0_1_ != (hb_bit_set_invertible_t)0x0) {
              ...
              puVar22 = (undefined4 *)
                        hb_bit_set_t::page_for((hb_bit_set_t *)&local_c8,(uint)uVar40,true);
              if (puVar22 != (undefined4 *)0x0) {
                *(ulong *)(puVar22 + (ulong)((uint)(uVar40 >> 6) & 7) * 2 + 2) =
                     *(ulong *)(puVar22 + (ulong)((uint)(uVar40 >> 6) & 7) * 2 + 2) |
                     1L << ((byte)uVar40 & 0x3f);
                *puVar22 = 0xffffffff;
              }
          ...
          else if ((local_c8._0_1_ != (hb_bit_set_invertible_t)0x0) &&
                  (puVar22 = (undefined4 *)
                             hb_bit_set_t::page_for((hb_bit_set_t *)&local_c8,(uint)uVar40,false),
                  puVar22 != (undefined4 *)0x0)) {
            local_c8 = CONCAT44(0xffffffff,(undefined4)local_c8);
            bVar8 = (byte)uVar40 & 0x3f;
            *(ulong *)(puVar22 + (ulong)((uint)(uVar40 >> 6) & 7) * 2 + 2) =
      ...
      local_150 = (void *)0x0;
      cVar11 = _iup_contour_optimize_dp
                         ((contour_point_vector_t *)&local_178,(hb_vector_t *)&local_198,
                          (hb_vector_t *)&local_188,(hb_set_t *)&local_d8,param_5,uVar15,
                          (hb_vector_t *)&local_168,(hb_vector_t *)&local_158);
      pvVar24 = local_150;
      if (cVar11 != '\0') {
        local_78 = 1;
        local_48 = 0;
        ...
        do {
          if ((char)local_48 == '\0') {
            if (local_78._0_1_ != (hb_bit_set_invertible_t)0x0) {
              ...
              if (puVar22 != (undefined4 *)0x0) {
                *(ulong *)(puVar22 + (ulong)(uVar15 >> 6 & 7) * 2 + 2) =
                     *(ulong *)(puVar22 + (ulong)(uVar15 >> 6 & 7) * 2 + 2) |
                     1L << ((byte)uVar15 & 0x3f);
                *puVar22 = 0xffffffff;
              }
                  ...
                  (puVar22 = (undefined4 *)
                             hb_bit_set_t::page_for((hb_bit_set_t *)&local_78,uVar15,false),
                  puVar22 != (undefined4 *)0x0)) {
            local_78 = CONCAT44(0xffffffff,(undefined4)local_78);
...
LAB_00103c6b:
              local_140 = (void *)CONCAT44(local_140._4_4_,uVar27);
            }
            else {
...
LAB_00103b71:
              hb_bit_set_t::next(phVar36,(uint *)&local_140);
              phVar37 = local_148;
            }
            phVar36 = phVar37;
...
LAB_00101556:
    ...
    if ((uVar26 < 0x15555556) &&
       (pvVar20 = realloc((void *)0x0,(ulong)uVar26 * 0xc), pvVar20 != (void *)0x0)) {
...
LAB_00103cb2:
      ...
      pvVar25 = pvVar23;
LAB_00103fb3:
      memcpy(pvVar24,__dest + (__n - (long)pvVar25),sVar31);
      pvVar20 = pvVar23;
      uVar40 = uVar34;
...
LAB_00104286:
    ...
    if (uVar5 < uVar9) {
LAB_00104210:
      if (0x38e38e3 < (uint)uVar6) goto LAB_00104187;
      pvVar2 = *(void **)(this + 0x28);
LAB_00104221:
      uVar8 = (uint)uVar6;
...
LAB_001046bb:
    if (uVar2 <= uVar9) goto LAB_001045a8;
LAB_001046c4:
    *(uint *)(this + 8) = uVar9;
    puVar13 = (uint *)(lVar5 + (ulong)uVar9 * 8);
    lVar14 = *(long *)(this + 0x28);
...
joined_r0x001048d5:
    if ((uVar9 < uVar16) &&
       (puVar15 = puVar1 + (ulong)uVar9 * 2, puVar1[(ulong)uVar9 * 2] == uVar11)) goto LAB_001047fd;
  }
  if (-1 < (int)(uVar9 - 1)) {
    lVar6 = 7;
LAB_001047b0:
...
ulong __thiscall hb_bit_set_invertible_t::get_population(hb_bit_set_invertible_t *this)
...
/* hb_bit_set_invertible_t::set(hb_bit_set_invertible_t const&) */

void __thiscall
hb_bit_set_invertible_t::set(hb_bit_set_invertible_t *this,hb_bit_set_invertible_t *param_1)
...
void __thiscall hb_vector_t<int,false>::fini(hb_vector_t<int,false> *this)

...
void GLTFMesh::set_additional_data(long param_1,StringName *param_2,Variant *param_3)

{
  ...
  this = (Variant *)Dictionary::operator[]((Variant *)(param_1 + 0x268));
  Variant::operator=(this,param_3);
  if (Variant::needs_deinit[local_38[0]] != '\0') {
    Variant::_clear_internal();
  }
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {

...

{
  ...
  puVar3[1] = _LC5;
  *puVar3 = &PTR___Sp_counted_ptr_inplace_00111338;
...

{
  ...
  puVar6[1] = _LC5;
  *puVar6 = &PTR___Sp_counted_ptr_inplace_00111338;
...
LAB_00104598:
  ...
  *(undefined ***)p_Var7 = &PTR___Sp_counted_ptr_inplace_001113a8;
...

{
  ...
  if (*(int *)(local_68 + 0x40) == 0) {
    ...
    *(undefined8 *)(this + 0x28) = uVar5;
    uVar3 = _LC21;
    *(undefined ***)this = &PTR___Sp_counted_ptr_inplace_00111370;
    uVar4 = _LC24;
...

{
  ...
  *(undefined8 *)(this_00 + 0x28) = uVar3;
  uVar1 = _LC21;
  *(undefined ***)this_00 = &PTR___Sp_counted_ptr_inplace_00111370;
  uVar2 = _LC24;
...

{
  ...
  *(undefined ***)p_Var5 = &PTR___Sp_counted_ptr_inplace_00111370;
...

{
  ...
  if (*(ulong *)(this + 0x10) < param_1) {
    puVar3 = (undefined8 *)malloc(param_1 * 8);
...
LAB_0010bc9d:
      ...
      if (puVar5 != (undefined8 *)0x0) goto LAB_0010bc9d;
    }
    *(undefined8 **)this = puVar3;
    *(ulong *)(this + 0x10) = param_1;
    if (uVar4 < param_1) goto LAB_0010bbae;
LAB_0010bbcd:
...
LAB_0010bc30:
    sVar6 = param_1 * 8;
    puVar5 = (undefined8 *)malloc(sVar6);
    puVar3 = *(undefined8 **)this;
    if (8 < (long)sVar6) {
      memmove(puVar5,puVar3,sVar6);
      goto LAB_0010bc56;
    }
    if (sVar6 == 8) {
      *puVar5 = *puVar3;
    ...
    if (uVar1 < param_1) {
      puVar3 = *(undefined8 **)this;
LAB_0010bbae:
      for (pdVar2 = (double *)(puVar3 + uVar4); (double *)(puVar3 + param_1) != pdVar2;
          pdVar2 = pdVar2 + 1) {
        *pdVar2 = param_2;
      }
      goto LAB_0010bbcd;
    ...
    *(ulong *)(this + 8) = param_1;
    ...
    if (param_1 != 0) goto LAB_0010bc30;
    puVar3 = *(undefined8 **)this;
...

{
  ...
  *(undefined1 (*) [16])(puVar16 + 0xc) = (undefined1  [16])0x0;
  ...
  uVar14 = param_3[6];
  uVar15 = param_3[7];
  *puVar16 = &PTR___Sp_counted_ptr_inplace_00111370;
...

{
  ...
  if (pvVar3 == pvVar2) {
    if (0xfffffffffffffffe < uVar5) goto LAB_0010ca38;
...
LAB_0010ca38:
  ...
  *puVar1 = *param_3;
  ...
  if (param_2 == pvVar3) {
    if (param_2 != pvVar2) goto LAB_0010c9c8;
LAB_0010c9fc:
    if (pvVar3 == (void *)0x0) goto LAB_0010ca18;
  }
  else {
    lVar8 = 0;
    uVar5 = 0;
...

{
  ...
  *(undefined8 *)this = 0;
  ...
  puVar7[1] = _LC5;
  *puVar7 = &PTR___Sp_counted_ptr_inplace_00111338;
  if (p_Stack_40 != (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *)0x0) {
    if (__libc_single_threaded == '\0') {
      LOCK();
      *(int *)(p_Stack_40 + 8) = *(int *)(p_Stack_40 + 8) + 1;
...
LAB_0010cc48:
    ...
    if (plVar8 != (long *)0x0) {
      if (__libc_single_threaded != '\0') goto LAB_0010cc0b;
      LOCK();
...

{
  ...
  if (uVar2 < param_1) {
    ...
    *puVar6 = 0;
    if (param_1 - 1 != 0) goto LAB_0010cda4;
LAB_0010cdb8:
    if (sVar4 != 0) goto LAB_0010ce88;
    if (pvVar3 == (void *)0x0) goto LAB_0010cdca;
...

{
  ...
  if (uVar2 < param_1) {
    ...
    puVar6 = (undefined4 *)((long)__dest + sVar4);
    *puVar6 = 0;
    if (param_1 - 1 != 0) goto LAB_0010cf84;
LAB_0010cf98:
    if (sVar4 != 0) goto LAB_0010d068;
    if (pvVar3 == (void *)0x0) goto LAB_0010cfaa;
    uVar5 = *(long *)(this + 0x10) - (long)pvVar3;
  }
  else {
    uVar2 = uVar2 * 2;
...

{
  ...
  if (uVar2 < param_1) {
    ...
    *puVar6 = 0;
    if (param_1 - 1 != 0) goto LAB_0010d165;
LAB_0010d179:
    if (sVar4 != 0) goto LAB_0010d250;
    if (pvVar3 == (void *)0x0) goto LAB_0010d18b;
    uVar5 = *(long *)(this + 0x10) - (long)pvVar3;
  }
  else {
    uVar2 = uVar2 * 2;
...

{
  ...
  if (uVar2 < param_1) {
    ...
    puVar6 = (undefined8 *)((long)__dest + sVar4);
    *puVar6 = 0;
    if (param_1 - 1 != 0) goto LAB_0010d345;
LAB_0010d359:
    if (sVar4 != 0) goto LAB_0010d430;
    if (pvVar3 == (void *)0x0) goto LAB_0010d36b;
    uVar5 = *(long *)(this + 0x10) - (long)pvVar3;
  }
  else {
    uVar2 = uVar2 * 2;
...

{
  ...
  if (__src == pvVar1) {
    if (0xfffffffffffffffe < uVar2) goto LAB_0010d530;
...
LAB_0010d530:
  ...
  *(undefined8 *)((long)__dest_00 + __n) = *param_3;
  if ((long)__n < 1) {
    ...
    if (__src == (void *)0x0) goto LAB_0010d50f;
  }
  else {
...

{
  ...
  *puVar7 = &PTR___Sp_counted_ptr_inplace_00111338;
  ...
  if (local_58 != 0) {
    ...
    *(undefined ***)this_00 = &PTR___Sp_counted_deleter_001113e0;
  ...
  if ((lVar3 != 0) && (*(int *)(lVar3 + 8) != 0)) goto LAB_0010d702;
  lVar3 = *(long *)(this + 8);
  puVar7[3] = pCVar1;
  if (lVar3 == 0) {
LAB_0010d788:
    plVar8 = (long *)puVar7[4];
    if (plVar8 != (long *)0x0) {
      if (__libc_single_threaded != '\0') goto LAB_0010d75c;
      LOCK();
      piVar2 = (int *)((long)plVar8 + 0xc);
      iVar6 = *piVar2;
      *piVar2 = *piVar2 + -1;
...

{
  ...
  __n = (long)param_2 - (long)__src;
  if (__src == pvVar1) {
    if (0xfffffffffffffffe < uVar2) goto LAB_0010d890;
...
LAB_0010d890:
  ...
  *(undefined4 *)((long)__dest_00 + __n) = *param_3;
  if ((long)__n < 1) {
    ...
    if (__src == (void *)0x0) goto LAB_0010d86b;
  }
  else {
    __dest_00 = memmove(__dest_00,__src,__n);
    if (0 < (long)__n_00) {
...

{
  ...
  if (puVar2 == puVar1) {
    uVar15 = uVar12 + 1;
    if (0xfffffffffffffffe < uVar12) goto LAB_0010dad0;
...
LAB_0010da20:
    ...
    puVar14 = puVar16;
    if (param_2 == puVar1) goto LAB_0010da94;
  }
  else {
...
LAB_0010dad0:
    ...
    *puVar14 = *param_3;
    ...
    puVar14 = puVar2;
    puVar17 = puVar13;
    if (param_2 != puVar2) goto LAB_0010da20;
  }
...

{
  ...
  __n = (long)param_2 - (long)__src;
  if (__src == pvVar1) {
    if (0xfffffffffffffffe < uVar2) goto LAB_0010dc70;
    uVar3 = 0x1fffffffffffffff;
    if (uVar2 + 1 < 0x2000000000000000) {
      uVar3 = uVar2 + 1;
    }
...
LAB_0010dc70:
  ...
  *(undefined4 *)((long)__dest_00 + __n) = *param_3;
  if ((long)__n < 1) {
    ...
    if (__src == (void *)0x0) goto LAB_0010dc4f;
  }
  else {
    __dest_00 = memmove(__dest_00,__src,__n);
    if (0 < (long)__n_00) {
...

{
  ...
  if (puVar2 == puVar1) {
    if (0xfffffffffffffffe < uVar5) goto LAB_0010de40;
...
LAB_0010ddb9:
    ...
    if (param_2 == puVar1) goto LAB_0010de09;
  }
  else {
    uVar7 = uVar5 * 2;
    if (uVar7 < uVar5) {
LAB_0010de40:
    ...
    *(undefined8 *)((long)param_2 - (long)puVar2) = *param_3;
    if (param_2 != puVar2) goto LAB_0010ddb9;
  }
...
LAB_0010f0f6:
      ...
      if (pVVar35 != (Vec *)0x0) goto LAB_0010f0f6;
    }
    *(Vec **)(this + 0x48) = pVVar22;
    *(Vec **)(this + 0x58) = pVVar42;
    if (pVVar41 < pVVar42) goto LAB_0010eba0;
LAB_0010f131:
...
LAB_0010eba0:
      ...
      if (pVVar22 + (long)pVVar42 * 0x18 == pVVar41) goto LAB_0010f131;
      do {
      ...
      *(Vec **)(this + 0x50) = pVVar42;
      if (pVVar21 < pVVar24) goto LAB_0010f13e;
      goto LAB_0010ebe2;
    }
    *(Vec **)(this + 0x50) = pVVar42;
    if (pVVar21 < pVVar24) {
      if (pVVar42 != (Vec *)0x0) goto LAB_0010f13e;
      pVVar24 = *(Vec **)(this + 0x48);
      uVar36 = 0;
      pVVar41 = pVVar24;
      if (pVVar24 != (Vec *)0x0) {
...
LAB_0010f1c3:
      ...
      if (pVVar35 != (Vec *)0x0) goto LAB_0010f1c3;
    }
    *(Vec **)(this + 0xa8) = pVVar22;
    *(Vec **)(this + 0xb8) = pVVar42;
    if (pVVar28 < pVVar42) goto LAB_0010e5a4;
LAB_0010f207:
    *(Vec **)(this + 0xb0) = pVVar42;
    if (pVVar26 <= pVVar41) goto LAB_0010e5f4;
LAB_0010f217:
    ...
    if ((long)local_190 < 0x21) {
      if (local_190 != (Vec *)0x20) goto LAB_0010ecfd;
...
LAB_0010ed06:
    ...
    *(Vec **)(this + 0xb8) = pVVar42;
LAB_0010ed1b:
    if (pVVar42 != (Vec *)0x0) goto LAB_0010e5f4;
    pVVar42 = (Vec *)0x0;
  }
  else {
    if (pVVar42 <= pVVar26) {
      *(Vec **)(this + 0xb0) = pVVar42;
      if (pVVar41 < pVVar26) {
        if (pVVar42 != (Vec *)0x0) goto LAB_0010f217;
        pVVar26 = *(Vec **)(this + 0xa8);
        puVar31 = (ulong *)0x0;
LAB_0010ecfd:
        if (pVVar26 != (Vec *)0x0) goto LAB_0010f24b;
        goto LAB_0010ed06;
      }
      goto LAB_0010ed1b;
    }
...
LAB_0010e5a4:
    ...
    if (pVVar22 + (long)pVVar42 * 0x20 == pVVar21) goto LAB_0010f207;
    pVVar28 = (Vec *)0x0;
    ...
    *(Vec **)(this + 0xb0) = pVVar42;
    if (pVVar41 < pVVar26) goto LAB_0010f217;
LAB_0010e5f4:
    uStack_50 = _UNK_001114b8;
    local_58 = _LC27;
    lVar40 = 0;
  ...
  if (*(long *)(param_1 + 0x88) == *(long *)(param_1 + 0x80)) {
    ...
    if (lVar40 == *(long *)(param_1 + 0x88)) {
      if (pVVar22 == (Vec *)0x0) goto LAB_0010ea1f;
    }
    else {
      do {
...
LAB_0010ec56:
            ...
            do {
              while( true ) {
                ...
                pVVar24 = pVVar35;
                if (*(Vec **)(pVVar35 + 0x10) == (Vec *)0x0) goto LAB_0010ec49;
              }
              pVVar21 = *(Vec **)(pVVar35 + 0x18);
            } while (*(Vec **)(pVVar35 + 0x18) != (Vec *)0x0);
LAB_0010ec49:
            if ((pVVar45 == pVVar24) || (iVar19 < *(int *)(pVVar24 + 0x20))) goto LAB_0010ec56;
          }
          uVar23 = _LC6;
...
LAB_0010e92a:
            ...
            do {
              while( true ) {
                ...
                pVVar21 = *(Vec **)(pVVar35 + 0x10);
                pVVar24 = pVVar35;
                if (*(Vec **)(pVVar35 + 0x10) == (Vec *)0x0) goto LAB_0010e919;
              }
              pVVar21 = *(Vec **)(pVVar35 + 0x18);
            } while (*(Vec **)(pVVar35 + 0x18) != (Vec *)0x0);
LAB_0010e919:
            if ((pVVar45 == pVVar24) || (iVar19 < *(int *)(pVVar24 + 0x20))) goto LAB_0010e92a;
          }
          *(int *)(pVVar24 + 0x28) = iVar2;
          pVVar24[0x90] = (Vec)0x0;
...
LAB_0010f3de:
                pVVar32 = (Vec *)this;
                if (pVVar35 != (Vec *)0x0) goto LAB_0010f516;
              }
              else {
LAB_0010f4a7:
                sVar43 = uVar27 * 0x10;
                if ((long)sVar43 < 0x11) {
                  if (sVar43 != 0x10) goto LAB_0010f3de;
                  uVar27 = *(ulong *)(pVVar35 + 8);
  ...
  if (*(int **)(this + 0x58) < piVar24) {
    ...
    if (piVar54 != (int *)0x0) {
      ...
      if ((long)sVar32 < 0x19) {
        ...
        if (puVar38 != (undefined8 *)0x0) goto LAB_0011094f;
      }
      else {
...
LAB_0010fb05:
    if (piVar43 < piVar24) goto LAB_001102d1;
  }
...
LAB_00110548:
      if (puVar38 != (undefined8 *)0x0) goto LAB_001109ed;
    }
    else {
      ...
      puVar38 = *(undefined8 **)(this + 0x48);
      if ((long)sVar32 < 0x19) {
        if (sVar32 != 0x18) goto LAB_00110548;
        uVar44 = puVar38[1];
        *puVar40 = *puVar38;
        puVar40[1] = uVar44;
        puVar40[2] = puVar38[2];
...
LAB_001108a7:
      ...
      if (piVar43 != (int *)0x0) goto LAB_001108a7;
    }
    *(int **)(this + 0xa8) = __dest;
    *(int **)(this + 0xb8) = piVar24;
    if (piVar39 < piVar24) goto LAB_00110323;
LAB_001108eb:
    *(int **)(this + 0xb0) = piVar24;
    if (piVar54 <= piVar26) goto LAB_0010fcd7;
LAB_0011037b:
    sVar32 = (long)piVar24 << 5;
    puVar38 = (undefined8 *)malloc(sVar32);
    piVar54 = *(int **)(this + 0xa8);
    if ((long)sVar32 < 0x21) {
      if (sVar32 != 0x20) goto LAB_0010fcb0;
...
LAB_0010fcb9:
    ...
    *(int **)(this + 0xb8) = piVar24;
LAB_0010fcce:
    if (piVar24 != (int *)0x0) goto LAB_0010fcd7;
  }
  else {
    if (piVar24 <= piVar54) {
      *(int **)(this + 0xb0) = piVar24;
      if (piVar26 < piVar54) {
        if (piVar24 != (int *)0x0) goto LAB_0011037b;
        piVar54 = *(int **)(this + 0xa8);
        puVar38 = (undefined8 *)0x0;
LAB_0010fcb0:
        if (piVar54 != (int *)0x0) goto LAB_001103c3;
        goto LAB_0010fcb9;
      }
      goto LAB_0010fcce;
    }
...
LAB_00110323:
    ...
    if ((undefined1 (*) [16])(__dest + (long)piVar24 * 8) == pauVar29) goto LAB_001108eb;
    piVar39 = (int *)0x0;
    ...
    *(int **)(this + 0xb0) = piVar24;
    if (piVar26 < piVar54) goto LAB_0011037b;
LAB_0010fcd7:
    uStack_50 = _UNK_001114b8;
    local_58 = _LC27;
    lVar52 = 0;
...
LAB_0010fe04:
      ...
      if (piVar26 == piVar39) {
        ...
        if (pMVar46 == (MeshGLP *)((long)piVar54 >> 3)) {
          piVar28 = piVar26;
          __dest = piVar54;
          if (piVar39 == piVar24) goto LAB_00110bdc;
          *(int **)piVar39 = piVar43;
        }
      }
    }
...
LAB_00110ddb:
      ...
      *(int **)((long)piVar26 + (long)piVar54) = piVar43;
      if ((long)__dest < 1) {
        if (piVar28 != (int *)0x0) goto LAB_00110d9d;
      }
      else {
...
LAB_00110d9d:
    ...
    if (*(long *)(param_1 + 0x88) == lVar51) {
      if (piVar26 == (int *)0x0) goto LAB_0011010a;
    }
    else {
      do {
...
LAB_0011043e:
            ...
            do {
              while( true ) {
                ...
                pIVar27 = pIVar30;
                if (*(Impl **)(pIVar30 + 0x10) == (Impl *)0x0) goto LAB_00110431;
              }
              pIVar4 = *(Impl **)(pIVar30 + 0x18);
            } while (*(Impl **)(pIVar30 + 0x18) != (Impl *)0x0);
LAB_00110431:
            if ((pIVar1 == pIVar27) || (iVar21 < *(int *)(pIVar27 + 0x20))) goto LAB_0011043e;
          }
          uVar44 = _LC6;
...
LAB_00110012:
            ...
            do {
              while( true ) {
                ...
                pIVar4 = *(Impl **)(pIVar30 + 0x10);
                pIVar27 = pIVar30;
                if (*(Impl **)(pIVar30 + 0x10) == (Impl *)0x0) goto LAB_00110001;
              }
              pIVar4 = *(Impl **)(pIVar30 + 0x18);
            } while (*(Impl **)(pIVar30 + 0x18) != (Impl *)0x0);
LAB_00110001:
            if ((pIVar1 == pIVar27) || (iVar21 < *(int *)(pIVar27 + 0x20))) goto LAB_00110012;
          }
          *(int *)(pIVar27 + 0x28) = iVar2;
          pIVar27[0x90] = (Impl)0x0;
          *(undefined8 *)(pIVar27 + 0x30) = uVar44;
...
LAB_00110b02:
              ...
              if (uVar37 == 0) {
LAB_00110b6f:
                if (__src != (undefined8 *)0x0) goto LAB_00110caf;
              }
              else {
                sVar32 = uVar37 * 0x10;
                if ((long)sVar32 < 0x11) {
                  if (sVar32 != 0x10) goto LAB_00110b6f;
                  uVar9 = __src[1];
                  *puVar40 = *__src;
                  puVar40[1] = uVar9;
                }

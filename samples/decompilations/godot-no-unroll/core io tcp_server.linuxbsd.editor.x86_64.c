...
/* TCPServer::get_local_port() const */

undefined2 __thiscall TCPServer::get_local_port(TCPServer *this)
...
void __thiscall TCPServer::stop(TCPServer *this)
...
/* TCPServer::listen(unsigned short, IPAddress const&) */

undefined8 __thiscall TCPServer::listen(TCPServer *this,ushort param_1,IPAddress *param_2)

{
  ...
  if (*(long **)(this + 0x180) == (long *)0x0) {
    _err_print_error("listen","core/io/tcp_server.cpp",0x2b,
  ...
  if (cVar2 == '\0') {
    if (param_2[0x10] == (IPAddress)0x0) {
      ...
      if (param_2[0x11] == (IPAddress)0x0) {
        _err_print_error("listen","core/io/tcp_server.cpp",0x2d,
    ...
    if (iVar5 != 0) {
      _err_print_error("listen","core/io/tcp_server.cpp",0x39,
    ...
    _err_print_error("listen","core/io/tcp_server.cpp",0x2c,
...
/* TCPServer::is_listening() const */

undefined8 __thiscall TCPServer::is_listening(TCPServer *this)

{
  ...
  _err_print_error("is_listening","core/io/tcp_server.cpp",0x55,
...
/* TCPServer::is_connection_available() const */

bool __thiscall TCPServer::is_connection_available(TCPServer *this)

{
  ...
  if (*(long **)(this + 0x180) == (long *)0x0) {
    _err_print_error("is_connection_available","core/io/tcp_server.cpp",0x5b,
                     "Condition \"_sock.is_null()\" is true. Returning: false",0,0);
  }
  else {
...
void TCPServer::take_connection(void)

{
  ...
  *in_RDI = 0;
  ...
  IPAddress::clear();
  local_52 = 0;
  (**(code **)(**(long **)(in_RSI + 0x180) + 0x1a0))
            (&local_50,*(long **)(in_RSI + 0x180),local_48,&local_52);
  pOVar3 = local_50;
  if (local_50 == (Object *)0x0) goto LAB_001004d9;
  cVar2 = RefCounted::reference();
  if (cVar2 == '\0') {
    if ((local_50 == (Object *)0x0) ||
       (cVar2 = RefCounted::unreference(), pOVar4 = local_50, cVar2 == '\0')) goto LAB_001004d9;
    pOVar3 = (Object *)0x0;
...
LAB_0010057c:
  ...
  else if (((local_50 != (Object *)0x0) &&
           (cVar2 = RefCounted::unreference(), pOVar4 = local_50, cVar2 != '\0')) &&
          (cVar2 = predelete_handler(local_50), cVar2 != '\0')) goto LAB_0010057c;
...
LAB_001005ef:
  ...
  StreamPeerTCP::accept_socket(pOVar4,&local_50,uVar1);
  if (((local_50 != (Object *)0x0) &&
      (cVar2 = RefCounted::unreference(), pOVar4 = local_50, cVar2 != '\0')) &&
...
/* TCPServer::_bind_methods() */

void TCPServer::_bind_methods(void)
...
/* TCPServer::is_class_ptr(void*) const */

uint __thiscall TCPServer::is_class_ptr(TCPServer *this,void *param_1)
...
/* TCPServer::_getv(StringName const&, Variant&) const */

undefined8 TCPServer::_getv(StringName *param_1,Variant *param_2)
...
/* TCPServer::_setv(StringName const&, Variant const&) */

undefined8 TCPServer::_setv(StringName *param_1,Variant *param_2)
...
/* TCPServer::_validate_propertyv(PropertyInfo&) const */

void TCPServer::_validate_propertyv(PropertyInfo *param_1)
...
/* TCPServer::_property_can_revertv(StringName const&) const */

undefined8 TCPServer::_property_can_revertv(StringName *param_1)
...
/* TCPServer::_property_get_revertv(StringName const&, Variant&) const */

undefined8 TCPServer::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* TCPServer::_notificationv(int, bool) */

void TCPServer::_notificationv(int param_1,bool param_2)
...
/* MethodBindTR<Ref<StreamPeerTCP>>::_gen_argument_type(int) const */

undefined8 MethodBindTR<Ref<StreamPeerTCP>>::_gen_argument_type(int param_1)
...
/* MethodBindTR<Ref<StreamPeerTCP>>::get_argument_meta(int) const */

undefined8 MethodBindTR<Ref<StreamPeerTCP>>::get_argument_meta(int param_1)
...
void __thiscall
MethodBindTR<Ref<StreamPeerTCP>>::~MethodBindTR(MethodBindTR<Ref<StreamPeerTCP>> *this)
...
/* TCPServer::_get_class_namev() const */

undefined8 * TCPServer::_get_class_namev(void)
...
LAB_00101713:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      goto LAB_00101713;
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"TCPServer");
      goto LAB_0010177e;
    }
  }
  StringName::assign_static_unique_class_name
...
/* TCPServer::get_class() const */

void TCPServer::get_class(void)
...
/* TCPServer::is_class(String const&) const */

undefined8 __thiscall TCPServer::is_class(TCPServer *this,String *param_1)
...
/* MethodBindTR<Ref<StreamPeerTCP>>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTR<Ref<StreamPeerTCP>>::_gen_argument_type_info(int param_1)
...
/* TCPServer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall TCPServer::_get_property_listv(TCPServer *this,List *param_1,bool param_2)
...
/* MethodBind* create_method_bind<TCPServer, Error, unsigned short, IPAddress const&>(Error
   (TCPServer::*)(unsigned short, IPAddress const&)) */

MethodBind *
create_method_bind<TCPServer,Error,unsigned_short,IPAddress_const&>
...
/* MethodBind* create_method_bind<TCPServer, bool>(bool (TCPServer::*)() const) */

MethodBind * create_method_bind<TCPServer,bool>(_func_bool *param_1)
...
/* MethodBind* create_method_bind<TCPServer, int>(int (TCPServer::*)() const) */

MethodBind * create_method_bind<TCPServer,int>(_func_int *param_1)
...
MethodBind * create_method_bind<TCPServer,Ref<StreamPeerTCP>>(_func_Ref *param_1)
...
/* MethodBind* create_method_bind<TCPServer>(void (TCPServer::*)()) */

MethodBind * create_method_bind<TCPServer>(_func_void *param_1)
...
/* TCPServer::_bind_methods() [clone .cold] */
...
/* TCPServer::_initialize_classv() */

void TCPServer::_initialize_classv(void)

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialize_class()::initialized != '\0') goto LAB_00103629;
...
/* WARNING: Removing unreachable block (ram,0x00103a78) */
/* WARNING: Removing unreachable block (ram,0x00103c40) */
/* WARNING: Removing unreachable block (ram,0x00103a84) */
/* WARNING: Removing unreachable block (ram,0x00103a8e) */
/* WARNING: Removing unreachable block (ram,0x00103c20) */
/* WARNING: Removing unreachable block (ram,0x00103a9a) */
...
/* WARNING: Removing unreachable block (ram,0x00103aba) */
/* WARNING: Removing unreachable block (ram,0x00103be0) */
/* WARNING: Removing unreachable block (ram,0x00103ac6) */
/* WARNING: Removing unreachable block (ram,0x00103ad0) */
/* WARNING: Removing unreachable block (ram,0x00103bc0) */
/* WARNING: Removing unreachable block (ram,0x00103adc) */
/* WARNING: Removing unreachable block (ram,0x00103ae6) */
/* WARNING: Removing unreachable block (ram,0x00103ba0) */
/* WARNING: Removing unreachable block (ram,0x00103af2) */
/* WARNING: Removing unreachable block (ram,0x00103afc) */
...
Object * MethodBindTR<Ref<StreamPeerTCP>>::call
...
void __thiscall
MethodBindTR<Ref<StreamPeerTCP>>::ptrcall
          (MethodBindTR<Ref<StreamPeerTCP>> *this,Object *param_1,void **param_2,void *param_3)
...
void __thiscall
MethodBindTR<Ref<StreamPeerTCP>>::validated_call
          (MethodBindTR<Ref<StreamPeerTCP>> *this,Object *param_1,Variant **param_2,Variant *param_3
          )

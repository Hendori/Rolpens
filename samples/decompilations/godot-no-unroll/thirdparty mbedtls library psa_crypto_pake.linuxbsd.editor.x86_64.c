...

{
  ...
  if ((((iVar2 != 0) || (iVar2 = psa_crypto_driver_pake_get_user_len(param_2,&local_80), iVar2 != 0)
       ) || (iVar2 = psa_crypto_driver_pake_get_peer_len(param_2,&local_78), iVar2 != 0)) ||
     (iVar2 = psa_crypto_driver_pake_get_cipher_suite(param_2,&local_4c), sVar1 = local_70,
     iVar2 != 0)) goto LAB_00100132;
  ...
  *(void **)(param_1 + 2) = pvVar4;
  if ((pvVar4 == (void *)0x0) || (__s1 = calloc(1,local_80), __s1 == (void *)0x0)) {
    ...
    if (__s1_00 == (void *)0x0) {
      ...
      if (((iVar3 == 0) &&
          (iVar3 = psa_crypto_driver_pake_get_user(param_2,__s1,local_80,&local_68), iVar3 == 0)) &&
         (iVar2 = psa_crypto_driver_pake_get_peer(param_2,__s1_00,local_78,&local_60), iVar3 = iVar2
         , iVar2 == 0)) {
        *(undefined8 *)(param_1 + 4) = local_58;
        *param_1 = (int)local_4c;
        if (((((int)local_4c == 0xa000100) && (local_4c._4_4_ == 0x1001201)) &&
            (local_44 == 0x2000009)) && ((local_68 == 6 && (local_60 == 6)))) {
          iVar3 = memcmp(__s1,&jpake_client_id,6);
          if ((iVar3 == 0) && (iVar3 = memcmp(__s1_00,&jpake_server_id,6), iVar3 == 0)) {
            iVar3 = 0;
          }
          else {
            iVar3 = memcmp(__s1,&jpake_server_id,6);
            if ((iVar3 != 0) || (iVar3 = memcmp(__s1_00,&jpake_client_id,6), iVar3 != 0))
            goto LAB_001002ab;
            iVar3 = 1;
          }
          param_1[6] = iVar3;
          *(undefined1 (*) [16])(param_1 + 0x5c) = (undefined1  [16])0x0;
          ...
          iVar3 = mbedtls_ecjpake_setup
                            (param_1 + 0x60,param_1[6],9,3,*(undefined8 *)(param_1 + 2),
                             *(undefined8 *)(param_1 + 4));
          mbedtls_platform_zeroize(*(undefined8 *)(param_1 + 2),*(undefined8 *)(param_1 + 4));
          if ((iVar3 == 0) || (iVar3 = mbedtls_ecjpake_to_psa_error(iVar3), iVar3 == 0)) {
            free(__s1);
            free(__s1_00);
            goto LAB_00100132;
          }
...
undefined8
mbedtls_psa_pake_output(int *param_1,int param_2,undefined8 *param_3,ulong param_4,ulong *param_5)

{
  ...
  if (param_2 == 1) {
    iVar2 = mbedtls_ecjpake_write_round_one
                      (param_1 + 0x60,param_1 + 7,0x150,param_1 + 0x5c,&mbedtls_psa_get_random,0);
    if (iVar2 != 0) {
LAB_001005c0:
      uVar5 = mbedtls_ecjpake_to_psa_error(iVar2);
      return uVar5;
    }
  }
  else {
    ...
    iVar2 = mbedtls_ecjpake_write_round_two
                      (param_1 + 0x60,param_1 + 7,0x150,param_1 + 0x5c,&mbedtls_psa_get_random,0);
  ...
  lVar4 = 0;
LAB_00100474:
  bVar1 = *(byte *)((long)param_1 + lVar4 + 0x1c);
  uVar3 = (ulong)bVar1;
...
LAB_001006e2:
          mbedtls_platform_zeroize(piVar1,0x150);
          param_1[0x5c] = 0;
          param_1[0x5d] = 0;
          if (iVar3 != 0) {

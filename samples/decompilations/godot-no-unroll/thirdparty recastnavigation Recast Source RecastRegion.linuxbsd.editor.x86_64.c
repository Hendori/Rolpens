...

{
  ...
  if ((int)uVar24 < 1) {
    ...
    *(undefined2 *)(param_2 + 0x18) = 0;
    if (rVar23 != (rcContext)0x0) goto LAB_0010104b;
LAB_001014ae:
...
LAB_0010101f:
      ...
      do {
        ...
        puVar4 = puVar4 + 1;
      } while (puVar4 != __s + (int)uVar24);
      *(ushort *)(param_2 + 0x18) = uVar19;
      if (rVar23 == (rcContext)0x0) {
        if (local_64 < 1) goto LAB_001014ae;
...
LAB_0010104b:
      ...
      if (0 < local_64) goto LAB_00101096;
    }
    else {
LAB_001009f6:
      if (0 < (int)local_68) {
...
LAB_00101ed8:
          ...
          if (lVar48 <= (long)local_e8._8_8_) goto LAB_00101ed8;
...
LAB_00101870:
                    ...
                    *puVar21 = uVar28;
                    ...
                    if ((((short)uVar35 < 0) ||
                       ...
                       (uVar29 = uVar28, uVar35 == 0)) goto LAB_00101870;
                  }
            ...
            do {
              while ((uVar35 = puVar20[2], 0xfffd < (ushort)(uVar35 - 1) ||
                ...
                *puVar20 = (ushort)uVar14;
                puVar20 = puVar19;
                uVar14 = uVar47;
                if (puVar21 == puVar19) goto LAB_00101970;
              }
              *puVar20 = uVar35;
              puVar20 = puVar20 + 4;
              uVar47 = uVar14;
                      ...
                      if (uVar35 != 0) {
                        if ((uVar28 != uVar35) && (uVar14 < local_140)) {
                          if (0 < (int)*(undefined8 *)(piVar24 + 4)) {
                            ...
                            do {
                              if (uVar14 == *puVar38) goto LAB_00101d11;
                              puVar38 = puVar38 + 1;
...
LAB_00101d11:
                  ...
                  uVar18 = uVar18 + 1;
                  if ((int)uVar47 <= (int)uVar18) goto LAB_00101d46;
                }
                uVar18 = uVar18 + 1;
...
LAB_00101e49:
                        piVar46 = piVar46 + 1;
                        if (piVar22 == piVar46) goto LAB_00101e5e;
                      }
...
joined_r0x00101e1f:
                      if (0 < iVar26) {
                        ...
                        do {
                          if (*piVar23 == iVar44) goto LAB_00101e49;
                          piVar23 = piVar23 + 1;
...
LAB_0010261c:
              ...
              piVar24 = (int *)memmove((void *)local_78._0_8_,(int *)(local_78._0_8_ + 4),
                                       (ulong)uVar47 << 2);
              if (lVar45 < lVar48) goto LAB_0010261c;
              if (lVar48 < lVar45) goto LAB_0010259c;
            }
              ...
              do {
                while( true ) {
                  ...
                  if (0 < (int)*(undefined8 *)this) {
                    ...
                    do {
                      if (iVar34 == *piVar22) goto LAB_001020b5;
                      piVar22 = piVar22 + 1;
                    ...
                    do {
                      ...
                      if (0 < (int)*(undefined8 *)this) {
                        ...
                        do {
                          if (iVar34 == *piVar22) {
                            lVar30 = lVar30 + 1;
                            if ((int)lVar30 < (int)uVar33) goto LAB_00102132;
                            goto LAB_00102179;
                          }
                          piVar22 = piVar22 + 1;
                        } while (piVar22 != piVar46);
...
LAB_00102179:
                  ...
                  *piVar24 = 0;
                  ...
                  lVar45 = lVar45 + 4;
                  this[-0x1e] = rVar12;
                  if (lVar48 == lVar45) goto LAB_001021ce;
                }
LAB_001020b5:
                lVar45 = lVar45 + 4;
              } while (lVar48 != lVar45);
...
LAB_00102214:
      ...
      *(short *)(param_2 + 0x1a) = sVar36;
      ...
      rcFree(local_98);
      lVar48 = local_c8._0_8_;
      if (0 < (long)local_c8._0_8_) goto LAB_0010236b;
      rcFree(piVar49);
LAB_001023ae:
      if ((param_1[9] != (rcContext)0x0) &&
         (*(code **)(*(long *)param_1 + 0x30) != rcContext::doStopTimer)) {
...
LAB_00102b31:
                    uVar39 = uVar39 + 1;
                    if ((int)uVar32 <= (int)uVar39) goto LAB_00102b4b;
                  }
                  if (uVar43 == uVar3) {
                  ...
                  if (0 < (int)*(undefined8 *)(prVar44 + 0x28)) {
                    ...
                    do {
                      if (CONCAT22(0,uVar3) == *puVar18) goto LAB_00102b31;
                      puVar18 = puVar18 + 1;
            ...
            if (0 < (int)uVar42) {
              ...
              do {
                while (uVar19 = (ulong)*(int *)(*(long *)(prVar45 + 0x20) + lVar34 * 4),
                  ...
                  lVar34 = lVar34 + 1;
                  cVar14 = cVar13;
                  if ((int)uVar42 <= (int)lVar34) goto LAB_00102dea;
                }
        ...
        if (((0 < (short)uVar43) && (prVar44[9] == (rcRegion)0x0)) && (*(int *)prVar44 != 0)) {
          ...
          if (param_3 < *(int *)prVar44) {
            if (0 < iVar37) {
              ...
              piVar25 = piVar31;
              do {
                if (*piVar25 == 0) goto LAB_00103390;
                piVar25 = piVar25 + 1;
    ...
    *param_4 = uVar43;
    ...
    do {
      while (prVar44[5] != (rcRegion)0x0) {
        ...
        if (prVar44 == prVar35 + lVar34 + 0x44) goto LAB_001039b5;
      }
      prVar44 = prVar44 + 0x40;
...
LAB_001039b5:
  ...
  while( true ) {
    ...
    if (cVar14 == '\0') {
      ...
      if (uVar17 == 0x3f) goto joined_r0x00102a6f;
      uVar30 = uVar30 + 3;
...
LAB_00103540:
  ...
  if (1 < (int)lVar20) {
    do {
      ...
      do {
        iVar38 = iVar49;
        if (iVar33 <= iVar38) goto joined_r0x00102a6f;
...
joined_r0x00102a6f:
  uVar19 = uVar19 + 1;
  if ((int)uVar32 <= iVar47 + 1) goto LAB_00102bb5;
  goto LAB_00102a75;
LAB_001030c8:
  if (*(uint *)(*(long *)(prVar44 + 0x20) + uVar39 * 4) != (uint)uVar4) goto LAB_001030b8;
  iVar36 = (int)uVar19 + 1;
    ...
    do {
      ...
      if (0 < (int)*(undefined8 *)(prVar45 + 0x28)) {
        ...
        do {
          if (uVar16 == *puVar22) {
            lVar20 = lVar20 + 1;
            if ((int)uVar42 <= (int)lVar20) goto LAB_0010328f;
            goto LAB_00103240;
          }
          puVar22 = puVar22 + 1;
  ...
  *(undefined4 *)prVar44 = 0;
  ...
  if (*(long *)(prVar44 + 0x10) < 1) {
    if (*(long *)(prVar44 + 0x10) == 0) {
      ...
      if (-1 < *(long *)(prVar44 + 0x18)) goto LAB_001032af;
      lVar20 = rcAlloc(0,1);
...
LAB_0010330d:
        ...
        if (0 < iVar36) goto LAB_0010333b;
      }
      else {
        iVar36 = (int)*(undefined8 *)(prVar45 + 0x28);
        iVar37 = (int)*(undefined8 *)(prVar45 + 0x10);
        if (0 < iVar37) goto LAB_0010330d;
LAB_001037d4:
        cVar14 = '\0';
        if (iVar36 < 1) goto LAB_00103371;
LAB_0010333b:
      ...
      if (local_15c == 0) {
        ...
        do {
          *(undefined8 *)&prVar16->field_0x0 = 0;
          prVar16 = prVar16 + 0x18;
        } while (prVar16 != local_48);
        if (0 < iVar5) {
          iVar17 = 0;
          iVar22 = 0;
          if (0 < iVar34) {
...
LAB_0010451e:
        ...
        if (*(code **)(lVar13 + 0x30) != rcContext::doStopTimer) {
          ...
          if (param_1[9] == (rcContext)0x0) goto LAB_0010451e;
          lVar13 = *(long *)param_1;
        }
...
LAB_00103f68:
                ...
                if (lVar14 <= lVar13) goto LAB_001042d9;
              }
              lVar18 = (long)iVar34;
              if (__s_00[lVar18] != 0) goto LAB_00103f68;
              iVar5 = *(int *)param_2;
              ...
              __s[lVar18] = 0;
              if ((long)local_148._0_8_ < 1) goto LAB_00103f68;
              iVar34 = 0;
...
LAB_0010428c:
          ...
          if (0 < lVar14) goto LAB_00103f35;
LAB_001042d9:
          if (param_1[9] == (rcContext)0x0) goto LAB_001042fb;
          lVar13 = *(long *)param_1;
        }
        if (*(code **)(lVar13 + 0x30) != rcContext::doStopTimer) {
          uStack_200 = 0x10465c;
...
LAB_001042fb:
  ...
  if (param_1[9] != (rcContext)0x0) {
    ...
    if (pcVar6 != rcContext::doStopTimer) {
      ...
      if (param_1[9] == (rcContext)0x0) goto LAB_00104373;
      lVar13 = *(long *)param_1;
    }
    if (*(code **)(lVar13 + 0x28) != rcContext::doStartTimer) {
...
LAB_00104e97:
            ...
            if (lVar1 <= (long)local_78._8_8_) goto LAB_00104e97;
...
LAB_00104b50:
                      ...
                      *puVar16 = uVar18;
                      ...
                      if ((((short)uVar30 < 0) ||
                         ...
                         (uVar19 = uVar18, uVar30 == 0)) goto LAB_00104b50;
                    }
              ...
              do {
                while ((uVar30 = puVar15[2], 0xfffd < (ushort)(uVar30 - 1) ||
                  ...
                  *puVar15 = uVar29;
                  puVar15 = puVar14;
                  uVar29 = uVar30;
                  if (puVar16 == puVar14) goto LAB_00104c5c;
                }
                *puVar15 = uVar30;
                puVar15 = puVar15 + 4;

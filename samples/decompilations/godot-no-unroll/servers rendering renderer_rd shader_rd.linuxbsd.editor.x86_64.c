...
/* ShaderRD::_build_variant_code(StringBuilder&, unsigned int, ShaderRD::Version const*,
   ShaderRD::StageTemplate const&) */

void __thiscall
ShaderRD::_build_variant_code
          (ShaderRD *this,StringBuilder *param_1,uint param_2,Version *param_3,
          StageTemplate *param_4)
...
/* ShaderRD::set_variant_enabled(int, bool) */

void __thiscall ShaderRD::set_variant_enabled(ShaderRD *this,int param_1,bool param_2)

{
  ...
  if (*(int *)(this + 0xd8) != 0) {
    _err_print_error("set_variant_enabled","servers/rendering/renderer_rd/shader_rd.cpp",0x2cd,
                     "Condition \"version_owner.get_rid_count() > 0\" is true.",0,0);
    return;
  }
  lVar2 = (long)param_1;
...
LAB_001038c9:
  _err_print_index_error
            ("set_variant_enabled","servers/rendering/renderer_rd/shader_rd.cpp",0x2ce,lVar2,lVar1,
             "p_variant","variants_enabled.size()","",false,false);
  return;
}



/* ShaderRD::is_variant_enabled(int) const */

undefined1 __thiscall ShaderRD::is_variant_enabled(ShaderRD *this,int param_1)
...
LAB_00103971:
  _err_print_index_error
            ("is_variant_enabled","servers/rendering/renderer_rd/shader_rd.cpp",0x2d3,lVar2,lVar3,
             "p_variant","variants_enabled.size()","",false,false);
  return 0;
}
...
/* ShaderRD::is_group_enabled(int) const */

undefined1 __thiscall ShaderRD::is_group_enabled(ShaderRD *this,int param_1)
...
void __thiscall ShaderRD::ShaderRD(ShaderRD *this)

{
  ...
  *(undefined ***)this = &PTR__ShaderRD_001147d8;
  *(undefined ***)(this + 0xb8) = &PTR__RID_Alloc_001147b8;
...
/* ShaderRD::set_shader_cache_dir(String const&) */

void ShaderRD::set_shader_cache_dir(String *param_1)
...
/* ShaderRD::set_shader_cache_save_compressed(bool) */

void ShaderRD::set_shader_cache_save_compressed(bool param_1)
...
/* ShaderRD::set_shader_cache_save_compressed_zstd(bool) */

void ShaderRD::set_shader_cache_save_compressed_zstd(bool param_1)
...
/* ShaderRD::set_shader_cache_save_debug(bool) */

void ShaderRD::set_shader_cache_save_debug(bool param_1)
...
/* ShaderRD::_initialize_cache() */

void __thiscall ShaderRD::_initialize_cache(ShaderRD *this)
...
LAB_00104500:
          ...
          itos((long)&local_c0);
          operator+((char *)&local_b8,(String *)"[variant_defines:");
...
LAB_00104571:
      ...
      if (local_f0 == (Object *)0x0) {
        _err_print_error("_initialize_cache","servers/rendering/renderer_rd/shader_rd.cpp",0x32a,
                         "Condition \"d.is_null()\" is true.",0,0);
LAB_001046da:
        if (((local_f0 != (Object *)0x0) && (cVar7 = RefCounted::unreference(), cVar7 != '\0')) &&
...
LAB_0010419a:
      iVar8 = (*pcVar4)(local_f0,(String *)&local_a8);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_a8);
      pOVar5 = local_f0;
      if (iVar8 != 0) {
        ...
        pOVar5 = local_f0;
        if (iVar8 != 0) {
          _err_print_error("_initialize_cache","servers/rendering/renderer_rd/shader_rd.cpp",0x32d,
...
LAB_001042b0:
        ...
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_a8);
        if (iVar8 != 0) {
          _err_print_error("_initialize_cache","servers/rendering/renderer_rd/shader_rd.cpp",0x337,
                           "Condition \"err != OK\" is true.",0,0);
          goto LAB_001046da;
        }
      }
...
LAB_00104522:
          _err_print_index_error
                    ("operator[]","./core/templates/local_vector.h",iVar8,uVar10,uVar11,"p_index",
                     "count","",false,true);
          _err_flush_stdout();
                    /* WARNING: Does not return */
          pcVar4 = (code *)invalidInstructionException();
        ...
        operator+((char *)local_e8,(String *)"Shader \'");
      ...
      if (((local_f0 != (Object *)0x0) &&
          (cVar7 = RefCounted::unreference(), pOVar5 = local_f0, cVar7 != '\0')) &&
         (cVar7 = predelete_handler(local_f0), cVar7 != '\0')) {
...
/* ShaderRD::_add_stage(char const*, ShaderRD::StageType) */

void __thiscall ShaderRD::_add_stage(ShaderRD *this,int *param_1,int param_3)

{
  ...
  local_58 = param_1;
  String::parse_latin1((StrRange *)&local_78);
  String::split(local_108,SUB81((StrRange *)&local_78,0),0x10e758);
  lVar16 = local_78;
  if (local_78 != 0) {
    LOCK();
    plVar1 = (long *)(local_78 + -0x10);
  ...
  local_120 = 0;
  if ((local_100 == 0) ||
     (local_178 = *(ulong *)(local_100 + -8) & 0xffffffff, (int)*(ulong *)(local_100 + -8) < 1))
  goto LAB_00105209;
  uVar18 = 0;
LAB_00104b35:
  uVar10 = uVar18;
    ...
    if (cVar8 == '\0') {
      ...
      if (cVar8 != '\0') {
        ...
        String::strip_edges(SUB81((CowData<char32_t> *)&local_98,0),
                            SUB81((CowData<char32_t> *)&local_b8,0));
        String::to_upper();
      ...
      if (cVar8 == '\0') {
        ...
        String::strip_edges(SUB81((CowData<char32_t> *)&local_b8,0),
                            SUB81((CowData<char32_t> *)&local_58,0));
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
        if ((local_b8 == (int *)0x0) || (lVar16 = *(long *)(local_b8 + -2), lVar16 == 0))
        goto LAB_00104fd4;
        if (lVar16 < 1) {
          uVar10 = 0;
          goto LAB_00104e81;
        ...
        if (*local_b8 == 0x22) {
          ...
          if ((CONCAT44(uStack_94,local_98) == 0) ||
             (*(uint *)(CONCAT44(uStack_94,local_98) + -8) < 2)) {
            local_78 = 0;
            local_58 = (int *)&_LC12;
            local_50 = 1;
            String::parse_latin1((StrRange *)&local_78);
            ...
            String::split((char *)&local_58,SUB81((String *)&local_98,0),0x10e758);
...
LAB_0010585f:
                  _err_print_index_error
                            ("insert","./core/templates/cowdata.h",0xf0,uVar13,lVar16,"p_pos",
...
LAB_00104fd4:
    ...
    local_f8 = 1;
LAB_00104b7d:
    if (local_120 == 0) goto LAB_001049b8;
LAB_00104b8b:
    if (1 < *(uint *)(local_120 + -8)) {
      ...
      *(undefined8 *)(puVar3 + 4) = 0;
      if ((local_a8[0] != 0) &&
         (CowData<char>::_ref((CowData<char> *)(puVar3 + 4),(CowData *)local_a8),
         lVar16 = local_a8[0], local_a8[0] != 0)) {
        LOCK();
...
LAB_001049b8:
  ...
  *(undefined8 *)(puVar3 + 4) = 0;
  if ((local_88[0] != 0) &&
     (CowData<char>::_ref((CowData<char> *)(puVar3 + 4),(CowData *)local_88), lVar16 = local_88[0],
     local_88[0] != 0)) {
    LOCK();
...
/* ShaderRD::setup(char const*, char const*, char const*, char const*) */

void __thiscall
ShaderRD::setup(ShaderRD *this,char *param_1,char *param_2,char *param_3,char *param_4)
...
/* Error CowData<Vector<unsigned char> >::resize<false>(long) [clone .isra.0] */
    ...
    if (uVar10 != 0xffffffffffffffff) {
      if (param_1 <= lVar8) {
        ...
        while( true ) {
          ...
          if ((ulong)puVar5[-1] <= uVar7) break;
          while (puVar5[uVar7 * 2 + 1] == 0) {
            uVar7 = uVar7 + 1;
            if ((ulong)puVar5[-1] <= uVar7) goto LAB_00105fb2;
          }
          LOCK();
          plVar1 = (long *)(puVar5[uVar7 * 2 + 1] + -0x10);
          *plVar1 = *plVar1 + -1;
          UNLOCK();
          if (*plVar1 == 0) {
            lVar8 = puVar5[uVar7 * 2 + 1];
            puVar5[uVar7 * 2 + 1] = 0;
...
LAB_00105fbb:
        ...
        puVar3 = (undefined8 *)Memory::realloc_static(puVar5 + -2,uVar10 + 0x11,false);
        if (puVar3 != (undefined8 *)0x0) {
          puVar5 = puVar3 + 2;
          *puVar3 = 1;
...
LAB_00106153:
      ...
      if (uVar10 + 1 == lVar9) {
        ...
        lVar8 = puVar5[-1];
LAB_001060a8:
        if (param_1 <= lVar8) goto LAB_00106051;
      }
      else {
        if (lVar8 != 0) {
          puVar3 = (undefined8 *)
                   Memory::realloc_static((void *)(*(long *)this + -0x10),uVar10 + 0x11,false);
          if (puVar3 == (undefined8 *)0x0) goto LAB_00106153;
          puVar5 = puVar3 + 2;
          *puVar3 = 1;
          *(undefined8 **)this = puVar5;
          lVar8 = puVar3[1];
...
LAB_00106051:
  ...
  pcVar11 = "resize";
LAB_00106140:
  _err_print_error(pcVar11,"./core/templates/cowdata.h",uVar6,pcVar4,0,0);
  return;
}
...
/* ShaderRD::_allocate_placeholders(ShaderRD::Version*, int) */

void __thiscall ShaderRD::_allocate_placeholders(ShaderRD *this,Version *param_1,int param_2)

{
  HashMap<int,LocalVector<int,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,LocalVector<int,unsigned_int,false,false>>>>
  *this_00;
  long lVar1;
  code *pcVar2;
  int iVar3;
  ...
  if (*(long *)(param_1 + 0x88) == 0) {
    _err_print_error("_allocate_placeholders","servers/rendering/renderer_rd/shader_rd.cpp",0x20d,
                     "Condition \"p_version->variants.is_empty()\" is true.",0,0);
    return;
  }
  this_00 = (HashMap<int,LocalVector<int,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,LocalVector<int,unsigned_int,false,false>>>>
             *)(this + 0x40);
  uVar8 = 0;
  piVar4 = (int *)HashMap<int,LocalVector<int,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,LocalVector<int,unsigned_int,false,false>>>>
                  ::operator[](this_00,local_3c);
  if (*piVar4 != 0) {
    do {
      puVar5 = (uint *)HashMap<int,LocalVector<int,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,LocalVector<int,unsigned_int,false,false>>>>
                       ::operator[](this_00,local_3c);
      uVar10 = (ulong)*puVar5;
      if (*puVar5 <= uVar8) {
        uVar7 = (ulong)uVar8;
...
LAB_001063eb:
        _err_print_index_error
                  ("operator[]",pcVar9,iVar3,uVar7,uVar10,"p_index",pcVar11,"",false,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar2 = (code *)invalidInstructionException();
        (*pcVar2)();
...
LAB_00106438:
      ...
      if (*(long *)(lVar1 + -8) <= (long)uVar7) goto LAB_001063bd;
      uVar8 = uVar8 + 1;
...
void __thiscall
Vector<RenderingDeviceCommons::ShaderStageSPIRVData>::push_back
          (Vector<RenderingDeviceCommons::ShaderStageSPIRVData> *this,undefined4 *param_2)

{
  ...
  iVar2 = CowData<RenderingDeviceCommons::ShaderStageSPIRVData>::resize<false>
                    ((CowData<RenderingDeviceCommons::ShaderStageSPIRVData> *)(this + 8),lVar3);
  if (iVar2 == 0) {
    if (*(long *)(this + 8) == 0) {
      lVar4 = -1;
      lVar3 = 0;
      ...
      if (-1 < lVar4) {
        CowData<RenderingDeviceCommons::ShaderStageSPIRVData>::_copy_on_write
                  ((CowData<RenderingDeviceCommons::ShaderStageSPIRVData> *)(this + 8));
        ...
        *puVar1 = *param_2;
        ...
        CowData<unsigned_char>::_ref
                  ((CowData<unsigned_char> *)(puVar1 + 4),(CowData *)(param_2 + 4));
        return;
      }
    }
    _err_print_index_error
...
/* ShaderRD::_compile_variant(unsigned int, ShaderRD::CompileData) */

void ShaderRD::_compile_variant(ShaderRD *param_1,uint param_2,Version *param_3,undefined8 param_4)

{
  ...
  local_130[0] = param_4;
  puVar4 = (uint *)HashMap<int,LocalVector<int,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,LocalVector<int,unsigned_int,false,false>>>>
                   ::operator[]((HashMap<int,LocalVector<int,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,LocalVector<int,unsigned_int,false,false>>>>
                                 *)(param_1 + 0x40),(int *)local_130);
  uVar14 = (ulong)*puVar4;
  if (*puVar4 <= param_2) {
...
LAB_00107243:
    _err_print_index_error
              ("get","./core/templates/cowdata.h",0xdb,uVar10,lVar9,"p_index","size()","",false,true
              );
    _err_flush_stdout();
                    /* WARNING: Does not return */
    pcVar2 = (code *)invalidInstructionException();
  ...
  lVar9 = *(long *)(lVar12 + -8);
  if (lVar9 <= (long)uVar10) goto LAB_00107243;
  cVar16 = *(char *)(lVar12 + uVar10);
  if (cVar16 == '\0') goto LAB_00106bda;
  local_c0 = 0;
  local_120 = 0;
  local_118 = 0;
  local_148 = cVar16;
  if (param_1[0x110] == (ShaderRD)0x0) {
    ...
    local_70[4] = 0;
    local_70[5] = 0;
    _build_variant_code(param_1,(StringBuilder *)&local_78,uVar1,param_3,
                        (StageTemplate *)(param_1 + 0x148));
    StringBuilder::as_string();
    ...
    RenderingDevice::shader_compile_spirv_from_source
              ((CowData<char32_t> *)&local_98,uVar5,0,(CowData<char32_t> *)&local_118,0,&local_120,1
              );
    if (local_90 == 0) {
LAB_001072d0:
      StringBuilder::~StringBuilder((StringBuilder *)&local_78);
...
LAB_00106d9c:
    ...
    lVar12 = local_90;
    local_a8[0] = local_90;
    if (local_90 == 0) goto LAB_001072d0;
    local_148 = '\0';
...
LAB_00106d61:
      ...
      *plVar11 = *plVar11 + -1;
      ...
      StringBuilder::~StringBuilder((StringBuilder *)&local_78);
      if (param_1[0x110] != (ShaderRD)0x0) goto LAB_001067c7;
      if (local_148 != '\0') goto LAB_00107390;
      goto LAB_00106d9c;
    }
...
LAB_0010734b:
    Vector<RenderingDeviceCommons::ShaderStageSPIRVData>::push_back(local_c8);
    CowData<unsigned_char>::_unref((CowData<unsigned_char> *)local_88);
    local_148 = cVar16;
    if (lVar12 != 0) goto LAB_00106d61;
    StringBuilder::~StringBuilder((StringBuilder *)&local_78);
    if (param_1[0x110] != (ShaderRD)0x0) goto LAB_001067c7;
LAB_00107390:
    local_78 = (char *)0x0;
    ...
    uVar5 = RenderingDevice::get_singleton();
    RenderingDevice::shader_compile_spirv_from_source
              ((CowData<char32_t> *)&local_98,uVar5,1,(CowData<char32_t> *)&local_118,0,&local_120,1
              );
    if (local_90 == 0) {
...
LAB_001074e0:
      ...
      local_a8[0] = lVar12;
      CowData<unsigned_char>::_unref((CowData<unsigned_char> *)&local_90);
      if ((lVar12 == 0) || (*(long *)(lVar12 + -8) == 0)) goto LAB_001074e0;
...
LAB_0010769f:
      Vector<RenderingDeviceCommons::ShaderStageSPIRVData>::push_back
                (local_c8,(CowData<char32_t> *)&local_98);
      CowData<unsigned_char>::_unref((CowData<unsigned_char> *)local_88);
    }
    CowData<unsigned_char>::_unref((CowData<unsigned_char> *)local_a8);
    StringBuilder::~StringBuilder((StringBuilder *)&local_78);
    ...
    iVar15 = 1;
LAB_00106922:
    local_158 = (CowData<char32_t> *)&local_120;
    local_160 = (CowData<char32_t> *)&local_118;
    if (cVar16 == '\0') goto LAB_00106d9f;
    ...
    if (local_70[0] != 0) {
      ...
      if (iVar3 != 0) goto LAB_001076ef;
      uVar5 = RenderingDevice::get_singleton();
      lVar12 = *(long *)(param_3 + 0x88);
      if (lVar12 == 0) goto LAB_00107240;
      lVar9 = *(long *)(lVar12 + -8);
      if (lVar9 <= (long)uVar10) goto LAB_00107243;
      uVar5 = RenderingDevice::shader_create_from_bytecode_with_samplers
                        (uVar5,(Vector *)&local_78,*(undefined8 *)(lVar12 + uVar10 * 8),
                         param_1 + 0x80);
          ...
          *(undefined8 *)(*(long *)(param_3 + 0x88) + uVar10 * 8) = uVar5;
          ...
          if ((long)uVar10 < (long)uVar14) {
            ...
            CowData<RenderingDeviceCommons::ShaderStageSPIRVData>::_unref
                      ((CowData<RenderingDeviceCommons::ShaderStageSPIRVData> *)&local_c0);
            goto LAB_00106bda;
          }
        }
      }
...
LAB_001072b1:
      _err_print_index_error
                ("operator[]",pcVar13,iVar15,uVar10,uVar14,"p_index",pcVar18,"",false,true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
      pcVar2 = (code *)invalidInstructionException();
      (*pcVar2)();
    }
    _err_print_error("_compile_variant","servers/rendering/renderer_rd/shader_rd.cpp",0x158,
                     "Condition \"shader_data.is_empty()\" is true.",0,0);
...
LAB_001067c7:
    ...
    uVar5 = RenderingDevice::get_singleton();
    RenderingDevice::shader_compile_spirv_from_source
              ((CowData<char32_t> *)&local_98,uVar5,4,local_160,0,local_158,1);
    if (local_90 != 0) {
      CowData<unsigned_char>::_unref((CowData<unsigned_char> *)local_a8);
      lVar12 = local_90;
      local_a8[0] = local_90;
...
LAB_001076ef:
    ...
    if (*(long *)(param_1 + 0x18) == 0) goto LAB_00107240;
    ...
    String::parse_latin1((StrRange *)&local_110);
    operator+((char *)&local_108,(String *)"Error compiling ");
    ...
    _err_print_error("_compile_variant","servers/rendering/renderer_rd/shader_rd.cpp",0x14d,
                     (String *)&local_78,0,0);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_78);
    uVar14 = local_b8[0];
    if (local_b8[0] != 0) {
    ...
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_98);
    _err_print_error("_compile_variant","servers/rendering/renderer_rd/shader_rd.cpp",0x14e,
                     local_158,0,0);
    String::get_with_code_lines();
    operator+((char *)&local_78,(String *)"code:\n");
    _err_print_error("_compile_variant","servers/rendering/renderer_rd/shader_rd.cpp",0x151,
                     (String *)&local_78,0,0);
    pcVar13 = local_78;
  ...
  CowData<RenderingDeviceCommons::ShaderStageSPIRVData>::_unref
            ((CowData<RenderingDeviceCommons::ShaderStageSPIRVData> *)&local_c0);
LAB_00106bda:
  if (local_70[6] != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
  }
  return;
...
/* ShaderRD::_version_get_sha1(ShaderRD::Version*) const */

Version * ShaderRD::_version_get_sha1(Version *param_1)
...
LAB_0010789e:
    ...
    if ((pSVar7 != (StringName_conflict *)0x0) && (lVar8 = *(long *)(pSVar7 + -8), lVar8 != 0)) {
      CowData<StringName>::_copy_on_write((CowData<StringName> *)&local_90);
      pSVar7 = local_90;
      if (lVar8 != 1) {
        lVar10 = 0;
        ...
        if (lVar8 < 0x11) {
          ...
          do {
            lVar10 = lVar10 + -1;
            pSVar4 = (StringName_conflict *)
                     SortArray<StringName,StringName::AlphCompare,true>::median_of_3
                               (pSVar7,pSVar7 + (lVar11 >> 1) * 8,pSVar7 + lVar11 * 8 + -8);
            ...
            lVar5 = SortArray<StringName,StringName::AlphCompare,true>::partitioner
                              (0,lVar11,(StringName_conflict *)&local_88,pSVar7);
            if ((StringName::configured != '\0') && (local_88 != (char *)0x0)) {
              StringName::unref();
            }
            SortArray<StringName,StringName::AlphCompare,true>::introsort
                      (lVar5,lVar11,pSVar7,lVar10);
            lVar11 = 1;
            if (lVar5 < 0x11) goto LAB_00107c10;
            lVar11 = lVar5;
          } while (lVar10 != 0);
...
LAB_00107c10:
          ...
          do {
            ...
            SortArray<StringName,StringName::AlphCompare,true>::unguarded_linear_insert
                      (lVar10,(StringName_conflict *)&local_88,pSVar7);
            if ((StringName::configured != '\0') && (local_88 != (char *)0x0)) {
              StringName::unref();
            }
            lVar10 = lVar10 + 1;
      ...
      if (pSVar7 != (StringName_conflict *)0x0) {
        ...
        do {
          ...
          if (lVar10 <= lVar8) goto LAB_00107a88;
          lVar11 = lVar8 * 8;
...
LAB_00107d1e:
          ...
          ::operator[]((HashMap<StringName,CharString,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,CharString>>>
                        *)(in_RDX + 0x20),pSVar7 + lVar11);
          CharString::get_data();
          StringBuilder::append((char *)&local_78);
          pSVar7 = local_90;
  ...
  if (lVar10 != 0) {
    ...
    do {
      ...
      String::parse_latin1((StrRange *)local_a0);
      itos((long)&local_b0);
      operator+((char *)&local_a8,(String *)"[custom_defines:");
      String::operator+((String *)&local_88,(String *)&local_a8);
      StringBuilder::append((String *)&local_78);
      pcVar1 = local_88;
      if (local_88 != (char *)0x0) {
...
/* ShaderRD::_get_cache_file_path(ShaderRD::Version*, int) */

Version * ShaderRD::_get_cache_file_path(Version *param_1,int param_2)

{
  ...
  _err_print_index_error
            ("operator[]","./core/templates/local_vector.h",0xb2,(ulong)in_ECX,(ulong)uVar2,
...
/* ShaderRD::_load_from_cache(ShaderRD::Version*, int) */

undefined8 __thiscall ShaderRD::_load_from_cache(ShaderRD *this,Version *param_1,int param_2)

{
  ...
  *this_00;
  ...
  if (cVar5 == '\0') {
    ...
    if (iVar6 != 3) goto LAB_00108828;
    uVar7 = (**(code **)(*(long *)local_68 + 0x1f0))();
    this_00 = (HashMap<int,LocalVector<int,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,LocalVector<int,unsigned_int,false,false>>>>
               *)(this + 0x40);
    puVar10 = (uint *)HashMap<int,LocalVector<int,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,LocalVector<int,unsigned_int,false,false>>>>
                      ::operator[](this_00,local_7c);
    if (uVar7 != *puVar10) {
      _err_print_error("_load_from_cache","servers/rendering/renderer_rd/shader_rd.cpp",0x1cf,
                       "Condition \"variant_count != (uint32_t)group_to_variant_map[p_group].size()\" is true. Returning: false"
                       ,0,0);
      goto LAB_00108828;
    }
    if (uVar7 != 0) {
...
LAB_001088f0:
          ...
          if ((long)uVar19 < *(long *)(lVar20 + -8)) {
            if (*(char *)(lVar20 + uVar19) == '\0') goto LAB_001086f8;
            local_50 = (ulong *)0x0;
            ...
            if (uVar8 != uVar9) {
              _err_print_error("_load_from_cache","servers/rendering/renderer_rd/shader_rd.cpp",
                               0x1dd,"Condition \"br != variant_size\" is true. Returning: false",0,
                               0);
            ...
            if ((long)uVar16 <= (long)uVar19) goto LAB_00108b59;
            CowData<Vector<unsigned_char>>::_copy_on_write
                      ((CowData<Vector<unsigned_char>> *)(param_1 + 0x78));
            lVar20 = uVar19 * 0x10 + *(long *)(param_1 + 0x78);
            if (*(ulong **)(lVar20 + 8) != puVar21) {
              CowData<unsigned_char>::_ref
                        ((CowData<unsigned_char> *)(lVar20 + 8),(CowData *)&local_50);
            }
            if (puVar21 != (ulong *)0x0) {
              LOCK();
              puVar21 = puVar21 + -2;
...
LAB_001088a5:
      ...
      if ((long)uVar19 < 0) goto LAB_001088a0;
      if (lVar20 == 0) goto LAB_001088f0;
      if (*(long *)(lVar20 + -8) <= (long)uVar19) goto LAB_001088a5;
      if (*(char *)(lVar20 + uVar19) != '\0') {
        _err_print_error("_load_from_cache","servers/rendering/renderer_rd/shader_rd.cpp",0x1d4,
                         "Condition \"variant_size == 0 && variants_enabled[variant_id]\" is true. Returning: false"
                         ,0,0);
        goto LAB_00108828;
      }
LAB_001086f8:
      uVar22 = uVar22 + 1;
      if (uVar22 == uVar7) goto code_r0x0010870a;
      goto LAB_00108585;
    }
LAB_001087c6:
    ...
    _err_print_error("_load_from_cache","servers/rendering/renderer_rd/shader_rd.cpp",0x1c6,
                     "Condition \"header != String(shader_file_header)\" is true. Returning: false",
                     0,0);
LAB_00108828:
    uVar13 = 0;
  }
...
code_r0x0010870a:
  uVar22 = 0;
  __mutex = (pthread_mutex_t *)(this + 0x90);
LAB_00108714:
  uVar8 = (uint)uVar22;
  puVar10 = (uint *)HashMap<int,LocalVector<int,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,LocalVector<int,unsigned_int,false,false>>>>
                    ::operator[](this_00,local_7c);
  ...
  uVar19 = (ulong)*(int *)(*(long *)(puVar10 + 2) + uVar22 * 4);
  lVar20 = *(long *)(this + 0x28);
  if ((long)uVar19 < 0) {
    if (lVar20 == 0) {
      lVar20 = 0;
...
LAB_00108c90:
  ...
  if (lVar20 != 0) {
    if (*(long *)(lVar20 + -8) <= (long)uVar19) goto LAB_00108c90;
    if (*(char *)(lVar20 + uVar19) == '\0') {
      iVar6 = pthread_mutex_lock(__mutex);
      if (iVar6 != 0) goto LAB_00108e45;
      if (*(long *)(param_1 + 0x88) != 0) {
...
LAB_001087b4:
        uVar22 = uVar22 + 1;
        if (uVar22 == uVar7) goto LAB_001087c6;
        goto LAB_00108714;
      }
LAB_00108cdc:
      uVar16 = 0;
...
LAB_0010895a:
      _err_print_index_error
                ("operator[]",pcVar14,iVar6,uVar22,uVar16,"p_index",pcVar23,"",false,true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
      pcVar17 = (code *)invalidInstructionException();
      (*pcVar17)();
...
LAB_00108e45:
    ...
    if (lVar2 == 0) goto LAB_00108c2c;
    lVar20 = *(long *)(lVar2 + -8);
    if (lVar20 <= (long)uVar19) goto LAB_001088c7;
    lVar3 = *(long *)(param_1 + 0x78);
    if (lVar3 != 0) {
      lVar20 = *(long *)(lVar3 + -8);
      if (lVar20 <= (long)uVar19) goto LAB_001088c7;
      lVar20 = RenderingDevice::shader_create_from_bytecode_with_samplers
                         (uVar13,uVar19 * 0x10 + lVar3,*(undefined8 *)(lVar2 + uVar19 * 8),
                          this + 0x80);
      if (lVar20 != 0) {
        if (*(long *)(param_1 + 0x88) == 0) goto LAB_00108cdc;
        uVar16 = *(ulong *)(*(long *)(param_1 + 0x88) + -8);
...
LAB_00108c2c:
  ...
  goto LAB_001088c7;
LAB_00108d56:
  if (uVar8 <= (uint)uVar22) goto LAB_00108e13;
  puVar10 = (uint *)HashMap<int,LocalVector<int,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,LocalVector<int,unsigned_int,false,false>>>>
                    ::operator[](this_00,local_7c);
  uVar16 = (ulong)*puVar10;
  if (*puVar10 <= (uint)uVar22) {
...
LAB_001088c7:
    _err_print_index_error
              ("get","./core/templates/cowdata.h",0xdb,uVar19,lVar20,"p_index","size()","",false,
               true);
    _err_flush_stdout();
                    /* WARNING: Does not return */
    pcVar17 = (code *)invalidInstructionException();
  ...
  if (lVar20 == 0) goto LAB_00108ddf;
  uVar22 = uVar22 + 1;
  if (*(long *)(lVar20 + -8) <= (long)uVar19) goto LAB_00108db8;
  RenderingDevice::free(uVar13,*(undefined8 *)(lVar20 + uVar19 * 8));
  goto LAB_00108d56;
LAB_00108e13:
  _err_print_error("_load_from_cache","servers/rendering/renderer_rd/shader_rd.cpp",0x1f1,
                   "Condition \"shader.is_null()\" is true. Returning: false",0,0);
  pthread_mutex_unlock(__mutex);
  goto LAB_00108828;
}
...
/* ShaderRD::_compile_version_start(ShaderRD::Version*, int) */

void __thiscall ShaderRD::_compile_version_start(ShaderRD *this,Version *param_1,int param_2)

{
  ...
  if (lVar10 < 0) {
    ...
    lVar9 = *(long *)(lVar11 + -8);
    if (lVar9 <= lVar10) goto LAB_0010909d;
    if ((*(char *)(lVar11 + lVar10) == '\0') ||
       ((param_1[0x91] = (Version)0x0, this[0x140] != (ShaderRD)0x0 &&
        (cVar3 = _load_from_cache(this,param_1,param_2), cVar3 != '\0')))) goto LAB_0010902b;
    if ((_compile_version_start(ShaderRD::Version*,int)::{lambda()#1}::operator()()::sname == '\0')
    ...
    pCVar5 = (Callable *)
             WorkerThreadPool::get_named_pool
                       ((StringName_conflict *)
                        &_compile_version_start(ShaderRD::Version*,int)::{lambda()#1}::operator()()
                         ::sname);
    if ((_compile_version_start(ShaderRD::Version*,int)::{lambda()#2}::operator()()::sname == '\0')
    ...
    lVar11 = _compile_version_start(ShaderRD::Version*,int)::{lambda()#2}::operator()()::sname;
    if (_compile_version_start(ShaderRD::Version*,int)::{lambda()#2}::operator()()::sname == 0) {
LAB_00109199:
      local_60 = 0;
    }
      ...
      if (__s == (char *)0x0) {
        plVar1 = (long *)(*(long *)(_compile_version_start(ShaderRD::Version*,int)::{lambda()#2}::
                                    operator()()::sname + 0x10) + -0x10);
        if (*(long *)(_compile_version_start(ShaderRD::Version*,int)::{lambda()#2}::operator()()::
                      sname + 0x10) != 0) {
          do {
            lVar10 = *plVar1;
            if (lVar10 == 0) goto LAB_00109199;
            LOCK();
            lVar9 = *plVar1;
            bVar12 = lVar10 == lVar9;
            if (bVar12) {
...
LAB_00108f3e:
    piVar6 = (int *)HashMap<int,LocalVector<int,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,LocalVector<int,unsigned_int,false,false>>>>
                    ::operator[]((HashMap<int,LocalVector<int,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,LocalVector<int,unsigned_int,false,false>>>>
                                  *)(this + 0x40),local_6c);
    iVar4 = *piVar6;
    puVar7 = (undefined8 *)operator_new(0x30,"");
    *puVar7 = &PTR_callback_001147f8;
    puVar7[1] = this;
    puVar7[2] = _compile_variant;
    puVar7[3] = 0;
    puVar7[4] = param_1;
    *(int *)(puVar7 + 5) = param_2;
    local_58 = (char *)0x0;
    local_50 = 0;
    uVar8 = WorkerThreadPool::_add_group_task
                      (pCVar5,(_func_void_void_ptr_uint *)&local_58,(void *)0x0,
                       (BaseTemplateUserdata *)0x0,(int)puVar7,iVar4,true,(String *)0x1);
...
/* ShaderRD::enable_group(int) */

void __thiscall ShaderRD::enable_group(ShaderRD *this,int param_1)
      ...
      if (*(char *)(lVar7 + lVar11) == '\0') {
        ...
        *(undefined1 *)(*(long *)(this + 0x78) + lVar11) = 1;
        if (iVar2 != 0) {
          ...
          do {
            uVar3 = *(uint *)((uVar12 % (ulong)*(uint *)(this + 0xd0)) * 0xa0 +
                              *(long *)(*(long *)(this + 0xc0) +
                                       (uVar12 / *(uint *)(this + 0xd0)) * 8) + 0x98);
            if (uVar3 != 0xffffffff) {
...
LAB_001093f5:
                ...
                pVVar9 = (Version *)
                         (((uVar12 & 0xffffffff) % (ulong)*(uint *)(this + 0xd0)) * 0xa0 +
                         *(long *)(*(long *)(this + 0xc0) +
                                  ((uVar12 & 0xffffffff) / (ulong)*(uint *)(this + 0xd0)) * 8));
                if (*(int *)(pVVar9 + 0x98) != (int)(uVar12 >> 0x20)) {
                  if (0x7ffffffe < *(int *)(pVVar9 + 0x98) + 0x80000000U) goto LAB_001093f5;
              ...
              do {
                while( true ) {
                  ...
                  *(int *)*pauVar1 = *(int *)*pauVar1 + -1;
                  if (*(int *)*pauVar1 == 0) goto LAB_00109458;
                }
...
LAB_0010953d:
  _err_print_index_error
            ("enable_group","servers/rendering/renderer_rd/shader_rd.cpp",0x2d8,lVar11,lVar10,
             "p_group","group_enabled.size()","",false,false);
  return;
}



/* ShaderRD::_save_to_cache(ShaderRD::Version*, int) */

void __thiscall ShaderRD::_save_to_cache(ShaderRD *this,Version *param_1,int param_2)

{
  ...
  if (this[0x140] == (ShaderRD)0x0) {
    _err_print_error("_save_to_cache","servers/rendering/renderer_rd/shader_rd.cpp",0x1fd,
                     "Condition \"!shader_cache_dir_valid\" is true.",0,0);
  }
  else {
    _get_cache_file_path((Version *)&local_50,(int)this);
    FileAccess::open((String *)&local_48,(int)(Version *)&local_50,(Error *)0x2);
    if (local_48 == (Object *)0x0) {
      _err_print_error("_save_to_cache","servers/rendering/renderer_rd/shader_rd.cpp",0x200,
      ...
      puVar6 = (uint *)HashMap<int,LocalVector<int,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,LocalVector<int,unsigned_int,false,false>>>>
                       ::operator[]((HashMap<int,LocalVector<int,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,LocalVector<int,unsigned_int,false,false>>>>
                                     *)(this + 0x40),local_5c);
      uVar2 = *puVar6;
      ...
      if (uVar2 != 0) {
        do {
          ...
          if (*puVar6 <= (uint)uVar8) {
            _err_print_index_error
                      ("operator[]","./core/templates/local_vector.h",0xb2,uVar8,(ulong)*puVar6,
                       "p_index","count","",false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
            pcVar4 = (code *)invalidInstructionException();
...
LAB_001097b9:
          ...
          if (lVar10 == 0) goto LAB_00109800;
          if (*(long *)(lVar10 + -8) <= lVar11) goto LAB_001097b5;
          ...
          lVar3 = *(long *)(param_1 + 0x78);
          if (lVar3 == 0) goto LAB_00109800;
          lVar10 = *(long *)(lVar3 + -8);
          if (lVar10 <= lVar11) goto LAB_001097b9;
...
/* ShaderRD::_compile_version_end(ShaderRD::Version*, int) */

void __thiscall ShaderRD::_compile_version_end(ShaderRD *this,Version *param_1,int param_2)
...
LAB_00109b57:
  ...
  lVar13 = *(long *)(lVar4 + -8);
  if (lVar13 <= lVar9) goto LAB_001099df;
  if (lVar9 < 0) goto LAB_00109b57;
  if (*(long *)(lVar4 + lVar9 * 8) == 0) goto LAB_001099df;
  if ((_compile_version_end(ShaderRD::Version*,int)::{lambda()#1}::operator()()::sname == '\0') &&
     (iVar3 = __cxa_guard_acquire(&_compile_version_end(ShaderRD::Version*,int)::{lambda()#1}::
                                   operator()()::sname), iVar3 != 0)) {
    _scs_create((char *)&_compile_version_end(ShaderRD::Version*,int)::{lambda()#1}::operator()()::
                         sname,true);
    __cxa_atexit(StringName::~StringName,
                 &_compile_version_end(ShaderRD::Version*,int)::{lambda()#1}::operator()()::sname,
                 &__dso_handle);
    __cxa_guard_release(&_compile_version_end(ShaderRD::Version*,int)::{lambda()#1}::operator()()::
                         sname);
  }
  lVar4 = WorkerThreadPool::get_named_pool
                    ((StringName_conflict *)
                     &_compile_version_end(ShaderRD::Version*,int)::{lambda()#1}::operator()()::
                      sname);
  ...
  if ((long)uVar15 < 0) {
    ...
    if ((long)uVar15 < (long)uVar12) {
      ...
      *(undefined8 *)(*(long *)(param_1 + 0x68) + uVar15 * 8) = 0;
      uVar14 = 0;
      piVar5 = (int *)HashMap<int,LocalVector<int,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,LocalVector<int,unsigned_int,false,false>>>>
      ...
      if (*piVar5 != 0) {
        do {
          ...
          if (lVar9 < 0) {
            if (lVar4 == 0) goto LAB_00109b39;
LAB_00109be1:
            lVar13 = *(long *)(lVar4 + -8);
            goto LAB_00109b57;
          }
          if (lVar4 == 0) goto LAB_00109b39;
          if (*(long *)(lVar4 + -8) <= lVar9) goto LAB_00109be1;
          if (*(char *)(lVar4 + lVar9) != '\0') {
            lVar4 = *(long *)(param_1 + 0x88);
            if (lVar4 == 0) goto LAB_00109b39;
            lVar13 = *(long *)(lVar4 + -8);
            if (lVar13 <= lVar9) goto LAB_00109b57;
            if (*(long *)(lVar4 + lVar9 * 8) == 0) {
              lVar10 = *(long *)(this + 0x18);
              lVar9 = 0;
              if (lVar10 == 0) goto LAB_00109d16;
              goto LAB_00109c82;
            }
          }
          uVar14 = uVar14 + 1;
...
LAB_00109c1a:
  _err_print_index_error("operator[]",pcVar11,iVar3,uVar15,uVar12,"p_index",pcVar16,"",false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar2 = (code *)invalidInstructionException();
  (*pcVar2)();
LAB_00109c82:
  if (*(long *)(lVar10 + -8) <= lVar9) goto LAB_00109d0f;
  lVar4 = *(long *)(this + 0x28);
  if (lVar4 == 0) goto LAB_00109b39;
  lVar13 = *(long *)(lVar4 + -8);
  if (lVar13 <= lVar9) goto LAB_00109b57;
...
LAB_00109d47:
    ...
    if (*(long *)(lVar4 + -8) <= lVar7) goto LAB_00109d47;
    if (*(char *)(lVar4 + lVar7) == '\0') goto LAB_00109d02;
    lVar4 = *(long *)(param_1 + 0x88);
    if (lVar4 == 0) goto LAB_00109b39;
    lVar13 = *(long *)(lVar4 + -8);
    if (lVar13 <= lVar9) goto LAB_00109b57;
    if (*(long *)(lVar4 + lVar9 * 8) != 0) {
      ...
      if (*(long *)(param_1 + 0x88) == 0) goto LAB_00109b39;
...
LAB_00109d16:
  ...
  CowData<Vector<unsigned_char>>::resize<false>
            ((CowData<Vector<unsigned_char>> *)(param_1 + 0x78),0);
LAB_001099df:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
...
/* ShaderRD::_compile_ensure_finished(ShaderRD::Version*) */

void __thiscall ShaderRD::_compile_ensure_finished(ShaderRD *this,Version *param_1)
...
/* ShaderRD::_clear_version(ShaderRD::Version*) */

void __thiscall ShaderRD::_clear_version(ShaderRD *this,Version *param_1)
...
LAB_00109f73:
      ...
      lVar7 = *(long *)(lVar3 + -8);
      if (lVar7 <= lVar6) goto LAB_00109f73;
      if (*(long *)(lVar3 + lVar6 * 8) != 0) {
        uVar4 = RenderingDevice::get_singleton();
        if (*(long *)(param_1 + 0x88) == 0) goto LAB_00109f70;
...
LAB_00109f44:
  if ((*(long *)(param_1 + 0x78) != 0) && (*(long *)(*(long *)(param_1 + 0x78) + -8) != 0)) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ShaderRD::_initialize_version(ShaderRD::Version*) */

void __thiscall ShaderRD::_initialize_version(ShaderRD *this,Version *param_1)
...
LAB_0010a48a:
    ...
    if (lVar8 < 0) {
      _err_print_error("resize","./core/templates/cowdata.h",0x157,
                       "Condition \"p_size < 0\" is true. Returning: ERR_INVALID_PARAMETER",0,0);
LAB_0010a1a8:
      if (*(long *)(this + 0x18) == 0) goto LAB_0010a48a;
...
LAB_0010a0ae:
          if (lVar8 * 8 != 0) {
            ...
            if (lVar9 != 0) {
              if (lVar8 <= lVar10) {
                if ((lVar9 == lVar4) || (iVar3 = CowData<RID>::_realloc(this_00,lVar9), iVar3 == 0))
                {
                  if (*(long *)(param_1 + 0x88) == 0) {
                    FUN_0010f3ca();
                    return;
...
LAB_0010a150:
  ...
  CowData<Vector<unsigned_char>>::resize<false>
            ((CowData<Vector<unsigned_char>> *)(param_1 + 0x78),lVar8);
  if (*(long *)(this + 0x78) == 0) {
    lVar4 = *(long *)(param_1 + 0x68);
    if ((lVar4 == 0) || (*(long *)(lVar4 + -8) == 0)) goto LAB_0010a300;
LAB_0010a394:
    LOCK();
    plVar1 = (long *)(lVar4 + -0x10);
    *plVar1 = *plVar1 + -1;
  ...
  if (lVar4 == 0) {
    ...
    lVar10 = *(long *)(lVar4 + -8);
    if (lVar8 == lVar10) goto LAB_0010a300;
    if (lVar8 == 0) goto LAB_0010a394;
    CowData<long>::_copy_on_write((CowData<long> *)(param_1 + 0x68));
    lVar4 = lVar10 * 8;
    if (lVar4 != 0) {
      uVar5 = lVar4 - 1U | lVar4 - 1U >> 1;
            ...
            *puVar7 = 1;
            ...
            puVar7 = (undefined8 *)
                     Memory::realloc_static
                               ((void *)(*(long *)(param_1 + 0x68) + -0x10),uVar5 + 0x11,false);
            if (puVar7 == (undefined8 *)0x0) goto LAB_0010a592;
            *puVar7 = 1;
          }
          puVar7 = puVar7 + 2;
...
/* ShaderRD::version_free(RID) */

undefined8 __thiscall ShaderRD::version_free(ShaderRD *this,ulong param_2)

{
  ...
  pVVar5 = (Version *)
           (((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0xd0)) * 0xa0 +
           *(long *)(*(long *)(this + 0xc0) +
  ...
  if (param_2 != 0) {
    if (uVar6 == uVar3) goto LAB_0010a6a2;
...
LAB_0010a6a2:
  ...
  if (uVar4 < *(uint *)(this + 0xd4)) {
    ...
    uVar3 = *(uint *)(pVVar5 + 0x98);
    if ((int)uVar3 < 0) {
      _err_print_error(&_LC143,"./core/templates/rid_owner.h",0x16c,"Method/function failed.",
      ...
      *(uint *)(*(long *)(lVar1 + ((ulong)uVar3 / (ulong)*(uint *)(this + 0xd0)) * 8) +
               ((ulong)uVar3 % (ulong)*(uint *)(this + 0xd0)) * 4) = uVar4;
    }
    else {
...
/* ShaderRD::version_is_valid(RID) */

Version __thiscall ShaderRD::version_is_valid(ShaderRD *this,ulong param_2)
...
LAB_0010a892:
        ...
        if (lVar1 != 0) {
          lVar2 = 0;
          do {
            if (*(long *)(lVar1 + -8) <= lVar2) goto LAB_0010a892;
  ...
  _err_print_error("version_is_valid","servers/rendering/renderer_rd/shader_rd.cpp",0x2ae,
...
/* ShaderRD::version_set_compute_code(RID, HashMap<String, String, HashMapHasherDefault,
   ...
   const&, String const&, String const&, Vector<String> const&) */

void __thiscall
ShaderRD::version_set_compute_code
          (ShaderRD *this,ulong param_2,long param_3,undefined8 param_4,undefined8 param_5,
          long param_6)
  ...
  if (this[0x110] == (ShaderRD)0x0) {
    ...
    if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0xd4))) {
      ...
      if (*(int *)(pVVar8 + 0x98) == (int)(param_2 >> 0x20)) {
        ...
        for (puVar4 = *(undefined8 **)(param_3 + 0x18); puVar4 != (undefined8 *)0x0;
            puVar4 = (undefined8 *)*puVar4) {
          String::utf8();
          String::to_upper();
          StringName::StringName((StringName_conflict *)&local_50,(String *)&local_58,false);
          plVar5 = (long *)HashMap<StringName,CharString,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,CharString>>>
                           ::operator[]((HashMap<StringName,CharString,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,CharString>>>
                                         *)(pVVar8 + 0x20),(StringName_conflict *)&local_50);
          lVar10 = *plVar5;
          if (lVar10 != local_48) {
            if (lVar10 != 0) {
              LOCK();
...
LAB_0010b016:
      _err_print_error("version_set_compute_code","servers/rendering/renderer_rd/shader_rd.cpp",
                       uVar7,pcVar6,0,0);
      return;
    }
  }
...
void ShaderRD::version_set_code(ShaderRD *param_1,ulong param_2,long param_3)

{
  ...
  if (param_1[0x110] == (ShaderRD)0x0) {
    if ((param_2 != 0) && ((uint)param_2 < *(uint *)(param_1 + 0xd4))) {
      pVVar8 = (Version *)
               (((param_2 & 0xffffffff) % (ulong)*(uint *)(param_1 + 0xd0)) * 0xa0 +
               *(long *)(*(long *)(param_1 + 0xc0) +
                        ((param_2 & 0xffffffff) / (ulong)*(uint *)(param_1 + 0xd0)) * 8));
      if (*(int *)(pVVar8 + 0x98) == (int)(param_2 >> 0x20)) {
        lVar10 = *(long *)(param_1 + 0x78);
        for (lVar9 = 0; (lVar10 != 0 && (lVar9 < *(long *)(lVar10 + -8))); lVar9 = lVar9 + 1) {
        ...
        if (pVVar8[0x92] != (Version)0x0) {
          ...
          while (lVar10 != 0) {
            while( true ) {
              if (*(long *)(lVar10 + -8) <= lVar9) goto LAB_0010b612;
              if (*(char *)(lVar10 + lVar9) != '\0') break;
              _allocate_placeholders(param_1,pVVar8,(int)lVar9);
              lVar10 = *(long *)(param_1 + 0x78);
              lVar9 = lVar9 + 1;
              if (lVar10 == 0) goto LAB_0010b612;
            }
...
LAB_0010b612:
    ...
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      ...
      pcVar6 = "Parameter \"version\" is null.";
LAB_0010b6b6:
      _err_print_error("version_set_code","servers/rendering/renderer_rd/shader_rd.cpp",uVar7,pcVar6
                       ,0,0);
      return;
    }
  }
...

{
  ...
  *(undefined ***)this = &PTR__ShaderRD_001147d8;
  if (*(int *)(this + 0xd4) != 0) {
    ...
    uVar13 = 0;
    do {
      uVar4 = *(uint *)((uVar13 % (ulong)*(uint *)(this + 0xd0)) * 0xa0 +
                        *(long *)(*(long *)(this + 0xc0) + (uVar13 / *(uint *)(this + 0xd0)) * 8) +
                       0x98);
      if (uVar4 != 0xffffffff) {
...
LAB_0010b85d:
        ...
        _err_print_error("~ShaderRD","servers/rendering/renderer_rd/shader_rd.cpp",0x382,
                         (String *)&local_80,0,0);
        lVar12 = local_80;
        if (local_80 != 0) {
          LOCK();
        ...
        if (pauVar11 != (undefined1 (*) [16])0x0) {
          do {
            do {
              if (*(int *)pauVar11[1] == 0) goto LAB_0010bb2d;
              version_free(this);
              pvVar10 = *(void **)*pauVar11;
    ...
    if (pvVar10 != (void *)0x0) {
      if (*(uint *)pSVar14 != 0) {
        ...
        while( true ) {
          ...
          if ((StringName::configured != '\0') &&
             (*(long *)((long)pvVar10 + lVar12 * 0x18 + 8) != 0)) {
            StringName::unref();
          }
          lVar12 = lVar12 + 1;
        ...
        pvVar10 = *(void **)(pSVar14 + 8);
        *(uint *)pSVar14 = 0;
        if (pvVar10 == (void *)0x0) goto LAB_0010b908;
      }
      Memory::free_static(pvVar10,false);
    }
LAB_0010b908:
  ...
  if (pvVar10 != (void *)0x0) {
    if (*(int *)(this + 0x130) != 0) {
      ...
      *(undefined4 *)(this + 0x130) = 0;
      if (pvVar10 == (void *)0x0) goto LAB_0010b987;
    }
    Memory::free_static(pvVar10,false);
  }
LAB_0010b987:
  ...
  RID_Alloc<ShaderRD::Version,false>::~RID_Alloc
            ((RID_Alloc<ShaderRD::Version,false> *)(this + 0xb8));
  ...
  if (pvVar10 != (void *)0x0) {
    if (*(int *)(this + 0x6c) != 0) {
      ...
      if (uVar4 == 0) {
        ...
        *(undefined4 *)(this + 0x6c) = 0;
        *(undefined1 (*) [16])(this + 0x58) = (undefined1  [16])0x0;
        if (pvVar10 == (void *)0x0) goto LAB_0010baa6;
      }
    }
    Memory::free_static(pvVar10,false);
...
/* CowData<ShaderRD::VariantDefine>::_copy_on_write() [clone .isra.0] */

void __thiscall
CowData<ShaderRD::VariantDefine>::_copy_on_write(CowData<ShaderRD::VariantDefine> *this)
...
/* Vector<ShaderRD::VariantDefine>::push_back(ShaderRD::VariantDefine) [clone .isra.0] */

void __thiscall
Vector<ShaderRD::VariantDefine>::push_back
          (Vector<ShaderRD::VariantDefine> *this,undefined4 *param_2)

{
  ...
  iVar2 = CowData<ShaderRD::VariantDefine>::resize<false>
                    ((CowData<ShaderRD::VariantDefine> *)(this + 8),lVar3);
  if (iVar2 == 0) {
    if (*(long *)(this + 8) == 0) {
      lVar4 = -1;
      lVar3 = 0;
      ...
      lVar4 = lVar3 + -1;
      if (-1 < lVar4) {
        CowData<ShaderRD::VariantDefine>::_copy_on_write
                  ((CowData<ShaderRD::VariantDefine> *)(this + 8));
        puVar1 = (undefined4 *)(*(long *)(this + 8) + lVar4 * 0x18);
        *puVar1 = *param_2;
...
/* Vector<bool>::push_back(bool) [clone .isra.0] */

void __thiscall Vector<bool>::push_back(Vector<bool> *this,bool param_1)
...
void __thiscall ShaderRD::initialize(ShaderRD *this,Vector *param_1,String *param_2,Vector *param_3)
...
LAB_0010c8eb:
      _err_print_error("initialize","servers/rendering/renderer_rd/shader_rd.cpp",uVar9,pcVar7,0,0);
      return;
    }
    goto LAB_0010c968;
  }
  ...
  local_64 = 0;
  HashMap<int,LocalVector<int,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,LocalVector<int,unsigned_int,false,false>>>>
  ::insert((int *)plVar14,this_00,SUB81(&local_64,0));
  ...
  for (lVar10 = 0; (lVar6 != 0 && (lVar10 < *(long *)(lVar6 + -8))); lVar10 = lVar10 + 1) {
    ...
    if (local_60 == 0) {
      Vector<ShaderRD::VariantDefine>::push_back
                ((Vector<ShaderRD::VariantDefine> *)(this + 0x10),&local_58);
    }
    else {
      local_50 = local_60;
        ...
        *(undefined8 **)(this + 0x138) = puVar11;
        if (puVar11 == (undefined8 *)0x0) {
          _err_print_error("resize","./core/templates/local_vector.h",0xa3,
                           "FATAL: Condition \"!data\" is true.","Out of memory",0,0,auVar13._8_8_,
                           this_00,plVar14);
          _err_flush_stdout();
                    /* WARNING: Does not return */
          pcVar3 = (code *)invalidInstructionException();
        ...
        if (*(int *)(this + 0x130) != 0) goto LAB_0010c7e3;
      }
      *puVar11 = 0;
      goto LAB_0010c7e3;
    }
...
/* ShaderRD::initialize(Vector<ShaderRD::VariantDefine> const&, String const&) */

void ShaderRD::initialize(Vector *param_1,String *param_2)
...
LAB_0010ce87:
      _err_print_error("initialize","servers/rendering/renderer_rd/shader_rd.cpp",uVar24,pcVar21,0,0
                      );
      return;
    }
    goto LAB_0010d2b7;
  ...
  if (lVar22 == 0) {
    if (*(long *)(param_1 + 0x78) == 0) {
      ...
      lVar22 = 1;
LAB_0010d1db:
      CowData<bool>::_copy_on_write((CowData<bool> *)(param_1 + 0x78));
LAB_0010d1f7:
      lVar15 = 0;
LAB_0010d1fa:
      puVar20 = (undefined8 *)Memory::alloc_static(uVar23 + 0x11,false);
      if (puVar20 == (undefined8 *)0x0) {
        ...
        *(undefined8 **)(param_1 + 0x78) = puVar19;
        lVar27 = 0;
LAB_0010d194:
        __s = (Vector *)((long)puVar19 + lVar15);
        pSVar30 = (String *)0x0;
...
LAB_0010cfd0:
      ...
      if (lVar15 != 1) {
        ...
        uVar26 = 1;
LAB_0010cf2d:
        this = (CowData<bool> *)(param_1 + 0x78);
        pCVar31 = this;
        CowData<bool>::_copy_on_write(this);
        if (lVar15 == 0) goto LAB_0010d1f7;
        ...
        if (lVar15 < lVar22) {
          ...
          if (pSVar17 == pSVar30) {
            ...
            if (lVar15 == 0) goto LAB_0010d1fa;
            iVar14 = CowData<bool>::_realloc(this,(long)pSVar30);
            if (iVar14 != 0) goto LAB_0010cfd4;
            puVar19 = *(undefined8 **)(param_1 + 0x78);
          }
          goto LAB_0010d194;
        }
        if ((pSVar17 != pSVar30) &&
           (iVar14 = CowData<bool>::_realloc(this,(long)pSVar30), pCVar31 = this, iVar14 != 0))
        goto LAB_0010cfd4;
        lVar15 = *(long *)(param_1 + 0x78);
        if (lVar15 == 0) {
    ...
    for (lVar27 = 0; lVar27 < lVar15; lVar27 = lVar27 + 1) {
      ...
      if (*(long *)(puVar2 + 2) == 0) {
        ...
        Vector<ShaderRD::VariantDefine>::push_back
                  ((Vector<ShaderRD::VariantDefine> *)(param_1 + 0x10),&local_58);
      }
      else {
        do {
          lVar22 = *plVar25;
          if (lVar22 == 0) goto LAB_0010caca;
          LOCK();
          lVar15 = *plVar25;
...
LAB_0010caca:
        ...
        local_48 = *(undefined1 *)(puVar2 + 4);
        Vector<ShaderRD::VariantDefine>::push_back
                  ((Vector<ShaderRD::VariantDefine> *)(param_1 + 0x10));
        if (lVar22 != 0) {
          LOCK();
          plVar25 = (long *)(lVar22 + -0x10);
          *plVar25 = *plVar25 + -1;
...
LAB_0010cd76:
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,lVar27,lVar15,"p_index","size()","",false
                   ,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
      ...
      lVar15 = *(long *)(lVar22 + -8);
      if (lVar15 <= lVar27) goto LAB_0010cd76;
      Vector<unsigned_int>::push_back
                ((Vector<unsigned_int> *)(param_1 + 0x30),*(uint *)(lVar22 + lVar27 * 0x18));
      lVar22 = *(long *)(param_2 + 8);
      if (lVar22 == 0) goto LAB_0010cd70;
      lVar15 = *(long *)(lVar22 + -8);
      if (lVar15 <= lVar27) goto LAB_0010cd76;
      ...
      if ((*(long *)(param_1 + 0x48) != 0) && (*(int *)(param_1 + 0x6c) != 0)) {
        ...
        if (uVar13 != 0) {
          ...
          do {
            if ((uVar13 == uVar28) &&
               (uVar26 == *(uint *)(*(long *)(*(long *)(param_1 + 0x48) + lVar22 * 8) + 0x10)))
            goto LAB_0010cce2;
            uVar33 = uVar33 + 1;
            auVar5._8_8_ = 0;
            ...
            iVar14 = SUB164(auVar5 * auVar9,8);
                  ...
                  (auVar6._8_8_ = 0, auVar6._0_8_ = uVar13 * uVar23, auVar10._8_8_ = 0,
                  auVar10._0_8_ = uVar32, auVar7._8_8_ = 0,
                  auVar7._0_8_ = ((*(uint *)(hash_table_size_primes +
                                            (ulong)*(uint *)(param_1 + 0x68) * 4) + iVar14) -
                                 SUB164(auVar6 * auVar10,8)) * uVar23, auVar11._8_8_ = 0,
      ...
      local_50 = 0;
      HashMap<int,LocalVector<int,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,LocalVector<int,unsigned_int,false,false>>>>
      ::insert(local_60,(LocalVector *)(param_1 + 0x40),SUB81(puVar29,0));
      lVar22 = *(long *)(param_2 + 8);
      if (lVar22 == 0) goto LAB_0010cd70;
      lVar15 = *(long *)(lVar22 + -8);
      if (lVar15 <= lVar27) goto LAB_0010cd76;
      puVar29 = (uint *)(lVar4 + lVar22);
LAB_0010cce2:
      puVar29 = (uint *)HashMap<int,LocalVector<int,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,LocalVector<int,unsigned_int,false,false>>>>
                        ::operator[]((HashMap<int,LocalVector<int,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,LocalVector<int,unsigned_int,false,false>>>>
                                      *)(param_1 + 0x40),(int *)puVar29);
      uVar26 = *puVar29;
      if (uVar26 == puVar29[1]) {
    ...
    *(uint *)(param_1 + 0x130) = uVar26;
    ...
    if (*(uint *)(param_1 + 0x134) < uVar26) {
      ...
      *(long *)(param_1 + 0x138) = auVar35._0_8_;
      if (auVar35._0_8_ == 0) {
        _err_print_error("resize","./core/templates/local_vector.h",0xa3,
                         "FATAL: Condition \"!data\" is true.","Out of memory",0,0,auVar35._8_8_);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar12 = (code *)invalidInstructionException();
        (*pcVar12)();
      ...
      uVar13 = *(uint *)(param_1 + 0x130);
      if (uVar26 <= uVar13) goto LAB_0010d0f1;
    }
    memset((void *)(*(long *)(param_1 + 0x138) + (ulong)uVar13 * 8),0,
           (ulong)((uVar26 - 1) - uVar13) * 8 + 8);
    goto LAB_0010d0f1;
  }
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
void __thiscall
CowData<RenderingServer::ShaderNativeSourceCode::Version>::_copy_on_write
...
void __thiscall
CowData<RenderingServer::ShaderNativeSourceCode::Version::Stage>::_copy_on_write
          (CowData<RenderingServer::ShaderNativeSourceCode::Version::Stage> *this)
...
void __thiscall
Vector<RenderingServer::ShaderNativeSourceCode::Version::Stage>::push_back
          (Vector<RenderingServer::ShaderNativeSourceCode::Version::Stage> *this,CowData *param_2)

{
  ...
  iVar1 = CowData<RenderingServer::ShaderNativeSourceCode::Version::Stage>::resize<false>
                    ((CowData<RenderingServer::ShaderNativeSourceCode::Version::Stage> *)(this + 8),
                     lVar3);
  if (iVar1 != 0) {
    _err_print_error("push_back","./core/templates/vector.h",0x142,
                     "Condition \"err\" is true. Returning: true",0,0);
...
/* ShaderRD::version_get_native_source_code(RID) */

long ShaderRD::version_get_native_source_code(long param_1,ShaderRD *param_2,ulong param_3)
...
LAB_0010e050:
    *(undefined8 *)(param_1 + 8) = 0;
    ...
    pVVar12 = (Version *)
              (((param_3 & 0xffffffff) % (ulong)*(uint *)(param_2 + 0xd0)) * 0xa0 +
    ...
    if (*(int *)(pVVar12 + 0x98) == (int)(param_3 >> 0x20)) {
      ...
      *(undefined8 *)(param_1 + 8) = 0;
      ...
      if ((lVar16 * 0x10 == 0) ||
         (uVar8 = lVar16 * 0x10 - 1, uVar8 = uVar8 | uVar8 >> 1, uVar8 = uVar8 | uVar8 >> 2,
        ...
        puVar13 = *(undefined8 **)(param_1 + 8);
LAB_0010e219:
        if (puVar13 == (undefined8 *)0x0) goto LAB_0010e080;
      }
      else {
        ...
        *(undefined8 **)(param_1 + 8) = puVar13;
        ...
        do {
          puVar11[1] = 0;
          puVar11 = puVar11 + 2;
        } while (puVar9 + lVar16 * 2 + 2 != puVar11);
        puVar9[1] = lVar16;
      }
      lVar16 = 0;
      do {
        ...
        uVar15 = (uint)lVar16;
        if (param_2[0x110] != (ShaderRD)0x0) goto LAB_0010d9c4;
        local_78 = 0;
        local_70 = 0;
        local_68 = 0;
        local_60 = 0;
        ...
        local_50 = 0;
        local_48 = 0;
        _build_variant_code(param_2,(StringBuilder *)&local_78,uVar15,pVVar12,
                            (StageTemplate *)(param_2 + 0x148));
        local_88 = _LC162;
        ...
        if ((char *)local_98._8_8_ == local_88) {
          if ((char *)local_98._8_8_ == (char *)0x0) goto LAB_0010dcdd;
          LOCK();
          plVar1 = (long *)(local_98._8_8_ + -0x10);
          *plVar1 = *plVar1 + -1;
          UNLOCK();
          if (*plVar1 != 0) goto LAB_0010dcdd;
          local_88 = (char *)0x0;
          Memory::free_static(pcVar7 + -0x10,false);
          lVar14 = *(long *)(param_1 + 8);
          if (lVar14 != 0) goto LAB_0010dcea;
LAB_0010e0f0:
          lVar14 = 0;
LAB_0010e0f3:
          _err_print_index_error
                    ("operator[]","./core/templates/vector.h",0x38,lVar16,lVar14,"p_index",
                     "((Vector<T> *)(this))->_cowdata.size()","",false,true);
          _err_flush_stdout();
                    /* WARNING: Does not return */
          pcVar2 = (code *)invalidInstructionException();
...
LAB_0010dcdd:
        lVar14 = *(long *)(param_1 + 8);
        if (lVar14 == 0) goto LAB_0010e0f0;
LAB_0010dcea:
        local_d0 = (StrRange *)local_98;
        lVar14 = *(long *)(lVar14 + -8);
        if (lVar14 <= lVar16) goto LAB_0010e0f3;
        CowData<RenderingServer::ShaderNativeSourceCode::Version>::_copy_on_write(this);
        local_88 = (char *)0x0;
        pVVar10 = (Vector<RenderingServer::ShaderNativeSourceCode::Version::Stage> *)
                  (lVar16 * 0x10 + *(long *)(param_1 + 8));
        if (local_98._0_8_ != 0) {
        ...
        if (param_2[0x110] == (ShaderRD)0x0) {
          ...
          if (*(long *)(param_1 + 8) == 0) goto LAB_0010e0f0;
...
LAB_0010d9c4:
    ...
    if (0x7ffffffe < *(int *)(pVVar12 + 0x98) + 0x80000000U) goto LAB_0010e050;
    _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                     "Method/function failed. Returning: nullptr",
                     "Attempting to use an uninitialized RID",0,0);
    *(undefined8 *)(param_1 + 8) = 0;
  }
  _err_print_error("version_get_native_source_code","servers/rendering/renderer_rd/shader_rd.cpp",
                   0x165,"Parameter \"version\" is null.",0,0);
LAB_0010e080:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
...
/* ShaderRD::version_create() */

undefined8 __thiscall ShaderRD::version_create(ShaderRD *this)

{
  ...
  if (*(int *)(this + 0x6c) == 0) {
    uVar6 = 0;
    _err_print_error("version_create","servers/rendering/renderer_rd/shader_rd.cpp",0xab,
                     "Condition \"group_to_variant_map.is_empty()\" is true. Returning: RID()",0,0);
    goto LAB_0010e4fc;
  }
  local_90 = 2;
  local_48 = 0x100;
  ...
  local_50 = 0;
  local_46 = 1;
  uVar6 = RID_Alloc<ShaderRD::Version,false>::make_rid
                    ((RID_Alloc<ShaderRD::Version,false> *)(this + 0xb8),(Version *)local_d8);
  ...
  if ((void *)local_b0._0_8_ != (void *)0x0) {
    ...
    if ((local_90._4_4_ != 0) &&
       (uVar2 = *(uint *)(hash_table_size_primes + (local_90 & 0xffffffff) * 4), uVar2 != 0)) {
      lVar7 = 0;
      do {
      ...
      local_a0 = (undefined1  [16])0x0;
      if (pvVar8 == (void *)0x0) goto LAB_0010e4ac;
    }
...
void __thiscall StringName::~StringName(StringName_conflict *this)
...
/* WorkerThreadPool::GroupUserData<ShaderRD, void (ShaderRD::*)(unsigned int,
   ShaderRD::CompileData), ShaderRD::CompileData>::~GroupUserData() */

void __thiscall
WorkerThreadPool::
GroupUserData<ShaderRD,void(ShaderRD::*)(unsigned_int,ShaderRD::CompileData),ShaderRD::CompileData>
::~GroupUserData(GroupUserData<ShaderRD,void(ShaderRD::*)(unsigned_int,ShaderRD::CompileData),ShaderRD::CompileData>
                 *this)
...
/* WorkerThreadPool::GroupUserData<ShaderRD, void (ShaderRD::*)(unsigned int,
   ShaderRD::CompileData), ShaderRD::CompileData>::callback_indexed(unsigned int) */

void __thiscall
WorkerThreadPool::
GroupUserData<ShaderRD,void(ShaderRD::*)(unsigned_int,ShaderRD::CompileData),ShaderRD::CompileData>
::callback_indexed(GroupUserData<ShaderRD,void(ShaderRD::*)(unsigned_int,ShaderRD::CompileData),ShaderRD::CompileData>
                   *this,uint param_1)
    ...
    UNRECOVERED_JUMPTABLE =
         *(code **)(UNRECOVERED_JUMPTABLE +
                   *(long *)(*(long *)(this + 0x18) + *(long *)(this + 8)) + -1);
                    ...
                    /* WARNING: Could not recover jumptable at 0x0010e6af. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*UNRECOVERED_JUMPTABLE)
            ((long *)(*(long *)(this + 0x18) + *(long *)(this + 8)),param_1,
             *(undefined8 *)(this + 0x20),*(undefined8 *)(this + 0x28),UNRECOVERED_JUMPTABLE);
  return;
}
...
/* Error CowData<Vector<unsigned char> >::resize<false>(long) [clone .isra.0] [clone .cold] */

void CowData<Vector<unsigned_char>>::resize<false>(long param_1)
...
/* ShaderRD::_load_from_cache(ShaderRD::Version*, int) [clone .cold] */

void ShaderRD::_load_from_cache(Version *param_1,int param_2)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ShaderRD::_initialize_version(ShaderRD::Version*) [clone .cold] */

void ShaderRD::_initialize_version(Version *param_1)
...
/* CowData<ShaderRD::VariantDefine>::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<ShaderRD::VariantDefine>::_copy_on_write(void)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ShaderRD::initialize(Vector<ShaderRD::VariantDefine> const&, String const&) [clone .cold] */
...
void CowData<RenderingServer::ShaderNativeSourceCode::Version>::_copy_on_write(void)
...
void CowData<RenderingServer::ShaderNativeSourceCode::Version::Stage>::_copy_on_write(void)
...
/* WARNING: Removing unreachable block (ram,0x0010f8c0) */
/* WARNING: Removing unreachable block (ram,0x0010fa39) */
/* WARNING: Removing unreachable block (ram,0x0010f8cc) */
/* WARNING: Removing unreachable block (ram,0x0010f8d6) */
/* WARNING: Removing unreachable block (ram,0x0010fa1b) */
/* WARNING: Removing unreachable block (ram,0x0010f8e2) */
/* WARNING: Removing unreachable block (ram,0x0010f8ec) */
/* WARNING: Removing unreachable block (ram,0x0010f9fd) */
/* WARNING: Removing unreachable block (ram,0x0010f8f8) */
/* WARNING: Removing unreachable block (ram,0x0010f902) */
/* WARNING: Removing unreachable block (ram,0x0010f9df) */
/* WARNING: Removing unreachable block (ram,0x0010f90e) */
/* WARNING: Removing unreachable block (ram,0x0010f918) */
/* WARNING: Removing unreachable block (ram,0x0010f9c1) */
/* WARNING: Removing unreachable block (ram,0x0010f924) */
/* WARNING: Removing unreachable block (ram,0x0010f92e) */
/* WARNING: Removing unreachable block (ram,0x0010f9a3) */
/* WARNING: Removing unreachable block (ram,0x0010f936) */
/* WARNING: Removing unreachable block (ram,0x0010f940) */
/* WARNING: Removing unreachable block (ram,0x0010f988) */
/* WARNING: Removing unreachable block (ram,0x0010f948) */
/* WARNING: Removing unreachable block (ram,0x0010f95e) */
/* WARNING: Removing unreachable block (ram,0x0010f96a) */
...
LAB_0010fed0:
  ...
  if (uVar6 == 0xffffffffffffffff) goto LAB_0010fed0;
  if (param_1 <= lVar9) {
...
LAB_0010fd59:
        if (uVar6 + 1 != lVar5) {
          ...
          if (puVar4 == (undefined8 *)0x0) goto LAB_0010feff;
          puVar7 = puVar4 + 2;
          *puVar4 = 1;
      ...
      while( true ) {
        ...
        if (*plVar2 != 0) break;
        uVar8 = uVar8 + 1;
        if ((ulong)puVar7[-1] <= uVar8) goto LAB_0010fd59;
      }
      LOCK();
      plVar1 = (long *)(*plVar2 + -0x10);
      *plVar1 = *plVar1 + -1;
...
LAB_0010ff4d:
  ...
  if (uVar6 + 1 == lVar5) {
    puVar7 = *(undefined8 **)this;
    if (puVar7 == (undefined8 *)0x0) goto LAB_0010ff4d;
    lVar9 = puVar7[-1];
LAB_0010fe30:
    if (param_1 <= lVar9) goto LAB_0010fde5;
  }
  else {
    if (lVar9 != 0) {
      puVar4 = (undefined8 *)
...
LAB_001102b0:
  ...
  if (uVar4 == 0xffffffffffffffff) goto LAB_001102b0;
  if (param_1 <= lVar7) {
    puVar5 = *(undefined8 **)this;
    uVar6 = param_1;
...
LAB_0011015a:
        if (uVar4 + 1 != lVar3) {
          ...
          if (puVar2 == (undefined8 *)0x0) goto LAB_001102df;
          puVar5 = puVar2 + 2;
          *puVar2 = 1;
          *(undefined8 **)this = puVar5;
        }
      ...
      while ((StringName::configured == '\0' || (puVar5[uVar6] == 0))) {
        uVar6 = uVar6 + 1;
        if ((ulong)puVar5[-1] <= uVar6) goto LAB_0011015a;
      }
      uVar6 = uVar6 + 1;
      StringName::unref();
      puVar5 = *(undefined8 **)this;
...
LAB_0011012a:
  ...
  if (uVar4 + 1 == lVar3) {
    puVar5 = *(undefined8 **)this;
    if (puVar5 == (undefined8 *)0x0) goto LAB_0011012a;
    lVar7 = puVar5[-1];
LAB_00110210:
    if (param_1 <= lVar7) goto LAB_001101bd;
  }
  else {
    if (lVar7 != 0) {
      puVar2 = (undefined8 *)
...
/* ShaderRD::Version::~Version() */

void __thiscall ShaderRD::Version::~Version(Version *this)
  ...
  if (pvVar5 != (void *)0x0) {
    if (*(int *)(this + 0x4c) != 0) {
      ...
      if (uVar2 == 0) {
        ...
        *(undefined4 *)(this + 0x4c) = 0;
        *(undefined1 (*) [16])(this + 0x38) = (undefined1  [16])0x0;
        if (pvVar5 == (void *)0x0) goto LAB_001106f1;
      }
    }
    Memory::free_static(pvVar5,false);
    Memory::free_static(*(void **)(this + 0x30),false);
...
void __thiscall
RID_Alloc<ShaderRD::Version,false>::~RID_Alloc(RID_Alloc<ShaderRD::Version,false> *this)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  *(undefined ***)this = &PTR__RID_Alloc_001147b8;
  if (uVar2 == 0) {
    uVar6 = (ulong)*(uint *)(this + 0x1c);
    uVar8 = (ulong)*(uint *)(this + 0x18);
    puVar10 = *(undefined8 **)(this + 8);
LAB_00110baa:
    if ((uint)uVar6 < (uint)uVar8) goto LAB_00110beb;
    lVar12 = 0;
    while( true ) {
    ...
    if (local_58 == (char *)0x0) {
LAB_0011093b:
      if (local_60 == 0) goto LAB_00110951;
LAB_00110945:
      lVar12 = local_60;
      LOCK();
      ...
      *plVar7 = *plVar7 + -1;
      UNLOCK();
      if (*plVar7 != 0) goto LAB_0011093b;
      local_58 = (char *)0x0;
      Memory::free_static(pcVar5 + -0x10,false);
      if (local_60 != 0) goto LAB_00110945;
LAB_00110951:
      iVar3 = *(int *)(this + 0x1c);
      uVar2 = *(uint *)(this + 0x18);
      puVar10 = *(undefined8 **)(this + 8);
          ...
          if (pvVar9 != (void *)0x0) {
            if (*(int *)((long)plVar7 + 0x4c) != 0) {
              ...
              if (uVar2 == 0) {
                ...
                *(undefined4 *)((long)plVar7 + 0x4c) = 0;
                *(undefined1 (*) [16])(plVar7 + 7) = (undefined1  [16])0x0;
                if (pvVar9 == (void *)0x0) goto LAB_00110ae3;
              }
            }
            Memory::free_static(pvVar9,false);
...
/* HashMap<int, LocalVector<int, unsigned int, false, false>, HashMapHasherDefault,
   ...
   unsigned int, false, false> > > >::_resize_and_rehash(unsigned int) */
...
/* HashMap<int, LocalVector<int, unsigned int, false, false>, HashMapHasherDefault,
   HashMapComparatorDefault<int>, DefaultTypedAllocator<HashMapElement<int, LocalVector<int,
   unsigned int, false, false> > > >::operator[](int const&) */
...
LAB_00111475:
    ...
    uVar31 = *param_1;
    iVar39 = *(int *)(this + 0x2c);
    if (__s_00 != (void *)0x0) goto LAB_00111475;
  }
  else {
    iVar39 = *(int *)(this + 0x2c);
    if (iVar39 == 0) {
      ...
      if (uVar29 != 0) {
        ...
        do {
          ...
          uVar44 = SUB164(auVar5 * auVar17,8);
                ...
                auVar7._0_8_ = ((uVar30 + uVar44) - SUB164(auVar6 * auVar18,8)) * uVar2,
...
LAB_00111144:
      ...
      if (uVar30 != 0) {
        ...
        do {
          if ((uVar29 == uVar30) &&
             (*(uint *)(*(long *)((long)__s_00 + lVar36 * 8) + 0x10) == uVar31)) {
          ...
          uVar43 = SUB164(auVar9 * auVar21,8);
                ...
                , lStack_78 = SUB168(auVar11 * auVar23,8), uVar44 <= SUB164(auVar11 * auVar23,8)));
      }
    }
  }
  ...
  *(undefined1 (**) [16])(this + 0x20) = pauVar32;
  ...
  lStack_78 = SUB168(auVar12 * auVar24,8);
  lVar37 = *(long *)(this + 8);
  ...
  *(undefined1 (**) [16])(lVar37 + lStack_78 * 8) = pauVar28;
  *puVar1 = uVar31;
  *(int *)(this + 0x2c) = *(int *)(this + 0x2c) + 1;
LAB_001113cc:
  auVar47._8_8_ = lStack_78;
...
void HashMap<int,LocalVector<int,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,LocalVector<int,unsigned_int,false,false>>>>
     ::insert(int *param_1,LocalVector *param_2,bool param_3)

{
  ...
  if (pvVar26 == (void *)0x0) {
    ...
    *(void **)(param_2 + 8) = pvVar26;
    ...
    iVar28 = *(int *)(param_2 + 0x2c);
    local_68 = *puVar29;
    if (pvVar26 != (void *)0x0) goto LAB_001115b2;
  }
  else {
LAB_001115a4:
    iVar28 = *(int *)(param_2 + 0x2c);
...
LAB_001115b2:
    if (iVar28 != 0) {
      ...
      if (uVar20 != 0) {
        uVar20 = 0;
        do {
          if (((uint)uVar30 == uVar36) &&
             (*(uint *)(*(long *)((long)pvVar26 + lVar31 * 8) + 0x10) == local_68)) {
          ...
          uVar34 = SUB164(auVar3 * auVar11,8);
                ...
                (auVar4._8_8_ = 0, auVar4._0_8_ = uVar30 * uVar33, auVar12._8_8_ = 0,
                auVar12._0_8_ = uVar35, auVar5._8_8_ = 0,
                auVar5._0_8_ = ((*(uint *)(hash_table_size_primes +
                                          (ulong)*(uint *)(param_2 + 0x28) * 4) + uVar34) -
                               SUB164(auVar4 * auVar12,8)) * uVar33, auVar13._8_8_ = 0,
                auVar13._0_8_ = uVar35, uVar20 <= SUB164(auVar5 * auVar13,8)));
      }
    }
  }
  if ((float)uVar21 * __LC88 < (float)(iVar28 + 1)) {
    ...
    _resize_and_rehash((HashMap<int,LocalVector<int,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,LocalVector<int,unsigned_int,false,false>>>>
  ...
  if (uVar21 == 0) {
    ...
    *pauVar24 = (undefined1  [16])0x0;
    ...
    pvVar26 = (void *)Memory::realloc_static
                                ((void *)0x0,(ulong)((uVar36 | uVar36 >> 0x10) + 1) << 2,false);
    if (pvVar26 == (void *)0x0) {
LAB_00111ba8:
      _err_print_error("resize","./core/templates/local_vector.h",0xa3,
                       "FATAL: Condition \"!data\" is true.","Out of memory",0,0);
...
LAB_00111f98:
  ...
  if (uVar7 == 0xffffffffffffffff) goto LAB_00111f98;
  if (param_1 <= lVar9) {
    puVar5 = *(undefined8 **)this;
    uVar8 = param_1;
    while (puVar5 != (undefined8 *)0x0) {
...
LAB_00111df9:
        if (uVar7 + 1 != lVar6) {
          ...
          if (puVar4 == (undefined8 *)0x0) goto LAB_00111fc7;
          puVar5 = puVar4 + 2;
          *puVar4 = 1;
          *(undefined8 **)this = puVar5;
        }
      ...
      while (puVar5[uVar8 * 3 + 2] == 0) {
        uVar8 = uVar8 + 1;
        if ((ulong)puVar5[-1] <= uVar8) goto LAB_00111df9;
      }
      LOCK();
...
LAB_00112015:
  ...
  if (uVar7 + 1 == lVar6) {
    puVar5 = *(undefined8 **)this;
    if (puVar5 == (undefined8 *)0x0) goto LAB_00112015;
    lVar9 = puVar5[-1];
LAB_00111ef0:
    if (param_1 <= lVar9) goto LAB_00111e9f;
  }
  else {
    if (lVar9 != 0) {
      puVar4 = (undefined8 *)
...
LAB_001123bd:
    ...
    iVar35 = *(int *)(this + 0x2c);
    if (__s_00 == (void *)0x0) goto LAB_001124bc;
    if (*(int *)(this + 0x2c) != 0) goto LAB_001123bd;
LAB_001124de:
    if (*(int *)(this + 0x28) == 0x1c) {
      _err_print_error("_insert","./core/templates/hash_map.h",0xdd,
                       "Condition \"capacity_index + 1 == HASH_TABLE_SIZE_MAX\" is true. Returning: nullptr"
      ...
      lVar34 = 0;
LAB_00112358:
      local_88 = (CowData<char> *)(lVar34 + 0x18);
      goto LAB_00112361;
    }
    _resize_and_rehash(this,*(int *)(this + 0x28) + 1);
  }
    ...
    if (*(int *)(this + 0x2c) != 0) {
      ...
      if (lVar34 == 0) goto LAB_00112798;
      goto LAB_001123b1;
    }
    local_70 = 0;
    iVar35 = 0;
LAB_001124bc:
    if ((float)uVar43 * __LC88 < (float)(iVar35 + 1)) goto LAB_001124de;
  }
  local_68 = (undefined1  [16])0x0;
  StringName::StringName((StringName_conflict *)&local_58,param_1);
  local_50[0] = 0;
  puVar31 = (undefined8 *)operator_new(0x20,"");
  *puVar31 = local_68._0_8_;
  puVar31[1] = local_68._8_8_;
  StringName::StringName((StringName_conflict *)(puVar31 + 2),(StringName_conflict *)&local_58);
  puVar31[3] = 0;
  local_88 = (CowData<char> *)(puVar31 + 3);
  if ((local_50[0] == 0) ||
     (CowData<char>::_ref(local_88,(CowData *)local_50), lVar34 = local_50[0], local_50[0] == 0)) {
    lVar37 = 0;
  }
  else {
    LOCK();
...
LAB_00112b50:
  ...
  uVar6 = uVar6 | uVar6 >> 0x10;
  uVar6 = uVar6 | uVar6 >> 0x20;
  if (uVar6 == 0xffffffffffffffff) goto LAB_00112b50;
  if (param_1 <= lVar9) {
    puVar7 = *(undefined8 **)this;
    uVar8 = param_1;
    while (puVar7 != (undefined8 *)0x0) {
...
LAB_001129d9:
        if (uVar6 + 1 != lVar5) {
          puVar4 = (undefined8 *)Memory::realloc_static(puVar7 + -2,uVar6 + 0x11,false);
          if (puVar4 == (undefined8 *)0x0) goto LAB_00112b7f;
          puVar7 = puVar4 + 2;
          *puVar4 = 1;
          *(undefined8 **)this = puVar7;
        }
      ...
      while( true ) {
        ...
        if (*plVar2 != 0) break;
        uVar8 = uVar8 + 1;
        if ((ulong)puVar7[-1] <= uVar8) goto LAB_001129d9;
      }
      LOCK();
      plVar1 = (long *)(*plVar2 + -0x10);
      *plVar1 = *plVar1 + -1;
...
LAB_00112bcd:
  ...
  if (uVar6 + 1 == lVar5) {
    puVar7 = *(undefined8 **)this;
    if (puVar7 == (undefined8 *)0x0) goto LAB_00112bcd;
    lVar9 = puVar7[-1];
LAB_00112ab0:
    if (param_1 <= lVar9) goto LAB_00112a65;
  }
  else {
    if (lVar9 != 0) {
      puVar4 = (undefined8 *)
...
/* CowData<ShaderRD::VariantDefine>::_unref() */

void __thiscall CowData<ShaderRD::VariantDefine>::_unref(CowData<ShaderRD::VariantDefine> *this)
...
/* Error CowData<ShaderRD::VariantDefine>::resize<false>(long) */

undefined8 __thiscall
CowData<ShaderRD::VariantDefine>::resize<false>(CowData<ShaderRD::VariantDefine> *this,long param_1)
...
LAB_00112f98:
  ...
  uVar7 = uVar7 | uVar7 >> 0x10;
  uVar7 = uVar7 | uVar7 >> 0x20;
  if (uVar7 == 0xffffffffffffffff) goto LAB_00112f98;
  if (param_1 <= lVar9) {
    puVar5 = *(undefined8 **)this;
    uVar8 = param_1;
    while (puVar5 != (undefined8 *)0x0) {
...
LAB_00112df9:
        if (uVar7 + 1 != lVar6) {
          puVar4 = (undefined8 *)Memory::realloc_static(puVar5 + -2,uVar7 + 0x11,false);
          if (puVar4 == (undefined8 *)0x0) goto LAB_00112fc7;
          puVar5 = puVar4 + 2;
          *puVar4 = 1;
          *(undefined8 **)this = puVar5;
        }
      ...
      while (puVar5[uVar8 * 3 + 1] == 0) {
        uVar8 = uVar8 + 1;
        if ((ulong)puVar5[-1] <= uVar8) goto LAB_00112df9;
      }
      LOCK();
...
LAB_00113015:
  ...
  if (uVar7 + 1 == lVar6) {
    puVar5 = *(undefined8 **)this;
    if (puVar5 == (undefined8 *)0x0) goto LAB_00113015;
    lVar9 = puVar5[-1];
LAB_00112ef0:
    if (param_1 <= lVar9) goto LAB_00112ea3;
  }
  else {
    if (lVar9 != 0) {
      puVar4 = (undefined8 *)
  ...
  if (param_1 * 4 != 0) {
    ...
    if (uVar4 != 0xffffffffffffffff) {
      if (lVar7 < param_1) {
        if (uVar4 + 1 == lVar3) {
          puVar5 = *(undefined8 **)this;
          if (puVar5 == (undefined8 *)0x0) goto LAB_001131b9;
        }
        else {
          if (lVar7 == 0) {
            ...
            *puVar5 = 1;
            ...
            puVar5 = (undefined8 *)
                     Memory::realloc_static((void *)(*(long *)this + -0x10),uVar4 + 0x11,false);
            if (puVar5 == (undefined8 *)0x0) goto LAB_001132a0;
            *puVar5 = 1;
          }
          puVar5 = puVar5 + 2;
          *(undefined8 **)this = puVar5;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Error CowData<bool>::resize<false>(long) */

undefined8 __thiscall CowData<bool>::resize<false>(CowData<bool> *this,long param_1)
...
/* CowData<RenderingServer::ShaderNativeSourceCode::Version::Stage>::_unref() */
...
/* Error CowData<RenderingServer::ShaderNativeSourceCode::Version::Stage>::resize<false>(long) */

undefined8 __thiscall
CowData<RenderingServer::ShaderNativeSourceCode::Version::Stage>::resize<false>
          (CowData<RenderingServer::ShaderNativeSourceCode::Version::Stage> *this,long param_1)
...
LAB_001139f0:
  ...
  if (uVar9 == 0xffffffffffffffff) goto LAB_001139f0;
  uVar10 = param_1;
  if (param_1 <= lVar7) {
    while (puVar6 = *(undefined8 **)this, puVar6 != (undefined8 *)0x0) {
      if ((ulong)puVar6[-1] <= uVar10) {
        if (uVar9 + 1 != lVar8) {
          puVar4 = (undefined8 *)Memory::realloc_static(puVar6 + -2,uVar9 + 0x11,false);
          if (puVar4 == (undefined8 *)0x0) goto LAB_00113a1f;
          puVar6 = puVar4 + 2;
          *puVar4 = 1;
...
LAB_00113a6d:
  ...
  if (uVar9 + 1 == lVar8) {
    ...
    if (puVar6 == (undefined8 *)0x0) goto LAB_00113a6d;
    lVar7 = puVar6[-1];
LAB_00113951:
    if (param_1 <= lVar7) goto LAB_0011385c;
  }
  else {
    if (lVar7 != 0) {
      puVar4 = (undefined8 *)
...
LAB_00113a1f:
  ...
  pauVar5 = (undefined1 (*) [16])(puVar6 + lVar7 * 2);
  do {
    *pauVar5 = (undefined1  [16])0x0;
    pauVar5 = pauVar5 + 1;
  } while ((undefined1 (*) [16])(puVar6 + param_1 * 2) != pauVar5);
LAB_0011385c:
  puVar6[-1] = param_1;
  return 0;
}
...

{
  ...
  if (*(long *)(param_2 + 8) == 0) {
    ...
    *(void **)(param_2 + 8) = __s_00;
    ...
    iVar28 = *(int *)(param_2 + 0x2c);
    if (__s_00 == (void *)0x0) goto LAB_00113be9;
    if (*(int *)(param_2 + 0x2c) != 0) goto LAB_00113ade;
LAB_00113c0b:
    if (*(int *)(param_2 + 0x28) == 0x1c) {
      _err_print_error("_insert","./core/templates/hash_map.h",0xdd,
                       "Condition \"capacity_index + 1 == HASH_TABLE_SIZE_MAX\" is true. Returning: nullptr"
    ...
    _resize_and_rehash((HashMap<StringName,CharString,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,CharString>>>
                        *)param_2,*(int *)(param_2 + 0x28) + 1);
  }
  else {
LAB_00113ad2:
...
LAB_00113be9:
    if ((float)uVar23 * __LC88 < (float)(iVar28 + 1)) goto LAB_00113c0b;
  }
  ...
  *local_80 = 0;
  ...
  local_80[3] = 0;
  if ((local_50[0] != 0) &&
     (CowData<char>::_ref((CowData<char> *)(local_80 + 3),(CowData *)local_50), lVar25 = local_50[0]
     , local_50[0] != 0)) {
    LOCK();
    plVar1 = (long *)(local_50[0] + -0x10);
    *plVar1 = *plVar1 + -1;
...
/* ShaderRD::Version::Version(ShaderRD::Version const&) */

void __thiscall ShaderRD::Version::Version(Version *this,Version *param_1)

{
  ...
  *(undefined8 *)(this + 8) = 0;
  if (*(long *)(param_1 + 8) != 0) {
    CowData<char>::_ref((CowData<char> *)(this + 8),(CowData *)(param_1 + 8));
  }
  *(undefined8 *)(this + 0x10) = 0;
  if (*(long *)(param_1 + 0x10) != 0) {
    CowData<char>::_ref((CowData<char> *)(this + 0x10),(CowData *)(param_1 + 0x10));
  }
  *(undefined8 *)(this + 0x18) = 0;
  if (*(long *)(param_1 + 0x18) != 0) {
    CowData<char>::_ref((CowData<char> *)(this + 0x18),(CowData *)(param_1 + 0x18));
  }
...
LAB_001140f0:
  if ((*(int *)(param_1 + 0x4c) != 0) &&
    ...
    do {
      HashMap<StringName,CharString,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,CharString>>>
      ::insert(aSStack_38,this + 0x20,(bool)((char)plVar4 + '\x10'));
      plVar4 = (long *)*plVar4;
...
LAB_0011423c:
  *(undefined2 *)(this + 0x90) = *(undefined2 *)(param_1 + 0x90);
...
/* RID_Alloc<ShaderRD::Version, false>::make_rid(ShaderRD::Version const&) */

ulong __thiscall
RID_Alloc<ShaderRD::Version,false>::make_rid
          (RID_Alloc<ShaderRD::Version,false> *this,Version *param_1)

{
  ...
  if (uVar8 != 0x7fffffff) {
    ...
    *(uint *)((uVar15 % (ulong)uVar6) * 0xa0 + *(long *)(lVar14 + (uVar15 / uVar6) * 8) + 0x98) =
         uVar8 | 0x80000000;
    *(int *)(this + 0x20) = *(int *)(this + 0x20) + 1;
    uVar12 = CONCAT44(uVar7,uVar9) & 0x7fffffffffffffff;
    if ((uVar12 != 0) && ((uint)uVar12 < *(uint *)(this + 0x1c))) {
      this_00 = (Version *)
                ((uVar15 % (ulong)*(uint *)(this + 0x18)) * 0xa0 +
...
void ShaderRD::_GLOBAL__sub_I__add_stage(void)

...

{
  ...
  *(undefined ***)this = &PTR_poll_events_0010cbe8;
...

{
  ...
  *(undefined ***)this_00 = &PTR__initialize_classv_0010ca70;
...
{
  *(undefined ***)this = &PTR__initialize_classv_0010ca70;
...
LAB_0010c9cf:
            ...
            lVar15 = puVar14[-1];
            if (lVar15 < (long)uVar9) goto LAB_0010c926;
          }
          else {
            if (lVar13 != 0) {
              iVar6 = CowData<ScriptLanguage::StackInfo>::_realloc(local_50,lVar15);
...
LAB_0010c7b6:
      ...
      if (lVar10 <= (long)uVar9) goto LAB_0010c7b6;

...
/* CowData<GodotCollisionObject3D::Shape>::_copy_on_write() [clone .isra.0] */

void __thiscall
CowData<GodotCollisionObject3D::Shape>::_copy_on_write(CowData<GodotCollisionObject3D::Shape> *this)
...
/* GodotCollisionObject3D::_update_shapes() [clone .part.0] */

void __thiscall GodotCollisionObject3D::_update_shapes(GodotCollisionObject3D *this)
  ...
  if (lVar7 != 0) {
    ...
    do {
      while( true ) {
        ...
        CowData<GodotCollisionObject3D::Shape>::_copy_on_write
                  ((CowData<GodotCollisionObject3D::Shape> *)(this + 0x38));
        lVar7 = *(long *)(this + 0x38);
        ...
        fVar13 = (float)((double)(*(float *)(lVar8 + 0x70) + *(float *)(lVar8 + 0x74)) * __LC4 *
                        __LC5);
...
/* GodotCollisionObject3D::_shape_changed() */

void __thiscall GodotCollisionObject3D::_shape_changed(GodotCollisionObject3D *this)
...
/* GodotCollisionObject3D::set_shape(int, GodotShape3D*) */

void __thiscall
GodotCollisionObject3D::set_shape(GodotCollisionObject3D *this,int param_1,GodotShape3D *param_2)
...
LAB_001004fd:
  _err_print_index_error
            ("set_shape","modules/godot_physics_3d/godot_collision_object_3d.cpp",0x34,lVar3,lVar5,
...
/* GodotCollisionObject3D::set_shape_transform(int, Transform3D const&) */

void __thiscall
GodotCollisionObject3D::set_shape_transform
          (GodotCollisionObject3D *this,int param_1,Transform3D *param_2)
...
LAB_001007ab:
  ...
  _err_print_index_error
            ("set_shape_transform","modules/godot_physics_3d/godot_collision_object_3d.cpp",0x3f,
...
/* GodotCollisionObject3D::set_shape_disabled(int, bool) */

void __thiscall
GodotCollisionObject3D::set_shape_disabled(GodotCollisionObject3D *this,int param_1,bool param_2)

{
  ...
  if (param_1 < 0) {
    ...
    if (lVar3 < lVar4) {
      ...
      if (((bool)*(char *)(lVar4 + 0x88) != param_2) &&
         (lVar3 = *(long *)(this + 0x40), *(bool *)(lVar4 + 0x88) = param_2, lVar3 != 0)) {
        if (param_2) {
          if (*(int *)(lVar4 + 0x60) == 0) {
            return;
          }
...
LAB_00100919:
  _err_print_index_error
            ("set_shape_disabled","modules/godot_physics_3d/godot_collision_object_3d.cpp",0x49,
             lVar3,lVar4,"p_idx","shapes.size()","",false,false);
  return;
}



/* GodotCollisionObject3D::_set_static(bool) */

void __thiscall GodotCollisionObject3D::_set_static(GodotCollisionObject3D *this,bool param_1)

{
  ...
  if ((*(long *)(this + 0x40) != 0) && (lVar2 = *(long *)(this + 0x38), lVar2 != 0)) {
    lVar4 = 0;
    do {
      while( true ) {
        lVar5 = *(long *)(lVar2 + -8);
...
void __thiscall GodotCollisionObject3D::_unregister_shapes(GodotCollisionObject3D *this)
...
/* GodotCollisionObject3D::_update_shapes_with_motion(Vector3 const&) */

void __thiscall
GodotCollisionObject3D::_update_shapes_with_motion(GodotCollisionObject3D *this,Vector3 *param_1)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((*(long *)(this + 0x40) != 0) && (lVar6 = *(long *)(this + 0x38), lVar6 != 0)) {
    uVar8 = 0;
    do {
      while( true ) {
        ...
        local_98 = CONCAT44((float)((ulong)*(undefined8 *)param_1 >> 0x20) + fVar12,
                            (float)*(undefined8 *)param_1 + (float)local_e0);
        fStack_8c = fStack_ac;
        fStack_88 = fStack_a8;
        fStack_84 = fStack_a4;
...
/* GodotCollisionObject3D::_set_space(GodotSpace3D*) */

void __thiscall
GodotCollisionObject3D::_set_space(GodotCollisionObject3D *this,GodotSpace3D *param_1)

{
  ...
  *(GodotSpace3D **)(this + 0x40) = param_1;
  ...
  if ((param_1 != (GodotSpace3D *)0x0) &&
     (GodotSpace3D::add_object((GodotCollisionObject3D *)param_1), *(long *)(this + 0x40) != 0)) {
    _update_shapes(this);
    return;
  }
  return;
...
/* GodotCollisionObject3D::GodotCollisionObject3D(GodotCollisionObject3D::Type) */

void __thiscall
GodotCollisionObject3D::GodotCollisionObject3D(GodotCollisionObject3D *this,undefined4 param_2)
...
/* GodotCollisionObject3D::remove_shape(int) */

void __thiscall GodotCollisionObject3D::remove_shape(GodotCollisionObject3D *this,int param_1)
...
LAB_001010a8:
    ...
    if (*(long *)(this + 0x38) == 0) {
      ...
      if (lVar10 < lVar6) {
        ...
        CowData<GodotCollisionObject3D::Shape>::resize<false>
                  ((CowData<GodotCollisionObject3D::Shape> *)(this + 0x38),lVar9);
        goto LAB_0010127d;
      }
    }
    _err_print_index_error
              ("remove_at","./core/templates/cowdata.h",0xe4,lVar10,lVar6,"p_index","size()","",
               false,false);
LAB_0010127d:
    lVar6 = GodotPhysicsServer3D::godot_singleton;
    if (*(long *)(this + 0xb0) != 0) {
      return;
    }
    pGVar1 = this + 0xb0;
...
LAB_0010114d:
  _err_print_index_error
            ("remove_shape","modules/godot_physics_3d/godot_collision_object_3d.cpp",0x6f,lVar10,
             lVar9,"p_index","shapes.size()","",false,false);
  return;
}



/* GodotCollisionObject3D::remove_shape(GodotShape3D*) */

void __thiscall
GodotCollisionObject3D::remove_shape(GodotCollisionObject3D *this,GodotShape3D *param_1)
...
/* GodotCollisionObject3D::add_shape(GodotShape3D*, Transform3D const&, bool) */

void __thiscall
GodotCollisionObject3D::add_shape
          (GodotCollisionObject3D *this,GodotShape3D *param_1,Transform3D *param_2,bool param_3)

{
  ...
  iVar9 = CowData<GodotCollisionObject3D::Shape>::resize<false>
                    ((CowData<GodotCollisionObject3D::Shape> *)(this + 0x38),lVar11);
  if (iVar9 == 0) {
    if (*(long *)(this + 0x38) == 0) {
      lVar12 = -1;
      lVar11 = 0;
...
LAB_0010160f:
  GodotShape3D::add_owner((GodotShapeOwner3D *)param_1);
...
/* CowData<GodotCollisionObject3D::Shape>::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<GodotCollisionObject3D::Shape>::_copy_on_write(void)
...
/* CowData<GodotCollisionObject3D::Shape>::_realloc(long) */

undefined8 __thiscall
CowData<GodotCollisionObject3D::Shape>::_realloc
          (CowData<GodotCollisionObject3D::Shape> *this,long param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Error CowData<GodotCollisionObject3D::Shape>::resize<false>(long) */

...
joined_r0x00105f4b:
  ...
  plVar1 = (long *)((long)plVar8 + uVar23);
  if (plVar1 != plVar8) {
    lVar24 = -2;
    uVar20 = (long)uVar23 >> 3;
    if (uVar20 != 0) {
      lVar24 = 0x3f;
      if (uVar20 != 0) {
  ...
  if (uVar17 < 0x1fffffffffffffff) {
    ...
    if (0 < (long)local_e0) goto LAB_00105f91;
    if (uVar17 >> 0x3c != 0) goto LAB_00106ca7;
LAB_0010608d:
        ...
        if (!NAN(fVar3) && !NAN(fVar4)) {
          if (fVar3 == fVar4) {
            ...
            if (fVar27 < fVar25) {
              ...
              else if ((fVar26 != fVar3) || (fVar28 = *pfVar2, fVar25 <= fVar28)) goto LAB_00105fd0;
              goto LAB_00106038;
            }
            if (fVar25 < fVar27) goto LAB_00105faa;
          }
          else if (fVar3 <= fVar4) {
LAB_00105faa:
            fVar26 = pfVar2[1];
...
LAB_00106150:
            ...
            if (fVar3 == fVar26) {
              fVar28 = *pfVar10;
              fVar25 = *pfVar2;
              if (fVar28 < fVar25) goto LAB_00106150;
            }
          }
        }
LAB_00105fd0:
...
LAB_00105fd8:
        lVar24 = lVar24 + 1;
        pfVar10 = pfVar10 + 6;
        if ((long)local_e0 <= lVar24) goto LAB_00106080;
      }
      fVar26 = pfVar2[1];
      if (fVar3 <= fVar26) {
        if (fVar3 == fVar26) {
...
LAB_00106080:
    if (uVar17 >> 0x3c == 0) goto LAB_0010608d;
    local_f8 = operator_new__(0xffffffffffffffff);
    pvStack_98 = (void *)0x0;
    uStack_88 = 0;
    puStack_90 = &_GlobalNilClass::_nil;
  ...
  do {
    if (*(uint *)((long)pvVar9 + plVar8[uVar23] * 4) < 5) {
                    /* WARNING: Could not recover jumptable at 0x00106142. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      uVar11 = (*(code *)(&DAT_00109584 +
                         *(int *)(&DAT_00109584 +
                                 (ulong)*(uint *)((long)pvVar9 + plVar8[uVar23] * 4) * 4)))();
      return uVar11;
    }
    uVar23 = uVar23 + 1;
  } while (local_e0 !=
  ...
  if (0 < (long)local_e0) {
    ...
    do {
      while (*pcVar22 != '\0') {
        pcVar22 = pcVar22 + 1;
        pfVar10 = pfVar10 + 6;
        if (pcVar22 == pcVar12 + (long)local_e0) goto LAB_0010652c;
      }
      lVar19 = 1;
      ...
      *(int *)(plVar1 + 2) = (int)plVar1[2] + 1;
      pfVar10 = pfVar10 + 6;
    } while (pcVar22 != pcVar12 + (long)local_e0);
LAB_0010652c:
...
LAB_00107951:
    ...
    lVar3 = lVar8;
    lVar7 = lVar9;
    if (lVar13 <= lVar9) goto LAB_00107a5d;
LAB_00107993:
    do {
    ...
    ppEVar12 = ppEVar5;
    if (lVar13 == lVar9) goto LAB_00107a63;
    do {
      lVar9 = lVar7;
      lVar7 = lVar2 + -1;
      if (lVar2 <= lVar8) goto LAB_00107ba1;
      lVar3 = *(long *)pEVar10;
      do {
        lVar4 = lVar7 >> 1;
...
joined_r0x00107a3d:
      ...
      while( true ) {
        ...
        lVar3 = lVar8;
        lVar7 = lVar9;
        if (lVar9 < lVar13) goto LAB_00107993;
LAB_00107a5d:
        lVar7 = lVar9;
        ppEVar12 = ppEVar6;
        ppEVar5 = ppEVar6;
...
LAB_00107923:
    ...
    if (lVar7 < lVar8) goto LAB_001077d4;
  }
  else if (lVar8 <= lVar7) {
    if (lVar3 < lVar8) goto LAB_001077d4;
    goto LAB_00107923;
  }
...
LAB_0010780f:
      ...
      if (lVar8 < *(long *)*ppEVar6) {
        ...
        while (param_1 != lVar7) {
          lVar7 = lVar7 + -1;
          ppEVar6 = ppEVar5;
          if (*(long *)*ppEVar5 <= lVar8) goto LAB_00107875;
          ppEVar5 = ppEVar5 + -1;
        }
...
LAB_00107875:
  ...
  lVar9 = param_2;
  if (local_58 == 0) goto LAB_00107951;
  goto LAB_00107791;
LAB_00107a98:
...
LAB_0010815c:
        ...
        *ppEVar7 = pEVar6;
        pEVar6 = *__src;
        pEVar8 = pEVar6;
        if (pEVar4 == pEVar13) goto LAB_00107ff1;
      }
      pEVar13 = pEVar13 + 1;
...
LAB_00107f38:
        *ppEVar12 = pEVar13;
        ppEVar7 = ppEVar7 + 1;
        lVar9 = lVar14 + 1;
        if (lVar14 + 1 == 0x10) goto LAB_00107f4d;
      }
  ...
  if (*(int **)(piVar14 + 4) != piVar10) {
    do {
      while (piVar14 = piVar8,
        ...
        if (*(int **)(piVar14 + 2) == piVar10) goto LAB_001084ab;
      }
      piVar8 = *(int **)(piVar14 + 4);
  ...
  if ((*(int **)this == piVar14) ||
    ...
    *(int **)(piVar14 + 4) = piVar8;
    ...
    if (piVar10 == piVar13) {
      piVar11 = piVar14;
      piVar10 = piVar14;
      if (piVar8 == *(int **)(piVar14 + 2)) goto LAB_001086b8;
      goto LAB_001086c5;
    }
LAB_00108690:
    do {
...
LAB_001086c5:
      ...
      piVar10 = *(int **)(piVar11 + 4);
      if (piVar13 != *(int **)(piVar11 + 4)) goto LAB_00108690;
    }
  }
  *(int **)(piVar8 + 8) = piVar11;
  ...
  if (*(int **)(this + 8) == piVar9) {
    ...
    if (piVar10 != piVar9) goto LAB_0010857c;
    piVar8[10] = 0;
    piVar8[0xb] = 0;
    if (piVar11 == (int *)0x0) goto LAB_00108596;
LAB_00108585:
    *(int **)(piVar11 + 10) = piVar8;
    piVar13 = *(int **)(piVar8 + 10);
    if (piVar13 == (int *)0x0) goto LAB_00108596;
  }
  else {
    do {
      piVar13 = piVar9;
...
LAB_0010857c:
    *(int **)(piVar8 + 10) = piVar13;
    if (piVar11 != (int *)0x0) goto LAB_00108585;
  }
...
LAB_00108905:
            ...
            *(int **)(piVar12 + 6) = piVar13;
            if (piVar14 == *(int **)(piVar13 + 4)) goto LAB_00108905;
      ...
      if (*piVar9 != 0) {
        ...
        if (piVar13 == piVar9) {
          ...
          *(int **)(piVar14 + 6) = piVar9;
          piVar13 = *(int **)(this + 8);
          *piVar9 = 1;
          if (piVar10 != piVar13) goto LAB_001085d1;
LAB_001087b8:
          _err_print_error("_set_color","./core/templates/rb_set.h",0xd0,
                           "Condition \"p_node == _data._nil && p_color == RED\" is true.",0,0);
          piVar13 = piVar14;
          ...
          *piVar14 = 1;
          piVar9 = piVar14;
          piVar14 = piVar13;
          if (piVar10 == piVar12) goto LAB_001087b8;
LAB_001085d1:
          *piVar10 = 0;
          piVar13 = piVar14;
        }
...
LAB_001089f9:
      ...
      if (*(int *)pEVar7 == 1) goto LAB_00108a06;
LAB_00108ab0:
      if (pEVar9 != *(Element **)(pEVar6 + 8)) {
        iVar1 = *(int *)pEVar6;
        pEVar7 = pEVar9;
        goto joined_r0x00108abf;
      }
      if (**(int **)(pEVar9 + 8) == 1) {
        *(int *)pEVar7 = 1;
        if (pEVar9 == pEVar8) {
...
LAB_00108ca1:
    ...
    *(Element **)(pEVar6 + 0x18) = param_1;
    pEVar7 = *(Element **)(pEVar9 + 0x10);
    if (*(int *)pEVar7 != 1) goto LAB_00108ab0;
LAB_00108a06:
    pEVar7 = *(Element **)(pEVar9 + 8);
    if (*(int *)pEVar7 != 1) {
      if (*(Element **)(pEVar6 + 8) == pEVar9) goto LAB_00108ca1;
      *(int *)pEVar7 = 1;
      if (pEVar9 == pEVar8) {
        _err_print_error("_set_color","./core/templates/rb_set.h",0xd0,
                         "Condition \"p_node == _data._nil && p_color == RED\" is true.",0,0);
...
LAB_00108f78:
    ...
    if (pEVar9 == pEVar8) goto LAB_00108f8d;
LAB_00108e9d:
    *(int **)(lVar6 + 8) = piVar4;
  }
  else {
    if (piVar1 != *(int **)(param_1 + 8)) {
      ...
      if (piVar1 == piVar4) goto LAB_00108f78;
    }
    lVar6 = *(long *)(pEVar8 + 0x18);
    pEVar9 = *(Element **)(lVar6 + 0x10);
    if (pEVar9 != pEVar8) goto LAB_00108e9d;
LAB_00108f8d:
...

{
  ...
  if (param_2 < lVar9) {
    ...
    if ((param_3 & 1) == 0) goto LAB_00109258;
  }
  else {
    plVar7 = (long *)(param_1 + param_2 * 8);
    if ((param_3 & 1) != 0) goto LAB_00109237;
LAB_00109258:
      ...
      do {
        ...
        if ((fVar6 < fVar15) || ((fVar15 == fVar6 && (*pfVar4 <= *pfVar3 && *pfVar3 != *pfVar4)))) {
          ...
          if ((fVar6 <= fVar7) && ((fVar6 != fVar7 || (*pfVar4 < *pfVar5 || *pfVar4 == *pfVar5)))) {
            if ((fVar7 < fVar15) ||
               ((fVar15 == fVar7 && (*pfVar5 <= *pfVar3 && *pfVar3 != *pfVar5)))) goto LAB_0010955e;
            goto LAB_00109487;
          }
LAB_00109397:
          lVar11 = *param_1;

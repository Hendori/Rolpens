...
LAB_00101b51:
    ...
    if (param_1 != 0) {
      ...
      if (*(long *)(pcVar8 + 8) == 0) {
        switch(param_4) {
        case 0x14:
          std::__cxx11::string::_M_replace((ulong)pcVar8,0,(char *)0x0,0x1043af);
          break;
        case 0x15:
          iVar18 = *(int *)(**(long **)(this + 0x10) + (long)*(int *)(this + 0x1c) * 4);
          if (iVar18 == 0x10) {
            std::__cxx11::string::_M_replace((ulong)pcVar8,0,(char *)0x0,0x104381);
          }
          else if (iVar18 == 0x40) {
            std::__cxx11::string::_M_replace((ulong)pcVar8,0,(char *)0x0,0x10438d);
          }
          else if (iVar18 == 8) {
            std::__cxx11::string::_M_replace((ulong)pcVar8,0,(char *)0x0,0x10437a);
          }
          else {
            std::__cxx11::string::_M_replace((ulong)pcVar8,0,(char *)0x0,0x104389);
          }
          break;
        case 0x16:
          iVar18 = *(int *)(**(long **)(this + 0x10) + (long)*(int *)(this + 0x1c) * 4);
          if (iVar18 == 0x10) {
            std::__cxx11::string::_M_replace((ulong)pcVar8,0,(char *)0x0,0x104395);
          }
          else {
            if (iVar18 == 0x40) goto LAB_001023c0;
            std::__cxx11::string::_M_replace((ulong)pcVar8,0,(char *)0x0,0x10439f);
          }
          break;
        case 0x17:
          ...
          if (puVar11[1] == 0) {
LAB_00101bca:
            std::__cxx11::string::_M_append(pcVar8,0x1043dc);
...
LAB_001022e6:
              ...
              if (pcVar13 != (char *)0x0) {
                ...
                std::__cxx11::string::_M_append(pcVar8,0x1043d6);
                pcVar8 = (char *)(*(long *)(this + 0x40) + lVar6);
...
LAB_001023c0:
            std::__cxx11::string::_M_replace((ulong)pcVar8,0,(char *)0x0,0x1043a5);
          }
          break;
        default:
          goto switchD_00100fff_caseD_18;
        case 0x1e:
          std::__cxx11::string::_M_replace((ulong)pcVar8,0,(char *)0x0,0x1043b4);
          break;
        case 0x20:
          std::__cxx11::string::_M_replace((ulong)pcVar8,0,(char *)0x0,0x1043bb);
        }
        goto LAB_00101020;
      }
    }
...

{
  ...
  local_d8 = &PTR__SpirvStream_00105488;
  local_bc = 0;
  local_70 = 8;
  local_d0 = param_1;
  local_c8 = param_2;
  ...
  *puStack_50 = local_68;
  ...
  spv::Parameterize();
  puVar4 = GlslStd450DebugNames;
  do {
    *(char **)puVar4 = "Unknown";
    *(char **)((code *)puVar4 + 8) = "Unknown";
    puVar4 = (code *)puVar4 + 0x10;
  } while ((code *)puVar4 != std::ctype<char>::do_widen);
  ...
  if (local_78 != (void *)0x0) {
    puVar6 = puStack_30 + 1;
    for (puVar5 = puStack_50; puVar5 < puVar6; puVar5 = puVar5 + 1) {
      operator_delete((void *)*puVar5,0x200);
    }
    operator_delete(pvVar3,local_70 * 8);
  }
  uVar2 = local_90._0_8_;
  uVar1 = local_a0._8_8_;
  for (puVar6 = (undefined8 *)local_a0._8_8_; (undefined8 *)uVar2 != puVar6; puVar6 = puVar6 + 4) {
...

{
  ...
  *(undefined ***)this = &PTR__SpirvStream_00105488;
...

{
  ...
  if (uVar2 < param_1) {
    ...
    *puVar6 = 0;
    if (param_1 - 1 != 0) goto LAB_001050d4;
LAB_001050e8:
    if (sVar4 != 0) goto LAB_001051b8;
    if (pvVar3 == (void *)0x0) goto LAB_001050fa;
          ...
          if ((uVar4 & 4) == 0) {
            if (uVar3 != 0) {
              *(char *)plVar6 = (char)*plVar11;
              if ((uVar4 & 2) == 0) goto LAB_00105372;

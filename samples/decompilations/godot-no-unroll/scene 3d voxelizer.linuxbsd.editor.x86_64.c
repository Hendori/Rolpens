...
void edt(float *param_1,int param_2,int param_3)
    ...
    while( true ) {
      ...
      if (fVar24 < fVar21) {
        ...
        do {
          ...
          fVar21 = (fVar23 - ((float)((int)fVar24 * (int)fVar24) + param_1[(int)fVar24 * param_2]))
                   / (float)(((int)fVar18 - (int)fVar24) * 2);
          uVar8 = uVar12 - 1;
...
/* CowData<Voxelizer::Cell>::_copy_on_write() [clone .isra.0] */

void __thiscall CowData<Voxelizer::Cell>::_copy_on_write(CowData<Voxelizer::Cell> *this)
...
/* SortArray<Voxelizer::CellSort, _DefaultComparator<Voxelizer::CellSort>, true>::introsort(long,
   long, Voxelizer::CellSort*, long) const [clone .isra.0] */

void SortArray<Voxelizer::CellSort,_DefaultComparator<Voxelizer::CellSort>,true>::introsort
               (long param_1,long param_2,CellSort *param_3,long param_4)
...
LAB_001005dc:
        if (lVar5 <= param_2) goto LAB_00100610;
  ...
  do {
    ...
    if (lVar8 < lVar5) {
      do {
        ...
        lVar11 = lVar2;
        if (*(ulong *)(param_3 + (param_1 + lVar2 + -1) * 0x10) <=
            *(ulong *)(param_3 + (param_1 + lVar2) * 0x10)) {
          lVar11 = lVar2 + 1;
          lVar3 = lVar2;
...
LAB_00100610:
  introsort(param_2,lVar8,param_3,param_4);
  lVar5 = param_2 - param_1;
  if (lVar5 < 0x11) {
    return;
  }
...
LAB_00100950:
      ...
      *(undefined4 *)(pCVar7 + 8) = *(undefined4 *)(pCVar14 + 8);
      ...
      do {
        ...
        if (*(ulong *)(param_3 + (param_1 + lVar8 + -1) * 0x10) <=
            *(ulong *)(param_3 + (param_1 + lVar8) * 0x10)) {
          lVar12 = lVar8 + 1;
          lVar2 = lVar8;
...
/* CowData<Voxelizer::CellSort>::_copy_on_write() [clone .isra.0] */

void __thiscall CowData<Voxelizer::CellSort>::_copy_on_write(CowData<Voxelizer::CellSort> *this)
...
/* Voxelizer::get_bake_steps(Ref<Mesh>&) const */

int __thiscall Voxelizer::get_bake_steps(Voxelizer *this,Ref *param_1)
...
/* Voxelizer::_fixup_plot(int, int) */

void __thiscall Voxelizer::_fixup_plot(Voxelizer *this,int param_1,int param_2)
...
LAB_001016f1:
  _err_print_index_error
            ("get","./core/templates/cowdata.h",0xdb,uVar4,lVar7,"p_index","size()","",false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar3 = (code *)invalidInstructionException();
  (*pcVar3)();
...
/* Voxelizer::get_voxel_gi_octree_depth() const */

undefined4 __thiscall Voxelizer::get_voxel_gi_octree_depth(Voxelizer *this)
...
/* Voxelizer::get_voxel_gi_octree_size() const */

undefined8 Voxelizer::get_voxel_gi_octree_size(void)
...
/* Voxelizer::get_voxel_gi_cell_count() const */

undefined4 __thiscall Voxelizer::get_voxel_gi_cell_count(Voxelizer *this)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Voxelizer::_debug_mesh(int, int, AABB const&, Ref<MultiMesh>&, int&) */

void __thiscall
Voxelizer::_debug_mesh
          (Voxelizer *this,int param_1,int param_2,AABB *param_3,Ref *param_4,int *param_5)

{
  ...
  if (*(int *)(this + 0x10) + -1 == param_2) {
    ...
    local_54 = CONCAT44((float)((ulong)*(undefined8 *)param_3 >> 0x20) +
                        (float)((ulong)*(undefined8 *)(param_3 + 0xc) >> 0x20) * _UNK_0010eeec,
                        (float)*(undefined8 *)param_3 + (float)*(undefined8 *)(param_3 + 0xc) * _LC2
                       );
    Basis::scale((Vector3 *)&local_78);
    MultiMesh::set_instance_transform
              ((int)*(undefined8 *)param_4,(Transform3D *)(ulong)(uint)*param_5);
    lVar3 = *(long *)(this + 8);
    if (lVar5 < 0) {
      if (lVar3 != 0) {
        lVar3 = *(long *)(lVar3 + -8);
...
/* Voxelizer::get_to_cell_space_xform() const */

void Voxelizer::get_to_cell_space_xform(void)
...
void __thiscall Voxelizer::Voxelizer(Voxelizer *this)
...
/* Voxelizer::get_voxel_gi_level_cell_count() const */

void Voxelizer::get_voxel_gi_level_cell_count(void)
...
/* Error CowData<Voxelizer::Cell>::resize<false>(long) [clone .isra.0] */

void __thiscall CowData<Voxelizer::Cell>::resize<false>(CowData<Voxelizer::Cell> *this,long param_1)

{
  ...
  if (lVar13 != 0) {
    ...
    if (lVar11 != 0) {
      if (param_1 <= lVar14) {
        if ((lVar11 != lVar3) && (iVar2 = _realloc(this,lVar11), iVar2 != 0)) {
          return;
        }
        if (*(long *)this != 0) {
...
/* Voxelizer::begin_bake(int, AABB const&, float) */

void __thiscall Voxelizer::begin_bake(Voxelizer *this,int param_1,AABB *param_2,float param_3)

{
  ...
  *(float *)(this + 0xc0) =
       *(float *)(this + (long)iVar12 * 4 + 0x70) / (float)*(int *)(this + (long)iVar12 * 4 + 0x7c);
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
                    /* WARNING: Subroutine does not return */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Voxelizer::_plot_face(int, int, int, int, int, Vector3 const*, Vector3 const*, Vector2 const*,
   Voxelizer::MaterialCache const&, AABB const&) */

void __thiscall
Voxelizer::_plot_face
          (Voxelizer *this,int param_1,int param_2,int param_3,int param_4,int param_5,
          Vector3 *param_6,Vector3 *param_7,Vector2 *param_8,MaterialCache *param_9,AABB *param_10)

{
  ...
  if (*(int *)(this + 0x10) != param_2) {
    ...
    do {
      ...
      if ((((-1 < iVar18) && (iVar18 < *(int *)(this + 0x7c))) && (-1 < iVar20)) &&
         (((iVar20 < *(int *)(this + 0x80) && (-1 < iVar15)) && (iVar15 < *(int *)(this + 0x84)))))
      {
                    ...
                    if ((fVar46 <= fVar62) && ((float)((uint)fVar62 ^ _LC54) <= fVar54)) {
                      ...
                      if ((fVar54 <= fVar61) && ((float)((uint)fVar61 ^ _LC54) <= fVar46)) {
                        ...
                        if ((fVar46 <= fVar61) && ((float)((uint)fVar61 ^ _LC54) <= fVar54)) {
                          ...
                          fVar46 = fVar37;
                          if ((fVar37 <= fVar47) &&
                             (fVar54 = fVar37, fVar46 = fVar47, fVar47 <= fVar37)) {
                            fVar46 = fVar37;
                          }
                          fVar47 = fVar64;
                          if (fVar64 <= fVar46) {
                          ...
                          if ((fVar64 <= fVar21) && ((float)((uint)fVar21 ^ _LC54) <= fVar47)) {
                            fVar54 = fVar32;
                            fVar64 = fVar29;
                            if ((fVar32 <= fVar29) && (fVar64 = fVar32, fVar32 < fVar29)) {
                              fVar54 = fVar29;
                            }
                            fVar29 = fVar25;
                            if (fVar25 <= fVar54) {
                            ...
                            if ((fVar25 <= fVar28) && ((float)((uint)fVar28 ^ _LC54) <= fVar29)) {
                              fVar64 = fVar35;
                              fVar25 = fVar31;
                              if ((fVar35 <= fVar31) && (fVar25 = fVar35, fVar35 < fVar31)) {
                                fVar64 = fVar31;
                              }
                              fVar54 = fVar27;
                              if (fVar27 <= fVar64) {
                              ...
                              if ((fVar27 <= fVar30) && ((float)((uint)fVar30 ^ _LC54) <= fVar54)) {
                                ...
                                if (((float)local_88._0_4_ * fVar27 + (float)local_88._4_4_ * fVar64
                                    + local_80 * local_b0) - fVar25 <= 0.0) {
                                  if (0.0 <= (fVar27 * local_78[0] + fVar64 * local_78[1] +
                                             local_b0 * local_78[2]) - fVar25) {
                                    lVar13 = (long)param_1;
                                    lVar10 = *(long *)(this + 8);
                                    fStack_58 = fVar26;
                                    if (lVar13 < 0) {
...
LAB_0010303e:
                                        ...
                                        if (lVar13 < (long)uVar16) {
                                          _plot_face(this,*(int *)(lVar10 + (long)(int)uVar17 * 4 +
                                                                  lVar19),param_2 + 1,iVar18,iVar20,
                                                     iVar15,param_6,param_7,param_8,param_9,
                                                     (AABB *)local_68);
                                          fVar26 = fStack_58;
                                          goto LAB_001030b0;
                                        }
                                        ...
                                        if (lVar10 != 0) {
                                          ...
                                          *(short *)(lVar10 + 0x4c + lVar14) =
                                          ...
                                          if (lVar10 != 0) {
                                            ...
                                            CowData<Voxelizer::Cell>::_copy_on_write(pCVar1);
                                            lVar10 = *(long *)(this + 8);
                                            *(short *)(lVar10 + 0x4e + lVar14) =
                                                 (short)(iVar20 / iVar7);
                                            if (lVar10 != 0) {
                                              lVar10 = *(long *)(lVar10 + -8);
                                              if ((long)uVar16 < lVar10) {
                                                CowData<Voxelizer::Cell>::_copy_on_write(pCVar1);
                                                *(short *)(*(long *)(this + 8) + 0x50 + lVar14) =
                                                     (short)(iVar15 / iVar7);
                                                lVar10 = *(long *)(this + 8);
...
LAB_001030b0:
  ...
  local_78[2] = (fVar23 - *(float *)(param_6 + 0x10)) * (fVar26 - *(float *)(param_6 + 0x18)) -
                (fVar23 - *(float *)(param_6 + 0x1c)) * (fVar26 - *(float *)(param_6 + 0xc));
  local_13c = (fVar26 - *(float *)(param_6 + 0xc)) * (fVar24 - *(float *)(param_6 + 0x20)) -
              (fVar26 - *(float *)(param_6 + 0x18)) * (fVar24 - *(float *)(param_6 + 0x14));
  local_140 = (fVar23 - *(float *)(param_6 + 0x1c)) * (fVar24 - *(float *)(param_6 + 0x14)) -
              (fVar24 - *(float *)(param_6 + 0x20)) * (fVar23 - *(float *)(param_6 + 0x10));
...
LAB_001047ab:
    ...
    local_98 = CONCAT44((float)((ulong)*(undefined8 *)(param_10 + 0xc) >> 0x20) * fVar26 +
                        (float)((ulong)*(undefined8 *)param_10 >> 0x20),
                        (float)*(undefined8 *)(param_10 + 0xc) * fVar24 +
                        (float)*(undefined8 *)param_10);
    ...
    if (cVar6 == '\0') {
      ...
      if (cVar6 == '\0') {
        ...
        if (cVar6 == '\0') {
          ...
          fVar54 = fVar54 * ((float)local_88._0_4_ - fVar24) +
                   fVar29 * ((float)local_88._4_4_ - fVar23) + fVar28 * (local_80 - fVar26);
          fVar23 = fVar27 * ((float)local_88._0_4_ - fVar24) +
                   fVar35 * ((float)local_88._4_4_ - fVar23) + fVar32 * (local_80 - fVar26);
          fVar26 = (fVar25 * fVar54 - fVar31 * fVar23) / fVar64;
          fVar64 = (fVar23 * fVar30 - fVar54 * fVar31) / fVar64;
          fVar25 = (_LC32 - fVar26) - fVar64;
          fVar24 = *(float *)(param_8 + 0xc) * fVar26 + *(float *)(param_8 + 4) * fVar25 +
                   *(float *)(param_8 + 0x14) * fVar64;
          fVar23 = *(float *)(param_8 + 8) * fVar26 + *(float *)param_8 * fVar25 +
                   *(float *)(param_8 + 0x10) * fVar64;
          local_1b0 = *(float *)(param_7 + 0x14) * fVar26 + *(float *)(param_7 + 8) * fVar25 +
                      *(float *)(param_7 + 0x20) * fVar64;
          local_108 = *(float *)(param_7 + 0x10) * fVar26 + *(float *)(param_7 + 4) * fVar25 +
                      *(float *)(param_7 + 0x1c) * fVar64;
          local_11c = fVar26 * *(float *)(param_7 + 0xc) + fVar25 * *(float *)param_7 +
                      fVar64 * *(float *)(param_7 + 0x18);
...
LAB_00104bb6:
      iVar18 = iVar18 + (int)fVar23 * iVar7;
    }
    else {
      if (fVar23 < 0.0) {
        fVar23 = fVar23 + _LC32;
...
LAB_00104ec7:
    _err_print_index_error
              ("get","./core/templates/cowdata.h",0xdb,lVar13,uVar16,"p_index","size()","",false,
               true);
    _err_flush_stdout();
                    /* WARNING: Does not return */
  ...
  do {
    ...
    do {
      ...
      fVar60 = (float)((ulong)*(undefined8 *)(param_10 + 4) >> 0x20) + fVar35 * fVar23 +
               fVar56 * fVar27;
                  ...
                  if ((fVar56 <= fVar51) && ((float)((uint)fVar51 ^ _LC54) <= fVar62)) {
                    ...
                    if ((fVar56 <= fVar42) && ((float)((uint)fVar42 ^ _LC54) <= fVar62)) {
                      ...
                      if ((fVar62 <= fVar41) && ((float)((uint)fVar41 ^ _LC54) <= fVar56)) {
                        fVar56 = fVar34;
                        fVar62 = fVar58;
                        if ((fVar34 <= fVar58) && (fVar62 = fVar34, fVar34 < fVar58)) {
                          fVar56 = fVar58;
                        }
                        fVar58 = fVar37;
                        if (fVar62 <= fVar37) {
                        ...
                        if ((fVar58 <= fVar21) && ((float)((uint)fVar21 ^ _LC54) <= fVar37)) {
                          ...
                          local_164 = fVar61;
                          if ((fVar61 <= fVar63) &&
                             (fVar37 = fVar61, local_164 = fVar63, fVar63 <= fVar61)) {
                            local_164 = fVar61;
                          }
                          fVar62 = fVar46;
                          if (fVar46 <= local_164) {
                          ...
                          if ((fVar46 <= fVar38) && ((float)((uint)fVar38 ^ _LC54) <= fVar62)) {
                            fVar46 = fVar55;
                            local_160 = fVar44;
                            if ((fVar55 <= fVar44) && (local_160 = fVar55, fVar55 < fVar44)) {
                              fVar46 = fVar44;
                            }
                            fVar37 = fVar48;
                            if (local_160 <= fVar48) {
                            ...
                            if ((fVar37 <= fVar47) && ((float)((uint)fVar47 ^ _LC54) <= fVar48)) {
                              ...
                              _local_88 = ZEXT812(0);
                              if (((fVar48 * 0.0 + fVar46 * 0.0 + local_b0 * 0.0) - fVar37 <= 0.0)
                                 && (_local_88 = ZEXT812(0),
                                    0.0 <= (fVar48 * 0.0 + fVar46 * 0.0 + local_b0 * 0.0) - fVar37))
                              {
                                ...
                                local_a8[1] = fVar66;
                                local_a8[2] = fVar46;
                                if ((fVar46 - local_90) * fVar25 +
                                    (fVar48 - fVar21) * local_140 + (fVar66 - fVar45) * local_13c <
                                    0.0) {
                                ...
                                local_88 = (undefined1  [8])0x0;
                                local_80 = 0.0;
                                cVar6 = Plane::intersects_segment
                                                  ((Vector3 *)local_78,(Vector3 *)local_a8,
                                                   (Vector3 *)&local_98);
                                if (cVar6 == '\0') {
                                  fVar21 = SUB84(local_78._0_8_,4);
                                  fVar48 = (local_78[2] * local_a8[2] +
                                           local_a8[1] * fVar21 + local_a8[0] * local_78[0]) -
                                           local_78[3];
                                  fVar46 = (float)((ulong)local_98 >> 0x20);
                                  fVar45 = (fVar46 * fVar21 + local_78[0] * (float)local_98 +
                                           local_90 * local_78[2]) - local_78[3];
                                  if ((float)(((uint)fVar45 ^ _LC54) & -(uint)(fVar45 < 0.0) |
                                             ~-(uint)(fVar45 < 0.0) & (uint)fVar45) <=
                                      (float)(((uint)fVar48 ^ _LC54) & -(uint)(fVar48 < 0.0) |
                                             ~-(uint)(fVar48 < 0.0) & (uint)fVar48)) {
                                    local_80 = local_90 - fVar45 * local_78[2];
                                    local_88 = (undefined1  [8])
                                               CONCAT44(fVar46 - fVar45 * fVar21,
                                                        (float)local_98 - fVar45 * local_78[0]);
                                  }
                                  else {
                                    local_80 = local_a8[2] - fVar48 * local_78[2];
                                    local_88 = (undefined1  [8])
                                               CONCAT44(local_a8[1] - fVar48 * fVar21,
                                                        local_a8[0] - fVar48 * local_78[0]);
                                  }
                                }
                                local_68[0] = (float)*(undefined8 *)param_6;
                                local_68[1] = (float)((ulong)*(undefined8 *)param_6 >> 0x20);
                                ...
                                if (cVar6 == '\0') {
                                  ...
                                  fVar21 = fVar62 * (local_80 - fVar48) +
                                           fVar21 * ((float)local_88._0_4_ - fVar46) +
                                           fVar47 * ((float)local_88._4_4_ - fVar45);
                                  fVar45 = fVar37 * ((float)local_88._4_4_ - fVar45) +
                                           fVar60 * ((float)local_88._0_4_ - fVar46) +
                                           fVar65 * (local_80 - fVar48);
                                  fVar48 = (fVar55 * fVar45 - fVar66 * fVar21) / fVar38;
                                  fVar38 = (fVar61 * fVar21 - fVar66 * fVar45) / fVar38;
                                  fVar21 = (_LC32 - fVar48) - fVar38;
                                  fVar46 = *(float *)(param_8 + 0xc) * fVar48 +
                                           *(float *)(param_8 + 4) * fVar21 +
                                           *(float *)(param_8 + 0x14) * fVar38;
                                  fVar45 = *(float *)(param_8 + 8) * fVar48 +
                                           *(float *)param_8 * fVar21 +
                                           *(float *)(param_8 + 0x10) * fVar38;
                                  fVar65 = *(float *)(param_7 + 0x14) * fVar48 +
                                           *(float *)(param_7 + 8) * fVar21 +
                                           *(float *)(param_7 + 0x20) * fVar38;
                                  fVar60 = *(float *)(param_7 + 4) * fVar21 +
                                           *(float *)(param_7 + 0x10) * fVar48 +
                                           *(float *)(param_7 + 0x1c) * fVar38;
                                  fVar38 = fVar48 * *(float *)(param_7 + 0xc) +
                                           fVar21 * *(float *)param_7 +
                                           fVar38 * *(float *)(param_7 + 0x18);
              ...
              if (lVar10 != 0) {
                ...
                *(float *)(lVar10 + lVar13 + 0x38) = local_11c + *(float *)(lVar10 + lVar13 + 0x38);
                if (lVar10 != 0) {
                  ...
                  CowData<Voxelizer::Cell>::_copy_on_write(pCVar1);
                  lVar10 = *(long *)(this + 8);
                  *(float *)(lVar10 + lVar13 + 0x3c) =
                       local_108 + *(float *)(lVar10 + lVar13 + 0x3c);
                  if (lVar10 != 0) {
                    lVar10 = *(long *)(lVar10 + -8);
                    if (lVar10 <= (long)uVar16) goto LAB_001048d1;
                    CowData<Voxelizer::Cell>::_copy_on_write(pCVar1);
                    lVar10 = *(long *)(this + 8);
                    *(float *)(lVar10 + lVar13 + 0x40) =
                         local_1b0 + *(float *)(lVar10 + lVar13 + 0x40);
                    if (lVar10 != 0) {
                      lVar10 = *(long *)(lVar10 + -8);
                      if ((long)uVar16 < lVar10) {
                        CowData<Voxelizer::Cell>::_copy_on_write(pCVar1);
                        *(float *)(lVar13 + *(long *)(this + 8) + 0x48) =
                             local_124 + *(float *)(lVar13 + *(long *)(this + 8) + 0x48);
LAB_001030bc:
                        if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
                          return;
                        }
...
LAB_001048d1:
  _err_print_index_error
            ("operator[]","./core/templates/vector.h",0x38,uVar16,lVar10,"p_index",
             "((Vector<T> *)(this))->_cowdata.size()","",false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar4 = (code *)invalidInstructionException();
...
/* Voxelizer::_get_bake_texture(Ref<Image>, Color const&, Color const&) */

long Voxelizer::_get_bake_texture
               (long param_1,long param_2,long *param_3,float *param_4,float *param_5)

{
  ...
  *(undefined8 *)(param_1 + 8) = 0;
  if ((*param_3 == 0) || (cVar11 = Image::is_empty(), cVar11 != '\0')) {
    CowData<Color>::resize<false>
              ((CowData<Color> *)(param_1 + 8),
               (long)(*(int *)(param_2 + 0xbc) * *(int *)(param_2 + 0xbc)));
...
LAB_0010574a:
          _err_print_index_error
                    ("operator[]","./core/templates/vector.h",0x38,lVar17,lVar12,"p_index",
                     "((Vector<T> *)(this))->_cowdata.size()","",false,true);
          _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_00105a73:
    ...
    cVar11 = RefCounted::unreference();
    if ((cVar11 != '\0') && (cVar11 = predelete_handler(local_58), cVar11 != '\0')) {
      (**(code **)(*(long *)local_58 + 0x140))();
      Memory::free_static(local_58,false);
    }
  }
LAB_00105801:
  cVar11 = Image::is_compressed();
  if (cVar11 != '\0') {
    Image::decompress();
  }
  ...
  if (*(int *)(param_2 + 0xbc) * *(int *)(param_2 + 0xbc) != 0) {
    ...
    do {
      ...
      *puVar2 = CONCAT44((float)(dVar19 * (double)fVar4 + (double)fVar6),
                         (float)(dVar18 * (double)fVar3 + (double)fVar5));
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Voxelizer::_get_material_cache(Ref<Material>) */

long Voxelizer::_get_material_cache
               (undefined8 param_1,undefined8 param_2,long param_3,long param_4,Ref *param_5)
...
LAB_00106199:
    ...
    local_68 = CONCAT44(_UNK_0010ef54,__LC36);
    uStack_60 = CONCAT44(_UNK_0010ef5c,_UNK_0010ef58);
    ...
    pIVar22 = local_c0;
    if ((local_c0 != (Image *)0x0) && (cVar10 = RefCounted::unreference(), cVar10 != '\0')) {
      memdelete<Image>(pIVar22);
    }
    local_c0 = (Image *)0x0;
    local_58 = CONCAT44(_UNK_0010ef54,__LC36);
    uStack_50 = CONCAT44(_UNK_0010ef5c,_UNK_0010ef58);
    local_68 = CONCAT44(_UNK_0010ef54,__LC36);
    uStack_60 = CONCAT44(_UNK_0010ef5c,_UNK_0010ef58);
  ...
  ;
  if ((pOVar13 == (Object *)0x0) || (cVar10 = RefCounted::reference(), cVar10 == '\0')) {
    local_d8 = (Object *)0x0;
    lVar15 = *(long *)(param_4 + 0x20);
    ...
    pOVar13 = (Object *)0x0;
LAB_00105c36:
    local_110 = (HashMap<Ref<Material>,Voxelizer::MaterialCache,HashMapHasherDefault,HashMapComparatorDefault<Ref<Material>>,DefaultTypedAllocator<HashMapElement<Ref<Material>,Voxelizer::MaterialCache>>>
                 *)(param_4 + 0x18);
    ...
    if (uVar18 != 0) {
      ...
      do {
        ...
        {
          lVar15 = HashMap<Ref<Material>,Voxelizer::MaterialCache,HashMapHasherDefault,HashMapComparatorDefault<Ref<Material>>,DefaultTypedAllocator<HashMapElement<Ref<Material>,Voxelizer::MaterialCache>>>
                   ::operator[](local_110,(Ref *)&local_d8);
        ...
        iVar12 = SUB164(auVar2 * auVar6,8);
              ...
              (auVar3._8_8_ = 0, auVar3._0_8_ = (ulong)uVar18 * lVar24, auVar7._8_8_ = 0,
              auVar7._0_8_ = uVar21, auVar4._8_8_ = 0,
              auVar4._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                               (ulong)*(uint *)(param_4 + 0x40) * 4) + iVar12) -
                                    SUB164(auVar3 * auVar7,8)) * lVar24, auVar8._8_8_ = 0,
              auVar8._0_8_ = uVar21, uVar19 <= SUB164(auVar4 * auVar8,8)));
    }
...
LAB_00105d99:
  ...
  if (local_d0 == (Object *)0x0) {
    ...
    if ((*(code **)(*(long *)local_d0 + 0x210) == Texture2D::get_image) ||
       ((**(code **)(*(long *)local_d0 + 0x210))(&local_b8,local_d0), pIVar22 = local_b8,
       local_b8 == (Image *)0x0)) {
LAB_00105df1:
      local_58 = CONCAT44(_UNK_0010ef54,__LC36);
      uStack_50 = CONCAT44(_UNK_0010ef5c,_UNK_0010ef58);
...
LAB_00105ea3:
  _get_bake_texture((StringName *)&local_b8,param_4,&local_c0);
  lVar24 = local_b0[0];
  if (local_b0[0] != 0) {
    CowData<Color>::_unref((CowData<Color> *)local_a0);
    local_a0[0] = local_b0[0];
  ...
  if (cVar10 == '\0') {
    ...
    StringName::StringName
              ((StringName *)&local_b8,"rendering/lights_and_shadows/use_physical_light_units",false
              );
...
LAB_00106034:
      ...
      if ((*(code **)(*(long *)local_c8 + 0x210) == Texture2D::get_image) ||
         ((**(code **)(*(long *)local_c8 + 0x210))((StringName *)&local_b8,local_c8),
         pIVar23 = local_b8, local_b8 == (Image *)0x0)) {
        iVar12 = BaseMaterial3D::get_emission_operator();
        ...
        if ((local_b8 != (Image *)0x0) && (cVar10 = RefCounted::unreference(), cVar10 != '\0')) {
          memdelete<Image>(local_b8);
        }
        iVar12 = BaseMaterial3D::get_emission_operator();
        if (iVar12 == 0) {
...
LAB_00106078:
    ...
    if ((pIVar23 != (Image *)0x0) && (cVar10 = RefCounted::unreference(), cVar10 != '\0')) {
      memdelete<Image>(pIVar23);
    }
    if (((local_c8 != (Object *)0x0) && (cVar10 = RefCounted::unreference(), cVar10 != '\0')) &&
       (cVar10 = predelete_handler(local_c8), cVar10 != '\0')) {
      (**(code **)(*(long *)local_c8 + 0x140))(local_c8);
      Memory::free_static(local_c8,false);
    }
  }
  if ((pIVar22 != (Image *)0x0) && (cVar10 = RefCounted::unreference(), cVar10 != '\0')) {
    memdelete<Image>(pIVar22);
  }
  if (((local_d0 != (Object *)0x0) && (cVar10 = RefCounted::unreference(), cVar10 != '\0')) &&
     (cVar10 = predelete_handler(local_d0), cVar10 != '\0')) {
...
LAB_001062e1:
  local_110 = (HashMap<Ref<Material>,Voxelizer::MaterialCache,HashMapHasherDefault,HashMapComparatorDefault<Ref<Material>>,DefaultTypedAllocator<HashMapElement<Ref<Material>,Voxelizer::MaterialCache>>>
               *)(param_4 + 0x18);
  lVar17 = HashMap<Ref<Material>,Voxelizer::MaterialCache,HashMapHasherDefault,HashMapComparatorDefault<Ref<Material>>,DefaultTypedAllocator<HashMapElement<Ref<Material>,Voxelizer::MaterialCache>>>
           ::operator[](local_110,param_5);
  lVar24 = local_a0[0];
  if (*(long *)(lVar17 + 8) != local_a0[0]) {
  ...
  *(long *)(param_3 + 8) = lVar24;
  *(long *)(param_3 + 0x18) = lVar15;
LAB_00105d36:
  if (((pOVar14 != (Object *)0x0) && (cVar10 = RefCounted::unreference(), cVar10 != '\0')) &&
     (cVar10 = predelete_handler(pOVar14), cVar10 != '\0')) {
    (**(code **)(*(long *)pOVar14 + 0x140))(pOVar14);
    Memory::free_static(pOVar14,false);
  }
  if (((pOVar13 != (Object *)0x0) && (cVar10 = RefCounted::unreference(), cVar10 != '\0')) &&
     (cVar10 = predelete_handler(pOVar13), cVar10 != '\0')) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Voxelizer::plot_mesh(Transform3D const&, Ref<Mesh>&, Vector<Ref<Material> > const&, Ref<Material>
   const&, bool (*)(int, int)) */

undefined8 __thiscall
Voxelizer::plot_mesh
          (Voxelizer *this,Transform3D *param_1,Ref *param_2,Vector *param_3,Ref *param_4,
          _func_bool_int_int *param_5)

{
  ...
  if (cVar7 == '\0') {
    _err_print_error("plot_mesh","scene/3d/voxelizer.cpp",400,
                     "Condition \"!p_xform.is_finite()\" is true. Returning: BAKE_RESULT_INVALID_PARAMETER"
                     ,"Invalid mesh bake transform.",0,0);
    uVar15 = 1;
  }
  else {
    uVar25 = 0;
    ...
    while( true ) {
      ...
      if (iVar10 == 3) {
        ...
        if (local_1e0 == (Object *)0x0) {
          ...
          if (((lVar6 == 0) || (*(long *)(lVar6 + -8) <= (long)local_1e8)) ||
             (pOVar24 = *(Object **)(lVar6 + local_1e8 * 8), pOVar24 == (Object *)0x0)) {
            (**(code **)(**(long **)param_2 + 0x210))
                      (&local_148,*(long **)param_2,local_1e8 & 0xffffffff);
            pOVar24 = local_148;
            ...
            if (cVar7 != '\0') {
              ...
              if (((local_148 != (Object *)0x0) &&
                  (cVar7 = RefCounted::unreference(), pOVar24 = local_148, cVar7 != '\0')) &&
                 (cVar7 = predelete_handler(local_148), cVar7 != '\0')) {
LAB_0010876e:
...
LAB_00107967:
          ...
          if (cVar7 == '\0') {
            ...
            _get_material_cache(local_1c0,this,&local_158);
            cVar7 = RefCounted::unreference();
            if ((cVar7 != '\0') && (cVar7 = predelete_handler(local_1e0), cVar7 != '\0')) {
        ...
        local_1c0 = (MaterialCache *)&local_148;
        (**(code **)(**(long **)param_2 + 0x1e0))
                  (local_190,*(long **)param_2,local_1e8 & 0xffffffff);
...
LAB_00107a51:
            ...
            do {
              ...
              local_68[7] = 0.0;
              local_68[8] = 0.0;
              if (((param_5 != (_func_bool_int_int *)0x0) && ((uVar25 & 0x7ff) == 1)) &&
                 (bVar8 = (*param_5)(uVar25,iVar9), bVar8)) {
              ...
              do {
                ...
                *(ulong *)pfVar12 =
                     CONCAT44(fVar32 * fVar43 + fVar29 * (float)((ulong)uVar15 >> 0x20) +
                              fVar28 * (float)((ulong)uVar2 >> 0x20) + (float)((ulong)uVar4 >> 0x20)
                              ,fVar32 * fVar31 + fVar29 * (float)uVar3 + fVar28 * (float)uVar15 +
                               (float)uVar4);
              ...
              if (lVar22 != 0) {
                lVar16 = 0;
                do {
                  *(undefined8 *)((long)local_68 + lVar16) =
                       *(undefined8 *)(lVar22 + lVar23 + lVar16);
                  *(undefined4 *)((long)local_68 + lVar16 + 8) =
                       *(undefined4 *)(lVar22 + lVar23 + 8 + lVar16);
                  lVar16 = lVar16 + 0xc;
                } while (lVar16 != 0x24);
              }
              fVar26 = (float)*(undefined8 *)(this + 0x5c) * _LC2;
              fVar27 = (float)((ulong)*(undefined8 *)(this + 0x5c) >> 0x20) * _UNK_0010eeec;
                          ...
                          if ((fVar37 <= fVar42) && ((float)((uint)fVar42 ^ _LC54) <= fVar30)) {
                            ...
                            if ((fVar30 <= fVar40) && ((float)((uint)fVar40 ^ _LC54) <= fVar37)) {
                              ...
                              if ((fVar37 <= fVar40) && ((float)((uint)fVar40 ^ _LC54) <= fVar30)) {
                                ...
                                fVar37 = fVar47;
                                if ((fVar46 <= fVar47) &&
                                   (fVar30 = fVar47, fVar37 = fVar46, fVar47 <= fVar46)) {
                                  fVar30 = fVar46;
                                }
                                fVar47 = fVar39;
                                if (fVar39 <= fVar30) {
                                ...
                                if ((fVar39 <= fVar36) && ((float)((uint)fVar36 ^ _LC54) <= fVar47))
                                {
                                  fVar30 = fVar28;
                                  local_1a0 = fVar32;
                                  if ((fVar28 <= fVar32) && (local_1a0 = fVar28, fVar28 < fVar32)) {
                                    fVar30 = fVar32;
                                  }
                                  fVar32 = fVar43;
                                  if (fVar43 <= fVar30) {
                                  ...
                                  if ((fVar43 <= fVar26) &&
                                     ((float)((uint)fVar26 ^ _LC54) <= fVar32)) {
                                    fVar43 = fVar29;
                                    ...
                                    if ((fVar30 <= fVar27) &&
                                       ((float)((uint)fVar27 ^ _LC54) <= fVar31)) {
                                      local_114[5] = 0.0;
                                      local_114[6] = 0.0;
                                      local_114[7] = 0.0;
                                      local_114[8] = 0.0;
                                      ...
                                      fVar31 = fVar46 * local_128 + fVar28 * fStack_124 +
                                               fVar29 * local_120;
                                      lVar16 = 0;
                                      while( true ) {
                                        fVar43 = fVar36;
                                      ...
                                      if ((local_114[5] * local_128 + local_114[6] * fStack_124 +
                                          local_114[7] * local_120) - fVar31 <= 0.0) {
                                        if (0.0 <= (local_128 * local_114[8] +
                                                    fStack_124 * local_114[9] +
                                                   local_120 * local_114[10]) - fVar31) {
                                          _plot_face(this,0,0,0,0,0,(Vector3 *)&local_98,
                                                     (Vector3 *)local_68,(Vector2 *)local_e8,
                                                     local_1c0,(AABB *)(this + 100));
                                        }
                                      }
                                    }
                                  }
...
LAB_001074c9:
            if (local_150 != (int *)0x0) goto LAB_001074d6;
          }
        }
        else {
...
LAB_00107812:
                  ...
                  if (((local_1e0 != (Object *)0x0) &&
                     ...
                     (cVar7 = predelete_handler(local_1e0), cVar7 != '\0')) {
                    (**(code **)(*(long *)local_1e0 + 0x140))(local_1e0);
                    Memory::free_static(local_1e0,false);
                  }
                  uVar15 = 2;
                ...
                do {
                  ...
                  pfVar13 = pfVar12 + 3;
                  piVar17 = piVar17 + 1;
                  puVar18 = (undefined8 *)(lVar6 + (long)iVar10 * 0xc);
                  uVar5 = *puVar18;
                  fVar28 = *(float *)(puVar18 + 1);
                  fVar29 = (float)uVar5;
                  fVar32 = (float)((ulong)uVar5 >> 0x20);
                  *(ulong *)pfVar12 =
                       CONCAT44(fVar32 * fVar27 + fVar29 * (float)((ulong)uVar15 >> 0x20) +
                                fVar28 * (float)((ulong)uVar3 >> 0x20) +
                                (float)((ulong)uVar4 >> 0x20),
                                fVar32 * fVar31 + fVar29 * (float)uVar2 + fVar28 * (float)uVar15 +
                                (float)uVar4);
                  pfVar12[2] = fVar29 * fVar36 + fVar32 * fVar43 + fVar28 * fVar30 + fVar26;
                  pfVar12 = pfVar13;
                } while (local_74 != pfVar13);
                if (lVar21 != 0) {
                  lVar14 = 0;
                  do {
                    local_e8[lVar14] = *(undefined8 *)(lVar21 + (long)piVar20[lVar14] * 8);
                    lVar14 = lVar14 + 1;
                  } while (lVar14 != 3);
                }
                if (lVar22 != 0) {
                  ...
                  piVar17 = piVar20;
                  do {
                    pfVar13 = (float *)(lVar22 + (long)*piVar17 * 0xc);
                    fVar31 = *pfVar13;
                    fVar43 = pfVar13[1];
                    fVar36 = pfVar13[2];
                    fVar26 = local_b0 * fVar31 + local_ac * fVar43 + local_a8 * fVar36;
                    fVar30 = fVar31 * local_bc + fVar43 * local_b8 + fVar36 * local_b4;
                    fVar31 = fVar31 * local_c8 + fVar43 * local_c4 + fVar36 * local_c0;
                    fVar43 = fVar31 * fVar31 + fVar30 * fVar30 + fVar26 * fVar26;
                    if (fVar43 == 0.0) {
                      fVar26 = 0.0;
                      fVar30 = 0.0;
                      fVar31 = 0.0;
                    ...
                    *pfVar12 = fVar31;
                    ...
                    pfVar12[2] = fVar26;
                    pfVar12 = pfVar13;
                  } while (local_68 + 9 != pfVar13);
                }
                fVar26 = (float)*(undefined8 *)(this + 0x5c) * _LC2;
                fVar27 = (float)((ulong)*(undefined8 *)(this + 0x5c) >> 0x20) * _UNK_0010eeec;
                fVar30 = (float)*(undefined8 *)(this + 0x50) + fVar26;
                fVar31 = (float)((ulong)*(undefined8 *)(this + 0x50) >> 0x20) + fVar27;
                fVar28 = fStack_94 - fVar30;
                fVar29 = local_90 - fVar31;
                fVar32 = fStack_88 - fVar30;
                fVar35 = local_84 - fVar31;
                fVar44 = fVar32 - fVar28;
                fVar45 = fVar35 - fVar29;
                fVar31 = local_78 - fVar31;
                fVar30 = local_80._4_4_ - fVar30;
                fVar36 = fVar28 * fVar45 - fVar44 * fVar29;
                fVar39 = fVar30 * fVar45 - fVar31 * fVar44;
                fVar43 = fVar39;
                if (fVar36 < fVar39) {
                  fVar43 = fVar36;
                  fVar36 = fVar39;
                ...
                fVar39 = ABS(fVar45) * fVar26 + ABS(fVar44) * fVar27;
                if ((fVar43 <= fVar39) && ((float)((uint)fVar39 ^ _LC54) <= fVar36)) {
                            ...
                            if ((fVar39 <= fVar42) && ((float)((uint)fVar42 ^ _LC54) <= fVar37)) {
                              ...
                              if ((fVar39 <= fVar40) && ((float)((uint)fVar40 ^ _LC54) <= fVar37)) {
                                ...
                                if ((fVar37 <= fVar40) && ((float)((uint)fVar40 ^ _LC54) <= fVar39))
                                {
                                  ...
                                  fVar37 = fVar48;
                                  if ((fVar46 <= fVar48) &&
                                     (fVar39 = fVar48, fVar37 = fVar46, fVar48 <= fVar46)) {
                                    fVar39 = fVar46;
                                  }
                                  fVar48 = fVar36;
                                  if (fVar36 <= fVar39) {
                                  ...
                                  if ((fVar36 <= fVar43) &&
                                     ((float)((uint)fVar43 ^ _LC54) <= fVar48)) {
                                    fVar39 = fVar28;
                                    fVar36 = fVar32;
                                    if ((fVar28 <= fVar32) && (fVar36 = fVar28, fVar28 < fVar32)) {
                                      fVar39 = fVar32;
                                    }
                                    fVar32 = fVar30;
                                    if (fVar36 <= fVar30) {
                                    ...
                                    if ((fVar32 <= fVar26) &&
                                       ((float)((uint)fVar26 ^ _LC54) <= fVar30)) {
                                      fVar36 = fVar29;
                                      if ((fVar29 <= fVar35) && (fVar29 < fVar35)) {
                                        fVar36 = fVar35;
                                      }
...
LAB_001074d6:
        ...
        if (((local_1e0 != (Object *)0x0) && (cVar7 = RefCounted::unreference(), cVar7 != '\0')) &&
           (cVar7 = predelete_handler(local_1e0), cVar7 != '\0')) {
          (**(code **)(*(long *)local_1e0 + 0x140))(local_1e0);
          Memory::free_static(local_1e0,false);
        }
...
Ref * Voxelizer::create_debug_multimesh(void)
...
LAB_001089e2:
    ...
    do {
      ...
      if (iVar15 < 3) {
        ...
        do {
          ...
          iVar8 = iVar7 + 1;
          puVar12 = puVar12 + 1;
          *(uint *)(auStack_70 + ((long)(iVar7 % 3) + (long)(int)(3 - uVar14) * 3) * 4 + -8) =
               uVar2 ^ _LC54;
          iVar7 = iVar8;
        } while (iVar17 != iVar8);
      }
  ...
  *(undefined ***)this_01 = &PTR__initialize_classv_0010eaf0;
...
LAB_0010938d:
    ...
    if ((pOVar6 != (Object *)0x0) &&
       (local_98 = pOVar6, cVar4 = RefCounted::reference(), cVar4 == '\0')) {
      local_98 = (Object *)0x0;
    }
    (*pcVar16)(local_f0,0,(Vector *)&local_98);
    if ((local_98 != (Object *)0x0) && (cVar4 = RefCounted::unreference(), cVar4 != '\0'))
...
LAB_00108fd2:
  ...
  if (((local_98 != (Object *)0x0) &&
      (cVar4 = RefCounted::unreference(), pOVar6 = local_98, cVar4 != '\0')) &&
     (cVar4 = predelete_handler(local_98), cVar4 != '\0')) {
    (**(code **)(*(long *)pOVar6 + 0x140))(pOVar6);
    Memory::free_static(pOVar6,false);
  }
  local_98 = (Object *)((ulong)local_98 & 0xffffffff00000000);
  _debug_mesh(in_RSI,0,0,(AABB *)(in_RSI + 100),in_RDI,(int *)&local_98);
  cVar4 = RefCounted::unreference();
  if ((cVar4 != '\0') && (cVar4 = predelete_handler(local_f0), cVar4 != '\0')) {
...
void __thiscall Voxelizer::_sort(Voxelizer *this)

{
  ...
  pCVar21 = local_60[0];
  if ((local_60[0] == (CellSort *)0x0) || (lVar23 = *(long *)(local_60[0] + -8), lVar23 == 0)) {
LAB_00109632:
    if (pCVar21 == (CellSort *)0x0) {
      lVar23 = 0;
      goto LAB_00109ccf;
    }
  }
    ...
    pCVar21 = local_60[0];
    if (lVar23 == 1) {
      SortArray<Voxelizer::CellSort,_DefaultComparator<Voxelizer::CellSort>,true>::introsort
                (0,1,local_60[0],0);
      goto LAB_00109632;
    }
    lVar11 = 0;
...
LAB_00109ccf:
    _err_print_index_error
              ("get","./core/templates/cowdata.h",0xdb,0,lVar23,"p_index","size()","",false,true);
    _err_flush_stdout();
                    /* WARNING: Does not return */
    pcVar3 = (code *)invalidInstructionException();
    (*pcVar3)();
...
LAB_00109813:
    ...
    _err_print_error("_sort","scene/3d/voxelizer.cpp",0x227,
                     "Condition \"sorted_cells[0].level != 0\" is true.",0,0);
    LOCK();
    pCVar21 = pCVar21 + -0x10;
    *(long *)pCVar21 = *(long *)pCVar21 + -1;
    lVar23 = *(long *)pCVar21;
...
void __thiscall Voxelizer::end_bake(Voxelizer *this)
...
/* Voxelizer::get_sdf_3d_image(Vector<unsigned char>&, bool (*)(int, int)) const */

undefined8 __thiscall
Voxelizer::get_sdf_3d_image(Voxelizer *this,Vector *param_1,_func_bool_int_int *param_2)

{
  ...
  iVar19 = *(int *)(this + 0x80);
  uVar8 = *(uint *)(this + 0x7c);
  iVar1 = *(int *)(this + 0x84);
  uVar6 = iVar19 * uVar8 * iVar1;
  uVar9 = (ulong)uVar6;
  if (uVar9 != 0) {
    ...
    do {
      *puVar11 = uVar3;
      puVar11 = puVar11 + 1;
    } while (puVar11 != puVar10 + uVar9);
  }
  lVar2 = *(long *)(this + 8);
  iVar7 = iVar19 * uVar8;
  if ((lVar2 != 0) && (iVar13 = (int)*(undefined8 *)(lVar2 + -8), iVar13 != 0)) {
    iVar18 = *(int *)(this + 0x10);
    puVar12 = (ushort *)(lVar2 + 0x4c);
    do {
      if (iVar18 <= (int)(uint)puVar12[3]) {
        puVar10[(uint)puVar12[2] * iVar7 + puVar12[1] * uVar8 + (uint)*puVar12] = 0;
      }
      puVar12 = puVar12 + 0x2a;
    } while ((ushort *)(lVar2 + 0xa0 + (ulong)(iVar13 - 1) * 0x54) != puVar12);
  }
  iVar13 = iVar19 + uVar8 * 2;
  if ((int)uVar8 < 1) {
    local_58 = 0;
  }
  else {
    uVar15 = 0;
    if (param_2 != (_func_bool_int_int *)0x0) goto LAB_0010a3ba;
    if (0 < iVar19) {
      while( true ) {
        iVar18 = 0;
        uVar20 = uVar15;
        do {
          iVar18 = iVar18 + 1;
          edt((float *)(puVar10 + uVar20),iVar19 * uVar8,iVar1);
...
LAB_0010a3ba:
          while( true ) {
            bVar4 = (*param_2)((int)uVar15,iVar13);
            if (bVar4) goto LAB_0010a420;
            if (0 < iVar19) break;
            uVar14 = (int)uVar15 + 1;
            uVar15 = (ulong)uVar14;
            if (uVar8 == uVar14) goto LAB_0010a209;
          }
        }
      }
    }
LAB_0010a209:
    ...
    do {
      iVar18 = (int)uVar15;
      if ((param_2 != (_func_bool_int_int *)0x0) && (bVar4 = (*param_2)(local_58,iVar13), bVar4))
      goto LAB_0010a420;
      iVar16 = 0;
      if (0 < iVar1) {
        do {
          iVar16 = iVar16 + 1;
          edt((float *)(puVar10 + uVar15),uVar8,iVar19);
          uVar15 = (ulong)(uint)((int)uVar15 + iVar7);
        } while (iVar16 != iVar1);
      }
      uVar14 = iVar18 + 1;
      uVar15 = (ulong)uVar14;
...
LAB_0010a420:
      ...
      if (0 < iVar1) {
        do {
          ...
          iVar19 = iVar19 + 1;
          uVar17 = uVar17 + iVar7;
          edt((float *)(puVar10 + uVar15),1,uVar8);
        } while (iVar19 != iVar1);
      }
      local_58 = local_58 + 1;
...
/* Voxelizer::get_voxel_gi_data_cells() const */

void Voxelizer::get_voxel_gi_data_cells(void)
  ...
  *(undefined8 *)(in_RDI + 8) = 0;
  ...
  if ((lVar14 != 0) && (uVar3 = *(ulong *)(lVar14 + -8), (int)uVar3 != 0)) {
    ...
    do {
      ...
      *(uint *)(lVar2 + (ulong)uVar10 * 4) =
           (uint)*(ushort *)((long)pfVar9 + 0x2e) << 0xb | (uint)*(ushort *)(pfVar9 + 0xc) << 0x15 |
           (uint)*(ushort *)(pfVar9 + 0xb);
      uVar12 = 0;
      if ((0.0 <= dVar18) && (uVar12 = 0xff000000, dVar18 <= dVar5)) {
...
LAB_0010a573:
        *puVar1 = uVar11;
        ...
        if (fVar13 <= _LC73) {
          fVar22 = fVar13;
          if (0.0 <= fVar17) goto LAB_0010a875;
          if (0.0 <= fVar19) {
            fVar17 = 0.0;
            goto joined_r0x0010a548;
          }
...
LAB_0010a875:
            ...
            if (0.0 <= fVar19) goto joined_r0x0010a548;
            fVar19 = 0.0;
          }
          else {
            uVar11 = 0xf80001ff;
            if (fVar19 < 0.0) goto LAB_0010a573;
            fVar17 = 0.0;
joined_r0x0010a548:
            if (_LC73 < fVar19) {
        ...
        if (fVar13 <= fVar21) {
          ...
          uVar11 = (int)(fVar17 + fVar13) << 9 | (int)(fVar19 + fVar13) << 0x12 |
                   (int)fVar13 * 0x10 + 0x10000000U | (uint)(fVar22 + fVar13) & 0x1ff;
          goto LAB_0010a573;
        }
        fVar13 = (float)((int)fVar13 + 0x7804000U & 0x7f800000);
        *puVar1 = (int)(fVar17 + fVar13) << 9 | (int)(fVar19 + fVar13) << 0x12 |
                  (int)fVar13 * 0x10 + 0x10000000U | (uint)(fVar22 + fVar13) & 0x1ff;
      }
      if ((long)uVar3 <= (long)uVar15) {
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,uVar15,uVar3,"p_index","size()","",false,
                   true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar4 = (code *)invalidInstructionException();
...
LAB_0010a5cf:
        ...
        uVar16 = 0x800000;
        if (dVar7 <= dVar18) goto LAB_0010a5cf;
      }
      uVar15 = uVar15 + 1;
      pfVar9 = pfVar9 + 0x15;
...
/* Voxelizer::get_voxel_gi_octree_cells() const */

void Voxelizer::get_voxel_gi_octree_cells(void)

{
  ...
  *(undefined8 *)(in_RDI + 8) = 0;
  ...
  lVar7 = *(long *)(in_RSI + 8);
  lVar3 = *(long *)(in_RDI + 8);
  if ((lVar7 != 0) && (iVar5 = (int)*(undefined8 *)(lVar7 + -8), iVar5 != 0)) {
    iVar8 = 0;
    lVar2 = lVar7 + 0x54;
    do {
      lVar6 = 0;
...

{
  ...
  return (uint)CONCAT71(0x10ec,in_RSI == &BaseMaterial3D::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x10ec,in_RSI == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x10ed,in_RSI == &Material::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x10ed,in_RSI == &Resource::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x10ed,in_RSI == &RefCounted::get_class_ptr_static()::ptr) |
...
{
  *(undefined ***)this = &PTR__initialize_classv_0010eaf0;
...
/* CowData<Voxelizer::Cell>::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<Voxelizer::Cell>::_copy_on_write(void)
...
/* CowData<Voxelizer::CellSort>::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<Voxelizer::CellSort>::_copy_on_write(void)
...
/* Error CowData<Voxelizer::Cell>::resize<false>(long) [clone .isra.0] [clone .cold] */

void CowData<Voxelizer::Cell>::resize<false>(long param_1)
...
LAB_0010b718:
    ...
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_0010b718;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)pLVar6;
      local_68 = local_80;
      goto joined_r0x0010b736;
    }
...
LAB_0010c948:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_0010c948;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x0010c965;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
LAB_0010cd98:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_0010cd98;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x0010cdb5;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
/* HashMap<Ref<Material>, Voxelizer::MaterialCache, HashMapHasherDefault,
   ...
   Voxelizer::MaterialCache> > >::operator[](Ref<Material> const&) */

undefined1 * __thiscall
HashMap<Ref<Material>,Voxelizer::MaterialCache,HashMapHasherDefault,HashMapComparatorDefault<Ref<Material>>,DefaultTypedAllocator<HashMapElement<Ref<Material>,Voxelizer::MaterialCache>>>
::operator[](HashMap<Ref<Material>,Voxelizer::MaterialCache,HashMapHasherDefault,HashMapComparatorDefault<Ref<Material>>,DefaultTypedAllocator<HashMapElement<Ref<Material>,Voxelizer::MaterialCache>>>
             *this,Ref *param_1)
  ...
  if (local_98 == (void *)0x0) {
    ...
    *(void **)(this + 8) = local_98;
    if (uVar50 == 0) {
      ...
      if (local_98 == (void *)0x0) goto LAB_0010d2c5;
    }
    else {
      pvVar4 = *(void **)(this + 0x10);
      if ((local_98 < (void *)((long)pvVar4 + uVar42)) &&
         (pvVar4 < (void *)((long)local_98 + uVar40))) {
        uVar42 = 0;
        do {
    ...
    if (iVar46 == 0) {
      ...
      if (uVar47 != 0) {
        uVar54 = 0;
        do {
          if ((uVar47 == (uint)uVar56) &&
             (pOVar52 == *(Object **)(*(long *)((long)local_98 + lVar48 * 8) + 0x10))) {
          ...
          uVar55 = SUB164(auVar6 * auVar22,8);
                ...
                (auVar7._8_8_ = 0, auVar7._0_8_ = (ulong)uVar47 * lVar3, auVar23._8_8_ = 0,
                auVar23._0_8_ = uVar58, auVar8._8_8_ = 0,
                auVar8._0_8_ = (ulong)((uVar55 + uVar50) - SUB164(auVar7 * auVar23,8)) * lVar3,
                auVar24._8_8_ = 0, auVar24._0_8_ = uVar58, uVar54 <= SUB164(auVar8 * auVar24,8)));
      }
      local_60[0] = 0;
      local_50[0] = 0;
LAB_0010d75a:
      uVar56 = CONCAT44(0,*(uint *)(hash_table_size_primes + uVar42 * 4));
      lVar3 = *(long *)(hash_table_size_primes_inv + uVar42 * 8);
      uVar40 = (long)pOVar52 * 0x3ffff - 1;
      uVar40 = (uVar40 ^ uVar40 >> 0x1f) * 0x15;
      uVar40 = (uVar40 ^ uVar40 >> 0xb) * 0x41;
      ...
      if (uVar50 != 0) {
        uVar55 = 0;
        do {
          if ((uVar50 == (uint)uVar59) &&
             (*(Object **)(*(long *)((long)local_98 + lVar48 * 8) + 0x10) == pOVar52)) {
          ...
          uVar47 = SUB164(auVar18 * auVar34,8);
                ...
                (auVar19._8_8_ = 0, auVar19._0_8_ = (ulong)uVar50 * lVar3, auVar35._8_8_ = 0,
                auVar35._0_8_ = uVar56, auVar20._8_8_ = 0,
                auVar20._0_8_ =
                     (ulong)((*(uint *)(hash_table_size_primes + uVar42 * 4) + uVar47) -
                            SUB164(auVar19 * auVar35,8)) * lVar3, auVar36._8_8_ = 0,
                auVar36._0_8_ = uVar56, uVar55 <= SUB164(auVar20 * auVar36,8)));
      }
    }
  }
LAB_0010d2c5:
  if ((float)uVar58 * __LC40 < (float)(iVar46 + 1)) {
  ...
  if ((pOVar52 == (Object *)0x0) || (cVar38 = RefCounted::reference(), cVar38 == '\0')) {
    ...
    *pauVar44 = (undefined1  [16])0x0;
    ...
    if (puVar45 != (undefined8 *)0x0) goto LAB_0010d5ad;
LAB_0010d542:
    ...
    *(undefined8 *)pauVar44[3] = 0;
    ...
    if ((cVar38 != '\0') && (cVar38 = predelete_handler(pOVar52), cVar38 != '\0')) {
      (**(code **)(*(long *)pOVar52 + 0x140))(pOVar52);
      Memory::free_static(pOVar52,false);
    }
    puVar45 = *(undefined8 **)(this + 0x20);
    if (puVar45 == (undefined8 *)0x0) goto LAB_0010d542;
LAB_0010d5ad:
    *puVar45 = pauVar44;
...
LAB_0010e36c:
    ...
    lVar3 = puVar9[-1];
    if (param_1 <= lVar3) goto LAB_0010e2fb;
  }
  else {
    if (lVar8 != 0) {
...
/* CowData<Voxelizer::Cell>::_realloc(long) */

undefined8 __thiscall
CowData<Voxelizer::Cell>::_realloc(CowData<Voxelizer::Cell> *this,long param_1)
...
LAB_0010e85c:
    ...
    lVar4 = puVar8[-1];
    if (param_1 <= lVar4) goto LAB_0010e7f4;
  }
  else {
    if (lVar10 != 0) {
...
/* CowData<Voxelizer::CellSort>::_realloc(long) */

undefined8 __thiscall
CowData<Voxelizer::CellSort>::_realloc(CowData<Voxelizer::CellSort> *this,long param_1)

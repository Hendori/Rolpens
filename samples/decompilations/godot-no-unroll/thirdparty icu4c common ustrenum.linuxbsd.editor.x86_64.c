...
/* icu_76_godot::StringEnumeration::clone() const */

undefined8 icu_76_godot::StringEnumeration::clone(void)
...
/* icu_76_godot::UStringEnumeration::getDynamicClassID() const */

undefined1 * icu_76_godot::UStringEnumeration::getDynamicClassID(void)
...
/* icu_76_godot::StringEnumeration::unext(int*, UErrorCode&) */

undefined8 __thiscall
icu_76_godot::StringEnumeration::unext(StringEnumeration *this,int *param_1,UErrorCode *param_2)
...
/* icu_76_godot::UStringEnumeration::count(UErrorCode&) const */

void icu_76_godot::UStringEnumeration::count(UErrorCode *param_1)
...
/* icu_76_godot::UStringEnumeration::next(int*, UErrorCode&) */

void icu_76_godot::UStringEnumeration::next(int *param_1,UErrorCode *param_2)
...
/* icu_76_godot::UStringEnumeration::snext(UErrorCode&) */

long __thiscall
icu_76_godot::UStringEnumeration::snext(UStringEnumeration *this,UErrorCode *param_1)

{
  ...
  if (lVar1 != 0) {
    if (*(int *)param_1 < 1) {
      ...
      lVar1 = icu_76_godot::UnicodeString::doReplace
                        ((int)this + 8,0,(wchar16 *)(ulong)uVar2,(int)lVar1,0);
    }
    else {
      lVar1 = 0;
    }
...
/* icu_76_godot::UStringEnumeration::reset(UErrorCode&) */

void icu_76_godot::UStringEnumeration::reset(UErrorCode *param_1)
...
/* icu_76_godot::StringEnumeration::next(int*, UErrorCode&) */

undefined8 __thiscall
icu_76_godot::StringEnumeration::next(StringEnumeration *this,int *param_1,UErrorCode *param_2)
...
LAB_00100345:
        ...
        icu_76_godot::UnicodeString::extract
                  ((UnicodeString *)(this + 8),0,0x7fffffff,pSVar3,*(undefined4 *)(this + 0x70),0);
...
undefined8 __thiscall
icu_76_godot::StringEnumeration::operator==(StringEnumeration *this,StringEnumeration *param_1)
...
/* icu_76_godot::UStringEnumeration::~UStringEnumeration() */

void __thiscall icu_76_godot::UStringEnumeration::~UStringEnumeration(UStringEnumeration *this)

{
  *(undefined ***)this = &PTR__UStringEnumeration_00100c78;
  uenum_close_76_godot(*(undefined8 *)(this + 0x78));
  *(undefined **)this = &DAT_00100c10;
  if ((*(UStringEnumeration **)(this + 0x68) != (UStringEnumeration *)0x0) &&
...

{
  ...
  if (this != (UObject *)0x0) {
    ...
    *(undefined ***)this = &PTR__UStringEnumeration_00100c78;
    uenum_close_76_godot(*(undefined8 *)(this + 0x78));
    *(undefined **)this = &DAT_00100c10;
    if ((*(UObject **)(this + 0x68) != (UObject *)0x0) &&
       (*(UObject **)(this + 0x68) != this + 0x48)) {
      uprv_free_76_godot();
    }
    icu_76_godot::UnicodeString::~UnicodeString((UnicodeString *)(this + 8));
...
/* icu_76_godot::StringEnumeration::StringEnumeration() */

void __thiscall icu_76_godot::StringEnumeration::StringEnumeration(StringEnumeration *this)
...
{
  *(undefined **)this = &DAT_00100c10;
  if ((*(StringEnumeration **)(this + 0x68) != (StringEnumeration *)0x0) &&
     (*(StringEnumeration **)(this + 0x68) != this + 0x48)) {
    uprv_free_76_godot();
  }
  icu_76_godot::UnicodeString::~UnicodeString((UnicodeString *)(this + 8));
...
/* icu_76_godot::StringEnumeration::ensureCharsCapacity(int, UErrorCode&) */

void __thiscall
icu_76_godot::StringEnumeration::ensureCharsCapacity
          (StringEnumeration *this,int param_1,UErrorCode *param_2)
...
/* icu_76_godot::StringEnumeration::setChars(char const*, int, UErrorCode&) */
...
/* icu_76_godot::StringEnumeration::snext(UErrorCode&) */

void __thiscall icu_76_godot::StringEnumeration::snext(StringEnumeration *this,UErrorCode *param_1)
...
/* icu_76_godot::UStringEnumeration::fromUEnumeration(UEnumeration*, UErrorCode&) */

undefined8 *
icu_76_godot::UStringEnumeration::fromUEnumeration(UEnumeration *param_1,UErrorCode *param_2)
...
/* icu_76_godot::UStringEnumeration::UStringEnumeration(UEnumeration*) */

void __thiscall
icu_76_godot::UStringEnumeration::UStringEnumeration(UStringEnumeration *this,UEnumeration *param_1)
...
/* icu_76_godot::UStringEnumeration::getStaticClassID() */

undefined1 * icu_76_godot::UStringEnumeration::getStaticClassID(void)
...

{
  ...
  if (*(code **)(*(long *)param_1 + 8) == icu_76_godot::UStringEnumeration::~UStringEnumeration) {
    ...
    *(undefined **)param_1 = &DAT_00100c10;
    if ((*(UObject **)(param_1 + 0x68) != (UObject *)0x0) &&
       (*(UObject **)(param_1 + 0x68) != param_1 + 0x48)) {
      uprv_free_76_godot();
    }

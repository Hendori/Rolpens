...
/* Color::set_hsv(float, float, float, float) [clone .part.0] */

void Color::set_hsv(float param_1,float param_2,float param_3,float param_4)

{
  ...
  if ((float)((uint)fVar3 & _LC10) < _LC6) {
    fVar1 = (float)((uint)((float)(int)fVar3 -
                          (float)(-(uint)(fVar3 < (float)(int)fVar3) & (uint)_LC8)) |
                   ~_LC10 & (uint)fVar3);
  }
...
uint __thiscall Color::to_argb32(Color *this)

{
  ...
  return (int)fVar4 & 0xffU |
         ((int)fVar3 & 0xffU | ((int)fVar2 & 0xffU | ((int)fVar1 & 0xffU) << 8) << 8) << 8;
}



/* Color::to_abgr32() const */

uint __thiscall Color::to_abgr32(Color *this)
...
/* Color::to_rgba32() const */

uint __thiscall Color::to_rgba32(Color *this)
...
/* Color::to_abgr64() const */

ulong __thiscall Color::to_abgr64(Color *this)

{
  ...
  return (ulong)((int)fVar4 & 0xffff) |
         ((ulong)((int)fVar3 & 0xffff) |
         ((ulong)((int)fVar2 & 0xffff) | (ulong)((int)fVar1 & 0xffff) << 0x10) << 0x10) << 0x10;
}



/* Color::to_argb64() const */

ulong __thiscall Color::to_argb64(Color *this)
...
/* Color::to_rgba64() const */

ulong __thiscall Color::to_rgba64(Color *this)
...
/* Color::to_html(bool) const */

String * Color::to_html(bool param_1)
...
undefined8 __thiscall Color::get_h(Color *this)
...
LAB_001009e1:
    if (fVar2 <= fVar3) goto LAB_00100990;
    fVar6 = fVar2 - fVar6;
    if (fVar6 == 0.0) {
      return 0;
    }
LAB_001009f8:
    auVar4 = ZEXT416((uint)((fVar1 - fVar3) / fVar6));
  }
  else {
    fVar6 = fVar2;
    if (fVar3 <= fVar2) {
...
LAB_00100a03:
  auVar4._0_4_ = auVar4._0_4_ / _LC5;
  if (0.0 <= auVar4._0_4_) {
    return auVar4._0_8_;
  }
...
float __thiscall Color::get_s(Color *this)
...
float __thiscall Color::get_v(Color *this)
...
/* Color::set_hsv(float, float, float, float) */

void __thiscall Color::set_hsv(Color *this,float param_1,float param_2,float param_3,float param_4)
...
/* Color::set_ok_hsl(float, float, float, float) */

void Color::set_ok_hsl(float param_1,float param_2,float param_3,float param_4)
...
/* Color::is_equal_approx(Color const&) const */

undefined4 __thiscall Color::is_equal_approx(Color *this,Color *param_1)
...
/* Color::clamp(Color const&, Color const&) const */

undefined1  [16] __thiscall Color::clamp(Color *this,Color *param_1,Color *param_2)
...
void __thiscall Color::invert(Color *this)

{
  *(ulong *)this =
       CONCAT44(_UNK_0010763c - (float)((ulong)*(undefined8 *)this >> 0x20),
                _LC8 - (float)*(undefined8 *)this);
...
/* Color::hex(unsigned int) */

undefined1  [16] Color::hex(uint param_1)
...
/* Color::hex64(unsigned long) */

undefined1  [16] Color::hex64(ulong param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Color::html(String const&) */

undefined1  [16] Color::html(String *param_1)
      ...
      if ((uint)uVar12 < 2) {
        ...
        if ((long)uVar12 < 1) {
          _err_print_index_error
                    ("get","./core/templates/cowdata.h",0xdb,0,uVar12,"p_index","size()","",false,
                     true);
          _err_flush_stdout();
...
LAB_001010ed:
          ...
          uVar11 = 0x15a;
LAB_00101158:
          _err_print_error(&_LC124,"core/math/color.cpp",uVar11,pcVar10,&local_48,0,0);
          piVar5 = local_48;
          if (local_48 != (int *)0x0) {
            LOCK();
            plVar1 = (long *)(local_48 + -4);
...
/* Color::html_is_valid(String const&) */

ulong Color::html_is_valid(String *param_1)
...
LAB_00101763:
        ...
        uVar8 = 1;
LAB_0010180f:
        if (local_40 == (int *)0x0) goto LAB_00101786;
      }
      piVar3 = local_40;
      LOCK();
      plVar1 = (long *)(local_40 + -4);
...
/* Color::get_named_color_count() */

undefined8 Color::get_named_color_count(void)
...
/* Color::get_named_color_name(int) */

Color * __thiscall Color::get_named_color_name(Color *this,int param_1)

{
  ...
  if ((uint)param_1 < 0x92) {
    *(undefined8 *)this = 0;
    ...
    _err_print_index_error
              ("get_named_color_name","core/math/color.cpp",0x1be,(long)param_1,0x92,"p_idx",
               "get_named_color_count()","",false,false);
    *(undefined8 *)this = 0;
    String::parse_latin1((StrRange *)this);
  }
...
/* Color::get_named_color(int) */

undefined1  [16] Color::get_named_color(int param_1)

{
  ...
  _err_print_index_error
            ("get_named_color","core/math/color.cpp",0x1c3,(long)param_1,0x92,"p_idx",
             "get_named_color_count()","",false,false);
...
/* Color::from_hsv(float, float, float, float) */

undefined1  [16] Color::from_hsv(float param_1,float param_2,float param_3,float param_4)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Color::from_rgbe9995(unsigned int) */

void Color::from_rgbe9995(uint param_1)
...
/* Color::from_rgba8(long, long, long, long) */

undefined1  [16] Color::from_rgba8(long param_1,long param_2,long param_3,long param_4)
...
Color * __thiscall Color::operator_cast_to_String(Color *this)
...
undefined1  [16] __thiscall Color::operator+(Color *this,Color *param_1)
...
/* Color::TEMPNAMEPLACEHOLDERVALUE(Color const&) */

void __thiscall Color::operator+=(Color *this,Color *param_1)
...
/* Color::TEMPNAMEPLACEHOLDERVALUE(float) const */

undefined1  [16] __thiscall Color::operator*(Color *this,float param_1)
...
/* Color::TEMPNAMEPLACEHOLDERVALUE(float) */

void __thiscall Color::operator*=(Color *this,float param_1)
...
/* Color::TEMPNAMEPLACEHOLDERVALUE() const */

undefined1  [16] __thiscall Color::operator-(Color *this)
...
/* Color::from_ok_hsl(float, float, float, float) */

undefined1  [16] Color::from_ok_hsl(float param_1,float param_2,float param_3,float param_4)
...
/* Color::get_ok_hsl_h() const */

float __thiscall Color::get_ok_hsl_h(Color *this)
...
/* Color::get_ok_hsl_s() const */

float __thiscall Color::get_ok_hsl_s(Color *this)
...
/* Color::get_ok_hsl_l() const */

uint __thiscall Color::get_ok_hsl_l(Color *this)
...
/* Color::find_named_color(String const&) */

undefined4 Color::find_named_color(String *param_1)
...
LAB_001027aa:
    if (find_named_color(String_const&)::named_colors_hashmap._44_4_ != 0) goto LAB_001027b8;
LAB_001028ad:
    puVar24 = &named_colors;
    iVar22 = 0;
    do {
      local_60 = 0;
      pcVar4 = (char *)*puVar24;
      ...
      piVar17 = (int *)HashMap<String,int,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,int>>>
                       ::operator[]((HashMap<String,int,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,int>>>
                                     *)find_named_color(String_const&)::named_colors_hashmap,
                                    (String *)&local_58);
      pcVar4 = local_58;
      *piVar17 = iVar22;
    ...
    if ((find_named_color(String_const&)::named_colors_hashmap._8_8_ == 0) ||
       (find_named_color(String_const&)::named_colors_hashmap._44_4_ == 0)) goto LAB_001027c6;
  }
  else {
    if (local_68 != (char *)0x0) {
      LOCK();
    ...
    local_68 = local_58;
LAB_0010279b:
    if (find_named_color(String_const&)::named_colors_hashmap != '\0') goto LAB_001027aa;
LAB_00102849:
    iVar22 = __cxa_guard_acquire(&find_named_color(String_const&)::named_colors_hashmap);
    if (iVar22 == 0) goto LAB_001027aa;
    find_named_color(String_const&)::named_colors_hashmap._40_8_ = 2;
    find_named_color(String_const&)::named_colors_hashmap._8_16_ = (undefined1  [16])0x0;
    find_named_color(String_const&)::named_colors_hashmap._24_16_ = (undefined1  [16])0x0;
    __cxa_atexit(HashMap<String,int,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,int>>>
                 ::~HashMap,find_named_color(String_const&)::named_colors_hashmap,&__dso_handle);
    __cxa_guard_release(&find_named_color(String_const&)::named_colors_hashmap);
    if (find_named_color(String_const&)::named_colors_hashmap._44_4_ == 0) goto LAB_001028ad;
LAB_001027b8:
    if (find_named_color(String_const&)::named_colors_hashmap._8_8_ == 0) goto LAB_001027c6;
  }
  uVar2 = *(uint *)(hash_table_size_primes +
                   (find_named_color(String_const&)::named_colors_hashmap._40_8_ & 0xffffffff) * 4);
  uVar25 = CONCAT44(0,uVar2);
  lVar3 = *(long *)(hash_table_size_primes_inv +
                   (find_named_color(String_const&)::named_colors_hashmap._40_8_ & 0xffffffff) * 8);
  uVar15 = String::hash();
  uVar18 = 1;
  if (uVar15 != 0) {
    uVar18 = uVar15;
  ...
  auVar5._8_8_ = 0;
  auVar5._0_8_ = (ulong)uVar18 * lVar3;
  auVar9._8_8_ = 0;
  auVar9._0_8_ = uVar25;
  lVar20 = SUB168(auVar5 * auVar9,8);
  uVar15 = *(uint *)(find_named_color(String_const&)::named_colors_hashmap._16_8_ + lVar20 * 4);
  uVar19 = SUB164(auVar5 * auVar9,8);
  if (uVar15 != 0) {
    uVar26 = 0;
    lVar23 = find_named_color(String_const&)::named_colors_hashmap._16_8_;
    do {
      if (uVar15 == uVar18) {
        cVar14 = String::operator==((String *)
                                    (*(long *)(find_named_color(String_const&)::named_colors_hashmap
                                               ._8_8_ + lVar20 * 8) + 0x10),(String *)&local_68);
        if (cVar14 != '\0') {
          lVar3 = *(long *)(find_named_color(String_const&)::named_colors_hashmap._8_8_ +
                           (ulong)uVar19 * 8);
          if (lVar3 != 0) {
            uVar21 = *(undefined4 *)(lVar3 + 0x18);
            goto LAB_001027cb;
          }
          break;
        }
      ...
      uVar26 = uVar26 + 1;
      auVar6._8_8_ = 0;
      auVar6._0_8_ = (ulong)(uVar19 + 1) * lVar3;
      auVar10._8_8_ = 0;
      auVar10._0_8_ = uVar25;
      lVar20 = SUB168(auVar6 * auVar10,8);
      uVar15 = *(uint *)(lVar23 + lVar20 * 4);
      uVar19 = SUB164(auVar6 * auVar10,8);
      if ((uVar15 == 0) ||
         (auVar7._8_8_ = 0, auVar7._0_8_ = (ulong)uVar15 * lVar3, auVar11._8_8_ = 0,
         auVar11._0_8_ = uVar25, auVar8._8_8_ = 0,
         auVar8._0_8_ = (ulong)((uVar2 + uVar19) - SUB164(auVar7 * auVar11,8)) * lVar3,
         auVar12._8_8_ = 0, auVar12._0_8_ = uVar25, SUB164(auVar8 * auVar12,8) < uVar26)) break;
    } while( true );
  }
LAB_001027c6:
  uVar21 = 0xffffffff;
...
undefined1  [16] Color::named(String *param_1)

{
  ...
  if (iVar4 == -1) {
    ...
    String::operator+((String *)&local_48,(String *)&local_58);
    _err_print_error("named","core/math/color.cpp",0x192,
                     "Method/function failed. Returning: Color()",(String *)&local_48,0,0);
    puVar3 = local_48;
...
undefined1  [16] Color::named(String *param_1,Color *param_2)
...
::~HashMap(HashMap<String,int,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,int>>>
           *this)
...

{
  ...
  fVar9 = _LC13;
  fVar10 = _LC14;
  if ((_LC36 * param_1 - _LC37 * param_2 <= _LC8) &&
     (fVar1 = _LC34, fVar2 = _LC31, fVar3 = _LC32, fVar5 = _LC28, fVar4 = _LC33, fVar6 = _LC35,
     fVar9 = _LC29, fVar10 = _LC30, _LC8 < _LC38 * param_1 - _LC39 * param_2)) {
    fVar1 = _LC26;
    fVar2 = _LC23;
    fVar3 = _LC24;
    fVar5 = _LC20;
  ...
  fVar1 = fVar1 * param_1 + fVar6 + fVar4 * param_2 + fVar3 * param_1 * param_1 +
  ...
  fVar4 = fVar11 * fVar11 * fVar11 * fVar10 + fVar7 * fVar7 * fVar7 * fVar9 +
          fVar6 * fVar6 * fVar6 * fVar5;
  fVar2 = fVar12 * _LC46 * fVar11 * fVar11 * fVar10 + fVar8 * _LC46 * fVar7 * fVar7 * fVar9 +
          _LC46 * fVar3 * fVar6 * fVar6 * fVar5;
  return fVar1 - (fVar4 * fVar2) /
                 (fVar2 * fVar2 -
                 (fVar12 * _LC5 * fVar12 * fVar11 * fVar10 + fVar7 * fVar8 * fVar8 * _LC5 * fVar9 +
                 _LC5 * fVar3 * fVar3 * fVar6 * fVar5) * fVar4 * _LC47);
}
...
ulong ok_color::find_gamut_intersection
...

{
  ...
  fVar5 = fVar5 * fVar5 * fVar5;
  fVar4 = fVar4 * fVar4 * fVar4;
  fVar3 = fmaxf((fVar2 * _LC14 - fVar5 * _LC50) + fVar4 * _LC12,
                (_LC22 * fVar2 + _LC21 * fVar5) - _LC51 * fVar4);
  ...
  fVar2 = (_LC8 / (((((_LC56 * param_3 - __LC57) + _LC58 * param_2) * param_2 +
                    (_LC60 - _LC59 * param_3)) * param_2 + (_LC61 * param_3 - __LC62)) * param_2 +
                  _LC63 * param_3 + __LC64) + __LC65) * param_1;
  fVar1 = (_LC8 / (((((_LC67 - _LC66 * param_3) - _LC68 * param_2) * param_2 +
                    (_LC69 * param_3 - __LC70)) * param_2 + _LC71 * param_3 + __LC72) * param_2 +
                  (_LC74 - param_3 * __LC73)) + __LC75) * fVar3;
  ...
  fVar1 = _LC8 / (_LC8 / (param_1 * __LC77 * param_1 * __LC77) +
                 _LC8 / (fVar3 * _LC78 * fVar3 * _LC78));
  if (fVar1 < 0.0) {
    sqrtf(fVar1);
  }
  return;
...
undefined8 __thiscall ok_color::okhsl_to_srgb(undefined8 param_1,float param_2)
  ...
  if (param_2 == _LC8) {
    ...
    if (_LC78 <= fVar2) {
      ...
      local_14._4_4_ =
           ...
           (_LC8 - (_LC8 - (float)local_14 / (auVar6._8_4_ - local_14._4_4_)) * fVar2) +
           local_14._4_4_;
    }
    else {
      local_14._4_4_ =
           (fVar2 * _LC84 * _LC78 * (float)local_14) /
           (_LC8 - fVar2 * _LC84 * (_LC8 - (_LC78 * (float)local_14) / local_14._4_4_));
    }
...
undefined8 __thiscall ok_color::srgb_to_okhsl(undefined8 param_1,float param_2)
...
joined_r0x001058f6:
  ...
  if (uStack_10 <= fVar3) {
    ...
    fVar2 = ((fVar3 - uStack_10) /
            (local_14 + (_LC8 - local_14 / (fVar6 - uStack_10)) * (fVar3 - uStack_10))) * _LC85 +
            _LC78;
  }
  else {
...
LAB_00105b74:
    if ((float)uVar39 * __LC140 < (float)(iVar45 + 1)) goto LAB_00105b9a;
  }
  local_58 = 0;
  if (*(long *)param_1 == 0) {

...
/* JPH::SoftBodyCreationSettings::sCreateRTTI(JPH::RTTI&) */

void JPH::SoftBodyCreationSettings::sCreateRTTI(RTTI *param_1)
...
void JPH::GetRTTIOfType(JPH::SoftBodyCreationSettings*)::{lambda()#1}::_FUN(void)
...

{
  ...
  if (GetRTTIOfType(JPH::SoftBodyCreationSettings*)::rtti == '\0') {
    ...
    if (iVar1 != 0) {
      JPH::RTTI::RTTI((RTTI *)GetRTTIOfType(JPH::SoftBodyCreationSettings*)::rtti,
                      "SoftBodyCreationSettings",0x70,
                      GetRTTIOfType(JPH::SoftBodyCreationSettings*)::{lambda()#1}::_FUN,
                      GetRTTIOfType(JPH::SoftBodyCreationSettings*)::{lambda(void*)#1}::_FUN,
                      SoftBodyCreationSettings::sCreateRTTI);
      __cxa_atexit(RTTI::~RTTI,GetRTTIOfType(JPH::SoftBodyCreationSettings*)::rtti,&__dso_handle);
      __cxa_guard_release(&GetRTTIOfType(JPH::SoftBodyCreationSettings*)::rtti);
...
/* JPH::SoftBodyCreationSettings::SaveBinaryState(JPH::StreamOut&) const */
...
/* JPH::SoftBodyCreationSettings::RestoreBinaryState(JPH::StreamIn&) */

void __thiscall
JPH::SoftBodyCreationSettings::RestoreBinaryState(SoftBodyCreationSettings *this,StreamIn *param_1)

{
  ...
  (**(code **)(*(long *)param_1 + 0x10))(param_1,this + 0x30,8);
  (**(code **)(*(long *)param_1 + 0x10))(param_1,this + 0x38,2);
  JPH::CollisionGroup::RestoreBinaryState((StreamIn *)(this + 0x40));
  (**(code **)(*(long *)param_1 + 0x10))(param_1,this + 0x50,4);
  (**(code **)(*(long *)param_1 + 0x10))(param_1,this + 0x54,4);
  (**(code **)(*(long *)param_1 + 0x10))(param_1,this + 0x58,4);
  (**(code **)(*(long *)param_1 + 0x10))(param_1,this + 0x5c,4);
  ...
  (**(code **)(*(long *)param_1 + 0x10))(param_1,this + 0x6c,1);
  (**(code **)(*(long *)param_1 + 0x10))(param_1,this + 0x6d,1);
                    /* WARNING: Could not recover jumptable at 0x001006df. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(*(long *)param_1 + 0x10))(param_1,this + 0x6e,1);
  return;
}
...
void JPH::GetRTTIOfType(JPH::SoftBodyCreationSettings*)::{lambda(void*)#1}::_FUN(void *param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* JPH::SoftBodyCreationSettings::sRestoreWithChildren(JPH::StreamIn&,
...
SoftBodyCreationSettings * __thiscall
JPH::SoftBodyCreationSettings::sRestoreWithChildren
          (SoftBodyCreationSettings *this,StreamIn *param_1,Array *param_2,Array *param_3,
          Array *param_4)

{
  long *plVar1;
  long *plVar2;
  SoftBodySharedSettings *pSVar3;
  long *plVar4;
  SoftBodySharedSettings *pSVar5;
  char cVar6;
  SoftBodyCreationSettings *extraout_RAX;
  UnorderedMap *extraout_RDX;
  StreamIn *pSVar7;
  char *this_00;
  Array *pAVar8;
  SoftBodyCreationSettings SVar9;
  ulong uVar10;
  long lVar11;
  long in_FS_OFFSET;
  undefined4 uStack_14c;
  long lStack_148;
  SoftBodyCreationSettings *pSStack_140;
  SoftBodyCreationSettings *pSStack_138;
  ulong uStack_130;
  long lStack_128;
  SoftBodySharedSettings *pSStack_120;
  SoftBodySharedSettings *local_118;
  ulong local_110;
  SoftBodySharedSettings local_108 [16];
  char local_f8;
  long *local_e8;
  long local_e0;
  long local_d8 [2];
  byte local_c8;
  SoftBodySharedSettings *local_b8 [2];
  ...
  undefined8 local_54;
  undefined2 local_4c;
  SoftBodyCreationSettings local_4a;
  long local_40;
  ...
  local_80 = 0;
  local_54 = _LC5;
  local_b8[0] = (SoftBodySharedSettings *)0x0;
  local_88 = 0;
  local_78 = (long *)0x0;
  ...
  if (cVar6 == '\0') {
    ...
    if (cVar6 == '\0') {
      ...
      JPH::SoftBodySharedSettings::sRestoreWithMaterials
                ((StreamIn *)&local_118,(Array *)param_1,param_2);
      pSVar5 = local_b8[0];
      pSVar3 = local_118;
      if (local_f8 == '\x02') {
        ...
        else if ((this[0x70] == (SoftBodyCreationSettings)0x2) &&
        ...
        *(SoftBodyCreationSettings **)this = this + 0x10;
        if ((pSVar3 == (SoftBodySharedSettings *)0x0) &&
           (lVar11 = 0, uVar10 = local_110, local_110 != 0)) {
LAB_00100dc8:
          ...
          if ((extraout_RDX == (UnorderedMap *)0x0) || (param_3 == (Array *)0x0)) {
            ...
            JPH::SoftBodySharedSettings::SaveWithMaterials
                      (*(StreamOut **)this_00,(UnorderedMap *)pSVar7,extraout_RDX);
          }
        ...
        StreamUtils::RestoreObjectReference<JPH::GroupFilter>
                  ((StreamUtils *)&local_e8,param_1,param_4);
        plVar2 = local_e8;
        ...
        if (local_c8 == 2) {
          ...
          *(SoftBodyCreationSettings **)this = this + 0x10;
          if ((plVar2 == (long *)0x0) &&
             (param_4 = (Array *)0x0, pSVar7 = param_1, lVar11 = local_e0, local_e0 != 0))
          goto LAB_00100dc8;
          pSStack_120 = (SoftBodySharedSettings *)0x100c94;
          std::__cxx11::basic_string<char,std::char_traits<char>,JPH::STLAllocator<char>>::
          _M_construct<char_const*>(this,plVar2,(long)plVar2 + local_e0);
  ...
  if (this[0x70] == (SoftBodyCreationSettings)0x1) {
    ...
    if (plVar2 != (long *)0x0) {
      ...
      *(int *)plVar4 = (int)*plVar4 + -1;
      UNLOCK();
      if ((int)*plVar4 == 0) {
        pSStack_120 = (SoftBodySharedSettings *)0x100bd6;
        (**(code **)(*plVar2 + 0x18))();
      }
    }
    pSVar3 = *(SoftBodySharedSettings **)this;
...
JPH::SoftBodyCreationSettings::SaveWithChildren
          (SoftBodyCreationSettings *this,StreamOut *param_1,UnorderedMap *param_2,
          UnorderedMap *param_3,UnorderedMap *param_4)

{
  ...
  if ((param_2 == (UnorderedMap *)0x0) || (param_3 == (UnorderedMap *)0x0)) {
    ...
    JPH::SoftBodySharedSettings::SaveWithMaterials
              (*(StreamOut **)this,(UnorderedMap *)param_1,param_2);
  }
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    StreamUtils::SaveObjectReference<JPH::GroupFilter>
              (param_1,*(GroupFilter **)(this + 0x40),param_4);
    return;
  }
                    /* WARNING: Subroutine does not return */
  __stack_chk_fail();

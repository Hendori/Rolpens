  ...
  if (in_RDX != (bool *)0x0) {
    ...
    if (cVar2 == '\0') {
      ...
      if (cVar2 == '\0') {
        ...
        String::split((char *)&local_68,SUB81(this,0),0x113ecd);
        if ((local_60 != 0) &&
...
LAB_00106558:
    ...
    if (cVar5 != '\0') {
      local_88 = (char *)0x0;
      String::parse_latin1((String *)&local_88,(char *)((long)&DAT_001113ff + 4));
      List<String,DefaultAllocator>::push_back(local_140,(String *)&local_88);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_88);
      pbVar2 = *(bool **)param_1;
    ...
    if (((iVar7 == 0) && (iVar8 = String::find((char *)&local_e8,0x111417), iVar8 == -1)) &&
       (iVar8 = String::find((char *)&local_e8,0x111421), iVar8 == -1)) {
      local_b0 = 0;
      String::parse_latin1((String *)&local_b0,"): ");
      ...
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_b8);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_b0);
      iVar7 = String::find((char *)&local_e8,0x11143f);
      if (iVar7 == -1) {
        String::get_base_dir();
...

{
  ...
  if ((local_138 == (Object *)0x0) || (*(uint *)(local_138 + -8) < 2)) {
    local_c8 = (Object *)0x111456;
    pcVar1 = *(code **)(*(long *)this + 0x2b0);
    local_c0 = 5;
    local_d8 = 0;
    if (param_2 == '\0') {
      local_c0 = 7;
      local_c8 = (Object *)0x11144e;
    }
...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_00117c48;
    ...
    do {
      ...
      if (local_138 != (byte *)0x0) {
        while (local_60._4_4_ != 0) {
          ...
          pbVar118 = pbVar118 + 1;
          if (pbVar118 == (byte *)0x117f26) goto LAB_0010acf3;
          bVar123 = *pbVar118;
        }
      }
LAB_0010ab26:
...
LAB_0010ad92:
      ...
      do {
        while (local_60._4_4_ != 0) {
          ...
          if (local_140 == (byte *)0x117f26) goto LAB_0010adb3;
        }
        local_140 = local_140 + 1;
      } while (local_140 != (byte *)0x117f26);
      goto LAB_0010adb3;
    }
LAB_0010aded:
    uVar109 = (ulong)local_cc;
...
LAB_0010add4:
  local_120 = local_120 + 1;
  if (local_120 == (byte *)0x117f26) goto LAB_0010aded;
  goto LAB_0010adc8;
}
...
LAB_0010c1b9:
    ...
    *(int *)local_d0[1] = *(int *)local_d0[1] + 1;
    ...
    if (((iVar7 == 0) && (iVar8 = String::find((char *)&local_c8,0x111417), iVar8 == -1)) &&
       (iVar8 = String::find((char *)&local_c8,0x111421), iVar8 == -1)) {
      local_a0 = 0;
      ...
      iVar8 = String::find((char *)&local_c8,0x1116d2);
      if (iVar8 != -1) {
        pcVar4 = *(code **)(*(long *)this + 0x178);
        local_90 = 0;
        if (local_c8 != 0) {
...

{
  ...
  if ((cVar14 == '\0') &&
    ...
    String::split((char *)&local_a8,bVar20,0x111710);
    CowData<char32_t>::_unref((CowData<char32_t> *)local_88);
    if (Variant::needs_deinit[local_58[0]] != '\0') {
      Variant::_clear_internal();
    }
    ...
    Object::get((StringName *)local_58,pbVar17);
    Variant::operator_cast_to_String((Variant *)local_88);
    String::split((char *)&local_98,bVar20,0x111710);
    CowData<char32_t>::_unref((CowData<char32_t> *)local_88);
    if (Variant::needs_deinit[local_58[0]] != '\0') {
      Variant::_clear_internal();
    }
...
{
  return (uint)CONCAT71(0x117f,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr) |
...
{
  *(undefined ***)this = &PTR__initialize_classv_00117ae8;
  ...
  if (pvVar5 != (void *)0x0) {
    if (*(int *)(this + 0x3c) != 0) {
      ...
      if (uVar2 == 0) {
        ...
        *(undefined4 *)(this + 0x3c) = 0;
        *(undefined1 (*) [16])(this + 0x28) = (undefined1  [16])0x0;
        if (pvVar5 == (void *)0x0) goto LAB_00113484;
      }
    }
    Memory::free_static(pvVar5,false);
...
/* WARNING: Removing unreachable block (ram,0x00114068) */
/* WARNING: Removing unreachable block (ram,0x001141fd) */
/* WARNING: Removing unreachable block (ram,0x00114209) */
...
/* WARNING: Removing unreachable block (ram,0x00114535) */
/* WARNING: Removing unreachable block (ram,0x00114541) */
...
/* WARNING: Removing unreachable block (ram,0x00114ad8) */
/* WARNING: Removing unreachable block (ram,0x00114c6d) */
/* WARNING: Removing unreachable block (ram,0x00114c79) */
...
LAB_00114ea5:
    ...
    *plVar1 = *plVar1 + -1;
    UNLOCK();
    if (*plVar1 != 0) goto LAB_00114df1;
    local_48 = (char *)0x0;
    Memory::free_static((void *)((long)pcVar4 + -0x10),false);
    lVar7 = *(long *)param_1;
    if (cVar5 == '\0') goto LAB_00114ea5;
LAB_00114dfd:
    pOVar3 = local_60;
...
LAB_001154a5:
    ...
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_001154a5;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)pLVar5;
      local_68 = local_80;
      goto joined_r0x001154c7;
    }
...
LAB_0011584d:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_0011584d;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x0011586f;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
LAB_00115c2d:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_00115c2d;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x00115c4f;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
LAB_0011600d:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_0011600d;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x0011602f;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
LAB_00116f56:
    ...
    lVar6 = puVar7[-1];
    if (param_1 <= lVar6) goto LAB_00116d85;
  }
  else {
    if (lVar6 != 0) {
      uVar5 = _realloc(this,lVar11);
...
LAB_001178a6:
    ...
    lVar9 = puVar7[-1];
    if (param_1 <= lVar9) goto LAB_00117695;
  }
  else {
    if (lVar9 != 0) {
      uVar6 = _realloc(this,lVar12);

...
/* GameView::_remote_window_title_changed(String) */

void GameView::_remote_window_title_changed(long param_1)
...
/* GameView::_update_floating_window_settings() */

void __thiscall GameView::_update_floating_window_settings(GameView *this)
...
/* GameView::_embedded_process_focused() */

void __thiscall GameView::_embedded_process_focused(GameView *this)
...
/* GameView::_window_close_request() */

void __thiscall GameView::_window_close_request(GameView *this)

{
  ...
  if ((cVar3 != '\0') &&
     ((cVar3 = EmbeddedProcess::is_embedding_completed(), cVar3 != '\0' ||
      (cVar3 = EmbeddedProcess::is_embedding_in_progress(), cVar3 != '\0')))) {
...
/* GameViewPlugin::_feature_profile_changed() */

void __thiscall GameViewPlugin::_feature_profile_changed(GameViewPlugin *this)

{
  ...
  if (local_18 == (Object *)0x0) {
    ...
    if (((local_18 != (Object *)0x0) && (cVar4 = RefCounted::unreference(), cVar4 != '\0')) &&
       (cVar4 = predelete_handler(local_18), cVar4 != '\0')) {
...
/* GameViewPlugin::make_visible(bool) */

void __thiscall GameViewPlugin::make_visible(GameViewPlugin *this,bool param_1)
...
/* GameViewDebugger::_session_stopped() */

void __thiscall GameViewDebugger::_session_stopped(GameViewDebugger *this)

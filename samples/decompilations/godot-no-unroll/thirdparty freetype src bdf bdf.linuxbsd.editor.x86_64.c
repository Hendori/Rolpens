...

{
  ...
  if (bVar1 != 0) {
    ...
    lVar3 = 0;
    if (((byte)ddigits[(uint)((uVar2 & 0xffffffff) >> 3) & 0x1f] >> ((int)(char)bVar1 & 7U) & 1) !=
        0) {
      do {
        param_1 = param_1 + 1;
...

{
  ...
  if ((param_1 != (byte *)0x0) && (bVar1 = *param_1, bVar1 != 0)) {
    ...
    iVar2 = 0;
    if (((byte)ddigits[(uint)((uVar3 & 0xffffffff) >> 3) & 0x1f] >> ((int)(char)bVar1 & 7U) & 1) !=
        0) {
      while( true ) {
        param_1 = param_1 + 1;
  ...
  if (param_3 < *(uint *)(lVar9 + 0x20)) {
    ...
    *(ulong *)(param_1 + 0x38) = (ulong)(uint)(*(int *)(param_1 + 0x98) << 6);
    ft_synthesize_vertical_metrics
              (param_1 + 0x30,(uint)*(ushort *)(*(long *)(lVar9 + 0x108) + 10) << 6);
    uVar10 = 0;
  }
  return uVar10;
}
...

{
  ...
  local_34 = 0;
  lVar1 = ft_mem_qrealloc(*(undefined8 *)(param_1 + 0xb8),1,*(long *)(param_1 + 0xa0),
                          *(long *)(param_1 + 0xa0) + param_3 + 1,*(undefined8 *)(param_1 + 0x98),
                          &local_34);
...

{
  ...
  if (bVar1 != 0) {
    ...
    while (local_68[uVar5 >> 3] = local_68[uVar5 >> 3] | (byte)(1 << ((byte)uVar5 & 7)),
          uVar5 = uVar8, pbVar10 = param_2, (char)uVar8 != '\0') {
      while( true ) {
        param_2 = pbVar10 + 1;
...

{
  ...
  if (plVar5 == (long *)0x0) {
    ...
    if (puVar6 == (ulong *)0x0) {
      ...
      if (lVar12 == 0) {
        lVar12 = ft_mem_qrealloc(uVar8,0x18,*(long *)(param_1 + 200),*(long *)(param_1 + 200) + 1,
                                 *(undefined8 *)(param_1 + 0xc0),&local_44);
    ...
    *puVar1 = puVar3;
    ...
    else if (((iVar4 == 1) && (puVar1[2] = 0, param_3 != (char *)0x0)) && (*param_3 != '\0')) {
    ...
    if ((bVar14 & 0xdf) != 0) {
      if ((char)bVar14 < '\v') {
        if ((char)bVar14 < '\t') {
LAB_00101280:
          uVar10 = ft_hash_str_insert(*puVar1,lVar12,*(undefined8 *)(param_1 + 0xa8),uVar9);
    ...
    *(long *)(param_1 + 0x88) = lVar12 + 1;
    ...
    if (((iVar4 == 0) && ((byte)param_2[0xc] < 0x21)) &&
       ((0xfffffffeffffd9feU >> ((ulong)(byte)param_2[0xc] & 0x3f) & 1) == 0)) {
    ...
    if (((iVar4 == 0) && ((byte)param_2[0xb] < 0x21)) &&
       ((0xfffffffeffffd9feU >> ((ulong)(byte)param_2[0xb] & 0x3f) & 1) == 0)) {
    ...
    if (((iVar4 == 0) && ((byte)param_2[7] < 0x21)) &&
       ((0xfffffffeffffd9feU >> ((ulong)(byte)param_2[7] & 0x3f) & 1) == 0)) {
...

{
  ...
  if ((((lVar2 != 0) && (*(long *)(lVar2 + 0x80) != 0)) && (param_2 != (char *)0x0)) &&
     (((*param_2 != '\0' &&
       (plVar4 = (long *)ft_hash_str_lookup(param_2,*(undefined8 *)(lVar2 + 0xa8)),
       plVar4 != (long *)0x0)) && (lVar2 = *(long *)(lVar2 + 0x90) + *plVar4 * 0x18, lVar2 != 0))))
  {
    iVar1 = *(int *)(lVar2 + 8);
    if (iVar1 == 2) {
...
bdf_parse_properties_
          (byte *param_1,long param_2,undefined8 param_3,undefined8 *param_4,ulong *param_5)

{
  ...
  if (((iVar5 == 0) && (param_1[0xd] < 0x21)) &&
     ((0xfffffffeffffd9feU >> ((ulong)param_1[0xd] & 0x3f) & 1) == 0)) {
    uVar11 = param_5[7];
    if ((uVar11 == 0) || (*(long *)(uVar11 + 0x80) == 0)) {
LAB_0010197f:
      *(long *)(uVar11 + 0x40) = (long)*(short *)(uVar11 + 0x10);
    ...
    if ((uVar11 == 0) || (*(long *)(uVar11 + 0x80) == 0)) {
LAB_001019d7:
      *(long *)(uVar11 + 0x48) = (long)*(short *)(uVar11 + 0x12);
...
LAB_00101793:
    ...
    if (((iVar5 == 0) && (param_1[0x15] < 0x21)) &&
       ((0xfffffffeffffd9feU >> ((ulong)param_1[0x15] & 0x3f) & 1) == 0)) goto LAB_00101793;
...
LAB_00101946:
      ...
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
        uVar11 = param_5[7];
LAB_0010181f:
        uVar12 = bdf_add_property__isra_0(uVar11,param_1,pbVar13);
        return uVar12;
      }
      goto LAB_00101b2d;
    }
    ...
    if (puVar7 == (ulong *)0x0) {
LAB_001018f7:
      if (pbVar13 < param_1 + param_2) goto LAB_00101908;
...
LAB_00101923:
    ...
    if (((0x52 < uVar3) &&
        (ppuVar8 = (undefined **)(*(long *)(uVar11 + 0xc0) + -0x7c8 + uVar3 * 0x18),
        ppuVar8 == (undefined **)0x0)) || (*(int *)(ppuVar8 + 1) == 1)) goto LAB_001018f7;
    *pbVar13 = bVar2;
    puVar7 = param_5 + 9;
    param_5[0xb] = 0;
    if (param_5[10] != 0) {
    ...
    if (((param_2 == 0) || (*param_1 == 0)) ||
       (uVar12 = bdf_list_split__part_0(puVar7,&_LC9,param_1,param_2), (int)uVar12 == 0)) {
...
ulong BDF_Face_Init(long param_1,code *param_2,int param_3)
      ...
      *(undefined8 *)(param_2 + 8) = uVar3;
      if ((uVar20 == 0) || (*(long *)(uVar20 + 0x80) == 0)) {
        ...
        *(undefined8 *)(param_2 + 0x18) = 0;
        ...
        if (((((plVar9 != (long *)0x0) &&
              (lVar8 = *(long *)(uVar20 + 0x90) + *plVar9 * 0x18, lVar8 != 0)) &&
             (*(int *)(lVar8 + 8) == 1)) &&
            ((*(byte **)(lVar8 + 0x10) != (byte *)0x0 &&
             (uVar4 = **(byte **)(lVar8 + 0x10) - 0x43, (byte)uVar4 < 0x2b)))) &&
           ((0x40100000401U >> ((ulong)uVar4 & 0x3f) & 1) != 0)) {
          *(ulong *)(param_2 + 0x10) = *(ulong *)(param_2 + 0x10) | 4;
        }
        if (((*(long *)(uVar20 + 0x80) == 0) ||
            (plVar9 = (long *)ft_hash_str_lookup("FAMILY_NAME"), plVar9 == (long *)0x0)) ||
           ((lVar8 = *(long *)(uVar20 + 0x90) + *plVar9 * 0x18, lVar8 == 0 ||
            (lVar8 = *(long *)(lVar8 + 0x10), lVar8 == 0)))) {
          *(undefined8 *)(param_2 + 0x28) = 0;
        ...
        *(undefined8 *)(param_2 + 0x18) = 0;
        ...
        if ((lVar8 != 0) && (*(long *)(lVar8 + 0x80) != 0)) {
          ...
          if (((plVar9 != (long *)0x0) &&
              (((lVar21 = *(long *)(lVar8 + 0x90) + *plVar9 * 0x18, lVar21 != 0 &&
                (*(int *)(lVar21 + 8) == 1)) &&
               (pbVar15 = *(byte **)(lVar21 + 0x10), pbVar15 != (byte *)0x0)))) &&
             (((byte)(*pbVar15 - 0x49) < 0x27 &&
              ((0x4100000041U >> ((ulong)(*pbVar15 - 0x49) & 0x3f) & 1) != 0)))) {
          ...
          if (*(long *)(lVar8 + 0x80) != 0) {
            ...
            if (((plVar9 != (long *)0x0) &&
                (lVar21 = *(long *)(lVar8 + 0x90) + *plVar9 * 0x18, lVar21 != 0)) &&
               ((*(int *)(lVar21 + 8) == 1 &&
                ((*(byte **)(lVar21 + 0x10) != (byte *)0x0 &&
                 ((**(byte **)(lVar21 + 0x10) & 0xdf) == 0x42)))))) {
            ...
            if (*(long *)(lVar8 + 0x80) != 0) {
              ...
              if ((((plVar9 != (long *)0x0) &&
                   (lVar21 = *(long *)(lVar8 + 0x90) + *plVar9 * 0x18, lVar21 != 0)) &&
                  (*(int *)(lVar21 + 8) == 1)) &&
                 (((pbVar15 = *(byte **)(lVar21 + 0x10), pbVar15 != (byte *)0x0 && (*pbVar15 != 0))
                  && ((*pbVar15 & 0xdf) != 0x4e)))) {
                local_78._8_8_ = pbVar15;
              }
              if (((*(long *)(lVar8 + 0x80) != 0) &&
                  (plVar9 = (long *)ft_hash_str_lookup("ADD_STYLE_NAME"), plVar9 != (long *)0x0)) &&
                 ((lVar8 = *(long *)(lVar8 + 0x90) + *plVar9 * 0x18, lVar8 != 0 &&
                  ((((*(int *)(lVar8 + 8) == 1 &&
                     (pbVar15 = *(byte **)(lVar8 + 0x10), pbVar15 != (byte *)0x0)) &&
                    (*pbVar15 != 0)) && ((*pbVar15 & 0xdf) != 0x4e)))))) {
                local_88._0_8_ = pbVar15;
              }
            }
          }
        }
      ...
      uVar22 = 0;
      pcVar12 = (char *)ft_mem_qalloc(local_118,lVar8,&local_98);
      *(char **)(param_2 + 0x30) = pcVar12;
      uVar6 = (ulong)local_98 & 0xffffffff;
      if ((uint)local_98 != 0) goto LAB_00101b91;
      do {
        while( true ) {
...
LAB_001022f0:
        ...
        if (((9UL >> (uVar22 & 0x3f) & 1) == 0) || (pcVar12 = pcVar13, sVar11 == 0))
        goto LAB_001022f0;
        pcVar12 = pcVar13 + sVar11;
        do {
          if (*pcVar13 == ' ') {
...
LAB_00102368:
      *pcVar12 = '\0';
      uVar6 = (ulong)local_98 & 0xffffffff;
      local_b4 = (uint)local_98;
      if ((uint)local_98 != 0) goto LAB_00101b91;
      lVar8 = *(long *)(uVar20 + 0x50);
      *(undefined4 *)(param_2 + 0x38) = 1;
      *(long *)(param_2 + 0x20) = lVar8 + 1;
      psVar14 = (short *)ft_mem_alloc(uVar2,0x20,&local_b4);
      *(short **)(param_2 + 0x40) = psVar14;
      uVar6 = (ulong)local_b4;
      if (local_b4 != 0) goto LAB_00101b91;
      lVar8 = *(long *)(uVar20 + 0x40);
      sVar16 = (short)lVar8;
      if (0xfffe < lVar8 + 0x7fffU) {
        *(ulong *)(uVar20 + 0x40) = (lVar8 >> 0x3f & 0xffffffffffff0002U) + 0x7fff;
        sVar16 = ((ushort)(lVar8 >> 0x3f) & 2) + 0x7fff;
      }
      lVar8 = *(long *)(uVar20 + 0x48);
      sVar17 = sVar16 + (short)lVar8;
      if (0xfffe < lVar8 + 0x7fffU) {
...
LAB_00102915:
        ...
        psVar14[1] = sVar16;
        if (((lVar8 == 0) ||
            (plVar9 = (long *)ft_hash_str_lookup("POINT_SIZE",*(undefined8 *)(uVar20 + 0xa8)),
            plVar9 == (long *)0x0)) ||
           (lVar8 = *(long *)(uVar20 + 0x90) + *plVar9 * 0x18, lVar8 == 0)) goto LAB_001028e8;
...
LAB_001024bb:
      ...
      lVar21 = *(long *)(uVar20 + 0x80);
      *(long *)(psVar14 + 4) = lVar8;
      if (lVar21 == 0) {
LAB_00102b25:
...
LAB_00102d05:
        ...
        if (((lVar8 == 0) ||
            (plVar9 = (long *)ft_hash_str_lookup("RESOLUTION_Y",*(undefined8 *)(uVar20 + 0xa8)),
            plVar9 == (long *)0x0)) ||
           (lVar8 = *(long *)(uVar20 + 0x90) + *plVar9 * 0x18, lVar8 == 0)) goto LAB_00102b53;
        uVar6 = *(ulong *)(lVar8 + 0x10);
      }
      lVar8 = *(long *)(psVar14 + 0xc);
      if (uVar6 == 0) {
        if (lVar8 == 0) {
...
LAB_00102a86:
      ...
      *(long *)(psVar14 + 8) = lVar8;
      lVar8 = *(long *)(uVar20 + 0x60);
      plVar9 = (long *)ft_mem_qrealloc(uVar2,0x10,0,*(undefined8 *)(uVar20 + 0x50),0,&local_b4);
      *(long **)(param_2 + 0x110) = plVar9;
      uVar6 = (ulong)local_b4;
      if (local_b4 != 0) goto LAB_00101b91;
      *(undefined4 *)(param_2 + 0x118) = 0;
      uVar6 = *(ulong *)(uVar20 + 0x50);
      if (uVar6 != 0) {
      ...
      if (*(long *)(uVar20 + 0x80) != 0) {
        ...
        if ((((*(long *)(uVar20 + 0x80) != 0) &&
             (plVar18 = (long *)ft_hash_str_lookup("CHARSET_ENCODING",*(undefined8 *)(uVar20 + 0xa8)
                                                  ), plVar18 != (long *)0x0)) &&
            ((lVar8 = *(long *)(uVar20 + 0x90) + *plVar18 * 0x18, plVar9 != (long *)0x0 &&
             (((lVar8 != 0 && ((int)plVar9[1] == 1)) && (*(int *)(lVar8 + 8) == 1)))))) &&
           ((plVar9[2] != 0 && (*(long *)(lVar8 + 0x10) != 0)))) {
          ...
          *(byte **)(param_2 + 0x100) = pbVar15;
          uVar6 = (ulong)local_b4;
          if (local_b4 != 0) goto LAB_00101b91;
          if ((((*pbVar15 & 0xdf) == 0x49) && ((pbVar15[1] & 0xdf) == 0x53)) &&
             ((pbVar15[2] & 0xdf) == 0x4f)) {
            pbVar15 = pbVar15 + 3;
            iVar5 = strcmp((char *)pbVar15,"10646");
            if ((iVar5 == 0) ||
               ((iVar5 = strcmp((char *)pbVar15,"8859"), iVar5 == 0 &&
                (iVar5 = strcmp(*(char **)(param_2 + 0xf8),"1"), iVar5 == 0)))) {
LAB_00102cba:
              local_90 = 0x10003756e6963;
            }
            else {
...
ulong bdf_parse_start_(char *param_1,long param_2,undefined8 param_3,undefined8 *param_4,
                      ulong *param_5)

{
  ...
  if (iVar8 == 0) {
    bVar16 = param_1[7];
    if ((0x20 < bVar16) || ((0xfffffffeffffd9feU >> ((ulong)bVar16 & 0x3f) & 1) != 0))
    goto LAB_00102e60;
...
LAB_00102e60:
  ...
  if ((uVar10 & 1) == 0) {
    ...
    if (((iVar8 == 0) && ((byte)param_1[9] < 0x21)) &&
       ((0xfffffffeffffd9feU >> ((ulong)(byte)param_1[9] & 0x3f) & 1) == 0)) {
      uVar15 = param_5[0xd];
      *param_5 = 1;
      param_5[7] = 0;
  ...
  if (iVar8 == 0) {
    if ((0x20 < (byte)param_1[0xf]) ||
       ((0xfffffffeffffd9feU >> ((ulong)(byte)param_1[0xf] & 0x3f) & 1) != 0)) goto LAB_00103150;
    uVar9 = 0xb3;
...
LAB_0010303f:
  ...
  if (((iVar8 == 0) && ((byte)param_1[0xf] < 0x21)) &&
     ((0xfffffffeffffd9feU >> ((ulong)(byte)param_1[0xf] & 0x3f) & 1) == 0)) {
    uVar9 = 0xb2;
...
LAB_00103150:
  ...
  if (iVar8 == 0) {
    if ((0x20 < (byte)param_1[4]) ||
       ((0xfffffffeffffd9feU >> ((ulong)(byte)param_1[4] & 0x3f) & 1) != 0)) goto LAB_00103430;
    param_5[0xb] = 0;
    puVar1 = param_5 + 9;
    if (param_5[10] != 0) {
      puVar3 = (undefined8 *)param_5[9];
      ...
      if (((puVar3 != (undefined8 *)0x0) && (__s = (char *)*puVar3, __s != (char *)0x0)) &&
        ...
        *(undefined4 *)(puVar3 + 6) = *(undefined4 *)(param_5[8] + 0xc);
        ...
        if (uVar15 < 0x100) {
          ...
          if ((local_148[0] == '\0') ||
             (uVar9 = bdf_list_split__part_0(local_168,&_LC39,pvVar11,uVar15), (int)uVar9 == 0)) {
            if (local_158 == 0xf) {
    ...
    if (((iVar8 == 0) && ((byte)param_1[4] < 0x21)) &&
       ((0xfffffffeffffd9feU >> ((ulong)(byte)param_1[4] & 0x3f) & 1) == 0)) {
      uVar9 = 0xb1;
      if ((uVar10 & 2) != 0) {
        param_5[0xb] = 0;
        if (param_5[10] != 0) {
...
LAB_00103430:
    ...
    if ((iVar8 == 0) &&
       (((byte)param_1[5] < 0x21 &&
        ((0xfffffffeffffd9feU >> ((ulong)(byte)param_1[5] & 0x3f) & 1) == 0)))) {
      uVar9 = 0xb3;
      if ((uVar10 & 8) != 0) {
...
int bdf_parse_glyphs_(char *param_1,long param_2,undefined8 param_3,undefined8 *param_4,
                     ulong *param_5)
...
LAB_001038dd:
        local_4c = bdf_add_comment_(uVar24,pcVar23,lVar17);
LAB_001038e9:
...
LAB_0010377d:
    ...
    if ((uVar15 & 0x20) == 0) {
      ...
      if (((iVar14 == 0) && ((byte)param_1[5] < 0x21)) &&
         ((0xfffffffeffffd9feU >> ((ulong)(byte)param_1[5] & 0x3f) & 1) == 0)) {
        param_5[0xb] = 0;
        if (param_5[10] != 0) {
        ...
        if (((param_2 == 0) || (*param_1 == '\0')) ||
           (local_4c = bdf_list_split__part_0(param_5 + 9,&_LC9,param_1,param_2), local_4c == 0)) {
      ...
      if (iVar14 == 0) {
        if (((byte)param_1[7] < 0x21) &&
           ((0xfffffffeffffd9feU >> ((ulong)(byte)param_1[7] & 0x3f) & 1) == 0)) {
          if ((uVar15 & 0xfc0) == 0) {
        ...
        if (((iVar14 == 0) && ((byte)param_1[7] < 0x21)) &&
           ((0xfffffffeffffd9feU >> ((ulong)(byte)param_1[7] & 0x3f) & 1) == 0)) {
          param_5[6] = 0;
      ...
      uVar21 = (ulong)(uVar18 & 0x40);
      if ((((uVar15 & 0x40) != 0) && (param_5[6] == 0xffffffffffffffff)) &&
         (*(int *)(param_5[8] + 4) == 0)) goto LAB_001038f1;
      iVar14 = strncmp(param_1,"STARTCHAR",9);
      if (((iVar14 == 0) && ((byte)param_1[9] < 0x21)) &&
         ((0xfffffffeffffd9feU >> ((ulong)(byte)param_1[9] & 0x3f) & 1) == 0)) {
        iVar14 = 0xb5;
        if ((uVar15 & 0xfc0) == 0) {
          puVar1 = param_5 + 9;
      ...
      if (((iVar14 == 0) && ((byte)param_1[8] < 0x21)) &&
         ((0xfffffffeffffd9feU >> ((ulong)(byte)param_1[8] & 0x3f) & 1) == 0)) {
        iVar14 = 0xb5;
      ...
      if ((uVar15 & 0x800) != 0) {
        ...
        if (uVar15 == 0) {
          if (*(ushort *)(lVar17 + 0x14) != 0) {
            *pbVar20 = *pbVar20 &
                       *(byte *)((long)&nibble_mask +
                                (ulong)((uint)*(ushort *)(uVar24 + 0xb0) *
                                        (uint)*(ushort *)(lVar17 + 0x14) & 7));
          }
LAB_001043c9:
          if ((((byte)hdigits[(byte)param_1[lVar16 * 2] >> 3] >> (param_1[lVar16 * 2] & 7U) & 1) !=
               0) && ((*param_5 & 0x40000000) == 0)) {
            *param_5 = *param_5 | 0x40000000;
          }
        }
        else {
          uVar24 = 0;
          while (bVar2 = param_1[uVar24],
                ((byte)hdigits[bVar2 >> 3] >> ((int)(char)bVar2 & 7U) & 1) != 0) {
            *pbVar20 = *pbVar20 * '\x10' + a2i[(int)(char)bVar2];
            uVar21 = uVar24 + 1;
            if (uVar21 == uVar15) {
              if (*(ushort *)(lVar17 + 0x14) == 0) goto LAB_001043c9;
              uVar21 = (ulong)((uint)*(ushort *)(param_5[7] + 0xb0) *
                               (uint)*(ushort *)(lVar17 + 0x14) & 7);
              uVar24 = uVar15;
              goto LAB_0010404d;
            }
          ...
          if (uVar24 < uVar15) {
            ...
            if (uVar11 != 0) {
LAB_0010404d:
              *pbVar20 = *pbVar20 & *(byte *)((long)&nibble_mask + uVar21);
              goto LAB_0010405a;
            }
          }
          else {
...
LAB_0010405a:
            if (uVar15 == uVar24) goto LAB_001043c9;
          }
        }
      ...
      if (iVar14 == 0) {
        if (((byte)param_1[6] < 0x21) &&
           ((0xfffffffeffffd9feU >> ((ulong)(byte)param_1[6] & 0x3f) & 1) == 0)) {
          param_5[0xb] = 0;
          if (param_5[10] != 0) {
            puVar5 = (undefined8 *)param_5[9];
            puVar5[4] = &empty;
...
LAB_00104071:
          if ((*param_1 != 'B') ||
             ((((param_1[1] != 'B' || (param_1[2] != 'X')) || (0x20 < (byte)param_1[3])) ||
              ((0xfffffffeffffd9feU >> ((ulong)(byte)param_1[3] & 0x3f) & 1) != 0)))) {
            iVar14 = strncmp(param_1,"BITMAP",6);
            if (((iVar14 == 0) && ((byte)param_1[6] < 0x21)) &&
               ((0xfffffffeffffd9feU >> ((ulong)(byte)param_1[6] & 0x3f) & 1) == 0)) {
              if ((uVar15 & 0x400) == 0) {
                iVar14 = 0xb7;
              }
              else {
                iVar14 = (int)((uint)*(ushort *)(lVar17 + 0x14) * (uint)*(ushort *)(uVar24 + 0xb0) +
                              7) >> 3;
             ...
             (local_4c = bdf_list_split__part_0(param_5 + 9,&_LC9,param_1,param_2), local_4c == 0))
          {
            ...
            *(short *)(param_5 + 4) = sVar13;
            ...
            if ((*(int *)param_5[8] != 0) &&
               (sVar13 = FT_MulDiv(*(undefined2 *)(lVar17 + 0x12),72000,
                                   *(long *)(uVar24 + 0x18) * *(long *)(uVar24 + 0x20)),
        ...
        if (((iVar14 != 0) || (0x20 < (byte)param_1[6])) ||
           ((0xfffffffeffffd9feU >> ((ulong)(byte)param_1[6] & 0x3f) & 1) != 0)) goto LAB_00104071;
        param_5[0xb] = 0;
        if (param_5[10] != 0) {
          puVar5 = (undefined8 *)param_5[9];
          puVar5[4] = &empty;

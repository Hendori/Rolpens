...
/* PluginConfigAndroid::resolve_local_dependency_path(String, String) */

PluginConfigAndroid * __thiscall
...
/* PluginConfigAndroid::get_prebuilt_plugins(String) */

long PluginConfigAndroid::get_prebuilt_plugins(long param_1)
...
/* PluginConfigAndroid::is_plugin_config_valid(PluginConfigAndroid) */

uint PluginConfigAndroid::is_plugin_config_valid(long param_1)
...
joined_r0x0010026f:
    ...
    if ((*(long *)(param_1 + 0x20) == 0) ||
       ((iVar3 = (int)*(undefined8 *)(*(long *)(param_1 + 0x20) + -8), iVar3 == 0 || (iVar3 == 1))))
    {
      lVar5 = *(long *)(param_1 + 0x30);
      uVar4 = 1;
...
/* PluginConfigAndroid::get_plugin_modification_time(PluginConfigAndroid const&, String const&) */

ulong PluginConfigAndroid::get_plugin_modification_time
                (PluginConfigAndroid *param_1,String *param_2)
...
LAB_00100392:
      uVar4 = FileAccess::get_modified_time((String *)&local_38);
      lVar5 = local_38;
      if (uVar3 < uVar4) {
        uVar3 = uVar4;
      }
...
/* PluginConfigAndroid::get_plugins_names(Vector<PluginConfigAndroid>, Vector<String>&) */

void PluginConfigAndroid::get_plugins_names(long param_1,Vector<String> *param_2)
...
/* PluginConfigAndroid::load_plugin_config(Ref<ConfigFile>, String const&) */
...

{
  ...
  if (((String *)*param_2 == (String *)0x0) ||
     (iVar7 = ConfigFile::load((String *)*param_2), iVar7 != 0)) goto LAB_00100f2d;
  String::get_base_dir();
...
LAB_001016fe:
      ...
      if (lVar9 == -1) {
LAB_00101a28:
        if (puVar13 != (undefined *)0x0) goto LAB_001016e9;
      }
      else {
        local_d8 = local_110;
        if (local_110 != puVar13) {
LAB_001016e9:
          if (puVar13 != (undefined *)0x0) goto LAB_001016ee;
          goto LAB_001016fe;
        }
        if (local_110 != (undefined *)0x0) {
          local_d8 = local_110;
...
LAB_00101536:
    resolve_local_dependency_path
              ((PluginConfigAndroid *)&local_d8,(StrRange *)&local_f8,(StrRange *)&local_e8);
    puVar13 = *(undefined **)(this + 0x20);
    if (puVar13 == local_d8) {
      if (puVar13 != (undefined *)0x0) {
        LOCK();
...
LAB_00101c94:
      resolve_local_dependency_path
                ((PluginConfigAndroid *)&local_d8,(String *)&local_100,(StrRange *)&local_e8);
...
/* PluginConfigAndroid::resolve_prebuilt_plugin(PluginConfigAndroid, String) */
...

{
  ...
  *(undefined8 *)(this + 0x30) = 0;
  if (*(long *)(param_2 + 0x30) != 0) {
    CowData<String>::_ref((CowData<String> *)(this + 0x30),(CowData *)(param_2 + 0x30));
  }
  *(undefined8 *)(this + 0x40) = 0;
  if (*(long *)(param_2 + 0x40) != 0) {
    CowData<String>::_ref((CowData<String> *)(this + 0x40),(CowData *)(param_2 + 0x40));
  }
  *(undefined8 *)(this + 0x50) = 0;
  if (*(long *)(param_2 + 0x50) != 0) {
    CowData<String>::_ref((CowData<String> *)(this + 0x50),(CowData *)(param_2 + 0x50));
  }
...
LAB_0010233e:
    resolve_local_dependency_path((PluginConfigAndroid *)&local_48,&local_58,&local_50);
    lVar5 = *(long *)(this + 0x20);
    if (lVar5 == local_48) {
      if (lVar5 != 0) {
        LOCK();

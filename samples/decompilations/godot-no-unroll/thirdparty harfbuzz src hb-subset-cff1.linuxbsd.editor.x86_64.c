  ...
  if (cVar1 != '\x01') {
    if (cVar1 != '\x02') {
      if (((cVar1 == '\0') && (in_ECX < uVar6)) && (in_ECX != 0)) {
        return (ulong)(ushort)(*(ushort *)(pcVar9 + (ulong)(in_ECX - 1) * 2 + 1) << 8 |
                              *(ushort *)(pcVar9 + (ulong)(in_ECX - 1) * 2 + 1) >> 8);
      }
      return 0;
    }
    if (uVar6 <= in_ECX) {
    ...
    if ((in_R8 == (uint *)0x0) || (uVar6 = in_R8[1], in_ECX < uVar6)) {
      if (in_ECX == 0) {
        return 0;
      }
      uVar8 = in_ECX - 1;
...
LAB_001002e8:
      if (in_R8 == (uint *)0x0) goto LAB_001002f4;
    }
    else {
      uVar3 = *in_R8;
      uVar5 = (ulong)uVar3;
...
LAB_001002c0:
        do {
          ...
          uVar3 = (int)uVar5 + 1;
          uVar5 = (ulong)uVar3;
          uVar4 = (uint)(ushort)(*(ushort *)(pcVar9 + uVar5 * 4 + 3) << 8 |
                                *(ushort *)(pcVar9 + uVar5 * 4 + 3) >> 8);
        } while (uVar4 < uVar8);
    ...
    *in_R8 = uVar3;
    in_R8[1] = uVar6;
LAB_001002f4:
    return (ulong)((ushort)(*puVar7 << 8 | *puVar7 >> 8) + uVar8);
  }
  if (uVar6 <= in_ECX) {
    return 0;
  }
...
LAB_0010036e:
    if (in_R8 == (uint *)0x0) goto LAB_0010037a;
  }
  else {
    uVar3 = *in_R8;
    uVar5 = (ulong)uVar3;
...
bool OT::CFFIndex<OT::IntType<unsigned_short,2u>>::
     serialize_header<hb_array_t<hb_vector_t<unsigned_char,false>const>,(void*)0>
               (ushort *param_1,long param_2,long param_3,uint param_4,int param_5,uint param_6)
      ...
      if ((uVar10 < 0x80000000) && ((long)uVar10 <= *(long *)(param_2 + 0x10) - (long)puVar6)) {
        *(undefined1 **)(param_2 + 8) = puVar6 + uVar10;
        if (param_6 == 3) {
          ...
          *(ushort *)(puVar4 + ((lVar1 - param_3) - 0x10U >> 4) * 3 + 3 + 1) =
               (ushort)iVar5 << 8 | (ushort)iVar5 >> 8;
          return true;
        }
        if (3 < param_6) {
          if (param_6 != 4) {
          ...
          *(uint *)((long)param_1 + ((lVar1 - param_3) - 0x10U >> 4) * 4 + 7) =
               uVar7 >> 0x18 | (uVar7 & 0xff0000) >> 8 | (uVar7 & 0xff00) << 8 | uVar7 << 0x18;
          return true;
        }
        if (param_6 == 1) {
        ...
        *(ushort *)((long)param_1 + ((lVar1 - param_3) - 0x10U >> 4) * 2 + 5) =
             uVar2 << 8 | uVar2 >> 8;
        return true;
      }
    }
...
bool __thiscall
OT::CFFIndex<OT::IntType<unsigned_short,2u>>::
serialize<hb_vector_t<hb_vector_t<unsigned_char,false>,false>,(void*)0>
          (CFFIndex<OT::IntType<unsigned_short,2u>> *this,hb_serialize_context_t *param_1,
...
/* CFF::str_encoder_t::encode_num_cs(CFF::number_t const&) [clone .isra.0] */

void __thiscall CFF::str_encoder_t::encode_num_cs(str_encoder_t *this,number_t *param_1)

{
  ...
  if ((double)(int)(short)iVar4 != in_XMM0_Qa) {
    ...
    phVar2 = *(hb_vector_t<unsigned_char,false> **)this;
    uVar1 = *(uint *)(phVar2 + 4);
    uVar7 = (undefined1)((uint)iVar4 >> 0x10);
    if ((int)uVar1 < *(int *)phVar2) {
      *(uint *)(phVar2 + 4) = uVar1 + 1;
      *(undefined1 *)(*(long *)(phVar2 + 8) + (ulong)uVar1) = uVar7;
    }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* OT::cff1::accelerator_subset_t::serialize(hb_serialize_context_t*, OT::cff1_subset_plan&) const
    */

cff1_subset_plan __thiscall
OT::cff1::accelerator_subset_t::serialize
          (accelerator_subset_t *this,hb_serialize_context_t *param_1,cff1_subset_plan *param_2)

{
  ...
  if (*(int *)(param_1 + 0x2c) == 0) {
    plVar15 = (long *)hb_pool_t<hb_serialize_context_t::object_t,32u>::alloc
                                ((hb_pool_t<hb_serialize_context_t::object_t,32u> *)(param_1 + 0x30)
                                );
    if (plVar15 == (long *)0x0) {
      if (*(int *)(param_1 + 0x2c) == 0) {
...
LAB_00100dab:
    if ((long)uVar27 <= lVar38 - lVar19) {
      ...
      *plVar15 = lVar38;
      plVar15[1] = lVar38;
      bVar8 = CFFIndex<OT::IntType<unsigned_short,2u>>::
              serialize_header<hb_array_t<hb_vector_t<unsigned_char,false>const>,(void*)0>
                        (lVar38,param_1,lVar42,uVar30);
      if ((bVar8) && (*(int *)(param_1 + 0x2c) == 0)) {
        if ((uVar34 < 0x80000000) &&
           (puVar24 = *(undefined1 **)(param_1 + 8),
           (long)uVar34 <= *(long *)(param_1 + 0x10) - (long)puVar24)) {
                    ...
                    if ((bVar3 & 1) != 0) {
                      ...
                      if (iVar26 != 0) {
                        ...
                        bVar8 = CFFIndex<OT::IntType<unsigned_short,2u>>::
                                serialize<hb_vector_t<hb_vector_t<unsigned_char,false>,false>,(void*)0>
                                          (pCVar39,param_1,
                                           (hb_vector_t *)(ulong)*(uint *)(puVar29 + 4),
                                           *(uint **)(puVar29 + 8),0);
                      ...
                      if (*(int *)(param_1 + 0x2c) == 0) {
                        auVar44 = hb_pool_t<hb_serialize_context_t::object_t,32u>::alloc
                                            ((hb_pool_t<hb_serialize_context_t::object_t,32u> *)
                                             (param_1 + 0x30));
...
LAB_00101acb:
  uVar30 = (ulong)*(uint *)(param_2 + 0x104);
  uVar37 = *(uint *)(param_2 + 0x200);
  lVar42 = *(long *)(param_2 + 0x108);
...
LAB_0010109d:
  plVar15 = (long *)(lVar38 * 0x10 + *(long *)(puVar29 + 0x10));
      ...
      if (bVar3 != 0) {
        if (bVar3 < 8) {
          ...
          *(undefined8 *)((long)puVar18 + (uVar30 - 8)) = 0;
          uVar27 = (ulong)(((int)puVar18 -
                           (int)(undefined8 *)((ulong)(puVar18 + 1) & 0xfffffffffffffff8)) +
                           (uint)bVar3 >> 3);
    ...
    if ((iVar26 != 0) && (cVar1 == (cff1_subset_plan)0x0)) {
      ...
      if (*(int *)(param_1 + 0x2c) == 0) {
        if (*(void **)(param_1 + 0x10) != pvVar21 &&
            -1 < (long)*(void **)(param_1 + 0x10) - (long)pvVar21) {
            ...
            if (1 < *(long *)(param_1 + 0x10) - (long)puVar24) {
              ...
              *(undefined2 **)(param_1 + 8) = puVar5 + 1;
              if ((puVar5 != (undefined2 *)0x0) && (*puVar5 = 0, *(int *)(param_1 + 0x2c) == 0)) {
                puVar24 = *(undefined1 **)(param_1 + 8);
                if (*(undefined1 **)(param_1 + 0x10) != puVar24 &&
                    -1 < (long)*(undefined1 **)(param_1 + 0x10) - (long)puVar24) {
...
LAB_00101217:
    iVar26 = (int)*(undefined8 *)(param_1 + 8) - *piVar31;
...
LAB_0010127f:
  ...
  if (*(undefined **)(this + 0x80) != &_hb_NullPool) {
    ...
    uStack_58 = uStack_68;
    uStack_50 = uStack_60;
    bVar8 = CFF::FDArray<OT::IntType<unsigned_short,2u>>::
            serialize<CFF::cff1_font_dict_values_mod_t,CFF::cff1_font_dict_values_mod_t,hb_zip_iter_t<hb_array_t<CFF::cff1_font_dict_values_mod_t_const>,hb_array_t<CFF::cff1_font_dict_values_mod_t_const>>,cff1_font_dict_op_serializer_t>
                      (uVar33,param_1,&uStack_69);
    if (!bVar8) goto LAB_0010179a;
    uVar13 = hb_serialize_context_t::pop_pack(param_1,false);
  ...
  if (pFVar32 != (FDSelect *)&_hb_NullPool) {
    ...
    cVar9 = hb_serialize_cff_fdselect
                      (param_1,*(uint *)(param_2 + 0xa0),pFVar32,*(uint *)(this + 0x90),
                       *(uint *)(param_2 + 0xac),*(uint *)(param_2 + 0x7c),
                       (hb_vector_t *)(param_2 + 0xb0));
  ...
  if (param_2[0x180] != (cff1_subset_plan)0x0) {
    ...
    cVar9 = CFF::Charset::serialize
                      (this_01,param_1,(uchar)param_2[0x168],*(uint *)(param_2 + 0xa0),
                       (hb_vector_t *)(param_2 + 0x170));
    if (cVar9 == '\0') goto LAB_0010179a;
    uVar13 = hb_serialize_context_t::pop_pack(param_1,true);
  ...
  if (param_2[0x142] != (cff1_subset_plan)0x0) {
    ...
    cVar9 = CFF::Encoding::serialize
                      (this_00,param_1,(uchar)param_2[0x143],*(uint *)(param_2 + 0x144),
                       (hb_vector_t *)(param_2 + 0x148),(hb_vector_t *)(param_2 + 0x158));
    if (cVar9 == '\0') goto LAB_0010179a;
    uVar13 = hb_serialize_context_t::pop_pack(param_1,true);
  ...
  bVar8 = CFFIndex<OT::IntType<unsigned_short,2u>>::
          serialize<hb_vector_t<hb_vector_t<unsigned_char,false>,false>,(void*)0>
                    (pCVar39,param_1,(hb_vector_t *)(ulong)*(uint *)(param_2 + 0x114),
                     *(uint **)(param_2 + 0x118),0);
  if (bVar8) {
...
LAB_001015f3:
          *(undefined1 (*) [16])(puVar23 + (ulong)uVar37 * 2) = auVar44;
          puVar18 = puVar23;
          uVar12 = uVar11;
          uVar37 = uVar28;
        }
          ...
          if (-1 < (int)uVar12) {
            ...
            if (uVar12 < uVar28) {
              ...
              if ((0xfffffff < uVar11) ||
                 (puVar23 = (undefined8 *)realloc(puVar18,uVar34 << 4), puVar23 == (undefined8 *)0x0
                 )) {
                uVar12 = ~uVar12;
                goto LAB_00102591;
              }
...
LAB_00102591:
      ...
      if (-1 < (int)uVar12) {
        ...
        if ((0x7fffffff < uVar34) || (*(ushort **)(param_1 + 0x10) < puVar41 + 1))
        goto LAB_001022d9;
            ...
            if (*(int *)(param_1 + 0x2c) == 0) {
              ...
              *(ulong *)(param_1 + 8) = lVar16 + uVar34;
              if (uVar28 == 3) {
                ...
                puVar24[((ulong)((long)puVar36 + (-0x10 - (long)puVar18)) >> 4) * 3 + 3] =
                     (char)((uint)iVar14 >> 0x10);
                *(ushort *)
                 (puVar24 + ((ulong)((long)puVar36 + (-0x10 - (long)puVar18)) >> 4) * 3 + 3 + 1) =
                     (ushort)iVar14 << 8 | (ushort)iVar14 >> 8;
                iVar26 = *(int *)(param_1 + 0x2c);
LAB_001016fc:
                if (iVar26 != 0) goto LAB_001022e0;
              }
              else {
                if (uVar28 == 4) {
                  uVar28 = 0x1000000;
                  ...
                  do {
                    ...
                    *(uint *)((long)puVar41 + lVar16 + 3) = uVar28;
                    lVar16 = lVar16 + 4;
                    uVar28 = uVar11 >> 0x18 | (uVar11 & 0xff0000) >> 8 | (uVar11 & 0xff00) << 8 |
                             uVar11 * 0x1000000;
                ...
                if (uVar28 == 1) {
                  ...
                  *(char *)((long)puVar41 +
                           ((ulong)((long)(puVar18 + (ulong)uVar37 * 2) + (-0x10 - (long)puVar18))
                           >> 4) + 4) = (char)iVar26;
                }
                else if (uVar28 == 2) {
                  uVar10 = 0x100;
              ...
              if ((0x7fffffff < uVar34) ||
                 (puVar24 = *(undefined1 **)(param_1 + 8),
                 *(long *)(param_1 + 0x10) - (long)puVar24 < (long)uVar34)) goto LAB_001022d9;
              *(undefined1 **)(param_1 + 8) = puVar24 + uVar34;
              if (puVar24 != (undefined1 *)0x0) {
                for (puVar23 = puVar18; puVar18 + (ulong)uVar37 * 2 != puVar23;
                    puVar23 = puVar23 + 2) {
...
LAB_001022e0:
    ...
    *puVar41 = 0;
LAB_00101bd5:
    hb_serialize_context_t::pop_pack(param_1,true);
    if (*(int *)(param_1 + 0x2c) == 0) {
...
joined_r0x00102532:
          ...
          sVar35 = (size_t)((uVar12 >> 0x18 | (uVar12 & 0xff0000) >> 8 | (uVar12 & 0xff00) << 8 |
                            uVar12 << 0x18) + uVar28);
          if (iVar26 != 0) goto LAB_001017a2;
          if ((0x7fffffff < sVar35) || (*(long *)(param_1 + 0x10) - (long)puVar22 < (long)sVar35))
          goto LAB_001019dd;
          *(size_t *)(param_1 + 8) = (long)puVar22 + sVar35;
...
LAB_00102016:
          iVar26 = (int)*(undefined8 *)(param_1 + 8) - (int)*puVar18;
          hb_serialize_context_t::pop_pack(param_1,false);
          puVar41 = *(ushort **)(param_1 + 8);
          uVar28 = iVar26 + 1;
...
LAB_001021e6:
                          ...
                          *(ulong *)(param_1 + 8) = (ulong)bVar43 + lVar16;
                          if (lVar16 != 0) {
                            if (*(char *)((long)plVar15 + 0xc) != '\0') {
                              lVar38 = 0;
                              do {
                                *(undefined1 *)(lVar16 + lVar38) =
                                     *(undefined1 *)(*plVar15 + lVar38);
                                lVar38 = lVar38 + 1;
                    ...
                    bVar8 = CFF::Dict::serialize_link_op<OT::IntType<int,4u>,29>
                                      (param_1,0xf,*(int *)(param_2 + 0x90),2);
                  }
                  else {
                    if (uVar28 < 0x10) {
                      ...
                      if (uVar28 == 3) {
                        lVar16 = 4;
LAB_00102196:
                        uVar12 = *(uint *)(param_2 + lVar16 * 4 + 0x1d0);
                      }
                      else {
                        if (uVar28 == 4) {
                          lVar16 = 5;
                      ...
                      bVar8 = CFF::UnsizedByteStr::serialize_int<OT::IntType<short,2u>,unsigned_int>
                                        (param_1,0x1c,uVar12);
                      if (bVar8) {
                        lVar38 = 1;
                        lVar16 = 1;
                    ...
                    if (uVar28 == 0x10) {
                      ...
                      bVar8 = CFF::Dict::serialize_link_op<OT::IntType<int,4u>,29>
                                        (param_1,0x10,*(int *)(param_2 + 0x8c),2);
                    }
                    else {
                      bVar8 = CFF::Dict::serialize_link_op<OT::IntType<int,4u>,29>
                                        (param_1,0x11,*(undefined4 *)(param_2 + 0x88),2);
                    }
                  }
LAB_00101d6a:
                  if (bVar8 == false) goto LAB_0010179a;
                }
                  ...
                  lVar16 = *plVar15;
                  bVar8 = CFF::UnsizedByteStr::serialize_int<OT::IntType<short,2u>,unsigned_int>
                                    (param_1,0x1c,*(uint *)(param_2 + 500));
                  if (((!bVar8) ||
                      (bVar8 = CFF::UnsizedByteStr::
                               serialize_int<OT::IntType<short,2u>,unsigned_int>
                                         (param_1,0x1c,*(uint *)(param_2 + 0x1f8)), !bVar8)) ||
                     (*(int *)(param_1 + 0x2c) != 0)) goto LAB_0010179a;
                  ...
                  *(ulong *)(param_1 + 8) = (ulong)(uVar12 & 0xff) + lVar38;
                  ...
                  if ((char)uVar12 != '\0') {
                    lVar19 = 0;
                    do {
                      *(undefined1 *)(lVar38 + lVar19) =
                           *(undefined1 *)(lVar16 + (ulong)uVar28 + lVar19);
                      lVar19 = lVar19 + 1;
                  ...
                  if (uVar28 < 0x11f) {
                    ...
                    if (uVar28 != 0x126) {
                      if (uVar28 == 0x124) {
                        bVar8 = CFF::Dict::serialize_link_op<OT::IntType<int,4u>,29>
                                          (param_1,0x124,*(undefined4 *)(param_2 + 0x84),2);
                      }
                      else {
                        if (uVar28 != 0x125) goto LAB_001021e6;
                        bVar8 = CFF::Dict::serialize_link_op<OT::IntType<int,4u>,29>
                                          (param_1,0x125,*(undefined4 *)(param_2 + 0x80),2);
                      }
                      goto LAB_00101d6a;
                    }
                    iVar26 = 7;
                  ...
                  bVar8 = CFF::UnsizedByteStr::serialize_int<OT::IntType<short,2u>,unsigned_int>
                                    (param_1,0x1c,*(uint *)(param_2 + (long)iVar26 * 4 + 0x1d0));
                  if (!bVar8) goto LAB_0010179a;
                  lVar38 = 2;
                  lVar16 = 2;
LAB_00101ec5:
...
LAB_00101db7:
                bVar8 = CFF::UnsizedByteStr::serialize_int<OT::IntType<short,2u>,unsigned_int>
                                  (param_1,0x1c,*(uint *)(param_2 + 0x98));
                if ((!bVar8) ||
                   (bVar8 = CFF::Dict::serialize_link_op<OT::IntType<int,4u>,29>
                                      (param_1,0x12,*(undefined4 *)(param_2 + 0x9c),2), !bVar8))
                goto LAB_0010179a;
              }
LAB_00101d72:
              lVar16 = *(long *)(param_2 + 0x70);
        ...
        if (*(int *)(param_1 + 0x2c) == 0) {
          ...
          *(long *)(param_1 + 8) = lVar16 + 2;
          if (((lVar16 != 0) && (puVar41 != (ushort *)0x0)) &&
             (*puVar41 = 0x100, *(int *)(param_1 + 0x2c) == 0)) {
            pvVar21 = *(void **)(param_1 + 8);
            uVar34 = ((long)puVar41 + 3U) - (long)pvVar21;
            if ((0x7fffffff < uVar34) || (*(ulong *)(param_1 + 0x10) < (long)puVar41 + 3U))
            goto LAB_001019dd;
            if ((int)uVar34 != 0) {
...
LAB_0010179a:
    hb_serialize_context_t::pop_discard(param_1);
  }
LAB_001017a2:
  cVar1 = (cff1_subset_plan)0x0;
LAB_001017a7:
...
/* OT::cff1::accelerator_subset_t::subset(hb_subset_context_t*) const */

undefined4 __thiscall
OT::cff1::accelerator_subset_t::subset(accelerator_subset_t *this,hb_subset_context_t *param_1)
...
void CFF::
     cff1_cs_opset_t<cff1_cs_opset_subr_subset_t,CFF::subr_subset_param_t,CFF::path_procs_null_t<CFF::cff1_cs_interp_env_t,CFF::subr_subset_param_t>>
     ::check_width(uint param_1,cff1_cs_interp_env_t *param_2,subr_subset_param_t *param_3)

{
  ...
  else if ((*(uint *)(param_2 + 0x14) == 0) || ((*(uint *)(param_2 + 0x14) & 1) == 0))
  goto LAB_00102e38;
...
/* CFF::cff1_cs_opset_t<cff1_cs_opset_flatten_t, CFF::flatten_param_t,
   ...
   int, CFF::cff1_cs_interp_env_t&, CFF::flatten_param_t&) [clone .isra.0] */
...
void CFF::
     ...
     ::check_width(uint param_1,cff1_cs_interp_env_t *param_2,flatten_param_t *param_3)
...
/* CFF::subr_subsetter_t<cff1_subr_subsetter_t, CFF::Subrs<OT::IntType<unsigned short, 2u> >,
   ...
   CFF::subr_subsetter_t<cff1_subr_subsetter_t, CFF::Subrs<OT::IntType<unsigned short, 2u> >,
   OT::cff1::accelerator_subset_t const, CFF::cff1_cs_interp_env_t, cff1_cs_opset_subr_subset_t,
   14u>::drop_hints_param_t&) [clone .isra.0] */

undefined8
CFF::
subr_subsetter_t<cff1_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_short,2u>>,OT::cff1::accelerator_subset_t_const,CFF::cff1_cs_interp_env_t,cff1_cs_opset_subr_subset_t,14u>
...
LAB_00103649:
    ...
    param_3 = (bool)hVar1;
LAB_00103650:
    pvVar4 = realloc(pvVar4,(ulong)uVar8 * 0x48);
    if (pvVar4 == (void *)0x0) {
      uVar3 = *(uint *)(this + 0x20);
...
LAB_001035b6:
    ...
    if (uVar3 < uVar2) {
LAB_00103540:
      if (0x38e38e3 < (uint)uVar9) goto LAB_001034b7;
      pvVar4 = *(void **)(this + 0x28);
LAB_00103551:
      uVar8 = (uint)uVar9;
...
LAB_0010356d:
  ...
  if ((uVar8 < uVar6) && (param_2)) {
    hb_memset((void *)(*(long *)(this + 0x28) + (ulong)uVar8 * 0x48),(uVar6 - uVar8) * 0x48,
              uVar8 * 9);
  }
...
LAB_001039bb:
    if (uVar2 <= uVar9) goto LAB_001038a8;
LAB_001039c4:
    *(uint *)(this + 8) = uVar9;
    puVar13 = (uint *)(lVar5 + (ulong)uVar9 * 8);
    lVar14 = *(long *)(this + 0x28);
...
/* CFF::subr_subsetter_t<cff1_subr_subsetter_t, CFF::Subrs<OT::IntType<unsigned short, 2u> >,
   ...
   CFF::subr_subset_param_t const&) [clone .isra.0] */
...
LAB_00103c1b:
    if (param_3[0x10] == (hb_set_t)0x0) goto LAB_00103c63;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* CFF::Encoding::serialize(hb_serialize_context_t*, unsigned char, unsigned int,
   hb_vector_t<CFF::code_pair_t, false> const&, hb_vector_t<CFF::code_pair_t, false> const&) */

undefined8 __thiscall
CFF::Encoding::serialize
          (Encoding *this,hb_serialize_context_t *param_1,uchar param_2,uint param_3,
          hb_vector_t *param_4,hb_vector_t *param_5)

{
  ...
  *this = (Encoding)((uVar8 != 0) << 7 | param_2);
  if (param_2 == '\0') {
    ...
    if ((0x7fffffff < uVar9) || (*(long *)(param_1 + 0x10) - (long)pvVar2 < (long)uVar9))
    goto LAB_00104360;
...
LAB_00104339:
  ...
  if ((uVar9 < 0x80000000) &&
     ((long)uVar9 <= *(long *)(param_1 + 0x10) - (long)*(void **)(param_1 + 8))) {
...
/* CFF::Charset::serialize(hb_serialize_context_t*, unsigned char, unsigned int,
   hb_vector_t<CFF::code_pair_t, false> const&) */

undefined8 __thiscall
CFF::Charset::serialize
          (Charset *this,hb_serialize_context_t *param_1,uchar param_2,uint param_3,
          hb_vector_t *param_4)
        ...
        *(Charset **)(param_1 + 8) = pCVar8 + uVar11;
        ...
        do {
          ...
          if (-1 < iVar3) {
            iVar5 = iVar4;
            do {
              *(ushort *)(pCVar8 + (ulong)(uint)((iVar10 - iVar4) + iVar5) * 2) =
                   (ushort)iVar5 << 8 | (ushort)iVar5 >> 8;
...
/* CFF::subr_subsetter_t<cff1_subr_subsetter_t, CFF::Subrs<OT::IntType<unsigned short, 2u> >,
   OT::cff1::accelerator_subset_t const, CFF::cff1_cs_interp_env_t, cff1_cs_opset_subr_subset_t,
   14u>::~subr_subsetter_t() */

void __thiscall
CFF::
subr_subsetter_t<cff1_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_short,2u>>,OT::cff1::accelerator_subset_t_const,CFF::cff1_cs_interp_env_t,cff1_cs_opset_subr_subset_t,14u>
::~subr_subsetter_t(subr_subsetter_t<cff1_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_short,2u>>,OT::cff1::accelerator_subset_t_const,CFF::cff1_cs_interp_env_t,cff1_cs_opset_subr_subset_t,14u>
                    *this)
...
LAB_0010506f:
    ...
    *(int *)(this + 0x1c) = iVar17;
    ...
    uStack_b8 = __LC1;
    uStack_b0 = _UNK_0010f8e8;
    uStack_a8 = __LC2;
    uStack_a0 = _UNK_0010f8f8;
    uStack_98 = __LC3;
    uStack_90 = _UNK_0010f908;
    uStack_88 = __LC4;
    uStack_80 = _UNK_0010f918;
    uStack_78 = __LC5;
    uStack_70 = _UNK_0010f928;
    uStack_68 = __LC6;
    uStack_60 = _UNK_0010f938;
    uStack_58 = __LC7;
    uStack_50 = _UNK_0010f948;
    if ((int)uVar9 == 0x20) {
      uVar8 = 0x7fffffff;
    }
    else {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* OT::cff1_subset_plan::plan_subset_encoding(OT::cff1::accelerator_subset_t const&,
   hb_subset_plan_t*) */

void __thiscall
OT::cff1_subset_plan::plan_subset_encoding
          (cff1_subset_plan *this,accelerator_subset_t *param_1,hb_subset_plan_t *param_2)
...
LAB_001058d2:
            __hb_CrapPool =
                 CONCAT44(_DAT_0011100c,CONCAT22(_DAT_0011100a,CONCAT11(DAT_00111009,_hb_NullPool)))
            ;
            goto LAB_00105451;
          }
          uVar12 = uVar21;
        ...
        *puVar9 = uVar20;
        puVar9[1] = uVar14;
LAB_00105451:
        if (pbVar5 != &_hb_NullPool) {
          uVar12 = cff1::
                   accelerator_templ_t<CFF::cff1_private_dict_opset_subset_t,CFF::cff1_private_dict_values_base_t<CFF::op_str_t>>
                   ::glyph_to_sid((uint)*(undefined8 *)(param_1 + 0x50),
                                  (code_pair_t *)(ulong)*(uint *)(param_1 + 0x128));
          if ((int)local_58 < 0) {
            bVar2 = *pbVar5;
                ...
                if (uVar12 == (ushort)(*(ushort *)(pbVar11 + 1) << 8 | *(ushort *)(pbVar11 + 1) >> 8
                  ...
                  if ((int)local_58 <= (int)local_58._4_4_) {
                    cVar7 = hb_vector_t<unsigned_int,false>::alloc
                                      ((hb_vector_t<unsigned_int,false> *)&local_58,
                                       local_58._4_4_ + 1,false);
                    if (cVar7 == '\0') {
                      __hb_CrapPool =
                           CONCAT44(_DAT_00111044,
                                    CONCAT22(_DAT_0011100a,CONCAT11(DAT_00111009,_hb_NullPool)));
                      goto LAB_001054f0;
                    }
                  }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* remap_sid_t::add(unsigned int) */

uint __thiscall remap_sid_t::add(remap_sid_t *this,uint param_1)
...
LAB_00105a72:
  ...
  if (uVar12 <= (*(uint *)(this + 0x20) >> 1) + *(uint *)(this + 0x20)) {
    cVar3 = hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc
                      ((hb_hashmap_t<unsigned_int,unsigned_int,true> *)(this + 8),0);
    if (cVar3 == '\0') {
      lVar11 = *(long *)(this + 0x30);
      uVar12 = *(uint *)(this + 0x24);
      uVar10 = *(uint *)(this + 0x28);
...
LAB_00105b0b:
  ...
  *(int *)(this + 0x1c) = iVar7 + 1;
  if ((uVar2 < uVar10) && (*(uint *)(this + 0x24) < (uint)(iVar9 << 3))) {
    hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc
              ((hb_hashmap_t<unsigned_int,unsigned_int,true> *)(this + 8),*(uint *)(this + 0x24) - 8
              );
  }
  uVar12 = *(uint *)(this + 0x3c);
  if (*(int *)(this + 0x38) <= (int)uVar12) {
    cVar3 = hb_vector_t<unsigned_int,false>::alloc
                      ((hb_vector_t<unsigned_int,false> *)(this + 0x38),uVar12 + 1,false);
    if (cVar3 == '\0') {
      __hb_CrapPool = __hb_NullPool;
      goto LAB_00105af7;
    }
...

{
  ...
  hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc
            ((hb_hashmap_t<unsigned_int,unsigned_int,true> *)this,uVar19);
  hb_vector_t<unsigned_int,false>::alloc
            ((hb_vector_t<unsigned_int,false> *)(this + 0x30),uVar19,false);
...
joined_r0x00105efa:
  if (uVar19 == 0xffffffff) goto LAB_00105fbe;
LAB_00105f00:
  do {
...
LAB_001061ef:
              lVar9 = (ulong)uVar21 * 0xc;
LAB_001061fa:
              puVar18 = (uint *)(lVar9 + lVar10);
          ...
          cVar5 = hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* cff1_cs_opset_flatten_t::flush_args_and_op(unsigned int, CFF::cff1_cs_interp_env_t&,
   CFF::flatten_param_t&) */

void cff1_cs_opset_flatten_t::flush_args_and_op
          ...
          if (0x8d6 < iVar4 + 0x46bU) {
            ...
            if ((int)uVar2 < *(int *)this) {
              ...
              *(undefined1 *)(*(long *)(this + 8) + (ulong)uVar2) = 0x1c;
              ...
              cVar3 = hb_vector_t<unsigned_char,false>::alloc
                                ((hb_vector_t<unsigned_char,false> *)this,uVar2 + 1,false);
...
LAB_001066a2:
    if ((param_1 != 0) && ((0x9c000aUL >> ((ulong)param_1 & 0x3f) & 1) != 0)) {
LAB_001066b9:
...
LAB_0010686c:
  CFF::str_encoder_t::encode_byte(this,(uchar)param_1);
  return;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* CFF::parsed_values_t<CFF::cff1_top_dict_val_t>::add_op(unsigned int, CFF::byte_str_ref_t const&,
   CFF::cff1_top_dict_val_t const&) */

void __thiscall
CFF::parsed_values_t<CFF::cff1_top_dict_val_t>::add_op
          (parsed_values_t<CFF::cff1_top_dict_val_t> *this,uint param_1,byte_str_ref_t *param_2,
          cff1_top_dict_val_t *param_3)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* CFF::cs_interp_env_t<CFF::number_t, CFF::Subrs<OT::IntType<unsigned short, 2u> >
   >::call_subr(CFF::biased_subrs_t<CFF::Subrs<OT::IntType<unsigned short, 2u> > > const&,
   CFF::cs_type_t) */

void __thiscall
CFF::cs_interp_env_t<CFF::number_t,CFF::Subrs<OT::IntType<unsigned_short,2u>>>::call_subr
          (cs_interp_env_t<CFF::number_t,CFF::Subrs<OT::IntType<unsigned_short,2u>>> *this,
...

{
  ...
  if (uVar5 == 0) {
    ...
    pcVar4 = (cs_interp_env_t<CFF::number_t,CFF::Subrs<OT::IntType<unsigned_short,2u>>> *)
             &_hb_CrapPool;
  }
  else {
  ...
  if (((-1 < (int)uVar5) &&
      (this_00 = *(CFFIndex<OT::IntType<unsigned_short,2u>> **)(param_1 + 2),
      this_00 != (CFFIndex<OT::IntType<unsigned_short,2u>> *)0x0)) &&
     (uVar5 < (ushort)(*(ushort *)this_00 << 8 | *(ushort *)this_00 >> 8))) {
...
/* CFF::subr_subsetter_t<cff1_subr_subsetter_t, CFF::Subrs<OT::IntType<unsigned short, 2u> >,
   OT::cff1::accelerator_subset_t const, CFF::cff1_cs_interp_env_t, cff1_cs_opset_subr_subset_t,
   14u>::subr_subsetter_t(OT::cff1::accelerator_subset_t const&, hb_subset_plan_t const*) */
...

{
  ...
  *(undefined8 *)(this + 0x18) = 0;
  this[0x20] = (subr_subsetter_t<cff1_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_short,2u>>,OT::cff1::accelerator_subset_t_const,CFF::cff1_cs_interp_env_t,cff1_cs_opset_subr_subset_t,14u>
                )0x1;
  ...
  *(undefined8 *)(this + 0x48) = 0;
  this[0x50] = (subr_subsetter_t<cff1_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_short,2u>>,OT::cff1::accelerator_subset_t_const,CFF::cff1_cs_interp_env_t,cff1_cs_opset_subr_subset_t,14u>
                )0x0;
...
LAB_00107544:
  ...
  *(undefined8 *)(this + 0x90) = 0;
  ...
  this[0x98] = (subr_subsetter_t<cff1_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_short,2u>>,OT::cff1::accelerator_subset_t_const,CFF::cff1_cs_interp_env_t,cff1_cs_opset_subr_subset_t,14u>
                )0x1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* OT::cff1::accelerator_templ_t<CFF::cff1_private_dict_opset_subset_t,
   CFF::cff1_private_dict_values_base_t<CFF::op_str_t> >::create_glyph_to_sid_map() const */
...
LAB_00107820:
    ...
    while( true ) {
      ...
      iVar15 = (ushort)(*(ushort *)(pcVar5 + uVar11 * 4 + 1) << 8 |
                       *(ushort *)(pcVar5 + uVar11 * 4 + 1) >> 8) - uVar8;
      do {
        uVar14 = (ulong)uVar8;
        iVar1 = iVar15 + uVar8;
        uVar8 = uVar8 + 1;
...
LAB_001078ec:
  if (1 < uVar4) {
    ...
    while( true ) {
      ...
      iVar15 = (ushort)(*(ushort *)(pcVar5 + uVar11 * 3 + 1) << 8 |
                       *(ushort *)(pcVar5 + uVar11 * 3 + 1) >> 8) - uVar8;
      do {
        uVar14 = (ulong)uVar8;
        iVar1 = iVar15 + uVar8;
        uVar8 = uVar8 + 1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* OT::cff1_subset_plan::plan_subset_charset(OT::cff1::accelerator_subset_t const&,
   hb_subset_plan_t*) */

undefined8 __thiscall
OT::cff1_subset_plan::plan_subset_charset
          (cff1_subset_plan *this,accelerator_subset_t *param_1,hb_subset_plan_t *param_2)
...
LAB_00107cc0:
  ...
  if (iVar2 == -1) {
    hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc
              ((hb_hashmap_t<unsigned_int,unsigned_int,true> *)(this + 400),uVar8);
    hb_vector_t<unsigned_int,false>::alloc
              ((hb_vector_t<unsigned_int,false> *)(this + 0x1c0),uVar8,true);
  }
  uVar16 = 1;
  uVar17 = 0xfffffffe;
  if (1 < uVar8) {
...
LAB_00107b44:
        uVar9 = *(uint *)(*(long *)(__ptr + 2) + (ulong)uVar14 * 8);
...
LAB_00107b94:
        if ((uVar14 == uVar16) && ((bool)(iVar2 != -1 & bVar21))) {
...
LAB_00107bf6:
  iVar20 = *(int *)(this + 0x174);
  lVar5 = *(long *)(this + 0x178);
  if (iVar20 == 0) {
LAB_00107ea0:
    cVar7 = (cff1_subset_plan)0x1;
  }
  else {
    uVar18 = 0;
...
LAB_001083a0:
              if ((*(byte *)(plVar14 + 1) & 2) == 0) goto LAB_00108458;
...
LAB_00108bd1:
          if ((*(byte *)(plVar19 + 1) & 2) == 0) goto LAB_00108c68;
...
/* bool CFF::UnsizedByteStr::serialize_int<OT::IntType<short, 2u>, unsigned
   int>(hb_serialize_context_t*, unsigned int, unsigned int) */

bool CFF::UnsizedByteStr::serialize_int<OT::IntType<short,2u>,unsigned_int>
               (hb_serialize_context_t *param_1,uint param_2,uint param_3)

{
  ...
  if (*(int *)(param_1 + 0x2c) == 0) {
    ...
    if (*(undefined1 **)(param_1 + 0x10) == puVar1 ||
        (long)*(undefined1 **)(param_1 + 0x10) - (long)puVar1 < 0) {
LAB_001090f0:
      *(undefined4 *)(param_1 + 0x2c) = 4;
      return false;
    }
    ...
    *(undefined1 **)(param_1 + 8) = puVar1 + 1;
    if ((puVar1 != (undefined1 *)0x0) && (*puVar1 = (char)param_2, *(int *)(param_1 + 0x2c) == 0)) {
      if (*(long *)(param_1 + 0x10) - (long)(puVar1 + 1) < 2) goto LAB_001090f0;
...

{
  ...
  if (param_2) {
    ...
    if (uVar1 < uVar3) {
      if (0xfffffff < uVar3) goto LAB_00109146;
      pvVar2 = *(void **)(this + 8);
    }
    else {
      if (uVar1 >> 2 <= uVar3) {
...
/* CFF::parsed_cs_str_t::compact() */

void __thiscall CFF::parsed_cs_str_t::compact(parsed_cs_str_t *this)

{
  ...
  do {
    ...
    if (((((int)plVar7[1] == 10) || ((int)plVar7[1] == 0x1d)) || ((int)plVar6[1] == 10)) ||
       ((((int)plVar6[1] == 0x1d || (*(char *)((long)plVar7 + 0xd) != *(char *)((long)plVar6 + 0xd))
         ) || ((bVar1 = *(byte *)((long)plVar7 + 0xc), *plVar6 != (ulong)bVar1 + *plVar7 ||
               (bVar2 = *(byte *)((long)plVar6 + 0xc), 0xff < (uint)bVar1 + (uint)bVar2)))))) {
  ...
  if (uVar8 < uVar3) {
    *(uint *)(this + 0xc) = uVar8;
    hb_vector_t<CFF::parsed_cs_op_t,false>::alloc
              ((hb_vector_t<CFF::parsed_cs_op_t,false> *)(this + 8),uVar8,true);
    return;
  }
  return;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* cff1_cs_opset_subr_subset_t::process_call_subr(unsigned int, CFF::cs_type_t,
   CFF::cff1_cs_interp_env_t&, CFF::subr_subset_param_t&,
   CFF::biased_subrs_t<CFF::Subrs<OT::IntType<unsigned short, 2u> > >&, hb_set_t*) */

void cff1_cs_opset_subr_subset_t::process_call_subr
...

{
  ...
  if ((((int)uVar12 < 0) ||
      (this = *(CFFIndex<OT::IntType<unsigned_short,2u>> **)(param_5 + 2),
      this == (CFFIndex<OT::IntType<unsigned_short,2u>> *)0x0)) ||
     ((ushort)(*(ushort *)this << 8 | *(ushort *)this >> 8) <= uVar12)) {
LAB_00109570:
...
LAB_001094c5:
      plVar10 = (long *)((ulong)uVar15 * 0x10 + *(long *)(puVar4 + 4));
      puVar4[3] = uVar16;
      *plVar10 = 0;
      ...
      *(short *)((long)plVar10 + 0xe) = (short)uVar12;
      ...
      cVar7 = hb_vector_t<CFF::parsed_cs_op_t,false>::alloc
                        ((hb_vector_t<CFF::parsed_cs_op_t,false> *)(puVar4 + 2),uVar16,false);
      if (cVar7 != '\0') {
        uVar15 = puVar4[3];
    ...
    if ((uVar12 != 0xffffffff) && (*(char *)(param_6 + 0x10) == '\x01')) {
      *(undefined4 *)(param_6 + 0x14) = 0xffffffff;
      ...
      if (puVar9 != (undefined4 *)0x0) {
        *(ulong *)(puVar9 + (ulong)(uVar12 >> 6 & 7) * 2 + 2) =
             *(ulong *)(puVar9 + (ulong)(uVar12 >> 6 & 7) * 2 + 2) | 1L << ((byte)uVar12 & 0x3f);
        *puVar9 = 0xffffffff;
      }
    }
  }
          ...
          (puVar9 = (undefined4 *)
                    hb_bit_set_t::page_for((hb_bit_set_t *)(param_6 + 0x10),uVar12,false),
  ...
  if (iVar3 == 1) {
    ...
    if (*(uint *)(lVar13 + 4) <= uVar1) goto LAB_00109448;
LAB_0010946f:
    lVar13 = *(long *)(lVar13 + 8) + (ulong)uVar1 * 0x28;
  }
  else {
    if (iVar3 == 2) {
      lVar13 = param_4[3];
  ...
  if (lVar13 != 0) {
    ...
    hb_vector_t<CFF::parsed_cs_op_t,false>::alloc
              ((hb_vector_t<CFF::parsed_cs_op_t,false> *)(lVar13 + 8),*(uint *)(param_3 + 1),true);
    *param_4 = lVar13;
    return;
  }
LAB_00109448:
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* cff1_cs_opset_subr_subset_t::process_op(unsigned int, CFF::cff1_cs_interp_env_t&,
   CFF::subr_subset_param_t&) */

void cff1_cs_opset_subr_subset_t::process_op
               (uint param_1,cff1_cs_interp_env_t *param_2,subr_subset_param_t *param_3)
...
LAB_0010982f:
            ...
            *plVar6 = 0;
            ...
            cVar4 = hb_vector_t<CFF::parsed_cs_op_t,false>::alloc
                              ((hb_vector_t<CFF::parsed_cs_op_t,false> *)(puVar8 + 2),uVar5 + 1,
                               false);
            if (cVar4 != '\0') {
              uVar5 = puVar8[3];
        ...
        *(undefined8 *)(param_2 + 0x1030) = uVar1;
        ...
        if (iVar10 == 1) {
          ...
          if (*(uint *)(lVar11 + 4) <= uVar5) goto LAB_0010974a;
LAB_00109953:
          lVar11 = *(long *)(lVar11 + 8) + (ulong)uVar5 * 0x28;
        }
        else {
          if (iVar10 == 2) {
          ...
          if (iVar10 != 0) goto LAB_0010974a;
          lVar11 = *(long *)(param_3 + 8);
        }
        if (lVar11 != 0) {
          if ((*(byte *)(lVar11 + 0x18) & 1) == 0) {
            hb_vector_t<CFF::parsed_cs_op_t,false>::alloc
                      ((hb_vector_t<CFF::parsed_cs_op_t,false> *)(lVar11 + 8),*(uint *)(param_2 + 8)
                       ,true);
          }
          *(long *)param_3 = lVar11;
          return;
...
LAB_00109991:
                    /* WARNING: Could not recover jumptable at 0x001099a1. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        (*(code *)(&DAT_00109e08 + *(int *)(&DAT_00109e08 + (ulong)param_1 * 4)))();
        return;
      }
LAB_00109a60:
      CFF::opset_t<CFF::number_t>::process_op(param_1,(interp_env_t *)param_2);
    }
    else {
      if (param_1 == 0x1d) {
      ...
      if (param_1 != 0x100) {
        if (param_1 < 0x20) goto LAB_00109991;
        if (param_1 == 0xff) {
          uVar5 = *(uint *)(param_2 + 0xc);
          uVar9 = *(uint *)(param_2 + 8);
          uVar14 = uVar5 + 4;
          if (uVar14 <= uVar9) {
            ...
            *(double *)pcVar7 =
                 (double)(int)(uVar5 >> 0x18 | (uVar5 & 0xff0000) >> 8 | (uVar5 & 0xff00) << 8 |
                              uVar5 << 0x18) * __LC12;
            *(uint *)(param_2 + 0xc) = uVar14;
          }
          goto LAB_001099c5;
        }
        if (3 < param_1 - 0x122) goto LAB_00109a60;
      }
      *(undefined4 *)(param_2 + 0x14) = 0;
      *(undefined4 *)(param_2 + 0x1174) = 0;
    }
LAB_001099c5:
    ...
    if ((int)puVar8[2] <= (int)uVar5) {
      cVar4 = hb_vector_t<CFF::parsed_cs_op_t,false>::alloc
                        ((hb_vector_t<CFF::parsed_cs_op_t,false> *)(puVar8 + 2),uVar5 + 1,false);
      if (cVar4 == '\0') {
        __hb_CrapPool = __hb_NullPool;
        _memcpy = _lookup_expert_subset_charset_for_sid;
        plVar6 = (long *)&_hb_CrapPool;
...
LAB_00109a04:
  ...
  puVar8 = *(uint **)param_3;
  puVar12 = puVar8;
  if ((puVar8[6] & 1) != 0) goto LAB_0010979d;
  uVar5 = puVar8[3];
  if ((int)uVar5 < (int)puVar8[2]) {
LAB_0010989f:
    plVar6 = (long *)((ulong)uVar5 * 0x10 + *(long *)(puVar8 + 4));
...

{
  ...
  if (param_2) {
    ...
    if (uVar11 <= uVar13) {
      ...
      if (0x6666666 < uVar11) goto LAB_00109ee9;
      if (uVar11 == 0) {
...

{
  ...
  if (param_3) {
    ...
    uVar9 = (ulong)uVar2;
    if (uVar4 < uVar2) {
      if (0xfffffff < uVar2) goto LAB_0010a18a;
      pvVar7 = *(void **)(this + 8);
LAB_0010a294:
      uVar8 = (uint)uVar9;
...
LAB_0010a18a:
      ...
      if (uVar4 >> 2 <= uVar2) goto LAB_0010a0fc;
      if (0xfffffff < uVar2) goto LAB_0010a18a;
      pvVar7 = *(void **)(this + 8);
      if (uVar2 != 0) goto LAB_0010a294;
      free(pvVar7);
      uVar8 = 0;
      pvVar7 = (void *)0x0;
    }
    ...
    *(uint *)this = uVar8;
    ...
    if (uVar4 < uVar3) {
      ...
      if (0xfffffff < uVar8) goto LAB_0010a18a;
      pvVar7 = *(void **)(this + 8);
      uVar9 = (ulong)uVar8;
      goto LAB_0010a294;
    }
        ...
        if (uVar4 != 0) {
          ...
          do {
            while (lVar11 = lVar10 + -0x28, *(int *)(lVar10 + 8) != 0) {
              ...
              lVar10 = lVar11;
              if (lVar12 == lVar11) goto LAB_0010a251;
            }
            lVar10 = lVar11;
          } while (lVar12 != lVar11);
LAB_0010a251:
...
LAB_0010a4b0:
      uVar7 = 0;
LAB_0010a4b2:
      if (*(uint *)(lVar13 + 0x90) <= (uint)uVar7) {
LAB_0010a482:
        uVar8 = 0;
        goto LAB_0010a484;
      }
      ...
      if (*pcVar4 != '\x03') goto LAB_0010a4b0;
      ppVar11 = local_a8;
      if (*(short *)(pcVar4 + 1) != 0) {
      ...
      if (-1 < iVar15) {
        ...
        do {
          while( true ) {
            ...
            iVar15 = uVar9 - 1;
            if (iVar15 < iVar16) goto LAB_0010a443;
          }
          if (uVar6 < (ushort)(*(ushort *)(ppVar10 + 3) << 8 | *(ushort *)(ppVar10 + 3) >> 8))
          goto LAB_0010a470;
          iVar16 = uVar9 + 1;
        } while (iVar16 <= iVar15);
      }
LAB_0010a443:
      uVar6 = (ushort)(*(ushort *)(pcVar4 + 1) << 8 | *(ushort *)(pcVar4 + 1) >> 8) - 1;
      ppVar10 = local_a8;
      if (uVar6 < (ushort)(*(ushort *)(pcVar4 + 1) << 8 | *(ushort *)(pcVar4 + 1) >> 8)) {
        ppVar10 = (parsed_cs_str_vec_t *)(pcVar4 + (ulong)uVar6 * 3 + 3);
      }
LAB_0010a470:
      uVar7 = (ulong)(byte)ppVar10[2];
      if (*(uint *)(*(long *)this + 0x90) <= (uint)(byte)ppVar10[2]) goto LAB_0010a482;
    }
    ...
    if ((puVar12[0x18] & 0x10) != 0) {
      ...
      for (; lVar17 != lVar13; lVar17 = lVar17 + 0x10) {
        while( true ) {
          if ((local_48 != 0) && (*(char *)(lVar17 + 0xd) != '\0')) goto LAB_0010a57c;
          if (*(int *)(lVar17 + 8) != 10) break;
          puVar1 = (ushort *)(lVar17 + 0xe);
          lVar17 = lVar17 + 0x10;
          collect_subr_refs_in_subr
                    ((uint)*puVar1,local_60,local_50,(subr_subset_param_t *)&local_78);
          if (lVar13 == lVar17) goto LAB_0010a5c0;
        }
        if (*(int *)(lVar17 + 8) == 0x1d) {
          collect_subr_refs_in_subr
                    ((uint)*(ushort *)(lVar17 + 0xe),local_68,(hb_set_t *)local_58,
...
CFF::
subr_subsetter_t<cff1_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_short,2u>>,OT::cff1::accelerator_subset_t_const,CFF::cff1_cs_interp_env_t,cff1_cs_opset_subr_subset_t,14u>
::subset(subr_subsetter_t<cff1_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_short,2u>>,OT::cff1::accelerator_subset_t_const,CFF::cff1_cs_interp_env_t,cff1_cs_opset_subr_subset_t,14u>
         *this)

{
  ...
  void *pvVar11;
  long *plVar12;
  hb_vector_t<CFF::parsed_cs_str_t,false> *phVar13;
  ...
  *local_11e8;
  ...
  uVar41 = (uint)uVar43;
  if (lVar31 == 0) {
    cVar10 = hb_vector_t<CFF::parsed_cs_str_t,false>::alloc
                       ((hb_vector_t<CFF::parsed_cs_str_t,false> *)(this + 0xe0),uVar41,true);
    if (cVar10 != '\0') {
        ...
        do {
          ...
          *puVar45 = 0;
          puVar45 = puVar34;
                 ...
                 (undefined4 *)
                 (lVar32 + 0x28 + ((ulong)((uVar41 - uVar36) - 1) + (ulong)uVar36) * 0x28));
      }
    ...
    phVar13 = (hb_vector_t<CFF::parsed_cs_str_t,false> *)(this + 0xf0);
    uVar35 = **(ushort **)(*(long *)this + 0x70) << 8 | **(ushort **)(*(long *)this + 0x70) >> 8;
    cVar10 = hb_vector_t<CFF::parsed_cs_str_t,false>::alloc(phVar13,(uint)uVar35,true);
    if (cVar10 != '\0') {
        ...
        do {
          ...
          *puVar45 = 0;
          puVar45 = puVar34;
                 ...
                 (lVar32 + 0x28 + ((ulong)((uVar36 - uVar41) - 1) + (ulong)uVar41) * 0x28) !=
                 puVar34);
      }
    ...
    cVar10 = hb_vector_t<CFF::parsed_cs_str_vec_t,false>::resize(this_00,iVar38,true,false);
    if (cVar10 != '\0') {
      lVar32 = *(long *)this;
      if (*(int *)(lVar32 + 0x90) != 0) {
        ...
        do {
          ...
          if (uVar36 < uVar41) {
            phVar47 = (hb_vector_t<CFF::parsed_cs_str_t,false> *)
                      (lVar29 * 0x10 + *(long *)(this + 0x108));
          }
          else {
            __hb_CrapPool = __hb_NullPool;
            _memcpy = _lookup_expert_subset_charset_for_sid;
          ...
          cVar10 = hb_vector_t<CFF::parsed_cs_str_t,false>::alloc(phVar47,(uint)uVar35,false);
          if (cVar10 != '\0') {
              ...
              do {
                ...
                *puVar45 = 0;
                puVar45 = puVar34;
                       ...
                       (undefined4 *)
                       (lVar32 + 0x28 + ((ulong)((uVar35 - 1) - uVar41) + (ulong)uVar41) * 0x28));
            }
          ...
          if (*piVar15 < 0) goto LAB_0010a950;
          lVar32 = *(long *)this;
          lVar29 = lVar29 + 1;
    ...
    if (-1 < (int)uVar36) {
      ...
      if (uVar36 < uVar30) {
        if (uVar30 < 0x20000000) {
          pvVar11 = *(void **)(this + 0x70);
LAB_0010a782:
          pvVar11 = realloc(pvVar11,uVar43 << 3);
          if (pvVar11 != (void *)0x0) goto LAB_0010a796;
          uVar36 = *(uint *)(this + 0x68);
          if (uVar30 <= uVar36) goto LAB_0010a79d;
        }
...
LAB_0010a79d:
        ...
        if (uVar19 < uVar41) {
          hb_memset((void *)(*(long *)(this + 0x70) + (ulong)uVar19 * 8),(uVar41 - uVar19) * 8,
                    uVar19);
        }
        *(uint *)(this + 0x6c) = uVar41;
      }
    }
    phVar13 = (hb_vector_t<CFF::parsed_cs_str_t,false> *)(lVar31 + 0x10);
    this_00 = (hb_vector_t<CFF::parsed_cs_str_vec_t,false> *)(lVar31 + 0x20);
LAB_0010a7cb:
    *(hb_vector_t<CFF::parsed_cs_str_t,false> **)(this + 0x78) = phVar13;
    *(hb_vector_t<CFF::parsed_cs_str_vec_t,false> **)(this + 0x80) = this_00;
    if ((((-1 < *(int *)(this + 0xd0)) && (-1 < *(int *)(this + 0x68))) &&
        (-1 < *(int *)(this + 0xe0))) && ((-1 < *(int *)phVar13 && (-1 < *(int *)(this + 0x58))))) {
      ...
      if (puVar2 != puVar46) {
        do {
          ...
          uVar36 = *puVar46;
          uVar43 = (ulong)uVar36;
          auVar50 = OT::CFFIndex<OT::IntType<unsigned_short,2u>>::operator[]
                              (*(CFFIndex<OT::IntType<unsigned_short,2u>> **)(*(long *)this + 0x78),
                               uVar41);
          lVar32 = *(long *)this;
...
LAB_0010a980:
            uVar21 = 0;
LAB_0010a983:
            if (*(uint *)(lVar32 + 0x90) <= (uint)uVar21) goto LAB_0010a950;
          }
          else {
            if (*pcVar7 == '\0') {
            ...
            if (*pcVar7 != '\x03') goto LAB_0010a980;
            ...
            if (-1 < iVar38) {
              ...
              do {
                while( true ) {
                  ...
                  iVar38 = uVar19 - 1;
                  if (iVar38 < iVar42) goto LAB_0010a905;
                }
                if (uVar41 < (ushort)(*(ushort *)((long)puVar25 + 3) << 8 |
                                     *(ushort *)((long)puVar25 + 3) >> 8)) goto LAB_0010a938;
                iVar42 = uVar19 + 1;
              } while (iVar42 <= iVar38);
            }
LAB_0010a905:
...
LAB_0010a938:
            ...
            if (*(uint *)(lVar32 + 0x90) <= (uint)(byte)puVar25[1]) goto LAB_0010a950;
          }
          if (lVar31 == 0) {
            puVar20 = &_hb_NullPool;
            uVar41 = (uint)uVar21;
            ...
            local_17c = 0;
            pauVar14 = (undefined1 (*) [16])local_178;
            do {
              pauVar9 = pauVar14 + 1;
              *pauVar14 = (undefined1  [16])0x0;
              pauVar14 = (undefined1 (*) [16])(*pauVar9 + 8);
            } while ((undefined1 (*) [16])local_88 != (undefined1 (*) [16])(*pauVar9 + 8));
            local_18f = _LC14;
            local_88[0] = 0x6b;
            local_19c = 0;
            local_198 = 0;
            ...
            if ((local_80 != (ushort *)0x0) &&
               (uVar35 = *local_80 << 8 | *local_80 >> 8, 0x4d7 < uVar35)) {
              local_88[0] = (-(uint)(uVar35 < 0x846c) & 0xffff846b) + 0x8000;
            }
            local_78 = 0x6b;
            if ((local_70 != (ushort *)0x0) &&
               (uVar35 = *local_70 << 8 | *local_70 >> 8, 0x4d7 < uVar35)) {
            ...
            hb_vector_t<CFF::parsed_cs_op_t,false>::alloc
                      ((hb_vector_t<CFF::parsed_cs_op_t,false> *)(puVar20 + 8),local_1a0,true);
...
LAB_0010b816:
                ...
                if (*(byte *)(local_11c8 + (ulong)uVar30) == 0xc) {
                  if (uVar19 < uVar30 + 2) goto LAB_0010b816;
                  local_11c0 = CONCAT44(uVar30 + 2,(uint)local_11c0);
                  uVar39 = *(byte *)(local_11c8 + (ulong)uVar1) + 0x100;
                }
              }
              cff1_cs_opset_subr_subset_t::process_op
                        (uVar39,(cff1_cs_interp_env_t *)&local_11c8,
                         (subr_subset_param_t *)&local_1248);
              if (local_180 != '\0') goto LAB_0010a950;
              uVar19 = (uint)local_11c0;
              if ((((uint)local_11c0 < local_11c0._4_4_) || ((char)local_11b8 != '\0')) ||
                 (local_125c = local_125c + -1, local_125c == 0)) goto LAB_0010a950;
              uVar30 = local_11c0._4_4_;
            } while (local_190 == '\0');
              ...
              do {
                while (iVar38 = *(int *)(pcVar33 + 0x1060), iVar38 == 1) {
                  if (*(uint *)(pcVar33 + 0x1064) < *(uint *)(local_1238 + 4)) {
                    puVar20 = (undefined *)
                              (*(long *)(local_1238 + 8) + (ulong)*(uint *)(pcVar33 + 0x1064) * 0x28
                              );
                    goto LAB_0010b28c;
                  }
LAB_0010b248:
                  ...
                  if (pcVar3 == pcVar33) goto LAB_0010b29e;
                }
                if (iVar38 != 2) {
                  puVar20 = puStack_1240;
                  if (iVar38 == 0) goto LAB_0010b28c;
                  goto LAB_0010b248;
                }
                if (*(uint *)(local_1230 + 4) <= *(uint *)(pcVar33 + 0x1064)) goto LAB_0010b248;
                puVar20 = (undefined *)
                          (*(long *)(local_1230 + 8) + (ulong)*(uint *)(pcVar33 + 0x1064) * 0x28);
LAB_0010b28c:
                if (puVar20 == (undefined *)0x0) goto LAB_0010b248;
                pcVar33 = pcVar33 + 0x18;
                puVar20[0x18] = puVar20[0x18] | 1;
              } while (pcVar3 != pcVar33);
            }
LAB_0010b29e:
            uVar19 = *(uint *)(*(long *)(this + 8) + 0x14);
...
LAB_0010b379:
              ...
              cVar10 = drop_hints_in_str(ppVar40,(subr_subset_param_t *)&local_1208,
                                         (drop_hints_param_t *)&local_124c);
              uVar30 = *(uint *)(this + 0xe4);
              if (cVar10 == '\0') goto LAB_0010b379;
              if (uVar30 <= uVar36) {
                _realloc = _lookup_expert_charset_for_sid;
                _memmove = _pthread_mutex_lock;
                __hb_CrapPool = __hb_NullPool;
              ...
              if (local_124c._3_1_ != '\0') {
LAB_0010b375:
                puVar20[0x18] = puVar20[0x18] | 4;
                goto LAB_0010b379;
              }
LAB_0010b38c:
              ppVar40 = (parsed_cs_str_t *)(lVar32 + uVar43 * 0x28);
            }
            ...
            *puVar34 = *puVar45;
            ...
            cVar10 = hb_vector_t<CFF::parsed_cs_op_t,false>::alloc
                               ((hb_vector_t<CFF::parsed_cs_op_t,false> *)(puVar34 + 2),0,false);
            if (cVar10 != '\0') {
              puVar34[3] = 0;
            }
            hb_vector_t<CFF::parsed_cs_op_t,false>::alloc
                      ((hb_vector_t<CFF::parsed_cs_op_t,false> *)(puVar34 + 2),puVar45[3],true);
            if (-1 < (int)puVar34[2]) {
              uVar41 = puVar45[3];
            ...
            *(byte *)(puVar34 + 6) =
                 bVar5 & 0xe0 | bVar22 | bVar23 | bVar24 | bVar4 & 8 | *(byte *)(puVar45 + 6) & 0x10
            ;
      ...
      if (((lVar31 == 0) && ((*(byte *)(*(long *)(this + 8) + 0x14) & 1) == 0)) ||
         (cVar10 = closure_subroutines(this,*(parsed_cs_str_vec_t **)(this + 0x78),
                                       *(hb_vector_t **)(this + 0x80)), cVar10 != '\0')) {
        lVar31 = 0;
        ...
        if (*(long *)(*(long *)(this + 8) + 0xad8) != 0) {
          ...
          for (; lVar32 != lVar31; lVar32 = lVar32 + 0x28) {
            ...
            if (1 < uVar41) {
              ...
              uVar21 = 0;
              uVar43 = 0;
              plVar12 = (long *)(lVar29 + 0x10);
              do {
                plVar26 = (long *)(uVar43 * 0x10 + lVar29);
                if ((((((int)plVar26[1] == 10) || ((int)plVar26[1] == 0x1d)) ||
                     ((int)plVar12[1] == 10)) ||
                    (((int)plVar12[1] == 0x1d ||
                     (*(char *)((long)plVar26 + 0xd) != *(char *)((long)plVar12 + 0xd))))) ||
                   ((bVar49 = *(byte *)((long)plVar26 + 0xc), *plVar12 != (ulong)bVar49 + *plVar26
                    || (bVar5 = *(byte *)((long)plVar12 + 0xc), 0xff < (uint)bVar49 + (uint)bVar5)))
                   ) {
                ...
                plVar12 = plVar12 + 2;
              } while ((long *)(lVar29 + 0x20 + (ulong)(uVar41 - 2) * 0x10) != plVar12);
              uVar36 = (int)uVar21 + 1;
              if ((int)uVar36 < 0) {
                uVar36 = 0;
              }
              if (uVar36 < uVar41) {
                *(uint *)(lVar32 + 0xc) = uVar36;
                hb_vector_t<CFF::parsed_cs_op_t,false>::alloc
                          ((hb_vector_t<CFF::parsed_cs_op_t,false> *)(lVar32 + 8),uVar36,true);
              }
            }
          }
          ...
          for (; lVar32 != lVar31; lVar32 = lVar32 + 0x10) {
            ...
            for (; lVar28 != lVar29; lVar28 = lVar28 + 0x28) {
              ...
              if (1 < uVar41) {
                pvVar11 = *(void **)(lVar28 + 0x10);
                uVar21 = 0;
                uVar43 = 0;
                plVar12 = (long *)((long)pvVar11 + 0x10);
                do {
                  plVar26 = (long *)(uVar43 * 0x10 + (long)pvVar11);
                  if (((((int)plVar26[1] == 10) || ((int)plVar26[1] == 0x1d)) ||
                      (((int)plVar12[1] == 10 ||
                       ((((int)plVar12[1] == 0x1d ||
                         (*(char *)((long)plVar26 + 0xd) != *(char *)((long)plVar12 + 0xd))) ||
                        (bVar49 = *(byte *)((long)plVar26 + 0xc),
                        *plVar12 != (ulong)bVar49 + *plVar26)))))) ||
                     (bVar5 = *(byte *)((long)plVar12 + 0xc), 0xff < (uint)bVar49 + (uint)bVar5)) {
                    uVar21 = (ulong)((int)uVar21 + 1);
                    lVar16 = plVar12[1];
                    plVar26 = (long *)((long)pvVar11 + uVar21 * 0x10);
                    *plVar26 = *plVar12;
                    plVar26[1] = lVar16;
                    uVar43 = uVar21;
                  }
                  ...
                  plVar12 = plVar12 + 2;
                } while (plVar12 != (long *)((long)pvVar11 + (ulong)(uVar41 - 2) * 0x10 + 0x20));
                uVar19 = (int)uVar21 + 1;
                uVar36 = 0;
                if (-1 < (int)uVar19) {
                  uVar36 = uVar19;
...
LAB_0010ac50:
                        pvVar11 = realloc(pvVar11,(long)(int)uVar36 << 4);
                        if (pvVar11 != (void *)0x0) {
LAB_0010ac65:
                          *(void **)(lVar28 + 0x10) = pvVar11;
                          *(uint *)(lVar28 + 8) = uVar36;
                          goto LAB_0010ac70;
                        }
                        uVar41 = *(uint *)(lVar28 + 8);
                        if (uVar36 <= uVar41) goto LAB_0010ac70;
                      }
                    }
                    else {
                      if (uVar41 >> 2 <= uVar36) goto LAB_0010ac70;
                      if ((int)uVar19 < 0x10000000) {
                        if (0 < (int)uVar19) goto LAB_0010ac50;
                        free(pvVar11);
                        pvVar11 = (void *)0x0;
                        goto LAB_0010ac65;
                      }
...
LAB_0010ac70:
          ...
          phVar13 = (hb_vector_t<CFF::parsed_cs_str_t,false> *)malloc(0x40);
          if (phVar13 != (hb_vector_t<CFF::parsed_cs_str_t,false> *)0x0) {
            *(undefined8 *)phVar13 = 0;
            *(undefined8 *)(phVar13 + 8) = 0;
            *(undefined8 *)(phVar13 + 0x10) = 0;
            *(undefined8 *)(phVar13 + 0x18) = 0;
            *(undefined8 *)(phVar13 + 0x20) = 0;
            *(undefined1 (*) [16])(phVar13 + 0x28) = (undefined1  [16])0x0;
            cVar10 = hb_vector_t<CFF::parsed_cs_str_t,false>::alloc(phVar13,0,false);
            if (cVar10 != '\0') {
              uVar41 = *(uint *)(phVar13 + 4);
              if (uVar41 != 0) {
                lVar32 = *(long *)(phVar13 + 8) + -0x28 + (ulong)uVar41 * 0x28;
                lVar29 = lVar32;
                do {
                  lVar28 = lVar29 + -0x28;
                  if (*(int *)(lVar29 + 8) != 0) {
              ...
              *(undefined4 *)(phVar13 + 4) = 0;
            }
            hb_vector_t<CFF::parsed_cs_str_t,false>::alloc(phVar13,*(uint *)(this + 0xe4),true);
            if (-1 < *(int *)phVar13) {
              iVar38 = *(int *)(this + 0xe4);
              *(undefined4 *)(phVar13 + 4) = 0;
              if (iVar38 != 0) {
                iVar42 = 0;
                puVar45 = *(undefined4 **)(phVar13 + 8);
                puVar34 = *(undefined4 **)(this + 0xe8);
                do {
                  iVar42 = iVar42 + 1;
                  *(int *)(phVar13 + 4) = iVar42;
                  uVar6 = *puVar34;
                  puVar45[2] = 0;
                  *puVar45 = uVar6;
                  uVar41 = puVar34[3];
                  ...
                  *(undefined8 *)(puVar45 + 4) = 0;
                  if (uVar41 != 0) {
                    if (uVar41 < 0x10000000) {
                      pvVar11 = malloc((ulong)uVar41 << 4);
                      if (pvVar11 != (void *)0x0) {
                        *(void **)(puVar45 + 4) = pvVar11;
                        ...
                        do {
                          ...
                          *(undefined8 *)((long)pvVar11 + sVar27) = *(undefined8 *)(lVar32 + sVar27)
                          ;
                          ((undefined8 *)((long)pvVar11 + sVar27))[1] = uVar8;
                          sVar27 = sVar27 + 0x10;
...
LAB_0010bcd2:
            ...
            if ((int)*(uint *)(phVar13 + 0x10) < 0) {
              *(uint *)(phVar13 + 0x10) = ~*(uint *)(phVar13 + 0x10);
            }
            cVar10 = hb_vector_t<CFF::parsed_cs_str_t,false>::alloc(phVar13 + 0x10,0,false);
            if (cVar10 != '\0') {
              uVar41 = *(uint *)(phVar13 + 0x14);
              if (uVar41 != 0) {
                lVar32 = *(long *)(phVar13 + 0x18) + -0x28 + (ulong)uVar41 * 0x28;
                lVar29 = lVar32;
                do {
                  lVar28 = lVar29 + -0x28;
                  if (*(int *)(lVar29 + 8) != 0) {
              ...
              *(undefined4 *)(phVar13 + 0x14) = 0;
            }
            hb_vector_t<CFF::parsed_cs_str_t,false>::alloc
                      (phVar13 + 0x10,*(uint *)(this + 0xf4),true);
            if (-1 < *(int *)(phVar13 + 0x10)) {
              iVar38 = *(int *)(this + 0xf4);
              *(undefined4 *)(phVar13 + 0x14) = 0;
              if (iVar38 != 0) {
                iVar42 = 0;
                puVar45 = *(undefined4 **)(phVar13 + 0x18);
                puVar34 = *(undefined4 **)(this + 0xf8);
                do {
                  iVar42 = iVar42 + 1;
                  *(int *)(phVar13 + 0x14) = iVar42;
                  uVar6 = *puVar34;
                  puVar45[2] = 0;
                  *puVar45 = uVar6;
                  uVar41 = puVar34[3];
...
LAB_0010be72:
            ...
            if ((int)*(uint *)(phVar13 + 0x20) < 0) {
              *(uint *)(phVar13 + 0x20) = ~*(uint *)(phVar13 + 0x20);
            }
            uVar41 = *(uint *)(phVar13 + 0x24);
            if (uVar41 != 0) {
              piVar48 = (int *)(*(long *)(phVar13 + 0x28) + -0x10 + (ulong)uVar41 * 0x10);
              piVar15 = piVar48 + (ulong)(uVar41 - 1) * -4 + -4;
              do {
                if (*piVar48 != 0) {
                  uVar41 = piVar48[1];
                  pvVar11 = *(void **)(piVar48 + 2);
                  lVar32 = (long)pvVar11 + (ulong)uVar41 * 0x28 + -0x28;
                  if (uVar41 != 0) {
                    lVar29 = lVar32;
                    do {
                      lVar28 = lVar29 + -0x28;
            ...
            uVar41 = *(uint *)(phVar13 + 0x20);
            *(undefined4 *)(phVar13 + 0x24) = 0;
            if (-1 < (int)uVar41) {
              if (uVar41 < uVar36) {
                if (uVar36 < 0x10000000) {
                  pvVar11 = *(void **)(phVar13 + 0x28);
LAB_0010bf92:
                  pvVar11 = realloc(pvVar11,(ulong)uVar36 << 4);
                  if (pvVar11 != (void *)0x0) {
LAB_0010bfb2:
                    *(void **)(phVar13 + 0x28) = pvVar11;
                    *(uint *)(phVar13 + 0x20) = uVar36;
                    uVar36 = *(uint *)(this + 0x104);
                    goto LAB_0010bfc7;
                  }
                  uVar41 = *(uint *)(phVar13 + 0x20);
...
LAB_0010bfc7:
                  ...
                  *(undefined4 *)(phVar13 + 0x24) = 0;
                  ...
                  while ((uint)uVar43 < uVar36) {
                    *(uint *)(phVar13 + 0x24) = (uint)uVar43 + 1;
                    phVar47 = (hb_vector_t<CFF::parsed_cs_str_t,false> *)
                              (*(long *)(phVar13 + 0x28) + uVar43 * 0x10);
                              ...
                              if (pvVar11 != (void *)0x0) {
                                *(void **)(puVar34 + 4) = pvVar11;
                                ...
                                do {
                                  ...
                                  *(undefined8 *)((long)pvVar11 + sVar27) =
                                       *(undefined8 *)(lVar29 + sVar27);
                                  ((undefined8 *)((long)pvVar11 + sVar27))[1] = uVar8;
                                  sVar27 = sVar27 + 0x10;
...
LAB_0010c0d2:
                    ...
                    uVar43 = (ulong)*(uint *)(phVar13 + 0x24);
                  }
                  goto LAB_0010b6ec;
                }
                if (uVar36 < 0x10000000) {
                  pvVar11 = *(void **)(phVar13 + 0x28);
                  if (uVar36 != 0) goto LAB_0010bf92;
                  free(pvVar11);
                  pvVar11 = (void *)0x0;
                  goto LAB_0010bfb2;
                }
              }
              *(uint *)(phVar13 + 0x20) = ~uVar41;
            }
LAB_0010b6ec:
            uVar17 = hb_blob_reference(uVar17);
            *(undefined8 *)(phVar13 + 0x38) = uVar17;
          }
          *(hb_vector_t<CFF::parsed_cs_str_t,false> **)(lVar31 + 0x130) = phVar13;
        }
        uVar17 = 1;
        goto LAB_0010a952;
      }
...
CFF::
subr_subsetter_t<cff1_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_short,2u>>,OT::cff1::accelerator_subset_t_const,CFF::cff1_cs_interp_env_t,cff1_cs_opset_subr_subset_t,14u>
::encode_str(subr_subsetter_t<cff1_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_short,2u>>,OT::cff1::accelerator_subset_t_const,CFF::cff1_cs_interp_env_t,cff1_cs_opset_subr_subset_t,14u>
  ...
  if (puVar12 == puVar17) {
    ...
    do {
      while( true ) {
        ...
        puVar4 = puVar4 + 2;
        iVar10 = iVar10 + 3;
        if (puVar17 == puVar4) goto LAB_0010c2f8;
      }
      puVar4 = puVar4 + 2;
...
LAB_0010c319:
    pvVar5 = realloc(pvVar5,(ulong)uVar14);
    if (pvVar5 == (void *)0x0) {
    ...
    do {
      if ((uVar3 & 1) != 0) {
        while (*(char *)((long)puVar12 + 0xd) != '\0') {
          puVar12 = puVar12 + 2;
          if (puVar17 == puVar12) goto LAB_0010c4db;
        }
      }
      if (*(int *)(puVar12 + 1) == 10) {
        ...
        if (lVar8 != 0) {
          uVar9 = (ulong)((uint)*(ushort *)((long)puVar12 + 0xe) * -0x61c8864f & 0x3fffffff) %
...
LAB_0010c62a:
        local_4c = *puVar16 - *(int *)(puVar15 + 0x40);
        if (local_4c + 0x46bU < 0x8d7) goto LAB_0010c445;
LAB_0010c642:
        if (0x7fff < local_4c) {
          local_4c = 0x7fff;
        }
...
LAB_0010c46f:
        str_encoder_t::encode_byte((str_encoder_t *)param_3,uVar13);
...
LAB_0010c429:
        local_4c = *puVar16 - *(int *)(this + 200);
        if (0x8d6 < local_4c + 0x46bU) goto LAB_0010c642;
LAB_0010c445:
        if (local_4c + 0x6bU < 0xd7) {
          ...
          str_encoder_t::encode_byte
                    ((str_encoder_t *)param_3,(char)((uint)(-0x6c - local_4c) >> 8) + 0xfb);
          ...
          if ((bVar1 & 4) == 0) {
            if (bVar1 != 0) {
              *(undefined1 *)puVar7 = *(undefined1 *)puVar4;
              if ((bVar1 & 2) == 0) goto LAB_0010c4c5;
              *(undefined2 *)((long)puVar7 + (uVar9 - 2)) =
                   *(undefined2 *)((long)puVar4 + (uVar9 - 2));
              uVar14 = *(uint *)(param_3 + 4);
            }
          }
          else {
            *(undefined4 *)puVar7 = *(undefined4 *)puVar4;
            *(undefined4 *)((long)puVar7 + (uVar9 - 4)) =
                 *(undefined4 *)((long)puVar4 + (uVar9 - 4));
            uVar14 = *(uint *)(param_3 + 4);
          }
        }
        else {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* bool CFF::FDArray<OT::IntType<unsigned short, 2u> >::serialize<CFF::cff1_font_dict_values_mod_t,
   ...
   hb_array_t<CFF::cff1_font_dict_values_mod_t const> >, cff1_font_dict_op_serializer_t&) */

bool CFF::FDArray<OT::IntType<unsigned_short,2u>>::
     serialize<CFF::cff1_font_dict_values_mod_t,CFF::cff1_font_dict_values_mod_t,hb_zip_iter_t<hb_array_t<CFF::cff1_font_dict_values_mod_t_const>,hb_array_t<CFF::cff1_font_dict_values_mod_t_const>>,cff1_font_dict_op_serializer_t>
               (ushort *param_1,hb_serialize_context_t *param_2)

{
  ...
  hb_vector_t<unsigned_int,false>::alloc
            ((hb_vector_t<unsigned_int,false> *)local_58,in_stack_00000010,false);
  if (*(int *)(param_2 + 0x2c) == 0) {
    puVar12 = (undefined8 *)
              hb_pool_t<hb_serialize_context_t::object_t,32u>::alloc
...
LAB_0010c900:
        ...
        if ((int)plVar25[1] == 0x126) {
          if (iVar5 != 0) goto LAB_0010c99d;
          uVar19 = local_90[2];
          if (*(undefined2 **)(param_2 + 0x10) != puVar23 &&
              -1 < (long)*(undefined2 **)(param_2 + 0x10) - (long)puVar23) {
...
LAB_0010cf8f:
              puVar23 = (undefined2 *)0x1;
              iVar26 = 1 - iVar26;
              goto LAB_0010c9a9;
            }
            *puVar1 = 0x1c;
            if (*(int *)(param_2 + 0x2c) != 0) goto LAB_0010c99d;
...
LAB_0010cf76:
          ...
          if ((int)plVar25[1] != 0x12) {
            ...
            if (*(long *)(param_2 + 0x10) - (long)puVar23 < (long)(ulong)bVar4) goto LAB_0010cbc8;
...
LAB_0010c989:
              puVar22 = *(undefined2 **)(param_2 + 8);
            }
LAB_0010c98d:
            lVar15 = *in_stack_00000008;
            lVar18 = lVar18 + 1;
            puVar23 = puVar22;
            if (*(uint *)(lVar15 + 0xc) <= (uint)lVar18) goto LAB_0010c99d;
            goto LAB_0010c900;
          }
          if (iVar5 != 0) goto LAB_0010c99d;
          uVar19 = *local_90;
          if (*(undefined2 **)(param_2 + 0x10) == puVar23 ||
              (long)*(undefined2 **)(param_2 + 0x10) - (long)puVar23 < 0) goto LAB_0010cbc8;
          *(undefined1 *)puVar23 = 0;
          puVar1 = *(undefined1 **)(param_2 + 8);
          puVar23 = (undefined2 *)(puVar1 + 1);
          *(undefined2 **)(param_2 + 8) = puVar23;
          if (puVar1 == (undefined1 *)0x0) goto LAB_0010cf8f;
          *puVar1 = 0x1c;
          if (*(int *)(param_2 + 0x2c) != 0) goto LAB_0010c99d;
          if (1 < *(long *)(param_2 + 0x10) - (long)puVar23) {
            ...
            puVar7 = *(ushort **)(param_2 + 8);
            *(ushort **)(param_2 + 8) = puVar7 + 1;
            if (puVar7 == (ushort *)0x0) goto LAB_0010cf76;
            uVar11 = (ushort)uVar19;
            *puVar7 = uVar11 << 8 | uVar11 >> 8;
            if ((long)(short)((uVar11 >> 8) << 8 | uVar11 & 0xff) != (ulong)uVar19)
            goto LAB_0010cb67;
            bVar29 = Dict::serialize_link_op<OT::IntType<int,4u>,29>
                               (param_2,(int)plVar25[1],local_90[1],2);
            if (bVar29) goto LAB_0010c989;
            puVar23 = *(undefined2 **)(param_2 + 8);
            iVar26 = (int)puVar23 - iVar26;
            goto LAB_0010c9a9;
          }
...
LAB_0010c9e0:
  ...
  if (iVar28 < 0) {
    ...
    if (*(int *)(param_2 + 0x2c) != 0) goto LAB_0010cdff;
    uVar27 = (long)(param_1 + 1) - (long)*(void **)(param_2 + 8);
    if ((0x7fffffff < uVar27) || (*(ushort **)(param_2 + 0x10) < param_1 + 1)) goto LAB_0010cdf8;
                ...
                if ((long)uVar27 <= *(long *)(param_2 + 0x10) - (long)puVar17) {
                  *(undefined1 **)(param_2 + 8) = puVar17 + uVar27;
                  if (uVar19 == 3) {
                    ...
                    *(ushort *)
                     (puVar1 + ((ulong)((long)(__ptr + uVar14) + (-4 - (long)__ptr)) >> 2) * 3 + 3 +
                     1) = (ushort)iVar26 << 8 | (ushort)iVar26 >> 8;
                    puVar1[((ulong)((long)(__ptr + uVar14) + (-4 - (long)__ptr)) >> 2) * 3 + 3] =
                         (char)((uint)iVar26 >> 0x10);
                  }
                  else if (uVar19 == 4) {
                    *(undefined4 *)((long)param_1 + 3) = 0x1000000;
                    uVar19 = *__ptr + 1;
                    ...
                    *(uint *)((long)param_1 + (ulong)(uint)iVar26 * 4 + 3) =
                         uVar19 >> 0x18 | (uVar19 & 0xff0000) >> 8 | (uVar19 & 0xff00) << 8 |
                         uVar19 << 0x18;
                  }
                  else if (uVar19 == 1) {
                    ...
                    *(undefined2 *)((long)param_1 + 3) = 0x100;
                    ...
                    if (piVar20 != __ptr + 1) {
                      lVar15 = 0;
                      do {
                        *(ushort *)((long)param_1 + lVar15 + 5) =
                             (ushort)iVar26 << 8 | (ushort)iVar26 >> 8;
                    ...
                    *(ushort *)
                     ((long)param_1 + ((ulong)((long)piVar20 + (-4 - (long)__ptr)) >> 2) * 2 + 5) =
                         uVar11 << 8 | uVar11 >> 8;
                  }
                  goto LAB_0010ca93;
                }
...
LAB_0010c9a9:
  ...
  if (iVar28 <= local_58[1]) {
    cVar10 = hb_vector_t<unsigned_int,false>::alloc
                       ((hb_vector_t<unsigned_int,false> *)local_58,local_58[1] + 1,false);
    iVar28 = local_58[0];
    if (cVar10 == '\0') {
      __hb_CrapPool = __hb_NullPool;
...
LAB_0010c9c9:
  ...
  if (plVar2 == in_stack_00000008) goto LAB_0010c9e0;
  goto LAB_0010c8d0;
}
...

{
  ...
  if (param_3) {
    ...
    uVar7 = (ulong)uVar2;
    if (uVar4 < uVar2) {
      if (0xfffffff < uVar2) goto LAB_0010d042;
      pvVar5 = *(void **)(this + 8);
LAB_0010d114:
      uVar6 = (uint)uVar7;
...
LAB_0010d042:
      ...
      if (uVar4 >> 2 <= uVar2) goto LAB_0010d000;
      if (0xfffffff < uVar2) goto LAB_0010d042;
      pvVar5 = *(void **)(this + 8);
      if (uVar2 != 0) goto LAB_0010d114;
      free(pvVar5);
      uVar6 = 0;
      pvVar5 = (void *)0x0;
    }
    ...
    *(uint *)this = uVar6;
    ...
    if (uVar4 < uVar3) {
      ...
      if (0xfffffff < uVar6) goto LAB_0010d042;
      pvVar5 = *(void **)(this + 8);
      uVar7 = (ulong)uVar6;
      goto LAB_0010d114;
    }
...
/* CFF::subr_subsetter_t<cff1_subr_subsetter_t, CFF::Subrs<OT::IntType<unsigned short, 2u> >,
   OT::cff1::accelerator_subset_t const, CFF::cff1_cs_interp_env_t, cff1_cs_opset_subr_subset_t,
   14u>::encode_charstrings(hb_vector_t<hb_vector_t<unsigned char, false>, false>&, bool) const */
...
::encode_charstrings
          (subr_subsetter_t<cff1_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_short,2u>>,OT::cff1::accelerator_subset_t_const,CFF::cff1_cs_interp_env_t,cff1_cs_opset_subr_subset_t,14u>
           *this,hb_vector_t *param_1,bool param_2)

{
  ...
  uVar8 = hb_vector_t<hb_vector_t<unsigned_char,false>,false>::resize
                    ((hb_vector_t<hb_vector_t<unsigned_char,false>,false> *)param_1,uVar2,true,true)
  ;
  if ((char)uVar8 == '\0') {
LAB_0010d318:
    uVar8 = 0;
...
LAB_0010d330:
          uVar7 = 0;
LAB_0010d332:
          if (*(uint *)(lVar11 + 0x90) <= uVar7) goto LAB_0010d318;
        }
        else {
          if (*pcVar4 == '\0') {
          ...
          if (*pcVar4 != '\x03') goto LAB_0010d330;
          ...
          if (-1 < iVar16) {
            ...
            do {
              while( true ) {
                ...
                iVar16 = uVar13 - 1;
                if (iVar16 < iVar18) goto LAB_0010d2cb;
              }
              if (uVar7 < (ushort)(*(ushort *)((long)puVar14 + 3) << 8 |
                                  *(ushort *)((long)puVar14 + 3) >> 8)) goto LAB_0010d300;
              iVar18 = uVar13 + 1;
            } while (iVar18 <= iVar16);
          }
LAB_0010d2cb:
...
LAB_0010d300:
          uVar7 = (uint)(byte)puVar14[1];
          if (*(uint *)(*(long *)this + 0x90) <= (uint)(byte)puVar14[1]) goto LAB_0010d318;
        }
        uVar12 = (ulong)uVar3;
        if (*(uint *)(this + 0x6c) == 0) {
        ...
        cVar6 = encode_str(this,ppVar17,uVar7,
                           (hb_vector_t *)(uVar12 * 0x10 + *(long *)(param_1 + 8)),param_2);
        if (cVar6 == '\0') goto LAB_0010d318;
        puVar21 = puVar21 + 2;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* CFF::cs_opset_t<CFF::number_t, cff1_cs_opset_flatten_t, CFF::cff1_cs_interp_env_t,
   CFF::flatten_param_t, CFF::path_procs_null_t<CFF::cff1_cs_interp_env_t, CFF::flatten_param_t>
   >::process_op(unsigned int, CFF::cff1_cs_interp_env_t&, CFF::flatten_param_t&) */

void CFF::
     cs_opset_t<CFF::number_t,cff1_cs_opset_flatten_t,CFF::cff1_cs_interp_env_t,CFF::flatten_param_t,CFF::path_procs_null_t<CFF::cff1_cs_interp_env_t,CFF::flatten_param_t>>
     ::process_op(uint param_1,cff1_cs_interp_env_t *param_2,flatten_param_t *param_3)
...
switchD_0010d44c_caseD_2:
  ...
  case 0x12:
    cff1_cs_opset_t<cff1_cs_opset_flatten_t,CFF::flatten_param_t,CFF::path_procs_null_t<CFF::cff1_cs_interp_env_t,CFF::flatten_param_t>>
    ::check_width(param_1,param_2,(flatten_param_t *)&DAT_0010da30);
    *(uint *)(param_2 + 0x103c) = *(int *)(param_2 + 0x103c) + (*(uint *)(param_2 + 0x14) >> 1);
    break;
  default:
    goto switchD_0010d44c_caseD_2;
  case 3:
  case 0x17:
    cff1_cs_opset_t<cff1_cs_opset_flatten_t,CFF::flatten_param_t,CFF::path_procs_null_t<CFF::cff1_cs_interp_env_t,CFF::flatten_param_t>>
    ::check_width(param_1,param_2,(flatten_param_t *)&DAT_0010da30);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* CFF::subr_flattener_t<OT::cff1::accelerator_subset_t const, CFF::cff1_cs_interp_env_t,
   cff1_cs_opset_flatten_t, 14u>::flatten(hb_vector_t<hb_vector_t<unsigned char, false>, false>&) */

uint __thiscall
CFF::
subr_flattener_t<OT::cff1::accelerator_subset_t_const,CFF::cff1_cs_interp_env_t,cff1_cs_opset_flatten_t,14u>
::flatten(subr_flattener_t<OT::cff1::accelerator_subset_t_const,CFF::cff1_cs_interp_env_t,cff1_cs_opset_flatten_t,14u>
...

{
  ...
  uVar10 = hb_vector_t<hb_vector_t<unsigned_char,false>,false>::resize
                     ((hb_vector_t<hb_vector_t<unsigned_char,false>,false> *)param_1,uVar3,true,true
                     );
  if ((char)uVar10 == '\0') {
LAB_0010dd60:
    uVar10 = 0;
    ...
    if (uVar3 != 0) {
      ...
      do {
        ...
        if (lVar4 != 0) {
          uVar13 = (ulong)(uVar29 & 0x3fffffff) % (ulong)*(uint *)(lVar20 + 0x20);
          puVar12 = (uint *)(lVar4 + uVar13 * 0xc);
          bVar2 = (byte)puVar12[1];
          if ((bVar2 & 2) != 0) {
            iVar26 = 0;
            do {
              if (*puVar12 == (uint)uVar31) {
                puVar21 = (uint *)&minus_1;
                if ((bVar2 & 1) != 0) {
                  puVar21 = puVar12 + 2;
                }
              ...
              iVar26 = iVar26 + 1;
              uVar13 = (ulong)((int)uVar13 + iVar26 & *(uint *)(lVar20 + 0x1c));
              puVar12 = (uint *)(lVar4 + uVar13 * 0xc);
              bVar2 = (byte)puVar12[1];
            } while ((bVar2 & 2) != 0);
            puVar21 = (uint *)&minus_1;
...
LAB_0010dc4f:
        ...
        if (uVar11 == 0xffffffff) {
          if ((uint)uVar31 < *(uint *)(param_1 + 4)) {
            ...
            uVar11 = *(uint *)(this_00 + 4);
            uVar13 = (ulong)uVar11;
            if ((int)uVar11 < *(int *)this_00) goto LAB_0010ddb0;
LAB_0010e358:
            cVar9 = hb_vector_t<unsigned_char,false>::alloc(this_00,uVar11 + 1,false);
            if (cVar9 != '\0') {
              uVar13 = (ulong)*(uint *)(this_00 + 4);
              goto LAB_0010ddb0;
            }
            ...
            uVar13 = (ulong)_DAT_00111044;
            __hb_CrapPool = (int)uVar7;
            bVar6 = __hb_CrapPool <= (int)_DAT_00111044;
            uVar11 = _DAT_00111044;
            __hb_CrapPool = uVar7;
            if (bVar6) goto LAB_0010e358;
LAB_0010ddb0:
            *(int *)(this_00 + 4) = (int)uVar13 + 1;
            *(undefined1 *)(*(long *)(this_00 + 8) + uVar13) = 0xe;
          }
        }
        else {
          auVar35 = OT::CFFIndex<OT::IntType<unsigned_short,2u>>::operator[]
                              (*(CFFIndex<OT::IntType<unsigned_short,2u>> **)(*(long *)this + 0x78),
                               uVar11);
          lVar20 = *(long *)this;
...
LAB_0010dde8:
            uVar13 = 0;
LAB_0010ddea:
            if (*(uint *)(lVar20 + 0x90) <= (uint)uVar13) goto LAB_0010dd60;
          }
          else {
            if (*pcVar5 == '\0') {
              uVar13 = (ulong)(byte)pcVar5[(ulong)uVar11 + 1];
              lVar20 = *(long *)this;
              goto LAB_0010ddea;
            }
            if (*pcVar5 != '\x03') goto LAB_0010dde8;
            ...
            if (-1 < iVar26) {
              ...
              do {
                while( true ) {
                  ...
                  if ((ushort)(*puVar22 << 8 | *puVar22 >> 8) <= uVar11) break;
                  iVar26 = uVar18 - 1;
                  if (iVar26 < iVar30) goto LAB_0010dd0d;
                }
                if (uVar11 < (ushort)(*(ushort *)((long)puVar22 + 3) << 8 |
                                     *(ushort *)((long)puVar22 + 3) >> 8)) goto LAB_0010dd40;
                iVar30 = uVar18 + 1;
              } while (iVar30 <= iVar26);
            }
LAB_0010dd0d:
            puVar22 = (ushort *)&_hb_NullPool;
            uVar11 = (ushort)(*(ushort *)(pcVar5 + 1) << 8 | *(ushort *)(pcVar5 + 1) >> 8) - 1;
            if (uVar11 < (ushort)(*(ushort *)(pcVar5 + 1) << 8 | *(ushort *)(pcVar5 + 1) >> 8)) {
              puVar22 = (ushort *)(pcVar5 + (ulong)uVar11 * 3 + 3);
            }
LAB_0010dd40:
            lVar20 = *(long *)this;
            uVar13 = (ulong)(byte)puVar22[1];
            if (*(uint *)(lVar20 + 0x90) <= (uint)(byte)puVar22[1]) goto LAB_0010dd60;
          }
          local_11d8 = *(long *)(this + 8);
          puVar19 = &_hb_NullPool;
          if ((uint)uVar13 < *(uint *)(lVar20 + 0x11c)) {
            puVar19 = (undefined *)(*(long *)(lVar20 + 0x120) + uVar13 * 0x28);
          }
          ...
          } while ((undefined1 (*) [16])(*pauVar8 + 8) != (undefined1 (*) [16])local_88);
          local_18f = _LC14;
          local_88[0] = 0x6b;
          local_19c = 0;
          local_198 = 0;
          ...
          local_68 = (undefined1  [16])0x0;
          if ((local_80 != (ushort *)0x0) &&
             (uVar17 = *local_80 << 8 | *local_80 >> 8, 0x4d7 < uVar17)) {
            local_88[0] = (-(uint)(uVar17 < 0x846c) & 0xffff846b) + 0x8000;
          }
          local_78 = 0x6b;
          if ((local_70 != (ushort *)0x0) &&
             (uVar17 = *local_70 << 8 | *local_70 >> 8, 0x4d7 < uVar17)) {
...
LAB_0010e0b5:
              cs_opset_t<CFF::number_t,cff1_cs_opset_flatten_t,CFF::cff1_cs_interp_env_t,CFF::flatten_param_t,CFF::path_procs_null_t<CFF::cff1_cs_interp_env_t,CFF::flatten_param_t>>
              ::process_op(uVar27,(cff1_cs_interp_env_t *)&local_11c8,(flatten_param_t *)&local_11e8
                          );
            }
            else {
              ...
              uVar27 = (uint)bVar2;
              if (bVar2 == 0xc) {
                if (uVar11 < uVar18 + 2) goto LAB_0010e0b0;
                local_11c0 = CONCAT44(uVar18 + 2,(uint)local_11c0);
                uVar27 = *(byte *)(local_11c8 + (ulong)uVar25) + 0x100;
                if (*(byte *)(local_11c8 + (ulong)uVar25) != 0) goto LAB_0010e0b5;
                if (local_54 < local_11b8._4_4_) {
                  uVar13 = (ulong)local_54;
                  uVar11 = (local_11b8._4_4_ - 1) - local_54;
                  pcVar32 = (cff1_cs_interp_env_t *)&local_11c8 + uVar13 * 8;
                  do {
                    while( true ) {
                      ...
                      if ((int)uVar18 < *(int *)this_01) {
                        ...
                        *(undefined1 *)(*(long *)(this_01 + 8) + (ulong)uVar18) = 0xff;
                        ...
                        cVar9 = hb_vector_t<unsigned_char,false>::alloc
                                          ((hb_vector_t<unsigned_char,false> *)this_01,uVar18 + 1,
                                           false);
                        if (cVar9 == '\0') {
                          __hb_CrapPool = CONCAT71(_DAT_00111041,_hb_NullPool);
                        }
...
LAB_0010e1d1:
                        uVar18 = *(uint *)(this_01 + 4);
                        uVar25 = uVar18 + 1;
                        if ((int)uVar18 < *(int *)this_01) goto LAB_0010e1e4;
LAB_0010e3c0:
                        cVar9 = hb_vector_t<unsigned_char,false>::alloc
                                          ((hb_vector_t<unsigned_char,false> *)this_01,uVar25,false)
                        ;
                        if (cVar9 == '\0') {
                          __hb_CrapPool = CONCAT71(_DAT_00111041,_hb_NullPool);
                          goto LAB_0010e1ee;
                        ...
                        *(undefined1 *)(*(long *)(this_01 + 8) + (ulong)uVar18) = uVar15;
                        uVar18 = *(uint *)(this_01 + 4);
                        uVar25 = uVar18 + 1;
                        if ((int)uVar18 < *(int *)this_01) goto LAB_0010e201;
LAB_0010e400:
                        cVar9 = hb_vector_t<unsigned_char,false>::alloc
                                          ((hb_vector_t<unsigned_char,false> *)this_01,uVar25,false)
                        ;
                        ...
                        *(undefined1 *)(*(long *)(this_01 + 8) + (ulong)uVar18) = uVar23;
                        uVar18 = *(uint *)(this_01 + 4);
                        uVar25 = uVar18 + 1;
                        if (*(int *)this_01 <= (int)uVar18) goto LAB_0010e440;
                      }
                      else {
                        cVar9 = hb_vector_t<unsigned_char,false>::alloc
                                          ((hb_vector_t<unsigned_char,false> *)this_01,uVar18 + 1,
                        ...
                        *(undefined1 *)(*(long *)(this_01 + 8) + (ulong)uVar18) = uVar16;
                        uVar18 = *(uint *)(this_01 + 4);
                        uVar25 = uVar18 + 1;
                        if (*(int *)this_01 <= (int)uVar18) goto LAB_0010e3c0;
LAB_0010e1e4:
...
LAB_0010e1ee:
                        uVar18 = *(uint *)(this_01 + 4);
                        uVar25 = uVar18 + 1;
                        if (*(int *)this_01 <= (int)uVar18) goto LAB_0010e400;
LAB_0010e201:
                        *(uint *)(this_01 + 4) = uVar25;
                        *(undefined1 *)(*(long *)(this_01 + 8) + (ulong)uVar18) = uVar23;
LAB_0010e20b:
...
LAB_0010e440:
                          cVar9 = hb_vector_t<unsigned_char,false>::alloc
                                            ((hb_vector_t<unsigned_char,false> *)this_01,uVar25,
                                             false);
                          if (cVar9 == '\0') goto LAB_0010e54c;
                          uVar18 = *(uint *)(this_01 + 4);
                          *(uint *)(this_01 + 4) = uVar18 + 1;
                      ...
                      *(uint *)(this_01 + 4) = uVar25;
                      *(char *)(*(long *)(this_01 + 8) + (ulong)uVar18) = (char)iVar26;
                      if (pcVar32 == (cff1_cs_interp_env_t *)(&local_11c0 + uVar11 + uVar13))
                      goto LAB_0010e236;
                    }
...
LAB_0010e164:
                    pcVar32 = pcVar32 + 8;
                  } while (pcVar32 != (cff1_cs_interp_env_t *)(&local_11c0 + uVar11 + uVar13));
                }
LAB_0010e236:
                ...
                if (bVar2 != 0xe) goto LAB_0010e0b5;
                if ((char)local_58 == '\0') {
                ...
                cff1_cs_opset_flatten_t::flush_args_and_op
                          (0xe,(cff1_cs_interp_env_t *)&local_11c8,(flatten_param_t *)&local_11e8);
                local_190 = '\x01';
              }
            }
            if (local_180 != '\0') goto LAB_0010dd60;
            if ((((uint)local_11c0 < local_11c0._4_4_) || ((char)local_11b8 != '\0')) ||
               (local_1208 = local_1208 + -1, local_1208 == 0)) goto LAB_0010dd60;
            uVar11 = (uint)local_11c0;
            uVar18 = local_11c0._4_4_;
          } while (local_190 == '\0');
        }
        uVar31 = uVar31 + 1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* OT::cff1_subset_plan::create(OT::cff1::accelerator_subset_t const&, hb_subset_plan_t*) */

undefined4 __thiscall
OT::cff1_subset_plan::create
          (cff1_subset_plan *this,accelerator_subset_t *param_1,hb_subset_plan_t *param_2)
...
LAB_0010e65a:
  if (*piVar11 == 0) {
    *(ulong *)(this + 0xa0) =
         CONCAT44(*(undefined4 *)(param_1 + 0x90),*(undefined4 *)(param_2 + 0x58));
...
LAB_0010e775:
          do {
            if (*(int *)(lVar27 + 8) == 0xf) {
              if (!bVar6) goto LAB_0010e7c0;
              goto LAB_0010e77f;
            }
            lVar27 = lVar27 + 0x18;
          } while (lVar30 != lVar27);
          if (bVar6) goto LAB_0010f333;
        }
LAB_0010f05d:
        ...
        local_168[0] = (byte_str_ref_t)0x0;
        local_168[1] = (byte_str_ref_t)0x0;
        local_168[2] = (byte_str_ref_t)0x0;
        local_168[3] = (byte_str_ref_t)0x0;
        local_168[4] = (byte_str_ref_t)0x0;
        local_168[5] = (byte_str_ref_t)0x0;
        local_168[6] = (byte_str_ref_t)0x0;
        local_168[7] = (byte_str_ref_t)0x0;
        local_168[8] = (byte_str_ref_t)0x0;
        local_168[9] = (byte_str_ref_t)0x0;
        local_168[10] = (byte_str_ref_t)0x0;
        local_168[0xb] = (byte_str_ref_t)0x0;
        local_168[0xc] = (byte_str_ref_t)0x0;
        local_168[0xd] = (byte_str_ref_t)0x0;
        local_168[0xe] = (byte_str_ref_t)0x0;
        local_168[0xf] = (byte_str_ref_t)0x0;
        CFF::parsed_values_t<CFF::cff1_top_dict_val_t>::add_op
                  ((parsed_values_t<CFF::cff1_top_dict_val_t> *)this,0xf,local_168,
                   (cff1_top_dict_val_t *)&local_158);
      }
    }
    else {
      lVar27 = *(long *)(param_1 + 0xa8);
...
LAB_0010f333:
          ...
          local_168[0xf] = (byte_str_ref_t)0x0;
          CFF::parsed_values_t<CFF::cff1_top_dict_val_t>::add_op
                    ((parsed_values_t<CFF::cff1_top_dict_val_t> *)this,0x10,local_168,
                     (cff1_top_dict_val_t *)&local_158);
          goto LAB_0010f05d;
        }
      }
...
LAB_0010e7c0:
    if (*(FDSelect **)(param_1 + 0x88) == (FDSelect *)&_hb_NullPool) {
      ...
      cVar9 = hb_vector_t<unsigned_int,false>::alloc
                        ((hb_vector_t<unsigned_int,false> *)(this + 0xf0),0,false);
      if (cVar9 != '\0') {
...
LAB_0010eefb:
      uVar33 = (ulong)*puVar16;
      if (*puVar16 != 0xffffffff) goto LAB_0010e813;
...
LAB_0010ef3a:
          ...
          if ((bVar4 & 2) == 0) {
            ...
            *(int *)(this + 0xd4) = iVar29 + 1;
            ...
            do {
              if (*piVar14 == 0) {
                if ((int)uVar33 == -1) goto LAB_0010efaa;
                goto LAB_0010efa2;
              }
...
LAB_0010efa2:
              lVar30 = uVar33 * 0xc;
LAB_0010efaa:
              piVar14 = (int *)(lVar30 + (long)piVar11);
              if ((*(byte *)(piVar14 + 1) & 2) == 0) goto LAB_0010f0a6;
            ...
            *(int *)(this + 0xd4) = iVar29 + 1;
            if ((*(ushort *)(this + 0xd2) < uVar19) && (*(uint *)(this + 0xdc) < uVar32 << 3)) {
              hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc
                        ((hb_hashmap_t<unsigned_int,unsigned_int,true> *)(this + 0xc0),
                         *(uint *)(this + 0xdc) - 8);
            }
          }
        }
        else {
          cVar9 = hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc
                            ((hb_hashmap_t<unsigned_int,unsigned_int,true> *)(this + 0xc0),0);
          if (cVar9 != '\0') {
            piVar11 = *(int **)(this + 0xe8);
            uVar32 = *(uint *)(this + 0xd8);
            goto LAB_0010ef3a;
      ...
      if (*(int *)(this + 0xf0) <= (int)uVar31) {
        cVar9 = hb_vector_t<unsigned_int,false>::alloc
                          ((hb_vector_t<unsigned_int,false> *)(this + 0xf0),uVar31 + 1,false);
        if (cVar9 == '\0') {
      ...
      *(undefined4 *)(*(long *)(this + 0xf8) + (ulong)uVar31 * 4) = 0;
      ...
      cVar9 = hb_plan_subset_cff_fdselect
                        (param_2,*(uint *)(this + 0xa4),*(FDSelect **)(param_1 + 0x88),
                         (uint *)(this + 0xa8),(uint *)(this + 0x7c),(uint *)(this + 0xac),
                         (hb_vector_t *)(this + 0xb0),(hb_inc_bimap_t *)(this + 0xc0));
      if (cVar9 == '\0') goto LAB_0010ece0;
    }
LAB_0010e813:
    lVar30 = 0;
    do {
    ...
    if ((*(uint *)(this + 0x1c4) < 0x8001) &&
       ((this[0x180] == (cff1_subset_plan)0x0 ||
        (cVar9 = plan_subset_charset(this,param_1,param_2), cVar9 != '\0')))) {
      ...
      do {
        ...
        if ((0x186 < uVar31) && (uVar31 != 0xffffffff)) {
          ...
          piVar11 = (int *)&minus_1;
          if (lVar22 != 0) {
            uVar33 = (ulong)((uVar31 - 0x187) * -0x61c8864f & 0x3fffffff) %
                     (ulong)*(uint *)(this + 0x1b0);
      ...
      if (this[0x1fc] == (cff1_subset_plan)0x0) {
        ...
        if (((cVar9 != '\0') &&
            (cVar9 = CFF::
                     ...
                     ::encode_charstrings
                               ((subr_subsetter_t<cff1_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_short,2u>>,OT::cff1::accelerator_subset_t_const,CFF::cff1_cs_interp_env_t,cff1_cs_opset_subr_subset_t,14u>
                                 *)&local_158,(hb_vector_t *)(this + 0x100),true), cVar9 != '\0'))
           && (cVar9 = hb_vector_t<hb_vector_t<unsigned_char,false>,false>::resize
                                 ((hb_vector_t<hb_vector_t<unsigned_char,false>,false> *)
                                  (this + 0x110),local_bc,true,true), cVar9 != '\0')) {
          uVar33 = 0;
          if (local_bc != 0) {
            do {
              ...
              cVar9 = CFF::
                      subr_subsetter_t<cff1_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_short,2u>>,OT::cff1::accelerator_subset_t_const,CFF::cff1_cs_interp_env_t,cff1_cs_opset_subr_subset_t,14u>
                      ::encode_str((subr_subsetter_t<cff1_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_short,2u>>,OT::cff1::accelerator_subset_t_const,CFF::cff1_cs_interp_env_t,cff1_cs_opset_subr_subset_t,14u>
                                    *)&local_158,ppVar28,0,phVar20,true);
              if (cVar9 == '\0') goto LAB_0010ee06;
              uVar33 = uVar33 + 1;
...
LAB_0010f7c6:
              ...
              if (pvVar15 == (void *)0x0) {
                uVar31 = *(uint *)(this + 0x120);
                if (uVar31 < uVar26) goto LAB_0010f7c6;
              }
              else {
            ...
            if (uVar31 < uVar32) {
              hb_memset((void *)((ulong)uVar31 * 0x10 + *(long *)(this + 0x128)),
                        (uVar32 - uVar31) * 0x10,uVar19);
            }
...
LAB_0010ee06:
        ...
        cVar9 = CFF::
                subr_flattener_t<OT::cff1::accelerator_subset_t_const,CFF::cff1_cs_interp_env_t,cff1_cs_opset_flatten_t,14u>
                ::flatten((subr_flattener_t<OT::cff1::accelerator_subset_t_const,CFF::cff1_cs_interp_env_t,cff1_cs_opset_flatten_t,14u>
                           *)&local_158,(hb_vector_t *)(this + 0x100));
        if (cVar9 != '\0') {
LAB_0010ea4f:
          if (this[0x142] != (cff1_subset_plan)0x0) {
            ...
            *puVar3 = &_hb_NullPool;
            ...
            if (iVar29 != 0) {
              ...
              do {
                ...
                if (lVar30 != 0) {
                  uVar33 = (ulong)(iVar17 * -0x138e8143 & 0x3fffffff) %
                  ...
                  if ((bVar4 & 2) != 0) {
                    ...
                    do {
                      if (iVar17 * -0x33333333 == *piVar11) {
                        if ((bVar4 & 1) != 0) goto LAB_0010eb30;
                        break;
                      }
                      iVar18 = iVar18 + 1;
...
LAB_0010ecd1:
          if ((param_2[0x10] != (hb_subset_plan_t)0x0) &&
             (*(int *)(this + 0x104) == *(int *)(param_2 + 0x58))) {
            uVar10 = CONCAT31((int3)((uint)*(int *)(this + 0xa8) >> 8),
                              *(int *)(this + 0x134) == *(int *)(this + 0xa8));
            goto LAB_0010ece2;
          }
        }
      }
...
LAB_0010f5b3:
    ...
    cVar9 = CFF::
            subr_subsetter_t<cff1_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_short,2u>>,OT::cff1::accelerator_subset_t_const,CFF::cff1_cs_interp_env_t,cff1_cs_opset_subr_subset_t,14u>
            ::encode_str((subr_subsetter_t<cff1_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_short,2u>>,OT::cff1::accelerator_subset_t_const,CFF::cff1_cs_interp_env_t,cff1_cs_opset_subr_subset_t,14u>
                          *)&local_158,ppVar28,uVar19,phVar20,true);
    if (cVar9 == '\0') goto LAB_0010ee06;
  }
LAB_0010f651:
  lVar30 = lVar30 + 1;
  uVar31 = uVar31 + 0x9e3779b1;
  if (*(uint *)(this + 0xa4) <= (uint)lVar30) goto LAB_0010f6d9;
  uVar32 = *(uint *)(this + 0x124);
  goto LAB_0010f42a;
LAB_0010eb30:
  uVar31 = *(uint *)(lVar27 + 0x24);
  if ((0x186 < uVar31) && (uVar31 != 0xffffffff)) {
    lVar30 = *(long *)(this + 0x1b8);
    piVar11 = (int *)&minus_1;
    if (lVar30 != 0) {
      uVar33 = ((ulong)((uVar31 - 0x187) * -0x61c8864f) & 0xffffffff3fffffff) %
               (ulong)*(uint *)(this + 0x1b0);
...
LAB_0010f258:
      ...
      _memcpy = _lookup_expert_subset_charset_for_sid;
      _realloc = _lookup_expert_charset_for_sid;
      goto joined_r0x0010ec24;
    }
    uVar32 = uVar19;
    if (uVar26 <= uVar19) goto LAB_0010ebef;
    do {

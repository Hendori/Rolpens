...
{
  *(undefined ***)this = &PTR__UnicodeStringAppendable_001051d8;
...

{
  ...
  *(undefined ***)this = &PTR__UnicodeString_00105170;
  if (((byte)this[8] & 4) != 0) {
    LOCK();
...
{
  *(undefined ***)param_1 = &PTR__UnicodeString_00105170;
  ...
  *(undefined2 *)(this + 8) = 0;
  if ((0 < param_3) && ((uint)param_2 < 0x110000)) {
    if (param_2 < 0x10000) {
      ...
      lVar2 = 0;
      do {
        *(ushort *)(pUVar3 + lVar2 * 2) = (ushort)param_2;
        lVar2 = lVar2 + 1;
      } while ((int)lVar2 < param_3);
    }
    else {
      if (0x3fffffff < param_3) goto LAB_001009c0;
      param_3 = param_3 * 2;
      if (param_1 < param_3) {
        param_1 = param_3;
      }
      ...
      do {
        ...
        *(ushort *)(pUVar3 + lVar2 * 2 + 2) = (ushort)param_2 & 0x3ff | 0xdc00;
        lVar2 = lVar2 + 2;
      } while ((int)lVar2 < param_3);
    }
    if (0x3ff < param_3) {
...
joined_r0x00100bbc:
    ...
    if (uVar5 < 5) {
      ...
      if (uVar5 != 8) goto LAB_00100a79;
      if (param_3 != '\0') {
        *(undefined8 *)(this + 0x18) = *(undefined8 *)(param_1 + 0x18);
        *(undefined4 *)(this + 0x10) = *(undefined4 *)(param_1 + 0x10);
        goto joined_r0x00100bbc;
      }
    }
    iVar8 = (int)sVar3;
    if ((short)uVar2 < 0) {
...

{
  ...
  uVar4 = 0;
  if ((param_5 < 0) || ((0 < param_5 && (param_4 == 0)))) goto LAB_0010188e;
  uVar1 = *(ushort *)(param_1 + 8);
  if ((short)uVar1 < 0) {
...
LAB_001018f2:
    ...
    if (param_2 <= (int)lVar3) goto LAB_001018f2;
LAB_001018cf:
    param_3 = 0;
LAB_001018d1:
    if ((uVar1 & 2) == 0) {
...

{
  ...
  if ((uVar3 & 0x11) == 0) {
    if ((uVar3 & 2) != 0) {
      ...
      *(undefined ***)CONCAT44(in_register_0000003c,param_1) = &PTR__UnicodeString_00105170;
      *(undefined2 *)(CONCAT44(in_register_0000003c,param_1) + 8) = 8;
      if (-1 < iVar2) goto LAB_001019d3;
      goto LAB_00101a1c;
    }
...
LAB_001026ef:
  ...
  if (((param_6 == '\0') && ((uVar5 & 8) == 0)) &&
    ...
    if (iVar6 < param_1) goto LAB_00102576;
  }
  else {
LAB_00102576:
    uVar3 = uVar5 & 2;
    if (param_2 < 0) {
      param_2 = param_1;
      if ((short)uVar5 < 0) goto LAB_0010267d;
LAB_0010259d:
      iVar6 = (int)((short)uVar5 >> 5);
      if (uVar3 != 0) goto LAB_001025b2;
LAB_0010268a:
...
LAB_001026c8:
      ...
      if (param_4 != '\0') {
        if ((uVar3 & 2) != 0) {
          ...
          if (local_90 != (undefined1 *)0x0) goto LAB_001028f0;
          goto LAB_001025fc;
        }
        if (*(int *)(this + 0x10) < iVar6) {
          iVar6 = *(int *)(this + 0x10);
        }
        if (local_90 != (undefined1 *)0x0) goto LAB_0010280c;
        goto LAB_0010282d;
      }
      *(ushort *)(this + 8) = uVar3 & 0x1f;
      ...
      if (-1 < (short)uVar5) goto LAB_0010259d;
LAB_0010267d:
      iVar6 = *(int *)(this + 0xc);
      if (uVar3 == 0) goto LAB_0010268a;
LAB_001025b2:
...

{
  ...
  if ((uVar1 & 2) == 0) {
    ...
    lVar7 = (long)sVar4;
    if (iVar5 <= sVar4) goto LAB_00102a88;
    if ((uVar1 & 8) == 0) goto LAB_00102ae6;
LAB_00102a7e:
...
LAB_00102b04:
      lVar7 = (long)iVar2;
      if (iVar2 < iVar5) goto LAB_00102a7a;
      if (iVar2 == 0x7fffffff) {
        return (UnicodeString *)0x0;
      }
    }
      ...
      if (sVar4 < 0x1b) {
LAB_00102a7a:
        if ((uVar1 & 8) != 0) goto LAB_00102a7e;
LAB_00102ae6:
        if (((uVar1 & 4) == 0) || (*(int *)(*(long *)(this + 0x18) + -4) == 1)) goto LAB_00102ab1;
      }
    }
  }
LAB_00102a88:
...

{
  ...
  uVar2 = *(ushort *)(this + 8);
  if ((((uVar2 & 0x11) != 0) || (param_3 == 0)) || (param_1 == (wchar16 *)0x0)) goto LAB_00102cf3;
  __src = (UnicodeString *)(param_1 + param_2);
  if (param_3 < 0) {
    param_3 = u_strlen_76_godot(__src);
    if (param_3 == 0) goto LAB_00102cf3;
    uVar2 = *(ushort *)(this + 8);
  }
  if ((short)uVar2 < 0) {
...
LAB_00102d18:
    ...
    if (((((uVar2 & 0x19) == 0) &&
      ...
      local_70 = 2;
      local_78 = &PTR__UnicodeString_00105170;
...
LAB_00102ca1:
    ...
    if ((uVar2 & 4) != 0) {
      if (*(int *)(*(long *)(this + 0x18) + -4) != 1) goto LAB_00102d18;
      uVar2 = *(ushort *)(this + 8);
    }
    uVar7 = uVar2 & 2;
    local_7c = param_3 + iVar5;
    if (4 < param_3) goto LAB_00102ca1;
    pUVar6 = this + 10;
    if (uVar7 == 0) {
      pUVar6 = *(UnicodeString **)(this + 0x18);
    }
...

{
  ...
  if ((uint)param_1 < 0x10000) {
    ...
    if (0x10ffff < (uint)param_1) goto LAB_00102fe6;
    iVar1 = 2;
...

{
  ...
  if ((uint)param_1 < 0x10000) {
    ...
    bVar3 = false;
    if (0x10ffff < (uint)param_1) goto LAB_001031c1;
    iVar2 = 2;
    local_12 = (wchar16)param_1 & 0x3ffU | 0xdc00;
    local_14 = (short)(param_1 >> 10) + L'ퟀ';
  }
...

{
  ...
  if (cVar2 != '\0') {
    ...
    *(undefined4 *)(this + 0x10) = 0;
    ...
    local_60 = 0;
    local_68 = 0;
    local_78 = (undefined **)&DAT_00105108;
...
LAB_00103393:
    ...
    if (-1 < (short)uVar3) goto LAB_00103302;
LAB_001033b9:
    iVar7 = *(int *)(param_2 + 0xc);
    if (iVar7 != 0) {
      if (iVar7 < 0) {
...
LAB_001032f5:
    ...
    if ((short)uVar3 < 0) goto LAB_001033b9;
LAB_00103302:
    if ((short)uVar3 >> 5 != 0) {
...
LAB_00103637:
      ...
      *(undefined2 *)(param_1 + 8) = 2;
      ...
      local_88 = &PTR__UnicodeString_00105170;
      if ((local_80 & 4) != 0) {
        LOCK();
      ...
      local_88 = (undefined **)&DAT_00105108;
...
LAB_0010375e:
    ...
    if (-1 < (int)uVar5) {
      if (0xffff < uVar5) goto LAB_00103840;
      iVar8 = 1;
...

{
  ...
  uVar3 = *(ushort *)(this + 8);
  uVar7 = uVar3 & 0x11;
  if ((uVar3 & 0x11) != 0) goto LAB_00103af3;
  if ((short)uVar3 < 0) {
    iVar11 = *(int *)(this + 0xc);
  }
  else {
  ...
  if (((uVar3 & 8) == 0) || (param_5 != 0)) {
    if (iVar11 == param_1) goto LAB_00103c28;
    if (param_3 == (wchar16 *)0x0) {
      param_5 = 0;
    }
    else {
...
LAB_00103e5b:
      ...
      if (iVar11 - iVar12 <= param_2) {
        ...
        if (iVar12 < 0x400) goto LAB_00103e5b;
        *(int *)(this + 0xc) = iVar12;
        uVar3 = uVar3 | 0xffe0;
LAB_00103e43:
        *(ushort *)(this + 8) = uVar3;
...
LAB_001039a9:
          ...
          pUVar4 = pUVar5;
          if (((byte)this[8] & 2) != 0) goto LAB_001039d7;
        }
LAB_00103b8d:
        iVar8 = 0x7ffffff5;
        if ((iVar12 >> 2) + 0x80 <= 0x7ffffff5 - iVar12) goto LAB_001039f3;
      }
      else {
        pUVar5 = this + 10;
        pUVar4 = pUVar5;
        if ((uVar3 & 0x19) == 0) goto LAB_001039a9;
LAB_001039d7:
        pUVar5 = pUVar4;
        if (0x1b < iVar12) {
...
LAB_00104236:
    ...
    iVar4 = 0;
    iVar6 = iVar2 - param_2;
    if (-1 < param_2) goto LAB_00104236;
  }
  iVar5 = 0;
...

{
  ...
  if (param_1 < 0) {
    param_1 = 0;
    iVar7 = 0;
    if (param_2 < 0) goto LAB_00104316;
    iVar4 = 0;
    if (-1 < (short)uVar1) goto LAB_00104306;
    iVar4 = *(int *)(this + 0xc);
  }
...

{
  ...
  if (iVar3 < param_1) {
    cVar1 = cloneArrayIfNeeded(this,param_1,0xffffffff,1,0,0);
    if (cVar1 != '\0') {
      __src = this + 10;
      if (((byte)this[8] & 2) == 0) {
      ...
      if (0 < iVar3) {
        memmove(__src + (long)(param_1 - iVar3) * 2,__src,(long)iVar3 * 2);
      }
      lVar2 = (long)((param_1 - iVar3) + -1);
      do {
        *(wchar16 *)(__src + lVar2 * 2) = param_2;
        lVar2 = lVar2 + -1;
      } while ((int)lVar2 != -1);
      if (param_1 < 0x400) {
  ...
  if (iVar5 < param_1) {
    ...
    if (cVar2 != '\0') {
      ...
      if (iVar5 <= param_1 + -1) {
        ...
        do {
          *(wchar16 *)(pUVar4 + lVar3 * 2) = param_2;
          lVar3 = lVar3 + -1;
        } while (iVar5 <= (int)lVar3);
        uVar1 = *(ushort *)(this + 8);
      }
      if (param_1 < 0x400) {
        *(ushort *)(this + 8) = uVar1 & 0x1f | (ushort)(param_1 << 5);
      }
      else {
        *(int *)(this + 0xc) = param_1;
        *(ushort *)(this + 8) = uVar1 | 0xffe0;
      }
      return 1;
    }
  }
...
{
  *param_1 = &PTR__UnicodeString_00105170;

...

{
  ...
  *(int *)(plVar5 + 1) = iVar4;
  ...
  puVar6 = (undefined8 *)((long)iVar12 * 0x60 + lVar15);
  uVar3 = *puVar6;
  plVar5[2] = lVar15;
  plVar5[3] = (long)puVar6;
  pvVar7 = calloc((long)iVar4,8);
  plVar5[4] = (long)pvVar7;
  if (iVar4 < 1) {
    local_60._0_4_ = 0;
  }
  else {
...
LAB_00100791:
    do {
      ...
      if (iVar4 != 0) {
        ...
        lVar10 = plVar5[4];
        pvVar7 = calloc((long)iVar4,8);
        *(void **)(lVar10 + lVar15 * 8) = pvVar7;
        if (0 < iVar4) {
          uVar2 = *(uint *)(param_2 + 0x20 + lVar15 * 4);
          sVar8 = 0;
          do {
            if ((uVar2 >> ((uint)sVar8 & 0x1f) & 1) != 0) {
              lVar10 = (long)iVar12;
              iVar12 = iVar12 + 1;
              *(long *)((long)pvVar7 + sVar8 * 8) =
                   (long)*(int *)(param_2 + 0x120 + lVar10 * 4) * 0x60 + *(long *)(lVar16 + 0x1328);
            }
            sVar8 = sVar8 + 1;
  ...
  *(undefined4 *)(plVar5 + 5) = 1;
  ...
  iVar12 = 0;
  if (local_58 < 1) {
    *(int *)((long)plVar5 + 0xc) = (int)local_60;
    pvVar7 = malloc(8);
    local_60 = 1;
    plVar5[6] = (long)pvVar7;
  }
  else {
    do {
      iVar12 = iVar12 + 1;
  ...
  lVar16 = 0;
  do {
    puVar9 = (undefined4 *)malloc((long)local_58 << 2);
    *(undefined4 **)((long)pvVar7 + lVar16 * 8) = puVar9;
    puVar1 = puVar9 + (ulong)(local_58 - 1) + 1;
    lVar15 = (long)(iVar13 / iVar4);
    lVar10 = lVar16;
    if (0 < local_58) {
      do {
        puVar14 = puVar9 + 1;
        lVar11 = lVar10 % lVar15;
        *puVar9 = (int)(lVar10 / lVar15);
...
joined_r0x00100dd4:
          plVar14 = plVar14 + 1;
          if (plVar14 == plVar2) goto LAB_00100daf;
        }
        plVar10 = plVar14 + 1;
        *plVar14 = 0;
        plVar14 = plVar10;
...
LAB_001013f9:
      ...
      do {
        if (*(int *)(param_4 + lVar11 * 4) != 0) goto LAB_001013f9;
        lVar11 = lVar11 + 1;
      } while (lVar11 != lVar8);
    }
  }

...
undefined4 uprv_readSwapUInt16(ushort param_1)
...
undefined4 uprv_readDirectUInt16(ushort param_1)
...
uint uprv_readSwapUInt32(uint param_1)
...
uint uprv_readDirectUInt32(uint param_1)
...
void uprv_writeSwapUInt16(ushort *param_1,ushort param_2)
...
void uprv_writeDirectUInt16(ushort *param_1,ushort param_2)
...
void uprv_writeSwapUInt32(uint *param_1,uint param_2)
...
void uprv_writeDirectUInt32(uint *param_1,uint param_2)
...
int uprv_swapArray16(UDataSwapper *param_1,void *param_2,int param_3,void *param_4,
                    UErrorCode *param_5)

{
  ...
  if ((param_5 != (UErrorCode *)0x0) && (*(int *)param_5 < 1)) {
    if ((param_1 != (UDataSwapper *)0x0 && param_2 != (void *)0x0) &&
       (((-1 < param_3 && (param_4 != (void *)0x0)) && ((param_3 & 1U) == 0)))) {
      uVar2 = 0;
      if (param_3 >> 1 != 0) {
        do {
...
int uprv_copyArray16(UDataSwapper *param_1,void *param_2,int param_3,void *param_4,
                    UErrorCode *param_5)

{
  ...
  if ((((param_1 != (UDataSwapper *)0x0 && param_2 != (void *)0x0) && (-1 < param_3)) &&
      (param_4 != (void *)0x0)) && ((param_3 & 1U) == 0)) {
...
int uprv_swapArray32(UDataSwapper *param_1,void *param_2,int param_3,void *param_4,
                    UErrorCode *param_5)

{
  ...
  if ((param_5 != (UErrorCode *)0x0) && (*(int *)param_5 < 1)) {
    if ((param_1 != (UDataSwapper *)0x0 && param_2 != (void *)0x0) &&
       (((-1 < param_3 && ((param_3 & 3U) == 0)) && (param_4 != (void *)0x0)))) {
      uVar2 = 0;
      if (param_3 >> 2 != 0) {
        do {
          uVar1 = *(uint *)((long)param_2 + uVar2 * 4);
          *(uint *)((long)param_4 + uVar2 * 4) =
...
int uprv_copyArray32(UDataSwapper *param_1,void *param_2,int param_3,void *param_4,
                    UErrorCode *param_5)
...
int uprv_swapArray64(UDataSwapper *param_1,void *param_2,int param_3,void *param_4,
                    UErrorCode *param_5)

{
  ...
  if ((param_5 != (UErrorCode *)0x0) && (*(int *)param_5 < 1)) {
    if ((param_1 != (UDataSwapper *)0x0 && param_2 != (void *)0x0) &&
       (((-1 < param_3 && ((param_3 & 7U) == 0)) && (param_4 != (void *)0x0)))) {
      uVar2 = 0;
      if (param_3 >> 3 != 0) {
        do {
          uVar1 = *(ulong *)((long)param_2 + uVar2 * 8);
          *(ulong *)((long)param_4 + uVar2 * 8) =
...
int uprv_copyArray64(UDataSwapper *param_1,void *param_2,int param_3,void *param_4,
                    UErrorCode *param_5)
...
int udata_swapInvStringBlock_76_godot
...
void udata_printError_76_godot
...
ushort udata_swapDataHeader_76_godot
                 (long param_1,undefined2 *param_2,uint param_3,undefined2 *param_4,int *param_5)

{
  ...
  if ((param_5 != (int *)0x0) && (*param_5 < 1)) {
    if (((param_1 == 0 || param_2 == (undefined2 *)0x0) || ((int)param_3 < -1)) ||
       ((0 < (int)param_3 && (param_4 == (undefined2 *)0x0)))) {
      *param_5 = 1;
    }
    else if (((param_3 < 0x18) || (param_2[1] != 0x27da)) || (*(char *)(param_2 + 5) != '\x02')) {
      udata_printError_76_godot
                (param_1,"udata_swapDataHeader(): initial bytes do not look like ICU data\n");
      *param_5 = 0x10;
    }
    else {
        ...
        if (uVar6 <= uVar1) {
          ...
          if ((int)uVar7 <= (int)param_3) {
            ...
            *(undefined1 *)((long)param_4 + 9) = *(undefined1 *)(param_1 + 3);
            ...
            (**(code **)(param_1 + 0x48))
                      (param_1,(char *)((long)param_2 + uVar6),iVar5,(long)param_4 + uVar6,param_5);
            return uVar1;
          }
        }
      }
  ...
  if (*param_5 < 1) {
    if ((param_4 | param_2) < 2) {
      ...
      if (pcVar1 != (char *)0x0) {
        ...
        for (uVar3 = (ulong)(((int)pcVar1 -
                             (int)(undefined8 *)((ulong)(pcVar1 + 0xc) & 0xfffffffffffffff8)) +
                             0x60U >> 3); uVar3 != 0; uVar3 = uVar3 - 1) {
          *puVar6 = 0;
...
undefined8
udata_openSwapperForInputData_76_godot
          (ushort *param_1,uint param_2,char param_3,byte param_4,int *param_5)

{
  ...
  if ((param_5 != (int *)0x0) && (*param_5 < 1)) {
    ...
    if ((param_1[1] == 0x27da) && ((char)param_1[5] == '\x02')) {
      ...
      if ((((0x17 < uVar3) && (0x13 < uVar1)) && ((ulong)uVar1 + 4 <= (ulong)uVar3)) &&
         (uVar3 <= param_2)) {
        uVar2 = udata_openSwapper_76_godot
                          ((int)(char)param_1[4],*(undefined1 *)((long)param_1 + 9),(int)param_3,
                           param_4);
        return uVar2;
      }
    }

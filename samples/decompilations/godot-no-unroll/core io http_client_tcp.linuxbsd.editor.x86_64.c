...
/* HTTPClientTCP::has_response() const */

undefined8 __thiscall HTTPClientTCP::has_response(HTTPClientTCP *this)
...
/* HTTPClientTCP::is_response_chunked() const */

HTTPClientTCP __thiscall HTTPClientTCP::is_response_chunked(HTTPClientTCP *this)
...
/* HTTPClientTCP::get_response_code() const */

undefined4 __thiscall HTTPClientTCP::get_response_code(HTTPClientTCP *this)
...
/* HTTPClientTCP::get_response_body_length() const */

undefined8 __thiscall HTTPClientTCP::get_response_body_length(HTTPClientTCP *this)
...
/* HTTPClientTCP::get_status() const */

undefined4 __thiscall HTTPClientTCP::get_status(HTTPClientTCP *this)
...
/* HTTPClientTCP::set_blocking_mode(bool) */

void __thiscall HTTPClientTCP::set_blocking_mode(HTTPClientTCP *this,bool param_1)
...
/* HTTPClientTCP::is_blocking_mode_enabled() const */

HTTPClientTCP __thiscall HTTPClientTCP::is_blocking_mode_enabled(HTTPClientTCP *this)
...
/* HTTPClientTCP::get_read_chunk_size() const */

undefined4 __thiscall HTTPClientTCP::get_read_chunk_size(HTTPClientTCP *this)
...
/* HTTPClientTCP::set_read_chunk_size(int) */

void __thiscall HTTPClientTCP::set_read_chunk_size(HTTPClientTCP *this,int param_1)

{
  ...
  _err_print_error("set_read_chunk_size","core/io/http_client_tcp.cpp",0x2fb,
                   "Condition \"p_size < 256 || p_size > (1 << 24)\" is true.",0,0);
  return;
}



/* HTTPClientTCP::get_connection() const */

void HTTPClientTCP::get_connection(void)
...
/* HTTPClientTCP::set_connection(Ref<StreamPeer> const&) */

void __thiscall HTTPClientTCP::set_connection(HTTPClientTCP *this,Ref *param_1)

{
  ...
  lVar1 = *(long *)param_1;
  if (lVar1 == 0) {
    _err_print_error("set_connection","core/io/http_client_tcp.cpp",0x6f,
                     "Condition \"p_connection.is_null()\" is true.",
                     "Connection is not a reference to a valid StreamPeer object.",0,0);
    return;
  }
  if ((*(long *)(this + 0x1d8) != 0) &&
     (lVar5 = __dynamic_cast(lVar1,&Object::typeinfo,&StreamPeerTLS::typeinfo,0), lVar5 == 0)) {
    _err_print_error("set_connection","core/io/http_client_tcp.cpp",0x72,
                     "Parameter \"Object::cast_to<StreamPeerTLS>(p_connection.ptr())\" is null.",
                     "Connection is not a reference to a valid StreamPeerTLS object.",0,0);
    return;
  }
...
/* HTTPClientTCP::set_https_proxy(String const&, int) */

void __thiscall HTTPClientTCP::set_https_proxy(HTTPClientTCP *this,String *param_1,int param_2)
...
/* HTTPClientTCP::set_http_proxy(String const&, int) */

void __thiscall HTTPClientTCP::set_http_proxy(HTTPClientTCP *this,String *param_1,int param_2)
...
/* HTTPClientTCP::_get_http_data(unsigned char*, int, int&) */

undefined8 __thiscall
HTTPClientTCP::_get_http_data(HTTPClientTCP *this,uchar *param_1,int param_2,int *param_3)
  ...
  if (this[0x1d0] == (HTTPClientTCP)0x0) {
    ...
    *param_3 = 0;
    if (param_2 < 1) {
      ...
      do {
        uVar1 = (**(code **)(**(long **)(this + 0x238) + 0x168))
                          (*(long **)(this + 0x238),param_1 + iVar2,param_2,&local_34);
        if ((int)uVar1 != 0) {
          if ((int)uVar1 == 0x12) {
...
HTTPClientTCP * HTTPClientTCP::_create_func(bool param_1)
...
/* HTTPClientTCP::connect_to_host(String const&, int, Ref<TLSOptions>) */

int __thiscall
HTTPClientTCP::connect_to_host
          (HTTPClientTCP *this,CowData *param_1,undefined4 param_2,long *param_4)
...
LAB_0010126e:
            ...
            pOVar7 = local_50;
            if ((cVar5 != '\0') &&
               (cVar5 = predelete_handler(pOVar2), pOVar7 = local_50, cVar5 != '\0')) {
              (**(code **)(*(long *)pOVar2 + 0x140))(pOVar2);
              Memory::free_static(pOVar2,false);
              pOVar7 = local_50;
            }
        ...
        if (((local_60 != (Object *)0x0) &&
            (cVar5 = RefCounted::unreference(), pOVar2 = local_60, cVar5 != '\0')) &&
    ...
    if (*(long *)(this + 0x1d8) == 0) goto LAB_00100c02;
    if (*(int *)(*(long *)(this + 0x1d8) + 0x17c) != 2) {
      cVar5 = StreamPeerTLS::is_available();
      if (cVar5 == '\0') {
        iVar6 = 2;
        _err_print_error("connect_to_host","core/io/http_client_tcp.cpp",0x3f,
                         "Condition \"tls_options.is_valid() && !StreamPeerTLS::is_available()\" is true. Returning: ERR_UNAVAILABLE"
                         ,"HTTPS is not available in this build.",0,0);
        goto LAB_00100c40;
      }
      goto LAB_00100c02;
    }
    _err_print_error("connect_to_host","core/io/http_client_tcp.cpp",0x3e,
                     "Condition \"tls_options.is_valid() && tls_options->is_server()\" is true. Returning: ERR_INVALID_PARAMETER"
                     ,0,0);
  }
  else {
    String::substr((int)&local_50,(int)this_00);
    ...
    if ((*(long *)(this + 0x1d8) != 0) && (cVar5 = RefCounted::unreference(), cVar5 != '\0')) {
      pOVar2 = *(Object **)(this + 0x1d8);
    ...
    *(undefined8 *)(this + 0x1d8) = 0;
LAB_00100c02:
    if ((*(long *)(this + 0x198) != 0) && (4 < *(int *)(*(long *)(this + 0x198) + -8))) {
      if (*(int *)(this + 400) < 0) {
        if (*(long *)(this + 0x1d8) == 0) {
...
LAB_00100e74:
        ...
        pOVar7 = (Object *)
                 __dynamic_cast(*(long *)(this + 0x230),&Object::typeinfo,&StreamPeer::typeinfo,0);
        if (pOVar7 != pOVar2) {
...
LAB_00100da0:
        if (*(long *)(this + 0x1a8) != *(long *)(this + 0x198)) {
    ...
    _err_print_error("connect_to_host","core/io/http_client_tcp.cpp",0x40,
                     "Condition \"conn_host.length() < HOST_MIN_LEN\" is true. Returning: ERR_INVALID_PARAMETER"
                     ,0,0);
  }
  iVar6 = 0x1f;
LAB_00100c40:
...
/* HTTPClientTCP::request(HTTPClient::Method, String const&, Vector<String> const&, unsigned char
   const*, int) */

int __thiscall
HTTPClientTCP::request
          (HTTPClientTCP *this,uint param_2,String *param_3,long param_4,undefined8 param_5,
          int param_6)
...
LAB_0010146f:
      if (*(int *)(this + 0x17c) == 5) {
        if (*(long *)(this + 0x238) == 0) {
          iVar6 = 0x1e;
          _err_print_error("request","core/io/http_client_tcp.cpp",0x9a,
                           "Condition \"connection.is_null()\" is true. Returning: ERR_INVALID_DATA"
                           ,0,0);
          goto LAB_00101d0b;
        }
...
LAB_001014db:
        if ((*(long *)(this + 0x1d8) == 0) && (*(int *)(this + 0x1b0) != -1)) {
          local_60 = 0;
          plVar10 = (long *)(*(long *)param_3 + -0x10);
          if (*(long *)param_3 != 0) {
            do {
...
LAB_001025e2:
            ...
            local_58 = "\r\n";
            String::parse_latin1(local_e0);
            operator+((char *)local_c8,(String *)"Host: ");
            String::operator+((String *)&local_58,local_c8);
            String::operator+=((String *)&local_98,(String *)&local_58);
            pcVar3 = local_58;
            if (local_58 != (char *)0x0) {
...
LAB_001018f2:
            ...
            operator+((char *)&local_88,(String *)"Host: ");
...
LAB_00101d63:
        ...
        if (bVar14) {
          ...
          String::parse_latin1(local_e0);
          itos((long)local_d8);
          operator+((char *)local_c8,(String *)"Content-Length: ");
          String::operator+((String *)&local_58,local_c8);
          String::operator+=((String *)&local_98,(String *)&local_58);
          pcVar3 = local_58;
          if (local_58 != (char *)0x0) {
        ...
        if (bVar16) {
          ...
          operator+((char *)&local_88,(String *)"User-Agent: GodotEngine/");
          String::operator+((String *)&local_78,(String *)&local_88);
          String::operator+(local_c8,(String *)&local_78);
          String::operator+((String *)&local_58,local_c8);
          String::operator+=((String *)&local_98,(String *)&local_58);
        ...
        if (local_58 == (char *)0x0) {
          ...
          iVar7 = (int)*(undefined8 *)(local_58 + -8) + -1 +
      ...
      _err_print_error("request","core/io/http_client_tcp.cpp",0x99,
      ...
      if (param_2 == 7) {
        ...
        if ((((0 < iVar6) && (*(long *)param_3 != 0)) &&
            (iVar7 = (int)*(undefined8 *)(*(long *)param_3 + -8), iVar7 != 0)) &&
           (iVar6 < iVar7 + -2)) goto LAB_0010146f;
      }
      else {
LAB_00101458:
        cVar5 = String::begins_with((char *)param_3);
        if (((cVar5 != '\0') || (cVar5 = String::begins_with((char *)param_3), cVar5 != '\0')) ||
           (cVar5 = String::begins_with((char *)param_3), cVar5 != '\0')) goto LAB_0010146f;
      }
      _err_print_error("request","core/io/http_client_tcp.cpp",0x98,
                       "Condition \"!_check_request_url(p_method, p_url)\" is true. Returning: ERR_INVALID_PARAMETER"
                       ,0,0);
    }
  }
  else {
    _err_print_index_error
              ("request","core/io/http_client_tcp.cpp",0x97,(ulong)param_2,9,"p_method","METHOD_MAX"
               ,"",false,false);
  }
  iVar6 = 0x1f;
LAB_00101d0b:
...
/* HTTPClientTCP::get_response_headers(List<String, DefaultAllocator>*) */

undefined8 __thiscall HTTPClientTCP::get_response_headers(HTTPClientTCP *this,List *param_1)

{
  ...
  lVar3 = *(long *)(this + 600);
  if ((lVar3 != 0) && (lVar5 = *(long *)(lVar3 + -8), lVar5 != 0)) {
    lVar6 = 0;
    while( true ) {
      if (lVar5 <= lVar6) {
        if (lVar5 != 0) {
...
void __thiscall HTTPClientTCP::close(HTTPClientTCP *this)
...
/* HTTPClientTCP::read_response_body_chunk() */

long HTTPClientTCP::read_response_body_chunk(void)
...
LAB_00102d28:
      if (in_RSI[0x20c] == (HTTPClientTCP)0x0) {
        ...
        if (iVar5 == 0) {
          ...
          if (pbVar6 != (byte *)0x0) {
            ...
            if (0x20 < lVar11) {
              _err_print_error("read_response_body_chunk","core/io/http_client_tcp.cpp",0x268,
                               "HTTP Invalid chunk hex len",0,0);
              ...
              do {
                ...
                if ((int)(char)bVar3 - 0x30U < 10) {
                  ...
                  if (5 < (byte)(bVar3 + 0xbf)) {
                    _err_print_error("read_response_body_chunk","core/io/http_client_tcp.cpp",0x279,
                                     "HTTP Chunk len not in hex!!",0,0);
                    *(undefined4 *)(in_RSI + 0x17c) = 8;
                    break;
                  }
                  uVar8 = bVar3 - 0x37;
                ...
                if (0x1000000 < (int)uVar9) {
                  _err_print_error("read_response_body_chunk","core/io/http_client_tcp.cpp",0x280,
                                   "HTTP Chunk too big!! >16mb",0,0);
                  *(undefined4 *)(in_RSI + 0x17c) = 8;
                  goto LAB_00103123;
                }
                pbVar6 = pbVar6 + 1;
...
LAB_00103123:
              *(uint *)(in_RSI + 0x208) = uVar9 + 2;
              CowData<unsigned_char>::resize<false>
                        ((CowData<unsigned_char> *)(in_RSI + 0x200),(long)(int)(uVar9 + 2));
            }
          }
          goto LAB_00102d28;
        }
...
LAB_0010317a:
          _err_print_index_error
                    (_LC72,"./core/templates/vector.h",0x38,lVar13,lVar11,"p_index",
        ...
        *(int *)pHVar1 = *(int *)pHVar1 - local_5c[0];
        ...
        if (lVar11 != 0) {
          ...
          _err_print_error("read_response_body_chunk","core/io/http_client_tcp.cpp",0x29b,
                           "HTTP Invalid chunk terminator (not \\r\\n)",0,0);
          *(undefined4 *)(in_RSI + 0x17c) = 8;
          goto LAB_00102cd2;
        }
        lVar13 = 0;
...
LAB_00102f5b:
      _err_print_index_error
                ("get","./core/templates/cowdata.h",0xdb,sVar7,lVar13,"p_index","size()","",false,
                 true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
      pcVar4 = (code *)invalidInstructionException();
...
LAB_00102cdb:
    if (((*(long *)(in_RSI + 0x218) == 0) && (in_RSI[0x1f0] == (HTTPClientTCP)0x0)) &&
       (in_RSI[0x220] == (HTTPClientTCP)0x0)) {
      *(undefined4 *)(in_RSI + 0x17c) = 5;
    }
LAB_00102ce9:
    *(void **)(in_RDI + 8) = local_50[0];
  }
  else {
    _err_print_error("read_response_body_chunk","core/io/http_client_tcp.cpp",0x23c,
                     "Condition \"status != STATUS_BODY\" is true. Returning: PackedByteArray()",0,0
                    );
  ...
  return in_RDI;
code_r0x00102c8e:
  if ((int)uVar9 < 1) goto LAB_00102cdb;
  goto LAB_00102c92;
}
...
int __thiscall HTTPClientTCP::poll(HTTPClientTCP *this)
      ...
      if (iVar9 == 0) {
        ...
        if (pOVar14 != pOVar15) {
          *(Object **)(this + 0x238) = pOVar15;
          if ((pOVar15 != (Object *)0x0) && (cVar7 = RefCounted::reference(), cVar7 == '\0')) {
            *(undefined8 *)(this + 0x238) = 0;
          }
          if (((pOVar14 != (Object *)0x0) && (cVar7 = RefCounted::unreference(), cVar7 != '\0')) &&
             (cVar7 = predelete_handler(pOVar14), cVar7 != '\0')) {
            (**(code **)(*(long *)pOVar14 + 0x140))(pOVar14);
            Memory::free_static(pOVar14,false);
          }
        }
...
LAB_00103f80:
    ...
    iVar10 = (**(code **)(*plVar2 + 0x1d0))(plVar2);
    if (iVar10 == 3) {
      plVar2 = *(long **)(this + 0x240);
      ...
      if (((*(long *)(this + 0x230) != 0) &&
         ...
         (local_88 = pOVar12, cVar7 = RefCounted::reference(), cVar7 == '\0')) {
        local_88 = (Object *)0x0;
      }
      (*pcVar5)(plVar2);
      if (((local_88 != (Object *)0x0) &&
          (cVar7 = RefCounted::unreference(), pOVar12 = local_88, cVar7 != '\0')) &&
         (cVar7 = predelete_handler(local_88), cVar7 != '\0')) {
        (**(code **)(*(long *)pOVar12 + 0x140))(pOVar12);
        Memory::free_static(pOVar12,false);
      }
      plVar4 = *(long **)(this + 0x240);
      uVar11 = *(undefined4 *)(this + 400);
      local_90 = 0;
      pcVar5 = *(code **)(*plVar4 + 0x150);
      local_a0 = 0;
      plVar2 = (long *)(*(long *)(this + 0x198) + -0x10);
      if (*(long *)(this + 0x198) != 0) {
        do {
          lVar18 = *plVar2;
...
LAB_0010428e:
      local_a8 = 0;
      local_88 = (Object *)0x1050cd;
      local_80 = (char *)0x5;
      String::parse_latin1((StrRange *)&local_a8);
      vformat<String,int>(&local_88,(StrRange *)&local_a8,&local_a0,uVar11);
      iVar10 = (*pcVar5)(plVar4,7,&local_88,&local_98,0);
      pOVar12 = local_88;
      if (local_88 != (Object *)0x0) {
        LOCK();
...
LAB_00103ccc:
    ...
    pcVar5 = *(code **)(**(long **)(this + 0x240) + 0x178);
    if (pcVar5 == get_status) {

  ...
  if ((iVar6 == 0) &&
    ...
    *(int *)((long)param_2 + 0x11c) = *(int *)((long)param_2 + 0x11c) + (int)param_2[0x28] * 0x10000
    ...
    if (((int)param_2[0x1f] == 0x50465230) &&
      ...
      uVar27 = *(uint *)((long)param_2 + 0x10c);
      uVar11 = FT_Stream_Seek(param_1,(ulong)uVar27);
      ...
      if (((0x3332 < uVar5) || (*(ulong *)(param_1 + 8) - (ulong)uVar27 <= uVar18 * 5 + 2)) ||
      ...
      *param_2 = uVar18;
      ...
      uVar27 = (uint)param_3 & 0xffff;
      if (uVar18 <= (param_3 & 0xffff)) {
LAB_00102e50:
        uVar11 = 6;
        goto LAB_001027da;
      }
      ...
      uVar11 = (ulong)local_58 & 0xffffffff;
      if ((uint)local_58 != 0) goto LAB_001027da;
      if ((uVar7 & 0xffff) <= uVar27) goto LAB_00102e50;
      uVar11 = FT_Stream_Skip(param_1,uVar27 * 5);
      local_58 = (ulong *)CONCAT44(local_58._4_4_,(int)uVar11);
      if ((int)uVar11 != 0) goto LAB_001027da;
      uVar5 = FT_Stream_ReadUShort(param_1,&local_58);
      uVar11 = (ulong)local_58 & 0xffffffff;
...
LAB_00103518:
        ...
        *(int *)(param_2 + 0x2f) =
        ...
        if ((bVar2 & 4) == 0) {
          ...
          bVar29 = bVar2 & 0x10;
          if ((bVar2 & 0x10) == 0) {
            if (puVar16 < (ushort *)((long)puVar12 + (ulong)uVar27)) goto LAB_00103518;
LAB_00102aae:
            if ((bVar2 & 8) == 0) {
              puVar26 = (ushort *)(pbVar4 + 0xe);
              uVar27 = (uint)pbVar4[0xd];
            }
            else {
              puVar26 = (ushort *)(pbVar4 + 0xf);
              uVar27 = (uint)(short)(*(ushort *)(pbVar4 + 0xd) << 8 | *(ushort *)(pbVar4 + 0xd) >> 8
                                    );
            }
            *(uint *)(param_2 + 0x30) = uVar27;
            puVar12 = puVar26;
            if ((bVar2 & 3) == 0) {
            ...
            if (bVar29 == 0) goto LAB_00102b25;
          }
          else {
LAB_00103536:
            if (puVar16 < (ushort *)((ulong)(((bVar2 & 0x20) != 0) + uVar27 + 1) + (long)puVar12))
            goto LAB_00103518;
            if ((bVar2 & 4) != 0) {
              bVar29 = 0x10;
              goto LAB_00102aae;
          ...
          if ((bVar2 & 0x20) == 0) {
            ...
            uVar5 = *puVar12;
            puVar12 = puVar12 + 1;
            uVar27 = (uint)(short)(uVar5 << 8 | uVar5 >> 8);
          }
          *(uint *)((long)param_2 + 0x184) = uVar27;
        }
LAB_00102b25:
        puVar26 = puVar12;
        if ((bVar2 & 0x40) != 0) {
          puVar26 = (ushort *)((long)puVar12 + 1);
          if (puVar16 < puVar26) goto LAB_00103518;
          for (uVar27 = (uint)(byte)*puVar12; uVar27 != 0; uVar27 = uVar27 - 1) {
        ...
        if (puVar16 < (ushort *)((long)puVar26 + 5U)) goto LAB_00103518;
        uVar27 = (uint)(ushort)(*puVar26 << 8 | *puVar26 >> 8);
        *(uint *)((long)param_2 + 0x18c) = uVar27;
        *(uint *)(param_2 + 0x32) =
             (uint)(byte)puVar26[1] << 0x10 | (uint)*(byte *)((long)puVar26 + 3) << 8 |
             (uint)(byte)puVar26[2];
        if ((int)uVar18 != 0) {
          if (puVar16 < puVar26 + 3) goto LAB_00103518;
          *(uint *)((long)param_2 + 0x18c) = (uint)*(byte *)((long)puVar26 + 5) * 0x10000 + uVar27;
        }
      }
      ...
      uVar27 = (uint)param_2[0x32];
      param_2[0x4d] = 0;
      uVar7 = *(uint *)((long)param_2 + 0x18c);
      param_2[0x33] = uVar18;
      *(uint *)(param_2 + 0x34) = uVar27;
        ...
        *(uint *)(param_2 + 0x3a) = (uint)bVar2;
        ...
        if ((char)bVar2 < '\0') {
          ...
          if (puVar26 <= puVar16) {
            ...
            puVar28 = (ushort *)((long)puVar12 + 3);
            if (puVar28 <= puVar16) {
              bVar29 = (byte)puVar12[1];
              puVar26 = (ushort *)((ulong)*(byte *)((long)puVar12 + 1) + (long)puVar28);
              if (puVar26 <= puVar16) {
                uVar7 = (uint)(byte)*puVar12;
                do {
                  pcVar31 = pfr_extra_item_load_bitmap_info;
                  puVar15 = &pfr_phy_font_extra_items;
                  do {
                    if ((uint)bVar29 == *puVar15) {
                      iVar6 = (*pcVar31)(puVar28,puVar26,param_2 + 0x33);
                      if (iVar6 != 0) goto LAB_0010350f;
                      break;
                    }
                    pcVar31 = *(code **)(puVar15 + 6);
                    puVar15 = puVar15 + 4;
                  ...
                  puVar28 = puVar26 + 1;
                  if (puVar16 < puVar28) break;
                  bVar29 = *(byte *)((long)puVar26 + 1);
                  puVar26 = (ushort *)((long)puVar28 + (ulong)(byte)*puVar26);
...
LAB_00102cfb:
        ...
        if (uVar7 != 0) {
          uVar11 = (ulong)uVar7;
          puVar28 = (ushort *)((long)puVar12 + uVar11);
          if (puVar16 < puVar28) goto LAB_00102e60;
          ...
          if (puVar26 <= puVar28) {
            while( true ) {
              ...
              if (uVar3 == 0x200) {
                ...
                puVar17 = param_2 + 0x43;
                if (uVar24 != 3) {
                  if (uVar24 != 1) goto LAB_00102da8;
                  puVar17 = param_2 + 0x42;
                }
                uVar7 = pfr_aux_name_load(puVar26,uVar5 - 4,uVar18,puVar17);
...
LAB_00102da8:
              ...
              if ((uVar11 == 0) || (puVar26 = puVar1 + 2, puVar12 = puVar1, puVar28 < puVar26))
              break;
            }
          }
        }
        local_98 = (ushort *)((long)puVar28 + 1);
        if (puVar16 < local_98) goto LAB_00102e60;
        bVar29 = (byte)*puVar28;
        uVar7 = (uint)bVar29;
        *(uint *)(param_2 + 0x46) = uVar7;
        if (puVar16 < (ushort *)((ulong)((uint)bVar29 + (uint)bVar29) + (long)local_98))
        goto LAB_00102e60;
        uVar11 = ft_mem_qrealloc(uVar18,4,0,(ulong)bVar29,0,&local_58);
        param_2[0x47] = uVar11;
        if ((uint)local_58 == 0) {
          if (uVar7 != 0) {
            lVar22 = 0;
            do {
              *(int *)(uVar11 + lVar22 * 4) =
                   (int)CONCAT11(*(byte *)((long)puVar28 + lVar22 * 2 + 1),(byte)puVar28[lVar22 + 1]
                                );
              lVar22 = lVar22 + 1;
            } while ((uint)lVar22 < uVar7);
            local_98 = local_98 + bVar29;
          }
          puVar12 = local_98 + 4;
          if (puVar12 <= puVar16) {
            ...
            *(uint *)(param_2 + 0x3d) = (uint)(ushort)(local_98[2] << 8 | local_98[2] >> 8);
            ...
            param_2[0x4a] = (ulong)((long)puVar12 + ((ulong)uVar27 - *(long *)(param_1 + 0x40)));
            uVar27 = (uint)uVar5;
            *(uint *)(param_2 + 0x49) = uVar27;
            if (uVar27 != 0) {
              local_90 = bVar2 & 2;
              ...
              if ((ushort *)
                  ((ulong)(((((iVar9 - (uint)((bVar2 & 8) == 0)) - (uint)((bVar2 & 0x10) == 0)) + 3)
                           - (uint)((bVar2 & 0x20) == 0)) * uVar27) + (long)puVar12) <= puVar16) {
                puVar15 = (uint *)ft_mem_qrealloc(uVar18,0x10,0,uVar5,0,&local_58);
...
LAB_00102e68:
      ...
      if ((uint)local_58 == 0) {
        uVar18 = param_2[2];
        uVar27 = (uint)param_2[0x49];
        param_2[1] = param_3 & 0xffff;
        uVar11 = uVar18 | 1;
        param_2[4] = (ulong)uVar27 + 1;
        param_2[2] = uVar11;
        if (uVar27 != 0) {
          uVar7 = 0;
        ...
        uVar11 = 3;
        if (uVar27 != 0) {
          uVar11 = uVar18 & 0xfffffffffffffffe;
LAB_00102f06:
          ...
          *(undefined4 *)(param_2 + 7) = 0;
          ...
          sVar30 = (short)param_2[0x37];
          sVar25 = (short)param_2[0x39];
          *(short *)((long)param_2 + 0x8a) = sVar25;
          *(short *)((long)param_2 + 0x8c) = sVar30;
          ...
          *(short *)(param_2 + 0x11) = (short)(uint)param_2[0x35];
          ...
          sVar19 = (short)((uVar10 * 0xc) / 10);
          if ((int)sVar19 < (int)sVar25 - (int)sVar30) {
            sVar19 = sVar25 - sVar30;
          }
          *(short *)((long)param_2 + 0x8e) = sVar19;
          if (uVar27 != 0) {
            puVar14 = (undefined2 *)ft_mem_qrealloc(param_2[0x17],0x20,0,(ulong)uVar27,0,&local_5c);
            ...
            do {
              ...
              *(ulong *)(puVar20 + 0xc) = uVar11;
              puVar20 = puVar21;
            } while (puVar21 != puVar14 + (ulong)uVar27 * 0x10);
            uVar10 = (uint)(ushort)param_2[0x11];
            *(uint *)(param_2 + 7) = uVar27;
            uVar7 = (uint)param_2[0x3a] & 4;
          }
          if (uVar7 == 0) {
            uVar27 = (uint)*(ushort *)((long)param_2 + 0x1d4);
          }
          else {
            uVar11 = param_2[0x4b];
            if ((uint)param_2[0x49] == 0) {
              ...
              uVar18 = uVar11 + (ulong)(uint)param_2[0x49] * 0x10;
              uVar27 = 0;
              do {
                if ((int)uVar27 < (int)*(uint *)(uVar11 + 4)) {
                  uVar27 = *(uint *)(uVar11 + 4);
                }
                uVar11 = uVar11 + 0x10;
              } while (uVar11 != uVar18);
            }
          ...
          param_2[0x12] =
               (((ulong)(uVar10 / 0x1e) << 0x10 |
                (ulong)(-(int)((ulong)(long)(int)uVar10 / 10) & 0xffff)) << 0x10 |
               (ulong)*(ushort *)((long)param_2 + 0x8e)) << 0x10 | (ulong)(uVar27 & 0xffff);

...
/* GLES3::MeshStorage::_multimesh_get_command_buffer_rd_rid(RID) const */

undefined8 GLES3::MeshStorage::_multimesh_get_command_buffer_rd_rid(void)

{
  _err_print_error("_multimesh_get_command_buffer_rd_rid","drivers/gles3/storage/mesh_storage.cpp",
                   0x7fd,"Method/function failed. Returning: RID()",
                   "GLES3 does not implement indirect multimeshes.",0,0);
  return 0;
}



/* GLES3::MeshStorage::_multimesh_get_buffer_rd_rid(RID) const */

undefined8 GLES3::MeshStorage::_multimesh_get_buffer_rd_rid(void)

{
  _err_print_error("_multimesh_get_buffer_rd_rid","drivers/gles3/storage/mesh_storage.cpp",0x801,
                   "Method/function failed. Returning: RID()",
                   "GLES3 does not contain a Rid for the multimesh buffer.",0,0);
  return 0;
}



/* GLES3::MeshStorage::mesh_instance_set_skeleton(RID, RID) */

void __thiscall
GLES3::MeshStorage::mesh_instance_set_skeleton(MeshStorage *this,ulong param_2,long param_3)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 500))) {
    lVar1 = *(long *)(*(long *)(this + 0x1e0) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x1f0)) * 8) +
            ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x1f0)) * 0xa8;
    ...
    if (*(int *)(lVar1 + 0xa0) + 0x80000000U < 0x7fffffff) {
      _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                       ...
                       "Attempting to use an uninitialized RID",0,0,lVar1);
    }
  }
...
/* GLES3::MeshStorage::mesh_instance_set_canvas_item_transform(RID, Transform2D const&) */

void __thiscall
GLES3::MeshStorage::mesh_instance_set_canvas_item_transform
          (MeshStorage *this,ulong param_2,undefined8 *param_3)
...
/* GLES3::MeshStorage::mesh_set_blend_shape_count(RID, int) */

void __thiscall
GLES3::MeshStorage::mesh_set_blend_shape_count(MeshStorage *this,ulong param_2,int param_3)

{
  int *piVar1;
  
  if (param_3 < 0) {
    _err_print_error("mesh_set_blend_shape_count","drivers/gles3/storage/mesh_storage.cpp",0x5b,
                     "Condition \"p_blend_shape_count < 0\" is true.",0,0);
    return;
  }
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x19c))) {
    piVar1 = (int *)(*(long *)(*(long *)(this + 0x188) +
                              ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x198)) * 8) +
                    ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x198)) * 0xd8);
    if (piVar1[0x34] == (int)(param_2 >> 0x20)) {
      if (piVar1[4] == 0) {
        *piVar1 = param_3;
        return;
      }
      _err_print_error("mesh_set_blend_shape_count","drivers/gles3/storage/mesh_storage.cpp",0x60,
                       "Condition \"mesh->surface_count > 0\" is true.",0,0);
      return;
    }
  ...
  _err_print_error("mesh_set_blend_shape_count","drivers/gles3/storage/mesh_storage.cpp",0x5e,
...
/* GLES3::MeshStorage::mesh_needs_instance(RID, bool) */

byte __thiscall
GLES3::MeshStorage::mesh_needs_instance(MeshStorage *this,ulong param_2,byte param_3)

{
  ...
  _err_print_error("mesh_needs_instance","drivers/gles3/storage/mesh_storage.cpp",0x66,
                   "Parameter \"mesh\" is null.",0,0);
  return 0;
}
...
/* GLES3::MeshStorage::mesh_get_blend_shape_count(RID) const */

undefined4 __thiscall
GLES3::MeshStorage::mesh_get_blend_shape_count(MeshStorage *this,ulong param_2)

{
  ...
  _err_print_error("mesh_get_blend_shape_count","drivers/gles3/storage/mesh_storage.cpp",0x206,
                   "Parameter \"mesh\" is null.",0,0);
  return 0xffffffff;
}
...
/* GLES3::MeshStorage::mesh_get_blend_shape_mode(RID) const */

undefined4 __thiscall GLES3::MeshStorage::mesh_get_blend_shape_mode(MeshStorage *this,ulong param_2)

{
  ...
  _err_print_error("mesh_get_blend_shape_mode","drivers/gles3/storage/mesh_storage.cpp",0x214,
                   "Parameter \"mesh\" is null.",0,0);
  return 0;
}
...
/* GLES3::MeshStorage::mesh_get_surface_count(RID) const */

undefined4 __thiscall GLES3::MeshStorage::mesh_get_surface_count(MeshStorage *this,ulong param_2)

{
  ...
  _err_print_error("mesh_get_surface_count","drivers/gles3/storage/mesh_storage.cpp",0x292,
                   "Parameter \"mesh\" is null.",0,0);
  return 0;
}
...
/* GLES3::MeshStorage::mesh_get_custom_aabb(RID) const */

undefined8 *
GLES3::MeshStorage::mesh_get_custom_aabb(undefined8 *param_1,long param_2,ulong param_3)

{
  ...
  if ((param_3 != 0) && ((uint)param_3 < *(uint *)(param_2 + 0x19c))) {
    lVar1 = *(long *)(*(long *)(param_2 + 0x188) +
                     ((param_3 & 0xffffffff) / (ulong)*(uint *)(param_2 + 0x198)) * 8) +
            ((param_3 & 0xffffffff) % (ulong)*(uint *)(param_2 + 0x198)) * 0xd8;
  ...
  _err_print_error("mesh_get_custom_aabb","drivers/gles3/storage/mesh_storage.cpp",0x2a0,
                   "Parameter \"mesh\" is null.",0,0);
  *param_1 = 0;
...
/* GLES3::MeshStorage::_multimesh_get_instance_count(RID) const */

undefined4 __thiscall
GLES3::MeshStorage::_multimesh_get_instance_count(MeshStorage *this,ulong param_2)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x26c))) {
    lVar2 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x268)) * 0x118 +
            *(long *)(*(long *)(this + 600) +
  ...
  _err_print_error("_multimesh_get_instance_count","drivers/gles3/storage/mesh_storage.cpp",0x622,
                   "Parameter \"multimesh\" is null.",0,0);
  return 0;
}



/* GLES3::MeshStorage::_multimesh_get_mesh(RID) const */

undefined8 __thiscall GLES3::MeshStorage::_multimesh_get_mesh(MeshStorage *this,ulong param_2)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x26c))) {
    puVar2 = (undefined8 *)
             (((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x268)) * 0x118 +
             *(long *)(*(long *)(this + 600) +
                      ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x268)) * 8));
  ...
  _err_print_error("_multimesh_get_mesh","drivers/gles3/storage/mesh_storage.cpp",0x71d,
                   "Parameter \"multimesh\" is null.",0,0);
  return 0;
}
...
/* GLES3::MeshStorage::_multimesh_get_custom_aabb(RID) const */

undefined8 *
GLES3::MeshStorage::_multimesh_get_custom_aabb(undefined8 *param_1,long param_2,ulong param_3)

{
  ...
  if ((param_3 != 0) && ((uint)param_3 < *(uint *)(param_2 + 0x26c))) {
    lVar3 = ((param_3 & 0xffffffff) % (ulong)*(uint *)(param_2 + 0x268)) * 0x118 +
  ...
  _err_print_error("_multimesh_get_custom_aabb","drivers/gles3/storage/mesh_storage.cpp",0x72b,
                   "Parameter \"multimesh\" is null.",0,0);
  *param_1 = 0;
  *(undefined4 *)(param_1 + 1) = 0;
  *(undefined8 *)((long)param_1 + 0xc) = 0;
...
/* GLES3::MeshStorage::_multimesh_get_visible_instances(RID) const */

undefined4 __thiscall
GLES3::MeshStorage::_multimesh_get_visible_instances(MeshStorage *this,ulong param_2)

{
  ...
  _err_print_error("_multimesh_get_visible_instances","drivers/gles3/storage/mesh_storage.cpp",0x864
                   ,"Parameter \"multimesh\" is null.",0,0);
  return 0;
}
...
/* GLES3::MeshStorage::skeleton_set_base_transform_2d(RID, Transform2D const&) */

void __thiscall
GLES3::MeshStorage::skeleton_set_base_transform_2d
          (MeshStorage *this,ulong param_2,undefined8 *param_3)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x2cc))) {
    pcVar2 = (char *)(((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x2c8)) * 0x90 +
                     *(long *)(*(long *)(this + 0x2b8) +
                              ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x2c8)) * 8));
    if (*(int *)(pcVar2 + 0x88) == (int)(param_2 >> 0x20)) {
      ...
      _err_print_error("skeleton_set_base_transform_2d","drivers/gles3/storage/mesh_storage.cpp",
                       0x8f3,"Condition \"!skeleton->use_2d\" is true.",0,0);
      return;
    }
  ...
  _err_print_error("skeleton_set_base_transform_2d","drivers/gles3/storage/mesh_storage.cpp",0x8f2,
...
/* GLES3::MeshStorage::skeleton_get_bone_count(RID) const */

undefined4 __thiscall GLES3::MeshStorage::skeleton_get_bone_count(MeshStorage *this,ulong param_2)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x2cc))) {
    lVar2 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x2c8)) * 0x90 +
            *(long *)(*(long *)(this + 0x2b8) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x2c8)) * 8);
  ...
  _err_print_error("skeleton_get_bone_count","drivers/gles3/storage/mesh_storage.cpp",0x8fa,
                   "Parameter \"skeleton\" is null.",0,0);
  return 0;
}
...
/* GLES3::MeshStorage::mesh_set_custom_aabb(RID, AABB const&) */

void __thiscall
GLES3::MeshStorage::mesh_set_custom_aabb(MeshStorage *this,ulong param_2,undefined8 *param_3)

{
  ...
  _err_print_error("mesh_set_custom_aabb","drivers/gles3/storage/mesh_storage.cpp",0x298,
                   "Parameter \"mesh\" is null.",0,0);
  return;
}
...
/* GLES3::MeshStorage::_multimesh_set_custom_aabb(RID, AABB const&) */

void __thiscall
GLES3::MeshStorage::_multimesh_set_custom_aabb(MeshStorage *this,ulong param_2,undefined8 *param_3)

{
  ...
  _err_print_error("_multimesh_set_custom_aabb","drivers/gles3/storage/mesh_storage.cpp",0x724,
                   "Parameter \"multimesh\" is null.",0,0);
  return;
}
...
/* GLES3::MeshStorage::mesh_set_blend_shape_mode(RID, RenderingServer::BlendShapeMode) */

void __thiscall
GLES3::MeshStorage::mesh_set_blend_shape_mode(MeshStorage *this,ulong param_2,uint param_3)

{
      ...
      if (param_3 < 2) {
        *(uint *)(lVar1 + 4) = param_3;
        ...
        _err_print_index_error
                  ("mesh_set_blend_shape_mode","drivers/gles3/storage/mesh_storage.cpp",0x20d,
                   (long)(int)param_3,2,"(int)p_mode","2","",false,false);
      }
      return;
    }
    if (iVar2 + 0x80000000U < 0x7fffffff) {
  ...
  _err_print_error("mesh_set_blend_shape_mode","drivers/gles3/storage/mesh_storage.cpp",0x20c,
                   "Parameter \"mesh\" is null.",0,0);
  return;
}
...
/* GLES3::MeshStorage::mesh_surface_get_material(RID, int) const */

undefined8 __thiscall
GLES3::MeshStorage::mesh_surface_get_material(MeshStorage *this,ulong param_2,uint param_3)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x19c))) {
    ...
    if (*(int *)(lVar1 + 0xd0) == (int)(param_2 >> 0x20)) {
      if (param_3 < *(uint *)(lVar1 + 0x10)) {
        ...
        _err_print_index_error
                  ("mesh_surface_get_material","drivers/gles3/storage/mesh_storage.cpp",0x252,
                   (ulong)param_3,(ulong)*(uint *)(lVar1 + 0x10),"(uint32_t)p_surface",
  ...
  _err_print_error("mesh_surface_get_material","drivers/gles3/storage/mesh_storage.cpp",0x251,
                   "Parameter \"mesh\" is null.",0,0);
  return 0;
}
...
/* GLES3::MeshStorage::mesh_instance_set_blend_shape_weight(RID, int, float) */

void __thiscall
GLES3::MeshStorage::mesh_instance_set_blend_shape_weight
          (undefined4 param_1,MeshStorage *this,ulong param_3,uint param_4)

{
  ...
  if ((param_3 != 0) && ((uint)param_3 < *(uint *)(this + 500))) {
    lVar1 = *(long *)(*(long *)(this + 0x1e0) +
                     ((param_3 & 0xffffffff) / (ulong)*(uint *)(this + 0x1f0)) * 8) +
            ((param_3 & 0xffffffff) % (ulong)*(uint *)(this + 0x1f0)) * 0xa8;
    if (*(int *)(lVar1 + 0xa0) == (int)(param_3 >> 0x20)) {
      ...
      if ((-1 < (int)param_4) && ((int)param_4 < (int)uVar2)) {
        ...
        _err_print_index_error
                  ("operator[]","./core/templates/local_vector.h",0xb2,(long)(int)param_4,
                   (ulong)uVar2,"p_index","count","",false,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
      ...
      _err_print_index_error
                ("mesh_instance_set_blend_shape_weight","drivers/gles3/storage/mesh_storage.cpp",
                 0x46e,(long)(int)param_4,(long)(int)uVar2,"p_shape","(int)mi->blend_weights.size()"
                 ,"",false,false);
      return;
    }
    if (*(int *)(lVar1 + 0xa0) + 0x80000000U < 0x7fffffff) {
  ...
  _err_print_error("mesh_instance_set_blend_shape_weight","drivers/gles3/storage/mesh_storage.cpp",
                   0x46d,"Parameter \"mi\" is null.",0,0);
  return;
}



/* GLES3::MeshStorage::skeleton_bone_set_transform(RID, int, Transform3D const&) */

void __thiscall
GLES3::MeshStorage::skeleton_bone_set_transform
          (MeshStorage *this,ulong param_2,int param_3,undefined4 *param_4)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x2cc))) {
    pcVar4 = (char *)(((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x2c8)) * 0x90 +
                     *(long *)(*(long *)(this + 0x2b8) +
                              ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x2c8)) * 8));
    if (*(int *)(pcVar4 + 0x88) == (int)(param_2 >> 0x20)) {
      if ((-1 < param_3) && (param_3 < *(int *)(pcVar4 + 4))) {
        ...
        _err_print_error("skeleton_bone_set_transform","drivers/gles3/storage/mesh_storage.cpp",
                         0x904,"Condition \"skeleton->use_2d\" is true.",0,0);
        return;
      }
      _err_print_index_error
                ("skeleton_bone_set_transform","drivers/gles3/storage/mesh_storage.cpp",0x903,
                 (long)param_3,(long)*(int *)(pcVar4 + 4),"p_bone","skeleton->size","",false,false);
      return;
    }
  ...
  _err_print_error("skeleton_bone_set_transform","drivers/gles3/storage/mesh_storage.cpp",0x902,
                   "Parameter \"skeleton\" is null.",0,0);
  return;
}
...
/* GLES3::MeshStorage::skeleton_bone_get_transform(RID, int) const */

undefined1 (*) [16]
GLES3::MeshStorage::skeleton_bone_get_transform
          (undefined1 (*param_1) [16],long param_2,ulong param_3,int param_4)

{
  ...
  if ((param_3 != 0) && ((uint)param_3 < *(uint *)(param_2 + 0x2cc))) {
    pcVar10 = (char *)(((param_3 & 0xffffffff) % (ulong)*(uint *)(param_2 + 0x2c8)) * 0x90 +
                      *(long *)(*(long *)(param_2 + 0x2b8) +
                               ((param_3 & 0xffffffff) / (ulong)*(uint *)(param_2 + 0x2c8)) * 8));
    if (*(int *)(pcVar10 + 0x88) == (int)(param_3 >> 0x20)) {
      if ((param_4 < 0) || (*(int *)(pcVar10 + 4) <= param_4)) {
        _err_print_index_error
                  ("skeleton_bone_get_transform","drivers/gles3/storage/mesh_storage.cpp",0x91c,
                   (long)param_4,(long)*(int *)(pcVar10 + 4),"p_bone","skeleton->size","",false,
                   false);
        uVar9 = _LC54;
...
LAB_00101562:
  _err_print_error("skeleton_bone_get_transform","drivers/gles3/storage/mesh_storage.cpp",uVar11,
                   pcVar10,0,0);
  uVar9 = _LC54;
  *(undefined4 *)param_1[2] = 0x3f800000;
  *(undefined8 *)(param_1[2] + 4) = 0;
...
/* GLES3::MeshStorage::skeleton_bone_set_transform_2d(RID, int, Transform2D const&) */

void __thiscall
GLES3::MeshStorage::skeleton_bone_set_transform_2d
          (MeshStorage *this,ulong param_2,int param_3,undefined4 *param_4)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x2cc))) {
    pcVar5 = (char *)(((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x2c8)) * 0x90 +
                     *(long *)(*(long *)(this + 0x2b8) +
                              ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x2c8)) * 8));
    if (*(int *)(pcVar5 + 0x88) == (int)(param_2 >> 0x20)) {
      if ((-1 < param_3) && (param_3 < *(int *)(pcVar5 + 4))) {
        ...
        _err_print_error("skeleton_bone_set_transform_2d","drivers/gles3/storage/mesh_storage.cpp",
                         0x938,"Condition \"!skeleton->use_2d\" is true.",0,0);
        return;
      }
      _err_print_index_error
                ("skeleton_bone_set_transform_2d","drivers/gles3/storage/mesh_storage.cpp",0x937,
                 (long)param_3,(long)*(int *)(pcVar5 + 4),"p_bone","skeleton->size","",false,false);
      return;
    }
  ...
  _err_print_error("skeleton_bone_set_transform_2d","drivers/gles3/storage/mesh_storage.cpp",0x936,
                   "Parameter \"skeleton\" is null.",0,0);
  return;
}
...
/* GLES3::MeshStorage::skeleton_bone_get_transform_2d(RID, int) const */

undefined8 *
GLES3::MeshStorage::skeleton_bone_get_transform_2d
...

{
  ...
  if ((param_3 != 0) && ((uint)param_3 < *(uint *)(param_2 + 0x2cc))) {
    pcVar6 = (char *)(((param_3 & 0xffffffff) % (ulong)*(uint *)(param_2 + 0x2c8)) * 0x90 +
                     *(long *)(*(long *)(param_2 + 0x2b8) +
                              ((param_3 & 0xffffffff) / (ulong)*(uint *)(param_2 + 0x2c8)) * 8));
    if (*(int *)(pcVar6 + 0x88) == (int)(param_3 >> 0x20)) {
      if ((param_4 < 0) || (*(int *)(pcVar6 + 4) <= param_4)) {
        _err_print_index_error
                  ("skeleton_bone_get_transform_2d","drivers/gles3/storage/mesh_storage.cpp",0x94c,
                   (long)param_4,(long)*(int *)(pcVar6 + 4),"p_bone","skeleton->size","",false,false
                  );
        *param_1 = 0x3f800000;
      ...
      if (*pcVar6 != '\0') {
        ...
        uVar4 = *puVar1;
        uVar5 = puVar1[1];
        param_1[2] = CONCAT44((int)((ulong)*(undefined8 *)(puVar1 + 6) >> 0x20),
                              (int)((ulong)*(undefined8 *)(puVar1 + 2) >> 0x20));
...
LAB_00101912:
  _err_print_error("skeleton_bone_get_transform_2d","drivers/gles3/storage/mesh_storage.cpp",uVar7,
                   pcVar6,0,0);
  *param_1 = 0x3f800000;
  param_1[1] = 0x3f80000000000000;
  param_1[2] = 0;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::MeshStorage::mesh_surface_update_vertex_region(RID, int, int, Vector<unsigned char>
   const&) */

void __thiscall
GLES3::MeshStorage::mesh_surface_update_vertex_region
          (MeshStorage *this,ulong param_2,uint param_3,int param_4,long param_5)
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x19c))) {
    ...
    if (*(int *)(lVar1 + 0xd0) == (int)(param_2 >> 0x20)) {
      if (*(uint *)(lVar1 + 0x10) <= param_3) {
        _err_print_index_error
                  ("mesh_surface_update_vertex_region","drivers/gles3/storage/mesh_storage.cpp",
                   0x21b,(ulong)param_3,(ulong)*(uint *)(lVar1 + 0x10),"(uint32_t)p_surface",
                   "mesh->surface_count","",false,false);
        return;
      }
      ...
      if (lVar2 == 0) {
        ...
        uVar5 = 0x21f;
        pcVar4 = 
        "Condition \"p_offset + data_size > mesh->surfaces[p_surface]->vertex_buffer_size\" is true."
        ;
      }
      goto LAB_00101a92;
    }
...
LAB_00101a92:
  _err_print_error("mesh_surface_update_vertex_region","drivers/gles3/storage/mesh_storage.cpp",
                   uVar5,pcVar4,0,0);
  return;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::MeshStorage::mesh_surface_update_attribute_region(RID, int, int, Vector<unsigned char>
   const&) */

void __thiscall
GLES3::MeshStorage::mesh_surface_update_attribute_region
          (MeshStorage *this,ulong param_2,uint param_3,int param_4,long param_5)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x19c))) {
    ...
    if (*(int *)(lVar1 + 0xd0) == (int)(param_2 >> 0x20)) {
      if (*(uint *)(lVar1 + 0x10) <= param_3) {
        _err_print_index_error
                  ("mesh_surface_update_attribute_region","drivers/gles3/storage/mesh_storage.cpp",
                   0x22a,(ulong)param_3,(ulong)*(uint *)(lVar1 + 0x10),"(uint32_t)p_surface",
                   "mesh->surface_count","",false,false);
        return;
      }
      lVar2 = *(long *)(param_5 + 8);
      if (lVar2 == 0) {
        ...
        uVar5 = 0x22e;
        pcVar4 = 
        "Condition \"p_offset + data_size > mesh->surfaces[p_surface]->attribute_buffer_size\" is true."
        ;
      }
      goto LAB_00101c62;
    }
  ...
  pcVar4 = "Parameter \"mesh\" is null.";
LAB_00101c62:
  _err_print_error("mesh_surface_update_attribute_region","drivers/gles3/storage/mesh_storage.cpp",
                   uVar5,pcVar4,0,0);
  return;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::MeshStorage::mesh_surface_update_skin_region(RID, int, int, Vector<unsigned char> const&)
    */

void __thiscall
GLES3::MeshStorage::mesh_surface_update_skin_region
          (MeshStorage *this,ulong param_2,uint param_3,int param_4,long param_5)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x19c))) {
    ...
    if (*(int *)(lVar1 + 0xd0) == (int)(param_2 >> 0x20)) {
      if (*(uint *)(lVar1 + 0x10) <= param_3) {
        _err_print_index_error
                  ("mesh_surface_update_skin_region","drivers/gles3/storage/mesh_storage.cpp",0x239,
                   (ulong)param_3,(ulong)*(uint *)(lVar1 + 0x10),"(uint32_t)p_surface",
                   "mesh->surface_count","",false,false);
        return;
      }
      ...
      if (lVar2 == 0) {
        ...
        uVar5 = 0x23d;
        pcVar4 = 
        "Condition \"p_offset + data_size > mesh->surfaces[p_surface]->skin_buffer_size\" is true.";
      }
      goto LAB_00101e32;
    }
    if (*(int *)(lVar1 + 0xd0) + 0x80000000U < 0x7fffffff) {
  ...
  pcVar4 = "Parameter \"mesh\" is null.";
LAB_00101e32:
  _err_print_error("mesh_surface_update_skin_region","drivers/gles3/storage/mesh_storage.cpp",uVar5,
                   pcVar4,0,0);
  return;
}
...
/* GLES3::MeshStorage::_multimesh_set_visible_instances(RID, int) */

void __thiscall
GLES3::MeshStorage::_multimesh_set_visible_instances(MeshStorage *this,ulong param_2,int param_3)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x26c))) {
    lVar5 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x268)) * 0x118 +
            *(long *)(*(long *)(this + 600) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x268)) * 8);
    if (*(int *)(lVar5 + 0x110) == (int)(param_2 >> 0x20)) {
      if ((-2 < param_3) && (iVar1 = *(int *)(lVar5 + 8), param_3 <= iVar1)) {
            ...
            while( true ) {
              ...
              if (uVar2 < (uint)(iVar6 >> 9)) {
                ...
                *(undefined1 *)(lVar5 + 0x48) = 1;
                ...
                _err_print_index_error
                          ("_multimesh_mark_dirty","drivers/gles3/storage/mesh_storage.cpp",0x666,
                           (long)(int)uVar2,(long)(iVar6 >> 9),"region_index",
                           "data_cache_dirty_region_count","",false,false);
              }
              iVar7 = iVar7 + 1;
...
LAB_001020b2:
  _err_print_error("_multimesh_set_visible_instances","drivers/gles3/storage/mesh_storage.cpp",uVar4
                   ,pcVar3,0,0);
  return;
}
...
/* GLES3::MeshStorage::mesh_get_aabb(RID, RID) */

undefined8 *
GLES3::MeshStorage::mesh_get_aabb(undefined8 *param_1,long param_2,ulong param_3,ulong param_4)
    ...
    if (*(int *)(lVar1 + 0xd0) == (int)(param_3 >> 0x20)) {
      ...
      if (cVar9 == '\0') {
        if ((param_4 != 0) && ((uint)param_4 < *(uint *)(param_2 + 0x2cc))) {
          pcVar12 = (char *)(((param_4 & 0xffffffff) % (ulong)*(uint *)(param_2 + 0x2c8)) * 0x90 +
                            *(long *)(*(long *)(param_2 + 0x2b8) +
                                     ((param_4 & 0xffffffff) / (ulong)*(uint *)(param_2 + 0x2c8)) *
                                     8));
          if (*(int *)(pcVar12 + 0x88) == (int)(param_4 >> 0x20)) {
            if ((*(int *)(pcVar12 + 4) != 0) &&
               (lVar19 = *(long *)(pcVar12 + 0x50), *(long *)(lVar1 + 0x48) != lVar19)) {
              local_f8 = 0;
              fStack_f0 = 0.0;
              fStack_ec = 0.0;
              fStack_e8 = 0.0;
              ...
              if (*(int *)(lVar1 + 0x10) != 0) {
                ...
                do {
                  ...
                  fStack_c4 = 0.0;
                  if ((((*(byte *)(lVar5 + 9) & 4) == 0) ||
                      (puVar15 = *(undefined8 **)(lVar5 + 0xc0), puVar15 == (undefined8 *)0x0)) ||
                     (puVar15[-1] == 0)) {
LAB_00102800:
                    auVar4 = *(undefined1 (*) [16])(lVar5 + 0x9c);
                    ...
                    if (iVar10 <= *(int *)(pcVar12 + 4)) {
                      ...
                      if (cVar9 == '\0') {
                        ...
                        do {
                          ...
                          if (((fVar21 != fVar24) || (fVar25 != fVar24)) ||
                             (*(float *)((long)puVar15 + 0x14) != fVar24)) {
                            local_110 = 0.0;
                            lVar13 = 0;
                            ...
                            local_118 = 0;
                            local_108 = 0;
                            local_58 = CONCAT44(*(undefined4 *)((long)puVar2 + 0xc),
                                                *(undefined4 *)(puVar2 + 5));
                            ...
                            uStack_64 = (undefined4)
                                        ((ulong)*(undefined8 *)((long)puVar2 + 0x14) >> 0x20);
                            uStack_50 = CONCAT44(*(undefined4 *)((long)puVar2 + 0x2c),
                                                 *(undefined4 *)((long)puVar2 + 0x1c));
                            local_98 = *puVar15;
                            fStack_90 = (float)*(undefined4 *)(puVar15 + 1);
                            local_128 = CONCAT44((float)((ulong)*puVar15 >> 0x20) + fVar25,
                                                 (float)*puVar15 + fVar21);
                            ...
                            local_110 = 0.0;
                            local_108 = local_b8;
                            local_138 = CONCAT44(((float)uVar8 - fVar23) + fVar23,
                            ...
                            do {
                              ...
                              fVar25 = fVar21;
                              do {
                                fVar23 = *(float *)((long)&local_108 + lVar13) *
                                         *(float *)(pAVar18 + lVar13);
                                fVar22 = *(float *)(pAVar18 + lVar13) *
...
LAB_0010266e:
                        if (cVar16 != '\0') {
                          ...
                          local_100 = 0.0;
                          local_128 = CONCAT44(fStack_c8 + (float)((ulong)local_d8 >> 0x20),
                                               fStack_cc + (float)local_d8);
                          ...
                          do {
                            ...
                            fVar21 = fVar24;
                            do {
                              fVar26 = *(float *)((long)&local_b8 + lVar17) *
                                       *(float *)(pAVar18 + lVar17);
                              fVar23 = *(float *)(pAVar18 + lVar17) *
                                       *(float *)((long)&local_128 + lVar17);
                              fVar25 = fVar23;
                              if (fVar26 < fVar23) {
                                fVar25 = fVar26;
                                fVar26 = fVar23;
                          ...
                          fStack_c8 = (float)((ulong)local_108 >> 0x20) -
                        ...
                        if (0 < iVar10) {
                          ...
                          puVar3 = puVar15 + (ulong)(iVar10 - 1) * 3 + 3;
                          do {
                            if (((*(float *)((long)puVar15 + 0xc) != fVar24) ||
                                (*(float *)(puVar15 + 2) != fVar24)) ||
                               (*(float *)((long)puVar15 + 0x14) != fVar24)) {
                              uStack_70 = 0;
                              puVar2 = (undefined8 *)(lVar14 + (long)iVar20 * 4);
                              uStack_64 = 0;
                              ...
                              local_98 = *puVar15;
                              fStack_90 = (float)*(undefined4 *)(puVar15 + 1);
                              local_128 = CONCAT44((float)((ulong)*puVar15 >> 0x20) +
                                                   *(float *)(puVar15 + 2),
                                                   (float)*puVar15 + *(float *)((long)puVar15 + 0xc)
                                                  );
                              local_120 = *(float *)((long)puVar15 + 0x14) + *(float *)(puVar15 + 1)
                              ;
                              lVar17 = lVar5;
                              ...
                              do {
                                ...
                                do {
                                  fVar23 = *(float *)((long)&local_108 + lVar13) *
                                           *(float *)(pAVar18 + lVar13);
                                  fVar22 = *(float *)((long)&local_138 + lVar13) *
                                           *(float *)(pAVar18 + lVar13);
                                  fVar26 = fVar22;
                                  if (fVar23 < fVar22) {
                                    fVar26 = fVar23;
...
LAB_001027d0:
                        if ((fStack_c8 == 0.0) && (fStack_c4 == 0.0)) goto LAB_00102800;
                      }
                      if ((int)lVar19 != 0) goto LAB_00102828;
                      goto LAB_001026a0;
                    }
                    _err_print_error("mesh_get_aabb","drivers/gles3/storage/mesh_storage.cpp",0x2be,
                                     "Condition \"bs > sbs\" is true. Continuing.",0);
                  }
                  lVar19 = lVar19 + 1;
  ...
  _err_print_error("mesh_get_aabb","drivers/gles3/storage/mesh_storage.cpp",0x2a6,
                   "Parameter \"mesh\" is null.",0,0);
  *param_1 = 0;
  *(undefined4 *)(param_1 + 1) = 0;
  *(undefined8 *)((long)param_1 + 0xc) = 0;
...
/* GLES3::MeshStorage::mesh_instance_check_for_update(RID) */

undefined1  [16] __thiscall
GLES3::MeshStorage::mesh_instance_check_for_update(MeshStorage *this,ulong param_2)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 500))) {
    ...
    uVar7 = uVar8 * 0x15;
    lVar2 = *(long *)(*(long *)(this + 0x1e0) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x1f0)) * 8) + uVar8 * 0xa8;
...
LAB_00102f38:
        ...
        if (*(long *)(lVar2 + 8) != 0) {
          ...
          if ((uint)uVar3 < *(uint *)(this + 0x2cc)) {
            uVar8 = (uVar8 % (ulong)*(uint *)(this + 0x2c8)) * 0x90 +
                    *(long *)(*(long *)(this + 0x2b8) + (uVar8 / *(uint *)(this + 0x2c8)) * 8);
            if (*(int *)(uVar8 + 0x88) == (int)(uVar3 >> 0x20)) {
              uVar7 = *(ulong *)(lVar2 + 0x38);
              if (*(ulong *)(uVar8 + 0x50) != uVar7) {
                if (*(long *)(lVar2 + 0x68) != 0) {
                  auVar10 = _err_print_error(&_LC77,"./core/templates/self_list.h",0x2e,
...
/* CowData<AABB>::_ref(CowData<AABB> const&) [clone .part.0] */

void __thiscall CowData<AABB>::_ref(CowData<AABB> *this,CowData *param_1)
...
/* GLES3::MeshStorage::mesh_surface_set_material(RID, int, RID) */

void __thiscall
GLES3::MeshStorage::mesh_surface_set_material
          (MeshStorage *this,ulong param_2,uint param_3,undefined8 param_4)

{
  ...
  if (param_2 != 0) {
    if ((uint)param_2 < *(uint *)(this + 0x19c)) {
      lVar2 = *(long *)(*(long *)(this + 0x188) +
                       ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x198)) * 8) +
              ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x198)) * 0xd8;
      if (*(int *)(lVar2 + 0xd0) == (int)(param_2 >> 0x20)) {
        if (*(uint *)(lVar2 + 0x10) <= param_3) {
          _err_print_index_error
                    ("mesh_surface_set_material","drivers/gles3/storage/mesh_storage.cpp",0x248,
                     (ulong)param_3,(ulong)*(uint *)(lVar2 + 0x10),"(uint32_t)p_surface",
                     "mesh->surface_count","",false,false);
          return;
        }
  ...
  _err_print_error("mesh_surface_set_material","drivers/gles3/storage/mesh_storage.cpp",0x247,
                   "Parameter \"mesh\" is null.",0,0);
  return;
}
...
/* GLES3::MeshStorage::mesh_get_path(RID) const */

CowData<char32_t> *
GLES3::MeshStorage::mesh_get_path(CowData<char32_t> *param_1,long param_2,ulong param_3)

{
  ...
  _err_print_error("mesh_get_path","drivers/gles3/storage/mesh_storage.cpp",0x325,
                   "Parameter \"mesh\" is null.",0,0);
  *(undefined8 *)param_1 = 0;
  return param_1;
}
...
/* GLES3::MeshStorage::mesh_set_path(RID, String const&) */

void __thiscall GLES3::MeshStorage::mesh_set_path(MeshStorage *this,ulong param_2,CowData *param_3)

{
  ...
  _err_print_error("mesh_set_path","drivers/gles3/storage/mesh_storage.cpp",0x31e,
                   "Parameter \"mesh\" is null.",0,0);
  return;
}
...
/* GLES3::MeshStorage::_multimesh_get_interpolator(RID) const */

long __thiscall GLES3::MeshStorage::_multimesh_get_interpolator(MeshStorage *this,ulong param_2)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x26c))) {
    lVar3 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x268)) * 0x118 +
            *(long *)(*(long *)(this + 600) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x268)) * 8);
  ...
  itos((long)&local_30);
  operator+((char *)&local_28,(String *)"Multimesh not found: ");
  _err_print_error("_multimesh_get_interpolator","drivers/gles3/storage/mesh_storage.cpp",0x86a,
                   "Parameter \"multimesh\" is null.",&local_28,0,0);
  lVar3 = local_28;
  if (local_28 != 0) {
    LOCK();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::MeshStorage::_multimesh_set_mesh(RID, RID) */

void __thiscall
GLES3::MeshStorage::_multimesh_set_mesh(MeshStorage *this,ulong param_2,long param_3)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x26c))) {
    plVar11 = (long *)(((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x268)) * 0x118 +
                      *(long *)(*(long *)(this + 600) +
                               ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x268)) * 8));
      ...
      if (((*plVar11 == param_3) || (param_3 == 0)) || (*plVar11 = param_3, (int)plVar11[1] == 0)) {
        ...
        if ((plVar11[0xc] == 0) || (*(long *)(plVar11[0xc] + -8) == 0)) {
          if (*(char *)((long)plVar11 + 0x49) != '\0') {
            GLES3::Utilities::buffer_get_data
                      ((uint)local_128,0x8892,*(uint *)((long)plVar11 + 0x74));
            lVar5 = local_120;
            lVar4 = plVar11[1];
            if (*plVar11 == 0) {
              _err_print_error("_multimesh_re_create_aabb","drivers/gles3/storage/mesh_storage.cpp",
                               0x690,"Condition \"multimesh->mesh.is_null()\" is true.",0,0);
            }
            else {
              local_78 = 0;
              uStack_74 = 0;
              ...
              if (cVar6 == '\0') {
                ...
                if (0 < (int)lVar4) {
                  iVar10 = 0;
                  uVar16 = __LC96;
                  uVar17 = _UNK_00125778;
                  do {
                    uStack_70 = (undefined4)((ulong)uVar16 >> 0x20);
                    local_54[2] = 0.0;
                    puVar2 = (undefined8 *)
                             (lVar5 + (ulong)(uint)(iVar10 * *(int *)((long)plVar11 + 0x4c)) * 4);
                    ...
                    local_f0 = 0.0;
                    local_110 = local_b0;
                    local_108 = CONCAT44((float)((ulong)local_ac >> 0x20) +
                                         (float)((ulong)local_b8 >> 0x20),
                                         (float)local_ac + (float)local_b8);
                    local_e8[0] = 0.0;
                    local_e8[1] = 0.0;
                    local_e8[2] = 0.0;
                    local_118 = local_b8;
  ...
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    _err_print_error("_multimesh_set_mesh","drivers/gles3/storage/mesh_storage.cpp",0x628,
                     "Parameter \"multimesh\" is null.",0,0);
    return;
  }
LAB_0010433c:
...
undefined8 GLES3::MeshStorage::get_singleton(void)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::MeshStorage::MeshStorage() */

void __thiscall GLES3::MeshStorage::MeshStorage(MeshStorage *this)

{
  ...
  *(undefined ***)this = &PTR__MeshStorage_00122470;
  ...
  *(undefined ***)(this + 0x48) = &PTR__init_001223c8;
  *(undefined8 *)(this + 0x178) = 0;
  *(undefined ***)(this + 0x180) = &PTR__RID_Alloc_001223f0;
  ...
  *(undefined ***)(this + 0x1d8) = &PTR__RID_Alloc_00122410;
  ...
  *(undefined ***)(this + 0x250) = &PTR__RID_Alloc_00122430;
  ...
  *(undefined ***)(this + 0x2b0) = &PTR__RID_Alloc_00122450;
  uVar2 = _UNK_001257b8;
  uVar4 = __LC100;
...
/* GLES3::MeshStorage::mesh_free(RID) */

ulong __thiscall GLES3::MeshStorage::mesh_free(MeshStorage *this,ulong param_2)

{
    ...
    if (uVar4 < *(uint *)(this + 0x19c)) {
      ...
      if (*(int *)(lVar8 + 0xd0) == iVar6) {
        ...
        if ((*(long *)(lVar8 + 0x60) == 0) || (*(int *)(*(long *)(lVar8 + 0x60) + 0x10) == 0)) {
          ...
          _err_print_error("mesh_free","drivers/gles3/storage/mesh_storage.cpp",0x4e,
                           "deleting mesh with active instances",0,0);
          iVar2 = *(int *)(lVar8 + 0x94);
        }
        if (iVar2 != 0) {
        ...
        if (iVar2 == 0) {
          if (uVar4 < *(uint *)(this + 0x19c)) {
            ...
            if (iVar2 < 0) {
              ...
              uVar5 = 0;
              _err_print_error(&_LC111,"./core/templates/rid_owner.h",0x16c,
              ...
              Mesh::~Mesh(this_00);
              lVar7 = *(long *)(this + 400);
              *(undefined4 *)(*(long *)(*(long *)(this + 0x188) + uVar5 * 8) + 0xd0 + lVar8) =
                   0xffffffff;
              uVar3 = *(int *)(this + 0x1a0) - 1;
              *(uint *)(this + 0x1a0) = uVar3;
              *(uint *)(*(long *)(lVar7 + ((ulong)uVar3 / (ulong)*(uint *)(this + 0x198)) * 8) +
                       ((ulong)uVar3 % (ulong)*(uint *)(this + 0x198)) * 4) = uVar4;
              uVar4 = pthread_mutex_unlock(__mutex);
              uVar5 = (ulong)uVar4;
            }
            else {
              pthread_mutex_unlock(__mutex);
              uVar5 = _err_print_error(&_LC111,"./core/templates/rid_owner.h",0x171,
                                       "Method/function failed.",0,0);
            }
          }
          else {
            pthread_mutex_unlock(__mutex);
            uVar5 = _err_print_error(&_LC111,"./core/templates/rid_owner.h",0x161,
                                     "Method/function failed.",0,0);
          }
          return uVar5;
        }
  ...
  uVar5 = _err_print_error("mesh_free","drivers/gles3/storage/mesh_storage.cpp",0x4a,
                           "Parameter \"mesh\" is null.",0,0);
  return uVar5;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::MeshStorage::_mesh_surface_generate_version_for_input_mask(GLES3::Mesh::Surface::Version&,
   GLES3::Mesh::Surface*, unsigned long, GLES3::MeshInstance::Surface*) */

void __thiscall
GLES3::MeshStorage::_mesh_surface_generate_version_for_input_mask
          (MeshStorage *this,Version *param_1,Surface *param_2,ulong param_3,Surface *param_4)
    ...
    for (; (uVar1 >> (uVar2 & 0x3f) & 1) != 0; uVar2 = uVar2 + 1) {
      ...
      *pbVar3 = *pbVar3 & 1;
      if ((uint)uVar2 < 0xc) {
                    ...
                    /* WARNING: Treating indirect jump as call */
        (*(code *)((long)&DAT_0011c034 + (long)(int)(&DAT_0011c034)[uVar2 & 0xffffffff]))();
        return;
      }
      local_174 = 0;
      local_17c = 0;
    ...
    if (uVar2 == 0xc) {
      ...
      do {
        ...
        while( true ) {
          while( true ) {
            if (pbVar4[1] == 0) {
              (*_glad_glVertexAttribPointer)
                        (iVar5,*(undefined4 *)(pbVar4 + 4),*(undefined4 *)(pbVar4 + 8),pbVar4[0xc],
                         local_1dc,*(undefined4 *)(pbVar4 + 0x14));
            }
            else {
              (*_glad_glVertexAttribIPointer)
                        (iVar5,*(undefined4 *)(pbVar4 + 4),*(undefined4 *)(pbVar4 + 8),local_1dc);
            }
            ...
            while( true ) {
              ...
              if (*pbVar4 != 0) break;
LAB_00104d88:
              (*_glad_glDisableVertexAttribArray)(iVar5);
            }
            if (iVar5 < 3) break;
            if (iVar5 < 10) {
...
LAB_00104e88:
          (*_glad_glBindBuffer)(0x8892,*(undefined4 *)(param_2 + 0x10));
        }
      } while( true );
    }
  } while( true );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::MeshStorage::_blend_shape_bind_mesh_instance_buffer(GLES3::MeshInstance*, unsigned int) */

void __thiscall
GLES3::MeshStorage::_blend_shape_bind_mesh_instance_buffer
          (MeshStorage *this,MeshInstance *param_1,uint param_2)
  ...
  if (param_2 < *(uint *)(param_1 + 0x10)) {
    ...
    if (param_2 < *(uint *)(param_1 + 0x10)) {
      if ((*(byte *)(*(long *)(param_1 + 0x18) + 0x28 + lVar3) & 1) == 0) {
        ...
        (*_glad_glVertexAttribPointer)
                  (0,*(undefined4 *)(*(long *)(param_1 + 0x18) + lVar3 + 0x18),0x1406,0,
                   *(undefined4 *)(*(long *)(param_1 + 0x18) + lVar3 + 0x14),0);
      }
      uVar2 = (ulong)*(uint *)(param_1 + 0x10);
      if (param_2 < *(uint *)(param_1 + 0x10)) {
        if ((*(byte *)(*(long *)(param_1 + 0x18) + 0x28 + lVar3) & 2) == 0) {
          ...
          if (*(uint *)(param_1 + 0x10) <= param_2) goto LAB_0010517e;
          (*_glad_glVertexAttribIPointer)
                    (1,2,0x1405,*(undefined4 *)(*(long *)(param_1 + 0x18) + lVar3 + 0x14),
                     (long)*(int *)(*(long *)(param_1 + 0x18) + lVar3 + 0x1c));
        }
        uVar2 = (ulong)*(uint *)(param_1 + 0x10);
        if (param_2 < *(uint *)(param_1 + 0x10)) {
          ...
          if (param_2 < *(uint *)(param_1 + 0x10)) {
                    ...
                    /* WARNING: Treating indirect jump as call */
            (*_glad_glVertexAttribIPointer)
                      (2,2,0x1405,*(undefined4 *)(*(long *)(param_1 + 0x18) + lVar3 + 0x14),
                       (long)*(int *)(*(long *)(param_1 + 0x18) + lVar3 + 0x20),
                       _glad_glVertexAttribIPointer);
            return;
          }
        }
...
LAB_0010517e:
  _err_print_index_error
            ("operator[]","./core/templates/local_vector.h",0xb2,(ulong)param_2,uVar2,"p_index",
             "count","",false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::MeshStorage::_compute_skeleton(GLES3::MeshInstance*, GLES3::Skeleton*, unsigned int) */

void __thiscall
GLES3::MeshStorage::_compute_skeleton
          (MeshStorage *this,MeshInstance *param_1,Skeleton *param_2,uint param_3)

{
  ...
  uVar3 = (ulong)param_3;
  (*_glad_glBindBuffer)
            (0x8892,*(undefined4 *)(*(long *)(*(long *)(*(long *)param_1 + 8) + uVar3 * 8) + 0x18));
  ...
  if (param_3 < uVar1) {
    ...
    if (param_3 < uVar1) {
      (*_glad_glBindBufferBase)
                (0x8c8e,0,*(undefined4 *)(*(long *)(param_1 + 0x18) + 0x10 + uVar3 * 0x40));
      (*_glad_glActiveTexture)(0x84c0);
      (*_glad_glBindTexture)(0xde1,*(undefined4 *)(param_2 + 0x48));
      (*_glad_glBeginTransformFeedback)(0);
      (*_glad_glDrawArrays)
                (0,0,*(undefined4 *)(*(long *)(*(long *)(*(long *)param_1 + 8) + uVar3 * 8) + 0x1c))
      ;
      (*_glad_glEndTransformFeedback)();
      (*_glad_glDisableVertexAttribArray)(10);
      (*_glad_glDisableVertexAttribArray)(0xb);
      (*_glad_glDisableVertexAttribArray)(0xc);
      (*_glad_glDisableVertexAttribArray)(0xd);
      (*_glad_glBindVertexArray)(0);
  ...
  _err_print_index_error
            ("operator[]","./core/templates/local_vector.h",0xb2,uVar3,(ulong)uVar1,"p_index",
             "count","",false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar2 = (code *)invalidInstructionException();
...
void __thiscall GLES3::MeshStorage::_update_dirty_multimeshes(MeshStorage *this)
...
LAB_00105943:
            ...
            do {
              if (*(char *)(plVar17[0xd] + lVar13) != '\0') {
                ...
                (*_glad_glBufferSubData)
                          (0x8892,(long)iVar16,(long)iVar8,
                           lVar3 + (ulong)(uint)(*(int *)((long)plVar17 + 0x4c) * (int)lVar13 *
                                                0x200) * 4);
              }
              lVar13 = lVar13 + 1;
            ...
            if (*plVar17 == 0) {
              ...
              if (cVar7 == '\0') {
                ...
                if (0 < iVar12) {
                  ...
                  iVar18 = 0;
                  uVar26 = __LC96;
                  uVar27 = _UNK_00125778;
                  do {
                    uStack_70 = (undefined4)((ulong)uVar26 >> 0x20);
                    local_54[2] = 0.0;
                    puVar1 = (undefined8 *)
                             (lVar3 + (ulong)(uint)(iVar18 * *(int *)((long)plVar17 + 0x4c)) * 4);
                    ...
                    if (iVar18 == 0) {
                      do {
                        ...
                        fVar23 = fVar25;
                        do {
                          fVar24 = *(float *)((long)&local_118 + lVar9) *
                                   *(float *)(pAVar14 + lVar9);
                          fVar21 = *(float *)(pAVar14 + lVar9) *
                                   *(float *)((long)&local_108 + lVar9);
                          fVar4 = fVar24;
                          if (fVar24 < fVar21) {
                            fVar4 = fVar21;
                            fVar21 = fVar24;
...
/* GLES3::MeshStorage::_multimesh_free(RID) */

ulong __thiscall GLES3::MeshStorage::_multimesh_free(MeshStorage *this,ulong param_2)

{
  ...
  if (param_2 != 0) {
    if (uVar5 < *(uint *)(this + 0x26c)) {
      lVar8 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x268)) * 0x118 +
              *(long *)(*(long *)(this + 600) +
                       ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x268)) * 8);
  ...
  if (iVar3 == 0) {
    if (uVar5 < *(uint *)(this + 0x26c)) {
      ...
      if (*(int *)(lVar8 + 0x110) < 0) {
        pthread_mutex_unlock(__mutex);
        uVar6 = 0;
        _err_print_error(&_LC111,"./core/templates/rid_owner.h",0x16c,"Method/function failed.",
                         "Attempted to free an uninitialized or invalid RID",0);
      }
        ...
        *(uint *)(*(long *)(lVar8 + ((ulong)uVar4 / (ulong)*(uint *)(this + 0x268)) * 8) +
        ...
        pthread_mutex_unlock(__mutex);
        uVar6 = _err_print_error(&_LC111,"./core/templates/rid_owner.h",0x171,
                                 "Method/function failed.",0,0);
      }
    }
    else {
      pthread_mutex_unlock(__mutex);
      uVar6 = _err_print_error(&_LC111,"./core/templates/rid_owner.h",0x161,
                               "Method/function failed.",0,0);
    }
    return uVar6;
  }
...
/* GLES3::MeshStorage::_multimesh_get_aabb(RID) */

undefined8 *
GLES3::MeshStorage::_multimesh_get_aabb(undefined8 *param_1,MeshStorage *param_2,ulong param_3)

{
  ...
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  if ((param_3 != 0) && ((uint)param_3 < *(uint *)(param_2 + 0x26c))) {
    lVar4 = ((param_3 & 0xffffffff) % (ulong)*(uint *)(param_2 + 0x268)) * 0x118 +
            *(long *)(*(long *)(param_2 + 600) +
                     ((param_3 & 0xffffffff) / (ulong)*(uint *)(param_2 + 0x268)) * 8);
  ...
  _err_print_error("_multimesh_get_aabb","drivers/gles3/storage/mesh_storage.cpp",0x731,
                   "Parameter \"multimesh\" is null.",0,0);
  *param_1 = 0;
  *(undefined4 *)(param_1 + 1) = 0;
  *(undefined8 *)((long)param_1 + 0xc) = 0;
...
void __thiscall GLES3::MeshStorage::_update_dirty_skeletons(MeshStorage *this)

{
  ...
  while (lVar1 != 0) {
    if (*(int *)(lVar1 + 4) != 0) {
      ...
      (*_glad_glTexImage2D)
                (0xde1,0,0x8814,0x100,*(undefined4 *)(lVar1 + 8),0,0x1908,0x1406,
...
/* GLES3::MeshStorage::skeleton_free(RID) */

void __thiscall GLES3::MeshStorage::skeleton_free(MeshStorage *this,ulong param_2)
  ...
  if (iVar2 == 0) {
    if (uVar4 < *(uint *)(this + 0x2cc)) {
      ...
      if (*(int *)(lVar7 + 0x88) < 0) {
        ...
        *(uint *)(*(long *)(lVar7 + ((ulong)uVar3 / (ulong)*(uint *)(this + 0x2c8)) * 8) +
                 ((ulong)uVar3 % (ulong)*(uint *)(this + 0x2c8)) * 4) = uVar4;
        pthread_mutex_unlock(__mutex);
      }
      else {
        pthread_mutex_unlock(__mutex);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::MeshStorage::update_mesh_instances() [clone .part.0] */

void __thiscall GLES3::MeshStorage::update_mesh_instances(MeshStorage *this)
...
LAB_0010649e:
  pMVar5 = *(MeshInstance **)(pMVar13 + 8);
  if (*(long *)(pMVar5 + 8) != 0) {
    uVar41 = *(ulong *)(pMVar5 + 8);
    if (*(uint *)(this + 0x2cc) <= (uint)uVar41) goto LAB_00109d5f;
    local_160 = (Skeleton *)
                (((uVar41 & 0xffffffff) % (ulong)*(uint *)(this + 0x2c8)) * 0x90 +
                *(long *)(*(long *)(this + 0x2b8) +
                         ((uVar41 & 0xffffffff) / (ulong)*(uint *)(this + 0x2c8)) * 8));
...
LAB_00106560:
    do {
      ...
      uVar20 = (uint)uVar41;
      uVar34 = **(uint **)pMVar5;
      if (((local_160 == (Skeleton *)0x0) || ((Skeleton)((uVar19 & 0x2000000) != 0) != *local_160))
         || ((uVar19 & 0x400) == 0)) {
        if (uVar34 != 0) {
          bVar9 = false;
          goto LAB_001065d0;
...
LAB_001065d0:
        ...
        uVar24 = ((uVar21 & 0xffffffff) % (ulong)*(uint *)(this + 0x98)) * 0x80 +
                 *(long *)(*(long *)(this + 0x88) +
                          ((uVar21 & 0xffffffff) / (ulong)*(uint *)(this + 0x98)) * 8);
        iVar10 = *(int *)(uVar24 + 0x78);
        if (iVar10 != (int)(uVar21 >> 0x20)) goto LAB_0010953f;
        if ((*(int *)(uVar24 + 0x68) == 0) &&
           (ShaderGLES3::_initialize_version(pVVar1), *(int *)(uVar24 + 0x68) == 0))
        goto LAB_00106fb7;
        uVar33 = local_108;
        ...
        if (uVar27 != 0) {
          ...
          while ((uVar27 != (uint)uVar22 || (local_108 != *(ulong *)(plVar6[1] + uVar21 * 8)))) {
            ...
            uVar27 = *(uint *)(lVar17 + uVar21 * 4);
            if ((uVar27 == 0) || (((uVar34 + (int)uVar21) - uVar27 % uVar34) % uVar34 < uVar32))
            goto LAB_00109630;
          }
...
LAB_00109630:
        ...
        ShaderGLES3::_compile_specialization
                  ((Specialization *)pVVar1,(uint)(Specialization *)local_f8,(Version *)0x0,uVar24);
        if ((*(int *)(uVar24 + 0x68) == 0) ||
           (OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
            ::insert(*(OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                       **)(uVar24 + 0x70),&local_108,(Specialization *)local_f8),
        ...
        if (uVar27 != 0) {
          uVar32 = 0;
LAB_0010973a:
          if ((uVar27 != (uint)uVar22) || (uVar33 != *(ulong *)(plVar6[1] + uVar21 * 8)))
          goto LAB_00109700;
          puVar23 = (undefined4 *)(*plVar6 + uVar21 * 0x38);
...
LAB_00106833:
          if (puVar23 == (undefined4 *)0x0) goto LAB_00106e70;
LAB_0010683c:
          ...
          if (*(int *)(this + 0x118) < 1) {
            _err_print_index_error
                      ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe4,0,
                       (long)*(int *)(this + 0x118),"p_which","uniform_count","",false,false);
            goto LAB_00106ae0;
          }
...
LAB_00109804:
            ...
            lVar17 = ((uVar21 & 0xffffffff) % (ulong)*(uint *)(this + 0x98)) * 0x80 +
                     *(long *)(*(long *)(this + 0x88) +
                              ((uVar21 & 0xffffffff) / (ulong)*(uint *)(this + 0x98)) * 8);
            ...
            if (*(int *)(lVar17 + 0x68) < 1) {
              _err_print_index_error
                        ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe7,0,
                         (long)*(int *)(lVar17 + 0x68),"p_variant","int(version->variants.size())",
                         "",false,false);
              goto LAB_00106ae0;
            }
...
LAB_00109e5f:
              ...
              while ((uVar27 != (uint)uVar33 || (uVar16 != *(ulong *)(plVar6[1] + uVar24 * 8)))) {
                ...
                uVar27 = *(uint *)(plVar6[2] + uVar24 * 4);
                if ((uVar27 == 0) || (((uVar34 + (int)uVar24) - uVar27 % uVar34) % uVar34 < uVar32))
                goto LAB_00109e5f;
              }
...
LAB_0010a143:
                  ...
                  if (*(int *)(lVar17 + 0x68) < 1) {
                    _err_print_index_error
                              ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe7,0,
                               (long)*(int *)(lVar17 + 0x68),"p_variant",
...
LAB_0010aaf1:
                  ...
                  while ((uVar27 != (uint)uVar33 || (uVar16 != *(ulong *)(plVar6[1] + uVar21 * 8))))
                  {
                    ...
                    uVar27 = *(uint *)(plVar6[2] + uVar21 * 4);
                    if ((uVar27 == 0) ||
                       (((uVar34 + (int)uVar21) - uVar27 % uVar34) % uVar34 < uVar32))
                    goto LAB_0010aaf1;
                  }
...
LAB_00109eca:
              ...
              while ((uVar32 != (uint)uVar33 || (uVar16 != *(ulong *)(plVar6[1] + uVar24 * 8)))) {
                ...
                uVar32 = *(uint *)(plVar6[2] + uVar24 * 4);
                if ((uVar32 == 0) || (((uVar27 + (int)uVar24) - uVar32 % uVar27) % uVar27 < uVar28))
                goto LAB_00109eca;
              }
              lVar17 = *plVar6 + uVar24 * 0x38;
...
LAB_0010aac7:
                  ...
                  while ((uVar32 != (uint)uVar33 || (uVar16 != *(ulong *)(plVar6[1] + uVar21 * 8))))
                  {
                    ...
                    uVar32 = *(uint *)(plVar6[2] + uVar21 * 4);
                    if ((uVar32 == 0) ||
                       (((uVar27 + (int)uVar21) - uVar32 % uVar27) % uVar27 < uVar28))
                    goto LAB_0010aac7;
                  }
                  lVar17 = *plVar6 + uVar21 * 0x38;
...
LAB_00106e21:
          ...
          (*_glad_glBeginTransformFeedback)(0);
          (*_glad_glDrawArrays)
                    (0,0,*(undefined4 *)(*(long *)(*(long *)(*(long *)pMVar5 + 8) + lVar17) + 0x1c))
          ;
          (*_glad_glEndTransformFeedback)();
          iVar10 = *(int *)(this + 0x168);
          uVar21 = *(ulong *)(this + 0x178);
          ...
          uVar33 = *(long *)(*(long *)(this + 0x88) +
                            ((uVar21 & 0xffffffff) / (ulong)*(uint *)(this + 0x98)) * 8) +
                   ((uVar21 & 0xffffffff) % (ulong)*(uint *)(this + 0x98)) * 0x80;
...
LAB_001099cf:
            ...
            local_88 = 0;
            ShaderGLES3::_compile_specialization
                      ((Specialization *)pVVar1,uVar32,(Version *)0x1,uVar33);
            uVar24 = (ulong)*(uint *)(uVar33 + 0x68);
            if (*(uint *)(uVar33 + 0x68) < 2) goto LAB_00109bb4;
            OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
            ::insert((OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                      *)(*(long *)(uVar33 + 0x70) + 0x20),local_f8,(Specialization *)local_b8);
            uVar24 = (ulong)*(uint *)(uVar33 + 0x68);
            if (*(uint *)(uVar33 + 0x68) < 2) goto LAB_00109bb4;
            lVar35 = *(long *)(uVar33 + 0x70);
            uVar34 = *(uint *)(lVar35 + 0x38);
            ...
            if (uVar27 != 0) {
              uVar28 = 0;
              do {
                if ((uVar27 == (uint)uVar22) &&
                   (uVar21 == *(ulong *)(*(long *)(lVar35 + 0x28) + uVar24 * 8))) {
                ...
                uVar27 = *(uint *)(*(long *)(lVar35 + 0x30) + uVar24 * 4);
                      ...
                      (uVar28 <= ((uVar34 + (int)uVar24) - uVar27 % uVar34) % uVar34));
            }
            if (this[0xe8] != (MeshStorage)0x0) {
              ShaderGLES3::_save_to_cache(pVVar1);
              ShaderGLES3::Version::Specialization::~Specialization((Specialization *)local_b8);
          ...
          uVar28 = 0;
          while ((uVar27 != (uint)uVar22 ||
                 (local_f8[0] != *(ulong *)(*(long *)(lVar35 + 0x28) + uVar24 * 8)))) {
            uVar28 = uVar28 + 1;
            uVar24 = (ulong)((int)uVar24 + 1) % uVar36;
            uVar27 = *(uint *)(lVar12 + uVar24 * 4);
            if ((uVar27 == 0) || (((uVar34 + (int)uVar24) - uVar27 % uVar34) % uVar34 < uVar28))
            goto LAB_001099cf;
          }
          puVar23 = (undefined4 *)(*(long *)(lVar35 + 0x20) + uVar24 * 0x38);
          ...
          if (*(char *)(puVar23 + 0xc) != '\0') {
            ...
            if (uVar27 == 0) goto LAB_00106e70;
            while ((uVar27 != (uint)uVar24 ||
                   (*(long *)(this + 0x158) != *(long *)(*(long *)(lVar35 + 0x28) + uVar21 * 8)))) {
              uVar28 = uVar28 + 1;
              uVar21 = (ulong)((int)uVar21 + 1) % uVar36;
              uVar27 = *(uint *)(lVar12 + uVar21 * 4);
              if ((uVar27 == 0) || (((uVar34 + (int)uVar21) - uVar27 % uVar34) % uVar34 < uVar28))
              goto LAB_00106e70;
            }
          ...
          if (_LC132 <= ABS(*(float *)(*(long *)(pMVar5 + 0x28) + uVar36 * 4))) {
            ...
            if (*(int *)(this + 0x118) < 1) {
              ...
              if ((uVar21 != 0) && ((uint)uVar21 < *(uint *)pMVar3)) {
                lVar35 = ((uVar21 & 0xffffffff) % (ulong)*(uint *)(this + 0x98)) * 0x80 +
                         *(long *)(*(long *)(this + 0x88) +
                                  ((uVar21 & 0xffffffff) / (ulong)*(uint *)(this + 0x98)) * 8);
                  ...
                  if (*(int *)(lVar35 + 0x68) < 2) {
                    _err_print_index_error
                              ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe7,1,
                               (long)*(int *)(lVar35 + 0x68),"p_variant",
                               "int(version->variants.size())","",false,false);
                  }
                  else {
                    ...
                    if (uVar28 != 0) {
                      uVar29 = 0;
                      while ((uVar28 != uVar34 ||
                             (uVar16 != *(ulong *)(*(long *)(lVar35 + 0x28) + uVar24 * 8)))) {
                        uVar29 = uVar29 + 1;
                        uVar24 = (ulong)((int)uVar24 + 1) % (ulong)uVar27;
                        uVar28 = *(uint *)(*(long *)(lVar35 + 0x30) + uVar24 * 4);
                        if ((uVar28 == 0) ||
                           (((uVar27 + (int)uVar24) - uVar28 % uVar27) % uVar27 < uVar29))
                        goto LAB_00109f35;
                      }
                      ...
                      if (lVar35 != 0) {
                        ...
                        if (*(int *)(this + 0x118) < 1) {
                          _err_print_index_error
                                    ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe4,0,
                                     (long)*(int *)(this + 0x118),"p_which","uniform_count","",false
                                     ,false);
                          goto LAB_0010a113;
                        }
                        if ((uint)uVar21 < *(uint *)pMVar3) {
                          lVar35 = ((uVar21 & 0xffffffff) % (ulong)*(uint *)(this + 0x98)) * 0x80 +
                                   *(long *)(*(long *)(this + 0x88) +
                                            ((uVar21 & 0xffffffff) / (ulong)*(uint *)(this + 0x98))
                                            * 8);
                          if (iVar10 == *(int *)(lVar35 + 0x78)) {
                            if (*(int *)(lVar35 + 0x68) < 2) {
                              _err_print_index_error
                                        ("_version_get_uniform","./drivers/gles3/shader_gles3.h",
                                         0xe7,1,(long)*(int *)(lVar35 + 0x68),"p_variant",
                                         "int(version->variants.size())","",false,false);
                              goto LAB_0010a113;
                            }
                            lVar35 = *(long *)(lVar35 + 0x70);
...
LAB_00109590:
      ...
      uVar19 = ((uVar24 & 0xffffffff) % (ulong)*(uint *)(this + 0x98)) * 0x80 +
               *(long *)(*(long *)(this + 0x88) +
                        ((uVar24 & 0xffffffff) / (ulong)*(uint *)(this + 0x98)) * 8);
      iVar10 = *(int *)(uVar19 + 0x78);
      if (iVar10 != (int)(uVar24 >> 0x20)) goto LAB_0010953f;
      uVar24 = uVar19;
      if ((*(int *)(uVar19 + 0x68) == 0) &&
         (ShaderGLES3::_initialize_version(pVVar1), *(int *)(uVar19 + 0x68) == 0)) {
LAB_00106fb7:
        uVar21 = 0;
        uVar24 = 0;
LAB_00106fd7:
        _err_print_index_error
                  ("operator[]","./core/templates/local_vector.h",0xb2,uVar21,uVar24,"p_index",
                   "count","",false,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
      ...
      if (uVar32 != 0) {
        ...
        while ((uVar32 != (uint)uVar36 || (local_100 != *(ulong *)(plVar6[1] + uVar19 * 8)))) {
          ...
          uVar32 = *(uint *)(lVar11 + uVar19 * 4);
          if ((uVar32 == 0) || (((uVar27 + (int)uVar19) - uVar32 % uVar27) % uVar27 < uVar28))
          goto LAB_00109880;
        }
...
LAB_00109880:
      ...
      local_b8[5] = 0;
      ShaderGLES3::_compile_specialization
                ((Specialization *)pVVar1,(uint)(Specialization *)local_b8,(Version *)0x0,uVar24);
      if ((*(int *)(uVar24 + 0x68) == 0) ||
         (OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
          ::insert(*(OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                     **)(uVar24 + 0x70),&local_100,(Specialization *)local_b8),
         *(int *)(uVar24 + 0x68) == 0)) goto LAB_00106fb7;
      plVar6 = *(long **)(uVar24 + 0x70);
      uVar27 = *(uint *)(plVar6 + 3);
...
LAB_00106e56:
      ...
      uVar28 = 0;
LAB_00109989:
      if ((uVar32 != (uint)uVar36) || (uVar16 != *(ulong *)(plVar6[1] + uVar24 * 8)))
      goto LAB_00109950;
...
LAB_0010a341:
        _err_print_index_error
                  ("_version_get_uniform","./drivers/gles3/shader_gles3.h",iVar10,lVar17,lVar11,
                   pcVar31,pcVar40,"",false,false);
        lVar11 = (long)*(int *)(this + 0x118);
      }
      else {
        if ((uVar24 != 0) && ((uint)uVar24 < *(uint *)(this + 0x9c))) {
          lVar17 = ((uVar24 & 0xffffffff) % (ulong)*(uint *)(this + 0x98)) * 0x80 +
                   *(long *)(*(long *)(this + 0x88) +
                            ((uVar24 & 0xffffffff) / (ulong)*(uint *)(this + 0x98)) * 8);
          iVar10 = *(int *)(lVar17 + 0x78);
          if (iVar10 == (int)(uVar24 >> 0x20)) {
            ...
            if (uVar32 != 0) {
              ...
              if (lVar17 != 0) {
                ...
                if (*(int *)(this + 0x118) < 3) {
                  _err_print_index_error
                            ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe4,2,lVar11,
...
LAB_0010afa5:
                  ...
                  lVar11 = ((uVar24 & 0xffffffff) % (ulong)*(uint *)(this + 0x98)) * 0x80 +
                           *(long *)(*(long *)(this + 0x88) +
                                    ((uVar24 & 0xffffffff) / (ulong)*(uint *)(this + 0x98)) * 8);
                  ...
                  if (*(int *)(lVar11 + 0x68) < 1) {
                    _err_print_index_error
                              ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe7,0,
                               (long)*(int *)(lVar11 + 0x68),"p_variant",
                               "int(version->variants.size())","",false,false);
                    goto LAB_0010aeb0;
                  }
...
LAB_0010b433:
                  ...
                  while ((uVar32 != (uint)uVar16 || (uVar21 != *(ulong *)(plVar6[1] + uVar24 * 8))))
                  {
                    ...
                    uVar32 = *(uint *)(plVar6[2] + uVar24 * 4);
                    if ((uVar32 == 0) ||
                       (((uVar27 + (int)uVar24) - uVar32 % uVar27) % uVar27 < uVar28))
                    goto LAB_0010b433;
                  }
          ...
          if (iVar10 == (int)(uVar24 >> 0x20)) {
            ...
            if (uVar32 != 0) {
              ...
              if (lVar17 != 0) {
                ...
                if (*(int *)(this + 0x118) < 4) {
                  _err_print_index_error
                            ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe4,3,lVar11,
                             "p_which","uniform_count","",false,false);
LAB_0010b1ca:
                  uVar26 = 0xffffffff;
                }
...
LAB_0010788e:
      ...
      if ((int)lVar11 < 5) {
        _err_print_index_error
                  ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe4,4,lVar11,"p_which",
...
LAB_0010a537:
        ...
        if (*(int *)(lVar11 + 0x68) < 1) {
          _err_print_index_error
                    ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe7,0,
                     (long)*(int *)(lVar11 + 0x68),"p_variant","int(version->variants.size())","",
                     false,false);
          goto LAB_00107b27;
        }
        plVar6 = *(long **)(lVar11 + 0x70);
          ...
          if (*(int *)(lVar11 + 0x10) < 5) {
            _err_print_index_error
                      ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xea,4,
                       (long)*(int *)(lVar11 + 0x10),"p_which","int(spec->uniform_location.size())",
                       "",false,false);
          }
          ...
          if (iVar10 == (int)(uVar24 >> 0x20)) {
            ...
            if (uVar32 != 0) {
              ...
              if (lVar17 != 0) {
                ...
                if (*(int *)(this + 0x118) < 6) {
                  _err_print_index_error
                            ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe4,5,lVar11,
                             "p_which","uniform_count","",false,false);
LAB_0010ade6:
                  uVar26 = 0xffffffff;
                }
          ...
          if (iVar10 == (int)(uVar24 >> 0x20)) {
            ...
            if (uVar32 != 0) {
              ...
              if (lVar17 != 0) {
                ...
                if (*(int *)(this + 0x118) < 7) {
                  _err_print_index_error
                            ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe4,6,lVar11,
                             "p_which","uniform_count","",false,false);
LAB_0010ae6a:
                  uVar26 = 0xffffffff;
                }
...
LAB_0010806f:
      ...
      if ((int)lVar11 < 8) {
        _err_print_index_error
                  ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe4,7,lVar11,"p_which",
                   "uniform_count","",false,false);
        goto LAB_00108300;
      }
      if ((uVar24 == 0) || (*(uint *)(this + 0x9c) <= (uint)uVar24)) {
...
LAB_0010b5f7:
              ...
              while ((uVar32 != (uint)uVar16 || (uVar21 != *(ulong *)(plVar6[1] + uVar24 * 8)))) {
                ...
                uVar24 = (ulong)((int)uVar24 + 1) % (ulong)uVar27;
                uVar32 = *(uint *)(plVar6[2] + uVar24 * 4);
                if ((uVar32 == 0) || (((uVar27 + (int)uVar24) - uVar32 % uVar27) % uVar27 < uVar34))
                goto LAB_0010b5f7;
              }
              lVar11 = *plVar6 + uVar24 * 0x38;
...
LAB_00108389:
        ...
        *(long *)(pSVar7 + 0x70) = lVar17;
        _mesh_surface_generate_version_for_input_mask
                  (this,(Version *)(lVar17 + lVar11),pSVar7,uVar21,(Surface *)0x0);
...
LAB_00106819:
    if ((uVar27 == (uint)uVar24) && (*(long *)(this + 0x158) == *(long *)(plVar6[1] + uVar21 * 8)))
    {
      puVar23 = (undefined4 *)(*plVar6 + uVar21 * 0x38);
      goto LAB_00106833;
    }
  ...
  goto LAB_00106e70;
LAB_00108929:
  if ((uVar28 != uVar34) || (uVar16 != *(ulong *)(*(long *)(lVar35 + 0x28) + uVar21 * 8))) {
    uVar29 = uVar29 + 1;
    uVar21 = (ulong)((int)uVar21 + 1) % (ulong)uVar27;
    uVar28 = *(uint *)(*(long *)(lVar35 + 0x30) + uVar21 * 4);
    if ((uVar28 == 0) || (((uVar27 + (int)uVar21) - uVar28 % uVar27) % uVar27 < uVar29))
    goto LAB_0010ab5c;
    goto LAB_00108929;
  }
  ...
  if (lVar35 != 0) {
    if (*(int *)(lVar35 + 0x10) < 1) {
      _err_print_index_error
                ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xea,0,
                 (long)*(int *)(lVar35 + 0x10),"p_which","int(spec->uniform_location.size())","",
                 false,false);
      goto LAB_0010a113;
    }
    ...
    if ((uVar21 != 0) && ((uint)uVar21 < *(uint *)pMVar3)) {
      ...
      if (iVar10 == (int)(uVar21 >> 0x20)) {
        if (*(int *)(lVar35 + 0x68) < 2) {
          _err_print_index_error
                    ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe7,1,
                     (long)*(int *)(lVar35 + 0x68),"p_variant","int(version->variants.size())","",
                     false,false);
        }
        else {
          lVar35 = *(long *)(lVar35 + 0x70);
          ...
          if (uVar29 != 0) {
            ...
            while ((uVar29 != uVar34 ||
              ...
              uVar29 = *(uint *)(*(long *)(lVar35 + 0x30) + uVar24 * 4);
              if ((uVar29 == 0) || (((uVar28 + (int)uVar24) - uVar29 % uVar28) % uVar28 < uVar30))
              goto LAB_00109f9d;
            }
            lVar35 = *(long *)(lVar35 + 0x20) + uVar24 * 0x38;
            if (lVar35 != 0) {
...
LAB_00108bd6:
  (*_glad_glBindVertexArray)
            (*(undefined4 *)
              (*(long *)(*(long *)(*(long *)(*(long *)pMVar5 + 8) + lVar17) + 0x108) + 4 +
              uVar36 * 8));
...
LAB_00108c81:
  ...
  goto LAB_001086f0;
LAB_00108b81:
  if ((uVar29 != uVar34) || (uVar16 != *(ulong *)(*(long *)(lVar35 + 0x28) + uVar21 * 8))) {
    uVar30 = uVar30 + 1;
    uVar21 = (ulong)((int)uVar21 + 1) % (ulong)uVar28;
    uVar29 = *(uint *)(*(long *)(lVar35 + 0x30) + uVar21 * 4);
    if ((uVar29 == 0) || (((uVar28 + (int)uVar21) - uVar29 % uVar28) % uVar28 < uVar30))
    goto LAB_0010ab86;
    goto LAB_00108b81;
  }
  lVar35 = *(long *)(lVar35 + 0x20) + uVar21 * 0x38;
...
LAB_0010a0a3:
  uVar26 = 0xffffffff;
LAB_00108bc6:
  auVar38._4_12_ = SUB1612((undefined1  [16])0x0,4);
  auVar38._0_4_ = (float)uVar27;
  (*pcVar42)(auVar38._0_8_,uVar26);
  goto LAB_00108bd6;
LAB_00108c93:
  if ((uint)uVar24 <= (uint)uVar21) goto LAB_00106fd7;
  (*_glad_glBindVertexArray)
            (*(undefined4 *)
              (*(long *)(*(long *)(*(long *)(piVar18 + 2) + lVar17) + 0x108) + 4 + uVar21 * 8));
  _blend_shape_bind_mesh_instance_buffer(this,pMVar5,uVar20);
  if (bVar9) {
...
LAB_001095ad:
    _err_print_index_error
              ("_version_bind_shader","./drivers/gles3/shader_gles3.h",0xbb,lVar11,(long)iVar10,
  ...
  if ((uVar21 != 0) && ((uint)uVar21 < *(uint *)(this + 0x9c))) {
    uVar19 = ((uVar21 & 0xffffffff) % (ulong)*(uint *)(this + 0x98)) * 0x80 +
             *(long *)(*(long *)(this + 0x88) +
                      ((uVar21 & 0xffffffff) / (ulong)*(uint *)(this + 0x98)) * 8);
    iVar10 = *(int *)(uVar19 + 0x78);
    if (iVar10 == (int)(uVar21 >> 0x20)) {
      ...
      if (1 < uVar34) {
        ...
        if (uVar27 != 0) {
          uVar28 = 0;
          while ((uVar27 != (uint)uVar33 ||
                 (local_f8[0] != *(ulong *)(*(long *)(lVar35 + 0x28) + uVar21 * 8)))) {
            uVar28 = uVar28 + 1;
...
LAB_0010c674:
        ...
        if (1 < *(uint *)(uVar19 + 0x68)) {
          OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
          ::insert((OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                    *)(*(long *)(uVar19 + 0x70) + 0x20),local_f8,(Specialization *)local_b8);
          uVar24 = (ulong)*(uint *)(uVar19 + 0x68);
          if (1 < *(uint *)(uVar19 + 0x68)) {
            lVar35 = *(long *)(uVar19 + 0x70);
            uVar34 = *(uint *)(lVar35 + 0x38);
            ...
            if (uVar27 != 0) {
              uVar32 = 0;
LAB_0010c787:
              if ((uVar27 != (uint)uVar33) ||
                 (uVar21 != *(ulong *)(*(long *)(lVar35 + 0x28) + uVar24 * 8))) goto LAB_0010c750;
              puVar23 = (undefined4 *)(*(long *)(lVar35 + 0x20) + uVar24 * 0x38);
              if (this[0xe8] != (MeshStorage)0x0) {
                ShaderGLES3::_save_to_cache(pVVar1);
              }
...
LAB_0010d417:
                ...
                if (iVar10 != (int)(uVar21 >> 0x20)) {
                  if (iVar10 + 0x80000000U < 0x7fffffff) {
                    _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                                     "Method/function failed. Returning: nullptr",
                                     "Attempting to use an uninitialized RID",0,0,uVar19);
                  }
                  goto LAB_0010d417;
                }
                if (*(int *)(lVar35 + 0x68) < 2) {
...
LAB_0010d26a:
                  ...
                  while ((uVar27 != (uint)uVar19 ||
                    ...
                    uVar27 = *(uint *)(*(long *)(lVar35 + 0x30) + uVar24 * 4);
                    if ((uVar27 == 0) ||
                       (((uVar34 + (int)uVar24) - uVar27 % uVar34) % uVar34 < uVar32))
                    goto LAB_0010d26a;
                  }
...
LAB_0010d1c1:
                      ...
                      lVar12 = ((uVar21 & 0xffffffff) % (ulong)*(uint *)(this + 0x98)) * 0x80 +
                               *(long *)(*(long *)(this + 0x88) +
                                        ((uVar21 & 0xffffffff) / (ulong)*(uint *)(this + 0x98)) * 8)
                      ;
                      if (iVar10 != *(int *)(lVar12 + 0x78)) {
                        if (*(int *)(lVar12 + 0x78) + 0x80000000U < 0x7fffffff) {
                          _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                                           "Method/function failed. Returning: nullptr",
                                           "Attempting to use an uninitialized RID",0,0,lVar35);
                        }
                        goto LAB_0010d1c1;
                      }
...
LAB_0010c81e:
                      ...
                      uVar32 = 0;
                      while ((uVar27 != (uint)uVar19 ||
                             (uVar16 != *(ulong *)(*(long *)(lVar35 + 0x28) + uVar21 * 8)))) {
                        uVar32 = uVar32 + 1;
...
LAB_0010d5e3:
                  ...
                  uVar32 = 0;
                  while ((uVar27 != (uint)uVar19 ||
                         (uVar16 != *(ulong *)(*(long *)(lVar35 + 0x28) + uVar33 * 8)))) {
                    uVar32 = uVar32 + 1;
                    uVar33 = (ulong)((int)uVar33 + 1) % (ulong)uVar34;
                    uVar27 = *(uint *)(*(long *)(lVar35 + 0x30) + uVar33 * 4);
                    if ((uVar27 == 0) ||
                       (((uVar34 + (int)uVar33) - uVar27 % uVar34) % uVar34 < uVar32))
                    goto LAB_0010d5e3;
                  }
...
LAB_00109481:
              if (!bVar9) {
                ...
                if (uVar20 < *(uint *)(pMVar5 + 0x10)) {
                  (*_glad_glBindBufferBase)
                            (0x8c8e,0,*(undefined4 *)(*(long *)(pMVar5 + 0x18) + 0x10 + lVar11));
                  (*_glad_glBeginTransformFeedback)(0);
                  (*_glad_glDrawArrays)
                            (0,0,*(undefined4 *)
                                  (*(long *)(*(long *)(*(long *)pMVar5 + 8) + lVar17) + 0x1c));
                  (*_glad_glEndTransformFeedback)();
                  goto LAB_001094e3;
                }
                goto LAB_001095e8;
...
LAB_0010d3a5:
                _err_print_index_error
                          ("_version_get_uniform","./drivers/gles3/shader_gles3.h",iVar10,lVar17,
                           lVar11,pcVar31,pcVar40,"",false,false);
                lVar11 = (long)*(int *)(this + 0x118);
              }
              else {
                if (uVar21 != 0) {
                  ...
                  if ((uint)uVar21 < *(uint *)(this + 0x9c)) {
                    ...
                    if (iVar10 == (int)(uVar21 >> 0x20)) {
                      ...
                      if (uVar27 != 0) {
                        uVar32 = 0;
                        while ((uVar27 != (uint)uVar19 ||
                               (uVar16 != *(ulong *)(*(long *)(lVar11 + 0x28) + uVar33 * 8)))) {
                          uVar32 = uVar32 + 1;
                          uVar33 = (ulong)((int)uVar33 + 1) % (ulong)uVar34;
                          uVar27 = *(uint *)(*(long *)(lVar11 + 0x30) + uVar33 * 4);
                          if ((uVar27 == 0) ||
                          ...
                          if (*(int *)(this + 0x118) < 3) {
                            _err_print_index_error
                                      ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe4,
                                       2,lVar11,"p_which","uniform_count","",false,false);
LAB_0010d797:
                            uVar26 = 0xffffffff;
                          }
                          else {
...
LAB_0010d8ce:
                            ...
                            lVar11 = ((uVar21 & 0xffffffff) % (ulong)*(uint *)(this + 0x98)) * 0x80
                                     + *(long *)(*(long *)(this + 0x88) +
                                                ((uVar21 & 0xffffffff) /
                                                (ulong)*(uint *)(this + 0x98)) * 8);
                            if (iVar10 != *(int *)(lVar11 + 0x78)) {
                              if (*(int *)(lVar11 + 0x78) + 0x80000000U < 0x7fffffff) {
                                _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                                                 "Method/function failed. Returning: nullptr",
                                                 "Attempting to use an uninitialized RID",0,0,
                                                 *(long *)(this + 0x88),uVar41,uVar24,this_00);
                              }
                              goto LAB_0010d8ce;
                            }
                            if (*(int *)(lVar11 + 0x68) < 2) {
                              _err_print_index_error
                                        ("_version_get_uniform","./drivers/gles3/shader_gles3.h",
                                         0xe7,1,(long)*(int *)(lVar11 + 0x68),"p_variant",
                                         "int(version->variants.size())","",false,false);
                              goto LAB_0010d797;
                            }
...
LAB_0010d772:
                            ...
                            uVar32 = 0;
                            while ((uVar27 != (uint)uVar19 ||
                                   (uVar16 != *(ulong *)(*(long *)(lVar11 + 0x28) + uVar21 * 8)))) {
                              uVar32 = uVar32 + 1;
                              uVar21 = (ulong)((int)uVar21 + 1) % (ulong)uVar34;
                              uVar27 = *(uint *)(*(long *)(lVar11 + 0x30) + uVar21 * 4);
                              if ((uVar27 == 0) ||
                            ...
                            if (*(int *)(lVar11 + 0x10) < 3) {
                              _err_print_index_error
                                        ("_version_get_uniform","./drivers/gles3/shader_gles3.h",
                                         0xea,2,(long)*(int *)(lVar11 + 0x10),"p_which",
                                         "int(spec->uniform_location.size())","",false,false);
                              goto LAB_0010d797;
                            }
                            uVar26 = *(undefined4 *)(*(long *)(lVar11 + 0x18) + 8);
...
LAB_0010d865:
                    ...
                    if (iVar10 + 0x80000000U < 0x7fffffff) {
                      _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                                       "Method/function failed. Returning: nullptr",
                                       "Attempting to use an uninitialized RID",0,0,iVar10,uVar41,
                                       uVar24,this_00);
                    }
                  }
                }
                  ...
                  if ((uint)uVar21 < *(uint *)(this + 0x9c)) {
                    ...
                    if (iVar10 == (int)(uVar21 >> 0x20)) {
                      ...
                      if (uVar27 != 0) {
                        uVar32 = 0;
                        while ((uVar27 != (uint)uVar19 ||
                               (uVar16 != *(ulong *)(*(long *)(lVar17 + 0x28) + uVar33 * 8)))) {
                          uVar32 = uVar32 + 1;
                        ...
                        if (lVar35 != 0) {
                          ...
                          if (*(int *)(this + 0x118) < 4) {
                            _err_print_index_error
                                      ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe4,
                                       3,lVar11,"p_which","uniform_count","",false,false);
LAB_0010da77:
                            uVar26 = 0xffffffff;
                          }
                          else {
...
LAB_0010dacb:
                            ...
                            if (iVar10 != *(int *)(lVar11 + 0x78)) {
                              if (*(int *)(lVar11 + 0x78) + 0x80000000U < 0x7fffffff) {
                                _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                                                 "Method/function failed. Returning: nullptr",
                                                 "Attempting to use an uninitialized RID",0,0,lVar17
                                                 ,uVar41,uVar24,this_00);
                              }
                              goto LAB_0010dacb;
                            }
                            if (*(int *)(lVar11 + 0x68) < 2) {
...
LAB_0010da52:
                            ...
                            if (*(int *)(lVar11 + 0x10) < 4) {
                              _err_print_index_error
                                        ("_version_get_uniform","./drivers/gles3/shader_gles3.h",
                                         0xea,3,(long)*(int *)(lVar11 + 0x10),"p_which",
                                         "int(spec->uniform_location.size())","",false,false);
                              goto LAB_0010da77;
                            }
                            uVar26 = *(undefined4 *)(*(long *)(lVar11 + 0x18) + 0xc);
...
LAB_0010d6d7:
                    ...
                    if (iVar10 + 0x80000000U < 0x7fffffff) {
                      _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                                       "Method/function failed. Returning: nullptr",
                                       "Attempting to use an uninitialized RID",0,0,uVar19,uVar41,
                                       uVar24,this_00);
                    }
                  }
                }
...
LAB_0010bbf3:
              ...
              if ((int)lVar11 < 5) {
                _err_print_index_error
                          ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe4,4,lVar11,
                           "p_which","uniform_count","",false,false);
                goto LAB_0010be84;
              }
              if (uVar21 == 0) {
LAB_0010d9e7:
                ...
                if (iVar10 != (int)(uVar21 >> 0x20)) {
                  if (iVar10 + 0x80000000U < 0x7fffffff) {
                    _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                                     "Method/function failed. Returning: nullptr",
                                     "Attempting to use an uninitialized RID",0,0,pcVar25,uVar41,
                                     uVar24,this_00);
                  }
                  goto LAB_0010d9e7;
                }
...
LAB_0010dbeb:
                  ...
                  uVar32 = 0;
                  while ((uVar27 != (uint)uVar19 ||
                         (uVar16 != *(ulong *)(*(long *)(lVar11 + 0x28) + uVar24 * 8)))) {
                    uVar32 = uVar32 + 1;
                    uVar24 = (ulong)((int)uVar24 + 1) % (ulong)uVar34;
                    uVar27 = *(uint *)(*(long *)(lVar11 + 0x30) + uVar24 * 4);
                    if ((uVar27 == 0) ||
...
LAB_0010dc67:
                      ...
                      if (iVar10 != *(int *)(lVar11 + 0x78)) {
                        if (*(int *)(lVar11 + 0x78) + 0x80000000U < 0x7fffffff) {
                          _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                                           "Method/function failed. Returning: nullptr",
                                           "Attempting to use an uninitialized RID",0,0,lVar11,
                                           uVar41,_glad_glUniform2fv,this_00);
                        }
                        goto LAB_0010dc67;
                      }
                      if (*(int *)(lVar11 + 0x68) < 2) {
                ...
                if ((uVar21 != 0) && ((uint)uVar21 < *(uint *)(this + 0x9c))) {
                  ...
                  if (iVar10 == (int)(uVar21 >> 0x20)) {
                    ...
                    if (uVar27 != 0) {
                      uVar32 = 0;
                      while ((uVar27 != (uint)uVar19 ||
                             (uVar16 != *(ulong *)(*(long *)(lVar17 + 0x28) + uVar24 * 8)))) {
                        uVar32 = uVar32 + 1;
                        ...
                        if (*(int *)(this + 0x118) < 6) {
                          _err_print_index_error
                                    ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe4,5,
                                     lVar11,"p_which","uniform_count","",false,false);
LAB_0010cdc7:
                          uVar26 = 0xffffffff;
                        }
                        else {
                          ...
                          if (*(int *)(lVar11 + 0x68) < 2) {
                            _err_print_index_error
                                      ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe7,
                                       1,(long)*(int *)(lVar11 + 0x68),"p_variant",
                                       "int(version->variants.size())","",false,false);
                            goto LAB_0010cdc7;
                          }
                          lVar11 = *(long *)(lVar11 + 0x70);
                          ...
                          if (*(int *)(lVar11 + 0x10) < 6) {
                            _err_print_index_error
                                      ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xea,
                                       5,(long)*(int *)(lVar11 + 0x10),"p_which",
                                       "int(spec->uniform_location.size())","",false,false);
                            goto LAB_0010cdc7;
                          }
                          uVar26 = *(undefined4 *)(*(long *)(lVar11 + 0x18) + 0x14);
...
LAB_0010c938:
                          ...
                          if (*(int *)(lVar11 + 0x10) < 7) {
                            _err_print_index_error
                                      ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xea,
                                       6,(long)*(int *)(lVar11 + 0x10),"p_which",
                                       "int(spec->uniform_location.size())","",false,false);
                            goto LAB_0010c95d;
                          }
                          uVar26 = *(undefined4 *)(*(long *)(lVar11 + 0x18) + 0x18);
...
LAB_0010ca61:
                  ...
                  if (iVar10 + 0x80000000U < 0x7fffffff) {
                    _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                                     "Method/function failed. Returning: nullptr",
                                     "Attempting to use an uninitialized RID",0,0,pcVar25);
                  }
                }
                _err_print_error("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe6,
                                 "Parameter \"version\" is null.",0);
...
LAB_0010c3a4:
              ...
              if ((int)lVar11 < 8) {
                _err_print_index_error
                          ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe4,7,lVar11,
                           "p_which","uniform_count","",false,false);
                goto LAB_0010c625;
              }
              if ((uVar21 == 0) || (*(uint *)(this + 0x9c) <= (uint)uVar21)) {
LAB_0010c90e:
                ...
                if (iVar10 != (int)(uVar21 >> 0x20)) {
                  if (iVar10 + 0x80000000U < 0x7fffffff) {
                    _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                                     "Method/function failed. Returning: nullptr",
                                     "Attempting to use an uninitialized RID",0,0,iVar10);
                  }
                  goto LAB_0010c90e;
                }
                if (*(int *)(lVar11 + 0x68) < 2) {
...
LAB_0010c7f4:
            if (this[0xe8] == (MeshStorage)0x0) {
LAB_00106e64:
              local_128 = (Specialization *)local_b8;
...
LAB_001072d7:
    if ((uVar32 == (uint)uVar19) && (*(long *)(this + 0x158) == *(long *)(plVar6[1] + uVar24 * 8)))
    {
      puVar23 = (undefined4 *)(*plVar6 + uVar24 * 0x38);
      goto LAB_001072f6;
    }
...
LAB_0010650f:
    *(undefined8 *)(pMVar5 + 0x38) = *(undefined8 *)(local_160 + 0x50);
  }
LAB_00106eab:
  if (*(MeshStorage **)(pMVar5 + 0x68) == this + 0x240) {
    ...
    *(undefined1 (*) [16])(pMVar5 + 0x78) = (undefined1  [16])0x0;
    ...
    _err_print_error("remove","./core/templates/self_list.h",0x50,
                     "Condition \"p_elem->_root != this\" is true.",0);
    pMVar13 = *(MeshInstance **)(this + 0x240);
  }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::MeshStorage::_mesh_instance_remove_surface(GLES3::MeshInstance*, int) */

void __thiscall
GLES3::MeshStorage::_mesh_instance_remove_surface
          (MeshStorage *this,MeshInstance *param_1,int param_2)
  ...
  if (*(uint *)(param_1 + 0x10) <= (uint)param_2) {
    _err_print_index_error
              ("operator[]","./core/templates/local_vector.h",0xb2,(ulong)(uint)param_2,
               (ulong)*(uint *)(param_1 + 0x10),"p_index","count","",false,true);
    _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_0010df03:
    ...
    pHVar1 = (HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
              *)(Utilities::singleton + 0x68);
    local_44 = uVar31;
    if ((*(long *)(Utilities::singleton + 0x70) != 0) &&
       (*(int *)(Utilities::singleton + 0x94) != 0)) {
      uVar36 = *(ulong *)(hash_table_size_primes_inv +
                         (ulong)*(uint *)(Utilities::singleton + 0x90) * 8);
      ...
      uVar41 = CONCAT44(0,*(uint *)(hash_table_size_primes +
                                   (ulong)*(uint *)(Utilities::singleton + 0x90) * 4));
      auVar4._8_8_ = 0;
      auVar4._0_8_ = uVar41;
      auVar16._8_8_ = 0;
      ...
      if (uVar30 != 0) {
        ...
        do {
          if ((local_50 == uVar30) &&
             (uVar31 == *(uint *)(*(long *)(*(long *)(Utilities::singleton + 0x70) + lVar39 * 8) +
                                 0x10))) {
            (*_glad_glDeleteBuffers)(1,&local_44);
            puVar35 = (uint *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
          ...
          iVar37 = SUB164(auVar5 * auVar17,8);
                ...
                (auVar6._8_8_ = 0, auVar6._0_8_ = uVar30 * uVar36, auVar18._8_8_ = 0,
                auVar18._0_8_ = uVar41, auVar7._8_8_ = 0,
                auVar7._0_8_ = ((*(uint *)(hash_table_size_primes +
                                          (ulong)*(uint *)(Utilities::singleton + 0x90) * 4) +
                                iVar37) - SUB164(auVar6 * auVar18,8)) * uVar36, auVar19._8_8_ = 0,
                auVar19._0_8_ = uVar41, uVar42 <= SUB164(auVar7 * auVar19,8)));
      }
    }
    ...
    if ((*(long *)(Utilities::singleton + 0x70) != 0) &&
      ...
      if (uVar31 != 0) {
        ...
        do {
          if ((local_60 == uVar31) &&
             (local_44 ==
              *(uint *)(*(long *)(*(long *)(Utilities::singleton + 0x70) + lVar39 * 8) + 0x10))) {
            (*_glad_glDeleteBuffers)(1,&local_44);
            puVar35 = (uint *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                              ::operator[](pHVar1,&local_44);
            *(long *)(lVar43 + 0xf8) = *(long *)(lVar43 + 0xf8) - (ulong)*puVar35;
          ...
          iVar37 = SUB164(auVar9 * auVar21,8);
                ...
                (auVar10._8_8_ = 0, auVar10._0_8_ = uVar31 * uVar36, auVar22._8_8_ = 0,
                auVar22._0_8_ = uVar41, auVar11._8_8_ = 0,
                auVar11._0_8_ =
                     ((*(uint *)(hash_table_size_primes +
                                (ulong)*(uint *)(Utilities::singleton + 0x90) * 4) + iVar37) -
                     SUB164(auVar10 * auVar22,8)) * uVar36, auVar23._8_8_ = 0,
                auVar23._0_8_ = uVar41, uVar30 <= SUB164(auVar11 * auVar23,8)));
      }
    }
    _err_print_error("buffer_free_data","drivers/gles3/storage/utilities.h",0x66,
                     "Condition \"!buffer_allocs_cache.has(p_id)\" is true.",0,0);
  ...
  if (local_44 != 0) {
    if ((*(long *)(lVar43 + 0x70) != 0) && (*(int *)(lVar43 + 0x94) != 0)) {
      ...
      if (uVar31 != 0) {
        ...
        do {
          if ((uVar31 == uVar30) &&
             (local_44 == *(uint *)(*(long *)(*(long *)(lVar43 + 0x70) + lVar39 * 8) + 0x10))) {
            (*_glad_glDeleteBuffers)(1,&local_44);
            puVar35 = (uint *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
          ...
          iVar37 = SUB164(auVar13 * auVar25,8);
                ...
                (auVar14._8_8_ = 0, auVar14._0_8_ = uVar31 * uVar36, auVar26._8_8_ = 0,
                auVar26._0_8_ = uVar41, auVar15._8_8_ = 0,
                auVar15._0_8_ =
                     ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(lVar43 + 0x90) * 4) +
                      iVar37) - SUB164(auVar14 * auVar26,8)) * uVar36, auVar27._8_8_ = 0,
                auVar27._0_8_ = uVar41, uVar42 <= SUB164(auVar15 * auVar27,8)));
      }
    }
    _err_print_error("buffer_free_data","drivers/gles3/storage/utilities.h",0x66,
                     "Condition \"!buffer_allocs_cache.has(p_id)\" is true.",0,0);
LAB_0010e35e:
  ...
  if ((uint)param_2 < uVar31) {
    ...
    *(uint *)(param_1 + 0x10) = uVar30;
    ...
    _err_print_index_error
              ("remove_at","./core/templates/local_vector.h",0x4c,uVar32,(ulong)uVar31,"p_index",
               "count","",false,false);
...
/* GLES3::MeshStorage::_mesh_instance_clear(GLES3::MeshInstance*) */

void __thiscall GLES3::MeshStorage::_mesh_instance_clear(MeshStorage *this,MeshInstance *param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::MeshStorage::skeleton_allocate_data(RID, int, bool) */

void __thiscall
GLES3::MeshStorage::skeleton_allocate_data(MeshStorage *this,ulong param_2,int param_3,byte param_4)

{
  ...
  *this_00;
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x2cc))) {
    pbVar20 = (byte *)(((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x2c8)) * 0x90 +
                      *(long *)(*(long *)(this + 0x2b8) +
                               ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x2c8)) * 8));
...
LAB_0010e881:
          *(uint *)(pbVar20 + 0x10) = uVar16;
LAB_0010e885:
          (*_glad_glGenTextures)(1,pbVar20 + 0x48);
        ...
        if ((*(long *)(Utilities::singleton + 0xd0) != 0) &&
          ...
          if (uVar16 != 0) {
            ...
            do {
              if ((uVar16 == uVar23) &&
                 (uVar13 == *(uint *)(*(long *)(*(long *)(Utilities::singleton + 0xd0) + lVar18 * 8)
                                     + 0x10))) {
              ...
              iVar12 = SUB164(auVar3 * auVar7,8);
                    ...
                    (auVar4._8_8_ = 0, auVar4._0_8_ = uVar16 * uVar2, auVar8._8_8_ = 0,
                    auVar8._0_8_ = uVar21, auVar5._8_8_ = 0,
                    auVar5._0_8_ = ((*(uint *)(hash_table_size_primes +
                                              (ulong)*(uint *)(Utilities::singleton + 0xf0) * 4) +
                                    iVar12) - SUB164(auVar4 * auVar8,8)) * uVar2, auVar9._8_8_ = 0,
...
LAB_0010ea76:
    _err_print_error("skeleton_allocate_data","drivers/gles3/storage/mesh_storage.cpp",uVar19,
                     pcVar15,0,0);
    return;
  }
LAB_0010eb0e:
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::MeshStorage::_mesh_surface_clear(GLES3::Mesh*, int) */

void __thiscall GLES3::MeshStorage::_mesh_surface_clear(MeshStorage *this,Mesh *param_1,int param_2)
  ...
  *pHVar1;
  ...
  if (uVar61 != 0) {
    ...
    if ((*(long *)(Utilities::singleton + 0x70) != 0) &&
      ...
      uVar64 = CONCAT44(0,*(uint *)(hash_table_size_primes +
                                   (ulong)*(uint *)(Utilities::singleton + 0x90) * 4));
      auVar17._8_8_ = 0;
      ...
      if (uVar68 != 0) {
        ...
        do {
          if ((uVar71 == uVar68) &&
             (uVar61 == *(uint *)(*(long *)(*(long *)(Utilities::singleton + 0x70) + lVar69 * 8) +
                                 0x10))) {
            (*_glad_glDeleteBuffers)(1,&local_44);
            puVar62 = (uint *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                              ::operator[](pHVar1,&local_44);
          ...
          iVar65 = SUB164(auVar18 * auVar46,8);
                ...
                (auVar19._8_8_ = 0, auVar19._0_8_ = uVar68 * uVar4, auVar47._8_8_ = 0,
                auVar47._0_8_ = uVar64, auVar20._8_8_ = 0,
                auVar20._0_8_ =
                     ((*(uint *)(hash_table_size_primes +
                                (ulong)*(uint *)(Utilities::singleton + 0x90) * 4) + iVar65) -
                     SUB164(auVar19 * auVar47,8)) * uVar4, auVar48._8_8_ = 0, auVar48._0_8_ = uVar64
                , uVar72 <= SUB164(auVar20 * auVar48,8)));
      }
    }
    _err_print_error("buffer_free_data","drivers/gles3/storage/utilities.h",0x66,
                     "Condition \"!buffer_allocs_cache.has(p_id)\" is true.",0,0);
LAB_0010f355:
  ...
  if (uVar61 != 0) {
    ...
    if ((*(long *)(Utilities::singleton + 0x70) != 0) &&
       (*(int *)(Utilities::singleton + 0x94) != 0)) {
      uVar63 = CONCAT44(0,*(uint *)(hash_table_size_primes +
                                   (ulong)*(uint *)(Utilities::singleton + 0x90) * 4));
      uVar4 = *(ulong *)(hash_table_size_primes_inv +
                        (ulong)*(uint *)(Utilities::singleton + 0x90) * 8);
      uVar68 = (uVar61 >> 0x10 ^ uVar61) * -0x7a143595;
      ...
      if (uVar68 != 0) {
        ...
        do {
          ...
          iVar65 = SUB164(auVar30 * auVar58,8);
                ...
                (auVar31._8_8_ = 0, auVar31._0_8_ = uVar68 * uVar4, auVar59._8_8_ = 0,
                auVar59._0_8_ = uVar63, auVar32._8_8_ = 0,
                auVar32._0_8_ =
                     ((*(uint *)(hash_table_size_primes +
                                (ulong)*(uint *)(Utilities::singleton + 0x90) * 4) + iVar65) -
                     SUB164(auVar31 * auVar59,8)) * uVar4, auVar60._8_8_ = 0, auVar60._0_8_ = uVar63
                , uVar72 <= SUB164(auVar32 * auVar60,8)));
      }
    }
    _err_print_error("buffer_free_data","drivers/gles3/storage/utilities.h",0x66,
                     "Condition \"!buffer_allocs_cache.has(p_id)\" is true.",0,0);
      ...
      if (uVar68 != 0) {
        ...
        do {
          ...
          iVar65 = SUB164(auVar26 * auVar54,8);
                ...
                (auVar27._8_8_ = 0, auVar27._0_8_ = uVar68 * uVar4, auVar55._8_8_ = 0,
                auVar55._0_8_ = uVar63, auVar28._8_8_ = 0,
                auVar28._0_8_ =
                     ((*(uint *)(hash_table_size_primes +
                                (ulong)*(uint *)(Utilities::singleton + 0x90) * 4) + iVar65) -
                     SUB164(auVar27 * auVar55,8)) * uVar4, auVar56._8_8_ = 0, auVar56._0_8_ = uVar63
                , uVar72 <= SUB164(auVar28 * auVar56,8)));
      }
    }
    _err_print_error("buffer_free_data","drivers/gles3/storage/utilities.h",0x66,
                     "Condition \"!buffer_allocs_cache.has(p_id)\" is true.",0,0);
      ...
      if (uVar68 != 0) {
        ...
        do {
          ...
          iVar65 = SUB164(auVar22 * auVar50,8);
                ...
                (auVar23._8_8_ = 0, auVar23._0_8_ = uVar68 * uVar4, auVar51._8_8_ = 0,
                auVar51._0_8_ = uVar63, auVar24._8_8_ = 0,
                auVar24._0_8_ =
                     ((*(uint *)(hash_table_size_primes +
                                (ulong)*(uint *)(Utilities::singleton + 0x90) * 4) + iVar65) -
                     SUB164(auVar23 * auVar51,8)) * uVar4, auVar52._8_8_ = 0, auVar52._0_8_ = uVar63
                , uVar72 <= SUB164(auVar24 * auVar52,8)));
      }
    }
    _err_print_error("buffer_free_data","drivers/gles3/storage/utilities.h",0x66,
                     "Condition \"!buffer_allocs_cache.has(p_id)\" is true.",0,0);
    ...
    if ((*(long *)(Utilities::singleton + 0x70) != 0) &&
      ...
      if (uVar61 != 0) {
        ...
        do {
          if ((uVar68 == uVar61) &&
             (local_44 ==
              *(uint *)(*(long *)(*(long *)(Utilities::singleton + 0x70) + lVar69 * 8) + 0x10))) {
            (*_glad_glDeleteBuffers)(1,&local_44);
            puVar62 = (uint *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                              ::operator[](pHVar1,&local_44);
            *(long *)(lVar73 + 0xf8) = *(long *)(lVar73 + 0xf8) - (ulong)*puVar62;
          ...
          iVar65 = SUB164(auVar6 * auVar34,8);
                ...
                (auVar7._8_8_ = 0, auVar7._0_8_ = uVar61 * uVar4, auVar35._8_8_ = 0,
                auVar35._0_8_ = uVar64, auVar8._8_8_ = 0,
                auVar8._0_8_ = ((*(uint *)(hash_table_size_primes +
                                          (ulong)*(uint *)(Utilities::singleton + 0x90) * 4) +
                                iVar65) - SUB164(auVar7 * auVar35,8)) * uVar4, auVar36._8_8_ = 0,
                auVar36._0_8_ = uVar64, uVar71 <= SUB164(auVar8 * auVar36,8)));
      }
    }
    _err_print_error("buffer_free_data","drivers/gles3/storage/utilities.h",0x66,
                     "Condition \"!buffer_allocs_cache.has(p_id)\" is true.",0,0);
LAB_0010ed34:
    Memory::free_static(*(void **)(lVar3 + 0x88),false);
  }
  if (*(int *)(lVar3 + 0x98) != 0) {
      ...
      if (uVar61 != 0) {
        ...
        if ((*(long *)(Utilities::singleton + 0x70) != 0) &&
          ...
          if (uVar68 != 0) {
            ...
            do {
              if ((local_68 == uVar68) &&
                 (uVar61 == *(uint *)(*(long *)(*(long *)(Utilities::singleton + 0x70) + lVar66 * 8)
                                     + 0x10))) {
                (*_glad_glDeleteBuffers)(1,&local_44);
                puVar62 = (uint *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                                  ::operator[](pHVar1,&local_44);
              ...
              iVar65 = SUB164(auVar10 * auVar38,8);
                    ...
                    (auVar11._8_8_ = 0, auVar11._0_8_ = uVar68 * uVar4, auVar39._8_8_ = 0,
                    auVar39._0_8_ = uVar64, auVar12._8_8_ = 0,
                    auVar12._0_8_ =
                         ((*(uint *)(hash_table_size_primes +
                                    (ulong)*(uint *)(Utilities::singleton + 0x90) * 4) + iVar65) -
                         SUB164(auVar11 * auVar39,8)) * uVar4, auVar40._8_8_ = 0,
                    auVar40._0_8_ = uVar64, uVar71 <= SUB164(auVar12 * auVar40,8)));
          }
        }
        _err_print_error("buffer_free_data","drivers/gles3/storage/utilities.h",0x66,
                         "Condition \"!buffer_allocs_cache.has(p_id)\" is true.",0,0);
      ...
      if (uVar61 != 0) {
        ...
        if ((*(long *)(Utilities::singleton + 0x70) != 0) &&
          ...
          if (uVar68 != 0) {
            ...
            do {
              if ((local_68 == uVar68) &&
                 (uVar61 == *(uint *)(*(long *)(*(long *)(Utilities::singleton + 0x70) + lVar67 * 8)
                                     + 0x10))) {
                (*_glad_glDeleteBuffers)(1,&local_44);
                puVar62 = (uint *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                                  ::operator[](pHVar1,&local_44);
              ...
              iVar65 = SUB164(auVar14 * auVar42,8);
                    ...
                    (auVar15._8_8_ = 0, auVar15._0_8_ = uVar68 * uVar4, auVar43._8_8_ = 0,
                    auVar43._0_8_ = uVar64, auVar16._8_8_ = 0,
                    auVar16._0_8_ =
                         ((*(uint *)(hash_table_size_primes +
                                    (ulong)*(uint *)(Utilities::singleton + 0x90) * 4) + iVar65) -
                         SUB164(auVar15 * auVar43,8)) * uVar4, auVar44._8_8_ = 0,
                    auVar44._0_8_ = uVar64, uVar71 <= SUB164(auVar16 * auVar44,8)));
          }
        }
        _err_print_error("buffer_free_data","drivers/gles3/storage/utilities.h",0x66,
                         "Condition \"!buffer_allocs_cache.has(p_id)\" is true.",0,0);
...
/* GLES3::MeshStorage::mesh_clear(RID) */

void __thiscall GLES3::MeshStorage::mesh_clear(MeshStorage *this,ulong param_2)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x19c))) {
    pMVar2 = (Mesh *)(*(long *)(*(long *)(this + 0x188) +
                               ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x198)) * 8) +
                     ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x198)) * 0xd8);
  ...
  if (lVar4 == *(long *)(in_FS_OFFSET + 0x28)) {
    _err_print_error("mesh_clear","drivers/gles3/storage/mesh_storage.cpp",0x340,
                     "Parameter \"mesh\" is null.",0,0);
    return;
  }
LAB_0010fb49:
...
/* GLES3::MeshStorage::mesh_surface_remove(RID, int) */

void __thiscall
GLES3::MeshStorage::mesh_surface_remove(MeshStorage *this,ulong param_2,uint param_3)
    ...
    if (*(int *)(pMVar1 + 0xd0) == (int)(param_2 >> 0x20)) {
      if (param_3 < *(uint *)(pMVar1 + 0x10)) {
        ...
        if (param_3 < uVar9) {
          ...
          memmove((void *)(*(long *)(pMVar1 + 8) + -8 + lVar5),
                  (void *)(*(long *)(pMVar1 + 8) + lVar5),
                  (ulong)((*(int *)(pMVar1 + 0x10) - param_3) - 1) << 3);
          uVar9 = *(int *)(pMVar1 + 0x10) - 1;
        }
...
LAB_0010fdb3:
        ...
        _err_print_index_error
                  ("mesh_surface_remove","drivers/gles3/storage/mesh_storage.cpp",0x413,
                   (ulong)param_3,(ulong)*(uint *)(pMVar1 + 0x10),"(uint32_t)p_surface",
                   "mesh->surface_count","",false,false);
      }
  ...
  if (lVar3 == *(long *)(in_FS_OFFSET + 0x28)) {
    _err_print_error("mesh_surface_remove","drivers/gles3/storage/mesh_storage.cpp",0x412,
                     "Parameter \"mesh\" is null.",0,0);
    return;
  }
LAB_0010ff25:
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::MeshStorage::_mesh_instance_add_surface(GLES3::MeshInstance*, GLES3::Mesh*, unsigned int)
    */

void __thiscall
GLES3::MeshStorage::_mesh_instance_add_surface
          (MeshStorage *this,MeshInstance *param_1,Mesh *param_2,uint param_3)
...
LAB_0010ff97:
    if ((*(byte *)(lVar16 + 9) & 4) != 0) goto LAB_00110076;
  }
  else {
...
LAB_0011002c:
      ...
      *(long *)(param_1 + 0x28) = lVar16;
      if (lVar16 == 0) {
        _err_print_error("resize","./core/templates/local_vector.h",0xa3,
                         "FATAL: Condition \"!data\" is true.","Out of memory",0,0,uVar10);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar2 = (code *)invalidInstructionException();
        (*pcVar2)();
      ...
      *puVar8 = uVar14;
      ...
      if (*(int *)param_2 != 0) {
        ...
        while( true ) {
          ...
          String::parse_latin1((StrRange *)&local_a0);
          itos((long)&local_b0);
          operator+((char *)&local_a8,(String *)"MeshInstance process buffer[");
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::MeshStorage::_multimesh_allocate_data(RID, int, RenderingServer::MultimeshTransformFormat,
   bool, bool, bool) */

void GLES3::MeshStorage::_multimesh_allocate_data
               (long param_1,ulong param_2,int param_3,int param_4,byte param_5,byte param_6)

{
  ...
  *this;
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(param_1 + 0x26c))) {
    lVar19 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(param_1 + 0x268)) * 0x118 +
             *(long *)(*(long *)(param_1 + 600) +
                      ((param_2 & 0xffffffff) / (ulong)*(uint *)(param_1 + 0x268)) * 8);
    if (*(int *)(lVar19 + 0x110) == (int)(param_2 >> 0x20)) {
      if ((((*(int *)(lVar19 + 8) == param_3) && (*(int *)(lVar19 + 0xc) == param_4)) &&
          (*(byte *)(lVar19 + 0x10) == param_5)) && (*(byte *)(lVar19 + 0x11) == param_6)) {
        if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
          return;
        }
        goto LAB_00110a2b;
      ...
      if (uVar2 != 0) {
        ...
        if ((*(long *)(Utilities::singleton + 0x70) != 0) &&
          ...
          if (uVar14 != 0) {
            ...
            do {
              if ((uVar14 == local_8c) &&
                 (uVar2 == *(uint *)(*(long *)(*(long *)(Utilities::singleton + 0x70) + lVar18 * 8)
                                    + 0x10))) {
                ...
                puVar15 = (uint *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                                  ::operator[](this,(uint *)&local_68);
                *(long *)(lVar3 + 0xf8) = *(long *)(lVar3 + 0xf8) - (ulong)*puVar15;
                HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                ::erase(this,(uint *)&local_68);
                goto LAB_00110914;
              }
              uVar21 = uVar21 + 1;
              auVar6._8_8_ = 0;
              ...
              iVar16 = SUB164(auVar6 * auVar10,8);
                    ...
                    (auVar7._8_8_ = 0, auVar7._0_8_ = uVar14 * uVar4, auVar11._8_8_ = 0,
                    auVar11._0_8_ = uVar20, auVar8._8_8_ = 0,
                    auVar8._0_8_ = ((*(uint *)(hash_table_size_primes +
                                              (ulong)*(uint *)(Utilities::singleton + 0x90) * 4) +
                                    iVar16) - SUB164(auVar7 * auVar11,8)) * uVar4, auVar12._8_8_ = 0
...
LAB_001106f9:
  ...
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    _err_print_error("_multimesh_allocate_data","drivers/gles3/storage/mesh_storage.cpp",0x5f3,
                     "Parameter \"multimesh\" is null.",0,0);
    return;
  }
LAB_00110a2b:
...
/* GLES3::MeshStorage::mesh_instance_free(RID) */

long __thiscall GLES3::MeshStorage::mesh_instance_free(MeshStorage *this,ulong param_2)

{
  ...
  if (param_2 != 0) {
    ...
    if (uVar12 < *(uint *)(this + 500)) {
      pMVar13 = (MeshInstance *)
                (*(long *)(*(long *)(this + 0x1e0) +
                          ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x1f0)) * 8) +
                ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x1f0)) * 0xa8);
      ...
      *(undefined8 *)(pMVar13 + 0x30) = 0;
      if (uVar12 < *(uint *)(this + 500)) {
        ...
        if (iVar2 < 0) {
          ...
          *(undefined4 *)(*(long *)(*(long *)(this + 0x1e0) + uVar6 * 8) + 0xa0 + lVar9) =
               0xffffffff;
      ...
      uVar11 = 0x161;
LAB_00110c1a:
      lVar9 = _err_print_error(&_LC111,"./core/templates/rid_owner.h",uVar11,
                               "Method/function failed.",0,0);
      return lVar9;
    }
  }
...
/* GLES3::MeshStorage::mesh_set_shadow_mesh(RID, RID) */

void __thiscall
GLES3::MeshStorage::mesh_set_shadow_mesh(MeshStorage *this,ulong param_2,ulong param_3)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (param_3 == param_2) {
    _err_print_error("mesh_set_shadow_mesh","drivers/gles3/storage/mesh_storage.cpp",0x32b,
                     "Condition \"p_mesh == p_shadow_mesh\" is true.",
                     "Cannot set a mesh as its own shadow mesh.",0,0);
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      return;
    }
  }
      ...
      if (*(int *)(lVar1 + 0xd0) == (int)(param_2 >> 0x20)) {
        if (*(long *)(lVar1 + 0x68) != 0) {
          ...
          if ((uint)uVar34 < *(uint *)(this + 0x19c)) {
            lVar2 = *(long *)(*(long *)(this + 0x188) +
                             ((uVar34 & 0xffffffff) / (ulong)*(uint *)(this + 0x198)) * 8) +
                    ((uVar34 & 0xffffffff) % (ulong)*(uint *)(this + 0x198)) * 0xd8;
            if (*(int *)(lVar2 + 0xd0) == (int)(uVar34 >> 0x20)) {
              ...
              if ((lVar8 != 0) && (*(int *)(lVar2 + 0x94) != 0)) {
                ...
                if (uVar45 != 0) {
                  uVar41 = 0;
LAB_00110ec5:
                  if (uVar45 != (uint)uVar43) goto LAB_00110e78;
                  ...
                  if ((*puVar44 == 0) ||
                     (auVar18._8_8_ = 0, auVar18._0_8_ = (ulong)*puVar44 * lVar10, auVar28._8_8_ = 0
                     , auVar28._0_8_ = uVar42, auVar19._8_8_ = 0,
                     auVar19._0_8_ =
                          (ulong)((uVar33 + uVar37) - SUB164(auVar18 * auVar28,8)) * lVar10,
                     auVar29._8_8_ = 0, auVar29._0_8_ = uVar42, SUB164(auVar19 * auVar29,8) == 0)) {
                    uVar46 = (ulong)uVar41;
                  }
                  else {
                    while( true ) {
                      ...
                      *puVar4 = uVar41;
                      ...
                      puVar44 = (uint *)(lVar9 + lVar38);
                      if ((*puVar44 == 0) ||
                         (auVar20._8_8_ = 0, auVar20._0_8_ = (ulong)*puVar44 * lVar10,
                         auVar30._8_8_ = 0, auVar30._0_8_ = uVar42, auVar21._8_8_ = 0,
                         auVar21._0_8_ =
                              (ulong)((SUB164(auVar22 * auVar32,8) + uVar33) -
                                     SUB164(auVar20 * auVar30,8)) * lVar10, auVar31._8_8_ = 0,
                         auVar31._0_8_ = uVar42, SUB164(auVar21 * auVar31,8) == 0)) break;
                      uVar43 = uVar46;
                  ...
                  *(uint *)(lVar2 + 0x94) = uVar33;
                  if (uVar45 < uVar33) {
                    ...
                    *(undefined8 *)(lVar8 + uVar34 * 8) = *(undefined8 *)(lVar8 + (ulong)uVar33 * 8)
                    ;
                    *puVar3 = uVar41;
                    *(uint *)(lVar11 + (ulong)*(uint *)(lVar12 + (ulong)*(uint *)(lVar2 + 0x94) * 4)
                                       * 4) = uVar45;
                  }
                }
              }
...
LAB_00111040:
        *(ulong *)(lVar1 + 0x68) = param_3;
        if (param_3 != 0) {
          uVar34 = *(ulong *)(lVar1 + 0x68);
          if ((uint)uVar34 < *(uint *)(this + 0x19c)) {
            iVar36 = *(int *)(*(long *)(*(long *)(this + 0x188) +
                                       ((uVar34 & 0xffffffff) / (ulong)*(uint *)(this + 0x198)) * 8)
                              + ((uVar34 & 0xffffffff) % (ulong)*(uint *)(this + 0x198)) * 0xd8 +
                             0xd0);
            if (iVar36 == (int)(uVar34 >> 0x20)) {
              HashSet<GLES3::Mesh*,HashMapHasherDefault,HashMapComparatorDefault<GLES3::Mesh*>>::
              insert(local_58);
            }
    ...
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error("mesh_set_shadow_mesh","drivers/gles3/storage/mesh_storage.cpp",0x32d,
                       "Parameter \"mesh\" is null.",0,0);
      return;
    }
  }
...
LAB_00110e78:
  ...
  if ((uVar45 == 0) ||
     (auVar15._8_8_ = 0, auVar15._0_8_ = (ulong)uVar45 * lVar10, auVar25._8_8_ = 0,
     auVar25._0_8_ = uVar42, auVar16._8_8_ = 0,
     auVar16._0_8_ = (ulong)((uVar33 + iVar36) - SUB164(auVar15 * auVar25,8)) * lVar10,
     auVar26._8_8_ = 0, auVar26._0_8_ = uVar42, SUB164(auVar16 * auVar26,8) < uVar41))
  goto LAB_00111040;
  goto LAB_00110ec5;
}
...
LAB_00111495:
    ...
    vformat<unsigned_int,char_const*>
              ((String *)&local_58,(uint)(StrRange *)&local_60,(char *)(ulong)uVar3);
...
LAB_001115e3:
    if ((uint)uVar5 < (uint)uVar8) goto LAB_0011162c;
    lVar7 = 0;
    while( true ) {
      Memory::free_static((void *)puVar9[lVar7],false);
      lVar2 = lVar7 * 8;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::MeshStorage::mesh_instance_create(RID) */

ulong __thiscall GLES3::MeshStorage::mesh_instance_create(MeshStorage *this,ulong param_2)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x19c))) {
    pMVar1 = (Mesh *)(*(long *)(*(long *)(this + 0x188) +
                     ...
                     ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x198)) * 0xd8);
    if (*(int *)(pMVar1 + 0xd0) == (int)(param_2 >> 0x20)) {
      uVar7 = RID_Alloc<GLES3::MeshInstance,false>::make_rid
                        ((RID_Alloc<GLES3::MeshInstance,false> *)(this + 0x1d8));
      if ((uVar7 != 0) && ((uint)uVar7 < *(uint *)(this + 500))) {
        pMVar2 = (MeshInstance *)
                 (*(long *)(*(long *)(this + 0x1e0) +
                           ((uVar7 & 0xffffffff) / (ulong)*(uint *)(this + 0x1f0)) * 8) +
                 ((uVar7 & 0xffffffff) % (ulong)*(uint *)(this + 0x1f0)) * 0xa8);
        ...
        if (*(int *)(pMVar2 + 0xa0) + 0x80000000U < 0x7fffffff) {
          _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                           "Method/function failed. Returning: nullptr",
                           "Attempting to use an uninitialized RID",0,0,uVar7 >> 0x20);
        }
      }
                    /* WARNING: Does not return */
  ...
  _err_print_error("mesh_instance_create","drivers/gles3/storage/mesh_storage.cpp",0x446,
                   "Parameter \"mesh\" is null.",0,0);
  return 0;
}
...
/* GLES3::MeshStorage::skeleton_update_dependency(RID, DependencyTracker*) */

void __thiscall
GLES3::MeshStorage::skeleton_update_dependency(MeshStorage *this,ulong param_2,Dependency *param_3)

{
  ...
  if (param_2 != 0) {
    if ((uint)param_2 < *(uint *)(this + 0x2cc)) {
      lVar4 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x2c8)) * 0x90 +
              *(long *)(*(long *)(this + 0x2b8) +
                       ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x2c8)) * 8);
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    _err_print_error("skeleton_update_dependency","drivers/gles3/storage/mesh_storage.cpp",0x975,
                     "Parameter \"skeleton\" is null.",0,0);
    return;
  }
LAB_00111b83:
...
/* CowData<RenderingServer::SurfaceData::LOD>::_copy_on_write() [clone .isra.0] */

void __thiscall
CowData<RenderingServer::SurfaceData::LOD>::_copy_on_write
          (CowData<RenderingServer::SurfaceData::LOD> *this)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::MeshStorage::mesh_add_surface(RID, RenderingServer::SurfaceData const&) */

void __thiscall
GLES3::MeshStorage::mesh_add_surface(MeshStorage *this,ulong param_2,undefined4 *param_3)
    ...
    if (*(int *)(pMVar2 + 0xd0) == (int)(param_2 >> 0x20)) {
      if (*(int *)(pMVar2 + 0x10) == 0x100) {
        if (*(long *)(in_FS_OFFSET + 0x28) == *(long *)(in_FS_OFFSET + 0x28)) {
          uVar22 = 0x6f;
          pcVar17 = 
          "Condition \"mesh->surface_count == RenderingServer::MAX_MESH_SURFACES\" is true.";
          goto LAB_00113a49;
        }
        goto LAB_001147af;
      }
      iVar31 = 0;
      iVar29 = 0;
      uVar32 = *(ulong *)(param_3 + 2);
      uVar16 = 0;
LAB_001121f0:
      do {
        if ((uVar32 >> (uVar16 & 0x3f) & 1) != 0) {
LAB_001121f8:
          switch(uVar16 & 0xffffffff) {
          default:
            if ((uVar32 & 0x22000000) == 0) {
              iVar29 = iVar29 + 0xc;
              uVar16 = uVar16 + 1;
            }
            else {
...
switchD_00112208_caseD_3:
          ...
          case 10:
            iVar19 = (-(uint)((uVar32 & 0x8000000) == 0) & 0xfffffff0) + 0x20;
            goto LAB_001122c4;
          }
          goto LAB_001121f0;
        }
...
LAB_001122c4:
      ...
      if (iVar29 * iVar3 == lVar25) {
        if (*(long *)(param_3 + 0x34) == 0) {
          lVar25 = 0;
        }
        else {
          lVar25 = *(long *)(*(long *)(param_3 + 0x34) + -8);
        }
        if (iVar29 * iVar3 * *(int *)pMVar2 != lVar25) {
          local_168 = 0;
          local_158 = ")";
          local_150 = 1;
          ...
          itos((long)&local_198);
          operator+((char *)&local_190,(String *)"Size of blend shape data provided (");
        ...
        if (iVar31 * iVar3 != lVar34) {
          ...
          String::parse_latin1((StrRange *)&local_188);
          itos((long)&local_198);
          operator+((char *)&local_190,(String *)"Size of attribute data provided (");
          String::operator+((String *)&local_180,(String *)&local_190);
          String::operator+((String *)&local_170,(String *)&local_180);
          String::operator+((String *)&local_158,(String *)&local_170);
        ...
        if ((~uVar32 & 0xc00) == 0) {
          if (*(long *)(param_3 + 0xe) == 0) {
            ...
            lVar34 = *(long *)(*(long *)(param_3 + 0xe) + -8);
          }
          if (iVar3 * iVar19 != lVar34) {
            local_168 = 0;
            local_158 = ")";
            local_150 = 1;
            String::parse_latin1((StrRange *)&local_168);
            ...
            String::parse_latin1((StrRange *)&local_188);
            itos((long)&local_198);
            operator+((char *)&local_190,(String *)"Size of skin data provided (");
            String::operator+((String *)&local_180,(String *)&local_190);
            String::operator+((String *)&local_170,(String *)&local_180);
            String::operator+((String *)&local_158,(String *)&local_170);
        ...
        if (lVar13 != 0) {
          CowData<unsigned_char>::_ref
                    ((CowData<unsigned_char> *)apvStack_120,(CowData *)(param_3 + 6));
          lVar25 = *(long *)(param_3 + 10);
        }
        local_110[0] = 0;
        if (lVar25 != 0) {
          CowData<unsigned_char>::_ref
                    ((CowData<unsigned_char> *)local_110,(CowData *)(param_3 + 10));
        }
        local_100 = 0;
        if (*(long *)(param_3 + 0xe) != 0) {
          CowData<unsigned_char>::_ref
                    ((CowData<unsigned_char> *)&local_100,(CowData *)(param_3 + 0xe));
        }
        local_e8 = 0;
        local_f8 = param_3[0x10];
        if (*(long *)(param_3 + 0x14) != 0) {
          CowData<unsigned_char>::_ref
                    ((CowData<unsigned_char> *)&local_e8,(CowData *)(param_3 + 0x14));
        }
        local_b8[0] = 0;
        ...
        if (*(long *)(param_3 + 0x20) != 0) {
          CowData<RenderingServer::SurfaceData::LOD>::_unref
                    ((CowData<RenderingServer::SurfaceData::LOD> *)local_b8);
          if (*(long *)(param_3 + 0x20) != 0) {
...
LAB_001124cc:
        ...
        if (*(long *)(param_3 + 0x34) != 0) {
          CowData<unsigned_char>::_ref
                    ((CowData<unsigned_char> *)&local_68,(CowData *)(param_3 + 0x34));
        }
        local_60 = *(undefined8 *)(param_3 + 0x36);
        uStack_58 = *(undefined8 *)(param_3 + 0x38);
        local_50 = *(undefined8 *)(param_3 + 0x3a);
        if ((uVar32 & 0x7f800000000) == 0x800000000) {
LAB_0011264a:
          piVar9 = (int *)operator_new(0x120,"");
          ...
          *(undefined1 (*) [16])(piVar9 + 0x22) = (undefined1  [16])0x0;
          auVar36 = ZEXT416(_LC54);
          *(undefined1 (*) [16])(piVar9 + 0x32) = auVar36;
          *(undefined1 (*) [16])(piVar9 + 0x36) = auVar36;
          *piVar9 = 0;
          piVar9[2] = 0;
          piVar9[3] = 0;
          piVar9[8] = 0;
...
LAB_00112817:
                ...
                puVar10 = (undefined8 *)Memory::alloc_static(uVar32,false);
...
LAB_0011286c:
                if (apvStack_120[0] == (void *)0x0) {
                  ...
                  sVar33 = *(size_t *)((long)apvStack_120[0] + -8);
                }
              }
              else {
                sVar33 = *(long *)((long)apvStack_120[0] + -8) + 4;
                if ((long)sVar33 < 0) {
                  _err_print_error("resize","./core/templates/cowdata.h",0x157,
              ...
              (*_glad_glBufferData)
                        (0x8892,uVar16,puVar10,
                         (-(uint)((*(ulong *)(piVar9 + 2) & 0x4000000) == 0) & 0xfffffffc) + 0x88e8)
              ;
              ...
              *plVar1 = *plVar1 + -1;
              ...
              local_158 = (char *)CONCAT44(local_158._4_4_,piVar9[4]);
              (*_glad_glBufferData)
                        (0x8892,uVar32,apvStack_120[0],
                         (-(uint)((*(ulong *)(piVar9 + 2) & 0x4000000) == 0) & 0xfffffffc) + 0x88e8)
              ;
              plVar1 = (long *)(lVar13 + 0xf8);
              *plVar1 = *plVar1 + uVar32;
              puVar12 = (uint *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                                ::operator[]((HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                                              *)(lVar13 + 0x68),(uint *)&local_158);
              lVar13 = local_168;
              *puVar12 = uVar7;
              ...
              if (apvStack_120[0] == (void *)0x0) {
                ...
                iVar29 = *(int *)((long)apvStack_120[0] + -8);
              }
              piVar9[8] = iVar29;
            }
          }
joined_r0x0011299b:
          if ((local_110[0] != 0) && (*(long *)(local_110[0] + -8) != 0)) {
...
LAB_00112da0:
            if (local_f8 == 0) {
              _err_print_error("mesh_add_surface","drivers/gles3/storage/mesh_storage.cpp",0x11f,
                               "Condition \"!new_surface.index_count && !new_surface.vertex_count\" is true."
                               ,"Meshes must contain a vertex array, an index array, or both",0,0);
              goto LAB_00114366;
            }
          }
          else {
            ...
            if (local_e8 == 0) {
              ...
              uVar32 = (ulong)*(uint *)(local_e8 + -8);
            }
            local_158 = (char *)CONCAT44(local_158._4_4_,piVar9[0x1f]);
            (*_glad_glBufferData)(0x8893,uVar32,local_e8,0x88e4);
            plVar1 = (long *)(lVar13 + 0xf8);
            *plVar1 = *plVar1 + uVar32;
            puVar11 = (undefined4 *)
                      HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
            ...
            *puVar11 = (int)uVar32;
            ...
            if (local_e8 == 0) {
              ...
              iVar29 = *(int *)(local_e8 + -8);
            }
            piVar9[0x21] = iVar29;
            if ((local_b8[0] != 0) && (lVar13 = *(long *)(local_b8[0] + -8), lVar13 != 0)) {
              ...
              *(undefined4 **)(piVar9 + 0x24) = puVar11;
              if (local_b8[0] == 0) {
                ...
                lVar25 = (-(ulong)(uVar7 - 1 < 0x10000) & 0xfffffffffffffffe) + 4;
                for (lVar34 = 0; lVar34 < lVar13; lVar34 = lVar34 + 1) {
                  lVar24 = lVar34 * 0x10;
                  (*_glad_glGenBuffers)(1,*(long *)(piVar9 + 0x24) + lVar24 + 0xc,puVar20);
                  (*_glad_glBindBuffer)
                            (0x8893,*(undefined4 *)(*(long *)(piVar9 + 0x24) + 0xc + lVar24));
                  ...
                  String::parse_latin1((StrRange *)&local_168);
                  itos((long)&local_178);
                  operator+((char *)&local_170,(String *)"Mesh index buffer LOD[");
                  String::operator+((String *)&local_158,(String *)&local_170);
                  if (local_b8[0] == 0) {
LAB_001136d6:
                    lVar13 = 0;
LAB_001136de:
                    _err_print_index_error
                              ("get","./core/templates/cowdata.h",0xdb,lVar34,lVar13,"p_index",
                               "size()","",false,true);
                    _err_flush_stdout();
                    /* WARNING: Does not return */
                    pcVar5 = (code *)invalidInstructionException();
                  ...
                  lVar13 = *(long *)(local_b8[0] + -8);
                  if (lVar13 <= lVar34) goto LAB_001136de;
                  lVar13 = *(long *)(local_b8[0] + 0x10 + lVar34 * 0x18);
                  if (lVar13 == 0) {
                    local_1c8 = 0;
                    uVar32 = 0;
                  }
                    ...
                    uVar32 = (ulong)local_1c8;
                  }
                  local_180 = CONCAT44(local_180._4_4_,
                                       *(undefined4 *)(*(long *)(piVar9 + 0x24) + 0xc + lVar24));
                  (*_glad_glBufferData)(0x8893,uVar32,lVar13,0x88e4);
                  ...
                  *puVar12 = local_1c8;
                  ...
                  lVar13 = *(long *)(local_b8[0] + -8);
                  if (lVar13 <= lVar34) goto LAB_001136de;
                  puVar11 = (undefined4 *)(local_b8[0] + lVar34 * 0x18);
                  puVar23 = (undefined4 *)(lVar24 + *(long *)(piVar9 + 0x24));
                  ...
                  *puVar23 = *puVar11;
                  if (lVar18 == 0) {
                    ...
                    uVar6 = (undefined4)(lVar18 / lVar25);
                    puVar20 = (undefined4 *)(lVar18 % lVar25);
                  }
                  puVar23[1] = uVar6;
                  puVar23[2] = (int)lVar18;
                }
              }
            }
          ...
          if ((*(char *)(Config::singleton + 0x40) != '\0') && (*piVar9 == 3)) {
            ...
            *(undefined8 **)(piVar9 + 0x22) = puVar10;
            ...
            if ((uStack_130 & 0x1000) == 0) {
              iVar29 = piVar9[7];
              *(int *)((long)puVar10 + 4) = iVar29 * 2;
              CowData<unsigned_int>::resize<false>
                        ((CowData<unsigned_int> *)&local_160,(ulong)(uint)(iVar29 * 2));
              ...
              if (5 < uVar7) {
                ...
                do {
                  uVar7 = uVar27 - 5 >> 1;
                  *(uint *)((long)local_160 + (ulong)(uVar27 - 5) * 4) = uVar7;
                  *(uint *)((long)local_160 + (ulong)(uVar27 - 4) * 4) = uVar7 + 1;
                  *(uint *)((long)local_160 + (ulong)(uVar27 - 3) * 4) = uVar7 + 1;
                  *(uint *)((long)local_160 + (ulong)(uVar27 - 2) * 4) = uVar7 + 2;
                  *(uint *)((long)local_160 + (ulong)(uVar27 - 1) * 4) = uVar7 + 2;
                  uVar32 = (ulong)uVar27;
                  uVar27 = uVar27 + 6;
                  *(uint *)((long)local_160 + uVar32 * 4) = uVar7;
                  uVar7 = *(uint *)((long)puVar10 + 4);
                } while (uVar27 < uVar7);
              }
            }
...
LAB_001145f0:
              ...
              if (local_f8 < 0x10001) {
                ...
                if (5 < *(uint *)((long)puVar10 + 4)) {
                  do {
                    uVar26 = uVar7 - 5 >> 1;
                    uVar28 = (uint)*(ushort *)(lVar13 + (ulong)uVar26 * 2);
                    *(uint *)((long)local_160 + (ulong)(uVar7 - 5) * 4) = uVar28;
                    uVar27 = (uint)*(ushort *)(lVar13 + (ulong)(uVar26 + 1) * 2);
                    *(uint *)((long)local_160 + (ulong)(uVar7 - 4) * 4) = uVar27;
                    *(uint *)((long)local_160 + (ulong)(uVar7 - 3) * 4) = uVar27;
                    uVar27 = (uint)*(ushort *)(lVar13 + (ulong)(uVar26 + 2) * 2);
                    *(uint *)((long)local_160 + (ulong)(uVar7 - 2) * 4) = uVar27;
                    *(uint *)((long)local_160 + (ulong)(uVar7 - 1) * 4) = uVar27;
                    uVar32 = (ulong)uVar7;
                    uVar7 = uVar7 + 6;
                    *(uint *)((long)local_160 + uVar32 * 4) = uVar28;
          ...
          *(undefined8 *)(piVar9 + 0x32) = *(undefined8 *)(param_3 + 0x26);
          *(undefined8 *)(piVar9 + 0x34) = uVar22;
          uVar22 = *(undefined8 *)(param_3 + 0x2c);
          *(undefined8 *)(piVar9 + 0x36) = *(undefined8 *)(param_3 + 0x2a);
          *(undefined8 *)(piVar9 + 0x38) = uVar22;
          uVar22 = *(undefined8 *)(param_3 + 0x30);
          *(undefined8 *)(piVar9 + 0x3a) = *(undefined8 *)(param_3 + 0x2e);
          *(undefined8 *)(piVar9 + 0x3c) = uVar22;
          *(undefined8 *)(piVar9 + 0x3e) = local_60;
          *(undefined8 *)(piVar9 + 0x40) = uStack_58;
          if (((local_100 == 0) || (*(long *)(local_100 + -8) == 0)) && (uVar7 == 0)) {
            iVar29 = *(int *)(pMVar2 + 0x10);
            if (iVar29 != 0) goto LAB_0011301e;
LAB_00112e83:
            *(undefined8 *)(pMVar2 + 0x28) = local_cc;
            ...
            *(undefined8 *)(pMVar2 + 0x20) = uStack_d4;
            ...
            if (apvStack_120[0] == (void *)0x0) {
              ...
              uVar32 = *(ulong *)((long)apvStack_120[0] + -8);
            }
            if ((uStack_130 & 1) == 0) {
              iVar29 = 0;
              cVar30 = '\0';
              ...
              cVar30 = (-((uStack_130 & 0x20000000) == 0) & 4U) + 8;
              iVar29 = 4 - (uint)((uStack_130 & 0x20000000) == 0);
            }
            else {
              iVar29 = 2;
              cVar30 = '\b';
            ...
            if (uVar7 != 0) {
              ...
              *(undefined8 **)(piVar9 + 0x42) = puVar10;
              if (iVar19 != 0) {
                ...
                while( true ) {
                  lVar25 = lVar13 * 8;
                  (*_glad_glGenVertexArrays)(1,(long)puVar10 + lVar25 + 4);
                  (*_glad_glBindVertexArray)(*(undefined4 *)(*(long *)(piVar9 + 0x42) + 4 + lVar25))
                  ;
                  (*_glad_glGenBuffers)(1,lVar25 + *(long *)(piVar9 + 0x42));
                  (*_glad_glBindBuffer)
                            (0x8892,*(undefined4 *)(*(long *)(piVar9 + 0x42) + lVar13 * 8));
                  lVar25 = Utilities::singleton;
                  local_158 = "Mesh blend shape buffer";
                  local_168 = 0;
                  local_150 = 0x17;
                  String::parse_latin1((StrRange *)&local_168);
                  local_158 = (char *)CONCAT44(local_158._4_4_,
                                               *(undefined4 *)
                                                (*(long *)(piVar9 + 0x42) + lVar13 * 8));
                  (*_glad_glBufferData)
                            (0x8892,uVar32 & 0xffffffff,uVar16 + local_68,
                             (-(uint)((*(ulong *)(piVar9 + 2) & 0x4000000) == 0) & 0xfffffffc) +
                             0x88e8);
                  plVar1 = (long *)(lVar25 + 0xf8);
                  *plVar1 = *plVar1 + (uVar32 & 0xffffffff);
                  piVar15 = (int *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                                   ::operator[]((HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                                                 *)(lVar25 + 0x68),(uint *)&local_158);
                  lVar25 = local_168;
                  *piVar15 = (int)uVar32;
                  if (local_168 != 0) {
                    LOCK();
                  ...
                  if ((uStack_130 & 1) != 0) {
                    ...
                    (*_glad_glVertexAttribPointer)(3,iVar29,0x1406,0,cVar30,0);
                  }
                  if ((uStack_130 & 2) != 0) {
                    (*_glad_glEnableVertexAttribArray)(4);
                    (*_glad_glVertexAttribPointer)(4,2,0x1403,1,iVar31);
                  }
                  if ((*(byte *)(param_3 + 2) & 4) != 0) {
                    (*_glad_glEnableVertexAttribArray)(5);
                    (*_glad_glVertexAttribPointer)(5,2,0x1403,1,iVar31);
                  }
                  lVar13 = lVar13 + 1;
                  uVar16 = (ulong)(uint)((int)uVar16 + (int)uVar32);
            ...
            (*_glad_glBindBuffer)(0x8892,0);
            iVar29 = *(int *)(pMVar2 + 0x10);
            if (iVar29 == 0) goto LAB_00112e83;
LAB_0011301e:
            AABB::merge_with((AABB *)(pMVar2 + 0x18));
            iVar29 = *(int *)(pMVar2 + 0x10);
          }
          *(undefined8 *)(pMVar2 + 0x48) = 0;
          pvVar4 = *(void **)(pMVar2 + 8);
          *(undefined8 *)(piVar9 + 0x46) = local_50;
          lVar13 = Memory::realloc_static(pvVar4,(ulong)(iVar29 + 1) << 3,false);
          uVar7 = *(uint *)(pMVar2 + 0x10);
          plVar1 = *(long **)(pMVar2 + 0x60);
          *(long *)(pMVar2 + 8) = lVar13;
          *(int **)(lVar13 + (ulong)uVar7 * 8) = piVar9;
          iVar29 = uVar7 + 1;
          *(int *)(pMVar2 + 0x10) = iVar29;
          if ((plVar1 != (long *)0x0) &&
             (puVar10 = (undefined8 *)*plVar1, puVar10 != (undefined8 *)0x0)) {
            while( true ) {
              _mesh_instance_add_surface(this,(MeshInstance *)*puVar10,pMVar2,iVar29 - 1);
          ...
          iVar29 = *(int *)(pMVar2 + 0x94);
          if (iVar29 != 0) {
            lVar13 = *(long *)(pMVar2 + 0x70);
            lVar25 = 0;
            while( true ) {
              lVar34 = *(long *)(lVar13 + lVar25 * 8);
              *(undefined8 *)(lVar34 + 0x68) = 0;
              Dependency::changed_notify(lVar34 + 0xa0);
              if (iVar29 <= (int)lVar25 + 1) break;
              lVar25 = lVar25 + 1;
            }
          }
          ...
          uVar32 = uStack_130 & 0x7f800000000;
          if (uVar32 == 0x800000000) goto LAB_0011264a;
          local_168 = 0;
          local_158 = "Surface version provided (%d) does not match current version (%d).";
          local_150 = 0x42;
          String::parse_latin1((StrRange *)&local_168);
          vformat<unsigned_long,unsigned_long>
                    ((String *)&local_158,(ulong)&local_168,uVar32 >> 0x23);
          _err_print_error("mesh_add_surface","drivers/gles3/storage/mesh_storage.cpp",0xce,
                           "Condition \"surface_version != RenderingServer::ARRAY_FLAG_FORMAT_CURRENT_VERSION\" is true."
...
LAB_00114366:
        ...
        String::parse_latin1((StrRange *)&local_188);
        itos((long)&local_198);
        operator+((char *)&local_190,(String *)"Size of vertex data provided (");
        String::operator+((String *)&local_180,(String *)&local_190);
        String::operator+((String *)&local_170,(String *)&local_180);
        String::operator+((String *)&local_158,(String *)&local_170);
        ...
        uVar22 = 0xb2;
LAB_00113bcb:
        _err_print_error("mesh_add_surface","drivers/gles3/storage/mesh_storage.cpp",uVar22,pcVar17,
                         &local_158,0,0);
        pcVar17 = local_158;
        if (local_158 != (char *)0x0) {
          LOCK();
...
LAB_00113a49:
    _err_print_error("mesh_add_surface","drivers/gles3/storage/mesh_storage.cpp",uVar22,pcVar17,0,0)
    ;
    return;
  }
LAB_001147af:
                    /* WARNING: Subroutine does not return */
  __stack_chk_fail();
switchD_00112208_caseD_6:
  local_148 = __LC113;
  uStack_140 = _UNK_001257c8;
  lVar13 = uVar16 * 4;
  uVar16 = uVar16 + 1;
  local_138 = __LC114;
  uStack_130 = _UNK_001257d8;
  local_128 = __LC115;
  apvStack_120[0] = _UNK_001257e8;
  iVar31 = iVar31 + *(int *)((long)&local_138 +
                            (ulong)((uint)(uVar32 >>
                                          ((byte)*(undefined4 *)((long)&local_160 + lVar13) & 0x3f))
                                   & 7) * 4);
  if ((uVar32 >> (uVar16 & 0x3f) & 1) == 0) goto LAB_00112268;
  goto LAB_001121f8;
}
...
/* GLES3::MeshStorage::_multimesh_get_buffer(RID) const */

long GLES3::MeshStorage::_multimesh_get_buffer(long param_1,long param_2,ulong param_3)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((param_3 != 0) && ((uint)param_3 < *(uint *)(param_2 + 0x26c))) {
    lVar13 = ((param_3 & 0xffffffff) % (ulong)*(uint *)(param_2 + 0x268)) * 0x118 +
             *(long *)(*(long *)(param_2 + 600) +
                      ((param_3 & 0xffffffff) / (ulong)*(uint *)(param_2 + 0x268)) * 8);
        ...
        *(undefined8 *)(param_1 + 8) = 0;
        ...
        if ((lVar14 == 0) || (*(long *)(lVar14 + -8) == 0)) {
          ...
          CowData<float>::resize<false>
                    ((CowData<float> *)&local_80,
                     (ulong)(uint)(*(int *)(lVar13 + 8) * *(int *)(lVar13 + 0x4c)));
...
LAB_00114b7c:
        ...
        local_70 = (void *)0x0;
        CowData<float>::resize<false>
                  ((CowData<float> *)&local_70,(long)(*(int *)(lVar13 + 8) * iVar9));
        ...
        if (0 < *(int *)(lVar13 + 8)) {
          do {
            ...
            puVar2 = (undefined8 *)
                     ((long)pvVar18 + (ulong)(uint)(iVar11 * *(int *)(lVar13 + 0x4c)) * 4);
            local_58 = puVar2[2];
            uStack_50 = puVar2[3];
            local_68 = *puVar2;
            uStack_60 = puVar2[1];
            ...
            *puVar2 = local_68;
            ...
            if (*(int *)(lVar13 + 0xc) == 1) {
              puVar2 = (undefined8 *)
                       ((long)pvVar18 + (ulong)(uint)(iVar11 * *(int *)(lVar13 + 0x4c)) * 4 + 0x20);
              uVar7 = puVar2[1];
            ...
            if (bVar4 != 0) {
              puVar17 = (uint *)(lVar14 + 0x30 +
                                 (-(ulong)(*(int *)(lVar13 + 0xc) == 0) & 0xfffffffffffffff0) +
                                (long)local_70);
              uVar5 = *(ulong *)((long)pvVar18 +
                                ((ulong)(uint)(iVar11 * *(int *)(lVar13 + 0x4c)) +
                                (ulong)*(uint *)(lVar13 + 0x50)) * 4);
              uVar16 = (uint)uVar5;
            ...
            if (*(char *)(lVar13 + 0x11) != '\0') {
              puVar17 = (uint *)((-(ulong)(*(int *)(lVar13 + 0xc) == 0) & 0xfffffffffffffff0) + 0x30
                                 + (ulong)bVar4 * 0x10 + lVar14 + (long)local_70);
              uVar5 = *(ulong *)((long)pvVar18 +
                                ((ulong)(uint)(iVar11 * *(int *)(lVar13 + 0x4c)) +
                                (ulong)*(uint *)(lVar13 + 0x54)) * 4);
              uVar16 = (uint)uVar5;
              uVar19 = (uVar16 & 0x8000) * 0x10000;
              if ((uVar5 & 0x7c00) == 0) {
                if ((uVar5 & 0x3ff) != 0) {
  ...
  _err_print_error("_multimesh_get_buffer","drivers/gles3/storage/mesh_storage.cpp",0x806,
                   "Parameter \"multimesh\" is null.",0,0);
  *(undefined8 *)(param_1 + 8) = 0;
LAB_00114ab7:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::MeshStorage::_multimesh_set_buffer(RID, Vector<float> const&) */

void __thiscall
GLES3::MeshStorage::_multimesh_set_buffer(MeshStorage *this,ulong param_2,long param_3)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x26c))) {
    plVar17 = (long *)(((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x268)) * 0x118 +
                      *(long *)(*(long *)(this + 600) +
                               ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x268)) * 8));
...
LAB_001154c9:
        ...
        if ((int)plVar17[1] * *(int *)((long)plVar17 + 0x4c) != lVar22) {
          if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
            uVar16 = 0x7df;
            pcVar12 = 
            "Condition \"p_buffer.size() != (multimesh->instances * (int)multimesh->stride_cache)\" is true."
            ;
            goto LAB_001161d9;
          }
          goto LAB_0011647a;
        ...
        if (((lVar21 == 0) || (uVar13 = (uint)bVar4, *(long *)(lVar21 + -8) < 1)) &&
           (uVar13 = (uint)bVar4, iVar28 != 0)) {
          CowData<float>::resize<false>
                    ((CowData<float> *)(plVar17 + 0xc),
                     (ulong)(uint)(iVar28 * *(int *)((long)plVar17 + 0x4c)));
          ...
          if (*(char *)((long)plVar17 + 0x49) == '\0') {
            ...
            GLES3::Utilities::buffer_get_data
                      ((uint)local_128,0x8892,*(uint *)((long)plVar17 + 0x74));
        ...
        iVar9 = (-(uint)(*(int *)((long)plVar17 + 0xc) == 0) & 0xfffffffc) + 0xc +
                (uVar13 + *(byte *)((long)plVar17 + 0x11)) * 4;
        ...
        if (iVar28 * iVar9 != lVar14) {
          if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
            uVar16 = 0x7af;
            pcVar12 = 
            "Condition \"p_buffer.size() != (multimesh->instances * (int)old_stride)\" is true.";
            goto LAB_001161d9;
          }
          goto LAB_0011647a;
        }
        ...
        if (0 < iVar28) {
          ...
          do {
            ...
            uVar6 = puVar2[1];
            puVar2 = (undefined8 *)
                     (lVar21 + (ulong)(uint)(iVar8 * *(int *)((long)plVar17 + 0x4c)) * 4);
            ...
            *puVar2 = local_78;
            ...
            if (*(int *)((long)plVar17 + 0xc) == 1) {
              ...
              uVar16 = puVar2[1];
              puVar3 = (undefined8 *)
                       (lVar21 + 0x20 + (ulong)(uint)(iVar8 * *(int *)((long)plVar17 + 0x4c)) * 4);
              *puVar3 = *puVar2;
              puVar3[1] = uVar16;
            }
            if ((char)plVar17[2] != '\0') {
              puVar26 = (uint *)(lVar14 + 0x30 +
                                 (-(ulong)(*(int *)((long)plVar17 + 0xc) == 0) & 0xfffffffffffffff0)
                                + lVar21);
              uVar13 = *puVar26;
              ...
              if (uVar20 < 0x47800000) {
                ...
                if (0x38000000 < uVar20) {
                  uVar23 = (ushort)((uVar13 >> 0x1f) << 0xf) | (ushort)((uVar13 & 0x7fffff) >> 0xd)
                           | (ushort)(uVar20 + 0xc8000000 >> 0xd);
                }
              }
              else {
              ...
              if (uVar20 < 0x47800000) {
                uVar18 = 0;
                if (0x38000000 < uVar20) {
                  uVar18 = (ushort)((uVar13 >> 0x1f) << 0xf) | (ushort)((uVar13 & 0x7fffff) >> 0xd)
                           | (ushort)(uVar20 + 0xc8000000 >> 0xd);
                }
              }
              else {
              ...
              if (uVar20 < 0x47800000) {
                uVar19 = 0;
                if (0x38000000 < uVar20) {
                  uVar19 = (ushort)((uVar13 >> 0x1f) << 0xf) | (ushort)((uVar13 & 0x7fffff) >> 0xd)
                           | (ushort)(uVar20 + 0xc8000000 >> 0xd);
                }
              }
              else {
              ...
              if (uVar20 < 0x47800000) {
                uVar15 = 0;
                if (0x38000000 < uVar20) {
                  uVar15 = (ulong)(uVar20 + 0xc8000000 >> 0xd |
                                  (uVar13 >> 0x1f) << 0xf | (uVar13 & 0x7fffff) >> 0xd);
                }
              }
              else {
                if (((uVar13 & 0x7fffff) == 0) || (uVar25 = 0x3ff, uVar20 != 0x7f800000)) {
                  uVar25 = 0;
                }
                uVar15 = (ulong)((uVar13 >> 0x1f) << 0xf | uVar25) | 0x7c00;
              }
              *(ulong *)(lVar21 + ((ulong)(uint)(iVar8 * *(int *)((long)plVar17 + 0x4c)) +
                                  (ulong)*(uint *)(plVar17 + 10)) * 4) =
                   (ulong)CONCAT24(uVar19,CONCAT22(uVar18,uVar23)) | uVar15 << 0x30;
            }
            if (*(char *)((long)plVar17 + 0x11) != '\0') {
              puVar26 = (uint *)((-(ulong)(*(int *)((long)plVar17 + 0xc) == 0) & 0xfffffffffffffff0)
                                 + 0x30 + lVar14 + (ulong)*(byte *)(plVar17 + 2) * 0x10 + lVar21);
              uVar13 = *puVar26;
              uVar20 = uVar13 & 0x7f800000;
              if (uVar20 < 0x47800000) {
                uVar23 = 0;
                if (0x38000000 < uVar20) {
                  uVar23 = (ushort)(uVar20 + 0xc8000000 >> 0xd) |
                           (ushort)((uVar13 >> 0x1f) << 0xf) | (ushort)((uVar13 & 0x7fffff) >> 0xd);
                }
              }
              else {
                if (((uVar13 & 0x7fffff) == 0) || (uVar23 = 0x3ff, uVar20 != 0x7f800000)) {
                  uVar23 = 0;
                }
                uVar23 = (ushort)((uVar13 >> 0x1f) << 0xf) | uVar23 | 0x7c00;
              }
              ...
              if (uVar20 < 0x47800000) {
                uVar18 = 0;
                if (0x38000000 < uVar20) {
                  uVar18 = (ushort)(uVar20 + 0xc8000000 >> 0xd) |
                           (ushort)((uVar13 >> 0x1f) << 0xf) | (ushort)((uVar13 & 0x7fffff) >> 0xd);
                }
              }
              else {
                if (((uVar13 & 0x7fffff) == 0) || (uVar18 = 0x3ff, uVar20 != 0x7f800000)) {
                  uVar18 = 0;
                }
                uVar18 = (ushort)((uVar13 >> 0x1f) << 0xf) | uVar18 | 0x7c00;
              }
              ...
              if (uVar20 < 0x47800000) {
                uVar19 = 0;
                if (0x38000000 < uVar20) {
                  uVar19 = (ushort)(uVar20 + 0xc8000000 >> 0xd) |
                           (ushort)((uVar13 >> 0x1f) << 0xf) | (ushort)((uVar13 & 0x7fffff) >> 0xd);
                }
              }
              else {
                if (((uVar13 & 0x7fffff) == 0) || (uVar19 = 0x3ff, uVar20 != 0x7f800000)) {
                  uVar19 = 0;
                }
                uVar19 = (ushort)((uVar13 >> 0x1f) << 0xf) | uVar19 | 0x7c00;
              }
              ...
              *(ulong *)(lVar21 + ((ulong)(uint)(iVar8 * *(int *)((long)plVar17 + 0x4c)) +
                                  (ulong)*(uint *)((long)plVar17 + 0x54)) * 4) =
                   (ulong)CONCAT24(uVar19,CONCAT22(uVar18,uVar23)) | uVar15 << 0x30;
            }
            iVar28 = (int)plVar17[1];
            iVar8 = iVar8 + 1;
      ...
      *(undefined1 *)((long)plVar17 + 0x49) = 1;
      if ((((plVar17[0xc] == 0) || (*(long *)(plVar17[0xc] + -8) == 0)) &&
          ((char)plVar17[2] == '\0')) && (*(char *)((long)plVar17 + 0x11) == '\0')) {
        if (*plVar17 != 0) {
          local_78 = 0;
          uStack_70 = 0;
          uStack_6c = 0;
            ...
            if (*plVar17 == 0) {
              ...
              if (cVar7 == '\0') {
                ...
                if (0 < (int)lVar14) {
                  iVar28 = 0;
                  uVar33 = __LC96;
                  uVar34 = _UNK_00125774;
                  uVar35 = _UNK_00125778;
                  uVar36 = _UNK_0012577c;
                  do {
                    uStack_70 = uVar34;
                    local_54[2] = 0.0;
                    puVar2 = (undefined8 *)
                             (lVar21 + (ulong)(uint)(iVar28 * *(int *)((long)plVar17 + 0x4c)) * 4);
                    uStack_64 = uVar33;
                    ...
                    if (iVar28 == 0) {
                      do {
                        ...
                        fVar32 = fVar30;
                        do {
                          fVar31 = *(float *)((long)&local_118 + lVar11) *
                                   *(float *)(pAVar24 + lVar11);
                          fVar29 = *(float *)(pAVar24 + lVar11) *
                                   *(float *)((long)&local_108 + lVar11);
                          fVar5 = fVar29;
                          if (fVar31 < fVar29) {
                            fVar5 = fVar31;
                            fVar31 = fVar29;
...
LAB_001161d9:
    _err_print_error("_multimesh_set_buffer","drivers/gles3/storage/mesh_storage.cpp",uVar16,pcVar12
                     ,0,0);
    return;
  }
LAB_0011647a:
...
/* GLES3::MeshStorage::_multimesh_instance_get_custom_data(RID, int) const */

undefined1  [16] __thiscall
GLES3::MeshStorage::_multimesh_instance_get_custom_data(MeshStorage *this,ulong param_2,int param_3)
...
LAB_001169c0:
    ...
    lVar12 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x268)) * 0x118 +
             *(long *)(*(long *)(this + 600) +
                      ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x268)) * 8);
    ...
    if ((param_3 < 0) || (iVar14 <= param_3)) {
      _err_print_index_error
                ("_multimesh_instance_get_custom_data","drivers/gles3/storage/mesh_storage.cpp",
                 0x78e,(long)param_3,(long)iVar14,"p_index","multimesh->instances","",false,false);
      local_48 = 0;
    ...
    if (*(char *)(lVar12 + 0x11) != '\0') {
      ...
      if ((lVar10 == 0) || (*(long *)(lVar10 + -8) < 1)) {
        CowData<float>::resize<false>
                  ((CowData<float> *)(lVar12 + 0x60),(ulong)(uint)(iVar14 * *(int *)(lVar12 + 0x4c))
                  );
      ...
      uVar16 = *(ulong *)(lVar10 + ((ulong)(uint)(param_3 * *(int *)(lVar12 + 0x4c)) +
                                   (ulong)*(uint *)(lVar12 + 0x54)) * 4);
      uVar7 = (uint)uVar16;
  ...
  _err_print_error("_multimesh_instance_get_custom_data","drivers/gles3/storage/mesh_storage.cpp",
                   uVar11,pcVar8,0,0);
  local_48 = 0;
  uStack_40 = 0x3f80000000000000;
LAB_001166de:
...
/* GLES3::MeshStorage::_multimesh_instance_get_transform_2d(RID, int) const */

undefined8 *
GLES3::MeshStorage::_multimesh_instance_get_transform_2d
          (undefined8 *param_1,long param_2,ulong param_3,int param_4)
...
LAB_00116d40:
    ...
    lVar12 = ((param_3 & 0xffffffff) % (ulong)*(uint *)(param_2 + 0x268)) * 0x118 +
             *(long *)(*(long *)(param_2 + 600) +
                      ((param_3 & 0xffffffff) / (ulong)*(uint *)(param_2 + 0x268)) * 8);
    ...
    if ((param_4 < 0) || (iVar13 <= param_4)) {
      _err_print_index_error
                ("_multimesh_instance_get_transform_2d","drivers/gles3/storage/mesh_storage.cpp",
                 0x75d,(long)param_4,(long)iVar13,"p_index","multimesh->instances","",false,false);
      *param_1 = 0x3f800000;
      param_1[1] = 0x3f80000000000000;
      param_1[2] = 0;
      goto LAB_00116c25;
    ...
    if (*(int *)(lVar12 + 0xc) == 0) {
      ...
      if ((lVar10 == 0) || (*(long *)(lVar10 + -8) < 1)) {
        CowData<float>::resize<false>
                  ((CowData<float> *)(lVar12 + 0x60),(ulong)(uint)(iVar13 * *(int *)(lVar12 + 0x4c))
                  );
        CowData<float>::_copy_on_write((CowData<float> *)(lVar12 + 0x60));
      ...
      uVar5 = *puVar2;
      uVar6 = puVar2[1];
      param_1[2] = CONCAT44((int)((ulong)*(undefined8 *)(puVar2 + 6) >> 0x20),
                            (int)((ulong)*(undefined8 *)(puVar2 + 2) >> 0x20));
    ...
    uVar11 = 0x75e;
    pcVar9 = 
    "Condition \"multimesh->xform_format != RenderingServer::MULTIMESH_TRANSFORM_2D\" is true. Returning: Transform2D()"
    ;
  }
  _err_print_error("_multimesh_instance_get_transform_2d","drivers/gles3/storage/mesh_storage.cpp",
                   uVar11,pcVar9,0,0);
  *param_1 = 0x3f800000;
  param_1[1] = 0x3f80000000000000;
  param_1[2] = 0;
...
/* GLES3::MeshStorage::_multimesh_instance_set_transform_2d(RID, int, Transform2D const&) */

void __thiscall
GLES3::MeshStorage::_multimesh_instance_set_transform_2d
          (MeshStorage *this,ulong param_2,int param_3,undefined4 *param_4)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x26c))) {
    lVar7 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x268)) * 0x118 +
            *(long *)(*(long *)(this + 600) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x268)) * 8);
    if (*(int *)(lVar7 + 0x110) == (int)(param_2 >> 0x20)) {
      ...
      if ((param_3 < 0) || (iVar10 <= param_3)) {
        _err_print_index_error
                  ("_multimesh_instance_set_transform_2d","drivers/gles3/storage/mesh_storage.cpp",
                   0x6dd,(long)param_3,(long)iVar10,"p_index","multimesh->instances","",false,false)
        ;
      }
      else {
        if (*(int *)(lVar7 + 0xc) != 0) {
          if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
            uVar6 = 0x6de;
            pcVar9 = 
            "Condition \"multimesh->xform_format != RenderingServer::MULTIMESH_TRANSFORM_2D\" is true."
            ;
            goto LAB_00117156;
          }
          goto LAB_00117263;
        ...
        if ((*(long *)(lVar7 + 0x60) == 0) || (*(long *)(*(long *)(lVar7 + 0x60) + -8) < 1)) {
          CowData<float>::resize<false>
                    ((CowData<float> *)(lVar7 + 0x60),(ulong)(uint)(iVar10 * *(int *)(lVar7 + 0x4c))
                    );
        ...
        uVar8 = param_3 >> 9;
        puVar2 = (undefined4 *)
                 (*(long *)(lVar7 + 0x60) + (ulong)(uint)(param_3 * *(int *)(lVar7 + 0x4c)) * 4);
        *puVar2 = *param_4;
        uVar3 = param_4[2];
        puVar2[2] = 0;
        puVar2[1] = uVar3;
        ...
        if (uVar8 < (uint)(iVar10 >> 9)) {
          ...
          *(undefined1 *)(lVar7 + 0x48) = 1;
          ...
          _err_print_index_error
                    ("_multimesh_mark_dirty","drivers/gles3/storage/mesh_storage.cpp",0x666,
                     (long)(int)uVar8,(long)(iVar10 >> 9),"region_index",
                     "data_cache_dirty_region_count","",false,false);
        }
      }
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
  ...
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    ...
    pcVar9 = "Parameter \"multimesh\" is null.";
LAB_00117156:
    _err_print_error("_multimesh_instance_set_transform_2d","drivers/gles3/storage/mesh_storage.cpp"
                     ,uVar6,pcVar9,0,0);
    return;
  }
LAB_00117263:
...
/* GLES3::MeshStorage::_multimesh_instance_get_transform(RID, int) const */

undefined1 (*) [16]
GLES3::MeshStorage::_multimesh_instance_get_transform
          (undefined1 (*param_1) [16],long param_2,ulong param_3,int param_4)
...
LAB_00117540:
    ...
    lVar16 = ((param_3 & 0xffffffff) % (ulong)*(uint *)(param_2 + 0x268)) * 0x118 +
             *(long *)(*(long *)(param_2 + 600) +
                      ((param_3 & 0xffffffff) / (ulong)*(uint *)(param_2 + 0x268)) * 8);
    ...
    if ((param_4 < 0) || (iVar17 <= param_4)) {
      _err_print_index_error
                ("_multimesh_instance_get_transform","drivers/gles3/storage/mesh_storage.cpp",0x73e,
                 (long)param_4,(long)iVar17,"p_index","multimesh->instances","",false,false);
      *(undefined4 *)param_1[2] = 0x3f800000;
      uVar10 = _LC54;
      *(undefined8 *)(param_1[2] + 4) = 0;
      *(undefined4 *)(param_1[2] + 0xc) = 0;
    ...
    if (*(int *)(lVar16 + 0xc) == 1) {
      ...
      if ((lVar14 == 0) || (*(long *)(lVar14 + -8) < 1)) {
        CowData<float>::resize<false>
                  ((CowData<float> *)(lVar16 + 0x60),(ulong)(uint)(iVar17 * *(int *)(lVar16 + 0x4c))
                  );
    ...
    uVar15 = 0x73f;
    pcVar13 = 
    "Condition \"multimesh->xform_format != RenderingServer::MULTIMESH_TRANSFORM_3D\" is true. Returning: Transform3D()"
    ;
  }
  _err_print_error("_multimesh_instance_get_transform","drivers/gles3/storage/mesh_storage.cpp",
                   uVar15,pcVar13,0,0);
  uVar10 = _LC54;
  *(undefined4 *)param_1[2] = 0x3f800000;
  *(undefined8 *)(param_1[2] + 4) = 0;
...
/* GLES3::MeshStorage::_multimesh_instance_set_transform(RID, int, Transform3D const&) */

void __thiscall
GLES3::MeshStorage::_multimesh_instance_set_transform
          (MeshStorage *this,ulong param_2,int param_3,undefined4 *param_4)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x26c))) {
    lVar6 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x268)) * 0x118 +
            *(long *)(*(long *)(this + 600) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x268)) * 8);
    if (*(int *)(lVar6 + 0x110) == (int)(param_2 >> 0x20)) {
      ...
      if ((param_3 < 0) || (iVar9 <= param_3)) {
        _err_print_index_error
                  ("_multimesh_instance_set_transform","drivers/gles3/storage/mesh_storage.cpp",
                   0x6bf,(long)param_3,(long)iVar9,"p_index","multimesh->instances","",false,false);
      }
      else {
        if (*(int *)(lVar6 + 0xc) != 1) {
          if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
            uVar5 = 0x6c0;
            pcVar8 = 
            "Condition \"multimesh->xform_format != RenderingServer::MULTIMESH_TRANSFORM_3D\" is true."
            ;
            goto LAB_00117986;
          }
          goto LAB_00117a93;
        ...
        if ((*(long *)(lVar6 + 0x60) == 0) || (*(long *)(*(long *)(lVar6 + 0x60) + -8) < 1)) {
          CowData<float>::resize<false>
                    ((CowData<float> *)(lVar6 + 0x60),(ulong)(uint)(iVar9 * *(int *)(lVar6 + 0x4c)))
          ;
        ...
        uVar7 = param_3 >> 9;
        puVar2 = (undefined4 *)
                 (*(long *)(lVar6 + 0x60) + (ulong)(uint)(param_3 * *(int *)(lVar6 + 0x4c)) * 4);
        *puVar2 = *param_4;
        puVar2[1] = param_4[1];
        puVar2[2] = param_4[2];
        puVar2[3] = param_4[9];
        ...
        if (uVar7 < (uint)(iVar9 >> 9)) {
          ...
          *(undefined1 *)(lVar6 + 0x48) = 1;
          ...
          _err_print_index_error
                    ("_multimesh_mark_dirty","drivers/gles3/storage/mesh_storage.cpp",0x666,
                     (long)(int)uVar7,(long)(iVar9 >> 9),"region_index",
                     "data_cache_dirty_region_count","",false,false);
        }
      }
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
  ...
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    ...
    pcVar8 = "Parameter \"multimesh\" is null.";
LAB_00117986:
    _err_print_error("_multimesh_instance_set_transform","drivers/gles3/storage/mesh_storage.cpp",
                     uVar5,pcVar8,0,0);
    return;
  }
LAB_00117a93:
...
/* GLES3::MeshStorage::_multimesh_instance_set_color(RID, int, Color const&) */

void __thiscall
GLES3::MeshStorage::_multimesh_instance_set_color
          (MeshStorage *this,ulong param_2,int param_3,uint *param_4)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x26c))) {
    ...
    if (*(int *)(lVar6 + 0x110) == (int)(param_2 >> 0x20)) {
      ...
      if ((param_3 < 0) || (iVar13 <= param_3)) {
        _err_print_index_error
                  ("_multimesh_instance_set_color","drivers/gles3/storage/mesh_storage.cpp",0x6f7,
                   (long)param_3,(long)iVar13,"p_index","multimesh->instances","",false,false);
      }
      else {
        ...
        if ((*(long *)(lVar6 + 0x60) == 0) || (*(long *)(*(long *)(lVar6 + 0x60) + -8) < 1)) {
          CowData<float>::resize<false>
                    ((CowData<float> *)(lVar6 + 0x60),(ulong)(uint)(iVar13 * *(int *)(lVar6 + 0x4c))
                    );
          CowData<float>::_copy_on_write((CowData<float> *)(lVar6 + 0x60));
          pvVar4 = *(void **)(lVar6 + 0x60);
          if (*(char *)(lVar6 + 0x49) == '\0') {
        ...
        if (uVar3 < 0x47800000) {
          uVar9 = 0;
          if (0x38000000 < uVar3) {
            uVar9 = (ulong)(uVar3 + 0xc8000000 >> 0xd |
                           (uVar7 >> 0x1f) << 0xf | (uVar7 & 0x7fffff) >> 0xd);
          }
        }
        else {
        ...
        if (uVar3 < 0x47800000) {
          uVar11 = 0;
          if (0x38000000 < uVar3) {
            uVar11 = (ushort)(uVar3 + 0xc8000000 >> 0xd) |
                     (ushort)((uVar7 >> 0x1f) << 0xf) | (ushort)((uVar7 & 0x7fffff) >> 0xd);
          }
        }
        else {
          if (((uVar7 & 0x7fffff) == 0) || (uVar11 = 0x3ff, uVar3 != 0x7f800000)) {
            uVar11 = 0;
          }
        ...
        if (uVar3 < 0x47800000) {
          uVar12 = 0;
          if (0x38000000 < uVar3) {
            uVar12 = (ushort)(uVar3 + 0xc8000000 >> 0xd) |
                     (ushort)((uVar7 >> 0x1f) << 0xf) | (ushort)((uVar7 & 0x7fffff) >> 0xd);
          }
        }
        else {
          if (((uVar7 & 0x7fffff) == 0) || (uVar12 = 0x3ff, uVar3 != 0x7f800000)) {
            uVar12 = 0;
          }
        ...
        if (uVar3 < 0x47800000) {
          uVar10 = 0;
          if (0x38000000 < uVar3) {
            uVar10 = (ulong)(uVar3 + 0xc8000000 >> 0xd |
                            (uVar7 >> 0x1f) << 0xf | (uVar7 & 0x7fffff) >> 0xd);
          }
        }
        else {
        ...
        uVar7 = param_3 >> 9;
        *(ulong *)(*(long *)(lVar6 + 0x60) +
                  ((ulong)(uint)(param_3 * *(int *)(lVar6 + 0x4c)) + (ulong)*(uint *)(lVar6 + 0x50))
                  * 4) =
             uVar9 & 0xffff | (ulong)uVar11 << 0x10 | (ulong)uVar12 << 0x20 | uVar10 << 0x30;
        iVar2 = *(int *)(lVar6 + 8) + 0x1ff;
        iVar13 = *(int *)(lVar6 + 8) + 0x3fe;
        if (-1 < iVar2) {
          iVar13 = iVar2;
        ...
        if (uVar7 < (uint)(iVar13 >> 9)) {
          ...
          _err_print_index_error
                    ("_multimesh_mark_dirty","drivers/gles3/storage/mesh_storage.cpp",0x666,
                     (long)(int)uVar7,(long)(iVar13 >> 9),"region_index",
                     "data_cache_dirty_region_count","",false,false);
        }
      }
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
  ...
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    ...
    pcVar8 = "Parameter \"multimesh\" is null.";
LAB_00117fb6:
    _err_print_error("_multimesh_instance_set_color","drivers/gles3/storage/mesh_storage.cpp",uVar5,
                     pcVar8,0,0);
    return;
  }
LAB_001180c3:
...
/* GLES3::MeshStorage::_multimesh_instance_set_custom_data(RID, int, Color const&) */

void __thiscall
GLES3::MeshStorage::_multimesh_instance_set_custom_data
          (MeshStorage *this,ulong param_2,int param_3,uint *param_4)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x26c))) {
    ...
    if (*(int *)(lVar6 + 0x110) == (int)(param_2 >> 0x20)) {
      ...
      if ((param_3 < 0) || (iVar13 <= param_3)) {
        _err_print_index_error
                  ("_multimesh_instance_set_custom_data","drivers/gles3/storage/mesh_storage.cpp",
                   0x70b,(long)param_3,(long)iVar13,"p_index","multimesh->instances","",false,false)
        ;
      }
      else {
        ...
        uVar7 = param_3 >> 9;
        *(ulong *)(*(long *)(lVar6 + 0x60) +
                  ((ulong)(uint)(param_3 * *(int *)(lVar6 + 0x4c)) + (ulong)*(uint *)(lVar6 + 0x54))
                  * 4) =
             uVar9 & 0xffff | (ulong)uVar11 << 0x10 | (ulong)uVar12 << 0x20 | uVar10 << 0x30;
        iVar2 = *(int *)(lVar6 + 8) + 0x1ff;
        iVar13 = *(int *)(lVar6 + 8) + 0x3fe;
  ...
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    ...
    pcVar8 = "Parameter \"multimesh\" is null.";
LAB_001185e6:
    _err_print_error("_multimesh_instance_set_custom_data","drivers/gles3/storage/mesh_storage.cpp",
                     uVar5,pcVar8,0,0);
    return;
  }
LAB_001186f3:
...
/* GLES3::MeshStorage::_multimesh_instance_get_color(RID, int) const */

undefined1  [16] __thiscall
GLES3::MeshStorage::_multimesh_instance_get_color(MeshStorage *this,ulong param_2,int param_3)
...
LAB_00118c40:
    ...
    if ((param_3 < 0) || (iVar14 <= param_3)) {
      _err_print_index_error
                ("_multimesh_instance_get_color","drivers/gles3/storage/mesh_storage.cpp",0x776,
                 (long)param_3,(long)iVar14,"p_index","multimesh->instances","",false,false);
      local_48 = 0;
      uStack_40 = 0x3f80000000000000;
      goto LAB_0011895e;
    }
  ...
  _err_print_error("_multimesh_instance_get_color","drivers/gles3/storage/mesh_storage.cpp",uVar11,
                   pcVar8,0,0);
  local_48 = 0;
  uStack_40 = 0x3f80000000000000;
LAB_0011895e:
...
/* GLES3::MeshStorage::mesh_allocate() */

void __thiscall GLES3::MeshStorage::mesh_allocate(MeshStorage *this)
...
/* GLES3::MeshStorage::_multimesh_allocate() */

void __thiscall GLES3::MeshStorage::_multimesh_allocate(MeshStorage *this)
...
/* GLES3::MeshStorage::skeleton_allocate() */

void __thiscall GLES3::MeshStorage::skeleton_allocate(MeshStorage *this)
...
/* GLES3::MeshStorage::mesh_initialize(RID) */

void __thiscall GLES3::MeshStorage::mesh_initialize(MeshStorage *this,undefined8 param_2)

{
  ...
  local_e8[8] = (Mesh)0x0;
  local_e8[9] = (Mesh)0x0;
  local_e8[10] = (Mesh)0x0;
  local_e8[0xb] = (Mesh)0x0;
  local_e8[0xc] = (Mesh)0x0;
  local_e8[0xd] = (Mesh)0x0;
  local_e8[0xe] = (Mesh)0x0;
  local_e8[0xf] = (Mesh)0x0;
  ...
  RID_Alloc<GLES3::Mesh,true>::initialize_rid
            ((RID_Alloc<GLES3::Mesh,true> *)(this + 0x180),param_2,local_e8);
  Mesh::~Mesh(local_e8);
...
/* GLES3::MeshStorage::skeleton_initialize(RID) */

void __thiscall GLES3::MeshStorage::skeleton_initialize(MeshStorage *this,undefined8 param_2)

{
  ...
  local_48 = 1;
  local_18 = 2;
  RID_Alloc<GLES3::Skeleton,true>::initialize_rid
            ((RID_Alloc<GLES3::Skeleton,true> *)(this + 0x2b0),param_2,local_98);
...
/* GLES3::MeshStorage::_multimesh_initialize(RID) */

void __thiscall GLES3::MeshStorage::_multimesh_initialize(MeshStorage *this,undefined8 param_2)

{
  ...
  local_a0 = 1;
  local_20 = 2;
  RID_Alloc<GLES3::MultiMesh,true>::initialize_rid
            ((RID_Alloc<GLES3::MultiMesh,true> *)(this + 0x250),param_2,&uStack_128);
...
/* GLES3::MeshStorage::mesh_get_surface(RID, int) const */

undefined8 *
GLES3::MeshStorage::mesh_get_surface(undefined8 *param_1,long param_2,ulong param_3,uint param_4)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((param_3 != 0) && ((uint)param_3 < *(uint *)(param_2 + 0x19c))) {
    puVar2 = (uint *)(*(long *)(*(long *)(param_2 + 0x188) +
                               ((param_3 & 0xffffffff) / (ulong)*(uint *)(param_2 + 0x198)) * 8) +
                     ((param_3 & 0xffffffff) % (ulong)*(uint *)(param_2 + 0x198)) * 0xd8);
    if (puVar2[0x34] == (uint)(param_3 >> 0x20)) {
      if (puVar2[4] <= param_4) {
        _err_print_index_error
                  ("mesh_get_surface","drivers/gles3/storage/mesh_storage.cpp",0x25a,(ulong)param_4,
                   (ulong)puVar2[4],"(uint32_t)p_surface","mesh->surface_count","",false,false);
        puVar12 = param_1;
        ...
        *(undefined2 *)((long)param_1 + 0x9a) = 0x3f80;
        *(undefined2 *)((long)param_1 + 0xaa) = 0x3f80;
        *(undefined2 *)((long)param_1 + 0xba) = 0x3f80;
        goto LAB_00119748;
      }
      ...
      if (puVar4[0x26] != 0) {
        do {
          ...
          if (local_150 == 0) {
LAB_00119328:
            if (local_b8[0] == 0) goto LAB_00119475;
LAB_00119339:
            lVar13 = local_148[0];
            iVar8 = CowData<RenderingServer::SurfaceData::LOD>::resize<false>
                              ((CowData<RenderingServer::SurfaceData::LOD> *)local_b8,
                               *(long *)(local_b8[0] + -8) + 1);
            if (iVar8 != 0) goto LAB_00119490;
LAB_00119352:
            if (local_b8[0] == 0) {
              lVar11 = -1;
              lVar10 = 0;
              ...
              if (-1 < lVar11) {
                ...
                *puVar9 = local_158[0];
                if (lVar13 != *(long *)(puVar9 + 4)) {
                  CowData<unsigned_char>::_ref
                            ((CowData<unsigned_char> *)(puVar9 + 4),(CowData *)local_148);
                }
                goto LAB_001193b5;
              }
            }
...
LAB_0011945f:
            if (local_b8[0] != 0) goto LAB_00119339;
LAB_00119475:
            lVar13 = local_148[0];
            iVar8 = CowData<RenderingServer::SurfaceData::LOD>::resize<false>
                              ((CowData<RenderingServer::SurfaceData::LOD> *)local_b8,1);
            if (iVar8 == 0) goto LAB_00119352;
LAB_00119490:
      ...
      if (*puVar2 != 0) {
        if (local_68 != 0) {
          ...
          *plVar1 = *plVar1 + -1;
          ...
          local_68 = 0;
          if (*puVar2 == 0) goto LAB_001195c7;
        }
        lVar14 = 0;
        do {
          GLES3::Utilities::buffer_get_data
                    ((uint)local_158,0x8892,*(uint *)(*(long *)(puVar4 + 0x42) + lVar14 * 8));
...
LAB_001195c7:
  ...
  _err_print_error("mesh_get_surface","drivers/gles3/storage/mesh_storage.cpp",0x259,
                   "Parameter \"mesh\" is null.",0,0);
  puVar12 = param_1;
  for (lVar14 = 0x1e; lVar14 != 0; lVar14 = lVar14 + -1) {
    *puVar12 = 0;
...
/* SkeletonShaderGLES3::~SkeletonShaderGLES3() */

void __thiscall SkeletonShaderGLES3::~SkeletonShaderGLES3(SkeletonShaderGLES3 *this)

{
  *(undefined ***)this = &PTR__init_001223c8;
...
/* SkeletonShaderGLES3::_init() */

void __thiscall SkeletonShaderGLES3::_init(SkeletonShaderGLES3 *this)

{
  ShaderGLES3::_setup((char *)this,
                      ...
                      ,"\nvoid main() {\n\n}\n/* clang-format on */\n",0x119c05,
                      (char **)&DAT_00000008,0x125540,(UBOPair *)0x0,(int)_init()::_ubo_pairs,
                      (Feedback *)0x3,0x125460,(TexUnitPair *)0x1,0x125520,(Specialization *)0x7,
                      0x1254a0,(char **)0x2);
  return;
}
...
/* GLES3::MeshStorage::mesh_instance_set_skeleton(RID, RID) [clone .cold] */

void __thiscall
GLES3::MeshStorage::mesh_instance_set_skeleton(undefined8 param_1,undefined8 param_2,int param_3)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::MeshStorage::mesh_instance_set_canvas_item_transform(RID, Transform2D const&) [clone
   .cold] */
...
/* GLES3::MeshStorage::mesh_instance_check_for_update(RID) [clone .cold] */

void GLES3::MeshStorage::mesh_instance_check_for_update(void)
...
/* GLES3::MeshStorage::mesh_instance_free(RID) [clone .cold] */

void __thiscall GLES3::MeshStorage::mesh_instance_free(undefined8 param_1,undefined8 param_2)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::MeshStorage::mesh_instance_create(RID) [clone .cold] */

void GLES3::MeshStorage::mesh_instance_create
...
/* CowData<RenderingServer::SurfaceData::LOD>::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<RenderingServer::SurfaceData::LOD>::_copy_on_write(void)
...

{
  ...
  if (local_54 == 0) {
    ...
    if (pvVar11 == (void *)0x0) goto LAB_0011bd35;
  ...
  if (uVar6 == 0) {
    ...
    if (pvVar13 == (void *)0x0) goto LAB_0011bd35;
  ...
  if (uVar15 != 0) {
    ...
    pvVar24 = pvVar13;
    do {
      uVar16 = (uint)((ulong)(uint)(((int)uVar19 + (int)uVar14) - (int)((ulong)uVar15 % uVar14)) %
                     uVar14);
      pvVar11 = pvVar18;
      param_2 = puVar23;
      pvVar13 = pvVar24;
  ...
  *puVar1 = uVar25;
  ...
  if (uVar6 == 0) {
    ...
    *(int *)(this + 0x1c) = *(int *)(this + 0x1c) + 1;
    if (pvVar13 == (void *)0x0) goto joined_r0x0011bc77;
  }
  else {
...
void __thiscall GLES3::Mesh::~Mesh(Mesh *this)
...

{
  ...
  if (local_88 == (Dependency *)0x0) {
    ...
    *in_RSI = lVar34;
    ...
    lVar34 = *in_RDX;
    local_88 = (Dependency *)*in_RSI;
    if (local_88 != (Dependency *)0x0) goto LAB_0011c39f;
  }
  else {
    uVar44 = *(uint *)((long)in_RSI + 0x24);
    lVar34 = *in_RDX;
      ...
      if (uVar39 != 0) {
        ...
        do {
          if ((int)uVar42 == (int)uVar33) {
            ...
            if (*(long *)(local_88 + uStack_98 * 8) == lVar34) goto LAB_0011c841;
          }
          uVar39 = uVar39 + 1;
          auVar8._8_8_ = 0;
  ...
  if (local_70 == (void *)0x0) {
    ...
    *(void **)(this + 8) = local_70;
    if (uVar39 == 0) {
      ...
      uVar38 = *param_1;
      if (local_70 == (void *)0x0) goto LAB_0011cb23;
    }
    else {
...
LAB_0011cb23:
  if ((float)uVar51 * __LC135 < (float)(iVar44 + 1)) {
...
/* GLES3::MeshInstance::~MeshInstance() */

void __thiscall GLES3::MeshInstance::~MeshInstance(MeshInstance *this)
...
/* WARNING: Removing unreachable block (ram,0x0011d3f0) */
/* WARNING: Removing unreachable block (ram,0x0011d520) */
/* WARNING: Removing unreachable block (ram,0x0011d699) */
/* WARNING: Removing unreachable block (ram,0x0011d52c) */
/* WARNING: Removing unreachable block (ram,0x0011d536) */
/* WARNING: Removing unreachable block (ram,0x0011d67b) */
/* WARNING: Removing unreachable block (ram,0x0011d542) */
/* WARNING: Removing unreachable block (ram,0x0011d54c) */
/* WARNING: Removing unreachable block (ram,0x0011d65d) */
/* WARNING: Removing unreachable block (ram,0x0011d558) */
/* WARNING: Removing unreachable block (ram,0x0011d562) */
/* WARNING: Removing unreachable block (ram,0x0011d63f) */
/* WARNING: Removing unreachable block (ram,0x0011d56e) */
/* WARNING: Removing unreachable block (ram,0x0011d578) */
/* WARNING: Removing unreachable block (ram,0x0011d621) */
/* WARNING: Removing unreachable block (ram,0x0011d584) */
/* WARNING: Removing unreachable block (ram,0x0011d58e) */
/* WARNING: Removing unreachable block (ram,0x0011d603) */
/* WARNING: Removing unreachable block (ram,0x0011d596) */
/* WARNING: Removing unreachable block (ram,0x0011d5a0) */
/* WARNING: Removing unreachable block (ram,0x0011d5e8) */
/* WARNING: Removing unreachable block (ram,0x0011d5a8) */
/* WARNING: Removing unreachable block (ram,0x0011d5be) */
/* WARNING: Removing unreachable block (ram,0x0011d5ca) */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashSet<GLES3::Mesh*, HashMapHasherDefault, HashMapComparatorDefault<GLES3::Mesh*>
   >::insert(GLES3::Mesh* const&) */

undefined1  [16]
HashSet<GLES3::Mesh*,HashMapHasherDefault,HashMapComparatorDefault<GLES3::Mesh*>>::insert
          (Mesh **param_1)

{
  ...
  if (local_88 == (Mesh *)0x0) {
    ...
    *in_RSI = lVar34;
    ...
    lVar34 = *in_RDX;
    local_88 = (Mesh *)*in_RSI;
    if (local_88 != (Mesh *)0x0) goto LAB_0011d70f;
  }
  else {
    uVar44 = *(uint *)((long)in_RSI + 0x24);
    lVar34 = *in_RDX;
      ...
      if (uVar39 != 0) {
        ...
        do {
          if ((int)uVar42 == (int)uVar33) {
            uVar37 = *(uint *)(in_RSI[1] + lVar36 * 4);
            uStack_98 = (ulong)uVar37;
            if (*(long *)(local_88 + uStack_98 * 8) == lVar34) goto LAB_0011dbb1;
          }
          uVar39 = uVar39 + 1;
          auVar8._8_8_ = 0;
          auVar8._0_8_ = (ulong)(iVar35 + 1) * lVar3;
...
/* WARNING: Removing unreachable block (ram,0x0011de30) */
/* WARNING: Removing unreachable block (ram,0x0011df60) */
/* WARNING: Removing unreachable block (ram,0x0011e0d9) */
/* WARNING: Removing unreachable block (ram,0x0011df6c) */
/* WARNING: Removing unreachable block (ram,0x0011df76) */
/* WARNING: Removing unreachable block (ram,0x0011e0bb) */
/* WARNING: Removing unreachable block (ram,0x0011df82) */
/* WARNING: Removing unreachable block (ram,0x0011df8c) */
/* WARNING: Removing unreachable block (ram,0x0011e09d) */
/* WARNING: Removing unreachable block (ram,0x0011df98) */
/* WARNING: Removing unreachable block (ram,0x0011dfa2) */
/* WARNING: Removing unreachable block (ram,0x0011e07f) */
/* WARNING: Removing unreachable block (ram,0x0011dfae) */
/* WARNING: Removing unreachable block (ram,0x0011dfb8) */
/* WARNING: Removing unreachable block (ram,0x0011e061) */
/* WARNING: Removing unreachable block (ram,0x0011dfc4) */
/* WARNING: Removing unreachable block (ram,0x0011dfce) */
/* WARNING: Removing unreachable block (ram,0x0011e043) */
/* WARNING: Removing unreachable block (ram,0x0011dfd6) */
/* WARNING: Removing unreachable block (ram,0x0011dfe0) */
/* WARNING: Removing unreachable block (ram,0x0011e028) */
/* WARNING: Removing unreachable block (ram,0x0011dfe8) */
/* WARNING: Removing unreachable block (ram,0x0011dffe) */
/* WARNING: Removing unreachable block (ram,0x0011e00a) */
...
/* RID_Alloc<GLES3::MultiMesh, true>::~RID_Alloc() */

void __thiscall RID_Alloc<GLES3::MultiMesh,true>::~RID_Alloc(RID_Alloc<GLES3::MultiMesh,true> *this)
...
LAB_0011e32a:
    if ((uint)uVar5 < (uint)uVar7) goto LAB_0011e36b;
    lVar6 = 0;
    while( true ) {
    ...
    if (*(uint *)(this + 0x18) != 0) goto LAB_0011e36b;
...
/* RID_Alloc<GLES3::Skeleton, true>::~RID_Alloc() */

void __thiscall RID_Alloc<GLES3::Skeleton,true>::~RID_Alloc(RID_Alloc<GLES3::Skeleton,true> *this)

{
  ...
  *(undefined ***)this = &PTR__RID_Alloc_00122450;
  ...
  if (uVar3 == 0) {
    ...
    puVar8 = *(undefined8 **)(this + 8);
LAB_0011e5aa:
    if ((uint)uVar5 < (uint)uVar7) goto LAB_0011e5eb;
    lVar6 = 0;
    while( true ) {
      Memory::free_static((void *)puVar8[lVar6],false);
      lVar2 = lVar6 * 8;
    ...
    if (*(uint *)(this + 0x18) != 0) goto LAB_0011e5eb;
    Memory::free_static((void *)*puVar8,false);
    Memory::free_static((void *)**(undefined8 **)(this + 0x10),false);
  }
  puVar8 = *(undefined8 **)(this + 8);
...
/* RID_Alloc<GLES3::MeshInstance, false>::~RID_Alloc() */

void __thiscall
RID_Alloc<GLES3::MeshInstance,false>::~RID_Alloc(RID_Alloc<GLES3::MeshInstance,false> *this)
...
LAB_0011e80a:
    if ((uint)uVar5 < (uint)uVar8) goto LAB_0011e84b;
    lVar7 = 0;
    while( true ) {
      Memory::free_static((void *)puVar9[lVar7],false);
      lVar2 = lVar7 * 8;
    ...
    if (*(uint *)(this + 0x18) != 0) goto LAB_0011e84b;
    Memory::free_static((void *)*puVar9,false);
    Memory::free_static((void *)**(undefined8 **)(this + 0x10),false);
  }
  puVar9 = *(undefined8 **)(this + 8);
...
/* RID_Alloc<GLES3::Mesh, true>::~RID_Alloc() */

void __thiscall RID_Alloc<GLES3::Mesh,true>::~RID_Alloc(RID_Alloc<GLES3::Mesh,true> *this)

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  *(undefined ***)this = &PTR__RID_Alloc_001223f0;
  uVar3 = *(uint *)(this + 0x20);
  if (uVar3 == 0) {
    uVar5 = (ulong)*(uint *)(this + 0x1c);
    uVar8 = (ulong)*(uint *)(this + 0x18);
    puVar9 = *(undefined8 **)(this + 8);
LAB_0011ea4a:
    if ((uint)uVar5 < (uint)uVar8) goto LAB_0011ea8b;
    lVar7 = 0;
    while( true ) {
      Memory::free_static((void *)puVar9[lVar7],false);
      lVar2 = lVar7 * 8;
    ...
    if (*(uint *)(this + 0x18) != 0) goto LAB_0011ea8b;
    Memory::free_static((void *)*puVar9,false);
    Memory::free_static((void *)**(undefined8 **)(this + 0x10),false);
  }
  puVar9 = *(undefined8 **)(this + 8);
...

{
  ...
  *(undefined ***)this = &PTR__RID_Alloc_00122410;
  if (uVar3 == 0) {
    ...
    puVar9 = *(undefined8 **)(this + 8);
LAB_0011ec8a:
    if ((uint)uVar5 < (uint)uVar8) goto LAB_0011eccb;
    lVar7 = 0;
    while( true ) {
      Memory::free_static((void *)puVar9[lVar7],false);
      lVar2 = lVar7 * 8;
    ...
    if (*(uint *)(this + 0x18) != 0) goto LAB_0011eccb;
    Memory::free_static((void *)*puVar9,false);
    Memory::free_static((void *)**(undefined8 **)(this + 0x10),false);
  }
  puVar9 = *(undefined8 **)(this + 8);
...

{
  ...
  *(undefined ***)this = &PTR__RID_Alloc_001223f0;
  ...
  if (uVar3 == 0) {
    ...
    puVar9 = *(undefined8 **)(this + 8);
LAB_0011eeaa:
    if ((uint)uVar5 < (uint)uVar8) goto LAB_0011eeeb;
    lVar7 = 0;
    while( true ) {
      Memory::free_static((void *)puVar9[lVar7],false);
      lVar2 = lVar7 * 8;
    ...
    if (*(uint *)(this + 0x18) != 0) goto LAB_0011eeeb;
    Memory::free_static((void *)*puVar9,false);
    Memory::free_static((void *)**(undefined8 **)(this + 0x10),false);
  }
  puVar9 = *(undefined8 **)(this + 8);
...
/* RID_Alloc<GLES3::MeshInstance, false>::make_rid() */

ulong __thiscall
RID_Alloc<GLES3::MeshInstance,false>::make_rid(RID_Alloc<GLES3::MeshInstance,false> *this)

{
  ...
  uVar13 = *(uint *)(*(long *)(lVar4 + ((ulong)uVar13 / (ulong)uVar7) * 8) +
  ...
  if (uVar9 != 0x7fffffff) {
    ...
    *(uint *)(*(long *)(lVar12 + (uVar16 / uVar7) * 8) + (uVar16 % (ulong)uVar7) * 0xa8 + 0xa0) =
         uVar9 | 0x80000000;
    *(int *)(this + 0x20) = *(int *)(this + 0x20) + 1;
    ...
    if ((uVar14 != 0) && ((uint)uVar14 < *(uint *)(this + 0x1c))) {
      puVar1 = (undefined8 *)
               ...
               (uVar16 % (ulong)*(uint *)(this + 0x18)) * 0xa8);
...
LAB_0011fa99:
    ...
    pDVar45 = *param_1;
    iVar36 = *(int *)(this + 0x2c);
    if (__s_00 != (void *)0x0) goto LAB_0011fa99;
  }
  else {
    iVar36 = *(int *)(this + 0x2c);
    if (iVar36 == 0) {
...
void __thiscall
CowData<RenderingServer::SurfaceData::LOD>::_unref(CowData<RenderingServer::SurfaceData::LOD> *this)
...

{
  ...
  CowData<RenderingServer::SurfaceData::LOD>::_unref
            ((CowData<RenderingServer::SurfaceData::LOD> *)(this + 0x80));
  if (*(long *)(this + 0x50) != 0) {
    LOCK();
...
LAB_0011feb9:
        ...
        lVar6 = *(long *)(lVar3 + -8);
        if (lVar6 <= lVar5) goto LAB_0011feb9;
...
/* WARNING: Removing unreachable block (ram,0x00120128) */
/* WARNING: Removing unreachable block (ram,0x00120258) */
/* WARNING: Removing unreachable block (ram,0x00120420) */
/* WARNING: Removing unreachable block (ram,0x00120264) */
/* WARNING: Removing unreachable block (ram,0x0012026e) */
/* WARNING: Removing unreachable block (ram,0x00120400) */
/* WARNING: Removing unreachable block (ram,0x0012027a) */
/* WARNING: Removing unreachable block (ram,0x00120284) */
/* WARNING: Removing unreachable block (ram,0x001203e0) */
/* WARNING: Removing unreachable block (ram,0x00120290) */
/* WARNING: Removing unreachable block (ram,0x0012029a) */
/* WARNING: Removing unreachable block (ram,0x001203c0) */
/* WARNING: Removing unreachable block (ram,0x001202a6) */
/* WARNING: Removing unreachable block (ram,0x001202b0) */
/* WARNING: Removing unreachable block (ram,0x001203a0) */
/* WARNING: Removing unreachable block (ram,0x001202bc) */
/* WARNING: Removing unreachable block (ram,0x001202c6) */
/* WARNING: Removing unreachable block (ram,0x00120380) */
/* WARNING: Removing unreachable block (ram,0x001202d2) */
/* WARNING: Removing unreachable block (ram,0x001202dc) */
/* WARNING: Removing unreachable block (ram,0x00120360) */
/* WARNING: Removing unreachable block (ram,0x001202e4) */
/* WARNING: Removing unreachable block (ram,0x001202fa) */
/* WARNING: Removing unreachable block (ram,0x00120306) */
...
/* RID_Alloc<GLES3::Mesh, true>::allocate_rid() */

ulong __thiscall RID_Alloc<GLES3::Mesh,true>::allocate_rid(RID_Alloc<GLES3::Mesh,true> *this)

{
  ...
  *(uint *)(*(long *)(*(long *)(this + 8) + ((ulong)uVar7 / (ulong)uVar2) * 8) +
            ((ulong)uVar7 % (ulong)uVar2) * 0xd8 + 0xd0) = uVar13 | 0x80000000;
  *(int *)(this + 0x20) = *(int *)(this + 0x20) + 1;
  pthread_mutex_unlock(__mutex);
LAB_001205f5:
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
...
/* RID_Alloc<GLES3::MultiMesh, true>::allocate_rid() */

ulong __thiscall
RID_Alloc<GLES3::MultiMesh,true>::allocate_rid(RID_Alloc<GLES3::MultiMesh,true> *this)
...
/* RID_Alloc<GLES3::Skeleton, true>::allocate_rid() */

ulong __thiscall
RID_Alloc<GLES3::Skeleton,true>::allocate_rid(RID_Alloc<GLES3::Skeleton,true> *this)
...

{
  ...
  if (__s_00 == (void *)0x0) {
    ...
    *(void **)(param_2 + 2) = __s_00;
    ...
    uVar32 = param_2[0xb];
    lVar36 = *plVar28;
    if (__s_00 != (void *)0x0) goto LAB_00120f11;
  }
  else {
LAB_00120f06:
    uVar32 = param_2[0xb];
...
/* RID_Alloc<GLES3::Mesh, true>::initialize_rid(RID, GLES3::Mesh const&) */

void __thiscall
RID_Alloc<GLES3::Mesh,true>::initialize_rid
          (RID_Alloc<GLES3::Mesh,true> *this,ulong param_2,undefined8 *param_3)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x1c))) {
    puVar1 = (undefined8 *)
             ...
             ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x18)) * 0xd8);
...
LAB_0012144b:
        plVar18 = (long *)param_3[0xc];
        puVar1[0xc] = 0;
        if ((plVar18 != (long *)0x0) &&
           (puVar17 = (undefined8 *)*plVar18, puVar17 != (undefined8 *)0x0)) {
          ...
          do {
            while( true ) {
              ...
              *plVar18 = (long)puVar12;
              if (puVar17 == (undefined8 *)0x0) goto LAB_001214f4;
            }
            puVar17 = (undefined8 *)puVar17[1];
            *(int *)(plVar18 + 2) = (int)plVar18[2] + 1;
...
LAB_001215e1:
        if ((*(int *)((long)param_3 + 0xcc) != 0) &&
           (plVar18 = (long *)param_3[0x17], plVar18 != (long *)0x0)) {
          do {
            HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>
            ::insert(&pDStack_48,(uint *)(puVar1 + 0x14),(bool)((char)plVar18 + '\x10'));
...
/* RID_Alloc<GLES3::Skeleton, true>::initialize_rid(RID, GLES3::Skeleton const&) */

void __thiscall
RID_Alloc<GLES3::Skeleton,true>::initialize_rid
          (RID_Alloc<GLES3::Skeleton,true> *this,ulong param_2,undefined1 *param_3)

{
  ...
  if (param_2 != 0) {
    if ((uint)param_2 < *(uint *)(this + 0x1c)) {
      puVar11 = (undefined1 *)
                (((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x18)) * 0x90 +
                *(long *)(*(long *)(this + 8) +
                         ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x18)) * 8));
...
LAB_001219a2:
          if ((*(int *)(param_3 + 0x84) != 0) &&
             (plVar12 = *(long **)(param_3 + 0x70), plVar12 != (long *)0x0)) {
            do {
              HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>
              ::insert(&pDStack_28,(uint *)(puVar11 + 0x58),(bool)((char)plVar12 + '\x10'));
...
/* RID_Alloc<GLES3::MultiMesh, true>::initialize_rid(RID, GLES3::MultiMesh const&) */

void __thiscall
RID_Alloc<GLES3::MultiMesh,true>::initialize_rid
          (RID_Alloc<GLES3::MultiMesh,true> *this,ulong param_2,undefined8 *param_3)
...
LAB_00121d40:
        if ((*(int *)((long)param_3 + 0x10c) != 0) &&
           (plVar13 = (long *)param_3[0x1f], plVar13 != (long *)0x0)) {
          do {
            HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>
            ::insert(&pDStack_28,(uint *)(puVar12 + 0x1c),(bool)((char)plVar13 + '\x10'));
...
/* CowData<RenderingServer::SurfaceData::LOD>::_realloc(long) */

undefined8 __thiscall
CowData<RenderingServer::SurfaceData::LOD>::_realloc
          (CowData<RenderingServer::SurfaceData::LOD> *this,long param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Error CowData<RenderingServer::SurfaceData::LOD>::resize<false>(long) */

undefined8 __thiscall
CowData<RenderingServer::SurfaceData::LOD>::resize<false>
          (CowData<RenderingServer::SurfaceData::LOD> *this,long param_1)
...
LAB_00122021:
      ...
      while (puVar6[uVar8 * 3 + 2] == 0) {
        uVar8 = uVar8 + 1;
        if ((ulong)puVar6[-1] <= uVar8) goto LAB_00122021;
      }
      LOCK();
...
LAB_001221b6:
    ...
    lVar10 = puVar6[-1];
    if (param_1 <= lVar10) goto LAB_001220c7;
  }
  else {
    if (lVar10 != 0) {
      uVar3 = _realloc(this,lVar9);

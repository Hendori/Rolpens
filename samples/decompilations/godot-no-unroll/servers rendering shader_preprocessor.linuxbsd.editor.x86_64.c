...
/* ShaderPreprocessor::Tokenizer::add_generated(ShaderPreprocessor::Token const&) */

void __thiscall ShaderPreprocessor::Tokenizer::add_generated(Tokenizer *this,Token *param_1)
...
/* ShaderPreprocessor::Tokenizer::next() */

undefined4 __thiscall ShaderPreprocessor::Tokenizer::next(Tokenizer *this)
...
/* ShaderPreprocessor::Tokenizer::get_line() const */

undefined4 __thiscall ShaderPreprocessor::Tokenizer::get_line(Tokenizer *this)
...
/* ShaderPreprocessor::Tokenizer::get_index() const */

undefined4 __thiscall ShaderPreprocessor::Tokenizer::get_index(Tokenizer *this)
...
void __thiscall
ShaderPreprocessor::Tokenizer::get_and_clear_generated(Tokenizer *this,LocalVector *param_1)
...
/* ShaderPreprocessor::Tokenizer::backtrack(char32_t) */

void __thiscall ShaderPreprocessor::Tokenizer::backtrack(Tokenizer *this,wchar32 param_1)
...
/* ShaderPreprocessor::Tokenizer::peek() */

undefined4 __thiscall ShaderPreprocessor::Tokenizer::peek(Tokenizer *this)

{
  ...
  if (*(int *)(this + 0xc) < *(int *)(this + 0x10)) {
    ...
    if (lVar3 != lVar4) {
      ...
      _err_print_index_error
                ("get","./core/templates/cowdata.h",0xdb,lVar3,lVar4,"p_index","size()","",false,
                 true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
      pcVar2 = (code *)invalidInstructionException();
...
/* ShaderPreprocessor::Tokenizer::consume_line_continuations(int) */

int __thiscall
ShaderPreprocessor::Tokenizer::consume_line_continuations(Tokenizer *this,int param_1)
...
LAB_00100750:
          _err_print_index_error
                    ("get","./core/templates/cowdata.h",0xdb,lVar5,lVar9,"p_index","size()","",false
                     ,true);
          _err_flush_stdout();
                    /* WARNING: Does not return */
          pcVar3 = (code *)invalidInstructionException();
        ...
        lVar1 = lVar5 * 4;
        if (uVar2 == 0x5c) {
          if ((iVar8 <= iVar6 + 1) || (lVar5 = (long)(iVar6 + 1), lVar5 == lVar9))
          goto LAB_001006b8;
          ...
          *(int *)(this + 0xc) = iVar6;
          ...
          if ((uVar2 < 0x2028) || ((0x80000000000083U >> ((ulong)(uVar2 - 0x2028) & 0x3f) & 1) == 0)
             ) goto LAB_001006b8;
        }
...
/* ShaderPreprocessor::Tokenizer::skip_whitespace() */

void __thiscall ShaderPreprocessor::Tokenizer::skip_whitespace(Tokenizer *this)

{
  ...
  while( true ) {
    ...
    if (((long)uVar6 < 0) || ((long)uVar7 <= (long)uVar6)) {
      _err_print_index_error
                ("get","./core/templates/cowdata.h",0xdb,uVar6,uVar7,"p_index","size()","",false,
                 true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
      pcVar3 = (code *)invalidInstructionException();
...
/* ShaderPreprocessor::Tokenizer::get_token() */

ulong __thiscall ShaderPreprocessor::Tokenizer::get_token(Tokenizer *this)
...
/* ShaderPreprocessor::CommentRemover::get_error() const */

void ShaderPreprocessor::CommentRemover::get_error(void)
...
/* ShaderPreprocessor::CommentRemover::get_error_line() const */

undefined4 __thiscall ShaderPreprocessor::CommentRemover::get_error_line(CommentRemover *this)
...
/* ShaderPreprocessor::CommentRemover::peek() const */

undefined4 __thiscall ShaderPreprocessor::CommentRemover::peek(CommentRemover *this)
...
/* ShaderPreprocessor::CommentRemover::advance(char32_t) */

undefined8 __thiscall
ShaderPreprocessor::CommentRemover::advance(CommentRemover *this,wchar32 param_1)
...
void __thiscall ShaderPreprocessor::Token::Token(Token *this)
...
/* ShaderPreprocessor::Token::Token(char32_t, int) */

void __thiscall ShaderPreprocessor::Token::Token(Token *this,wchar32 param_1,int param_2)
...
/* ShaderPreprocessor::is_char_word(char32_t) */

bool ShaderPreprocessor::is_char_word(wchar32 param_1)

{
  if (0x39 < (uint)param_1) {
    return (uint)(param_1 + L'\xffffffbf') < 0x3a &&
           (0x3ffffff43ffffffU >> ((ulong)(uint)(param_1 + L'\xffffffbf') & 0x3f) & 1) != 0;
  }
...
/* ShaderPreprocessor::is_char_space(char32_t) */

uint ShaderPreprocessor::is_char_space(wchar32 param_1)

{
  ...
  return (uint)CONCAT71((int7)((ulong)in_RAX >> 8),param_1 == L' ') |
         CONCAT31((int3)((uint)in_EDX >> 8),param_1 == L'\t');
}



/* ShaderPreprocessor::is_char_end(char32_t) */

uint ShaderPreprocessor::is_char_end(wchar32 param_1)
...
/* ShaderPreprocessor::find_match(String const&, String const&, int&, int&) */

undefined8 __thiscall
ShaderPreprocessor::find_match
          (ShaderPreprocessor *this,String *param_1,String *param_2,int *param_3,int *param_4)
...
LAB_00100de8:
      ...
      if (bVar11) {
LAB_00100ea6:
        puVar9 = (uint *)&String::_null;
      }
      else {
LAB_00100df1:
        if ((bVar11 || bVar12 != lVar4 < 0) || (lVar8 < 0)) {
LAB_00100f24:
          _err_print_index_error
      ...
      else if ((0x39 < uVar1 - 0x41) ||
              ((0x3ffffff43ffffffU >> ((ulong)(uVar1 - 0x41) & 0x3f) & 1) == 0)) {
LAB_00100e55:
        if (lVar3 == 0) goto LAB_00100e67;
        goto LAB_00100e5a;
      }
      if ((lVar3 != 0) && (iVar7 = (int)*(undefined8 *)(lVar3 + -8), iVar7 != 0)) {
        iVar6 = iVar6 + -1 + iVar7;
      }
    }
    else {
      ...
      if (uVar1 < 0x3a) {
        if (uVar1 < 0x30) {
          ...
          goto joined_r0x00100ec8;
              ...
              ((0x3ffffff43ffffffU >> ((ulong)(uVar1 - 0x41) & 0x3f) & 1) == 0)) goto LAB_00100db0;
    }
    *param_4 = iVar6 + 1;
    iVar6 = String::find(param_1,(int)param_2);
  } while( true );
...
/* ShaderPreprocessor::add_to_output(String const&) */

void __thiscall ShaderPreprocessor::add_to_output(ShaderPreprocessor *this,String *param_1)

{
  ...
  do {
    ...
    if (lVar1 == lVar7) {
      ...
      if (lVar1 <= lVar7) {
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,lVar7,lVar1,"p_index","size()","",false,
                   true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar2 = (code *)invalidInstructionException();
...
void __thiscall ShaderPreprocessor::ShaderPreprocessor(ShaderPreprocessor *this)
...
/* ShaderPreprocessor::create_define(String const&) */

void * ShaderPreprocessor::create_define(String *param_1)
...
/* ShaderPreprocessor::CommentRemover::CommentRemover(String const&) */

void __thiscall
ShaderPreprocessor::CommentRemover::CommentRemover(CommentRemover *this,String *param_1)
...
/* ShaderPreprocessor::Tokenizer::Tokenizer(String const&) */

void __thiscall ShaderPreprocessor::Tokenizer::Tokenizer(Tokenizer *this,String *param_1)
...
/* ShaderPreprocessor::get_keyword_list(List<String, DefaultAllocator>*, bool, bool) */

void ShaderPreprocessor::get_keyword_list(List *param_1,bool param_2,bool param_3)

{
  ...
  List<String,DefaultAllocator>::push_back
            ((List<String,DefaultAllocator> *)param_1,(String *)&local_50);
...
/* ShaderPreprocessor::set_error(String const&, int) */

void __thiscall ShaderPreprocessor::set_error(ShaderPreprocessor *this,String *param_1,int param_2)
...
/* ShaderPreprocessor::get_pragma_list(List<String, DefaultAllocator>*) */

void ShaderPreprocessor::get_pragma_list(List *param_1)
...
/* ShaderPreprocessor::concatenate_macro_body(String&) */

void __thiscall ShaderPreprocessor::concatenate_macro_body(ShaderPreprocessor *this,String *param_1)
...
LAB_00101c73:
      _err_print_index_error
                ("concatenate_macro_body","servers/rendering/shader_preprocessor.cpp",0x484,
                 (long)iVar6,lVar9,"index_end","r_body.size()","",false,false);
      goto LAB_00101af8;
    }
    lVar2 = *(long *)(lVar9 + -8);
    iVar8 = (int)lVar2;
    ...
    if (bVar4) {
      ...
      lVar7 = (long)(iVar5 + -1);
      do {
        if ((iVar5 == 0) || (iVar5 = iVar5 + -1, lVar2 == lVar7)) break;
        if (lVar2 <= lVar7) {
LAB_00101b3b:
          _err_print_index_error
          ...
          if (*(uint *)param_1 <= (uint)param_2) {
            _err_print_index_error
                      ("operator[]","./core/templates/local_vector.h",0xae,(ulong)(uint)param_2,
                       (ulong)*(uint *)param_1,"p_index","count","",false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_00101e80:
  ...
  _err_print_index_error
            ("set","./core/templates/cowdata.h",0xcf,lVar3,lVar6,"p_index","size()","",false,false);
  return this;
}



/* ShaderPreprocessor::Tokenizer::get_identifier(bool*, bool) */

bool * ShaderPreprocessor::Tokenizer::get_identifier(bool *param_1,bool param_2)
...
LAB_001021d0:
        if (uVar5 != 0x20) goto LAB_0010207d;
      }
    }
    ...
    if (in_CL != '\0') {
LAB_001020f8:
      vector_to_string((ShaderPreprocessor *)&local_70,(LocalVector *)&local_68,0,-1);
...
LAB_0010206f:
      iVar6 = consume_line_continuations(this,0);
...
/* ShaderPreprocessor::Tokenizer::peek_identifier() */

void ShaderPreprocessor::Tokenizer::peek_identifier(void)
...
/* ShaderPreprocessor::CommentRemover::strip() */

void ShaderPreprocessor::CommentRemover::strip(void)
...
LAB_001025c8:
    vector_to_string(in_RDI,(LocalVector *)in_RSI,0,-1);
    if (lVar2 == *(long *)(in_FS_OFFSET + 0x28)) {
      return;
    }
                    /* WARNING: Subroutine does not return */
  ...
  lVar6 = *(long *)(lVar11 + -8);
LAB_00102341:
  if ((int)lVar6 <= iVar5) goto LAB_001025c8;
  lVar8 = (long)iVar5;
  *(int *)(in_RSI + 0x18) = iVar5 + 1;
  if (lVar8 == lVar6) {
    iVar5 = 0;
    ...
    if (iVar5 == 0x2f) {
      if (*(int *)(in_RSI + 0x28) == 0) {
        ...
        if (iVar5 == 0x2a) {
          ...
          *(ulong *)(in_RSI + 0x20) =
               CONCAT44(*(int *)(in_RSI + 0x24) + 1,*(undefined4 *)(in_RSI + 0x1c));
          goto LAB_00102710;
        }
        uVar1 = *(uint *)in_RSI;
...
LAB_001026bd:
  ...
  *(undefined4 *)(lVar6 + (ulong)uVar1 * 4) = 0xffff;
  ...
  while( true ) {
    ...
    if (iVar5 == 0x2f) break;
LAB_00102710:
    cVar4 = advance((CommentRemover *)in_RSI,L'*');
...
/* ShaderPreprocessor::expand_condition(String const&, int, String&) */

undefined4 __thiscall
ShaderPreprocessor::expand_condition
          (ShaderPreprocessor *this,String *param_1,int param_2,String *param_3)
...
LAB_00102d69:
            if (local_ac != L'\xffffffff') {
              local_b0 = local_ac;
            }
            plVar2 = *(long **)(this + 0x10);
            vector_to_string((ShaderPreprocessor *)&local_58,(LocalVector *)&local_68,0,-1);
            if ((*plVar2 == 0) || (lVar20 = *(long *)(*plVar2 + 0x10), plVar2[1] == lVar20))
            goto LAB_00102f70;
            goto LAB_00102dc6;
          }
...
LAB_0010300b:
            _set_unexpected_token_error(this,(String *)&local_70,param_2);
            CowData<char32_t>::_unref((CowData<char32_t> *)&local_70);
            pvVar23 = local_60;
            goto LAB_00103029;
          }
...
LAB_00103029:
      if ((pvVar23 != (void *)0x0) &&
         (LocalVector<char32_t,unsigned_int,false,false>::resize
                    ((LocalVector<char32_t,unsigned_int,false,false> *)&local_68,0),
         local_60 != (void *)0x0)) {
...
LAB_001029cb:
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,lVar12,lVar20,"p_index","size()","",false
                   ,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar3 = (code *)invalidInstructionException();
...
LAB_00102e40:
  ...
  if (local_88 == (wchar32 *)0x0) {
    ...
    local_8c = (int)*(undefined8 *)(local_88 + -2) + -1 +
               (uint)((int)*(undefined8 *)(local_88 + -2) == 0);
  }
  if (L'\0' < local_b0) {
...
/* ShaderPreprocessor::Tokenizer::advance(char32_t) */

undefined8 * ShaderPreprocessor::Tokenizer::advance(wchar32 param_1)
...
LAB_001032b7:
        piVar1 = (int *)((long)local_50 + uVar8 * 8);
        iVar7 = (int)uVar8 + 1;
    ...
    *puVar10 = 0;
    puVar10[1] = 0;
    if (local_50 != (void *)0x0) {
      LocalVector<ShaderPreprocessor::Token,unsigned_int,false,false>::resize
                ((LocalVector<ShaderPreprocessor::Token,unsigned_int,false,false> *)&local_58,0);
      if (local_50 != (void *)0x0) {
...
/* ShaderPreprocessor::Tokenizer::consume_empty_line() */

ulong ShaderPreprocessor::Tokenizer::consume_empty_line(void)
...
/* ShaderPreprocessor::process_pragma(ShaderPreprocessor::Tokenizer*) */

void __thiscall ShaderPreprocessor::process_pragma(ShaderPreprocessor *this,Tokenizer *param_1)
...
/* ShaderPreprocessor::process_endif(ShaderPreprocessor::Tokenizer*) */

void __thiscall ShaderPreprocessor::process_endif(ShaderPreprocessor *this,Tokenizer *param_1)
...
/* ShaderPreprocessor::next_directive(ShaderPreprocessor::Tokenizer*, Vector<String> const&) */

Tokenizer * ShaderPreprocessor::next_directive(Tokenizer *param_1,Vector *param_2)

{
  ...
  iVar1 = *(int *)(in_RDX + 8);
  do {
    Tokenizer::advance((wchar32)(LocalVector<ShaderPreprocessor::Token,unsigned_int,false,false> *)
                                &local_58);
    if ((local_50 != (void *)0x0) &&
       (LocalVector<ShaderPreprocessor::Token,unsigned_int,false,false>::resize
                  ((LocalVector<ShaderPreprocessor::Token,unsigned_int,false,false> *)&local_58,0),
...
LAB_00103c0c:
    ...
    if ((iVar5 == 0) && (lVar4 = *(long *)(in_RCX + 8), lVar4 != 0)) {
      lVar6 = 0;
      do {
    ...
    if (((cVar3 == '\0') &&
        (cVar3 = String::operator==((String *)&local_58,"ifndef"), cVar3 == '\0')) &&
       (cVar3 = String::operator==((String *)&local_58,"if"), cVar3 == '\0')) {
...
/* ShaderPreprocessor::process_error(ShaderPreprocessor::Tokenizer*) */

void __thiscall ShaderPreprocessor::process_error(ShaderPreprocessor *this,Tokenizer *param_1)

{
  ...
  String::strip_edges(SUB81((CowData<char32_t> *)&local_78,0),
                      SUB81((ShaderPreprocessor *)&local_60,0));
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
  if (local_50 != (void *)0x0) {
    LocalVector<ShaderPreprocessor::Token,unsigned_int,false,false>::resize
              ((LocalVector<ShaderPreprocessor::Token,unsigned_int,false,false> *)&local_58,0);
...
/* ShaderPreprocessor::clear_state() */

void __thiscall ShaderPreprocessor::clear_state(ShaderPreprocessor *this)

{
  ...
  this_00 = *(RBMap<String,ShaderPreprocessor::Define*,Comparator<String>,DefaultAllocator> **)
             (this + 0x10);
  if (this_00 !=
      (RBMap<String,ShaderPreprocessor::Define*,Comparator<String>,DefaultAllocator> *)0x0) {
    if (*(long *)this_00 != 0) {
...
/* ShaderPreprocessor::expand_macros_once(String const&, int, RBMap<String,
   ShaderPreprocessor::Define*, Comparator<String>, DefaultAllocator>::Element const*, String&) */

char __thiscall
ShaderPreprocessor::expand_macros_once
          (ShaderPreprocessor *this,String *param_1,int param_2,Element *param_3,String *param_4)

{
  ...
  if ((*(long *)(lVar2 + 8) == 0) || (*(long *)(*(long *)(lVar2 + 8) + -8) < 1)) {
    ...
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
LAB_001044ed:
    CowData<char32_t>::_ref((CowData<char32_t> *)param_4,(CowData *)&local_a8);
  }
  else {
    lVar7 = *(long *)param_1;
    local_50[0] = (long *)0x0;
    ...
    if (lVar7 == 0) {
      ...
      lVar7 = *(long *)(lVar2 + 8);
LAB_00104780:
      if (*(long *)(lVar7 + -8) != 0) goto LAB_00104b90;
LAB_0010478b:
      concatenate_macro_body(this,(String *)&local_a0);
...
LAB_00104316:
      _err_print_index_error
                ("get","./core/templates/cowdata.h",0xdb,lVar6,lVar9,"p_index","size()","",false,
                 true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
      pcVar3 = (code *)invalidInstructionException();
...
LAB_0010495f:
      ...
      for (lVar6 = 0; lVar6 < lVar9; lVar6 = lVar6 + 1) {
        ...
        while( true ) {
          ...
          lVar9 = plVar4[-1];
          if (lVar9 <= lVar6) goto LAB_00104316;
          if ((*local_f0 != 0) && (iVar14 = (int)*(undefined8 *)(*local_f0 + -8), iVar14 != 0)) {
...
/* ShaderPreprocessor::expand_macros(String const&, int, String&) */

bool __thiscall
ShaderPreprocessor::expand_macros
          (ShaderPreprocessor *this,String *param_1,int param_2,String *param_3)
...
/* ShaderPreprocessor::expand_output_macros(int, int) */

void __thiscall
ShaderPreprocessor::expand_output_macros(ShaderPreprocessor *this,int param_1,int param_2)
...
/* ShaderPreprocessor::process_define(ShaderPreprocessor::Tokenizer*) */

void __thiscall ShaderPreprocessor::process_define(ShaderPreprocessor *this,Tokenizer *param_1)
...
LAB_0010514d:
  ...
  if (iVar4 == 0x28) {
    ...
    while ((Tokenizer::get_identifier((bool *)&local_80,SUB81(param_1,0)), local_80 != 0 &&
           (1 < *(uint *)(local_80 + -8)))) {
      local_58 = (char *)0x0;
      CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_80);
      Vector<String>::push_back
                ((Vector<String> *)&local_68,
                 (LocalVector<ShaderPreprocessor::Token,unsigned_int,false,false> *)&local_58);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
...
LAB_00105171:
    ...
    String::strip_edges(SUB81((CowData<char32_t> *)&local_80,0),
                        SUB81((ShaderPreprocessor *)&local_70,0));
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_70);
    if ((local_50 != (void *)0x0) &&
       (LocalVector<ShaderPreprocessor::Token,unsigned_int,false,false>::resize
                  ((LocalVector<ShaderPreprocessor::Token,unsigned_int,false,false> *)&local_58,0),
...
LAB_00105259:
        ...
        puVar7 = (undefined8 *)
                 RBMap<String,ShaderPreprocessor::Define*,Comparator<String>,DefaultAllocator>::
                 operator[](*(RBMap<String,ShaderPreprocessor::Define*,Comparator<String>,DefaultAllocator>
...
/* ShaderPreprocessor::insert_builtin_define(String, String, ShaderPreprocessor::State&) */

void __thiscall
ShaderPreprocessor::insert_builtin_define
          (undefined8 param_1,String *param_2,CowData *param_3,
          RBMap<String,ShaderPreprocessor::Define*,Comparator<String>,DefaultAllocator> *param_4)
  ...
  *(undefined1 *)((long)pvVar3 + 0x18) = 1;
  ...
  if (*(long *)param_4 == 0) {
    ...
    *(undefined4 **)param_4 = puVar5;
    local_48[0] = (CowData<char32_t>)0x0;
    local_48[1] = (CowData<char32_t>)0x0;
    local_48[2] = (CowData<char32_t>)0x0;
    local_48[3] = (CowData<char32_t>)0x0;
    local_48[4] = (CowData<char32_t>)0x0;
    local_48[5] = (CowData<char32_t>)0x0;
    local_48[6] = (CowData<char32_t>)0x0;
    local_48[7] = (CowData<char32_t>)0x0;
    local_48[8] = (CowData<char32_t>)0x0;
    local_48[9] = (CowData<char32_t>)0x0;
    local_48[10] = (CowData<char32_t>)0x0;
    local_48[0xb] = (CowData<char32_t>)0x0;
    local_48[0xc] = (CowData<char32_t>)0x0;
    local_48[0xd] = (CowData<char32_t>)0x0;
    local_48[0xe] = (CowData<char32_t>)0x0;
    local_48[0xf] = (CowData<char32_t>)0x0;
...
LAB_001055d6:
  ...
  lVar4 = RBMap<String,ShaderPreprocessor::Define*,Comparator<String>,DefaultAllocator>::_insert
                    (param_4,param_2,&local_58);
LAB_00105605:
...
/* ShaderPreprocessor::process_undef(ShaderPreprocessor::Tokenizer*) */

void __thiscall ShaderPreprocessor::process_undef(ShaderPreprocessor *this,Tokenizer *param_1)

{
  ...
  Tokenizer::get_identifier((bool *)&local_78,SUB81(param_1,0));
  if (((local_78 == 0) || (*(uint *)(local_78 + -8) < 2)) ||
     (cVar3 = Tokenizer::consume_empty_line(), cVar3 == '\0')) {
    local_68 = 0;
    local_50 = 0;
    local_58 = "";
    String::parse_latin1((StrRange *)&local_68);
    ...
    if ((*plVar4 != 0) && (lVar6 = *(long *)(*plVar4 + 0x10), lVar6 != plVar4[1])) {
      do {
        ...
        if (cVar3 == '\0') {
          ...
          if (cVar3 == '\0') {
            if (lVar6 != 0) {
              plVar4 = (long *)RBMap<String,ShaderPreprocessor::Define*,Comparator<String>,DefaultAllocator>
                               ::operator[](*(RBMap<String,ShaderPreprocessor::Define*,Comparator<String>,DefaultAllocator>
...
LAB_00105948:
  ...
  if (cVar3 == '\0') {
    if (((pEVar7 != (Element *)0x0) &&
        (RBMap<String,ShaderPreprocessor::Define*,Comparator<String>,DefaultAllocator>::_erase
                   (this_00,pEVar7), *(int *)(this_00 + 0x10) == 0)) &&
       (pvVar2 = *(void **)this_00, pvVar2 != (void *)0x0)) {
...
/* ShaderPreprocessor::start_branch_condition(ShaderPreprocessor::Tokenizer*, bool, bool) */

void __thiscall
ShaderPreprocessor::start_branch_condition
          (ShaderPreprocessor *this,Tokenizer *param_1,bool param_2,bool param_3)
...
LAB_00105fcb:
    *(Vector<bool> **)((long)pvVar3 + 0x10) = local_48;
...
/* ShaderPreprocessor::add_region(int, bool, ShaderPreprocessor::Region*) */

void __thiscall
ShaderPreprocessor::add_region(ShaderPreprocessor *this,int param_1,bool param_2,Region *param_3)
...
LAB_001062a0:
  ...
  ::_Data::_create_root(this_00);
LAB_001062b9:
  lVar5 = RBMap<String,List<ShaderPreprocessor::Region,DefaultAllocator>,Comparator<String>,DefaultAllocator>
          ::_insert((RBMap<String,List<ShaderPreprocessor::Region,DefaultAllocator>,Comparator<String>,DefaultAllocator>
                     *)this_00,(String *)&local_68,(List *)&local_70);
  List<ShaderPreprocessor::Region,DefaultAllocator>::~List
            ((List<ShaderPreprocessor::Region,DefaultAllocator> *)&local_70);
  lVar7 = *(long *)(lVar5 + 0x38);
joined_r0x00106321:
  if (lVar7 == 0) {
...
/* ShaderPreprocessor::process_elif(ShaderPreprocessor::Tokenizer*) */

void __thiscall ShaderPreprocessor::process_elif(ShaderPreprocessor *this,Tokenizer *param_1)

{
  ...
  if ((lVar3 == 0) || (*(char *)(lVar3 + 0x18) != '\0')) {
    ...
    if ((local_250 != (void *)0x0) &&
       (LocalVector<ShaderPreprocessor::Token,unsigned_int,false,false>::resize
                  ((LocalVector<ShaderPreprocessor::Token,unsigned_int,false,false> *)&local_258,0),
       local_250 != (void *)0x0)) {
    ...
    if ((local_278 == 0) || (*(uint *)(local_278 + -8) < 2)) {
      ...
      if ((iVar5 == 0) &&
         (iVar5 = expand_macros(this,(String *)&local_278,iVar2,(String *)&local_278), iVar5 == 0))
      {
...
LAB_00106844:
            ...
            if (*(char *)(*(long *)(this + 0x10) + 0x78) != '\0') {
              add_region(this,iVar2 + 1,(bool)uVar4,
                         *(Region **)(*(long *)(*(long *)(this + 0x10) + 0x98) + 0x18));
            }
            cVar1 = Variant::needs_deinit[local_248[0]];
          }
          if (cVar1 != '\0') {
...
/* ShaderPreprocessor::process_else(ShaderPreprocessor::Tokenizer*) */

void __thiscall ShaderPreprocessor::process_else(ShaderPreprocessor *this,Tokenizer *param_1)

{
  ...
  if (lVar4 == 0) {
    *(undefined1 *)(lVar3 + 0x18) = 1;
    ...
    bVar7 = true;
LAB_00106c19:
    add_region(this,iVar1 + 1,(bool)bVar7,*(Region **)(*(long *)(lVar2 + 0x98) + 0x18));
    if (bVar8 == 0) goto LAB_00106b04;
  }
  else {
    lVar6 = 0;
...
/* ShaderPreprocessor::process_if(ShaderPreprocessor::Tokenizer*) */

void __thiscall ShaderPreprocessor::process_if(ShaderPreprocessor *this,Tokenizer *param_1)

{
  ...
  if ((local_278 == 0) || (*(uint *)(local_278 + -8) < 2)) {
    ...
    if ((iVar4 == 0) &&
       (iVar4 = expand_macros(this,(String *)&local_278,iVar2,(String *)&local_278), iVar4 == 0)) {
      RefCounted::RefCounted((RefCounted *)local_228);
      local_a0 = 0;
      local_228[0] = Expression::execute;
      local_98 = 0;
...
/* ShaderPreprocessor::process_ifdef(ShaderPreprocessor::Tokenizer*) */

void __thiscall ShaderPreprocessor::process_ifdef(ShaderPreprocessor *this,Tokenizer *param_1)
...
LAB_00107191:
      bVar5 = false;
LAB_00107194:
      start_branch_condition(this,param_1,bVar5,false);
      if (*(char *)(*(long *)(this + 0x10) + 0x78) != '\0') {
...
/* ShaderPreprocessor::process_ifndef(ShaderPreprocessor::Tokenizer*) */

void __thiscall ShaderPreprocessor::process_ifndef(ShaderPreprocessor *this,Tokenizer *param_1)
...
/* ShaderPreprocessor::process_directive(ShaderPreprocessor::Tokenizer*) */

void __thiscall ShaderPreprocessor::process_directive(ShaderPreprocessor *this,Tokenizer *param_1)
...
/* ShaderPreprocessor::preprocess(ShaderPreprocessor::State*, String const&, String&) */

undefined4 __thiscall
ShaderPreprocessor::preprocess
          (ShaderPreprocessor *this,State *param_1,String *param_2,String *param_3)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  LocalVector<char32_t,unsigned_int,false,false>::resize
            ((LocalVector<char32_t,unsigned_int,false,false> *)this,0);
  lVar14 = *(long *)param_2;
      ...
      do {
        while( true ) {
          ...
          if (iVar7 == 0) {
            ...
            plVar2 = *(long **)(lVar14 + 0x48);
            if ((plVar2 == (long *)0x0) ||
               (plVar10 = (long *)*plVar2, plVar15 = plVar10, plVar10 == (long *)0x0))
            goto LAB_00107d08;
            goto LAB_00107ca9;
          }
...
LAB_00107d70:
  if ((local_88 != (void *)0x0) &&
     (LocalVector<ShaderPreprocessor::Token,unsigned_int,false,false>::resize
                ((LocalVector<ShaderPreprocessor::Token,unsigned_int,false,false> *)&local_90,0),
     local_88 != (void *)0x0)) {
...
LAB_001078df:
  ...
  if (local_70._0_8_ != 0) {
    LocalVector<char32_t,unsigned_int,false,false>::resize
              ((LocalVector<char32_t,unsigned_int,false,false> *)&local_78,0);
...
/* ShaderPreprocessor::process_include(ShaderPreprocessor::Tokenizer*) */

void __thiscall ShaderPreprocessor::process_include(ShaderPreprocessor *this,Tokenizer *param_1)

{
    ...
    if ((int)lVar7 != 0) {
      for (lVar15 = 0; (int)lVar15 < (int)lVar7 + -1; lVar15 = lVar15 + 1) {
        if (lVar7 != lVar15) {
          if (lVar7 <= lVar15) {
            _err_print_index_error
                      ("get","./core/templates/cowdata.h",0xdb,lVar15,lVar7,"p_index","size()","",
                       false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
            pcVar4 = (code *)invalidInstructionException();
  ...
  if (((local_b8 == 0) || (*(uint *)(local_b8 + -8) < 2)) ||
     (cVar5 = Tokenizer::consume_empty_line(), cVar5 == '\0')) {
    local_68 = 0;
    String::parse_latin1((String *)&local_68,"");
    local_70 = 0;
  ...
  String::parse_latin1((String *)&local_58,"");
  ResourceLoader::load
            ((Ref<Resource> *)&local_b0,(ShaderPreprocessor *)&local_b8,
             (LocalVector<ShaderPreprocessor::Token,unsigned_int,false,false> *)&local_58,1);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
  if (local_b0 == 0) {
    local_68 = 0;
    String::parse_latin1((String *)&local_68,"");
    ...
    String::parse_latin1
              ((String *)&local_70,
               "Shader include load failed. Does the shader include exist? Is there a cyclic dependency?"
              );
    RTR((String *)&local_58,(String *)&local_70);
    set_error(this,(String *)&local_58,iVar17);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
...
LAB_001083ee:
      ...
      if ((local_a0 != 0) && (1 < *(uint *)(local_a0 + -8))) {
        ...
        if (*(undefined8 **)(*(long *)(this + 0x10) + 0x48) != (undefined8 *)0x0) {
          for (plVar2 = (long *)**(undefined8 **)(*(long *)(this + 0x10) + 0x48);
              plVar2 != (long *)0x0; plVar2 = (long *)plVar2[1]) {
            if (lVar7 == *plVar2) {
              local_70 = 0;
              String::parse_latin1((String *)&local_70,": ");
              local_80 = 0;
...
LAB_00108f39:
        puVar13 = (undefined4 *)operator_new(0x38,DefaultAllocator::alloc);
      ...
      *(undefined8 *)(pEVar9 + 0x10) = uVar1;
      ...
      if ((puVar13 == *(undefined4 **)(lVar7 + 0x30)) ||
         (cVar5 = String::operator<((String *)&local_98,(String *)(puVar13 + 0xc)), cVar5 != '\0'))
      {
...
LAB_00108a3e:
      *(int *)(lVar7 + 0x40) = *(int *)(lVar7 + 0x40) + 1;
      ...
      if (iVar6 < 0x1a) {
        ...
        if (*(long *)(lVar7 + 0x58) == 0) {
          ...
          *(undefined4 *)(lVar7 + 0x28) = 0;
          ...
          if (local_98 != lVar15) {
LAB_00108a9c:
            CowData<char32_t>::_ref((CowData<char32_t> *)(lVar7 + 0x58),(CowData *)&local_98);
            lVar7 = *(long *)(this + 0x10);
            lVar15 = *(long *)(lVar7 + 0x58);
          }
          local_58 = 0;
        ...
        *(int *)(plVar2 + 2) = (int)plVar2[2] + 1;
        local_88 = 0;
        preprocess((ShaderPreprocessor *)&local_58,*(State **)(this + 0x10),(String *)&local_a0,
                   (String *)&local_88);
        local_78 = 0;
        String::parse_latin1((String *)&local_78,"\n");
        operator+((char *)&local_80,(String *)&_LC104);
        String::operator+((String *)&local_70,(String *)&local_80);
        ...
        local_78 = 0;
        String::parse_latin1((String *)&local_78,"\n");
        operator+((char *)&local_80,(String *)&_LC105);
        String::operator+((String *)&local_70,(String *)&local_80);
        add_to_output(this,(String *)&local_70);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_70);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_80);
        ...
        if ((*(long *)(lVar7 + 0x68) == 0) || (*(uint *)(*(long *)(lVar7 + 0x68) + -8) < 2)) {
          ...
          plVar2 = *(long **)(lVar7 + 0x70);
          if ((plVar2 != (long *)0x0) &&
             (pCVar11 = (CowData<char32_t> *)plVar2[1], pCVar11 != (CowData<char32_t> *)0x0)) {
...
int __thiscall
ShaderPreprocessor::preprocess
          (ShaderPreprocessor *this,String *param_1,String *param_2,String *param_3,String *param_4,
          List *param_5,List *param_6,HashSet *param_7,List *param_8,List *param_9,
          _func_void_List_ptr *param_10)

{
  ...
  local_140[0] = (CowData<char32_t>)0x0;
  local_140[1] = (CowData<char32_t>)0x0;
  local_140[2] = (CowData<char32_t>)0x0;
  local_140[3] = (CowData<char32_t>)0x0;
  local_140[4] = (CowData<char32_t>)0x0;
  local_140[5] = (CowData<char32_t>)0x0;
  local_140[6] = (CowData<char32_t>)0x0;
  local_140[7] = (CowData<char32_t>)0x0;
  local_140[8] = (CowData<char32_t>)0x0;
  local_140[9] = (CowData<char32_t>)0x0;
  local_140[10] = (CowData<char32_t>)0x0;
  local_140[0xb] = (CowData<char32_t>)0x0;
  local_140[0xc] = (CowData<char32_t>)0x0;
  local_140[0xd] = (CowData<char32_t>)0x0;
  local_140[0xe] = (CowData<char32_t>)0x0;
  local_140[0xf] = (CowData<char32_t>)0x0;
  local_130 = (undefined1  [16])0x0;
  local_f0[0] = (HashSet)0x0;
  local_f0[1] = (HashSet)0x0;
  local_f0[2] = (HashSet)0x0;
  local_f0[3] = (HashSet)0x0;
  local_f0[4] = (HashSet)0x0;
  local_f0[5] = (HashSet)0x0;
  local_f0[6] = (HashSet)0x0;
  local_f0[7] = (HashSet)0x0;
  local_f0[8] = (HashSet)0x0;
  local_f0[9] = (HashSet)0x0;
  local_f0[10] = (HashSet)0x0;
  local_f0[0xb] = (HashSet)0x0;
  local_f0[0xc] = (HashSet)0x0;
  local_f0[0xd] = (HashSet)0x0;
  local_f0[0xe] = (HashSet)0x0;
  local_f0[0xf] = (HashSet)0x0;
  ...
  if (iVar5 != 0) {
    ...
    if (param_5 != (List *)0x0) {
      ...
      plVar8 = (long *)0x0;
LAB_00109550:
      if (((long *)local_130._8_8_ != (long *)0x0) &&
         (pCVar11 = *(CowData **)local_130._8_8_, pCVar11 != (CowData *)0x0)) {
        if (plVar8 == (long *)0x0) {
          pauVar10 = (undefined1 (*) [16])operator_new(0x18,DefaultAllocator::alloc);
...
LAB_0010962f:
  if (param_6 != (List *)0x0) {
    if ((local_118 == 0) &&
       (RBMap<String,List<ShaderPreprocessor::Region,DefaultAllocator>,Comparator<String>,DefaultAllocator>
        ::_Data::_create_root((_Data *)&local_118), local_118 == 0)) {
LAB_00109ded:
      local_1a8 = (char *)0x0;
      RBMap<String,List<ShaderPreprocessor::Region,DefaultAllocator>,Comparator<String>,DefaultAllocator>
      ::_Data::_create_root((_Data *)&local_118);
    }
    else {
...
LAB_001096aa:
    ...
    puVar9 = (undefined8 *)
             RBMap<String,List<ShaderPreprocessor::Region,DefaultAllocator>,Comparator<String>,DefaultAllocator>
             ::_insert((RBMap<String,List<ShaderPreprocessor::Region,DefaultAllocator>,Comparator<String>,DefaultAllocator>
                        *)&local_118,param_2,local_228);
    List<ShaderPreprocessor::Region,DefaultAllocator>::~List
              ((List<ShaderPreprocessor::Region,DefaultAllocator> *)local_228);
LAB_00109d01:
    plVar8 = *(long **)param_6;
    if (plVar8 != (long *)0x0) {
      do {
    ...
    plVar8 = (long *)0x0;
LAB_0010a0b3:
    if (((long *)puVar9[7] != (long *)0x0) &&
       (pCVar11 = *(CowData **)puVar9[7], pCVar11 != (CowData *)0x0)) {
      uVar2 = _LC90;
      if (plVar8 == (long *)0x0) {
        pauVar10 = (undefined1 (*) [16])operator_new(0x18,DefaultAllocator::alloc);
  ...
  if (param_7 != (HashSet *)0x0) {
    HashSet<Ref<ShaderInclude>,HashMapHasherDefault,HashMapComparatorDefault<Ref<ShaderInclude>>>::
    operator=((HashSet<Ref<ShaderInclude>,HashMapHasherDefault,HashMapComparatorDefault<Ref<ShaderInclude>>>
               *)param_7,local_f0);
  }
  if (param_9 != (List *)0x0) {
      ...
      if (lVar6 != lVar1) {
        ...
        do {
          ...
          ScriptLanguage::CodeCompletionOption::CodeCompletionOption
                    (local_c8,lVar12 + 0x30,6,0x400,(StrRange *)&local_1b0);
          CowData<char32_t>::_unref((CowData<char32_t> *)&local_1b0);
          List<ScriptLanguage::CodeCompletionOption,DefaultAllocator>::push_back
                    ((List<ScriptLanguage::CodeCompletionOption,DefaultAllocator> *)param_9,local_c8
                    );
  ...
  if (param_8 != (List *)0x0) {
    if (local_f4 == 4) {
      ...
      ScriptLanguage::CodeCompletionOption::CodeCompletionOption
                (local_c8,(StrRange *)&local_1b0,9,0x400,local_228);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_1b0);
      CowData<char32_t>::_unref((CowData<char32_t> *)local_228);
      List<ScriptLanguage::CodeCompletionOption,DefaultAllocator>::push_back
                ((List<ScriptLanguage::CodeCompletionOption,DefaultAllocator> *)param_8,local_c8);
      ...
      if (local_f4 == 1) {
        ...
        if ((local_1b8 != (long *)0x0) && (lVar6 = *local_1b8, lVar6 != 0)) {
          do {
            ...
            String::parse_latin1((StrRange *)&local_1b0);
            ScriptLanguage::CodeCompletionOption::CodeCompletionOption
                      (local_c8,lVar6,9,0x400,(StrRange *)&local_1b0);
            CowData<char32_t>::_unref((CowData<char32_t> *)&local_1b0);
            List<ScriptLanguage::CodeCompletionOption,DefaultAllocator>::push_back
                      ((List<ScriptLanguage::CodeCompletionOption,DefaultAllocator> *)param_8,
                       local_c8);
            Array::~Array(local_50);
            CowData<char32_t>::_unref(local_58);
            lVar1 = local_68;
        ...
        String::parse_latin1((StrRange *)&local_1b0);
        List<String,DefaultAllocator>::push_back
                  ((List<String,DefaultAllocator> *)&local_1b8,(String *)&local_1b0);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_1b0);
        if ((local_1b8 != (long *)0x0) && (lVar6 = *local_1b8, lVar6 != 0)) {
          do {
            local_1b0 = 0;
...
void RBMap<String,ShaderPreprocessor::Define*,Comparator<String>,DefaultAllocator>::_set_color
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashSet<Ref<ShaderInclude>, HashMapHasherDefault, HashMapComparatorDefault<Ref<ShaderInclude> >
   >::insert(Ref<ShaderInclude> const&) */
...
/* LocalVector<char32_t, unsigned int, false, false>::resize(unsigned int) */

void __thiscall
LocalVector<char32_t,unsigned_int,false,false>::resize
          (LocalVector<char32_t,unsigned_int,false,false> *this,uint param_1)
...
/* HashSet<Ref<ShaderInclude>, HashMapHasherDefault, HashMapComparatorDefault<Ref<ShaderInclude> >
   ...
   HashMapComparatorDefault<Ref<ShaderInclude> > > const&) */

void __thiscall
HashSet<Ref<ShaderInclude>,HashMapHasherDefault,HashMapComparatorDefault<Ref<ShaderInclude>>>::
operator=(HashSet<Ref<ShaderInclude>,HashMapHasherDefault,HashMapComparatorDefault<Ref<ShaderInclude>>>
          *this,HashSet *param_1)

{
  ...
  if (this == (HashSet<Ref<ShaderInclude>,HashMapHasherDefault,HashMapComparatorDefault<Ref<ShaderInclude>>>
               *)param_1) {
    return;
  }
  pvVar11 = *(void **)this;
    ...
    *(undefined8 *)(this + 8) = uVar8;
    if (*(int *)(this + 0x24) != 0) {
      do {
        ...
        *(undefined4 *)(*(long *)(this + 0x10) + lVar10 * 4) =
...
/* WARNING: Removing unreachable block (ram,0x0010b558) */
...
/* ShaderPreprocessor::_set_unexpected_token_error(String const&, int) */

void __thiscall
ShaderPreprocessor::_set_unexpected_token_error
          (ShaderPreprocessor *this,String *param_1,int param_2)
...
/* ShaderPreprocessor::_set_expected_error(String const&, int) */

void __thiscall
ShaderPreprocessor::_set_expected_error(ShaderPreprocessor *this,String *param_1,int param_2)
...
void __thiscall
RBMap<String,ShaderPreprocessor::Define*,Comparator<String>,DefaultAllocator>::_cleanup_tree
          (RBMap<String,ShaderPreprocessor::Define*,Comparator<String>,DefaultAllocator> *this,
          Element *param_1)
...
/* RBMap<String, ShaderPreprocessor::Define*, Comparator<String>, DefaultAllocator>::clear() */
...
/* LocalVector<ShaderPreprocessor::Token, unsigned int, false, false>::resize(unsigned int) */

void __thiscall
LocalVector<ShaderPreprocessor::Token,unsigned_int,false,false>::resize
          (LocalVector<ShaderPreprocessor::Token,unsigned_int,false,false> *this,uint param_1)
...

{
  ...
  *(undefined4 **)this = puVar2;
  ...
  local_48 = 0;
  List<ShaderPreprocessor::Region,DefaultAllocator>::~List
            ((List<ShaderPreprocessor::Region,DefaultAllocator> *)(local_38 + 8));
  CowData<char32_t>::_unref(local_38);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
  List<ShaderPreprocessor::Region,DefaultAllocator>::~List
            ((List<ShaderPreprocessor::Region,DefaultAllocator> *)&local_40);
...
/* RBMap<String, List<ShaderPreprocessor::Region, DefaultAllocator>, Comparator<String>,
   ...
   DefaultAllocator>, Comparator<String>, DefaultAllocator>::Element*) [clone .part.0] */

void __thiscall
RBMap<String,List<ShaderPreprocessor::Region,DefaultAllocator>,Comparator<String>,DefaultAllocator>
::_cleanup_tree(RBMap<String,List<ShaderPreprocessor::Region,DefaultAllocator>,Comparator<String>,DefaultAllocator>
...

{
  ...
  if (pEVar1 != pEVar2) {
    ...
    if (pEVar2 != pEVar4) {
      ...
      if (pEVar2 != pEVar6) {
        ...
        if (pEVar2 != pEVar3) {
          ...
          List<ShaderPreprocessor::Region,DefaultAllocator>::~List
                    ((List<ShaderPreprocessor::Region,DefaultAllocator> *)(pEVar3 + 0x38));
          CowData<char32_t>::_unref((CowData<char32_t> *)(pEVar3 + 0x30));
          Memory::free_static(pEVar3,false);
          pEVar3 = *(Element **)(this + 8);
        }
        ...
        if (pEVar2 != pEVar3) {
          ...
          List<ShaderPreprocessor::Region,DefaultAllocator>::~List
                    ((List<ShaderPreprocessor::Region,DefaultAllocator> *)(pEVar2 + 0x38));
          CowData<char32_t>::_unref((CowData<char32_t> *)(pEVar2 + 0x30));
          Memory::free_static(pEVar2,false);
        }
        List<ShaderPreprocessor::Region,DefaultAllocator>::~List
                  ((List<ShaderPreprocessor::Region,DefaultAllocator> *)(pEVar6 + 0x38));
        CowData<char32_t>::_unref((CowData<char32_t> *)(pEVar6 + 0x30));
        Memory::free_static(pEVar6,false);
        pEVar6 = *(Element **)(this + 8);
      }
      ...
      List<ShaderPreprocessor::Region,DefaultAllocator>::~List
                ((List<ShaderPreprocessor::Region,DefaultAllocator> *)(pEVar4 + 0x38));
      CowData<char32_t>::_unref((CowData<char32_t> *)(pEVar4 + 0x30));
      Memory::free_static(pEVar4,false);
      pEVar4 = *(Element **)(this + 8);
    }
    ...
    List<ShaderPreprocessor::Region,DefaultAllocator>::~List
              ((List<ShaderPreprocessor::Region,DefaultAllocator> *)(pEVar1 + 0x38));
    CowData<char32_t>::_unref((CowData<char32_t> *)(pEVar1 + 0x30));
    Memory::free_static(pEVar1,false);
    pEVar2 = *(Element **)(this + 8);
  }
  ...
  List<ShaderPreprocessor::Region,DefaultAllocator>::~List
            ((List<ShaderPreprocessor::Region,DefaultAllocator> *)(param_1 + 0x38));
  CowData<char32_t>::_unref((CowData<char32_t> *)(param_1 + 0x30));
  Memory::free_static(param_1,false);
  return;
}
...
/* ShaderPreprocessor::State::~State() */

void __thiscall ShaderPreprocessor::State::~State(State *this)
  ...
  *this_01;
  ...
  if (*(int *)(this + 0xcc) != 0) {
    if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 200) * 4) != 0) {
      memset(*(void **)(this + 0xc0),0,
             (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 200) * 4) << 2);
...
LAB_0010df2b:
  ...
  if (pvVar13 != (void *)0x0) {
    ...
    if (pEVar3 != pEVar7) {
      ...
      this_01 = (RBMap<String,List<ShaderPreprocessor::Region,DefaultAllocator>,Comparator<String>,DefaultAllocator>
                 *)(this + 0x80);
      if (pEVar7 != pEVar10) {
        pEVar14 = *(Element **)(pEVar10 + 0x10);
        if (pEVar7 != pEVar14) {
          RBMap<String,List<ShaderPreprocessor::Region,DefaultAllocator>,Comparator<String>,DefaultAllocator>
          ::_cleanup_tree(this_01,pEVar14);
          pEVar14 = *(Element **)(this + 0x88);
        }
        if (*(Element **)(pEVar10 + 8) != pEVar14) {
          RBMap<String,List<ShaderPreprocessor::Region,DefaultAllocator>,Comparator<String>,DefaultAllocator>
          ::_cleanup_tree(this_01,*(Element **)(pEVar10 + 8));
        }
        List<ShaderPreprocessor::Region,DefaultAllocator>::~List
                  ((List<ShaderPreprocessor::Region,DefaultAllocator> *)(pEVar10 + 0x38));
      ...
      if (pEVar7 != pEVar10) {
        if (*(Element **)(pEVar7 + 0x10) != pEVar10) {
          RBMap<String,List<ShaderPreprocessor::Region,DefaultAllocator>,Comparator<String>,DefaultAllocator>
          ::_cleanup_tree(this_01,*(Element **)(pEVar7 + 0x10));
          pEVar10 = *(Element **)(this + 0x88);
        }
        if (pEVar10 != *(Element **)(pEVar7 + 8)) {
          RBMap<String,List<ShaderPreprocessor::Region,DefaultAllocator>,Comparator<String>,DefaultAllocator>
          ::_cleanup_tree(this_01,*(Element **)(pEVar7 + 8));
        }
        List<ShaderPreprocessor::Region,DefaultAllocator>::~List
                  ((List<ShaderPreprocessor::Region,DefaultAllocator> *)(pEVar7 + 0x38));
        CowData<char32_t>::_unref((CowData<char32_t> *)(pEVar7 + 0x30));
        Memory::free_static(pEVar7,false);
      }
      List<ShaderPreprocessor::Region,DefaultAllocator>::~List
    ...
    *(undefined4 *)(this + 0x90) = 0;
    List<ShaderPreprocessor::Region,DefaultAllocator>::~List
              ((List<ShaderPreprocessor::Region,DefaultAllocator> *)((long)pvVar13 + 0x38));
...
/* RBMap<String, ShaderPreprocessor::Define*, Comparator<String>, DefaultAllocator>::_insert(String
   const&, ShaderPreprocessor::Define* const&) */

int * __thiscall
RBMap<String,ShaderPreprocessor::Define*,Comparator<String>,DefaultAllocator>::_insert
          (RBMap<String,ShaderPreprocessor::Define*,Comparator<String>,DefaultAllocator> *this,
          String *param_1,Define **param_2)
...
LAB_0010e9bf:
  ...
  if (*(long *)param_1 == 0) {
    ...
    *(undefined1 (*) [16])(piVar6 + 6) = (undefined1  [16])0x0;
...
long __thiscall
RBMap<String,ShaderPreprocessor::Define*,Comparator<String>,DefaultAllocator>::operator[]
          (RBMap<String,ShaderPreprocessor::Define*,Comparator<String>,DefaultAllocator> *this,
          String *param_1)
...
void __thiscall
RBMap<String,ShaderPreprocessor::Define*,Comparator<String>,DefaultAllocator>::_erase_fix_rb
          (RBMap<String,ShaderPreprocessor::Define*,Comparator<String>,DefaultAllocator> *this,
          Element *param_1)
...
LAB_0010fbec:
    ...
    lVar3 = puVar7[-1];
    if (param_1 <= lVar3) goto LAB_0010fb78;
  }
  else {
    if (lVar9 != 0) {
...
/* RBMap<String, List<ShaderPreprocessor::Region, DefaultAllocator>, Comparator<String>,
   ...
   DefaultAllocator>, Comparator<String>, DefaultAllocator>::Element*) */

void __thiscall
RBMap<String,List<ShaderPreprocessor::Region,DefaultAllocator>,Comparator<String>,DefaultAllocator>
::_insert_rb_fix(RBMap<String,List<ShaderPreprocessor::Region,DefaultAllocator>,Comparator<String>,DefaultAllocator>
                 *this,Element *param_1)

{
  ...
  do {
    while( true ) {
      ...
      pEVar7 = pEVar8;
      if (pEVar6 == pEVar8) break;
      if (*(int *)pEVar6 == 0) goto LAB_0011025d;
      if (*(Element **)(pEVar8 + 0x10) == param_1) {
        lVar2 = *(long *)(this + 8);
        lVar3 = *(long *)(param_1 + 8);
        *(long *)(pEVar8 + 0x10) = lVar3;
        ...
        *(int *)param_1 = 1;
        pEVar7 = param_1;
        if (pEVar5 == pEVar6) goto LAB_00110380;
LAB_00110206:
        *(int *)pEVar5 = 0;
      }
      else {
        ...
        *(int *)pEVar8 = 1;
        pEVar8 = param_1;
        if (pEVar5 != pEVar6) goto LAB_00110206;
LAB_00110380:
        _err_print_error("_set_color","./core/templates/rb_map.h",0xed,
                         "Condition \"p_node == _data._nil && p_color == RED\" is true.",0,0);
      }
...
LAB_00110472:
          ...
          *(Element **)(lVar3 + 0x18) = pEVar8;
          pEVar7 = *(Element **)(pEVar8 + 0x18);
          *(Element **)(param_1 + 0x18) = pEVar7;
          if (pEVar8 == *(Element **)(pEVar7 + 0x10)) goto LAB_00110472;
          *(Element **)(pEVar7 + 8) = param_1;
        }
        *(Element **)(param_1 + 0x10) = pEVar8;
        *(Element **)(pEVar8 + 0x18) = param_1;
        ...
        *(int *)param_1 = 1;
        pEVar7 = param_1;
        if (pEVar5 == pEVar6) goto LAB_00110440;
LAB_001102d0:
        *(int *)pEVar5 = 0;
      }
      else {
        ...
        *(int *)pEVar8 = 1;
        pEVar8 = param_1;
        if (pEVar5 != pEVar6) goto LAB_001102d0;
LAB_00110440:
        _err_print_error("_set_color","./core/templates/rb_map.h",0xed,
                         "Condition \"p_node == _data._nil && p_color == RED\" is true.",0,0);
      }
    ...
    do {
      while( true ) {
        ...
        if (cVar3 == '\0') {
          ...
          if (plVar12 == (long *)0x0) goto LAB_0011098d;
          goto LAB_00110919;
        }
        pEVar4 = *(Element **)(pEVar8 + 8);
        if (*(Element **)(this + 8) == *(Element **)(pEVar8 + 8)) goto LAB_0011050d;
      }
      pEVar4 = *(Element **)(pEVar8 + 0x10);
    } while (*(Element **)(this + 8) != *(Element **)(pEVar8 + 0x10));
  }
LAB_0011050d:
  pEVar4 = (Element *)operator_new(0x40,DefaultAllocator::alloc);
  local_58 = 0;
  ...
  if ((*(long **)param_2 == (long *)0x0) ||
     (pCVar11 = (CowData *)**(long **)param_2, pCVar11 == (CowData *)0x0)) {
    *(undefined4 *)pEVar4 = 0;
    ...
    do {
      while( true ) {
        ...
        *(CowData<char32_t> **)*pauVar5 = pCVar6;
        if (pCVar11 == (CowData *)0x0) goto LAB_00110665;
      }
      pCVar11 = *(CowData **)(pCVar11 + 0x20);
      *(int *)pauVar5[1] = *(int *)pauVar5[1] + 1;
    } while (pCVar11 != (CowData *)0x0);
      ...
      *pauVar5 = (undefined1  [16])0x0;
      do {
        while( true ) {
          ...
          *plVar12 = (long)pCVar6;
          if (pCVar11 == (CowData *)0x0) goto LAB_0011079c;
        }
        pCVar11 = *(CowData **)(pCVar11 + 0x20);
        *(int *)(plVar12 + 2) = (int)plVar12[2] + 1;
      } while (pCVar11 != (CowData *)0x0);
...
LAB_0011079c:
  local_70 = pEVar4 + 8;
  List<ShaderPreprocessor::Region,DefaultAllocator>::~List
            ((List<ShaderPreprocessor::Region,DefaultAllocator> *)local_50);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
...
LAB_001107ed:
  ...
  *(Element **)(pEVar4 + 0x20) = pEVar7;
  ...
  if (*(Element **)(this + 8) == *(Element **)(pEVar4 + 0x10)) {
    ...
    if (*(Element **)this != pEVar10) goto LAB_0011083c;
    *(undefined8 *)(pEVar4 + 0x28) = 0;
    if (pEVar7 != (Element *)0x0) goto LAB_00110846;
  }
  else {
    do {
      pEVar8 = pEVar10;
...
LAB_0011083c:
    *(Element **)(pEVar4 + 0x28) = pEVar8;
    if (pEVar7 != (Element *)0x0) {
LAB_00110846:
      *(Element **)(pEVar7 + 0x28) = pEVar4;
      pEVar8 = *(Element **)(pEVar4 + 0x28);
      if (pEVar8 == (Element *)0x0) goto LAB_00110858;
    }
...
LAB_00110919:
    pCVar6 = (CowData<char32_t> *)*plVar12;
    if (pCVar6 == (CowData<char32_t> *)0x0) goto LAB_00110990;
  }
  ...
  if ((*(long **)param_2 != (long *)0x0) &&
    ...
    do {
      while( true ) {
        ...
        *(int *)(plVar12 + 2) = (int)plVar12[2] + 1;
        *plVar12 = (long)pCVar6;
        if (pCVar11 == (CowData *)0x0) goto LAB_00110867;
      }
      pCVar11 = *(CowData **)(pCVar11 + 0x20);
      *(int *)(plVar12 + 2) = (int)plVar12[2] + 1;
    } while (pCVar11 != (CowData *)0x0);

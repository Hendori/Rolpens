...
LAB_00105912:
      local_c8 = (CowData<MultiplayerSynchronizer::Watcher> *)(this + 0x488);
      if (uVar15 == 0) {
...
undefined8 __thiscall
CowData<MultiplayerSynchronizer::Watcher>::_realloc
          (CowData<MultiplayerSynchronizer::Watcher> *this,long param_1)

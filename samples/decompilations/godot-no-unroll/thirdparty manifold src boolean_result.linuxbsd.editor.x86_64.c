...

{
  ...
  if (__src == pvVar1) {
    uVar4 = uVar3 + 1;
    if (0xfffffffffffffffe < uVar3) goto LAB_00109870;
...
LAB_00109870:
  ...
  *(undefined4 *)((long)__dest_00 + __n + 8) = *(undefined4 *)(param_3 + 1);
  if ((long)__n < 1) {
    ...
    if (__src == (void *)0x0) goto LAB_00109853;
  }
  else {
    __dest_00 = memmove(__dest_00,__src,__n);
    if (0 < (long)__n_00) {
...

{
  ...
  if (puVar2 == puVar1) {
    if (0xfffffffffffffffe < uVar5) goto LAB_00109a48;
...
LAB_001099ba:
    ...
    puVar8 = puVar10;
    if (param_2 == puVar1) goto LAB_00109a0c;
  }
  else {
    uVar7 = uVar5 * 2;
    if (uVar7 < uVar5) {
LAB_00109a48:
    ...
    *puVar8 = *param_3;
    puVar8[1] = uVar3;
    if (param_2 != puVar2) goto LAB_001099ba;
  }
...

{
  ...
  if (0 < lVar2 >> 4) {
    ...
    do {
      if (*param_1 == iVar1) goto LAB_00109b2b;
      if (iVar1 == param_1[1]) {
        param_1 = param_1 + 1;
        goto LAB_00109b2b;
      }

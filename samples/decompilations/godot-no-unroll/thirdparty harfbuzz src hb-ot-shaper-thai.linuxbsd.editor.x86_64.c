  ...
  if ((param_5) || (!param_4)) {
    *(uint *)(this + 0xc0) = *(uint *)(this + 0xc0) | 0x20;
    if ((param_5) && (this[0x5a] != (hb_buffer_t)0x0)) {
      ...
      if (uVar11 == param_3) {
        local_44 = 0xffffffff;
        if (param_2 == uVar5) goto LAB_00100990;
        if (iVar1 == 2) goto LAB_00100d2e;
LAB_00100ae5:
        ...
        if (param_2 == uVar5) {
LAB_00100dc5:
          if (param_3 == uVar11) goto LAB_00100990;
LAB_00100dce:
...
LAB_00100ba9:
          ...
          if (uVar7 != uVar2) goto LAB_00100d82;
          if (uVar7 == uVar13) goto LAB_00100c8d;
          if (param_2 < uVar5) {
        ...
        if (uVar11 == param_3) goto LAB_00100990;
        uVar9 = (ulong)(param_3 - 1);
        uVar6 = (ulong)uVar11;
...
LAB_00100bd3:
        if (uVar5 != uVar7) {
          if (uVar13 != uVar7) goto LAB_00100df6;
          if (uVar5 != uVar7) {
            if (uVar11 < param_3) {
...
LAB_00100d2e:
            ...
            if (param_2 < uVar5) {
              ...
              if (param_2 == uVar5) goto LAB_00100dc5;
            }
            local_50 = uVar6 * 0x14;
LAB_00100d82:
            if (param_2 < uVar5) {
        ...
        local_44 = uVar7;
        if (param_2 != uVar5) goto LAB_00100ae5;
LAB_00100dd5:
        uVar5 = *(uint *)(lVar3 + 8 + uVar6 * 0x14);
        uVar13 = *(uint *)(lVar3 + 8 + uVar9 * 0x14);
        if (iVar1 != 2) goto LAB_00100bd3;
LAB_00100df6:
        if (uVar11 < param_3) {
          puVar4 = (uint *)(lVar3 + 4 + uVar6 * 0x14);
          do {

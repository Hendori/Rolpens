...
LAB_001006bf:
    ...
    if ((iVar11 != 0) &&
       (iVar11 = VP8PutBitUniform(lVar23,*(int *)(param_1 + 0x1c) != 0), iVar11 != 0)) {
    ...
    uVar27 = 3;
    if ((iVar11 != 8) && (uVar27 = 2, iVar11 != 4)) {
      uVar27 = iVar11 == 2;
    }
    VP8PutBits(lVar23,uVar27,2);
    VP8PutBits(lVar23,*(undefined4 *)(param_1 + 0xe00),7);
    VP8PutSignedBits(lVar23,*(undefined4 *)(param_1 + 0xe0c),4);
    VP8PutSignedBits(lVar23,*(undefined4 *)(param_1 + 0xe10),4);
    VP8PutSignedBits(lVar23,*(undefined4 *)(param_1 + 0xe14),4);
    VP8PutSignedBits(lVar23,*(undefined4 *)(param_1 + 0xe18),4);
    VP8PutSignedBits(lVar23,*(undefined4 *)(param_1 + 0xe1c),4);
    VP8PutBitUniform(lVar23,0);
    ...
    if (lVar9 != 0) {
      ...
      *(int *)(lVar9 + 0x28) =
           (int)(((long)*(int *)(param_1 + 0x4c) + 0xf +
                 ((long)*(int *)(param_1 + 0x48) + uVar26) * 8) - lVar7 >> 3);
      uVar4 = *(undefined4 *)(param_1 + 0x228);
      *(int *)(lVar9 + 0x24) =
           (int)((ulong)((lVar7 - (iVar12 + 8)) + 7 + (iVar14 + lVar6) * -8) >> 3);
...
LAB_00100858:
      uVar20 = 8;
LAB_0010085d:
      iVar12 = WebPEncodingSetError(lVar6,uVar20);
...
LAB_001004f0:
          ...
          if (((int)uVar26 == 0) ||
             (iVar14 = (**(code **)(lVar5 + 0x60))
                                 (*(undefined8 *)(lVar23 + 0x10),*(long *)(lVar23 + 0x18),lVar5),
             iVar14 == 0)) {
            VP8BitWriterWipeOut(lVar23);
          ...
          VP8BitWriterWipeOut(lVar23);
LAB_001004a7:
          iVar14 = WebPReportProgress(lVar5,*(int *)(param_1 + 0x218) + (int)(0x13 / (long)iVar2),
                                      param_1 + 0x218);
...
LAB_00100569:
    ...
    if (*(int *)(param_1 + 0x21c) != 0) {
      ...
      if (*(int *)(param_1 + 0x21c) != 0) {
        ...
        if ((iVar12 == 0) ||
           (iVar12 = (**(code **)(lVar7 + 0x60))
                               (*(undefined8 *)(param_1 + 0x220),*(undefined4 *)(param_1 + 0x228)),
           iVar12 == 0)) goto LAB_00100858;
    ...
    uStack_52 = (ushort)((*(uint *)(lVar6 + 8) >> 8 & 0xff) << 8) |
                (ushort)*(uint *)(lVar6 + 8) & 0xff;
    ...
    if (iVar12 == 0) goto LAB_00100858;
LAB_0010041b:
    iVar12 = (**(code **)(lVar5 + 0x60))(uVar10,uVar26,lVar5);
...
LAB_00100506:
    ...
    *(int *)(param_1 + 0x5c00) = (int)uVar1 + 8;
    if (((int)uVar26 == 0) ||
       (iVar12 = WebPReportProgress(lVar5,iVar3 + 0x13,param_1 + 0x218), iVar12 == 0))
    goto LAB_00100569;
  }
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return uVar26;

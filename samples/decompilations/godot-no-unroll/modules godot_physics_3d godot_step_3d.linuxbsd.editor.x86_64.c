...
/* GodotStep3D::_solve_island(unsigned int, void*) */

void GodotStep3D::_solve_island(uint param_1,void *param_2)
...
LAB_0010012e:
  _err_print_index_error
            ("operator[]","./core/templates/local_vector.h",0xb2,uVar7,uVar11,"p_index","count","",
             false,true);
  _err_flush_stdout();
...
/* GodotStep3D::_setup_constraint(unsigned int, void*) */

void GodotStep3D::_setup_constraint(uint param_1,void *param_2)
...
/* GodotStep3D::_populate_island_soft_body(GodotSoftBody3D*, LocalVector<GodotBody3D*, unsigned int,
   false, false>&, LocalVector<GodotConstraint3D*, unsigned int, false, false>&) */

void __thiscall
GodotStep3D::_populate_island_soft_body
          (GodotStep3D *this,GodotSoftBody3D *param_1,LocalVector *param_2,LocalVector *param_3)
        ...
        *(long *)((long)pvVar8 + (ulong)uVar2 * 8) = lVar11;
        if (0 < *(int *)(lVar11 + 0x10)) {
          do {
            ...
            if ((*(long *)this != *(long *)(pGVar4 + 0x368)) &&
               (iVar6 = GodotBody3D::get_mode(), iVar6 != 0)) {
...
/* GodotStep3D::_populate_island(GodotBody3D*, LocalVector<GodotBody3D*, unsigned int, false,
   false>&, LocalVector<GodotConstraint3D*, unsigned int, false, false>&) */

void __thiscall
GodotStep3D::_populate_island
          (GodotStep3D *this,GodotBody3D *param_1,LocalVector *param_2,LocalVector *param_3)
  ...
  do {
    ...
    if (*(long *)this != plVar3[3]) {
      ...
      *(long **)((long)pvVar10 + (ulong)uVar1 * 8) = plVar3;
      if (0 < (int)plVar3[2]) {
        do {
          if (((*(int *)(puVar2 + 3) != (int)lVar11) &&
              (pGVar4 = *(GodotBody3D **)(plVar3[1] + lVar11 * 8),
              *(long *)this != *(long *)(pGVar4 + 0x368))) &&
             (iVar5 = GodotBody3D::get_mode(), iVar5 != 0)) {
            _populate_island(this,pGVar4,param_2,param_3);
          }
          lVar11 = lVar11 + 1;
...
void __thiscall GodotStep3D::_pre_solve_island(GodotStep3D *this,LocalVector *param_1)
  ...
  do {
    while( true ) {
      if ((uint)uVar10 <= (uint)uVar7) {
        _err_print_index_error
                  ("operator[]","./core/templates/local_vector.h",0xb2,uVar7,uVar10,"p_index",
                   "count","",false,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
...
void __thiscall GodotStep3D::_check_suspend(GodotStep3D *this,LocalVector *param_1)
...
LAB_00100931:
  _err_print_index_error
            ("operator[]","./core/templates/local_vector.h",0xae,uVar5,uVar4,"p_index","count","",
             false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar2 = (code *)invalidInstructionException();
...
void __thiscall GodotStep3D::GodotStep3D(GodotStep3D *this)
...
/* GodotStep3D::step(GodotSpace3D*, float) */

void __thiscall GodotStep3D::step(GodotStep3D *this,GodotSpace3D *param_1,float param_2)
        ...
        do {
          ...
          if (*(long *)this != *(long *)(lVar16 + 0x18)) {
            ...
            *(long *)(lVar16 + 0x18) = *(long *)this;
            if (uVar24 < uVar17) {
              LocalVector<LocalVector<GodotConstraint3D*,unsigned_int,false,false>,unsigned_int,false,false>
              ::resize((LocalVector<LocalVector<GodotConstraint3D*,unsigned_int,false,false>,unsigned_int,false,false>
                        *)(this + 0x20),uVar17);
              uVar24 = *(uint *)(this + 0x20);
            }
...
LAB_00100f10:
  ...
  if (lVar14 != 0) {
    do {
      ...
      if (*(long *)this != *(long *)(pGVar2 + 0x368)) {
        ...
        uVar17 = uVar24 + 1;
        if (uVar1 < uVar17) {
          LocalVector<LocalVector<GodotBody3D*,unsigned_int,false,false>,unsigned_int,false,false>::
          resize((LocalVector<LocalVector<GodotBody3D*,unsigned_int,false,false>,unsigned_int,false,false>
                  *)(this + 0x10),uVar17);
          uVar1 = *(uint *)(this + 0x10);
        }
  ...
  for (lVar14 = *plVar9; uVar17 = (uint)uVar26, lVar14 != 0; lVar14 = *(long *)(lVar14 + 0x10)) {
    local_98 = (LocalVector<LocalVector<GodotBody3D*,unsigned_int,false,false>,unsigned_int,false,false>
                *)(this + 0x10);
...
LAB_00100f95:
  ...
  *(long *)(param_1 + 8) = lVar14 - lVar12;
  ...
  if ((step(GodotSpace3D*,float)::{lambda()#1}::operator()()::sname == '\0') &&
     (iVar7 = __cxa_guard_acquire(&step(GodotSpace3D*,float)::{lambda()#1}::operator()()::sname),
     iVar7 != 0)) {
    _scs_create((char *)&step(GodotSpace3D*,float)::{lambda()#1}::operator()()::sname,true);
    __cxa_atexit(StringName::~StringName,
                 &step(GodotSpace3D*,float)::{lambda()#1}::operator()()::sname,&__dso_handle);
    __cxa_guard_release(&step(GodotSpace3D*,float)::{lambda()#1}::operator()()::sname);
  }
  lVar11 = step(GodotSpace3D*,float)::{lambda()#1}::operator()()::sname;
  if (step(GodotSpace3D*,float)::{lambda()#1}::operator()()::sname != 0) {
    local_60 = 0;
    if (*(char **)(step(GodotSpace3D*,float)::{lambda()#1}::operator()()::sname + 8) != (char *)0x0)
    {
      String::parse_latin1
                ((String *)&local_60,
                 *(char **)(step(GodotSpace3D*,float)::{lambda()#1}::operator()()::sname + 8));
      goto LAB_0010128a;
    }
    plVar10 = (long *)(*(long *)(step(GodotSpace3D*,float)::{lambda()#1}::operator()()::sname + 0x10
                                ) + -0x10);
    if (*(long *)(step(GodotSpace3D*,float)::{lambda()#1}::operator()()::sname + 0x10) != 0) {
      do {
        lVar12 = *plVar10;
...
LAB_0010128a:
  ...
  *puVar15 = &PTR_callback_00101d28;
  puVar15[2] = _setup_constraint;
  puVar15[1] = this;
  puVar15[3] = 0;
  puVar15[4] = 0;
  local_58 = 0;
  ...
  WorkerThreadPool::_add_group_task
            (pCVar5,(_func_void_void_ptr_uint *)&local_58,(void *)0x0,(BaseTemplateUserdata *)0x0,
             (int)puVar15,iVar23,true,(String *)0x1);
  ...
  plVar10 = (long *)OS::get_singleton();
  lVar11 = (**(code **)(*plVar10 + 0x208))();
  *(long *)(param_1 + 0x10) = lVar11 - lVar14;
  if (uVar17 != 0) {
    do {
      uVar1 = *(uint *)(this + 0x20);
  ...
  pCVar5 = WorkerThreadPool::singleton;
  if ((step(GodotSpace3D*,float)::{lambda()#2}::operator()()::sname == '\0') &&
     (iVar23 = __cxa_guard_acquire(), iVar23 != 0)) {
    _scs_create((char *)&step(GodotSpace3D*,float)::{lambda()#2}::operator()()::sname,true);
    __cxa_atexit(StringName::~StringName,
                 &step(GodotSpace3D*,float)::{lambda()#2}::operator()()::sname,&__dso_handle);
    __cxa_guard_release();
  }
  lVar14 = step(GodotSpace3D*,float)::{lambda()#2}::operator()()::sname;
  if (step(GodotSpace3D*,float)::{lambda()#2}::operator()()::sname == 0) {
    local_60 = 0;
  }
  else {
    local_60 = 0;
    if (*(char **)(step(GodotSpace3D*,float)::{lambda()#2}::operator()()::sname + 8) == (char *)0x0)
    {
      plVar10 = (long *)(*(long *)(step(GodotSpace3D*,float)::{lambda()#2}::operator()()::sname +
                                  0x10) + -0x10);
      if (*(long *)(step(GodotSpace3D*,float)::{lambda()#2}::operator()()::sname + 0x10) != 0) {
        do {
          lVar12 = *plVar10;
      ...
      String::parse_latin1
                ((String *)&local_60,
                 *(char **)(step(GodotSpace3D*,float)::{lambda()#2}::operator()()::sname + 8));
    }
  }
LAB_00101424:
  puVar15 = (undefined8 *)operator_new(0x28,"");
  *puVar15 = &PTR_callback_00101d28;
  ...
  WorkerThreadPool::_add_group_task
            (pCVar5,(_func_void_void_ptr_uint *)&local_58,(void *)0x0,(BaseTemplateUserdata *)0x0,
             (int)puVar15,uVar17,true,(String *)0x1);
  Callable::~Callable((Callable *)&local_58);
  lVar14 = local_60;
  if (local_60 != 0) {
    LOCK();
  ...
  plVar10 = (long *)OS::get_singleton();
  lVar12 = (**(code **)(*plVar10 + 0x208))(plVar10);
  *(long *)(param_1 + 0x18) = lVar12 - lVar11;
  lVar14 = *plVar8;
  while (lVar14 != 0) {
    lVar14 = *(long *)(lVar14 + 0x10);
  ...
  lVar14 = (**(code **)(*plVar8 + 0x208))(plVar8);
  iVar23 = *(int *)(this + 0x30);
  *(long *)(param_1 + 0x20) = lVar14 - lVar12;
  if (iVar23 != 0) {
...
LAB_00100e6e:
  _err_print_index_error
            ("operator[]","./core/templates/local_vector.h",0xb2,uVar26,uVar21,"p_index","count","",
             false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar4 = (code *)invalidInstructionException();
...

{
  ...
  if (*(long *)(this + 0x18) != 0) {
    LocalVector<LocalVector<GodotBody3D*,unsigned_int,false,false>,unsigned_int,false,false>::resize
              ((LocalVector<LocalVector<GodotBody3D*,unsigned_int,false,false>,unsigned_int,false,false>
                *)(this + 0x10),0);
...
void __thiscall
WorkerThreadPool::
GroupUserData<GodotStep3D,void(GodotStep3D::*)(unsigned_int,void*),decltype(nullptr)>::
~GroupUserData(GroupUserData<GodotStep3D,void(GodotStep3D::*)(unsigned_int,void*),decltype(nullptr)>
               *this)
...
WorkerThreadPool::
GroupUserData<GodotStep3D,void(GodotStep3D::*)(unsigned_int,void*),decltype(nullptr)>::
callback_indexed(GroupUserData<GodotStep3D,void(GodotStep3D::*)(unsigned_int,void*),decltype(nullptr)>
                 *this,uint param_1)
...
/* GodotStep3D::_populate_island(GodotBody3D*, LocalVector<GodotBody3D*, unsigned int, false,
   false>&, LocalVector<GodotConstraint3D*, unsigned int, false, false>&) [clone .cold] */

void GodotStep3D::_populate_island(GodotBody3D *param_1,LocalVector *param_2,LocalVector *param_3)

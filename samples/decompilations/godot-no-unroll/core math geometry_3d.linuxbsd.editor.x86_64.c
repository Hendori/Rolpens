...
/* LocalVector<int, unsigned int, false, false>::resize(unsigned int) [clone .part.0] */

void LocalVector<int,unsigned_int,false,false>::resize(uint param_1)
...
/* Geometry3D::get_closest_points_between_segments(Vector3 const&, Vector3 const&, Vector3 const&,
   Vector3 const&, Vector3&, Vector3&) */

void Geometry3D::get_closest_points_between_segments
...
LAB_00100ee1:
      if (fVar4 - fVar10 < fVar3) goto LAB_00100e13;
LAB_00100eec:
      fVar11 = fVar11 * 0.0;
      uVar17 = CONCAT44(fVar2 * 0.0,fVar16 * 0.0);
      fVar6 = 0.0;
...
LAB_00100f2e:
  *(ulong *)param_5 =
       CONCAT44((float)((ulong)uVar13 >> 0x20) + (float)((ulong)uVar17 >> 0x20),
                (float)uVar13 + (float)uVar17);
  ...
  *(ulong *)param_6 =
       CONCAT44(fVar5 * (float)((ulong)uVar13 >> 0x20) + (float)((ulong)uVar17 >> 0x20) * fVar6,
                fVar5 * (float)uVar13 + (float)uVar17 * fVar6);
  return;
}
...
float Geometry3D::get_closest_distance_between_segments
...

{
  ...
  get_closest_points_between_segments
            (param_1,param_2,param_3,param_4,(Vector3 *)&local_28,(Vector3 *)&local_1c);
  if (local_10 == *(long *)(in_FS_OFFSET + 0x28)) {
    return SQRT((local_14 - local_20) * (local_14 - local_20) +
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Geometry3D::build_convex_mesh(Vector<Plane> const&) */

Geometry3D * __thiscall Geometry3D::build_convex_mesh(Geometry3D *this,Vector *param_1)
...
LAB_00101412:
    local_60 = local_f0._0_4_ * fVar3 + fVar44;
...
LAB_00101bb0:
      ...
      do {
        ...
        if (SQRT((*pfVar27 - *pfVar16) * (*pfVar27 - *pfVar16) + fVar43 +
                 (pfVar27[2] - pfVar16[2]) * (pfVar27[2] - pfVar16[2])) < fVar44) {
          uVar19 = uVar24;
          uVar11 = uVar12;
...
LAB_00101c18:
      ...
      *(uint *)((long)pvVar17 + uVar19 * 4) = uVar11;
      ...
      if (fVar43 == 0.0) {
        ...
        pvVar18 = (void *)Memory::realloc_static
...
LAB_0010196c:
            ...
            *(ulong *)piVar21 = CONCAT44(iVar7,iVar28);
            ...
            piVar20 = piVar21;
            while( true ) {
              if (((*piVar20 == iVar28) && (iVar7 == piVar20[1])) ||
                 ((*piVar20 == iVar7 && (iVar28 == piVar20[1])))) break;
            ...
            if (uVar11 <= (uint)uVar25) {
              _err_print_index_error
                        ("operator[]","./core/templates/local_vector.h",0xb2,uVar25,uVar19,"p_index"
                         ,"count","",false,true);
              _err_flush_stdout();
                    /* WARNING: Does not return */
              pcVar9 = (code *)invalidInstructionException();
...
LAB_00102014:
        if (pfVar13 != (float *)0x0) goto LAB_00101864;
        goto LAB_0010186e;
      }
LAB_00102177:
      local_f0 = pvVar22;
...
LAB_001015a8:
      ...
      fVar41 = pfVar15[2];
      fVar36 = pfVar15[3];
      if (__LC27 < local_f0._0_4_ * fVar43 + local_f8._0_4_ * fVar42 + fVar2 * fVar41)
      goto LAB_001015a8;
      uVar11 = (uint)uVar24;
...
LAB_0010173c:
        auVar38._0_4_ = (float)uVar4 - fVar39;
...
LAB_00101850:
    if (2 < (uint)uVar29) goto LAB_00101b6f;
joined_r0x00101dba:
    if (pfVar13 != (float *)0x0) {
LAB_00101864:
      Memory::free_static(pfVar13,false);
LAB_0010186e:
      lVar14 = *(long *)(param_1 + 8);
    }
...
/* Geometry3D::MeshData::optimize_vertices() */

void __thiscall Geometry3D::MeshData::optimize_vertices(MeshData *this)
    ...
    do {
      ...
      if (puVar41 != puVar40) {
        ...
        do {
          ...
          while ((uVar47 != uVar37 ||
                 (puVar39 = puVar40,
                 uVar51 != *(uint *)(*(long *)(local_70._0_8_ + lVar45 * 8) + 0x10)))) {
            uVar53 = uVar53 + 1;
            auVar3._8_8_ = 0;
            ...
            auVar5._8_8_ = 0;
            auVar5._0_8_ = ((*(uint *)(hash_table_size_primes + (local_50 & 0xffffffff) * 4) +
                            iVar43) - SUB164(auVar4 * auVar20,8)) * uVar49;
            auVar21._8_8_ = 0;
          ...
          while( true ) {
            puVar40 = puVar39 + 1;
            puVar38 = (uint *)HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>>
                              ::operator[](local_78,(int *)puVar39);
            *puVar39 = *puVar38;
            if (puVar41 == puVar40) {
...
LAB_00102370:
            puVar39 = (uint *)HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>>
                              ::operator[](local_78,(int *)puVar40);
            *puVar39 = local_90;
            puVar39 = puVar40;
          }
        } while( true );
...
LAB_0010261f:
    if (local_90 == 0) goto LAB_00102998;
    uVar51 = local_90 - 1;
    ...
    __s = (void *)Memory::realloc_static
                            ((void *)0x0,(ulong)((uVar37 | uVar37 >> 0x10) + 1) * 0xc,false);
    ...
    do {
      ...
      if ((local_70._0_8_ != 0) && (local_90 != 0)) {
        ...
        if (uVar37 != 0) {
          ...
          do {
            if ((uVar47 == uVar37) &&
               (local_80 == *(uint *)(*(long *)(local_70._0_8_ + lVar46 * 8) + 0x10)))
            goto LAB_0010250c;
            uVar53 = uVar53 + 1;
            auVar7._8_8_ = 0;
            ...
            iVar43 = SUB164(auVar7 * auVar23,8);
                  ...
                  (auVar8._8_8_ = 0, auVar8._0_8_ = uVar37 * uVar49, auVar24._8_8_ = 0,
                  auVar24._0_8_ = uVar42, auVar9._8_8_ = 0,
                  auVar9._0_8_ = ((*(uint *)(hash_table_size_primes + (local_50 & 0xffffffff) * 4) +
                                  iVar43) - SUB164(auVar8 * auVar24,8)) * uVar49, auVar25._8_8_ = 0,
                  auVar25._0_8_ = uVar42, uVar53 <= SUB164(auVar9 * auVar25,8)));
        }
      }
      puVar40 = (uint *)HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>>
                        ::operator[](local_78,(int *)&local_80);
      *puVar40 = local_90;
      local_90 = local_50._4_4_;
      if ((local_70._0_8_ != 0) && (local_50._4_4_ != 0)) {
LAB_0010250c:
        uVar49 = *(ulong *)(hash_table_size_primes_inv + (ulong)(uint)local_50 * 8);
        uVar37 = (uVar51 >> 0x10 ^ uVar51) * -0x7a143595;
        uVar37 = (uVar37 ^ uVar37 >> 0xd) * -0x3d4d51cb;
        uVar47 = uVar37 ^ uVar37 >> 0x10;
        if (uVar37 == uVar37 >> 0x10) {
        ...
        if (uVar37 != 0) {
          ...
          do {
            if ((uVar47 == uVar37) &&
               (uVar51 == *(uint *)(*(long *)(local_70._0_8_ + lVar46 * 8) + 0x10)))
            goto LAB_001025d8;
            uVar53 = uVar53 + 1;
            auVar11._8_8_ = 0;
            ...
            iVar43 = SUB164(auVar11 * auVar27,8);
                  ...
                  (auVar12._8_8_ = 0, auVar12._0_8_ = uVar37 * uVar49, auVar28._8_8_ = 0,
                  auVar28._0_8_ = uVar44, auVar13._8_8_ = 0,
                  auVar13._0_8_ =
                       ((*(uint *)(hash_table_size_primes + (ulong)(uint)local_50 * 4) + iVar43) -
                       SUB164(auVar12 * auVar28,8)) * uVar49, auVar29._8_8_ = 0,
                  auVar29._0_8_ = uVar44, uVar53 <= SUB164(auVar13 * auVar29,8)));
        }
      }
      puVar40 = (uint *)HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>>
                        ::operator[](local_78,(int *)&local_7c);
      *puVar40 = local_90;
LAB_001025d8:
      puVar39 = puVar41 + 4;
      puVar40 = (uint *)HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>>
...
LAB_00102998:
  if (*(int *)(this + 0x20) == 0) goto LAB_0010285c;
  local_90 = 0;
  __s = (void *)0x0;
LAB_0010269a:
  lVar46 = 0;
  ...
  do {
    if ((local_70._0_8_ != 0) && (local_50._4_4_ != 0)) {
      ...
      if (uVar37 != 0) {
        uVar53 = 0;
        while ((uVar37 != uVar47 ||
               (uVar51 != *(uint *)(*(long *)(local_70._0_8_ + lVar48 * 8) + 0x10)))) {
          uVar53 = uVar53 + 1;
          auVar15._8_8_ = 0;
          ...
          if ((uVar37 == 0) ||
             (auVar16._8_8_ = 0, auVar16._0_8_ = uVar37 * uVar49, auVar32._8_8_ = 0,
             auVar32._0_8_ = uVar44, auVar17._8_8_ = 0,
             auVar17._0_8_ =
                  ((*(uint *)(hash_table_size_primes + (local_50 & 0xffffffff) * 4) + iVar43) -
                  SUB164(auVar16 * auVar32,8)) * uVar49, auVar33._8_8_ = 0, auVar33._0_8_ = uVar44,
             SUB164(auVar17 * auVar33,8) < uVar53)) goto LAB_001027e5;
        }
        lVar48 = *(long *)(this + 0x28);
        local_7c = uVar51;
        puVar41 = (uint *)HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>>
                          ::operator[](local_78,(int *)&local_7c);
        uVar37 = *puVar41;
        if (local_90 <= uVar37) {
          _err_print_index_error
                    ("operator[]","./core/templates/local_vector.h",0xb2,(ulong)uVar37,
                     (ulong)local_90,"p_index","count","",false,true);
          _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_00102a3b:
      memset((void *)(*(long *)(this + 0x28) + uVar42 * 0xc),0,
             ((ulong)((local_90 - (int)uVar42) - 1) * 3 + 3) * 4);
    }
    *(uint *)(this + 0x20) = local_90;
LAB_00102821:
...
/* Geometry3D::compute_convex_mesh_points(Plane const*, int) */

Geometry3D * __thiscall
...

{
  ...
  *(undefined8 *)(this + 8) = 0;
  iVar12 = param_2 + -1;
  if ((-1 < iVar12) && (iVar13 = param_2 + -2, param_2 != 1)) {
...
LAB_00102c60:
        do {
          ...
          if (cVar3 != '\0') {
            ...
            pPVar9 = param_1;
            do {
              if (((iVar12 != iVar4 && iVar6 != iVar4) && (iVar10 != iVar4)) &&
                 (_LC31 < (*(float *)pPVar9 * 0.0 + *(float *)(pPVar9 + 4) * 0.0 +
                          *(float *)(pPVar9 + 8) * 0.0) - *(float *)(pPVar9 + 0xc)))
              goto LAB_00102c50;
              iVar4 = iVar4 + 1;
              pPVar9 = pPVar9 + 0x10;
            } while (param_2 != iVar4);
            ...
            if (iVar4 == 0) {
              ...
              _err_print_index_error
                        ("set","./core/templates/cowdata.h",0xcf,lVar7,lVar11,"p_index","size()","",
                         false,false);
            }
            else {
...
/* Geometry3D::build_box_planes(Vector3 const&) */

Geometry3D * __thiscall Geometry3D::build_box_planes(Geometry3D *this,Vector3 *param_1)
...
/* Vector<Plane>::push_back(Plane) [clone .isra.0] */

void Vector<Plane>::push_back(undefined8 param_1,undefined8 param_2,long param_3)

{
  ...
  if (iVar1 == 0) {
    ...
    _err_print_index_error
              ("set","./core/templates/cowdata.h",0xcf,lVar2,lVar4,"p_index","size()","",false,false
              );
    return;
  }
  _err_print_error("push_back","./core/templates/vector.h",0x142,
...
/* Geometry3D::build_capsule_planes(float, float, int, int, Vector3::Axis) */
...

{
  ...
  if (param_6 < 3) {
        ...
        *(float *)((long)&local_64 + lVar7 * 4) = (float)local_a0;
        ...
        if (0 < param_4) {
          ...
          do {
            ...
            fStack_4c = fVar21 * fVar1 * fVar15 + fVar23 * fVar2 * fVar19 +
                        fVar22 * fVar3 * fStack_50;
            local_58 = CONCAT44(fVar19,fVar15);
    ...
    *(undefined8 *)(this + 8) = local_90;
    ...
    _err_print_index_error
              ("build_capsule_planes","core/math/geometry_3d.cpp",0x31b,(ulong)param_6,3,"p_axis",
               "3","",false,false);
    *(undefined8 *)(this + 8) = 0;
  }
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
/* Geometry3D::build_sphere_planes(float, int, int, Vector3::Axis) */
...

{
  ...
  if (param_5 < 3) {
    ...
    *(undefined8 *)(this + 8) = local_90;
    ...
    _err_print_index_error
              ("build_sphere_planes","core/math/geometry_3d.cpp",0x2fc,(ulong)param_5,3,"p_axis","3"
               ,"",false,false);
    *(undefined8 *)(this + 8) = 0;
  }
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
/* Geometry3D::build_cylinder_planes(float, float, int, Vector3::Axis) */
...

{
  ...
  if (param_5 < 3) {
    ...
    *(undefined8 *)(this + 8) = local_70;
    ...
    _err_print_index_error
              ("build_cylinder_planes","core/math/geometry_3d.cpp",0x2e5,(ulong)param_5,3,"p_axis",
               "3","",false,false);
    *(undefined8 *)(this + 8) = 0;
  }
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Geometry3D::wrap_geometry(Vector<Face3> const&, float*) */

Geometry3D * __thiscall Geometry3D::wrap_geometry(Geometry3D *this,Vector *param_1,float *param_2)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  fVar37 = __LC60;
  fVar39 = _UNK_00107214;
  if (pfVar13 == (float *)0x0) {
    uVar22 = CONCAT44(_LC59._4_4_,(float)_LC59);
    auVar34._8_8_ = 0;
    auVar34._0_8_ = uVar22;
    local_158 = 0;
    fStack_c0 = _UNK_00107218;
    fStack_bc = _UNK_0010721c;
  }
  else {
    local_c8 = 0;
    fStack_c0 = 0.0;
    local_158 = (int)*(undefined8 *)(pfVar13 + -2);
    fStack_bc = 0.0;
    fStack_b8 = 0.0;
    fStack_b4 = 0.0;
    if (local_158 < 1) {
      ...
      fVar41 = pfVar13[5];
      fVar35 = fVar41;
      if (fVar41 <= fVar40 + 0.0) {
        fVar35 = fVar40 + 0.0;
      }
      if (fVar40 <= fVar41) {
        fVar41 = fVar40;
      }
      if (((fVar37 - fVar3 < 0.0) || (fVar39 - fVar4 < 0.0)) || (fVar35 - fVar41 < 0.0)) {
      ...
      local_c8._4_4_ = pfVar13[7];
      fVar40 = (fVar37 - fVar3) + fVar3;
      fVar37 = (fVar35 - fVar41) + fVar41;
      local_c8._0_4_ = pfVar13[6];
      fVar39 = (fVar39 - fVar4) + fVar4;
      iVar28 = 1;
      fStack_bc = (float)local_c8;
      if ((float)local_c8 <= fVar40) {
        fStack_bc = fVar40;
      }
      ...
      if (local_158 != 1) {
        do {
          uVar6 = *(undefined8 *)(pfVar16 + 9);
          fStack_70 = pfVar16[0xb];
          ...
          fVar41 = pfVar16[0xe];
          fVar40 = fVar37;
          if ((float)local_78 <= fVar37) {
            fVar40 = (float)local_78;
          }
          fVar3 = fVar39;
          if (local_78._4_4_ <= fVar39) {
          ...
          if (fVar37 <= (float)local_78 + 0.0) {
            fVar37 = (float)local_78 + 0.0;
          }
          if (fVar39 <= local_78._4_4_ + 0.0) {
            fVar39 = local_78._4_4_ + 0.0;
          }
          if (fVar41 <= fStack_70 + 0.0) {
            fVar41 = fStack_70 + 0.0;
          }
          if (((fVar37 - fVar40 < 0.0) || (fVar39 - fVar3 < 0.0)) || (fVar41 - fVar4 < 0.0)) {
            local_78 = uVar6;
            _err_print_error("expand_to","./core/math/aabb.h",0x158,
                             "AABB size is negative, this is not supported. Use AABB.abs() to get an AABB with a positive size."
                             ,0,0);
          }
          fVar38 = (fVar37 - fVar40) + fVar40;
          fVar35 = (fVar41 - fVar4) + fVar4;
          iVar28 = iVar28 + 1;
          fVar37 = pfVar16[0xf];
          fVar41 = pfVar16[0x10];
          fVar39 = (fVar39 - fVar3) + fVar3;
          fStack_70 = pfVar16[0x11];
          fStack_6c = fVar37;
          if (fVar37 <= fVar38) {
            fStack_6c = fVar38;
          }
          ...
          fStack_68 = fStack_68 - fVar41;
          local_78 = CONCAT44(fVar41,fVar37);
          fStack_64 = fStack_64 - fStack_70;
          AABB::merge_with((AABB *)&local_c8);
          pfVar16 = pfVar16 + 9;
        } while (local_158 != iVar28);
      }
      uVar22 = CONCAT44(fStack_b4 + _LC59._4_4_,fStack_b8 + (float)_LC59);
      auVar34._0_4_ = fStack_bc + (float)_LC59;
      auVar34._4_4_ = fStack_b8 + _LC59._4_4_;
      auVar34._8_8_ = 0;
      fVar37 = __LC65 + (float)local_c8;
      fVar39 = _UNK_00107224 + local_c8._4_4_;
      fStack_c0 = _UNK_00107228 + fStack_c0;
      fStack_bc = fStack_bc + _UNK_0010723c;
    }
  }
  local_c8 = CONCAT44(fVar39,fVar37);
  fStack_b4 = (float)(uVar22 >> 0x20);
  fStack_b8 = (float)uVar22;
  if (_LC61 <= fStack_bc) {
    local_150 = 0x14;
    ppuVar20 = (uchar **)0x14;
    fVar37 = _LC61;
    ...
    ppuVar20 = (uchar **)(long)local_150;
    fVar37 = (float)local_150;
  }
  if (_LC61 <= fStack_b8) {
    iVar28 = 0x14;
    fVar39 = _LC61;
  ...
  auVar36._8_8_ = __LC23;
  auVar34 = divps(auVar34,auVar36);
  local_d8 = auVar34._0_8_;
  if (ppuVar20 == (uchar **)0x0) {
    local_108 = (uchar ***)0x0;
LAB_00104fb7:
    if (0 < local_158) goto LAB_001043c8;
    if (local_14c < 1) {
      *(undefined8 *)(this + 8) = 0;
...
LAB_00104e24:
        ...
        do {
          ...
          if (0 < iVar28) {
            do {
              puVar2 = (undefined8 *)((long)*pppuVar25 + lVar23);
              lVar23 = lVar23 + 8;
              Memory::free_static((void *)*puVar2,true);
            } while (lVar23 != (long)iVar28 * 8);
          }
          ppuVar20 = *pppuVar25;
          pppuVar25 = pppuVar25 + 1;
          Memory::free_static(ppuVar20,true);
        } while (pppuVar25 != local_108 + local_150);
      }
      goto LAB_00104e6e;
    }
  }
  else {
    local_108 = (uchar ***)Memory::alloc_static((long)ppuVar20 * 8,true);
    if (local_108 == (uchar ***)0x0) {
      _err_print_error("memnew_arr_template","./core/os/memory.h",0xb6,"Parameter \"mem\" is null.",
                       0,0);
    }
    else {
      local_108[-1] = ppuVar20;
    }
    if (local_150 < 1) goto LAB_00104fb7;
    puVar33 = (uchar *)(long)iVar28;
    uVar30 = (ulong)local_14c;
    pppuVar25 = local_108 + local_150;
    uVar22 = (long)puVar33 * 8;
    pppuVar21 = local_108;
    if (puVar33 == (uchar *)0x0) {
      do {
        *pppuVar21 = (uchar **)0x0;
        pppuVar21 = pppuVar21 + 1;
      } while (pppuVar21 != pppuVar25);
    }
    else {
      do {
        while( true ) {
          ppuVar20 = (uchar **)Memory::alloc_static(uVar22,true);
          if (ppuVar20 == (uchar **)0x0) {
...
LAB_00104efa:
          pppuVar21 = pppuVar21 + 1;
          if (pppuVar21 == pppuVar25) goto LAB_001043bc;
        }
        uVar19 = 0;
        while( true ) {
          if (local_14c == 0) {
            *ppuVar20 = (uchar *)0x0;
            ...
            while( true ) {
              puVar9 = (uchar *)Memory::alloc_static(uVar30,true);
              if (puVar9 == (uchar *)0x0) {
                _err_print_error("memnew_arr_template","./core/os/memory.h",0xb6,
                                 "Parameter \"mem\" is null.",0,0);
                *ppuVar20 = (uchar *)0x0;
                ...
                *(ulong *)(puVar9 + -8) = uVar30;
                *ppuVar20 = puVar9;
              }
              if (local_14c < 1) break;
              uVar10 = 0;
              do {
                *(undefined1 *)(*(long *)((long)*pppuVar21 + uVar19) + uVar10) = 0;
                uVar10 = uVar10 + 1;
              } while (uVar10 != uVar30);
              uVar19 = uVar19 + 8;
              if (uVar19 == uVar22) goto LAB_00104efa;
              ppuVar20 = (uchar **)((long)*pppuVar21 + uVar19);
            }
          }
          uVar19 = uVar19 + 8;
...
LAB_001043bc:
    if (local_158 < 1) goto LAB_00104488;
LAB_001043c8:
    iVar29 = 0;
    do {
      local_78 = *(undefined8 *)pfVar13;
      fStack_70 = (float)*(undefined8 *)(pfVar13 + 2);
      fStack_6c = (float)((ulong)*(undefined8 *)(pfVar13 + 2) >> 0x20);
      fStack_68 = (float)*(undefined8 *)(pfVar13 + 4);
      fStack_64 = (float)((ulong)*(undefined8 *)(pfVar13 + 4) >> 0x20);
      uStack_60 = *(undefined8 *)(pfVar13 + 6);
      local_58 = pfVar13[8];
      pFVar11 = (Face3 *)&local_78;
      do {
        pFVar12 = pFVar11 + 0xc;
        *(ulong *)pFVar11 =
             CONCAT44((float)((ulong)*(undefined8 *)pFVar11 >> 0x20) -
                      (float)((ulong)local_c8 >> 0x20),
                      (float)*(undefined8 *)pFVar11 - (float)local_c8);
        *(float *)(pFVar11 + 8) = *(float *)(pFVar11 + 8) - fStack_c0;
        pFVar11 = pFVar12;
      } while ((Face3 *)&local_54 != pFVar12);
      iVar29 = iVar29 + 1;
      pfVar13 = pfVar13 + 9;
      _plot_face(local_108,0,0,0,local_150,iVar28,local_14c,(Vector3 *)&local_d8,(Face3 *)&local_78)
      ;
    } while (iVar29 < local_158);
    if (0 < local_150) {
LAB_00104488:
      iVar29 = 0;
      pppuVar25 = local_108;
LAB_0010448f:
      if (iVar28 < 1) goto LAB_00104872;
      do {
        uVar22 = 0;
        do {
          pbVar27 = (*pppuVar25)[uVar22];
          uVar30 = uVar22;
          if ((*pbVar27 & 3) == 0) {
            *pbVar27 = 0xe0;
            _mark_outside(local_108,iVar29,(int)uVar22,0,local_150,iVar28,local_14c);
            uVar30 = uVar22 & 0xffffffff;
            pbVar27 = (*pppuVar25)[uVar22];
          }
          if ((pbVar27[local_14c + -1] & 3) == 0) {
            pbVar27[local_14c + -1] = 0xe0;
            _mark_outside(local_108,iVar29,(int)uVar30,local_14c + -1,local_150,iVar28,local_14c);
          }
          uVar22 = uVar22 + 1;
        } while ((long)iVar28 != uVar22);
        iVar29 = iVar29 + 1;
        pppuVar25 = pppuVar25 + 1;
      } while (local_150 != iVar29);
LAB_00104562:
      if (0 < local_14c) goto LAB_0010456e;
      goto LAB_0010478d;
    }
    if (local_14c < 1) {
LAB_00105036:
      *(undefined8 *)(this + 8) = 0;
      CowData<Face3>::_copy_on_write((CowData<Face3> *)(this + 8));
LAB_00104e6e:
      Memory::free_static(local_108,true);
      if (param_2 != (float *)0x0) {
        *param_2 = SQRT((float)local_d8 * (float)local_d8 + local_d8._4_4_ * local_d8._4_4_ +
                        local_d0 * local_d0);
      }
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
        return this;
...
LAB_0010456e:
  lVar23 = 0;
LAB_00104584:
  if (iVar28 < 1) goto LAB_0010476c;
  do {
    uVar22 = 0;
    do {
      uVar30 = uVar22;
      if (((*local_108)[uVar22][lVar23] & 3) == 0) {
        (*local_108)[uVar22][lVar23] = 0xe0;
        _mark_outside(local_108,0,(int)uVar22,(int)lVar23,local_150,iVar28,local_14c);
        uVar30 = uVar22 & 0xffffffff;
      }
      if ((local_108[local_150 + -1][uVar22][lVar23] & 3) == 0) {
        local_108[local_150 + -1][uVar22][lVar23] = 0xe0;
        _mark_outside(local_108,local_150 + -1,(int)uVar30,(int)lVar23,local_150,iVar28,local_14c);
      }
      uVar22 = uVar22 + 1;
    } while ((long)iVar28 != uVar22);
    lVar23 = lVar23 + 1;
  } while ((int)lVar23 < local_14c);
LAB_0010477f:
  if (local_150 < 1) goto LAB_00105036;
LAB_0010478d:
  lVar23 = 0;
  do {
    if (0 < local_14c) goto LAB_001047c9;
    lVar23 = lVar23 + 1;
  } while (local_150 != lVar23);
LAB_00104891:
  lVar24 = 0;
  *(undefined8 *)(this + 8) = 0;
  do {
    if (0 < iVar28) {
      local_118 = (int)lVar24 + 1;
      goto LAB_001048e2;
    }
    lVar24 = lVar24 + 1;
  } while (lVar24 != lVar23);
LAB_00104d71:
  if (*(long *)(this + 8) == 0) {
    ...
    if (0 < iVar29) {
      pfVar16 = pfVar13 + 9;
      pfVar1 = pfVar16 + (ulong)(iVar29 - 1) * 9;
      pfVar18 = pfVar13;
      do {
        do {
          fVar37 = pfVar13[2];
          pfVar14 = pfVar13 + 3;
          pfVar13[2] = fVar37 * local_d0;
          *(ulong *)pfVar13 =
               CONCAT44((float)((ulong)*(undefined8 *)pfVar13 >> 0x20) *
                        (float)((ulong)local_d8 >> 0x20),
                        (float)*(undefined8 *)pfVar13 * (float)local_d8);
          *pfVar13 = *pfVar13 + (float)local_c8;
          pfVar13[1] = pfVar13[1] + local_c8._4_4_;
          pfVar13[2] = fVar37 * local_d0 + fStack_c0;
          pfVar13 = pfVar14;
...
LAB_00104872:
  iVar29 = iVar29 + 1;
  pppuVar25 = pppuVar25 + 1;
  if (local_150 == iVar29) goto LAB_00104562;
  goto LAB_0010448f;
LAB_0010476c:
  lVar23 = lVar23 + 1;
  if (local_14c <= (int)lVar23) goto LAB_0010477f;
  goto LAB_00104584;
LAB_001047c9:
  do {
    lVar24 = 0;
    do {
      ppuVar20 = local_108[lVar23];
      if (((*ppuVar20)[lVar24] & 3) == 0) {
        (*ppuVar20)[lVar24] = 0xe0;
        _mark_outside(local_108,(int)lVar23,0,(int)lVar24,local_150,iVar28,local_14c);
        ppuVar20 = local_108[lVar23];
      }
      if ((ppuVar20[iVar28 + -1][lVar24] & 3) == 0) {
        ppuVar20[iVar28 + -1][lVar24] = 0xe0;
        _mark_outside(local_108,(int)lVar23,iVar28 + -1,(int)lVar24,local_150,iVar28,local_14c);
      }
      lVar24 = lVar24 + 1;
    } while (local_14c != lVar24);
    lVar23 = lVar23 + 1;
  } while (local_150 != lVar23);
  goto LAB_00104891;
LAB_001048e2:
  ...
  if (0 < local_14c) {
    ...
    do {
      lVar31 = 0;
      do {
        if ((local_108[lVar24][uVar22][lVar31] & 2) == 0) {
          iVar7 = (int)lVar31;
          uVar30 = 0;
          do {
            iVar32 = (int)uVar30;
            ...
            iVar8 = iVar17;
            iVar15 = iVar7;
            if ((uint)(iVar32 * -0x55555555) < 0x55555556) {
              if (uVar30 < 3) {
                iVar26 = local_118;
                iVar8 = (uint)(iVar32 == 1) + iVar17;
LAB_00104a1f:
                if ((0x55555554 < (iVar32 + -2) * -0x55555555 + 0x2aaaaaaaU) ||
                   (iVar15 = iVar7 + 1, uVar30 < 3)) goto LAB_00104a47;
              }
              else {
                iVar26 = iVar29 + -1;
                if ((iVar32 + -1) * -0x55555555 + 0x2aaaaaaaU < 0x55555555) {
LAB_00104d0a:
                  iVar8 = (int)local_128 + -1;
                  iVar15 = iVar7 - (uint)((uint)((iVar32 + -2) * -0x55555555) < 0x55555556);
                  goto LAB_00104a47;
                }
                if (0x55555555 < (uint)((iVar32 + -2) * -0x55555555)) goto LAB_00104a47;
              }
              iVar15 = iVar7 + -1;
            }
            else {
              iVar26 = iVar29;
              if (0x55555554 < (iVar32 + -1) * -0x55555555 + 0x2aaaaaaaU) goto LAB_00104a1f;
              if (2 < uVar30) goto LAB_00104d0a;
              iVar8 = local_10c;
              iVar15 = (uint)(iVar32 != 1) + iVar7;
            }
LAB_00104a47:
            if ((((iVar28 <= iVar8) ||
                 ((char)((byte)((uint)iVar26 >> 0x18) | (byte)((uint)iVar8 >> 0x18) |
                        (byte)((uint)iVar15 >> 0x18)) < '\0' || local_150 <= iVar26)) ||
                (local_14c <= iVar15)) || ((local_108[iVar26][iVar8][iVar15] & 2) != 0)) {
              pbVar27 = &_build_faces(unsigned_char***,int,int,int,int,int,int,Vector<Face3>&)::
                         indices + uVar30 * 4;
              ...
              do {
                ...
                pfVar16 = pfVar13 + 3;
                pbVar27 = pbVar27 + 1;
                *pfVar13 = (float)(bVar5 >> 2 & 1) + (float)iVar29;
                pfVar13[1] = (float)(bVar5 >> 1 & 1) + (float)iVar17;
                pfVar13[2] = (float)(bVar5 & 1) + (float)iVar7;
                pfVar13 = pfVar16;
              } while (pfVar16 != local_48);
              local_a8 = local_78;
              fStack_a0 = fStack_70;
              fStack_9c = fStack_6c;
              fStack_98 = fStack_68;
        ...
        lVar31 = lVar31 + 1;
      } while (local_14c != lVar31);
      uVar30 = uVar22 + 1;
      if (uVar30 == (long)iVar28) break;
      local_10c = (int)uVar22 + 2;
      iVar17 = (int)uVar30;
      local_128 = uVar30 & 0xffffffff;
      uVar22 = uVar30;
    } while( true );
  }
  lVar24 = lVar24 + 1;
  if (lVar24 == lVar23) goto LAB_00104d71;
  local_118 = iVar29 + 2;
  goto LAB_001048e2;
}
...
/* Geometry3D::generate_edf(Vector<bool> const&, Vector3i const&, bool) */
...

{
  ...
  uVar6 = iVar2 * iVar13;
  if (*(long *)(param_1 + 8) == 0) {
    if (uVar6 != 0) goto LAB_00105462;
LAB_0010543e:
    local_40 = 0;
    puVar7 = (undefined4 *)0x0;
    if ((int)uVar12 < 1) {
      if (0 < iVar14) goto LAB_00105283;
    }
    else {
LAB_001051d3:
      if (0 < iVar14) {
...
LAB_00105283:
      ...
      if (uVar6 != 0) {
        uVar17 = local_40 << 2;
        if (local_40 != 0) goto LAB_001052ff;
        __src = (ulong *)0x0;
...
LAB_00105462:
      _err_print_error("generate_edf","core/math/geometry_3d.cpp",0x38a,
                       "Condition \"(uint32_t)p_voxels.size() != float_count\" is true. Returning: Vector<uint32_t>()"
                       ,0,0);
      *(undefined8 *)(this + 8) = 0;
      return this;
    }
    local_40 = (ulong)uVar6;
    if (local_40 == 0) goto LAB_0010543e;
    uVar17 = local_40 * 4;
...
LAB_001053b5:
  Memory::free_static(puVar7,true);
  *(ulong **)(this + 8) = __src;
  return this;
}
...
/* Geometry3D::generate_sdf8(Vector<unsigned int> const&, Vector<unsigned int> const&) */

Geometry3D * __thiscall Geometry3D::generate_sdf8(Geometry3D *this,Vector *param_1,Vector *param_2)
...
joined_r0x001056da:
      if (lVar6 != 0) {
LAB_001056e0:
        _err_print_error("generate_sdf8","core/math/geometry_3d.cpp",0x3ca,
                         "Condition \"p_positive.size() != p_negative.size()\" is true. Returning: Vector<int8_t>()"
                         ,0,0);
        *(undefined8 *)(this + 8) = 0;
        return this;
      }
      ...
      if (lVar6 != *(long *)(lVar8 + -8)) goto LAB_001056e0;
  ...
  if (local_70 == (void *)0x0) {
    ...
    *(void **)(this + 8) = local_70;
    if (uVar39 == 0) {
      ...
      uVar38 = *param_1;
      if (local_70 == (void *)0x0) goto LAB_00105ee3;
    }
    else {
...
LAB_001067ac:
    ...
    lVar3 = puVar9[-1];
    if (param_1 <= lVar3) goto LAB_0010673b;
  }
  else {
    if (lVar8 != 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Error CowData<Plane>::resize<false>(long) */

undefined8 __thiscall CowData<Plane>::resize<false>(CowData<Plane> *this,long param_1)
...
LAB_00106aec:
    ...
    lVar3 = puVar8[-1];
    if (param_1 <= lVar3) goto LAB_00106a7e;
  }
  else {
    if (lVar9 != 0) {
...
/* CowData<Face3>::_realloc(long) */

undefined8 __thiscall CowData<Face3>::_realloc(CowData<Face3> *this,long param_1)
...
LAB_00106e4c:
    ...
    lVar3 = puVar8[-1];
    if (param_1 <= lVar3) goto LAB_00106dd5;
  }
  else {
    if (lVar11 != 0) {
...
/* CowData<signed char>::_realloc(long) */

undefined8 __thiscall CowData<signed_char>::_realloc(CowData<signed_char> *this,long param_1)

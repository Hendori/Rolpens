...
/* VariantParser::StreamFile::is_utf8() const */

undefined8 VariantParser::StreamFile::is_utf8(void)
...
/* VariantParser::StreamFile::_is_eof() const */

void __thiscall VariantParser::StreamFile::_is_eof(StreamFile *this)
...
/* VariantParser::StreamString::is_utf8() const */

undefined8 VariantParser::StreamString::is_utf8(void)
...
/* VariantParser::StreamString::_is_eof() const */

undefined8 __thiscall VariantParser::StreamString::_is_eof(StreamString *this)
...
/* VariantParser::StreamFile::_read_buffer(char32_t*, unsigned int) */

ulong __thiscall
VariantParser::StreamFile::_read_buffer(StreamFile *this,wchar32 *param_1,uint param_2)

{
  ...
  if (param_2 == 0) {
    _err_print_error("_read_buffer","core/variant/variant_parser.cpp",0x4a,
                     "Condition \"!p_num_chars\" is true. Returning: 0",0,0);
    uVar4 = 0;
  }
  else {
    puVar8 = auStack_28;
    ...
    *(undefined8 *)(puVar6 + lVar3 + -8) = 0x10010a;
    ...
    if (uVar4 == 0xffffffffffffffff) {
      *(undefined8 *)(puVar6 + lVar3 + -8) = 0x1001ae;
      _err_print_error("_read_buffer","core/variant/variant_parser.cpp",0x4e,
                       "Condition \"num_read == (18446744073709551615UL)\" is true. Returning: 0",0,
                       0);
      uVar4 = 0;
    }
    else {
      ...
      if (uVar4 != 0) {
        do {
          param_1[uVar5] =
               (uint)*(byte *)(((ulong)(puVar6 + lVar3 + 0xf) & 0xfffffffffffffff0) + uVar5);
...
/* VariantParser::StreamString::_read_buffer(char32_t*, unsigned int) */

uint __thiscall
VariantParser::StreamString::_read_buffer(StreamString *this,wchar32 *param_1,uint param_2)

{
  ...
  if (param_2 == 0) {
    _err_print_error("_read_buffer","core/variant/variant_parser.cpp",99,
                     "Condition \"!p_num_chars\" is true. Returning: 0",0,0);
    uVar5 = 0;
  }
  else if (param_1 == (wchar32 *)0x0) {
    _err_print_error("_read_buffer","core/variant/variant_parser.cpp",100,
                     "Parameter \"p_buffer\" is null.",0,0);
    uVar5 = 0;
  }
  else {
...
/* stor_fix(String const&) */

undefined8 stor_fix(String *param_1)
...
/* VariantParser::Stream::is_eof() const [clone .part.0] */

void __thiscall VariantParser::Stream::is_eof(Stream *this)
...
LAB_00101030:
      ...
      if (uVar6 + 1 == lVar5) {
        ...
        lVar5 = puVar8[-1];
LAB_00100f41:
        if (param_1 <= lVar5) goto LAB_00100ea7;
      }
      else {
        if (lVar10 != 0) {
          puVar3 = (undefined8 *)
...
LAB_00101340:
      ...
      if (uVar4 + 1 == lVar3) {
        ...
        lVar3 = puVar8[-1];
LAB_00101251:
        if (param_1 <= lVar3) goto LAB_001011bd;
      }
      else {
        if (lVar10 != 0) {
          puVar5 = (undefined8 *)
...
LAB_00101638:
      ...
      if (uVar4 + 1 == lVar3) {
        ...
        lVar3 = puVar7[-1];
LAB_00101561:
        if (param_1 <= lVar3) goto LAB_001014dc;
      }
      else {
        if (lVar11 != 0) {
          puVar5 = (undefined8 *)
                   Memory::realloc_static((void *)(*(long *)this + -0x10),uVar4 + 0x11,false);
          if (puVar5 == (undefined8 *)0x0) goto LAB_00101638;
          puVar7 = puVar5 + 2;
          *puVar5 = 1;
          *(undefined8 **)this = puVar7;
          lVar3 = puVar5[1];
...
LAB_00101928:
      ...
      if (uVar5 + 1 == lVar4) {
        ...
        lVar4 = puVar7[-1];
LAB_00101851:
        if (param_1 <= lVar4) goto LAB_001017cc;
      }
      else {
        if (lVar11 != 0) {
          puVar6 = (undefined8 *)
                   Memory::realloc_static((void *)(*(long *)this + -0x10),uVar5 + 0x11,false);
          if (puVar6 == (undefined8 *)0x0) goto LAB_00101928;
          puVar7 = puVar6 + 2;
          *puVar6 = 1;
          *(undefined8 **)this = puVar7;
          lVar4 = puVar6[1];
      ...
      if (uVar4 + 1 == lVar3) {
        ...
        if (lVar10 == 0) {
          ...
          *puVar5 = 1;
          ...
          puVar5 = (undefined8 *)
                   Memory::realloc_static((void *)(*(long *)this + -0x10),uVar4 + 0x11,false);
          if (puVar5 == (undefined8 *)0x0) goto LAB_00101f40;
          *puVar5 = 1;
        }
        puVar5 = puVar5 + 2;
        *(undefined8 **)this = puVar5;
...
/* StringBuffer<64>::append(char32_t) [clone .isra.0] */

void __thiscall StringBuffer<64>::append(StringBuffer<64> *this,wchar32 param_1)
...
LAB_00102001:
    ...
    if (lVar4 == 0) {
      bVar2 = true;
LAB_00101fbc:
      uVar5 = *(int *)(this + 0x108) + 1;
      uVar5 = uVar5 | uVar5 >> 1;
      uVar5 = uVar5 | uVar5 >> 2;
      uVar5 = uVar5 | uVar5 >> 4;
      uVar5 = uVar5 | uVar5 >> 8;
      CowData<char32_t>::resize<false>
                ((CowData<char32_t> *)(this + 0x100),(long)(int)((uVar5 | uVar5 >> 0x10) + 1));
      if (bVar2) {
...
/* VariantParser::Stream::get_char() */

ulong __thiscall VariantParser::Stream::get_char(Stream *this)

{
  ...
  if (uVar1 < *(uint *)(this + 0x200c)) {
    ...
    uVar2 = (*(code *)**(undefined8 **)this)
                      (this,this + 8,(-(uint)(this[0x2011] == (Stream)0x0) & 0xfffff801) + 0x800);
    iVar3 = 1;
    uVar4 = 0;
...
/* VariantParser::Stream::is_eof() const */

ulong __thiscall VariantParser::Stream::is_eof(Stream *this)

{
  ulong uVar1;
  
  if (this[0x2011] == (Stream)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00102110. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
/* VariantParser::get_token(VariantParser::Stream*, VariantParser::Token&, int&, String&) */

undefined4 VariantParser::get_token(Stream *param_1,Token *param_2,int *param_3,String *param_4)
...
LAB_00102154:
  do {
    ...
    if (wVar7 == L'\0') {
      ...
      if (SVar5 == (Stream)0x0) goto LAB_0010216b;
switchD_00102186_caseD_0:
...
LAB_0010216b:
    switch(wVar7) {
    case L'\0':
      goto switchD_00102186_caseD_0;
    default:
      goto switchD_00102186_caseD_1;
    case L'\"':
      bVar15 = false;
      goto LAB_001025f5;
    case L'#':
...
LAB_001025f5:
    ...
    case L';':
      do {
        ...
        if (SVar5 != (Stream)0x0) goto switchD_00102186_caseD_0;
      } while (iVar8 != 10);
    case L'\n':
      *param_3 = *param_3 + 1;
      break;
...
LAB_0010244b:
  ...
  if ((0x36 < (uint)(wVar7 + L'\xffffffd0')) ||
     ((0x7e0000007e03ffU >> ((ulong)(uint)(wVar7 + L'\xffffffd0') & 0x3f) & 1) == 0))
  goto LAB_00102518;
...
LAB_001027f8:
    ...
    wVar10 = Stream::get_char(param_1);
    if (wVar10 == L'\0') goto LAB_001027f8;
    switch(wVar10) {
    case L'U':
    case L'u':
      local_1b0 = 0;
    ...
    default:
      if ((wVar10 & 0xfffffc00U) == 0xd800) goto LAB_001027d0;
    ...
    if (wVar7 != L'\0') goto LAB_00102740;
LAB_0010261a:
    String::operator+=((String *)&local_1a0,wVar10);
    wVar7 = L'\0';
  } while( true );
LAB_001027d0:
  bVar16 = wVar7 != L'\0';
  wVar7 = wVar10;
  if (bVar16) goto LAB_00102740;
  goto LAB_0010262a;
LAB_00102740:
  local_190 = 0x3a;
...
LAB_00102770:
  ...
  goto LAB_00102213;
switchD_00102186_caseD_1:
  if (0x20 < (uint)wVar7) goto code_r0x0010224a;
  goto LAB_00102154;
code_r0x0010224a:
  if ((uint)wVar7 < 0x3a) {
    if (0x2f < (uint)wVar7) {
...
LAB_00102298:
      ...
      do {
        if (iVar8 == 2) {
          if (wVar7 != L'E') {
            if ((uint)wVar7 < 0x46) {
              if ((uint)(wVar7 + L'\xffffffd0') < 10) goto LAB_001022e5;
              goto LAB_0010231b;
            }
            if (wVar7 != L'e') goto LAB_0010231b;
          }
          iVar8 = 3;
        }
        else if (iVar8 == 3) {
          if ((uint)(wVar7 + L'\xffffffd0') < 10) {
            ...
            if (((wVar7 + L'\xffffffd5' & 0xfffffffdU) != 0) || (bVar16 || bVar3))
            goto LAB_0010231b;
            bVar3 = true;
            bVar16 = false;
          }
          ...
          if ((uint)wVar7 < 0x3a) {
            if ((uint)wVar7 < 0x30) {
              if (wVar7 != L'.') goto LAB_0010231b;
              bVar15 = true;
              iVar8 = 2;
            }
          }
          else {
            if ((wVar7 & 0xffffffdfU) != 0x45) goto LAB_0010231b;
            bVar15 = true;
            iVar8 = 3;
          }
        }
LAB_001022e5:
    ...
    if (((uint)(wVar7 + L'\xffffffbf') < 0x3a) &&
       (bVar15 = (0x3ffffff43ffffffU >> (uVar11 & 0x3f) & 1) != 0, bVar15)) {
      local_58 = (wchar32 *)0x0;
      local_50 = 0;
      do {
        if ((uint)uVar11 < 0x3a) {
          if ((0x3ffffff43ffffffU >> (uVar11 & 0x3f) & 1) == 0) goto LAB_00102a80;
        }
        else if ((bVar15) || (9 < (uint)(wVar7 + L'\xffffffd0'))) goto LAB_00102a80;
        StringBuffer<64>::append((StringBuffer<64> *)local_158,wVar7);
        wVar7 = Stream::get_char(param_1);
        bVar15 = false;
        uVar11 = (ulong)(uint)(wVar7 + L'\xffffffbf');
...
undefined8
VariantParser::_parse_byte_array(Stream *param_1,Vector *param_2,int *param_3,String *param_4)
...
LAB_00102dd6:
          ...
          iVar5 = CowData<unsigned_char>::resize<false>
                            ((CowData<unsigned_char> *)(param_2 + 8),lVar10);
          if (iVar5 == 0) {
            if (*(long *)(param_2 + 8) == 0) {
              lVar7 = -1;
              lVar10 = 0;
            ...
            _err_print_index_error
                      ("set","./core/templates/cowdata.h",0xcf,lVar7,lVar10,"p_index","size()","",
                       false,false);
          }
          else {
...
LAB_00102e49:
          get_token(param_1,(Token *)local_68,param_3,param_4);
          if (local_68[0] != 0xc) goto LAB_00103140;
          get_token(param_1,(Token *)local_68,param_3,param_4);
        } while( true );
      }
      if (local_68[0] == 5) {
LAB_00102cce:
  ...
  goto LAB_00102ec6;
LAB_00103140:
  if (local_68[0] == 5) goto LAB_00102cce;
  local_90 = 0x22;
...
/* VariantWriter::write(Variant const&, Error (*)(void*, String const&), void*, String (*)(void*,
   Ref<Resource> const&), void*, int, bool) */

undefined8
VariantWriter::write
          (Variant *param_1,_func_Error_void_ptr_String_ptr *param_2,void *param_3,
          _func_String_void_ptr_Ref_ptr *param_4,void *param_5,int param_6,bool param_7)
  ...
  case 3:
    ...
    if (((cVar5 != '\0') &&
      ...
      if (((iVar22 == -1) && (iVar22 = String::find_char(wVar21,0x65), iVar22 == -1)) &&
        ...
        String::operator+=((String *)local_1c0,(char *)((long)&DAT_00111a16 + 1));
      }
    }
    goto LAB_0010330f;
  case 4:
...
LAB_0010870d:
    ...
    operator+((char *)&local_d8,(String *)pcVar20);
  ...
  case 7:
    ...
    rtos_fix((double)(float)uVar11);
    operator+((char *)&local_118,(String *)"Rect2(");
  ...
  case 8:
    ...
    String::parse_latin1((StrRange *)&local_110);
    itos((long)local_120);
    operator+((char *)&local_118,(String *)"Rect2i(");
    String::operator+((String *)&local_108,(String *)&local_118);
    String::operator+((String *)&local_f8,(String *)&local_108);
    String::operator+((String *)&local_e8,(String *)&local_f8);
    String::operator+((String *)&local_d8,(String *)&local_e8);
  ...
  case 9:
    ...
    operator+((char *)&local_f8,(String *)"Vector3(");
    String::operator+((String *)&local_e8,(String *)&local_f8);
    String::operator+((String *)&local_d8,(String *)&local_e8);
    String::operator+((String *)&local_c8,(String *)&local_d8);
    String::operator+((String *)&local_b8,(String *)&local_c8);
  ...
  case 10:
    ...
    String::parse_latin1((StrRange *)&local_f0);
    itos((long)&local_100);
    operator+((char *)&local_f8,(String *)"Vector3i(");
    String::operator+((String *)&local_e8,(String *)&local_f8);
    String::operator+((String *)&local_d8,(String *)&local_e8);
    String::operator+((String *)&local_c8,(String *)&local_d8);
    String::operator+((String *)&local_b8,(String *)&local_c8);
...
LAB_00107d0f:
    local_178 = (CowData<char32_t> *)&local_a8;
  ...
  case 0xc:
    ...
    String::parse_latin1((StrRange *)&local_110);
    rtos_fix((double)(float)uVar11);
    operator+((char *)&local_118,(String *)"Vector4(");
    String::operator+((String *)&local_108,(String *)&local_118);
    String::operator+((String *)&local_f8,(String *)&local_108);
    String::operator+((String *)&local_e8,(String *)&local_f8);
    String::operator+((String *)&local_d8,(String *)&local_e8);
  ...
  case 0xd:
    ...
    String::parse_latin1((StrRange *)&local_110);
    itos((long)local_120);
    operator+((char *)&local_118,(String *)"Vector4i(");
    String::operator+((String *)&local_108,(String *)&local_118);
    String::operator+((String *)&local_f8,(String *)&local_108);
    String::operator+((String *)&local_e8,(String *)&local_f8);
    String::operator+((String *)&local_d8,(String *)&local_e8);
  ...
  case 0xe:
    ...
    String::parse_latin1((StrRange *)&local_110);
    rtos_fix((double)(float)local_88);
    operator+((char *)&local_118,(String *)"Plane(");
    String::operator+((String *)&local_108,(String *)&local_118);
    String::operator+((String *)&local_f8,(String *)&local_108);
    String::operator+((String *)&local_e8,(String *)&local_f8);
    String::operator+((String *)&local_d8,(String *)&local_e8);
...
LAB_00106beb:
  ...
  case 0xf:
    ...
    String::parse_latin1((StrRange *)&local_110);
    rtos_fix((double)(float)local_88);
    operator+((char *)&local_118,(String *)"Quaternion(");
    String::operator+((String *)&local_108,(String *)&local_118);
    String::operator+((String *)&local_f8,(String *)&local_108);
    String::operator+((String *)&local_e8,(String *)&local_f8);
    String::operator+((String *)&local_d8,(String *)&local_e8);
  ...
  case 0x10:
    ...
    rtos_fix((double)(float)local_88);
    operator+((char *)&local_158,(String *)&_LC103);
...
LAB_00106b54:
  ...
  case 0x14:
    ...
    String::parse_latin1((StrRange *)&local_110);
    rtos_fix((double)(float)uVar11);
    operator+((char *)&local_118,(String *)"Color(");
    String::operator+((String *)&local_108,(String *)&local_118);
    String::operator+((String *)&local_f8,(String *)&local_108);
    String::operator+((String *)&local_e8,(String *)&local_f8);
    String::operator+((String *)&local_d8,(String *)&local_e8);
...
LAB_00105e90:
  ...
  case 0x15:
    ...
    String::parse_latin1((StrRange *)&local_a8);
    String::c_escape();
    operator+((char *)&local_b8,(String *)&_LC110);
    String::operator+((String *)&local_98,(String *)&local_b8);
  ...
  case 0x16:
    ...
    String::parse_latin1((StrRange *)&local_a8);
    String::c_escape();
    operator+((char *)&local_b8,(String *)"NodePath(\"");
LAB_00108923:
    local_178 = (CowData<char32_t> *)&local_a8;
    local_1c8 = (CowData<char32_t> *)&local_c0;
    String::operator+((String *)&local_98,(String *)&local_b8);
...
LAB_00108988:
  ...
  case 0x17:
    ...
    String::parse_latin1((StrRange *)&local_a8);
    itos((long)&local_c0);
    operator+((char *)&local_b8,(String *)&_LC114);
    String::operator+((String *)&local_98,(String *)&local_b8);
    (*param_2)(param_3,(String *)&local_98);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_98);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_b8);
  ...
  case 0x18:
    ...
    if (pLVar9 == (List *)0x0) goto switchD_001032cb_caseD_0;
    local_d0 = (Object *)0x0;
    ...
    if (pOVar10 == local_d0) {
LAB_00105691:
      if (pOVar14 == (Object *)0x0) goto LAB_001057d8;
      local_c8 = (char *)0x0;
...
LAB_00105763:
        ...
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_98);
        if ((local_c8 == (char *)0x0) || (*(uint *)(local_c8 + -8) < 2)) goto LAB_00105763;
      }
...
LAB_00105664:
        ...
        if (pOVar13 == pOVar10) goto LAB_00105691;
        local_d0 = pOVar10;
        if (pOVar10 != (Object *)0x0) {
          cVar5 = RefCounted::reference();
          if (cVar5 != '\0') {
            pOVar14 = local_d0;
            if (pOVar13 != (Object *)0x0) goto LAB_00105664;
            goto LAB_00105691;
          }
          local_d0 = (Object *)0x0;
        }
...
joined_r0x0010a679:
        ...
        if (local_198 == (Object *)0x0) {
          cVar5 = ::Variant::needs_deinit[(int)(float)local_88];
          goto joined_r0x0010a679;
        }
        cVar5 = RefCounted::reference();
        if (cVar5 == '\0') goto LAB_00109fb5;
        if (::Variant::needs_deinit[(int)(float)local_88] != '\0') {
          ::Variant::_clear_internal();
        }
        local_c8 = (char *)0x0;
...
LAB_0010942b:
          ...
          if ((local_c8 != (char *)0x0) && (1 < *(uint *)(local_c8 + -8))) goto LAB_0010a0e1;
          ...
          if ((local_c8 == (char *)0x0) || (*(uint *)(local_c8 + -8) < 2)) goto LAB_0010942b;
LAB_0010a0e1:
          (*param_2)(param_3,(String *)&local_c8);
        }
        local_1c0 = (CowData<char32_t> *)&local_c8;
...
joined_r0x0010a6a9:
        ...
        if (pOVar13 == (Object *)0x0) {
          cVar5 = ::Variant::needs_deinit[(int)(float)local_88];
          goto joined_r0x0010a6a9;
        }
        cVar5 = RefCounted::reference();
        if (cVar5 == '\0') goto LAB_00109ee6;
        if (::Variant::needs_deinit[(int)(float)local_88] != '\0') {
          ::Variant::_clear_internal();
        }
        local_c8 = (char *)0x0;
...
LAB_00109743:
          ...
          if ((local_c8 != (char *)0x0) && (1 < *(uint *)(local_c8 + -8))) goto LAB_0010a0b7;
          ...
          if ((local_c8 == (char *)0x0) || (*(uint *)(local_c8 + -8) < 2)) goto LAB_00109743;
LAB_0010a0b7:
          (*param_2)(param_3,(String *)&local_c8);
        }
        local_1c0 = (CowData<char32_t> *)&local_c8;
      ...
      if (((local_198 != (Object *)0x0) && (cVar5 = RefCounted::unreference(), cVar5 != '\0')) &&
    ...
    if (param_6 < 0x65) {
      ...
      List<Variant,DefaultAllocator>::sort_custom<StringLikeVariantOrder>
                ((List<Variant,DefaultAllocator> *)&local_b8);
      if ((local_b8 == (Variant *)0x0) || (*(int *)(local_b8 + 0x10) == 0)) {
        local_98 = (char *)&_LC129;
        local_90 = 2;
      }
      else {
        local_98 = (undefined *)0x111b37;
        local_a8 = (Variant *)0x0;
        local_90 = 2;
        String::parse_latin1((StrRange *)&local_a8);
        (*param_2)(param_3,(String *)&local_a8);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_a8);
        if (local_b8 != (Variant *)0x0) {
          for (pVVar23 = *(Variant **)local_b8; pVVar23 != (Variant *)0x0;
              pVVar23 = *(Variant **)(pVVar23 + 0x18)) {
...
joined_r0x0010a6db:
        ...
        if (pOVar13 == (Object *)0x0) {
          cVar5 = ::Variant::needs_deinit[(int)(float)local_88];
          goto joined_r0x0010a6db;
        }
        cVar5 = RefCounted::reference();
        if (cVar5 == '\0') goto LAB_00109ccf;
        if (::Variant::needs_deinit[(int)(float)local_88] != '\0') {
          ::Variant::_clear_internal();
        }
        local_c8 = (char *)0x0;
...
LAB_00109b39:
          ...
          if ((local_c8 != (char *)0x0) && (1 < *(uint *)(local_c8 + -8))) goto LAB_0010a08d;
          ...
          if ((local_c8 == (char *)0x0) || (*(uint *)(local_c8 + -8) < 2)) goto LAB_00109b39;
LAB_0010a08d:
          (*param_2)(param_3,(String *)&local_c8);
        }
        local_1c0 = (CowData<char32_t> *)&local_c8;
...
LAB_0010b882:
    ...
    if (cVar7 == '\0') {
      ...
      if (cVar7 != '\0') {
        ...
        pSVar24 = (StringName *)(ulong)uVar9;
        if (uVar9 == 0) {
          if ((local_130 == (undefined8 *)0x0) || (local_130[-1] != 4)) goto LAB_0010b779;
          local_b8 = *local_130;
...
LAB_0010b9ab:
      ...
      if (cVar7 != '\0') {
        ...
        pSVar24 = (StringName *)(ulong)uVar9;
        if (uVar9 == 0) {
          if ((local_130 == (undefined8 *)0x0) || (local_130[-1] != 4)) goto LAB_0010b80f;
          local_b8 = *local_130;
          auStack_b0._0_8_ = local_130[1];
                          ...
                          if (cVar7 == '\0') {
                            ...
                            if (cVar7 == '\0') {
                              ...
                              if (cVar7 != '\0') {
                                ...
                                if (*(int *)param_1 != 4) goto LAB_0010c472;
                                get_token(param_3,param_1,param_4,param_5);
                                if (*(int *)param_1 == 6) {
                                          ...
                                          if (((cVar7 != '\0') ||
                                            ...
                                            if (uVar9 == 0) {
                                              ...
                                              for (lVar18 = 0; (int)lVar18 < iVar21;
                                                  lVar18 = lVar18 + 1) {
                                                if (puVar6 == (undefined8 *)0x0) goto LAB_0010ecfd;
                                                lVar23 = puVar6[-1];
                                                if (lVar23 <= lVar18) goto LAB_0010ed1b;
                                              ...
                                              if (((cVar7 == '\0') &&
                                                ...
                                                if (((cVar7 == '\0') &&
                                                  ...
                                                  for (iVar11 = 0; iVar11 < iVar21;
                                                    ...
                                                    lVar18 = lVar19 + 2;
                                                    if (lVar23 <= lVar19 + 2) goto LAB_0010ed1b;
                                                    uVar5 = *(undefined4 *)
...
LAB_0010b243:
                                              ...
                                              do {
                                                get_token(param_3,param_1,param_4,param_5);
                                                if (*(int *)param_1 == 5) goto LAB_0010f2dd;
                                                if (*(int *)param_1 != 7) {
...
LAB_0010f2dd:
                                  ...
                                  get_token(param_3,param_1,param_4,param_5);
                                  if (*(int *)param_1 != 2) goto LAB_0010df54;
                                  get_token(param_3,param_1,param_4,param_5);
                                  if (*(int *)param_1 != 6) {
...
LAB_0010d720:
                                          ...
                                          if (uVar9 != 0 || (int)pSVar24 != 0) goto LAB_0010d2c3;
                                          goto LAB_0010d2fd;
                                        }
                                        ::Variant::Variant((Variant *)&local_88,"Resource");
                                        cVar7 = ::Variant::operator==(this,(Variant *)&local_88);
...
LAB_0010d052:
                                          get_token(param_3,param_1,param_4,param_5);
                                          if (*(int *)param_1 == 3) goto LAB_0010d077;
                                          String::parse_latin1(param_5,"Expected \']\'");
                                        }
                                        else {
LAB_0010d2c3:
                                          ...
                                          Dictionary::set_typed
                                                    ((uint)local_160,(StringName *)(ulong)uVar9,
                                                     ...
                                                     local_198);
LAB_0010d2fd:
                                          if (local_180 == false) goto LAB_0010d052;
LAB_0010d077:
                                          get_token(param_3,param_1,param_4,param_5);
                                          if (*(int *)param_1 == 4) {
                                            get_token(param_3,param_1,param_4,param_5);
...
LAB_0010c441:
                        get_token(param_3,param_1,param_4,param_5);
                        if (*(int *)param_1 == 5) goto LAB_0010b4ab;
                        String::parse_latin1(param_5,"Expected \')\'");
                      }
LAB_0010c314:
                      pSVar24 = (StringName *)0x2b;
              ...
              pSVar24 = (StringName *)(ulong)uVar9;
              if (uVar9 == 0) {
                if ((local_130 == (undefined8 *)0x0) || (local_130[-1] != 6)) goto LAB_0010bd0e;
                local_b8 = *local_130;
                auStack_b0 = *(undefined1 (*) [16])(local_130 + 1);
...
LAB_0010ed1b:
  _err_print_index_error
            ("get","./core/templates/cowdata.h",0xdb,lVar18,lVar23,"p_index","size()","",false,true)
  ;
  _err_flush_stdout();
                    /* WARNING: Does not return */
...
/* VariantParser::_parse_array(Array&, VariantParser::Stream*, int&, String&,
   VariantParser::ResourceParser*) */

ulong VariantParser::_parse_array
                (Array *param_1,Stream *param_2,int *param_3,String *param_4,ResourceParser *param_5
                )

{
  ...
  local_58 = (undefined1  [16])0x0;
  local_60 = 0;
  if (param_2[0x2011] != (Stream)0x0) goto LAB_0010fbfc;
LAB_0010fba7:
  SVar2 = (Stream)(**(code **)(*(long *)param_2 + 8))(param_2);
  do {
    if (SVar2 != (Stream)0x0) {
      String::parse_latin1((StrRange *)param_4);
      uVar3 = 0x10;
LAB_0010fc97:
    ...
    if ((int)uVar3 != 0) goto LAB_0010fc97;
    if (local_68[0] == 3) goto LAB_0010fc97;
    if (bVar1) {
      bVar1 = false;
      if (local_68[0] != 0xc) {
        String::parse_latin1((StrRange *)param_4);
    ...
    if (param_2[0x2011] == (Stream)0x0) goto LAB_0010fba7;
LAB_0010fbfc:
    SVar2 = param_2[0x2010];
  } while( true );
}
...
ulong VariantParser::_parse_dictionary
                (Dictionary *param_1,Stream *param_2,int *param_3,String *param_4,
                ResourceParser *param_5)

{
  ...
  bVar1 = true;
LAB_0010fdc8:
  if (param_2[0x2011] != (Stream)0x0) goto LAB_0010fe26;
LAB_0010fdd1:
  SVar4 = (Stream)(**(code **)(*(long *)param_2 + 8))(param_2);
  bVar3 = bVar1;
joined_r0x0010fddc:
  bVar1 = bVar2;
  if (SVar4 != (Stream)0x0) {
  ...
  if (bVar3) {
    ...
    if (((int)uVar5 != 0) || (local_68[0] == 1)) goto LAB_0010fe58;
    if (bVar1) {
      if (local_68[0] != 0xc) {
        String::parse_latin1((StrRange *)param_4);
        goto LAB_0010ffb2;
      ...
      bVar2 = false;
      if (param_2[0x2011] == (Stream)0x0) goto LAB_0010fdd1;
LAB_0010fe26:
      SVar4 = param_2[0x2010];
      bVar3 = bVar1;
      goto joined_r0x0010fddc;
    }
    uVar5 = parse_value((Token *)local_68,(Variant *)&local_a8,param_2,param_3,param_4,param_5);
    if (((int)uVar5 != 0) ||
       (uVar5 = get_token(param_2,(Token *)local_68,param_3,param_4), (int)uVar5 != 0))
    goto LAB_0010fe58;
    if (local_68[0] == 0xb) {
      bVar2 = bVar1;
      bVar1 = false;
...
ulong VariantParser::parse
                (Stream *param_1,Variant *param_2,String *param_3,int *param_4,
                ResourceParser *param_5)
...
/* VariantParser::_parse_tag(VariantParser::Token&, VariantParser::Stream*, int&, String&,
   VariantParser::Tag&, VariantParser::ResourceParser*, bool) */

ulong VariantParser::_parse_tag
                (Token *param_1,Stream *param_2,int *param_3,String *param_4,Tag *param_5,
                ResourceParser *param_6,bool param_7)
...
LAB_001103a8:
    ...
    if (*(int *)param_1 == 6) {
      ...
      bVar12 = true;
LAB_001104b3:
      if (param_2[0x2011] != (Stream)0x0) goto LAB_001105f5;
LAB_001104c0:
      SVar6 = (Stream)(**(code **)(*(long *)param_2 + 8))(param_2);
      do {
        if (SVar6 != (Stream)0x0) {
          ...
          if (*(long *)param_5 == 0) goto LAB_001109bb;
          goto LAB_0011099a;
        }
        get_token(param_2,param_1,param_3,param_4);
        iVar7 = *(int *)param_1;
        if (iVar7 == 3) goto LAB_00110934;
        if (bVar12) {
          pcVar11 = ".";
          if (iVar7 != 0xd) {
            if (iVar7 != 0xb) goto LAB_0011050d;
            pcVar11 = ":";
          }
...
LAB_00110b16:
        ...
        bVar12 = false;
        if (param_2[0x2011] == (Stream)0x0) goto LAB_001104c0;
LAB_001105f5:
        SVar6 = param_2[0x2010];
      } while( true );
    }
...
LAB_001108e8:
  String::strip_edges(SUB81((String *)&local_68,0),SUB81(param_5,0));
  pcVar4 = local_68;
  pcVar11 = *(char **)param_5;
  if (pcVar11 == local_68) {
    if (pcVar11 != (char *)0x0) {
...
/* VariantParser::parse_tag(VariantParser::Stream*, int&, String&, VariantParser::Tag&,
   VariantParser::ResourceParser*, bool) */

ulong VariantParser::parse_tag
                (Stream *param_1,int *param_2,String *param_3,Tag *param_4,ResourceParser *param_5,
                bool param_6)
...
/* VariantParser::parse_tag_assign_eof(VariantParser::Stream*, int&, String&, VariantParser::Tag&,
   String&, Variant&, VariantParser::ResourceParser*, bool) */

ulong VariantParser::parse_tag_assign_eof
                (Stream *param_1,int *param_2,String *param_3,Tag *param_4,String *param_5,
                Variant *param_6,ResourceParser *param_7,bool param_8)
...
LAB_00110d36:
  ...
  if (uVar5 == 0) goto LAB_00110d93;
LAB_00110d42:
  *(undefined4 *)(param_1 + 0x2014) = 0;
  if (param_1[0x2011] != (Stream)0x0) goto LAB_00110da8;
LAB_00110d57:
  SVar4 = (Stream)(**(code **)(*(long *)param_1 + 8))(param_1);
  do {
    if (SVar4 != (Stream)0x0) {
LAB_00110ee0:
    ...
    if (uVar5 == 0x3b) {
      do {
        ...
        if (SVar4 != (Stream)0x0) goto LAB_00110ee0;
      } while (iVar6 != 10);
    }
    else {
      if (uVar5 == 0x5b) {
...
LAB_00110e7c:
        String::chr((wchar32)(Variant *)&local_78);
      ...
      if (0x20 < uVar5) {
        if (uVar5 == 0x22) {
          *(undefined4 *)(param_1 + 0x2014) = 0x22;
          ...
          if (uVar5 != 0x3d) goto LAB_00110e7c;
...
LAB_00110e29:
      ...
      if (uVar5 != 10) goto LAB_00110d36;
    }
    *param_2 = *param_2 + 1;
    uVar5 = *(uint *)(param_1 + 0x2014);
    if (uVar5 != 0) goto LAB_00110d42;
LAB_00110d93:
    uVar5 = Stream::get_char(param_1);
    if (param_1[0x2011] == (Stream)0x0) goto LAB_00110d57;
LAB_00110da8:
    SVar4 = param_1[0x2010];
  } while( true );
}
...
void __thiscall VariantParser::StreamFile::~StreamFile(StreamFile *this)

{
  Object *pOVar1;
  char cVar2;
  
  *(undefined ***)this = &PTR__read_buffer_001195e8;
  if (*(long *)(this + 0x2018) != 0) {
...
/* HashMap<StringName, Variant::Type, HashMapHasherDefault, HashMapComparatorDefault<StringName>,
   DefaultTypedAllocator<HashMapElement<StringName, Variant::Type> > >::~HashMap() */

void __thiscall
HashMap<StringName,Variant::Type,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant::Type>>>
::~HashMap(HashMap<StringName,Variant::Type,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant::Type>>>
           *this)
...
/* VariantParser::StreamString::~StreamString() */

void __thiscall VariantParser::StreamString::~StreamString(StreamString *this)

{
  long *plVar1;
  long lVar2;
  
  *(undefined ***)this = &PTR__read_buffer_00119620;
  if (*(long *)(this + 0x2018) != 0) {
    LOCK();
...
LAB_001125ed:
      ...
      while( true ) {
        ...
        if (cVar5 == '\0') goto joined_r0x00112755;
...

{
  ...
  if (lVar8 < param_3) {
    ...
    ppEVar6 = ppEVar7;
    if (lVar8 == param_3) goto LAB_00112b60;
  }
  else {
    ppEVar7 = param_5 + param_2 + param_1;
    if (lVar8 != param_3) goto LAB_00112b10;
LAB_00112b60:
    lVar5 = lVar8 + -1;
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (lVar10 < 2) {
    if (param_2 <= param_3) goto LAB_00112ce3;
LAB_00112c19:
    lVar9 = param_3;
    do {
      while( true ) {
        ...
        if (lVar9 == param_2) goto LAB_00112c9b;
      }
      lVar9 = lVar9 + 1;
    } while (lVar9 != param_2);
LAB_00112c9b:
    if (lVar10 < 2) goto LAB_00112ce3;
  }
  else {
    ...
    if (param_3 < param_2) goto LAB_00112c19;
  }
...
LAB_00113404:
            ...
            if (0x10 < lVar1) goto code_r0x00113450;
LAB_001138e6:
            lVar1 = lVar4 - lVar3;
            if (0x10 < lVar1) goto LAB_001138f6;
            goto LAB_00113a93;
          }
LAB_00113b08:
...
LAB_00113a1f:
        lVar1 = lVar3 - param_2;
        if (lVar1 < 0x11) goto joined_r0x00113ad1;
        lVar4 = lVar3;
        if (lVar11 == 0) break;
      } while( true );
    }
  ...
  if (param_4 != 0) goto LAB_00113b6c;
  goto LAB_00113b93;
code_r0x00113450:
  if (lVar15 != 0) {
    lVar13 = lVar15;
...
LAB_00113687:
                            do {
                                ...
                                if (local_108 != 0) {
                                  ...
                                  do {
                                    ...
                                    if (lVar1 < 0x11) {
                                      lVar1 = lVar9 - lVar8;
                                      lVar10 = lVar9;
                                      if (lVar1 < 0x11) goto LAB_0011381c;
                                      goto LAB_00113687;
                                    }
                                    lVar14 = lVar10;
                                  } while (lVar12 != 0);
                              ...
                              if (lVar1 < 0x11) {
                                lVar1 = lVar8 - lVar7;
                                lVar9 = lVar8;
                                if (lVar1 < 0x11) goto joined_r0x00113930;
                                goto LAB_00113611;
                              }
                              lVar10 = lVar9;
                            } while (local_108 != 0);
...
LAB_0011381c:
                        ...
                        if (lVar1 < 0x11) {
                          lVar1 = lVar7 - lVar6;
                          lVar8 = lVar7;
                          if (lVar1 < 0x11) goto joined_r0x001138ab;
                          goto LAB_00113593;
                        }
                        lVar9 = lVar8;
                      } while (local_118 != 0);
...
joined_r0x001138ab:
            ...
            if (lVar1 < 0x11) {
              lVar1 = lVar5 - lVar4;
              lVar6 = lVar5;
              if (lVar1 < 0x11) goto LAB_001138e6;
              goto LAB_0011348c;
            }
            lVar7 = lVar6;
          } while (local_f8 != 0);
...
joined_r0x00113970:
      ...
      if (lVar1 < 0x11) {
        lVar1 = lVar4 - lVar3;
        local_118 = lVar4;
        if (lVar1 < 0x11) goto LAB_00113a1f;
        goto LAB_00113404;
      }
      lVar6 = lVar5;
      local_118 = lVar5;
...
LAB_00113a93:
    lVar1 = lVar3 - param_2;
    lVar4 = lVar3;
    if (0x10 < lVar1) goto LAB_0011336c;
    goto joined_r0x00113ad1;
  }
LAB_001138f6:
  local_118 = lVar4;
  if (lVar15 == 0) goto LAB_00113b08;
  goto LAB_00113404;
joined_r0x00113ad1:
  lVar1 = param_2 - param_1;
  if (lVar1 < 0x11) {
...
void StringBuffer<64>::as_string(void)
  ...
  if (lVar4 == 0) {
    ...
    if (*(uint *)(lVar4 + -8) < 2) {
      ...
      *(undefined4 *)(lVar4 + (long)in_RSI[0x42] * 4) = 0;
      if (lVar4 == 0) goto LAB_00113ee0;
    }
    iVar3 = (int)*(undefined8 *)(lVar4 + -8);
    if ((iVar3 != 0) && (iVar3 != 1)) {
      CowData<char32_t>::resize<false>
                ((CowData<char32_t> *)(in_RSI + 0x40),(long)(in_RSI[0x42] + 1));
      *(undefined8 *)in_RDI = 0;
...
/* WARNING: Removing unreachable block (ram,0x00114168) */
/* WARNING: Removing unreachable block (ram,0x00114298) */
/* WARNING: Removing unreachable block (ram,0x00114460) */
/* WARNING: Removing unreachable block (ram,0x001142a4) */
/* WARNING: Removing unreachable block (ram,0x001142ae) */
/* WARNING: Removing unreachable block (ram,0x00114440) */
/* WARNING: Removing unreachable block (ram,0x001142ba) */
/* WARNING: Removing unreachable block (ram,0x001142c4) */
/* WARNING: Removing unreachable block (ram,0x00114420) */
/* WARNING: Removing unreachable block (ram,0x001142d0) */
/* WARNING: Removing unreachable block (ram,0x001142da) */
/* WARNING: Removing unreachable block (ram,0x00114400) */
/* WARNING: Removing unreachable block (ram,0x001142e6) */
/* WARNING: Removing unreachable block (ram,0x001142f0) */
/* WARNING: Removing unreachable block (ram,0x001143e0) */
/* WARNING: Removing unreachable block (ram,0x001142fc) */
/* WARNING: Removing unreachable block (ram,0x00114306) */
/* WARNING: Removing unreachable block (ram,0x001143c0) */
/* WARNING: Removing unreachable block (ram,0x00114312) */
/* WARNING: Removing unreachable block (ram,0x0011431c) */
/* WARNING: Removing unreachable block (ram,0x001143a0) */
/* WARNING: Removing unreachable block (ram,0x00114324) */
/* WARNING: Removing unreachable block (ram,0x0011433a) */
/* WARNING: Removing unreachable block (ram,0x00114346) */
...
HashMap<StringName,Variant::Type,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant::Type>>>
::operator[](HashMap<StringName,Variant::Type,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant::Type>>>
...
LAB_00114a54:
    ...
    iVar46 = *(int *)(this + 0x2c);
    if (pvVar44 == (void *)0x0) goto LAB_00114683;
    if (iVar46 != 0) goto LAB_00114a54;
LAB_001146a9:
    ...
    *(void **)(this + 8) = __s_00;
    ...
    if (iVar46 != 0) {
      ...
      if (lVar43 == 0) goto LAB_00114b98;
LAB_00114a48:
      iVar46 = *(int *)(this + 0x2c);
      goto LAB_00114a4c;
    }
LAB_00114683:
    if ((float)uVar40 * __LC53 < (float)(iVar46 + 1)) goto LAB_001146a9;
  }
...
/* HashMap<StringName, Variant::Type, HashMapHasherDefault, HashMapComparatorDefault<StringName>,
   DefaultTypedAllocator<HashMapElement<StringName, Variant::Type> > >::get(StringName const&) */

long __thiscall
HashMap<StringName,Variant::Type,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant::Type>>>
::get(HashMap<StringName,Variant::Type,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant::Type>>>
      *this,StringName *param_1)

{
  ...
  _err_print_error(&_LC62,"./core/templates/hash_map.h",0x140,
...
LAB_00115396:
    ...
    iVar45 = *(int *)(this + 0x2c);
    if (pvVar43 == (void *)0x0) goto LAB_00114e84;
    if (iVar45 != 0) goto LAB_00115396;
LAB_00114eaa:
    ...
    *(void **)(this + 8) = __s_00;
    ...
    if (iVar45 != 0) {
      ...
      uVar55 = *(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x28) * 4);
      if (*(long *)(this + 8) == 0) goto LAB_001154f8;
LAB_0011538a:
      iVar45 = *(int *)(this + 0x2c);
      goto LAB_0011538e;
    }
LAB_00114e84:
    if ((float)uVar39 * __LC53 < (float)(iVar45 + 1)) goto LAB_00114eaa;
  }
  local_58 = 0;
  if (*(long *)param_1 == 0) {
...
LAB_00115131:
    ...
    if (puVar42 != (undefined8 *)0x0) goto LAB_0011513e;
LAB_00115365:
    ...
    *plVar1 = *plVar1 + -1;
    UNLOCK();
    if (*plVar1 != 0) goto LAB_00115131;
    Memory::free_static((void *)(local_58 + -0x10),false);
    puVar42 = *(undefined8 **)(this + 0x20);
    if (puVar42 == (undefined8 *)0x0) goto LAB_00115365;
LAB_0011513e:
    *puVar42 = pauVar41;
...
/* HashMap<String, Variant::Type, HashMapHasherDefault, HashMapComparatorDefault<String>,
   DefaultTypedAllocator<HashMapElement<String, Variant::Type> > >::get(String const&) */

long __thiscall
HashMap<String,Variant::Type,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Variant::Type>>>
::get(HashMap<String,Variant::Type,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Variant::Type>>>
      *this,String *param_1)

{
  ...
  if ((*(long *)(this + 8) != 0) && (*(int *)(this + 0x2c) != 0)) {
    ...
    if (uVar13 != 0) {
      ...
      do {
        if (uVar14 == uVar13) {
          cVar12 = String::operator==((String *)(*(long *)(*(long *)(this + 8) + lVar16 * 8) + 0x10)
                                      ,param_1);
          if (cVar12 != '\0') {
...
LAB_00115d09:
        ...
        if (uVar52 != 0) {
          do {
            ...
            uVar51 = SUB164(auVar19 * auVar35,8);
                  ...
                  (auVar20._8_8_ = 0, auVar20._0_8_ = (ulong)uVar52 * lVar5, auVar36._8_8_ = 0,
                  auVar36._0_8_ = uVar41, auVar21._8_8_ = 0,
                  auVar21._0_8_ = (ulong)((uVar39 + uVar51) - SUB164(auVar20 * auVar36,8)) * lVar5,
                  auVar37._8_8_ = 0, auVar37._0_8_ = uVar41, uVar55 <= SUB164(auVar21 * auVar37,8)))
          ;
        }
        iVar46 = *(int *)(this + 0x2c);
      }
    ...
    iVar46 = *(int *)(this + 0x2c);
    if (pvVar45 == (void *)0x0) goto LAB_001157c9;
    if (*(int *)(this + 0x2c) != 0) goto LAB_00115d09;
LAB_001157ef:
    ...
    *(void **)(this + 8) = __s_00;
      ...
      if (uVar40 == 0) {
        ...
        do {
          ...
          uVar52 = SUB164(auVar15 * auVar31,8);
                ...
                (auVar16._8_8_ = 0, auVar16._0_8_ = (ulong)uVar40 * lVar5, auVar32._8_8_ = 0,
                auVar32._0_8_ = uVar41, auVar17._8_8_ = 0,
                auVar17._0_8_ = (ulong)((uVar52 + uVar56) - SUB164(auVar16 * auVar32,8)) * lVar5,
                auVar33._8_8_ = 0, auVar33._0_8_ = uVar41, uVar51 <= SUB164(auVar17 * auVar33,8)));
      }
      local_98[0] = 0;
      local_98[1] = 0;
      local_90 = (undefined1  [16])0x0;
      uVar56 = *(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x28) * 4);
      if (lVar48 == 0) goto LAB_00115e4d;
      goto LAB_00115cfd;
    }
    local_98[0] = 0;
    local_98[1] = 0;
    ...
    iVar46 = 0;
LAB_001157c9:
    if ((float)uVar49 * __LC53 < (float)(iVar46 + 1)) goto LAB_001157ef;
  }
  local_68 = 0;
...
LAB_00115ab2:
    ...
    if (puVar44 != (undefined8 *)0x0) goto LAB_00115abf;
LAB_00115e34:
    ...
    *plVar1 = *plVar1 + -1;
    UNLOCK();
    if (*plVar1 != 0) goto LAB_00115ab2;
    local_68 = 0;
    Memory::free_static((void *)(lVar5 + -0x10),false);
    puVar44 = *(undefined8 **)(this + 0x20);
    if (puVar44 == (undefined8 *)0x0) goto LAB_00115e34;
LAB_00115abf:
    *puVar44 = puVar43;
  ...
  *(undefined8 **)(this + 0x20) = puVar43;
  ...
  lVar54 = *(long *)(hash_table_size_primes_inv + (ulong)*(uint *)(this + 0x28) * 8);
  auVar10._8_8_ = 0;
  auVar10._0_8_ = (ulong)uVar56 * lVar54;
  auVar26._8_8_ = 0;
      ...
      do {
        while( true ) {
          ...
          *__src = (Element *)pVVar12;
          ...
          if (pEVar6 == pEVar10) goto LAB_001166bc;
        }
...
LAB_001169da:
      ...
      do {
        ...
        if ((long)pEVar8 < 0x11) goto LAB_001162bc;
        pEVar10 = pEVar8;
      } while (lVar14 != 0);
      SortArray<List<Variant,DefaultAllocator>::Element*,List<Variant,DefaultAllocator>::AuxiliaryComparator<StringLikeVariantOrder>,true>
...
LAB_001162bc:
      ...
      do {
        while( true ) {
          ...
          *__src = (Element *)pVVar12;
          lVar14 = lVar11 + 1;
          if (lVar11 + 1 == 0x10) goto LAB_00116441;
        }
...
LAB_00116fd9:
      ...
      if (lVar7 == 0) {
        ...
        *puVar5 = 1;
        ...
        if (puVar5 == (undefined8 *)0x0) goto LAB_00117090;
        *puVar5 = 1;
      }
      puVar5 = puVar5 + 2;
      *(undefined8 **)this = puVar5;
    ...
    puVar5 = *(undefined8 **)this;
    if (uVar3 + 1 == lVar4) {
      if (puVar5 == (undefined8 *)0x0) goto LAB_00116fd9;
    }
    else {
...
undefined8 __thiscall
HashMap<StringName,Variant::Type,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant::Type>>>
::_lookup_pos(HashMap<StringName,Variant::Type,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant::Type>>>
...
undefined8 __thiscall
HashMap<String,Variant::Type,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Variant::Type>>>
::_lookup_pos(HashMap<String,Variant::Type,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Variant::Type>>>
  ...
  if (param_1 * 4 != 0) {
    ...
    if (uVar4 != 0xffffffffffffffff) {
      if (lVar7 < param_1) {
        if (uVar4 + 1 == lVar3) {
          puVar5 = *(undefined8 **)this;
          if (puVar5 == (undefined8 *)0x0) goto LAB_00117629;
        }
        else {
          if (lVar7 == 0) {
            puVar5 = (undefined8 *)Memory::alloc_static(uVar4 + 0x11,false);
            ...
            *puVar5 = 1;
            ...
            puVar5 = (undefined8 *)
                     Memory::realloc_static((void *)(*(long *)this + -0x10),uVar4 + 0x11,false);
            if (puVar5 == (undefined8 *)0x0) goto LAB_00117710;
            *puVar5 = 1;
          }
          puVar5 = puVar5 + 2;
          *(undefined8 **)this = puVar5;
...
undefined8
VariantParser::_parse_construct<int>(Stream *param_1,Vector *param_2,int *param_3,String *param_4)
...
LAB_001178bf:
        iVar4 = ::Variant::operator_cast_to_int((Variant *)&local_60);
        if (*(long *)(param_2 + 8) == 0) {
          lVar7 = 1;
        }
        else {
...
LAB_00117920:
        get_token(param_1,(Token *)local_68,param_3,param_4);
        if (local_68[0] != 0xc) goto LAB_00117af0;
        get_token(param_1,(Token *)local_68,param_3,param_4);
      } while( true );
    }
    goto LAB_00117ac4;
  ...
  if (param_1 * 8 != 0) {
    ...
    if (uVar4 != 0xffffffffffffffff) {
      if (lVar7 < param_1) {
        if (uVar4 + 1 == lVar3) {
          puVar5 = *(undefined8 **)this;
          if (puVar5 == (undefined8 *)0x0) goto LAB_00117cc9;
        }
        else {
          if (lVar7 == 0) {
            puVar5 = (undefined8 *)Memory::alloc_static(uVar4 + 0x11,false);
            ...
            *puVar5 = 1;
            ...
            puVar5 = (undefined8 *)
                     Memory::realloc_static((void *)(*(long *)this + -0x10),uVar4 + 0x11,false);
            if (puVar5 == (undefined8 *)0x0) goto LAB_00117db0;
            *puVar5 = 1;
          }
          puVar5 = puVar5 + 2;
          *(undefined8 **)this = puVar5;
...
undefined8
VariantParser::_parse_construct<long>(Stream *param_1,Vector *param_2,int *param_3,String *param_4)
...
LAB_00117f3f:
        lVar5 = ::Variant::operator_cast_to_long((Variant *)&local_60);
        if (*(long *)(param_2 + 8) == 0) {
          lVar7 = 1;
        }
        else {
...
LAB_00117fa1:
        get_token(param_1,(Token *)local_68,param_3,param_4);
        if (local_68[0] != 0xc) goto LAB_00118170;
        get_token(param_1,(Token *)local_68,param_3,param_4);
      } while( true );
    }
    goto LAB_00118144;
  ...
  if (param_1 * 4 != 0) {
    ...
    if (uVar4 != 0xffffffffffffffff) {
      if (lVar7 < param_1) {
        if (uVar4 + 1 == lVar3) {
          puVar5 = *(undefined8 **)this;
          if (puVar5 == (undefined8 *)0x0) goto LAB_00118349;
        }
        else {
          if (lVar7 == 0) {
            puVar5 = (undefined8 *)Memory::alloc_static(uVar4 + 0x11,false);
            ...
            *puVar5 = 1;
            ...
            puVar5 = (undefined8 *)
                     Memory::realloc_static((void *)(*(long *)this + -0x10),uVar4 + 0x11,false);
            if (puVar5 == (undefined8 *)0x0) goto LAB_00118430;
            *puVar5 = 1;
          }
          puVar5 = puVar5 + 2;
          *(undefined8 **)this = puVar5;
...
undefined8
VariantParser::_parse_construct<float>(Stream *param_1,Vector *param_2,int *param_3,String *param_4)
...
LAB_001185bd:
        fVar8 = ::Variant::operator_cast_to_float((Variant *)&local_60);
        if (*(long *)(param_2 + 8) == 0) {
          lVar7 = 1;
        }
        else {
...
LAB_00118629:
        get_token(param_1,(Token *)local_68,param_3,param_4);
        if (local_68[0] != 0xc) goto LAB_001187f0;
        get_token(param_1,(Token *)local_68,param_3,param_4);
      } while( true );
    }
    goto LAB_001187c4;
  ...
  if (param_1 * 8 != 0) {
    ...
    if (uVar4 != 0xffffffffffffffff) {
      if (lVar7 < param_1) {
        if (uVar4 + 1 == lVar3) {
          puVar5 = *(undefined8 **)this;
          if (puVar5 == (undefined8 *)0x0) goto LAB_001189c9;
        }
        else {
          if (lVar7 == 0) {
            puVar5 = (undefined8 *)Memory::alloc_static(uVar4 + 0x11,false);
            ...
            *puVar5 = 1;
            ...
            puVar5 = (undefined8 *)
                     Memory::realloc_static((void *)(*(long *)this + -0x10),uVar4 + 0x11,false);
            if (puVar5 == (undefined8 *)0x0) goto LAB_00118ab0;
            *puVar5 = 1;
          }
          puVar5 = puVar5 + 2;
          *(undefined8 **)this = puVar5;
...
undefined8
VariantParser::_parse_construct<double>
          (Stream *param_1,Vector *param_2,int *param_3,String *param_4)
...
LAB_00118c3d:
        dVar8 = ::Variant::operator_cast_to_double((Variant *)&local_60);
        if (*(long *)(param_2 + 8) == 0) {
          lVar7 = 1;
        }
        else {
...
LAB_00118ca9:
        get_token(param_1,(Token *)local_68,param_3,param_4);
        if (local_68[0] != 0xc) goto LAB_00118e70;
        get_token(param_1,(Token *)local_68,param_3,param_4);
      } while( true );
    }
    goto LAB_00118e44;
...
LAB_001193e0:
  ...
  uVar6 = uVar6 | uVar6 >> 0x10;
  uVar6 = uVar6 | uVar6 >> 0x20;
  if (uVar6 == 0xffffffffffffffff) goto LAB_001193e0;
  if (param_1 <= lVar9) {
    puVar7 = *(undefined8 **)this;
    uVar8 = param_1;
...
LAB_00119269:
        if (uVar6 + 1 != lVar5) {
          ...
          if (puVar4 == (undefined8 *)0x0) goto LAB_0011940f;
          puVar7 = puVar4 + 2;
          *puVar4 = 1;
          *(undefined8 **)this = puVar7;
        }
      ...
      while( true ) {
        ...
        if (*plVar2 != 0) break;
        uVar8 = uVar8 + 1;
        if ((ulong)puVar7[-1] <= uVar8) goto LAB_00119269;
      }
      LOCK();
...
LAB_0011945d:
  ...
  if (uVar6 + 1 == lVar5) {
    puVar7 = *(undefined8 **)this;
    if (puVar7 == (undefined8 *)0x0) goto LAB_0011945d;
    lVar9 = puVar7[-1];
LAB_00119340:
    if (param_1 <= lVar9) goto LAB_001192f5;
  }
  else {
    if (lVar9 != 0) {
      puVar4 = (undefined8 *)

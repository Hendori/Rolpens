...
undefined8 Node3D::is_class(String *param_1)
...
LAB_0010879f:
    cVar6 = String::operator==(in_RSI,(StrRange *)&local_60);
    lVar4 = local_60;
    if (local_60 != 0) {
      LOCK();
  ...
  cVar6 = String::operator==(in_RSI,"Node3D");
  if (cVar6 == '\0') {
    for (lVar2 = *(long *)(param_1 + 8); lVar2 != 0; lVar2 = *(long *)(lVar2 + 8)) {
      lVar4 = *(long *)(lVar2 + 0x20);
      if (lVar4 == 0) {
...
LAB_0010892b:
    ...
    cVar6 = String::operator==(in_RSI,"Node");
    if (cVar6 == '\0') {
      for (lVar2 = *(long *)(param_1 + 8); lVar2 != 0; lVar2 = *(long *)(lVar2 + 8)) {
        lVar4 = *(long *)(lVar2 + 0x20);
        if (lVar4 == 0) {

...
/* icu_76_godot::ConstArray1D::~ConstArray1D() */

void __thiscall icu_76_godot::ConstArray1D::~ConstArray1D(ConstArray1D *this)
...
/* icu_76_godot::ConstArray2D::~ConstArray2D() */

void __thiscall icu_76_godot::ConstArray2D::~ConstArray2D(ConstArray2D *this)
...
/* icu_76_godot::CodePointsVectorizer::~CodePointsVectorizer() */

void __thiscall
icu_76_godot::CodePointsVectorizer::~CodePointsVectorizer(CodePointsVectorizer *this)
...
/* icu_76_godot::GraphemeClusterVectorizer::~GraphemeClusterVectorizer() */

void __thiscall
icu_76_godot::GraphemeClusterVectorizer::~GraphemeClusterVectorizer(GraphemeClusterVectorizer *this)
...
/* icu_76_godot::LSTMBreakEngine::name() const */

undefined8 __thiscall icu_76_godot::LSTMBreakEngine::name(LSTMBreakEngine *this)
...
/* icu_76_godot::Array1D::~Array1D() */

void __thiscall icu_76_godot::Array1D::~Array1D(Array1D *this)
...
/* icu_76_godot::Array2D::~Array2D() */

void __thiscall icu_76_godot::Array2D::~Array2D(Array2D *this)
...
/* icu_76_godot::LSTMBreakEngine::~LSTMBreakEngine() */

void __thiscall icu_76_godot::LSTMBreakEngine::~LSTMBreakEngine(LSTMBreakEngine *this)
...
/* icu_76_godot::CodePointsVectorizer::vectorize(UText*, int, int, icu_76_godot::UVector32&,
   icu_76_godot::UVector32&, UErrorCode&) const */

void __thiscall
icu_76_godot::CodePointsVectorizer::vectorize
          (CodePointsVectorizer *this,UText *param_1,int param_2,int param_3,UVector32 *param_4,
          UVector32 *param_5,UErrorCode *param_6)

{
  ...
  if ((int)uVar6 < 0) {
    ...
    if ((*(int *)(param_4 + 0xc) < (int)uVar6) &&
       (cVar2 = icu_76_godot::UVector32::expandCapacity(iVar7,(UErrorCode *)(ulong)uVar6),
       cVar2 == '\0')) goto LAB_00100211;
...
LAB_0010024c:
    if (*(int *)param_6 < 1) {
      ...
      local_44 = 0;
LAB_00100278:
      if ((*(int *)param_6 < 1) && (iVar4 = utext_getNativeIndex_76_godot(param_1), iVar4 < param_3)
         ) {
...
LAB_00100354:
          *(int *)(*(long *)(param_4 + 0x18) + (long)iVar1 * 4) = iVar4;
...
LAB_001002ff:
  ...
  if (cVar2 != '\0') {
    iVar4 = *(int *)(param_5 + 8);
LAB_00100316:
    *(undefined4 *)(*(long *)(param_5 + 0x18) + (long)iVar4 * 4) = uVar5;
...
/* icu_76_godot::ReadArray1D::~ReadArray1D() */

void __thiscall icu_76_godot::ReadArray1D::~ReadArray1D(ReadArray1D *this)
...
/* icu_76_godot::ReadArray2D::~ReadArray2D() */

void __thiscall icu_76_godot::ReadArray2D::~ReadArray2D(ReadArray2D *this)
...
/* icu_76_godot::LSTMData::LSTMData(UResourceBundle*, UErrorCode&) */

void __thiscall
icu_76_godot::LSTMData::LSTMData(LSTMData *this,UResourceBundle *param_1,UErrorCode *param_2)

{
  ...
  *(undefined ***)(this + 0x18) = &PTR__ConstArray2D_00102b30;
  *(undefined8 *)(this + 0x20) = 0;
  *(undefined8 *)(this + 0x28) = 0;
  *(undefined ***)(this + 0x30) = &PTR__ConstArray2D_00102b30;
  *(undefined8 *)(this + 0x38) = 0;
  *(undefined8 *)(this + 0x40) = 0;
  *(undefined ***)(this + 0x48) = &PTR__ConstArray2D_00102b30;
      ...
      if (*(int *)param_2 < 1) {
        ...
        *(undefined8 *)(this + 0x10) = uVar6;
        ...
        if (*(int *)param_2 < 1) {
          ...
          uVar6 = uhash_open_76_godot(&uhash_hashUChars_76_godot,&uhash_compareUChars_76_godot,0,
                                      param_2);
          *(undefined8 *)this = uVar6;
          ...
          ures_getValueWithFallback_76_godot
                    (param_1,&_LC7,local_c8,(ResourceDataValue *)&local_e8,param_2);
...
/* icu_76_godot::LSTMData::~LSTMData() */

void __thiscall icu_76_godot::LSTMData::~LSTMData(LSTMData *this)
...
/* icu_76_godot::Vectorizer::~Vectorizer() */

void __thiscall icu_76_godot::Vectorizer::~Vectorizer(Vectorizer *this)
...
/* icu_76_godot::compute(int, icu_76_godot::ReadArray2D const&, icu_76_godot::ReadArray2D const&,
   icu_76_godot::ReadArray1D const&, icu_76_godot::ReadArray1D const&, icu_76_godot::Array1D&,
   icu_76_godot::Array1D&, icu_76_godot::Array1D&) */

void icu_76_godot::compute
               (int param_1,ReadArray2D *param_2,ReadArray2D *param_3,ReadArray1D *param_4,
               ReadArray1D *param_5,Array1D *param_6,Array1D *param_7,Array1D *param_8)

{
  ...
  while( true ) {
    ...
    if (iVar3 <= (int)uVar7) break;
    for (iVar3 = 0; iVar4 = (**(code **)(*(long *)param_5 + 0x10))(), iVar3 < iVar4;
        iVar3 = iVar3 + 1) {
  ...
  while( true ) {
    ...
    for (iVar3 = 0; iVar4 = (**(code **)(*(long *)param_6 + 0x10))(), iVar3 < iVar4;
        iVar3 = iVar3 + 1) {
...
/* icu_76_godot::createVectorizer(icu_76_godot::LSTMData const*, UErrorCode&) */

undefined8 * icu_76_godot::createVectorizer(LSTMData *param_1,UErrorCode *param_2)
...
void __thiscall
icu_76_godot::LSTMBreakEngine::LSTMBreakEngine
          (LSTMBreakEngine *this,LSTMData *param_1,UnicodeSet *param_2,UErrorCode *param_3)
...
/* icu_76_godot::defaultLSTM(UScriptCode, UErrorCode&) */
...

{
  ...
  if (((uint)param_1 < 0x27) && ((0xffffffbfee7fffffU >> (param_1 & 0x3f) & 1) == 0)) {
    ...
    if (*(int *)param_2 < 1) {
      ...
      local_40 = 0;
      local_6c = 0;
      iVar1 = icu_76_godot::CharString::appendInvariantChars
                        ((UnicodeString *)&local_78,(UErrorCode *)aUStack_b8);
...
void __thiscall
icu_76_godot::GraphemeClusterVectorizer::vectorize
          (GraphemeClusterVectorizer *this,UText *param_1,int param_2,int param_3,UVector32 *param_4
          ,UVector32 *param_5,UErrorCode *param_6)
...
LAB_00101386:
    cVar2 = icu_76_godot::UVector32::expandCapacity(iVar8,(UErrorCode *)(ulong)uVar9);
    if (cVar2 == '\0') goto LAB_0010130d;
LAB_001013a4:
    if (0 < *(int *)param_6) goto LAB_0010130d;
  }
      ...
      do {
        do {
          ...
          if ((param_3 <= (int)uVar9) || (uVar9 == 0xffffffff)) {
            if ((*(int *)param_6 < 1) &&
               (((int)uVar6 < param_3 &&
                (utext_extract_76_godot(param_1,(long)(int)uVar6,(long)param_3,local_128,10,param_6)
                , *(int *)param_6 < 1)))) {
...
LAB_0010156c:
          *(uint *)(*(long *)(param_4 + 0x18) + (long)iVar1 * 4) = uVar6;
          *(int *)(param_4 + 8) = *(int *)(param_4 + 8) + 1;
        }
        local_129 = '\0';
...
LAB_00101585:
          *(undefined4 *)(*(long *)(param_5 + 0x18) + (long)iVar1 * 4) = uVar3;
          *(int *)(param_5 + 8) = *(int *)(param_5 + 8) + 1;
        }
      } while (*(int *)param_6 < 1);
    }
...
int __thiscall
icu_76_godot::LSTMBreakEngine::divideUpDictionaryRange
          (LSTMBreakEngine *this,undefined8 param_1,int param_2,int param_3,long param_4,
          undefined8 param_6,UErrorCode *param_7)
    ...
    if (lVar10 < param_3) {
      ...
      if ((*(int *)param_7 < 1) &&
         ((**(code **)(**(long **)(this + 0xd8) + 0x10))
                    (*(long **)(this + 0xd8),param_1,param_2,param_3,local_e8,local_c8,param_7),
         *(int *)param_7 < 1)) {
          ...
          if (-1 < iVar8) {
            ...
            do {
              ...
              if (iVar8 != (int)lVar10) {
                ...
                if (0 < iVar5) {
                  do {
                    *(undefined4 *)((long)pvVar17 + sVar13) =
                         *(undefined4 *)((long)__s + sVar13 + (long)iVar12 * 4);
                    sVar13 = sVar13 + 4;
                  } while (__n != sVar13);
                }
                uprv_free_76_godot(0);
              ...
              local_100 = *(long *)(lVar6 + 0x20) +
                          (long)(*(int *)(local_b0 + lVar1) * local_f8) * 4;
              compute(iVar5,(ReadArray2D *)(lVar6 + 0x78),(ReadArray2D *)(lVar6 + 0x90),
                      (ReadArray1D *)(lVar6 + 0xa8),(ReadArray1D *)&local_108,(Array1D *)&local_68,
                      (Array1D *)&local_88,(Array1D *)&local_a8);
              local_68 = &PTR__Array1D_00102b68;
...
LAB_00101bd0:
            ...
            local_108 = &PTR__ConstArray1D_00102b00;
            local_100 = *(long *)(lVar10 + 0x20) +
                        (long)(*(int *)(local_b0 + local_1a0 * 4) * local_f8) * 4;
            compute(iVar5,(ReadArray2D *)(lVar10 + 0x30),(ReadArray2D *)(lVar10 + 0x48),
                    (ReadArray1D *)(lVar10 + 0x60),(ReadArray1D *)&local_108,(Array1D *)&local_68,
                    (Array1D *)&local_88,(Array1D *)&local_a8);
            if (0 < iVar5) {
            ...
            lVar10 = *(long *)(this + 0xd0);
            do {
              uVar19 = (**(code **)(*(long *)(lVar10 + 0xd8) + 0x18))
                                 (lVar10 + 0xd8,uVar14 & 0xffffffff);
...
LAB_00101e7d:
    *(undefined4 *)(*(long *)(param_4 + 0x18) + (long)iVar8 * 4) = uVar19;
    *(int *)(param_4 + 8) = *(int *)(param_4 + 8) + 1;
  }
  if (0 < *(int *)param_7) {
    iVar9 = 0;
...
CreateLSTMBreakEngine_76_godot(int param_1,LSTMData *param_2,UErrorCode *param_3)

{
  ...
  this = (DictionaryBreakEngine *)
         icu_76_godot::UMemory::operator_new((UMemory *)0xe0,(ulong)ppcVar4);
...
LAB_001020d4:
  icu_76_godot::UnicodeSet::~UnicodeSet((UnicodeSet *)&local_f8);
LAB_001020dc:
  icu_76_godot::UnicodeString::~UnicodeString((UnicodeString *)&local_138);
  if (local_30 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
  }
...
/* icu_76_godot::ConstArray1D::d1() const */

undefined4 __thiscall icu_76_godot::ConstArray1D::d1(ConstArray1D *this)
...
/* icu_76_godot::ConstArray1D::get(int) const */

undefined4 __thiscall icu_76_godot::ConstArray1D::get(ConstArray1D *this,int param_1)
...
/* icu_76_godot::ConstArray2D::d1() const */

undefined4 __thiscall icu_76_godot::ConstArray2D::d1(ConstArray2D *this)
...
/* icu_76_godot::ConstArray2D::d2() const */

undefined4 __thiscall icu_76_godot::ConstArray2D::d2(ConstArray2D *this)
...
/* icu_76_godot::ConstArray2D::get(int, int) const */

undefined4 __thiscall icu_76_godot::ConstArray2D::get(ConstArray2D *this,int param_1,int param_2)

{
  return *(undefined4 *)
          (*(long *)(this + 8) + (long)(param_1 * *(int *)(this + 0x14) + param_2) * 4);
}



/* icu_76_godot::Array1D::d1() const */

undefined4 __thiscall icu_76_godot::Array1D::d1(Array1D *this)
...
/* icu_76_godot::Array1D::get(int) const */

undefined4 __thiscall icu_76_godot::Array1D::get(Array1D *this,int param_1)
...
/* icu_76_godot::Array2D::d1() const */

undefined4 __thiscall icu_76_godot::Array2D::d1(Array2D *this)
...
/* icu_76_godot::Array2D::d2() const */

undefined4 __thiscall icu_76_godot::Array2D::d2(Array2D *this)
...
/* icu_76_godot::Array2D::get(int, int) const */

undefined4 __thiscall icu_76_godot::Array2D::get(Array2D *this,int param_1,int param_2)

{
  return *(undefined4 *)
          (*(long *)(this + 0x10) + (long)(param_1 * *(int *)(this + 0x1c) + param_2) * 4);
}
...
/* icu_76_godot::UVector32::addElement(int, UErrorCode&) */

void icu_76_godot::UVector32::addElement(int param_1,UErrorCode *param_2)
...
/* icu_76_godot::createVectorizer(icu_76_godot::LSTMData const*, UErrorCode&) [clone .cold] */

void icu_76_godot::createVectorizer(LSTMData *param_1,UErrorCode *param_2)

...
/* jpgd::jpeg_decoder_mem_stream::read(unsigned char*, int, bool*) */
...
/* jpgd::jpeg_decoder_file_stream::read(unsigned char*, int, bool*) */
...
/* jpgd::jpeg_decoder_file_stream::~jpeg_decoder_file_stream() */

void __thiscall
jpgd::jpeg_decoder_file_stream::~jpeg_decoder_file_stream(jpeg_decoder_file_stream *this)

{
  *(undefined ***)this = &PTR__jpeg_decoder_file_stream_0010cbf0;
  if (*(FILE **)(this + 8) != (FILE *)0x0) {
    fclose(*(FILE **)(this + 8));
    return;
  }
...
/* jpgd::idctSSEShortU8(short const*, unsigned char*) */

void jpgd::idctSSEShortU8(short *param_1,uchar *param_2)
...
/* jpgd::jpeg_decoder::free_all_blocks() */
...
/* jpgd::jpeg_decoder::stop_decoding(jpgd::jpgd_status) */

void __thiscall jpgd::jpeg_decoder::stop_decoding(jpeg_decoder *this,undefined4 param_2)
...
/* jpgd::jpeg_decoder::alloc(unsigned long, bool) */

undefined8 * __thiscall jpgd::jpeg_decoder::alloc(jpeg_decoder *this,ulong param_1,bool param_2)
...
/* jpgd::jpeg_decoder::alloc_aligned(unsigned long, unsigned int, bool) */

ulong __thiscall
jpgd::jpeg_decoder::alloc_aligned(jpeg_decoder *this,ulong param_1,uint param_2,bool param_3)
...
/* jpgd::jpeg_decoder::word_clear(void*, unsigned short, unsigned int) */

void __thiscall
jpgd::jpeg_decoder::word_clear(jpeg_decoder *this,void *param_1,ushort param_2,uint param_3)
...
/* jpgd::jpeg_decoder::prep_in_buffer() */
...

{
  ...
  *(jpeg_decoder **)(this + 0x338) = this + 0x388;
  if (this[0x34d1] == (jpeg_decoder)0x0) {
    iVar4 = 0;
    do {
      iVar4 = (**(code **)(**(long **)(this + 0xe0) + 0x10))
                        (*(long **)(this + 0xe0),this + 0x388 + iVar4,0x2000 - iVar4,this + 0x34d1);
      if (iVar4 == -1) {
                    /* WARNING: Subroutine does not return */
    ...
    *(int *)(this + 0x34cc) = *(int *)(this + 0x34cc) + iVar4;
    uVar3 = _UNK_0010cc38;
    uVar2 = __LC0;
    puVar5 = (undefined8 *)((long)iVar4 + *(long *)(this + 0x338));
    puVar1 = puVar5 + 0x10;
    do {
      *puVar5 = uVar2;
      puVar5[1] = uVar3;
...
/* jpgd::jpeg_decoder::decode_block_dc_first(jpgd::jpeg_decoder*, int, int, int) */

void jpgd::jpeg_decoder::decode_block_dc_first
               (jpeg_decoder *param_1,int param_2,int param_3,int param_4)

{
  ...
  if ((param_3 < (int)lVar5) && (param_4 < *(int *)((long)plVar2 + 0xc))) {
    ...
    if (lVar3 != 0) {
      ...
      *(short *)((long)((int)lVar5 * (int)lVar6 * param_4) + (long)(param_3 * (int)lVar6) + lVar4) =
           (short)(iVar8 + iVar1 << ((byte)*(undefined4 *)(param_1 + 0x23c) & 0x1f));
      return;
    }
  }
LAB_00100b05:
...
/* jpgd::jpeg_decoder::decode_block_dc_refine(jpgd::jpeg_decoder*, int, int, int) */
...
/* jpgd::jpeg_decoder::decode_block_ac_first(jpgd::jpeg_decoder*, int, int, int) */
...
LAB_00100d55:
    ...
    if (iVar8 <= *(int *)(param_1 + 0x238)) {
      do {
        if ((7 < *(uint *)(param_1 + ((long)param_2 + 0x88) * 4 + 4)) ||
           (lVar3 = *(long *)(param_1 +
                             (ulong)*(uint *)(param_1 + ((long)param_2 + 0x88) * 4 + 4) * 8 + 0x2a0)
           , lVar3 == 0)) goto LAB_00100d55;
        ...
        if (uVar6 == 0) {
          ...
          *(short *)(lVar2 + (long)*(int *)(g_ZAG + (long)iVar8 * 4) * 2 +
                    (long)(param_3 * (int)lVar5) + (long)((int)lVar4 * (int)lVar5 * param_4)) =
               (short)(iVar7 << ((byte)*(undefined4 *)(param_1 + 0x23c) & 0x1f));
        }
        iVar8 = iVar8 + 1;
...
/* jpgd::jpeg_decoder::decode_block_ac_refine(jpgd::jpeg_decoder*, int, int, int) */
...

{
  ...
  if ((param_3 < (int)plVar7[1]) && (param_4 < *(int *)((long)plVar7 + 0xc))) {
    lVar20 = (long)((int)plVar7[1] * (int)plVar7[3] * param_4) + (long)(param_3 * (int)plVar7[3]) +
             *plVar7;
    if (*(int *)(param_1 + 0x238) < 0x40) {
      ...
      if (iVar14 == 0) {
        ...
        do {
          if ((7 < *(uint *)(param_1 + (long)param_2 * 4 + 0x224)) ||
             (lVar8 = *(long *)(param_1 +
                               (ulong)*(uint *)(param_1 + (long)param_2 * 4 + 0x224) * 8 + 0x2a0),
             lVar8 == 0)) goto LAB_001014d4;
...
LAB_00101240:
                  iVar14 = *(int *)(param_1 + 0x2448);
                  uVar17 = *(uint *)(param_1 + 0x244c) | uVar15 | uVar17;
                }
                else {
                  pbVar9 = *(byte **)(param_1 + 0x338);
                  bVar2 = *pbVar9;
                  if ((bVar2 == 0xff) || (bVar3 = pbVar9[1], bVar3 == 0xff)) {
                    pbVar16 = pbVar9 + 1;
                    iVar18 = iVar18 + -1;
                    *(byte **)(param_1 + 0x338) = pbVar16;
                    bVar2 = *pbVar9;
...
LAB_0010100d:
      if (0 < iVar14) {
LAB_00101015:
        if ((int)uVar17 <= *(int *)(param_1 + 0x238)) {
          do {
            while (((psVar1 = (short *)(lVar20 + (long)*(int *)(g_ZAG + (ulong)(uVar17 & 0x3f) * 4)
                                                 * 2), *psVar1 != 0 &&
                    (iVar14 = get_bits_no_markers(param_1,1), iVar14 != 0)) &&
                   (sVar4 = *psVar1, ((int)sVar4 & uVar11) == 0))) {
              sVar10 = local_48;
              if (-1 < sVar4) {
                sVar10 = (short)uVar11;
              }
...
/* jpgd::jpeg_decoder::read_dht_marker() */
...
LAB_00101bef:
  ...
  *(int *)(this + 0x2448) = iVar6;
  *(uint *)(this + 0x244c) =
       (uVar18 | uVar13 | *(uint *)(this + 0x244c) & 0xffff0000) << (-(char)iVar8 & 0x1fU);
LAB_0010154a:
  if (uVar15 >> 0x10 < 2) {
LAB_00101ca6:
                    /* WARNING: Subroutine does not return */
...
LAB_00101aa3:
  ...
  uVar13 = (*(uint *)(this + 0x244c) & 0xffff0000 | uVar18 | uVar13) <<
           (-(char)*(int *)(this + 0x2448) & 0x1fU);
...
LAB_0010163c:
      ...
      *(uint *)(this + 0x244c) =
           (*(uint *)(this + 0x244c) & 0xffff0000 | uVar17 | uVar18) << (-(char)iVar8 & 0x1fU);
    }
    else {
      *(undefined1 *)puVar19 = uVar14;
...
LAB_00101759:
        ...
        *(int *)(this + 0x2448) = iVar8;
        *(uint *)(this + 0x244c) =
             (*(uint *)(this + 0x244c) & 0xffff0000 | uVar10 | uVar17) << (-(char)iVar7 & 0x1fU);
  ...
  *puVar1 = local_148[0];
  puVar1[1] = local_148[1];
  puVar1[2] = local_148[2];
  puVar1[3] = local_148[3];
  puVar1[4] = local_128;
  puVar1[5] = uStack_120;
  puVar1[6] = local_118;
  puVar1[7] = uStack_110;
...
/* jpgd::jpeg_decoder::read_dqt_marker() */
...
LAB_001021c7:
  ...
  *(int *)(this + 0x2448) = iVar4;
  *(uint *)(this + 0x244c) =
       (uVar12 | uVar9 | *(uint *)(this + 0x244c) & 0xffff0000) << (-(char)iVar5 & 0x1fU);
LAB_00101d12:
  if (uVar11 >> 0x10 < 2) {
                    /* WARNING: Subroutine does not return */
...
LAB_001020ad:
      ...
      *(int *)(this + 0x2448) = iVar5;
      *(uint *)(this + 0x244c) =
           (*(uint *)(this + 0x244c) & 0xffff0000 | uVar8 | uVar9) << (-(char)iVar4 & 0x1fU);
    }
    else {
...
LAB_00101ed1:
          ...
          *(int *)(this + 0x2448) = iVar5;
          *(uint *)(this + 0x244c) =
               (*(uint *)(this + 0x244c) & 0xffff0000 | uVar8 | uVar9) << (-(char)iVar6 & 0x1fU);
        }
        else {
          *(int *)(this + 0x244c) = iVar4 << 8;
          iVar5 = iVar6;
...
/* jpgd::jpeg_decoder::read_sof_marker() */
...
LAB_0010295a:
    ...
    uVar3 = (*(uint *)(this + 0x244c) & 0xffff0000 | uVar8 | uVar3) <<
            (-(char)*(int *)(this + 0x2448) & 0x1fU);
  }
...
LAB_00102b5f:
    ...
    *(uint *)(this + 0x244c) =
         (*(uint *)(this + 0x244c) & 0xffff0000 | uVar11 | uVar8) << (-(char)iVar10 & 0x1fU);
  }
  else {
...
LAB_00102a59:
    ...
    *(int *)(this + 0x2448) = iVar10;
    *(uint *)(this + 0x244c) =
         (*(uint *)(this + 0x244c) & 0xffff0000 | uVar11 | uVar8) << (-(char)iVar5 & 0x1fU);
  }
  else {
    *(uint *)(this + 0x244c) = uVar3 << 0x10;
  }
...
LAB_001029d3:
  ...
  *(int *)(this + 0x2448) = iVar5;
  *(uint *)(this + 0x244c) =
       (*(uint *)(this + 0x244c) & 0xffff0000 | uVar6 | uVar11) << (-(char)iVar10 & 0x1fU);
LAB_001023b5:
...
LAB_00102517:
      ...
      iVar5 = *(int *)(this + 0x2448) + 0x10;
      uVar4 = (*(uint *)(this + 0x244c) & 0xffff0000 | uVar8 | uVar4) <<
              (-(char)*(int *)(this + 0x2448) & 0x1fU);
    }
...
LAB_00102613:
      ...
      *(int *)(this + 0x2448) = iVar10 + 0x10;
      *(uint *)(this + 0x244c) =
           (*(uint *)(this + 0x244c) & 0xffff0000 | uVar8 | uVar3) << (-(char)iVar10 & 0x1fU);
    }
    else {
      *(uint *)(this + 0x244c) = uVar4 << 4;
    }
    *(uint *)(this + lVar9 * 4 + 0x1b0) = uVar4 >> 0x1c;
    if ((*(int *)(this + lVar9 * 4 + 0x1a0) == 0 || 2 < *(int *)(this + lVar9 * 4 + 0x1a0)) ||
       (1 < (uVar4 >> 0x1c) - 1)) {
                    /* WARNING: Subroutine does not return */
...
/* jpgd::jpeg_decoder::skip_variable_marker() */
...
LAB_00103049:
  ...
  *(int *)(this + 0x2448) = iVar3;
  *(uint *)(this + 0x244c) =
       (*(uint *)(this + 0x244c) & 0xffff0000 | uVar6 | uVar5) << (-(char)iVar8 & 0x1fU);
LAB_00102eb8:
  if (uVar9 >> 0x10 < 2) {
                    /* WARNING: Subroutine does not return */
...
LAB_00102f34:
      ...
      *(int *)(this + 0x2448) = iVar3;
      *(uint *)(this + 0x244c) =
           (*(uint *)(this + 0x244c) & 0xffff0000 | uVar5 | uVar9) << (-(char)iVar4 & 0x1fU);
      iVar8 = iVar8 + -1;
      if (iVar8 == 0) {
        return;
      }
...
/* jpgd::jpeg_decoder::read_dri_marker() */

void __thiscall jpgd::jpeg_decoder::read_dri_marker(jpeg_decoder *this)
...
LAB_001031d1:
    ...
    *(int *)(this + 0x2448) = iVar4;
    *(uint *)(this + 0x244c) =
         (*(uint *)(this + 0x244c) & 0xffff0000 | uVar6 | uVar8) << (-(char)iVar5 & 0x1fU);
  }
  else {
...
/* jpgd::jpeg_decoder::read_sos_marker() */
...
LAB_0010399b:
      *(byte **)(this + 0x338) = pbVar8 + 1;
      uVar12 = (uint)*pbVar8;
      *(int *)(this + 0x340) = iVar6 + -1;
    }
    iVar6 = *(int *)(this + 0x2448) + 0x10;
    uVar3 = (*(uint *)(this + 0x244c) & 0xffff0000 | uVar12 | uVar3) <<
            (-(char)*(int *)(this + 0x2448) & 0x1fU);
  }
...
LAB_00103a14:
    ...
    *(int *)(this + 0x2448) = iVar10 + 0x10;
    *(uint *)(this + 0x244c) =
         (*(uint *)(this + 0x244c) & 0xffff0000 | uVar13 | uVar3) << (-(char)iVar10 & 0x1fU);
  }
  else {
    *(uint *)(this + 0x244c) = uVar3 << 8;
  }
...
LAB_00103619:
      ...
      iVar6 = *(int *)(this + 0x2448) + 0x10;
      uVar3 = (*(uint *)(this + 0x244c) & 0xffff0000 | uVar13 | uVar3) <<
              (-(char)*(int *)(this + 0x2448) & 0x1fU);
    }
    *(int *)(this + 0x2448) = iVar6 + -8;
    uVar13 = uVar3 >> 0x18;
...
LAB_00103571:
      ...
      *(uint *)(this + 0x244c) =
           (*(uint *)(this + 0x244c) & 0xffff0000 | uVar5 | uVar3) << (-(char)iVar10 & 0x1fU);
    }
    else {
      iVar6 = *(int *)(this + 0x19c);
      *(uint *)(this + 0x244c) = uVar3 << 8;
...
LAB_00103b9f:
    ...
    iVar6 = *(int *)(this + 0x2448) + 0x10;
    uVar7 = (*(uint *)(this + 0x244c) & 0xffff0000 | uVar12 | uVar7) <<
            (-(char)*(int *)(this + 0x2448) & 0x1fU);
  }
...
LAB_00103a9b:
  ...
  *(int *)(this + 0x2448) = iVar10 + 0x10;
  *(uint *)(this + 0x244c) =
       (uVar12 | uVar7 | *(uint *)(this + 0x244c) & 0xffff0000) << (-(char)iVar10 & 0x1fU);
LAB_001037e3:
  *(uint *)(this + 0x23c) = uVar3 >> 0x1c;
  if (*(int *)(this + 0xe8) == 0) {
...
LAB_00103877:
        ...
        *(int *)(this + 0x2448) = iVar10;
        *(uint *)(this + 0x244c) =
             (*(uint *)(this + 0x244c) & 0xffff0000 | uVar3 | uVar7) << (-(char)iVar6 & 0x1fU);
        iVar11 = iVar11 + -1;
        if (iVar11 == 0) {
          return;
        }
...
/* jpgd::jpeg_decoder::next_marker() */

uint __thiscall jpgd::jpeg_decoder::next_marker(jpeg_decoder *this)
...
LAB_00104121:
      ...
      uVar3 = (*(uint *)(this + 0x244c) & 0xffff0000 | uVar5 | uVar3) <<
              (-(char)*(int *)(this + 0x2448) & 0x1fU);
      iVar6 = *(int *)(this + 0x2448) + 0x10;
...
LAB_00104024:
      ...
      *(int *)(this + 0x2448) = iVar4 + 0x10;
      *(uint *)(this + 0x244c) =
           (*(uint *)(this + 0x244c) & 0xffff0000 | uVar5 | uVar3) << (-(char)iVar4 & 0x1fU);
    }
    else {
      *(uint *)(this + 0x244c) = uVar3 << 8;
    }
...
/* jpgd::jpeg_decoder::process_markers() */

uint __thiscall jpgd::jpeg_decoder::process_markers(jpeg_decoder *this)
...
LAB_001042e7:
          ...
          *(int *)(this + 0x2448) = iVar4 + 0x10;
          *(uint *)(this + 0x244c) =
               (*(uint *)(this + 0x244c) & 0xffff0000 | uVar7 | uVar8) << (-(char)iVar4 & 0x1fU);
        }
        else {
          *(uint *)(this + 0x244c) = uVar3 << 8;
        }
...
LAB_001047be:
        ...
        *(int *)(this + 0x2448) = iVar9;
        *(uint *)(this + 0x244c) =
             (*(uint *)(this + 0x244c) & 0xffff0000 | uVar8 | uVar11) << (-(char)iVar4 & 0x1fU);
      }
      else {
        *(uint *)(this + 0x244c) = uVar3 << 0x10;
      }
...
LAB_001048c4:
      ...
      uVar3 = (*(uint *)(this + 0x244c) & 0xffff0000 | uVar7 | uVar3) <<
              (-(char)*(int *)(this + 0x2448) & 0x1fU);
      iVar4 = *(int *)(this + 0x2448) + 0x10;
LAB_001045b0:
      *(uint *)(this + 0x2450) = uVar11 >> 0x10;
      goto LAB_00104244;
    }
  }
  iVar9 = *(int *)(this + 0x2448);
...
LAB_00104844:
  ...
  *(int *)(this + 0x2448) = iVar4;
  *(uint *)(this + 0x244c) =
       (*(uint *)(this + 0x244c) & 0xffff0000 | uVar8 | uVar3) << (-(char)iVar9 & 0x1fU);
LAB_0010461b:
  if (uVar11 >> 0x10 < 2) {
                    /* WARNING: Subroutine does not return */
    stop_decoding(this,0xffffff0a);
...
LAB_001046a2:
      ...
      uVar3 = (*(uint *)(this + 0x244c) & 0xffff0000 | uVar11 | uVar3) <<
              (-(char)*(int *)(this + 0x2448) & 0x1fU);
      iVar10 = *(int *)(this + 0x2448) + 0x10;
      *(uint *)(this + 0x244c) = uVar3;
      *(int *)(this + 0x2448) = iVar10;
...
/* jpgd::jpeg_decoder::locate_soi_marker() */
...
LAB_00104d84:
    ...
    uVar3 = (*(uint *)(this + 0x244c) & 0xffff0000 | uVar10 | uVar3) <<
            (-(char)*(int *)(this + 0x2448) & 0x1fU);
  }
...
LAB_00104d06:
  ...
  *(int *)(this + 0x2448) = iVar5 + 0x10;
  *(uint *)(this + 0x244c) =
       (*(uint *)(this + 0x244c) & 0xffff0000 | uVar6 | uVar10) << (-(char)iVar5 & 0x1fU);
LAB_00104b07:
...
LAB_00104bd5:
      ...
      *(int *)(this + 0x2448) = iVar5;
      *(uint *)(this + 0x244c) =
           (*(uint *)(this + 0x244c) & 0xffff0000 | uVar6 | uVar3) << (-(char)iVar4 & 0x1fU);
    }
    else {
      *(uint *)(this + 0x244c) = uVar3 << 8;
      iVar5 = iVar4;
...
/* jpgd::jpeg_decoder::locate_sof_marker() */
...
/* jpgd::jpeg_decoder::locate_sos_marker() */

undefined8 __thiscall jpgd::jpeg_decoder::locate_sos_marker(jpeg_decoder *this)
...
/* jpgd::jpeg_decoder::init(jpgd::jpeg_decoder_stream*, unsigned int) */

void __thiscall
jpgd::jpeg_decoder::init(jpeg_decoder *this,jpeg_decoder_stream *param_1,uint param_2)
...
LAB_001051eb:
  ...
  iVar5 = (*(uint *)(this + 0x244c) & 0xffff0000 | uVar7 | uVar9) << (-cVar3 & 0x1fU);
...
LAB_0010529a:
  ...
  *(int *)(this + 0x2448) = iVar5 + 0x10;
  *(uint *)(this + 0x244c) =
       (*(uint *)(this + 0x244c) & 0xffff0000 | uVar7 | uVar9) << (-(char)iVar5 & 0x1fU);
LAB_00105228:
  uVar4 = _LC2;
  pjVar6 = this + 0x2480;
  do {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* jpgd::jpeg_decoder::create_look_ups() */
...

{
  ...
  iVar12 = _UNK_0010cc7c;
  iVar11 = _UNK_0010cc78;
  iVar10 = _UNK_0010cc74;
  iVar9 = __LC9;
  iVar8 = _UNK_0010cc6c;
  iVar7 = _UNK_0010cc68;
  iVar6 = _UNK_0010cc64;
  ...
  pjVar13 = this + 0x24b8;
  iVar19 = __LC6;
  iVar20 = _UNK_0010cc44;
  iVar21 = _UNK_0010cc48;
  iVar22 = _UNK_0010cc4c;
  do {
...
/* jpgd::jpeg_decoder::fix_in_buffer() */
...
/* jpgd::jpeg_decoder::process_restart() */
...

{
  ...
  pbVar11 = (byte *)((long)((*(int *)(this + 0x248) - *(int *)(this + 0x288)) * 8) +
                    *(long *)(this + 0x24a8));
  if (0 < iVar4) {
    ...
    do {
      ...
      do {
        ...
        *puVar7 = (char)uVar6;
        uVar6 = (*(int *)(this + (ulong)bVar3 * 4 + 0x30b8) +
                 *(int *)(this + (ulong)bVar1 * 4 + 0x2cb8) >> 0x10) + (uint)bVar2;
        if (0xff < uVar6) {
          uVar6 = (int)~uVar6 >> 0x1f & 0xff;
        }
        puVar7[1] = (char)uVar6;
    ...
    do {
      ...
      do {
        ...
        do {
          ...
          iVar6 = *(int *)(this + (ulong)*(byte *)(lVar15 + lVar13) * 4 + 0x30b8) +
                  *(int *)(this + uVar12 * 4 + 0x2cb8) >> 0x10;
          uVar18 = iVar3 + uVar8;
          if (0xff < uVar18) {
...
/* jpgd::jpeg_decoder::H2V1ConvertFiltered() */
...

{
  ...
  do {
    ...
    uVar10 = (uint)*(byte *)(lVar13 + (int)((uVar6 & 7) + iVar11 + ((int)uVar6 >> 4) * 0x100 +
                                           (uVar6 * 8 & 0x40)));
    uVar3 = (int)(uVar6 - 1) >> 1;
    uVar7 = uVar3 + 1;
    ...
    uVar3 = (*(int *)(this + lVar14 * 4 + 0x2cb8) + *(int *)(this + lVar13 * 4 + 0x30b8) >> 0x10) +
            uVar10;
    *puVar9 = (char)uVar7;
    if (0xff < uVar3) {
  ...
  if (0 < (int)*(uint *)(this + 0x245c)) {
    ...
    do {
      ...
      do {
        ...
        iVar6 = *(int *)(this + (ulong)*(byte *)(lVar13 + lVar5) * 4 + 0x30b8) +
                *(int *)(this + uVar9 * 4 + 0x2cb8) >> 0x10;
        uVar4 = iVar2 + uVar8;
        if (0xff < uVar4) {
...
/* jpgd::jpeg_decoder::H1V2ConvertFiltered() */
...

{
  ...
  lVar9 = lVar14;
  local_38 = lVar14;
  if ((((-1 < (int)uVar2) && (1 < *(int *)(this + 0x284))) && ((0x8001UL >> (uVar7 & 0xf) & 1) != 0)
      ) && (lVar9 = *(long *)(this + 0x24b0), (uVar7 & 0xf) == 0xf)) {
    local_38 = lVar9;
  }
  if (0 < *(int *)(this + 0xd8)) {
    uVar11 = 0;
    ...
    while( true ) {
      ...
      lVar13 = (long)((int)((uint)*(byte *)(lVar9 + iVar6) * iVar15 + 2 +
                           *(byte *)(lVar14 + iVar3) * uVar8) >> 2);
      lVar14 = (long)((int)((uint)*(byte *)(lVar9 + (iVar6 + 0x40)) * iVar15 + 2 +
                           *(byte *)(lVar14 + (iVar3 + 0x40)) * uVar8) >> 2);
      iVar3 = *(int *)(this + lVar13 * 4 + 0x28b8);
      uVar12 = *(int *)(this + lVar14 * 4 + 0x24b8) + (uint)bVar1;
      if (0xff < uVar12) {
        uVar12 = (int)~uVar12 >> 0x1f & 0xff;
      }
      uVar4 = (*(int *)(this + lVar13 * 4 + 0x30b8) + *(int *)(this + lVar14 * 4 + 0x2cb8) >> 0x10)
              + (uint)bVar1;
      *puVar10 = (char)uVar12;
      if (0xff < uVar4) {
        uVar4 = (int)~uVar4 >> 0x1f & 0xff;
    ...
    do {
      ...
      do {
        ...
        do {
          ...
          iVar7 = *(int *)(this + (ulong)*(byte *)(lVar9 + lVar16) * 4 + 0x30b8) +
                  *(int *)(this + uVar15 * 4 + 0x2cb8) >> 0x10;
          uVar4 = iVar2 + uVar14;
          if (0xff < uVar4) {
            uVar4 = (int)~uVar4 >> 0x1f & 0xff;
          }
...
/* jpgd::jpeg_decoder::H2V2ConvertFiltered() */

undefined8 __thiscall jpgd::jpeg_decoder::H2V2ConvertFiltered(jpeg_decoder *this)

{
  ...
  lVar31 = lVar21;
  local_68 = lVar21;
  if ((((-1 < (int)uVar9) && ((0x8001UL >> uVar13 & 1) != 0)) && (1 < *(int *)(this + 0x284))) &&
     (lVar31 = *(long *)(this + 0x24b0), uVar13 == 0xf)) {
    local_68 = lVar31;
  }
...
LAB_0010654a:
      ...
      while( true ) {
        ...
        lVar16 = (long)((int)(uVar23 * (byte)H2V2ConvertFiltered()::s_muls[lVar21 + 2] +
                              uVar27 * (byte)H2V2ConvertFiltered()::s_muls[lVar21 + 1] +
                              uVar32 * (byte)H2V2ConvertFiltered()::s_muls[(lVar8 + uVar17) * 4] + 8
                             + (uint)(byte)H2V2ConvertFiltered()::s_muls[lVar21 + 3] * (uint)bVar5)
                       >> 4);
        iVar11 = *(int *)(this + lVar16 * 4 + 0x28b8);
        lVar21 = (long)((int)((byte)H2V2ConvertFiltered()::s_muls[lVar21 + 2] * uVar30 +
                              (byte)H2V2ConvertFiltered()::s_muls[lVar21 + 1] * uVar25 +
                              (byte)H2V2ConvertFiltered()::s_muls[(lVar8 + uVar17) * 4] * uVar26 + 8
                             + (byte)H2V2ConvertFiltered()::s_muls[lVar21 + 3] * uVar9) >> 4);
        uVar13 = *(int *)(this + lVar21 * 4 + 0x24b8) + (uint)bVar3;
        if (0xff < uVar13) {
          uVar13 = (int)~uVar13 >> 0x1f & 0xff;
        }
        uVar20 = (*(int *)(this + lVar16 * 4 + 0x30b8) + *(int *)(this + lVar21 * 4 + 0x2cb8) >>
                 0x10) + (uint)bVar3;
        *puVar29 = (char)uVar13;
        if (0xff < uVar20) {
        ...
        lVar16 = uVar17 + lVar2;
        lVar21 = lVar16 * 4;
        lVar24 = (long)((int)(uVar23 * (byte)H2V2ConvertFiltered()::s_muls[lVar21 + 2] +
                              uVar27 * (byte)H2V2ConvertFiltered()::s_muls[lVar21 + 1] +
                              uVar32 * (byte)H2V2ConvertFiltered()::s_muls[lVar16 * 4] + 8 +
                             (uint)(byte)H2V2ConvertFiltered()::s_muls[lVar21 + 3] * (uint)bVar5) >>
                       4);
        iVar11 = *(int *)(this + lVar24 * 4 + 0x28b8);
        lVar21 = (long)((int)((byte)H2V2ConvertFiltered()::s_muls[lVar21 + 2] * uVar30 +
                              (byte)H2V2ConvertFiltered()::s_muls[lVar21 + 1] * uVar25 +
                              (byte)H2V2ConvertFiltered()::s_muls[lVar16 * 4] * uVar26 + 8 +
                             (byte)H2V2ConvertFiltered()::s_muls[lVar21 + 3] * uVar9) >> 4);
        uVar13 = *(int *)(this + lVar21 * 4 + 0x24b8) + (uint)bVar4;
        if (0xff < uVar13) {
          uVar13 = (int)~uVar13 >> 0x1f & 0xff;
        }
        uVar20 = (*(int *)(this + lVar24 * 4 + 0x30b8) + *(int *)(this + lVar21 * 4 + 0x2cb8) >>
                 0x10) + (uint)bVar4;
        *puVar19 = (char)uVar13;
        if (0xff < uVar20) {
          uVar20 = (int)~uVar20 >> 0x1f & 0xff;
        ...
        if (((uVar22 & 1) != 0) && ((int)uVar22 < iVar11 + -1)) {
          ...
          lVar24 = (long)((int)(uVar23 * (byte)H2V2ConvertFiltered()::s_muls[lVar21 + 2] +
                                uVar27 * (byte)H2V2ConvertFiltered()::s_muls[lVar21 + 1] +
                                uVar32 * (byte)H2V2ConvertFiltered()::s_muls[lVar16 * 4] + 8 +
                               (uint)bVar5 * (uint)(byte)H2V2ConvertFiltered()::s_muls[lVar21 + 3])
                         >> 4);
          iVar11 = *(int *)(this + lVar24 * 4 + 0x28b8);
          lVar21 = (long)((int)((byte)H2V2ConvertFiltered()::s_muls[lVar16 * 4] * uVar26 +
                                (byte)H2V2ConvertFiltered()::s_muls[lVar21 + 1] * uVar25 +
                                (byte)H2V2ConvertFiltered()::s_muls[lVar21 + 2] * uVar30 + 8 +
                               (byte)H2V2ConvertFiltered()::s_muls[lVar21 + 3] * uVar9) >> 4);
          uVar13 = *(int *)(this + lVar21 * 4 + 0x24b8) + (uint)bVar4;
          if (0xff < uVar13) {
            uVar13 = (int)~uVar13 >> 0x1f & 0xff;
          }
          uVar25 = (*(int *)(this + lVar24 * 4 + 0x30b8) + *(int *)(this + lVar21 * 4 + 0x2cb8) >>
                   0x10) + (uint)bVar4;
  ...
  while( true ) {
    bVar3 = *(byte *)(local_68 +
                     (int)(((int)uVar22 >> 4) * 0x180 + (uVar22 & 7) + iVar18 + (uVar22 * 8 & 0x40))
                     );
    uVar25 = (int)(uVar22 - 1) >> 1;
    uVar13 = uVar25 + 1;
    if ((int)local_58 < (int)(uVar25 + 1)) {
    ...
    lVar16 = (long)((int)((uint)*(byte *)(lVar31 + iVar11) *
                          (uint)(byte)H2V2ConvertFiltered()::s_muls
                                      [((ulong)(uVar22 & 1) + lVar8) * 4] +
                          (uint)*(byte *)(lVar21 + iVar10) *
                          (uint)(byte)H2V2ConvertFiltered()::s_muls[lVar2 + 1] +
                          (uint)*(byte *)(lVar31 + iVar15) *
                          (uint)(byte)H2V2ConvertFiltered()::s_muls[lVar2 + 2] + 8 +
                         (uint)*(byte *)(lVar21 + iVar14) *
                         (uint)(byte)H2V2ConvertFiltered()::s_muls[lVar2 + 3]) >> 4);
    iVar7 = *(int *)(this + lVar16 * 4 + 0x28b8);
    lVar21 = (long)((int)((uint)*(byte *)(lVar31 + (iVar15 + 0x40)) *
                          (uint)(byte)H2V2ConvertFiltered()::s_muls[lVar2 + 2] +
                          (uint)*(byte *)(lVar21 + (iVar10 + 0x40)) *
                          (uint)(byte)H2V2ConvertFiltered()::s_muls[lVar2 + 1] +
                          (uint)*(byte *)(lVar31 + (iVar11 + 0x40)) *
                          (uint)(byte)H2V2ConvertFiltered()::s_muls
                                      [((ulong)(uVar22 & 1) + lVar8) * 4] + 8 +
                         (uint)*(byte *)(lVar21 + (iVar14 + 0x40)) *
                         (uint)(byte)H2V2ConvertFiltered()::s_muls[lVar2 + 3]) >> 4);
    uVar13 = *(int *)(this + lVar21 * 4 + 0x24b8) + (uint)bVar3;
    if (0xff < uVar13) {
      uVar13 = (int)~uVar13 >> 0x1f & 0xff;
    }
    uVar25 = (*(int *)(this + lVar16 * 4 + 0x30b8) + *(int *)(this + lVar21 * 4 + 0x2cb8) >> 0x10) +
             (uint)bVar3;
    *puVar19 = (char)uVar13;
    if (0xff < uVar25) {
      uVar25 = (int)~uVar25 >> 0x1f & 0xff;
...
/* jpgd::jpeg_decoder::gray_convert() */
...
LAB_00106cca:
    ...
    *(int *)(this + 0x2448) = iVar4 + 0x10;
    *(uint *)(this + 0x244c) =
         (*(uint *)(this + 0x244c) & 0xffff0000 | uVar5 | uVar7) << (-(char)iVar4 & 0x1fU);
  }
  else {
...
/* jpgd::jpeg_decoder::make_huff_table(int, jpgd::jpeg_decoder::huff_tables*) */

void __thiscall
jpgd::jpeg_decoder::make_huff_table(jpeg_decoder *this,int param_1,huff_tables *param_2)
...
LAB_00106f49:
  ...
  *(undefined8 *)(param_2 + 0x3fc) = 0;
  ...
  for (uVar6 = (ulong)((iVar4 - (int)(undefined8 *)((ulong)(param_2 + 0xc) & 0xfffffffffffffff8)) +
                       0x404U >> 3); uVar6 != 0; uVar6 = uVar6 - 1) {
    *puVar11 = 0;
    puVar11 = puVar11 + 1;
  }
  ...
  *(undefined8 *)(param_2 + 0x7fc) = 0;
  ...
  for (uVar6 = (ulong)((iVar4 - (int)(undefined8 *)((ulong)(param_2 + 0x40c) & 0xfffffffffffffff8))
                       + 0x804U >> 3); uVar6 != 0; uVar6 = uVar6 - 1) {
    *puVar11 = 0;
    puVar11 = puVar11 + 1;
  }
  ...
  *(undefined8 *)(param_2 + 0x10fc) = 0;
  ...
  for (uVar6 = (ulong)((iVar4 - (int)(undefined8 *)((ulong)(param_2 + 0x90c) & 0xfffffffffffffff8))
                       + 0x1104U >> 3); uVar6 != 0; uVar6 = uVar6 - 1) {
    *puVar11 = 0;
    puVar11 = puVar11 + 1;
  }
  ...
  *(undefined8 *)(param_2 + 0x8fc) = 0;
  ...
  for (uVar6 = (ulong)((iVar4 - (int)(undefined8 *)((ulong)(param_2 + 0x80c) & 0xfffffffffffffff8))
                       + 0x904U >> 3); uVar6 != 0; uVar6 = uVar6 - 1) {
    *puVar11 = 0;
    puVar11 = puVar11 + 1;
  }
  if (0 < iVar7) {
...
LAB_0010720d:
        ...
        while( true ) {
          ...
          if (((bVar2 & 0xf) != 0) && (uVar10 < 9)) {
            uVar12 = (uVar14 >> (8U - (char)uVar10 & 0x1f) & (1 << (bVar2 & 0xf)) - 1U) << 0x10 |
                     (uint)bVar2 | uVar10 * 0x100 | 0x8000;
          }
          uVar14 = uVar14 + 1;
...
/* jpgd::jpeg_decoder::check_quant_tables() */
...

{
  ...
  if (0 < *(int *)(this + 0x200)) {
    pjVar1 = this;
    do {
      if (*(long *)(this + (long)*(int *)(this + (long)*(int *)(pjVar1 + 0x204) * 4 + 0x1c0) * 8 +
                           0x178) == 0) {
                    /* WARNING: Subroutine does not return */
...
/* jpgd::jpeg_decoder::check_huff_tables() */
...

{
  ...
  if (0 < *(int *)(this + 0x200)) {
    ...
    do {
      if (*(int *)(this + 0x234) == 0) {
        while( true ) {
          if (*(long *)(this + (long)*(int *)(this + (long)*(int *)(pjVar1 + 0x204) * 4 + 0x214) * 8
                               + 0xf8) == 0) goto LAB_00107377;
          if (0 < *(int *)(this + 0x238)) break;
          pjVar1 = pjVar1 + 4;
          if (pjVar1 == this + (long)*(int *)(this + 0x200) * 4) goto LAB_00107318;
        }
LAB_001072ba:
        if (*(long *)(this + (long)*(int *)(this + (long)*(int *)(pjVar1 + 0x204) * 4 + 0x224) * 8 +
                             0xf8) == 0) {
LAB_00107377:
                    /* WARNING: Subroutine does not return */
...
/* jpgd::jpeg_decoder::calc_mcu_block_order() */

undefined1  [16] __thiscall jpgd::jpeg_decoder::calc_mcu_block_order(jpeg_decoder *this)

{
  ...
  if (iVar1 < 1) {
    ...
    pjVar7 = this;
    do {
      if (iVar13 < *(int *)(pjVar7 + 0x1a0)) {
        iVar13 = *(int *)(pjVar7 + 0x1a0);
      }
    ...
    pjVar7 = this;
    do {
      iVar4 = (*(int *)(pjVar7 + 0x1a0) * iVar9 + iVar13 + -1) / iVar13;
      iVar6 = iVar4 + 7;
      iVar4 = iVar4 + 0xe;
      if (-1 < iVar6) {
        iVar4 = iVar6;
      ...
      *(int *)(pjVar7 + 0x1f0) = iVar4 >> 3;
      pjVar7 = pjVar10;
    } while (this + (long)iVar1 * 4 != pjVar10);
  }
  iVar1 = *(int *)(this + 0x200);
  if (iVar1 == 1) {
    uVar11 = (ulong)*(int *)(this + 0x204);
    uVar2 = *(undefined4 *)(this + uVar11 * 4 + 0x1e0);
    uVar3 = *(undefined4 *)(this + uVar11 * 4 + 0x1f0);
    *(int *)(this + 0x25c) = *(int *)(this + 0x204);
    *(undefined4 *)(this + 0x24c) = 1;
    *(ulong *)(this + 0x254) = CONCAT44(uVar3,uVar2);
    iVar13 = 1;
    if (*(int *)(this + 0x2460) < 1) goto LAB_00107532;
  }
  else {
    ...
    *(int *)(this + 0x254) = (iVar13 + -1 + (iVar9 >> 3)) / iVar13;
    iVar9 = *(int *)(this + 0xdc) + 7;
    iVar13 = *(int *)(this + 0xdc) + 0xe;
    if (-1 < iVar9) {
      iVar13 = iVar9;
    }
    iVar13 = iVar12 + -1 + (iVar13 >> 3);
    auVar15._8_8_ = (long)iVar13 % (long)iVar12 & 0xffffffff;
    *(int *)(this + 600) = iVar13 / iVar12;
    if (iVar1 < 1) {
    ...
    do {
      ...
      uVar11 = (ulong)iVar12;
      iVar9 = *(int *)(this + uVar11 * 4 + 0x1a0) * *(int *)(this + uVar11 * 4 + 0x1b0);
      if (iVar9 != 0) {
        pjVar10 = this + (long)iVar13 * 4;
        do {
          *(int *)(pjVar10 + 0x25c) = iVar12;
          pjVar10 = pjVar10 + 4;
        } while (this + ((ulong)(iVar9 - 1) + (long)iVar13) * 4 + 4 != pjVar10);
        iVar13 = iVar9 + iVar13;
        *(int *)(this + 0x24c) = iVar13;
      }
      pjVar7 = pjVar7 + 4;
    } while (this + (long)iVar1 * 4 != pjVar7);
    if (*(int *)(this + 0x2460) < iVar13) {
LAB_00107532:
      auVar5._8_8_ = 0;
      auVar5._0_8_ = uVar11;
      return auVar5 << 0x40;
    }
    if (iVar13 < 1) goto LAB_00107588;
  }
  pjVar7 = this + (long)iVar13 * 4;
  do {
    if (3 < *(int *)(this + 0x25c)) goto LAB_00107532;
    this = this + 4;
  } while (pjVar7 != this);
LAB_00107588:
...
/* jpgd::jpeg_decoder::init_scan() */

undefined8 __thiscall jpgd::jpeg_decoder::init_scan(jpeg_decoder *this)
  ...
  if (iVar2 != 0xd9) {
    ...
    if (cVar1 != '\0') {
      ...
      if (0 < *(int *)(this + 0x200)) {
        pjVar3 = this;
        do {
          if (*(long *)(this + (long)*(int *)(this + (long)*(int *)(pjVar3 + 0x204) * 4 + 0x1c0) * 8
                               + 0x178) == 0) {
                    /* WARNING: Subroutine does not return */
            stop_decoding(this,0xffffff15);
          }
...

{
  ...
  if (*(int *)(this + 0x19c) == 1) {
    ...
    if ((((*(int *)(this + 0x1a4) == 1) && (*(int *)(this + 0x1b4) == 1)) &&
        (*(int *)(this + 0x1a8) == 1)) && (*(int *)(this + 0x1b8) == 1)) {
      if (*(int *)(this + 0x1a0) == 1) {
        if (*(int *)(this + 0x1b0) == 1) {
          iVar8 = 7;
          iVar9 = 8;
          ...
          if (*(int *)(this + 0x1b0) != 2) goto LAB_001076f8;
          iVar6 = 3;
          uVar7 = 4;
          iVar8 = 0xf;
          iVar9 = 0x10;
        ...
        if (*(int *)(this + 0x1a0) != 2) goto LAB_001076f8;
        if (*(int *)(this + 0x1b0) == 1) {
          uVar7 = 4;
          iVar8 = 7;
          iVar5 = 0xf;
...
LAB_0010776c:
      iVar1 = *(int *)(this + 0xd8);
      *(undefined4 *)(this + 0x2460) = uVar7;
      *(int *)(this + 0x198) = iVar6;
      *(int *)(this + 0x244) = iVar10;
      *(int *)(this + 0x248) = iVar9;
      *(int *)(this + 0x245c) = (iVar5 + iVar1) / iVar10;
      *(int *)(this + 0x2464) = (*(int *)(this + 0xdc) + iVar8) / iVar9;
      if (iVar6 == 0) {
        iVar5 = 1;
        iVar6 = iVar1;
      }
      ...
      *(int *)(this + 0x290) = iVar6;
      *(int *)(this + 0x298) = iVar5;
      iVar5 = (iVar1 + 0xfU & 0xfff0) * iVar5;
      *(int *)(this + 0x294) = iVar5;
      uVar2 = alloc(this,(long)iVar5,false);
      *(undefined8 *)(this + 0x34b8) = uVar2;
      if (*(int *)(this + 0x198) - 3U < 2) {
        uVar2 = alloc(this,(long)*(int *)(this + 0x294),false);
        *(undefined8 *)(this + 0x34c0) = uVar2;
      }
      iVar6 = *(int *)(this + 0x245c) * *(int *)(this + 0x2460);
      *(int *)(this + 0x250) = iVar6;
      if (iVar6 < 0x4001) {
        lVar3 = alloc(this,(long)(*(int *)(this + 0x2460) << 6) * 2 + 0xf,false);
        iVar6 = *(int *)(this + 0x2460);
        *(ulong *)(this + 0x2478) = lVar3 + 0xfU & 0xfffffffffffffff0;
        if (0 < iVar6) {
          pjVar4 = this;
          do {
            *(undefined4 *)(pjVar4 + 0x2480) = 0x40;
            pjVar4 = pjVar4 + 4;
          } while (pjVar4 != this + (long)iVar6 * 4);
        }
        lVar3 = alloc(this,(long)(*(int *)(this + 0x250) << 6) + 0xf,false);
        *(ulong *)(this + 0x24a8) = lVar3 + 0xfU & 0xfffffffffffffff0;
        lVar3 = alloc(this,(long)(*(int *)(this + 0x250) << 6) + 0xf,false);
        *(undefined4 *)(this + 0x288) = 0;
        *(ulong *)(this + 0x24b0) = lVar3 + 0xfU & 0xfffffffffffffff0;
...
/* jpgd::jpeg_decoder::coeff_buf_open(int, int, int, int) */
...
/* jpgd::jpeg_decoder::decode_scan(void (*)(jpgd::jpeg_decoder*, int, int, int)) */

void __thiscall
jpgd::jpeg_decoder::decode_scan(jpeg_decoder *this,_func_void_jpeg_decoder_ptr_int_int_int *param_1)
          ...
          if (0 < *(int *)(this + 0x24c)) {
            ...
            do {
              while( true ) {
                ...
                (*param_1)(this,*(int *)(this + lVar6 * 4 + 0x25c),iVar4 + iVar7,
                           *(int *)(local_58 + lVar5 * 4) + iVar3);
                if (*(int *)(this + 0x200) != 1) break;
                lVar6 = lVar6 + 1;
                *(int *)(local_68 + lVar5 * 4) = iVar4 + 1;
                if (*(int *)(this + 0x24c) <= (int)lVar6) goto LAB_00107b44;
              }
              iVar7 = iVar7 + 1;
...
LAB_00107b44:
      ...
      if (iVar3 == 1) {
        *(int *)(local_58 + (long)*(int *)(this + 0x204) * 4) =
             *(int *)(local_58 + (long)*(int *)(this + 0x204) * 4) + 1;
      }
      else if (0 < iVar3) {
        pjVar2 = this;
        do {
          ...
          *(int *)(local_58 + (long)*(int *)pjVar1 * 4) =
               *(int *)(local_58 + (long)*(int *)pjVar1 * 4) +
               *(int *)(this + (long)*(int *)pjVar1 * 4 + 0x1b0);
...
/* jpgd::jpeg_decoder::init_progressive() [clone .part.0] */
...
LAB_00107da5:
      ...
      if (*(int *)(this + 0x200) != 1) goto LAB_00108076;
      pcVar13 = decode_block_ac_first;
      if (iVar2 != 0) {
        if (iVar2 + -1 != *(int *)(this + 0x23c)) goto LAB_00107da5;
...
LAB_00107ecd:
      ...
      *(uint *)(this + 0x244c) =
           (*(uint *)(this + 0x244c) & 0xffff0000 | uVar10 | uVar15) << (-(char)iVar7 & 0x1fU);
    }
    else {
...
/* jpgd::jpeg_decoder::init_progressive() */
...
/* jpgd::jpeg_decoder::init_sequential() */

void __thiscall jpgd::jpeg_decoder::init_sequential(jpeg_decoder *this)
...
/* jpgd::jpeg_decoder::decode_start() */

void __thiscall jpgd::jpeg_decoder::decode_start(jpeg_decoder *this)
...
/* jpgd::jpeg_decoder::decode_init(jpgd::jpeg_decoder_stream*, unsigned int) */

void __thiscall
jpgd::jpeg_decoder::decode_init(jpeg_decoder *this,jpeg_decoder_stream *param_1,uint param_2)
...
/* jpgd::jpeg_decoder::jpeg_decoder(jpgd::jpeg_decoder_stream*, unsigned int) */

void __thiscall
jpgd::jpeg_decoder::jpeg_decoder(jpeg_decoder *this,jpeg_decoder_stream *param_1,uint param_2)
...
/* jpgd::jpeg_decoder::begin_decoding() */

undefined8 __thiscall jpgd::jpeg_decoder::begin_decoding(jpeg_decoder *this)
...
/* jpgd::jpeg_decoder_file_stream::close() */

void __thiscall jpgd::jpeg_decoder_file_stream::close(jpeg_decoder_file_stream *this)
...
/* jpgd::jpeg_decoder_file_stream::open(char const*) */

bool __thiscall jpgd::jpeg_decoder_file_stream::open(jpeg_decoder_file_stream *this,char *param_1)
...
/* jpgd::jpeg_decoder_mem_stream::open(unsigned char const*, unsigned int) */

undefined8 __thiscall
jpgd::jpeg_decoder_mem_stream::open(jpeg_decoder_mem_stream *this,uchar *param_1,uint param_2)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* jpgd::jpeg_decoder::transform_mcu(int) */

void __thiscall jpgd::jpeg_decoder::transform_mcu(jpeg_decoder *this,int param_1)
  ...
  if (0 < *(int *)(this + 0x24c)) {
    do {
      ...
      if (((byte)this[200] & 2) == 0) {
        if (iVar9 < 2) goto LAB_00108de0;
        if (this[0x34d3] == (jpeg_decoder)0x0) goto LAB_0010837f;
          ...
          do {
            ...
            case 2:
              ...
              *piVar3 = iVar4 * 0x2c63 + iVar6 + __LC13 >> 0xb;
              piVar3[1] = iVar4 * 0x25a1 + iVar6 + _UNK_0010cc84 >> 0xb;
              piVar3[2] = iVar4 * 0x1925 + iVar6 + _UNK_0010cc88 >> 0xb;
              piVar3[3] = iVar4 * 0x8d4 + iVar6 + _UNK_0010cc8c >> 0xb;
              piVar3[4] = iVar6 + iVar4 * -0x8d4 + __LC13 >> 0xb;
              piVar3[5] = iVar6 + iVar4 * -0x1925 + _UNK_0010cc84 >> 0xb;
              piVar3[6] = iVar6 + iVar4 * -0x25a1 + _UNK_0010cc88 >> 0xb;
              piVar3[7] = iVar6 + iVar4 * -0x2c63 + _UNK_0010cc8c >> 0xb;
              break;
            case 3:
              iVar10 = (int)psVar7[2];
              iVar5 = *psVar7 * 0x2000;
...
LAB_001085c6:
          ...
          piVar8 = piVar12;
LAB_00108591:
          switch(s_idct_col_table[iVar9 + -1]) {
          default:
            goto switchD_001085a8_caseD_0;
          case 1:
            do {
...
LAB_00108af8:
  ...
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
                    ...
                    /* WARNING: Subroutine does not return */
  __stack_chk_fail();
switchD_001085a8_caseD_0:
  piVar25 = piVar25 + 1;
  piVar8 = (int *)((long)piVar8 + 1);
  if (piVar25 == piVar3) goto LAB_00108af8;
  goto LAB_00108591;
}



/* jpgd::jpeg_decoder::load_next_row() */
...
LAB_0010913a:
          ...
          if (((int)lVar10 <= iVar15) || (*(int *)((long)plVar3 + 0xc) <= iVar17))
          goto LAB_0010913a;
          lVar5 = *plVar3;
          lVar7 = plVar3[3];
          plVar3 = *(long **)(this + lVar16 * 8 + 0x2e0);
          if (((int)plVar3[1] <= iVar15) || (*(int *)((long)plVar3 + 0xc) <= iVar17))
          goto LAB_0010913a;
          sVar2 = *(short *)((long)((int)plVar3[1] * (int)plVar3[3] * iVar17) + *plVar3 +
                            (long)(iVar15 * (int)plVar3[3]));
          lVar11 = 0x3f;
          *psVar8 = sVar2;
          puVar9 = (undefined8 *)
                   ((long)((int)lVar10 * (int)lVar7 * iVar17) + (long)((int)lVar7 * iVar15) + 2 +
                   lVar5);
          uVar6 = puVar9[1];
          *(undefined8 *)(psVar8 + 1) = *puVar9;
          *(undefined8 *)(psVar8 + 5) = uVar6;
          uVar6 = puVar9[3];
          *(undefined8 *)(psVar8 + 9) = puVar9[2];
          *(undefined8 *)(psVar8 + 0xd) = uVar6;
          uVar6 = puVar9[5];
          *(undefined8 *)(psVar8 + 0x11) = puVar9[4];
          *(undefined8 *)(psVar8 + 0x15) = uVar6;
          uVar6 = puVar9[7];
          *(undefined8 *)(psVar8 + 0x19) = puVar9[6];
          *(undefined8 *)(psVar8 + 0x1d) = uVar6;
          uVar6 = puVar9[9];
          *(undefined8 *)(psVar8 + 0x21) = puVar9[8];
          *(undefined8 *)(psVar8 + 0x25) = uVar6;
          uVar6 = puVar9[0xb];
          *(undefined8 *)(psVar8 + 0x29) = puVar9[10];
          *(undefined8 *)(psVar8 + 0x2d) = uVar6;
          uVar6 = puVar9[0xd];
          *(undefined8 *)(psVar8 + 0x31) = puVar9[0xc];
          *(undefined8 *)(psVar8 + 0x35) = uVar6;
          ...
          *(undefined8 *)(psVar8 + 0x3c) = uVar6;
          ...
          sVar2 = psVar8[lVar10];
LAB_00108fec:
          *(int *)(this + lVar18 * 4 + 0x2480) = iVar17;
          lVar10 = (long)iVar15;
          while( true ) {
            if (sVar2 != 0) {
  ...
  if (iVar13 == 1) {
    *(int *)(this + (long)*(int *)(this + 0x204) * 4 + 0x324) =
         *(int *)(this + (long)*(int *)(this + 0x204) * 4 + 0x324) + 1;
  }
  else if (0 < iVar13) {
    pjVar12 = this;
    do {
      ...
      pjVar12 = pjVar12 + 4;
      *(int *)(this + (long)*(int *)pjVar1 * 4 + 0x324) =
           *(int *)(this + (long)*(int *)pjVar1 * 4 + 0x324) +
           *(int *)(this + (long)*(int *)pjVar1 * 4 + 0x1b0);
...
/* jpgd::jpeg_decoder::decode_next_row() */
...
LAB_001094e6:
        ...
        if ((int)uVar22 < 0) {
          ...
          do {
            ...
            if ((0x1ff < uVar22) || (iVar17 < 0)) goto LAB_001094e6;
        ...
        if (0xf < (int)uVar16) goto LAB_001094e6;
        ...
        do {
          ...
          if ((int)uVar8 < 0) {
            ...
            do {
              ...
              if ((0x1ff < uVar8) || (iVar10 < 0)) goto LAB_001094e6;
...
LAB_00109ba9:
                iVar18 = *(int *)(this + 0x2448);
                uVar9 = uVar15 | uVar9 | *(uint *)(this + 0x244c);
              }
              else {
                pbVar6 = *(byte **)(this + 0x338);
                bVar1 = *pbVar6;
                if ((bVar1 == 0xff) || (bVar2 = pbVar6[1], bVar2 == 0xff)) {
                  pbVar11 = pbVar6 + 1;
                  iVar10 = iVar10 + -1;
                  *(byte **)(this + 0x338) = pbVar11;
                  bVar1 = *pbVar6;
                  *(int *)(this + 0x340) = iVar10;
                  if (bVar1 == 0xff) goto LAB_0010a4aa;
                  uVar9 = (uint)bVar1 << 8;
                  goto LAB_00109b7c;
                }
            ...
            if (uVar20 == 0) {
LAB_001094b5:
              if (uVar9 == 0xf) goto LAB_001094be;
              break;
            }
            iVar10 = *(int *)(this + 0x2448);
            uVar15 = *(uint *)(this + 0x244c);
...
LAB_00109a7e:
                ...
                if ((bVar1 == 0xff) || (bVar2 = pbVar6[1], bVar2 == 0xff)) {
                  ...
                  *(byte **)(this + 0x338) = pbVar11;
                  bVar1 = *pbVar6;
                  *(int *)(this + 0x340) = iVar10;
                  if (bVar1 == 0xff) goto LAB_0010a590;
                  uVar8 = (uint)bVar1 << 8;
                  goto LAB_00109acd;
                }
                *(int *)(this + 0x340) = iVar10 + -2;
...
LAB_00109384:
            ...
            if (uVar9 != 0) {
              uVar8 = uVar9 + uVar22;
              if (0x3f < (int)uVar8) goto LAB_001094e6;
              if ((int)uVar22 < iVar3) {
                ...
                do {
                  ...
                  piVar13 = piVar13 + 1;
                  psVar23[iVar10] = 0;
                } while ((int *)(g_ZAG + ((ulong)(uVar20 - 1) + (long)(int)uVar22) * 4 + 4) !=
                         piVar13);
              }
            }
...
LAB_0010a0d5:
                    ...
                    if ((bVar1 == 0xff) || (bVar2 = pbVar6[1], bVar2 == 0xff)) {
                      ...
                      *(byte **)(this + 0x338) = pbVar11;
                      bVar1 = *pbVar6;
                      *(int *)(this + 0x340) = iVar10;
                      if (bVar1 == 0xff) goto LAB_0010a6ff;
                      uVar9 = (uint)bVar1 << 8;
                      goto LAB_0010a124;
                    }
                    *(int *)(this + 0x340) = iVar10 + -2;
...
LAB_00109370:
              uVar9 = (int)uVar8 >> 4 & 0xf;
              lVar12 = (long)(int)(uVar8 & 0xf);
              if ((uVar8 & 0xf) != 0) goto LAB_00109384;
              goto LAB_001094b5;
            }
            uVar15 = (int)uVar8 >> 8 & 0x1f;
            uVar20 = uVar15 + (uVar8 & 0xf);
            if (uVar20 < 0x11) {
              if (uVar20 == 0) goto LAB_00109588;
              iVar10 = *(int *)(this + 0x2448);
              iVar17 = iVar10 - uVar20;
              *(int *)(this + 0x2448) = iVar17;
...
LAB_00109daf:
                  ...
                  if ((bVar1 == 0xff) || (bVar2 = pbVar6[1], bVar2 == 0xff)) {
                    ...
                    *(byte **)(this + 0x338) = pbVar11;
                    bVar1 = *pbVar6;
                    *(int *)(this + 0x340) = iVar18;
                    if (bVar1 == 0xff) goto LAB_0010a665;
                    uVar9 = (uint)bVar1 << 8;
                    goto LAB_00109dfa;
                  }
...
LAB_0010a263:
                ...
                if ((bVar1 == 0xff) || (bVar2 = pbVar6[1], bVar2 == 0xff)) {
                  ...
                  *(byte **)(this + 0x338) = pbVar11;
                  bVar1 = *pbVar6;
                  *(int *)(this + 0x340) = iVar10;
                  if (bVar1 == 0xff) goto LAB_0010a914;
                  uVar9 = (uint)bVar1 << 8;
                  goto LAB_0010a2af;
                }
                *(int *)(this + 0x340) = iVar10 + -2;
...
LAB_00109f27:
                ...
                if ((bVar1 == 0xff) || (bVar2 = pbVar6[1], bVar2 == 0xff)) {
                  ...
                  *(byte **)(this + 0x338) = pbVar11;
                  bVar1 = *pbVar6;
                  *(int *)(this + 0x340) = iVar10;
                  if (bVar1 == 0xff) goto LAB_0010a79a;
                  uVar9 = (uint)bVar1 << 8;
                  goto LAB_00109f72;
                }
                *(int *)(this + 0x340) = iVar10 + -2;
...
LAB_00109588:
            if (((int)uVar8 >> 4 & 0xfU) != 0xf) break;
LAB_001094be:
            if (0x30 < (int)uVar22) goto LAB_001094e6;
            if ((int)uVar22 < iVar3) {
              ...
              while (psVar23[*piVar13] = 0,
                    piVar13 != (int *)(g_ZAG + ((ulong)(iVar10 - 1) + lVar12) * 4)) {
                piVar13 = piVar13 + 1;
            ...
            uVar8 = uVar22 + 0xf;
            if (psVar23[*(int *)(g_ZAG + (ulong)(uVar8 & 0x3f) * 4)] != 0) goto LAB_001094e6;
          }
          uVar22 = uVar8 + 1;
        } while (uVar22 != 0x40);
        if ((int)uVar22 < iVar3) {
...
/* jpgd::jpeg_decoder::decode_next_mcu_row() */

undefined4 __thiscall jpgd::jpeg_decoder::decode_next_mcu_row(jpeg_decoder *this)

{
  ...
  if (iVar4 < *(int *)(this + 0x284)) goto LAB_0010ac64;
  iVar7 = *(int *)(this + 0x340);
  if (*(int *)(this + 0xe8) == 0) {
    *(undefined4 *)(this + 0x2448) = 0;
    *(int *)(this + 0x244c) = *(int *)(this + 0x244c) << 0x10;
...
LAB_0010acd9:
      ...
      *(byte **)(this + 0x338) = pbVar5;
      uVar8 = (uint)*pbVar1;
      *(int *)(this + 0x340) = iVar7;
      if (iVar7 == 0) goto LAB_0010adb0;
LAB_0010ad02:
      *(byte **)(this + 0x338) = pbVar5 + 1;
      uVar6 = (uint)*pbVar5;
      *(int *)(this + 0x340) = iVar7 + -1;
    }
...
LAB_0010ae27:
      ...
      *(int *)(this + 0x2448) = iVar4 + 0x10;
      *(uint *)(this + 0x244c) =
           (*(uint *)(this + 0x244c) & 0xffff0000 | uVar6 | uVar8 << 8) << (-(char)iVar4 & 0x1fU);
    }
    else {
      *(int *)(this + 0x244c) = iVar4 << 0x10;
    }
...
/* jpgd::jpeg_decoder::decode(void const**, unsigned int*) */

int __thiscall jpgd::jpeg_decoder::decode(jpeg_decoder *this,void **param_1,uint *param_2)

{
  ...
  if ((*(int *)(this + 0x34c8) != 0) || (jVar1 = this[0x34d0], jVar1 == (jpeg_decoder)0x0)) {
    return -1;
  }
  ...
  if ((uVar5 != 0) || (iVar2 = *(int *)(this + 0x198), 1 < iVar2 - 3U)) {
    if (*(int *)(this + 0x288) == 0) {
...
LAB_0010afb4:
    ...
    jVar4 = jVar12;
    if (*(int *)(this + 0x288) != 1 || iVar6 < 2) goto LAB_0010aff9;
  }
...
byte * jpgd::decompress_jpeg_image_from_stream
                 (jpeg_decoder_stream *param_1,int *param_2,int *param_3,int *param_4,int param_5,
                 uint param_6)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (((((param_4 == (int *)0x0) || (*param_4 = 0, param_1 == (jpeg_decoder_stream *)0x0)) ||
       (param_2 == (int *)0x0)) || ((param_3 == (int *)0x0 || (param_5 == 0)))) ||
     ((1 < param_5 - 3U && (param_5 != 1)))) {
    __ptr = (byte *)0x0;
    goto LAB_0010b373;
  }
...
LAB_0010b530:
            ...
            do {
              pbVar7 = pbVar6 + 1;
              *pbVar6 = (byte)((uint)*pbVar10 * 0x4c8b + (uint)pbVar10[1] * 0x9646 + 0x8000 +
                               (uint)pbVar10[2] * 0x1d2f >> 0x10);
              pbVar6 = pbVar7;
              pbVar10 = pbVar10 + 4;
          ...
          if (local_337c == 3) goto LAB_0010b530;
...
void jpgd::decompress_jpeg_image_from_memory
...

{
  ...
  local_28 = &PTR__jpeg_decoder_mem_stream_0010cc18;
  local_18 = 0;
  local_20 = param_1;
  local_14 = param_2;
  decompress_jpeg_image_from_stream
            ((jpeg_decoder_stream *)&local_28,param_3,param_4,param_5,param_6,param_7);
...
/* jpgd::decompress_jpeg_image_from_file(char const*, int*, int*, int*, int, unsigned int) */

FILE * jpgd::decompress_jpeg_image_from_file
                 (char *param_1,int *param_2,int *param_3,int *param_4,int param_5,uint param_6)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  local_58 = &PTR__jpeg_decoder_file_stream_0010cbf0;
  local_50 = (FILE *)0x0;
  local_48 = 0;
  pFVar1 = fopen64(param_1,"rb");
  local_50 = pFVar1;
  if (pFVar1 != (FILE *)0x0) {
    pFVar1 = (FILE *)decompress_jpeg_image_from_stream
                               ((jpeg_decoder_stream *)&local_58,param_2,param_3,param_4,param_5,
                                param_6);
    local_58 = &PTR__jpeg_decoder_file_stream_0010cbf0;
...
/* jpgd::jpeg_decoder_mem_stream::~jpeg_decoder_mem_stream() */

void __thiscall
jpgd::jpeg_decoder_mem_stream::~jpeg_decoder_mem_stream(jpeg_decoder_mem_stream *this)
...
/* jpgd::jpeg_decoder::get_bits_no_markers(int) */

uint __thiscall jpgd::jpeg_decoder::get_bits_no_markers(jpeg_decoder *this,int param_1)
...
LAB_0010bb70:
    ...
    *(byte **)(this + 0x338) = pbVar6;
    bVar1 = *pbVar3;
    *(int *)(this + 0x340) = iVar7;
    if (bVar1 == 0xff) goto LAB_0010bb18;
    uVar5 = (uint)bVar1 << 8;
LAB_0010ba69:
    pbVar3 = *(byte **)(this + 0x338);
    iVar7 = iVar7 + -1;
...
/* jpgd::Col<3>::idct(unsigned char*, int const*) */

void jpgd::Col<3>::idct(uchar *param_1,int *param_2)
...
/* jpgd::Col<4>::idct(unsigned char*, int const*) */

void jpgd::Col<4>::idct(uchar *param_1,int *param_2)
...
/* jpgd::Col<5>::idct(unsigned char*, int const*) */

void jpgd::Col<5>::idct(uchar *param_1,int *param_2)
...
/* jpgd::Col<6>::idct(unsigned char*, int const*) */

void jpgd::Col<6>::idct(uchar *param_1,int *param_2)
...
/* jpgd::Col<7>::idct(unsigned char*, int const*) */

void jpgd::Col<7>::idct(uchar *param_1,int *param_2)
...
/* jpgd::Col<8>::idct(unsigned char*, int const*) */

void jpgd::Col<8>::idct(uchar *param_1,int *param_2)

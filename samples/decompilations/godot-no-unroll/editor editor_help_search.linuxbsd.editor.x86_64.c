...

{
  ...
  if ((*in_RDX == 0) || (*(uint *)(*in_RDX + -8) < 2)) {
    *(undefined8 *)param_1 = 0;
    ...
    String::split((char *)&local_68,SUB81(in_RDX,0),0x10f4e0);
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  String::split(local_58,in_CL,0x10f4e0);
...

{
  ...
  String::split((char *)&local_68,(bool)((char)param_2 + ' '),0x10f4e0);
  CowData<String>::_copy_on_write((CowData<String> *)&local_60);
  lVar9 = local_60;
  CowData<String>::_copy_on_write((CowData<String> *)&local_60);
  lVar10 = local_60;
...

{
  ...
  String::split((char *)&local_68,SUB81(param_9,0),0x10f4e0);
  CowData<String>::_copy_on_write((CowData<String> *)&local_60);
  lVar8 = local_60;
  CowData<String>::_copy_on_write((CowData<String> *)&local_60);
  lVar10 = local_60;
...

{
  ...
  local_60 = 0;
  puVar9 = (undefined8 *)((ulong)(*(int *)(this + 0x218) - 1) * 0x10 + *(long *)(this + 0x220));
  local_68 = (ClassDoc *)*puVar9;
  CowData<char32_t>::_ref((CowData<char32_t> *)&local_60,(CowData *)(puVar9 + 1));
  pCVar3 = local_68;
  uVar11 = *(int *)(this + 0x218) - 1;
  if (*(int *)(this + 0x218) == 0) {
    uVar11 = 0;
    if (*(int *)(this + 0x21c) == -1) {
LAB_0010ab99:
      lVar12 = *(long *)(this + 0x220);
      pauVar5 = (undefined1 (*) [16])((ulong)uVar11 * 0x10 + lVar12);
      do {
        *pauVar5 = (undefined1  [16])0x0;
        pauVar5 = pauVar5 + 1;
      } while (pauVar5 !=
               (undefined1 (*) [16])(lVar12 + 0x10 + ((ulong)(-uVar11 - 2) + (ulong)uVar11) * 0x10))
      ;
    }
    else {
      *(undefined4 *)(this + 0x21c) = 0;
      pvVar10 = *(void **)(this + 0x220);
      lVar12 = Memory::realloc_static(pvVar10,0,false);
      *(long *)(this + 0x220) = lVar12;
      if (lVar12 == 0) {
                    /* WARNING: Subroutine does not return */
        LocalVector<TreeItem*,unsigned_int,false,false>::resize((uint)pvVar10);
      }
      uVar11 = *(uint *)(this + 0x218);
      if (uVar11 != 0xffffffff) goto LAB_0010ab99;
    }
    uVar11 = 0xffffffff;
  }
  else {
    ...
    uVar7 = uVar11;
    do {
      lVar13 = *(long *)(this + 0x220) + lVar12;
      if (*(long *)(lVar13 + 8) != 0) {
        LOCK();
        plVar1 = (long *)(*(long *)(lVar13 + 8) + -0x10);
        *plVar1 = *plVar1 + -1;
        UNLOCK();
        if (*plVar1 == 0) {
          lVar2 = *(long *)(lVar13 + 8);
      ...
      uVar7 = uVar7 + 1;
      lVar12 = lVar12 + 0x10;
    } while (uVar7 < *(uint *)(this + 0x218));
  }
  *(uint *)(this + 0x218) = uVar11;
  if (pCVar3 != (ClassDoc *)0x0) {
    pSVar6 = (String *)
             _create_class_hierarchy
                       (this,pCVar3,(String *)&local_60,
                        (bool)(~(byte)*(undefined4 *)(this + 0x1b0) & 1));
    TreeItem::get_first_child();
    TreeItem::set_collapsed(SUB81(pSVar6,0));
    iVar4 = (int)pSVar6;
    if (((byte)this[0x1b0] & 1) == 0) {
      TreeItem::set_custom_color(iVar4,(Color *)0x0);
      TreeItem::set_custom_color(iVar4,(Color *)0x1);
    }
    else {
      TreeItem::clear_custom_color(iVar4);
      TreeItem::clear_custom_color(iVar4);
    }
    uVar11 = *(uint *)(this + 0x1b0);
    uVar7 = uVar11 & 0x1ff;
    if (((uVar11 & 2) != 0) && (*(long *)(pCVar3 + 0x40) != 0)) {
      local_80 = (TreeItem *)pSVar6;
      if (uVar7 == 0x1ff) {
        local_58 = 0;
        ...
        if ((_phase_fill_member_items()::{lambda()#1}::operator()()::sname == '\0') &&
           (iVar4 = __cxa_guard_acquire(&_phase_fill_member_items()::{lambda()#1}::operator()()::
                                         sname), iVar4 != 0)) {
          _scs_create((char *)&_phase_fill_member_items()::{lambda()#1}::operator()()::sname,false);
          __cxa_atexit(StringName::~StringName,
        ...
        local_80 = (TreeItem *)
                   _create_category_item
                             ((TreeItem *)this,pSVar6,(StringName *)pCVar3,
                              (String *)
      ...
      CowData<DocData::MethodDoc>::_copy_on_write((CowData<DocData::MethodDoc> *)(pCVar3 + 0x40));
      lVar12 = *(long *)(pCVar3 + 0x40);
      CowData<DocData::MethodDoc>::_copy_on_write((CowData<DocData::MethodDoc> *)(pCVar3 + 0x40));
      local_90 = *(long *)(pCVar3 + 0x40);
      if (local_90 != 0) {
        local_90 = local_90 + *(long *)(local_90 + -8) * 0x78;
      }
      for (; lVar12 != local_90; lVar12 = lVar12 + 0x78) {
        local_50 = 0;
        local_48 = 0;
        local_58 = lVar12;
        _create_constructor_item(this,local_80,pCVar3,(MemberMatch *)&local_58);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
      }
      uVar11 = *(uint *)(this + 0x1b0);
    }
    if (((uVar11 & 4) != 0) && (*(long *)(pCVar3 + 0x50) != 0)) {
      local_80 = (TreeItem *)pSVar6;
      if (uVar7 == 0x1ff) {
        local_58 = 0;
        ...
        if ((_phase_fill_member_items()::{lambda()#2}::operator()()::sname == '\0') &&
           (iVar4 = __cxa_guard_acquire(&_phase_fill_member_items()::{lambda()#2}::operator()()::
                                         sname), iVar4 != 0)) {
      ...
      CowData<DocData::MethodDoc>::_copy_on_write((CowData<DocData::MethodDoc> *)(pCVar3 + 0x50));
      lVar12 = *(long *)(pCVar3 + 0x50);
      CowData<DocData::MethodDoc>::_copy_on_write((CowData<DocData::MethodDoc> *)(pCVar3 + 0x50));
      local_90 = *(long *)(pCVar3 + 0x50);
      if (local_90 != 0) {
        local_90 = local_90 + *(long *)(local_90 + -8) * 0x78;
      }
      for (; lVar12 != local_90; lVar12 = lVar12 + 0x78) {
        ...
        local_48 = 0;
        local_58 = lVar12;
        _create_method_item(this,local_80,pCVar3,(MemberMatch *)&local_58);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
      }
      uVar11 = *(uint *)(this + 0x1b0);
    }
    if (((uVar11 & 8) != 0) && (*(long *)(pCVar3 + 0x60) != 0)) {
      local_80 = (TreeItem *)pSVar6;
      if (uVar7 == 0x1ff) {
        local_58 = 0;
        ...
        if ((_phase_fill_member_items()::{lambda()#3}::operator()()::sname == '\0') &&
           (iVar4 = __cxa_guard_acquire(&_phase_fill_member_items()::{lambda()#3}::operator()()::
                                         sname), iVar4 != 0)) {
      ...
      CowData<DocData::MethodDoc>::_copy_on_write((CowData<DocData::MethodDoc> *)(pCVar3 + 0x60));
      lVar12 = *(long *)(pCVar3 + 0x60);
      CowData<DocData::MethodDoc>::_copy_on_write((CowData<DocData::MethodDoc> *)(pCVar3 + 0x60));
      local_90 = *(long *)(pCVar3 + 0x60);
      if (local_90 != 0) {
        local_90 = local_90 + *(long *)(local_90 + -8) * 0x78;
      }
      for (; lVar12 != local_90; lVar12 = lVar12 + 0x78) {
        ...
        local_48 = 0;
        local_58 = lVar12;
        _create_operator_item(this,local_80,pCVar3,(MemberMatch *)&local_58);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
      }
      uVar11 = *(uint *)(this + 0x1b0);
    }
    if (((uVar11 & 0x10) != 0) && (*(long *)(pCVar3 + 0x70) != 0)) {
      local_80 = (TreeItem *)pSVar6;
      if (uVar7 == 0x1ff) {
        local_58 = 0;
        ...
        if ((_phase_fill_member_items()::{lambda()#4}::operator()()::sname == '\0') &&
           (iVar4 = __cxa_guard_acquire(&_phase_fill_member_items()::{lambda()#4}::operator()()::
                                         sname), iVar4 != 0)) {
      ...
      CowData<DocData::MethodDoc>::_copy_on_write((CowData<DocData::MethodDoc> *)(pCVar3 + 0x70));
      lVar12 = *(long *)(pCVar3 + 0x70);
      CowData<DocData::MethodDoc>::_copy_on_write((CowData<DocData::MethodDoc> *)(pCVar3 + 0x70));
      local_90 = *(long *)(pCVar3 + 0x70);
      if (local_90 != 0) {
        local_90 = local_90 + *(long *)(local_90 + -8) * 0x78;
      }
      for (; lVar12 != local_90; lVar12 = lVar12 + 0x78) {
        ...
        local_48 = 0;
        local_58 = lVar12;
        _create_signal_item(this,local_80,pCVar3,(MemberMatch *)&local_58);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
      }
      uVar11 = *(uint *)(this + 0x1b0);
    }
    if (((uVar11 & 0x20) != 0) && (*(long *)(pCVar3 + 0x80) != 0)) {
      local_80 = (TreeItem *)pSVar6;
      if (uVar7 == 0x1ff) {
        local_58 = 0;
        ...
        if ((_phase_fill_member_items()::{lambda()#5}::operator()()::sname == '\0') &&
           (iVar4 = __cxa_guard_acquire(&_phase_fill_member_items()::{lambda()#5}::operator()()::
                                         sname), iVar4 != 0)) {
      ...
      CowData<DocData::ConstantDoc>::_copy_on_write
                ((CowData<DocData::ConstantDoc> *)(pCVar3 + 0x80));
      lVar12 = *(long *)(pCVar3 + 0x80);
      CowData<DocData::ConstantDoc>::_copy_on_write
                ((CowData<DocData::ConstantDoc> *)(pCVar3 + 0x80));
      local_90 = *(long *)(pCVar3 + 0x80);
      if (local_90 != 0) {
        local_90 = local_90 + *(long *)(local_90 + -8) * 0x60;
      }
      for (; lVar12 != local_90; lVar12 = lVar12 + 0x60) {
        local_50 = 0;
        local_48 = 0;
        local_58 = lVar12;
        _create_constant_item(this,local_80,pCVar3,(MemberMatch *)&local_58);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
      }
      uVar11 = *(uint *)(this + 0x1b0);
    }
    if (((uVar11 & 0x40) != 0) && (*(long *)(pCVar3 + 0xc0) != 0)) {
      local_80 = (TreeItem *)pSVar6;
      if (uVar7 == 0x1ff) {
        local_58 = 0;
        ...
        if ((_phase_fill_member_items()::{lambda()#6}::operator()()::sname == '\0') &&
           (iVar4 = __cxa_guard_acquire(&_phase_fill_member_items()::{lambda()#6}::operator()()::
                                         sname), iVar4 != 0)) {
      ...
      CowData<DocData::PropertyDoc>::_copy_on_write
                ((CowData<DocData::PropertyDoc> *)(pCVar3 + 0xc0));
      lVar12 = *(long *)(pCVar3 + 0xc0);
      CowData<DocData::PropertyDoc>::_copy_on_write
                ((CowData<DocData::PropertyDoc> *)(pCVar3 + 0xc0));
      local_90 = *(long *)(pCVar3 + 0xc0);
      if (local_90 != 0) {
        local_90 = local_90 + *(long *)(local_90 + -8) * 0x78;
      }
      for (; lVar12 != local_90; lVar12 = lVar12 + 0x78) {
        ...
        local_48 = 0;
        local_58 = lVar12;
        _create_property_item(this,local_80,pCVar3,(MemberMatch *)&local_58);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
      }
      uVar11 = *(uint *)(this + 0x1b0);
    }
    if (((uVar11 & 0x80) != 0) && (*(long *)(pCVar3 + 0xe0) != 0)) {
      local_80 = (TreeItem *)pSVar6;
      if (uVar7 == 0x1ff) {
        local_58 = 0;
        ...
        if ((_phase_fill_member_items()::{lambda()#7}::operator()()::sname == '\0') &&
           (iVar4 = __cxa_guard_acquire(&_phase_fill_member_items()::{lambda()#7}::operator()()::
                                         sname), iVar4 != 0)) {
      ...
      CowData<DocData::ThemeItemDoc>::_copy_on_write
                ((CowData<DocData::ThemeItemDoc> *)(pCVar3 + 0xe0));
      lVar12 = *(long *)(pCVar3 + 0xe0);
      CowData<DocData::ThemeItemDoc>::_copy_on_write
                ((CowData<DocData::ThemeItemDoc> *)(pCVar3 + 0xe0));
      local_90 = *(long *)(pCVar3 + 0xe0);
      if (local_90 != 0) {
        local_90 = local_90 + *(long *)(local_90 + -8) * 0x50;
      }
      for (; lVar12 != local_90; lVar12 = lVar12 + 0x50) {
        local_50 = 0;
        local_48 = 0;
        local_58 = lVar12;
        _create_theme_property_item(this,local_80,pCVar3,(MemberMatch *)&local_58);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
      }
      uVar11 = *(uint *)(this + 0x1b0);
    }
    if (((uVar11 & 0x100) != 0) && (*(long *)(pCVar3 + 0xd0) != 0)) {
      if (uVar7 == 0x1ff) {
        local_58 = 0;
        ...
        if ((_phase_fill_member_items()::{lambda()#8}::operator()()::sname == '\0') &&
           (iVar4 = __cxa_guard_acquire(&_phase_fill_member_items()::{lambda()#8}::operator()()::
                                         sname), iVar4 != 0)) {
      ...
      CowData<DocData::MethodDoc>::_copy_on_write((CowData<DocData::MethodDoc> *)(pCVar3 + 0xd0));
      lVar12 = *(long *)(pCVar3 + 0xd0);
      CowData<DocData::MethodDoc>::_copy_on_write((CowData<DocData::MethodDoc> *)(pCVar3 + 0xd0));
      local_90 = *(long *)(pCVar3 + 0xd0);
      if (local_90 != 0) {
        local_90 = local_90 + *(long *)(local_90 + -8) * 0x78;
      }
      if (lVar12 != local_90) {
        do {
          ...
          local_48 = 0;
          local_58 = lVar12;
          _create_annotation_item(this,(TreeItem *)pSVar6,pCVar3,(MemberMatch *)&local_58);
          CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
          lVar12 = lVar13;
        } while (local_90 != lVar13);
      }
    }
  }
  uVar8 = CONCAT71((int7)((ulong)pCVar3 >> 8),*(int *)(this + 0x218) == 0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
LAB_0010ab0f:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
...
LAB_0010be50:
      ...
      if (param_1[8] != (ClassMatch)0x0) goto LAB_0010be34;
      if (*(long *)(param_1 + 0x10) == 0) goto LAB_0010be50;
...

{
  ...
  if (((byte)this[0x1b3] & 0x40) == 0) {
    if (*(char *)(puVar1 + 4) == '\0') {
      if ((puVar1[5] == 0) || (*(uint *)(puVar1[5] + -8) < 2)) goto LAB_0010bf4b;
      local_28 = 0;
...
LAB_0010bf3f:
    puVar1 = *(undefined8 **)(this + 0x210);
    if (puVar1 != (undefined8 *)0x0) goto LAB_0010bf4b;
  }
  else {
    if (((*(char *)(puVar1 + 4) != '\0') ||
...
LAB_0010c36a:
    uVar23 = *(int *)(this + 0x1d0) - 1;
    if (*(int *)(this + 0x1d0) == 0) goto LAB_0010c1d3;
    plVar16 = (long *)(*(long *)(this + 0x1d8) + (ulong)uVar23 * 8);
    ...
    *plVar16 = lVar15;
    ...
    if (((pSVar22 == (String *)0x0) || (*(long *)pSVar22 == 0)) ||
       (*(uint *)(*(long *)pSVar22 + -8) < 2)) goto LAB_0010c24c;
      ...
      if (((*(long *)(this + 0x198) == 0) || (*(uint *)(*(long *)(this + 0x198) + -8) < 2)) ||
        ...
        if (uVar23 == *(uint *)(this + 0x21c)) {
          ...
          *(void **)(this + 0x220) = pvVar17;
          if (pvVar17 == (void *)0x0) goto LAB_0010c6fd;
          uVar23 = *(uint *)(this + 0x218);
        }
...

{
  ...
  case 0:
    ...
    break;
  case 1:
    if (*(int *)(this + 0x1d0) == 0) goto switchD_0010c7ec_caseD_2;
...
LAB_0010c7f9:
  iVar4 = *(int *)(this + 0x17c);
switchD_0010c7ec_caseD_2:
  *(int *)(this + 0x17c) = iVar4 + 1;
  return 0;
switchD_0010c7ec_caseD_7:
  return 1;
}
          ...
          for (; pSVar26 != local_228; pSVar26 = pSVar26 + 0x78) {
            ...
            if ((cVar13 != '\0') ||
              ...
              if ((int)local_90 == local_90._4_4_) {
                ...
                if (local_88 == (void *)0x0) goto LAB_0010d29e;
              }
          ...
          for (; pSVar26 != local_228; pSVar26 = pSVar26 + 0x60) {
            ...
            if ((cVar13 != '\0') ||
              ...
              if ((int)local_80 == local_80._4_4_) {
                ...
                if (local_78 == (void *)0x0) goto LAB_0010d29e;
              }
          ...
          for (; pSVar26 != local_228; pSVar26 = pSVar26 + 0x78) {
            ...
            if ((cVar13 != '\0') ||
              ...
              if ((int)local_70 == local_70._4_4_) {
                ...
                if (local_68 == (void *)0x0) goto LAB_0010d29e;
              }
          ...
          for (; pSVar26 != local_228; pSVar26 = pSVar26 + 0x50) {
            ...
            if ((cVar13 != '\0') ||
              ...
              if ((int)local_60 == local_60._4_4_) {
                ...
                if (local_58 == (void *)0x0) goto LAB_0010d29e;
              }
            ...
            do {
              ...
              if ((cVar13 != '\0') ||
                ...
                if ((int)local_50 == local_50._4_4_) {
                  ...
                  if (local_48 == (void *)0x0) goto LAB_0010d29e;
                }
...
LAB_0010d078:
  ...
  if (*(long *)(*(long *)(this + 0x1d8) + (ulong)(iVar21 - 1) * 8) != 0) {
    ...
    plVar18 = *(long **)(this + 0x1c8);
    if (plVar18 != (long *)0x0) goto LAB_0010d078;
    iVar21 = *(int *)(this + 0x1d0);
  }
  if (iVar21 == 0) {
LAB_0010dc38:
...
/* WARNING: Removing unreachable block (ram,0x001106e8) */
...
/* WARNING: Removing unreachable block (ram,0x00110758) */
  ...
  *(code **)this = strlen;
  if (bVar1) {
    if (*(long *)(this + 0x9e8) != 0) {
      StringName::unref();
      if (StringName::configured == '\0') goto LAB_00110910;
    }
...

{
  ...
  *(code **)this = strlen;
  if (bVar1) {
    if (*(long *)(this + 0x9e8) != 0) {
      StringName::unref();
      if (StringName::configured == '\0') goto LAB_00110970;
    }
    if (*(long *)(this + 0x9d0) != 0) {
      StringName::unref();
    }
...

{
  ...
  *(code **)this = strlen;
  if (bVar1) {
    if (*(long *)(this + 0x9e8) != 0) {
      StringName::unref();
      if (StringName::configured == '\0') goto LAB_001109d0;
    }
    if (*(long *)(this + 0x9d0) != 0) {
      StringName::unref();
    }
...

{
  ...
  *(code **)this = strlen;
  if (bVar1) {
    if (*(long *)(this + 0x9e8) != 0) {
      StringName::unref();
      if (StringName::configured == '\0') goto LAB_00110a40;
    }
    if (*(long *)(this + 0x9d0) != 0) {
      StringName::unref();
    }
...
/* WARNING: Removing unreachable block (ram,0x00112000) */
...

{
  ...
  if (cVar1 == '\0') {
    ...
    *(undefined8 *)this = 0;
    ...
    pOVar3 = *(Object **)this;
    pOVar2 = pOVar3;
    if (this_00 == (Runner *)pOVar3) goto LAB_00112795;
    *(Runner **)this = this_00;
    ...
    if (((pOVar3 == (Object *)0x0) || (cVar1 = RefCounted::unreference(), cVar1 == '\0')) ||
       (cVar1 = predelete_handler(pOVar3), cVar1 == '\0')) goto LAB_00112795;
  }
...
/* WARNING: Removing unreachable block (ram,0x00112f48) */
  ...
  if (pvVar5 != (void *)0x0) {
    if (*(int *)(this + 0x3c) != 0) {
      ...
      if (uVar2 == 0) {
        ...
        *(undefined4 *)(this + 0x3c) = 0;
        *(undefined1 (*) [16])(this + 0x28) = (undefined1  [16])0x0;
        if (pvVar5 == (void *)0x0) goto LAB_00113274;
      }
    }
    Memory::free_static(pvVar5,false);
  ...
  if (pvVar7 != (void *)0x0) {
    if (*(int *)(this + 0xe2c) != 0) {
      ...
      if (uVar2 == 0) {
        ...
        *(undefined4 *)(this + 0xe2c) = 0;
        *(undefined1 (*) [16])(this + 0xe18) = (undefined1  [16])0x0;
        if (pvVar7 == (void *)0x0) goto LAB_001133c2;
      }
    }
    Memory::free_static(pvVar7,false);
...

{
  ...
  if (uVar3 < (uint)ObjectDB::slot_max) {
    ...
    ObjectDB::spin_lock._0_1_ = '\0';
    if (puVar4[1] == 0) goto LAB_0011364f;
    ...
    if (param_2 == 0) {
      *(undefined4 *)param_4 = 0;
      ...
      if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00113628. Too many branches */
...

{
  ...
  if (uVar3 < (uint)ObjectDB::slot_max) {
    ...
    ObjectDB::spin_lock._0_1_ = '\0';
    if (puVar4[1] == 0) goto LAB_0011386f;
    lVar1 = *(long *)(this + 0x28);
    UNRECOVERED_JUMPTABLE = *(code **)(this + 0x38);
    lVar2 = *(long *)(this + 0x40);
    if (param_2 == 0) {
      *(undefined4 *)param_4 = 0;
      ...
      if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00113848. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        (*UNRECOVERED_JUMPTABLE)((long *)(lVar1 + lVar2),uVar5,UNRECOVERED_JUMPTABLE);
        return;
      }
...

{
  ...
  if (uVar6 < (uint)ObjectDB::slot_max) {
    ...
    ObjectDB::spin_lock._0_1_ = '\0';
    if (puVar7[1] == 0) goto LAB_00113af9;
    lVar1 = *(long *)(this + 0x28);
    UNRECOVERED_JUMPTABLE = *(code **)(this + 0x38);
    lVar2 = *(long *)(this + 0x40);
    if ((uint)param_2 < 2) {
      if (param_2 != 0) {
        *(undefined4 *)param_4 = 0;
        ...
        if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00113aa8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (uVar7 < (uint)ObjectDB::slot_max) {
    ...
    ObjectDB::spin_lock._0_1_ = '\0';
    if (puVar8[1] == 0) goto LAB_00113d78;
    lVar1 = *(long *)(this + 0x28);
    UNRECOVERED_JUMPTABLE = *(code **)(this + 0x38);
    lVar2 = *(long *)(this + 0x40);
    if ((uint)param_2 < 2) {
      if (param_2 != 0) {
        *(undefined4 *)param_4 = 0;
        ...
        if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00113d27. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
LAB_00113fdd:
            ...
            if (pOVar5 != pOVar7) {
              ...
              if (pOVar5 != (Object *)0x0) goto LAB_00113fdd;
            }
          }
        }
  ...
  if (pvVar7 != (void *)0x0) {
    if (*(int *)(this + 0xe2c) != 0) {
      ...
      if (uVar2 == 0) {
        ...
        *(undefined4 *)(this + 0xe2c) = 0;
        *(undefined1 (*) [16])(this + 0xe18) = (undefined1  [16])0x0;
        if (pvVar7 == (void *)0x0) goto LAB_00115002;
      }
    }
    Memory::free_static(pvVar7,false);
    Memory::free_static(*(void **)(this + 0xe10),false);
...
LAB_0011671d:
    ...
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_0011671d;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)pLVar5;
      local_68 = local_80;
      goto joined_r0x0011673f;
    }
...
LAB_00116d5d:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_00116d5d;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)pLVar5;
      local_68 = local_80;
      goto joined_r0x00116d7f;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
LAB_001170dd:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_001170dd;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x001170ff;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
  ...
  if (param_1 < uVar9) {
    ...
    if (*(uint *)(this + 4) < param_1) {
      ...
      *(long *)(this + 8) = lVar7;
      ...
      uVar9 = *(uint *)this;
      if (param_1 <= uVar9) goto LAB_0011941d;
    }
    lVar7 = *(long *)(this + 8);
  ...
  if (pvVar2 != (void *)0x0) {
    if (*(int *)(this + 0x78) != 0) {
      ...
      *(undefined4 *)(this + 0x78) = 0;
      if (pvVar2 == (void *)0x0) goto LAB_0011956e;
    }
    Memory::free_static(pvVar2,false);
  }
LAB_0011956e:
  ...
  if (pvVar2 != (void *)0x0) {
    if (*(int *)(this + 0x68) != 0) {
      ...
      *(undefined4 *)(this + 0x68) = 0;
      if (pvVar2 == (void *)0x0) goto LAB_001195c0;
    }
    Memory::free_static(pvVar2,false);
  }
LAB_001195c0:
  ...
  if (pvVar2 != (void *)0x0) {
    if (*(int *)(this + 0x58) != 0) {
      ...
      *(undefined4 *)(this + 0x58) = 0;
      if (pvVar2 == (void *)0x0) goto LAB_00119610;
    }
    Memory::free_static(pvVar2,false);
  }
LAB_00119610:
  ...
  if (pvVar3 != (void *)0x0) {
    if (*(int *)(this + 0x25c) != 0) {
      ...
      if (uVar1 == 0) {
        ...
        *(undefined4 *)(this + 0x25c) = 0;
        *(undefined1 (*) [16])(this + 0x248) = (undefined1  [16])0x0;
        if (pvVar3 == (void *)0x0) goto LAB_00119985;
      }
    }
    Memory::free_static(pvVar3,false);
...
LAB_00119985:
  ...
  if (pvVar3 != (void *)0x0) {
    if (*(int *)(this + 0x218) != 0) {
      ...
      pvVar3 = *(void **)(this + 0x220);
      *(undefined4 *)(this + 0x218) = 0;
      if (pvVar3 == (void *)0x0) goto LAB_001199e6;
    }
    Memory::free_static(pvVar3,false);
  }
LAB_001199e6:
  ...
  if (pvVar3 != (void *)0x0) {
    if (*(int *)(this + 0x20c) != 0) {
      ...
      if (uVar1 == 0) {
        ...
        *(undefined4 *)(this + 0x20c) = 0;
        *(undefined1 (*) [16])(this + 0x1f8) = (undefined1  [16])0x0;
        if (pvVar3 == (void *)0x0) goto LAB_00119a99;
      }
    }
    Memory::free_static(pvVar3,false);
...
LAB_00119f66:
    ...
    lVar4 = puVar7[-1];
    if (param_1 <= lVar4) goto LAB_00119dff;
  }
  else {
    if (lVar4 != 0) {
      uVar3 = _realloc(this,lVar9);
...

{
  ...
  if (param_2[1] == (TreeItem *)0x0) {
    ...
    if (pTVar22 == (TreeItem *)0x0) goto LAB_0011ae9f;
    if (*(int *)((long)param_2 + 0x2c) != 0) goto LAB_0011b0e8;
LAB_0011aec1:
...
LAB_0011ae9f:
    if ((float)uVar21 * __LC134 < (float)(iVar24 + 1)) goto LAB_0011aec1;
  }
  local_58 = 0;
  if (*(long *)pSVar26 == 0) {
    uVar32 = *in_RCX;
...
LAB_0011b720:
    ...
    *(void **)(this + 8) = __s_00;
    ...
    uVar22 = *(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x28) * 4);
    if (*(long *)(this + 8) == 0) goto LAB_0011b720;
  }
  local_6c = 0;
...

{
  ...
  if (lVar51 == 0) {
    ...
    *(void **)(this + 8) = pvVar43;
    ...
    if (pvVar43 == (void *)0x0) goto LAB_0011c15f;
    if (*(int *)(this + 0x2c) != 0) goto LAB_0011bf46;
LAB_0011c185:
...
LAB_0011c15f:
    if ((float)uVar47 * __LC134 < (float)(iVar44 + 1)) goto LAB_0011c185;
  }
  local_e8 = 0;
...

{
  ...
  do {
    while( true ) {
      ...
      if (*(int *)pEVar6 == 0) goto LAB_0011c7ed;
      if (*(Element **)(pEVar8 + 0x10) == param_1) {
        ...
        *(int *)param_1 = 1;
        pEVar7 = param_1;
        if (pEVar5 == pEVar6) goto LAB_0011c910;
LAB_0011c796:
        *(int *)pEVar5 = 0;
      }
      else {
        ...
        *(int *)pEVar8 = 1;
        pEVar8 = param_1;
        if (pEVar5 != pEVar6) goto LAB_0011c796;
LAB_0011c910:
...
LAB_0011ca02:
          ...
          *(Element **)(lVar3 + 0x18) = pEVar8;
          pEVar7 = *(Element **)(pEVar8 + 0x18);
          *(Element **)(param_1 + 0x18) = pEVar7;
          if (pEVar8 == *(Element **)(pEVar7 + 0x10)) goto LAB_0011ca02;
          *(Element **)(pEVar7 + 8) = param_1;
        }
        ...
        *(int *)param_1 = 1;
        pEVar7 = param_1;
        if (pEVar5 == pEVar6) goto LAB_0011c9d0;
LAB_0011c860:
        *(int *)pEVar5 = 0;
      }
      else {
        ...
        *(int *)pEVar8 = 1;
        pEVar8 = param_1;
        if (pEVar5 != pEVar6) goto LAB_0011c860;
LAB_0011c9d0:
        _err_print_error("_set_color","./core/templates/rb_set.h",0xd0,
                         "Condition \"p_node == _data._nil && p_color == RED\" is true.",0,0);
      }
          ...
          if (*(undefined4 **)(puVar9 + 4) != *(undefined4 **)(this + 8)) {
            do {
              while( true ) {
                ...
                if (-1 < cVar5) goto LAB_0011cbc5;
                puVar4 = *(undefined4 **)(puVar9 + 2);
                if (*(undefined4 **)(this + 8) == *(undefined4 **)(puVar9 + 2)) goto LAB_0011cae0;
              }
              puVar4 = *(undefined4 **)(puVar9 + 4);
...
LAB_0011cae0:
        ...
        *(Element **)(pEVar6 + 0x20) = pEVar7;
        ...
        if (*(Element **)(this + 8) == *(Element **)(pEVar6 + 0x10)) {
          ...
          if (*(Element **)this != pEVar10) goto LAB_0011cb9c;
          *(undefined8 *)(pEVar6 + 0x28) = 0;
          if (pEVar7 != (Element *)0x0) goto LAB_0011cba5;
        }
        else {
          do {
            pEVar8 = pEVar10;
...
LAB_0011cba5:
            *(Element **)(pEVar7 + 0x28) = pEVar6;
            ...
            if (pEVar8 == (Element *)0x0) goto LAB_0011cbb6;
          }
...
LAB_0011d3f0:
    ...
    *(void **)(this + 8) = pvVar44;
    ...
    if (pvVar44 == (void *)0x0) goto LAB_0011cf1f;
    if (*(int *)(this + 0x2c) != 0) goto LAB_0011cd43;
LAB_0011cf45:
...
LAB_0011cf1f:
    if ((float)uVar48 * __LC134 < (float)(iVar45 + 1)) goto LAB_0011cf45;
  }
  local_68 = 0;
          ...
          if (pvVar5 != (void *)0x0) {
            if (*(int *)((long)pvVar6 + 0x44) != 0) {
              ...
              if (uVar2 == 0) {
                ...
                *(undefined4 *)((long)pvVar6 + 0x44) = 0;
                *(undefined1 (*) [16])((long)pvVar6 + 0x30) = (undefined1  [16])0x0;
                if (pvVar5 == (void *)0x0) goto LAB_0011d9c9;
              }
            }
            Memory::free_static(pvVar5,false);

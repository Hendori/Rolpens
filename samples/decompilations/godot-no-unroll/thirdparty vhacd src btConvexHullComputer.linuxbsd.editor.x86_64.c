...
undefined4 VHACD::pointCmp(Point32 *param_1,Point32 *param_2)

{
  ...
  if ((*(int *)(param_2 + 4) <= *(int *)(param_1 + 4)) &&
     (uVar1 = 0, *(int *)(param_1 + 4) == *(int *)(param_2 + 4))) {
    uVar1 = 1;
...
/* VHACD::btConvexHullInternal::Int128::toScalar() const [clone .isra.0] */

undefined8 VHACD::btConvexHullInternal::Int128::toScalar(void)

{
  ...
  if (in_RSI < 0) {
    ...
    return CONCAT44(_UNK_00109374,(uint)((float)lVar1 * _LC0 + fVar4) ^ __LC1);
  }
...
/* VHACD::btConvexHullInternal::Int128::TEMPNAMEPLACEHOLDERVALUE(long) const */

undefined1  [16] __thiscall
VHACD::btConvexHullInternal::Int128::operator*(Int128 *this,long param_1)

{
  ...
  lVar3 = uVar2 + uVar8;
  lVar5 = param_1 * lVar5 +
          (((uVar4 >> 0x20) + (uVar6 >> 0x20) + ((ulong)param_1 >> 0x20) * (uVar7 >> 0x20) +
            (uVar9 >> 0x20) + 1) - (ulong)!CARRY8(uVar2,uVar8));
  if ((char)bVar1 < '\0') {
    bVar10 = lVar3 != 0;
    lVar3 = -lVar3;
...
/* VHACD::btConvexHullInternal::Int128::mul(long, long) */

undefined1  [16] VHACD::btConvexHullInternal::Int128::mul(long param_1,long param_2)
...
/* VHACD::btConvexHullInternal::Int128::mul(unsigned long, unsigned long) */

undefined1  [16] VHACD::btConvexHullInternal::Int128::mul(ulong param_1,ulong param_2)
...
int __thiscall
VHACD::btConvexHullInternal::Rational64::compare(Rational64 *this,Rational64 *param_1)

{
  ...
  uVar5 = (uVar3 >> 0x20) + (uVar10 >> 0x20) + uVar4 * uVar9 + (uVar6 >> 0x20) +
          (ulong)CARRY8(uVar7,uVar5);
  ...
  uVar7 = uVar9 << 0x20;
  uVar3 = uVar2 + uVar7;
  uVar2 = (uVar4 >> 0x20) + (uVar11 >> 0x20) + uVar6 * uVar10 + (uVar9 >> 0x20) +
          (ulong)CARRY8(uVar2,uVar7);
  if (uVar2 <= uVar5) {
    if (uVar5 <= uVar2) {
...
/* VHACD::btConvexHullInternal::Rational128::compare(long) const */

int __thiscall VHACD::btConvexHullInternal::Rational128::compare(Rational128 *this,long param_1)
...
/* VHACD::btConvexHullInternal::newEdgePair(VHACD::btConvexHullInternal::Vertex*,
   VHACD::btConvexHullInternal::Vertex*) */

undefined1 (*) [16] __thiscall
VHACD::btConvexHullInternal::newEdgePair(btConvexHullInternal *this,Vertex *param_1,Vertex *param_2)
...
VHACD::btConvexHullInternal::mergeProjection
  ...
  if (*(long *)(*(Vertex **)(param_1 + 0x18) + 0x68) == *(long *)(pVVar15 + 0x68)) {
    ...
    *(Vertex **)(pVVar2 + 8) = pVVar17;
    if (*(Vertex **)param_2 == pVVar15) {
      if ((*(int *)(pVVar2 + 0x68) < *(int *)(pVVar17 + 0x68)) ||
         ((*(int *)(pVVar2 + 0x68) == *(int *)(pVVar17 + 0x68) &&
          (*(int *)(pVVar2 + 0x6c) < *(int *)(pVVar17 + 0x6c))))) {
    ...
    if (pVVar3 == pVVar15) {
      ...
      if (iVar21 < iVar1) {
        ...
        if ((iVar1 != iVar21) ||
           (iVar12 = *(int *)(pVVar2 + 0x6c), *(int *)(pVVar2 + 0x6c) <= iVar19)) {
...
LAB_001007d3:
      pVVar10 = *(Vertex **)pVVar8;
      pVVar7 = pVVar8;
      pVVar13 = pVVar18;
      if ((pVVar8 != pVVar10) &&
         (iVar16 = *(int *)(pVVar10 + 0x6c) - iVar20, pVVar8 = pVVar10, iVar16 < 1))
      goto LAB_001008b8;
      do {
        ...
        while( true ) {
          ...
          if (((iVar23 < 1) || (-1 < iVar24)) ||
             ((iVar19 = iVar16, iVar14 != 0 &&
              ((-1 < iVar14 || (iVar14 * iVar25 <= iVar24 * iVar12)))))) goto LAB_00100846;
          while( true ) {
            iVar12 = iVar23;
            iVar25 = iVar19 - iVar20;
            if (bVar6) goto LAB_001007d3;
LAB_0010090d:
            pVVar10 = *(Vertex **)(pVVar8 + 8);
            pVVar7 = pVVar8;
            pVVar13 = pVVar18;
            if ((pVVar8 == pVVar10) ||
               (iVar16 = *(int *)(pVVar10 + 0x6c) - iVar20, pVVar8 = pVVar10, 0 < iVar16))
            goto LAB_00100920;
LAB_001008b8:
            iVar23 = (*(int *)(pVVar8 + 0x68) - *(int *)(pVVar7 + 0x68)) * iVar22;
...
LAB_00100989:
        ...
        while( true ) {
          ...
          iVar16 = (*(int *)(pVVar13 + 0x68) - *(int *)(pVVar10 + 0x68)) * iVar22;
          if (((-1 < iVar16) || (iVar24 < 1)) ||
             ((iVar20 = iVar23, iVar14 != 0 &&
              ((-1 < iVar14 || (iVar14 * iVar25 <= iVar24 * iVar12)))))) goto LAB_00100846;
LAB_001009ee:
          iVar12 = iVar16;
          iVar25 = iVar19 - iVar20;
...
LAB_001009fd:
          pVVar13 = *(Vertex **)pVVar18;
          if ((pVVar18 != pVVar13) && (iVar16 = *(int *)(pVVar13 + 0x6c) - iVar19, -1 < iVar16))
          break;
LAB_00100a10:
          pVVar8 = pVVar10;
    ...
    do {
      ...
      pVVar7 = pVVar18;
    } while (((pVVar13 != pVVar10) && (iVar25 == *(int *)(pVVar13 + 0x68))) &&
            (bVar5 = *(int *)(pVVar13 + 0x6c) <= iVar20, iVar20 = *(int *)(pVVar13 + 0x6c), bVar5));
    do {
      pVVar13 = pVVar7;
      if (bVar6) {
    ...
    } while ((iVar25 == *(int *)(pVVar7 + 0x68)) &&
            (bVar5 = iVar19 <= *(int *)(pVVar7 + 0x6c), iVar19 = *(int *)(pVVar7 + 0x6c), bVar5));
LAB_00100846:
    if (bVar6) break;
LAB_00100a26:
    iVar19 = *(int *)(pVVar3 + 0x6c);
...
/* VHACD::btConvexHullInternal::getOrientation(VHACD::btConvexHullInternal::Edge const*,
   ...
   VHACD::btConvexHullInternal::Point32 const&) */

char VHACD::btConvexHullInternal::getOrientation
...

{
  ...
  if ((*(Edge **)param_1 == param_2) && (cVar10 = '\x02', param_2 == *(Edge **)(param_1 + 8))) {
    ...
    return (0 < (long)(iVar5 * iVar6 - iVar9 * iVar4) *
                (long)(*(int *)(param_4 + 8) * *(int *)param_3 -
                      *(int *)(param_3 + 8) * *(int *)param_4) +
                (long)(iVar8 * iVar9 - iVar5 * iVar7) *
                (long)(*(int *)(param_3 + 8) * *(int *)(param_4 + 4) -
                      *(int *)(param_3 + 4) * *(int *)(param_4 + 8)) +
                (long)(iVar4 * iVar7 - iVar8 * iVar6) *
                (long)(*(int *)(param_3 + 4) * *(int *)param_4 -
                      *(int *)param_3 * *(int *)(param_4 + 4))) + '\x01';
  }
  return cVar10;
}
...
/* VHACD::btConvexHullInternal::findMaxAngle(bool, VHACD::btConvexHullInternal::Vertex const*,
   ...
   VHACD::btConvexHullInternal::Point64 const&, VHACD::btConvexHullInternal::Rational64&) */
...
LAB_00100d00:
      ...
      lStack_50 = *(long *)param_4 * (long)iVar7 + *(long *)(param_4 + 8) * (long)iVar8 +
                  *(long *)(param_4 + 0x10) * (long)local_60;
      local_58 = (long)iVar7 * *(long *)param_5 + (long)iVar8 * *(long *)(param_5 + 8) +
                 (long)local_60 * *(long *)(param_5 + 0x10);
      local_48 = 1;
      if (local_58 < 1) {
        if (local_58 == 0) {
          local_58 = 0;
      ...
      pEVar6 = pEVar5;
      if ((iVar7 != 0) ||
         (iVar7 = getOrientation(pEVar5,pEVar4,param_3,(Point32 *)&local_68), pEVar6 = pEVar4,
         (iVar7 == 2) == param_1)) goto LAB_00100d00;
      pEVar4 = *(Edge **)pEVar4;
      pEVar6 = pEVar5;
    } while (pEVar3 != pEVar4);
  }
...
void __thiscall
VHACD::btConvexHullInternal::findEdgeForCoplanarFaces
...

{
  ...
  local_a0 = (int)*(uint *)(pVVar5 + 8) * lVar17 +
             (int)*(uint *)(pVVar5 + 4) * lVar35 + (int)*(uint *)pVVar5 * lVar25;
  pEVar10 = pEVar28;
  if ((pEVar29 != (Edge *)0x0) &&
     (pEVar18 = pEVar29, lVar36 = local_a0, uVar13 = uVar26, uVar32 = uVar21, uVar8 = uVar7,
     param_5 != *(Vertex **)(pEVar29 + 0x18))) {
    do {
      ...
      if (((long)(lVar24 * uVar7 + lVar20 * uVar26 + lVar16 * uVar21) < lVar9) ||
         ((*(int *)(pEVar18 + 0x28) == *(int *)(this + 0xa0) ||
          (local_a0 = uVar7 * lVar35 + uVar26 * lVar25 + uVar21 * lVar17, local_a0 <= lVar36)))) {
...
LAB_001011d0:
  ...
  if ((pEVar10 != (Edge *)0x0) &&
     (uVar13 = (ulong)local_90, uVar32 = (ulong)local_a8, lVar11 = lVar36,
     param_6 != *(Vertex **)(pEVar10 + 0x18))) {
    do {
      ...
      if (((long)(lVar24 * uVar8 + lVar20 * uVar27 + lVar16 * uVar22) < lVar9) ||
         ((*(int *)(pEVar10 + 0x28) == *(int *)(this + 0xa0) ||
          (lVar36 = uVar8 * lVar35 + uVar27 * lVar25 + uVar22 * lVar17, lVar36 <= lVar11)))) {
...
LAB_00101338:
    do {
      ...
      iVar15 = (int)uVar26;
      iVar4 = (int)uVar21;
      lVar9 = (long)(int)((local_a8 - iVar15) * iVar14 + ((int)local_98 - iVar31) * iVar30 +
                         (local_90 - iVar4) * iVar33);
      if (((pEVar28 != (Edge *)0x0) && (*(Vertex **)(pEVar28 + 0x18) != param_5)) &&
         (pEVar10 = *(Edge **)(*(long *)pEVar28 + 0x10),
         *(int *)(this + 0xa0) < *(int *)(pEVar10 + 0x28))) {
        lVar36 = *(long *)(pEVar10 + 0x18);
        uVar1 = *(uint *)(lVar36 + 0x68);
        uVar2 = *(uint *)(lVar36 + 0x6c);
        uVar3 = *(uint *)(lVar36 + 0x70);
        lVar36 = (long)(int)((uVar2 - iVar31) * iVar30 + (uVar1 - iVar15) * iVar14 +
                            (uVar3 - iVar4) * iVar33);
        lVar11 = (int)(uVar3 - iVar4) * lVar17 +
                 (int)(uVar1 - iVar15) * lVar25 + (int)(uVar2 - iVar31) * lVar35;
        if (lVar11 == 0) {
          if (lVar36 < 0) {
LAB_00101b06:
            uVar21 = (ulong)uVar3;
            uVar7 = (ulong)uVar2;
            uVar26 = (ulong)uVar1;
            local_a0 = (int)(local_a8 - uVar1) * lVar25 + (int)((int)local_98 - uVar2) * lVar35 +
                       (int)(local_90 - uVar3) * lVar17;
      ...
      pEVar28 = *param_4;
      if (((pEVar28 == (Edge *)0x0) || (*(Vertex **)(pEVar28 + 0x18) == param_6)) ||
         (pEVar28 = (Edge *)**(long **)(pEVar28 + 0x10),
         *(int *)(pEVar28 + 0x28) <= *(int *)(this + 0xa0))) goto LAB_001015b7;
      ...
      lVar11 = (int)(uVar1 - iVar15) * lVar25 + (iVar19 - iVar31) * lVar35 +
               (int)(uVar2 - iVar4) * lVar17;
...
LAB_001015b7:
  ...
  do {
    while( true ) {
      ...
      iVar4 = (int)uVar7;
      iVar31 = (int)uVar21;
      lVar9 = (long)(int)((local_a8 - iVar15) * iVar14 + ((int)local_98 - iVar4) * iVar30 +
                         (local_90 - iVar31) * iVar33);
      if (((pEVar29 == (Edge *)0x0) || (*(Vertex **)(pEVar29 + 0x18) == param_6)) ||
         (pEVar10 = *(Edge **)(*(long *)(pEVar29 + 8) + 0x10),
         *(int *)(pEVar10 + 0x28) <= *(int *)(this + 0xa0))) break;
      lVar36 = *(long *)(pEVar10 + 0x18);
      uVar1 = *(uint *)(lVar36 + 0x70);
      uVar2 = *(uint *)(lVar36 + 0x6c);
      uVar3 = *(uint *)(lVar36 + 0x68);
      lVar36 = (long)(int)((uVar2 - (int)local_98) * iVar30 + (uVar3 - local_a8) * iVar14 +
                          (uVar1 - local_90) * iVar33);
      lVar11 = (int)(uVar1 - local_90) * lVar17 +
               (int)(uVar3 - local_a8) * lVar25 + (int)(uVar2 - (int)local_98) * lVar35;
      if (lVar11 != 0) {
        if (lVar11 < 0) {
          local_68 = 0xffffffff;
          if (lVar36 < 1) {
...
LAB_001017bb:
      ...
      *param_4 = pEVar29;
      local_a0 = (int)(uVar3 - iVar15) * lVar25 + (int)(uVar2 - iVar4) * lVar35 +
                 (int)(uVar1 - iVar31) * lVar17;
      local_a8 = uVar3;
      local_90 = uVar1;
    }
    pEVar29 = *param_3;
    if (((pEVar29 == (Edge *)0x0) || (*(Vertex **)(pEVar29 + 0x18) == param_5)) ||
       (pEVar29 = *(Edge **)(*(long *)(pEVar29 + 0x10) + 8),
       *(int *)(pEVar29 + 0x28) <= *(int *)(this + 0xa0))) goto LAB_001015b7;
    ...
    lVar11 = (int)(local_a8 - uVar3) * lVar25 + (int)((int)local_98 - uVar2) * lVar35 +
             (int)(local_90 - uVar1) * lVar17;
...
/* VHACD::btConvexHullInternal::merge(VHACD::btConvexHullInternal::IntermediateHull&,
   VHACD::btConvexHullInternal::IntermediateHull&) [clone .part.0] */

void __thiscall
VHACD::btConvexHullInternal::merge
          (btConvexHullInternal *this,IntermediateHull *param_1,IntermediateHull *param_2)
  ...
  if (cVar5 == '\0') {
    ...
    if (pEVar13 == (Edge *)0x0) {
      ...
      do {
        ...
        if ((lVar9 * lVar24 + lVar17 * lVar26 == 0) &&
           (0 < lVar9 * lVar8 + lVar17 * lVar23 + (*(int *)(lVar1 + 0x70) - iVar21) * lVar16)) {
...
LAB_00101f60:
        pEVar10 = *(Edge **)pEVar10;
      } while (pEVar13 != pEVar10);
      local_98 = (Edge *)0x0;
      pEVar13 = *(Edge **)(pVVar25 + 0x10);
      if (pEVar13 == (Edge *)0x0) {
joined_r0x00102b90:
        if (local_168 == (Edge *)0x0) goto LAB_0010212a;
      }
      else {
LAB_00101f8e:
        ...
        do {
          ...
          if ((lVar9 * lVar24 + lVar17 * lVar26 == 0) &&
             (0 < lVar9 * lVar8 + lVar17 * lVar23 + (*(int *)(lVar1 + 0x70) - iVar7) * lVar16)) {
...
LAB_0010212a:
  ...
  while( true ) {
    ...
    pEVar10 = (Edge *)findMaxAngle(this,false,pVVar27,(Point32 *)&local_c8,local_160,local_158,
                                   (Rational64 *)local_138);
    local_48 = 0;
    local_58 = (undefined1  [16])0x0;
    pEVar11 = (Edge *)findMaxAngle(this,true,pVVar25,(Point32 *)&local_c8,local_160,local_158,
    ...
    if (pEVar10 == (Edge *)0x0) {
      ...
      if (bVar29) {
LAB_00102410:
        pEVar12 = (Edge *)newEdgePair(this,pVVar27,pVVar25);
        pEVar19 = pEVar12;
...
LAB_00102470:
        ...
        findEdgeForCoplanarFaces
                  (this,pVVar27,pVVar25,&local_d8,&local_d0,(Vertex *)0x0,(Vertex *)0x0);
        iVar7 = 0;
        pEVar19 = pEVar13;
        pEVar12 = local_120;
...
LAB_001021de:
      ...
      iVar7 = -1;
      if ((bVar29) || (iVar21 = -1, -1 < local_68)) goto LAB_00102410;
LAB_0010277e:
      iVar7 = iVar21;
...
joined_r0x00102575:
    if ((local_128 == pVVar27) && (local_108 == pVVar25)) {
      if (local_118 == 0) {
...
/* VHACD::btConvexHullInternal::computeInternal(int, int,
   VHACD::btConvexHullInternal::IntermediateHull&) */

void __thiscall
VHACD::btConvexHullInternal::computeInternal
    ...
    if (iVar2 == 0) {
      ...
      *(undefined1 (*) [16])(param_3 + 0x10) = (undefined1  [16])0x0;
      ...
      if (iVar6 < param_2) {
        ...
        do {
          lVar1 = *plVar5;
          if (((*(int *)(lVar4 + 0x68) != *(int *)(lVar1 + 0x68)) ||
              (*(int *)(lVar4 + 0x6c) != *(int *)(lVar1 + 0x6c))) ||
             (*(int *)(lVar4 + 0x70) != *(int *)(lVar1 + 0x70))) break;
          iVar2 = iVar2 + 1;
          plVar5 = plVar5 + 1;
        } while (param_2 != iVar2);
      }
...
/* VHACD::btConvexHullInternal::toBtVector(VHACD::btConvexHullInternal::Point32 const&) */

void __thiscall VHACD::btConvexHullInternal::toBtVector(btConvexHullInternal *this,Point32 *param_1)
...
/* VHACD::btConvexHullInternal::getBtNormal(VHACD::btConvexHullInternal::Face*) */

void __thiscall VHACD::btConvexHullInternal::getBtNormal(btConvexHullInternal *this,Face *param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* VHACD::btConvexHullInternal::getCoordinates(VHACD::btConvexHullInternal::Vertex const*) */

void __thiscall
VHACD::btConvexHullInternal::getCoordinates(btConvexHullInternal *this,Vertex *param_1)
...
int __thiscall
VHACD::btConvexHullInternal::Rational128::compare(Rational128 *this,Rational128 *param_1)

{
  ...
  if (iVar1 == *(int *)(param_1 + 0x20)) {
    if (iVar1 != 0) {
      if (this[0x24] == (Rational128)0x0) {
        DMul<VHACD::btConvexHullInternal::Int128,unsigned_long>::mul
                  (*(undefined8 *)this,*(undefined8 *)(this + 8),*(undefined8 *)(param_1 + 0x10),
                   *(undefined8 *)(param_1 + 0x18),&local_68,&local_58);
        DMul<VHACD::btConvexHullInternal::Int128,unsigned_long>::mul
                  (*(undefined8 *)(this + 0x10),*(undefined8 *)(this + 0x18),*(undefined8 *)param_1,
                   *(undefined8 *)(param_1 + 8),&local_48,&local_38);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* VHACD::btConvexHullInternal::shiftFace(VHACD::btConvexHullInternal::Face*, float,
   VHACD::btAlignedObjectArray<VHACD::btConvexHullInternal::Vertex*>) */

undefined8 __thiscall
VHACD::btConvexHullInternal::shiftFace
          (uint param_2,btConvexHullInternal *this,Face *param_1,long param_4)

{
  ...
  if ((iVar42 != 0 || iVar32 != 0) || iVar29 != 0) {
    ...
    lVar21 = (long)(*(int *)(param_1 + 0x38) * *(int *)(param_1 + 0x30) -
                   *(int *)(param_1 + 0x28) * *(int *)(param_1 + 0x40));
    iVar42 = iVar42 + *(int *)(param_1 + 0x20);
    lVar16 = (long)(*(int *)(param_1 + 0x40) * *(int *)(param_1 + 0x2c) -
                   *(int *)(param_1 + 0x30) * *(int *)(param_1 + 0x3c));
    iVar32 = iVar32 + *(int *)(param_1 + 0x1c);
    lVar26 = (long)(*(int *)(param_1 + 0x28) * *(int *)(param_1 + 0x3c) -
                   *(int *)(param_1 + 0x2c) * *(int *)(param_1 + 0x38));
    lVar25 = iVar29 * lVar16 + iVar32 * lVar21 + iVar42 * lVar26;
    if (lVar25 < *(int *)(param_1 + 0x18) * lVar16 + lVar21 * *(int *)(param_1 + 0x1c) +
                 *(int *)(param_1 + 0x20) * lVar26) {
...
LAB_00103c4c:
    ...
    while( true ) {
      ...
      local_190 = plVar13;
      if ((plVar18 != (long *)0x0) && (local_190 = plVar18, plVar13 == plVar18)) break;
...
LAB_001047ec:
        if (plVar13 == local_1e0) goto LAB_001047f1;
LAB_00104836:
        iVar7 = *(int *)(param_4 + 4);
...
LAB_001047f1:
        ...
        lVar21 = plVar18[4];
        lVar9 = (long)(*(int *)(lVar21 + 0x38) * *(int *)(lVar21 + 0x30) -
                      *(int *)(lVar21 + 0x28) * *(int *)(lVar21 + 0x40));
        lVar40 = (long)(*(int *)(lVar21 + 0x28) * *(int *)(lVar21 + 0x3c) -
                       *(int *)(lVar21 + 0x2c) * *(int *)(lVar21 + 0x38));
        lVar22 = (long)(*(int *)(lVar21 + 0x2c) * *(int *)(lVar21 + 0x40) -
                       *(int *)(lVar21 + 0x30) * *(int *)(lVar21 + 0x3c));
        lVar26 = plVar10[4];
        lVar17 = (long)(*(int *)(lVar26 + 0x28) * *(int *)(lVar26 + 0x3c) -
                       *(int *)(lVar26 + 0x2c) * *(int *)(lVar26 + 0x38));
        lVar30 = (long)(*(int *)(lVar26 + 0x30) * *(int *)(lVar26 + 0x38) -
                       *(int *)(lVar26 + 0x28) * *(int *)(lVar26 + 0x40));
        lVar33 = (long)(*(int *)(lVar26 + 0x2c) * *(int *)(lVar26 + 0x40) -
                       *(int *)(lVar26 + 0x3c) * *(int *)(lVar26 + 0x30));
        lVar34 = *(int *)(param_1 + 0x2c) * lVar9 + *(int *)(param_1 + 0x28) * lVar22 +
                 lVar40 * *(int *)(param_1 + 0x30);
        lVar41 = lVar40 * *(int *)(param_1 + 0x40) +
                 *(int *)(param_1 + 0x3c) * lVar9 + *(int *)(param_1 + 0x38) * lVar22;
        lVar35 = *(int *)(param_1 + 0x2c) * lVar30 + *(int *)(param_1 + 0x28) * lVar33 +
                 *(int *)(param_1 + 0x30) * lVar17;
        lVar16 = *(int *)(param_1 + 0x3c) * lVar30 + *(int *)(param_1 + 0x38) * lVar33 +
                 *(int *)(param_1 + 0x40) * lVar17;
        lVar21 = (*(int *)(lVar21 + 0x20) - iVar42) * lVar40 +
                 (*(int *)(lVar21 + 0x1c) - iVar32) * lVar9 +
                 (*(int *)(lVar21 + 0x18) - iVar29) * lVar22;
        lVar26 = (*(int *)(lVar26 + 0x18) - iVar29) * lVar33 +
                 (*(int *)(lVar26 + 0x1c) - iVar32) * lVar30 +
                 (*(int *)(lVar26 + 0x20) - iVar42) * lVar17;
        auVar47 = Int128::mul(lVar41,lVar35);
        auVar48 = Int128::mul(lVar34,lVar16);
        uVar36 = auVar48._0_8_ - auVar47._0_8_;
        lVar9 = ((auVar48._8_8_ + -1) - auVar47._8_8_) + (ulong)(uVar36 < auVar48._0_8_) +
                (ulong)(auVar47._0_8_ == 0);
        ...
        *(undefined1 (*) [16])(pauVar15[1] + 8) = (undefined1  [16])0x0;
        ...
        lVar17 = (ulong)CARRY8(auVar47._0_8_,uVar38) +
                 (((auVar49._8_8_ + -2 + auVar51._8_8_ + auVar47._8_8_) - auVar50._8_8_) -
                 auVar48._8_8_) + (ulong)(auVar48._0_8_ == 0) + (ulong)(auVar50._0_8_ == 0) +
                 (ulong)CARRY8(auVar49._0_8_,uVar37) + (ulong)(uVar37 < auVar51._0_8_) +
                 (ulong)(uVar38 < uVar31);
        ...
        lVar22 = (ulong)CARRY8(auVar47._0_8_,uVar38) +
                 (((auVar49._8_8_ + -2 + auVar51._8_8_ + auVar47._8_8_) - auVar50._8_8_) -
                 auVar48._8_8_) + (ulong)(auVar48._0_8_ == 0) + (ulong)(auVar50._0_8_ == 0) +
                 (ulong)CARRY8(auVar49._0_8_,uVar37) + (ulong)(uVar37 < auVar51._0_8_) +
                 (ulong)(uVar38 < uVar31);
        ...
        *(ulong *)(pauVar15[2] + 8) = uVar31;
        lVar16 = (((auVar49._8_8_ + -2 + auVar51._8_8_ + auVar47._8_8_) - auVar50._8_8_) -
                 auVar48._8_8_) + (ulong)(auVar48._0_8_ == 0) + (ulong)(auVar50._0_8_ == 0) +
                 (ulong)CARRY8(auVar49._0_8_,uVar27) + (ulong)(uVar27 < auVar51._0_8_) +
                 (ulong)CARRY8(auVar47._0_8_,uVar38) + (ulong)(uVar38 < uVar37);
...
LAB_00104c8b:
            lVar16 = VHACD::btAlignedAllocInternal((long)iVar6 << 3,0x10);
            pvVar28 = *(void **)(param_4 + 0x10);
            iVar7 = *(int *)(param_4 + 4);
            if (iVar7 < 1) {
...
LAB_00104647:
        *(undefined8 *)(lVar16 + (long)iVar7 * 8) = 0;
        pVVar1 = (Vertex *)plVar18[3];
...
LAB_00105596:
  if ((local_158 < local_1c0) || (local_1c0 = iVar5, local_158 < iVar5)) goto LAB_00105000;
  if (iVar5 < 1) {
LAB_00105798:
    if (iVar5 != 0) {
      pvVar28 = *(void **)(param_4 + 0x10);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* VHACD::btConvexHullInternal::shrink(float, float) */

void __thiscall
VHACD::btConvexHullInternal::shrink(btConvexHullInternal *this,float param_1,float param_2)
...
LAB_00105c6c:
  ...
  *(float *)((long)&local_58 + (long)*(int *)(this + 0xa4) * 4) = fVar33;
  ...
  do {
    ...
    fVar34 = (auVar38._4_4_ - fVar32) * auVar37._4_4_ + auVar37._0_4_ * (auVar38._0_4_ - fVar33) +
             (auVar38._8_4_ - fVar36) * auVar37._8_4_;
    if (fVar35 <= fVar34) {
      fVar34 = fVar35;
    }
    fVar35 = fVar34;
...
LAB_001064c1:
    ...
    if (iVar19 != (int)plVar30[5]) {
      ...
      *(int *)(puVar15 + 6) = iVar10 - iVar11;
      puVar15[5] = CONCAT44((int)((ulong)uVar2 >> 0x20) - (int)((ulong)uVar7 >> 0x20),
                            (int)uVar2 - (int)uVar7);
...
LAB_00106581:
      ...
      while( true ) {
        if ((lVar28 != 0) && (lVar21 != 0)) {
          ...
          uVar12 = (long)(iVar11 * iVar10 - iVar27 * iVar18) *
                   (long)(*(int *)(lVar5 + 0x70) - iVar4) +
                   (long)(*(int *)(lVar5 + 0x68) - iVar26) *
                   (long)(iVar22 * iVar18 - iVar11 * iVar24) +
                   (long)(iVar24 * iVar27 - iVar22 * iVar10) *
                   (long)(*(int *)(lVar5 + 0x6c) - iVar3);
          uVar23 = (long)(*(int *)(lVar28 + 0x68) + *(int *)(lVar5 + 0x68) + *(int *)(lVar21 + 0x68)
                         + iVar26) * uVar12;
          bVar31 = CARRY8(uVar23,local_e0);
          local_e0 = uVar23 + local_e0;
          uVar17 = (long)(*(int *)(lVar28 + 0x6c) + *(int *)(lVar5 + 0x6c) + *(int *)(lVar21 + 0x6c)
                         + iVar3) * uVar12;
          local_110 = ((local_110 + 1) - (ulong)!bVar31) + ((long)uVar23 >> 0x3f);
          bVar31 = CARRY8(uVar17,local_d0);
          local_d0 = uVar17 + local_d0;
          uVar23 = (long)(*(int *)(lVar28 + 0x70) + *(int *)(lVar5 + 0x70) + *(int *)(lVar21 + 0x70)
                         + iVar4) * uVar12;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* VHACD::btConvexHullInternal::compute(void const*, bool, int, int) */

void __thiscall
VHACD::btConvexHullInternal::compute
      ...
      if (fVar44 <= fVar42) {
        *(undefined4 *)(this + 0xac) = 0;
        if (fVar42 < fVar40) {
          uVar23 = 2;
          uVar12 = 1;
          if (fVar42 < fVar44) goto LAB_001072a7;
        }
...
LAB_00106b96:
  ...
  *(float *)(this + 0x18) = fVar34;
  ...
  if (-1 < param_4) {
    if (param_4 != 0) {
      pauVar14 = (undefined1 (*) [16])VHACD::btAlignedAllocInternal((long)param_4 << 4,0x10);
      if ((int)local_94 < 1) {
...
LAB_00106cab:
      ...
      do {
        *pauVar16 = (undefined1  [16])0x0;
        pauVar16 = pauVar16 + 1;
      } while (pauVar14 + param_4 != pauVar16);
      ...
      if (param_2) {
        do {
          ...
          *(ulong *)(*pauVar16 + 8) = CONCAT44(iVar21,(int)fVar45);
          pauVar16 = pauVar16 + 1;
          iVar21 = iVar9;
        } while (param_4 != iVar9);
      }
        ...
        do {
          ...
          param_1 = (void *)((long)param_1 + (long)param_3);
          local_58 = CONCAT44(((float)((ulong)uVar33 >> 0x20) - fVar42) * fVar39,
                              ((float)uVar33 - fVar40) * fVar37);
...
LAB_00107491:
        ...
        if (iVar26 == iVar9) {
          if (*(int *)*pauVar16 < iVar21) goto LAB_00107491;
          if ((*(int *)*pauVar16 != iVar21) || (iVar4 <= *(int *)(*pauVar16 + 8)))
          goto LAB_00106deb;
          iVar20 = iVar20 + 1;
          pauVar16 = pauVar16 + 1;
          iVar19 = iVar19 + 1;
...
LAB_00106deb:
        for (pauVar25 = pauVar14 + iVar28;
            (iVar31 = *(int *)(*pauVar25 + 4), iVar31 != iVar9 && iVar9 <= iVar31 ||
            ((iVar31 == iVar9 &&
             ((iVar21 < *(int *)*pauVar25 ||
              ((*(int *)*pauVar25 == iVar21 && (iVar4 < *(int *)(*pauVar25 + 8)))))))));
            pauVar25 = pauVar25 + -1) {
          iVar28 = iVar28 + -1;
        }
        iVar31 = iVar20;
        if (iVar20 <= iVar28) {
          ...
          *(undefined8 *)(*pauVar25 + 8) = uVar33;
          iVar31 = iVar19;
          if (iVar19 <= iVar28) goto LAB_00107491;
        }
        if (0 < iVar28) {
          iVar26 = 1;
          iVar19 = 0;
          pauVar16 = pauVar14 + (iVar28 >> 1);
          iVar21 = *(int *)(*pauVar16 + 8);
          iVar9 = *(int *)*pauVar16;
          ...
          do {
            ...
            if ((iVar4 <= iVar30) &&
               ((iVar30 != iVar4 ||
                ((iVar9 <= *(int *)*pauVar16 &&
                 ((*(int *)*pauVar16 != iVar9 || (iVar21 <= *(int *)(*pauVar16 + 8))))))))) {
              for (pauVar25 = pauVar14 + iVar20;
                  (iVar27 = *(int *)(*pauVar25 + 4), iVar27 != iVar4 && iVar4 <= iVar27 ||
                  ((iVar27 == iVar4 &&
                   ((iVar9 < *(int *)*pauVar25 ||
                    ((*(int *)*pauVar25 == iVar9 && (iVar21 < *(int *)(*pauVar25 + 8)))))))));
                  pauVar25 = pauVar25 + -1) {
                iVar20 = iVar20 + -1;
              }
              iVar27 = iVar19;
              if (iVar20 < iVar19) goto LAB_001075ae;
              uVar33 = *(undefined8 *)(*pauVar16 + 8);
              uVar12 = *(undefined4 *)*pauVar16;
              iVar20 = iVar20 + -1;
              uVar8 = *(undefined8 *)(*pauVar25 + 8);
              ...
              *(undefined8 *)(*pauVar25 + 8) = uVar33;
              iVar27 = iVar26;
              if (iVar20 < iVar26) goto LAB_001075ae;
            }
            iVar19 = iVar19 + 1;
            pauVar16 = pauVar16 + 1;
            iVar26 = iVar26 + 1;
  ...
  if (0 < iVar20) {
    ...
    do {
      ...
      if ((iVar4 <= iVar32) &&
         ((iVar32 != iVar4 ||
          ((iVar21 <= *(int *)*pauVar16 &&
           ((*(int *)*pauVar16 != iVar21 || (iVar9 <= *(int *)(*pauVar16 + 8))))))))) {
        for (pauVar25 = pauVar14 + iVar19;
            (iVar29 = *(int *)(*pauVar25 + 4), iVar29 != iVar4 && iVar4 <= iVar29 ||
            ((iVar29 == iVar4 &&
             ((iVar21 < *(int *)*pauVar25 ||
              ((*(int *)*pauVar25 == iVar21 && (iVar9 < *(int *)(*pauVar25 + 8)))))))));
            pauVar25 = pauVar25 + -1) {
          iVar19 = iVar19 + -1;
        }
        iVar29 = iVar26;
        if (iVar19 < iVar26) goto LAB_001079e7;
        uVar33 = *(undefined8 *)(*pauVar16 + 8);
        iVar19 = iVar19 + -1;
        uVar12 = *(undefined4 *)*pauVar16;
        uVar8 = *(undefined8 *)(*pauVar25 + 8);
        ...
        *(undefined8 *)(*pauVar25 + 8) = uVar33;
        iVar29 = iVar30;
        if (iVar19 < iVar30) goto LAB_001079e7;
      }
      iVar26 = iVar26 + 1;
      pauVar16 = pauVar16 + 1;
      iVar30 = iVar30 + 1;
...
LAB_001075b7:
  if (iVar27 < iVar28) {
    ...
    do {
      ...
      if ((iVar4 == iVar30 || iVar4 < iVar30) &&
         ((iVar4 != iVar30 ||
          ((iVar9 <= *(int *)*pauVar14 &&
           ((*(int *)*pauVar14 != iVar9 || (iVar21 <= *(int *)(*pauVar14 + 8))))))))) {
        for (pauVar16 = local_88 + iVar26;
            (iVar4 < *(int *)(*pauVar16 + 4) ||
            ((iVar4 == *(int *)(*pauVar16 + 4) &&
             ((iVar9 < *(int *)*pauVar16 ||
              ((*(int *)*pauVar16 == iVar9 && (iVar21 < *(int *)(*pauVar16 + 8)))))))));
        ...
        iVar32 = iVar20;
        if (iVar26 < iVar20) goto LAB_00107643;
        ...
        *(undefined8 *)(*pauVar16 + 8) = uVar33;
        iVar32 = iVar19;
        if (iVar26 < iVar19) goto LAB_00107643;
      }
      pauVar14 = pauVar14 + 1;
      iVar20 = iVar20 + 1;
    } while( true );
  ...
  if (iVar31 < iVar10) {
    ...
    do {
      ...
      if ((iVar4 <= iVar30) &&
         ((iVar30 != iVar4 ||
          ((iVar9 <= *(int *)*pauVar14 &&
           ((iVar9 != *(int *)*pauVar14 || (iVar21 <= *(int *)(*pauVar14 + 8))))))))) {
        for (pauVar25 = local_88 + iVar19;
            (iVar27 = *(int *)(*pauVar25 + 4), iVar27 != iVar4 && iVar4 <= iVar27 ||
            ((iVar27 == iVar4 &&
             ((iVar9 < *(int *)*pauVar25 ||
              ((iVar9 == *(int *)*pauVar25 && (iVar21 < *(int *)(*pauVar25 + 8)))))))));
            pauVar25 = pauVar25 + -1) {
          iVar19 = iVar19 + -1;
        }
        iVar27 = iVar20;
        if (iVar19 < iVar20) goto LAB_00106eab;
        uVar12 = *(undefined4 *)*pauVar14;
        iVar19 = iVar19 + -1;
        uVar33 = *(undefined8 *)(*pauVar14 + 8);
        uVar8 = *(undefined8 *)(*pauVar25 + 8);
        ...
        *(undefined8 *)(*pauVar25 + 8) = uVar33;
        iVar27 = iVar28;
        if (iVar19 < iVar28) goto LAB_00106eab;
      }
      pauVar14 = pauVar14 + 1;
      iVar28 = iVar28 + 1;
      iVar20 = iVar20 + 1;
...
LAB_001079e7:
  if (0 < iVar19) {
    btAlignedObjectArray<VHACD::btConvexHullInternal::Point32>::
    quickSortInternal<bool(VHACD::btConvexHullInternal::Point32_const&,VHACD::btConvexHullInternal::Point32_const&)>
              (local_98,pointCmp,0,iVar19);
  }
  if (iVar29 < iVar20) {
    btAlignedObjectArray<VHACD::btConvexHullInternal::Point32>::
    quickSortInternal<bool(VHACD::btConvexHullInternal::Point32_const&,VHACD::btConvexHullInternal::Point32_const&)>
              (local_98,pointCmp,iVar29,iVar20);
  }
  goto LAB_001075b7;
LAB_00107643:
  if (iVar27 < iVar26) {
    btAlignedObjectArray<VHACD::btConvexHullInternal::Point32>::
    quickSortInternal<bool(VHACD::btConvexHullInternal::Point32_const&,VHACD::btConvexHullInternal::Point32_const&)>
              (local_98,pointCmp,iVar27,iVar26);
  }
  if (iVar32 < iVar28) {
    btAlignedObjectArray<VHACD::btConvexHullInternal::Point32>::
    quickSortInternal<bool(VHACD::btConvexHullInternal::Point32_const&,VHACD::btConvexHullInternal::Point32_const&)>
              (local_98,pointCmp,iVar32,iVar28);
  }
  goto LAB_00106e1c;
LAB_001078af:
  if (iVar31 < iVar20) {
    btAlignedObjectArray<VHACD::btConvexHullInternal::Point32>::
    quickSortInternal<bool(VHACD::btConvexHullInternal::Point32_const&,VHACD::btConvexHullInternal::Point32_const&)>
              (local_98,pointCmp,iVar31,iVar20);
  }
  if (iVar32 < iVar19) {
    btAlignedObjectArray<VHACD::btConvexHullInternal::Point32>::
    quickSortInternal<bool(VHACD::btConvexHullInternal::Point32_const&,VHACD::btConvexHullInternal::Point32_const&)>
              (local_98,pointCmp,iVar32,iVar19);
  }
  goto LAB_00106eb9;
LAB_00106f33:
  if (iVar27 < iVar19) {
    btAlignedObjectArray<VHACD::btConvexHullInternal::Point32>::
    quickSortInternal<bool(VHACD::btConvexHullInternal::Point32_const&,VHACD::btConvexHullInternal::Point32_const&)>
              (local_98,pointCmp,iVar27,iVar19);
  }
  if (iVar31 < iVar10) {
    btAlignedObjectArray<VHACD::btConvexHullInternal::Point32>::
    quickSortInternal<bool(VHACD::btConvexHullInternal::Point32_const&,VHACD::btConvexHullInternal::Point32_const&)>
              (local_98,pointCmp,iVar31,iVar10);
  }
  goto LAB_00107006;
LAB_00106eab:
  if (iVar31 < iVar19) {
    ...
    do {
      ...
      if ((iVar4 <= iVar30) &&
         ((iVar30 != iVar4 ||
          ((iVar9 <= *(int *)*pauVar16 &&
           ((*(int *)*pauVar16 != iVar9 || (iVar21 <= *(int *)(*pauVar16 + 8))))))))) {
        for (pauVar14 = local_88 + iVar20;
            (iVar32 = *(int *)(*pauVar14 + 4), iVar32 != iVar4 && iVar4 <= iVar32 ||
            ((iVar32 == iVar4 &&
             ((iVar9 < *(int *)*pauVar14 ||
              ((*(int *)*pauVar14 == iVar9 && (iVar21 < *(int *)(*pauVar14 + 8)))))))));
            pauVar14 = pauVar14 + -1) {
        ...
        iVar32 = iVar28;
        if (iVar20 < iVar28) goto LAB_001078af;
        iVar20 = iVar20 + -1;
        uVar33 = *(undefined8 *)(*pauVar16 + 8);
        uVar12 = *(undefined4 *)*pauVar16;
        ...
        *(undefined8 *)(*pauVar14 + 8) = uVar33;
        iVar32 = iVar26;
        if (iVar20 < iVar26) goto LAB_001078af;
      }
      pauVar16 = pauVar16 + 1;
      iVar26 = iVar26 + 1;
      iVar28 = iVar28 + 1;
  ...
  if (iVar27 < iVar10) {
    ...
    do {
      ...
      if ((iVar9 <= iVar26) &&
         ((iVar26 != iVar9 ||
          ((iVar21 <= *(int *)*pauVar16 &&
           ((*(int *)*pauVar16 != iVar21 || (iVar4 <= *(int *)(*pauVar16 + 8))))))))) {
        for (pauVar14 = local_88 + iVar19;
            (iVar31 = *(int *)(*pauVar14 + 4), iVar31 != iVar9 && iVar9 <= iVar31 ||
            ((iVar31 == iVar9 &&
             ((iVar21 < *(int *)*pauVar14 ||
              ((*(int *)*pauVar14 == iVar21 && (iVar4 < *(int *)(*pauVar14 + 8)))))))));
            pauVar14 = pauVar14 + -1) {
          iVar19 = iVar19 + -1;
        }
        iVar31 = iVar28;
        if (iVar19 < iVar28) goto LAB_00106f33;
        uVar33 = *(undefined8 *)(*pauVar16 + 8);
        iVar19 = iVar19 + -1;
        uVar12 = *(undefined4 *)*pauVar16;
        uVar8 = *(undefined8 *)(*pauVar14 + 8);
        ...
        *(undefined8 *)(*pauVar14 + 8) = uVar33;
        iVar31 = iVar20;
        if (iVar19 < iVar20) goto LAB_00106f33;
      }
      pauVar16 = pauVar16 + 1;
      iVar28 = iVar28 + 1;
    } while( true );
...
LAB_00107006:
  ...
  *(undefined8 *)(this + 0x28) = *(undefined8 *)(this + 0x20);
  if ((param_4 < iVar21) || (param_4 <= iVar21)) goto LAB_00107055;
  if (*(int *)(this + 0x88) < param_4) {
    if (param_4 == 0) {
      ...
      lVar15 = VHACD::btAlignedAllocInternal((long)param_4 << 3,0x10);
      iVar9 = *(int *)(this + 0x84);
    }
    pvVar5 = *(void **)(this + 0x90);
    lVar24 = 0;
    if (iVar9 < 1) {
      if (pvVar5 != (void *)0x0) goto LAB_00107322;
    }
    else {
      do {
        *(undefined8 *)(lVar15 + lVar24) = *(undefined8 *)((long)pvVar5 + lVar24);
        lVar24 = lVar24 + 8;
      } while (lVar24 != (long)iVar9 * 8);
LAB_00107322:
    ...
    *(long *)(this + 0x90) = lVar15;
    *(int *)(this + 0x88) = param_4;
  }
  memset((void *)(*(long *)(this + 0x90) + (long)iVar21 * 8),0,
         (ulong)((param_4 - iVar21) - 1) * 8 + 8);
LAB_00107055:
    ...
    do {
      ...
      if (pauVar14 == (undefined1 (*) [16])0x0) {
        ...
        if (puVar18 == (undefined8 *)0x0) {
          ...
          puVar18[2] = 0;
          *(int *)(puVar18 + 1) = iVar21;
          pauVar14 = (undefined1 (*) [16])VHACD::btAlignedAllocInternal((long)iVar21 << 7,0x10);
      ...
      *(undefined8 *)pauVar14[2] = 0;
      uVar33 = *(undefined8 *)(*local_88 + lVar15 * 2);
      uVar8 = *(undefined8 *)((long)(*local_88 + lVar15 * 2) + 8);
      *(undefined4 *)(pauVar14[7] + 8) = 0xffffffff;
      *(undefined8 *)(pauVar14[6] + 8) = uVar33;
      *(undefined8 *)pauVar14[7] = uVar8;
      *(undefined1 (**) [16])(lVar24 + lVar15) = pauVar14;
      lVar15 = lVar15 + 8;
    } while (lVar15 != (long)param_4 * 8);
  }
...
/* VHACD::btConvexHullComputer::compute(void const*, bool, int, int, float, float) */

void __thiscall
VHACD::btConvexHullComputer::compute
          (btConvexHullComputer *this,void *param_1,bool param_2,int param_3,int param_4,
...

{
  ...
  if (0.0 < param_5) {
    in_XMM1_Db = 0;
    fVar28 = (float)btConvexHullInternal::shrink(local_108,param_5,param_6);
    fVar30 = param_6;
    if (fVar28 < 0.0) {
      if ((*(void **)(this + 0x10) != (void *)0x0) && (this[0x18] != (btConvexHullComputer)0x0)) {
        VHACD::btAlignedFreeInternal(*(void **)(this + 0x10));
  ...
  if (iVar7 < 0) {
    ...
    if (*(int *)(this + 8) < 0) {
      if ((pvVar23 != (void *)0x0) && (this[0x18] != (btConvexHullComputer)0x0)) {
        VHACD::btAlignedFreeInternal(pvVar23);
      }
      this[0x18] = (btConvexHullComputer)0x1;
      pvVar23 = (void *)0x0;
      *(undefined8 *)(this + 0x10) = 0;
    ...
    pauVar10 = (undefined1 (*) [16])((long)iVar7 * 0x10 + (long)pvVar23);
    pauVar1 = pauVar10 + (uint)-iVar7;
    do {
  ...
  *(undefined4 *)(this + 4) = 0;
  if ((int)uVar3 < 0) {
    ...
    if (*(int *)(this + 0x28) < 0) {
      if ((pvVar23 != (void *)0x0) && (this[0x38] != (btConvexHullComputer)0x0)) {
        VHACD::btAlignedFreeInternal(pvVar23);
      }
      this[0x38] = (btConvexHullComputer)0x1;
      pvVar23 = (void *)0x0;
    ...
    puVar11 = (undefined8 *)((long)pvVar23 + (long)(int)uVar3 * 0xc);
    do {
      *puVar11 = 0;
      puVar12 = (undefined8 *)((long)puVar11 + 0xc);
      *(undefined4 *)(puVar11 + 1) = 0;
      puVar11 = puVar12;
    } while ((undefined8 *)((long)pvVar23 + ((long)(int)uVar3 + 1 + (ulong)~uVar3) * 0xc) != puVar12
            );
  }
  iVar7 = *(int *)(this + 0x44);
  *(undefined4 *)(this + 0x24) = 0;
  if (iVar7 < 0) {
    ...
    if (*(int *)(this + 0x48) < 0) {
      if ((pvVar23 != (void *)0x0) && (this[0x58] != (btConvexHullComputer)0x0)) {
        VHACD::btAlignedFreeInternal(pvVar23);
      }
      this[0x58] = (btConvexHullComputer)0x1;
      pvVar23 = (void *)0x0;
    ...
    memset((void *)((long)pvVar23 + (long)iVar7 * 4),0,(ulong)(uint)-iVar7 << 2);
  }
  *(undefined4 *)(this + 0x44) = 0;
  if (*(int *)(local_50 + 0x78) < 0) {
    ...
    *local_158 = (long)local_50;
    ...
    pVVar26 = local_50;
    do {
      uVar29 = btConvexHullInternal::getCoordinates(local_108,pVVar26);
      iVar8 = *(int *)(this + 4);
      uVar5 = CONCAT44(in_XMM1_Db,fVar30);
      if (iVar8 == *(int *)(this + 8)) {
        iVar24 = iVar8 * 2;
        if (iVar8 == 0) {
          iVar24 = 1;
        }
        if (iVar24 <= iVar8) goto LAB_00108019;
        lVar18 = VHACD::btAlignedAllocInternal((long)iVar24 << 4,0x10);
        pvVar23 = *(void **)(this + 0x10);
        iVar8 = *(int *)(this + 4);
        if (iVar8 < 1) {
          if (pvVar23 != (void *)0x0) goto LAB_001082b3;
        }
        else {
          lVar14 = 0;
          do {
            uVar6 = ((undefined8 *)((long)pvVar23 + lVar14))[1];
            *(undefined8 *)(lVar18 + lVar14) = *(undefined8 *)((long)pvVar23 + lVar14);
            ((undefined8 *)(lVar18 + lVar14))[1] = uVar6;
            lVar14 = lVar14 + 0x10;
          } while (lVar14 != (long)iVar8 * 0x10);
LAB_001082b3:
...
LAB_00108019:
      ...
      puVar11 = *(undefined8 **)(pVVar26 + 0x10);
      puVar12 = (undefined8 *)(lVar18 + (long)iVar8 * 0x10);
      *puVar12 = uVar29;
      puVar12[1] = uVar5;
      *(int *)(this + 4) = iVar8 + 1;
      iVar8 = (int)lVar27;
      if (puVar11 == (undefined8 *)0x0) {
        if (iVar7 <= iVar8 + 1) goto LAB_001080cb;
      }
      else {
        iVar24 = -1;
        puVar12 = puVar11;
          ...
          if (iVar9 < 0) {
            ...
            if (iVar9 == iVar17) {
              ...
              if (iVar17 <= iVar9) {
                ...
                iVar22 = iVar9 + 1;
                puVar2 = (undefined8 *)(lVar18 + (long)iVar9 * 0xc);
                *puVar2 = 0;
                *(undefined4 *)(puVar2 + 1) = 0;
                goto LAB_0010818f;
              }
              lVar18 = VHACD::btAlignedAllocInternal((long)iVar17 * 0xc,0x10);
              iVar21 = *(int *)(this + 0x24);
              pvVar23 = *(void **)(this + 0x30);
              if (iVar21 < 1) {
                if (pvVar23 != (void *)0x0) goto LAB_0010841c;
              }
              else {
                lVar14 = 0;
                do {
                  *(undefined8 *)(lVar18 + lVar14) = *(undefined8 *)((long)pvVar23 + lVar14);
                  *(undefined4 *)(lVar18 + 8 + lVar14) = *(undefined4 *)((long)pvVar23 + lVar14 + 8)
                  ;
                  lVar14 = lVar14 + 0xc;
                } while (lVar14 != (long)iVar21 * 0xc);
LAB_0010841c:
              ...
              iVar22 = iVar21 + 1;
              *(int *)(this + 0x28) = iVar17;
              this[0x38] = (btConvexHullComputer)0x1;
              puVar2 = (undefined8 *)(lVar18 + (long)iVar21 * 0xc);
              *(long *)(this + 0x30) = lVar18;
              *puVar2 = 0;
              *(undefined4 *)(puVar2 + 1) = 0;
              *(int *)(this + 0x24) = iVar22;
              if (iVar17 == iVar22) {
LAB_00108462:
                iVar17 = iVar22 * 2;
                if (SBORROW4(iVar22,iVar17) != 0 < iVar22) goto LAB_001082de;
              }
            }
            else {
              lVar18 = *(long *)(this + 0x30);
              ...
              *(int *)(this + 0x24) = iVar22;
              if (iVar17 == iVar22) {
                iVar17 = 1;
                if (iVar22 != 0) goto LAB_00108462;
LAB_001082de:
                lVar18 = VHACD::btAlignedAllocInternal((long)iVar17 * 0xc,0x10);
                iVar22 = *(int *)(this + 0x24);
                pvVar23 = *(void **)(this + 0x30);
                if (iVar22 < 1) {
                  if (pvVar23 != (void *)0x0) goto LAB_00108367;
                }
                else {
                  lVar14 = 0;
                  do {
                    *(undefined8 *)(lVar18 + lVar14) = *(undefined8 *)((long)pvVar23 + lVar14);
                    *(undefined4 *)(lVar18 + 8 + lVar14) =
                         *(undefined4 *)((long)pvVar23 + lVar14 + 8);
                    lVar14 = lVar14 + 0xc;
                  } while (lVar14 != (long)iVar22 * 0xc);
LAB_00108367:
                  if (this[0x38] != (btConvexHullComputer)0x0) {
                    VHACD::btAlignedFreeInternal(pvVar23);
                    iVar22 = *(int *)(this + 0x24);
...
LAB_0010818f:
            puVar2 = (undefined8 *)(lVar18 + (long)iVar22 * 0xc);
            *puVar2 = 0;
            *(undefined4 *)(puVar2 + 1) = 0;
            *(int *)(this + 0x24) = iVar22 + 1;
            lVar14 = lVar18 + (long)iVar9 * 0xc;
            *(int *)(puVar12 + 5) = iVar9;
            lVar18 = lVar18 + 0xc + (long)iVar9 * 0xc;
            lVar19 = puVar12[3];
            *(int *)(puVar12[2] + 0x28) = iVar9 + 1;
            iVar9 = *(int *)(lVar19 + 0x78);
            *(undefined4 *)(lVar14 + 4) = 1;
            *(undefined4 *)(lVar18 + 4) = 0xffffffff;
            iVar17 = iVar7;
            if (iVar9 < 0) {
              *(int *)(lVar19 + 0x78) = iVar7;
              plVar15 = local_158;
              if (local_110 == iVar7) {
                if (iVar7 == 0) {
                  plVar15 = (long *)VHACD::btAlignedAllocInternal(8,0x10);
                  local_110 = 1;
LAB_00108536:
...
LAB_00108626:
                  ...
                  iVar9 = iVar7 * 2;
                  if (SBORROW4(iVar7,iVar9) != 0 < iVar7) {
                    plVar15 = (long *)VHACD::btAlignedAllocInternal((long)iVar9 << 3,0x10);
                    local_110 = iVar9;
                    if (iVar7 < 1) goto LAB_00108536;
                    lVar16 = 0;
                    do {
                      *(undefined8 *)((long)plVar15 + lVar16) =
                           *(undefined8 *)((long)local_158 + lVar16);
                      lVar16 = lVar16 + 8;
                    } while (lVar16 != (long)iVar7 * 8);
                    goto LAB_00108626;
                  }
                }
              }
              local_158 = plVar15;
              local_158[iVar7] = lVar19;
              iVar17 = iVar7 + 1;
              iVar9 = iVar7;
            }
            *(int *)(lVar14 + 8) = iVar9;
          ...
          if (iVar25 < 0) {
            ...
            puVar12 = (undefined8 *)*puVar12;
            *(int *)(*(long *)(this + 0x30) + (long)iVar9 * 0xc) = iVar25 - iVar9;
          }
          iVar25 = iVar9;
        } while (puVar11 != puVar12);
        *(int *)(*(long *)(this + 0x30) + (long)iVar24 * 0xc) = iVar9 - iVar24;
        if (iVar7 <= iVar8 + 1) goto LAB_001080cb;
      }
      lVar27 = lVar27 + 1;
      pVVar26 = (Vertex *)local_158[lVar27];
    } while( true );
  }
  goto LAB_00107dde;
LAB_001080cb:
    ...
    if (plVar4 != (long *)0x0) {
      do {
        ...
        if (-1 < iVar7) {
          iVar8 = *(int *)(this + 0x44);
          lVar18 = (long)iVar8;
          if (iVar8 == *(int *)(this + 0x48)) {
            iVar24 = iVar8 * 2;
            if (iVar8 == 0) {
              iVar24 = 1;
            }
            if (iVar24 <= iVar8) goto LAB_0010811d;
            lVar14 = VHACD::btAlignedAllocInternal((long)iVar24 << 2,0x10);
            lVar18 = (long)*(int *)(this + 0x44);
            pvVar23 = *(void **)(this + 0x50);
            if (*(int *)(this + 0x44) < 1) {
              if (pvVar23 != (void *)0x0) goto LAB_001084d1;
            }
            else {
              lVar19 = 0;
              do {
                *(undefined4 *)(lVar14 + lVar19) = *(undefined4 *)((long)pvVar23 + lVar19);
                lVar19 = lVar19 + 4;
              } while (lVar19 != lVar18 * 4);
LAB_001084d1:
...
LAB_0010811d:
          ...
          *(int *)(lVar14 + lVar18 * 4) = iVar7;
          *(int *)(this + 0x44) = *(int *)(this + 0x44) + 1;
          plVar13 = plVar20;
          do {
            *(undefined4 *)(plVar13 + 5) = 0xffffffff;
            plVar13 = *(long **)(plVar13[2] + 8);
          } while (plVar20 != plVar13);
        }
        plVar20 = (long *)*plVar20;
      } while (plVar4 != plVar20);
    }
    plVar15 = plVar15 + 1;
  } while (plVar15 != local_158 + lVar27 + 1);
  if (local_158 != (long *)0x0) {
    VHACD::btAlignedFreeInternal(local_158);
  }
LAB_00107dde:
  ...
  puVar11 = (undefined8 *)local_a8._0_8_;
  if ((undefined8 *)local_a8._0_8_ == (undefined8 *)0x0) goto LAB_00107e6c;
  do {
    local_a8._0_8_ = puVar11[2];
    VHACD::btAlignedFreeInternal((void *)*puVar11);
    VHACD::btAlignedFreeInternal(puVar11);
    puVar11 = (undefined8 *)local_a8._0_8_;
  } while ((undefined8 *)local_a8._0_8_ != (undefined8 *)0x0);
  puVar11 = (undefined8 *)local_c8._0_8_;
  if ((undefined8 *)local_c8._0_8_ == (undefined8 *)0x0) goto LAB_00107eac;
  do {
    local_c8._0_8_ = puVar11[2];
    VHACD::btAlignedFreeInternal((void *)*puVar11);
    VHACD::btAlignedFreeInternal(puVar11);
LAB_00107e6c:
    puVar11 = (undefined8 *)local_c8._0_8_;
  } while ((undefined8 *)local_c8._0_8_ != (undefined8 *)0x0);
  puVar11 = (undefined8 *)local_e8._0_8_;
  while (puVar11 != (undefined8 *)0x0) {
    local_e8._0_8_ = puVar11[2];
    VHACD::btAlignedFreeInternal((void *)*puVar11);
    VHACD::btAlignedFreeInternal(puVar11);
LAB_00107eac:
    puVar11 = (undefined8 *)local_e8._0_8_;
...
/* VHACD::btConvexHullInternal::Vertex::dot(VHACD::btConvexHullInternal::Point64 const&) const */

Point64 * VHACD::btConvexHullInternal::Vertex::dot(Point64 *param_1)

{
  ...
  if (*(int *)(in_RSI + 0x74) < 0) {
    ...
    lVar4 = auVar10._8_8_ + auVar9._8_8_ + auVar8._8_8_ + (ulong)CARRY8(auVar10._0_8_,auVar9._0_8_)
            + (ulong)CARRY8(auVar8._0_8_,uVar5);
    if (lVar4 < 0) {
  ...
  lVar4 = *(int *)(in_RSI + 0x68) * lVar7 + *(int *)(in_RSI + 0x6c) * lVar4 +
...
/* VHACD::btConvexHullInternal::DMul<VHACD::btConvexHullInternal::Int128, unsigned
   ...
   VHACD::btConvexHullInternal::Int128&, VHACD::btConvexHullInternal::Int128&) */

void VHACD::btConvexHullInternal::DMul<VHACD::btConvexHullInternal::Int128,unsigned_long>::mul
...

{
  ...
  uVar8 = (uVar2 * param_3 >> 0x20) + (uVar5 * param_1 >> 0x20) + param_3 * param_1 +
          (uVar8 >> 0x20) + (ulong)CARRY8(uVar2 * uVar5,uVar9);
  param_4 = param_4 >> 0x20;
  uVar12 = (uVar2 * param_4 & 0xffffffff) + (param_1 * uVar10 & 0xffffffff);
  uVar13 = uVar12 << 0x20;
  uVar3 = uVar2 * uVar10 + uVar13;
  uVar14 = param_2 & 0xffffffff;
  uVar12 = (uVar2 * param_4 >> 0x20) + (param_1 * uVar10 >> 0x20) + param_1 * param_4 +
           (uVar12 >> 0x20) + (ulong)CARRY8(uVar2 * uVar10,uVar13);
  param_2 = param_2 >> 0x20;
  uVar13 = (uVar5 * param_2 & 0xffffffff) + (param_3 * uVar14 & 0xffffffff);
  uVar15 = uVar13 << 0x20;
  uVar6 = uVar5 * uVar14 + uVar15;
  uVar4 = param_3 * param_2 + (param_3 * uVar14 >> 0x20) + (uVar5 * param_2 >> 0x20) +
          (uVar13 >> 0x20) + (ulong)CARRY8(uVar5 * uVar14,uVar15);
  ...
  lVar7 = (uVar16 >> 0x20) +
          param_4 * param_2 + (param_4 * uVar14 >> 0x20) + (uVar10 * param_2 >> 0x20) +
          (ulong)CARRY8(uVar10 * uVar14,uVar17) + (ulong)CARRY8(uVar12,uVar11);
  uVar12 = uVar13 + uVar4;
...
void __thiscall
VHACD::btAlignedObjectArray<VHACD::btConvexHullInternal::Point32>::
quickSortInternal<bool(VHACD::btConvexHullInternal::Point32_const&,VHACD::btConvexHullInternal::Point32_const&)>
          (btAlignedObjectArray<VHACD::btConvexHullInternal::Point32> *this,
          _func_bool_Point32_ptr_Point32_ptr *param_1,int param_2,int param_3)

{
  ...
  if (param_2 < iVar8) {
    ...
    do {
      ...
      if (bVar4) {
        ...
        local_88 = local_94 + -1;
        if (iVar9 < local_88) goto LAB_00108d57;
        lVar5 = *(long *)(this + 0x10);
        iVar9 = iVar9 + -1;
        ...
        *puVar7 = uVar1;
        puVar7[1] = uVar2;
        local_88 = local_94;
        if (iVar9 < local_94) goto LAB_00108d57;
      }
  ...
  goto LAB_00108c3a;
LAB_0010924d:
  if (param_2 < (int)local_a0) {
    quickSortInternal<bool(VHACD::btConvexHullInternal::Point32_const&,VHACD::btConvexHullInternal::Point32_const&)>
              (this,param_1,param_2,(int)local_a0);
  }
  if (iVar10 < iVar9) {
    quickSortInternal<bool(VHACD::btConvexHullInternal::Point32_const&,VHACD::btConvexHullInternal::Point32_const&)>
              (this,param_1,iVar10,iVar9);
  }
  goto LAB_00108d62;
LAB_00108e04:
  if (local_88 < iVar10) {
    quickSortInternal<bool(VHACD::btConvexHullInternal::Point32_const&,VHACD::btConvexHullInternal::Point32_const&)>
              (this,param_1,local_88,iVar10);
  }
  if (iVar9 < iVar8) {
    quickSortInternal<bool(VHACD::btConvexHullInternal::Point32_const&,VHACD::btConvexHullInternal::Point32_const&)>
              (this,param_1,iVar9,iVar8);
  }
  goto LAB_00108c3a;
LAB_00108f1f:
  if (local_98 < iVar8) {
    ...
    do {
      ...
      if (bVar4) {
        ...
        iVar10 = local_88 + -1;
        if (iVar9 < local_88 + -1) goto LAB_00109158;
        lVar5 = *(long *)(this + 0x10);
        iVar9 = iVar9 + -1;
        ...
        *puVar12 = uVar1;
        puVar12[1] = uVar2;
        iVar10 = local_88;
        if (iVar9 < local_88) goto LAB_00109158;
      }
  ...
  if (local_94 < param_3) {
    ...
    do {
      ...
      if (bVar4) {
        ...
        if (iVar9 < iVar8) goto LAB_00108fcc;
        lVar5 = *(long *)(this + 0x10);
        iVar9 = iVar9 + -1;
        puVar7 = (undefined8 *)(lVar5 + lVar11);
        puVar12 = (undefined8 *)(lVar5 + lVar6);
        ...
        *puVar7 = uVar2;
        puVar7[1] = uVar3;
        iVar8 = (int)local_a0;
        if (iVar9 < (int)local_a0) goto LAB_00108fcc;
      }
      lVar6 = lVar6 + 0x10;
      iVar8 = (int)local_a0;
    } while( true );
...
LAB_00109158:
  if (local_98 < iVar9) {
    quickSortInternal<bool(VHACD::btConvexHullInternal::Point32_const&,VHACD::btConvexHullInternal::Point32_const&)>
              (this,param_1,local_98,iVar9);
  }
  if (iVar10 < iVar8) {
    quickSortInternal<bool(VHACD::btConvexHullInternal::Point32_const&,VHACD::btConvexHullInternal::Point32_const&)>
              (this,param_1,iVar10,iVar8);
  }
  goto LAB_00108f2c;
LAB_00108fcc:
  if (local_94 < iVar9) {
    quickSortInternal<bool(VHACD::btConvexHullInternal::Point32_const&,VHACD::btConvexHullInternal::Point32_const&)>
              (this,param_1,local_94,iVar9);
  }
  if (iVar8 < param_3) {
    quickSortInternal<bool(VHACD::btConvexHullInternal::Point32_const&,VHACD::btConvexHullInternal::Point32_const&)>
              (this,param_1,iVar8,param_3);
  }
  goto LAB_00108c48;
LAB_00108d57:
  if (param_2 < iVar9) {
    ...
    do {
      ...
      if (bVar4) {
        ...
        iVar10 = local_84 + -1;
        if ((int)local_a0 < local_84 + -1) goto LAB_0010924d;
        lVar5 = *(long *)(this + 0x10);
        local_a0._0_4_ = (int)local_a0 + -1;
        ...
        *puVar12 = uVar1;
        puVar12[1] = uVar2;
        iVar10 = local_84;
        if ((int)local_a0 < local_84) goto LAB_0010924d;
      }
      local_90 = local_90 + 0x10;
      local_84 = local_84 + 1;
    } while( true );
  ...
  if (local_88 < iVar8) {
    ...
    do {
      ...
      if (bVar4) {
        ...
        if (iVar10 < iVar9) goto LAB_00108e04;
        lVar5 = *(long *)(this + 0x10);
        iVar10 = iVar10 + -1;
        ...
        *puVar12 = uVar2;
        puVar12[1] = uVar3;
        iVar9 = local_94;
        if (iVar10 < local_94) goto LAB_00108e04;
      }
      local_a0 = local_a0 + 0x10;
      iVar9 = local_94;
    } while( true );
  ...
  if (local_98 < param_3) {
    ...
    do {
      ...
      if (bVar4) {
        ...
        if (iVar8 < local_94) goto LAB_00108f1f;
        lVar5 = *(long *)(this + 0x10);
        iVar8 = iVar8 + -1;
        puVar7 = (undefined8 *)(lVar5 + lVar11);
        puVar12 = (undefined8 *)(lVar5 + lVar6);
        ...
        *puVar7 = uVar1;
        ...
        if (iVar8 < (int)local_a0) goto LAB_00108f1f;
      }
      local_a0._0_4_ = (int)local_a0 + 1;
      lVar6 = lVar6 + 0x10;
    } while( true );

...

{
  ...
  *(undefined8 *)(this + 0x78) = 0xb;
  ...
  } while (pNVar6 != &NoteGnuProperty_4_00100f60);
...

{
  ...
  if (sVar10 < 0x10) {
    ...
    else if (sVar10 != 0) goto LAB_00100829;
  }
  else {
  ...
  if (uVar9 == 0) {
    ...
    for (plVar21 = *(long **)(this + 0x18); plVar21 != (long *)0x0; plVar21 = (long *)*plVar21) {
      while (plVar21[3] == sVar10) {
        if (sVar10 == 0) goto LAB_001006a6;
        do {
          iVar8 = memcmp(__s1,(void *)plVar21[2],sVar10);
          if (iVar8 == 0) goto LAB_001006a6;
          plVar21 = (long *)*plVar21;
          if (plVar21 == (long *)0x0) goto LAB_00100630;
        } while (plVar21[3] == sVar10);
        plVar21 = (long *)*plVar21;
        if (plVar21 == (long *)0x0) goto LAB_00100630;
      }
...
LAB_00100721:
    ...
    if (uVar9 == 0) goto LAB_00100650;
  }
  else {
    sVar10 = plVar12[3];
    __s1 = (char *)plVar12[2];
    local_70 = local_60;
    if (sVar10 != 0) goto LAB_00100721;
    uVar18 = *(ulong *)(this + 0x10);
    uVar20 = 0x811c9dc5;
    auVar5._8_8_ = 0;
    auVar5._0_8_ = uVar18;
  ...
  if (puVar25 != (undefined8 *)0x0) {
    ...
    while (((puVar22 = puVar3, uVar23 != uVar20 || (sVar10 != puVar22[3])) ||
      ...
      if ((puVar3 == (undefined8 *)0x0) ||
         (uVar23 = puVar3[7], puVar25 = puVar22, uVar23 % uVar18 != uVar16)) goto LAB_00100650;
    }
    plVar21 = (long *)*puVar25;
    if (plVar21 != (long *)0x0) goto LAB_001006a6;
  }
LAB_00100650:
    ...
    while (uVar18 = uVar9, plVar24 = plVar21, plVar21 != (long *)0x0) {
      while( true ) {
        ...
        **(undefined8 **)pTVar1 = plVar24;
        plVar24 = plVar21;
        if (plVar21 == (long *)0x0) goto LAB_001008f1;
      }
...

{
  ...
  *(undefined1 *)(*(long *)(unaff_RBP + 0x70) + 0xb) = 0;
  ...
  } while (pNVar5 != &NoteGnuProperty_4_00100f60);

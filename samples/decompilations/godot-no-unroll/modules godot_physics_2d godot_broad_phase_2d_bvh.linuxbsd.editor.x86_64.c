...

{
  ...
  *(undefined ***)this = &PTR_create_001073d0;
...

{
  ...
  uVar5 = CONCAT44(_LC32._4_4_,(float)_LC32);
...

{
  ...
  uVar7 = CONCAT44(_LC32._4_4_,(float)_LC32);
  do {
...

{
  ...
  do {
    puVar13 = (undefined8 *)
              ...
              ::request((PooledList<BVH_Tree<GodotCollisionObject2D,2,2,128,GodotBroadPhase2DBVH::UserPairTestFunction<GodotCollisionObject2D>,GodotBroadPhase2DBVH::UserCullTestFunction<GodotCollisionObject2D>,true,Rect2,Vector2>::TNode,unsigned_int,true,false>
                         *)(this + 0x78),puVar23);
    *puVar13 = 0x7f7fffff7f7fffff;
    *(undefined4 *)(puVar13 + 2) = 0;
    uVar12 = *puVar23;
    *(undefined4 *)((long)puVar13 + 0x1c) = 0;
    puVar13[1] = uVar4;
    *(uint *)((long)puVar13 + 0x14) = local_6c;
    puVar14 = (undefined4 *)
              PooledList<BVH_Tree<GodotCollisionObject2D,2,2,128,GodotBroadPhase2DBVH::UserPairTestFunction<GodotCollisionObject2D>,GodotBroadPhase2DBVH::UserCullTestFunction<GodotCollisionObject2D>,true,Rect2,Vector2>::TLeaf,unsigned_int,true,false>
              ::request((PooledList<BVH_Tree<GodotCollisionObject2D,2,2,128,GodotBroadPhase2DBVH::UserPairTestFunction<GodotCollisionObject2D>,GodotBroadPhase2DBVH::UserCullTestFunction<GodotCollisionObject2D>,true,Rect2,Vector2>::TLeaf,unsigned_int,true,false>
    ...
    *puVar14 = 0;
    ...
    puVar23 = puVar23 + 1;
    *(int *)(lVar19 + 0x10 + (ulong)uVar12 * 0x20) = -local_54;
  } while (local_78 != puVar23);
  if (local_6c < uVar29) {
    uVar15 = (ulong)*(uint *)(this + 0xa0);
    puVar13 = (undefined8 *)(lVar19 + (ulong)local_6c * 0x20);
    uVar12 = -*(int *)(puVar13 + 2);
    local_88 = (uint *)CONCAT44(local_88._4_4_,uVar12);
    uVar18 = (ulong)uVar12;
    puVar27 = auStack_c8;
    if (uVar12 < *(uint *)(this + 0xa0)) {
      local_b0 = (ulong)uVar12;
      lVar19 = *(long *)(this + 0xa8);
      *(undefined4 *)(puVar13 + 2) = 2;
      uVar29 = *puVar10;
      *(short *)(puVar13 + 3) = (short)uVar29;
      uVar30 = puVar10[1];
      local_90 = (ushort *)(lVar19 + local_b0 * 0xa04);
      *(short *)((long)puVar13 + 0x1a) = (short)uVar30;
      uVar11 = *local_90;
      uVar12 = uVar11 + 1;
      uVar35 = (uint)uVar11;
      local_60 = (BVH_ABB *)CONCAT44(local_60._4_4_,uVar35);
      lVar19 = (long)(int)uVar12;
      uVar31 = uVar12 * 2 + 0x17;
      puVar27 = auStack_c8;
      while (puVar25 != auStack_c8 + -(ulong)(uVar31 & 0x7f000)) {
        puVar24 = puVar27 + -0x1000;
        *(undefined8 *)(puVar27 + -8) = *(undefined8 *)(puVar27 + -8);
        puVar25 = puVar27 + -0x1000;
        puVar27 = puVar27 + -0x1000;
      }
      lVar7 = -(ulong)(uVar31 & 0xff0);
      puVar26 = puVar24 + lVar7;
      if ((ulong)(uVar31 & 0xff0) != 0) {
        *(undefined8 *)(puVar24 + -8) = *(undefined8 *)(puVar24 + -8);
      }
      puVar32 = (ushort *)((ulong)(puVar24 + lVar7 + 0xf) & 0xfffffffffffffff0);
      for (; puVar26 != puVar24 + (lVar7 - (ulong)(uVar31 & 0x7f000)); puVar26 = puVar26 + -0x1000)
      {
        *(undefined8 *)(puVar26 + -8) = *(undefined8 *)(puVar26 + -8);
      }
      lVar7 = -(ulong)(uVar31 & 0xff0);
      puVar28 = puVar26 + lVar7;
      if ((ulong)(uVar31 & 0xff0) != 0) {
        *(undefined8 *)(puVar26 + -8) = *(undefined8 *)(puVar26 + -8);
      }
      local_68 = (BVH_ABB *)((ulong)(puVar26 + lVar7 + 0xf) & 0xfffffffffffffff0);
      uVar15 = lVar19 * 0x10 + 0x10;
      for (; puVar28 != puVar26 + (lVar7 - (uVar15 & 0xfffffffffffff000));
          puVar28 = puVar28 + -0x1000) {
        *(undefined8 *)(puVar28 + -8) = *(undefined8 *)(puVar28 + -8);
      }
      uVar15 = (ulong)((uint)uVar15 & 0xfff);
      lVar7 = -uVar15;
      puVar24 = puVar28 + lVar7;
      if (uVar15 != 0) {
        *(undefined8 *)(puVar28 + -8) = *(undefined8 *)(puVar28 + -8);
      }
      lVar16 = 0;
      pvVar34 = (void *)((ulong)(puVar28 + lVar7 + 0xf) & 0xfffffffffffffff0);
      if (uVar35 != 0) {
        do {
          puVar32[lVar16] = (ushort)lVar16;
          lVar16 = lVar16 + 1;
        } while ((int)lVar16 < (int)uVar35);
        local_a8 = (BVH_ABB *)CONCAT44(local_a8._4_4_,uVar30);
        local_78 = (uint *)CONCAT44(local_78._4_4_,uVar35);
        *(undefined8 *)(puVar28 + lVar7 + -8) = 0x1054eb;
        local_a0 = (BVH_ABB *)this;
        local_98 = lVar19;
        local_70 = uVar29;
        memcpy(pvVar34,local_90 + 0x102,(ulong)uVar35 << 4);
        lVar19 = local_98;
        this = (BVH_Tree<GodotCollisionObject2D,2,2,128,GodotBroadPhase2DBVH::UserPairTestFunction<GodotCollisionObject2D>,GodotBroadPhase2DBVH::UserCullTestFunction<GodotCollisionObject2D>,true,Rect2,Vector2>
                *)local_a0;
        uVar29 = local_70;
        uVar30 = (uint)local_a8;
        uVar11 = (ushort)local_78;
      }
      uVar4 = puVar13[1];
      uVar5 = *puVar13;
      puVar32[uVar35] = uVar11;
      fVar9 = _LC34._4_4_;
      fVar3 = (float)_LC34;
      uVar8 = *(undefined8 *)(local_80 + 8);
      fVar38 = (float)uVar5;
      fVar36 = (float)((uint)uVar4 ^ (uint)_LC18) - fVar38;
      fVar39 = (float)((ulong)uVar5 >> 0x20);
      fVar37 = (float)((uint)((ulong)uVar4 >> 0x20) ^ _LC18._4_4_) - fVar39;
      puVar1 = (undefined8 *)((long)pvVar34 + (ulong)uVar35 * 0x10);
      *puVar1 = *(undefined8 *)local_80;
      puVar1[1] = uVar8;
      local_50 = CONCAT44(fVar9 * fVar37 + fVar39,fVar3 * fVar36 + fVar38);
      local_48[0] = (uint)(fVar36 < fVar37);
      uVar35 = 0;
      iVar21 = 0;
      fVar3 = *(float *)((long)&local_50 + (ulong)local_48[0] * 4);
      local_78 = (uint *)CONCAT44(local_78._4_4_,(uint)(fVar37 <= fVar36));
      local_48[1] = (uint)(fVar37 <= fVar36);
      do {
        while( true ) {
          uVar11 = puVar32[iVar21];
          if (*(float *)((long)pvVar34 + (ulong)local_48[0] * 4 + (ulong)uVar11 * 0x10) <= fVar3)
          break;
          lVar19 = (long)(int)uVar35;
          uVar12 = uVar12 - 1;
          uVar35 = uVar35 + 1;
          *(ushort *)(local_68 + lVar19 * 2) = uVar11;
          lVar19 = (long)(int)uVar12;
          puVar32[iVar21] = puVar32[lVar19];
          if ((int)uVar12 <= iVar21) goto LAB_001055c7;
        }
        iVar21 = iVar21 + 1;
...
LAB_001055c7:
      ...
      if ((int)uVar31 < 0x20) {
        if (0 < (int)uVar35) {
          local_80 = (BVH_ABB *)CONCAT44(local_80._4_4_,uVar31);
          uVar12 = uVar12 + uVar35;
          local_a0 = (BVH_ABB *)CONCAT44(local_a0._4_4_,uVar30);
          local_98 = CONCAT44(local_98._4_4_,uVar29);
          *(undefined8 *)(puVar28 + lVar7 + -8) = 0x10560f;
          local_a8 = (BVH_ABB *)this;
          memcpy(puVar32 + lVar19,local_68,(ulong)uVar35 * 2);
          this = (BVH_Tree<GodotCollisionObject2D,2,2,128,GodotBroadPhase2DBVH::UserPairTestFunction<GodotCollisionObject2D>,GodotBroadPhase2DBVH::UserCullTestFunction<GodotCollisionObject2D>,true,Rect2,Vector2>
                  *)local_a8;
          uVar29 = (uint)local_98;
          uVar31 = (uint)local_80;
          uVar30 = (uint)local_a0;
        }
        if ((int)uVar12 < 1) {
          uVar17 = 0;
          uVar35 = uVar12;
          ...
          do {
            uVar11 = *puVar22;
            puVar22 = puVar22 + 1;
            uVar17 = uVar17 + (*(float *)((long)&local_50 + (long)(int)(uint)local_78 * 4) <
                              *(float *)((long)pvVar34 +
                                        (long)(int)(uint)local_78 * 4 + (ulong)uVar11 * 0x10));
          } while (puVar22 != puVar32 + (int)uVar12);
          uVar35 = uVar12 - uVar17;
        }
        if ((int)uVar17 < (int)uVar35) {
          uVar35 = uVar17;
        }
        uVar17 = uVar31;
        ...
        if ((0 < (int)uVar17) && (uVar31 = local_48[(int)uVar31 < (int)uVar35], 0 < (int)uVar12)) {
          fVar3 = *(float *)((long)&local_50 + (long)(int)uVar31 * 4);
          uVar35 = 0;
          iVar21 = 0;
          do {
            while( true ) {
              uVar11 = puVar32[iVar21];
              if (*(float *)((long)pvVar34 + (long)(int)uVar31 * 4 + (ulong)uVar11 * 0x10) <= fVar3)
              break;
              lVar19 = (long)(int)uVar35;
              uVar12 = uVar12 - 1;
              uVar35 = uVar35 + 1;
              *(ushort *)(local_68 + lVar19 * 2) = uVar11;
              puVar32[iVar21] = puVar32[(int)uVar12];
              if ((int)uVar12 <= iVar21) goto LAB_001056f8;
            }
            iVar21 = iVar21 + 1;
          } while (iVar21 < (int)uVar12);
          goto LAB_001056f8;
...
LAB_00105830:
        uVar12 = uVar12 - 1;
        uVar11 = *puVar32;
        uVar20 = puVar32[(int)uVar12];
        *(ushort *)local_68 = uVar11;
        *puVar32 = uVar20;
        if (uVar12 == 0) {
          uVar35 = 0;
          uVar20 = uVar11;
LAB_0010571b:
          *puVar32 = uVar11;
          uVar12 = 1;
          *(ushort *)local_68 = uVar20;
LAB_0010572c:
          puVar22 = local_90;
          lVar19 = 0;
          uVar29 = uVar29 & 0xffff;
          local_98 = CONCAT44(local_98._4_4_,uVar35);
          local_78 = (uint *)CONCAT44(local_78._4_4_,0xffffffff);
          local_80 = (BVH_ABB *)this;
          while( true ) {
            uVar11 = puVar32[lVar19];
            if ((uint)local_60 == uVar11) {
              local_78 = (uint *)CONCAT44(local_78._4_4_,uVar29);
              this = (BVH_Tree<GodotCollisionObject2D,2,2,128,GodotBroadPhase2DBVH::UserPairTestFunction<GodotCollisionObject2D>,GodotBroadPhase2DBVH::UserCullTestFunction<GodotCollisionObject2D>,true,Rect2,Vector2>
                      *)local_80;
            }
            else {
              uVar30 = *(uint *)(puVar22 + (ulong)uVar11 * 2 + 2);
              *(undefined8 *)(puVar28 + lVar7 + -8) = 0x105780;
              _node_add_item((BVH_Tree<GodotCollisionObject2D,2,2,128,GodotBroadPhase2DBVH::UserPairTestFunction<GodotCollisionObject2D>,GodotBroadPhase2DBVH::UserCullTestFunction<GodotCollisionObject2D>,true,Rect2,Vector2>
                              *)local_80,uVar29,uVar30,
                             (BVH_ABB *)(puVar22 + (ulong)uVar11 * 8 + 0x102));
              this = (BVH_Tree<GodotCollisionObject2D,2,2,128,GodotBroadPhase2DBVH::UserPairTestFunction<GodotCollisionObject2D>,GodotBroadPhase2DBVH::UserCullTestFunction<GodotCollisionObject2D>,true,Rect2,Vector2>
                      *)local_80;
            }
            local_80 = (BVH_ABB *)this;
            if ((int)uVar12 <= (int)lVar19 + 1) break;
            lVar19 = lVar19 + 1;
            uVar29 = (uint)*(ushort *)(puVar13 + 3);
          }
          uVar31 = (uint)local_78;
          if (0 < (int)(uint)local_98) {
            uVar30 = (uint)*(ushort *)((long)puVar13 + 0x1a);
            uVar35 = (uint)local_98;
            goto LAB_001057c0;
          }
        }
        else {
          uVar31 = 0xffffffff;
          uVar35 = 1;
          if (0 < (int)uVar12) goto LAB_0010572c;
LAB_001057c0:
          puVar32 = local_90;
          uVar30 = uVar30 & 0xffff;
          pBVar2 = local_68 + (long)(int)uVar35 * 2;
          pBVar33 = local_68;
          local_68 = (BVH_ABB *)this;
          while( true ) {
            uVar11 = *(ushort *)pBVar33;
            if ((uint)local_60 != uVar11) {
              uVar12 = *(uint *)(puVar32 + (ulong)uVar11 * 2 + 2);
              *(undefined8 *)(puVar28 + lVar7 + -8) = 0x105803;
              _node_add_item((BVH_Tree<GodotCollisionObject2D,2,2,128,GodotBroadPhase2DBVH::UserPairTestFunction<GodotCollisionObject2D>,GodotBroadPhase2DBVH::UserCullTestFunction<GodotCollisionObject2D>,true,Rect2,Vector2>
                              *)local_68,uVar30,uVar12,
                             (BVH_ABB *)(puVar32 + (ulong)uVar11 * 8 + 0x102));
              uVar30 = uVar31;
            }
            uVar31 = uVar30;
            pBVar33 = pBVar33 + 2;
            this = (BVH_Tree<GodotCollisionObject2D,2,2,128,GodotBroadPhase2DBVH::UserPairTestFunction<GodotCollisionObject2D>,GodotBroadPhase2DBVH::UserCullTestFunction<GodotCollisionObject2D>,true,Rect2,Vector2>
                    *)local_68;
            if (pBVar33 == pBVar2) break;
            uVar30 = (uint)*(ushort *)((long)puVar13 + 0x1a);
          }
        }
        uVar12 = *(uint *)((BVH_ABB *)this + 0xa0);
        if ((uint)local_88 < uVar12) goto LAB_001052e8;
        *(undefined8 *)(puVar28 + lVar7 + -8) = 0;
        *(undefined8 *)(puVar28 + lVar7 + -0x10) = 0;
        *(undefined **)(puVar28 + lVar7 + -0x18) = &_LC9;
        *(char **)(puVar28 + lVar7 + -0x20) = "list.size()";
        *(undefined8 *)(puVar28 + lVar7 + -0x28) = 0x10592e;
        local_60 = (BVH_ABB *)this;
        _err_print_index_error
                  ("free","./core/templates/pooled_list.h",0x7b,local_b0,(ulong)uVar12,"p_id",
                   *(char **)(puVar28 + lVar7 + -0x20),*(char **)(puVar28 + lVar7 + -0x18),
                   (bool)puVar28[lVar7 + -0x10],(bool)puVar28[lVar7 + -8]);
        this = (BVH_Tree<GodotCollisionObject2D,2,2,128,GodotBroadPhase2DBVH::UserPairTestFunction<GodotCollisionObject2D>,GodotBroadPhase2DBVH::UserCullTestFunction<GodotCollisionObject2D>,true,Rect2,Vector2>
                *)local_60;
      }
      else {
LAB_001056f8:
        if (uVar35 == 0) goto LAB_00105830;
        if (uVar12 == 0) {
          uVar35 = uVar35 - 1;
          uVar11 = *(ushort *)local_68;
          uVar20 = *(ushort *)(local_68 + (long)(int)uVar35 * 2);
          goto LAB_0010571b;
        }
        if (0 < (int)uVar12) goto LAB_0010572c;
        uVar31 = 0xffffffff;
        if (0 < (int)uVar35) goto LAB_001057c0;
LAB_001052e8:
        uVar12 = *(uint *)((BVH_ABB *)this + 0xb0);
        pvVar34 = *(void **)((BVH_ABB *)this + 0xb8);
        if (uVar12 == *(uint *)((BVH_ABB *)this + 0xb4)) {
          uVar15 = (ulong)(uVar12 * 2);
          if (uVar12 * 2 == 0) {
            uVar15 = 1;
          }
          *(int *)((BVH_ABB *)this + 0xb4) = (int)uVar15;
          *(undefined8 *)(puVar28 + lVar7 + -8) = 0x10598b;
          local_60 = (BVH_ABB *)this;
          pvVar34 = (void *)Memory::realloc_static(pvVar34,uVar15 * 4,false);
          *(void **)(local_60 + 0xb8) = pvVar34;
          if (pvVar34 == (void *)0x0) {
            *(undefined8 *)(puVar28 + lVar7 + -0x10) = 0;
            *(undefined8 *)(puVar28 + lVar7 + -0x18) = 0x105a34;
            _err_print_error("push_back","./core/templates/local_vector.h",0x41,
                             "FATAL: Condition \"!data\" is true.","Out of memory",0);
            *(undefined8 *)(puVar28 + lVar7 + -0x18) = 0x105a39;
            _err_flush_stdout();
                    /* WARNING: Does not return */
            pcVar6 = (code *)invalidInstructionException();
            (*pcVar6)();
          }
          uVar12 = *(uint *)(local_60 + 0xb0);
          this = (BVH_Tree<GodotCollisionObject2D,2,2,128,GodotBroadPhase2DBVH::UserPairTestFunction<GodotCollisionObject2D>,GodotBroadPhase2DBVH::UserCullTestFunction<GodotCollisionObject2D>,true,Rect2,Vector2>
                  *)local_60;
        }
        *(uint *)((BVH_ABB *)this + 0xb0) = uVar12 + 1;
        *(uint *)((long)pvVar34 + (ulong)uVar12 * 4) = (uint)local_88;
        if (*(int *)((BVH_ABB *)this + 0xc0) == 0) {
          *(undefined8 *)(puVar28 + lVar7 + -0x10) = 0;
          *(undefined8 *)(puVar28 + lVar7 + -0x18) = 0x1059dd;
          local_60 = (BVH_ABB *)this;
      ...
      lVar19 = 0;
      while( true ) {
        uVar11 = *(ushort *)((long)puVar13 + lVar19 + 0x18);
        uVar18 = (ulong)uVar11;
        if (uVar12 <= uVar11) break;
        uVar15 = (ulong)*(uint *)(this + 0xa0);
        uVar29 = -*(int *)(uVar18 * 0x20 + *(long *)(this + 0x80) + 0x10);
        if (*(uint *)(this + 0xa0) <= uVar29) {
          uVar18 = (ulong)uVar29;
          puVar27 = puVar28 + lVar7;
          goto LAB_001053aa;
        }
        puVar32 = (ushort *)((ulong)uVar29 * 0xa04 + *(long *)(this + 0xa8));
        uVar20 = *puVar32;
        if (uVar20 != 0) {
          uVar29 = *(uint *)this;
          uVar15 = (ulong)uVar29;
          lVar16 = 0;
          do {
            uVar30 = *(uint *)(puVar32 + lVar16 * 2 + 2);
            uVar18 = (ulong)uVar30;
            puVar27 = puVar28 + lVar7;
            if (uVar29 <= uVar30) goto LAB_001053aa;
            puVar23 = (uint *)(*(long *)(this + 8) + uVar18 * 8);
            puVar23[1] = (uint)lVar16;
            lVar16 = lVar16 + 1;
            *puVar23 = (uint)uVar11;
          } while ((int)lVar16 < (int)(uint)uVar20);
        }
        if (lVar19 == 2) {
          *(undefined8 *)(puVar28 + lVar7 + -8) = 0x105893;
          refit_upward(this,local_6c);
          if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
            *(undefined8 *)(puVar28 + lVar7 + -8) = 0x105a49;
            __stack_chk_fail();
          }
          return uVar31;
        }
      ...
      *(undefined8 *)(puVar28 + lVar7 + -8) = 1;
      uVar15 = (ulong)uVar12;
      *(undefined8 *)(puVar28 + lVar7 + -0x10) = 0;
      *(undefined **)(puVar28 + lVar7 + -0x18) = &_LC9;
      *(char **)(puVar28 + lVar7 + -0x20) = "count";
      goto LAB_001053c5;
    }
  }
  else {
...
LAB_001053aa:
  ...
  *(undefined **)(puVar27 + -0x18) = &_LC9;
  *(char **)(puVar27 + -0x20) = "count";
  puVar24 = puVar27;
LAB_001053c5:
  *(undefined8 *)(puVar24 + -0x28) = 0x1053dd;
  _err_print_index_error
            ("operator[]","./core/templates/local_vector.h",0xb2,uVar18,uVar15,"p_index",
             *(char **)(puVar24 + -0x20),*(char **)(puVar24 + -0x18),(bool)puVar24[-0x10],
             (bool)puVar24[-8]);
  *(undefined8 *)(puVar24 + -8) = 0x1053e6;
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar6 = (code *)invalidInstructionException();
  (*pcVar6)();
  ...
  if (param_1 < *(uint *)(this + 0x78)) {
    do {
      ...
      if (iVar7 == 1) {
        ...
        if ((uint)uVar5 <= (uint)*(ushort *)(lVar9 + 0x1a)) goto LAB_00105b03;
    ...
    if (uVar4 < *(uint *)(this + 0xa0)) {
      ...
      if (uVar2 == *(uint *)(this + 0xb4)) {
        ...
        *(void **)(this + 0xb8) = pvVar5;
        if (pvVar5 == (void *)0x0) goto LAB_00105f80;
        uVar2 = *(uint *)(this + 0xb0);
      }
...
LAB_001061b0:
    ...
    uVar6 = *(uint *)(this + 0x78);
    if (uVar6 <= param_2) goto LAB_0010613d;
      ...
      if (uVar6 < *(uint *)(this + 0xa0)) {
        ...
        if (uVar11 == *(uint *)(this + 0xb4)) {
          ...
          *(void **)(this + 0xb8) = pvVar8;
          if (pvVar8 == (void *)0x0) goto LAB_00106416;
          uVar11 = *(uint *)(this + 0xb0);
        }
...
LAB_00106286:
    ...
    uVar14 = (ulong)uVar11;
    if (uVar6 <= uVar11) goto LAB_0010613d;
...
LAB_00106356:
      ...
      if (*(int *)(lVar7 + 0x10) == 1) goto LAB_00106356;
      ...
      if (uVar13 < *(uint *)(this + 0xa0)) {
        ...
        *(uint *)(puVar12 + uVar16 * 2 + 2) = uVar6;
        if (uVar1 == 0) {
          ...
          uVar10 = uVar4;
          if (uVar4 <= uVar6) goto LAB_001066c8;
      ...
      *(int *)(this + 200) = iVar5;
      ...
      if (uVar3 < uVar1) {
        ...
        *(uint *)((ulong)uVar3 * 0x20 + *(long *)(this + 0x30) + 0x18) = uVar2;
        if (uVar1 <= param_2) goto LAB_00106797;
...
LAB_00106873:
          ...
          if (uVar6 == *(uint *)(this + 0x14)) {
            ...
            *(void **)(this + 0x18) = pvVar8;
            if (pvVar8 == (void *)0x0) goto LAB_00106bf0;
            uVar6 = *(uint *)(this + 0x10);
          }
          ...
          *(uint *)((long)pvVar8 + (ulong)uVar6 * 4) = param_2;
          ...
          if (param_2 < *(uint *)this) goto LAB_00106873;
          _err_print_index_error
        ...
        if ((((fStack_40 < pfVar9[2]) || (fStack_3c < pfVar9[3])) || ((float)local_48 < *pfVar9)) ||
          ...
          *puVar1 = uVar8;
          ...
          if (cVar7 != '\0') {
            uVar10 = (ulong)*puVar1;
            uVar15 = (ulong)*(uint *)(this + 0x78);
            if (*(uint *)(this + 0x78) <= *puVar1) goto LAB_00106f52;
          ...
          uVar8 = -(int)pfVar9[4];
          uVar10 = (ulong)uVar8;
          if (*(uint *)(this + 0xa0) <= uVar8) goto LAB_00106f52;
          uVar5 = puVar1[1];

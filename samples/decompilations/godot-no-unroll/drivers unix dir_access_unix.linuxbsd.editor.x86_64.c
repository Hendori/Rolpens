...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_00106148;
  if (*(DIR **)(this + 400) != (DIR *)0x0) {
    closedir(*(DIR **)(this + 400));
  }
  this[0x198] = (DirAccessUnix)0x0;
...

{
  ...
  if (in_EDX < 0) {
    if (local_40 == (long *)0x0) goto LAB_00103e50;
...
LAB_00103e50:
  ...
  _err_print_index_error
            ("get_drive","drivers/unix/dir_access_unix.cpp",0x122,(long)in_EDX,lVar3,"p_drive",
...
LAB_001040e8:
    ...
    if (iVar4 <= iVar5) goto LAB_001040e8;
...
LAB_001040a7:
      ...
      if (cVar3 == '\0') {
        if (local_50 != 0) goto LAB_00103fd0;
      }
      else {
        local_5c = iVar5;
        if (local_50 != 0) {
...
LAB_00104644:
        ...
        if (lVar9 <= local_78) goto LAB_001046b0;
...
LAB_00104a3d:
      ...
      lVar6 = lVar8 + -1;
      if (lVar8 <= lVar7) goto LAB_00104a8e;
      do {
        lVar12 = lVar6 >> 1;
...
joined_r0x001048fd:
      if (lVar7 == 0) goto LAB_001048ff;
    }
    else {
      ppEVar5 = local_50;
      ppEVar11 = local_50;
      if (local_58 == lVar9) goto LAB_00104a3d;
LAB_00104a8e:
      *ppEVar11 = (Element *)pSVar2;
    }
    local_50 = local_50 + -1;
...
LAB_001046b0:
  ...
  local_68 = local_78;
  if (local_60 == 0) goto LAB_00104772;
  goto LAB_001045a1;
LAB_001048ff:
  ppEVar11 = param_3 + param_1;
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialize_class()::initialized != '\0') goto LAB_00104d1b;
...
LAB_00104e3a:
      ...
      *plVar1 = *plVar1 + -1;
      UNLOCK();
      if (*plVar1 != 0) goto LAB_00104e2a;
      local_68 = 0;
      Memory::free_static((void *)(lVar2 + -0x10),false);
      if ((code *)PTR__bind_methods_00108008 != RefCounted::_bind_methods) goto LAB_00104e3a;
    }
  ...
  if ((long)pEVar4 < 0x11) {
    ...
    do {
      while( true ) {
        ...
        *ppEVar5 = (Element *)pSVar8;
        ...
        if (pEVar4 == pEVar10) goto LAB_00106055;
      }
      __n = (long)pEVar10 * 8;
      pEVar10 = pEVar10 + 1;
    ...
    do {
      while( true ) {
        ...
        *ppEVar5 = (Element *)pSVar8;
        lVar7 = lVar9 + 1;
        if (lVar9 + 1 == 0x10) goto LAB_00105ed6;
      }

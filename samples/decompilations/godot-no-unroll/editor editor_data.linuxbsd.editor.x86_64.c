...
void __thiscall EditorSelection::_emit_change(EditorSelection *this)

{
  ...
  if (_emit_change()::{lambda()#1}::operator()()::sname == '\0') {
    iVar2 = __cxa_guard_acquire(&_emit_change()::{lambda()#1}::operator()()::sname);
    if (iVar2 != 0) {
      _scs_create((char *)&_emit_change()::{lambda()#1}::operator()()::sname,true);
      __cxa_atexit(StringName::~StringName,&_emit_change()::{lambda()#1}::operator()()::sname,
                   &__dso_handle);
...
/* EditorSelection::_update_node_list() [clone .part.0] */

void __thiscall EditorSelection::_update_node_list(EditorSelection *this)
        ...
        if (uVar21 != 0) {
          ...
          do {
            if ((uVar21 == (uint)uVar20) &&
               (lVar13 == *(long *)(*(long *)(*(long *)(this + 0x180) + lVar18 * 8) + 0x10)))
            goto LAB_0010050d;
            uVar23 = uVar23 + 1;
            auVar6._8_8_ = 0;
            ...
            iVar17 = SUB164(auVar6 * auVar10,8);
                  ...
                  (auVar7._8_8_ = 0, auVar7._0_8_ = (ulong)uVar21 * lVar2, auVar11._8_8_ = 0,
                  auVar11._0_8_ = uVar22, auVar8._8_8_ = 0,
                  auVar8._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                                   (ulong)*(uint *)(this + 0x1a0) * 4) + iVar17) -
                                        SUB164(auVar7 * auVar11,8)) * lVar2, auVar12._8_8_ = 0,
                  auVar12._0_8_ = uVar22, uVar23 <= SUB164(auVar8 * auVar12,8)));
        }
      }
      lVar13 = Node::get_parent();
    }
...
void __thiscall
HashMap<Node*,Object*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,Object*>>>
::erase(HashMap<Node*,Object*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,Object*>>>
        *this,Node **param_1)
...
undefined4 __thiscall EditorSelectionHistory::get_history_len(EditorSelectionHistory *this)
...
undefined4 __thiscall EditorSelectionHistory::get_history_pos(EditorSelectionHistory *this)
...
EditorSelectionHistory::get_history_obj(EditorSelectionHistory *this,int param_1)
...
LAB_001009d9:
  _err_print_index_error
            ("get_history_obj","editor/editor_data.cpp",iVar3,lVar2,lVar4,pcVar5,pcVar6,"",false,
             false);
  return 0;
}
...
undefined4 __thiscall EditorSelectionHistory::is_at_beginning(EditorSelectionHistory *this)
...
undefined8 __thiscall EditorSelectionHistory::is_at_end(EditorSelectionHistory *this)

{
  ...
  return CONCAT71((int7)(int3)((uint)(*(int *)(this + 0x10) + 1) >> 8),
                  lVar1 <= *(int *)(this + 0x10) + 1);
}
...
EditorSelectionHistory::is_current_inspector_only(EditorSelectionHistory *this)

{
  ...
  iVar1 = *(int *)(this + 0x10);
  if (((iVar1 < 0) || (lVar2 = *(long *)(this + 8), lVar2 == 0)) ||
     (*(long *)(lVar2 + -8) <= (long)iVar1)) {
    return 0;
  }
...
undefined8 __thiscall EditorSelectionHistory::get_current(EditorSelectionHistory *this)
...
undefined4 __thiscall EditorSelectionHistory::get_path_size(EditorSelectionHistory *this)

{
  ...
  uVar3 = 0;
  uVar4 = 0;
  if ((((-1 < iVar1) && (lVar2 = *(long *)(this + 8), uVar4 = uVar3, lVar2 != 0)) &&
      ((long)iVar1 < *(long *)(lVar2 + -8))) &&
     (lVar2 = *(long *)(lVar2 + 8 + (long)iVar1 * 0x18), lVar2 != 0)) {
...
undefined8 __thiscall
EditorSelectionHistory::get_path_object(EditorSelectionHistory *this,int param_1)

{
  ...
  lVar2 = *(long *)(in_FS_OFFSET + 0x28);
  iVar1 = *(int *)(this + 0x10);
  if (((iVar1 < 0) || (lVar3 = *(long *)(this + 8), lVar3 == 0)) ||
     (*(long *)(lVar3 + -8) <= (long)iVar1)) {
LAB_00100da8:
    uVar5 = 0;
    goto LAB_00100daa;
  }
...
LAB_00100e2a:
  ...
  _err_print_index_error
            ("get_path_object","editor/editor_data.cpp",0xe6,lVar7,lVar9,"p_index",
             "history[current_elem_idx].path.size()","",false,false);
  uVar5 = 0;
LAB_00100daa:
  if (lVar2 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
...

{
  ...
  if (((iVar1 < 0) || (lVar4 = *(long *)(in_RSI + 8), lVar4 == 0)) ||
     (*(long *)(lVar4 + -8) <= (long)iVar1)) {
    *(undefined8 *)this = 0;
...
LAB_00100f68:
  ...
  _err_print_index_error
            ("get_path_property","editor/editor_data.cpp",0xf1,lVar3,lVar5,"p_index",
             "history[current_elem_idx].path.size()","",false,false);
  *(undefined8 *)this = 0;
  String::parse_latin1((StrRange *)this);
LAB_00100ee6:
...
void __thiscall EditorSelectionHistory::EditorSelectionHistory(EditorSelectionHistory *this)
...
undefined8 __thiscall EditorData::get_handling_main_editor(EditorData *this,Object *param_1)
...
LAB_0010103c:
  _err_print_index_error
            ("get","./core/templates/cowdata.h",0xdb,uVar6,lVar7,"p_index","size()","",false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar2 = (code *)invalidInstructionException();
  (*pcVar2)();
...
undefined8 __thiscall EditorData::get_editor_by_name(EditorData *this,String *param_1)
...
void __thiscall EditorData::get_editor_breakpoints(EditorData *this,List *param_1)
...
void __thiscall EditorData::clear_editor_states(EditorData *this)
...
void __thiscall EditorData::save_editor_external_data(EditorData *this)
...
void __thiscall EditorData::apply_changes_in_editors(EditorData *this)
...
undefined8 __thiscall EditorData::call_build(EditorData *this)
...
void __thiscall EditorData::set_scene_as_saved(EditorData *this,int param_1)
...
LAB_00101769:
  _err_print_index_error
            ("set_scene_as_saved","editor/editor_data.cpp",0x1a6,(long)param_1,lVar1,"p_idx",
             "edited_scene.size()","",false,false);
  return;
}
...
undefined4 __thiscall EditorData::get_scene_history_id_from_path(EditorData *this,String *param_1)
...
undefined4 __thiscall EditorData::get_current_edited_scene_history_id(EditorData *this)
...
undefined4 __thiscall EditorData::get_scene_history_id(EditorData *this,int param_1)
...
ulong __thiscall
EditorData::remove_move_array_element_function(EditorData *this,StringName *param_1)
...

{
  ...
  if ((*(long *)(in_RSI + 0x98) != 0) && (*(int *)(in_RSI + 0xbc) != 0)) {
    ...
    if (uVar23 != 0) {
      ...
      do {
        if ((uVar20 == uVar23) &&
           (lVar22 = *(long *)(*(long *)(*(long *)(in_RSI + 0x98) + lVar22 * 8) + 0x10),
           lVar22 == *in_RDX)) {
          if ((*(long *)(in_RSI + 0x98) != 0) && (*(int *)(in_RSI + 0xbc) != 0)) {
            uVar1 = *(uint *)(hash_table_size_primes + (ulong)*(uint *)(in_RSI + 0xb8) * 4);
            uVar24 = CONCAT44(0,uVar1);
            ...
            if (uVar23 != 0) {
              ...
              do {
                if ((uVar20 == uVar23) &&
                   (*(long *)(*(long *)(*(long *)(in_RSI + 0x98) + lVar22 * 8) + 0x10) == *in_RDX))
                {
                  Callable::Callable((Callable *)param_1,
                                     (Callable *)
                                     (*(long *)(*(long *)(in_RSI + 0x98) + (ulong)uVar25 * 8) + 0x18
                                     ));
                  return param_1;
                }
                uVar26 = uVar26 + 1;
...
undefined4 __thiscall EditorData::get_editor_plugin_count(EditorData *this)
...
undefined8 __thiscall EditorData::get_editor_plugin(EditorData *this,int param_1)
...
LAB_00101ee1:
  _err_print_index_error
            ("get_editor_plugin","editor/editor_data.cpp",499,lVar2,lVar3,"p_idx",
             "editor_plugins.size()","",false,false);
  return 0;
}
...
ulong __thiscall EditorData::remove_extension_editor_plugin(EditorData *this,StringName *param_1)
...
undefined8 __thiscall EditorData::has_extension_editor_plugin(EditorData *this,StringName *param_1)

{
  ...
  if (*(int *)(this + 0x3c) != 0) {
    ...
    if (uVar14 != 0) {
      ...
      do {
        if ((uVar11 == uVar14) &&
           (*(long *)(*(long *)(*(long *)(this + 0x18) + lVar13 * 8) + 0x10) == *(long *)param_1)) {
          return 1;
        }
        uVar16 = uVar16 + 1;
        auVar4._8_8_ = 0;
...
undefined8 __thiscall EditorData::get_extension_editor_plugin(EditorData *this,StringName *param_1)
...
String * __thiscall EditorData::get_custom_type_by_name(EditorData *this,String *param_1)
...
long __thiscall EditorData::get_custom_type_by_path(EditorData *this,String *param_1)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  for (puVar3 = *(undefined8 **)(this + 0x58); puVar3 != (undefined8 *)0x0;
      puVar3 = (undefined8 *)*puVar3) {
    lVar6 = puVar3[4];
    if (lVar6 != 0) {
...
char __thiscall EditorData::is_type_recognized(EditorData *this,String *param_1)
...
undefined4 __thiscall EditorData::get_edited_scene(EditorData *this)
...
ulong __thiscall EditorData::get_edited_scene_from_path(EditorData *this,String *param_1)
...
void __thiscall EditorData::set_edited_scene(EditorData *this,int param_1)
...
LAB_00102729:
  _err_print_index_error
            ("set_edited_scene","editor/editor_data.cpp",0x2fb,(long)param_1,lVar1,"p_idx",
             "edited_scene.size()","",false,false);
  return;
}
...
undefined8 __thiscall EditorData::get_edited_scene_root(EditorData *this,int param_1)

{
  ...
  if (-1 < param_1) {
    ...
    if (lVar1 == 0) {
      ...
      if (lVar2 < lVar3) {
LAB_0010279c:
        return *(undefined8 *)(lVar1 + lVar2 * 0x60);
      }
    }
    _err_print_index_error
              ("get_edited_scene_root","editor/editor_data.cpp",0x304,lVar2,lVar3,"p_idx",
               "edited_scene.size()","",false,false);
    return 0;
  }
...
LAB_001027d0:
  _err_print_index_error
            ("get_edited_scene_root","editor/editor_data.cpp",0x301,lVar2,lVar3,
             "current_edited_scene","edited_scene.size()","",false,false);
  return 0;
}
...
void __thiscall EditorData::notify_edited_scene_changed(EditorData *this)
...
undefined4 __thiscall EditorData::get_edited_scene_count(EditorData *this)
...
undefined8 __thiscall EditorData::get_scene_modified_time(EditorData *this,int param_1)
...
LAB_001029c9:
  _err_print_index_error
            ("get_scene_modified_time","editor/editor_data.cpp",0x331,lVar2,lVar3,"p_idx",
             "edited_scene.size()","",false,false);
  return 0;
}
...
LAB_00102b10:
  ...
  _err_print_index_error
            ("get_scene_type","editor/editor_data.cpp",0x336,lVar4,lVar6,"p_idx",
             "edited_scene.size()","",false,false);
  *(undefined8 *)pSVar5 = 0;
LAB_00102a73:
  if (lVar1 == *(long *)(in_FS_OFFSET + 0x28)) {
...
void __thiscall EditorData::set_plugin_window_layout(EditorData *this,long *param_2)
...
void __thiscall EditorData::get_plugin_window_layout(EditorData *this,long *param_2)
      ...
      do {
        if (uVar22 == uVar21) {
          cVar20 = String::operator==((String *)
                                      (*(long *)(*(long *)(in_RSI + 0x110) + lVar24 * 8) + 0x10),
                                      in_RDX);
          if (cVar20 != '\0') {
            if ((*(long *)(in_RSI + 0x110) != 0) && (*(int *)(in_RSI + 0x134) != 0)) {
              uVar1 = *(uint *)(hash_table_size_primes + (ulong)*(uint *)(in_RSI + 0x130) * 4);
              ...
              if (uVar21 != 0) {
                ...
                do {
                  if (uVar22 == uVar21) {
                    cVar20 = String::operator==((String *)
                                                (*(long *)(*(long *)(in_RSI + 0x110) + lVar24 * 8) +
                                                0x10),in_RDX);
                    if (cVar20 != '\0') {
                      StringName::StringName
                                ((StringName *)param_1,
                                 (StringName *)
                                 (*(long *)(*(long *)(in_RSI + 0x110) + (ulong)uVar27 * 8) + 0x18));
                      return param_1;
                    }
                    lVar25 = *(long *)(in_RSI + 0x118);
                  }
                  ...
                  uVar27 = SUB164(auVar8 * auVar16,8);
                        ...
                        auVar10._0_8_ =
                             (ulong)((uVar1 + uVar27) - SUB164(auVar9 * auVar17,8)) * lVar2,
                        auVar18._8_8_ = 0, auVar18._0_8_ = uVar26,
                        uVar28 <= SUB164(auVar10 * auVar18,8)));
              }
            }
            _err_print_error("operator[]","./core/templates/hash_map.h",0x245,
                             "FATAL: Condition \"!exists\" is true.",0,0);
...
void __thiscall EditorData::clear_script_icon_cache(EditorData *this)
...
undefined8 __thiscall EditorSelection::is_selected(EditorSelection *this,Node *param_1)
    ...
    if (uVar14 != 0) {
      ...
      do {
        if (((uint)uVar13 == uVar14) &&
           (*(Node **)(*(long *)(*(long *)(this + 0x180) + lVar12 * 8) + 0x10) == param_1)) {
          return 1;
        }
        uVar16 = uVar16 + 1;
        auVar3._8_8_ = 0;
        ...
        auVar5._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                         (ulong)*(uint *)(this + 0x1a0) * 4) + iVar11) -
...
void __thiscall EditorSelection::add_editor_plugin(EditorSelection *this,Object *param_1)
...
void __thiscall EditorSelection::update(EditorSelection *this)

{
  ...
  if ((this[0x1a9] != (EditorSelection)0x0) &&
     (this[0x1a9] = (EditorSelection)0x0, this[0x1a8] == (EditorSelection)0x0)) {
...
EditorSelection * __thiscall EditorSelection::get_selected_node_list(EditorSelection *this)
...
void __thiscall EditorSelection::EditorSelection(EditorSelection *this)
...
void __thiscall EditorData::script_class_save_global_classes(EditorData *this)
    ...
    do {
      ...
      if ((*(long *)(this + 0xe0) != 0) && (*(int *)(this + 0x104) != 0)) {
        ...
        if (uVar20 != 0) {
          ...
          do {
            if ((uVar20 == uVar15) &&
               (*(long *)(*(long *)(*(long *)(this + 0xe0) + lVar19 * 8) + 0x10) == *(long *)pSVar24
               )) {
            ...
            uVar18 = SUB164(auVar7 * auVar11,8);
                  ...
                  (auVar8._8_8_ = 0, auVar8._0_8_ = (ulong)uVar20 * lVar4, auVar12._8_8_ = 0,
                  auVar12._0_8_ = uVar21, auVar9._8_8_ = 0,
                  auVar9._0_8_ = (ulong)((uVar3 + uVar18) - SUB164(auVar8 * auVar12,8)) * lVar4,
                  auVar13._8_8_ = 0, auVar13._0_8_ = uVar21, uVar22 <= SUB164(auVar9 * auVar13,8)));
        }
      }
      pCVar23 = (CowData *)0x0;
LAB_0010379d:
      Variant::Variant((Variant *)local_58,pSVar24);
...

{
  ...
  ::insert(aSStack_18,(Callable *)(param_1 + 0x90),param_2);
...

{
  ...
  if ((*(long *)(param_1 + 0x18) != 0) && (*(int *)(param_1 + 0x3c) != 0)) {
    ...
    if (uVar14 != 0) {
      ...
      do {
        if ((uVar11 == uVar14) &&
           (*(long *)(*(long *)(*(long *)(param_1 + 0x18) + lVar13 * 8) + 0x10) == *(long *)param_2)
           ) {
          _err_print_error("add_extension_editor_plugin","editor/editor_data.cpp",0x1f8,
                           "Condition \"extension_editor_plugins.has(p_class_name)\" is true.",0,0);
          goto LAB_001042b8;
        }
        uVar16 = uVar16 + 1;
        auVar4._8_8_ = 0;
  ...
  ::insert(local_48,(EditorPlugin **)(param_1 + 0x10),SUB81(param_2,0));
LAB_001042b8:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
...
void __thiscall EditorSelection::_node_removed(EditorSelection *this,Node *param_1)
  ...
  if ((*(long *)(this + 0x180) != 0) && (*(int *)(this + 0x1a4) != 0)) {
    ...
    if (uVar17 != 0) {
      ...
      while (((uint)uVar16 != uVar17 ||
             (param_1 != *(Node **)(*(long *)(*(long *)(this + 0x180) + lVar15 * 8) + 0x10)))) {
        uVar19 = uVar19 + 1;
        auVar4._8_8_ = 0;
      ...
      puVar13 = (undefined8 *)
                HashMap<Node*,Object*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,Object*>>>
                ::operator[]((HashMap<Node*,Object*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,Object*>>>
                              *)(this + 0x178),local_40);
...
void __thiscall EditorSelection::add_node(EditorSelection *this,Node *param_1)

{
  ...
  if (param_1 == (Node *)0x0) {
    ...
    _err_print_error("add_node","editor/editor_data.cpp",0x4c0,
                     "Condition \"!p_node->is_inside_tree()\" is true.",0,0);
  }
  else {
    if ((*(long *)(this + 0x180) != 0) && (*(int *)(this + 0x1a4) != 0)) {
      ...
      if (uVar19 != 0) {
        ...
        do {
          if (((uint)uVar21 == uVar19) &&
             (param_1 == *(Node **)(*(long *)(*(long *)(this + 0x180) + lVar17 * 8) + 0x10)))
          goto LAB_001045e0;
          uVar18 = uVar18 + 1;
          auVar6._8_8_ = 0;
          ...
          iVar16 = SUB164(auVar6 * auVar10,8);
                ...
                (auVar7._8_8_ = 0, auVar7._0_8_ = (ulong)uVar19 * lVar2, auVar11._8_8_ = 0,
                auVar11._0_8_ = uVar20, auVar8._8_8_ = 0,
                auVar8._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                                 (ulong)*(uint *)(this + 0x1a0) * 4) + iVar16) -
                                      SUB164(auVar7 * auVar11,8)) * lVar2, auVar12._8_8_ = 0,
                auVar12._0_8_ = uVar20, uVar18 <= SUB164(auVar8 * auVar12,8)));
      }
    }
    *(undefined2 *)(this + 0x1a9) = 0x101;
    if (*(long **)(this + 0x1b0) == (long *)0x0) {
      ...
      if (puVar15 == (undefined8 *)0x0) {
        ...
        do {
          ...
          (**(code **)(*plVar3 + 0x68))
                    ((Variant *)local_98,plVar3,(StringName *)local_e8,local_c8,1,&local_d8);
          if (local_d8 == 0) {
            Variant::Variant((Variant *)local_b8,(Variant *)local_98);
            if (Variant::needs_deinit[(int)local_98[0]] != '\0') goto LAB_001047c2;
LAB_001046af:
            if (Variant::needs_deinit[(int)local_60] == '\0') goto LAB_001046c1;
LAB_001047e0:
            Variant::_clear_internal();
...
LAB_0010483d:
    ...
    *puVar15 = pOVar14;
    ...
    create_custom_callable_function_pointer<EditorSelection,Node*>
              ((EditorSelection *)local_e8,(char *)this,
               (_func_void_Node_ptr *)"&EditorSelection::_node_removed");
    Variant::Variant((Variant *)local_78,(Object *)param_1);
    local_60 = 0;
    local_58 = (undefined1  [16])0x0;
...
void __thiscall EditorSelection::remove_node(EditorSelection *this,Node *param_1)

{
  ...
  local_60 = param_1;
  if (param_1 == (Node *)0x0) {
    _err_print_error("remove_node","editor/editor_data.cpp",0x4d4,"Parameter \"p_node\" is null.",0,
                     0);
  }
    ...
    if (uVar17 != 0) {
      uVar19 = 0;
      while (((uint)uVar20 != uVar17 ||
             (param_1 != *(Node **)(*(long *)(*(long *)(this + 0x180) + lVar16 * 8) + 0x10)))) {
        uVar19 = uVar19 + 1;
        auVar5._8_8_ = 0;
        ...
        if ((uVar17 == 0) ||
           ...
           auVar7._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                            (ulong)*(uint *)(this + 0x1a0) * 4) + iVar15) -
                                 SUB164(auVar6 * auVar10,8)) * lVar1, auVar11._8_8_ = 0,
           auVar11._0_8_ = uVar18, SUB164(auVar7 * auVar11,8) < uVar19)) goto LAB_00104be9;
      }
      *(undefined2 *)(this + 0x1a9) = 0x101;
      puVar14 = (undefined8 *)
                HashMap<Node*,Object*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,Object*>>>
      ...
      create_custom_callable_function_pointer<EditorSelection,Node*>
                (local_58,(char *)this,(_func_void_Node_ptr *)"&EditorSelection::_node_removed");
...
void __thiscall EditorSelection::clear(EditorSelection *this)
...
EditorData::script_class_is_parent(EditorData *this,String *param_1,String *param_2)
...
void __thiscall EditorData::paste_object_params(EditorData *this,Object *param_1)

{
  ...
  if (param_1 == (Object *)0x0) {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error("paste_object_params","editor/editor_data.cpp",0x18e,
    ...
    if ((*(long **)(this + 0x70) != (long *)0x0) &&
       (plVar6 = (long *)**(long **)(this + 0x70), plVar6 != (long *)0x0)) {
      do {
        local_78 = 0;
...

{
  ...
  if (*(undefined8 **)(in_RSI + 0x1b8) != (undefined8 *)0x0) {
    for (puVar1 = (undefined8 *)**(undefined8 **)(in_RSI + 0x1b8); puVar1 != (undefined8 *)0x0;
...
LAB_00105a7e:
    ...
    if ((*(long *)(param_2 + 0xe0) != 0) && (*(int *)(param_2 + 0x104) != 0)) {
      ...
      if (uVar17 != 0) {
        ...
        do {
          if ((uVar17 == uVar14) &&
             (*(char **)(*(long *)(*(long *)(param_2 + 0xe0) + lVar16 * 8) + 0x10) == local_58)) {
            lVar3 = *(long *)(*(long *)(param_2 + 0xe0) + (ulong)uVar15 * 8);
            if ((StringName::configured != '\0') && (local_58 != (char *)0x0)) {
              StringName::unref();
            }
            if (lVar3 == 0) goto LAB_001058ca;
            if (((in_RCX != (undefined1 *)0x0) && (*(long *)(lVar3 + 0x18) != 0)) &&
               (1 < *(uint *)(*(long *)(lVar3 + 0x18) + -8))) {
              *in_RCX = 1;
            }
            *(undefined8 *)param_1 = 0;
...
void __thiscall
EditorData::script_class_set_name(EditorData *this,String *param_1,StringName *param_2)
...

{
  ...
  for (puVar1 = *(undefined8 **)(in_RSI + 400); puVar1 != (undefined8 *)0x0;
...
LAB_00105f1d:
  _err_print_index_error
            ("get_scene_root_script","editor/editor_data.cpp",0x348,lVar9,lVar10,"p_idx",
             "edited_scene.size()","",false,false);
  *puVar7 = 0;
LAB_00105ee0:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
...
LAB_00106204:
  ...
  _err_print_index_error
            ("get_scene_title","editor/editor_data.cpp",0x358,lVar7,lVar6,"p_idx",
             "edited_scene.size()","",false,false);
  *(undefined8 *)this = 0;
LAB_001062a8:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
  ...
  if (in_EDX < 0) {
    ...
    if (lVar2 != 0) {
      ...
      if (*(long *)(lVar2 + lVar5) != 0) {
        Node::get_scene_file_path();
        if ((local_48 == 0) || (iVar6 = (int)*(undefined8 *)(local_48 + -8), iVar6 == 0)) {
...
LAB_001065e1:
  _err_print_index_error
            ("get_scene_path","editor/editor_data.cpp",0x382,lVar4,lVar5,"p_idx",
             "edited_scene.size()","",false,false);
  *(undefined8 *)this = 0;
LAB_00106504:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
LAB_00106718:
  ...
  _err_print_index_error
            ("get_edited_scene_live_edit_root","editor/editor_data.cpp",0x396,lVar2,lVar3,
             "current_edited_scene","edited_scene.size()","",false,false);
  local_28 = 0;
...
undefined4 __thiscall
EditorData::_find_updated_instances(EditorData *this,Node *param_1,Node *param_2,HashSet *param_3)
...
LAB_00106818:
    ...
    if ((local_58[0] != (Object *)0x0) && (cVar12 = RefCounted::unreference(), cVar12 != '\0')) {
LAB_00106846:
      cVar12 = predelete_handler(local_58[0]);
      if (cVar12 != '\0') {
        ...
        do {
          if ((uint)uVar20 == uVar18) {
            cVar12 = String::operator==((String *)
                                        (*(long *)param_3 +
                                        (ulong)*(uint *)(*(long *)(param_3 + 8) + lVar19 * 4) * 8),
                                        local_60);
          ...
          iVar23 = SUB164(auVar5 * auVar9,8);
                ...
                (auVar6._8_8_ = 0, auVar6._0_8_ = uVar20 * lVar17, auVar10._8_8_ = 0,
                auVar10._0_8_ = uVar24, auVar7._8_8_ = 0,
                auVar7._0_8_ = (ulong)((uVar1 + iVar23) - SUB164(auVar6 * auVar10,8)) * lVar17,
                auVar11._8_8_ = 0, auVar11._0_8_ = uVar24, uVar15 <= SUB164(auVar7 * auVar11,8)));
      }
    }
...
LAB_00106aa2:
    ...
    if ((local_58[0] == (Object *)0x0) ||
       (uVar3 = *(undefined8 *)(local_58[0] + -8), (int)uVar3 == 0)) {
      CowData<char32_t>::_unref((CowData<char32_t> *)local_58);
    }
    else {
      CowData<char32_t>::_unref((CowData<char32_t> *)local_58);
      if (((int)uVar3 != 1) && (Node::get_scene_instance_state(), local_58[0] != (Object *)0x0))
      goto LAB_00106818;
    }
LAB_0010679b:
    pOVar22 = (Object *)0x0;
LAB_0010679e:
    for (iVar23 = 0; iVar13 = Node::get_child_count(SUB81(param_2,0)), iVar23 < iVar13;
        iVar23 = iVar23 + 1) {
    ...
    uVar14 = 0;
LAB_001069b3:
    if (pOVar22 == (Object *)0x0) goto LAB_001069b8;
  }
...
void __thiscall
EditorData::script_class_set_icon_path(EditorData *this,String *param_1,String *param_2)
...
void __thiscall EditorData::set_editor_plugin_states(EditorData *this,Dictionary *param_1)

{
  ...
  if (cVar4 == '\0') {
    ...
    if ((local_70 != (long *)0x0) && (lVar8 = *local_70, lVar8 != 0)) {
      do {
...
void __thiscall EditorData::script_class_load_icon_paths(EditorData *this)

{
  ...
  if (cVar4 != '\0') {
    ...
    if ((local_c0 != (long *)0x0) && (lVar10 = *local_c0, lVar10 != 0)) {
      do {
        ...
        pCVar8 = (CowData<char32_t> *)
                 HashMap<StringName,String,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,String>>>
                 ::operator[]((HashMap<StringName,String,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,String>>>
                               *)(this + 0xd8),(StringName *)&local_b0);
  ...
  do {
    ...
    if (bVar5 == 0) {
      ...
      if (cVar4 == '\0') {
LAB_0010771a:
        if (Variant::needs_deinit[local_78[0]] == '\0') goto LAB_0010772d;
LAB_00107950:
        Variant::_clear_internal();
...
void __thiscall EditorData::EditorData(EditorData *this)
...
void __thiscall EditorData::copy_object_params(EditorData *this,Object *param_1)
...
LAB_00107e52:
  ...
  Object::get_property_list
            ((List *)param_1,SUB81((List<PropertyInfo,DefaultAllocator> *)&local_98,0));
    ...
    for (lVar1 = *local_98; lVar1 != 0; lVar1 = *(long *)(lVar1 + 0x30)) {
      if ((*(byte *)(lVar1 + 0x28) & 4) != 0) {
        ...
        if (((cVar4 == '\0') && (cVar4 = String::operator==(this_00,"scripts"), cVar4 == '\0')) &&
           (cVar4 = String::operator==(this_00,"resource_path"), cVar4 == '\0')) {
          local_60[0] = 0;
          local_58 = (undefined1  [16])0x0;
          local_68 = 0;
          if (*(long *)(lVar1 + 8) != 0) {
...
void __thiscall EditorData::instantiate_object_properties(EditorData *this,Object *param_1)

{
  ...
  if (param_1 == (Object *)0x0) {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error("instantiate_object_properties","editor/editor_data.cpp",600,
                       "Parameter \"p_object\" is null.",0,0);
      return;
    }
  }
...
{
  HashMap<String,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Texture>>>>
  *this;
  uint uVar1;
  undefined1 auVar2 [16];
  undefined1 auVar3 [16];
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  this = (HashMap<String,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Texture>>>>
          *)(in_RSI + 0x138);
  if ((*(long *)(in_RSI + 0x140) != 0) && (*(int *)(in_RSI + 0x164) != 0)) {
    ...
    if (uVar13 != 0) {
      ...
      do {
        if (uVar20 == uVar13) {
          cVar12 = String::operator==((String *)
                                      (*(long *)(*(long *)(in_RSI + 0x140) + lVar21 * 8) + 0x10),
                                      in_RDX);
          if (cVar12 != '\0') {
            plVar15 = (long *)HashMap<String,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Texture>>>>
                              ::operator[](this,in_RDX);
            lVar18 = *plVar15;
            *(undefined8 *)param_1 = 0;
            if ((lVar18 != 0) &&
               (lVar18 = __dynamic_cast(lVar18,&Object::typeinfo,&Texture2D::typeinfo,0),
               lVar18 != 0)) {
              *(long *)param_1 = lVar18;
              cVar12 = RefCounted::reference();
              if (cVar12 == '\0') {
        ...
        iVar14 = SUB164(auVar3 * auVar7,8);
              ...
              (auVar4._8_8_ = 0, auVar4._0_8_ = (ulong)uVar13 * lVar18, auVar8._8_8_ = 0,
              auVar8._0_8_ = uVar10, auVar5._8_8_ = 0,
              auVar5._0_8_ = (ulong)((uVar1 + iVar14) - SUB164(auVar4 * auVar8,8)) * lVar18,
              auVar9._8_8_ = 0, auVar9._0_8_ = uVar10, uVar24 <= SUB164(auVar5 * auVar9,8)));
    }
  }
...
LAB_0010894d:
      ...
      cVar12 = RefCounted::reference();
      if (cVar12 == '\0') {
        if ((local_58 == (Object *)0x0) || (cVar12 = RefCounted::unreference(), cVar12 == '\0'))
        goto LAB_00108a80;
        pOVar17 = (Object *)0x0;
        goto LAB_0010894d;
      }
...
LAB_001087e1:
        (**(code **)(*(long *)pOVar17 + 0x240))((CowData<char32_t> *)&local_58,pOVar17);
        ...
        if ((iVar14 != -1) ||
           ((cVar12 = String::begins_with((char *)(pOVar17 + 0x188)), cVar12 != '\0' ||
            (lVar18 = CONCAT71(uStack_67,local_68), lVar18 == 0)))) goto LAB_001087e1;
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  local_80 = 0;
  cVar21 = HashMap<String,Vector<EditorData::CustomType>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Vector<EditorData::CustomType>>>>
           ::_lookup_pos((HashMap<String,Vector<EditorData::CustomType>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Vector<EditorData::CustomType>>>>
                          *)(param_2 + 0x40),in_RCX,&local_80);
  if (cVar21 == '\0') {
LAB_00108dc5:
    *(undefined4 *)param_1 = 0;
    *(undefined1 (*) [16])(param_1 + 8) = (undefined1  [16])0x0;
      ...
      do {
        if (uVar23 == uVar26) {
          cVar21 = String::operator==((String *)
                                      (*(long *)(*(long *)(param_2 + 0x48) + lVar28 * 8) + 0x10),
                                      in_RCX);
        ...
        if ((uVar23 == 0) ||
           (auVar5._8_8_ = 0, auVar5._0_8_ = (ulong)uVar23 * lVar2, auVar13._8_8_ = 0,
           auVar13._0_8_ = uVar20, auVar6._8_8_ = 0,
           auVar6._0_8_ = (ulong)((uVar1 + uVar27) - SUB164(auVar5 * auVar13,8)) * lVar2,
           auVar14._8_8_ = 0, auVar14._0_8_ = uVar20, SUB164(auVar6 * auVar14,8) < uVar30)) break;
      } while( true );
    }
  }
  goto LAB_00108d93;
LAB_00108ef8:
  lVar2 = *(long *)(*(long *)(*(long *)(param_2 + 0x48) + (ulong)uVar27 * 8) + 0x20);
  ...
  if ((*(long *)(param_2 + 0x48) != 0) && (*(int *)(param_2 + 0x6c) != 0)) {
    ...
    if (uVar23 != 0) {
      ...
      do {
        ...
        if ((uVar23 == 0) ||
           (auVar9._8_8_ = 0, auVar9._0_8_ = (ulong)uVar23 * lVar2, auVar17._8_8_ = 0,
           auVar17._0_8_ = uVar20, auVar10._8_8_ = 0,
           auVar10._0_8_ = (ulong)((uVar1 + uVar27) - SUB164(auVar9 * auVar17,8)) * lVar2,
           auVar18._8_8_ = 0, auVar18._0_8_ = uVar20, SUB164(auVar10 * auVar18,8) < uVar30)) break;
      } while( true );
    }
  }
  goto LAB_00108d93;
LAB_00109028:
      ...
      if (lVar2 == 0) {
        ...
        if (lVar31 < lVar29) {
          ...
          if ((pOVar24 != (Object *)0x0) &&
             (local_88 = pOVar24, cVar21 = RefCounted::reference(), cVar21 == '\0')) {
            local_88 = (Object *)0x0;
          }
          ...
          if (bVar22) {
            ...
            if ((pOVar24 != (Object *)0x0) &&
               (pSVar25 = (String *)__dynamic_cast(pOVar24,&Object::typeinfo,&Node::typeinfo,0),
               pSVar25 != (String *)0x0)) {
            ...
            *(undefined8 *)(param_1 + 0x10) = uStack_68;
            ...
            _err_print_error("instantiate_custom_type","editor/editor_data.cpp",0x21e,
                             "Condition \"!v\" is true. Returning: Variant()",0,0);
            *(undefined4 *)param_1 = 0;
          ...
          if (((local_88 != (Object *)0x0) &&
              (cVar21 = RefCounted::unreference(), pOVar24 = local_88, cVar21 != '\0')) &&
             (cVar21 = predelete_handler(local_88), cVar21 != '\0')) {
  ...
  _err_print_index_error
            ("get","./core/templates/cowdata.h",0xdb,lVar31,lVar29,"p_index","size()","",false,true)
  ;
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar19 = (code *)invalidInstructionException();
...
void __thiscall EditorData::EditedScene::operator=(EditedScene *this,EditedScene *param_1)
...
LAB_0010991e:
  ...
  if (*(long *)(this + 0x30) != *(long *)(param_1 + 0x30)) {
    CowData<EditorSelectionHistory::HistoryElement>::_unref
              ((CowData<EditorSelectionHistory::HistoryElement> *)(this + 0x30));
...
void __thiscall
CowData<EditorSelectionHistory::HistoryElement>::_ref
          (CowData<EditorSelectionHistory::HistoryElement> *this,CowData *param_1)
...
LAB_00109c38:
    ...
    if (lVar4 < lVar6) {
      ...
      if (((long *)puVar5[4] != (long *)0x0) &&
         (puVar7 = *(undefined8 **)puVar5[4], puVar7 != (undefined8 *)0x0)) {
...
LAB_00109b5c:
      ...
      if (puVar5[6] != 0) {
        CowData<EditorSelectionHistory::HistoryElement>::_ref
                  ((CowData<EditorSelectionHistory::HistoryElement> *)&local_68,
                   (CowData *)(puVar5 + 6));
      }
  ...
  _err_print_index_error
            ("get_scene_editor_states","editor/editor_data.cpp",0x146,lVar4,lVar6,"p_idx",
             "edited_scene.size()","",false,false);
...
void __thiscall EditorSelectionHistory::clear(EditorSelectionHistory *this)

{
  if ((*(long *)(this + 8) != 0) && (*(long *)(*(long *)(this + 8) + -8) != 0)) {
    CowData<EditorSelectionHistory::HistoryElement>::_unref
              ((CowData<EditorSelectionHistory::HistoryElement> *)(this + 8));
  }
  *(undefined4 *)(this + 0x10) = 0xffffffff;
  return;
}
...
void __thiscall
CowData<EditorSelectionHistory::_Object>::_ref
          (CowData<EditorSelectionHistory::_Object> *this,CowData *param_1)
...
void __thiscall
CowData<EditorSelectionHistory::HistoryElement>::_copy_on_write
...
void __thiscall EditorSelectionHistory::cleanup_history(EditorSelectionHistory *this)
...
LAB_0010a1ef:
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,lVar9,lVar13,"p_index","size()","",false,
                   true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar3 = (code *)invalidInstructionException();
...
LAB_00109fd6:
        ...
        ObjectDB::spin_lock._0_1_ = '\0';
        if ((uVar1 == 0) ||
           ((lVar8 = __dynamic_cast(uVar1,&Object::typeinfo,&Node::typeinfo,0), lVar8 != 0 &&
            ((*(byte *)(lVar8 + 0x2fa) & 0x40) == 0)))) goto LAB_0010a0ae;
LAB_0010a1b8:
        lVar8 = *(long *)(this + 8);
LAB_0010a1c1:
        lVar15 = lVar15 + 1;
      ...
      pNVar7 = (NodePath *)
               EditorData::get_edited_scene_root((EditorData *)(EditorNode::singleton + 0x430),-1);
      if (pNVar7 != (NodePath *)0x0) {
        for (iVar10 = 0; iVar5 = MultiNodeEdit::get_node_count(), iVar10 < iVar5;
            iVar10 = iVar10 + 1) {
...
LAB_0010a2bd:
        _err_print_index_error
                  ("remove_at","./core/templates/cowdata.h",0xe4,lVar14,lVar8,"p_index","size()","",
                   false,false);
        lVar8 = *(long *)(this + 8);
        lVar14 = lVar16;
      }
        ...
        CowData<EditorSelectionHistory::HistoryElement>::resize<false>
                  ((CowData<EditorSelectionHistory::HistoryElement> *)(this + 8),lVar15);
        lVar8 = *(long *)(this + 8);
        lVar14 = lVar16;
      }
LAB_0010a14f:
...
bool __thiscall EditorSelectionHistory::next(EditorSelectionHistory *this)
...
bool __thiscall EditorSelectionHistory::previous(EditorSelectionHistory *this)
...
void __thiscall
CowData<EditorSelectionHistory::_Object>::_copy_on_write
          (CowData<EditorSelectionHistory::_Object> *this)
...
void __thiscall
EditorSelectionHistory::replace_object(EditorSelectionHistory *this,long param_2,undefined8 param_3)
...
void __thiscall
Vector<EditorSelectionHistory::_Object>::push_back
          (Vector<EditorSelectionHistory::_Object> *this,long *param_2)

{
  ...
  iVar4 = CowData<EditorSelectionHistory::_Object>::resize<false>
                    ((CowData<EditorSelectionHistory::_Object> *)(this + 8),lVar7);
  if (iVar4 == 0) {
    if (*(long *)(this + 8) == 0) {
      lVar5 = -1;
      lVar7 = 0;
      ...
      if (-1 < lVar5) {
        CowData<EditorSelectionHistory::_Object>::_copy_on_write
                  ((CowData<EditorSelectionHistory::_Object> *)(this + 8));
...
/* EditorSelectionHistory::add_object(ObjectID, String const&, bool) */
...
LAB_0010a936:
          ...
          if ((*(long *)(this + 8) == 0) || (*(long *)(*(long *)(this + 8) + -8) <= (long)iVar9))
          goto LAB_0010a936;
          CowData<EditorSelectionHistory::HistoryElement>::resize<false>
                    ((CowData<EditorSelectionHistory::HistoryElement> *)(this + 8),(long)(iVar9 + 1)
                    );
          local_98 = 0;
          local_a0 = 0;
...
LAB_0010adc2:
          ...
          if (*(long *)(lVar10 + 8) != 0) {
            CowData<EditorSelectionHistory::_Object>::_ref
                      ((CowData<EditorSelectionHistory::_Object> *)&local_a0,(CowData *)(lVar10 + 8)
                      );
          }
          local_98 = *(int *)(lVar10 + 0x10);
          CowData<EditorSelectionHistory::_Object>::resize<false>
                    ((CowData<EditorSelectionHistory::_Object> *)&local_a0,(long)(local_98 + 1));
          local_68 = (Object *)0x0;
          if (local_88 != (Object *)0x0) {
            local_68 = local_88;
            cVar3 = RefCounted::reference();
        ...
        if (local_a0 != 0) {
          CowData<EditorSelectionHistory::_Object>::_ref
                    ((CowData<EditorSelectionHistory::_Object> *)&local_60,(CowData *)&local_a0);
        }
        local_58[0] = iVar9;
        if (*(long *)(this + 8) == 0) {
          lVar10 = 1;
        ...
        iVar4 = CowData<EditorSelectionHistory::HistoryElement>::resize<false>
                          ((CowData<EditorSelectionHistory::HistoryElement> *)(this + 8),lVar10);
        if (iVar4 == 0) {
          if (*(long *)(this + 8) == 0) {
            lVar8 = -1;
            lVar10 = 0;
            ...
            if (-1 < lVar8) {
              ...
              if (*(long *)(lVar10 + 8) != local_60) {
                CowData<EditorSelectionHistory::_Object>::_ref
                          ((CowData<EditorSelectionHistory::_Object> *)(lVar10 + 8),
                           (CowData *)&local_60);
              }
...
LAB_0010aa6b:
        CowData<EditorSelectionHistory::_Object>::_unref
                  ((CowData<EditorSelectionHistory::_Object> *)&local_60);
        *(int *)(this + 0x10) = *(int *)(this + 0x10) + 1;
        CowData<EditorSelectionHistory::_Object>::_unref
                  ((CowData<EditorSelectionHistory::_Object> *)&local_a0);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_78);
        pOVar5 = local_88;
...
/* EditorData::get_undo_redo_inspector_hook_callback() */

void EditorData::get_undo_redo_inspector_hook_callback(void)
...
/* CowData<EditorData::CustomType>::_copy_on_write() [clone .isra.0] */

void __thiscall
CowData<EditorData::CustomType>::_copy_on_write(CowData<EditorData::CustomType> *this)
...
LAB_0010b4c9:
  CowData<Callable>::_unref((CowData<Callable> *)(this + 0x88));
  puVar7 = *(undefined8 **)(this + 0x70);
  if (puVar7 != (undefined8 *)0x0) {
    do {
        ...
        do {
          if (*(int *)(*(long *)(this + 0x50) + lVar5) != 0) {
            ...
            *(int *)(*(long *)(this + 0x50) + lVar5) = 0;
            CowData<EditorData::CustomType>::_unref
                      ((CowData<EditorData::CustomType> *)((long)pvVar6 + 0x20));
            CowData<char32_t>::_unref((CowData<char32_t> *)((long)pvVar6 + 0x10));
            Memory::free_static(pvVar6,false);
            pvVar6 = *(void **)(this + 0x48);
            *(undefined8 *)((long)pvVar6 + lVar5 * 2) = 0;
...
LAB_0010badb:
      ...
      if (puVar10[6] != 0) {
        CowData<EditorSelectionHistory::HistoryElement>::_ref
                  ((CowData<EditorSelectionHistory::HistoryElement> *)(puVar9 + 6),
                   (CowData *)(puVar10 + 6));
      }
      lVar12 = lVar12 + 1;
...
/* EditorData::restore_edited_scene_state(EditorSelection*, EditorSelectionHistory*) */

EditorSelection *
EditorData::restore_edited_scene_state(EditorSelection *param_1,EditorSelectionHistory *param_2)

{
  ...
  if (*(int *)(param_2 + 0xd0) < 0) {
    ...
    lVar3 = *(long *)(lVar3 + -8);
    if (lVar2 < lVar3) {
      CowData<EditorData::EditedScene>::_copy_on_write
                ((CowData<EditorData::EditedScene> *)(param_2 + 200));
      lVar3 = lVar2 * 0x60 + *(long *)(param_2 + 200);
      *(undefined4 *)(in_RCX + 0x10) = *(undefined4 *)(lVar3 + 0x38);
      if (*(long *)(in_RCX + 8) != *(long *)(lVar3 + 0x30)) {
        CowData<EditorSelectionHistory::HistoryElement>::_ref
                  ((CowData<EditorSelectionHistory::HistoryElement> *)(in_RCX + 8),
                   (CowData *)(lVar3 + 0x30));
      }
...
LAB_0010bca1:
  _err_print_index_error
            ("restore_edited_scene_state","editor/editor_data.cpp",0x3a7,lVar2,lVar3,
             "current_edited_scene","edited_scene.size()","",false,false);
...
void __thiscall
EditorData::save_edited_scene_state
          (EditorData *this,EditorSelection *param_1,EditorSelectionHistory *param_2,
          Dictionary *param_3)
...
LAB_0010bfb0:
    ...
    if (lVar6 < lVar7) {
      CowData<EditorData::EditedScene>::_copy_on_write
                ((CowData<EditorData::EditedScene> *)(this + 200));
...
LAB_0010be70:
      ...
      *(undefined4 *)(lVar7 + 0x38) = uVar1;
      if (*(long *)(lVar7 + 0x30) != *(long *)(param_2 + 8)) {
        CowData<EditorSelectionHistory::HistoryElement>::_ref
                  ((CowData<EditorSelectionHistory::HistoryElement> *)(lVar7 + 0x30),
                   (CowData *)(param_2 + 8));
      }
  ...
  _err_print_index_error
            ("save_edited_scene_state","editor/editor_data.cpp",0x39c,lVar6,lVar7,
             "current_edited_scene","edited_scene.size()","",false,false);
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
...
/* EditorData::move_edited_scene_index(int, int) */

void __thiscall EditorData::move_edited_scene_index(EditorData *this,int param_1,int param_2)
...
LAB_0010c1c0:
    ...
    if (lVar4 < lVar3) {
      ...
      _err_print_index_error
                ("move_edited_scene_index","editor/editor_data.cpp",0x280,lVar2,lVar3,"p_to_idx",
                 "edited_scene.size()","",false,false);
      goto LAB_0010c10c;
    }
  }
  _err_print_index_error
            ("move_edited_scene_index","editor/editor_data.cpp",0x27f,lVar4,lVar3,"p_idx",
             "edited_scene.size()","",false,false);
LAB_0010c10c:
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
...
/* EditorData::check_and_update_scene(int) */

char __thiscall EditorData::check_and_update_scene(EditorData *this,int param_1)
...
LAB_0010c72d:
    _err_print_index_error
              ("check_and_update_scene","editor/editor_data.cpp",0x2c0,lVar15,lVar16,"p_idx",
               "edited_scene.size()","",false,false);
  }
  else {
    if (lVar12 == 0) {
    ...
    if (pNVar1 != (Node *)0x0) {
      ...
      if (local_d1 != '\0') {
        ...
        EditorProgress::EditorProgress
                  ((EditorProgress *)&local_78,(String *)&local_80,(String *)&local_88,2,false,false
                  );
...
LAB_0010c973:
            _err_print_index_error
                      ("operator[]","./core/templates/vector.h",0x38,lVar15,lVar12,"p_index",
                       "((Vector<T> *)(this))->_cowdata.size()","",false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
            pcVar3 = (code *)invalidInstructionException();
          ...
          if ((plVar8 != (long *)0x0) && (lVar17 = *plVar8, lVar17 != 0)) {
            while (lVar9 != 0) {
              lVar12 = *(long *)(lVar9 + -8);
              if (lVar12 <= lVar15) goto LAB_0010c7bb;
...
LAB_0010c7bb:
            _err_print_index_error
                      ("get","./core/templates/cowdata.h",0xdb,lVar15,lVar12,"p_index","size()","",
                       false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
            pcVar3 = (code *)invalidInstructionException();
...
LAB_0010c84c:
          ...
          CowData<EditorData::EditedScene>::_copy_on_write
                    ((CowData<EditorData::EditedScene> *)(this + 200));
          List<Node*,DefaultAllocator>::operator=
                    ((List<Node*,DefaultAllocator> *)(lVar16 + *(long *)(this + 200) + 0x20),
                     (List *)&local_88);
...
LAB_0010c9ca:
          _err_print_error("check_and_update_scene","editor/editor_data.cpp",uVar11,pcVar10,0,0);
          EditorProgress::~EditorProgress((EditorProgress *)&local_78);
          local_d1 = '\0';
        }
        cVar5 = RefCounted::unreference();
...
/* EditorData::set_edited_scene_live_edit_root(NodePath const&) */

void __thiscall EditorData::set_edited_scene_live_edit_root(EditorData *this,NodePath *param_1)
...
LAB_0010ca89:
  _err_print_index_error
            ("set_edited_scene_live_edit_root","editor/editor_data.cpp",0x390,lVar2,lVar1,
             "current_edited_scene","edited_scene.size()","",false,false);
  return;
}
...
/* EditorData::set_scene_path(int, String const&) */

void __thiscall EditorData::set_scene_path(EditorData *this,int param_1,String *param_2)
...
LAB_0010cb8d:
  _err_print_index_error
            ("set_scene_path","editor/editor_data.cpp",0x378,lVar5,lVar4,"p_idx",
             "edited_scene.size()","",false,false);
  return;
}
...
/* EditorData::set_scene_modified_time(int, unsigned long) */

void __thiscall EditorData::set_scene_modified_time(EditorData *this,int param_1,ulong param_2)
...
LAB_0010cc99:
  _err_print_index_error
            ("set_scene_modified_time","editor/editor_data.cpp",0x32b,lVar2,lVar1,"p_idx",
             "edited_scene.size()","",false,false);
  return;
}
...
/* EditorData::set_edited_scene_root(Node*) */

void __thiscall EditorData::set_edited_scene_root(EditorData *this,Node *param_1)
...
LAB_0010ce30:
        ...
        Node::get_scene_file_path();
        if ((local_38 != 0) && (iVar6 = (int)*(undefined8 *)(local_38 + -8), iVar6 != 0)) {
...
LAB_0010cfa9:
  _err_print_index_error
            ("set_edited_scene_root","editor/editor_data.cpp",0x30a,lVar5,lVar3,
             "current_edited_scene","edited_scene.size()","",false,false);
LAB_0010ce74:
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
...
/* EditorData::is_scene_changed(int) */

ulong __thiscall EditorData::is_scene_changed(EditorData *this,int param_1)
...
LAB_0010d13d:
  _err_print_index_error
            ("is_scene_changed","editor/editor_data.cpp",0x1af,lVar5,lVar4,"p_idx",
             "edited_scene.size()","",false,false);
  return 0;
}
...
/* EditorData::clear_edited_scenes() */

void __thiscall EditorData::clear_edited_scenes(EditorData *this)
...
/* EditorData::remove_editor_plugin(EditorPlugin*) */

void __thiscall EditorData::remove_editor_plugin(EditorData *this,EditorPlugin *param_1)
...
/* Vector<EditorPlugin*>::push_back(EditorPlugin*) [clone .isra.0] */

void __thiscall Vector<EditorPlugin*>::push_back(Vector<EditorPlugin*> *this,EditorPlugin *param_1)
...
/* EditorData::add_editor_plugin(EditorPlugin*) */

void __thiscall EditorData::add_editor_plugin(EditorData *this,EditorPlugin *param_1)
...
/* EditorData::get_handling_sub_editors(Object*) */

Object * EditorData::get_handling_sub_editors(Object *param_1)
  ...
  while (lVar3 != 0) {
    ...
    if (cVar2 == '\0') {
      ...
      if (cVar2 != '\0') {
        ...
        lVar6 = *(long *)(lVar3 + -8);
        if (lVar6 <= (long)uVar5) goto LAB_0010d52a;
        Vector<EditorPlugin*>::push_back
                  ((Vector<EditorPlugin*> *)param_1,*(EditorPlugin **)(lVar3 + uVar5 * 8));
      }
    }
    uVar5 = uVar5 - 1;
    if ((int)uVar5 < 0) {
...
/* EditorData::remove_undo_redo_inspector_hook_callback(Callable) */

void __thiscall
EditorData::remove_undo_redo_inspector_hook_callback(EditorData *this,Callable *param_2)
...
/* EditorData::add_undo_redo_inspector_hook_callback(Callable) */

void __thiscall
EditorData::add_undo_redo_inspector_hook_callback(EditorData *this,Callable *param_2)
...
/* EditorData::remove_custom_type(String const&) */

void __thiscall EditorData::remove_custom_type(EditorData *this,String *param_1)
...
LAB_0010d84e:
  ...
  if (puVar4[4] == 0) {
    ...
    if (lVar38 < lVar35) {
      CowData<EditorData::CustomType>::_copy_on_write
                ((CowData<EditorData::CustomType> *)(puVar4 + 4));
      lVar35 = puVar4[4];
      if (lVar35 == 0) {
        lVar32 = -1;
      }
        ...
        if (lVar38 < lVar32) {
          ...
          do {
            ...
            pOVar5 = (Object *)plVar39[4];
            pOVar6 = (Object *)plVar39[1];
            if (pOVar5 != pOVar6) {
              plVar39[1] = (long)pOVar5;
              if ((pOVar5 != (Object *)0x0) && (cVar28 = RefCounted::reference(), cVar28 == '\0')) {
                plVar39[1] = 0;
              }
              if (((pOVar6 != (Object *)0x0) && (cVar28 = RefCounted::unreference(), cVar28 != '\0')
                  ) && (cVar28 = predelete_handler(pOVar6), cVar28 != '\0')) {
                (**(code **)(*(long *)pOVar6 + 0x140))(pOVar6);
                Memory::free_static(pOVar6,false);
              }
            }
            pOVar5 = (Object *)plVar39[5];
            pOVar6 = (Object *)plVar39[2];
            if (pOVar5 != pOVar6) {
      ...
      CowData<EditorData::CustomType>::resize<false>
                ((CowData<EditorData::CustomType> *)(puVar4 + 4),lVar32);
LAB_0010da0c:
      if (((puVar4[4] == 0) && (*(long *)(this + 0x48) != 0)) && (*(int *)(this + 0x6c) != 0)) {
        ...
        do {
          if (uVar30 == uVar29) {
            cVar28 = String::operator==((String *)
                                        (*(long *)(*(long *)(this + 0x48) + lVar32 * 8) + 0x10),
                                        (String *)(puVar4 + 2));
            if (cVar28 != '\0') {
              ...
              if ((uVar30 == 0) ||
                 ...
                 auVar14._0_8_ = (ulong)((uVar3 + uVar29) - SUB164(auVar13 * auVar23,8)) * lVar32,
                 auVar24._8_8_ = 0, auVar24._0_8_ = uVar36, uVar37 = uVar31,
                 SUB164(auVar14 * auVar24,8) == 0)) goto LAB_0010dc32;
              goto LAB_0010dbec;
            }
            lVar38 = *(long *)(this + 0x50);
          }
          ...
          uVar31 = SUB164(auVar9 * auVar19,8);
                ...
                (auVar10._8_8_ = 0, auVar10._0_8_ = (ulong)uVar29 * lVar35, auVar20._8_8_ = 0,
                auVar20._0_8_ = uVar36, auVar11._8_8_ = 0,
                auVar11._0_8_ = (ulong)((uVar3 + uVar31) - SUB164(auVar10 * auVar20,8)) * lVar35,
                auVar21._8_8_ = 0, auVar21._0_8_ = uVar36, uVar37 <= SUB164(auVar11 * auVar21,8)));
      }
      return;
    }
  }
  _err_print_index_error
            ("remove_at","./core/templates/cowdata.h",0xe4,lVar38,lVar35,"p_index","size()","",false
             ,false);
  goto LAB_0010da0c;
  while (auVar15._8_8_ = 0, auVar15._0_8_ = (ulong)uVar30 * lVar32, auVar25._8_8_ = 0,
        auVar25._0_8_ = uVar36, auVar16._8_8_ = 0,
        auVar16._0_8_ = (ulong)((uVar29 + uVar3) - SUB164(auVar15 * auVar25,8)) * lVar32,
        auVar26._8_8_ = 0, auVar26._0_8_ = uVar36, uVar37 = uVar31, SUB164(auVar16 * auVar26,8) != 0
        ) {
LAB_0010dbec:
    uVar31 = uVar29;
...
void __thiscall
EditorData::add_custom_type
          (EditorData *this,String *param_1,String *param_2,Ref *param_3,Ref *param_4)

{
  ...
  long lVar7;
  Object *pOVar8;
  HashMap<String,Vector<EditorData::CustomType>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Vector<EditorData::CustomType>>>>
  *this_01;
  long lVar9;
  Object *pOVar10;
  Object *pOVar11;
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (*(ulong *)param_3 == 0) {
    _err_print_error("add_custom_type","editor/editor_data.cpp",0x20a,
                     "Condition \"p_script.is_null()\" is true.",
                     "It\'s not a reference to a valid Script object.",0,0);
    goto LAB_0010e005;
  }
  local_68 = (Object *)0x0;
  local_78 = (undefined1  [16])0x0;
...
LAB_0010dda0:
  ...
  local_88 = (CowData *)local_78;
  this_01 = (HashMap<String,Vector<EditorData::CustomType>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Vector<EditorData::CustomType>>>>
             *)(this + 0x40);
  local_58 = (ulong)local_58._4_4_ << 0x20;
  cVar4 = HashMap<String,Vector<EditorData::CustomType>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Vector<EditorData::CustomType>>>>
          ::_lookup_pos(this_01,param_2,(uint *)&local_58);
  if (cVar4 == '\0') {
    local_50 = (Object *)0x0;
    lVar6 = HashMap<String,Vector<EditorData::CustomType>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Vector<EditorData::CustomType>>>>
            ::operator[](this_01,param_2);
    if (*(long *)(lVar6 + 8) != 0) {
  ...
  if ((pOVar8 == (Object *)0x0) ||
     (local_50 = pOVar8, cVar4 = RefCounted::reference(), pOVar10 = pOVar8, cVar4 == '\0')) {
    local_50 = (Object *)0x0;
    pOVar10 = (Object *)0x0;
  }
  pOVar3 = local_68;
...
LAB_0010e121:
  ...
  iVar5 = CowData<EditorData::CustomType>::resize<false>
                    ((CowData<EditorData::CustomType> *)(lVar6 + 8),lVar9);
  if (iVar5 == 0) {
    if (*(long *)(lVar6 + 8) == 0) {
      lVar7 = -1;
      lVar9 = 0;
LAB_0010e31a:
    ...
    if (pOVar11 == pOVar1) goto LAB_0010dfa0;
    *(Object **)(this_00 + 0x10) = pOVar11;
    if (pOVar11 != (Object *)0x0) {
      ...
      if (((pOVar1 != (Object *)0x0) && (cVar4 = RefCounted::unreference(), cVar4 != '\0')) &&
         (cVar4 = predelete_handler(pOVar1), cVar4 != '\0')) goto LAB_0010df7f;
      goto LAB_0010dfa5;
    }
    if (((pOVar1 != (Object *)0x0) && (cVar4 = RefCounted::unreference(), cVar4 != '\0')) &&
       (cVar4 = predelete_handler(pOVar1), cVar4 != '\0')) {
...
/* EditorData::remove_scene(int) */

void __thiscall EditorData::remove_scene(EditorData *this,int param_1)
...
LAB_0010e54f:
        if ((iVar7 != 0) && (param_1 == iVar7)) goto LAB_0010e600;
LAB_0010e55d:
        if (lVar6 == 0) goto LAB_0010e46b;
      }
      ...
      if (cVar5 != '\0') {
        ...
        lVar8 = *(long *)(lVar6 + -8);
        if (lVar8 <= lVar9) goto LAB_0010e46e;
        EditorUndoRedoManager::discard_history
                  ((int)*(undefined8 *)(this + 0x78),SUB41(*(undefined4 *)(lVar6 + 0x50 + lVar10),0)
                  );
      }
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
        Vector<EditorData::EditedScene>::remove_at
                  ((Vector<EditorData::EditedScene> *)(this + 0xc0),lVar9);
        return;
      }
      goto LAB_0010e7df;
    }
...
LAB_0010e61d:
  _err_print_index_error
            ("remove_scene","editor/editor_data.cpp",0x285,lVar9,lVar10,"p_idx",
             "edited_scene.size()","",false,false);
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
...
/* CowData<EditorData::EditedScene>::insert(long, EditorData::EditedScene const&) [clone .isra.0] */

void __thiscall
CowData<EditorData::EditedScene>::insert
          (CowData<EditorData::EditedScene> *this,long param_1,EditedScene *param_2)

{
  ...
  if ((param_1 < 0) || (lVar10 <= param_1)) {
    _err_print_index_error
              ("insert","./core/templates/cowdata.h",0xf0,param_1,lVar10,"p_pos","new_size","",false
               ,false);
    return;
  }
...
LAB_0010ea61:
  if ((*(long **)(param_2 + 0x20) != (long *)0x0) &&
     (puVar11 = (undefined8 *)**(long **)(param_2 + 0x20), puVar11 != (undefined8 *)0x0)) {
    if (plVar12 == (long *)0x0) {
...
LAB_0010eb4c:
  if (puVar9[6] != *(long *)(param_2 + 0x30)) {
    CowData<EditorSelectionHistory::HistoryElement>::_ref
              ((CowData<EditorSelectionHistory::HistoryElement> *)(puVar9 + 6),
               (CowData *)(param_2 + 0x30));
  }
...
/* EditorData::move_edited_scene_to_index(int) */

void __thiscall EditorData::move_edited_scene_to_index(EditorData *this,int param_1)
...
LAB_0010f0b0:
    ...
    if (lVar5 < lVar7) {
      ...
      if ((param_1 < 0) || (lVar7 <= lVar8)) {
        _err_print_index_error
                  ("move_edited_scene_to_index","editor/editor_data.cpp",0x33f,lVar8,lVar7,"p_idx",
                   "edited_scene.size()","",false,false);
      }
      else {
        ...
        if (((long *)puVar6[4] != (long *)0x0) &&
           (puVar4 = *(undefined8 **)puVar6[4], puVar4 != (undefined8 *)0x0)) {
...
LAB_0010eddc:
        ...
        if (puVar6[6] != 0) {
          CowData<EditorSelectionHistory::HistoryElement>::_ref
                    ((CowData<EditorSelectionHistory::HistoryElement> *)&local_d8,
                     (CowData *)(puVar6 + 6));
        }
        ...
        local_b0 = puVar6[0xb];
        Vector<EditorData::EditedScene>::remove_at
                  ((Vector<EditorData::EditedScene> *)(this + 0xc0),(long)*(int *)(this + 0xd0));
        local_a0 = 0;
        local_a8 = local_108;
        if (local_100 != 0) {
        ...
        if ((local_e8 != (undefined1 (*) [16])0x0) &&
           (puVar6 = *(undefined8 **)*local_e8, puVar6 != (undefined8 *)0x0)) {
          local_88 = (undefined1 (*) [16])operator_new(0x18,DefaultAllocator::alloc);
          *(undefined4 *)local_88[1] = 0;
          *local_88 = (undefined1  [16])0x0;
          do {
...
LAB_0010ef50:
        ...
        if (local_d8 != 0) {
          CowData<EditorSelectionHistory::HistoryElement>::_ref
                    ((CowData<EditorSelectionHistory::HistoryElement> *)&local_78,
                     (CowData *)&local_d8);
        }
        local_70 = local_d0;
        ...
        local_50 = local_b0;
        CowData<EditorData::EditedScene>::insert
                  ((CowData<EditorData::EditedScene> *)(this + 200),lVar8,(EditedScene *)&local_a8);
  ...
  _err_print_index_error
            ("move_edited_scene_to_index","editor/editor_data.cpp",0x33e,lVar5,lVar7,
             "current_edited_scene","edited_scene.size()","",false,false);
LAB_0010eff0:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
...
/* Vector<EditorData::EditedScene>::push_back(EditorData::EditedScene) [clone .isra.0] */

void __thiscall
Vector<EditorData::EditedScene>::push_back
          (Vector<EditorData::EditedScene> *this,undefined8 *param_2)

{
  ...
  iVar3 = CowData<EditorData::EditedScene>::resize<false>
                    ((CowData<EditorData::EditedScene> *)(this + 8),lVar7);
  if (iVar3 != 0) {
    _err_print_error("push_back","./core/templates/vector.h",0x142,
                     "Condition \"err\" is true. Returning: true",0,0);
    return;
  ...
  if (*(long *)(this + 8) == 0) {
    ...
    if (-1 < lVar8) {
      CowData<EditorData::EditedScene>::_copy_on_write
                ((CowData<EditorData::EditedScene> *)(this + 8));
...
LAB_0010f1d8:
      if (((long *)param_2[4] != (long *)0x0) &&
         (puVar9 = *(undefined8 **)param_2[4], puVar9 != (undefined8 *)0x0)) {
        if (plVar10 == (long *)0x0) {
          pauVar4 = (undefined1 (*) [16])operator_new(0x18,DefaultAllocator::alloc);
          puVar6[4] = pauVar4;
          *(undefined4 *)pauVar4[1] = 0;
...
LAB_0010f27c:
      if (puVar6[6] != param_2[6]) {
        CowData<EditorSelectionHistory::HistoryElement>::_ref
                  ((CowData<EditorSelectionHistory::HistoryElement> *)(puVar6 + 6),
                   (CowData *)(param_2 + 6));
      }
...
/* EditorData::add_edited_scene(int) */

int __thiscall EditorData::add_edited_scene(EditorData *this,int param_1)
...
LAB_0010f83f:
    ...
    if (local_d8 != 0) {
      CowData<EditorSelectionHistory::HistoryElement>::_ref
                ((CowData<EditorSelectionHistory::HistoryElement> *)&local_78,(CowData *)&local_d8);
    }
    local_70 = local_d0;
    Dictionary::Dictionary(local_68,local_c8);
    ...
    local_50 = local_b0;
    Vector<EditorData::EditedScene>::push_back
              ((Vector<EditorData::EditedScene> *)(this + 0xc0),(CowData<char32_t> *)&local_a8);
    EditedScene::~EditedScene((EditedScene *)&local_a8);
  }
  else {
    local_a8 = (char *)local_108._0_8_;
...
LAB_0010f637:
    ...
    local_50 = local_b0;
    CowData<EditorData::EditedScene>::insert
              ((CowData<EditorData::EditedScene> *)(this + 200),lVar5,(EditedScene *)&local_a8);
    EditedScene::~EditedScene((EditedScene *)&local_a8);
  }
  if (*(int *)(this + 0xd0) < 0) {
...
/* EditorData::get_edited_scenes() const */

Vector<EditorData::EditedScene> * EditorData::get_edited_scenes(void)
  ...
  *(undefined8 *)(in_RDI + 8) = 0;
  ...
  do {
    ...
    if ((*(long **)(lVar7 + 0x20) != (long *)0x0) &&
       (puVar9 = (undefined8 *)**(long **)(lVar7 + 0x20), puVar9 != (undefined8 *)0x0)) {
      local_88 = (undefined1 (*) [16])operator_new(0x18,DefaultAllocator::alloc);
      *(undefined4 *)local_88[1] = 0;
      *local_88 = (undefined1  [16])0x0;
      do {
...
/* EditorSelection::is_class_ptr(void*) const */

uint __thiscall EditorSelection::is_class_ptr(EditorSelection *this,void *param_1)

{
  return (uint)CONCAT71(0x11a1,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x11a0,(undefined4 *)param_1 == &get_class_ptr_static()::ptr);
}



/* EditorSelection::_getv(StringName const&, Variant&) const */

undefined8 EditorSelection::_getv(StringName *param_1,Variant *param_2)
...
/* EditorSelection::_setv(StringName const&, Variant const&) */

undefined8 EditorSelection::_setv(StringName *param_1,Variant *param_2)
...
/* EditorSelection::_validate_propertyv(PropertyInfo&) const */

void EditorSelection::_validate_propertyv(PropertyInfo *param_1)
...
/* EditorSelection::_property_can_revertv(StringName const&) const */

undefined8 EditorSelection::_property_can_revertv(StringName *param_1)
...
/* EditorSelection::_property_get_revertv(StringName const&, Variant&) const */

undefined8 EditorSelection::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* EditorSelection::_notificationv(int, bool) */

void EditorSelection::_notificationv(int param_1,bool param_2)
...
/* CallableCustomMethodPointer<EditorSelection, void>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<EditorSelection,void>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<EditorSelection,void> *this)
...
/* CallableCustomMethodPointer<EditorSelection, void, Node*>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<EditorSelection,void,Node*>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<EditorSelection,void,Node*> *this)
...
/* MethodBindTR<TypedArray<Node>>::_gen_argument_type(int) const */

undefined8 MethodBindTR<TypedArray<Node>>::_gen_argument_type(int param_1)
...
/* MethodBindTR<TypedArray<Node>>::get_argument_meta(int) const */

undefined8 MethodBindTR<TypedArray<Node>>::get_argument_meta(int param_1)
...
/* CallableCustomMethodPointer<EditorSelection, void>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<EditorSelection,void>::get_argument_count
          (CallableCustomMethodPointer<EditorSelection,void> *this,bool *param_1)
...
/* CallableCustomMethodPointer<EditorSelection, void, Node*>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<EditorSelection,void,Node*>::get_argument_count
          (CallableCustomMethodPointer<EditorSelection,void,Node*> *this,bool *param_1)
...
/* MethodBindTR<TypedArray<Node>>::~MethodBindTR() */

void __thiscall MethodBindTR<TypedArray<Node>>::~MethodBindTR(MethodBindTR<TypedArray<Node>> *this)
...
/* CowData<EditorSelectionHistory::_Object>::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<EditorSelectionHistory::_Object>::_copy_on_write(void)
...
/* CowData<EditorData::CustomType>::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<EditorData::CustomType>::_copy_on_write(void)
...
undefined8 __thiscall
HashMap<Node*,Object*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,Object*>>>
::_lookup_pos(HashMap<Node*,Object*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,Object*>>>
...
/* CallableCustomMethodPointer<EditorSelection, void>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<EditorSelection,void>::get_object
          (CallableCustomMethodPointer<EditorSelection,void> *this)
...
/* CallableCustomMethodPointer<EditorSelection, void, Node*>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<EditorSelection,void,Node*>::get_object
          (CallableCustomMethodPointer<EditorSelection,void,Node*> *this)
...
/* EditorSelection::_get_class_namev() const */

undefined8 * EditorSelection::_get_class_namev(void)
...
LAB_00110c83:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"EditorSelection");
      goto LAB_00110cee;
    }
  }
  StringName::assign_static_unique_class_name
...
/* EditorSelection::get_class() const */

void EditorSelection::get_class(void)
...
/* EditorSelection::is_class(String const&) const */

undefined8 __thiscall EditorSelection::is_class(EditorSelection *this,String *param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashMap<StringName, Callable, HashMapHasherDefault, HashMapComparatorDefault<StringName>,
...
LAB_00111ce7:
    if ((float)uVar30 * __LC51 < (float)(iVar36 + 1)) goto LAB_00111d0d;
  }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashMap<StringName, EditorPlugin*, HashMapHasherDefault, HashMapComparatorDefault<StringName>,
...
LAB_001122d4:
      ...
      if (uVar41 != 0) {
        do {
          if ((uVar30 == uVar41) &&
             (*(long *)(*(long *)(param_2[1] + lVar37 * 8) + 0x10) == *(long *)pSVar36)) {
          ...
          uVar40 = SUB164(auVar5 * auVar17,8);
                ...
                (auVar6._8_8_ = 0, auVar6._0_8_ = (ulong)uVar41 * lVar33, auVar18._8_8_ = 0,
                auVar18._0_8_ = uVar31, auVar7._8_8_ = 0,
                auVar7._0_8_ = (ulong)((uVar1 + uVar40) - SUB164(auVar6 * auVar18,8)) * lVar33,
                auVar19._8_8_ = 0, auVar19._0_8_ = uVar31, uVar43 <= SUB164(auVar7 * auVar19,8)));
      }
      iVar35 = *(int *)((long)param_2 + 0x2c);
    }
LAB_001123f0:
    if ((float)uVar29 * __LC51 < (float)(iVar35 + 1)) goto LAB_00112416;
  }
...
/* List<Node*, DefaultAllocator>::TEMPNAMEPLACEHOLDERVALUE(List<Node*, DefaultAllocator> const&) */

void __thiscall
List<Node*,DefaultAllocator>::operator=(List<Node*,DefaultAllocator> *this,List *param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashMap<Node*, Object*, HashMapHasherDefault, HashMapComparatorDefault<Node*>,
   DefaultTypedAllocator<HashMapElement<Node*, Object*> > >::operator[](Node* const&) */
...
/* Callable create_custom_callable_function_pointer<EditorSelection, Node*>(EditorSelection*, char
   const*, void (EditorSelection::*)(Node*)) */

EditorSelection *
create_custom_callable_function_pointer<EditorSelection,Node*>
          (EditorSelection *param_1,char *param_2,_func_void_Node_ptr *param_3)
        ...
        if (uVar50 != 0) {
          do {
            if (uVar39 == uVar50) {
              ...
              if (cVar37 != '\0') {
                StringName::operator=
                          ((StringName *)(*(long *)(*(long *)(this + 8) + (ulong)uVar49 * 8) + 0x18)
                           ,(StringName *)&local_70);
...
LAB_001131d6:
    ...
    *(void **)(this + 8) = __s_00;
    ...
    iVar44 = 0;
LAB_001131b0:
    if ((float)uVar47 * __LC51 < (float)(iVar44 + 1)) goto LAB_001131d6;
  }
  local_58 = 0;
  local_68 = (undefined1  [16])0x0;
  if (*(long *)param_1 != 0) {
  ...
  *puVar42 = local_68._0_8_;
  ...
  local_a0 = (StringName *)(puVar42 + 3);
  StringName::StringName(local_a0,(StringName *)local_50);
...
LAB_00113be2:
    ...
    *(void **)(this + 8) = __s_00;
    ...
    iVar45 = 0;
LAB_00113bbc:
    if ((float)uVar39 * __LC51 < (float)(iVar45 + 1)) goto LAB_00113be2;
  }
  local_68 = (undefined1  [16])0x0;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashMap<String, Ref<Texture>, HashMapHasherDefault, HashMapComparatorDefault<String>,
   DefaultTypedAllocator<HashMapElement<String, Ref<Texture> > > >::operator[](String const&) */

undefined1 * __thiscall
HashMap<String,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Texture>>>>
::operator[](HashMap<String,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Texture>>>>
             *this,String *param_1)
...
LAB_001141c4:
    if ((float)uVar40 * __LC51 < (float)(iVar45 + 1)) goto LAB_001141ea;
  }
  local_58[0] = 0;
  if (*(long *)param_1 == 0) {
...
/* MethodBindTR<TypedArray<Node>>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTR<TypedArray<Node>>::_gen_argument_type_info(int param_1)
...
void __thiscall
CallableCustomMethodPointer<EditorSelection,void>::call
          (CallableCustomMethodPointer<EditorSelection,void> *this,Variant **param_1,int param_2,
...
void __thiscall
CallableCustomMethodPointer<EditorSelection,void,Node*>::call
          (CallableCustomMethodPointer<EditorSelection,void,Node*> *this,Variant **param_1,
...
LAB_00114ee0:
          ...
          *(undefined8 *)(param_4 + 4) = uVar4;
          ...
          if (((pOVar7 == (Object *)0x0) ||
             ...
             (pOVar6 != (Object *)0x0)) goto LAB_00114ee0;
        }
...
/* EditorSelection::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void EditorSelection::_get_property_listv(List *param_1,bool param_2)
...
/* HashMap<String, Vector<EditorData::CustomType>, HashMapHasherDefault,
   ...
   Vector<EditorData::CustomType> > > >::_lookup_pos(String const&, unsigned int&) const */
...
/* MethodBind* create_method_bind<EditorSelection>(void (EditorSelection::*)()) */

MethodBind * create_method_bind<EditorSelection>(_func_void *param_1)
...
/* MethodBind* create_method_bind<EditorSelection, Node*>(void (EditorSelection::*)(Node*)) */

MethodBind * create_method_bind<EditorSelection,Node*>(_func_void_Node_ptr *param_1)
...
MethodBind * create_method_bind<EditorSelection,TypedArray<Node>>(_func_TypedArray *param_1)
...
/* EditorSelection::_initialize_classv() */

void EditorSelection::_initialize_classv(void)
...
/* CowData<EditorSelectionHistory::HistoryElement>::_realloc(long) */

undefined8 __thiscall
CowData<EditorSelectionHistory::HistoryElement>::_realloc
          (CowData<EditorSelectionHistory::HistoryElement> *this,long param_1)
...
void __thiscall
CowData<EditorSelectionHistory::_Object>::_unref(CowData<EditorSelectionHistory::_Object> *this)
...
/* EditorData::EditedScene::~EditedScene() */

void __thiscall EditorData::EditedScene::~EditedScene(EditedScene *this)
...
LAB_0011612e:
  Dictionary::~Dictionary((Dictionary *)(this + 0x18));
  CowData<char32_t>::_unref((CowData<char32_t> *)(this + 8));
  return;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Error CowData<EditorSelectionHistory::HistoryElement>::resize<false>(long) */
...
LAB_001164f0:
  ...
  if (param_1 <= lVar5) {
    while (lVar5 = *(long *)this, lVar5 != 0) {
      ...
      CowData<EditorSelectionHistory::_Object>::_unref
                ((CowData<EditorSelectionHistory::_Object> *)(lVar5 + 8 + uVar9 * 0x18));
      uVar9 = uVar9 + 1;
    }
    goto LAB_00116546;
  }
...
/* CowData<EditorSelectionHistory::_Object>::_realloc(long) */

undefined8 __thiscall
CowData<EditorSelectionHistory::_Object>::_realloc
          (CowData<EditorSelectionHistory::_Object> *this,long param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Error CowData<EditorSelectionHistory::_Object>::resize<false>(long) */
...
void __thiscall CowData<EditorData::CustomType>::_unref(CowData<EditorData::CustomType> *this)
...
/* CowData<EditorData::CustomType>::_ref(CowData<EditorData::CustomType> const&) [clone .part.0] */

void __thiscall
CowData<EditorData::CustomType>::_ref(CowData<EditorData::CustomType> *this,CowData *param_1)
...
/* HashMap<String, Vector<EditorData::CustomType>, HashMapHasherDefault,
   HashMapComparatorDefault<String>, DefaultTypedAllocator<HashMapElement<String,
   Vector<EditorData::CustomType> > > >::operator[](String const&) */

undefined1 * __thiscall
HashMap<String,Vector<EditorData::CustomType>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Vector<EditorData::CustomType>>>>
::operator[](HashMap<String,Vector<EditorData::CustomType>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Vector<EditorData::CustomType>>>>
             *this,String *param_1)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  local_80 = 0;
  cVar21 = _lookup_pos(this,param_1,&local_80);
  if (cVar21 != '\0') {
  ...
  local_7c[0] = 0;
  cVar21 = _lookup_pos(this,param_1,local_7c);
  if (cVar21 == '\0') {
    ...
    *(int *)(this + 0x2c) = *(int *)(this + 0x2c) + 1;
    ...
    if (*(long *)pauVar26[2] != 0) {
      CowData<EditorData::CustomType>::_ref
                ((CowData<EditorData::CustomType> *)(pauVar26 + 2),(CowData *)&local_70);
      pauVar26 = *(undefined1 (**) [16])(*(long *)(this + 8) + uVar24 * 8);
    }
  }
LAB_00116f6c:
  CowData<EditorData::CustomType>::_unref((CowData<EditorData::CustomType> *)&local_70);
LAB_00116f78:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return pauVar26[1] + 8;
  }
...
/* CowData<EditorData::EditedScene>::_unref() */
...
/* CowData<EditorData::CustomType>::_realloc(long) */

undefined8 __thiscall
CowData<EditorData::CustomType>::_realloc(CowData<EditorData::CustomType> *this,long param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Error CowData<EditorData::CustomType>::resize<false>(long) */

undefined8 __thiscall
CowData<EditorData::CustomType>::resize<false>(CowData<EditorData::CustomType> *this,long param_1)
...
/* CowData<EditorData::EditedScene>::_realloc(long) */

undefined8 __thiscall
CowData<EditorData::EditedScene>::_realloc(CowData<EditorData::EditedScene> *this,long param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Error CowData<EditorData::EditedScene>::resize<false>(long) */

undefined8 __thiscall
CowData<EditorData::EditedScene>::resize<false>(CowData<EditorData::EditedScene> *this,long param_1)
...
/* Vector<EditorData::EditedScene>::remove_at(long) */

void __thiscall
Vector<EditorData::EditedScene>::remove_at(Vector<EditorData::EditedScene> *this,long param_1)
  ...
  if (param_1 < 0) {
    ...
    if (param_1 < lVar4) {
      ...
      if (lVar4 == 0) {
        ...
        if (param_1 < lVar5) {
          this_00 = (CowData<EditorSelectionHistory::HistoryElement> *)
                    (lVar4 + 0x30 + param_1 * 0x60);
          do {
...
LAB_001180e6:
      ...
      CowData<EditorData::EditedScene>::resize<false>
                ((CowData<EditorData::EditedScene> *)(this + 8),lVar5);
      return;
    }
    goto LAB_001181b7;
  }
...
/* WARNING: Removing unreachable block (ram,0x001183b8) */
...
Object * MethodBindTR<TypedArray<Node>>::call
...
/* MethodBindTR<TypedArray<Node>>::validated_call(Object*, Variant const**, Variant*) const */

void __thiscall
MethodBindTR<TypedArray<Node>>::validated_call
          (MethodBindTR<TypedArray<Node>> *this,Object *param_1,Variant **param_2,Variant *param_3)
...
/* MethodBindTR<TypedArray<Node>>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTR<TypedArray<Node>>::ptrcall
          (MethodBindTR<TypedArray<Node>> *this,Object *param_1,void **param_2,void *param_3)
...
LAB_00119836:
    ...
    *(undefined8 *)(in_R9 + 1) = uVar3;
    ...
    if (((pOVar8 == (Object *)0x0) ||
       ...
       (pOVar6 != (Object *)0x0)) goto LAB_00119836;
  }
  pOVar6 = Variant::operator_cast_to_Object_(pVVar12);
  if (pOVar6 != (Object *)0x0) {
    pOVar6 = (Object *)__dynamic_cast(pOVar6,&Object::typeinfo,&Node::typeinfo,0);

...
/* FileAccessZip::is_open() const */

bool __thiscall FileAccessZip::is_open(FileAccessZip *this)
...
/* FileAccessZip::file_exists(String const&) */

undefined8 FileAccessZip::file_exists(String *param_1)
...
/* FileAccessZip::store_buffer(unsigned char const*, unsigned long) */

undefined8 FileAccessZip::store_buffer(uchar *param_1,ulong param_2)

{
  _err_print_error("store_buffer","core/io/file_access_zip.cpp",0x146,
...
/* FileAccessZip::get_buffer(unsigned char*, unsigned long) const */

ulong __thiscall FileAccessZip::get_buffer(FileAccessZip *this,uchar *param_1,ulong param_2)

{
  ...
  if ((param_1 == (uchar *)0x0) && (param_2 != 0)) {
    _err_print_error("get_buffer","core/io/file_access_zip.cpp",0x127,
    ...
    if (*(long *)(this + 400) != 0) {
      ...
      _err_print_error("get_buffer","core/io/file_access_zip.cpp",0x12f,
                       "Condition \"read < 0\" is true. Returning: read",0,0);
      return (long)iVar1;
    }
    _err_print_error("get_buffer","core/io/file_access_zip.cpp",0x128,"Parameter \"zfile\" is null."
                     ,0,0);
  }
...
undefined8 __thiscall FileAccessZip::get_length(FileAccessZip *this)

{
  if (*(long *)(this + 400) != 0) {
    return *(undefined8 *)(this + 0x1d0);
  }
  _err_print_error("get_length","core/io/file_access_zip.cpp",0x11c,"Parameter \"zfile\" is null.",0
                   ,0);
  return 0;
}
...
/* FileAccessZip::eof_reached() const */

FileAccessZip __thiscall FileAccessZip::eof_reached(FileAccessZip *this)

{
  if (*(long *)(this + 400) != 0) {
    return this[0x220];
  }
  _err_print_error("eof_reached","core/io/file_access_zip.cpp",0x121,"Parameter \"zfile\" is null.",
                   0,0);
...
/* FileAccessZip::seek(unsigned long) */

void FileAccessZip::seek(ulong param_1)
...
/* FileAccessZip::get_position() const */

undefined8 __thiscall FileAccessZip::get_position(FileAccessZip *this)

{
  ...
  _err_print_error("get_position","core/io/file_access_zip.cpp",0x117,"Parameter \"zfile\" is null."
                   ,0,0);
  return 0;
}
...
/* FileAccessZip::get_error() const */

byte __thiscall FileAccessZip::get_error(FileAccessZip *this)
...
/* FileAccessZip::seek_end(long) */

void __thiscall FileAccessZip::seek_end(FileAccessZip *this,long param_1)

{
  int iVar1;
  
  if (*(long *)(this + 400) == 0) {
    _err_print_error("seek_end","core/io/file_access_zip.cpp",0x112,"Parameter \"zfile\" is null.",0
                     ,0);
    return;
  }
...

{
  ...
  if (param_4 == 1) {
    if (*(code **)(lVar1 + 0x1c8) == FileAccessZip::get_position) {
      if (plVar2[0x32] == 0) {
        _err_print_error("get_position","core/io/file_access_zip.cpp",0x117,
                         "Parameter \"zfile\" is null.",0,0);
      }
      else {
        lVar1 = unztell64();
    ...
    if (*(code **)(lVar1 + 0x1d0) == FileAccessZip::get_length) {
      if (plVar2[0x32] == 0) {
        _err_print_error("get_length","core/io/file_access_zip.cpp",0x11c,
                         "Parameter \"zfile\" is null.",0,0);
        plVar2 = (long *)*param_2;
        lVar1 = *plVar2;
      }
  ...
  lVar1 = *plVar2;
LAB_00100560:
  if (*(code **)(lVar1 + 0x1b8) == FileAccessZip::seek) {
    if (plVar2[0x32] == 0) {
      _err_print_error(&_LC11,"core/io/file_access_zip.cpp",0x10c,"Parameter \"zfile\" is null.",0,0
                      );
    }
...
/* ZipArchive::close_handle(void*) const */

undefined8 __thiscall ZipArchive::close_handle(ZipArchive *this,void *param_1)

{
  ...
  _err_print_error("close_handle","core/io/file_access_zip.cpp",0x71,"Parameter \"p_file\" is null."
                   ,"Cannot close a file if none is open.",0);
  return 0;
}



/* ZipArchive::file_exists(String const&) const */

undefined8 __thiscall ZipArchive::file_exists(ZipArchive *this,String *param_1)
      ...
      do {
        if (uVar13 == uVar11) {
          uVar12 = String::operator==((String *)
                                      (*(long *)(*(long *)(this + 0x20) + lVar15 * 8) + 0x10),
                                      param_1);
          if ((char)uVar12 != '\0') {
            return uVar12;
          }
...
void ZipArchive::get_singleton(void)

{
  ...
  *puVar1 = &PTR_try_open_pack_00104d98;
  puVar1[2] = 0;
  puVar1[8] = 2;
  instance = puVar1;
...
undefined8 __thiscall FileAccessZip::close(FileAccessZip *this)

{
  ...
  if (lVar1 != 0) {
    ...
    if (lVar1 == 0) {
      uStack_28 = 0;
      _err_print_error("close_handle","core/io/file_access_zip.cpp",0x71,
                       "Parameter \"p_file\" is null.","Cannot close a file if none is open.",0);
    }
    else {
  ...
  uVar2 = _err_print_error("_close","core/io/file_access_zip.cpp",0x102,
                           "Parameter \"arch\" is null.",0,0);
  return uVar2;
}
...
void __thiscall ZipArchive::ZipArchive(ZipArchive *this)

{
  *(undefined8 *)(this + 0x10) = 0;
  *(undefined ***)this = &PTR_try_open_pack_00104d98;
...
/* FileAccessZip::_close() */

undefined8 __thiscall FileAccessZip::_close(FileAccessZip *this)
...
void __thiscall FileAccessZip::~FileAccessZip(FileAccessZip *this)

{
  *(undefined ***)this = &PTR__initialize_classv_00104dc8;
  _close(this);
...
/* ZipArchive::get_file_handle(String const&) const */

long __thiscall ZipArchive::get_file_handle(ZipArchive *this,String *param_1)
      ...
      do {
        if (uVar28 == uVar24) {
          cVar23 = String::operator==((String *)
                                      (*(long *)(*(long *)(this + 0x20) + lVar29 * 8) + 0x10),
                                      param_1);
          if (cVar23 != '\0') {
        ...
        iVar25 = SUB164(auVar6 * auVar14,8);
              ...
              (auVar7._8_8_ = 0, auVar7._0_8_ = (ulong)uVar24 * lVar27, auVar15._8_8_ = 0,
              auVar15._0_8_ = uVar31, auVar8._8_8_ = 0,
              auVar8._0_8_ = (ulong)((uVar4 + iVar25) - SUB164(auVar7 * auVar15,8)) * lVar27,
              auVar16._8_8_ = 0, auVar16._0_8_ = uVar31, uVar33 <= SUB164(auVar8 * auVar16,8)));
    }
  }
  local_b8 = 0;
  plVar1 = (long *)(*(long *)param_1 + -0x10);
...
LAB_00100bd8:
  ...
  _err_print_error("get_file_handle","core/io/file_access_zip.cpp",0x77,
                   "Condition \"!file_exists(p_file)\" is true. Returning: nullptr",&local_98,0,0);
  pcVar21 = local_98;
...
LAB_00100e47:
  if (uVar24 == uVar28) {
    cVar23 = String::operator==((String *)(*(long *)(*(long *)(this + 0x20) + lVar29 * 8) + 0x10),
                                param_1);
    if (cVar23 != '\0') {
...
LAB_00101085:
        ...
        if (lVar27 != 0) {
          ...
          if ((iVar25 != 0) || (iVar25 = unzOpenCurrentFile(lVar27), lVar30 = lVar27, iVar25 != 0))
          {
            lVar30 = 0;
            unzClose(lVar27);
            _err_print_error("get_file_handle","core/io/file_access_zip.cpp",0x8f,
...
LAB_00101089:
      _err_print_index_error
                ("get","./core/templates/cowdata.h",0xdb,lVar27,lVar30,"p_index","size()","",false,
                 true);
      _err_flush_stdout();
  ...
  if ((uVar24 == 0) ||
     (auVar11._8_8_ = 0, auVar11._0_8_ = (ulong)uVar24 * lVar27, auVar19._8_8_ = 0,
     auVar19._0_8_ = uVar31, auVar12._8_8_ = 0,
     auVar12._0_8_ = (ulong)((uVar4 + uVar33) - SUB164(auVar11 * auVar19,8)) * lVar27,
     auVar20._8_8_ = 0, auVar20._0_8_ = uVar31, SUB164(auVar12 * auVar20,8) < uVar32)) {
LAB_00101010:
...
LAB_00101130:
  ...
  _err_print_error("get_file_handle","core/io/file_access_zip.cpp",0x8b,"Parameter \"pkg\" is null."
                   ,&local_c8,0);
  pcVar22 = local_c8;
  if (local_c8 != (char *)0x0) {
    LOCK();
...
/* FileAccessZip::open_internal(String const&, int) */

undefined8 __thiscall FileAccessZip::open_internal(FileAccessZip *this,String *param_1,int param_2)

{
  ...
  if ((param_2 & 2U) == 0) {
    ...
    if (this_00 == (ZipArchive *)0x0) {
      _err_print_error("open_internal","core/io/file_access_zip.cpp",0xf2,
                       "Parameter \"arch\" is null.",0,0);
    }
    else {
      ...
      *(long *)(this + 400) = lVar2;
      if (lVar2 == 0) {
        _err_print_error("open_internal","core/io/file_access_zip.cpp",0xf4,
                         "Parameter \"zfile\" is null.",0,0);
      }
      else {
        ...
        _err_print_error("open_internal","core/io/file_access_zip.cpp",0xf7,
                         "Condition \"err != (0)\" is true. Returning: FAILED",0,0);
      }
    }
  }
  else {
    _err_print_error("open_internal","core/io/file_access_zip.cpp",0xf0,
                     "Condition \"p_mode_flags & FileAccess::WRITE\" is true. Returning: FAILED",0,0
                    );
  }
  return 1;
}
...
/* FileAccessZip::FileAccessZip(String const&, PackedData::PackedFile const&) */

void __thiscall
FileAccessZip::FileAccessZip(FileAccessZip *this,String *param_1,PackedFile *param_2)
...
/* ZipArchive::get_file(String const&, PackedData::PackedFile*) */

ZipArchive * __thiscall ZipArchive::get_file(ZipArchive *this,String *param_1,PackedFile *param_2)

{
  ...
  *(undefined ***)this_00 = &PTR__initialize_classv_00104dc8;
...

{
  ...
  if ((param_3 & 2) == 0) {
    ...
    if (local_20 == (FileAccess *)0x0) {
      _err_print_error("godot_open","core/io/file_access_zip.cpp",0x33,
                       "Condition \"f.is_null()\" is true. Returning: nullptr",0,0);
      plVar3 = (long *)0x0;
    }
    else {
...
/* CowData<ZipArchive::Package>::_copy_on_write() [clone .isra.0] */

void __thiscall CowData<ZipArchive::Package>::_copy_on_write(CowData<ZipArchive::Package> *this)
...
/* ZipArchive::try_open_pack(String const&, bool, unsigned long) */

undefined8 __thiscall
ZipArchive::try_open_pack(ZipArchive *this,String *param_1,bool param_2,ulong param_3)
...
joined_r0x00101a00:
    ...
    if (lVar9 == 0) {
      _err_print_error("try_open_pack","core/io/file_access_zip.cpp",0xab,
                       "Parameter \"zfile\" is null.",0,0);
    }
    else {
...
LAB_00101c39:
        ...
        local_1e0 = lVar9;
        iVar7 = CowData<ZipArchive::Package>::resize<false>
                          ((CowData<ZipArchive::Package> *)(this + 0x10),lVar12);
        if (iVar7 == 0) {
          if (*(long *)(this + 0x10) == 0) {
            lVar13 = -1;
            lVar12 = 0;
            ...
            lVar13 = lVar12 + -1;
            if (-1 < lVar13) {
              CowData<ZipArchive::Package>::_copy_on_write
                        ((CowData<ZipArchive::Package> *)(this + 0x10));
...
LAB_00101cba:
        ...
        if (local_278[0] != 0) {
          ...
          do {
            ...
            if (iVar7 == 0) {
              ...
              plVar10 = (long *)HashMap<String,ZipArchive::File,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ZipArchive::File>>>
                                ::operator[]((HashMap<String,ZipArchive::File,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ZipArchive::File>>>
                                              *)(this + 0x18),(String *)&local_268);
              pSVar2 = PackedData::singleton;
              *plVar10 = local_258;
              plVar10[1] = lStack_250;
              local_158[0] = (PackSource)0x0;
              local_158[1] = (PackSource)0x0;
              local_158[2] = (PackSource)0x0;
              local_158[3] = (PackSource)0x0;
              local_158[4] = (PackSource)0x0;
              local_158[5] = (PackSource)0x0;
              local_158[6] = (PackSource)0x0;
              local_158[7] = (PackSource)0x0;
              local_158[8] = (PackSource)0x0;
              local_158[9] = (PackSource)0x0;
              local_158[10] = (PackSource)0x0;
              local_158[0xb] = (PackSource)0x0;
              local_158[0xc] = (PackSource)0x0;
              local_158[0xd] = (PackSource)0x0;
              local_158[0xe] = (PackSource)0x0;
              local_158[0xf] = (PackSource)0x0;
              plVar10[2] = local_248;
              PackedData::add_path
                        (pSVar2,param_1,(ulong)&local_268,1,(uchar *)0x0,local_158,SUB81(this,0),
                         param_2);
              ...
              _err_print_error("try_open_pack","core/io/file_access_zip.cpp",0xbc,
                               "Condition \"err != (0)\" is true. Continuing.");
            }
      ...
      _err_print_error("try_open_pack","core/io/file_access_zip.cpp",0xaf,
                       "Condition \"err != (0)\" is true. Returning: false",0,0);
    }
  }
  else {
    _err_print_error("try_open_pack","core/io/file_access_zip.cpp",0x97,
...
/* FileAccessZip::resize(long) */

undefined8 FileAccessZip::resize(long param_1)
...
/* FileAccessZip::_get_modified_time(String const&) */

undefined8 FileAccessZip::_get_modified_time(String *param_1)
...
/* FileAccessZip::_get_unix_permissions(String const&) */

undefined8 FileAccessZip::_get_unix_permissions(String *param_1)
...
/* FileAccessZip::_set_unix_permissions(String const&, BitField<FileAccess::UnixPermissionFlags>) */

undefined8 FileAccessZip::_set_unix_permissions(void)
...
/* FileAccessZip::_get_hidden_attribute(String const&) */

undefined8 FileAccessZip::_get_hidden_attribute(String *param_1)
...
/* FileAccessZip::_set_hidden_attribute(String const&, bool) */

undefined8 FileAccessZip::_set_hidden_attribute(String *param_1,bool param_2)
...
/* FileAccessZip::_get_read_only_attribute(String const&) */

undefined8 FileAccessZip::_get_read_only_attribute(String *param_1)
...
/* FileAccessZip::_set_read_only_attribute(String const&, bool) */

undefined8 FileAccessZip::_set_read_only_attribute(String *param_1,bool param_2)
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialize_class()::initialized != '\0') goto LAB_00102ce0;
...
HashMap<String,ZipArchive::File,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ZipArchive::File>>>
::operator[](HashMap<String,ZipArchive::File,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ZipArchive::File>>>
             *this,String *param_1)
...
LAB_00103fe7:
    if ((float)uVar39 * __LC47 < (float)(iVar45 + 1)) goto LAB_0010400d;
  }
  local_68 = 0;
  if (*(long *)param_1 == 0) {
    local_60 = 0xffffffff;
...

{
  ...
  if (*(code **)(*(long *)param_1 + 0x140) == FileAccessZip::~FileAccessZip) {
    *(undefined ***)param_1 = &PTR__initialize_classv_00104dc8;
...
void __thiscall CowData<ZipArchive::Package>::_unref(CowData<ZipArchive::Package> *this)
...
undefined8 __thiscall
CowData<ZipArchive::Package>::_realloc(CowData<ZipArchive::Package> *this,long param_1)
...
undefined8 __thiscall
CowData<ZipArchive::Package>::resize<false>(CowData<ZipArchive::Package> *this,long param_1)
...
LAB_00104b5f:
      ...
      while( true ) {
        plVar3 = (long *)(uVar10 * 0x10 + lVar7);
        if (*plVar3 != 0) break;
        uVar10 = uVar10 + 1;
        if (*(ulong *)(lVar7 + -8) <= uVar10) goto LAB_00104b5f;
      }
      LOCK();
...
LAB_00104d06:
    ...
    lVar7 = puVar8[-1];
    if (param_1 <= lVar7) goto LAB_00104c04;
  }
  else {
    if (lVar7 != 0) {
      uVar4 = _realloc(this,lVar11);
  ...
  pauVar6 = (undefined1 (*) [16])(puVar8 + lVar7 * 2);
  do {
    *pauVar6 = (undefined1  [16])0x0;
    pauVar6 = pauVar6 + 1;
  } while (pauVar6 != (undefined1 (*) [16])(puVar8 + param_1 * 2));
LAB_00104c04:
  puVar8[-1] = param_1;
  return 0;
}

...
void EditorTranslationParser::get_singleton(void)
...
void __thiscall EditorTranslationParser::EditorTranslationParser(EditorTranslationParser *this)
...
/* EditorTranslationParser::get_parser(String const&) const */

String * EditorTranslationParser::get_parser(String *param_1)
  ...
  if (lVar6 != 0) {
    ...
    while (lVar7 < *(long *)(lVar6 + -8)) {
      ...
      if (local_58 != (char *)0x0) {
        for (pSVar2 = *(String **)local_58; pSVar2 != (String *)0x0;
...
LAB_00100527:
  ...
  operator+((char *)&local_68,(String *)"No translation parser available for \"");
  String::operator+((String *)&local_58,(String *)&local_68);
  _err_print_error("get_parser","editor/editor_translation_parser.cpp",0x95,
                   (List<String,DefaultAllocator> *)&local_58,0,1);
  pcVar4 = local_58;
  if (local_58 != (char *)0x0) {
    LOCK();
...
/* EditorTranslationParser::get_recognized_extensions(List<String, DefaultAllocator>*) const */

void __thiscall
EditorTranslationParser::get_recognized_extensions(EditorTranslationParser *this,List *param_1)
...
LAB_001005fe:
    ...
    if ((local_80 != (long *)0x0) && (lVar5 = *local_80, lVar5 != 0)) {
      do {
...
/* EditorTranslationParser::can_parse(String const&) const */

char __thiscall EditorTranslationParser::can_parse(EditorTranslationParser *this,String *param_1)
...
void __thiscall
EditorTranslationParserPlugin::get_recognized_extensions
          (EditorTranslationParserPlugin *this,List *param_1)

{
  ...
  if (plVar7 == (long *)0x0) {
LAB_00100c3b:
    if ((*(long *)(this + 8) != 0) && (this[0x1a0] == (EditorTranslationParserPlugin)0x0)) {
      local_c8 = 0;
      local_f8[0] = 0x10599f;
      local_f8[1] = 0;
...
LAB_0010121e:
          ...
          if (((pcVar8 == (code *)0x0) || (*(long *)(lVar6 + 0xe0) == 0)) &&
             (pcVar8 = *(code **)(lVar6 + 0xc0), pcVar8 == (code *)0x0)) goto LAB_0010110e;
...
LAB_0010110e:
    ...
    if (pcVar8 == (code *)0x0) {
      _err_print_error("get_recognized_extensions","editor/editor_translation_parser.cpp",0x53,
                       "Custom translation parser plugin\'s \"func get_recognized_extensions()\" is undefined."
                       ,0,0);
      goto LAB_00100dba;
    }
    uStack_f0 = 0;
...
LAB_00100e38:
      ...
      (**(code **)(*(long *)(this + 8) + 0xe0))
                (*(undefined8 *)(this + 0x10),this + 0x198,pcVar8,0,local_f8);
      lVar6 = CONCAT44(uStack_ec,uStack_f0);
...
/* CowData<Ref<EditorTranslationParserPlugin> >::_copy_on_write() [clone .isra.0] */

void __thiscall
CowData<Ref<EditorTranslationParserPlugin>>::_copy_on_write
          (CowData<Ref<EditorTranslationParserPlugin>> *this)
...

{
  ...
  Memory::free_static(pEVar1,false);
  singleton = (EditorTranslationParser *)0x0;
  CowData<Ref<EditorTranslationParserPlugin>>::_unref
            ((CowData<Ref<EditorTranslationParserPlugin>> *)(this + 0x18));
  CowData<Ref<EditorTranslationParserPlugin>>::_unref
            ((CowData<Ref<EditorTranslationParserPlugin>> *)(this + 8));
  return;
}



/* EditorTranslationParser::clean_parsers() */

void __thiscall EditorTranslationParser::clean_parsers(EditorTranslationParser *this)
...
void EditorTranslationParserPlugin::_bind_methods(void)
...
LAB_00102dc6:
  ...
  *(int *)local_78[0][1] = *(int *)local_78[0][1] + 1;
  ...
  String::parse_latin1((StrRange *)&local_100);
  StringName::StringName((StringName *)&local_e8,(String *)&local_100,false);
  ClassDB::add_virtual_compatibility_method
            ((StringName *)&local_e8,(MethodInfo *)&local_b8,true,local_158,false);
  if ((StringName::configured != '\0') && (local_e8 != (char *)0x0)) {
    StringName::unref();
  }
  uVar12 = local_100;
...
/* EditorTranslationParserPlugin::parse_file(String const&, Vector<Vector<String> >*) */

undefined8 __thiscall
EditorTranslationParserPlugin::parse_file
          (EditorTranslationParserPlugin *this,String *param_1,Vector *param_2)
...
LAB_00103929:
  ...
  if (plVar12 == (long *)0x0) {
LAB_001039ea:
    if ((*(long *)(this + 8) != 0) && (this[0x188] == (EditorTranslationParserPlugin)0x0)) {
      ...
      GetTypeInfo<TypedArray<Vector<String>>,void>::get_class_info
                ((GetTypeInfo<TypedArray<Vector<String>>,void> *)&local_148);
      ...
      *(undefined8 *)(this + 400) = 0;
      ...
      if (((pcVar13 == (code *)0x0) || (*(long *)(lVar18 + 0xe0) == 0)) &&
         (pcVar13 = *(code **)(lVar18 + 0xd0), pcVar13 == (code *)0x0)) {
        local_140 = 0x1d;
        local_168 = 0;
...
LAB_001050fc:
          ...
          if (((pcVar13 == (code *)0x0) || (*(long *)(lVar18 + 0xe0) == 0)) &&
             (pcVar13 = *(code **)(lVar18 + 0xc0), pcVar13 == (code *)0x0)) goto LAB_0010493c;
...
LAB_0010493c:
    ...
    if (*(long *)(this + 400) == 0) {
      ...
      if (*(long *)param_1 == 0) {
        if (*(long *)(this + 8) != 0) {
LAB_001049b7:
          if (this[0x1b8] == (EditorTranslationParserPlugin)0x0) {
            pVVar15 = (Variant *)0x0;
            goto LAB_001049c8;
          }
          goto LAB_00103eec;
        ...
        pVVar15 = (Variant *)0x0;
LAB_00104068:
        Array::Array((Array *)&local_148,(Array *)&local_170);
        ...
        if (*(code **)(*(long *)(this + 8) + 0xe0) == (code *)0x0) {
          ...
          (**(code **)(*(long *)(this + 8) + 0xe0))
                    (*(undefined8 *)(this + 0x10),this + 0x1b0,*(undefined8 *)(this + 0x1c0));
        }
              ...
              if (0 < lVar18) {
                ...
                if (local_58 != *(Variant ***)CONCAT44(uStack_10c,local_110)) {
                  CowData<char32_t>::_ref
                            ((CowData<char32_t> *)CONCAT44(uStack_10c,local_110),
                             (CowData *)&local_58);
                }
                goto LAB_001041e5;
              }
...
LAB_001041e5:
        ...
        if (0 < iVar8) {
          do {
            ...
            if (iVar8 != 3) {
              uVar14 = 0x1e;
              _err_print_error("parse_file","editor/editor_translation_parser.cpp",0x40,
                               "Condition \"arr.size() != 3\" is true. Returning: ERR_INVALID_DATA",
                               "Array entries written into `msgids_context_plural` in `_parse_file` method should have the form [\"message\", \"context\", \"plural message\"]"
                               ,0,0);
              Array::~Array((Array *)&local_148);
              goto LAB_00103c0b;
            }
...
LAB_001043e3:
                  _err_print_index_error
                            ("set","./core/templates/cowdata.h",0xcf,lVar18,lVar10,"p_index",
                             "size()","",false,false);
                }
                else {
        ...
        if (lVar10 == -1) {
LAB_00103ee0:
          if (*(long *)(this + 8) != 0) goto LAB_001049b7;
LAB_00103eec:
          if (*(long *)(this + 0x1c0) != 0) goto LAB_00103f07;
        }
        else {
...
LAB_001049c8:
            ...
            *(int *)local_d8[1] = *(int *)local_d8[1] + 1;
            ...
            GetTypeInfo<TypedArray<String>,void>::get_class_info
                      ((GetTypeInfo<TypedArray<String>,void> *)&local_148);
            if (local_d8 == (undefined1 (*) [16])0x0) {
              local_d8 = (undefined1 (*) [16])operator_new(0x18,DefaultAllocator::alloc);
              *(undefined4 *)local_d8[1] = 0;
              *local_d8 = (undefined1  [16])0x0;
            ...
            *(int *)local_d8[1] = *(int *)local_d8[1] + 1;
            ...
            Vector<int>::push_back(local_b8,0);
            GetTypeInfo<TypedArray<Array>,void>::get_class_info
                      ((GetTypeInfo<TypedArray<Array>,void> *)&local_148);
            if (local_d8 == (undefined1 (*) [16])0x0) {
              local_d8 = (undefined1 (*) [16])operator_new(0x18,DefaultAllocator::alloc);
              *(undefined4 *)local_d8[1] = 0;
              *local_d8 = (undefined1  [16])0x0;
            ...
            *(undefined8 *)(this + 0x1c0) = 0;
            ...
            if (((pcVar13 == (code *)0x0) || (*(long *)(lVar18 + 0xe0) == 0)) &&
              ...
              pcVar13 = *(code **)(lVar18 + 200);
              if (((pcVar13 != (code *)0x0) && (*(long *)(lVar18 + 0xe0) != 0)) ||
                 (pcVar13 = *(code **)(lVar18 + 0xc0), pcVar13 != (code *)0x0)) {
                uVar14 = (*pcVar13)(*(undefined8 *)(lVar18 + 0xa0));
...
LAB_00103bcd:
        ...
        Array::~Array((Array *)&local_170);
        Array::~Array(local_1c0);
        _err_print_error("parse_file","editor/editor_translation_parser.cpp",0x48,
                         "Custom translation parser plugin\'s \"_parse_file\" is undefined.",0,0);
      }
LAB_00103c0b:
      Array::~Array(local_178);
      Array::~Array(local_180);
...
LAB_00103c8d:
    ...
    if (*(code **)(*(long *)(this + 8) + 0xe0) == (code *)0x0) {
      ...
      (**(code **)(*(long *)(this + 8) + 0xe0))
                (*(undefined8 *)(this + 0x10),this + 0x180,*(undefined8 *)(this + 400),local_78,
                 (Array *)&local_158);
    }
    Array::Array((Array *)&local_118);
    local_58 = (Variant **)0x0;
...
/* EditorTranslationParser::remove_parser(Ref<EditorTranslationParserPlugin> const&,
   EditorTranslationParser::ParserType) */

void __thiscall
EditorTranslationParser::remove_parser(EditorTranslationParser *this,long *param_1,int param_3)
...
LAB_001053df:
      Vector<Ref<EditorTranslationParserPlugin>>::remove_at
                ((Vector<Ref<EditorTranslationParserPlugin>> *)this,lVar2);
      return;
    }
  }
  else if (param_3 == 1) {
...
void __thiscall
Vector<Ref<EditorTranslationParserPlugin>>::push_back
          (Vector<Ref<EditorTranslationParserPlugin>> *this,long *param_2)

{
  ...
  iVar5 = CowData<Ref<EditorTranslationParserPlugin>>::resize<false>
                    ((CowData<Ref<EditorTranslationParserPlugin>> *)(this + 8),lVar6);
  if (iVar5 != 0) {
    _err_print_error("push_back","./core/templates/vector.h",0x142,
                     "Condition \"err\" is true. Returning: true",0,0);
    return;
...
void __thiscall
EditorTranslationParser::add_parser(EditorTranslationParser *this,undefined8 *param_1,int param_3)
...
LAB_001055ec:
    ...
    if ((pOVar1 == (Object *)0x0) ||
      ...
      local_28 = (Object *)0x0;
      Vector<Ref<EditorTranslationParserPlugin>>::push_back
                ((Vector<Ref<EditorTranslationParserPlugin>> *)this,&local_28);
    }
    else {
      Vector<Ref<EditorTranslationParserPlugin>>::push_back
                ((Vector<Ref<EditorTranslationParserPlugin>> *)this);
...
/* EditorTranslationParserPlugin::is_class_ptr(void*) const */

uint __thiscall
EditorTranslationParserPlugin::is_class_ptr(EditorTranslationParserPlugin *this,void *param_1)
...
/* EditorTranslationParserPlugin::_getv(StringName const&, Variant&) const */

undefined8 EditorTranslationParserPlugin::_getv(StringName *param_1,Variant *param_2)
...
/* EditorTranslationParserPlugin::_setv(StringName const&, Variant const&) */

undefined8 EditorTranslationParserPlugin::_setv(StringName *param_1,Variant *param_2)
...
/* EditorTranslationParserPlugin::_validate_propertyv(PropertyInfo&) const */

void EditorTranslationParserPlugin::_validate_propertyv(PropertyInfo *param_1)
...
/* EditorTranslationParserPlugin::_property_can_revertv(StringName const&) const */

undefined8 EditorTranslationParserPlugin::_property_can_revertv(StringName *param_1)
...
/* EditorTranslationParserPlugin::_property_get_revertv(StringName const&, Variant&) const */

undefined8
EditorTranslationParserPlugin::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* EditorTranslationParserPlugin::_notificationv(int, bool) */

void EditorTranslationParserPlugin::_notificationv(int param_1,bool param_2)
...
{
  *(undefined ***)this = &PTR__initialize_classv_00109688;
...
void __thiscall
EditorTranslationParserPlugin::~EditorTranslationParserPlugin(EditorTranslationParserPlugin *this)

{
  bool bVar1;
  
  bVar1 = StringName::configured != '\0';
  *(undefined ***)this = &PTR__initialize_classv_001097e8;
  if (bVar1) {
...
/* CowData<Ref<EditorTranslationParserPlugin> >::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<Ref<EditorTranslationParserPlugin>>::_copy_on_write(void)
...
/* EditorTranslationParserPlugin::_bind_methods() [clone .cold] */
...
/* EditorTranslationParserPlugin::_get_class_namev() const */

undefined8 * EditorTranslationParserPlugin::_get_class_namev(void)
...
LAB_00105ab3:
  ...
  StringName::assign_static_unique_class_name
            ((StringName *)&_get_class_namev()::_class_name_static,"EditorTranslationParserPlugin");
LAB_00105b1e:
  return &_get_class_namev()::_class_name_static;
}
...
/* EditorTranslationParserPlugin::get_class() const */

void EditorTranslationParserPlugin::get_class(void)
...
/* EditorTranslationParserPlugin::is_class(String const&) const */

undefined8 __thiscall
EditorTranslationParserPlugin::is_class(EditorTranslationParserPlugin *this,String *param_1)
...
GetTypeInfo<TypedArray<Array>,void> * __thiscall
...
GetTypeInfo<TypedArray<Vector<String>>,void> * __thiscall
GetTypeInfo<TypedArray<Vector<String>>,void>::get_class_info
...
/* EditorTranslationParserPlugin::_initialize_classv() */

void EditorTranslationParserPlugin::_initialize_classv(void)

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialize_class()::initialized != '\0') goto LAB_00108bb9;
...
LAB_00108cda:
  ...
  String::parse_latin1((StrRange *)&local_58);
  StringName::StringName((StringName *)&local_50,(String *)&local_58,false);
  local_48 = "EditorTranslationParserPlugin";
  local_60 = 0;
  local_40 = 0x1d;
  String::parse_latin1((StrRange *)&local_60);
  StringName::StringName((StringName *)&local_48,(String *)&local_60,false);
...
LAB_00109126:
    ...
    lVar4 = puVar5[-1];
    if (param_1 <= lVar4) goto LAB_00108fa1;
  }
  else {
    if (lVar4 != 0) {
      uVar3 = _realloc(this,lVar9);
...
undefined8 __thiscall
CowData<Ref<EditorTranslationParserPlugin>>::_realloc
          (CowData<Ref<EditorTranslationParserPlugin>> *this,long param_1)
...
undefined8 __thiscall
CowData<Ref<EditorTranslationParserPlugin>>::resize<false>
          (CowData<Ref<EditorTranslationParserPlugin>> *this,long param_1)
...
LAB_0010930a:
      ...
      while (plVar1 = (long *)(lVar7 + uVar9 * 8), *plVar1 == 0) {
        uVar9 = uVar9 + 1;
        if (*(ulong *)(lVar7 + -8) <= uVar9) goto LAB_0010930a;
      }
      cVar4 = RefCounted::unreference();
      if (cVar4 != '\0') {
...
LAB_001092d0:
    ...
    lVar7 = puVar10[-1];
    if (param_1 <= lVar7) goto LAB_001093bb;
  }
  else {
    if (lVar7 != 0) {
      uVar5 = _realloc(this,lVar11);
...
void __thiscall
Vector<Ref<EditorTranslationParserPlugin>>::remove_at
          (Vector<Ref<EditorTranslationParserPlugin>> *this,long param_1)
...
LAB_00109520:
              param_1 = param_1 + 1;
              if (param_1 == lVar5) goto LAB_0010958e;
            }
            *(Object **)(lVar4 + param_1 * 8) = pOVar1;
            ...
            if (((pOVar2 == (Object *)0x0) || (cVar3 = RefCounted::unreference(), cVar3 == '\0')) ||
               (cVar3 = predelete_handler(pOVar2), cVar3 == '\0')) goto LAB_00109520;
            param_1 = param_1 + 1;
            (**(code **)(*(long *)pOVar2 + 0x140))(pOVar2);
            Memory::free_static(pOVar2,false);
          } while (param_1 != lVar5);
...
LAB_0010958e:
      CowData<Ref<EditorTranslationParserPlugin>>::resize<false>
                ((CowData<Ref<EditorTranslationParserPlugin>> *)(this + 8),lVar5);
      return;
    }
    goto LAB_001095b1;
  }

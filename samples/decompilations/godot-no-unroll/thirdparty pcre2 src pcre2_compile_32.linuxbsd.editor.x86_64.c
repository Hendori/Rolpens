...
undefined4
read_number(undefined8 *param_1,int *param_2,int param_3,uint param_4,undefined4 param_5,
...
LAB_00100062:
  ...
  uVar3 = 0;
  while ((piVar1 < param_2 && (iVar2 = *piVar1, iVar2 - 0x30U < 10))) {
    piVar1 = piVar1 + 1;
    uVar3 = iVar2 + -0x30 + uVar3 * 10;
    if (param_4 < uVar3) {
      *param_7 = param_5;
      uVar5 = 0;
LAB_001000b4:
...
undefined8
read_repeat_counts(ulong *param_1,int *param_2,int *param_3,int *param_4,int *param_5,int *param_6)
...
undefined8
read_name(undefined8 *param_1,uint *param_2,uint param_3,uint param_4,long *param_5,
...
LAB_00100753:
        while (*puVar4 < 0x100) {
          if (((*(byte *)(*(long *)(param_9 + 0x20) + (ulong)*puVar4) & 0x10) == 0) ||
             (puVar4 = puVar4 + 1, param_2 <= puVar4)) break;
        }
...
LAB_001006c9:
            if ((puVar4 < param_2) && (*puVar4 == param_4)) {
              puVar4 = puVar4 + 1;
LAB_001006df:
              *param_1 = puVar4;
              return 1;
        ...
        if ((param_3 & 1) == 0) {
          ...
          bVar1 = puVar3[1];
          if (bVar1 != 0xd) {
            while ((((bVar1 == 0xd || (*(int *)(&_pcre2_ucp_gentype_32 + (ulong)bVar1 * 4) == 1)) ||
                    (uVar6 == 0x5f)) && (puVar4 = puVar4 + 1, puVar4 < param_2))) {
              uVar6 = *puVar4;
              puVar3 = &_pcre2_dummy_ucd_record_32;
              if (uVar6 < 0x110000) {
                puVar3 = &_pcre2_ucd_records_32 +
...
LAB_00100baa:
        if ((((puVar2[1] != 0xd) || ((param_2 & *(uint *)(param_3 + 0xf4)) != 0)) || (0 < param_4))
           || (uVar4 = param_5 | *(uint *)(param_3 + 0x128), uVar4 != 0)) {
          return 0;
        }
...
LAB_00100b0c:
        uVar3 = is_anchored(puVar2,param_2,param_3,iVar1,uVar5);
        iVar1 = (int)uVar3;
      }
      else {
  ...
  do {
    ...
    if (iVar1 == 0x8b) {
      ...
      if (uVar5 == 0x76) {
        ...
        uVar5 = *puVar6;
joined_r0x00100e5b:
        if (0x96 < uVar5) goto LAB_00100de8;
LAB_00100d04:
        if (0x90 < uVar5) {
          return 0;
        }
...

{
  ...
  *param_2 = 0xfffffffe;
  ...
  uVar5 = 0;
LAB_00100ecd:
  puVar4 = (uint *)first_significant_code
                             ((ulong)((uint)(iVar2 - 0x8eU < 2 || iVar2 - 0x89U < 2) * 4 + 8) +
                              (long)param_1,1);
  uVar3 = *puVar4;
  if (0x38 < uVar3) {
    uVar3 = uVar3 - 0x7f;
    if (((0x10 < uVar3) || ((0x18fd1UL >> ((ulong)uVar3 & 0x3f) & 1) == 0)) ||
       (uVar3 = find_firstassertedcu(puVar4,&local_44,param_3 + (uint)((uVar3 & 0xfffffffb) == 0)),
       0xfffffffd < local_44)) goto switchD_00100f1d_caseD_1f;
    uVar1 = local_44;
    if (uVar6 != 0xfffffffe) {
...
switchD_00100f1d_caseD_1e:
  ...
  puVar4 = puVar4 + 1;
switchD_00100f1d_caseD_1d:
  if (param_3 == 0) {
switchD_00100f1d_caseD_1f:
    uVar3 = 0;
    goto LAB_00100f62;
  }
  uVar3 = puVar4[1];
...
LAB_0010156c:
  ...
  iVar10 = 0;
LAB_0010130d:
  if (-1 < (int)uVar4) goto LAB_001012e0;
...
LAB_001017c4:
    ...
    if (uVar9 == 0x80240000) {
LAB_00101a1c:
      iVar16 = check_lookbehinds(local_68 + 1,&local_68,param_5,param_6,param_4);
      *param_3 = iVar16;
    ...
    if (uVar9 < 0x80240001) {
      ...
      if (uVar9 < 0x801b0001) {
        if (uVar9 == 0x80180000) {
          ...
          uVar12 = 2;
LAB_001012ed:
          if (iVar10 < 0x10000) goto LAB_001012f9;
          goto LAB_001017e8;
        }
        if (uVar9 < 0x80180001) {
...
LAB_00101378:
          ...
          if (*(short *)(param_6 + 0xb0) != 0) {
            iVar16 = 0;
            while ((*(ushort *)((long)puVar11 + 0xc) != uVar4 ||
                   (iVar3 = _pcre2_strncmp_32(lVar1 + lVar5 * 4,*puVar11,uVar4), iVar3 != 0))) {
              iVar16 = iVar16 + 1;
              puVar11 = puVar11 + 2;
            ...
            if (uVar4 != 0) {
              if ((uVar9 == 0x80210000) ||
                 ((*(short *)((long)puVar11 + 0xe) == 0 && ((*(byte *)(param_6 + 0xca) & 0x20) == 0)
                  ))) {
...
LAB_001018ec:
        iVar16 = set_lookbehind_lengths(&local_68,param_3,param_4,param_5,param_6);
...
LAB_001017d1:
  if (((int)uVar13 < (int)uVar4) || (iVar10 = iVar10 + (int)uVar12, 0xffff < iVar10))
  goto LAB_001017e8;
LAB_001012f9:
  uVar4 = local_68[1];
LAB_00101301:
...
LAB_001021b2:
          ...
          if (uVar4 < 0x803e0001) {
            ...
            if ((uVar4 < 0x803d0001) &&
               (((uVar5 & 0xfffe0000) == 0x803a0000 || (uVar4 == 0x803c0000)))) goto LAB_00101ee8;
          }
...
LAB_00102138:
            ...
            if (uVar4 < 0x80280001) {
              ...
              if ((0x8028ffff < uVar4) &&
                 (((uVar5 & 0xfffe0000) == 0x802a0000 || (uVar4 == 0x802c0000)))) goto LAB_00101ee8;
            }
          }
          goto LAB_00101f80;
        }
      ...
      if (uVar4 != 0x80060000) {
        if (uVar4 < 0x80060001) {
          ...
          if (0x8006ffff < uVar4) {
            ...
            if ((0x8007ffff < uVar4) &&
               ((uVar4 == 0x800a0000 || ((uVar5 & 0xfffd0000) == 0x80090000)))) goto LAB_00101ee8;
          }
        }
        goto LAB_00101f80;
      }
...

{
  ...
  if ((param_3 & 8) == 0) {
LAB_00102706:
    if (*(uint *)(param_5 + 0x100) < (uint)uVar9) {
LAB_00102804:
...
LAB_0010259d:
      do {
        if ((param_7 < param_6) || (uVar7 = param_6, 0x10ffff < param_6)) goto LAB_00102706;
        while( true ) {
          bVar3 = (&DAT_0011002b)
                  [(ulong)*(ushort *)
                           (&_pcre2_ucd_stage2_32 +
                           (long)(int)((uint)*(ushort *)
                                              (&_pcre2_ucd_stage1_32 + (long)((int)uVar7 >> 7) * 2)
                                       * 0x80 + (uVar7 & 0x7f)) * 2) * 0xc];
          if ((bVar3 != 0) &&
             (((param_4 & 0x80) == 0 ||
              (0x7f < *(uint *)(&_pcre2_ucd_caseless_sets_32 + (ulong)bVar3 * 4))))) {
            ...
            if (uVar16 != 0xffffffff) {
              do {
                if (uVar7 == uVar16) {
                  ...
                  iVar6 = add_to_class_internal
                                    (param_1,param_2,local_5c,param_4,param_5,uVar16,puVar12[uVar10]
                                    );
                  uVar16 = *puVar2;
                  iVar5 = iVar5 + iVar6;
                  puVar12 = puVar2;
          ...
          uVar16 = *(int *)(&DAT_0011002c +
                           (ulong)*(ushort *)
                                   (&_pcre2_ucd_stage2_32 +
                                   (long)(int)((uint)*(ushort *)
                                                      (&_pcre2_ucd_stage1_32 +
                                                      (long)((int)uVar7 >> 7) * 2) * 0x80 +
                                              (uVar7 & 0x7f)) * 2) * 0xc) + uVar7;
          ...
          if (param_6 < 0x110000) {
            puVar8 = &_pcre2_ucd_records_32 +
                     (ulong)*(ushort *)
                             ...
                             (long)(int)((uint)*(ushort *)
                                                (&_pcre2_ucd_stage1_32 +
                                                (long)((int)param_6 >> 7) * 2) * 0x80 +
                                        (param_6 & 0x7f)) * 2) * 0xc;
          }
          if ((puVar8[3] != '\0') ||
             (uVar13 = uVar7 + 1, *(int *)(puVar8 + 4) + param_6 != uVar7 + 1)) break;
        }
...
LAB_00102c00:
      ...
      if (__pcre2_utt_size_32 != 0) {
        do {
          ...
          iVar5 = _pcre2_strcmp_c8_32(local_108,
                                      &_pcre2_utt_names_32 + *(ushort *)(&_pcre2_utt_32 + lVar1));
          if (iVar5 == 0) {
            *param_4 = *(undefined2 *)(&DAT_00110064 + lVar1);
            sVar2 = *(short *)(&DAT_00110062 + lVar1);
            sVar4 = sVar2;
            if ((((local_138 == (uint *)0x0) || ((short)local_130 == 0xff)) || (sVar2 == 4)) ||
               (sVar4 = (short)local_130, sVar2 == 5)) {
              *param_3 = sVar4;
              uVar8 = 1;
              goto LAB_00102c83;
            }
...
LAB_00102da0:
  ...
  if (uVar9 == 0x7d) {
    ...
    *local_138 = 0;
    ...
    if ((iVar5 == 0) || (iVar5 = _pcre2_strcmp_c8_32(local_108,&_LC3), iVar5 == 0)) {
      local_128 = __LC2;
    ...
    if ((iVar5 == 0) || (iVar5 = _pcre2_strcmp_c8_32(local_108,&_LC5), iVar5 == 0)) {
      local_130._0_2_ = 4;
    }
    else {
      iVar5 = _pcre2_strcmp_c8_32(local_108,"scriptextensions");
      if ((iVar5 != 0) && (iVar5 = _pcre2_strcmp_c8_32(local_108,&_LC7), iVar5 != 0))
      goto LAB_00102d40;
      local_130._0_2_ = 5;
    }
...
LAB_00102de2:
  ...
  *local_130 = uVar11;
  if ((local_140 == 0x31) || (local_130 = local_130 + 1, param_7 <= puVar12)) goto LAB_00102c78;
  goto LAB_00102cd7;
}
...
LAB_00103050:
      param_1 = param_1 + (byte)(&_pcre2_OP_lengths_32)[uVar1];
    }
    uVar1 = *param_1;
  } while( true );
}
...

{
  ...
  if ((pcVar6 == (code *)0x0) ||
     (iVar15 = (*pcVar6)(*(undefined2 *)((long)param_13 + 0xb4),*(undefined8 *)(*param_13 + 0x20)),
     local_278 = auVar48, iVar15 == 0)) {
    local_f8 = (ulong)(param_6 + 4);
    uVar20 = *puVar5;
    bVar8 = uVar20 - 0x81 < 2 || uVar20 == 0x84;
    if (bVar8) {
      local_170 = *puVar38;
      uVar45 = (ulong)(ushort)puVar38[-1];
      puVar38 = puVar38 + 2;
    }
    else if (uVar20 == 0x89) {
      uVar45 = 0;
...
LAB_0010378a:
      ...
      uVar39 = _LC8;
      uVar35 = *puVar38;
      uVar31 = uVar35 & 0xffff0000;
      local_f0 = puVar38;
      if (param_14 == (long *)0x0) {
        local_208 = puVar40;
        if (0xb0000 < uVar31 + 0x7fcc0000) goto LAB_00103595;
LAB_001037e1:
        if (uVar31 == 0x803a0000) {
LAB_00104ef8:
          uVar35 = 1;
          uVar18 = 2;
          goto LAB_00103830;
        }
        if (uVar31 < 0x803a0001) {
          if (uVar31 != 0x80370000) {
            if (uVar31 < 0x80370001) {
              if (((uVar35 & 0xfffe0000) == 0x80340000) || (uVar31 == 0x80360000)) {
                uVar35 = 0x10000;
                uVar18 = 2;
                goto LAB_00103830;
              }
            }
            else if ((uVar35 & 0xfffe0000) == 0x80380000) goto LAB_0010459a;
            goto LAB_00103ec8;
          }
LAB_0010459a:
          uVar18 = 2;
          uVar35 = 0x10000;
          uVar45 = 1;
          if (uVar19 != 0) goto LAB_0010444a;
LAB_00103859:
          if (uVar31 == 0x803b0000) goto LAB_00104460;
LAB_00103866:
          if (uVar31 < 0x803b0001) {
            if (uVar31 == 0x80380000) goto LAB_00104460;
            if (uVar31 < 0x80380001) {
              if (uVar31 == 0x80350000) goto LAB_00104460;
              if (uVar31 == 0x80360000) goto LAB_00104abd;
            }
            else if (uVar31 == 0x80390000) {
LAB_00104abd:
              bVar47 = false;
              uVar32 = local_1c4;
              goto LAB_001038b0;
            ...
            if (uVar31 == 0x803e0000) goto LAB_00104460;
            if (uVar31 == 0x803f0000) goto LAB_00104abd;
            bVar47 = false;
            uVar32 = local_1c4;
            if (uVar31 != 0x803c0000) {
              uVar32 = local_190;
            }
          }
        }
        else {
          if (uVar31 != 0x803d0000) {
            if (uVar31 < 0x803d0001) {
              if ((uVar31 + 0x7fc50000 & 0xfffe0000) != 0) goto LAB_00103ec8;
              goto LAB_00104ef8;
            }
joined_r0x00105c00:
            if ((uVar35 & 0xfffe0000) != 0x803e0000) goto LAB_00103ec8;
          }
          uVar32 = puVar38[1];
          uVar45 = (ulong)uVar32;
          uVar35 = puVar38[2];
          local_f0 = puVar38 + 2;
          uVar18 = (uint)(uVar32 != uVar35) * 2;
          if (uVar32 == 0) {
LAB_00103830:
            uVar19 = 0;
            uVar45 = 0;
...
LAB_0010444a:
          uVar19 = 1;
          if (uVar31 != 0x803b0000) goto LAB_00103866;
LAB_00104460:
          bVar47 = true;
          uVar32 = 0;
        }
LAB_001038b0:
        ...
        local_e0 = puVar24;
        if (uVar31 < 0x21) {
          if (uVar31 < 0x1d) goto switchD_001038df_caseD_76;
          if ((uVar35 == 1) && (uVar21 == 1)) goto switchD_001038df_caseD_a3;
          iVar30 = *(int *)(chartypeoffset + (ulong)(uVar31 - 0x1d) * 4);
          local_a8[0] = puVar40[-1];
          if ((uVar31 < 0x1f) &&
             ((1 < uVar21 &&
              (local_224 = *(uint *)(param_13 + 0x23), local_21c = local_a8[0], uVar31 == 0x1e)))) {
            uVar34 = 0xffffffff;
            uVar37 = 0xffffffff;
            bVar12 = true;
...
LAB_00103969:
            ...
            *puVar24 = iVar30 + 0x29;
            puVar40 = puVar24 + 2;
            if (uVar21 == uVar35) goto LAB_00103957;
            if (!bVar12) {
              puVar24[2] = uVar31;
              if ((int)uVar37 < 0) {
                if (uVar35 == 0x10000) {
                  puVar41 = puVar24 + 5;
                  *(ulong *)(puVar24 + 3) = CONCAT44(uVar31,iVar43 + 0x21);
                  goto LAB_00103980;
                }
                goto LAB_00106c40;
              }
              ...
              puVar38 = puVar24 + 5;
              puVar24[4] = uVar34;
              if (uVar35 != 0x10000) goto LAB_00105f77;
              puVar40 = puVar24 + 6;
              *(ulong *)(puVar24 + 5) = CONCAT44(uVar31,iVar43 + 0x21);
              goto LAB_00103969;
            }
...
LAB_0010398c:
            ...
            if (uVar35 < 0x70) {
              if (uVar35 < 0x6e) {
                if (uVar35 < 0x51) {
                  if ((0x1c < uVar35) &&
                     ((0x800400200100fU >> ((ulong)(uVar35 - 0x1d) & 0x3f) & 1) != 0)) {
...
LAB_001039e8:
            puVar38 = local_e0;
            iVar30 = (int)((long)puVar41 - (long)local_e0 >> 2);
            if (0 < iVar30) {
              if ((*local_e0 < 0x76) && (opcode_possessify[*local_e0] != 0)) {
                *local_e0 = (uint)(byte)opcode_possessify[*local_e0];
                ...
                uVar35 = iVar30 + 2;
                _pcre2_memmove32(local_e0 + 2,local_e0,(long)(int)((long)puVar41 - (long)local_e0));
                *puVar38 = 0x85;
                puVar41[2] = 0x79;
                puVar41[3] = uVar35;
                puVar38[1] = uVar35;
          ...
          case 0x74:
            puVar41 = puVar24;
            if (uVar35 != 0) {
              if ((uVar35 != 1) || (puVar41 = puVar40, uVar21 != 1)) {
          ...
          case 0x75:
            if ((uVar35 == 1) && (uVar21 == 1)) {
              if (!bVar47) break;
              uVar45 = 0;
              if (param_14 != (long *)0x0) goto LAB_00103d02;
              goto LAB_001039e8;
            }
            if (uVar21 != 0) {
              if ((uVar21 == 1) && (uVar35 == 0x10000)) {
                ...
                if (uVar21 == uVar35) {
                  uVar45 = (ulong)(uVar21 - 1);
                  if (param_14 != (long *)0x0) goto LAB_00103d02;
                  if (0 < (int)(uVar21 - 1)) goto LAB_00106a39;
LAB_00103d86:
                  puVar40 = puVar41;
                  if (uVar21 == uVar35) goto LAB_00103980;
                }
                else {
                  if (param_14 != (long *)0x0) {
LAB_00103d02:
                    iVar30 = _pcre2_ckd_smul(&local_d0,uVar45,2);
                    if (iVar30 == 0) {
...
LAB_00106a39:
                    ...
                    puVar38 = puVar40;
                    do {
                      *(undefined8 *)puVar38 = uVar39;
                      puVar38 = puVar38 + 2;
                    } while (puVar38 != puVar40 + (long)(int)uVar45 * 2);
                    local_208 = puVar40 + uVar45 * 2 + -2;
                    puVar41 = puVar40 + uVar45 * 2;
                    goto LAB_00103d86;
                  }
                }
                puVar38 = local_208;
            ...
            _pcre2_memmove32(puVar38 + 2,puVar38,8);
            local_e8 = 6;
            iVar15 = -1;
            *(undefined8 *)puVar38 = _LC11;
            puVar40 = puVar40 + 4;
            *(undefined8 *)(puVar38 + 4) = _LC12;
            local_1e0 = (long)puVar40 - (long)puVar38;
            local_1c0 = (int)(local_1e0 >> 2);
            puVar41 = puVar40;
            if ((int)uVar45 == 0) goto LAB_00103a9d;
LAB_00105ced:
            local_208 = puVar38;
            if ((int)uVar45 != 1) goto LAB_00105cf7;
LAB_00105d87:
            uVar31 = (uint)uVar45;
            puVar38 = (uint *)0x0;
            if (uVar35 != 0x10000) goto LAB_00106757;
            goto LAB_00105d96;
          case 0x76:
          case 0x77:
          case 0x78:
...
switchD_001038df_caseD_76:
            if (0x16 < uVar31) goto switchD_001038df_default;
            if ((uVar35 != 1) || (uVar21 != 1)) {
              if (uVar31 - 0xf < 2) {
                uVar37 = puVar24[1];
                uVar34 = puVar24[2];
...
LAB_0010391d:
          ...
          case 0x89:
          case 0x8b:
            local_1e0 = (long)puVar40 - (long)puVar24;
            local_1c0 = (int)(local_1e0 >> 2);
            if ((uVar35 == 1) && (uVar21 == 1)) {
              if (!bVar47) break;
              if (uVar31 == 0x8b) {
...
LAB_00106757:
              local_158 = (uint *)0x0;
              uVar31 = (uint)uVar45;
              iVar30 = uVar35 - uVar31;
              puVar38 = (uint *)0x0;
            }
            else {
              if (uVar31 != 0x8b) {
                if (0x84 < uVar31) goto LAB_00103a94;
                if (uVar35 == 0x10000) {
                  uVar35 = uVar21 + 1;
                  goto LAB_00103a94;
                }
                if (uVar21 == 0) goto LAB_00103a9d;
                if (uVar21 == 1) goto LAB_00106757;
LAB_00105cf7:
                iVar30 = (int)uVar45;
                if (param_14 == (long *)0x0) {
                  ...
                  do {
                    iVar43 = iVar43 + 1;
                    pvVar26 = memcpy(puVar38,local_208,(long)(int)local_1e0);
                    puVar38 = (uint *)((long)pvVar26 + (long)local_1c0 * 4);
                  } while (iVar43 != iVar30);
                  puVar41 = (uint *)((long)puVar41 + (ulong)(iVar30 - 1) * (long)local_1c0 * 4);
                  goto LAB_00105d87;
                }
                iVar30 = _pcre2_ckd_smul(&local_d0,iVar30 + -1,local_e8 & 0xffffffff);
                if (iVar30 != 0) goto LAB_00104f40;
                if (0x7fffffeb - *puVar22 < CONCAT44(uStack_cc,local_d0)) goto LAB_00104f40;
                *puVar22 = *puVar22 + CONCAT44(uStack_cc,local_d0);
                goto LAB_00105d87;
              }
              if ((puVar24[2] == 0x95) && (puVar24[puVar24[1]] != 0x78)) break;
LAB_00103a94:
              if (uVar21 != 0) goto LAB_00105ced;
LAB_00103a9d:
              if ((uVar35 < 2) || (uVar35 == 0x10000)) {
                local_208 = puVar38 + 1;
                _pcre2_memmove32(local_208,puVar38,(long)(int)local_1e0);
                puVar41 = puVar40 + 1;
                if (uVar35 == 0) {
                  *puVar38 = 0xa7;
                  break;
...
LAB_00105d96:
              uVar35 = puVar41[-1];
              puVar40 = puVar41 + (-2 - (ulong)uVar35);
              uVar21 = *puVar40;
              if (uVar21 == 0x85) {
                if (!bVar47) {
LAB_00105ddb:
                  puVar41[-2] = uVar32 + 0x7a;
                  break;
                }
                *puVar40 = 0x87;
                uVar32 = 0x88;
...
LAB_001070c7:
                ...
                *puVar40 = uVar32;
                ...
                if (param_14 == (long *)0x0) {
                  ...
                  if (uVar21 != 0x8b) goto LAB_00105dcf;
                  if (puVar40[puVar40[1]] != 0x78) {
                    *puVar40 = 0x90;
                  }
                  if (!bVar47) goto LAB_00105ddb;
                }
                else {
LAB_00105dcf:
                  if (!bVar47) goto LAB_00105ddb;
                  uVar32 = *puVar40;
                  if ((uVar32 != 0x8b) && (uVar32 != 0x90)) goto LAB_001070c7;
                }
                lVar36 = -((ulong)uVar35 * -4 + -8);
                _pcre2_memmove32(puVar40 + 2,puVar40,(long)(int)lVar36);
                local_248 = (int)(lVar36 >> 2);
                puVar42 = puVar41 + 4;
                *puVar40 = (uint)(*puVar40 != 0x8b) * 5 + 0x88;
                puVar41[2] = 0x7c;
                puVar41[3] = local_248 + 2U;
                puVar40[1] = local_248 + 2U;
              }
              if (puVar38 != (uint *)0x0) {
                *puVar38 = 0x99;
              }
            ...
            if (iVar30 != 0) {
              if (param_14 != (long *)0x0) {
                iVar30 = _pcre2_ckd_smul(&local_d0,iVar30,(int)local_e8 + 5);
                if ((iVar30 != 0) || (0x7fffffef - local_f8 < CONCAT44(uStack_cc,local_d0)))
                goto LAB_00104f40;
                ...
                *puVar41 = uVar32 + 0x97;
                if (iVar30 != 1) {
                  ...
                  lVar36 = 0;
                  puVar41[1] = 0x87;
                  if (local_158 != (uint *)0x0) goto LAB_00103c40;
                  while( true ) {
                    local_158 = puVar38;
                    puVar41[2] = (uint)lVar36;
                    memcpy(puVar41 + 3,local_208,(long)(int)local_1e0);
                    puVar41 = puVar41 + (long)local_1c0 + 3;
                    iVar30 = iVar30 + -1;
                    *puVar41 = uVar32 + 0x97;
                    if (iVar30 == 1) break;
                    puVar41[1] = 0x87;
                    puVar38 = puVar41 + 2;
LAB_00103c40:
                    lVar36 = (long)puVar38 - (long)local_158 >> 2;
                  }
                }
                pvVar26 = memcpy(puVar41 + 1,local_208,(long)(int)local_1e0);
                puVar41 = (uint *)((long)pvVar26 + (long)local_1c0 * 4);
              }
            }
            if (local_158 != (uint *)0x0) {
              uVar31 = (int)((long)puVar41 - (long)local_158 >> 2) + 1;
              puVar38 = puVar41 + -(long)(int)uVar31;
              uVar35 = puVar38[1];
              puVar40 = puVar41;
              while (puVar41 = puVar40 + 2, uVar35 != 0) {
                puVar41[-1] = uVar31;
                puVar41[-2] = 0x79;
...
switchD_001038df_caseD_a3:
        *(uint *)(param_13 + 0x23) = *(uint *)(param_13 + 0x23) | uVar18;
        puVar38 = local_f0;
        puVar40 = puVar41;
        uVar32 = local_224;
LAB_0010377e:
      ...
      if ((uint *)(param_13[5] + -400 + param_13[10] * 4) < puVar40) {
        uVar16 = 0;
        *param_5 = (-(uint)(puVar40 < (uint *)(param_13[5] + param_13[10] * 4)) & 0x22) + 0x98;
        goto LAB_001064e0;
      }
      if (puVar40 < (ulong)local_278._0_8_) {
        puVar40 = (uint *)local_278._0_8_;
      }
      if (uVar31 + 0x7fcc0000 < 0xb0001) {
        local_278._0_8_ = puVar40;
        goto LAB_001037e1;
      }
      uVar45 = (long)puVar40 - (long)local_250 >> 2;
      if ((0x7fffffeb - *puVar22 < uVar45) ||
         (uVar45 = *puVar22 + uVar45, *puVar22 = uVar45, 0x40000000 < uVar45)) goto LAB_00104f40;
      local_278._0_8_ = local_250;
      local_208 = local_250;
LAB_00103595:
      uVar18 = (local_228 ^ 1) & uVar19;
      if (uVar18 == 0) {
        uVar18 = local_25c;
      }
      puVar40 = local_208;
      ...
      uVar45 = (ulong)uVar35 & 0xffff;
      uVar21 = (uint)uVar45;
      if (0x801b0000 < uVar31) {
        if (uVar31 == 0x802a0000) {
          *(undefined4 *)((long)param_13 + 0x124) = 1;
          uVar2 = *(ushort *)((long)param_13 + 0xb6);
          ppppppplVar25 = local_218;
          while (puVar24 = puVar40, ppppppplVar25 != (long *******)0x0) {
            while( true ) {
              if (*(ushort *)((long)ppppppplVar25 + 10) < uVar2) goto LAB_001059d0;
              ...
              *puVar24 = 0xa6;
              ...
              puVar24 = puVar40;
              if (ppppppplVar25 == (long *******)0x0) goto LAB_00104dec;
            }
            ppppppplVar25 = (long *******)*ppppppplVar25;
            *puVar22 = *puVar22 + 5;
            puVar40 = puVar24;
...
LAB_001059d0:
          ...
          *puVar24 = uVar19;
          ...
          if (uVar31 < 0x802a0001) {
            if (uVar31 == 0x80250000) {
            ...
            else if (uVar31 < 0x80250001) {
              if (uVar31 == 0x80220000) {
                uVar35 = 0x86;
                uVar39 = 0;
                bVar47 = true;
                uVar31 = 0x86;
                ...
                if (uVar31 < 0x80220001) {
                  if (uVar31 != 0x80200000) {
                    if (uVar31 == 0x80210000) goto LAB_001052c4;
                    goto LAB_00103ec8;
                  }
                  puVar40 = puVar38 + 2;
                  local_1f0 = CONCAT44(puVar38[1],puVar38[2]);
                  if (uVar21 <= *(uint *)((long)param_13 + 0xcc)) {
LAB_0010507c:
                    *local_208 = 0x75;
                    local_208[1] = (uint)uVar45;
                ...
                if (uVar31 == 0x80230000) {
                  *(short *)((long)param_13 + 0xb6) = *(short *)((long)param_13 + 0xb6) + 1;
                  ...
                  if (uVar31 != 0x80240000) goto LAB_00103ec8;
                  if ((puVar38[1] == 0x80190000) && (0xb0000 < puVar38[2] + 0x7fcc0000)) {
                    *local_208 = 0xa3;
                    puVar38 = puVar38 + 1;
                    uVar19 = 0;
                    puVar40 = local_208 + 1;
              ...
              if (uVar31 != 0x80270000) {
                if (uVar31 < 0x80270001) {
                  if (uVar31 == 0x80260000) {
                    *(short *)((long)param_13 + 0xb6) = *(short *)((long)param_13 + 0xb6) + 1;
                    uVar35 = 0x82;
                    uVar39 = 0;
                    bVar47 = false;
                  ...
                  if (uVar31 == 0x80290000) goto LAB_00104139;
                }
                goto LAB_00103ec8;
              }
              *(short *)((long)param_13 + 0xb6) = *(short *)((long)param_13 + 0xb6) + 1;
...
LAB_00103630:
            ...
            *local_208 = uVar35;
            ...
            local_e8 = 0;
            local_e0 = local_208;
            iVar15 = compile_regex(local_240,local_220,&local_e0,&local_f0,param_5,uVar39,&local_100
                                   ,&local_d0,&local_104,&local_fc,local_b8,local_218,param_13,
                                   puVar23);
            if (iVar15 == 0) goto LAB_00103ccd;
            *(short *)((long)param_13 + 0xb4) = *(short *)((long)param_13 + 0xb4) + -1;
            uVar35 = uVar35 - 0x7f;
            puVar38 = local_f0;
            puVar40 = local_e0;
            if ((uVar31 == 0x8b) || (!bVar47)) {
              if (uVar35 < 6) {
                uVar19 = 0;
                goto LAB_00103721;
              }
              if ((uVar31 == 0x8b) && (param_14 == (long *)0x0)) {
                iVar30 = 0;
                puVar24 = local_208;
                do {
                  iVar30 = iVar30 + 1;
              ...
              uVar19 = 0;
              if (param_14 == (long *)0x0) goto LAB_00103fde;
            }
            else {
              uVar19 = (uint)(0 < iVar15);
              if (uVar35 < 6) {
LAB_00103721:
              ...
              if (param_14 == (long *)0x0) {
                if (uVar31 < 0x85) {
                  if ((((uVar35 & 0xfffffffb) == 0) && (local_fc < 0xfffffffe)) &&
                     (local_d0 < 0xfffffffe)) {
                    bVar46 = false;
                    local_20c = local_23c;
                    local_200 = local_210;
...
joined_r0x001062ca:
                  ...
                  if (0xfffffffd < local_d0) {
                    bVar46 = false;
                    local_20c = local_23c;
                    goto joined_r0x001062ca;
                  }
                  if (0xfffffffd < local_fc) {
                    bVar46 = false;
                    local_104 = local_100;
                    uVar32 = uVar18 | local_d0;
                    local_20c = local_23c;
                    goto joined_r0x001062ca;
                  }
                  local_20c = local_23c;
            ...
            uVar39 = _LC10;
            uVar45 = *puVar22;
            if (local_e8 - 4 <= 0x7fffffeb - uVar45) {
              local_208[3] = 2;
              *puVar22 = uVar45 + (local_e8 - 4);
              *(undefined8 *)(local_208 + 1) = uVar39;
              puVar38 = local_f0;
              puVar40 = local_208 + 4;
              goto LAB_0010377e;
            }
          ...
          if (uVar31 != 0x80330000) {
            if (uVar31 < 0x80330001) {
              if (uVar31 == 0x802f0000) {
LAB_0010412d:
                *(undefined4 *)(param_13 + 0x25) = 1;
                goto LAB_00104139;
              }
              if (uVar31 < 0x802f0001) {
                if (uVar31 == 0x802d0000) goto LAB_00104139;
                if (uVar31 < 0x802d0001) {
                  if ((uVar31 + 0x7fd50000 & 0xfffe0000) == 0) {
LAB_001043c9:
                    uVar19 = 0;
                    *local_208 = *(uint *)(verbops + (ulong)(uVar31 + 0x7fd70000 >> 0x10) * 4);
                    puVar40 = local_208 + 1;
                    goto LAB_0010377e;
                  }
                }
                else if (uVar31 == 0x802e0000) {
LAB_001043bd:
                  *(undefined4 *)(param_13 + 0x25) = 1;
                  goto LAB_001043c9;
                }
                ...
                if (uVar31 < 0x80320001) {
                  if (uVar31 == 0x80300000) goto LAB_001043bd;
                  if (uVar31 == 0x80310000) goto LAB_0010412d;
                }
              }
            }
            else {
              puVar24 = local_208;
              if (0x803a0000 < uVar31) goto joined_r0x00105c00;
            }
            goto LAB_00103ec8;
          }
          *(uint *)(param_13 + 0x19) = *(uint *)(param_13 + 0x19) | 0x1000;
LAB_00104139:
          local_e0 = local_208 + 1;
          *local_208 = *(uint *)(verbops + (ulong)(uVar31 + 0x7fd70000 >> 0x10) * 4);
          uVar19 = puVar38[1];
          puVar40 = local_208 + 2;
          if ((int)uVar19 < 1) {
            ...
            uVar35 = 0;
            do {
              while (uVar31 = *puVar24, local_f0 = puVar24, uVar17 != 0) {
                uVar31 = _pcre2_ord2utf_32(uVar31,local_a8);
                uVar45 = (ulong)uVar31;
                if (param_14 != (long *)0x0) goto LAB_001041e8;
LAB_0010421d:
                puVar24 = puVar24 + 1;
                memcpy(puVar40,local_a8,(ulong)(uint)((int)uVar45 * 4));
                uVar35 = uVar35 + (int)uVar45;
                puVar40 = puVar40 + uVar45;
                if (puVar38 + (ulong)(uVar19 - 1) + 3 == puVar24) goto LAB_00104268;
              }
              uVar45 = 1;
              local_a8[0] = uVar31;
              if (param_14 == (long *)0x0) goto LAB_0010421d;
LAB_001041e8:
              puVar24 = puVar24 + 1;
              *puVar22 = *puVar22 + uVar45;
            } while (puVar38 + (ulong)(uVar19 - 1) + 3 != puVar24);
LAB_00104268:
            puVar38 = puVar38 + 1 + uVar19;
          }
          local_208[1] = uVar35;
          uVar19 = 0;
          *puVar40 = 0;
...
LAB_00105817:
                    bVar13 = (bool)(bVar13 | bVar47);
                  }
LAB_00105822:
                  iVar43 = uVar19 * 3;
                  uVar45 = *(ulong *)(pbVar7 + (int)(&posix_class_maps)[iVar43]);
                  uVar28 = *(ulong *)((long)(pbVar7 + (int)(&posix_class_maps)[iVar43]) + 8);
                  local_58 = *(ulong *)(pbVar7 + (long)(int)(&posix_class_maps)[iVar43] + 0x10);
                  uStack_50 = *(ulong *)((long)(pbVar7 + (long)(int)(&posix_class_maps)[iVar43] +
                                                         0x10) + 8);
                  iVar30 = (&posix_class_maps)[iVar43 + 1];
                  local_68 = (byte)uVar45;
                  bStack_67 = (byte)(uVar45 >> 8);
                  uStack_66 = (undefined6)(uVar45 >> 0x10);
                  uStack_60 = (uint)uVar28;
                  uStack_5c = (undefined4)(uVar28 >> 0x20);
                  iVar43 = (&posix_class_maps)[iVar43 + 2];
                  if (-1 < iVar30) {
                    if (iVar43 < 0) goto LAB_001067e1;
                    puVar23 = (ulong *)(pbVar7 + iVar30);
                    uVar45 = *puVar23 | uVar45;
                    local_68 = (byte)uVar45;
                    bStack_67 = (byte)(uVar45 >> 8);
                    uStack_66 = (undefined6)(uVar45 >> 0x10);
                  ...
                  if ((local_240 & 0x20000) != 0) {
                    uVar19 = 0;
                    if ((local_220 & 0x800) == 0) goto LAB_00105817;
                    goto LAB_00105822;
                  }
                  uVar39 = *(undefined8 *)(pbVar7 + 0xa0);
                  iVar43 = -2;
                  iVar30 = 0x40;
                  local_58 = *(ulong *)(pbVar7 + 0xb0);
                  uStack_50 = *(ulong *)(pbVar7 + 0xb8);
                  local_68 = (byte)uVar39;
                  bStack_67 = (byte)((ulong)uVar39 >> 8);
                  uStack_66 = (undefined6)((ulong)uVar39 >> 0x10);
                  uStack_60 = (uint)*(undefined8 *)(pbVar7 + 0xa8);
                  uStack_5c = (undefined4)((ulong)*(undefined8 *)(pbVar7 + 0xa8) >> 0x20);
LAB_001067e1:
                  puVar23 = (ulong *)(pbVar7 + iVar30);
                  uVar45 = ~*puVar23 & CONCAT62(uStack_66,CONCAT11(bStack_67,local_68));
...
LAB_00105708:
                ...
                if ((uVar19 & 0xfffeffff) == 0x801e0000) {
                  ...
                  *(uint *)((long)param_13 + 0x104) = uVar19;
                  local_f0 = puVar41;
                  iVar43 = add_to_class_internal
                                     (local_88,&local_d8,local_240,local_220,param_13,uVar20,uVar19)
                  ;
                  ...
                  iVar43 = add_to_class_internal
                                     (local_88,&local_d8,local_240,local_220,param_13,uVar20,uVar20)
                  ;
                  iVar30 = iVar30 + iVar43;
                }
                goto LAB_001048e0;
              }
              if (-1 < (int)uVar20) goto LAB_00105708;
              if ((uVar20 & 0xffff0000) != 0x80180000) goto LAB_00103ec8;
              ...
              case 8:
                ...
                do {
                  bVar1 = *pbVar29;
                  pbVar29 = pbVar29 + 1;
                  *pbVar33 = *pbVar33 | ~bVar1;
                  pbVar33 = pbVar33 + 1;
                } while (&local_68 != pbVar33);
                goto LAB_001072a6;
              case 9:
                pbVar33 = local_88;
                pbVar29 = pbVar7;
                do {
                  *pbVar33 = *pbVar33 | *pbVar29;
                  pbVar33 = pbVar33 + 1;
                  pbVar29 = pbVar29 + 1;
                } while (&local_68 != pbVar33);
                break;
...
LAB_001048e0:
              if (puVar24 < local_d8) {
                if (param_14 != (long *)0x0) {
                  lVar36 = (long)local_d8 - (long)puVar24;
                  local_d8 = puVar24;
                  *puVar22 = *puVar22 + (lVar36 >> 2);
                }
                local_200 = 1;
              }
              uVar20 = puVar41[1];
            ...
            if (local_200 != 0) {
              if ((local_240 & 0x20000) == 0) {
                ...
                if ((bVar13) || ((uVar31 != 0x800e0000 && (bVar47 != false)))) goto LAB_001049a2;
              }
              else if (bVar13) {
LAB_001049a2:
                *local_d8 = 2;
              ...
              *local_d8 = 0;
              *local_208 = 0x70;
              uVar19 = (uint)(uVar31 == 0x800e0000);
              local_d8 = puVar40;
              if (bVar12) {
                local_208[2] = uVar19 | 4;
                if (0 < iVar30) {
                  local_208[2] = local_208[2] | 2;
                  _pcre2_memmove32(local_208 + 0xb,puVar24,(long)puVar40 - (long)puVar24);
                  goto LAB_001074b4;
                }
              }
              else {
...
LAB_001074b4:
                  *(undefined8 *)(local_208 + 3) = local_88._0_8_;
              ...
              local_208[1] = (uint)((long)puVar40 - (long)local_208 >> 2);
              uVar19 = local_200;
              local_23c = uVar20;
LAB_00105af8:
              local_20c = local_23c;
...
LAB_00107100:
          local_23c = uVar20;
          *local_208 = ((uVar31 == 0x800e0000) != bVar47) + 0x6e;
          if (param_14 == (long *)0x0) {
            if (uVar31 == 0x800e0000) {
          ...
          if (uVar19 != 0x800d0000) {
            if (((uVar31 == 0x800a0000) && (-1 < (int)uVar19)) && (puVar38[3] == 0x800d0000)) {
              if (uVar35 < 0x110000) {
                puVar27 = &_pcre2_ucd_records_32 +
                          (ulong)*(ushort *)
                                  (&_pcre2_ucd_stage2_32 +
                                  (long)(int)((uint)*(ushort *)
                                                     (&_pcre2_ucd_stage1_32 +
                                                     (long)((int)uVar35 >> 7) * 2) * 0x80 +
                                             (uVar35 & 0x7f)) * 2) * 0xc;
                if ((&DAT_0011002b)
                    [(ulong)*(ushort *)
                             (&_pcre2_ucd_stage2_32 +
                  ...
                  if ((local_1e8 & 0xa0000) == 0) {
                    if (0xff < uVar35) goto LAB_001047a0;
                  }
                  else if (0x7f < uVar35) goto LAB_00106bbb;
                }
                else if ((-1 < (char)local_220) || (0x7f < (uVar35 | uVar19))) goto LAB_001047a0;
                uVar20 = (uint)*(byte *)(param_13[2] + (ulong)uVar35);
              }
              else {
                if ((DAT_0011000b != '\0') || ((local_1e8 & 0xa0000) == 0)) goto LAB_001047a0;
                puVar27 = &_pcre2_dummy_ucd_record_32;
LAB_00106bbb:
                uVar20 = *(int *)(puVar27 + 4) + uVar35;
              }
...
LAB_00105259:
                if (uVar17 == 0) goto LAB_0010515d;
                uVar20 = _pcre2_ord2utf_32();
                __n = (size_t)(uVar20 * 4);
                lVar36 = (ulong)uVar20 << 2;
                bVar47 = uVar20 == 1;
                goto LAB_00105181;
              }
            }
          ...
          puVar24 = puVar38 + 2;
          local_f0 = puVar24;
          if (uVar31 == 0x800a0000) goto LAB_00105134;
          uVar20 = 0xfffffffe;
          if (local_23c != 0xffffffff) {
            uVar20 = local_23c;
          }
          local_23c = uVar20;
          if ((local_1e8 & 0xa0000) == 0) {
            iVar30 = 0x20 - (uint)((local_240 & 8) == 0);
LAB_00106b04:
            puVar40 = local_208 + 2;
            *(ulong *)local_208 = CONCAT44(uVar35,iVar30);
          }
          else {
            if ((local_240 & 8) == 0) {
              iVar30 = 0x1f;
            ...
            if ((bVar1 == 0) ||
               (((local_220 & 0x80) != 0 &&
                (*(uint *)(&_pcre2_ucd_caseless_sets_32 + (ulong)(uint)bVar1 * 4) < 0x80)))) {
              iVar30 = 0x20;
              goto LAB_00106b04;
            }
            local_208[2] = (uint)bVar1;
            puVar40 = local_208 + 3;
            *(undefined8 *)local_208 = uVar39;
          }
        }
LAB_0010606e:
        local_20c = local_23c;
LAB_0010438a:
      ...
      puVar24 = puVar38;
      if (0x800e0000 < uVar31) {
        if (uVar31 == 0x80150000) {
          uVar19 = puVar38[2];
          if (puVar38[1] == 0) {
            uVar35 = 0x95;
            if (uVar19 == 10) {
              uVar35 = (puVar38[3] == 0x2b) + 0x95;
            }
          }
          else {
            uVar35 = 0x96;
            if ((9 < uVar19) && (uVar35 = 0x95, uVar19 == 10)) {
              uVar35 = ~-(uint)(puVar38[3] < 0x2c) + 0x96;
            }
          }
          local_208[2] = uVar35;
          puVar38 = puVar38 + 3;
        ...
        if (uVar31 < 0x80150001) {
          if (uVar31 == 0x80110000) {
LAB_00104af1:
            puVar40 = puVar38 + 3;
            uVar19 = puVar38[1];
            puVar44 = (undefined8 *)param_13[0x17];
            local_1f0 = CONCAT44(puVar38[2],puVar38[3]);
            lVar36 = param_13[7] + local_1f0 * 4;
            local_f0 = puVar40;
            if ((short)param_13[0x16] != 0) {
              uVar35 = 0;
              do {
                if ((uVar19 == *(ushort *)((long)puVar44 + 0xc)) &&
                   (iVar15 = _pcre2_strncmp_32(lVar36,*puVar44,(ulong)uVar19), iVar15 == 0)) {
                  if (*(short *)((long)puVar44 + 0xe) == 0) {
                    local_208[2] = (uVar31 == 0x80130000) + 0x91 + (uint)(uVar31 == 0x80130000);
                    uVar19 = *(uint *)(puVar44 + 1);
                    local_208[3] = uVar19;
                  ...
                  if (uVar35 < *(ushort *)(param_13 + 0x16)) {
                    local_fc = 0;
                    uVar31 = (uint)(uVar31 == 0x80130000) * 2 + 0x91;
                    local_208[2] = uVar31;
                    local_d0 = 0;
                    if (param_14 == (long *)0x0) {
                      iVar15 = find_dupname_details_constprop_0
                                         (lVar36,uVar19,&local_d0,&local_fc,param_5,param_13);
                      if (iVar15 == 0) goto LAB_00103ccd;
                      uVar31 = local_208[2];
                    }
...
LAB_00106df1:
            ...
            if (uVar19 < 2) {
              ...
              uVar35 = *(int *)(lVar36 + 4) - 0x30;
              if (0xffff < uVar35) {
                uVar45 = 1;
LAB_0010693c:
                uVar16 = 0;
                *param_5 = 0xa1;
                param_13[0x15] = local_1f0 + uVar45;
                goto LAB_001064e0;
              }
              uVar28 = 2;
              while (uVar45 = uVar28, uVar19 != uVar45) {
                uVar35 = *(int *)(lVar36 + uVar45 * 4) + -0x30 + uVar35 * 10;
                uVar28 = uVar45 + 1;
                if (0xffff < uVar35) goto LAB_0010693c;
              }
              if (*(uint *)((long)param_13 + 0xcc) < uVar35) goto LAB_00106df1;
              if (uVar35 == 0) {
                uVar35 = 0xffff;
              }
            }
            ...
            if (uVar31 < 0x80110001) {
              if (uVar31 == 0x800f0000) {
                uVar35 = 0x8b;
                uVar39 = 0;
                bVar47 = true;
                uVar31 = 0x8b;
                ...
                if (uVar31 != 0x80100000) goto LAB_00103ec8;
                uVar19 = puVar38[1];
                uVar18 = puVar38[2];
                uVar35 = 0x8b;
                uVar39 = 1;
            ...
            if (uVar31 != 0x80120000) {
              if ((uVar31 < 0x80120000) || ((uVar31 + 0x7fed0000 & 0xfffe0000) != 0))
              goto LAB_00103ec8;
              goto LAB_00104af1;
            }
            uVar19 = puVar38[1];
            uVar35 = puVar38[2];
            uVar31 = puVar38[3];
            if (*(uint *)((long)param_13 + 0xcc) < uVar31) {
              uVar16 = 0;
              *param_5 = 0x73;
            ...
            if (*(uint *)(param_13 + 0x1e) < uVar31) {
              *(uint *)(param_13 + 0x1e) = uVar31;
            }
...
LAB_00104fbc:
        ...
        if (uVar31 == 0x80180000) {
          ...
          if ((*(short *)((long)param_13 + 0xb6) == 0) || (uVar21 != 3)) {
            if (uVar21 < 6) {
              if ((uVar35 & 0xfffc) == 0) {
                if (uVar21 != 1) goto LAB_00105aed;
              }
              else if (((local_240 & 0x20000) != 0) && ((local_220 & 0x400) == 0)) {
                uVar45 = (ulong)((uVar21 != 4) + 0xa9);
              }
...
LAB_00105af0:
          *local_208 = (uint)uVar45;
          puVar40 = local_208 + 1;
          goto LAB_00105af8;
        }
        if (0x80180000 < uVar31) {
          if (uVar31 != 0x80190000) {
            if (uVar31 == 0x801a0000) {
              uVar35 = 0x87;
              uVar39 = 0;
              bVar47 = true;
              uVar31 = 0x87;
          ...
          if (-1 < (int)uVar18) {
            if (param_14 == (long *)0x0) goto LAB_001065cd;
            goto LAB_00106446;
          }
          if (param_14 == (long *)0x0) {
            uVar16 = 0xffffffff;
        ...
        if (uVar31 == 0x80160000) {
          uVar19 = 0;
          *local_208 = ((local_240 & 0x400) != 0) + 0x19;
          puVar40 = local_208 + 1;
          goto LAB_0010377e;
        }
        if (uVar31 == 0x80170000) {
          puVar40 = local_208 + 1;
          local_20c = 0xfffffffe;
          if (local_23c != 0xffffffff) {
            local_20c = local_23c;
...
LAB_00103ec8:
      ...
      if (uVar31 == 0x80060000) {
        *local_208 = 0x76;
        uVar19 = 0;
        local_208[1] = puVar38[1];
        local_208[2] = puVar38[2];
        local_208[3] = puVar38[3];
        puVar38 = puVar38 + 3;
        puVar40 = local_208 + DAT_001100a6;
        goto LAB_0010377e;
      }
      if (0x80060000 < uVar31) {
        if (uVar31 != 0x80090000) {
          if (uVar31 < 0x80090001) {
            if (uVar31 == 0x80070000) {
              uVar35 = puVar38[3];
              if (param_14 == (long *)0x0) {
                *local_208 = 0x77;
                local_208[1] = puVar38[1];
                local_208[2] = puVar38[2];
                uVar19 = puVar38[5];
                local_1f0 = CONCAT44(puVar38[4],uVar19);
                puVar40 = local_208 + 6;
                ...
                do {
                  ...
                  while( true ) {
                    if (uVar35 < 2) {
                      *puVar41 = 0;
                      uVar19 = 0;
                      local_208[3] = (uint)((long)(puVar41 + 1) - (long)local_208 >> 2);
                      puVar38 = puVar38 + 5;
                      puVar40 = puVar41 + 1;
                      goto LAB_0010377e;
                    }
                    uVar18 = *puVar24;
                    puVar40 = puVar41 + 1;
                    if ((uVar18 != uVar31) || (uVar31 != puVar24[1])) break;
                    *puVar41 = uVar18;
                    puVar24 = puVar24 + 2;
                    uVar35 = uVar19 - 3;
                    uVar19 = uVar19 - 2;
            ...
            if ((uVar31 + 0x7ff50000 & 0xfffe0000) == 0) {
              uVar19 = 0xa3;
              if (uVar31 == 0x800c0000) {
                uVar19 = 0xd;
              }
              *local_208 = uVar19;
              puVar40 = local_208 + 1;
            ...
            if (uVar31 == 0x800a0000) goto LAB_00104757;
          }
          goto LAB_00103ec8;
        }
        puVar40 = local_208 + 1;
      ...
      if (uVar31 == 0x80030000) {
        if (uVar21 < 10) {
          local_1f0 = param_13[uVar45 + 0xb];
        }
        else {
          local_f0 = puVar38 + 2;
          local_1f0 = CONCAT44(puVar38[1],puVar38[2]);
...
LAB_001045e6:
      ...
      if (0x80030000 < uVar31) {
        if (uVar31 == 0x80040000) {
LAB_001052c4:
          puVar40 = puVar38 + 3;
          uVar19 = puVar38[1];
          puVar44 = (undefined8 *)param_13[0x17];
          ...
          lVar36 = param_13[7] + local_1f0 * 4;
          local_f0 = puVar40;
          if ((short)param_13[0x16] == 0) goto LAB_00106df1;
          uVar45 = 0;
          uVar35 = 0;
          sVar4 = 0;
          do {
            if ((uVar19 == *(ushort *)((long)puVar44 + 0xc)) &&
               (iVar30 = _pcre2_strncmp_32(lVar36,*puVar44,uVar19), iVar30 == 0)) {
              sVar4 = *(short *)((long)puVar44 + 0xe);
              uVar18 = *(uint *)(puVar44 + 1);
              uVar45 = (ulong)uVar18;
              if (uVar31 == 0x80210000) goto LAB_0010507c;
          ...
          if ((int)uVar45 != 0) {
            if (sVar4 == 0) goto LAB_001045e6;
            local_fc = 0;
            local_d0 = 0;
            if ((param_14 != (long *)0x0) ||
               (iVar30 = find_dupname_details_constprop_0
                                   (lVar36,uVar19,&local_d0,&local_fc,param_5,param_13), iVar30 != 0
               )) {
        ...
        if (uVar31 != 0x80050000) goto LAB_00103ec8;
        puVar24 = puVar38 + 1;
        uVar35 = puVar38[1];
        local_f0 = puVar24;
LAB_00105134:
        ...
        if ((local_1e8 & 0xa0000) != 0) {
          if (uVar31 != 0) {
            ...
            if ((bVar1 != 0) &&
               (((local_220 & 0x80) == 0 ||
                (0x7f < *(uint *)(&_pcre2_ucd_caseless_sets_32 + (ulong)(uint)bVar1 * 4))))) {
              local_208[2] = (uint)bVar1;
              uVar19 = 1;
...
LAB_0010515d:
        ...
        __n = 4;
LAB_00105181:
        *local_208 = 0x1e - (uVar31 == 0);
        pvVar26 = memcpy(local_208 + 1,local_a8,__n);
        puVar40 = (uint *)((long)pvVar26 + lVar36);
        uVar35 = local_21c;
        if ((local_a8[0] == 0xd) || (local_a8[0] == 10)) {
          *(uint *)(param_13 + 0x19) = *(uint *)(param_13 + 0x19) | 0x800;
          if (local_23c != 0xffffffff) goto LAB_001051d3;
LAB_00105417:
          if (uVar20 == 1) {
LAB_00106915:
            ...
            if (uVar20 == 1) goto LAB_00106915;
            local_23c = local_1e4;
            local_20c = 0xfffffffe;
            uVar32 = *(uint *)(param_13 + 0x23);
            uVar35 = puVar40[-1];
            local_210 = local_a8[0];
          }
          else {
          ...
          if (local_23c == 0xffffffff) goto LAB_00105417;
LAB_001051d3:
          if ((local_20c != 0) || (bVar47)) {
            local_20c = local_23c;
            local_200 = local_210;
            uVar32 = local_1e4 | *(uint *)(param_13 + 0x23);
            uVar35 = puVar40[-1];
          }
          else {
            local_20c = local_23c;
      ...
      if (0x80020000 < uVar31) goto LAB_00103ec8;
      if ((uVar35 & 0xfffe0000) != 0x80000000) {
        if (-1 < (int)uVar31) goto LAB_00105134;
        goto LAB_00103ec8;
      }
      if ((int)uVar18 < 0) {
        uVar16 = 0xffffffff;
...
LAB_001066a0:
            ...
            if ((0xfffffffd < local_23c) || (local_16c = 0xfffffffe, local_224 < 0xfffffffe))
            goto LAB_001066a0;
            local_224 = local_23c;
            local_23c = 0xfffffffe;
          }
        ...
        if (uVar31 != 0x80010000) {
          uVar45 = (long)local_208 - (long)local_188 >> 2;
          do {
            uVar28 = (ulong)local_188[1];
            local_188[1] = (uint)uVar45;
        ...
        *local_208 = 0x78;
        ...
        if (uVar31 != 0x80010000) goto LAB_00106446;
        local_f8 = local_f8 + 2;
...
LAB_00106446:
  ...
  *param_9 = local_160;
  *param_10 = local_168;
  if (0x7fffffebU - lVar36 < local_f8) {
LAB_00104f40:
    uVar16 = 0;
    *param_5 = 0x78;
  }
  else {
    *param_14 = lVar36 + local_f8;
  }
  goto LAB_001064e0;
}
        ...
        *(long *)(lVar1 + 0x440) = lVar2;
        if (lVar2 == 0) {
          ...
          uVar3 = *(undefined8 *)(param_1 + 0x10);
                    ...
                    /* WARNING: Could not recover jumptable at 0x00107827. Too many branches */
...
long pcre2_compile_32(uint *param_1,long param_2,uint param_3,uint *param_4,undefined1 *param_5,
                     undefined8 param_6)
...
LAB_00108a17:
  ...
  *(uint *)((long)param_5 + 4) = 0;
  if ((param_1 == (uint *)0x0) && (param_1 = (uint *)&_LC15, param_2 != 0)) {
    *param_4 = 0x74;
    goto LAB_00108a17;
  }
  ...
  *(undefined **)(puVar40 + -0x1660) = puVar39;
  ...
  if (((uVar25 & 0x2000000) != 0) &&
     ((uVar25 & 0x1976fef3) != 0 || (*(uint *)(puVar39 + 0x40) & 0xffffff73) != 0)) {
    *param_4 = 0xc0;
    goto LAB_00108a17;
  }
  if (*(long *)(puVar40 + -0x1678) == -1) {
    *(uint **)(puVar40 + -0x1658) = param_1;
    *(undefined8 *)(puVar40 + -0x1680) = 0x108cac;
  ...
  *(undefined1 (*) [16])(puVar40 + -0x1400) = auVar58;
  *(undefined1 (*) [16])(puVar40 + -0x13f0) = auVar58;
  *(undefined1 (*) [16])(puVar40 + -0x13e0) = auVar58;
  *(undefined1 (*) [16])(puVar40 + -0x13d0) = auVar58;
  *(undefined1 (*) [16])(puVar40 + -0x13c0) = auVar58;
  if ((uVar25 & 0x2000000) == 0) {
...
switchD_00108b7a_default:
  ...
  *(undefined4 *)(puVar40 + -0x15b8) = 0xffffffff;
  ...
  uVar42 = uVar25;
LAB_00108960:
  *(uint *)(puVar40 + -0x15f4) = (uint)uVar42 & 0x80000;
  uVar18 = (undefined4)uVar25;
  if ((uVar42 & 0x80000) == 0) goto LAB_0010898b;
  if ((uVar25 & 0x1000) != 0) {
    uVar16 = 0xae;
    lVar35 = 0;
  ...
  if ((uVar25 & 0x40000000) == 0) {
    *(uint **)(puVar40 + -0x1658) = param_1;
    *(undefined8 *)(puVar40 + -0x1680) = 0x109a2e;
    uVar16 = _pcre2_valid_utf_32(param_1,*(undefined8 *)(puVar40 + -0x1678),
                                 *(undefined8 *)(puVar40 + -0x1638));
...
LAB_00108e26:
    ...
    *(uint *)(puVar40 + -0x15f0) = uVar16;
    ...
    if ((uVar42 & 0x2000000) == 0) {
      *(ulong *)(puVar40 + -0x1570) =
           (*(long *)(puVar40 + -0x1408) * 4 & 0xfffffffffffffff3U) + *(long *)(puVar40 + -0x1430);
...
LAB_00109116:
          ...
          if (*(uint *)(lVar35 + 0x3c) < (uint)*(ushort *)(puVar40 + -0x1628)) goto LAB_0010a5a0;
            ...
            if ((uVar16 == 0x5c) && (puVar30 < puVar52)) {
              ...
              if (iVar47 < 1) {
                if (*(int *)(puVar40 + -0x15d8) == 0) {
                  ...
                  if (*(int *)(puVar40 + -0x1620) < 1) goto LAB_0010a893;
...
LAB_0010a893:
                  param_5 = puVar40 + -0x1458;
                  *(undefined8 *)(puVar40 + -0x1680) = 0x10a8b7;
                  puVar27 = (uint *)manage_callouts(puVar32,puVar40 + -0x14f8,
                                                    *(undefined4 *)(puVar40 + -0x157c));
...
LAB_0010983c:
              uVar18 = *(undefined4 *)(puVar40 + -0x15e0);
              *puVar27 = uVar16;
              puVar27 = puVar27 + 1;
              uVar25 = 0;
...
LAB_00109c64:
              ...
              if ((puVar40[-0x1610] & 0x80) == 0) goto LAB_0010a043;
              if ((*(byte *)(*(long *)(puVar40 + -0x1438) + 0x5c) & 1) != 0) goto LAB_0010a2a5;
              if (*(int *)(puVar40 + -0x1620) < 1) goto LAB_0010a868;
              *(int *)(puVar40 + -0x1620) = *(int *)(puVar40 + -0x1620) + -1;
LAB_001098b1:
              if (iVar47 < 1) goto LAB_001098ba;
              goto LAB_00109186;
            }
            if ((puVar40[-0x1610] & 0x80) != 0) {
              if (uVar16 < 0x100) {
                ...
                if (((*(byte *)((long)puVar23 + (ulong)uVar16) & 1) == 0) && (uVar16 != 0x85)) {
                  if (uVar16 == 0x23) goto LAB_0010aa8d;
                  goto LAB_00109cc9;
                }
LAB_00109767:
                *(undefined4 *)(puVar40 + -0x15e0) = 0;
...
LAB_0010987b:
                ...
                uVar48 = uVar16 | 1;
                puVar23 = (uint *)(ulong)uVar48;
                if ((uVar48 != 0x200f) && (uVar48 != 0x2029)) goto LAB_0010989e;
              }
              goto LAB_00109777;
            }
LAB_00109cc9:
            if (uVar16 != 0x28) {
LAB_0010989e:
              if ((uVar16 - 0x2a < 2) || (uVar16 == 0x3f)) goto LAB_001098b1;
              if (uVar16 != 0x7b) {
LAB_0010a81a:
                param_5 = (undefined1 *)(ulong)*(uint *)(puVar40 + -0x1620);
                if ((int)*(uint *)(puVar40 + -0x1620) < 1) goto LAB_0010a868;
                goto LAB_0010a824;
              }
              *(int *)(puVar40 + -0x154c) = (int)uVar25;
              *(undefined4 *)(puVar40 + -0x1558) = 0x7b;
              *(uint **)(puVar40 + -0x14e8) = puVar30;
              *(undefined8 *)(puVar40 + -0x1680) = 0x10a1e3;
              ...
              if (iVar14 == 0) goto LAB_0010a81a;
              if (0 < iVar47) goto LAB_00109186;
              goto LAB_0010a204;
            }
            if (((4 < (long)puVar52 - (long)puVar30) && (puVar32[1] == 0x3f)) &&
               (puVar32[2] == 0x23)) {
              do {
                puVar32 = puVar30;
                puVar49 = puVar32 + 1;
            ...
            *(int *)(puVar40 + -0x1620) = *(int *)(puVar40 + -0x1620) + -1;
            if (iVar47 < 1) goto LAB_001098ba;
LAB_00109d05:
            if (8 < (long)puVar52 - (long)puVar30) {
              uVar34 = puVar32[1];
              ...
              if ((uVar34 == 0x3f) || (uVar34 == 0x2a)) {
                ...
                if (uVar34 == 0x2a) {
                  if ((uVar16 < 0x100) &&
                     (puVar23 = *(uint **)(puVar40 + -0x1438),
                     (*(byte *)((long)puVar23 + (ulong)uVar16) & 4) != 0)) {
                    if (puVar30 < puVar52) goto LAB_0010a2d5;
                    goto LAB_00109d65;
                  }
                }
                else {
                  if (uVar16 == 0x3d) {
LAB_00109d5c:
                    if (puVar30 < puVar52) goto LAB_0010b9c5;
                    goto LAB_00109d65;
                  }
                  if (uVar16 < 0x3e) {
                    if ((uVar16 == 0x21) ||
                       ((uVar16 == 0x3c && ((puVar32[3] == 0x3d || (puVar32[3] == 0x21))))))
                    goto LAB_00109d5c;
                  }
                  else if ((uVar16 == 0x43) && (iVar47 == 2)) goto LAB_00109d5c;
                }
              }
            }
LAB_00109186:
            ...
            if (uVar16 < 0x100) {
              if (uVar16 != 0x23) {
                ...
                if ((*(byte *)((long)puVar23 + (ulong)uVar16) & 1) == 0) {
                  if (uVar16 != 0x85) {
                    if (uVar16 == 0x29) goto LAB_00109e06;
                    puVar27 = *(uint **)(puVar40 + -0x1658);
                    if (uVar16 == 0x5c) goto LAB_001096dd;
                    goto LAB_00109dfa;
                  }
                  if ((puVar40[-0x1610] & 0x80) == 0) goto LAB_0010a043;
                }
                else {
                  if (uVar16 == 0x5c) goto LAB_00109c64;
                  if ((puVar40[-0x1610] & 0x80) == 0) goto LAB_00109cc9;
                }
LAB_0010a2a5:
                puVar27 = *(uint **)(puVar40 + -0x1658);
                goto LAB_00109777;
...
LAB_0010aa8d:
                  if (puVar52 <= puVar30) goto LAB_0010a2a5;
                  uVar25 = uVar25 & 0xffffffff;
                  do {
                    if (*(int *)(puVar40 + -0x1360) == 0) {
                      if (((puVar30 <=
                            *(uint **)(puVar40 + -0x1418) + -(ulong)*(uint *)(puVar40 + -0x135c)) &&
                          (*puVar30 == *(uint *)(puVar40 + -0x1350))) &&
                         ((*(uint *)(puVar40 + -0x135c) == 1 ||
                          (puVar30[1] == *(uint *)(puVar40 + -0x134c))))) {
LAB_0010ab0f:
                        puVar30 = puVar30 + *(uint *)(puVar40 + -0x135c);
                        puVar27 = *(uint **)(puVar40 + -0x1658);
                        *(uint **)(puVar40 + -0x1500) = puVar30;
                        goto LAB_00109777;
                      }
              ...
              if (((uVar16 | 1) != 0x200f) && ((uVar16 | 1) != 0x2029)) goto LAB_00109de3;
              if ((puVar40[-0x1610] & 0x80) != 0) goto LAB_0010987b;
            }
LAB_0010a043:
            if (*(int *)(puVar40 + -0x1620) < 1) {
LAB_0010a868:
              param_5 = puVar40 + -0x1458;
              *(undefined8 *)(puVar40 + -0x1680) = 0x10a88c;
...
LAB_0010a824:
              *(int *)(puVar40 + -0x1620) = *(int *)(puVar40 + -0x1620) + -1;
              if (0 < iVar47) {
                if (uVar16 == 0x28) goto LAB_00109d05;
                goto LAB_00109186;
              }
            }
            else {
...
LAB_001098ba:
            ...
            if ((iVar14 == 0) || ((uVar16 != 0x3f && (uVar16 != 0x2b)))) {
              puVar23 = &switchD_001098ea::switchdataD_0010dff0;
              switch(uVar16) {
              case 0x24:
              ...
              default:
                ...
                *puVar23 = uVar16;
                ...
                break;
              case 0x28:
                if (puVar52 <= puVar30) goto LAB_00109d65;
                if (puVar32[1] == 0x3f) {
LAB_0010b9c5:
                  puVar49 = puVar32 + 2;
                  *(uint **)(puVar40 + -0x1500) = puVar49;
                  puVar30 = puVar49;
                  if (puVar52 <= puVar49) goto LAB_00109d65;
                  uVar34 = puVar32[2];
                  puVar23 = &switchD_0010b9f7::switchdataD_0010e1b4;
                  switch(uVar34) {
                  case 0x21:
                    goto switchD_0010b9f7_caseD_21;
                  default:
                    if (((uVar34 == 0x2d) && (4 < (long)puVar52 - (long)puVar49)) &&
                       (puVar32[3] - 0x30 < 10)) goto LAB_0010b108;
...
LAB_0010cf29:
                      ...
                      if (puVar49 < puVar52) {
                        ...
                        if (uVar34 == 0x3a || uVar34 == 0x29) goto LAB_0010d00d;
                        puVar30 = puVar49 + 1;
                        bVar56 = bVar10;
                        switch(uVar34) {
                        case 0x2d:
...
switchD_0010b9f7_caseD_26:
                    ...
                    *(undefined8 *)(puVar40 + -0x16a0) = 0x10cc24;
...
LAB_0010b39f:
                    ...
                    goto LAB_00109917;
                  case 0x27:
switchD_0010b9f7_caseD_27:
                    *(undefined1 **)(puVar40 + -0x1680) = param_5;
                    *(undefined1 **)(puVar40 + -0x1688) = puVar40 + -0x1458;
                    *(undefined1 **)(puVar40 + -0x1690) = puVar40 + -0x1524;
                    *(undefined1 **)(puVar40 + -0x1698) = puVar40 + -0x1528;
                    puVar45 = (uint *)(puVar40 + -0x14f0);
                    *(undefined8 *)(puVar40 + -0x16a0) = 0x10c825;
                    iVar47 = read_name(puVar40 + -0x1500,puVar52,*(undefined4 *)(puVar40 + -0x15c0),
                            ...
                            *(uint **)(puVar40 + -0x1610) = puVar52;
                            ...
                            do {
                              if (uVar16 == (ushort)puVar49[3]) {
                                ...
                                *(undefined8 *)(puVar40 + -0x1680) = 0x10c923;
...
LAB_0010c9f6:
                          if (*(uint *)(puVar40 + -0x1398) <= uVar34) {
                            ...
                            *(undefined8 *)(puVar40 + -0x1680) = 0x10ca22;
                            ...
                            *(undefined8 *)(puVar40 + -0x1680) = 0x10ca53;
                            ...
                            if (0x14 < *(uint *)(puVar40 + -0x1398)) {
                              ...
                              *(undefined8 *)(puVar40 + -0x1680) = 0x10ca79;
                  ...
                  case 0x28:
                    ...
                    *(undefined8 *)(puVar40 + -0x1690) = 0x10cd33;
...
LAB_0010cd91:
                    ...
                    puVar30 = *(uint **)(puVar40 + -0x1500);
                    if (uVar16 != 0) goto LAB_0010ae62;
                    if ((long)puVar52 - (long)puVar30 < 0x25) {
                      uVar34 = *puVar30;
                      if (uVar34 != 0x52) goto LAB_0010d1a0;
                      if (4 < (long)puVar52 - (long)puVar30) {
LAB_0010d343:
                        if (puVar30[1] != 0x26) goto LAB_0010d27f;
                        ...
                        *(undefined1 **)(puVar40 + -0x1698) = puVar40 + -0x1528;
                        param_5 = puVar40 + -0x14e0;
                        *(undefined8 *)(puVar40 + -0x16a0) = 0x10d39a;
...
LAB_0010d27f:
                      ...
                      *(undefined1 **)(puVar40 + -0x1698) = puVar40 + -0x1528;
                      param_5 = puVar40 + -0x14e0;
                      *(undefined8 *)(puVar40 + -0x16a0) = 0x10d2cb;
                      iVar47 = read_name(*(undefined8 *)(puVar40 + -0x1588),puVar52,
                                         *(undefined4 *)(puVar40 + -0x15c0),0x29,param_5,
                                         puVar40 + -0x14f0);
...
LAB_0010d505:
                      ...
                      *(undefined8 *)(puVar40 + -0x1680) = 0x10d607;
...
LAB_0010d213:
                    ...
                    pcVar43 = "VERSION";
                    *(undefined8 *)(puVar40 + -0x1680) = 0x10d42d;
                      ...
                      if (*puVar49 == 0x3d) {
                        ...
                        *(uint **)(puVar40 + -0x1500) = puVar49;
                        if (uVar16 - 0x30 < 10) {
                          ...
                          *(undefined1 **)(puVar40 + -0x1688) = puVar51;
                          *(undefined8 *)(puVar40 + -0x1690) = 0x10d4b1;
                              ...
                              *(uint **)(puVar40 + -0x1500) = puVar30;
                              ...
                              if (puVar30 < puVar52) {
                                if (puVar49[2] - 0x30 < 10) {
                                  ...
                                  *(uint **)(puVar40 + -0x1500) = puVar30;
                                  if (puVar52 <= puVar30) goto LAB_0010d59f;
                                }
                                if (*puVar30 != 0x29) {
                                  param_4 = *(uint **)(puVar40 + -0x1650);
                                  puVar49 = *(uint **)(puVar40 + -0x1500);
...
LAB_0010d5a7:
                    ...
                    if (uVar34 == 0x52) goto LAB_0010d343;
LAB_0010d1a0:
                    if (uVar34 == 0x3c) {
                      uVar34 = 0x3e;
                    }
                    else if (uVar34 != 0x27) goto LAB_0010d27f;
                    *(char **)(puVar40 + -0x1680) = pcVar43;
                    *(undefined1 **)(puVar40 + -0x1688) = puVar40 + -0x1458;
                    *(undefined1 **)(puVar40 + -0x1690) = puVar51;
                    *(undefined1 **)(puVar40 + -0x1698) = puVar40 + -0x1528;
                    param_5 = puVar40 + -0x14e0;
                    *(undefined8 *)(puVar40 + -0x16a0) = 0x10d1e9;
                    iVar47 = read_name(*(undefined8 *)(puVar40 + -0x1588),puVar52,
...
LAB_0010d207:
                    ...
                    break;
                  case 0x2a:
                    goto switchD_0010b9f7_caseD_2a;
                  case 0x2b:
...
LAB_0010b10f:
                    ...
                    *(undefined8 *)(puVar40 + -0x1690) = 0x10b13d;
...
LAB_0010c7dc:
                      uVar34 = 0x3e;
                      goto switchD_0010b9f7_caseD_27;
                    }
                    uVar34 = puVar32[3];
                    if ((uVar34 == 0x3d) || (uVar34 == 0x21)) {
                      ...
                      if (uVar34 != 0x2a) goto LAB_0010c7dc;
                      uVar16 = 0x80280000;
                    }
                    puVar30 = *(uint **)(puVar40 + -0x1658);
                    *puVar30 = uVar16;
                    goto LAB_0010b855;
                  case 0x3d:
                    goto switchD_0010b9f7_caseD_3d;
                  case 0x3e:
                    goto switchD_0010b9f7_caseD_3e;
                  case 0x43:
                    puVar30 = puVar32 + 3;
                    *(uint **)(puVar40 + -0x1500) = puVar30;
                    if (puVar52 <= puVar30) goto LAB_00109d65;
...
LAB_0010c61f:
                      ...
                      *puVar29 = 0x80060000;
                      ...
                      do {
                        uVar34 = *puVar49;
                        if (9 < uVar34 - 0x30) {
                          if ((char)puVar23 == '\0') goto LAB_0010d71e;
                          break;
                        }
                        puVar49 = puVar49 + 1;
...
LAB_0010d71e:
                  ...
                  case 0x50:
                    ...
                    *(uint **)(puVar40 + -0x1500) = puVar30;
                    if (puVar30 < puVar52) {
                      uVar34 = puVar32[3];
                      if (uVar34 == 0x3c) goto LAB_0010c7dc;
                      if (uVar34 == 0x3e) goto switchD_0010b9f7_caseD_26;
                      if (uVar34 == 0x3d) {
                        ...
                        *(undefined1 **)(puVar40 + -0x1698) = puVar40 + -0x1528;
                        puVar45 = (uint *)(puVar40 + -0x14f0);
                        param_5 = puVar40 + -0x14e0;
                        *(undefined8 *)(puVar40 + -0x16a0) = 0x10c758;
...
LAB_00109d65:
                  ...
                  case 0x52:
                    ...
                    *(uint **)(puVar40 + -0x1500) = puVar45;
                    if ((puVar45 < puVar52) && (puVar32[3] == 0x29)) goto LAB_0010b175;
                    uVar34 = *(uint *)(puVar40 + -0x1648);
                    uVar18 = *(undefined4 *)(puVar40 + -0x163c);
                    uVar16 = 0x9e;
                    param_4 = *(uint **)(puVar40 + -0x1650);
                          ...
                          do {
                            *(int *)(puVar40 + -0x1520) = iVar14;
                            ...
                            if (iVar47 == *(int *)(puVar40 + -0x1528)) {
                              *(undefined8 *)(puVar40 + -0x1680) = 0x10b55f;
                              ...
                              if (iVar15 == 0) goto code_r0x0010b56d;
                            }
                            iVar14 = iVar14 + 1;
...
LAB_0010b90a:
                      ...
                      *(undefined1 **)(puVar40 + -0x1698) = puVar40 + -0x1528;
                      param_5 = puVar40 + -0x14e0;
                      *(undefined8 *)(puVar40 + -0x16a0) = 0x10a356;
                      iVar47 = read_name(puVar40 + -0x1500,puVar52,
                          ...
                          *(uint **)(puVar40 + -0x1590) = puVar52;
                          ...
                          do {
                            if (*piVar38 == (int)puVar45) {
                              ...
                              *(undefined8 *)(puVar40 + -0x1680) = 0x10a409;
                              ...
                              if (uVar34 == 0) goto code_r0x0010a420;
                            }
                            iVar47 = iVar47 + 1;
                            piVar38 = piVar38 + 3;
                            *(int *)(puVar40 + -0x1520) = iVar47;
                ...
                if (**(int **)(puVar40 + -0x1618) == -0x7fd60000) {
                  if (*(undefined4 **)(puVar40 + -0x1578) <= puVar29 + -1) {
                    ...
                    *(int *)(puVar40 + -0x1590) = (int)uVar25;
                    ...
                    ;
                    *(undefined8 *)(puVar40 + -0x1680) = 0x10b41d;
                  ...
                  if (puVar30 < puVar52) {
                    ...
                    if (puVar32[1] < 0x3e) {
                      if ((0x2400400000000000U >> ((ulong)puVar45 & 0x3f) & 1) != 0) {
                        *(undefined8 *)(puVar40 + -0x1680) = 0x10ba55;
                      ...
                      if (puVar52 <= puVar30) goto LAB_0010bfc1;
                    }
                    bVar55 = false;
                    do {
                      uVar34 = *puVar30;
                      ...
                      *(uint *)(puVar40 + -0x152c) = uVar34;
                      if (uVar34 == 0x5c) {
                        ...
                        if (puVar30[1] == 0x45) {
                          ...
                          *(undefined8 *)(puVar40 + -0x1680) = 0x10beef;
                        ...
                        if (bVar55) {
                          if ((uVar34 != 0x5d) || ((puVar40[-0x1394] & 1) == 0)) goto LAB_0010bae3;
                          uVar18 = 0x800c0000;
                        }
                        else {
                          if (uVar34 == 0x5e) {
...
LAB_0010bb71:
                  if (uVar48 != 0) {
                    if (uVar34 != 0x5c) goto LAB_0010bbe1;
                    puVar45 = *(uint **)(puVar40 + -0x1500);
                    ...
                    if (puVar30[-2] == 0x5c) goto LAB_0010bf3d;
                    if (puVar30[-2] < 0x5d) goto LAB_0010bc1a;
LAB_0010bf22:
                    param_4 = *(uint **)(puVar40 + -0x1650);
                    puVar49 = puVar45;
                    goto LAB_0010bf2a;
...
LAB_0010bf10:
                      puVar49 = puVar45;
                      if (puVar30[-2] == uVar34) goto LAB_0010bf3d;
                      if (puVar30[-2] <= uVar34) goto LAB_0010bc0a;
                      goto LAB_0010bf22;
                    }
                    uVar16 = *puVar49;
                    puVar45 = puVar49;
                    ...
                    *(undefined8 *)(puVar40 + -0x1680) = 0x10bcea;
                    ...
                    if (iVar47 == 0) goto LAB_0010be94;
                    if (uVar17 == 1) goto LAB_0010bf72;
                    if (uVar16 != 0x3a) {
                      param_4 = *(uint **)(puVar40 + -0x1650);
                      puVar49 = *(uint **)(puVar40 + -0x1500);
                      uVar16 = 0x71;
...
LAB_0010be94:
                  ...
                  *(undefined1 **)(puVar40 + -0x1588) = puVar40 + -0x1500;
                  *(undefined8 *)(puVar40 + -0x1690) = 0x10c1cb;
                      ...
                      if ((int)uVar41 < 0x11) {
                        if ((int)uVar41 < 0xf) {
                          if (0xb < (int)uVar41) {
                            ...
                            uVar18 = *(undefined4 *)(puVar40 + -0x163c);
                            param_4 = *(uint **)(puVar40 + -0x1650);
                            if (uVar41 != 0xc) goto LAB_0010c42e;
                            uVar16 = 0xab;
                            puVar49 = *(uint **)(puVar40 + -0x1500);
                            goto LAB_0010919b;
                          }
                          if ((int)uVar41 < 6) goto LAB_0010c41f;
                          *(undefined8 *)(puVar40 + -0x1680) = 0x10c3f2;
                          ...
                          *(undefined8 *)(puVar40 + -0x1690) = 0x10c4b9;
...
LAB_0010c42e:
                    ...
                    puVar23 = &switchD_0010c2dc::switchdataD_0010e27c;
                    uVar25 = (long)&switchD_0010c2dc::switchdataD_0010e27c +
                             (long)(int)(&switchD_0010c2dc::switchdataD_0010e27c)[uVar41];
                    switch(uVar41) {
                    case 0:
                      uVar34 = *(uint *)(puVar40 + -0x152c);
                      if (uVar17 != 1) {
LAB_0010c27b:
                      ...
                      if (puVar30[-2] == uVar34) goto LAB_0010bf35;
                      if (puVar30[-2] <= uVar34) goto LAB_0010c2ef;
                      break;
                    default:
                      goto switchD_0010c2dc_caseD_1;
                    case 4:
                    case 0x11:
                    case 0x16:
                      uVar34 = *(uint *)(puVar40 + -0x1648);
                    ...
                    case 5:
                      *(undefined4 *)(puVar40 + -0x152c) = 8;
                      ...
                      if (puVar30[-2] == 8) goto LAB_0010bf35;
                      if (puVar30[-2] < 9) {
                        uVar34 = 8;
LAB_0010c233:
                    ...
                    *(uint **)(puVar40 + -0x1500) = puVar49;
                    if (puVar52 <= puVar49) {
                      *(undefined4 *)(puVar40 + -0x152c) = 0x5c;
                      bVar55 = uVar17 != 1;
                      uVar17 = 2;
                      if (bVar55) goto LAB_0010bb40;
                      if (puVar30[-2] == 0x5c) goto LAB_0010bf3d;
                      if (puVar30[-2] < 0x5d) goto LAB_0010c233;
                      param_4 = *(uint **)(puVar40 + -0x1650);
                      goto LAB_0010bf2a;
                    }
                    uVar34 = *puVar49;
                    ...
                    *(uint *)(puVar40 + -0x152c) = uVar34;
                    uVar41 = uVar48;
                    if (uVar17 != 1) goto LAB_0010c27b;
                    puVar49 = puVar45;
                    if (uVar34 == puVar30[-2]) goto LAB_0010bf3d;
                    if (uVar34 < puVar30[-2]) goto LAB_0010bf22;
LAB_0010c2ef:
                    if (puVar30[-1] == 0x801f0000) {
                      puVar30[-1] = 0x801e0000;
                    }
...
LAB_0010bb47:
                      while( true ) {
                        while( true ) {
                          ...
                          *(uint *)(puVar40 + -0x152c) = uVar34;
                          if (uVar34 != 0x5d) goto LAB_0010bb71;
                          if (uVar48 == 0) {
                            puVar54 = (uint *)0x0;
                            if (uVar17 == 1) {
                              puVar30[-1] = 0x2d;
...
LAB_0010bf2a:
              ...
              case 0x5c:
                ...
                *(undefined8 *)(puVar40 + -0x1688) = 0;
                puVar45 = (uint *)(ulong)*(uint *)(puVar40 + -0x1590);
                param_5 = (undefined1 *)(ulong)*(uint *)(puVar40 + -0x1610);
                *(undefined8 *)(puVar40 + -0x1690) = 0x10a971;
                ...
                if (*(uint *)(puVar40 + -0x1524) != 0) goto LAB_0010a98f;
                if (iVar14 == 0) {
LAB_0010adde:
...
LAB_0010a9be:
                ...
                if (iVar14 < 0) {
                  ...
                  **(uint **)(puVar40 + -0x1658) = uVar34 | 0x80030000;
                  ...
                  puVar23 = &switchD_0010ae2a::switchdataD_0010e154;
                  uVar34 = (&switchD_0010ae2a::switchdataD_0010e154)[iVar14 - 6U];
                  switch(iVar14) {
                  case 6:
                  case 7:
                  case 8:
                  ...
                  case 0xb:
                    uVar25 = 0;
                    uVar34 = 1;
                    *(undefined8 *)(puVar40 + -0x1680) = 0x10b30f;
                  ...
                  case 0x10:
                    ...
                    *(undefined2 *)(puVar40 + -0x150c) = 0;
                    *(long *)(puVar40 + -0x1680) =
                         (long)&switchD_0010ae2a::switchdataD_0010e154 + (long)(int)uVar34;
                    *(undefined8 *)(puVar40 + -0x1688) = *(undefined8 *)(puVar40 + -0x1418);
                    puVar45 = *(uint **)(puVar40 + -0x1438);
                    *(undefined8 *)(puVar40 + -0x1690) = 0x10b219;
...
LAB_0010b065:
                      ...
                      *(undefined8 *)(puVar40 + -0x16a0) = 0x10b0a6;
...
LAB_0010b004:
                      ...
                      else if (uVar34 != 0x27) goto LAB_0010b0cc;
                      if (iVar14 != 0x1b) goto LAB_0010b065;
                      ...
                      *(undefined8 *)(puVar40 + -0x1690) = 0x10af63;
                      ...
                      if (*(int *)(puVar40 + -0x1524) == 0) {
                        ...
                        *(undefined1 **)(puVar40 + -0x1698) = puVar40 + -0x1528;
                        puVar45 = (uint *)(puVar40 + -0x14f0);
                        *(undefined8 *)(puVar40 + -0x16a0) = 0x10afee;
                        ...
                        param_5 = (undefined1 *)puVar27;
                        if (iVar14 == 0) goto LAB_0010a98f;
                        uVar18 = 0x80210000;
                        goto LAB_0010b004;
                      }
                    }
LAB_0010a98f:
                    if ((puVar40[-0x1590] & 2) == 0) goto LAB_0010acad;
                    *(uint **)(puVar40 + -0x1500) = puVar30;
                    if (puVar30 < puVar52) {
...
LAB_0010a204:
                ...
                *(uint *)(puVar40 + -0x1610) = uVar16;
                *(undefined8 *)(puVar40 + -0x1680) = 0x10a22c;
...
LAB_00109784:
              if (puVar52 <= puVar30) {
                ...
                if (*(int *)(puVar40 + -0x15d8) == 0) goto LAB_0010998f;
...
LAB_00109e06:
            if (0x40000 < (long)puVar30 - *(long *)(puVar40 + -0x1560)) {
              uVar34 = *(uint *)(puVar40 + -0x1648);
              uVar18 = *(undefined4 *)(puVar40 + -0x163c);
              uVar16 = 0xb0;
              param_4 = *(uint **)(puVar40 + -0x1650);
            ...
            piVar38 = *(int **)(puVar40 + -0x1658);
            **(int **)(puVar40 + -0x1568) =
                 (int)((long)piVar38 - (long)*(int **)(puVar40 + -0x1568) >> 2) + -1;
...
LAB_0010a53b:
            ...
            *(undefined1 **)(puVar40 + -0x1680) = puVar40 + -0x1458;
            *(undefined8 *)(puVar40 + -0x1688) = 0;
            *(undefined8 *)(puVar40 + -0x1690) = 0x109727;
            iVar47 = _pcre2_check_escape_32
                               (puVar40 + -0x1500,puVar52,puVar40 + -0x152c,puVar40 + -0x1524,
                                param_5,*(undefined4 *)(puVar40 + -0x1590));
            ...
            if (iVar47 != 0x1a) {
              if (iVar47 < 0x1b) {
                ...
                if (iVar47 == 0x19) goto LAB_00109767;
              }
              else if (iVar47 == 0x1d) {
                puVar22 = *(undefined8 **)(puVar40 + -0x1658);
                *(undefined4 *)(puVar40 + -0x15e0) = 0;
...
LAB_0010a4de:
      ...
      *(undefined2 *)(puVar40 + -0x1628) = 0;
LAB_0010998f:
      *(undefined8 *)(puVar40 + -0x1680) = 0x1099b3;
      auVar59 = manage_callouts(puVar30,puVar40 + -0x14f8,*(undefined4 *)(puVar40 + -0x157c),
                                *(undefined8 *)(puVar40 + -0x1658),puVar40 + -0x1458);
      ...
      if (*(undefined4 **)(puVar40 + -0x15d0) <= auVar59._0_8_) goto LAB_001097cd;
      sVar2 = *(short *)(puVar40 + -0x1628);
      *auVar59._0_8_ = 0x80000000;
      if (sVar2 != 0) {
LAB_001099ee:
        *(undefined4 *)(puVar40 + -0x1530) = 0x72;
        uVar16 = 0x72;
        uVar25 = (long)puVar30 - *(long *)(puVar40 + -0x1420) >> 2;
        *(ulong *)(puVar40 + -0x13b0) = uVar25;
        goto LAB_001097f5;
    ...
    if (puVar52 <= puVar30) goto LAB_0010a4de;
    puVar23 = *(uint **)(puVar40 + -0x1658);
    ...
    if (puVar23 < puVar45) {
      *(uint *)(puVar40 + -0x1658) = uVar16;
      ...
      do {
        ...
        *(uint *)(puVar40 + -0x152c) = uVar16;
        if ((int)uVar25 != 0) {
          *(undefined8 *)(puVar40 + -0x1680) = 0x108f47;
...
LAB_001097cd:
    *(undefined4 *)(puVar40 + -0x1530) = 0xa3;
    uVar16 = 0xa3;
    uVar25 = (long)puVar30 - *(long *)(puVar40 + -0x1420) >> 2;
    *(ulong *)(puVar40 + -0x13b0) = uVar25;
    goto LAB_001097f5;
  ...
  *(undefined8 *)(puVar40 + -0x1680) = 0x108e0b;
...
LAB_0010a5a0:
  ...
  goto LAB_0010919b;
LAB_0010bda6:
  if (uVar34 != uVar16) goto LAB_0010bd90;
  *(uint **)(puVar40 + -0x1540) = puVar23;
  *(undefined8 *)(puVar40 + -0x1680) = 0x10bdc1;
  ...
  *(uint **)(puVar40 + -0x1500) = puVar49;
  if (((puVar23 <= puVar49) || (*(int *)(lVar35 + 8) != 0x2d)) || (*(int *)(lVar35 + 0xc) == 0x5d))
  {
    ...
    uVar48 = 0;
    if ((((*(uint *)(puVar40 + -0x1610) & 0x20000) != 0) &&
        ((*(uint *)(puVar40 + -0x1590) & 0x800) == 0)) &&
       (((*(uint *)(puVar40 + -0x1590) & 0x1000) == 0 ||
        (puVar23 = (uint *)0x2080, (0x2080UL >> ((ulong)uVar34 & 0x3f) & 1) == 0)))) {
...
LAB_0010bd90:
  ...
  if (*puVar51 == 0) goto LAB_0010c2a4;
  goto LAB_0010bda6;
code_r0x0010b56d:
  iVar47 = *(int *)(puVar40 + -0x1590);
  puVar49 = *(uint **)(puVar40 + -0x1610);
  uVar16 = (&DAT_0010e704)[(long)param_5 * 2];
  if ((0 < iVar47) &&
     (puVar23 = (uint *)(ulong)(uVar16 + 0x7fdd0000), 0x30000 < uVar16 + 0x7fdd0000)) {
    uVar34 = *(uint *)(puVar40 + -0x1648);
    uVar18 = *(undefined4 *)(puVar40 + -0x163c);
    param_4 = *(uint **)(puVar40 + -0x1650);
    ...
    *puVar29 = 0x80240000;
    ...
    if (uVar16 < 0x80240001) {
      ...
      if (uVar16 != 0x80230000) {
        if (uVar16 != 0x80020000) goto LAB_0010b669;
switchD_0010b9f7_caseD_3e:
        puVar29 = *(undefined4 **)(puVar40 + -0x1658);
        uVar34 = 0;
        puVar54 = (uint *)0x0;
        uVar25 = 0;
...
LAB_0010b669:
        ...
        if (uVar16 != 0x8fff0000) goto LAB_0010b669;
        puVar22 = *(undefined8 **)(puVar40 + -0x1658);
        puVar49 = puVar49 + 1;
        *(short *)(puVar40 + -0x1628) = *(short *)(puVar40 + -0x1628) + 1;
        ...
        *puVar22 = 0x8002000080220000;
        ...
        if (lVar35 == 0) {
          ...
          *(long *)(puVar40 + -0x1630) = *(long *)(puVar40 + -0x1630) + 0x10;
          if (*(ulong *)(puVar40 + -0x1570) <= *(ulong *)(puVar40 + -0x1630)) goto LAB_0010b735;
        }
        puVar9 = *(undefined2 **)(puVar40 + -0x1630);
        puVar54 = (uint *)0x0;
        uVar25 = 0;
    ...
    if (puVar45 < puVar52) {
      if (piVar38[1] == 0x29) {
        *(uint **)(puVar40 + -0x1500) = puVar45;
        uVar34 = *puVar45;
        puVar30 = puVar45;
        if (0 < iVar47) goto LAB_0010cdf6;
      }
      else {
        puVar45 = *(uint **)(puVar40 + -0x1500);
        puVar30 = puVar45;
        if (0 < iVar47) goto LAB_0010d8f1;
      }
      puVar30 = puVar45 + 1;
      *(uint **)(puVar40 + -0x1500) = puVar30;
      ...
      if (*puVar45 != 0x3a) goto LAB_0010a477;
LAB_0010d9c0:
      iVar15 = -0x7fd70000;
      pauVar33 = pauVar28;
      if (-1 < iVar47) goto LAB_0010d91b;
    }
    else {
      puVar30 = *(uint **)(puVar40 + -0x1500);
      uVar34 = *puVar30;
...
LAB_0010d8f1:
      ...
      *(uint **)(puVar40 + -0x1500) = puVar30;
LAB_0010d91b:
      iVar15 = (uint)(iVar14 != -0x7fd70000) * 0x10000 + iVar14;
...
LAB_001091c3:
    if (*(int *)(puVar40 + -0x1594) == 0) {
      ...
      *(undefined4 *)(puVar40 + -0x14e0) = 0;
      if (uVar16 < 0x80) {
        ...
        uVar20 = (*(undefined8 **)(puVar40 + -0x1660))[2];
        pcVar6 = (code *)**(undefined8 **)(puVar40 + -0x1660);
        *(undefined8 *)(puVar40 + -0x1680) = 0x109202;
      ...
      *(undefined8 *)(puVar40 + -0x1680) = 0x10922c;
      memset(pvVar24,0,(ulong)(uVar16 * 2 + 1) << 2);
      *(undefined1 **)(puVar40 + -0x1648) = puVar40 + -0x1458;
      *(undefined1 **)(puVar40 + -0x1620) = puVar40 + -0x14e0;
      *(undefined8 *)(puVar40 + -0x1680) = 0x10925a;
    ...
    *(undefined8 *)(puVar40 + -0x16c0) = 0x109337;
    compile_regex(*(undefined4 *)(puVar40 + -0x1394),uVar4,puVar40 + -0x14e8,
                  *(undefined8 *)(puVar40 + -0x1620),puVar40 + -0x1530,0);
    ...
    *(ulong *)(puVar40 + -0x1618) = *(ulong *)(puVar40 + -0x1508);
    ...
    uVar20 = (*(undefined8 **)(puVar40 + -0x1660))[2];
    pcVar6 = (code *)**(undefined8 **)(puVar40 + -0x1660);
    *(undefined8 *)(puVar40 + -0x1680) = 0x109395;
    ...
    *(undefined4 *)(puVar40 + -0x1340) = 0;
    puVar29 = (undefined4 *)
              ((long)puVar22 + (long)(int)((uVar16 >> 0x10) * (uVar16 & 0xffff)) * 4 + 0x88);
    ...
    if ((short)uVar16 != 0) {
      ...
      *(uint *)(puVar40 + -0x1628) = (uint)uVar13;
      ...
      while( true ) {
        ...
        *(undefined8 *)(puVar40 + -0x1680) = 0x10955c;
        memcpy(puVar37,pvVar24,__n);
        *(undefined8 *)(puVar40 + -0x1680) = 0x109585;
        memset((void *)((long)puVar50 + (ulong)*(ushort *)(puVar40 + -0x1630) * 4 + 4),0,
               (long)(int)(((uint)*(ushort *)(puVar40 + -0x13a6) - *(int *)(puVar40 + -0x1628)) * 4
                          + -4));
        ...
        *(ulong *)(puVar40 + -0x1658) = (ulong)(uVar13 + 1);
        ...
        do {
          ...
          *(undefined8 *)(puVar40 + -0x1680) = 0x109638;
          iVar15 = memcmp(pvVar24,puVar37,__n);
          if (iVar15 == 0) {
            if (*(int *)((long)puVar50 + *(long *)(puVar40 + -0x1658) * 4) != 0) goto LAB_0010963e;
          }
          else if (iVar15 < 0) {
LAB_0010963e:
            *(undefined8 *)(puVar40 + -0x1680) = 0x109669;
            _pcre2_memmove32(*(long *)(puVar40 + -0x1678) + (long)puVar50,puVar50,
                             (*(int *)(puVar40 + -0x163c) - iVar14) *
                             (uint)*(ushort *)(puVar40 + -0x15f8) * 4);
            goto LAB_00109669;
          }
...
LAB_00109669:
    ...
    *(undefined8 *)(puVar40 + -0x16c0) = 0x109b9a;
    iVar47 = compile_regex(uVar18,uVar4,*(undefined8 *)(puVar40 + -0x15c0),
                           *(undefined8 *)(puVar40 + -0x1620),*(undefined8 *)(puVar40 + -0x15f0),0);
    lVar35 = *(long *)(puVar40 + -0x1678);
    if (iVar47 < 0) {
...
LAB_00109c43:
    ...
    uVar16 = *(uint *)(puVar40 + -0x1530);
    *(long *)(lVar35 + 0x48) =
         *(long *)(lVar35 + 0x48) + (*(long *)(puVar40 + -0x1618) - uVar25) * -4;
    if (uVar16 != 0) goto LAB_00109c43;
    if (*(int *)(puVar40 + -0x132c) != 0) {
      *(undefined8 *)(puVar40 + -0x1680) = 0x10a5ca;
        ...
        *(uint *)(puVar40 + -0x1658) = (uint)(*(int *)(puVar40 + -0x15f4) != 0);
        do {
          ...
          if (iVar47 != 0) {
              ...
              do {
                ...
                if (*(int *)(puVar40 + lVar36 + -0x14d0) == iVar47) {
                  if (*(long *)(puVar40 + lVar36 + -0x14d8) != 0) {
                    uVar18 = (undefined4)
                             (*(long *)(puVar40 + lVar36 + -0x14d8) - (long)puVar29 >> 2);
                    goto LAB_0010a600;
                  }
                  break;
                }
            ...
            *(undefined8 *)(puVar40 + -0x1680) = 0x10a67c;
...
LAB_0010a600:
          *(undefined4 *)(lVar26 + 4) = uVar18;
          *(undefined8 *)(puVar40 + -0x1680) = 0x10a60c;
...
LAB_0010a6c5:
    ...
    if ((uVar16 & 0x4000) == 0) {
      ...
      *(undefined8 *)(puVar40 + -0x1680) = 0x10ab56;
...
LAB_00109eb0:
    if (-1 < (int)uVar16) {
      *(long *)(puVar40 + -0x1678) = lVar35;
      *(undefined8 *)(puVar40 + -0x1680) = 0x10a4c2;
...
LAB_00109ee7:
        uVar41 = *(uint *)(lVar35 + 0x60);
        uVar5 = *(uint *)(puVar40 + -0x14f8);
        *(uint *)(lVar35 + 0x70) = uVar5;
        *(uint *)(lVar35 + 0x60) = uVar41 | 0x10;
        if ((uVar48 & 1) == 0) goto LAB_00109f64;
        if (uVar5 < 0x80) {
LAB_0010b94d:
          if (uVar5 != *(byte *)(*(long *)(puVar40 + -0x1448) + (ulong)uVar5)) {
LAB_00109f5d:
            *(uint *)(lVar35 + 0x60) = uVar41 | 0x30;
          }
        }
        else if (*(int *)(puVar40 + -0x15f4) == 0 && (uVar34 & 0x20000) == 0) {
          if (uVar5 < 0xff) goto LAB_0010b94d;
        }
...
LAB_00109f64:
        ...
        if (uVar17 < 0xfffffffe) {
          ...
          if ((int)uVar16 < 0) {
LAB_0010a71e:
            if ((uVar17 & 2) == 0) goto LAB_0010a001;
          }
LAB_00109f81:
          uVar16 = *(uint *)(lVar35 + 0x60);
          ...
          *(uint *)(lVar35 + 0x60) = uVar16 | 0x80;
          if ((uVar17 & 1) != 0) {
            if (uVar48 < 0x80) {
LAB_0010b610:
              if (uVar48 != *(byte *)(*(long *)(puVar40 + -0x1448) + (ulong)uVar48)) {
LAB_00109ff7:
                *(uint *)(lVar35 + 0x60) = uVar16 | 0x180;
              }
            }
            else if ((uVar34 & 0x20000) == 0 && *(int *)(puVar40 + -0x15f4) == 0) {
              if (uVar48 < 0xff) goto LAB_0010b610;
            }
            else if ((uVar48 < 0x110000) &&
                    (*(int *)(&DAT_0011002c +
                             (ulong)*(ushort *)
                                     (&_pcre2_ucd_stage2_32 +
                                     (long)(int)((uVar48 & 0x7f) +
                                                (uint)*(ushort *)
                                                       (&_pcre2_ucd_stage1_32 +
                                                       (long)((int)uVar48 >> 7) * 2) * 0x80) * 2) *
                             0xc) != 0)) goto LAB_00109ff7;
          }
        }
LAB_0010a001:
        *(undefined4 *)(puVar40 + -0x1658) = uVar18;
        *(long *)(puVar40 + -0x1678) = lVar35;
        *(undefined8 *)(puVar40 + -0x1680) = 0x10a011;
...
LAB_0010a57a:
        ...
        *(long *)(puVar40 + -0x1678) = lVar35;
        *(undefined8 *)(puVar40 + -0x1680) = 0x10a6f3;
        uVar18 = find_firstassertedcu(puVar29,*(undefined8 *)(puVar40 + -0x1610),0);
        uVar48 = *(uint *)(puVar40 + -0x150c);
        lVar35 = *(long *)(puVar40 + -0x1678);
        *(undefined4 *)(puVar40 + -0x14f8) = uVar18;
        if (uVar48 < 0xfffffffe) goto LAB_00109ee7;
        if (-1 < (int)uVar16) {
          *(long *)(puVar40 + -0x1678) = lVar35;
          *(undefined8 *)(puVar40 + -0x1680) = 0x10a745;
          ...
          uVar18 = 1;
          if (0xfffffffd < uVar17) goto LAB_0010a764;
          goto LAB_00109f81;
        }
        if (uVar17 < 0xfffffffe) {
          uVar18 = 1;
...
LAB_0010a764:
        *(long *)(puVar40 + -0x1678) = lVar35;
        *(undefined8 *)(puVar40 + -0x1680) = 0x10a770;
        iVar47 = _pcre2_study_32(lVar35);
        lVar35 = *(long *)(puVar40 + -0x1678);
        if (iVar47 != 0) goto LAB_0010a57a;
...
LAB_001097f5:
    lVar35 = 0;
LAB_00108ce4:
    **(ulong **)(puVar40 + -0x1638) = uVar25;
LAB_00108cec:
    *param_4 = uVar16;
    *(undefined8 *)(puVar40 + -0x1680) = 0x108cf8;
...
LAB_00108cf8:
  ...
  if (*(long *)(puVar40 + -0x1380) != *(long *)(puVar40 + -0x1600)) {
    ...
    *(undefined8 *)(puVar40 + -0x1680) = 0x108d1d;
  ...
  if (0x14 < *(uint *)(puVar40 + -0x1398)) {
    *(long *)(puVar40 + -0x1678) = lVar35;
    uVar20 = *(undefined8 *)(*(long *)(puVar40 + -0x1660) + 0x10);
    pcVar6 = *(code **)(*(long *)(puVar40 + -0x1660) + 8);
    *(undefined8 *)(puVar40 + -0x1680) = 0x108d43;
  ...
  if (*(long *)(puVar40 + -0x1370) != *(long *)(puVar40 + -0x1608)) {
    *(long *)(puVar40 + -0x1678) = lVar35;
    uVar20 = *(undefined8 *)(*(long *)(puVar40 + -0x1660) + 0x10);
    pcVar6 = *(code **)(*(long *)(puVar40 + -0x1660) + 8);
    *(undefined8 *)(puVar40 + -0x1680) = 0x108d6d;
    (*pcVar6)(*(long *)(puVar40 + -0x1370),uVar20);
    lVar35 = *(long *)(puVar40 + -0x1678);
  }
LAB_00108a20:
  if (*(long *)(puVar40 + 0x5ff0) != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    *(undefined8 *)(puVar40 + -0x1680) = 0x10b942;
    __stack_chk_fail();
  }
  return lVar35;
}

...
undefined8
Bezier_Up(undefined4 *param_1,int param_2,long *param_3,code *param_4,ulong param_5,ulong param_6)
...
LAB_00100733:
      ...
      if (uVar6 != param_5) {
        ...
        if (iVar11 != 1) {
          uVar12 = 1;
          bVar10 = (long)*(int *)(param_1 + 8) <=
                   (long)(((long)-*(int *)(param_1 + 4) & (uVar6 - 1) + (long)*(int *)(param_1 + 4))
                         - uVar6);
          goto LAB_00100600;
        }
LAB_00100760:
        cVar4 = Bezier_Up(param_1,2,puVar9,Split_Conic,*(undefined8 *)(param_1 + 0x68),
  ...
  if (plVar3 != (long *)0x0) {
    do {
      *plVar1 = *(long *)plVar1[2];
      plVar1[4] = plVar1[4] + -1;
      plVar1[2] = plVar1[2] +
                  (-(ulong)((*(ushort *)(plVar1 + 3) & 8) == 0) & 0xfffffffffffffff0) + 8;
      plVar2 = plVar1 + 1;
      plVar1 = (long *)*plVar2;
...
{
  *(long *)(param_1 + 0x50) =
       *(long *)(param_1 + 0x48) - (long)((int)param_2 * *(int *)(param_1 + 0xa8));
  return;
}



void Vertical_Sweep_Span(undefined4 *param_1,undefined8 param_2,ulong param_3,ulong param_4,
                        long param_5)

{
  ...
  if (((((*(ushort *)(param_5 + 0x18) & 7) != 2) &&
       ((long)((param_4 - param_3) - (long)iVar5) <= (long)(int)param_1[5])) && (param_3 != uVar11))
     && (param_4 != uVar7)) {
    uVar7 = uVar11;
  }
        ...
        *pbVar9 = *pbVar9 | bVar4;
        if (iVar5 != 1) {
          ...
          if (uVar6 < 8) {
            ...
            for (uVar7 = (ulong)(uVar6 + ((int)pbVar1 -
                                         (int)(undefined8 *)
                                              ((ulong)(pbVar9 + 9) & 0xfffffffffffffff8)) >> 3);
...
void Vertical_Sweep_Drop(undefined4 *param_1,short param_2,long param_3,ulong param_4,long param_5,
                        long param_6)
...
LAB_00100ab6:
              if (*(long *)(param_5 + 0x28) == (long)param_2) {
                if ((uVar1 & 0x20) == 0) {
                  return;
                }
                if ((long)(param_4 - param_3) < (long)(int)param_1[2]) {
        ...
        else if ((param_5 == *(long *)(param_6 + 0x38)) &&
                ((long)param_2 == *(long *)(param_5 + 0x28))) {
          if ((uVar1 & 0x20) == 0) {
            return;
          }
          if ((long)(param_4 - param_3) < (long)(int)param_1[2]) {
...
LAB_00100b61:
      ...
      if ((lVar12 < 0) || ((long)(ulong)*(ushort *)((long)param_1 + 0x42) <= lVar12))
      goto LAB_00100a04;
    }
    else {
      ...
      uVar3 = uVar13;
      uVar14 = uVar7;
      if (((long)uVar10 <= lVar11) || (uVar3 = uVar7, uVar14 = uVar13, uVar5 == uVar7))
      goto LAB_00100b61;
      lVar12 = (long)uVar7 >> (bVar6 & 0x3f);
      if ((lVar12 < 0) || ((long)uVar10 <= lVar12)) goto LAB_00100a16;
    }
    if (((uint)*(byte *)(*(long *)(param_1 + 0x14) + (lVar12 >> 3)) & 0x80 >> ((byte)lVar12 & 7)) !=
        0) {
      return;
    }
  }
...

{
  ...
  if (((param_3 == ((param_3 - 1) + (long)(int)param_1[1] & uVar1)) &&
      (param_3 = (long)param_3 >> ((byte)*param_1 & 0x3f), -1 < (long)param_3)) &&
     (param_3 < (uint)param_1[0x28])) {
    pbVar2 = (byte *)(((long)(param_2 >> 3) - param_3 * (long)(int)param_1[0x2a]) +
                     *(long *)(param_1 + 0x12));
    *pbVar2 = *pbVar2 | (byte)(0x80 >> ((byte)param_2 & 7));
    uVar1 = (ulong)(int)-param_1[1];
  }
  if ((((~uVar1 & param_4) == 0) &&
      (param_4 = (long)param_4 >> ((byte)*param_1 & 0x3f), -1 < (long)param_4)) &&
     (param_4 < (uint)param_1[0x28])) {
    pbVar2 = (byte *)(((long)(param_2 >> 3) - (long)(int)param_1[0x2a] * param_4) +
                     *(long *)(param_1 + 0x12));
    *pbVar2 = *pbVar2 | (byte)(0x80 >> ((byte)param_2 & 7));
    return;
  }
...
void Horizontal_Sweep_Drop
               (undefined4 *param_1,short param_2,long param_3,ulong param_4,long param_5,
               long param_6)
...
LAB_00100e36:
            ...
            if (uVar11 == 1) goto LAB_00100e74;
                ...
                (*(long *)(param_5 + 0x28) == (long)param_2)) {
          if ((uVar1 & 0x20) == 0) {
            return;
          }
          if ((long)(param_4 - param_3) < (long)(int)param_1[2]) {
...
LAB_00100ef9:
    ...
    if ((*(byte *)(*(long *)(param_1 + 0x12) +
                  ((long)(param_2 >> 3) - (long)(int)param_1[0x2a] * uVar4)) &
        (byte)(0x80 >> ((byte)param_2 & 7))) != 0) {
      return;
    }
  }
  else {
...
LAB_00100d78:
  if (uVar5 < uVar13) {
    pbVar6 = (byte *)(*(long *)(param_1 + 0x12) +
                     ((long)(param_2 >> 3) - (long)(int)param_1[0x2a] * uVar5));
...
undefined8
Line_Up(undefined4 *param_1,long param_2,long param_3,long param_4,long param_5,long param_6,
       long param_7)
...

{
  ...
  if (iVar3 == 1) {
    ...
    if (param_3 < (long)uVar6) {
      cVar4 = End_Profile(param_1,(long)*(int *)(param_1 + 8) <=
                                  (long)((long)(*(int *)(param_1 + 4) + -1) & uVar6));
      if (cVar4 != '\0') {
        return 1;
      }
      cVar4 = New_Profile();
...
LAB_0010142d:
    cVar4 = Line_Up(param_1,*(undefined8 *)(param_1 + 0x58),uVar6,param_2,param_3,
    ...
    if (iVar3 == 2) {
      ...
      if (lVar5 < param_3) {
        cVar4 = End_Profile(param_1,(long)*(int *)(param_1 + 8) <=
                                    ((long)-*(int *)(param_1 + 4) &
                                    lVar5 + -1 + (long)*(int *)(param_1 + 4)) - lVar5);
        if (cVar4 != '\0') {
          return 1;
        }
        cVar4 = New_Profile();
      ...
      if ((long)uVar6 < param_3) {
        cVar4 = New_Profile(param_1,1,
                            (long)*(int *)(param_1 + 8) <=
                            (long)(((long)-*(int *)(param_1 + 4) &
                                   (uVar6 - 1) + (long)*(int *)(param_1 + 4)) - uVar6));
      }
      else {
        if ((long)uVar6 <= param_3) goto LAB_00101409;
        cVar4 = New_Profile(param_1,2,
                            (long)*(int *)(param_1 + 8) <=
                            (long)(uVar6 & (long)(*(int *)(param_1 + 4) + -1)));
      }
joined_r0x001014eb:
      if (cVar4 != '\0') {
        return 1;
    ...
    cVar4 = Line_Up(param_1,*(undefined8 *)(param_1 + 0x58),-lVar5,param_2,-param_3,
...

{
  ...
  if (cVar6 == '\0') {
    uVar8 = ft_mem_realloc(uVar5,(long)*(int *)(param_2 + 0xa0),0,*(undefined4 *)(param_2 + 0x98),0,
                           &local_ac);
...
undefined8
Cubic_To(long param_1,undefined8 param_2,long param_3,undefined8 param_4,long param_5,
...
LAB_0010192e:
      if ((long)uVar11 < lVar9) goto LAB_00101a75;
      if (uVar5 != param_7) {
...
LAB_001019c9:
            ...
            uVar13 = 2;
            bVar10 = (long)*(int *)(param_1 + 8) <=
                     (long)(uVar5 & (long)(*(int *)(param_1 + 4) + -1));
LAB_0010197e:
            uVar5 = (ulong)(uint)(int)bVar10;
...
LAB_00101b20:
        ...
        if (iVar12 != 1) {
          uVar13 = 1;
          bVar10 = (long)*(int *)(param_1 + 8) <=
                   (long)(((long)-*(int *)(param_1 + 4) & (uVar5 - 1) + (long)*(int *)(param_1 + 4))
                         - uVar5);
          goto LAB_0010197e;
        }
LAB_00101af0:
        cVar3 = Bezier_Up(param_1,3,puVar8,Split_Cubic,*(undefined8 *)(param_1 + 0x68),
                          *(undefined8 *)(param_1 + 0x70));
...
int Render_Single_Pass_constprop_0(undefined4 *param_1,char param_2,int param_3)
...
joined_r0x0010215a:
              ...
              if (param_2 == '\0') {
                ...
                if (plVar20 < plVar5) {
LAB_00102798:
                  cVar3 = Cubic_To(param_1,lVar32,lVar33,lVar30,lVar34,lVar23,lVar28);
joined_r0x001020fa:
...
joined_r0x001020fa:
        ...
        if ((((uVar6 == 0) && (*(long *)(param_1 + 0x1a) <= (long)uVar7)) &&
            ((long)uVar7 <= *(long *)(param_1 + 0x1c))) &&
           ((*(long *)(param_1 + 0x24) != 0 &&
            (((*(ushort *)(*(long *)(param_1 + 0x24) + 0x18) ^ *(ushort *)(lVar12 + 0x18)) & 8) == 0
            )))) {
          lVar28 = lVar28 + -8;
      ...
      do {
        ...
        *(long *)(lVar40 + 8) = lVar12;
        ...
        if ((cVar3 != '\0') || (cVar3 = Insert_Y_Turn(), cVar3 != '\0')) goto LAB_00101d97;
        uVar35 = uVar35 - 1;
        lVar40 = lVar12;
      } while (uVar35 != 0);
      if (*(ulong *)(param_1 + 0xc) < *(ulong *)(param_1 + 10)) {
        ...
        do {
          ...
          *puVar24 = 0;
          ...
          ppuVar14 = &local_e0;
          for (puVar8 = local_e0; (puVar8 != (ulong *)0x0 && ((long)*puVar8 < 1));
...
LAB_001023ad:
                  ...
                  if ((puVar21[3] & 8) == 0) {
                    ...
                    for (; (puVar8 != (ulong *)0x0 && ((long)*puVar8 <= (long)*puVar21));
                        puVar8 = (ulong *)puVar8[1]) {
                      ppuVar14 = (ulong **)(puVar8 + 1);
                    }
                  }
              ...
              if ((short)uVar37 < (short)uVar35) {
                ...
                do {
                  ...
                  if ((local_d8 != (ulong *)0x0) &&
                     (sVar17 = 0, puVar36 = local_d0, puVar8 = local_d8, local_d0 != (ulong *)0x0))
                  {
                    do {
                      uVar7 = *puVar8;
                      uVar6 = *puVar36;
...
LAB_00102490:
                        (**(code **)(param_1 + 0x3e))(param_1,iVar38);
LAB_001024a2:
                        puVar8 = (ulong *)puVar8[1];
                        ...
                        uVar7 = uVar7 & uVar6;
                        if (((uVar6 == uVar7) || (uVar13 == uVar9)) ||
                           (((long)uVar7 <= (long)uVar9 && (uVar9 != uVar7 + lVar40))))
                        goto LAB_00102490;
                      ...
                      do {
                        if ((int)puVar36[6] != 0) {
                          ...
                          *(undefined4 *)(puVar36 + 6) = 0;
                          (**(code **)(param_1 + 0x40))
                                    (param_1,iVar38,*puVar36,uVar7,puVar36,puVar8);
                        }
                        puVar10 = puVar8 + 1;
                      } while (((ulong *)puVar36[1] != (ulong *)0x0) &&
                              (puVar8 = (ulong *)*puVar10, puVar36 = (ulong *)puVar36[1],
                              (ulong *)*puVar10 != (ulong *)0x0));
                    }
                  }
...
undefined8 ft_black_render(long param_1,undefined8 *param_2)
  ...
  if (psVar1 != (short *)0x0) {
    ...
    if ((*(long *)(psVar1 + 0xc) != 0) && (*(long *)(psVar1 + 4) != 0)) {
      ...
      if (((int)psVar1[1] != *(short *)(*(long *)(psVar1 + 0xc) + -2 + (long)*psVar1 * 2) + 1) ||
         (uVar7 = 0x13, (*(byte *)(param_2 + 2) & 3) != 0)) goto LAB_00102a8a;
      if (piVar2 == (int *)0x0) {
LAB_00102ad0:
        uVar7 = 6;
      }
        ...
        if ((piVar2[1] != 0) && (*piVar2 != 0)) {
          ...
          *(code **)(puVar9 + -0x1018) = Vertical_Sweep_Step;
          if (0 < *(int *)(puVar9 + -0x1078)) {
            *(ulong *)(puVar9 + -0x10d8) =
                 *(long *)(puVar9 + -0x1070) +
                 (long)*(int *)(puVar9 + -0x1078) * (ulong)(*(int *)(puVar9 + -0x1080) - 1U);
          }
          *(undefined8 *)(puVar9 + -0x1128) = 0x102a13;
          ...
          if ((puVar9[-0x1037] & 2) == 0) {
            ...
            *(undefined8 *)(puVar9 + -0x1128) = 0x102a80;
            uVar7 = Render_Single_Pass_constprop_0
                              (puVar9 + -0x1120,1,*(int *)(puVar9 + -0x107c) + -1);
            goto LAB_00102a8a;
          }
        }
LAB_00102a88:

...
void HistogramCombineEntropyBin
               (float param_1,int *param_2,int *param_3,long param_4,long param_5,long param_6,
...

{
  ...
  if (0 < iVar5) {
    do {
      *(short *)(param_5 + lVar8 * 2) = (short)lVar8;
      lVar8 = lVar8 + 1;
    } while (iVar5 != lVar8);
  }
  uVar9 = 0;
  ...
  if (0 < *param_2) {
    do {
      while( true ) {
        lVar8 = *(long *)(lVar3 + uVar9 * 8);
        if (lVar8 == 0) goto LAB_00100b5d;
        uVar11 = (ulong)*(ushort *)(param_7 + uVar9 * 2);
        ...
        if (param_9 == 0) {
          local_14c = 0.0;
          fVar12 = *(float *)(lVar8 + 0xcb0) + *(float *)(lVar4 + 0xcb0);
          fVar13 = (float)((uint)*(float *)(lVar8 + 0xcb0) ^ __LC17) * param_1;
          iVar5 = GetCombinedHistogramEntropy(fVar13 + fVar12,lVar4,lVar8,&local_14c);
          if (iVar5 != 0) {
            VP8LHistogramAdd(lVar4,lVar8,local_198);
            iVar5 = *(int *)(lVar8 + 0xcac);
          ...
          if (local_14c - fVar12 < fVar13) {
            if (*(int *)(local_198 + 0xcac) == -1) {
              if ((*(int *)(*(long *)(lVar3 + uVar9 * 8) + 0xcac) != -1) ||
                 (lVar8 = *plVar1, *(int *)(lVar8 + 0xcac) != -1)) {
...
LAB_00100cc0:
            ...
            *plVar1 = local_198;
            HistogramSetRemoveHistogram(param_2,(int)uVar9,param_3);
            *(undefined2 *)(param_5 + (ulong)*(ushort *)(param_4 + uVar9 * 2) * 2) =
                 *(undefined2 *)(param_4 + lVar10 * 2);
            local_198 = lVar8;
          }
        }
        else {
          VP8LHistogramAdd(lVar8,lVar4,lVar4);
          iVar5 = *(int *)(lVar4 + 0xcac);
          if (*(int *)(lVar8 + 0xcac) != iVar5) {
            iVar5 = -1;
          }
          *(int *)(lVar4 + 0xcac) = iVar5;
          HistogramSetRemoveHistogram(param_2,uVar9 & 0xffffffff,param_3);
          *(undefined2 *)(param_5 + (ulong)*(ushort *)(param_4 + uVar9 * 2) * 2) =
               *(undefined2 *)(param_4 + lVar10 * 2);
        }
LAB_00100b5d:
        iVar5 = *param_2;
        uVar9 = uVar9 + 1;
        if (iVar5 <= (int)uVar9) goto LAB_00100b9e;
      }
      iVar5 = *param_2;
      local_148[uVar11 * 2] = (ushort)uVar9;
      uVar9 = uVar9 + 1;
...

{
  ...
  local_5c = local_c0;
  if (lVar11 == 0 || __s == (void *)0x0) goto LAB_00101a9b;
  iVar39 = 0;
  iVar36 = 0;
  ...
  if ((iVar23 * 2 < (int)local_c0) && (param_4 < 100)) {
    ...
    local_e0 = *(long **)(param_8 + 2);
    local_c0 = local_5c;
    if (param_5 == 0) goto LAB_00101750;
  }
  else {
LAB_00101750:
...
LAB_00101cef:
                  uVar34 = (ulong)uVar38;
                  uVar40 = (ulong)iVar39;
                  if (iVar27 != 0) goto LAB_00101cff;
                }
              }
              else {
                uVar24 = (uint)(uVar40 >> 0x1f);
                iVar27 = (int)local_50;
                if (1 < iVar39) goto LAB_00101c05;
LAB_00101cff:
                piVar14 = local_58;
                iVar36 = *local_58;
                iVar39 = local_58[1];
                ...
                while (uVar30 = uVar16, uVar25 < uVar30) {
                  while( true ) {
                    ...
                    uVar25 = uVar16 + 1;
                    if (uVar30 <= uVar25) goto LAB_00101d38;
                  }
                }
LAB_00101d38:
                __src_00 = (int *)0x4;
...
LAB_00101e48:
                      ...
                      iVar27 = (int)local_50;
LAB_00101e7c:
                      if (iVar27 <= iVar42) goto LAB_00101f72;
                    }
                    if (iVar36 == iVar37 || iVar39 == iVar37) {
                      lVar15 = (long)iVar27;
                      iVar27 = iVar27 + -1;
...
LAB_00101ee0:
                    ...
                    *(float *)(*pauVar28 + 8) = fVar45;
                    if (fVar45 < 0.0) goto LAB_00101e48;
                    lVar15 = (long)iVar27;
                    iVar27 = iVar27 + -1;
...
LAB_00101f72:
              ...
              local_a0 = local_a0 + 1;
              if (local_a0 == local_c0) goto LAB_001020b3;
...
LAB_001020c6:
          WebPSafeFree(local_58);
          WebPSafeFree(lVar33);
          if ((int)local_c0 <= iVar23) goto LAB_00101fb6;
          goto LAB_001020e5;
        }
        WebPSafeFree(0);
        WebPSafeFree(lVar33);
...
LAB_0010178e:
    ...
    if (iVar23 < 1) {
      ...
      *param_8 = 0;
      ...
      local_58 = piVar14;
      if (piVar14 == (int *)0x0) goto LAB_00101a94;
    }
    else {
      plVar13 = local_e0;
      uVar34 = 0;
...
LAB_00101a94:
      ...
      if (0 < iVar23) {
        ...
        iVar36 = 1;
        if (*plVar13 == 0) goto LAB_001018a2;
...
LAB_001018a2:
            lVar21 = lVar33;
            if (iVar23 == iVar36) goto LAB_001018ab;
          }
        }
LAB_001018ab:
        piVar14 = local_58;
            ...
            *(int *)(local_e0[iVar36] + 0xcb0) = piVar14[3];
            ...
            do {
              while( true ) {
                ...
                iVar27 = iVar27 + 1;
                bVar35 = bVar8;
                if (iVar23 <= iVar27) goto LAB_001019d4;
              }
              lVar33 = (long)iVar23;
              iVar23 = iVar23 + -1;
              bVar8 = true;
      ...
      if (lVar33 != 0) {
        ...
        do {
          ...
          if (uVar40 == 0) {
            ...
            uVar40 = uVar40 + 1;
            if (uVar40 == local_98) goto LAB_00102210;
          }
          lVar33 = *plVar17;
        } while( true );
      }
...
LAB_00102217:
  ...
  puVar18[1] = uVar22;
  puVar18 = puVar18 + 1;
  if (plVar17 == plVar13 + (int)uVar24) goto LAB_0010223a;
  goto LAB_00102178;
}

...
/* FreeDesktopPortalDesktop::try_parse_variant(DBusMessage*, int, void*) */

undefined8
FreeDesktopPortalDesktop::try_parse_variant(DBusMessage *param_1,int param_2,void *param_3)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* FreeDesktopPortalDesktop::append_dbus_string(DBusMessageIter*, String const&) */

void FreeDesktopPortalDesktop::append_dbus_string(DBusMessageIter *param_1,String *param_2)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* FreeDesktopPortalDesktop::append_dbus_dict_string(DBusMessageIter*, String const&, String const&,
   bool) */

void FreeDesktopPortalDesktop::append_dbus_dict_string
               (DBusMessageIter *param_1,String *param_2,String *param_3,bool param_4)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* FreeDesktopPortalDesktop::append_dbus_dict_bool(DBusMessageIter*, String const&, bool) */

void FreeDesktopPortalDesktop::append_dbus_dict_bool
               (DBusMessageIter *param_1,String *param_2,bool param_3)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* FreeDesktopPortalDesktop::read_setting(char const*, char const*, int, void*) */

undefined4 __thiscall
FreeDesktopPortalDesktop::read_setting
          (FreeDesktopPortalDesktop *this,char *param_1,char *param_2,int param_3,void *param_4)
  ...
  if (this[0x171] == (FreeDesktopPortalDesktop)0x0) {
    ...
    if (iVar5 != 0) {
      ...
      if (cVar4 != '\0') {
        ...
        _err_print_error("read_setting","platform/linuxbsd/freedesktop_portal_desktop.cpp",0x59,
                         (String *)&local_78,0,0);
        pcVar3 = local_78;
    ...
    uVar8 = (*_dbus_message_new_method_call_dylibloader_wrapper_dbus)
                      ("org.freedesktop.portal.Desktop","/org/freedesktop/portal/desktop",
                       "org.freedesktop.portal.Settings",&_LC23);
    (*_dbus_message_append_args_dylibloader_wrapper_dbus)(uVar8,0x73,local_90,0x73,&local_98,0);
    pDVar9 = (DBusMessage *)
             (*_dbus_connection_send_with_reply_and_block_dylibloader_wrapper_dbus)
                       (uVar7,uVar8,0x32,local_68);
    ...
    if (cVar4 != '\0') {
      ...
      String::parse_latin1((StrRange *)&local_80);
      vformat<char_const*>((String *)&local_78,(char *)&local_80);
      _err_print_error("read_setting","platform/linuxbsd/freedesktop_portal_desktop.cpp",0x6d,
                       (String *)&local_78,0,0);
      pcVar3 = local_78;
      if (local_78 != (char *)0x0) {
        LOCK();
...
/* FreeDesktopPortalDesktop::get_appearance_color_scheme() */

undefined4 __thiscall
FreeDesktopPortalDesktop::get_appearance_color_scheme(FreeDesktopPortalDesktop *this)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* FreeDesktopPortalDesktop::append_dbus_dict_filters(DBusMessageIter*, Vector<String> const&,
   Vector<String> const&, Vector<String> const&) */

void FreeDesktopPortalDesktop::append_dbus_dict_filters
               (DBusMessageIter *param_1,Vector *param_2,Vector *param_3,Vector *param_4)
...
LAB_00100860:
    ...
    if (lVar10 != lVar16) {
      _err_print_error("append_dbus_dict_filters","platform/linuxbsd/freedesktop_portal_desktop.cpp"
                       ,0xca,"Condition \"p_filter_names.size() != p_filter_exts.size()\" is true.",
                       0,0);
      goto LAB_00100fa3;
    }
    lVar10 = *(long *)(param_4 + 8);
...
LAB_0010087f:
    ...
    if (lVar16 != lVar10) {
      _err_print_error("append_dbus_dict_filters","platform/linuxbsd/freedesktop_portal_desktop.cpp"
                       ,0xcb,"Condition \"p_filter_names.size() != p_filter_mimes.size()\" is true."
                       ,0,0);
      goto LAB_00100fa3;
    }
  }
  ...
  (*_dbus_message_iter_open_container_dylibloader_wrapper_dbus)
            (local_218,0x76,"a(sa(us))",local_1c8);
...
LAB_00100ac5:
    iVar8 = String::get_slice_count((char *)&local_230);
    if (0 < iVar8) {
      iVar7 = 0;
      do {
        while( true ) {
          (*_dbus_message_iter_open_container_dylibloader_wrapper_dbus)
                    (local_d8,0x72,0,(DBusMessageIter *)&local_88);
          ...
          (*_dbus_message_iter_append_basic_dylibloader_wrapper_dbus)
                    ((DBusMessageIter *)&local_88,0x75,&local_220);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* FreeDesktopPortalDesktop::_is_interface_supported(char const*) */

undefined8 __thiscall
FreeDesktopPortalDesktop::_is_interface_supported(FreeDesktopPortalDesktop *this,char *param_1)

{
  ...
  uVar9 = 0;
  lVar7 = (*_dbus_message_new_method_call_dylibloader_wrapper_dbus)
                    ("org.freedesktop.portal.Desktop","/org/freedesktop/portal/desktop",
                     "org.freedesktop.DBus.Properties",&_LC44);
  if (lVar7 != 0) {
    local_140 = "version";
    local_148 = param_1;
    (*_dbus_message_append_args_dylibloader_wrapper_dbus)(lVar7,0x73,&local_148,0x73,&local_140,0);
    lVar8 = (*_dbus_connection_send_with_reply_and_block_dylibloader_wrapper_dbus)
                      (uVar6,lVar7,0xfa,local_118);
    iVar5 = (*_dbus_error_is_set_dylibloader_wrapper_dbus)(local_118);
    if (iVar5 == 0) {
...
/* FreeDesktopPortalDesktop::is_file_chooser_supported() */

ulong __thiscall FreeDesktopPortalDesktop::is_file_chooser_supported(FreeDesktopPortalDesktop *this)

{
  ulong uVar1;
  
  if (is_file_chooser_supported()::supported != -1) {
    return (ulong)CONCAT31((int3)(is_file_chooser_supported()::supported >> 8),
                           is_file_chooser_supported()::supported != 0);
  }
  uVar1 = _is_interface_supported(this,"org.freedesktop.portal.FileChooser");
  is_file_chooser_supported()::supported = (uint)uVar1 & 0xff;
  return uVar1;
}



/* FreeDesktopPortalDesktop::is_settings_supported() */

ulong __thiscall FreeDesktopPortalDesktop::is_settings_supported(FreeDesktopPortalDesktop *this)

{
  ulong uVar1;
  
  if (is_settings_supported()::supported != -1) {
    return (ulong)CONCAT31((int3)(is_settings_supported()::supported >> 8),
                           is_settings_supported()::supported != 0);
  }
  uVar1 = _is_interface_supported(this,"org.freedesktop.portal.Settings");
  is_settings_supported()::supported = (uint)uVar1 & 0xff;
  return uVar1;
}



/* FreeDesktopPortalDesktop::_system_theme_changed_callback() */

void __thiscall
FreeDesktopPortalDesktop::_system_theme_changed_callback(FreeDesktopPortalDesktop *this)
  ...
  if (cVar4 != '\0') {
    ...
    if (local_68 != 0) {
      Variant::get_callable_error_text
                ((Callable *)&local_78,(Variant **)(this + 0x1e0),0,(CallError *)0x0);
      local_58 = "Failed to execute system theme changed callback: %s.";
      local_70 = 0;
      local_50 = 0x34;
      String::parse_latin1((StrRange *)&local_70);
      vformat<String>(&local_58,(StrRange *)&local_70,&local_78);
      _err_print_error("_system_theme_changed_callback",
                       "platform/linuxbsd/freedesktop_portal_desktop.cpp",700,&local_58,0,0);
      pcVar3 = local_58;
...
void __thiscall
FreeDesktopPortalDesktop::process_file_dialog_callbacks(FreeDesktopPortalDesktop *this)
  ...
  if (puVar6 != (undefined8 *)0x0) {
    do {
      ...
      if ((puVar6 != (undefined8 *)0x0) && (pCVar2 = (Callable *)*puVar6, pCVar2 != (Callable *)0x0)
        ...
        if (puVar6 == *(undefined8 **)(pCVar2 + 0x88)) {
          *puVar6 = *(undefined8 *)(pCVar2 + 0x78);
          ...
          if (Variant::needs_deinit[*(int *)(pCVar2 + 0x58)] != '\0') {
            Variant::_clear_internal();
          }
          if (Variant::needs_deinit[*(int *)(pCVar2 + 0x40)] != '\0') {
            Variant::_clear_internal();
          }
          if (Variant::needs_deinit[*(int *)(pCVar2 + 0x28)] != '\0') {
            Variant::_clear_internal();
          }
      ...
      if (local_48 == (Callable)0x0) {
        ...
        if (local_118 != 0) {
          Variant::get_callable_error_text
                    ((Callable *)&local_128,(Variant **)local_b8,(int)&local_d8,(CallError *)0x3);
        ...
        if (local_118 != 0) {
          Variant::get_callable_error_text
                    ((Callable *)&local_128,(Variant **)local_b8,(int)&local_d8,(CallError *)0x4);
          local_108 = "Failed to execute file dialog callback: %s.";
          local_120 = 0;
          local_100 = 0x2b;
          String::parse_latin1((StrRange *)&local_120);
          ...
          uVar7 = 0x260;
LAB_001019f5:
          _err_print_error("process_file_dialog_callbacks",
                           "platform/linuxbsd/freedesktop_portal_desktop.cpp",uVar7,&local_108);
          pcVar4 = local_108;
...
void __thiscall FreeDesktopPortalDesktop::FreeDesktopPortalDesktop(FreeDesktopPortalDesktop *this)
...
LAB_00101cae:
  ...
  *(undefined8 *)(this + 0x1d0) = uVar8;
  ...
  if (iVar7 == 0) {
    local_80 = 0x79;
    local_88 = 
    "type=\'signal\',sender=\'org.freedesktop.portal.Desktop\',interface=\'org.freedesktop.portal.Settings\',member=\'SettingChanged\'"
    ;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* FreeDesktopPortalDesktop::file_chooser_parse_response(DBusMessageIter*, Vector<String> const&,
...
undefined8
FreeDesktopPortalDesktop::file_chooser_parse_response
          (DBusMessageIter *param_1,Vector *param_2,HashMap *param_3,bool *param_4,Vector *param_5,
          int *param_6,Dictionary *param_7)

{
  ...
  if (iVar21 != 0x75) {
    _err_print_error("file_chooser_parse_response",
                     "platform/linuxbsd/freedesktop_portal_desktop.cpp",299,
                     "Condition \"dbus_message_iter_get_arg_type_dylibloader_wrapper_dbus(p_iter) != ((int) \'u\')\" is true. Returning: false"
                     ,0,0);
    uVar23 = 0;
    goto LAB_0010250a;
  }
  ...
  if (local_234 == 0) {
    *param_4 = false;
    ...
    if (iVar21 == 0) {
      _err_print_error("file_chooser_parse_response",
                       "platform/linuxbsd/freedesktop_portal_desktop.cpp",0x133,
                       "Condition \"!dbus_message_iter_next_dylibloader_wrapper_dbus(p_iter)\" is true. Returning: false"
                       ,0,0);
      uVar23 = 0;
      goto LAB_0010250a;
    }
    ...
    if (iVar21 != 0x61) {
      _err_print_error("file_chooser_parse_response",
                       "platform/linuxbsd/freedesktop_portal_desktop.cpp",0x134,
                       "Condition \"dbus_message_iter_get_arg_type_dylibloader_wrapper_dbus(p_iter) != ((int) \'a\')\" is true. Returning: false"
                       ,0,0);
      uVar23 = 0;
      goto LAB_0010250a;
    }
...
LAB_00102590:
              iVar21 = (*_dbus_message_iter_get_arg_type_dylibloader_wrapper_dbus)(local_118);
              if (iVar21 == 0x72) {
                    ...
                    do {
                      if (uVar22 == uVar27) {
                        cVar20 = String::operator==((String *)
                                                    (*(long *)(*(long *)(param_3 + 8) + lVar30 * 8)
                                                    + 0x10),(String *)&local_220);
                        if (cVar20 != '\0') {
                          if ((*(long *)(param_3 + 8) == 0) || (*(int *)(param_3 + 0x2c) == 0))
                          goto LAB_00102a80;
                      ...
                      iVar21 = SUB164(auVar4 * auVar12,8);
                            ...
                            (auVar5._8_8_ = 0, auVar5._0_8_ = (ulong)uVar22 * lVar25,
                            auVar13._8_8_ = 0, auVar13._0_8_ = uVar31, auVar6._8_8_ = 0,
                            auVar6._0_8_ = (ulong)((uVar2 + iVar21) - SUB164(auVar5 * auVar13,8)) *
                                           lVar25, auVar14._8_8_ = 0, auVar14._0_8_ = uVar31,
        ...
        if (iVar21 == 0x72) {
          (*_dbus_message_iter_recurse_dylibloader_wrapper_dbus)(local_168,local_c8);
          while (iVar21 = (*_dbus_message_iter_get_arg_type_dylibloader_wrapper_dbus)(local_c8),
                iVar21 == 0x73) {
            ...
            if ((lVar25 != 0) && (lVar26 = *(long *)(lVar25 + -8), lVar26 != 0)) {
              lVar30 = 0;
              while (lVar30 < lVar26) {
...
LAB_00102360:
      iVar21 = (*_dbus_message_iter_next_dylibloader_wrapper_dbus)(local_208);
    } while (iVar21 != 0);
  }
  else {
    *param_4 = true;
...
LAB_00102a4f:
  if (uVar22 == uVar27) {
    cVar20 = String::operator==((String *)(*(long *)(*(long *)(param_3 + 8) + lVar30 * 8) + 0x10),
                                (String *)&local_220);
  ...
  if ((uVar22 == 0) ||
     ...
     auVar10._0_8_ = (ulong)((uVar2 + uVar28) - SUB164(auVar9 * auVar17,8)) * lVar25,
     auVar18._8_8_ = 0, auVar18._0_8_ = uVar31, SUB164(auVar10 * auVar18,8) < uVar29)) {
LAB_00102a80:
  ...
  goto LAB_00102a4f;
LAB_00102aac:
  lVar25 = *(long *)(*(long *)(param_3 + 8) + (ulong)uVar28 * 8);
...
LAB_00102903:
  iVar21 = (*_dbus_message_iter_next_dylibloader_wrapper_dbus)(local_118);
  lVar25 = local_210;
  if (iVar21 == 0) {
    if (local_210 != 0) {
      LOCK();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* FreeDesktopPortalDesktop::append_dbus_dict_options(DBusMessageIter*, TypedArray<Dictionary>
...
void FreeDesktopPortalDesktop::append_dbus_dict_options
               (DBusMessageIter *param_1,TypedArray *param_2,HashMap *param_3)

{
  ...
  (*_dbus_message_iter_open_container_dylibloader_wrapper_dbus)
            (local_278,0x76,"a(ssa(ss)s)",local_228);
  (*_dbus_message_iter_open_container_dylibloader_wrapper_dbus)
            (local_228,0x61,"(ss(ss)s)",local_1d8);
  if ((*(long *)(param_3 + 8) != 0) && (*(int *)(param_3 + 0x2c) != 0)) {
    lVar11 = 0;
    uVar2 = *(uint *)(hash_table_size_primes + (ulong)*(uint *)(param_3 + 0x28) * 4);
    if (uVar2 != 0) {
  ...
  do {
    ...
    if (bVar6 == 0) {
      ...
      if (bVar6 == 0) {
        ...
        itos((long)local_138);
        operator+((char *)local_e8,(String *)"option_");
        ...
        (*_dbus_message_iter_open_container_dylibloader_wrapper_dbus)
                  (local_188,0x61,&_LC94,local_138);
        for (lVar11 = 0; (local_290 != 0 && (lVar11 < *(long *)(local_290 + -8)));
            lVar11 = lVar11 + 1) {
          (*_dbus_message_iter_open_container_dylibloader_wrapper_dbus)
                    (local_138,0x72,0,(DBusMessageIter *)local_e8);
          itos((long)&local_288);
...
LAB_001033a6:
            _err_print_index_error
                      ("get","./core/templates/cowdata.h",0xdb,lVar11,lVar9,"p_index","size()","",
                       false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
            pcVar4 = (code *)invalidInstructionException();
          ...
          (*_dbus_message_iter_close_container_dylibloader_wrapper_dbus)
                    (local_138,(DBusMessageIter *)local_e8);
        }
...
/* CowData<FreeDesktopPortalDesktop::FileDialogData>::_copy_on_write() [clone .isra.0] */

void __thiscall
CowData<FreeDesktopPortalDesktop::FileDialogData>::_copy_on_write
...
LAB_001038d0:
        if ((*(int *)(this_00 + lVar5 + 0x3c) != 0) &&
           (plVar9 = *(long **)(this_00 + lVar5 + 0x28), plVar9 != (long *)0x0)) {
          do {
            HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>
            ::insert(local_48,(String *)(pCVar4 + 0x20),(bool)((char)plVar9 + '\x10'));
            plVar9 = (long *)*plVar9;
    ...
    do {
      ...
      if (*(undefined8 **)(this_01 + 0x88) == puVar7) {
        *puVar7 = *(undefined8 *)(this_01 + 0x78);
        ...
        if (Variant::needs_deinit[*(int *)(this_01 + 0x58)] != '\0') {
          Variant::_clear_internal();
        }
        if (Variant::needs_deinit[*(int *)(this_01 + 0x40)] != '\0') {
          Variant::_clear_internal();
        }
        if (Variant::needs_deinit[*(int *)(this_01 + 0x28)] != '\0') {
          Variant::_clear_internal();
        }
        if (Variant::needs_deinit[*(int *)(this_01 + 0x10)] != '\0') {
          Variant::_clear_internal();
        }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* FreeDesktopPortalDesktop::_thread_monitor(void*) */

void FreeDesktopPortalDesktop::_thread_monitor(void *param_1)
  ...
  *this_01;
  ...
  do {
    ...
    if (*(long *)((long)param_1 + 0x1d0) != 0) {
      ...
      while (lVar8 != 0) {
        iVar5 = (*_dbus_message_is_signal_dylibloader_wrapper_dbus)
                          (lVar8,"org.freedesktop.portal.Settings","SettingChanged");
        if (iVar5 == 0) {
          iVar5 = (*_dbus_message_is_signal_dylibloader_wrapper_dbus)
                            (lVar8,"org.freedesktop.portal.Request","Response");
          if (iVar5 != 0) {
            ...
            if (iVar5 != 0) {
              ...
              local_16c = 0;
              file_chooser_parse_response
                        (local_128,pVVar16,(HashMap *)(pVVar16 + 0x10),&local_16d,
                         (Vector *)&local_158,&local_16c,(Dictionary *)&local_160);
              cVar4 = Callable::is_valid();
              if (cVar4 != '\0') {
                local_b8 = 0;
...
LAB_00104b9e:
              _err_print_index_error
                        ("remove_at","./core/templates/cowdata.h",0xe4,lVar14,lVar17,"p_index",
                         "size()","",false,false);
            }
            else {
              ...
              if (lVar17 == 0) {
                ...
                if (lVar14 < lVar18) {
                  this_01 = (HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>
                             *)(lVar17 + 0x10 + lVar14 * 0x70);
                  do {
                    ...
                    if (uVar6 < *(uint *)(hash_table_size_primes +
                                         (ulong)*(uint *)(this_01 + 0x98) * 4)) {
                      if (uVar15 != 0x1c) {
                        uVar10 = (ulong)uVar15;
                        do {
                          uVar6 = (int)uVar10 + 1;
                            ...
                            if (uVar15 != uVar6) {
                              if (*(long *)(this_01 + 8) == 0) {
                                *(uint *)(this_01 + 0x28) = uVar6;
                                ...
                                HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>
                                ::_resize_and_rehash(this_01,uVar6);
                              }
                            }
                            goto LAB_001043e2;
                          }
...
LAB_001043e2:
                    if (*(long *)(this_01 + 0x78) != 0) {
                      for (puVar1 = *(undefined8 **)(this_01 + 0x88); puVar1 != (undefined8 *)0x0;
                          puVar1 = (undefined8 *)*puVar1) {
                        HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>
                        ::insert((String *)&local_158,(String *)this_01,
                                 (bool)((char)puVar1 + '\x10'));
                      }
                    }
...
LAB_001040c3:
            pthread_mutex_unlock((pthread_mutex_t *)((long)param_1 + 0x180));
            lVar17 = local_168;
            if (local_168 != 0) {
              LOCK();
          ...
          if (iVar5 != 0) {
            ...
            if ((cVar4 != '\0') &&
               (cVar4 = String::operator==((String *)&local_158,"color-scheme"), cVar4 != '\0')) {
              pCVar11 = (CallableCustom *)operator_new(0x48,"");
              CallableCustom::CallableCustom(pCVar11);
              *(undefined8 *)(pCVar11 + 0x40) = 0;
        ...
        (*_dbus_message_unref_dylibloader_wrapper_dbus)(lVar8);
        lVar8 = (*_dbus_connection_pop_message_dylibloader_wrapper_dbus)
                          (*(undefined8 *)((long)param_1 + 0x1d0));
      }
      (*_dbus_connection_read_write_dylibloader_wrapper_dbus)
                (*(undefined8 *)((long)param_1 + 0x1d0),0);
    }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* FreeDesktopPortalDesktop::file_dialog_show(int, String const&, String const&, String const&,
   String const&, String const&, DisplayServer::FileDialogMode, Vector<String> const&,
   TypedArray<Dictionary> const&, Callable const&, bool) */

int __thiscall
FreeDesktopPortalDesktop::file_dialog_show
          (FreeDesktopPortalDesktop *this,undefined4 param_1,String *param_2,String *param_3,
          String *param_4,undefined8 param_6_00,String *param_6,uint param_8,long param_9,
          TypedArray *param_10,Callable *param_11,undefined1 param_12)
...
LAB_00105117:
                if (1 < *(uint *)(local_238 + -8)) goto LAB_001051f8;
...
LAB_001051f8:
                  if ((local_160 != 0) && (1 < *(long *)(local_160 + -8))) {
                    ...
                    if (cVar6 == '\0') {
                      ...
                      if (local_238 == 0) {
                        ...
                        CowData<char32_t>::_ref
                                  ((CowData<char32_t> *)&local_f8,(CowData *)&local_238);
                        pcVar11 = local_f8;
                        Vector<String>::push_back(local_218);
                        if (pcVar11 != (char *)0x0) {
                          LOCK();
                    ...
                    if (local_160 == 0) {
                      ...
                      if (1 < lVar9) {
                        ...
                        if (*(long *)(local_160 + 8) != 0) {
                          CowData<char32_t>::_ref
                                    ((CowData<char32_t> *)&local_f8,(CowData *)(local_160 + 8));
                          pcVar11 = local_f8;
                          Vector<String>::push_back(local_228);
...
LAB_00106736:
                    _err_print_index_error
                              ("get","./core/templates/cowdata.h",0xdb,lVar12,lVar9,"p_index",
                               "size()","",false,true);
                    _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_00105330:
                  if (local_230 != 0) goto LAB_00105138;
                }
                if (local_238 == 0) goto LAB_00105198;
              }
              lVar9 = local_238;
...
LAB_00105198:
        ...
        if (iVar7 == 0) {
          ...
          if (iVar7 == 0) {
            iVar7 = (*_dbus_bus_get_unique_name_dylibloader_wrapper_dbus)
...
LAB_0010564c:
            String::replace((char *)&local_238,(char *)&local_250);
            ...
            vformat<String,String>
                      ((CowData *)&local_240,(StrRange *)&local_1e8,(StrRange *)&local_230,
                       (DBusMessageIter *)&local_1b8);
            pcVar11 = local_1e8;
            if (local_1e8 != (char *)0x0) {
              LOCK();
...
LAB_00105871:
            local_230 = 0;
            local_f8 = 
            "type=\'signal\',sender=\'org.freedesktop.portal.Desktop\',path=\'%s\',interface=\'org.freedesktop.portal.Request\',member=\'Response\',destination=\'%s\'"
            ;
            local_f0 = 0x8d;
            String::parse_latin1((StrRange *)&local_230);
            vformat<String,String>
                      ((DBusMessageIter *)&local_f8,(StrRange *)&local_230,(StrRange *)&local_1e8,
                       (DBusMessageIter *)&local_1b8);
            ...
            if (iVar7 != 0) {
              ...
              _err_print_error("file_dialog_show","platform/linuxbsd/freedesktop_portal_desktop.cpp"
                               ,0x202,(DBusMessageIter *)&local_f8,0,0);
              pcVar11 = local_f8;
              if (local_f8 != (char *)0x0) {
                LOCK();
                plVar14 = (long *)(local_f8 + -0x10);
            ...
            uVar8 = (*_dbus_message_new_method_call_dylibloader_wrapper_dbus)
                              ("org.freedesktop.portal.Desktop","/org/freedesktop/portal/desktop",
                               "org.freedesktop.portal.FileChooser",pcVar11);
            (*_dbus_message_iter_init_append_dylibloader_wrapper_dbus)
                      (uVar8,(DBusMessageIter *)&local_1b8);
            append_dbus_string((DBusMessageIter *)&local_1b8,param_2);
            append_dbus_string((DBusMessageIter *)&local_1b8,param_3);
            (*_dbus_message_iter_open_container_dylibloader_wrapper_dbus)
                      ((DBusMessageIter *)&local_1b8,0x61,&_LC127);
            local_1e8 = "handle_token";
            local_230 = 0;
            local_1e0 = 0xc;
            String::parse_latin1((StrRange *)&local_230);
            append_dbus_dict_string
                      ((DBusMessageIter *)&local_f8,(String *)&local_230,(String *)&local_248,false)
            ;
            lVar9 = local_230;
            if (local_230 != 0) {
              LOCK();
            ...
            append_dbus_dict_filters
                      ((DBusMessageIter *)&local_f8,(Vector *)local_228,(Vector *)local_218,
                       (Vector *)local_208);
            ...
            if (param_8 == 4) {
              ...
              String::parse_latin1((StrRange *)&local_230);
              append_dbus_dict_string
                        ((DBusMessageIter *)&local_f8,(String *)&local_230,param_6,false);
              lVar9 = local_230;
              if (local_230 != 0) {
                LOCK();
                plVar14 = (long *)(local_230 + -0x10);
            ...
            (*_dbus_message_iter_close_container_dylibloader_wrapper_dbus)
                      ((DBusMessageIter *)&local_1b8,(DBusMessageIter *)&local_f8);
            lVar9 = (*_dbus_connection_send_with_reply_and_block_dylibloader_wrapper_dbus)
                              (*(undefined8 *)(this + 0x1d0),uVar8,0x7fffffff,local_1d8);
            (*_dbus_message_unref_dylibloader_wrapper_dbus)(uVar8);
            if ((lVar9 == 0) ||
               (iVar7 = (*_dbus_error_is_set_dylibloader_wrapper_dbus)(local_1d8), iVar7 != 0)) {
              ...
              vformat<char_const*>((String *)&local_f8,(char *)&local_1b8);
              _err_print_error("file_dialog_show","platform/linuxbsd/freedesktop_portal_desktop.cpp"
                               ,0x22c,(DBusMessageIter *)&local_f8,0,0);
              pcVar11 = local_f8;
              if (local_f8 != (char *)0x0) {
                LOCK();
                plVar14 = (long *)(local_f8 + -0x10);
...
LAB_0010689d:
              ...
              iVar7 = (*_dbus_message_iter_init_dylibloader_wrapper_dbus)
                                (lVar9,(DBusMessageIter *)&local_f8);
              if ((iVar7 != 0) &&
                 (iVar7 = (*_dbus_message_iter_get_arg_type_dylibloader_wrapper_dbus)
                                    ((DBusMessageIter *)&local_f8), iVar7 == 0x6f)) {
                local_230 = 0;
                (*_dbus_message_iter_get_basic_dylibloader_wrapper_dbus)
                          ((DBusMessageIter *)&local_f8,(StrRange *)&local_230);
                ...
                if (cVar6 != '\0') {
                  ...
                  if (iVar7 == 0) {
                    ...
                    _err_print_error("file_dialog_show",
                                     "platform/linuxbsd/freedesktop_portal_desktop.cpp",0x243,
                                     (DBusMessageIter *)&local_1b8,0,0);
                    ...
                    vformat<char_const*>((String *)&local_1b8,(char *)&local_1e8);
                    _err_print_error("file_dialog_show",
                                     "platform/linuxbsd/freedesktop_portal_desktop.cpp",0x23c,
                                     (DBusMessageIter *)&local_1b8,0,0);
                    pcVar11 = local_1b8;
                    if (local_1b8 != (char *)0x0) {
                      LOCK();
...
LAB_00105d48:
              (*_dbus_message_unref_dylibloader_wrapper_dbus)(lVar9);
              ...
              if (5 < *(uint *)(hash_table_size_primes + (local_130 & 0xffffffff) * 4)) {
                do {
                  if (*(uint *)(hash_table_size_primes + (local_130 & 0xffffffff) * 4) <=
                      *(uint *)(hash_table_size_primes + uVar10 * 4)) {
...
LAB_00105e21:
              if ((local_130._4_4_ != 0) && ((long *)local_140._0_8_ != (long *)0x0)) {
                plVar14 = (long *)local_140._0_8_;
                do {
                  HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>
                  ::insert((String *)&local_1b8,local_e8,(bool)((char)plVar14 + '\x10'));
              ...
              iVar7 = CowData<FreeDesktopPortalDesktop::FileDialogData>::resize<false>
                                ((CowData<FreeDesktopPortalDesktop::FileDialogData> *)(this + 0x1b0)
                                 ,lVar9);
              if (iVar7 == 0) {
                if (*(long *)(this + 0x1b0) == 0) {
                  lVar12 = -1;
                ...
                _err_print_index_error
                          ("set","./core/templates/cowdata.h",0xcf,lVar12,lVar9,"p_index","size()",
                           "",false,false);
              }
              else {
                _err_print_error("push_back","./core/templates/vector.h",0x142,
...
LAB_00106005:
              FileDialogData::~FileDialogData((FileDialogData *)&local_f8);
              pthread_mutex_unlock((pthread_mutex_t *)(this + 0x180));
              iVar7 = 0;
            }
            pcVar11 = local_240;
            ...
            _err_print_error("file_dialog_show","platform/linuxbsd/freedesktop_portal_desktop.cpp",
                             0x1f8,"Condition \"rng_err\" is true. Returning: rng_err",
                             "Failed to generate unique token.",0,0);
          }
        }
        else {
          iVar7 = 1;
          _err_print_error("file_dialog_show","platform/linuxbsd/freedesktop_portal_desktop.cpp",
                           0x1f5,"Condition \"rng.init()\" is true. Returning: FAILED",
...
LAB_0010620e:
      ...
      _err_print_error("file_dialog_show","platform/linuxbsd/freedesktop_portal_desktop.cpp",0x1c4,
                       "Parameter \"monitor_connection\" is null.",0,0);
    }
    else {
      _err_print_index_error
                ("file_dialog_show","platform/linuxbsd/freedesktop_portal_desktop.cpp",0x1c3,
                 (long)(int)param_8,5,"int(p_mode)","DisplayServer::FILE_DIALOG_MODE_SAVE_MAX","",
                 false,false);
    }
  }
  iVar7 = 1;
...
/* CallableCustomMethodPointer<DisplayServer, void, int>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<DisplayServer,void,int>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<DisplayServer,void,int> *this)
...
/* CallableCustomMethodPointer<FreeDesktopPortalDesktop, void>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<FreeDesktopPortalDesktop,void>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<FreeDesktopPortalDesktop,void> *this)
...
/* CallableCustomMethodPointer<DisplayServer, void, int>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<DisplayServer,void,int>::get_argument_count
          (CallableCustomMethodPointer<DisplayServer,void,int> *this,bool *param_1)
...
/* CallableCustomMethodPointer<FreeDesktopPortalDesktop, void>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<FreeDesktopPortalDesktop,void>::get_argument_count
          (CallableCustomMethodPointer<FreeDesktopPortalDesktop,void> *this,bool *param_1)
...
/* CallableCustomMethodPointer<FreeDesktopPortalDesktop, void>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<FreeDesktopPortalDesktop,void>::get_object
          (CallableCustomMethodPointer<FreeDesktopPortalDesktop,void> *this)
...
/* CallableCustomMethodPointer<DisplayServer, void, int>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<DisplayServer,void,int>::get_object
          (CallableCustomMethodPointer<DisplayServer,void,int> *this)
...
void __thiscall
CallableCustomMethodPointer<FreeDesktopPortalDesktop,void>::call
          (CallableCustomMethodPointer<FreeDesktopPortalDesktop,void> *this,Variant **param_1,
...
LAB_0010790f:
    ...
    _err_print_error(&_LC8,"./core/object/callable_method_pointer.h",0x67,
...
void __thiscall
CallableCustomMethodPointer<DisplayServer,void,int>::call
          (CallableCustomMethodPointer<DisplayServer,void,int> *this,Variant **param_1,int param_2,
...
/* WARNING: Removing unreachable block (ram,0x00108208) */
/* WARNING: Removing unreachable block (ram,0x00108338) */
/* WARNING: Removing unreachable block (ram,0x00108500) */
/* WARNING: Removing unreachable block (ram,0x00108344) */
/* WARNING: Removing unreachable block (ram,0x0010834e) */
...
/* WARNING: Removing unreachable block (ram,0x00108370) */
/* WARNING: Removing unreachable block (ram,0x0010837a) */
/* WARNING: Removing unreachable block (ram,0x001084a0) */
/* WARNING: Removing unreachable block (ram,0x00108386) */
/* WARNING: Removing unreachable block (ram,0x00108390) */
/* WARNING: Removing unreachable block (ram,0x00108480) */
/* WARNING: Removing unreachable block (ram,0x0010839c) */
/* WARNING: Removing unreachable block (ram,0x001083a6) */
/* WARNING: Removing unreachable block (ram,0x00108460) */
/* WARNING: Removing unreachable block (ram,0x001083b2) */
/* WARNING: Removing unreachable block (ram,0x001083bc) */
/* WARNING: Removing unreachable block (ram,0x00108440) */
/* WARNING: Removing unreachable block (ram,0x001083c4) */
/* WARNING: Removing unreachable block (ram,0x001083da) */
/* WARNING: Removing unreachable block (ram,0x001083e6) */
...
/* WARNING: Removing unreachable block (ram,0x00108e80) */
/* WARNING: Removing unreachable block (ram,0x00108fb0) */
/* WARNING: Removing unreachable block (ram,0x00109129) */
/* WARNING: Removing unreachable block (ram,0x00108fbc) */
/* WARNING: Removing unreachable block (ram,0x00108fc6) */
/* WARNING: Removing unreachable block (ram,0x0010910b) */
/* WARNING: Removing unreachable block (ram,0x00108fd2) */
/* WARNING: Removing unreachable block (ram,0x00108fdc) */
/* WARNING: Removing unreachable block (ram,0x001090ed) */
/* WARNING: Removing unreachable block (ram,0x00108fe8) */
/* WARNING: Removing unreachable block (ram,0x00108ff2) */
/* WARNING: Removing unreachable block (ram,0x001090cf) */
/* WARNING: Removing unreachable block (ram,0x00108ffe) */
/* WARNING: Removing unreachable block (ram,0x00109008) */
/* WARNING: Removing unreachable block (ram,0x001090b1) */
/* WARNING: Removing unreachable block (ram,0x00109014) */
/* WARNING: Removing unreachable block (ram,0x0010901e) */
/* WARNING: Removing unreachable block (ram,0x00109093) */
/* WARNING: Removing unreachable block (ram,0x00109026) */
/* WARNING: Removing unreachable block (ram,0x00109030) */
/* WARNING: Removing unreachable block (ram,0x00109078) */
/* WARNING: Removing unreachable block (ram,0x00109038) */
/* WARNING: Removing unreachable block (ram,0x0010904e) */
/* WARNING: Removing unreachable block (ram,0x0010905a) */
...
/* WARNING: Removing unreachable block (ram,0x001093d0) */
/* WARNING: Removing unreachable block (ram,0x00109549) */
/* WARNING: Removing unreachable block (ram,0x001093dc) */
/* WARNING: Removing unreachable block (ram,0x001093e6) */
/* WARNING: Removing unreachable block (ram,0x0010952b) */
/* WARNING: Removing unreachable block (ram,0x001093f2) */
/* WARNING: Removing unreachable block (ram,0x001093fc) */
/* WARNING: Removing unreachable block (ram,0x0010950d) */
/* WARNING: Removing unreachable block (ram,0x00109408) */
/* WARNING: Removing unreachable block (ram,0x00109412) */
/* WARNING: Removing unreachable block (ram,0x001094ef) */
/* WARNING: Removing unreachable block (ram,0x0010941e) */
/* WARNING: Removing unreachable block (ram,0x00109428) */
/* WARNING: Removing unreachable block (ram,0x001094d1) */
/* WARNING: Removing unreachable block (ram,0x00109434) */
/* WARNING: Removing unreachable block (ram,0x0010943e) */
/* WARNING: Removing unreachable block (ram,0x001094b3) */
/* WARNING: Removing unreachable block (ram,0x00109446) */
/* WARNING: Removing unreachable block (ram,0x00109450) */
/* WARNING: Removing unreachable block (ram,0x00109498) */
/* WARNING: Removing unreachable block (ram,0x00109458) */
/* WARNING: Removing unreachable block (ram,0x0010946e) */
/* WARNING: Removing unreachable block (ram,0x0010947a) */
/* String vformat<char const*, unsigned int>(String const&, char const* const, unsigned int const)
    */
...
/* WARNING: Removing unreachable block (ram,0x00109be4) */
/* WARNING: Removing unreachable block (ram,0x00109bee) */
/* WARNING: Removing unreachable block (ram,0x00109d80) */
/* WARNING: Removing unreachable block (ram,0x00109bfa) */
/* WARNING: Removing unreachable block (ram,0x00109c04) */
/* WARNING: Removing unreachable block (ram,0x00109d60) */
/* WARNING: Removing unreachable block (ram,0x00109c10) */
/* WARNING: Removing unreachable block (ram,0x00109c1a) */
/* WARNING: Removing unreachable block (ram,0x00109d40) */
/* WARNING: Removing unreachable block (ram,0x00109c26) */
/* WARNING: Removing unreachable block (ram,0x00109c30) */
/* WARNING: Removing unreachable block (ram,0x00109d20) */
/* WARNING: Removing unreachable block (ram,0x00109c3c) */
/* WARNING: Removing unreachable block (ram,0x00109c46) */
/* WARNING: Removing unreachable block (ram,0x00109d00) */
/* WARNING: Removing unreachable block (ram,0x00109c52) */
/* WARNING: Removing unreachable block (ram,0x00109c5c) */
/* WARNING: Removing unreachable block (ram,0x00109ce0) */
/* WARNING: Removing unreachable block (ram,0x00109c64) */
/* WARNING: Removing unreachable block (ram,0x00109c7a) */
/* WARNING: Removing unreachable block (ram,0x00109c86) */
...
/* WARNING: Removing unreachable block (ram,0x0010a1aa) */
...
/* WARNING: Removing unreachable block (ram,0x0010a092) */
/* WARNING: Removing unreachable block (ram,0x0010a16e) */
/* WARNING: Removing unreachable block (ram,0x0010a09e) */
/* WARNING: Removing unreachable block (ram,0x0010a0a8) */
/* WARNING: Removing unreachable block (ram,0x0010a150) */
/* WARNING: Removing unreachable block (ram,0x0010a0b4) */
/* WARNING: Removing unreachable block (ram,0x0010a0be) */
/* WARNING: Removing unreachable block (ram,0x0010a132) */
/* WARNING: Removing unreachable block (ram,0x0010a0c6) */
/* WARNING: Removing unreachable block (ram,0x0010a0d0) */
/* WARNING: Removing unreachable block (ram,0x0010a117) */
/* WARNING: Removing unreachable block (ram,0x0010a0d8) */
/* WARNING: Removing unreachable block (ram,0x0010a0ed) */
/* WARNING: Removing unreachable block (ram,0x0010a0f9) */
...
/* FreeDesktopPortalDesktop::FileDialogData::~FileDialogData() */

void __thiscall FreeDesktopPortalDesktop::FileDialogData::~FileDialogData(FileDialogData *this)
...
LAB_0010abfa:
    ...
    iVar33 = 0;
LAB_0010abd8:
    if ((float)uVar36 * __LC83 < (float)(iVar33 + 1)) goto LAB_0010abfa;
  }
  local_58[0] = 0;
...
LAB_0010b27f:
    if ((float)uVar23 * __LC83 < (float)(iVar24 + 1)) goto LAB_0010b2a1;
  }
  local_58 = 0;
  if (*(long *)pSVar26 != 0) {
...
/* CowData<FreeDesktopPortalDesktop::FileDialogData>::_unref() */
...
/* CowData<FreeDesktopPortalDesktop::FileDialogData>::_realloc(long) */

undefined8 __thiscall
CowData<FreeDesktopPortalDesktop::FileDialogData>::_realloc
          (CowData<FreeDesktopPortalDesktop::FileDialogData> *this,long param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Error CowData<FreeDesktopPortalDesktop::FileDialogData>::resize<false>(long) */

undefined8 __thiscall
CowData<FreeDesktopPortalDesktop::FileDialogData>::resize<false>
          (CowData<FreeDesktopPortalDesktop::FileDialogData> *this,long param_1)
...
LAB_0010c062:
      CowData<String>::_unref((CowData<String> *)(lVar8 + 8));
      uVar14 = uVar14 + 1;
    }
    goto LAB_0010c1e6;
  }

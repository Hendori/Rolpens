...

{
  ...
  *param_2 = *(undefined8 *)(lVar1 + 8);
  ...
  param_2[2] = *(undefined8 *)(lVar1 + 0x18);
  param_2[3] = uVar2;
  uVar2 = *(undefined8 *)(lVar1 + 0x30);
  param_2[4] = *(undefined8 *)(lVar1 + 0x28);
  param_2[5] = uVar2;
  uVar2 = *(undefined8 *)(lVar1 + 0x40);
  param_2[6] = *(undefined8 *)(lVar1 + 0x38);
  param_2[7] = uVar2;
  uVar2 = *(undefined8 *)(lVar1 + 0x50);
  param_2[8] = *(undefined8 *)(lVar1 + 0x48);
  param_2[9] = uVar2;
  uVar2 = *(undefined8 *)(lVar1 + 0x60);
  param_2[10] = *(undefined8 *)(lVar1 + 0x58);
  param_2[0xb] = uVar2;
  uVar2 = *(undefined8 *)(lVar1 + 0x70);
  param_2[0xc] = *(undefined8 *)(lVar1 + 0x68);
  param_2[0xd] = uVar2;
  uVar2 = *(undefined8 *)(lVar1 + 0x80);
  param_2[0xe] = *(undefined8 *)(lVar1 + 0x78);
  param_2[0xf] = uVar2;
  uVar2 = *(undefined8 *)(lVar1 + 0x90);
  param_2[0x10] = *(undefined8 *)(lVar1 + 0x88);
  param_2[0x11] = uVar2;
  uVar2 = *(undefined8 *)(lVar1 + 0xa0);
  param_2[0x12] = *(undefined8 *)(lVar1 + 0x98);
  param_2[0x13] = uVar2;
  uVar2 = *(undefined8 *)(lVar1 + 0xb0);
  param_2[0x14] = *(undefined8 *)(lVar1 + 0xa8);
  param_2[0x15] = uVar2;
  uVar2 = *(undefined8 *)(lVar1 + 0xc0);
  param_2[0x16] = *(undefined8 *)(lVar1 + 0xb8);
  param_2[0x17] = uVar2;
  uVar2 = *(undefined8 *)(lVar1 + 0xd0);
  param_2[0x18] = *(undefined8 *)(lVar1 + 200);
  param_2[0x19] = uVar2;
  return 0;
}
...
LAB_0010021b:
      if (uVar10 < uVar14) {
        ...
        *(uint *)(param_1 + 0xa0) = uVar9;
        ...
        {
          puVar12 = (undefined1 *)
                    ft_mem_qrealloc(uVar8,(ulong)uVar9,0,*(int *)(param_1 + 0x98),0,&local_34);
...

{
  ...
  if (((iVar1 == 0) &&
      (iVar1 = FT_Stream_ReadFields(param_2,winfnt_header_fields,param_1 + 1), iVar1 == 0)) &&
     ((*(ushort *)(param_1 + 1) & 0xfeff) == 0x200)) {
...

{
  ...
  if ((local_148 == 0) &&
     (iVar7 = FT_Stream_ReadFields(uVar3,winmz_header_fields,&local_142), iVar7 == 0)) {
    local_148 = 2;
    if (local_142 == 0x5a4d) {
      local_148 = FT_Stream_Seek(uVar3,local_140);
      uVar8 = local_148;
      if ((local_148 != 0) ||
         (uVar8 = FT_Stream_ReadFields(uVar3,winne_header_fields,&local_13e), uVar8 != 0))
      goto LAB_00100720;
      local_148 = 2;
      if (local_13e != 0x454e) {
        if (local_13e == 0x4550) {
          ...
          uVar8 = local_148;
          if ((local_148 == 0) &&
             (local_148 = FT_Stream_ReadFields(uVar3,winpe32_header_fields,&local_a8),
             uVar8 = local_148, local_148 == 0)) {
            if ((CONCAT44(uStack_a4,local_a8) == 0x4550) &&
               (((CONCAT44(uStack_9c,CONCAT22(uStack_9e,local_a0)) & 0xffffffff0000ffff) ==
                 0x10b00e00000014c && (*param_2 = 0, uStack_9e != 0)))) {
              uVar4 = 0;
              do {
                local_148 = 0;
                ...
                if (local_98 == local_60) {
                  ...
                  uVar8 = local_148;
                  if ((local_148 != 0) ||
                     (local_148 = FT_Stream_ReadFields(uVar3,winpe_rsrc_dir_fields,local_108),
                     lVar23 = local_50, uVar8 = local_148, local_148 != 0)) goto LAB_00100720;
                  local_15a = 0;
                  lVar1 = local_50 + 0x10;
                  goto LAB_00100ddd;
                }
...
LAB_00100a19:
        if (*param_2 == 0) goto LAB_00100af3;
...
LAB_00100a2e:
      ...
      uVar8 = local_148;
      if ((local_148 != 0) ||
         (local_148 = FT_Stream_EnterFrame(uVar3,(long)(int)((uint)local_13a - (uint)local_13c)),
         uVar8 = local_148, local_148 != 0)) goto LAB_00100720;
      ...
      while (sVar6 = FT_Stream_GetUShortLE(uVar3), sVar6 != 0) {
        ...
        if (sVar6 == -0x7ff8) {
          ...
          FT_Stream_ExitFrame(uVar3);
          if (((uVar5 == 0) || (lVar23 == 0)) ||
             (uVar16 = (ulong)uVar5, *(ulong *)(uVar3 + 8) < uVar16 * 0x76)) goto LAB_00100af3;
          *param_2 = uVar16;
          if (param_3 < 0) {
            bVar19 = local_148 == 0;
            goto LAB_00100669;
          ...
          if ((local_148 == 0) && (local_148 = FT_Stream_EnterFrame(uVar3,0xc), local_148 == 0)) {
            uVar5 = FT_Stream_GetUShortLE(uVar3);
        ...
        *(long *)(uVar3 + 0x40) =
             *(long *)(uVar3 + 0x40) + (long)(int)(((uint)uVar5 + (uint)uVar5 * 2) * 4 + 4);
      }
      FT_Stream_ExitFrame();
LAB_00100af3:
      local_a8 = 3;
...
LAB_00100659:
      bVar19 = (bool)(local_148 == 0 & (byte)((uint)param_3 >> 0x1f));
LAB_00100669:
      local_a8 = local_148;
      uVar8 = local_a8;
        ...
        *(ulong *)(puVar10 + 4) = lVar23 + 0x20U & 0xffffffffffffffc0;
        ...
        if (local_a8 == 0) {
          if (*(byte *)(uVar3 + 0x74) <= *(byte *)(uVar3 + 0x75)) {
            ...
            param_2[4] = (long)(int)(((uint)*(byte *)(uVar3 + 0x75) - (uint)*(byte *)(uVar3 + 0x74))
                                    + 2);
...
LAB_001008d0:
    ...
    local_a8 = 2;
LAB_001005b7:
    puVar9 = (undefined8 *)ft_mem_alloc(uVar14,0xf0,&local_a8);
...
LAB_001005f0:
  ...
  __stack_chk_fail();
LAB_00100ddd:
  if ((uint)local_f4 + (uint)local_f2 <= (uint)local_15a) goto LAB_00100a19;
  local_148 = FT_Stream_Seek(uVar3,(int)((uint)local_15a * 8) + lVar1);
  uVar8 = local_148;
  if ((local_148 != 0) ||
     (local_148 = FT_Stream_ReadFields(uVar3,winpe_rsrc_dir_entry_fields,&local_138),
     uVar8 = local_148, local_148 != 0)) goto LAB_00100720;
  ...
  uVar8 = local_148;
  if ((local_148 != 0) ||
     (local_148 = FT_Stream_ReadFields(uVar3,winpe_rsrc_dir_fields,local_e8), uVar8 = local_148,
     local_148 != 0)) goto LAB_00100720;
  for (uVar22 = 0; (uVar22 & 0xffff) < (uint)local_d4 + (uint)local_d2; uVar22 = uVar22 + 1) {
    ...
    uVar8 = local_148;
    if ((local_148 != 0) ||
       (local_148 = FT_Stream_ReadFields(uVar3,winpe_rsrc_dir_entry_fields,local_128),
       uVar8 = local_148, local_148 != 0)) goto LAB_00100720;
    ...
    uVar8 = local_148;
    if ((local_148 != 0) ||
       (local_148 = FT_Stream_ReadFields(uVar3,winpe_rsrc_dir_fields,local_c8), uVar8 = local_148,
       local_148 != 0)) goto LAB_00100720;
    for (uVar24 = 0; (uVar24 & 0xffff) < (uint)local_b4 + (uint)local_b2; uVar24 = uVar24 + 1) {
      ...
      uVar8 = local_148;
      if ((local_148 != 0) ||
         (local_148 = FT_Stream_ReadFields(uVar3,winpe_rsrc_dir_entry_fields,local_118),
         uVar8 = local_148, local_148 != 0)) goto LAB_00100720;
      if ((local_120 & 0x80000000) != 0) goto LAB_00100c16;
      if (local_138 == 8) {
        ...
        uVar8 = local_148;
        if ((local_148 != 0) ||
           (local_148 = FT_Stream_ReadFields(uVar3,winpe_rsrc_data_entry_fields,&local_88),
           uVar8 = local_148, local_148 != 0)) goto LAB_00100720;
        if (uVar11 == *param_2) {

...
undefined1  [16] Clipper2Lib::GetLowestClosedPathIdx(vector *param_1)
...
joined_r0x00100062:
    ...
    if ((long *)puVar2[1] != plVar1) {
      do {
        ...
        if (lVar4 <= lVar5) {
          lVar7 = *plVar1;
          if ((lVar4 == lVar5) && (lVar5 = lVar4, lVar8 <= lVar7)) goto code_r0x0010009b;
          uVar9 = 1;
          lVar4 = lVar5;
          uVar10 = uVar6;
        }
...
/* Clipper2Lib::GetUnitNormal(Clipper2Lib::Point<long> const&, Clipper2Lib::Point<long> const&) */

undefined1  [16] Clipper2Lib::GetUnitNormal(Point *param_1,Point *param_2)
...
void __thiscall
Clipper2Lib::ClipperOffset::Group::Group(Group *this,long *param_1,undefined4 param_3,uint param_4)
...
LAB_001001f9:
    *(undefined1 **)(this + 0x10) = *unaff_RBX + uVar14;
    ...
    *(uint *)(this + 0x30) = param_4;
    for (pauVar13 = pauVar12; unaff_RBX != pauVar13;
        pauVar13 = (undefined1 (*) [16])(pauVar13[1] + 8)) {
      plVar5 = *(long **)(*pauVar13 + 8);
      plVar6 = *(long **)*pauVar13;
      if ((plVar5 != plVar6) && (plVar3 = plVar6 + 2, plVar5 != plVar3)) {
        lVar4 = *plVar6;
        do {
          lVar7 = *plVar3;
...
LAB_00100477:
    ...
    do {
      ...
      lVar9 = plVar5[2];
      lVar4 = plVar5[3];
      dVar15 = dVar15 + (double)lVar11 * (double)lVar7 +
               (double)(plVar5[1] + lVar4) * (double)(*plVar5 - lVar9);
      plVar5 = plVar6;
    } while (plVar3 != plVar6);
    if ((uVar14 & 1) != 0) {
      lVar7 = plVar3[1];
    ...
    dVar16 = dVar15;
LAB_001004f5:
    dVar15 = dVar15 + (double)(lVar4 + lVar7) * dVar16;
  }
...
/* Clipper2Lib::ClipperOffset::CalcSolutionCapacity() */

long __thiscall Clipper2Lib::ClipperOffset::CalcSolutionCapacity(ClipperOffset *this)
...
/* Clipper2Lib::ClipperOffset::CheckReverseOrientation() */

undefined1 __thiscall Clipper2Lib::ClipperOffset::CheckReverseOrientation(ClipperOffset *this)
...
void __thiscall
Clipper2Lib::ClipperOffset::AddPath
          (ClipperOffset *this,undefined8 param_1,undefined4 param_3,undefined4 param_4)

{
  ...
  if (local_98._8_8_ != local_98._0_8_) {
    Group::Group((Group *)&local_78,
                 (vector<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>,std::allocator<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>>>
                  *)local_98,param_3,param_4);
    std::vector<Clipper2Lib::ClipperOffset::Group,std::allocator<Clipper2Lib::ClipperOffset::Group>>
    ::emplace_back<Clipper2Lib::ClipperOffset::Group>
              ((vector<Clipper2Lib::ClipperOffset::Group,std::allocator<Clipper2Lib::ClipperOffset::Group>>
                *)(this + 0x78),(Group *)&local_78);
...
void Clipper2Lib::ClipperOffset::AddPaths(long param_1,long *param_2)
...
void Clipper2Lib::ClipperOffset::BuildNormals(vector *param_1)
...
/* Clipper2Lib::ClipperOffset::DoMiter(std::vector<Clipper2Lib::Point<long>,
   std::allocator<Clipper2Lib::Point<long> > > const&, unsigned long, unsigned long, double) */

void __thiscall
Clipper2Lib::ClipperOffset::DoMiter
          (ClipperOffset *this,vector *param_1,ulong param_2,ulong param_3,double param_4)
...
/* Clipper2Lib::ClipperOffset::DoBevel(std::vector<Clipper2Lib::Point<long>,
   std::allocator<Clipper2Lib::Point<long> > > const&, unsigned long, unsigned long) */

void __thiscall
Clipper2Lib::ClipperOffset::DoBevel(ClipperOffset *this,vector *param_1,ulong param_2,ulong param_3)
...
/* Clipper2Lib::ClipperOffset::DoRound(std::vector<Clipper2Lib::Point<long>,
   std::allocator<Clipper2Lib::Point<long> > > const&, unsigned long, unsigned long, double) */

void __thiscall
Clipper2Lib::ClipperOffset::DoRound
          (ClipperOffset *this,vector *param_1,ulong param_2,ulong param_3,double param_4)

{
  ...
  pvVar1 = (vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>> *)
           (this + 0x50);
  ...
  if (plVar9 == plVar6) {
    std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>::
    _M_realloc_insert<Clipper2Lib::Point<long>>(pvVar1,plVar6,&local_58);
  ...
  if ((double)((ulong)dVar12 & uVar4) < _LC14) {
    dVar12 = (double)((ulong)((double)(long)dVar12 +
                             (double)(-(ulong)((double)(long)dVar12 < dVar12) & (ulong)_LC0)) |
                     ~uVar4 & (ulong)dVar12);
  }
  iVar7 = (int)dVar12;
  if (1 < iVar7) {
    ...
    do {
      while( true ) {
        ...
        iVar11 = iVar11 + 1;
        std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>::
        _M_realloc_insert<Clipper2Lib::Point<long>>(pvVar1,plVar9,&local_58);
        plVar10 = *(long **)(this + 0x58);
        plVar6 = *(long **)(this + 0x60);
        plVar9 = plVar10;
...
LAB_00101050:
  ...
  if (plVar10 == plVar6) {
    std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>::
    _M_realloc_insert<Clipper2Lib::Point<long>>(pvVar1,plVar10,&local_58);
  }
  else {
    *plVar10 = local_58;
    plVar10[1] = lStack_50;
...
void __thiscall
Clipper2Lib::ClipperOffset::DoSquare
          (ClipperOffset *this,vector *param_1,ulong param_2,ulong param_3)

{
  ...
  if (param_2 == param_3) {
    ...
    dVar5 = dVar6;
    if (((dVar15 != 0.0) &&
        (dVar15 = ((dVar9 - dVar11) * dVar7 - (dVar20 - dVar10) * dVar17) / dVar15, dVar5 = dVar9,
        local_68 = dVar20, 0.0 < dVar15)) && (dVar5 = dVar18, local_68 = dVar19, dVar15 < _LC0)) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Clipper2Lib::ClipperOffset::OffsetPoint(Clipper2Lib::ClipperOffset::Group&,
   std::vector<Clipper2Lib::Point<long>, std::allocator<Clipper2Lib::Point<long> > > const&,
   unsigned long, unsigned long) */

void __thiscall
Clipper2Lib::ClipperOffset::OffsetPoint
          (ClipperOffset *this,Group *param_1,vector *param_2,ulong param_3,ulong param_4)

{
  ...
  if ((*plVar2 != *plVar11) || (plVar2[1] != plVar11[1])) {
    ...
    dVar21 = _LC0;
    if ((dVar23 <= _LC0) && (dVar21 = _LC17, _LC17 <= dVar23)) {
      dVar21 = dVar23;
    }
    if (*(long *)(this + 0xc0) == 0) {
      ...
      local_60 = param_3;
      local_58 = param_4;
      dVar20 = (double)(**(code **)(this + 200))
                                 (this + 0xb0,param_2,this + 0x38,&local_60,&local_58);
      GVar5 = param_1[0x28];
...
LAB_00101882:
      ...
      if (puVar19 == puVar14) {
        std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>::
        _M_realloc_insert<Clipper2Lib::Point<long>>(pvVar1,puVar14,&local_58);
      ...
      if (dVar22 < _LC19) {
        if (puVar18 == puVar14) {
          std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>::
          _M_realloc_insert<Clipper2Lib::Point<long>const&>(pvVar1,puVar18,puVar15);
          puVar19 = *(ulong **)(this + 0x58);
          puVar14 = *(ulong **)(this + 0x60);
          puVar15 = (ulong *)(*(long *)param_2 + lVar16);
        }
      ...
      if (puVar19 == puVar14) {
        std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>::
        _M_realloc_insert<Clipper2Lib::Point<long>>(pvVar1,puVar19,&local_58);
      }
      else {
        *puVar19 = local_58;
        puVar19[1] = uStack_50;
...
void __thiscall
Clipper2Lib::ClipperOffset::OffsetPolygon(ClipperOffset *this,Group *param_1,vector *param_2)

{
  ...
  *pvStack_30;
  ...
  if (*(long *)param_2 != *(long *)(param_2 + 8)) {
    do {
      uVar18 = uVar23;
      pvStack_30 = (vector<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>,std::allocator<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>>>
                    *)0x101c8c;
      pGVar19 = param_1;
      this_00 = this;
  ...
  pvVar1 = *(vector<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>,std::allocator<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>>>
             **)(this + 0x68);
  ...
  *pauVar2 = (undefined1  [16])0x0;
  if (uVar23 == 0) {
    ...
    pauVar20 = pauVar2;
LAB_00101cee:
    *(ulong *)pauVar2[1] = uVar23 + (long)pvVar6;
    *(void **)*pauVar2 = pvVar6;
...
void __thiscall
Clipper2Lib::ClipperOffset::OffsetOpenJoined(ClipperOffset *this,Group *param_1,vector *param_2)
...
void __thiscall
Clipper2Lib::ClipperOffset::OffsetOpenPath(ClipperOffset *this,Group *param_1,vector *param_2)
...
LAB_001020df:
  ...
  *puVar14 = *puVar8;
  ...
  pvVar2 = *(vector<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>,std::allocator<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>>>
             **)(this + 0x68);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Clipper2Lib::ClipperOffset::DoGroupOffset(Clipper2Lib::ClipperOffset::Group&) */

void __thiscall Clipper2Lib::ClipperOffset::DoGroupOffset(ClipperOffset *this,Group *param_1)
  ...
  do {
    ...
    if (lVar7 == 1) {
      if (*(long *)(this + 0xc0) == 0) {
        ...
        dVar24 = (double)(**(code **)(this + 200))
                                   (this + 0xb0,pvVar18,this + 0x38,local_68,local_58);
        GVar1 = param_1[0x28];
        *(double *)(this + 0x10) = dVar24;
        if (GVar1 != (Group)0x0) {
          dVar24 = (double)((ulong)dVar24 ^ _LC15);
...
LAB_00102ac0:
            dVar24 = SQRT((local_b8 + local_b8) * _LC3) * _LC12;
            if (_LC22 <= dVar24) {
...
LAB_00102ae0:
            sincos(_LC13 / (double)local_b0,&local_70,&local_78);
            dVar19 = local_70;
            dVar24 = local_78;
            ...
            if (0.0 < local_b8) {
              ...
              if ((double)((ulong)dVar24 & uVar6) < _LC14) {
                dVar24 = (double)((ulong)((double)(long)dVar24 +
                                         (double)(-(ulong)((double)(long)dVar24 < dVar24) &
                                                 (ulong)_LC0)) | ~uVar6 & (ulong)dVar24);
...
LAB_00102d50:
          ...
          *(long **)(this + 0x60) = local_c8;
          if (pvVar10 != (void *)0x0) {
LAB_001029a6:
            operator_delete(pvVar10,lVar7 - (long)pvVar10);
            goto LAB_001029b1;
          }
          pvVar15 = *(vector<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>,std::allocator<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>>>
                      **)(this + 0x68);
          ...
          if ((double)((ulong)local_b8 & uVar6) < _LC14) {
            dVar24 = (double)((ulong)((double)(-(ulong)((double)(long)local_b8 < local_b8) &
                                              (ulong)_LC0) + (double)(long)local_b8) |
...
LAB_001029c5:
            uVar17 = *(long *)(this + 0x58) - *(long *)(this + 0x50);
...
/* WARNING: Removing unreachable block (ram,0x0010329c) */
/* WARNING: Removing unreachable block (ram,0x00103660) */
/* WARNING: Removing unreachable block (ram,0x00103668) */
/* WARNING: Removing unreachable block (ram,0x00103674) */
/* WARNING: Removing unreachable block (ram,0x0010367d) */
/* WARNING: Removing unreachable block (ram,0x00103607) */
/* WARNING: Removing unreachable block (ram,0x0010360a) */
/* WARNING: Removing unreachable block (ram,0x00103612) */
/* WARNING: Removing unreachable block (ram,0x0010361e) */
/* WARNING: Removing unreachable block (ram,0x00103627) */
/* WARNING: Removing unreachable block (ram,0x00103723) */
...
/* WARNING: Removing unreachable block (ram,0x00103743) */
/* WARNING: Removing unreachable block (ram,0x0010354c) */
/* WARNING: Removing unreachable block (ram,0x0010354f) */
/* WARNING: Removing unreachable block (ram,0x00103557) */
/* WARNING: Removing unreachable block (ram,0x00103563) */
/* WARNING: Removing unreachable block (ram,0x0010356c) */
/* WARNING: Removing unreachable block (ram,0x001035a8) */
/* WARNING: Removing unreachable block (ram,0x001035b0) */
/* WARNING: Removing unreachable block (ram,0x001035b8) */
/* WARNING: Removing unreachable block (ram,0x001035c4) */
/* WARNING: Removing unreachable block (ram,0x001035cd) */
/* WARNING: Removing unreachable block (ram,0x001034ca) */
/* WARNING: Removing unreachable block (ram,0x001034d0) */
/* WARNING: Removing unreachable block (ram,0x001034d8) */
/* WARNING: Removing unreachable block (ram,0x001034e4) */
/* WARNING: Removing unreachable block (ram,0x001034ed) */
/* WARNING: Removing unreachable block (ram,0x001032a5) */
/* WARNING: Removing unreachable block (ram,0x001036b8) */
/* WARNING: Removing unreachable block (ram,0x001036bb) */
/* WARNING: Removing unreachable block (ram,0x001036c3) */
/* WARNING: Removing unreachable block (ram,0x001036cf) */
/* WARNING: Removing unreachable block (ram,0x001036d8) */
/* WARNING: Removing unreachable block (ram,0x001032af) */
/* Clipper2Lib::ClipperOffset::ExecuteInternal(double) */

void __thiscall Clipper2Lib::ClipperOffset::ExecuteInternal(ClipperOffset *this,double param_1)

{
  ...
  *(undefined4 *)this = 0;
  ...
  if ((double)((ulong)param_1 & _LC8) < _LC3) {
    uVar15 = 0;
    for (plVar13 = *(long **)(this + 0x78); *(long **)(this + 0x80) != plVar13;
        plVar13 = plVar13 + 7) {
    ...
    if (plVar13 != plVar18) {
      pvVar21 = *(vector<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>,std::allocator<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>>>
                  **)(this + 0x68);
      do {
...
void __thiscall
Clipper2Lib::ClipperOffset::Execute(ClipperOffset *this,double param_1,vector *param_2)
...
void __thiscall Clipper2Lib::ClipperOffset::Execute(ClipperOffset *this,long param_2,long *param_3)
...
/* Clipper2Lib::ClipperOffset::Execute(double, Clipper2Lib::PolyPath64&) */

void __thiscall
Clipper2Lib::ClipperOffset::Execute(ClipperOffset *this,double param_1,PolyPath64 *param_2)
                        ...
                        do {
                          ...
                          if (plVar8 != (long *)0x0) {
                            ...
                            *plVar8 = (long)&PTR__PolyPath64_00107088;
                            ...
                            if (puVar10 != puVar21) {
                              do {
                                while (pPVar11 = (PolyPath64 *)*puVar21,
                                      pPVar11 == (PolyPath64 *)0x0) {
LAB_00103b22:
                                  puVar21 = puVar21 + 1;
...
void __thiscall Clipper2Lib::Clipper64::~Clipper64(Clipper64 *this)
...

{
  ...
  if ((param_1 < uVar9) &&
     (puVar1 = (undefined8 *)(*(long *)this + param_1 * 8), local_68 = puVar1, puVar1 != puVar2)) {
    do {
                            ...
                            do {
                              ...
                              if (plVar8 != (long *)0x0) {
                                ...
                                *plVar8 = (long)&PTR__PolyPath64_00107088;
                                ...
                                if (puVar9 != puVar19) {
                                  do {
                                    while (pPVar7 = (PolyPath64 *)*puVar19,
                                          pPVar7 == (PolyPath64 *)0x0) {
LAB_00104c00:
                                      puVar19 = puVar19 + 1;
                            ...
                            do {
                              ...
                              if (plVar10 != (long *)0x0) {
                                ...
                                *plVar10 = (long)&PTR__PolyPath64_00107088;
                                ...
                                if (puVar11 != puVar24) {
                                  do {
                                    while (pPVar12 = (PolyPath64 *)*puVar24,
                                          pPVar12 == (PolyPath64 *)0x0) {
LAB_00106012:
                                      puVar24 = puVar24 + 1;
...
/* void std::vector<Clipper2Lib::ClipperOffset::Group,
   ...
   std::vector<Clipper2Lib::ClipperOffset::Group, std::allocator<Clipper2Lib::ClipperOffset::Group>
   > >, Clipper2Lib::ClipperOffset::Group&&) */
...
LAB_00106c08:
  ...
  puVar16 = puVar13 + 7;
LAB_00106a9b:
  puVar11 = (undefined8 *)((long)puVar13 + ((long)param_2 - (long)puVar3));
  ...
  *puVar11 = uVar5;
  ...
  if (param_2 != puVar3) {
    ...
    puVar16 = puVar13 + (((ulong)((long)param_2 + (-0x38 - (long)puVar3)) >> 3) * 0xdb6db6db6db6db7
                        & 0x1fffffffffffffff) * 7 + 0xe;
  }
  puVar11 = param_2;
  puVar14 = puVar16;
  if (param_2 != puVar2) {
    ...
    puVar16 = puVar16 + ((((ulong)((long)puVar12 + (-0x38 - (long)param_2)) >> 3) *
                          0xdb6db6db6db6db7 & 0x1fffffffffffffff) + 1) * 7;
  }
...
void Clipper2Lib::_GLOBAL__sub_I_GetLowestClosedPathIdx(void)

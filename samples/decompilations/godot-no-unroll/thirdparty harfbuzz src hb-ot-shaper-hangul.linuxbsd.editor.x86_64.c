...
joined_r0x00100151:
          ...
          uVar9 = *(uint *)((long)&DAT_001017c4 + lVar10);
          lVar10 = lVar10 + 4;
        } while( true );
      }
      *(undefined4 *)((long)pvVar6 + lVar10) = 0;
  ...
  if ((param_5) || (!param_4)) {
    *(uint *)(this + 0xc0) = *(uint *)(this + 0xc0) | 0x20;
    if ((param_5) && (this[0x5a] != (hb_buffer_t)0x0)) {
      ...
      if (uVar11 == param_3) {
        local_44 = 0xffffffff;
        if (param_2 == uVar5) goto LAB_00101190;
        if (iVar1 == 2) goto LAB_0010152e;
LAB_001012e5:
        ...
        if (param_2 == uVar5) {
LAB_001015c5:
          if (param_3 == uVar11) goto LAB_00101190;
LAB_001015ce:
...
LAB_001013a9:
          ...
          if (uVar7 != uVar2) goto LAB_00101582;
          if (uVar7 == uVar13) goto LAB_0010148d;
          if (param_2 < uVar5) {
        ...
        if (uVar11 == param_3) goto LAB_00101190;
        uVar9 = (ulong)(param_3 - 1);
        uVar6 = (ulong)uVar11;
...
LAB_001013d3:
        if (uVar5 != uVar7) {
          if (uVar13 != uVar7) goto LAB_001015f6;
          if (uVar5 != uVar7) {
            if (uVar11 < param_3) {
...
LAB_0010152e:
            ...
            if (param_2 < uVar5) {
              ...
              if (param_2 == uVar5) goto LAB_001015c5;
            }
            local_50 = uVar6 * 0x14;
LAB_00101582:
            if (param_2 < uVar5) {
        ...
        local_44 = uVar7;
        if (param_2 != uVar5) goto LAB_001012e5;
LAB_001015d5:
        uVar5 = *(uint *)(lVar3 + 8 + uVar6 * 0x14);
        uVar13 = *(uint *)(lVar3 + 8 + uVar9 * 0x14);
        if (iVar1 != 2) goto LAB_001013d3;
LAB_001015f6:
        if (uVar11 < param_3) {
          puVar4 = (uint *)(lVar3 + 4 + uVar6 * 0x14);
          do {

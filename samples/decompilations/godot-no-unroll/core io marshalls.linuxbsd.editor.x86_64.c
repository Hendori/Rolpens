...
/* EncodedObjectAsID::set_object_id(ObjectID) */

void __thiscall EncodedObjectAsID::set_object_id(EncodedObjectAsID *this,undefined8 param_2)
...
/* EncodedObjectAsID::get_object_id() const */

undefined8 __thiscall EncodedObjectAsID::get_object_id(EncodedObjectAsID *this)
...
LAB_00101f10:
      ...
      if (uVar6 + 1 == lVar5) {
        ...
        lVar5 = puVar8[-1];
LAB_00101e21:
        if (param_1 <= lVar5) goto LAB_00101d87;
      }
      else {
        if (lVar10 != 0) {
          puVar3 = (undefined8 *)
...
LAB_00102220:
      ...
      if (uVar4 + 1 == lVar3) {
        ...
        lVar3 = puVar8[-1];
LAB_00102131:
        if (param_1 <= lVar3) goto LAB_0010209d;
      }
      else {
        if (lVar10 != 0) {
          puVar5 = (undefined8 *)
...
LAB_00102518:
      ...
      if (uVar4 + 1 == lVar3) {
        ...
        lVar3 = puVar7[-1];
LAB_00102441:
        if (param_1 <= lVar3) goto LAB_001023bc;
      }
      else {
        if (lVar11 != 0) {
          puVar5 = (undefined8 *)
                   Memory::realloc_static((void *)(*(long *)this + -0x10),uVar4 + 0x11,false);
          if (puVar5 == (undefined8 *)0x0) goto LAB_00102518;
          puVar7 = puVar5 + 2;
          *puVar5 = 1;
          *(undefined8 **)this = puVar7;
          lVar3 = puVar5[1];
...
LAB_00102808:
      ...
      if (uVar5 + 1 == lVar4) {
        ...
        lVar4 = puVar7[-1];
LAB_00102731:
        if (param_1 <= lVar4) goto LAB_001026ac;
      }
      else {
        if (lVar11 != 0) {
          puVar6 = (undefined8 *)
                   Memory::realloc_static((void *)(*(long *)this + -0x10),uVar5 + 0x11,false);
          if (puVar6 == (undefined8 *)0x0) goto LAB_00102808;
          puVar7 = puVar6 + 2;
          *puVar6 = 1;
          *(undefined8 **)this = puVar7;
          lVar4 = puVar6[1];
...
/* vector3_to_float32_array(Vector3 const*, unsigned long) */

Vector3 * vector3_to_float32_array(Vector3 *param_1,ulong param_2)
...
/* encode_variant(Variant const&, unsigned char*, int&, bool, int) */

int encode_variant(Variant *param_1,uchar *param_2,int *param_3,bool param_4,int param_5)

{
  ...
  if (0x400 < param_5) {
    iVar14 = 6;
    _err_print_error("encode_variant","core/io/marshalls.cpp",0x552,
                     "Condition \"p_depth > Variant::MAX_RECURSION_DEPTH\" is true. Returning: ERR_OUT_OF_MEMORY"
                     ,"Potential infinite recursion detected. Bailing.",0,0);
  ...
  *param_3 = 0;
  ...
  case 0x1b:
    ...
    if ((int)local_c8 == 0) {
      if (local_b8 != (Object *)0x0) goto LAB_001035d7;
    }
...
LAB_001035d7:
    ...
    if ((int)local_c8 == 0) {
      if (local_b8 != (Object *)0x0) goto LAB_00103636;
    }
    else if (local_b8 == (Object *)0x0) {
...
LAB_00103636:
  ...
  case 0x1c:
    ...
    if ((int)local_c8 == 0) {
      if (local_b8 != (Object *)0x0) goto LAB_00103712;
    }
    else if (local_b8 == (Object *)0x0) {
...
LAB_00104205:
          if (local_e8 != local_d8) goto LAB_00104213;
LAB_00104363:
          pVVar40 = local_d8;
...
LAB_001051c9:
            local_d8 = (Variant *)0x0;
            if (local_e8 == (Variant *)0x0) goto LAB_00104226;
LAB_001051d7:
            pVVar40 = local_e8;
            LOCK();
...
LAB_00104355:
            if (local_d8 == local_e8) goto LAB_00104363;
LAB_00104213:
            if (local_e8 != (Variant *)0x0) goto LAB_001051d7;
          }
          local_e8 = local_d8;
        }
LAB_00104226:
...
LAB_00105ad1:
          *param_3 = *param_3 + iVar17 + 4;
          ...
          if (iVar19 == 0) {
            iVar17 = 0;
            if (local_f8 != (ulong *)0x0) goto LAB_00105250;
LAB_00104277:
            ...
            if ((uVar34 & 3) == 0) {
              iVar17 = 0;
              if (local_f8 != (ulong *)0x0) goto LAB_00105252;
              iVar16 = *param_3;
              iVar17 = 0;
            }
            else {
...
LAB_001053a8:
      ...
      *param_3 = *param_3 + 4;
      ...
      if ((local_d8 == (Variant *)0x0) || (lVar20 = *(long *)local_d8, lVar20 == 0)) {
        uVar38 = 0;
        if (local_f8 != (ulong *)0x0) goto LAB_001058c3;
        *param_3 = *param_3 + 4;
      }
      else {
        uVar38 = 0;
...
LAB_001058c3:
          ...
          *param_3 = *param_3 + 4;
          if (local_d8 == (Variant *)0x0) goto LAB_00105e8e;
        }
...
LAB_00105ae7:
      ...
      if (pVVar40 == (Variant *)0x0) {
        ...
        if (*(long *)(local_e8 + 0x10) == 0) goto LAB_00105ae7;
        do {
          lVar20 = *plVar1;
          if (lVar20 == 0) goto LAB_00105ae7;
          LOCK();
          lVar31 = *plVar1;
          bVar43 = lVar20 == lVar31;
          if (bVar43) {
  ...
  case 0x1b:
    ...
    if (iVar14 == 0) {
      Dictionary::get_value_type();
      iVar14 = _encode_container_type
                         ((ContainerType *)&local_c8,(uchar **)&local_f8,param_3,param_4);
      ...
      if (iVar14 == 0) {
        ...
        *param_3 = *param_3 + 4;
        ...
        if ((local_c8 != (Variant *)0x0) &&
           (pVVar40 = *(Variant **)local_c8, pVVar40 != (Variant *)0x0)) {
          do {
            puVar23 = local_f8;
            iVar14 = encode_variant(pVVar40,(uchar *)local_f8,(int *)&local_e0,param_4,param_5 + 1);
            if (iVar14 != 0) {
              _err_print_error("encode_variant","core/io/marshalls.cpp",0x742,
                               "Condition \"err\" is true. Returning: err",0,0);
LAB_0010554c:
            ...
            if (((long)(int)local_e0 & 3U) != 0) {
              _err_print_error("encode_variant","core/io/marshalls.cpp",0x743,
                               "Condition \"len % 4\" is true. Returning: ERR_BUG",0,0);
LAB_00105546:
              iVar14 = 0x2f;
              goto LAB_0010554c;
            ...
            *param_3 = *param_3 + (int)local_e0;
            ...
            if (pVVar21 == (Variant *)0x0) {
              _err_print_error("encode_variant","core/io/marshalls.cpp",0x749,
                               "Parameter \"value\" is null.",0,0);
              goto LAB_00105546;
            }
            iVar14 = encode_variant(pVVar21,(uchar *)local_f8,(int *)&local_e0,param_4,param_5 + 1);
            if (iVar14 != 0) {
              _err_print_error("encode_variant","core/io/marshalls.cpp",0x74b,
                               "Condition \"err\" is true. Returning: err",0,0);
              goto LAB_0010554c;
            }
            if (((long)(int)local_e0 & 3U) != 0) {
              _err_print_error("encode_variant","core/io/marshalls.cpp",0x74c,
                               "Condition \"len % 4\" is true. Returning: ERR_BUG",0,0);
              goto LAB_00105546;
            }
            *param_3 = *param_3 + (int)local_e0;
...
LAB_0010564c:
  ...
  case 0x1d:
    ...
    *param_3 = uVar34;
    while ((uVar34 & 3) != 0) {
      uVar34 = uVar34 + 1;
      *param_3 = uVar34;
      if (puVar23 == (ulong *)0x0) goto LAB_00103ab7;
  ...
  case 0x1e:
    Variant::operator_cast_to_Vector((Variant *)&local_c8);
    if (local_c0 == (ulong *)0x0) {
      if (local_f8 == (ulong *)0x0) goto LAB_001053a8;
      lVar20 = 0;
      uVar38 = 0;
      iVar14 = 4;
LAB_001039c0:
    ...
    if (local_f8 != (ulong *)0x0) goto LAB_001039c0;
LAB_00105454:
  ...
  case 0x1f:
    ...
    if (local_c0 == (ulong *)0x0) {
      ...
      if (local_f8 == (ulong *)0x0) goto LAB_00105454;
    }
    puVar23 = local_f8;
    do {
      *(char *)puVar23 = (char)uVar38;
...
LAB_0010396a:
  ...
  case 0x22:
    ...
    if (local_c0 == (ulong *)0x0) {
      iVar14 = 0;
      uVar38 = 0;
      if (local_f8 != (ulong *)0x0) goto LAB_00104df8;
      *param_3 = *param_3 + 4;
    }
    else {
      uVar38 = local_c0[-1];
...
LAB_00104ee8:
            ...
            *param_3 = uVar34;
            ...
            while ((uVar34 & 3) != 0) {
              uVar34 = uVar34 + 1;
              *param_3 = uVar34;
              if (puVar23 == (ulong *)0x0) goto LAB_00104f17;
              *(undefined1 *)puVar23 = 0;
              bVar43 = true;
              puVar23 = (ulong *)((long)puVar23 + 1);
              uVar34 = *param_3;
      ...
      *param_3 = iVar15;
      if (0 < iVar14) {
        ...
        do {
          ...
          uVar38 = local_c0[-1];
          if ((long)uVar38 <= lVar20) goto LAB_0010547e;
...
LAB_00105565:
      ...
      *param_3 = iVar14;
      if (0 < (int)uVar34) {
        ...
        do {
          local_f8 = local_f8 + 2;
          puVar24 = puVar25 + -2;
          if (local_c0 == (ulong *)0x0) goto LAB_0010545d;
          uVar38 = local_c0[-1];
          if ((long)uVar38 <= lVar20) goto LAB_0010547e;
  ...
  case 0x26:
    ...
    if (local_f8 == (ulong *)0x0) goto LAB_00105565;
    uVar38 = (ulong)uVar34;
    puVar23 = local_f8;
    do {
      *(char *)puVar23 = (char)uVar38;
...
LAB_00104f1d:
  ...
  lVar20 = lVar20 + 1;
  if (lVar20 == iVar14) goto LAB_00104f5f;
  goto LAB_00104e30;
LAB_00103ab7:
  while ((uVar34 & 3) != 0) {
    uVar34 = uVar34 + 1;
...
joined_r0x00105745:
  if (local_c0 == (ulong *)0x0) goto switchD_001036b6_caseD_0;
  auVar47._8_8_ = local_88._8_8_;
  auVar47._0_8_ = local_88._0_8_;
  LOCK();
  puVar23 = local_c0 + -2;
  ...
  case 2:
    if ((uVar45 & 0x10000) == 0) {
      ...
      if (7 < iVar47) {
        ...
        *(ulong *)(param_1 + 0x10) = uStack_78;
        *(uint *)param_1 = local_88;
        if (param_4 == (int *)0x0) goto LAB_001073a0;
LAB_00107668:
        *param_4 = *param_4 + 8;
        goto LAB_001073a0;
      }
...
joined_r0x00108819:
  ...
  case 6:
    ...
    *(uint *)param_1 = local_88;
joined_r0x00107662:
    if (param_4 != (int *)0x0) goto LAB_00107668;
    goto LAB_001073a0;
  case 7:
    local_a8[0] = 0.0;
    local_a8[1] = 0.0;
...
joined_r0x0010866d:
    ...
    *(ulong *)(param_1 + 0x10) = uStack_78;
    *(uint *)param_1 = local_88;
    if (param_4 != (int *)0x0) goto LAB_0010805f;
    goto LAB_001073a0;
  case 9:
    local_a8[0] = 0.0;
    local_a8[1] = 0.0;
...
joined_r0x001070c4:
  ...
  case 0xf:
    ...
    local_a8[2] = (float)_UNK_00112ac8;
    local_a8[3] = (float)((ulong)_UNK_00112ac8 >> 0x20);
    if ((uVar45 & 0x10000) == 0) {
      fVar32 = 0.0;
      lVar22 = 0;
      if (0xf < iVar47) {
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00112998;
...
{
  *(undefined ***)this = &PTR__gen_argument_type_001129f8;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__initialize_classv_001126d8;
...
LAB_0010f548:
    ...
    local_30 = 6;
    if (local_40 != 0x11) goto LAB_0010f548;
...
/* WARNING: Removing unreachable block (ram,0x0010fcc8) */
/* WARNING: Removing unreachable block (ram,0x0010fe90) */
/* WARNING: Removing unreachable block (ram,0x0010fcd4) */
/* WARNING: Removing unreachable block (ram,0x0010fcde) */
/* WARNING: Removing unreachable block (ram,0x0010fe70) */
/* WARNING: Removing unreachable block (ram,0x0010fcea) */
/* WARNING: Removing unreachable block (ram,0x0010fcf4) */
/* WARNING: Removing unreachable block (ram,0x0010fe50) */
/* WARNING: Removing unreachable block (ram,0x0010fd00) */
/* WARNING: Removing unreachable block (ram,0x0010fd0a) */
/* WARNING: Removing unreachable block (ram,0x0010fe30) */
/* WARNING: Removing unreachable block (ram,0x0010fd16) */
/* WARNING: Removing unreachable block (ram,0x0010fd20) */
/* WARNING: Removing unreachable block (ram,0x0010fe10) */
/* WARNING: Removing unreachable block (ram,0x0010fd2c) */
/* WARNING: Removing unreachable block (ram,0x0010fd36) */
/* WARNING: Removing unreachable block (ram,0x0010fdf0) */
/* WARNING: Removing unreachable block (ram,0x0010fd42) */
/* WARNING: Removing unreachable block (ram,0x0010fd4c) */
/* WARNING: Removing unreachable block (ram,0x0010fdd0) */
/* WARNING: Removing unreachable block (ram,0x0010fd54) */
/* WARNING: Removing unreachable block (ram,0x0010fd6a) */
...

{
  ...
  *(undefined ***)this_00 = &PTR__initialize_classv_00112838;
  ...
  if (cVar1 == '\0') {
    ...
    *(undefined8 *)this = 0;
    ...
    pOVar3 = *(Object **)this;
    pOVar2 = pOVar3;
    if (this_00 == (RefCounted *)pOVar3) goto LAB_0010ff75;
    *(RefCounted **)this = this_00;
    ...
    if (((pOVar3 == (Object *)0x0) || (cVar1 = RefCounted::unreference(), cVar1 == '\0')) ||
       (cVar1 = predelete_handler(pOVar3), cVar1 == '\0')) goto LAB_0010ff75;
  }
...
LAB_001109d0:
  ...
  uVar6 = uVar6 | uVar6 >> 0x10;
  uVar6 = uVar6 | uVar6 >> 0x20;
  if (uVar6 == 0xffffffffffffffff) goto LAB_001109d0;
  if (param_1 <= lVar9) {
    puVar7 = *(undefined8 **)this;
    uVar8 = param_1;
...
LAB_00110859:
        if (uVar6 + 1 != lVar5) {
          ...
          if (puVar4 == (undefined8 *)0x0) goto LAB_001109ff;
          puVar7 = puVar4 + 2;
          *puVar4 = 1;
          *(undefined8 **)this = puVar7;
        }
      ...
      while( true ) {
        ...
        if (*plVar2 != 0) break;
        uVar8 = uVar8 + 1;
        if ((ulong)puVar7[-1] <= uVar8) goto LAB_00110859;
      }
      LOCK();
...
LAB_00110a4d:
  ...
  if (uVar6 + 1 == lVar5) {
    puVar7 = *(undefined8 **)this;
    if (puVar7 == (undefined8 *)0x0) goto LAB_00110a4d;
    lVar9 = puVar7[-1];
LAB_00110930:
    if (param_1 <= lVar9) goto LAB_001108e5;
  }
  else {
    if (lVar9 != 0) {
      puVar4 = (undefined8 *)
...
LAB_00110db0:
  ...
  uVar4 = uVar4 | uVar4 >> 0x10;
  uVar4 = uVar4 | uVar4 >> 0x20;
  if (uVar4 == 0xffffffffffffffff) goto LAB_00110db0;
  if (param_1 <= lVar7) {
    puVar5 = *(undefined8 **)this;
    uVar6 = param_1;
...
LAB_00110c5a:
        if (uVar4 + 1 != lVar3) {
          ...
          if (puVar2 == (undefined8 *)0x0) goto LAB_00110ddf;
          puVar5 = puVar2 + 2;
          *puVar2 = 1;
          *(undefined8 **)this = puVar5;
        }
      ...
      while ((StringName::configured == '\0' || (puVar5[uVar6] == 0))) {
        uVar6 = uVar6 + 1;
        if ((ulong)puVar5[-1] <= uVar6) goto LAB_00110c5a;
      }
      uVar6 = uVar6 + 1;
      StringName::unref();
      puVar5 = *(undefined8 **)this;
...
LAB_00110c2a:
  ...
  if (uVar4 + 1 == lVar3) {
    puVar5 = *(undefined8 **)this;
    if (puVar5 == (undefined8 *)0x0) goto LAB_00110c2a;
    lVar7 = puVar5[-1];
LAB_00110d10:
    if (param_1 <= lVar7) goto LAB_00110cbd;
  }
  else {
    if (lVar7 != 0) {
      puVar2 = (undefined8 *)
...

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialize_class()::initialized != '\0') goto LAB_00110f89;
...
LAB_001110aa:
      ...
      *plVar1 = *plVar1 + -1;
      UNLOCK();
      if (*plVar1 != 0) goto LAB_0011109a;
      local_58 = 0;
      Memory::free_static((void *)(lVar2 + -0x10),false);
      if ((code *)_GLOBAL_OFFSET_TABLE_ != Object::_bind_methods) goto LAB_001110aa;
    }
...
/* WARNING: Removing unreachable block (ram,0x00111238) */
/* WARNING: Removing unreachable block (ram,0x00111368) */
/* WARNING: Removing unreachable block (ram,0x00111530) */
/* WARNING: Removing unreachable block (ram,0x00111374) */
/* WARNING: Removing unreachable block (ram,0x0011137e) */
/* WARNING: Removing unreachable block (ram,0x00111510) */
/* WARNING: Removing unreachable block (ram,0x0011138a) */
/* WARNING: Removing unreachable block (ram,0x00111394) */
/* WARNING: Removing unreachable block (ram,0x001114f0) */
/* WARNING: Removing unreachable block (ram,0x001113a0) */
/* WARNING: Removing unreachable block (ram,0x001113aa) */
/* WARNING: Removing unreachable block (ram,0x001114d0) */
/* WARNING: Removing unreachable block (ram,0x001113b6) */
/* WARNING: Removing unreachable block (ram,0x001113c0) */
/* WARNING: Removing unreachable block (ram,0x001114b0) */
/* WARNING: Removing unreachable block (ram,0x001113cc) */
/* WARNING: Removing unreachable block (ram,0x001113d6) */
/* WARNING: Removing unreachable block (ram,0x00111490) */
/* WARNING: Removing unreachable block (ram,0x001113e2) */
/* WARNING: Removing unreachable block (ram,0x001113ec) */
/* WARNING: Removing unreachable block (ram,0x00111470) */
/* WARNING: Removing unreachable block (ram,0x001113f4) */
/* WARNING: Removing unreachable block (ram,0x0011140a) */
...

{
  ...
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00111e09. Too many branches */
...

{
  ...
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00112028. Too many branches */
                    /* WARNING: Treating indirect jump as call */

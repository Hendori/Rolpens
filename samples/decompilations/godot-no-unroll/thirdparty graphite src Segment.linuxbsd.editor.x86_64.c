...

{
  ...
  for (lVar7 = (long)param_1 * 0x20 + lVar2; lVar7 != ((long)param_1 + param_2) * 0x20 + lVar2;
      lVar7 = lVar7 + 0x20) {
    *(undefined8 *)(lVar7 + 4) = uVar5;
  }
  ...
  if (plVar8 != (long *)0x0) {
    do {
      ...
      uVar9 = (ulong)uVar13;
      if ((-1 < (int)uVar13) && (iVar1 = *(int *)((long)plVar10 + 0x1c), (int)uVar13 <= iVar1)) {
        uVar3 = *(ulong *)(this + 0xb8);
        lVar7 = uVar9 * 0x20 + lVar2;
        do {
          if (uVar3 <= uVar9) {
          ...
          if ((iVar11 < *(int *)(lVar7 + 4)) || (*(int *)(lVar7 + 4) == -1)) {
            *(int *)(lVar7 + 4) = iVar11;
          }
          if (*(int *)(lVar7 + 8) < iVar11) {
            *(int *)(lVar7 + 8) = iVar11;
          }
          uVar9 = uVar9 + 1;
          lVar7 = lVar7 + 0x20;
      ...
      *(int *)(plVar10 + 4) = iVar11;
      plVar10 = (long *)*plVar10;
      iVar11 = iVar11 + 1;
    } while (plVar10 != (long *)0x0);
    uVar13 = param_1 + (int)param_2;
LAB_00100fe0:
    do {
      uVar12 = *(uint *)((long)plVar8 + 0x1c);
      if ((int)(uVar12 + 1) < (int)uVar13) {
        ...
        do {
          ...
          lVar7 = (ulong)uVar12 * 0x20 + lVar2;
          if (-1 < *(int *)(lVar7 + 8)) {
            uVar12 = uVar12 - 1;
            break;
          }
          *(int *)(lVar7 + 8) = (int)plVar8[4];
          uVar6 = uVar12 + 1;
        } while (uVar13 != uVar12 + 1);
      }
      *(uint *)((long)plVar8 + 0x1c) = uVar12;
      uVar12 = *(uint *)(plVar8 + 3);
      if (param_1 <= (int)(uVar12 - 1)) {
        uVar9 = *(ulong *)(this + 0xb8);
        uVar6 = uVar12 - 1;
        do {
          uVar12 = uVar6;
          ...
          *(int *)(lVar7 + 4) = (int)plVar8[4];
          uVar6 = uVar12 - 1;
        } while (param_1 <= (int)(uVar12 - 1));
      }
      *(uint *)(plVar8 + 3) = uVar12;
      plVar8 = (long *)*plVar8;
...

{
  ...
  if (pauVar6 == *(undefined1 (**) [16])(this + 0x10)) {
    ...
    uVar2 = (lVar7 >> 5) + 1;
    if (uVar2 <= (ulong)(lVar7 >> 5)) goto LAB_00101512;
    if (uVar2 >> 0x3b != 0) goto LAB_00101628;
    pvVar4 = realloc(*(void **)this,uVar2 * 0x20);
    *(void **)this = pvVar4;
    if (pvVar4 == (void *)0x0) goto LAB_00101628;

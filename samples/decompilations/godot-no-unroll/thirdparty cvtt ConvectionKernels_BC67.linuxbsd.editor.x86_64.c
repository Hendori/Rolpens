...

{
  ...
  do {
    uVar25 = (uint)lVar14;
    pbVar2 = param_2 + lVar14;
    lVar14 = lVar14 + 1;
    *(uint *)(auStack_c4 + (long)((int)uVar25 >> 2) * 4 + -4) =
         *(uint *)(auStack_c4 + (long)((int)uVar25 >> 2) * 4 + -4) |
         (uint)*pbVar2 << (sbyte)((uVar25 & 3) << 3);
    uVar25 = local_c8;
  } while (lVar14 != 0x10);
  puVar20 = (uint *)(auStack_c4 + 8);
  uVar10 = local_c8 >> 2;
  uVar24 = local_c8 & 3;
  local_c8 = uVar10;
  puVar21 = &local_c8;
  ...
  if ((uVar25 & 2) != 0) {
    ...
    uVar32 = 5;
    uVar24 = uVar24 | (uVar11 & 7) << 2;
  }
  puVar22 = &BC7Data::g_hdrModes;
  iVar12 = 0;
LAB_00102480:
  if (*puVar22 != uVar24) goto code_r0x00102487;
  lVar26 = (long)iVar12;
  local_b8 = (undefined1  [16])0x0;
  cVar3 = (&DAT_0010c462)[lVar26 * 0x14];
  local_a8 = (undefined1  [16])0x0;
  local_98 = (undefined1  [16])0x0;
  lVar14 = lVar26 * 0x290;
  puVar21 = (uint *)(local_b8 + 0xc);
  do {
    uVar25 = local_c8;
    if (*(uint *)(BC6HData::g_modeDescriptors + uVar32 * 8 + lVar14) < 0xf) {
                    /* WARNING: Could not recover jumptable at 0x00102569. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      (*(code *)(&DAT_00115ce0 +
                *(int *)(&DAT_00115ce0 +
                        (ulong)*(uint *)(BC6HData::g_modeDescriptors + uVar32 * 8 + lVar14) * 4)))
                (uVar10,lVar26,
                 &DAT_00115ce0 +
                 *(int *)(&DAT_00115ce0 +
                         (ulong)*(uint *)(BC6HData::g_modeDescriptors + uVar32 * 8 + lVar14) * 4));
    ...
    uRam0000000000000000 =
         uRam0000000000000000 | (uVar25 & 1) << (*(byte *)(lVar14 + 0x117b04 + lVar33) & 0x1f);
  } while (uVar32 < (-(ulong)(cVar3 == '\0') & 0xffffffffffffffef) + 0x52);
  if (cVar3 == '\0') {
    local_dc = 1;
    uVar10 = 7;
    local_ee = 0xf;
  ...
  sVar7 = (sbyte)iVar12;
  do {
    if (((int)lVar14 == 0) || (local_10c == (int)lVar14)) {
      uVar30 = (ushort)local_c8;
      uVar24 = local_c8 >> sVar35;
      local_c8 = uVar24;
      puVar18 = &local_c8;
      do {
        puVar19 = puVar18 + 1;
        uVar11 = (puVar18[1] & uVar10) << (-sVar35 & 0x1fU) | uVar24;
        uVar24 = puVar18[1] >> sVar35;
        *puVar18 = uVar11;
        *puVar19 = uVar24;
        puVar18 = puVar19;
      } while (puVar19 != puVar20);
      uVar24 = (uint)(local_f0 & uVar30);
    }
    else {
      uVar24 = local_ee & local_c8;
      uVar11 = local_c8 >> sVar7;
      local_c8 = uVar11;
      puVar18 = &local_c8;
      do {
        puVar19 = puVar18 + 1;
        *puVar18 = (puVar18[1] & uVar25) << (0x20U - sVar7 & 0x1f) | uVar11;
        uVar11 = *puVar19 >> sVar7;
        *puVar19 = uVar11;
        puVar18 = puVar19;
      } while (puVar19 != puVar20);
    }
    local_88[lVar14] = uVar24;
    lVar14 = lVar14 + 1;
  } while (lVar14 != 0x10);
  puVar27 = &BC7Data::g_hdrModes + lVar26 * 10;
  iVar31 = *(int *)(&DAT_0010c464 + lVar26 * 0x14);
  cVar4 = (&DAT_0010c463)[lVar26 * 0x14];
  uVar25 = iVar31 - 1;
  bVar15 = (byte)iVar31;
  bVar16 = (byte)uVar25;
  if (cVar3 == '\0') {
    ...
    do {
      if ((1 << (bVar16 & 0x1f) & *puVar20) != 0) {
        *puVar20 = -1 << (bVar15 & 0x1f) | *puVar20;
      }
      while( true ) {
        if ((puVar20[3] >> (*(int *)(puVar27 + 4) - 1U & 0x1f) & 1) != 0) {
          puVar20[3] = -(1 << ((byte)*(int *)(puVar27 + 4) & 0x1f)) | puVar20[3];
        }
        puVar20 = puVar20 + 1;
        puVar27 = puVar27 + 2;
        if (puVar21 == puVar20) goto LAB_0010278a;
        if (param_3) break;
LAB_00102c77:
        if (cVar4 == '\0') goto LAB_00102c7c;
      }
    } while( true );
  }
  puVar20 = (uint *)local_b8;
  while (param_3) {
    if ((*puVar20 & 1 << (bVar16 & 0x1f)) != 0) {
      *puVar20 = -1 << (bVar15 & 0x1f) | *puVar20;
    }
LAB_00102722:
    uVar10 = *(int *)(puVar27 + 4) - 1;
    bVar17 = (byte)*(int *)(puVar27 + 4);
    if ((puVar20[3] >> (uVar10 & 0x1f) & 1) != 0) {
      puVar20[3] = -(1 << (bVar17 & 0x1f)) | puVar20[3];
    }
    if ((puVar20[6] >> (uVar10 & 0x1f) & 1) != 0) {
      puVar20[6] = -(1 << (bVar17 & 0x1f)) | puVar20[6];
    }
    if ((puVar20[9] >> (uVar10 & 0x1f) & 1) != 0) {
      puVar20[9] = -(1 << (bVar17 & 0x1f)) | puVar20[9];
    }
    puVar20 = puVar20 + 1;
    puVar27 = puVar27 + 2;
    if (puVar20 == puVar21) {
LAB_0010278a:
      if (cVar4 != '\0') {
        iVar23 = 1 << (bVar15 & 0x1f);
        uVar10 = iVar23 - 1;
        puVar20 = (uint *)local_b8;
        do {
          uVar24 = *puVar20;
          uVar11 = puVar20[3] + uVar24 & uVar10;
          puVar20[3] = uVar11;
          if (param_3) {
            if ((uVar11 & 1 << (bVar16 & 0x1f)) != 0) {
              puVar20[3] = uVar11 | -iVar23;
            }
            if (cVar3 != '\0') {
              uVar11 = puVar20[6] + uVar24 & uVar10;
              uVar24 = uVar24 + puVar20[9] & uVar10;
              if ((uVar11 >> (uVar25 & 0x1f) & 1) != 0) {
                uVar11 = -iVar23 | uVar11;
              }
              uVar6 = -iVar23 | uVar24;
              if ((uVar24 >> (uVar25 & 0x1f) & 1) == 0) {
                uVar6 = uVar24;
              }
              puVar20[6] = uVar11;
              puVar20[9] = uVar6;
            ...
            puVar20[6] = puVar20[6] + uVar24 & uVar10;
            puVar20[9] = uVar24 + puVar20[9] & uVar10;
          }
          puVar20 = puVar20 + 1;
...
LAB_0010281d:
  ...
  lVar26 = 0;
LAB_00102859:
  piVar29 = (int *)((long)local_b8 + lVar26);
  iVar23 = 2;
  do {
    iVar13 = 3;
    piVar28 = piVar29;
    if (param_3) {
      ...
      do {
        while (iVar31 < 0x10) {
          ...
          if (iVar5 < 0) {
            iVar34 = -0x7fff;
            if (-iVar5 < (1 << (bVar16 & 0x1f)) + -1) {
              iVar34 = -(iVar5 * -0x8000 + 0x4000 >> (bVar16 & 0x1f));
            }
          }
          else {
            iVar34 = iVar5;
          ...
          *piVar28 = iVar34;
          iVar13 = iVar13 + -1;
          if (iVar13 == 0) goto joined_r0x001028c2;
          piVar28 = piVar28 + 1;
        }
        piVar28 = piVar28 + 1;
        iVar13 = iVar13 + -1;
...
LAB_00102878:
      do {
        if ((iVar31 < 0xf) && (iVar5 = *piVar28, iVar5 != 0)) {
          if (iVar5 != (1 << (bVar15 & 0x1f)) + -1) {
            *piVar28 = iVar5 * 0x10000 + 0x8000 >> (bVar15 & 0x1f);
            iVar13 = iVar13 + -1;
            piVar28 = piVar28 + 1;
            if (iVar13 == 0) break;
            goto LAB_00102878;
...
code_r0x00102487:
  iVar12 = iVar12 + 1;
  puVar22 = puVar22 + 10;
  if (iVar12 == 0xe) goto code_r0x00102493;
  goto LAB_00102480;
code_r0x00102493:
  pPVar1 = param_1 + 0x80;
  do {
...
LAB_00102900:
  lVar26 = lVar26 + 0x18;
  if (lVar14 == lVar26) goto code_r0x0010290d;
  goto LAB_00102859;
code_r0x0010290d:
  lVar14 = *(long *)(BC7Data::g_weightTables + (long)iVar12 * 8);
  lVar26 = 0;
  do {
    uVar25 = 0;
    if (cVar3 != '\0') {
      uVar25 = (int)(uint)BC7Data::g_partitionMap >> ((byte)lVar26 & 0x1f) & 1;
    }
    lVar33 = 0;
    iVar12 = *(int *)(lVar14 + (long)(int)local_88[lVar26] * 4);
    piVar29 = (int *)((ulong)(-uVar25 & 0x18) + (long)local_b8);
    do {
      iVar31 = piVar29[3] * iVar12 + 0x20 + *piVar29 * (0x40 - iVar12) >> 6;
      if (param_3) {
        if (iVar31 < 0) {
          iVar31 = iVar31 * -0x1f >> 5;
          uVar30 = (ushort)(iVar31 != 0) << 0xf;
        }
        else {
          iVar31 = iVar31 * 0x1f >> 5;
          uVar30 = 0;
        }
        uVar30 = uVar30 | (ushort)iVar31;
      }
      else {
        uVar30 = (ushort)(iVar31 * 0x1f >> 6);
      }
      *(ushort *)(param_1 + lVar33 * 2) = uVar30;
      lVar33 = lVar33 + 1;
      piVar29 = piVar29 + 1;
    } while (lVar33 != 3);
    lVar26 = lVar26 + 1;

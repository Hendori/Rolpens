...
/* RenderingDeviceGraph::_check_discardable_attachment_dependency(RenderingDeviceGraph::ResourceTracker*,
   int, int) [clone .part.0] */

void __thiscall
RenderingDeviceGraph::_check_discardable_attachment_dependency
          (RenderingDeviceGraph *this,ResourceTracker *param_1,int param_2,int param_3)

{
    ...
    if (uVar4 < uVar3) {
      ...
      if (*piVar1 == 6) {
        ...
        if (piVar1[0x21] != 0) {
          ...
          do {
            if ((*(ResourceTracker **)
                  ((uVar6 * -0x10 - (long)piVar1) + (long)piVar7 * 2 + uVar8 * -0x10 + -0x90) ==
                 param_1) && (*piVar7 == 1)) {
              return;
            }
            piVar7 = piVar7 + 1;
        ...
        if (uVar2 < uVar3) {
          ...
          if (*piVar1 == 6) {
            ...
            if (uVar2 != 0) {
              ...
              do {
                if (param_1 ==
                    *(ResourceTracker **)(piVar1 + (ulong)(uint)piVar1[0x20] * 4 + uVar6 * 2 + 0x24)
                   ) {
  ...
  _err_print_index_error
            ("operator[]","./core/templates/local_vector.h",0xb2,uVar6,(ulong)uVar3,"p_index",
             "count","",false,true);
  _err_flush_stdout();
...
/* LocalVector<RenderingDeviceGraph::AttachmentOperation, unsigned int, false,
   false>::resize(unsigned int) [clone .part.0] */

void LocalVector<RenderingDeviceGraph::AttachmentOperation,unsigned_int,false,false>::resize
               (uint param_1)
...
void __thiscall
SortArray<RenderingDeviceGraph::RecordedCommandSort,_DefaultComparator<RenderingDeviceGraph::RecordedCommandSort>,true>
::adjust_heap(SortArray<RenderingDeviceGraph::RecordedCommandSort,_DefaultComparator<RenderingDeviceGraph::RecordedCommandSort>,true>
              *this,long param_1,long param_2,undefined8 param_3,uint param_5,long param_6)
      ...
      if (*puVar4 <= *puVar5) {
        if (*puVar5 <= *puVar4) {
          if ((puVar5[1] < puVar4[1]) ||
             ((puVar5[1] <= puVar4[1] && ((int)puVar5[2] < (int)puVar4[2])))) goto LAB_00100243;
        }
        lVar3 = lVar6 + 1;
        lVar2 = lVar6;
        puVar4 = puVar5;
...
/* SortArray<RenderingDeviceGraph::RecordedCommandSort,
   ...
   RenderingDeviceGraph::RecordedCommandSort*, long) const [clone .isra.0] */

void SortArray<RenderingDeviceGraph::RecordedCommandSort,_DefaultComparator<RenderingDeviceGraph::RecordedCommandSort>,true>
     ::introsort(long param_1,long param_2,RecordedCommandSort_conflict *param_3,long param_4)
...
LAB_00100490:
        ...
        if (uVar7 <= uVar8) {
          ...
          if ((uVar10 <= *(uint *)(pRVar1 + 4)) &&
             (uVar12 = *(uint *)(pRVar15 + 8), (int)uVar12 < (int)*(uint *)(pRVar1 + 8)))
          goto LAB_001005d0;
        }
        if (uVar8 <= uVar2) {
          ...
          if ((uVar9 <= uVar10) && (uVar12 = *(uint *)(pRVar1 + 8), (int)uVar11 < (int)uVar12))
          goto LAB_001005d0;
LAB_00100501:
          uVar7 = uVar2;
          uVar10 = uVar9;
        ...
        if (uVar2 <= uVar7) {
          if ((*(uint *)(pRVar14 + 4) < *(uint *)(pRVar15 + 4)) ||
             ((*(uint *)(pRVar14 + 4) <= *(uint *)(pRVar15 + 4) &&
              ((int)*(uint *)(pRVar14 + 8) < (int)*(uint *)(pRVar15 + 8))))) goto LAB_00100490;
        }
        uVar8 = *(uint *)pRVar1;
        if (uVar2 < uVar8) {
          uVar12 = *(uint *)(pRVar14 + 8);
        ...
        if (uVar2 <= uVar8) {
          ...
          if ((*(uint *)(pRVar1 + 4) < uVar9) ||
             (uVar11 = *(uint *)(pRVar14 + 8), (int)*(uint *)(pRVar1 + 8) <= (int)uVar11))
          goto LAB_00100441;
          goto LAB_00100501;
        }
LAB_00100441:
...
LAB_001005d0:
      ...
      param_2 = param_1;
      do {
        if ((*(uint *)pRVar15 < uVar7) ||
           ((*(uint *)pRVar15 <= uVar7 &&
            ((*(uint *)(pRVar15 + 4) < uVar10 ||
             ((*(uint *)(pRVar15 + 4) <= uVar10 && ((int)*(uint *)(pRVar15 + 8) < (int)uVar12)))))))
           ) {
          if (lVar6 + -1 == param_2) {
...
LAB_0010062a:
          pRVar1 = param_3 + lVar13 * 0xc + -0xc;
          do {
            pRVar5 = pRVar1;
            lVar13 = lVar13 + -1;
            if ((*(uint *)pRVar5 <= uVar7) &&
               ((*(uint *)pRVar5 < uVar7 ||
                ((*(uint *)(pRVar5 + 4) <= uVar10 &&
                 ((*(uint *)(pRVar5 + 4) < uVar10 || ((int)*(uint *)(pRVar5 + 8) <= (int)uVar12)))))
          ...
          _err_print_error("partitioner","./core/templates/sort_array.h",0xb9,
                           "bad comparison function; sorting will be broken",0,0);
joined_r0x00100670:
          if (lVar13 <= param_2) goto LAB_001006e6;
...
LAB_00100515:
    ...
    while( true ) {
      ...
      pRVar14 = pRVar14 + -0xc;
      adjust_heap((SortArray<RenderingDeviceGraph::RecordedCommandSort,_DefaultComparator<RenderingDeviceGraph::RecordedCommandSort>,true>
                   *)param_1,lVar6,lVar13,uVar3,*(undefined4 *)pRVar15);
      if (lVar6 == 0) break;
      lVar6 = lVar6 + -1;
    }
...
/* RenderingDeviceGraph::_boost_priority_for_render_commands(RenderingDeviceGraph::RecordedCommandSort*,
   unsigned int, unsigned int&) [clone .part.0] */

void RenderingDeviceGraph::_boost_priority_for_render_commands
               (RecordedCommandSort_conflict *param_1,uint param_2,uint *param_3)
  ...
  if ((uVar5 != 0) && (param_2 != 0)) {
    ...
    if (bVar3) {
      if (uVar8 == 1) {
        ...
        SortArray<RenderingDeviceGraph::RecordedCommandSort,_DefaultComparator<RenderingDeviceGraph::RecordedCommandSort>,true>
        ::introsort(0,uVar8,param_1,lVar6 * 2);
        if (uVar8 < 0x11) {
          uVar9 = 1;
          pRVar4 = param_1 + 0xc;
          do {
            ...
            if ((uVar5 < *(uint *)param_1) ||
               ((uVar12 = (uint)((ulong)uVar1 >> 0x20), uVar11 = uVar9, pRVar7 = pRVar4,
                uVar5 <= *(uint *)param_1 &&
                ((uVar12 < *(uint *)(param_1 + 4) ||
                 ((uVar12 <= *(uint *)(param_1 + 4) && (iVar2 < *(int *)(param_1 + 8))))))))) {
              ...
              *(undefined8 *)param_1 = uVar1;
              ...
              while( true ) {
                if ((*(uint *)(pRVar7 + -0xc) <= uVar5) &&
                   ((*(uint *)(pRVar7 + -0xc) < uVar5 ||
                    ((*(uint *)(pRVar7 + -8) <= uVar12 &&
                     ((*(uint *)(pRVar7 + -8) < uVar12 || (*(int *)(pRVar7 + -4) <= iVar2))))))))
                goto LAB_00100bc7;
                if (uVar11 == 1) break;
...
LAB_00100bc7:
          ...
          do {
            ...
            uVar5 = (uint)uVar1;
            if ((uVar5 < *(uint *)param_1) ||
               ((uVar12 = (uint)((ulong)uVar1 >> 0x20), pRVar7 = pRVar4, lVar10 = lVar6,
                uVar5 <= *(uint *)param_1 &&
                ((uVar12 < *(uint *)(param_1 + 4) ||
                 ((uVar12 <= *(uint *)(param_1 + 4) && (iVar2 < *(int *)(param_1 + 8))))))))) {
              memmove(param_1 + 0xc,param_1,(long)pRVar4 - (long)param_1);
              ...
              *(undefined8 *)param_1 = uVar1;
              ...
              _err_print_error("unguarded_linear_insert","./core/templates/sort_array.h",0xff,
                               "bad comparison function; sorting will be broken",0,0);
LAB_0010095b:
              *(int *)(param_1 + lVar10 * 0xc + 8) = iVar2;
          ...
          do {
            ...
            uVar11 = uVar9;
            while( true ) {
              if ((*(uint *)(pRVar7 + -0xc) <= (uint)uVar1) &&
                 ((*(uint *)(pRVar7 + -0xc) < (uint)uVar1 ||
                  ((*(uint *)(pRVar7 + -8) <= uVar5 &&
                   ((*(uint *)(pRVar7 + -8) < uVar5 || (*(int *)(pRVar7 + -4) <= iVar2))))))))
              goto LAB_00100a17;
              if (uVar11 == 1) break;
              uVar11 = uVar11 - 1;
              *(undefined8 *)pRVar7 = *(undefined8 *)(pRVar7 + -0xc);
...
/* RenderingDeviceGraph::_check_command_intersection(RenderingDeviceGraph::ResourceTracker*, int,
   int) const [clone .part.0] */

bool RenderingDeviceGraph::_check_command_intersection
               (ResourceTracker *param_1,int param_2,int param_3)

{
    ...
    if ((uint)param_3 < uVar3) {
      ...
      if (uVar4 < uVar3) {
        ...
        if (uVar5 < uVar3) {
          bVar8 = true;
          if ((*piVar1 == 6) &&
             (piVar2 = (int *)(*(long *)(param_1 + 0x38) + (ulong)uVar5), *piVar2 == 6)) {
            if ((piVar1[0x1e] < 0) ||
               (((piVar1[0x1f] < 0 || (iVar7 = piVar2[0x1e], iVar7 < 0)) || (piVar2[0x1f] < 0)))) {
            ...
            bVar8 = false;
            if ((piVar1[0x1c] < iVar7 + piVar2[0x1c]) &&
               (piVar2[0x1c] < piVar1[0x1c] + piVar1[0x1e])) {
  ...
  _err_print_index_error
            ("operator[]","./core/templates/local_vector.h",0xae,uVar9,uVar10,"p_index","count","",
             false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
...
void __thiscall RenderingDeviceGraph::RenderingDeviceGraph(RenderingDeviceGraph *this)
...
/* RenderingDeviceGraph::_is_write_usage(RenderingDeviceGraph::ResourceUsage) */

undefined8 RenderingDeviceGraph::_is_write_usage(uint param_1)
...
/* RenderingDeviceGraph::_usage_to_image_layout(RenderingDeviceGraph::ResourceUsage) */

undefined4 RenderingDeviceGraph::_usage_to_image_layout(int param_1)
...
/* RenderingDeviceGraph::_usage_to_access_bits(RenderingDeviceGraph::ResourceUsage) */

undefined4 RenderingDeviceGraph::_usage_to_access_bits(int param_1)
...
RenderingDeviceGraph::_check_command_intersection
          (RenderingDeviceGraph *this,ResourceTracker *param_1,int param_2,int param_3)
...
bool __thiscall
RenderingDeviceGraph::_check_command_partial_coverage
          (RenderingDeviceGraph *this,ResourceTracker *param_1,int param_2)

{
  ...
  if ((uint)param_2 < *(uint *)(this + 0x40)) {
    ...
    if (uVar1 < *(uint *)(this + 0x30)) {
      ...
      if (*piVar5 == 6) {
        ...
        if ((piVar5[0x1e] < 0) || ((int)(uVar1 | uVar2 | piVar5[0x1f]) < 0)) {
          _err_print_error("encloses","./core/math/rect2i.h",0x4e,
                           "Rect2i size is negative, this is not supported. Use Rect2i.abs() to get a Rect2i with a positive size."
                           ,0,0);
        }
        bVar4 = true;
        if (((piVar5[0x1c] < 1) && (piVar5[0x1d] < 1)) &&
           ((int)uVar1 <= piVar5[0x1c] + piVar5[0x1e])) {
    ...
    _err_print_index_error
              ("operator[]","./core/templates/local_vector.h",0xae,(ulong)uVar1,
               (ulong)*(uint *)(this + 0x30),"p_index","count","",false,true);
    _err_flush_stdout();
                    /* WARNING: Does not return */
  ...
  _err_print_index_error
            ("operator[]","./core/templates/local_vector.h",0xae,(ulong)(uint)param_2,
             (ulong)*(uint *)(this + 0x40),"p_index","count","",false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar3 = (code *)invalidInstructionException();
  (*pcVar3)();
...
/* RenderingDeviceGraph::_add_to_command_list(int, int) */

uint __thiscall
RenderingDeviceGraph::_add_to_command_list(RenderingDeviceGraph *this,int param_1,int param_2)
...
LAB_00101305:
    _err_print_index_error
              ("operator[]","./core/templates/local_vector.h",0xb2,(ulong)uVar3,(ulong)uVar6,
  ...
  uVar6 = uVar3;
  if (uVar1 <= uVar3) goto LAB_00101305;
  ...
  if (*(uint *)(this + 0x194) < uVar1) {
    ...
    *(uint *)(this + 0x194) = uVar6;
    pvVar8 = (void *)Memory::realloc_static(pvVar8,(ulong)uVar6 * 8,false);
    *(void **)(this + 0x198) = pvVar8;
    if (pvVar8 == (void *)0x0) {
                    /* WARNING: Subroutine does not return */
      LocalVector<RenderingDeviceGraph::AttachmentOperation,unsigned_int,false,false>::resize(0);
    }
    uVar6 = *(uint *)(this + 400);
    if (uVar1 <= uVar6) goto LAB_0010139c;
  }
  uVar5 = _LC17;
  puVar7 = (undefined8 *)((long)pvVar8 + (ulong)uVar6 * 8);
  do {
    *puVar7 = uVar5;
    puVar7 = puVar7 + 1;
  } while (puVar7 != (undefined8 *)((long)pvVar8 + ((ulong)(uVar3 - uVar6) + (ulong)uVar6) * 8 + 8))
  ;
LAB_0010139c:
  *(uint *)(this + 400) = uVar1;
  piVar2 = (int *)((long)pvVar8 + (ulong)uVar3 * 8);
  *piVar2 = param_1;
  piVar2[1] = param_2;
  return uVar3;
}
...
/* RenderingDeviceGraph::_add_adjacent_command(int, int, RenderingDeviceGraph::RecordedCommand*) */

void __thiscall
RenderingDeviceGraph::_add_adjacent_command
          (RenderingDeviceGraph *this,int param_1,int param_2,RecordedCommand *param_3)
...
/* RenderingDeviceGraph::_add_to_slice_read_list(int, Rect2i, int) */

uint RenderingDeviceGraph::_add_to_slice_read_list
...
LAB_0010150b:
  ...
  uVar6 = uVar3;
  if (uVar1 <= uVar3) goto LAB_0010150b;
  ...
  if (*(uint *)(param_1 + 0x1a4) < uVar1) {
    ...
    *(void **)(param_1 + 0x1a8) = pvVar9;
    ...
    if (uVar1 <= uVar6) goto LAB_001015d0;
  }
  uVar5 = _LC17;
  ...
  do {
    ...
    *(undefined1 *)(puVar7 + 3) = 0;
    puVar7 = puVar8;
                     ...
                     ((long)pvVar9 + ((ulong)(uVar3 - uVar6) + (ulong)uVar6) * 0x1c + 0x1c));
LAB_001015d0:
  *(uint *)(param_1 + 0x1a0) = uVar1;
...
/* RenderingDeviceGraph::_add_to_write_list(int, Rect2i, int, bool) */

uint RenderingDeviceGraph::_add_to_write_list
               (long param_1,undefined4 param_2,undefined8 param_3,undefined8 param_4,
...
LAB_001016cb:
  ...
  uVar6 = uVar3;
  if (uVar1 <= uVar3) goto LAB_001016cb;
  ...
  if (*(uint *)(param_1 + 0x1b4) < uVar1) {
    ...
    *(void **)(param_1 + 0x1b8) = pvVar9;
    ...
    if (uVar1 <= uVar6) goto LAB_00101790;
  }
  uVar5 = _LC17;
  puVar7 = (undefined8 *)((long)pvVar9 + (ulong)uVar6 * 0x1c);
  do {
...
/* RenderingDeviceGraph::_allocate_command(unsigned int, int&) */

void __thiscall
RenderingDeviceGraph::_allocate_command(RenderingDeviceGraph *this,uint param_1,int *param_2)

{
  ...
  *(uint *)((long)pvVar7 + (ulong)uVar10 * 4) = uVar9;
  if (*(uint *)(this + 0x30) <= uVar11) {
    if (uVar11 <= *(uint *)(this + 0x30)) goto LAB_001018b8;
    if (*(uint *)(this + 0x34) < uVar11) {
      ...
      *(long *)(this + 0x38) = lVar6;
      if (lVar6 == 0) {
                    /* WARNING: Subroutine does not return */
        LocalVector<RenderingDeviceGraph::AttachmentOperation,unsigned_int,false,false>::resize
                  ((uint)pvVar7);
      }
    }
  }
...
/* RenderingDeviceGraph::_allocate_draw_list_instruction(unsigned int) */

long __thiscall
RenderingDeviceGraph::_allocate_draw_list_instruction(RenderingDeviceGraph *this,uint param_1)

{
  ...
  _err_print_index_error
            ("operator[]","./core/templates/local_vector.h",0xb2,(ulong)uVar1,(ulong)uVar5,"p_index"
             ,"count","",false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar2 = (code *)invalidInstructionException();
...
/* RenderingDeviceGraph::_allocate_compute_list_instruction(unsigned int) */

long __thiscall
RenderingDeviceGraph::_allocate_compute_list_instruction(RenderingDeviceGraph *this,uint param_1)
...
/* RenderingDeviceGraph::_add_texture_barrier_to_command(RenderingDeviceDriver::TextureID,
   ...
   LocalVector<RenderingDeviceDriver::TextureBarrier, unsigned int, false, false>&, int&, int&) */
...
void RenderingDeviceGraph::_add_texture_barrier_to_command
               ...
               int param_6,undefined8 param_7,undefined8 param_8,undefined8 param_9,uint *param_10,
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* RenderingDeviceGraph::_add_buffer_barrier_to_command(RenderingDeviceDriver::BufferID,
   BitField<RenderingDeviceDriver::BarrierAccessBits>,
   BitField<RenderingDeviceDriver::BarrierAccessBits>, int&, int&) */

void __thiscall
RenderingDeviceGraph::_add_buffer_barrier_to_command
          (RenderingDeviceGraph *this,undefined8 *param_2,undefined8 param_3,undefined8 param_4,
...
void __thiscall
RenderingDeviceGraph::_add_command_to_graph
          (RenderingDeviceGraph *this,ResourceTracker **param_1,ResourceUsage *param_2,uint param_3,
          int param_4,RecordedCommand *param_5)
  ...
  *(undefined8 *)(param_5 + 0x40) = *(undefined8 *)(param_5 + 0x48);
  ...
  if (param_3 != 0) {
    ...
    do {
      ...
      if ((uVar25 < 0x12) && (bVar27 = (0x38514UL >> ((ulong)uVar25 & 0x3f) & 1) != 0, bVar27)) {
LAB_00102052:
        pRVar20 = *(ResourceTracker **)(pRVar3 + 0x80);
        local_c8 = (ulong)*(uint *)(CSWTCH_348 + (ulong)(uVar25 - 1) * 4);
        if (pRVar20 == (ResourceTracker *)0x0) goto LAB_001022fd;
LAB_00102071:
        if (lVar14 != *(long *)(pRVar20 + 8)) {
          ...
          *(undefined4 *)(pRVar20 + 0x20) = 0xffffffff;
          *(undefined4 *)(pRVar20 + 0x24) = 0xffffffff;
          *(undefined4 *)(pRVar20 + 0x28) = 0xffffffff;
          *(undefined4 *)(pRVar20 + 0x2c) = 0xffffffff;
        }
        ...
        if (uVar21 != 0) {
          ...
          if (RVar10 == (ResourceTracker)0x0) {
            if (*(long *)(pRVar20 + 0x88) != 0) {
              if ((((*(int *)(pRVar20 + 0xa0) < 0) || (*(int *)(pRVar20 + 0xa4) < 0)) ||
                  (iVar13 = *(int *)(pRVar3 + 0xa0), iVar13 < 0)) || (*(int *)(pRVar3 + 0xa4) < 0))
              {
                _err_print_error("intersects","./core/math/rect2i.h",0x38,
                                 "Rect2i size is negative, this is not supported. Use Rect2i.abs() to get a Rect2i with a positive size."
                                 ,0);
              ...
              auVar31._8_8_ = local_58._8_8_;
              auVar31._0_8_ = local_58._0_8_;
              if ((*(int *)(pRVar20 + 0x98) < iVar13 + *(int *)(pRVar3 + 0x98)) &&
                 (*(int *)(pRVar3 + 0x98) < *(int *)(pRVar20 + 0x98) + *(int *)(pRVar20 + 0xa0))) {
                if ((*(int *)(pRVar20 + 0x9c) < *(int *)(pRVar3 + 0xa4) + *(int *)(pRVar3 + 0x9c))
                   && (*(int *)(pRVar3 + 0x9c) < *(int *)(pRVar20 + 0x9c) + *(int *)(pRVar20 + 0xa4)
                      )) {
                  lVar14 = 0;
                  if (*(long *)(local_b0 + 0x88) != 0) {
                    ...
                    do {
                      ...
                      if (((*(int *)(lVar18 + 0xa0) < 0) || (*(int *)(lVar18 + 0xa4) < 0)) ||
                         ((iVar13 = *(int *)(pRVar3 + 0xa0), iVar13 < 0 ||
                          (*(int *)(pRVar3 + 0xa4) < 0)))) {
                        local_58 = auVar31;
                        _err_print_error("intersects","./core/math/rect2i.h",0x38,
                                         "Rect2i size is negative, this is not supported. Use Rect2i.abs() to get a Rect2i with a positive size."
                      ...
                      local_58 = auVar31;
                      if ((*(int *)(lVar18 + 0x98) < iVar13 + *(int *)(pRVar3 + 0x98)) &&
                         (*(int *)(pRVar3 + 0x98) <
                          *(int *)(lVar18 + 0x98) + *(int *)(lVar18 + 0xa0))) {
                        if ((*(int *)(pRVar3 + 0xa4) + *(int *)(pRVar3 + 0x9c) <=
                             *(int *)(lVar18 + 0x9c)) ||
                           (*(int *)(lVar18 + 0x9c) + *(int *)(lVar18 + 0xa4) <=
                            *(int *)(pRVar3 + 0x9c))) goto LAB_00102881;
                        if ((*(long *)(lVar18 + 8) == *(long *)(this + 0x28)) &&
                           (*(int *)(lVar18 + 0x7c) == param_4)) {
                          _err_print_error("_add_command_to_graph",
                                           "servers/rendering/rendering_device_graph.cpp",0x1c2,
                                           "Method/function failed.",
                                           "Texture slices that overlap can\'t be used in the same command."
                                           ,0,0);
                          goto LAB_001022a8;
                        }
                        if (*(long *)(lVar18 + 0x50) != 0) {
                          ...
                          _add_texture_barrier_to_command
                                    (this,&local_60,*(undefined8 *)(lVar18 + 0x40),local_c8,
                                     *(undefined4 *)(lVar18 + 0x3c),
                                     *(undefined4 *)(*(long *)(pRVar3 + 0x80) + 0x3c),
                                     *(undefined8 *)(lVar18 + 0x58),*(undefined8 *)(lVar18 + 0x60),
                                     *(undefined8 *)(lVar18 + 0x68),this + 0x50,param_5 + 0x18,
                                     param_5 + 0x1c);
...
LAB_00102881:
                        lVar14 = *(long *)(pRVar3 + 0x80);
                        if (bVar24) {
                          auVar31 = Rect2i::merge((Rect2i *)(lVar14 + 0x98),
                                                  (Rect2i *)(lVar18 + 0x98));
...
LAB_001028c6:
            uVar4 = *(undefined8 *)(local_b0 + 0x40);
            *(uint *)(pRVar3 + 0x3c) = uVar21;
            *(undefined8 *)(pRVar3 + 0x40) = uVar4;
            if (uVar25 == uVar21) goto LAB_001023e5;
...
LAB_00102929:
            ...
            if (local_b0 != (ResourceTracker *)0x0) goto LAB_001023e5;
            goto LAB_00102935;
          }
          if (uVar21 == uVar25) {
...
LAB_001023e5:
        ...
        if (*(long *)(pRVar20 + 0x50) != 0) {
          ...
          _add_texture_barrier_to_command
                    (this,&local_60,0,local_c8,0,uVar25,*(undefined1 (*) [16])(pRVar20 + 0x58),
                     *(undefined8 *)(pRVar20 + 0x68),this + 0x50,param_5 + 0x18);
          pRVar20 = *(ResourceTracker **)(pRVar3 + 0x80);
        }
        ...
        *(undefined8 *)(pRVar3 + 0x40) = uVar4;
        ...
        local_c8 = 0;
        bVar27 = false;
        if (uVar25 - 1 < 0x11) goto LAB_00102052;
        pRVar20 = *(ResourceTracker **)(pRVar3 + 0x80);
        if (pRVar20 != (ResourceTracker *)0x0) goto LAB_00102071;
LAB_001022fd:
        lVar18 = *(long *)(pRVar3 + 0x88);
        if (lVar18 == 0) {
          uVar21 = *(uint *)(pRVar3 + 0x3c);
LAB_00102935:
          bVar28 = false;
          ...
          pRVar20 = pRVar3;
LAB_001023ef:
          if (bVar27 != false) goto LAB_00102ea4;
LAB_001023f8:
          local_58 = auVar31;
          if (uVar21 != uVar25) {
            lVar14 = *(long *)(pRVar3 + 0x50);
            bVar24 = bVar27;
            if (lVar14 != 0) goto LAB_00102115;
LAB_00102420:
            bVar27 = bVar24;
          ...
          while( true ) {
            if (lVar14 != *(long *)(lVar18 + 8)) {
              ...
              *(undefined4 *)(lVar18 + 0x24) = 0xffffffff;
              *(undefined4 *)(lVar18 + 0x28) = 0xffffffff;
              *(undefined4 *)(lVar18 + 0x2c) = 0xffffffff;
            }
            if (*(long *)(lVar18 + 0x50) != 0) {
              local_60 = *(long *)(lVar18 + 0x50);
              _add_texture_barrier_to_command
                        (this,&local_60,*(undefined8 *)(lVar18 + 0x40),local_c8,
                         *(undefined4 *)(lVar18 + 0x3c),*(undefined4 *)(pRVar3 + 0x3c),
                         *(undefined1 (*) [16])(lVar18 + 0x58),*(undefined8 *)(lVar18 + 0x68),
                         this + 0x50,param_5 + 0x18);
            }
...
LAB_00102ea4:
          bVar27 = true;
          if (*(int *)(pRVar20 + 0x28) < 0) goto LAB_001023f8;
LAB_00102108:
          bVar27 = true;
          lVar14 = *(long *)(pRVar3 + 0x50);
          bVar24 = true;
          local_58 = auVar31;
          if (lVar14 == 0) goto LAB_00102420;
LAB_00102115:
          if (*(long *)(pRVar3 + 0x40) == 0) {
            *(undefined8 *)(pRVar3 + 0x40) = 0x10000;
          }
          local_60 = lVar14;
          local_58 = auVar31;
          _add_texture_barrier_to_command
                    (this,&local_60,*(undefined8 *)(pRVar3 + 0x40),local_c8,uVar21,uVar25,
                     *(undefined8 *)(pRVar3 + 0x58),*(undefined8 *)(pRVar3 + 0x60),
                     *(undefined8 *)(pRVar3 + 0x68),this + 0x60,param_5 + 0x20);
        }
      }
      ...
      *(ulong *)(pRVar20 + 0x18) = *(ulong *)(pRVar20 + 0x18) | uVar15;
      ...
      if (uVar25 == uVar21) {
        ...
        if (RVar10 == (ResourceTracker)0x0) {
          ...
          if ((int)uVar21 < 0) goto LAB_001029bf;
LAB_001024b7:
          RVar10 = pRVar20[0xa9];
          bVar24 = bVar27;
          if (pRVar20[0xa9] == (ResourceTracker)0x0) goto LAB_001021f7;
          RVar9 = (ResourceTracker)0x0;
LAB_001024c8:
          uVar26 = 0xffffffff;
          uVar15 = (ulong)uVar21;
          do {
            ...
            if (*(uint *)(this + 0x1b0) <= (uint)uVar15) goto LAB_00102bd2;
            piVar1 = (int *)(*(long *)(this + 0x1b8) + (long)(int)(uint)uVar15 * 0x1c);
            if (local_b0 == (ResourceTracker *)0x0) {
              iVar13 = *piVar1;
              if (iVar13 == param_4) {
                _err_print_error("_add_command_to_graph",
                                 "servers/rendering/rendering_device_graph.cpp",0x245,
                                 "Condition \"!resource_has_parent\" is true.",
                                 "Command can\'t have itself as a dependency.",0,0);
                goto LAB_001022a8;
              }
LAB_0010259c:
              if (((char)piVar1[6] != '\0') && (*(int *)(pRVar3 + 0x3c) - 0x10U < 2)) {
                cVar11 = _check_command_intersection((ResourceTracker *)this,iVar13,param_4);
                if (cVar11 == '\0') goto LAB_001025d8;
                iVar13 = *piVar1;
              }
              ...
              _add_adjacent_command(this,iVar13,param_4,param_5);
              if ((bVar27 == false) || ((bool)bVar28 == false)) goto LAB_001025d8;
              if (((int)(local_58._8_4_ | local_58._12_4_) < 0) ||
                 ((piVar1[4] < 0 || (piVar1[5] < 0)))) {
                _err_print_error("encloses","./core/math/rect2i.h",0x4e,
                                 "Rect2i size is negative, this is not supported. Use Rect2i.abs() to get a Rect2i with a positive size."
                                 ,0);
              }
              if (piVar1[2] < (int)local_58._0_4_) goto LAB_001025d8;
              if ((((piVar1[3] < (int)local_58._4_4_) ||
                   ((int)(local_58._0_4_ + local_58._8_4_) < piVar1[2] + piVar1[4])) ||
                  ((int)(local_58._4_4_ + local_58._12_4_) < piVar1[3] + piVar1[5])) ||
                 (RVar9 != (ResourceTracker)0x0)) goto LAB_001025d8;
              uVar25 = (uint)uVar26;
              if ((int)uVar25 < 0) {
                ...
                *(int *)(pRVar20 + 0x28) = piVar1[1];
                ...
                uVar22 = (ulong)*(uint *)(this + 0x1b0);
                uVar15 = uVar26;
                if (*(uint *)(this + 0x1b0) <= uVar25) goto LAB_00102bd2;
                uVar22 = (ulong)(uint)piVar1[1];
                *(int *)(*(long *)(this + 0x1b8) + (long)(int)uVar25 * 0x1c + 4) = piVar1[1];
              }
            }
            else {
              if ((((int)(local_58._8_4_ | local_58._12_4_) < 0) || (iVar13 = piVar1[4], iVar13 < 0)
                  ) || (piVar1[5] < 0)) {
                _err_print_error("intersects","./core/math/rect2i.h",0x38,
                                 "Rect2i size is negative, this is not supported. Use Rect2i.abs() to get a Rect2i with a positive size."
                                 ,0);
              ...
              if (((int)local_58._0_4_ < iVar13 + piVar1[2]) &&
                 (piVar1[2] < (int)(local_58._0_4_ + local_58._8_4_))) {
                if (((int)local_58._4_4_ < piVar1[5] + piVar1[3]) &&
                   ((piVar1[3] < (int)(local_58._4_4_ + local_58._12_4_) &&
                    (iVar13 = *piVar1, param_4 != iVar13)))) goto LAB_0010259c;
              }
LAB_001025d8:
              uVar22 = (ulong)(uint)piVar1[1];
              uVar26 = uVar15;
        ...
        if (-1 < (int)uVar21) {
          RVar9 = pRVar20[0xa9];
          bVar24 = bVar27;
          if (RVar9 == (ResourceTracker)0x0) goto LAB_001021f7;
          goto LAB_001024c8;
        }
        if (bVar27 == false) goto LAB_0010225b;
LAB_00102a48:
        uVar12 = _add_to_write_list(this,param_4,local_58._0_8_,local_58._8_8_);
...
LAB_0010262d:
          ...
          do {
            while( true ) {
              ...
              if (*(uint *)(this + 400) <= (uint)uVar15) goto LAB_00102bd2;
              ...
              _add_adjacent_command(this,iVar13,param_4,param_5);
              if ((int)uVar25 < 0) goto LAB_0010267f;
            }
            if (local_b0 == (ResourceTracker *)0x0) {
              _err_print_error("_add_command_to_graph",
                               "servers/rendering/rendering_device_graph.cpp",0x282,
                               "Method/function failed.",
                               "Command can\'t have itself as a dependency.",0,0);
              goto LAB_001022a8;
            }
...
LAB_0010267f:
          if (!bVar27) goto LAB_0010268a;
        }
        bVar27 = true;
LAB_00102a8e:
        uVar25 = *(uint *)(pRVar20 + 0x24);
        if (-1 < (int)uVar25) {
          uVar15 = 0xffffffff;
          do {
...
LAB_00102bd2:
              _err_print_index_error
                        ("operator[]","./core/templates/local_vector.h",0xb2,uVar15,uVar22,"p_index"
                         ,"count","",false,true);
              _err_flush_stdout();
                    /* WARNING: Does not return */
              pcVar5 = (code *)invalidInstructionException();
            ...
            if (bVar27) {
              if ((((int)(local_58._8_4_ | local_58._12_4_) < 0) || (piVar1[4] < 0)) ||
                 (piVar1[5] < 0)) {
                _err_print_error("encloses","./core/math/rect2i.h",0x4e,
                                 "Rect2i size is negative, this is not supported. Use Rect2i.abs() to get a Rect2i with a positive size."
                                 ,0);
              ...
              if ((int)local_58._0_4_ <= piVar1[2]) {
                if ((((int)local_58._4_4_ <= piVar1[3]) &&
                    (piVar1[2] + piVar1[4] <= (int)(local_58._0_4_ + local_58._8_4_))) &&
                   (piVar1[3] + piVar1[5] <= (int)(local_58._4_4_ + local_58._12_4_)))
                goto LAB_00102bb0;
              }
              uVar15 = (ulong)uVar25;
              uVar25 = piVar1[1];
...
LAB_00102bb0:
              ...
              if ((int)uVar21 < 0) {
                *(uint *)(pRVar20 + 0x24) = uVar25;
                ...
                uVar22 = (ulong)*(uint *)(this + 0x1a0);
                if (*(uint *)(this + 0x1a0) <= uVar21) goto LAB_00102bd2;
                *(uint *)(*(long *)(this + 0x1a8) + (long)(int)uVar21 * 0x1c + 4) = uVar25;
              }
            }
            if (local_b0 == (ResourceTracker *)0x0) {
LAB_00102b62:
              _add_adjacent_command(this,*piVar1,param_4,param_5);
            }
            else {
              if ((((int)(local_58._8_4_ | local_58._12_4_) < 0) || (iVar13 = piVar1[4], iVar13 < 0)
                  ) || (piVar1[5] < 0)) {
              ...
              if (((int)local_58._0_4_ < iVar13 + piVar1[2]) &&
                 (piVar1[2] < (int)(local_58._0_4_ + local_58._8_4_))) {
                if (((int)local_58._4_4_ < piVar1[5] + piVar1[3]) &&
                   (piVar1[3] < (int)(local_58._4_4_ + local_58._12_4_))) goto LAB_00102b62;
              }
            }
          } while (-1 < (int)uVar25);
        }
...
LAB_00102610:
            if (bVar28 != 0) {
              if ((pRVar20[0xa9] == (ResourceTracker)0x0) && (-1 < *(int *)(pRVar20 + 0x28))) {
                ...
                ;
                uVar12 = _add_to_write_list(this,*(int *)(pRVar20 + 0x28),local_c8,
                                            CONCAT44(*(undefined4 *)(pRVar20 + 0x6c),
                                                     *(undefined4 *)(pRVar20 + 100)),0xffffffff,0);
                *(undefined4 *)(pRVar20 + 0x28) = uVar12;
              }
              goto LAB_00102a48;
            }
            ...
            *(int *)(pRVar20 + 0x28) = param_4;
            pRVar20[0xa9] = (ResourceTracker)0x0;
            bVar27 = false;
            if (-1 < (int)uVar25) goto LAB_0010262d;
LAB_0010268a:
            *(undefined4 *)(pRVar20 + 0x20) = 0xffffffff;
            bVar27 = false;
            goto LAB_00102a8e;
          ...
          bVar24 = true;
          if (pRVar20[0xa9] != (ResourceTracker)0x0) goto LAB_001024c8;
LAB_001021f7:
          RVar9 = RVar10;
          if (uVar21 != param_4) {
            if (pRVar20[0xaa] != (ResourceTracker)0x0) {
          ...
          _err_print_error("_add_command_to_graph","servers/rendering/rendering_device_graph.cpp",
                           0x261,"Method/function failed.",
                           "Command can\'t have itself as a dependency.",0,0);
          break;
        }
        RVar2 = this[0x220];
        *(uint *)(pRVar3 + 0x3c) = uVar25;
        ...
        if (-1 < (int)uVar21) goto LAB_001024b7;
LAB_001029bf:
        RVar9 = (ResourceTracker)0x0;
LAB_00102252:
        if (bVar27 != false) {
...
LAB_0010225b:
        if (local_b0 == (ResourceTracker *)0x0) {
          ...
          *(undefined4 *)(pRVar20 + 0x20) = uVar12;
          ...
          uVar12 = _add_to_slice_read_list
                             (this,param_4,CONCAT44(auVar29._8_4_,auVar29._0_4_),
                              CONCAT44(auVar29._12_4_,auVar29._4_4_));
...
void __thiscall
RenderingDeviceGraph::_run_compute_list_command
          (RenderingDeviceGraph *this,undefined8 *param_2,long param_3,uint param_4)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* RenderingDeviceGraph::_add_draw_list_begin(RenderingDeviceGraph::FramebufferCache*,
   ...
   VectorView<RenderingDeviceDriver::RenderPassClearValue>, bool, bool, unsigned int, bool) */

void RenderingDeviceGraph::_add_draw_list_begin
               (long param_1,undefined8 param_2,undefined8 *param_3,undefined8 *param_4,
               undefined8 param_5,undefined8 param_6,long param_7,uint param_8,long param_9,
               uint param_10,char param_11,char param_12,undefined4 param_13,undefined1 param_14)
...
LAB_00103bf9:
      if (*(uint *)(param_1 + 0x134) < param_10) {
        pvVar11 = *(void **)(param_1 + 0x138);
        ...
        *(uint *)(param_1 + 0x134) = uVar5;
        lVar6 = Memory::realloc_static(pvVar11,(ulong)uVar5 << 4,false);
        *(long *)(param_1 + 0x138) = lVar6;
        ...
        uVar5 = *(uint *)(param_1 + 0x130);
        if (uVar5 < param_10) goto LAB_00103c05;
      }
      else {
LAB_00103c05:
        uVar2 = _UNK_001129a8;
        ...
        puVar10 = puVar7 + (ulong)(param_10 - uVar5) * 2;
        do {
          *puVar7 = uVar1;
          puVar7[1] = uVar2;
          puVar7 = puVar7 + 2;
    ...
    if (param_8 == 0) goto LAB_00103b65;
  }
  else {
    if (param_8 <= *(uint *)(param_1 + 0x120)) goto LAB_00103afa;
    ...
    *(uint *)(param_1 + 0x120) = param_8;
    if (uVar5 <= param_10) {
      if (param_10 <= uVar5) goto LAB_00103b18;
      goto LAB_00103bf9;
    }
    *(uint *)(param_1 + 0x130) = param_10;
  }
...
LAB_00103c5e:
      _err_print_index_error
                ("operator[]","./core/templates/local_vector.h",0xb2,uVar8,uVar12,"p_index","count",
                 "",false,true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
      pcVar4 = (code *)invalidInstructionException();
    ...
    *(undefined4 *)(*(long *)(param_1 + 0x128) + lVar6) = *(undefined4 *)(param_7 + lVar6);
    ...
    puVar7 = (undefined8 *)(param_9 + lVar6 * 4);
    uVar1 = puVar7[1];
    uVar9 = uVar9 + 1;
    puVar10 = (undefined8 *)(*(long *)(param_1 + 0x138) + lVar6 * 4);
    *puVar10 = *puVar7;
    puVar10[1] = uVar1;
    lVar6 = lVar6 + 4;
  } while (uVar9 != param_8);
...
void __thiscall
RenderingDeviceGraph::_run_secondary_command_buffer_task
          (RenderingDeviceGraph *this,SecondaryCommandBuffer *param_1)
...
/* RenderingDeviceGraph::_wait_for_secondary_command_buffer_tasks() */

void __thiscall
RenderingDeviceGraph::_wait_for_secondary_command_buffer_tasks(RenderingDeviceGraph *this)

{
  ...
  _err_print_index_error
            ("operator[]","./core/templates/local_vector.h",0xb2,uVar4,uVar6,"p_index","count","",
             false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar3 = (code *)invalidInstructionException();
...
void __thiscall
RenderingDeviceGraph::_boost_priority_for_render_commands
          (RenderingDeviceGraph *this,RecordedCommandSort_conflict *param_1,uint param_2,
          uint *param_3)
...
/* RenderingDeviceGraph::begin() */

void __thiscall RenderingDeviceGraph::begin(RenderingDeviceGraph *this)
  ...
  *(undefined4 *)(this + 0xb0) = 0xffffffff;
  ...
  _err_print_index_error
            ("operator[]","./core/templates/local_vector.h",0xb2,(ulong)uVar1,
             (ulong)*(uint *)(this + 0x228),"p_index","count","",false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar2 = (code *)invalidInstructionException();
  (*pcVar2)();
...
/* RenderingDeviceGraph::add_buffer_clear(RenderingDeviceDriver::BufferID,
   RenderingDeviceGraph::ResourceTracker*, unsigned int, unsigned int) */

void __thiscall
RenderingDeviceGraph::add_buffer_clear
          (RenderingDeviceGraph *this,undefined8 *param_2,ResourceTracker *param_3,
...
/* RenderingDeviceGraph::add_buffer_copy(RenderingDeviceDriver::BufferID,
   ...
   RenderingDeviceGraph::ResourceTracker*, RenderingDeviceDriver::BufferCopyRegion) */

void RenderingDeviceGraph::add_buffer_copy
               (RenderingDeviceGraph *param_1,undefined8 *param_2,long param_3,undefined8 *param_4,
               ResourceTracker *param_5,undefined8 param_6,undefined8 param_7,undefined8 param_8,
               undefined8 param_9)

{
  ...
  *(undefined8 *)(pRVar2 + 0x70) = param_9;
  ...
  local_48 = param_5;
  local_40 = param_3;
  _add_command_to_graph
            (param_1,&local_48,(ResourceUsage *)&local_50,2 - (param_3 == 0),local_54,pRVar2);
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
                    /* WARNING: Subroutine does not return */
...
/* WARNING: Type propagation algorithm not settling */
/* RenderingDeviceGraph::add_buffer_get_data(RenderingDeviceDriver::BufferID,
   RenderingDeviceGraph::ResourceTracker*, RenderingDeviceDriver::BufferID,
   RenderingDeviceDriver::BufferCopyRegion) */

void RenderingDeviceGraph::add_buffer_get_data
               (RenderingDeviceGraph *param_1,undefined8 *param_2,ResourceTracker *param_3,
...
/* WARNING: Type propagation algorithm not settling */
/* RenderingDeviceGraph::add_buffer_update(RenderingDeviceDriver::BufferID,
   RenderingDeviceGraph::ResourceTracker*, VectorView<RenderingDeviceGraph::RecordedBufferCopy>) */

void RenderingDeviceGraph::add_buffer_update
               (RenderingDeviceGraph *param_1,undefined8 *param_2,ResourceTracker *param_3,
...
void RenderingDeviceGraph::add_driver_callback
               (RenderingDeviceGraph *param_1,undefined8 param_2,undefined8 param_3,
               ResourceTracker **param_4,uint param_5,undefined8 param_6,ResourceUsage *param_7)
...
void __thiscall
RenderingDeviceGraph::add_compute_list_begin(RenderingDeviceGraph *this,ushort param_2,uint param_3)
...
/* RenderingDeviceGraph::add_compute_list_bind_pipeline(RenderingDeviceDriver::PipelineID) */

void __thiscall
RenderingDeviceGraph::add_compute_list_bind_pipeline(RenderingDeviceGraph *this,undefined8 *param_2)
...
/* RenderingDeviceGraph::add_compute_list_bind_uniform_set(RenderingDeviceDriver::ShaderID,
   RenderingDeviceDriver::UniformSetID, unsigned int) */

void __thiscall
RenderingDeviceGraph::add_compute_list_bind_uniform_set
          (RenderingDeviceGraph *this,undefined8 *param_2,undefined8 *param_3,undefined4 param_4)
...
/* RenderingDeviceGraph::add_compute_list_bind_uniform_sets(RenderingDeviceDriver::ShaderID,
   VectorView<RenderingDeviceDriver::UniformSetID>, unsigned int, unsigned int) */

void RenderingDeviceGraph::add_compute_list_bind_uniform_sets
               (RenderingDeviceGraph *param_1,undefined8 *param_2,long param_3,undefined8 param_4,
...
/* RenderingDeviceGraph::add_compute_list_dispatch(unsigned int, unsigned int, unsigned int) */

void __thiscall
RenderingDeviceGraph::add_compute_list_dispatch
          (RenderingDeviceGraph *this,uint param_1,uint param_2,uint param_3)
...
void __thiscall
RenderingDeviceGraph::add_compute_list_dispatch_indirect
          (RenderingDeviceGraph *this,undefined8 *param_2,undefined4 param_3)
...
void __thiscall
RenderingDeviceGraph::add_compute_list_set_push_constant
          (RenderingDeviceGraph *this,undefined8 *param_2,void *param_3,uint param_4)
...
void __thiscall
RenderingDeviceGraph::add_compute_list_uniform_set_prepare_for_use
          (RenderingDeviceGraph *this,undefined8 *param_2,undefined8 *param_3,undefined4 param_4)
...
/* RenderingDeviceGraph::add_compute_list_usage(RenderingDeviceGraph::ResourceTracker*,
   RenderingDeviceGraph::ResourceUsage) */

void __thiscall
RenderingDeviceGraph::add_compute_list_usage
          (RenderingDeviceGraph *this,long param_1,undefined4 param_3)
  ...
  if (*(int *)(this + 0x180) != iVar5) {
    ...
    if (uVar1 == *(uint *)(this + 0x15c)) {
      ...
      *(void **)(this + 0x160) = pvVar6;
      if (pvVar6 == (void *)0x0) goto LAB_00104870;
      uVar1 = *(uint *)(this + 0x158);
    }
...
void RenderingDeviceGraph::add_compute_list_usages
               (RenderingDeviceGraph *param_1,undefined8 *param_2,uint param_3,undefined4 *param_4)
...
/* RenderingDeviceGraph::add_compute_list_end() */

void __thiscall RenderingDeviceGraph::add_compute_list_end(RenderingDeviceGraph *this)

{
  ...
  *(undefined8 *)(pRVar3 + 0x48) = uVar2;
  ...
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
    _add_command_to_graph
              (this,*(ResourceTracker ***)(this + 0x160),*(ResourceUsage **)(this + 0x170),
               *(uint *)(this + 0x158),local_24,pRVar3);
    return;
  }
                    /* WARNING: Subroutine does not return */
  __stack_chk_fail();
...

{
  ...
  local_18 = 0;
  local_20 = 0;
  _add_draw_list_begin
            (param_1,param_2,&local_20,&local_18,param_3,param_4,param_5,param_6,param_7,param_8,
...

{
  ...
  local_20 = *param_2;
  _add_draw_list_begin
            (param_1,0,&local_20,&local_18,param_4,param_5,param_7,param_8,param_9,param_10,param_6,
...
/* RenderingDeviceGraph::add_draw_list_bind_index_buffer(RenderingDeviceDriver::BufferID,
   RenderingDeviceCommons::IndexBufferFormat, unsigned int) */

void __thiscall
RenderingDeviceGraph::add_draw_list_bind_index_buffer
          (RenderingDeviceGraph *this,long *param_2,undefined4 param_3,undefined4 param_4)
...
/* RenderingDeviceGraph::add_draw_list_bind_pipeline(RenderingDeviceDriver::PipelineID,
   BitField<RenderingDeviceDriver::PipelineStageBits>) */

void __thiscall
RenderingDeviceGraph::add_draw_list_bind_pipeline
          (RenderingDeviceGraph *this,undefined8 *param_2,ulong param_3)
...
void __thiscall
RenderingDeviceGraph::add_draw_list_bind_uniform_set
          (RenderingDeviceGraph *this,undefined8 *param_2,undefined8 *param_3,undefined4 param_4)
...
void RenderingDeviceGraph::add_draw_list_bind_uniform_sets
               (RenderingDeviceGraph *param_1,undefined8 *param_2,long param_3,undefined8 param_4,
               undefined4 param_5,uint param_6)
...
/* RenderingDeviceGraph::add_draw_list_bind_vertex_buffers(VectorView<RenderingDeviceDriver::BufferID>,
   VectorView<unsigned long>) */

void RenderingDeviceGraph::add_draw_list_bind_vertex_buffers
               (RenderingDeviceGraph *param_1,long param_2,uint param_3,long param_4,int param_5)
  ...
  *puVar1 = 4;
  ...
  if (param_3 != 0) {
    ...
    do {
      ...
      *(undefined8 *)((long)puVar1 + lVar2 + (ulong)param_3 * 8 + 8) =
...
void RenderingDeviceGraph::add_draw_list_clear_attachments
               (RenderingDeviceGraph *param_1,long param_2,uint param_3,long param_4,uint param_5)

{
  ...
  puVar4 = (undefined4 *)
           _allocate_draw_list_instruction(param_1,(param_5 + param_3 * 2) * 0x10 + 0xc);
  *puVar4 = 5;
  puVar4[1] = param_3;
  puVar4[2] = param_5;
  if (param_3 != 0) {
...
/* RenderingDeviceGraph::add_draw_list_draw(unsigned int, unsigned int) */

void __thiscall
RenderingDeviceGraph::add_draw_list_draw(RenderingDeviceGraph *this,uint param_1,uint param_2)
...
/* RenderingDeviceGraph::add_draw_list_draw_indexed(unsigned int, unsigned int, unsigned int) */

void __thiscall
RenderingDeviceGraph::add_draw_list_draw_indexed
          (RenderingDeviceGraph *this,uint param_1,uint param_2,uint param_3)
...
void __thiscall
RenderingDeviceGraph::add_draw_list_draw_indirect
          (RenderingDeviceGraph *this,undefined8 *param_2,undefined4 param_3,undefined4 param_4,
          undefined4 param_5)
...
void __thiscall
RenderingDeviceGraph::add_draw_list_draw_indexed_indirect
          (RenderingDeviceGraph *this,undefined8 *param_2,undefined4 param_3,undefined4 param_4,
          undefined4 param_5)
...
/* RenderingDeviceGraph::add_draw_list_execute_commands(RenderingDeviceDriver::CommandBufferID) */

void __thiscall
RenderingDeviceGraph::add_draw_list_execute_commands(RenderingDeviceGraph *this,undefined8 *param_2)
...
/* RenderingDeviceGraph::add_draw_list_next_subpass(RenderingDeviceDriver::CommandBufferType) */

void __thiscall
RenderingDeviceGraph::add_draw_list_next_subpass(RenderingDeviceGraph *this,undefined4 param_2)
...
/* RenderingDeviceGraph::add_draw_list_set_blend_constants(Color const&) */

void __thiscall
RenderingDeviceGraph::add_draw_list_set_blend_constants(RenderingDeviceGraph *this,Color *param_1)
...
/* RenderingDeviceGraph::add_draw_list_set_line_width(float) */

void __thiscall
RenderingDeviceGraph::add_draw_list_set_line_width(RenderingDeviceGraph *this,float param_1)
...
void __thiscall
RenderingDeviceGraph::add_draw_list_set_push_constant
          (RenderingDeviceGraph *this,undefined8 *param_2,void *param_3,uint param_4)
...
/* RenderingDeviceGraph::add_draw_list_set_scissor(Rect2i) */

void RenderingDeviceGraph::add_draw_list_set_scissor
               (RenderingDeviceGraph *param_1,undefined8 param_2,undefined8 param_3)
...
/* RenderingDeviceGraph::add_draw_list_set_viewport(Rect2i) */

void RenderingDeviceGraph::add_draw_list_set_viewport
               (RenderingDeviceGraph *param_1,undefined8 param_2,undefined8 param_3)
...
void __thiscall
RenderingDeviceGraph::add_draw_list_uniform_set_prepare_for_use
          (RenderingDeviceGraph *this,undefined8 *param_2,undefined8 *param_3,undefined4 param_4)
...
void __thiscall
RenderingDeviceGraph::add_draw_list_usage
          (RenderingDeviceGraph *this,long param_1,undefined4 param_3)
  ...
  if (*(int *)(this + 0xf0) != iVar5) {
    ...
    if (uVar1 == *(uint *)(this + 0xcc)) {
      ...
      *(void **)(this + 0xd0) = pvVar6;
      if (pvVar6 == (void *)0x0) goto LAB_00105130;
      uVar1 = *(uint *)(this + 200);
    }
...
void RenderingDeviceGraph::add_draw_list_usages
               (RenderingDeviceGraph *param_1,undefined8 *param_2,uint param_3,undefined4 *param_4)
...
/* RenderingDeviceGraph::add_draw_list_end() */

void __thiscall RenderingDeviceGraph::add_draw_list_end(RenderingDeviceGraph *this)
  ...
  *(undefined8 *)(pRVar16 + 0x78) = uVar14;
  if (uVar24 != 0) {
    ...
    do {
      if (uVar19 == uVar7) {
        _err_print_index_error
                  ("operator[]","./core/templates/local_vector.h",0xb2,uVar19,uVar19,"p_index",
                   "count","",false,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_00105325:
        ...
        if (bVar2 != 0) {
          ...
          if (*(long *)(this + 0x28) == *(long *)(lVar21 + 8)) {
            ...
            *(undefined4 *)(lVar21 + 0x24) = 0xffffffff;
            *(undefined4 *)(lVar21 + 0x28) = 0xffffffff;
            *(undefined4 *)(lVar21 + 0x2c) = 0xffffffff;
            iVar15 = 2;
            uVar18 = uVar20;
          }
        }
...
LAB_00105380:
      *(int *)(pRVar16 + uVar19 * 4 + lVar23) = iVar15;
  ...
  _add_command_to_graph
            (this,*(ResourceTracker ***)(this + 0xd0),*(ResourceUsage **)(this + 0xe0),
             *(uint *)(this + 200),local_44,pRVar16);
  return;
}
...
/* RenderingDeviceGraph::add_texture_clear(RenderingDeviceDriver::TextureID,
   ...
   RenderingDeviceDriver::TextureSubresourceRange const&) */

void __thiscall
RenderingDeviceGraph::add_texture_clear
          (RenderingDeviceGraph *this,undefined8 *param_2,ResourceTracker *param_3,
...
/* RenderingDeviceGraph::add_texture_copy(RenderingDeviceDriver::TextureID,
   ...
   RenderingDeviceGraph::ResourceTracker*, VectorView<RenderingDeviceDriver::TextureCopyRegion>) */

void RenderingDeviceGraph::add_texture_copy
               (RenderingDeviceGraph *param_1,undefined8 *param_2,undefined8 param_3,
               undefined8 *param_4,ResourceTracker *param_5,undefined8 param_6,long param_7,
               uint param_8)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  pRVar3 = (RecordedCommand *)
           _allocate_command(param_1,(int)((ulong)param_8 * 0x58) + 0x68,&local_64);
  *(undefined4 *)pRVar3 = 8;
  *(undefined8 *)(pRVar3 + 0x48) = 0x1000;
  ...
  *(undefined8 *)(pRVar3 + 0x58) = uVar2;
  if (param_8 != 0) {
    ...
    do {
      ...
      *(undefined8 *)(pRVar3 + lVar4 + 0x68 + 8) = uVar2;
      puVar1 = (undefined8 *)(param_7 + 0x10 + lVar4);
      uVar2 = puVar1[1];
      *(undefined8 *)(pRVar3 + lVar4 + 0x78) = *puVar1;
      *(undefined8 *)(pRVar3 + lVar4 + 0x78 + 8) = uVar2;
      puVar1 = (undefined8 *)(param_7 + 0x20 + lVar4);
      uVar2 = puVar1[1];
      *(undefined8 *)(pRVar3 + lVar4 + 0x88) = *puVar1;
      *(undefined8 *)(pRVar3 + lVar4 + 0x88 + 8) = uVar2;
      puVar1 = (undefined8 *)(param_7 + 0x30 + lVar4);
      uVar2 = puVar1[1];
      *(undefined8 *)(pRVar3 + lVar4 + 0x98) = *puVar1;
      *(undefined8 *)(pRVar3 + lVar4 + 0x98 + 8) = uVar2;
      puVar1 = (undefined8 *)(param_7 + 0x40 + lVar4);
      uVar2 = puVar1[1];
      *(undefined8 *)(pRVar3 + lVar4 + 0xa8) = *puVar1;
      *(undefined8 *)(pRVar3 + lVar4 + 0xa8 + 8) = uVar2;
...
/* WARNING: Type propagation algorithm not settling */
/* RenderingDeviceGraph::add_texture_get_data(RenderingDeviceDriver::TextureID,
   RenderingDeviceGraph::ResourceTracker*, RenderingDeviceDriver::BufferID,
...
void RenderingDeviceGraph::add_texture_get_data
               (RenderingDeviceGraph *param_1,undefined8 *param_2,ResourceTracker *param_3,
               undefined8 *param_4,long param_5,uint param_6,ResourceTracker *param_7)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  local_70 = param_3;
  pRVar4 = (RecordedCommand *)
           _allocate_command(param_1,(int)((ulong)param_6 * 0x38) + 0x68,local_68);
  uVar2 = *param_2;
  *(undefined4 *)pRVar4 = 9;
  uVar3 = *param_4;
...
void __thiscall
RenderingDeviceGraph::add_texture_resolve
          (RenderingDeviceGraph *this,undefined8 *param_2,undefined8 param_3,undefined8 *param_4,
          ResourceTracker *param_5,undefined4 param_6,undefined4 param_7,undefined4 param_8,
          undefined4 param_9)
...
void RenderingDeviceGraph::add_texture_update
               (RenderingDeviceGraph *param_1,undefined8 *param_2,ResourceTracker *param_3,
               long param_4,uint param_5,undefined8 param_6,undefined8 *param_7,uint param_8)
  ...
  *(undefined8 *)(pRVar5 + 0x50) = uVar2;
  ...
  if (param_5 != 0) {
    do {
      *(undefined8 *)(pRVar5 + lVar6 + 0x60) = *(undefined8 *)(param_4 + lVar6);
      puVar1 = (undefined8 *)(param_4 + 8 + lVar6);
      uVar2 = puVar1[1];
      *(undefined8 *)(pRVar5 + lVar6 + 0x68) = *puVar1;
      *(undefined8 *)(pRVar5 + lVar6 + 0x68 + 8) = uVar2;
      puVar1 = (undefined8 *)(param_4 + 0x18 + lVar6);
      uVar2 = puVar1[1];
      *(undefined8 *)(pRVar5 + lVar6 + 0x78) = *puVar1;
      *(undefined8 *)(pRVar5 + lVar6 + 0x78 + 8) = uVar2;
      puVar1 = (undefined8 *)(param_4 + 0x28 + lVar6);
      uVar2 = puVar1[1];
      *(undefined8 *)(pRVar5 + lVar6 + 0x88) = *puVar1;
      *(undefined8 *)(pRVar5 + lVar6 + 0x88 + 8) = uVar2;
  ...
  if ((char)*in_FS_OFFSET == '\0') {
    ...
    *(char *)in_FS_OFFSET = '\x01';
    __cxa_thread_atexit(LocalVector<RenderingDeviceGraph::ResourceTracker*,unsigned_int,false,false>
                        ::~LocalVector,uVar2,&__dso_handle);
    if ((char)*in_FS_OFFSET == '\0') goto LAB_00105bf0;
LAB_00105a98:
    uVar12 = *in_FS_OFFSET;
  }
  else {
    if ((char)*in_FS_OFFSET != '\0') goto LAB_00105a98;
LAB_00105bf0:
    uVar2 = *(undefined8 *)in_FS_OFFSET;
    in_FS_OFFSET[0] = 0;
    in_FS_OFFSET[1] = 0;
    ...
    in_FS_OFFSET[1] = 0;
    *(char *)in_FS_OFFSET = '\x01';
    __cxa_thread_atexit(LocalVector<RenderingDeviceGraph::ResourceUsage,unsigned_int,false,false>::
                        ~LocalVector,uVar2,&__dso_handle);
    uVar12 = *in_FS_OFFSET;
  }
  if (uVar12 != 0) {
  ...
  do {
    ...
    if (in_FS_OFFSET[1] == (uint)uVar7) {
      ...
      *(ResourceTracker ***)(in_FS_OFFSET + 2) = ppRVar8;
      if (ppRVar8 == (ResourceTracker **)0x0) goto LAB_00105d60;
    ...
    *in_FS_OFFSET = uVar10;
    ...
    if (*in_FS_OFFSET == uVar12) {
      ...
      *(ResourceUsage **)in_FS_OFFSET = pRVar9;
      if (pRVar9 == (ResourceUsage *)0x0) goto LAB_00105d60;
      uVar12 = *in_FS_OFFSET;
      uVar10 = *in_FS_OFFSET;
...
/* RenderingDeviceGraph::add_capture_timestamp(RenderingDeviceDriver::QueryPoolID, unsigned int) */

void __thiscall
RenderingDeviceGraph::add_capture_timestamp
          (RenderingDeviceGraph *this,undefined8 *param_2,undefined4 param_3)
...
void __thiscall RenderingDeviceGraph::add_synchronization(RenderingDeviceGraph *this)
...
/* RenderingDeviceGraph::begin_label(String const&, Color const&) */

void __thiscall
RenderingDeviceGraph::begin_label(RenderingDeviceGraph *this,String *param_1,Color *param_2)
...
LAB_00105f4f:
      *(uint *)(this + 0x80) = uVar12;
      ...
      if (uVar12 <= *(uint *)(this + 0x84)) goto LAB_00105f4f;
LAB_0010606d:
...
LAB_001060f8:
    _err_print_index_error
              ("operator[]","./core/templates/local_vector.h",0xb2,uVar10,(ulong)uVar12,"p_index",
               "count","",false,true);
    _err_flush_stdout();
                    /* WARNING: Does not return */
    pcVar5 = (code *)invalidInstructionException();
  ...
  if (uVar12 <= (uint)uVar10) goto LAB_001060f8;
...
/* RenderingDeviceGraph::end_label() */

void __thiscall RenderingDeviceGraph::end_label(RenderingDeviceGraph *this)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* RenderingDeviceGraph::resource_tracker_create() */

void RenderingDeviceGraph::resource_tracker_create(void)
...
/* RenderingDeviceGraph::resource_tracker_free(RenderingDeviceGraph::ResourceTracker*) */

void RenderingDeviceGraph::resource_tracker_free(ResourceTracker *param_1)
...
/* RenderingDeviceGraph::framebuffer_cache_create() */

void RenderingDeviceGraph::framebuffer_cache_create(void)
...
/* RenderingDeviceGraph::_get_draw_list_render_pass_and_framebuffer(RenderingDeviceGraph::RecordedDrawListCommand
   const*, RenderingDeviceDriver::RenderPassID&, RenderingDeviceDriver::FramebufferID&) */

void __thiscall
RenderingDeviceGraph::_get_draw_list_render_pass_and_framebuffer
          (RenderingDeviceGraph *this,RecordedDrawListCommand *param_1,RenderPassID *param_2,
          FramebufferID *param_3)

{
  ...
  if (uVar23 != 0) {
    ...
    do {
      ...
      iVar17 = iVar17 + 3;
      local_70 = local_70 |
                 (ulong)*(uint *)pRVar1 << (bVar14 + 2 & 0x3f) |
                 (ulong)*(uint *)pRVar2 << (bVar14 & 0x3f);
  ...
  if ((lVar24 != 0) && (puVar4[0x15] != 0)) {
    ...
    if (uVar23 != 0) {
      uVar21 = 0;
      while (((uint)uVar25 != uVar23 ||
             (*(ulong *)(*(long *)(lVar24 + lVar19 * 8) + 0x10) != local_70))) {
        uVar21 = uVar21 + 1;
        auVar7._8_8_ = 0;
        ...
        if ((uVar23 == 0) ||
           (auVar8._8_8_ = 0, auVar8._0_8_ = (ulong)uVar23 * lVar5, auVar12._8_8_ = 0,
           auVar12._0_8_ = uVar26, auVar9._8_8_ = 0,
           auVar9._0_8_ = (ulong)((*(uint *)(hash_table_size_primes + (ulong)(uint)puVar4[0x14] * 4)
                                  + uVar18) - SUB164(auVar8 * auVar12,8)) * lVar5, auVar13._8_8_ = 0
           , auVar13._0_8_ = uVar26, SUB164(auVar9 * auVar13,8) < uVar21)) goto LAB_00106652;
      }
      uVar15 = *(ulong *)(lVar24 + (ulong)uVar18 * 8);
      if (uVar15 != 0) goto LAB_00106603;
    }
  }
LAB_00106652:
  local_58 = 0;
  (**(code **)(this + 0x20))
            (&local_60,*(undefined8 *)this,param_1 + lVar3,uVar22,param_1 + lVar3 + uVar22 * 4,
             uVar22,*(undefined8 *)(puVar4 + 0x16));
  local_50 = local_60;
  if (local_60 == 0) {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      uVar20 = 0x322;
...
LAB_0010673a:
      _err_print_error("_get_draw_list_render_pass_and_framebuffer",
                       "servers/rendering/rendering_device_graph.cpp",uVar20,pcVar16,0,0);
      return;
    }
  }
  else {
    ...
    (**(code **)(**(long **)this + 0x2e0))
              (&local_60,*(long **)this,&local_68,*(undefined8 *)(puVar4 + 4),puVar4[2],*puVar4);
    local_58 = local_60;
    if (local_60 == 0) {
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
        uVar20 = 0x325;
      ...
      HashMap<unsigned_long,RenderingDeviceGraph::FramebufferStorage,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>,DefaultTypedAllocator<HashMapElement<unsigned_long,RenderingDeviceGraph::FramebufferStorage>>>
      ::insert(&local_60,(FramebufferStorage *)(puVar4 + 10),SUB81(&local_70,0));
      uVar15 = local_60;
LAB_00106603:
      uVar20 = *(undefined8 *)(uVar15 + 0x18);
...
/* RenderingDeviceGraph::finalize() */

void __thiscall RenderingDeviceGraph::finalize(RenderingDeviceGraph *this)

{
  ...
  if (lVar3 == *(long *)(in_FS_OFFSET + 0x28)) {
    LocalVector<RenderingDeviceGraph::Frame,unsigned_int,false,true>::resize
              ((LocalVector<RenderingDeviceGraph::Frame,unsigned_int,false,true> *)(this + 0x228),0)
    ;
    return;
  }
                    /* WARNING: Subroutine does not return */
...
/* RenderingDeviceGraph::initialize(RenderingDeviceDriver*, RenderingContextDriver::Device,
   ...
   RenderingDeviceDriver::CommandQueueFamilyID, unsigned int) */

void __thiscall
RenderingDeviceGraph::initialize
          (RenderingDeviceGraph *this,undefined8 param_1,CowData *param_3,undefined8 param_4,
...

{
  ...
  *(CowData *)(this + 0x18) = CVar1;
  LocalVector<RenderingDeviceGraph::Frame,unsigned_int,false,true>::resize
            ((LocalVector<RenderingDeviceGraph::Frame,unsigned_int,false,true> *)(this + 0x228),
             param_5);
  lVar17 = 0;
  uVar7 = 0;
  if (param_5 != 0) {
...
LAB_00106bde:
        _err_print_index_error
                  ("operator[]","./core/templates/local_vector.h",0xb2,uVar13,(ulong)uVar10,
                   "p_index","count","",false,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar4 = (code *)invalidInstructionException();
      ...
      if (param_7 < uVar10) {
        ...
        *puVar16 = param_7;
LAB_00106995:
        if (param_7 != 0) goto LAB_001069a0;
      }
      else {
        if (param_7 <= uVar10) goto LAB_00106995;
        if (puVar16[1] < param_7) {
          ...
          *(long *)(puVar16 + 2) = lVar11;
          ...
          uVar10 = *puVar16;
          if (uVar10 < param_7) goto LAB_00106b55;
        }
        else {
LAB_00106b55:
          lVar11 = *(long *)(puVar16 + 2);
          ...
          do {
            ...
            *(undefined1 (*) [16])(puVar5 + 4) = (undefined1  [16])0x0;
            puVar5 = puVar6;
                             ...
                             (lVar11 + 0x38 +
                             ((ulong)((param_7 - 1) - uVar10) + (ulong)uVar10) * 0x38));
        }
        *puVar16 = param_7;
LAB_001069a0:
        uVar12 = 0;
        do {
          uVar10 = *(uint *)(this + 0x228);
          uVar13 = uVar7;
          if (uVar10 <= uVar15) goto LAB_00106bde;
          uVar10 = *(uint *)(lVar17 + *(long *)(this + 0x230));
          uVar13 = uVar12;
          if (uVar10 <= (uint)uVar12) goto LAB_00106bde;
          uVar13 = uVar12 + 1;
...
/* RenderingDeviceGraph::framebuffer_cache_free(RenderingDeviceDriver*,
   RenderingDeviceGraph::FramebufferCache*) */

void RenderingDeviceGraph::framebuffer_cache_free
               (RenderingDeviceDriver *param_1,FramebufferCache *param_2)
...
/* RenderingDeviceGraph::_usage_to_string(RenderingDeviceGraph::ResourceUsage) */

RenderingDeviceGraph * __thiscall
...

{
  ...
  if (0x11 < param_2) {
    ...
    vformat<RenderingDeviceGraph::ResourceUsage>
              ((CowData<char32_t> *)&local_48,(StrRange *)&local_50,param_2);
    _err_print_error("_usage_to_string","servers/rendering/rendering_device_graph.cpp",0x55,
                     "Method/function failed. Returning: \"Invalid\"",(CowData<char32_t> *)&local_48
                     ,0,0);
...
void __thiscall
RenderingDeviceGraph::_run_label_command_change
          (RenderingDeviceGraph *this,undefined8 *param_2,uint param_3,int param_4,char param_5,
          char param_6,long param_7,uint param_8,uint *param_9,int *param_10)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (param_5 == '\0') {
    if ((*param_9 == param_3) && (*param_10 == param_4)) goto LAB_00107504;
    ...
    local_88 = 0;
    local_58 = CONCAT44(_UNK_001129a4,__LC31);
    uStack_50 = CONCAT44(_LC78,_UNK_001129a8);
    if ((int)param_3 < 0) goto LAB_00107504;
LAB_001071c5:
    local_88 = 0;
...
LAB_001075cb:
      _err_print_index_error
                ("operator[]","./core/templates/local_vector.h",0xb2,uVar16,uVar19,"p_index","count"
                 ,"",false,true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
      pcVar3 = (code *)invalidInstructionException();
    ...
    if (*(uint *)(this + 0x90) <= param_3) goto LAB_001075cb;
...
LAB_001071a7:
    ...
    local_58 = CONCAT44(_UNK_001129a4,__LC31);
    uStack_50 = CONCAT44(_LC78,_UNK_001129a8);
    if (-1 < (int)param_3) goto LAB_001071c5;
    if (param_6 == '\0') goto LAB_00107504;
    local_60 = 0xd;
  ...
  itos((long)local_80);
  operator+((char *)local_78,(String *)&_LC80);
  ...
  if (param_7 != 0 && param_8 != 0) {
    ...
    do {
      ...
      if (*(uint *)(this + 0x40) <= *puVar15) goto LAB_001075cb;
      ...
      if ((bVar13) && (bVar13 = (bool)(bVar6 & bVar9), bVar4 = bVar13, bVar5 = bVar13, bVar13))
      goto LAB_001077bc;
      uVar11 = uVar11 + 1;
      puVar15 = puVar15 + 3;
      bVar13 = bVar7;
...
LAB_00107709:
      ...
      if ((!bVar6) && (!bVar5)) goto LAB_00107492;
      String::operator+=((String *)&local_88," (");
      String::operator+=((String *)&local_88,"");
      String::operator+=((String *)&local_88,"");
      pcVar18 = "";
...
/* RenderingDeviceGraph::_run_label_command_change(RenderingDeviceDriver::CommandBufferID, int, int,
   bool, bool, RenderingDeviceGraph::RecordedCommandSort const*, unsigned int, int&, int&) */

void RenderingDeviceGraph::_run_label_command_change(long param_1)
...
void __thiscall
RenderingDeviceGraph::_run_render_commands
          (RenderingDeviceGraph *this,int param_1,RecordedCommandSort_conflict *param_2,uint param_3
          ,CommandBufferID *param_4,CommandBufferPool *param_5,int *param_6,int *param_7)
...
LAB_00107a6a:
        _err_print_index_error
                  ("operator[]","./core/templates/local_vector.h",0xb2,uVar9,(ulong)uVar13,"p_index"
                   ,"count","",false,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar3 = (code *)invalidInstructionException();
      ...
      if (*(int *)(this + 0x18c) != 0) {
        _run_label_command_change
                  (this,&local_48,*(undefined4 *)(pRVar10 + 0x30),param_1,0,1,local_d8,local_d0,
                   param_6,param_7);
      }
      switch(*(undefined4 *)pRVar10) {
      default:
        goto switchD_00107a61_caseD_0;
      case 1:
              ...
              *(long *)(lVar6 + (ulong)uVar13 * 8) = lVar2;
              ...
              if (uVar13 == *(uint *)(param_5 + 0x1c)) {
                ...
                *(void **)(param_5 + 0x20) = pvVar7;
                if (pvVar7 == (void *)0x0) goto LAB_001084c7;
                uVar13 = *(uint *)(param_5 + 0x18);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* RenderingDeviceGraph::_group_barriers_for_render_commands(RenderingDeviceDriver::CommandBufferID,
   RenderingDeviceGraph::RecordedCommandSort const*, unsigned int, bool) */

void __thiscall
RenderingDeviceGraph::_group_barriers_for_render_commands
          (RenderingDeviceGraph *this,undefined8 *param_2,long param_3,uint param_4,char param_5)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (((byte)this[0x220] & 1) == 0) goto LAB_00108573;
  this_01 = (LocalVector<RenderingDeviceDriver::TextureBarrier,unsigned_int,false,false> *)
            (this + 0x1f0);
  *(undefined1 (*) [16])(this + 0x1d0) = (undefined1  [16])0x0;
  *(undefined1 (*) [16])(this + 0x1e0) = (undefined1  [16])0x0;
  this_00 = (LocalVector<RenderingDeviceDriver::TextureBarrier,unsigned_int,false,false> *)
            (this + 0x200);
...
LAB_00108728:
        _err_print_index_error
                  ("operator[]","./core/templates/local_vector.h",0xb2,uVar10,uVar14,"p_index",
                   "count","",false,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar4 = (code *)invalidInstructionException();
      ...
      *(ulong *)(this + 0x1e8) = *(ulong *)(this + 0x1e8) | *(ulong *)(lVar16 + 0x10);
      if (0 < iVar12) {
        do {
          ...
          uVar10 = (ulong)uVar9;
          if (*(uint *)(this + 0x50) <= uVar9) goto LAB_00108728;
          ...
          if (uVar9 == *(uint *)(this + 500)) {
            ...
            *(void **)(this + 0x1f8) = pvVar11;
            if (pvVar11 == (void *)0x0) goto LAB_00108940;
            uVar9 = *(uint *)(this + 0x1f0);
          }
          iVar17 = iVar17 + 1;
      ...
      if (0 < *(int *)(lVar16 + 0x24)) {
        do {
          ...
          uVar10 = (ulong)uVar9;
          if (*(uint *)(this + 0x60) <= uVar9) goto LAB_00108728;
...
LAB_00108940:
  ...
  uVar13 = _UNK_001129d8;
  pRVar15 = this + 0x1e0;
  if (param_5 == '\0') {
    iVar12 = *(int *)(this + 0x1f0);
    iVar17 = *(int *)(this + 0x210);
    if (*(long *)(this + 0x1e0) != 0) goto LAB_00108ab1;
    ...
    if (lVar16 != 0) goto LAB_00108ad1;
    if (iVar17 == 0) goto LAB_00108573;
    uVar13 = *(undefined8 *)(this + 0x208);
    pRVar15 = (RenderingDeviceGraph *)0x0;
    bVar20 = false;
    iVar12 = 0;
LAB_00108c33:
    uVar18 = *(undefined8 *)(this + 0x218);
  }
  else {
    iVar12 = *(int *)(this + 0x1f0);
    iVar17 = *(int *)(this + 0x210);
...
LAB_00108ad6:
    uVar13 = *(undefined8 *)(this_01 + 8);
    if (iVar17 != 0) goto LAB_00108c33;
    uVar18 = 0;
    iVar17 = 0;
  }
  local_48 = *param_2;
  (**(code **)(**(long **)this + 0x210))
            (*(long **)this,&local_48,*(undefined8 *)(this + 0x1d0),*(undefined8 *)(this + 0x1d8),
             pRVar15,bVar20,uVar18,iVar17,uVar13,iVar12);
  if ((*(int *)(this + 0x1f0) != 0) && (*(int *)(this + 0x200) != 0)) {
    local_48 = *param_2;
    (**(code **)(**(long **)this + 0x210))
              (*(long **)this,&local_48,*(undefined8 *)(this + 0x1d0),*(undefined8 *)(this + 0x1d8),
               0,0,0,0,*(undefined8 *)(this + 0x208),*(int *)(this + 0x200));
  }
LAB_00108573:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
...

{
  ...
  if (*(long *)(this + 0x208) != 0) {
    LocalVector<RenderingDeviceDriver::TextureBarrier,unsigned_int,false,false>::resize
              ((LocalVector<RenderingDeviceDriver::TextureBarrier,unsigned_int,false,false> *)
               (this + 0x200),0);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* RenderingDeviceGraph::end(bool, bool, RenderingDeviceDriver::CommandBufferID&,
   RenderingDeviceGraph::CommandBufferPool&) */

void __thiscall
RenderingDeviceGraph::end
          (RenderingDeviceGraph *this,bool param_1,bool param_2,CommandBufferID *param_3,
          CommandBufferPool *param_4)

{
  ...
  bVar18 = 0;
  local_40 = *(long *)(in_FS_OFFSET + 10);
  if (*(int *)(this + 0x188) == 0) goto LAB_00109428;
  if ((char)*in_FS_OFFSET == '\0') {
    ...
    *(undefined1 *)in_FS_OFFSET = 1;
    __cxa_thread_atexit(LocalVector<RenderingDeviceGraph::RecordedCommandSort,unsigned_int,false,false>
                        ::~LocalVector,uVar1,&__dso_handle);
    if (param_1) goto LAB_00109131;
LAB_0010935f:
    local_100 = *(LocalVector<RenderingDeviceGraph::RecordedCommandSort,unsigned_int,false,false> **
                 )in_FS_OFFSET;
    LocalVector<RenderingDeviceGraph::RecordedCommandSort,unsigned_int,false,false>::resize
              (local_100,0);
    LocalVector<RenderingDeviceGraph::RecordedCommandSort,unsigned_int,false,false>::resize
              (local_100,*(uint *)(this + 0x188));
    ...
    if (uVar8 != 0) {
      ...
      do {
        uVar14 = (uint)uVar17;
        uVar15 = uVar17;
        if (uVar14 == uVar10) goto LAB_001092e3;
        *puVar3 = uVar14;
...
LAB_00109131:
    if ((char)*in_FS_OFFSET == '\0') {
      ...
      in_FS_OFFSET[1] = 0;
      *(undefined1 *)in_FS_OFFSET = 1;
      __cxa_thread_atexit(LocalVector<long,unsigned_int,false,false>::~LocalVector,uVar1,
                          &__dso_handle);
    }
    if ((char)*in_FS_OFFSET == '\0') {
      uVar1 = *(undefined8 *)in_FS_OFFSET;
      ...
      in_FS_OFFSET[1] = 0;
      *(undefined1 *)in_FS_OFFSET = 1;
      __cxa_thread_atexit(LocalVector<int,unsigned_int,false,false>::~LocalVector,uVar1,
                          &__dso_handle);
    }
    if ((char)*in_FS_OFFSET == '\0') {
      uVar1 = *(undefined8 *)in_FS_OFFSET;
      ...
      in_FS_OFFSET[1] = 0;
      *(undefined1 *)in_FS_OFFSET = 1;
      __cxa_thread_atexit(LocalVector<unsigned_int,unsigned_int,false,false>::~LocalVector,uVar1,
                          &__dso_handle);
    }
    uVar8 = *(uint *)(this + 0x188);
    uVar10 = *in_FS_OFFSET;
...
LAB_0010918f:
    ...
    if (*(int *)(this + 0x188) != 0) {
      do {
        ...
        uVar17 = (ulong)uVar8;
        if (*(uint *)(this + 0x30) <= uVar8) goto LAB_001092e3;
        ...
        if (-1 < (int)uVar8) {
          ...
          do {
            ...
            if (*(uint *)(this + 400) <= uVar8) goto LAB_001092e3;
            uVar15 = (ulong)*in_FS_OFFSET;
            puVar3 = (uint *)(*(long *)(this + 0x198) + (long)(int)uVar8 * 8);
            uVar8 = *puVar3;
            uVar17 = (ulong)uVar8;
            if (*in_FS_OFFSET <= uVar8) goto LAB_001092e3;
    ...
    LocalVector<long,unsigned_int,false,false>::resize
              ((LocalVector<long,unsigned_int,false,false> *)local_100,0);
    uVar17 = 0;
    if (*(int *)(this + 0x188) != 0) {
      do {
        uVar15 = (ulong)*in_FS_OFFSET;
        ...
        if (*(int *)(*(long *)(in_FS_OFFSET + 2) + uVar17 * 4) == 0) {
          ...
          if (uVar8 == *in_FS_OFFSET) {
            ...
            *(void **)in_FS_OFFSET = pvVar5;
            if (pvVar5 == (void *)0x0) goto LAB_00109c83;
            uVar8 = *in_FS_OFFSET;
          }
    ...
    while (uVar8 != 0) {
      ...
      LocalVector<long,unsigned_int,false,false>::resize
                ((LocalVector<long,unsigned_int,false,false> *)local_100,uVar8 - 1);
      uVar8 = *in_FS_OFFSET;
...
LAB_00109c83:
          _err_print_error("push_back","./core/templates/local_vector.h",0x41,
                           "FATAL: Condition \"!data\" is true.","Out of memory",0,0,pvVar5);
          _err_flush_stdout();
                    /* WARNING: Does not return */
          pcVar2 = (code *)invalidInstructionException();
          (*pcVar2)();
      ...
      *(uint *)(*(long *)(in_FS_OFFSET + 2) + (ulong)uVar8 * 4) = uVar10;
      uVar15 = (ulong)*(uint *)(this + 0x40);
      uVar17 = uVar17 & 0xffffffff;
      if (*(uint *)(this + 0x40) <= uVar10) goto LAB_001092e3;
      uVar15 = (ulong)*(uint *)(this + 0x30);
      ...
      while (-1 < (int)uVar8) {
        ...
        puVar3 = (uint *)(*(long *)(this + 0x198) + (long)(int)uVar8 * 8);
        uVar17 = (ulong)*puVar3;
        if (*in_FS_OFFSET <= *puVar3) goto LAB_001092e3;
    ...
    local_78 = __LC88;
    uStack_70 = _UNK_001129f8;
    local_68 = __LC89;
    uStack_60 = _UNK_00112a08;
    local_58 = __LC90;
    uStack_50 = _UNK_00112a18;
    local_48 = _LC91;
    LocalVector<RenderingDeviceGraph::RecordedCommandSort,unsigned_int,false,false>::resize
              (local_100,0);
    LocalVector<RenderingDeviceGraph::RecordedCommandSort,unsigned_int,false,false>::resize
    ...
    for (uVar8 = 0; uVar8 < *(uint *)(this + 0x188); uVar8 = uVar8 + 1) {
      uVar15 = (ulong)*in_FS_OFFSET;
      if (*in_FS_OFFSET <= uVar8) goto LAB_0010996e;
      uVar15 = (ulong)*(uint *)(this + 0x40);
      ...
      uVar17 = (ulong)uVar14;
      if (*(uint *)(this + 0x30) <= uVar14) goto LAB_001092e3;
...
LAB_00109d3f:
      ...
      while (uVar17 = (ulong)uVar14, -1 < (int)uVar14) {
        uVar15 = (ulong)*(uint *)(this + 400);
        if (*(uint *)(this + 400) <= uVar14) goto LAB_001092e3;
        puVar3 = (uint *)(*(long *)(this + 0x198) + (long)(int)uVar14 * 8);
        uVar14 = *puVar3;
        uVar17 = (ulong)uVar14;
        uVar15 = (ulong)*in_FS_OFFSET;
        if (*in_FS_OFFSET <= uVar14) goto LAB_001092e3;
      ...
      uVar14 = *in_FS_OFFSET;
      if (uVar14 <= uVar10) goto LAB_00109d3f;
      piVar7[2] = uVar10;
  ...
  if (*(int *)(this + 0x188) != 0) {
    ...
    if (param_1) {
      LocalVector<RenderingDeviceGraph::RecordedCommandSort,unsigned_int,false,false>::
      sort_custom<_DefaultComparator<RenderingDeviceGraph::RecordedCommandSort>>(local_100);
      local_cc = 0;
      uVar15 = (ulong)*in_FS_OFFSET;
      if (*in_FS_OFFSET == 0) {
        uVar17 = 0;
...
LAB_001092e3:
        _err_print_index_error
                  ("operator[]","./core/templates/local_vector.h",0xb2,uVar17,uVar15,"p_index",
                   "count","",false,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar2 = (code *)invalidInstructionException();
...
LAB_00109910:
          ...
          if (*(int *)(*(long *)in_FS_OFFSET + uVar17 * 0xc) != iVar16) {
            if ((uint)uVar15 <= uVar8) goto LAB_0010996e;
            uVar10 = uVar14 - uVar8;
            ...
            uVar15 = (ulong)*in_FS_OFFSET;
            if (*in_FS_OFFSET <= uVar14) goto LAB_00109910;
            uVar10 = *(uint *)(this + 0x188);
...
LAB_00109730:
        ...
        local_c8 = *(undefined8 *)param_3;
        _group_barriers_for_render_commands
                  (this,&local_c8,*(long *)(in_FS_OFFSET + 2) + lVar6,1,param_2);
        uVar10 = *in_FS_OFFSET;
        if (uVar10 <= uVar8) goto LAB_00109730;
        uVar10 = uVar8 + 1;
...
/* RenderingDeviceGraph::_print_draw_list(unsigned char const*, unsigned int) */

void __thiscall
RenderingDeviceGraph::_print_draw_list(RenderingDeviceGraph *this,uchar *param_1,uint param_2)
...
LAB_0010a4d3:
      ...
      case 5:
        ...
        stringify_variants<unsigned_int,char_const*,unsigned_int>
                  ((Variant *)&local_60,(uint)(Variant *)local_58,(char *)(ulong)uVar13,0x10b7ad);
        __print_line((String *)&local_60);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
        if (Variant::needs_deinit[local_58[0]] != '\0') {
          Variant::_clear_internal();
      ...
      case 6:
        ...
        stringify_variants<unsigned_int,char_const*,unsigned_int>
                  ((Variant *)&local_60,(uint)(Variant *)local_58,(char *)(ulong)uVar13,0x10b7c7);
        __print_line((String *)&local_60);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
        if (Variant::needs_deinit[local_58[0]] != '\0') {
          Variant::_clear_internal();
      ...
      case 7:
        ...
        stringify_variants<unsigned_int,char_const*,unsigned_int,char_const*,unsigned_int>
                  ((Variant *)&local_60,(uint)(Variant *)local_58,(char *)(ulong)uVar5,0x10b7c7,
                   (char *)(ulong)uVar13,0x10b7df);
        __print_line((String *)&local_60);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
        cVar3 = Variant::needs_deinit[local_58[0]];
        goto joined_r0x0010a0fe;
      case 8:
        uVar10 = *(undefined4 *)(puVar9 + 0x14);
...
/* RenderingDeviceGraph::_print_compute_list(unsigned char const*, unsigned int) */

void __thiscall
RenderingDeviceGraph::_print_compute_list(RenderingDeviceGraph *this,uchar *param_1,uint param_2)
...
void __thiscall
RenderingDeviceGraph::_print_render_commands
          (RenderingDeviceGraph *this,RecordedCommandSort_conflict *param_1,uint param_2)
...
LAB_0010ae3a:
        _err_print_index_error
                  ("operator[]","./core/templates/local_vector.h",0xb2,uVar8,(ulong)uVar3,"p_index",
                   "count","",false,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_0010b1ae:
        stringify_variants<char_const*,unsigned_int,char_const*,unsigned_int>
                  ((Variant *)local_60,(char *)local_58,0x10b8e4,(char *)(ulong)uVar4,uVar11);
        __print_line((String *)local_60);
...
LAB_0010ae9b:
      ...
      print_line<char_const*,unsigned_int,char_const*,String>
                (local_58,"LEVEL",uVar4,pcVar9,local_60);
      cVar2 = Variant::needs_deinit[local_58[0]];
joined_r0x0010af6b:
      if (cVar2 != '\0') {
        Variant::_clear_internal();
...
void __thiscall
LocalVector<RenderingDeviceGraph::ResourceTracker*,unsigned_int,false,false>::~LocalVector
          (LocalVector<RenderingDeviceGraph::ResourceTracker*,unsigned_int,false,false> *this)
...
/* LocalVector<RenderingDeviceGraph::ResourceUsage, unsigned int, false, false>::~LocalVector() */

void __thiscall
LocalVector<RenderingDeviceGraph::ResourceUsage,unsigned_int,false,false>::~LocalVector
          (LocalVector<RenderingDeviceGraph::ResourceUsage,unsigned_int,false,false> *this)
...
void __thiscall
LocalVector<RenderingDeviceGraph::RecordedCommandSort,unsigned_int,false,false>::~LocalVector
          (LocalVector<RenderingDeviceGraph::RecordedCommandSort,unsigned_int,false,false> *this)
...
/* LocalVector<long, unsigned int, false, false>::~LocalVector() */

void __thiscall
LocalVector<long,unsigned_int,false,false>::~LocalVector
          (LocalVector<long,unsigned_int,false,false> *this)
...
/* LocalVector<int, unsigned int, false, false>::~LocalVector() */

void __thiscall
LocalVector<int,unsigned_int,false,false>::~LocalVector
          (LocalVector<int,unsigned_int,false,false> *this)
...
/* Rect2i::merge(Rect2i const&) const */

undefined8 __thiscall Rect2i::merge(Rect2i *this,Rect2i *param_1)

{
  ...
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  if ((((*(int *)(this + 8) < 0) || (*(int *)(this + 0xc) < 0)) || (*(int *)(param_1 + 8) < 0)) ||
     (*(int *)(param_1 + 0xc) < 0)) {
    _err_print_error("merge","./core/math/rect2i.h",0x6f,
                     "Rect2i size is negative, this is not supported. Use Rect2i.abs() to get a Rect2i with a positive size."
                     ,0,0);
  }
  local_30 = 0;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashMap<unsigned long, RenderingDeviceGraph::FramebufferStorage, HashMapHasherDefault,
   ...
   RenderingDeviceGraph::FramebufferStorage const&, bool) */

void HashMap<unsigned_long,RenderingDeviceGraph::FramebufferStorage,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>,DefaultTypedAllocator<HashMapElement<unsigned_long,RenderingDeviceGraph::FramebufferStorage>>>
     ::insert(ulong *param_1,FramebufferStorage *param_2,bool param_3)
  ...
  if (local_78 == (void *)0x0) {
    ...
    *(void **)(param_2 + 8) = local_78;
    if (uVar39 != 0) {
      ...
      if ((pvVar4 < (void *)((long)local_78 + uVar42)) &&
         (local_78 < (void *)((long)pvVar4 + uVar32))) {
        uVar32 = 0;
        do {
    ...
    lVar40 = *plVar36;
    iVar35 = *(int *)(param_2 + 0x2c);
    if (local_78 != (void *)0x0) goto LAB_0010c17c;
  }
  else {
LAB_0010c16b:
    lVar40 = *plVar36;
...
LAB_0010c17c:
      ...
      if (uVar43 != 0) {
        do {
          if (((uint)uVar46 == uVar43) &&
             (*(long *)(*(long *)((long)local_78 + lVar37 * 8) + 0x10) == lVar40)) {
  ...
  *(int *)(param_2 + 0x2c) = *(int *)(param_2 + 0x2c) + 1;
LAB_0010c650:
  *param_1 = (ulong)pauVar34;
  return;
}



/* LocalVector<RenderingDeviceGraph::Frame, unsigned int, false, true>::resize(unsigned int) */

void __thiscall
LocalVector<RenderingDeviceGraph::Frame,unsigned_int,false,true>::resize
          (LocalVector<RenderingDeviceGraph::Frame,unsigned_int,false,true> *this,uint param_1)
    ...
    do {
      ...
      if (pvVar6 != (void *)0x0) {
        if (*puVar9 != 0) {
          ...
          *puVar9 = 0;
          if (pvVar6 == (void *)0x0) goto LAB_0010c88f;
        }
...
LAB_0010c88f:
    ...
    if (*(uint *)(this + 4) < param_1) {
      ...
      *(long *)(this + 8) = lVar7;
      ...
      uVar8 = *(uint *)this;
      if (param_1 <= uVar8) goto LAB_0010c89d;
    }
    lVar7 = *(long *)(this + 8);
    ...
    do {
      ...
      *(undefined4 *)(puVar2 + 2) = 0;
      puVar2 = puVar3;
                       ...
                       (lVar7 + 0x18 + ((ulong)((param_1 - 1) - uVar8) + (ulong)uVar8) * 0x18));
  }
LAB_0010c89d:
  *(uint *)this = param_1;
  return;
...
/* LocalVector<long, unsigned int, false, false>::resize(unsigned int) */

void __thiscall
LocalVector<long,unsigned_int,false,false>::resize
          (LocalVector<long,unsigned_int,false,false> *this,uint param_1)
  ...
  if (uVar1 <= param_1) {
    ...
    if (*(uint *)(this + 4) < param_1) {
      ...
      *(long *)(this + 8) = lVar4;
      ...
      uVar1 = *(uint *)this;
      if (param_1 <= uVar1) goto LAB_0010ca47;
    }
    lVar4 = *(long *)(this + 8);
...
/* RenderingDeviceGraph::FramebufferCache::~FramebufferCache() */

void __thiscall RenderingDeviceGraph::FramebufferCache::~FramebufferCache(FramebufferCache *this)
  ...
  if (pvVar3 != (void *)0x0) {
    if (*(int *)(this + 0x54) != 0) {
      ...
      if (uVar1 == 0) {
        ...
        *(undefined4 *)(this + 0x54) = 0;
        *(undefined1 (*) [16])(this + 0x40) = (undefined1  [16])0x0;
        if (pvVar3 == (void *)0x0) goto LAB_0010cb37;
      }
    }
...
/* WARNING: Removing unreachable block (ram,0x0010cd88) */
/* WARNING: Removing unreachable block (ram,0x0010cf1d) */
/* WARNING: Removing unreachable block (ram,0x0010cf29) */
/* String vformat<RenderingDeviceGraph::ResourceUsage>(String const&,
   RenderingDeviceGraph::ResourceUsage const) */

undefined8 *
vformat<RenderingDeviceGraph::ResourceUsage>(undefined8 *param_1,bool *param_2,int param_3)
...
void __thiscall
LocalVector<RenderingDeviceDriver::TextureBarrier,unsigned_int,false,false>::resize
          (LocalVector<RenderingDeviceDriver::TextureBarrier,unsigned_int,false,false> *this,
          uint param_1)
  ...
  if (uVar1 <= param_1) {
    ...
    if (*(uint *)(this + 4) < param_1) {
      ...
      *(long *)(this + 8) = lVar4;
      ...
      uVar1 = *(uint *)this;
      if (param_1 <= uVar1) goto LAB_0010d000;
    }
    lVar4 = *(long *)(this + 8);
...
/* String stringify_variants<Color>(Variant const&, Color) */

String * stringify_variants<Color>(undefined8 param_1_00,undefined8 param_2,String *param_1)
...
/* String stringify_variants<float>(Variant const&, float) */

Variant * stringify_variants<float>(Variant *param_1,float param_2)
...
/* String stringify_variants<Rect2i>(Variant const&, Rect2i) */

String * stringify_variants<Rect2i>
                   (String *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)
...
Variant * stringify_variants<unsigned_int,unsigned_int,unsigned_int>
                    (Variant *param_1,uint param_2,uint param_3,uint param_4)
...
/* void LocalVector<RenderingDeviceGraph::RecordedCommandSort, unsigned int, false,
   false>::sort_custom<_DefaultComparator<RenderingDeviceGraph::RecordedCommandSort> >() */

void __thiscall
LocalVector<RenderingDeviceGraph::RecordedCommandSort,unsigned_int,false,false>::
sort_custom<_DefaultComparator<RenderingDeviceGraph::RecordedCommandSort>>
          (LocalVector<RenderingDeviceGraph::RecordedCommandSort,unsigned_int,false,false> *this)

{
  ...
  SortArray<RenderingDeviceGraph::RecordedCommandSort,_DefaultComparator<RenderingDeviceGraph::RecordedCommandSort>,true>
  ::introsort(0,uVar7,__src,lVar4 * 2);
  pRVar10 = __src + 0xc;
  if (uVar7 < 0x11) {
    uVar8 = 1;
    pRVar11 = pRVar10;
    do {
      ...
      uVar5 = (uint)uVar1;
      if ((uVar5 < *(uint *)__src) ||
         ((uVar12 = (uint)((ulong)uVar1 >> 0x20), pRVar3 = pRVar11, uVar6 = uVar8,
          uVar5 <= *(uint *)__src &&
          ((uVar12 < *(uint *)(__src + 4) ||
           ((uVar12 <= *(uint *)(__src + 4) && (iVar2 < *(int *)(__src + 8))))))))) {
        ...
        *(undefined8 *)__src = uVar1;
        ...
        while( true ) {
          if ((*(uint *)(pRVar3 + -0xc) <= uVar5) &&
             ((*(uint *)(pRVar3 + -0xc) < uVar5 ||
              ((*(uint *)(pRVar3 + -8) <= uVar12 &&
               ((*(uint *)(pRVar3 + -8) < uVar12 || (*(int *)(pRVar3 + -4) <= iVar2))))))))
          goto LAB_0010e07e;
          if (uVar6 == 1) break;
...
LAB_0010e07e:
    ...
    do {
      ...
      uVar5 = (uint)uVar1;
      if ((uVar5 < *(uint *)__src) ||
         ((uVar12 = (uint)((ulong)uVar1 >> 0x20), pRVar3 = pRVar11, lVar9 = lVar4,
          uVar5 <= *(uint *)__src &&
          ((uVar12 < *(uint *)(__src + 4) ||
           ((uVar12 <= *(uint *)(__src + 4) && (iVar2 < *(int *)(__src + 8))))))))) {
        memmove(pRVar10,__src,(long)pRVar11 - (long)__src);
...
LAB_0010de5a:
    ...
    do {
      ...
      uVar6 = uVar8;
      while( true ) {
        if ((*(uint *)(pRVar11 + -0xc) <= (uint)uVar1) &&
           ((*(uint *)(pRVar11 + -0xc) < (uint)uVar1 ||
            ((*(uint *)(pRVar11 + -8) <= uVar5 &&
             ((*(uint *)(pRVar11 + -8) < uVar5 || (*(int *)(pRVar11 + -4) <= iVar2))))))))
        goto LAB_0010deeb;
        if (uVar6 == 1) break;
        uVar6 = uVar6 - 1;
...
Variant * stringify_variants<unsigned_int,char_const*,unsigned_int>
                    (Variant *param_1,uint param_2,char *param_3,uint param_4)
...
Variant * stringify_variants<char_const*,unsigned_int,char_const*,unsigned_int>
                    (Variant *param_1,char *param_2,uint param_3,char *param_4,uint param_5)

{
  ...
  Variant::Variant((Variant *)local_58,(char *)CONCAT44(in_register_00000014,param_3));
  stringify_variants<unsigned_int,char_const*,unsigned_int>
            ((Variant *)&local_70,(uint)(Variant *)local_58,(char *)((ulong)param_4 & 0xffffffff),
             param_5);
  local_78 = 0;
  local_68 = &_LC87;
  local_60 = 1;
...
/* String stringify_variants<unsigned int, char const*, unsigned int, char const*, unsigned
   int>(Variant const&, unsigned int, char const*, unsigned int, char const*, unsigned int) */

Variant * stringify_variants<unsigned_int,char_const*,unsigned_int,char_const*,unsigned_int>
                    (Variant *param_1,uint param_2,char *param_3,uint param_4,char *param_5,
                    uint param_6)

{
  ...
  Variant::Variant((Variant *)local_58,(uint)param_3);
  stringify_variants<char_const*,unsigned_int,char_const*,unsigned_int>
            ((Variant *)&local_70,(char *)local_58,param_4,(char *)((ulong)param_5 & 0xffffffff),
             param_6);
  local_68 = &_LC87;
  local_78 = 0;
  local_60 = 1;
...
void print_line<String,char_const*,unsigned_int,char_const*,unsigned_int,char_const*,unsigned_int>
               (undefined8 param_1,CowData *param_2,char *param_3,uint param_4,uint param_5,
...

{
  ...
  Variant::Variant((Variant *)local_58,param_3);
  stringify_variants<unsigned_int,char_const*,unsigned_int,char_const*,unsigned_int>
            ((Variant *)&local_90,(uint)(Variant *)local_58,(char *)(ulong)param_4,param_5,
             (char *)(ulong)param_6,param_7);
  local_98 = 0;
  local_88 = &_LC87;
  local_80 = 1;
  String::parse_latin1((StrRange *)&local_98);
...
String * stringify_variants<String,char_const*,unsigned_int>
                   (String *param_1,undefined8 param_2,String *param_3,uint param_4)
...
String * stringify_variants<char_const*,RenderingDeviceCommons::IndexBufferFormat,char_const*,unsigned_int>
                   (String *param_1,undefined8 param_2,char *param_3,int param_4,uint param_5)
...
void print_line<String,char_const*,RenderingDeviceCommons::IndexBufferFormat,char_const*,unsigned_int>
...
LAB_0010f274:
  ...
  stringify_variants<char_const*,RenderingDeviceCommons::IndexBufferFormat,char_const*,unsigned_int>
            (&local_70,(Variant *)local_58,param_3,param_4,param_5,param_6);
  local_78 = 0;
  local_68 = &_LC87;
  local_60 = 1;
  String::parse_latin1((StrRange *)&local_78);
...
/* String stringify_variants<char const*, String, char const*, unsigned int>(Variant const&, char
   const*, String, char const*, unsigned int) */

String * stringify_variants<char_const*,String,char_const*,unsigned_int>
...
LAB_0010f51a:
  Variant::Variant((Variant *)local_58,param_3);
  stringify_variants<String,char_const*,unsigned_int>
            (&local_70,(Variant *)local_58,&local_78,param_5,param_6);
  local_68 = &_LC87;
  local_80 = 0;
  local_60 = 1;
...
void print_line<char_const*,unsigned_int,char_const*,String,char_const*,unsigned_int>
               (undefined8 param_1,char *param_2,uint param_3,undefined8 param_4,CowData *param_5,
...
LAB_0010fb59:
    ...
    local_b8 = 0;
    if (local_c0 == 0) goto LAB_0010fb59;
  ...
  Variant::Variant((Variant *)local_58,param_3);
  stringify_variants<char_const*,String,char_const*,unsigned_int>
            ((StrRange *)&local_90,(Variant *)local_58,param_4,(Variant *)&local_98,param_6,param_7,
             this_00,param_1);
  local_88 = &_LC87;
  local_a0 = 0;
  local_80 = 1;
...
/* void print_line<String, char const*, String, char const*, unsigned int>(Variant const&, String,
   char const*, String, char const*, unsigned int) */

void print_line<String,char_const*,String,char_const*,unsigned_int>
               (undefined8 param_1,CowData *param_2,undefined8 param_3,CowData *param_4,
               undefined8 param_5,undefined4 param_6)

{
  ...
  stringify_variants<char_const*,String,char_const*,unsigned_int>
            (&local_70,(Variant *)local_58,param_3,&local_78,param_5,param_6,param_1);
  local_68 = &_LC87;
  local_80 = 0;
  local_60 = 1;
  String::parse_latin1((StrRange *)&local_80);
...
String * stringify_variants<unsigned_int,char_const*,String>
                   (String *param_1,undefined8 param_2,uint param_3,undefined8 param_4,long *param_5
                   )
...
/* void print_line<char const*, unsigned int, char const*, String>(Variant const&, char const*,
   unsigned int, char const*, String) */

void print_line<char_const*,unsigned_int,char_const*,String>
               (undefined8 param_1,char *param_2,undefined4 param_3,undefined8 param_4,
               CowData *param_5)

{
  ...
  Variant::Variant((Variant *)local_58,param_2);
  stringify_variants<unsigned_int,char_const*,String>
            (&local_70,(Variant *)local_58,param_3,param_4,&local_78);
  local_80 = 0;
  local_68 = &_LC87;
  local_60 = 1;
  String::parse_latin1((StrRange *)&local_80);
...
void print_line<char_const*,unsigned_int,char_const*>
               (Variant *param_1,char *param_2,uint param_3,char *param_4)
...
String * stringify_variants<char_const*,String,char_const*,String>
                   (String *param_1,undefined8 param_2,char *param_3,long *param_4,
...
LAB_00110f3d:
  ...
  stringify_variants<String,char_const*,String>
            (&local_70,(Variant *)local_58,&local_80,param_5,&local_78);
  local_68 = &_LC87;
  local_88 = 0;
  local_60 = 1;
  String::parse_latin1((StrRange *)&local_88);
...
/* void print_line<char const*, unsigned int, char const*, String, char const*, String>(Variant
   const&, char const*, unsigned int, char const*, String, char const*, String) */

void print_line<char_const*,unsigned_int,char_const*,String,char_const*,String>
               (undefined8 param_1,char *param_2,uint param_3,undefined8 param_4,CowData *param_5,
               undefined8 param_6,CowData *param_7)
...
LAB_001116d9:
      local_c0 = 0;
      local_c8 = 0;
      if (local_d8 != 0) goto LAB_00111238;
      Variant::Variant((Variant *)local_78,param_2);
    }
  }
  else {
...
LAB_001112b6:
  ...
  local_110 = (CowData *)&local_d8;
  Variant::Variant((Variant *)local_58,param_3);
  stringify_variants<char_const*,String,char_const*,String>
            ((StrRange *)&local_90,(Variant *)local_58,param_4,(CowData<char32_t> *)&local_a0,
             param_6,local_118);
  local_a8 = 0;
  local_88 = &_LC87;
  local_80 = 1;
...
void print_line<String,char_const*,String,char_const*,String>
               (undefined8 param_1,CowData *param_2,undefined8 param_3,CowData *param_4,
               undefined8 param_5,CowData *param_6)

{
  ...
  stringify_variants<char_const*,String,char_const*,String>
            (&local_70,(Variant *)local_58,param_3,(CowData<char32_t> *)&local_80,param_5,
...
String * stringify_variants<String,char_const*,Color>
                   (undefined8 param_1_00,undefined8 param_2,String *param_1,undefined8 param_4,
...
/* String stringify_variants<unsigned int, char const*, String, char const*, Color>(Variant const&,
   unsigned int, char const*, String, char const*, Color) */

String * stringify_variants<unsigned_int,char_const*,String,char_const*,Color>
                   (undefined8 param_1_00,undefined8 param_2,String *param_1,undefined8 param_4,
                   uint param_5,char *param_6,CowData *param_7,undefined8 param_8)

{
  ...
  Variant::Variant((Variant *)local_58,param_6);
  stringify_variants<String,char_const*,Color>
            (param_1_00,param_2,(StrRange *)&local_90,(Variant *)local_58,(Variant *)&local_98,
             param_8);
  local_88 = &_LC87;
  local_a0 = 0;
  local_80 = 1;
...
/* void print_line<char const*, unsigned int, char const*, String, char const*, Color>(Variant
   const&, char const*, unsigned int, char const*, String, char const*, Color) */

void print_line<char_const*,unsigned_int,char_const*,String,char_const*,Color>
               (undefined8 param_1,undefined8 param_2_00,undefined8 param_3_00,char *param_2,
               undefined4 param_3,undefined8 param_4,CowData *param_7,undefined8 param_8)

{
  ...
  Variant::Variant((Variant *)local_58,param_2);
  stringify_variants<unsigned_int,char_const*,String,char_const*,Color>
            (param_1,param_2_00,&local_70,(Variant *)local_58,param_3,param_4,&local_78,param_8);
  local_68 = &_LC87;
  local_80 = 0;
  local_60 = 1;
  String::parse_latin1((StrRange *)&local_80);

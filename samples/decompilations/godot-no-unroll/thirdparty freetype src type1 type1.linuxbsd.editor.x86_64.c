...

{
  ...
  *param_2 = *(undefined8 *)(param_1 + 0x138);
  ...
  param_2[8] = *(undefined8 *)(param_1 + 0x178);
  param_2[9] = uVar1;
  uVar1 = *(undefined8 *)(param_1 + 400);
  param_2[10] = *(undefined8 *)(param_1 + 0x188);
  param_2[0xb] = uVar1;
  uVar1 = *(undefined8 *)(param_1 + 0x1a0);
  param_2[0xc] = *(undefined8 *)(param_1 + 0x198);
  param_2[0xd] = uVar1;
  uVar1 = *(undefined8 *)(param_1 + 0x1b0);
  param_2[0xe] = *(undefined8 *)(param_1 + 0x1a8);
  param_2[0xf] = uVar1;
  uVar1 = *(undefined8 *)(param_1 + 0x1c0);
  param_2[0x10] = *(undefined8 *)(param_1 + 0x1b8);
  param_2[0x11] = uVar1;
  uVar1 = *(undefined8 *)(param_1 + 0x1d0);
  param_2[0x12] = *(undefined8 *)(param_1 + 0x1c8);
  param_2[0x13] = uVar1;
  uVar1 = *(undefined8 *)(param_1 + 0x1e0);
  param_2[0x14] = *(undefined8 *)(param_1 + 0x1d8);
  param_2[0x15] = uVar1;
  uVar1 = *(undefined8 *)(param_1 + 0x1f0);
  param_2[0x16] = *(undefined8 *)(param_1 + 0x1e8);
  param_2[0x17] = uVar1;
  uVar1 = *(undefined8 *)(param_1 + 0x200);
  param_2[0x18] = *(undefined8 *)(param_1 + 0x1f8);
  param_2[0x19] = uVar1;
  uVar1 = *(undefined8 *)(param_1 + 0x210);
  param_2[0x1a] = *(undefined8 *)(param_1 + 0x208);
  param_2[0x1b] = uVar1;
  return 0;
}
    ...
    *param_2 = CONCAT44((int)*puVar1,uVar6);
    if (uVar6 != 0) {
      do {
        ...
        *(undefined8 *)((long)param_2 + lVar4 + 0x18) =
             puVar2[(ulong)*(byte *)((long)puVar1 + lVar4 + 0xa8) - 1];
        lVar4 = lVar4 + 0x18;
      } while (uVar5 != uVar6);
    }
    return 0;
...

{
  ...
  memset((void *)(*(long *)(puVar2 + 0x42) + (ulong)param_2 * 8),0,
         (ulong)((uVar1 - 1) - param_2) * 8 + 8);
  return 0;
}
...
undefined8 T1_Driver_Init(long param_1)
...
void T1_Parse_Glyph_And_Get_Char_String
               (long param_1,uint param_2,undefined8 *param_3,undefined1 *param_4)
...

{
  ...
  if ((iVar2 == 0) &&
     (plVar1 = *(long **)(*(long *)(*(long *)(param_1 + 8) + 0xf0) + 0x68), plVar1 != (long *)0x0))
  {
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  *param_2 = 0;
  iVar3 = (*(code *)**(undefined8 **)(lVar1 + 0x18))
                    (auStack_bf8,param_1,0,0,*(undefined8 *)(param_1 + 0x288),uVar2,0,0,
                     T1_Parse_Glyph);
  if (iVar3 == 0) {
...
LAB_00100927:
    (**(code **)(*(long *)(lVar1 + 0x18) + 8))(auStack_bf8);
  }
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return iVar3;
  }
...

{
  ...
  if ((param_4 & 0x10) == 0) {
    uVar2 = (*(code *)**(undefined8 **)(*(long *)(param_1 + 0x310) + 0x18))
                      (auStack_be8,param_1,0,0,*(undefined8 *)(param_1 + 0x288),
                       *(undefined8 *)(param_1 + 0x350),0,0,T1_Parse_Glyph);
...
LAB_00100bb7:
  ft_mem_free(uVar4,*(undefined8 *)(puVar3 + 0x42));
        ...
        *(undefined8 *)(param_1 + 0x238) = uVar9;
        if (local_44 == 0) {
          ...
          *(undefined8 *)(param_1 + 0x240) = uVar9;
          if ((local_44 == 0) &&
             (local_44 = (**(code **)*puVar3)(puVar1,local_78,uVar10), local_44 == 0)) {
            if (0 < local_78) {
              iVar7 = 0;
              do {
                iVar11 = iVar7 + 1;
...
LAB_0010104e:
                  if (bVar6) {
LAB_001010a8:
                    if (((pbVar12 + 2 < pbVar4) && (*pbVar12 == 0x2f)) &&
                       (iVar11 = iVar7, iVar7 < local_74)) goto LAB_001010cc;
LAB_00101140:
                  ...
                  if (((pbVar4 <= __s1 + 2) || (*__s1 != 0x2f)) ||
                     (pbVar12 = __s1, local_74 <= iVar7)) goto LAB_00101020;
LAB_001010cc:
                  __s1 = pbVar12 + 1;
                  *param_2 = (ulong)__s1;
                  (*(code *)param_2[8])(param_2);
                  ...
                  if (iVar7 < local_78) {
                    ...
                    *(undefined1 *)
                     (*(long *)(param_2[0x1e] + (long)iVar11 * 8) + (uVar10 & 0xffffffff)) = 0;
                  }
                  iVar7 = iVar7 + 1;
                }
LAB_00101020:
    ...
    else if ((__s1 + 0x11 < pbVar4) &&
            (iVar7 = strncmp((char *)__s1,"StandardEncoding",0x10), iVar7 == 0)) {
      *(undefined4 *)(param_1 + 0x220) = 2;
    }
    else if ((__s1 + 0xf < pbVar4) &&
            (iVar7 = strncmp((char *)__s1,"ExpertEncoding",0xe), iVar7 == 0)) {
      *(undefined4 *)(param_1 + 0x220) = 4;
    }
    else if ((__s1 + 0x12 < pbVar4) &&
            (iVar7 = strncmp((char *)__s1,"ISOLatin1Encoding",0x11), iVar7 == 0)) {
...
int T1_Load_Glyph(long param_1,long param_2,uint param_3,uint param_4)
...
LAB_00101635:
  ...
  *(undefined4 *)(param_1 + 0x90) = 0x6f75746c;
  iVar8 = (*(code *)*puVar6)(local_bf8,lVar5,param_2,param_1,*(undefined8 *)(lVar5 + 0x288),uVar16,
                             uVar14,(int)param_4 >> 0x10 & 0xf,T1_Parse_Glyph);
  if (iVar8 == 0) {
      ...
      *(uint *)(param_1 + 0xe8) = *(uint *)(param_1 + 0xe8) & 1 | 4;
      if ((param_4 & 0x400) == 0) {
        ...
        *(undefined4 *)(param_1 + 0x90) = 0x6f75746c;
        ...
        if (((local_c38 != 0x10000) || (lStack_c20 != 0x10000)) ||
           (lStack_c30 != 0 || local_c28 != 0)) {
        ...
        if ((local_c74 == 0) || (local_c49 != '\0')) {
          ...
          if (((cVar1 == '\0') || (local_b70 == 0)) &&
             (sVar2 = *(short *)(local_bd8 + 2), 0 < sVar2)) {
...
LAB_0010206f:
  ...
  if (bVar3 == 0x65) {
    if (pbVar2 == __s1 + 6) {
LAB_0010209c:
      iVar7 = strncmp((char *)__s1,"eexec",5);
joined_r0x00102147:
      if (iVar7 == 0) goto LAB_001020e0;
    }
    ...
    if (bVar3 == 99) {
      if (pbVar2 == __s1 + 10) {
LAB_00102131:
        iVar7 = strncmp((char *)__s1,"closefile",9);
    ...
    if (bVar3 == 0x46) {
      if (pbVar2 == __s1 + 0xe) {
LAB_00102029:
        iVar7 = strncmp((char *)__s1,"FontDirectory",0xd);
        if (iVar7 == 0) {
      ...
      *param_2 = (long)pbVar1;
      ...
      if (*(uint *)(param_2 + 3) == 0) {
        ...
        if (((int)uVar8 - 1U < 0x15) && ((byte *)*param_2 < pbVar2)) {
          ...
          __s = "version";
          puVar13 = t1_keywords;
          while (((bVar3 != bVar6 || (sVar9 = strlen(__s), uVar8 != sVar9)) ||
                 (iVar7 = memcmp(pbVar1,__s,uVar8), iVar7 != 0))) {
            __s = *(char **)(puVar13 + 0x30);
            puVar13 = puVar13 + 0x30;
            if ((byte *)__s == (byte *)0x0) goto LAB_001020c7;
            bVar6 = *__s;
          }
          if ((((*(uint *)((long)param_2 + 0x2c4) & 1) + 1 & *(uint *)(puVar13 + 0x28)) != 0) &&
             (((*(uint *)((long)param_2 + 0x2c4) & 2) == 0 ||
              (iVar7 = strcmp(__s,"CharStrings"), iVar7 == 0)))) {
...
LAB_001028d0:
    ...
    if ((int)param_2[0x25] == 0) {
      ...
      local_5c = iVar13;
      if (((iVar13 == 0) &&
          (iVar13 = (**(code **)*puVar7)(plVar2,iVar12 + 6,lVar6), local_5c = iVar13, iVar13 == 0))
         && (iVar13 = (**(code **)*puVar7)(plVar3,4,lVar6), local_5c = iVar13, iVar13 == 0))
      goto LAB_00102685;
    }
    else {
LAB_00102685:
...
LAB_001026ee:
              if (((cVar11 == 'e') && (pcVar8[1] == 'n')) && (pcVar8[2] == 'd')) break;
            }
          }
          else if (((byte)(bVar4 - 0x5b) < 0x23) &&
                  ((0x500000005U >> ((ulong)(bVar4 - 0x5b) & 0x3f) & 1) != 0)) {
            cVar11 = *pcVar8;
            if (cVar11 != 'd') goto LAB_001026ee;
LAB_0010295b:
            if (((pcVar8[1] == 'e') && (pcVar8[2] == 'f')) && (iVar16 != 0)) goto LAB_00102980;
          }
        }
        (*(code *)param_2[8])(param_2);
        pcVar9 = (char *)*param_2;
        ...
        if (*pcVar8 == '/') {
          ...
          iVar13 = read_binary_data(param_2,&local_58,&local_50,
                                    *(long *)(*(long *)(param_1 + 0xf0) + 0x68) != 0);
          ...
          if ((int)param_2[0x25] == 0) {
            ...
            *(undefined1 *)(*(long *)(param_2[0x2b] + (long)iVar16 * 8) + (uVar15 & 0xffffffff)) = 0
            ...
            if ((*(int *)(param_1 + 0x13c) < 0) || (iVar12 + 4 < iVar16)) {
              ...
              local_5c = (*(code *)param_2[0x3c])
                                   (plVar1,iVar16,(long)*(int *)(param_1 + 0x13c) + (long)__dest);
              ft_mem_free(lVar6);
            }
            iVar13 = local_5c;
            if (local_5c != 0) goto LAB_001028d5;
...
LAB_00102980:
      *(int *)(param_2 + 0x25) = iVar16;
      ...
      if (bVar10) {
        ...
        local_5c = iVar13;
        if ((iVar13 == 0) &&
           (iVar13 = (*(code *)param_2[0x48])
                               (plVar3,1,*(undefined8 *)param_2[0x37],*(undefined4 *)param_2[0x38]),
           local_5c = iVar13, iVar13 == 0)) {
          lVar14 = (long)local_78;
          iVar13 = (*(code *)param_2[0x48])
                             (plVar3,2,*(undefined8 *)(param_2[0x2b] + lVar14 * 8),
                              *(undefined4 *)(param_2[0x2c] + lVar14 * 4));
          local_5c = iVar13;
          if ((iVar13 == 0) &&
             ((((iVar13 = (*(code *)param_2[0x48])
                                    (plVar3,3,*(undefined8 *)(param_2[0x37] + lVar14 * 8),
                                     *(undefined4 *)(param_2[0x38] + lVar14 * 4)), local_5c = iVar13
                , iVar13 == 0 &&
                (iVar13 = (*(code *)param_2[0x30])
                                    (plVar2,local_78,*(undefined8 *)param_2[0x43],
                                     *(undefined4 *)param_2[0x44]), local_5c = iVar13, iVar13 == 0))
               && (iVar13 = (*(code *)param_2[0x3c])
                                      (plVar1,local_78,*(undefined8 *)(param_2[0x43] + 8),
                                       *(undefined4 *)(param_2[0x44] + 4)), local_5c = iVar13,
                  iVar13 == 0)) &&
              ((iVar13 = (*(code *)param_2[0x30])
                                   (plVar2,0,*(undefined8 *)(param_2[0x43] + 0x10),
                                    *(undefined4 *)(param_2[0x44] + 8)), local_5c = iVar13,
               iVar13 == 0 &&
               (iVar13 = (*(code *)param_2[0x3c])
                                   (plVar1,0,*(undefined8 *)(param_2[0x43] + 0x18),
                                    *(undefined4 *)(param_2[0x44] + 0xc)), iVar13 == 0))))))
          goto LAB_001028d9;
        }
      }
      else {
        ...
        if (((iVar13 == 0) &&
            (iVar13 = (*(code *)param_2[0x48])
                                (plVar3,1,*(undefined8 *)param_2[0x37],*(undefined4 *)param_2[0x38])
            , local_5c = iVar13, iVar13 == 0)) &&
           (((iVar13 = (*(code *)param_2[0x30])(plVar2,0,".notdef",8), local_5c = iVar13,
             iVar13 == 0 &&
             ((iVar13 = (*(code *)param_2[0x3c])(plVar1,0,&local_45,5), local_5c = iVar13,
              iVar13 == 0 &&
              (iVar13 = (*(code *)param_2[0x30])
                                  (plVar2,iVar16,*(undefined8 *)param_2[0x43],
                                   *(undefined4 *)param_2[0x44]), local_5c = iVar13, iVar13 == 0))))
            && (iVar13 = (*(code *)param_2[0x3c])
                                   (plVar1,iVar16,*(undefined8 *)(param_2[0x43] + 8),
                                    *(undefined4 *)(param_2[0x44] + 4)), local_5c = iVar13,
               iVar13 == 0)))) {
...

{
  ...
  if (((char *)*param_2 < (char *)param_2[2]) && (*(char *)*param_2 == '[')) {
    ...
    if (-1 < local_5c) {
      if ((param_2[2] < *param_2) || (lVar8 = (long)(param_2[2] - *param_2) >> 3, local_5c <= lVar8)
         ) {
LAB_00102d58:
        (*(code *)param_2[8])(param_2);
        ...
        if (((int)param_2[0x4a] != 0) ||
           (local_54 = (**(code **)*puVar3)(puVar1,local_5c,uVar2), iVar5 = local_54, local_54 == 0)
           ) {
          pcVar6 = (char *)*param_2;
          if (pcVar6 + 4 < (char *)param_2[2]) {
            ...
            do {
              ...
              iVar5 = read_binary_data(param_2,&local_50,&local_48,
                                       *(long *)(*(long *)(param_1 + 0xf0) + 0x68) != 0);
              if ((iVar5 == 0) || ((*(code *)param_2[8])(param_2), (int)param_2[3] != 0))
              goto LAB_00102de0;
              (*(code *)param_2[7])(param_2);
              pcVar6 = (char *)*param_2;
              if (((pcVar6 + 4 < (char *)param_2[2]) && ((*pcVar6 == 'p' && (pcVar6[1] == 'u')))) &&
                 (pcVar6[2] == 't')) {
                (*(code *)param_2[8])(param_2);
                (*(code *)param_2[7])(param_2);
              }
              ...
              if ((int)param_2[0x4a] == 0) {
                ...
                if (*(int *)(param_1 + 0x13c) < 0) {
                  ...
                  local_54 = (*(code *)param_2[0x55])
                                       (puVar1,iVar4,(long)__dest + (long)*(int *)(param_1 + 0x13c),
                                        iVar10 - *(int *)(param_1 + 0x13c));
...
LAB_00102d51:
        ...
        param_2[0x57] = uVar7;
        iVar5 = local_54;
        if ((local_54 == 0) && (iVar5 = ft_hash_num_init(uVar7,uVar2), local_54 = iVar5, iVar5 == 0)
           ) goto LAB_00102d51;
      }
LAB_00102fc8:
      *(int *)(param_2 + 3) = iVar5;
  ...
  if (1 < bVar1) {
    do {
      if (param_2 <= *(long *)((long)plVar2 + lVar6)) {
        ...
        lVar6 = FT_MulDiv(param_2 - lVar5,*(long *)((long)plVar3 + lVar6) - lVar4,
                          *(long *)((long)plVar2 + lVar6) - lVar5);
...
LAB_00103287:
    ...
    if (param_2 <= *(long *)(piVar1 + 6)) {
      lVar3 = FT_MulDiv(param_2 - lVar3,*(long *)(piVar1 + 8) - *(long *)(piVar1 + 4),
                        *(long *)(piVar1 + 6) - lVar3);
    ...
    if (param_3 != 3) {
      *param_2 = *(long *)(param_1 + 0x68) + *(long *)(param_1 + 0x78) + *(long *)(param_1 + 0x58) +
      ...
      param_2[1] = *(long *)(param_1 + 0x70) + *(long *)(param_1 + 0x78) + *(long *)(param_1 + 0x58)
                   + *(long *)(param_1 + 0x50) + *(long *)(param_1 + 0x38) +
                   *(long *)(param_1 + 0x30) + *(long *)(param_1 + 0x18) + *(long *)(param_1 + 0x10)
      ;
      param_2[2] = *(long *)(param_1 + 0x70) + *(long *)(param_1 + 0x78) + *(long *)(param_1 + 0x68)
                   + *(long *)(param_1 + 0x60) + *(long *)(param_1 + 0x38) +
                   *(long *)(param_1 + 0x30) + *(long *)(param_1 + 0x28) + *(long *)(param_1 + 0x20)
      ;
      param_2[3] = *(long *)(param_1 + 0x70) + *(long *)(param_1 + 0x78) + *(long *)(param_1 + 0x68)
                   + *(long *)(param_1 + 0x60) + *(long *)(param_1 + 0x58) +
                   *(long *)(param_1 + 0x50) + *(long *)(param_1 + 0x48) + *(long *)(param_1 + 0x40)
      ;
      return;
    }
...

{
  ...
  if (lVar1 == 0) {
    ...
    uVar4 = *(uint *)(lVar1 + 4);
    mm_weights_unmap(*(undefined8 *)(lVar1 + 0x108),auStack_48,uVar4);
    if (param_2 < uVar4) {
      uVar4 = param_2;
    }
    if (uVar4 != 0) {
      memcpy(param_3,__src,(ulong)uVar4 << 3);
    }
    if (uVar4 < param_2) {
      puVar2 = (undefined8 *)((long)param_3 + (ulong)uVar4 * 8);
      do {
        *puVar2 = 0x8000;
        puVar2 = puVar2 + 1;
      } while (puVar2 != (undefined8 *)
                         ((long)param_3 + ((ulong)((param_2 - 1) - uVar4) + (ulong)uVar4) * 8 + 8));
    }
    uVar3 = 0;
  }
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
...

{
  ...
  uVar5 = 0;
  while ((((__s = *(char **)(lVar2 + uVar5 * 8), __s == (char *)0x0 || (*__s != *param_1)) ||
          (sVar4 = strlen(__s), param_2 != sVar4)) ||
         (iVar3 = strncmp(__s,param_1,param_2), iVar3 != 0))) {
    uVar5 = uVar5 + 1;
    if ((long)iVar1 == uVar5) {
      return 0;
    }
...

{
  ...
  if ((int)uVar2 == 0) {
    if (local_2a != -0x7fff) {
      ...
      if ((int)uVar2 != 0) goto LAB_0010428a;
    }
...

{
  ...
  if (((lVar2 != 0) && (puVar1 != (undefined8 *)0x0)) &&
     (UNRECOVERED_JUMPTABLE = (code *)*puVar1, UNRECOVERED_JUMPTABLE != (code *)0x0)) {
                    /* WARNING: Could not recover jumptable at 0x001043b5. Too many branches */
      ...
      if (uVar1 != 0) {
        do {
          while ((uint)uVar7 < param_2) {
            ...
            uVar7 = uVar7 + 1;
            if (uVar1 == uVar7) goto LAB_001045b0;
          }
          uVar7 = uVar7 + 1;
          lVar5 = lVar5 >> 1;
        } while (uVar1 != uVar7);
...
LAB_0010469a:
          ...
          do {
            ...
            if (lVar8 < plVar2[lVar5]) {
              iVar4 = (int)lVar5;
              if (iVar4 == 0) goto LAB_00104740;
              uVar6 = FT_MulDiv(lVar8 - plVar2[iVar4 + -1],puVar3[iVar4] - puVar3[iVar4 + -1],
                                plVar2[iVar4] - plVar2[iVar4 + -1]);
              uVar10 = *(uint *)(lVar12 + 4);
              goto LAB_001046bc;
            }
            lVar5 = lVar5 + 1;
          ...
          if (bVar1 != 0) goto LAB_0010469a;
LAB_00104740:
          uVar6 = *puVar3;
        }
LAB_001046bc:
        local_c8[lVar9] = uVar6;
        lVar9 = lVar9 + 1;
...

{
  ...
  *(undefined8 *)(param_1 + 0x1b0) = _LC19;
  ...
  if (iVar8 == 0) {
    ...
    if (iVar8 != 0) goto LAB_00104971;
LAB_00104ad8:
    iVar8 = FT_Stream_Seek(plVar4,0);
    local_318 = (byte *)CONCAT44(local_318._4_4_,iVar8);
    if (iVar8 != 0) goto LAB_0010498b;
...
LAB_0010498b:
    ...
    local_320 = (int)local_318;
    iVar8 = local_320;
    if ((int)local_318 != 0) goto LAB_001049a9;
  }
  local_320 = parse_dict(param_1,local_308,local_270,local_268);
  plVar4 = local_278;
  uVar15 = local_2e8;
  iVar8 = local_320;
  if (local_320 != 0) goto LAB_001049a9;
  local_31c = 0;
  if ((char)local_250 != '\0') {
    ...
    while (local_31c = read_pfb_tag(plVar4,&local_310,&local_318), iVar8 = local_31c, local_31c == 0
      ...
      if ((short)local_310 != -0x7ffe) {
        if (local_258 == (byte *)0x0) {
          ...
          iVar8 = local_31c;
          if ((local_31c == 0) &&
             (local_260 = (byte *)ft_mem_qalloc(uVar15,local_258,&local_31c), iVar8 = local_31c,
             local_31c == 0)) {
            local_258 = (byte *)0x0;
            goto LAB_0010538f;
          }
  ...
  if (local_270 < pbVar18) {
    while (((((*local_308[0] != 0x65 || (pbVar18 <= local_308[0] + 9)) || (local_308[0][1] != 0x65))
            || ((local_308[0][2] != 0x78 || (local_308[0][3] != 0x65)))) || (local_308[0][4] != 99))
          ) {
      (*local_2c8)(local_308);
      if ((local_2f0 != 0) || ((*local_2d0)(local_308), pbVar18 <= local_308[0])) goto LAB_00105198;
    }
    local_308[2] = local_270 + (long)local_268;
    (*local_2c8)(local_308);
    pbVar6 = local_308[2];
    ...
    if (pbVar18 < pbVar6) goto LAB_00104dac;
  }
  goto LAB_00105198;
LAB_0010538f:
  local_31c = read_pfb_tag(plVar4,&local_310,&local_318);
  pbVar18 = local_318;
  if ((local_31c != 0) || ((short)local_310 != -0x7ffe)) goto LAB_001053c4;
  local_31c = FT_Stream_Read(plVar4,local_260 + (long)local_258,local_318);
  iVar8 = local_31c;
  if (local_31c != 0) goto LAB_001049a9;
...
LAB_001053c4:
  local_31c = 0;
LAB_00104efe:
  (**(code **)(lVar3 + 0x20))(local_260,local_258,0xd971);
  if ((byte *)0x3 < local_258) {
    *local_260 = 0x20;
    ...
    iVar8 = local_320;
    if ((local_31c != 0) ||
       (local_320 = parse_dict(param_1,local_308), iVar8 = local_320, local_320 != 0))
    goto LAB_001049a9;
...
LAB_00105510:
      *(undefined4 *)(param_1 + 0x360) = 0;
      ...
      if (*piVar13 == 1 << ((byte)piVar13[1] & 0x1f)) {
        if (piVar13[0xbe] == 0) {
LAB_00104fd4:
          if (piVar13[1] == 0) goto LAB_00104fdb;
        }
        ...
        piVar13 = *(int **)(param_1 + 0x350);
        if (piVar13 == (int *)0x0) goto LAB_00105510;
        if (piVar13[0xbe] == 0) {
LAB_001052cf:
          if (*piVar13 != 0) goto LAB_00104fd4;
        }
        else {
          ...
          if (*piVar13 != 0) goto LAB_00104ff3;
        }
LAB_00104fdb:
        T1_Done_Blend(param_1);
        piVar13 = *(int **)(param_1 + 0x350);
...
LAB_00104ff3:
      ...
      if (piVar13[1] != 0) {
        ...
        if (*(long *)(param_1 + 0x350) == 0) goto LAB_00105510;
      }
      if (*(int *)(param_1 + 0x360) != 0) {
        uVar15 = ft_mem_realloc(*(undefined8 *)(param_1 + 0xb8),8,0,*(int *)(param_1 + 0x360),0,
                                &local_320);
...
LAB_00104dac:
    ...
    if (((1 < (byte)(bVar2 - 9)) && (bVar2 != 0x20)) && ((bVar2 != 0xd || (!bVar5)))) {
      if (pbVar18 < pbVar6) {
        ...
        local_258 = __n_00;
        if ((((((pbVar18 + 3 < pbVar6) && ((byte)(*pbVar18 - 0x30) < 0x37)) &&
              ((0x7e0000007e03ffU >> ((ulong)(*pbVar18 - 0x30) & 0x3f) & 1) != 0)) &&
             (((byte)(pbVar18[1] - 0x30) < 0x37 &&
              ((0x7e0000007e03ffU >> ((ulong)(pbVar18[1] - 0x30) & 0x3f) & 1) != 0)))) &&
            (((byte)(pbVar18[2] - 0x30) < 0x37 &&
             (((0x7e0000007e03ffU >> ((ulong)(pbVar18[2] - 0x30) & 0x3f) & 1) != 0 &&
              ((byte)(pbVar18[3] - 0x30) < 0x37)))))) &&
           ((0x7e0000007e03ffU >> ((ulong)(pbVar18[3] - 0x30) & 0x3f) & 1) != 0)) {
          local_308[0] = pbVar18;
...
uint T1_Face_Init(undefined8 param_1,undefined8 *param_2,int param_3)

{
  ...
  *param_2 = 1;
  ...
  if ((uVar6 != 0) || (param_3 < 0)) goto LAB_00105a20;
  if ((short)param_3 != 0) {
    uVar6 = 6;
    goto LAB_00105a20;
  }
...
LAB_00105828:
      iVar7 = strcmp(pcVar14,"Bold");
      if ((iVar7 == 0) || (iVar7 = strcmp(pcVar14,"Black"), iVar7 == 0)) {
        param_2[3] = uVar17 | 2;
      }
    }
  }
    ...
    if (pcVar12 == (char *)0x0) goto LAB_00105a90;
LAB_001057c0:
    cVar5 = *pcVar12;
    if (cVar5 != '\0') {
      while (cVar2 = *pcVar14, cVar2 != cVar5) {
        ...
        if ((cVar2 != ' ') && (cVar2 != '-')) {
          if ((cVar2 != '\0') || (param_2[6] = pcVar12, pcVar12 == (char *)0x0)) goto LAB_00105a90;
          goto LAB_00105809;
        }
        cVar5 = *pcVar12;
        pcVar14 = pcVar14 + 1;
        if (cVar5 == '\0') goto LAB_001057fe;
      }
      pcVar14 = pcVar14 + 1;
      pcVar12 = pcVar12 + 1;
      goto LAB_001057c0;
...
LAB_00105809:
  ...
  *(uint *)((long)param_2 + 0x92) =
       CONCAT22(*(undefined2 *)((long)param_2 + 0x12a),*(undefined2 *)((long)param_2 + 0x8e));
  *(undefined2 *)((long)param_2 + 0x96) = *(undefined2 *)((long)param_2 + 300);
  if (lVar9 == 0) goto LAB_00105a20;
  plVar4 = *(long **)(lVar10 + 0x40);
  local_50 = 0x10003756e6963;
  local_58 = param_2;
  uVar6 = FT_CMap_New(plVar4[3],0,&local_58,0);
  if (((uVar6 != 0) && ((char)uVar6 != -0x5d)) && ((uVar6 & 0xff) != 7)) goto LAB_00105a20;
...
int T1_Read_Metrics(long param_1,long param_2)

{
  ...
  if ((local_70 == 0) &&
     (local_70 = FT_Stream_EnterFrame(param_2,*(undefined8 *)(param_2 + 8)), local_70 == 0)) {
...
LAB_0010609a:
      ...
      *(int *)(param_1 + 0x74) = auVar4._12_4_ >> 0x10;
      ...
      lVar19 = *(long *)(lVar12 + 0x20) + _UNK_001077b8;
      ...
      *(int *)(param_1 + 0x84) = (int)(lVar19 >> 0x30);
      ...
      local_70 = (*(code *)*puVar7)(local_68,*(undefined8 *)(param_2 + 0x38),
      ...
      if (local_70 == 0) {
        ...
        if ((char)local_70 == '\x02') goto LAB_00105fde;
joined_r0x00106094:
        if (local_70 == 0) goto LAB_0010609a;
      }
      else if ((char)local_70 == '\x02') {
LAB_00105fde:
        puVar17 = *(ushort **)(param_2 + 0x40);
        if (((6 < *(ulong *)(param_2 + 8)) && (*(byte *)((long)puVar17 + 1) < 4)) &&
           (*(ulong *)(param_2 + 8) == (ulong)*(uint *)(puVar17 + 1))) {
          puVar16 = *(ushort **)(param_2 + 0x48);
          local_6c = 0;
          uVar2 = *(undefined8 *)(param_2 + 0x38);
          if (puVar16 < (ushort *)((long)puVar17 + 0x65U)) goto LAB_001062ed;
          puVar15 = (ushort *)((long)puVar17 + (ulong)*(ushort *)((long)puVar17 + 99) + 0x75);
          if (((puVar16 < puVar15 + 9) || (*puVar15 < 0x12)) ||
             (puVar15 = (ushort *)((ulong)*(uint *)(puVar15 + 7) + (long)puVar17),
             puVar17 == puVar15)) goto LAB_001062e0;
          puVar17 = puVar15 + 1;
          if (puVar16 < puVar17) {
LAB_001062ed:
            local_6c = 2;
            ...
            *(uint *)(lVar12 + 0x50) = (uint)uVar5;
            if (puVar16 < (ushort *)((ulong)((uint)uVar5 * 4) + (long)puVar17)) goto LAB_001062ed;
            if (uVar5 == 0) {
LAB_001062e0:
              local_70 = 0;
              goto LAB_0010609a;
            ...
            *(undefined4 **)(lVar12 + 0x48) = puVar13;
            if (local_6c == 0) {
              ...
              *(undefined8 *)(param_1 + 0xa8) = uVar3;
              qsort(*(void **)(lVar12 + 0x48),(ulong)*(uint *)(lVar12 + 0x50),0x10,
                    compare_kern_pairs);
              if (local_6c == 0) goto LAB_001062e0;
            }
          }
          ...
          *(undefined4 *)(lVar12 + 0x50) = 0;
          local_70 = local_6c;
          goto joined_r0x00106094;
        }
      }
    }
    FT_Stream_ExitFrame(param_2);
  }
  else if (lVar12 == 0) goto LAB_00105f33;
  ft_mem_free(uVar6,*(undefined8 *)(lVar12 + 0x48));
  *(undefined8 *)(lVar12 + 0x48) = 0;
  *(undefined4 *)(lVar12 + 0x50) = 0;
  ft_mem_free(uVar6,*(undefined8 *)(lVar12 + 0x38));
...
LAB_00106490:
      ...
      if (lVar5 == 0) {
        ...
        iVar6 = local_ac;
        if (local_ac != 0) goto LAB_00106495;
        ...
        *(int *)(lVar5 + 4) = iVar2;
        ...
        if ((local_ac == 0) && (lVar5 = *(long *)(param_1 + 0x350), 0 < local_b4)) {
          ...
          do {
            ...
            if ((int)puVar9[1] == (int)pcVar4) goto LAB_00106490;
  ...
  if (-1 < local_290) {
    if ((local_290 == 0) || (4 < local_290)) {
      ...
      if (lVar7 == 0) {
        ...
        iVar10 = local_28c;
        if (local_28c != 0) goto LAB_00106780;
          ...
          if (0 < local_290) {
            ...
            do {
              ...
              *(long *)(puVar11 + 8) = lVar7;
              iVar10 = local_294;
              if (local_294 != 0) goto LAB_00106780;

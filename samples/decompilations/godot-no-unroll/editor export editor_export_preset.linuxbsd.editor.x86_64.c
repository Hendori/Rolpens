...
/* EditorExportPreset::get_customized_files_count() const */

undefined4 __thiscall EditorExportPreset::get_customized_files_count(EditorExportPreset *this)
...
/* EditorExportPreset::is_runnable() const */

EditorExportPreset __thiscall EditorExportPreset::is_runnable(EditorExportPreset *this)
...
/* EditorExportPreset::are_advanced_options_enabled() const */

EditorExportPreset __thiscall
EditorExportPreset::are_advanced_options_enabled(EditorExportPreset *this)
...
EditorExportPreset __thiscall EditorExportPreset::is_dedicated_server(EditorExportPreset *this)
...
/* EditorExportPreset::get_export_filter() const */

undefined4 __thiscall EditorExportPreset::get_export_filter(EditorExportPreset *this)
...
/* EditorExportPreset::get_enc_pck() const */

EditorExportPreset __thiscall EditorExportPreset::get_enc_pck(EditorExportPreset *this)
...
/* EditorExportPreset::get_enc_directory() const */

EditorExportPreset __thiscall EditorExportPreset::get_enc_directory(EditorExportPreset *this)
...
/* EditorExportPreset::get_script_export_mode() const */

undefined4 __thiscall EditorExportPreset::get_script_export_mode(EditorExportPreset *this)
...
EditorExportPreset::get_file_export_mode
          (EditorExportPreset *this,String *param_1,undefined4 param_3)
      ...
      while( true ) {
        if (uVar13 == uVar12) {
          cVar11 = String::operator==((String *)
                                      (*(long *)(*(long *)(this + 0x1e0) + lVar15 * 8) + 0x10),
                                      param_1);
          if (cVar11 != '\0') {
...
/* EditorExportPreset::has_export_file(String const&) */

undefined8 __thiscall EditorExportPreset::has_export_file(EditorExportPreset *this,String *param_1)
      ...
      do {
        if (uVar13 == uVar11) {
          uVar12 = String::operator==((String *)
                                      (*(long *)(this + 0x1b0) +
                                      (ulong)*(uint *)(*(long *)(this + 0x1b8) + lVar15 * 4) * 8),
                                      param_1);
          if ((char)uVar12 != '\0') {
            return uVar12;
          }
...
/* EditorExportPreset::get_customized_files() const */

void EditorExportPreset::get_customized_files(void)
...
/* EditorExportPreset::get_custom_features() const */

void EditorExportPreset::get_custom_features(void)
...
/* EditorExportPreset::get_script_encryption_key() const */

void EditorExportPreset::get_script_encryption_key(void)
...
/* EditorExportPreset::get_exclude_filter() const */

void EditorExportPreset::get_exclude_filter(void)
...
/* EditorExportPreset::get_name() const */

void EditorExportPreset::get_name(void)
...
/* EditorExportPreset::get_include_filter() const */

void EditorExportPreset::get_include_filter(void)
...
/* EditorExportPreset::get_export_path() const */

void EditorExportPreset::get_export_path(void)
...
/* EditorExportPreset::get_enc_in_filter() const */

void EditorExportPreset::get_enc_in_filter(void)
...
/* EditorExportPreset::get_enc_ex_filter() const */

void EditorExportPreset::get_enc_ex_filter(void)
...
/* EditorExportPreset::_get(StringName const&, Variant&) const */

undefined8 __thiscall
EditorExportPreset::_get(EditorExportPreset *this,StringName *param_1,Variant *param_2)

{
  ...
  if ((*(long *)(this + 0x288) != 0) && (*(int *)(this + 0x2ac) != 0)) {
    ...
    if (uVar40 != 0) {
      ...
      do {
        if ((uVar36 == uVar40) &&
           (lVar39 = *(long *)(*(long *)(*(long *)(this + 0x288) + lVar39 * 8) + 0x10),
           lVar39 == *(long *)param_1)) {
        ...
        iVar38 = SUB164(auVar4 * auVar20,8);
              ...
              (auVar5._8_8_ = 0, auVar5._0_8_ = (ulong)uVar40 * lVar2, auVar21._8_8_ = 0,
              auVar21._0_8_ = uVar41, auVar6._8_8_ = 0,
              auVar6._0_8_ = (ulong)((uVar1 + iVar38) - SUB164(auVar5 * auVar21,8)) * lVar2,
              auVar22._8_8_ = 0, auVar22._0_8_ = uVar41, uVar42 <= SUB164(auVar6 * auVar22,8)));
    }
  }
  if ((*(long *)(this + 600) != 0) && (*(int *)(this + 0x27c) != 0)) {
    ...
    if (uVar40 != 0) {
      ...
      do {
        if ((uVar36 == uVar40) &&
           (lVar39 = *(long *)(*(long *)(*(long *)(this + 600) + lVar39 * 8) + 0x10),
           lVar39 == *(long *)param_1)) {
          if ((*(long *)(this + 600) != 0) && (*(int *)(this + 0x27c) != 0)) {
            uVar1 = *(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x278) * 4);
            uVar41 = CONCAT44(0,uVar1);
            ...
            if (uVar40 != 0) {
              ...
              do {
                if ((uVar36 == uVar40) &&
                   (lVar37 = *(long *)(this + 600),
                   *(long *)(*(long *)(lVar37 + lVar39 * 8) + 0x10) == *(long *)param_1)) {
LAB_0010091c:
                  Variant::operator=(param_2,(Variant *)
                                             (*(long *)(lVar37 + (ulong)uVar42 * 8) + 0x18));
                  return 1;
                }
                uVar43 = uVar43 + 1;
                auVar16._8_8_ = 0;
                ...
                uVar42 = SUB164(auVar16 * auVar32,8);
                      ...
                      (auVar17._8_8_ = 0, auVar17._0_8_ = (ulong)uVar40 * lVar2, auVar33._8_8_ = 0,
                      auVar33._0_8_ = uVar41, auVar18._8_8_ = 0,
                      auVar18._0_8_ =
                           (ulong)((uVar1 + uVar42) - SUB164(auVar17 * auVar33,8)) * lVar2,
        ...
        iVar38 = SUB164(auVar12 * auVar28,8);
              ...
              (auVar13._8_8_ = 0, auVar13._0_8_ = (ulong)uVar40 * lVar2, auVar29._8_8_ = 0,
              auVar29._0_8_ = uVar41, auVar14._8_8_ = 0,
              auVar14._0_8_ = (ulong)((uVar1 + iVar38) - SUB164(auVar13 * auVar29,8)) * lVar2,
              auVar30._8_8_ = 0, auVar30._0_8_ = uVar41, uVar42 <= SUB164(auVar14 * auVar30,8)));
    }
  }
  return 0;
  while( true ) {
    ...
    if ((uVar40 == 0) ||
       (auVar9._8_8_ = 0, auVar9._0_8_ = (ulong)uVar40 * lVar2, auVar25._8_8_ = 0,
       auVar25._0_8_ = uVar41, auVar10._8_8_ = 0,
       auVar10._0_8_ = (ulong)((uVar1 + uVar42) - SUB164(auVar9 * auVar25,8)) * lVar2,
       auVar26._8_8_ = 0, auVar26._0_8_ = uVar41, SUB164(auVar10 * auVar26,8) < uVar43)) break;
LAB_00100902:
    if ((uVar36 == uVar40) &&
       (lVar37 = *(long *)(this + 0x288),
       *(long *)(*(long *)(lVar37 + lVar39 * 8) + 0x10) == *(long *)param_1)) goto LAB_0010091c;
  }
LAB_00100b28:
...
/* EditorExportPreset::get_platform() const */

void EditorExportPreset::get_platform(void)
...
/* EditorExportPreset::set_name(String const&) */

void __thiscall EditorExportPreset::set_name(EditorExportPreset *this,String *param_1)
...
/* EditorExportPreset::set_runnable(bool) */

void __thiscall EditorExportPreset::set_runnable(EditorExportPreset *this,bool param_1)
...
/* EditorExportPreset::set_advanced_options_enabled(bool) */

void __thiscall
EditorExportPreset::set_advanced_options_enabled(EditorExportPreset *this,bool param_1)
...
/* EditorExportPreset::set_dedicated_server(bool) */

void __thiscall EditorExportPreset::set_dedicated_server(EditorExportPreset *this,bool param_1)
...
/* EditorExportPreset::set_export_filter(EditorExportPreset::ExportFilter) */

void __thiscall EditorExportPreset::set_export_filter(EditorExportPreset *this,undefined4 param_2)
...
/* EditorExportPreset::set_include_filter(String const&) */

void __thiscall EditorExportPreset::set_include_filter(EditorExportPreset *this,String *param_1)
...
/* EditorExportPreset::set_exclude_filter(String const&) */

void __thiscall EditorExportPreset::set_exclude_filter(EditorExportPreset *this,String *param_1)
...
/* EditorExportPreset::get_patch(int) */

CowData<char32_t> * EditorExportPreset::get_patch(int param_1)
...
LAB_00100da9:
  _err_print_index_error
            ("get_patch","editor/export/editor_export_preset.cpp",0x199,lVar3,lVar4,"p_index",
             "patches.size()","",false,false);
  *(undefined8 *)this = 0;
  return this;
}
...
/* EditorExportPreset::set_custom_features(String const&) */

void __thiscall EditorExportPreset::set_custom_features(EditorExportPreset *this,String *param_1)
...
/* EditorExportPreset::set_enc_in_filter(String const&) */

void __thiscall EditorExportPreset::set_enc_in_filter(EditorExportPreset *this,String *param_1)
...
/* EditorExportPreset::set_enc_ex_filter(String const&) */

void __thiscall EditorExportPreset::set_enc_ex_filter(EditorExportPreset *this,String *param_1)
...
/* EditorExportPreset::set_seed(unsigned long) */

void __thiscall EditorExportPreset::set_seed(EditorExportPreset *this,ulong param_1)
...
/* EditorExportPreset::get_seed() const */

undefined8 __thiscall EditorExportPreset::get_seed(EditorExportPreset *this)
...
/* EditorExportPreset::set_enc_pck(bool) */

void __thiscall EditorExportPreset::set_enc_pck(EditorExportPreset *this,bool param_1)
...
/* EditorExportPreset::set_enc_directory(bool) */

void __thiscall EditorExportPreset::set_enc_directory(EditorExportPreset *this,bool param_1)
...
/* EditorExportPreset::set_script_encryption_key(String const&) */

void __thiscall
EditorExportPreset::set_script_encryption_key(EditorExportPreset *this,String *param_1)
...
/* EditorExportPreset::set_script_export_mode(int) */

void __thiscall EditorExportPreset::set_script_export_mode(EditorExportPreset *this,int param_1)
...
/* EditorExportPreset::get_or_env(StringName const&, String const&, bool*) const */

StringName * EditorExportPreset::get_or_env(StringName *param_1,String *param_2,bool *param_3)
...
void __thiscall EditorExportPreset::EditorExportPreset(EditorExportPreset *this)
...
/* EditorExportPreset::add_export_file(String const&) */

void EditorExportPreset::add_export_file(String *param_1)
...
/* HashMap<String, EditorExportPreset::FileExportMode, HashMapHasherDefault,
   ...
   EditorExportPreset::FileExportMode> > >::erase(String const&) [clone .isra.0] */

ulong __thiscall
HashMap<String,EditorExportPreset::FileExportMode,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorExportPreset::FileExportMode>>>
::erase(HashMap<String,EditorExportPreset::FileExportMode,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorExportPreset::FileExportMode>>>
        *this,String *param_1)
        ...
        if (uVar31 == uVar29) {
          ...
          if (cVar28 != '\0') {
            ...
            if ((uVar31 == 0) ||
               ...
               SUB164(auVar14 * auVar24,8) == 0)) goto LAB_001013eb;
            goto LAB_001013a5;
          }
          lVar36 = *(long *)(this + 0x10);
        }
...
/* EditorExportPreset::set_file_export_mode(String const&, EditorExportPreset::FileExportMode) */

void __thiscall
EditorExportPreset::set_file_export_mode(EditorExportPreset *this,String *param_1,int param_3)

{
  ...
  if (param_3 == 0) {
    ...
    HashMap<String,EditorExportPreset::FileExportMode,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorExportPreset::FileExportMode>>>
    ::insert(local_18,this + 0x1d8,SUB81(param_1,0));
  }
  EditorExport::save_presets();
  if (local_10 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
...
/* EditorExportPreset::set_customized_files(Dictionary const&) */

void __thiscall
EditorExportPreset::set_customized_files(EditorExportPreset *this,Dictionary *param_1)
...
LAB_00101590:
        HashMap<String,EditorExportPreset::FileExportMode,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorExportPreset::FileExportMode>>>
        ::insert(local_48,(HashMap<String,EditorExportPreset::FileExportMode,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorExportPreset::FileExportMode>>>
      ...
      do {
        if (uVar30 == uVar29) {
          cVar28 = String::operator==((String *)
                                      (*(long *)this +
                                      (ulong)*(uint *)(*(long *)(this + 8) + lVar34 * 4) * 8),
                                      param_1);
          if (cVar28 != '\0') {
            lVar41 = *(long *)(this + 8);
            lVar6 = *(long *)(this + 0x10);
            ...
            if ((*puVar38 == 0) ||
               ...
               auVar14._0_8_ = (ulong)((uVar30 + uVar42) - SUB164(auVar13 * auVar23,8)) * lVar34,
            ...
            *(undefined4 *)(lVar31 + uVar40 * 4) =
                 *(undefined4 *)(lVar31 + (ulong)*(uint *)(this + 0x24) * 4);
            *(uint *)(*(long *)(this + 8) +
                     (ulong)*(uint *)(lVar31 + (ulong)*(uint *)(this + 0x24) * 4) * 4) = uVar4;
            return;
          }
          lVar41 = *(long *)(this + 0x18);
        }
        ...
        iVar33 = SUB164(auVar9 * auVar19,8);
              ...
              auVar21._8_8_ = 0, auVar21._0_8_ = uVar36, uVar42 <= SUB164(auVar11 * auVar21,8)));
    }
  }
  return;
}
...
/* EditorExportPreset::remove_export_file(String const&) */

void __thiscall EditorExportPreset::remove_export_file(EditorExportPreset *this,String *param_1)

{
  HashSet<String,HashMapHasherDefault,HashMapComparatorDefault<String>>::erase
            ((HashSet<String,HashMapHasherDefault,HashMapComparatorDefault<String>> *)(this + 0x1b0)
             ,param_1);
  EditorExport::save_presets();
  return;
}
...
/* EditorExportPreset::set_export_path(String const&) */

void __thiscall EditorExportPreset::set_export_path(EditorExportPreset *this,String *param_1)
...
void EditorExportPreset::_bind_methods(void)

{
  ...
  pMVar3 = create_method_bind<EditorExportPreset,EditorExportPreset::FileExportMode,String_const&,EditorExportPreset::FileExportMode>
  ...
  auStack_70 = (undefined1  [16])0x0;
  local_78 = (Variant **)0x0;
  pMVar3 = create_method_bind<EditorExportPreset,EditorExportPreset::ExportFilter>
                     (get_export_filter);
  ClassDB::bind_methodfi(1,pMVar3,false,(MethodDefinition *)&local_118,(Variant **)0x0,0);
  if (Variant::needs_deinit[(int)local_78] != '\0') {
    Variant::_clear_internal();
  ...
  auStack_70 = (undefined1  [16])0x0;
  local_78 = (Variant **)0x0;
  pMVar3 = create_method_bind<EditorExportPreset,Variant,StringName_const&,String_const&>
                     (_get_or_env);
  ClassDB::bind_methodfi(1,pMVar3,false,(MethodDefinition *)&local_118,(Variant **)0x0,0);
  if (Variant::needs_deinit[(int)local_78] != '\0') {
    Variant::_clear_internal();
  ...
  GetTypeInfo<EditorExportPreset::ExportFilter,void>::get_class_info
            ((GetTypeInfo<EditorExportPreset::ExportFilter,void> *)&local_118);
  ...
  ClassDB::bind_integer_constant
            ((StringName *)&local_118,(StringName *)&local_120,(StringName *)&local_150,3,false);
  if ((StringName::configured != '\0') && (local_118 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_128);
  ...
  GetTypeInfo<EditorExportPreset::FileExportMode,void>::get_class_info
            ((GetTypeInfo<EditorExportPreset::FileExportMode,void> *)&local_118);
  local_128 = local_110._8_8_;
  local_110._8_8_ = 0;
  PropertyInfo::~PropertyInfo((PropertyInfo *)&local_118);
  local_118 = "EditorExportPreset";
  ...
  StringName::StringName((StringName *)&local_118,(String *)&local_128,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_118,(StringName *)&local_120,(StringName *)&local_148,0,false);
  if ((StringName::configured != '\0') && (local_118 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_128);
  ...
  StringName::StringName((StringName *)&local_118,(String *)&local_128,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_118,(StringName *)&local_120,(StringName *)&local_148,1,false);
  if ((StringName::configured != '\0') && (local_118 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_128);
  ...
  StringName::StringName((StringName *)&local_118,(String *)&local_128,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_118,(StringName *)&local_120,(StringName *)&local_148,2,false);
  if ((StringName::configured != '\0') && (local_118 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_128);
...
/* EditorExportPreset::get_version(StringName const&, bool) const */

StringName * EditorExportPreset::get_version(StringName *param_1,bool param_2)
...
LAB_00103db0:
    if ((*(long *)param_1 != 0) && (1 < *(uint *)(*(long *)param_1 + -8))) {
      ...
      String::parse_latin1
                ((String *)&local_80,
                 "Invalid version number \"%s\". The version number can only contain numeric characters (0-9) and non-consecutive periods (.)."
                );
      vformat<String>((StringName *)&local_70,(String *)&local_80,(CowData<char32_t> *)&local_78);
      _err_print_error("get_version","editor/export/editor_export_preset.cpp",0x228,
                       (StringName *)&local_70,0,1);
                  ...
                  if (local_60 == (CowData *)0x0) {
                    ...
                    if (0 < lVar8) {
                      ...
                      vformat<String,String,String,String>
                                ((StringName *)&local_70,(String *)&local_98,
                                 (CowData<char32_t> *)&local_90,(CowData<char32_t> *)&local_88,
                                 (CowData<char32_t> *)&local_80,(CowData<char32_t> *)&local_78);
                      lVar1 = local_70;
...
LAB_00103eab:
          _err_print_index_error
                    ("get","./core/templates/cowdata.h",0xdb,lVar4,lVar8,"p_index","size()","",false
                     ,true);
          _err_flush_stdout();
                    /* WARNING: Does not return */
...
/* EditorExportPreset::get_patches() const */

void EditorExportPreset::get_patches(void)
...
/* EditorExportPreset::set_patches(Vector<String> const&) */

void __thiscall EditorExportPreset::set_patches(EditorExportPreset *this,Vector *param_1)
...
/* EditorExportPreset::remove_patch(int) */

void __thiscall EditorExportPreset::remove_patch(EditorExportPreset *this,int param_1)
...
LAB_001044a9:
  _err_print_index_error
            ("remove_patch","editor/export/editor_export_preset.cpp",0x19e,lVar4,lVar5,"p_index",
             "patches.size()","",false,false);
  return;
}
...
/* EditorExportPreset::add_patch(String const&, int) */

void __thiscall EditorExportPreset::add_patch(EditorExportPreset *this,String *param_1,int param_2)

{
  ...
  if ((lVar7 != 0) && (lVar8 = *(long *)(lVar7 + -8), lVar8 != 0)) {
    ...
    while (lVar5 < lVar8) {
      ...
      if (cVar2 != '\0') {
        ...
        _err_print_error("add_patch","editor/export/editor_export_preset.cpp",0x188,
                         "Condition \"patches.has(p_path)\" is true.",(CowData<char32_t> *)&local_48
                         ,1,0);
  ...
  if (param_2 < 0) {
    ...
    if (lVar9 < lVar7) {
      ...
      _err_print_index_error
                ("insert","./core/templates/cowdata.h",0xf0,lVar9,lVar7,"p_pos","new_size","",false,
                 false);
    }
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
  }
...
/* EditorExportPreset::set_patch(int, String const&) */

void __thiscall EditorExportPreset::set_patch(EditorExportPreset *this,int param_1,String *param_2)
...
/* EditorExportPreset::get_files_to_export() const */

void EditorExportPreset::get_files_to_export(void)
...
void __thiscall EditorExportPreset::update_files(EditorExportPreset *this)
  ...
  if (plVar7 != (long *)0x0) {
    do {
      while( true ) {
        ...
        if ((cVar5 == '\0') && (cVar5 = DirAccess::exists((String *)(plVar7 + 2)), cVar5 == '\0'))
        break;
LAB_00104bb0:
        plVar7 = (long *)*plVar7;
...
void __thiscall EditorExportPreset::update_value_overrides(EditorExportPreset *this)
...
LAB_00105620:
    uVar29 = (ulong)*(uint *)(hash_table_size_primes + (ulong)uVar19 * 4);
...
LAB_00105683:
    if (puVar24 != (undefined8 *)0x0) {
      for (puVar28 = (undefined8 *)local_90._0_8_; puVar28 != (undefined8 *)0x0;
          puVar28 = (undefined8 *)*puVar28) {
        HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
        ::insert((StringName *)&local_b8,(Variant *)(this + 0x280),(bool)((char)puVar28 + '\x10'));
      }
      Object::notify_property_list_changed();
...
LAB_001057a6:
            _err_print_index_error
                      ("operator[]","./core/templates/vector.h",0x38,local_130,lVar23,"p_index",
          ...
          CowData<Ref<EditorExportPlugin>>::_copy_on_write
                    ((CowData<Ref<EditorExportPlugin>> *)&local_c0);
          ...
          if (((local_b8 != (EditorExportPreset *)0x0) &&
              (cVar16 = RefCounted::unreference(), pEVar14 = local_b8, cVar16 != '\0')) &&
             (cVar16 = predelete_handler((Object *)local_b8), cVar16 != '\0')) {
            (**(code **)(*(long *)pEVar14 + 0x140))(pEVar14);
...
LAB_001054cf:
            _err_print_index_error
                      ("get","./core/templates/cowdata.h",0xdb,local_130,lVar23,"p_index","size()",
                       "",false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
            pcVar13 = (code *)invalidInstructionException();
          ...
          (**(code **)(*(long *)local_c0[local_130] + 0x1b0))
                    (local_f8,(long *)local_c0[local_130],this + 0x180);
          ...
          if (cVar16 == '\0') {
            ...
            for (iVar2 = 0; iVar17 = Array::size(), iVar2 < iVar17; iVar2 = iVar2 + 1) {
              ...
              if ((local_a0._0_8_ != 0) && (local_80._4_4_ != 0)) {
                ...
                if (uVar26 != 0) {
                  while ((uVar26 != uVar18 ||
                         (*(long *)(*(long *)(uVar15 + lVar22 * 8) + 0x10) != local_e8))) {
                    uVar27 = uVar27 + 1;
                    auVar6._8_8_ = 0;
                    ...
                    if ((uVar26 == 0) ||
                       (auVar7._8_8_ = 0, auVar7._0_8_ = (ulong)uVar26 * lVar23, auVar11._8_8_ = 0,
                       auVar11._0_8_ = uVar29, auVar8._8_8_ = 0,
                       auVar8._0_8_ = (ulong)((uVar19 + iVar17) - SUB164(auVar7 * auVar11,8)) *
                                      lVar23, auVar12._8_8_ = 0, auVar12._0_8_ = uVar29,
                       SUB164(auVar8 * auVar12,8) < uVar27)) goto LAB_001052d5;
                  }
                  pVVar20 = (Variant *)
                            HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
                            ::operator[](local_a8,(StringName *)&local_e8);
                  ...
                  if (cVar16 != '\0') {
                    ...
                    vformat<String,StringName>
                              ((CowData<char32_t> *)&local_b8,(StrRange *)&local_d8,local_e0,
                               (StringName *)local_d0);
                    _err_print_error("update_value_overrides",
                                     "editor/export/editor_export_preset.cpp",0xd8,
...
LAB_001052d5:
  ...
  Object::notify_property_list_changed();
LAB_0010576d:
  CowData<Ref<EditorExportPlugin>>::_unref((CowData<Ref<EditorExportPlugin>> *)&local_c0);
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
                    /* WARNING: Subroutine does not return */
...
/* EditorExportPreset::_set(StringName const&, Variant const&) */

undefined8 __thiscall
EditorExportPreset::_set(EditorExportPreset *this,StringName *param_1,Variant *param_2)

{
  ...
  if ((*(long *)(this + 0x2b8) != 0) && (*(int *)(this + 0x2dc) != 0)) {
    ...
    if (uVar15 != 0) {
      ...
      do {
        if ((uVar11 == uVar15) &&
           (*(long *)(*(long *)(*(long *)(this + 0x2b8) + lVar14 * 8) + 0x10) == *(long *)param_1))
        {
...
/* EditorExportPreset::_get_property_list(List<PropertyInfo, DefaultAllocator>*) const */

void __thiscall EditorExportPreset::_get_property_list(EditorExportPreset *this,List *param_1)

{
  ...
  if (puVar25 != (undefined8 *)0x0) {
    do {
      ...
      if ((*(long *)(this + 0x288) != 0) && (*(int *)(this + 0x2ac) != 0)) {
        uVar1 = *(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x2a8) * 4);
        lVar24 = *(long *)(hash_table_size_primes_inv + (ulong)*(uint *)(this + 0x2a8) * 8);
        if (lVar20 == 0) {
        ...
        uVar26 = 0;
        auVar6._8_8_ = 0;
        auVar6._0_8_ = (ulong)uVar15 * lVar24;
        auVar10._8_8_ = 0;
        auVar10._0_8_ = uVar23;
        lVar20 = SUB168(auVar6 * auVar10,8);
        uVar21 = *(uint *)(*(long *)(this + 0x290) + lVar20 * 4);
        iVar19 = SUB164(auVar6 * auVar10,8);
        if (uVar21 != 0) {
          do {
            if ((uVar21 == uVar15) &&
               (*(long *)(*(long *)(*(long *)(this + 0x288) + lVar20 * 8) + 0x10) == puVar25[2])) {
              puVar25 = (undefined8 *)*puVar25;
              goto joined_r0x00105b81;
            }
            uVar26 = uVar26 + 1;
            auVar7._8_8_ = 0;
            auVar7._0_8_ = (ulong)(iVar19 + 1) * lVar24;
            auVar11._8_8_ = 0;
            ...
            iVar19 = SUB164(auVar7 * auVar11,8);
                  ...
                  (auVar8._8_8_ = 0, auVar8._0_8_ = (ulong)uVar21 * lVar24, auVar12._8_8_ = 0,
                  auVar12._0_8_ = uVar23, auVar9._8_8_ = 0,
                  auVar9._0_8_ = (ulong)((uVar1 + iVar19) - SUB164(auVar8 * auVar12,8)) * lVar24,
                  auVar13._8_8_ = 0, auVar13._0_8_ = uVar23, uVar26 <= SUB164(auVar9 * auVar13,8)));
        }
        lVar20 = puVar25[2];
      }
      plVar2 = *(long **)(this + 0x180);
      pcVar3 = *(code **)(*plVar2 + 0x1c8);
      if (lVar20 == 0) {
LAB_00105ef1:
        local_78 = 0;
        if (pcVar3 != EditorExportPlatform::get_export_option_visibility) goto LAB_00105f09;
LAB_00105c6a:
        EditorExport::get_export_plugins();
        for (lVar20 = 0; (local_70 != 0 && (lVar20 < *(long *)(local_70 + -8))); lVar20 = lVar20 + 1
            ) {
          plVar2 = *(long **)(local_70 + lVar20 * 8);
          cVar14 = (**(code **)(*plVar2 + 0x1d8))(plVar2,this + 0x180);
          if (cVar14 != '\0') {
            if (local_70 == 0) {
              lVar24 = 0;
LAB_001061a1:
              _err_print_index_error
                        ("operator[]","./core/templates/vector.h",0x38,lVar20,lVar24,"p_index",
                         "((Vector<T> *)(this))->_cowdata.size()","",false,true);
              _err_flush_stdout();
                    /* WARNING: Does not return */
              pcVar3 = (code *)invalidInstructionException();
            ...
            lVar24 = *(long *)(local_70 + -8);
            if (lVar24 <= lVar20) goto LAB_001061a1;
            CowData<Ref<EditorExportPlugin>>::_copy_on_write
                      ((CowData<Ref<EditorExportPlugin>> *)&local_70);
            pRVar5 = *(Ref **)(local_70 + lVar20 * 8);
...
joined_r0x0010616c:
                ...
                if (pOVar4 != pOVar16) {
                  local_68 = pOVar16;
                  if ((pOVar16 != (Object *)0x0) &&
                     (cVar14 = RefCounted::reference(), cVar14 == '\0')) {
                    local_68 = (Object *)0x0;
                  }
                  if (pOVar4 != (Object *)0x0) {
                    cVar14 = RefCounted::unreference();
                    goto joined_r0x0010616c;
                  }
                }
              }
            }
            ...
            if (((local_68 != (Object *)0x0) &&
                (cVar14 = RefCounted::unreference(), pOVar4 = local_68, cVar14 != '\0')) &&
               (cVar14 = predelete_handler(local_68), cVar14 != '\0')) {
              (**(code **)(*(long *)pOVar4 + 0x140))(pOVar4);
              Memory::free_static(pOVar4,false);
            }
            if (Variant::needs_deinit[local_58[0]] != '\0') {
...
LAB_001061fb:
              _err_print_index_error
                        ("get","./core/templates/cowdata.h",0xdb,lVar20,lVar24,"p_index","size()",""
                         ,false,true);
              _err_flush_stdout();
                    /* WARNING: Does not return */
              pcVar3 = (code *)invalidInstructionException();
            ...
            lVar24 = *(long *)(local_70 + -8);
            if (lVar24 <= lVar20) goto LAB_001061fb;
            plVar2 = *(long **)(local_70 + lVar20 * 8);
            pcVar3 = *(code **)(*plVar2 + 0x1c0);
            lVar24 = puVar25[2];
            if (lVar24 == 0) {
              local_80 = 0;
            }
            else {
              pOVar4 = *(Object **)(lVar24 + 8);
              local_80 = 0;
              if (pOVar4 == (Object *)0x0) {
                if (*(long *)(lVar24 + 0x10) != 0) {
                  CowData<char32_t>::_ref((CowData<char32_t> *)&local_80,(CowData *)(lVar24 + 0x10))
                  ;
                }
              }
              else {
            ...
            cVar14 = (*pcVar3)(plVar2,this + 0x180,&local_80);
            lVar24 = local_80;
            if (local_80 != 0) {
              LOCK();
        ...
        *puVar17 = *(undefined4 *)(puVar25 + 3);
        if (lVar20 != 0) {
          CowData<char32_t>::_ref((CowData<char32_t> *)(puVar17 + 2),(CowData *)(puVar25 + 4));
        }
        StringName::operator=((StringName *)(puVar17 + 4),(StringName *)(puVar25 + 5));
        puVar17[6] = *(undefined4 *)(puVar25 + 6);
        if (*(long *)(puVar17 + 8) != puVar25[7]) {
          CowData<char32_t>::_ref((CowData<char32_t> *)(puVar17 + 8),(CowData *)(puVar25 + 7));
        }
        puVar17[10] = *(undefined4 *)(puVar25 + 8);
        plVar2 = *(long **)param_1;
        lVar20 = plVar2[1];
        *(undefined8 *)(puVar17 + 0xc) = 0;
        *(long **)(puVar17 + 0x10) = plVar2;
        *(long *)(puVar17 + 0xe) = lVar20;
        if (lVar20 != 0) {
          *(undefined4 **)(lVar20 + 0x30) = puVar17;
        }
        plVar2[1] = (long)puVar17;
        if (*plVar2 == 0) {
          *plVar2 = (long)puVar17;
        }
...
LAB_00105f09:
        cVar14 = (*pcVar3)(plVar2,this,&local_78);
        if (local_78 != 0) {
          LOCK();
          plVar2 = (long *)(local_78 + -0x10);
          *plVar2 = *plVar2 + -1;
...
/* EditorExportPreset::_get_property_warning(StringName const&) const */

StringName * EditorExportPreset::_get_property_warning(StringName *param_1)

{
  ...
  if ((*(long *)(in_RSI + 0x288) != 0) && (*(int *)(in_RSI + 0x2ac) != 0)) {
    ...
    if (uVar19 != 0) {
      ...
      do {
        if ((uVar19 == uVar15) &&
           (*(long *)(*(long *)(*(long *)(in_RSI + 0x288) + lVar18 * 8) + 0x10) == *in_RDX)) {
        ...
        iVar17 = SUB164(auVar7 * auVar11,8);
              ...
              (auVar8._8_8_ = 0, auVar8._0_8_ = (ulong)uVar19 * lVar22, auVar12._8_8_ = 0,
              auVar12._0_8_ = uVar20, auVar9._8_8_ = 0,
              auVar9._0_8_ = (ulong)((uVar1 + iVar17) - SUB164(auVar8 * auVar12,8)) * lVar22,
              auVar13._8_8_ = 0, auVar13._0_8_ = uVar20, uVar21 <= SUB164(auVar9 * auVar13,8)));
    }
  }
...
LAB_00106833:
        _err_print_index_error
                  ("operator[]","./core/templates/vector.h",0x38,lVar22,lVar18,"p_index",
                   "((Vector<T> *)(this))->_cowdata.size()","",false,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar2 = (code *)invalidInstructionException();
...
joined_r0x001067fc:
          ...
          if (pOVar3 != pOVar16) {
            local_68 = pOVar16;
            if ((pOVar16 != (Object *)0x0) && (cVar14 = RefCounted::reference(), cVar14 == '\0')) {
              local_68 = (Object *)0x0;
            }
      ...
      EditorExportPlugin::set_export_preset(pRVar5);
      if (((local_68 != (Object *)0x0) &&
          (cVar14 = RefCounted::unreference(), pOVar3 = local_68, cVar14 != '\0')) &&
         (cVar14 = predelete_handler(local_68), cVar14 != '\0')) {
...
LAB_001068a3:
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,lVar22,lVar18,"p_index","size()","",false
                   ,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar2 = (code *)invalidInstructionException();
...
{
  return (uint)CONCAT71(0x115e,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr) |
...
/* EditorExportPreset::is_class_ptr(void*) const */

uint __thiscall EditorExportPreset::is_class_ptr(EditorExportPreset *this,void *param_1)

{
  return (uint)CONCAT71(0x115e,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x115d,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x115e,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}



/* EditorExportPreset::_validate_propertyv(PropertyInfo&) const */

void EditorExportPreset::_validate_propertyv(PropertyInfo *param_1)
...
/* EditorExportPreset::_property_can_revertv(StringName const&) const */

undefined8 EditorExportPreset::_property_can_revertv(StringName *param_1)
...
/* EditorExportPreset::_property_get_revertv(StringName const&, Variant&) const */

undefined8 EditorExportPreset::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* EditorExportPreset::_notificationv(int, bool) */

void EditorExportPreset::_notificationv(int param_1,bool param_2)
...
/* MethodBindTRC<String, StringName const&, bool>::_gen_argument_type(int) const */

char __thiscall
MethodBindTRC<String,StringName_const&,bool>::_gen_argument_type
          (MethodBindTRC<String,StringName_const&,bool> *this,int param_1)
...
/* MethodBindTRC<String, StringName const&, bool>::get_argument_meta(int) const */

undefined8 MethodBindTRC<String,StringName_const&,bool>::get_argument_meta(int param_1)
...
/* MethodBindTRC<Variant, StringName const&, String const&>::_gen_argument_type(int) const */

char __thiscall
MethodBindTRC<Variant,StringName_const&,String_const&>::_gen_argument_type
          (MethodBindTRC<Variant,StringName_const&,String_const&> *this,int param_1)
...
/* MethodBindTRC<Variant, StringName const&, String const&>::get_argument_meta(int) const */

undefined8 MethodBindTRC<Variant,StringName_const&,String_const&>::get_argument_meta(int param_1)
...
/* MethodBindTRC<EditorExportPreset::ExportFilter>::_gen_argument_type(int) const */

undefined8 MethodBindTRC<EditorExportPreset::ExportFilter>::_gen_argument_type(int param_1)
...
/* MethodBindTRC<EditorExportPreset::ExportFilter>::get_argument_meta(int) const */

undefined8 MethodBindTRC<EditorExportPreset::ExportFilter>::get_argument_meta(int param_1)
...
/* MethodBindTRC<EditorExportPreset::FileExportMode, String const&,
   EditorExportPreset::FileExportMode>::_gen_argument_type(int) const */

char __thiscall
MethodBindTRC<EditorExportPreset::FileExportMode,String_const&,EditorExportPreset::FileExportMode>::
_gen_argument_type(MethodBindTRC<EditorExportPreset::FileExportMode,String_const&,EditorExportPreset::FileExportMode>
                   *this,int param_1)
...
/* MethodBindTRC<EditorExportPreset::FileExportMode, String const&,
   EditorExportPreset::FileExportMode>::get_argument_meta(int) const */
...
/* MethodBindTR<bool, String const&>::_gen_argument_type(int) const */

char __thiscall
MethodBindTR<bool,String_const&>::_gen_argument_type
          (MethodBindTR<bool,String_const&> *this,int param_1)
...
/* MethodBindTR<bool, String const&>::get_argument_meta(int) const */

undefined8 MethodBindTR<bool,String_const&>::get_argument_meta(int param_1)
...
/* MethodBindTRC<String, StringName const&>::_gen_argument_type(int) const */

char __thiscall
MethodBindTRC<String,StringName_const&>::_gen_argument_type
          (MethodBindTRC<String,StringName_const&> *this,int param_1)
...
/* MethodBindTRC<String, StringName const&>::get_argument_meta(int) const */

undefined8 MethodBindTRC<String,StringName_const&>::get_argument_meta(int param_1)
...
/* MethodBindTRC<String, StringName const&>::~MethodBindTRC() */

void __thiscall
MethodBindTRC<String,StringName_const&>::~MethodBindTRC
          (MethodBindTRC<String,StringName_const&> *this)
...
/* MethodBindTR<bool, String const&>::~MethodBindTR() */

void __thiscall
MethodBindTR<bool,String_const&>::~MethodBindTR(MethodBindTR<bool,String_const&> *this)
...
/* MethodBindTRC<EditorExportPreset::FileExportMode, String const&,
   EditorExportPreset::FileExportMode>::~MethodBindTRC() */

void __thiscall
MethodBindTRC<EditorExportPreset::FileExportMode,String_const&,EditorExportPreset::FileExportMode>::
~MethodBindTRC(MethodBindTRC<EditorExportPreset::FileExportMode,String_const&,EditorExportPreset::FileExportMode>
               *this)
...
/* MethodBindTRC<EditorExportPreset::ExportFilter>::~MethodBindTRC() */

void __thiscall
MethodBindTRC<EditorExportPreset::ExportFilter>::~MethodBindTRC
          (MethodBindTRC<EditorExportPreset::ExportFilter> *this)
...
/* MethodBindTRC<Variant, StringName const&, String const&>::~MethodBindTRC() */

void __thiscall
MethodBindTRC<Variant,StringName_const&,String_const&>::~MethodBindTRC
          (MethodBindTRC<Variant,StringName_const&,String_const&> *this)
...
/* MethodBindTRC<String, StringName const&, bool>::~MethodBindTRC() */

void __thiscall
MethodBindTRC<String,StringName_const&,bool>::~MethodBindTRC
          (MethodBindTRC<String,StringName_const&,bool> *this)
...
/* EditorExportPreset::_get_class_namev() const */

undefined8 * EditorExportPreset::_get_class_namev(void)
...
LAB_001071a3:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      goto LAB_001071a3;
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"EditorExportPreset");
      goto LAB_0010720e;
    }
  }
  StringName::assign_static_unique_class_name
...
/* EditorExportPreset::has(StringName const&) const */

undefined8 __thiscall EditorExportPreset::has(EditorExportPreset *this,StringName *param_1)

{
  ...
  if (*(int *)(this + 0x27c) != 0) {
    ...
    if (uVar14 != 0) {
      ...
      do {
        if ((uVar11 == uVar14) &&
           (*(long *)(*(long *)(*(long *)(this + 600) + lVar13 * 8) + 0x10) == *(long *)param_1)) {
          return 1;
        }
        uVar16 = uVar16 + 1;
        auVar4._8_8_ = 0;
...
/* EditorExportPreset::get_class() const */

void EditorExportPreset::get_class(void)
...
/* EditorExportPreset::is_class(String const&) const */

undefined8 __thiscall EditorExportPreset::is_class(EditorExportPreset *this,String *param_1)
...
/* EditorExportPreset::_getv(StringName const&, Variant&) const */

void __thiscall
EditorExportPreset::_getv(EditorExportPreset *this,StringName *param_1,Variant *param_2)
...
/* EditorExportPreset::_get_or_env(StringName const&, String const&) const */
...
LAB_00108ef3:
    if ((float)uVar40 * __LC16 < (float)(iVar46 + 1)) goto LAB_00108f19;
  }
...
/* WARNING: Removing unreachable block (ram,0x0010a295) */
/* WARNING: Removing unreachable block (ram,0x0010a2a1) */
...
/* WARNING: Removing unreachable block (ram,0x0010a448) */
/* WARNING: Removing unreachable block (ram,0x0010a5dd) */
/* WARNING: Removing unreachable block (ram,0x0010a5e9) */
...
String * HashMap<String,EditorExportPreset::FileExportMode,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorExportPreset::FileExportMode>>>
...
LAB_0010a697:
    if ((float)uVar37 * __LC16 < (float)(iVar33 + 1)) goto LAB_0010a6bd;
  }
  local_58 = 0;
  if (*(long *)pSVar34 == 0) {
    uVar46 = *in_RCX;
...
/* MethodBind* create_method_bind<EditorExportPreset, String, StringName const&>(String
   (EditorExportPreset::*)(StringName const&) const) */

MethodBind *
create_method_bind<EditorExportPreset,String,StringName_const&>
          (_func_String_StringName_ptr *param_1)
...
MethodBind *
create_method_bind<EditorExportPreset,bool,StringName_const&>(_func_bool_StringName_ptr *param_1)
...
/* MethodBind* create_method_bind<EditorExportPreset, Vector<String>>(Vector<String>
   (EditorExportPreset::*)() const) */

MethodBind * create_method_bind<EditorExportPreset,Vector<String>>(_func_Vector *param_1)
...
MethodBind * create_method_bind<EditorExportPreset,Dictionary>(_func_Dictionary *param_1)
...
/* MethodBind* create_method_bind<EditorExportPreset, int>(int (EditorExportPreset::*)() const) */

MethodBind * create_method_bind<EditorExportPreset,int>(_func_int *param_1)
...
/* MethodBind* create_method_bind<EditorExportPreset, bool, String const&>(bool
   (EditorExportPreset::*)(String const&)) */

MethodBind *
create_method_bind<EditorExportPreset,bool,String_const&>(_func_bool_String_ptr *param_1)
...
/* MethodBind* create_method_bind<EditorExportPreset, EditorExportPreset::FileExportMode, String
   ...
   (EditorExportPreset::*)(String const&, EditorExportPreset::FileExportMode) const) */

MethodBind *
create_method_bind<EditorExportPreset,EditorExportPreset::FileExportMode,String_const&,EditorExportPreset::FileExportMode>
          (_func_FileExportMode_String_ptr_FileExportMode *param_1)
...
MethodBind * create_method_bind<EditorExportPreset,String>(_func_String *param_1)
...
/* MethodBind* create_method_bind<EditorExportPreset, bool>(bool (EditorExportPreset::*)() const) */

MethodBind * create_method_bind<EditorExportPreset,bool>(_func_bool *param_1)
...
MethodBind *
create_method_bind<EditorExportPreset,EditorExportPreset::ExportFilter>(_func_ExportFilter *param_1)
...
/* MethodBind* create_method_bind<EditorExportPreset, Variant, StringName const&, String
   const&>(Variant (EditorExportPreset::*)(StringName const&, String const&) const) */

MethodBind *
create_method_bind<EditorExportPreset,Variant,StringName_const&,String_const&>
          (_func_Variant_StringName_ptr_String_ptr *param_1)
...
/* MethodBind* create_method_bind<EditorExportPreset, String, StringName const&, bool>(String
   (EditorExportPreset::*)(StringName const&, bool) const) */

MethodBind *
create_method_bind<EditorExportPreset,String,StringName_const&,bool>
          (_func_String_StringName_ptr_bool *param_1)
...
GetTypeInfo<EditorExportPreset::FileExportMode,void> * __thiscall
GetTypeInfo<EditorExportPreset::FileExportMode,void>::get_class_info
...
GetTypeInfo<EditorExportPreset::ExportFilter,void> * __thiscall
GetTypeInfo<EditorExportPreset::ExportFilter,void>::get_class_info
...
/* MethodBindTRC<EditorExportPreset::ExportFilter>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTRC<EditorExportPreset::ExportFilter>::_gen_argument_type_info(int param_1)
...
/* EditorExportPreset::_initialize_classv() */

void EditorExportPreset::_initialize_classv(void)
...
LAB_0010cdaf:
  CowData<String>::_unref((CowData<String> *)(this + 0x218));
...
LAB_0010da77:
    ...
    iVar32 = 0;
LAB_0010da55:
    if ((float)uVar36 * __LC16 < (float)(iVar32 + 1)) goto LAB_0010da77;
  }
...
LAB_0010df59:
    if ((float)uVar23 * __LC16 < (float)(iVar28 + 1)) goto LAB_0010df7b;
  }
...
/* EditorExportPreset::_setv(StringName const&, Variant const&) */

void __thiscall
EditorExportPreset::_setv(EditorExportPreset *this,StringName *param_1,Variant *param_2)
...
/* EditorExportPreset::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall
EditorExportPreset::_get_property_listv(EditorExportPreset *this,List *param_1,bool param_2)
...
/* WARNING: Removing unreachable block (ram,0x0010e8d8) */
/* WARNING: Removing unreachable block (ram,0x0010ea6d) */
/* WARNING: Removing unreachable block (ram,0x0010ea79) */
...
void __thiscall
MethodBindTRC<String,StringName_const&,bool>::validated_call
          (MethodBindTRC<String,StringName_const&,bool> *this,Object *param_1,Variant **param_2,
          Variant *param_3)
...
/* MethodBindTRC<String, StringName const&, bool>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTRC<String,StringName_const&,bool>::ptrcall
          (MethodBindTRC<String,StringName_const&,bool> *this,Object *param_1,void **param_2,
          void *param_3)
...
void __thiscall
MethodBindTRC<Variant,StringName_const&,String_const&>::validated_call
          (MethodBindTRC<Variant,StringName_const&,String_const&> *this,Object *param_1,
...
void __thiscall
MethodBindTRC<Variant,StringName_const&,String_const&>::ptrcall
          (MethodBindTRC<Variant,StringName_const&,String_const&> *this,Object *param_1,
...
Object * MethodBindTRC<EditorExportPreset::ExportFilter>::call
  ...
  *(undefined1 (*) [16])(param_1 + 8) = (undefined1  [16])0x0;
  if (((plVar5 != (long *)0x0) && (plVar5[1] != 0)) && (*(char *)(plVar5[1] + 0x2e) != '\0')) {
    ...
    if (local_58 == (char *)*plVar4) {
      ...
      String::parse_latin1((StrRange *)&local_60);
      vformat<StringName>((StringName *)&local_58,(StrRange *)&local_60,&local_68);
      _err_print_error(&_LC119,"./core/object/method_bind.h",0x267,
...
void __thiscall
MethodBindTRC<EditorExportPreset::ExportFilter>::validated_call
          (MethodBindTRC<EditorExportPreset::ExportFilter> *this,Object *param_1,Variant **param_2,
          Variant *param_3)
...
/* MethodBindTRC<EditorExportPreset::ExportFilter>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTRC<EditorExportPreset::ExportFilter>::ptrcall
          (MethodBindTRC<EditorExportPreset::ExportFilter> *this,Object *param_1,void **param_2,
          void *param_3)
...
/* MethodBindTRC<EditorExportPreset::FileExportMode, String const&,
   EditorExportPreset::FileExportMode>::validated_call(Object*, Variant const**, Variant*) const */

void __thiscall
MethodBindTRC<EditorExportPreset::FileExportMode,String_const&,EditorExportPreset::FileExportMode>::
validated_call(MethodBindTRC<EditorExportPreset::FileExportMode,String_const&,EditorExportPreset::FileExportMode>
...
/* MethodBindTRC<EditorExportPreset::FileExportMode, String const&,
   EditorExportPreset::FileExportMode>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTRC<EditorExportPreset::FileExportMode,String_const&,EditorExportPreset::FileExportMode>::
ptrcall(MethodBindTRC<EditorExportPreset::FileExportMode,String_const&,EditorExportPreset::FileExportMode>
...
/* MethodBindTR<bool, String const&>::validated_call(Object*, Variant const**, Variant*) const */

void __thiscall
MethodBindTR<bool,String_const&>::validated_call
          (MethodBindTR<bool,String_const&> *this,Object *param_1,Variant **param_2,Variant *param_3
          )
...
/* MethodBindTR<bool, String const&>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTR<bool,String_const&>::ptrcall
          (MethodBindTR<bool,String_const&> *this,Object *param_1,void **param_2,void *param_3)
...
void __thiscall
MethodBindTRC<String,StringName_const&>::validated_call
          (MethodBindTRC<String,StringName_const&> *this,Object *param_1,Variant **param_2,
          Variant *param_3)
...
/* MethodBindTRC<String, StringName const&>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTRC<String,StringName_const&>::ptrcall
          (MethodBindTRC<String,StringName_const&> *this,Object *param_1,void **param_2,
          void *param_3)
...
Object * MethodBindTRC<String,StringName_const&>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
Object * MethodBindTRC<String,StringName_const&,bool>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
Object * MethodBindTR<bool,String_const&>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
  ...
  *(undefined1 (*) [16])(param_1 + 8) = (undefined1  [16])0x0;
  if (((plVar10 != (long *)0x0) && (plVar10[1] != 0)) && (*(char *)(plVar10[1] + 0x2e) != '\0')) {
    ...
    if (local_68 == (char *)*plVar8) {
      ...
      String::parse_latin1((StrRange *)&local_70);
      vformat<StringName>((StringName *)&local_68,(StrRange *)&local_70,&local_78);
      _err_print_error(&_LC119,"./core/object/method_bind.h",0x207,
                       "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret"
                       ,(StringName *)&local_68,0,0);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_68);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_70);
...
Object * MethodBindTRC<Variant,StringName_const&,String_const&>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
LAB_00113a70:
    ...
    *in_R9 = 0;
    ...
    Variant::operator_cast_to_StringName((Variant *)&local_68);
    (*(code *)pVVar13)(local_58,(Variant *)((long)plVar10 + (long)pVVar1),(Variant *)&local_68,
                       (Variant *)&local_70);
    if (Variant::needs_deinit[*(int *)param_1] != '\0') {
      Variant::_clear_internal();
    }
...
Object * MethodBindTRC<EditorExportPreset::FileExportMode,String_const&,EditorExportPreset::FileExportMode>
...
/* MethodBindTRC<String, StringName const&>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTRC<String,StringName_const&>::_gen_argument_type_info(int param_1)
...
/* MethodBindTRC<String, StringName const&, bool>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTRC<String,StringName_const&,bool>::_gen_argument_type_info(int param_1)
...
/* MethodBindTR<bool, String const&>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTR<bool,String_const&>::_gen_argument_type_info(int param_1)
...
/* MethodBindTRC<Variant, StringName const&, String const&>::_gen_argument_type_info(int) const */

undefined4 *
MethodBindTRC<Variant,StringName_const&,String_const&>::_gen_argument_type_info(int param_1)
...
/* MethodBindTRC<EditorExportPreset::FileExportMode, String const&,
   EditorExportPreset::FileExportMode>::_gen_argument_type_info(int) const */
...

{
  ...
  if (in_EDX < 2) {
    ...
    if (in_EDX == (uint)local_a0) {
      GetTypeInfo<EditorExportPreset::FileExportMode,void>::get_class_info
                ((GetTypeInfo<EditorExportPreset::FileExportMode,void> *)&local_68);
      local_98 = CONCAT44(local_98._4_4_,local_68._0_4_);
      if (local_90._0_8_ != local_60) {
        CowData<char32_t>::_unref((CowData<char32_t> *)local_90);
        local_90._0_8_ = local_60;
...
void EditorExportPreset::_GLOBAL__sub_I__set(void)

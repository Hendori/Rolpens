...
undefined1
hb_ot_get_font_v_extents(hb_font_t *param_1,void *param_2,hb_font_extents_t *param_3,void *param_4)
...
undefined1
hb_ot_get_font_h_extents(hb_font_t *param_1,void *param_2,hb_font_extents_t *param_3,void *param_4)
...

{
  ...
  *plVar2 = lVar4 + 0x70;
  ...
  if ((puVar3 == (undefined8 *)0x0) &&
     (__ptr = (undefined8 *)malloc(0x400), __ptr != (undefined8 *)0x0)) {
    puVar6 = __ptr;
    ...
    } while (puVar6 != __ptr + 0x80);
    iVar1 = hb_face_set_user_data
                      (*(undefined8 *)(param_1 + 0x20),&hb_ot_font_cmap_cache_user_data_key,__ptr,
                       free,0);
    puVar6 = __ptr;
    if (iVar1 == 0) {
      free(__ptr);
...
LAB_00100140:
  ...
  if (static_ot_funcs == 0) {
    ...
    if (lVar4 == 0) {
      ...
      UNLOCK();
      if (bVar7) goto code_r0x00100341;
    }
    else {
      LOCK();
      bVar7 = static_ot_funcs != 0;
...
hb_ot_get_glyph_from_name
          (hb_font_t *param_1,void *param_2,char *param_3,int param_4,uint *param_5,void *param_6)

{
  ...
  do {
    while( true ) {
      ...
      if (this_00 != (accelerator_t *)0x0) goto LAB_0010037c;
      phVar4 = (hb_face_t *)*puVar3;
      if (phVar4 == (hb_face_t *)0x0) goto LAB_00100470;
...
LAB_0010037c:
  cVar5 = OT::post::accelerator_t::get_glyph_from_name
                    ((char *)this_00,(int)param_3,(uint *)(ulong)(uint)param_4);
  uVar6 = 1;
  if (cVar5 == '\0') {
    this = (accelerator_t *)
...
hb_ot_get_glyph_name
          (hb_font_t *param_1,void *param_2,uint param_3,char *param_4,uint param_5,void *param_6)

{
  ...
  do {
    while( true ) {
      ...
      if (this != (accelerator_t *)0x0) goto LAB_001004c1;
      phVar5 = (hb_face_t *)*puVar4;
      if (phVar5 == (hb_face_t *)0x0) goto LAB_0010089f;
...
LAB_001004c1:
  if (*(int *)(this + 8) == 0x10000) {
    if (param_3 < 0x102) {
      uVar15 = param_3 + 1;
      uVar7 = *(uint *)(format1_names_msgidx + (ulong)param_3 * 4);
LAB_0010060e:
      uVar9 = (ulong)(~uVar7 + *(int *)(format1_names_msgidx + (ulong)uVar15 * 4));
...
LAB_0010061f:
  ...
  else if ((*(int *)(this + 8) == 0x20000) &&
          (uVar6 = **(ushort **)(this + 0x10), param_3 < (ushort)(uVar6 << 8 | uVar6 >> 8))) {
    ...
    if (uVar6 - 0x102 < *(uint *)(this + 0x1c)) {
      pbVar12 = (byte *)((ulong)*(uint *)(*(long *)(this + 0x20) + (ulong)(uVar6 - 0x102) * 4) +
                        *(long *)(this + 0x28));
      uVar9 = (ulong)*pbVar12;
      pbVar12 = pbVar12 + 1;
      goto LAB_0010061f;
  ...
  lVar8 = hb_lazy_loader_t<OT::cff1_accelerator_t,hb_face_lazy_loader_t<OT::cff1_accelerator_t,16u>,hb_face_t,16u,OT::cff1_accelerator_t>
          ::get_stored((hb_lazy_loader_t<OT::cff1_accelerator_t,hb_face_lazy_loader_t<OT::cff1_accelerator_t,16u>,hb_face_t,16u,OT::cff1_accelerator_t>
                        *)(puVar4 + 0x10));
...
LAB_0010082b:
        uVar15 = (ushort)(*puVar10 << 8 | *puVar10 >> 8) + uVar15;
        goto LAB_00100566;
      }
    }
    else if (cVar2 == '\x02') {
      if (param_3 != 0) {
        ...
        uVar7 = (uint)uVar6;
        if (uVar15 <= uVar6) goto LAB_001008ab;
        do {
          uVar15 = (uVar15 - 1) - uVar7;
          uVar9 = (ulong)((int)uVar9 + 1);
          lVar14 = uVar9 * 4;
          uVar7 = (uint)(ushort)(*(ushort *)(pcVar13 + uVar9 * 4 + 3) << 8 |
                                *(ushort *)(pcVar13 + uVar9 * 4 + 3) >> 8);
        } while (uVar7 < uVar15);
LAB_00100826:
        puVar10 = (ushort *)(pcVar13 + lVar14 + 1);
        goto LAB_0010082b;
      }
    }
    else if ((cVar2 == '\0') && (param_3 != 0)) {
      uVar15 = (uint)(ushort)(*(ushort *)(pcVar13 + (ulong)(param_3 - 1) * 2 + 1) << 8 |
                             *(ushort *)(pcVar13 + (ulong)(param_3 - 1) * 2 + 1) >> 8);
      goto LAB_00100566;
    }
LAB_00100790:
    pcVar13 = ".notdef";
...
LAB_00100566:
    if (uVar15 < 0x187) {
      uVar9 = (ulong)(uint)(~(&cff1_std_strings_msgidx)[uVar15] +
                           (&cff1_std_strings_msgidx)[uVar15 + 1]);
      pcVar13 = ".notdef" + (uint)(&cff1_std_strings_msgidx)[uVar15];
    }
    else {
      auVar16 = OT::CFFIndex<OT::IntType<unsigned_short,2u>>::operator[]
                          (*(CFFIndex<OT::IntType<unsigned_short,2u>> **)(lVar8 + 0x68),
                           uVar15 - 0x187);
    ...
    if ((iVar3 != 0) || (0xe4 < param_3)) goto LAB_00100790;
    uVar9 = (ulong)(uint)(~(&cff1_std_strings_msgidx)[param_3] +
                         (&cff1_std_strings_msgidx)[param_3 + 1]);
...
/* OT::hb_paint_context_t::return_t
   OT::Paint::dispatch<OT::hb_paint_context_t>(OT::hb_paint_context_t*) const [clone .isra.0] */

void __thiscall OT::Paint::dispatch<OT::hb_paint_context_t>(Paint *this,hb_paint_context_t *param_1)
...
LAB_00101069:
  ...
  case (Paint)0xf:
    uVar6 = *(uint *)(this + 8);
    uVar6 = uVar6 >> 0x18 | (uVar6 & 0xff0000) >> 8 | (uVar6 & 0xff00) << 8 | uVar6 << 0x18;
    if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) goto LAB_00101069;
    break;
  case (Paint)0x10:
    if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
      uVar6 = 0xffffffff;
LAB_00101019:
  ...
  case (Paint)0x11:
    uVar6 = *(uint *)(this + 8);
    uVar6 = uVar6 >> 0x18 | (uVar6 & 0xff0000) >> 8 | (uVar6 & 0xff00) << 8 | uVar6 << 0x18;
    if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) goto LAB_00101019;
    break;
  case (Paint)0x12:
    if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
      uVar6 = 0xffffffff;
LAB_00100fc9:
  ...
  case (Paint)0x13:
    uVar6 = *(uint *)(this + 0xc);
    uVar6 = uVar6 >> 0x18 | (uVar6 & 0xff0000) >> 8 | (uVar6 & 0xff00) << 8 | uVar6 << 0x18;
    if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) goto LAB_00100fc9;
    break;
  case (Paint)0x14:
...
LAB_00100dc9:
  ...
  case (Paint)0x17:
    uVar6 = *(uint *)(this + 10);
    uVar6 = uVar6 >> 0x18 | (uVar6 & 0xff0000) >> 8 | (uVar6 & 0xff00) << 8 | uVar6 << 0x18;
    if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) goto LAB_00100dc9;
    break;
  case (Paint)0x18:
    fVar12 = (float)ItemVarStoreInstancer::operator()
                              (*(ItemVarStoreInstancer **)(param_1 + 0x30),0xffffffff,0);
...
LAB_00100b19:
  ...
  case (Paint)0x1b:
    uVar6 = *(uint *)(this + 10);
    uVar6 = uVar6 >> 0x18 | (uVar6 & 0xff0000) >> 8 | (uVar6 & 0xff00) << 8 | uVar6 << 0x18;
    if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) goto LAB_00100b19;
    break;
  case (Paint)0x1c:
    if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
      uVar6 = 0xffffffff;
LAB_00100ac9:
  ...
  case (Paint)0x1d:
    uVar6 = *(uint *)(this + 8);
    uVar6 = uVar6 >> 0x18 | (uVar6 & 0xff0000) >> 8 | (uVar6 & 0xff00) << 8 | uVar6 << 0x18;
    if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) goto LAB_00100ac9;
    break;
  case (Paint)0x1e:
    if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
      uVar6 = 0xffffffff;
LAB_00100a79:
  ...
  case (Paint)0x1f:
    uVar6 = *(uint *)(this + 0xc);
    uVar6 = uVar6 >> 0x18 | (uVar6 & 0xff0000) >> 8 | (uVar6 & 0xff00) << 8 | uVar6 << 0x18;
    if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) goto LAB_00100a79;
    break;
  case (Paint)0x20:
    ...
    if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00100a5c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
hb_ot_get_variation_glyph
          (hb_font_t *param_1,void *param_2,uint param_3,uint param_4,uint *param_5,void *param_6)

{
  ...
  do {
    while( true ) {
      this = (accelerator_t *)*plVar1;
      if (this != (accelerator_t *)0x0) goto LAB_001014d4;
      phVar7 = (hb_face_t *)*puVar4;
      if (phVar7 == (hb_face_t *)0x0) goto LAB_001017c6;
  ...
  if (-1 < iVar15) {
    ...
    do {
      while( true ) {
        ...
        if (param_4 == uVar11) goto LAB_0010154c;
        iVar16 = uVar14 + 1;
        if (iVar15 < iVar16) goto LAB_00101545;
      }
      iVar15 = uVar14 - 1;
    } while (iVar16 <= iVar15);
LAB_00101545:
...
LAB_0010154c:
  ...
  if (-1 < iVar15) {
    ...
    do {
      ...
      uVar11 = (uint)(byte)*puVar2 * 0x10000 + (uint)*(byte *)((long)puVar2 + 1) * 0x100 +
               (uint)*(byte *)((long)puVar2 + 2);
      if (param_3 < uVar11) {
        iVar15 = uVar14 - 1;
      }
      else {
        if (param_3 <= uVar11 + *(byte *)((long)puVar2 + 3)) {
          ...
          if (pcVar6 == (code *)0x0) goto LAB_00101691;
          if (lVar5 == 0) {
  ...
  if (-1 < iVar15) {
    ...
    do {
      while( true ) {
        ...
        if (param_3 == uVar11) goto LAB_00101682;
        iVar16 = uVar14 + 1;
        if (iVar15 < iVar16) goto LAB_0010167b;
      }
      iVar15 = uVar14 - 1;
    } while (iVar16 <= iVar15);
LAB_0010167b:
...
LAB_00101682:
  uVar10 = *(ushort *)(pbVar13 + 3) << 8 | *(ushort *)(pbVar13 + 3) >> 8;
  if (uVar10 == 0) {
LAB_00101691:
    uVar8 = 0;
  }
...
undefined1
hb_ot_get_nominal_glyph(hb_font_t *param_1,void *param_2,uint param_3,uint *param_4,void *param_5)

{
  ...
  do {
    while( true ) {
      this = (accelerator_t *)*plVar1;
      if (this != (accelerator_t *)0x0) goto LAB_00101811;
      phVar8 = (hb_face_t *)*puVar5;
      if (phVar8 == (hb_face_t *)0x0) goto LAB_00101963;
      this = (accelerator_t *)calloc(1,0x58);
      if (this == (accelerator_t *)0x0) break;
...

{
  ...
  do {
    while( true ) {
      this = (accelerator_t *)*plVar1;
      if (this != (accelerator_t *)0x0) goto LAB_001019a9;
      phVar7 = (hb_face_t *)*puVar6;
      if (phVar7 == (hb_face_t *)0x0) goto LAB_00101b2f;
      this = (accelerator_t *)calloc(1,0x58);
      if (this == (accelerator_t *)0x0) break;
      OT::cmap::accelerator_t::accelerator_t(this,phVar7);
      LOCK();
...
LAB_001019a9:
  uVar9 = 0;
  uVar10 = uVar9;
  if ((*(long *)(this + 0x10) != 0) && (uVar10 = 0, param_3 != 0)) {
    do {
      uVar10 = *param_4;
      if (lVar5 == 0) {
...
void hb_ot_get_glyph_h_advances
               (hb_font_t *param_1,void *param_2,uint param_3,uint *param_4,uint param_5,
...

{
  ...
  do {
    while( true ) {
      this = (accelerator_t *)*plVar1;
      if (this != (accelerator_t *)0x0) goto LAB_00101b77;
      phVar4 = (hb_face_t *)*puVar8;
      if (phVar4 == (hb_face_t *)0x0) goto LAB_00102166;
      this = (accelerator_t *)calloc(1,0x28);
      if (this == (accelerator_t *)0x0) break;
      OT::hmtxvmtx<OT::hmtx,OT::hhea,OT::HVAR>::accelerator_t::accelerator_t(this,phVar4);
      LOCK();
      lVar10 = *plVar1;
      if (lVar10 == 0) {
        *plVar1 = (long)this;
...
LAB_00101b77:
  ...
  if (0x13 < *(uint *)(puVar7 + 0x18)) {
    puVar18 = *(undefined **)(puVar7 + 0x10);
  }
  uVar27 = *(uint *)(puVar18 + 4);
  if (uVar27 != 0) {
    puVar20 = puVar18 + (uVar27 >> 0x18 | (uVar27 & 0xff0000) >> 8 | (uVar27 & 0xff00) << 8 |
                        uVar27 << 0x18);
  }
  iVar22 = *(int *)(param_1 + 0x78);
  if (0x7f < iVar22 * param_3) {
    uVar27 = *(uint *)(puVar20 + 2);
    puVar7 = &_hb_NullPool;
    if (uVar27 != 0) {
      puVar7 = puVar20 + (uVar27 >> 0x18 | (uVar27 & 0xff0000) >> 8 | (uVar27 & 0xff00) << 8 |
                         uVar27 << 0x18);
    }
    uVar15 = *(ushort *)(puVar7 + 2) << 8 | *(ushort *)(puVar7 + 2) >> 8;
    local_58 = (float *)malloc((ulong)uVar15 * 4);
    fVar30 = _LC5;
    if (local_58 != (float *)0x0) {
      if (uVar15 != 0) {
        ...
        do {
          *pfVar11 = fVar30;
          pfVar11 = pfVar11 + 1;
        } while (pfVar11 != local_58 + (ulong)(uVar15 - 1) + 1);
      }
      goto LAB_00101bc0;
    }
  }
...
LAB_00101ce0:
    ...
    if (param_3 != 0) {
      do {
        uVar19 = *param_4;
        uVar23 = (ulong)uVar19;
        if (uVar19 < *(uint *)(this + 4)) {
          puVar20 = *(undefined **)(this + 0x18);
          pcVar21 = &_hb_NullPool;
          if (puVar20 == (undefined *)0x0) {
            puVar20 = &_hb_NullPool;
          }
          uVar9 = (ulong)(*(int *)this - 1U);
          if (uVar19 < *(int *)this - 1U) {
            uVar9 = uVar23;
          }
          uVar15 = *(ushort *)(*(long *)(puVar20 + 0x10) + uVar9 * 4);
          uVar15 = uVar15 << 8 | uVar15 >> 8;
          lVar10 = (long)(short)uVar15;
          if (*(uint *)(param_1 + 0x78) != 0) {
            puVar20 = *(undefined **)(this + 0x20);
            if (puVar20 == (undefined *)0x0) {
              puVar20 = &_hb_NullPool;
            }
            if (*(uint *)(puVar20 + 0x18) == 0) {
              iVar22 = _glyf_get_advance_with_var_unscaled(param_1,uVar19,false);
              uVar16 = (ushort)iVar22;
              if (iVar22 == 0) {
                uVar16 = uVar15;
              }
              lVar10 = (long)(short)uVar16;
            }
            else {
              puVar7 = &_hb_NullPool;
              if (0x13 < *(uint *)(puVar20 + 0x18)) {
                puVar7 = *(undefined **)(puVar20 + 0x10);
              }
              uVar17 = *(uint *)(puVar7 + 8);
              if (uVar17 != 0) {
                pcVar21 = puVar7 + (uVar17 >> 0x18 | (uVar17 & 0xff0000) >> 8 |
                                    (uVar17 & 0xff00) << 8 | uVar17 << 0x18);
              }
              if (*pcVar21 == '\0') {
                uVar16 = *(ushort *)(pcVar21 + 2) << 8 | *(ushort *)(pcVar21 + 2) >> 8;
                if (uVar16 != 0) {
                  bVar29 = pcVar21[1];
                  if (uVar16 <= uVar19) {
                    uVar19 = uVar16 - 1;
                  ...
                  uVar17 = (bVar29 >> 4 & 3) + 1;
                  pbVar24 = (byte *)(pcVar21 + (ulong)(uVar19 * uVar17) + 4);
                  uVar19 = 0;
                  pbVar25 = pbVar24 + uVar17;
                  do {
                    bVar3 = *pbVar24;
                    pbVar24 = pbVar24 + 1;
                    uVar19 = uVar19 * 0x100 + (uint)bVar3;
                  } while (pbVar25 != pbVar24);
                  goto LAB_00101dfa;
                }
              }
              else if ((*pcVar21 == '\x01') && (uVar17 = *(uint *)(pcVar21 + 2), uVar17 != 0)) {
                ...
                uVar17 = (bVar29 >> 4 & 3) + 1;
                pbVar24 = (byte *)(pcVar21 + (ulong)(uVar19 * uVar17) + 6);
                uVar19 = 0;
                pbVar25 = pbVar24 + uVar17;
                do {
                  bVar3 = *pbVar24;
...
LAB_00101dfa:
                sVar14 = (bVar29 & 0xf) + 1;
                uVar23 = (ulong)((1 << sVar14) - 1U & uVar19 | (uVar19 >> sVar14) << 0x10);
              }
              uVar19 = *(uint *)(puVar7 + 4);
              this_00 = (ItemVariationStore *)&_hb_NullPool;
              if (uVar19 != 0) {
                this_00 = (ItemVariationStore *)
                          (puVar7 + (uVar19 >> 0x18 | (uVar19 & 0xff0000) >> 8 |
                                     (uVar19 & 0xff00) << 8 | uVar19 << 0x18));
              }
              fVar30 = (float)OT::ItemVariationStore::get_delta
                                        (this_00,(uint)(uVar23 >> 0x10),(uint)uVar23 & 0xffff,
                                         *(int **)(param_1 + 0x80),*(uint *)(param_1 + 0x78),
                                         local_58);
              fVar30 = fVar30 + _LC9;
              if ((float)((uint)fVar30 & _LC4) < _LC1) {
                fVar30 = (float)((uint)((float)(int)fVar30 -
                                       (float)(-(uint)(fVar30 < (float)(int)fVar30) & _LC3)) |
                                ~_LC4 & (uint)fVar30);
              }
              lVar10 = (long)(short)(long)(fVar30 + (float)uVar15);
            }
          }
        }
        else {
          lVar10 = 0;
          if (*(int *)(this + 8) == 0) {
            lVar10 = (long)*(short *)(this + 0x10);
          }
        }
        uVar27 = uVar27 + 1;
        *piVar28 = (int)((ulong)(lVar10 * *(long *)(param_1 + 0x58) + 0x8000) >> 0x10);
        param_4 = (uint *)((long)param_4 + (ulong)param_5);
        piVar28 = (int *)((long)piVar28 + (ulong)param_7);
    ...
    while (*plVar1 == 0) {
      puVar8 = (undefined8 *)malloc(0x400);
      if (puVar8 == (undefined8 *)0x0) goto LAB_00101ce0;
      puVar26 = puVar8;
      for (lVar10 = 0x80; puVar13 = puVar8, lVar10 != 0; lVar10 = lVar10 + -1) {
        *puVar26 = 0;
        puVar26 = puVar26 + (ulong)bVar29 * -2 + 1;
      }
      do {
        *(undefined4 *)puVar13 = 0xffffffff;
        puVar13 = (undefined8 *)((long)puVar13 + 4);
      } while (puVar13 != puVar8 + 0x80);
      LOCK();
      lVar10 = *plVar1;
      if (lVar10 == 0) {
        *plVar1 = (long)puVar8;
    ...
    if (*(int *)(param_1 + 0x14) != *(int *)((long)param_2 + 0x10)) {
      puVar12 = *(undefined4 **)((long)param_2 + 0x18);
      puVar2 = puVar12 + 0x100;
      do {
        *puVar12 = 0xffffffff;
        puVar12 = puVar12 + 1;
    ...
    if (param_3 != 0) {
      do {
        uVar19 = *param_4;
        uVar17 = *(uint *)(*plVar1 + (ulong)(uVar19 & 0xff) * 4);
        if ((uVar17 == 0xffffffff) || (uVar5 = uVar17 & 0xffff, uVar17 >> 0x10 != uVar19 >> 8)) {
          uVar5 = OT::hmtxvmtx<OT::hmtx,OT::hhea,OT::HVAR>::accelerator_t::
                  get_advance_with_var_unscaled(this,uVar19,param_1,local_58);
          uVar19 = *param_4;
          if ((uVar5 & 0xffff0000) == 0 && uVar19 >> 0x18 == 0) {
            *(uint *)(*plVar1 + (ulong)(uVar19 & 0xff) * 4) = (uVar19 >> 8) << 0x10 | uVar5;
          }
        }
        uVar27 = uVar27 + 1;
        param_4 = (uint *)((long)param_4 + (ulong)param_5);
        *piVar28 = (int)((ulong)((long)(short)uVar5 * *(long *)(param_1 + 0x58) + 0x8000) >> 0x10);
        piVar28 = (int *)((long)piVar28 + (ulong)param_7);
      } while (param_3 != uVar27);
    }
  }
  ...
  if ((iVar22 != 0) && (param_1[0x38] == (hb_font_t)0x0)) {
...
/* hb_ot_get_glyph_v_advances(hb_font_t*, void*, unsigned int, unsigned int const*, unsigned int,
   int*, unsigned int, void*) */

void hb_ot_get_glyph_v_advances
               (hb_font_t *param_1,void *param_2,uint param_3,uint *param_4,uint param_5,
               int *param_6,uint param_7,void *param_8)

{
  ...
  do {
    while( true ) {
      this = (accelerator_t *)*plVar15;
      if (this != (accelerator_t *)0x0) goto LAB_00102224;
      phVar4 = (hb_face_t *)*puVar3;
      if (phVar4 == (hb_face_t *)0x0) goto LAB_0010278d;
      this = (accelerator_t *)calloc(1,0x28);
      if (this == (accelerator_t *)0x0) break;
      OT::hmtxvmtx<OT::vmtx,OT::vhea,OT::VVAR>::accelerator_t::accelerator_t(this,phVar4);
      LOCK();
      lVar8 = *plVar15;
      if (lVar8 == 0) {
        *plVar15 = (long)this;
...
LAB_00102224:
  ...
  if (uVar13 == 0) {
    ...
    iVar19 = (**(code **)(*(long *)(param_1 + 0x90) + 0x20))
                       (param_1,*(undefined8 *)(param_1 + 0x98),local_78,plVar15);
    if (iVar19 == 0) {
      iVar5 = (int)((double)*(int *)(param_1 + 0x2c) * __LC40);
      iVar19 = iVar5 - *(int *)(param_1 + 0x2c);
      local_78._4_4_ = iVar19;
      local_78._0_4_ = iVar5;
    }
    else {
      iVar19 = local_78._4_4_;
      iVar5 = local_78._0_4_;
    }
    if (param_3 != 0) {
      uVar13 = 0;
      piVar25 = param_6;
      do {
        uVar13 = uVar13 + 1;
        *piVar25 = iVar19 - iVar5;
        piVar25 = (int *)((long)piVar25 + (ulong)param_7);
      } while (param_3 != uVar13);
    }
    goto LAB_001025bf;
  }
  puVar16 = *(undefined **)(this + 0x20);
  puVar6 = &_hb_NullPool;
  if (puVar16 == (undefined *)0x0) {
    puVar16 = &_hb_NullPool;
  }
  puVar14 = &_hb_NullPool;
  if (0x17 < *(uint *)(puVar16 + 0x18)) {
    puVar14 = *(undefined **)(puVar16 + 0x10);
  }
  uVar18 = *(uint *)(puVar14 + 4);
  if (uVar18 != 0) {
    puVar6 = puVar14 + (uVar18 >> 0x18 | (uVar18 & 0xff0000) >> 8 | (uVar18 & 0xff00) << 8 |
                       uVar18 << 0x18);
  }
...
LAB_0010226b:
    ...
    uVar18 = *(uint *)(puVar6 + 2);
    puVar16 = &_hb_NullPool;
    if (uVar18 != 0) {
      puVar16 = puVar6 + (uVar18 >> 0x18 | (uVar18 & 0xff0000) >> 8 | (uVar18 & 0xff00) << 8 |
                         uVar18 << 0x18);
    }
    uVar11 = *(ushort *)(puVar16 + 2) << 8 | *(ushort *)(puVar16 + 2) >> 8;
    __ptr = (float *)malloc((ulong)uVar11 * 4);
    fVar26 = _LC5;
    if (__ptr == (float *)0x0) goto LAB_0010226b;
    if (uVar11 != 0) {
      pfVar9 = __ptr;
      do {
        *pfVar9 = fVar26;
        pfVar9 = pfVar9 + 1;
      } while (pfVar9 != __ptr + (ulong)(uVar11 - 1) + 1);
    }
  }
  if (param_3 != 0) {
    uVar24 = 0;
    uVar18 = *param_4;
    piVar25 = param_6;
    if (uVar13 <= uVar18) goto LAB_0010246e;
    do {
      uVar20 = (ulong)uVar18;
      puVar6 = *(undefined **)(this + 0x18);
      pcVar17 = &_hb_NullPool;
      if (puVar6 == (undefined *)0x0) {
        puVar6 = &_hb_NullPool;
      }
      uVar7 = (ulong)(*(int *)this - 1U);
      if (uVar18 < *(int *)this - 1U) {
        uVar7 = uVar20;
      }
      uVar11 = *(ushort *)(*(long *)(puVar6 + 0x10) + uVar7 * 4);
      uVar11 = uVar11 << 8 | uVar11 >> 8;
      if (*(uint *)(param_1 + 0x78) == 0) {
LAB_00102510:
        lVar8 = (long)(short)-uVar11;
      }
      else {
        puVar6 = *(undefined **)(this + 0x20);
        if (puVar6 == (undefined *)0x0) {
          puVar6 = &_hb_NullPool;
        }
        if (*(uint *)(puVar6 + 0x18) == 0) {
          iVar19 = _glyf_get_advance_with_var_unscaled(param_1,uVar18,true);
          if (iVar19 == 0) goto LAB_00102510;
          lVar8 = (long)(short)-(short)iVar19;
        }
        else {
          puVar16 = &_hb_NullPool;
          if (0x17 < *(uint *)(puVar6 + 0x18)) {
            puVar16 = *(undefined **)(puVar6 + 0x10);
          }
          uVar13 = *(uint *)(puVar16 + 8);
          if (uVar13 != 0) {
            pcVar17 = puVar16 + (uVar13 >> 0x18 | (uVar13 & 0xff0000) >> 8 | (uVar13 & 0xff00) << 8
                                | uVar13 << 0x18);
          }
          if (*pcVar17 == '\0') {
            uVar12 = *(ushort *)(pcVar17 + 2) << 8 | *(ushort *)(pcVar17 + 2) >> 8;
            if (uVar12 != 0) {
              bVar1 = pcVar17[1];
              if (uVar12 <= uVar18) {
                uVar18 = uVar12 - 1;
              ...
              uVar22 = (bVar1 >> 4 & 3) + 1;
              pbVar21 = (byte *)(pcVar17 + (ulong)(uVar18 * uVar22) + 4);
              uVar13 = 0;
              pbVar23 = pbVar21 + uVar22;
              do {
                bVar2 = *pbVar21;
                pbVar21 = pbVar21 + 1;
                uVar13 = uVar13 * 0x100 + (uint)bVar2;
              } while (pbVar23 != pbVar21);
              goto LAB_0010238b;
            }
          }
          else if ((*pcVar17 == '\x01') && (uVar13 = *(uint *)(pcVar17 + 2), uVar13 != 0)) {
            ...
            uVar22 = (bVar1 >> 4 & 3) + 1;
            pbVar21 = (byte *)(pcVar17 + (ulong)(uVar18 * uVar22) + 6);
            uVar13 = 0;
            pbVar23 = pbVar21 + uVar22;
            do {
              bVar2 = *pbVar21;
...
LAB_0010238b:
            sVar10 = (bVar1 & 0xf) + 1;
            uVar20 = (ulong)((1 << sVar10) - 1U & uVar13 | (uVar13 >> sVar10) << 0x10);
          }
          uVar13 = *(uint *)(puVar16 + 4);
          this_00 = (ItemVariationStore *)&_hb_NullPool;
          if (uVar13 != 0) {
            this_00 = (ItemVariationStore *)
                      (puVar16 +
          ...
          fVar26 = (float)OT::ItemVariationStore::get_delta
                                    (this_00,(uint)(uVar20 >> 0x10),(uint)uVar20 & 0xffff,
                                     *(int **)(param_1 + 0x80),*(uint *)(param_1 + 0x78),__ptr);
          fVar26 = fVar26 + _LC9;
          if ((float)((uint)fVar26 & _LC4) < _LC1) {
            fVar26 = (float)((uint)((float)(int)fVar26 -
                                   (float)(-(uint)(fVar26 < (float)(int)fVar26) & _LC3)) |
                            ~_LC4 & (uint)fVar26);
          }
          lVar8 = (long)(short)-(short)(long)(fVar26 + (float)uVar11);
        }
      }
      while( true ) {
        uVar24 = uVar24 + 1;
        *piVar25 = (int)((ulong)(lVar8 * *(long *)(param_1 + 0x60) + 0x8000) >> 0x10);
        param_4 = (uint *)((long)param_4 + (ulong)param_5);
        piVar25 = (int *)((long)piVar25 + (ulong)param_7);
        if (param_3 == uVar24) goto LAB_001025ad;
        uVar18 = *param_4;
        if (uVar18 < *(uint *)(this + 4)) break;
LAB_0010246e:
        lVar8 = 0;
        if (*(int *)(this + 8) == 0) {
          lVar8 = (long)-*(short *)(this + 0x10);
        }
      }
    } while( true );
  }
...
LAB_001025bf:
  ...
  if ((iVar19 != 0) && (param_1[0x38] == (hb_font_t)0x0)) {
    if (*(int *)(param_1 + 0x2c) < 0) {
      iVar19 = -iVar19;
    }
    if (param_3 != 0) {
...
void hb_ot_draw_glyph(hb_font_t *param_1,void *param_2,uint param_3,hb_draw_funcs_t *param_4,
...

{
  ...
  do {
    while( true ) {
      ...
      if (this != (glyf_accelerator_t *)0x0) goto LAB_001028e6;
      phVar3 = *(hb_face_t **)(lVar12 + 0x70);
      if (phVar3 == (hb_face_t *)0x0) goto LAB_00102c6b;
...
LAB_00102c6b:
  this = (glyf_accelerator_t *)&_hb_NullPool;
LAB_001028e6:
  uVar6 = uStack_a4;
  uVar5 = uStack_bc;
  pfStack_d0 = &local_88;
  ...
  local_98 = 0;
  local_d8 = param_1;
  bVar9 = OT::glyf_accelerator_t::get_points<OT::glyf_impl::path_builder_t>
                    (this,param_1,param_3,0,0,this,param_1,pfStack_d0,(ulong)uStack_c7 << 8,
                     CONCAT44(uVar5,uStack_c0) & 0xffffff00ffffffff,local_b8,(ulong)uStack_af << 8,
                     CONCAT44(uVar6,local_a8) & 0xffffff00ffffffff,uStack_a0,(ulong)uStack_97 << 8,
                     uStack_90);
  if (!bVar9) {
    phVar11 = (hb_font_t *)
              ...
              ::get_stored((hb_lazy_loader_t<OT::cff2_accelerator_t,hb_face_lazy_loader_t<OT::cff2_accelerator_t,17u>,hb_face_t,17u,OT::cff2_accelerator_t>
                            *)(*(long *)(param_1 + 0x20) + 0xf8));
    cVar10 = OT::cff2::accelerator_t::get_path
                       (phVar11,(uint)param_1,(hb_draw_session_t *)(ulong)param_3);
    if (cVar10 == '\0') {
      phVar11 = (hb_font_t *)
                hb_lazy_loader_t<OT::cff1_accelerator_t,hb_face_lazy_loader_t<OT::cff1_accelerator_t,16u>,hb_face_t,16u,OT::cff1_accelerator_t>
                ::get_stored((hb_lazy_loader_t<OT::cff1_accelerator_t,hb_face_lazy_loader_t<OT::cff1_accelerator_t,16u>,hb_face_t,16u,OT::cff1_accelerator_t>
                              *)(*(long *)(param_1 + 0x20) + 0xf0));
  ...
  if (bVar4) {
    ...
    hb_outline_t::embolden
              ((float)*(int *)(param_1 + 0x3c),(float)*(int *)(param_1 + 0x40),fVar13,fVar14);
...
hb_ot_get_glyph_v_origin
          (hb_font_t *param_1,void *param_2,uint param_3,int *param_4,int *param_5,void *param_6)

{
  ...
  iVar6 = (**(code **)(*(long *)(param_1 + 0x90) + 0x48))
                    (param_1,*(undefined8 *)(param_1 + 0x98),uVar21,lVar9);
  plVar15 = puVar2 + 0xd;
  *param_4 = iVar6 / 2;
LAB_00102ced:
  lVar9 = *plVar15;
  if (lVar9 == 0) {
    if ((hb_face_t *)*puVar2 == (hb_face_t *)0x0) {
      ...
      if (lVar9 == 0) {
        ...
        UNLOCK();
        if (lVar10 != 0) goto code_r0x0010364a;
      }
      else {
        LOCK();
        lVar10 = *plVar15;
  ...
  if ((uint)(ushort)(*puVar25 << 8 | *puVar25 >> 8) * 0x10000 +
      (uint)(ushort)(puVar25[1] << 8 | puVar25[1] >> 8) == 0) {
    plVar15 = puVar2 + 0xf;
    _local_88 = (undefined1  [16])0x0;
    do {
      while( true ) {
        this = (glyf_accelerator_t *)*plVar15;
        if (this != (glyf_accelerator_t *)0x0) goto LAB_00102d4c;
        phVar3 = (hb_face_t *)*puVar2;
        if (phVar3 == (hb_face_t *)0x0) goto LAB_00103672;
        this = (glyf_accelerator_t *)calloc(1,0x30);
        if (this == (glyf_accelerator_t *)0x0) break;
        OT::glyf_accelerator_t::glyf_accelerator_t(this,phVar3);
        LOCK();
...
LAB_00103672:
    this = (glyf_accelerator_t *)&_hb_NullPool;
LAB_00102d4c:
    cVar4 = OT::glyf_accelerator_t::get_extents(this,param_1,param_3,local_88);
    if (cVar4 == '\0') {
      local_78 = (undefined1  [16])0x0;
      local_68 = (undefined1  [16])0x0;
      local_58 = (undefined1  [16])0x0;
      ...
      iVar6 = (**(code **)(*(long *)(param_1 + 0x90) + 0x20))
                        (param_1,*(undefined8 *)(param_1 + 0x98),local_78,plVar15);
      if (iVar6 == 0) {
      ...
      do {
        while( true ) {
          ...
          if (paVar11 != (accelerator_t *)0x0) goto LAB_00102d7a;
          phVar3 = (hb_face_t *)*puVar2;
          if (phVar3 == (hb_face_t *)0x0) goto LAB_001036ae;
...
LAB_001036ae:
      paVar11 = (accelerator_t *)&_hb_NullPool;
LAB_00102d7a:
      local_8c = 0;
      if (*(uint *)(param_1 + 0x78) == 0) {
        uVar23 = *(uint *)paVar11;
        if (param_3 < uVar23) {
          ...
          if (*(uint *)(paVar11 + 4) <= param_3) goto LAB_00102ddc;
          puVar7 = *(undefined **)(paVar11 + 0x18);
          if (puVar7 == (undefined *)0x0) {
            puVar7 = &_hb_NullPool;
          }
          uVar5 = *(ushort *)
                   ((ulong)uVar23 * 4 + (ulong)(param_3 - uVar23) * 2 + *(long *)(puVar7 + 0x10));
          uVar5 = uVar5 << 8 | uVar5 >> 8;
        }
      }
      else {
        ...
        if (uVar23 == 0) {
LAB_00102dbf:
          cVar4 = _glyf_get_leading_bearing_with_var_unscaled(param_1,param_3,true,&local_8c);
          if (cVar4 == '\0') {
LAB_00102ddc:
            local_78 = (undefined1  [16])0x0;
            local_68 = (undefined1  [16])0x0;
          ...
          pcVar18 = puVar17 + (uVar23 >> 0x18 | (uVar23 & 0xff0000) >> 8 | (uVar23 & 0xff00) << 8 |
                              uVar23 << 0x18);
          uVar19 = uVar21;
          if (*pcVar18 == '\0') {
          ...
          else if ((*pcVar18 == '\x01') && (uVar23 = *(uint *)(pcVar18 + 2), uVar23 != 0)) {
            uVar14 = uVar23 >> 0x18 | (uVar23 & 0xff0000) >> 8 | (uVar23 & 0xff00) << 8 |
                     uVar23 << 0x18;
            bVar22 = pcVar18[1];
            uVar23 = uVar14 - 1;
            if (param_3 < uVar14) {
...
LAB_0010332c:
          ...
          if (uVar23 != 0) {
            pIVar24 = (ItemVariationStore *)
                      (puVar17 +
                      (uVar23 >> 0x18 | (uVar23 & 0xff0000) >> 8 | (uVar23 & 0xff00) << 8 |
                      uVar23 << 0x18));
          }
          fVar26 = (float)OT::ItemVariationStore::get_delta
                                    (pIVar24,(uint)(uVar19 >> 0x10),(uint)uVar19 & 0xffff,
                                     *(int **)(param_1 + 0x80),*(uint *)(param_1 + 0x78),
                                     (float *)0x0);
          uVar23 = *(uint *)paVar11;
          if (param_3 < uVar23) {
            ...
            if (*(uint *)(paVar11 + 4) <= param_3) goto LAB_00102dbf;
            puVar7 = *(undefined **)(paVar11 + 0x18);
            if (puVar7 == (undefined *)0x0) {
              puVar7 = &_hb_NullPool;
            }
      ...
      iVar6 = (int)((ulong)((long)(short)uVar5 * *(long *)(param_1 + 0x60) + 0x8000) >> 0x10) +
              iStack_84;
    }
LAB_00102e80:
    *param_5 = iVar6;
  ...
  do {
    while( true ) {
      paVar11 = (accelerator_t *)*plVar15;
      if (paVar11 != (accelerator_t *)0x0) goto LAB_00102ea3;
      phVar3 = (hb_face_t *)*puVar2;
      if (phVar3 == (hb_face_t *)0x0) goto LAB_00103690;
      paVar11 = (accelerator_t *)calloc(1,0x28);
      if (paVar11 == (accelerator_t *)0x0) break;
      OT::hmtxvmtx<OT::vmtx,OT::vhea,OT::VVAR>::accelerator_t::accelerator_t(paVar11,phVar3);
      LOCK();
...
LAB_00102ea3:
  ...
  if ((*(uint *)(param_1 + 0x78) != 0) && (uVar23 = *(uint *)(puVar17 + 0x14), uVar23 != 0)) {
    pcVar18 = puVar17 + (uVar23 >> 0x18 | (uVar23 & 0xff0000) >> 8 | (uVar23 & 0xff00) << 8 |
                        uVar23 << 0x18);
    if (*pcVar18 == '\0') {
      uVar5 = *(ushort *)(pcVar18 + 2) << 8 | *(ushort *)(pcVar18 + 2) >> 8;
...
LAB_001033a0:
    ...
    fVar26 = (float)OT::ItemVariationStore::get_delta
                              (pIVar24,(uint)(uVar21 >> 0x10),(uint)uVar21 & 0xffff,
                               *(int **)(param_1 + 0x80),*(uint *)(param_1 + 0x78),(float *)0x0);
  }
  ...
  if (uVar5 != 0) {
    ...
    do {
      while( true ) {
        ...
        uVar23 = (uint)(ushort)(puVar25[(ulong)uVar14 * 2 + 4] << 8 |
                               puVar25[(ulong)uVar14 * 2 + 4] >> 8);
        ...
        iVar13 = uVar14 + 1;
        if (iVar6 < iVar13) goto LAB_00102f23;
      }
      iVar6 = uVar14 - 1;
    } while (iVar13 <= iVar6);
  }
LAB_00102f23:
  uVar5 = puVar25[2] << 8 | puVar25[2] >> 8;
LAB_00102f2d:
  fVar26 = ((float)(int)(short)uVar5 + fVar26) * *(float *)(param_1 + 0x50) + _LC9;
  if ((float)((uint)fVar26 & _LC4) < _LC1) {
    fVar26 = (float)((uint)((float)(int)fVar26 -
                           (float)(-(uint)(fVar26 < (float)(int)fVar26) & _LC3)) |
                    ~_LC4 & (uint)fVar26);
...
void hb_ot_paint_glyph(hb_font_t *param_1,void *param_2,uint param_3,hb_paint_funcs_t *param_4,
  ...
  if (lVar9 == 0) {
    ...
    if (phVar4 == (hb_face_t *)0x0) {
      ...
      if (lVar9 == 0) {
        ...
        UNLOCK();
        if (lVar10 != 0) goto code_r0x00103cf3;
      }
      else {
        LOCK();
        lVar10 = *plVar1;
  ...
  if (cVar5 == '\0') {
    ...
    do {
      while( true ) {
        ...
        if (__ptr != (undefined8 *)0x0) goto LAB_0010378a;
        phVar4 = *(hb_face_t **)(lVar8 + 0x70);
        if (phVar4 == (hb_face_t *)0x0) goto LAB_00103da2;
        __ptr = (undefined8 *)
      ...
      if (uVar6 != 0) {
        ...
        do {
          while( true ) {
            ...
            if (param_3 <= (ushort)(puVar11[1] << 8 | puVar11[1] >> 8)) goto LAB_00103820;
            iVar14 = uVar12 + 1;
            if (iVar15 < iVar14) goto LAB_00103a4c;
          }
          iVar15 = uVar12 - 1;
        } while (iVar14 <= iVar15);
LAB_00103a4c:
...
LAB_00103820:
      uVar12 = *(uint *)(puVar11 + 2);
      uVar2 = *(uint *)(puVar11 + 4);
      lVar8 = hb_blob_create_sub_blob
                        (puVar3,uVar13 + (uVar12 >> 0x18 | (uVar12 & 0xff0000) >> 8 |
      ...
      if (lVar8 != lVar9) {
        (**(code **)(param_4 + 0x48))
                  (*(undefined4 *)(param_1 + 0x48),param_4,param_5,lVar8,0,0,0x73766720,0);
        if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    ...
    do {
      while( true ) {
        ...
        if (local_80 != (accelerator_t *)0x0) goto LAB_001038c4;
        phVar4 = *(hb_face_t **)(lVar8 + 0x70);
        if (phVar4 == (hb_face_t *)0x0) goto LAB_00103dc0;
...
LAB_00103dc0:
    local_80 = (accelerator_t *)&_hb_NullPool;
LAB_001038c4:
    lVar8 = OT::CBDT::accelerator_t::reference_png(local_80,param_1,param_3);
    lVar9 = hb_blob_get_empty();
    if (lVar8 != lVar9) {
      iVar15 = hb_font_get_glyph_extents(param_1,param_3,local_68);
      if ((iVar15 != 0) &&
         (cVar5 = OT::CBDT::accelerator_t::get_extents(local_80,param_1,param_3,local_58,false),
         cVar5 != '\0')) {
        iVar15 = (**(code **)(param_4 + 0x48))
                           (*(undefined4 *)(param_1 + 0x48),param_4,param_5,lVar8,local_50,-local_4c
                            ,0x706e6720,local_68);
        hb_blob_destroy(lVar8);
        if (iVar15 != 0) goto LAB_00103744;
      }
    }
    lVar8 = *(long *)(param_1 + 0x20);
    ...
    do {
      while( true ) {
        this = (accelerator_t *)*plVar1;
        if (this != (accelerator_t *)0x0) goto LAB_00103982;
        phVar4 = *(hb_face_t **)(lVar8 + 0x70);
        if (phVar4 == (hb_face_t *)0x0) goto LAB_00103de3;
        this = (accelerator_t *)
               hb_lazy_loader_t<OT::sbix_accelerator_t,hb_face_lazy_loader_t<OT::sbix_accelerator_t,38u>,hb_face_t,38u,OT::sbix_accelerator_t>
               ::create(phVar4);
        if (this == (accelerator_t *)0x0) break;
        LOCK();
        lVar9 = *plVar1;
...
LAB_00103de3:
    this = (accelerator_t *)&_hb_NullPool;
LAB_00103982:
    cVar5 = OT::sbix::accelerator_t::paint_glyph(this,param_1,param_3,param_4,param_5);
    if (cVar5 == '\0') {
      lVar8 = *(long *)(param_1 + 0x20);
      plVar1 = (long *)(lVar8 + 0xe8);
      do {
        while( true ) {
          if ((*plVar1 != 0) || (phVar4 = *(hb_face_t **)(lVar8 + 0x70), phVar4 == (hb_face_t *)0x0)
             ) goto LAB_001039b5;
...
LAB_001039b5:
      ...
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00103a38. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  do {
    while( true ) {
      this_00 = (accelerator_t *)*plVar1;
      if (this_00 != (accelerator_t *)0x0) goto LAB_00103e43;
      if ((hb_face_t *)*puVar2 == (hb_face_t *)0x0) goto LAB_00104152;
      this_00 = (accelerator_t *)
                hb_lazy_loader_t<OT::sbix_accelerator_t,hb_face_lazy_loader_t<OT::sbix_accelerator_t,38u>,hb_face_t,38u,OT::sbix_accelerator_t>
                ::create((hb_face_t *)*puVar2);
      if (this_00 == (accelerator_t *)0x0) break;
      LOCK();
      lVar7 = *plVar1;
      if (lVar7 == 0) {
...
LAB_00103e43:
  ...
  if (cVar4 == '\0') {
    do {
      while( true ) {
        this = (accelerator_t *)*plVar1;
        if (this != (accelerator_t *)0x0) goto LAB_00103f1f;
        phVar3 = (hb_face_t *)*puVar2;
        if (phVar3 == (hb_face_t *)0x0) goto LAB_00104170;
...
LAB_00104170:
    this = (accelerator_t *)&_hb_NullPool;
LAB_00103f1f:
    cVar4 = OT::CBDT::accelerator_t::get_extents(this,param_1,param_3,param_4,true);
    if (cVar4 == '\0') {
      plVar1 = puVar2 + 0x23;
LAB_00103f44:
      lVar7 = *plVar1;
      if (lVar7 == 0) {
        if ((hb_face_t *)*puVar2 == (hb_face_t *)0x0) {
          ...
          if (lVar7 == 0) {
            ...
            UNLOCK();
            if (lVar8 != 0) goto code_r0x001041a7;
          }
          else {
            LOCK();
            lVar8 = *plVar1;
      ...
      if (cVar4 == '\0') {
        ...
        do {
          while( true ) {
            ...
            if (this_01 != (glyf_accelerator_t *)0x0) goto LAB_00103f8c;
            phVar3 = (hb_face_t *)*puVar2;
            if (phVar3 == (hb_face_t *)0x0) goto LAB_001041ca;
...
LAB_001041ca:
        this_01 = (glyf_accelerator_t *)&_hb_NullPool;
LAB_00103f8c:
        cVar4 = OT::glyf_accelerator_t::get_extents(this_01,param_1,param_3,param_4);
        if (cVar4 == '\0') {
          phVar6 = (hb_font_t *)
                   hb_lazy_loader_t<OT::cff2_accelerator_t,hb_face_lazy_loader_t<OT::cff2_accelerator_t,17u>,hb_face_t,17u,OT::cff2_accelerator_t>
                   ::get_stored((hb_lazy_loader_t<OT::cff2_accelerator_t,hb_face_lazy_loader_t<OT::cff2_accelerator_t,17u>,hb_face_t,17u,OT::cff2_accelerator_t>
                                 *)(puVar2 + 0x11));
          cVar4 = OT::cff2::accelerator_t::get_extents
                            (phVar6,(uint)param_1,(hb_glyph_extents_t *)(ulong)param_3);
          if (cVar4 == '\0') {
            phVar6 = (hb_font_t *)
                     hb_lazy_loader_t<OT::cff1_accelerator_t,hb_face_lazy_loader_t<OT::cff1_accelerator_t,16u>,hb_face_t,16u,OT::cff1_accelerator_t>
                     ::get_stored((hb_lazy_loader_t<OT::cff1_accelerator_t,hb_face_lazy_loader_t<OT::cff1_accelerator_t,16u>,hb_face_t,16u,OT::cff1_accelerator_t>
                                   *)(puVar2 + 0x10));
            uVar5 = OT::cff1::accelerator_t::get_extents
                              (phVar6,(uint)param_1,(hb_glyph_extents_t *)(ulong)param_3);
            return uVar5;
          }
        }
...
undefined1
OT::ColorLine<OT::NoVariable>::static_get_extend
          (hb_color_line_t *param_1,void *param_2,void *param_3)
...
undefined1
OT::ColorLine<OT::Variable>::static_get_extend(hb_color_line_t *param_1,void *param_2,void *param_3)
...
int OT::cff1::accelerator_t::gname_t::cmp(void *param_1,void *param_2)
...

{
  ...
  if (9 < param_2) {
    do {
      ...
      p_Var15 = p_Var10;
      if (p_Var10 == p_Var13) {
        if (p_Var10 <= local_48) goto LAB_0010461b;
LAB_001043f4:
        do {
          while( true ) {
            ...
            do {
              while( true ) {
                ...
                p_Var7 = p_Var13;
                p_Var15 = p_Var12;
                if (p_Var12 <= p_Var8) goto LAB_00104468;
            ...
            p_Var8 = p_Var13;
            if (p_Var15 <= p_Var13) goto LAB_00104468;
          }
          p_Var13 = p_Var9;
          if ((iVar4 == 0) && (p_Var13 = p_Var9 + 0x18, p_Var9 < p_Var8)) {
            lVar5 = 0;
            do {
...
LAB_00104468:
        uVar14 = (long)p_Var15 - (long)p_Var9;
        ...
        if (p_Var10 != (_func_int_void_ptr_void_ptr *)0x0 &&
            p_Var13 != (_func_int_void_ptr_void_ptr *)0x0) {
        ...
        if (local_48 < p_Var10) goto LAB_001043f4;
LAB_0010461b:
        param_2 = 0;
  ...
  do {
    ...
    while( true ) {
      ...
      do {
        ...
        p_Var7 = p_Var9;
        if (iVar4 < 1) goto joined_r0x0010463a;
        do {
...
int OT::post::accelerator_t::cmp_gids(void *param_1,void *param_2,void *param_3)

{
  ...
  if (*(int *)((long)param_3 + 8) == 0x10000) {
    if (uVar4 < 0x102) {
      uVar4 = ~*(uint *)(format1_names_msgidx + (ulong)uVar5 * 4) +
              *(int *)(format1_names_msgidx + (ulong)(uVar4 + 1) * 4);
...
joined_r0x001047a5:
    uVar4 = 0;
    pbVar6 = (byte *)0x0;
    if (iVar2 == 0x10000) goto LAB_001047ab;
    uVar4 = 0;
    pbVar6 = (byte *)0x0;
    if (iVar2 != 0x20000) {
      return 0;
...
LAB_0010482a:
    uVar5 = **(ushort **)((long)param_3 + 0x10);
...
LAB_00104862:
    ...
    if (uVar7 < 0x102) goto LAB_001047b7;
    if (*(uint *)((long)param_3 + 0x1c) <= uVar7 - 0x102) goto LAB_00104862;
    pbVar8 = (byte *)((ulong)*(uint *)(*(long *)((long)param_3 + 0x20) + (ulong)(uVar7 - 0x102) * 4)
    ...
    if ((ushort)(uVar1 << 8 | uVar1 >> 8) <= uVar4) goto LAB_00104798;
    uVar5 = (*(ushort **)((long)param_3 + 0x10))[(ulong)uVar5 + 1];
    iVar2 = *(int *)((long)param_3 + 8);
    uVar5 = uVar5 << 8 | uVar5 >> 8;
    if (0x101 < uVar5) {
      if (uVar5 - 0x102 < *(uint *)((long)param_3 + 0x1c)) {
        pbVar6 = (byte *)((ulong)*(uint *)(*(long *)((long)param_3 + 0x20) +
                                          (ulong)(uVar5 - 0x102) * 4) +
                         *(long *)((long)param_3 + 0x28));
        uVar4 = (uint)*pbVar6;
        pbVar6 = pbVar6 + 1;
      ...
      goto joined_r0x001047a5;
    }
    uVar4 = ~*(uint *)(format1_names_msgidx + (ulong)uVar5 * 4) +
            *(int *)(format1_names_msgidx + (ulong)(uVar5 + 1) * 4);
    pbVar6 = (byte *)(".notdef" + *(uint *)(format1_names_msgidx + (ulong)uVar5 * 4));
LAB_00104818:
    if (iVar2 != 0x10000) {
      if (iVar2 == 0x20000) goto LAB_0010482a;
      goto LAB_00104862;
    }
LAB_001047ab:
    if (uVar3 < 0x102) {
LAB_001047b7:
      uVar3 = ~*(uint *)(format1_names_msgidx + (ulong)uVar7 * 4) +
              *(int *)(format1_names_msgidx + (ulong)(uVar7 + 1) * 4);
...
/* void sort_r_simple<void*>(void*, unsigned long, unsigned long, int (*)(void const*, void const*,
   void*), void*) [clone .constprop.0] */

void sort_r_simple<void*>
               (void *param_1,ulong param_2,ulong param_3,
               _func_int_void_ptr_void_ptr_void_ptr *param_4,void *param_5)
    ...
    do {
      ...
      while (puVar16 < puVar7) {
        ...
        if (*(int *)(param_3 + 8) == 0x10000) {
          if (uVar9 < 0x102) {
            iVar3 = *(int *)(param_3 + 8);
            uVar9 = ~*(uint *)(format1_names_msgidx + (ulong)uVar10 * 4) +
                    *(int *)(format1_names_msgidx + (ulong)(uVar9 + 1) * 4);
...
LAB_001052a3:
          pbVar18 = (byte *)0x0;
          uVar9 = 0;
          if (iVar3 == 0x10000) goto LAB_0010522e;
          if (iVar3 != 0x20000) break;
LAB_001052c3:
          uVar10 = **(ushort **)(param_3 + 0x10);
          if ((uint)uVar11 < (uint)(ushort)(uVar10 << 8 | uVar10 >> 8)) {
            uVar11 = (*(ushort **)(param_3 + 0x10))[uVar11 + 1];
            uVar11 = uVar11 << 8 | uVar11 >> 8;
            if (uVar11 < 0x102) goto LAB_00105310;
            if (*(uint *)(param_3 + 0x1c) <= uVar11 - 0x102) goto LAB_00105290;
            pbVar19 = (byte *)((ulong)*(uint *)(*(long *)(param_3 + 0x20) +
                                               (ulong)(uVar11 - 0x102) * 4) +
                              *(long *)(param_3 + 0x28));
            uVar5 = (uint)*pbVar19;
            pbVar19 = pbVar19 + 1;
            goto LAB_0010523d;
...
LAB_0010529b:
          ...
          if ((ushort)(uVar8 << 8 | uVar8 >> 8) <= uVar9) goto LAB_001052a0;
          ...
          if (0x101 < uVar10) {
            ...
            if (uVar9 < *(uint *)(param_3 + 0x1c)) {
              pbVar18 = (byte *)((ulong)*(uint *)(*(long *)(param_3 + 0x20) + (ulong)uVar9 * 4) +
                                *(long *)(param_3 + 0x28));
              uVar9 = (uint)*pbVar18;
              pbVar18 = pbVar18 + 1;
              goto LAB_00105223;
          ...
          pbVar18 = (byte *)(".notdef" + *(uint *)(format1_names_msgidx + (ulong)uVar10 * 4));
          uVar9 = ~*(uint *)(format1_names_msgidx + (ulong)uVar10 * 4) +
                  *(int *)(format1_names_msgidx + (ulong)(uVar10 + 1) * 4);
LAB_00105223:
          if (iVar3 != 0x10000) {
            if (iVar3 == 0x20000) goto LAB_001052c3;
            goto LAB_00105290;
          }
LAB_0010522e:
          if (uVar11 < 0x102) {
LAB_00105310:
            ...
            uVar5 = ~*(uint *)(format1_names_msgidx + (ulong)uVar11 * 4) +
                    *(int *)(format1_names_msgidx + (ulong)(uVar11 + 1) * 4);
          }
          else {
            uVar5 = 0;
            pbVar19 = (byte *)0x0;
...
LAB_0010523d:
          if (uVar5 != uVar9) goto LAB_0010529b;
          if (uVar5 == 0) break;
...
LAB_00104936:
  ...
  if (*(int *)(param_3 + 8) == 0x10000) {
    if (uVar10 < 0x102) {
      __n = (size_t)(~*(uint *)(format1_names_msgidx + (ulong)(uint)uVar10 * 4) +
                    *(int *)(format1_names_msgidx + (ulong)(uVar10 + 1) * 4));
      pcVar12 = ".notdef";
...
LAB_0010501b:
      ...
      puVar21 = pcVar22;
      puVar14 = local_48 + 1;
      if (iVar4 < 1) goto LAB_00105021;
    }
    else {
      if (iVar3 != 0x20000) {
        if (uVar9 == 0) goto LAB_00104972;
        uVar5 = 0;
        goto LAB_0010501b;
      }
      ...
      if (uVar11 < uVar10) {
        iVar3 = *(int *)(param_3 + 8);
        uVar11 = *(ushort *)((long)pcVar22 + ((ulong)uVar11 + 1) * 2) << 8 |
                 *(ushort *)((long)pcVar22 + ((ulong)uVar11 + 1) * 2) >> 8;
        if (uVar11 < 0x102) {
          uVar5 = ~*(uint *)(format1_names_msgidx + (ulong)uVar11 * 4) +
                  *(int *)(format1_names_msgidx + (ulong)(uVar11 + 1) * 4);
          pcVar22 = ".notdef";
...
LAB_00105021:
    ...
    if (iVar3 == 0x10000) {
      if (uVar10 < 0x102) {
        ...
        pcVar12 = (char *)(ulong)(~*(uint *)(format1_names_msgidx + (ulong)(uint)uVar10 * 4) +
                                 *(int *)(format1_names_msgidx + (ulong)(uVar10 + 1) * 4));
        pbVar18 = (byte *)(".notdef" + *(uint *)(format1_names_msgidx + (ulong)(uint)uVar10 * 4));
      }
      else {
      ...
      if (iVar3 != 0x20000) goto LAB_00104972;
      uVar8 = **(ushort **)(param_3 + 0x10);
      if (uVar10 < (ushort)(uVar8 << 8 | uVar8 >> 8)) {
        ...
        if (uVar10 < 0x102) {
          puVar21 = format1_names_msgidx;
          pcVar12 = (char *)(ulong)(~*(uint *)(format1_names_msgidx + (ulong)uVar9 * 4) +
                                   *(int *)(format1_names_msgidx + (ulong)(uVar9 + 1) * 4));
          pbVar18 = (byte *)(".notdef" + *(uint *)(format1_names_msgidx + (ulong)uVar9 * 4));
        }
        else if (uVar9 - 0x102 < *(uint *)(param_3 + 0x1c)) {
          pbVar18 = (byte *)((ulong)*(uint *)(*(long *)(param_3 + 0x20) + (ulong)(uVar9 - 0x102) * 4
                                             ) + *(long *)(param_3 + 0x28));
...
LAB_00105459:
        puVar21 = format1_names_msgidx;
        uVar5 = ~*(uint *)(format1_names_msgidx + uVar6 * 4) +
                *(int *)(format1_names_msgidx + (ulong)((int)uVar6 + 1) * 4);
...
LAB_001050d5:
      if (uVar5 != uVar9) goto LAB_00105191;
      if (uVar5 == 0) goto LAB_00104972;
      iVar3 = memcmp(pbVar19,pbVar18,(ulong)uVar5);
    }
    else {
      if ((iVar3 == 0x20000) &&
         (puVar21 = *(undefined1 **)(param_3 + 0x10),
         uVar11 < (ushort)(*(ushort *)puVar21 << 8 | *(ushort *)puVar21 >> 8))) {
        uVar11 = *(ushort *)((long)puVar21 + (uVar6 + 1) * 2) << 8 |
                 *(ushort *)((long)puVar21 + (uVar6 + 1) * 2) >> 8;
        uVar6 = (ulong)uVar11;
        if (uVar11 < 0x102) goto LAB_00105459;
...
LAB_00105679:
            puVar21 = format1_names_msgidx;
            uVar9 = ~*(uint *)(format1_names_msgidx + (ulong)uVar11 * 4) +
                    *(int *)(format1_names_msgidx + (ulong)(uVar11 + 1) * 4);
            pbVar19 = (byte *)(".notdef" + *(uint *)(format1_names_msgidx + (ulong)uVar11 * 4));
          }
          else {
...
LAB_00105634:
          if (uVar9 != (uint)pcVar12) goto LAB_00105500;
          if (uVar9 == 0) goto LAB_0010511f;
          iVar3 = memcmp(pbVar19,pbVar18,(ulong)uVar9);
        }
        else {
joined_r0x001054d6:
          if (iVar3 != 0x20000) goto LAB_0010511f;
          pcVar12 = (char *)0x0;
          pbVar18 = (byte *)0x0;
LAB_001054e0:
          uVar10 = **(ushort **)(param_3 + 0x10);
          if ((uint)uVar11 < (uint)(ushort)(uVar10 << 8 | uVar10 >> 8)) {
            uVar11 = (*(ushort **)(param_3 + 0x10))[uVar11 + 1];
            uVar11 = uVar11 << 8 | uVar11 >> 8;
            if (uVar11 < 0x102) goto LAB_00105679;
            if (*(uint *)(param_3 + 0x1c) <= uVar11 - 0x102) goto LAB_001054f6;
            pbVar19 = (byte *)((ulong)*(uint *)(*(long *)(param_3 + 0x20) +
                                               (ulong)(uVar11 - 0x102) * 4) +
                              *(long *)(param_3 + 0x28));
            uVar9 = (uint)*pbVar19;
...
LAB_001054f6:
          if ((int)pcVar12 == 0) goto LAB_0010511f;
          uVar9 = 0;
LAB_00105500:
          iVar3 = uVar9 - (int)pcVar12;
        }
        puVar16 = puVar15;
        if (0 < iVar3) goto LAB_00104972;
      }
      else if (uVar9 == 0x20000) {
        uVar8 = **(ushort **)(param_3 + 0x10);
        uVar8 = uVar8 << 8 | uVar8 >> 8;
        pcVar12 = (char *)(ulong)uVar8;
        if ((uint)uVar8 <= (uint)uVar10) goto LAB_001054c1;
        uVar10 = (*(ushort **)(param_3 + 0x10))[(ulong)uVar10 + 1];
        iVar3 = *(int *)(param_3 + 8);
        uVar10 = uVar10 << 8 | uVar10 >> 8;
        pcVar12 = (char *)(ulong)uVar10;
        if (uVar10 < 0x102) {
          puVar21 = format1_names_msgidx;
          pcVar12 = (char *)(ulong)(~*(uint *)(format1_names_msgidx + (ulong)uVar10 * 4) +
                                   *(int *)(format1_names_msgidx + (ulong)(uVar10 + 1) * 4));
          pbVar18 = (byte *)(".notdef" + *(uint *)(format1_names_msgidx + (ulong)uVar10 * 4));
        }
        else {
          if (*(uint *)(param_3 + 0x1c) <= uVar10 - 0x102) {
            if (iVar3 != 0x10000) goto joined_r0x001054d6;
            goto LAB_00105625;
          }
          pbVar18 = (byte *)((ulong)*(uint *)(*(long *)(param_3 + 0x20) +
                                             (ulong)(uVar10 - 0x102) * 4) +
                            *(long *)(param_3 + 0x28));
          pcVar12 = (char *)(ulong)*pbVar18;
          pbVar18 = pbVar18 + 1;
        }
LAB_001054ab:
        if (iVar3 != 0x10000) {
          if (iVar3 == 0x20000) goto LAB_001054e0;
          goto LAB_001054f6;
        }
        goto LAB_00105629;
      }
LAB_0010511f:
    ...
    if ((uint)uVar10 < (uint)(ushort)(uVar8 << 8 | uVar8 >> 8)) {
      uVar10 = (*(ushort **)(param_3 + 0x10))
               [(long)((_func_int_void_ptr_void_ptr_void_ptr *)pcVar12 + 1)];
      iVar3 = *(int *)(param_3 + 8);
      uVar10 = uVar10 << 8 | uVar10 >> 8;
      uVar9 = (uint)uVar10;
      if (uVar10 < 0x102) {
        puVar21 = format1_names_msgidx;
        __n = (size_t)(~*(uint *)(format1_names_msgidx + (ulong)uVar9 * 4) +
                      *(int *)(format1_names_msgidx + (ulong)(uVar9 + 1) * 4));
        pbVar18 = (byte *)(".notdef" + *(uint *)(format1_names_msgidx + (ulong)uVar9 * 4));
      }
      else if (uVar9 - 0x102 < *(uint *)(param_3 + 0x1c)) {
...
LAB_001049d1:
    ...
    if (uVar9 == 0x10000) {
      ...
      if (*(uint *)(param_3 + 8) == 0x10000) {
        ...
        pbVar18 = (byte *)0x0;
LAB_00104a94:
        if (0x101 < uVar11) goto LAB_00104c70;
LAB_00104a9f:
        puVar21 = (undefined1 *)(ulong)((int)pcVar22 + 1);
        pcVar12 = ".notdef";
        pbVar19 = (byte *)(".notdef" + *(uint *)(format1_names_msgidx + (long)pcVar22 * 4));
        uVar5 = ~*(uint *)(format1_names_msgidx + (long)pcVar22 * 4) +
                *(int *)(format1_names_msgidx + (long)puVar21 * 4);
        if (uVar5 == uVar9) {
LAB_00104abf:
          if (uVar5 == 0) goto joined_r0x00104a6f;
          iVar3 = memcmp(pbVar19,pbVar18,(ulong)uVar5);
...
LAB_00104a60:
        ...
        if (iVar3 < 1) {
          if (iVar3 == 0) goto joined_r0x00104a6f;
          goto LAB_001049c4;
        }
LAB_00104ad2:
        puVar13 = puVar16;
        if (puVar15 < puVar16) {
          do {
            ...
            if (uVar9 == 0x10000) {
              if (uVar17 < 0x102) {
                pcVar12 = (char *)(ulong)(~*(uint *)(format1_names_msgidx + (ulong)uVar11 * 4) +
                                         *(int *)(format1_names_msgidx + (ulong)(uVar17 + 1) * 4));
...
LAB_00104d04:
                if (uVar5 < 0x102) {
LAB_00104cc0:
                  pbVar19 = (byte *)(".notdef" + *(uint *)(format1_names_msgidx + (ulong)uVar10 * 4)
                                    );
                  uVar9 = ~*(uint *)(format1_names_msgidx + (ulong)uVar10 * 4) +
                          *(int *)(format1_names_msgidx + (ulong)(uVar10 + 1) * 4);
                  if ((uint)pcVar12 != uVar9) goto LAB_00104baa;
LAB_00104ce4:
                  if ((int)pcVar12 == 0) goto LAB_00104afc;
...
LAB_00104d0b:
                if ((int)pcVar12 == 0) goto LAB_00104afc;
                if (0 < (int)pcVar12) goto LAB_00104bbc;
              }
              else {
LAB_00104b49:
                iVar3 = (int)pcVar12;
joined_r0x00104e11:
                if (iVar3 != 0x20000) goto LAB_00104afc;
                pcVar12 = (char *)0x0;
                pbVar18 = (byte *)0x0;
LAB_00104b55:
                uVar11 = **(ushort **)(param_3 + 0x10);
                if ((ushort)(uVar11 << 8 | uVar11 >> 8) <= uVar5) goto LAB_00104d0b;
                ...
                if (uVar11 < 0x102) {
                  ...
                  if (*(uint *)(param_3 + 0x1c) <= uVar11 - 0x102) goto LAB_00104d0b;
                  pbVar19 = (byte *)((ulong)*(uint *)(*(long *)(param_3 + 0x20) +
                                                     (ulong)(uVar11 - 0x102) * 4) +
                                    *(long *)(param_3 + 0x28));
                  uVar9 = (uint)*pbVar19;
                ...
                if ((uint)pcVar12 == uVar9) goto LAB_00104ce4;
LAB_00104baa:
                iVar3 = uVar9 - (int)pcVar12;
LAB_00104bac:
                if (iVar3 == 0) goto LAB_00104afc;
                if (iVar3 < 0) goto LAB_00104bbc;
              }
            }
            else {
              if (uVar9 == 0x20000) {
                ...
                if (uVar17 < (ushort)(uVar8 << 8 | uVar8 >> 8)) {
                  ...
                  if (uVar11 < 0x102) {
                    pbVar18 = (byte *)(".notdef" +
                                      *(uint *)(format1_names_msgidx + (ulong)uVar11 * 4));
                    pcVar12 = (char *)(ulong)(~*(uint *)(format1_names_msgidx + (ulong)uVar11 * 4) +
                                             *(int *)(format1_names_msgidx + (ulong)(uVar11 + 1) * 4
                                                     ));
                  }
                    ...
                    if (*(uint *)(param_3 + 0x1c) <= uVar11 - 0x102) {
                      if (iVar3 != 0x10000) goto joined_r0x00104e11;
                      goto LAB_00104cae;
                    }
                    pbVar18 = (byte *)((ulong)*(uint *)(*(long *)(param_3 + 0x20) +
                                                       (long)pcVar12 * 4) +
...
LAB_00104d48:
                  if (iVar3 != 0x10000) {
                    if (iVar3 == 0x20000) goto LAB_00104b55;
                    goto LAB_00104d0b;
                  }
                  goto LAB_00104d04;
                }
                pcVar12 = (char *)(ulong)*(uint *)(param_3 + 8);
                if (*(uint *)(param_3 + 8) != 0x10000) goto LAB_00104b49;
LAB_00104cae:
                if (uVar5 < 0x102) {
                  pcVar12 = (char *)0x0;
                  pbVar18 = (byte *)0x0;
...
LAB_00104a00:
      if ((int)pcVar12 != 0x20000) goto joined_r0x00104a6f;
      uVar9 = 0;
      pbVar18 = (byte *)0x0;
LAB_00104a0c:
      uVar10 = **(ushort **)(param_3 + 0x10);
      ...
      if ((uint)uVar11 < (uint)uVar10) {
        ...
        uVar11 = uVar11 << 8 | uVar11 >> 8;
        pcVar22 = (char *)(ulong)uVar11;
        if (uVar11 < 0x102) goto LAB_00104a9f;
        pcVar12 = pcVar22;
        if (uVar11 - 0x102 < *(uint *)(param_3 + 0x1c)) {
          pcVar12 = *(char **)(param_3 + 0x20);
          pbVar19 = (byte *)((ulong)*(uint *)(pcVar12 + (ulong)(uVar11 - 0x102) * 4) +
                            *(long *)(param_3 + 0x28));
          bVar1 = *pbVar19;
          uVar5 = (uint)bVar1;
          pbVar19 = pbVar19 + 1;
          if (bVar1 == uVar9) goto LAB_00104abf;
          goto LAB_00104a60;
        }
      }
LAB_00104c70:
      if (uVar9 == 0) goto joined_r0x00104a6f;
      if ((int)uVar9 < 0) goto LAB_00104ad2;
    }
    else {
      if (uVar9 == 0x20000) {
        uVar8 = **(ushort **)(param_3 + 0x10);
        if (uVar10 < (ushort)(uVar8 << 8 | uVar8 >> 8)) {
          ...
          if (uVar10 < 0x102) {
            ...
            if (*(uint *)(param_3 + 0x1c) <= uVar10 - 0x102) goto joined_r0x00104f61;
            pbVar18 = (byte *)((ulong)*(uint *)(*(long *)(param_3 + 0x20) +
                                               (ulong)(uVar10 - 0x102) * 4) +
                              *(long *)(param_3 + 0x28));
            uVar9 = (uint)*pbVar18;
...
LAB_00104c56:
          if ((int)pcVar12 != 0x10000) {
            if ((int)pcVar12 == 0x20000) goto LAB_00104a0c;
            goto LAB_00104c70;
          }
          goto LAB_00104a94;
        }
        ...
        pcVar12 = (char *)(ulong)uVar9;
joined_r0x00104f61:
        if (uVar9 != 0x10000) goto LAB_00104a00;
        if (uVar11 < 0x102) {
          uVar9 = 0;
          pbVar18 = (byte *)0x0;
          goto LAB_00104a9f;
...
LAB_001049c4:
  puVar15 = puVar15 + 1;
  if (puVar16 <= puVar15) goto LAB_00104e51;
  goto LAB_001049d1;
LAB_00104e51:
  uVar23 = (long)puVar16 - (long)puVar14;
  uVar20 = (long)local_40 - (long)local_58;
  uVar6 = (long)local_58 - (long)puVar16;
  param_1 = (void *)((long)local_40 - uVar6);
  uVar9 = (uint)CONCAT71((int7)((ulong)pcVar12 >> 8),uVar20 != 0) &
          (uint)CONCAT71((int7)(uVar6 >> 8),uVar6 != 0);
  pcVar12 = (char *)(ulong)uVar9;
  param_2 = uVar6 >> 1;
...
LAB_00104f1a:
  sort_r_simple<void*>
            (local_48,uVar23 >> 1,param_3,(_func_int_void_ptr_void_ptr_void_ptr *)pcVar12,puVar21);
  local_48 = (ushort *)param_1;
  puVar16 = (ushort *)param_1;
  if (param_2 < 10) goto joined_r0x001051a7;
  goto LAB_00104936;
}
...
Subrs * CFF::StructAtOffsetOrNull<CFF::Subrs<OT::IntType<unsigned_short,2u>>>
                  (void *param_1,int param_2,hb_sanitize_context_t *param_3)

{
  ...
  if (param_2 != 0) {
    ...
    if ((pSVar1 + -*(long *)(param_3 + 8) <= (Subrs *)(ulong)*(uint *)(param_3 + 0x18)) &&
       (pSVar1 + (2 - *(long *)(param_3 + 8)) <= (Subrs *)(ulong)*(uint *)(param_3 + 0x18))) {
            ...
            *(int *)(param_3 + 0x1c) = iVar6;
            if (0 < iVar6) {
              ...
              if (SVar2 == (Subrs)0x3) {
                ...
                uVar8 = (uint)(byte)*pSVar5 * 0x10000 + (uint)(byte)pSVar5[1] * 0x100 +
                        (uint)(byte)pSVar5[2];
              }
                ...
                uVar8 = (uint)(ushort)(*(ushort *)(pSVar5 + uVar4 * 2) << 8 |
                                      *(ushort *)(pSVar5 + uVar4 * 2) >> 8);
              }
              else {
                uVar8 = (uint)(byte)pSVar5[uVar4];
              }
              if ((((ulong)((long)(pSVar1 + (uVar7 + 2)) - *(long *)(param_3 + 8)) <=
                    (ulong)*(uint *)(param_3 + 0x18)) &&
                  (uVar8 <= (uint)((int)*(undefined8 *)(param_3 + 0x10) -
                                  (int)(pSVar1 + (uVar7 + 2))))) &&
                 (*(uint *)(param_3 + 0x1c) = iVar6 - uVar8, 0 < (int)(iVar6 - uVar8))) {
                return pSVar1;
              }
            }
          }
...
/* hb_draw_funcs_t::emit_close_path(void*, hb_draw_state_t&) */

void hb_draw_funcs_t::emit_close_path(void *param_1,hb_draw_state_t *param_2)

{
                    /* WARNING: Could not recover jumptable at 0x00105b95. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
void __thiscall
hb_draw_funcs_t::start_path(hb_draw_funcs_t *this,void *param_1,hb_draw_state_t *param_2)

{
  ...
  (**(code **)(this + 0x10))
            (*(undefined4 *)(param_2 + 0xc),*(undefined4 *)(param_2 + 0x10),this,param_1,param_2,
             plVar1);
...
OT::ItemVariationStore::get_delta
          (ItemVariationStore *this,uint param_1,uint param_2,int *param_3,uint param_4,
          float *param_5)

{
  ...
  if (uVar4 != 0) {
    pIVar21 = this + (uVar4 >> 0x18 | (uVar4 & 0xff0000) >> 8 | (uVar4 & 0xff00) << 8 |
                     uVar4 << 0x18);
  }
  uVar4 = *(uint *)(this + 2);
  pIVar16 = (ItemVariationStore *)&_hb_NullPool;
  if (uVar4 != 0) {
    pIVar16 = this + (uVar4 >> 0x18 | (uVar4 & 0xff0000) >> 8 | (uVar4 & 0xff00) << 8 |
                     uVar4 << 0x18);
  }
  if (param_2 < (ushort)(*(ushort *)pIVar21 << 8 | *(ushort *)pIVar21 >> 8)) {
    ...
    if ((short)uVar17 < 0) {
      ...
      if (uVar8 == 0) {
        ...
        lVar19 = 0;
        do {
          uVar17 = *(ushort *)(pIVar21 + lVar19 * 2 + 6) << 8 |
                   *(ushort *)(pIVar21 + lVar19 * 2 + 6) >> 8;
          if ((uint)uVar17 < (uint)(ushort)(uVar3 << 8 | uVar3 >> 8)) {
            if (param_5 == (float *)0x0) {
              ...
              if (uVar12 != 0) {
LAB_00105e56:
                pIVar9 = pIVar16 + (ulong)(uVar17 * uVar12) * 6 + 4;
                uVar20 = 0;
                fVar27 = _LC3;
                do {
                  ...
                  if ((uint)uVar20 < param_4) {
                    ...
                    if ((uVar17 != 0) && (iVar2 != iVar18)) {
                      if (iVar2 != 0) {
                        ...
                        if (((iVar18 < iVar7) || (iVar13 < iVar18)) ||
                           (((short)uVar17 < 0 && (0 < (short)uVar15)))) goto LAB_00105eee;
...
LAB_00105f0d:
                  ...
                  else if (uVar17 != 0) goto LAB_00105f0d;
LAB_00105eee:
                  uVar20 = uVar20 + 1;
                  pIVar9 = pIVar9 + 6;
                } while (uVar11 != uVar20);
                if (param_5 != (float *)0x0) goto LAB_00105f5e;
              }
            }
            else {
...
LAB_00105f1e:
          ...
          auVar26._0_4_ =
               auVar26._0_4_ +
               fVar27 * (float)(int)(uVar12 >> 0x18 | (uVar12 & 0xff0000) >> 8 |
                                     (uVar12 & 0xff00) << 8 | uVar12 << 0x18);
    ...
    if (uVar6 < uVar12) {
      ...
      lVar19 = uVar20 * -2;
      do {
        uVar8 = *(ushort *)(pIVar21 + uVar20 * 2 + 6) << 8 |
                *(ushort *)(pIVar21 + uVar20 * 2 + 6) >> 8;
        if ((uint)uVar8 < (uint)(ushort)(uVar3 << 8 | uVar3 >> 8)) {
          if (param_5 == (float *)0x0) {
            ...
            if (uVar10 != 0) {
LAB_00106056:
              pIVar9 = pIVar16 + (ulong)(uVar8 * uVar10) * 6 + 4;
              uVar5 = 0;
              fVar27 = _LC3;
              do {
                ...
                if ((uint)uVar5 < param_4) {
                  ...
                  if ((uVar8 != 0) && (iVar2 != iVar18)) {
                    if (iVar2 != 0) {
                      ...
                      if (((iVar18 < iVar7) || (iVar13 < iVar18)) ||
                         (((short)uVar8 < 0 && (0 < (short)uVar11)))) goto LAB_001060f3;
                      if ((iVar7 < iVar2) && (iVar2 < iVar13)) {
                        if (iVar2 < iVar18) {
                          fVar28 = (float)(iVar2 - iVar7) / (float)(iVar18 - iVar7);
                        }
...
LAB_00106112:
                ...
                else if (uVar8 != 0) goto LAB_00106112;
LAB_001060f3:
                uVar5 = uVar5 + 1;
                pIVar9 = pIVar9 + 6;
              } while (uVar17 != uVar5);
              if (param_5 != (float *)0x0) goto LAB_0010615e;
            }
          }
          else {
...
LAB_00106123:
        ...
        auVar26._0_4_ =
             auVar26._0_4_ +
             fVar27 * (float)(int)(short)(*(ushort *)(pIVar14 + lVar1 + lVar19) << 8 |
                                         *(ushort *)(pIVar14 + lVar1 + lVar19) >> 8);
    ...
    if ((uint)uVar23 < uVar4) {
      ...
      uVar20 = 0;
      do {
        uVar8 = *(ushort *)(pIVar21 + uVar20 * 2 + uVar23 * 2 + 6) << 8 |
                *(ushort *)(pIVar21 + uVar20 * 2 + uVar23 * 2 + 6) >> 8;
        if ((uint)uVar8 < (uint)(ushort)(uVar3 << 8 | uVar3 >> 8)) {
          if (param_5 == (float *)0x0) {
            pfVar22 = (float *)0x0;
            uVar17 = *(ushort *)pIVar16 << 8 | *(ushort *)pIVar16 >> 8;
            ...
            if (uVar17 != 0) {
LAB_0010625b:
              pIVar9 = pIVar16 + (ulong)uVar6 * 6 + 4;
              uVar5 = 0;
              fVar27 = _LC3;
              do {
                uVar8 = *(ushort *)(pIVar9 + 2);
                if ((uint)uVar5 < param_4) {
                  ...
                  if ((uVar8 != 0) && (iVar2 != iVar18)) {
                    if (iVar2 != 0) {
                      ...
                      iVar13 = (int)(short)uVar11;
                      if (((iVar18 < iVar7) || (iVar13 < iVar18)) ||
                         (((short)uVar8 < 0 && (0 < (short)uVar11)))) goto LAB_001062f5;
                      if ((iVar7 < iVar2) && (iVar2 < iVar13)) {
                        if (iVar2 < iVar18) {
                          fVar28 = (float)(iVar2 - iVar7) / (float)(iVar18 - iVar7);
                        }
...
LAB_00106314:
                ...
                else if (uVar8 != 0) goto LAB_00106314;
LAB_001062f5:
                uVar5 = uVar5 + 1;
                pIVar9 = pIVar9 + 6;
              } while (uVar17 != uVar5);
              if (param_5 != (float *)0x0) goto LAB_00106359;
            }
          }
          else {
            pfVar22 = param_5 + uVar8;
...
/* OT::ItemVarStoreInstancer::TEMPNAMEPLACEHOLDERVALUE(unsigned int, unsigned short) const */

undefined8 __thiscall
OT::ItemVarStoreInstancer::operator()(ItemVarStoreInstancer *this,uint param_1,ushort param_2)

{
  ...
  if (pcVar2 == (char *)0x0) {
    ...
    if (*pcVar2 == '\0') {
      ...
      if ((*pcVar2 != '\x01') || (uVar6 = *(uint *)(pcVar2 + 2), uVar6 == 0)) goto LAB_00106746;
      uVar6 = uVar6 >> 0x18 | (uVar6 & 0xff0000) >> 8 | (uVar6 & 0xff00) << 8 | uVar6 << 0x18;
      if (uVar6 <= uVar7) {
        uVar7 = uVar6 - 1;
      }
...
LAB_00106746:
  if (*(uint *)(this + 0x18) != 0) {
    uVar11 = ItemVariationStore::get_delta
                       (*(ItemVariationStore **)this,(uint)(uVar8 >> 0x10),(uint)uVar8 & 0xffff,
                        *(int **)(this + 0x10),*(uint *)(this + 0x18),*(float **)(this + 0x20));
    return uVar11;
  }
  return 0;
}
...
/* WARNING: Type propagation algorithm not settling */
/* OT::ColorLine<OT::Variable>::static_get_color_stops(hb_color_line_t*, void*, unsigned int,
   unsigned int*, hb_color_stop_t*, void*) */

ushort OT::ColorLine<OT::Variable>::static_get_color_stops
                 (hb_color_line_t *param_1,void *param_2,uint param_3,uint *param_4,
                 hb_color_stop_t *param_5,void *param_6)
          ...
          *(undefined4 *)(param_5 + 4) = 1;
          ...
          if (uVar6 != 0xffff) {
            ...
            iVar2 = (**(code **)(lVar1 + 0x78))
                              (lVar1,*(undefined8 *)((long)param_6 + 0x18),uVar6,local_48,lVar9);
            if (iVar2 == 0) {
              local_48[1] = 1;
              uVar3 = hb_font_get_face(*(undefined8 *)((long)param_6 + 0x20));
              hb_ot_color_palette_get_colors
                        (uVar3,*(undefined4 *)((long)param_6 + 0x28),uVar6,local_48 + 1,local_48);
            }
            *(undefined4 *)(param_5 + 4) = 0;
          }
          uVar10 = uVar10 + 1;
          *(uint *)(param_5 + 8) =
               local_48[0] & 0xffffff00 | (uint)(long)(fVar12 * (float)(local_48[0] & 0xff)) & 0xff;
...
/* WARNING: Type propagation algorithm not settling */
/* OT::ColorLine<OT::NoVariable>::static_get_color_stops(hb_color_line_t*, void*, unsigned int,
   unsigned int*, hb_color_stop_t*, void*) */

ushort OT::ColorLine<OT::NoVariable>::static_get_color_stops
                 (hb_color_line_t *param_1,void *param_2,uint param_3,uint *param_4,
                 hb_color_stop_t *param_5,void *param_6)
        ...
        while( true ) {
          ...
          *(undefined4 *)(param_5 + 4) = 1;
          ...
          if (uVar6 != 0xffff) {
            ...
            iVar2 = (**(code **)(lVar1 + 0x78))
                              (lVar1,*(undefined8 *)((long)param_6 + 0x18),uVar6,local_48,lVar8);
            if (iVar2 == 0) {
              local_48[1] = 1;
              uVar3 = hb_font_get_face(*(undefined8 *)((long)param_6 + 0x20));
              hb_ot_color_palette_get_colors
          ...
          uVar9 = uVar9 + 1;
          *(uint *)(param_5 + 8) =
               local_48[0] & 0xffffff00 | (uint)(long)(fVar11 * (float)(local_48[0] & 0xff)) & 0xff;
    ...
    do {
      while( true ) {
        ...
        if ((ushort)(uVar1 << 8 | uVar1 >> 8) == uVar2) {
          if (uVar7 == 0xffff) goto LAB_00107a25;
          uVar2 = *(ushort *)(pcVar4 + 2);
          if ((ushort)((uVar7 >> 8) << 8 | uVar7 & 0xff) < (ushort)(uVar2 << 8 | uVar2 >> 8)) break;
          if ((ushort)(uVar7 << 8 | uVar7 >> 8) == uVar2) goto LAB_00107a25;
        }
        iVar5 = uVar3 + 1;
        if (iVar6 < iVar5) goto LAB_00107a49;
      }
      iVar6 = uVar3 - 1;
    } while (iVar5 <= iVar6);
LAB_00107a49:
...
LAB_00107ab8:
        iVar6 = uVar2 - 1;
        if (iVar6 < iVar5) goto joined_r0x00107b23;
      }
      if (uVar1 == 0x300) {
        if (*(ushort *)(pcVar4 + 2) != 0) goto LAB_00107ab8;
        uVar3 = *(uint *)(pcVar4 + 4);
        break;
      }
      iVar5 = uVar2 + 1;
      ...
      do {
        while( true ) {
          ...
          if (uVar1 == 0x300) {
            ...
            if (uVar1 == 0xa00) goto LAB_00107b81;
          }
          iVar5 = uVar3 + 1;
          if (iVar6 < iVar5) goto LAB_00107d63;
        }
        iVar6 = uVar3 - 1;
      } while (iVar5 <= iVar6);
LAB_00107d63:
      ...
      if (uVar3 == 0) {
        ...
        do {
          ...
          if ((*(short *)pcVar4 == 0) &&
            ...
            if (uVar1 == 0x600) goto LAB_00107bd2;
            iVar5 = uVar3 + 1;
          }
          else {
            iVar6 = uVar3 - 1;
        ...
        if (uVar3 == 0) {
          ...
          do {
            ...
            if ((*(short *)pcVar4 == 0) &&
              ...
              if (uVar1 == 0x400) goto LAB_00107c22;
              iVar5 = uVar3 + 1;
            }
            else {
              iVar6 = uVar3 - 1;
          ...
          if (uVar3 == 0) {
            ...
            do {
              ...
              if ((ushort)(uVar1 << 8 | uVar1 >> 8) < 4) {
                if (uVar1 == 0x300) {
                  uVar1 = *(ushort *)(pcVar4 + 2);
                  if (1 < (ushort)(uVar1 << 8 | uVar1 >> 8)) goto LAB_00107c34;
                  if (uVar1 == 0x100) goto LAB_00107c85;
                }
                iVar5 = uVar3 + 1;
              }
              else {
            ...
            if (uVar3 == 0) {
              ...
              do {
                ...
                if ((*(short *)pcVar4 == 0) &&
                  ...
                  if (uVar1 == 0x300) goto LAB_00107cce;
                  iVar5 = uVar3 + 1;
                }
                else {
                  iVar7 = uVar3 - 1;
      ...
      if (*pHVar5 == (HVARVVAR)0x0) {
        ...
        if ((ulong)((long)pHVar1 - *(long *)(param_1 + 8)) <= (ulong)*(uint *)(param_1 + 0x18)) {
          if (((ulong)((long)pHVar1 - *(long *)(param_1 + 8)) <= (ulong)*(uint *)(param_1 + 0x18))
            ...
            *(int *)(param_1 + 0x1c) = iVar6;
joined_r0x001081dc:
            if (0 < iVar6) goto LAB_00107f89;
          }
        }
      }
      else {
        if (*pHVar5 != (HVARVVAR)0x1) goto LAB_00107f89;
        pHVar1 = pHVar5 + 6;
        if ((ulong)((long)pHVar1 - *(long *)(param_1 + 8)) <= (ulong)*(uint *)(param_1 + 0x18)) {
          uVar4 = *(uint *)(pHVar5 + 2);
...
LAB_0010813d:
            ...
            *(uint *)(param_1 + 0x1c) = iVar6 - uVar4;
            if (0 < (int)(iVar6 - uVar4)) goto LAB_00107fa4;
          }
        }
      }
      else {
        if (*pHVar5 != (HVARVVAR)0x1) goto LAB_00107fa4;
        pHVar1 = pHVar5 + 6;
        if ((ulong)((long)pHVar1 - *(long *)(param_1 + 8)) <= (ulong)*(uint *)(param_1 + 0x18)) {
          uVar4 = *(uint *)(pHVar5 + 2);
          lVar2 = (ulong)(((byte)pHVar5[1] >> 4 & 3) + 1) *
...
LAB_00107fa4:
  ...
  if (*pHVar5 == (HVARVVAR)0x0) {
    ...
    if (((ulong)*(uint *)(param_1 + 0x18) < (ulong)((long)pHVar1 - *(long *)(param_1 + 8))) ||
       (uVar4 = (((byte)pHVar5[1] >> 4 & 3) + 1) *
                (uint)(ushort)(*(ushort *)(pHVar5 + 2) << 8 | *(ushort *)(pHVar5 + 2) >> 8),
       (uint)((int)*(undefined8 *)(param_1 + 0x10) - (int)pHVar1) < uVar4)) goto LAB_00108265;
  }
  else {
...

{
  ...
  if (*pVVar6 == (VVAR)0x0) {
    ...
    if (((ulong)*(uint *)(param_1 + 0x18) < (ulong)((long)pVVar1 - *(long *)(param_1 + 8))) ||
       ...
       (uint)((int)*(undefined8 *)(param_1 + 0x10) - (int)pVVar1) < uVar4)) goto LAB_00108410;
...
LAB_001086f3:
  *(undefined **)this = puVar6;
  ...
  iVar4 = (uint)(ushort)(*puVar11 << 8 | *puVar11 >> 8) * 0x10000 +
          (uint)(ushort)(puVar11[1] << 8 | puVar11[1] >> 8);
  if ((iVar4 != 0) && (iVar4 = *(int *)(param_1 + 0x18), iVar4 == -1)) {
        ...
        while (piVar14 = piVar13,
              *(short *)(puVar17 +
                        ...
                        (ulong)(uVar2 >> 0x18 | (uVar2 & 0xff0000) >> 8 | (uVar2 & 0xff00) << 8 |
                               uVar2 << 0x18) + uVar16 * 2) == 0) {
LAB_001087e7:
          lVar7 = lVar7 + 1;
          if ((uint)uVar10 <= (uint)lVar7) goto LAB_00108808;
        }
        iVar5 = (int)lVar7;
        if (iVar12 != -1) {
          bVar20 = iVar4 != -1;
          iVar4 = iVar5;
          if (bVar20) goto LAB_00108828;
          goto LAB_001087e7;
        }
        lVar7 = lVar7 + 1;
        iVar12 = iVar5;
  ...
  if (puVar4 + 1 < puVar11) {
    ...
    do {
      ...
      if ((bVar1 & 8) == 0) {
        ...
        if (puVar11 <= puVar7) goto LAB_00108a50;
        puVar7 = puVar4 + 1;
...

{
  ...
  if (uVar10 < uVar14) {
    if (0x15555555 < uVar14) goto LAB_00108aeb;
...
LAB_00108bae:
    ...
    uVar10 = *(uint *)param_1;
    if (uVar10 < uVar14) goto LAB_00108aeb;
...
LAB_00108cac:
  ...
  while (puVar9 = puVar7, uVar10 < uVar16) {
    ...
    *(byte *)pfVar8 = bVar1;
    puVar7 = puVar4;
    pfVar8 = pfVar8 + 3;
    if ((bVar1 & 8) != 0) goto LAB_00108e40;
  }
  iVar20 = 0;
  pfVar8 = pfVar6 + uVar17 * 3;
  pfVar13 = pfVar6;
  if (pfVar8 == pfVar6) goto LAB_00108f0f;
  do {
    fVar2 = pfVar13[2];
    if (((uint)fVar2 & 2) == 0) {
      puVar7 = puVar9;
  ...
  do {
    ...
    if (((uint)fVar2 & 4) == 0) {
      ...
      if (((uint)fVar2 & 0x20) == 0) {
        puVar9 = puVar7 + 1;
        if (puVar19 < puVar9) goto LAB_00108f14;
...
LAB_00108e40:
  ...
  if (uVar10 < uVar14) {
    uVar18 = (ulong)uVar10;
    iVar20 = uVar14 - uVar10;
    pfVar8 = pfVar6 + uVar18 * 3 + 2;
    do {
      *(byte *)pfVar8 = bVar1;
      pfVar8 = pfVar8 + 3;
      uVar10 = uVar14;
    } while (pfVar6 + ((iVar20 - 1) + uVar18) * 3 + 5 != pfVar8);
  }
  goto LAB_00108cac;
}
...
/* CFF::Encoding::sanitize(hb_sanitize_context_t*) const */

undefined4 __thiscall CFF::Encoding::sanitize(Encoding *this,hb_sanitize_context_t *param_1)

{
  ...
  if (0 < iVar3) {
    ...
    pEVar1 = pEVar4 + 1;
    if ((((ulong)((long)pEVar1 - *(long *)(param_1 + 8)) <= uVar6) &&
        ((ulong)((long)pEVar1 - *(long *)(param_1 + 8)) <= (ulong)*(uint *)(param_1 + 0x18))) &&
       (uVar5 = (uint)(byte)*pEVar4 + (uint)(byte)*pEVar4 * 2,
       uVar5 <= (uint)((int)*(undefined8 *)(param_1 + 0x10) - (int)pEVar1))) {
...
/* CFF::Charset::sanitize(hb_sanitize_context_t*, unsigned int*) const */

bool __thiscall CFF::Charset::sanitize(Charset *this,hb_sanitize_context_t *param_1,uint *param_2)

{
  ...
  if (CVar2 == (Charset)0x1) {
    uVar8 = 0;
    uVar7 = 0;
    for (uVar6 = *(int *)(param_1 + 0x38) - 1; uVar6 != 0;
        uVar6 = uVar6 - ((byte)this[lVar3 + 3] + 1)) {
      lVar3 = uVar8 * 3;
      if ((Charset *)(ulong)*(uint *)(param_1 + 0x18) <
          this + ((lVar3 + 4) - *(long *)(param_1 + 8))) {
        return false;
      }
    ...
    for (uVar6 = *(int *)(param_1 + 0x38) - 1; uVar6 != 0; uVar6 = uVar6 - uVar4) {
      if ((Charset *)(ulong)*(uint *)(param_1 + 0x18) <
          this + ((uVar8 * 4 + 5) - *(long *)(param_1 + 8))) {
        return false;
      }
      uVar4 = (ushort)(*(ushort *)(this + uVar8 * 4 + 3) << 8 |
                      *(ushort *)(this + uVar8 * 4 + 3) >> 8) + 1;
      if (uVar6 < uVar4) {
        return false;
      }
      uVar7 = (int)uVar8 + 1;
    ...
    if (iVar3 != 0x10000) {
      if (iVar3 == 0x20000) {
        if (((0x21 < uVar10) &&
            ...
            uVar4 * 2 <= uVar10 - 0x22)) && (0 < (int)(uVar5 + uVar4 * -2))) goto LAB_001096a0;
        iVar3 = (uint)(ushort)(*puVar11 << 8 | *puVar11 >> 8) * 0x10000 +
                (uint)(ushort)(puVar11[1] << 8 | puVar11[1] >> 8);
      }
      if (iVar3 != 0x30000) goto LAB_001094d8;
    }
LAB_001096a0:
    hb_blob_destroy(lVar7);
    hb_blob_make_immutable(puVar6);
          ...
          *(uint *)(this + 0x1c) = uVar10;
          ...
          if (-1 < (int)uVar5) {
            ...
            if (uVar5 < uVar10 + 1) {
              ...
              if (pvVar9 == (void *)0x0) {
                if (uVar5 <= *(uint *)(this + 0x18)) goto LAB_001095c8;
                *(uint *)(this + 0x18) = ~*(uint *)(this + 0x18);
                goto LAB_00109745;
              }
              *(void **)(this + 0x20) = pvVar9;
...
/* OT::post::accelerator_t::get_glyph_from_name(char const*, int, unsigned int*) const */

undefined8 OT::post::accelerator_t::get_glyph_from_name(char *param_1,int param_2,uint *param_3)

{
  ...
  if (uVar17 != 0) {
    ...
    while (__ptr = (void *)*plVar1, __ptr == (void *)0x0) {
      uVar16 = (ulong)uVar10;
      ...
      uVar11 = 0;
      do {
        *(short *)((long)__ptr + uVar11 * 2) = (short)uVar11;
        uVar11 = uVar11 + 1;
      } while (uVar16 != uVar11);
    ...
    do {
      ...
      uVar7 = *puVar12;
      if (*(int *)(param_1 + 8) == 0x10000) {
        if (0x101 < uVar7) goto LAB_0010983b;
        uVar4 = *(uint *)(format1_names_msgidx + (ulong)uVar7 * 4);
        uVar9 = (uint)uVar7;
LAB_00109882:
        uVar9 = ~uVar4 + *(int *)(format1_names_msgidx + (ulong)(uVar9 + 1) * 4);
...
LAB_00109843:
        ...
        if ((*(int *)(param_1 + 8) == 0x20000) &&
           (uVar3 = **(ushort **)(param_1 + 0x10), uVar7 < (ushort)(uVar3 << 8 | uVar3 >> 8))) {
          ...
          if (uVar9 - 0x102 < *(uint *)(param_1 + 0x1c)) {
            pbVar13 = (byte *)((ulong)*(uint *)(*(long *)(param_1 + 0x20) +
                                               (ulong)(uVar9 - 0x102) * 4) +
                              *(long *)(param_1 + 0x28));
            uVar9 = (uint)*pbVar13;
            pbVar13 = pbVar13 + 1;
...
LAB_0010983b:
        if (-1 < (int)uVar17) goto LAB_00109843;
LAB_001098d8:
        iVar14 = uVar10 - 1;
      }
    } while (iVar15 <= iVar14);
...
LAB_00109c22:
                  if ((uVar8 <= (uint)((int)*(undefined8 *)(param_1 + 0x10) - (int)pCVar1)) &&
                     ...
                     0 < (int)(iVar7 - uVar8))) goto LAB_00109b44;
                }
                goto LAB_00109c3f;
              }
              pCVar12 = (CBLC *)(ulong)*(uint *)(param_1 + 0x18);
              if (sVar2 == 0x300) {
                if ((pCVar1 + -lVar16 <= pCVar12) &&
                   (iVar7 = iVar7 + 2, uVar8 = iVar7 * 2, -1 < iVar7)) goto LAB_00109c22;
                goto LAB_00109c3f;
              }
            }
LAB_00109b44:
...
ulong __thiscall
OT::CBDT::accelerator_t::get_extents
...

{
  ...
  if (uVar17 != 0) {
    ...
    if ((*(uint *)(param_1 + 0x6c) <= uVar7) && (uVar17 = 0x40000000, uVar7 != 0)) {
      uVar17 = uVar7;
    }
    puVar16 = puVar18 + 8;
    if (*(int *)(puVar18 + 4) == 0) {
...
LAB_0010a000:
          ...
          uVar20 = uVar21;
          uVar8 = uVar13;
          if (uVar22 == uVar10 + 1) goto LAB_0010a06f;
        }
        uVar4 = uVar17;
        if (uVar13 <= uVar17) {
          uVar4 = uVar13;
        ...
        if (uVar8 < uVar4) goto LAB_0010a000;
        puVar16 = puVar16 + 0x30;
        uVar5 = (ulong)(uVar10 + 1);
        uVar21 = uVar20;
...
LAB_0010a10d:
    ...
    do {
      ...
      in_R11 = (undefined *)
               CONCAT71((int7)((ulong)in_R11 >> 8),uVar8 <= param_2 && param_2 <= uVar10);
      if (uVar8 <= param_2 && param_2 <= uVar10) {
        uVar7 = puVar19[0xb];
        if (((((byte)uVar7 == 0) || (bVar1 = *(byte *)((long)puVar19 + 0x2d), bVar1 == 0)) ||
            (param_2 < uVar8)) || (uVar10 < param_2)) goto LAB_0010a10d;
        uVar22 = *(uint *)(puVar11 + 2);
        psVar12 = (short *)&_hb_NullPool;
        if (uVar22 != 0) {
          psVar12 = (short *)((long)(puVar14 +
                                    (uVar17 >> 0x18 | (uVar17 & 0xff0000) >> 8 |
                                     (uVar17 & 0xff00) << 8 | uVar17 << 0x18)) +
                             (ulong)(uVar22 >> 0x18 | (uVar22 & 0xff0000) >> 8 |
        ...
        if (*psVar12 == 0x100) {
          ...
          uVar17 = uVar17 >> 0x18 | (uVar17 & 0xff0000) >> 8 | (uVar17 & 0xff00) << 8 |
                   uVar17 << 0x18;
          if (uVar22 <= uVar17) goto LAB_0010a10d;
        }
        else {
          if (*psVar12 != 0x300) goto LAB_0010a10d;
          uVar15 = psVar12[(ulong)(uVar17 + 1) + 4] << 8 |
                   (ushort)psVar12[(ulong)(uVar17 + 1) + 4] >> 8;
          uVar6 = psVar12[(ulong)uVar17 + 4] << 8 | (ushort)psVar12[(ulong)uVar17 + 4] >> 8;
          uVar22 = (uint)uVar15;
          uVar17 = (uint)uVar6;
          if (uVar15 <= uVar6) goto LAB_0010a10d;
        }
        puVar16 = *(undefined **)(this + 8);
        uVar8 = *(uint *)(psVar12 + 2);
        uVar22 = uVar22 - uVar17;
        uVar17 = (uVar8 >> 0x18 | (uVar8 & 0xff0000) >> 8 | (uVar8 & 0xff00) << 8 | uVar8 << 0x18) +
                 uVar17;
        if (puVar16 == (undefined *)0x0) {
          puVar16 = &_hb_NullPool;
        }
        uVar8 = *(uint *)(puVar16 + 0x18);
        if ((uVar8 < uVar17) || (uVar8 - uVar17 < uVar22)) goto LAB_0010a10d;
        if (psVar12[1] == 0x1100) {
          if (uVar22 < 9) goto LAB_0010a10d;
          puVar14 = &_hb_NullPool;
          if (3 < uVar8) {
            puVar14 = *(undefined **)(puVar16 + 0x10);
          }
          ...
          *(ulong *)(param_3 + 8) = CONCAT44(-(uint)bVar3,(uint)bVar2);
          ...
          if ((psVar12[1] != 0x1200) || (uVar22 < 0xc)) goto LAB_0010a10d;
          puVar14 = &_hb_NullPool;
          if (3 < uVar8) {
            puVar14 = *(undefined **)(puVar16 + 0x10);
          }
        ...
        if ((float)((uint)fVar25 & _LC4) < _LC1) {
          fVar25 = (float)((uint)((float)(int)fVar25 -
                                 (float)(-(uint)(fVar25 < (float)(int)fVar25) & _LC3)) |
                          ~_LC4 & (uint)fVar25);
        }
      ...
      uVar22 = uVar22 + 1;
      puVar11 = puVar11 + 4;
    } while (uVar22 < (uVar7 >> 0x18 | (uVar7 & 0xff0000) >> 8 | (uVar7 & 0xff00) << 8 |
                      uVar7 << 0x18));
...
LAB_0010a560:
          ...
          uVar14 = uVar15;
          uVar10 = uVar9;
          if (uVar22 == uVar6 + 1) goto LAB_0010a5c9;
        }
        uVar12 = uVar20;
        if (uVar9 <= uVar20) {
          uVar12 = uVar9;
        }
        if (uVar10 < uVar12) goto LAB_0010a560;
        puVar18 = puVar18 + 0x30;
        uVar3 = (ulong)(uVar6 + 1);
        uVar15 = uVar14;
...
void __thiscall OT::Affine2x3::paint_glyph(Affine2x3 *this,hb_paint_context_t *param_1,uint param_2)

{
  ...
  ItemVarStoreInstancer::operator()(*(ItemVarStoreInstancer **)(param_1 + 0x30),param_2,5);
  ItemVarStoreInstancer::operator()(*(ItemVarStoreInstancer **)(param_1 + 0x30),param_2,4);
  ...
  ItemVarStoreInstancer::operator()(*(ItemVarStoreInstancer **)(param_1 + 0x30),param_2,1);
  fVar4 = (float)ItemVarStoreInstancer::operator()
                           (*(ItemVarStoreInstancer **)(param_1 + 0x30),param_2,0);
  uVar1 = *(uint *)this;
  plVar3 = *(long **)(lVar2 + 0x80);
  auVar5._4_12_ = SUB1612((undefined1  [16])0x0,4);
  auVar5._0_4_ = ((float)(int)(uVar1 >> 0x18 | (uVar1 & 0xff0000) >> 8 | (uVar1 & 0xff00) << 8 |
                              uVar1 << 0x18) + fVar4) * __LC12;
  if (plVar3 != (long *)0x0) {
    plVar3 = (long *)*plVar3;
  }
                    /* WARNING: Could not recover jumptable at 0x0010aaeb. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
LAB_0010ac00:
              ...
              *(undefined2 *)(pCVar5 + -3) = 0;
              ...
              if ((ClipList *)(ulong)*(uint *)(param_1 + 0x18) <
                  pCVar3 + (9 - *(long *)(param_1 + 8))) goto LAB_0010ac00;
            }
...
undefined8 __thiscall
OT::ClipList::get_extents
          (ClipList *this,uint param_1,hb_glyph_extents_t *param_2,ItemVarStoreInstancer *param_3)

{
  ...
  if (*pCVar5 == (ClipList)0x1) {
    ...
    if ((*(long *)param_3 != 0) && (*(int *)(param_3 + 0x18) != 0)) {
      uVar2 = *(uint *)(pCVar5 + 9);
      fVar7 = (float)ItemVarStoreInstancer::operator()
                               (param_3,uVar2 >> 0x18 | (uVar2 & 0xff0000) >> 8 |
                                        (uVar2 & 0xff00) << 8 | uVar2 << 0x18,0);
      fVar7 = fVar7 + _LC9;
      if ((float)((uint)fVar7 & _LC4) < _LC1) {
...
bool __thiscall
OT::sbix::accelerator_t::get_png_extents
          (accelerator_t *this,hb_font_t *param_1,uint param_2,hb_glyph_extents_t *param_3,
          bool param_4)

{
  ...
  if (*psVar8 != 0) {
    ...
    if (uVar2 != 0) {
      ...
      if ((*(uint *)(param_1 + 0x6c) <= uVar2) && (uVar15 = 0x40000000, uVar2 != 0)) {
        uVar15 = uVar2;
      }
      uVar2 = *(uint *)(psVar8 + 4);
      puVar3 = (ushort *)&_hb_NullPool;
      ...
      if (uVar21 < 2) {
        ...
        do {
          while( true ) {
            ...
            uVar1 = *(uint *)(puVar9 + 4);
            if (uVar6 < (uVar1 >> 0x18 | (uVar1 & 0xff0000) >> 8 | (uVar1 & 0xff00) << 8 |
                        uVar1 << 0x18)) {
              puVar12 = *(undefined **)this;
            ...
            if (uVar1 != 0) {
              puVar3 = (ushort *)
                       (puVar9 + (uVar1 >> 0x18 | (uVar1 & 0xff0000) >> 8 | (uVar1 & 0xff00) << 8 |
                                 uVar1 << 0x18));
            }
...
LAB_0010b0f8:
            ...
            uVar6 = uVar6 + 1;
            uVar2 = uVar1;
            if (uVar21 == uVar6) goto LAB_0010b173;
          }
          uVar13 = uVar15;
          if (uVar1 <= uVar15) {
            uVar13 = uVar1;
          }
          if (uVar2 < uVar13) goto LAB_0010b0f8;
          uVar6 = uVar6 + 1;
        } while (uVar21 != uVar6);
      }
LAB_0010b173:
    ...
    if (uVar17 != 0) {
      ...
      do {
        ...
        if (((uVar21 <= uVar15) || (uVar21 - uVar15 < 9)) ||
           ((uint)(*(int *)(puVar12 + 0x18) - iVar19) < uVar21)) break;
        ...
        if (uVar17 == 0) {
          ...
          if ((float)((uint)fVar22 & _LC4) < _LC1) {
            fVar22 = (float)((uint)((float)(int)fVar22 -
                                   (float)(-(uint)(fVar22 < (float)(int)fVar22) & _LC3)) |
                            ~_LC4 & (uint)fVar22);
          }
          fVar24 = (float)*(int *)(param_3 + 4) * fVar25 + _LC9;
          if ((float)((uint)fVar24 & _LC4) < _LC1) {
...
/* OT::sbix::accelerator_t::paint_glyph(hb_font_t*, unsigned int, hb_paint_funcs_t*, void*) const */

bool __thiscall
OT::sbix::accelerator_t::paint_glyph
...

{
  ...
  if (*psVar9 != 0) {
    ...
    if (uVar18 != 0) {
      ...
      uVar15 = *(uint *)(param_1 + 0x6c);
      if ((*(uint *)(param_1 + 0x6c) <= uVar18) && (uVar15 = 0x40000000, uVar18 != 0)) {
        uVar15 = uVar18;
      }
      ...
      if (uVar19 < 2) {
        ...
        do {
          while( true ) {
            ...
            if (uVar7 < (uVar3 >> 0x18 | (uVar3 & 0xff0000) >> 8 | (uVar3 & 0xff00) << 8 |
                        uVar3 << 0x18)) {
              puVar16 = *(undefined **)this;
...
LAB_0010b610:
            ...
            uVar7 = uVar7 + 1;
            uVar18 = uVar3;
            if (uVar19 == uVar7) goto LAB_0010b689;
          }
          uVar1 = uVar15;
          if (uVar3 <= uVar15) {
            uVar1 = uVar3;
          }
          if (uVar18 < uVar1) goto LAB_0010b610;
          uVar7 = uVar7 + 1;
        } while (uVar19 != uVar7);
      }
LAB_0010b689:
    ...
    if (*psVar4 != 0) {
      ...
      do {
        ...
        ;
        if (((uVar19 <= uVar15) || (uVar19 - uVar15 < 9)) ||
           ((uint)(*(int *)(puVar16 + 0x18) - iVar20) < uVar19)) break;
...
LAB_0010b768:
    ...
    if (((lVar13 != lVar6) &&
        (iVar17 = hb_font_get_glyph_extents(param_1,param_2,local_68), iVar17 != 0)) &&
       (cVar2 = get_png_extents(this,param_1,param_2,local_58,false), cVar2 != '\0')) {
      iVar17 = (**(code **)(param_3 + 0x48))
                         (*(undefined4 *)(param_1 + 0x48),param_3,param_4,lVar13,local_50,-local_4c,
                          0x706e6720);
      bVar21 = iVar17 != 0;
...
LAB_0010bcf3:
    ...
    if (param_1 == 0) {
      ...
      if ((param_1 >> 1) + param_1 < *(uint *)(this + 0x1c)) goto LAB_0010bc5d;
    ...
    if (uVar14 == 0) {
      pvVar4 = malloc(0xc);
      if (pvVar4 == (void *)0x0) goto LAB_0010bcef;
      iVar17 = 0;
      sVar18 = 0;
      iVar7 = 0xc;
      __size = 0xc;
...
LAB_0010bcef:
      ...
      if (iVar7 != 0) goto LAB_0010ba39;
    }
    uStack_c0 = _UNK_00120f38;
    uStack_c8 = __LC13;
    iVar7 = *(int *)(this + 0x1c);
    ...
    *(int *)(this + 0x1c) = iVar17;
    ...
    uStack_b8 = __LC14;
    uStack_b0 = _UNK_00120f48;
    uStack_a8 = __LC15;
    uStack_a0 = _UNK_00120f58;
    uStack_98 = __LC16;
    uStack_90 = _UNK_00120f68;
    uStack_88 = __LC17;
    uStack_80 = _UNK_00120f78;
    uStack_78 = __LC18;
    uStack_70 = _UNK_00120f88;
    uStack_68 = __LC19;
    uStack_60 = _UNK_00120f98;
    uStack_58 = __LC20;
    uStack_50 = _UNK_00120fa8;
    if ((int)uVar9 == 0x20) {
      uVar8 = 0x7fffffff;
    }
    else {
        ...
        if (((*(byte *)(piVar15 + 1) & 1) != 0) &&
          ...
          if ((bVar1 & 2) == 0) {
            ...
            *(int *)(this + 0x14) = iVar7 + 1;
            ...
            do {
              if (*piVar6 == iVar17) {
                if (uVar12 == 0xffffffff) goto LAB_0010bbbf;
                goto LAB_0010bbb4;
              }
...
LAB_0010bbbf:
              piVar6 = (int *)(lVar2 + lVar5);
              if ((*(byte *)(piVar6 + 1) & 2) == 0) goto LAB_0010bc9a;
...
undefined8 __thiscall
OT::CFFIndex<OT::IntType<unsigned_int,4u>>::sanitize
          (CFFIndex<OT::IntType<unsigned_int,4u>> *this,hb_sanitize_context_t *param_1)

{
  ...
  if ((CFFIndex<OT::IntType<unsigned_int,4u>> *)(ulong)*(uint *)(param_1 + 0x18) <
  ...
  if (uVar2 != 0) {
    ...
    if ((ulong)((long)pCVar4 - *(long *)(param_1 + 8)) <= (ulong)*(uint *)(param_1 + 0x18)) {
      CVar1 = this[4];
      if ((((byte)CVar1 - 1 < 4) &&
          (uVar3 = (uint)((ulong)uVar2 * (ulong)(byte)CVar1),
          (int)((ulong)uVar2 * (ulong)(byte)CVar1 >> 0x20) == 0)) &&
         (uVar3 <= (uint)((int)*(undefined8 *)(param_1 + 0x10) - (int)pCVar4))) {
        ...
        *(int *)(param_1 + 0x1c) = iVar7;
        if (0 < iVar7) {
          ...
          if (CVar1 == (CFFIndex<OT::IntType<unsigned_int,4u>>)0x3) {
            ...
            uVar6 = (uint)(byte)*pCVar4 * 0x10000 + (uint)(byte)pCVar4[1] * 0x100 +
                    (uint)(byte)pCVar4[2];
          }
            ...
            uVar6 = (uint)(ushort)(*(ushort *)(pCVar4 + uVar5 * 2) << 8 |
                                  *(ushort *)(pCVar4 + uVar5 * 2) >> 8);
          }
          else {
          ...
          if (((ulong)((long)pCVar4 - *(long *)(param_1 + 8)) <= (ulong)*(uint *)(param_1 + 0x18))
             && (uVar6 <= (uint)((int)*(undefined8 *)(param_1 + 0x10) - (int)pCVar4))) {
...
void CFF::dict_opset_t::process_op(uint param_1,interp_env_t *param_2)

{
  ...
  if (param_1 == 0x1d) {
    ...
    *(double *)piVar7 =
         (double)(int)((uint)bVar2 << 8 | (uint)bVar1 << 0x10 | (uint)bVar8 << 0x18 | (uint)bVar3);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* CFF::cff1_top_dict_opset_t::process_op(unsigned int, CFF::cff1_top_dict_interp_env_t&,
   CFF::cff1_top_dict_values_t&) */

void CFF::cff1_top_dict_opset_t::process_op
               (uint param_1,cff1_top_dict_interp_env_t *param_2,cff1_top_dict_values_t *param_3)
      ...
      *(uint *)(param_2 + 0x1024) = uVar12;
      if (param_1 == 0x124) {
        ...
        *(int *)(param_3 + 0x1c) = (int)*(double *)pcVar8;
        ...
        if (param_1 != 0x11) goto LAB_0010c7f1;
        if (*(uint *)(param_2 + 0x14) == 0) {
          __hb_CrapPool = __hb_NullPool;
          param_2[0x10] = (cff1_top_dict_interp_env_t)0x1;
          pcVar8 = (cff1_top_dict_interp_env_t *)&_hb_CrapPool;
...
LAB_0010c920:
        ...
        *(int *)(param_3 + 0x50) = iVar4;
        dVar7 = __hb_NullPool;
        if ((int)uVar5 == 0) goto LAB_0010c951;
...
LAB_0010c7f1:
  ...
  if (0xff < param_1) {
    ...
    if ((uVar5 & 0x10017e) == 0) {
      if ((uVar5 & 0x600001) != 0) goto switchD_0010c442_caseD_0;
      uVar12 = *(uint *)(param_2 + 0xc);
      *(uint *)(param_2 + 0x1024) = uVar12;
      if (param_1 != 0x107) goto LAB_0010c7f1;
      goto LAB_0010c5dd;
    }
    goto switchD_0010c442_caseD_5;
  }
...
LAB_0010c8a9:
  ...
  case 0xd:
  case 0xe:
switchD_0010c442_caseD_5:
    *(undefined4 *)(param_2 + 0x14) = 0;
    uVar12 = *(uint *)(param_2 + 0xc);
    break;
  default:
    goto switchD_0010c442_default;
  }
LAB_0010c48a:
  if (*(uint *)(param_2 + 8) < uVar12) {
    return;
  }
...
LAB_0010c9f3:
    ...
    uVar11 = uVar14;
    if (uVar10 <= uVar14) goto LAB_0010c4a6;
    do {
...
LAB_0010c9ee:
    ...
    if (pvVar6 == (void *)0x0) {
      uVar14 = *(uint *)(param_3 + 8);
      if (uVar14 < uVar11) goto LAB_0010c9ee;
...
/* CFF::FDSelect3_4<OT::IntType<unsigned short, 2u>, OT::IntType<unsigned char, 1u>
   >::sanitize(hb_sanitize_context_t*, unsigned int) const */

undefined2 __thiscall
CFF::FDSelect3_4<OT::IntType<unsigned_short,2u>,OT::IntType<unsigned_char,1u>>::sanitize
          (FDSelect3_4<OT::IntType<unsigned_short,2u>,OT::IntType<unsigned_char,1u>> *this,
...

{
  ...
  pFVar3 = this + 2;
  if (((((ulong)((long)pFVar3 - *(long *)(param_1 + 8)) <= (ulong)*(uint *)(param_1 + 0x18)) &&
       ((ulong)((long)pFVar3 - *(long *)(param_1 + 8)) <= (ulong)*(uint *)(param_1 + 0x18))) &&
      (uVar1 = *(ushort *)this << 8 | *(ushort *)this >> 8, uVar4 = (uint)uVar1 + (uint)uVar1 * 2,
      uVar4 <= (uint)((int)*(undefined8 *)(param_1 + 0x10) - (int)pFVar3))) &&
     (iVar2 = *(int *)(param_1 + 0x1c) - uVar4, *(int *)(param_1 + 0x1c) = iVar2, 0 < iVar2)) {
    ...
    if (uVar1 != 0) {
      ...
      do {
        ...
        if (*(uint *)(param_1 + 0x38) <=
            (uint)(ushort)(*(ushort *)(pFVar5 + -3) << 8 | *(ushort *)(pFVar5 + -3) >> 8)) {
          return 0;
        }
    ...
    if (*(short *)this != 0) {
      if (*(short *)this == 0) {
        pFVar3 = (FDSelect3_4<OT::IntType<unsigned_short,2u>,OT::IntType<unsigned_char,1u>> *)
                 &_hb_NullPool;
      }
      if (*(short *)pFVar3 == 0) {
        uVar1 = *(ushort *)this;
        ...
        if (1 < (ushort)(uVar1 << 8 | uVar1 >> 8)) {
          do {
            pFVar5 = (FDSelect3_4<OT::IntType<unsigned_short,2u>,OT::IntType<unsigned_char,1u>> *)
                     &_hb_NullPool;
            uVar1 = *(ushort *)this << 8 | *(ushort *)this >> 8;
            ...
            pFVar6 = (FDSelect3_4<OT::IntType<unsigned_short,2u>,OT::IntType<unsigned_char,1u>> *)
                     &_hb_NullPool;
            if (uVar4 < uVar1) {
              pFVar6 = pFVar3;
            }
            if ((ushort)(*(ushort *)pFVar6 << 8 | *(ushort *)pFVar6 >> 8) <=
                (ushort)(*(ushort *)pFVar5 << 8 | *(ushort *)pFVar5 >> 8)) {
              return 0;
            }
            uVar1 = *(ushort *)this;
            uVar4 = uVar4 + 1;
        ...
        if (pFVar3 + (5 - *(long *)(param_1 + 8)) <=
          ...
          return CONCAT11((char)uVar1,
                          *(uint *)(param_1 + 0x38) == (uint)(ushort)(uVar1 << 8 | uVar1 >> 8));
        }
      }
    }
  }
...
CFF::FDSelect3_4<OT::IntType<unsigned_int,4u>,OT::IntType<unsigned_short,2u>>::sanitize
          (FDSelect3_4<OT::IntType<unsigned_int,4u>,OT::IntType<unsigned_short,2u>> *this,
          hb_sanitize_context_t *param_1,uint param_2)

{
  ...
  if ((ulong)((long)pFVar4 - *(long *)(param_1 + 8)) <= (ulong)*(uint *)(param_1 + 0x18)) {
    ...
    uVar6 = (uint)bVar8;
    if ((((!bVar8) &&
         ((ulong)((long)pFVar4 - *(long *)(param_1 + 8)) <= (ulong)*(uint *)(param_1 + 0x18))) &&
        (uVar3 <= (uint)((int)*(undefined8 *)(param_1 + 0x10) - (int)pFVar4))) &&
       (iVar5 = *(int *)(param_1 + 0x1c) - uVar3, *(int *)(param_1 + 0x1c) = iVar5, 0 < iVar5)) {
      uVar3 = *(uint *)this;
      pFVar7 = this + 10;
      if (uVar3 != 0) {
      ...
      if (*(int *)this != 0) {
        if (*(int *)this == 0) {
          pFVar4 = (FDSelect3_4<OT::IntType<unsigned_int,4u>,OT::IntType<unsigned_short,2u>> *)
                   &_hb_NullPool;
        }
        if (*(int *)pFVar4 == 0) {
          uVar3 = *(uint *)this;
          ...
          if (1 < (uVar3 >> 0x18 | (uVar3 & 0xff0000) >> 8 | (uVar3 & 0xff00) << 8 | uVar3 << 0x18))
          {
            do {
              uVar3 = *(uint *)this;
              pFVar7 = (FDSelect3_4<OT::IntType<unsigned_int,4u>,OT::IntType<unsigned_short,2u>> *)
                       &_hb_NullPool;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* CFF::parsed_values_t<CFF::op_str_t>::add_op(unsigned int, CFF::byte_str_ref_t const&,
   CFF::op_str_t const&) */

void __thiscall
CFF::parsed_values_t<CFF::op_str_t>::add_op
          (parsed_values_t<CFF::op_str_t> *this,uint param_1,byte_str_ref_t *param_2,
          op_str_t *param_3)
...
LAB_0010cf89:
    ...
    uVar10 = uVar9;
    if (uVar6 <= uVar9) goto LAB_0010ced5;
    do {
...
LAB_0010cf84:
    ...
    if (pvVar5 == (void *)0x0) {
      uVar9 = *(uint *)(this + 8);
      if (uVar9 < uVar10) goto LAB_0010cf84;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* CFF::parsed_values_t<CFF::dict_val_t>::add_op(unsigned int, CFF::byte_str_ref_t const&,
   CFF::dict_val_t const&) */

void __thiscall
CFF::parsed_values_t<CFF::dict_val_t>::add_op
          (parsed_values_t<CFF::dict_val_t> *this,uint param_1,byte_str_ref_t *param_2,
          dict_val_t *param_3)
...
LAB_0010d099:
    ...
    uVar10 = uVar9;
    if (uVar6 <= uVar9) goto LAB_0010cfe5;
    do {
      uVar10 = (uVar10 >> 1) + 8 + uVar10;
    } while (uVar10 < uVar6);
    if (0xfffffff < uVar10) {
LAB_0010d094:
    ...
    if (pvVar5 == (void *)0x0) {
      uVar9 = *(uint *)(this + 8);
      if (uVar9 < uVar10) goto LAB_0010d094;
      uVar7 = (ulong)*(uint *)(this + 0xc);
      pvVar5 = *(void **)(this + 0x10);
      uVar6 = *(uint *)(this + 0xc) + 1;
    }
...
OT::CFFIndex<OT::IntType<unsigned_short,2u>>::operator[]
          (CFFIndex<OT::IntType<unsigned_short,2u>> *this,uint param_1)

{
  ...
  if (param_1 < (ushort)(*(ushort *)this << 8 | *(ushort *)this >> 8)) {
    ...
    if (CVar1 == (CFFIndex<OT::IntType<unsigned_short,2u>>)0x3) {
      ...
      if (uVar4 < uVar7) goto LAB_0010d1a8;
      ...
      if (CVar1 == (CFFIndex<OT::IntType<unsigned_short,2u>>)0x1) {
        ...
        if (CVar1 != (CFFIndex<OT::IntType<unsigned_short,2u>>)0x2) goto LAB_0010d1b0;
        uVar6 = *(ushort *)(this + (ulong)param_1 * 2 + 3) << 8 |
                *(ushort *)(this + (ulong)param_1 * 2 + 3) >> 8;
        uVar3 = *(ushort *)(this + (ulong)(param_1 + 1) * 2 + 3) << 8 |
                *(ushort *)(this + (ulong)(param_1 + 1) * 2 + 3) >> 8;
        uVar7 = (uint)uVar6;
        uVar4 = (uint)uVar3;
        if (uVar3 < uVar6) goto LAB_0010d1a8;
        uVar3 = *(ushort *)this << 8 | *(ushort *)this >> 8;
        uVar2 = (uint)uVar3;
        uVar8 = (uint)(ushort)(*(ushort *)(this + (ulong)uVar3 * 2 + 3) << 8 |
                              *(ushort *)(this + (ulong)uVar3 * 2 + 3) >> 8);
      }
    }
    else {
...
LAB_0010d1b0:
        auVar11._0_8_ =
             this + (((ushort)(*(ushort *)this << 8 | *(ushort *)this >> 8) + 1) * (uint)(byte)CVar1
                    + 2);
        auVar11._8_8_ = 0;
        return auVar11;
      }
...
undefined8 __thiscall
OT::cff1::accelerator_t::get_glyph_from_name
          (accelerator_t *this,char *param_1,int param_2,uint *param_3)
      ...
      if (iVar18 == 0) {
        ...
        do {
          ...
          if (pcVar5 == &_hb_NullPool) {
            ...
            if ((iVar18 != 0) || (0xe4 < uVar22)) goto LAB_0010d51b;
            ...
            if (cVar4 == '\x01') {
              ...
              if (cVar4 != '\x02') {
                if ((cVar4 == '\0') && (uVar22 != 0)) {
                  uVar21 = *(ushort *)(pcVar5 + (ulong)(uVar22 - 1) * 2 + 1) << 8 |
                           *(ushort *)(pcVar5 + (ulong)(uVar22 - 1) * 2 + 1) >> 8;
                  uVar22 = (uint)uVar21;
                  goto LAB_0010d5fd;
                }
LAB_0010d51b:
              ...
              if (uVar21 < uVar22) {
                do {
                  ...
                  uVar8 = (ulong)((int)uVar8 + 1);
                  lVar17 = uVar8 * 4;
                  uVar20 = (uint)(ushort)(*(ushort *)(pcVar5 + uVar8 * 4 + 3) << 8 |
                                         *(ushort *)(pcVar5 + uVar8 * 4 + 3) >> 8);
                } while (uVar20 < uVar22);
              }
            }
            uVar22 = (ushort)(*(ushort *)(pcVar5 + lVar17 + 1) << 8 |
                             *(ushort *)(pcVar5 + lVar17 + 1) >> 8) + uVar22;
            uVar21 = (ushort)uVar22;
LAB_0010d5fd:
            if (uVar22 < 0x187) {
              auVar23._8_4_ =
                   ~(&cff1_std_strings_msgidx)[uVar22] + (&cff1_std_strings_msgidx)[uVar22 + 1];
              auVar23._0_8_ = ".notdef" + (uint)(&cff1_std_strings_msgidx)[uVar22];
            }
            else {
              auVar23 = CFFIndex<OT::IntType<unsigned_short,2u>>::operator[]
                                  (*(CFFIndex<OT::IntType<unsigned_short,2u>> **)(this + 0x68),
                                   uVar22 - 0x187);
              if (auVar23._0_8_ == 0) {
                auVar23 = ZEXT812(0x10d284);
              }
            }
          }
LAB_0010d52b:
...
LAB_0010d53d:
            p_Var12 = *(_func_int_void_ptr_void_ptr **)(__ptr + 2);
            __ptr[1] = uVar11;
...
LAB_0010d95e:
      ...
      if (__ptr[1] != 0) {
        sort_r_simple<>(pvVar9,(ulong)__ptr[1],0x104230,p_Var12);
      }
      LOCK();
      lVar10 = *(long *)paVar1;
      if (lVar10 == 0) {
...
LAB_0010d347:
    ...
    if (-1 < (int)(uVar13 - uVar16)) {
      if (uVar13 != uVar16) goto LAB_0010d347;
      ...
      if (cVar4 == '\x02') {
        ...
        uVar20 = 0;
        uVar19 = 1;
        if (1 < uVar13) goto LAB_0010d742;
        goto LAB_0010d460;
      }
      if (cVar4 != '\0') goto LAB_0010d465;
      if (uVar22 == 0) goto LAB_0010d460;
      uVar15 = 1;
      if (1 < uVar13) goto LAB_0010d419;
      goto LAB_0010d460;
    }
LAB_0010d389:
    iVar18 = uVar22 - 1;
  ...
  while( true ) {
    ...
    uVar16 = (uint)(ushort)(*(ushort *)(pcVar5 + (ulong)uVar20 * 3 + 1) << 8 |
                           *(ushort *)(pcVar5 + (ulong)uVar20 * 3 + 1) >> 8);
  ...
  goto LAB_0010d460;
LAB_0010d742:
  uVar16 = (uint)(ushort)(*(ushort *)(pcVar5 + (ulong)uVar20 * 4 + 1) << 8 |
                         *(ushort *)(pcVar5 + (ulong)uVar20 * 4 + 1) >> 8);
  uVar11 = (uint)(ushort)(*(ushort *)(pcVar5 + (ulong)uVar20 * 4 + 3) << 8 |
                         *(ushort *)(pcVar5 + (ulong)uVar20 * 4 + 3) >> 8);
  if ((uVar22 < uVar16) || (uVar16 + uVar11 < uVar22)) goto LAB_0010d730;
  uVar16 = (uVar19 + uVar22) - uVar16;
LAB_0010d458:
  if (uVar16 != 0) goto LAB_0010d470;
  goto LAB_0010d460;
LAB_0010d730:
  uVar19 = uVar19 + 1 + uVar11;
  uVar20 = uVar20 + 1;
  if (uVar13 <= uVar19) goto LAB_0010d460;
  goto LAB_0010d742;
  while (uVar15 = uVar15 + 1, uVar15 != uVar13) {
LAB_0010d419:
    if (uVar22 == (ushort)(*(ushort *)(pcVar5 + uVar15 * 2 + -1) << 8 |
                          *(ushort *)(pcVar5 + uVar15 * 2 + -1) >> 8)) {
      uVar16 = (uint)uVar15;
      goto LAB_0010d470;
    }
  }
...
/* OT::hmtxvmtx<OT::hmtx, OT::hhea, OT::HVAR>::accelerator_t::get_advance_with_var_unscaled(unsigned
   int, hb_font_t*, float*) const */

ulong __thiscall
OT::hmtxvmtx<OT::hmtx,OT::hhea,OT::HVAR>::accelerator_t::get_advance_with_var_unscaled
          (accelerator_t *this,uint param_1,hb_font_t *param_2,float *param_3)
...
LAB_0010db1e:
  ...
  if (uVar3 != 0) {
    pcVar9 = puVar13 + (uVar3 >> 0x18 | (uVar3 & 0xff0000) >> 8 | (uVar3 & 0xff00) << 8 |
                       uVar3 << 0x18);
  }
  if (*pcVar9 == '\0') {
    uVar2 = *(ushort *)(pcVar9 + 2) << 8 | *(ushort *)(pcVar9 + 2) >> 8;
    if (uVar2 == 0) goto LAB_0010da6d;
    if (uVar2 <= param_1) {
      param_1 = uVar2 - 1;
    }
    bVar6 = pcVar9[1];
    ...
    if ((*pcVar9 != '\x01') || (uVar3 = *(uint *)(pcVar9 + 2), uVar3 == 0)) goto LAB_0010da6d;
    uVar3 = uVar3 >> 0x18 | (uVar3 & 0xff0000) >> 8 | (uVar3 & 0xff00) << 8 | uVar3 << 0x18;
    if (uVar3 <= param_1) {
      param_1 = uVar3 - 1;
    }
...
LAB_0010da6d:
  ...
  fVar14 = (float)ItemVariationStore::get_delta
                            (this_00,param_1 >> 0x10,param_1 & 0xffff,*(int **)(param_2 + 0x80),
                             *(uint *)(param_2 + 0x78),param_3);
  fVar14 = fVar14 + _LC9;
  if ((float)((uint)fVar14 & _LC4) < _LC1) {
    fVar14 = (float)((uint)((float)(int)fVar14 -
                           (float)(-(uint)(fVar14 < (float)(int)fVar14) & _LC3)) |
                    ~_LC4 & (uint)fVar14);
  }
...
LAB_0010e088:
        ...
        if (pvVar7 != (void *)0x0) {
          ...
          *(uint *)(param_2 + 4) = uVar15;
          goto joined_r0x0010de76;
        }
        uVar11 = *(uint *)param_2;
        if (uVar11 < uVar14) goto LAB_0010e088;
      }
      *(uint *)(param_2 + 4) = uVar15;
    }
joined_r0x0010de76:
...

{
  ...
  local_b8 = param_5;
  local_b0 = param_6;
  if (*(uint *)(param_1 + 1) <= param_2) goto LAB_0010e230;
...
LAB_0010eaa1:
    ...
    uVar28 = (uVar28 >> 0x18 | (uVar28 & 0xff0000) >> 8 | (uVar28 & 0xff00) << 8 | uVar28 << 0x18) +
             uVar29;
    if (*(uint *)(puVar34 + 0x18) < uVar28) goto LAB_0010eaa1;
    ...
    local_160 = local_168;
    if (uVar49 < 4) goto LAB_0010eaa1;
  }
  uVar15 = *(ushort *)local_168;
  if (uVar15 == 0) goto LAB_0010e230;
  ...
  if ((short)(uVar15 << 8 | uVar15 >> 8) < 0) {
    ...
    if ((((uVar15 << 8 & 0xfff) == 0 && uVar15 >> 8 == 0) || (local_168 + 4 < local_160)) ||
       (local_160 + uVar59 < local_168 + 4)) goto LAB_0010e230;
    local_c4 = 0;
    local_110 = 0;
LAB_0010e37a:
...
LAB_0010e650:
              do {
                ...
                if (iVar19 != 0) {
                  ...
                  if (iVar19 != iVar12) {
                    if ((uVar28 & 0x4000) == 0) {
                      if (iVar12 == 0) goto LAB_0010eade;
                      if ((short)uVar16 < 0) {
                        if (iVar12 < iVar19) goto LAB_0010eade;
                        iVar42 = 0;
                      }
                      else {
                        iVar42 = iVar19;
                      ...
                      if (iVar42 < iVar12) goto LAB_0010eade;
                      ...
                      if (((iVar19 <= iVar51) && (iVar42 <= iVar19)) &&
                        ...
                        if ((iVar12 < iVar42) || (iVar51 < iVar12)) goto LAB_0010eade;
                        if (iVar12 < iVar19) {
              ...
              fVar4 = (float)dVar62;
              if ((float)dVar62 == 0.0) goto LAB_0010eade;
            }
            pIVar43 = (IntType *)&_hb_NullPool;
            ...
            if (((local_160 <= pIVar43) && (pIVar43 <= local_e0)) &&
              ...
              if (local_10c == 0) {
                ...
                pvVar56 = pvVar22;
                if (param_7 == '\0') {
                  if (uVar29 * 0xc == 0) goto LAB_0010e765;
...
LAB_0010f583:
                      ...
                      pvVar60 = local_80;
                      if (bVar61 == false) goto LAB_0010f3eb;
                      uVar59 = 0;
                      if (uVar29 != 0) goto LAB_0010f590;
LAB_0010f404:
                      if (fVar4 != _LC3) {
                        if (uVar31 == 0) goto LAB_0010e969;
LAB_0010f44f:
                        lVar21 = 0;
                        do {
                      ...
                      if (uVar31 != 0) goto LAB_0010e8e4;
                    }
                    else {
                      if (bVar61 != false) {
                        if (param_7 != '\0') goto LAB_0010f583;
                        uVar59 = 0;
                        if (uVar29 == 0) goto LAB_0010f404;
LAB_0010f590:
...
LAB_0010f3eb:
                        sVar35 = (size_t)(uVar29 * 0xc);
                        pvVar22 = pvVar56;
                        if (uVar29 * 0xc == 0) goto LAB_0010f404;
                      }
                      else {
LAB_0010e890:
                        sVar35 = 0x30;
...
LAB_0010e8e4:
                      ...
                      else if (uVar31 != 0) goto LAB_0010f44f;
LAB_0010e95b:
                      if (param_7 != '\0') goto LAB_0010ed64;
                    }
LAB_0010e969:
                    uVar59 = (ulong)local_d0;
                    if (local_d0 == 0) {
                      if (uVar29 == 0) {
                        if (-1 < (int)local_108) goto LAB_0010ed64;
                      }
                      else {
                        uVar28 = 0;
...
LAB_0010f730:
                                ...
                                uVar28 = uVar28 + 1;
                                pcVar58 = pcVar58 + 0xc;
                                if (uVar29 == uVar28) goto LAB_0010e9ee;
                                goto LAB_0010e9ad;
                              }
                              if (local_108 < uVar30) {
                                do {
                        ...
                        if (-1 < (int)local_108) goto LAB_0010ecba;
                      }
LAB_0010e9ee:
                      local_118 = (uint)local_58;
                      local_148 = (uint)local_68;
...
LAB_0010f068:
                            ...
                            if ((cVar54 != '\0') && (uVar23 = uVar47, cVar10 == '\0')) {
                              do {
                                uVar38 = uVar59;
                                if (uVar28 <= (uint)uVar23) goto LAB_0010f0a6;
                                while( true ) {
...
LAB_0010ea10:
        iVar40 = (int)local_88;
        if (local_118 == 0) {
          if (local_148 == 0) goto LAB_0010ea2c;
LAB_0010efcf:
          free(local_60);
        }
        else {
LAB_0010efb4:
          free(local_50);
          if (local_148 != 0) goto LAB_0010efcf;
LAB_0010ea2c:
        }
        if ((int)local_78 != 0) {
          free(local_70);
...
LAB_0010f1af:
  ...
  if (uVar30 == uVar32) goto LAB_0010f270;
...
LAB_0010f108:
    if (fVar6 <= fVar5) {
      ...
      if (fVar6 < fVar5) goto LAB_0010f11f;
...
LAB_0010f11f:
    ...
    if (fVar4 != fVar5) {
      if (fVar5 < fVar4) goto LAB_0010f108;
      if ((fVar6 <= fVar4) || (fVar63 = fVar7, fVar5 <= fVar6)) goto LAB_0010f137;
      goto LAB_0010f11f;
    }
    if (fVar64 != fVar7) {
      fVar63 = 0.0;
...
LAB_0010f170:
    if (fVar6 <= fVar5) {
      ...
      if (fVar6 < fVar5) goto LAB_0010f187;
...
LAB_0010f19f:
    ...
    if (fVar5 < fVar4) goto LAB_0010f170;
    if (fVar6 <= fVar4) goto LAB_0010f19f;
    if (fVar6 < fVar5) goto LAB_0010f187;
    pfVar3[1] = fVar7;
  }
  iVar19 = iVar19 + -1;
  if (iVar19 == 0) goto LAB_0010ed4f;
  goto LAB_0010f1af;
LAB_0010f270:
...
LAB_0010ffc8:
  ...
  if (param_15 == (uint *)0x0) {
    ...
    uVar23 = *param_15;
    if (0x800 < uVar23) goto LAB_0010ffc8;
  }
  *local_160 = uVar23 + 1;
  local_78 = 1;
  local_74 = 1;
...
LAB_001111c0:
                ...
                if ((int)uVar23 < 0) goto LAB_0010ffb0;
              ...
              if (uVar8 < (uint)uVar39) goto LAB_001111c0;
              uVar20 = uVar7 >> 8;
              if ((uVar7 & 0x100) != 0) goto LAB_001110ba;
LAB_001111a0:
              iVar29 = (int)(char)puVar40[2];
              iVar36 = (int)*(char *)((long)puVar40 + 5);
              if ((uVar20 & 2) != 0) goto LAB_001110d9;
LAB_001111b3:
              fVar47 = 0.0;
              fVar45 = 0.0;
            } while( true );
...
LAB_0010fe70:
      ...
      if (uVar18 < 0x15555556) goto LAB_0010f954;
      bVar5 = 0;
...
LAB_0010fa71:
      ...
      if ((param_5 == (uint *)0x0) || (param_14 != 0)) {
        if (iVar36 == 1) {
          if (param_14 == 0) goto LAB_00110261;
        }
        else {
          if (iVar36 == 2) {
LAB_00110030:
                ...
                do {
                  ...
                  if (lVar32 != 0) {
                    ...
                    if ((bVar5 & 2) != 0) {
                      ...
                      do {
                        if (uVar8 == *puVar15) {
                          if ((bVar5 & 1) != 0) goto LAB_0011014f;
                          break;
                        }
                        iVar36 = iVar36 + 1;
                  ...
                  if (param_13[0x10] != (hb_hashmap_t<unsigned_int,unsigned_int,true>)0x0) {
                    ...
                    if ((bVar5 & 2) == 0) {
                      ...
                      *(int *)(param_13 + 0x14) = iVar36 + 1;
                      ...
                      do {
                        if (uVar37 == *puVar15) {
                          if (uVar18 == 0xffffffff) goto LAB_001103a7;
                          goto LAB_0011039c;
                        }
...
LAB_001103a7:
                        puVar15 = (uint *)(lVar32 + lVar17);
                        if (((byte)puVar15[1] & 2) == 0) goto LAB_0011056a;
...
LAB_00110588:
                    ...
                    if (!bVar42) {
                      lVar32 = *(long *)(param_13 + 0x28);
                      if (lVar32 == 0) goto LAB_00110bdf;
                      uVar39 = (ulong)(uVar38 & 0x3fffffff) % (ulong)*(uint *)(param_13 + 0x20);
                      puVar15 = (uint *)(lVar32 + uVar39 * 0xc);
                      bVar5 = (byte)puVar15[1];
                      if ((bVar5 & 2) == 0) goto LAB_00110bdf;
                      iVar36 = 0;
                      goto LAB_00111483;
                    }
...
LAB_0011067c:
                      uVar39 = (ulong)uVar30;
                      if (param_9 == '\0') goto LAB_00110692;
                      goto LAB_00110681;
                    }
                    if (uVar18 <= uVar30) goto LAB_00110671;
                    pfVar14 = pfVar14 + (ulong)uVar18 * 3;
                    if (param_9 != '\0') goto LAB_00110ae7;
                    uVar39 = 0;
...
LAB_0011069f:
                    ...
                    uVar8 = (uint)*puVar40;
                    if (param_9 != '\0') {
                      if ((*puVar40 & 2) != 0) goto LAB_00110588;
                      pfVar14 = *(float **)(param_4 + 8);
                      uVar30 = uVar18;
                      if (uVar18 != 0) {
LAB_00110671:
...
LAB_0010fef6:
          ...
          else if (iVar36 == 0) goto LAB_0010fef6;
          if (param_14 == 0) goto LAB_0010fc70;
        }
      }
      else {
        if (iVar36 == 2) {
...
LAB_00110ddf:
              ...
              uVar39 = (ulong)uVar18;
              if (uVar10 < uVar18) {
                if (0x15555555 < uVar18) goto LAB_001102b6;
...
LAB_00111496:
                ...
                if (iVar36 == 2) goto LAB_00110030;
                if (iVar36 == 0) goto LAB_0011022b;
              }
              else {
                if (uVar18 < uVar10 >> 2) {
                  if (uVar18 < 0x15555556) {
                    pvVar11 = *(void **)(param_5 + 2);
                    if (uVar18 != 0) goto LAB_00110e26;
                    free(pvVar11);
                    pvVar11 = (void *)0x0;
                    goto LAB_00110e49;
                  }
...
LAB_00110e5e:
                ...
                if ((uint)uVar39 == 0) goto LAB_001102bf;
                ...
                iVar36 = *(int *)((long)param_1 + 0x1c);
                if (iVar36 == 1) goto LAB_00111496;
                if (iVar36 == 2) goto LAB_00110030;
                if (iVar36 == 0) goto LAB_0010fef6;
              }
              iVar29 = (int)local_b8;
              goto LAB_0010fc70;
            }
            ...
            if (uVar10 < 0x15555556) {
              ...
              if (pvVar11 != (void *)0x0) {
                ...
                *(void **)(param_5 + 2) = pvVar11;
                *param_5 = uVar10;
                if (uVar38 < uVar8) goto LAB_00110d9b;
                goto LAB_00110ddf;
              }
              uVar18 = *param_5;
              if (uVar10 <= uVar18) goto LAB_00110d8e;
              *param_5 = ~uVar18;
            }
            else {
              *param_5 = ~uVar18;
...
LAB_0010fde5:
      uVar39 = (ulong)uVar23;
      if (uVar23 < uVar31) goto LAB_0010fe70;
      pvVar11 = *(void **)(local_158 + 8);
      goto LAB_0010f98f;
    }
    bVar5 = 0;
  ...
  while( true ) {
    ...
    if ((bVar5 & 2) == 0) break;
LAB_00111483:
    if (uVar37 == *puVar15) goto joined_r0x0011148b;
  }
  goto LAB_00110bdf;
joined_r0x0011148b:
  if ((bVar5 & 1) != 0) {
...

{
  ...
  if (param_2 < *(uint *)(this + 0x1c)) {
    if (*(int *)(param_1 + 0x78) == 0) {
      ...
      iStack_3c = __LC27;
      uStack_38 = _UNK_00120fb4;
      uStack_34 = _UNK_00120fb8;
      uStack_30 = _UNK_00120fbc;
      local_48 = 0;
...
LAB_00111d58:
              cVar6 = (char)param_9;
              if (*(char *)((long)puVar13 + 9) != '\0') goto LAB_00111e1e;
              goto LAB_00111d62;
            }
            if (param_10._4_1_ == '\0') {
            ...
            param_10._0_4_ = (param_11._4_4_ + fVar24) * _UNK_00120ff4;
            if (*(char *)(param_8 + 1) == '\0') {
            ...
            *(ulong *)(param_8 + 9) = CONCAT44((float)param_10,fVar20);
            if ((char)param_9 == '\0') goto LAB_00111d62;
LAB_00112130:
            cVar2 = param_12;
...
LAB_00111e1e:
            ...
            if (param_10._4_1_ != '\0') {
              ...
              fVar24 = param_11._4_4_;
              cVar2 = param_12;
              if (param_13._4_1_ != '\0') goto LAB_00112130;
            ...
            if (param_13._4_1_ == '\0') {
              ...
              phVar15 = (hb_draw_state_t *)(param_8 + 6);
              if ((char)param_9 == '\0') goto LAB_00111e70;
              uVar19 = CONCAT44((float)param_10,param_9._4_4_);
              if ((char)param_15 == '\0') {
                if (*(char *)(param_8 + 1) == '\0') {
...
LAB_00113c9c:
      ...
      if (uVar2 >> 2 <= uVar10) goto LAB_00113b49;
      if (0x5555555 < uVar10) goto LAB_00113b92;
      if (uVar10 != 0) goto LAB_00113d44;
    ...
    *(uint *)this = uVar10;
    ...
    if (0x5555555 < uVar9) goto LAB_00113b92;
LAB_00113d44:
    uVar10 = (uint)uVar11;
    pauVar7 = (undefined1 (*) [16])malloc(uVar11 * 0x30);
    if (pauVar7 != (undefined1 (*) [16])0x0) goto LAB_00113c9c;
    if (uVar2 < uVar10) {
LAB_00113b92:
      *(uint *)this = ~uVar2;
      return 0;
  ...
  if (uVar1 < uVar11) {
    ...
    do {
      while (lVar10 = lVar9 + -0x28, *(int *)(lVar9 + 8) != 0) {
        ...
        lVar9 = lVar10;
        if (lVar8 == lVar10) goto LAB_00113ef1;
      }
      lVar9 = lVar10;
    } while (lVar8 != lVar10);
LAB_00113ef1:
...

{
  ...
  *(undefined1 (*) [16])(this + 0x80) = (undefined1  [16])0x0;
  if (param_1 == (hb_face_t *)0x0) goto LAB_001142c3;
...
LAB_00114149:
  ...
  *(undefined4 *)(this + 0x2c) = 0;
  if (pcVar27 + (5 - *(long *)(this + 8)) <= (char *)(ulong)*(uint *)(this + 0x18)) {
    cVar6 = *pcVar27;
    lVar12 = *(long *)(this + 0x30);
    if (*(int *)(this + 0x2c) != 0) goto LAB_00114326;
    hb_blob_destroy(lVar12);
    *(undefined8 *)(this + 0x30) = 0;
    *(undefined4 *)(this + 0x18) = 0;
    *(undefined1 (*) [16])(this + 8) = (undefined1  [16])0x0;
    if (cVar6 != '\x02') goto LAB_00114347;
    goto LAB_00114149;
  }
LAB_00114f20:
  lVar12 = *(long *)(this + 0x30);
...
LAB_001145d8:
            ...
            if (((undefined *)(ulong)*(uint *)(this + 0x18) <
               ...
               ((undefined *)(ulong)*(uint *)(this + 0x18) <
                (undefined *)((long)puVar26 + (10 - *(long *)(this + 8))))) goto LAB_001145d8;
                 ...
                 (((ulong)*(uint *)(this + 0x18) < (ulong)((long)pcVar1 - *(long *)(this + 8)) ||
                  (((uint)((int)*(undefined8 *)(this + 0x10) - (int)pcVar1) < *(uint *)(this + 0x38)
                   || (iVar8 = *(int *)(this + 0x1c) - *(uint *)(this + 0x38),
                      *(int *)(this + 0x1c) = iVar8, iVar8 < 1)))))) goto LAB_0011467b;
            }
          }
...
LAB_00114fa8:
                    ...
                    *(uint *)(this + 0x1c) = iVar8 - uVar21;
                    if ((int)(iVar8 - uVar21) < 1) goto LAB_001146c8;
                    pdVar19 = local_2070;
...
LAB_00114d82:
                          ...
                          if (local_2078._4_4_ != 0) goto LAB_00114eb0;
                          cVar6 = (char)local_2078;
                          if ((uint)local_2080 < local_2080._4_4_) goto LAB_001146c8;
                        }
                        else {
                          if (bVar2 != 0x12) goto LAB_00114d82;
                          if (local_2078._4_4_ == 0) {
                            __hb_CrapPool = __hb_NullPool;
                            uVar18 = 0;
                            if ((int)__hb_NullPool < 0) goto LAB_001150c6;
...
LAB_00114bbd:
                      ...
                      if (bVar2 == 0xc) {
                        if (uVar21 < uVar9 + 2) {
                          ...
                          if (uVar10 < 0x10e) {
                            if (0x108 < uVar10) goto LAB_00114e00;
                          }
...
LAB_00114e00:
                      ...
                      if (0x16 < bVar2) {
                        if (bVar2 != 0x17) goto LAB_00114e25;
LAB_00114e0b:
                        if (uVar21 < local_1060._4_4_) goto LAB_001146c8;
LAB_00114c41:
                        if ((char)local_1058 != '\0') goto LAB_00114f3e;
                        CFF::parsed_values_t<CFF::dict_val_t>::add_op
                      ...
                      if (0xb < bVar2) {
                        if (bVar2 != 0x13) goto LAB_00114e25;
                        if (iVar8 == 0) {
                          local_1058 = CONCAT71(local_1058._1_7_,1);
                          __hb_CrapPool = __hb_NullPool;
                          pdVar19 = (double *)&_hb_CrapPool;
...
LAB_00114e25:
                      ...
                      uVar21 = (uint)local_1060;
                      if (local_1058._4_4_ == 0) goto LAB_00114e0b;
                      if ((uint)local_1060 < local_1060._4_4_) goto LAB_001146c8;
LAB_00114f3e:
                      if ((char)local_1058 != '\0') goto LAB_001146c8;
                    }
    ...
    if (uVar24 != 0) {
      ...
      do {
        while (lVar13 = lVar12 + -0x28, *(int *)(lVar12 + 8) == 0) {
          lVar12 = lVar13;
          if (lVar11 == lVar13) goto LAB_00114436;
        }
        free(*(void **)(lVar12 + 0x10));
        lVar12 = lVar13;
      } while (lVar11 != lVar13);
    ...
    if (uVar24 != 0) {
      ...
      do {
        while (lVar13 = lVar12 + -0x30, *(int *)(lVar12 + 8) == 0) {
          lVar12 = lVar13;
          if (lVar11 == lVar13) goto LAB_001143ce;
        }
        free(*(void **)(lVar12 + 0x10));
        lVar12 = lVar13;
      } while (lVar11 != lVar13);
...
LAB_001154bc:
      ...
      if (uVar1 >> 2 <= uVar12) goto LAB_001153a9;
      if (0x6666666 < uVar12) goto LAB_001153ee;
      if (uVar12 != 0) goto LAB_001155d4;
    ...
    *(uint *)this = uVar12;
    ...
    if (0x6666666 < uVar11) goto LAB_001153ee;
LAB_001155d4:
    uVar12 = (uint)uVar15;
    puVar9 = (undefined4 *)malloc(uVar15 * 0x28);
    if (puVar9 != (undefined4 *)0x0) goto LAB_001154bc;
    if (uVar1 < uVar12) {
LAB_001153ee:
      *(uint *)this = ~uVar1;
      return 0;
  ...
  if (uVar1 < uVar11) {
    ...
    do {
      while (lVar10 = lVar9 + -0x28, *(int *)(lVar9 + 8) != 0) {
        free(*(void **)(lVar9 + 0x10));
        lVar9 = lVar10;
        if (lVar8 == lVar10) goto LAB_00115791;
      }
      lVar9 = lVar10;
    } while (lVar8 != lVar10);
LAB_00115791:
    ...
    if (bVar15 == 0xc) {
      ...
      if (uVar11 < uVar7) {
        ...
        *(uint *)(piVar13 + 0xc) = uVar7;
        uVar6 = bVar15 + 0x100;
        if (uVar6 < 0x10f) {
          if (0x108 < uVar6) goto LAB_001158a3;
        }
        else if (bVar15 - 0x11 < 3) goto LAB_001158a3;
      }
LAB_00115a29:
      local_6c = 0;
      local_70 = 0xffff;
      ...
      if (*(int *)(piVar13 + 0x14) == 0) {
        ...
        uVar11 = *(uint *)(piVar13 + 8);
LAB_001158aa:
        if (uVar7 <= uVar11) goto LAB_001159b6;
      }
LAB_001158b2:
...
LAB_001159b6:
      ...
      if (bVar15 < 0x14) {
        if (5 < uVar6 - 6) goto LAB_00115a29;
LAB_001158a3:
        local_6c = 0;
        local_70 = 0xffff;
        local_78 = 0;
      ...
      if (bVar15 - 0x14 < 2) goto LAB_001158a3;
      piVar10 = piVar13;
      if (bVar15 == 0x1d) {
        ...
        *(uint *)(piVar13 + 0xc) = uVar7 + 4;
        ...
        if (bVar15 != 0x1e) goto LAB_00115a29;
        uVar8 = 0;
        uVar16 = 0;
        bVar15 = 0;
        local_68 = (undefined1  [16])0x0;
...

{
  ...
  *(undefined1 (*) [16])(this + 0x80) = (undefined1  [16])0x0;
  uVar6 = _LC30;
  if (param_1 == (hb_face_t *)0x0) goto LAB_00116031;
  ...
  *(long *)(this + 0x30) = lVar12;
  while( true ) {
    ...
    *(undefined4 *)(this + 0x24) = 0;
    ...
    if (uVar19 < 4) goto LAB_00116090;
    if (*pcVar4 == '\x01') break;
    if ((*(int *)(this + 0x2c) == 0) ||
       (this[0x28] !=
        (accelerator_templ_t<CFF::cff1_private_dict_opset_t,CFF::cff1_private_dict_values_base_t<CFF::dict_val_t>>
         )0x0)) goto LAB_00116560;
    lVar12 = hb_blob_get_data_writable(lVar11,0);
    uVar19 = *(uint *)(lVar11 + 0x18);
    *(long *)(this + 8) = lVar12;
    *(ulong *)(this + 0x10) = (ulong)uVar19 + lVar12;
    if (lVar12 == 0) goto LAB_00116560;
    this[0x28] = (accelerator_templ_t<CFF::cff1_private_dict_opset_t,CFF::cff1_private_dict_values_base_t<CFF::dict_val_t>>
                  )0x1;
    lVar12 = *(long *)(this + 0x30);
  }
...
LAB_00115ee4:
  ...
  *(undefined4 *)(this + 0x2c) = 0;
  if (pcVar4 + (4 - *(long *)(this + 8)) <= (char *)(ulong)*(uint *)(this + 0x18)) {
    cVar8 = *pcVar4;
    lVar12 = *(long *)(this + 0x30);
    if (*(int *)(this + 0x2c) != 0) goto LAB_00116090;
    hb_blob_destroy(lVar12);
    *(undefined8 *)(this + 0x30) = 0;
    *(undefined4 *)(this + 0x18) = 0;
    *(undefined1 (*) [16])(this + 8) = (undefined1  [16])0x0;
    if (cVar8 != '\x01') goto LAB_001160ac;
    goto LAB_00115ee4;
  }
LAB_00116560:
  lVar12 = *(long *)(this + 0x30);
...
LAB_001163db:
                ...
                uVar19 = (int)uVar16 + 1;
                if (uVar19 <= auVar32._8_4_) goto code_r0x001163e6;
                if (*(int *)(this + 0xf4) < 3) {
                  ...
                  *(Charset **)(this + 0x50) = this_01;
                  if (this_01 == (Charset *)&_hb_NullPool) goto LAB_00115f94;
                }
                            ...
                            *(char **)(this + 0x88) = pcVar4;
                            if ((*(ushort **)(this + 0x80) != (ushort *)&_hb_NullPool) &&
                              ...
                              *(uint *)(this + 0x90) = (uint)(ushort)(uVar21 << 8 | uVar21 >> 8);
                              if (*(int *)(this + 0xdc) == -1) goto LAB_0011657d;
                              if (*(undefined **)(this + 0x50) != &_hb_NullPool) goto LAB_0011658d;
                            }
                            goto LAB_00115f94;
                          }
                        }
...
LAB_0011657d:
                if (1 < *(int *)(this + 0xf0)) {
                  ...
                  *(Encoding **)(this + 0x48) = this_02;
                  if (this_02 == (Encoding *)&_hb_NullPool) goto LAB_00115f94;
                }
LAB_0011658d:
...
LAB_00116685:
                    ...
                    if (CVar2 != (CFFIndex<OT::IntType<unsigned_short,2u>>)0x4) goto LAB_00116685;
...
LAB_001166a6:
                  ...
                  *(CFFIndex<OT::IntType<unsigned_short,2u>> **)(this + 0x78) = pCVar13;
                  if (((pCVar13 != (CFFIndex<OT::IntType<unsigned_short,2u>> *)&_hb_NullPool) &&
                    ...
                    if (uVar19 == 0) {
                      if (*(int *)(this + 0xdc) != -1) goto LAB_00116031;
...
LAB_001168b4:
                                ...
                                uVar23 = (uint)local_1060;
                                if (local_1058._4_4_ != 0) goto LAB_00116ef0;
                              }
                              else {
                                ...
                                if (uVar24 != 0x107) {
                                  if (uVar24 < 0x108) {
                                    if (uVar24 == 0x105) goto LAB_00116b48;
                                  }
...
LAB_001168e1:
                              if (uVar23 < local_1060._4_4_) goto LAB_00115f94;
                            }
                            else {
                              if (bVar3 != 0x12) goto LAB_001168b4;
                              if (local_1058._4_4_ == 0) {
                                __hb_CrapPool = __hb_NullPool;
                                uVar19 = 0;
                                if ((int)__hb_NullPool < 0) goto LAB_00116f66;
...
LAB_00116f66:
                            ...
                            if ((char)local_1058 != '\0') goto LAB_00115f94;
                        ...
                        *(Subrs **)(pcVar29 + 0x20) = pSVar15;
                        ...
                        if (*(uint *)(this + 0x90) <= local_20b4) goto LAB_00116031;
                      }
                    }
                  }
                }
    ...
    if (uVar19 != 0) {
      ...
      do {
        while (lVar25 = lVar12 + -0x28, *(int *)(lVar12 + 8) == 0) {
          lVar12 = lVar25;
          if (lVar11 == lVar25) goto LAB_0011617e;
        }
        free(*(void **)(lVar12 + 0x10));
        lVar12 = lVar25;
      } while (lVar11 != lVar25);
  ...
  if (*(int *)(this + 0x118) != 0) {
    ...
    if (uVar19 != 0) {
      ...
      do {
        while (lVar25 = lVar12 + -0x28, *(int *)(lVar12 + 8) == 0) {
          lVar12 = lVar25;
          if (lVar11 == lVar25) goto LAB_0011611e;
        }
        free(*(void **)(lVar12 + 0x10));
        lVar12 = lVar25;
      } while (lVar11 != lVar25);
...
code_r0x001163e6:
  ...
  if (((uint)local_1060 < local_1060._4_4_) || ((char)local_1058 != '\0')) goto LAB_00115f94;
  goto LAB_001163db;
LAB_00116ef0:
  ...
  *this_00;
  ...
  do {
    while( true ) {
      ...
      if (phVar3 == (hb_face_t *)0x0) goto LAB_00117191;
  ...
  *this_00;
  ...
  do {
    while( true ) {
      ...
      if (phVar3 == (hb_face_t *)0x0) goto LAB_001174f3;
    ...
    do {
      ...
      if (lVar8 != 0) {
        ...
        if ((bVar1 & 2) != 0) {
          ...
          do {
            if (*puVar4 == uVar7) {
              if ((bVar1 & 1) != 0) goto LAB_0011add0;
              break;
            }
            iVar11 = iVar11 + 1;
      ...
      if (param_1[0x78] != (hb_paint_context_t)0x0) {
        ...
        if ((bVar1 & 2) == 0) {
          ...
          *(int *)(param_1 + 0x7c) = iVar11 + 1;
          ...
          do {
            if (uVar7 == *puVar4) {
              if (uVar10 != 0xffffffff) goto LAB_0011aea1;
              goto LAB_0011aeac;
            }
...
LAB_0011aeac:
            ...
            if (((byte)puVar4[1] & 2) == 0) goto LAB_0011b03d;
  ...
  if (bVar2) {
    ...
    if (lVar5 != 0) {
      lVar5 = *(long *)(lVar5 + 8);
                    ...
                    /* WARNING: Could not recover jumptable at 0x0011b3e4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(lVar1 + 0x18))(lVar1,*(undefined8 *)(param_1 + 0x18),lVar5);
    return;
  }
  ...
  if (bVar2) {
    ...
    if (lVar5 != 0) {
      lVar5 = *(long *)(lVar5 + 8);
                    ...
                    /* WARNING: Could not recover jumptable at 0x0011b5bc. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(lVar1 + 0x18))(lVar1,*(undefined8 *)(param_1 + 0x18),lVar5);
    return;
  }
...

{
  ...
  if (lVar7 != 0) {
    lVar7 = *(long *)(lVar7 + 8);
                    ...
                    /* WARNING: Could not recover jumptable at 0x0011b7ea. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(lVar1 + 0x18))(lVar1,*(undefined8 *)(param_1 + 0x18),lVar7);
  return;
}
...
LAB_0011ba24:
    ...
    if (fVar14 != fVar13) {
      ...
      bVar3 = true;
      bVar4 = bVar3;
      if (puVar7 != (undefined8 *)0x0) goto LAB_0011b9e7;
      (*pcVar8)(fVar14,lVar12,uVar11,0);
      goto LAB_0011ba24;
    }
    bVar3 = true;
  ...
  if (bVar3) {
    ...
    if (lVar10 != 0) {
      lVar10 = *(long *)(lVar10 + 8);
                    ...
                    /* WARNING: Could not recover jumptable at 0x0011bb5f. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(lVar12 + 0x18))(lVar12,*(undefined8 *)(param_1 + 0x18),lVar10);
    return;
  }
  if (bVar5) {
    ...
    if (*(long *)(lVar12 + 0x80) == 0) {
      ...
      uVar11 = *(undefined8 *)(*(long *)(lVar12 + 0x80) + 8);
                    ...
                    /* WARNING: Could not recover jumptable at 0x0011bbe8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(lVar12 + 0x18))
...
LAB_0011be84:
    ...
    if (fVar13 != 0.0) {
      ...
      puVar7 = *(undefined8 **)(lVar12 + 0x80);
      pcVar8 = *(code **)(lVar12 + 0x10);
      if (puVar7 != (undefined8 *)0x0) goto LAB_0011be42;
      (*pcVar8)(lVar12,uVar11,0);
      goto LAB_0011be84;
    }
    bVar3 = true;
  ...
  if (bVar3) {
    ...
    if (lVar10 != 0) {
      lVar10 = *(long *)(lVar10 + 8);
                    ...
                    /* WARNING: Could not recover jumptable at 0x0011bfc1. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(lVar12 + 0x18))(lVar12,*(undefined8 *)(param_1 + 0x18),lVar10);
    return;
  }
  if (bVar5) {
    ...
    if (*(long *)(lVar12 + 0x80) == 0) {
      ...
      uVar11 = *(undefined8 *)(*(long *)(lVar12 + 0x80) + 8);
                    ...
                    /* WARNING: Could not recover jumptable at 0x0011c08a. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(lVar12 + 0x18))
              (lVar12,*(undefined8 *)(param_1 + 0x18),uVar11,*(code **)(lVar12 + 0x18));
    return;
...
LAB_0011c321:
    ...
    if (fVar14 != fVar13 || fVar15 != fVar13) {
      ...
      pcVar8 = *(code **)(lVar12 + 0x10);
      bVar3 = true;
      if (puVar7 != (undefined8 *)0x0) goto LAB_0011c2e4;
      (*pcVar8)(fVar14,0,lVar12,uVar11,0);
      goto LAB_0011c321;
    }
  }
...
LAB_0011c23c:
  ...
  if (!bVar3) {
    ...
    if (*(long *)(lVar12 + 0x80) == 0) {
      ...
      uVar11 = *(undefined8 *)(*(long *)(lVar12 + 0x80) + 8);
                    ...
                    /* WARNING: Could not recover jumptable at 0x0011c4ea. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(lVar12 + 0x18))
              (lVar12,*(undefined8 *)(param_1 + 0x18),uVar11,*(code **)(lVar12 + 0x18));
    return;
  ...
  if (lVar10 != 0) {
    lVar10 = *(long *)(lVar10 + 8);
                    ...
                    /* WARNING: Could not recover jumptable at 0x0011c461. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(lVar12 + 0x18))(lVar12,*(undefined8 *)(param_1 + 0x18),lVar10);
  return;
}
...
LAB_0011c7d8:
    ...
    if (fVar13 != 0.0 || fVar14 != 0.0) {
      ...
      puVar8 = *(undefined8 **)(lVar12 + 0x80);
      pcVar7 = *(code **)(lVar12 + 0x10);
      if (puVar8 != (undefined8 *)0x0) goto LAB_0011c7a3;
      (*pcVar7)(lVar12,uVar11,0);
      goto LAB_0011c7d8;
    }
  }
...
LAB_0011c698:
  ...
  if (!bVar3) {
    ...
    if (*(long *)(lVar12 + 0x80) == 0) {
      ...
      uVar11 = *(undefined8 *)(*(long *)(lVar12 + 0x80) + 8);
                    ...
                    /* WARNING: Could not recover jumptable at 0x0011c9ea. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(lVar12 + 0x18))
              (lVar12,*(undefined8 *)(param_1 + 0x18),uVar11,*(code **)(lVar12 + 0x18));
    return;
  ...
  if (lVar10 != 0) {
    lVar10 = *(long *)(lVar10 + 8);
                    ...
                    /* WARNING: Could not recover jumptable at 0x0011c921. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(lVar12 + 0x18))(lVar12,*(undefined8 *)(param_1 + 0x18),lVar10);
  return;
}
...

{
  ...
  if (lVar17 != 0) {
    ...
    if ((bVar1 & 2) != 0) {
      ...
      do {
        if (uVar13 == *puVar11) {
          if ((bVar1 & 1) != 0) goto LAB_0011caf0;
          break;
        }
        iVar19 = iVar19 + 1;
  ...
  if (param_1[0x48] != (hb_paint_context_t)0x0) {
    ...
    if ((bVar1 & 2) == 0) {
      ...
      *(int *)(param_1 + 0x4c) = iVar19 + 1;
      ...
      do {
        if (uVar23 == *puVar11) {
          if (uVar20 != 0xffffffff) goto LAB_0011cbae;
          goto LAB_0011cbb9;
        }
...
LAB_0011cbb9:
        ...
        if (((byte)puVar11[1] & 2) == 0) goto LAB_0011cf0d;
    ...
    if (-1 < iVar9) {
      do {
        while( true ) {
          ...
          if (uVar22 <= uVar8) goto LAB_0011cd6b;
          iVar19 = uVar13 + 1;
          if (iVar9 < iVar19) goto LAB_0011ced5;
        }
        iVar9 = uVar13 - 1;
      } while (iVar19 <= iVar9);
    }
...
LAB_0011cd6b:
    ...
    if (lVar17 != 0) {
      ...
      if ((bVar1 & 2) != 0) {
        iVar19 = 0;
        do {
          if (uVar13 == *puVar11) goto LAB_0011ce84;
          iVar19 = iVar19 + 1;
  ...
  if (cVar3 != '\0') {
    ...
    if ((bVar1 & 2) == 0) {
      *puVar11 = param_2;
      ...
      do {
        if (*puVar11 == param_2) {
          if (uVar13 == 0xffffffff) goto LAB_0011d376;
          goto LAB_0011d36b;
        }
...
LAB_0011d376:
        puVar11 = (uint *)(local_88 + lVar6);
        if (((byte)puVar11[1] & 2) == 0) goto LAB_0011d7d2;
    ...
    if (-1 < iVar10) {
      ...
      do {
        while( true ) {
          ...
          if (param_2 <= uVar5) goto LAB_0011d430;
          iVar17 = uVar12 + 1;
          if (iVar10 < iVar17) goto LAB_0011d57b;
        }
        iVar10 = uVar12 - 1;
      } while (iVar17 <= iVar10);
    }
  ...
  if (uVar4 != 0) {
    ...
    do {
      while( true ) {
        ...
        iVar17 = uVar13 + 1;
        if (iVar10 < iVar17) goto LAB_0011d7bb;
      }
      iVar10 = uVar13 - 1;
    } while (iVar17 <= iVar10);
  }
...
LAB_0011dc55:
    ...
    if (*(short *)this == 0) goto LAB_0011dc32;
    ...
    if (((sVar9 == 0) || (*(int *)(this + 0x16) == 0)) ||
       (uVar5 = *(uint *)(this + 0x16), uVar5 == 0)) goto LAB_0011dc55;
    this_00 = (ClipList *)
              (this + (uVar5 >> 0x18 | (uVar5 & 0xff0000) >> 8 | (uVar5 & 0xff00) << 8 |
                      uVar5 << 0x18));
  }
  ...
  if (fVar1 <= fVar2) {
    ...
    *(int *)(param_3 + 0xc) = (int)(fVar4 - fVar3);
    if ((int)local_58 != 0) goto LAB_0011ddc0;
LAB_0011dcff:
    if ((int)local_68 == 0) goto LAB_0011dd0b;
LAB_0011dda0:
    free((void *)CONCAT44(uStack_5c,local_60));
  }
  else {
    *(undefined1 (*) [16])param_3 = (undefined1  [16])0x0;
    if ((int)local_58 == 0) goto LAB_0011dcff;
LAB_0011ddc0:
    free(local_50);
    if ((int)local_68 != 0) goto LAB_0011dda0;
LAB_0011dd0b:
  }
  if ((int)local_78 != 0) {
    free(local_70);
  ...
  if (uVar3 != 0) {
    ...
    do {
      while( true ) {
        ...
        if (uVar3 == 0x500) goto LAB_0011e0a2;
        iVar12 = uVar4 + 1;
        if (iVar16 < iVar12) goto LAB_0011e14b;
      }
      iVar16 = uVar4 - 1;
    } while (iVar12 <= iVar16);
LAB_0011e14b:
  ...
  *(short **)(this + 0x18) = psVar8;
  if (local_8a == false) {
    ...
    if ((local_88[0]._0_1_ != (hb_sanitize_context_t)0x0) ||
       (pcVar9 = get_glyph_from_ascii<OT::CmapSubtable>, local_89 != false)) goto LAB_0011e116;
    if (*psVar8 == 0x400) {
      uVar3 = psVar8[3];
      psVar10 = psVar8 + 7;
    ...
    if (*psVar8 == 0xc00) goto LAB_0011e116;
  }
  else {
    phVar1 = param_1 + 0xa0;
LAB_0011e223:
    ...
    if (lVar6 == 0) {
      if (*(hb_face_t **)(param_1 + 0x70) == (hb_face_t *)0x0) {
        ...
        if (lVar6 == 0) {
          ...
          UNLOCK();
          if (lVar11 != 0) goto code_r0x0011e360;
        }
        else {
          LOCK();
          lVar11 = *(long *)phVar1;
...
LAB_0011e9c5:
    ...
    if (uVar4 == 1) {
      if (*(uint *)(lVar3 + 0x18) < 0x20) goto LAB_0011e9c5;
    }
    else if ((uVar4 != 0) || (puVar1[1] != 0x50)) goto LAB_0011e9c5;
    hb_blob_destroy();
    hb_blob_make_immutable(uVar2);
  }
  return uVar2;
  ...
  if (lVar9 == 0) {
    if (*(hb_face_t **)(param_1 + 0x70) == (hb_face_t *)0x0) {
      ...
      if (lVar9 == 0) {
        ...
        UNLOCK();
        if (lVar10 != 0) goto code_r0x0011ee96;
      }
      else {
        LOCK();
        lVar10 = *(long *)phVar1;
  ...
  if (lVar9 == 0) {
    if (*(hb_face_t **)(param_1 + 0x70) == (hb_face_t *)0x0) {
      ...
      if (lVar9 == 0) {
        ...
        UNLOCK();
        if (lVar10 != 0) goto code_r0x0011ee69;
      }
      else {
        LOCK();
        lVar10 = *(long *)phVar1;
  ...
  *(undefined8 *)(this + 0x18) = uVar10;
  ...
  do {
    ...
    if ((cVar5 == '\0') || ((HVARVVAR *)(ulong)local_70 < this_00 + (0x18 - local_80._0_8_))) {
      if (local_5c == 0) goto LAB_0011f1a5;
LAB_0011ef91:
      if (local_60 != '\0') goto LAB_0011f1a5;
    }
    else {
...
joined_r0x0011f3ef:
              ...
              if (0 < (int)local_6c) goto LAB_0011f05e;
            }
          }
        }
        else {
          if (*pHVar14 != (HVARVVAR)0x1) goto LAB_0011f05e;
          pHVar1 = pHVar14 + 6;
          if ((ulong)((long)pHVar1 - local_80._0_8_) <= (ulong)local_70) {
            ...
            if ((((int)((ulong)lVar3 >> 0x20) == 0) &&
               ...
               (uVar16 <= (uint)(local_80._8_4_ - (int)pHVar1))) goto joined_r0x0011f3ef;
          }
        }
      }
      if (0x1f < local_5c) goto LAB_0011ef91;
      local_5c = local_5c + 1;
      if (local_60 != '\0') {
    ...
    if (local_80._0_8_ == 0) goto LAB_0011f1a5;
    local_60 = '\x01';
  } while( true );
code_r0x0011f4b6:
  if (lVar11 != 0) {
  ...
  if (lVar11 == 0) {
    if (*(hb_face_t **)(param_1 + 0x70) == (hb_face_t *)0x0) {
      ...
      if (lVar11 == 0) {
        ...
        UNLOCK();
        if (lVar12 != 0) goto code_r0x0011f4b6;
      }
      else {
        LOCK();
        lVar12 = *(long *)phVar2;
  ...
  if (lVar11 == 0) {
    if (*(hb_face_t **)(param_1 + 0x70) == (hb_face_t *)0x0) {
      ...
      if (lVar11 == 0) {
        ...
        UNLOCK();
        if (lVar12 != 0) goto code_r0x0011f48c;
      }
      else {
        LOCK();
        lVar12 = *(long *)phVar2;
  ...
  if (lVar6 == 0) {
    if (*(hb_face_t **)(param_1 + 0x70) == (hb_face_t *)0x0) {
      ...
      if (lVar6 == 0) {
        ...
        UNLOCK();
        if (lVar7 != 0) goto code_r0x0011f9a7;
      }
      else {
        LOCK();
        lVar7 = *(long *)phVar1;
        ...
        UNLOCK();
        if (lVar7 != 0) goto LAB_0011f715;
      }
    }
  }
  puVar9 = &_hb_NullPool;
  if (*(uint *)(lVar6 + 0x18) < 0x36) goto LAB_0011f538;
  ...
  if (lVar6 == 0) {
    if (*(long *)(param_1 + 0x70) == 0) {
      ...
      if (lVar6 == 0) {
        ...
        UNLOCK();
        if (lVar7 != 0) goto code_r0x0011fa41;
      }
      else {
        LOCK();
        lVar7 = *(long *)phVar1;
  ...
  *(undefined8 *)(this + 0x28) = uVar5;
  ...
  do {
    while( true ) {
      ...
      if (this_00 != (accelerator_t *)0x0) goto LAB_0011f650;
      phVar2 = *(hb_face_t **)(param_1 + 0x70);
      if (phVar2 == (hb_face_t *)0x0) goto LAB_0011f9e9;
  ...
  *(accelerator_t **)this = this_00;
  ...
  do {
    while( true ) {
      ...
      if (this_01 != (accelerator_t *)0x0) goto LAB_0011f66a;
      phVar2 = *(hb_face_t **)(param_1 + 0x70);
      if (phVar2 == (hb_face_t *)0x0) goto LAB_0011fa15;
  ...
  *(accelerator_t **)(this + 8) = this_01;
  ...
  do {
    while( true ) {
      ...
      if (this_02 != (accelerator_t *)0x0) goto LAB_0011f685;
      phVar2 = *(hb_face_t **)(param_1 + 0x70);
      if (phVar2 == (hb_face_t *)0x0) goto LAB_0011f9cb;
                ...
                cVar4 = Paint::dispatch<hb_sanitize_context_t>
                                  ((Paint *)(pCVar11 +
                                            (uVar1 >> 0x18 | (uVar1 & 0xff0000) >> 8 |
                                             (uVar1 & 0xff00) << 8 | uVar1 << 0x18)),param_1);
                *(int *)(param_1 + 0x24) = *(int *)(param_1 + 0x24) + -1;
                if (cVar4 != '\0') goto LAB_001207e0;
              }
              if (0x1f < *(uint *)(param_1 + 0x2c)) {
                return 0;
              }
              *(uint *)(param_1 + 0x2c) = *(uint *)(param_1 + 0x2c) + 1;
              if (param_1[0x28] == (hb_sanitize_context_t)0x0) goto LAB_00120850;
              *(uint *)(pCVar7 + -4) = 0;
            }
LAB_001207e0:
            uVar6 = uVar6 + 1;
...
LAB_0012096e:
            ...
            *(uint *)(param_1 + 0x1c) = iVar10 - uVar6;
            if (0 < (int)(iVar10 - uVar6)) goto LAB_001206ef;
          }
        }
      }
      else {
        if (*pCVar7 != (COLR)0x1) goto LAB_001206ec;
        pCVar11 = pCVar7 + 6;
        if ((ulong)((long)pCVar11 - *(long *)(param_1 + 8)) <= (ulong)*(uint *)(param_1 + 0x18)) {
          uVar6 = *(uint *)(pCVar7 + 2);

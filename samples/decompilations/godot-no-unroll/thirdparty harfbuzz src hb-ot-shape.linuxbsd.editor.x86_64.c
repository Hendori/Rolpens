...

{
  ...
  *(undefined8 *)(this + 0x80) = 0;
  ...
  } while (puVar6 != (undefined4 *)0x103f38);
  if ((local_f0 & 0xfffffffe) == 4) {
    ...
    do {
      ...
      puVar6 = puVar6 + 2;
      hb_ot_map_builder_t::add_feature(local_d0,uVar3,*puVar1,1);
    } while (puVar6 != (undefined4 *)&DAT_00103ef8);
  }
  else {
  ...
  if ((param_5) || (!param_4)) {
    *(uint *)(this + 0xc0) = *(uint *)(this + 0xc0) | 0x20;
    if ((param_5) && (this[0x5a] != (hb_buffer_t)0x0)) {
      ...
      if (uVar11 == param_3) {
        local_44 = 0xffffffff;
        if (param_2 == uVar5) goto LAB_00104010;
        if (iVar1 == 2) goto LAB_001043ae;
LAB_00104165:
        ...
        if (param_2 == uVar5) {
LAB_00104445:
          if (param_3 == uVar11) goto LAB_00104010;
LAB_0010444e:
...
LAB_00104229:
          ...
          if (uVar7 != uVar2) goto LAB_00104402;
          if (uVar7 == uVar13) goto LAB_0010430d;
          if (param_2 < uVar5) {
        ...
        if (uVar11 == param_3) goto LAB_00104010;
        uVar9 = (ulong)(param_3 - 1);
        uVar6 = (ulong)uVar11;
...
LAB_00104253:
        if (uVar5 != uVar7) {
          if (uVar13 != uVar7) goto LAB_00104476;
          if (uVar5 != uVar7) {
            if (uVar11 < param_3) {
...
LAB_001043ae:
            ...
            if (param_2 < uVar5) {
              ...
              if (param_2 == uVar5) goto LAB_00104445;
            }
            local_50 = uVar6 * 0x14;
LAB_00104402:
            if (param_2 < uVar5) {
        ...
        local_44 = uVar7;
        if (param_2 != uVar5) goto LAB_00104165;
LAB_00104455:
        uVar5 = *(uint *)(lVar3 + 8 + uVar6 * 0x14);
        uVar13 = *(uint *)(lVar3 + 8 + uVar9 * 0x14);
        if (iVar1 != 2) goto LAB_00104253;
LAB_00104476:
        if (uVar11 < param_3) {
          puVar4 = (uint *)(lVar3 + 4 + uVar6 * 0x14);
          do {
    ...
    if (param_3 - param_2 < 2) goto LAB_00104010;
    *(uint *)(this + 0xc0) = *(uint *)(this + 0xc0) | 0x20;
  }
  lVar3 = *(long *)(this + 0x70);
  if (param_2 != param_3) {
...

{
  ...
  if (param_1 != 1 || uVar4 != 0) {
    ...
    if ((int)uVar5 < 0) goto LAB_001047bc;
    ...
    if (param_3) {
      ...
      if (uVar5 < uVar8) {
        if (uVar8 < 0x38e38e4) goto LAB_00104949;
      }
      else {
        if (uVar5 >> 2 <= uVar8) goto LAB_00104703;
        if (uVar8 < 0x38e38e4) {
          pvVar2 = *(void **)(this + 0x28);
          if (uVar8 != 0) goto LAB_00104950;
          free(pvVar2);
          uVar8 = 0;
          pvVar2 = (void *)0x0;
          goto LAB_0010496c;
      ...
      uVar8 = uVar5;
      if (param_1 <= uVar5) goto LAB_00104703;
      do {
...
LAB_00104950:
    ...
    if (pvVar2 == (void *)0x0) {
      uVar5 = *(uint *)(this + 0x20);
      if (uVar5 < uVar8) goto LAB_001047b7;
    }
    else {
LAB_0010496c:
...
LAB_001049b4:
        ...
        if (pvVar2 == (void *)0x0) {
          ...
          uVar6 = (ulong)uVar5;
          if (uVar4 <= *(uint *)(this + 0x10)) goto LAB_001047cf;
          *(uint *)(this + 0x10) = ~*(uint *)(this + 0x10);
          goto LAB_00104a13;
        }
      }
      else {
        if (uVar4 >> 2 <= uVar5) goto LAB_001047cf;
        pvVar2 = *(void **)(this + 0x18);
        if (uVar5 != 0) goto LAB_001049b4;
        free(pvVar2);
        uVar4 = 0;
        pvVar2 = (void *)0x0;
      }
...
LAB_001048b6:
    ...
    if (uVar5 < uVar9) {
LAB_00104840:
      if (0x38e38e3 < (uint)uVar6) goto LAB_001047b7;
      pvVar2 = *(void **)(this + 0x28);
LAB_00104851:
      uVar8 = (uint)uVar6;
...
LAB_0010486d:
    ...
    if (uVar9 < uVar5 >> 2) {
      if (0x38e38e3 < uVar9) goto LAB_001047b7;
      pvVar2 = *(void **)(this + 0x28);
      if (uVar9 != 0) goto LAB_00104851;
      free(pvVar2);
      uVar8 = 0;
      pvVar2 = (void *)0x0;
      goto LAB_0010486d;
  ...
  if (iVar10 < 0) {
    ...
    do {
      while( true ) {
        ...
        iVar10 = uVar7 - 1;
        if (iVar10 < (int)uVar8) goto LAB_00104b4c;
      }
      if (uVar9 == uVar3) goto LAB_00104be5;
      uVar8 = uVar7 + 1;

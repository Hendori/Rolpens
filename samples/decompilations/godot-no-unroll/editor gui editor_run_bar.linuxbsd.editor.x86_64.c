...

{
  ...
  *(Button **)(this + 0xa28) = pBVar10;
  ...
  (*pcVar17)(plVar15,SceneStringNames::singleton + 0x238,(CowData<char32_t> *)local_98,0);
  ...
  *(BoxContainer **)(this + 0xa18) = pBVar9;
  ...
  if (*(char *)(lVar12 + 0xc4) != '\0') {
    ...
    *(AcceptDialog **)(this + 0xa48) = this_02;
    ...
    String::utf8((char *)local_d8,0x1084f0);
    local_e0 = 0;
    ...
    String::utf8((char *)local_f8,0x1085b2);
    local_100 = 0;
  ...
  *(Button **)(this + 0xa50) = pBVar10;
  ...
  ED_SHORTCUT_AND_COMMAND
            (&local_b8,(String *)&local_b0,(Callable *)local_a8,0x400020,
  ...
  ED_SHORTCUT_OVERRIDE((Callable *)local_a8,(CowData<char32_t> *)local_98,0x8000042,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_a8);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_98);
  ...
  *(Button **)(this + 0xa58) = pBVar10;
  ...
  ED_SHORTCUT((String *)&local_b0,(Callable *)local_a8,(CowData<char32_t> *)local_98,0x400022,0);
  ...
  local_a8[0] = (Object *)0x0;
  String::parse_latin1((String *)local_a8,"editor/pause_running_project");
  ED_SHORTCUT_OVERRIDE((Callable *)local_a8,(CowData<char32_t> *)local_98,0x18000059,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_a8);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_98);
  ...
  *(Button **)(this + 0xa60) = pBVar10;
  ...
  ED_SHORTCUT((String *)&local_b0,(Callable *)local_a8,(CowData<char32_t> *)local_98,0x400023,0);
  if (((local_b0 != (Object *)0x0) &&
      (cVar5 = RefCounted::unreference(), pOVar4 = local_b0, cVar5 != '\0')) &&
     (cVar5 = predelete_handler(local_b0), cVar5 != '\0')) {
    (**(code **)(*(long *)pOVar4 + 0x140))(pOVar4);
  ...
  local_a8[0] = (Object *)0x0;
  String::parse_latin1((String *)local_a8,"editor/stop_running_project");
  ED_SHORTCUT_OVERRIDE((Callable *)local_a8,(CowData<char32_t> *)local_98,0x800002e,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_a8);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_98);
  ...
  *(char **)(this_01 + 0x20) = "EditorRunBar::_run_native";
  ...
  (*pcVar17)(plVar15,(Callable *)local_a8,(CowData<char32_t> *)local_98,0);
...
LAB_00102a66:
    ...
    PopupMenu::add_item(plVar15,(CowData<char32_t> *)local_98,0,0);
    CowData<char32_t>::_unref((CowData<char32_t> *)local_98);
    local_98[0] = 0;
    String::parse_latin1((String *)local_98,"Run Scene in XR Mode");
    PopupMenu::add_item(plVar15,(CowData<char32_t> *)local_98,1,0);
    CowData<char32_t>::_unref((CowData<char32_t> *)local_98);
    pcVar17 = *(code **)(*plVar15 + 0x108);
    create_custom_callable_function_pointer<EditorRunBar,int>
              ((EditorRunBar *)local_98,(char *)this,
               (_func_void_int *)"&EditorRunBar::_play_current_pressed");
    (*pcVar17)(plVar15,SceneStringNames::singleton + 0x240,(CowData<char32_t> *)local_98,0);
    Callable::~Callable((Callable *)local_98);
  ...
  ED_SHORTCUT_AND_COMMAND
            (&local_b8,(String *)&local_b0,(Callable *)local_a8,0x400021,
             (CowData<char32_t> *)local_98);
  if (((local_b8 != (Object *)0x0) &&
  ...
  ED_SHORTCUT_OVERRIDE((Callable *)local_a8,(CowData<char32_t> *)local_98,0x8000052,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_a8);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_98);
  ...
  ED_SHORTCUT_AND_COMMAND
            (&local_b8,(String *)&local_b0,(Callable *)local_a8,0x12400020,
             (CowData<char32_t> *)local_98);
  ...
  ED_SHORTCUT_OVERRIDE((Callable *)local_a8,(CowData<char32_t> *)local_98,0xa000052,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_a8);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_98);
...
LAB_00102910:
  (*pcVar17)(plVar15,lVar12,(CowData<char32_t> *)local_98,0);
  Callable::~Callable((Callable *)local_98);
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
...
LAB_001050b8:
    ...
    *(undefined4 *)(this + 0xaa8) = 2;
    ...
    EditorToaster::popup_str(uVar4,(String *)&local_48,1,(CowData<char32_t> *)&local_50);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_50);
...

{
  ...
  if (*(char *)(lVar1 + 0xc4) == '\0') {
    ...
    *(undefined4 *)(param_1 + 0xaa8) = 3;
    ...
    String::parse_latin1((StrRange *)&local_50);
    TTR((String *)&local_48,(String *)&local_50);
    EditorToaster::popup_str(uVar2,(String *)&local_48,1,(CowData<char32_t> *)&local_60);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_50);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
...

{
  ...
  if (*(char *)(lVar1 + 0xc4) == '\0') {
    ...
    *(undefined4 *)(this + 0xaa8) = 1;
    ...
    EditorToaster::popup_str(uVar2,(String *)&local_48,1,(CowData<char32_t> *)&local_58);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_68);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_0010e400;
  CowData<char32_t>::_unref((CowData<char32_t> *)(this + 0xab8));
  CowData<char32_t>::_unref((CowData<char32_t> *)(this + 0xab0));
  CowData<char32_t>::_unref((CowData<char32_t> *)(this + 0xa88));

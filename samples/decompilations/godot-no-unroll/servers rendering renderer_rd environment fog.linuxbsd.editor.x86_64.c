...
/* RendererRD::Fog::FogShaderData::casts_shadows() const */

undefined8 RendererRD::Fog::FogShaderData::casts_shadows(void)
...
/* RendererRD::Fog::fog_volume_set_material(RID, RID) */

void __thiscall RendererRD::Fog::fog_volume_set_material(Fog *this,ulong param_2,undefined8 param_3)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x24))) {
    puVar2 = (undefined8 *)
             (((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x20)) * 0x50 +
             *(long *)(*(long *)(this + 0x10) +
  ...
  _err_print_error("fog_volume_set_material","servers/rendering/renderer_rd/environment/fog.cpp",
                   0x5f,"Parameter \"fog_volume\" is null.",0,0);
  return;
}



/* RendererRD::Fog::fog_volume_get_shape(RID) const */

undefined4 __thiscall RendererRD::Fog::fog_volume_get_shape(Fog *this,ulong param_2)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x24))) {
    lVar2 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x20)) * 0x50 +
            *(long *)(*(long *)(this + 0x10) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x20)) * 8);
  ...
  _err_print_error("fog_volume_get_shape","servers/rendering/renderer_rd/environment/fog.cpp",0x6c,
                   "Parameter \"fog_volume\" is null.",0,0);
  return 3;
}
...
/* RendererRD::Fog::fog_volume_get_aabb(RID) const */

undefined8 * RendererRD::Fog::fog_volume_get_aabb(undefined8 *param_1,long param_2,ulong param_3)

{
  ...
  if ((param_3 != 0) && ((uint)param_3 < *(uint *)(param_2 + 0x24))) {
    lVar4 = ((param_3 & 0xffffffff) % (ulong)*(uint *)(param_2 + 0x20)) * 0x50 +
    ...
    if (*(int *)(lVar4 + 0x48) == (int)(param_3 >> 0x20)) {
      if (*(uint *)(lVar4 + 0x14) < 4) {
        ...
        fVar7 = _UNK_0011d33c * (float)((ulong)*(undefined8 *)(lVar4 + 8) >> 0x20);
  ...
  _err_print_error("fog_volume_get_aabb","servers/rendering/renderer_rd/environment/fog.cpp",0x73,
                   "Parameter \"fog_volume\" is null.",0,0);
  *param_1 = 0;
...
/* RendererRD::Fog::fog_volume_set_shape(RID, RenderingServer::FogVolumeShape) */

void __thiscall RendererRD::Fog::fog_volume_set_shape(Fog *this,ulong param_2,int param_3)

{
  long lVar1;
  
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x24))) {
    lVar1 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x20)) * 0x50 +
            *(long *)(*(long *)(this + 0x10) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x20)) * 8);
  ...
  _err_print_error("fog_volume_set_shape","servers/rendering/renderer_rd/environment/fog.cpp",0x4b,
                   "Parameter \"fog_volume\" is null.",0,0);
  return;
}
...
/* RendererRD::Fog::fog_volume_set_size(RID, Vector3 const&) */

void __thiscall RendererRD::Fog::fog_volume_set_size(Fog *this,ulong param_2,undefined8 *param_3)

{
  ...
  _err_print_error("fog_volume_set_size","servers/rendering/renderer_rd/environment/fog.cpp",0x57,
                   "Parameter \"fog_volume\" is null.",0,0);
  return;
}
...
void __thiscall
RendererRD::Fog::FogMaterialData::update_parameters
          (FogMaterialData *this,HashMap *param_1,bool param_2,bool param_3)
...
LAB_00100760:
    ...
    lVar9 = ((uVar8 & 0xffffffff) % (ulong)*(uint *)(lVar5 + 0x698)) * 0xa0 +
            *(long *)(*(long *)(lVar5 + 0x688) +
                     ((uVar8 & 0xffffffff) / (ulong)*(uint *)(lVar5 + 0x698)) * 8);
...
LAB_0010061c:
  ...
  RendererRD::MaterialStorage::MaterialData::update_parameters_uniform_set
            (this,param_1,param_2,param_3,lVar5 + 0x10,*(undefined8 *)(lVar5 + 0xa0),lVar5 + 0x88,
             lVar5 + 0x40,*(undefined4 *)(lVar5 + 0xa8),this + 0xb0,uVar11,2,1,1);
  return;
}



/* RendererRD::Fog::FogMaterialData::~FogMaterialData() */

void __thiscall RendererRD::Fog::FogMaterialData::~FogMaterialData(FogMaterialData *this)

{
  *(undefined ***)this = &PTR_set_render_priority_001139b8;
...
/* RendererRD::Fog::FogShaderData::get_native_source_code() const */

void RendererRD::Fog::FogShaderData::get_native_source_code(void)
...
/* RendererRD::Fog::fog_volume_free(RID) */

ulong __thiscall RendererRD::Fog::fog_volume_free(Fog *this,ulong param_2)

{
  ...
  if (param_2 != 0) {
    if (uVar3 < *(uint *)(this + 0x24)) {
      lVar6 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x20)) * 0x50 +
              *(long *)(*(long *)(this + 0x10) +
                       ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x20)) * 8);
...
LAB_00100959:
  ...
  if (uVar2 == 0) {
    if (uVar3 < *(uint *)(this + 0x24)) {
      ...
      if (iVar1 < 0) {
        ...
        uVar4 = 0;
        _err_print_error(&_LC30,"./core/templates/rid_owner.h",0x16c,"Method/function failed.",
        ...
        *(uint *)(*(long *)(lVar6 + ((ulong)uVar2 / (ulong)*(uint *)(this + 0x20)) * 8) +
        ...
        pthread_mutex_unlock(__mutex);
        uVar4 = _err_print_error(&_LC30,"./core/templates/rid_owner.h",0x171,
                                 "Method/function failed.",0,0);
      }
    }
    else {
      pthread_mutex_unlock(__mutex);
      uVar4 = _err_print_error(&_LC30,"./core/templates/rid_owner.h",0x161,"Method/function failed."
                               ,0,0);
    }
    return uVar4;
  }
  ...
  *(undefined ***)this_00 = &PTR_set_render_priority_001139b8;
  RendererRD::MaterialStorage::MaterialData::free_parameters_uniform_set();
...
/* RendererRD::Fog::_create_fog_shader_funcs() */

void RendererRD::Fog::_create_fog_shader_funcs(void)

{
  ...
  puVar2[7] = uVar1;
  puVar2[0xd] = uVar1;
  *puVar2 = &PTR_set_path_hint_001139f0;
...
void __thiscall RendererRD::Fog::Fog(Fog *this)

{
  undefined8 uVar1;
  undefined8 uVar2;
  
  *(undefined ***)this = &PTR__Fog_00113958;
  *(undefined ***)(this + 8) = &PTR__RID_Alloc_00113918;
  uVar1 = _UNK_0011d498;
  uVar2 = __LC40;
  ...
  *(undefined ***)(this + 0x60) = &PTR__RID_Alloc_00113938;
  uVar1 = _UNK_0011d4a8;
  uVar2 = __LC41;
  ...
  *(undefined ***)(this + 0x5c8) = &PTR__VolumetricFogShaderRD_001138d8;
  ...
  *(undefined ***)(this + 0x770) = &PTR__VolumetricFogProcessShaderRD_001138f8;
...
/* RendererRD::Fog::fog_volume_get_dependency(RID) const */

long __thiscall RendererRD::Fog::fog_volume_get_dependency(Fog *this,ulong param_2)

{
  ...
  _err_print_error("fog_volume_get_dependency","servers/rendering/renderer_rd/environment/fog.cpp",
                   0x44,"Parameter \"fog_volume\" is null.",0,0);
  return 0;
}



/* RendererRD::Fog::fog_volume_get_material(RID) const */

undefined8 __thiscall RendererRD::Fog::fog_volume_get_material(Fog *this,ulong param_2)

{
  ...
  _err_print_error("fog_volume_get_material","servers/rendering/renderer_rd/environment/fog.cpp",
                   0x65,"Parameter \"fog_volume\" is null.",0,0);
  return 0;
}



/* RendererRD::Fog::fog_volume_get_size(RID) const */

undefined1  [16] __thiscall RendererRD::Fog::fog_volume_get_size(Fog *this,ulong param_2)

{
  ...
  _err_print_error("fog_volume_get_size","servers/rendering/renderer_rd/environment/fog.cpp",0x88,
                   "Parameter \"fog_volume\" is null.",0,0);
  local_14 = 0;
  local_1c = 0;
LAB_001011ab:
...
/* RendererRD::Fog::_create_fog_shader_func() */

void RendererRD::Fog::_create_fog_shader_func(void)
...
/* RendererRD::Fog::_create_fog_material_func(RendererRD::Fog::FogShaderData*) */

void __thiscall RendererRD::Fog::_create_fog_material_func(Fog *this,FogShaderData *param_1)

{
  ...
  puVar1[0x10] = 0;
  puVar1[0x14] = 0;
  *puVar1 = &PTR_set_render_priority_001139b8;
  puVar1[0x16] = 0;
  puVar1[0x15] = param_1;
...
/* RendererRD::Fog::_create_fog_material_funcs(RendererRD::MaterialStorage::ShaderData*) */

void RendererRD::Fog::_create_fog_material_funcs(ShaderData *param_1)
...
/* RendererRD::Fog::fog_instance_free(RID) */

void __thiscall RendererRD::Fog::fog_instance_free(Fog *this,ulong param_2)

{
  ...
  lVar1 = *(long *)(*(long *)(this + 0x68) +
          ...
          ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x78)) * 0x48;
  ...
  if (-1 < iVar2) {
    if ((int)(param_2 >> 0x20) == iVar2) {
      ...
      *(uint *)(*(long *)(*(long *)(this + 0x70) +
               ...
               ((ulong)uVar3 % (ulong)*(uint *)(this + 0x78)) * 4) = (uint)param_2;
      return;
    }
...
void __thiscall RendererRD::Fog::free_fog_shader(Fog *this)
...
/* RendererRD::Fog::VolumetricFog::sync_gi_dependent_sets_validity(bool) */

undefined8 __thiscall
RendererRD::Fog::VolumetricFog::sync_gi_dependent_sets_validity(VolumetricFog *this,bool param_1)

{
  ...
  if ((char)uVar1 != '\0') {
    ...
    uVar1 = RenderingDevice::get_singleton();
    RenderingDevice::free(uVar1,*(undefined8 *)(this + 0x1d0));
    uVar1 = RenderingDevice::get_singleton();
    RenderingDevice::free(uVar1,*(undefined8 *)(this + 0x1d8));
    uVar1 = RenderingDevice::get_singleton();
    RenderingDevice::free(uVar1,*(undefined8 *)(this + 0x1e0));
  }
...
/* RendererRD::Fog::VolumetricFog::~VolumetricFog() */

void __thiscall RendererRD::Fog::VolumetricFog::~VolumetricFog(VolumetricFog *this)

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_00113a60;
...
joined_r0x00101734:
  ...
  *(undefined ***)this = &PTR__initialize_classv_00113778;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* RendererRD::Fog::_point_get_position_in_froxel_volume(Vector3 const&, float, Vector2 const&,
   Vector2 const&, float, Vector3 const&, Transform3D const&) */

void RendererRD::Fog::_point_get_position_in_froxel_volume
               (Vector3 *param_1,float param_2,Vector2 *param_3,Vector2 *param_4,float param_5,
               Vector3 *param_6,Transform3D *param_7)

{
  ...
  fVar3 = fVar3 / param_2;
  auVar5._0_8_ = (double)(fVar4 * (float)local_68._0_4_ + fVar1 * (float)local_68._4_4_ +
                          fVar2 * local_60 + local_44);
  auVar5._8_8_ = (double)(float)((uint)(local_5c * fVar4 + local_58 * fVar1 + local_54 * fVar2 +
                                       local_40) ^ _LC10);
  dVar6 = (double)((float)*(undefined8 *)param_6 * fVar3) +
          (_LC50 - (double)fVar3) * (double)(float)*(undefined8 *)param_4;
  dVar8 = (double)((float)((ulong)*(undefined8 *)param_6 >> 0x20) * fVar3) +
          (_LC50 - (double)fVar3) * (double)(float)((ulong)*(undefined8 *)param_4 >> 0x20);
  ...
  local_78 = CONCAT44((float)((ulong)*(undefined8 *)param_7 >> 0x20) * (float)dVar8 + _UNK_0011d33c,
                      (float)*(undefined8 *)param_7 * (float)dVar6 + _LC14);
...

{
  ...
  *(undefined ***)(this + 0x5c8) = &PTR__VolumetricFogShaderRD_001138d8;
  ...
  if (*(long *)(this + 0x5b0) != 0) {
    LOCK();
    plVar1 = (long *)(*(long *)(this + 0x5b0) + -0x10);
    *plVar1 = *plVar1 + -1;
    UNLOCK();
    if (*plVar1 == 0) {
      lVar7 = *(long *)(this + 0x5b0);
...
LAB_00101e99:
  ...
  if (pvVar9 != (void *)0x0) {
    if ((*(int *)(this + 0x4d4) != 0) &&
       ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x4d0) * 4) == 0 ||
        (memset(*(void **)(this + 0x4c8),0,
                (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x4d0) * 4) * 4),
        *(int *)(this + 0x4d4) != 0)))) {
      lVar7 = 0;
      do {
...
LAB_00101f36:
  ...
  if (pvVar9 != (void *)0x0) {
    if ((*(int *)(this + 0x4ac) != 0) &&
       ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x4a8) * 4) == 0 ||
        (memset(*(void **)(this + 0x4a0),0,
                (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x4a8) * 4) * 4),
        *(int *)(this + 0x4ac) != 0)))) {
      lVar7 = 0;
      do {
        if ((StringName::configured != '\0') && (*(long *)((long)pvVar9 + lVar7 * 8) != 0)) {
...
LAB_00101fd6:
  ...
  if (pvVar9 != (void *)0x0) {
    if ((*(int *)(this + 0x484) != 0) &&
       ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x480) * 4) == 0 ||
        (memset(*(void **)(this + 0x478),0,
                (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x480) * 4) * 4),
        *(int *)(this + 0x484) != 0)))) {
      lVar7 = 0;
      do {
        if ((StringName::configured != '\0') && (*(long *)((long)pvVar9 + lVar7 * 8) != 0)) {
...
LAB_0010206e:
  ...
  if (pvVar9 != (void *)0x0) {
    if ((*(int *)(this + 0x45c) != 0) &&
       ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x458) * 4) == 0 ||
        (memset(*(void **)(this + 0x450),0,
                (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x458) * 4) * 4),
        *(int *)(this + 0x45c) != 0)))) {
      lVar7 = 0;
      do {
        if ((StringName::configured != '\0') && (*(long *)((long)pvVar9 + lVar7 * 8) != 0)) {
    ...
    if ((*(int *)(this + 0x434) != 0) &&
       ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x430) * 4) == 0 ||
        (memset(*(void **)(this + 0x428),0,
                (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x430) * 4) * 4),
        *(int *)(this + 0x434) != 0)))) {
      lVar7 = 0;
      do {
        if ((StringName::configured != '\0') && (*(long *)((long)pvVar9 + lVar7 * 8) != 0)) {
...
LAB_001021ae:
  ...
  if (pvVar9 != (void *)0x0) {
    if ((*(int *)(this + 0x40c) != 0) &&
       ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x408) * 4) == 0 ||
        (memset(*(void **)(this + 0x400),0,
                (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x408) * 4) * 4),
        *(int *)(this + 0x40c) != 0)))) {
      lVar7 = 0;
      do {
        if ((StringName::configured != '\0') && (*(long *)((long)pvVar9 + lVar7 * 8) != 0)) {
...
LAB_0010224e:
  if ((StringName::configured != '\0') &&
     (((*(long *)(this + 0x3e0) == 0 || (StringName::unref(), StringName::configured != '\0')) &&
      (*(long *)(this + 0x3d8) != 0)))) {
    StringName::unref();
  }
...
LAB_001026eb:
    if ((uint)uVar5 < uVar10) goto LAB_0010272b;
    lVar7 = 0;
    while( true ) {
...
/* RendererRD::Fog::fog_volume_allocate() */

void __thiscall RendererRD::Fog::fog_volume_allocate(Fog *this)

{
  RID_Alloc<RendererRD::Fog::FogVolume,true>::allocate_rid
            ((RID_Alloc<RendererRD::Fog::FogVolume,true> *)(this + 8));
  return;
}



/* RendererRD::Fog::fog_volume_instance_create(RID) */

void __thiscall RendererRD::Fog::fog_volume_instance_create(Fog *this,undefined8 param_2)

{
  ...
  local_58 = param_2;
  RID_Alloc<RendererRD::Fog::FogVolumeInstance,false>::make_rid
            ((RID_Alloc<RendererRD::Fog::FogVolumeInstance,false> *)(this + 0x60),
             (FogVolumeInstance *)&local_58);
...
/* RendererRD::Fog::FogShaderData::set_code(String const&) */

void __thiscall RendererRD::Fog::FogShaderData::set_code(FogShaderData *this,String *param_1)

{
  ...
  *puVar10 = 2;
  ...
  plVar11 = (long *)HashMap<StringName,bool*,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,bool*>>>
  ...
  *plVar11 = (long)(this + 0xb8);
  ...
  lVar17 = singleton;
  local_e8 = this + 0x10;
  iVar9 = ShaderCompiler::compile
                    (singleton + 0xc0,4,(CowData<char32_t> *)(this + 0xb0),local_1d8,this + 8);
  if (iVar9 == 0) {
    ...
    ShaderRD::version_set_compute_code
              (pVVar1,*(undefined8 *)(this + 0x78),plVar11,local_a0,local_90 + 8,local_d8);
    cVar8 = ShaderRD::version_is_valid(pVVar1);
    if (cVar8 == '\0') {
      _err_print_error("set_code","servers/rendering/renderer_rd/environment/fog.cpp",0x15a,
                       "Condition \"!fog_singleton->volumetric_fog.shader.version_is_valid(version)\" is true."
                       ,0,0);
      goto LAB_001036af;
    }
...
LAB_00103616:
      _err_print_index_error
                ("version_get_shader","./servers/rendering/renderer_rd/shader_rd.h",0xa6,0,lVar20,
                 "p_variant","variant_defines.size()","",false,false);
LAB_0010364f:
      uVar18 = 0;
    }
...
LAB_001038e0:
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,uVar13,lVar20,"p_index","size()","",false
                   ,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_00103a0a:
        ...
        lVar16 = ((uVar13 & 0xffffffff) % (ulong)*(uint *)(lVar17 + 0x698)) * 0xa0 +
                 *(long *)(*(long *)(lVar17 + 0x688) +
                          ((uVar13 & 0xffffffff) / (ulong)*(uint *)(lVar17 + 0x698)) * 8);
...
LAB_00103535:
    ...
    _err_print_error("set_code","servers/rendering/renderer_rd/environment/fog.cpp",0x153,
                     "Condition \"err != OK\" is true.","Fog shader compilation failed.",0,0);
LAB_001036af:
    local_200 = (CowData<char32_t> *)local_a0;
    plVar11 = &local_80;
    ShaderCompiler::IdentifierActions::~IdentifierActions((IdentifierActions *)local_1d8);
    if ((void *)local_78._0_8_ != (void *)0x0) {
      pvVar19 = (void *)local_78._0_8_;
...
/* RendererRD::Fog::FogShaderData::~FogShaderData() */

void __thiscall RendererRD::Fog::FogShaderData::~FogShaderData(FogShaderData *this)

{
  long *plVar1;
  long lVar2;
  
  *(undefined ***)this = &PTR_set_path_hint_001139f0;
  if (singleton == 0) {
    _err_print_error("~FogShaderData","servers/rendering/renderer_rd/environment/fog.cpp",0x175,
                     "Parameter \"fog_singleton\" is null.",0,0);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* RendererRD::Fog::volumetric_fog_update(RendererRD::Fog::VolumetricFogSettings const&, Projection
   const&, Transform3D const&, Transform3D const&, RID, int, bool, int, int, PagedArray<RID> const&)
    */

void __thiscall
RendererRD::Fog::volumetric_fog_update
          (Fog *this,int *param_1,undefined8 param_3_00,float *param_3,Transform3D *param_4,
          undefined8 param_6,undefined4 param_7,undefined8 param_8,undefined8 param_9,float param_10
          ,long param_11)

{
  ...
  if ((this_01 != (Object *)0x0) && (cVar23 = RefCounted::reference(), cVar23 == '\0')) {
    this_01 = (Object *)0x0;
  }
...
LAB_00103e94:
    ...
    fVar47 = (float)RendererSceneRender::environment_get_volumetric_fog_length
                              (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
    ...
    bVar24 = RendererSceneRender::environment_get_volumetric_fog_temporal_reprojection
                       (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
    ...
    local_140 = RendererSceneRender::environment_get_volumetric_fog_detail_spread
                          (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
    local_13c = RendererSceneRender::environment_get_volumetric_fog_temporal_reprojection_amount
                          (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
...
LAB_00106750:
      ...
      CowData<RID>::_unref((CowData<RID> *)local_2d8);
      uVar31 = RenderingDevice::get_singleton();
      uVar31 = RenderingDevice::uniform_set_create<Vector<RenderingDevice::Uniform>>
                         (uVar31,local_308,*(undefined8 *)(this + 0x758),1,0);
    ...
    if ((int)uVar33 < 1) {
LAB_001089e5:
      cVar23 = RendererSceneRender::environment_get_volumetric_fog_temporal_reprojection
      ...
      do {
        ...
        uVar33 = *(ulong *)(*(long *)(*(long *)(param_11 + 8) +
                                     (uVar43 >> ((byte)*(undefined4 *)(param_11 + 0x1c) & 0x3f)) * 8
                                     ) + (ulong)((uint)uVar43 & *(uint *)(param_11 + 0x20)) * 8);
        if ((uVar33 == 0) || (*(uint *)(this + 0x7c) <= (uint)uVar33)) {
LAB_00106b3b:
          _err_print_error("volumetric_fog_update",
                           "servers/rendering/renderer_rd/environment/fog.cpp",0x275,
                           "Parameter \"fog_volume_instance\" is null.",0,0);
LAB_001069b8:
        ...
        puVar4 = (undefined8 *)
                 (*(long *)(*(long *)(this + 0x68) +
                           ((uVar33 & 0xffffffff) / (ulong)*(uint *)(this + 0x78)) * 8) +
                 ((uVar33 & 0xffffffff) % (ulong)*(uint *)(this + 0x78)) * 0x48);
...
LAB_001043ce:
          uVar33 = *(ulong *)(this + 0x750);
          if ((uVar33 == 0) || (*(uint *)(lVar30 + 0x26c) <= (uint)uVar33)) {
LAB_00106993:
            _err_print_error("volumetric_fog_update",
                             "servers/rendering/renderer_rd/environment/fog.cpp",0x288,
                             "Parameter \"material\" is null.",0,0);
          }
          else {
            lVar36 = ((uVar33 & 0xffffffff) % (ulong)*(uint *)(lVar30 + 0x268)) * 0xc0 +
                     *(long *)(*(long *)(lVar30 + 600) +
                              ((uVar33 & 0xffffffff) / (ulong)*(uint *)(lVar30 + 0x268)) * 8);
            ...
            if ((*(int *)(lVar36 + 0x18) != 4) ||
               (local_3c0 = *(long *)(lVar36 + 8), local_3c0 == 0)) goto LAB_00106993;
            lVar36 = *(long *)(local_3c0 + 0xa8);
            if (lVar36 != 0) goto LAB_0010445f;
            _err_print_error("volumetric_fog_update",
                             "servers/rendering/renderer_rd/environment/fog.cpp",0x28c,
                             "Parameter \"shader_data\" is null.",0,0);
          }
          goto LAB_001069b8;
        }
        lVar36 = ((uVar33 & 0xffffffff) % (ulong)*(uint *)(lVar30 + 0x268)) * 0xc0 +
        ...
        if (((*(int *)(lVar36 + 0x18) != 4) || (local_3c0 = *(long *)(lVar36 + 8), local_3c0 == 0))
           || (lVar36 = *(long *)(local_3c0 + 0xa8), *(char *)(lVar36 + 0x70) == '\0'))
        goto LAB_001043ce;
LAB_0010445f:
        uVar34 = *(undefined8 *)((long)puVar4 + 0x2c);
...
LAB_00104559:
          ...
          fStack_37c = (float)local_1e8._4_4_ * _UNK_0011d38c;
          ...
          _local_1e8 = auVar117;
          fVar51 = (float)RendererSceneRender::environment_get_volumetric_fog_detail_spread
                                    (RendererSceneRenderRD::singleton,
          ...
          local_1f4 = CONCAT44((((float)((uint)(*(float *)(puVar4 + 3) * fVar107) ^ _LC117._4_4_) -
                                (float)((ulong)puVar4[2] >> 0x20) * fVar61) -
                               (float)((ulong)puVar4[3] >> 0x20) * local_38c) +
                               (float)((ulong)*(undefined8 *)((long)puVar4 + 0x2c) >> 0x20),
                               (((float)((uint)(*(float *)((long)puVar4 + 0xc) * fVar107) ^
                                        (uint)_LC117) - (float)puVar4[1] * fVar61) -
                               (float)puVar4[2] * local_38c) +
                               (float)*(undefined8 *)((long)puVar4 + 0x2c));
          ...
          fStack_220 = fStack_1fc +
                       *(float *)((long)puVar4 + 0x1c) * local_38c +
                       ((float)((uint)fVar110 ^ _LC10) - fVar52);
          ...
          do {
            ...
            iVar27 = iVar27 + 1;
            _local_1e8 = auVar21;
            auVar117 = _point_get_position_in_froxel_volume
                                 ((Vector3 *)this,fVar47,pVVar44,(Vector2 *)&local_298,fVar51,
                                  (Vector3 *)&local_290,(Transform3D *)&local_288);
          ...
          if (((((fVar77 - fVar63 < fVar46) && (fVar46 < fVar61 + fVar63)) &&
               (local_478 - fVar63 < fVar67)) &&
              ((fVar67 < fVar82 + fVar63 && ((float)local_468 - fVar63 < fVar60)))) &&
             (fVar60 < fVar63 + fVar83)) {
            pfVar35 = afStack_1e0;
            fVar61 = 1.4013e-45;
            do {
        ...
        if ((uVar28 != 0 && uVar80 != 0) && (fVar61 != 0.0)) {
          ...
          if (*(long *)(local_3c0 + 0xb0) != 0) {
            ...
            if (cVar23 != '\0') {
              uVar31 = RenderingDevice::get_singleton();
              RenderingDevice::compute_list_bind_uniform_set
                        (uVar31,pvVar32,*(undefined8 *)(local_3c0 + 0xb0),2);
      ...
      if (local_395 == 0) goto LAB_001089e5;
LAB_001045bd:
...
LAB_00104e05:
    ...
    local_2d8[0] = 0;
    lVar30 = RendererSceneRender::environment_get_sky
                       (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
    if (lVar30 == 0) {
LAB_00105249:
      local_2e8 = lVar29;
      ...
      uVar34 = RendererSceneRender::environment_get_sky
                         (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
...
LAB_0010822a:
      _err_print_index_error
                ("version_get_shader","./servers/rendering/renderer_rd/shader_rd.h",0xa6,4,lVar29,
                 "p_variant","variant_defines.size()","",false,false);
LAB_00108266:
      uVar34 = 0;
LAB_001053e4:
      uVar31 = RenderingDevice::uniform_set_create<Vector<RenderingDevice::Uniform>>
                         (uVar31,local_308,uVar34);
      *(undefined8 *)(this_01 + 0x1c8) = uVar31;
      if (cVar23 == '\0') {
        ...
        if (*(long *)(this + 0x788) != 0) {
          ...
          if (lVar29 < 4) goto LAB_00108273;
          lVar29 = *(long *)(this + 0x798);
          if (lVar29 != 0) {
            lVar30 = *(long *)(lVar29 + -8);
            if (lVar30 < 4) goto LAB_001083c6;
            if (*(char *)(lVar29 + 3) == '\0') {
...
LAB_00108af8:
            ...
            lVar29 = ((uVar33 & 0xffffffff) % (ulong)*(uint *)(this + 0x840)) * 0xa0 +
                     *(long *)(*(long *)(this + 0x830) +
                              ((uVar33 & 0xffffffff) / (ulong)*(uint *)(this + 0x840)) * 8);
...
LAB_00108273:
        _err_print_index_error
                  ("version_get_shader","./servers/rendering/renderer_rd/shader_rd.h",0xa6,3,lVar29,
                   "p_variant","variant_defines.size()","",false,false);
LAB_001082af:
        uVar34 = 0;
LAB_0010554b:
        uVar31 = RenderingDevice::uniform_set_create<Vector<RenderingDevice::Uniform>>
                           (uVar31,local_318,uVar34,0);
...
LAB_00108958:
          ...
          if (7 < (long)uVar33) {
            CowData<RenderingDevice::Uniform>::_copy_on_write
                      ((CowData<RenderingDevice::Uniform> *)&local_310);
...
LAB_00108444:
            ...
            if (lVar29 == 0) {
              ...
              if (plVar2 == (long *)0x0) goto LAB_001089c0;
              lVar30 = plVar2[-1];
              if (lVar30 < 1) goto LAB_001089c3;
              lVar29 = *plVar2;
            }
            uVar33 = *(ulong *)(local_310 + -8);
            if ((long)uVar33 < 8) goto LAB_0010895b;
            CowData<RenderingDevice::Uniform>::_copy_on_write
                      ((CowData<RenderingDevice::Uniform> *)&local_310);
            lVar30 = local_310;
...
LAB_0010565b:
            uVar33 = *(ulong *)(local_310 + -8);
            if ((long)uVar33 < 9) goto LAB_00108444;
            CowData<RenderingDevice::Uniform>::_copy_on_write
                      ((CowData<RenderingDevice::Uniform> *)&local_310);
            lVar29 = local_310;
            if (*(long *)(local_310 + 0x150) == 0) {
              if (*(long *)(local_310 + 0x160) == 0) goto LAB_00108b3e;
              uVar33 = *(ulong *)(*(long *)(local_310 + 0x160) + -8);
              if ((long)uVar33 < 1) goto LAB_00108b41;
...
LAB_00108307:
              _err_print_index_error
                        ("version_get_shader","./servers/rendering/renderer_rd/shader_rd.h",0xa6,3,
...
LAB_001057cc:
            uVar31 = RenderingDevice::uniform_set_create<Vector<RenderingDevice::Uniform>>
                               (uVar31,local_318,uVar34);
            *(undefined8 *)(this_01 + 0x1e0) = uVar31;
            if (local_310 == 0) {
              lVar29 = 0;
LAB_00108b66:
              _err_print_index_error
                        ("remove_at","./core/templates/cowdata.h",0xe4,8,lVar29,"p_index","size()",
                         "",false,false);
            }
            else {
              lVar29 = *(long *)(local_310 + -8);
              if (lVar29 < 9) goto LAB_00108b66;
              CowData<RenderingDevice::Uniform>::_copy_on_write
                        ((CowData<RenderingDevice::Uniform> *)&local_310);
              if (local_310 == 0) {
                lVar29 = -1;
              ...
              CowData<RenderingDevice::Uniform>::resize<false>
                        ((CowData<RenderingDevice::Uniform> *)&local_310,lVar29);
            }
            if (local_310 == 0) goto LAB_00108958;
            uVar33 = *(ulong *)(local_310 + -8);
            if ((long)uVar33 < 8) goto LAB_0010895b;
            CowData<RenderingDevice::Uniform>::_copy_on_write
                      ((CowData<RenderingDevice::Uniform> *)&local_310);
            lVar29 = local_310;
            if (*(long *)(local_310 + 0x128) == 0) {
              if (*(long *)(local_310 + 0x138) == 0) goto LAB_00108b3e;
              uVar33 = *(ulong *)(*(long *)(local_310 + 0x138) + -8);
              if ((long)uVar33 < 1) goto LAB_00108b41;
              CowData<RID>::_copy_on_write((CowData<RID> *)(local_310 + 0x138));
...
LAB_00108e3e:
                ...
                if (puVar7 == (uint *)0x0) goto LAB_001089c0;
                ...
                if (*(char *)(lVar29 + 0x90) != '\0') {
                  ...
                  if (puVar4 == (undefined8 *)0x0) goto LAB_001089c0;
                  lVar30 = puVar4[-1];
                  if (0 < lVar30) {
                    uVar34 = *puVar4;
                    goto LAB_00105a35;
...
LAB_0010895b:
        lVar29 = 7;
LAB_00108464:
        pcVar118 = "((Vector<T> *)(this))->_cowdata.size()";
        iVar27 = 0x38;
        pcVar42 = "./core/templates/vector.h";
LAB_00107a3a:
        _err_print_index_error
                  ("operator[]",pcVar42,iVar27,lVar29,uVar33,"p_index",pcVar118,"",false,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_001082d8:
    ...
    lVar29 = *(long *)(*(long *)(this + 0x830) +
                      ((uVar33 & 0xffffffff) / (ulong)*(uint *)(this + 0x840)) * 8) +
             ((uVar33 & 0xffffffff) % (ulong)*(uint *)(this + 0x840)) * 0xa0;
    if (*(int *)(lVar29 + 0x98) != (int)(uVar33 >> 0x20)) {
      if (*(int *)(lVar29 + 0x98) + 0x80000000U < 0x7fffffff) {
        _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                         "Method/function failed. Returning: nullptr",
...
LAB_00105a65:
  fVar48 = (float)RendererSceneRender::environment_get_volumetric_fog_gi_inject
                            (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
  if (__LC139 < (double)fVar48) {
    cVar23 = RendererSceneRender::environment_get_sdfgi_enabled
                       (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
...
LAB_001081a3:
            _err_print_index_error
                      ("get","./core/templates/cowdata.h",0xdb,uVar33,lVar30,"p_index","size()","",
                       false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
            pcVar8 = (code *)invalidInstructionException();
...
LAB_00108ed0:
            ...
            if (*(int *)(lVar29 + 0x98) != (int)(uVar33 >> 0x20)) {
              ...
              if (uVar28 < 0x7fffffff) {
                _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                                 "Method/function failed. Returning: nullptr",
                                 "Attempting to use an uninitialized RID",0,0,uVar28);
              }
              goto LAB_00108ed0;
            }
            pVVar3 = (Version *)(this + 0x770);
...
LAB_001088d3:
  ...
  cVar23 = '\0';
LAB_00105a94:
  uVar49 = RendererSceneRender::environment_get_volumetric_fog_length
                     (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
  ...
  *(undefined4 *)(this_01 + 0x18c) = uVar49;
  ...
  fVar48 = (float)RendererSceneRender::environment_get_volumetric_fog_ambient_inject
                            (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
  fVar50 = (float)RendererSceneRender::environment_get_ambient_light_energy
                            (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
  local_168._8_4_ = fVar46;
  auVar98 = _local_168;
  ...
  auVar117 = RendererSceneRender::environment_get_ambient_light
                       (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
  ...
  local_150 = fVar48;
  local_14c = RendererSceneRender::environment_get_ambient_sky_contribution
                        (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
  local_148 = *(ulong *)(this_01 + 0x17c);
  local_140 = *(undefined4 *)(this_01 + 0x184);
  local_13c = param_7;
  auVar117 = RendererSceneRender::environment_get_volumetric_fog_emission
                       (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
  ...
  fVar50 = (float)RendererSceneRender::environment_get_volumetric_fog_emission_energy
                            (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
  local_138 = CONCAT44(local_138._4_4_,fVar50 * fVar48);
  fVar48 = (float)RendererSceneRender::environment_get_volumetric_fog_emission_energy
                            (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
  local_138 = CONCAT44(fVar48 * (float)local_468,(undefined4)local_138);
  local_130 = (float)RendererSceneRender::environment_get_volumetric_fog_emission_energy
                               (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
  local_130 = local_130 * local_478;
  local_12c = RendererSceneRender::environment_get_volumetric_fog_density
                        (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
  auVar117 = RendererSceneRender::environment_get_volumetric_fog_scattering
                       (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
  fVar48 = auVar117._8_4_;
  if (_LC141 <= fVar48) {
    fVar48 = powf((float)(((double)fVar48 + __LC143) * __LC144),_LC145);
  ...
  local_120 = fVar48;
  local_11c = RendererSceneRender::environment_get_volumetric_fog_anisotropy
                        (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
  local_118 = (float)RendererSceneRender::environment_get_volumetric_fog_detail_spread
                               (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
  local_114 = (float)RendererSceneRender::environment_get_volumetric_fog_gi_inject
                               (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
  local_dc = 0;
  local_cc = 0;
  local_bc = 0;
  ...
  local_90 = local_1c8;
  local_80 = uStack_1bc;
  bVar26 = RendererSceneRender::environment_get_volumetric_fog_temporal_reprojection
                     (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
  local_f4 = (float)(uint)bVar26;
  local_ec = RendererSceneRender::environment_get_volumetric_fog_temporal_reprojection_amount
                       (RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
  ...
  RendererSceneRender::environment_get_sky_orientation
            (&local_278,RendererSceneRenderRD::singleton,*(undefined8 *)(param_1 + 0x20));
  Basis::inverse();
  fVar45 = *param_3;
  fVar46 = param_3[1];
  fVar47 = param_3[3];
  ...
  local_78 = CONCAT44(uStack_240._4_4_ * (float)*(undefined8 *)param_3 + local_238 * fVar116 +
                      fStack_234 * (float)*(undefined8 *)(param_3 + 6),
                      (float)local_248 * (float)*(undefined8 *)param_3 + local_248._4_4_ * fVar116 +
                      fVar60 * (float)*(undefined8 *)(param_3 + 6));
  local_278 = fVar50 * fVar60 + local_248._4_4_ * fVar47 + (float)local_248 * fVar45;
  fStack_274 = (float)((ulong)*(undefined8 *)(param_3 + 6) >> 0x20) * fVar60 +
               local_248._4_4_ * fVar67 + (float)local_248 * fVar46;
  ...
  RenderingDevice::compute_list_bind_compute_pipeline
            (uVar34,uVar31,*(undefined8 *)(this + (long)local_420 * 8 + 0x8f0));
  uVar34 = RenderingDevice::get_singleton();
  ...
  RenderingDevice::compute_list_dispatch_threads
            (lVar29,uVar28,*(uint *)(this_01 + 0x17c),*(uint *)(this_01 + 0x180));
  lVar29 = RenderingDevice::get_singleton();
  ...
  if ((char)param_1[6] != '\0') {
    ...
    lVar29 = RenderingDevice::get_singleton();
    RenderingDevice::compute_list_dispatch_threads
              (lVar29,(uint)uVar31,*(uint *)(this_01 + 0x17c),*(uint *)(this_01 + 0x180));
    lVar29 = RenderingDevice::get_singleton();
    RenderingDevice::compute_list_add_barrier(lVar29);
    RenderingDevice::get_singleton();
    RenderingDevice::draw_command_end_label();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* RendererRD::Fog::VolumetricFog::init(Vector3i const&, RID) */

void __thiscall
RendererRD::Fog::VolumetricFog::init(VolumetricFog *this,undefined8 *param_1,undefined8 param_3)

{
  ...
  *(undefined8 *)(this + 0x1b8) = uVar4;
  ...
  local_a8 = 0;
  Vector<RenderingDevice::Uniform>::push_back
            ((Vector<RenderingDevice::Uniform> *)&local_d8,(Vector *)&local_c8);
  uVar4 = RenderingDevice::get_singleton();
  uVar4 = RenderingDevice::uniform_set_create<Vector<RenderingDevice::Uniform>>
                    (uVar4,(StrRange *)&local_d8,param_3,3,0);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* RendererRD::Fog::init_fog_shader(unsigned int, int, bool) */

void __thiscall RendererRD::Fog::init_fog_shader(Fog *this,uint param_1,int param_2,bool param_3)

{
  ...
  itos((long)&local_230);
  operator+((char *)&local_138,(String *)"#define SAMPLERS_BINDING_FIRST_INDEX ");
  ...
  RendererRD::MaterialStorage::material_set_data_request_function
            (plVar18,4,_create_fog_material_funcs);
...
LAB_00109fe4:
  if (local_200._4_4_ != 0) {
    for (puVar3 = (undefined8 *)local_210._0_8_; puVar3 != (undefined8 *)0x0;
        puVar3 = (undefined8 *)*puVar3) {
      HashMap<StringName,String,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,String>>>
      ::insert((StringName *)&local_230,(String *)&local_138,(bool)((char)puVar3 + '\x10'));
    }
  }
  local_e0 = 0;
  local_100 = (undefined1  [16])0x0;
...
LAB_0010a244:
  ...
  *(undefined8 *)(this + 0x750) = uVar19;
  ...
  plVar24 = plVar18;
  (**(code **)(*plVar18 + 0xe8))
            (plVar18,*(undefined8 *)(this + 0x750),*(undefined8 *)(this + 0x748));
...
LAB_0010d218:
  ...
  lVar22 = ((uVar21 & 0xffffffff) % (ulong)*(uint *)(plVar18 + 0x4d)) * 0xc0 +
  ...
  if (*(int *)(lVar22 + 0x18) != 4) goto LAB_0010d218;
  uVar21 = *(ulong *)(*(long *)(*(long *)(lVar22 + 8) + 0xa8) + 0x78);
  if (*(long *)(this + 0x5e0) == 0) {
    lVar22 = 0;
LAB_0010afb7:
    _err_print_index_error
              ("version_get_shader","./servers/rendering/renderer_rd/shader_rd.h",0xa6,0,lVar22,
               "p_variant","variant_defines.size()","",false,false);
  }
  else {
    lVar22 = *(long *)(*(long *)(this + 0x5e0) + -8);
    if (lVar22 < 1) goto LAB_0010afb7;
...
LAB_0010af11:
      _err_print_index_error
                ("get","./core/templates/cowdata.h",0xdb,uVar21,lVar22,"p_index","size()","",false,
                 true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
      pcVar4 = (code *)invalidInstructionException();
...
LAB_0010b080:
    ...
    lVar27 = ((uVar21 & 0xffffffff) % (ulong)*(uint *)(this + 0x698)) * 0xa0 +
             *(long *)(*(long *)(this + 0x688) +
                      ((uVar21 & 0xffffffff) / (ulong)*(uint *)(this + 0x698)) * 8);
    ...
    if (puVar6 == (uint *)0x0) goto LAB_0010b0b0;
...
LAB_0010b120:
    ...
    if (lVar22 <= (long)uVar21) goto LAB_0010af11;
    ...
    if (cVar2 != '\0') {
      ...
      if (puVar3 == (undefined8 *)0x0) goto LAB_0010b0b0;
      lVar22 = puVar3[-1];
      if (0 < lVar22) {
        uVar19 = *puVar3;
        goto LAB_0010a5b1;
...
LAB_0010a5b1:
  *(undefined8 *)(this + 0x758) = uVar19;
  ...
  uVar19 = RenderingDevice::uniform_set_create<Vector<RenderingDevice::Uniform>>
                     (uVar19,(StrRange *)&local_228,*(undefined8 *)(this + 0x758),0);
  *(undefined8 *)(this + 0x760) = uVar19;
  ...
  String::parse_latin1((StrRange *)&local_228);
  itos((long)&local_238);
  operator+((char *)&local_230,(String *)"\n#define MAX_SKY_LOD ");
...
LAB_0010b0db:
      _err_print_index_error
                ("version_get_shader","./servers/rendering/renderer_rd/shader_rd.h",0xa6,uVar28,
                 lVar22,"p_variant","variant_defines.size()","",false,false);
      uVar26 = 0;
    }
    else {
      lVar22 = *(long *)(*(long *)(this + 0x788) + -8);
      if (lVar22 <= (long)uVar28) goto LAB_0010b0db;
      lVar27 = *(long *)(this + 0x798);
      uVar21 = uVar28;
      if (lVar27 == 0) goto LAB_0010aef0;
      lVar22 = *(long *)(lVar27 + -8);
      if (lVar22 <= (long)uVar28) goto LAB_0010af11;
...
LAB_0010b190:
        ...
        lVar27 = ((uVar7 & 0xffffffff) % (ulong)*(uint *)(this + 0x840)) * 0xa0 +
                 *(long *)(*(long *)(this + 0x830) +
                          ((uVar7 & 0xffffffff) / (ulong)*(uint *)(this + 0x840)) * 8);
...
LAB_0010ac1b:
    uVar19 = RenderingDevice::compute_pipeline_create(uVar19,uVar26,(String *)&local_138);
...
/* RendererRD::Fog::fog_volume_initialize(RID) */

void __thiscall RendererRD::Fog::fog_volume_initialize(Fog *this,undefined8 param_2)

{
  ...
  RID_Alloc<RendererRD::Fog::FogVolume,true>::initialize_rid
            ((RID_Alloc<RendererRD::Fog::FogVolume,true> *)(this + 8),param_2,&local_58);
...
{
  return (uint)CONCAT71(0x11d1,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x11d1,(undefined4 *)param_1 == &get_class_ptr_static()::ptr);
}
...
/* RendererRD::Fog::FogMaterialData::set_render_priority(int) */

void RendererRD::Fog::FogMaterialData::set_render_priority(int param_1)
...
/* RendererRD::Fog::FogMaterialData::set_next_pass(RID) */

void RendererRD::Fog::FogMaterialData::set_next_pass(void)
...
/* RendererRD::Fog::VolumetricFog::is_class_ptr(void*) const */

uint __thiscall RendererRD::Fog::VolumetricFog::is_class_ptr(VolumetricFog *this,void *param_1)

{
  return (uint)CONCAT71(0x11d1,(undefined4 *)param_1 ==
                               &RenderBufferCustomDataRD::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x113b,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x11d1,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x11d1,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}



/* RendererRD::Fog::VolumetricFog::_getv(StringName const&, Variant&) const */

undefined8 RendererRD::Fog::VolumetricFog::_getv(StringName *param_1,Variant *param_2)
...
/* RendererRD::Fog::VolumetricFog::_setv(StringName const&, Variant const&) */

undefined8 RendererRD::Fog::VolumetricFog::_setv(StringName *param_1,Variant *param_2)
...
/* RendererRD::Fog::VolumetricFog::_validate_propertyv(PropertyInfo&) const */

void RendererRD::Fog::VolumetricFog::_validate_propertyv(PropertyInfo *param_1)
...
/* RendererRD::Fog::VolumetricFog::_property_can_revertv(StringName const&) const */

undefined8 RendererRD::Fog::VolumetricFog::_property_can_revertv(StringName *param_1)
...
/* RendererRD::Fog::VolumetricFog::_property_get_revertv(StringName const&, Variant&) const */

undefined8
RendererRD::Fog::VolumetricFog::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* RendererRD::Fog::VolumetricFog::_notificationv(int, bool) */

void RendererRD::Fog::VolumetricFog::_notificationv(int param_1,bool param_2)
...
/* RendererRD::Fog::VolumetricFog::configure(RenderSceneBuffersRD*) */

void RendererRD::Fog::VolumetricFog::configure(RenderSceneBuffersRD *param_1)
...
/* RendererRD::Fog::VolumetricFog::free_data() */

void RendererRD::Fog::VolumetricFog::free_data(void)
...
/* VolumetricFogShaderRD::~VolumetricFogShaderRD() */

void __thiscall VolumetricFogShaderRD::~VolumetricFogShaderRD(VolumetricFogShaderRD *this)

{
  *(undefined ***)this = &PTR__VolumetricFogShaderRD_001138d8;
...
/* VolumetricFogProcessShaderRD::~VolumetricFogProcessShaderRD() */

void __thiscall
VolumetricFogProcessShaderRD::~VolumetricFogProcessShaderRD(VolumetricFogProcessShaderRD *this)

{
  *(undefined ***)this = &PTR__VolumetricFogProcessShaderRD_001138f8;
  ShaderRD::~ShaderRD((ShaderRD *)this);
  return;
}
...
/* RendererRD::Fog::VolumetricFog::_get_class_namev() const */

undefined8 * RendererRD::Fog::VolumetricFog::_get_class_namev(void)
...
LAB_0010bfd3:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"VolumetricFog");
      goto LAB_0010c03e;
    }
  }
  StringName::assign_static_unique_class_name
...
/* RendererRD::Fog::VolumetricFog::get_class() const */

void RendererRD::Fog::VolumetricFog::get_class(void)
...
/* RendererRD::Fog::VolumetricFog::is_class(String const&) const */

undefined8 __thiscall RendererRD::Fog::VolumetricFog::is_class(VolumetricFog *this,String *param_1)
...
/* RendererRD::Fog::VolumetricFog::_initialize_classv() */

void RendererRD::Fog::VolumetricFog::_initialize_classv(void)

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialize_class()::initialized != '\0') goto LAB_0010d03a;
...
/* RendererRD::Fog::init_fog_shader(unsigned int, int, bool) [clone .cold] */

void RendererRD::Fog::init_fog_shader(uint param_1,int param_2,bool param_3)
...
LAB_0010d3d8:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_0010d3d8;
    StringName::StringName((StringName *)&local_80,(CowData<char32_t> *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x0010d3f5;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
void __thiscall
RendererRD::Fog::VolumetricFog::_get_property_listv(VolumetricFog *this,List *param_1,bool param_2)
...
LAB_0010d828:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_0010d828;
    StringName::StringName((StringName *)&local_80,(CowData<char32_t> *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x0010d845;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
  ...
  if (pvVar5 != (void *)0x0) {
    if (*(int *)(this + 0xbc) != 0) {
      ...
      if (uVar2 == 0) {
        ...
        *(undefined4 *)(this + 0xbc) = 0;
        *(undefined1 (*) [16])(this + 0xa8) = (undefined1  [16])0x0;
        if (pvVar5 == (void *)0x0) goto LAB_0010dc43;
      }
    }
    Memory::free_static(pvVar5,false);
  ...
  if (pvVar5 != (void *)0x0) {
    if (*(int *)(this + 0x8c) != 0) {
      ...
      if (uVar2 == 0) {
        ...
        *(undefined4 *)(this + 0x8c) = 0;
        *(undefined1 (*) [16])(this + 0x78) = (undefined1  [16])0x0;
        if (pvVar5 == (void *)0x0) goto LAB_0010dd22;
      }
    }
    Memory::free_static(pvVar5,false);
    Memory::free_static(*(void **)(this + 0x70),false);
  ...
  if (pvVar5 != (void *)0x0) {
    if (*(int *)(this + 0x5c) != 0) {
      ...
      if (uVar2 == 0) {
        ...
        *(undefined4 *)(this + 0x5c) = 0;
        *(undefined1 (*) [16])(this + 0x48) = (undefined1  [16])0x0;
        if (pvVar5 == (void *)0x0) goto LAB_0010ddfd;
      }
    }
    Memory::free_static(pvVar5,false);
  ...
  if (pvVar3 != (void *)0x0) {
    if (*(int *)(this + 0xec) != 0) {
      ...
      if (uVar1 == 0) {
        ...
        *(undefined4 *)(this + 0xec) = 0;
        *(undefined1 (*) [16])(this + 0xd8) = (undefined1  [16])0x0;
        if (pvVar3 == (void *)0x0) goto LAB_0010e0fc;
      }
    }
    Memory::free_static(pvVar3,false);
  ...
  if (pvVar3 != (void *)0x0) {
    if (*(int *)(this + 0xbc) != 0) {
      ...
      if (uVar1 == 0) {
        ...
        *(undefined4 *)(this + 0xbc) = 0;
        *(undefined1 (*) [16])(this + 0xa8) = (undefined1  [16])0x0;
        if (pvVar3 == (void *)0x0) goto LAB_0010e1bc;
      }
    }
    Memory::free_static(pvVar3,false);
    Memory::free_static(*(void **)(this + 0xa0),false);
  ...
  if (pvVar3 != (void *)0x0) {
    if (*(int *)(this + 0x8c) != 0) {
      ...
      if (uVar1 == 0) {
        ...
        *(undefined4 *)(this + 0x8c) = 0;
        *(undefined1 (*) [16])(this + 0x78) = (undefined1  [16])0x0;
        if (pvVar3 == (void *)0x0) goto LAB_0010e273;
      }
    }
    Memory::free_static(pvVar3,false);
    Memory::free_static(*(void **)(this + 0x70),false);
  ...
  if (pvVar3 != (void *)0x0) {
    if (*(int *)(this + 0x5c) != 0) {
      ...
      if (uVar1 == 0) {
        ...
        *(undefined4 *)(this + 0x5c) = 0;
        *(undefined1 (*) [16])(this + 0x48) = (undefined1  [16])0x0;
        if (pvVar3 == (void *)0x0) goto LAB_0010e31e;
      }
    }
    Memory::free_static(pvVar3,false);
    Memory::free_static(*(void **)(this + 0x40),false);
...
/* WARNING: Removing unreachable block (ram,0x0010e668) */
/* WARNING: Removing unreachable block (ram,0x0010e798) */
/* WARNING: Removing unreachable block (ram,0x0010e960) */
/* WARNING: Removing unreachable block (ram,0x0010e7a4) */
/* WARNING: Removing unreachable block (ram,0x0010e7ae) */
/* WARNING: Removing unreachable block (ram,0x0010e940) */
/* WARNING: Removing unreachable block (ram,0x0010e7ba) */
/* WARNING: Removing unreachable block (ram,0x0010e7c4) */
/* WARNING: Removing unreachable block (ram,0x0010e920) */
/* WARNING: Removing unreachable block (ram,0x0010e7d0) */
/* WARNING: Removing unreachable block (ram,0x0010e7da) */
/* WARNING: Removing unreachable block (ram,0x0010e900) */
/* WARNING: Removing unreachable block (ram,0x0010e7e6) */
/* WARNING: Removing unreachable block (ram,0x0010e7f0) */
/* WARNING: Removing unreachable block (ram,0x0010e8e0) */
/* WARNING: Removing unreachable block (ram,0x0010e7fc) */
/* WARNING: Removing unreachable block (ram,0x0010e806) */
/* WARNING: Removing unreachable block (ram,0x0010e8c0) */
/* WARNING: Removing unreachable block (ram,0x0010e812) */
/* WARNING: Removing unreachable block (ram,0x0010e81c) */
/* WARNING: Removing unreachable block (ram,0x0010e8a0) */
/* WARNING: Removing unreachable block (ram,0x0010e824) */
/* WARNING: Removing unreachable block (ram,0x0010e83a) */
/* WARNING: Removing unreachable block (ram,0x0010e846) */
...
LAB_0010ef54:
    ...
    iVar46 = *(int *)(this + 0x2c);
    if (pvVar44 == (void *)0x0) goto LAB_0010eb83;
    if (iVar46 != 0) goto LAB_0010ef54;
LAB_0010eba9:
    ...
    *(void **)(this + 8) = __s_00;
    ...
    if (iVar46 != 0) {
      ...
      if (lVar43 == 0) goto LAB_0010f098;
LAB_0010ef48:
      iVar46 = *(int *)(this + 0x2c);
      goto LAB_0010ef4c;
    }
LAB_0010eb83:
    if ((float)uVar40 * __LC60 < (float)(iVar46 + 1)) goto LAB_0010eba9;
  }
...
LAB_0010f6c4:
    ...
    iVar46 = *(int *)(this + 0x2c);
    if (pvVar44 == (void *)0x0) goto LAB_0010f2f3;
    if (iVar46 != 0) goto LAB_0010f6c4;
LAB_0010f319:
    uVar38 = *(uint *)(this + 0x28);
    if (uVar38 == 0x1c) {
      puVar42 = (undefined8 *)0x0;
    ...
    *(void **)(this + 8) = __s_00;
    ...
    if (iVar46 != 0) {
      ...
      uVar40 = (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x28) * 4);
      if (lVar43 == 0) goto LAB_0010f808;
LAB_0010f6b8:
      iVar46 = *(int *)(this + 0x2c);
      goto LAB_0010f6bc;
    }
LAB_0010f2f3:
    if ((float)uVar40 * __LC60 < (float)(iVar46 + 1)) goto LAB_0010f319;
  }
  StringName::StringName((StringName *)&local_58,param_1);
  local_50 = 0;
  puVar42 = (undefined8 *)operator_new(0x20,"");
...
/* WARNING: Removing unreachable block (ram,0x0010fab0) */
/* WARNING: Removing unreachable block (ram,0x0010fbe0) */
/* WARNING: Removing unreachable block (ram,0x0010fd59) */
/* WARNING: Removing unreachable block (ram,0x0010fbec) */
/* WARNING: Removing unreachable block (ram,0x0010fbf6) */
/* WARNING: Removing unreachable block (ram,0x0010fd3b) */
/* WARNING: Removing unreachable block (ram,0x0010fc02) */
/* WARNING: Removing unreachable block (ram,0x0010fc0c) */
/* WARNING: Removing unreachable block (ram,0x0010fd1d) */
/* WARNING: Removing unreachable block (ram,0x0010fc18) */
/* WARNING: Removing unreachable block (ram,0x0010fc22) */
/* WARNING: Removing unreachable block (ram,0x0010fcff) */
/* WARNING: Removing unreachable block (ram,0x0010fc2e) */
/* WARNING: Removing unreachable block (ram,0x0010fc38) */
/* WARNING: Removing unreachable block (ram,0x0010fce1) */
/* WARNING: Removing unreachable block (ram,0x0010fc44) */
/* WARNING: Removing unreachable block (ram,0x0010fc4e) */
/* WARNING: Removing unreachable block (ram,0x0010fcc3) */
/* WARNING: Removing unreachable block (ram,0x0010fc56) */
/* WARNING: Removing unreachable block (ram,0x0010fc60) */
/* WARNING: Removing unreachable block (ram,0x0010fca8) */
/* WARNING: Removing unreachable block (ram,0x0010fc68) */
/* WARNING: Removing unreachable block (ram,0x0010fc7e) */
/* WARNING: Removing unreachable block (ram,0x0010fc8a) */
...
/* RID_Alloc<RendererRD::Fog::FogVolume, true>::~RID_Alloc() */

void __thiscall
RID_Alloc<RendererRD::Fog::FogVolume,true>::~RID_Alloc
          (RID_Alloc<RendererRD::Fog::FogVolume,true> *this)

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  *(undefined ***)this = &PTR__RID_Alloc_00113918;
...
LAB_0010feeb:
    if ((uint)uVar4 < uVar8) goto LAB_0010ff2b;
    lVar7 = 0;
    while( true ) {
...
/* RID_Alloc<RendererRD::Fog::FogVolumeInstance, false>::~RID_Alloc() */

void __thiscall
RID_Alloc<RendererRD::Fog::FogVolumeInstance,false>::~RID_Alloc
          (RID_Alloc<RendererRD::Fog::FogVolumeInstance,false> *this)
...

{
  ...
  *(undefined ***)this = &PTR__RID_Alloc_00113918;
  ...
  if (uVar8 == 0) {
    ...
    puVar5 = *(undefined8 **)(this + 8);
LAB_0011048b:
    if ((uint)uVar4 < uVar8) goto LAB_001104cb;
    lVar7 = 0;
    while( true ) {
      Memory::free_static((void *)puVar5[lVar7],false);
      lVar2 = lVar7 * 8;
...
ulong __thiscall
RID_Alloc<RendererRD::Fog::FogVolumeInstance,false>::make_rid
          (RID_Alloc<RendererRD::Fog::FogVolumeInstance,false> *this,FogVolumeInstance *param_1)
...
LAB_00111009:
      ...
      while( true ) {
        ...
        if (*plVar2 != 0) break;
        uVar8 = uVar8 + 1;
        if (*(ulong *)(lVar6 + -8) <= uVar8) goto LAB_00111009;
      }
      LOCK();
...
LAB_00111186:
    ...
    lVar6 = puVar9[-1];
    if (param_1 <= lVar6) goto LAB_0011109a;
  }
  else {
    if (lVar6 != 0) {
      uVar4 = _realloc(this,lVar10);
...
LAB_001113ec:
    ...
    lVar3 = puVar9[-1];
    if (param_1 <= lVar3) goto LAB_00111381;
  }
  else {
    if (lVar8 != 0) {
...
LAB_00111ced:
    ...
    iVar35 = *(int *)(this + 0x2c);
    if (__s_00 == (void *)0x0) goto LAB_00111dec;
    if (*(int *)(this + 0x2c) != 0) goto LAB_00111ced;
LAB_00111e0e:
...
LAB_00111c88:
    ...
    if (*(int *)(this + 0x2c) != 0) {
      ...
      if (lVar34 == 0) goto LAB_001120c8;
      goto LAB_00111ce1;
    }
    local_70 = 0;
    iVar35 = 0;
LAB_00111dec:
    if ((float)uVar43 * __LC60 < (float)(iVar35 + 1)) goto LAB_00111e0e;
  }
  local_68 = (undefined1  [16])0x0;
  StringName::StringName((StringName *)&local_58,param_1);
  local_50[0] = 0;
...

{
  ...
  if (*(long *)(param_2 + 8) == 0) {
    ...
    *(void **)(param_2 + 8) = __s_00;
    ...
    if (__s_00 == (void *)0x0) goto LAB_00112329;
    if (*(int *)(param_2 + 0x2c) != 0) goto LAB_0011221e;
LAB_0011234b:
...
LAB_00112329:
    if ((float)uVar23 * __LC60 < (float)(iVar28 + 1)) goto LAB_0011234b;
  }
  ...
  if (pvVar3 != (void *)0x0) {
    if (*(int *)(param_1 + 0x44) != 0) {
      ...
      if (uVar1 == 0) {
        ...
        *(undefined4 *)(param_1 + 0x44) = 0;
        *(undefined1 (*) [16])(param_1 + 0x30) = (undefined1  [16])0x0;
        if (pvVar3 == (void *)0x0) goto LAB_00112767;
      }
    }
    Memory::free_static(pvVar3,false);
  ...
  if (pvVar5 != (void *)0x0) {
    if (*(int *)(this + 0x6c) != 0) {
      ...
      if (uVar2 == 0) {
        ...
        *(undefined4 *)(this + 0x6c) = 0;
        *(undefined1 (*) [16])(this + 0x58) = (undefined1  [16])0x0;
        if (pvVar5 == (void *)0x0) goto LAB_00112859;
      }
    }
    Memory::free_static(pvVar5,false);
  ...
  if (pvVar5 != (void *)0x0) {
    if (*(int *)(this + 0x3c) != 0) {
      ...
      if (uVar2 == 0) {
        ...
        *(undefined4 *)(this + 0x3c) = 0;
        *(undefined1 (*) [16])(this + 0x28) = (undefined1  [16])0x0;
        if (pvVar5 == (void *)0x0) goto LAB_0011299f;
      }
    }
    Memory::free_static(pvVar5,false);
...
LAB_00112c21:
      ...
      while( true ) {
        ...
        uVar10 = uVar10 + 1;
        if (*(ulong *)(lVar8 + -8) <= uVar10) goto LAB_00112c21;
      }
      LOCK();
...
LAB_00112de6:
    ...
    lVar8 = puVar7[-1];
    if (param_1 <= lVar8) goto LAB_00112ce0;
  }
  else {
    if (lVar8 != 0) {
      uVar4 = _realloc(this,lVar11);
...

{
  ...
  if (__s_00 == (void *)0x0) {
    ...
    *(void **)(param_2 + 2) = __s_00;
    ...
    uVar32 = param_2[0xb];
    lVar36 = *plVar28;
    if (__s_00 != (void *)0x0) goto LAB_00112e41;
  }
  else {
LAB_00112e36:
    uVar32 = param_2[0xb];
...
void __thiscall
RID_Alloc<RendererRD::Fog::FogVolume,true>::initialize_rid
          (RID_Alloc<RendererRD::Fog::FogVolume,true> *this,ulong param_2,undefined8 *param_3)

{
  ...
  if (param_2 != 0) {
    if ((uint)param_2 < *(uint *)(this + 0x1c)) {
      puVar5 = (undefined8 *)
               (((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x18)) * 0x50 +
               *(long *)(*(long *)(this + 8) +
...
LAB_00113328:
          if ((*(int *)((long)param_3 + 0x44) != 0) &&
             (plVar4 = (long *)param_3[6], plVar4 != (long *)0x0)) {
            do {
              HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>
              ::insert(&pDStack_28,(uint *)(puVar5 + 3),(bool)((char)plVar4 + '\x10'));
              plVar4 = (long *)*plVar4;

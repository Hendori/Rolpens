...

{
  ...
  lVar20 = 8;
  if (param_4 != 0) {
    lVar20 = (ulong)((uVar3 >> 1) + 1) * 4;
  }
  uVar23 = param_3 + 1;
  uVar2 = (uVar3 >> 1) + 3 + (uVar3 >> 3);
  pbVar19 = (byte *)(param_5 + (param_3 + 2));
  ...
  *param_5 = 0;
  if (uVar23 == 0) {
    *param_5 = sVar24;
    pbVar17 = pbVar19 + uVar3;
LAB_001009d7:
    uVar22 = (ulong)uVar14;
    if ((ulong)uVar3 == 0) goto LAB_00100a5c;
    uVar6 = 0;
    pbVar4 = pbVar17;
    do {
      uVar5 = uVar6 + uVar2;
      pbVar18 = pbVar4 + 2;
      pbVar19[uVar6 & uVar22] = *pbVar4;
      uVar6 = uVar5 + uVar2 & uVar22;
      pbVar19[uVar5 & uVar22] = pbVar4[1];
      pbVar4 = pbVar18;
    } while (pbVar17 + ((ulong)uVar3 - 1 & 0xfffffffffffffffe) + 2 != pbVar18);
  }
  else {
    uVar21 = 0;
    sVar8 = 0;
    ...
    while( true ) {
      ...
      if (param_2[uVar6] == -1) {
        uVar11 = uVar11 - 1;
        param_5[uVar15] = sVar8 + 1;
        pbVar19[uVar22] = (byte)uVar21;
        uVar22 = (ulong)uVar11;
      }
      else {
        param_5[uVar15] = param_2[uVar6] + sVar8;
      }
      if (uVar23 < uVar15 + 1) break;
      uVar15 = uVar15 + 1;
      uVar21 = uVar21 + 1;
      uVar6 = (ulong)uVar21;
      sVar8 = param_5[uVar6];
    }
    param_5[uVar23] = sVar24;
    uVar22 = 0;
    uVar23 = 0;
    if (uVar11 == uVar14) {
      lVar13 = 0;
      ...
      do {
        sVar24 = *psVar25;
        *(long *)(pbVar17 + uVar22) = lVar13;
        if (8 < sVar24) {
          pbVar4 = pbVar17 + uVar22 + 8;
          do {
            *(long *)pbVar4 = lVar13;
            pbVar4 = pbVar4 + 8;
          } while (pbVar17 + (ulong)((int)sVar24 - 9U & 0xfffffff8) + uVar22 + 0x10 != pbVar4);
        }
        psVar25 = psVar25 + 1;
        uVar22 = uVar22 + (long)sVar24;
        lVar13 = lVar13 + 0x101010101010101;
      } while (param_2 + (ulong)param_3 + 1 != psVar25);
      goto LAB_001009d7;
    }
    do {
      sVar24 = param_2[uVar22];
      if (0 < sVar24) {
        iVar9 = 0;
        do {
          pbVar19[uVar23] = (byte)uVar22;
          do {
            uVar23 = uVar23 + uVar2 & uVar14;
          } while (uVar11 < uVar23);
          iVar9 = iVar9 + 1;
        } while (sVar24 != iVar9);
      }
      bVar26 = uVar22 != param_3;
      uVar22 = uVar22 + 1;
    } while (bVar26);
  }
  if (uVar3 != 0) {
    pbVar17 = pbVar19 + (ulong)uVar14 + 1;
    sVar24 = (short)pbVar19;
    do {
      uVar1 = param_5[*pbVar19];
      param_5[*pbVar19] = uVar1 + 1;
      sVar8 = (short)pbVar19;
      pbVar19 = pbVar19 + 1;
      param_1[(ulong)uVar1 + 2] = ((short)uVar3 - sVar24) + sVar8;
...
LAB_00100a5c:
  ...
  iVar9 = 0;
  do {
    iVar12 = (int)param_2[uVar14];
    piVar7 = (int *)(lVar20 + (ulong)uVar14 * 8 + (long)param_1);
    if (param_2[uVar14] == 0) {
      piVar7[1] = (param_4 + 1) * 0x10000 - uVar3;
      iVar16 = iVar9;
    }
    else if ((iVar12 + 1U & 0xfffd) == 0) {
      ...
      *piVar7 = iVar9 + -1;
      ...
      uVar2 = 0x1f;
      if (iVar12 - 1U != 0) {
        for (; iVar12 - 1U >> uVar2 == 0; uVar2 = uVar2 - 1) {
        }
      }
      iVar10 = (uVar2 ^ 0x1f) + param_4 + -0x1f;
      iVar16 = iVar9 + iVar12;
      *piVar7 = iVar9 - iVar12;
      piVar7[1] = iVar10 * 0x10000 - (iVar12 << ((byte)iVar10 & 0x1f));
    }
    uVar14 = uVar14 + 1;
    iVar9 = iVar16;
...
LAB_00100d26:
      uVar9 = uVar9 + 1;
      *psVar1 = sVar4;
      if (param_5 < uVar9) goto LAB_00100dac;
    }
    if (uVar10 <= uVar17) {
      iVar16 = iVar16 + -1;
      sVar4 = sVar11;
...
LAB_00100dac:
  ...
  if ((uVar6 & 0xffffffff) < param_4 / uVar7) {
    ...
    uVar9 = iVar5 - iVar16;
    if (param_5 + 1 == iVar16) goto LAB_00100fca;
    uVar7 = (ulong)uVar9;
    if (param_4 == 0) {
      if (uVar9 == 0) goto LAB_00100dcc;
      goto LAB_00100f8d;

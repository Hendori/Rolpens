...

{
  ...
  *(undefined8 *)((long)param_1 + 100) = 0;
  ...
  for (uVar1 = (ulong)(((int)param_1 -
                       (int)(undefined8 *)((ulong)(param_1 + 1) & 0xfffffffffffffff8)) + 0x6cU >> 3)
...
undefined8 mbedtls_sha256_starts(long param_1,uint param_2)
...

{
  ...
  piVar24 = &K;
  do {
    iVar12 = (((uint)local_50 >> 6 | (uint)local_50 << 0x1a) ^
              ((uint)local_50 >> 0xb | (uint)local_50 << 0x15) ^
             ((uint)local_50 << 7 | (uint)local_50 >> 0x19)) + piVar19[2] + *piVar24 +
             (((uint)uStack_48 ^ local_50._4_4_) & (uint)local_50 ^ (uint)uStack_48) +
             uStack_48._4_4_;
    uStack_54 = iVar12 + uStack_54;
    uStack_48._4_4_ =
         ((local_60 >> 2 | local_60 << 0x1e) ^ (local_60 >> 0xd | local_60 << 0x13) ^
         (local_60 << 10 | local_60 >> 0x16)) + iVar12 +
         ((local_60 | uStack_5c) & uStack_58 | local_60 & uStack_5c);
    iVar12 = piVar19[3] + piVar24[1] + (uint)uStack_48 +
             (((uint)local_50 ^ local_50._4_4_) & uStack_54 ^ local_50._4_4_) +
             ((uStack_54 >> 6 | uStack_54 * 0x4000000) ^ (uStack_54 >> 0xb | uStack_54 * 0x200000) ^
             (uStack_54 * 0x80 | uStack_54 >> 0x19));
    uStack_58 = iVar12 + uStack_58;
    uStack_48._0_4_ =
         ((uStack_48._4_4_ >> 2 | uStack_48._4_4_ * 0x40000000) ^
          (uStack_48._4_4_ >> 0xd | uStack_48._4_4_ * 0x80000) ^
         (uStack_48._4_4_ * 0x400 | uStack_48._4_4_ >> 0x16)) + iVar12 +
         ((uStack_48._4_4_ | local_60) & uStack_5c | uStack_48._4_4_ & local_60);
    iVar12 = piVar19[4] + piVar24[2] + local_50._4_4_ +
             ((uStack_54 ^ (uint)local_50) & uStack_58 ^ (uint)local_50) +
             ((uStack_58 >> 6 | uStack_58 * 0x4000000) ^ (uStack_58 >> 0xb | uStack_58 * 0x200000) ^
             (uStack_58 * 0x80 | uStack_58 >> 0x19));
    uStack_5c = uStack_5c + iVar12;
    local_50._4_4_ =
         (((uint)uStack_48 >> 2 | (uint)uStack_48 * 0x40000000) ^
          ((uint)uStack_48 >> 0xd | (uint)uStack_48 * 0x80000) ^
         ((uint)uStack_48 * 0x400 | (uint)uStack_48 >> 0x16)) + iVar12 +
         ((uStack_48._4_4_ | (uint)uStack_48) & local_60 | uStack_48._4_4_ & (uint)uStack_48);
    iVar12 = piVar19[5] + piVar24[3] + (uint)local_50 +
             ((uStack_54 ^ uStack_58) & uStack_5c ^ uStack_54) +
             ((uStack_5c >> 6 | uStack_5c * 0x4000000) ^ (uStack_5c >> 0xb | uStack_5c * 0x200000) ^
             (uStack_5c * 0x80 | uStack_5c >> 0x19));
    local_60 = iVar12 + local_60;
    local_50._0_4_ =
         ((local_50._4_4_ >> 2 | local_50._4_4_ * 0x40000000) ^
          (local_50._4_4_ >> 0xd | local_50._4_4_ * 0x80000) ^
         (local_50._4_4_ * 0x400 | local_50._4_4_ >> 0x16)) + iVar12 +
         (((uint)uStack_48 | local_50._4_4_) & uStack_48._4_4_ | (uint)uStack_48 & local_50._4_4_);
    iVar12 = uStack_54 + piVar19[6] + piVar24[4] + ((uStack_58 ^ uStack_5c) & local_60 ^ uStack_58)
             + ((local_60 >> 6 | local_60 * 0x4000000) ^ (local_60 >> 0xb | local_60 * 0x200000) ^
               (local_60 * 0x80 | local_60 >> 0x19));
    uStack_48._4_4_ = uStack_48._4_4_ + iVar12;
    uStack_54 = (((uint)local_50 >> 2 | (uint)local_50 * 0x40000000) ^
                 ((uint)local_50 >> 0xd | (uint)local_50 * 0x80000) ^
                ((uint)local_50 * 0x400 | (uint)local_50 >> 0x16)) + iVar12 +
                ((local_50._4_4_ | (uint)local_50) & (uint)uStack_48 |
                local_50._4_4_ & (uint)local_50);
    iVar12 = piVar19[7] + piVar24[5] + uStack_58 +
             ((uStack_5c ^ local_60) & uStack_48._4_4_ ^ uStack_5c) +
             ((uStack_48._4_4_ >> 6 | uStack_48._4_4_ * 0x4000000) ^
              (uStack_48._4_4_ >> 0xb | uStack_48._4_4_ * 0x200000) ^
             (uStack_48._4_4_ * 0x80 | uStack_48._4_4_ >> 0x19));
    uStack_48._0_4_ = (uint)uStack_48 + iVar12;
    uStack_58 = ((uStack_54 >> 2 | uStack_54 * 0x40000000) ^
                 (uStack_54 >> 0xd | uStack_54 * 0x80000) ^ (uStack_54 * 0x400 | uStack_54 >> 0x16))
                + iVar12 +
                (((uint)local_50 | uStack_54) & local_50._4_4_ | (uint)local_50 & uStack_54);
    iVar12 = piVar19[8] + piVar24[6] + uStack_5c +
             ((local_60 ^ uStack_48._4_4_) & (uint)uStack_48 ^ local_60) +
             (((uint)uStack_48 >> 6 | (uint)uStack_48 * 0x4000000) ^
              ((uint)uStack_48 >> 0xb | (uint)uStack_48 * 0x200000) ^
             ((uint)uStack_48 * 0x80 | (uint)uStack_48 >> 0x19));
    local_50._4_4_ = local_50._4_4_ + iVar12;
    piVar25 = piVar24 + 8;
    uStack_5c = ((uStack_58 >> 2 | uStack_58 * 0x40000000) ^
                 (uStack_58 >> 0xd | uStack_58 * 0x80000) ^ (uStack_58 * 0x400 | uStack_58 >> 0x16))
                + iVar12 + ((uStack_54 | uStack_58) & (uint)local_50 | uStack_54 & uStack_58);
    iVar12 = piVar19[9] + piVar24[7] + local_60 +
             ((uStack_48._4_4_ ^ (uint)uStack_48) & local_50._4_4_ ^ uStack_48._4_4_) +
             ((local_50._4_4_ >> 6 | local_50._4_4_ * 0x4000000) ^
              (local_50._4_4_ >> 0xb | local_50._4_4_ * 0x200000) ^
             (local_50._4_4_ * 0x80 | local_50._4_4_ >> 0x19));
    local_50._0_4_ = (uint)local_50 + iVar12;
    local_60 = ((uStack_5c >> 2 | uStack_5c * 0x40000000) ^ (uStack_5c >> 0xd | uStack_5c * 0x80000)
               ^ (uStack_5c * 0x400 | uStack_5c >> 0x16)) + iVar12 +
               ((uStack_58 | uStack_5c) & uStack_54 | uStack_58 & uStack_5c);
    piVar19 = piVar19 + 8;
    piVar24 = piVar25;
  ...
  do {
    uVar9 = local_188 +
            ((local_1d4 << 0xd | local_1d4 >> 0x13) ^ (local_1d4 << 0xf | local_1d4 >> 0x11) ^
            local_1d4 >> 10) +
            ((local_160[1] << 0xe | local_160[1] >> 0x12) ^
             (local_160[1] >> 7 | local_160[1] << 0x19) ^ local_160[1] >> 3) + local_1a4;
    piVar19[0x12] = uVar9;
    iVar10 = local_18c +
             ((uVar11 >> 0xb | uVar11 << 0x15) ^ (uVar11 >> 6 | uVar11 << 0x1a) ^
             (uVar11 << 7 | uVar11 >> 0x19)) + ((uVar7 ^ uVar13) & uVar11 ^ uVar7) + puVar21[0x10] +
             uVar9;
    uVar15 = uVar15 + iVar10;
    iVar12 = puVar21[0x11];
    local_18c = ((uVar20 >> 0xd | uVar20 << 0x13) ^ (uVar20 >> 2 | uVar20 << 0x1e) ^
                (uVar20 << 10 | uVar20 >> 0x16)) + ((uVar20 | uVar14) & uVar17 | uVar20 & uVar14) +
                iVar10;
    uVar1 = local_160[1] + local_1a8 +
            (local_1e0 >> 10 ^
            (local_1e0 << 0xd | local_1e0 >> 0x13) ^ (local_1e0 << 0xf | local_1e0 >> 0x11)) +
            ((local_1bc << 0xe | local_1bc >> 0x12) ^ (local_1bc >> 7 | local_1bc << 0x19) ^
            local_1bc >> 3);
    piVar19[0x13] = uVar1;
    iVar10 = ((uVar15 >> 0xb | uVar15 * 0x200000) ^ (uVar15 >> 6 | uVar15 * 0x4000000) ^
             (uVar15 * 0x80 | uVar15 >> 0x19)) +
             uVar7 + iVar12 + uVar1 + ((uVar11 ^ uVar13) & uVar15 ^ uVar13);
    uVar17 = uVar17 + iVar10;
    iVar12 = puVar21[0x12];
    uVar7 = ((local_18c >> 0xd | local_18c * 0x80000) ^ (local_18c >> 2 | local_18c * 0x40000000) ^
            (local_18c * 0x400 | local_18c >> 0x16)) +
            ((uVar20 | local_18c) & uVar14 | uVar20 & local_18c) + iVar10;
    uVar18 = (local_1c8 >> 3 ^
             (local_1c8 << 0xe | local_1c8 >> 0x12) ^ (local_1c8 >> 7 | local_1c8 << 0x19)) +
             local_1bc + local_1ac +
             ((uVar9 * 0x2000 | uVar9 >> 0x13) ^ (uVar9 * 0x8000 | uVar9 >> 0x11) ^ uVar9 >> 10);
    piVar19[0x14] = uVar18;
    iVar10 = ((uVar17 >> 0xb | uVar17 * 0x200000) ^ (uVar17 >> 6 | uVar17 * 0x4000000) ^
             (uVar17 * 0x80 | uVar17 >> 0x19)) +
             uVar13 + iVar12 + uVar18 + ((uVar11 ^ uVar15) & uVar17 ^ uVar11);
    uVar14 = uVar14 + iVar10;
    iVar12 = puVar21[0x13];
    uVar13 = ((uVar7 >> 0xd | uVar7 * 0x80000) ^ (uVar7 >> 2 | uVar7 * 0x40000000) ^
             (uVar7 * 0x400 | uVar7 >> 0x16)) + ((local_18c | uVar7) & uVar20 | local_18c & uVar7) +
             iVar10;
    uVar2 = (local_1d0 >> 3 ^
            (local_1d0 << 0xe | local_1d0 >> 0x12) ^ (local_1d0 >> 7 | local_1d0 << 0x19)) +
            local_1c8 + local_1b0 +
            ((uVar1 * 0x2000 | uVar1 >> 0x13) ^ (uVar1 * 0x8000 | uVar1 >> 0x11) ^ uVar1 >> 10);
    piVar19[0x15] = uVar2;
    iVar10 = puVar21[0x14];
    iVar12 = ((uVar14 >> 0xb | uVar14 * 0x200000) ^ (uVar14 >> 6 | uVar14 * 0x4000000) ^
             (uVar14 * 0x80 | uVar14 >> 0x19)) +
             uVar11 + iVar12 + uVar2 + ((uVar15 ^ uVar17) & uVar14 ^ uVar15);
    uVar20 = uVar20 + iVar12;
    uVar11 = ((uVar13 >> 0xd | uVar13 * 0x80000) ^ (uVar13 >> 2 | uVar13 * 0x40000000) ^
             (uVar13 * 0x400 | uVar13 >> 0x16)) + ((uVar7 | uVar13) & local_18c | uVar7 & uVar13) +
             iVar12;
    uVar3 = (local_1cc >> 3 ^
            (local_1cc << 0xe | local_1cc >> 0x12) ^ (local_1cc >> 7 | local_1cc << 0x19)) +
            local_1d0 + local_1b4 +
            ((uVar18 * 0x2000 | uVar18 >> 0x13) ^ (uVar18 * 0x8000 | uVar18 >> 0x11) ^ uVar18 >> 10)
    ;
    piVar19[0x16] = uVar3;
    iVar12 = ((uVar20 >> 0xb | uVar20 * 0x200000) ^ (uVar20 >> 6 | uVar20 * 0x4000000) ^
             (uVar20 * 0x80 | uVar20 >> 0x19)) +
             ((uVar17 ^ uVar14) & uVar20 ^ uVar17) + uVar15 + iVar10 + uVar3;
    local_18c = local_18c + iVar12;
    uVar15 = ((uVar11 >> 0xd | uVar11 * 0x80000) ^ (uVar11 >> 2 | uVar11 * 0x40000000) ^
             (uVar11 * 0x400 | uVar11 >> 0x16)) + ((uVar13 | uVar11) & uVar7 | uVar13 & uVar11) +
             iVar12;
    uVar23 = (local_1c0 >> 3 ^
             (local_1c0 << 0xe | local_1c0 >> 0x12) ^ (local_1c0 >> 7 | local_1c0 << 0x19)) +
             local_1cc + local_1d4 +
             ((uVar2 * 0x2000 | uVar2 >> 0x13) ^ (uVar2 * 0x8000 | uVar2 >> 0x11) ^ uVar2 >> 10);
    iVar12 = puVar21[0x15];
    piVar19[0x17] = uVar23;
    iVar12 = ((local_18c >> 0xb | local_18c * 0x200000) ^ (local_18c >> 6 | local_18c * 0x4000000) ^
             (local_18c * 0x80 | local_18c >> 0x19)) +
             uVar17 + iVar12 + uVar23 + ((uVar14 ^ uVar20) & local_18c ^ uVar14);
    uVar7 = uVar7 + iVar12;
    uVar17 = ((uVar15 >> 0xd | uVar15 * 0x80000) ^ (uVar15 >> 2 | uVar15 * 0x40000000) ^
             (uVar15 * 0x400 | uVar15 >> 0x16)) + ((uVar11 | uVar15) & uVar13 | uVar11 & uVar15) +
             iVar12;
    iVar12 = puVar21[0x16];
    uVar4 = (local_1c4 >> 3 ^
            (local_1c4 << 0xe | local_1c4 >> 0x12) ^ (local_1c4 >> 7 | local_1c4 << 0x19)) +
            local_1c0 + local_1e0 +
            ((uVar3 * 0x2000 | uVar3 >> 0x13) ^ (uVar3 * 0x8000 | uVar3 >> 0x11) ^ uVar3 >> 10);
    piVar19[0x18] = uVar4;
    iVar12 = ((uVar7 >> 0xb | uVar7 * 0x200000) ^ (uVar7 >> 6 | uVar7 * 0x4000000) ^
             (uVar7 * 0x80 | uVar7 >> 0x19)) +
             uVar14 + iVar12 + uVar4 + ((local_18c ^ uVar20) & uVar7 ^ uVar20);
    uVar13 = uVar13 + iVar12;
    uVar14 = ((uVar17 >> 0xd | uVar17 * 0x80000) ^ (uVar17 >> 2 | uVar17 * 0x40000000) ^
             (uVar17 * 0x400 | uVar17 >> 0x16)) + ((uVar15 | uVar17) & uVar11 | uVar15 & uVar17) +
             iVar12;
    puVar22 = puVar21 + 8;
    uVar16 = ((local_1b8 << 0xe | local_1b8 >> 0x12) ^ (local_1b8 >> 7 | local_1b8 << 0x19) ^
             local_1b8 >> 3) + local_1c4 + uVar9 +
             ((uVar23 * 0x2000 | uVar23 >> 0x13) ^ (uVar23 * 0x8000 | uVar23 >> 0x11) ^ uVar23 >> 10
             );
    piVar19[0x19] = uVar16;
    local_168 = ((uVar13 >> 0xb | uVar13 * 0x200000) ^ (uVar13 >> 6 | uVar13 * 0x4000000) ^
                (uVar13 * 0x80 | uVar13 >> 0x19)) +
                ((local_18c ^ uVar7) & uVar13 ^ local_18c) + puVar21[0x17] + uVar16 + uVar20;
    uVar11 = uVar11 + local_168;
    local_1cc = local_1b4;
    local_188 = local_1b8;
    local_1c0 = local_1d4;
    local_164 = ((uVar14 >> 0xd | uVar14 * 0x80000) ^ (uVar14 >> 2 | uVar14 * 0x40000000) ^
                (uVar14 * 0x400 | uVar14 >> 0x16)) + ((uVar17 | uVar14) & uVar15 | uVar17 & uVar14);
    local_1d0 = local_1b0;
      ...
      if (7 < uVar8) {
        ...
        do {
          ...
          *(undefined8 *)(((ulong)(puVar2 + 1) & 0xfffffffffffffff8) + uVar6) =
               *(undefined8 *)((long)param_2 + (uVar6 - lVar3));
        } while (uVar9 < uVar8);
      }
    }
    ...
    *(undefined8 *)((long)puVar2 + ((param_3 & 0xffffffff) - 8)) =
    ...
    if (7 < uVar8) {
      ...
      do {
        uVar5 = (ulong)uVar9;
        uVar9 = uVar9 + 8;
        *(undefined8 *)(((ulong)(puVar2 + 1) & 0xfffffffffffffff8) + uVar5) =
             *(undefined8 *)((long)param_2 + (uVar5 - lVar3));
      } while (uVar9 < uVar8);
      return 0;
    }
  }
...
int mbedtls_sha256_common_self_test(int param_1,int param_2)
...
LAB_0010120a:
      iVar1 = mbedtls_sha256_finish(local_d8,local_68);
      if (iVar1 != 0) goto LAB_00101381;
...
LAB_00101277:
    mbedtls_platform_zeroize(local_d8,0x6c);
    free(__ptr);
  }
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
...
int mbedtls_sha256(undefined8 param_1,undefined8 param_2,undefined8 param_3,uint param_4)

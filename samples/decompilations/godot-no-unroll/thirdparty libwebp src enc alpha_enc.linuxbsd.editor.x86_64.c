...
bool EncodeAlphaInternal(undefined8 param_1,int param_2,int param_3,int param_4,int param_5,
...
LAB_00100072:
    ...
    uVar5 = uVar7;
LAB_0010007e:
    bVar6 = (byte)(param_5 << 2) | (byte)param_4;
    bVar2 = bVar6 | 0x10;
    if (param_6 == 0) {
      bVar2 = bVar6;
    }
    ...
    if (((iVar3 == 0) || (iVar3 = VP8BitWriterAppend(puVar1,&local_1c8,1), iVar3 == 0)) ||
       (iVar3 = VP8BitWriterAppend(puVar1,uVar4,uVar5), iVar3 == 0)) {
      if (param_4 != 0) {
    ...
    *param_9 = param_9[4];
    ...
    VP8LBitWriterWipeOut(local_1f8);
    bVar8 = false;
    *(undefined1 (*) [16])(param_9 + 1) = (undefined1  [16])0x0;
    *(undefined1 (*) [16])(param_9 + 3) = (undefined1  [16])0x0;
    *(undefined1 (*) [16])(param_9 + 5) = (undefined1  [16])0x0;
  }
...
int ApplyFiltersAndEncode
              (long param_1,int param_2,int param_3,undefined8 param_4,undefined4 param_5,
              int param_6,undefined4 param_7,int param_8,undefined8 *param_9,undefined8 *param_10,
              long param_11)

{
  ...
  if (param_6 == 6) {
    ...
    do {
      ...
      iVar15 = (((iVar15 - CONCAT22(-(ushort)bVar2,auVar40._0_2_)) - iVar38) -
               CONCAT22(-(ushort)bVar3,CONCAT11(-bVar3,-bVar3))) - iVar26;
      iVar23 = (((iVar23 - auVar10._0_4_) - (int)((ulong)auVar39._0_8_ >> 0x20)) - auVar45._4_4_) -
               (int)((ulong)auVar30._0_8_ >> 0x20);
...
LAB_001003de:
      ...
      VP8BitWriterInit(auStack_340,0);
LAB_001003fc:
      iVar15 = EncodeAlphaInternal(param_1,param_2,param_3,param_5,0,param_7,param_8,0,&local_348);
joined_r0x0010079e:
      if (iVar15 != 0) goto LAB_0010043c;
...
LAB_001006ef:
        ...
        do {
          if ((uVar24 & 1) != 0) {
            iVar15 = EncodeAlphaInternal(param_1,param_2,param_3,param_5,iVar23,param_7,param_8,
                                         lVar17,&local_248);
...

{
  ...
  if ((uVar3 < 0x65) && (uVar2 < 2)) {
    ...
    WebPCopyPlane(*(undefined8 *)(lVar6 + 0x30),*(undefined4 *)(lVar6 + 0x38),lVar8,iVar5,iVar5,
                  iVar4);
    if (uVar3 == 100) {
LAB_00100a68:
      VP8FiltersInit();
      iVar11 = ApplyFiltersAndEncode
                         (lVar8,iVar5,iVar4,(long)(iVar4 * iVar5),uVar2,iVar11,(int)uVar3 < 100,
                          uVar1,&local_58,&local_50,*(undefined8 *)(lVar6 + 0x80));
      if (iVar11 == 0) {

...

{
  ...
  if (*(long *)(param_1 + 8) == 0) {
    ...
    iVar6 = (int)*(undefined8 *)(*(long *)(param_1 + 8) + -8);
    lVar5 = (long)iVar6;
    pvVar2 = (void *)rtcSetNewGeometryBuffer(uVar1,1,0,0x9003,0xc,lVar5);
    memcpy(pvVar2,*(void **)(param_1 + 8),lVar5 * 0xc);
    lVar3 = *(long *)(param_2 + 8);
    if (lVar3 == 0) {
      ...
      lVar3 = rtcSetNewGeometryBuffer(uVar1,0,0,0x5003,0xc,(long)(iVar6 / 3));
      if (0 < iVar6) {
        lVar4 = 0;
        do {
...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_00102aa0;
  ...
  *(undefined ***)this = &PTR__initialize_classv_00102940;
...

{
  ...
  if (*(long *)(param_1 + 8) == 0) goto LAB_00100730;
  if (*(ulong *)(*(long *)(param_1 + 8) + -0x10) < 2) {
LAB_00100691:
    __dest = *(undefined8 **)(param_1 + 8);
    if (__dest == (undefined8 *)0x0) goto LAB_00100730;
  }
  else {
    if (*(long *)(param_1 + 8) == 0) {
...

{
  ...
  if (initialize_class()::initialized != '\0') goto LAB_00101e5a;
...
LAB_001025d8:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_001025d8;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x001025f5;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }

...
bool hb_map_set_user_data(int *param_1,long param_2,long param_3,long param_4,int param_5)
...
int hb_map_get(long param_1,int param_2)
...
undefined8 hb_map_is_equal(long param_1,long param_2)
...

{
  ...
  local_70 = iVar2;
  local_6c = iVar3;
  _Z7hb_copyI13hb_map_iter_tIS0_I16hb_filter_iter_tI10hb_array_tIN12hb_hashmap_tIjjLb1EE6item_tEEMS5_KFbvERK10__anon_117LPv0EEMS5_FRjvEL24hb_function_sortedness_t0ELSC_0EERK10__anon_119LSH_0ELSC_0EER8hb_set_tEvOT_OT0_
            (&local_78,param_2);
...

{
  ...
  if (*(char *)(param_1 + 0x10) != '\0') {
    ...
    iStack_50 = iVar2;
    iStack_4c = iVar3;
    _ZN9hb_sink_tIR12hb_hashmap_tIjjLb1EEEclI13hb_map_iter_tI16hb_filter_iter_tI10hb_array_tINS1_6item_tEEMS8_KFbvERK10__anon_117LPv0EEMS8_KF9hb_pair_tIjjEvEL24hb_function_sortedness_t0ELSF_0EELSF_0EEEvT_
              (&local_60);
  }
  ...
  if (this[0x10] == (hb_hashmap_t<unsigned_int,unsigned_int,true>)0x0) {
    ...
    *(undefined8 *)(this + 0x14) = 0;
    ...
    if (iStack_60 != 0) {
      ...
      iVar5 = 0;
      while ((iStack_60 != 0 &&
             (cVar2 = hb_hashmap_t<unsigned_int,unsigned_int,true>::item_t::is_real(local_68),
             cVar2 == '\0'))) {
        iVar5 = iVar5 + 1;
...
byte __thiscall hb_hashmap_t<unsigned_int,unsigned_int,true>::item_t::is_real(item_t *this)
...
undefined8 __thiscall hb_hashmap_t<unsigned_int,unsigned_int,true>::item_t::get_pair(item_t *this)
...
item_t * __thiscall hb_hashmap_t<unsigned_int,unsigned_int,true>::item_t::get_key(item_t *this)
...
item_t * __thiscall hb_hashmap_t<unsigned_int,unsigned_int,true>::item_t::get_value(item_t *this)
...
LAB_00101796:
    ...
    if (uVar5 < uVar9) {
LAB_00101720:
      if (0x38e38e3 < (uint)uVar6) goto LAB_00101697;
      pvVar2 = *(void **)(this + 0x28);
LAB_00101731:
      uVar8 = (uint)uVar6;

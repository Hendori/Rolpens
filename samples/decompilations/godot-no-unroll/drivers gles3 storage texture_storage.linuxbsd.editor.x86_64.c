...
/* GLES3::TextureStorage::texture_2d_placeholder_initialize(RID) */

void __thiscall
GLES3::TextureStorage::texture_2d_placeholder_initialize(TextureStorage *this,undefined8 param_2)
...
void __thiscall
GLES3::TextureStorage::texture_2d_layered_placeholder_initialize
...
/* GLES3::TextureStorage::texture_3d_placeholder_initialize(RID) */

void __thiscall
GLES3::TextureStorage::texture_3d_placeholder_initialize(TextureStorage *this,undefined8 param_2)
...
void GLES3::TextureStorage::texture_rd_initialize(void)
...
/* GLES3::TextureStorage::texture_get_rd_texture(RID, bool) const */

undefined8 GLES3::TextureStorage::texture_get_rd_texture(void)
...
/* GLES3::TextureStorage::decal_allocate() */

undefined8 GLES3::TextureStorage::decal_allocate(void)
...
/* GLES3::TextureStorage::decal_initialize(RID) */

void GLES3::TextureStorage::decal_initialize(void)
...
/* GLES3::TextureStorage::decal_set_modulate(RID, Color const&) */

void GLES3::TextureStorage::decal_set_modulate(void)
...
/* GLES3::TextureStorage::decal_set_texture(RID, RenderingServer::DecalTexture, RID) */

void GLES3::TextureStorage::decal_set_texture(void)
...
/* GLES3::TextureStorage::decal_set_albedo_mix(RID, float) */

void GLES3::TextureStorage::decal_set_albedo_mix(void)
...
/* GLES3::TextureStorage::decal_set_cull_mask(RID, unsigned int) */

void GLES3::TextureStorage::decal_set_cull_mask(void)
...
/* GLES3::TextureStorage::decal_set_distance_fade(RID, bool, float, float) */

void GLES3::TextureStorage::decal_set_distance_fade(void)
...
/* GLES3::TextureStorage::decal_set_fade(RID, float, float) */

void GLES3::TextureStorage::decal_set_fade(void)
...
/* GLES3::TextureStorage::decal_get_aabb(RID) const */

undefined8 * GLES3::TextureStorage::decal_get_aabb(undefined8 *param_1)
...
/* GLES3::TextureStorage::render_target_set_position(RID, int, int) */

void __thiscall
GLES3::TextureStorage::render_target_set_position
          (TextureStorage *this,ulong param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x194))) {
    puVar1 = (undefined4 *)
             (((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 400)) * 0xf0 +
  ...
  _err_print_error("render_target_set_position","drivers/gles3/storage/texture_storage.cpp",0x9b4,
...
/* GLES3::TextureStorage::render_target_get_position(RID) const */

undefined8 __thiscall
GLES3::TextureStorage::render_target_get_position(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_get_position","drivers/gles3/storage/texture_storage.cpp",0x9bb,
                   "Parameter \"rt\" is null.",0,0);
  return 0;
}
...
/* GLES3::TextureStorage::render_target_get_size(RID) const */

undefined8 __thiscall
GLES3::TextureStorage::render_target_get_size(TextureStorage *this,ulong param_2)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x194))) {
    lVar2 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 400)) * 0xf0 +
            *(long *)(*(long *)(this + 0x180) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 400)) * 8);
  ...
  _err_print_error("render_target_get_size","drivers/gles3/storage/texture_storage.cpp",0x9d6,
                   "Parameter \"rt\" is null.",0,0);
  return 0;
}
...
/* GLES3::TextureStorage::render_target_get_override_color(RID) const */

undefined8 __thiscall
GLES3::TextureStorage::render_target_get_override_color(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_get_override_color","drivers/gles3/storage/texture_storage.cpp",
                   0xa15,"Parameter \"rt\" is null.",0,0);
  return 0;
}



/* GLES3::TextureStorage::render_target_get_override_depth(RID) const */

undefined8 __thiscall
GLES3::TextureStorage::render_target_get_override_depth(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_get_override_depth","drivers/gles3/storage/texture_storage.cpp",
                   0xa1c,"Parameter \"rt\" is null.",0,0);
  return 0;
}



/* GLES3::TextureStorage::render_target_get_override_velocity(RID) const */

undefined8 __thiscall
GLES3::TextureStorage::render_target_get_override_velocity(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_get_override_velocity","drivers/gles3/storage/texture_storage.cpp"
                   ,0xa23,"Parameter \"rt\" is null.",0,0);
  return 0;
}



/* GLES3::TextureStorage::render_target_set_render_region(RID, Rect2i const&) */

void __thiscall
GLES3::TextureStorage::render_target_set_render_region
...

{
  ...
  _err_print_error("render_target_set_render_region","drivers/gles3/storage/texture_storage.cpp",
                   0xa2a,"Parameter \"rt\" is null.",0,0);
  return;
}



/* GLES3::TextureStorage::render_target_get_render_region(RID) const */

undefined1  [16] __thiscall
GLES3::TextureStorage::render_target_get_render_region(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_get_render_region","drivers/gles3/storage/texture_storage.cpp",
                   0xa31,"Parameter \"rt\" is null.",0,0);
  return ZEXT816(0);
}



/* GLES3::TextureStorage::render_target_get_texture(RID) */

undefined8 __thiscall
GLES3::TextureStorage::render_target_get_texture(TextureStorage *this,ulong param_2)

{
  long lVar1;
  
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x194))) {
    lVar1 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 400)) * 0xf0 +
            *(long *)(*(long *)(this + 0x180) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 400)) * 8);
  ...
  _err_print_error("render_target_get_texture","drivers/gles3/storage/texture_storage.cpp",0xa38,
                   "Parameter \"rt\" is null.",0,0);
  return 0;
}
...
/* GLES3::TextureStorage::render_target_get_transparent(RID) const */

undefined1 __thiscall
GLES3::TextureStorage::render_target_get_transparent(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_get_transparent","drivers/gles3/storage/texture_storage.cpp",0xa4f
                   ,"Parameter \"rt\" is null.",0,0);
  return 0;
}
...
/* GLES3::TextureStorage::render_target_get_direct_to_screen(RID) const */

undefined1 __thiscall
GLES3::TextureStorage::render_target_get_direct_to_screen(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_get_direct_to_screen","drivers/gles3/storage/texture_storage.cpp",
                   0xa69,"Parameter \"rt\" is null.",0,0);
  return 0;
}



/* GLES3::TextureStorage::render_target_was_used(RID) const */

undefined1 __thiscall
GLES3::TextureStorage::render_target_was_used(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_was_used","drivers/gles3/storage/texture_storage.cpp",0xa70,
                   "Parameter \"rt\" is null.",0,0);
  return 0;
}
...
/* GLES3::TextureStorage::render_target_get_msaa(RID) const */

undefined4 __thiscall
GLES3::TextureStorage::render_target_get_msaa(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_get_msaa","drivers/gles3/storage/texture_storage.cpp",0xa8d,
                   "Parameter \"rt\" is null.",0,0);
  return 0;
}
...
/* GLES3::TextureStorage::render_target_is_using_hdr(RID) const */

undefined1 __thiscall
GLES3::TextureStorage::render_target_is_using_hdr(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_is_using_hdr","drivers/gles3/storage/texture_storage.cpp",0xaa1,
                   "Parameter \"rt\" is null.",0,0);
  return 0;
}
...
/* GLES3::TextureStorage::render_target_request_clear(RID, Color const&) */

void __thiscall
GLES3::TextureStorage::render_target_request_clear
          (TextureStorage *this,ulong param_2,undefined8 *param_3)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x194))) {
    lVar3 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 400)) * 0xf0 +
            *(long *)(*(long *)(this + 0x180) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 400)) * 8);
  ...
  _err_print_error("render_target_request_clear","drivers/gles3/storage/texture_storage.cpp",0xac4,
                   "Parameter \"rt\" is null.",0,0);
  return;
}
...
/* GLES3::TextureStorage::render_target_is_clear_requested(RID) */

undefined1 __thiscall
GLES3::TextureStorage::render_target_is_clear_requested(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_is_clear_requested","drivers/gles3/storage/texture_storage.cpp",
                   0xacb,"Parameter \"rt\" is null.",0,0);
  return 0;
}



/* GLES3::TextureStorage::render_target_get_clear_request_color(RID) */

undefined1  [16] __thiscall
GLES3::TextureStorage::render_target_get_clear_request_color(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_get_clear_request_color",
                   "drivers/gles3/storage/texture_storage.cpp",0xad0,"Parameter \"rt\" is null.",0,0
                  );
...
/* GLES3::TextureStorage::render_target_disable_clear_request(RID) */

void __thiscall
GLES3::TextureStorage::render_target_disable_clear_request(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_disable_clear_request","drivers/gles3/storage/texture_storage.cpp"
                   ,0xad6,"Parameter \"rt\" is null.",0,0);
  return;
}
...
/* GLES3::TextureStorage::render_target_do_clear_request(RID) */

void __thiscall
GLES3::TextureStorage::render_target_do_clear_request(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_do_clear_request","drivers/gles3/storage/texture_storage.cpp",
                   0xadc,"Parameter \"rt\" is null.",0,0);
  return;
}



/* GLES3::TextureStorage::render_target_mark_sdf_enabled(RID, bool) */

void __thiscall
GLES3::TextureStorage::render_target_mark_sdf_enabled
...

{
  ...
  _err_print_error("render_target_mark_sdf_enabled","drivers/gles3/storage/texture_storage.cpp",
                   0xb4d,"Parameter \"rt\" is null.",0,0);
  return;
}
...
void __thiscall
GLES3::TextureStorage::canvas_texture_set_channel
...

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x9c))) {
    puVar1 = (undefined8 *)
             (((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x98)) * 0x40 +
             *(long *)(*(long *)(this + 0x88) +
                      ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x98)) * 8));
  ...
  _err_print_error("canvas_texture_set_channel","drivers/gles3/storage/texture_storage.cpp",0x128,
...
/* GLES3::TextureStorage::canvas_texture_set_shading_parameters(RID, Color const&, float) */

void __thiscall
GLES3::TextureStorage::canvas_texture_set_shading_parameters
...

{
  ...
  if ((param_3 != 0) && ((uint)param_3 < *(uint *)(this + 0x9c))) {
    lVar3 = ((param_3 & 0xffffffff) % (ulong)*(uint *)(this + 0x98)) * 0x40 +
            *(long *)(*(long *)(this + 0x88) +
                     ((param_3 & 0xffffffff) / (ulong)*(uint *)(this + 0x98)) * 8);
  ...
  _err_print_error("canvas_texture_set_shading_parameters",
                   "drivers/gles3/storage/texture_storage.cpp",0x139,"Parameter \"ct\" is null.",0,0
                  );
  return;
}
...
void __thiscall
GLES3::TextureStorage::canvas_texture_set_texture_filter
...

{
  ...
  if (param_2 != 0) {
    if ((uint)param_2 < *(uint *)(this + 0x9c)) {
      lVar2 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x98)) * 0x40 +
              *(long *)(*(long *)(this + 0x88) +
                       ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x98)) * 8);
  ...
  _err_print_error("canvas_texture_set_texture_filter","drivers/gles3/storage/texture_storage.cpp",
                   0x143,"Parameter \"ct\" is null.",0,0);
  return;
}
...
void __thiscall
GLES3::TextureStorage::canvas_texture_set_texture_repeat
          (TextureStorage *this,ulong param_2,undefined4 param_3)

{
  ...
  _err_print_error("canvas_texture_set_texture_repeat","drivers/gles3/storage/texture_storage.cpp",
                   0x14a,"Parameter \"ct\" is null.",0,0);
  return;
}



/* GLES3::TextureStorage::texture_external_update(RID, int, int, unsigned long) */

void GLES3::TextureStorage::texture_external_update
               (long param_1,ulong param_2,undefined4 param_3,undefined4 param_4)

{
  long lVar1;
  
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(param_1 + 0xf4))) {
    lVar1 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(param_1 + 0xf0)) * 0xf0 +
            *(long *)(*(long *)(param_1 + 0xe0) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(param_1 + 0xf0)) * 8);
    if (*(int *)(lVar1 + 0xe8) == (int)(param_2 >> 0x20)) {
  ...
  _err_print_error("texture_external_update","drivers/gles3/storage/texture_storage.cpp",0x3ff,
...
/* GLES3::TextureStorage::texture_set_size_override(RID, int, int) */

void __thiscall
GLES3::TextureStorage::texture_set_size_override
...

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0xf4))) {
    lVar1 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
            *(long *)(*(long *)(this + 0xe0) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0xf0)) * 8);
    if (*(int *)(lVar1 + 0xe8) == (int)(param_2 >> 0x20)) {
      if (*(char *)(lVar1 + 10) != '\0') {
        _err_print_error("texture_set_size_override","drivers/gles3/storage/texture_storage.cpp",
                         0x589,"Condition \"texture->is_render_target\" is true.",0,0);
        return;
      }
      if (param_3 - 1U < 0x4000) {
        ...
        _err_print_error("texture_set_size_override","drivers/gles3/storage/texture_storage.cpp",
                         0x58c,"Condition \"p_height <= 0 || p_height > 16384\" is true.",0,0);
        return;
      }
      _err_print_error("texture_set_size_override","drivers/gles3/storage/texture_storage.cpp",0x58b
                       ,"Condition \"p_width <= 0 || p_width > 16384\" is true.",0,0);
      return;
    }
    if (*(int *)(lVar1 + 0xe8) + 0x80000000U < 0x7fffffff) {
      _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
  ...
  _err_print_error("texture_set_size_override","drivers/gles3/storage/texture_storage.cpp",0x588,
...
/* GLES3::TextureStorage::texture_set_detect_3d_callback(RID, void (*)(void*), void*) */

void __thiscall
GLES3::TextureStorage::texture_set_detect_3d_callback
...

{
  ...
  _err_print_error("texture_set_detect_3d_callback","drivers/gles3/storage/texture_storage.cpp",
                   0x5a2,"Parameter \"texture\" is null.",0,0);
  return;
}



/* GLES3::TextureStorage::texture_set_detect_normal_callback(RID, void (*)(void*), void*) */

void __thiscall
GLES3::TextureStorage::texture_set_detect_normal_callback
          (TextureStorage *this,ulong param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  _err_print_error("texture_set_detect_normal_callback","drivers/gles3/storage/texture_storage.cpp",
                   0x5ad,"Parameter \"texture\" is null.",0,0);
  return;
}
...
/* GLES3::TextureStorage::texture_set_detect_roughness_callback(RID, void (*)(void*, String const&,
   RenderingServer::TextureDetectRoughnessChannel), void*) */

void __thiscall
GLES3::TextureStorage::texture_set_detect_roughness_callback
          (TextureStorage *this,ulong param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  _err_print_error("texture_set_detect_roughness_callback",
                   "drivers/gles3/storage/texture_storage.cpp",0x5b5,
                   "Parameter \"texture\" is null.",0,0);
  return;
}
...
/* GLES3::TextureStorage::texture_set_force_redraw_if_visible(RID, bool) */

void __thiscall
GLES3::TextureStorage::texture_set_force_redraw_if_visible
          (TextureStorage *this,ulong param_2,undefined1 param_3)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0xf4))) {
    lVar2 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
            *(long *)(*(long *)(this + 0xe0) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0xf0)) * 8);
    iVar1 = *(int *)(lVar2 + 0xe8);
    if (iVar1 == (int)(param_2 >> 0x20)) {
  ...
  _err_print_error("texture_set_force_redraw_if_visible","drivers/gles3/storage/texture_storage.cpp"
                   ,0x5df,"Parameter \"texture\" is null.",0,0);
  return;
}



/* GLES3::TextureStorage::texture_size_with_proxy(RID) */

undefined8 __thiscall
GLES3::TextureStorage::texture_size_with_proxy(TextureStorage *this,ulong param_2)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0xf4))) {
    lVar3 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
            *(long *)(*(long *)(this + 0xe0) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0xf0)) * 8);
    if (*(int *)(lVar3 + 0xe8) == (int)(param_2 >> 0x20)) {
      if (*(char *)(lVar3 + 8) != '\0') {
        if (*(long *)(lVar3 + 0x10) != 0) {
          ...
          if ((uint)uVar1 < *(uint *)(this + 0xf4)) {
            lVar3 = ((uVar1 & 0xffffffff) % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
                    *(long *)(*(long *)(this + 0xe0) +
                             ((uVar1 & 0xffffffff) / (ulong)*(uint *)(this + 0xf0)) * 8);
...
LAB_00101d15:
      return CONCAT44((float)(int)((ulong)*(undefined8 *)(lVar3 + 0x30) >> 0x20),
                      (float)(int)*(undefined8 *)(lVar3 + 0x30));
    }
    if (*(int *)(lVar3 + 0xe8) + 0x80000000U < 0x7fffffff) {
      _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                       "Method/function failed. Returning: nullptr",
  ...
  _err_print_error("texture_size_with_proxy","drivers/gles3/storage/texture_storage.cpp",0x5e6,
                   "Parameter \"texture\" is null.",0,0);
  return 0;
}
...
/* GLES3::TextureStorage::texture_get_native_handle(RID, bool) const */

undefined4 GLES3::TextureStorage::texture_get_native_handle(long param_1,ulong param_2)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(param_1 + 0xf4))) {
    lVar2 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(param_1 + 0xf0)) * 0xf0 +
            *(long *)(*(long *)(param_1 + 0xe0) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(param_1 + 0xf0)) * 8);
    iVar1 = *(int *)(lVar2 + 0xe8);
    if (iVar1 == (int)(param_2 >> 0x20)) {
  ...
  _err_print_error("texture_get_native_handle","drivers/gles3/storage/texture_storage.cpp",0x5f8,
                   "Parameter \"texture\" is null.",0,0);
  return 0;
}
...
/* GLES3::TextureStorage::texture_get_format(RID) const */

undefined4 __thiscall GLES3::TextureStorage::texture_get_format(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("texture_get_format","drivers/gles3/storage/texture_storage.cpp",0x6f8,
                   "Parameter \"texture\" is null.",0,0);
  return 0;
}
...
/* GLES3::TextureStorage::canvas_texture_initialize(RID) */

void __thiscall GLES3::TextureStorage::canvas_texture_initialize(TextureStorage *this,ulong param_2)
...
::_lookup_pos(HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
...
/* GLES3::TextureStorage::canvas_texture_free(RID) */

int __thiscall GLES3::TextureStorage::canvas_texture_free(TextureStorage *this,ulong param_2)

{
  ...
  if ((uint)param_2 < *(uint *)(this + 0x9c)) {
    lVar3 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x98)) * 0x40 +
            *(long *)(*(long *)(this + 0x88) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x98)) * 8);
    iVar1 = *(int *)(lVar3 + 0x38);
    if (iVar1 < 0) {
      pthread_mutex_unlock(__mutex);
      _err_print_error(&_LC65,"./core/templates/rid_owner.h",0x16c,"Method/function failed.",
    ...
    if ((int)(param_2 >> 0x20) == iVar1) {
      ...
      *(uint *)(*(long *)(*(long *)(this + 0x90) +
                         ((ulong)uVar2 / (ulong)*(uint *)(this + 0x98)) * 8) +
               ((ulong)uVar2 % (ulong)*(uint *)(this + 0x98)) * 4) = (uint)param_2;
...
/* CowData<GLES3::TextureStorage::TextureAtlas::SortItem>::_copy_on_write() [clone .isra.0] */

void __thiscall
CowData<GLES3::TextureStorage::TextureAtlas::SortItem>::_copy_on_write
          (CowData<GLES3::TextureStorage::TextureAtlas::SortItem> *this)
...
/* GLES3::TextureStorage::texture_set_path(RID, String const&) */

void __thiscall
GLES3::TextureStorage::texture_set_path(TextureStorage *this,ulong param_2,CowData *param_3)

{
  ...
  _err_print_error("texture_set_path","drivers/gles3/storage/texture_storage.cpp",0x594,
                   "Parameter \"texture\" is null.",0,0);
  return;
}
...
/* GLES3::TextureStorage::texture_get_path(RID) const */

CowData<char32_t> *
GLES3::TextureStorage::texture_get_path(CowData<char32_t> *param_1,long param_2,ulong param_3)

{
  ...
  if ((param_3 != 0) && ((uint)param_3 < *(uint *)(param_2 + 0xf4))) {
    lVar2 = ((param_3 & 0xffffffff) % (ulong)*(uint *)(param_2 + 0xf0)) * 0xf0 +
            *(long *)(*(long *)(param_2 + 0xe0) +
                     ((param_3 & 0xffffffff) / (ulong)*(uint *)(param_2 + 0xf0)) * 8);
  ...
  _err_print_error("texture_get_path","drivers/gles3/storage/texture_storage.cpp",0x59b,
                   "Parameter \"texture\" is null.",0,0);
  *(undefined8 *)param_1 = 0;
...
/* HashMap<RID, GLES3::TextureStorage::TextureAtlas::Texture, HashMapHasherDefault,
   ...
   GLES3::TextureStorage::TextureAtlas::Texture> > >::erase(RID const&) [clone .isra.0] */

void __thiscall
HashMap<RID,GLES3::TextureStorage::TextureAtlas::Texture,HashMapHasherDefault,HashMapComparatorDefault<RID>,DefaultTypedAllocator<HashMapElement<RID,GLES3::TextureStorage::TextureAtlas::Texture>>>
::erase(HashMap<RID,GLES3::TextureStorage::TextureAtlas::Texture,HashMapHasherDefault,HashMapComparatorDefault<RID>,DefaultTypedAllocator<HashMapElement<RID,GLES3::TextureStorage::TextureAtlas::Texture>>>
        *this,RID *param_1)
...
void __thiscall GLES3::TextureStorage::texture_debug_usage(TextureStorage *this,List *param_1)

{
  ...
  if (*(int *)(this + 0xf4) == 0) {
    ...
    do {
      uVar2 = *(uint *)((uVar16 % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
                        *(long *)(*(long *)(this + 0xe0) + (uVar16 / *(uint *)(this + 0xf0)) * 8) +
                       0xe8);
      if (uVar2 != 0xffffffff) {
      ...
      for (puVar9 = *(ulong **)*pauVar13; puVar9 != (ulong *)0x0; puVar9 = (ulong *)puVar9[1]) {
        if (*puVar9 != 0) {
          ...
          if ((uint)uVar16 < *(uint *)(this + 0xf4)) {
            lVar15 = ((uVar16 & 0xffffffff) % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
                     *(long *)(*(long *)(this + 0xe0) +
                              ((uVar16 & 0xffffffff) / (ulong)*(uint *)(this + 0xf0)) * 8);
...
undefined8 GLES3::TextureStorage::get_singleton(void)
...
/* GLES3::TextureStorage::texture_set_detect_srgb_callback(RID, void (*)(void*), void*) */

void GLES3::TextureStorage::texture_set_detect_srgb_callback(void)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::_texture_set_swizzle(GLES3::Texture*, Image::Format) */

void __thiscall
GLES3::TextureStorage::_texture_set_swizzle(undefined8 param_1_00,long param_1,int param_3)

{
  ...
  uVar2 = 0x1906;
LAB_001039f4:
                    /* WARNING: Could not recover jumptable at 0x001039ff. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*_glad_glTexParameteri)(uVar3,0x8e45,uVar2);
  return;
}



/* GLES3::TextureStorage::texture_get_texid(RID) const */

undefined4 __thiscall GLES3::TextureStorage::texture_get_texid(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("texture_get_texid","drivers/gles3/storage/texture_storage.cpp",0x700,
                   "Parameter \"texture\" is null.",0,0);
  return 0;
}
...
/* GLES3::TextureStorage::texture_get_size(RID) const */

undefined8 __thiscall GLES3::TextureStorage::texture_get_size(TextureStorage *this,ulong param_2)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0xf4))) {
    lVar4 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
            *(long *)(*(long *)(this + 0xe0) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0xf0)) * 8);
  ...
  _err_print_error("texture_get_size","drivers/gles3/storage/texture_storage.cpp",0x708,
                   "Parameter \"texture\" is null.",0,0);
  uVar3 = 0;
LAB_00103c47:
...
/* GLES3::TextureStorage::texture_get_width(RID) const */

undefined4 __thiscall GLES3::TextureStorage::texture_get_width(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("texture_get_width","drivers/gles3/storage/texture_storage.cpp",0x710,
                   "Parameter \"texture\" is null.",0,0);
  return 0;
}
...
/* GLES3::TextureStorage::texture_get_height(RID) const */

undefined4 __thiscall GLES3::TextureStorage::texture_get_height(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("texture_get_height","drivers/gles3/storage/texture_storage.cpp",0x718,
                   "Parameter \"texture\" is null.",0,0);
  return 0;
}
...
/* GLES3::TextureStorage::texture_get_depth(RID) const */

undefined4 __thiscall GLES3::TextureStorage::texture_get_depth(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("texture_get_depth","drivers/gles3/storage/texture_storage.cpp",0x720,
                   "Parameter \"texture\" is null.",0,0);
  return 0;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::texture_bind(RID, unsigned int) */

void __thiscall GLES3::TextureStorage::texture_bind(TextureStorage *this,ulong param_2,int param_3)

{
  ...
  _err_print_error("texture_bind","drivers/gles3/storage/texture_storage.cpp",0x728,
                   "Parameter \"texture\" is null.",0,0);
  return;
}
...
/* GLES3::TextureStorage::texture_remove_from_texture_atlas(RID) */

void __thiscall
GLES3::TextureStorage::texture_remove_from_texture_atlas(TextureStorage *this,long param_2)
      ...
      do {
        ...
        uVar13 = SUB164(auVar5 * auVar9,8);
              ...
              auVar7._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                               (ulong)*(uint *)(this + 0x158) * 4) + uVar13) -
                                    SUB164(auVar6 * auVar10,8)) * lVar3, auVar11._8_8_ = 0,
              auVar11._0_8_ = uVar17, uVar18 <= SUB164(auVar7 * auVar11,8)));
    }
  }
  _err_print_error("texture_remove_from_texture_atlas","drivers/gles3/storage/texture_storage.cpp",
                   0x73e,"Parameter \"t\" is null.",0,0);
  return;
}



/* GLES3::TextureStorage::texture_atlas_mark_dirty_on_texture(RID) */

void __thiscall
GLES3::TextureStorage::texture_atlas_mark_dirty_on_texture(TextureStorage *this,long param_2)
  ...
  if ((*(long *)(this + 0x138) != 0) && (*(int *)(this + 0x15c) != 0)) {
    ...
    if (uVar14 != 0) {
      ...
      while (((uint)uVar13 != uVar14 ||
             (param_2 != *(long *)(*(long *)(*(long *)(this + 0x138) + lVar12 * 8) + 0x10)))) {
        uVar16 = uVar16 + 1;
        auVar3._8_8_ = 0;
        ...
        auVar5._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                         (ulong)*(uint *)(this + 0x158) * 4) + iVar11) -
...
/* GLES3::TextureStorage::texture_atlas_remove_texture(RID) */

void __thiscall
GLES3::TextureStorage::texture_atlas_remove_texture(TextureStorage *this,long param_2)
...
/* GLES3::TextureStorage::texture_atlas_get_texture() const */

undefined4 __thiscall GLES3::TextureStorage::texture_atlas_get_texture(TextureStorage *this)
...
/* GLES3::TextureStorage::render_target_clear_used(RID) */

void __thiscall GLES3::TextureStorage::render_target_clear_used(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_clear_used","drivers/gles3/storage/texture_storage.cpp",0xa77,
                   "Parameter \"rt\" is null.",0,0);
  return;
}
...
/* GLES3::TextureStorage::render_target_get_color_internal_format(RID) const */

undefined4 __thiscall
GLES3::TextureStorage::render_target_get_color_internal_format(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_get_color_internal_format",
                   "drivers/gles3/storage/texture_storage.cpp",0xaa8,"Parameter \"rt\" is null.",0,0
                  );
  return 0x8058;
}
...
/* GLES3::TextureStorage::render_target_get_color_format(RID) const */

undefined4 __thiscall
GLES3::TextureStorage::render_target_get_color_format(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_get_color_format","drivers/gles3/storage/texture_storage.cpp",
                   0xaaf,"Parameter \"rt\" is null.",0,0);
  return 0x1908;
}



/* GLES3::TextureStorage::render_target_get_color_type(RID) const */

undefined4 __thiscall
GLES3::TextureStorage::render_target_get_color_type(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_get_color_type","drivers/gles3/storage/texture_storage.cpp",0xab6,
                   "Parameter \"rt\" is null.",0,0);
  return 0x1401;
}
...
/* GLES3::TextureStorage::render_target_get_color_format_size(RID) const */

undefined4 __thiscall
GLES3::TextureStorage::render_target_get_color_format_size(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_get_color_format_size","drivers/gles3/storage/texture_storage.cpp"
                   ,0xabd,"Parameter \"rt\" is null.",0,0);
  return 4;
}



/* GLES3::TextureStorage::render_target_get_fbo(RID) const */

undefined4 __thiscall
GLES3::TextureStorage::render_target_get_fbo(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_get_fbo","drivers/gles3/storage/texture_storage.cpp",0xae9,
                   "Parameter \"rt\" is null.",0,0);
  return 0;
}
...
/* GLES3::TextureStorage::render_target_get_color(RID) const */

undefined4 __thiscall
GLES3::TextureStorage::render_target_get_color(TextureStorage *this,ulong param_2)
    ...
    if (*(int *)(lVar3 + 0xe8) == (int)(param_2 >> 0x20)) {
      ...
      if ((uint)uVar1 < *(uint *)(this + 0xf4)) {
        ...
        if (iVar2 == (int)(uVar1 >> 0x20)) {
          if (*(char *)(lVar3 + 8) == '\0') {
LAB_00104a55:
            return *(undefined4 *)(lVar3 + 0x74);
          }
          if ((*(long *)(lVar3 + 0x10) == 0) ||
             (uVar1 = *(ulong *)(lVar3 + 0x10), *(uint *)(this + 0xf4) <= (uint)uVar1))
          goto LAB_00104af0;
          lVar3 = ((uVar1 & 0xffffffff) % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
                  *(long *)(*(long *)(this + 0xe0) +
                           ((uVar1 & 0xffffffff) / (ulong)*(uint *)(this + 0xf0)) * 8);
...
LAB_00104af0:
      _err_print_error("render_target_get_color","drivers/gles3/storage/texture_storage.cpp",0xaf4,
                       "Parameter \"texture\" is null.",0,0);
      return 0;
    }
    if (*(int *)(lVar3 + 0xe8) + 0x80000000U < 0x7fffffff) {
  ...
  _err_print_error("render_target_get_color","drivers/gles3/storage/texture_storage.cpp",0xaf0,
                   "Parameter \"rt\" is null.",0,0);
  return 0;
}
...
/* GLES3::TextureStorage::render_target_get_depth(RID) const */

undefined4 __thiscall
GLES3::TextureStorage::render_target_get_depth(TextureStorage *this,ulong param_2)
...
LAB_00104d10:
      _err_print_error("render_target_get_depth","drivers/gles3/storage/texture_storage.cpp",0xb02,
                       "Parameter \"texture\" is null.",0,0);
      return 0;
    }
    if (*(int *)(lVar3 + 0xe8) + 0x80000000U < 0x7fffffff) {
  ...
  _err_print_error("render_target_get_depth","drivers/gles3/storage/texture_storage.cpp",0xafe,
                   "Parameter \"rt\" is null.",0,0);
  return 0;
}
...
/* GLES3::TextureStorage::render_target_set_reattach_textures(RID, bool) const */

void __thiscall
GLES3::TextureStorage::render_target_set_reattach_textures
          (TextureStorage *this,ulong param_2,undefined1 param_3)

{
  ...
  _err_print_error("render_target_set_reattach_textures","drivers/gles3/storage/texture_storage.cpp"
                   ,0xb0c,"Parameter \"rt\" is null.",0,0);
  return;
}



/* GLES3::TextureStorage::render_target_is_reattach_textures(RID) const */

undefined1 __thiscall
GLES3::TextureStorage::render_target_is_reattach_textures(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_is_reattach_textures","drivers/gles3/storage/texture_storage.cpp",
                   0xb13,"Parameter \"rt\" is null.",0,0);
  return 0;
}



/* GLES3::TextureStorage::_render_target_get_sdf_rect(GLES3::RenderTarget const*) const */

undefined8 __thiscall
GLES3::TextureStorage::_render_target_get_sdf_rect(TextureStorage *this,RenderTarget *param_1)

{
  ...
  if (uVar1 == 2) {
    ...
    if (uVar1 < 3) {
      ...
      _err_print_error("_render_target_get_sdf_rect","drivers/gles3/storage/texture_storage.cpp",
                       0xb36,"Invalid viewport SDF oversize, defaulting to 100%.",0,0);
    }
    iVar2 = 100;
  }
LAB_00104f78:
  local_50 = Vector2i::operator*((Vector2i *)(param_1 + 8),iVar2);
...
/* GLES3::TextureStorage::render_target_get_sdf_rect(RID) const */

undefined8 __thiscall
GLES3::TextureStorage::render_target_get_sdf_rect(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_get_sdf_rect","drivers/gles3/storage/texture_storage.cpp",0xb46,
                   "Parameter \"rt\" is null.",0,0);
  return 0;
}
...
/* GLES3::TextureStorage::render_target_is_sdf_enabled(RID) const */

undefined1 __thiscall
GLES3::TextureStorage::render_target_is_sdf_enabled(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_is_sdf_enabled","drivers/gles3/storage/texture_storage.cpp",0xb54,
                   "Parameter \"rt\" is null.",0,0);
  return 0;
}
...
/* GLES3::TextureStorage::render_target_get_sdf_texture(RID) */

int __thiscall
GLES3::TextureStorage::render_target_get_sdf_texture(TextureStorage *this,ulong param_2)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x194))) {
    lVar4 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 400)) * 0xf0 +
            *(long *)(*(long *)(this + 0x180) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 400)) * 8);
    iVar1 = *(int *)(lVar4 + 0xe8);
    if (iVar1 == (int)(param_2 >> 0x20)) {
      ...
      if (*(long *)(this + 0x20) != 0) {
        ...
        if ((uint)uVar2 < *(uint *)(this + 0xf4)) {
          lVar4 = ((uVar2 & 0xffffffff) % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
                  *(long *)(*(long *)(this + 0xe0) +
                           ((uVar2 & 0xffffffff) / (ulong)*(uint *)(this + 0xf0)) * 8);
  ...
  _err_print_error("render_target_get_sdf_texture","drivers/gles3/storage/texture_storage.cpp",0xb5b
                   ,"Parameter \"rt\" is null.",0,0);
  return 0;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::render_target_sdf_process(RID) */

void __thiscall GLES3::TextureStorage::render_target_sdf_process(TextureStorage *this,ulong param_2)
      ...
      if (local_120 < iVar5) {
        if (uVar19 != 0) {
          if ((uint)uVar19 < *(uint *)(this + 0x224)) {
            uVar18 = ((uVar19 & 0xffffffff) % (ulong)*(uint *)(this + 0x220)) * 0x80 +
                     *(long *)(*(long *)(this + 0x210) +
                              ((uVar19 & 0xffffffff) / (ulong)*(uint *)(this + 0x220)) * 8);
...
LAB_00106918:
              ...
              uVar19 = (ulong)bVar17;
              lVar6 = uVar19 * 0x20;
              pOVar22 = (OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                         *)(*(long *)(uVar18 + 0x70) + lVar6);
              ...
              if (uVar14 != 0) {
                in_R10 = 0;
                while (((uint)uVar20 != uVar14 ||
                       (local_c0[6] != *(long *)(*(long *)(pOVar22 + 8) + uVar7 * 8)))) {
                  uVar16 = (int)in_R10 + 1;
                  in_R10 = (ulong)uVar16;
                  uVar7 = (ulong)((int)uVar7 + 1) % (ulong)uVar4;
                  uVar14 = *(uint *)(*(long *)(pOVar22 + 0x10) + uVar7 * 4);
                  if ((uVar14 == 0) || (((uVar4 + (int)uVar7) - uVar14 % uVar4) % uVar4 < uVar16))
                  goto LAB_001066e0;
                }
                ...
                if (puVar8 != (undefined4 *)0x0) {
                  ...
                  puVar8 = (undefined4 *)
                           OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                           ::lookup_ptr(pOVar22,(ulong *)(this + 0x2e0));
                  goto LAB_00105624;
                }
              }
LAB_001066e0:
              ...
              ShaderGLES3::_compile_specialization
                        ((Specialization *)pVVar1,(uint)(Specialization *)local_88,
                         (Version *)(ulong)uVar21,uVar18);
              uVar4 = *(uint *)(uVar18 + 0x68);
              if (uVar21 < uVar4) {
                OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                ::insert((OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                          *)(lVar6 + *(long *)(uVar18 + 0x70)),local_c0 + 6,
                         (Specialization *)local_88);
                uVar4 = *(uint *)(uVar18 + 0x68);
                if (uVar21 < uVar4) {
                  puVar8 = (undefined4 *)
                           OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                           ::lookup_ptr((OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                                         *)(lVar6 + *(long *)(uVar18 + 0x70)),local_c0 + 6);
...
LAB_0010740d:
                        _err_print_index_error
                                  ("_version_get_uniform","./drivers/gles3/shader_gles3.h",iVar5,
                                   uVar18,lVar13,pcVar15,pcVar24,"",false,false);
                        lVar13 = (long)*(int *)(this + 0x2a0);
                        goto LAB_001057e1;
                      }
                      if ((uVar18 != 0) && ((uint)uVar18 < *(uint *)(this + 0x224))) {
                        lVar9 = ((uVar18 & 0xffffffff) % (ulong)*(uint *)(this + 0x220)) * 0x80 +
                                *(long *)(*(long *)(this + 0x210) +
                                         ((uVar18 & 0xffffffff) / (ulong)*(uint *)(this + 0x220)) *
                                         8);
                        ...
                        if (uVar21 < uVar4) {
                          lVar9 = OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                                  ::lookup_ptr((OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                                                *)(lVar6 + *(long *)(lVar9 + 0x70)),local_88);
                            ...
                            if (*(int *)(this + 0x2a0) < 4) {
                              ...
                              _err_print_index_error
                                        ("_version_get_uniform","./drivers/gles3/shader_gles3.h",
                                         0xe4,3,lVar13,"p_which","uniform_count","",false,false);
                              goto LAB_00107bad;
                            }
                            local_48 = extraout_RDX;
                            if ((uint)uVar18 < *(uint *)(this + 0x224)) {
                              lVar13 = ((uVar18 & 0xffffffff) % (ulong)*(uint *)(this + 0x220)) *
                                       0x80 + *(long *)(*(long *)(this + 0x210) +
                                                       ((uVar18 & 0xffffffff) /
                                                       (ulong)*(uint *)(this + 0x220)) * 8);
                              ...
                              if ((int)uVar4 <= local_120) {
                                _err_print_index_error
                                          ("_version_get_uniform","./drivers/gles3/shader_gles3.h",
                                           0xe7,uVar19,(long)(int)uVar4,"p_variant",
                                           "int(version->variants.size())","",false,false);
                                goto LAB_00107bad;
                              }
                              if (uVar4 <= uVar21) goto LAB_00106690;
                              lVar13 = OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                                       ::lookup_ptr((
                                                  OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                                                  *)(lVar6 + *(long *)(lVar13 + 0x70)),local_c0 + 6)
                              ;
                              if (lVar13 == 0) {
                              ...
                              if (*(int *)(lVar13 + 0x10) < 4) {
                                _err_print_index_error
                                          ("_version_get_uniform","./drivers/gles3/shader_gles3.h",
                                           0xea,3,(long)*(int *)(lVar13 + 0x10),"p_which",
...
LAB_001076a0:
                        ...
                        lVar9 = OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                                ::lookup_ptr((OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                                              *)(lVar6 + *(long *)(lVar9 + 0x70)),local_c0 + 5);
                        pcVar3 = _glad_glUniform2iv;
                        if (lVar9 == 0) {
                          _err_print_error("_version_get_uniform","./drivers/gles3/shader_gles3.h",
                                           0xe9,"Parameter \"spec\" is null.",0,0);
                          ...
                          if (*(int *)(this + 0x2a0) < 1) {
                            _err_print_index_error
                                      ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe4,
                                       0,lVar13,"p_which","uniform_count","",false,false);
                            goto LAB_00107c86;
                          }
                          if ((uint)uVar18 < *(uint *)(this + 0x224)) {
                            lVar13 = ((uVar18 & 0xffffffff) % (ulong)*(uint *)(this + 0x220)) * 0x80
                                     + *(long *)(*(long *)(this + 0x210) +
                                                ((uVar18 & 0xffffffff) /
                                                (ulong)*(uint *)(this + 0x220)) * 8);
                            if (iVar5 != *(int *)(lVar13 + 0x78)) {
                            ...
                            lVar13 = OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                                     ::lookup_ptr((
                                                  OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                                                  *)(lVar6 + *(long *)(lVar13 + 0x70)),local_c0 + 4)
                            ;
                            if (lVar13 == 0) {
                              _err_print_error("_version_get_uniform",
                                               "./drivers/gles3/shader_gles3.h",0xe9,
                            ...
                            if (*(int *)(lVar13 + 0x10) < 1) {
                              _err_print_index_error
                                        ("_version_get_uniform","./drivers/gles3/shader_gles3.h",
                                         0xea,0,(long)*(int *)(lVar13 + 0x10),"p_which",
                                         "int(spec->uniform_location.size())","",false,false);
                              goto LAB_00107c86;
                            }
...
LAB_001077b0:
                        ...
                        lVar9 = OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                                ::lookup_ptr((OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                                              *)(lVar6 + *(long *)(lVar9 + 0x70)),local_c0 + 3);
                        ...
                        if (lVar9 == 0) {
                          ...
                          if (*(int *)(this + 0x2a0) < 2) {
                            _err_print_index_error
                                      ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe4,
                                       1,lVar13,"p_which","uniform_count","",false,false);
                            goto LAB_00107e68;
                          }
                          if ((uint)uVar18 < *(uint *)(this + 0x224)) {
                            lVar13 = ((uVar18 & 0xffffffff) % (ulong)*(uint *)(this + 0x220)) * 0x80
                            ...
                            lVar13 = OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                                     ::lookup_ptr((
                                                  OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                                                  *)(lVar6 + *(long *)(lVar13 + 0x70)),local_c0 + 2)
                            ;
                            if (lVar13 == 0) {
                              _err_print_error("_version_get_uniform",
                                               "./drivers/gles3/shader_gles3.h",0xe9,
                            ...
                            if (*(int *)(lVar13 + 0x10) < 2) {
                              _err_print_index_error
                                        ("_version_get_uniform","./drivers/gles3/shader_gles3.h",
                                         0xea,1,(long)*(int *)(lVar13 + 0x10),"p_which",
                                         "int(spec->uniform_location.size())","",false,false);
                              goto LAB_00107e68;
                            }
                      ...
                      if ((int)lVar13 < 3) {
                        _err_print_index_error
                                  ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe4,2,
                                   lVar13,"p_which","uniform_count","",false,false);
                        goto LAB_00105c48;
                      }
                      if ((uVar18 == 0) || (*(uint *)(this + 0x224) <= (uint)uVar18)) {
LAB_00107958:
                        ...
                        if ((int)uVar4 <= local_120) {
                          _err_print_index_error
                                    ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe7,
                                     uVar19,(long)(int)uVar4,"p_variant",
                                     "int(version->variants.size())","",false,false);
                          goto LAB_00105c48;
                        }
                        if (uVar4 <= uVar21) goto LAB_00106690;
                        lVar13 = OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                                 ::lookup_ptr((OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                                               *)(lVar6 + *(long *)(lVar13 + 0x70)),local_c0 + 1);
                        pcVar3 = _glad_glUniform1i;
                        if (lVar13 == 0) {
                          _err_print_error("_version_get_uniform","./drivers/gles3/shader_gles3.h",
                                           0xe9,"Parameter \"spec\" is null.",0,0);
                          ...
                          if (*(int *)(this + 0x2a0) < 3) {
                            _err_print_index_error
                                      ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe4,
                                       2,(long)*(int *)(this + 0x2a0),"p_which","uniform_count","",
                                       false,false);
                            goto LAB_00106ae5;
                          }
                          if ((uint)uVar18 < *(uint *)(this + 0x224)) {
                            ...
                            if (uVar4 <= uVar21) goto LAB_00106690;
                            lVar6 = OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                                    ::lookup_ptr((OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                                                  *)(lVar6 + *(long *)(lVar13 + 0x70)),local_c0);
                            if (lVar6 == 0) {
                              _err_print_error("_version_get_uniform",
                                               "./drivers/gles3/shader_gles3.h",0xe9,
                                               "Parameter \"spec\" is null.",0,0);
                            ...
                            if (*(int *)(lVar6 + 0x10) < 3) {
                              _err_print_index_error
                                        ("_version_get_uniform","./drivers/gles3/shader_gles3.h",
                                         0xea,2,(long)*(int *)(lVar6 + 0x10),"p_which",
                                         "int(spec->uniform_location.size())","",false,false);
                              goto LAB_00106ae5;
                            }
...
LAB_00105c48:
                      uVar4 = (uint)(local_f8 >> 0x20);
                      (*_glad_glActiveTexture)(0x84c0);
                      (*_glad_glBindTexture)(0xde1,*(undefined4 *)(pRVar11 + 0x50));
                      (*_glad_glFramebufferTexture2D)
                                (0x8d40,0x8ce0,0xde1,*(undefined4 *)(pRVar11 + 0x58),0);
                      ...
                      goto LAB_00106830;
                      uVar20 = ((uVar19 & 0xffffffff) % (ulong)*(uint *)(this + 0x220)) * 0x80 +
                               *(long *)(*(long *)(this + 0x210) +
                                        ((uVar19 & 0xffffffff) / (ulong)*(uint *)(this + 0x220)) * 8
                                        );
                      ...
                      if (2 < uVar14) {
                        pOVar22 = (OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                                   *)(*(long *)(uVar20 + 0x70) + 0x40);
                        puVar2 = local_c0 + 6;
                        puVar8 = (undefined4 *)
                                 OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                                 ::lookup_ptr(pOVar22,puVar2);
                        if (puVar8 != (undefined4 *)0x0) {
                          if (*(char *)(puVar8 + 0xc) != '\0') {
                            puVar8 = (undefined4 *)
                                     ...
                                     ::lookup_ptr(pOVar22,(ulong *)(this + 0x2e0));
LAB_00105d82:
                            if (puVar8 == (undefined4 *)0x0) goto LAB_00106600;
                          }
...
LAB_00106a78:
                            ...
                            lVar13 = ((uVar19 & 0xffffffff) % (ulong)*(uint *)(this + 0x220)) * 0x80
                                     + *(long *)(*(long *)(this + 0x210) +
                                                ((uVar19 & 0xffffffff) /
                                                (ulong)*(uint *)(this + 0x220)) * 8);
                            iVar5 = *(int *)(lVar13 + 0x78);
...
LAB_00107ff4:
                              ...
                              _err_print_index_error
                                        ("_version_get_uniform","./drivers/gles3/shader_gles3.h",
                                         iVar5,lVar13,lVar6,pcVar15,pcVar24,"",false,false);
                              lVar6 = (long)*(int *)(this + 0x2a0);
                            }
                            else {
                              uVar18 = 0x105e4a;
                              lVar13 = OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                                       ::lookup_ptr((
                                                  OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                                                  *)(*(long *)(lVar13 + 0x70) + 0x40),local_88);
                              pcVar3 = _glad_glUniform2iv;
                              if (lVar13 == 0) {
                                uVar18 = 0x108453;
                                _err_print_error("_version_get_uniform",
                                ...
                                if (*(int *)(this + 0x2a0) < 4) {
                                  ...
                                  _err_print_index_error
                                            ("_version_get_uniform","./drivers/gles3/shader_gles3.h"
                                             ,0xe4,3,lVar6,"p_which","uniform_count","",false,false)
                                  ;
                                  goto LAB_001087da;
                                }
                                local_48 = extraout_RDX;
                                if ((uint)uVar19 < *(uint *)(this + 0x224)) {
                                  lVar6 = ((uVar19 & 0xffffffff) % (ulong)*(uint *)(this + 0x220)) *
                                          0x80 + *(long *)(*(long *)(this + 0x210) +
                                                          ((uVar19 & 0xffffffff) /
                                                          (ulong)*(uint *)(this + 0x220)) * 8);
                                  ...
                                  if (*(int *)(lVar6 + 0x68) < 3) {
                                    _err_print_index_error
                                              ("_version_get_uniform",
                                               "./drivers/gles3/shader_gles3.h",0xe7,2,
                                               (long)*(int *)(lVar6 + 0x68),"p_variant",
                                               "int(version->variants.size())","",false,false);
                                    goto LAB_001087da;
                                  }
                                  lVar6 = OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                                  ...
                                  if (*(int *)(lVar6 + 0x10) < 4) {
                                    _err_print_index_error
                                              ("_version_get_uniform",
                                               "./drivers/gles3/shader_gles3.h",0xea,3,
                                               (long)*(int *)(lVar6 + 0x10),"p_which",
                                               "int(spec->uniform_location.size())","",false,false);
                                    goto LAB_001087da;
                                  }
...
LAB_0010807a:
                              ...
                              if (lVar13 == 0) {
                                ...
                                if (*(int *)(this + 0x2a0) < 1) {
                                  _err_print_index_error
                                            ("_version_get_uniform","./drivers/gles3/shader_gles3.h"
                                             ,0xe4,0,lVar6,"p_which","uniform_count","",false,false)
                                  ;
                                  goto LAB_00108883;
                                }
                                if ((uint)uVar19 < *(uint *)(this + 0x224)) {
                                  ...
                                  if (*(int *)(lVar6 + 0x10) < 1) {
                                    _err_print_index_error
                                              ("_version_get_uniform",
                                               "./drivers/gles3/shader_gles3.h",0xea,0,
                                               (long)*(int *)(lVar6 + 0x10),"p_which",
                                               "int(spec->uniform_location.size())","",false,false);
                                    goto LAB_00108883;
                                  }
...
LAB_001060b9:
                          ...
                          if ((int)lVar6 < 2) {
                            ...
                            _err_print_index_error
                                      ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe4,
                                       1,lVar6,"p_which","uniform_count","",false,false);
                            goto LAB_00106257;
                          }
                          if ((uVar18 == 0) || (*(uint *)(this + 0x224) <= (uint)uVar18)) {
LAB_0010811f:
                            ...
                            lVar6 = ((uVar18 & 0xffffffff) % (ulong)*(uint *)(this + 0x220)) * 0x80
                                    + *(long *)(*(long *)(this + 0x210) +
                                               ((uVar18 & 0xffffffff) /
                                               (ulong)*(uint *)(this + 0x220)) * 8);
                            ...
                            if (*(int *)(lVar6 + 0x68) < 3) {
                              ...
                              _err_print_index_error
                                        ("_version_get_uniform","./drivers/gles3/shader_gles3.h",
                                         0xe7,2,(long)*(int *)(lVar6 + 0x68),"p_variant",
                                         "int(version->variants.size())","",false,false);
                            }
                            else {
                              uVar19 = 0x106187;
                              ...
                              if (lVar6 == 0) {
                                ...
                                _err_print_index_error
                                          ("_version_get_uniform","./drivers/gles3/shader_gles3.h",
                                           0xea,1,(long)*(int *)(lVar6 + 0x10),"p_which",
                                           "int(spec->uniform_location.size())","",false,false);
                              }
                                ...
                                if (*(int *)(this + 0x2a0) < 2) {
                                  _err_print_index_error
                                            ("_version_get_uniform","./drivers/gles3/shader_gles3.h"
                                             ,0xe4,1,(long)*(int *)(this + 0x2a0),"p_which",
                                             "uniform_count","",false,false);
                                  goto LAB_00108686;
                                }
                                if ((uint)uVar18 < *(uint *)(this + 0x224)) {
                                  lVar6 = ((uVar18 & 0xffffffff) % (ulong)*(uint *)(this + 0x220)) *
                                          0x80 + *(long *)(*(long *)(this + 0x210) +
                                                          ((uVar18 & 0xffffffff) /
                                                          (ulong)*(uint *)(this + 0x220)) * 8);
                                  if (iVar5 != *(int *)(lVar6 + 0x78)) {
                                  ...
                                  if (*(int *)(lVar6 + 0x10) < 2) {
                                    _err_print_index_error
                                              ("_version_get_uniform",
                                               "./drivers/gles3/shader_gles3.h",0xea,1,
                                               (long)*(int *)(lVar6 + 0x10),"p_which",
                                               "int(spec->uniform_location.size())","",false,false);
                                    goto LAB_00108686;
                                  }
                            ...
                            if (*(int *)(lVar6 + 0x68) < 3) {
                              ...
                              if (lVar6 == 0) {
                                ...
                                if (*(int *)(this + 0x2a0) < 3) {
                                  _err_print_index_error
                                            ("_version_get_uniform","./drivers/gles3/shader_gles3.h"
                                             ,0xe4,2,(long)*(int *)(this + 0x2a0),"p_which",
                                             "uniform_count","",false,false);
                                  goto LAB_0010872f;
                                }
                                if ((uint)uVar18 < *(uint *)(this + 0x224)) {
                                  ...
                                  if (*(int *)(lVar6 + 0x10) < 3) {
                                    _err_print_index_error
                                              ("_version_get_uniform",
                                               "./drivers/gles3/shader_gles3.h",0xea,2,
                                               (long)*(int *)(lVar6 + 0x10),"p_which",
                                               "int(spec->uniform_location.size())","",false,false);
                                    goto LAB_0010872f;
                                  }
...
LAB_001063c4:
                          ...
                          if (0 < iVar23) {
                            do {
                              ...
                              (*_glad_glFramebufferTexture2D)
                                        (0x8d40,0x8ce0,0xde1,
                                         *(undefined4 *)(pRVar11 + (ulong)bVar17 * 4 + 0x58),0);
                              (*_glad_glBindTexture)
                                        (0xde1,*(undefined4 *)(pRVar11 + uVar19 * 4 + 0x58));
                              local_88[0] = 0;
                              uVar19 = *(ulong *)(this + 0x300);
                              if (*(int *)(this + 0x2a0) < 2) {
                                _err_print_index_error
                                ...
                                if (*(int *)(lVar6 + 0x68) < 3) {
                                  ...
                                  if (lVar6 == 0) {
                                    ...
                                    if (*(int *)(this + 0x2a0) < 2) {
                                      _err_print_index_error
                                                ("_version_get_uniform",
                                                 "./drivers/gles3/shader_gles3.h",0xe4,1,
                                                 (long)*(int *)(this + 0x2a0),"p_which",
                                                 "uniform_count","",false,false);
                                      goto LAB_0010746c;
                                    }
                                    if ((uint)uVar19 < *(uint *)(this + 0x224)) {
                                      lVar6 = ((uVar19 & 0xffffffff) %
                                              (ulong)*(uint *)(this + 0x220)) * 0x80 +
                                              *(long *)(*(long *)(this + 0x210) +
                                                       ((uVar19 & 0xffffffff) /
                                                       (ulong)*(uint *)(this + 0x220)) * 8);
                                      if (iVar5 != *(int *)(lVar6 + 0x78)) {
                                        if (*(int *)(lVar6 + 0x78) + 0x80000000U < 0x7fffffff) {
                                          _err_print_error("get_or_null",
                                                           "./core/templates/rid_owner.h",0x103,
                                      ...
                                      if (*(int *)(lVar6 + 0x10) < 2) {
                                        _err_print_index_error
                                                  ("_version_get_uniform",
                                                   "./drivers/gles3/shader_gles3.h",0xea,1,
                                                   (long)*(int *)(lVar6 + 0x10),"p_which",
                                                   "int(spec->uniform_location.size())","",false,
                                                   false);
                                        goto LAB_0010746c;
                                      }
                                      uVar12 = *(undefined4 *)(*(long *)(lVar6 + 0x18) + 4);
...
LAB_00106520:
                          ...
                          if ((uVar18 == 0) || (*(uint *)(this + 0x224) <= (uint)uVar18))
                          goto LAB_00106830;
                          uVar20 = ((uVar18 & 0xffffffff) % (ulong)*(uint *)(this + 0x220)) * 0x80 +
                                   *(long *)(*(long *)(this + 0x210) +
                                            ((uVar18 & 0xffffffff) / (ulong)*(uint *)(this + 0x220))
                                            * 8);
                          iVar5 = *(int *)(uVar20 + 0x78);
                          ...
                          if (puVar8 == (undefined4 *)0x0) {
                            ...
                            ShaderGLES3::_compile_specialization
                                      ((Specialization *)pVVar1,(uint)(Specialization *)local_88,
                                       (Version *)(ulong)uVar21,uVar20);
                            uVar4 = *(uint *)(uVar20 + 0x68);
                            if (uVar21 < uVar4) {
                              OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                              ::insert((OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                                        *)(lVar6 + *(long *)(uVar20 + 0x70)),puVar2,
                                       (Specialization *)local_88);
                              uVar4 = *(uint *)(uVar20 + 0x68);
                              if (uVar21 < uVar4) {
                                puVar8 = (undefined4 *)
                              ...
                              if (lVar9 == 0) {
                                ...
                                if ((uint)uVar18 < *(uint *)(this + 0x224)) {
                                  ...
                                  if ((int)uVar4 <= (int)uVar21) {
                                    _err_print_index_error
                                              ("_version_get_uniform",
                                               "./drivers/gles3/shader_gles3.h",0xe7,uVar19,
                                               (long)(int)uVar4,"p_variant",
                                               "int(version->variants.size())","",false,false);
                                    goto LAB_0010915d;
                                  }
...
LAB_00108a12:
                            ...
                            if (lVar9 == 0) {
                              ...
                              if (*(int *)(this + 0x2a0) < 1) {
                                _err_print_index_error
                                          ("_version_get_uniform","./drivers/gles3/shader_gles3.h",
                                           0xe4,0,lVar13,"p_which","uniform_count","",false,false);
                                goto LAB_001090b2;
                              }
                              if ((uint)uVar18 < *(uint *)(this + 0x224)) {
                                lVar13 = ((uVar18 & 0xffffffff) % (ulong)*(uint *)(this + 0x220)) *
...
LAB_00108d17:
                            ...
                            if (lVar9 == 0) {
                              ...
                              if (*(int *)(this + 0x2a0) < 2) {
                                _err_print_index_error
                                          ("_version_get_uniform","./drivers/gles3/shader_gles3.h",
                                           0xe4,1,lVar13,"p_which","uniform_count","",false,false);
                                goto LAB_00109247;
                              }
                              if ((uint)uVar18 < *(uint *)(this + 0x224)) {
                                lVar13 = ((uVar18 & 0xffffffff) % (ulong)*(uint *)(this + 0x220)) *
...
LAB_001070c8:
                          ...
                          if ((int)lVar13 < 3) {
                            _err_print_index_error
                                      ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe4,
                                       2,lVar13,"p_which","uniform_count","",false,false);
                            goto LAB_0010722d;
                          }
                          if ((uVar18 == 0) || (*(uint *)(this + 0x224) <= (uint)uVar18)) {
LAB_00108d88:
                            ...
                            if (lVar13 == 0) {
                              ...
                              _err_print_index_error
                                        ("_version_get_uniform","./drivers/gles3/shader_gles3.h",
                                         0xea,2,(long)*(int *)(lVar13 + 0x10),"p_which",
                                         "int(spec->uniform_location.size())","",false,false);
                            }
                            else if (-1 < *(int *)(*(long *)(lVar13 + 0x18) + 8)) {
                              local_c0[0] = 0;
...
LAB_0010722d:
                          (*_glad_glBindTexture)(0xde1,0);
                          (*_glad_glFramebufferTexture2D)
                                    (0x8d40,0x8ce0,0xde1,*(undefined4 *)(pRVar11 + 0x60),0);
                          (*_glad_glBindTexture)
                                    (0xde1,*(undefined4 *)(pRVar11 + (ulong)bVar17 * 4 + 0x58));
                          GLES3::CopyEffects::draw_screen_triangle();
                          (*_glad_glBindTexture)(0xde1,0);
...
LAB_001066b6:
              _err_print_index_error
                        ("operator[]","./core/templates/local_vector.h",0xb2,uVar19,uVar18,"p_index"
                         ,"count","",false,true);
              _err_flush_stdout();
                    /* WARNING: Does not return */
              pcVar3 = (code *)invalidInstructionException();
...
LAB_001068ef:
        local_c0[6] = 0;
        _err_print_index_error
                  ("_version_bind_shader","./drivers/gles3/shader_gles3.h",0xbb,uVar19,(long)iVar5,
                   "p_variant","variant_count","",false,false);
      }
LAB_0010660d:
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
        return;
...
LAB_001067f9:
    _err_print_error("render_target_sdf_process","drivers/gles3/storage/texture_storage.cpp",uVar10,
                     pcVar15,0,0);
    return;
  }
LAB_0010964d:
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::_render_target_allocate_sdf(GLES3::RenderTarget*) */

void __thiscall
GLES3::TextureStorage::_render_target_allocate_sdf(TextureStorage *this,RenderTarget *param_1)

{
  ...
  if (*(int *)(param_1 + 0x54) == 0) {
    ...
    *puVar3 = uVar6;
    ...
    iVar2 = 0x32;
    if ((iVar5 != 1) && (iVar2 = 0x19, iVar5 != 2)) {
      if (iVar5 != 0) {
        _err_print_error("_render_target_allocate_sdf","drivers/gles3/storage/texture_storage.cpp",
                         0xb85,"Invalid viewport SDF scale, defaulting to 100%.",0,0);
      }
      iVar2 = 100;
    }
    ...
    *(int *)(param_1 + 0x6c) = iVar2;
    ...
    (*_glad_glTexImage2D)
              (0xde1,0,0x8239,*(undefined4 *)(param_1 + 0x6c),*(undefined4 *)(param_1 + 0x70),0,
               0x8228,0x1402,0);
    (*_glad_glTexParameteri)(0xde1,0x2801,0x2600);
    (*_glad_glTexParameteri)(0xde1,0x2800,0x2600);
    (*_glad_glTexParameteri)(0xde1,0x813c,0);
    ...
    *puVar3 = uVar6;
    ...
    (*_glad_glTexImage2D)
              (0xde1,0,0x8058,*(undefined4 *)(param_1 + 0x6c),*(undefined4 *)(param_1 + 0x70),0,
               0x1908,0x1401,0);
    ...
    *puVar3 = uVar6;
    ...
    _err_print_error("_render_target_allocate_sdf","drivers/gles3/storage/texture_storage.cpp",0xb65
                     ,"Condition \"rt->sdf_texture_write_fb != 0\" is true.",0,0);
    return;
  }
                    /* WARNING: Subroutine does not return */
  __stack_chk_fail();
...
/* GLES3::TextureStorage::render_target_get_sdf_framebuffer(RID) */

int __thiscall
GLES3::TextureStorage::render_target_get_sdf_framebuffer(TextureStorage *this,ulong param_2)

{
  ...
  _err_print_error("render_target_get_sdf_framebuffer","drivers/gles3/storage/texture_storage.cpp",
                   0xbc0,"Parameter \"rt\" is null.",0,0);
  return 0;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::_render_target_clear_sdf(GLES3::RenderTarget*) [clone .part.0] */

void GLES3::TextureStorage::_render_target_clear_sdf(RenderTarget *param_1)

{
  ...
  *pHVar1;
  ...
  if ((*(long *)(Utilities::singleton + 0xd0) != 0) && (*(int *)(Utilities::singleton + 0xf4) != 0))
  {
    ...
    uVar42 = CONCAT44(0,*(uint *)(hash_table_size_primes +
    ...
    if (uVar36 != 0) {
      ...
      do {
        if ((uVar41 == uVar36) &&
           (local_44 ==
            *(uint *)(*(long *)(*(long *)(Utilities::singleton + 0xd0) + lVar39 * 8) + 0x10))) {
          (*_glad_glDeleteTextures)(1,&local_44);
          puVar37 = (uint *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
        ...
        iVar38 = SUB164(auVar4 * auVar20,8);
              ...
              (auVar5._8_8_ = 0, auVar5._0_8_ = uVar36 * uVar2, auVar21._8_8_ = 0,
              auVar21._0_8_ = uVar42, auVar6._8_8_ = 0,
              auVar6._0_8_ = ((*(uint *)(hash_table_size_primes +
                                        (ulong)*(uint *)(Utilities::singleton + 0xf0) * 4) + iVar38)
                             - SUB164(auVar5 * auVar21,8)) * uVar2, auVar22._8_8_ = 0,
              auVar22._0_8_ = uVar42, uVar43 <= SUB164(auVar6 * auVar22,8)));
    }
  }
    ...
    if (uVar36 != 0) {
      ...
      do {
        ...
        iVar38 = SUB164(auVar8 * auVar24,8);
              ...
              (auVar9._8_8_ = 0, auVar9._0_8_ = uVar36 * uVar2, auVar25._8_8_ = 0,
              auVar25._0_8_ = uVar42, auVar10._8_8_ = 0,
              auVar10._0_8_ =
                   ((*(uint *)(hash_table_size_primes +
                              (ulong)*(uint *)(Utilities::singleton + 0xf0) * 4) + iVar38) -
                   SUB164(auVar9 * auVar25,8)) * uVar2, auVar26._8_8_ = 0, auVar26._0_8_ = uVar42,
              uVar43 <= SUB164(auVar10 * auVar26,8)));
    }
  }
  _err_print_error("texture_free_data","drivers/gles3/storage/../storage/utilities.h",0x90,
                   "Condition \"!texture_allocs_cache.has(p_id)\" is true.",0,0);
    ...
    if (uVar36 != 0) {
      ...
      do {
        ...
        iVar38 = SUB164(auVar12 * auVar28,8);
              ...
              (auVar13._8_8_ = 0, auVar13._0_8_ = uVar36 * uVar2, auVar29._8_8_ = 0,
              auVar29._0_8_ = uVar42, auVar14._8_8_ = 0,
              auVar14._0_8_ =
                   ((*(uint *)(hash_table_size_primes +
                              (ulong)*(uint *)(Utilities::singleton + 0xf0) * 4) + iVar38) -
                   SUB164(auVar13 * auVar29,8)) * uVar2, auVar30._8_8_ = 0, auVar30._0_8_ = uVar42,
              uVar43 <= SUB164(auVar14 * auVar30,8)));
    }
  }
  _err_print_error("texture_free_data","drivers/gles3/storage/../storage/utilities.h",0x90,
                   "Condition \"!texture_allocs_cache.has(p_id)\" is true.",0,0);
    ...
    if (uVar36 != 0) {
      ...
      do {
        ...
        iVar38 = SUB164(auVar16 * auVar32,8);
              ...
              (auVar17._8_8_ = 0, auVar17._0_8_ = uVar36 * uVar2, auVar33._8_8_ = 0,
              auVar33._0_8_ = uVar42, auVar18._8_8_ = 0,
              auVar18._0_8_ =
                   ((*(uint *)(hash_table_size_primes +
                              (ulong)*(uint *)(Utilities::singleton + 0xf0) * 4) + iVar38) -
                   SUB164(auVar17 * auVar33,8)) * uVar2, auVar34._8_8_ = 0, auVar34._0_8_ = uVar42,
              uVar43 <= SUB164(auVar18 * auVar34,8)));
    }
  }
  _err_print_error("texture_free_data","drivers/gles3/storage/../storage/utilities.h",0x90,
                   "Condition \"!texture_allocs_cache.has(p_id)\" is true.",0,0);
LAB_0010a370:
  (*_glad_glDeleteFramebuffers)(1,param_1 + 0x54);
...
/* GLES3::TextureStorage::_render_target_clear_sdf(GLES3::RenderTarget*) */

void __thiscall
GLES3::TextureStorage::_render_target_clear_sdf(TextureStorage *this,RenderTarget *param_1)
...
void __thiscall
GLES3::TextureStorage::render_target_set_sdf_size_and_scale
          (TextureStorage *this,ulong param_2,int param_3,int param_4)

{
  ...
  _err_print_error("render_target_set_sdf_size_and_scale",
                   "drivers/gles3/storage/texture_storage.cpp",0xb1a,"Parameter \"rt\" is null.",0,0
                  );
  return;
}
...
/* GLES3::TextureStorage::texture_add_to_texture_atlas(RID) */

void __thiscall
GLES3::TextureStorage::texture_add_to_texture_atlas(TextureStorage *this,long param_2)

{
      ...
      do {
        if ((uVar25 == uVar24) && (param_2 == *(long *)(*(long *)(lVar3 + lVar29 * 8) + 0x10))) {
          ...
          while ((uVar25 != uVar21 || (param_2 != *(long *)(*(long *)(lVar3 + lVar28 * 8) + 0x10))))
          {
            ...
            if ((uVar21 == 0) ||
               (auVar11._8_8_ = 0, auVar11._0_8_ = (ulong)uVar21 * lVar5, auVar18._8_8_ = 0,
               auVar18._0_8_ = uVar30, auVar12._8_8_ = 0,
               auVar12._0_8_ = (ulong)((uVar2 + uVar26) - SUB164(auVar11 * auVar18,8)) * lVar5,
               auVar19._8_8_ = 0, auVar19._0_8_ = uVar30, SUB164(auVar12 * auVar19,8) < uVar24)) {
                    /* WARNING: Does not return */
        ...
        uVar27 = SUB164(auVar7 * auVar14,8);
              ...
              (auVar8._8_8_ = 0, auVar8._0_8_ = (ulong)uVar24 * lVar5, auVar15._8_8_ = 0,
              auVar15._0_8_ = uVar30, auVar9._8_8_ = 0,
              auVar9._0_8_ = (ulong)((uVar2 + uVar27) - SUB164(auVar8 * auVar15,8)) * lVar5,
              auVar16._8_8_ = 0, auVar16._0_8_ = uVar30, uVar31 <= SUB164(auVar9 * auVar16,8)));
    }
  }
  uStack_54 = 0;
  uStack_50 = 0;
  ...
  puVar23 = (undefined8 *)
            HashMap<RID,GLES3::TextureStorage::TextureAtlas::Texture,HashMapHasherDefault,HashMapComparatorDefault<RID>,DefaultTypedAllocator<HashMapElement<RID,GLES3::TextureStorage::TextureAtlas::Texture>>>
            ::operator[]((HashMap<RID,GLES3::TextureStorage::TextureAtlas::Texture,HashMapHasherDefault,HashMapComparatorDefault<RID>,DefaultTypedAllocator<HashMapElement<RID,GLES3::TextureStorage::TextureAtlas::Texture>>>
                          *)(this + 0x130),(RID *)&local_60);
  local_58 = 1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::_clear_render_target(GLES3::RenderTarget*) [clone .part.0] */

void __thiscall
GLES3::TextureStorage::_clear_render_target(TextureStorage *this,RenderTarget *param_1)

{
  ...
  *pHVar1;
  ...
  RBMap<unsigned_int,GLES3::RenderTarget::RTOverridden::FBOCacheEntry,Comparator<unsigned_int>,DefaultAllocator>
  ::clear((RBMap<unsigned_int,GLES3::RenderTarget::RTOverridden::FBOCacheEntry,Comparator<unsigned_int>,DefaultAllocator>
           *)(param_1 + 0xb0));
  ...
  if (uVar2 == 0) {
    ...
    lVar38 = ((uVar2 & 0xffffffff) % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
             *(long *)(*(long *)(this + 0xe0) +
                      ((uVar2 & 0xffffffff) / (ulong)*(uint *)(this + 0xf0)) * 8);
    iVar39 = *(int *)(lVar38 + 0xe8);
    if (iVar39 != (int)(uVar2 >> 0x20)) {
GLES3_TextureStorage__clear_render_target:
      if (iVar39 + 0x80000000U < 0x7fffffff) {
        _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                         "Method/function failed. Returning: nullptr",
...
LAB_0011b7e3:
    ...
    if (*(char *)(lVar38 + 8) != '\0') {
      if ((*(long *)(lVar38 + 0x10) == 0) ||
         (uVar2 = *(ulong *)(lVar38 + 0x10), *(uint *)(this + 0xf4) <= (uint)uVar2))
      goto LAB_0011b7e3;
      lVar38 = ((uVar2 & 0xffffffff) % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
               *(long *)(*(long *)(this + 0xe0) +
                        ((uVar2 & 0xffffffff) / (ulong)*(uint *)(this + 0xf0)) * 8);
  ...
  if (uVar36 != 0) {
    ...
    if ((*(long *)(Utilities::singleton + 0xd0) != 0) &&
      ...
      if (uVar46 != 0) {
        ...
        do {
          if ((local_58 == uVar46) &&
             (uVar36 == *(uint *)(*(long *)(*(long *)(Utilities::singleton + 0xd0) + lVar42 * 8) +
                                 0x10))) {
            (*_glad_glDeleteTextures)(1,&local_44);
            puVar37 = (uint *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                              ::operator[](pHVar1,&local_44);
          ...
          iVar39 = SUB164(auVar16 * auVar32,8);
                ...
                (auVar17._8_8_ = 0, auVar17._0_8_ = uVar46 * uVar2, auVar33._8_8_ = 0,
                auVar33._0_8_ = uVar41, auVar18._8_8_ = 0,
                auVar18._0_8_ =
                     ((*(uint *)(hash_table_size_primes +
                                (ulong)*(uint *)(Utilities::singleton + 0xf0) * 4) + iVar39) -
                     SUB164(auVar17 * auVar33,8)) * uVar2, auVar34._8_8_ = 0, auVar34._0_8_ = uVar41
        ...
        if (uVar46 != 0) {
          ...
          do {
            ...
            iVar39 = SUB164(auVar4 * auVar20,8);
                  ...
                  (auVar5._8_8_ = 0, auVar5._0_8_ = uVar46 * uVar2, auVar21._8_8_ = 0,
                  auVar21._0_8_ = uVar41, auVar6._8_8_ = 0,
                  auVar6._0_8_ = ((*(uint *)(hash_table_size_primes +
                                            (ulong)*(uint *)(Utilities::singleton + 0xf0) * 4) +
                                  iVar39) - SUB164(auVar5 * auVar21,8)) * uVar2, auVar22._8_8_ = 0,
                  auVar22._0_8_ = uVar41, uVar44 <= SUB164(auVar6 * auVar22,8)));
        }
      }
      _err_print_error("texture_free_data","drivers/gles3/storage/../storage/utilities.h",0x90,
                       "Condition \"!texture_allocs_cache.has(p_id)\" is true.",0,0);
      ...
      if (uVar46 != 0) {
        ...
        do {
          ...
          iVar39 = SUB164(auVar8 * auVar24,8);
                ...
                (auVar9._8_8_ = 0, auVar9._0_8_ = uVar46 * uVar2, auVar25._8_8_ = 0,
                auVar25._0_8_ = uVar40, auVar10._8_8_ = 0,
                auVar10._0_8_ =
                     ((*(uint *)(hash_table_size_primes +
                                (ulong)*(uint *)(Utilities::singleton + 0xf0) * 4) + iVar39) -
                     SUB164(auVar9 * auVar25,8)) * uVar2, auVar26._8_8_ = 0, auVar26._0_8_ = uVar40,
  ...
  if (local_44 == 0) {
    ...
    if ((*(long *)(lVar38 + 0xd0) != 0) && (*(int *)(lVar38 + 0xf4) != 0)) {
      ...
      if (uVar36 != 0) {
        ...
        do {
          if ((uVar46 == uVar36) &&
             (local_44 == *(uint *)(*(long *)(*(long *)(lVar38 + 0xd0) + lVar42 * 8) + 0x10))) {
            (*_glad_glDeleteTextures)(1,&local_44);
            puVar37 = (uint *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                              ::operator[]((HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                                            *)(lVar38 + 200),&local_44);
          ...
          iVar39 = SUB164(auVar12 * auVar28,8);
                ...
                (auVar13._8_8_ = 0, auVar13._0_8_ = uVar36 * uVar2, auVar29._8_8_ = 0,
                auVar29._0_8_ = uVar40, auVar14._8_8_ = 0,
                auVar14._0_8_ =
                     ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(lVar38 + 0xf0) * 4) +
                      iVar39) - SUB164(auVar13 * auVar29,8)) * uVar2, auVar30._8_8_ = 0,
                auVar30._0_8_ = uVar40, uVar45 <= SUB164(auVar14 * auVar30,8)));
      }
    }
    _err_print_error("texture_free_data","drivers/gles3/storage/../storage/utilities.h",0x90,
                     "Condition \"!texture_allocs_cache.has(p_id)\" is true.",0,0);
...
/* GLES3::TextureStorage::_clear_render_target(GLES3::RenderTarget*) */
...
/* GLES3::TextureStorage::render_target_free(RID) */

undefined1  [16] __thiscall
GLES3::TextureStorage::render_target_free(TextureStorage *this,ulong param_2)
...
LAB_0010b346:
    ...
    lVar8 = ((uVar4 & 0xffffffff) % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
            *(long *)(*(long *)(this + 0xe0) +
                     ((uVar4 & 0xffffffff) / (ulong)*(uint *)(this + 0xf0)) * 8);
...
LAB_0010b334:
  ...
  if (uVar7 <= uVar11) {
    uVar9 = 0x161;
LAB_0010b44f:
    auVar13 = _err_print_error(&_LC65,"./core/templates/rid_owner.h",uVar9,"Method/function failed."
                               ,0,0);
    return auVar13;
  }
...
LAB_0010b40c:
  auVar13._8_8_ = in_stack_ffffffffffffffc0;
  auVar13._0_8_ = lVar8;
  return auVar13;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::_create_render_target_backbuffer(GLES3::RenderTarget*) */

void __thiscall
GLES3::TextureStorage::_create_render_target_backbuffer(TextureStorage *this,RenderTarget *param_1)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (*(int *)(param_1 + 0x2c) != 0) {
    _err_print_error("_create_render_target_backbuffer","drivers/gles3/storage/texture_storage.cpp",
                     0x8d7,"Condition \"rt->backbuffer_fbo != 0\" is true.",
                     "Cannot allocate RenderTarget backbuffer: already initialized.",0,0);
LAB_0010b758:
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      return;
    }
  ...
  if (param_1[0x76] != (RenderTarget)0x0) {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error("_create_render_target_backbuffer",
                       "drivers/gles3/storage/texture_storage.cpp",0x8d8,
                       "Condition \"rt->direct_to_screen\" is true.",0,0);
      return;
    }
    goto LAB_0010ba3a;
  }
  iVar4 = Image::get_image_required_mipmaps
                    (*(undefined4 *)(param_1 + 8),*(undefined4 *)(param_1 + 0xc),5);
  iVar5 = *(int *)(param_1 + 8);
  if ((iVar5 < 0x29) || (iVar7 = *(int *)(param_1 + 0xc), iVar7 < 0x29)) goto LAB_0010b758;
  iVar2 = iVar4 + -4;
  if (iVar4 + -4 < 1) {
    iVar2 = 1;
  }
  *(int *)(param_1 + 0x14) = iVar2;
  ...
  do {
    ...
    (*_glad_glTexImage2D)
              (0xde1,iVar8,*(undefined4 *)(param_1 + 0x3c),iVar5,iVar7,0,
               *(undefined4 *)(param_1 + 0x40),*(undefined4 *)(param_1 + 0x44),0);
    iVar5 = iVar4;
    if (iVar4 < 1) {
      iVar5 = 1;
    }
...
LAB_0010b9c0:
    ...
    operator+((char *)&local_58,(String *)"Cannot allocate mipmaps for canvas screen blur. Status: "
             );
    _err_print_error("_create_render_target_backbuffer","drivers/gles3/storage/texture_storage.cpp",
                     0x8f7,(CowData<char32_t> *)&local_58,0,1);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
    _create_render_target_backbuffer(GLES3::RenderTarget*)::first_print = '\0';
  }
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::render_target_copy_to_back_buffer(RID, Rect2i const&, bool) */
...

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x194))) {
    ...
    if (*(int *)(pRVar10 + 0xe8) == (int)(param_2 >> 0x20)) {
      ...
      if ((cVar2 == '\0') ||
         (cVar2 = Vector2i::operator==(param_3 + 8,(Vector2i *)(local_48 + 8)), cVar2 == '\0')) {
...
LAB_0010bd68:
        ...
        if ((iVar8 < iVar3) && ((int)local_48._0_4_ < (int)local_50 + iVar8)) {
          if (((int)(local_48._12_4_ + local_48._4_4_) <= local_58[1]) ||
             (local_50._4_4_ + local_58[1] <= (int)local_48._4_4_)) goto LAB_0010bd58;
...
LAB_0010bc40:
        ...
        if (param_4 != '\0') {
          ...
          GLES3::CopyEffects::gaussian_blur
                    (uVar4,*(int *)(pRVar10 + 0x30),(Rect2i *)(ulong)*(uint *)(pRVar10 + 0x14),
                     (Vector2i *)&local_68);
          (*_glad_glBindFramebuffer)(0x8d40,*(undefined4 *)(pRVar10 + 0x2c));
        }
...
LAB_0010bdd6:
    _err_print_error("render_target_copy_to_back_buffer","drivers/gles3/storage/texture_storage.cpp"
                     ,uVar6,pcVar9,0,0);
    return;
  }
LAB_0010be56:
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::render_target_clear_back_buffer(RID, Rect2i const&, Color const&) */

void __thiscall
GLES3::TextureStorage::render_target_clear_back_buffer
          (TextureStorage *this,ulong param_2,Vector2i *param_3,Rect2i *param_4)
...
LAB_0010c0f0:
        ...
        if ((iVar7 < iVar2) && ((int)local_48 < (int)local_50 + iVar7)) {
          if (((int)(uStack_40._4_4_ + local_48._4_4_) <= local_58[1]) ||
             (local_50._4_4_ + local_58[1] <= local_48._4_4_)) goto LAB_0010c0e0;
          iVar2 = local_58[1];
          if (local_58[1] < *(int *)(param_3 + 4)) {
            iVar2 = *(int *)(param_3 + 4);
          }
...
LAB_0010c15e:
    _err_print_error("render_target_clear_back_buffer","drivers/gles3/storage/texture_storage.cpp",
                     uVar4,pcVar8,0,0);
    return;
  }
LAB_0010c1de:
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::render_target_gen_back_buffer_mipmaps(RID, Rect2i const&) */
...

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x194))) {
    ...
    if (*(int *)(pRVar8 + 0xe8) == (int)(param_2 >> 0x20)) {
      ...
      if ((cVar1 == '\0') ||
         (cVar1 = Vector2i::operator==(param_3 + 8,(Vector2i *)&uStack_30), cVar1 == '\0')) {
...
LAB_0010c2f2:
          if ((int)local_40 + iVar7 <= (int)local_38) goto LAB_0010c450;
          if (((int)(uStack_30._4_4_ + local_38._4_4_) <= local_48[1]) ||
             (local_40._4_4_ + local_48[1] <= local_38._4_4_)) goto LAB_0010c450;
          iVar2 = local_48[1];
...
LAB_0010c3df:
        ...
        GLES3::CopyEffects::gaussian_blur
                  (uVar3,*(int *)(pRVar8 + 0x30),(Rect2i *)(ulong)*(uint *)(pRVar8 + 0x14),
                   (Vector2i *)&local_58);
        (*_glad_glEnable)(0xbe2);
  ...
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
    _err_print_error("render_target_gen_back_buffer_mipmaps",
                     "drivers/gles3/storage/texture_storage.cpp",0xc78,"Parameter \"rt\" is null.",0
                     ,0);
    return;
  }
LAB_0010c523:
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::check_backbuffer(GLES3::RenderTarget*, bool, bool) */

void __thiscall
GLES3::TextureStorage::check_backbuffer
          (TextureStorage *this,RenderTarget *param_1,bool param_2,bool param_3)

{
  ...
  if ((*(int *)(param_1 + 0x30) == 0) || (*(int *)(param_1 + 0x34) == 0)) {
    ...
    if ((*(int *)(param_1 + 0x30) == 0) && (param_2)) {
      ...
      if (cVar7 == '\0') {
        (*_glad_glTexImage2D)
                  (iVar6,0,*(undefined4 *)(param_1 + 0x3c),*(undefined4 *)(param_1 + 8),
                   *(undefined4 *)(param_1 + 0xc),0,*(undefined4 *)(param_1 + 0x40),
      ...
      String::parse_latin1((StrRange *)&local_60);
      uVar5 = *(int *)(param_1 + 8) * *(int *)(param_1 + 0xc) *
              *(int *)(param_1 + 0x10) * *(int *)(param_1 + 0x48);
      local_58 = (char *)CONCAT44(local_58._4_4_,*(undefined4 *)(param_1 + 0x30));
      plVar1 = (long *)(lVar3 + 0x108);
      *plVar1 = *plVar1 + (ulong)uVar5;
      puVar4 = (uint *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                       ::operator[]((HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                                     *)(lVar3 + 200),(uint *)&local_58);
      *puVar4 = uVar5;
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
      ...
      if (cVar7 == '\0') {
        ...
        (*_glad_glFramebufferTextureMultiviewOVR)
                  (0x8d40,0x8ce0,*(undefined4 *)(param_1 + 0x30),0,0,*(undefined4 *)(param_1 + 0x10)
                  );
        if ((*(int *)(param_1 + 0x34) == 0) && (param_3)) {
          (*_glad_glGenTextures)(1,param_1 + 0x34);
          (*_glad_glBindTexture)(iVar6,*(undefined4 *)(param_1 + 0x34));
...
LAB_0010c989:
        (*_glad_glTexImage2D)
                  (iVar6,0,0x81a6,*(undefined4 *)(param_1 + 8),*(undefined4 *)(param_1 + 0xc),0,
                   0x1902,0x1405,0);
      }
      else {
LAB_0010c7ad:
        (*_glad_glTexImage3D)
                  (iVar6,0,0x81a6,*(undefined4 *)(param_1 + 8),*(undefined4 *)(param_1 + 0xc),
                   *(undefined4 *)(param_1 + 0x10),0,0x1902,0x1405,0);
      }
      lVar3 = Utilities::singleton;
      ...
      if (cVar7 == '\0') {
        if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
          ...
          return;
                    ...
                    /* WARNING: Treating indirect jump as call */
        (*_glad_glFramebufferTextureMultiviewOVR)
                  (0x8d40,0x8d00,*(undefined4 *)(param_1 + 0x34),0,0,*(undefined4 *)(param_1 + 0x10)
                  );
        return;
      }
      goto LAB_0010c9bb;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::_update_render_target(GLES3::RenderTarget*) [clone .part.0] */

void __thiscall
GLES3::TextureStorage::_update_render_target(TextureStorage *this,RenderTarget *param_1)
  ...
  *(undefined4 *)(param_1 + 0x40) = 0x1908;
  ...
  if (uVar4 == 0) {
    ...
    if ((uVar4 != 0) && ((uint)uVar4 < *(uint *)(this + 0xf4))) {
      lVar15 = ((uVar4 & 0xffffffff) % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
               *(long *)(*(long *)(this + 0xe0) +
                        ((uVar4 & 0xffffffff) / (ulong)*(uint *)(this + 0xf0)) * 8);
      ...
      if (iVar11 == (int)(uVar4 >> 0x20)) {
        if (*(char *)(lVar15 + 8) == '\0') {
LAB_0010ce67:
          (*_glad_glGenTextures)(1,param_1 + 0x24);
          (*_glad_glBindTexture)(iVar8,*(undefined4 *)(param_1 + 0x24));
          if (local_90 == '\0') {
            (*_glad_glTexImage2D)
                      (iVar8,0,*(undefined4 *)(param_1 + 0x3c),*(undefined4 *)(param_1 + 8),
                       *(undefined4 *)(param_1 + 0xc),0,*(undefined4 *)(param_1 + 0x40),
                       *(undefined4 *)(param_1 + 0x44),0);
          }
          else {
          ...
          String::parse_latin1((StrRange *)&local_60);
          uVar12 = *(int *)(param_1 + 8) * *(int *)(param_1 + 0xc) *
                   *(int *)(param_1 + 0x10) * *(int *)(param_1 + 0x48);
          local_58 = (char *)CONCAT44(local_58._4_4_,*(undefined4 *)(param_1 + 0x24));
          plVar2 = (long *)(lVar5 + 0x108);
          *plVar2 = *plVar2 + (ulong)uVar12;
          puVar9 = (uint *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                           ::operator[]((HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
...
joined_r0x0010d004:
        if (local_90 == '\0') {
          ...
          (*_glad_glTexImage2D)
                    (iVar8,0,0x81a6,*(undefined4 *)(param_1 + 8),*(undefined4 *)(param_1 + 0xc),0,
                     0x1902,0x1405,0);
LAB_0010cba6:
          (*_glad_glTexParameteri)(iVar8,0x2800,0x2600);
          ...
          *puVar9 = uVar12;
          ...
          (*_glad_glFramebufferTextureMultiviewOVR)
                    (0x8d40,0x8ce0,uVar10,0,0,*(undefined4 *)(param_1 + 0x10));
          if (*(long *)(param_1 + 0xa0) == 0) {
            (*_glad_glGenTextures)(1,param_1 + 0x28);
            (*_glad_glBindTexture)(iVar8,*(undefined4 *)(param_1 + 0x28));
            (*_glad_glTexImage3D)
                      (iVar8,0,0x81a6,*(undefined4 *)(param_1 + 8),*(undefined4 *)(param_1 + 0xc),
                       *(undefined4 *)(param_1 + 0x10),0,0x1902,0x1405,0);
            goto LAB_0010cba6;
          }
LAB_0010d1a0:
          lVar15 = get_texture(this,*(undefined8 *)(param_1 + 0xa0));
          if (lVar15 == 0) {
            if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
              uVar14 = 0x884;
              goto LAB_0010d2de;
        ...
        if (local_90 == '\0') {
          ...
          (*_glad_glFramebufferTextureMultiviewOVR)
                    (0x8d40,0x8d00,uVar10,0,0,*(undefined4 *)(param_1 + 0x10));
        }
        ...
        if (iVar11 == 0x8cd5) {
          ...
          *(RenderTarget **)(lVar15 + 0x80) = param_1;
          if (lVar5 == 0) {
            ...
            *(ulong *)(lVar15 + 100) =
                 CONCAT44((-(uint)(RVar3 == (RenderTarget)0x0) & 0xfffffffb) + 0x1406,uVar10);
        ...
        if (*(long *)(param_1 + 0x98) == 0) {
          ...
          cVar7 = HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                  ::_lookup_pos(pHVar1,(uint *)(ulong)*(uint *)(param_1 + 0x24),(uint *)&local_58);
          if (cVar7 == '\0') {
            _err_print_error("texture_free_data","drivers/gles3/storage/../storage/utilities.h",0x90
                             ,"Condition \"!texture_allocs_cache.has(p_id)\" is true.",0,0);
          }
            ...
            puVar9 = (uint *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                             ::operator[](pHVar1,(uint *)&local_60);
            *(long *)(lVar6 + 0x108) = *(long *)(lVar6 + 0x108) - (ulong)*puVar9;
            HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
            ::erase(pHVar1,(uint *)&local_60);
          }
        }
        lVar6 = Utilities::singleton;
        if (*(long *)(param_1 + 0xa0) == 0) {
          ...
          cVar7 = HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                  ::_lookup_pos(pHVar1,(uint *)(ulong)*(uint *)(param_1 + 0x28),(uint *)&local_58);
          if (cVar7 == '\0') {
            _err_print_error("texture_free_data","drivers/gles3/storage/../storage/utilities.h",0x90
                             ,"Condition \"!texture_allocs_cache.has(p_id)\" is true.",0,0);
          }
...
LAB_0010cd6e:
        operator+((char *)&local_58,(String *)"Could not create render target, status: ");
        _err_print_error("_update_render_target","drivers/gles3/storage/texture_storage.cpp",0x8b4,
                         (CowData<char32_t> *)&local_58,0,1);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
        if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
          return;
...
joined_r0x0010d57c:
  ...
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    uVar14 = 0x861;
LAB_0010d2de:
    _err_print_error("_update_render_target","drivers/gles3/storage/texture_storage.cpp",uVar14,
                     "Parameter \"texture\" is null.",0,0);
    return;
  }
LAB_0010d61a:
...
/* GLES3::TextureStorage::_update_render_target(GLES3::RenderTarget*) */
...
/* GLES3::TextureStorage::render_target_set_direct_to_screen(RID, bool) */

void __thiscall
GLES3::TextureStorage::render_target_set_direct_to_screen
...

{
  ...
  _err_print_error("render_target_set_direct_to_screen","drivers/gles3/storage/texture_storage.cpp",
                   0xa56,"Parameter \"rt\" is null.",0,0);
  return;
}



/* GLES3::TextureStorage::render_target_set_size(RID, int, int, unsigned int) */

void __thiscall
GLES3::TextureStorage::render_target_set_size
...

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x194))) {
    pRVar1 = (RenderTarget *)
             ...
             *(long *)(*(long *)(this + 0x180) +
                      ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 400)) * 8));
    if (*(int *)(pRVar1 + 0xe8) == (int)(param_2 >> 0x20)) {
      if ((((*(int *)(pRVar1 + 8) != param_3) || (*(int *)(pRVar1 + 0xc) != param_4)) ||
          (*(int *)(pRVar1 + 0x10) != param_5)) && (*(long *)(pRVar1 + 0x98) == 0)) {
        if (pRVar1[0x76] == (RenderTarget)0x0) {
          _clear_render_target(this,pRVar1);
        }
  ...
  _err_print_error("render_target_set_size","drivers/gles3/storage/texture_storage.cpp",0x9c2,
                   "Parameter \"rt\" is null.",0,0);
  return;
}
...
/* GLES3::TextureStorage::render_target_set_use_hdr(RID, bool) */

void __thiscall
GLES3::TextureStorage::render_target_set_use_hdr
          (TextureStorage *this,ulong param_2,RenderTarget param_3)
...
LAB_0010d9d2:
  _err_print_error("render_target_set_use_hdr","drivers/gles3/storage/texture_storage.cpp",uVar2,
                   pcVar1,0,0);
  return;
}
...
/* GLES3::TextureStorage::render_target_set_transparent(RID, bool) */

void __thiscall
GLES3::TextureStorage::render_target_set_transparent
          (TextureStorage *this,ulong param_2,RenderTarget param_3)

{
  ...
  _err_print_error("render_target_set_transparent","drivers/gles3/storage/texture_storage.cpp",0xa43
                   ,"Parameter \"rt\" is null.",0,0);
  return;
}
...
/* GLES3::TextureStorage::render_target_set_msaa(RID, RenderingServer::ViewportMSAA) */

void __thiscall
GLES3::TextureStorage::render_target_set_msaa(TextureStorage *this,ulong param_2,int param_3)

{
    ...
    if (*(int *)(pRVar3 + 0xe8) == (int)(param_2 >> 0x20)) {
      if (pRVar3[0x76] == (RenderTarget)0x0) {
        if (*(int *)(pRVar3 + 0x78) != param_3) {
          _err_print_error("render_target_set_msaa","drivers/gles3/storage/texture_storage.cpp",
                           0xa84,"2D MSAA is not yet supported for GLES3.",0,1);
          if (pRVar3[0x76] == (RenderTarget)0x0) {
            _clear_render_target(this,pRVar3);
          }
  ...
  pcVar1 = "Parameter \"rt\" is null.";
LAB_0010dc72:
  _err_print_error("render_target_set_msaa","drivers/gles3/storage/texture_storage.cpp",uVar2,pcVar1
                   ,0,0);
  return;
}
...
/* GLES3::TextureStorage::canvas_texture_allocate() */

void __thiscall GLES3::TextureStorage::canvas_texture_allocate(TextureStorage *this)

{
  RID_Alloc<GLES3::CanvasTexture,true>::allocate_rid
            ((RID_Alloc<GLES3::CanvasTexture,true> *)(this + 0x80));
  return;
}



/* GLES3::TextureStorage::texture_allocate() */

void __thiscall GLES3::TextureStorage::texture_allocate(TextureStorage *this)
...
/* GLES3::TextureStorage::_get_gl_image_and_format(Ref<Image> const&, Image::Format, Image::Format&,
   unsigned int&, unsigned int&, unsigned int&, bool&, bool) const */

Ref<Image> *
GLES3::TextureStorage::_get_gl_image_and_format
          (Ref<Image> *param_1,undefined8 param_2,long *param_3,undefined4 param_4,
...

{
  ...
  *param_6 = 0;
  if ((pIVar12 == (Image *)0x0) ||
     (local_68 = pIVar12, cVar3 = RefCounted::reference(), cVar3 == '\0')) {
    local_68 = (Image *)0x0;
    pIVar12 = (Image *)0x0;
  }
  *param_9 = 0;
...
LAB_0010de88:
    if (pIVar12 == (Image *)0x0) goto LAB_0010de91;
  }
  else {
    switch(param_4) {
    case 0x11:
...
LAB_0010e3c8:
    ...
    if (cVar4 != '\0') {
      _err_print_error("_get_gl_image_and_format","drivers/gles3/storage/texture_storage.cpp",0x2e0,
                       "Condition \"image->is_compressed()\" is true. Returning: image",0,0);
      *(undefined8 *)param_1 = 0;
    ...
    if (iVar5 == 0) {
      ...
      *(Image **)param_1 = pIVar12;
      ...
      _err_print_error("_get_gl_image_and_format","drivers/gles3/storage/texture_storage.cpp",0x2e8,
                       "Condition \"err != OK\" is true. Returning: Ref<Image>()",
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::_texture_set_data(RID, Ref<Image> const&, int, bool) */

void __thiscall
GLES3::TextureStorage::_texture_set_data
          (TextureStorage *this,ulong param_2,long *param_3,int param_4,char param_5)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0xf4))) {
    lVar14 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
             *(long *)(*(long *)(this + 0xe0) +
                      ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0xf0)) * 8);
    if (*(int *)(lVar14 + 0xe8) == (int)(param_2 >> 0x20)) {
      if (*(int *)(lVar14 + 0x5c) != 0x806f) {
        ...
        local_81 = '\0';
        if ((((char)RasterizerGLES3::gles_over_gl == '\0') && (*(int *)(lVar14 + 0x5c) == 0x8c1a))
           && ((iVar4 = Image::get_format(), iVar4 == 0x14 ||
               (iVar4 = Image::get_format(), iVar4 == 0x15)))) {
          uVar12 = 1;
        }
        uVar5 = Image::get_format();
        _get_gl_image_and_format
                  ((Ref<Image> *)&local_70,this,param_3,uVar5,&local_74,&local_7c,&local_78,
                   &local_80,&local_81,uVar12);
        pIVar15 = local_70;
        ...
        if (*(char *)(lVar14 + 0x71) != '\0') {
          ...
          if (cVar2 != '\0') {
            ...
            operator+((char *)this_00,(String *)"Texture \'");
            String::operator+((String *)&local_58,this_00);
            _err_print_error("_texture_set_data","drivers/gles3/storage/texture_storage.cpp",0x624,
                             (String *)&local_58,0,0);
            CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
...
LAB_0010f058:
              ...
              if (pIVar15 != pIVar7) {
                local_70 = pIVar7;
                if ((pIVar7 != (Image *)0x0) && (cVar2 = RefCounted::reference(), cVar2 == '\0'))
                goto LAB_0010f04f;
                goto LAB_0010f058;
              }
            }
            ...
            pIVar15 = local_70;
            if ((cVar2 != '\0') &&
               (cVar2 = predelete_handler(local_58), pIVar15 = local_70, cVar2 != '\0')) {
...
LAB_0010ed99:
          Image::resize_to_po2(pIVar15,0,1);
        }
          ...
          do {
            ...
            if (cVar2 == '\0') {
              ...
              if (*(int *)(lVar14 + 0x5c) == 0x8c1a) {
                if (param_5 != '\0') {
                  (*_glad_glTexImage3D)
                            (0x8c1a,uVar13,local_78,iVar4,iVar3,*(undefined4 *)(lVar14 + 0x40),0,
                             local_7c,local_80,0,piVar17);
                }
                ...
                if (local_60 < *(long *)(local_50[0] + -8)) {
                  (*_glad_glTexImage2D)
                            (local_94,uVar13,local_78,iVar4,iVar3,0,local_7c,local_80,
                             local_50[0] + local_60);
                  goto LAB_0010e978;
                }
              }
...
LAB_0010ec1d:
              _err_print_index_error
                        ("get","./core/templates/cowdata.h",0xdb,local_60,lVar14,"p_index","size()",
                         "",false,true);
              _err_flush_stdout();
                    /* WARNING: Does not return */
              pcVar6 = (code *)invalidInstructionException();
            ...
            if (*(int *)(lVar14 + 0x5c) == 0x8c1a) {
              if (param_5 != '\0') {
                (*_glad_glCompressedTexImage3D)
                          (0x8c1a,uVar13,local_78,iVar4,iVar3,*(int *)(lVar14 + 0x40),0,
                           local_68 * *(int *)(lVar14 + 0x40),0);
              }
              if (local_60 < 0) {
LAB_0010ec10:
                if (local_50[0] != 0) goto LAB_0010ec19;
              }
                ...
                uVar5 = local_78;
LAB_0010ecd1:
                (*pcVar6)(0x8c1a,uVar13,0,0,param_4,iVar4,iVar3,1,uVar5,uVar10,lVar8);
                goto LAB_0010e978;
              }
LAB_0010ed70:
              lVar14 = 0;
            ...
            if (local_50[0] == 0) goto LAB_0010ed70;
            if (*(long *)(local_50[0] + -8) <= local_60) goto LAB_0010ec19;
            (*_glad_glCompressedTexImage2D)
                      (local_94,uVar13,local_78,iVar4,iVar3,0,CONCAT44(uStack_64,local_68),
                       local_50[0] + local_60);
LAB_0010e978:
            iVar4 = iVar4 >> 1;
...
LAB_0010eb6e:
    _err_print_error("_texture_set_data","drivers/gles3/storage/texture_storage.cpp",uVar11,pcVar9,0
                     ,0);
    return;
  }
LAB_0010f0dc:
...
/* GLES3::TextureStorage::texture_set_data(RID, Ref<Image> const&, int) */

void GLES3::TextureStorage::texture_set_data(void)
...
/* GLES3::TextureStorage::texture_2d_update(RID, Ref<Image> const&, int) */

void GLES3::TextureStorage::texture_2d_update(long param_1,ulong param_2)

{
  ...
  *this;
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(param_1 + 0xf4))) {
    lVar18 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(param_1 + 0xf0)) * 0xf0 +
             *(long *)(*(long *)(param_1 + 0xe0) +
                      ((param_2 & 0xffffffff) / (ulong)*(uint *)(param_1 + 0xf0)) * 8);
    if (*(int *)(lVar18 + 0xe8) == (int)(param_2 >> 0x20)) {
      uVar1 = *(uint *)(lVar18 + 0x6c);
      local_44 = *(uint *)(lVar18 + 0x74);
      this = (HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
              *)(Utilities::singleton + 200);
      if ((*(long *)(Utilities::singleton + 0xd0) != 0) &&
         (*(int *)(Utilities::singleton + 0xf4) != 0)) {
        uVar2 = *(ulong *)(hash_table_size_primes_inv +
        ...
        if (uVar13 != 0) {
          ...
          do {
            if ((uVar13 == uVar19) &&
               (local_44 ==
                *(uint *)(*(long *)(*(long *)(Utilities::singleton + 0xd0) + lVar17 * 8) + 0x10))) {
              puVar14 = (uint *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                                ::operator[](this,&local_44);
              *(long *)(lVar11 + 0x108) =
                   *(long *)(lVar11 + 0x108) + ((ulong)uVar1 - (ulong)*puVar14);
              puVar14 = (uint *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                                ::operator[](this,&local_44);
              *puVar14 = uVar1;
              goto LAB_0010f2e7;
            ...
            iVar15 = SUB164(auVar4 * auVar8,8);
                  ...
                  auVar6._0_8_ = ((*(uint *)(hash_table_size_primes +
                                            (ulong)*(uint *)(Utilities::singleton + 0xf0) * 4) +
                                  iVar15) - SUB164(auVar5 * auVar9,8)) * uVar2, auVar10._8_8_ = 0,
                  auVar10._0_8_ = uVar20, uVar21 <= SUB164(auVar6 * auVar10,8)));
        }
      }
      _err_print_error("texture_resize_data","drivers/gles3/storage/../storage/utilities.h",0x97,
                       "Condition \"!texture_allocs_cache.has(p_id)\" is true.",0,0);
LAB_0010f2e7:
      if (*(long *)(lVar18 + 0x88) != 0) {
  ...
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    _err_print_error("texture_2d_update","drivers/gles3/storage/texture_storage.cpp",1000,
                     "Parameter \"tex\" is null.",0,0);
    return;
  }
LAB_0010f403:
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::texture_2d_layered_initialize(RID, Vector<Ref<Image> > const&,
   RenderingServer::TextureLayeredType) */

void __thiscall
GLES3::TextureStorage::texture_2d_layered_initialize
...
LAB_0010f811:
      _err_print_error("texture_2d_layered_initialize","drivers/gles3/storage/texture_storage.cpp",
                       uVar12,pcVar10,0,0);
      return;
    }
    goto LAB_0010fd83;
...
LAB_0010f6a3:
    ...
    local_140 = 0;
    _get_gl_image_and_format
              ((Ref<Image> *)&local_138,this,(StrRange *)&local_140,uStack_dc,&local_d8,
               (long)&uStack_cc + 4,&local_c4,(long)&local_c4 + 4,&local_b8,0);
...
LAB_0010f7c0:
      _err_print_index_error
                ("get","./core/templates/cowdata.h",0xdb,lVar13,lVar15,"p_index","size()","",false,
                 true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
      pcVar2 = (code *)invalidInstructionException();
    ...
    lVar15 = *(long *)(*(long *)(param_3 + 8) + -8);
    if (lVar15 < 1) goto LAB_0010f7a3;
    iVar6 = Image::get_image_data_size
                      (local_f8 & 0xffffffff,local_f8._4_4_,uStack_dc,uStack_f0._4_4_ != 0);
    ...
    *puVar9 = uVar4;
    ...
    RID_Alloc<GLES3::Texture,true>::initialize_rid
              ((RID_Alloc<GLES3::Texture,true> *)(this + 0xd8),param_2,&local_128);
    lVar15 = *(long *)(param_3 + 8);
    while (lVar15 != 0) {
      iVar6 = (int)uVar14;
    ...
    if ((local_a8._8_8_ != 0) && (cVar5 = RefCounted::unreference(), cVar5 != '\0')) {
    ...
    _err_print_error("texture_2d_layered_initialize","drivers/gles3/storage/texture_storage.cpp",
                     0x360,
                     "Condition \"p_layered_type == RenderingServer::TEXTURE_LAYERED_CUBEMAP_ARRAY\" is true."
                     ,"Cubemap Arrays are not supported in the Compatibility renderer.",0,0);
  }
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
...
/* GLES3::TextureStorage::texture_proxy_update(RID, RID) */

void __thiscall
GLES3::TextureStorage::texture_proxy_update(TextureStorage *this,ulong param_2,ulong param_3)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0xf4))) {
    puVar13 = (undefined8 *)
              (((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
              *(long *)(*(long *)(this + 0xe0) +
                       ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0xf0)) * 8));
    if (*(int *)(puVar13 + 0x1d) == (int)(param_2 >> 0x20)) {
      if (*(char *)(puVar13 + 1) == '\0') {
        ...
        if ((param_3 != 0) && ((uint)param_3 < *(uint *)(this + 0xf4))) {
          puVar14 = (undefined8 *)
                    (((param_3 & 0xffffffff) % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
                    *(long *)(*(long *)(this + 0xe0) +
                             ((param_3 & 0xffffffff) / (ulong)*(uint *)(this + 0xf0)) * 8));
...
LAB_0010ff60:
              ...
              *(undefined2 *)(puVar13 + 0xf) = *(undefined2 *)(puVar14 + 0xf);
              ...
              if (puVar13[0x13] != puVar14[0x13]) {
                CowData<Ref<Image>>::_ref
                          ((CowData<Ref<Image>> *)(puVar13 + 0x13),(CowData *)(puVar14 + 0x13));
              }
              *(undefined1 *)(puVar13 + 0x14) = *(undefined1 *)(puVar14 + 0x14);
              puVar13[0x15] = puVar14[0x15];
              puVar13[0x16] = puVar14[0x16];
              puVar13[0x17] = puVar14[0x17];
              puVar13[0x18] = puVar14[0x18];
              puVar13[0x19] = puVar14[0x19];
              uVar12 = puVar14[0x1b];
            ...
            uVar1 = puVar13[2];
            if ((uint)uVar1 < *(uint *)(this + 0xf4)) {
              lVar11 = ((uVar1 & 0xffffffff) % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
                       *(long *)(*(long *)(this + 0xe0) +
                                ((uVar1 & 0xffffffff) / (ulong)*(uint *)(this + 0xf0)) * 8);
              if (*(int *)(lVar11 + 0xe8) == (int)(uVar1 >> 0x20)) {
                lVar2 = *(long *)(lVar11 + 0x20);
                if (((lVar2 != 0) && (lVar9 = *(long *)(lVar2 + -8), lVar9 != 0)) && (0 < lVar9)) {
                  lVar15 = 0;
                  do {
                    if (param_2 == *(ulong *)(lVar2 + lVar15 * 8)) {
                      if (lVar9 <= lVar15) {
                        _err_print_index_error
                                  ("remove_at","./core/templates/cowdata.h",0xe4,lVar15,lVar9,
                      ...
                      if (lVar2 == 0) {
                        ...
                        if (lVar15 < lVar9) {
                          memmove((void *)(lVar2 + lVar15 * 8),(void *)(lVar2 + 8 + lVar15 * 8),
                                  (lVar9 - lVar15) * 8);
                        }
                      }
...
LAB_00110162:
  _err_print_error("texture_proxy_update","drivers/gles3/storage/texture_storage.cpp",uVar12,pcVar8,
                   0,0);
  return;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::texture_create_from_native_handle(RenderingServer::TextureType,
   Image::Format, unsigned long, int, int, int, int, RenderingServer::TextureLayeredType) */

undefined8 __thiscall
GLES3::TextureStorage::texture_create_from_native_handle
          (TextureStorage *this,int param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5
...

{
  ...
  local_b8 = param_3;
  local_94 = param_4;
  uVar4 = RID_Alloc<GLES3::Texture,true>::make_rid
                    ((RID_Alloc<GLES3::Texture,true> *)(this + 0xd8),(Texture *)&local_108);
...
/* GLES3::TextureStorage::texture_proxy_initialize(RID, RID) */

void __thiscall
GLES3::TextureStorage::texture_proxy_initialize
...

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  if ((param_3 != 0) && ((uint)param_3 < *(uint *)(this + 0xf4))) {
    lVar4 = ((param_3 & 0xffffffff) % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
            *(long *)(*(long *)(this + 0xe0) +
                     ((param_3 & 0xffffffff) / (ulong)*(uint *)(this + 0xf0)) * 8);
    if (*(int *)(lVar4 + 0xe8) == (int)(param_3 >> 0x20)) {
      ...
      RID_Alloc<GLES3::Texture,true>::initialize_rid
                ((RID_Alloc<GLES3::Texture,true> *)(this + 0xd8),param_2,&local_118);
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    _err_print_error("texture_proxy_initialize","drivers/gles3/storage/texture_storage.cpp",0x3ba,
                     "Parameter \"texture\" is null.",0,0);
    return;
  }
LAB_00110a03:
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::texture_external_initialize(RID, int, int, unsigned long) */

void GLES3::TextureStorage::texture_external_initialize
...

{
  ...
  *plVar1 = *plVar1 + (ulong)local_b0._4_4_;
  puVar7 = (uint *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                   ::operator[]((HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
  ...
  *puVar7 = uVar5;
  ...
  RID_Alloc<GLES3::Texture,true>::initialize_rid
            ((RID_Alloc<GLES3::Texture,true> *)(param_1 + 0xd8),param_2,&local_118);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::texture_2d_initialize(RID, Ref<Image> const&) */

void __thiscall
GLES3::TextureStorage::texture_2d_initialize(TextureStorage *this,undefined8 param_2,long *param_3)

{
  ...
  if (*param_3 == 0) {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error("texture_2d_initialize","drivers/gles3/storage/texture_storage.cpp",0x31e,
    ...
    local_140 = 0;
    _get_gl_image_and_format
              (&local_138,this,(StrRange *)&local_140,uStack_dc,&local_d8,(long)&uStack_cc + 4,
               &local_c4,(long)&local_c4 + 4,&local_b8,0);
    ...
    local_bc = Image::get_image_data_size
                         (local_f8 & 0xffffffff,local_f8._4_4_,uStack_dc,uStack_f0._4_4_ != 0);
    local_b6 = 1;
    (*_glad_glGenTextures)(1,&local_b4);
    lVar3 = Utilities::singleton;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::texture_free(RID) */

void __thiscall GLES3::TextureStorage::texture_free(TextureStorage *this,ulong param_2)
          ...
          if (*(char *)(lVar20 + 8) == '\0') {
            ...
            if ((uVar14 != 0) && (*(char *)(lVar20 + 9) == '\0')) {
              this_00 = (HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                         *)(Utilities::singleton + 200);
              local_4c = uVar14;
              cVar12 = HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                       ::_lookup_pos(this_00,(uint *)(ulong)uVar14,(uint *)&local_48);
              if (cVar12 == '\0') {
                ...
                puVar16 = (uint *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                                  ::operator[](this_00,&local_4c);
                *(long *)(lVar28 + 0x108) = *(long *)(lVar28 + 0x108) - (ulong)*puVar16;
                HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                ::erase(this_00,&local_4c);
              }
            ...
            if ((uint)uVar15 < *(uint *)(this + 0xf4)) {
              lVar28 = ((uVar15 & 0xffffffff) % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
                       *(long *)(*(long *)(this + 0xe0) +
                                ((uVar15 & 0xffffffff) / (ulong)*(uint *)(this + 0xf0)) * 8);
                    ...
                    if (param_2 == *(ulong *)(lVar18 + lVar27 * 8)) {
                      if (lVar27 < lVar29) {
                        ...
                        if (lVar18 == 0) {
                          ...
                          if (lVar27 < lVar29) {
                            memmove((void *)(lVar18 + lVar27 * 8),(void *)(lVar18 + 8 + lVar27 * 8),
                                    (lVar29 - lVar27) * 8);
                          }
                        }
                        ...
                        _err_print_index_error
                                  ("remove_at","./core/templates/cowdata.h",0xe4,lVar27,lVar29,
                                   "p_index","size()","",false,false);
                      }
                      break;
                    }
          ...
          if ((*(long *)(this + 0x138) != 0) && (*(int *)(this + 0x15c) != 0)) {
            ...
            if (uVar14 != 0) {
              ...
              while ((uVar14 != (uint)uVar26 ||
                     (param_2 != *(ulong *)(*(long *)(*(long *)(this + 0x138) + lVar18 * 8) + 0x10))
                     )) {
                uVar25 = uVar25 + 1;
                auVar5._8_8_ = 0;
                ...
                if ((uVar14 == 0) ||
                   (auVar6._8_8_ = 0, auVar6._0_8_ = (ulong)uVar14 * lVar28, auVar10._8_8_ = 0,
                   auVar10._0_8_ = uVar24, auVar7._8_8_ = 0,
                   auVar7._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                                    (ulong)*(uint *)(this + 0x158) * 4) + iVar13) -
                                         SUB164(auVar6 * auVar10,8)) * lVar28, auVar11._8_8_ = 0,
                   auVar11._0_8_ = uVar24, SUB164(auVar7 * auVar11,8) < uVar25)) goto LAB_001113de;
              }
              HashMap<RID,GLES3::TextureStorage::TextureAtlas::Texture,HashMapHasherDefault,HashMapComparatorDefault<RID>,DefaultTypedAllocator<HashMapElement<RID,GLES3::TextureStorage::TextureAtlas::Texture>>>
              ::erase((HashMap<RID,GLES3::TextureStorage::TextureAtlas::Texture,HashMapHasherDefault,HashMapComparatorDefault<RID>,DefaultTypedAllocator<HashMapElement<RID,GLES3::TextureStorage::TextureAtlas::Texture>>>
                       *)(this + 0x130),(RID *)&local_48);
            }
          }
LAB_001113de:
...
joined_r0x001113ed:
          if (lVar28 != 0) {
            do {
              ...
              lVar18 = lVar18 + 1;
              _err_print_error("texture_free","drivers/gles3/storage/texture_storage.cpp",0x315,
          ...
          if (uVar21 < *(uint *)(this + 0xf4)) {
            ...
            if (*(int *)(lVar28 + 0xe8) < 0) {
              ...
              *(undefined4 *)(*(long *)(*(long *)(this + 0xe0) + uVar15 * 8) + 0xe8 + lVar20) =
                   0xffffffff;
              uVar14 = *(int *)(this + 0xf8) - 1;
              *(uint *)(this + 0xf8) = uVar14;
              *(uint *)(*(long *)(lVar28 + ((ulong)uVar14 / (ulong)*(uint *)(this + 0xf0)) * 8) +
                       ((ulong)uVar14 % (ulong)*(uint *)(this + 0xf0)) * 4) = uVar21;
              if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
                pthread_mutex_unlock(__mutex);
                return;
              }
...
LAB_00111806:
  pcVar22 = "drivers/gles3/storage/texture_storage.cpp";
  pcVar23 = "texture_free";
LAB_00111814:
  _err_print_error(pcVar23,pcVar22,uVar19,pcVar17,0,0);
  return;
code_r0x0011143c:
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::~TextureStorage() */

void __thiscall GLES3::TextureStorage::~TextureStorage(TextureStorage *this)
  ...
  if (uVar2 != 0) {
    ...
    if ((*(long *)(Utilities::singleton + 0xd0) != 0) &&
      ...
      if (uVar14 != 0) {
        ...
        do {
          if ((uVar14 == uVar23) &&
             (uVar2 == *(uint *)(*(long *)(*(long *)(Utilities::singleton + 0xd0) + lVar18 * 8) +
                                0x10))) {
          ...
          iVar19 = SUB164(auVar5 * auVar9,8);
                ...
                auVar7._0_8_ = ((*(uint *)(hash_table_size_primes +
                                          (ulong)*(uint *)(Utilities::singleton + 0xf0) * 4) +
                                iVar19) - SUB164(auVar6 * auVar10,8)) * uVar3, auVar11._8_8_ = 0,
                auVar11._0_8_ = uVar21, uVar22 <= SUB164(auVar7 * auVar11,8)));
      }
    }
    _err_print_error("texture_free_data","drivers/gles3/storage/../storage/utilities.h",0x90,
                     "Condition \"!texture_allocs_cache.has(p_id)\" is true.",0,0);
...
LAB_00111aa6:
  ...
  *(undefined4 *)(this + 0x168) = 0;
  ...
  CowData<Ref<Image>>::_unref((CowData<Ref<Image>> *)(this + 0x338));
  CowData<Ref<Image>>::_unref((CowData<Ref<Image>> *)(this + 0x328));
  CowData<Ref<Image>>::_unref((CowData<Ref<Image>> *)(this + 0x318));
  if ((*(long *)(this + 0x308) != 0) && (cVar13 = RefCounted::unreference(), cVar13 != '\0')) {
    memdelete<Image>(*(Image **)(this + 0x308));
  }
  *(undefined ***)(this + 0x1d0) = &PTR__init_00122b88;
  ShaderGLES3::~ShaderGLES3((ShaderGLES3 *)(this + 0x1d0));
  RID_Alloc<GLES3::RenderTarget,false>::~RID_Alloc
            ((RID_Alloc<GLES3::RenderTarget,false> *)(this + 0x178));
...
LAB_00111bd7:
  RID_Alloc<GLES3::Texture,true>::~RID_Alloc((RID_Alloc<GLES3::Texture,true> *)(this + 0xd8));
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::texture_replace(RID, RID) */

void __thiscall
GLES3::TextureStorage::texture_replace(TextureStorage *this,ulong param_2,ulong param_3)
              ...
              if (uVar25 != 0) {
                ...
                if ((*(long *)(Utilities::singleton + 0xd0) != 0) &&
                  ...
                  if (uVar26 != 0) {
                    ...
                    do {
                      if ((local_68 == uVar26) &&
                         (uVar25 == *(uint *)(*(long *)(*(long *)(Utilities::singleton + 0xd0) +
                                                       lVar38 * 8) + 0x10))) {
                        (*_glad_glDeleteTextures)(1,local_58);
                        puVar29 = (uint *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                      ...
                      iVar24 = SUB164(auVar10 * auVar18,8);
                            ...
                            (auVar11._8_8_ = 0, auVar11._0_8_ = uVar26 * uVar28, auVar19._8_8_ = 0,
                            auVar19._0_8_ = uVar39, auVar12._8_8_ = 0,
                            auVar12._0_8_ =
                                 ((*(uint *)(hash_table_size_primes +
                                            (ulong)*(uint *)(Utilities::singleton + 0xf0) * 4) +
                                  iVar24) - SUB164(auVar11 * auVar19,8)) * uVar28, auVar20._8_8_ = 0
                            , auVar20._0_8_ = uVar39, uVar35 <= SUB164(auVar12 * auVar20,8)));
                  }
                }
                _err_print_error("texture_free_data","drivers/gles3/storage/../storage/utilities.h",
                                 0x90,"Condition \"!texture_allocs_cache.has(p_id)\" is true.",0,0);
LAB_001127d3:
                *(undefined4 *)((long)puVar36 + 0x74) = 0;
              }
              local_50[0] = 0;
...
LAB_00112150:
              ...
              *(undefined2 *)(puVar36 + 0xf) = *(undefined2 *)(puVar40 + 0xf);
              ...
              if (pIVar4 != pIVar3) {
                puVar36[0x11] = pIVar4;
                if ((pIVar4 != (Image *)0x0) && (cVar23 = RefCounted::reference(), cVar23 == '\0'))
                {
                  puVar36[0x11] = 0;
                }
                if ((pIVar3 != (Image *)0x0) && (cVar23 = RefCounted::unreference(), cVar23 != '\0')
                   ) {
                  memdelete<Image>(pIVar3);
                }
              }
              if (puVar36[0x13] != puVar40[0x13]) {
                CowData<Ref<Image>>::_ref
                          ((CowData<Ref<Image>> *)(puVar36 + 0x13),(CowData *)(puVar40 + 0x13));
              }
              lVar38 = local_50[0];
              *(undefined1 *)(puVar36 + 0x14) = *(undefined1 *)(puVar40 + 0x14);
              puVar36[0x15] = puVar40[0x15];
              puVar36[0x16] = puVar40[0x16];
              puVar36[0x17] = puVar40[0x17];
              puVar36[0x18] = puVar40[0x18];
              puVar36[0x19] = puVar40[0x19];
              ...
              if (uVar41 < *(uint *)(this + 0xf4)) {
                ...
                if (*(int *)(lVar37 + 0xe8) < 0) {
                  pthread_mutex_unlock(__mutex);
                  _err_print_error(&_LC65,"./core/templates/rid_owner.h",0x16c,
                  ...
                  if ((*(long *)(lVar37 + 0x88) != 0) &&
                     (cVar23 = RefCounted::unreference(), cVar23 != '\0')) {
                  ...
                  *(undefined4 *)(*(long *)(*(long *)(this + 0xe0) + uVar28 * 8) + 0xe8 + lVar38) =
                       0xffffffff;
                  uVar25 = *(int *)(this + 0xf8) - 1;
                  *(uint *)(this + 0xf8) = uVar25;
                  *(uint *)(*(long *)(lVar37 + ((ulong)uVar25 / (ulong)*(uint *)(this + 0xf0)) * 8)
                           + ((ulong)uVar25 % (ulong)*(uint *)(this + 0xf0)) * 4) = uVar41;
                  pthread_mutex_unlock(__mutex);
                }
                else {
                  pthread_mutex_unlock(__mutex);
                  _err_print_error(&_LC65,"./core/templates/rid_owner.h",0x171,
                                   "Method/function failed.",0,0);
                }
              }
              else {
                pthread_mutex_unlock(__mutex);
                _err_print_error(&_LC65,"./core/templates/rid_owner.h",0x161,
                                 "Method/function failed.",0,0);
              }
              if ((*(long *)(this + 0x138) != 0) && (*(int *)(this + 0x15c) != 0)) {
                uVar32 = CONCAT44(0,*(uint *)(hash_table_size_primes +
                                             (ulong)*(uint *)(this + 0x158) * 4));
                ...
                if (uVar41 != 0) {
                  uVar25 = 0;
                  while ((uVar41 != (uint)uVar39 ||
                         (param_2 !=
                          *(ulong *)(*(long *)(*(long *)(this + 0x138) + lVar37 * 8) + 0x10)))) {
                    uVar25 = uVar25 + 1;
                    auVar6._8_8_ = 0;
                    ...
                    if ((uVar41 == 0) ||
                       (auVar7._8_8_ = 0, auVar7._0_8_ = (ulong)uVar41 * lVar38, auVar15._8_8_ = 0,
                       auVar15._0_8_ = uVar32, auVar8._8_8_ = 0,
                       auVar8._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                                        (ulong)*(uint *)(this + 0x158) * 4) + iVar31
                                              ) - SUB164(auVar7 * auVar15,8)) * lVar38,
                       auVar16._8_8_ = 0, auVar16._0_8_ = uVar32,
                       SUB164(auVar8 * auVar16,8) < uVar25)) goto LAB_001125bb;
                  }
                  this[0x160] = (TextureStorage)0x1;
                }
              }
...
LAB_001128be:
    _err_print_error("texture_replace","drivers/gles3/storage/texture_storage.cpp",uVar33,pcVar30,0,
                     0);
    return;
  }
LAB_00112ab9:
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::texture_2d_layer_get(RID, int) const */

undefined8 *
GLES3::TextureStorage::texture_2d_layer_get
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((param_3 != 0) && ((uint)param_3 < *(uint *)(param_2 + 0xf4))) {
    lVar7 = ((param_3 & 0xffffffff) % (ulong)*(uint *)(param_2 + 0xf0)) * 0xf0 +
            *(long *)(*(long *)(param_2 + 0xe0) +
                     ((param_3 & 0xffffffff) / (ulong)*(uint *)(param_2 + 0xf0)) * 8);
    if (*(int *)(lVar7 + 0xe8) == (int)(param_3 >> 0x20)) {
      local_80 = 0;
      lVar4 = Image::get_image_data_size
                        (*(undefined4 *)(lVar7 + 0x44),*(undefined4 *)(lVar7 + 0x48),5,0);
      ...
      (*_glad_glTexImage2D)
                (0xde1,0,0x1908,*(undefined4 *)(lVar7 + 0x44),*(undefined4 *)(lVar7 + 0x48),0,0x1908
                 ,0x1401,0);
      (*_glad_glTexParameteri)(0xde1,0x2801,0x2601);
      (*_glad_glTexParameteri)(0xde1,0x2800,0x2601);
      ...
      (*_glad_glReadPixels)
                (0,0,*(undefined4 *)(lVar7 + 0x44),*(undefined4 *)(lVar7 + 0x48),0x1908,0x1401,lVar6
                );
      (*_glad_glBindFramebuffer)(0x8d40,system_fbo);
      ...
      if (local_80 == 0) {
        _err_print_error("texture_2d_layer_get","drivers/gles3/storage/texture_storage.cpp",0x4e7,
                         "Condition \"data.is_empty()\" is true. Returning: Ref<Image>()",0,0);
        *param_1 = 0;
      }
      else {
        Image::create_from_data
                  (&local_a8,*(undefined4 *)(lVar7 + 0x30),*(undefined4 *)(lVar7 + 0x34),0,5,
                   local_88);
...
LAB_0011307f:
          ...
          _err_print_error("texture_2d_layer_get","drivers/gles3/storage/texture_storage.cpp",0x4eb,
                           "Method/function failed. Returning: Ref<Image>()",&local_78,0,0);
          pcVar2 = local_78;
...
LAB_0011315a:
  ...
  _err_print_error("texture_2d_layer_get","drivers/gles3/storage/texture_storage.cpp",0x4b8,
                   "Parameter \"texture\" is null.",0,0);
  *param_1 = 0;
LAB_00113185:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::texture_2d_get(RID) const */

long * GLES3::TextureStorage::texture_2d_get(long *param_1,long param_2,ulong param_3)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((param_3 != 0) && ((uint)param_3 < *(uint *)(param_2 + 0xf4))) {
    lVar11 = ((param_3 & 0xffffffff) % (ulong)*(uint *)(param_2 + 0xf0)) * 0xf0 +
             *(long *)(*(long *)(param_2 + 0xe0) +
                      ((param_3 & 0xffffffff) / (ulong)*(uint *)(param_2 + 0xf0)) * 8);
...
LAB_001134b6:
        ...
        (*_glad_glTexImage2D)
                  (0xde1,0,0x1908,*(undefined4 *)(lVar11 + 0x44),*(undefined4 *)(lVar11 + 0x48),0,
                   0x1908,0x1401,0);
        (*_glad_glTexParameteri)(0xde1,0x2801,0x2601);
        (*_glad_glTexParameteri)(0xde1,0x2800,0x2601);
        ...
        (*_glad_glReadPixels)
                  (0,0,*(undefined4 *)(lVar11 + 0x44),*(undefined4 *)(lVar11 + 0x48),0x1908,0x1401,
                   lVar6);
        (*_glad_glBindFramebuffer)(0x8d40,system_fbo);
        ...
        if (local_80 == 0) {
          _err_print_error("texture_2d_get","drivers/gles3/storage/texture_storage.cpp",0x49c,
                           "Condition \"data.is_empty()\" is true. Returning: Ref<Image>()",0,0);
          *param_1 = 0;
        }
        else {
          Image::create_from_data
                    ((CowData<char32_t> *)&local_78,*(undefined4 *)(lVar11 + 0x44),
                     *(undefined4 *)(lVar11 + 0x48),0,5,local_88);
          pIVar10 = local_78;
          if (pIVar9 == local_78) {
LAB_00113757:
            pIVar9 = pIVar10;
            if ((local_78 != (Image *)0x0) && (cVar2 = RefCounted::unreference(), cVar2 != '\0')) {
...
LAB_00113742:
          ...
          if (cVar2 == '\0') {
            if ((*(int *)(lVar11 + 0x4c) != 5) &&
               (cVar2 = Image::is_format_compressed(), cVar2 == '\0')) {
          ...
          local_70 = 0x17;
          String::parse_latin1((StrRange *)&local_98);
          vformat<String>((CowData<char32_t> *)&local_78,(StrRange *)&local_98,
                          (CowData<char32_t> *)&local_90);
          _err_print_error("texture_2d_get","drivers/gles3/storage/texture_storage.cpp",0x4a0,
                           "Method/function failed. Returning: Ref<Image>()",
...
LAB_00113879:
        ...
        local_80 = 0;
        lVar3 = Image::get_image_data_size
                          (uVar13,uVar12,*(undefined4 *)(lVar11 + 0x50),1 < *(int *)(lVar11 + 0x3c))
        ;
        CowData<unsigned_char>::resize<false>((CowData<unsigned_char> *)&local_80,lVar3 * 2);
        CowData<unsigned_char>::_copy_on_write((CowData<unsigned_char> *)&local_80);
        lVar6 = local_80;
        ...
        if (0 < *(int *)(lVar11 + 0x3c)) {
          do {
            while (lVar5 = Image::get_image_mipmap_offset
                                     (*(undefined4 *)(lVar11 + 0x44),*(undefined4 *)(lVar11 + 0x48),
                                      *(undefined4 *)(lVar11 + 0x50),iVar7),
                  *(char *)(lVar11 + 0x70) == '\0') {
              (*_glad_glPixelStorei)(0xd05,1);
              iVar8 = iVar7 + 1;
              (*_glad_glGetTexImage)
                        (*(undefined4 *)(lVar11 + 0x5c),iVar7,*(undefined4 *)(lVar11 + 0x60),
                         *(undefined4 *)(lVar11 + 0x68),lVar6 + lVar5);
              iVar7 = iVar8;
...
LAB_001139d7:
        CowData<unsigned_char>::resize<false>((CowData<unsigned_char> *)&local_80,lVar3);
        if (local_80 == 0) {
          _err_print_error("texture_2d_get","drivers/gles3/storage/texture_storage.cpp",0x460,
                           "Condition \"data.is_empty()\" is true. Returning: Ref<Image>()",0,0);
          *param_1 = 0;
          pIVar9 = (Image *)0x0;
        ...
        Image::create_from_data
                  ((CowData<char32_t> *)&local_78,*(undefined4 *)(lVar11 + 0x44),
                   *(undefined4 *)(lVar11 + 0x48),1 < *(int *)(lVar11 + 0x3c),
                   *(undefined4 *)(lVar11 + 0x50),local_88);
        pIVar9 = local_78;
        if (local_78 != (Image *)0x0) {
          cVar2 = RefCounted::reference();
          if (cVar2 == '\0') {
        ...
        if (cVar2 != '\0') {
          ...
          vformat<String>((CowData<char32_t> *)&local_78,(StrRange *)&local_98,
                          (CowData<char32_t> *)&local_90);
          _err_print_error("texture_2d_get","drivers/gles3/storage/texture_storage.cpp",0x464,
                           "Method/function failed. Returning: Ref<Image>()",
                           (CowData<char32_t> *)&local_78,0,0);
          CowData<char32_t>::_unref((CowData<char32_t> *)&local_78);
          CowData<char32_t>::_unref((CowData<char32_t> *)&local_98);
        ...
        if ((*(int *)(lVar11 + 0x4c) != *(int *)(lVar11 + 0x50)) &&
           (cVar2 = Image::is_format_compressed(), cVar2 == '\0')) {
...
LAB_00113bd4:
  ...
  _err_print_error("texture_2d_get","drivers/gles3/storage/texture_storage.cpp",0x438,
                   "Parameter \"texture\" is null.",0,0);
  *param_1 = 0;
LAB_001138b8:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
...
/* WARNING: Removing unreachable block (ram,0x00114948) */
/* WARNING: Removing unreachable block (ram,0x00114989) */
/* WARNING: Removing unreachable block (ram,0x0011499c) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::_texture_set_3d_data(RID, Vector<Ref<Image> > const&, bool) */

void __thiscall
GLES3::TextureStorage::_texture_set_3d_data
          (TextureStorage *this,ulong param_2,long param_3,byte param_4)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0xf4))) {
    lVar15 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
             *(long *)(*(long *)(this + 0xe0) +
                      ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0xf0)) * 8);
      ...
      if (*(long *)(param_3 + 8) != 0) {
        ...
        if (*(int *)(lVar15 + 0x3c) < 2) {
          ...
          *(undefined4 *)(lVar15 + 0xe0) = 3;
          (*_glad_glTexParameteri)
                    (*(undefined4 *)(lVar15 + 0x5c),0x2801,(-(uint)(*pcVar11 == '\0') & 2) + 0x2700)
          ;
          (*_glad_glTexParameteri)(*(undefined4 *)(lVar15 + 0x5c),0x2800,0x2600);
          (*_glad_glTexParameteri)(*(undefined4 *)(lVar15 + 0x5c),0x813c,0);
          uVar12 = 1000;
          uVar8 = *(undefined4 *)(lVar15 + 0x5c);
LAB_001140de:
          (*_glad_glTexParameteri)(uVar8,0x813d,uVar12);
          if (pcVar11[0x7b] != '\0') {
        ...
        if (lVar19 != 0) {
          ...
          do {
            ...
            if ((pIVar13 != (Image *)0x0) && (cVar6 = RefCounted::reference(), cVar6 == '\0')) {
              pIVar13 = (Image *)0x0;
            }
            iVar7 = Image::get_format();
...
LAB_0011430c:
                ...
                if (pIVar13 != pIVar10) {
                  if ((pIVar10 != (Image *)0x0) && (cVar6 = RefCounted::reference(), cVar6 == '\0'))
                  goto LAB_00114309;
                  goto LAB_0011430c;
                }
LAB_0011432d:
...
LAB_00114383:
              _err_print_index_error
                        ("operator[]","./core/templates/vector.h",0x38,lVar18,lVar19,"p_index",
            ...
            if (pIVar13 != pIVar10) {
              *puVar14 = pIVar13;
              ...
              if ((pIVar10 != (Image *)0x0) && (cVar6 = RefCounted::unreference(), cVar6 != '\0')) {
        ...
        if (lVar17 != 0) {
          ...
          do {
            ...
            if (bVar16 != 0) {
              (*_glad_glTexImage3D)
                        (0x806f,iVar2,local_88,local_48,uStack_44,iVar7,0,local_8c,local_90,0);
            }
          ...
          *(int *)(lVar15 + 0x3c) = iVar2 + 1;
          ...
          if (((*(char *)(lVar19 + 0xc0) != '\0') && (*(char *)(lVar15 + 10) == '\0')) &&
             (*(long *)(lVar15 + 0x98) != lVar17)) {
            CowData<Ref<Image>>::_ref((CowData<Ref<Image>> *)(lVar15 + 0x98),(CowData *)&local_70);
          }
          CowData<Ref<Image>>::_unref((CowData<Ref<Image>> *)&local_70);
          if ((local_80[0] != (Image *)0x0) && (cVar6 = RefCounted::unreference(), cVar6 != '\0')) {
...
LAB_00114663:
      _err_print_index_error
                ("get","./core/templates/cowdata.h",0xdb,0,lVar19,"p_index","size()","",false,true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
      pcVar4 = (code *)invalidInstructionException();
      (*pcVar4)();
...
LAB_00114819:
    _err_print_error("_texture_set_3d_data","drivers/gles3/storage/texture_storage.cpp",uVar12,
                     pcVar11,0,0);
    return;
  }
LAB_001149ef:
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::texture_3d_initialize(RID, Image::Format, int, int, int, bool,
   Vector<Ref<Image> > const&) */

void __thiscall
GLES3::TextureStorage::texture_3d_initialize
...

{
  ...
  if (*(long *)(param_8 + 8) == 0) {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error("texture_3d_initialize","drivers/gles3/storage/texture_storage.cpp",0x391,
  ...
  if (iVar7 != 0) {
    ...
    _err_print_error("texture_3d_initialize","drivers/gles3/storage/texture_storage.cpp",0x394,
                     "Condition \"verr != Image::VALIDATE_3D_OK\" is true.",
                     (CowData<char32_t> *)&local_138,0,0);
...
LAB_00114ade:
    ...
    local_150 = 0;
    _get_gl_image_and_format
              (&local_148,this,(StrRange *)&local_150,uVar8,(long)&local_ec + 4,(long)&uStack_dc + 4
               ,&local_d4,(long)&local_d4 + 4,&local_c8,0);
    if ((local_148 != (Image *)0x0) && (cVar6 = RefCounted::unreference(), cVar6 != '\0')) {
      memdelete<Image>(local_148);
    }
    if (*(long *)(param_8 + 8) != 0) {
      lVar11 = *(long *)(*(long *)(param_8 + 8) + -8);
      if (lVar11 < 1) goto LAB_00114f8b;
      iVar7 = Image::get_image_data_size
                        (local_108 & 0xffffffff,local_108._4_4_,local_ec & 0xffffffff,
                         uStack_100._4_4_ != 0);
      ...
      *plVar9 = *plVar9 + (ulong)local_cc;
      puVar10 = (uint *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                        ::operator[]((HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                                      *)(lVar11 + 200),(uint *)&local_148);
      lVar11 = local_150;
      *puVar10 = uVar5;
      if (local_150 != 0) {
        LOCK();
      ...
      RID_Alloc<GLES3::Texture,true>::initialize_rid
                ((RID_Alloc<GLES3::Texture,true> *)(this + 0xd8),param_2,&local_138);
      _texture_set_3d_data(this,param_2,param_8,1);
      CowData<Ref<Image>>::_unref((CowData<Ref<Image>> *)&local_a0);
      if ((local_b8._8_8_ != 0) && (cVar6 = RefCounted::unreference(), cVar6 != '\0')) {
...
LAB_00114b87:
  _err_print_index_error
            ("get","./core/templates/cowdata.h",0xdb,lVar12,lVar11,"p_index","size()","",false,true)
  ;
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar2 = (code *)invalidInstructionException();
...
/* GLES3::TextureStorage::texture_3d_update(RID, Vector<Ref<Image> > const&) */

void __thiscall
GLES3::TextureStorage::texture_3d_update(TextureStorage *this,ulong param_2,undefined8 param_3)

{
  ...
  *this_00;
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0xf4))) {
    lVar19 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
             *(long *)(*(long *)(this + 0xe0) +
                      ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0xf0)) * 8);
    if (*(int *)(lVar19 + 0xe8) == (int)(param_2 >> 0x20)) {
      if (*(int *)(lVar19 + 0x54) == 2) {
        iVar12 = Image::validate_3d_image
                           (*(undefined4 *)(lVar19 + 0x4c),*(undefined4 *)(lVar19 + 0x30),
                            *(undefined4 *)(lVar19 + 0x34),*(undefined4 *)(lVar19 + 0x38),
                            1 < *(int *)(lVar19 + 0x3c),param_3);
        if (iVar12 == 0) {
          ...
          if ((*(long *)(Utilities::singleton + 0xd0) != 0) &&
            ...
            uVar22 = CONCAT44(0,*(uint *)(hash_table_size_primes +
                                         (ulong)*(uint *)(Utilities::singleton + 0xf0) * 4));
            auVar3._8_8_ = 0;
            auVar3._0_8_ = uVar22;
            auVar7._8_8_ = 0;
            ...
            if (uVar13 != 0) {
              do {
                if ((uVar23 == uVar13) &&
                   (local_48[0] ==
                    *(uint *)(*(long *)(*(long *)(Utilities::singleton + 0xd0) + lVar19 * 8) + 0x10)
                   )) {
                  puVar14 = (uint *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                ...
                iVar12 = SUB164(auVar4 * auVar8,8);
                      ...
                      auVar6._0_8_ = ((*(uint *)(hash_table_size_primes +
                                                (ulong)*(uint *)(Utilities::singleton + 0xf0) * 4) +
                                      iVar12) - SUB164(auVar5 * auVar9,8)) * uVar2,
                      auVar10._8_8_ = 0, auVar10._0_8_ = uVar22,
          ...
          _err_print_error("texture_3d_update","drivers/gles3/storage/texture_storage.cpp",0x3f6,
                           "Condition \"verr != Image::VALIDATE_3D_OK\" is true.",
                           (CowData<char32_t> *)local_48,0);
...
LAB_0011543d:
  ...
  pcVar21 = "texture_3d_update";
LAB_00115304:
  _err_print_error(pcVar21,pcVar20,uVar17,pcVar15,0,0);
  return;
}
...

{
  ...
  *(undefined8 *)(this + 0x78) = 0;
  ...
  for (uVar14 = (ulong)(((int)this - (int)(undefined8 *)((ulong)(this + 0x20) & 0xfffffffffffffff8))
                        + 0x80U >> 3); uVar14 != 0; uVar14 = uVar14 - 1) {
    *puVar18 = 0;
    puVar18 = puVar18 + 1;
  }
...
LAB_00115951:
  ...
  *(undefined8 *)(this + 0x50) = uVar11;
  ...
  if ((local_1b0 != (Color *)0x0) && (cVar9 = RefCounted::unreference(), cVar9 != '\0')) {
...
LAB_00115a7a:
  ...
  *(undefined8 *)(this + 0x58) = uVar11;
  ...
  texture_3d_initialize
            (this,*(undefined8 *)(this + 0x58),uVar10,4,4,4,0,(Vector<Ref<Image>> *)&local_198);
  CowData<Ref<Image>>::_unref((CowData<Ref<Image>> *)&local_190);
  if ((local_1b0 != (Color *)0x0) && (cVar9 = RefCounted::unreference(), cVar9 != '\0')) {
    memdelete<Image>((Image *)local_1b0);
  }
...
LAB_00115c9a:
  ...
  *(undefined8 *)(this + 0x60) = uVar11;
  uVar10 = Image::get_format();
  texture_3d_initialize
            (this,*(undefined8 *)(this + 0x60),uVar10,4,4,4,0,(Vector<Ref<Image>> *)&local_198);
  CowData<Ref<Image>>::_unref((CowData<Ref<Image>> *)&local_190);
  if ((local_1b0 != (Color *)0x0) && (cVar9 = RefCounted::unreference(), cVar9 != '\0')) {
    memdelete<Image>((Image *)local_1b0);
  }
  ...
  *(undefined8 *)(this + 0x28) = uVar11;
  ...
  if ((local_198 != (Image *)0x0) && (cVar9 = RefCounted::unreference(), cVar9 != '\0')) {
  ...
  *(undefined8 *)(this + 0x70) = uVar11;
  ...
  RID_Alloc<GLES3::Texture,true>::initialize_rid
            (this_00,*(undefined8 *)(this + 0x70),(Vector<Ref<Image>> *)&local_198);
  ...
  *puVar12 = 0x40;
  ...
  if ((local_118._8_8_ != 0) && (cVar9 = RefCounted::unreference(), cVar9 != '\0')) {
  ...
  *(undefined8 *)(this + 0x40) = uVar11;
  ...
  (*_glad_glGenTextures)(1,&local_124);
  RID_Alloc<GLES3::Texture,true>::initialize_rid
            (this_00,*(undefined8 *)(this + 0x40),(Vector<Ref<Image>> *)&local_198);
  (*_glad_glBindTexture)(0xde1,local_124);
...
LAB_00116628:
  if ((pIVar22 != (Image *)0x0) && (cVar9 = RefCounted::unreference(), cVar9 != '\0')) {
    memdelete<Image>(local_198);
  }
  pIVar19 = *(Image **)(this + 0x308);
LAB_00116644:
  ...
  if ((pIVar19 == (Image *)0x0) ||
     (local_198 = pIVar19, cVar9 = RefCounted::reference(), cVar9 == '\0')) {
    local_198 = (Image *)0x0;
    Vector<Ref<Image>>::push_back
              ((Vector<Ref<Image>> *)(this + 0x310),(Vector<Ref<Image>> *)&local_198);
  }
  else {
    Vector<Ref<Image>>::push_back
              ((Vector<Ref<Image>> *)(this + 0x310),(Vector<Ref<Image>> *)&local_198);
  ...
  do {
    ...
    if ((pIVar19 == (Image *)0x0) ||
      ...
      local_198 = (Image *)0x0;
      Vector<Ref<Image>>::push_back
                ((Vector<Ref<Image>> *)(this + 800),(Vector<Ref<Image>> *)&local_198);
    }
    else {
      Vector<Ref<Image>>::push_back
                ((Vector<Ref<Image>> *)(this + 800),(Vector<Ref<Image>> *)&local_198);
  ...
  *(undefined8 *)(this_01 + 600) = 0;
  ...
  if (((*(long *)(this + 0x308) != 0) &&
      (pOVar13 = (Object *)
                 __dynamic_cast(*(long *)(this + 0x308),&Object::typeinfo,&Resource::typeinfo,0),
      pOVar13 != (Object *)0x0)) &&
     (local_198 = (Image *)pOVar13, cVar9 = RefCounted::reference(), cVar9 == '\0')) {
    local_198 = (Image *)0x0;
  }
  (*pcVar2)(pIVar19);
  if (((local_198 != (Image *)0x0) &&
      (cVar9 = RefCounted::unreference(), pIVar22 = local_198, cVar9 != '\0')) &&
     (cVar9 = predelete_handler((Object *)local_198), cVar9 != '\0')) {
    (**(code **)(*(long *)pIVar22 + 0x140))(pIVar22);
    Memory::free_static(pIVar22,false);
  }
  Image::rotate_90(pIVar19,0);
  uVar21 = 0;
LAB_001168e7:
  pIVar22 = *(Image **)(this + 0x308);
  uVar16 = uVar21;
  if (*(Image **)(this + 0x308) == (Image *)0x0) goto LAB_00116907;
  do {
    local_198 = pIVar22;
    cVar9 = RefCounted::reference();
    if (cVar9 == '\0') goto LAB_00116907;
    Vector<Ref<Image>>::push_back
              ((Vector<Ref<Image>> *)(this + 0x330),(Vector<Ref<Image>> *)&local_198);
    cVar9 = RefCounted::unreference();
    if (cVar9 != '\0') {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::_texture_3d_read_framebuffer(GLES3::Texture*) const */

Texture * GLES3::TextureStorage::_texture_3d_read_framebuffer(Texture *param_1)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (in_RDX == 0) {
    _err_print_error("_texture_3d_read_framebuffer","drivers/gles3/storage/texture_storage.cpp",
                     0x4fa,"Parameter \"p_texture\" is null.",0,0);
    *(undefined8 *)(param_1 + 8) = 0;
  }
  else {
        ...
        if (0 < iVar9) {
          ...
          do {
            ...
            GLES3::CopyEffects::copy_to_rect_3d
                      (pRVar7,(float)iVar8 / (float)iVar9,(int)&local_58,(float)iVar10);
            ...
            if (local_70 == 0) {
              _err_print_error("_texture_3d_read_framebuffer",
                               "drivers/gles3/storage/texture_storage.cpp",0x512,
                               "Condition \"data.is_empty()\" is true. Returning: Vector<Ref<Image>>()"
                               ,0,0);
              *(undefined8 *)(param_1 + 8) = 0;
              goto LAB_0011709a;
            }
            ...
            if (cVar5 != '\0') {
              _err_print_error("_texture_3d_read_framebuffer",
                               "drivers/gles3/storage/texture_storage.cpp",0x515,
                               "Condition \"img->is_empty()\" is true. Returning: Vector<Ref<Image>>()"
                               ,0,0);
              *(undefined8 *)(param_1 + 8) = 0;
              if ((local_98 != (Image *)0x0) && (cVar5 = RefCounted::unreference(), cVar5 != '\0'))
              {
                memdelete<Image>(local_98);
              }
              goto LAB_0011709a;
            }
            if ((*(int *)(in_RDX + 0x4c) != 5) &&
               (cVar5 = Image::is_format_compressed(), cVar5 == '\0')) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::texture_3d_get(RID) const */

long GLES3::TextureStorage::texture_3d_get(long param_1,long param_2,ulong param_3)

{
    ...
    if (*(int *)(lVar2 + 0xe8) == (int)(param_3 >> 0x20)) {
      if (*(int *)(lVar2 + 0x54) == 2) {
        if ((*(long *)(lVar2 + 0x98) == 0) || (*(char *)(lVar2 + 10) != '\0')) {
          ...
          (*_glad_glTexImage2D)
                    (0xde1,0,0x1908,*(undefined4 *)(lVar2 + 0x44),*(undefined4 *)(lVar2 + 0x48),0,
                     0x1908,0x1401,0);
          (*_glad_glTexParameteri)(0xde1,0x2801,0x2601);
          (*_glad_glTexParameteri)(0xde1,0x2800,0x2601);
          ...
          if ((*(char *)(lVar1 + 0xc0) != '\0') &&
             ((*(char *)(lVar2 + 10) == '\0' && (local_40[0] != *(long *)(lVar2 + 0x98))))) {
          ...
          *(undefined8 *)(param_1 + 8) = 0;
          if (*(long *)(lVar2 + 0x98) != 0) {
            CowData<Ref<Image>>::_ref
                      ((CowData<Ref<Image>> *)(param_1 + 8),(CowData *)(lVar2 + 0x98));
          }
        }
      }
      else {
        _err_print_error("texture_3d_get","drivers/gles3/storage/texture_storage.cpp",0x529,
                         "Condition \"texture->type != Texture::TYPE_3D\" is true. Returning: Vector<Ref<Image>>()"
                         ,0,0);
        *(undefined8 *)(param_1 + 8) = 0;
      }
      goto LAB_001173e5;
  ...
  _err_print_error("texture_3d_get","drivers/gles3/storage/texture_storage.cpp",0x528,
                   "Parameter \"texture\" is null.",0,0);
  *(undefined8 *)(param_1 + 8) = 0;
LAB_001173e5:
  if (local_30 != *(long *)(in_FS_OFFSET + 0x28)) {
...
void __thiscall GLES3::TextureStorage::update_texture_atlas(TextureStorage *this)

{
  ...
  *this_01;
  ...
  if (pRVar36 == (Rect2 *)0x0) {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error("update_texture_atlas","drivers/gles3/storage/texture_storage.cpp",0x759,
...
LAB_00117d97:
      ...
      local_60 = (long *)0x0;
      CowData<GLES3::TextureStorage::TextureAtlas::SortItem>::_copy_on_write
                ((CowData<GLES3::TextureStorage::TextureAtlas::SortItem> *)&local_60);
...
LAB_00117fd8:
            _err_print_index_error
                      ("operator[]","./core/templates/vector.h",0x38,lVar48,lVar47,"p_index",
                       "((Vector<T> *)(this))->_cowdata.size()","",false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
          ...
          lVar47 = ((uVar39 & 0xffffffff) % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
                   *(long *)(*(long *)(this + 0xe0) +
                            ((uVar39 & 0xffffffff) / (ulong)*(uint *)(this + 0xf0)) * 8);
...
LAB_001181d1:
          ...
          if (*(char *)(lVar47 + 8) != '\0') {
            if ((*(long *)(lVar47 + 0x10) == 0) ||
               (uVar39 = *(ulong *)(lVar47 + 0x10), *(uint *)(this + 0xf4) <= (uint)uVar39))
            goto LAB_001181d1;
            lVar47 = ((uVar39 & 0xffffffff) % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
                     *(long *)(*(long *)(this + 0xe0) +
                              ((uVar39 & 0xffffffff) / (ulong)*(uint *)(this + 0xf0)) * 8);
      ...
      Vector<GLES3::TextureStorage::TextureAtlas::SortItem>::
      sort_custom<_DefaultComparator<GLES3::TextureStorage::TextureAtlas::SortItem>,true>
                ((Vector<GLES3::TextureStorage::TextureAtlas::SortItem> *)&local_68);
      if (local_60 == (long *)0x0) {
        local_b0 = 0;
      }
      else {
        ...
        do {
          ...
          if (0 < (int)uVar52) {
            do {
              ...
              if ((iVar46 < iVar1) && (iVar46 = iVar1, iVar34 < iVar1)) goto LAB_00118335;
              uVar45 = uVar45 + 1;
            } while (uVar45 != uVar51);
          }
          if (iVar46 < iVar34) {
...
LAB_00118335:
        ...
        if (0 < (int)uVar52) {
          lVar48 = 0;
          do {
            *(int *)((long)puVar57 + lVar48 * 4 + (long)(int)uVar55 * 4) =
                 *(int *)((long)plVar44 + 0x14) + iVar34;
            lVar48 = lVar48 + 1;
      ...
      *puVar43 = *puVar43 - 1;
      ...
      if (*puVar43 == 0) {
LAB_001183fb:
        Memory::free_static(puVar57 + -2,false);
        *(uint *)(this + 0x16c) = uVar56 * 2;
...
LAB_00118837:
          ...
          uVar52 = 0;
          while (((uint)uVar38 != uVar56 ||
                 (*local_b8 != *(long *)(*(long *)(lVar48 + lVar49 * 8) + 0x10)))) {
            uVar52 = uVar52 + 1;
            auVar14._8_8_ = 0;
            ...
            if ((uVar56 == 0) ||
               (auVar15._8_8_ = 0, auVar15._0_8_ = (ulong)uVar56 * lVar47, auVar31._8_8_ = 0,
               auVar31._0_8_ = uVar50, auVar16._8_8_ = 0,
               auVar16._0_8_ =
                    (ulong)((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x158) * 4)
                            + uVar35) - SUB164(auVar15 * auVar31,8)) * lVar47, auVar32._8_8_ = 0,
               auVar32._0_8_ = uVar50, SUB164(auVar16 * auVar32,8) < uVar52)) goto LAB_00118837;
          }
...
LAB_00118621:
      ...
      this_01 = (HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                 *)(Utilities::singleton + 200);
      if ((*(long *)(Utilities::singleton + 0xd0) != 0) &&
         (*(int *)(Utilities::singleton + 0xf4) != 0)) {
        uVar38 = CONCAT44(0,*(uint *)(hash_table_size_primes +
                                     (ulong)*(uint *)(Utilities::singleton + 0xf0) * 4));
        uVar39 = *(ulong *)(hash_table_size_primes_inv +
                           (ulong)*(uint *)(Utilities::singleton + 0xf0) * 8);
        ...
        if (uVar35 != 0) {
          ...
          do {
            if ((uVar52 == uVar35) &&
               (uVar56 == *(uint *)(*(long *)(*(long *)(Utilities::singleton + 0xd0) + lVar47 * 8) +
                                   0x10))) {
              (*_glad_glDeleteTextures)(1,&local_68);
              puVar37 = (uint *)HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
                                ::operator[](this_01,(uint *)&local_68);
              *(long *)(lVar48 + 0x108) = *(long *)(lVar48 + 0x108) - (ulong)*puVar37;
              HashMap<unsigned_int,GLES3::Utilities::ResourceAllocation,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,GLES3::Utilities::ResourceAllocation>>>
              ::erase(this_01,(uint *)&local_68);
              goto LAB_00117d63;
            }
            uVar51 = uVar51 + 1;
            auVar10._8_8_ = 0;
            ...
            iVar34 = SUB164(auVar10 * auVar26,8);
                  ...
                  (auVar11._8_8_ = 0, auVar11._0_8_ = uVar35 * uVar39, auVar27._8_8_ = 0,
                  auVar27._0_8_ = uVar38, auVar12._8_8_ = 0,
                  auVar12._0_8_ =
                       ((*(uint *)(hash_table_size_primes +
                                  (ulong)*(uint *)(Utilities::singleton + 0xf0) * 4) + iVar34) -
                       SUB164(auVar11 * auVar27,8)) * uVar39, auVar28._8_8_ = 0,
                  auVar28._0_8_ = uVar38, uVar51 <= SUB164(auVar12 * auVar28,8)));
        }
      }
      _err_print_error("texture_free_data","drivers/gles3/storage/../storage/utilities.h",0x90,
                       "Condition \"!texture_allocs_cache.has(p_id)\" is true.");
LAB_00117d63:
      *(undefined4 *)(this + 0x164) = 0;
...
LAB_0011756d:
      *(undefined8 *)(this + 0x16c) = _LC241;
    }
    (*_glad_glGenTextures)(1,this + 0x164);
    (*_glad_glActiveTexture)(0x84c0);
    (*_glad_glBindTexture)(0xde1,*(undefined4 *)(this + 0x164));
    (*_glad_glTexImage2D)
              (0xde1,0,0x8058,*(undefined4 *)(this + 0x16c),*(undefined4 *)(this + 0x170),0,0x1908,
               0x1401,0);
    lVar48 = Utilities::singleton;
    ...
    *puVar37 = uVar56;
    ...
    if (iVar34 == 0x8cd5) {
      ...
      (*_glad_glDisable)(0xbe2);
      if (*(int *)(this + 0x15c) != 0) {
        for (puVar40 = *(undefined8 **)(this + 0x148); puVar40 != (undefined8 *)0x0;
            puVar40 = (undefined8 *)*puVar40) {
          uVar39 = puVar40[2];
          if ((*(long *)(this + 0x138) != 0) && (*(int *)(this + 0x15c) != 0)) {
            uVar54 = CONCAT44(0,*(uint *)(hash_table_size_primes +
                                         (ulong)*(uint *)(this + 0x158) * 4));
            ...
            if (uVar56 != 0) {
              uVar35 = 0;
              while ((uVar56 != (uint)uVar50 ||
                     (uVar39 != *(ulong *)(*(long *)(*(long *)(this + 0x138) + lVar47 * 8) + 0x10)))
                    ) {
                uVar35 = uVar35 + 1;
                auVar7._8_8_ = 0;
                ...
                if ((uVar56 == 0) ||
                   (auVar8._8_8_ = 0, auVar8._0_8_ = (ulong)uVar56 * lVar48, auVar23._8_8_ = 0,
                   auVar23._0_8_ = uVar54, auVar9._8_8_ = 0,
                   auVar9._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                                    (ulong)*(uint *)(this + 0x158) * 4) + iVar34) -
                                         SUB164(auVar8 * auVar23,8)) * lVar48, auVar24._8_8_ = 0,
                   auVar24._0_8_ = uVar54, SUB164(auVar9 * auVar24,8) < uVar35)) break;
              }
            }
          }
          if ((uVar39 == 0) || (*(uint *)(this + 0xf4) <= (uint)uVar39)) goto LAB_001180aa;
          lVar48 = ((uVar39 & 0xffffffff) % (ulong)*(uint *)(this + 0xf0)) * 0xf0 +
                   *(long *)(*(long *)(this + 0xe0) +
                            ((uVar39 & 0xffffffff) / (ulong)*(uint *)(this + 0xf0)) * 8);
    ...
    *(undefined4 *)(this + 0x168) = 0;
    ...
    if ((*(long *)(lVar48 + 0xd0) != 0) && (*(int *)(lVar48 + 0xf4) != 0)) {
      ...
      if (uVar35 != 0) {
        ...
        do {
          if ((uVar35 == local_b0) &&
             (uVar56 == *(uint *)(*(long *)(*(long *)(lVar48 + 0xd0) + lVar47 * 8) + 0x10))) {
          ...
          iVar46 = SUB164(auVar3 * auVar18,8);
                ...
                (auVar4._8_8_ = 0, auVar4._0_8_ = uVar35 * uVar39, auVar19._8_8_ = 0,
                auVar19._0_8_ = uVar50, auVar5._8_8_ = 0,
                auVar5._0_8_ = ((*(uint *)(hash_table_size_primes +
                                          (ulong)*(uint *)(lVar48 + 0xf0) * 4) + iVar46) -
                               SUB164(auVar4 * auVar19,8)) * uVar39, auVar20._8_8_ = 0,
                auVar20._0_8_ = uVar50, uVar52 <= SUB164(auVar5 * auVar20,8)));
      }
    }
    _err_print_error("texture_free_data","drivers/gles3/storage/../storage/utilities.h",0x90,
                     "Condition \"!texture_allocs_cache.has(p_id)\" is true.",0,0);
LAB_001178b5:
    *(undefined4 *)(this + 0x164) = 0;
    ...
    operator+((char *)&local_68,(String *)"Could not create texture atlas, status: ");
    _err_print_error("update_texture_atlas","drivers/gles3/storage/texture_storage.cpp",0x7eb,
...
/* GLES3::TextureStorage::render_target_set_override(RID, RID, RID, RID, RID) */

void GLES3::TextureStorage::render_target_set_override
               (TextureStorage *param_1,ulong param_2,long param_3,long param_4,undefined8 param_5)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(param_1 + 0x194))) {
    pRVar17 = (RenderTarget *)
              (((param_2 & 0xffffffff) % (ulong)*(uint *)(param_1 + 400)) * 0xf0 +
      ...
      if ((*(long *)(pRVar17 + 0x98) != param_3) || (param_4 != *(long *)(pRVar17 + 0xa0))) {
        if (param_4 == 0 && param_3 == 0) {
          ...
          *(long *)(pRVar17 + 0xa0) = param_4;
          uVar20 = system_fbo;
          uVar5 = ((int)param_3 * 0x16a88000 | (uint)((int)param_3 * -0x3361d2af) >> 0x11) *
                  0x1b873593 ^ 0x7f07c65;
          uVar5 = (uVar5 << 0xd | uVar5 >> 0x13) * 5 + 0xe6546b64 ^
                  (iVar13 * 0x16a88000 | (uint)(iVar13 * -0x3361d2af) >> 0x11) * 0x1b873593;
          uVar5 = ((int)param_4 * 0x16a88000 | (uint)((int)param_4 * -0x3361d2af) >> 0x11) *
                  0x1b873593 ^ (uVar5 << 0xd | uVar5 >> 0x13) * 5 + 0xe6546b64;
          iVar13 = (int)((ulong)param_4 >> 0x20);
          uVar5 = (iVar13 * 0x16a88000 | (uint)(iVar13 * -0x3361d2af) >> 0x11) * 0x1b873593 ^
...
LAB_00118b31:
          if ((*(int *)(pRVar17 + 8) < 1) || (*(int *)(pRVar17 + 0xc) < 1)) {
LAB_00118b5a:
            uVar20 = *(undefined4 *)(pRVar17 + 0x20);
          }
          else {
            if (pRVar17[0x76] == (RenderTarget)0x0) {
              _update_render_target(param_1,pRVar17);
          ...
          if (pEVar10 == (Element *)0x0) {
            ...
            *(undefined8 *)(pEVar10 + 8) = uVar2;
            *(undefined8 *)(pEVar10 + 0x10) = uVar2;
            *(undefined8 *)(pEVar10 + 0x18) = uVar2;
          }
          else {
                  ...
                  *(undefined8 *)(pEVar7 + 0x44) = uVar15;
                  if (*(long *)(pEVar7 + 0x58) != local_88[0]) {
                    CowData<unsigned_int>::_ref
                              ((CowData<unsigned_int> *)(pEVar7 + 0x58),(CowData *)local_88);
                  }
                  goto LAB_00118e37;
                }
          ...
          *(undefined1 (*) [16])(pEVar7 + 0x18) = (undefined1  [16])0x0;
          if (local_50[0] != 0) {
            CowData<unsigned_int>::_ref
                      ((CowData<unsigned_int> *)(pEVar7 + 0x58),(CowData *)local_50);
            LOCK();
...
LAB_00118e04:
            *(Element **)(pEVar7 + 0x28) = pEVar10;
            if (pEVar9 != (Element *)0x0) {
LAB_00118e0d:
              *(Element **)(pEVar9 + 0x28) = pEVar7;
...
LAB_00118e1e:
          *(int *)(pRVar17 + 0xc0) = *(int *)(pRVar17 + 0xc0) + 1;
          RBMap<unsigned_int,GLES3::RenderTarget::RTOverridden::FBOCacheEntry,Comparator<unsigned_int>,DefaultAllocator>
          ::_insert_rb_fix((RBMap<unsigned_int,GLES3::RenderTarget::RTOverridden::FBOCacheEntry,Comparator<unsigned_int>,DefaultAllocator>
                            *)(pRVar17 + 0xb0),pEVar7);
LAB_00118e37:
          if (lVar6 != 0) {
            LOCK();
...
LAB_00118fb6:
    _err_print_error("render_target_set_override","drivers/gles3/storage/texture_storage.cpp",uVar15
                     ,pcVar12,0,0);
    return;
  }
LAB_00119157:
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::render_target_create() */

undefined8 __thiscall GLES3::TextureStorage::render_target_create(TextureStorage *this)

{
  ...
  local_178 = local_108;
  local_40 = RID_Alloc<GLES3::Texture,true>::make_rid
                       ((RID_Alloc<GLES3::Texture,true> *)(this + 0xd8),(Texture *)&local_1f8);
  ...
  uVar6 = RID_Alloc<GLES3::RenderTarget,false>::make_rid
                    ((RID_Alloc<GLES3::RenderTarget,false> *)(this + 0x178),local_108);
...
/* GLES3::TextureStorage::decal_free(RID) */

void GLES3::TextureStorage::decal_free(void)
...
/* GLES3::TextureStorage::decal_get_cull_mask(RID) const */

undefined8 GLES3::TextureStorage::decal_get_cull_mask(void)
...
/* GLES3::TextureStorage::decal_instance_create(RID) */

undefined8 GLES3::TextureStorage::decal_instance_create(void)
...
/* GLES3::TextureStorage::decal_instance_free(RID) */

void GLES3::TextureStorage::decal_instance_free(void)
...
/* GLES3::TextureStorage::decal_instance_set_transform(RID, Transform3D const&) */

void GLES3::TextureStorage::decal_instance_set_transform(void)
...
/* GLES3::TextureStorage::decal_instance_set_sorting_offset(RID, float) */

void GLES3::TextureStorage::decal_instance_set_sorting_offset(void)
...
/* GLES3::TextureStorage::render_target_set_msaa_needs_resolve(RID, bool) */

void GLES3::TextureStorage::render_target_set_msaa_needs_resolve(void)
...
/* GLES3::TextureStorage::render_target_get_msaa_needs_resolve(RID) const */

undefined8 GLES3::TextureStorage::render_target_get_msaa_needs_resolve(void)
...
/* GLES3::TextureStorage::render_target_do_msaa_resolve(RID) */

void GLES3::TextureStorage::render_target_do_msaa_resolve(void)
...
/* GLES3::TextureStorage::render_target_set_vrs_mode(RID, RenderingServer::ViewportVRSMode) */

void GLES3::TextureStorage::render_target_set_vrs_mode(void)
...
/* GLES3::TextureStorage::render_target_get_vrs_mode(RID) const */

undefined8 GLES3::TextureStorage::render_target_get_vrs_mode(void)
...
void GLES3::TextureStorage::render_target_set_vrs_update_mode(void)
...
/* GLES3::TextureStorage::render_target_get_vrs_update_mode(RID) const */

undefined8 GLES3::TextureStorage::render_target_get_vrs_update_mode(void)
...
/* GLES3::TextureStorage::render_target_set_vrs_texture(RID, RID) */

void GLES3::TextureStorage::render_target_set_vrs_texture(void)
...
/* GLES3::TextureStorage::render_target_get_vrs_texture(RID) const */

undefined8 GLES3::TextureStorage::render_target_get_vrs_texture(void)
...
/* GLES3::TextureStorage::render_target_get_override_velocity_depth(RID) const */

undefined8 GLES3::TextureStorage::render_target_get_override_velocity_depth(void)
...
/* GLES3::TextureStorage::render_target_set_velocity_target_size(RID, Vector2i const&) */

void GLES3::TextureStorage::render_target_set_velocity_target_size(void)
...
/* GLES3::TextureStorage::render_target_get_velocity_target_size(RID) const */

undefined8 GLES3::TextureStorage::render_target_get_velocity_target_size(void)
...
/* CanvasSdfShaderGLES3::~CanvasSdfShaderGLES3() */

void __thiscall CanvasSdfShaderGLES3::~CanvasSdfShaderGLES3(CanvasSdfShaderGLES3 *this)
...
/* CanvasSdfShaderGLES3::_init() */

void __thiscall CanvasSdfShaderGLES3::_init(CanvasSdfShaderGLES3 *this)

{
  ShaderGLES3::_setup((char *)this,
                      ...
                      ,0x1196f5,(char **)&DAT_00000004,0x123ec0,(UBOPair *)0x0,
                      (int)_init()::_ubo_pairs,(Feedback *)0x0,(int)_init()::_feedbacks,
                      (TexUnitPair *)0x2,0x123e60,(Specialization *)0x0,(int)_init()::_spec_pairs,
                      (char **)0x5);
  return;
}
...
/* GLES3::TextureStorage::texture_size_with_proxy(RID) [clone .cold] */

void GLES3::TextureStorage::texture_size_with_proxy
...
void CowData<GLES3::TextureStorage::TextureAtlas::SortItem>::_copy_on_write(void)
...
/* GLES3::TextureStorage::render_target_get_sdf_texture(RID) [clone .cold] */

void GLES3::TextureStorage::render_target_get_sdf_texture
               (undefined8 param_1,undefined8 param_2,int param_3)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::TextureStorage::_clear_render_target(GLES3::RenderTarget*) [clone .part.0] [clone .cold]
    */
...
/* GLES3::TextureStorage::render_target_free(RID) [clone .cold] */

void GLES3::TextureStorage::render_target_free(undefined8 param_1)
...
/* SortArray<GLES3::TextureStorage::TextureAtlas::SortItem,
   ...
   GLES3::TextureStorage::TextureAtlas::SortItem*, long) const [clone .isra.0] */

void SortArray<GLES3::TextureStorage::TextureAtlas::SortItem,_DefaultComparator<GLES3::TextureStorage::TextureAtlas::SortItem>,true>
...
LAB_0011bab4:
          ...
          _err_print_error("partitioner","./core/templates/sort_array.h",0xb9,
                           "bad comparison function; sorting will be broken",0,0);
joined_r0x0011baf5:
          if (lVar10 <= param_2) goto LAB_0011bb8a;
...
void __thiscall
RBMap<unsigned_int,GLES3::RenderTarget::RTOverridden::FBOCacheEntry,Comparator<unsigned_int>,DefaultAllocator>
::_cleanup_tree(RBMap<unsigned_int,GLES3::RenderTarget::RTOverridden::FBOCacheEntry,Comparator<unsigned_int>,DefaultAllocator>
...
/* GLES3::TextureStorage::get_texture(RID) const */

long __thiscall GLES3::TextureStorage::get_texture(TextureStorage *this,ulong param_2)
...
/* GLES3::TextureStorage::render_target_set_as_unused(RID) */

void GLES3::TextureStorage::render_target_set_as_unused(void)
...
/* OAHashMap<unsigned long, ShaderGLES3::Version::Specialization, HashMapHasherDefault,
   HashMapComparatorDefault<unsigned long> >::lookup_ptr(unsigned long const&) */
...
LAB_0011d973:
  if ((float)uVar51 * __LC127 < (float)(iVar44 + 1)) {
...
/* HashMap<RID, GLES3::TextureStorage::TextureAtlas::Texture, HashMapHasherDefault,
   HashMapComparatorDefault<RID>, DefaultTypedAllocator<HashMapElement<RID,
   GLES3::TextureStorage::TextureAtlas::Texture> > >::operator[](RID const&) */
...
LAB_0011e0fb:
  if ((float)uVar55 * __LC127 < (float)(iVar43 + 1)) {
...
LAB_0011ea3a:
  ...
  pEVar4 = *(Element **)(this + 8);
LAB_0011ea5d:
  *(Element **)((long)pvVar6 + 0x10) = pEVar4;
...
/* WARNING: Removing unreachable block (ram,0x0011ed18) */
/* WARNING: Removing unreachable block (ram,0x0011ee9a) */
/* WARNING: Removing unreachable block (ram,0x0011ef20) */
/* WARNING: Removing unreachable block (ram,0x0011eea2) */
/* WARNING: Removing unreachable block (ram,0x0011eeb8) */
/* WARNING: Removing unreachable block (ram,0x0011eec4) */
...
/* WARNING: Removing unreachable block (ram,0x0011f068) */
/* WARNING: Removing unreachable block (ram,0x0011f1cd) */
/* WARNING: Removing unreachable block (ram,0x0011f260) */
/* WARNING: Removing unreachable block (ram,0x0011f1d9) */
/* WARNING: Removing unreachable block (ram,0x0011f1ff) */
/* WARNING: Removing unreachable block (ram,0x0011f20b) */
/* String vformat<Image::Format>(String const&, Image::Format const) */

undefined8 * vformat<Image::Format>(undefined8 *param_1,bool *param_2,int param_3)
...
/* WARNING: Removing unreachable block (ram,0x0011f3d0) */
/* WARNING: Removing unreachable block (ram,0x0011f565) */
/* WARNING: Removing unreachable block (ram,0x0011f571) */
...
/* RID_Alloc<GLES3::CanvasTexture, true>::~RID_Alloc() */

void __thiscall
RID_Alloc<GLES3::CanvasTexture,true>::~RID_Alloc(RID_Alloc<GLES3::CanvasTexture,true> *this)
...
void __thiscall
RID_Alloc<GLES3::RenderTarget,false>::~RID_Alloc(RID_Alloc<GLES3::RenderTarget,false> *this)
...
LAB_0011f922:
    if ((uint)uVar6 < (uint)uVar8) goto LAB_0011f963;
    lVar7 = 0;
    while( true ) {
...

{
  ...
  *(undefined ***)this = &PTR__RID_Alloc_00122bf0;
  if (uVar3 == 0) {
    ...
    puVar9 = *(undefined8 **)(this + 8);
LAB_0011fd42:
    if ((uint)uVar6 < (uint)uVar8) goto LAB_0011fd83;
    lVar7 = 0;
    while( true ) {
      Memory::free_static((void *)puVar9[lVar7],false);
      lVar2 = lVar7 * 8;
...
ulong __thiscall
RID_Alloc<GLES3::CanvasTexture,true>::allocate_rid(RID_Alloc<GLES3::CanvasTexture,true> *this)

{
  ...
  RID_AllocBase::base_id = RID_AllocBase::base_id + 1;
  *(uint *)(((ulong)uVar8 % (ulong)uVar2) * 0x40 +
            *(long *)(*(long *)(this + 8) + ((ulong)uVar8 / (ulong)uVar2) * 8) + 0x38) =
       uVar12 | 0x80000000;
...
/* RID_Alloc<GLES3::Texture, true>::allocate_rid() */

ulong __thiscall RID_Alloc<GLES3::Texture,true>::allocate_rid(RID_Alloc<GLES3::Texture,true> *this)

{
  ...
  if (uVar6 == *(uint *)(this + 0x1c)) {
    ...
    if (*(uint *)(this + 0x24) == uVar6) {
      ...
      if (__s == (char *)0x0) {
        ...
        _err_print_error("_allocate_rid","./core/templates/rid_owner.h",0x83,
                         "Method/function failed. Returning: RID()",(CowData<char32_t> *)&local_48,0
                         ,0);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
        lVar3 = local_50;
  ...
  uVar2 = *(uint *)(this + 0x18);
  uVar6 = *(uint *)(*(long *)(*(long *)(this + 0x10) + ((ulong)uVar6 / (ulong)uVar2) * 8) +
                   ((ulong)uVar6 % (ulong)uVar2) * 4);
  LOCK();
  UNLOCK();
  ...
  RID_AllocBase::base_id = RID_AllocBase::base_id + 1;
  *(uint *)(((ulong)uVar6 % (ulong)uVar2) * 0xf0 +
            *(long *)(*(long *)(this + 8) + ((ulong)uVar6 / (ulong)uVar2) * 8) + 0xe8) =
       uVar10 | 0x80000000;
  *(int *)(this + 0x20) = *(int *)(this + 0x20) + 1;
  pthread_mutex_unlock(__mutex);
LAB_00120377:
...
Vector<GLES3::TextureStorage::TextureAtlas::SortItem>::
sort_custom<_DefaultComparator<GLES3::TextureStorage::TextureAtlas::SortItem>,true>
          (Vector<GLES3::TextureStorage::TextureAtlas::SortItem> *this)

{
  ...
  if ((*(long *)(this + 8) != 0) && (lVar4 = *(long *)(*(long *)(this + 8) + -8), lVar4 != 0)) {
    CowData<GLES3::TextureStorage::TextureAtlas::SortItem>::_copy_on_write
              ((CowData<GLES3::TextureStorage::TextureAtlas::SortItem> *)(this + 8));
    __src = *(SortItem **)(this + 8);
    if (lVar4 == 1) {
      if (lVar3 == *(long *)(in_FS_OFFSET + 0x28)) {
        SortArray<GLES3::TextureStorage::TextureAtlas::SortItem,_DefaultComparator<GLES3::TextureStorage::TextureAtlas::SortItem>,true>
...
/* RID_Alloc<GLES3::Texture, true>::initialize_rid(RID, GLES3::Texture const&) */

void __thiscall
RID_Alloc<GLES3::Texture,true>::initialize_rid
          (RID_Alloc<GLES3::Texture,true> *this,ulong param_2,undefined8 *param_3)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x1c))) {
    puVar13 = (undefined8 *)
              (((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x18)) * 0xf0 +
              *(long *)(*(long *)(this + 8) +
    ...
    if ((int)*(uint *)(puVar13 + 0x1d) < 0) {
      ...
      if (uVar11 == (uint)(param_2 >> 0x20)) {
        ...
        *(undefined2 *)(puVar13 + 0xf) = *(undefined2 *)(param_3 + 0xf);
        ...
        if (param_3[0x13] != 0) {
          CowData<Ref<Image>>::_ref
                    ((CowData<Ref<Image>> *)(puVar13 + 0x13),(CowData *)(param_3 + 0x13));
        }
        uVar4 = param_3[0x1a];
        uVar5 = param_3[0x1b];
...
/* RID_Alloc<GLES3::Texture, true>::make_rid(GLES3::Texture const&) */

ulong __thiscall
RID_Alloc<GLES3::Texture,true>::make_rid(RID_Alloc<GLES3::Texture,true> *this,Texture *param_1)

{
  ...
  if (uVar5 == *(uint *)(this + 0x1c)) {
    ...
    if (*(uint *)(this + 0x24) == uVar5) {
      ...
      if (__s == (char *)0x0) {
        ...
        _err_print_error("_allocate_rid","./core/templates/rid_owner.h",0x83,
                         "Method/function failed. Returning: RID()",(CowData<char32_t> *)&local_58,0
                         ,0);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_68);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
  ...
  uVar1 = *(uint *)(this + 0x18);
  uVar5 = *(uint *)(*(long *)(*(long *)(this + 0x10) + ((ulong)uVar5 / (ulong)uVar1) * 8) +
                   ((ulong)uVar5 % (ulong)uVar1) * 4);
  LOCK();
  UNLOCK();
  ...
  RID_AllocBase::base_id = RID_AllocBase::base_id + 1;
  *(uint *)(((ulong)uVar5 % (ulong)uVar1) * 0xf0 +
            *(long *)(*(long *)(this + 8) + ((ulong)uVar5 / (ulong)uVar1) * 8) + 0xe8) =
       uVar9 | 0x80000000;
  *(int *)(this + 0x20) = *(int *)(this + 0x20) + 1;
  pthread_mutex_unlock(__mutex);
LAB_00121307:
  initialize_rid(this,uVar11,param_1);
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return uVar11;
  }
                    /* WARNING: Subroutine does not return */
...
/* RID_Alloc<GLES3::Texture, true>::~RID_Alloc() */

void __thiscall RID_Alloc<GLES3::Texture,true>::~RID_Alloc(RID_Alloc<GLES3::Texture,true> *this)

{
  ...
  *(undefined ***)this = &PTR__RID_Alloc_00122bd0;
  ...
  if (uVar2 == 0) {
    ...
    puVar9 = *(undefined8 **)(this + 8);
LAB_0012164a:
    if ((uint)uVar6 < (uint)uVar8) goto LAB_0012168b;
    lVar7 = 0;
    while( true ) {
      Memory::free_static((void *)puVar9[lVar7],false);
      lVar3 = lVar7 * 8;
    ...
    if (*(int *)(this + 0x1c) != 0) {
      ...
      do {
        ...
        if (-1 < *(int *)(lVar7 + 0xe8)) {
          ...
          if ((*(long *)(lVar7 + 0x88) != 0) && (cVar5 = RefCounted::unreference(), cVar5 != '\0'))
          {
...
/* CowData<GLES3::TextureStorage::TextureAtlas::SortItem>::_realloc(long) */

undefined8 __thiscall
CowData<GLES3::TextureStorage::TextureAtlas::SortItem>::_realloc
          (CowData<GLES3::TextureStorage::TextureAtlas::SortItem> *this,long param_1)
...
void __thiscall
RBMap<unsigned_int,GLES3::RenderTarget::RTOverridden::FBOCacheEntry,Comparator<unsigned_int>,DefaultAllocator>
::_copy_from(RBMap<unsigned_int,GLES3::RenderTarget::RTOverridden::FBOCacheEntry,Comparator<unsigned_int>,DefaultAllocator>
             *this,RBMap *param_1)
    ...
    if (lVar15 != *(long *)(param_1 + 8)) {
      ...
      do {
        ...
        if (pEVar9 == (Element *)0x0) {
          ...
          *(Element **)this = pEVar9;
          *(undefined4 *)pEVar9 = 1;
          *(undefined8 *)(pEVar9 + 8) = uVar4;
          *(undefined8 *)(pEVar9 + 0x10) = uVar4;
          *(undefined8 *)(pEVar9 + 0x18) = uVar4;
        }
              ...
              if (*(uint *)(lVar14 + 0x30) <= *(uint *)(pEVar9 + 0x30)) {
                ...
                *(undefined8 *)(pEVar9 + 0x44) = *(undefined8 *)(lVar14 + 0x44);
                if (*(long *)(pEVar9 + 0x58) != *(long *)(lVar14 + 0x58)) {
                  CowData<unsigned_int>::_ref
                            ((CowData<unsigned_int> *)(pEVar9 + 0x58),(CowData *)(lVar14 + 0x58));
                }
                goto LAB_00122420;
              }
...
/* RID_Alloc<GLES3::RenderTarget, false>::make_rid(GLES3::RenderTarget const&) */

ulong __thiscall
RID_Alloc<GLES3::RenderTarget,false>::make_rid
          (RID_Alloc<GLES3::RenderTarget,false> *this,RenderTarget *param_1)

{
  ...
  if (uVar14 != 0x7fffffff) {
    lVar21 = *(long *)(this + 8);
    RID_AllocBase::base_id = RID_AllocBase::base_id + 1;
    *(uint *)((uVar22 % (ulong)uVar12) * 0xf0 + *(long *)(lVar21 + (uVar22 / uVar12) * 8) + 0xe8) =
         uVar14 | 0x80000000;
    *(int *)(this + 0x20) = *(int *)(this + 0x20) + 1;
    uVar20 = CONCAT44(uVar13,uVar15) & 0x7fffffffffffffff;
    if ((uVar20 != 0) && ((uint)uVar20 < *(uint *)(this + 0x1c))) {
      puVar18 = (undefined8 *)
                ((uVar22 % (ulong)*(uint *)(this + 0x18)) * 0xf0 +
                *(long *)(lVar21 + (uVar22 / *(uint *)(this + 0x18)) * 8));
      if ((int)*(uint *)(puVar18 + 0x1d) < 0) {
        ...
        if (uVar15 == (*(uint *)(puVar18 + 0x1d) & 0x7fffffff)) {
          ...
          *(undefined4 *)((long)puVar18 + 0x4c) = *(undefined4 *)(param_1 + 0x4c);
          puVar18[10] = *(undefined8 *)(param_1 + 0x50);
          puVar18[0xb] = *(undefined8 *)(param_1 + 0x58);
          puVar18[0xc] = *(undefined8 *)(param_1 + 0x60);
          ...
          *(undefined4 *)(puVar18 + 0x18) = 0;
          RBMap<unsigned_int,GLES3::RenderTarget::RTOverridden::FBOCacheEntry,Comparator<unsigned_int>,DefaultAllocator>
          ::_copy_from((RBMap<unsigned_int,GLES3::RenderTarget::RTOverridden::FBOCacheEntry,Comparator<unsigned_int>,DefaultAllocator>
                        *)(puVar18 + 0x16),(RBMap *)(param_1 + 0xb0));

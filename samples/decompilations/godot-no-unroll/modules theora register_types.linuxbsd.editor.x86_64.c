...
/* uninitialize_theora_module(ModuleInitializationLevel) */

void uninitialize_theora_module(int param_1)

{
  ...
  if (param_1 == 2) {
    local_18 = (Object *)0x0;
    if (resource_loader_theora != (Object *)0x0) {
      pOVar2 = (Object *)
               __dynamic_cast(resource_loader_theora,&Object::typeinfo,
                              &ResourceFormatLoader::typeinfo,0);
    ...
    if (resource_loader_theora != (Object *)0x0) {
      cVar1 = RefCounted::unreference();
      pOVar2 = resource_loader_theora;
      if (cVar1 != '\0') {
        cVar1 = predelete_handler(resource_loader_theora);
        if (cVar1 != '\0') {
          (**(code **)(*(long *)pOVar2 + 0x140))(pOVar2);
          Memory::free_static(pOVar2,false);
        }
    ...
    resource_loader_theora = (Object *)0x0;
  }
...
/* initialize_theora_module(ModuleInitializationLevel) */

void initialize_theora_module(int param_1)

{
  ...
  local_10 = *(long *)(in_FS_OFFSET + 0x28);
  if (param_1 == 2) {
    Ref<ResourceFormatLoaderTheora>::instantiate<>
              ((Ref<ResourceFormatLoaderTheora> *)&resource_loader_theora);
    local_18 = (Object *)0x0;
    if (resource_loader_theora != 0) {
      pOVar2 = (Object *)
               __dynamic_cast(resource_loader_theora,&Object::typeinfo,
                              &ResourceFormatLoader::typeinfo,0);
      if (pOVar2 != (Object *)0x0) {
    ...
    if (local_10 == *(long *)(in_FS_OFFSET + 0x28)) {
      ClassDB::register_class<VideoStreamTheora>(false);
      return;
    }
  }
...
{
  return (uint)CONCAT71(0x1035,(undefined4 *)param_1 == &VideoStream::get_class_ptr_static()::ptr) |
...
/* Object* ClassDB::creator<VideoStreamTheora>(bool) */

Object * ClassDB::creator<VideoStreamTheora>(bool param_1)

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_00103360;
  Object::_initialize();
  if (!param_1) {
    return (Object *)this;
  }
...

{
  ...
  (**(code **)(*(long *)this + 0x208))(this,*(undefined4 *)(in_RSI + 0x260));
  VideoStreamPlaybackTheora::set_file((String *)this);
  *in_RDI = 0;
...
/* Ref<ResourceFormatLoaderTheora>::~Ref() */

void __thiscall Ref<ResourceFormatLoaderTheora>::~Ref(Ref<ResourceFormatLoaderTheora> *this)
...

{
  ...
  if (initialize_class()::initialized == '\0') {
    ...
    if ((code *)_GLOBAL_OFFSET_TABLE_ != VideoStream::_bind_methods) {
...
LAB_00101238:
    ...
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_00101238;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)pLVar6;
      local_68 = local_80;
      goto joined_r0x00101256;
    }
...
LAB_00101638:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_00101638;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
...
LAB_00101c1f:
    ...
    if (cVar5 != '\0') goto LAB_00101cd3;
  }
  cVar5 = String::operator==(param_1,"VideoStreamTheora");
  if (cVar5 == '\0') {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      uVar7 = VideoStream::is_class((VideoStream *)this,param_1);
      return uVar7;
    }
  }
  else {
...
LAB_001022f8:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_001022f8;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x00102315;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
/* void Ref<ResourceFormatLoaderTheora>::instantiate<>() */

void __thiscall
Ref<ResourceFormatLoaderTheora>::instantiate<>(Ref<ResourceFormatLoaderTheora> *this)

{
  ...
  *(undefined8 **)this_00 = &ClassDB::classes;
  ...
  if (cVar1 == '\0') {
    ...
    *(undefined8 *)this = 0;
    ...
    pOVar5 = *(Object **)this;
    pOVar4 = pOVar5;
    if (this_00 == (RefCounted *)pOVar5) goto LAB_00102905;
    *(RefCounted **)this = this_00;
    ...
    if (((pOVar5 == (Object *)0x0) || (cVar1 = RefCounted::unreference(), cVar1 == '\0')) ||
       (cVar1 = predelete_handler(pOVar5), cVar1 == '\0')) goto LAB_00102905;
  }
...
/* void ClassDB::register_class<VideoStreamTheora>(bool) */

void ClassDB::register_class<VideoStreamTheora>(bool param_1)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  _global_lock();
  if (VideoStreamTheora::initialize_class()::initialized == '\0') {
    if (VideoStream::initialize_class()::initialized == '\0') {
      if (Resource::initialize_class()::initialized == '\0') {
        if (RefCounted::initialize_class()::initialized == '\0') {
          Object::initialize_class();
    ...
    VideoStreamTheora::initialize_class()::initialized = '\x01';
  }
  local_58 = "VideoStreamTheora";
  local_60 = 0;
  local_50 = 0x11;
  ...
  if ((CONCAT44(current_api._4_4_,(undefined4)current_api) != 0) && (_DAT_001041a4 != 0)) {
    ...
    if (uVar17 != 0) {
      ...
      do {
        if ((uVar13 == uVar17) &&
          ...
          if (local_60 == 0) goto LAB_00102f47;
          goto LAB_00102f1d;
        }
        uVar18 = uVar18 + 1;
        auVar5._8_8_ = 0;
...
LAB_00102f47:
        ...
        *(code **)(puVar16 + 0xa4) = creator<VideoStreamTheora>;
        *(bool *)((long)puVar16 + 0x28b) = param_1;
        *(undefined4 **)(puVar16 + 4) = &VideoStreamTheora::get_class_ptr_static()::ptr;
        *puVar16 = (undefined4)current_api;
        ...
        if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) goto LAB_001030e7;
        goto LAB_00103043;
      }
    }
  }

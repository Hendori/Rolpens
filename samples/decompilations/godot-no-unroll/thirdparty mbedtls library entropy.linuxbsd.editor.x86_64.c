...

{
  ...
  while( true ) {
    ...
    iVar1 = entropy_gather_internal_part_0();
    if (iVar1 != 0) goto LAB_00100402;
    if (0 < *(int *)(param_1 + 0x1c)) {
      ...
      do {
        ...
        puVar2 = puVar2 + 5;
      } while (puVar2 != puVar7 + (long)*(int *)(param_1 + 0x1c) * 5);
      if ((0x3f < uVar6) && (bVar4)) {
        local_88 = (undefined1  [16])0x0;
        local_78 = (undefined1  [16])0x0;
        local_68 = (undefined1  [16])0x0;
        local_58 = (undefined1  [16])0x0;
        iVar1 = mbedtls_md_finish(param_1,local_88);
        if (iVar1 == 0) {
          mbedtls_md_free(param_1);
          mbedtls_md_init(param_1);
          uVar3 = mbedtls_md_info_from_type(0xb);
          iVar1 = mbedtls_md_setup(param_1,uVar3,0);
          if (((iVar1 == 0) && (iVar1 = mbedtls_md_starts(param_1), iVar1 == 0)) &&
             (iVar1 = mbedtls_md_update(param_1,local_88,0x40), iVar1 == 0)) {
            uVar3 = mbedtls_md_info_from_type(0xb);
            iVar1 = mbedtls_md(uVar3,local_88,0x40,local_88);
            if (iVar1 == 0) {
              if (0 < *(int *)(param_1 + 0x1c)) {
                puVar2 = puVar7 + (long)*(int *)(param_1 + 0x1c) * 5;
                do {
                  *puVar7 = 0;
                  puVar7 = puVar7 + 5;
                } while (puVar7 != puVar2);
...
LAB_001009d1:
    bVar11 = true;
    if (param_1 == 0) goto LAB_001009fb;
LAB_001009dc:
    bVar11 = true;
    puts("failed");
  }
    ...
    if (iVar4 != 0) goto LAB_001009ca;
    if (0x13 < local_3ec) {
      iVar4 = -0x3e;
      if (local_3f0 == -1) goto LAB_001009d1;
      goto LAB_0010097b;
    }
    ...
    *(undefined4 *)(auStack_3c8 + lVar5 * 5) = 0;
    ...
    while (cVar1 != '\0') {
      ...
      if (puVar8 == &local_48) goto LAB_00100974;
      cVar1 = *(char *)puVar8;
    }
    iVar4 = 1;
LAB_00100974:
    if (local_3f0 != -1) goto LAB_0010097b;
LAB_001009a2:
    if (param_1 == 0) {
      bVar11 = iVar4 != 0;
      goto LAB_001009fb;
    }
    if (iVar4 != 0) goto LAB_001009dc;
    puts("passed");
    bVar11 = false;
  }
  putchar(10);

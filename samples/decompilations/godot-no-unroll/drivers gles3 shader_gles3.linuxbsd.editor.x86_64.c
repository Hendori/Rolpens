...
void LocalVector<ShaderGLES3::TextureUniformData,unsigned_int,false,false>::resize(uint param_1)
...
LAB_00101336:
        if (pbVar15 != (byte *)0x0) goto LAB_00101228;
        goto LAB_0010133f;
      }
      if (pbVar16 == (byte *)0x0) {
        puVar7 = *(uint **)(lVar8 + 0x10);
...
LAB_001012d9:
        if (pbVar16 == (byte *)0x0) goto LAB_001012de;
        goto LAB_00101286;
      }
      bVar11 = *pbVar17;
      uVar4 = (uint)(char)bVar11;
...
void OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
     ::_insert_with_hash(uint param_1,ulong *param_2,Specialization *param_3)

{
  ...
  if (uVar37 != 0) {
    ...
    pvVar52 = unaff_R15;
    do {
      uVar38 = (uint)((ulong)(uint)(((int)puVar43 + (int)in_RCX) -
                                   (int)((ulong)uVar37 % (ulong)in_RCX)) % (ulong)in_RCX);
      pvVar32 = pvVar44;
      param_3 = pSVar51;
      unaff_R15 = pvVar52;
      uVar39 = (uint)in_R9;
...
LAB_00103369:
        do {
          if ((in_R9 >> (uVar53 & 0x3f) & 1) != 0) {
            ...
            operator+((char *)&lStack_e0,(String *)"#define ");
...
LAB_00103b70:
        if (lStack_b8 == *(long *)(in_FS_OFFSET + 0x28)) {
          return;
        }
                    /* WARNING: Subroutine does not return */
        __stack_chk_fail();
...
LAB_00103938:
      puVar2 = (undefined4 *)(*(long *)(lVar41 + 0xb0) + lVar33 * 0x18);
      switch(*puVar2) {
      case 0:
        CharString::get_data();
        StringBuilder::append((char *)pSVar45);
...
/* ShaderGLES3::_build_variant_code(StringBuilder&, unsigned int, ShaderGLES3::Version const*,
   ShaderGLES3::StageType, unsigned long) */

void __thiscall
ShaderGLES3::_build_variant_code
          (ShaderGLES3 *this,String *param_1,undefined8 param_3_00,long param_3,int param_5,
          ulong param_6)
...
LAB_00103369:
    do {
      if ((param_6 >> (uVar33 & 0x3f) & 1) != 0) {
        ...
        operator+((char *)&local_68,(String *)"#define ");
...
LAB_00103938:
  puVar2 = (undefined4 *)(*(long *)(this + (long)param_5 * 0x10 + 0xb0) + lVar32 * 0x18);
  switch(*puVar2) {
  case 0:
    CharString::get_data();
    StringBuilder::append((char *)param_1);
...
/* ShaderGLES3::version_is_valid(RID) */

undefined8 __thiscall ShaderGLES3::version_is_valid(ShaderGLES3 *this,ulong param_2)

{
  int iVar1;
  
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x54))) {
    iVar1 = *(int *)(((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x50)) * 0x80 +
                     *(long *)(*(long *)(this + 0x40) +
                              ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x50)) * 8) + 0x78);
...
void __thiscall ShaderGLES3::ShaderGLES3(ShaderGLES3 *this)

{
  undefined8 uVar1;
  undefined8 uVar2;
  
  *(undefined ***)this = &PTR___cxa_pure_virtual_0010fc88;
  ...
  *(undefined ***)(this + 0x38) = &PTR__RID_Alloc_0010fc68;
...
/* ShaderGLES3::set_shader_cache_dir(String const&) */

void ShaderGLES3::set_shader_cache_dir(String *param_1)
...
/* ShaderGLES3::set_shader_cache_save_compressed(bool) */

void ShaderGLES3::set_shader_cache_save_compressed(bool param_1)
...
/* ShaderGLES3::set_shader_cache_save_compressed_zstd(bool) */

void ShaderGLES3::set_shader_cache_save_compressed_zstd(bool param_1)
...
/* ShaderGLES3::set_shader_cache_save_debug(bool) */

void ShaderGLES3::set_shader_cache_save_debug(bool param_1)
...
/* ShaderGLES3::initialize(String const&, int) */

void __thiscall ShaderGLES3::initialize(ShaderGLES3 *this,String *param_1,int param_2)

{
  ...
  *(int *)(this + 0x124) = param_2;
  ...
  if (cVar5 == '\0') {
LAB_00104030:
    if (GLES3::Config::singleton == 0) {
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
        _err_print_error("initialize","drivers/gles3/shader_gles3.cpp",0x332,
                         "Parameter \"config\" is null.",0,0);
        return;
      }
      goto LAB_00104739;
    }
...
LAB_00104324:
      iVar6 = (*pcVar2)(local_d0,(CowData<char32_t> *)&local_a8);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_a8);
      if (iVar6 != 0) {
...
LAB_00104388:
        ...
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_a8);
        if (iVar6 != 0) {
          _err_print_error("initialize","drivers/gles3/shader_gles3.cpp",800,
...
LAB_001043ec:
        (*pcVar2)(local_d0,(CowData<char32_t> *)&local_a8);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_a8);
      }
      pcVar2 = *(code **)(*(long *)local_d0 + 0x1a8);
      local_a8 = (char *)0x0;
...
LAB_001044a6:
        ...
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_a8);
        if (iVar6 != 0) {
          _err_print_error("initialize","drivers/gles3/shader_gles3.cpp",0x32a,
                           "Condition \"err != OK\" is true.",0,0);
          goto LAB_00104686;
        }
      }
      ...
      if (cVar5 != '\0') {
        ...
        operator+((char *)local_c8,(String *)"Shader \'");
    ...
    _err_print_error("initialize","drivers/gles3/shader_gles3.cpp",0x31d,
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ShaderGLES3::_clear_version(ShaderGLES3::Version*) [clone .part.0] */

void __thiscall ShaderGLES3::_clear_version(ShaderGLES3 *this,Version *param_1)

{
  ...
  if (*(int *)(this + 0x120) < 1) {
LAB_0010484d:
    LocalVector<OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>,unsigned_int,false,false>
    ::resize((LocalVector<OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>,unsigned_int,false,false>
              *)(param_1 + 0x68),0);
    return;
  }
...
LAB_0010476c:
  ...
  _err_print_index_error
            ("operator[]","./core/templates/local_vector.h",0xb2,lVar6,uVar7,"p_index","count","",
             false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar1 = (code *)invalidInstructionException();
...
/* ShaderGLES3::_clear_version(ShaderGLES3::Version*) */
...
/* ShaderGLES3::_add_stage(char const*, ShaderGLES3::StageType) */

void __thiscall ShaderGLES3::_add_stage(ShaderGLES3 *this,char *param_1,int param_3)

{
  ...
  local_58 = param_1;
  String::parse_latin1((StrRange *)&local_78);
  String::split(local_108,SUB81((StrRange *)&local_78,0),0x10abeb);
...
LAB_001049e1:
        ...
        if (cVar9 != '\0') {
          ...
          *puVar2 = local_b8[0];
          StringName::StringName
                    ((StringName_conflict *)(puVar2 + 2),(StringName_conflict *)&local_b0);
          *(undefined8 *)(puVar2 + 4) = 0;
          if ((local_a8[0] != 0) &&
             (CowData<char>::_ref((CowData<char> *)(puVar2 + 4),(CowData *)local_a8),
             lVar6 = local_a8[0], local_a8[0] != 0)) {
            LOCK();
        ...
        *(undefined8 *)(puVar2 + 4) = 0;
        if ((local_88[0] != 0) &&
           (CowData<char>::_ref((CowData<char> *)(puVar2 + 4),(CowData *)local_88),
           lVar6 = local_88[0], local_88[0] != 0)) {
          LOCK();
...
LAB_001053b8:
        ...
        *(undefined8 *)(puVar2 + 4) = 0;
        if ((local_48 != 0) &&
           (CowData<char>::_ref((CowData<char> *)(puVar2 + 4),(CowData *)&local_48),
           lVar6 = local_48, local_48 != 0)) {
          LOCK();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ShaderGLES3::_setup(char const*, char const*, char const*, int, char const**, int,
   ShaderGLES3::UBOPair const*, int, ShaderGLES3::Feedback const*, int, ShaderGLES3::TexUnitPair
   const*, int, ShaderGLES3::Specialization const*, int, char const**) */

void __thiscall
ShaderGLES3::_setup(ShaderGLES3 *this,char *param_1,char *param_2,char *param_3,int param_4,
                   char **param_5,int param_6,UBOPair *param_7,int param_8,Feedback *param_9,
                   int param_10,TexUnitPair *param_11,int param_12,Specialization *param_13,
                   int param_14,char **param_15)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ShaderGLES3::_get_uniform_locations(ShaderGLES3::Version::Specialization&, ShaderGLES3::Version*)
    */

void __thiscall
ShaderGLES3::_get_uniform_locations(ShaderGLES3 *this,Specialization *param_1,Version *param_2)
...
LAB_00105e31:
  ...
  if (0 < (int)uVar12) {
    do {
      uVar5 = (*_glad_glGetUniformLocation)
                        (*(undefined4 *)param_1,
                         *(undefined8 *)(*(long *)(this + 200) + local_c0 * 8));
  ...
  if (0 < *(int *)(this + 0x100)) {
    do {
      while( true ) {
        iVar6 = (*_glad_glGetUniformLocation)
                          (*(undefined4 *)param_1,
                           *(undefined8 *)(*(long *)(this + 0xf8) + lVar11 * 0x10));
        if (-1 < iVar6) break;
LAB_00105e5a:
        lVar11 = lVar11 + 1;
...
LAB_00105eb8:
  ...
  if (0 < *(int *)(this + 0xe0)) {
    do {
      iVar6 = (*_glad_glGetUniformBlockIndex)
                        (*(undefined4 *)param_1,
                         *(undefined8 *)(*(long *)(this + 0xd8) + lVar11 * 0x10));
      if (-1 < iVar6) {
        (*_glad_glUniformBlockBinding)
                  (*(undefined4 *)param_1,iVar6,
                   *(undefined4 *)(*(long *)(this + 0xd8) + 8 + lVar11 * 0x10));
      }
      lVar11 = lVar11 + 1;
...
LAB_00105fb4:
      ...
      operator+((char *)&local_60,(String *)&_LC91);
      pcVar3 = local_58;
      if (local_58 != (char *)0x0) {
        LOCK();
        plVar1 = (long *)(local_58 + -0x10);
...
LAB_00105dff:
        _err_print_index_error
                  ("operator[]","./core/templates/local_vector.h",0xb2,local_c0,(ulong)uVar12,
...
LAB_0010635f:
        ...
        do {
          ...
          if (iVar7 == 0) {
            ...
            _err_print_index_error
                      ("set","./core/templates/cowdata.h",0xcf,lVar15,lVar11,"p_index","size()","",
                       false,false);
          }
          else {
...
/* ShaderGLES3::version_free(RID) */

undefined8 __thiscall ShaderGLES3::version_free(ShaderGLES3 *this,ulong param_2)

{
  ...
  if (iVar5 == 0) {
    uVar7 = (uint)param_2;
    if (((*(uint *)(this + 0x54) <= uVar7) || (param_2 >> 0x20 == 0x7fffffff)) ||
       (uVar6 = (uint)(param_2 >> 0x20),
       uVar6 != (*(uint *)(((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x50)) * 0x80 +
                           *(long *)(*(long *)(this + 0x40) +
                                    ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x50)) * 8) +
                          0x78) & 0x7fffffff))) {
      pthread_mutex_unlock(__mutex);
      return 0;
    }
    pthread_mutex_unlock(__mutex);
    if ((param_2 == 0) || (*(uint *)(this + 0x54) <= uVar7)) goto LAB_0010b732;
    pVVar8 = (Version *)
             (((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x50)) * 0x80 +
             *(long *)(*(long *)(this + 0x40) +
                      ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x50)) * 8));
    ...
    if (uVar6 != uVar1) {
      if (uVar1 + 0x80000000 < 0x7fffffff) {
        _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                         "Method/function failed. Returning: nullptr",
                         "Attempting to use an uninitialized RID",0,0,pVVar8);
      }
      goto LAB_0010b732;
    }
    ...
    if (iVar5 == 0) {
      if (uVar7 < *(uint *)(this + 0x54)) {
        ...
        if ((int)uVar6 < 0) {
          pthread_mutex_unlock(__mutex);
          _err_print_error(&_LC98,"./core/templates/rid_owner.h",0x16c,"Method/function failed.",
          ...
          *(uint *)(*(long *)(lVar2 + ((ulong)uVar6 / (ulong)*(uint *)(this + 0x50)) * 8) +
                   ((ulong)uVar6 % (ulong)*(uint *)(this + 0x50)) * 4) = uVar7;
          pthread_mutex_unlock(__mutex);
        }
        else {
          pthread_mutex_unlock(__mutex);
...

{
  ...
  *(undefined ***)this = &PTR___cxa_pure_virtual_0010fc88;
  ...
  if (*(int *)(this + 0x54) == 0) {
    ...
    do {
      uVar4 = *(uint *)((uVar12 % (ulong)*(uint *)(this + 0x50)) * 0x80 +
                        *(long *)(*(long *)(this + 0x40) + (uVar12 / *(uint *)(this + 0x50)) * 8) +
                       0x78);
      if (uVar4 != 0xffffffff) {
    ...
    if (pauVar8 != (undefined1 (*) [16])0x0) {
      if (*(int *)pauVar8[1] == 0) {
LAB_00106704:
        if (pauVar8 == (undefined1 (*) [16])0x0) goto LAB_00106766;
        do {
          while( true ) {
            pvVar7 = *(void **)*pauVar8;
            if (pvVar7 == (void *)0x0) {
...
LAB_00106766:
  pCVar13 = (CowData<char32_t> *)(this + 0xb8);
...
LAB_001069a4:
    if ((uint)uVar12 < uVar4) goto LAB_001069ea;
    lVar11 = 0;
    while( true ) {
    ...
    vformat<unsigned_int,char_const*>
              ((String *)&local_58,(uint)(StrRange *)&local_60,(char *)(ulong)uVar4);
...
/* ShaderGLES3::_version_get_sha1(ShaderGLES3::Version*) const */

Version * ShaderGLES3::_version_get_sha1(Version *param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ShaderGLES3::_save_to_cache(ShaderGLES3::Version*) */

void __thiscall ShaderGLES3::_save_to_cache(ShaderGLES3 *this,Version *param_1)

{
  ...
  if (this[0xa0] == (ShaderGLES3)0x0) {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error("_save_to_cache","drivers/gles3/shader_gles3.cpp",0x280,
    ...
    if (((char)RasterizerGLES3::gles_over_gl == '\0') || (_glad_glGetProgramBinary != (code *)0x0))
    {
      ...
      if (local_60 == (Object *)0x0) {
        _err_print_error("_save_to_cache","drivers/gles3/shader_gles3.cpp",0x28b,
...
LAB_001079c7:
          ...
          if (uVar8 < (uint)uVar15) {
            lVar16 = lVar9 * 0x20;
            (**(code **)(*(long *)local_60 + 0x278))
                      (local_60,*(undefined4 *)(*(long *)(param_1 + 0x70) + 0x1c + lVar16));
            uVar15 = (ulong)*(uint *)(param_1 + 0x68);
...
LAB_00107a76:
                  ...
                  CowData<unsigned_char>::resize<false>
                            ((CowData<unsigned_char> *)local_50,(long)local_70[0]);
                  ...
                  (**(code **)(*(long *)local_60 + 0x2d0))
                            (local_60,lVar5,*(undefined8 *)(lVar5 + -8));
                  LOCK();
                  plVar10 = (long *)(lVar5 + -0x10);
                  *plVar10 = *plVar10 + -1;
                  UNLOCK();
...
LAB_00107bb6:
          ...
          _err_print_index_error
                    ("operator[]","./core/templates/local_vector.h",0xb2,lVar9,uVar15,"p_index",
                     "count","",false,true);
          _err_flush_stdout();
                    /* WARNING: Does not return */
          pcVar3 = (code *)invalidInstructionException();
...
joined_r0x00107cd8:
      if (((local_60 != (Object *)0x0) &&
          (cVar7 = RefCounted::unreference(), pOVar4 = local_60, cVar7 != '\0')) &&
...
LAB_00107cba:
  lVar9 = lVar9 + 1;
  if (*(int *)(this + 0x120) <= (int)lVar9) goto joined_r0x00107cd8;
  goto LAB_001079c7;
}



/* Vector<char const*>::push_back(char const*) [clone .isra.0] */

void __thiscall Vector<char_const*>::push_back(Vector<char_const*> *this,char *param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ShaderGLES3::_load_from_cache(ShaderGLES3::Version*) */

undefined8 __thiscall ShaderGLES3::_load_from_cache(ShaderGLES3 *this,Version *param_1)
  ...
  if (local_e8 == (Object *)0x0) {
    ...
    if (cVar6 == '\0') {
      ...
      if (*(int *)(this + 0x120) != iVar7) {
        ...
        itos((long)local_e0);
        operator+((char *)&local_d8,(String *)"shader cache variant count mismatch, expected ");
        String::operator+((String *)local_b8,(String *)&local_d8);
        String::operator+((String *)local_88,(String *)local_b8);
        _err_print_error("_load_from_cache","drivers/gles3/shader_gles3.cpp",0x241,
                         "Condition \"cache_variant_count != variant_count\" is true. Returning: false"
                         ,(String *)local_88,0,0);
        CowData<char32_t>::_unref((CowData<char32_t> *)local_88);
        CowData<char32_t>::_unref((CowData<char32_t> *)local_b8);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_d8);
      ...
      if (iVar7 < 1) {
        ...
        do {
          ...
          *local_98 = 0;
          ...
          for (uVar16 = (ulong)(((int)local_98 -
                                (int)(undefined8 *)((ulong)(local_98 + 1) & 0xfffffffffffffff8)) +
                                0x100U >> 3); uVar16 != 0; uVar16 = uVar16 - 1) {
            *puVar14 = 0;
          ...
          if (iVar8 != 0) {
            do {
              ...
              if (uVar9 != 0) {
                ...
                local_c0 = 0;
                CowData<unsigned_char>::resize<false>
                          ((CowData<unsigned_char> *)&local_c0,(ulong)uVar9);
                pOVar4 = local_e8;
...
LAB_0010839c:
                    ...
                    do {
                      ...
                      if ((uVar16 == 0) || (((ulong)pSVar13 & uVar16) != 0)) {
                        Vector<char_const*>::push_back
                                  ((Vector<char_const*> *)local_b8,(char *)*puVar14);
                      }
                      lVar5 = local_b0;
                      lVar17 = lVar17 + 1;
                    } while ((int)lVar17 < *(int *)(this + 0xf0));
                    if (local_b0 == 0) goto LAB_0010838c;
                    (*_glad_glTransformFeedbackVaryings)
                              (uVar12,*(undefined4 *)(local_b0 + -8),local_b0,0x8c8c);
                    LOCK();
...
LAB_001084f0:
                  ...
                  if (local_b8[0] == 1) {
                    ...
                    OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                    ::_insert_with_hash((uint)(StrRange *)&local_a8,puVar19,pSVar13);
                  ...
                  if (_load_from_cache(ShaderGLES3::Version*)::first_print != '\0') {
                    _err_print_error("_load_from_cache","drivers/gles3/shader_gles3.cpp",0x26a,
                                     "Failed to load cached shader, recompiling.",0,1);
                    _load_from_cache(ShaderGLES3::Version*)::first_print = '\0';
                  }
                  Version::Specialization::~Specialization((Specialization *)local_88);
                  lVar18 = lVar17;
                }
                else {
                  _err_print_error("_load_from_cache","drivers/gles3/shader_gles3.cpp",0x253,
                                   "Condition \"br != variant_size\" is true. Returning: false",0,0)
                  ;
                }
                uVar23 = 0;
                if (lVar18 != 0) {
                ...
                OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                ::~OAHashMap((OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                              *)&local_a8);
                pvVar21 = local_d0;
                goto LAB_00108560;
              }
LAB_0010827a:
          ...
          OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
          ::operator=((OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                       *)local_88,(OAHashMap *)&local_a8);
          uVar16 = local_d8;
          iVar8 = (int)local_d8;
          ...
          pOVar20 = (OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                     *)((long)local_d0 + (uVar16 & 0xffffffff) * 0x20);
          *(undefined8 *)(pOVar20 + 0x10) = 0;
          *(undefined8 *)(pOVar20 + 0x18) = 0;
          *(undefined1 (*) [16])pOVar20 = (undefined1  [16])0x0;
          OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
          ::operator=(pOVar20,(OAHashMap *)local_88);
          OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
          ::~OAHashMap((OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                        *)local_88);
          OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
...
LAB_00108560:
        if ((pvVar21 != (void *)0x0) &&
           (LocalVector<OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>,unsigned_int,false,false>
            ::resize((LocalVector<OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>,unsigned_int,false,false>
                      *)&local_d8,0), local_d0 != (void *)0x0)) {
          Memory::free_static(local_d0,false);
        }
      }
    }
    else {
      _err_print_error("_load_from_cache","drivers/gles3/shader_gles3.cpp",0x239,
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ShaderGLES3::_compile_specialization(ShaderGLES3::Version::Specialization&, unsigned int,
   ShaderGLES3::Version*, unsigned long) */

void __thiscall
ShaderGLES3::_compile_specialization
          (ShaderGLES3 *this,Specialization *param_1,uint param_2,Version *param_3,ulong param_4)

{
  ...
  *(undefined4 *)(param_1 + 4) = uVar3;
  ...
  if (local_b0 == 0) {
    ...
    if (local_ac < 0) {
      ...
      *(undefined4 *)param_1 = 0;
      _err_print_error("_compile_specialization","drivers/gles3/shader_gles3.cpp",0x151,
                       "No OpenGL vertex shader compiler log.",0,0);
    }
    else {
      if (local_ac == 0) {
        local_ac = 0x1000;
    ...
    *(undefined4 *)(param_1 + 8) = uVar3;
    ...
    if (local_b0 != 0) {
        ...
        if (0 < *(int *)(this + 0xf0)) {
          ...
          if (local_70 != 0) {
            if (*(long *)(local_70 + -8) != 0) {
              (*_glad_glTransformFeedbackVaryings)
                        (*(undefined4 *)param_1,*(long *)(local_70 + -8),local_70,0x8c8c);
            }
            LOCK();
      ...
      if (local_b0 == 0) {
        ...
        if ((int)local_98 < 0) {
          ...
          (*_glad_glDeleteProgram)(*(undefined4 *)param_1);
          *(undefined4 *)param_1 = 0;
          _err_print_error("_compile_specialization","drivers/gles3/shader_gles3.cpp",0x1bb,
                           "No OpenGL program link log. Something is wrong.",0,0);
          _err_print_error("_compile_specialization","drivers/gles3/shader_gles3.cpp",0x1bc,
          ...
          (*_glad_glGetProgramInfoLog)
                    (*(undefined4 *)param_1,local_98 & 0xffffffff,&local_98,pcVar4);
          ...
          (*_glad_glDeleteProgram)(*(undefined4 *)param_1);
          *(undefined4 *)param_1 = 0;
          _err_print_error("_compile_specialization","drivers/gles3/shader_gles3.cpp",0x1d3,
                           "Method/function failed.",0,0);
          CowData<char32_t>::_unref((CowData<char32_t> *)&local_90);
        }
      }
    ...
    if (local_ac < 0) {
      ...
      (*_glad_glDeleteProgram)(*(undefined4 *)param_1);
      *(undefined4 *)param_1 = 0;
      _err_print_error("_compile_specialization","drivers/gles3/shader_gles3.cpp",0x181,
                       "No OpenGL fragment shader compiler log.",0,0);
    }
    else {
      if (local_ac == 0) {
        local_ac = 0x1000;
  ...
  _err_print_error("_compile_specialization","drivers/gles3/shader_gles3.cpp",uVar6,
                   "Method/function failed.",0,0);
  CowData<char>::_unref((CowData<char> *)&local_a0);
  CowData<char32_t>::_unref(local_a8);
  StringBuilder::~StringBuilder((StringBuilder *)&local_78);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ShaderGLES3::_initialize_version(ShaderGLES3::Version*) */

void __thiscall ShaderGLES3::_initialize_version(ShaderGLES3 *this,Version *param_1)

{
  ...
  *pOVar13;
  ...
  if (*(int *)(param_1 + 0x68) != 0) {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error("_initialize_version","drivers/gles3/shader_gles3.cpp",0x2c7,
                       "Condition \"p_version->variants.size() > 0\" is true.",0,0);
      return;
    }
    goto LAB_00109722;
  }
    ...
    if (0 < iVar8) {
      ...
      do {
        ...
        *local_88 = 0;
        ...
        for (uVar9 = (ulong)(((int)local_88 -
                             (int)(undefined8 *)((ulong)(local_88 + 1) & 0xfffffffffffffff8)) +
                             0x100U >> 3); uVar9 != 0; uVar9 = uVar9 - 1) {
          *puVar12 = 0;
        ...
        pOVar13 = (OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
        ...
        *(undefined1 (*) [16])pOVar13 = (undefined1  [16])0x0;
        OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
        ::operator=(pOVar13,(OAHashMap *)local_78);
        piVar4 = local_68;
        ...
        _compile_specialization
                  (this,(Specialization *)local_78,(uint)lVar10,param_1,*(ulong *)(this + 0x110));
        if (*(uint *)(param_1 + 0x68) <= (uint)lVar10) {
          _err_print_index_error
                    ("operator[]","./core/templates/local_vector.h",0xb2,lVar10,
                     (ulong)*(uint *)(param_1 + 0x68),"p_index","count","",false,true);
          _err_flush_stdout();
                    /* WARNING: Does not return */
          pcVar2 = (code *)invalidInstructionException();
          (*pcVar2)();
        ...
        pOVar13 = (OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                   *)(lVar10 * 0x20 + *(long *)(param_1 + 0x70));
        if ((double)*(uint *)(pOVar13 + 0x18) * __LC96 < (double)(*(int *)(pOVar13 + 0x1c) + 1)) {
          OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
          ::_resize_and_rehash(pOVar13,*(uint *)(pOVar13 + 0x18) * 2);
        }
        ...
        OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
        ::_insert_with_hash((uint)pOVar13,puVar11,*(Specialization **)(this + 0x110));
...
/* ShaderGLES3::version_get_native_source_code(RID) */

long ShaderGLES3::version_get_native_source_code(long param_1,ShaderGLES3 *param_2,ulong param_3)

{
  ...
  undefined8 *puVar5;
  Vector<RenderingServer::ShaderNativeSourceCode::Version::Stage> *pVVar6;
  undefined8 *puVar7;
  char *pcVar8;
  long lVar9;
  undefined8 *puVar10;
...
LAB_0010a140:
    *(undefined8 *)(param_1 + 8) = 0;
    ...
    lVar9 = ((param_3 & 0xffffffff) % (ulong)*(uint *)(param_2 + 0x50)) * 0x80 +
            *(long *)(*(long *)(param_2 + 0x40) +
                     ((param_3 & 0xffffffff) / (ulong)*(uint *)(param_2 + 0x50)) * 8);
    if (*(int *)(lVar9 + 0x78) == (int)(param_3 >> 0x20)) {
      lVar12 = (long)*(int *)(param_2 + 0x120);
      this = (CowData<RenderingServer::ShaderNativeSourceCode::Version> *)(param_1 + 8);
      *(undefined8 *)(param_1 + 8) = 0;
      if (lVar12 < 0) {
        uVar11 = 0x157;
        pcVar8 = "Condition \"p_size < 0\" is true. Returning: ERR_INVALID_PARAMETER";
LAB_0010a216:
        _err_print_error("resize","./core/templates/cowdata.h",uVar11,pcVar8,0,0);
        puVar10 = *(undefined8 **)(param_1 + 8);
        if (puVar10 == (undefined8 *)0x0) goto LAB_0010a170;
      }
      else {
        if (lVar12 == 0) goto LAB_0010a170;
        ...
        puVar5 = (undefined8 *)Memory::alloc_static((uVar13 | uVar13 >> 0x20) + 0x11,false);
        if (puVar5 == (undefined8 *)0x0) {
          uVar11 = 0x171;
        ...
        *(undefined8 **)(param_1 + 8) = puVar10;
        ...
        do {
          puVar7[1] = 0;
          puVar7 = puVar7 + 2;
        } while (puVar5 + lVar12 * 2 + 2 != puVar7);
        puVar5[1] = lVar12;
      }
      uVar13 = 0;
      do {
        ...
        local_50 = 0;
        local_48 = 0;
        _build_variant_code(param_2,(StringBuilder *)&local_78,uVar13 & 0xffffffff,lVar9,0,
        ...
        if ((char *)local_98._8_8_ == local_88) {
          if ((char *)local_98._8_8_ == (char *)0x0) goto LAB_00109ca8;
          LOCK();
          plVar1 = (long *)(local_98._8_8_ + -0x10);
          *plVar1 = *plVar1 + -1;
          UNLOCK();
          if (*plVar1 != 0) goto LAB_00109ca8;
          local_88 = (char *)0x0;
          Memory::free_static(pcVar8 + -0x10,false);
          lVar12 = *(long *)(param_1 + 8);
          if (lVar12 != 0) goto LAB_00109cb5;
LAB_0010a0e0:
          lVar12 = 0;
LAB_0010a0e3:
          _err_print_index_error
                    ("operator[]","./core/templates/vector.h",0x38,uVar13,lVar12,"p_index",
        ...
        if ((char *)local_98._8_8_ != (char *)0x0) {
          ...
          *plVar1 = *plVar1 + -1;
          ...
          if (*plVar1 == 0) {
            local_98._8_8_ = 0;
            Memory::free_static((char *)(uVar11 + -0x10),false);
          }
        }
        local_98._8_8_ = local_88;
LAB_00109ca8:
        lVar12 = *(long *)(param_1 + 8);
        if (lVar12 == 0) goto LAB_0010a0e0;
LAB_00109cb5:
        lVar12 = *(long *)(lVar12 + -8);
        if (lVar12 <= (long)uVar13) goto LAB_0010a0e3;
        CowData<RenderingServer::ShaderNativeSourceCode::Version>::_copy_on_write(this);
        local_88 = (char *)0x0;
        pVVar6 = (Vector<RenderingServer::ShaderNativeSourceCode::Version::Stage> *)
                 (*(long *)(param_1 + 8) + uVar13 * 0x10);
        if (local_98._0_8_ != 0) {
          CowData<char32_t>::_ref((CowData<char32_t> *)&local_88,(CowData *)local_98);
        }
        local_80 = 0;
        if (local_98._8_8_ == 0) {
          Vector<RenderingServer::ShaderNativeSourceCode::Version::Stage>::push_back(pVVar6);
        }
        else {
        ...
        local_50 = 0;
        local_48 = 0;
        _build_variant_code(param_2,(StringBuilder *)&local_78,(int)uVar13,lVar9,1,
                            *(undefined8 *)(param_2 + 0x110));
        local_98 = (undefined1  [16])0x0;
        local_88 = "fragment";
        local_80 = 8;
        ...
        if (*(long *)(param_1 + 8) == 0) goto LAB_0010a0e0;
        lVar12 = *(long *)(*(long *)(param_1 + 8) + -8);
        if (lVar12 <= (long)uVar13) goto LAB_0010a0e3;
        CowData<RenderingServer::ShaderNativeSourceCode::Version>::_copy_on_write(this);
        pVVar6 = (Vector<RenderingServer::ShaderNativeSourceCode::Version::Stage> *)
                 (uVar13 * 0x10 + *(long *)(param_1 + 8));
        local_88 = (char *)0x0;
        if (local_98._0_8_ != 0) {
          CowData<char32_t>::_ref((CowData<char32_t> *)&local_88,(CowData *)local_98);
        }
    ...
    if (0x7ffffffe < *(int *)(lVar9 + 0x78) + 0x80000000U) goto LAB_0010a140;
    _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                     "Method/function failed. Returning: nullptr",
                     "Attempting to use an uninitialized RID",0,0);
    *(undefined8 *)(param_1 + 8) = 0;
  }
  _err_print_error("version_get_native_source_code","drivers/gles3/shader_gles3.cpp",0x1de,
...
/* ShaderGLES3::version_set_code(RID, HashMap<String, String, HashMapHasherDefault,
   ...
   LocalVector<ShaderGLES3::TextureUniformData, unsigned int, false, false> const&, bool) */

void ShaderGLES3::version_set_code(ShaderGLES3 *param_1,ulong param_2,long param_3)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(param_1 + 0x54))) {
    pVVar8 = (Version *)
             (((param_2 & 0xffffffff) % (ulong)*(uint *)(param_1 + 0x50)) * 0x80 +
             *(long *)(*(long *)(param_1 + 0x40) +
                      ((param_2 & 0xffffffff) / (ulong)*(uint *)(param_1 + 0x50)) * 8));
    if (*(int *)(pVVar8 + 0x78) == (int)(param_2 >> 0x20)) {
      if (*(int *)(pVVar8 + 0x68) != 0) {
        _clear_version(param_1,pVVar8);
      }
      String::utf8();
      if (*(long *)(pVVar8 + 0x18) != local_48) {
        CowData<char>::_unref((CowData<char> *)(pVVar8 + 0x18));
        *(long *)(pVVar8 + 0x18) = local_48;
        local_48 = 0;
      }
      CowData<char>::_unref((CowData<char> *)&local_48);
      String::utf8();
      if (*(long *)(pVVar8 + 0x20) != local_48) {
        CowData<char>::_unref((CowData<char> *)(pVVar8 + 0x20));
        *(long *)(pVVar8 + 0x20) = local_48;
        local_48 = 0;
      }
      CowData<char>::_unref((CowData<char> *)&local_48);
      String::utf8();
      if (*(long *)(pVVar8 + 0x10) != local_48) {
        CowData<char>::_unref((CowData<char> *)(pVVar8 + 0x10));
        *(long *)(pVVar8 + 0x10) = local_48;
        local_48 = 0;
      }
      CowData<char>::_unref((CowData<char> *)&local_48);
      if ((*(long *)(pVVar8 + 0x30) != 0) && (*(int *)(pVVar8 + 0x54) != 0)) {
        lVar13 = 0;
        uVar7 = *(uint *)(hash_table_size_primes + (ulong)*(uint *)(pVVar8 + 0x50) * 4);
        if (uVar7 != 0) {
          do {
            if (*(int *)(*(long *)(pVVar8 + 0x38) + lVar13) != 0) {
              *(int *)(*(long *)(pVVar8 + 0x38) + lVar13) = 0;
              pvVar9 = *(void **)(*(long *)(pVVar8 + 0x30) + lVar13 * 2);
              if (*(long *)((long)pvVar9 + 0x18) != 0) {
                LOCK();
                plVar5 = (long *)(*(long *)((long)pvVar9 + 0x18) + -0x10);
                *plVar5 = *plVar5 + -1;
                UNLOCK();
                if (*plVar5 == 0) {
                  lVar11 = *(long *)((long)pvVar9 + 0x18);
              ...
              *(undefined8 *)(*(long *)(pVVar8 + 0x30) + lVar13 * 2) = 0;
            }
            lVar13 = lVar13 + 4;
          } while ((ulong)uVar7 * 4 - lVar13 != 0);
        }
        *(undefined4 *)(pVVar8 + 0x54) = 0;
        *(undefined1 (*) [16])(pVVar8 + 0x40) = (undefined1  [16])0x0;
      }
      ...
      if (uVar7 < uVar10) {
        ...
        uVar10 = uVar7;
        do {
          if ((StringName::configured != '\0') && (*(long *)(*(long *)(pVVar8 + 8) + lVar13) != 0))
          {
            StringName::unref();
          }
          uVar10 = uVar10 + 1;
          lVar13 = lVar13 + 0x10;
        } while (uVar10 < *(uint *)pVVar8);
LAB_0010a520:
        *(uint *)pVVar8 = uVar7;
        uVar7 = *in_stack_00000010;
      }
        ...
        uVar1 = uVar7 - 1;
        if (*(uint *)(pVVar8 + 4) < uVar7) {
          pvVar9 = *(void **)(pVVar8 + 8);
          uVar10 = uVar1 >> 1 | uVar1;
          uVar10 = uVar10 | uVar10 >> 2;
          uVar10 = uVar10 | uVar10 >> 4;
          uVar10 = uVar10 >> 8 | uVar10;
          uVar10 = (uVar10 >> 0x10 | uVar10) + 1;
          *(uint *)(pVVar8 + 4) = uVar10;
          lVar13 = Memory::realloc_static(pvVar9,(ulong)uVar10 << 4,false);
          *(long *)(pVVar8 + 8) = lVar13;
          if (lVar13 == 0) {
            LocalVector<ShaderGLES3::TextureUniformData,unsigned_int,false,false>::resize
                      ((uint)pvVar9);
            goto LAB_0010a9dd;
          }
          uVar10 = *(uint *)pVVar8;
          if (uVar7 <= uVar10) goto LAB_0010a520;
        }
        puVar6 = (undefined8 *)((ulong)uVar10 * 0x10 + *(long *)(pVVar8 + 8));
        puVar3 = (undefined8 *)
                 (*(long *)(pVVar8 + 8) + 0x10 + ((ulong)(uVar1 - uVar10) + (ulong)uVar10) * 0x10);
        do {
          *puVar6 = 0;
          if (puVar3 == puVar6 + 2) break;
          puVar6[2] = 0;
          puVar6 = puVar6 + 4;
        } while (puVar3 != puVar6);
        goto LAB_0010a520;
      ...
      if (uVar7 != 0) {
        do {
          lVar11 = lVar13 + 1;
          pSVar14 = (StringName_conflict *)(*(long *)(in_stack_00000010 + 2) + lVar13 * 0x10);
          this_01 = (StringName_conflict *)(lVar13 * 0x10 + *(long *)(pVVar8 + 8));
          StringName::operator=(this_01,pSVar14);
          *(undefined4 *)(this_01 + 8) = *(undefined4 *)(pSVar14 + 8);
          lVar13 = lVar11;
        } while ((uint)lVar11 < *in_stack_00000010);
      }
      for (puVar3 = *(undefined8 **)(param_3 + 0x18); puVar3 != (undefined8 *)0x0;
        ...
        plVar5 = (long *)HashMap<StringName,CharString,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,CharString>>>
                         ::operator[]((HashMap<StringName,CharString,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,CharString>>>
                                       *)(pVVar8 + 0x28),(StringName_conflict *)&local_50);
        lVar13 = *plVar5;
        if (lVar13 != local_48) {
          if (lVar13 != 0) {
            LOCK();
      ...
      this = (CowData<CharString> *)(pVVar8 + 0x60);
      if ((*(long *)(pVVar8 + 0x60) != 0) && (*(long *)(*(long *)(pVVar8 + 0x60) + -8) != 0)) {
        CowData<CharString>::_unref(this);
      }
      lVar13 = *(long *)(in_stack_00000008 + 8);
      for (lVar11 = 0; (lVar13 != 0 && (lVar11 < *(long *)(lVar13 + -8))); lVar11 = lVar11 + 1) {
        String::utf8();
        if (*(long *)(pVVar8 + 0x60) == 0) {
          lVar13 = 1;
        }
        else {
          lVar13 = *(long *)(*(long *)(pVVar8 + 0x60) + -8) + 1;
        }
        iVar4 = CowData<CharString>::resize<false>(this,lVar13);
        if (iVar4 == 0) {
          if (*(long *)(pVVar8 + 0x60) == 0) {
            lVar12 = -1;
            lVar13 = 0;
            ...
            lVar13 = *(long *)(*(long *)(pVVar8 + 0x60) + -8);
            lVar12 = lVar13 + -1;
            if (-1 < lVar12) {
              CowData<CharString>::_copy_on_write(this);
              this_00 = (CowData<char> *)(*(long *)(pVVar8 + 0x60) + lVar12 * 8);
          ...
          _err_print_index_error
                    ("set","./core/templates/cowdata.h",0xcf,lVar12,lVar13,"p_index","size()","",
                     false,false);
        }
        else {
          _err_print_error("push_back","./core/templates/vector.h",0x142,
...
LAB_0010a785:
    ...
    if (*(int *)(pVVar8 + 0x78) + 0x80000000U < 0x7fffffff) {
      _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                       "Method/function failed. Returning: nullptr",
                       "Attempting to use an uninitialized RID",0,0);
    }
  ...
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    _err_print_error("version_set_code","drivers/gles3/shader_gles3.cpp",0x2db,
                     "Parameter \"version\" is null.",0,0);
    return;
  }
LAB_0010a9dd:
...
/* ShaderGLES3::version_create() */

undefined8 __thiscall ShaderGLES3::version_create(ShaderGLES3 *this)

{
  ...
  if (*(int *)(this + 0x120) == 0) {
    uVar1 = 0;
    _err_print_error("version_create","drivers/gles3/shader_gles3.cpp",0x9c,
                     "Condition \"variant_count == 0\" is true. Returning: RID()",0,0);
  }
  else {
    local_98 = 0;
    ...
    uVar1 = RID_Alloc<ShaderGLES3::Version,true>::make_rid
                      ((RID_Alloc<ShaderGLES3::Version,true> *)(this + 0x38),(Version *)&local_98);
...
/* ShaderGLES3::version_free(RID) [clone .cold] */

void __thiscall ShaderGLES3::version_free(undefined8 param_1,undefined8 param_2)
...
/* OAHashMap<unsigned long, ShaderGLES3::Version::Specialization, HashMapHasherDefault,
   HashMapComparatorDefault<unsigned long> >::~OAHashMap() */
...
/* WARNING: Removing unreachable block (ram,0x0010bd8d) */
/* WARNING: Removing unreachable block (ram,0x0010bd99) */
...
/* LocalVector<OAHashMap<unsigned long, ShaderGLES3::Version::Specialization, HashMapHasherDefault,
   HashMapComparatorDefault<unsigned long> >, unsigned int, false, false>::resize(unsigned int) */
  ...
  if (param_1 < uVar11) {
    ...
    if (*(uint *)(this + 4) < param_1) {
      ...
      *(long *)(this + 8) = lVar10;
      ...
      uVar11 = *(uint *)this;
      if (param_1 <= uVar11) goto LAB_0010bed2;
    }
    uVar5 = _LC71;
...
/* WARNING: Removing unreachable block (ram,0x0010c305) */
/* WARNING: Removing unreachable block (ram,0x0010c311) */
...
LAB_0010c71a:
      ...
      while ((StringName::configured == '\0' || (*(long *)(lVar4 + uVar6 * 8) == 0))) {
        uVar6 = uVar6 + 1;
        if (*(ulong *)(lVar4 + -8) <= uVar6) goto LAB_0010c71a;
      }
      StringName::unref();
      uVar6 = uVar6 + 1;
      lVar4 = *(long *)this;
...
LAB_0010c6e7:
    ...
    lVar4 = puVar7[-1];
    if (param_1 <= lVar4) goto LAB_0010c79b;
  }
  else {
    if (lVar4 != 0) {
      uVar2 = _realloc(this,lVar8);
...
/* OAHashMap<unsigned long, ShaderGLES3::Version::Specialization, HashMapHasherDefault,
   HashMapComparatorDefault<unsigned long> >::_resize_and_rehash(unsigned int) */
...

{
  ...
  while( true ) {
    ...
    if (uVar6 != 0) break;
LAB_0010cf10:
    if ((double)uVar11 * __LC96 < (double)(*(int *)(this + 0x1c) + 1)) {
...
LAB_0010cec0:
  ...
  uVar12 = 0;
LAB_0010ce19:
  if (((uint)puVar13 != uVar6) || (pSVar16 != *(Specialization **)(*(long *)(this + 8) + uVar8 * 8))
     ) goto LAB_0010cde0;
...
LAB_0010cde0:
  ...
  uVar6 = *(uint *)(*(long *)(this + 0x10) + uVar8 * 4);
  if ((uVar6 == 0) || (((uVar15 + (int)uVar8) - uVar6 % uVar15) % uVar15 < uVar12))
  goto LAB_0010cf10;
  goto LAB_0010ce19;
}
...
/* ShaderGLES3::Version::~Version() */

void __thiscall ShaderGLES3::Version::~Version(Version *this)
  ...
  if (pvVar4 != (void *)0x0) {
    if (*(int *)(this + 0x54) != 0) {
      ...
      if (uVar2 == 0) {
        ...
        *(undefined4 *)(this + 0x54) = 0;
        *(undefined1 (*) [16])(this + 0x40) = (undefined1  [16])0x0;
        if (pvVar4 == (void *)0x0) goto LAB_0010d31d;
      }
    }
    Memory::free_static(pvVar4,false);
...
/* RID_Alloc<ShaderGLES3::Version, true>::~RID_Alloc() */

void __thiscall
RID_Alloc<ShaderGLES3::Version,true>::~RID_Alloc(RID_Alloc<ShaderGLES3::Version,true> *this)

{
  ...
  *(undefined ***)this = &PTR__RID_Alloc_0010fc68;
...
LAB_0010d5d3:
    if ((uint)uVar4 < uVar8) goto LAB_0010d61b;
    lVar7 = 0;
    while( true ) {
...

{
  ...
  *(undefined ***)this = &PTR__RID_Alloc_0010fc68;
  ...
  if (uVar8 == 0) {
    ...
    puVar5 = *(undefined8 **)(this + 8);
LAB_0010d813:
    if ((uint)uVar4 < uVar8) goto LAB_0010d85b;
    lVar7 = 0;
    while( true ) {
      Memory::free_static((void *)puVar5[lVar7],false);
      lVar2 = lVar7 * 8;
...
/* CowData<RenderingServer::ShaderNativeSourceCode::Version>::_realloc(long) */

undefined8 __thiscall
CowData<RenderingServer::ShaderNativeSourceCode::Version>::_realloc
          (CowData<RenderingServer::ShaderNativeSourceCode::Version> *this,long param_1)
...
LAB_0010ddb5:
    ...
    iVar33 = *(int *)(this + 0x2c);
    if (__s_00 == (void *)0x0) goto LAB_0010decc;
    if (*(int *)(this + 0x2c) != 0) goto LAB_0010ddb5;
LAB_0010deee:
    ...
    if (*(int *)(this + 0x2c) != 0) {
      ...
      if (lVar30 == 0) goto LAB_0010e140;
      goto LAB_0010dda9;
    }
    local_70 = 0;
    iVar33 = 0;
LAB_0010decc:
    if ((float)uVar37 * __LC111 < (float)(iVar33 + 1)) goto LAB_0010deee;
  }
  local_68 = (undefined1  [16])0x0;
  ...
  *puVar29 = local_68._0_8_;
  ...
  StringName::StringName((StringName_conflict *)(puVar29 + 2),(StringName_conflict *)&local_58);
  puVar29[3] = 0;
  if (local_50[0] != 0) {
    CowData<char>::_ref((CowData<char> *)(puVar29 + 3),(CowData *)local_50);
  }
  local_80 = puVar29 + 3;
  CowData<char>::_unref((CowData<char> *)local_50);
...
/* CowData<char const*>::_realloc(long) */

undefined8 __thiscall CowData<char_const*>::_realloc(CowData<char_const*> *this,long param_1)
...
/* CowData<RenderingServer::ShaderNativeSourceCode::Version::Stage>::_realloc(long) */

undefined8 __thiscall
CowData<RenderingServer::ShaderNativeSourceCode::Version::Stage>::_realloc
...
LAB_0010ea96:
    ...
    lVar7 = puVar8[-1];
    if (param_1 <= lVar7) goto LAB_0010e8cc;
  }
  else {
    if (lVar7 != 0) {
      uVar6 = _realloc(this,lVar11);
...
LAB_0010ec59:
      ...
      while( true ) {
        ...
        if (*plVar2 != 0) break;
        uVar8 = uVar8 + 1;
        if (*(ulong *)(lVar6 + -8) <= uVar8) goto LAB_0010ec59;
      }
      LOCK();
      plVar1 = (long *)(*plVar2 + -0x10);
      *plVar1 = *plVar1 + -1;
...
LAB_0010edd6:
    ...
    lVar6 = puVar9[-1];
    if (param_1 <= lVar6) goto LAB_0010ecea;
  }
  else {
    if (lVar6 != 0) {
      uVar4 = _realloc(this,lVar10);
...

{
  ...
  if (*(long *)(param_2 + 8) == 0) {
    ...
    *(void **)(param_2 + 8) = __s_00;
    ...
    if (__s_00 == (void *)0x0) goto LAB_0010ef49;
    if (*(int *)(param_2 + 0x2c) != 0) goto LAB_0010ee3e;
LAB_0010ef6b:
...
LAB_0010ef49:
    if ((float)uVar23 * __LC111 < (float)(iVar28 + 1)) goto LAB_0010ef6b;
  }
...
/* RID_Alloc<ShaderGLES3::Version, true>::initialize_rid(RID, ShaderGLES3::Version const&) */

void __thiscall
RID_Alloc<ShaderGLES3::Version,true>::initialize_rid
          (RID_Alloc<ShaderGLES3::Version,true> *this,ulong param_2,uint *param_3)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x1c))) {
    puVar8 = (uint *)(((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x18)) * 0x80 +
                     *(long *)(*(long *)(this + 8) +
                              ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x18)) * 8));
    if ((int)puVar8[0x1e] < 0) {
      uVar2 = (uint)(param_2 >> 0x20);
      if (uVar2 == (puVar8[0x1e] & 0x7fffffff)) {
        uVar1 = *param_3;
        puVar8[0x1e] = uVar2;
        puVar8[0] = 0;
        puVar8[1] = 0;
        ...
        if (uVar1 != 0) {
          ...
          *(long *)(puVar8 + 2) = lVar3;
          if (lVar3 == 0) {
            LocalVector<ShaderGLES3::TextureUniformData,unsigned_int,false,false>::resize(uVar7);
            goto LAB_0010f7b4;
          }
          uVar2 = *puVar8;
          if (uVar2 < uVar1) {
            puVar4 = (undefined8 *)((ulong)uVar2 * 0x10 + lVar3);
            do {
              *puVar4 = 0;
              puVar4 = puVar4 + 2;
            } while ((undefined8 *)(((ulong)uVar2 + 1 + (ulong)(uVar9 - uVar2)) * 0x10 + lVar3) !=
                     puVar4);
          }
          *puVar8 = uVar1;
          if (*param_3 != 0) {
            lVar6 = 0;
            while( true ) {
              pSVar10 = (StringName_conflict *)(*(long *)(param_3 + 2) + lVar6 * 0x10);
              this_00 = (StringName_conflict *)(lVar6 * 0x10 + lVar3);
              StringName::operator=(this_00,pSVar10);
              *(undefined4 *)(this_00 + 8) = *(undefined4 *)(pSVar10 + 8);
              if (*param_3 <= (uint)(lVar6 + 1)) break;
              lVar3 = *(long *)(puVar8 + 2);
              lVar6 = lVar6 + 1;
            }
          }
        ...
        puVar8[5] = 0;
        if (*(long *)(param_3 + 4) != 0) {
          CowData<char>::_ref((CowData<char> *)(puVar8 + 4),(CowData *)(param_3 + 4));
        }
        puVar8[6] = 0;
        puVar8[7] = 0;
        if (*(long *)(param_3 + 6) != 0) {
          CowData<char>::_ref((CowData<char> *)(puVar8 + 6),(CowData *)(param_3 + 6));
        }
        puVar8[8] = 0;
        puVar8[9] = 0;
        if (*(long *)(param_3 + 8) != 0) {
          CowData<char>::_ref((CowData<char> *)(puVar8 + 8),(CowData *)(param_3 + 8));
        }
        uVar2 = param_3[0x14];
        puVar8[0x14] = 0;
        puVar8[0x15] = 0;
...
LAB_0010f520:
        if ((param_3[0x15] != 0) && (plVar5 = *(long **)(param_3 + 0x10), plVar5 != (long *)0x0)) {
          do {
            HashMap<StringName,CharString,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,CharString>>>
            ::insert(aSStack_38,(CharString *)(puVar8 + 10),(bool)((char)plVar5 + '\x10'));
            plVar5 = (long *)*plVar5;
        ...
        if (*(long *)(param_3 + 0x18) != 0) {
          CowData<CharString>::_unref((CowData<CharString> *)(puVar8 + 0x18));
          if (*(long *)(param_3 + 0x18) != 0) {
            plVar5 = (long *)(*(long *)(param_3 + 0x18) + -0x10);
            do {
              lVar3 = *plVar5;
              if (lVar3 == 0) goto LAB_0010f5a7;
              LOCK();
              lVar6 = *plVar5;
              bVar11 = lVar3 == lVar6;
              if (bVar11) {
...
LAB_0010f5a7:
        ...
        if (param_3[0x1a] != 0) {
          do {
            ...
            OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
            ::operator=((OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                         *)(lVar3 * 0x20 + *(long *)(puVar8 + 0x1c)),
                        (OAHashMap *)(*(long *)(param_3 + 0x1c) + lVar3 * 0x20));
            lVar3 = lVar6;
          } while ((uint)lVar6 < param_3[0x1a]);
        }
        if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
          return;
        }
...
/* RID_Alloc<ShaderGLES3::Version, true>::make_rid(ShaderGLES3::Version const&) */

ulong __thiscall
RID_Alloc<ShaderGLES3::Version,true>::make_rid
          (RID_Alloc<ShaderGLES3::Version,true> *this,Version *param_1)

{
  ...
  uVar1 = *(uint *)(this + 0x18);
  uVar6 = *(uint *)(*(long *)(*(long *)(this + 0x10) + ((ulong)uVar6 / (ulong)uVar1) * 8) +
                   ((ulong)uVar6 % (ulong)uVar1) * 4);
  LOCK();
  UNLOCK();
  ...
  RID_AllocBase::base_id = RID_AllocBase::base_id + 1;
  *(uint *)(((ulong)uVar6 % (ulong)uVar1) * 0x80 +
            *(long *)(*(long *)(this + 8) + ((ulong)uVar6 / (ulong)uVar1) * 8) + 0x78) =
       uVar10 | 0x80000000;
...
void ShaderGLES3::_GLOBAL__sub_I__add_stage(void)

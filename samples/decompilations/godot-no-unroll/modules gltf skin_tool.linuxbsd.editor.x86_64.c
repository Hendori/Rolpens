...
/* DisjointSet<int, HashMapHasherDefault, HashMapComparatorDefault<int>,
   ...
   HashMapComparatorDefault<int>, DefaultAllocator>::Element*) [clone .isra.0] */

Element * DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::
          get_parent(Element *param_1)
...
/* Ref<Skin>::TEMPNAMEPLACEHOLDERVALUE(Ref<Skin> const&) [clone .isra.0] */

void __thiscall Ref<Skin>::operator=(Ref<Skin> *this,Ref *param_1)
...
/* Ref<GLTFSkeleton>::TEMPNAMEPLACEHOLDERVALUE(Ref<GLTFSkeleton> const&) [clone .isra.0] */

void __thiscall Ref<GLTFSkeleton>::operator=(Ref<GLTFSkeleton> *this,Ref *param_1)
...
/* SkinTool::_find_highest_node(Vector<Ref<GLTFNode> >&, Vector<int> const&) */

int SkinTool::_find_highest_node(Vector *param_1,Vector *param_2)
...
LAB_00100af9:
      ...
      if ((pOVar6 != (Object *)0x0) &&
         (cVar3 = RefCounted::reference(), local_40 = pOVar6, cVar3 == '\0')) {
        pOVar6 = (Object *)0x0;
        local_40 = pOVar6;
      }
...
/* SkinTool::_skins_are_same(Ref<Skin>, Ref<Skin>) */

undefined8 SkinTool::_skins_are_same(long *param_1,long *param_2)
...
LAB_00100bf8:
          StringName::StringName((StringName *)&local_b0,(StringName *)(piVar12 + 2));
        }
        else {
          _err_print_index_error
                    ("get_bind_bone","./scene/resources/3d/skin.h",0x46,lVar11,(long)iVar2,"p_index"
                     ,"bind_count","",false,false);
          ...
          _err_print_index_error
                    ("get_bind_name","./scene/resources/3d/skin.h",0x4b,lVar11,(long)iVar2,"p_index"
                     ,"bind_count","",false,false);
          local_b0 = 0;
        }
        ...
        if (iVar10 < iVar2) {
          StringName::StringName
                    ((StringName *)&local_b8,(StringName *)(*(long *)(*param_1 + 0x250) + 8 + lVar9)
                    );
          lVar6 = local_b8;
          local_c8 = local_b0;
...
LAB_00100c64:
        ...
        if (iVar10 < iVar2) {
          ...
          _err_print_index_error
                    ("get_bind_pose","./scene/resources/3d/skin.h",0x50,lVar11,(long)iVar2,"p_index"
                     ,"bind_count","",false,false);
          local_88 = 0x3f800000;
          uStack_84 = 0;
          uStack_80 = 0;
...
HashSet * SkinTool::_gen_unique_name(HashSet *param_1,String *param_2)
...
/* SkinTool::_sanitize_bone_name(String const&) */

SkinTool * __thiscall SkinTool::_sanitize_bone_name(SkinTool *this,String *param_1)
...
LAB_00101378:
  ...
  if (local_90 != 1) {
    itos((long)&local_60);
    operator+((char *)local_78,(String *)&_LC31);
      ...
      do {
        if (uVar14 == uVar15) {
          cVar13 = String::operator==((String *)
                                      (*(long *)param_1 +
                                      (ulong)*(uint *)(*(long *)(param_1 + 8) + lVar18 * 4) * 8),
                                      (String *)this);
        ...
        iVar16 = SUB164(auVar4 * auVar8,8);
        if ((uVar14 == 0) ||
           (auVar5._8_8_ = 0, auVar5._0_8_ = (ulong)uVar14 * lVar17, auVar9._8_8_ = 0,
           auVar9._0_8_ = uVar11, auVar6._8_8_ = 0,
           auVar6._0_8_ = (ulong)((uVar2 + iVar16) - SUB164(auVar5 * auVar9,8)) * lVar17,
           auVar10._8_8_ = 0, auVar10._0_8_ = uVar11, SUB164(auVar6 * auVar10,8) < uVar20)) break;
      } while( true );
    }
  }
...
/* SkinTool::_capture_nodes_in_skin(Vector<Ref<GLTFNode> > const&, Ref<GLTFSkin>, int) */

ulong SkinTool::_capture_nodes_in_skin(long param_1,long *param_2,uint param_3)
...
LAB_00101929:
    lVar12 = *(long *)(lVar12 + 0x270);
    if (((lVar12 != 0) && (lVar7 = *(long *)(lVar12 + -8), lVar7 != 0)) && (0 < lVar7)) {
      lVar6 = 0;
      do {
...
/* SkinTool::_capture_nodes_for_multirooted_skin(Vector<Ref<GLTFNode> >&, Ref<GLTFSkin>) */

void SkinTool::_capture_nodes_for_multirooted_skin(long param_1,long *param_2)
  ...
  if (lVar20 != 0) {
    for (; local_c0 < *(long *)(lVar20 + -8); local_c0 = local_c0 + 1) {
      ...
      if ((local_70._0_8_ != 0) && (local_50._4_4_ != 0)) {
        ...
        if (uVar13 != 0) {
          uVar13 = 0;
          while (((uint)uVar19 != uVar24 ||
                 (uVar21 != *(uint *)(*(long *)(local_70._0_8_ + lVar20 * 8) + 0x10)))) {
            uVar13 = uVar13 + 1;
            auVar4._8_8_ = 0;
            ...
            if ((uVar1 == 0) ||
               (auVar5._8_8_ = 0, auVar5._0_8_ = uVar19 * uVar2, auVar9._8_8_ = 0,
               auVar9._0_8_ = uVar25, auVar6._8_8_ = 0,
               auVar6._0_8_ = ((*(uint *)(hash_table_size_primes + (local_50 & 0xffffffff) * 4) +
                               uVar18) - SUB164(auVar5 * auVar9,8)) * uVar2, auVar10._8_8_ = 0,
               auVar10._0_8_ = uVar25, SUB164(auVar6 * auVar10,8) < uVar13)) goto LAB_00101cd8;
          }
...
LAB_00101cd8:
      local_90 = (uint *)operator_new(0x18,DefaultAllocator::alloc);
      *local_90 = uVar21;
      local_90[4] = 0;
      *(uint **)(local_90 + 2) = local_90;
      HashMap<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*>>>
      ::insert((int *)local_88,(Element **)local_78,SUB81(&local_94,0));
      lVar22 = *param_2;
      lVar20 = *(long *)(lVar22 + 0x270);
joined_r0x00101c77:
      if (lVar20 == 0) break;
      if (0 < *(long *)(lVar20 + -8)) {
        ...
        do {
          if (iVar26 == *(int *)(lVar20 + lVar16 * 4)) {
            ...
            create_union(local_78,iVar26,uVar21);
            local_c0 = local_c0 + 1;
            lVar22 = *param_2;
            lVar20 = *(long *)(lVar22 + 0x270);
  ...
  local_80 = (int *)0x0;
  DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::
  get_representatives(local_78,local_88);
  if ((local_80 == (int *)0x0) || (lVar20 = *(long *)(local_80 + -2), lVar20 < 2)) {
LAB_00101f19:
    CowData<int>::_unref((CowData<int> *)&local_80);
    DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::
    ~DisjointSet(local_78);
    if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
      __stack_chk_fail();
    }
...
LAB_00101db3:
          iVar26 = *(int *)(*(long *)(lVar22 + lVar16 * 8) + 0x24c);
          goto LAB_00101dbe;
        }
      }
LAB_00101f76:
...
LAB_00101e00:
      do {
        ...
        do {
          ...
          lVar17 = *param_2;
          if ((*(char *)(*(long *)(lVar20 + lVar16 * 8) + 0x290) != '\0') &&
             (uVar13 = uVar21,
             lVar15 = CowData<int>::find(*(CowData<int> **)(lVar17 + 0x270),(int *)(ulong)uVar21,0),
             lVar15 == -1)) {
...
LAB_00102002:
  ...
  while (piVar23 != (int *)0x0) {
    ...
    while (lVar14 != lVar15) {
      ...
      lVar15 = lVar15 + 1;
      if ((lVar16 < 0) || (lVar22 <= lVar16)) goto LAB_00101edc;
      bVar12 = (bool)(bVar12 & *(int *)(*(long *)(lVar20 + lVar16 * 8) + 0x248) ==
                               *(int *)(*(long *)(lVar20 + lVar17) + 0x248));
    }
    ...
    while( true ) {
      ...
      if ((*(char *)(*(long *)(lVar20 + lVar16 * 8) + 0x290) == '\0') ||
         (uVar13 = uVar21,
         lVar20 = CowData<int>::find(*(CowData<int> **)(lVar22 + 0x270),(int *)(ulong)uVar21,0),
         lVar20 != -1)) {
        uVar13 = uVar21;
...
LAB_0010204e:
          _err_print_index_error
                    ("operator[]","./core/templates/vector.h",0x38,lVar14,lVar20,"p_index",
...
LAB_00101edc:
  _err_print_index_error
            ("get","./core/templates/cowdata.h",0xdb,lVar16,lVar22,"p_index","size()","",false,true)
  ;
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar11 = (code *)invalidInstructionException();
...
undefined8 SkinTool::_reparent_non_joint_skeleton_subtrees(long param_1,long *param_2,long param_3)
    ...
    do {
      ...
      if ((local_70._0_8_ != 0) && (local_50._4_4_ != 0)) {
        ...
        if (uVar15 != 0) {
          uVar23 = 0;
          while ((uVar24 != uVar15 ||
                 (uVar1 != *(uint *)(*(long *)(local_70._0_8_ + lVar19 * 8) + 0x10)))) {
            uVar23 = uVar23 + 1;
            auVar6._8_8_ = 0;
            ...
            if ((uVar15 == 0) ||
               (auVar7._8_8_ = 0, auVar7._0_8_ = uVar15 * uVar3, auVar11._8_8_ = 0,
               auVar11._0_8_ = uVar25, auVar8._8_8_ = 0,
               auVar8._0_8_ = ((*(uint *)(hash_table_size_primes + (local_50 & 0xffffffff) * 4) +
                               uVar17) - SUB164(auVar7 * auVar11,8)) * uVar3, auVar12._8_8_ = 0,
               auVar12._0_8_ = uVar25, SUB164(auVar8 * auVar12,8) < uVar23)) goto LAB_00102430;
          }
...
LAB_00102430:
      local_98 = (uint *)operator_new(0x18,DefaultAllocator::alloc);
      *local_98 = uVar1;
      local_98[4] = 0;
      *(uint **)(local_98 + 2) = local_98;
      HashMap<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*>>>
      ::insert((int *)local_88,(Element **)local_78,SUB81(&local_9c,0));
      lVar4 = *(long *)(param_1 + 8);
joined_r0x001023b1:
      if ((int)uVar1 < 0) {
...
LAB_001024ab:
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,lVar16,lVar22,"p_index","size()","",false
                   ,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
          ...
          do {
            if (iVar2 == *(int *)(lVar19 + lVar16 * 4)) {
              ...
              if (*(char *)(*(long *)(lVar4 + lVar16 * 8) + 0x290) == '\0') {
                DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>
                ::create_union(local_78,iVar2,uVar1);
                lVar19 = *(long *)(param_3 + 8);
                goto LAB_001024e5;
              }
              break;
...
LAB_001024e5:
  ...
  local_90 = 0;
  DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::
  get_representatives(local_78,(Vector *)&local_98);
  lVar21 = local_90;
  if (local_90 != 0) {
    for (local_c0 = 0; local_c0 < *(long *)(lVar21 + -8); local_c0 = local_c0 + 1) {
      ...
      local_80 = 0;
      DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::
      get_members(local_78,local_88,*(int *)(lVar21 + local_c0 * 4));
      lVar4 = local_80;
...
/* SkinTool::_expand_skin(Vector<Ref<GLTFNode> >&, Ref<GLTFSkin>) */

undefined8 SkinTool::_expand_skin(Vector *param_1,long *param_2)

{
  ...
  if ((pOVar3 == (Object *)0x0) ||
     (local_78 = pOVar3, cVar14 = RefCounted::reference(), cVar14 == '\0')) {
    local_78 = (Object *)0x0;
  ...
  local_f0 = (DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator> *
             )&local_78;
  local_50 = 2;
  local_b0 = 0;
  local_70 = (undefined1  [16])0x0;
...
LAB_00102a41:
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,lVar17,lVar22,"p_index","size()","",false
                   ,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar13 = (code *)invalidInstructionException();
      ...
      if ((local_70._0_8_ != 0) && (local_50._4_4_ != 0)) {
        ...
        if (uVar15 != 0) {
          uVar15 = 0;
          while ((uVar24 != (uint)uVar19 ||
                 (uVar1 != *(uint *)(*(long *)(local_70._0_8_ + lVar20 * 8) + 0x10)))) {
            uVar15 = uVar15 + 1;
            auVar6._8_8_ = 0;
            ...
            if ((uVar2 == 0) ||
               (auVar7._8_8_ = 0, auVar7._0_8_ = uVar19 * uVar4, auVar11._8_8_ = 0,
               auVar11._0_8_ = uVar26, auVar8._8_8_ = 0,
               auVar8._0_8_ = ((*(uint *)(hash_table_size_primes + (local_50 & 0xffffffff) * 4) +
                               uVar18) - SUB164(auVar7 * auVar11,8)) * uVar4, auVar12._8_8_ = 0,
               auVar12._0_8_ = uVar26, SUB164(auVar8 * auVar12,8) < uVar15)) goto LAB_001029ec;
          }
...
LAB_001029ec:
      ...
      *(uint **)(local_98 + 2) = local_98;
      HashMap<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*>>>
      ::insert((int *)&local_88,(Element **)local_f0,SUB81(local_a8,0));
...
LAB_001029aa:
      if (0 < lVar27) {
        ...
        do {
          if (iVar16 == *(int *)(lVar22 + lVar20 * 4)) {
            DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::
            create_union(local_f0,iVar16,uVar1);
            lVar27 = *(long *)(lVar22 + -8);
            break;
          }
          lVar20 = lVar20 + 1;
  ...
  local_a0 = 0;
  DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::
  get_representatives(local_f0,(Vector *)local_a8);
  lVar22 = local_a0;
  local_90 = (int *)0x0;
  if (local_a0 != 0) {
    lVar27 = 0;
    while (lVar27 < *(long *)(lVar22 + -8)) {
      ...
      lVar27 = lVar27 + 1;
      DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::
      get_members(local_f0,(Vector *)&local_88,*(int *)(lVar22 + lVar20));
      iVar16 = _find_highest_node(param_1,(Vector *)&local_88);
      if (iVar16 < 0) {
        uVar21 = 1;
        _err_print_error("_expand_skin","modules/gltf/skin_tool.cpp",0xb8,
                         "Condition \"root < 0\" is true. Returning: FAILED",0,0);
        CowData<int>::_unref((CowData<int> *)&local_80);
        goto LAB_00102bcb;
      }
...
/* SkinTool::_verify_skin(Vector<Ref<GLTFNode> >&, Ref<GLTFSkin>) */

undefined8 SkinTool::_verify_skin(Vector *param_1,long *param_2)
      ...
      if ((local_70._0_8_ != 0) && (local_50._4_4_ != 0)) {
        ...
        if (uVar15 != 0) {
          ...
          while ((uVar23 != (uint)uVar19 ||
                 (uVar2 != *(uint *)(*(long *)(local_70._0_8_ + lVar20 * 8) + 0x10)))) {
            uVar15 = uVar15 + 1;
            auVar6._8_8_ = 0;
            auVar6._0_8_ = (uVar18 + 1) * uVar4;
            auVar10._8_8_ = 0;
            ...
            if ((uVar3 == 0) ||
               ...
               auVar8._0_8_ = ((*(uint *)(hash_table_size_primes + (local_50 & 0xffffffff) * 4) +
                               uVar18) - SUB164(auVar7 * auVar11,8)) * uVar4, auVar12._8_8_ = 0,
               auVar12._0_8_ = uVar25, SUB164(auVar8 * auVar12,8) < uVar15)) goto LAB_00102fd4;
          }
...
LAB_00102fd4:
      ...
      *(uint **)(local_98 + 2) = local_98;
      HashMap<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*>>>
      ::insert((int *)local_88,(Element **)local_78,SUB81(local_a8,0));
...
LAB_00102f93:
      if (0 < lVar26) {
        ...
        do {
          if (iVar16 == *(int *)(lVar24 + lVar20 * 4)) {
            DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::
            create_union(local_78,iVar16,uVar2);
            lVar26 = *(long *)(lVar24 + -8);
            break;
          }
          lVar20 = lVar20 + 1;
  ...
  local_a0 = 0;
  DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::
  get_representatives(local_78,(Vector *)local_a8);
  lVar24 = local_a0;
  local_90 = (int *)0x0;
  if (local_a0 == 0) {
LAB_001032a5:
    _err_print_error("_verify_skin","modules/gltf/skin_tool.cpp",0xf0,
                     "Condition \"out_roots.is_empty()\" is true. Returning: FAILED",0,0);
  }
  else {
    lVar26 = 0;
    while (lVar26 < *(long *)(lVar24 + -8)) {
      ...
      lVar26 = lVar26 + 1;
      DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::
      get_members(local_78,local_88,*(int *)(lVar24 + lVar20));
      iVar16 = _find_highest_node(param_1,local_88);
      if (iVar16 < 0) {
        _err_print_error("_verify_skin","modules/gltf/skin_tool.cpp",0xea,
                         "Condition \"root < 0\" is true. Returning: FAILED",0,0);
        CowData<int>::_unref((CowData<int> *)&local_80);
        goto LAB_00103156;
      }
      ...
      if (0 < lVar24) {
        ...
        do {
          if (piVar14[lVar20] != *(int *)(lVar26 + lVar20 * 4)) {
            _err_print_error("_verify_skin","modules/gltf/skin_tool.cpp",0xf5,
                             "Condition \"out_roots[i] != p_skin->roots[i]\" is true. Returning: FAILED"
                             ,0,0);
            goto LAB_00103156;
          }
          lVar20 = lVar20 + 1;
...
LAB_00103025:
            ...
            do {
              ...
              if (*(int *)(*(long *)(lVar20 + lVar17 * 8) + 0x248) !=
                  *(int *)(*(long *)(lVar20 + lVar1) + 0x248)) goto LAB_00103156;
              lVar22 = lVar22 + 1;
            } while (lVar22 < lVar24);
            goto LAB_00103340;
          }
...
LAB_00103044:
      _err_print_index_error
                ("get","./core/templates/cowdata.h",0xdb,lVar17,lVar26,"p_index","size()","",false,
                 true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
      pcVar13 = (code *)invalidInstructionException();
...
joined_r0x0010334a:
    if (lVar24 == 0) goto LAB_00103350;
LAB_001031ea:
    _err_print_error("_verify_skin","modules/gltf/skin_tool.cpp",0xf3,
                     "Condition \"out_roots.size() != p_skin->roots.size()\" is true. Returning: FAILED"
                     ,0,0);
  }
LAB_00103156:
  uVar21 = 1;
...
/* SkinTool::_recurse_children(Vector<Ref<GLTFNode> >&, int, RBSet<int, Comparator<int>,
   DefaultAllocator>&, HashSet<int, HashMapHasherDefault, HashMapComparatorDefault<int> >&) */
  ...
  if ((*(long *)param_4 != 0) && (*(int *)(param_4 + 0x24) != 0)) {
    ...
    if (uVar12 != 0) {
      ...
      do {
        if ((uVar12 == uVar20) &&
           (param_2 ==
            *(int *)(*(long *)param_4 + (ulong)*(uint *)(*(long *)(param_4 + 8) + lVar16 * 4) * 4)))
        goto LAB_001036e2;
        uVar19 = uVar19 + 1;
        auVar3._8_8_ = 0;
        ...
        iVar14 = SUB164(auVar3 * auVar7,8);
              ...
              auVar5._0_8_ = ((*(uint *)(hash_table_size_primes +
                                        (ulong)*(uint *)(param_4 + 0x20) * 4) + iVar14) -
                             SUB164(auVar4 * auVar8,8)) * uVar1, auVar9._8_8_ = 0,
              auVar9._0_8_ = uVar21, uVar19 <= SUB164(auVar5 * auVar9,8)));
    }
  }
...
LAB_001037c8:
        RBSet<int,Comparator<int>,DefaultAllocator>::insert
                  ((RBSet<int,Comparator<int>,DefaultAllocator> *)param_3,&local_5c);
      }
...
LAB_00103828:
  _err_print_index_error
            ("get","./core/templates/cowdata.h",0xdb,lVar13,lVar18,"p_index","size()","",false,true)
  ;
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar10 = (code *)invalidInstructionException();
...
/* SkinTool::_map_skin_joints_indices_to_skeleton_bone_indices(Vector<Ref<GLTFSkin> >&,
   Vector<Ref<GLTFSkeleton> >&, Vector<Ref<GLTFNode> >&) */

undefined8
SkinTool::_map_skin_joints_indices_to_skeleton_bone_indices
...
LAB_00103ce1:
        ...
        for (lVar9 = 0; (lVar5 != 0 && (lVar9 < *(long *)(lVar5 + -8))); lVar9 = lVar9 + 1) {
          ...
          if ((pOVar8 == (Object *)0x0) ||
             (local_50 = pOVar8, cVar3 = RefCounted::reference(), cVar3 == '\0')) {
            local_50 = (Object *)0x0;
            pOVar8 = (Object *)0x0;
          }
          ...
          if (iVar4 < 0) {
            _err_print_error("_map_skin_joints_indices_to_skeleton_bone_indices",
                             "modules/gltf/skin_tool.cpp",0x280,
                             "Condition \"bone_index < 0\" is true. Returning: FAILED",0,0);
          ...
          ::insert((int *)local_48,(int *)(lVar10 + 0x2a0),SUB81(&local_68,0));
...
LAB_00103ce5:
    ...
    local_60 = 0;
    _err_print_error("_map_skin_joints_indices_to_skeleton_bone_indices",
                     "modules/gltf/skin_tool.cpp",0x277,
                     "Condition \"skin.is_null()\" is true. Continuing.",0,0);
    Ref<GLTFSkin>::unref((Ref<GLTFSkin> *)&local_60);
LAB_00103d60:
    lVar10 = *(long *)(param_1 + 8);
    lVar11 = lVar11 + 1;
...
/* SkinTool::_remove_duplicate_skins(Vector<Ref<GLTFSkin> >&) */

void SkinTool::_remove_duplicate_skins(Vector *param_1)
...
LAB_0010427b:
            _err_print_index_error
                      ("operator[]","./core/templates/vector.h",0x38,lVar9,lVar4,"p_index",
                       "((Vector<T> *)(this))->_cowdata.size()","",false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
            pcVar1 = (code *)invalidInstructionException();
...
/* SkinTool::_create_skins(Vector<Ref<GLTFSkin> >&, Vector<Ref<GLTFNode> >&, bool, HashSet<String,
   HashMapHasherDefault, HashMapComparatorDefault<String> >&) */

undefined8 SkinTool::_create_skins(Vector *param_1,Vector *param_2,bool param_3,HashSet *param_4)

{
  ...
  for (lVar10 = 0; (lVar5 != 0 && (lVar10 < *(long *)(lVar5 + -8))); lVar10 = lVar10 + 1) {
    ...
    if ((pSVar1 == (String *)0x0) ||
       (local_90 = pSVar1, cVar4 = RefCounted::reference(), cVar4 == '\0')) {
      local_90 = (String *)0x0;
      _err_print_error("_create_skins","modules/gltf/skin_tool.cpp",0x28c,
                       "Condition \"gltf_skin.is_null()\" is true. Continuing.",0,0);
...
LAB_0010473c:
        ...
        if (param_3) {
          ...
          puVar7 = (uint *)HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>>
                           ::operator[]((HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>>
                                         *)(pSVar1 + 0x2a0),&local_94);
  ...
  if (lVar5 != 0) {
    ...
    do {
      ...
      if (lVar5 == 0) {
        _err_print_error("_create_skins","modules/gltf/skin_tool.cpp",0x2ad,
                         "Condition \"skins.get(skin_i).is_null()\" is true. Continuing.",0,0);
      }
      else {
        if (*(long *)(param_1 + 8) == 0) {
          lVar5 = 0;
LAB_001047e3:
          _err_print_index_error
                    ("operator[]","./core/templates/vector.h",0x38,lVar10,lVar5,"p_index",
                     "((Vector<T> *)(this))->_cowdata.size()","",false,true);
          _err_flush_stdout();
                    /* WARNING: Does not return */
          pcVar2 = (code *)invalidInstructionException();
        ...
        Ref<Skin>::operator=
                  ((Ref<Skin> *)&local_90,
                   *(Ref **)(*(long *)(*(long *)(param_1 + 8) + lVar10 * 8) + 0x300));
        pSVar1 = local_90;
        if (local_90 == (String *)0x0) {
          _err_print_error("_create_skins","modules/gltf/skin_tool.cpp",0x2af,
                           "Condition \"skin.is_null()\" is true. Continuing.",0,0);
          Ref<Skin>::unref((Ref<Skin> *)&local_90);
          goto LAB_001043c7;
        }
        Resource::get_name();
        if ((local_80 == 0) || (iVar11 = (int)*(undefined8 *)(local_80 + -8), iVar11 == 0)) {
          CowData<char32_t>::_unref((CowData<char32_t> *)&local_80);
LAB_00104495:
          local_88 = (Ref *)0x0;
    ...
    if (-1 < iVar2) {
      ...
      if ((*(long *)(param_2 + 8) != 0) && (lVar10 < *(long *)(*(long *)(param_2 + 8) + -8))) {
        ...
        if (lVar7 != 0) {
          ...
          if ((pOVar8 == (Object *)0x0) ||
             (local_58 = pOVar8, cVar4 = RefCounted::reference(), cVar4 == '\0')) {
            local_58 = (Object *)0x0;
          ...
          if (lVar7 != 0) {
            ...
            GLTFSkin::get_joints();
            for (lVar7 = 0; (local_50[0] != 0 && (lVar7 < *(long *)(local_50[0] + -8)));
                lVar7 = lVar7 + 1) {
...
LAB_00104b73:
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,lVar10,lVar6,"p_index","size()","",false,
                   true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar3 = (code *)invalidInstructionException();
...
/* CowData<Ref<GLTFSkeleton> >::_copy_on_write() [clone .isra.0] */

void __thiscall CowData<Ref<GLTFSkeleton>>::_copy_on_write(CowData<Ref<GLTFSkeleton>> *this)
...
/* SkinTool::_create_skeletons(HashSet<String, HashMapHasherDefault,
   ...
   DefaultTypedAllocator<HashMapElement<int, Node*> > >&) */

undefined8
SkinTool::_create_skeletons
          (HashSet *param_1,Vector *param_2,Vector *param_3,HashMap *param_4,Vector *param_5,
          HashMap *param_6)
...
LAB_00104f0d:
      ...
      *(Skeleton3D **)(pOVar14 + 0x260) = this;
      ...
      piVar7 = (int *)HashMap<ObjectID,int,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,int>>>
      ...
      *piVar7 = iVar15;
      ...
      if ((puVar19 == (undefined4 *)0x0) || (*(long *)(puVar19 + -2) < 1)) {
        List<int,DefaultAllocator>::sort_custom<Comparator<int>>
                  ((List<int,DefaultAllocator> *)&local_e0);
      }
      else {
        lVar21 = 0;
...
LAB_0010548c:
            _err_print_index_error
                      ("get","./core/templates/cowdata.h",0xdb,uVar13,lVar21,"p_index","size()","",
                       false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_00105297:
          ...
          if (*(int *)(pSVar20 + 0x28c) != iVar15) {
            _err_print_error("_create_skeletons","modules/gltf/skin_tool.cpp",0x23c,
                             "Condition \"node->skeleton != skel_i\" is true. Returning: FAILED",0,0
                            );
LAB_00105525:
          ...
          if ((local_c8 == (char *)0x0) ||
             (uVar10 = *(undefined8 *)(local_c8 + -8), (int)uVar10 == 0)) {
...
LAB_001058f4:
          ...
          if (-1 < *(int *)(pSVar20 + 0x248)) {
            ...
            if (*(int *)(*(long *)(lVar11 + uVar13 * 8) + 0x28c) == iVar15) {
              ...
              CowData<char32_t>::_unref((CowData<char32_t> *)&local_c8);
              if (iVar6 < 0) {
                _err_print_error("_create_skeletons","modules/gltf/skin_tool.cpp",0x264,
                                 "Condition \"bone_parent < 0\" is true. Returning: FAILED",0,0);
                goto LAB_00105525;
              }
              uVar13 = (ulong)*(int *)(pSVar20 + 0x248);
              lVar21 = *(long *)(param_3 + 8);
          ...
          ::insert((int *)&local_c8,(Node **)param_6,SUB81(&local_ec,0));
          Ref<GLTFNode>::unref((Ref<GLTFNode> *)&local_d8);
          pauVar8 = local_e0;
...
LAB_00105125:
  uVar10 = _map_skin_joints_indices_to_skeleton_bone_indices(param_2,param_5,param_3);
  if ((int)uVar10 != 0) {
    _err_print_error("_create_skeletons","modules/gltf/skin_tool.cpp",0x26c,
                     "Condition \"_map_skin_joints_indices_to_skeleton_bone_indices(skins, skeletons, nodes)\" is true. Returning: ERR_PARSE_ERROR"
                     ,0,0);
    uVar10 = 0x2b;
  }
  goto LAB_0010513d;
...
LAB_0010553f:
  ...
  Memory::free_static(pauVar8,false);
LAB_00105597:
  Ref<GLTFSkeleton>::unref((Ref<GLTFSkeleton> *)&local_e8);
  uVar10 = 1;
LAB_0010513d:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
...
/* SkinTool::_determine_skeleton_roots(Vector<Ref<GLTFNode> >&, Vector<Ref<GLTFSkeleton> >&, int) */

undefined8 SkinTool::_determine_skeleton_roots(Vector *param_1,Vector *param_2,int param_3)
      ...
      if (*(int *)(pOVar20 + 0x28c) == param_3) {
        ...
        if ((local_70._0_8_ != 0) && (local_50._4_4_ != 0)) {
          ...
          if (uVar13 != 0) {
            uVar27 = 0;
            while ((uVar28 != uVar13 ||
                   (*(uint *)(*(long *)(local_70._0_8_ + lVar19 * 8) + 0x10) != uVar24))) {
              uVar27 = uVar27 + 1;
              auVar4._8_8_ = 0;
              auVar4._0_8_ = (uVar18 + 1) * uVar2;
              auVar8._8_8_ = 0;
              ...
              if ((uVar13 == 0) ||
                 ...
                 auVar6._0_8_ = ((*(uint *)(hash_table_size_primes + (local_50 & 0xffffffff) * 4) +
                                 uVar18) - SUB164(auVar5 * auVar9,8)) * uVar2, auVar10._8_8_ = 0,
                 auVar10._0_8_ = uVar29, SUB164(auVar6 * auVar10,8) < uVar27)) goto LAB_00105e58;
            }
...
LAB_00105dc3:
        ...
        DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::
        create_union(local_78,iVar14,uVar24);
...
LAB_00105f58:
      ...
      while (piVar23 = local_90, lVar17 = local_b0, lVar25 < *(long *)(lVar19 + -8)) {
        ...
        lVar25 = lVar25 + 1;
        DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::
        get_members(local_78,local_88,*(int *)(lVar19 + lVar17));
        iVar14 = _find_highest_node(param_1,local_88);
        if (iVar14 < 0) {
          _err_print_error("_determine_skeleton_roots","modules/gltf/skin_tool.cpp",0x203,
                           "Condition \"root < 0\" is true. Returning: FAILED",0,0);
          CowData<int>::_unref((CowData<int> *)&local_80);
          goto LAB_0010600d;
        }
            ...
            if (lVar19 != 1) {
              ...
              if (lVar17 < 0) {
                ...
                do {
                  ...
                  if (*(int *)(*(long *)(lVar25 + lVar17 * 8) + 0x248) !=
                      *(int *)(*(long *)(lVar25 + lVar1) + 0x248)) goto LAB_0010600d;
                  lVar15 = lVar15 + 1;
                } while (lVar19 != lVar15);
                goto LAB_00106193;
              }
...
LAB_0010607f:
              _err_print_index_error
                        ("get","./core/templates/cowdata.h",0xdb,lVar17,lVar26,"p_index","size()",""
                         ,false,true);
              _err_flush_stdout();
                    /* WARNING: Does not return */
              pcVar11 = (code *)invalidInstructionException();
...
LAB_001061ac:
  _err_print_index_error
            ("operator[]","./core/templates/vector.h",0x38,lVar25,lVar19,"p_index",
             "((Vector<T> *)(this))->_cowdata.size()","",false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar11 = (code *)invalidInstructionException();
...
/* SkinTool::_determine_skeletons(Vector<Ref<GLTFSkin> >&, Vector<Ref<GLTFNode> >&,
   Vector<Ref<GLTFSkeleton> >&, Vector<int> const&) */

undefined8
SkinTool::_determine_skeletons(Vector *param_1,Vector *param_2,Vector *param_3,Vector *param_4)

{
  ...
  if (*(long *)(param_4 + 8) != 0) {
    ...
    *(undefined ***)pRVar15 = &PTR__initialize_classv_00110850;
    uVar27 = _LC24;
    *(undefined4 *)(pRVar15 + 0x240) = 0xffffffff;
    *(undefined8 *)(pRVar15 + 0x250) = 0;
    *(undefined8 *)(pRVar15 + 0x260) = 0;
    *(undefined8 *)(pRVar15 + 0x270) = 0;
    *(undefined8 *)(pRVar15 + 0x280) = 0;
    *(undefined8 *)(pRVar15 + 0x290) = 0;
    ...
    *(undefined1 (*) [16])(pRVar15 + 0x2e8) = (undefined1  [16])0x0;
    ...
    for (lVar26 = 0; (lVar20 != 0 && (lVar26 < *(long *)(lVar20 + -8))); lVar26 = lVar26 + 1) {
      Vector<int>::push_back
                ((Vector<int> *)((String *)pRVar15 + 0x268),*(int *)(lVar20 + lVar26 * 4));
      lVar20 = *(long *)(param_4 + 8);
    }
    local_78 = 0;
  ...
  for (lVar26 = 0; (lVar20 != 0 && (lVar26 < *(long *)(lVar20 + -8))); lVar26 = lVar26 + 1) {
    ...
    pRVar11 = local_f8;
    if (local_f8 == (Ref *)0x0) {
      _err_print_error("_determine_skeletons","modules/gltf/skin_tool.cpp",0x134,
                       "Condition \"skin.is_null()\" is true. Continuing.");
      ...
      if (lVar20 == 0) {
        ...
        do {
          ...
          lVar23 = uVar27 * 4;
          RBSet<int,Comparator<int>,DefaultAllocator>::insert
                    ((RBSet<int,Comparator<int>,DefaultAllocator> *)&local_c8,
                     (int *)(lVar20 + lVar23));
...
LAB_0010666c:
          ...
          do {
            ...
            if (lVar19 <= (long)uVar27) goto LAB_00106637;
            uVar27 = uVar27 + 1;
            _recurse_children(param_2,*(int *)(lVar20 + lVar23),(RBSet *)&local_c8,
                              (HashSet *)local_a8);
            lVar20 = *(long *)(pRVar11 + 0x280);
          } while (lVar20 != 0);
        }
        if ((local_c8 != (Resource *)0x0) &&
           (pRVar16 = *(Resource **)(local_c8 + 0x10), *(Resource **)(local_c8 + 0x10) != local_c0))
        {
          do {
            pRVar15 = pRVar16;
...
LAB_00106730:
          do {
            ...
            local_fc = uVar3;
            cVar13 = HashMap<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*>>>
                     ::_lookup_pos((HashMap<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*>>>
                                    *)&local_78,(int *)(ulong)uVar3,local_d8);
            if ((cVar13 == '\0') || (*(long *)(local_70._0_8_ + (ulong)local_d8[0] * 8) == 0)) {
              ...
              *(Object **)((long)local_e8 + 8) = local_e8;
              HashMap<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*>>>
              ::insert((int *)local_d8,(Element **)&local_78,SUB81(&local_fc,0));
            }
            pRVar16 = local_c8;
            if (local_c8 != (Resource *)0x0) {
              while (pRVar16 = *(Resource **)(pRVar16 + 0x10), local_c0 != pRVar16) {
                while ((int)*(uint *)(pRVar16 + 0x30) <= iVar14) {
                  if (iVar14 <= (int)*(uint *)(pRVar16 + 0x30)) {
                    DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>
                    ::create_union((DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>
                                    *)&local_78,iVar14,uVar3);
...
LAB_001067f5:
  ...
  if ((local_f0 != 0) && (0 < *(long *)(local_f0 + -8))) {
    ...
    do {
      ...
      DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::
      get_members((DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>
                   *)&local_78,(Vector *)&local_c8,*(int *)(lVar20 + lVar26 * 4));
      ...
      if (iVar14 == 0) {
        ...
        _err_print_index_error
                  ("set","./core/templates/cowdata.h",0xcf,lVar19,lVar23,"p_index","size()","",false
                   ,false);
      }
      else {
        _err_print_error("push_back","./core/templates/vector.h",0x142,
        ...
        if (lVar26 < lVar19) {
          ...
          if (lVar18 != 0) {
            while( true ) {
              ...
              if (*(int *)(*(long *)(lVar18 + uVar28 * 8) + 0x248) ==
                  *(int *)(*(long *)(lVar18 + uVar27 * 8) + 0x248)) {
                DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>
                ::create_union((DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>
                                *)&local_78,(int)uVar24,iVar4);
...
LAB_00106f56:
        ...
        lVar20 = lVar26;
        if (((((int)uVar3 < 0) || (local_d0 == 0)) || (*(long *)(local_d0 + -8) < 1)) ||
           (iVar29 == 0)) {
          ...
          uVar27 = 0;
          do {
            lVar26 = CowData<int>::find(*(CowData<int> **)(lVar12 + 8 + uVar27 * 0x10),
                                        (int *)(ulong)uVar3,0);
            if (lVar26 != -1) {
              if (lVar19 <= (long)uVar27) goto LAB_00106637;
              DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::
              create_union((DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>
                            *)&local_78,iVar14,*(int *)(lVar23 + uVar27 * 4));
              lVar19 = *(long *)(lVar23 + -8);
            }
            uVar27 = uVar27 + 1;
  ...
  for (lVar26 = 0; (local_d0 != 0 && (lVar26 < *(long *)(local_d0 + -8))); lVar26 = lVar26 + 1) {
    ...
    DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::
    get_members((DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>
                 *)&local_78,(Vector *)&local_c8,iVar14);
    pRVar16 = local_c0;
    lVar20 = *(long *)(param_1 + 8);
    if (lVar20 != 0) {
      lVar23 = 0;
      do {
        ...
        Ref<GLTFSkin>::operator=
                  ((Ref<GLTFSkin> *)local_a8,*(Ref **)(*(long *)(param_1 + 8) + lVar23 * 8));
        if (pRVar16 != (Resource *)0x0) {
          if (0 < *(long *)(pRVar16 + -8)) {
            ...
            do {
              ...
              if ((lVar19 != -1) ||
                 (lVar19 = CowData<int>::find(*(CowData<int> **)(lVar20 + 0x280),piVar17,0),
                 lVar19 != -1)) {
    ...
    if (iVar14 == 0) {
        ...
        if (-1 < lVar23) {
          ...
          if (local_e8 != pOVar5) {
            *puVar2 = local_e8;
            ...
            if (((pOVar5 != (Object *)0x0) && (cVar13 = RefCounted::unreference(), cVar13 != '\0'))
               && (cVar13 = predelete_handler(pOVar5), cVar13 != '\0')) {
      ...
      _err_print_index_error
                ("set","./core/templates/cowdata.h",0xcf,lVar23,lVar20,"p_index","size()","",false,
                 false);
    }
    else {
      _err_print_error("push_back","./core/templates/vector.h",0x142,
...
LAB_001073db:
      _err_print_index_error
                ("operator[]","./core/templates/vector.h",0x38,lVar26,lVar20,"p_index",
                 "((Vector<T> *)(this))->_cowdata.size()","",false,true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
    ...
    lVar20 = *(long *)(*(long *)(param_3 + 8) + -8);
    if (lVar20 <= lVar26) goto LAB_001073db;
    CowData<Ref<GLTFSkeleton>>::_copy_on_write(this);
    local_e8 = (Object *)0x0;
    Ref<GLTFSkeleton>::operator=
              ((Ref<GLTFSkeleton> *)&local_e8,*(Ref **)(*(long *)(param_3 + 8) + lVar26 * 8));
    _reparent_non_joint_skeleton_subtrees(param_2,(Ref<GLTFSkeleton> *)&local_e8,local_a8);
    Ref<GLTFSkeleton>::unref((Ref<GLTFSkeleton> *)&local_e8);
    CowData<int>::_unref((CowData<int> *)(local_a8 + 8));
    CowData<int>::_unref((CowData<int> *)&local_c0);
    Ref<GLTFSkeleton>::unref((Ref<GLTFSkeleton> *)&local_f8);
  }
  lVar20 = 0;
  do {
    if ((*(long *)(param_3 + 8) == 0) || (*(long *)(*(long *)(param_3 + 8) + -8) <= lVar20)) {
      uVar22 = 0;
LAB_0010718b:
      CowData<int>::_unref((CowData<int> *)local_128);
      DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::
      ~DisjointSet((DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>
                    *)&local_78);
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
        return uVar22;
      }
    ...
    local_c8 = (Resource *)0x0;
    Ref<GLTFSkeleton>::operator=
              ((Ref<GLTFSkeleton> *)&local_c8,*(Ref **)(*(long *)(param_3 + 8) + lVar20 * 8));
    while( true ) {
...
LAB_0010713e:
      ...
      if (*(char *)(local_a8._0_8_ + 0x290) == '\0') {
        _err_print_error("_determine_skeletons","modules/gltf/skin_tool.cpp",0x1aa,
                         "Condition \"!node->joint\" is true. Returning: ERR_PARSE_ERROR",0,0);
LAB_00107171:
      ...
      if (-1 < *(int *)(local_a8._0_8_ + 0x28c)) {
        _err_print_error("_determine_skeletons","modules/gltf/skin_tool.cpp",0x1ab,
                         "Condition \"node->skeleton >= 0\" is true. Returning: ERR_PARSE_ERROR",0,0
                        );
        goto LAB_00107171;
      }
    ...
    if (iVar14 != 0) {
      _err_print_error("_determine_skeletons","modules/gltf/skin_tool.cpp",0x1af,
                       "Condition \"SkinTool::_determine_skeleton_roots(nodes, skeletons, skel_i)\" is true. Returning: ERR_PARSE_ERROR"
                       ,0,0);
LAB_0010717e:
      uVar22 = 0x2b;
...
LAB_00106637:
  _err_print_index_error
            ("get","./core/templates/cowdata.h",0xdb,uVar27,lVar19,"p_index","size()","",false,true)
  ;
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar6 = (code *)invalidInstructionException();
...
{
  return (uint)CONCAT71(0x110a,(undefined4 *)param_1 == &Resource::get_class_ptr_static()::ptr) |
...
/* SortArray<List<int, DefaultAllocator>::Element*, List<int,
   ...
   DefaultAllocator>::Element**, long) const [clone .isra.0] */

void SortArray<List<int,DefaultAllocator>::Element*,List<int,DefaultAllocator>::AuxiliaryComparator<Comparator<int>>,true>
...
/* void Ref<GLTFSkeleton>::instantiate<>() */

void __thiscall Ref<GLTFSkeleton>::instantiate<>(Ref<GLTFSkeleton> *this)

{
  ...
  *(undefined ***)this_00 = &PTR__initialize_classv_00110678;
  uVar1 = _LC24;
  ...
  *(undefined1 (*) [16])(this_00 + 0x2a8) = (undefined1  [16])0x0;
  ...
  if (cVar2 == '\0') {
    ...
    *(Resource **)this = this_00;
    ...
    if (((pOVar6 == (Object *)0x0) || (cVar2 = RefCounted::unreference(), cVar2 == '\0')) ||
       (cVar2 = predelete_handler(pOVar6), cVar2 == '\0')) goto LAB_00109385;
  }
  (**(code **)(*(long *)pOVar6 + 0x140))(pOVar6);
  Memory::free_static(pOVar6,false);
  pOVar5 = (Object *)this_00;
...
LAB_001095db:
  if ((float)uVar55 * __LC19 < (float)(iVar42 + 1)) {
...
LAB_0010a3e3:
  if ((float)uVar51 * __LC19 < (float)(iVar44 + 1)) {
...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_00110678;
...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_00110850;
...
LAB_00110150:
  ...
  if (param_1 <= lVar4) {
    while (lVar4 = *(long *)this, lVar4 != 0) {
      ...
      CowData<int>::_unref((CowData<int> *)(lVar4 + 8 + uVar6 * 0x10));
      uVar6 = uVar6 + 1;
    }
    goto LAB_001101a6;
  }
...
LAB_001101a6:
    ...
    lVar4 = puVar5[-1];
    if (param_1 <= lVar4) goto LAB_00110021;
  }
  else {
    if (lVar4 != 0) {
      uVar3 = _realloc(this,lVar9);
...
LAB_0011046a:
      ...
      while (plVar1 = (long *)(lVar7 + uVar9 * 8), *plVar1 == 0) {
        uVar9 = uVar9 + 1;
        if (*(ulong *)(lVar7 + -8) <= uVar9) goto LAB_0011046a;
      }
      cVar4 = RefCounted::unreference();
      if (cVar4 != '\0') {
        pOVar2 = (Object *)*plVar1;
...
LAB_00110430:
    ...
    lVar7 = puVar10[-1];
    if (param_1 <= lVar7) goto LAB_0011051b;
  }
  else {
    if (lVar7 != 0) {
      uVar5 = _realloc(this,lVar11);

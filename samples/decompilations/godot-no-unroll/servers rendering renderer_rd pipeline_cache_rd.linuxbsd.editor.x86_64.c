...
/* PipelineCacheRD::_clear() [clone .part.0] */

void __thiscall PipelineCacheRD::_clear(PipelineCacheRD *this)
...
void __thiscall
CowData<RenderingDeviceCommons::PipelineSpecializationConstant>::_ref
          (CowData<RenderingDeviceCommons::PipelineSpecializationConstant> *this,CowData *param_1)
...
/* PipelineCacheRD::setup(RID, RenderingDeviceCommons::RenderPrimitive,
   ...
   Vector<RenderingDeviceCommons::PipelineSpecializationConstant> const&) */

void __thiscall
PipelineCacheRD::setup
          (PipelineCacheRD *this,long param_2,undefined4 param_3,undefined8 *param_4,
          undefined4 *param_5,undefined8 *param_6,PipelineCacheRD *param_7,undefined4 param_8,
          long param_9)

{
  ...
  if (param_2 == 0) {
    _err_print_error("setup","servers/rendering/renderer_rd/pipeline_cache_rd.cpp",0x59,
                     "Condition \"p_shader.is_null()\" is true.",0,0);
    return;
  }
  if (*(long *)(this + 0x128) != 0) {
    _clear(this);
  ...
  *(undefined8 *)(this + 0xa0) = uVar3;
  uVar3 = param_6[3];
  *(undefined8 *)(this + 0xa8) = param_6[2];
  *(undefined8 *)(this + 0xb0) = uVar3;
  uVar3 = param_6[5];
  *(undefined8 *)(this + 0xb8) = param_6[4];
  *(undefined8 *)(this + 0xc0) = uVar3;
  uVar3 = param_6[7];
  *(undefined8 *)(this + 200) = param_6[6];
  *(undefined8 *)(this + 0xd0) = uVar3;
  uVar3 = param_6[9];
  *(undefined8 *)(this + 0xd8) = param_6[8];
...
LAB_0010044f:
  ...
  *(undefined4 *)(this + 0x110) = param_8;
  ...
  CowData<RenderingDeviceCommons::PipelineSpecializationConstant>::_ref
            ((CowData<RenderingDeviceCommons::PipelineSpecializationConstant> *)(this + 0x120),
             (CowData *)(param_9 + 8));
  return;
}
...
void __thiscall
PipelineCacheRD::update_specialization_constants(PipelineCacheRD *this,Vector *param_1)
...
/* PipelineCacheRD::update_shader(RID) */

void __thiscall PipelineCacheRD::update_shader(PipelineCacheRD *this,long param_2)

{
  ...
  if (param_2 == 0) {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error("update_shader","servers/rendering/renderer_rd/pipeline_cache_rd.cpp",0x6a,
                       "Condition \"p_shader.is_null()\" is true.",0,0);
      return;
    }
  }
    ...
    if (*(long *)(this + 0x88) == 0) {
      ...
      setup(this,param_2,*(undefined4 *)(this + 0x48),this + 0x4c,&local_68,this + 0x98,this + 0xe8,
            uVar2,local_78);
    }
    else {
...
void __thiscall PipelineCacheRD::clear(PipelineCacheRD *this)
...
void __thiscall PipelineCacheRD::PipelineCacheRD(PipelineCacheRD *this)
...
/* PipelineCacheRD::_generate_version(long, long, bool, unsigned int, unsigned int) */

long __thiscall
PipelineCacheRD::_generate_version
          (PipelineCacheRD *this,long param_1,long param_2,bool param_3,uint param_4,uint param_5)
...
LAB_00100b58:
    ...
    lVar4 = RenderingDevice::render_pipeline_create
                      (uVar5,*(undefined8 *)(this + 0x40),param_2,param_1,
                       *(undefined4 *)(this + 0x48),&local_98,&local_68,this + 0x98,this + 0xe8,
                       (long)*(int *)(this + 0x110),param_4,local_a8);
    if (lVar4 == 0) {
      lVar4 = 0;
      _err_print_error("_generate_version","servers/rendering/renderer_rd/pipeline_cache_rd.cpp",
                       0x3d,"Condition \"pipeline.is_null()\" is true. Returning: RID()",0,0);
    }
    else {
      lVar6 = Memory::realloc_static
                        (*(void **)(this + 0x128),(ulong)(*(int *)(this + 0x130) + 1) * 0x28,false);
    ...
    if ((uVar7 & uVar9) != 0) {
      ...
      if (iVar3 == 0) {
        if (local_a0 == 0) {
          ...
          if (-1 < lVar6) {
            CowData<RenderingDeviceCommons::PipelineSpecializationConstant>::_copy_on_write
                      ((CowData<RenderingDeviceCommons::PipelineSpecializationConstant> *)&local_a0)
            ;
        ...
        _err_print_index_error
                  ("set","./core/templates/cowdata.h",0xcf,lVar6,lVar4,"p_index","size()","",false,
                   false);
      }
      else {

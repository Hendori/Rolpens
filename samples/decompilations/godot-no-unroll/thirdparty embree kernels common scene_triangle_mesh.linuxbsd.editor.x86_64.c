...
/* embree::TriangleMesh::verify() */

undefined8 __thiscall embree::TriangleMesh::verify(TriangleMesh *this)
...
LAB_00100050:
      ...
      if (puVar6 != puVar11) {
        do {
          if (*(long *)(puVar6 + 4) != puVar13[2]) goto LAB_00100047;
          puVar6 = puVar6 + 0xc;
      ...
      if (*(uint *)(this + 0x20) != 0) {
        ...
        uVar2 = puVar13[2];
        do {
          if (((uVar2 <= *puVar6) || (uVar2 <= puVar6[1])) || (uVar2 <= puVar6[2]))
          goto LAB_00100047;
          uVar7 = uVar7 + 1;
      ...
      for (; puVar9 != puVar13; puVar13 = puVar13 + 6) {
        if (puVar13[2] != 0) {
          ...
          lVar12 = 0;
          do {
            auVar3._4_4_ = -(uint)(_LC3 < pfVar8[1] && pfVar8[1] < _LC1);
            auVar3._0_4_ = -(uint)(_LC3 < *pfVar8 && *pfVar8 < _LC1);
            auVar3._8_4_ = -(uint)(_LC3 < pfVar8[2] && pfVar8[2] < _LC1);
            auVar3._12_4_ = -(uint)(_LC3 < pfVar8[3] && pfVar8[3] < _LC1);
            uVar4 = movmskps((int)puVar6,auVar3);
            puVar6 = (uint *)(ulong)~uVar4;
            if ((~uVar4 & 7) != 0) goto LAB_00100047;
            lVar12 = lVar12 + 1;
      ...
      puVar5 = puVar13;
      do {
        if (puVar9 == puVar5 + 6) goto LAB_00100050;
        plVar1 = puVar5 + 8;
        puVar5 = puVar5 + 6;
...
/* embree::TriangleMesh::setMask(unsigned int) */

void __thiscall embree::TriangleMesh::setMask(TriangleMesh *this,uint param_1)
...
/* embree::TriangleMesh::updateBuffer(RTCBufferType, unsigned int) */

void __thiscall embree::TriangleMesh::updateBuffer(TriangleMesh *this,int param_2,uint param_3)
...
/* embree::TriangleMesh::commit() */

void __thiscall embree::TriangleMesh::commit(TriangleMesh *this)
...
/* embree::TriangleMesh::getBuffer(RTCBufferType, unsigned int) */

undefined8 __thiscall embree::TriangleMesh::getBuffer(TriangleMesh *this,int param_2,uint param_3)
...
/* embree::TriangleMesh::addElementsToCount(embree::GeometryCounts&) const */

void __thiscall embree::TriangleMesh::addElementsToCount(TriangleMesh *this,GeometryCounts *param_1)
...
/* embree::TriangleMesh::setBuffer(RTCBufferType, unsigned int, RTCFormat,
   embree::Ref<embree::Buffer> const&, unsigned long, unsigned long, unsigned int) */

void __thiscall
embree::TriangleMesh::setBuffer
          (TriangleMesh *this,int param_2,uint param_3,int param_4,long *param_5,long param_6,
...

{
  ...
  lVar2 = *param_5;
  uVar8 = (ulong)param_8;
  lVar6 = *(long *)(lVar2 + 0x18) + param_6;
  if ((((uint)lVar6 | (uint)param_7) & 3) == 0) {
    if (param_2 == 1) {
      if ((((param_4 == 0x9003) && (uVar8 * param_7 < 0x400000001)) &&
          (uVar5 < *(ulong *)(this + 0xc0))) &&
         (plVar7 = (long *)(*(long *)(this + 0xd0) + uVar5 * 0x30),
         uVar8 * param_7 + param_6 <= (ulong)(*(long *)(lVar2 + 0x20) * param_7))) {
      ...
      if (((param_4 - 0x9001U < 0x10) && (uVar5 < *(ulong *)(this + 0xe0))) &&
         (plVar7 = (long *)(*(long *)(this + 0xf0) + uVar5 * 0x30),
         uVar8 * param_7 + param_6 <= (ulong)(*(long *)(lVar2 + 0x20) * param_7))) {
        *(int *)((long)plVar7 + 0x1c) = *(int *)((long)plVar7 + 0x1c) + 1;
        *plVar7 = lVar6;
        plVar7[1] = param_7;
    ...
    else if (((param_3 == 0 && param_2 == 0) && (param_4 == 0x5003)) &&
            (uVar8 * param_7 + param_6 <= (ulong)(*(long *)(lVar2 + 0x20) * param_7))) {
      *(int *)(this + 0x74) = *(int *)(this + 0x74) + 1;
      ...
      *(long *)(this + 0x80) = *param_5;
                    /* WARNING: Could not recover jumptable at 0x001003f7. Too many branches */
...
/* embree::TriangleMesh::setVertexAttributeCount(unsigned int) */

void __thiscall embree::TriangleMesh::setVertexAttributeCount(TriangleMesh *this,uint param_1)

{
  ...
  if (uVar10 < uVar3) {
    if (uVar10 != 0) {
      ...
      if (uVar3 < uVar8) goto LAB_001007c3;
      goto LAB_00100814;
    }
    uVar10 = uVar3;
    if (uVar3 < uVar8) goto LAB_001007c3;
    ...
    *(long *)(this + 0xf0) = lVar4;
    if (*(long *)(this + 0xe0) != 0) goto LAB_00100848;
    uVar8 = 0;
  }
  else {
    if (uVar8 <= uVar3) {
...
LAB_001007c3:
    do {
      while (plVar2 = *(long **)(uVar11 * 0x30 + *(long *)(this + 0xf0) + 0x28),
            plVar2 == (long *)0x0) {
LAB_001007b6:
        uVar11 = uVar11 + 1;
        if (*(ulong *)(this + 0xe0) <= uVar11) goto LAB_00100800;
      }
...
LAB_00100848:
    ...
    if (uVar3 <= uVar8) goto LAB_00100915;
  }
  lVar4 = uVar8 * 0x30;
  do {
    uVar8 = uVar8 + 1;
...
/* embree::TriangleMesh::setNumTimeSteps(unsigned int) */

void __thiscall embree::TriangleMesh::setNumTimeSteps(TriangleMesh *this,uint param_1)

{
  ...
  uVar9 = (ulong)param_1;
  uVar11 = *(ulong *)(this + 200);
  uVar7 = *(ulong *)(this + 0xc0);
  uVar10 = uVar9;
  if (uVar9 <= uVar11) {
    if (uVar9 < uVar7) goto LAB_00100abb;
    if (uVar7 < uVar9) {
      lVar3 = uVar7 * 0x30;
      do {
        uVar7 = uVar7 + 1;
...
LAB_00100cc5:
  ...
  if (uVar11 == 0) {
    ...
    *(long *)(this + 0xd0) = lVar3;
    if (*(long *)(this + 0xc0) != 0) goto LAB_00100b38;
    uVar7 = 0;
LAB_00100ba6:
    lVar3 = uVar7 * 0x30;
    do {
...
LAB_00100abb:
      do {
        while (plVar2 = *(long **)(uVar10 * 0x30 + *(long *)(this + 0xd0) + 0x28),
              plVar2 == (long *)0x0) {
LAB_00100aae:
          uVar10 = uVar10 + 1;
          if (*(ulong *)(this + 0xc0) <= uVar10) goto LAB_00100af0;
        }
        if (*(code **)(*plVar2 + 0x18) == RefCount::refDec) {
          LOCK();
          plVar1 = plVar2 + 1;
        ...
        (**(code **)(*plVar2 + 0x18))();
        uVar10 = uVar10 + 1;
      } while (uVar10 < *(ulong *)(this + 0xc0));
LAB_00100af0:
      *(ulong *)(this + 0xc0) = uVar9;
      if (uVar11 == *(ulong *)(this + 200)) goto LAB_00100cc5;
    }
    puVar6 = *(undefined8 **)(this + 0xd0);
    lVar3 = (**(code **)(**(long **)(this + 0xb8) + 0x38))(*(long **)(this + 0xb8),uVar11 * 0x30,8);
    uVar7 = *(ulong *)(this + 0xc0);
    *(long *)(this + 0xd0) = lVar3;
    if (uVar7 != 0) {
LAB_00100b38:
    ...
    if (uVar7 < uVar9) goto LAB_00100ba6;
  }
...
LAB_00100c28:
  embree::Geometry::setNumTimeSteps((uint)this);
  return;
}



/* embree::TriangleMesh::TriangleMesh(embree::Device*) */

void __thiscall embree::TriangleMesh::TriangleMesh(TriangleMesh *this,Device *param_1)

{
  ...
  *(undefined ***)this = &PTR__TriangleMesh_00103328;
  ...
  *(long *)(this + 0xd0) = lVar7;
  if (uVar10 != 0) {
    ...
    if (uVar11 <= uVar10) goto LAB_00100f15;
  }
  lVar7 = uVar10 * 0x30;
  do {
    uVar10 = uVar10 + 1;
...
/* embree::sse2::createTriangleMesh(embree::Device*) */

TriangleMesh * embree::sse2::createTriangleMesh(Device *param_1)

{
  ...
  *(undefined ***)this = &PTR__TriangleMeshISA_00103128;
  return this;
}



/* embree::TriangleMesh::interpolate(RTCInterpolateArguments const*) */

void __thiscall
embree::TriangleMesh::interpolate(TriangleMesh *this,RTCInterpolateArguments *param_1)

{
  interpolate_impl<4>(this,param_1);
  return;
}
...
/* embree::TriangleMesh::getCompactVertexArray() const */

undefined8 __thiscall embree::TriangleMesh::getCompactVertexArray(TriangleMesh *this)
...
PrimRef * embree::sse2::TriangleMeshISA::createPrimRefArray
                    (PrimRef *param_1,range *param_2,ulong param_3,uint param_4)

{
  ...
  uVar7 = _LC5;
  puVar13 = (ulong *)CONCAT44(in_register_0000000c,param_4);
  auVar20._4_4_ = _LC7;
  auVar20._0_4_ = _LC7;
  auVar20._8_4_ = _LC7;
  auVar20._12_4_ = _LC7;
...
LAB_00101300:
    do {
      ...
      puVar8 = (uint *)(*(long *)(param_2 + 0x60) * uVar17 + *(long *)(param_2 + 0x58));
      uVar16 = plVar14[2];
      uVar18 = (ulong)*puVar8;
      if (((uVar18 < uVar16) && (uVar15 = (ulong)puVar8[1], uVar15 < uVar16)) &&
         (uVar19 = (ulong)puVar8[2], uVar19 < uVar16)) {
        if (*(uint *)(param_2 + 0x24) != 0) {
          uVar16 = 0;
          do {
            lVar10 = plVar14[1];
            lVar2 = *plVar14;
            pfVar9 = (float *)(lVar2 + uVar18 * lVar10);
            pfVar1 = (float *)(lVar2 + uVar15 * lVar10);
            auVar21._0_4_ = -(uint)(fVar6 < *pfVar9 && *pfVar9 < fVar5);
            auVar21._4_4_ = -(uint)(fVar6 < pfVar9[1] && pfVar9[1] < fVar5);
            auVar21._8_4_ = -(uint)(fVar6 < pfVar9[2] && pfVar9[2] < fVar5);
            auVar21._12_4_ = -(uint)(fVar6 < pfVar9[3] && pfVar9[3] < fVar5);
            pfVar9 = (float *)(lVar10 * uVar19 + lVar2);
            uVar12 = movmskps((int)lVar2,auVar21);
            if ((((~uVar12 & 7) != 0) ||
                (auVar23._4_4_ = -(uint)(fVar6 < pfVar1[1] && pfVar1[1] < fVar5),
                auVar23._0_4_ = -(uint)(fVar6 < *pfVar1 && *pfVar1 < fVar5),
                auVar23._8_4_ = -(uint)(fVar6 < pfVar1[2] && pfVar1[2] < fVar5),
                auVar23._12_4_ = -(uint)(fVar6 < pfVar1[3] && pfVar1[3] < fVar5),
                uVar12 = movmskps(0,auVar23), (~uVar12 & 7) != 0)) ||
               (auVar22._0_4_ = -(uint)(*pfVar9 < fVar5 && fVar6 < *pfVar9),
               auVar22._4_4_ = -(uint)(pfVar9[1] < fVar5 && fVar6 < pfVar9[1]),
               auVar22._8_4_ = -(uint)(fVar6 < pfVar9[2] && pfVar9[2] < fVar5),
               auVar22._12_4_ = -(uint)(pfVar9[3] < fVar5 && fVar6 < pfVar9[3]),
               uVar12 = movmskps((int)pfVar9,auVar22), (~uVar12 & 7) != 0)) {
              uVar17 = uVar17 + 1;
              if (puVar13[1] <= uVar17) {
                return param_1;
              }
        ...
        auVar20 = *(undefined1 (*) [16])(lVar2 + uVar18 * lVar10);
        auVar21 = *(undefined1 (*) [16])(lVar2 + uVar15 * lVar10);
...
void embree::sse2::TriangleMeshISA::createPrimRefArrayMB
               (vector_t *param_1,ulong param_2,range *param_3,ulong param_4,uint param_5)

{
  ...
  *(undefined1 (*) [16])(param_1 + 0x30) = auVar29;
  ...
  if (uVar18 < *(ulong *)(CONCAT44(in_register_00000084,param_5) + 8)) {
    do {
      ...
      if (((uVar13 < uVar2) && (uVar19 = (ulong)puVar20[1], uVar19 < uVar2)) &&
         (uVar21 = (ulong)puVar20[2], uVar21 < uVar2)) {
        plVar14 = (long *)(lVar15 + param_4 * 0x30);
        lVar3 = *plVar14;
        lVar4 = plVar14[1];
        auVar29 = *(undefined1 (*) [16])(lVar3 + uVar13 * lVar4);
        auVar23._4_4_ = -(uint)(fVar11 < auVar29._4_4_ && auVar29._4_4_ < fVar10);
        auVar23._0_4_ = -(uint)(fVar11 < auVar29._0_4_ && auVar29._0_4_ < fVar10);
        auVar23._8_4_ = -(uint)(fVar11 < auVar29._8_4_ && auVar29._8_4_ < fVar10);
        auVar23._12_4_ = -(uint)(fVar11 < auVar29._12_4_ && auVar29._12_4_ < fVar10);
        uVar17 = movmskps((int)(uVar13 * lVar4),auVar23);
        if ((~uVar17 & 7) == 0) {
          auVar23 = *(undefined1 (*) [16])(lVar3 + uVar19 * lVar4);
          auVar24._4_4_ = -(uint)(fVar11 < auVar23._4_4_ && auVar23._4_4_ < fVar10);
          auVar24._0_4_ = -(uint)(fVar11 < auVar23._0_4_ && auVar23._0_4_ < fVar10);
          auVar24._8_4_ = -(uint)(fVar11 < auVar23._8_4_ && auVar23._8_4_ < fVar10);
          auVar24._12_4_ = -(uint)(fVar11 < auVar23._12_4_ && auVar23._12_4_ < fVar10);
          uVar17 = movmskps((int)(uVar19 * lVar4),auVar24);
          if ((~uVar17 & 7) == 0) {
            auVar24 = *(undefined1 (*) [16])(lVar3 + lVar4 * uVar21);
            auVar22._4_4_ = -(uint)(fVar11 < auVar24._4_4_ && auVar24._4_4_ < fVar10);
            auVar22._0_4_ = -(uint)(fVar11 < auVar24._0_4_ && auVar24._0_4_ < fVar10);
            auVar22._8_4_ = -(uint)(fVar11 < auVar24._8_4_ && auVar24._8_4_ < fVar10);
            auVar22._12_4_ = -(uint)(fVar11 < auVar24._12_4_ && auVar24._12_4_ < fVar10);
            uVar17 = movmskps((int)(lVar4 * uVar21),auVar22);
            if ((~uVar17 & 7) == 0) {
              ...
              if ((~uVar17 & 7) == 0) {
                ...
                if ((~uVar17 & 7) == 0) {
                  ...
                  if ((~uVar17 & 7) == 0) {
                    auVar22 = minps(auVar29,auVar23);
                    auVar29 = maxps(auVar29,auVar23);
                    *(long *)(param_1 + 0x48) = *(long *)(param_1 + 0x48) + 1;
                    lVar15 = in_R9 * 0x20;
                    in_R9 = in_R9 + 1;
                    auVar23 = minps(auVar22,auVar24);
                    auVar22 = maxps(auVar29,auVar24);
                    local_48._0_12_ = auVar23._0_12_;
                    local_48._12_4_ = in_stack_00000008;
                    auVar29 = local_48._0_16_;
                    auVar24 = minps(*(undefined1 (*) [16])param_1,local_48._0_16_);
                    local_48._0_12_ = auVar22._0_12_;
                    local_48._12_4_ = (float)uVar18;
                    fVar25 = auVar23._0_4_ + auVar22._0_4_;
                    fVar26 = auVar23._4_4_ + auVar22._4_4_;
                    fVar27 = auVar23._8_4_ + auVar22._8_4_;
                    fVar28 = in_stack_00000008 + (float)uVar18;
                    *(undefined1 (*) [16])param_1 = auVar24;
                    auVar23 = maxps(*(undefined1 (*) [16])(param_1 + 0x10),local_48._0_16_);
                    *(undefined1 (*) [16])(param_1 + 0x10) = auVar23;
                    auVar8._4_4_ = fVar26;
                    auVar8._0_4_ = fVar25;
                    auVar8._8_4_ = fVar27;
                    auVar8._12_4_ = fVar28;
                    auVar23 = minps(*(undefined1 (*) [16])(param_1 + 0x20),auVar8);
                    *(undefined1 (*) [16])(param_1 + 0x20) = auVar23;
                    auVar9._4_4_ = fVar26;
                    auVar9._0_4_ = fVar25;
                    auVar9._8_4_ = fVar27;
                    auVar9._12_4_ = fVar28;
                    auVar23 = maxps(*(undefined1 (*) [16])(param_1 + 0x30),auVar9);
                    *(undefined1 (*) [16])(param_1 + 0x30) = auVar23;
      ...
      uVar18 = uVar18 + 1;
    } while (uVar18 < *(ulong *)(CONCAT44(in_register_00000084,param_5) + 8));
  }
  return;
}
...
/* embree::TriangleMesh::updateBuffer(RTCBufferType, unsigned int) [clone .cold] */

void embree::TriangleMesh::updateBuffer(void)
...
/* embree::TriangleMesh::commit() [clone .cold] */

void embree::TriangleMesh::commit(void)
...
/* embree::TriangleMesh::getBuffer(RTCBufferType, unsigned int) [clone .cold] */

void embree::TriangleMesh::getBuffer(void)
...
/* embree::TriangleMesh::setBuffer(RTCBufferType, unsigned int, RTCFormat,
   embree::Ref<embree::Buffer> const&, unsigned long, unsigned long, unsigned int) [clone .cold] */

void embree::TriangleMesh::setBuffer(void)
...
/* embree::sse2::TriangleMeshISA::createPrimRefMBArray(embree::vector_t<embree::PrimRefMB,
   embree::aligned_monitored_allocator<embree::PrimRefMB, 16ul> >&, embree::BBox<float> const&,
   embree::range<unsigned long> const&, unsigned long, unsigned int) const */

vector_t *
embree::sse2::TriangleMeshISA::createPrimRefMBArray
          (vector_t *param_1,BBox *param_2,range *param_3,ulong param_4,uint param_5)
  ...
  if (uVar22 < puVar21[1]) {
    do {
      while( true ) {
        ...
        fVar25 = _LC14 * fVar37 * fVar31;
        if ((float)(_LC20 & (uint)fVar25) < _LC15) {
        ...
        fVar25 = _LC17 * fVar36 * fVar31;
        if ((float)(_LC20 & (uint)fVar25) < _LC15) {
          fVar25 = (float)((uint)((float)(int)fVar25 +
                                 (float)(-(uint)((float)(int)fVar25 < fVar25) & (uint)_LC12)) |
                          ~_LC20 & (uint)fVar25);
        }
        ...
        if (((uVar11 < uVar5) && (uVar15 = (ulong)puVar13[1], uVar15 < uVar5)) &&
           (uVar14 = (ulong)puVar13[2], uVar14 < uVar5)) break;
LAB_00101a20:
        uVar22 = uVar22 + 1;
        if (puVar21[1] <= uVar22) {
          return param_1;
      ...
      if (uVar24 <= (ulong)(long)(int)fVar25) {
        ...
        do {
          ...
          auVar51._0_4_ = -(uint)(_LC3 < *pfVar1 && *pfVar1 < fVar8);
          auVar51._4_4_ = -(uint)(_LC3 < pfVar1[1] && pfVar1[1] < fVar8);
          auVar51._8_4_ = -(uint)(_LC3 < pfVar1[2] && pfVar1[2] < fVar8);
          auVar51._12_4_ = -(uint)(_LC3 < pfVar1[3] && pfVar1[3] < fVar8);
          uVar16 = movmskps((int)(uVar11 * lVar6),auVar51);
          if ((~uVar16 & 7) != 0) goto LAB_00101a20;
          pfVar1 = (float *)(lVar7 + uVar15 * lVar6);
          auVar40._0_4_ = -(uint)(_LC3 < *pfVar1 && *pfVar1 < fVar8);
          auVar40._4_4_ = -(uint)(_LC3 < pfVar1[1] && pfVar1[1] < fVar8);
          auVar40._8_4_ = -(uint)(_LC3 < pfVar1[2] && pfVar1[2] < fVar8);
          auVar40._12_4_ = -(uint)(_LC3 < pfVar1[3] && pfVar1[3] < fVar8);
          uVar16 = movmskps((int)(uVar15 * lVar6),auVar40);
          if ((~uVar16 & 7) != 0) goto LAB_00101a20;
          pfVar1 = (float *)(lVar7 + lVar6 * uVar14);
          auVar45._0_4_ = -(uint)(_LC3 < *pfVar1 && *pfVar1 < fVar8);
          auVar45._4_4_ = -(uint)(_LC3 < pfVar1[1] && pfVar1[1] < fVar8);
          auVar45._8_4_ = -(uint)(_LC3 < pfVar1[2] && pfVar1[2] < fVar8);
          auVar45._12_4_ = -(uint)(_LC3 < pfVar1[3] && pfVar1[3] < fVar8);
      ...
      fVar25 = fVar26;
      if ((float)(_LC20 & (uint)fVar26) < _LC15) {
        fVar25 = (float)(~_LC20 & (uint)fVar26 |
                        (uint)((float)(int)fVar26 -
                              (float)(-(uint)(fVar26 < (float)(int)fVar26) & (uint)_LC12)));
      }
      fVar34 = fVar43;
      if ((float)(_LC20 & (uint)fVar43) < _LC15) {
        fVar34 = (float)(~_LC20 & (uint)fVar43 |
                        (uint)((float)(int)fVar43 +
                              (float)(-(uint)((float)(int)fVar43 < fVar43) & (uint)_LC12)));
      }
      iVar19 = (int)fVar25;
      if (fVar25 <= 0.0) {
        local_94 = 0;
      ...
      auVar46._0_4_ = __LC18 * fVar26 + __LC18 * fVar44 + __LC18 * fVar50 + __LC18 * fVar27;
      auVar46._4_4_ =
           _UNK_00103554 * fVar43 + _UNK_00103554 * fVar47 +
           _UNK_00103554 * fVar53 + _UNK_00103554 * fVar28;
      auVar46._8_4_ =
           _UNK_00103558 * fVar34 + _UNK_00103558 * fVar48 +
           _UNK_00103558 * fVar54 + _UNK_00103558 * fVar29;
      auVar46._12_4_ =
           _UNK_0010355c * fVar20 + _UNK_0010355c * (float)uVar22 +
           _UNK_0010355c * fVar20 + _UNK_0010355c * in_stack_00000008;
...
/* embree::TriangleMesh::~TriangleMesh() */

void __thiscall embree::TriangleMesh::~TriangleMesh(TriangleMesh *this)
...
/* embree::sse2::TriangleMeshISA::~TriangleMeshISA() */

void __thiscall embree::sse2::TriangleMeshISA::~TriangleMeshISA(TriangleMeshISA *this)

{
  *(undefined ***)this = &PTR__TriangleMeshISA_00103128;
  TriangleMesh::~TriangleMesh((TriangleMesh *)this);
  return;
}
...
PrimRef * embree::sse2::TriangleMeshISA::createPrimRefArrayMB
                    (PrimRef *param_1,BBox *param_2,range *param_3,ulong param_4,uint param_5)
  ...
  if ((fVar24 <= fVar26) && (uVar21 = *puVar20, uVar21 < puVar20[1])) {
    do {
      while( true ) {
        ...
        fVar27 = _LC14 * fVar37 * fVar36;
        if ((float)(_LC20 & (uint)fVar27) < _LC15) {
          fVar27 = (float)((uint)((float)(int)fVar27 -
                                 (float)(-(uint)(fVar27 < (float)(int)fVar27) & _LC12)) |
                          ~_LC20 & (uint)fVar27);
        }
        uVar23 = 0;
        if (0.0 <= fVar27) {
        ...
        fVar27 = _LC17 * fVar35 * fVar36;
        if ((float)(_LC20 & (uint)fVar27) < _LC15) {
          fVar27 = (float)((uint)((float)(int)fVar27 +
                                 (float)(-(uint)((float)(int)fVar27 < fVar27) & _LC12)) |
                          ~_LC20 & (uint)fVar27);
        }
        ...
        if (((uVar15 < uVar2) && (uVar14 = (ulong)puVar13[1], uVar14 < uVar2)) &&
           (uVar16 = (ulong)puVar13[2], uVar16 < uVar2)) break;
LAB_001024e9:
        uVar21 = uVar21 + 1;
        if (puVar20[1] <= uVar21) {
          return param_1;
      ...
      if (uVar23 <= (ulong)(long)(int)fVar27) {
        ...
        do {
          ...
          if ((~uVar18 & 7) != 0) goto LAB_001024e9;
      ...
      fVar27 = fVar28;
      if ((float)(_LC20 & (uint)fVar28) < _LC15) {
        fVar27 = (float)(~_LC20 & (uint)fVar28 |
                        (uint)((float)(int)fVar28 -
                              (float)(-(uint)(fVar28 < (float)(int)fVar28) & _LC12)));
      }
      fVar31 = fVar45;
      if ((float)(_LC20 & (uint)fVar45) < _LC15) {
        fVar31 = (float)(~_LC20 & (uint)fVar45 |
                        (uint)((float)(int)fVar45 +
                              (float)(-(uint)((float)(int)fVar45 < fVar45) & 0x3f800000)));
      }
      iVar12 = (int)fVar27;
      if (fVar27 <= 0.0) {
        iVar19 = 0;
...
/* embree::sse2::TriangleMeshISA::vlinearBounds(unsigned long, embree::BBox<float> const&) const */

ulong embree::sse2::TriangleMeshISA::vlinearBounds(ulong param_1,BBox *param_2)

{
  ...
  fVar12 = fVar15;
  if ((float)((uint)fVar15 & _LC20) < _LC15) {
    fVar12 = (float)((uint)((float)(int)fVar15 -
                           (float)(-(uint)(fVar15 < (float)(int)fVar15) & (uint)_LC12)) |
                    ~_LC20 & (uint)fVar15);
  }
  fVar20 = fVar40;
  if ((float)((uint)fVar40 & _LC20) < _LC15) {
    fVar20 = (float)((uint)((float)(-(uint)((float)(int)fVar40 < fVar40) & (uint)_LC12) +
                           (float)(int)fVar40) | ~_LC20 & (uint)fVar40);
  }
  iVar4 = (int)fVar12;
  if (fVar12 <= 0.0) {
    lVar9 = 0;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* void embree::TriangleMesh::interpolate_impl<4>(RTCInterpolateArguments const*) */

void __thiscall
embree::TriangleMesh::interpolate_impl<4>(TriangleMesh *this,RTCInterpolateArguments *param_1)

{
  ...
  iVar24 = _UNK_0010356c;
  iVar23 = _UNK_00103568;
  iVar22 = _UNK_00103564;
  iVar21 = __LC21;
  ...
  if (*(int *)(param_1 + 0x14) == 2) {
    plVar25 = (long *)((ulong)*(uint *)(param_1 + 0x18) * 0x30 + *(long *)(this + 0xf0));
    lVar31 = *plVar25;
    uVar7 = *(uint *)(plVar25 + 1);
  }
  else {
    plVar25 = (long *)((ulong)*(uint *)(param_1 + 0x18) * 0x30 + *(long *)(this + 0xd0));
    lVar31 = *plVar25;
    uVar7 = *(uint *)(plVar25 + 1);
  }
  uVar30 = (ulong)uVar7;
  if (uVar6 != 0) {
    uVar28 = 0;
    fVar36 = (_LC12 - fVar3) - fVar4;
    do {
      iVar27 = (int)uVar28;
      lVar26 = uVar28 * 4;
      puVar29 = (uint *)(*(long *)(this + 0x60) * (ulong)uVar5 + *(long *)(this + 0x58));
      lVar2 = lVar31 + lVar26;
      uVar32 = -(uint)(iVar27 + iVar21 < (int)uVar6);
      uVar33 = -(uint)(iVar27 + iVar22 < (int)uVar6);
      uVar34 = -(uint)(iVar27 + iVar23 < (int)uVar6);
      uVar35 = -(uint)(iVar27 + iVar24 < (int)uVar6);
      puVar1 = (uint *)(lVar2 + *puVar29 * uVar30);
      fVar37 = (float)(*puVar1 & uVar32);
      fVar38 = (float)(puVar1[1] & uVar33);
      fVar39 = (float)(puVar1[2] & uVar34);
      fVar40 = (float)(puVar1[3] & uVar35);
      puVar1 = (uint *)(lVar2 + puVar29[1] * uVar30);
      uVar7 = *puVar1;
      uVar14 = puVar1[1];
      uVar15 = puVar1[2];
      uVar16 = puVar1[3];
      puVar1 = (uint *)(lVar2 + puVar29[2] * uVar30);
      uVar17 = *puVar1;
      uVar18 = puVar1[1];
      uVar19 = puVar1[2];
      uVar20 = puVar1[3];
      if (lVar9 != 0) {
        puVar1 = (uint *)(lVar9 + lVar26);
        *puVar1 = (uint)(fVar3 * (float)(uVar7 & uVar32) + fVar4 * (float)(uVar17 & uVar32) +
                        fVar36 * fVar37) & uVar32 | ~uVar32 & *puVar1;
        puVar1[1] = (uint)(fVar3 * (float)(uVar14 & uVar33) + fVar4 * (float)(uVar18 & uVar33) +
                          fVar36 * fVar38) & uVar33 | ~uVar33 & puVar1[1];
        puVar1[2] = (uint)(fVar3 * (float)(uVar15 & uVar34) + fVar4 * (float)(uVar19 & uVar34) +
                          fVar36 * fVar39) & uVar34 | ~uVar34 & puVar1[2];
        puVar1[3] = (uint)(fVar3 * (float)(uVar16 & uVar35) + fVar4 * (float)(uVar20 & uVar35) +
                          fVar36 * fVar40) & uVar35 | ~uVar35 & puVar1[3];
      }
      if (lVar10 != 0) {
        puVar1 = (uint *)(lVar10 + lVar26);
        *puVar1 = (uint)((float)(uVar7 & uVar32) - fVar37) & uVar32 | ~uVar32 & *puVar1;
        puVar1[1] = (uint)((float)(uVar14 & uVar33) - fVar38) & uVar33 | ~uVar33 & puVar1[1];
        puVar1[2] = (uint)((float)(uVar15 & uVar34) - fVar39) & uVar34 | ~uVar34 & puVar1[2];
        puVar1[3] = (uint)((float)(uVar16 & uVar35) - fVar40) & uVar35 | ~uVar35 & puVar1[3];
        puVar1 = (uint *)(lVar8 + lVar26);
        *puVar1 = (uint)((float)(uVar17 & uVar32) - fVar37) & uVar32 | ~uVar32 & *puVar1;
        puVar1[1] = (uint)((float)(uVar18 & uVar33) - fVar38) & uVar33 | ~uVar33 & puVar1[1];
        puVar1[2] = (uint)((float)(uVar19 & uVar34) - fVar39) & uVar34 | ~uVar34 & puVar1[2];
        puVar1[3] = (uint)((float)(uVar20 & uVar35) - fVar40) & uVar35 | ~uVar35 & puVar1[3];
      }
      if (lVar11 != 0) {
        puVar1 = (uint *)(lVar11 + lVar26);
        *puVar1 = ~uVar32 & *puVar1;
        puVar1[1] = ~uVar33 & puVar1[1];
        puVar1[2] = ~uVar34 & puVar1[2];
        puVar1[3] = ~uVar35 & puVar1[3];
        puVar1 = (uint *)(lVar12 + lVar26);
        puVar29 = (uint *)(lVar26 + lVar13);
        *puVar1 = ~uVar32 & *puVar1;
        puVar1[1] = ~uVar33 & puVar1[1];
        puVar1[2] = ~uVar34 & puVar1[2];
        puVar1[3] = ~uVar35 & puVar1[3];
        *puVar29 = ~uVar32 & *puVar29;
        puVar29[1] = ~uVar33 & puVar29[1];
        puVar29[2] = ~uVar34 & puVar29[2];
        puVar29[3] = ~uVar35 & puVar29[3];
      }
      uVar28 = (ulong)(iVar27 + 4U);
    } while (iVar27 + 4U < uVar6);
  }
  return;
}

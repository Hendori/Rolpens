...

{
  ...
  *(undefined8 *)(this + 0x1a8) = 0;
  ...
  local_58 = "text";
  *(undefined ***)this = &PTR__initialize_classv_00107338;
  uVar3 = _LC30;
...
{
  *(undefined ***)this = &PTR__initialize_classv_001071d8;
...
LAB_00107136:
    ...
    lVar4 = puVar5[-1];
    if (param_1 <= lVar4) goto LAB_00106fb1;
  }
  else {
    if (lVar4 != 0) {
      uVar3 = _realloc(this,lVar9);

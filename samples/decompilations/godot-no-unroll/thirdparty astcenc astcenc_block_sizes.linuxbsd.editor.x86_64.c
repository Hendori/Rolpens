...

{
  ...
  if ((byte)bVar3 < 0x41) {
    ...
    if (bVar3 != (block_size_descriptor)0x0) {
      pcVar5 = local_108;
      if (7 < (byte)bVar3) {
        for (uVar2 = (ulong)((byte)bVar3 >> 3); uVar2 != 0; uVar2 = uVar2 - 1) {
          pcVar5[0] = '\0';
          pcVar5[1] = '\0';
          pcVar5[2] = '\0';
          pcVar5[3] = '\0';
          ...
          pcVar5[6] = '\0';
          pcVar5[7] = '\0';
          pcVar5 = pcVar5 + ((ulong)bVar1 * -2 + 1) * 8;
        }
      }
      if (((byte)bVar3 & 4) != 0) {
        pcVar5[0] = '\0';
    ...
    pbVar4 = param_1 + 0xe091b0;
    while (pbVar4 != param_1 + 0xe091f0) {
      bVar1 = astc::rand(auStack_118);
      bVar3 = (block_size_descriptor)(bVar1 % (byte)param_1[3]);
      if (local_108[(byte)bVar3] == '\0') {
        *pbVar4 = bVar3;
        pbVar4 = pbVar4 + 1;
        local_108[(byte)bVar3] = '\x01';
      }
    }
  }
...
LAB_00100e96:
          uVar17 = uVar17 + 1;
          if (uVar17 == 0x800) goto LAB_00101036;
        }
        uVar27 = (uint)uVar17;
        uVar7 = (uint)(uVar17 >> 9);
        ...
        if ((uVar17 & 3) == 0) {
          ...
          if ((uVar17 & 0xc) == 0) goto LAB_00100e96;
...
LAB_00101036:
  ...
  local_7fc = 2;
LAB_0010024f:
  if (param_2 < 2) goto LAB_0010107d;
  local_78c = 0;
  do {
    local_7b8 = 2;
  ...
  uVar6 = local_78c;
  uVar5 = _LC2;
  if (0x56 < local_78c) goto LAB_00100e2e;
  goto LAB_00100e10;
LAB_0010107d:
  local_7fc = local_7fc + 1;
  if (param_1 < local_7fc) goto LAB_0010108d;
  goto LAB_0010024f;
}
    ...
    do {
      if (*(short *)(param_5 + uVar19 * 2 + 0xac7560) == -1) {
        ...
        if ((uVar19 & 3) == 0) {
          ...
          if ((uVar19 & 0xc) == 0) goto LAB_00101390;
          ...
          if (uVar41 == 2) {
            ...
            if (uVar45 == 1) {
              ...
              if (uVar45 - 2 < 2) goto LAB_00101390;
              uVar41 = 10;
              uVar25 = (iVar26 + 1) * 0x3c;
              local_3d3 = local_3d3 & 1;
              local_470 = 0x3c;
        ...
        if ((iVar26 - 0x18U < 0x49 && uVar25 < 0x41) && (uVar45 <= param_1 && uVar41 <= param_2)) {
          if (local_468 < 2) {
            if (local_3d3 == 0) {
              if (local_468 != 0) goto LAB_001014bf;
...
LAB_00101c37:
                    ...
                    if (bVar2 != (block_size_descriptor)0x4) goto LAB_00101c37;
                  }
                  lVar40 = lVar40 + 1;
                  pbVar13 = pbVar13 + 1;
                ...
                do {
                  while( true ) {
                    ...
                    bVar28 = SUB41(iVar30,0);
                    iVar49 = iVar49 + 1;
                    if (iVar49 == 0xc) goto LAB_001020db;
                  }
                  iVar49 = iVar49 + 1;
                } while (iVar49 != 0xc);
LAB_001020db:

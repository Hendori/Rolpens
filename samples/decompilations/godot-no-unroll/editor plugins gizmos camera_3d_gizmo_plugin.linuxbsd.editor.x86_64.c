...
/* Camera3DGizmoPlugin::get_priority() const */

undefined8 Camera3DGizmoPlugin::get_priority(void)
...
/* Camera3DGizmoPlugin::has_gizmo(Node3D*) */

bool __thiscall Camera3DGizmoPlugin::has_gizmo(Camera3DGizmoPlugin *this,Node3D *param_1)
...
/* Camera3DGizmoPlugin::get_handle_value(EditorNode3DGizmo const*, int, bool) const */

EditorNode3DGizmo *
Camera3DGizmoPlugin::get_handle_value(EditorNode3DGizmo *param_1,int param_2,bool param_3)
...
/* Camera3DGizmoPlugin::get_gizmo_name() const */

Camera3DGizmoPlugin * __thiscall Camera3DGizmoPlugin::get_gizmo_name(Camera3DGizmoPlugin *this)
...
/* Camera3DGizmoPlugin::get_handle_name(EditorNode3DGizmo const*, int, bool) const */

EditorNode3DGizmo *
Camera3DGizmoPlugin::get_handle_name(EditorNode3DGizmo *param_1,int param_2,bool param_3)
...
/* Camera3DGizmoPlugin::commit_handle(EditorNode3DGizmo const*, int, bool, Variant const&, bool) */

void __thiscall
Camera3DGizmoPlugin::commit_handle
          (Camera3DGizmoPlugin *this,EditorNode3DGizmo *param_1,int param_2,bool param_3,
...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_00105f70;
  ...
  if ((Camera3DGizmoPlugin()::{lambda()#1}::operator()()::sname == '\0') &&
     (iVar6 = __cxa_guard_acquire(&Camera3DGizmoPlugin()::{lambda()#1}::operator()()::sname),
     iVar6 != 0)) {
    _scs_create((char *)&Camera3DGizmoPlugin()::{lambda()#1}::operator()()::sname,true);
    __cxa_atexit(StringName::~StringName,&Camera3DGizmoPlugin()::{lambda()#1}::operator()()::sname,
                 &__dso_handle);
    __cxa_guard_release(&Camera3DGizmoPlugin()::{lambda()#1}::operator()()::sname);
  }
  (*pcVar3)((StrRange *)&local_80,pOVar7,&Camera3DGizmoPlugin()::{lambda()#1}::operator()()::sname);
  ...
  if (((local_80 == (Object *)0x0) ||
      (cVar5 = RefCounted::unreference(), pOVar2 = local_80, cVar5 == '\0')) ||
...
/* Camera3DGizmoPlugin::_find_closest_angle_to_half_pi_arc(Vector3 const&, Vector3 const&, float,
   Transform3D const&) */
...

{
  ...
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return CONCAT44((int)((ulong)(_LC34 - (double)fVar5) >> 0x20),
                    (float)(_LC34 - (double)fVar5) * __LC35);
  }
                    /* WARNING: Subroutine does not return */
  __stack_chk_fail();
}
...
void __thiscall
Camera3DGizmoPlugin::set_handle
          (Camera3DGizmoPlugin *this,EditorNode3DGizmo *param_1,int param_2,bool param_3,
...

{
  ...
  fStack_fc = (_LC41 * fVar8 + fVar4) * fStack_94 + ((float)local_130 * _LC41 + fVar3) * local_98 +
              fStack_90 * fVar10 + fStack_74;
  local_f8 = CONCAT44(fVar11 * fStack_80 + fStack_7c * fVar12 + fVar10 * local_78 + fStack_1c0,
                      fVar12 * local_88 + fStack_8c * fVar11 + fVar10 * fStack_84 + fStack_1c4);
  iVar1 = Camera3D::get_projection();
  if (iVar1 == 0) {
    Node3D::get_global_transform();
    fVar3 = (float)_find_closest_angle_to_half_pi_arc
                             ((Vector3 *)&local_108,(Vector3 *)&fStack_fc,_LC21,
                              (Transform3D *)local_68);
    dVar6 = (double)fVar3 + (double)fVar3;
    dVar7 = _LC36;
    if ((_LC36 <= dVar6) && (dVar7 = _LC37, dVar6 <= _LC37)) {
      dVar7 = dVar6;
    }
    ...
    if (iVar1 == 0) {
      ...
      local_68[2] = _LC43;
      Geometry3D::get_closest_points_between_segments
                ((Vector3 *)local_68,(Vector3 *)&local_120,(Vector3 *)&local_108,
                 (Vector3 *)&fStack_fc,(Vector3 *)local_114,(Vector3 *)local_e8);
    ...
    fVar4 = _LC38;
    if ((_LC45 <= (double)fVar3) && (fVar4 = fVar3, _LC39 < fVar3)) {
      fVar4 = _LC39;
    }
...
void __thiscall Camera3DGizmoPlugin::redraw(Camera3DGizmoPlugin *this,EditorNode3DGizmo *param_1)
...
LAB_00101735:
  ...
  if (((local_578 != (EditorNode3DGizmo *)0x0) &&
      (cVar8 = RefCounted::unreference(), pEVar7 = local_578, cVar8 != '\0')) &&
     (cVar8 = predelete_handler((Object *)local_578), cVar8 != '\0')) {
    (**(code **)(*(long *)pEVar7 + 0x140))(pEVar7);
...
LAB_00101830:
  ...
  fVar23 = _LC21;
  if (((int)uVar12 < 1) || (iVar9 = (int)((ulong)uVar12 >> 0x20), iVar9 < 1)) {
    local_630 = _LC21;
    fVar15 = _LC21;
  }
  else {
...
LAB_0010190f:
  ...
  if (local_580 != 0) {
    ...
    if (((local_5a0 != (Object *)0x0) &&
        (pOVar11 = (Object *)__dynamic_cast(local_5a0,&Object::typeinfo,&Material::typeinfo,0),
        pOVar11 != (Object *)0x0)) &&
       (local_568 = pOVar11, cVar8 = RefCounted::reference(), cVar8 == '\0')) {
      local_568 = (Object *)0x0;
    }
    EditorNode3DGizmo::add_handles
              ((Vector *)param_1,local_588,(Vector *)&local_568,SUB81(&local_578,0),false);
    if (((local_568 != (Object *)0x0) &&
        (cVar8 = RefCounted::unreference(), pOVar11 = local_568, cVar8 != '\0')) &&
       (cVar8 = predelete_handler(local_568), cVar8 != '\0')) {
      (**(code **)(*(long *)pOVar11 + 0x140))(pOVar11);
      Memory::free_static(pOVar11,false);
    }
    if (((local_5a0 != (Object *)0x0) &&
        (cVar8 = RefCounted::unreference(), pOVar11 = local_5a0, cVar8 != '\0')) &&
       (cVar8 = predelete_handler(local_5a0), cVar8 != '\0')) {
      (**(code **)(*(long *)pOVar11 + 0x140))(pOVar11);
      Memory::free_static(pOVar11,false);
    }
    lVar6 = local_5b0;
    ...
    if (((local_5a8 != (Object *)0x0) &&
        (cVar8 = RefCounted::unreference(), pOVar11 = local_5a8, cVar8 != '\0')) &&
       (cVar8 = predelete_handler(local_5a8), cVar8 != '\0')) {
      (**(code **)(*(long *)pOVar11 + 0x140))(pOVar11);
      Memory::free_static(pOVar11,false);
    }
    lVar6 = local_570;
  ...
  if (((local_5b8 != (Object *)0x0) &&
      (cVar8 = RefCounted::unreference(), pOVar11 = local_5b8, cVar8 != '\0')) &&
     (cVar8 = predelete_handler(local_5b8), cVar8 != '\0')) {
    (**(code **)(*(long *)pOVar11 + 0x140))(pOVar11);
    Memory::free_static(pOVar11,false);
  }
  if (((local_5c0 != (Object *)0x0) &&
      (cVar8 = RefCounted::unreference(), pOVar11 = local_5c0, cVar8 != '\0')) &&
     (cVar8 = predelete_handler(local_5c0), cVar8 != '\0')) {
    (**(code **)(*(long *)pOVar11 + 0x140))(pOVar11);
    Memory::free_static(pOVar11,false);
  }
  lVar6 = local_580;
...
/* Camera3DGizmoPlugin::is_class_ptr(void*) const */

uint __thiscall Camera3DGizmoPlugin::is_class_ptr(Camera3DGizmoPlugin *this,void *param_1)

{
  return (uint)CONCAT71(0x1062,(undefined4 *)param_1 ==
                               &EditorNode3DGizmoPlugin::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1062,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1062,(undefined4 *)param_1 == &Resource::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1062,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1062,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}



/* Camera3DGizmoPlugin::_getv(StringName const&, Variant&) const */

undefined8 Camera3DGizmoPlugin::_getv(StringName *param_1,Variant *param_2)
...
/* Camera3DGizmoPlugin::_setv(StringName const&, Variant const&) */

undefined8 Camera3DGizmoPlugin::_setv(StringName *param_1,Variant *param_2)
...
/* Camera3DGizmoPlugin::_validate_propertyv(PropertyInfo&) const */

void Camera3DGizmoPlugin::_validate_propertyv(PropertyInfo *param_1)
...
/* Camera3DGizmoPlugin::_property_can_revertv(StringName const&) const */

undefined8 Camera3DGizmoPlugin::_property_can_revertv(StringName *param_1)
...
/* Camera3DGizmoPlugin::_property_get_revertv(StringName const&, Variant&) const */

undefined8 Camera3DGizmoPlugin::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* Camera3DGizmoPlugin::_notificationv(int, bool) */

void Camera3DGizmoPlugin::_notificationv(int param_1,bool param_2)
...
/* Camera3DGizmoPlugin::Camera3DGizmoPlugin() [clone .cold] */
...
/* Camera3DGizmoPlugin::_get_class_namev() const */

undefined8 * Camera3DGizmoPlugin::_get_class_namev(void)
...
LAB_001039f3:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"Camera3DGizmoPlugin");
      goto LAB_00103a5e;
    }
  }
  StringName::assign_static_unique_class_name
...
/* Camera3DGizmoPlugin::get_class() const */

void Camera3DGizmoPlugin::get_class(void)
...
/* Camera3DGizmoPlugin::_initialize_classv() */

void Camera3DGizmoPlugin::_initialize_classv(void)

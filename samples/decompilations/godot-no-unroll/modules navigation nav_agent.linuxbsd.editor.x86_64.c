...
/* NavAgent::_update_rvo_agent_properties() */

void __thiscall NavAgent::_update_rvo_agent_properties(NavAgent *this)

{
  ...
  if (this[0x1b0] == (NavAgent)0x0) {
    ...
    *(ulong *)(this + 0xf4) =
         CONCAT44((int)((ulong)*(undefined8 *)(this + 8) >> 0x20),(int)*(undefined8 *)(this + 0x38))
    ;
...
/* NavAgent::set_avoidance_enabled(bool) */

void __thiscall NavAgent::set_avoidance_enabled(NavAgent *this,bool param_1)
...
/* NavAgent::set_use_3d_avoidance(bool) */

void __thiscall NavAgent::set_use_3d_avoidance(NavAgent *this,bool param_1)
...
/* NavAgent::set_map(NavMap*) */

void __thiscall NavAgent::set_map(NavAgent *this,NavMap *param_1)
...
bool __thiscall NavAgent::is_map_changed(NavAgent *this)
...
/* NavAgent::set_avoidance_callback(Callable) */

void __thiscall NavAgent::set_avoidance_callback(NavAgent *this,Callable *param_2)
...
/* NavAgent::has_avoidance_callback() const */

void NavAgent::has_avoidance_callback(void)
...
void __thiscall NavAgent::dispatch_avoidance_callback(NavAgent *this)
...
/* NavAgent::set_neighbor_distance(float) */

void __thiscall NavAgent::set_neighbor_distance(NavAgent *this,float param_1)
...
/* NavAgent::set_max_neighbors(int) */

void __thiscall NavAgent::set_max_neighbors(NavAgent *this,int param_1)
...
/* NavAgent::set_time_horizon_agents(float) */

void __thiscall NavAgent::set_time_horizon_agents(NavAgent *this,float param_1)
...
/* NavAgent::set_time_horizon_obstacles(float) */

void __thiscall NavAgent::set_time_horizon_obstacles(NavAgent *this,float param_1)
...
/* NavAgent::set_radius(float) */

void __thiscall NavAgent::set_radius(NavAgent *this,float param_1)
...
/* NavAgent::set_height(float) */

void __thiscall NavAgent::set_height(NavAgent *this,float param_1)
...
/* NavAgent::set_max_speed(float) */

void __thiscall NavAgent::set_max_speed(NavAgent *this,float param_1)
...
/* NavAgent::set_position(Vector3) */

void NavAgent::set_position(undefined8 param_1,undefined4 param_2,long param_3)
...
/* NavAgent::set_target_position(Vector3) */

void NavAgent::set_target_position(undefined8 param_1,undefined4 param_2,long param_3)
...
/* NavAgent::set_velocity(Vector3) */

void NavAgent::set_velocity(undefined8 param_1,undefined4 param_2,long param_3)

{
  ...
  *(undefined4 *)(param_3 + 0x28) = param_2;
  if (*(char *)(param_3 + 0x1b1) != '\0') {
    if (*(char *)(param_3 + 0x1b0) == '\0') {
      *(ulong *)(param_3 + 0xd8) =
           CONCAT44(*(undefined4 *)(param_3 + 0x28),*(undefined4 *)(param_3 + 0x20));
    }
    else {
      *(undefined4 *)(param_3 + 0x130) = *(undefined4 *)(param_3 + 0x28);
      *(ulong *)(param_3 + 0x128) =
           CONCAT44(*(undefined4 *)(param_3 + 0x24),*(undefined4 *)(param_3 + 0x20));
    }
  }
  *(undefined1 *)(param_3 + 0x1d0) = 1;
  if ((*(SelfList **)(param_3 + 0x68) != (SelfList *)0x0) && (*(long *)(param_3 + 0x1e0) == 0)) {
...
/* NavAgent::set_velocity_forced(Vector3) */

void NavAgent::set_velocity_forced(undefined8 param_1,undefined4 param_2,long param_3)
...
void __thiscall NavAgent::update(NavAgent *this)
...
/* NavAgent::set_avoidance_mask(unsigned int) */

void __thiscall NavAgent::set_avoidance_mask(NavAgent *this,uint param_1)
...
/* NavAgent::set_avoidance_layers(unsigned int) */

void __thiscall NavAgent::set_avoidance_layers(NavAgent *this,uint param_1)
...
/* NavAgent::set_avoidance_priority(float) */

SelfList * NavAgent::set_avoidance_priority(float param_1)

{
  ...
  if (param_1 < 0.0) {
    pSVar1 = (SelfList *)
             _err_print_error("set_avoidance_priority","modules/navigation/nav_agent.cpp",0x149,
  ...
  if (_LC5 < param_1) {
    pSVar1 = (SelfList *)0x0;
    _err_print_error("set_avoidance_priority","modules/navigation/nav_agent.cpp",0x14a,
...
/* NavAgent::is_dirty() const */

NavAgent __thiscall NavAgent::is_dirty(NavAgent *this)
...
void __thiscall NavAgent::sync(NavAgent *this)
...
/* NavAgent::get_avoidance_data() const */

void NavAgent::get_avoidance_data(void)
...
/* NavAgent::set_paused(bool) */

void __thiscall NavAgent::set_paused(NavAgent *this,bool param_1)
...
/* NavAgent::get_paused() const */

NavAgent __thiscall NavAgent::get_paused(NavAgent *this)
...
/* NavAgent::request_sync() */

void __thiscall NavAgent::request_sync(NavAgent *this)
...
/* NavAgent::cancel_sync_request() */

void __thiscall NavAgent::cancel_sync_request(NavAgent *this)
...
void __thiscall NavAgent::NavAgent(NavAgent *this)

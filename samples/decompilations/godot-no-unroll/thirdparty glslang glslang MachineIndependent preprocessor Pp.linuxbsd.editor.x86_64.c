...
LAB_001016ee:
      ...
      if ((*(long *)(pIVar10 + 0x20) == 0) || (*(long *)(pIVar10 + 0x28) == 0)) {
        ...
        pTVar12 = (TokenizableIncludeFile *)PTR_vtable_0010aec0;
...
LAB_00102ae6:
      if (param_2) {
        ...
        *(undefined1 *)(plVar15 + 1) = 0;
        plVar15[2] = (long)this;
        *plVar15 = (long)&PTR__tZeroInput_0010abe8;
        local_4c8 = plVar15;
        ...
        if (pTVar18 != (TPpContext *)0x0) {
          ...
          if ((this + 0x18 != pTVar33) && (*(int *)(pTVar33 + 0x20) <= iVar7)) {
            ...
            if (((byte)pTVar33[0x70] & 4) == 0) {
              ...
              *(undefined1 *)(plVar15 + 1) = 0;
              plVar15[2] = (long)this;
              *plVar15 = (long)&PTR__tMacroInput_0010ab78;
...

{
  ...
  *plVar6 = (long)&PTR__tMarkerInput_0010aa98;
  local_48 = plVar6;
...
{
  *(undefined ***)this = &PTR__TInputScanner_0010aa78;
...

{
  ...
  *(undefined ***)this = &PTR__tMacroInput_0010ab78;
...
{
  *(undefined ***)this = &PTR__TokenizableIncludeFile_0010ab08;
  *(undefined ***)(this + 0x90) = &PTR__TInputScanner_0010aa78;
    ...
    *pcVar7 = (char)uVar14 + '0';
    ...
    if (uVar14 < 100) {
      *puVar13 = (ulong)(puVar13 + 2);
      ...
      local_118 = __LC10;
      uStack_110 = _UNK_0010add8;
      pcVar7 = (char *)(*puVar13 + uVar15);
      local_108 = __LC11;
      uStack_100 = _UNK_0010ade8;
      local_f8 = __LC12;
      uStack_f0 = _UNK_0010adf8;
      local_e8 = __LC13;
      uStack_e0 = _UNK_0010ae08;
      local_d8 = __LC14;
      uStack_d0 = _UNK_0010ae18;
      local_c8 = __LC15;
      uStack_c0 = _UNK_0010ae28;
      local_b8 = __LC16;
      uStack_b0 = _UNK_0010ae38;
      local_a8 = __LC17;
      uStack_a0 = _UNK_0010ae48;
      local_98 = __LC18;
      uStack_90 = _UNK_0010ae58;
      local_88 = __LC19;
      uStack_80 = _UNK_0010ae68;
      local_78 = __LC20;
      uStack_70 = _UNK_0010ae78;
      local_68 = __LC21;
      uStack_60 = (undefined1)_UNK_0010ae88;
...

{
  ...
  if ((ulong)(*(long *)(this + 0x18) - (long)puVar11 >> 3) < param_3) {
    ...
    uVar2 = (long)puVar11 - (long)puVar8 >> 3;
    if (0xfffffffffffffff - uVar2 < param_3) {
                    /* WARNING: Subroutine does not return */
    ...
    puVar4 = (undefined8 *)((long)param_2 + (lVar3 - (long)puVar8));
    puVar5 = puVar4;
    do {
      puVar6 = puVar5 + 1;
      *puVar5 = *param_4;
      puVar5 = puVar6;
    } while (puVar6 != puVar4 + param_3);
    lVar7 = lVar3;
    if (puVar8 != param_2) {
      lVar7 = 0;
      do {
        *(undefined8 *)(lVar3 + lVar7) = *(undefined8 *)((long)puVar8 + lVar7);
        lVar7 = lVar7 + 8;
      } while (lVar7 != (long)param_2 - (long)puVar8);
      lVar7 = lVar7 + lVar3;
    }
    lVar7 = lVar7 + param_3 * 8;
    if (puVar11 != param_2) {
      lVar9 = 0;
      do {
        *(undefined8 *)(lVar7 + lVar9) = *(undefined8 *)((long)param_2 + lVar9);
        lVar9 = lVar9 + 8;
      } while (lVar9 != (long)puVar11 - (long)param_2);
      lVar7 = lVar7 + lVar9;
    }
    *(long *)(this + 8) = lVar3;
    *(long *)(this + 0x10) = lVar7;
    *(long *)(this + 0x18) = lVar3 + lVar10;
    return;
  }
  uVar1 = *param_4;
  ...
  if (param_3 < uVar2) {
    lVar10 = 0;
    puVar8 = puVar11 + -param_3;
    if (puVar11 != puVar8) {
      do {
        *(undefined8 *)((long)puVar11 + lVar10) = *(undefined8 *)((long)puVar8 + lVar10);
        lVar10 = lVar10 + 8;
      } while (param_3 * 8 != lVar10);
    }
    ...
    *(undefined8 **)(this + 0x10) = puVar11 + param_3;
    ...
    if (lVar10 != 0) {
      ...
      puVar8 = puVar11 + lVar10;
    }
    lVar10 = (long)puVar8 + ((long)puVar11 - (long)param_2);
    if (puVar11 == param_2) {
      *(long *)(this + 0x10) = lVar10;
    }
    else {
      lVar3 = 0;
      do {
        *(undefined8 *)((long)puVar8 + lVar3) = *(undefined8 *)((long)param_2 + lVar3);
        lVar3 = lVar3 + 8;
...

{
  ...
  if (__src == pvVar1) {
    if (0xfffffffffffffffe < uVar2) goto LAB_00108c10;
...
LAB_00108c10:
  ...
  *(undefined8 *)((long)__dest_00 + __n) = *param_3;
  if ((long)__n < 1) {
    ...
    if (__src == (void *)0x0) goto LAB_00108bec;
  }
  else {
...

{
  ...
  __n = (long)param_2 - (long)__src;
  if (__src == pvVar1) {
    if (0xfffffffffffffffe < uVar2) goto LAB_00108da0;
...
LAB_00108da0:
  ...
  *(undefined4 *)((long)__dest_00 + __n) = *param_3;
  if ((long)__n < 1) {
    ...
    if (__src == (void *)0x0) goto LAB_00108d7b;
  }
  else {
    __dest_00 = memmove(__dest_00,__src,__n);
    if (0 < (long)__n_00) {
...

{
  ...
  if (__src == pvVar1) {
    uVar6 = uVar5 + 1;
    if (0xfffffffffffffffe < uVar5) goto LAB_00108f40;
...
LAB_00108f40:
  ...
  *(undefined8 *)((long)__dest_00 + __n) = uVar2;
  ...
  if ((long)__n < 1) {
    ...
    if (__src == (void *)0x0) goto LAB_00108f26;
  }
  else {
    __dest_00 = memmove(__dest_00,__src,__n);
    if (0 < (long)__n_00) {
...

{
  ...
  else if (__n == 0) goto LAB_001099fc;
  if (__n == 1) {
    *__dest = **(basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> **)
                (param_1 + 8);
    __dest = *(basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> **)(this + 8)
  ...
  if (*(_Rb_tree_node_base **)(this + 0x20) != (_Rb_tree_node_base *)0x0) {
    do {
      while( true ) {
        ...
        p_Var9 = p_Var7;
        if (*(_Rb_tree_node_base **)(p_Var7 + 0x10) == (_Rb_tree_node_base *)0x0) goto LAB_00109ae0;
      }
      p_Var5 = *(_Rb_tree_node_base **)(p_Var7 + 0x18);
    } while (*(_Rb_tree_node_base **)(p_Var7 + 0x18) != (_Rb_tree_node_base *)0x0);
LAB_00109ae0:
    if ((p_Var1 != p_Var9) && (*(int *)(p_Var9 + 0x20) <= param_1)) goto LAB_00109bad;
  }
...
LAB_00109c38:
      ...
      if (p_Var7 == (_Rb_tree_node_base *)0x0) goto LAB_00109bad;
...
LAB_00109c6a:
    ...
    if (*(_Rb_tree_node_base **)(this + 0x28) != p_Var9) {
      ...
      if ((int)uVar4 <= *(int *)(p_Var7 + 0x20)) goto LAB_00109c38;
...

{
  ...
  if (lVar8 == lVar1) {
    if (0xfffffffffffffffe < uVar4) goto LAB_00109e20;
  ...
  for (; param_2 != lVar8; lVar8 = lVar8 + 0x28) {
    ...
    *puVar6 = uVar5;
    if (uVar4 < 0x10) {
      ...
      else if (uVar4 != 0) goto LAB_00109e09;
    }
    else {
      if ((long)uVar4 < 0) goto LAB_00109fd9;
    ...
    do {
      ...
      *puVar6 = uVar5;
      if (uVar4 < 0x10) {
        ...
        else if (uVar4 != 0) goto LAB_00109ece;
      }
      else {
        if ((long)uVar4 < 0) goto LAB_00109fd9;
        puVar7 = (ulong *)glslang::TPoolAllocator::allocate(uVar5);
...
LAB_0010a084:
        uVar4 = uVar10 - uVar9;
        if (0x7fffffff < (long)uVar4) goto LAB_0010a0a2;
        if (-0x80000001 < (long)uVar4) goto LAB_0010a09e;
LAB_0010a048:
        ...
        uVar4 = (ulong)uVar2;
        if (uVar2 == 0) goto LAB_0010a084;
LAB_0010a09e:
        if ((int)uVar4 < 0) goto LAB_0010a048;
LAB_0010a0a2:
  ...
  if (param_2 == (_Rb_tree_node_base *)(this + 8)) {
    if (*(long *)(this + 0x28) != 0) {
      ...
      if ((uVar6 == 0) ||
        ...
        lVar5 = uVar2 - uVar1;
        if (0x7fffffff < lVar5) goto LAB_0010a3b6;
        if (lVar5 < -0x80000000) goto LAB_0010a346;
        iVar3 = (int)lVar5;
      }
      if (-1 < iVar3) goto LAB_0010a3b6;
      goto LAB_0010a346;
    }
    goto LAB_0010a3b6;
  }
...
LAB_0010a26a:
      if (*(_Rb_tree_node_base **)(this + 0x18) == param_2) goto LAB_0010a23b;
...
LAB_0010a214:
    ...
    if ((long)uVar6 < 0x80000000) {
      if (-0x80000001 < (long)uVar6) goto LAB_0010a22e;
      goto LAB_0010a360;
    }
  }
  else {
    ...
    if (iVar3 == 0) {
      lVar5 = uVar1 - uVar2;
      if (lVar5 < 0x80000000) {
        if (lVar5 < -0x80000000) goto LAB_0010a26a;
        iVar3 = (int)lVar5;
        goto LAB_0010a203;
      }
    }
...
LAB_0010a203:
      if (iVar3 < 0) goto LAB_0010a26a;
    }
    uVar4 = memcmp(__s2,__s1,uVar6);
    uVar6 = (ulong)uVar4;
    if (uVar4 == 0) goto LAB_0010a214;
LAB_0010a22e:
    if ((int)uVar6 < 0) {
LAB_0010a360:
...
LAB_0010a39c:
        uVar6 = uVar1 - uVar2;
        if (0x7fffffff < (long)uVar6) goto LAB_0010a3b6;
        if (-0x80000001 < (long)uVar6) goto LAB_0010a3b2;
      }
      else {
        uVar4 = memcmp(__s1,*(void **)(p_Var8 + 0x20),uVar6);
        uVar6 = (ulong)uVar4;
        if (uVar4 == 0) goto LAB_0010a39c;
LAB_0010a3b2:
        if (-1 < (int)uVar6) {
LAB_0010a3b6:
...

{
  ...
  if (__n < 0x10) {
    ...
    else if (__n != 0) goto LAB_0010a6c6;
  }
  else {
...
LAB_0010a502:
        ...
        p_Var14 = p_Var6;
        if (*(_Rb_tree_node_base **)(p_Var6 + 0x10) == (_Rb_tree_node_base *)0x0) goto LAB_0010a50e;
      }
      if (-1 < iVar4) goto LAB_0010a502;
LAB_0010a4b8:
...
LAB_0010a50e:
    if (p_Var2 != p_Var14) {
      ...
      if ((uVar10 == 0) || (iVar4 = memcmp(__s2,*(void **)(p_Var14 + 0x20),uVar10), iVar4 == 0)) {
        lVar13 = uVar3 - uVar11;
        if (0x7fffffff < lVar13) goto LAB_0010a62d;
        if (lVar13 < -0x80000000) goto LAB_0010a567;
        iVar4 = (int)lVar13;
      }
      if (-1 < iVar4) goto LAB_0010a62d;
    }
  }
LAB_0010a567:
...
LAB_0010a60f:
    ...
    if ((uVar10 == 0) ||
      ...
      lVar13 = uVar3 - uVar11;
      bVar12 = false;
      if (0x7fffffff < lVar13) goto LAB_0010a614;
      if (lVar13 < -0x80000000) goto LAB_0010a60f;
      iVar4 = (int)lVar13;
    }

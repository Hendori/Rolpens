...
/* bcdec__color_block(void const*, void*, int, int) */

void bcdec__color_block(void *param_1,void *param_2,int param_3,int param_4)

{
  ...
  uVar15 = uVar2 & 0x1f;
  uVar10 = uVar2 >> 5 & 0x3f;
  local_48[0] = uVar6 * 0x40c + 0x84 & 0x3ff00 | (uint)uVar3 * 0x20f + 0x17 >> 6 |
                (uVar11 * 0x20f + 0x17 >> 6) << 0x10 | 0xff000000;
  local_48[1] = uVar10 * 0x40c + 0x84 & 0x3ff00 | (uint)uVar4 * 0x20f + 0x17 >> 6 |
                (uVar15 * 0x20f + 0x17 >> 6) << 0x10 | 0xff000000;
  if ((uVar2 < uVar1) || ((param_4 & 1U) != 0)) {
    uVar7 = ((uVar10 + uVar6 * 2) * 0xacb + 0x40f >> 0xb) << 8 |
            ((uint)uVar4 + (uint)uVar3 * 2) * 0x15f + 0x3d >> 7 |
            ((uVar15 + uVar11 * 2) * 0x15f + 0x3d >> 7) << 0x10;
    local_48[3] = ((uVar6 + uVar10 * 2) * 0xacb + 0x40f >> 0xb) << 8 |
                  ((uint)uVar3 + (uint)uVar4 * 2) * 0x15f + 0x3d >> 7 |
                  ((uVar11 + uVar15 * 2) * 0x15f + 0x3d >> 7) << 0x10 | 0xff000000;
  }
  else {
    uVar7 = ((uVar6 + uVar10) * 0x1031 + 0x3fb >> 0xb) << 8 |
            ((uint)uVar3 + (uint)uVar4) * 0x41d + 0x7d >> 8 |
            ((uVar11 + uVar15) * 0x41d + 0x7d >> 8) << 0x10;
    local_48[3] = 0;
  }
...
/* bcdec__smooth_alpha_block(void const*, void*, int, int) */

void bcdec__smooth_alpha_block(void *param_1,void *param_2,int param_3,int param_4)

{
  ...
  iVar10 = 4;
  uVar1 = uVar2 >> 0x10;
  local_48 = (((((((ulong)(uVar5 & 0xff) << 8 | (ulong)(uVar7 & 0xff)) << 8 | (ulong)bVar3) << 8 |
                (ulong)bVar11) << 8 | (ulong)bVar9) << 8 | (ulong)bVar8) << 8 | uVar2 >> 8 & 0xff)
             << 8 | uVar2 & 0xff;
  do {
    iVar12 = 4;
    uVar2 = uVar1;
...
/* bcdec__unquantize(int, int, int) */

int bcdec__unquantize(int param_1,int param_2,int param_3)
...
LAB_00100efa:
    uVar42 = (int)(uVar42 << (bVar13 & 0x1f)) >> (bVar13 & 0x1f);
...
LAB_00100f28:
  ...
  do {
    *(int *)(local_78 + lVar40 * 4) =
         (*(int *)(local_78 + lVar40 * 4) << (bVar38 & 0x1f)) >> (bVar38 & 0x1f);
    *(int *)(local_68 + lVar40 * 4) =
         (*(int *)(local_68 + lVar40 * 4) << (bVar14 & 0x1f)) >> (bVar14 & 0x1f);
    *(int *)(local_58 + lVar40 * 4) =
         (*(int *)(local_58 + lVar40 * 4) << (bVar26 & 0x1f)) >> (bVar26 & 0x1f);
    lVar40 = lVar40 + 1;
...
LAB_00100a69:
  ...
  do {
    ...
    while( true ) {
      ...
      iVar15 = 0x40 - iVar8;
      iVar27 = *(int *)(local_78 + lVar18 * 4) * iVar15 + 0x20 +
               *(int *)(local_78 + lVar25 * 4) * iVar8 >> 6;
      iVar29 = *(int *)(local_68 + lVar25 * 4) * iVar8 + 0x20 +
               *(int *)(local_68 + lVar18 * 4) * iVar15 >> 6;
      iVar8 = iVar8 * *(int *)(local_58 + lVar25 * 4) + 0x20 +
              iVar15 * *(int *)(local_58 + lVar18 * 4) >> 6;
      if (param_4 == 0) {
...
LAB_00100b6b:
      uVar42 = ((byte)local_c0[lVar40] & 1) * 2;
      iVar8 = uVar42 + 1;
      uVar37 = uVar36;
      if ((char)local_c0[lVar40] < '\0') {
LAB_001024d0:
        uVar36 = uVar10 & uVar37;
        puVar34 = puVar33;
        uVar28 = uVar10;
        bVar26 = bVar14;
        bVar38 = 0x40 - bVar14;
...

{
  ...
  do {
    ...
    do {
      ...
      *(uint *)(param_2 + 4 + lVar2 * 2) =
           (*(ushort *)(puVar3 + lVar2 + 2) & 0x8000) << 0x10 | (uint)fVar6;
      ...
      *(uint *)(param_2 + 8 + lVar2 * 2) =
           (*(ushort *)(puVar3 + lVar2 + 4) & 0x8000) << 0x10 | (uint)fVar6;
      lVar2 = lVar2 + 6;
    } while (lVar2 != 0x18);
    puVar3 = puVar3 + 0x18;
...

{
  ...
  uVar27 = *param_1;
  do {
    local_118 = uVar27 >> 1 | uVar24 << 0x3f;
    local_f0 = uVar24 >> 1;
    iVar6 = (int)uVar23;
    if ((uVar27 & 1) != 0) {
      local_bc = (uint)(uVar27 >> 1);
      if ((0x8fUL >> (uVar23 & 0x3f) & 1) == 0) {
        if (iVar6 == 6) {
          lVar13 = 2;
          local_d8 = 1;
          uVar12 = 0;
          ...
          uVar15 = local_118 >> 2;
          local_118 = uVar15 | local_f0 << 0x3e;
          local_f0 = uVar24 >> 3;
          local_bc = local_bc & 3;
          if (iVar6 == 4) {
            local_d8 = 1;
        ...
        if ((uVar23 & 0xfffffffd) == 0) {
          local_d8 = 3;
          lVar13 = 6;
          bVar9 = (-(iVar6 == 0) & 2U) + 0x3a;
          uVar24 = (-(ulong)(iVar6 == 0) & 0xffffffffffffffd0) + 0x3f;
          uVar12 = (-(uint)(iVar6 == 0) & 0xffffffd0) + 0x3f;
          bVar28 = (-(iVar6 == 0) & 0xfeU) + 6;
        }
        else {
          bVar9 = 0x3a;
          uVar24 = 0x3f;
        ...
        uVar24 = uVar24 & local_f0;
        uVar12 = uVar12 & local_bc;
        local_d4 = 0;
        local_bc = 0;
        local_f0 = local_f0 >> (bVar28 & 0x3f);
        local_118 = uVar24 << (bVar9 & 0x3f) | local_118 >> (bVar28 & 0x3f);
      }
      puVar31 = local_a8;
      puVar1 = puVar31 + lVar13 * 4;
      bVar9 = (&bcdec_bc7::actual_bits_count)[iVar6];
      puVar2 = local_a8 + 3;
      uVar11 = (1 << (bVar9 & 0x1f)) - 1;
      puVar16 = puVar31;
      puVar7 = puVar31;
      puVar33 = puVar1;
      do {
        do {
          puVar14 = puVar16 + 4;
          uVar24 = local_f0 & uVar11;
          *puVar16 = uVar11 & (uint)local_118;
          local_f0 = local_f0 >> (bVar9 & 0x3f);
          local_118 = local_118 >> (bVar9 & 0x3f) | uVar24 << (0x40 - bVar9 & 0x3f);
          puVar16 = puVar14;
      ...
      bVar28 = (&DAT_00106928)[iVar6];
      if ('\0' < (char)bVar28) {
        uVar11 = (1 << (bVar28 & 0x1f)) - 1;
        puVar16 = puVar31;
        do {
          puVar7 = puVar16 + 4;
          uVar24 = local_f0 & uVar11;
          puVar16[3] = uVar11 & (uint)local_118;
          local_f0 = local_f0 >> (bVar28 & 0x3f);
          local_118 = local_118 >> (bVar28 & 0x3f) | uVar24 << (0x40 - bVar28 & 0x3f);
          puVar16 = puVar7;
        } while (puVar1 != puVar7);
      }
      puVar16 = puVar31;
      if ((0xcbUL >> (uVar23 & 0x3f) & 1) != 0) {
        do {
          puVar7 = puVar16 + 4;
          *puVar16 = *puVar16 << 1;
          puVar16[1] = puVar16[1] << 1;
          puVar16[2] = puVar16[2] << 1;
          puVar16[3] = puVar16[3] << 1;
          puVar16 = puVar7;
        } while (puVar1 != puVar7);
        uVar24 = local_118;
        puVar16 = puVar31;
        if (iVar6 == 1) {
          uVar24 = local_f0 << 0x3f;
          uVar15 = local_f0 >> 1;
          uVar17 = (uint)local_118 & 1;
          local_f0 = local_f0 >> 2;
          uVar11 = (uint)(local_118 >> 1) & 1;
          local_118 = (local_118 >> 1 | uVar24) >> 1 | uVar15 << 0x3f;
          do {
            *puVar16 = *puVar16 | uVar17;
            puVar16[4] = puVar16[4] | uVar17;
            puVar16[8] = puVar16[8] | uVar11;
            puVar16[0xc] = puVar16[0xc] | uVar11;
            puVar16 = puVar16 + 1;
          } while (puVar2 != puVar16);
        }
        else {
          do {
            puVar7 = puVar16 + 4;
            local_118 = uVar24 >> 1 | local_f0 << 0x3f;
            uVar11 = (uint)uVar24;
            local_f0 = local_f0 >> 1;
            *puVar16 = uVar11 & 1 | *puVar16;
            puVar16[1] = uVar11 & 1 | puVar16[1];
            puVar16[2] = uVar11 & 1 | puVar16[2];
            puVar16[3] = uVar11 & 1 | puVar16[3];
            uVar24 = local_118;
            puVar16 = puVar7;
          } while (puVar1 != puVar7);
        }
      ...
      uVar24 = local_118;
      bVar8 = (byte)(0xcb >> ((byte)uVar23 & 0x1f)) & 1;
      bVar9 = bVar9 + bVar8;
      bVar8 = bVar8 + bVar28;
      puVar16 = puVar2;
      do {
        ...
        do {
          puVar33 = puVar7 + 1;
          uVar11 = *puVar7 << (8 - bVar9 & 0x1f);
          *puVar7 = uVar11 | (int)uVar11 >> (bVar9 & 0x1f);
          puVar7 = puVar33;
        } while (puVar16 != puVar33);
        puVar7 = puVar16 + 4;
        uVar11 = *puVar16 << (8 - bVar8 & 0x1f);
        *puVar16 = uVar11 | (int)uVar11 >> (bVar8 & 0x1f);
        puVar16 = puVar7;
      } while (puVar2 + lVar13 * 4 != puVar7);
      if (bVar28 == 0) {
        do {
          puVar31[3] = 0xff;
          puVar31 = puVar31 + 4;
      ...
      local_100 = local_b8;
      iVar35 = 0;
      local_118._0_4_ = (uint)uVar27 & 1;
      local_e0 = bcdec_bc7::partition_sets +
                 ((long)(local_d8 + -2) * 0x40 + (long)(int)uVar12) * 0x10;
      puVar18 = local_e0;
      pcVar34 = local_100;
      do {
        lVar13 = 0;
        do {
          if (local_d8 == 1) {
            ...
            bVar28 = 3;
            if (1 < iVar6) {
              bVar28 = (iVar6 == 6) * '\x02' + 2;
            }
            if ((char)puVar18[lVar13] < '\0') {
              bVar28 = bVar28 - 1;
            }
            uVar12 = (1 << (bVar28 & 0x1f)) - 1;
            bVar8 = -bVar28;
            uVar27 = (ulong)(int)uVar12;
          }
          uVar27 = uVar27 & local_f0;
          pcVar34[lVar13] = (byte)uVar12 & (byte)uVar24;
          lVar13 = lVar13 + 1;
          local_f0 = local_f0 >> (bVar28 & 0x3f);
          uVar24 = uVar24 >> (bVar28 & 0x3f) | uVar27 << (bVar8 & 0x3f);
        } while (lVar13 != 4);
        iVar35 = iVar35 + 1;
        pcVar34 = pcVar34 + 4;
        puVar18 = puVar18 + 4;
      ...
      do {
        ...
        do {
          if (local_d8 == 1) {
            if (iVar6 != 0 || (int)lVar13 != 0) {
              iVar35 = 1;
              iVar29 = 0;
              goto LAB_00102cd3;
            }
            lVar25 = (long)local_b8[0];
            iVar35 = 1;
            iVar29 = 0;
            iVar5 = 0;
            iVar3 = 1;
            if (bVar9 != 0) goto LAB_00102f1e;
LAB_00102e60:
            lVar10 = (long)iVar35;
            iVar35 = *(int *)(local_f8 + lVar25 * 4);
            lVar25 = (long)iVar29;
            iVar22 = 0x40 - iVar35;
            iVar3 = local_a8[lVar25 * 4] * iVar22 + 0x20 + local_a8[lVar10 * 4] * iVar35;
            iVar5 = local_a8[lVar25 * 4 + 1] * iVar22 + 0x20 + local_a8[lVar10 * 4 + 1] * iVar35;
            iVar29 = local_a8[lVar25 * 4 + 2] * iVar22 + 0x20 + local_a8[lVar10 * 4 + 2] * iVar35;
            iVar35 = iVar22 * local_a8[lVar25 * 4 + 3] + 0x20 + iVar35 * local_a8[lVar10 * 4 + 3];
          }
          else {
            iVar29 = ((byte)local_e0[lVar13] & 3) * 2;
            iVar35 = iVar29 + 1;
LAB_00102cd3:
            lVar25 = (long)local_100[lVar13];
            if (bVar9 == 0) goto LAB_00102e60;
            iVar5 = iVar29;
            iVar3 = iVar35;
            bVar28 = bVar9;
            if ((int)lVar13 == 0 && iVar6 == 0) {
LAB_00102f1e:
              iVar35 = iVar3;
              iVar29 = iVar5;
              bVar28 = bVar9 - 1;
            ...
            lVar19 = (long)iVar35;
            uVar12 = (1 << (bVar28 & 0x1f)) - 1;
            uVar27 = (long)(int)uVar12 & local_f0;
            iVar35 = *(int *)(local_d0 + (long)(int)(uVar12 & (uint)uVar24) * 4);
            local_f0 = local_f0 >> (bVar28 & 0x3f);
            lVar10 = (long)iVar29;
            uVar24 = uVar27 << (-bVar28 & 0x3f) | uVar24 >> (bVar28 & 0x3f);
            iVar20 = 0x40 - iVar35;
            iVar22 = *(int *)(local_f8 + lVar25 * 4);
            iVar21 = 0x40 - iVar22;
            if (local_d4 == 0) {
              iVar3 = local_a8[lVar10 * 4] * iVar21 + 0x20 + local_a8[lVar19 * 4] * iVar22;
              iVar5 = local_a8[lVar10 * 4 + 1] * iVar21 + 0x20 + local_a8[lVar19 * 4 + 1] * iVar22;
              iVar29 = iVar21 * local_a8[lVar10 * 4 + 2] + 0x20 + iVar22 * local_a8[lVar19 * 4 + 2];
              iVar35 = iVar20 * local_a8[lVar10 * 4 + 3] + 0x20 + iVar35 * local_a8[lVar19 * 4 + 3];
            }
            else {
              iVar3 = local_a8[lVar10 * 4] * iVar20 + 0x20 + local_a8[lVar19 * 4] * iVar35;
              iVar5 = local_a8[lVar10 * 4 + 1] * iVar20 + 0x20 + local_a8[lVar19 * 4 + 1] * iVar35;
              iVar29 = local_a8[lVar10 * 4 + 2] * iVar20 + 0x20 + local_a8[lVar19 * 4 + 2] * iVar35;
              iVar35 = local_a8[lVar10 * 4 + 3] * iVar21 + 0x20 + local_a8[lVar19 * 4 + 3] * iVar22;
            }
          }
          uVar4 = iVar35 >> 6;
          uVar17 = iVar29 >> 6;
          ...
          uVar26 = uVar4;
          uVar30 = uVar17;
          if (((local_bc != 2) && (uVar26 = uVar11, uVar30 = uVar4, uVar11 = uVar17, local_bc != 3))
             && (uVar30 = uVar17, uVar11 = uVar4, local_bc == 1)) {
            uVar32 = uVar4;
            uVar11 = uVar12;
          }
          *(uint *)(*local_108 + lVar13 * 4) =
               (((uVar11 & 0xff) << 8 | uVar30 & 0xff) << 8 | uVar26 & 0xff) << 8 | uVar32 & 0xff;
          lVar13 = lVar13 + 1;
        } while (lVar13 != 4);
        iVar6 = iVar6 + 1;
...
/* image_decompress_bcdec(Image*) */

void image_decompress_bcdec(Image *param_1)

{
  ...
  if (((uVar6 | uVar7) & 3) != 0) {
    ...
    if (cVar4 != '\0') {
      local_f0 = 0;
      local_d8 = 
      "Compressed image\'s dimensions are not multiples of 4 (%dx%d), aligning to (%dx%d)";
      local_d0 = 0x51;
      String::parse_latin1((StrRange *)&local_f0);
      vformat<int,int,int,int>
                ((String_conflict *)&local_e8,(int)(StrRange *)&local_f0,uVar6,uVar7,local_124);
  ...
  default:
    ...
    operator+((char *)&local_f0,(String_conflict *)"bcdec: Can\'t decompress unknown format: ");
    String::operator+((String_conflict *)&local_d8,(String_conflict *)&local_f0);
    _err_print_error("image_decompress_bcdec","modules/bcdec/image_decompress_bcdec.cpp",0xde,
                     "Method/function failed.",(String_conflict *)&local_d8,0,0);
    pcVar3 = local_d8;
    if (local_d8 != (char *)0x0) {
      LOCK();
      plVar1 = (long *)(local_d8 + -0x10);
...
LAB_001035f0:
  ...
  if (-1 < iVar10) {
    ...
    Image::get_image_mipmap_offset_and_dimensions
              (local_124,local_1a4,iVar9,0,&local_f0,(Variant *)&local_d8);
    Image::get_image_mipmap_offset(local_124,local_1a4,local_1a8,0);
    if ((((uint)local_d8 | (uint)local_f0) & 3) != 0) {
                    /* WARNING: Could not recover jumptable at 0x00103739. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      (*(code *)(&DAT_001060c4 + *(int *)(&DAT_001060c4 + (ulong)local_128 * 4)))();
      return;
    }
                    /* WARNING: Could not recover jumptable at 0x00104b60. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&DAT_001060e4 + *(int *)(&DAT_001060e4 + (ulong)local_128 * 4)))
              (&DAT_001060e4,local_f0 & 0xffffffff,
               &DAT_001060e4 + *(int *)(&DAT_001060e4 + (ulong)local_128 * 4));
    return;
  }
  uVar5 = Image::has_mipmaps();
  ...
  if (cVar4 != '\0') {
    ...
    vformat<int,int,String,int,unsigned_long>
              ((String_conflict *)&local_f0,(StrRange *)&local_f8,uVar13,uVar12,&local_100,uVar11,
               lVar15 - lVar14);
...
/* WARNING: Removing unreachable block (ram,0x00106d60) */
/* WARNING: Removing unreachable block (ram,0x00106e90) */
/* WARNING: Removing unreachable block (ram,0x00107008) */
/* WARNING: Removing unreachable block (ram,0x00106e9c) */
/* WARNING: Removing unreachable block (ram,0x00106ea6) */
/* WARNING: Removing unreachable block (ram,0x00106fea) */
/* WARNING: Removing unreachable block (ram,0x00106eb2) */
/* WARNING: Removing unreachable block (ram,0x00106ebc) */
/* WARNING: Removing unreachable block (ram,0x00106fcc) */
/* WARNING: Removing unreachable block (ram,0x00106ec8) */
/* WARNING: Removing unreachable block (ram,0x00106ed2) */
/* WARNING: Removing unreachable block (ram,0x00106fae) */
/* WARNING: Removing unreachable block (ram,0x00106ede) */
/* WARNING: Removing unreachable block (ram,0x00106ee8) */
/* WARNING: Removing unreachable block (ram,0x00106f90) */
/* WARNING: Removing unreachable block (ram,0x00106ef4) */
/* WARNING: Removing unreachable block (ram,0x00106efe) */
/* WARNING: Removing unreachable block (ram,0x00106f72) */
/* WARNING: Removing unreachable block (ram,0x00106f06) */
/* WARNING: Removing unreachable block (ram,0x00106f10) */
/* WARNING: Removing unreachable block (ram,0x00106f57) */
/* WARNING: Removing unreachable block (ram,0x00106f18) */
/* WARNING: Removing unreachable block (ram,0x00106f2d) */
/* WARNING: Removing unreachable block (ram,0x00106f39) */
/* String vformat<int, int, int, int>(String const&, int const, int const, int const, int const) */

String_conflict *
vformat<int,int,int,int>(String_conflict *param_1,int param_2,int param_3,int param_4,int param_5)
...
/* WARNING: Removing unreachable block (ram,0x001071b0) */
/* WARNING: Removing unreachable block (ram,0x001072e0) */
/* WARNING: Removing unreachable block (ram,0x00107458) */
/* WARNING: Removing unreachable block (ram,0x001072ec) */
/* WARNING: Removing unreachable block (ram,0x001072f6) */
/* WARNING: Removing unreachable block (ram,0x0010743a) */
/* WARNING: Removing unreachable block (ram,0x00107302) */
/* WARNING: Removing unreachable block (ram,0x0010730c) */
/* WARNING: Removing unreachable block (ram,0x0010741c) */
/* WARNING: Removing unreachable block (ram,0x00107318) */
/* WARNING: Removing unreachable block (ram,0x00107322) */
...
/* WARNING: Removing unreachable block (ram,0x00107344) */
/* WARNING: Removing unreachable block (ram,0x0010734e) */
/* WARNING: Removing unreachable block (ram,0x001073c2) */
/* WARNING: Removing unreachable block (ram,0x00107356) */
/* WARNING: Removing unreachable block (ram,0x00107360) */
/* WARNING: Removing unreachable block (ram,0x001073a7) */
/* WARNING: Removing unreachable block (ram,0x00107368) */
/* WARNING: Removing unreachable block (ram,0x0010737d) */
/* WARNING: Removing unreachable block (ram,0x00107389) */
/* String vformat<int, int, String, int, unsigned long>(String const&, int const, int const, String
   const, int const, unsigned long const) */
...
/* image_decompress_bcdec(Image*) [clone .cold] */

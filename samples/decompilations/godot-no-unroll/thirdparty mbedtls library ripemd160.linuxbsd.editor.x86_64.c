...
undefined8 mbedtls_ripemd160_starts(undefined8 *param_1)
...

{
  ...
  uVar13 = (*(uint *)(param_1 + 0xc) ^ *(uint *)(param_1 + 0x10) ^ *(uint *)(param_1 + 0x14)) +
           *(int *)(param_1 + 8) + local_80;
  uVar2 = *(uint *)(param_1 + 0x10) << 10 | *(uint *)(param_1 + 0x10) >> 0x16;
  uVar14 = (uVar13 * 0x800 | uVar13 >> 0x15) + iVar1;
  uVar13 = ((*(uint *)(param_1 + 0x10) | ~*(uint *)(param_1 + 0x14)) ^ *(uint *)(param_1 + 0xc)) +
           *(int *)(param_1 + 8) + 0x50a28be6 + local_6c;
  ...
  *(ulong *)(param_1 + 0x10) =
       CONCAT44(iVar1 + local_a8 + local_90,*(int *)(param_1 + 0x14) + local_94 + local_98);
...
LAB_001018ae:
      uVar1 = mbedtls_internal_ripemd160_process(param_1,param_2);
      if ((int)uVar1 != 0) {
        return uVar1;
      }
      param_2 = param_2 + 8;
...
int mbedtls_ripemd160(undefined8 param_1,undefined8 param_2,undefined8 param_3)

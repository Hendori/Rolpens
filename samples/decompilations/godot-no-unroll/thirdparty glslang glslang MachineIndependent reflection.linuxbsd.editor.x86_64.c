...
/* glslang::TReflectionTraverser::mapToGlType(glslang::TType const&) [clone .isra.0] */

int glslang::TReflectionTraverser::mapToGlType(TType *param_1)

{
  ...
  if (bVar6 != 0) {
LAB_0010006d:
    if (*(code **)(lVar8 + 0x60) == TType::getVectorSize) {
...
/* std::_Rb_tree<TIntermNode const*, TIntermNode const*, std::_Identity<TIntermNode const*>,
   ...
   >::_M_erase(std::_Rb_tree_node<TIntermNode const*>*) [clone .isra.0] */
...
/* glslang::TObjectReflection::getBinding() const */

ulong __thiscall glslang::TObjectReflection::getBinding(TObjectReflection *this)
...
/* glslang::TObjectReflection::dump() const */

void __thiscall glslang::TObjectReflection::dump(TObjectReflection *this)

{
  ...
  __printf_chk(2,"%s: offset %d, type %x, size %d, index %d, binding %d, stages %d",
               *(undefined8 *)this,*(undefined4 *)(this + 0x20),*(undefined4 *)(this + 0x24),
               *(undefined4 *)(this + 0x28),*(undefined4 *)(this + 0x2c),uVar3,uVar1);
  if (*(int *)(this + 0x30) != -1) {
...
/* glslang::TReflection::buildAttributeReflection(EShLanguage, glslang::TIntermediate const&) */

void __thiscall
glslang::TReflection::buildAttributeReflection(TReflection *this,int param_2,long param_3)

{
  if (param_2 != 5) {
    return;
  }
  *(undefined4 *)(this + 0x1a0) = *(undefined4 *)(param_3 + 0x278);
  *(undefined4 *)(this + 0x1a4) = *(undefined4 *)(param_3 + 0x27c);
  *(undefined4 *)(this + 0x1a8) = *(undefined4 *)(param_3 + 0x280);
  return;
}



/* glslang::TReflection::buildCounterIndices(glslang::TIntermediate const&) */

void glslang::TReflection::buildCounterIndices(TIntermediate *param_1)
...
/* glslang::TReflection::buildUniformStageMask(glslang::TIntermediate const&) */

void __thiscall
glslang::TReflection::buildUniformStageMask(TReflection *this,TIntermediate *param_1)

{
  ...
  if (((byte)this[8] & 0x10) == 0) {
    ...
    iVar4 = (int)(*(long *)(this + 0x100) - lVar2 >> 4) * -0x33333333;
    if (0 < iVar4) {
      puVar3 = (uint *)(lVar2 + 0x44);
      do {
        *puVar3 = *puVar3 | 1 << ((byte)uVar1 & 0x1f);
        puVar3 = puVar3 + 0x14;
      } while (puVar3 != (uint *)(lVar2 + 0x94 + (ulong)(iVar4 - 1) * 0x50));
    }
    lVar2 = *(long *)(this + 0x128);
    iVar4 = (int)(*(long *)(this + 0x130) - lVar2 >> 4) * -0x33333333;
    if (0 < iVar4) {
      puVar3 = (uint *)(lVar2 + 0x44);
      do {
        *puVar3 = *puVar3 | 1 << ((byte)uVar1 & 0x1f);
        puVar3 = puVar3 + 0x14;
      } while ((uint *)(lVar2 + 0x94 + (ulong)(iVar4 - 1) * 0x50) != puVar3);
    }
  }
  return;
}
...
/* glslang::TReflection::addStage(EShLanguage, glslang::TIntermediate const&) */

undefined8 __thiscall
glslang::TReflection::addStage(TReflection *this,int param_2,TIntermediate *param_3)

{
  ...
  if (*(long *)(param_3 + 0x80) == 0) {
    ...
    local_c0 = 1;
    local_c8 = &PTR__TIntermTraverser_001102d8;
    local_bc = 0;
    local_b0 = glslang::GetThreadPoolAllocator();
    local_a8 = 0;
    local_c8 = &PTR__TReflectionTraverser_00110340;
    local_68 = local_78;
    local_a0 = 0;
    local_98 = 0;
    local_78[0] = 0;
        ...
        if (*(int *)(lVar7 + 0xb8) == 3) {
          ...
          if (puVar11 != puVar2) {
            do {
              ...
              if (plVar6 == (long *)0x0) goto LAB_00101540;
              lVar7 = *plVar6;
              if (*(code **)(lVar7 + 0x108) == TIntermTyped::getQualifier) {
                ...
                bVar4 = bVar3 & 0x7f;
                if (bVar4 == 5) {
                  if ((uVar5 & 0x100) != 0) goto LAB_0010159c;
LAB_0010167c:
                  bVar4 = bVar3 & 0x7f;
                }
LAB_00101586:
                if ((bVar4 == 6) && ((uVar5 & 0x80) != 0)) {
                  lVar7 = *plVar6;
                  goto LAB_0010159c;
                }
                if ((uVar5 & 0x40) != 0) {
...
LAB_00101740:
                        if ((0x71c00010UL >> (uVar8 & 0x3f) & 1) == 0) goto LAB_00101540;
                        lVar7 = *plVar6;
                      }
                    }
                    else if (0x1e < bVar3) goto LAB_00101540;
                  }
                  else {
                    ...
                    if ((0x1b < (byte)uVar5) || ((0xe300008UL >> ((ulong)uVar5 & 0x3f) & 1) == 0)) {
                      ...
                      if ((byte)(bVar3 & 0x7f) < 0x1f) goto LAB_00101740;
                      goto LAB_00101540;
                    }
                    lVar7 = *plVar6;
                  }
...
/* glslang::TObjectReflection& std::vector<glslang::TObjectReflection,
   ...
   >::emplace_back<glslang::TObjectReflection>(glslang::TObjectReflection&&) [clone .isra.0] */

TObjectReflection * __thiscall
  ...
  if (*(TObjectReflection **)param_1 == pTVar1) {
    ...
    if (uVar10 < 8) {
      if ((uVar9 & 4) != 0) {
        ...
        *(undefined4 *)((long)plVar2 + (uVar9 & 0xffffffff) + 0xc) =
             *(undefined4 *)(param_1 + (uVar9 & 0xffffffff) + 0xc);
        lVar8 = *(long *)(param_1 + 8);
        goto LAB_00101c50;
      }
      if (uVar10 == 0) goto LAB_00101c50;
      *(TObjectReflection *)(plVar2 + 2) = param_1[0x10];
      if ((uVar9 & 2) != 0) {
        *(undefined2 *)((long)plVar2 + (uVar9 & 0xffffffff) + 0xe) =
             *(undefined2 *)(param_1 + (uVar9 & 0xffffffff) + 0xe);
        lVar8 = *(long *)(param_1 + 8);
        goto LAB_00101c50;
      }
    }
      ...
      *(undefined8 *)((long)plVar2 + (uVar9 & 0xffffffff) + 8) =
           *(undefined8 *)(param_1 + (uVar9 & 0xffffffff) + 8);
      ...
      if (7 < uVar10) {
        ...
        do {
          uVar9 = (ulong)uVar7;
          uVar7 = uVar7 + 8;
          *(undefined8 *)(((ulong)(plVar2 + 3) & 0xfffffffffffffff8) + uVar9) =
               *(undefined8 *)(pTVar1 + (uVar9 - lVar8));
        } while (uVar7 < uVar10);
      }
    }
  }
...
glslang::TObjectReflection::TObjectReflection
          (TObjectReflection *this,string *param_1,TType *param_2,int param_3,int param_4,
...

{
  ...
  *(TObjectReflection **)this = this + 0x10;
  ...
  *(ulong *)(this + 0x20) = CONCAT44(param_4,param_3);
  ...
  *(undefined ***)this_00 = &PTR__TType_001100f0;
  *(uint *)(this_00 + 0x80) = *(uint *)(this_00 + 0x80) & 0x9fc00000;
  this_00[0x20] = (TType)((byte)this_00[0x20] & 0xf0);
  *(undefined8 *)(this_00 + 0x10) = 0;
  *(uint *)(this_00 + 8) =
       CONCAT22((short)((uint)*(undefined4 *)(this_00 + 8) >> 0x10),0x100) & 0xf800ffff;
  ...
  *(ulong *)(this_00 + 0x38) =
       (ulong)((uint)*(undefined8 *)(this_00 + 0x38) & 0xfe07ff00) | 0x1f800ff;
  ...
  *(undefined1 (*) [16])(this_00 + 0x70) = (undefined1  [16])0x0;
  local_68[0] = glslang::GetThreadPoolAllocator();
  local_48 = local_58;
  local_58[0] = 0;
  local_50 = 0;
  local_38 = 0;
  local_40 = local_48;
  TType::deepCopy(this_00,param_2,(TMap *)local_68);
  for (lVar3 = local_50; lVar3 != 0; lVar3 = *(long *)(lVar3 + 0x10)) {
    std::
    _Rb_tree<glslang::TVector<glslang::TTypeLoc>*,std::pair<glslang::TVector<glslang::TTypeLoc>*const,glslang::TVector<glslang::TTypeLoc>*>,std::_Select1st<std::pair<glslang::TVector<glslang::TTypeLoc>*const,glslang::TVector<glslang::TTypeLoc>*>>,std::less<glslang::TVector<glslang::TTypeLoc>*>,glslang::pool_allocator<std::pair<glslang::TVector<glslang::TTypeLoc>*const,glslang::TVector<glslang::TTypeLoc>*>>>
    ::_M_erase(*(_Rb_tree_node **)(lVar3 + 0x18));
  }
  *(TType **)(this + 0x48) = this_00;
...
/* glslang::TReflectionTraverser::visitBinary(glslang::TVisit, glslang::TIntermBinary*) */

undefined8 __thiscall
glslang::TReflectionTraverser::visitBinary
          (TReflectionTraverser *this,undefined8 param_2,TIntermBinary *param_3)
...
/* glslang::TReflectionTraverser::visitSymbol(glslang::TIntermSymbol*) */

void __thiscall
glslang::TReflectionTraverser::visitSymbol(TReflectionTraverser *this,TIntermSymbol *param_1)
...
LAB_00102193:
    ...
    uVar3 = *(uint *)(lVar5 + 8);
    if ((uVar3 & 0x100) != 0) goto LAB_00102193;
  }
  else {
LAB_00102107:
    lVar5 = *(long *)(this + 0x40);
  ...
  if ((uVar3 & 0x80) == 0) goto LAB_00102140;
  if (*(code **)(*(long *)param_1 + 0x108) == TIntermTyped::getQualifier) {
    TVar1 = param_1[0x38];
  }
  else {
...
LAB_00102140:
  ...
  if (*(int *)(lVar5 + 0xc) == iVar6) {
    ...
    if (((byte)((byte)pTVar4[8] & 0x7f) < 0x1c) &&
       ((0xe300008UL >> ((ulong)((byte)pTVar4[8] & 0x7f) & 0x3f) & 1) != 0)) {
  ...
  if (*(int *)(lVar5 + 0x10) == iVar6) {
    ...
    if (((byte)((byte)pTVar4[8] & 0x7f) < 0x1f) &&
       ((0x71c00010UL >> ((ulong)((byte)pTVar4[8] & 0x7f) & 0x3f) & 1) != 0)) {
      addPipeIOVariable(this,param_1);
      return;
    }
  }
...

{
  ...
  if (*(_Rb_tree_node_base **)(this + 0x18) == (_Rb_tree_node_base *)0x0) {
    ...
    p_Var2 = p_Var4;
    if (param_1 >= ppTVar5) goto LAB_0010278a;
  }
...
void __thiscall
std::vector<glslang::TSpirvTypeParameter,glslang::pool_allocator<glslang::TSpirvTypeParameter>>::
operator=(vector<glslang::TSpirvTypeParameter,glslang::pool_allocator<glslang::TSpirvTypeParameter>>
          *this,vector *param_1)
...
undefined4 glslang::TReflectionTraverser::getArrayStride(TType *param_1,TType *param_2)

{
  ...
  uVar1 = 0;
  if (uVar2 == 0x10) goto LAB_00102bb0;
  ...
  if (((byte)pTVar4[0xf] >> 4 & 7) == 0) {
    ...
    if (pcVar3 == TType::getQualifier) goto LAB_00102b8f;
LAB_00102bdf:
    pTVar4 = (TType *)(*pcVar3)(param_1);
  }
  else {
    bVar5 = ((byte)pTVar4[0xf] >> 4 & 7) == 1;
    if (pcVar3 != TType::getQualifier) goto LAB_00102bdf;
LAB_00102b8f:
    pTVar4 = param_1 + 0x10;
  }
  glslang::TIntermediate::getMemberAlignment
            (param_2,local_28,&local_24,(byte)pTVar4[0x10] & 0xf,bVar5);
  uVar1 = local_24;
LAB_00102bb0:
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
    return uVar1;
...
/* std::vector<glslang::TArraySize, glslang::pool_allocator<glslang::TArraySize>
   ...
   glslang::pool_allocator<glslang::TArraySize> > const&) [clone .isra.0] */

void __thiscall
std::vector<glslang::TArraySize,glslang::pool_allocator<glslang::TArraySize>>::operator=
...

{
  ...
  if (pcVar2 == isScalar) {
    ...
    if (pcVar2 == isVector) {
      ...
      if (1 < ((byte)this[9] & 0xf)) goto LAB_00103643;
    }
    else {
      bVar3 = (*pcVar2)();
    }
...
void __thiscall glslang::TReflectionTraverser::~TReflectionTraverser(TReflectionTraverser *this)

{
  void *pvVar1;
  void *pvVar2;
  
  *(undefined ***)this = &PTR__TReflectionTraverser_00110340;
...
LAB_00103aad:
        ...
        if (cVar3 != '\0') goto LAB_00103aad;
      }
      plVar2 = (long *)param_1[4];
      bVar1 = *(byte *)(plVar2 + 1);
      if ((bVar1 < 0xd) || (bVar1 == 0x12)) goto LAB_001039af;
      if (*(code **)(*plVar2 + 0x128) == glslang::TType::isStruct) {
        if ((byte)(bVar1 - 0xf) < 2) {
LAB_00103aed:
          lVar5 = *(long *)(plVar2[0xd] + 0x10);
...
LAB_00103e7d:
        ...
        if (cVar2 != '\0') goto LAB_00103e7d;
      }
      plVar1 = (long *)param_1[4];
      if (*(byte *)(plVar1 + 1) == param_3) goto LAB_00103ecc;
      if (*(code **)(*plVar1 + 0x128) == glslang::TType::isStruct) {
        if ((byte)(*(byte *)(plVar1 + 1) - 0xf) < 2) {
LAB_00103ead:
          lVar4 = *(long *)(plVar1[0xd] + 0x10);
...
LAB_00103ecc:
        ...
        cVar2 = (**(code **)(*plVar1 + 0x128))(plVar1);
        if (cVar2 != '\0') goto LAB_00103ead;
      }
      plVar1 = (long *)param_1[8];
      if (*(byte *)(plVar1 + 1) == param_3) goto LAB_00103f04;
      if (*(code **)(*plVar1 + 0x128) == glslang::TType::isStruct) {
        if ((byte)(*(byte *)(plVar1 + 1) - 0xf) < 2) {
LAB_00103ee5:
          lVar4 = *(long *)(plVar1[0xd] + 0x10);
...
LAB_00103f04:
        ...
        cVar2 = (**(code **)(*plVar1 + 0x128))(plVar1);
        if (cVar2 != '\0') goto LAB_00103ee5;
      }
      plVar1 = (long *)param_1[0xc];
      if (*(byte *)(plVar1 + 1) == param_3) goto LAB_00103f3c;
      if (*(code **)(*plVar1 + 0x128) == glslang::TType::isStruct) {
        if ((byte)(*(byte *)(plVar1 + 1) - 0xf) < 2) {
LAB_00103f1d:
          lVar4 = *(long *)(plVar1[0xd] + 0x10);
...
LAB_0010437d:
        ...
        if (cVar2 != '\0') goto LAB_0010437d;
      }
      plVar1 = (long *)param_1[4];
      lVar4 = *plVar1;
      if (*(code **)(lVar4 + 0xe8) == glslang::TType::isArray) {
        if (plVar1[0xc] != 0) goto LAB_001042f3;
      }
      else {
        cVar2 = (**(code **)(lVar4 + 0xe8))(plVar1);
        if (cVar2 != '\0') goto LAB_001042f3;
        lVar4 = *plVar1;
      }
      if (*(code **)(lVar4 + 0x128) == glslang::TType::isStruct) {
        if ((byte)((char)plVar1[1] - 0xfU) < 2) {
...
LAB_001042f3:
        ...
        cVar2 = (**(code **)(lVar4 + 0x128))(plVar1);
        if (cVar2 != '\0') goto LAB_001042d5;
      }
      plVar1 = (long *)param_1[8];
      lVar4 = *plVar1;
      if (*(code **)(lVar4 + 0xe8) == glslang::TType::isArray) {
        if (plVar1[0xc] != 0) goto LAB_0010432b;
      }
      else {
        cVar2 = (**(code **)(lVar4 + 0xe8))(plVar1);
        if (cVar2 != '\0') goto LAB_0010432b;
        lVar4 = *plVar1;
      }
      if (*(code **)(lVar4 + 0x128) == glslang::TType::isStruct) {
        if ((byte)((char)plVar1[1] - 0xfU) < 2) {
...
LAB_0010432b:
        ...
        cVar2 = (**(code **)(lVar4 + 0x128))(plVar1);
        if (cVar2 != '\0') goto LAB_0010430d;
      }
      plVar1 = (long *)param_1[0xc];
      lVar4 = *plVar1;
      if (*(code **)(lVar4 + 0xe8) == glslang::TType::isArray) {
        if (plVar1[0xc] != 0) goto LAB_00104363;
      }
      else {
        cVar2 = (**(code **)(lVar4 + 0xe8))(plVar1);
        if (cVar2 != '\0') goto LAB_00104363;
        lVar4 = *plVar1;
      }
      if (*(code **)(lVar4 + 0x128) == glslang::TType::isStruct) {
        if ((byte)((char)plVar1[1] - 0xfU) < 2) {
...
LAB_00104915:
      ...
      if (pcVar1 == glslang::TType::isBuiltIn) {
        ...
        if (0x7f < *(ushort *)(plVar3 + 1)) goto LAB_0010489a;
      }
      else {
        cVar2 = (*pcVar1)(plVar5);
        if (cVar2 != '\0') {
...
LAB_0010489a:
      ...
      if (pcVar1 == glslang::TType::isBuiltIn) {
        ...
        if (0x7f < *(ushort *)(plVar3 + 1)) goto LAB_001048ca;
      }
      else {
        cVar2 = (*pcVar1)(plVar5);
        if (cVar2 != '\0') {
...
LAB_001048ca:
      ...
      if (pcVar1 == glslang::TType::isBuiltIn) {
        ...
        if (0x7f < *(ushort *)(plVar3 + 1)) goto LAB_001048fa;
      }
      else {
        cVar2 = (*pcVar1)(plVar5);
        if (cVar2 != '\0') {
...
LAB_00104fad:
      ...
      if (*(code **)(lVar4 + 0xe8) == glslang::TType::isArray) {
        ...
        if (lVar3 != 0) {
LAB_00104dd4:
          if (*(long *)(*(long *)(*(long *)(lVar3 + 8) + 8) + 8) != 0) goto LAB_00104de3;
          goto LAB_00104df0;
        }
      }
      else {
...
LAB_00104de3:
      ...
      if (*(code **)(lVar4 + 0xe8) == glslang::TType::isArray) {
        ...
        if (lVar3 != 0) {
LAB_00104e34:
          if (*(long *)(*(long *)(*(long *)(lVar3 + 8) + 8) + 8) != 0) goto LAB_00104e43;
          goto LAB_00104e50;
        }
      }
      else {
...
LAB_00104e43:
      ...
      if (*(code **)(lVar4 + 0xe8) == glslang::TType::isArray) {
        ...
        if (lVar3 != 0) {
LAB_00104e94:
          if (*(long *)(*(long *)(*(long *)(lVar3 + 8) + 8) + 8) != 0) goto LAB_00104ea3;
          goto LAB_00104eb0;
        }
      }
      else {
...
LAB_001055ad:
        ...
        cVar2 = (**(code **)(lVar4 + 0x128))(plVar1);
        if (cVar2 != '\0') goto LAB_001055ad;
      }
      plVar1 = (long *)param_1[4];
      lVar4 = *plVar1;
      if (*(code **)(lVar4 + 0x140) == glslang::TType::isOpaque) {
        if ((*(byte *)(plVar1 + 1) < 0x15) &&
           ((0x1a6000UL >> ((ulong)*(byte *)(plVar1 + 1) & 0x3f) & 1) != 0)) goto LAB_001053d0;
      }
      else {
        cVar2 = (**(code **)(lVar4 + 0x140))(plVar1);
        if (cVar2 != '\0') goto LAB_001053d0;
        lVar4 = *plVar1;
      }
      if (*(code **)(lVar4 + 0x128) == glslang::TType::isStruct) {
        if ((byte)((char)plVar1[1] - 0xfU) < 2) {
...
LAB_001053d0:
        ...
        cVar2 = (**(code **)(lVar4 + 0x128))(plVar1);
        if (cVar2 != '\0') goto LAB_001055dd;
      }
      plVar1 = (long *)param_1[8];
      lVar4 = *plVar1;
      if (*(code **)(lVar4 + 0x140) == glslang::TType::isOpaque) {
        if ((*(byte *)(plVar1 + 1) < 0x15) &&
           ((0x1a6000UL >> ((ulong)*(byte *)(plVar1 + 1) & 0x3f) & 1) != 0)) goto LAB_00105438;
      }
      else {
        cVar2 = (**(code **)(lVar4 + 0x140))(plVar1);
        if (cVar2 != '\0') goto LAB_00105438;
        lVar4 = *plVar1;
      }
      if (*(code **)(lVar4 + 0x128) == glslang::TType::isStruct) {
        if ((byte)((char)plVar1[1] - 0xfU) < 2) {
...
LAB_00105438:
        ...
        cVar2 = (**(code **)(lVar4 + 0x128))(plVar1);
        if (cVar2 != '\0') goto LAB_0010560d;
      }
      plVar1 = (long *)param_1[0xc];
      lVar4 = *plVar1;
      if (*(code **)(lVar4 + 0x140) == glslang::TType::isOpaque) {
        if ((*(byte *)(plVar1 + 1) < 0x15) &&
           ((0x1a6000UL >> ((ulong)*(byte *)(plVar1 + 1) & 0x3f) & 1) != 0)) goto LAB_001054a0;
      }
      else {
        cVar2 = (**(code **)(lVar4 + 0x140))(plVar1);
        if (cVar2 != '\0') goto LAB_001054a0;
        lVar4 = *plVar1;
      }
      if (*(code **)(lVar4 + 0x128) == glslang::TType::isStruct) {
        if ((byte)((char)plVar1[1] - 0xfU) < 2) {
...
LAB_00105b95:
      ...
      if (*(code **)(lVar4 + 0xf8) == glslang::TType::isUnsizedArray) {
        ...
        if (lVar3 != 0) {
LAB_00105968:
          if (**(int **)(*(long *)(lVar3 + 8) + 8) == 0) goto LAB_00105978;
          goto LAB_00105991;
        }
      }
      else {
        cVar2 = (**(code **)(lVar4 + 0xf8))(plVar1);
        if (cVar2 != '\0') goto LAB_00105978;
LAB_00105991:
        lVar4 = *plVar1;
      }
      if (*(code **)(lVar4 + 0x128) == glslang::TType::isStruct) {
...
LAB_00105978:
      ...
      if (*(code **)(lVar4 + 0xf8) == glslang::TType::isUnsizedArray) {
        ...
        if (lVar3 != 0) {
LAB_001059e0:
          if (**(int **)(*(long *)(lVar3 + 8) + 8) == 0) goto LAB_001059ee;
          goto LAB_00105a09;
        }
      }
      else {
        cVar2 = (**(code **)(lVar4 + 0xf8))(plVar1);
        if (cVar2 != '\0') goto LAB_001059ee;
LAB_00105a09:
        lVar4 = *plVar1;
      }
      if (*(code **)(lVar4 + 0x128) == glslang::TType::isStruct) {
...
LAB_001059ee:
      ...
      if (*(code **)(lVar4 + 0xf8) == glslang::TType::isUnsizedArray) {
        ...
        if (lVar3 != 0) {
LAB_00105a58:
          if (**(int **)(*(long *)(lVar3 + 8) + 8) == 0) goto LAB_00105a66;
          goto LAB_00105a79;
        }
      }
      else {
        cVar2 = (**(code **)(lVar4 + 0xf8))(plVar1);
        if (cVar2 != '\0') goto LAB_00105a66;
LAB_00105a79:
        lVar4 = *plVar1;
      }
      if (*(code **)(lVar4 + 0x128) == glslang::TType::isStruct) {
...
LAB_00105e6a:
  ...
  if (*(code **)(lVar4 + 0xf8) == glslang::TType::isUnsizedArray) {
    if (*(code **)(lVar4 + 0xe8) == glslang::TType::isArray) {
      lVar3 = plVar5[0xc];
      if (lVar3 == 0) goto LAB_00105b2f;
    }
    else {
      cVar2 = (**(code **)(lVar4 + 0xe8))(plVar5);
      if (cVar2 == '\0') goto LAB_00105b2b;
      lVar3 = plVar5[0xc];
    }
    if (**(int **)(*(long *)(lVar3 + 8) + 8) == 0) {
      return param_1;
...
LAB_00106066:
          ...
          cVar2 = (**(code **)(lVar5 + 0x128))(plVar1);
          if (cVar2 != '\0') goto LAB_0010609d;
        }
      }
      else {
        if (*(code **)(lVar5 + 0x128) != glslang::TType::isStruct) {
          cVar2 = (**(code **)(lVar5 + 0x128))(plVar1);
          if (cVar2 != '\0') goto LAB_00106066;
          lVar5 = *plVar1;
          goto LAB_00106080;
        }
        if ((byte)((char)plVar1[1] - 0xfU) < 2) goto LAB_00106066;
      }
...
LAB_001060e6:
          ...
          cVar2 = (**(code **)(lVar5 + 0x128))(plVar1);
          if (cVar2 != '\0') goto LAB_0010611d;
        }
      }
      else {
        if (*(code **)(lVar5 + 0x128) != glslang::TType::isStruct) {
          cVar2 = (**(code **)(lVar5 + 0x128))(plVar1);
          if (cVar2 != '\0') goto LAB_001060e6;
          lVar5 = *plVar1;
          goto LAB_00106100;
        }
        if ((byte)((char)plVar1[1] - 0xfU) < 2) goto LAB_001060e6;
      }
...
LAB_00106180:
        if (*(code **)(lVar5 + 0x128) == glslang::TType::isStruct) {
          if (1 < (byte)((char)plVar1[1] - 0xfU)) goto LAB_001061ba;
        }
        else {
          cVar2 = (**(code **)(lVar5 + 0x128))(plVar1);
          if (cVar2 == '\0') {
...
LAB_00106166:
        ...
        if (*(code **)(lVar5 + 0x128) != glslang::TType::isStruct) {
          cVar2 = (**(code **)(lVar5 + 0x128))(plVar1);
          if (cVar2 != '\0') goto LAB_00106166;
          lVar5 = *plVar1;
          goto LAB_00106180;
        }
        if ((byte)((char)plVar1[1] - 0xfU) < 2) goto LAB_00106166;
      }
LAB_001061ba:
      plVar1 = plVar6 + 0x10;
...

{
  ...
  lVar26 = *(long *)param_1;
  *(undefined ***)this = &PTR__TType_001100f0;
...
LAB_0010663d:
      ...
      *puVar21 = &PTR__TSmallArrayVector_001100d0;
      puVar21[1] = 0;
...
/* glslang::TReflectionTraverser::countAggregateMembers(glslang::TType const&) */

int __thiscall
glslang::TReflectionTraverser::countAggregateMembers(TReflectionTraverser *this,TType *param_1)
...
LAB_00106a39:
          if (*(code **)(lVar8 + 0x98) == TType::getArraySizes) {
...

{
  ...
  if (*(code **)(lVar2 + 0x168) == isTexture) {
    ...
    if (pcVar5 != isImage) goto LAB_00106ec0;
  }
  else {
...
LAB_00106e70:
    ...
    pcVar5 = *(code **)(lVar2 + 0x158);
    if (pcVar5 == isImage) {
      if ((char)param_1[1] != '\x0e') goto LAB_00106ddf;
      if (*(code **)(lVar2 + 0x40) == getSampler) {
        plVar4 = param_1 + 0x10;
      }
      else {
...

{
  ...
  if (*(code **)(lVar2 + 0x168) == isTexture) {
    ...
    pcVar5 = *(code **)(lVar2 + 0x158);
    if (pcVar5 != isImage) goto LAB_00107010;
  }
  else {
    cVar1 = (**(code **)(lVar2 + 0x168))();
    if (cVar1 != '\0') {
...
LAB_00106fc0:
    ...
    pcVar5 = *(code **)(lVar2 + 0x158);
    if (pcVar5 == isImage) {
      if (this[8] != (TType)0xe) goto LAB_00106f2f;
      if (*(code **)(lVar2 + 0x40) == getSampler) {
        pTVar4 = this + 0x80;
      }
      else {
...
std::
map<glslang::TVector<glslang::TTypeLoc>*,glslang::TVector<glslang::TTypeLoc>*,std::less<glslang::TVector<glslang::TTypeLoc>*>,glslang::pool_allocator<std::pair<glslang::TVector<glslang::TTypeLoc>*const,glslang::TVector<glslang::TTypeLoc>*>>>
::operator[](map<glslang::TVector<glslang::TTypeLoc>*,glslang::TVector<glslang::TTypeLoc>*,std::less<glslang::TVector<glslang::TTypeLoc>*>,glslang::pool_allocator<std::pair<glslang::TVector<glslang::TTypeLoc>*const,glslang::TVector<glslang::TTypeLoc>*>>>
             *this,TVector **param_1)
...
LAB_00107170:
    ...
    *(TVector **)(p_Var4 + 0x20) = pTVar7;
    if ((lVar3 == 0) ||
       (p_Var5 = *(_Rb_tree_node_base **)(this + 0x28), pTVar7 <= *(TVector **)(p_Var5 + 0x20))) {
LAB_00107140:
      auVar9 = _Rb_tree<glslang::TVector<glslang::TTypeLoc>*,std::pair<glslang::TVector<glslang::TTypeLoc>*const,glslang::TVector<glslang::TTypeLoc>*>,std::_Select1st<std::pair<glslang::TVector<glslang::TTypeLoc>*const,glslang::TVector<glslang::TTypeLoc>*>>,std::less<glslang::TVector<glslang::TTypeLoc>*>,glslang::pool_allocator<std::pair<glslang::TVector<glslang::TTypeLoc>*const,glslang::TVector<glslang::TTypeLoc>*>>>
               ::_M_get_insert_unique_pos
                         ((_Rb_tree<glslang::TVector<glslang::TTypeLoc>*,std::pair<glslang::TVector<glslang::TTypeLoc>*const,glslang::TVector<glslang::TTypeLoc>*>,std::_Select1st<std::pair<glslang::TVector<glslang::TTypeLoc>*const,glslang::TVector<glslang::TTypeLoc>*>>,std::less<glslang::TVector<glslang::TTypeLoc>*>,glslang::pool_allocator<std::pair<glslang::TVector<glslang::TTypeLoc>*const,glslang::TVector<glslang::TTypeLoc>*>>>
                           *)this,(TVector **)pTVar7);
      p_Var5 = auVar9._8_8_;
      p_Var6 = auVar9._0_8_;
      if (p_Var5 == (_Rb_tree_node_base *)0x0) goto LAB_00107107;
...
LAB_0010715c:
    if ((p_Var1 == p_Var5) || (p_Var6 = p_Var5, bVar8)) {
      bVar8 = true;
      p_Var6 = p_Var4;
    }
    else {
LAB_001071ac:
    ...
    do {
      while( true ) {
        ...
        p_Var6 = p_Var5;
        if (*(_Rb_tree_node_base **)p_Var2 == (_Rb_tree_node_base *)0x0) goto LAB_00107091;
      }
      p_Var4 = *(_Rb_tree_node_base **)(p_Var6 + 0x10);
      p_Var5 = p_Var6;
    } while (*(_Rb_tree_node_base **)(p_Var6 + 0x10) != (_Rb_tree_node_base *)0x0);
LAB_00107091:
    if (p_Var1 == p_Var6) goto LAB_00107170;
    if (*(TVector **)(p_Var6 + 0x20) <= *param_1) goto LAB_00107107;
    p_Var4 = (_Rb_tree_node_base *)glslang::TPoolAllocator::allocate(*(ulong *)this);
    pTVar7 = *param_1;
    *(undefined8 *)(p_Var4 + 0x28) = 0;
    *(TVector **)(p_Var4 + 0x20) = pTVar7;
    if (*(TVector **)(p_Var6 + 0x20) <= pTVar7) {
      if (pTVar7 <= *(TVector **)(p_Var6 + 0x20)) goto LAB_00107107;
      if (*(_Rb_tree_node_base **)(this + 0x28) != p_Var6) {
        p_Var5 = (_Rb_tree_node_base *)std::_Rb_tree_increment(p_Var6);
        if (*(TVector **)(p_Var5 + 0x20) <= pTVar7) goto LAB_00107140;
        if (*(long *)(p_Var6 + 0x18) == 0) goto LAB_001071ac;
        bVar8 = true;
        goto LAB_0010715c;
      }
      goto LAB_001071ac;
    ...
    if (*(_Rb_tree_node_base **)(this + 0x20) != p_Var6) {
      ...
      if (pTVar7 <= *(TVector **)(p_Var5 + 0x20)) goto LAB_00107140;
      if (*(long *)(p_Var5 + 0x18) != 0) goto LAB_001070ec;
      goto LAB_001071a2;
    }
LAB_001070ec:
    bVar8 = true;
...

{
  ...
  if (lVar10 == lVar2) {
    if (0xfffffffffffffffe < uVar4) goto LAB_001072f0;
...
LAB_00107275:
    ...
    if (param_2 == lVar2) goto LAB_001072d0;
  }
  else {
    uVar7 = uVar4 * 2;
    if (uVar7 < uVar4) {
LAB_001072f0:
    ...
    *puVar9 = *param_3;
    ...
    puVar9[2] = param_3[2];
    puVar9[3] = uVar3;
    if (param_2 != lVar10) goto LAB_00107275;
  }
  lVar10 = 0;
  do {
...
std::
_Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,int>,std::_Select1st<std::pair<std::__cxx11::string_const,int>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
::find(_Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,int>,std::_Select1st<std::pair<std::__cxx11::string_const,int>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
       *this,string *param_1)

{
  ...
  *p_Var9;
  ...
  p_Var1 = this + 8;
  p_Var8 = p_Var1;
  if (*(_Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,int>,std::_Select1st<std::pair<std::__cxx11::string_const,int>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
        **)(this + 0x10) !=
      (_Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,int>,std::_Select1st<std::pair<std::__cxx11::string_const,int>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
       *)0x0) {
    __s2 = *(void **)param_1;
    uVar3 = *(ulong *)(param_1 + 8);
    p_Var9 = *(_Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,int>,std::_Select1st<std::pair<std::__cxx11::string_const,int>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
               **)(this + 0x10);
    do {
      while( true ) {
        ...
        if ((uVar6 != 0) && (iVar5 = memcmp(*(void **)(p_Var9 + 0x20),__s2,uVar6), iVar5 != 0))
        break;
        lVar7 = uVar4 - uVar3;
        if (lVar7 < 0x80000000) {
          if (-0x80000001 < lVar7) {
...
LAB_00107419:
        ...
        if (*(_Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,int>,std::_Select1st<std::pair<std::__cxx11::string_const,int>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
              **)p_Var2 ==
            (_Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,int>,std::_Select1st<std::pair<std::__cxx11::string_const,int>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
             *)0x0) goto LAB_00107425;
      }
      if (-1 < iVar5) goto LAB_00107419;
LAB_001073d0:
      p_Var9 = *(_Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,int>,std::_Select1st<std::pair<std::__cxx11::string_const,int>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
                 **)(p_Var9 + 0x18);
    } while (p_Var9 != (_Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,int>,std::_Select1st<std::pair<std::__cxx11::string_const,int>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
                        *)0x0);
LAB_00107425:
    if (p_Var1 != p_Var8) {
...

{
  ...
  if (__src == pvVar1) {
    if (0xfffffffffffffffe < uVar2) goto LAB_00107550;
...
LAB_00107550:
  ...
  *(undefined4 *)((long)__dest_00 + __n) = *param_3;
  if ((long)__n < 1) {
    ...
    if (__src == (void *)0x0) goto LAB_0010752b;
  }
  else {
...

{
  ...
  uVar2 = *(ulong *)(this + 0x10);
  if (param_2 <= 0x7fffffffffffffff - uVar2) {
    pbVar4 = *(basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> **)(this + 8)
    ;
    uVar1 = param_2 + uVar2;
    if (pbVar4 == this + 0x18) {
...

{
  ...
  else if (__n == 0) goto LAB_0010794c;
  if (__n == 1) {
    *__dest = **(basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> **)
                (param_1 + 8);
    __dest = *(basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> **)(this + 8)
...
/* void std::vector<glslang::TObjectReflection, std::allocator<glslang::TObjectReflection>
   >::_M_realloc_insert<glslang::TObjectReflection>(__gnu_cxx::__normal_iterator<glslang::TObjectReflection*,
   std::vector<glslang::TObjectReflection, std::allocator<glslang::TObjectReflection> > >,
   glslang::TObjectReflection&&) */
...

{
  ...
  lVar9 = (long)puVar2 - (long)puVar3 >> 4;
  uVar10 = lVar9 * -0x3333333333333333;
  if (uVar10 == 0x199999999999999) {
                    /* WARNING: Subroutine does not return */
    std::__throw_length_error("vector::_M_realloc_insert");
  }
  if (puVar3 == puVar2) {
    uVar16 = uVar10 + 1;
    if (0xfffffffffffffffe < uVar10) goto LAB_00107b88;
    if (0x199999999999999 < uVar16) {
      uVar16 = 0x199999999999999;
    }
    uVar16 = uVar16 * 0x50;
  }
  else {
    uVar16 = lVar9 * -0x6666666666666666;
    if (uVar16 < uVar10) {
LAB_00107b88:
      uVar16 = 0x7fffffffffffffd0;
    }
    else {
      if (uVar16 == 0) {
        plVar14 = (long *)0x50;
  ...
  plVar12 = (long *)operator_new(uVar16);
  plVar14 = plVar12 + 10;
  lVar9 = uVar16 + (long)plVar12;
LAB_00107a59:
  plVar15 = (long *)((long)plVar12 + ((long)param_2 - (long)puVar3));
  lVar17 = *param_3;
  plVar4 = param_3 + 2;
  lVar20 = param_3[1];
  *plVar15 = (long)(plVar15 + 2);
  if ((long *)lVar17 == plVar4) {
    uVar10 = lVar20 + 1;
    uVar18 = (uint)uVar10;
    if (uVar18 < 8) {
      if ((uVar10 & 4) == 0) {
        if ((uVar18 != 0) && (*(char *)(plVar15 + 2) = (char)param_3[2], (uVar10 & 2) != 0)) {
          *(undefined2 *)((long)plVar15 + (uVar10 & 0xffffffff) + 0xe) =
               *(undefined2 *)((long)param_3 + (uVar10 & 0xffffffff) + 0xe);
        }
      }
      else {
        *(int *)(plVar15 + 2) = (int)param_3[2];
        *(undefined4 *)((long)plVar15 + (uVar10 & 0xffffffff) + 0xc) =
             *(undefined4 *)((long)param_3 + (uVar10 & 0xffffffff) + 0xc);
      }
    }
    else {
      plVar15[2] = param_3[2];
      *(undefined8 *)((long)plVar15 + (uVar10 & 0xffffffff) + 8) =
           *(undefined8 *)((long)param_3 + (uVar10 & 0xffffffff) + 8);
      lVar17 = (long)(plVar15 + 2) - ((ulong)(plVar15 + 3) & 0xfffffffffffffff8);
      uVar18 = uVar18 + (int)lVar17 & 0xfffffff8;
      if (7 < uVar18) {
        uVar19 = 0;
        do {
          uVar10 = (ulong)uVar19;
          uVar19 = uVar19 + 8;
          *(undefined8 *)(((ulong)(plVar15 + 3) & 0xfffffffffffffff8) + uVar10) =
               *(undefined8 *)((long)plVar4 + (uVar10 - lVar17));
        } while (uVar19 < uVar18);
      }
    }
  }
      ...
      *plVar15 = (long)plVar14;
      ...
      if (plVar4 == puVar13 + 2) {
        ...
        if (7 < uVar18) {
          *plVar14 = *plVar4;
          *(undefined8 *)((long)plVar15 + (uVar10 & 0xffffffff) + 8) =
               *(undefined8 *)((long)plVar4 + ((uVar10 & 0xffffffff) - 8));
          lVar17 = (long)plVar14 - ((ulong)(plVar15 + 3) & 0xfffffffffffffff8);
          uVar18 = uVar18 + (int)lVar17 & 0xfffffff8;
          if (7 < uVar18) {
            uVar19 = 0;
            do {
        ...
        if ((uVar10 & 4) == 0) {
          if (uVar18 != 0) {
            *(char *)plVar14 = (char)*plVar4;
            if ((uVar10 & 2) == 0) goto LAB_00107aeb;
            *(undefined2 *)((long)plVar15 + (uVar10 & 0xffffffff) + 0xe) =
                 *(undefined2 *)((long)plVar4 + ((uVar10 & 0xffffffff) - 2));
            lVar17 = puVar13[1];
          }
        }
        else {
          *(int *)plVar14 = (int)*plVar4;
          *(undefined4 *)((long)plVar15 + (uVar10 & 0xffffffff) + 0xc) =
               *(undefined4 *)((long)plVar4 + ((uVar10 & 0xffffffff) - 4));
          lVar17 = puVar13[1];
        }
      }
      else {
...
LAB_00107aeb:
      ...
      lVar7 = puVar13[6];
      lVar8 = puVar13[7];
      *(undefined4 *)(plVar15 + 8) = uVar1;
      uVar1 = *(undefined4 *)((long)puVar13 + 0x44);
      plVar15[4] = lVar20;
      plVar15[5] = lVar6;
      *(undefined4 *)((long)plVar15 + 0x44) = uVar1;
      lVar17 = puVar13[9];
      plVar15[6] = lVar7;
      plVar15[7] = lVar8;
      plVar15[9] = lVar17;
    ...
    plVar14 = (long *)((long)plVar12 +
                      ((long)param_2 + (-0x50 - (long)puVar3) & 0xfffffffffffffff0U) + 0xa0);
  }
  puVar13 = param_2;
  plVar15 = plVar14;
  if (param_2 != puVar2) {
    do {
      ...
      *plVar15 = (long)plVar4;
      if (plVar5 == puVar13 + 2) {
        ...
        if (uVar18 < 8) {
          if ((uVar10 & 4) == 0) {
            if ((uVar18 != 0) && (*(char *)plVar4 = (char)*plVar5, (uVar10 & 2) != 0)) {
              *(undefined2 *)((long)plVar15 + (uVar10 & 0xffffffff) + 0xe) =
                   *(undefined2 *)((long)plVar5 + ((uVar10 & 0xffffffff) - 2));
            }
          }
          else {
            *(int *)plVar4 = (int)*plVar5;
            *(undefined4 *)((long)plVar15 + (uVar10 & 0xffffffff) + 0xc) =
                 *(undefined4 *)((long)plVar5 + ((uVar10 & 0xffffffff) - 4));
          }
        }
        else {
          *plVar4 = *plVar5;
          *(undefined8 *)((long)plVar15 + (uVar10 & 0xffffffff) + 8) =
          ...
          lVar20 = (long)plVar4 - ((ulong)(plVar15 + 3) & 0xfffffffffffffff8);
          uVar18 = uVar18 + (int)lVar20 & 0xfffffff8;
          if (7 < uVar18) {
            uVar19 = 0;
            do {
              uVar10 = (ulong)uVar19;
              uVar19 = uVar19 + 8;
              *(undefined8 *)(((ulong)(plVar15 + 3) & 0xfffffffffffffff8) + uVar10) =
                   *(undefined8 *)((long)plVar5 + (uVar10 - lVar20));
            } while (uVar19 < uVar18);
          }
        }
      }
    ...
    plVar14 = plVar14 + ((((ulong)((long)puVar2 + (-0x50 - (long)param_2)) >> 4) * 0xccccccccccccccd
...
void std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
     _M_replace(ulong param_1,ulong param_2,char *param_3,ulong param_4)
...
LAB_00108154:
    ...
    do {
      p_Var7 = (_Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,int>,std::_Select1st<std::pair<std::__cxx11::string_const,int>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
                *)p_Var5;
...
LAB_001080c4:
        uVar4 = uVar10 - uVar9;
        if (0x7fffffff < (long)uVar4) goto LAB_001080e2;
        if (-0x80000001 < (long)uVar4) goto LAB_001080de;
LAB_00108088:
        ...
        uVar4 = (ulong)uVar2;
        if (uVar2 == 0) goto LAB_001080c4;
LAB_001080de:
        if ((int)uVar4 < 0) goto LAB_00108088;
LAB_001080e2:
  ...
  if (param_2 == (_Rb_tree_node_base *)(this + 8)) {
    if (*(long *)(this + 0x28) != 0) {
      ...
      if ((uVar6 == 0) ||
        ...
        lVar5 = uVar2 - uVar1;
        if (0x7fffffff < lVar5) goto LAB_001083f6;
        if (lVar5 < -0x80000000) goto LAB_00108386;
        iVar3 = (int)lVar5;
      }
      if (-1 < iVar3) goto LAB_001083f6;
      goto LAB_00108386;
    }
    goto LAB_001083f6;
  }
...
LAB_001082aa:
      if (*(_Rb_tree_node_base **)(this + 0x18) == param_2) goto LAB_0010827b;
...
LAB_00108254:
    ...
    if ((long)uVar6 < 0x80000000) {
      if (-0x80000001 < (long)uVar6) goto LAB_0010826e;
      goto LAB_001083a0;
    }
  }
  else {
    ...
    if (iVar3 == 0) {
      lVar5 = uVar1 - uVar2;
      if (lVar5 < 0x80000000) {
        if (lVar5 < -0x80000000) goto LAB_001082aa;
        iVar3 = (int)lVar5;
        goto LAB_00108243;
      }
    }
...
LAB_00108243:
      if (iVar3 < 0) goto LAB_001082aa;
    }
    uVar4 = memcmp(__s2,__s1,uVar6);
    uVar6 = (ulong)uVar4;
    if (uVar4 == 0) goto LAB_00108254;
LAB_0010826e:
    if ((int)uVar6 < 0) {
LAB_001083a0:
...
LAB_001083dc:
        uVar6 = uVar1 - uVar2;
        if (0x7fffffff < (long)uVar6) goto LAB_001083f6;
        if (-0x80000001 < (long)uVar6) goto LAB_001083f2;
      }
      else {
        uVar4 = memcmp(__s1,*(void **)(p_Var8 + 0x20),uVar6);
        uVar6 = (ulong)uVar4;
        if (uVar4 == 0) goto LAB_001083dc;
LAB_001083f2:
        if (-1 < (int)uVar6) {
LAB_001083f6:
  ...
  if (*(_Rb_tree_node_base **)(this + 0x10) != (_Rb_tree_node_base *)0x0) {
    ...
    do {
      while( true ) {
        ...
        if ((uVar7 != 0) && (iVar4 = memcmp(*(void **)(p_Var5 + 0x20),__s2,uVar7), iVar4 != 0))
        break;
        lVar6 = uVar3 - uVar2;
        if (lVar6 < 0x80000000) {
          if (-0x80000001 < lVar6) {
...
LAB_001084c4:
        p_Var8 = p_Var5 + 0x10;
        p_Var9 = p_Var5;
        p_Var5 = *(_Rb_tree_node_base **)p_Var8;
        if (*(_Rb_tree_node_base **)p_Var8 == (_Rb_tree_node_base *)0x0) goto LAB_001084d0;
      }
      if (-1 < iVar4) goto LAB_001084c4;
LAB_00108478:
...
LAB_001084d0:
    if (p_Var1 != p_Var9) {
      ...
      if ((uVar7 == 0) || (iVar4 = memcmp(__s2,*(void **)(p_Var9 + 0x20),uVar7), iVar4 == 0)) {
        lVar6 = uVar2 - uVar3;
        if (0x7fffffff < lVar6) goto LAB_00108519;
        if (lVar6 < -0x80000000) goto LAB_00108535;
        iVar4 = (int)lVar6;
      }
      if (-1 < iVar4) goto LAB_00108519;
    }
  }
LAB_00108535:
  ...
  *(_Rb_tree_node_base **)(p_Var5 + 0x20) = p_Var5 + 0x30;
  __cxx11::string::_M_construct<char*>
            (p_Var5 + 0x20,*(long *)param_1,*(long *)(param_1 + 8) + *(long *)param_1);
  *(undefined4 *)(p_Var5 + 0x40) = 0;
  auVar11 = _Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,int>,std::_Select1st<std::pair<std::__cxx11::string_const,int>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
            ::_M_get_insert_hint_unique_pos
                      ((_Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,int>,std::_Select1st<std::pair<std::__cxx11::string_const,int>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
                        *)this,p_Var9,p_Var5 + 0x20);
  p_Var8 = auVar11._8_8_;
  p_Var9 = auVar11._0_8_;
  if (p_Var8 == (_Rb_tree_node_base *)0x0) {
    if (p_Var5 + 0x30 != *(_Rb_tree_node_base **)(p_Var5 + 0x20)) {
      operator_delete(*(_Rb_tree_node_base **)(p_Var5 + 0x20),*(long *)(p_Var5 + 0x30) + 1);
    }
    operator_delete(p_Var5,0x48);
    goto LAB_00108519;
  }
  if ((p_Var1 == p_Var8) || (p_Var9 != (_Rb_tree_node_base *)0x0)) {
LAB_00108596:
    bVar10 = true;
  }
  else {
    uVar2 = *(ulong *)(p_Var5 + 0x28);
    ...
    if ((uVar7 == 0) ||
       (iVar4 = memcmp(*(void **)(p_Var5 + 0x20),*(void **)(p_Var8 + 0x20),uVar7), iVar4 == 0)) {
      lVar6 = uVar2 - uVar3;
      bVar10 = false;
      if (0x7fffffff < lVar6) goto LAB_0010859b;
      if (lVar6 < -0x80000000) goto LAB_00108596;
      iVar4 = (int)lVar6;
    }
    bVar10 = SUB41((uint)iVar4 >> 0x1f,0);
  }
LAB_0010859b:
  std::_Rb_tree_insert_and_rebalance(bVar10,p_Var5,p_Var8,p_Var1);
...

{
  ...
  if (*(_Rb_tree_node_base **)(this + 0x10) != (_Rb_tree_node_base *)0x0) {
    ...
    do {
      while( true ) {
        p_Var6 = p_Var2;
        uVar14 = *(ulong *)(p_Var6 + 0x28);
        uVar11 = uVar12;
        if (uVar14 <= uVar12) {
          uVar11 = uVar14;
        }
        if ((uVar11 != 0) && (iVar5 = memcmp(*(void **)(p_Var6 + 0x20),__s2,uVar11), iVar5 != 0))
        break;
        lVar8 = uVar14 - uVar12;
        if (lVar8 < 0x80000000) {
          if (-0x80000001 < lVar8) {
...
LAB_001086d1:
        p_Var2 = *(_Rb_tree_node_base **)(p_Var6 + 0x10);
        p_Var15 = p_Var6;
        if (*(_Rb_tree_node_base **)(p_Var6 + 0x10) == (_Rb_tree_node_base *)0x0) goto LAB_001086dd;
      }
      if (-1 < iVar5) goto LAB_001086d1;
LAB_00108680:
      p_Var2 = *(_Rb_tree_node_base **)(p_Var6 + 0x18);
    } while (*(_Rb_tree_node_base **)(p_Var6 + 0x18) != (_Rb_tree_node_base *)0x0);
LAB_001086dd:
    if (p_Var1 != p_Var15) {
      uVar14 = *(ulong *)(p_Var15 + 0x28);
      uVar11 = uVar12;
      if (uVar14 <= uVar12) {
        uVar11 = uVar14;
      }
      if ((uVar11 == 0) || (iVar5 = memcmp(__s2,*(void **)(p_Var15 + 0x20),uVar11), iVar5 == 0)) {
        lVar8 = uVar12 - uVar14;
        if (0x7fffffff < lVar8) goto LAB_00108725;
        if (lVar8 < -0x80000000) goto LAB_00108744;
        iVar5 = (int)lVar8;
      }
      if (-1 < iVar5) goto LAB_00108725;
    }
  }
LAB_00108744:
  p_Var6 = (_Rb_tree_node_base *)operator_new(0x48);
  psVar4 = *(string **)param_1;
  p_Var2 = p_Var6 + 0x30;
  *(_Rb_tree_node_base **)(p_Var6 + 0x20) = p_Var2;
  psVar3 = param_1 + 0x10;
  if (psVar4 == psVar3) {
    ...
    if (uVar9 < 8) {
      if ((uVar12 & 4) == 0) {
        if ((uVar9 != 0) && (*p_Var2 = *(_Rb_tree_node_base *)(param_1 + 0x10), (uVar12 & 2) != 0))
        {
          *(undefined2 *)(p_Var6 + (uVar12 & 0xffffffff) + 0x2e) =
               *(undefined2 *)(param_1 + (uVar12 & 0xffffffff) + 0xe);
        }
      }
      else {
        *(undefined4 *)p_Var2 = *(undefined4 *)(param_1 + 0x10);
        *(undefined4 *)(p_Var6 + (uVar12 & 0xffffffff) + 0x2c) =
             *(undefined4 *)(param_1 + (uVar12 & 0xffffffff) + 0xc);
      }
    }
    else {
      *(undefined8 *)p_Var2 = *(undefined8 *)(param_1 + 0x10);
      *(undefined8 *)(p_Var6 + (uVar12 & 0xffffffff) + 0x28) =
           *(undefined8 *)(param_1 + (uVar12 & 0xffffffff) + 8);
      lVar8 = (long)p_Var2 - ((ulong)(p_Var6 + 0x38) & 0xfffffffffffffff8);
      ...
      if (7 < uVar9) {
        ...
        do {
          uVar12 = (ulong)uVar7;
          uVar7 = uVar7 + 8;
          *(undefined8 *)(((ulong)(p_Var6 + 0x38) & 0xfffffffffffffff8) + uVar12) =
               *(undefined8 *)(psVar3 + (uVar12 - lVar8));
        } while (uVar7 < uVar9);
      }
    }
  }
  else {
    *(string **)(p_Var6 + 0x20) = psVar4;
    uVar14 = *(ulong *)(param_1 + 8);
    *(undefined8 *)(p_Var6 + 0x30) = *(undefined8 *)(param_1 + 0x10);
  }
  *(string **)param_1 = psVar3;
  *(undefined8 *)(param_1 + 8) = 0;
  param_1[0x10] = (string)0x0;
  *(ulong *)(p_Var6 + 0x28) = uVar14;
  *(undefined4 *)(p_Var6 + 0x40) = 0;
  auVar16 = _Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,int>,std::_Select1st<std::pair<std::__cxx11::string_const,int>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
            ::_M_get_insert_hint_unique_pos
                      ((_Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,int>,std::_Select1st<std::pair<std::__cxx11::string_const,int>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
                        *)this,p_Var15,p_Var6 + 0x20);
  p_Var10 = auVar16._8_8_;
  p_Var15 = auVar16._0_8_;
  if (p_Var10 == (_Rb_tree_node_base *)0x0) {
    if (p_Var2 != *(_Rb_tree_node_base **)(p_Var6 + 0x20)) {
      operator_delete(*(_Rb_tree_node_base **)(p_Var6 + 0x20),*(long *)(p_Var6 + 0x30) + 1);
    }
    operator_delete(p_Var6,0x48);
    goto LAB_00108725;
  }
  if ((p_Var1 == p_Var10) || (p_Var15 != (_Rb_tree_node_base *)0x0)) {
LAB_001087c2:
    bVar13 = true;
  }
  else {
    ...
    if ((uVar11 == 0) ||
       (iVar5 = memcmp(*(void **)(p_Var6 + 0x20),*(void **)(p_Var10 + 0x20),uVar11), iVar5 == 0)) {
      bVar13 = false;
      lVar8 = uVar14 - uVar12;
      if (0x7fffffff < lVar8) goto LAB_001087c7;
      if (lVar8 < -0x80000000) goto LAB_001087c2;
      iVar5 = (int)lVar8;
    }
    bVar13 = SUB41((uint)iVar5 >> 0x1f,0);
  }
LAB_001087c7:
  std::_Rb_tree_insert_and_rebalance(bVar13,p_Var6,p_Var10,p_Var1);
  *(long *)(this + 0x28) = *(long *)(this + 0x28) + 1;
  p_Var15 = p_Var6;
LAB_00108725:
  return p_Var15 + 0x40;
...
std::
_Rb_tree<int,std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>,std::_Select1st<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>>
::_Reuse_or_alloc_node::operator()(_Reuse_or_alloc_node *this,pair *param_1)
...
_Rb_tree<int,std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>,std::_Select1st<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>>
::
_M_copy<false,std::_Rb_tree<int,std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>,std::_Select1st<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>>::_Reuse_or_alloc_node>
...

{
  ...
  p_Var2 = _Reuse_or_alloc_node::operator()(param_3,(pair *)(param_1 + 0x20));
  uVar1 = *(undefined4 *)param_1;
  ...
  *(undefined4 *)p_Var2 = uVar1;
  if (p_Var3 != (_Rb_tree_node *)0x0) {
    p_Var3 = _M_copy<false,std::_Rb_tree<int,std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>,std::_Select1st<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>>::_Reuse_or_alloc_node>
                       (p_Var3,(_Rb_tree_node_base *)p_Var2,param_3);
  ...
  p_Var3 = p_Var2;
  if (p_Var7 == (_Rb_tree_node_base *)0x0) goto LAB_00108ca3;
  do {
    p_Var6 = p_Var7;
    lVar9 = *(long *)(p_Var6 + 8);
    ...
    while( true ) {
      ...
      *(_Rb_tree_node **)(p_Var6 + 8) = p_Var3;
      if (*(_Rb_tree_node **)(puVar11 + 6) != (_Rb_tree_node *)0x0) {
        p_Var3 = _M_copy<false,std::_Rb_tree<int,std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>,std::_Select1st<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>>::_Reuse_or_alloc_node>
                           (*(_Rb_tree_node **)(puVar11 + 6),p_Var6,param_3);
...
std::
_Rb_tree<int,std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>,std::_Select1st<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>>
::operator=(_Rb_tree<int,std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>,std::_Select1st<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>>
  ...
  *local_28;
  ...
  if (local_38 == 0) {
    ...
    *(undefined8 *)(this + 0x30) = 0;
    ...
    lStack_30 = 0;
    if (p_Var5 == (_Rb_tree_node *)0x0) goto LAB_00108ec2;
LAB_00108e5f:
    p_Var2 = _M_copy<false,std::_Rb_tree<int,std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>,std::_Select1st<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>>::_Reuse_or_alloc_node>
                       (p_Var5,(_Rb_tree_node_base *)(this + 0x10),(_Reuse_or_alloc_node *)&local_38
                       );
    p_Var5 = p_Var2;
    do {
      p_Var3 = p_Var5;
    ...
    *(undefined8 *)(this + 0x30) = uVar1;
    lVar4 = local_38;
    if (local_38 == 0) goto LAB_00108ec2;
  }
  else {
    ...
    *(undefined8 *)(this + 0x30) = 0;
    lVar4 = local_38;
    if (p_Var5 != (_Rb_tree_node *)0x0) goto LAB_00108e5f;
  }
  do {
...
_Rb_tree<int,std::pair<int_const,glslang::TVector<glslang::TIntermTyped_const*>>,std::_Select1st<std::pair<int_const,glslang::TVector<glslang::TIntermTyped_const*>>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TVector<glslang::TIntermTyped_const*>>>>
::
_M_copy<false,std::_Rb_tree<int,std::pair<int_const,glslang::TVector<glslang::TIntermTyped_const*>>,std::_Select1st<std::pair<int_const,glslang::TVector<glslang::TIntermTyped_const*>>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TVector<glslang::TIntermTyped_const*>>>>::_Reuse_or_alloc_node>
          (_Rb_tree_node *param_1,_Rb_tree_node_base *param_2,_Reuse_or_alloc_node *param_3)

{
  ...
  *(undefined4 *)p_Var2 = uVar1;
  if (p_Var3 != (_Rb_tree_node *)0x0) {
    p_Var3 = _M_copy<false,std::_Rb_tree<int,std::pair<int_const,glslang::TVector<glslang::TIntermTyped_const*>>,std::_Select1st<std::pair<int_const,glslang::TVector<glslang::TIntermTyped_const*>>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TVector<glslang::TIntermTyped_const*>>>>::_Reuse_or_alloc_node>
                       (p_Var3,(_Rb_tree_node_base *)p_Var2,param_3);
    *(_Rb_tree_node **)(p_Var2 + 0x18) = p_Var3;
  }
  puVar11 = *(undefined4 **)(param_1 + 0x10);
  ...
  p_Var7 = *(_Rb_tree_node_base **)(param_3 + 8);
  p_Var3 = p_Var2;
  if (p_Var7 == (_Rb_tree_node_base *)0x0) goto LAB_001092a3;
  do {
    p_Var6 = p_Var7;
    lVar9 = *(long *)(p_Var6 + 8);
    *(long *)(param_3 + 8) = lVar9;
...
void __thiscall glslang::TType::deepCopy(TType *this,TType *param_1,TMap *param_2)

{
  ...
  *(ushort *)(this + 10) = *(ushort *)(this + 10) & 0xfc7f | *(ushort *)(param_1 + 10) & 0x380;
  ...
  if (*(long *)(param_1 + 0x50) != 0) {
    ...
    this_00 = (_Rb_tree<int,std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>,std::_Select1st<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>>
               *)glslang::TPoolAllocator::allocate(uVar16);
    ...
    *(_Rb_tree<int,std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>,std::_Select1st<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>>
      **)(this_00 + 0x90) = this_00 + 0x80;
    *(_Rb_tree<int,std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>,std::_Select1st<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>>
      **)(this_00 + 0x98) = this_00 + 0x80;
    ...
    *(_Rb_tree<int,std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>,std::_Select1st<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>>
      ...
      *(undefined8 *)(this_00 + 0x68) = 0;
      ...
      if (p_Var7 != (_Rb_tree_node *)0x0) {
        p_Var18 = std::
                  ...
                  ::
                  _M_copy<false,std::_Rb_tree<int,std::pair<int_const,glslang::TVector<glslang::TIntermTyped_const*>>,std::_Select1st<std::pair<int_const,glslang::TVector<glslang::TIntermTyped_const*>>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TVector<glslang::TIntermTyped_const*>>>>::_Reuse_or_alloc_node>
                            (p_Var7,p_Var2,(_Reuse_or_alloc_node *)&local_68);
        p_Var7 = p_Var18;
        do {
          p_Var27 = p_Var7;
    ...
    if (p_Var6 + 0x70 != (_Rb_tree *)(this_00 + 0x70)) {
      std::
      _Rb_tree<int,std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>,std::_Select1st<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>>
      ::operator=(this_00 + 0x70,p_Var6 + 0x70);
    }
  }
  if (*(long *)(param_1 + 0x90) != 0) {
    ...
    *(basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> **)(pbVar19 + 8) =
         pbVar19 + 0x18;
    *(undefined8 *)(pbVar19 + 0x10) = 0;
    std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
    _M_replace(pbVar19,0,0,"",0);
    ...
    *(basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> **)(this + 0x90) =
         pbVar19;
    ...
    *(undefined4 *)(pbVar19 + 0x28) = *(undefined4 *)(pbVar8 + 0x28);
    std::vector<glslang::TSpirvTypeParameter,glslang::pool_allocator<glslang::TSpirvTypeParameter>>
    ::operator=((vector<glslang::TSpirvTypeParameter,glslang::pool_allocator<glslang::TSpirvTypeParameter>>
                 *)(pbVar19 + 0x30),(vector *)(pbVar8 + 0x30));
  }
  if (*(long *)(param_1 + 0x60) != 0) {
    ...
    *puVar20 = &PTR__TSmallArrayVector_001100d0;
    puVar20[1] = 0;
    ...
    *(undefined1 *)((long)puVar20 + 0x15) = *(undefined1 *)(lVar29 + 0x15);
    if (lVar28 == 0) {
      ...
      uVar16 = glslang::GetThreadPoolAllocator();
      pvVar21 = (vector<glslang::TArraySize,glslang::pool_allocator<glslang::TArraySize>> *)
                glslang::TPoolAllocator::allocate(uVar16);
      uVar17 = glslang::GetThreadPoolAllocator();
        ...
        if (*(TMap **)(param_2 + 0x18) != (TMap *)0x0) {
          do {
            while( true ) {
              ...
              pTVar13 = *(TMap **)pTVar1;
              pTVar31 = pTVar30;
              if (*(TMap **)pTVar1 == (TMap *)0x0) goto LAB_00109ae9;
            }
            pTVar13 = *(TMap **)(pTVar31 + 0x10);
            pTVar30 = pTVar31;
          } while (*(TMap **)(pTVar31 + 0x10) != (TMap *)0x0);
LAB_00109ae9:
          if ((param_2 + 0x10 != pTVar31) && (*(ulong *)(pTVar31 + 0x20) <= uVar16)) {
        ...
        *plVar25 = (long)puVar20;
        ...
        if (lVar29 != *(long *)(*(long *)(param_1 + 0x68) + 0x10)) {
          ...
          do {
            ...
            *(undefined ***)local_68 = &PTR__TType_001100f0;
            ...
            *(uint *)((TType *)local_68 + 8) =
                 CONCAT22((short)((uint)*(undefined4 *)((TType *)local_68 + 8) >> 0x10),0x100) &
                 0xf800ffff;
            ...
            *(ulong *)((TType *)local_68 + 0x2d) =
                 *(ulong *)((TType *)local_68 + 0x2d) & 0xffffff0000ffc07f | 0xffff001f80;
            ...
            *(ulong *)((TType *)local_68 + 0x38) =
                 (ulong)((uint)*(undefined8 *)((TType *)local_68 + 0x38) & 0xfe07ff00) | 0x1f800ff;
            ((TType *)local_68)[0x40] = (TType)0x0;
            *(ulong *)((TType *)local_68 + 0x2c) =
                 *(ulong *)((TType *)local_68 + 0x2c) & 0xffffffff8000 | 0xffff000000004fff;
            *(ulong *)((TType *)local_68 + 0x34) =
                 *(ulong *)((TType *)local_68 + 0x34) | 0x7ff007fffffff;
            *(undefined4 *)((TType *)local_68 + 0x4c) = 0xffffffff;
            *(ulong *)((TType *)local_68 + 0x18) =
                 *(ulong *)((TType *)local_68 + 0x18) & 0x8000000400000000;
            lVar29 = *(long *)(param_1 + 0x68);
            *(undefined8 *)((TType *)local_68 + 0x50) = 0;
            deepCopy((TType *)local_68,*(TType **)(*(long *)(lVar29 + 8) + lVar28),param_2);
            pvVar10 = *(vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>> **)
                       (this + 0x68);
            puVar20 = *(undefined8 **)(pvVar10 + 0x10);
            if (puVar20 == *(undefined8 **)(pvVar10 + 0x18)) {
              std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>::
              _M_realloc_insert<glslang::TTypeLoc_const&>(pvVar10,puVar20,&local_68);
            }
            else {
              *puVar20 = local_68;
              puVar20[1] = lStack_60;
...
LAB_001099ba:
  if (*(long *)(param_1 + 0x70) != 0) {
    ...
    *puVar20 = uVar17;
    puVar20[1] = puVar20 + 3;
    if (pcVar9 == (char *)0x0) goto LAB_00109d54;
    sVar24 = strlen(pcVar9);
    std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
    _M_construct<char_const*>(puVar20,pcVar9,pcVar9 + sVar24);
...
/* glslang::TReflectionTraverser::addBlockName(std::__cxx11::basic_string<char,
   std::char_traits<char>, glslang::std::allocator<char> > const&, glslang::TType const&, int) */

int __thiscall
glslang::TReflectionTraverser::addBlockName
          (TReflectionTraverser *this,basic_string *param_1,TType *param_2,int param_3)
...
LAB_0010a015:
      ...
      do {
        ...
        if (ppppcVar10 < (char ****)0x10) {
          ...
          if (ppppcVar17 == (char ****)0xffffffffffffffff) goto LAB_0010a426;
          if (ppppcVar17 != (char ****)0x0) {
            __dest = apppcStack_120;
            ppppcVar25 = ppppcVar17;
            if (ppppcVar17 != (char ****)0x1) goto LAB_0010a1b4;
...
LAB_0010a426:
          ...
          if (ppppcVar10 < ppppcVar25) {
            ...
            _M_mutate((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                      &local_138,(ulong)ppppcVar23,0,pcVar5,(ulong)ppppcVar17);
            ppppcVar17 = ppppcVar25;
          }
          else {
LAB_0010a1b4:
            memcpy(__dest,pcVar5,(size_t)ppppcVar17);
            ppppcVar17 = ppppcVar25;
          }
        }
        *(undefined1 *)((long)local_130 + (long)ppppcVar17) = 0;
        ...
        if (ppppcVar17 == (char ****)0x7fffffffffffffff) goto LAB_0010a426;
        ppppcVar10 = (char ****)((long)ppppcVar17 + 1);
        ...
        if (ppppcVar14 < ppppcVar10) {
          std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
          _M_mutate((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                    &local_138,(ulong)ppppcVar17,0,"[",1);
        }
        else {
        ...
        if ((char ****)(0x7fffffffffffffff - (long)ppppcVar10) < local_f8) goto LAB_0010a426;
        ...
        if (ppppcVar14 < ppppcVar17) {
          std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
          _M_mutate((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                    &local_138,(ulong)ppppcVar10,0,(char *)local_100,(ulong)local_f8);
        }
        ...
        if ((char ****)local_130 == apppcStack_120) {
          ...
          if (uVar22 < 8) {
            if (((ulong)puVar2 & 4) == 0) {
              if (uVar22 != 0) {
                apppcStack_c0[0] =
                     (char ***)CONCAT71(apppcStack_c0[0]._1_7_,apppcStack_120[0]._0_1_);
                if (((ulong)puVar2 & 2) != 0) {
                  *(undefined2 *)((long)apppcStack_c0 + (uVar18 - 2)) =
                       *(undefined2 *)((long)apppcStack_120 + (uVar18 - 2));
                }
              }
            }
            else {
              apppcStack_c0[0] = (char ***)CONCAT44(apppcStack_c0[0]._4_4_,apppcStack_120[0]._0_4_);
              *(undefined4 *)((long)apppcStack_c0 + (uVar18 - 4)) =
                   *(undefined4 *)((long)apppcStack_120 + (uVar18 - 4));
            }
          }
          else {
            *(undefined8 *)((long)apppcStack_c0 + (((ulong)puVar2 & 0xffffffff) - 8)) =
                 *(undefined8 *)((long)apppcStack_120 + (((ulong)puVar2 & 0xffffffff) - 8));
            if (7 < uVar22 - 1) {
              uVar24 = 0;
              do {
                uVar18 = (ulong)uVar24;
                uVar24 = uVar24 + 8;
                *(undefined8 *)((long)apppcStack_c0 + uVar18) =
                     *(undefined8 *)((long)local_130 + uVar18);
          ...
          if (uVar22 < 8) {
            if (((ulong)puVar2 & 4) == 0) {
              if (uVar22 != 0) {
                ...
                if (((ulong)puVar2 & 2) != 0) {
                  *(undefined2 *)((long)local_90 + (((ulong)puVar2 & 0xffffffff) - 2)) =
                       *(undefined2 *)((long)apppcStack_c0 + (((ulong)puVar2 & 0xffffffff) - 2));
                }
              }
            }
            else {
              local_90[0] = (char ***)CONCAT44(local_90[0]._4_4_,apppcStack_c0[0]._0_4_);
              *(undefined4 *)((long)local_90 + (((ulong)puVar2 & 0xffffffff) - 4)) =
                   *(undefined4 *)((long)apppcStack_c0 + (((ulong)puVar2 & 0xffffffff) - 4));
            }
          }
          else {
            *(undefined8 *)((long)local_90 + (((ulong)puVar2 & 0xffffffff) - 8)) =
                 *(undefined8 *)((long)apppcStack_c0 + (((ulong)puVar2 & 0xffffffff) - 8));
            if (7 < uVar22 - 1) {
              uVar24 = 0;
              do {
  ...
  if (((*(byte *)(lVar4 + 8) & 8) == 0) || (((byte)pTVar15[8] & 0x7f) != 6)) {
    this_00 = (vector<glslang::TObjectReflection,std::allocator<glslang::TObjectReflection>> *)
              (lVar4 + 0x110);
  }
  else {
    this_00 = (vector<glslang::TObjectReflection,std::allocator<glslang::TObjectReflection>> *)
  ...
  pcVar5 = *(char **)(param_1 + 8);
  local_138 = &local_128;
  if (pcVar5 == (char *)0x0) goto LAB_0010aaab;
  ...
  if (ppppcVar10 < (char ****)0x10) {
    ...
    else if (ppppcVar10 != (char ****)0x0) goto LAB_00109fe7;
  }
  else {
    ...
    puVar19 = local_138;
LAB_00109fe7:
    memcpy(puVar19,pcVar5,(size_t)ppppcVar10);
    puVar19 = local_138;
  }
  *(undefined1 *)((long)puVar19 + (long)local_1d8[0]) = 0;
  ...
  lVar11 = std::
           _Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,int>,std::_Select1st<std::pair<std::__cxx11::string_const,int>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
           ::find((_Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,int>,std::_Select1st<std::pair<std::__cxx11::string_const,int>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
                   *)(local_1f0 + 0x68),(string *)&local_138);
  ...
  if (ppppcVar10 < (char ****)0x10) {
    ...
    else if (ppppcVar10 != (char ****)0x0) goto LAB_0010a581;
  }
  else {
...
LAB_0010a581:
    memcpy(ppppcVar17,pcVar5,(size_t)ppppcVar10);
    ppppcVar17 = (char ****)local_108;
  }
  *(undefined1 *)((long)ppppcVar17 + (long)local_1d8[0]) = 0;
  ...
  if (ppppcVar10 < (char ****)0x10) {
    ...
    else if (ppppcVar10 != (char ****)0x0) goto LAB_0010a9d8;
  }
  else {
...
LAB_0010aaab:
  ...
  if (ppppcVar10 < (char ****)0x10) {
    ...
    else if (ppppcVar10 != (char ****)0x0) goto LAB_0010a9a8;
  }
  else {
...
LAB_0010a9a8:
  ...
  *(undefined1 *)((long)puVar19 + (long)local_1d8[0]) = 0;
  ...
  TObjectReflection::TObjectReflection
            ((TObjectReflection *)&local_a8,(string *)&local_d8,param_2,-1,-1,param_3,iVar21);
  std::vector<glslang::TObjectReflection,std::allocator<glslang::TObjectReflection>>::
  emplace_back<glslang::TObjectReflection>(this_00,(TObjectReflection *)&local_a8);
  if (local_a8 != &local_98) {
    operator_delete(local_a8,(ulong)((long)local_98 + 1));
  }
...
/* glslang::TReflectionTraverser::blowUpActiveAggregate(glslang::TType const&,
   ...
   glslang::TStorageQualifier, bool) */

void __thiscall
glslang::TReflectionTraverser::blowUpActiveAggregate
          (TReflectionTraverser *this,TType *param_1,long param_2,long param_3,long *param_5,
          int param_6,int param_7,int param_8,int param_9,int param_10,uint param_11,char param_12)

{
  ...
  if (uVar19 < 0x10) {
    ...
    else if (uVar19 != 0) goto LAB_0010bfd0;
  }
  else {
    if ((long)uVar19 < 0) {
LAB_0010d5cc:
      ...
      if (iVar7 == 0xb7) {
        ...
        if (uVar28 != 0x10) {
          ...
          if ((bVar5 & 7) == 0) {
            ...
            if (pcVar16 == TType::getQualifier) goto LAB_0010b6cc;
LAB_0010c01b:
            pTVar24 = (TType *)(*pcVar16)(param_1);
          }
          else {
            bVar33 = (bVar5 & 7) == 1;
            if (pcVar16 != TType::getQualifier) goto LAB_0010c01b;
LAB_0010b6cc:
            pTVar24 = param_1 + 0x10;
          }
          glslang::TIntermediate::getMemberAlignment
                    (plVar14,local_4e8,local_448,(byte)pTVar24[0x10] & 0xf,bVar33);
          iVar7 = local_448[0];
        }
        iVar10 = iVar7;
        if (param_10 != 0) {
      ...
      if (iVar7 == 0xb8) {
        ...
        if (local_398 != 0) {
          puVar4 = local_310;
          if (local_398 == 0x7fffffffffffffff) goto LAB_0010d4f6;
          uVar27 = local_398 + 1;
          uVar13 = local_390[0];
        ...
        if (*(code **)(*plVar18 + 400) == TIntermBinary::getLeft) {
          ...
          if (pcVar16 != TIntermTyped::getType) goto LAB_0010c520;
LAB_0010bd48:
          plVar17 = plVar17 + 4;
        }
        else {
          plVar17 = (long *)(**(code **)(*plVar18 + 400))(plVar18);
          pcVar16 = *(code **)(*plVar17 + 0xf0);
          if (pcVar16 == TIntermTyped::getType) goto LAB_0010bd48;
LAB_0010c520:
        ...
        puVar4 = local_310;
        if (0x7fffffffffffffff - local_398 < uVar19) goto LAB_0010d4f6;
        ...
        if (uVar13 < uVar27) {
          std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
          _M_mutate((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                    &local_3a8,local_398,0,__src_00,uVar19);
        }
        else if (uVar19 != 0) {
          if (uVar19 == 1) {
        ...
        if (uVar28 != 0x10) {
          if (((uVar9 & 1) == 0) || (!bVar34)) {
            if (local_520 == 0) {
              ...
              if (uVar28 == 0x10) goto LAB_0010b04f;
            }
            ...
            std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
            _M_construct<char_const*>(&local_1f8,local_58,local_58 + sVar12);
            ...
            _M_construct<char_const*>
                      ((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                       &local_228,&_LC25);
            puVar4 = local_310;
            if (0x7fffffffffffffff - local_218 < local_1e8) goto LAB_0010d4f6;
            ...
            if (uVar27 < uVar19) {
              std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>
              ::_M_mutate((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *
                          )&local_228,local_218,0,local_1f0,local_1e8);
            }
            else if (local_1e8 != 0) {
              if (local_1e8 == 1) {
            ...
            *(char *)((long)local_220 + uVar19) = '\0';
            ...
            if (local_220 == (ulong *)&uStack_210) {
              ...
              if (uVar29 < 8) {
                if ((uVar27 & 4) == 0) {
                  if (uVar29 != 0) {
                    ...
                    if ((uVar27 & 2) != 0) {
                      *(undefined2 *)((long)auStack_1b0 + (uVar13 - 2)) =
                           *(undefined2 *)((long)&local_218 + uVar13 + 6);
                    }
                  }
                }
                else {
                  auStack_1b0[0] = CONCAT44(auStack_1b0[0]._4_4_,uStack_210);
                  *(undefined4 *)((long)auStack_1b0 + (uVar13 - 4)) =
                       *(undefined4 *)((long)&local_218 + uVar13 + 4);
                }
              }
              else {
                *(undefined8 *)((long)auStack_1b0 + ((uVar27 & 0xffffffff) - 8)) =
                     *(undefined8 *)((long)&local_218 + (uVar27 & 0xffffffff));
                if (7 < uVar29 - 1) {
                  uVar25 = 0;
                  do {
                    uVar27 = (ulong)uVar25;
                    uVar25 = uVar25 + 8;
                    *(undefined8 *)((long)auStack_1b0 + uVar27) =
                         *(undefined8 *)((long)local_220 + uVar27);
              ...
              puVar4 = local_310;
              if (uVar19 == 0x7fffffffffffffff) goto LAB_0010d4f6;
            ...
            *(char *)((long)local_1c0 + uVar13) = '\0';
              ...
              if (uVar28 < 8) {
                if ((uVar19 & 4) == 0) {
                  if (uVar28 != 0) {
                    ...
                    if ((uVar19 & 2) != 0) {
                      *(undefined2 *)((long)local_180 + ((uVar19 & 0xffffffff) - 2)) =
                           *(undefined2 *)((long)auStack_1b0 + ((uVar19 & 0xffffffff) - 2));
                    }
                  }
                }
                else {
                  local_180[0] = CONCAT44(local_180[0]._4_4_,(undefined4)auStack_1b0[0]);
                  *(undefined4 *)((long)local_180 + ((uVar19 & 0xffffffff) - 4)) =
                       *(undefined4 *)((long)auStack_1b0 + ((uVar19 & 0xffffffff) - 4));
                }
              }
              else {
                *(undefined8 *)((long)local_180 + ((uVar19 & 0xffffffff) - 8)) =
                     *(undefined8 *)((long)auStack_1b0 + ((uVar19 & 0xffffffff) - 8));
                if (7 < uVar28 - 1) {
                  uVar29 = 0;
                  do {
                    uVar19 = (ulong)uVar29;
                    uVar29 = uVar29 + 8;
                    *(undefined8 *)((long)local_190 + uVar19) =
                         *(undefined8 *)((long)local_1c0 + uVar19);
            ...
            local_1b8 = 0;
            puVar4 = local_310;
            if (0x7fffffffffffffff - local_398 < uVar13) goto LAB_0010d4f6;
            ...
            if (uVar27 < uVar19) {
              std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>
              ::_M_mutate((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *
                          )&local_3a8,local_398,0,(char *)local_190,uVar13);
            }
            else if (uVar13 != 0) {
              if (uVar13 == 1) {
            ...
            *(undefined1 *)((long)local_3a0 + uVar19) = 0;
            ...
            local_250 = local_240;
            std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
            _M_construct<char_const*>(local_270 + 3,&_LC27);
            puVar4 = local_310;
            if (0x7fffffffffffffff - local_398 < local_248) goto LAB_0010d4f6;
            ...
            if (uVar27 < uVar19) {
              std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>
              ::_M_mutate((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *
                          )&local_3a8,local_398,0,local_250,local_248);
            }
            else if (local_248 != 0) {
              if (local_248 == 1) {
...
LAB_0010b04f:
        iVar10 = param_10;
        if ((param_10 != 0) || (iVar10 = iVar7, iVar7 != 0)) {
          param_10 = iVar10;
          if (*(code **)(*plVar18 + 400) == TIntermBinary::getLeft) {
            plVar18 = (long *)plVar18[0x18];
          }
...
LAB_0010b0f9:
      if ((uVar28 == 0xf) ||
         (((lVar11 = *(long *)(pTVar15 + 0x60), lVar11 != 0 &&
           (lVar32 = *(long *)(lVar11 + 8), lVar32 != 0)) &&
          (1 < (int)(*(long *)(lVar32 + 0x10) - *(long *)(lVar32 + 8) >> 4))))) goto LAB_0010b12d;
...
LAB_0010c813:
      ...
      if (param_8 == 0) {
        ...
        if (*(code **)(lVar11 + 0xe8) == TType::isArray) {
          if (*(long *)(pTVar15 + 0x60) != 0) {
LAB_0010d125:
            if (*(code **)(lVar11 + 0x78) == TType::getOuterArraySize) {
...
LAB_0010c3ea:
      lVar11 = *(long *)(this + 0x40);
      if (((*(byte *)(lVar11 + 8) & 8) == 0) ||
         (this_00 = (vector<glslang::TObjectReflection,std::allocator<glslang::TObjectReflection>> *
                    )(lVar11 + 0x128), param_11 != 6)) {
        this_00 = (vector<glslang::TObjectReflection,std::allocator<glslang::TObjectReflection>> *)
                  (lVar11 + 0xf8);
      }
      std::__cxx11::string::string<std::allocator<char>>
                ((string *)&local_a8,(char *)local_3a0,(allocator *)local_448);
      lVar11 = std::
               _Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,int>,std::_Select1st<std::pair<std::__cxx11::string_const,int>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
               ::find((_Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,int>,std::_Select1st<std::pair<std::__cxx11::string_const,int>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
                       *)(lVar11 + 0x68),(string *)&local_a8);
      ...
      local_448[0] = iVar7;
      std::__cxx11::string::string<std::allocator<char>>
                ((string *)&local_a8,(char *)local_3a0,(allocator *)local_4e8);
      piVar21 = (int *)std::
                       map<std::__cxx11::string,int,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
                       ::operator[]((map<std::__cxx11::string,int,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
                                     *)(lVar32 + 0x68),(string *)&local_a8);
      *piVar21 = iVar7;
      std::__cxx11::string::_M_dispose();
      iVar10 = mapToGlType(pTVar15);
      std::__cxx11::string::string<std::allocator<char>>
                ((string *)&local_d8,(char *)local_3a0,(allocator *)local_4e8);
      TObjectReflection::TObjectReflection
                ((TObjectReflection *)&local_a8,(string *)&local_d8,pTVar15,param_6,iVar10,param_8,
                 param_7);
      std::vector<glslang::TObjectReflection,std::allocator<glslang::TObjectReflection>>::
      emplace_back<glslang::TObjectReflection>(this_00,(TObjectReflection *)&local_a8);
      std::__cxx11::string::_M_dispose();
      std::__cxx11::string::_M_dispose();
      if (*(code **)(*(long *)pTVar15 + 0xe8) == TType::isArray) {
        if (*(long *)(pTVar15 + 0x60) == 0) goto LAB_0010d0b3;
LAB_0010d4ba:
        iVar10 = getArrayStride(param_1,pTVar15);
        *(int *)(*(long *)(this_00 + 8) + -0x18) = iVar10;
        if (param_10 != 0) goto LAB_0010d0b3;
      }
      else {
        cVar6 = (**(code **)(*(long *)pTVar15 + 0xe8))(pTVar15);
        if (cVar6 != '\0') goto LAB_0010d4ba;
LAB_0010d0b3:
        iVar10 = param_10;
      }
      lVar11 = *(long *)(this + 0x40);
      ...
      if (((uVar9 & 8) != 0) && (pTVar15[8] == (TType)0xd)) {
        ...
        if (piVar21 == *(int **)(lVar11 + 0x198)) {
          std::vector<int,std::allocator<int>>::_M_realloc_insert<int_const&>
                    ((vector<int,std::allocator<int>> *)(lVar11 + 0x188),piVar21,
                     (allocator *)local_448);
          uVar9 = *(uint *)(*(long *)(this + 0x40) + 8);
        }
        else {
      ...
      *(int *)(lVar11 + -0x10) = iVar10;
      if (((uVar9 & 0x10) != 0) && (param_12 != '\0')) {
        *(uint *)(lVar11 + -0xc) =
             *(uint *)(lVar11 + -0xc) | 1 << ((byte)**(undefined4 **)(this + 0x38) & 0x1f);
      }
      goto LAB_0010b5d0;
    }
  }
      ...
      if (0 < iVar7) {
        ...
        do {
          ...
          if (local_398 < 0x10) {
            ...
            else if (local_398 != 0) goto LAB_0010ce62;
          }
          else {
            if ((long)local_398 < 0) goto LAB_0010d5cc;
            local_a0 = (ulong *)glslang::TPoolAllocator::allocate((ulong)local_a8);
            local_90[0] = uVar19;
LAB_0010ce62:
            memcpy(local_a0,puVar4,uVar19);
          }
          local_98 = uVar19;
          *(char *)((long)local_a0 + uVar19) = '\0';
          ...
          std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
          append((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                 &local_a8,*(char **)(lVar20 + 8),*(ulong *)(lVar20 + 0x10));
...
LAB_0010cd44:
            blowUpActiveAggregate
                      (this,(TType *)local_4e8,
                       (basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                       &local_a8,param_3,plVar14,iVar31,param_7,0,iVar8,iVar10,uVar28,cVar6);
          }
          else {
LAB_0010ccc7:
            iVar8 = param_9;
            if (((uVar9 & 1) == 0) || (!bVar34)) goto LAB_0010cd44;
            if (local_488 == 0) {
              if (*(code **)(*(long *)pTVar15 + 0x58) == TType::getQualifier) {
                pTVar24 = pTVar15 + 0x10;
              }
            ...
            if (local_488 == 0) {
LAB_0010d17d:
              local_4fc = **(undefined4 **)(lVar20 + 8);
            }
            else {
              local_4fc = 0;
              lVar20 = *(long *)(local_488 + 8);
              if (**(int **)(*(long *)(local_488 + 8) + 8) != 0) goto LAB_0010d17d;
            }
            if (*(code **)(*(long *)pTVar15 + 0x58) == TType::getQualifier) {
              pTVar24 = pTVar15 + 0x10;
            }
            ...
            blowUpActiveAggregate
                      (this,(TType *)local_448,
                       (basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                       &local_a8,param_3,plVar14,uVar3,param_7,0,local_4fc,iVar10,(byte)TVar2 & 0x7f
                       ,0);
          }
          lVar32 = lVar32 + 1;
  ...
  if (((uVar9 & 1) == 0) || (iVar10 = 1, !bVar34)) {
    iVar10 = 1;
    if (0 < iVar7) {
      iVar10 = iVar7;
    }
    if ((param_9 != iVar10) || (param_10 != 0)) goto LAB_0010b1a8;
    iVar10 = 1;
    param_10 = local_548;
    iVar7 = param_10;
  }
...
LAB_0010b1a8:
  ...
  do {
    ...
    if (local_398 < 0x10) {
      ...
      else if (local_398 != 0) goto LAB_0010c972;
    }
    else {
      if ((long)local_398 < 0) goto LAB_0010d5cc;
      ...
      local_150[0] = uVar19;
LAB_0010c972:
      memcpy(local_160,puVar4,uVar19);
    }
    local_158 = uVar19;
    *(undefined1 *)((long)local_160 + uVar19) = 0;
    ...
    if (uVar9 != 0x10) {
      ...
      sVar12 = strlen(local_58);
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
      _M_construct<char_const*>(&local_108,local_58,local_58 + sVar12);
      local_138 = (undefined8 *)glslang::GetThreadPoolAllocator();
...
LAB_0010d4f6:
      ...
      if (uVar27 < uVar19) {
        std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
        _M_mutate((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                  &local_138,local_128,0,local_100,local_f8);
      }
      else if (local_f8 != 0) {
        if (local_f8 == 1) {
        ...
        if (uVar28 < 8) {
          if ((uVar27 & 4) == 0) {
            if (uVar28 != 0) {
              ...
              if ((uVar27 & 2) != 0) {
                *(undefined2 *)((long)auStack_c0 + (uVar13 - 2)) =
                     *(undefined2 *)((long)&local_128 + uVar13 + 6);
              }
            }
          }
          else {
            auStack_c0[0] = CONCAT44(auStack_c0[0]._4_4_,uStack_120);
            *(undefined4 *)((long)auStack_c0 + (uVar13 - 4)) =
                 *(undefined4 *)((long)&local_128 + uVar13 + 4);
          }
        }
        else {
          *(undefined8 *)((long)auStack_c0 + ((uVar27 & 0xffffffff) - 8)) =
               *(undefined8 *)((long)&local_128 + (uVar27 & 0xffffffff));
          if (7 < uVar28 - 1) {
            uVar29 = 0;
            do {
              uVar27 = (ulong)uVar29;
      ...
      *(char *)((long)local_d0 + uVar13) = '\0';
        ...
        if (uVar9 < 8) {
          if ((uVar19 & 4) == 0) {
            if (uVar9 != 0) {
              ...
              if ((uVar19 & 2) != 0) {
                *(undefined2 *)((long)local_90 + ((uVar19 & 0xffffffff) - 2)) =
                     *(undefined2 *)((long)auStack_c0 + ((uVar19 & 0xffffffff) - 2));
              }
            }
          }
          else {
            local_90[0] = CONCAT44(local_90[0]._4_4_,(undefined4)auStack_c0[0]);
            *(undefined4 *)((long)local_90 + ((uVar19 & 0xffffffff) - 4)) =
                 *(undefined4 *)((long)auStack_c0 + ((uVar19 & 0xffffffff) - 4));
          }
        }
        else {
          *(undefined8 *)((long)local_90 + ((uVar19 & 0xffffffff) - 8)) =
               *(undefined8 *)((long)auStack_c0 + ((uVar19 & 0xffffffff) - 8));
          if (7 < uVar9 - 1) {
            uVar28 = 0;
            do {
              uVar19 = (ulong)uVar28;
      ...
      local_c8 = 0;
      puVar4 = local_310;
      if (0x7fffffffffffffff - local_158 < uVar13) goto LAB_0010d4f6;
      ...
      if (uVar27 < uVar19) {
        std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
        _M_mutate((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                  &local_168,local_158,0,(char *)local_a0,uVar13);
      }
      else if (uVar13 != 0) {
        if (uVar13 == 1) {
    ...
    iVar31 = iVar31 + 1;
    blowUpActiveAggregate
              (this,(TType *)local_448,local_550,param_3,plVar14,param_6,param_7,0,param_9,param_10,
               param_11,param_12);
...
LAB_0010b724:
  ...
  if (iVar8 <= iVar31) goto LAB_0010b5d0;
  ...
  if (local_398 < 0x10) {
    ...
    else if (local_398 != 0) goto LAB_0010bc52;
  }
  else {
    if ((long)local_398 < 0) goto LAB_0010d5cc;
    ...
    local_360[0] = uVar19;
LAB_0010bc52:
    memcpy(local_370,puVar4,uVar19);
  }
  local_368 = uVar19;
  ...
  if (uVar28 != 0x10) {
    if (((uVar9 & 1) == 0) || (!bVar34)) {
      if (local_520 == 0) {
        ...
        if (uVar28 == 0x10) goto LAB_0010b8ea;
      }
      __snprintf_chk(local_58,0x10,2,0x10,&_LC24,iVar31);
      ...
      sVar12 = strlen(local_58);
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
      _M_construct<char_const*>(&local_2e8,local_58,local_58 + sVar12);
      ...
      _M_construct<char_const*>
                ((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                 &local_318,&_LC25);
      puVar4 = local_310;
      if (0x7fffffffffffffff - local_308 < local_2d8) goto LAB_0010d4f6;
      ...
      if (uVar27 < uVar19) {
        std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
        _M_mutate((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                  &local_318,local_308,0,local_2e0,local_2d8);
      }
      else if (local_2d8 != 0) {
        if (local_2d8 == 1) {
        ...
        if (uVar29 < 8) {
          if ((uVar27 & 4) == 0) {
            if (uVar29 != 0) {
              ...
              if ((uVar27 & 2) != 0) {
                *(undefined2 *)((long)auStack_2a0 + (uVar13 - 2)) =
                     *(undefined2 *)((long)&local_308 + uVar13 + 6);
              }
            }
          }
          else {
            auStack_2a0[0] = CONCAT44(auStack_2a0[0]._4_4_,uStack_300);
            *(undefined4 *)((long)auStack_2a0 + (uVar13 - 4)) =
                 *(undefined4 *)((long)&local_308 + uVar13 + 4);
          }
        }
        else {
          *(undefined8 *)((long)auStack_2a0 + ((uVar27 & 0xffffffff) - 8)) =
               *(undefined8 *)((long)&local_308 + (uVar27 & 0xffffffff));
          if (7 < uVar29 - 1) {
            uVar25 = 0;
            do {
              uVar27 = (ulong)uVar25;
              uVar25 = uVar25 + 8;
              *(undefined8 *)((long)auStack_2a0 + uVar27) =
                   *(undefined8 *)((long)local_310 + uVar27);
            } while (uVar25 < (uVar29 - 1 & 0xfffffff8));
          }
        }
        uVar27 = 0xf;
      ...
      *(char *)((long)local_2b0 + uVar13) = '\0';
        ...
        if (uVar28 < 8) {
          if ((uVar19 & 4) == 0) {
            if (uVar28 != 0) {
              ...
              if ((uVar19 & 2) != 0) {
                *(undefined2 *)((long)local_270 + ((uVar19 & 0xffffffff) - 2)) =
                     *(undefined2 *)((long)auStack_2a0 + ((uVar19 & 0xffffffff) - 2));
              }
            }
          }
          else {
            local_270[0] = CONCAT44(local_270[0]._4_4_,(undefined4)auStack_2a0[0]);
            *(undefined4 *)((long)local_270 + ((uVar19 & 0xffffffff) - 4)) =
                 *(undefined4 *)((long)auStack_2a0 + ((uVar19 & 0xffffffff) - 4));
          }
        }
        else {
          *(undefined8 *)((long)local_270 + ((uVar19 & 0xffffffff) - 8)) =
               *(undefined8 *)((long)auStack_2a0 + ((uVar19 & 0xffffffff) - 8));
          if (7 < uVar28 - 1) {
            uVar29 = 0;
            do {
              uVar19 = (ulong)uVar29;
      ...
      local_340 = local_330;
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
      _M_construct<char_const*>(&local_348,&_LC27);
      puVar26 = local_340;
      uVar13 = local_338;
    }
    puVar4 = local_310;
    if (0x7fffffffffffffff - local_368 < uVar13) goto LAB_0010d4f6;
    ...
    if (uVar27 < uVar19) {
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
      _M_mutate((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                &local_378,local_368,0,(char *)puVar26,uVar13);
    }
    else if (uVar13 != 0) {
      if (uVar13 == 1) {
...
LAB_0010b8ea:
  blowUpActiveAggregate
            (this,pTVar15,&local_378,param_3,*param_5,param_6,param_7,param_8,param_9,iVar10,
             param_11,param_12);
  iVar8 = iVar7 + param_6;
  if (param_6 < 0) {
    iVar8 = param_6;
...
/* glslang::TReflectionTraverser::addDereferencedUniform(glslang::TIntermBinary*) */

void __thiscall
glslang::TReflectionTraverser::addDereferencedUniform
          (TReflectionTraverser *this,TIntermBinary *param_1)
...
LAB_0010d6f6:
    if (*(code **)(lVar13 + 0xe8) == TType::isArray) {
      if (plVar8[0xc] == 0) goto LAB_0010dcd0;
    }
    else {
      cVar5 = (**(code **)(lVar13 + 0xe8))(plVar8);
      if (cVar5 == '\0') goto LAB_0010dcd0;
    }
  }
  else {
    ...
    lVar13 = *plVar8;
LAB_0010dd1b:
    if (bVar4 != 0) goto LAB_0010d6f6;
    if (*(code **)(lVar13 + 0xe0) == TType::isMatrix) {
      if (0xf < *(byte *)((long)plVar8 + 9)) goto LAB_0010d6f6;
    }
    else {
  ...
  do {
    ...
    if (plVar8 != (long *)0x0) {
      ...
      if ((*(byte *)(plVar14 + 1) & 0x7f) - 5 < 2) {
        ...
        p_Var19 = p_Var1;
        if (*(_Rb_tree_node_base **)(this + 0x58) != (_Rb_tree_node_base *)0x0) goto LAB_0010d7d8;
        goto LAB_0010d801;
      }
      break;
    }
  ...
  goto LAB_0010dcd0;
  while (p_Var11 = *(_Rb_tree_node_base **)(p_Var9 + 0x18),
        *(_Rb_tree_node_base **)(p_Var9 + 0x18) != (_Rb_tree_node_base *)0x0) {
LAB_0010d7d8:
    p_Var9 = p_Var11;
  ...
  if ((p_Var1 != p_Var19) && (*(TIntermBinary **)(p_Var19 + 0x20) <= param_1)) goto LAB_0010dcd0;
LAB_0010d801:
  ...
  if (local_b0 == 0x10) {
    ...
    if (iVar6 != 0) {
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
      _M_assign((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)&local_68
                ,pbVar17);
    }
    ...
    if ((*(byte *)(*(long *)(this + 0x40) + 8) & 0x10) != 0) {
      ...
      blowUpActiveAggregate
                (this,plVar14,local_c0,&local_88,&local_80,0,local_ac,0,0xffffffffffffffff,0,
                 bVar4 & 0x7f,0);
    }
    local_94 = 0;
  }
  ...
  do {
    ...
    if (*(code **)(*plVar14 + 0x38) == TType::getBasicType) {
      ...
      if (*(byte *)(plVar14 + 1) == 0x10) goto LAB_0010da46;
LAB_0010da12:
      if ((uVar7 == 0xf) ||
         (((plVar14[0xc] != 0 && (lVar13 = *(long *)(plVar14[0xc] + 8), lVar13 != 0)) &&
          (1 < (int)(*(long *)(lVar13 + 0x10) - *(long *)(lVar13 + 8) >> 4))))) goto LAB_0010da46;
    }
    else {
...
LAB_0010da46:
      p_Var10 = (_List_node_base *)glslang::TPoolAllocator::allocate(local_88);
...
LAB_0010daa5:
          if (pTVar12 <= pTVar18) goto LAB_0010dadf;
          goto LAB_0010daaa;
        }
        bVar20 = true;
      }
        ...
        if (pTVar12 >= pTVar18) goto LAB_0010daa5;
        if (*(_Rb_tree_node_base **)(this + 0x60) != p_Var19) goto LAB_0010df3a;
LAB_0010daaa:
        bVar20 = true;
        if (p_Var1 != p_Var19) {
...
LAB_0010dadf:
  ...
  if (*(_Rb_tree_node_base **)(this + 0x58) == (_Rb_tree_node_base *)0x0) {
LAB_0010df6b:
    if (p_Var19 != *(_Rb_tree_node_base **)(this + 0x60)) {
      lVar13 = std::_Rb_tree_decrement(p_Var19);
...
LAB_0010db52:
    ...
    *(long *)(this + 0x70) = *(long *)(this + 0x70) + 1;
    ...
    if (plVar8 < plVar14) goto LAB_0010df6b;
LAB_0010db4d:
    if (plVar14 < plVar8) goto LAB_0010db52;
  }
  if (*(code **)(*(long *)param_1 + 400) == TIntermBinary::getLeft) {
  ...
  if (*(code **)(*plVar14 + 0x38) == TType::getBasicType) {
    uVar7 = (uint)*(byte *)(plVar14 + 1);
    if (*(byte *)(plVar14 + 1) == 0x10) goto LAB_0010dbf3;
LAB_0010de01:
    if ((uVar7 == 0xf) ||
       (((plVar14[0xc] != 0 && (lVar13 = *(long *)(plVar14[0xc] + 8), lVar13 != 0)) &&
        (1 < (int)(*(long *)(lVar13 + 0x10) - *(long *)(lVar13 + 8) >> 4))))) goto LAB_0010dbf3;
    if (*(code **)(*(long *)param_1 + 400) == TIntermBinary::getLeft) {
      plVar14 = *(long **)(param_1 + 0xc0);
    }
    else {
    ...
    if (*(code **)(*plVar14 + 0x150) != TIntermTyped::isArray) {
      ...
      if (cVar5 != '\0') goto LAB_0010de73;
      goto LAB_0010dbf3;
    }
    if (plVar14[0x10] == 0) goto LAB_0010dbf3;
LAB_0010de73:
    if (*(int *)(param_1 + 0xb8) != 0xb6) goto LAB_0010dbf3;
...
LAB_0010dbf3:
  ...
  if (!bVar21) {
    if (local_b0 == 0x10) {
      ...
      if (pcVar16 != TType::getTypeName_abi_cxx11_) goto LAB_0010e1fb;
      pbVar17 = (basic_string *)plVar14[0xf];
    }
    else {
...
LAB_0010e1fb:
        pbVar17 = (basic_string *)(*pcVar16)(plVar14);
      }
    }
    std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_assign
              (local_c0,pbVar17);
  ...
  blowUpActiveAggregate
            (this,plVar8,local_c0,local_a8,pppppuVar3,local_94,local_ac,iVar6,0xffffffffffffffff,0,
             bVar4 & 0x7f,1);
LAB_0010dcd0:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
...
/* glslang::TReflectionTraverser::addUniform(glslang::TIntermSymbol const&) */

void __thiscall
glslang::TReflectionTraverser::addUniform(TReflectionTraverser *this,TIntermSymbol *param_1)
...
LAB_0010e4d3:
    if (p_Var14 != *(_Rb_tree_node_base **)(this + 0x60)) {
    ...
    *(long *)(this + 0x70) = *(long *)(this + 0x70) + 1;
    ...
    do {
      while( true ) {
        ...
        p_Var14 = p_Var8;
        if (*(_Rb_tree_node_base **)(p_Var8 + 0x10) == (_Rb_tree_node_base *)0x0) goto LAB_0010e2f9;
      }
      p_Var4 = *(_Rb_tree_node_base **)(p_Var8 + 0x18);
    } while (*(_Rb_tree_node_base **)(p_Var8 + 0x18) != (_Rb_tree_node_base *)0x0);
LAB_0010e2f9:
    if ((p_Var1 != p_Var14) && (*(TIntermSymbol **)(p_Var14 + 0x20) <= param_1)) goto LAB_0010e304;
    do {
      p_Var14 = p_Var9;
    ...
    if (param_1 < pTVar11) goto LAB_0010e4d3;
LAB_0010e353:
    if (pTVar11 < param_1) goto LAB_0010e358;
  }
  local_88 = glslang::GetThreadPoolAllocator();
  local_70 = 0;
  local_80 = &local_80;
  ...
  if (__n < 0x10) {
    ...
    else if (__n != 0) goto LAB_0010e522;
  }
  else {
    if ((long)__n < 0) {
                    /* WARNING: Subroutine does not return */
...
LAB_0010e522:
  ...
  *(undefined1 *)((long)local_60 + __n) = 0;
  ...
  if (uVar7 == 0x10) {
    ...
    if (iVar5 == 0) {
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
      _M_replace((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
  ...
  blowUpActiveAggregate
            (this,pTVar11,&local_68,&local_88,&local_80,uVar15,uVar6,0,0xffffffffffffffff,0,
             (byte)TVar3 & 0x7f,TVar2);
LAB_0010e304:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
...
void __thiscall
glslang::TReflectionTraverser::blowUpIOAggregate
          (TReflectionTraverser *this,bool param_1,basic_string *param_2,TType *param_3)

{
  ...
  *this_00;
  ...
  if (ppppuVar14 < (undefined8 ****)0x10) {
    ...
    else if (ppppuVar14 != (undefined8 ****)0x0) goto LAB_0010eff0;
  }
  else {
...
LAB_0010eff0:
    memcpy(local_1f0,puVar23,(size_t)ppppuVar14);
  }
...
LAB_0010e7ad:
      if ((uVar8 == 0xf) ||
         (((lVar15 = *(long *)(param_3 + 0x60), lVar15 != 0 &&
           (lVar12 = *(long *)(lVar15 + 8), lVar12 != 0)) &&
          (1 < (int)(*(long *)(lVar12 + 0x10) - *(long *)(lVar12 + 8) >> 4))))) goto LAB_0010e7e1;
      lVar12 = *(long *)(this + 0x40);
      if ((*(byte *)(lVar12 + 8) & 2) != 0) {
        if (*(code **)(*(long *)param_3 + 0xe8) == TType::isArray) {
          if (lVar15 == 0) goto LAB_0010eeb7;
LAB_0010edf5:
          local_a8 = (ulong *)glslang::GetThreadPoolAllocator();
          local_a0 = local_90;
          std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
          _M_construct<char_const*>(&local_a8,&_LC27);
          puVar5 = local_190;
          if (0x7fffffffffffffffU - (long)local_1e8 < local_98) goto LAB_0010f73d;
          ...
          if (ppppuVar10 < ppppuVar14) {
            std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
            _M_mutate((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                      &local_1f8,(ulong)local_1e8,0,local_a0,local_98);
          }
          else if (local_98 != 0) {
            if (local_98 == 1) {
          ...
          *(undefined1 *)((long)local_1f0 + (long)ppppuVar14) = 0;
          ...
          if (cVar6 != '\0') goto LAB_0010edf5;
        }
        lVar12 = *(long *)(this + 0x40);
      }
LAB_0010eeb7:
      if (param_1) {
        this_01 = (vector<glslang::TObjectReflection,std::allocator<glslang::TObjectReflection>> *)
                  (lVar12 + 0x158);
        local_210 = 3;
        puVar23 = &_LC31;
      }
      ...
      if (lVar12 == lVar15 + 0x70) {
        ...
        *piVar13 = (int)(lVar15 - lVar12 >> 4) * -0x33333333;
        ...
        if (*(code **)(lVar15 + 0xe8) == TType::isArray) {
          if (*(long *)(param_3 + 0x60) != 0) goto LAB_0010f620;
LAB_0010f42c:
          local_2d8 = 1;
        }
        else {
          cVar6 = (**(code **)(lVar15 + 0xe8))(param_3);
          if (cVar6 == '\0') goto LAB_0010f42c;
          lVar15 = *(long *)param_3;
LAB_0010f620:
          if (*(code **)(lVar15 + 0x78) == TType::getOuterArraySize) {
        ...
        if (ppppuVar14 < (undefined8 ****)0x10) {
          ...
          else if (ppppuVar14 != (undefined8 ****)0x0) goto LAB_0010f660;
        }
        else {
          local_d8 = (undefined8 ***)
                     std::__cxx11::string::_M_create((ulong *)&local_d8,(ulong)local_2b8);
          local_c8 = local_2b8[0];
          ppppuVar10 = (undefined8 ****)local_d8;
LAB_0010f660:
          memcpy(ppppuVar10,pppuVar3,(size_t)ppppuVar14);
          ppppuVar10 = (undefined8 ****)local_d8;
        }
        *(undefined1 *)((long)ppppuVar10 + (long)local_2b8[0]) = 0;
        local_d0 = local_2b8[0];
        TObjectReflection::TObjectReflection
                  ((TObjectReflection *)&local_a8,(string *)&local_d8,param_3,0,iVar20,local_2d8,0);
        std::vector<glslang::TObjectReflection,std::allocator<glslang::TObjectReflection>>::
        emplace_back<glslang::TObjectReflection>(this_01,(TObjectReflection *)&local_a8);
        if (local_a8 != &local_98) {
          operator_delete(local_a8,local_98 + 1);
        }
        ...
        *(uint *)(*(long *)(this_01 + 8) + -0xc) =
             *(uint *)(*(long *)(this_01 + 8) + -0xc) |
             1 << ((byte)**(undefined4 **)(this + 0x38) & 0x1f);
      }
      else {
      ...
      if (0 < (int)(*(long *)(lVar15 + 0x10) - *(long *)(lVar15 + 8) >> 5)) {
        ...
        do {
          ...
          if (local_1e8 < (undefined8 ****)0x10) {
            ...
            else if ((undefined8 ****)local_1e8 != (undefined8 ****)0x0) goto LAB_0010f1d3;
          }
          else {
            if ((long)local_1e8 < 0) goto LAB_0010f74e;
            local_d0 = (undefined8 ***)glslang::TPoolAllocator::allocate((ulong)local_d8);
            local_c0[0] = pppuVar4;
LAB_0010f1d3:
            memcpy(local_d0,pppuVar3,(size_t)pppuVar4);
          }
          local_c8 = pppuVar4;
          *(undefined1 *)((long)local_d0 + (long)pppuVar4) = 0;
          if ((undefined8 ****)pppuVar4 != (undefined8 ****)0x0) {
            puVar5 = local_190;
            if ((undefined8 ****)pppuVar4 == (undefined8 ****)0x7fffffffffffffff) goto LAB_0010f73d;
          ...
          __src = *(char **)(lVar21 + 8);
          puVar5 = local_190;
          if (0x7fffffffffffffffU - (long)local_c8 < uVar19) goto LAB_0010f73d;
          ...
          if (ppppuVar10 < ppppuVar14) {
            std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
            _M_mutate((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                      &local_d8,(ulong)local_c8,0,__src,uVar19);
          }
          else if (uVar19 != 0) {
            if (uVar19 == 1) {
    ...
    cVar6 = (**(code **)(lVar15 + 0xe8))(param_3);
    if (cVar6 == '\0') goto LAB_0010ec25;
    lVar15 = *(long *)param_3;
  }
  pcVar11 = *(code **)(lVar15 + 0x78);
  iVar20 = 0;
  if (pcVar11 != TType::getOuterArraySize) goto LAB_0010ebaf;
LAB_0010e826:
  ...
  if (iVar20 < iVar7) {
    do {
      ...
      if (local_1e8 < (undefined8 ****)0x10) {
        ...
        else if ((undefined8 ****)local_1e8 != (undefined8 ****)0x0) goto LAB_0010f048;
      }
      else {
        if ((long)local_1e8 < 0) goto LAB_0010f74e;
...
LAB_0010f048:
        memcpy(local_1c0,pppuVar3,(size_t)pppuVar4);
      }
      local_1b8 = pppuVar4;
      *(undefined1 *)((long)local_1c0 + (long)pppuVar4) = 0;
      ...
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
      _M_construct<char_const*>(&local_168,local_58,local_58 + sVar9);
      ...
      _M_construct<char_const*>
                ((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                 &local_198,&_LC25);
      puVar5 = local_190;
      if (0x7fffffffffffffff - local_188 < local_158) goto LAB_0010f73d;
      ...
      if (uVar18 < uVar19) {
        std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
        _M_mutate((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                  &local_198,local_188,0,local_160,local_158);
      }
      else if (local_158 != 0) {
        if (local_158 == 1) {
      ...
      *(char *)((long)local_190 + uVar19) = '\0';
      ...
      if (local_190 == (ulong *)&uStack_180) {
        ...
        if (uVar22 < 8) {
          if ((uVar18 & 4) == 0) {
            if (uVar22 != 0) {
              ...
              if ((uVar18 & 2) != 0) {
                *(undefined2 *)((long)auStack_120 + (uVar17 - 2)) =
                     *(undefined2 *)((long)&local_188 + uVar17 + 6);
              }
            }
          }
          else {
            auStack_120[0] = CONCAT44(auStack_120[0]._4_4_,uStack_180);
            *(undefined4 *)((long)auStack_120 + (uVar17 - 4)) =
                 *(undefined4 *)((long)&local_188 + uVar17 + 4);
          }
        }
        else {
          *(undefined8 *)((long)auStack_120 + ((uVar18 & 0xffffffff) - 8)) =
               *(undefined8 *)((long)&local_188 + (uVar18 & 0xffffffff));
          if (7 < uVar22 - 1) {
            uVar16 = 0;
            do {
              uVar18 = (ulong)uVar16;
              uVar16 = uVar16 + 8;
              *(undefined8 *)((long)auStack_120 + uVar18) =
                   *(undefined8 *)((long)local_190 + uVar18);
        ...
        if (uVar19 == 0x7fffffffffffffff) goto LAB_0010f73d;
      ...
      *(char *)((long)local_130 + uVar17) = '\0';
        ...
        if (uVar8 < 8) {
          if ((uVar19 & 4) == 0) {
            if (uVar8 != 0) {
              ...
              if ((uVar19 & 2) != 0) {
                *(undefined2 *)((long)local_f0 + ((uVar19 & 0xffffffff) - 2)) =
                     *(undefined2 *)((long)auStack_120 + ((uVar19 & 0xffffffff) - 2));
              }
            }
          }
          else {
            local_f0[0] = CONCAT44(local_f0[0]._4_4_,(undefined4)auStack_120[0]);
            *(undefined4 *)((long)local_f0 + ((uVar19 & 0xffffffff) - 4)) =
                 *(undefined4 *)((long)auStack_120 + ((uVar19 & 0xffffffff) - 4));
          }
        }
        else {
          *(undefined8 *)((long)local_f0 + ((uVar19 & 0xffffffff) - 8)) =
               *(undefined8 *)((long)auStack_120 + ((uVar19 & 0xffffffff) - 8));
          if (7 < uVar8 - 1) {
            uVar22 = 0;
            do {
              uVar19 = (ulong)uVar22;
      ...
      puVar5 = local_190;
      local_130 = auStack_120;
      if (0x7fffffffffffffffU - (long)local_1b8 < uVar17) goto LAB_0010f73d;
      ...
      if (ppppuVar10 < ppppuVar14) {
        std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
        _M_mutate((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                  &local_1c8,(ulong)local_1b8,0,(char *)local_100,uVar17);
      }
      else if (uVar17 != 0) {
        if (uVar17 == 1) {
      ...
      *(undefined1 *)((long)local_1c0 + (long)ppppuVar14) = 0;
      ...
      if (pcVar11 == TType::getOuterArraySize) goto LAB_0010e826;
LAB_0010ebaf:
      iVar7 = (*pcVar11)(param_3);
      if (iVar7 < 1) {
        iVar7 = 1;
      }
...
/* glslang::TReflectionTraverser::addPipeIOVariable(glslang::TIntermSymbol const&) */

void __thiscall
glslang::TReflectionTraverser::addPipeIOVariable(TReflectionTraverser *this,TIntermSymbol *param_1)
...
LAB_0010fa75:
    lVar17 = std::_Rb_tree_decrement(p_Var19);
    pTVar14 = *(TIntermSymbol **)(lVar17 + 0x20);
LAB_0010f83b:
    if (pTVar14 < param_1) goto LAB_0010f840;
  }
  else {
    do {
      while( true ) {
...
LAB_0010f7e1:
    if ((p_Var1 != p_Var20) && (*(TIntermSymbol **)(p_Var20 + 0x20) <= param_1)) goto LAB_0010f7ec;
    do {
      p_Var19 = p_Var11;
    ...
    if (param_1 >= pTVar14) goto LAB_0010f83b;
    if (*(_Rb_tree_node_base **)(this + 0x60) != p_Var19) goto LAB_0010fa75;
LAB_0010f840:
    bVar22 = true;
    if (p_Var1 != p_Var19) {
...
LAB_0010f84f:
  ...
  if (((byte)((byte)pTVar21[8] & 0x7f) < 0x1c) &&
     (bVar22 = (0xe300008UL >> ((ulong)((byte)pTVar21[8] & 0x7f) & 0x3f) & 1) != 0, bVar22)) {
    this_01 = (vector<glslang::TObjectReflection,std::allocator<glslang::TObjectReflection>> *)
              (lVar17 + 0x158);
    this_00 = (_Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,int>,std::_Select1st<std::pair<std::__cxx11::string_const,int>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
               *)(lVar17 + 0x98);
    ...
    if (uVar9 == 0x10) {
      if (iVar7 == 0) {
        ...
        if (uVar3 < 0x10) {
          ...
          else if (uVar3 != 0) goto LAB_0010ff66;
        }
        else {
          if ((long)uVar3 < 0) goto LAB_0010ffa5;
          local_c0 = (ulong *)glslang::TPoolAllocator::allocate((ulong)local_c8);
          local_b0[0] = uVar3;
LAB_0010ff66:
          memcpy(local_c0,puVar4,uVar3);
        }
        *(undefined1 *)((long)local_c0 + uVar3) = 0;
        local_b8 = uVar3;
      }
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
      _M_assign((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)&local_f8
      ...
      if (iVar7 == 0) {
        ...
        if (ppppuVar12 < (undefined8 ****)0x10) {
          ...
          else if (ppppuVar12 != (undefined8 ****)0x0) goto LAB_0010fede;
        }
        else {
...
LAB_0010fede:
          memcpy(local_90,puVar4,(size_t)ppppuVar12);
        }
    ...
    if (*(code **)(lVar17 + 0xe8) == TType::isArray) {
      if (*(long *)(pTVar15 + 0x60) != 0) {
LAB_0010fa32:
        if (*(code **)(lVar17 + 0x38) == TType::getBasicType) {
          uVar9 = (uint)(byte)pTVar15[8];
        }
        else {
  ...
  if (ppppuVar12 < (undefined8 ****)0x10) {
    ...
    else if (ppppuVar12 != (undefined8 ****)0x0) goto LAB_0010fcbf;
  }
  else {
...
LAB_0010fcbf:
    memcpy(ppppuVar18,__s,(size_t)ppppuVar12);
    ppppuVar18 = (undefined8 ****)local_98;
  }
  *(undefined1 *)((long)ppppuVar18 + (long)local_198[0]) = 0;
  local_90 = local_198[0];
  p_Var13 = (_Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,int>,std::_Select1st<std::pair<std::__cxx11::string_const,int>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
             *)std::
               _Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,int>,std::_Select1st<std::pair<std::__cxx11::string_const,int>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
               ::find(this_00,(string *)&local_98);
  ...
  lVar5 = *(long *)this_01;
  std::__cxx11::string::string<std::allocator<char>>
            ((string *)&local_98,*(char **)(pTVar14 + 8),(allocator *)local_198);
  piVar16 = (int *)std::
                   map<std::__cxx11::string,int,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
                   ::operator[]((map<std::__cxx11::string,int,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,int>>>
  ...
  *piVar16 = (int)(lVar17 - lVar5 >> 4) * -0x33333333;
  ...
  lVar17 = *(long *)pTVar15;
  if (*(code **)(lVar17 + 0xe8) == TType::isArray) {
    if (*(long *)(pTVar15 + 0x60) != 0) goto LAB_0010ff0e;
LAB_0010fd7f:
    iVar7 = 1;
  }
  else {
    cVar6 = (**(code **)(lVar17 + 0xe8))(pTVar15);
    if (cVar6 == '\0') goto LAB_0010fd7f;
    lVar17 = *(long *)pTVar15;
LAB_0010ff0e:
    if (*(code **)(lVar17 + 0x78) == TType::getOuterArraySize) {
      iVar7 = **(int **)(*(long *)(*(long *)(pTVar15 + 0x60) + 8) + 8);
    }
    else {
  ...
  std::__cxx11::string::string<std::allocator<char>>
            ((string *)&local_c8,*(char **)(pTVar14 + 8),(allocator *)local_198);
  TObjectReflection::TObjectReflection
            ((TObjectReflection *)&local_98,(string *)&local_c8,pTVar15,0,iVar8,iVar7,0);
  std::vector<glslang::TObjectReflection,std::allocator<glslang::TObjectReflection>>::
  emplace_back<glslang::TObjectReflection>(this_01,(TObjectReflection *)&local_98);
  if ((undefined8 ****)local_98 != &local_88) {
    operator_delete(local_98,(long)local_88 + 1);
  }
  ...
  *(uint *)(*(long *)(this_01 + 8) + -0xc) =
       *(uint *)(*(long *)(this_01 + 8) + -0xc) | 1 << ((byte)**(undefined4 **)(this + 0x38) & 0x1f)
  ;
LAB_0010f7ec:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */

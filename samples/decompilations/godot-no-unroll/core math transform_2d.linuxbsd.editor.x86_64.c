...

{
  ...
  *(long *)((long)in_RDI + 4) = auVar2._0_8_;
  ...
  in_RDI[2] = CONCAT44(fVar6 * fVar5 - fVar4 * (float)((ulong)in_RDI[1] >> 0x20),
                       (float)*in_RDI * fVar5 - fVar4 * fVar3);
  return;
}
...

{
  ...
  *(long *)((long)in_RDI + 4) = auVar3._0_8_;
  ...
  in_RDI[2] = CONCAT44((float)((ulong)in_RDI[1] >> 0x20) * fVar6 - (float)in_RDI[2] * fVar7,
                       fVar5 * fVar6 - (float)in_RDI[2] * (float)uVar1);
  return;
}
...
void __thiscall Transform2D::affine_invert(Transform2D *this)

{
  ...
  _err_print_error("affine_invert","core/math/transform_2d.cpp",0x33,
                   "Condition \"det == 0\" is true.",0,0);
  return;
}
...
void Transform2D::affine_inverse(void)
...
/* Transform2D::get_skew() const */

void Transform2D::get_skew(void)
...
/* Transform2D::set_skew(float) */

void __thiscall Transform2D::set_skew(Transform2D *this,float param_1)

{
  ...
  *(ulong *)(this + 8) =
       CONCAT44(fVar4 * (float)((ulong)uVar3 >> 0x20) * fVar2,fVar4 * (float)uVar3 * fVar2);
...
/* Transform2D::get_rotation() const */

void __thiscall Transform2D::get_rotation(Transform2D *this)
...
/* Transform2D::Transform2D(float, Vector2 const&) */

void __thiscall Transform2D::Transform2D(Transform2D *this,float param_1,Vector2 *param_2)
...
/* Transform2D::Transform2D(float, Vector2 const&, float, Vector2 const&) */

void __thiscall
Transform2D::Transform2D
          (Transform2D *this,float param_1,Vector2 *param_2,float param_3,Vector2 *param_4)
...
/* Transform2D::get_scale() const */

void Transform2D::get_scale(void)
...
/* Transform2D::set_rotation(float) */

void __thiscall Transform2D::set_rotation(Transform2D *this,float param_1)
...
/* Transform2D::set_scale(Vector2 const&) */

void __thiscall Transform2D::set_scale(Transform2D *this,Vector2 *param_1)
...
/* Transform2D::scale(Vector2 const&) */

void __thiscall Transform2D::scale(Transform2D *this,Vector2 *param_1)

{
  ...
  *(ulong *)(this + 0x10) =
       CONCAT44((float)((ulong)*(undefined8 *)(this + 0x10) >> 0x20) *
                (float)((ulong)*(undefined8 *)param_1 >> 0x20),
                (float)*(undefined8 *)(this + 0x10) * (float)*(undefined8 *)param_1);
  return;
}



/* Transform2D::scale_basis(Vector2 const&) */

void __thiscall Transform2D::scale_basis(Transform2D *this,Vector2 *param_1)
...
/* Transform2D::translate_local(float, float) */

void __thiscall Transform2D::translate_local(Transform2D *this,float param_1,float param_2)

{
  *(ulong *)(this + 0x10) =
       CONCAT44((float)((ulong)*(undefined8 *)this >> 0x20) * param_1 +
                (float)((ulong)*(undefined8 *)(this + 8) >> 0x20) * param_2 +
                (float)((ulong)*(undefined8 *)(this + 0x10) >> 0x20),
                (float)*(undefined8 *)this * param_1 + (float)*(undefined8 *)(this + 8) * param_2 +
                (float)*(undefined8 *)(this + 0x10));
  return;
}



/* Transform2D::translate_local(Vector2 const&) */

void __thiscall Transform2D::translate_local(Transform2D *this,Vector2 *param_1)

{
  ...
  *(ulong *)(this + 0x10) =
       CONCAT44(fVar1 * (float)((ulong)*(undefined8 *)this >> 0x20) +
                fVar2 * (float)((ulong)*(undefined8 *)(this + 8) >> 0x20) +
                (float)((ulong)*(undefined8 *)(this + 0x10) >> 0x20),
                fVar1 * (float)*(undefined8 *)this + fVar2 * (float)*(undefined8 *)(this + 8) +
                (float)*(undefined8 *)(this + 0x10));
  return;
}
...
void __thiscall Transform2D::orthonormalize(Transform2D *this)

{
  ...
  local_28 = CONCAT44((float)((ulong)local_28 >> 0x20) - fVar1 * (float)((ulong)local_30 >> 0x20),
                      (float)local_28 - fVar1 * (float)local_30);
  Vector2::normalize();
...
void Transform2D::orthonormalized(void)
...
/* Transform2D::is_conformal() const */

undefined4 __thiscall Transform2D::is_conformal(Transform2D *this)
...
LAB_001008cc:
  if (fVar3 != (float)(_LC0 ^ (uint)fVar1)) {
    fVar2 = _LC10;
    if (_LC10 <= ABS(fVar3) * _LC10) {
      fVar2 = ABS(fVar3) * _LC10;
    }
...
/* Transform2D::is_equal_approx(Transform2D const&) const */

undefined8 Transform2D::is_equal_approx(Transform2D *param_1)
...
/* Transform2D::is_finite() const */

undefined8 Transform2D::is_finite(void)
...
/* Transform2D::looking_at(Vector2 const&) const */

Vector2 * Transform2D::looking_at(Vector2 *param_1)

{
  ...
  *(ulong *)(param_1 + 8) = CONCAT44(local_50,uVar9);
  ...
  uVar7 = get_scale();
  local_48 = CONCAT44((fVar8 * (float)uVar1 + fVar4 * (float)uVar2 + (float)uVar3) *
                      (float)((ulong)uVar7 >> 0x20),
                      (fVar8 * fVar10 + fVar4 * fVar11 + fVar5) * (float)uVar7);
...
/* Transform2D::TEMPNAMEPLACEHOLDERVALUE(Transform2D const&) const */

undefined8 __thiscall Transform2D::operator==(Transform2D *this,Transform2D *param_1)
...
/* Transform2D::TEMPNAMEPLACEHOLDERVALUE(Transform2D const&) */

void __thiscall Transform2D::operator*=(Transform2D *this,Transform2D *param_1)

{
  ...
  *(ulong *)(this + 0x10) =
       CONCAT44(fVar5 * (float)((ulong)*(undefined8 *)this >> 0x20) +
                fVar6 * (float)((ulong)*(undefined8 *)(this + 8) >> 0x20) +
                (float)((ulong)*(undefined8 *)(this + 0x10) >> 0x20),
                fVar5 * (float)*(undefined8 *)this + fVar6 * (float)*(undefined8 *)(this + 8) +
                (float)*(undefined8 *)(this + 0x10));
  fVar5 = *(float *)param_1;
...
/* Transform2D::rotate(float) */

void __thiscall Transform2D::rotate(Transform2D *this,float param_1)

{
  ...
  fStack_1c = local_50;
  operator*=((Transform2D *)&local_28,this);
...
Transform2D * __thiscall Transform2D::operator*(Transform2D *this,Transform2D *param_1)

{
  ...
  *(ulong *)(this + 0x10) =
       CONCAT44(fVar9 * fVar4 + fVar10 * (float)((ulong)*(undefined8 *)(this + 8) >> 0x20) +
                (float)((ulong)uVar2 >> 0x20),
                fVar9 * fVar3 + fVar10 * (float)*(undefined8 *)(this + 8) + (float)uVar2);
  fVar9 = *in_RDX;
  fVar10 = in_RDX[1];
  fVar7 = in_RDX[2];
  fVar8 = in_RDX[3];
...
/* Transform2D::scaled(Vector2 const&) const */

Vector2 * Transform2D::scaled(Vector2 *param_1)
...
/* Transform2D::scaled_local(Vector2 const&) const */

Vector2 * Transform2D::scaled_local(Vector2 *param_1)
...
void Transform2D::untranslated(void)
...
/* Transform2D::translated(Vector2 const&) const */

Vector2 * Transform2D::translated(Vector2 *param_1)
...
/* Transform2D::translated_local(Vector2 const&) const */

Vector2 * Transform2D::translated_local(Vector2 *param_1)

{
  ...
  *(ulong *)(param_1 + 0x10) =
       CONCAT44(fVar4 * (float)((ulong)uVar1 >> 0x20) + (float)((ulong)uVar2 >> 0x20) * fVar5 +
                (float)((ulong)uVar3 >> 0x20),
                fVar4 * (float)uVar1 + (float)uVar2 * fVar5 + (float)uVar3);
  return param_1;
}



/* Transform2D::rotated(float) const */

void Transform2D::rotated(float param_1)
...
/* Transform2D::rotated_local(float) const */

void Transform2D::rotated_local(float param_1)
...
/* Transform2D::determinant() const */

float __thiscall Transform2D::determinant(Transform2D *this)
...
/* Transform2D::interpolate_with(Transform2D const&, float) const */

Transform2D * Transform2D::interpolate_with(Transform2D *param_1,float param_2)

{
  ...
  local_38 = CONCAT44(((float)((ulong)*(undefined8 *)(in_RDX + 4) >> 0x20) - fVar1) * param_2 +
                      fVar1,((float)*(undefined8 *)(in_RDX + 4) - fVar7) * param_2 + fVar7);
  ...
  local_40 = CONCAT44(((float)((ulong)uVar6 >> 0x20) - fVar8) * param_2 + fVar8,
                      ((float)uVar6 - (float)uVar5) * param_2 + (float)uVar5);
  ...
  Transform2D(param_1,(fVar3 - fVar8) * param_2 + fVar4,(Vector2 *)&local_40,
              (fVar1 - fVar7) * param_2 + fVar2,(Vector2 *)&local_38);
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    return param_1;
  }
                    /* WARNING: Subroutine does not return */
...
/* Transform2D::TEMPNAMEPLACEHOLDERVALUE(float) */

void __thiscall Transform2D::operator*=(Transform2D *this,float param_1)
...
/* Transform2D::TEMPNAMEPLACEHOLDERVALUE(float) const */

Transform2D * __thiscall Transform2D::operator*(Transform2D *this,float param_1)
...
Transform2D * __thiscall Transform2D::operator_cast_to_String(Transform2D *this)

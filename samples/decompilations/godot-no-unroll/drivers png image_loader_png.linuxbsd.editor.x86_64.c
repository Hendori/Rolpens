...
/* ImageLoaderPNG::get_recognized_extensions(List<String, DefaultAllocator>*) const */

void __thiscall ImageLoaderPNG::get_recognized_extensions(ImageLoaderPNG *this,List *param_1)
...
void __thiscall ImageLoaderPNG::ImageLoaderPNG(ImageLoaderPNG *this)

{
  RefCounted::RefCounted((RefCounted *)this);
  *(undefined ***)this = &PTR__initialize_classv_00102800;
...
/* ImageLoaderPNG::load_mem_png(unsigned char const*, int) */

ImageLoaderPNG * __thiscall
ImageLoaderPNG::load_mem_png(ImageLoaderPNG *this,uchar *param_1,int param_2)
...
LAB_00100411:
  ...
  iVar2 = PNGDriverCommon::png_to_image(param_1,(long)param_2,0,&local_38);
  if ((local_38 == (Resource *)0x0) || (cVar1 = RefCounted::unreference(), cVar1 == '\0')) {
    if (iVar2 != 0) goto LAB_001004a8;
LAB_00100443:
    ...
    *(Resource **)this = this_00;
    ...
    memdelete<Image>((Image *)local_38);
    if (iVar2 == 0) goto LAB_00100443;
LAB_001004a8:
    _err_print_error("load_mem_png","drivers/png/image_loader_png.cpp",0x3e,
                     "Condition \"err\" is true. Returning: Ref<Image>()",0,0);
    *(undefined8 *)this = 0;
    if (this_00 == (Resource *)0x0) goto LAB_00100470;
  }
  cVar1 = RefCounted::unreference();
  if (cVar1 != '\0') {
    memdelete<Image>((Image *)this_00);
...
/* ImageLoaderPNG::unpack_mem_png(unsigned char const*, int) */

ImageLoaderPNG * __thiscall
ImageLoaderPNG::unpack_mem_png(ImageLoaderPNG *this,uchar *param_1,int param_2)

{
  ...
  if (param_2 < 4) {
    _err_print_error("unpack_mem_png","drivers/png/image_loader_png.cpp",0x44,
                     "Condition \"p_size < 4\" is true. Returning: Ref<Image>()",0,0);
    *(undefined8 *)this = 0;
  }
  else if ((((*param_1 == 'P') && (param_1[1] == 'N')) && (param_1[2] == 'G')) &&
          (param_1[3] == ' ')) {
    load_mem_png(this,param_1 + 4,param_2 + -4);
  }
  else {
    _err_print_error("unpack_mem_png","drivers/png/image_loader_png.cpp",0x45,
                     "Condition \"p_png[0] != \'P\' || p_png[1] != \'N\' || p_png[2] != \'G\' || p_png[3] != \' \'\" is true. Returning: Ref<Image>()"
                     ,0,0);
    *(undefined8 *)this = 0;
  }
...
/* ImageLoaderPNG::lossless_unpack_png(Vector<unsigned char> const&) */

ImageLoaderPNG * __thiscall
ImageLoaderPNG::lossless_unpack_png(ImageLoaderPNG *this,Vector *param_1)

{
  ...
  if ((pcVar1 == (char *)0x0) || ((int)*(undefined8 *)(pcVar1 + -8) < 4)) {
    _err_print_error("unpack_mem_png","drivers/png/image_loader_png.cpp",0x44,
                     "Condition \"p_size < 4\" is true. Returning: Ref<Image>()",0,0);
    *(undefined8 *)this = 0;
  }
  else if ((((*pcVar1 == 'P') && (pcVar1[1] == 'N')) && (pcVar1[2] == 'G')) && (pcVar1[3] == ' ')) {
    load_mem_png(this,(uchar *)(pcVar1 + 4),(int)*(undefined8 *)(pcVar1 + -8) + -4);
  }
  else {
    _err_print_error("unpack_mem_png","drivers/png/image_loader_png.cpp",0x45,
                     "Condition \"p_png[0] != \'P\' || p_png[1] != \'N\' || p_png[2] != \'G\' || p_png[3] != \' \'\" is true. Returning: Ref<Image>()"
...
/* ImageLoaderPNG::load_image(Ref<Image>, Ref<FileAccess>, BitField<ImageFormatLoader::LoaderFlags>,
   float) */

int ImageLoaderPNG::load_image(undefined8 param_1,long *param_2,undefined8 *param_3,uint param_4)

{
  ...
  local_50[0] = 0;
  iVar3 = CowData<unsigned_char>::resize<false>((CowData<unsigned_char> *)local_50,lVar4);
  lVar5 = local_50[0];
  if (iVar3 == 0) {
    CowData<unsigned_char>::_copy_on_write((CowData<unsigned_char> *)local_50);
    lVar5 = local_50[0];
    (**(code **)(*(long *)*param_3 + 0x220))((long *)*param_3,local_50[0],lVar4);
    local_60[0] = (Image *)0x0;
    if (((Image *)*param_2 != (Image *)0x0) &&
       (local_60[0] = (Image *)*param_2, cVar2 = RefCounted::reference(), cVar2 == '\0')) {
      local_60[0] = (Image *)0x0;
    }
    iVar3 = PNGDriverCommon::png_to_image(lVar5,lVar4,param_4 & 1,local_60);
    if ((local_60[0] != (Image *)0x0) && (cVar2 = RefCounted::unreference(), cVar2 != '\0')) {
      memdelete<Image>(local_60[0]);
    }
  }
  if (lVar5 != 0) {
    LOCK();
...
/* ImageLoaderPNG::lossless_pack_png(Ref<Image> const&) */

ImageLoaderPNG * __thiscall ImageLoaderPNG::lossless_pack_png(ImageLoaderPNG *this,Ref *param_1)

{
  ...
  if (iVar3 == 0) {
    ...
    *local_40[0] = 0x20474e50;
    iVar3 = PNGDriverCommon::image_to_png(param_1,aVStack_48);
    if (iVar3 == 0) {
      *(undefined4 **)(this + 8) = local_40[0];
      goto LAB_00100882;
    }
    _err_print_error("lossless_pack_png","drivers/png/image_loader_png.cpp",0x5e,
                     "Method/function failed. Returning: Vector<uint8_t>()",0,0);
    *(undefined8 *)(this + 8) = 0;
  }
  else {
    _err_print_error("lossless_pack_png","drivers/png/image_loader_png.cpp",0x52,
                     "Method/function failed. Returning: Vector<uint8_t>()",0,0);
    *(undefined8 *)(this + 8) = 0;
  }
  puVar2 = local_40[0];
...
{
  return (uint)CONCAT71(0x1029,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr) |
...
{
  return (uint)CONCAT71(0x1029,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1029,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
...
{
  *(undefined ***)this = &PTR__initialize_classv_001026a0;
...
LAB_001016f8:
    ...
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_001016f8;
...
LAB_00101af8:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_00101af8;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x00101b15;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialize_class()::initialized != '\0') goto LAB_00101f3b;
...
LAB_0010205a:
      ...
      *plVar1 = *plVar1 + -1;
      UNLOCK();
      if (*plVar1 != 0) goto LAB_0010204a;
      local_68 = 0;
      Memory::free_static((void *)(lVar2 + -0x10),false);
      if ((code *)PTR__bind_methods_00105010 != RefCounted::_bind_methods) goto LAB_0010205a;
    }

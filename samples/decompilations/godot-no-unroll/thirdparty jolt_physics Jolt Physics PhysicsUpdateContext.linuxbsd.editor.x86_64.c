...
/* JPH::PhysicsUpdateContext::PhysicsUpdateContext(JPH::TempAllocator&) */

void __thiscall
JPH::PhysicsUpdateContext::PhysicsUpdateContext(PhysicsUpdateContext *this,TempAllocator *param_1)
...
void __thiscall JPH::PhysicsUpdateContext::~PhysicsUpdateContext(PhysicsUpdateContext *this)
  ...
  if (pSVar3 != (Step *)0x0) {
    ...
    *(undefined8 *)(this + 0x50) = 0;
    ...
    (**(code **)(**(long **)(this + 0x48) + 0x18))
              (*(long **)(this + 0x48),pSVar3,*(int *)(this + 0x58) * 0x1cb0);
    return;
  }
  return;
}
...
void JPH::PhysicsUpdateContext::_GLOBAL__sub_I_PhysicsUpdateContext(void)

...
LAB_00100678:
    ...
    do {
      ...
      *(int *)(pXVar5 + 0xc) = -1;
      pXVar5 = pXVar5 + 0x10;
    } while (this + 0x62c != pXVar5);
    pSVar6 = (String *)SkeletonModifier3D::get_skeleton();
    if ((pSVar6 != (String *)0x0) && (lVar7 = XRServer::get_singleton(), lVar7 != 0)) {
...
LAB_00100414:
          ...
          local_d8 = local_100;
          if (local_b8 != (Object *)0x0) goto LAB_00100414;
        }
        iVar3 = XRPositionalTracker::get_tracker_hand();
        if (iVar3 - 1U < 2) {
          puVar8 = _get_joint_data()::bone_names;
          plVar9 = local_a8;
          do {
            local_c0 = 0;
            ...
            iVar4 = Skeleton3D::find_bone(pSVar6);
            *(int *)plVar9 = iVar4;
            if (iVar4 == -1) {
              local_c0 = 0;
            ...
            puVar8 = (code *)puVar8 + 8;
            plVar9 = (long *)((long)plVar9 + 4);
            CowData<char32_t>::_unref(local_d0);
          } while ((code *)puVar8 != DefaultAllocator::alloc);
          plVar9 = local_a8;
          do {
            iVar3 = (int)*plVar9;
            if (iVar3 != -1) {
              iVar4 = Skeleton3D::get_bone_parent((int)pSVar6);
              lVar7 = 0;
              if (iVar4 == -1) {
                *(int *)pXVar10 = iVar3;
                *(int *)(pXVar10 + 4) = 0;
                ...
                do {
                  if (*(int *)((long)local_a8 + lVar7 * 4) == iVar4) {
                    *(ulong *)pXVar10 = CONCAT44((int)lVar7,iVar3);
                    break;
                  }
                  lVar7 = lVar7 + 1;
                } while (lVar7 != 0x1a);

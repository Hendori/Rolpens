...

{
  ...
  *(undefined ***)this = &PTR__get_broad_phase_layer_00108830;
  ...
  if (((*(long *)(this + 0x28) != 0) && (*(int *)(this + 0x30) != -1)) &&
    ...
    if (local_48 == 0) {
      ...
      if (*(float *)(this + 0xa0) != 0.0) {
        fVar15 = (float)uVar6 / *(float *)(this + 0xa0);
      }
      lVar10 = *(long *)(lVar5 + 0x118);
      lVar12 = uVar6 * 0x50 + lVar10;
      for (; lVar12 != lVar10; lVar10 = lVar10 + 0x50) {
        *(float *)(lVar10 + 0x4c) = fVar15;
      }
      ...
      if (iVar2 != 0) {
        uVar11 = *puVar8;
        if ((int)uVar11 < 0) goto LAB_0010295e;
        do {
          if ((int)uVar3 <= (int)uVar11) goto LAB_0010295e;
          if (*puVar7 <= uVar11) {
            _err_print_index_error
                      ("operator[]","./core/templates/local_vector.h",0xae,(ulong)uVar11,
          ...
          iVar4 = *(int *)(*(long *)(puVar7 + 2) + (long)(int)uVar11 * 4);
          if ((iVar4 < 0) || ((int)uVar6 <= iVar4)) {
            ...
            _err_print_error("pin_vertices","modules/jolt_physics/objects/jolt_soft_body_3d.cpp",
                             ...
                             ,&local_98,0,0);
            goto joined_r0x00102c8f;
          }
          *(undefined4 *)((long)iVar4 * 0x50 + *(long *)(lVar5 + 0x118) + 0x4c) = 0;
          while( true ) {
            if (iVar2 <= (int)lVar10 + 1) goto LAB_00102b20;
            lVar10 = lVar10 + 1;
...
LAB_0010295e:
            ...
            local_90 = 0x6d;
            String::parse_latin1((StrRange *)&local_a0);
            vformat<int,String,int>(&local_98,(StrRange *)&local_a0,uVar11,&local_a8,uVar3);
            _err_print_error("pin_vertices","modules/jolt_physics/objects/jolt_soft_body_3d.cpp",
                             0x39,
...
joined_r0x00102c8f:
            if (local_98 != (char *)0x0) {
              ...
              *plVar1 = *plVar1 + -1;
              UNLOCK();
              if (*plVar1 == 0) {
                pcVar13 = local_98 + -0x10;
                local_98 = (char *)0x0;
                Memory::free_static(pcVar13,false);
              }
            }
            if (local_a0 != 0) {
              LOCK();
    ...
    if (uVar29 != 0) {
      ...
      while ((uVar29 != (uint)uVar28 ||
        ...
        if ((uVar29 == 0) ||
           ...
           auVar14._0_8_ = uVar33, SUB164(auVar10 * auVar14,8) < uVar34)) goto LAB_00103980;
      }
        ...
        if (0 < local_190) {
          ...
          do {
            ...
            do {
              ...
              if (lVar26 <= lVar22) goto LAB_00104133;
...
LAB_00104133:
              ...
              if (local_140 == 0) goto LAB_001042e2;
              if (*(long *)(local_140 + -8) <= lVar35) goto LAB_00104111;
...
LAB_00103c31:
                ...
                *(ulong *)(pOVar5 + 8) = uVar20;
                ...
                if (pcVar24 == (char *)0x0) goto LAB_00103c31;
              }
        ...
        if (iVar30 != 0) {
          lVar22 = 0;
          uVar29 = *puVar6;
          if ((int)uVar29 < 0) goto LAB_00103e81;
          do {
            if (iVar3 <= (int)uVar29) goto LAB_00103e81;
            uVar19 = *(uint *)(local_118 + 0x18);
            if (uVar19 <= uVar29) {
              iVar30 = 0xae;
LAB_00104336:
            ...
            *(undefined4 *)(*(long *)(pOVar5 + 0x18) + (long)iVar4 * 0x1c + 0x18) = 0;
            while( true ) {
              if (iVar30 <= (int)lVar22 + 1) goto LAB_001043dc;
              lVar22 = lVar22 + 1;
...
{
                    /* WARNING: Could not recover jumptable at 0x001049e4. Too many branches */
...
/* WARNING: Removing unreachable block (ram,0x00105a30) */
/* WARNING: Removing unreachable block (ram,0x00105b60) */
/* WARNING: Removing unreachable block (ram,0x00105cd8) */
/* WARNING: Removing unreachable block (ram,0x00105b6c) */
/* WARNING: Removing unreachable block (ram,0x00105b76) */
...
/* WARNING: Removing unreachable block (ram,0x00105c9c) */
/* WARNING: Removing unreachable block (ram,0x00105b98) */
/* WARNING: Removing unreachable block (ram,0x00105ba2) */
/* WARNING: Removing unreachable block (ram,0x00105c7e) */
...
/* WARNING: Removing unreachable block (ram,0x00105bc4) */
/* WARNING: Removing unreachable block (ram,0x00105bce) */
/* WARNING: Removing unreachable block (ram,0x00105c42) */
/* WARNING: Removing unreachable block (ram,0x00105bd6) */
/* WARNING: Removing unreachable block (ram,0x00105be0) */
/* WARNING: Removing unreachable block (ram,0x00105c27) */
/* WARNING: Removing unreachable block (ram,0x00105be8) */
/* WARNING: Removing unreachable block (ram,0x00105bfd) */
/* WARNING: Removing unreachable block (ram,0x00105c09) */
...
/* WARNING: Removing unreachable block (ram,0x00105f54) */
/* WARNING: Removing unreachable block (ram,0x00105f5e) */
...
/* WARNING: Removing unreachable block (ram,0x001063b4) */
/* WARNING: Removing unreachable block (ram,0x001063be) */
/* WARNING: Removing unreachable block (ram,0x00106550) */
/* WARNING: Removing unreachable block (ram,0x001063ca) */
...
/* WARNING: Removing unreachable block (ram,0x001063f6) */
...
/* WARNING: Removing unreachable block (ram,0x00106422) */
/* WARNING: Removing unreachable block (ram,0x0010642c) */
/* WARNING: Removing unreachable block (ram,0x001064b0) */
/* WARNING: Removing unreachable block (ram,0x00106434) */
/* WARNING: Removing unreachable block (ram,0x0010644a) */
/* WARNING: Removing unreachable block (ram,0x00106456) */
      ...
      if (uVar29 != 0) {
        ...
        do {
          if (uVar41 == (uint)uVar40) {
            ...
            if (*(uint *)(lVar34 + (long)plStack_98 * 4) == uVar31) goto LAB_0010678f;
          }
          uVar29 = uVar29 + 1;
          auVar6._8_8_ = 0;
...
/* WARNING: Removing unreachable block (ram,0x001078ec) */
/* WARNING: Removing unreachable block (ram,0x001078f6) */
/* WARNING: Removing unreachable block (ram,0x00107a3a) */
/* WARNING: Removing unreachable block (ram,0x00107902) */
/* WARNING: Removing unreachable block (ram,0x0010790c) */
/* WARNING: Removing unreachable block (ram,0x00107a1c) */
/* WARNING: Removing unreachable block (ram,0x00107918) */
/* WARNING: Removing unreachable block (ram,0x00107922) */
/* WARNING: Removing unreachable block (ram,0x001079fe) */
/* WARNING: Removing unreachable block (ram,0x0010792e) */
/* WARNING: Removing unreachable block (ram,0x00107938) */
/* WARNING: Removing unreachable block (ram,0x001079e0) */
/* WARNING: Removing unreachable block (ram,0x00107944) */
/* WARNING: Removing unreachable block (ram,0x0010794e) */
/* WARNING: Removing unreachable block (ram,0x001079c2) */
/* WARNING: Removing unreachable block (ram,0x00107956) */
/* WARNING: Removing unreachable block (ram,0x00107960) */
/* WARNING: Removing unreachable block (ram,0x001079a7) */
/* WARNING: Removing unreachable block (ram,0x00107968) */
/* WARNING: Removing unreachable block (ram,0x0010797d) */
...
LAB_00107c20:
          plVar4 = plVar4 + 1;
          if (plVar2 <= plVar4) goto LAB_00107c58;
        }
        LOCK();
        plVar1 = plVar3 + 1;
        *(int *)plVar1 = (int)*plVar1 + -1;
        UNLOCK();
        if ((int)*plVar1 != 0) goto LAB_00107c20;
...
LAB_00107c58:
  ...
  *(undefined8 *)(this + 8) = 0;
                    /* WARNING: Could not recover jumptable at 0x00107bfa. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*Free)();
  return;
}
...

{
  ...
  if (local_b0 == (void *)0x0) {
    ...
    *(void **)(param_2 + 8) = local_b0;
    ...
    lVar35 = *plVar41;
    iVar39 = *(int *)(param_2 + 0x2c);
    if (local_b0 != (void *)0x0) goto LAB_00107e1f;
  }
  else {
LAB_00107e0e:
    lVar35 = *plVar41;
...
LAB_00107e1f:
  ...
  if (uVar49 == 0) {
    ...
    if (pvVar38 == (void *)0x0) goto LAB_0010870d;
    if (*in_RCX != 0) {
      lVar36 = *(long *)(in_RCX + 2);
      lVar42 = 0;
      do {
...
LAB_001082e8:
    ...
    if (pvVar38 != (void *)0x0) goto LAB_001084c3;
    puVar37 = *(undefined8 **)(param_2 + 0x20);
    if (puVar37 == (undefined8 *)0x0) goto LAB_001084df;
LAB_00108314:
    if (in_R8B == '\0') {
      *puVar37 = pauVar34;
...
LAB_0010870d:
    ...
    *(SoftBodySharedSettings **)(pauVar34[2] + 8) = pSVar2;
    if (pSVar2 == (SoftBodySharedSettings *)0x0) {
      ...
      *(int *)pSVar2 = *(int *)pSVar2 + -1;
      UNLOCK();
      if (*(int *)pSVar2 == 0) goto LAB_001082e8;
    }
LAB_001084c3:
    Memory::free_static(pvVar38,false);
    puVar37 = *(undefined8 **)(param_2 + 0x20);
    if (puVar37 != (undefined8 *)0x0) goto LAB_00108314;
LAB_001084df:
    *(undefined1 (**) [16])(param_2 + 0x18) = pauVar34;
    *(undefined1 (**) [16])(param_2 + 0x20) = pauVar34;
  }

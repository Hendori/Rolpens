...
/* HeightMapShape3D::get_map_width() const */

undefined4 __thiscall HeightMapShape3D::get_map_width(HeightMapShape3D *this)
...
/* HeightMapShape3D::get_map_depth() const */

undefined4 __thiscall HeightMapShape3D::get_map_depth(HeightMapShape3D *this)
...
/* HeightMapShape3D::get_min_height() const */

undefined4 __thiscall HeightMapShape3D::get_min_height(HeightMapShape3D *this)
...
/* HeightMapShape3D::get_max_height() const */

undefined4 __thiscall HeightMapShape3D::get_max_height(HeightMapShape3D *this)
...
/* HeightMapShape3D::get_enclosing_radius() const */

float __thiscall HeightMapShape3D::get_enclosing_radius(HeightMapShape3D *this)

{
  return SQRT((float)*(int *)(this + 0x274) * (float)*(int *)(this + 0x274) +
              (*(float *)(this + 0x294) - *(float *)(this + 0x290)) *
              (*(float *)(this + 0x294) - *(float *)(this + 0x290)) +
              (float)*(int *)(this + 0x278) * (float)*(int *)(this + 0x278));
}
...
/* HeightMapShape3D::get_map_data() const */

void HeightMapShape3D::get_map_data(void)
...
/* HeightMapShape3D::set_map_data(Vector<float>) */

void __thiscall HeightMapShape3D::set_map_data(HeightMapShape3D *this,long param_2)
...
/* HeightMapShape3D::_bind_methods() */

void HeightMapShape3D::_bind_methods(void)

{
  ...
  auStack_60._0_16_ = (undefined1  [16])0x0;
  local_68 = (char **)0x0;
  pMVar4 = create_method_bind<HeightMapShape3D,Ref<Image>const&,float,float>
...
/* HeightMapShape3D::get_debug_mesh_lines() const */

long HeightMapShape3D::get_debug_mesh_lines(void)

{
  ...
  *(undefined8 *)(in_RDI + 8) = 0;
  if ((iVar9 != 0) && (iVar10 = *(int *)(in_RSI + 0x278), iVar10 != 0)) {
    iVar15 = iVar10 + -1;
    ...
    CowData<Vector3>::resize<false>
              (this,(long)(((iVar10 * (iVar9 + -1) + iVar9 * iVar15 * 2) - iVar15) * 2));
              ...
              *(float *)(puVar2 + 1) = fVar8 + local_60;
              if (iVar9 + -1 == local_74) {
                ...
                if (*(int *)(in_RSI + 0x278) + -1 != iVar15) {
                  ...
                  *(float *)(puVar2 + 1) = local_60;
                  uVar3 = *(undefined4 *)
                           (lVar4 + -4 + (long)(*(int *)(in_RSI + 0x274) + iVar10) * 4);
                  if (lVar14 == 0) {
                    lVar14 = 0;
                  }
                  else {
...
/* HeightMapShape3D::update_map_data_from_image(Ref<Image> const&, float, float) */

void __thiscall
HeightMapShape3D::update_map_data_from_image
          (HeightMapShape3D *this,Ref *param_1,float param_2,float param_3)

{
  ...
  if (*(long *)param_1 == 0) {
    _err_print_error("update_map_data_from_image","scene/resources/3d/height_map_shape_3d.cpp",0xf7,
                     "Condition \"p_image.is_null()\" is true.",
                     "Heightmap update image requires a valid Image reference.",0,0);
  }
  else {
    iVar7 = Image::get_format();
    if (((iVar7 == 8) || (iVar7 = Image::get_format(), iVar7 == 0xc)) ||
       (iVar7 = Image::get_format(), iVar7 == 2)) {
      iVar7 = Image::get_width();
      if (iVar7 < 2) {
        _err_print_error("update_map_data_from_image","scene/resources/3d/height_map_shape_3d.cpp",
                         0xf9,"Condition \"p_image->get_width() < 2\" is true.",
                         "Heightmap update image requires a minimum Image width of 2.",0,0);
      }
      else {
        iVar7 = Image::get_height();
        if (iVar7 < 2) {
          _err_print_error("update_map_data_from_image","scene/resources/3d/height_map_shape_3d.cpp"
                           ,0xfa,"Condition \"p_image->get_height() < 2\" is true.",
                           "Heightmap update image requires a minimum Image height of 2.",0,0);
        }
        else {
          if (param_2 <= param_3) {
            ...
            *(int *)(this + 0x278) = iVar7;
            CowData<float>::resize<false>
                      ((CowData<float> *)(this + 0x288),(long)(iVar7 * *(int *)(this + 0x274)));
            CowData<float>::_copy_on_write((CowData<float> *)(this + 0x288));
            ...
            if (iVar7 == 8) {
              ...
              if ((*(long *)(this + 0x288) != 0) &&
                 (lVar5 = *(long *)(*(long *)(this + 0x288) + -8), 0 < lVar5)) {
                lVar10 = 0;
                fVar15 = _LC52._4_4_;
                fVar13 = (float)_LC52;
                do {
...
LAB_00102c00:
              uVar14 = CONCAT44(_LC52._4_4_,(float)_LC52);
            }
            else {
              if (iVar7 == 0xc) {
                Image::get_data();
                ...
                if ((*(long *)(this + 0x288) == 0) ||
                   (lVar5 = *(long *)(*(long *)(this + 0x288) + -8), lVar5 < 1)) goto LAB_00102c00;
                lVar10 = 0;
                fVar15 = _LC52._4_4_;
                fVar13 = (float)_LC52;
                do {
                ...
                fVar13 = (float)_LC52;
                do {
                  fVar12 = (float)((double)*(byte *)(local_30 + lVar10) / dVar6) *
...
LAB_0010282a:
          ...
          _err_print_error("update_map_data_from_image","scene/resources/3d/height_map_shape_3d.cpp"
                           ,0xfb,"Condition \"p_height_min > p_height_max\" is true.",
                           "Heightmap update image requires height_max to be greater than height_min."
                           ,0,0);
        }
      }
    }
      ...
      _err_print_error("update_map_data_from_image","scene/resources/3d/height_map_shape_3d.cpp",
                       0xf8,
                       "Condition \"p_image->get_format() != Image::FORMAT_RF && p_image->get_format() != Image::FORMAT_RH && p_image->get_format() != Image::FORMAT_R8\" is true."
                       ,
                       "Heightmap update image requires Image in format FORMAT_RF (32 bit), FORMAT_RH (16 bit), or FORMAT_R8 (8 bit)."
                       ,0,0,in_R9);
    }
  }
LAB_001028a0:
...
/* HeightMapShape3D::set_map_depth(int) */

void __thiscall HeightMapShape3D::set_map_depth(HeightMapShape3D *this,int param_1)

{
  ...
  *(int *)(this + 0x278) = param_1;
  ...
  CowData<float>::_copy_on_write((CowData<float> *)(this + 0x288));
  if (iVar1 < iVar2) {
    memset((void *)(*(long *)(this + 0x288) + (long)iVar1 * 4),0,
           (ulong)((iVar2 - iVar1) - 1) * 4 + 4);
  }
  (**(code **)(*(long *)this + 0x1c8))(this);
  Resource::emit_changed();
  return;
...
/* HeightMapShape3D::set_map_width(int) */

void __thiscall HeightMapShape3D::set_map_width(HeightMapShape3D *this,int param_1)
...
/* HeightMapShape3D::get_debug_arraymesh_faces(Color const&) const */

Color * HeightMapShape3D::get_debug_arraymesh_faces(Color *param_1)

{
  ...
  local_70 = 0;
  local_60 = 0;
  if ((iVar10 != 0) && (iVar11 = *(int *)(in_RSI + 0x278), iVar11 != 0)) {
...
/* HeightMapShape3D::_update_shape() */

void __thiscall HeightMapShape3D::_update_shape(HeightMapShape3D *this)
...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_0010bf70;
  uVar1 = _LC91;
...
/* HeightMapShape3D::is_class_ptr(void*) const */

uint __thiscall HeightMapShape3D::is_class_ptr(HeightMapShape3D *this,void *param_1)

{
  return (uint)CONCAT71(0x10c3,(undefined4 *)param_1 == &Shape3D::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x10c3,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x10c3,(undefined4 *)param_1 == &Resource::get_class_ptr_static()::ptr) |
...
/* HeightMapShape3D::_getv(StringName const&, Variant&) const */

undefined8 HeightMapShape3D::_getv(StringName *param_1,Variant *param_2)
...
/* HeightMapShape3D::_setv(StringName const&, Variant const&) */

undefined8 HeightMapShape3D::_setv(StringName *param_1,Variant *param_2)
...
/* HeightMapShape3D::_validate_propertyv(PropertyInfo&) const */

void HeightMapShape3D::_validate_propertyv(PropertyInfo *param_1)
...
/* HeightMapShape3D::_property_can_revertv(StringName const&) const */

undefined8 HeightMapShape3D::_property_can_revertv(StringName *param_1)
...
/* HeightMapShape3D::_property_get_revertv(StringName const&, Variant&) const */

undefined8 HeightMapShape3D::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* HeightMapShape3D::_notificationv(int, bool) */

void HeightMapShape3D::_notificationv(int param_1,bool param_2)
...
/* MethodBindT<Ref<Image> const&, float, float>::get_argument_meta(int) const */

byte __thiscall
MethodBindT<Ref<Image>const&,float,float>::get_argument_meta
          (MethodBindT<Ref<Image>const&,float,float> *this,int param_1)
...
{
  *(undefined ***)this = &PTR__gen_argument_type_0010c168;
...
{
  *(undefined ***)this = &PTR__gen_argument_type_0010c1c8;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_0010c228;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_0010c288;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_0010c2e8;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_0010c348;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
/* MethodBindT<Ref<Image> const&, float, float>::_gen_argument_type(int) const */

char __thiscall
MethodBindT<Ref<Image>const&,float,float>::_gen_argument_type
          (MethodBindT<Ref<Image>const&,float,float> *this,int param_1)
...
/* HeightMapShape3D::_bind_methods() [clone .cold] */
...
/* HeightMapShape3D::_get_class_namev() const */

undefined8 * HeightMapShape3D::_get_class_namev(void)
...
LAB_00104393:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"HeightMapShape3D");
      goto LAB_001043fe;
    }
  }
  StringName::assign_static_unique_class_name
...
/* HeightMapShape3D::get_class() const */

void HeightMapShape3D::get_class(void)
...
/* MethodBindT<Ref<Image> const&, float, float>::_gen_argument_type_info(int) const */

undefined4 * MethodBindT<Ref<Image>const&,float,float>::_gen_argument_type_info(int param_1)

{
  ...
  *(undefined1 (*) [16])(puVar8 + 2) = (undefined1  [16])0x0;
  if (in_EDX == 0) {
    ...
    if ((local_70 != 0) &&
       (CowData<char32_t>::_ref((CowData<char32_t> *)&local_38,(CowData *)&local_70),
       local_40 != 0x11)) goto LAB_00105110;
LAB_001050ca:
    local_30 = 6;
    StringName::StringName((StringName *)&local_60,(String *)&local_38,false);
    if (local_50._8_8_ == local_60) {
    ...
    if ((local_70 != 0) &&
       (CowData<char32_t>::_ref((CowData<char32_t> *)&local_38,(CowData *)&local_70),
       local_40 == 0x11)) goto LAB_001050ca;
LAB_00105110:
    local_30 = 6;
    StringName::operator=((StringName *)(local_50 + 8),(StringName *)&local_68);
  }
...
/* HeightMapShape3D::is_class(String const&) const */

undefined8 __thiscall HeightMapShape3D::is_class(HeightMapShape3D *this,String *param_1)
...
/* HeightMapShape3D::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall
HeightMapShape3D::_get_property_listv(HeightMapShape3D *this,List *param_1,bool param_2)
...
/* MethodBind* create_method_bind<HeightMapShape3D, int>(void (HeightMapShape3D::*)(int)) */

MethodBind * create_method_bind<HeightMapShape3D,int>(_func_void_int *param_1)
...
/* MethodBind* create_method_bind<HeightMapShape3D, int>(int (HeightMapShape3D::*)() const) */

MethodBind * create_method_bind<HeightMapShape3D,int>(_func_int *param_1)
...
/* MethodBind* create_method_bind<HeightMapShape3D, Vector<float> >(void
   (HeightMapShape3D::*)(Vector<float>)) */

MethodBind * create_method_bind<HeightMapShape3D,Vector<float>>(_func_void_Vector *param_1)
...
/* MethodBind* create_method_bind<HeightMapShape3D, Vector<float>>(Vector<float>
   (HeightMapShape3D::*)() const) */

MethodBind * create_method_bind<HeightMapShape3D,Vector<float>>(_func_Vector *param_1)
...
/* MethodBind* create_method_bind<HeightMapShape3D, float>(float (HeightMapShape3D::*)() const) */

MethodBind * create_method_bind<HeightMapShape3D,float>(_func_float *param_1)
...
/* MethodBind* create_method_bind<HeightMapShape3D, Ref<Image> const&, float, float>(void
   (HeightMapShape3D::*)(Ref<Image> const&, float, float)) */

MethodBind *
create_method_bind<HeightMapShape3D,Ref<Image>const&,float,float>
          (_func_void_Ref_ptr_float_float *param_1)
...
/* HeightMapShape3D::_initialize_classv() */

void HeightMapShape3D::_initialize_classv(void)
...
LAB_0010850c:
    ...
    lVar4 = puVar8[-1];
    if (param_1 <= lVar4) goto LAB_001084a4;
  }
  else {
    if (lVar10 != 0) {
...
/* WARNING: Removing unreachable block (ram,0x001088d4) */
/* WARNING: Removing unreachable block (ram,0x001088de) */
/* WARNING: Removing unreachable block (ram,0x00108a70) */
/* WARNING: Removing unreachable block (ram,0x001088ea) */
...

{
  ...
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010a917. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
LAB_0010abd9:
      ...
      if (pIVar4 != pIVar6) {
        ...
        if (pIVar4 != (Image *)0x0) goto LAB_0010abd9;
      }
    }
  }
  if (Variant::needs_deinit[local_58[0]] != '\0') {
...
LAB_0010b358:
          ...
          if (pIVar5 != pIVar9) {
            ...
            if (pIVar5 != (Image *)0x0) goto LAB_0010b358;
          }
        }
      }
...
LAB_0010ba7b:
  *(undefined4 *)param_6 = 0;
  ...
  Variant::operator_cast_to_int(this);
                    /* WARNING: Could not recover jumptable at 0x0010bad6. Too many branches */
                    /* WARNING: Treating indirect jump as call */

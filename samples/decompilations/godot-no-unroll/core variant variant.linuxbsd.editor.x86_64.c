...

{
  ...
  local_10 = *(long *)(in_FS_OFFSET + 0x28);
  uVar3 = (undefined7)
          ((ulong)((long)&switchD_001039d5::switchdataD_001116b0 +
                  (long)(int)(&switchD_001039d5::switchdataD_001116b0)[*(uint *)this]) >> 8);
  switch(*(uint *)this) {
  case 0:
    uVar2 = 1;
    break;
...

{
  ...
  *puVar1 = &PTR__PackedArrayRefBase_0011f4d0;
  *(undefined4 *)(puVar1 + 1) = 0;
  puVar1[3] = 0;
  *puVar1 = &PTR__PackedArrayRef_0011f4f0;
  if (*(long *)(param_1 + 8) != 0) {
...

{
  ...
  *(undefined4 *)(puVar1 + 1) = 0;
  puVar1[3] = 0;
  *puVar1 = &PTR__PackedArrayRef_0011f510;
  if (*(long *)(param_1 + 8) != 0) {
...

{
  ...
  *(undefined4 *)(puVar1 + 1) = 0;
  puVar1[3] = 0;
  *puVar1 = &PTR__PackedArrayRef_0011f530;
  if (*(long *)(param_1 + 8) != 0) {
...
LAB_00109382:
    ...
    *puVar7 = &PTR__PackedArrayRefBase_0011f4d0;
    ppuVar11 = &PTR__PackedArrayRef_0011f4f0;
...
LAB_001093b6:
    ...
    puVar7 = (undefined8 *)operator_new(0x20,"");
    *puVar7 = &PTR__PackedArrayRefBase_0011f4d0;
    ppuVar11 = &PTR__PackedArrayRef_0011f510;
    *(undefined4 *)(puVar7 + 1) = 0;
    goto LAB_00108de0;
  case 0x1f:
    lVar4 = *(long *)(param_1 + 8);
...
LAB_0010939c:
    ...
    puVar7 = (undefined8 *)operator_new(0x20,"");
    *puVar7 = &PTR__PackedArrayRefBase_0011f4d0;
    ppuVar11 = &PTR__PackedArrayRef_0011f530;
    *(undefined4 *)(puVar7 + 1) = 0;
    goto LAB_00108de0;
  case 0x20:
    lVar4 = *(long *)(param_1 + 8);
...

{
  ...
  *(undefined ***)this = &PTR__PackedArrayRef_0011f4f0;
  if (*(long *)(this + 0x18) != 0) {
    LOCK();
...

{
  ...
  *(undefined ***)this = &PTR__PackedArrayRef_0011f530;
  if (*(long *)(this + 0x18) != 0) {
    LOCK();
    plVar1 = (long *)(*(long *)(this + 0x18) + -0x10);
    *plVar1 = *plVar1 + -1;
...

{
  ...
  *(undefined ***)this = &PTR__PackedArrayRef_0011f510;
  if (*(long *)(this + 0x18) != 0) {
    LOCK();
    plVar1 = (long *)(*(long *)(this + 0x18) + -0x10);
    *plVar1 = *plVar1 + -1;
...
LAB_00110ed8:
      ...
      if (uVar5 + 1 == lVar4) {
        ...
        lVar4 = puVar7[-1];
LAB_00110e01:
        if (param_1 <= lVar4) goto LAB_00110d7c;
      }
      else {
        if (lVar11 != 0) {
          puVar6 = (undefined8 *)
                   Memory::realloc_static((void *)(*(long *)this + -0x10),uVar5 + 0x11,false);
          if (puVar6 == (undefined8 *)0x0) goto LAB_00110ed8;
          puVar7 = puVar6 + 2;
          *puVar6 = 1;
          *(undefined8 **)this = puVar7;
          lVar4 = puVar6[1];
...
LAB_001111d8:
      ...
      if (uVar4 + 1 == lVar3) {
        ...
        lVar3 = puVar7[-1];
LAB_00111101:
        if (param_1 <= lVar3) goto LAB_0011107c;
      }
      else {
        if (lVar11 != 0) {
          puVar5 = (undefined8 *)
                   Memory::realloc_static((void *)(*(long *)this + -0x10),uVar4 + 0x11,false);
          if (puVar5 == (undefined8 *)0x0) goto LAB_001111d8;
          puVar7 = puVar5 + 2;
          *puVar5 = 1;
          *(undefined8 **)this = puVar7;
          lVar3 = puVar5[1];
...
LAB_00112996:
    ...
    iVar45 = *(int *)(this + 0x2c);
    if (pvVar43 == (void *)0x0) goto LAB_00112484;
    if (iVar45 != 0) goto LAB_00112996;
LAB_001124aa:
    ...
    *(void **)(this + 8) = __s_00;
    ...
    if (iVar45 != 0) {
      ...
      uVar55 = *(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x28) * 4);
      if (*(long *)(this + 8) == 0) goto LAB_00112af8;
LAB_0011298a:
      iVar45 = *(int *)(this + 0x2c);
      goto LAB_0011298e;
    }
LAB_00112484:
    if ((float)uVar39 * __LC97 < (float)(iVar45 + 1)) goto LAB_001124aa;
  }
  local_58 = 0;
  if (*(long *)param_1 == 0) {
...
LAB_00112731:
    ...
    if (puVar42 != (undefined8 *)0x0) goto LAB_0011273e;
LAB_00112965:
    ...
    *plVar1 = *plVar1 + -1;
    UNLOCK();
    if (*plVar1 != 0) goto LAB_00112731;
    Memory::free_static((void *)(local_58 + -0x10),false);
    puVar42 = *(undefined8 **)(this + 0x20);
    if (puVar42 == (undefined8 *)0x0) goto LAB_00112965;
LAB_0011273e:
    *puVar42 = pauVar41;
...
LAB_001133f0:
  ...
  if (uVar9 == 0xffffffffffffffff) goto LAB_001133f0;
  uVar10 = param_1;
  if (param_1 <= lVar7) {
    while (puVar6 = *(undefined8 **)this, puVar6 != (undefined8 *)0x0) {
      if ((ulong)puVar6[-1] <= uVar10) {
        if (uVar9 + 1 != lVar8) {
          ...
          if (puVar4 == (undefined8 *)0x0) goto LAB_0011341f;
          puVar6 = puVar4 + 2;
          *puVar4 = 1;
...
LAB_0011346d:
  ...
  if (uVar9 + 1 == lVar8) {
    ...
    if (puVar6 == (undefined8 *)0x0) goto LAB_0011346d;
    lVar7 = puVar6[-1];
LAB_00113351:
    if (param_1 <= lVar7) goto LAB_0011325c;
  }
  else {
    if (lVar7 != 0) {
      puVar4 = (undefined8 *)
...

{
  ...
  *(undefined8 *)param_1 = 0;
  ...
  while( true ) {
    ...
    if (lVar2 == 0) break;
    lVar6 = *(long *)(lVar2 + -8);
    if (lVar6 <= lVar7) goto LAB_0011dc33;
    local_58 = 5;
    local_50._8_8_ = 0;
...

{
  ...
  *(undefined8 *)param_1 = 0;
  ...
  while( true ) {
    ...
    if (lVar2 == 0) break;
    lVar6 = *(long *)(lVar2 + -8);
    if (lVar6 <= lVar7) goto LAB_0011de22;
    local_58 = 9;
    local_50._12_4_ = 0;
...

{
  ...
  *(undefined8 *)param_1 = 0;
  ...
  while( true ) {
    ...
    if (lVar2 == 0) break;
    lVar6 = *(long *)(lVar2 + -8);
    if (lVar6 <= lVar7) goto LAB_0011e00b;
    local_58 = 0x14;
...

{
  ...
  *(undefined8 *)param_1 = 0;
  ...
  while( true ) {
    ...
    if (lVar2 == 0) break;
    lVar6 = *(long *)(lVar2 + -8);
    if (lVar6 <= lVar7) goto LAB_0011e1eb;
    local_58 = 0xc;
    local_50 = *(undefined1 (*) [16])(lVar2 + lVar7 * 0x10);
    stringify_variant_clean((Variant *)&local_68,(int)(Variant *)&local_58);
    String::operator+=((String *)param_1,(String *)&local_68);
...

{
  ...
  *(undefined8 *)param_1 = 0;
  ...
  while( true ) {
    ...
    if (lVar3 == 0) break;
    lVar6 = *(long *)(lVar3 + -8);
    if (lVar6 <= lVar8) goto LAB_0011e3f4;
    local_58 = 4;
...

{
  ...
  *(undefined8 *)param_1 = 0;
  ...
  while( true ) {
    ...
    if (lVar2 == 0) break;
    lVar6 = *(long *)(lVar2 + -8);
    if (lVar6 <= lVar7) goto LAB_0011e5d3;
...

{
  ...
  *(undefined8 *)param_1 = 0;
  ...
  while( true ) {
    ...
    if (lVar2 == 0) break;
    lVar6 = *(long *)(lVar2 + -8);
    if (lVar6 <= lVar7) goto LAB_0011e7b2;
...

{
  ...
  *(undefined8 *)param_1 = 0;
  ...
  while( true ) {
    ...
    if (lVar2 == 0) break;
    lVar6 = *(long *)(lVar2 + -8);
    if (lVar6 <= lVar7) goto LAB_0011e992;
...

{
  ...
  *(undefined8 *)param_1 = 0;
  ...
  while( true ) {
    ...
    if (lVar2 == 0) break;
    lVar6 = *(long *)(lVar2 + -8);
    if (lVar6 <= lVar7) goto LAB_0011eb79;
    local_58[0] = 3;
    local_48 = 0;
...

{
  ...
  *(undefined8 *)param_1 = 0;
  ...
  while( true ) {
    ...
    if (lVar2 == 0) break;
    lVar6 = *(long *)(lVar2 + -8);
    if (lVar6 <= lVar7) goto LAB_0011ed55;
    local_50 = *(undefined8 *)(lVar2 + lVar7 * 8);
    local_58[0] = 3;
    local_48 = 0;
    stringify_variant_clean((Variant *)&local_68,(int)(Variant *)local_58);
...
/* WARNING: Removing unreachable block (ram,0x0011f144) */
/* WARNING: Removing unreachable block (ram,0x0011f11a) */
/* WARNING: Removing unreachable block (ram,0x0011f16e) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

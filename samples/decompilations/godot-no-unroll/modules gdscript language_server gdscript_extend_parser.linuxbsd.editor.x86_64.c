...
/* CowData<GDScriptParser::MatchBranchNode*>::_copy_on_write() [clone .isra.0] */

void __thiscall
CowData<GDScriptParser::MatchBranchNode*>::_copy_on_write
          (CowData<GDScriptParser::MatchBranchNode*> *this)
...
/* CowData<GDScriptParser::ParameterNode*>::_copy_on_write() [clone .isra.0] */

void __thiscall
CowData<GDScriptParser::ParameterNode*>::_copy_on_write
          (CowData<GDScriptParser::ParameterNode*> *this)
...
List<GDScriptParser::Node*,DefaultAllocator>::push_back
          (List<GDScriptParser::Node*,DefaultAllocator> *this,Node **param_1)
...
/* ExtendGDScriptParser::get_text_for_completion(lsp::Position const&) const */

Position * ExtendGDScriptParser::get_text_for_completion(Position *param_1)
...
LAB_001006d3:
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,uVar8,lVar6,"p_index","size()","",false,
                   true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
...
/* ExtendGDScriptParser::get_uri() const */

ExtendGDScriptParser * __thiscall ExtendGDScriptParser::get_uri(ExtendGDScriptParser *this)
...

{
  ...
  if ((*(int *)(param_2 + 0x28) == param_1) &&
     (((*(long *)param_3 == 0 || (*(uint *)(*(long *)param_3 + -8) < 2)) ||
      (cVar1 = String::operator==((String *)param_2,param_3), cVar1 != '\0')))) {
    return param_2;
  }
  ...
  if (lVar2 != 0) {
    ...
    do {
      ...
      pDVar3 = (DocumentSymbol *)
               search_symbol_defined_at_line
                         (this,param_1,(DocumentSymbol *)(lVar2 + lVar4 * 0x68),param_3);
...
/* ExtendGDScriptParser::get_symbol_defined_at_line(int, String const&) const */

void __thiscall
ExtendGDScriptParser::get_symbol_defined_at_line
          (ExtendGDScriptParser *this,int param_1,String *param_2)
...
/* ExtendGDScriptParser::get_member_symbol(String const&, String const&) const */

undefined8 __thiscall
ExtendGDScriptParser::get_member_symbol(ExtendGDScriptParser *this,String *param_1,String *param_2)
  ...
  if ((*(long *)param_2 == 0) || (*(uint *)(*(long *)param_2 + -8) < 2)) {
        ...
        do {
          if (uVar29 == uVar28) {
            cVar27 = String::operator==((String *)
                                        (*(long *)(*(long *)(this + 0xac8) + lVar31 * 8) + 0x10),
                                        param_1);
            if (cVar27 != '\0') {
          ...
          uVar30 = SUB164(auVar4 * auVar16,8);
                ...
                (auVar5._8_8_ = 0, auVar5._0_8_ = (ulong)uVar28 * lVar2, auVar17._8_8_ = 0,
                auVar17._0_8_ = uVar34, auVar6._8_8_ = 0,
                auVar6._0_8_ = (ulong)((uVar1 + uVar30) - SUB164(auVar5 * auVar17,8)) * lVar2,
                auVar18._8_8_ = 0, auVar18._0_8_ = uVar34, uVar35 <= SUB164(auVar6 * auVar18,8)));
      }
    }
  }
    ...
    if (uVar28 != 0) {
      ...
      do {
        if (uVar29 == uVar28) {
          cVar27 = String::operator==((String *)
                                      (*(long *)(*(long *)(this + 0xaf8) + lVar31 * 8) + 0x10),
                                      param_2);
          if (cVar27 != '\0') {
            ...
            while( true ) {
              if (uVar29 == uVar28) {
                cVar27 = String::operator==((String *)
                                            (*(long *)(*(long *)(lVar2 + 0x20) + lVar32 * 8) + 0x10)
                                            ,param_1);
                if (cVar27 != '\0') {
                  return *(undefined8 *)
                          (*(long *)(*(long *)(lVar2 + 0x20) + (ulong)uVar30 * 8) + 0x18);
                }
                lVar31 = *(long *)(lVar2 + 0x28);
              }
              uVar35 = uVar35 + 1;
...
/* ExtendGDScriptParser::get_document_links() const */

ExtendGDScriptParser * __thiscall
...
/* GodotPosition::to_lsp(Vector<String> const&) const */

ulong __thiscall GodotPosition::to_lsp(GodotPosition *this,Vector *param_1)
...
LAB_00100df3:
            _err_print_index_error
                      ("get","./core/templates/cowdata.h",0xdb,uVar8,uVar5,"p_index","size()","",
                       false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
            pcVar3 = (code *)invalidInstructionException();
          ...
          if (iVar4 == -1) {
            ...
            if (local_38 == 0) {
              ...
              uVar8 = 0;
              iVar7 = 1;
              while ((uVar9 = uVar8 & 0xffffffff, (int)uVar8 < (int)uVar5 &&
                     (iVar7 < *(int *)(this + 4)))) {
                if (uVar8 == uVar5) {
LAB_00100d50:
                  iVar7 = iVar7 + 1;
...
/* GodotRange::to_lsp(Vector<String> const&) const */

undefined1  [16] __thiscall GodotRange::to_lsp(GodotRange *this,Vector *param_1)
...
/* ExtendGDScriptParser::range_of_node(GDScriptParser::Node const*) const */

undefined8 __thiscall ExtendGDScriptParser::range_of_node(ExtendGDScriptParser *this,Node *param_1)
...
/* GodotPosition::from_lsp(lsp::Position, Vector<String> const&) */

ulong GodotPosition::from_lsp(undefined8 param_1,long param_2)
...
/* GodotRange::from_lsp(lsp::Range const&, Vector<String> const&) */

undefined1  [16] GodotRange::from_lsp(Range *param_1,Vector *param_2)
...
/* ExtendGDScriptParser::get_identifier_under_position(lsp::Position const&, lsp::Range&) const */

Position * ExtendGDScriptParser::get_identifier_under_position(Position *param_1,Range *param_2)

{
  ...
  if (*in_RDX < 0) {
    ...
    if (lVar4 != 0) {
      ...
      local_60 = 0;
      if ((*(long *)pCVar1 != 0) &&
         (CowData<char32_t>::_ref((CowData<char32_t> *)&local_60,pCVar1), local_60 != 0)) {
        lVar4 = *(long *)(local_60 + -8);
        iVar11 = (int)lVar4;
        if ((iVar11 != 0) && (iVar14 = iVar11 + -1, iVar11 != 1)) {
          iVar10 = in_RDX[1];
          if ((iVar10 < 0) || (iVar11 <= iVar10)) {
            _err_print_index_error
                      ("get_identifier_under_position",
                       "modules/gdscript/language_server/gdscript_extend_parser.cpp",0x2b8,
                       (long)iVar10,(long)iVar11,"p_position.character","line.size()","",false,false
                      );
            *(undefined8 *)param_1 = 0;
...
LAB_00101458:
              if (lVar4 <= lVar6) goto LAB_001013ce;
              ...
              else if ((uVar8 - 0x41 < 0x3a) &&
                      ((0x3ffffff43ffffffU >> ((ulong)(uVar8 - 0x41) & 0x3f) & 1) != 0)) {
                lVar7 = lVar6;
                iVar10 = iVar10 + -1;
              }
              goto LAB_00101200;
            ...
            if ((uVar8 - 0x41 < 0x3a) &&
               ((0x3ffffff43ffffffU >> ((ulong)(uVar8 - 0x41) & 0x3f) & 1) != 0)) goto LAB_00101209;
LAB_00101440:
            if (iVar10 != 0) {
              lVar6 = (long)(iVar10 + -1);
            ...
            iVar10 = iVar10 + -1;
LAB_00101200:
            if (lVar4 == lVar7) goto LAB_00101570;
LAB_00101209:
            lVar6 = lVar7;
            if (lVar4 <= lVar7) goto LAB_001013ce;
            lVar7 = (long)iVar10;
          ...
          do {
            ...
            if (0x39 < uVar8) {
              ...
              goto LAB_0010123e;
LAB_00101274:
              if ((iVar14 <= iVar10) || (lVar4 == lVar7)) goto LAB_001012f3;
LAB_00101289:
              lVar6 = lVar7;
              if (lVar7 < lVar4) {
...
LAB_0010134d:
  _err_print_index_error
            ("get_identifier_under_position",
             "modules/gdscript/language_server/gdscript_extend_parser.cpp",0x2b3,lVar7,lVar6,
             "p_position.line","lines.size()","",false,false);
  *(undefined8 *)param_1 = 0;
  local_58 = &_LC8;
  local_50 = 0;
  String::parse_latin1((StrRange *)param_1);
  ...
  while( true ) {
    iVar10 = iVar11;
    if ((lVar12 == (ulong)uVar8 + lVar7) || (lVar9 = lVar12 + 1, lVar4 + -1 == lVar12))
    goto LAB_001012f3;
    lVar6 = lVar4;
    lVar12 = lVar9;
    if (lVar9 == lVar4) break;
LAB_001012e0:
    uVar3 = *(uint *)(local_60 + lVar12 * 4);
    iVar11 = (int)lVar12;
    if (uVar3 < 0x3a) {
      if (uVar3 < 0x30) goto LAB_001012f3;
    }
    else if ((0x39 < uVar3 - 0x41) ||
            ((0x3ffffff43ffffffU >> ((ulong)(uVar3 - 0x41) & 0x3f) & 1) == 0)) goto LAB_001012f3;
  }
  goto LAB_001013ce;
LAB_001012f3:
  if (iVar13 < iVar10) {
LAB_001012fc:
    *in_RCX = CONCAT44(iVar13 + 1,iVar2);
...
/* ExtendGDScriptParser::get_left_function_call(lsp::Position const&, lsp::Position&, int&) const */

undefined8 __thiscall
ExtendGDScriptParser::get_left_function_call
          (ExtendGDScriptParser *this,Position *param_1,Position *param_2,int *param_3)
...
LAB_00101829:
  _err_print_index_error
            ("get_left_function_call","modules/gdscript/language_server/gdscript_extend_parser.cpp",
             0x306,uVar10,lVar5,"p_position.line","lines.size()","",false,false);
  uVar6 = 0x1f;
LAB_001017b1:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return uVar6;
...
Position *
ExtendGDScriptParser::get_text_for_lookup_symbol(Position *param_1,String *param_2,bool param_3)
...
LAB_00101b63:
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,uVar11,lVar10,"p_index","size()","",false
                   ,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar3 = (code *)invalidInstructionException();
...
/* ExtendGDScriptParser::update_document_links(String const&) */

void ExtendGDScriptParser::update_document_links(String *param_1)
...
LAB_00101eb3:
  ...
  do {
    ...
    if (local_208 == 0x62) {
      ...
      if (Variant::needs_deinit[local_200] != '\0') {
        Variant::_clear_internal();
      }
      if (((local_258 != (Object *)0x0) && (cVar4 = RefCounted::unreference(), cVar4 != '\0')) &&
         (cVar4 = predelete_handler(local_258), cVar4 != '\0')) {
    ...
    if ((local_208 == 3) && (local_200 == 4)) {
      Variant::operator_cast_to_String((Variant *)&local_250);
      cVar4 = (**(code **)(*(long *)local_258 + 0x2e0))(local_258,(Variant *)&local_250);
      if (cVar4 == '\0') {
        local_240 = 0;
        local_228._8_8_ = 1;
        local_228._0_8_ = &_LC31;
        String::parse_latin1((StrRange *)&local_240);
        String::get_base_dir();
        String::operator+((String *)&local_238,local_248);
        String::operator+((String *)local_228,(String *)&local_238);
        if (local_250 != local_228._0_8_) {
          CowData<char32_t>::_unref((CowData<char32_t> *)&local_250);
          local_250 = local_228._0_8_;
          auVar3._8_8_ = 0;
          auVar3._0_8_ = local_228._8_8_;
          local_228 = auVar3 << 0x40;
        }
        ...
        cVar4 = (**(code **)(*(long *)local_258 + 0x2e0))();
        if (cVar4 != '\0') goto LAB_00101fa6;
      }
      else {
LAB_00101fa6:
        local_278 = (Variant *)&local_240;
        local_280 = (String *)&local_238;
        Variant::operator_cast_to_String(local_278);
        local_218[0] = 0;
        ...
        GDScriptWorkspace::get_file_uri(local_280);
        local_270 = local_238;
        if (local_238 == 0) {
          ...
          local_270 = local_238;
          local_238 = 0;
          local_218[0] = local_270;
          CowData<char32_t>::_unref((CowData<char32_t> *)local_280);
        }
        local_268 = (CowData *)local_218;
        cVar4 = RefCounted::unreference();
        if ((cVar4 != '\0') && (cVar4 = predelete_handler(pOVar10), cVar4 != '\0')) {
          (**(code **)(*(long *)pOVar10 + 0x140))(pOVar10);
          Memory::free_static(pOVar10,false);
        }
        local_238 = CONCAT44(uStack_1e0,local_1e8);
        uStack_230 = uStack_1e4;
        uStack_22c = uStack_1e4;
        uVar6 = GodotPosition::to_lsp((GodotPosition *)local_280,(Vector *)(param_1 + 0xa30));
        local_228._8_8_ =
             GodotPosition::to_lsp((GodotPosition *)&uStack_230,(Vector *)(param_1 + 0xa30));
        local_228._0_8_ = uVar6;
        if (*(long *)(param_1 + 0xab8) == 0) {
          pauVar8 = (undefined1 (*) [16])operator_new(0x18,DefaultAllocator::alloc);
          *(undefined1 (**) [16])(param_1 + 0xab8) = pauVar8;
        ...
        *puVar7 = local_228._0_8_;
        puVar7[1] = local_228._8_8_;
        if (local_270 != 0) {
          CowData<char32_t>::_ref((CowData<char32_t> *)(puVar7 + 2),local_268);
        }
        plVar9 = *(long **)(param_1 + 0xab8);
        lVar5 = plVar9[1];
        puVar7[3] = 0;
...
Variant * __thiscall ExtendGDScriptParser::get_member_completions(ExtendGDScriptParser *this)

{
  ...
  if (cVar13 != '\0') {
    ...
    for (puVar6 = *(undefined8 **)(this + 0xb08); puVar6 != (undefined8 *)0x0;
...
void __thiscall
CowData<GDScriptParser::DataType>::_ref(CowData<GDScriptParser::DataType> *this,CowData *param_1)
...
/* ExtendGDScriptParser::dump_function_api(GDScriptParser::FunctionNode const*) const */

FunctionNode * ExtendGDScriptParser::dump_function_api(FunctionNode *param_1)

{
  ...
  if (in_RDX == (undefined8 *)0x0) {
    _err_print_error("dump_function_api",
                     "modules/gdscript/language_server/gdscript_extend_parser.cpp",0x368,
                     "Parameter \"p_func\" is null.",0,0);
    goto LAB_00103ed5;
  }
...
LAB_00103d93:
    ...
    Variant::Variant((Variant *)local_58,
                     (StringName *)(*(long *)(*(long *)(lVar2 + lVar9 * 8) + 0x128) + 0x148));
    Variant::Variant((Variant *)local_78,"name");
...
LAB_00103fa6:
    Variant::Variant((Variant *)local_58,(String *)(pEVar6 + 8));
    ...
    pEVar6 = (ExtendGDScriptParser *)
             search_symbol_defined_at_line
                       (in_RSI,iVar7,(DocumentSymbol *)(in_RSI + 0xa40),(String *)local_1b8);
    CowData<char32_t>::_unref((CowData<char32_t> *)local_1b8);
...
/* ExtendGDScriptParser::dump_class_api(GDScriptParser::ClassNode const*) const */

ClassNode * ExtendGDScriptParser::dump_class_api(ClassNode *param_1)

{
  ...
  Dictionary::Dictionary((Dictionary *)param_1);
  if (in_RDX == 0) {
    _err_print_error("dump_class_api","modules/gdscript/language_server/gdscript_extend_parser.cpp",
                     0x381,"Parameter \"p_class\" is null.",0,0);
    goto LAB_00104bec;
  }
  if ((*(long *)(in_RDX + 0x128) == 0) ||
     (lVar9 = *(long *)(*(long *)(in_RDX + 0x128) + 0x148), lVar9 == 0)) {
    local_168 = (char *)0x0;
  }
  else {
    local_168 = (char *)0x0;
  ...
  if (iVar10 < 1) {
    ...
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_170);
LAB_001055db:
    Variant::Variant((Variant *)&local_58,(String *)(pEVar7 + 8));
    Variant::Variant((Variant *)local_78,"signature");
    pVVar6 = (Variant *)Dictionary::operator[]((Variant *)param_1);
    ...
    pEVar7 = (ExtendGDScriptParser *)
             search_symbol_defined_at_line
                       (in_RSI,iVar10,(DocumentSymbol *)(in_RSI + 0xa40),(String *)&local_170);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_170);
...
/* ExtendGDScriptParser::generate_api() const */

void ExtendGDScriptParser::generate_api(void)
...
void __thiscall
CowData<lsp::DiagnosticRelatedInformation>::_ref
          (CowData<lsp::DiagnosticRelatedInformation> *this,CowData *param_1)
      ...
      do {
        ...
        *(undefined8 *)(this_00 + 0x10) = 0;
        if (*(long *)(pCVar10 + 0x10) != 0) {
          CowData<char32_t>::_ref(this_00 + 0x10,pCVar10 + 0x10);
        }
        *(undefined8 *)(this_00 + 0x18) = 0;
        if (*(long *)(pCVar10 + 0x18) != 0) {
          CowData<char32_t>::_ref(this_00 + 0x18,pCVar10 + 0x18);
        }
...
/* CowData<lsp::Diagnostic>::_copy_on_write() [clone .isra.0] */

void __thiscall CowData<lsp::Diagnostic>::_copy_on_write(CowData<lsp::Diagnostic> *this)
...
/* Vector<lsp::Diagnostic>::push_back(lsp::Diagnostic) [clone .isra.0] */

void __thiscall
Vector<lsp::Diagnostic>::push_back(Vector<lsp::Diagnostic> *this,undefined8 *param_2)
  ...
  if (*(long *)(this + 8) == 0) {
    ...
    if (-1 < lVar5) {
      ...
      *puVar1 = *param_2;
      ...
      CowData<lsp::DiagnosticRelatedInformation>::_ref
                ((CowData<lsp::DiagnosticRelatedInformation> *)(puVar1 + 6),(CowData *)(param_2 + 6)
                );
      return;
    }
  }
...
/* ExtendGDScriptParser::update_diagnostics() */

void __thiscall ExtendGDScriptParser::update_diagnostics(ExtendGDScriptParser *this)

{
  ...
  if ((*(long **)(this + 0x60) != (long *)0x0) &&
     (puVar12 = (ulong *)**(long **)(this + 0x60), puVar12 != (ulong *)0x0)) {
    do {
      local_88[0] = 0;
...
LAB_00106e5c:
      if (local_c0 == 0) goto LAB_00107528;
      ...
      if (local_78 == (char *)0x0) {
        ...
        iVar11 = (int)*(undefined8 *)(local_78 + -8) + -1 +
                 (uint)((int)*(undefined8 *)(local_78 + -8) == 0);
        LOCK();
        plVar1 = (long *)(local_78 + -0x10);
        *plVar1 = *plVar1 + -1;
        UNLOCK();
      ...
      if (local_88[0] != 0) {
        CowData<lsp::DiagnosticRelatedInformation>::_ref
                  ((CowData<lsp::DiagnosticRelatedInformation> *)&local_48,(CowData *)local_88);
      }
      Vector<lsp::Diagnostic>::push_back((Vector<lsp::Diagnostic> *)(this + 0xaa8));
      CowData<lsp::DiagnosticRelatedInformation>::_unref
                ((CowData<lsp::DiagnosticRelatedInformation> *)&local_48);
      if (local_58[0] != 0) {
        LOCK();
      ...
      CowData<lsp::DiagnosticRelatedInformation>::_unref
                ((CowData<lsp::DiagnosticRelatedInformation> *)local_88);
  ...
  if ((*(undefined8 **)(this + 0x70) != (undefined8 *)0x0) &&
     (puVar13 = (undefined4 *)**(undefined8 **)(this + 0x70), puVar13 != (undefined4 *)0x0)) {
    do {
      local_b8 = (undefined1  [16])0x0;
      local_a0._0_16_ = (undefined1  [16])0x0;
      local_a8 = _LC44;
      ...
      operator+((char *)local_e0,(String *)&_LC30);
...
LAB_00107555:
      ...
      Vector<lsp::Diagnostic>::push_back
                ((Vector<lsp::Diagnostic> *)(this + 0xaa8),(String *)&local_78);
...
void __thiscall
ExtendGDScriptParser::parse_function_symbol
          (ExtendGDScriptParser *this,FunctionNode *param_1,DocumentSymbol *param_2)

{
  ...
  local_1a8._0_8_ = 0;
LAB_001078d1:
  if (local_1a8._0_8_ != *(long *)param_2) {
  ...
  *(int *)(param_2 + 0x20) = iVar19;
  ...
  if (lVar28 == 0) {
    ...
    *(long *)(param_2 + 0x38) = auVar34._0_8_;
    ...
    operator+((char *)local_138,(String *)&_LC100);
  ...
  for (lVar31 = 0; (lVar28 != 0 && (lVar31 < *(long *)(lVar28 + -8))); lVar31 = lVar31 + 1) {
    ...
    if (*(code **)*puVar24 == GDScriptParser::Node::get_datatype) {
      local_e0 = 0;
      local_110[0] = (StringName)0x0;
      local_110[1] = (StringName)0x0;
      local_110[2] = (StringName)0x0;
      local_110[3] = (StringName)0x0;
      local_110[4] = (StringName)0x0;
      local_110[5] = (StringName)0x0;
      local_110[6] = (StringName)0x0;
      local_110[7] = (StringName)0x0;
      local_110[8] = (StringName)0x0;
      local_110[9] = (StringName)0x0;
      local_110[10] = (StringName)0x0;
      local_110[0xb] = (StringName)0x0;
      local_110[0xc] = (StringName)0x0;
      local_110[0xd] = (StringName)0x0;
      local_110[0xe] = (StringName)0x0;
      local_110[0xf] = (StringName)0x0;
      ...
      if (pOVar8 != (Object *)local_100._0_8_) {
        ...
        if ((((Object *)uVar25 != (Object *)0x0) &&
            (cVar18 = RefCounted::unreference(), cVar18 != '\0')) &&
           (cVar18 = predelete_handler((Object *)uVar25), cVar18 != '\0')) {
          (**(code **)(*(long *)uVar25 + 0x140))(uVar25);
...
LAB_00107eb0:
      if (((undefined8 *)puVar24[0x19] != (undefined8 *)0x0) &&
         (puVar33 = *(undefined4 **)puVar24[0x19], puVar33 != (undefined4 *)0x0)) {
        ...
        if (uVar20 < *(uint *)(hash_table_size_primes + (ulong)*(uint *)(puVar24 + 0x24) * 4)) {
          if (uVar30 != 0x1c) {
            ...
            do {
              uVar20 = (int)uVar22 + 1;
              uVar22 = (ulong)uVar20;
              if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(puVar24 + 0x24) * 4) <=
                ...
                if (uVar20 != uVar30) {
                  if (local_70._0_8_ == 0) {
                    ...
                    HashMap<StringName,long,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,long>>>
                    ::_resize_and_rehash(local_78,uVar20);
                  }
                }
                goto LAB_001080d4;
              }
...
LAB_001080d4:
        if (puVar24[0x20] != 0) {
          for (puVar32 = (undefined8 *)puVar24[0x22]; puVar32 != (undefined8 *)0x0;
              puVar32 = (undefined8 *)*puVar32) {
            HashMap<StringName,long,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,long>>>
            ::insert((StringName *)local_1a8,(long *)local_78,(bool)((char)puVar32 + '\x10'));
          }
        }
      }
      if (local_138._8_8_ != puVar24[8]) {
        CowData<GDScriptParser::DataType>::_ref
                  ((CowData<GDScriptParser::DataType> *)(local_138 + 8),(CowData *)(puVar24 + 8));
      }
    }
    else {
    ...
    if (1 < (int)uVar17) {
      ...
      GDScriptParser::DataType::to_string();
      operator+((char *)local_1a8,(String *)&_LC103);
      String::operator+=((String *)&local_1d0,(String *)local_1a8);
      CowData<char32_t>::_unref((CowData<char32_t> *)local_1a8);
    ...
    if (puVar24[0x26] != 0) {
      ...
      operator+((char *)local_138,(String *)&_LC104);
  ...
  auVar12._8_8_ = 0;
  auVar12._0_8_ = local_1a8._8_8_;
  local_1a8 = auVar12 << 0x40;
  local_138._0_8_ = &_LC101;
  local_138._8_8_ = 1;
  String::parse_latin1((StrRange *)local_1a8);
  String::operator+((String *)local_138,(String *)&local_1d0);
  String::operator+=((String *)pSVar1,(String *)local_138);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_138);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_1a8);
  ...
  if (1 < (int)uVar17) {
    ...
    GDScriptParser::DataType::to_string();
    operator+((char *)local_1a8,(String *)&_LC105);
    String::operator+=((String *)pSVar1,(String *)local_1a8);
    CowData<char32_t>::_unref((CowData<char32_t> *)local_1a8);
    CowData<char32_t>::_unref(local_238);
    GDScriptParser::DataType::~DataType((DataType *)local_138);
  }
  uVar25 = *(undefined8 *)(param_1 + 0x178);
  pauVar23 = (undefined1 (*) [16])operator_new(0x18,DefaultAllocator::alloc);
  *(undefined4 *)pauVar23[1] = 0;
  *pauVar23 = (undefined1  [16])0x0;
  local_1c8 = pauVar23;
  puVar24 = (undefined8 *)operator_new(0x20,DefaultAllocator::alloc);
  puVar24[1] = 0;
  lVar28 = *(long *)(*pauVar23 + 8);
  *puVar24 = uVar25;
  puVar24[3] = pauVar23;
  puVar24[2] = lVar28;
  if (lVar28 != 0) {
  ...
  lVar28 = *(long *)*pauVar23;
  *(undefined8 **)(*pauVar23 + 8) = puVar24;
  if (lVar28 == 0) {
    *(undefined8 **)*pauVar23 = puVar24;
  }
  *(int *)pauVar23[1] = *(int *)pauVar23[1] + 1;
  pauVar27 = (undefined1 (*) [16])0x0;
  while ((pauVar23 != (undefined1 (*) [16])0x0 && (*(int *)pauVar23[1] != 0))) {
            ...
            if (uVar20 == 2) {
              ...
              if ((lVar31 != 0) && (*(int *)(lVar31 + 8) == 0x15)) {
                ...
                parse_function_symbol
                          (this,*(FunctionNode **)(lVar31 + 0x148),(DocumentSymbol *)local_138);
                local_1b0 = 0;
                if (local_d8._0_8_ != 0) {
                  CowData<lsp::DocumentSymbol>::_ref
                            ((CowData<lsp::DocumentSymbol> *)&local_1b0,(CowData *)local_d8);
                }
...
LAB_00108e80:
              local_138._0_8_ = CONCAT44(puVar5[10],puVar5[8]);
              ...
              local_170._8_8_ =
                   GodotPosition::to_lsp((GodotPosition *)local_138,(Vector *)(this + 0xa30));
        ...
        if (1 < (int)uVar17) {
          GDScriptParser::SuiteNode::Local::get_datatype();
          GDScriptParser::DataType::to_string();
          operator+((char *)local_238,(String *)&_LC103);
        ...
        if (*puVar5 == 1) {
          if (local_198._0_8_ != *(long *)(*(long *)(puVar5 + 2) + 0x148)) {
            CowData<char32_t>::_ref
                      ((CowData<char32_t> *)local_198,(CowData *)(*(long *)(puVar5 + 2) + 0x148));
          }
        }
        else if ((*puVar5 == 2) && (local_198._0_8_ != *(long *)(*(long *)(puVar5 + 2) + 0x1a8))) {
          CowData<char32_t>::_ref
                    ((CowData<char32_t> *)local_198,(CowData *)(*(long *)(puVar5 + 2) + 0x1a8));
        }
        auVar13._8_8_ = 0;
        ...
        local_110[0] = (StringName)local_180[0];
        local_110[1] = (StringName)local_180[1];
        local_110[2] = (StringName)local_180[2];
        local_110[3] = (StringName)local_180[3];
        local_110[4] = (StringName)local_180[4];
        local_110[5] = (StringName)local_180[5];
        local_110[6] = (StringName)local_180[6];
        local_110[7] = (StringName)local_180[7];
        local_110[8] = (StringName)local_180[8];
        local_110[9] = (StringName)local_180[9];
        local_110[10] = (StringName)local_180[10];
        local_110[0xb] = (StringName)local_180[0xb];
        local_110[0xc] = (StringName)local_180[0xc];
        local_110[0xd] = (StringName)local_180[0xd];
        local_110[0xe] = (StringName)local_180[0xe];
        local_110[0xf] = (StringName)local_180[0xf];
        ...
        if (local_148[0] != 0) {
          CowData<lsp::DocumentSymbol>::_ref
                    ((CowData<lsp::DocumentSymbol> *)local_d8,(CowData *)local_148);
        }
...
ExtendGDScriptParser::parse_class_symbol
          (ExtendGDScriptParser *this,ClassNode *param_1,DocumentSymbol *param_2)

{
  ...
  if ((*(long *)(param_1 + 0x128) != 0) &&
     (lVar32 = *(long *)(*(long *)(param_1 + 0x128) + 0x148), lVar32 != 0)) {
    local_138 = (char *)0x0;
...
LAB_00109511:
  ...
  *(undefined1 (*) [16])(param_2 + 0x28) = auVar43;
  ...
  operator+((char *)&local_138,(String *)"class ");
  ...
  if (*(long *)(param_1 + 0x2a8) != 0) {
    ...
    if ((*(long *)(param_1 + 0x2a8) != 0) && (1 < *(uint *)(*(long *)(param_1 + 0x2a8) + -8))) {
      operator+((char *)&local_138,(String *)&_LC107);
  ...
  if (*(long *)(param_1 + 0x2b8) != 0) {
    ...
    if ((pCVar41 != (CowData *)0x0) &&
       (pCVar2 = pCVar41 + *(long *)(pCVar41 + -8) * 0x10, pCVar2 != pCVar41)) {
      do {
        if ((*(long *)pCVar41 == 0) || (*(uint *)(*(long *)pCVar41 + -8) < 2)) {
          ...
          vformat<String>((CowData<char32_t> *)&local_138,(StrRange *)local_218,
          ...
          vformat<String,String>
                    ((CowData<char32_t> *)&local_138,(StrRange *)&local_278,(StrRange *)local_218,
                     (CowData<char32_t> *)local_1a8);
          String::operator+=(local_310,(String *)&local_138);
          CowData<char32_t>::_unref((CowData<char32_t> *)&local_138);
...
joined_r0x001098e0:
  if ((lVar32 == 0) || (*(long *)(lVar32 + -8) <= local_2f8)) {
...
LAB_0010adfb:
    ...
    operator+((char *)&local_138,(String *)"const ");
    ...
    if (pcVar15 == GDScriptParser::Node::get_datatype) {
      GDScriptParser::DataType::DataType
                ((DataType *)&local_138,(DataType *)(*(undefined8 **)(puVar36 + 2) + 7));
    }
    else {
    ...
    if (1 < (int)uVar27) {
      ...
      GDScriptParser::DataType::to_string();
      operator+((char *)local_218,(String *)&_LC103);
    ...
    if (*(int *)(*(long *)(*(long *)(puVar36 + 2) + 0x130) + 0x130) == 0x18) {
      ...
      if (((lVar32 == 0) ||
          (pOVar33 = (Object *)__dynamic_cast(lVar32,&Object::typeinfo,&Resource::typeinfo,0),
          pOVar33 == (Object *)0x0)) || (cVar28 = RefCounted::reference(), cVar28 == '\0')) {
        Variant::to_json_string();
        ...
        if ((local_138 == (char *)0x0) || (*(uint *)(local_138 + -8) < 2)) {
          ...
          Resource::get_path();
          operator+((char *)&local_278,(String *)"preload(\"");
          ...
          if ((local_198._0_8_ == 0) || (*(uint *)(local_198._0_8_ + -8) < 2)) {
                ...
                do {
                  if (uVar29 == uVar34) {
                    cVar28 = String::operator==((String *)
                                                (*(long *)(*(long *)(pOVar42 + 0x1c8) + lVar40 * 8)
                                                + 0x10),(String *)&local_138);
                    if (cVar28 != '\0') {
                      lVar32 = *(long *)(*(long *)(pOVar42 + 0x1c8) + (ulong)uVar35 * 8);
                      CowData<char32_t>::_unref((CowData<char32_t> *)&local_138);
                      cVar28 = RefCounted::unreference();
                      if ((cVar28 == '\0') || (cVar28 = predelete_handler(pOVar42), cVar28 == '\0'))
                      goto LAB_0010ba51;
                      goto LAB_0010ba3b;
                    }
                    lVar31 = *(long *)(pOVar42 + 0x1d0);
                  ...
                  uVar35 = SUB164(auVar8 * auVar12,8);
                        ...
                        (auVar9._8_8_ = 0, auVar9._0_8_ = (ulong)uVar29 * lVar32, auVar13._8_8_ = 0,
                        auVar13._0_8_ = uVar22, auVar10._8_8_ = 0,
                        auVar10._0_8_ =
                             (ulong)((uVar3 + uVar35) - SUB164(auVar9 * auVar13,8)) * lVar32,
                        auVar14._8_8_ = 0, auVar14._0_8_ = uVar22,
                        uVar39 <= SUB164(auVar10 * auVar14,8)));
              }
            }
            CowData<char32_t>::_unref((CowData<char32_t> *)&local_138);
            cVar28 = RefCounted::unreference();
            if (cVar28 != '\0') {
              ...
              if (cVar28 != '\0') {
LAB_0010ba3b:
                (**(code **)(*(long *)pOVar42 + 0x140))(pOVar42);
                  ...
                  if (local_198._0_8_ != *(long *)(*(long *)(lVar32 + 0x18) + 0xa50)) {
                    CowData<char32_t>::_ref
                              ((CowData<char32_t> *)local_198,
                               (CowData *)(*(long *)(lVar32 + 0x18) + 0xa50));
                  }
                }
              }
            }
...
LAB_0010a893:
    ...
    operator+((char *)&local_278,(String *)"signal ");
    String::operator+((String *)&local_138,(String *)&local_278);
...
LAB_0010abb6:
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,lVar40,lVar32,"p_index","size()","",false
                   ,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar15 = (code *)invalidInstructionException();
    ...
    lVar32 = *(long *)(puVar36 + 2);
    CowData<GDScriptParser::ParameterNode*>::_copy_on_write
              ((CowData<GDScriptParser::ParameterNode*> *)(lVar32 + 0x138));
...
LAB_0010b295:
          ...
          if (pcVar5 == (char *)0x0) {
            ...
            String::parse_latin1((StrRange *)&local_278);
LAB_0010b26b:
            if ((Node *)local_1a8._0_8_ != local_278) {
              CowData<char32_t>::_unref((CowData<char32_t> *)local_1a8);
        ...
        operator+((char *)&local_138,(String *)&_LC98);
        if ((char *)local_1a8._8_8_ != local_138) {
          CowData<char32_t>::_unref((CowData<char32_t> *)(local_1a8 + 8));
          pcVar5 = local_138;
          local_138 = (char *)0x0;
        ...
        if (1 < (int)uVar27) {
          ...
          GDScriptParser::DataType::to_string();
          operator+((char *)&local_278,(String *)&_LC103);
        ...
        lsp::DocumentSymbol::DocumentSymbol
                  ((DocumentSymbol *)&local_138,(DocumentSymbol *)local_1a8);
...
LAB_0010a54b:
    ...
    if ((lVar32 != 0) && (*(int *)(lVar32 + 8) == 0x15)) {
      ...
      if (local_d8[0] != 0) {
        CowData<lsp::DocumentSymbol>::_ref
                  ((CowData<lsp::DocumentSymbol> *)(local_1a8 + 8),(CowData *)local_d8);
      }
...
LAB_00109c49:
    ...
    operator+((char *)&local_278,(String *)"enum ");
    String::operator+((String *)&local_138,(String *)&local_278);
    if ((char *)local_218._8_8_ != local_138) {
      CowData<char32_t>::_unref((CowData<char32_t> *)(local_218 + 8));
      pcVar5 = local_138;
    ...
    for (lVar40 = 0;
        (lVar32 != 0 && (local_2e8 = (String *)&local_278, lVar40 < *(long *)(lVar32 + -8)));
        lVar40 = lVar40 + 1) {
      if (lVar40 != 0) {
        String::operator+=((String *)(local_218 + 8),", ");
        lVar31 = *(long *)(puVar36 + 2);
    ...
    lVar32 = *(long *)(puVar36 + 2);
    CowData<GDScriptParser::EnumNode::Value>::_copy_on_write
              ((CowData<GDScriptParser::EnumNode::Value> *)(lVar32 + 0x138));
    puVar38 = *(undefined8 **)(lVar32 + 0x138);
    CowData<GDScriptParser::EnumNode::Value>::_copy_on_write
              ((CowData<GDScriptParser::EnumNode::Value> *)(lVar32 + 0x138));
    puVar37 = *(undefined8 **)(lVar32 + 0x138);
...
LAB_0010a786:
    lsp::DocumentSymbol::DocumentSymbol((DocumentSymbol *)&local_138,(DocumentSymbol *)local_218);
    Vector<lsp::DocumentSymbol>::push_back((Vector<lsp::DocumentSymbol> *)(param_2 + 0x58));
    lsp::DocumentSymbol::~DocumentSymbol((DocumentSymbol *)&local_138);
...
/* ExtendGDScriptParser::update_symbols() */

void __thiscall ExtendGDScriptParser::update_symbols(ExtendGDScriptParser *this)
  ...
  if (*(ClassNode **)(this + 0x50) != (ClassNode *)0x0) {
    ...
    if (lVar7 != 0) {
      ...
      do {
        ...
        ::insert(local_78,(DocumentSymbol **)(this + 0xac0),bVar5);
        if (*(int *)(lVar7 + 0x20) == 5) {
          cVar11 = '\0';
          lVar9 = 0;
          local_70 = (undefined1  [16])0x0;
          ...
          if (lVar4 == 0) {
            ...
            ::insert((String *)&local_80,(HashMap *)(this + 0xaf0),bVar5);
          }
          else {
            do {
              ...
              cVar11 = cVar11 + 'h';
              HashMap<String,lsp::DocumentSymbol_const*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,lsp::DocumentSymbol_const*>>>
              ::insert((String *)&local_80,(DocumentSymbol **)local_78,bVar6);
              lVar4 = *(long *)(lVar7 + 0x60);
            } while (lVar4 != 0);
...
/* ExtendGDScriptParser::parse(String const&, String const&) */

int __thiscall
ExtendGDScriptParser::parse(ExtendGDScriptParser *this,String *param_1,String *param_2)
...
/* CowData<GDScriptParser::MatchBranchNode*>::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<GDScriptParser::MatchBranchNode*>::_copy_on_write(void)
...
/* CowData<GDScriptParser::ParameterNode*>::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<GDScriptParser::ParameterNode*>::_copy_on_write(void)
...
/* ExtendGDScriptParser::get_member_completions() [clone .cold] */

void ExtendGDScriptParser::get_member_completions(void)
...
/* CowData<lsp::Diagnostic>::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<lsp::Diagnostic>::_copy_on_write(void)
...
void ExtendGDScriptParser::parse_class_symbol(ClassNode *param_1,DocumentSymbol *param_2)
...
/* WARNING: Removing unreachable block (ram,0x0010d0a0) */
/* WARNING: Removing unreachable block (ram,0x0010d235) */
/* WARNING: Removing unreachable block (ram,0x0010d241) */
...
/* WARNING: Removing unreachable block (ram,0x0010d52d) */
/* WARNING: Removing unreachable block (ram,0x0010d539) */
...
LAB_0010e499:
    if ((float)uVar23 * __LC38 < (float)(iVar27 + 1)) goto LAB_0010e4bb;
  }
...
LAB_0010eaa0:
  if ((*(undefined8 **)(param_1 + 0x90) != (undefined8 *)0x0) &&
     (puVar12 = (undefined4 *)**(undefined8 **)(param_1 + 0x90), puVar12 != (undefined4 *)0x0)) {
    if (plVar11 == (long *)0x0) {
...
LAB_0010ecc1:
    if ((*(long *)(param_1 + 200) != 0) &&
       (plVar11 = *(long **)(param_1 + 0xd8), plVar11 != (long *)0x0)) {
      do {
        HashMap<StringName,long,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,long>>>
        ::insert(local_48,(long *)this_00,(bool)((char)plVar11 + '\x10'));
  ...
  if (*(long *)(this + 8) == *(long *)(param_1 + 8)) {
    ...
    CowData<GDScriptParser::DataType>::_ref
              ((CowData<GDScriptParser::DataType> *)(this + 8),(CowData *)(param_1 + 8));
    return;
  }
                    /* WARNING: Subroutine does not return */
  __stack_chk_fail();
...

{
  ...
  *(undefined4 *)(in_RDI + 0x8c) = *(undefined4 *)(in_RSI + 0xc4);
  ...
  plVar12 = (long *)0x0;
LAB_0010f9f0:
  if ((*(undefined8 **)(in_RSI + 200) != (undefined8 *)0x0) &&
     (puVar13 = (undefined4 *)**(undefined8 **)(in_RSI + 200), puVar13 != (undefined4 *)0x0)) {
    if (plVar12 == (long *)0x0) {
      pauVar7 = (undefined1 (*) [16])operator_new(0x18,DefaultAllocator::alloc);
...
LAB_0010fb21:
  if (*(long *)(in_RDI + 0xa0) != *(long *)(in_RSI + 0xd8)) {
  ...
  *(undefined4 *)(in_RDI + 0xa8) = *(undefined4 *)(in_RSI + 0xe0);
  ...
  this = (HashMap<StringName,long,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,long>>>
          *)(in_RDI + 0xc0);
  if (this != (HashMap<StringName,long,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,long>>>
               *)(in_RSI + 0xf8)) {
    ...
    if (uVar6 < *(uint *)(hash_table_size_primes + (ulong)*(uint *)(in_RSI + 0x120) * 4)) {
      if (uVar10 != 0x1c) {
        ...
        do {
          uVar6 = (int)uVar9 + 1;
          uVar9 = (ulong)uVar6;
          if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(in_RSI + 0x120) * 4) <=
              *(uint *)(hash_table_size_primes + uVar9 * 4)) {
            if (uVar10 != uVar6) {
...
LAB_0010fc11:
    if ((*(long *)(in_RSI + 0x100) != 0) &&
       (plVar12 = *(long **)(in_RSI + 0x110), plVar12 != (long *)0x0)) {
      do {
        HashMap<StringName,long,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,long>>>
        ::insert(local_48,(long *)this,(bool)((char)plVar12 + '\x10'));
  ...
  if (*(long *)(in_RDI + 8) != *(long *)(in_RSI + 0x40)) {
    CowData<GDScriptParser::DataType>::_ref
              ((CowData<GDScriptParser::DataType> *)(in_RDI + 8),(CowData *)(in_RSI + 0x40));
  }
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
...
/* CowData<GDScriptParser::EnumNode::Value>::_unref() */

void __thiscall
CowData<GDScriptParser::EnumNode::Value>::_unref(CowData<GDScriptParser::EnumNode::Value> *this)
...
void __thiscall
CowData<lsp::DiagnosticRelatedInformation>::_unref(CowData<lsp::DiagnosticRelatedInformation> *this)
...
LAB_0011028f:
    if ((float)uVar21 * __LC38 < (float)(iVar24 + 1)) goto LAB_001102b1;
  }
  local_58 = 0;
  if (*(long *)pSVar26 == 0) {
    uVar32 = *in_RCX;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashMap<String, HashMap<String, lsp::DocumentSymbol const*, HashMapHasherDefault,
   HashMapComparatorDefault<String>, DefaultTypedAllocator<HashMapElement<String,
                        ...
                        if (uVar30 != uVar41) {
                          if (plVar33[4] == 0) {
                            *(uint *)(plVar33 + 8) = uVar30;
                            ...
                            HashMap<String,lsp::DocumentSymbol_const*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,lsp::DocumentSymbol_const*>>>
                            ::_resize_and_rehash(this,uVar30);
                          }
                        }
                        goto LAB_0011103a;
                      }
...
LAB_0011103a:
                if (*(long *)(in_RCX + 8) != 0) {
                  for (puVar50 = *(undefined8 **)(in_RCX + 0x18); puVar50 != (undefined8 *)0x0;
                      puVar50 = (undefined8 *)*puVar50) {
                    HashMap<String,lsp::DocumentSymbol_const*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,lsp::DocumentSymbol_const*>>>
                    ::insert((String *)local_88,(DocumentSymbol **)this,
                             (bool)((char)puVar50 + '\x10'));
                  }
                }
                plVar33 = *(long **)(*(long *)(param_2 + 8) + (ulong)uVar46 * 8);
              }
          ...
          uVar46 = SUB164(auVar13 * auVar25,8);
                ...
                (auVar14._8_8_ = 0, auVar14._0_8_ = (ulong)uVar47 * lVar34, auVar26._8_8_ = 0,
                auVar26._0_8_ = uVar31, auVar15._8_8_ = 0,
                auVar15._0_8_ = (ulong)((uVar30 + uVar46) - SUB164(auVar14 * auVar26,8)) * lVar34,
                auVar27._8_8_ = 0, auVar27._0_8_ = uVar31, uVar51 <= SUB164(auVar15 * auVar27,8)));
      }
      iVar42 = *(int *)(param_2 + 0x2c);
    }
LAB_001107dd:
    if ((float)uVar41 * __LC38 < (float)(iVar42 + 1)) goto LAB_00110803;
  }
  local_78 = 0;
...
LAB_00110be0:
    for (puVar52 = (undefined8 *)local_58._0_8_; puVar52 != (undefined8 *)0x0;
        puVar52 = (undefined8 *)*puVar52) {
      HashMap<String,lsp::DocumentSymbol_const*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,lsp::DocumentSymbol_const*>>>
      ::insert(local_90,(DocumentSymbol **)(plVar33 + 3),(bool)((char)puVar52 + '\x10'));
    }
...
LAB_00110c7b:
      Memory::free_static(puVar50,false);
...
/* CowData<lsp::Diagnostic>::_unref() */

void __thiscall CowData<lsp::Diagnostic>::_unref(CowData<lsp::Diagnostic> *this)
...
/* CowData<lsp::Diagnostic>::_realloc(long) */

undefined8 __thiscall
CowData<lsp::Diagnostic>::_realloc(CowData<lsp::Diagnostic> *this,long param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Error CowData<lsp::Diagnostic>::resize<false>(long) */

undefined8 __thiscall
CowData<lsp::Diagnostic>::resize<false>(CowData<lsp::Diagnostic> *this,long param_1)
...
LAB_00111b60:
  ...
  if (param_1 <= lVar8) {
    while (lVar8 = *(long *)this, lVar8 != 0) {
      ...
      CowData<lsp::DiagnosticRelatedInformation>::_unref
                ((CowData<lsp::DiagnosticRelatedInformation> *)(lVar8 + 0x30));
...
/* Vector<lsp::DocumentSymbol>::append_array(Vector<lsp::DocumentSymbol>) */

void __thiscall
Vector<lsp::DocumentSymbol>::append_array(Vector<lsp::DocumentSymbol> *this,long param_2)

{
  ...
  if ((*(long *)(param_2 + 8) != 0) && (lVar3 = *(long *)(*(long *)(param_2 + 8) + -8), lVar3 != 0))
  {
    if (*(long *)(this + 8) == 0) {
      lVar11 = 0;
      lVar10 = lVar3;
...
LAB_001120c5:
          _err_print_index_error
                    ("get","./core/templates/cowdata.h",0xdb,lVar10,lVar13,"p_index","size()","",
                     false,true);
          _err_flush_stdout();
                    /* WARNING: Does not return */
          pcVar5 = (code *)invalidInstructionException();
        ...
        if (*(long *)(this_00 + 8) != *(long *)(pCVar1 + 8)) {
          CowData<char32_t>::_ref(this_00 + 8,pCVar1 + 8);
        }
        if (*(long *)(this_00 + 0x10) != *(long *)(pCVar1 + 0x10)) {
          CowData<char32_t>::_ref(this_00 + 0x10,pCVar1 + 0x10);
        }
        if (*(long *)(this_00 + 0x18) != *(long *)(pCVar1 + 0x18)) {
          CowData<char32_t>::_ref(this_00 + 0x18,pCVar1 + 0x18);
        }
        ...
        *(undefined8 *)(this_00 + 0x40) = uVar9;
        ...
        if (*(long *)(this_00 + 0x60) != *(long *)(pCVar1 + 0x60)) {
          CowData<lsp::DocumentSymbol>::_ref
                    ((CowData<lsp::DocumentSymbol> *)(this_00 + 0x60),pCVar1 + 0x60);
        }
        lVar10 = lVar10 + 1;
        lVar12 = lVar12 + 0x68;
      } while (lVar10 != lVar3);

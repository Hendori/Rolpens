...
void __thiscall
CowData<MultiplayerDebugger::BandwidthProfiler::BandwidthFrame>::_copy_on_write
          (CowData<MultiplayerDebugger::BandwidthProfiler::BandwidthFrame> *this)
...
/* MultiplayerDebugger::ReplicationProfiler::toggle(bool, Array const&) */

void MultiplayerDebugger::ReplicationProfiler::toggle(bool param_1,Array *param_2)
...
/* MultiplayerDebugger::RPCProfiler::toggle(bool, Array const&) */

void MultiplayerDebugger::RPCProfiler::toggle(bool param_1,Array *param_2)
...
/* MultiplayerDebugger::BandwidthProfiler::add(Array const&) */

void __thiscall MultiplayerDebugger::BandwidthProfiler::add(BandwidthProfiler *this,Array *param_1)

{
  ...
  if (iVar4 < 3) {
    if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error(&_LC12,"modules/multiplayer/multiplayer_debugger.cpp",0x83,
                       "Condition \"p_data.size() < 3\" is true.",0,0);
      return;
    }
    goto LAB_00100629;
  }
...
/* MultiplayerDebugger::_capture(void*, String const&, Array const&, bool&) */

undefined8 MultiplayerDebugger::_capture(void *param_1,String *param_2,Array *param_3,bool *param_4)

{
  ...
  if (cVar5 == '\0') {
    uVar8 = 1;
    _err_print_error("_capture","modules/multiplayer/multiplayer_debugger.cpp",0x56,
                     "Method/function failed. Returning: FAILED",0,0);
  }
  else {
    Array::Array(local_80);
    for (iVar11 = 0; iVar6 = Array::size(), plVar1 = EngineDebugger::singleton, iVar11 < iVar6;
        iVar11 = iVar11 + 1) {
      ...
      if (uVar9 < (uint)ObjectDB::slot_max) {
        ...
        if (lVar7 == 0) {
          ...
          if (lVar7 == 0) {
            uVar8 = 1;
            _err_print_error("_capture","modules/multiplayer/multiplayer_debugger.cpp",0x50,
                             "Method/function failed. Returning: FAILED",0,0);
            goto LAB_00100a9f;
          }
...
LAB_001009c0:
        _err_print_error("_capture","modules/multiplayer/multiplayer_debugger.cpp",0x46,
...
void MultiplayerDebugger::initialize(void)

{
  ...
  *(undefined8 *)(pRVar5 + 0x200) = 0;
  ...
  if (local_60 == 0) {
LAB_00100cec:
    if (pRVar11 == (RefCounted *)0x0) goto joined_r0x00100fe8;
LAB_00100cf5:
    pOVar6 = (Object *)__dynamic_cast(pRVar11,&Object::typeinfo,&EngineProfiler::typeinfo,0);
    if ((pOVar6 == (Object *)0x0) || (cVar4 = RefCounted::reference(), cVar4 == '\0'))
    goto joined_r0x00100fe8;
...
LAB_00100ff0:
      multiplayer_profilers = (undefined1 (*) [16])operator_new(0x18,DefaultAllocator::alloc);
  ...
  *(int *)pauVar2[1] = *(int *)pauVar2[1] + 1;
  ...
  pRVar8 = (RefCounted *)operator_new(0x208,"");
  pRVar10 = pRVar8;
  for (lVar9 = 0x41; lVar9 != 0; lVar9 = lVar9 + -1) {
    *(undefined8 *)pRVar10 = 0;
    pRVar10 = pRVar10 + (ulong)bVar12 * -0x10 + 8;
  }
  RefCounted::RefCounted(pRVar8);
  *(undefined8 *)(pRVar8 + 0x180) = 0;
  *(code **)pRVar8 = RefCounted::init_ref;
  StringName::StringName((StringName *)(pRVar8 + 0x188),"_toggle",false);
  pRVar8[400] = (RefCounted)0x0;
  *(undefined8 *)(pRVar8 + 0x198) = 0;
  StringName::StringName((StringName *)(pRVar8 + 0x1a0),"_add_frame",false);
  pRVar8[0x1a8] = (RefCounted)0x0;
  *(undefined8 *)(pRVar8 + 0x1b0) = 0;
  StringName::StringName((StringName *)(pRVar8 + 0x1b8),"_tick",false);
  *(undefined ***)pRVar8 = &PTR__initialize_classv_001079b0;
  uVar3 = _LC35;
  pRVar8[0x1c0] = (RefCounted)0x0;
  *(undefined8 *)(pRVar8 + 0x1f8) = uVar3;
  *(undefined8 *)(pRVar8 + 0x1c8) = 0;
  *(undefined8 *)(pRVar8 + 0x200) = 0;
  *(undefined1 (*) [16])(pRVar8 + 0x1d8) = (undefined1  [16])0x0;
  *(undefined1 (*) [16])(pRVar8 + 0x1e8) = (undefined1  [16])0x0;
  ...
  local_60 = 0;
  local_58 = "multiplayer:rpc";
  local_50 = 0xf;
  String::parse_latin1((StrRange *)&local_60);
  EngineProfiler::bind((String *)pRVar5);
  lVar9 = local_60;
  if (local_60 != 0) {
    LOCK();
    plVar1 = (long *)(local_60 + -0x10);
  ...
  if ((pRVar5 == (RefCounted *)0x0) ||
     (pOVar6 = (Object *)__dynamic_cast(pRVar5,&Object::typeinfo,&EngineProfiler::typeinfo,0),
     pOVar6 == (Object *)0x0)) {
...
LAB_001010fa:
  ...
  lVar9 = *(long *)(*multiplayer_profilers + 8);
  *(undefined8 *)(*pauVar7 + 8) = 0;
  *(undefined1 (**) [16])(pauVar7[1] + 8) = pauVar2;
  *(long *)pauVar7[1] = lVar9;
  if (lVar9 != 0) {
    *(undefined1 (**) [16])(lVar9 + 8) = pauVar7;
  }
  ...
  *(int *)pauVar2[1] = *(int *)pauVar2[1] + 1;
  ...
  this = (RefCounted *)operator_new(0x208,"");
  pRVar8 = this;
  for (lVar9 = 0x41; lVar9 != 0; lVar9 = lVar9 + -1) {
    *(undefined8 *)pRVar8 = 0;
  ...
  *(code **)this = RefCounted::init_ref;
  StringName::StringName((StringName *)(this + 0x188),"_toggle",false);
  this[400] = (RefCounted)0x0;
  *(undefined8 *)(this + 0x198) = 0;
  StringName::StringName((StringName *)(this + 0x1a0),"_add_frame",false);
  this[0x1a8] = (RefCounted)0x0;
  *(undefined8 *)(this + 0x1b0) = 0;
  StringName::StringName((StringName *)(this + 0x1b8),"_tick",false);
  ...
  *(undefined1 (*) [16])(this + 0x1e8) = (undefined1  [16])0x0;
  ...
  local_60 = 0;
  local_58 = "multiplayer:replication";
  local_50 = 0x17;
  String::parse_latin1((StrRange *)&local_60);
  EngineProfiler::bind((String *)pRVar10);
  lVar9 = local_60;
  if (local_60 != 0) {
    LOCK();
    plVar1 = (long *)(local_60 + -0x10);
  ...
  if (((pRVar10 == (RefCounted *)0x0) ||
      (pOVar6 = (Object *)__dynamic_cast(pRVar10,&Object::typeinfo,&EngineProfiler::typeinfo,0),
...
LAB_0010136f:
  ...
  *(int *)pauVar2[1] = *(int *)pauVar2[1] + 1;
  ...
  StringName::StringName((StringName *)&local_58,"multiplayer",false);
  EngineDebugger::register_message_capture((StringName *)&local_58,_capture,0);
  if ((StringName::configured != '\0') && (local_58 != (char *)0x0)) {
    StringName::unref();
  }
  if (((pRVar10 != (RefCounted *)0x0) && (cVar4 = RefCounted::unreference(), cVar4 != '\0')) &&
     (cVar4 = predelete_handler((Object *)pRVar10), cVar4 != '\0')) {
    (**(code **)(*(long *)pRVar10 + 0x140))(pRVar10);
    Memory::free_static(pRVar10,false);
  }
  if (((pRVar5 != (RefCounted *)0x0) && (cVar4 = RefCounted::unreference(), cVar4 != '\0')) &&
     (cVar4 = predelete_handler((Object *)pRVar5), cVar4 != '\0')) {
    (**(code **)(*(long *)pRVar5 + 0x140))(pRVar5);
    Memory::free_static(pRVar5,false);
  }
  if (((pRVar11 == (RefCounted *)0x0) || (cVar4 = RefCounted::unreference(), cVar4 == '\0')) ||
     (cVar4 = predelete_handler((Object *)pRVar11), cVar4 == '\0')) {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      return;
    }
  }
...
void MultiplayerDebugger::deinitialize(void)
...
MultiplayerDebugger::BandwidthProfiler::bandwidth_usage
          (BandwidthProfiler *this,Vector *param_1,int param_2)

{
  ...
  if (*(long *)(param_1 + 8) == 0) {
    _err_print_error("bandwidth_usage","modules/multiplayer/multiplayer_debugger.cpp",0x5c,
                     "Condition \"p_buffer.is_empty()\" is true. Returning: 0",0,0);
    auVar6._8_8_ = 0;
  ...
  if (param_2 != (int)lVar9) {
    ...
    _err_print_index_error
              ("get","./core/templates/cowdata.h",0xdb,lVar8,lVar4,"p_index","size()","",false,true)
    ;
    _err_flush_stdout();
                    /* WARNING: Does not return */
    pcVar5 = (code *)invalidInstructionException();
...
LAB_00101922:
  uVar10 = uVar13;
  _err_print_error("bandwidth_usage","modules/multiplayer/multiplayer_debugger.cpp",0x6c,
                   "Condition \"i == p_pointer\" is true. Returning: total_bandwidth",
                   "Reached the end of the bandwidth profiler buffer, values might be inaccurate.",0
                   ,0);
LAB_001018e4:
  auVar12._4_4_ = 0;
...
/* MultiplayerDebugger::BandwidthProfiler::tick(double, double, double, double) */
...
/* MultiplayerDebugger::RPCFrame::serialize() */

void MultiplayerDebugger::RPCFrame::serialize(void)

{
  ...
  while( true ) {
    ...
    lVar4 = *(long *)(lVar3 + -8);
    if (lVar4 <= lVar2) goto LAB_00101d63;
    Variant::Variant((Variant *)local_58,*(int *)(lVar3 + 0x10 + lVar5));
    Array::push_back((Variant *)in_RDI);
    if (Variant::needs_deinit[local_58[0]] != '\0') {
      Variant::_clear_internal();
    }
    ...
    lVar4 = *(long *)(lVar3 + -8);
    if (lVar4 <= lVar2) goto LAB_00101d63;
    Variant::Variant((Variant *)local_58,*(int *)(lVar3 + 0x14 + lVar5));
    Array::push_back((Variant *)in_RDI);
    if (Variant::needs_deinit[local_58[0]] != '\0') {
      Variant::_clear_internal();
    }
    ...
    lVar4 = *(long *)(lVar3 + -8);
    if (lVar4 <= lVar2) goto LAB_00101d63;
    Variant::Variant((Variant *)local_58,*(int *)(lVar3 + 0x18 + lVar5));
    Array::push_back((Variant *)in_RDI);
    if (Variant::needs_deinit[local_58[0]] != '\0') {
      Variant::_clear_internal();
    }
    ...
    lVar4 = *(long *)(lVar3 + -8);
    if (lVar4 <= lVar2) goto LAB_00101d63;
    Variant::Variant((Variant *)local_58,*(int *)(lVar3 + 0x1c + lVar5));
    Array::push_back((Variant *)in_RDI);
    if (Variant::needs_deinit[local_58[0]] != '\0') {
      Variant::_clear_internal();
    }
...
/* MultiplayerDebugger::SyncInfo::SyncInfo(MultiplayerSynchronizer*) */

void __thiscall
MultiplayerDebugger::SyncInfo::SyncInfo(SyncInfo *this,MultiplayerSynchronizer *param_1)

{
  ...
  *(undefined1 (*) [16])(this + 0x18) = (undefined1  [16])0x0;
  ...
  _err_print_error("SyncInfo","modules/multiplayer/multiplayer_debugger.cpp",0xf0,
                   "Parameter \"p_sync\" is null.",0,0);
  return;
}



/* MultiplayerDebugger::SyncInfo::write_to_array(Array&) const */

void __thiscall MultiplayerDebugger::SyncInfo::write_to_array(SyncInfo *this,Array *param_1)

{
  ...
  Variant::Variant((Variant *)local_48,*(int *)(this + 0x18));
  Array::push_back((Variant *)param_1);
  if (Variant::needs_deinit[local_48[0]] != '\0') {
    Variant::_clear_internal();
  }
  Variant::Variant((Variant *)local_48,*(int *)(this + 0x1c));
  Array::push_back((Variant *)param_1);
  if (Variant::needs_deinit[local_48[0]] != '\0') {
    Variant::_clear_internal();
  }
  Variant::Variant((Variant *)local_48,*(int *)(this + 0x20));
  Array::push_back((Variant *)param_1);
  if (Variant::needs_deinit[local_48[0]] != '\0') {
    Variant::_clear_internal();
  }
  Variant::Variant((Variant *)local_48,*(int *)(this + 0x24));
  Array::push_back((Variant *)param_1);
  if (Variant::needs_deinit[local_48[0]] != '\0') {
    Variant::_clear_internal();
  }
...
/* MultiplayerDebugger::SyncInfo::read_from_array(Array const&, int) */

undefined8 __thiscall
MultiplayerDebugger::SyncInfo::read_from_array(SyncInfo *this,Array *param_1,int param_2)

{
  ...
  _err_print_error("read_from_array","modules/multiplayer/multiplayer_debugger.cpp",0x105,
                   "Condition \"p_arr.size() - p_offset < 7\" is true. Returning: false",0,0);
  return 0;
}



/* MultiplayerDebugger::ReplicationFrame::serialize() */

void MultiplayerDebugger::ReplicationFrame::serialize(void)

{
  ...
  for (puVar1 = *(undefined8 **)(in_RSI + 0x18); puVar1 != (undefined8 *)0x0;
...
/* MultiplayerDebugger::ReplicationFrame::deserialize(Array const&) */

undefined8 __thiscall
MultiplayerDebugger::ReplicationFrame::deserialize(ReplicationFrame *this,Array *param_1)
  ...
  if (cVar1 == '\0') {
    ...
    if (uVar2 % 7 == 0) {
      ...
      if (iVar3 == uVar2 + 1) {
        ...
        _err_print_error("deserialize","modules/multiplayer/multiplayer_debugger.cpp",0x11d,
                         "Condition \"(uint32_t)p_arr.size() != size + 1\" is true. Returning: false"
                         ,0,0);
        uVar5 = 0;
      }
    }
    else {
      _err_print_error("deserialize","modules/multiplayer/multiplayer_debugger.cpp",0x11c,
                       "Condition \"size % 7\" is true. Returning: false",0,0);
      uVar5 = 0;
    }
  }
  else {
    _err_print_error("deserialize","modules/multiplayer/multiplayer_debugger.cpp",0x11a,
                     "Condition \"p_arr.is_empty()\" is true. Returning: false",0,0);
    uVar5 = 0;
  }
LAB_0010238d:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
...
/* MultiplayerDebugger::ReplicationProfiler::add(Array const&) */

void __thiscall
MultiplayerDebugger::ReplicationProfiler::add(ReplicationProfiler *this,Array *param_1)

{
  ...
  if (iVar12 != 3) {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error(&_LC12,"modules/multiplayer/multiplayer_debugger.cpp",0x12f,
                       "Condition \"p_data.size() != 3\" is true.",0,0);
      return;
    }
    goto LAB_00102838;
  ...
  if (uVar18 < (uint)ObjectDB::slot_max) {
    ...
    ObjectDB::spin_lock._0_1_ = '\0';
    if ((uVar16 == 0) ||
       (pMVar15 = (MultiplayerSynchronizer *)
                  __dynamic_cast(uVar16,&Object::typeinfo,&MultiplayerSynchronizer::typeinfo,0),
       pMVar15 == (MultiplayerSynchronizer *)0x0)) goto LAB_001027f7;
    if ((*(long *)(this + 0x1d8) != 0) && (*(int *)(this + 0x1fc) != 0)) {
      ...
      if (uVar18 != 0) {
        uVar21 = 0;
        do {
          if ((uVar18 == (uint)uVar23) &&
             (local_70 == *(ulong *)(*(long *)(*(long *)(this + 0x1d8) + lVar20 * 8) + 0x10)))
          goto LAB_001026ed;
          uVar21 = uVar21 + 1;
          auVar4._8_8_ = 0;
          ...
          iVar12 = SUB164(auVar4 * auVar8,8);
                ...
                auVar6._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                                 (ulong)*(uint *)(this + 0x1f8) * 4) + iVar12) -
                                      SUB164(auVar5 * auVar9,8)) * lVar2, auVar10._8_8_ = 0,
                auVar10._0_8_ = uVar22, uVar21 <= SUB164(auVar6 * auVar10,8)));
      }
    }
    ...
    *puVar17 = CONCAT71(uStack_67,local_68);
    ...
    puVar17[4] = local_48;
LAB_001026ed:
    lVar20 = HashMap<ObjectID,MultiplayerDebugger::SyncInfo,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,MultiplayerDebugger::SyncInfo>>>
             ::operator[]((HashMap<ObjectID,MultiplayerDebugger::SyncInfo,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,MultiplayerDebugger::SyncInfo>>>
                           *)(this + 0x1d0),(ObjectID *)&local_70);
    ...
    _err_print_error("get_instance","./core/object/object.h",0x418,
                     "Condition \"slot >= slot_max\" is true. Returning: nullptr",0,0);
LAB_001027f7:
    _err_print_error(&_LC12,"modules/multiplayer/multiplayer_debugger.cpp",0x134,
                     "Parameter \"sync\" is null.",0,0);
    lVar2 = local_78;
  }
  local_78 = lVar2;
  if (lVar2 != 0) {
...
/* MultiplayerDebugger::ReplicationProfiler::tick(double, double, double, double) */
  ...
  if (100 < (ulong)(lVar7 - *(long *)(in_RDI + 0x200))) {
    ...
    *(long *)(in_RDI + 0x200) = lVar7;
    ...
    while (puVar11 != (undefined8 *)0x0) {
      puVar8 = (undefined8 *)
               HashMap<ObjectID,MultiplayerDebugger::SyncInfo,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,MultiplayerDebugger::SyncInfo>>>
               ::operator[](local_68,(ObjectID *)(puVar11 + 2));
      uVar5 = puVar11[4];
      *puVar8 = puVar11[3];
      puVar8[1] = uVar5;
      uVar5 = puVar11[6];
    ...
    if ((undefined8 *)local_60._0_8_ != (undefined8 *)0x0) {
      ...
      if ((local_40._4_4_ != 0) &&
         (*(uint *)(hash_table_size_primes + (local_40 & 0xffffffff) * 4) != 0)) {
        piVar9 = (int *)(local_60._8_8_ +
...
void __thiscall
CowData<MultiplayerDebugger::BandwidthProfiler::BandwidthFrame>::resize<false>
          (CowData<MultiplayerDebugger::BandwidthProfiler::BandwidthFrame> *this,long param_1)

{
  ...
  if (lVar2 == 0) {
    ...
    if (pCVar4 != (CowData<MultiplayerDebugger::BandwidthProfiler::BandwidthFrame> *)0x0) {
      ...
      uVar5 = uVar5 | uVar5 >> 8;
      uVar5 = uVar5 | uVar5 >> 0x10;
      pCVar4 = (CowData<MultiplayerDebugger::BandwidthProfiler::BandwidthFrame> *)
               ((uVar5 | uVar5 >> 0x20) + 1);
    }
  }
  if (param_1 * 8 != 0) {
    ...
    uVar5 = uVar5 | uVar5 >> 8;
    uVar5 = uVar5 | uVar5 >> 0x10;
    pCVar11 = (CowData<MultiplayerDebugger::BandwidthProfiler::BandwidthFrame> *)
              (uVar5 | uVar5 >> 0x20);
    pCVar10 = pCVar11 + 1;
...
/* MultiplayerDebugger::BandwidthProfiler::toggle(bool, Array const&) */

void MultiplayerDebugger::BandwidthProfiler::toggle(bool param_1,Array *param_2)

{
  ...
  if ((char)param_2 != '\0') {
    *(undefined4 *)(lVar4 + 0x1d0) = 0;
    CowData<MultiplayerDebugger::BandwidthProfiler::BandwidthFrame>::resize<false>
              ((CowData<MultiplayerDebugger::BandwidthProfiler::BandwidthFrame> *)(lVar4 + 0x1e0),
               0x4000);
    ...
    *(undefined4 *)(lVar4 + 0x1e8) = 0;
    CowData<MultiplayerDebugger::BandwidthProfiler::BandwidthFrame>::resize<false>
              ((CowData<MultiplayerDebugger::BandwidthProfiler::BandwidthFrame> *)(lVar4 + 0x1f8),
               0x4000);
...
/* CowData<MultiplayerDebugger::RPCNodeInfo>::_copy_on_write() [clone .isra.0] */

void __thiscall
CowData<MultiplayerDebugger::RPCNodeInfo>::_copy_on_write
          (CowData<MultiplayerDebugger::RPCNodeInfo> *this)
...
/* MultiplayerDebugger::RPCFrame::deserialize(Array const&) */

undefined8 __thiscall MultiplayerDebugger::RPCFrame::deserialize(RPCFrame *this,Array *param_1)
...
LAB_00103172:
            ...
            if (lVar12 <= lVar13) goto LAB_001032e3;
            CowData<MultiplayerDebugger::RPCNodeInfo>::_copy_on_write(this_00);
            *(int *)(*(long *)(this + 8) + 0x10 + lVar14) = iVar6;
            pVVar7 = (Variant *)Array::operator[](iVar11);
            iVar6 = Variant::operator_cast_to_int(pVVar7);
            if (*(long *)(this + 8) == 0) goto LAB_001032e0;
            lVar12 = *(long *)(*(long *)(this + 8) + -8);
            if (lVar12 <= lVar13) goto LAB_001032e3;
            CowData<MultiplayerDebugger::RPCNodeInfo>::_copy_on_write(this_00);
            *(int *)(*(long *)(this + 8) + 0x14 + lVar14) = iVar6;
            pVVar7 = (Variant *)Array::operator[](iVar11);
            iVar6 = Variant::operator_cast_to_int(pVVar7);
            if (*(long *)(this + 8) == 0) goto LAB_001032e0;
            lVar12 = *(long *)(*(long *)(this + 8) + -8);
            if (lVar12 <= lVar13) goto LAB_001032e3;
            CowData<MultiplayerDebugger::RPCNodeInfo>::_copy_on_write(this_00);
            *(int *)(*(long *)(this + 8) + 0x18 + lVar14) = iVar6;
            pVVar7 = (Variant *)Array::operator[](iVar11);
            iVar6 = Variant::operator_cast_to_int(pVVar7);
            if (*(long *)(this + 8) == 0) goto LAB_001032e0;
            lVar12 = *(long *)(*(long *)(this + 8) + -8);
      ...
      _err_print_error("deserialize","modules/multiplayer/multiplayer_debugger.cpp",0xb4,
                       "Condition \"(uint32_t)p_arr.size() != size + 1\" is true. Returning: false",
                       0,0);
    }
    else {
      _err_print_error("deserialize","modules/multiplayer/multiplayer_debugger.cpp",0xb3,
                       "Condition \"size % 6\" is true. Returning: false",0,0);
    }
  }
  else {
    _err_print_error("deserialize","modules/multiplayer/multiplayer_debugger.cpp",0xb1,
                     "Condition \"p_arr.is_empty()\" is true. Returning: false",0,0);
  }
  uVar9 = 0;
LAB_00103387:
...
/* MultiplayerDebugger::RPCProfiler::tick(double, double, double, double) */
    ...
    *(long *)(in_RDI + 0x200) = lVar7;
    ...
    if (plVar11 != (long *)0x0) {
      do {
        ...
        local_58 = lVar4;
        lStack_50 = lVar5;
        iVar6 = CowData<MultiplayerDebugger::RPCNodeInfo>::resize<false>
                          ((CowData<MultiplayerDebugger::RPCNodeInfo> *)&local_70,lVar7);
        if (iVar6 == 0) {
          if (local_70 == 0) {
            lVar9 = -1;
            lVar7 = 0;
            ...
            if (-1 < lVar9) {
              CowData<MultiplayerDebugger::RPCNodeInfo>::_copy_on_write
                        ((CowData<MultiplayerDebugger::RPCNodeInfo> *)&local_70);
...
LAB_00103544:
    ...
    CowData<MultiplayerDebugger::RPCNodeInfo>::_unref
              ((CowData<MultiplayerDebugger::RPCNodeInfo> *)&local_70);
  }
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
...
/* MultiplayerDebugger::RPCProfiler::init_node(ObjectID) */

void __thiscall MultiplayerDebugger::RPCProfiler::init_node(RPCProfiler *this,ulong param_2)

{
  ...
  *this_00;
    ...
    if (uVar13 != 0) {
      ...
      do {
        if (((uint)uVar16 == uVar13) &&
           (param_2 == *(ulong *)(*(long *)(*(long *)(this + 0x1d8) + lVar15 * 8) + 0x10)))
        goto LAB_001038d0;
        uVar18 = uVar18 + 1;
        auVar3._8_8_ = 0;
        ...
        iVar14 = SUB164(auVar3 * auVar7,8);
              ...
              (auVar4._8_8_ = 0, auVar4._0_8_ = (ulong)uVar13 * lVar12, auVar8._8_8_ = 0,
              auVar8._0_8_ = uVar17, auVar5._8_8_ = 0,
              auVar5._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                               (ulong)*(uint *)(this + 0x1f8) * 4) + iVar14) -
  ...
  local_68[1] = 0;
  HashMap<ObjectID,MultiplayerDebugger::RPCNodeInfo,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,MultiplayerDebugger::RPCNodeInfo>>>
  ::insert(local_70,(RPCNodeInfo *)this_00,SUB81(local_80,0));
  puVar11 = (ulong *)HashMap<ObjectID,MultiplayerDebugger::RPCNodeInfo,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,MultiplayerDebugger::RPCNodeInfo>>>
                     ::operator[](this_00,(ObjectID *)local_80);
  ...
  *puVar11 = local_80[0];
  ...
  lVar12 = HashMap<ObjectID,MultiplayerDebugger::RPCNodeInfo,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,MultiplayerDebugger::RPCNodeInfo>>>
           ::operator[](this_00,(ObjectID *)local_80);
  uVar16 = local_68[0];
...
/* MultiplayerDebugger::RPCProfiler::add(Array const&) */

void __thiscall MultiplayerDebugger::RPCProfiler::add(RPCProfiler *this,Array *param_1)
  ...
  if (iVar3 == 3) {
    ...
    lVar5 = HashMap<ObjectID,MultiplayerDebugger::RPCNodeInfo,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,MultiplayerDebugger::RPCNodeInfo>>>
            ::operator[]((HashMap<ObjectID,MultiplayerDebugger::RPCNodeInfo,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,MultiplayerDebugger::RPCNodeInfo>>>
                          *)(this + 0x1d0),(ObjectID *)&local_28);
    cVar2 = String::operator==((String *)&local_30,"rpc_in");
    if (cVar2 == '\0') {
      cVar2 = String::operator==((String *)&local_30,"rpc_out");
      if (cVar2 != '\0') {
        *(ulong *)(lVar5 + 0x18) =
             CONCAT44((int)((ulong)*(undefined8 *)(lVar5 + 0x18) >> 0x20) + iVar3,
                      (int)*(undefined8 *)(lVar5 + 0x18) + 1);
      }
    }
    else {
      *(ulong *)(lVar5 + 0x10) =
           CONCAT44((int)((ulong)*(undefined8 *)(lVar5 + 0x10) >> 0x20) + iVar3,
                    (int)*(undefined8 *)(lVar5 + 0x10) + 1);
    }
    lVar5 = local_30;
    if (local_30 != 0) {
      LOCK();
    ...
    _err_print_error(&_LC12,"modules/multiplayer/multiplayer_debugger.cpp",0xd1,
                     "Condition \"p_data.size() != 3\" is true.",0,0);
    return;
  }
                    /* WARNING: Subroutine does not return */
...
{
  return (uint)CONCAT71(0x107c,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x107c,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x107c,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}
...
void CowData<MultiplayerDebugger::BandwidthProfiler::BandwidthFrame>::_copy_on_write(void)
...
/* MultiplayerDebugger::BandwidthProfiler::add(Array const&) [clone .cold] */

void MultiplayerDebugger::BandwidthProfiler::add(Array *param_1)
...
void MultiplayerDebugger::BandwidthProfiler::bandwidth_usage(Vector *param_1,int param_2)
...
void CowData<MultiplayerDebugger::BandwidthProfiler::BandwidthFrame>::resize<false>(long param_1)
...
/* CowData<MultiplayerDebugger::RPCNodeInfo>::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<MultiplayerDebugger::RPCNodeInfo>::_copy_on_write(void)
...
/* MultiplayerDebugger::ReplicationProfiler::~ReplicationProfiler() */

void __thiscall
MultiplayerDebugger::ReplicationProfiler::~ReplicationProfiler(ReplicationProfiler *this)
...
/* List<Ref<EngineProfiler>, DefaultAllocator>::~List() */

undefined8 __thiscall
List<Ref<EngineProfiler>,DefaultAllocator>::~List(List<Ref<EngineProfiler>,DefaultAllocator> *this)
...
/* MultiplayerDebugger::BandwidthProfiler::~BandwidthProfiler() */

void __thiscall MultiplayerDebugger::BandwidthProfiler::~BandwidthProfiler(BandwidthProfiler *this)
...
/* MultiplayerDebugger::RPCProfiler::~RPCProfiler() */

void __thiscall MultiplayerDebugger::RPCProfiler::~RPCProfiler(RPCProfiler *this)
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialize_class()::initialized != '\0') goto LAB_00104e5b;
  ...
  if (local_b0 == (void *)0x0) {
    ...
    *(void **)(this + 8) = local_b0;
    if (uVar47 == 0) {
      ...
      if ((pvVar3 < (void *)((long)local_b0 + uVar38)) &&
      ...
      if (uVar43 != 0) {
        ...
        do {
          if (((uint)uVar54 == uVar43) &&
             (lVar56 == *(long *)(*(long *)((long)local_b0 + lVar44 * 8) + 0x10))) {
      ...
      if (uVar47 != 0) {
        ...
        do {
          if (((uint)uVar54 == uVar47) &&
             (*(long *)(*(long *)((long)local_b0 + lVar44 * 8) + 0x10) == lVar56)) {
...
LAB_00105dd3:
  if ((float)uVar55 * __LC51 < (float)(iVar42 + 1)) {
...
/* CowData<MultiplayerDebugger::BandwidthProfiler::BandwidthFrame>::_realloc(long) */

undefined8 __thiscall
CowData<MultiplayerDebugger::BandwidthProfiler::BandwidthFrame>::_realloc
          (CowData<MultiplayerDebugger::BandwidthProfiler::BandwidthFrame> *this,long param_1)
...
void __thiscall
CowData<MultiplayerDebugger::RPCNodeInfo>::_unref(CowData<MultiplayerDebugger::RPCNodeInfo> *this)
...
/* CowData<MultiplayerDebugger::RPCNodeInfo>::_realloc(long) */

undefined8 __thiscall
CowData<MultiplayerDebugger::RPCNodeInfo>::_realloc
          (CowData<MultiplayerDebugger::RPCNodeInfo> *this,long param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Error CowData<MultiplayerDebugger::RPCNodeInfo>::resize<false>(long) */

undefined8 __thiscall
CowData<MultiplayerDebugger::RPCNodeInfo>::resize<false>
          (CowData<MultiplayerDebugger::RPCNodeInfo> *this,long param_1)
      ...
      if (uVar31 != 0) {
        ...
        do {
          if ((uVar31 == (uint)uVar33) &&
             (*(long *)(*(long *)((long)__s_00 + lVar28 * 8) + 0x10) == local_b8)) {
          ...
          uVar21 = SUB164(auVar5 * auVar13,8);
                ...
                (auVar6._8_8_ = 0, auVar6._0_8_ = (ulong)uVar31 * lVar3, auVar14._8_8_ = 0,
                ...
                auVar15._0_8_ = uVar34, uVar32 <= SUB164(auVar7 * auVar15,8)));
      }
    }
  }
...

{
  ...
  uVar36 = *(uint *)(hash_table_size_primes + uVar31 * 4);
      ...
      if (uVar33 != 0) {
        ...
        do {
          ...
          uVar38 = SUB164(auVar5 * auVar17,8);
                ...
                auVar18._0_8_ = uVar42, auVar7._8_8_ = 0,
                auVar7._0_8_ = (ulong)((uVar38 + uVar36) - SUB164(auVar6 * auVar18,8)) * lVar2,
                auVar19._8_8_ = 0, auVar19._0_8_ = uVar42, uVar37 <= SUB164(auVar7 * auVar19,8)));
      }
      local_90 = 0;
      local_88 = (undefined1  [16])0x0;
LAB_00107247:
      uVar39 = CONCAT44(0,*(uint *)(hash_table_size_primes + uVar31 * 4));
      lVar2 = *(long *)(hash_table_size_primes_inv + uVar31 * 8);
      uVar29 = lVar44 * 0x3ffff - 1;
      uVar29 = (uVar29 ^ uVar29 >> 0x1f) * 0x15;
      uVar29 = (uVar29 ^ uVar29 >> 0xb) * 0x41;
      ...
      if (uVar36 != 0) {
        ...
        do {
          ...
          uVar33 = SUB164(auVar9 * auVar21,8);
                ...
                (auVar10._8_8_ = 0, auVar10._0_8_ = (ulong)uVar36 * lVar2, auVar22._8_8_ = 0,
                ...
                auVar23._0_8_ = uVar39, uVar38 <= SUB164(auVar11 * auVar23,8)));
      }
    }
  }
  ...
  *(undefined1 (*) [16])(pauVar30[2] + 8) = (undefined1  [16])0x0;
  *(undefined8 *)(pauVar30[1] + 8) = local_60;
  ...
  *(undefined1 (**) [16])(this + 0x20) = pauVar30;
  ...
  uVar31 = CONCAT44(0,uVar36);
  auVar12._8_8_ = 0;
  auVar12._0_8_ = uVar42 * lVar44;
  auVar24._8_8_ = 0;

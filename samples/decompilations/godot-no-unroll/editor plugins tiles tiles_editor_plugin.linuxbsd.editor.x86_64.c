...
::introsort(SortArray<List<int,DefaultAllocator>::Element*,List<int,DefaultAllocator>::AuxiliaryComparator<TilesEditorUtils::SourceNameComparator>,true>
            *this,long param_1,long param_2,Element **param_3,long param_4)

{
  ...
  if (param_4 != 0) {
    ...
    local_58 = param_2;
    local_50 = (Element **)param_4;
LAB_001093ed:
    local_50 = (Element **)((long)local_50 + -1);
    ppEVar4 = param_3 + (lVar8 >> 1) + param_1;
    cVar3 = TilesEditorUtils::SourceNameComparator::operator()((int *)this,(int *)*ppEVar11);
    if (cVar3 == '\0') {
      cVar3 = TilesEditorUtils::SourceNameComparator::operator()((int *)this,(int *)*ppEVar11);
      ppEVar9 = ppEVar11;
      if (cVar3 != '\0') goto LAB_00109457;
      cVar3 = TilesEditorUtils::SourceNameComparator::operator()((int *)this,(int *)*ppEVar4);
    }
    else {
      cVar3 = TilesEditorUtils::SourceNameComparator::operator()((int *)this,(int *)*ppEVar4);
      ppEVar9 = ppEVar4;
...
LAB_00109457:
    ...
    do {
      cVar3 = TilesEditorUtils::SourceNameComparator::operator()
                        ((int *)this,(int *)param_3[local_70]);
      if (cVar3 == '\0') {
LAB_001094a0:
        lVar8 = lVar8 + -1;
        ppEVar4 = param_3 + lVar8;
        while (cVar3 = TilesEditorUtils::SourceNameComparator::operator()((int *)this,(int *)pEVar1)
              , cVar3 != '\0') {
          if (param_1 == lVar8) {
        ...
        if (lVar8 <= local_70) goto LAB_0010953c;
        pEVar2 = param_3[local_70];
        param_3[local_70] = *ppEVar4;
        *ppEVar4 = pEVar2;
      }
      else if (local_58 + -1 == local_70) {
...
LAB_0010960d:
  ...
  do {
    ...
    if (lVar5 < lVar8) {
      do {
        cVar3 = TilesEditorUtils::SourceNameComparator::operator()
                          ((int *)this,(int *)param_3[param_1 + lVar5]);
        lVar7 = lVar5 + -1;
        lVar10 = lVar5;
        ppEVar11 = param_3 + param_1 + lVar5 + -1;
        if (cVar3 == '\0') {
          lVar10 = lVar5 + 1;
          lVar7 = lVar5;
          ppEVar11 = param_3 + param_1 + lVar5;
        }
        lVar5 = lVar10 * 2;
        param_3[local_78 + param_1] = *ppEVar11;
        local_78 = lVar7;
      } while (lVar5 < lVar8);
      ppEVar4 = ppEVar11;
      if (lVar5 == lVar8) {
LAB_00109909:
      ...
      lVar5 = lVar7 + -1 >> 1;
      if (lVar7 <= lVar6) goto LAB_0010995a;
      do {
        lVar10 = lVar5;
        ppEVar11 = param_3 + param_1 + lVar10;
        cVar3 = TilesEditorUtils::SourceNameComparator::operator()((int *)this,(int *)*ppEVar11);
        if (cVar3 == '\0') {
          param_3[lVar7 + param_1] = pEVar1;
          goto joined_r0x001097b0;
        }
        param_3[lVar7 + param_1] = *ppEVar11;
        lVar5 = (lVar10 + -1) / 2;
        lVar7 = lVar10;
      } while (lVar6 < lVar10);
      *ppEVar11 = pEVar1;
joined_r0x001097b0:
      ...
      ppEVar4 = local_50;
      ppEVar11 = local_50;
      if (lVar5 == lVar8) goto LAB_00109909;
LAB_0010995a:
      *ppEVar11 = pEVar1;
    }
    local_50 = local_50 + -1;
...
LAB_0010953c:
  introsort(this,local_70,local_58,param_3,(long)local_50);
  lVar8 = local_70 - param_1;
  if (lVar8 < 0x11) {
    return;
  }
  local_58 = local_70;
  if (local_50 == (Element **)0x0) goto LAB_0010960d;
  goto LAB_001093ed;
LAB_001097b2:
  ppEVar11 = param_3 + param_1;
  local_60 = (local_70 + -1) - param_1;
LAB_001097e0:
  do {
    pEVar1 = ppEVar11[local_60];
    ppEVar11[local_60] = *ppEVar11;
    if (local_60 < 3) {
      if (local_60 != 2) {
        *ppEVar11 = pEVar1;
        return;
      ...
      lVar8 = param_1 + 1;
      lVar6 = 0;
      *ppEVar11 = param_3[lVar8];
LAB_001098c7:
      while( true ) {
        ppEVar9 = param_3 + param_1 + lVar6;
        cVar3 = TilesEditorUtils::SourceNameComparator::operator()((int *)this,(int *)*ppEVar9);
        ppEVar4 = param_3 + lVar8;
        if (cVar3 == '\0') break;
        *ppEVar4 = *ppEVar9;
        if (lVar6 == 0) {
      ...
      do {
        cVar3 = TilesEditorUtils::SourceNameComparator::operator()
                          ((int *)this,(int *)param_3[param_1 + lVar8]);
        lVar5 = lVar8 + -1;
...

{
  ...
  if ((*(long *)this != 0) && (iVar1 = *(int *)(*(long *)this + 0x10), 1 < iVar1)) {
    ...
    SortArray<List<int,DefaultAllocator>::Element*,List<int,DefaultAllocator>::AuxiliaryComparator<TilesEditorUtils::SourceNameComparator>,true>
    ::introsort(&local_41,0,(long)pEVar4,__src,lVar5 * 2);
    if ((long)pEVar4 < 0x11) {
      pEVar9 = (Element *)0x1;
      do {
        while( true ) {
          pEVar8 = __src[(long)pEVar9];
          ppEVar6 = __src + (long)pEVar9;
          cVar3 = TilesEditorUtils::SourceNameComparator::operator()((int *)&local_41,(int *)pEVar8)
          ;
          if (cVar3 != '\0') break;
          while (cVar3 = TilesEditorUtils::SourceNameComparator::operator()
                                   ((int *)&local_41,(int *)pEVar8), cVar3 != '\0') {
            if (ppEVar6 == __src + 1) {
          ...
          *ppEVar6 = pEVar8;
          pEVar9 = pEVar9 + 1;
          pEVar8 = *__src;
          if (pEVar4 == pEVar9) goto LAB_00109bfe;
        }
        __n = (long)pEVar9 * 8;
        pEVar9 = pEVar9 + 1;
      ...
      do {
        while( true ) {
          lVar10 = lVar5;
          pEVar9 = __src[lVar10];
          cVar3 = TilesEditorUtils::SourceNameComparator::operator()((int *)&local_41,(int *)pEVar9)
          ;
          if (cVar3 != '\0') break;
          ppEVar6 = __src + lVar10;
          while (cVar3 = TilesEditorUtils::SourceNameComparator::operator()
                                   ((int *)&local_41,(int *)pEVar9), cVar3 != '\0') {
            if (__src == ppEVar6 + -1) {
              _err_print_error("unguarded_linear_insert","./core/templates/sort_array.h",0xff,
                               "bad comparison function; sorting will be broken",0,0);
              break;
...
LAB_00109bfe:
    ...
    *puVar2 = pEVar8;
    *(undefined8 *)(pEVar8 + 0x10) = 0;
    *(Element **)(*__src + 8) = __src[1];
    pEVar9 = __src[(long)(pEVar4 + -1)];
    puVar2[1] = pEVar9;
    *(Element **)(pEVar9 + 0x10) = __src[(long)(pEVar4 + -2)];
    *(undefined8 *)(__src[(long)(pEVar4 + -1)] + 8) = 0;
    if (iVar1 != 2) {
      ppEVar6 = __src;
      do {
        ppEVar7 = ppEVar6 + 1;
        *(Element **)(ppEVar6[1] + 0x10) = *ppEVar6;
        *(Element **)(*ppEVar7 + 8) = ppEVar6[2];
        ppEVar6 = ppEVar7;

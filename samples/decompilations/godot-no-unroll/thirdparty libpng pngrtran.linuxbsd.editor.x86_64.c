      ...
      *(byte *)((long)param_1 + 0x13) = bVar14;
      ...
      if (bVar5 == 0x10) {
        ...
        do {
          ...
          *(char *)(lVar18 + -3) = pcVar9[-1];
          *(char *)(lVar18 + -4) = pcVar9[-2];
          *(char *)(lVar18 + -5) = pcVar9[-3];
          *(char *)(lVar18 + -6) = pcVar9[-4];
          *(char *)(lVar18 + -7) = pcVar9[-5];
          pcVar9 = pcVar10;
          lVar18 = lVar18 + -8;
...
void png_set_alpha_mode(double param_1,long param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if ((double)((ulong)param_1 & _LC21) < _LC15) {
    param_1 = (double)((ulong)((double)(long)param_1 -
                              (double)(-(ulong)(param_1 < (double)(long)param_1) & _LC17)) |
                      ~_LC21 & (ulong)param_1);
  }
  ...
  *(ulong *)(param_2 + 0x130) = _LC22 | *(ulong *)(param_2 + 0x130);
  if (param_7 == 0) {
    lVar20 = png_malloc();
    *(long *)(param_2 + 0x380) = lVar20;
    lVar32 = 0;
    if (0 < (int)uVar31) {
      do {
        *(char *)(lVar20 + lVar32) = (char)lVar32;
        lVar32 = lVar32 + 1;
      } while ((int)uVar31 != lVar32);
    }
    if ((int)uVar31 <= (int)uVar29) {
      if (*(long *)(param_2 + 0x250) != 0) {
        *(short *)(param_2 + 600) = (short)uVar14;
        return;
      }
      *(char **)(param_2 + 0x250) = pcVar27;
      *(short *)(param_2 + 600) = (short)uVar14;
      return;
    }
  }
  else if ((int)uVar31 <= (int)uVar29) {
    if (*(long *)(param_2 + 0x250) == 0) {
      *(char **)(param_2 + 0x250) = pcVar27;
  ...
  lStack_98 = (long)(int)uVar31;
  if (param_6 == 0) {
    uVar10 = png_malloc(param_2,lStack_98);
    *(undefined8 *)(param_2 + 0x410) = uVar10;
    lVar20 = png_malloc(param_2,lStack_98);
    *(long *)(param_2 + 0x418) = lVar20;
    if (0 < (int)uVar31) {
      lVar32 = *(long *)(param_2 + 0x410);
      lVar11 = 0;
      do {
        *(char *)(lVar32 + lVar11) = (char)lVar11;
        *(char *)(lVar20 + lVar11) = (char)lVar11;
        lVar11 = lVar11 + 1;
      } while (lVar11 != lStack_98);
    }
    plVar12 = (long *)png_calloc(param_2,0x1808);
    if ((int)uVar29 < (int)uVar31) {
      plVar37 = plVar12 + 0x61;
      plVar13 = (long *)0x0;
      iStack_88 = 0x60;
      uVar36 = uVar31;
      do {
            ...
            if ((int)uVar15 < (int)uVar36) {
              do {
                while( true ) {
                  ...
                  iVar23 = (uint)pbVar9[1] - (uint)pbVar16[1];
                  iVar30 = -iVar23;
                  if (0 < iVar23) {
                    iVar30 = iVar23;
                  }
                  iVar25 = (uint)pbVar9[2] - (uint)pbVar16[2];
                  iVar23 = -iVar25;
                  if (0 < iVar25) {
                    iVar23 = iVar25;
                  }
                  iVar23 = iVar7 + iVar30 + iVar23;
                  if (iStack_88 < iVar23) break;
                  plVar13 = (long *)png_malloc_warn(param_2,0x10);
                  if (plVar13 == (long *)0x0) goto LAB_001016f7;
                  lVar20 = plVar12[iVar23];
                  *(char *)((long)plVar13 + 9) = (char)uVar26;
                  uVar26 = uVar26 + 1;
                  *(char *)(plVar13 + 1) = (char)uVar8;
                  *plVar13 = lVar20;
                  plVar12[iVar23] = (long)plVar13;
                  pbVar16 = pbVar16 + 3;
                  if (uVar26 == uVar36) goto LAB_001015c7;
                }
                uVar26 = uVar26 + 1;
                pbVar16 = pbVar16 + 3;
              } while (uVar26 != uVar36);
...
LAB_001016f7:
          ...
          do {
            ...
            if (plVar24 != (long *)0x0) {
              lVar20 = *(long *)(param_2 + 0x410);
              do {
                uVar14 = (ulong)*(byte *)(plVar24 + 1);
                pbVar9 = (byte *)(uVar14 + lVar20);
                bVar28 = *pbVar9;
                if ((int)(uint)bVar28 < (int)uVar36) {
                  uVar8 = (uint)*(byte *)((long)plVar24 + 9);
                  uVar17 = (ulong)uVar8;
                  pbVar16 = (byte *)(lVar20 + uVar17);
                  bVar1 = *pbVar16;
                  if ((int)(uint)bVar1 < (int)uVar36) {
                    if ((uVar36 & 1) == 0) {
                      uVar8 = (uint)*(byte *)(plVar24 + 1);
                      pbVar9 = pbVar16;
                      uVar14 = uVar17;
                      bVar28 = bVar1;
                    }
                    uVar36 = uVar36 - 1;
                    *(undefined2 *)((byte *)pcVar27 + (ulong)bVar28 * 3) =
                         *(undefined2 *)((byte *)pcVar27 + (long)(int)uVar36 * 3);
                    ((byte *)pcVar27 + (ulong)bVar28 * 3)[2] =
                         ((byte *)pcVar27 + (long)(int)uVar36 * 3)[2];
                    uVar17 = (ulong)*pbVar9;
                    if ((param_7 == 0) && (0 < (int)uVar31)) {
                      pbVar16 = *(byte **)(param_2 + 0x380);
                      pbVar21 = pbVar16 + lStack_98;
                      do {
                        bVar28 = *pbVar16;
                        if (bVar28 == (byte)uVar17) {
                          bVar28 = *(byte *)(lVar20 + (int)uVar8);
                          *pbVar16 = bVar28;
                          uVar17 = (ulong)*pbVar9;
                        }
                        if (bVar28 == uVar36) {
                    ...
                    pbVar16 = (byte *)((int)uVar36 + lVar32);
                    *(char *)(lVar20 + (ulong)*pbVar16) = (char)uVar17;
                    *(byte *)(lVar32 + uVar17) = *pbVar16;
                    *pbVar9 = (byte)uVar36;
                    *pbVar16 = (byte)uVar14;
                  }
                }
                if ((int)uVar36 <= (int)uVar29) goto LAB_001016f9;
...
LAB_001016f9:
        ...
        do {
          ...
          *plVar22 = 0;
          plVar22 = plVar22 + 1;
        } while (plVar22 != plVar12 + 0x301);
        iStack_88 = iStack_88 + 0x60;
        plVar37 = plVar37 + 0x60;
      } while ((int)uVar29 < (int)uVar36);
    }
    uVar31 = uVar29;
    png_free(param_2,plVar12);
    ...
    *(undefined1 (*) [16])(param_2 + 0x410) = (undefined1  [16])0x0;
    ...
    pbVar9 = (byte *)png_malloc(param_2,lStack_98);
    *(byte **)(param_2 + 0x408) = pbVar9;
    iVar7 = uVar31 - 1;
    if ((int)uVar31 < 1) {
      if ((int)uVar29 <= iVar7) goto LAB_00100f46;
      if (param_7 == 0) {
        if ((int)uVar29 < 1) goto LAB_00101013;
        goto LAB_001012aa;
      }
LAB_00101832:
      if (0 < (int)uVar29) goto LAB_00100fb3;
    }
    else {
      lVar20 = 0;
      do {
        pbVar9[lVar20] = (byte)lVar20;
        lVar20 = lVar20 + 1;
      } while (lVar20 != lStack_98);
      if ((int)uVar29 <= iVar7) {
LAB_00100f46:
        pbVar16 = pbVar9 + iVar7;
        do {
          if (iVar7 < 1) {
LAB_00101297:
            if (param_7 != 0) goto LAB_00101832;
            if (0 < (int)uVar29) goto LAB_001012aa;
            goto LAB_00101327;
          }
          bVar6 = true;
          pbVar21 = pbVar9;
          do {
            if (*(ushort *)(param_6 + (ulong)*pbVar21 * 2) <
                *(ushort *)(param_6 + (ulong)pbVar21[1] * 2)) {
              *(ushort *)pbVar21 = CONCAT11(*pbVar21,pbVar21[1]);
              bVar6 = false;
            }
            pbVar21 = pbVar21 + 1;
          } while (pbVar16 != pbVar21);
          if (bVar6) goto LAB_00101297;
          iVar7 = iVar7 + -1;
          pbVar16 = pbVar16 + -1;
...
LAB_001012aa:
        lVar20 = 0;
        pbVar16 = (byte *)pcVar27;
        do {
          while ((int)uVar29 <= (int)(uint)pbVar9[lVar20]) {
            uVar14 = (long)((int)uVar14 + -1);
            do {
              uVar17 = uVar14;
              uVar14 = uVar17 - 1;
            } while ((int)uVar29 <= (int)(uint)pbVar9[uVar17]);
            uVar14 = uVar17 & 0xffffffff;
            pbVar21 = (byte *)pcVar27 + uVar17 * 3;
            ...
            *(undefined2 *)pbVar16 = uVar3;
            pbVar16[2] = bVar28;
            *(char *)(lVar32 + uVar17) = (char)lVar20;
            *(char *)(lVar32 + lVar20) = (char)uVar17;
            lVar20 = lVar20 + 1;
            pbVar16 = pbVar16 + 3;
            if ((int)uVar29 <= (int)lVar20) goto LAB_00101327;
          }
          lVar20 = lVar20 + 1;
          pbVar16 = pbVar16 + 3;
        } while ((int)lVar20 < (int)uVar29);
LAB_00101327:
        if (0 < (int)uVar31) {
          pbVar9 = *(byte **)(param_2 + 0x380);
          pbVar16 = pbVar9 + lStack_98;
          do {
            if ((int)uVar29 <= (int)(uint)*pbVar9) {
              pbVar21 = (byte *)pcVar27 + (ulong)*pbVar9 * 3;
              iVar30 = (uint)*pbVar21 - (uint)(byte)*pcVar27;
              iVar7 = -iVar30;
              if (0 < iVar30) {
                iVar7 = iVar30;
              }
              iVar23 = (uint)pbVar21[1] - (uint)((byte *)pcVar27)[1];
              iVar30 = -iVar23;
              if (0 < iVar23) {
                iVar30 = iVar23;
              }
              iVar25 = (uint)pbVar21[2] - (uint)((byte *)pcVar27)[2];
              iVar23 = -iVar25;
              if (0 < iVar25) {
                iVar23 = iVar25;
              }
              ...
              if ((int)uVar29 < 2) {
                ...
                do {
                  ...
                  iVar35 = (uint)pbVar21[2] - (uint)pbVar4[5];
                  iVar25 = -iVar35;
                  if (0 < iVar35) {
                    iVar25 = iVar35;
                  }
...
LAB_00100fb3:
        pbVar16 = pbVar9;
        pbVar21 = (byte *)pcVar27;
        do {
          while ((int)uVar29 <= (int)(uint)*pbVar16) {
            uVar14 = (long)((int)uVar14 + -1);
            do {
              uVar17 = uVar14;
              uVar14 = uVar17 - 1;
            ...
            uVar14 = uVar17 & 0xffffffff;
            pbVar16 = pbVar16 + 1;
            *(undefined2 *)pbVar21 = *(undefined2 *)((byte *)pcVar27 + uVar17 * 3);
            pbVar21[2] = ((byte *)pcVar27 + uVar17 * 3)[2];
            pbVar21 = pbVar21 + 3;
            if (pbVar16 == pbVar9 + (int)uVar29) goto LAB_00101013;
          }
          pbVar16 = pbVar16 + 1;
          pbVar21 = pbVar21 + 3;
        } while (pbVar16 != pbVar9 + (int)uVar29);
      }
    }
LAB_00101013:
    png_free(param_2);
  ...
  *(short *)(param_2 + 600) = (short)uVar31;
  if (param_7 == 0) {
    return;
  }
LAB_00101131:
  uVar10 = png_calloc(param_2,0x8000);
  *(undefined8 *)(param_2 + 0x378) = uVar10;
  ...
  if (0 < (int)uVar31) {
    ...
    while( true ) {
      bVar28 = *pcVar27;
      bVar1 = ((byte *)pcVar27)[2];
      bVar2 = ((byte *)pcVar27)[1];
      iVar7 = -(uint)(bVar28 >> 3);
      lVar20 = 0;
      while( true ) {
        iVar30 = -iVar7;
        if ((int)(uint)(bVar28 >> 3) < (int)lVar20) {
          iVar30 = iVar7;
        }
        iVar25 = -(uint)(bVar2 >> 3);
        iVar23 = 0;
        ...
        while( true ) {
          ...
          while( true ) {
            iVar19 = -iVar33;
            if ((int)(uint)(bVar1 >> 3) < (int)uVar26) {
              iVar19 = iVar33;
            }
            iVar18 = iVar5;
            if (iVar5 <= iVar19) {
            ...
            iVar19 = iVar18 + iVar30 + iVar35 + iVar19;
            if (iVar19 < (int)uVar29) {
              lVar32 = (long)(int)(uVar34 | uVar26);
              pbVar9[lVar32] = (byte)iVar19;
              *(char *)(*(long *)(param_2 + 0x378) + lVar32) = (char)uVar36;
            }
            uVar26 = uVar26 + 1;
            iVar33 = iVar33 + 1;
            if (uVar26 == 0x20) break;
            uVar29 = (uint)pbVar9[(int)(uVar34 | uVar26)];
          }
          iVar25 = iVar25 + 1;
          iVar23 = iVar23 + 1;
        ...
        lVar20 = lVar20 + 1;
        iVar7 = iVar7 + 1;
        if (lVar20 == 0x20) break;
        uVar29 = (uint)pbVar9[lVar20 * 0x400];
      }
      uVar36 = uVar36 + 1;
      pcVar27 = (char *)((byte *)pcVar27 + 3);
...

{
  ...
  *(ulong *)(param_1 + 0x130) = _LC22 | *(ulong *)(param_1 + 0x130);
  if (param_6 == 0) {
    lVar19 = png_malloc(param_1,(long)(int)uVar29);
    *(long *)(param_1 + 0x380) = lVar19;
    lVar30 = 0;
    if (0 < (int)uVar29) {
      do {
        *(char *)(lVar19 + lVar30) = (char)lVar30;
        lVar30 = lVar30 + 1;
      } while ((int)uVar29 != lVar30);
    }
    if ((int)uVar29 <= (int)param_4) {
      if (*(long *)(param_1 + 0x250) != 0) {
        *(short *)(param_1 + 600) = (short)uVar13;
        return;
      }
  ...
  else if ((int)uVar29 <= (int)param_4) {
    if (*(long *)(param_1 + 0x250) == 0) {
      *(byte **)(param_1 + 0x250) = param_2;
  ...
  local_90 = (long)(int)uVar29;
  if (param_5 == 0) {
    uVar9 = png_malloc(param_1,local_90);
    *(undefined8 *)(param_1 + 0x410) = uVar9;
    lVar19 = png_malloc(param_1,local_90);
    *(long *)(param_1 + 0x418) = lVar19;
    if (0 < (int)uVar29) {
      lVar30 = *(long *)(param_1 + 0x410);
      lVar10 = 0;
      do {
        *(char *)(lVar30 + lVar10) = (char)lVar10;
        *(char *)(lVar19 + lVar10) = (char)lVar10;
        lVar10 = lVar10 + 1;
      } while (lVar10 != local_90);
    }
    plVar11 = (long *)png_calloc(param_1,0x1808);
    if ((int)param_4 < (int)uVar29) {
      plVar37 = plVar11 + 0x61;
      plVar12 = (long *)0x0;
      local_80 = 0x60;
      uVar27 = uVar29;
      do {
        ...
        if (0 < (int)(uVar27 - 1)) {
          do {
            ...
            if ((int)uVar7 < (int)uVar27) {
              do {
                while( true ) {
                  iVar28 = (uint)pbVar8[-3] - (uint)*pbVar15;
                  iVar6 = -iVar28;
                  if (0 < iVar28) {
                    iVar6 = iVar28;
                  }
                  iVar22 = (uint)pbVar8[-2] - (uint)pbVar15[1];
                  iVar28 = -iVar22;
                  if (0 < iVar22) {
                    iVar28 = iVar22;
                  }
                  iVar23 = (uint)pbVar8[-1] - (uint)pbVar15[2];
                  iVar22 = -iVar23;
                  if (0 < iVar23) {
                    iVar22 = iVar23;
                  }
                  iVar22 = iVar6 + iVar28 + iVar22;
                  if (local_80 < iVar22) break;
                  plVar12 = (long *)png_malloc_warn(param_1,0x10);
                  if (plVar12 == (long *)0x0) goto LAB_001016f7;
                  lVar19 = plVar11[iVar22];
                  *(char *)((long)plVar12 + 9) = (char)uVar14;
                  uVar14 = uVar14 + 1;
                  *(char *)(plVar12 + 1) = (char)uVar36;
                  *plVar12 = lVar19;
                  plVar11[iVar22] = (long)plVar12;
                  pbVar15 = pbVar15 + 3;
                  if (uVar14 == uVar27) goto LAB_001015c7;
                }
                uVar14 = uVar14 + 1;
                pbVar15 = pbVar15 + 3;
              } while (uVar14 != uVar27);
...
LAB_001016f7:
          ...
          do {
            plVar33 = (long *)*plVar21;
            if (plVar33 != (long *)0x0) {
              lVar19 = *(long *)(param_1 + 0x410);
              do {
                uVar13 = (ulong)*(byte *)(plVar33 + 1);
                pbVar8 = (byte *)(uVar13 + lVar19);
                bVar26 = *pbVar8;
                if ((int)(uint)bVar26 < (int)uVar27) {
                  uVar36 = (uint)*(byte *)((long)plVar33 + 9);
                  uVar16 = (ulong)uVar36;
                  pbVar15 = (byte *)(lVar19 + uVar16);
                  bVar1 = *pbVar15;
                  if ((int)(uint)bVar1 < (int)uVar27) {
                    if ((uVar27 & 1) == 0) {
                      uVar36 = (uint)*(byte *)(plVar33 + 1);
                      pbVar8 = pbVar15;
                      uVar13 = uVar16;
                      bVar26 = bVar1;
                    }
                    uVar27 = uVar27 - 1;
                    *(undefined2 *)(param_2 + (ulong)bVar26 * 3) =
                         *(undefined2 *)(param_2 + (long)(int)uVar27 * 3);
                    (param_2 + (ulong)bVar26 * 3)[2] = (param_2 + (long)(int)uVar27 * 3)[2];
                    uVar16 = (ulong)*pbVar8;
                    if ((param_6 == 0) && (0 < (int)uVar29)) {
                      pbVar15 = *(byte **)(param_1 + 0x380);
                      pbVar20 = pbVar15 + local_90;
                      do {
                        bVar26 = *pbVar15;
                        if (bVar26 == (byte)uVar16) {
                          bVar26 = *(byte *)(lVar19 + (int)uVar36);
                          *pbVar15 = bVar26;
                          uVar16 = (ulong)*pbVar8;
                        }
                        if (bVar26 == uVar27) {
                    ...
                    lVar30 = *(long *)(param_1 + 0x418);
                    pbVar15 = (byte *)((int)uVar27 + lVar30);
                    *(char *)(lVar19 + (ulong)*pbVar15) = (char)uVar16;
                    *(byte *)(lVar30 + uVar16) = *pbVar15;
                    *pbVar8 = (byte)uVar27;
                    *pbVar15 = (byte)uVar13;
                  }
                }
                if ((int)uVar27 <= (int)param_4) goto LAB_00101725;
...
LAB_00101725:
        do {
          ...
          *plVar24 = 0;
          plVar24 = plVar24 + 1;
        } while (plVar24 != plVar11 + 0x301);
        local_80 = local_80 + 0x60;
        plVar37 = plVar37 + 0x60;
      } while ((int)param_4 < (int)uVar27);
    }
    png_free(param_1,plVar11);
    ...
    *(undefined1 (*) [16])(param_1 + 0x410) = (undefined1  [16])0x0;
    ...
    pbVar8 = (byte *)png_malloc(param_1,local_90);
    *(byte **)(param_1 + 0x408) = pbVar8;
    iVar6 = uVar29 - 1;
    if ((int)uVar29 < 1) {
      if ((int)param_4 <= iVar6) goto LAB_00100f46;
      if (param_6 == 0) {
        if ((int)param_4 < 1) goto LAB_00101013;
        goto LAB_001012aa;
      }
LAB_00101832:
      if (0 < (int)param_4) goto LAB_00100fb3;
    }
    else {
      lVar19 = 0;
      do {
        pbVar8[lVar19] = (byte)lVar19;
        lVar19 = lVar19 + 1;
      } while (lVar19 != local_90);
      if ((int)param_4 <= iVar6) {
LAB_00100f46:
        pbVar15 = pbVar8 + iVar6;
        do {
          if (iVar6 < 1) {
LAB_00101297:
            if (param_6 != 0) goto LAB_00101832;
            if (0 < (int)param_4) goto LAB_001012aa;
            goto LAB_00101327;
          }
          bVar5 = true;
          pbVar20 = pbVar8;
          do {
            if (*(ushort *)(param_5 + (ulong)*pbVar20 * 2) <
                *(ushort *)(param_5 + (ulong)pbVar20[1] * 2)) {
              *(ushort *)pbVar20 = CONCAT11(*pbVar20,pbVar20[1]);
              bVar5 = false;
            }
            pbVar20 = pbVar20 + 1;
          } while (pbVar15 != pbVar20);
          if (bVar5) goto LAB_00101297;
          iVar6 = iVar6 + -1;
          pbVar15 = pbVar15 + -1;
...
LAB_001012aa:
        ...
        pbVar15 = param_2;
        do {
          while ((int)param_4 <= (int)(uint)pbVar8[lVar19]) {
            uVar13 = (long)((int)uVar13 + -1);
            do {
              uVar16 = uVar13;
              uVar13 = uVar16 - 1;
            } while ((int)param_4 <= (int)(uint)pbVar8[uVar16]);
            uVar13 = uVar16 & 0xffffffff;
            pbVar20 = param_2 + uVar16 * 3;
            uVar3 = *(undefined2 *)pbVar20;
            bVar26 = pbVar20[2];
            *(undefined2 *)pbVar20 = *(undefined2 *)pbVar15;
            pbVar20[2] = pbVar15[2];
            lVar30 = *(long *)(param_1 + 0x380);
            *(undefined2 *)pbVar15 = uVar3;
            pbVar15[2] = bVar26;
            *(char *)(lVar30 + uVar16) = (char)lVar19;
            *(char *)(lVar30 + lVar19) = (char)uVar16;
            lVar19 = lVar19 + 1;
            pbVar15 = pbVar15 + 3;
            if ((int)param_4 <= (int)lVar19) goto LAB_00101327;
          }
          lVar19 = lVar19 + 1;
          pbVar15 = pbVar15 + 3;
        } while ((int)lVar19 < (int)param_4);
LAB_00101327:
        if (0 < (int)uVar29) {
          pbVar8 = *(byte **)(param_1 + 0x380);
          pbVar15 = pbVar8 + local_90;
          do {
            if ((int)param_4 <= (int)(uint)*pbVar8) {
              pbVar20 = param_2 + (ulong)*pbVar8 * 3;
              iVar28 = (uint)*pbVar20 - (uint)*param_2;
              iVar6 = -iVar28;
              if (0 < iVar28) {
                iVar6 = iVar28;
              }
              iVar22 = (uint)pbVar20[1] - (uint)param_2[1];
              iVar28 = -iVar22;
              if (0 < iVar22) {
                iVar28 = iVar22;
              }
              iVar23 = (uint)pbVar20[2] - (uint)param_2[2];
              iVar22 = -iVar23;
              if (0 < iVar23) {
                iVar22 = iVar23;
              }
              ...
              if ((int)param_4 < 2) {
                ...
                uVar27 = 1;
                do {
                  iVar28 = (uint)pbVar20[1] - (uint)pbVar32[1];
                  iVar6 = -iVar28;
                  if (0 < iVar28) {
                    iVar6 = iVar28;
                  }
                  iVar23 = (uint)*pbVar20 - (uint)*pbVar32;
                  iVar28 = -iVar23;
                  if (0 < iVar23) {
                    iVar28 = iVar23;
                  }
                  iVar35 = (uint)pbVar20[2] - (uint)pbVar32[2];
                  iVar23 = -iVar35;
                  if (0 < iVar35) {
                    iVar23 = iVar35;
                  }
                  iVar23 = iVar6 + iVar28 + iVar23;
                  if (iVar23 < iVar22) {
                    iVar22 = iVar23;
                    uVar29 = uVar27;
                  }
...
LAB_00100fb3:
        ...
        pbVar20 = param_2;
        do {
          while ((int)param_4 <= (int)(uint)*pbVar15) {
            uVar13 = (long)((int)uVar13 + -1);
            do {
              uVar16 = uVar13;
              uVar13 = uVar16 - 1;
            ...
            uVar13 = uVar16 & 0xffffffff;
            pbVar15 = pbVar15 + 1;
            *(undefined2 *)pbVar20 = *(undefined2 *)(param_2 + uVar16 * 3);
            pbVar20[2] = (param_2 + uVar16 * 3)[2];
            pbVar20 = pbVar20 + 3;
            if (pbVar15 == pbVar8 + (int)param_4) goto LAB_00101013;
          }
          pbVar15 = pbVar15 + 1;
          pbVar20 = pbVar20 + 3;
        } while (pbVar15 != pbVar8 + (int)param_4);
      }
    }
LAB_00101013:
    png_free(param_1);
...
LAB_00101131:
  uVar9 = png_calloc(param_1,0x8000);
  *(undefined8 *)(param_1 + 0x378) = uVar9;
  pbVar8 = (byte *)png_malloc(param_1,0x8000);
  memset(pbVar8,0xff,0x8000);
  if (0 < (int)uVar29) {
    uVar27 = 0xff;
    uVar36 = 0;
    while( true ) {
      ...
      while( true ) {
        iVar28 = -iVar6;
        if ((int)(uint)(bVar26 >> 3) < (int)lVar19) {
          iVar28 = iVar6;
        }
        iVar23 = -(uint)(bVar2 >> 3);
        iVar22 = 0;
        ...
        while( true ) {
          ...
          while( true ) {
            iVar18 = -iVar31;
            if ((int)(uint)(bVar1 >> 3) < (int)uVar25) {
              iVar18 = iVar31;
            }
            iVar17 = iVar4;
            if (iVar4 <= iVar18) {
            ...
            iVar18 = iVar17 + iVar28 + iVar35 + iVar18;
            if (iVar18 < (int)uVar27) {
              lVar30 = (long)(int)(uVar34 | uVar25);
              pbVar8[lVar30] = (byte)iVar18;
              *(char *)(*(long *)(param_1 + 0x378) + lVar30) = (char)uVar36;
            }
            uVar25 = uVar25 + 1;
            iVar31 = iVar31 + 1;
            if (uVar25 == 0x20) break;
            uVar27 = (uint)pbVar8[(int)(uVar34 | uVar25)];
          }
          iVar23 = iVar23 + 1;
          iVar22 = iVar22 + 1;
          if (iVar22 == 0x20) break;
          uVar27 = (uint)pbVar8[(int)(uVar14 + 0x20 | uVar7)];
        }
        lVar19 = lVar19 + 1;
        iVar6 = iVar6 + 1;
        if (lVar19 == 0x20) break;
        uVar27 = (uint)pbVar8[lVar19 * 0x400];
      }
      uVar36 = uVar36 + 1;
      param_2 = param_2 + 3;
...
void png_set_gamma(double param_1,double param_2,long param_3,undefined8 param_4,int param_5)

{
  ...
  if ((double)((ulong)param_2 & _LC21) < _LC15) {
    param_2 = (double)((ulong)((double)(long)param_2 -
                              (double)(-(ulong)(param_2 < (double)(long)param_2) & _LC17)) |
                      ~_LC21 & (ulong)param_2);
  }
...
LAB_00101e78:
    ...
    *(uint *)(param_1 + 0x134) = uVar25;
    ...
    if ((iVar16 != 0) && (iVar16 = png_gamma_significant(local_44), iVar16 == 0)) {
      *(ushort *)(param_1 + 0x4ea) = *(ushort *)(param_1 + 0x4ea) | 1;
      goto LAB_00101e78;
    }
  ...
  if ((uVar25 & 0x100) == 0) {
    if ((((~uVar25 & 0x4080) == 0) &&
        (sVar27 = *(short *)(param_1 + 0x27e), sVar27 == *(short *)(param_1 + 0x280))) &&
       (sVar27 == *(short *)(param_1 + 0x282))) {
...
LAB_0010261a:
    ...
    *(uint *)(param_1 + 0x134) = uVar28;
LAB_00102041:
    if ((((uVar28 & 0x4000400) != 0) && ((uVar28 & 0x180) == 0x80)) &&
      ...
      *(ulong *)(param_1 + 0x27e) =
           CONCAT26(auVar34._6_2_ + (short)(uVar1 >> 0x30),
                    CONCAT24(auVar34._4_2_ + (short)(uVar1 >> 0x20),
                             CONCAT22(auVar34._2_2_ + (short)(uVar1 >> 0x10),
                                      auVar34._0_2_ + (short)uVar1)));
    }
  }
  else {
    if ((bVar12 & 4) != 0) {
LAB_00102022:
      if (((~uVar28 & 0x1100) == 0) && ((bVar12 & 2) == 0)) {
...
LAB_0010202f:
      if (((uVar28 & 0x380) == 0x280) && (*(char *)(param_1 + 0x268) != '\x10')) {
        *(ulong *)(param_1 + 0x27e) =
             ((ulong)(((uint)*(ushort *)(param_1 + 0x284) * 0x100 -
                      (uint)*(ushort *)(param_1 + 0x284)) + 0x807f & 0xffff0000 |
                     (uint)*(ushort *)(param_1 + 0x282) * 0xff + 0x807f >> 0x10) << 0x10 |
             (ulong)(((uint)*(ushort *)(param_1 + 0x280) * 0x100 -
                     (uint)*(ushort *)(param_1 + 0x280)) + 0x807f >> 0x10)) << 0x10 |
             (ulong)((uint)*(ushort *)(param_1 + 0x27e) * 0xff + 0x807f >> 0x10);
      }
      goto LAB_00102041;
    }
    *(uint *)(param_1 + 0x130) = *(uint *)(param_1 + 0x130) & 0xffffdfff;
  ...
  *(undefined2 *)(param_1 + 0x28e) = *(undefined2 *)(param_1 + 0x284);
  if ((uVar28 & 0x2000) == 0) {
    if ((uVar28 & 0x600000) != 0) {
      ...
      if ((iVar16 != 0) ||
         (iVar16 = png_gamma_significant(*(undefined4 *)(param_1 + 0x2a4)), iVar16 != 0))
      goto LAB_001021e8;
      uVar28 = *(uint *)(param_1 + 0x134);
    }
    if ((uVar28 & 0x80) == 0) {
...
LAB_001020a1:
      iVar16 = png_gamma_significant(*(undefined4 *)(param_1 + 0x2a4));
      ...
      if (((iVar16 != 0) ||
          (iVar16 = png_gamma_significant(*(undefined4 *)(param_1 + 0x2a4)), iVar16 != 0)) ||
         ((*(char *)(param_1 + 0x274) == '\x03' &&
          (iVar16 = png_gamma_significant(*(undefined4 *)(param_1 + 0x278)), iVar16 != 0))))
      goto LAB_001021e8;
      uVar28 = *(uint *)(param_1 + 0x134);
        ...
        while( true ) {
          ...
          if (bVar9 == 0) {
            *pbVar23 = bVar12;
            ...
            uVar25 = (ushort)((ushort)bVar9 * (ushort)*pbVar23) + 0x80 +
                     (0xff - (uint)bVar9) * (uint)bVar12;
            *pbVar23 = (byte)(uVar25 + (uVar25 >> 8 & 0xff) >> 8);
            uVar25 = (0xff - (uint)*pbVar30) * (uint)bVar8 + 0x80 +
                     (uint)(ushort)((ushort)*pbVar30 * (ushort)pbVar23[1]);
            pbVar23[1] = (byte)(uVar25 + (uVar25 >> 8 & 0xff) >> 8);
            uVar25 = (ushort)((0xff - (ushort)*pbVar30) * (uVar26 & 0xff)) + 0x80 +
                     (uint)(ushort)((ushort)*pbVar30 * (ushort)pbVar23[2]);
...
LAB_00102292:
    if (((uVar28 & 0x1008) != 8) || (*(char *)(param_1 + 0x267) != '\x03')) goto LAB_001022a2;
  }
  else {
LAB_001021e8:
    png_build_gamma_table(param_1,*(undefined1 *)(param_1 + 0x268));
    uVar28 = *(uint *)(param_1 + 0x134);
    if ((uVar28 & 0x80) != 0) {
      if ((uVar28 & 0x600000) != 0) {
      ...
      if (*(char *)(param_1 + 0x267) == '\x03') {
        ...
        if (cVar2 == '\x02') {
          ...
          if (cVar2 == '\x01') {
            ...
            uVar18 = png_reciprocal2(*(undefined4 *)(param_1 + 0x278),
              ...
              if (bVar7 != 0xff) {
                if (bVar7 == 0) {
                  *pbVar23 = bVar11;
                  ...
                  uVar25 = (ushort)((ushort)bVar7 * (ushort)*(byte *)(lVar4 + (ulong)*pbVar23)) +
                           0x80 + (uint)(ushort)((0xff - (ushort)bVar7) * (ushort)bVar8);
                  lVar5 = *(long *)(param_1 + 0x2b8);
                  *pbVar23 = *(byte *)(lVar5 + (ulong)(uVar25 + (uVar25 >> 8 & 0xff) >> 8 & 0xff));
                  uVar25 = (ushort)((ushort)*pbVar20 * (ushort)*(byte *)(lVar4 + (ulong)pbVar23[1]))
                           + 0x80 + (uint)(ushort)((0xff - (ushort)*pbVar20) * (ushort)bVar9);
                  pbVar23[1] = *(byte *)(lVar5 + (ulong)(uVar25 + (uVar25 >> 8 & 0xff) >> 8 & 0xff))
                  ;
                  uVar25 = (ushort)((ushort)*pbVar20 * (ushort)*(byte *)(lVar4 + (ulong)pbVar23[2]))
                           + 0x80 + (0xff - (uint)*pbVar20) * (uint)bVar10;
      ...
      if (iVar16 == 0) {
        if (iVar17 == 0) {
          ...
          *(short *)(param_1 + 0x284) = (short)uVar25;
          if (((sVar27 != *(short *)(param_1 + 0x280)) || (*(short *)(param_1 + 0x282) != sVar27))
             || (*(short *)(param_1 + 0x284) != sVar27)) goto LAB_00102a1b;
          auVar34 = pshuflw(auVar33,ZEXT416(uVar25),0);
          uVar15 = auVar34._0_4_;
LAB_00102ae8:
          *(undefined4 *)(param_1 + 0x27e) = uVar15;
        ...
        *(undefined2 *)(param_1 + 0x28e) = uVar14;
        if (iVar17 == 0) {
          ...
          if (((*(ushort *)(param_1 + 0x27e) == uVar3) &&
              (uVar26 = uVar3, uVar3 == *(ushort *)(param_1 + 0x282))) &&
             (uVar26 = *(ushort *)(param_1 + 0x282), uVar3 == *(ushort *)(param_1 + 0x284))) {
LAB_00102dc7:
            auVar34 = pshuflw(auVar32,ZEXT416(uVar25),0);
            uVar15 = auVar34._0_4_;
            goto LAB_00102ae8;
          }
        }
          ...
          uVar26 = *(ushort *)(param_1 + 0x27e);
          *(short *)(param_1 + 0x284) = (short)uVar25;
          if (((uVar26 == *(ushort *)(param_1 + 0x280)) && (*(ushort *)(param_1 + 0x282) == uVar26))
             && (*(ushort *)(param_1 + 0x284) == uVar26)) goto LAB_00102dc7;
        }
        ...
        *(undefined2 *)(param_1 + 0x28c) = uVar14;
        if (iVar17 != 0) {
          sVar27 = *(short *)(param_1 + 0x27e);
LAB_00102a1b:
          uVar14 = png_gamma_correct(param_1,sVar27,uVar18);
...
LAB_001022f0:
    if ((uVar28 & 0x1008) != 8) goto LAB_001022a2;
  }
  bVar12 = *(byte *)(param_1 + 0x2d9);
  uVar26 = *(ushort *)(param_1 + 600);
  *(uint *)(param_1 + 0x134) = uVar28 & 0xfffffff7;
  bVar8 = *(byte *)(param_1 + 0x2d8);
  uVar25 = 7 - bVar12;
  if (7 - bVar8 < 7) {
    ...
    while (pbVar30 = pbVar20, *pbVar21 = (byte)((int)(uint)*pbVar21 >> (8 - bVar8 & 0x1f)),
          pbVar30 != pbVar23 + (ulong)(uVar26 - 1) * 3) {
      pbVar21 = pbVar30;
      pbVar20 = pbVar30 + 3;
    }
...
LAB_00102379:
  ...
  lVar24 = *(long *)(param_1 + 0x250);
  pbVar23 = (byte *)(lVar24 + 2);
  do {
    pbVar20 = pbVar23 + 3;
    *pbVar23 = (byte)((int)(uint)*pbVar23 >> (8 - bVar12 & 0x1f));
    pbVar23 = pbVar20;
  } while (pbVar20 != (byte *)(lVar24 + 5 + (ulong)(uVar26 - 1) * 3));
LAB_001022a2:
...
LAB_00102e2a:
  ...
  if ((uVar3 & 0x600000) == 0) {
    ...
    if ((((uVar3 & 0x40) == 0) || ((bVar6 & 0xfb) != 2)) || (*(long *)(param_1 + 0x378) == 0))
    goto LAB_00102e90;
...
LAB_00103003:
    ...
    *(undefined2 *)((long)param_2 + 0x22) = 0;
LAB_00103011:
    if ((((uVar3 & 0x8000) != 0) && ((bVar6 & 0xfd) == 0)) &&
    ...
    *(byte *)((long)param_2 + 0x25) = *(byte *)((long)param_2 + 0x25) & 0xfd;
    bVar6 = *(byte *)((long)param_2 + 0x25);
LAB_00102e90:
    if (((uVar3 & 0x200) == 0) || ((char)param_2[9] != '\b')) {
LAB_00102e9e:
      if (((uVar3 & 4) != 0) && ((byte)param_2[9] < 8)) {
        *(undefined1 *)(param_2 + 9) = 8;
      }
      goto LAB_00102eac;
    }
...

{
  ...
  if ((uVar47 & 0x1000) == 0) {
LAB_001031b5:
    if (((uVar47 & 0x40080) == 0x40000) && ((param_2[4] & 0xfd) == 4)) {
LAB_001039a7:
      png_do_strip_channel(param_2,*(long *)(param_1 + 0x228) + 1,0);
      uVar47 = *(uint *)(param_1 + 0x134);
    }
  }
  else {
  ...
  if ((uVar47 & 0x600000) != 0) {
    ...
    if ((bVar34 & 3) == 2) {
      ...
      if (cVar13 == '\b') {
        ...
        if ((lVar31 == 0) || (lVar39 = *(long *)(param_1 + 0x2c0), lVar39 == 0)) {
          bVar58 = false;
          uVar57 = 0;
          puVar48 = puVar45;
          bVar12 = false;
          if (uVar37 != 0) {
            do {
              ...
              if ((bVar34 != *(byte *)((long)puVar48 + 1)) || (bVar34 != (byte)puVar48[1])) {
                bVar58 = true;
                bVar34 = (byte)(bVar34 * uVar50 + *(byte *)((long)puVar48 + 1) * uVar56 +
                                (uint)(byte)puVar48[1] * iVar38 >> 0xf);
              }
              *(byte *)puVar45 = bVar34;
              if (bVar55 == 0) {
          ...
          if (uVar37 != 0) {
            ...
            do {
              ...
              if ((bVar34 == *(byte *)((long)puVar45 + 1)) && (bVar34 == (byte)puVar45[1])) {
                ...
                bVar58 = true;
                bVar34 = *(byte *)(lVar31 + (ulong)(*(byte *)(lVar39 + (ulong)bVar34) * uVar50 +
                                                    0x4000 + (uint)*(byte *)(lVar39 + (ulong)*(byte 
                                                  *)((long)puVar45 + 1)) * (uint)uVar16 +
                                                  (uint)*(byte *)(lVar39 + (ulong)(byte)puVar45[1])
                                                  * iVar38 >> 0xf));
              }
              *(byte *)puVar48 = bVar34;
              if (bVar55 == 0) {
...
LAB_00105d67:
        ...
        if ((lVar31 == 0) || (lVar39 = *(long *)(param_1 + 0x2c8), lVar39 == 0)) {
          bVar58 = false;
          uVar57 = 0;
          puVar48 = puVar45;
          bVar12 = false;
          if (uVar37 != 0) {
            do {
              ...
              uVar16 = (ushort)((uint)(ushort)(uVar6 << 8 | uVar6 >> 8) * iVar38 +
                                (ushort)(uVar16 << 8 | uVar16 >> 8) * uVar50 + 0x4000 +
                                (ushort)(uVar17 << 8 | uVar17 >> 8) * uVar56 >> 0xf);
          ...
          do {
            ...
            if ((uVar16 == uVar17) && (uVar6 == uVar16)) {
              if (*(long *)(param_1 + 0x2b0) != 0) {
                uVar15 = *(ushort *)
                          (*(long *)(*(long *)(param_1 + 0x2b0) +
                                    (long)((int)(uint)bVar34 >>
                                          ((byte)*(undefined4 *)(param_1 + 0x2a0) & 0x1f)) * 8) +
                          (ulong)(byte)uVar16 * 2);
              }
            }
            else {
              ...
              bVar58 = true;
              uVar57 = *(ushort *)
                        (*(long *)(lVar31 + (long)((int)(uint)(byte)(uVar17 >> 8) >> (bVar36 & 0x1f)
                                                  ) * 8) + (ulong)(byte)uVar17 * 2) * uVar56 +
                       0x4000 + *(ushort *)
                                 (*(long *)(lVar31 + (long)((int)(uint)bVar34 >> (bVar36 & 0x1f)) *
                                                     8) + (ulong)(byte)uVar16 * 2) * uVar50 +
                       (uint)*(ushort *)
                              (*(long *)(lVar31 + (long)((int)(uint)(byte)(uVar6 >> 8) >>
                                                        (bVar36 & 0x1f)) * 8) +
                              (ulong)(byte)uVar6 * 2) * iVar38;
              uVar15 = *(ushort *)
                        (*(long *)(lVar39 + (long)((int)(uVar57 >> 0xf & 0xff) >> (bVar36 & 0x1f)) *
                                            8) + (ulong)(uVar57 >> 0x17 & 0xff) * 2);
            }
        ...
        if ((lVar8 == 0 || lVar26 == 0) || (lVar39 == 0)) {
            ...
            do {
              ...
              if (bVar34 == 0) {
                *(byte *)puVar45 = (byte)*(undefined2 *)(param_1 + 0x284);
                ...
                uVar47 = (ushort)((0xff - (ushort)bVar34) * *(short *)(param_1 + 0x284)) + 0x80 +
                         (uint)(ushort)((ushort)bVar34 * (ushort)(byte)*puVar45);
          ...
          do {
            ...
            if (bVar34 == 0xff) {
              ...
              uVar47 = (ushort)((ushort)bVar34 * (ushort)*(byte *)(lVar8 + (ulong)(byte)*puVar45)) +
                       0x80 + (uint)*(ushort *)(param_1 + 0x28e) * (0xff - (uint)bVar34);
          ...
          do {
            ...
            if (uVar16 == 0) {
              ...
              *(byte *)((long)puVar45 + 1) = (byte)uVar14;
              ...
              uVar47 = (ushort)(*puVar45 << 8 | *puVar45 >> 8) * uVar47 + 0x8000 +
                       (uint)*(ushort *)(param_1 + 0x284) * (0xffff - uVar47);
        ...
        if (uVar16 == 0xffff) {
          uVar16 = *(ushort *)
                    (*(long *)(lVar9 + (long)((int)(uint)*(byte *)((long)puVar45 + 1) >>
                                             (bVar55 & 0x1f)) * 8) + (ulong)(byte)*puVar45 * 2);
          uVar47 = (uint)uVar16;
          bVar34 = (byte)(uVar16 >> 8);
        }
        else if (uVar16 == 0) {
          ...
          uVar47 = (uint)(ushort)(uVar16 << 8 | uVar16 >> 8);
          uVar37 = *(ushort *)
                    (*(long *)(lVar11 + (long)((int)(uint)*(byte *)((long)puVar45 + 1) >>
                                              (bVar55 & 0x1f)) * 8) + (ulong)(byte)*puVar45 * 2) *
                   uVar47 + 0x8000 + (uint)*(ushort *)(param_1 + 0x28e) * (0xffff - uVar47);
          uVar37 = (uVar37 >> 0x10) + uVar37;
          uVar47 = uVar37 >> 0x10;
          if (uVar50 == 0) {
            uVar47 = (uint)*(ushort *)
                            (*(long *)(lVar10 + (long)((int)(uVar47 & 0xff) >> (bVar55 & 0x1f)) * 8)
                            + (ulong)(uVar37 >> 0x18) * 2);
          }
          ...
          if (*(char *)((long)param_2 + 0x11) == '\b') {
            if (lVar39 == 0) {
              if (uVar37 != 0) {
                ...
                do {
                  if ((((byte)*puVar45 == uVar16) &&
                      ((ushort)*(byte *)((long)puVar45 + 1) == *(ushort *)(param_1 + 0x2f4))) &&
                     ((ushort)(byte)puVar45[1] == *(ushort *)(param_1 + 0x2f6))) {
              ...
              do {
                if ((((byte)*puVar45 == uVar16) &&
                  ...
                  *(byte *)((long)puVar45 + 1) =
                       *(byte *)(lVar39 + (ulong)*(byte *)((long)puVar45 + 1));
            ...
            if (uVar37 != 0) {
              ...
              do {
                if ((((ushort)(*puVar45 << 8 | *puVar45 >> 8) == uVar16) &&
                    ((ushort)(puVar45[1] << 8 | puVar45[1] >> 8) == *(ushort *)(param_1 + 0x2f4)))
                   && ((ushort)(puVar45[2] << 8 | puVar45[2] >> 8) == *(ushort *)(param_1 + 0x2f6)))
                {
            ...
            do {
              if ((((ushort)(*puVar45 << 8 | *puVar45 >> 8) == uVar16) &&
                ...
                *(byte *)puVar45 = (byte)((ushort)uVar14 >> 8);
                uVar14 = *(undefined2 *)
                          (*(long *)(lVar9 + (long)((int)(uint)*(byte *)((long)puVar45 + 3) >>
                                                   (bVar55 & 0x1f)) * 8) +
                          (ulong)(byte)puVar45[1] * 2);
                *(byte *)((long)puVar45 + 3) = (byte)uVar14;
                *(byte *)(puVar45 + 1) = (byte)((ushort)uVar14 >> 8);
                uVar14 = *(undefined2 *)
                          (*(long *)(lVar9 + (long)((int)(uint)*(byte *)((long)puVar45 + 5) >>
                                                   (bVar55 & 0x1f)) * 8) +
                          (ulong)(byte)puVar45[2] * 2);
                bVar34 = (byte)((ushort)uVar14 >> 8);
              }
              ...
              do {
                ...
                if (bVar34 == 0) {
                  ...
                  *(byte *)(puVar45 + 1) = (byte)*(undefined2 *)(param_1 + 0x282);
                  ...
                  uVar47 = (ushort)((ushort)bVar34 * (ushort)(byte)*puVar45) + 0x80 +
                           (uint)*(ushort *)(param_1 + 0x27e) * iVar38;
                  uVar16 = *(ushort *)(param_1 + 0x280);
                  *(byte *)puVar45 = (byte)(uVar47 + (uVar47 >> 8 & 0xff) >> 8);
                  sVar5 = *(short *)(param_1 + 0x282);
                  uVar47 = (ushort)((ushort)bVar34 * (ushort)*(byte *)((long)puVar45 + 1)) + 0x80 +
                           (uint)uVar16 * iVar38;
                  *(byte *)((long)puVar45 + 1) = (byte)(uVar47 + (uVar47 >> 8 & 0xff) >> 8);
                  uVar47 = (ushort)((ushort)bVar34 * (ushort)(byte)puVar45[1]) + 0x80 +
                           (uint)(ushort)((short)iVar38 * sVar5);
            ...
            do {
              ...
              if (bVar34 == 0xff) {
                ...
                *(byte *)((long)puVar45 + 1) = (byte)*(undefined2 *)(param_1 + 0x280);
                ...
                uVar47 = (ushort)((ushort)bVar34 * (ushort)*(byte *)(lVar8 + (ulong)(byte)*puVar45))
                         + 0x80 + (uint)*(ushort *)(param_1 + 0x288) * iVar19;
                ...
                *(byte *)puVar45 = bVar55;
                uVar47 = (ushort)((ushort)bVar34 *
                                 (ushort)*(byte *)(lVar8 + (ulong)*(byte *)((long)puVar45 + 1))) +
                         0x80 + (uint)*(ushort *)(param_1 + 0x28a) * iVar19;
                iVar38 = (uVar47 >> 8 & 0xff) + (uVar47 & 0xffff);
                bVar55 = (byte)((uint)iVar38 >> 8);
                if (uVar50 == 0) {
                  bVar55 = *(byte *)(lVar26 + (ulong)(iVar38 >> 8 & 0xff));
                ...
                *(byte *)((long)puVar45 + 1) = bVar55;
                uVar47 = (ushort)((ushort)bVar34 *
                                 (ushort)*(byte *)(lVar8 + (ulong)(byte)puVar45[1])) + 0x80 +
                         (uint)(ushort)((short)iVar19 * sVar5);
                iVar38 = (uVar47 & 0xffff) + (uVar47 >> 8 & 0xff);
                bVar34 = (byte)((uint)iVar38 >> 8);
                if (uVar50 == 0) {
                  bVar34 = *(byte *)(lVar26 + (ulong)(iVar38 >> 8 & 0xff));
            ...
            do {
              ...
              if (uVar16 == 0) {
                ...
                *(byte *)((long)puVar45 + 5) = (byte)uVar14;
                ...
                uVar47 = (uint)(ushort)(*puVar45 << 8 | *puVar45 >> 8) * (uint)uVar17 + 0x8000 +
                         (uint)*(ushort *)(param_1 + 0x27e) * iVar19;
                iVar38 = (uVar47 >> 0x10) + uVar47;
                *(byte *)puVar45 = (byte)((uint)iVar38 >> 0x18);
                uVar16 = *(ushort *)(param_1 + 0x280);
                *(byte *)((long)puVar45 + 1) = (byte)((uint)iVar38 >> 0x10);
                uVar47 = (uint)uVar16 * iVar19 + 0x8000 +
                         (uint)(ushort)(puVar45[1] << 8 | puVar45[1] >> 8) * (uint)uVar17;
                iVar38 = (uVar47 >> 0x10) + uVar47;
                *(byte *)(puVar45 + 1) = (byte)((uint)iVar38 >> 0x18);
                uVar16 = *(ushort *)(param_1 + 0x282);
                *(byte *)((long)puVar45 + 3) = (byte)((uint)iVar38 >> 0x10);
                uVar47 = (uint)uVar16 * iVar19 + 0x8000 +
                         (uint)(ushort)(puVar45[2] << 8 | puVar45[2] >> 8) * (uint)uVar17;
                iVar38 = (uVar47 >> 0x10) + uVar47;
          ...
          do {
            ...
            if (uVar16 == 0xffff) {
              ...
              *(byte *)((long)puVar45 + 1) = (byte)uVar14;
              uVar14 = *(undefined2 *)
                        (*(long *)(lVar9 + (long)((int)(uint)*(byte *)((long)puVar45 + 3) >>
                                                 (bVar55 & 0x1f)) * 8) + (ulong)(byte)puVar45[1] * 2
                        );
              *(byte *)(puVar45 + 1) = (byte)((ushort)uVar14 >> 8);
              *(byte *)((long)puVar45 + 3) = (byte)uVar14;
              uVar16 = *(ushort *)
                        (*(long *)(lVar9 + (long)((int)(uint)*(byte *)((long)puVar45 + 5) >>
                                                 (bVar55 & 0x1f)) * 8) + (ulong)(byte)puVar45[2] * 2
                        );
              uVar37 = (uint)uVar16;
              bVar34 = (byte)(uVar16 >> 8);
            }
              ...
              *(byte *)((long)puVar45 + 3) = (byte)uVar14;
              ...
              uVar47 = (uint)*(ushort *)
                              (*(long *)(lVar11 + (long)((int)(uint)*(byte *)((long)puVar45 + 1) >>
                                                        (bVar55 & 0x1f)) * 8) +
                              (ulong)(byte)*puVar45 * 2) * (uint)uVar16 + 0x8000 +
                       (uint)*(ushort *)(param_1 + 0x288) * iVar38;
              uVar47 = (uVar47 >> 0x10) + uVar47;
              uVar14 = (undefined2)(uVar47 >> 0x10);
              if (uVar50 == 0) {
                uVar14 = *(undefined2 *)
                          (*(long *)(lVar10 + (long)((int)(uVar47 >> 0x10 & 0xff) >> (bVar55 & 0x1f)
                                                    ) * 8) + (ulong)(uVar47 >> 0x18) * 2);
              }
              *(byte *)((long)puVar45 + 1) = (byte)uVar14;
              *(byte *)puVar45 = (byte)((ushort)uVar14 >> 8);
              uVar47 = (uint)*(ushort *)
                              (*(long *)(lVar11 + (long)((int)(uint)*(byte *)((long)puVar45 + 3) >>
                                                        (bVar55 & 0x1f)) * 8) +
                              (ulong)(byte)puVar45[1] * 2) * (uint)uVar16 + 0x8000 +
                       (uint)*(ushort *)(param_1 + 0x28a) * iVar38;
              uVar47 = (uVar47 >> 0x10) + uVar47;
              uVar14 = (undefined2)(uVar47 >> 0x10);
              if (uVar50 == 0) {
                uVar14 = *(undefined2 *)
              ...
              *(byte *)(puVar45 + 1) = (byte)((ushort)uVar14 >> 8);
              uVar47 = (uint)*(ushort *)
                              (*(long *)(lVar11 + (long)((int)(uint)*(byte *)((long)puVar45 + 5) >>
                                                        (bVar55 & 0x1f)) * 8) +
                              (ulong)(byte)puVar45[2] * 2) * (uint)uVar16 + 0x8000 +
                       (uint)*(ushort *)(param_1 + 0x28c) * iVar38;
              uVar47 = (uVar47 >> 0x10) + uVar47;
              uVar37 = uVar47 >> 0x10;
              if (uVar50 == 0) {
                uVar37 = (uint)*(ushort *)
                                (*(long *)(lVar10 + (long)((int)(uVar37 & 0xff) >> (bVar55 & 0x1f))
                                                    * 8) + (ulong)(uVar47 >> 0x18) * 2);
              }
...
switchD_0010432d_caseD_0:
      if ((uVar47 & 0x602000) == 0x2000) {
LAB_00104658:
        if ((*(short *)(param_1 + 0x260) == 0) &&
           (bVar34 = *(byte *)(param_1 + 0x267), (bVar34 & 4) == 0)) goto LAB_00103d3f;
        goto LAB_00103df0;
      }
    }
LAB_00103df6:
    if (((~uVar47 & 0x40080) == 0) && ((param_2[4] & 0xfd) == 4)) {
      lVar26 = *(long *)(param_1 + 0x228);
LAB_00103e1b:
      png_do_strip_channel(param_2,lVar26 + 1,0);
      goto LAB_00103e29;
    }
LAB_001031fb:
    if ((uVar47 & 0x800000) != 0) goto LAB_00103340;
joined_r0x00103388:
    if ((uVar47 & 0x4000000) != 0) {
...
LAB_001033a1:
        ...
        for (; pbVar29 < pbVar49; pbVar29 = pbVar29 + 2) {
          *pbVar22 = *pbVar29 +
                     (char)((((uint)pbVar29[1] - (uint)*pbVar29) + 0x80) * 0xffff >> 0x18);
          pbVar22 = pbVar22 + 1;
        }
        uVar47 = *(uint *)(param_1 + 0x134);
        *(undefined1 *)((long)param_2 + 0x11) = 8;
    ...
    if (((uVar47 & 0x400) == 0) ||
       (pbVar29 = *(byte **)(param_1 + 0x228), *(char *)((long)param_2 + 0x11) != '\x10'))
    goto joined_r0x00103223;
LAB_001038f1:
...
LAB_001031e9:
    if ((uVar47 & 0x602000) != 0x2000) goto LAB_001031fb;
LAB_00103d38:
    bVar34 = *(byte *)(param_1 + 0x267);
LAB_00103d3f:
    if (bVar34 == 3) {
LAB_00103df0:
      uVar47 = *(uint *)(param_1 + 0x134);
    ...
    if (8 < bVar34) {
      if ((lVar39 != 0) && (bVar34 == 0x10)) {
        ...
        if (bVar34 == 4) {
LAB_00105c50:
          if (uVar47 == 0) goto LAB_00105f45;
          do {
            pbVar22 = pbVar29 + 4;
            uVar14 = *(undefined2 *)
                      (*(long *)(lVar39 + (long)((int)(uint)pbVar29[1] >> (bVar55 & 0x1f)) * 8) +
                      (ulong)*pbVar29 * 2);
...
LAB_00105ba8:
          ...
          do {
            ...
            *pbVar29 = (byte)((ushort)uVar14 >> 8);
            pbVar29[1] = (byte)uVar14;
            uVar14 = *(undefined2 *)
                      (*(long *)(lVar39 + (long)((int)(uint)pbVar29[3] >> (bVar55 & 0x1f)) * 8) +
                      (ulong)pbVar29[2] * 2);
            pbVar29[2] = (byte)((ushort)uVar14 >> 8);
            pbVar29[3] = (byte)uVar14;
            uVar14 = *(undefined2 *)
                      (*(long *)(lVar39 + (long)((int)(uint)pbVar29[5] >> (bVar55 & 0x1f)) * 8) +
                      (ulong)pbVar29[4] * 2);
          ...
          if (bVar34 == 2) {
            if (uVar47 != 0) {
              ...
              do {
                ...
                uVar57 = bVar34 & 0x30;
                uVar56 = bVar34 & 0xc;
                *pbVar22 = *(byte *)(lVar31 + (ulong)((bVar34 & 3) * 0x55)) >> 6 |
                           *(byte *)(lVar31 + (int)((int)uVar57 >> 4 | (int)uVar57 >> 2 | uVar57 * 5
                                                   )) >> 2 & 0x30 |
                           *(byte *)(lVar31 + (int)((int)uVar50 >> 2 | (int)uVar50 >> 4 | uVar50 |
                                                   (int)uVar50 >> 6)) & 0xc0 |
                           *(byte *)(lVar31 + (int)((int)uVar56 >> 2 | uVar56 | uVar56 * 0x14)) >> 4
                           & 0xc;
                pbVar22 = pbVar22 + 1;
              } while (uVar37 < uVar47);
              cVar13 = *(char *)((long)param_2 + 0x11);
...
LAB_00105a97:
                ...
                do {
                  uVar37 = uVar37 + 2;
                  uVar50 = *pbVar29 & 0xf0;
                  *pbVar29 = *(byte *)(lVar31 + (int)((int)uVar50 >> 4 | uVar50)) & 0xf0 |
                             *(byte *)(lVar31 + (ulong)((*pbVar29 & 0xf) * 0x11)) >> 4;
                  pbVar29 = pbVar29 + 1;
                } while (uVar37 < uVar47);
              }
              else {
                if (cVar13 == '\b') goto LAB_00105fd7;
                if (cVar13 == '\x10') goto LAB_00105f71;
              }
            }
          }
          else if (bVar34 == 4) {
            if (uVar47 != 0) goto LAB_00105a97;
          }
...
LAB_0010337c:
    ...
    if ((*(char *)((long)param_2 + 0x11) != '\x10') ||
       (lVar31 = *(long *)(param_1 + 0x2c8), lVar31 == 0)) {
LAB_0010336d:
    ...
    if (uVar50 != 0) {
      do {
        uVar14 = *(undefined2 *)
                  (*(long *)(lVar31 + (long)((int)(uint)pbVar22[1] >> ((byte)uVar7 & 0x1f)) * 8) +
                  (ulong)*pbVar22 * 2);
...
LAB_001041f4:
          ...
          if (cVar13 == '\x06') {
            if (lVar26 != 0) {
              ...
              if (uVar37 != 0) {
                do {
                  pbVar29[uVar30] =
                       *(byte *)(lVar26 + (((int)(uint)pbVar29[uVar30 * 4] >> 3) << 10 |
                                           ((int)(uint)*(byte *)(lVar31 + 2 + uVar30 * 4) >> 3) << 5
                                          | (int)(uint)*(byte *)(lVar31 + 3 + uVar30 * 4) >> 3));
                  uVar30 = uVar30 + 1;
                } while (uVar30 != uVar20);
              }
              goto LAB_00104570;
        ...
        if (uVar37 != 0) {
          do {
            pbVar53 = pbVar49 + 1;
            *pbVar49 = *(byte *)(lVar26 + (((int)(uint)*pbVar29 >> 3) << 10 |
                                           ((int)(uint)pbVar29[1] >> 3) << 5 |
                                          (int)(uint)pbVar29[2] >> 3));
            pbVar29 = pbVar29 + 3;
            pbVar49 = pbVar53;
...
LAB_00103f40:
      if ((uVar47 & 8) == 0) goto joined_r0x00103264;
      uVar47 = (uint)*(byte *)((long)param_2 + 0x11);
LAB_00103f58:
      local_58[0] = uVar47 - *(byte *)(param_1 + 0x2dd);
...
LAB_0010324b:
    if ((uVar47 & 0x80000) != 0) goto LAB_001036c5;
joined_r0x00103739:
    if ((uVar47 & 8) == 0) goto joined_r0x00103264;
    pbVar29 = *(byte **)(param_1 + 0x228);
    bVar34 = (byte)param_2[4];
...
LAB_0010376c:
    local_58[0] = uVar47 - *(byte *)(param_1 + 0x2e0);
    iVar38 = 1;
LAB_00103780:
    if ((bVar34 & 4) != 0) {
      lVar31 = (long)iVar38;
        ...
        if (bVar34 == 2) {
          ...
          if (puVar45 < puVar48) {
            do {
              puVar51 = (ushort *)((long)puVar45 + 1);
              *(byte *)puVar45 =
                   (byte)((int)(uint)(byte)*puVar45 >> ((byte)local_58[0] & 0x1f)) &
              ...
              (lVar31 = *(long *)(param_2 + 2), puVar45 < (ushort *)(lVar31 + (long)puVar45))) {
        iVar19 = 0;
        puVar48 = puVar45;
        do {
          iVar42 = iVar19 + 1;
          iVar18 = (int)(uint)(ushort)(*puVar48 << 8 | *puVar48 >> 8) >>
                   ((byte)local_58[iVar19] & 0x1f);
      ...
      if (*(char *)((long)param_2 + 0x11) == '\b') {
        ...
        if ((uVar47 & 0x80) == 0) {
          if (uVar50 != 0) {
            lVar31 = 0;
            do {
              *(ushort *)(puVar46 + lVar31 * 2 + -2) =
                   CONCAT11(puVar1[lVar31 + (uVar20 - 1)],uVar52);
              lVar31 = lVar31 + -1;
            } while (lVar31 != -uVar20);
            uVar37 = *(uint *)(param_1 + 0x134);
          }

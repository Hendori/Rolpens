  ...
  *(undefined8 *)((long)local_1b8 + *(long *)(local_1b8[0] + -0x18) + 8) = 2;
  poVar2 = std::ostream::_M_insert<double>
                     (((*(double *)param_3 /
                       (double)((fVar4 * fVar6 + fVar3 * fVar10) * _LC2 + fVar4 * fVar3 +
                                fVar6 * fVar10 * _LC4 +
                                (fVar5 * fVar7 + fVar4 * fVar11) * _UNK_0010d2b4 + fVar5 * fVar4 +
                                fVar7 * fVar11 * _UNK_0010d2c4 +
                               (fVar3 * fVar8 + fVar5 * fVar9) * _UNK_0010d2b8 + fVar3 * fVar5 +
                               fVar8 * fVar9 * _UNK_0010d2c8)) * __LC7) / param_2);
  ...
  *(undefined8 *)((long)local_1b8 + *(long *)(local_1b8[0] + -0x18) + 8) = 2;
  poVar2 = std::ostream::_M_insert<double>
                     (((*(double *)param_3 /
                       (double)((fVar6 * fVar8 + fVar5 * fVar12) * _LC2 + fVar6 * fVar5 +
                                fVar8 * fVar12 * _LC4 +
                                (fVar7 * fVar9 + fVar6 * fVar13) * _UNK_0010d2b4 + fVar7 * fVar6 +
                                fVar9 * fVar13 * _UNK_0010d2c4 +
                               (fVar5 * fVar10 + fVar7 * fVar11) * _UNK_0010d2b8 + fVar5 * fVar7 +
                               fVar10 * fVar11 * _UNK_0010d2c8)) * __LC7) / param_2);
  std::__ostream_insert<char,std::char_traits<char>>(poVar2,"%), ",4);
  std::__ostream_insert<char,std::char_traits<char>>((ostream *)local_1b8,"#bytes = ",9);
  *(undefined8 *)((long)local_1b8 + *(long *)(local_1b8[0] + -0x18) + 0x10) = 7;
  *(undefined8 *)((long)local_1b8 + *(long *)(local_1b8[0] + -0x18) + 8) = 2;
  ...
  *(undefined8 *)((long)local_1b8 + *(long *)(local_1b8[0] + -0x18) + 8) = 2;
  poVar3 = std::ostream::_M_insert<double>
                     (((*(double *)param_3 /
                       (double)((fVar7 * fVar9 + fVar6 * fVar13) * _LC2 + fVar7 * fVar6 +
                                fVar9 * fVar13 * _LC4 +
                                (fVar8 * fVar10 + fVar7 * fVar14) * _UNK_0010d2b4 + fVar8 * fVar7 +
                                fVar10 * fVar14 * _UNK_0010d2c4 +
                               (fVar6 * fVar11 + fVar8 * fVar12) * _UNK_0010d2b8 + fVar6 * fVar8 +
                               fVar11 * fVar12 * _UNK_0010d2c8)) * __LC7) / param_2);

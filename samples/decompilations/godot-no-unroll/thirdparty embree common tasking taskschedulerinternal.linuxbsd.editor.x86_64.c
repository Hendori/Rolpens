...

{
  ...
  *(undefined ***)this = &PTR__TaskScheduler_001018f8;
...

{
  ...
  *(ulong *)pTVar7 = param_1;
  ...
  do {
    *(undefined4 *)pTVar8 = 0;
    pTVar8 = pTVar8 + 0x40;
  } while (pTVar8 != (TaskQueue *)(pTVar7 + 0x40040));
...
LAB_00100910:
  ...
  do {
    ...
    do {
      while( true ) {
        if (*(long *)pTVar1 == 0) goto LAB_00100910;
        uVar9 = uVar9 + uVar4;
        ...
        *(long *)pTVar1 = *(long *)pTVar1 + -1;
        UNLOCK();
        uVar9 = uVar4;
        if (0x3ff < uVar4) goto LAB_00100983;
      }
    } while (uVar9 < 0x400);
LAB_00100983:
    embree::yield();
  ...
  do {
    ...
    while( true ) {
      ...
      *(ulong *)pTVar2 = *(ulong *)pTVar2 + 1;
      ...
      if (this_00 == (TaskScheduler *)0x0) goto LAB_00100a7c;
      ...
      *(long *)pTVar2 = *(long *)pTVar2 + -1;
      UNLOCK();
      if (*(long *)pTVar2 != 0) goto LAB_00100a7c;
    ...
    *(ulong *)pTVar1 = param_1;
    ...
    while (uVar7 = uVar7 - 1, (long)*(ulong *)pTVar1 <= (long)uVar7) {
      while (uVar7 != 0) {
        ...
        *(long *)(this + 0x20) = *(long *)(this + 0x20) + -8;
        if ((long)uVar7 < (long)*(ulong *)pTVar1) goto LAB_00100f01;
      }
    }
  }
LAB_00100f01:
...

{
  ...
  *(long *)pRVar1 = *(long *)pRVar1 + -1;
  ...
  if ((this != (RefCount *)0x0) && (*(long *)pRVar1 == 0)) {
                    /* WARNING: Could not recover jumptable at 0x001011d9. Too many branches */
...
LAB_0010122e:
        puVar4 = puVar4 + 1;
        if (puVar2 == puVar4) goto LAB_00101260;
      }
...

{
  ...
  if (bVar12 || bVar13) {
    ...
    if (__src != unaff_R12) goto LAB_0010144e;
    if (0xfffffffffffffffe < uVar3) goto LAB_001014e0;
...

{
  ...
  if (__src == pvVar2) {
    if (0xfffffffffffffffe < uVar1) goto LAB_001014e0;
...

{
  ...
  if (plVar2 == plVar1) {
    uVar7 = uVar4 + 1;
    if (0xfffffffffffffffe < uVar4) goto LAB_00101740;
...
LAB_00101740:
    ...
    *(undefined8 *)((long)param_2 - (long)plVar2) = uVar3;
    ...
    plVar6 = (long *)0x8;
    plVar5 = local_58;
    if (param_2 == plVar2) goto LAB_0010167b;
  }
  while( true ) {
    plVar6 = (long *)*plVar8;
    *plVar5 = (long)plVar6;
  ...
  plVar6 = plVar5 + 2;
  if (param_2 == plVar1) goto LAB_001016d7;
LAB_0010167b:
  do {
    while( true ) {
      plVar5 = plVar6;
...
LAB_0010166e:
      param_2 = param_2 + 1;
      plVar6 = plVar5 + 1;
      if (plVar1 == param_2) goto LAB_001016a8;
    }
...
LAB_001016d7:
    do {
      plVar8 = (long *)*plVar9;
      if (plVar8 != (long *)0x0) {
        if (*(code **)(*plVar8 + 0x18) != embree::RefCount::refDec) goto code_r0x001016eb;
        LOCK();
        plVar5 = plVar8 + 1;
        *plVar5 = *plVar5 + -1;
        UNLOCK();

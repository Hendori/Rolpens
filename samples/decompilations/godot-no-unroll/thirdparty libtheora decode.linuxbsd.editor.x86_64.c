...
LAB_00100cc8:
          ...
          lVar18 = lVar33;
          if (lVar23 <= lVar34) goto LAB_00100d1c;
        }
        iVar8 = 0;
LAB_00100bd1:
        uVar9 = iVar8 + *(int *)(OC_DCT_CODE_WORD + (long)iVar7 * 4);
        if (uVar9 == 0) goto LAB_00100cbe;
LAB_00100be2:
        uVar20 = (int)uVar9 >> 8 & 0xfff;
        lVar18 = (long)(int)uVar20;
        if (uVar20 != 0) goto LAB_00100cc8;
        sVar25 = 0;
        if ((uVar9 & 0xff) == 0) {
                ...
                do {
                  while( true ) {
                    ...
                    *(char *)(lVar4 + lVar19) = (char)iVar10;
                    ...
                    if (uVar5 <= uVar22) goto LAB_00100fec;
                  }
...
LAB_00100fec:
        ...
        if (puVar31 == (undefined5 *)0x1041e8) {
          if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
            __stack_chk_fail();
          }
    ...
    do {
      if (iVar17 == 0) {
        ...
        do {
          ...
          if ((*pbVar1 & 1) != 0) {
            bVar18 = *pbVar1 >> 6;
                    /* WARNING: Could not recover jumptable at 0x00101365. Too many branches */
      ...
      if (-1 < iVar3) {
        ...
        if (-1 < iVar3) {
          ...
          *(void **)(lVar4 + 0xdfb8) = pvVar5;
          if (pvVar5 != (void *)0x0) {
            lVar17 = __LC1 + lVar4;
            lVar18 = _UNK_00104668 + lVar4;
            lVar15 = __LC2 + lVar4;
            lVar16 = _UNK_00104678 + lVar4;
            lVar13 = lVar4 + __LC3;
            lVar14 = lVar4 + _UNK_00104688;
...
LAB_0010242a:
    ...
    if (uVar17 != 0) {
      ...
      do {
        ...
        if ((uVar29 < 0x1021) || (uVar17 <= uVar40)) {
          ...
          if (uVar17 <= uVar40) goto code_r0x0010332a;
        }
        else {
  ...
  if (*(char *)(param_1 + 0x4c0) != '\0') goto LAB_0010242a;
...
LAB_00104057:
    ...
    if ((uint)uVar32 < uVar17) {
      ...
      do {
        if ((*pbVar64 & 2) == 0) {
          if (uVar40 == 0) goto code_r0x001040b5;
...
LAB_00103ac8:
        ...
        if (lVar21 < lVar67) {
          do {
            ...
            if ((bVar45 & 0x3c) != 0) {
              uVar29 = uVar30 - 1;
              if ((int)uVar30 < 1) goto LAB_00104108;
...
LAB_00102547:
          ...
          if (*(int *)(param_1 + 0xe1e8) != 1) goto LAB_00101f40;
LAB_00101f9b:
            ...
            if (0 < iVar5) {
              ...
              do {
                ...
                if ((iVar61 < iVar6) && (bVar68)) {
                  ...
                  uVar30 = (uint)bVar69;
                  if (iVar6 < 0x601) {
                    if (iVar6 < 0x181) goto LAB_001031e8;
                    uVar20 = 0;
...
LAB_001031e8:
    ...
    if (local_1c8 == 3) {
      ...
      if (iVar18 < iVar4) goto LAB_00102081;
    ...
    local_140 = iVar16;
    if (local_1c8 == 0) goto LAB_00102877;
...
code_r0x001040b5:
  ...
  if (uVar17 <= (uint)uVar32) goto LAB_0010333e;
  goto LAB_00104057;
LAB_00104108:
  uVar17 = (uint)(uVar17 == 0);
  ...
  if (lVar67 <= lVar21) goto LAB_00101cbf;
  goto LAB_00103ac8;
}

...
uint match_constprop_0(ulong param_1,uint *param_2,ushort param_3,ulong param_4,undefined8 *param_5,
                      long param_6)
...
LAB_00100d6b:
  ...
  *(undefined1 *)(puVar32 + 9) = 0xb;
  param_2 = (uint *)puVar32[1] + (byte)(&_pcre2_OP_lengths_32)[uVar31];
LAB_00101aa0:
  local_a8 = (ulong *)((long)puVar32 + param_4);
  if (param_4 + (long)local_a8 < local_b0) {
LAB_00101dce:
    memcpy(local_a8 + 10,puVar32 + 10,param_4 - 0x50);
...
switchD_00100529_caseD_a3:
  uVar24 = 0;
switchD_001005c7_caseD_23:
  if (*(ulong *)(param_6 + 0xa8) < puVar32[10]) {
    *(ulong *)(param_6 + 0xa8) = puVar32[10];
  }
...
LAB_00100688:
  uVar24 = 0;
  goto switchD_001005c7_caseD_23;
switchD_00107fce_caseD_0:
joined_r0x00108041:
  if (bVar16 != 0xf) goto switchD_00100529_caseD_a3;
  goto LAB_00107fec;
switchD_001005c7_caseD_de:
  if (uVar24 == 0) goto code_r0x00100fe9;
  goto switchD_001005c7_caseD_23;
code_r0x00100fe9:
  puVar32[10] = puVar32[10] - 4;
LAB_00100fee:
  ...
  goto LAB_00100507;
joined_r0x001010c2:
  if (uVar26 <= puVar32[1]) goto LAB_00100507;
  ...
  bVar16 = puVar28[2];
  if ((1 << ((byte)uVar30 & 0x1f) & *(uint *)(&_pcre2_ucp_gbtable_32 + (ulong)bVar16 * 4)) == 0)
  goto LAB_0010114c;
  puVar32[10] = uVar26;
  uVar30 = (ulong)bVar16;
  goto joined_r0x001010c2;
...
int pcre2_match_32(undefined8 *param_1,uint *param_2,ulong param_3,ulong param_4,uint param_5,
...
LAB_0010bcb5:
  ...
  if ((param_5 & 0x20) == 0) {
    ...
    local_f8 = 2;
LAB_0010a6e4:
    if (((uVar8 | uVar5) & 0x20000000) != 0) goto LAB_0010bcb5;
  }
...
LAB_0010a7d8:
  ...
  if (uVar16 != 0) {
LAB_0010aad2:
    if (((param_5 & 0x40000000) == 0) || (puVar24 = param_2, uVar6 != 0)) {
      local_d8 = param_2;
      if (*(ushort *)((long)param_1 + 0x7c) <= param_4) {
        local_d8 = puVar9 + -(ulong)*(ushort *)((long)param_1 + 0x7c);
      }
      while( true ) {
        iVar7 = _pcre2_valid_utf_32(local_d8,param_3 - ((long)local_d8 - (long)param_2 >> 2),
                                    param_6 + 0xb);
        *(int *)((long)param_6 + 100) = iVar7;
        puVar20 = puVar1;
        puVar24 = local_d8;
...
LAB_0010a91c:
  ...
  if (((ulong)local_140 < uVar27 >> 10) && (uVar27 = (ulong)(local_140 << 10), uVar27 < uVar22)) {
    iVar7 = -0x3f;
    goto LAB_0010a7d8;
  }
  lVar11 = param_6[6];
  ...
  if ((uVar3 & 0x10) == 0) {
    local_210 = 0;
    if (((uVar2 & 0x200) == 0) && (local_210 = uVar3 & 0x40, local_210 != 0)) {
      local_1f0 = param_1 + 5;
      local_210 = 0;
      local_1dc = 0;
      local_218 = 0;
...
LAB_0010bb8a:
          puVar15 = &_pcre2_ucd_records_32 +
                    (ulong)*(ushort *)
                            (&_pcre2_ucd_stage2_32 +
                            (long)(int)((uint)*(ushort *)
                                               (&_pcre2_ucd_stage1_32 +
                                               (long)((int)local_210 >> 7) * 2) * 0x80 +
                                       (local_210 & 0x7f)) * 2) * 0xc;
          goto LAB_0010bbc6;
        }
      }
      else {
...
LAB_0010bbc6:
        local_1dc = local_210 + *(int *)(puVar15 + 4);
      }
      local_218 = 1;
      local_1f0 = (undefined8 *)0x0;
    }
...
LAB_0010bb26:
      puVar15 = &_pcre2_ucd_records_32 +
                (ulong)*(ushort *)
                        (&_pcre2_ucd_stage2_32 +
                        (long)(int)((uint)*(ushort *)
                                           (&_pcre2_ucd_stage1_32 + (long)((int)uVar12 >> 7) * 2) *
                                    0x80 + (uVar12 & 0x7f)) * 2) * 0xc;
    }
    else {
...
LAB_0010ae26:
  ...
  if (uVar6 != 0) {
    ...
    if (uVar16 != 0) {
      ...
      do {
        if (local_78._4_4_ == 0) {
          if (((puVar26 <= local_d0 + -(local_70 & 0xffffffff)) && (*puVar26 == local_70._4_4_)) &&
             (((int)local_70 == 1 || (puVar26[1] == local_68)))) break;
        }
        else if ((puVar26 < local_d0) &&
                (iVar7 = _pcre2_is_newline_32(puVar26,local_78._4_4_,local_d0,&local_70), iVar7 != 0
                )) break;
        puVar26 = puVar26 + 1;
...
LAB_0010b430:
        ...
        if (uVar16 == 0) {
          for (; local_70 = uVar27, puVar19 < puVar26; puVar19 = puVar19 + 1) {
            ...
            if (local_78._4_4_ == 0) {
              ...
              if (((local_e0 + uVar13 <= puVar19) &&
                  (local_70._4_4_ = (uint)(uVar27 >> 0x20), puVar19[-uVar13] == local_70._4_4_)) &&
                 ((bVar29 = (int)local_70 == 1, bVar29 || (puVar19[1 - uVar13] == local_68))))
              break;
            }
            else if ((local_e0 < puVar19) &&
                    (iVar7 = _pcre2_was_newline_32(puVar19,iVar7,local_e0,&local_70),
                    uVar27 = local_70, iVar7 != 0)) goto LAB_0010bc26;
            local_70 = uVar27;
            uVar27 = local_70;
          }
        }
    ...
    if (local_210 == local_1dc) {
      ...
      for (; ((puVar19 < puVar26 && (local_1dc != *puVar19)) && (local_210 != *puVar19));
          puVar19 = puVar19 + 1) {
      }
    }
LAB_0010af28:
  ...
  if ((local_218 == 0) || ((local_210 != uVar8 && (local_1dc != uVar8)))) {
    ...
    if ((*(byte *)((long)local_1f0 + (ulong)(uVar8 >> 3)) >> (uVar8 & 7) & 1) == 0)
    goto switchD_0010b2b0_default;
  }
  goto LAB_0010b1b3;
LAB_0010bc26:
  if ((puVar19[-1] == 0xd) &&
     (((uVar8 = local_78._4_4_ - 1, uVar8 < 2 && (puVar19 < puVar26)) && (*puVar19 == 10)))) {
    puVar19 = puVar19 + 1;
  }
LAB_0010b1b3:
  puVar20 = local_d0;
  if (local_f8 == 0) {
LAB_0010af4b:
    uVar27 = (long)local_d0 - (long)puVar19;
    puVar20 = local_d0;
    if ((long)uVar27 >> 2 < (long)(ulong)*(ushort *)((long)param_1 + 0x7e))
    goto switchD_0010b2b0_default;
    puVar26 = puVar19 + local_218;
    if (((local_1e8 < puVar26) && (bVar28)) &&
       ((uVar27 < 0x1f3d || ((-1 < (int)uVar23 && (uVar27 < 0x7a11fd)))))) {
      if (uVar12 == local_1d0) {
        do {
          puVar25 = puVar26;
...
LAB_0010b1d0:
  ...
  local_b8 = puVar19;
  puStack_b0 = puVar19;
  iVar7 = match_constprop_0(puVar19,local_e8,*(undefined2 *)(param_1 + 0x10),uVar22,param_6,
                            &local_158);
  ...
  if (iVar7 < -0x3e0) {
    ...
    if (((puVar20 == puVar1) || (uVar16 == 0)) || ((iVar7 + 2U & 0xfffffffd) != 0))
    goto LAB_0010b726;
    goto LAB_0010b023;
  }
...
LAB_0010b2d4:
  if (uVar6 != 0) {
    if (local_78._4_4_ == 0) {
      if (((puVar19 <= local_d0 + -(local_70 & 0xffffffff)) && (*puVar19 == local_70._4_4_)) &&
         (((int)local_70 == 1 || (puVar19[1] == local_68)))) goto switchD_0010b2b0_default;
    }
    else if ((puVar19 < local_d0) &&
            (iVar7 = _pcre2_is_newline_32(puVar19,local_78._4_4_,local_d0,&local_70), iVar7 != 0))
    goto switchD_0010b2b0_default;
  }
  puVar19 = puVar25;
  if ((puVar20 < puVar25) || ((int)uVar23 < 0)) goto switchD_0010b2b0_default;
  if (((((puVar9 < puVar25) && (puVar25[-1] == 0xd)) && (puVar25 < puVar20)) &&
      ((*puVar25 == 10 && ((*(byte *)((long)param_1 + 0x61) & 8) == 0)))) &&
  ...
  puVar19 = puVar25;
  goto LAB_0010ae26;
switchD_0010b2b0_default:
  if ((puVar1 == puVar20) || (uVar16 == 0)) {
    iVar7 = 0;
LAB_0010b726:
    param_6[3] = param_1;
    *(undefined1 *)(param_6 + 0xc) = 0;
    ...
    if (SBORROW4(iVar14,(uint)*(ushort *)((long)param_6 + 0x62) * 2) !=
        (int)(iVar14 + (uint)*(ushort *)((long)param_6 + 0x62) * -2) < 0) {
...
LAB_0010b023:
  do {
    ...
    do {
      ...
      local_d8 = puVar19;
      iVar7 = _pcre2_valid_utf_32(puVar19,param_3 - ((long)puVar19 - (long)param_2 >> 2),
                                  param_6 + 0xb);
      if (iVar7 == 0) {
        local_250 = 1;
        puVar20 = puVar1;

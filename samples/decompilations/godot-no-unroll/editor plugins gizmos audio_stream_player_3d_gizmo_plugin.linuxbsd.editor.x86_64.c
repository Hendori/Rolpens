...
/* AudioStreamPlayer3DGizmoPlugin::get_priority() const */

undefined8 AudioStreamPlayer3DGizmoPlugin::get_priority(void)
...
/* AudioStreamPlayer3DGizmoPlugin::has_gizmo(Node3D*) */

bool __thiscall
AudioStreamPlayer3DGizmoPlugin::has_gizmo(AudioStreamPlayer3DGizmoPlugin *this,Node3D *param_1)
...
/* AudioStreamPlayer3DGizmoPlugin::get_handle_value(EditorNode3DGizmo const*, int, bool) const */

EditorNode3DGizmo *
AudioStreamPlayer3DGizmoPlugin::get_handle_value
...
/* AudioStreamPlayer3DGizmoPlugin::set_handle(EditorNode3DGizmo const*, int, bool, Camera3D*,
   Vector2 const&) */

void __thiscall
AudioStreamPlayer3DGizmoPlugin::set_handle
          (AudioStreamPlayer3DGizmoPlugin *this,EditorNode3DGizmo *param_1,int param_2,bool param_3,
...

{
  ...
  local_100._8_4_ =
       fVar7 * local_60 + fVar9 * local_5c + (float)local_100._8_4_ * local_58 + local_4c;
  fVar6 = (float)((ulong)local_54 >> 0x20);
  local_100._0_8_ =
       CONCAT44(fVar7 * fVar3 + fVar9 * local_68 + fVar10 + fVar6,
                fVar7 * local_78 + fVar9 * fStack_74 + fVar8 + (float)local_54);
  local_e8 = fVar2 * local_5c + local_60 * fVar5 + fVar4 * local_58 + local_4c;
  local_f0 = CONCAT44(fVar5 * fVar3 + local_68 * fVar2 + fStack_64 * fVar4 + fVar6,
                      fVar5 * local_78 + fStack_74 * fVar2 + (float)local_70 * fVar4 +
                      (float)local_54);
  local_148 = _LC1;
  local_140 = _LC2;
  local_13c = _LC4;
  ...
  while( true ) {
    ...
    Geometry3D::get_closest_points_between_segments
              ((Vector3 *)local_d8,(Vector3 *)local_cc,local_100,(Vector3 *)&local_f0,
               (Vector3 *)&local_c0,(Vector3 *)&local_b4);
    fVar2 = SQRT(((float)local_b4 - (float)local_c0) * ((float)local_b4 - (float)local_c0) +
                 (local_b4._4_4_ - local_c0._4_4_) * (local_b4._4_4_ - local_c0._4_4_) +
                 (local_ac - local_b8) * (local_ac - local_b8));
    if (fVar2 < local_13c) {
...
/* AudioStreamPlayer3DGizmoPlugin::get_handle_name(EditorNode3DGizmo const*, int, bool) const */

EditorNode3DGizmo *
AudioStreamPlayer3DGizmoPlugin::get_handle_name(EditorNode3DGizmo *param_1,int param_2,bool param_3)
...
/* AudioStreamPlayer3DGizmoPlugin::get_gizmo_name() const */

AudioStreamPlayer3DGizmoPlugin * __thiscall
...
void __thiscall
AudioStreamPlayer3DGizmoPlugin::commit_handle
          (AudioStreamPlayer3DGizmoPlugin *this,EditorNode3DGizmo *param_1,int param_2,bool param_3,
...

{
  ...
  if (param_5) {
    ...
    EditorUndoRedoManager::add_do_methodp
              (pOVar5,pSVar4,(Variant **)&local_b8,(int)(Variant *)local_98);
...
void __thiscall
AudioStreamPlayer3DGizmoPlugin::AudioStreamPlayer3DGizmoPlugin(AudioStreamPlayer3DGizmoPlugin *this)

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_00104c30;
  ...
  if (pOVar7 != (Object *)0x0) {
    ...
    if ((AudioStreamPlayer3DGizmoPlugin()::{lambda()#1}::operator()()::sname == '\0') &&
       (iVar6 = __cxa_guard_acquire(&AudioStreamPlayer3DGizmoPlugin()::{lambda()#1}::operator()()::
                                     sname), iVar6 != 0)) {
      _scs_create((char *)&AudioStreamPlayer3DGizmoPlugin()::{lambda()#1}::operator()()::sname,true)
      ;
      __cxa_atexit(StringName::~StringName,
                   &AudioStreamPlayer3DGizmoPlugin()::{lambda()#1}::operator()()::sname,
                   &__dso_handle);
      __cxa_guard_release(&AudioStreamPlayer3DGizmoPlugin()::{lambda()#1}::operator()()::sname);
    }
    (*pcVar3)((StrRange *)&local_90,pOVar7,
              &AudioStreamPlayer3DGizmoPlugin()::{lambda()#1}::operator()()::sname);
    ...
    EditorNode3DGizmoPlugin::create_icon_material
              ((String *)this,(Ref *)&local_98,SUB81((StrRange *)&local_90,0),(Color *)0x0);
    lVar4 = local_98;
    if (local_98 != 0) {
      LOCK();
    ...
    if (((local_90 == (Object *)0x0) ||
        (cVar5 = RefCounted::unreference(), pOVar1 = local_90, cVar5 == '\0')) ||
    ...
    EditorNode3DGizmoPlugin::create_material
              ((String *)this,(StrRange *)&local_90,SUB81((Color *)local_78,0),false,false);
    pOVar7 = local_90;
    if (local_90 != (Object *)0x0) {
      LOCK();
    ...
    String::parse_latin1((StrRange *)&local_90);
    EditorNode3DGizmoPlugin::create_material
              ((String *)this,(StrRange *)&local_90,SUB81((String *)&local_58,0),true,false);
    pOVar7 = local_90;
    if (local_90 != (Object *)0x0) {
      LOCK();
      plVar2 = (long *)((long)local_90 + -0x10);
    ...
    EditorNode3DGizmoPlugin::create_handle_material
              ((String *)this,SUB81((StrRange *)&local_98,0),(Ref *)0x0);
    lVar4 = local_98;
    if (local_98 != 0) {
      LOCK();
      plVar2 = (long *)(local_98 + -0x10);
    ...
    if (((local_90 != (Object *)0x0) &&
        (cVar5 = RefCounted::unreference(), pOVar7 = local_90, cVar5 != '\0')) &&
       (cVar5 = predelete_handler(local_90), cVar5 != '\0')) {
      (**(code **)(*(long *)pOVar7 + 0x140))(pOVar7);
      Memory::free_static(pOVar7,false);
    }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* AudioStreamPlayer3DGizmoPlugin::redraw(EditorNode3DGizmo*) */

void __thiscall
AudioStreamPlayer3DGizmoPlugin::redraw
          (AudioStreamPlayer3DGizmoPlugin *this,EditorNode3DGizmo *param_1)

{
  ...
  if (param_1[0x17c] != (EditorNode3DGizmo)0x0) {
    ...
    if ((iVar6 != 3) ||
       (fVar17 = (float)AudioStreamPlayer3D::get_max_distance(), _LC52 < (double)fVar17)) {
      dVar3 = _LC52;
      local_88 = param_1;
...
LAB_0010132d:
      ...
      if (((local_88 != (EditorNode3DGizmo *)0x0) &&
          (cVar5 = RefCounted::unreference(), pEVar4 = local_88, cVar5 != '\0')) &&
      ...
      if (((iVar6 != 1) && (fVar17 = _LC50, iVar6 != 2)) &&
         (fVar17 = _LC3, fVar14 = _LC3, iVar6 == 0)) {
        fVar17 = _LC48;
        fVar14 = _LC47;
      }
      ...
      EditorNode3DGizmo::add_lines
                ((Vector *)param_1,(Ref *)&local_78,SUB81(&local_a8,0),(Color *)0x1);
      lVar10 = local_70;
      if (local_70 != 0) {
        LOCK();
      ...
      if (((local_a8 != (Object *)0x0) &&
          (cVar5 = RefCounted::unreference(), pOVar8 = local_a8, cVar5 != '\0')) &&
         (cVar5 = predelete_handler(local_a8), cVar5 != '\0')) {
        (**(code **)(*(long *)pOVar8 + 0x140))(pOVar8);
        Memory::free_static(pOVar8,false);
      }
    }
...
LAB_001016d8:
  ...
  uStack_50 = CONCAT44(fStack_13c,fStack_13c);
  local_58 = local_148;
  EditorNode3DGizmo::add_unscaled_billboard((Ref *)param_1,_LC59,(Color *)&local_a8);
  if (((local_a8 != (Object *)0x0) &&
      (cVar5 = RefCounted::unreference(), pOVar8 = local_a8, cVar5 != '\0')) &&
     (cVar5 = predelete_handler(local_a8), cVar5 != '\0')) {
    (**(code **)(*(long *)pOVar8 + 0x140))(pOVar8);
  ...
  return;
LAB_00101dca:
  local_68 = CONCAT44(fVar16 * fVar14,fVar15 * fVar14);
  lVar9 = local_110 + -1;
  if (lVar10 == 0) goto LAB_001019be;
  lVar10 = *(long *)(lVar10 + -8);
  local_60 = uVar7;
  if (lVar10 <= lVar9) goto LAB_001019dc;
  CowData<Vector3>::_copy_on_write((CowData<Vector3> *)&local_a0);
  *(undefined8 *)(local_a0 + lVar11) = local_68;
  *(uint *)(local_a0 + 8 + lVar11) = local_60;
  local_58 = 0;
  uStack_50 = uStack_50 & 0xffffffff00000000;
  lVar9 = local_110;
  if (local_a0 == 0) {
  ...
  if (lVar10 <= local_110) goto LAB_001019dc;
  iVar6 = iVar6 + 1;
  CowData<Vector3>::_copy_on_write((CowData<Vector3> *)&local_a0);
  lVar10 = local_a0;
  local_110 = local_110 + 2;
  *(ulong *)(local_a0 + 0xc + lVar11) = local_58;
  *(float *)(local_a0 + 0x14 + lVar11) = (float)uStack_50;
  lVar11 = lVar11 + 0x18;
  if (iVar6 == 8) {
    local_88 = param_1;
    cVar5 = RefCounted::init_ref();
...
LAB_00101fe4:
    ...
    uStack_50._0_4_ = fVar17;
    uStack_50._4_4_ = fVar17;
    local_58 = local_148;
    EditorNode3DGizmo::add_lines((Vector *)param_1,(Ref *)&local_a8,SUB81(&local_d8,0),(Color *)0x0)
    ;
    local_90 = 0;
    fVar17 = (float)AudioStreamPlayer3D::get_emission_angle();
    sincosf(fVar17 * __LC7,local_ec,&local_f0);
    local_58 = (ulong)(uint)local_ec[0];
    uStack_50 = CONCAT44(uStack_50._4_4_,(uint)local_f0 ^ __LC6);
    Vector<Vector3>::push_back(local_58,(uint)local_f0 ^ __LC6,(StrRange *)&local_98);
    local_78 = (Object *)0x1028c6;
    local_80 = 0;
    local_c8 = (Object *)0x0;
    local_d0 = 0;
    local_70 = 7;
    String::parse_latin1((StrRange *)&local_d0);
    EditorNode3DGizmoPlugin::get_material((String *)&local_c0,(Ref *)this);
    local_78 = (Object *)0x0;
    if (((local_c0 != (Object *)0x0) &&
        (pOVar8 = (Object *)__dynamic_cast(local_c0,&Object::typeinfo,&Material::typeinfo,0),
        pOVar8 != (Object *)0x0)) &&
       (local_78 = pOVar8, cVar5 = RefCounted::reference(), cVar5 == '\0')) {
      local_78 = (Object *)0x0;
    }
    EditorNode3DGizmo::add_handles
              ((Vector *)param_1,(Ref *)&local_98,(Vector *)&local_78,SUB81(&local_88,0),false);
    if (((local_78 != (Object *)0x0) &&
        (cVar5 = RefCounted::unreference(), pOVar8 = local_78, cVar5 != '\0')) &&
       (cVar5 = predelete_handler(local_78), cVar5 != '\0')) {
      (**(code **)(*(long *)pOVar8 + 0x140))(pOVar8);
      Memory::free_static(pOVar8,false);
    }
    if (((local_c0 != (Object *)0x0) && (cVar5 = RefCounted::unreference(), cVar5 != '\0')) &&
    ...
    if (((local_c8 != (Object *)0x0) &&
        (cVar5 = RefCounted::unreference(), pOVar8 = local_c8, cVar5 != '\0')) &&
    ...
    if (((local_d8 != (Object *)0x0) &&
        (cVar5 = RefCounted::unreference(), pOVar8 = local_d8, cVar5 != '\0')) &&
    ...
    if (((local_e0 != (Object *)0x0) &&
        (cVar5 = RefCounted::unreference(), pOVar8 = local_e0, cVar5 != '\0')) &&
  ...
  sincosf((float)((double)iVar6 * __LC58),local_ec,&local_f0);
  fVar15 = local_ec[0];
  fVar16 = local_f0;
  goto LAB_00101dca;
}
...
/* AudioStreamPlayer3DGizmoPlugin::is_class_ptr(void*) const */

uint __thiscall
AudioStreamPlayer3DGizmoPlugin::is_class_ptr(AudioStreamPlayer3DGizmoPlugin *this,void *param_1)

{
  return (uint)CONCAT71(0x104e,(undefined4 *)param_1 ==
                               &EditorNode3DGizmoPlugin::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x104e,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x104e,(undefined4 *)param_1 == &Resource::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x104e,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x104e,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}



/* AudioStreamPlayer3DGizmoPlugin::_getv(StringName const&, Variant&) const */

undefined8 AudioStreamPlayer3DGizmoPlugin::_getv(StringName *param_1,Variant *param_2)
...
/* AudioStreamPlayer3DGizmoPlugin::_setv(StringName const&, Variant const&) */

undefined8 AudioStreamPlayer3DGizmoPlugin::_setv(StringName *param_1,Variant *param_2)
...
/* AudioStreamPlayer3DGizmoPlugin::_validate_propertyv(PropertyInfo&) const */

void AudioStreamPlayer3DGizmoPlugin::_validate_propertyv(PropertyInfo *param_1)
...
/* AudioStreamPlayer3DGizmoPlugin::_property_can_revertv(StringName const&) const */

undefined8 AudioStreamPlayer3DGizmoPlugin::_property_can_revertv(StringName *param_1)
...
/* AudioStreamPlayer3DGizmoPlugin::_property_get_revertv(StringName const&, Variant&) const */

undefined8
AudioStreamPlayer3DGizmoPlugin::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* AudioStreamPlayer3DGizmoPlugin::_notificationv(int, bool) */

void AudioStreamPlayer3DGizmoPlugin::_notificationv(int param_1,bool param_2)
...
/* AudioStreamPlayer3DGizmoPlugin::_get_class_namev() const */

undefined8 * AudioStreamPlayer3DGizmoPlugin::_get_class_namev(void)
...
LAB_00102713:
  ...
  StringName::assign_static_unique_class_name
            ((StringName *)&_get_class_namev()::_class_name_static,"AudioStreamPlayer3DGizmoPlugin")
  ;
LAB_0010277e:
  return &_get_class_namev()::_class_name_static;
}
...
/* AudioStreamPlayer3DGizmoPlugin::get_class() const */

void AudioStreamPlayer3DGizmoPlugin::get_class(void)
...
/* AudioStreamPlayer3DGizmoPlugin::AudioStreamPlayer3DGizmoPlugin() [clone .cold] */
...
/* AudioStreamPlayer3DGizmoPlugin::_initialize_classv() */

void AudioStreamPlayer3DGizmoPlugin::_initialize_classv(void)

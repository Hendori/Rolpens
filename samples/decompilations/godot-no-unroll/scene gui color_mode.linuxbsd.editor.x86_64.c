...

{
  ...
  *(undefined ***)this = &PTR___cxa_pure_virtual_00105920;
  return;
}
...
LAB_0010199c:
        ...
        lVar13 = puVar7[-1];
        if (param_1 <= lVar13) goto LAB_0010193c;
      }
      else {
        if (lVar14 != 0) {
          pCVar12 = this;
...
LAB_00101e4b:
    ...
    lVar7 = 0;
    if (local_80 != (undefined8 *)0x0) goto LAB_00101c60;
LAB_00101ea7:
    _err_print_index_error
              ("set","./core/templates/cowdata.h",0xcf,1,lVar7,"p_index","size()","",false,false);
    lVar7 = 0;
    if (local_80 != (undefined8 *)0x0) goto LAB_00101c91;
LAB_00101ee4:
    _err_print_index_error
              ("set","./core/templates/cowdata.h",0xcf,2,lVar7,"p_index","size()","",false,false);
    lVar7 = 0;
    if (local_80 != (undefined8 *)0x0) goto LAB_00101cc2;
LAB_00101f21:
    _err_print_index_error
...
LAB_00101f5b:
    _err_print_index_error
              ("set","./core/templates/cowdata.h",0xcf,0,lVar7,"p_index","size()","",false,false);
    lVar7 = 0;
    if (local_90 != (undefined8 *)0x0) goto LAB_00101d22;
LAB_00101fb7:
    _err_print_index_error
              ("set","./core/templates/cowdata.h",0xcf,1,lVar7,"p_index","size()","",false,false);
    lVar7 = 0;
    if (local_90 != (undefined8 *)0x0) goto LAB_00101d4f;
LAB_00101ff4:
    _err_print_index_error
              ("set","./core/templates/cowdata.h",0xcf,2,lVar7,"p_index","size()","",false,false);
    lVar7 = 0;
    if (local_90 != (undefined8 *)0x0) goto LAB_00101d73;
LAB_00102031:
    _err_print_index_error
              ("set","./core/templates/cowdata.h",0xcf,3,lVar7,"p_index","size()","",false,false);
  }
...

{
  ...
  if (param_1 == 3) {
    ...
    uStack_60 = CONCAT44(_LC0,_UNK_00105bf8);
    local_68 = __LC34;
...
LAB_001028bb:
    ...
    lVar6 = 0;
    if (local_90 != (undefined8 *)0x0) goto LAB_00102425;
LAB_0010291e:
    _err_print_index_error
              ("set","./core/templates/cowdata.h",0xcf,1,lVar6,"p_index","size()","",false,false);
    lVar6 = 0;
    if (local_90 != (undefined8 *)0x0) goto LAB_00102448;
LAB_00102960:
    _err_print_index_error
              ("set","./core/templates/cowdata.h",0xcf,2,lVar6,"p_index","size()","",false,false);
    lVar6 = 0;
    if (local_90 != (undefined8 *)0x0) goto LAB_0010246b;
LAB_001029a2:
    _err_print_index_error
...
LAB_001029db:
    _err_print_index_error
              ("set","./core/templates/cowdata.h",0xcf,0,lVar6,"p_index","size()","",false,false);
    lVar6 = 0;
    if (local_a0 != (undefined8 *)0x0) goto LAB_001024be;
LAB_00102a3e:
    _err_print_index_error
              ("set","./core/templates/cowdata.h",0xcf,1,lVar6,"p_index","size()","",false,false);
    lVar6 = 0;
    if (local_a0 != (undefined8 *)0x0) goto LAB_001024eb;
LAB_00102a80:
    _err_print_index_error
              ("set","./core/templates/cowdata.h",0xcf,2,lVar6,"p_index","size()","",false,false);
    lVar6 = 0;
    if (local_a0 != (undefined8 *)0x0) goto LAB_0010250f;
  }
  else {
    lVar6 = local_a0[-1];
    if (lVar6 < 1) goto LAB_001029db;
    CowData<Vector2>::_copy_on_write((CowData<Vector2> *)&local_a0);
    *local_a0 = 0;
LAB_001024be:
    lVar6 = local_a0[-1];
    if (lVar6 < 2) goto LAB_00102a3e;
    CowData<Vector2>::_copy_on_write((CowData<Vector2> *)&local_a0);
    *(undefined4 *)((long)local_a0 + 0xc) = 0;
    *(undefined4 *)(local_a0 + 1) = uVar7;
LAB_001024eb:
    lVar6 = local_a0[-1];
    if (lVar6 < 3) goto LAB_00102a80;
    CowData<Vector2>::_copy_on_write((CowData<Vector2> *)&local_a0);
    local_a0[2] = uVar17;
LAB_0010250f:
    lVar6 = local_a0[-1];
...
LAB_001031a3:
    _err_print_index_error
              ("set","./core/templates/cowdata.h",0xcf,0,lVar7,"p_index","size()","",false,false);
    lVar7 = 0;
    if (local_80 != (undefined8 *)0x0) goto LAB_00102d77;
LAB_001031fd:
    _err_print_index_error
              ("set","./core/templates/cowdata.h",0xcf,1,lVar7,"p_index","size()","",false,false);
    lVar7 = 0;
    if (local_80 != (undefined8 *)0x0) goto LAB_00102dad;
LAB_0010323b:
    _err_print_index_error
              ("set","./core/templates/cowdata.h",0xcf,2,lVar7,"p_index","size()","",false,false);
    lVar7 = 0;
    if (local_80 != (undefined8 *)0x0) goto LAB_00102de3;
LAB_00103279:
    _err_print_index_error
              ("set","./core/templates/cowdata.h",0xcf,3,lVar7,"p_index","size()","",false,false);
  }
...
LAB_001030a3:
    _err_print_index_error
              ("set","./core/templates/cowdata.h",0xcf,0,lVar7,"p_index","size()","",false,false);
    lVar7 = 0;
    if (local_90 != (undefined8 *)0x0) goto LAB_00102e36;
LAB_001030fa:
    _err_print_index_error
              ("set","./core/templates/cowdata.h",0xcf,1,lVar7,"p_index","size()","",false,false);
    lVar7 = 0;
    if (local_90 != (undefined8 *)0x0) goto LAB_00102e63;
LAB_00103135:
    _err_print_index_error
              ("set","./core/templates/cowdata.h",0xcf,2,lVar7,"p_index","size()","",false,false);
    lVar7 = 0;
    if (local_90 != (undefined8 *)0x0) goto LAB_00102e87;
  }
  else {
    lVar7 = local_90[-1];
    if (lVar7 < 1) goto LAB_001030a3;
    CowData<Vector2>::_copy_on_write((CowData<Vector2> *)&local_90);
    *local_90 = 0;
LAB_00102e36:
    lVar7 = local_90[-1];
    if (lVar7 < 2) goto LAB_001030fa;
    CowData<Vector2>::_copy_on_write((CowData<Vector2> *)&local_90);
    *(undefined4 *)((long)local_90 + 0xc) = 0;
    *(undefined4 *)(local_90 + 1) = uVar8;
LAB_00102e63:
    lVar7 = local_90[-1];
    if (lVar7 < 3) goto LAB_00103135;
    CowData<Vector2>::_copy_on_write((CowData<Vector2> *)&local_90);
    local_90[2] = uVar14;
LAB_00102e87:
    lVar7 = local_90[-1];
...

{
  ...
  uStack_90 = CONCAT44(_LC0,_UNK_00105bf8);
...
LAB_00104569:
      ...
      lVar10 = local_c0[-1];
      if (lVar10 < 1) goto LAB_0010440b;
      CowData<Color>::_copy_on_write((CowData<Color> *)&local_c0);
      *local_c0 = local_98;
      local_c0[1] = uStack_90;
LAB_00103c60:
      lVar10 = local_c0[-1];
      if (lVar10 < 2) goto LAB_00104469;
      CowData<Color>::_copy_on_write((CowData<Color> *)&local_c0);
      local_c0[2] = local_58;
      local_c0[3] = uStack_50;
LAB_00103c88:
      lVar10 = local_c0[-1];
      if (lVar10 < 3) goto LAB_001044a9;
      CowData<Color>::_copy_on_write((CowData<Color> *)&local_c0);
      local_c0[4] = local_88;
      local_c0[5] = uStack_80;
LAB_00103cb0:
      lVar10 = local_c0[-1];
      if (lVar10 < 4) goto LAB_001044e9;
      CowData<Color>::_copy_on_write((CowData<Color> *)&local_c0);
      local_c0[6] = local_88;
      local_c0[7] = uStack_80;
LAB_00103cd8:
      lVar10 = local_c0[-1];
      if (lVar10 < 5) goto LAB_00104529;
      CowData<Color>::_copy_on_write((CowData<Color> *)&local_c0);
      local_c0[8] = local_58;
      local_c0[9] = uStack_50;
LAB_00103d00:
      lVar10 = local_c0[-1];
      if (lVar10 < 6) goto LAB_00104569;
      CowData<Color>::_copy_on_write((CowData<Color> *)&local_c0);
...
LAB_001045a3:
      ...
      lVar10 = 0;
      fVar15 = fVar13 * _LC53;
      if (local_d0 != (undefined8 *)0x0) goto LAB_00103d6a;
LAB_00104611:
      _err_print_index_error
                ("set","./core/templates/cowdata.h",0xcf,1,lVar10,"p_index","size()","",false,false)
      ;
      lVar10 = 0;
      if (local_d0 != (undefined8 *)0x0) goto LAB_00103d90;
LAB_0010464e:
      _err_print_index_error
                ("set","./core/templates/cowdata.h",0xcf,2,lVar10,"p_index","size()","",false,false)
      ;
      lVar10 = 0;
      if (local_d0 != (undefined8 *)0x0) goto LAB_00103dbd;
LAB_0010468b:
      _err_print_index_error
                ("set","./core/templates/cowdata.h",0xcf,3,lVar10,"p_index","size()","",false,false)
      ;
      lVar10 = 0;
      if (local_d0 != (undefined8 *)0x0) goto LAB_00103de1;
LAB_001046c8:
      _err_print_index_error
                ("set","./core/templates/cowdata.h",0xcf,4,lVar10,"p_index","size()","",false,false)
      ;
      lVar10 = 0;
      if (local_d0 != (undefined8 *)0x0) goto LAB_00103e13;
    }
    else {
      lVar10 = local_d0[-1];
      if (lVar10 < 1) goto LAB_001045a3;
      CowData<Vector2>::_copy_on_write((CowData<Vector2> *)&local_d0);
      fVar15 = fVar13 * _LC53;
      *local_d0 = 0;
LAB_00103d6a:
      lVar10 = local_d0[-1];
      if (lVar10 < 2) goto LAB_00104611;
      CowData<Vector2>::_copy_on_write((CowData<Vector2> *)&local_d0);
      *(float *)(local_d0 + 1) = fVar15;
      *(undefined4 *)((long)local_d0 + 0xc) = 0;
LAB_00103d90:
      lVar10 = local_d0[-1];
      if (lVar10 < 3) goto LAB_0010464e;
      CowData<Vector2>::_copy_on_write((CowData<Vector2> *)&local_d0);
      *(undefined4 *)((long)local_d0 + 0x14) = 0;
      *(float *)(local_d0 + 2) = fVar13;
LAB_00103dbd:
      lVar10 = local_d0[-1];
      if (lVar10 < 4) goto LAB_0010468b;
      CowData<Vector2>::_copy_on_write((CowData<Vector2> *)&local_d0);
      local_d0[3] = uVar18;
LAB_00103de1:
      lVar10 = local_d0[-1];
      if (lVar10 < 5) goto LAB_001046c8;
      CowData<Vector2>::_copy_on_write((CowData<Vector2> *)&local_d0);
...
LAB_001040b3:
      ...
      ;
      lVar10 = 0;
      if (local_c0 != (undefined8 *)0x0) goto LAB_00103515;
LAB_00104111:
      _err_print_index_error
                ("set","./core/templates/cowdata.h",0xcf,1,lVar10,"p_index","size()","",false,false)
      ;
      lVar10 = 0;
      if (local_c0 != (undefined8 *)0x0) goto LAB_0010353d;
LAB_00104151:
      _err_print_index_error
                ("set","./core/templates/cowdata.h",0xcf,2,lVar10,"p_index","size()","",false,false)
      ;
      lVar10 = 0;
      if (local_c0 != (undefined8 *)0x0) goto LAB_00103565;
LAB_00104191:
      _err_print_index_error
                ("set","./core/templates/cowdata.h",0xcf,3,lVar10,"p_index","size()","",false,false)
      ;
      ...
      lVar10 = local_c0[-1];
      if (lVar10 < 1) goto LAB_001040b3;
      CowData<Color>::_copy_on_write((CowData<Color> *)&local_c0);
      *local_c0 = local_98;
      local_c0[1] = uStack_90;
LAB_00103515:
      lVar10 = local_c0[-1];
      if (lVar10 < 2) goto LAB_00104111;
      CowData<Color>::_copy_on_write((CowData<Color> *)&local_c0);
      local_c0[2] = local_88;
      local_c0[3] = uStack_80;
LAB_0010353d:
      lVar10 = local_c0[-1];
      if (lVar10 < 3) goto LAB_00104151;
      CowData<Color>::_copy_on_write((CowData<Color> *)&local_c0);
      local_c0[4] = local_88;
      local_c0[5] = uStack_80;
LAB_00103565:
      lVar10 = local_c0[-1];
      if (lVar10 < 4) goto LAB_00104191;
      CowData<Color>::_copy_on_write((CowData<Color> *)&local_c0);
      local_c0[6] = local_98;
...
LAB_001041cb:
      ...
      ;
      lVar10 = 0;
      if (local_d0 != (undefined8 *)0x0) goto LAB_001035bc;
LAB_00104226:
      _err_print_index_error
                ("set","./core/templates/cowdata.h",0xcf,1,lVar10,"p_index","size()","",false,false)
      ;
      lVar10 = 0;
      if (local_d0 != (undefined8 *)0x0) goto LAB_001035e9;
LAB_00104263:
      _err_print_index_error
                ("set","./core/templates/cowdata.h",0xcf,2,lVar10,"p_index","size()","",false,false)
      ;
      lVar10 = 0;
      if (local_d0 != (undefined8 *)0x0) goto LAB_0010360d;
    }
    else {
      lVar10 = local_d0[-1];
      if (lVar10 < 1) goto LAB_001041cb;
      CowData<Vector2>::_copy_on_write((CowData<Vector2> *)&local_d0);
      *local_d0 = 0;
LAB_001035bc:
      lVar10 = local_d0[-1];
      if (lVar10 < 2) goto LAB_00104226;
      CowData<Vector2>::_copy_on_write((CowData<Vector2> *)&local_d0);
      *(undefined4 *)((long)local_d0 + 0xc) = 0;
      *(float *)(local_d0 + 1) = fVar13;
LAB_001035e9:
      lVar10 = local_d0[-1];
      if (lVar10 < 3) goto LAB_00104263;
      CowData<Vector2>::_copy_on_write((CowData<Vector2> *)&local_d0);
      local_d0[2] = uVar18;
LAB_0010360d:
      lVar10 = local_d0[-1];
...
LAB_00103e4e:
      ...
      lVar12 = local_b0[-1];
      if (lVar12 <= lVar10) goto LAB_00103e4e;
      ...
      *(float *)((long)local_b0 + lVar10 * 4) = fVar13;
      ...
      if (local_a0 == 0) goto LAB_00103e48;
...
{
                    /* WARNING: Could not recover jumptable at 0x00104a27. Too many branches */
...

{
  ...
  pCVar3 = this + 0x20;
  *(undefined ***)this = &PTR_get_name_00105aa0;
  do {
    if (*(long *)pCVar3 != 0) {
      LOCK();
...

{
  ...
  pCVar3 = this + 0x20;
  *(undefined ***)this = &PTR_get_name_001059a0;
  do {
    if (*(long *)pCVar3 != 0) {
      LOCK();
      plVar1 = (long *)(*(long *)pCVar3 + -0x10);
...

{
  ...
  pCVar3 = this + 0x20;
  *(undefined ***)this = &PTR_get_name_00105a20;
  do {
    if (*(long *)pCVar3 != 0) {
      LOCK();
      plVar1 = (long *)(*(long *)pCVar3 + -0x10);
...

{
  ...
  *(undefined ***)this = &PTR_get_name_00105b20;
  if (*(long *)(this + 0x40) != 0) {
    cVar4 = RefCounted::unreference();
    if (cVar4 != '\0') {
...

{
  ...
  if (cVar1 == '\0') {
    ...
    *(undefined8 *)this = 0;
    ...
    pOVar3 = *(Object **)this;
    pOVar2 = pOVar3;
    if (this_00 == (GradientTexture2D *)pOVar3) goto LAB_00105515;
    *(GradientTexture2D **)this = this_00;
    ...
    if (((pOVar3 == (Object *)0x0) || (cVar1 = RefCounted::unreference(), cVar1 == '\0')) ||
       (cVar1 = predelete_handler(pOVar3), cVar1 == '\0')) goto LAB_00105515;
  }
  (**(code **)(*(long *)pOVar3 + 0x140))(pOVar3);
  Memory::free_static(pOVar3,false);
  pOVar2 = (Object *)this_00;

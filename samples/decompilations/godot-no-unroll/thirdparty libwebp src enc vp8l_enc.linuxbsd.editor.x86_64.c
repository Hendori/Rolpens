...
LAB_00101268:
      ...
      *(int *)(param_1 + 1) = iVar8 + 1;
      ...
      do {
        ...
        lVar14 = lVar5 + -1;
      } while (local_78[(byte)(&DAT_0010476f)[lVar5]] == '\0');
      iVar8 = (int)param_1[1];
...
LAB_00101d77:
      ...
      local_638 = (uint *)(param_1 + 4);
      puVar2 = local_638 + (long)iVar4 * 7;
        ...
        if ((*(int *)(lVar11 + 0x5c) < 100) && (plVar13[0xb] == 0)) {
          ...
          *(undefined4 *)(plVar13 + 3) = 2;
          if (*(int *)((long)plVar13 + 0x5c) != 0) {
            lVar49 = plVar13[1];
LAB_00101ef5:
            iVar21 = PaletteSort(local_638[1],lVar49,(long)plVar13 + 0x464,(int)plVar13[0xc]);
            if (iVar21 == 0) {
            ...
            if (0 < (int)uVar44) {
              ...
              do {
                ...
                iVar28 = VP8LGetBackwardReferences
                                   (iVar24,iVar8,lVar49,iVar22,bVar51,local_638[lStack_5c0 * 2 + 2],
                                    iVar21,local_638[lStack_5c0 * 2 + 3],plVar13 + 0x121,plVar1,
...
LAB_00103121:
                ...
                do {
                  ...
                  iVar28 = VP8LGetHistoImageSymbols
                                     (iVar24,iVar8,local_628,iVar22,bVar51,iVar39,iVar27,piVar34,
                                      lVar35,lVar33,lVar10,iVar28,&local_520);
                  if (iVar28 == 0) goto LAB_00103121;
                  iVar28 = *piVar34;
                  iVar30 = iVar28 * 5;
...
LAB_0010284d:
                    ...
                    do {
                      ...
                      piVar34 = piVar34 + 6;
                    } while (piVar34 != piVar36 + (long)iVar30 * 6);
...
LAB_00102e9f:
                  ...
                  uVar18 = puVar12[3];
                  uVar19 = puVar12[1];
                  iVar28 = StoreImageToBitMask(puVar12,iVar24,iVar39,local_628,lVar33,piVar36,lVar10
                                              );
                  if (iVar28 == 0) goto LAB_00102ec0;
                  uVar16 = puVar12[3];
                  uVar17 = puVar12[2];
                  ...
                  WebPSafeFree(*(undefined8 *)(piVar36 + 4));
                  WebPSafeFree(piVar36);
                  if ((local_638[lStack_5c0 * 2 + 3] == 0) || (local_628 == plVar13 + 0x112)) break;
                  local_628 = local_628 + 5;
                  iVar27 = 0;
                } while (iStack_51c != 0);
...
LAB_00102166:
        ...
        local_638 = local_638 + 7;
      } while (local_638 != puVar2);
    }
...
LAB_001041b1:
            ...
            if (0 < (int)uVar30) goto LAB_00104188;
            goto LAB_00103639;
          }
...
LAB_00104115:
            WebPSafeFree(lVar16);
            if (iVar2 == 6) {
              if (*(float *)(lVar3 + 4) == __LC0) goto LAB_001041b1;
              local_548[0] = iVar5;
              if (iVar6 < 0x101) goto LAB_001034b6;
              local_548[1] = 3;
            }
            else {
...
LAB_00103639:
        ...
        if (*(int *)(param_1 + 0x54) < 1) {
          ...
          uVar24 = uVar30;
          local_210 = uVar30;
          if (0 < (int)uVar30) goto LAB_001036e0;
LAB_00103e0b:
...
LAB_00103925:
          ...
          local_50 = uVar23;
          if ((int)uVar30 < 2) {
            if (0 < (int)uVar24) goto LAB_001036e0;
LAB_00103702:
            local_210 = uVar24;
            if ((int)uVar23 < 1) goto LAB_00103e0b;
          }
          else {
...

{
  ...
  if (iVar11 == 0) goto LAB_00104618;
  iVar11 = WebPReportProgress(param_2,1,&local_8c);
  if (iVar11 == 0) goto LAB_001046d0;
  ...
  if (local_60 == 0) {
    ...
    local_80 = local_80 + 3;
    if (local_60 != 0) goto LAB_00104618;
...
LAB_001046d0:
      ...
      if (iVar11 != 0) {
        ...
        if (local_60 == 0) {
          uStack_50 = (undefined5)_UNK_00104798;
...
LAB_00104736:
          if (iVar11 == 0) goto LAB_00104625;
          iVar11 = 0;
        }
        iVar7 = WebPReportProgress(param_2,100,&local_8c);
        if (iVar7 == 0) goto LAB_001046d0;

...

{
  ...
  if ((*(int *)(param_1 + 0xaf0) == 0) || (cVar27 = *(char *)((long)puVar8 + 0x31d), cVar27 == '\0')
     ) {
    bVar3 = *(byte *)((long)puVar8 + 0x31e);
    *puVar8 = 0;
    puVar8[0x5f] = 0;
    puVar10 = (undefined8 *)((ulong)(puVar8 + 1) & 0xfffffffffffffff8);
    for (uVar13 = (ulong)(((int)puVar8 -
    ...
    if (*(char *)(puVar8 + 0x60) == '\0') {
      ...
      *(bool *)(lVar4 + -1) = 0 < iVar7;
      ...
      if (iVar7 < 2) {
        puVar10 = puVar8;
        do {
          *(short *)puVar10 = (short)((short)local_68._0_2_ + 3 >> 3);
          puVar10 = puVar10 + 4;
        } while (puVar10 != puVar8 + 0x40);
      }
      else {
    ...
    uVar23 = 0;
    psVar19 = (short *)(puVar8 + 0x10);
    uVar21 = *(byte *)(lVar4 + -2) & 0xf;
    uVar13 = (ulong)(*pbVar1 & 0xf);
    do {
      uVar22 = 0;
      uVar5 = uVar21 & 1;
      psVar26 = psVar19 + -0x40;
      do {
        psVar24 = psVar26;
        iVar6 = (*GetCoeffs)(param_2,local_c8,((uint)uVar13 & 1) + uVar5,param_1 + 0x424 + lVar9,
                             iVar7,psVar24);
        uVar17 = 3;
        uVar11 = (uint)(iVar7 < iVar6) << 7;
        uVar5 = (uint)(iVar7 < iVar6);
        uVar16 = (uint)(uVar13 >> 1) | uVar11;
        uVar13 = (ulong)uVar16;
        if ((iVar6 < 4) && (uVar17 = 2, iVar6 < 2)) {
          uVar17 = (uint)(*psVar24 != 0);
        }
        uVar22 = uVar22 * 4 | uVar17;
        psVar26 = psVar24 + 0x10;
      } while (psVar24 + 0x10 != psVar19);
      uVar13 = (ulong)(byte)((byte)uVar16 >> 4);
      psVar19 = psVar24 + 0x50;
      uVar21 = uVar21 >> 1 | uVar11;
      uVar23 = uVar23 << 8 | uVar22;
    } while (psVar19 != (short *)(puVar8 + 0x50));
    sVar25 = 0;
    uVar21 = uVar21 >> 4;
    uVar5 = 0;
    psVar19 = (short *)(puVar8 + 0x58);
    while( true ) {
      psVar26 = psVar19 + -0x40;
      uVar11 = 0;
      uVar18 = (ulong)(uint)((int)(uint)*pbVar1 >> sVar25 + 4);
      uVar22 = (int)(uint)*(byte *)(lVar4 + -2) >> sVar25 + 4;
      do {
        uVar16 = uVar22 & 1;
        psVar24 = psVar26 + -0x20;
        do {
          psVar20 = psVar24;
          iVar7 = (*GetCoeffs)(param_2,param_1 + 0x9e0,uVar16 + ((uint)uVar18 & 1),
                               param_1 + 0x434 + lVar9,0,psVar20);
          uVar16 = (uint)(0 < iVar7);
          uVar17 = (uint)(uVar18 >> 1) & 0x7f | (uint)(0 < iVar7) * 8;
          uVar18 = (ulong)uVar17;
          uVar12 = 3;
          if ((iVar7 < 4) && (uVar12 = 2, iVar7 < 2)) {
            uVar12 = (uint)(*psVar20 != 0);
          }
          uVar11 = uVar11 << 2 | uVar12;
          psVar24 = psVar20 + 0x10;
        } while (psVar20 + 0x10 != psVar26);
        uVar12 = (uint)(0 < iVar7) << 5;
        psVar26 = psVar20 + 0x30;
        bVar15 = (byte)uVar17 >> 2;
        uVar18 = (ulong)bVar15;
        uVar16 = uVar22 >> 1;
        uVar22 = uVar12 | uVar16 & 0x7f;
      } while (psVar26 != psVar19);
      psVar19 = psVar20 + 0x70;
      uVar5 = uVar5 | uVar11 << sVar25 * '\x04';
      uVar22 = (uint)uVar13 | ((uint)bVar15 << 4) << sVar25;
      uVar13 = (ulong)uVar22;
      uVar21 = uVar21 | (uVar12 | uVar16 & 0x70) << sVar25;
      if (sVar25 == 2) break;
      sVar25 = 2;
    }
    *pbVar1 = (byte)uVar22;
    uVar14 = 0;
    *(char *)(lVar4 + -2) = (char)uVar21;
    *(uint *)((long)puVar8 + 0x314) = uVar23;
    *(uint *)(puVar8 + 99) = uVar5;
    if ((uVar5 & 0xaaaa) == 0) {
      uVar14 = *(undefined1 *)(param_1 + 0x440 + (ulong)bVar3 * 0x20);
    }
    cVar27 = uVar23 == 0 && uVar5 == 0;
  }
  else {
    *pbVar1 = 0;
  ...
  *(undefined1 *)((long)puVar8 + 0x31c) = uVar14;
    ...
    if (0 < param_1[0x6b]) {
      ...
      do {
        ...
        if (iVar2 == 0) {
          ...
          if (*param_1 != 0) goto LAB_001020bf;
LAB_0010218f:

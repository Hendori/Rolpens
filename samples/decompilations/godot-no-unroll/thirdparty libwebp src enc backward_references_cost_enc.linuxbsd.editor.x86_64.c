...

{
  ...
  puVar10 = (ushort *)WebPSafeMalloc(lVar29,2);
...
LAB_00100d81:
        ...
        *(undefined4 *)(puVar12 + 1) = 0;
        ...
        if (0 < param_2) {
          ...
          puVar12[3] = 1;
          if (param_2 == 1) goto LAB_0010163d;
          lVar15 = 1;
          lVar31 = 1;
          ...
          if (pfVar16 != (float *)0x0) {
            ...
            *pfVar16 = fVar37;
            ...
            pfVar16 = (float *)WebPSafeMalloc(lVar29,4);
            puVar12[0x804] = pfVar16;
            if (pfVar16 == (float *)0x0) goto LAB_00101607;
            bVar36 = true;
LAB_00100cce:
            bVar7 = bVar36;
            fVar37 = _LC2;
...
LAB_0010163d:
        ...
        puVar12[2] = puVar20;
        if (puVar20 == (undefined4 *)0x0) goto LAB_00101607;
        uVar2 = *(undefined4 *)(puVar12 + 4);
        *(undefined8 *)(puVar20 + 1) = _LC1;
        *puVar20 = uVar2;
        pfVar16 = (float *)WebPSafeMalloc(lVar29);
        puVar12[0x804] = pfVar16;
        if (pfVar16 == (float *)0x0) goto LAB_00101607;
        bVar7 = false;
        bVar36 = false;
              ...
              if (uVar32 == uVar23) {
                ...
                if (iVar9 < (int)(((uVar25 & 0xfff) - 1) + iVar33)) {
                  ...
                  do {
                    uVar18 = uVar8;
                    iVar22 = (int)uVar18;
                    if (iVar9 < iVar22) goto LAB_001014b5;
...
LAB_001014b5:
        ...
        if (local_70 != 0) goto LAB_00100d81;
      }
      CostManagerClear_part_0(puVar12);
      WebPSafeFree(lVar11);
      WebPSafeFree(puVar12);
      if (bVar36) {
        puVar27 = puVar10 + lVar29 + -1;
        puVar34 = puVar10 + lVar29;
        if (puVar27 < puVar10) {
          if (param_4 < 1) {
...
LAB_00101056:
          ...
          iVar30 = (int)((long)(puVar10 + lVar29) - (long)puVar34 >> 1);
          if (param_4 < 1) {
            VP8LClearBackwardRefs(param_7);
            if (iVar30 < 1) goto LAB_001016aa;
            iVar9 = 0;
          }
          else {
            ...
            VP8LClearBackwardRefs(param_7);
            if (iVar30 < 1) goto LAB_00101056;
          }
          lVar29 = 0;
          iVar33 = 0;
          do {
            while( true ) {
              uVar3 = puVar34[lVar29];
              lVar11 = (long)iVar33;
              uVar23 = (uint)uVar3;
              if (uVar3 != 1) break;
              uVar23 = param_3[lVar11];
              if (param_4 < 1) {
LAB_00100fb4:
                uVar21 = 0;
                uVar25 = uVar23;
              ...
              if (iVar30 <= (int)lVar29) goto LAB_00100f5b;
            }
            unaff_RBP = CONCAT44(*(uint *)(*param_5 + lVar11 * 4) >> 0xc,
                                 (uint)CONCAT71((int7)((ulong)unaff_RBP >> 8),2) & 0xffff |
                                 (uint)uVar3 << 0x10);
            VP8LBackwardRefsCursorAdd(param_7,unaff_RBP);
            if ((0 < param_4) && (uVar23 != 0)) {
              puVar17 = param_3 + lVar11;
              do {
                uVar25 = *puVar17;
                puVar17 = puVar17 + 1;
                *(uint *)(local_58 + (long)(int)(uVar25 * 0x1e35a7bd >> ((byte)local_50 & 0x1f)) * 4
                         ) = uVar25;
              } while (puVar17 != param_3 + lVar11 + (ulong)(uVar23 - 1) + 1);
            }
            iVar33 = iVar33 + uVar23;
            lVar29 = lVar29 + 1;
          } while ((int)lVar29 < iVar30);
LAB_00100f5b:
          bVar36 = *(int *)(param_7 + 4) == 0;
          if (iVar9 == 0) goto LAB_00100f76;
        }

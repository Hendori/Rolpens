...

{
  ...
  if (in_RSI < 0) {
    ...
    return CONCAT44(_UNK_0010b864,(uint)((float)lVar1 * __LC8 + fVar4) ^ _LC9);
  }
...
LAB_00106d91:
  ...
  if (in_XMM7_Da <= fVar27) goto LAB_001073e0;
    ...
    *(float *)(this + 0x14) = fVar31;
    if (param_2 != 0) {
      ...
      do {
        *puVar10 = uVar4;
        puVar10[1] = uVar5;
        puVar10 = puVar10 + 2;
      } while (puVar10 != local_80 + (ulong)(uint)param_2 * 2);
    ...
    if (*(int *)(this + 0x28) != 0) {
      ...
      *(undefined1 (*) [16])(this + 0x18) = (undefined1  [16])0x0;
      if (uVar6 <= (uint)param_2) goto LAB_0010736e;
LAB_0010712c:
...
LAB_00107133:
      ...
      uVar4 = __LC53;
      iVar22 = (int)local_88;
      if (param_2 < 1) goto LAB_001071fa;
      uVar23 = local_88 & 0xffffffff;
      uVar17 = 0;
      break;
    }
    uVar6 = *(uint *)(this + 0x150);
    if ((uint)param_2 < uVar6) goto LAB_0010712c;
LAB_0010736e:
    if ((uint)param_2 <= uVar6) goto LAB_00107133;
    if ((uint)param_2 <= *(uint *)(this + 0x154)) goto LAB_0010712c;
...
LAB_001073e0:
    ...
    if (fVar27 < in_XMM8_Da) {
      ...
      *(undefined4 *)(this + 0x16c) = 2;
      uVar14 = uVar13;
      if (in_XMM7_Da < in_XMM8_Da) goto LAB_00107437;
LAB_00107460:
    ...
    *(undefined4 *)(this + 0x16c) = 0;
    if (fVar27 < in_XMM7_Da) {
      ...
      uVar8 = 1;
      uVar7 = 1;
      if (in_XMM8_Da <= fVar27) goto LAB_00107437;
      goto LAB_00107460;
    }
    uVar13 = 1;
    uVar7 = 2;
...
LAB_001074a8:
  ...
  *(undefined8 *)pauVar1[7] = uVar11;
  uVar15 = uVar17;
  if (uVar6 <= (uint)uVar17) goto LAB_001074a8;
    ...
    do {
      ...
      do {
        if ((int)uVar19 == 0) {
          ...
          fVar32 = *(float *)(this + 8);
          if (0.0 < param_2) {
            if ((int)uVar18 < 1) goto LAB_001077ee;
...
LAB_00108178:
              ...
              while( true ) {
                ...
                puVar26 = puVar26 + 1;
                if (uVar18 <= uVar29) goto LAB_00108178;
              }
LAB_001077ee:
              _local_4c = auVar38;
              if (local_98 != (undefined8 *)0x0) goto LAB_001077f3;
            }
            if (plVar24 != (long *)0x0) {
        ...
        if (iVar1 != *(int *)(lVar12 + 0x78)) {
          *(int *)(lVar12 + 0x78) = iVar1;
          ...
          if (local_78 == local_74) {
            ...
            if (local_70 == (long *)0x0) goto LAB_00108010;
          }
          local_78 = uVar29 + 1;
        ...
        if (iVar1 != (int)local_118[5]) {
          ...
          *(Face **)(lVar27 + 0x20) = pFVar20;
          if (local_88 == uVar18) {
            ...
            if (local_98 == (undefined8 *)0x0) goto LAB_00108010;
          }
          uVar19 = (ulong)uVar18;
          uVar18 = uVar18 + 1;
...

{
  ...
  if (param_3 <= 0.0) {
    ...
    fVar22 = param_4;
    if (local_1fc < 0.0) goto LAB_001084e5;
  }
  local_1f8 = 0;
  local_1f0 = (void *)0x0;
              ...
              if ((int)uVar12 < 0) {
                ...
                if (uVar12 == uVar17) {
                  ...
                  *(void **)(this + 0x18) = pvVar8;
                  if (pvVar8 == (void *)0x0) goto LAB_001088c2;
...
joined_r0x0010872d:
              ...
              uVar15 = uVar12;
              if (-1 < (int)uVar19) {
                if (uVar17 <= uVar12) goto LAB_001087a0;
...
LAB_00108931:
        ...
        if (-1 < (int)lVar5) {
          ...
          if (uVar17 == *(uint *)(this + 0x24)) {
            ...
            *(void **)(this + 0x28) = pvVar11;
            if (pvVar11 == (void *)0x0) goto LAB_001088c2;
            uVar17 = *(uint *)(this + 0x20);
          }
    ...
    if (uVar20 == uVar18) goto LAB_00108a13;
  }
LAB_00108771:
  _err_print_index_error
...

{
  ...
  *(undefined8 *)(param_2 + 0x20) = 0;
  ...
  uVar17 = 1;
  if (*(long *)(pVVar9 + -8) == 0) goto LAB_00108b4e;
  local_78 = 0;
  local_70 = 0;
  local_68 = 0;
  local_60 = 0;
...
LAB_00108bec:
    if ((uint)local_78 != 0) goto LAB_00108bf0;
  }
  else {
    if ((uint)local_78 <= uVar15) goto LAB_00108bec;
    ...
    if (*(uint *)(param_2 + 0x24) < (uint)local_78) {
      ...
      *(long *)(param_2 + 0x28) = lVar20;
      if (lVar20 == 0) goto LAB_001090ab;
      uVar15 = *(uint *)(param_2 + 0x20);
      if (uVar15 < uVar12) goto LAB_00108cd5;
    }
    else {
LAB_00108cd5:
...
LAB_00108bf0:
  ...
  if ((uint)local_68 != 0) {
    ...
    if (pvVar19 == (void *)0x0) goto LAB_001090ab;
    uVar22 = 0;
    do {
      uVar31 = uVar22;
      if (uVar22 == (uVar27 & 0xffffffff)) goto LAB_00108da4;
...
LAB_00108d86:
      ...
      do {
        ...
        uVar31 = (ulong)uVar13;
        if (uVar15 <= uVar13) goto LAB_00108d86;
...
LAB_00108f16:
  ...
  if (uVar12 != 0) {
    ...
    do {
      ...
      uVar31 = uVar30;
      if (*(uint *)param_2 <= (uint)uVar30) goto LAB_00108da4;
...
LAB_00109e67:
      ...
      if (local_18 <= *piVar6) {
        if (local_18 != *piVar6) goto LAB_00109e67;
...
LAB_0010a20d:
        ...
        if (iVar1 == iVar12) {
          iVar2 = *(int *)pPVar7;
          if (iVar2 < *(int *)pPVar10) goto LAB_0010a20d;
          if ((iVar2 == *(int *)pPVar10) &&
             (iVar15 = iVar1, iVar11 = *(int *)(pPVar7 + 8),
             *(int *)(pPVar7 + 8) < *(int *)(pPVar10 + 8))) goto LAB_00109fd7;
        }
        if (iVar12 <= iVar13) {
          iVar2 = *(int *)pPVar8;
          if (iVar13 == iVar12) {
...
LAB_0010a1eb:
        ...
        if (iVar13 == iVar12) {
          ...
          goto LAB_00109fd7;
          if (iVar12 <= iVar1) goto LAB_0010a32e;
        }
        else {
          if (iVar1 < iVar12) goto LAB_0010a1eb;
          if (iVar1 != iVar12) goto LAB_0010a208;
          iVar13 = *(int *)pPVar10;
LAB_0010a32e:
          iVar2 = *(int *)pPVar7;
          if (iVar13 <= iVar2) {
...
LAB_0010a039:
          ...
          _err_print_error("partitioner","./core/templates/sort_array.h",0xb9,
                           "bad comparison function; sorting will be broken",0,0);
joined_r0x0010a009:
          if (lVar9 <= param_2) goto LAB_0010a150;
...
LAB_0010a150:
  ...
  lVar14 = param_2;
  if (param_4 == 0) goto LAB_0010a218;
  goto LAB_00109f80;
}
...
LAB_0010a5f3:
    iVar4 = *(int *)(this + 0x28);
    if (*(uint *)(this + 0x2c) < (uint)(*(int *)(this + 0x38) * iVar4)) goto LAB_0010a605;
LAB_0010aa10:
    if (iVar4 != 0) {
      lVar5 = 0;
      do {
    ...
    if (*(int *)(this + 0x90) == 0) goto LAB_0010a5f3;
    lVar5 = 0;
    do {
      Memory::free_static(*(void **)(*(long *)(this + 0x80) + lVar5 * 8),false);
      lVar2 = lVar5 * 8;
    ...
    Memory::free_static(*(void **)(this + 0x88),false);
    iVar4 = *(int *)(this + 0x28);
    if ((uint)(*(int *)(this + 0x38) * iVar4) <= *(uint *)(this + 0x2c)) goto LAB_0010aa10;
LAB_0010a605:
    if ((char)CoreGlobals::leak_reporting_enabled != '\0') {
      local_50 = 0;
      local_40 = 0x1d;
...
LAB_0010afd2:
      ...
      if ((*(int *)(__src + 4) == iVar2) &&
         ((iVar12 < *(int *)__src ||
          ((*(int *)__src == iVar12 && ((int)uVar4 < *(int *)(__src + 8))))))) goto LAB_0010afd2;
      while( true ) {
...
LAB_0010aed3:
        ...
        *(undefined8 *)(__src + 8) = uVar4;
        lVar6 = lVar9 + 1;
        if (lVar9 + 1 == 0x10) goto LAB_0010af00;
      }
      iVar12 = (int)uVar3;
      pPVar5 = pPVar14;
      lVar6 = lVar9;
      if ((*(int *)(__src + 4) == iVar2) &&
         ((iVar12 < *(int *)__src ||
          ((*(int *)__src == iVar12 && ((int)uVar4 < *(int *)(__src + 8))))))) goto LAB_0010aed3;
      while( true ) {
        iVar11 = *(int *)(pPVar5 + -0xc);
        if ((iVar11 == iVar2 || iVar11 < iVar2) &&
           ((iVar11 != iVar2 ||
  ...
  if (param_1 < uVar7) {
    ...
    if (*(uint *)(this + 4) < param_1) {
      ...
      *(long *)(this + 8) = lVar6;
      ...
      uVar7 = *(uint *)this;
      if (param_1 <= uVar7) goto LAB_0010b6eb;
    }
    lVar6 = *(long *)(this + 8);

...
/* CompareOpCounters(std::pair<SpvOp, unsigned long>, std::pair<SpvOp, unsigned long>) */

bool CompareOpCounters(undefined8 param_1,ulong param_2,undefined8 param_3,ulong param_4)
...
/* smolv_CheckSmolHeader(unsigned char const*, unsigned long) */

bool smolv_CheckSmolHeader(uchar *param_1,ulong param_2)

{
  ...
  else if (((*(int *)param_1 == 0x534d4f4c) &&
           ((*(uint *)(param_1 + 4) & 0xffffff) - 0x10000 < 0x601)) && (0x17 < param_2)) {
...
/* smolv_ReadLengthOp(unsigned char const*&, unsigned char const*, unsigned int&, SpvOp&) */

undefined8 smolv_ReadLengthOp(uchar **param_1,uchar *param_2,uint *param_3,SpvOp *param_4)
...
/* smolv::GetDecodedBufferSize(void const*, unsigned long) */

undefined4 smolv::GetDecodedBufferSize(void *param_1,ulong param_2)

{
  ...
  if ((*param_1 == 0x534d4f4c) &&
     ((((*(uint *)((long)param_1 + 4) & 0xffffff) - 0x10000 < 0x601 && (0x17 < param_2)) &&
      (*(uint *)((long)param_1 + 4) < 0x2000000)))) {
...
/* smolv::Decode(void const*, unsigned long, void*, unsigned long, unsigned int) */

undefined8 smolv::Decode(void *param_1,ulong param_2,void *param_3,ulong param_4,uint param_5)

{
  ...
  if ((cVar4 == '\0') ||
     (uVar2 = *(uint *)((long)param_1 + 0x14), param_4 <= (ulong)uVar2 - 1 || param_3 == (void *)0x0
     )) {
LAB_0010027a:
    uVar8 = 0;
    goto LAB_0010027c;
...
LAB_0010082a:
        if ((local_50 < 10) && (puVar16 = puVar7, uVar6 == 0xd)) goto LAB_00100a68;
LAB_0010083c:
        puVar16 = puVar7 + (local_50 - uVar22);
        puVar11 = local_48;
        puVar18 = puVar7;
        puVar10 = local_48;
        if (uVar22 < local_50) {
...
LAB_00100892:
            bVar13 = 0;
LAB_00100753:
            if ((local_50 < 10) && (puVar16 = puVar7, uVar6 == 0xd)) {
LAB_00100a68:
...
LAB_00100450:
          ...
          if (local_71 != 0) {
            ...
            *puVar16 = local_84;
            bVar13 = bVar15;
            if ((local_4c == 0x48) || (bVar13 = bVar5, bVar15 != 0)) goto LAB_00100753;
            lVar24 = (long)(int)local_4c;
            uVar9 = (ulong)(byte)kSpirvOpData[lVar24 * 4 + 2];
LAB_00100679:
            uVar22 = uVar21;
...
/* smolv::StatsDelete(smolv::Stats*) */

void smolv::StatsDelete(Stats *param_1)
...
/* smolv::StatsCalculate(smolv::Stats*, void const*, unsigned long) */

undefined8 smolv::StatsCalculate(Stats *param_1,void *param_2,ulong param_3)

{
  ...
  uint *puVar6;
                    ...
                    /* WARNING: Load size is inaccurate */
  if (((((param_1 != (Stats *)0x0) && ((param_3 & 3) == 0)) && (param_2 != (void *)0x0)) &&
      ((4 < param_3 >> 2 && (*param_2 == 0x7230203)))) &&
     (*(int *)((long)param_2 + 4) - 0x10000U < 0x601)) {
    ...
    *(ulong *)(param_1 + 0x2330) = *(long *)(param_1 + 0x2330) + (param_3 >> 2);
    while( true ) {
      ...
      uVar3 = *puVar6;
      uVar5 = uVar3 >> 0x10;
      if ((uVar5 == 0) || (puVar6 = puVar6 + uVar5, puVar1 < puVar6)) break;
      uVar4 = (ushort)uVar3;
      if (uVar4 < 0x16f) {
...
/* smolv::StatsCalculateSmol(smolv::Stats*, void const*, unsigned long) */

ulong smolv::StatsCalculateSmol(Stats *param_1,void *param_2,ulong param_3)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((param_1 == (Stats *)0x0) ||
     (uVar4 = smolv_CheckSmolHeader((uchar *)param_2,param_3), (char)uVar4 == '\0')) {
LAB_00100ccc:
    uVar4 = 0;
  }
  else {
    ...
    local_8c = 0x14b;
    if ((in_R9D >> 0x18 != 0) && (local_8c = 0, in_R9D >> 0x18 == 1)) {
      local_8c = 0x16f;
    }
    ...
    *(ulong *)(param_1 + 0x2338) = *(long *)(param_1 + 0x2338) + param_3;
    if (local_48 < pbVar10) {
      do {
        ...
        if (local_4c == 0xd) {
          local_4c = 0x4f;
          *(long *)(param_1 + ((long)local_48 - (long)pbVar9) * 8 + 0x2268) =
               *(long *)(param_1 + ((long)local_48 - (long)pbVar9) * 8 + 0x2268) + 1;
          if (0x4f < local_8c) {
            uVar15 = 8;
            goto LAB_00100dca;
          }
...
LAB_00100f43:
          ...
          if (iVar13 < 0x16f) {
            lVar18 = (long)iVar13;
LAB_00101085:
            *(byte **)(param_1 + lVar18 * 8 + 0x16f0) =
                 local_48 + (*(long *)(param_1 + lVar18 * 8 + 0x16f0) - (long)pbVar9);
          }
        }
        else {
...
LAB_00100dca:
          ...
          if (kSpirvOpData[lVar18 * 4 + 1] != '\0') {
            ...
            local_48 = pbVar6;
LAB_00101036:
            *(long *)(param_1 + lVar17 * 8 + 0x2298) = *(long *)(param_1 + lVar17 * 8 + 0x2298) + 1;
            uVar11 = 2;
          }
          if (kSpirvOpData[lVar18 * 4] != '\0') {
            ...
            local_48 = pbVar6;
LAB_00100fe7:
            *(long *)(param_1 + lVar17 * 8 + 0x22c8) = *(long *)(param_1 + lVar17 * 8 + 0x22c8) + 1;
            if (uVar15 < 2) {
              uVar11 = uVar11 + 2;
              bVar7 = 0;
              goto LAB_001010a1;
...
LAB_00100ec5:
                  do {
                    ...
                    uVar11 = uVar11 + 1;
                    *(long *)(param_1 + ((long)pbVar6 - (long)pbVar5) * 8 + 0x22f8) =
                         *(long *)(param_1 + ((long)pbVar6 - (long)pbVar5) * 8 + 0x22f8) + 1;
                    pbVar5 = pbVar6;
                  } while (uVar11 != uVar16);
                  if (cVar8 != '\0') {
                    local_48 = pbVar6;
              ...
              do {
                ...
                uVar11 = uVar11 + 1;
                *(long *)(param_1 + ((long)pbVar5 - (long)pbVar6) * 8 + 0x22c8) =
                     *(long *)(param_1 + ((long)pbVar5 - (long)pbVar6) * 8 + 0x22c8) + 1;
                pbVar6 = pbVar5;
              } while (uVar11 != uVar16);
              if (cVar8 != '\0') {
                local_48 = pbVar5;
...
LAB_00100e7f:
              if (iVar13 != 0xd) goto LAB_00100e88;
LAB_0010106c:
              if (9 < local_50) goto LAB_00100e88;
              local_48 = local_48 + 1;
            }
            goto LAB_00101085;
          }
...
/* smolv_WriteVarint(std::vector<unsigned char, std::allocator<unsigned char> >&, unsigned int) */

void smolv_WriteVarint(vector *param_1,uint param_2)
    ...
    do {
      while( true ) {
        ...
        std::vector<unsigned_char,std::allocator<unsigned_char>>::_M_realloc_insert<unsigned_char>
                  ((vector<unsigned_char,std::allocator<unsigned_char>> *)param_1,pbVar1,&local_21);
        pbVar1 = *(byte **)(param_1 + 8);
...
/* smolv_Write4(std::vector<unsigned char, std::allocator<unsigned char> >&, unsigned int) */

void smolv_Write4(vector *param_1,uint param_2)

{
  ...
  if (puVar4 == *(undefined1 **)(param_1 + 0x10)) {
    std::vector<unsigned_char,std::allocator<unsigned_char>>::_M_realloc_insert<unsigned_char>
              ((vector<unsigned_char,std::allocator<unsigned_char>> *)param_1,puVar4,&local_21);
    puVar4 = *(undefined1 **)(param_1 + 8);
...
/* smolv::Encode(void const*, unsigned long, std::vector<unsigned char, std::allocator<unsigned
   char> >&, unsigned int, bool (*)(char const*)) */

undefined8
smolv::Encode(void *param_1,ulong param_2,vector *param_3,uint param_4,_func_bool_char_ptr *param_5)

{
  ...
  if (((((param_2 & 3) != 0) || (uVar23 = param_2 >> 2, param_1 == (void *)0x0)) || (uVar23 < 5)) ||
     ((*param_1 != 0x7230203 || (0x600 < *(int *)((long)param_1 + 4) - 0x10000U)))) {
LAB_00101700:
    uVar14 = 0;
    goto LAB_00101702;
  }
    ...
    *(undefined8 *)(puVar22 + 0x2ff0) = *(undefined8 *)(in_FS_OFFSET + 0x28);
    ...
    if (lVar28 != 0) {
      ...
      *(undefined8 *)(puVar22 + -0x1500) = 0x101f17;
      std::
      __introsort_loop<std::pair<SpvOp,unsigned_long>*,long,__gnu_cxx::__ops::_Iter_comp_iter<bool(*)(std::pair<SpvOp,unsigned_long>,std::pair<SpvOp,unsigned_long>)>>
                (puVar1,puVar2,0x10,CompareOpCounters);
      ...
      do {
        ...
        if (*(ulong *)(puVar22 + -0x14e0) < uVar23) {
            ...
            do {
              ...
              *(undefined8 *)(puVar27 + 2) = *(undefined8 *)(puVar27 + -2);
              puVar27 = puVar30;
                     ...
                     ((long)puVar18 - ((long)puVar18 - (long)puVar1 & 0xfffffffffffffff0U)) !=
                     puVar30);
          }
          ...
          *(undefined8 *)(puVar22 + -0x1500) = 0x102248;
          std::
          __unguarded_linear_insert<std::pair<SpvOp,unsigned_long>*,__gnu_cxx::__ops::_Val_comp_iter<bool(*)(std::pair<SpvOp,unsigned_long>,std::pair<SpvOp,unsigned_long>)>>
                    (puVar18,CompareOpCounters);
        }
        puVar18 = puVar20;
      ...
      do {
        ...
        *(undefined8 *)(puVar22 + -0x1500) = 0x101f87;
        std::
        __unguarded_linear_insert<std::pair<SpvOp,unsigned_long>*,__gnu_cxx::__ops::_Val_comp_iter<bool(*)(std::pair<SpvOp,unsigned_long>,std::pair<SpvOp,unsigned_long>)>>
                  (puVar20,CompareOpCounters);
        puVar20 = puVar18;
      } while (puVar18 != puVar2);
      *(undefined8 *)(puVar22 + -0x1500) = 0x101fb0;
      std::
      __introsort_loop<std::pair<SpvOp,unsigned_long>*,long,__gnu_cxx::__ops::_Iter_comp_iter<bool(*)(std::pair<SpvOp,unsigned_long>,std::pair<SpvOp,unsigned_long>)>>
                (puVar2,*(undefined8 *)(puVar22 + -0x14f8),0x10,CompareOpCounters);
            ...
            do {
              ...
              *(undefined8 *)(puVar27 + 2) = *(undefined8 *)(puVar27 + -2);
              puVar27 = puVar30;
                     ...
                     ((long)puVar18 - ((long)puVar18 - (long)puVar2 & 0xfffffffffffffff0U)) !=
                     puVar30);
          }
      ...
      *(undefined8 *)(puVar22 + -0x1500) = 0x102053;
      std::
      __introsort_loop<std::pair<SpvOp,unsigned_long>*,long,__gnu_cxx::__ops::_Iter_comp_iter<bool(*)(std::pair<SpvOp,unsigned_long>,std::pair<SpvOp,unsigned_long>)>>
                (*(undefined4 **)(puVar22 + -0x14f8),puVar22 + 0x2fe8,0x10,CompareOpCounters);
          ...
          if (0 < (long)puVar20 - lVar35) {
            do {
              ...
              *(undefined8 *)(puVar30 + 2) = *(undefined8 *)(puVar30 + -2);
              puVar30 = puVar31;
            } while ((undefined4 *)((long)puVar20 - ((long)puVar20 - lVar35 & 0xfffffffffffffff0U))
                     != puVar31);
          }
      ...
      *(undefined8 *)(puVar22 + -0x1500) = 0x102134;
      __printf_chk((double)((float)uVar23 * _LC2 * __LC3),2,
                   "Stats for %i SPIR-V inputs, total size %i words (%.1fKB):\n",uVar12);
      ...
      *(undefined8 *)(puVar22 + -0x1500) = 0x1022b1;
      ...
      do {
        ...
        *(undefined8 *)(puVar22 + -0x1500) = 0x102342;
        __printf_chk((double)((fVar38 / (float)uVar26) * __LC6),
                     (double)((_LC2 * fVar38) / (float)uVar13),2,
                     " #%2i: %-22s %6i (%4.1f%%) avg len %.1f\n",uVar21,uVar14,(int)uVar6 * 4);
      } while (uVar23 != 0x1e);
      uVar23 = 1;
      ...
      *(undefined8 *)(puVar22 + -0x1500) = 0x10246a;
      ...
      do {
        ...
        *(undefined8 *)(puVar22 + -0x1500) = 0x1024e5;
        __printf_chk((double)(((float)uVar6 / (float)uVar26) * __LC6),
                     (double)((float)uVar6 / (float)uVar13),2,
                     " #%2i: %-22s %6i (%4.1f%%) avg len %.1f\n",uVar21,uVar14);
      } while (uVar23 != 0x1e);
    }
...
LAB_00101cf5:
  ...
  uStack_b0 = 0x101563;
  smolv_Write4(param_3,*(uint *)((long)param_1 + 8));
  uStack_b0 = 0x10156f;
  smolv_Write4(param_3,*(uint *)((long)param_1 + 0xc));
  uStack_b0 = 0x10157b;
  smolv_Write4(param_3,*(uint *)((long)param_1 + 0x10));
...
LAB_001016ab:
          ...
          if (uVar19 == 0x47) {
            uVar16 = uVar32 - 3;
LAB_00101646:
            if (uVar16 < 0x10000) goto LAB_00101652;
            goto LAB_00101700;
          }
          if (uVar19 == 0x3d) {
            uVar16 = uVar32 - 4;
          ...
          uVar19 = 0x41;
          uStack_b0 = 0x101de8;
          smolv_WriteVarint(param_3,(uVar11 >> 4) << 0x14 | (uVar32 & 0xf) << 4 | uVar16 & 0xf |
                                    ((int)uVar16 >> 4) << 8);
          local_6c = 0;
LAB_00101a1a:
          uVar13 = 2;
...
LAB_00101745:
          local_90 = (vector *)(long)(int)uVar19;
          ...
          if (uVar11 - 0x47 < 2) {
            ...
            uStack_b0 = 0x1017c4;
            smolv_WriteVarint(param_3,(local_70 - (uint)local_80) * 2 ^
                                      (int)(local_70 - (uint)local_80) >> 0x1f);
            if ((uint)local_a8 == 0x48) {
              ...
              if (puVar4 == *(undefined1 **)(param_3 + 0x10)) {
                ...
                _M_realloc_insert<unsigned_char>
                          ((vector<unsigned_char,std::allocator<unsigned_char>> *)param_3,puVar4,
                           &local_41);
                pvVar33 = local_a8;
              }
              else {
              ...
              if (pvVar15 < local_a0) {
                ...
                do {
                  ...
                  if ((uVar16 == 0) || (pvVar24 = pvVar15 + (ulong)uVar16 * 4, local_a0 < pvVar24))
                  goto LAB_00101700;
...
LAB_00101c67:
                  ...
                  iVar36 = iVar36 + 1;
                        ...
                        (pvVar15 = pvVar24, uVar32 = local_6c, iVar36 < 0xff));
                vVar34 = SUB41(iVar36,0);
LAB_001019fc:
                pvVar33[*(long *)param_3] = vVar34;
          ...
          if ((bVar37 != 0) && (uVar13 < uVar23)) {
            ...
            do {
              ...
              iVar36 = iVar36 + 1;
              uStack_b0 = 0x10182d;
              smolv_WriteVarint(local_a8,(iVar17 - *(int *)(pvVar15 + lVar35)) * 2 ^
                                         iVar17 - *(int *)(pvVar15 + lVar35) >> 0x1f);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* smolv::StatsPrint(smolv::Stats const*) */

void smolv::StatsPrint(Stats *param_1)
  ...
  *(undefined8 *)(puVar16 + 0x2ff0) = *(undefined8 *)(in_FS_OFFSET + 0x28);
  if (param_1 != (Stats *)0x0) {
    ...
    *(undefined8 *)(puVar16 + -0x1500) = 0x101f17;
          ...
          do {
            ...
            *(undefined8 *)(puVar17 + 2) = *(undefined8 *)(puVar17 + -2);
            puVar17 = puVar19;
                   ...
                   ((long)puVar13 - ((long)puVar13 - (long)puVar1 & 0xfffffffffffffff0U)) != puVar19
                  );
        }
    ...
    do {
      ...
      *(undefined8 *)(puVar16 + -0x1500) = 0x101f87;
      std::
      __unguarded_linear_insert<std::pair<SpvOp,unsigned_long>*,__gnu_cxx::__ops::_Val_comp_iter<bool(*)(std::pair<SpvOp,unsigned_long>,std::pair<SpvOp,unsigned_long>)>>
                (puVar14,CompareOpCounters);
      puVar14 = puVar13;
    } while (puVar13 != puVar2);
    *(undefined8 *)(puVar16 + -0x1500) = 0x101fb0;
    std::
    __introsort_loop<std::pair<SpvOp,unsigned_long>*,long,__gnu_cxx::__ops::_Iter_comp_iter<bool(*)(std::pair<SpvOp,unsigned_long>,std::pair<SpvOp,unsigned_long>)>>
              (puVar2,*(undefined8 *)(puVar16 + -0x14f8),0x10,CompareOpCounters);
          ...
          do {
            ...
            *(undefined8 *)(puVar17 + 2) = *(undefined8 *)(puVar17 + -2);
            puVar17 = puVar19;
                   ...
                   ((long)puVar13 - ((long)puVar13 - (long)puVar2 & 0xfffffffffffffff0U)) != puVar19
                  );
        }
    ...
    *(undefined8 *)(puVar16 + -0x1500) = 0x102053;
    std::
    __introsort_loop<std::pair<SpvOp,unsigned_long>*,long,__gnu_cxx::__ops::_Iter_comp_iter<bool(*)(std::pair<SpvOp,unsigned_long>,std::pair<SpvOp,unsigned_long>)>>
              (*(undefined4 **)(puVar16 + -0x14f8),puVar16 + 0x2fe8,0x10,CompareOpCounters);
        ...
        if (0 < (long)puVar14 - lVar12) {
          do {
            ...
            *(undefined8 *)(puVar19 + 2) = *(undefined8 *)(puVar19 + -2);
            puVar19 = puVar20;
          } while ((undefined4 *)((long)puVar14 - ((long)puVar14 - lVar12 & 0xfffffffffffffff0U)) !=
                   puVar20);
        }
    ...
    *(undefined8 *)(puVar16 + -0x1500) = 0x102134;
    __printf_chk((double)((float)uVar22 * _LC2 * __LC3),2,
                 "Stats for %i SPIR-V inputs, total size %i words (%.1fKB):\n",uVar10);
    ...
    *(undefined8 *)(puVar16 + -0x1500) = 0x1022b1;
    ...
    do {
      ...
      *(undefined8 *)(puVar16 + -0x1500) = 0x102342;
      __printf_chk((double)((fVar23 / (float)uVar11) * __LC6),
                   (double)((_LC2 * fVar23) / (float)uVar21),2,
    ...
    *(undefined8 *)(puVar16 + -0x1500) = 0x10246a;
    ...
    do {
      ...
      *(undefined8 *)(puVar16 + -0x1500) = 0x1024e5;
      __printf_chk((double)(((float)uVar6 / (float)uVar11) * __LC6),
                   (double)((float)uVar6 / (float)uVar21),2,
                   " #%2i: %-22s %6i (%4.1f%%) avg len %.1f\n",uVar15,uVar5);
    } while (uVar22 != 0x1e);
  }
...
/* WARNING: Instruction at (ram,0x00102fe9) overlaps instruction at (ram,0x00102fe3)
    */
/* void std::vector<unsigned char, std::allocator<unsigned char> >::_M_realloc_insert<unsigned
   ...
   std::allocator<unsigned char> > >, unsigned char&&) */

void __thiscall
std::vector<unsigned_char,std::allocator<unsigned_char>>::_M_realloc_insert<unsigned_char>
          (vector<unsigned_char,std::allocator<unsigned_char>> *this,undefined4 *param_2,
          undefined1 *param_3)
...
code_r0x00102fed:
      puVar20 = (undefined4 *)(ulong)uVar7;
...
LAB_00102fcb:
      if (SCARRY1(bVar2,bVar14)) goto LAB_00103032;
...
LAB_00102fdb:
        pbVar1 = (byte *)((long)unaff_RBP + 0x6e);
        bVar27 = CARRY1(*pbVar1,bVar9);
        *pbVar1 = *pbVar1 + bVar9;
        bVar29 = (char)*pbVar1 < '\0';
        puVar21 = (undefined1 *)psVar17;
        if (*pbVar1 != 0) {
          ...
          if (!bVar29) {
LAB_00103032:
            pcVar24 = (char *)(uVar12 + 0x70 + (long)pcVar25 * 2);
...
/* void std::__unguarded_linear_insert<std::pair<SpvOp, unsigned long>*,
   ...
   (*)(std::pair<SpvOp, unsigned long>, std::pair<SpvOp, unsigned long>)>) */
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* void std::__adjust_heap<std::pair<SpvOp, unsigned long>*, long, std::pair<SpvOp, unsigned long>,
...
void std::
     __adjust_heap<std::pair<SpvOp,unsigned_long>*,long,std::pair<SpvOp,unsigned_long>,__gnu_cxx::__ops::_Iter_comp_iter<bool(*)(std::pair<SpvOp,unsigned_long>,std::pair<SpvOp,unsigned_long>)>>
               (long param_1,long param_2,ulong param_3,undefined4 param_4,undefined8 param_5,
               code *param_6)

{
  ...
  if (param_2 < lVar6) {
    do {
      ...
      cVar2 = (*param_6)(*puVar4,*(undefined8 *)(puVar4 + 2),
                         *(undefined4 *)(param_1 + -0x10 + lVar3),
                         *(undefined8 *)(param_1 + -8 + lVar3));
      if (cVar2 != '\0') {
        lVar7 = lVar7 + -1;
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* void std::__introsort_loop<std::pair<SpvOp, unsigned long>*, long,
   __gnu_cxx::__ops::_Iter_comp_iter<bool (*)(std::pair<SpvOp, unsigned long>, std::pair<SpvOp,
...
void std::
     __introsort_loop<std::pair<SpvOp,unsigned_long>*,long,__gnu_cxx::__ops::_Iter_comp_iter<bool(*)(std::pair<SpvOp,unsigned_long>,std::pair<SpvOp,unsigned_long>)>>
               (undefined4 *param_1,undefined8 *param_2,long param_3,code *param_4)
  ...
  if (0x100 < lVar7) {
    ...
    if (param_3 != 0) {
      do {
        ...
        cVar5 = (*param_4)(*(undefined4 *)puVar8,*(undefined8 *)(param_1 + 6),*puVar1,
                           *(undefined8 *)(puVar1 + 2));
        param_2 = puVar8;
        puVar9 = puVar11;
        if (cVar5 == '\0') {
          cVar5 = (*param_4)(*(undefined4 *)puVar8,*(undefined8 *)(param_1 + 6),
                             *(undefined4 *)(puVar11 + -2),puVar11[-1]);
          if (cVar5 == '\0') {
            cVar5 = (*param_4)(*puVar1,*(undefined8 *)(puVar1 + 2),*(undefined4 *)(puVar11 + -2),
                               puVar11[-1]);
            uVar6 = *param_1;
...
LAB_001045bc:
        ...
        while( true ) {
          while (cVar5 = (*param_4)(*(undefined4 *)param_2,param_2[1],*param_1,
                                    *(undefined8 *)(param_1 + 2)), cVar5 != '\0') {
            param_2 = param_2 + 2;
          }
          do {
            puVar10 = puVar9;
            puVar9 = puVar10 + -2;
            cVar5 = (*param_4)(*param_1,*(undefined8 *)(param_1 + 2),*(undefined4 *)puVar9,
                               puVar10[-1]);
          } while (cVar5 != '\0');
        ...
        __introsort_loop<std::pair<SpvOp,unsigned_long>*,long,__gnu_cxx::__ops::_Iter_comp_iter<bool(*)(std::pair<SpvOp,unsigned_long>,std::pair<SpvOp,unsigned_long>)>>
                  (param_2,puVar11,local_40,param_4);
        lVar7 = (long)param_2 - (long)param_1;
        if (lVar7 < 0x101) {
          return;
        }
    ...
    for (lVar12 = (lVar7 >> 4) + -2 >> 1;
        __adjust_heap<std::pair<SpvOp,unsigned_long>*,long,std::pair<SpvOp,unsigned_long>,__gnu_cxx::__ops::_Iter_comp_iter<bool(*)(std::pair<SpvOp,unsigned_long>,std::pair<SpvOp,unsigned_long>)>>
                  (param_1,lVar12,lVar7 >> 4,*(undefined8 *)(param_1 + lVar12 * 4),
                   *(undefined8 *)(param_1 + lVar12 * 4 + 2),param_4), lVar12 != 0;
        lVar12 = lVar12 + -1) {
    }
    do {
      puVar8 = param_2 + -2;
      ...
      *(undefined4 *)puVar8 = *param_1;
      ...
      __adjust_heap<std::pair<SpvOp,unsigned_long>*,long,std::pair<SpvOp,unsigned_long>,__gnu_cxx::__ops::_Iter_comp_iter<bool(*)(std::pair<SpvOp,unsigned_long>,std::pair<SpvOp,unsigned_long>)>>
                (param_1,0,(long)puVar8 - (long)param_1 >> 4,uVar3,uVar4,param_4);
      param_2 = puVar8;

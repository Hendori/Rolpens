...

{
  ...
  compute_avgs_and_dirs_3_comp_rgb(param_1,param_2,ppVar50);
  fVar86 = *(float *)(param_2 + 0xe00);
  fVar88 = *(float *)(param_2 + 0xe04);
  uVar32 = *(undefined8 *)(param_2 + 0xe00);
  ...
  do {
    ...
    if (auVar105._0_4_ == 0.0) {
      auVar121._4_4_ = _UNK_00102054;
      auVar121._0_4_ = _LC1;
      auVar121._8_4_ = _UNK_00102058;
      fStack_1144 = _LC1;
      fStack_10ac = _LC1;
      fStack_10c4 = _LC1;
    }
    ...
    fVar112 = _UNK_00102054 * fVar91 + _LC1 * fVar82 + _UNK_00102058 * fVar94;
    _local_1168 = (undefined1  [16])0x0;
    fVar82 = fVar82 - fVar112 * _LC1;
    fVar91 = fVar91 - fVar112 * _UNK_00102054;
    fVar94 = fVar94 - fVar112 * _UNK_00102058;
    ppVar71 = ppVar57;
    fVar112 = fVar150;
    fVar154 = fVar151;
    fVar155 = fVar152;
    fVar156 = fVar153;
    iVar142 = __LC31;
    iVar143 = _UNK_00102064;
    iVar144 = _UNK_00102068;
    iVar145 = _UNK_0010206c;
    do {
      uVar23 = *(uint *)ppVar71;
      uVar51 = uVar51 + 4;
      ppVar71 = ppVar71 + 4;
      ...
      uVar30 = CONCAT32(auVar25._10_3_,(ushort)(byte)(uVar23 >> 0x10));
      auVar31._5_8_ = 0;
      auVar31._0_5_ = uVar30;
      ...
      iVar143 = iVar143 + _UNK_00102084;
      iVar144 = iVar144 + _UNK_00102088;
      iVar145 = iVar145 + _UNK_0010208c;
      ...
      lVar67 = (long)(int)uVar30;
      lVar56 = (long)(int)CONCAT72(SUB137(auVar31 << 0x40,6),(ushort)(byte)(uVar23 >> 8));
      ...
      local_1168._4_4_ =
           (float)((uint)((*(float *)(param_2 + lVar56 * 4 + 0xa50) - fVar85) *
                         (*(float *)(param_2 + lVar56 * 4 + 0xa50) - fVar85)) & uVar136) +
    ...
    auVar106._4_4_ = -(uint)(auVar122._4_4_ < _UNK_00102094);
    auVar106._0_4_ = -(uint)(auVar122._0_4_ < __LC20);
    auVar106._8_4_ = -(uint)(auVar122._8_4_ < _UNK_00102098);
    auVar106._12_4_ = -(uint)(auVar122._12_4_ < _UNK_0010209c);
    uVar51 = movmskps((int)local_1048,auVar106);
    *(bool *)(local_1058 + 4) = (~uVar51 & 7) == 0;
    *local_1058 = (((float)local_1158._0_4_ + (float)uStack_1150 +
                   (float)local_1158._4_4_ + uStack_1150._4_4_) - fVar82) * __LC22;
    local_1058[1] = ((fVar150 + fVar152 + fVar151 + fVar153) - fVar82) * _UNK_001020a4;
    local_1058[2] = ((fVar146 + fVar148 + fVar147 + fVar149) - fVar82) * _UNK_001020a8;
    local_1058[3] =
         ((float)uStack_1160 + (float)local_1168._0_4_ + uStack_1160._4_4_ + (float)local_1168._4_4_
         ) * fVar104 * _UNK_001020ac;
    if (fVar101 == fVar85) {
  ...
  do {
    ...
    local_1118 = (float)uVar32;
    fStack_1114 = (float)((ulong)uVar32 >> 0x20);
    fVar155 = (local_1118 *
    ...
    fVar156 = fVar104 * (auVar122._12_4_ * auVar122._12_4_ + auVar124._12_4_ * auVar124._12_4_ +
              ...
              _LC12 * fVar116;
    if (iVar14 == (image_block)0x0) {
      cVar19 = *(char *)((long)pfVar45 + 0x11);
      cVar20 = *(char *)(pfVar45 + 4);
      fVar91 = fVar116 * fVar86;
      uVar27 = CONCAT44(_LC14._4_4_,(float)_LC14);
      *(undefined8 *)ppVar50 = uVar27;
      *(undefined8 *)(ppVar50 + 8) = uVar26;
      *(undefined8 *)(ppVar50 + 0x10) = uVar27;
      *(undefined8 *)(ppVar50 + 0x18) = uVar26;
      *(undefined8 *)(ppVar50 + 0x20) = uVar27;
      *(undefined8 *)(ppVar50 + 0x28) = uVar26;
      *(undefined8 *)(ppVar50 + 0x30) = uVar27;
      *(undefined8 *)(ppVar50 + 0x38) = uVar26;
      *(undefined8 *)pcVar40 = __LC30;
      *(undefined8 *)(pcVar40 + 8) = _UNK_001020b8;
      fVar88 = _LC10;
      fVar82 = _LC10;
      if (cVar19 == '\0') {
        fVar94 = _LC10;
      ...
      do {
        ...
        *(float *)(ppVar50 + lVar39 * 4 + 0x4c) = fVar112 * fVar150 * fVar82 + fVar155 + fVar156;
        ...
        *(float *)(ppVar50 + lVar39 * 4 + 0x48) = fVar146;
        ...
        *(float *)(ppVar50 + lVar39 * 4 + 0x40) = fVar146 + fVar120;
        *(float *)(ppVar50 + lVar39 * 4 + 0x40 + 4) = fVar150;
        lVar39 = lVar39 + 4;
      } while (iVar142 != 0x15);
    }
    else {
...
LAB_00101640:
            if ((char)uVar51 == '\0') goto LAB_00101649;
...
LAB_00100b5d:
      ...
      pcVar40[3] = cVar42;
      pcVar40[7] = cVar42;
      *(undefined8 *)ppVar50 = uVar26;
      *(undefined8 *)(ppVar50 + 8) = uVar26;
      *(undefined8 *)(ppVar50 + 0x10) = uVar26;
      *(undefined8 *)(ppVar50 + 0x18) = uVar26;
      *(undefined8 *)(ppVar50 + 0x20) = uVar26;
      *(undefined8 *)(ppVar50 + 0x28) = uVar26;
      *(undefined8 *)(ppVar50 + 0x30) = uVar26;
      *(undefined8 *)(ppVar50 + 0x38) = uVar26;
      *(undefined8 *)(ppVar50 + 0x40) = uVar26;
      *(undefined8 *)(ppVar50 + 0x48) = uVar26;
      *(undefined8 *)(ppVar50 + 0x50) = uVar26;
      *(undefined8 *)(ppVar50 + 0x58) = uVar26;
      *(undefined8 *)(ppVar50 + 0x60) = uVar26;
      *(undefined8 *)(ppVar50 + 0x68) = uVar26;
      *(undefined8 *)(ppVar50 + 0x70) = uVar26;
      *(undefined8 *)(ppVar50 + 0x78) = uVar26;
      lVar39 = 0;
      pcVar40[0xb] = cVar42;
      pcVar40[0xf] = cVar42;
      pcVar40[0x13] = cVar42;
      ...
      *(undefined2 *)pcVar40 = uVar55;
      ...
      do {
        ...
        *(undefined1 (*) [16])(ppVar50 + lVar39 * 4 + 0x80) = auVar90;
        lVar39 = lVar39 + 4;
      } while (lVar39 != 0x34);
    }
    lVar74 = lVar74 + 1;
    ...
    pfVar45 = pfVar45 + 5;
    ppVar50 = ppVar50 + 0x150;
  } while ((int)lVar74 < (int)uVar37);
  auVar28._4_4_ = _LC14._4_4_;
  auVar28._0_4_ = (float)_LC14;
  auVar28._8_8_ = _UNK_00102078;
  uVar75 = (ulong)(param_7 & 0xfffffffc);
  *(undefined1 (*) [16])(param_13 + uVar75 * 4 + 0x265c0) = auVar28;
  ...
  *(undefined4 *)(param_13 + uVar75 + 0x28dc0) = 0;
  ...
  if (uVar37 == 1) {
    if (param_7 < param_8) {
      ...
      fVar88 = (float)_LC14;
      do {
        while (local_9d8 = (float)uVar59, (float)_LC14 <= param_5[uVar75]) {
        ...
        cVar42 = *(compression_working_buffers *)
                  (&quant_mode_table +
                  (long)(int)(char)param_4[uVar75] + (long)((int)uVar46 + 1) * 0x80);
        param_13[uVar75 + 0x285c0] = cVar42;
        param_13[uVar75 * 4 + 0x295c0] = (compression_working_buffers)0x0;
        if ('\x03' < (char)cVar42) {
          param_13[uVar75 * 4 + 0x295c0] = local_f78[(long)(int)uVar46 + (long)(char)cVar42 * 4];
        }
...
LAB_00101f2b:
    ...
    if (uVar37 == 2) {
      pauVar47 = (undefined1 (*) [16])&local_9d8;
      do {
        auVar29._4_4_ = _LC14._4_4_;
        auVar29._0_4_ = (float)_LC14;
        auVar29._8_8_ = _UNK_00102078;
        *(ulong *)pauVar47[1] = CONCAT44(_LC14._4_4_,(float)_LC14);
        pauVar33 = pauVar47 + 1;
        *(float *)(pauVar47[1] + 8) = (float)_LC14;
        *pauVar47 = auVar29;
        pauVar47 = (undefined1 (*) [16])(*pauVar33 + 0xc);
        ...
        do {
          ...
          do {
            ...
            if (iVar143 - iVar145 < 2) {
              fVar88 = *(float *)(puVar54 + lVar74 * 4) + *(float *)(puVar54 + lVar39 * 4 + 0x150);
              if (_LC15 <= *(float *)(puVar54 + lVar74 * 4) +
                           *(float *)(puVar54 + lVar39 * 4 + 0x150)) {
                fVar88 = _LC15;
              }
              if (fVar88 <= *(float *)(puVar70 + lVar39 * 4)) {
                uVar18 = puVar53[lVar74];
                uVar22 = puVar53[lVar39 + 0x54];
      ...
      if (param_8 != 0) {
        ...
        do {
          ...
          if (param_5[uVar75] < (float)_LC14) {
            ...
            *(undefined2 *)(param_13 + uVar75 * 4 + 0x295c0) = uVar55;
            fVar102 = fVar102 + param_5[uVar75];
            if (fVar102 < fVar88) {
              uVar59 = uVar75 & 0xffffffff;
              fVar88 = fVar102;
    ...
    if (uVar37 == 3) {
      ...
      do {
        do {
          *(ulong *)pfVar45 = CONCAT44(_LC14._4_4_,(float)_LC14);
          pfVar45 = pfVar45 + 2;
        } while (pfVar44 != pfVar45);
        pfVar44 = pfVar44 + 10;
        pfVar45 = pfVar61 + 10;
        pfVar61 = pfVar45;
        ...
        do {
          ...
          do {
            ...
            if (iVar143 - iVar144 < 2) {
              lVar39 = 0;
              pfVar45 = (float *)(puVar77 + (long)iVar145 * 4);
              ...
              do {
                ...
                if (iVar48 - iVar52 < 2) {
                  fVar88 = *(float *)(puVar54 + uVar75 * 4) +
                           *(float *)(puVar54 + lVar74 * 4 + 0x150) +
                           *(float *)(puVar54 + lVar39 * 4 + 0x2a0);
                  if (_LC15 <= fVar88) {
                    fVar88 = _LC15;
                  }
                  if (fVar88 <= *pfVar45) {
                    uVar18 = puVar53[uVar75];
                    uVar22 = puVar53[lVar74 + 0x54];
                    *pfVar45 = fVar88;
                    *(ushort *)(puVar73 + (long)(iVar145 + iVar49) * 3) = CONCAT11(uVar22,uVar18);
                    puVar70[2] = puVar53[lVar39 + 0xa8];
                  }
                }
                lVar39 = lVar39 + 1;
                pfVar45 = pfVar45 + 1;
          ...
          while( true ) {
            ...
            do {
              while( true ) {
                ...
                iVar52 = (int)uVar59;
                if (1 < iVar49 - iVar48) break;
                pfVar45 = (float *)(puVar73 + (long)iVar52 * 4);
                lVar56 = 0;
                do {
                  iVar38 = (int)lVar56;
                  iVar58 = iVar38;
                  ...
                  if (iVar58 - iVar63 < 2) {
                    fVar102 = *(float *)(puVar77 + uVar75 * 4) +
                              ...
                              *(float *)(puVar77 + lVar56 * 4 + 0x3f0);
                    if (fVar88 <= fVar102) {
                      fVar102 = fVar88;
                    }
                    if (fVar102 <= *pfVar45) {
                      uVar18 = puVar53[lVar56 + 0xfc];
                      *pfVar45 = fVar102;
                      *(uint *)(local_1138 + (long)(iVar52 + iVar38) * 4) =
                           CONCAT31(CONCAT21(CONCAT11(uVar18,puVar53[lVar39 + 0xa8]),
                                             puVar53[lVar74 + 0x54]),puVar53[uVar75]);
                    }
                  }
                  lVar56 = lVar56 + 1;
                  pfVar45 = pfVar45 + 1;
...
LAB_0010104f:
    ...
    if (param_8 == 0) goto LAB_00101f2b;
    uVar75 = 0;
    uVar59 = 0xffffffff;
    fVar88 = fVar86;
    do {
...
LAB_001011c9:
  ...
  uVar136 = _UNK_001020cc;
  uVar132 = _UNK_001020c8;
  uVar23 = _UNK_001020c4;
  uVar51 = __LC32;
  fVar86 = (float)_LC14;
  iVar145 = _UNK_0010206c;
  iVar144 = _UNK_00102068;
    ...
    do {
      ...
      if (param_7 < param_8) {
        ...
        do {
          ...
          uVar137 = uVar137 + _UNK_00102084;
          uVar139 = uVar139 + _UNK_00102088;
          uVar141 = uVar141 + _UNK_0010208c;
      ...
      uVar138 = uVar138 & uVar133 | ~uVar133 & uVar51;

...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_00122268;
  singleton = this;
  return;
}
...
{
  *(undefined ***)this = &PTR__initialize_classv_00121f20;
...
{
  *(undefined ***)this = &PTR__initialize_classv_00122080;
...

{
  ...
  if (dep_err_notify != (code *)0x0) {
    ...
    *(undefined ***)this = &PTR_hash_001223f0;
...
LAB_00121d56:
    ...
    lVar8 = puVar9[-1];
    if (param_1 <= lVar8) goto LAB_00121b9c;
  }
  else {
    if (lVar8 != 0) {
      uVar7 = _realloc(this,lVar12);
  ...
  pauVar6 = (undefined1 (*) [16])(puVar9 + lVar8 * 2);
  do {
    *pauVar6 = (undefined1  [16])0x0;
    pauVar6 = pauVar6 + 1;
  } while (pauVar6 != (undefined1 (*) [16])(puVar9 + param_1 * 2));
LAB_00121b9c:
  puVar9[-1] = param_1;
  return 0;
}

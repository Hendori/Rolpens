...

{
  ...
  do {
    ...
    *(undefined ***)this_00 = &PTR__initialize_classv_00108608;
...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_00108808;
...
LAB_0010835c:
    ...
    lVar4 = puVar8[-1];
    if (param_1 <= lVar4) goto LAB_001082f4;
  }
  else {
    if (lVar10 != 0) {
...
LAB_00108516:
        ...
        lVar6 = *(long *)(lVar3 + -8);
        if (lVar6 <= lVar7) goto LAB_00108516;
        lVar6 = lVar7 + 1;

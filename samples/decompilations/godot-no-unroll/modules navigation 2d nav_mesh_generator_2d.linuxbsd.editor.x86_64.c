...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_0010e6a8;
  if (bVar1) {
    singleton = this;
      ...
      if (cVar6 != '\0') {
        ...
        if (cVar6 != '\0') {
          if (*(code **)(*(long *)this_00 + 0x140) ==
            ...
            *(undefined ***)this_00 = &PTR__initialize_classv_0010e0c8;
    ...
    if ((plVar2[1] != 0) && (cVar9 = RefCounted::unreference(), cVar9 != '\0')) {
      ...
      if (cVar9 != '\0') {
        if (*(code **)(*(long *)pOVar4 + 0x140) ==
            NavigationMeshSourceGeometryData2D::~NavigationMeshSourceGeometryData2D) {
          *(undefined ***)pOVar4 = &PTR__initialize_classv_0010e0c8;
          NavigationMeshSourceGeometryData2D::clear();
    ...
    if ((*plVar2 != 0) && (cVar9 = RefCounted::unreference(), cVar9 != '\0')) {
      ...
      if (cVar9 != '\0') {
        if (*(code **)(*(long *)pOVar4 + 0x140) == NavigationPolygon::~NavigationPolygon) {
          ...
          *(undefined ***)pOVar4 = &PTR__initialize_classv_0010e478;
    ...
    if (cVar10 != '\0') {
      ...
      if (((this != (Object *)0x0) && (cVar10 = RefCounted::unreference(), cVar10 != '\0')) &&
        ...
        if (*(code **)(*(long *)this + 0x140) ==
            NavigationMeshSourceGeometryData2D::~NavigationMeshSourceGeometryData2D) {
          *(undefined ***)this = &PTR__initialize_classv_0010e0c8;
          NavigationMeshSourceGeometryData2D::clear();
        ...
        if ((this == (Object *)0x0) ||
          ...
          if ((cVar8 != '\0') && (cVar8 = predelete_handler(this), cVar8 != '\0')) {
            if (*(code **)(*(long *)this + 0x140) == NavigationPolygon::~NavigationPolygon) {
              ...
              *(undefined ***)this = &PTR__initialize_classv_0010e478;
...
LAB_00103c06:
    ...
    if (local_1f0 == local_1f8) {
      ...
      local_1a8 = &PTR__PolyPathD_0010e650;
...
LAB_001044df:
      ...
      local_158._0_8_ = &PTR__ClipperD_0010e688;
...
{
  *(undefined ***)this = &PTR__ClipperD_0010e688;
...

{
  ...
  *(undefined ***)this = &PTR__PolyPathD_0010e650;
  puVar4 = puVar5;
  if (puVar1 != puVar5) {
    do {
    ...
    do {
      ...
      if (plVar3 != (long *)0x0) {
        if (*(code **)(*plVar3 + 8) == Clipper2Lib::PolyPathD::~PolyPathD) {
          ...
          *plVar3 = (long)&PTR__PolyPathD_0010e650;
...
LAB_00109a14:
    do {
      ...
      if (plVar2 != (long *)0x0) {
        ...
        *plVar2 = (long)&PTR__PolyPathD_0010e650;
...
LAB_00109ca8:
          do {
            ...
            if (plVar5 != (long *)0x0) {
              ...
              *plVar5 = (long)&PTR__PolyPathD_0010e650;
              puVar11 = puVar12;
              if (puVar6 != puVar12) {
LAB_00109cfa:
                do {
                  ...
                  if (plVar7 != (long *)0x0) {
                    ...
                    *plVar7 = (long)&PTR__PolyPathD_0010e650;
                    puVar17 = puVar14;
                    if (puVar8 != puVar14) {
                      do {
...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_0010e2a0;
        ...
        if (cVar3 != '\0') {
          ...
          if (cVar3 != '\0') {
            if (*(code **)(*(long *)this_00 + 0x140) == NavigationPolygon::~NavigationPolygon) {
              ...
              *(undefined ***)this_00 = &PTR__initialize_classv_0010e478;
    ...
    if (cVar4 != '\0') {
      ...
      if (cVar4 != '\0') {
        if (*(code **)(*(long *)this_00 + 0x140) == NavigationMesh::~NavigationMesh) {
          bVar5 = StringName::configured != '\0';
          *(undefined ***)this_00 = &PTR__initialize_classv_0010e2a0;
...

{
  ...
  if (*(code **)(*(long *)param_1 + 0x140) == NavigationPolygon::~NavigationPolygon) {
    ...
    *(undefined ***)param_1 = &PTR__initialize_classv_0010e478;
...

{
  ...
  if (*(code **)(*(long *)param_1 + 0x140) ==
      NavigationMeshSourceGeometryData2D::~NavigationMeshSourceGeometryData2D) {
    *(undefined ***)param_1 = &PTR__initialize_classv_0010e0c8;
    NavigationMeshSourceGeometryData2D::clear();
...

{
  ...
  if (param_6 + 8U < 0x11) {
    ...
    *(undefined8 *)(this + 0x10) = 0;
    ...
    local_158 = &PTR__ClipperD_0010e688;
    local_148 = 2;
    local_80 = 1;
    local_77 = 1;
    local_60 = 0;
...
LAB_0010ce66:
    ...
    lVar4 = puVar5[-1];
    if (param_1 <= lVar4) goto LAB_0010cce1;
  }
  else {
    if (lVar4 != 0) {
      uVar3 = _realloc(this,lVar9);
...

{
  ...
  puVar8 = (undefined8 *)((long)param_2 - (long)puVar2);
  if (puVar2 == puVar1) {
    if (0xfffffffffffffffe < uVar5) goto LAB_0010cf78;
    uVar7 = 0x7ffffffffffffff;
    if (uVar5 + 1 < 0x800000000000000) {
      uVar7 = uVar5 + 1;
    }
...
LAB_0010ceea:
    ...
    puVar8 = puVar10;
    if (param_2 == puVar1) goto LAB_0010cf3c;
  }
  else {
    uVar7 = uVar5 * 2;
    if (uVar7 < uVar5) {
LAB_0010cf78:
    ...
    *puVar8 = *param_3;
    puVar8[1] = uVar3;
    if (param_2 != puVar2) goto LAB_0010ceea;
  }
  puVar8 = (undefined8 *)((long)puVar10 + ((long)puVar1 - (long)param_2));
  memcpy(puVar10,param_2,(long)puVar1 - (long)param_2);
LAB_0010cf3c:
...

{
  ...
  *(undefined1 (*) [16])(puVar7 + 6) = (undefined1  [16])0x0;
  ...
  puVar7[1] = this;
  *puVar7 = &PTR__PolyPathD_0010e650;
  puVar7[2] = 0;
  puVar7[3] = 0;
  puVar7[4] = 0;
  puVar7[8] = 0;
  ...
  if (plVar2 != plVar9) {
    do {
      while( true ) {
        ...
        pdVar8 = local_48;
        if (plVar2 == plVar9) goto LAB_0010d160;
      }
  ...
  if (puVar11 == *(undefined8 **)(this + 0x20)) {
    ...
    if (local_58 != (undefined1  [8])0x0) {
      if (*(code **)(*(long *)local_58 + 8) == ~PolyPathD) {
        *(undefined ***)local_58 = &PTR__PolyPathD_0010e650;
...
LAB_0010d242:
              puVar10 = puVar10 + 1;
              if (puVar11 == puVar10) goto LAB_0010d270;
            }
...
LAB_0010d2e2:
              puVar11 = puVar11 + 1;
              if (puVar7 == puVar11) goto LAB_0010d310;
            }
            if (*(code **)(*(long *)pPVar5 + 8) == ~PolyPathD) {
              ~PolyPathD(pPVar5);
              operator_delete(pPVar5,0x48);
      ...
      for (plVar6 = (long *)*plVar5; plVar4 != plVar6; plVar6 = plVar6 + 2) {
        while( true ) {
          ...
          _M_realloc_insert<Clipper2Lib::Point<double>>
                    ((vector<Clipper2Lib::Point<double>,std::allocator<Clipper2Lib::Point<double>>>
                      *)local_58,local_58._8_8_,&local_68);
          if (plVar4 == plVar6) goto LAB_0010d4f0;
        }
...

{
  ...
  local_13c = 0;
  if (param_8 + 8U < 0x11) {
    if (param_2 == 0.0) goto LAB_0010d638;
        ...
        *pauVar4 = (undefined1  [16])0x0;
        if (uVar8 == 0) {
          ...
          if (0x7ffffffffffffff0 < uVar8) {
            if (-1 < (long)uVar8) goto LAB_0010db01;
            goto LAB_0010dafc;
          }

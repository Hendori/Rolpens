...

{
  ...
  if (param_5 < 2) {
    ...
    psVar4 = psVar1;
    do {
      *(undefined4 *)psVar4 = uVar8;
      *(undefined4 *)(psVar4 + 2) = uVar8;
      *(undefined4 *)(psVar4 + 4) = uVar8;
  ...
  if (bVar2 == 2) {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      ...
      (**(code **)(param_1 + 0x50))(lVar6,uVar8,psVar1);
      return;
    }
  }
  else {
    ...
    if (iVar3 < 2) {
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00101b85. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        (**(code **)(param_1 + 0x58))(lVar6,lVar5 + local_48,uVar8,psVar1);
        return;
      }
    }
    else if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00101b11. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      (**(code **)(param_1 + 0x60))(lVar6,local_48 + lVar5,local_44 + lVar5,uVar8,psVar1);
      return;
    }
  }
...
LAB_00101bb3:
  ...
  if (*param_1 == 3) {
    if (2 < param_1[1]) goto LAB_00101bb3;
    if (param_1[1] == 2) {

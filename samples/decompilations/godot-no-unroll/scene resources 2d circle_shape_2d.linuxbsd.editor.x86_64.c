...
/* CircleShape2D::get_enclosing_radius() const */

undefined4 __thiscall CircleShape2D::get_enclosing_radius(CircleShape2D *this)
...
/* CircleShape2D::get_rect() const */

undefined1  [16] __thiscall CircleShape2D::get_rect(CircleShape2D *this)
...
/* CircleShape2D::_edit_is_selected_on_click(Vector2 const&, double) const */

bool CircleShape2D::_edit_is_selected_on_click(Vector2 *param_1,double param_2)

{
  float fVar1;
  
  fVar1 = (float)Vector2::length();
  return (double)fVar1 < (double)*(float *)(param_1 + 0x24c) + param_2;
}
...
/* CircleShape2D::_update_shape() */

void __thiscall CircleShape2D::_update_shape(CircleShape2D *this)

{
  ...
  Variant::Variant((Variant *)local_48,*(float *)(this + 0x24c));
...
/* CircleShape2D::set_radius(float) */

void __thiscall CircleShape2D::set_radius(CircleShape2D *this,float param_1)

{
  if (param_1 < 0.0) {
    _err_print_error("set_radius","scene/resources/2d/circle_shape_2d.cpp",0x2e,
                     "Condition \"p_radius < 0\" is true.",
                     "CircleShape2D radius cannot be negative.",0,0);
    return;
  }
...
void __thiscall CircleShape2D::CircleShape2D(CircleShape2D *this)

{
  ...
  local_18 = (**(code **)(*plVar1 + 0x170))(plVar1);
  Shape2D::Shape2D((Shape2D *)this,(RID *)&local_18);
  *(undefined4 *)(this + 0x24c) = 0x41200000;
  *(undefined ***)this = &PTR__initialize_classv_001057d0;
...
/* CircleShape2D::_bind_methods() */

void CircleShape2D::_bind_methods(void)

{
  ...
  local_58 = (char **)0x0;
  pMVar4 = create_method_bind<CircleShape2D,float>(set_radius);
  ...
  local_50 = (undefined1  [16])0x0;
  local_58 = (char **)0x0;
  pMVar4 = create_method_bind<CircleShape2D,float>(get_enclosing_radius);
  ClassDB::bind_methodfi(1,pMVar4,false,(MethodDefinition *)&local_98,(Variant **)0x0,0);
  if (Variant::needs_deinit[(int)local_58] != '\0') {
    Variant::_clear_internal();
  }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* CircleShape2D::draw(RID const&, Color const&) */

void __thiscall CircleShape2D::draw(CircleShape2D *this,RID *param_1,Color *param_2)

{
  ...
  CowData<Vector2>::resize<false>((CowData<Vector2> *)&local_70,0x18);
  puVar10 = local_70;
  fVar12 = (float)_LC28;
  fVar13 = _LC28._4_4_;
  while (fVar1 = *(float *)(this + 0x24c), puVar10 != (undefined8 *)0x0) {
    lVar9 = puVar10[-1];
    if (lVar9 <= lVar11) goto LAB_00100bcb;
    CowData<Vector2>::_copy_on_write((CowData<Vector2> *)&local_70);
    puVar10 = local_70;
    iVar7 = (int)lVar11;
    local_70[lVar11] = CONCAT44(fVar1 * fVar13,fVar1 * fVar12);
    lVar11 = lVar11 + 1;
    if (lVar11 == 0x18) {
      uVar3 = *(undefined8 *)param_2;
      uVar5 = *(undefined8 *)(param_2 + 8);
      local_60 = (undefined8 *)0x0;
      iVar7 = CowData<Color>::resize<false>((CowData<Color> *)&local_60,1);
      if (iVar7 == 0) {
...
LAB_00100c69:
      ...
      (**(code **)(*plVar8 + 0xf50))(plVar8,*(undefined8 *)param_1,local_78,local_68,local_58,0);
      puVar10 = local_50[0];
      ...
      cVar6 = Shape2D::is_collision_outline_enabled();
      if (cVar6 == '\0') goto LAB_00100dee;
...
LAB_00100f23:
      ...
      lVar11 = local_70[-1];
      if (lVar11 < 1) goto LAB_00100f23;
      uVar3 = *local_70;
      iVar7 = CowData<Vector2>::resize<false>((CowData<Vector2> *)&local_70,lVar11 + 1);
      if (iVar7 == 0) {
        if (local_70 == (undefined8 *)0x0) {
          lVar9 = -1;
          lVar11 = 0;
          ...
          if (-1 < lVar9) {
            CowData<Vector2>::_copy_on_write((CowData<Vector2> *)&local_70);
            local_70[lVar9] = uVar3;
            goto LAB_00100d2f;
          }
        }
        _err_print_index_error
                  ("set","./core/templates/cowdata.h",0xcf,lVar9,lVar11,"p_index","size()","",false,
                   false);
      }
      else {
...
LAB_00100d2f:
      ...
      uVar3 = *(undefined8 *)param_2;
      local_50[0] = (undefined8 *)0x0;
      iVar7 = CowData<Color>::resize<false>((CowData<Color> *)local_50,1);
      puVar10 = local_50[0];
      if (iVar7 == 0) {
        if (local_50[0] == (undefined8 *)0x0) {
          lVar11 = 0;
LAB_00100e91:
        ...
        lVar11 = local_50[0][-1];
        if (lVar11 < 1) goto LAB_00100e91;
        CowData<Color>::_copy_on_write((CowData<Color> *)local_50);
        *local_50[0] = uVar3;
        *(undefined4 *)((long)local_50[0] + 0xc) = 0x3f800000;
        *(undefined4 *)(local_50[0] + 1) = uVar2;
        puVar10 = local_50[0];
        if (local_60 == local_50[0]) goto LAB_00100ee1;
LAB_00100dad:
        puVar10 = local_60;
        if (local_60 != (undefined8 *)0x0) {
          LOCK();
...
LAB_00100eca:
        if (local_60 != puVar10) goto LAB_00100dad;
...
LAB_00100ee1:
      ...
      plVar8 = (long *)RenderingServer::get_singleton();
      (**(code **)(*plVar8 + 0xf00))(plVar8,*(undefined8 *)param_1,local_78,local_68,0);
LAB_00100dee:
      puVar10 = local_60;
      if (local_60 != (undefined8 *)0x0) {
        LOCK();
    ...
    sincosf((float)(iVar7 + 1) * __LC33,&local_7c,&local_80);
    fVar12 = local_80;
    fVar13 = local_7c;
  }
  lVar9 = 0;
...
/* CircleShape2D::is_class_ptr(void*) const */

uint __thiscall CircleShape2D::is_class_ptr(CircleShape2D *this,void *param_1)

{
  return (uint)CONCAT71(0x105a,(undefined4 *)param_1 == &Shape2D::get_class_ptr_static()::ptr) |
...
/* CircleShape2D::_getv(StringName const&, Variant&) const */

undefined8 CircleShape2D::_getv(StringName *param_1,Variant *param_2)
...
/* CircleShape2D::_setv(StringName const&, Variant const&) */

undefined8 CircleShape2D::_setv(StringName *param_1,Variant *param_2)
...
/* CircleShape2D::_validate_propertyv(PropertyInfo&) const */

void CircleShape2D::_validate_propertyv(PropertyInfo *param_1)
...
/* CircleShape2D::_property_can_revertv(StringName const&) const */

undefined8 CircleShape2D::_property_can_revertv(StringName *param_1)
...
/* CircleShape2D::_property_get_revertv(StringName const&, Variant&) const */

undefined8 CircleShape2D::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* CircleShape2D::_notificationv(int, bool) */

void CircleShape2D::_notificationv(int param_1,bool param_2)
...
{
  *(undefined ***)this = &PTR__gen_argument_type_001059c8;
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00105a28;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
/* CircleShape2D::_bind_methods() [clone .cold] */
...
/* CircleShape2D::_get_class_namev() const */

undefined8 * CircleShape2D::_get_class_namev(void)
...
LAB_00101463:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"CircleShape2D");
      goto LAB_001014ce;
    }
  }
  StringName::assign_static_unique_class_name
...
/* CircleShape2D::get_class() const */

void CircleShape2D::get_class(void)
...
LAB_00101898:
    ...
    local_30 = 6;
    if (local_40 != 0x11) goto LAB_00101898;
...
LAB_00101bf8:
    ...
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_00101bf8;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)pLVar6;
      local_68 = local_80;
      goto joined_r0x00101c16;
    }
...
/* CircleShape2D::is_class(String const&) const */

undefined8 __thiscall CircleShape2D::is_class(CircleShape2D *this,String *param_1)
...
LAB_0010228f:
    ...
    if (cVar6 != '\0') goto LAB_00102343;
  }
  cVar6 = String::operator==(param_1,"CircleShape2D");
  if (cVar6 == '\0') {
    for (lVar2 = *(long *)(this + 8); lVar2 != 0; lVar2 = *(long *)(lVar2 + 8)) {
      lVar4 = *(long *)(lVar2 + 0x20);
      if (lVar4 == 0) {
...
LAB_00102638:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_00102638;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x00102655;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
/* CircleShape2D::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall CircleShape2D::_get_property_listv(CircleShape2D *this,List *param_1,bool param_2)
...
LAB_00102ed8:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_00102ed8;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x00102ef5;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
joined_r0x00102ef5:
  ...
  *(int *)(plVar1 + 2) = (int)plVar1[2] + 1;
  ...
  StringName::StringName((StringName *)&local_78,"CircleShape2D",false);
  ClassDB::get_property_list((StringName *)&local_78,param_1,true,(Object *)this);
  if ((StringName::configured != '\0') && (local_78 != (char *)0x0)) {
    StringName::unref();
  }
...
/* MethodBind* create_method_bind<CircleShape2D, float>(void (CircleShape2D::*)(float)) */

MethodBind * create_method_bind<CircleShape2D,float>(_func_void_float *param_1)
...
/* MethodBind* create_method_bind<CircleShape2D, float>(float (CircleShape2D::*)() const) */

MethodBind * create_method_bind<CircleShape2D,float>(_func_float *param_1)
...
/* CircleShape2D::_initialize_classv() */

void CircleShape2D::_initialize_classv(void)
...
LAB_00103d4c:
    ...
    lVar3 = puVar9[-1];
    if (param_1 <= lVar3) goto LAB_00103ce1;
  }
  else {
    if (lVar8 != 0) {
...
LAB_0010407c:
    ...
    lVar4 = puVar8[-1];
    if (param_1 <= lVar4) goto LAB_00104014;
  }
  else {
    if (lVar10 != 0) {
...
/* WARNING: Removing unreachable block (ram,0x00104308) */
/* WARNING: Removing unreachable block (ram,0x00104438) */
/* WARNING: Removing unreachable block (ram,0x00104600) */
/* WARNING: Removing unreachable block (ram,0x00104444) */
/* WARNING: Removing unreachable block (ram,0x0010444e) */
/* WARNING: Removing unreachable block (ram,0x001045e0) */
/* WARNING: Removing unreachable block (ram,0x0010445a) */
/* WARNING: Removing unreachable block (ram,0x00104464) */
/* WARNING: Removing unreachable block (ram,0x001045c0) */
/* WARNING: Removing unreachable block (ram,0x00104470) */
/* WARNING: Removing unreachable block (ram,0x0010447a) */
/* WARNING: Removing unreachable block (ram,0x001045a0) */
/* WARNING: Removing unreachable block (ram,0x00104486) */
/* WARNING: Removing unreachable block (ram,0x00104490) */
/* WARNING: Removing unreachable block (ram,0x00104580) */
/* WARNING: Removing unreachable block (ram,0x0010449c) */
/* WARNING: Removing unreachable block (ram,0x001044a6) */
/* WARNING: Removing unreachable block (ram,0x00104560) */
/* WARNING: Removing unreachable block (ram,0x001044b2) */
/* WARNING: Removing unreachable block (ram,0x001044bc) */
...
/* WARNING: Removing unreachable block (ram,0x001044e6) */
...

{
  ...
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
    ...
    auVar5._0_4_ = (float)*(double *)(*(long *)param_3 + 8);
                    /* WARNING: Could not recover jumptable at 0x00104eee. Too many branches */
...

{
  ...
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
    ...
    auVar4._0_4_ = (float)**param_3;
                    /* WARNING: Could not recover jumptable at 0x0010510d. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
LAB_0010533b:
  *(undefined4 *)param_6 = 0;
  ...
  fVar9 = Variant::operator_cast_to_float(this);
                    /* WARNING: Could not recover jumptable at 0x00105394. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*param_2)(fVar9);
  return;
}

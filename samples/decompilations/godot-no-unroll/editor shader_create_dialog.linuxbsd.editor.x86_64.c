...

{
  ...
  iVar5 = OptionButton::get_selected();
  puVar3 = *(undefined8 **)(this + 0xdb8);
  if ((puVar3 == (undefined8 *)0x0) || (iVar5 < 0)) {
    lVar9 = 0;
    if (puVar3 != (undefined8 *)0x0) {
      lVar9 = (long)*(int *)(puVar3 + 2);
    }
  }
  else {
    lVar9 = (long)*(int *)(puVar3 + 2);
    if (iVar5 < *(int *)(puVar3 + 2)) {
      plVar8 = (long *)*puVar3;
      if (iVar5 != 0) {
        iVar7 = 0;
        do {
      ...
      if (((long *)*plVar8 != (long *)0x0) &&
         (pCVar10 = *(CowData **)*plVar8, pCVar10 != (CowData *)0x0)) {
        ...
        do {
          while( true ) {
            ...
            *(undefined1 (*) [16])(this_00 + 0x10) = (undefined1  [16])0x0;
            ...
            lVar9 = *(long *)(*pauVar6 + 8);
            *(undefined8 *)(this_00 + 8) = 0;
            *(undefined1 (**) [16])(this_00 + 0x18) = pauVar6;
            *(long *)(this_00 + 0x10) = lVar9;
            if (lVar9 != 0) {
              *(CowData<char32_t> **)(lVar9 + 8) = this_00;
            }
            lVar9 = *(long *)*pauVar6;
            *(CowData<char32_t> **)(*pauVar6 + 8) = this_00;
            if (lVar9 != 0) break;
            pCVar10 = *(CowData **)(pCVar10 + 8);
            *(int *)pauVar6[1] = *(int *)pauVar6[1] + 1;
            *(CowData<char32_t> **)*pauVar6 = this_00;
            if (pCVar10 == (CowData *)0x0) goto LAB_00100fde;
          }
          pCVar10 = *(CowData **)(pCVar10 + 8);
          *(int *)pauVar6[1] = *(int *)pauVar6[1] + 1;
        } while (pCVar10 != (CowData *)0x0);
LAB_00100fde:
        for (lVar9 = *(long *)*pauVar6; lVar9 != 0; lVar9 = *(long *)(lVar9 + 8)) {
          pSVar1 = *(String **)(this + 0xe00);
          local_58 = "";
          local_60 = 0;
          local_50 = 0;
  ...
  _err_print_index_error
            ("get","./core/templates/list.h",0x21c,(long)iVar5,lVar9,"p_index","size()","",false,
             true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
...

{
  ...
  String::get_file();
  String::get_basename();
  if ((local_68._0_8_ == 0) || (iVar22 = (int)*(undefined8 *)(local_68._0_8_ + -8), iVar22 == 0)) {
    CowData<char32_t>::_unref((CowData<char32_t> *)local_68);
    CowData<char32_t>::_unref((CowData<char32_t> *)local_78);
LAB_00101417:
    auVar18._8_8_ = 0;
    auVar18._0_8_ = local_68._8_8_;
    local_68 = auVar18 << 0x40;
    String::parse_latin1((String *)local_68,"");
    pcVar28 = "Filename is empty.";
  }
  else {
    CowData<char32_t>::_unref((CowData<char32_t> *)local_68);
    CowData<char32_t>::_unref((CowData<char32_t> *)local_78);
    if (iVar22 == 1) goto LAB_00101417;
    ...
    CowData<char32_t>::_unref((CowData<char32_t> *)local_68);
    cVar21 = String::begins_with((char *)&local_a0);
    if (cVar21 != '\0') {
      DirAccess::create(&local_98,0);
      pOVar19 = local_98;
      pcVar2 = *(code **)(*(long *)local_98 + 0x1a8);
      String::get_base_dir();
      iVar22 = (*pcVar2)(pOVar19,(CowData<char32_t> *)local_68);
      CowData<char32_t>::_unref((CowData<char32_t> *)local_68);
      if (iVar22 == 0) {
        ...
        cVar21 = (*pcVar2)(pOVar19,(CowData<char32_t> *)local_68);
        CowData<char32_t>::_unref((CowData<char32_t> *)local_68);
        if (cVar21 == '\0') {
          String::get_extension();
          plVar26 = *(long **)(in_RSI + 0xdb8);
          local_48 = 2;
          local_68 = (undefined1  [16])0x0;
          local_58 = (undefined1  [16])0x0;
          if (plVar26 != (long *)0x0) {
          ...
          pSVar29 = (String *)0x0;
          do {
            if ((undefined8 *)*plVar26 != (undefined8 *)0x0) {
              uVar17 = local_48;
              for (pSVar32 = *(String **)*plVar26; local_48 = uVar17, pSVar32 != (String *)0x0;
                  pSVar32 = *(String **)(pSVar32 + 8)) {
                if ((pSVar29 != (String *)0x0) &&
                   (local_48._4_4_ = (uint)(uVar17 >> 0x20), bVar34 = local_48._4_4_ != 0, bVar34))
                {
                  uVar1 = *(uint *)(hash_table_size_primes + (uVar17 & 0xffffffff) * 4);
                  lVar30 = *(long *)(hash_table_size_primes_inv + (uVar17 & 0xffffffff) * 8);
                  uVar23 = String::hash();
                  ...
                  auVar4._8_8_ = 0;
                  auVar4._0_8_ = (ulong)uVar27 * lVar30;
                  auVar8._8_8_ = 0;
                  auVar8._0_8_ = uVar17;
                  ...
                  if (uVar23 != 0) {
                    ...
                    do {
                      if (uVar27 == uVar23) {
                        cVar21 = String::operator==(pSVar29 + (ulong)*(uint *)(local_68._8_8_ +
                                                                              lVar25 * 4) * 8,
                                                    pSVar32);
                        if (cVar21 != '\0') goto LAB_00101760;
                      }
                      uVar33 = uVar33 + 1;
                      auVar5._8_8_ = 0;
                      auVar5._0_8_ = (ulong)(iVar22 + 1) * lVar30;
                      auVar9._8_8_ = 0;
                      auVar9._0_8_ = uVar17;
                      lVar25 = SUB168(auVar5 * auVar9,8);
                      uVar23 = *(uint *)(uVar20 + lVar25 * 4);
                      iVar22 = SUB164(auVar5 * auVar9,8);
                    } while ((uVar23 != 0) &&
                            (auVar6._8_8_ = 0, auVar6._0_8_ = (ulong)uVar23 * lVar30,
                            auVar10._8_8_ = 0, auVar10._0_8_ = uVar17, auVar7._8_8_ = 0,
                            auVar7._0_8_ = (ulong)((uVar1 + iVar22) - SUB164(auVar6 * auVar10,8)) *
                                           lVar30, auVar11._8_8_ = 0, auVar11._0_8_ = uVar17,
                            uVar33 <= SUB164(auVar7 * auVar11,8)));
                  }
                }
                HashSet<String,HashMapHasherDefault,HashMapComparatorDefault<String>>::insert
                          ((String *)local_78);
                pSVar29 = (String *)local_68._0_8_;
LAB_00101760:
                uVar17 = local_48;
              }
            }
            local_c4 = local_c4 + -1;
            plVar26 = (long *)plVar26[3];
          } while (local_c4 != 0);
          uVar1 = local_48._4_4_;
          if (local_48._4_4_ != 0) {
            iVar22 = 1;
            pSVar32 = pSVar29;
            while (cVar21 = String::nocasecmp_to(pSVar32), cVar21 != '\0') {
              if ((int)uVar1 <= iVar22) {
                local_78[0] = 0;
                ...
                CowData<char32_t>::_unref((CowData<char32_t> *)&local_80);
                CowData<char32_t>::_unref((CowData<char32_t> *)local_78);
                if (pSVar29 == (String *)0x0) goto LAB_0010187c;
                goto LAB_001019ee;
              }
              iVar22 = iVar22 + 1;
              pSVar32 = pSVar32 + 8;
            }
            iVar22 = *(int *)(in_RSI + 0xe28);
            puVar3 = *(undefined8 **)(in_RSI + 0xdb8);
            if (iVar22 < 0) {
              lVar30 = 0;
              if (puVar3 == (undefined8 *)0x0) goto LAB_00101ad7;
            }
            else {
              if (puVar3 == (undefined8 *)0x0) {
                lVar30 = 0;
              ...
              if (iVar22 < *(int *)(puVar3 + 2)) {
                ...
                if ((undefined8 *)*plVar26 != (undefined8 *)0x0) {
                  for (pSVar32 = *(String **)*plVar26; pSVar32 != (String *)0x0;
                      pSVar32 = *(String **)(pSVar32 + 8)) {
                    cVar21 = String::nocasecmp_to(pSVar32);
                    if (cVar21 == '\0') {
...
LAB_001019ee:
                  ...
                  do {
                    ...
                    pSVar32 = (String *)((CowData<char32_t> *)pSVar32 + 8);
                  } while (uVar27 < uVar1);
                  goto LAB_00101903;
                }
                goto LAB_0010187c;
            ...
            lVar30 = (long)*(int *)(puVar3 + 2);
LAB_00101ad7:
            _err_print_index_error
                      ("get","./core/templates/list.h",0x21c,(long)iVar22,lVar30,"p_index","size()",
                       "",false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_0010187c:
          ...
          auVar16._8_8_ = 0;
          auVar16._0_8_ = local_68._8_8_;
          local_68 = auVar16 << 0x40;
          String::parse_latin1((String *)local_68,"");
          local_78[0] = 0;
        ...
        if (((local_90 != (Object *)0x0) && (cVar21 = RefCounted::unreference(), cVar21 != '\0')) &&
           (cVar21 = predelete_handler(local_90), cVar21 != '\0')) {
      ...
      if (((local_98 != (Object *)0x0) && (cVar21 = RefCounted::unreference(), cVar21 != '\0')) &&
         (cVar21 = predelete_handler(local_98), cVar21 != '\0')) {
    ...
    String::parse_latin1((String *)local_68,"");
    pcVar28 = "Path is not local.";
  }
  local_78[0] = 0;
  String::parse_latin1((String *)local_78,pcVar28);
  TTR(param_1,(String *)local_78);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_78);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_68);
LAB_00101216:
...

{
  ...
  if (this[0xe22] == (ShaderCreateDialog)0x0) {
    if (this[0xe21] == (ShaderCreateDialog)0x0) {
      ...
      uVar4 = *(undefined8 *)(this + 0xdc8);
      if (this[0xe22] != (ShaderCreateDialog)0x0) goto LAB_00101f3d;
    }
...
LAB_00101f3d:
    ...
    if ((cVar2 == '\0') || (this[0xe20] != (ShaderCreateDialog)0x0)) goto LAB_00101f4d;
    uVar4 = *(undefined8 *)(this + 0xdc8);
    local_50 = 0;
    String::parse_latin1((String *)&local_50,"");
    local_58 = 0;
...
LAB_00101fb4:
    if (this[0xe20] == (ShaderCreateDialog)0x0) {
      ...
      if (this[0xe24] != (ShaderCreateDialog)0x0) {
        ...
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_50);
        if (this[0xe21] == (ShaderCreateDialog)0x0) goto LAB_001021c4;
        local_50 = 0;
        uVar4 = *(undefined8 *)(this + 0xdc8);
        String::parse_latin1((String *)&local_50,"");
    ...
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_50);
    if (this[0xe22] == (ShaderCreateDialog)0x0) goto LAB_00101fb4;
    local_50 = 0;
    String::parse_latin1((String *)&local_50,"");
    local_58 = 0;
    String::parse_latin1((String *)&local_58,"Create");
  ...
  if ((puVar1 == (undefined8 *)0x0) || (param_1 < 0)) {
    ...
    if (param_1 < *(int *)(puVar1 + 2)) {
      ...
      if (((long *)*plVar9 != (long *)0x0) &&
         (pCVar8 = *(CowData **)*plVar9, pCVar8 != (CowData *)0x0)) {
        ...
        do {
          while( true ) {
            ...
            *(CowData<char32_t> **)*local_98 = this_00;
            if (pCVar8 == (CowData *)0x0) goto LAB_00102620;
          }
          pCVar8 = *(CowData **)(pCVar8 + 8);
          *(int *)local_98[1] = *(int *)local_98[1] + 1;
...
LAB_00102620:
      local_90 = 0;
      CowData<char32_t>::_ref((CowData<char32_t> *)&local_90,(CowData *)(plVar9 + 1));
      local_88 = (char)plVar9[2];
      ...
      if ((local_d0 == (undefined *)0x0) || (*(uint *)(local_d0 + -8) < 2)) {
        ...
        iVar4 = String::find_char((wchar32)(CowData<char32_t> *)&local_d0,0x2e);
        if (iVar4 != -1) {
          String::get_extension();
      ...
      OptionButton::clear();
      iVar4 = (int)(CowData<char32_t> *)&local_a8;
      if (local_88 == '\0') {
        ...
        OptionButton::add_item(pSVar6,iVar4);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_a8);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_b8);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_b0);
      }
        ...
        EditorSettings::get_project_metadata((String *)local_58,pSVar6,(Variant *)&local_b0);
        iVar5 = Variant::operator_cast_to_int((Variant *)local_58);
        if (Variant::needs_deinit[local_58[0]] != '\0') {
          Variant::_clear_internal();
        }
      ...
      EditorSettings::set_project_metadata(pSVar6,(String *)&local_b8,(Variant *)&local_b0);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_b8);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_b0);
      if (Variant::needs_deinit[local_58[0]] != '\0') {
        Variant::_clear_internal();
  ...
  _err_print_index_error
            ("get","./core/templates/list.h",0x21c,(long)param_1,lVar7,"p_index","size()","",false,
             true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
...

{
  ...
  if ((*(long *)param_1 != 0) && (1 < *(uint *)(*(long *)param_1 + -8))) {
    ...
    _err_print_index_error
              ("get","./core/templates/list.h",0x21c,(long)iVar5,lVar8,"p_index","size()","",false,
               true);
    _err_flush_stdout();
                    /* WARNING: Does not return */
    pcVar3 = (code *)invalidInstructionException();
...

{
  ...
  if (plVar6 != (long *)0x0) {
    do {
      ...
      if (this_01 == (List<String,DefaultAllocator> *)0x0) goto LAB_001030b6;
      ...
      *pauVar5 = (undefined1  [16])0x0;
      do {
        while( true ) {
          ...
          *(int *)(plVar6 + 2) = (int)plVar6[2] + 1;
          *plVar6 = (long)pCVar3;
          if (pCVar7 == (CowData *)0x0) goto LAB_00103364;
        }
        pCVar7 = *(CowData **)(pCVar7 + 8);
        *(int *)(plVar6 + 2) = (int)plVar6[2] + 1;
...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_00111b48;
  ...
  *(undefined ***)pBVar9 = &PTR__initialize_classv_00111558;
  ...
  *(undefined ***)this_04 = &PTR_hash_00111ee8;
  ...
  *(char **)(this_04 + 0x20) = "ShaderCreateDialog::_built_in_toggled";
  ...
  pBVar9[0xa0c] = (BoxContainer)0x1;
  *(undefined ***)pBVar9 = &PTR__initialize_classv_001111e0;
  postinitialize_handler((Object *)pBVar9);
...
LAB_001050f0:
      ...
      if (local_f8 == pVVar5) goto LAB_001050f0;
      local_c8 = local_f8;
      local_f8 = pVVar5;
...
LAB_00104c8e:
    ...
    if (cVar3 != '\0') {
      ...
      if (cVar3 != '\0') goto LAB_00104945;
      goto LAB_0010496a;
    }
LAB_0010476c:
    if (local_f8 == (VisualShader *)0x0) goto LAB_00104780;
LAB_00104976:
    if (this[0xe22] == (ShaderCreateDialog)0x0) {
      ProjectSettings::get_singleton();
      LineEdit::get_text();
...
LAB_00104e81:
    ...
    if (iVar4 == 2) {
      ...
      *(undefined ***)this_00 = &PTR__initialize_classv_00111008;
      ...
      *(undefined1 (*) [16])((Resource *)this_00 + 0x260) = (undefined1  [16])0x0;
      ...
      if (cVar3 == '\0') {
LAB_00104743:
        if (local_f0 == (VisualShader *)0x0) goto LAB_0010496a;
        local_c8 = local_f0;
        local_f0 = (VisualShader *)0x0;
        Ref<Resource>::unref((Ref<Resource> *)&local_c8);
        goto LAB_0010476c;
...
LAB_001045c1:
      ...
      cVar3 = RefCounted::unreference();
      if (cVar3 != '\0') goto LAB_00104939;
    }
LAB_0010496a:
    if (local_f8 != (VisualShader *)0x0) goto LAB_00104976;
LAB_00104780:
    ProjectSettings::get_singleton();
    LineEdit::get_text();
    ProjectSettings::localize_path((String *)local_e0);
...

{
  ...
  if (*(code **)(*(long *)param_1 + 0x250) == ok_pressed) {
    ...
    return;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00105341. Too many branches */
...

{
  ...
  return (uint)CONCAT71(0x1121,in_RSI == &AcceptDialog::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1121,in_RSI == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1121,in_RSI == &Window::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1121,in_RSI == &Viewport::get_class_ptr_static()::ptr) |
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00112008;
...
{
  *(undefined ***)this = &PTR__initialize_classv_001118d0;
...
/* WARNING: Removing unreachable block (ram,0x00107558) */
...
/* WARNING: Removing unreachable block (ram,0x001075c8) */
...

{
  ...
  if (in_RSI != &get_class_ptr_static()::ptr) {
    uVar1 = (uint)CONCAT71(0x1121,in_RSI == &Container::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x1121,in_RSI == &BoxContainer::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x1121,in_RSI == &Control::get_class_ptr_static()::ptr) |
...

{
  ...
  uVar1 = 1;
  if (in_RSI != &get_class_ptr_static()::ptr) {
    uVar1 = (uint)CONCAT71(0x1121,in_RSI == &AcceptDialog::get_class_ptr_static()::ptr) |
...

{
  ...
  *(code **)this = String::parse_latin1;
  if (bVar1) {
    if (*(long *)(this + 0x9e8) != 0) {
      StringName::unref();
      if (StringName::configured == '\0') goto LAB_001077e0;
    }
    if (*(long *)(this + 0x9d0) != 0) {
      StringName::unref();
    }
...

{
  ...
  *(code **)this = String::parse_latin1;
  if (bVar1) {
    if (*(long *)(this + 0x9e8) != 0) {
      StringName::unref();
      if (StringName::configured == '\0') goto LAB_00107840;
    }
    if (*(long *)(this + 0x9d0) != 0) {
      StringName::unref();
    }
...

{
  ...
  *(code **)this = String::parse_latin1;
  if (bVar1) {
    if (*(long *)(this + 0x9e8) != 0) {
      StringName::unref();
      if (StringName::configured == '\0') goto LAB_001078b0;
    }
    if (*(long *)(this + 0x9d0) != 0) {
      StringName::unref();
    }
...

{
  ...
  *(undefined ***)this = &PTR_hash_00111dc8;
...

{
  ...
  *(undefined1 (*) [16])(this + 0x30) = (undefined1  [16])0x0;
  *(undefined8 *)(this + 0x40) = 0;
  *(undefined ***)this = &PTR_hash_00111e58;
  uVar1 = *(undefined8 *)(param_2 + 0x60);
  *(char **)(this + 0x28) = param_2;
  *(undefined8 *)(this + 0x30) = uVar1;
  *(undefined8 *)(this + 0x38) = in_RCX;
...

{
  ...
  *(undefined1 (*) [16])(this + 0x30) = (undefined1  [16])0x0;
  *(undefined8 *)(this + 0x40) = 0;
  *(undefined ***)this = &PTR_hash_00111f78;
  uVar1 = *(undefined8 *)(param_2 + 0x60);
  *(char **)(this + 0x28) = param_2;
  *(undefined8 *)(this + 0x30) = uVar1;
  *(undefined8 *)(this + 0x38) = in_RCX;
...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_00111008;
  if (pvVar5 == (void *)0x0) goto LAB_00108b2b;
  if (*(int *)(this + 0x274) != 0) {
    if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x270) * 4) != 0) {
      ...
      if (*(int *)(this + 0x274) == 0) goto LAB_00108af7;
    }
    lVar4 = 0;
    do {
...

{
  ...
  if (uVar3 < (uint)ObjectDB::slot_max) {
    ...
    ObjectDB::spin_lock._0_1_ = '\0';
    if (puVar4[1] == 0) goto LAB_00109bcf;
    ...
    if (param_2 == 0) {
      *(undefined4 *)param_4 = 0;
      ...
      if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00109ba8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (uVar5 < (uint)ObjectDB::slot_max) {
    ...
    ObjectDB::spin_lock._0_1_ = '\0';
    if (puVar6[1] == 0) goto LAB_00109e49;
    lVar1 = *(long *)(this + 0x28);
    UNRECOVERED_JUMPTABLE = *(code **)(this + 0x38);
    lVar2 = *(long *)(this + 0x40);
    if ((uint)param_2 < 2) {
      if (param_2 != 0) {
        *(undefined4 *)param_4 = 0;
        ...
        if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00109df8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (uVar6 < (uint)ObjectDB::slot_max) {
    ...
    ObjectDB::spin_lock._0_1_ = '\0';
    if (puVar7[1] == 0) goto LAB_0010a0b8;
    lVar1 = *(long *)(this + 0x28);
    UNRECOVERED_JUMPTABLE = *(code **)(this + 0x38);
    lVar2 = *(long *)(this + 0x40);
    if ((uint)param_2 < 2) {
      if (param_2 != 0) {
        *(undefined4 *)param_4 = 0;
        ...
        if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010a067. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  pvVar5 = *(void **)(this + 0x250);
  *(undefined ***)this = &PTR__initialize_classv_00111008;
  if (pvVar5 == (void *)0x0) goto LAB_0010abab;
  if (*(int *)(this + 0x274) != 0) {
    if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x270) * 4) != 0) {
      memset(*(void **)(this + 0x268),0,
             (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x270) * 4) << 2);
      if (*(int *)(this + 0x274) == 0) goto LAB_0010ab77;
    }
    lVar4 = 0;
    do {
      plVar1 = (long *)((long)pvVar5 + lVar4 * 8);
  ...
  if (pvVar3 != (void *)0x0) {
    if (*(int *)(this + 0x3c) != 0) {
      ...
      if (uVar1 == 0) {
        ...
        *(undefined4 *)(this + 0x3c) = 0;
        *(undefined1 (*) [16])(this + 0x28) = (undefined1  [16])0x0;
        if (pvVar3 == (void *)0x0) goto LAB_0010cc4f;
      }
    }
    Memory::free_static(pvVar3,false);
    Memory::free_static(*(void **)(this + 0x20),false);
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    ...
                    /* WARNING: Could not recover jumptable at 0x00110055. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)

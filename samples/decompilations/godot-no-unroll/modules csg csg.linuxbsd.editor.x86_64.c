...
/* CowData<CSGBrush::Face>::_copy_on_write() [clone .isra.0] */

void __thiscall CowData<CSGBrush::Face>::_copy_on_write(CowData<CSGBrush::Face> *this)
...
/* CSGBrush::copy_from(CSGBrush const&, Transform3D const&) */

void __thiscall CSGBrush::copy_from(CSGBrush *this,CSGBrush *param_1,Transform3D *param_2)
...
LAB_0010033b:
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,lVar19,lVar17,"p_index","size()","",false
                   ,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_00100383:
        _err_print_index_error
                  ("operator[]","./core/templates/vector.h",0x38,lVar19,lVar13,"p_index",
      ...
      *puVar18 = CONCAT44((float)((ulong)uVar9 >> 0x20) * fVar21 + fVar22 * fVar3 +
                          (float)((ulong)uVar8 >> 0x20) * fVar4 + (float)((ulong)uVar11 >> 0x20),
                          (float)uVar10 * fVar21 + fVar22 * fVar7 + (float)uVar9 * fVar4 +
                          (float)uVar11);
...
/* CSGBrush::build_from_faces(Vector<Vector3> const&, Vector<Vector2> const&, Vector<bool> const&,
   Vector<Ref<Material> > const&, Vector<bool> const&) */

void __thiscall
CSGBrush::build_from_faces
          (CSGBrush *this,Vector *param_1,Vector *param_2,Vector *param_3,Vector *param_4,
          Vector *param_5)

{
  ...
  uint local_a8;
  Object *local_80;
  HashMap<Ref<Material>,int,HashMapHasherDefault,HashMapComparatorDefault<Ref<Material>>,DefaultTypedAllocator<HashMapElement<Ref<Material>,int>>>
  local_78 [8];
  ...
  if (puVar41 == (undefined8 *)0x0) {
    ...
    if (0x55555554 < local_f0 * -0x55555555 + 0x2aaaaaaaU) {
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
        _err_print_error("build_from_faces","modules/csg/csg.cpp",0x28,
                         "Condition \"(vc % 3) != 0\" is true.",0,0);
        return;
      }
      goto LAB_00101312;
    }
...
LAB_00101157:
    _err_print_error("resize","./core/templates/cowdata.h",uVar33,pcVar29,0,0);
            ...
            if (cVar19 != '\0') {
              if ((local_70._0_8_ != 0) && (local_a8 != 0)) {
                ...
                if (uVar30 != 0) {
                  uVar39 = 0;
                  while ((uVar30 != uVar21 ||
                         (pOVar5 != *(Object **)(*(long *)(local_70._0_8_ + lVar22 * 8) + 0x10)))) {
                    uVar39 = uVar39 + 1;
                    auVar9._8_8_ = 0;
                    ...
                    if ((uVar30 == 0) ||
                       (auVar10._8_8_ = 0, auVar10._0_8_ = (ulong)uVar30 * lVar37, auVar14._8_8_ = 0
                       , auVar14._0_8_ = uVar36, auVar11._8_8_ = 0,
                       auVar11._0_8_ =
                            (ulong)((*(uint *)(hash_table_size_primes + (local_50 & 0xffffffff) * 4)
                                    + uVar31) - SUB164(auVar10 * auVar14,8)) * lVar37,
                       auVar15._8_8_ = 0, auVar15._0_8_ = uVar36,
                       SUB164(auVar11 * auVar15,8) < uVar39)) goto LAB_00100e9c;
                  }
...
LAB_00100e9c:
              *(uint *)(puVar34 + 0xb) = local_a8;
              puVar27 = (uint *)HashMap<Ref<Material>,int,HashMapHasherDefault,HashMapComparatorDefault<Ref<Material>>,DefaultTypedAllocator<HashMapElement<Ref<Material>,int>>>
                                ::operator[](local_78,(Ref *)&local_80);
              *puVar27 = local_a8;
              cVar19 = RefCounted::unreference();
joined_r0x00100ec7:
              if (cVar19 == '\0') {
...
LAB_001006d9:
      ...
      if (lVar40 != 0) {
        ...
        if (lVar38 != 0) {
          if (lVar37 <= lVar42) {
            if ((lVar38 == lVar22) ||
               (iVar20 = CowData<CSGBrush::Face>::_realloc(this_00,lVar38), iVar20 == 0)) {
              puVar32 = *(undefined8 **)(this + 8);
...
LAB_00100bc2:
            ...
            do {
              ...
              *(undefined8 *)((long)puVar34 + 0x24) = 0;
              *(undefined8 *)((long)puVar34 + 0x2c) = 0;
              *(undefined8 *)((long)puVar34 + 0x34) = 0;
              *(undefined8 *)((long)puVar34 + 0x3c) = 0;
...
LAB_00100a08:
  for (puVar41 = (undefined8 *)local_60._0_8_; puVar41 != (undefined8 *)0x0;
...
LAB_00100e09:
      _err_print_index_error
                ("operator[]","./core/templates/vector.h",0x38,lVar37,lVar42,"p_index",
                 "((Vector<T> *)(this))->_cowdata.size()","",false,true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
      pcVar16 = (code *)invalidInstructionException();
    ...
    if (pOVar5 != pOVar6) {
      *plVar1 = (long)pOVar5;
      if ((pOVar5 != (Object *)0x0) && (cVar19 = RefCounted::reference(), cVar19 == '\0')) {
        *plVar1 = 0;
      }
      if (((pOVar6 != (Object *)0x0) && (cVar19 = RefCounted::unreference(), cVar19 != '\0')) &&
         (cVar19 = predelete_handler(pOVar6), cVar19 != '\0')) {
...
/* CowData<CSGBrush::Face>::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<CSGBrush::Face>::_copy_on_write(void)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* CSGBrush::build_from_faces(Vector<Vector3> const&, Vector<Vector2> const&, Vector<bool> const&,
   Vector<Ref<Material> > const&, Vector<bool> const&) [clone .cold] */
...
/* CSGBrush::_regen_face_aabbs() */

void __thiscall CSGBrush::_regen_face_aabbs(CSGBrush *this)
...
LAB_001017f3:
      ...
      if (((fVar10 < 0.0) || (fVar14 = *(float *)(lVar6 + 0x4c), fVar14 < 0.0)) ||
         (fVar17 = *(float *)(lVar6 + 0x50), fVar17 < 0.0)) {
      ...
      *(ulong *)(lVar6 + 0x4c) = CONCAT44(fVar12 - fVar14,fVar10 - fVar15);
      ...
      if (((fVar10 < 0.0) || (fVar14 = *(float *)(lVar5 + 0x4c), fVar14 < 0.0)) ||
         (fVar17 = *(float *)(lVar5 + 0x50), fVar17 < 0.0)) {
        _err_print_error("expand_to","./core/math/aabb.h",0x158,
                         "AABB size is negative, this is not supported. Use AABB.abs() to get an AABB with a positive size."
                         ,0,0);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashMap<Ref<Material>, int, HashMapHasherDefault, HashMapComparatorDefault<Ref<Material> >,
   DefaultTypedAllocator<HashMapElement<Ref<Material>, int> > >::operator[](Ref<Material> const&) */

undefined1  [16] __thiscall
HashMap<Ref<Material>,int,HashMapHasherDefault,HashMapComparatorDefault<Ref<Material>>,DefaultTypedAllocator<HashMapElement<Ref<Material>,int>>>
::operator[](HashMap<Ref<Material>,int,HashMapHasherDefault,HashMapComparatorDefault<Ref<Material>>,DefaultTypedAllocator<HashMapElement<Ref<Material>,int>>>
             *this,Ref *param_1)
...
LAB_00101aa3:
  if ((float)uVar56 * __LC15 < (float)(iVar44 + 1)) {
...
/* CowData<CSGBrush::Face>::_realloc(long) */

undefined8 __thiscall CowData<CSGBrush::Face>::_realloc(CowData<CSGBrush::Face> *this,long param_1)

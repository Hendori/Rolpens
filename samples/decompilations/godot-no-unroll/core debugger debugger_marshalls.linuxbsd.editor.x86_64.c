...
void DebuggerMarshalls::ScriptStackDump::serialize(void)
...
/* DebuggerMarshalls::ScriptStackDump::deserialize(Array const&) */

undefined8 __thiscall
DebuggerMarshalls::ScriptStackDump::deserialize(ScriptStackDump *this,Array *param_1)
...
/* DebuggerMarshalls::ScriptStackVariable::serialize(int) */

Array * DebuggerMarshalls::ScriptStackVariable::serialize(int param_1)

{
  ...
  if ((*(int *)(in_RSI + 8) == 0x18) && (lVar3 = Variant::get_validated_object(), lVar3 == 0)) {
  ...
  if (iVar2 != 0) {
    _err_print_error("serialize","core/debugger/debugger_marshalls.cpp",0x50,
                     "Failed to encode variant.",0,0);
  }
  if (in_EDX < local_7c) {
    local_58 = 0;
    local_50 = (undefined1  [16])0x0;
...
/* DebuggerMarshalls::ScriptStackVariable::deserialize(Array const&) */

undefined8 __thiscall
DebuggerMarshalls::ScriptStackVariable::deserialize(ScriptStackVariable *this,Array *param_1)
...
void DebuggerMarshalls::OutputError::serialize(void)

{
  ...
  Variant::Variant((Variant *)local_58,in_RSI[1]);
  Array::push_back((Variant *)in_RDI);
  if (Variant::needs_deinit[local_58[0]] != '\0') {
    Variant::_clear_internal();
  }
  Variant::Variant((Variant *)local_58,in_RSI[2]);
  Array::push_back((Variant *)in_RDI);
  if (Variant::needs_deinit[local_58[0]] != '\0') {
    Variant::_clear_internal();
  }
  Variant::Variant((Variant *)local_58,in_RSI[3]);
  Array::push_back((Variant *)in_RDI);
  if (Variant::needs_deinit[local_58[0]] != '\0') {
    Variant::_clear_internal();
  }
...
/* DebuggerMarshalls::serialize_key_shortcut(Ref<Shortcut> const&) */

DebuggerMarshalls * __thiscall
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (*(long *)param_1 == 0) {
    _err_print_error("serialize_key_shortcut","core/debugger/debugger_marshalls.cpp",0x98,
                     "Condition \"p_shortcut.is_null()\" is true. Returning: Array()",0,0);
    ...
    if (local_68 != local_78) {
      do {
        ...
        if (((lVar3 == 0) ||
            (pOVar4 = (Object *)__dynamic_cast(lVar3,&Object::typeinfo,&InputEvent::typeinfo,0),
            pOVar4 == (Object *)0x0)) || (cVar1 = RefCounted::reference(), cVar1 == '\0')) {
          _err_print_error("serialize_key_shortcut","core/debugger/debugger_marshalls.cpp",0x9c,
                           "Condition \"kev.is_null()\" is true. Continuing.",0,0);
        }
        else {
...
/* DebuggerMarshalls::deserialize_key_shortcut(Array const&) */
...

{
  ...
  if (uVar4 == 0) {
    while( true ) {
      ...
      if (*piVar6 == 1) {
        ...
        if (*piVar6 == 2) {
          ...
          _err_print_error("deserialize_key_shortcut","core/debugger/debugger_marshalls.cpp",0xad,
                           "Condition \"p_keys[i + 1].get_type() != Variant::INT\" is true. Continuing."
                           ,0,0);
        }
      }
      else {
        _err_print_error("deserialize_key_shortcut","core/debugger/debugger_marshalls.cpp",0xac,
                         "Condition \"p_keys[i].get_type() != Variant::BOOL\" is true. Continuing.",
                         0,0);
      }
      uVar4 = uVar4 + 2;
    }
    ...
    if (cVar3 == '\0') {
      ...
      *(undefined ***)this_00 = &PTR__initialize_classv_00104f00;
    ...
    _err_print_error("deserialize_key_shortcut","core/debugger/debugger_marshalls.cpp",0xaa,
                     "Condition \"p_keys.size() % 2 != 0\" is true. Returning: Ref<Shortcut>()",0,0)
    ;
    *(undefined8 *)this = 0;
  }
  Array::~Array(local_68);
...
/* DebuggerMarshalls::OutputError::deserialize(Array const&) */

undefined8 __thiscall DebuggerMarshalls::OutputError::deserialize(OutputError *this,Array *param_1)

{
  ...
  if (uVar5 < 0xb) {
    ...
    String::operator+((String *)&local_68,(String *)&local_78);
    String::operator+((String *)&local_58,(String *)&local_68);
    pcVar15 = "Condition \"(uint32_t)p_arr.size() < (uint32_t)(11)\" is true. Returning: false";
    uVar11 = 0x7d;
  }
  else {
    iVar18 = (int)param_1;
    pVVar8 = (Variant *)Array::operator[](iVar18);
    ...
    *(int *)(this + 0x20) = iVar6;
    ...
    pVVar8 = (Variant *)Array::operator[](iVar18);
    OVar4 = (OutputError)Variant::operator_cast_to_bool(pVVar8);
    this[0x38] = OVar4;
    pVVar8 = (Variant *)Array::operator[](iVar18);
    uVar5 = Variant::operator_cast_to_unsigned_int(pVVar8);
    uVar7 = Array::size();
    if (uVar7 < uVar5) {
      ...
      String::operator+((String *)&local_58,(String *)&local_68);
      pcVar15 = 
      "Condition \"(uint32_t)p_arr.size() < (uint32_t)(stack_size)\" is true. Returning: false";
      uVar11 = 0x89;
    }
    else {
      this_00 = (CowData<ScriptLanguage::StackInfo> *)(this + 0x48);
      uVar21 = (ulong)uVar5 / 3;
      uVar20 = uVar21;
      if (*(long *)(this + 0x48) == 0) {
        if (uVar5 < 3) goto LAB_00102630;
        CowData<ScriptLanguage::StackInfo>::_copy_on_write(this_00);
        uVar14 = 0;
LAB_00102730:
        uVar19 = uVar21 * 0x18 - 1;
        uVar19 = uVar19 >> 1 | uVar19;
        uVar19 = uVar19 >> 2 | uVar19;
        uVar19 = uVar19 >> 4 | uVar19;
        uVar19 = uVar19 >> 8 | uVar19;
        uVar19 = uVar19 >> 0x10 | uVar19;
        local_b8 = (uVar19 | uVar19 >> 0x20) + 1;
        if ((long)uVar14 < (long)uVar21) {
LAB_00102798:
          if (uVar14 == 0) {
            puVar12 = (undefined8 *)Memory::alloc_static(local_b8 + 0x10,false);
...
LAB_001022fc:
              if (lVar13 < (long)uVar21) {
                pauVar10 = (undefined1 (*) [16])(puVar17 + lVar13 * 3);
                do {
                  *pauVar10 = (undefined1  [16])0x0;
                  pauVar10 = (undefined1 (*) [16])(pauVar10[1] + 8);
                } while (pauVar10 != (undefined1 (*) [16])(puVar17 + uVar21 * 3));
              }
              puVar17[-1] = uVar21;
            }
          }
          else {
            iVar6 = CowData<ScriptLanguage::StackInfo>::_realloc(this_00,local_b8);
            if (iVar6 == 0) {
LAB_001022eb:
...
LAB_001026c3:
          while( true ) {
            ...
            if (*(ulong *)(lVar13 + -8) <= uVar20) break;
            plVar16 = (long *)(lVar13 + uVar20 * 0x18);
            if (plVar16[1] != 0) {
              LOCK();
              plVar1 = (long *)(plVar16[1] + -0x10);
              *plVar1 = *plVar1 + -1;
              UNLOCK();
              if (*plVar1 == 0) {
                lVar13 = plVar16[1];
          ...
          *(ulong *)(lVar13 + -8) = uVar21;
        }
LAB_00102330:
        uVar7 = 0;
        CowData<ScriptLanguage::StackInfo>::_copy_on_write(this_00);
        plVar16 = *(long **)(this + 0x48);
        if (uVar5 < 3) goto LAB_00102635;
        do {
          Array::operator[](iVar18);
          Variant::operator_cast_to_String((Variant *)&local_58);
          pcVar3 = local_58;
          ...
          if (pcVar15 == local_58) {
            ...
            *plVar16 = (long)local_58;
          }
          Array::operator[](iVar18);
          Variant::operator_cast_to_String((Variant *)&local_58);
          pcVar3 = local_58;
          pcVar15 = (char *)plVar16[1];
          if (pcVar15 == local_58) {
            if (pcVar15 != (char *)0x0) {
              LOCK();
              plVar1 = (long *)(pcVar15 + -0x10);
        ...
        uVar5 = (int)uVar21 * 3 + 0xb;
      }
      else {
        uVar14 = *(ulong *)(*(long *)(this + 0x48) + -8);
        if (uVar21 == uVar14) goto LAB_00102330;
        if (2 < uVar5) {
          CowData<ScriptLanguage::StackInfo>::_copy_on_write(this_00);
          uVar19 = uVar21 * 0x18 - 1;
          uVar19 = uVar19 >> 1 | uVar19;
          ...
          local_b8 = uVar19 + 1;
          if (uVar14 * 0x18 == 0) goto LAB_00102730;
          uVar9 = uVar14 * 0x18 - 1;
          uVar9 = uVar9 | uVar9 >> 1;
          uVar9 = uVar9 | uVar9 >> 2;
          uVar9 = uVar9 | uVar9 >> 4;
          ...
          if ((long)uVar14 < (long)uVar21) {
            if (uVar9 != uVar19) goto LAB_00102798;
            goto LAB_001022eb;
          }
          local_b0 = uVar9 + 1;
          goto LAB_001026c3;
...
LAB_00102635:
      ...
      uVar7 = Array::size();
      uVar11 = 1;
      if (uVar7 <= uVar5) goto LAB_001025f7;
      Array::size();
      itos((long)&local_60);
      local_58 = ", actual size: ";
      local_70 = 0;
      ...
      String::operator+((String *)&local_68,(String *)&local_78);
      String::operator+((String *)&local_58,(String *)&local_68);
      pcVar15 = "Condition \"(uint32_t)p_arr.size() > (uint32_t)idx\" is true. Returning: false";
      uVar11 = 0x93;
    }
  }
  _err_print_error("deserialize","core/debugger/debugger_marshalls.cpp",uVar11,pcVar15,&local_58,0,0
                  );
  pcVar15 = local_58;
  if (local_58 != (char *)0x0) {
    LOCK();
    plVar16 = (long *)(local_58 + -0x10);
    *plVar16 = *plVar16 + -1;
    UNLOCK();
    if (*plVar16 == 0) {
      local_58 = (char *)0x0;
...
{
  return (uint)CONCAT71(0x1050,(undefined4 *)param_1 == &Resource::get_class_ptr_static()::ptr) |
...
{
  *(undefined ***)this = &PTR__initialize_classv_00104f00;
...
LAB_001040f8:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_001040f8;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x00104115;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
LAB_00104548:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_00104548;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x00104565;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
/* CowData<ScriptLanguage::StackInfo>::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<ScriptLanguage::StackInfo>::_copy_on_write(void)
...
/* DebuggerMarshalls::OutputError::deserialize(Array const&) [clone .cold] */

void DebuggerMarshalls::OutputError::deserialize(Array *param_1)

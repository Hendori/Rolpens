...
LAB_00101213:
        ...
        if (lVar11 <= lVar5) goto LAB_00101213;
  ...
  if (cVar1 == '\0') {
    ...
    *this = (JoypadLinux)(iVar2 == 0);
    if (iVar2 == 0) {
      ...
      goto joined_r0x00101192;
    }
    cVar1 = is_print_verbose_enabled();
    if (cVar1 == '\0') goto LAB_00100f82;
    pcVar9 = 
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (*(int *)(param_1 + 0xe00) == -1) goto LAB_001012c3;
...

{
  ...
  if ((iVar12 == -1) || (iVar11 == -1)) goto LAB_00101924;
  local_208 = 0;
  puVar22 = local_1b8;
...
LAB_00101a34:
  ...
  if ((((iVar13 < 0) || (iVar13 = ioctl(iVar12,0x80604521,local_1b8), iVar13 < 0)) ||
    ...
    String::to_lower();
    String::split((char *)&local_218,SUB81((StrRange *)&local_220,0),0x102d81);
    lVar17 = local_220;
    if (local_220 != 0) {
      LOCK();
      plVar1 = (long *)(local_220 + -0x10);
...
LAB_00102125:
                  ...
                  if (lVar18 == lVar23) goto LAB_00102125;
                  if (lVar23 <= lVar18) goto LAB_0010213c;
...

{
  ...
  for (lVar5 = (*_udev_enumerate_get_list_entry_dylibloader_wrapper_libudev)(uVar4); lVar5 != 0;
    ...
    if (__s != (char *)0x0) {
      ...
      local_58 = __s;
      String::parse_latin1((StrRange *)&local_60);
      iVar3 = String::find((char *)&local_60,0x102e0c);
      if (iVar3 == -1) {
  ...
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00102678. Too many branches */
...

{
  ...
  do {
    if (JVar1 != (JoypadLinux)0x0) {
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x001028fe. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    ...
    if ((((0 < iVar5) &&
      ...
      if (pcVar8 != (char *)0x0) {
        ...
        iVar5 = String::find((char *)&local_f0,0x102e0c);
        if (iVar5 == -1) {
...
LAB_00102a78:
      ...
      if (pdVar4 != (dirent64 *)0x0) {
        while( true ) {
          ...
          pdVar4 = readdir64(__dirp);
          if (pdVar4 == (dirent64 *)0x0) goto LAB_00102b58;
        }
        goto LAB_00102a78;
      }
    }
  ...
  if (*this != (JoypadLinux)0x0) {
    ...
    if (puVar1 != (udev *)0x0) {
      ...
      monitor_joypads(this,puVar1);
                    /* WARNING: Could not recover jumptable at 0x00102bef. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
LAB_00103429:
      ...
      while( true ) {
        ...
        if (*plVar2 != 0) break;
        uVar8 = uVar8 + 1;
        if (*(ulong *)(lVar6 + -8) <= uVar8) goto LAB_00103429;
      }
      LOCK();
...
LAB_001035a6:
    ...
    lVar6 = puVar9[-1];
    if (param_1 <= lVar6) goto LAB_001034ba;
  }
  else {
    if (lVar6 != 0) {
      uVar4 = _realloc(this,lVar10);

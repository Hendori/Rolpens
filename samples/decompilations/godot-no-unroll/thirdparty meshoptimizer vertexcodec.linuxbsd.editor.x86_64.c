...
byte * meshopt::decodeVertexBlock
                 (uchar *param_1,uchar *param_2,uchar *param_3,ulong param_4,ulong param_5,
                 uchar *param_6)

{
  ...
  if (param_5 == 0) {
LAB_0010021c:
    memcpy(param_3,local_2048,param_4 * param_5);
    ...
    if (uVar13 <= (ulong)((long)param_2 - (long)param_1)) {
      ...
      if (uVar12 == 0) {
        ...
        uVar10 = 0;
LAB_001000a0:
        if (0x17 < (ulong)((long)param_2 - (long)pbVar15)) {
          pbVar2 = local_2148;
          uVar8 = 0;
          while( true ) {
...
/* meshopt::decodeBytesGroupSimd(unsigned char const*, unsigned char*, int) */

uchar * meshopt::decodeBytesGroupSimd(uchar *param_1,uchar *param_2,int param_3)

{
  ...
  if (param_3 == 2) {
    ...
    auVar26._8_8_ =
         (undefined8)
         (CONCAT73(auVar27._9_7_,CONCAT12((char)((ushort)(uVar3 >> 0x20) >> 4),uVar34)) >> 0x10);
    auVar26[7] = bVar6;
    auVar26[6] = bVar6 >> 4;
    ...
    bVar6 = SUB161(auVar11 >> 7,0) & 1 | (SUB161(auVar11 >> 0xf,0) & 1) << 1 |
    ...
    uVar1 = (&kDecodeBytesGroupShuffle)
            [(byte)(SUB161(auVar11 >> 0x47,0) & 1 |
                    (byte)((ushort)((ushort)(SUB161(auVar11 >> 0x4f,0) & 1) << 9) >> 8) |
                    (byte)((ushort)((ushort)(SUB161(auVar11 >> 0x57,0) & 1) << 10) >> 8) |
                    (byte)((ushort)((ushort)(SUB161(auVar11 >> 0x5f,0) & 1) << 0xb) >> 8) |
                    (byte)((ushort)((ushort)(SUB161(auVar11 >> 0x67,0) & 1) << 0xc) >> 8) |
                    (byte)((ushort)((ushort)(SUB161(auVar11 >> 0x6f,0) & 1) << 0xd) >> 8) |
                    (byte)((ushort)((ushort)(SUB161(auVar11 >> 0x77,0) & 1) << 0xe) >> 8) |
                   (byte)((ushort)((ushort)(auVar11[0xf] >> 7) << 0xf) >> 8))];
    ...
    auVar36[10] = auVar9[2] + (char)((ulong)uVar1 >> 0x10);
    auVar36[0xb] = auVar9[3] + (char)((ulong)uVar1 >> 0x18);
    auVar36[0xc] = auVar9[4] + (char)((ulong)uVar1 >> 0x20);
    auVar36[0xd] = auVar9[5] + (char)((ulong)uVar1 >> 0x28);
    auVar36[0xe] = auVar9[6] + (char)((ulong)uVar1 >> 0x30);
    auVar36[0xf] = auVar9[7] + (char)((ulong)uVar1 >> 0x38);
  ...
  if (param_3 != 3) {
    ...
    if (param_3 == 1) {
      ...
      auVar19[9] = uVar17;
      auVar18._8_8_ =
           (undefined8)(CONCAT73(auVar19._9_7_,CONCAT12((char)((ushort)uVar5 >> 2),uVar34)) >> 0x10)
      ;
      auVar18[7] = bVar12;
      auVar18[6] = bVar12 >> 2;
      auVar18[5] = bVar12 >> 4;
      auVar18[4] = (char)((ushort)(CONCAT53(CONCAT41(uVar5,bVar12),CONCAT12(bVar12 >> 4,uVar16)) >>
                                  0x10) >> 2);
      auVar18[3] = bVar6;
      auVar18[2] = bVar6 >> 2;
      ...
      bVar6 = SUB161(auVar10 >> 7,0) & 1 | (SUB161(auVar10 >> 0xf,0) & 1) << 1 |
      ...
      uVar1 = (&kDecodeBytesGroupShuffle)
              [(byte)(SUB161(auVar10 >> 0x47,0) & 1 |
                      (byte)((ushort)((ushort)(SUB161(auVar10 >> 0x4f,0) & 1) << 9) >> 8) |
                      (byte)((ushort)((ushort)(SUB161(auVar10 >> 0x57,0) & 1) << 10) >> 8) |
                      (byte)((ushort)((ushort)(SUB161(auVar10 >> 0x5f,0) & 1) << 0xb) >> 8) |
                      (byte)((ushort)((ushort)(SUB161(auVar10 >> 0x67,0) & 1) << 0xc) >> 8) |
                      (byte)((ushort)((ushort)(SUB161(auVar10 >> 0x6f,0) & 1) << 0xd) >> 8) |
                      (byte)((ushort)((ushort)(SUB161(auVar10 >> 0x77,0) & 1) << 0xe) >> 8) |
                     (byte)((ushort)((ushort)(auVar10[0xf] >> 7) << 0xf) >> 8))];
      auVar9 = pshufb(ZEXT116((byte)(&kDecodeBytesGroupCount)[bVar6]),(undefined1  [16])0x0);
      auVar35[9] = auVar9[1] + (char)((ulong)uVar1 >> 8);
      auVar35[8] = auVar9[0] + (char)uVar1;
      auVar35[10] = auVar9[2] + (char)((ulong)uVar1 >> 0x10);
      auVar35[0xb] = auVar9[3] + (char)((ulong)uVar1 >> 0x18);
      auVar35[0xc] = auVar9[4] + (char)((ulong)uVar1 >> 0x20);
      auVar35[0xd] = auVar9[5] + (char)((ulong)uVar1 >> 0x28);
      auVar35[0xe] = auVar9[6] + (char)((ulong)uVar1 >> 0x30);
      auVar35[0xf] = auVar9[7] + (char)((ulong)uVar1 >> 0x38);
      auVar35._0_8_ = (&kDecodeBytesGroupShuffle)[bVar6];
      auVar9 = pshufb(*(undefined1 (*) [16])(param_1 + 4),auVar35);
      auVar9 = ~auVar10 & auVar25 | auVar9;
      param_1 = param_1 + ((((ulong)uVar7 << 0x1e | (ulong)(uVar7 & 0x3fffffff)) &
                           0x1111111111111111) * 0x1111111111111111 >> 0x3c) + 4;
    }
...
/* meshopt::decodeVertexBlockSimd(unsigned char const*, unsigned char const*, unsigned char*,
   unsigned long, unsigned long, unsigned char*) */

uchar * meshopt::decodeVertexBlockSimd
                  (uchar *param_1,uchar *param_2,uchar *param_3,ulong param_4,ulong param_5,
                  uchar *param_6)
...
LAB_00100a5e:
  ...
  auVar29 = __LC6;
LAB_001008fb:
  if (uVar1 <= (ulong)((long)param_2 - (long)param_1)) {
    lVar5 = 4;
    puVar10 = local_2448;
    do {
...
LAB_001009e9:
        ...
        if (0x5f < uVar3) {
          ...
          do {
            ...
            puVar2 = (uchar *)decodeBytesGroupSimd
                                        (puVar2,puVar10 + 0x10,(uint)((uVar3 & 0xffffffff) >> 2) & 3
                                        );
            uVar6 = (uint)(uVar3 >> 6) & 3;
            puVar2 = (uchar *)decodeBytesGroupSimd
                                        (puVar2,puVar10 + 0x20,(uint)((uVar3 & 0xffffffff) >> 4) & 3
                                        );
            uVar3 = uVar11 + 0x40;
...
joined_r0x001009f8:
        while( true ) {
          ...
          uVar7 = uVar11 + 0x10;
          puVar2 = (uchar *)decodeBytesGroupSimd
                                      (puVar2,puVar9 + uVar11,
                                       (int)(uint)param_1[uVar11 >> 6] >> ((byte)(uVar11 >> 3) & 6)
                                       & 3);
...
LAB_00100a90:
  ...
  if (uVar12 != 0) {
    ...
    do {
      ...
      auVar21[8] = -auVar39[8];
      auVar21[9] = -auVar39[9];
      auVar21[10] = -auVar39[10];
      auVar21[0xb] = -auVar39[0xb];
      auVar21[0xc] = -auVar39[0xc];
      auVar21[0xd] = -auVar39[0xd];
      ...
      auVar14[8] = -auVar18[8];
      auVar14[9] = -auVar18[9];
      auVar14[10] = -auVar18[10];
      auVar14[0xb] = -auVar18[0xb];
      auVar14[0xc] = -auVar18[0xc];
      auVar14[0xd] = -auVar18[0xd];
      ...
      auVar20[8] = -auVar35[8];
      auVar20[9] = -auVar35[9];
      auVar20[10] = -auVar35[10];
      auVar20[0xb] = -auVar35[0xb];
      auVar20[0xc] = -auVar35[0xc];
      auVar20[0xd] = -auVar35[0xd];
      ...
      auVar23[8] = -auVar39[8];
      auVar23[9] = -auVar39[9];
      auVar23[10] = -auVar39[10];
      auVar23[0xb] = -auVar39[0xb];
      auVar23[0xc] = -auVar39[0xc];
      auVar23[0xd] = -auVar39[0xd];
      ...
      *(uint *)((long)puVar4 + param_5 * 2) =
           CONCAT13(cVar33,CONCAT12(cVar32,CONCAT11(cVar31,cVar30)));
      *(uint *)((long)puVar4 + param_5 * 3) =
           CONCAT13(cVar26,CONCAT12(cVar24,CONCAT11(cVar37,cVar34)));
      ...
      *(uint *)((long)puVar4 + param_5 * 5) =
           CONCAT13(cVar33,CONCAT12(cVar32,CONCAT11(cVar31,cVar30)));
      cVar30 = auVar14[7] + cVar36;
      cVar31 = auVar21[7] + cVar38;
      cVar32 = auVar23[7] + cVar25;
      cVar33 = auVar20[7] + cVar27;
      *(uint *)((long)puVar4 + param_5 * 6) =
           CONCAT13(cVar27,CONCAT12(cVar25,CONCAT11(cVar38,cVar36)));
      *(uint *)((long)puVar4 + param_5 * 7) =
           CONCAT13(cVar33,CONCAT12(cVar32,CONCAT11(cVar31,cVar30)));
      ...
      *(uint *)((long)puVar4 + param_5 * 10) =
           CONCAT13(cVar38,CONCAT12(cVar37,CONCAT11(cVar36,cVar34)));
      *(uint *)((long)puVar4 + param_5 * 0xb) =
           CONCAT13(cVar33,CONCAT12(cVar32,CONCAT11(cVar31,cVar30)));
...
byte * meshopt_encodeVertexBuffer
                 (byte *param_1,byte *param_2,long param_3,ulong param_4,byte *param_5)
    ...
    if (pbVar33 <= param_1 + ((long)param_2 - (long)pbVar37)) {
      if (param_5 < (byte *)0x20) {
        ...
        if (uVar42 < 8) {
          ...
          pbVar33[6] = 0;
          pbVar33[7] = 0;
          uVar42 = ((int)pbVar37 - (int)((ulong)(pbVar37 + 8) & 0xfffffffffffffff8)) + uVar42 &
                   0xfffffff8;
          if (7 < uVar42) {
            uVar40 = 0;
            do {
...
LAB_00101080:
  ...
  do {
    ...
    bVar51 = bVar1;
  } while ((undefined1 (*) [16])(puVar29 + 1) !=
           (undefined1 (*) [16])(*(undefined1 (*) [16])local_148 + uVar31));
      ...
      do {
        ...
        do {
          ...
          if (iVar39 == 1) {
            ...
            auVar57[0] = -(auVar56[0] == '\0');
            auVar57[1] = -(auVar56[1] == '\0');
            auVar57[2] = -(auVar56[2] == '\0');
            auVar57[3] = -(auVar56[3] == '\0');
            auVar57[4] = -(auVar56[4] == '\0');
            auVar57[5] = -(auVar56[5] == '\0');
            auVar57[6] = -(auVar56[6] == '\0');
            auVar57[7] = -(auVar56[7] == '\0');
            auVar57[8] = -(auVar56[8] == '\0');
            auVar57[9] = -(auVar56[9] == '\0');
            auVar57[10] = -(auVar56[10] == '\0');
            auVar57[0xb] = -(auVar56[0xb] == '\0');
            auVar57[0xc] = -(auVar56[0xc] == '\0');
            auVar57[0xd] = -(auVar56[0xd] == '\0');
            auVar57[0xe] = -(auVar56[0xe] == '\0');
            auVar57[0xf] = -(auVar56[0xf] == '\0');
            ...
            uVar34 = ((ulong)CONCAT14(auVar57[0xd],(uint)auVar57[0xc]) & 0xffffffff) +
                     (ulong)auVar57[0xe] +
                     ((ulong)CONCAT24(auVar7._10_2_,(uint)auVar16._8_2_) & 0xffffffff) +
                     ((ulong)(uVar17 >> 0x20) & 0xffff) +
                     (auVar15._0_8_ & 0xffffffff) + ((ulong)uVar28 & 0xffffffff) +
                     (auVar14._0_8_ & 0xffffffff) + ((ulong)uVar10 & 0xffffffff) +
                     (ulong)auVar57[0xd] + (ulong)auVar57[0xf] +
                     (ulong)auVar7._10_2_ + (ulong)(uVar17 >> 0x30) +
                     (ulong)auVar12._4_4_ + (ulong)(auVar4._10_4_ >> 0x10) +
                     (ulong)auVar11._4_4_ + (ulong)(uVar10 >> 0x20) +
                     ((ulong)((long)iVar39 << 4) >> 3);
          }
          if (uVar34 < uVar47) {
            uVar47 = uVar34;
            iVar50 = iVar39;
...
LAB_00101225:
        ...
        if (iVar50 - 1U < 4) {
          __s[local_3d8 >> 6] =
               __s[local_3d8 >> 6] |
               (byte)((&CSWTCH_224)[iVar50 - 1U] << ((byte)(local_3d8 >> 3) & 6));
          if (iVar50 != 1) {
LAB_0010126c:
            uVar42 = (1 << ((byte)iVar50 & 0x1f)) - 1;
  ...
  goto LAB_00101327;
LAB_001013c2:
  if (pbVar37 == (byte *)0x0) goto LAB_00101327;
  pbVar52 = pbVar52 + 1;
...
void meshopt_encodeVertexVersion(undefined4 param_1)

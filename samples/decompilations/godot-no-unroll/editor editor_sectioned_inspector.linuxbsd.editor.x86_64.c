...
/* SectionedInspector::get_current_section() const */

SectionedInspector * __thiscall SectionedInspector::get_current_section(SectionedInspector *this)
...
/* SectionedInspector::register_search_box(LineEdit*) */

void __thiscall SectionedInspector::register_search_box(SectionedInspector *this,LineEdit *param_1)
...
undefined8 __thiscall SectionedInspector::get_inspector(SectionedInspector *this)
...
void __thiscall SectionedInspector::SectionedInspector(SectionedInspector *this)
...
LAB_001006ef:
  *(undefined ***)this = &PTR__initialize_classv_0010a310;
...
/* SectionedInspector::get_full_item_path(String const&) */

String * SectionedInspector::get_full_item_path(String *param_1)
...
void __thiscall SectionedInspector::_section_selected(SectionedInspector *this)
...
/* SectionedInspector::_bind_methods() */

void SectionedInspector::_bind_methods(void)
...
/* SectionedInspector::set_current_section(String const&) */

void __thiscall SectionedInspector::set_current_section(SectionedInspector *this,String *param_1)

{
  ...
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  local_24 = 0;
  cVar2 = HashMap<String,TreeItem*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,TreeItem*>>>
...
void __thiscall SectionedInspector::update_category_list(SectionedInspector *this)
  ...
  if (uVar15 < (uint)ObjectDB::slot_max) {
    ...
    if ((*(ulong *)(this + 0xa70) >> 0x18 & 0x7fffffffff) == (*puVar16 & 0x7fffffffff)) {
      ...
      if (pLVar1 != (List *)0x0) {
        ...
        this_01 = (HashMap<String,TreeItem*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,TreeItem*>>>
                   *)(this + 0xa88);
        ...
        puVar11 = (undefined8 *)
                  HashMap<String,TreeItem*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,TreeItem*>>>
                  ::operator[](this_01,(String *)&local_68);
        *puVar11 = uVar10;
        ...
        if (local_98 != (long *)0x0) {
          for (lVar14 = *local_98; lVar14 != 0; lVar14 = *(long *)(lVar14 + 0x30)) {
            ...
            if ((((uVar15 & 0x80) == 0) && ((uVar15 & 4) != 0)) &&
               (((local_90 != 0 && (1 < *(uint *)(local_90 - 8))) ||
                ((this[0xad8] == (SectionedInspector)0x0 || ((uVar15 & 0x8000000) != 0)))))) {
              this_00 = (String *)(lVar14 + 8);
              iVar8 = String::find_char((wchar32)this_00,0x3a);
              if ((iVar8 == -1) &&
                 ((((cVar5 = String::operator==(this_00,"script"), cVar5 == '\0' &&
                    (cVar5 = String::operator==(this_00,"resource_name"), cVar5 == '\0')) &&
                   (cVar5 = String::operator==(this_00,"resource_path"), cVar5 == '\0')) &&
                  ((cVar5 = String::operator==(this_00,"resource_local_to_scene"), cVar5 == '\0' &&
                   (cVar5 = String::begins_with((char *)this_00), cVar5 == '\0')))))) {
                if ((local_90 == 0) || (*(uint *)(local_90 - 8) < 2)) {
LAB_00101075:
                  iVar8 = String::find_char((wchar32)this_00,0x2f);
                  if (iVar8 == -1) {
                    operator+((char *)&local_68,(String *)"global/");
...
LAB_001011b3:
                      ...
                      uVar10 = *puVar11;
                      if ((update_category_list()::{lambda()#1}::operator()()::sname == '\0') &&
                         (iVar9 = __cxa_guard_acquire(&update_category_list()::{lambda()#1}::
                                                       operator()()::sname), iVar9 != 0)) {
                        _scs_create((char *)&update_category_list()::{lambda()#1}::operator()()::
                                             sname,true);
                        __cxa_atexit(StringName::~StringName,
                                     &update_category_list()::{lambda()#1}::operator()()::sname,
                                     &__dso_handle);
                      ...
                      if (((local_70 != (Object *)0x0) &&
                          (cVar5 = RefCounted::unreference(), pOVar4 = local_70, cVar5 != '\0')) &&
...
LAB_001016e7:
                        _err_print_index_error
                                  ("get","./core/templates/cowdata.h",0xdb,uVar17,lVar12,"p_index",
                                   "size()","",false,true);
                        _err_flush_stdout();
                    /* WARNING: Does not return */
                      ...
                      if (local_60 != (CowData *)0x0) {
                        ...
                        operator+((char *)&local_70,(String *)&_LC24);
                        String::operator+=((String *)&local_88,(String *)&local_70);
                        CowData<char32_t>::_unref((CowData<char32_t> *)&local_70);
LAB_0010116f:
                        local_70 = (Object *)((ulong)local_70 & 0xffffffff00000000);
                        cVar5 = HashMap<String,TreeItem*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,TreeItem*>>>
                                ::_lookup_pos(this_01,(String *)&local_88,(uint *)&local_70);
                        if (cVar5 != '\0') {
LAB_00101191:
                          if (iVar8 + -1 == (int)uVar17) {
                            puVar11 = (undefined8 *)
                                      HashMap<String,TreeItem*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,TreeItem*>>>
                                      ::operator[](this_01,(String *)&local_88);
                        ...
                        *puVar11 = uVar13;
                        ...
                        EditorPropertyNameProcessor::process_name
                                  ((CowData *)&local_80,uVar10,local_60 + uVar17 * 8,uVar6,this_00,
                        ...
                        if (local_60 != (CowData *)0x0) {
                          ...
                          if ((long)uVar17 < lVar12) {
                            EditorPropertyNameProcessor::process_name
                                      ((CowData<char32_t> *)&local_78,uVar10,local_60 + uVar17 * 8,
                                       uVar7,this_00,(CowData<char32_t> *)&local_70);
                            if ((StringName::configured != '\0') && (local_70 != (Object *)0x0)) {
                              StringName::unref();
                            }
                            local_70 = (Object *)0x0;
                            if (local_80 != 0) {
                              CowData<char32_t>::_ref
                                        ((CowData<char32_t> *)&local_70,(CowData *)&local_80);
                            }
...
LAB_00101814:
                  ...
                  iVar8 = String::findn(this_00,(int)(String *)&local_90);
                  if (iVar8 != -1) goto LAB_00101075;
                  String::split((char *)&local_68,SUB81(this_00,0),0x103a09);
                  uVar10 = EditorPropertyNameProcessor::singleton;
                  for (uVar17 = 0;
                      (EditorPropertyNameProcessor::singleton = uVar10, local_60 != (CowData *)0x0
                      && ((long)uVar17 < *(long *)(local_60 + -8))); uVar17 = uVar17 + 1) {
                    ...
                    if (lVar12 <= (long)uVar17) goto LAB_001016e7;
                    EditorPropertyNameProcessor::process_name
                              ((CowData<char32_t> *)&local_70,uVar10,local_60 + uVar17 * 8,uVar6,
        ...
        cVar5 = HashMap<String,TreeItem*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,TreeItem*>>>
                ::_lookup_pos(this_01,(String *)(this + 0xad0),(uint *)&local_68);
        if (cVar5 != '\0') {
          puVar11 = (undefined8 *)
                    HashMap<String,TreeItem*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,TreeItem*>>>
                    ::operator[](this_01,(String *)(this + 0xad0));
...
/* SectionedInspector::edit(Object*) */

void __thiscall SectionedInspector::edit(SectionedInspector *this,Object *param_1)
...
/* SectionedInspector::_search_changed(String const&) */

void __thiscall SectionedInspector::_search_changed(SectionedInspector *this,String *param_1)
...
/* SectionedInspector::_advanced_toggled(bool) */

void __thiscall SectionedInspector::_advanced_toggled(SectionedInspector *this,bool param_1)
...
/* SectionedInspector::register_advanced_toggle(CheckButton*) */

void __thiscall
SectionedInspector::register_advanced_toggle(SectionedInspector *this,CheckButton *param_1)
...
/* SectionedInspectorFilter::is_class_ptr(void*) const */

uint __thiscall SectionedInspectorFilter::is_class_ptr(SectionedInspectorFilter *this,void *param_1)

{
  return (uint)CONCAT71(0x10b2,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x10b0,(undefined4 *)param_1 == &get_class_ptr_static()::ptr);
}



/* SectionedInspectorFilter::_validate_propertyv(PropertyInfo&) const */

void SectionedInspectorFilter::_validate_propertyv(PropertyInfo *param_1)
...
/* SectionedInspectorFilter::_notificationv(int, bool) */

void SectionedInspectorFilter::_notificationv(int param_1,bool param_2)
...
/* CallableCustomMethodPointer<SectionedInspector, void>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<SectionedInspector,void>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<SectionedInspector,void> *this)
...
/* CallableCustomMethodPointer<SectionedInspector, void, bool>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<SectionedInspector,void,bool>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<SectionedInspector,void,bool> *this)
...
void __thiscall
CallableCustomMethodPointer<SectionedInspector,void,String_const&>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<SectionedInspector,void,String_const&> *this)
...
/* CallableCustomMethodPointer<SectionedInspector, void>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<SectionedInspector,void>::get_argument_count
          (CallableCustomMethodPointer<SectionedInspector,void> *this,bool *param_1)
...
/* CallableCustomMethodPointer<SectionedInspector, void, bool>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<SectionedInspector,void,bool>::get_argument_count
          (CallableCustomMethodPointer<SectionedInspector,void,bool> *this,bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<SectionedInspector,void,String_const&>::get_argument_count
          (CallableCustomMethodPointer<SectionedInspector,void,String_const&> *this,bool *param_1)
...
/* SectionedInspector::_property_get_revertv(StringName const&, Variant&) const */

undefined8 SectionedInspector::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* SectionedInspector::_property_can_revertv(StringName const&) const */

undefined8 SectionedInspector::_property_can_revertv(StringName *param_1)
...
/* CallableCustomMethodPointer<SectionedInspector, void, String const&>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<SectionedInspector,void,String_const&>::get_object
          (CallableCustomMethodPointer<SectionedInspector,void,String_const&> *this)
...
/* CallableCustomMethodPointer<SectionedInspector, void, bool>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<SectionedInspector,void,bool>::get_object
          (CallableCustomMethodPointer<SectionedInspector,void,bool> *this)
...
/* CallableCustomMethodPointer<SectionedInspector, void>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<SectionedInspector,void>::get_object
          (CallableCustomMethodPointer<SectionedInspector,void> *this)
...
/* SectionedInspector::_validate_propertyv(PropertyInfo&) const */

void SectionedInspector::_validate_propertyv(PropertyInfo *param_1)
...

{
  ...
  if (in_RSI != &get_class_ptr_static()::ptr) {
    uVar1 = (uint)CONCAT71(0x10b2,in_RSI == &Container::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10b1,in_RSI == &BoxContainer::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10b2,in_RSI == &Control::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10b2,in_RSI == &CanvasItem::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10b2,in_RSI == &Node::get_class_ptr_static()::ptr) |
...

{
  ...
  if (in_RSI != &get_class_ptr_static()::ptr) {
    uVar1 = (uint)CONCAT71(0x10b2,in_RSI == &Container::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10b1,in_RSI == &SplitContainer::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10b2,in_RSI == &Control::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10b2,in_RSI == &CanvasItem::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10b2,in_RSI == &Node::get_class_ptr_static()::ptr) |
            CONCAT31((int3)((uint)in_EDX >> 8),in_RSI == &Object::get_class_ptr_static()::ptr);
...
/* SectionedInspector::is_class_ptr(void*) const */

ulong SectionedInspector::is_class_ptr(void *param_1)

{
  ...
  if (in_RSI == &HSplitContainer::get_class_ptr_static()::ptr ||
    ...
    return CONCAT71(0x10b1,in_RSI == &HSplitContainer::get_class_ptr_static()::ptr ||
                           in_RSI == &get_class_ptr_static()::ptr);
  }
  return (ulong)((uint)CONCAT71(0x10b2,in_RSI == &Container::get_class_ptr_static()::ptr) |
                 (uint)CONCAT71(0x10b1,in_RSI == &SplitContainer::get_class_ptr_static()::ptr) |
                 (uint)CONCAT71(0x10b2,in_RSI == &Control::get_class_ptr_static()::ptr) |
                 (uint)CONCAT71(0x10b2,in_RSI == &CanvasItem::get_class_ptr_static()::ptr) |
                 (uint)CONCAT71(0x10b2,in_RSI == &Node::get_class_ptr_static()::ptr) |
...
/* SectionedInspector::_setv(StringName const&, Variant const&) */

undefined8 SectionedInspector::_setv(StringName *param_1,Variant *param_2)
...
/* WARNING: Removing unreachable block (ram,0x00102958) */
...
/* WARNING: Removing unreachable block (ram,0x001029c8) */
...
/* WARNING: Removing unreachable block (ram,0x00102a38) */
/* SectionedInspector::_getv(StringName const&, Variant&) const */

undefined8 SectionedInspector::_getv(StringName *param_1,Variant *param_2)
...
/* SectionedInspectorFilter::_get_class_namev() const */

undefined8 * SectionedInspectorFilter::_get_class_namev(void)
...
LAB_00103273:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      goto LAB_00103273;
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"SectionedInspectorFilter");
      goto LAB_001032de;
    }
  }
  StringName::assign_static_unique_class_name
...
/* SectionedInspector::_get_class_namev() const */

undefined8 * SectionedInspector::_get_class_namev(void)
...
LAB_00103453:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      goto LAB_00103453;
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"SectionedInspector");
      goto LAB_001034be;
    }
  }
  StringName::assign_static_unique_class_name
...
/* SectionedInspector::_notificationv(int, bool) */

void __thiscall
SectionedInspector::_notificationv(SectionedInspector *this,int param_1,bool param_2)
...
/* SectionedInspectorFilter::~SectionedInspectorFilter() */

void __thiscall SectionedInspectorFilter::~SectionedInspectorFilter(SectionedInspectorFilter *this)
...
/* SectionedInspectorFilter::_initialize_classv() */

void SectionedInspectorFilter::_initialize_classv(void)
...
/* SectionedInspectorFilter::get_class() const */

void SectionedInspectorFilter::get_class(void)
...
/* SectionedInspector::get_class() const */

void SectionedInspector::get_class(void)
...
/* SectionedInspectorFilter::is_class(String const&) const */

undefined8 __thiscall
SectionedInspectorFilter::is_class(SectionedInspectorFilter *this,String *param_1)
...
void __thiscall
CallableCustomMethodPointer<SectionedInspector,void>::call
          (CallableCustomMethodPointer<SectionedInspector,void> *this,Variant **param_1,int param_2,
...
void __thiscall
CallableCustomMethodPointer<SectionedInspector,void,bool>::call
          (CallableCustomMethodPointer<SectionedInspector,void,bool> *this,Variant **param_1,
...
void __thiscall
CallableCustomMethodPointer<SectionedInspector,void,String_const&>::call
          (CallableCustomMethodPointer<SectionedInspector,void,String_const&> *this,
...
/* SectionedInspectorFilter::_property_get_revertv(StringName const&, Variant&) const */

undefined8 __thiscall
SectionedInspectorFilter::_property_get_revertv
          (SectionedInspectorFilter *this,StringName *param_1,Variant *param_2)
...
/* SectionedInspectorFilter::_property_can_revertv(StringName const&) const */

undefined4 __thiscall
SectionedInspectorFilter::_property_can_revertv(SectionedInspectorFilter *this,StringName *param_1)
...
/* SectionedInspectorFilter::_getv(StringName const&, Variant&) const */

String __thiscall
SectionedInspectorFilter::_getv(SectionedInspectorFilter *this,StringName *param_1,Variant *param_2)
...
/* SectionedInspectorFilter::_setv(StringName const&, Variant const&) */

String __thiscall
SectionedInspectorFilter::_setv(SectionedInspectorFilter *this,StringName *param_1,Variant *param_2)
...
/* SectionedInspectorFilter::_get_property_list(List<PropertyInfo, DefaultAllocator>*) const */

void __thiscall
SectionedInspectorFilter::_get_property_list(SectionedInspectorFilter *this,List *param_1)

{
  ...
  if (*(List **)(this + 0x178) != (List *)0x0) {
    ...
    Object::get_property_list
              (*(List **)(this + 0x178),SUB81((List<PropertyInfo,DefaultAllocator> *)&local_68,0));
    if (local_68 != (undefined8 *)0x0) {
      for (pPVar1 = (PropertyInfo *)*local_68; pPVar1 != (PropertyInfo *)0x0;
          pPVar1 = *(PropertyInfo **)(pPVar1 + 0x30)) {
        this_00 = (String *)(pPVar1 + 8);
        iVar3 = String::find_char((wchar32)this_00,0x2f);
        cVar2 = String::operator==(this_00,"resource_path");
        if ((((cVar2 == '\0') &&
             (cVar2 = String::operator==(this_00,"resource_name"), cVar2 == '\0')) &&
            (cVar2 = String::operator==(this_00,"resource_local_to_scene"), cVar2 == '\0')) &&
           ((cVar2 = String::begins_with((char *)this_00), cVar2 == '\0' &&
            (cVar2 = String::begins_with((char *)this_00), cVar2 == '\0')))) {
          if (iVar3 == -1) {
            operator+((char *)&local_48,(String *)"global/");
          ...
          if (cVar2 != '\0') {
            ...
            CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
            CowData<char32_t>::_unref((CowData<char32_t> *)&local_50);
            if ((this[0x188] != (SectionedInspectorFilter)0x0) ||
               (iVar3 = String::find_char((wchar32)this_00,0x2f), iVar3 == -1)) {
              List<PropertyInfo,DefaultAllocator>::push_back
                        ((List<PropertyInfo,DefaultAllocator> *)param_1,pPVar1);
            }
          }
        }
      }
...
/* SectionedInspector::is_class(String const&) const */

undefined8 __thiscall SectionedInspector::is_class(SectionedInspector *this,String *param_1)
...
/* SectionedInspector::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall
SectionedInspector::_get_property_listv(SectionedInspector *this,List *param_1,bool param_2)
...
/* MethodBind* create_method_bind<SectionedInspector>(void (SectionedInspector::*)()) */

MethodBind * create_method_bind<SectionedInspector>(_func_void *param_1)
...
/* SectionedInspector::_bind_methods() [clone .cold] */
...
/* SectionedInspector::_initialize_classv() */

void SectionedInspector::_initialize_classv(void)
...
void SectionedInspector::_GLOBAL__sub_I__bind_methods(void)

...
int accumulate_fit(long param_1,long param_2,int param_3,int param_4,int *param_5,int param_6,
                  long param_7)

{
  ...
  *(undefined1 (*) [16])(param_5 + 6) = (undefined1  [16])0x0;
  *(undefined1 (*) [16])(param_5 + 10) = (undefined1  [16])0x0;
  if (param_4 < param_3) {
    local_3c = 0;
    iVar6 = 0;
    iVar8 = 0;
...

{
  ...
  iVar15 = (int)(*(long *)(*(long *)(*(long *)(*(long *)(param_1 + 0x68) + 8) + 0x30) +
                          *(long *)(param_1 + 0x38) * 8) / 2);
  if (param_3 == (int *)0x0) {
          ...
          do {
            ...
            *pfVar9 = *pfVar9 * *(float *)(FLOOR1_fromdB_LOOKUP + (long)iVar18 * 4);
            pfVar9 = pfVar14;
                   ...
                   (float *)((long)param_4 +
                            ((ulong)(uint)(iVar17 + (-2 - iVar10)) + lVar13) * 4 + 8));
        }
        piVar21 = piVar21 + 1;
        lVar13 = (long)iVar3;
        iVar18 = iVar20;
...
LAB_001003e3:
  ...
  if (iVar12 < iVar15) {
    ...
    do {
      ...
      *pfVar9 = *pfVar9 * fVar2;
      pfVar9 = pfVar14;
    } while ((float *)((long)param_4 +
                      ((ulong)(uint)((iVar15 + -1) - iVar12) + (long)iVar12) * 4 + 4) != pfVar14);
  }
  return 1;
}
  ...
  if (0 < *param_1) {
    ...
    if (-1 < iVar2) {
      ...
      do {
        ...
        if ((piVar8[0x10] == 0) ||
           (oggpack_write(param_2,(long)piVar8[0x20],8), 0 < 1 << ((byte)piVar8[0x10] & 0x1f))) {
          lVar6 = 0;
          do {
            lVar1 = lVar6 + 0x50;
            lVar6 = lVar6 + 1;
    ...
    *puVar7 = uVar2;
    ...
    if (0 < *piVar1) {
      do {
        ...
        if ((piVar1[lVar15 + 0x30] != 0) &&
           (uVar4 = vorbis_book_decode((long)piVar1[lVar15 + 0x40] * 0x60 + lVar8,lVar13),
           uVar4 == 0xffffffff)) goto LAB_001006f3;
        if (0 < iVar5) {
          piVar11 = puVar7 + local_58;
          do {
            while( true ) {
              uVar12 = (int)uVar4 >> (bVar9 & 0x1f);
              if (piVar1[(long)(int)(uVar4 & (1 << (bVar9 & 0x1f)) - 1U) + 0x50 + lVar15 * 8] < 0)
              break;
              iVar3 = vorbis_book_decode((long)piVar1[(long)(int)(uVar4 & (1 << (bVar9 & 0x1f)) - 1U
                                                                 ) + 0x50 + lVar15 * 8] * 0x60 +
                                         lVar8,lVar13);
              *piVar11 = iVar3;
...
LAB_00100868:
    ...
    if (2 < *(int *)(param_2 + 0x504)) {
      do {
        ...
        iVar5 = ((piVar1[lVar13 + 0xd1] - piVar1[lVar8 + 0xd1]) * iVar5) /
                (piVar1[lVar6 + 0xd1] - piVar1[lVar8 + 0xd1]);
        uVar4 = puVar7[lVar13];
        if (iVar3 < 0) {
          iVar5 = -iVar5;
        }
        ...
        if (uVar4 == 0) {
          ...
          puVar7[*(int *)(param_2 + 0x400 + lVar13 * 4)] =
               puVar7[*(int *)(param_2 + 0x400 + lVar13 * 4)] & 0x7fff;
          puVar7[*(int *)(param_2 + 0x304 + lVar13 * 4)] =
               puVar7[*(int *)(param_2 + 0x304 + lVar13 * 4)] & 0x7fff;
        }
        lVar13 = lVar13 + 1;
...
LAB_00100a96:
    ...
    lVar11 = 0;
    do {
      *(int *)((long)piVar4 + lVar11 + 0x104) =
           (int)(*(long *)((long)local_248 + lVar11 * 2) - (long)(param_2 + 0xd1) >> 2);
      lVar11 = lVar11 + 4;
    ...
    do {
      ...
      do {
        while( true ) {
          ...
          if (((iVar1 <= iVar13) ||
              (iVar2 = (int)uVar9, iVar12 = iVar1, param_2[uVar10 + 0xd1] <= iVar1)) &&
             (iVar2 = iVar18, iVar12 = iVar13, iVar1 < iVar14)) break;
          iVar18 = iVar2;
          uVar9 = uVar9 + 1;
          iVar13 = iVar12;
...

{
  ...
  if (0 < param_2) {
    ...
    do {
      iVar1 = piVar5[7];
      piVar6 = piVar5 + 0xe;
      dVar7 = (double)(((float)(piVar5[0xd] + iVar1) * *(float *)(param_5 + 0x454)) /
                      (float)(iVar1 + 1)) + _LC4;
    ...
    if (0.0 < dVar7) {
      ...
      if ((double)((ulong)dVar12 & _LC6) < _LC5) {
        dVar12 = (double)((ulong)(((double)((ulong)dVar12 & _LC6) + _LC5) - _LC5) |
                         ~_LC6 & (ulong)dVar12);
      }
      *param_3 = (int)dVar12;
...
int * floor1_fit(undefined8 param_1,long param_2,long param_3,long param_4)

{
  ...
  uint auStack_1390 [66];
  undefined8 local_1288;
  uint auStack_1280 [66];
  uint local_1178 [68];
  uint local_1068 [68];
  uint local_f58 [68];
  ...
  if (lVar19 < 1) {
    if (lVar19 == 0) {
      ...
      if (iVar13 != 0) {
        ...
        local_1398 = CONCAT44(local_13ac,local_13b0);
    ...
    puVar14 = &local_1398;
    do {
      *(undefined4 *)puVar14 = 0xffffff38;
      puVar14 = (undefined8 *)((long)puVar14 + 4);
    } while (puVar14 != (undefined8 *)((long)&local_1398 + __n));
    puVar14 = &local_1288;
    do {
      *(undefined4 *)puVar14 = 0xffffff38;
      puVar14 = (undefined8 *)((long)puVar14 + 4);
    } while ((undefined8 *)((long)&local_1288 + __n) != puVar14);
    memset(local_1178,0,__n);
    puVar15 = local_1068;
    do {
      *puVar15 = 1;
      puVar15 = puVar15 + 1;
    } while (puVar15 != local_1068 + lVar19);
    ...
    if (lVar19 != 1) {
      ...
      if (lVar33 != 0) {
        local_13b0 = -200;
        local_13ac = -200;
        fit_line_constprop_0(local_e48,iVar13 + -1,&local_13b0,&local_13ac,lVar8,0x101454,uVar38);
        local_1288 = CONCAT44(local_13ac,local_13b0);
        local_1398 = CONCAT44(local_13ac,local_13b0);
...
LAB_001019c0:
              lVar31 = lVar31 + 1;
              if (lVar19 == lVar31) goto LAB_001019cf;
            }
            ...
            uVar39 = auStack_1390[lVar16 + -2];
            uVar29 = auStack_1280[lVar16 + -2];
            if ((int)uVar39 < 0) {
            ...
            uVar29 = auStack_1390[lVar26 + -2];
            uVar7 = auStack_1280[lVar26 + -2];
            if ((int)uVar29 < 0) {
            ...
            if (fVar35 <= *pfVar23 + *(float *)(lVar8 + 0x458)) {
              if (((float)iVar21 <= fVar2 + (float)(int)uVar39) &&
                 ((float)(int)uVar39 - fVar3 <= (float)iVar21)) goto LAB_0010172e;
LAB_0010181b:
              local_13a8 = 0xffffff38;
              local_13a4 = 0xffffff38;
              local_13a0 = 0xffffff38;
              local_139c = 0xffffff38;
              iVar12 = fit_line_constprop_0
                                 (local_e48 + (long)iVar12 * 0x38,iVar13 - iVar12,&local_13a8,
                                  &local_13a4);
              iVar25 = fit_line_constprop_0
                                 (local_e48 + lVar33 * 0x38,iVar25 - iVar13,&local_13a0,&local_139c)
              ;
              if (iVar12 == 0) {
                ...
                local_13a8 = uVar39;
                if (iVar25 != 0) goto LAB_00101b89;
              }
              auStack_1280[lVar16 + -2] = local_13a8;
              if (uVar5 == 0) {
                local_1398 = CONCAT44(local_1398._4_4_,local_13a8);
              }
              *(uint *)((long)&local_1398 + lVar31 * 4) = (uint)puVar15;
              *(uint *)((long)&local_1288 + lVar31 * 4) = local_13a0;
              auStack_1390[lVar26 + -2] = local_139c;
              if (uVar6 == 1) {
                local_1288 = CONCAT44(local_139c,(int)local_1288);
              }
              if (-1 < (int)((uint)puVar15 & local_13a0)) {
                ...
                if (iVar13 + -1 < 0) {
                  ...
                  lVar33 = (long)(iVar13 + 1);
                  puVar15 = local_1068;
                  if (lVar19 <= lVar33) goto LAB_001019c0;
                }
                do {
                  puVar15 = local_1178;
...
LAB_0010172e:
            ...
            if ((int)(iVar32 + 1U) < iVar18) {
              ...
              do {
                ...
                if ((fVar35 <= pfVar23[(long)puVar20 + 1] + *(float *)(lVar8 + 0x458)) &&
                   (0 < iVar28)) {
                  if ((fVar2 + (float)(int)uVar29 < (float)iVar22) ||
                     ((float)iVar22 < (float)(int)uVar29 - fVar3)) goto LAB_0010181b;
                }
            ...
            if ((((fVar2 * fVar2) / fVar35 <= fVar4) && ((fVar3 * fVar3) / fVar35 <= fVar4)) &&
               (puVar15 = (uint *)((long)iVar21 % (long)iVar18 & 0xffffffff),
               fVar4 < (float)(iVar21 / iVar18))) goto LAB_0010181b;
LAB_00101b89:
            *(undefined4 *)((long)&local_1398 + lVar31 * 4) = 0xffffff38;
            *(undefined4 *)((long)&local_1288 + lVar31 * 4) = 0xffffff38;
            lVar31 = lVar31 + 1;
          } while (lVar19 != lVar31);
LAB_001019cf:
          iVar13 = (int)local_1398;
          iVar12 = (int)local_1288;
          iVar25 = local_1398._4_4_;
          iVar18 = local_1288._4_4_;
        }
LAB_001019ed:
        piVar17 = (int *)_vorbis_block_alloc(param_1,lVar19 * 4,puVar15);
        iVar32 = iVar12;
        if ((-1 < iVar13) && (iVar32 = iVar13, -1 < iVar12)) {
          iVar32 = iVar13 + iVar12 >> 1;
        }
        *piVar17 = iVar32;
        iVar13 = iVar18;
        if ((-1 < iVar25) && (iVar13 = iVar25, -1 < iVar18)) {
        ...
        if (2 < lVar19) {
          do {
            while( true ) {
              ...
              iVar13 = ((*(int *)(lVar8 + 0x344 + lVar31 * 4) - iVar13) * iVar12) /
                       (*(int *)(lVar8 + 0x344 + lVar16 * 4) - iVar13);
              uVar5 = auStack_1390[lVar31 + -2];
              if (iVar25 < 0) {
                iVar13 = -iVar13;
              }
              uVar39 = iVar13 + (piVar17[lVar33] & 0x7fffU);
              uVar6 = auStack_1280[lVar31 + -2];
              uVar29 = uVar6;
              ...
              lVar31 = lVar31 + 1;
              if (lVar19 == lVar31) goto LAB_00101b16;
            }
  ...
  if (param_3 != 0) {
    ...
    if (param_4 != 0) {
      ...
      if (0 < lVar4) {
        lVar3 = 0;
        do {
          iVar1 = (*(uint *)(param_3 + lVar3 * 4) & 0x7fff) * (0x10000 - param_5) + 0x8000 +
                  (*(uint *)(param_4 + lVar3 * 4) & 0x7fff) * param_5;
          *(int *)(lVar2 + lVar3 * 4) = iVar1 >> 0x10;
          if (((*(byte *)(param_3 + 1 + lVar3 * 4) & 0x80) != 0) &&
             ((*(byte *)(param_4 + 1 + lVar3 * 4) & 0x80) != 0)) {
      ...
      if (2 < lVar29) {
        ...
        do {
          while( true ) {
            ...
            iVar5 = (iVar5 * (piVar1[lVar23 + 0xd1] - piVar1[lVar8 + 0xd1])) /
                    (piVar1[lVar22 + 0xd1] - piVar1[lVar8 + 0xd1]);
            if (iVar13 < 0) {
              iVar5 = -iVar5;
            }
            uVar2 = iVar5 + uVar24;
            ...
            lVar23 = lVar23 + 1;
            if (lVar29 == lVar23) goto LAB_00101fee;
          }
...
LAB_00102148:
              lVar8 = lVar8 + 4;
              if (lVar23 - lVar8 == 0) goto LAB_001021b3;
            }
            iVar13 = *(int *)((long)local_140 + lVar8 + local_1d8 * 4 + -8);
            lVar22 = (long)piVar1[(long)*(int *)((long)local_188 + lVar8) + 0x50 + lVar29 * 8] *
                     0x60 + lVar19;
            if (*(long *)(lVar22 + 8) <= (long)iVar13) goto LAB_00102148;
            lVar8 = lVar8 + 4;
            ...
            do {
              while (iVar15 = iVar15 + (iVar16 - iVar27), iVar25 <= iVar15) {
                ...
                *(int *)((long)param_5 + lVar9 * 4) = iVar5;
                lVar9 = lVar9 + 1;
                if (iVar28 <= (int)lVar9) goto LAB_001022f8;
              }
              iVar5 = iVar5 + iVar3;
              *(int *)((long)param_5 + lVar9 * 4) = iVar5;
              lVar9 = lVar9 + 1;

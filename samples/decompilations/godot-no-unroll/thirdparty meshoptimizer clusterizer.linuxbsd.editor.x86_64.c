...
undefined8
meshopt::appendMeshlet
          (meshopt_Meshlet *param_1,uint param_2,uint param_3,uint param_4,uchar *param_5,
          meshopt_Meshlet *param_6,uint *param_7,uchar *param_8,ulong param_9,ulong param_10,
          ulong param_11)

{
  ...
  if ((param_10 <
       (uint)(*puVar9 == 0xff) + (uint)(uVar2 == 0xff) + (uint)(*puVar8 == 0xff) +
       *(int *)(param_1 + 8)) || (uVar11 = 0, param_11 <= *(uint *)(param_1 + 0xc))) {
...
/* meshopt::computeBoundingSphere(float*, float const (*) [3], unsigned long) */

void meshopt::computeBoundingSphere(float *param_1,float *param_2,ulong param_3)

{
    ...
    do {
      ...
      do {
        ...
        *(ulong *)(local_58 + lVar4 * 8) = uVar6;
        ...
        if (param_2[*(ulong *)(local_38 + lVar4 * 8) * 3 + (long)(int)lVar4] <= fVar8 &&
            fVar8 != param_2[*(ulong *)(local_38 + lVar4 * 8) * 3 + (long)(int)lVar4]) {
          uVar6 = uVar5;
        }
  ...
  do {
    ...
    fVar10 = (pfVar2[1] - pfVar7[1]) * (pfVar2[1] - pfVar7[1]) +
             (*pfVar2 - *pfVar7) * (*pfVar2 - *pfVar7) +
             (pfVar2[2] - pfVar7[2]) * (pfVar2[2] - pfVar7[2]);
    if (fVar8 < fVar10) {
...
/* meshopt::kdtreeNearest(meshopt::KDNode*, unsigned int, float const*, unsigned long, unsigned char
   const*, float const*, unsigned int&, float&) [clone .constprop.0] */

undefined1  [16]
meshopt::kdtreeNearest
          (KDNode *param_1,uint param_2,float *param_3,ulong param_4,uchar *param_5,float *param_6,
...

{
  ...
  while ((~(byte)KVar3 & 3) != 0) {
    ...
    kdtreeNearest(param_1,uVar7 + iVar8,param_3,param_4,param_5,param_6,param_7,
  ...
  do {
    ...
    if (*(char *)(param_4 + (uint)fVar2) == '\0') {
      ...
      fVar9 = SQRT((*pfVar1 - *(float *)param_5) * (*pfVar1 - *(float *)param_5) +
                   (pfVar1[1] - *(float *)(param_5 + 4)) * (pfVar1[1] - *(float *)(param_5 + 4)) +
                   (pfVar1[2] - *(float *)(param_5 + 8)) * (pfVar1[2] - *(float *)(param_5 + 8)));
...
LAB_001005dd:
  auVar10._8_8_ = in_stack_ffffffffffffffb0;
...
/* meshopt::getNeighborTriangle(meshopt_Meshlet const&, meshopt::Cone const*, unsigned int*,
   ...
   const*, unsigned char const*, float, float) [clone .isra.0] */

uint __thiscall
meshopt::getNeighborTriangle
          (meshopt *this,meshopt_Meshlet *param_1,Cone *param_2,uint *param_3,uint *param_4,
          TriangleAdjacency2 *param_5,Cone *param_6,uint *param_7,uchar *param_8,float param_9,
          float param_10)
...
LAB_0010080d:
          if (param_2 == (Cone *)0x0) {
            ...
            fVar14 = _LC2 - (*(float *)(pCVar1 + 0xc) * *(float *)(param_2 + 0xc) +
                             *(float *)(pCVar1 + 0x10) * *(float *)(param_2 + 0x10) +
                            *(float *)(pCVar1 + 0x14) * *(float *)(param_2 + 0x14)) * param_10;
            fVar12 = _LC6;
            if (_LC6 <= fVar14) {
              fVar12 = fVar14;
            }
            fVar12 = ((SQRT((*(float *)pCVar1 - *(float *)param_2) *
                            (*(float *)pCVar1 - *(float *)param_2) +
                            (*(float *)(pCVar1 + 4) - *(float *)(param_2 + 4)) *
                            (*(float *)(pCVar1 + 4) - *(float *)(param_2 + 4)) +
                            (*(float *)(pCVar1 + 8) - *(float *)(param_2 + 8)) *
                            (*(float *)(pCVar1 + 8) - *(float *)(param_2 + 8))) / param_9) *
                      (_LC2 - param_10) + _LC2) * fVar12;
          }
          ...
          if (((param_7[uVar3] == 1) || (param_7[uVar4] == 1)) || (param_7[uVar5] == 1)) {
            ...
            bVar6 = ((byte)((param_7[uVar5] == 2) + (param_7[uVar4] == 2) + (param_7[uVar3] == 2)) <
                    2) + '\x01' + bVar6;
          }
...
/* meshopt::kdtreeBuild(unsigned long, meshopt::KDNode*, unsigned long, float const*, unsigned long,
   unsigned int*, unsigned long, unsigned long) [clone .constprop.0] [clone .isra.0] */

long meshopt::kdtreeBuild
               (ulong param_1,KDNode *param_2,ulong param_3,float *param_4,ulong param_5,
  ...
  if (8 < param_5) {
    ...
    do {
      ...
      *(float *)pKVar5 = fVar15;
      ...
      param_1 = kdtreeBuild(uVar12 + 1,param_2,param_3,param_4,uVar11,(uint *)pKVar5,
                            in_stack_ffffffffffffff88,(ulong)param_2);
      param_5 = param_5 - uVar11;
      param_4 = param_4 + uVar11;
      *(uint *)(pKVar5 + 4) =
           (uint)*(float *)(pKVar5 + 4) & 3 | ((int)param_1 - (int)uVar12) * 4 - 4U;
      uVar12 = param_1;
    } while (8 < param_5);
  }
...
ulong meshopt_buildMeshlets
                (float param_1,meshopt_Meshlet *param_2,uint *param_3,uchar *param_4,uint *param_5,
                ulong param_6,uint *param_7,ulong param_8,ulong param_9,ulong param_10,
                ulong param_11)
...
LAB_00100d98:
      ...
      uVar19 = 0;
      do {
        *(int *)(local_178._8_8_ + uVar19 * 4) = iVar12;
        iVar12 = iVar12 + *(int *)(local_178._0_8_ + uVar19 * 4);
        uVar19 = uVar19 + 1;
    ...
    uVar19 = 0;
    do {
      piVar1 = (int *)(lVar5 + uVar19 * 4);
      *piVar1 = *piVar1 - *(int *)(lVar14 + uVar19 * 4);
      uVar19 = uVar19 + 1;
    } while (param_8 != uVar19);
  }
LAB_00100e3f:
  puVar6 = (uint *)(*(code *)meshopt_Allocator::StorageT<void>::allocate)(sVar24);
  local_108[local_48] = (long)puVar6;
  local_48 = local_48 + 1;
  memcpy(puVar6,(void *)local_178._0_8_,__n);
  __s = (void *)(*(code *)meshopt_Allocator::StorageT<void>::allocate)(puVar23);
  local_108[local_48] = (long)__s;
  local_48 = local_48 + 1;
  memset(__s,0,(size_t)puVar23);
  if (param_6 < 0x2000000000000001) {
    pCVar7 = (Cone *)(*(code *)meshopt_Allocator::StorageT<void>::allocate)((long)puVar23 * 0x18);
    lVar14 = local_48 + 1;
    local_108[local_48] = (long)pCVar7;
    local_48 = lVar14;
    if (2 < param_6) goto LAB_00100f34;
    fVar31 = (float)param_11 * 0.0;
LAB_00101103:
    fVar32 = _LC1 * SQRT(fVar31);
    pfVar8 = (float *)(*(code *)meshopt_Allocator::StorageT<void>::allocate)((long)puVar23 * 4);
    lVar14 = local_48 + 1;
    local_108[local_48] = (long)pfVar8;
    local_48 = lVar14;
    if (param_6 < 3) goto LAB_0010116e;
  }
  else {
...
LAB_00100f34:
    ...
    puVar20 = param_5;
    do {
      puVar15 = (uint *)(puVar20[1] * param_9 + (long)param_7);
      pfVar8 = (float *)(puVar20[2] * param_9 + (long)param_7);
      puVar25 = (uint *)(*puVar20 * param_9 + (long)param_7);
      ...
      puVar20 = puVar20 + 3;
      *(float *)pCVar21 = (fVar37 + fVar33 + fVar39) / fVar31;
      *(float *)(pCVar21 + 4) = ((float)puVar25[1] + (float)puVar15[1] + pfVar8[1]) / fVar31;
      fVar38 = (float)puVar25[2];
      fVar33 = (float)puVar15[2];
      fVar37 = pfVar8[2];
      *(float *)(pCVar21 + 0xc) = fVar32 * fVar42;
      *(ulong *)(pCVar21 + 0x10) = CONCAT44(fVar42 * fVar35,fVar42 * fVar34);
      *(float *)(pCVar21 + 8) = (fVar38 + fVar33 + fVar37) / fVar31;
      fVar32 = _LC1;
      pCVar21 = pCVar21 + 0x18;
    } while (puVar29 < puVar23);
    fVar31 = (fVar36 / (float)(long)puVar23) * _LC1 * (float)param_11;
  ...
  puVar20 = (uint *)0x0;
  do {
    pfVar8[(long)puVar20] = SUB84(puVar20,0);
    puVar20 = (uint *)((long)puVar20 + 1);
  } while (puVar20 < puVar23);
LAB_0010116e:
  pKVar9 = (KDNode *)(*(code *)meshopt_Allocator::StorageT<void>::allocate)((long)puVar23 << 4);
  local_108[local_48] = (long)pKVar9;
  local_48 = local_48 + 1;
  meshopt::kdtreeBuild
            (0,pKVar9,(ulong)pCVar7,pfVar8,(ulong)puVar23,puVar29,in_stack_fffffffffffffdd8,
             (ulong)pCVar7);
  __s_00 = (uchar *)(*(code *)meshopt_Allocator::StorageT<void>::allocate)(param_8);
  local_108[local_48] = (long)__s_00;
  pfVar8 = (float *)0x1011fa;
  local_48 = local_48 + 1;
  ...
  do {
    ...
    local_138 = uVar40;
    fStack_130 = fVar38;
    fVar36 = (float)meshopt::getNeighborTriangle
                              (this,pmVar26,(Cone *)&local_138,param_3,param_5,
                               (TriangleAdjacency2 *)local_178,pCVar7,puVar6,__s_00,fVar32,param_1);
    if (fVar36 == -NAN) {
LAB_00101618:
      local_190 = -NAN;
      local_18c = uVar28;
      ...
      local_110 = fVar38;
      meshopt::kdtreeNearest
                (pKVar9,0,(float *)pCVar7,(ulong)__s,(uchar *)&local_118,&local_190,&local_18c,
                 pfVar8);
      fVar36 = local_190;
      if (local_190 == -NAN) {
        if (uVar18 != 0) {
...
LAB_00101488:
      ...
      uVar22 = (ulong)uVar13;
      if ((param_10 <
           (uint)(__s_00[uVar22] == 0xff) +
           (uint)(__s_00[uVar30] == 0xff) + (uint)(__s_00[uVar19] == 0xff) + (int)pmVar26) ||
         (param_11 <= uVar18)) {
        fVar36 = (float)meshopt::getNeighborTriangle
                                  (this,pmVar26,(Cone *)0x0,param_3,param_5,
                                   (TriangleAdjacency2 *)local_178,pCVar7,puVar6,__s_00,fVar32,0.0);
        if (fVar36 == -NAN) goto LAB_00101618;
        goto LAB_00101488;
      }
    }
    cVar3 = meshopt::appendMeshlet
                      ((meshopt_Meshlet *)local_188,uVar4,uVar17,uVar13,__s_00,param_2,param_3,
                       param_4,local_1e8,param_10,param_11);
    if (cVar3 == '\0') {
    }
    else {
      local_1e8 = local_1e8 + 1;
    ...
    puVar6[uVar22] = puVar6[uVar22] - 1;
    do {
      puVar23 = (uint *)(local_178._0_8_ + (ulong)param_5[uVar11 + lVar14] * 4);
      uVar19 = (ulong)*puVar23;
      pfVar2 = (float *)(local_168 +
                        (ulong)*(uint *)(local_178._8_8_ + (ulong)param_5[uVar11 + lVar14] * 4) * 4)
      ;
      if (uVar19 != 0) {
        uVar22 = 0;
        pfVar10 = pfVar2;
    ...
    pCVar21 = pCVar7 + (ulong)(uint)fVar36 * 0x18;
    local_158._4_4_ = (float)local_158._4_4_ + *(float *)(pCVar21 + 4);
    local_158._0_4_ = (float)local_158._0_4_ + *(float *)pCVar21;
    fStack_150 = fStack_150 + *(float *)(pCVar21 + 8);
    fStack_14c = fStack_14c + *(float *)(pCVar21 + 0xc);
    local_148 = (float)*(undefined8 *)(pCVar21 + 0x10) + local_148;
    fStack_144 = (float)((ulong)*(undefined8 *)(pCVar21 + 0x10) >> 0x20) + fStack_144;
...
ulong meshopt_buildMeshletsScan
                (meshopt_Meshlet *param_1,uint *param_2,uchar *param_3,long param_4,ulong param_5,
                size_t param_6,ulong param_7,ulong param_8)

{
  ...
  if (param_5 == 0) {
    ...
    do {
      ...
      lVar2 = uVar8 * 4;
      uVar8 = uVar8 + 3;
      bVar3 = meshopt::appendMeshlet
                        ((meshopt_Meshlet *)local_118,*(uint *)(param_4 + lVar2),
                         *(uint *)(param_4 + 4 + lVar1),*(uint *)(param_4 + 8 + lVar6),puVar4,
                         param_1,param_2,param_3,uVar10,param_7,param_8);
      uVar10 = uVar10 + bVar3;
    } while (uVar8 < param_5);
    lVar6 = local_48;
    uVar8 = uVar10;
...

{
  ...
  *(undefined1 (**) [16])(puVar10 + -0x1040) = param_1;
  ...
  do {
    ...
    auVar24._4_4_ =
         ((float)((ulong)*(undefined8 *)(pfVar11 + 1) >> 0x20) - fVar20) * fVar23 -
         fVar21 * ((float)((ulong)*(undefined8 *)(pfVar9 + 1) >> 0x20) - fVar20);
    auVar24._8_8_ = 0;
    ...
    if (fVar27 != 0.0) {
      ...
      *(undefined8 *)(puVar10 + -0x1070) = 0x101ca3;
      ...
      uVar16 = uVar15 + 1;
      *(undefined8 *)(puVar10 + -0x1070) = 0x101ccf;
  ...
  *param_1 = (undefined1  [16])0x0;
  param_1[1] = (undefined1  [16])0x0;
  param_1[2] = (undefined1  [16])0x0;
  if (uVar16 == 0) goto LAB_00101d0d;
  pfVar11 = (float *)(puVar10 + 0x7e8);
  *(undefined8 *)(puVar10 + -0x1070) = 0x101d5e;
  meshopt::computeBoundingSphere((float *)(puVar10 + -0x1038),pfVar11,uVar16 * 3);
  pfVar9 = (float *)(puVar10 + -0x1018);
  *(undefined4 *)(puVar10 + -0x1050) = *(undefined4 *)(puVar10 + -0x1038);
  *(undefined4 *)(puVar10 + -0x1058) = *(undefined4 *)(puVar10 + -0x1034);
  *(undefined4 *)(puVar10 + -0x1060) = *(undefined4 *)(puVar10 + -0x1030);
  *(undefined8 *)(puVar10 + -0x1070) = 0x101d9b;
  ...
  *(ulong *)(*param_1 + 8) = CONCAT44(uVar1,fVar21);
  ...
  do {
    pfVar8 = pfVar12 + 9;
    fVar19 = ((fVar27 - pfVar12[1]) * pfVar9[1] + (fVar20 - *pfVar12) * *pfVar9 +
             (fVar21 - pfVar12[2]) * pfVar9[2]) /
             (pfVar9[1] * fVar28 + *pfVar9 * fVar26 + pfVar9[2] * fVar25);
    if (fVar19 <= fVar17) {
      fVar19 = fVar17;
    }
    pfVar9 = pfVar9 + 3;
  ...
  *(float *)(param_1[1] + 0xc) = fVar26;
  ...
  if (fVar21 < 0.0) {
    ...
    *(undefined8 *)(puVar10 + -0x1070) = 0x1021be;
    fVar21 = sqrtf(fVar21);
...
LAB_001020c2:
  ...
  if (fVar25 < 0.0) {
    ...
    if (fVar25 <= fVar23) {
      fVar18 = fVar25 * fVar27 + _LC1;
LAB_00102090:
      cVar4 = (char)(int)fVar18;
      fVar18 = (float)(int)cVar4 / fVar27;
    }
  }
  param_1[2][0xe] = cVar4;
  iVar6 = (int)(((float)((uint)(fVar20 - fVar26) & uVar2) + fVar21 +
                 (float)((uint)(fVar17 - fVar28) & uVar2) + (float)((uint)(fVar18 - fVar25) & uVar2)
                ) * fVar27 + fVar23);
  ...
  param_1[2][0xf] = uVar5;
LAB_00101d0d:
  if (*(long *)(puVar10 + 0x4ff0) != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    *(undefined8 *)(puVar10 + -0x1070) = 0x10219d;
    __stack_chk_fail();
  }
  return param_1;
}
  ...
  if (param_3 != 0) {
    ...
    do {
      ...
      if (uVar15 < param_3) {
        ...
        pbVar8 = pbVar16;
        do {
          uVar4 = (uint)((byte)(cVar9 - local_248[*pbVar8]) < 3) +
                  (uint)((byte)(cVar9 - local_248[pbVar8[1]]) < 3) +
                  (uint)((byte)(cVar9 - local_248[pbVar8[2]]) < 3);

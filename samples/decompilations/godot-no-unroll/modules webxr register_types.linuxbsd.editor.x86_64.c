...
/* uninitialize_webxr_module(ModuleInitializationLevel) */

void uninitialize_webxr_module(void)
...
/* initialize_webxr_module(ModuleInitializationLevel) */

void initialize_webxr_module(int param_1)

{
  if (param_1 != 2) {
    return;
  }
  ClassDB::register_abstract_class<WebXRInterface>();
  return;
}
...
/* void ClassDB::register_abstract_class<WebXRInterface>() */

void ClassDB::register_abstract_class<WebXRInterface>(void)

{
  ...
  _global_lock();
  if (WebXRInterface::initialize_class()::initialized == '\0') {
    ...
    if ((code *)PTR__bind_compatibility_methods_00102008 != Object::_bind_compatibility_methods) {
      WebXRInterface::_bind_compatibility_methods();
    }
    WebXRInterface::initialize_class()::initialized = '\x01';
  }
  local_58 = "WebXRInterface";
  local_60 = 0;
  local_50 = 0xe;
    ...
    if (uVar17 != 0) {
      ...
      do {
        if ((uVar17 == uVar13) &&
          ...
          if (local_60 == 0) goto LAB_001004df;
          goto LAB_001004b5;
        }
        uVar18 = uVar18 + 1;
        auVar5._8_8_ = 0;
...
LAB_001004df:
        ...
        *(undefined4 **)(puVar16 + 4) = &WebXRInterface::get_class_ptr_static()::ptr;
        *puVar16 = (undefined4)current_api;
        if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) goto LAB_001006e7;
        goto LAB_0010050e;
      }
    }
  }

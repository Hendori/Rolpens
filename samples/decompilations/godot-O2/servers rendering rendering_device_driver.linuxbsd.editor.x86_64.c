    ...
    if (lVar13 != 0) {
      if (param_1 <= lVar7) {
        ...
        while( true ) {
          ...
          if (*(ulong *)(lVar7 + -8) <= uVar12) break;
          while( true ) {
            lVar4 = uVar12 * 0x10 + lVar7;
            if (*(long *)(lVar4 + 8) != 0) break;
            uVar12 = uVar12 + 1;
            if (*(ulong *)(lVar7 + -8) <= uVar12) goto LAB_00100c42;
          }
          LOCK();
...
LAB_00100d43:
        ...
        lVar7 = puVar9[-1];
        if (param_1 <= lVar7) goto LAB_00100d19;
      }
      else {
        if (lVar7 != 0) {
          iVar3 = _realloc(this,lVar13);
      ...
      puVar14 = puVar9 + param_1 * 2;
      puVar5 = puVar9 + lVar7 * 2;
      if (((int)puVar14 - (int)puVar5 & 0x10U) != 0) {
        puVar5[1] = 0;
        puVar5 = puVar5 + 2;
        if (puVar5 == puVar14) goto LAB_00100d19;
      }
      do {
        puVar5[1] = 0;
        puVar6 = puVar5 + 4;
        ...
        if ((uint)local_568 != 0) {
          ...
          if (lVar23 != 0) {
            ...
            do {
              ...
              if ((long)local_618 <= (long)uVar21) goto LAB_001023bd;
...
LAB_0010222c:
              ...
              lVar26 = lVar26 + 1;
              if ((uint)local_568 <= (uint)lVar26) goto LAB_0010391a;
              local_520 = local_520 & 0xffffffff00000000;
            } while( true );
          }
          goto LAB_00102e47;
    ...
    if (iVar12 == 0) {
      if (local_5bc == 0) {
        if (plVar29 == (long *)0x0) goto LAB_001016cd;
LAB_00101b22:
        LOCK();
        plVar29 = plVar29 + -2;
        *plVar29 = *plVar29 + -1;
            ...
            if ((uVar19 == 0) ||
              ...
              if (piVar16 != (int *)0x0) {
                ...
                do {
                  uVar30 = uVar11;
                  piVar25 = piVar9;
                  if (*(long *)(piVar16 + -2) <= (long)uVar30) goto LAB_00101a56;
                  piVar9 = piVar25 + 8;
                  uVar11 = uVar30 + 1;
...
LAB_00101a56:
            ...
            if (lVar28 <= (long)uVar21) goto LAB_00102e24;
            CowData<Vector<RenderingDeviceCommons::ShaderUniform>>::_copy_on_write(this);
  ...
  if (iVar13 == 0) {
    ...
    if (iVar13 == 0) {
      if ((int)local_560 != 0) {
        ...
        if (iVar13 == 0) {
          if ((int)local_560 == 0) {
            if (plVar29 == (long *)0x0) goto LAB_0010174e;
          }
          else {
            if (plVar29 == (long *)0x0) {
LAB_00102e47:
...
LAB_00101820:
              ...
              if (param_2 == piVar3) goto LAB_0010183f;
              goto LAB_0010162c;
            }
          }
...
LAB_00101d2f:
    ...
    if ((int)local_560 == 0) goto LAB_0010174e;
    local_530 = (long *)0x0;
    CowData<SpvReflectInterfaceVariable*>::resize<false>
              ((CowData<SpvReflectInterfaceVariable*> *)&local_530,local_560 & 0xffffffff);
    CowData<SpvReflectInterfaceVariable*>::_copy_on_write
    ...
    if (iVar13 == 0) {
      if ((int)local_560 == 0) {
        ...
        if (plVar29 == (long *)0x0) goto LAB_00102e47;
        local_618 = (CowData<char32_t> *)plVar29[-1];
        uVar21 = 0;
        do {
          if ((long)local_618 <= (long)uVar21) goto LAB_001023bd;
    ...
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_548);
joined_r0x00103d09:
    if (plVar29 == (long *)0x0) goto LAB_00101e15;
LAB_00102d59:
    LOCK();
    plVar29 = plVar29 + -2;
    *plVar29 = *plVar29 + -1;
...
LAB_001055cc:
        ...
        if (uVar16 < *(uint *)(pSVar14 + 4)) {
          ...
          while (param_1 != lVar11) {
            lVar11 = lVar11 + -1;
            pSVar14 = pSVar10;
            if (*(uint *)(pSVar10 + 4) <= uVar16) goto LAB_0010563f;
...
LAB_0010563f:
        if (lVar11 <= param_2) goto LAB_00105680;
...
LAB_00105a30:
      ...
      lVar8 = lVar9 + -1;
      if (lVar9 <= lVar15) goto LAB_00105ae4;
      do {
        lVar13 = lVar8 >> 1;
      ...
      *(undefined8 *)(pSVar10 + 8) = uVar6;
      if (lVar15 == 0) goto LAB_0010571f;
    }
    else {
      pSVar10 = pSVar18;
      pSVar14 = pSVar18;
      if (lVar17 == lVar11) goto LAB_00105a30;
LAB_00105ae4:
      *(undefined8 *)(pSVar14 + 0x10) = uVar4;
...
LAB_00105680:
  ...
  lVar17 = param_2;
  if (param_4 == 0) goto LAB_001058c0;
  goto LAB_0010554f;
LAB_0010571f:
  pSVar18 = param_3 + param_1 * 0x18;
...
LAB_00105f4d:
          ...
          *(undefined8 *)(pSVar14 + 8) = uVar5;
          lVar12 = lVar8;
          sVar15 = sVar15 + 0x18;
          if (lVar8 == 0xf) goto LAB_00105f71;
        }
...
LAB_001066cc:
    ...
    lVar3 = puVar8[-1];
    if (param_1 <= lVar3) goto LAB_00106659;
  }
  else {
    if (lVar9 != 0) {
...
LAB_00106a1c:
    ...
    lVar3 = puVar8[-1];
    if (param_1 <= lVar3) goto LAB_001069ab;
  }
  else {
    if (lVar10 != 0) {

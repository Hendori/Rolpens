...
/* icu_76_godot::UCharsTrie::Iterator::Iterator(icu_76_godot::ConstChar16Ptr, int, UErrorCode&) */

void __thiscall
icu_76_godot::UCharsTrie::Iterator::Iterator
          (Iterator *this,undefined8 *param_2,undefined4 param_3,UErrorCode *param_4)
...
void __thiscall
icu_76_godot::UCharsTrie::Iterator::Iterator
          (Iterator *this,UCharsTrie *param_1,int param_2,UErrorCode *param_3)
    ...
    *(UVector32 **)(this + 0x70) = this_00;
    if ((iVar1 < 1) && (-1 < *(int *)(this + 0x18))) {
      ...
      icu_76_godot::UnicodeString::doAppend
                ((wchar16 *)(this + 0x28),(int)*(undefined8 *)(this + 8),0);
...
void __thiscall icu_76_godot::UCharsTrie::Iterator::~Iterator(Iterator *this)
...
/* icu_76_godot::UCharsTrie::Iterator::reset() */

Iterator * __thiscall icu_76_godot::UCharsTrie::Iterator::reset(Iterator *this)
...
/* icu_76_godot::UCharsTrie::Iterator::hasNext() const */

undefined4 __thiscall icu_76_godot::UCharsTrie::Iterator::hasNext(Iterator *this)

{
  if (*(long *)(this + 8) != 0) {
    return 1;
  }
  return CONCAT31((int3)((uint)*(int *)(*(long *)(this + 0x70) + 8) >> 8),
                  *(int *)(*(long *)(this + 0x70) + 8) != 0);
}



/* icu_76_godot::UCharsTrie::Iterator::branchNext(char16_t const*, int, UErrorCode&) */

undefined2 *
icu_76_godot::UCharsTrie::Iterator::branchNext(wchar16 *param_1,int param_2,UErrorCode *param_3)
...
LAB_001003f3:
        *(int *)(*(long *)(lVar16 + 0x18) + (long)iVar3 * 4) = (int)((long)puVar14 - lVar4 >> 1);
...
LAB_00100413:
        *(uint *)(*(long *)(lVar13 + 0x18) + (long)iVar3 * 4) =
             ((int)uVar9 - uVar10) * 0x10000 | uVar8;
...
LAB_001004f1:
    uVar11 = (uint)(wVar15 >> 5);
  }
  else {
LAB_001005c3:
    *(int *)(*(long *)(lVar16 + 0x18) + (long)iVar3 * 4) = (int)((long)puVar6 - lVar4 >> 1);
    *(int *)(lVar16 + 8) = *(int *)(lVar16 + 8) + 1;
    wVar15 = param_1[0x18];
...
/* icu_76_godot::UCharsTrie::Iterator::next(UErrorCode&) */

undefined8 __thiscall icu_76_godot::UCharsTrie::Iterator::next(Iterator *this,UErrorCode *param_1)

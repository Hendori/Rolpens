...
LAB_001001c8:
  ...
  if (1 < uVar6) {
    do {
      ...
      if ((lVar8 != 0) &&
         (cVar7 = TaskQueue::steal((TaskQueue *)(lVar8 + 0x40),param_1), cVar7 != '\0'))
      goto LAB_00100250;
      uVar12 = uVar12 + 1;
    } while (uVar10 != uVar12);
  }
...
LAB_0010023b:
  if (0x3ff < uVar11) goto code_r0x00100244;
  goto LAB_001001c8;
code_r0x00100244:
  embree::yield();
  goto LAB_001001b0;
...

{
  ...
  pTVar4 = pTVar2;
  while (((pTVar4 != (Thread *)0x0 && (*(long *)pTVar1 != 0)) &&
         (*(Thread **)(pTVar2 + 0xc0100) != pTVar2 + (*(long *)pTVar1 + -1) * 0x40 + 0x40))) {
    lVar3 = *(long *)pTVar1;
...
LAB_00100bc8:
        ...
        *(long *)pTVar2 = *(long *)pTVar2 + 1;
        UNLOCK();
        do {
          cVar10 = TaskQueue::execute_local_internal
                             ((TaskQueue *)(pTVar11 + 0x40),pTVar11,(Task *)0x0);
        } while (cVar10 != '\0');
        LOCK();
        *(long *)pTVar2 = *(long *)pTVar2 + -1;
        UNLOCK();
...
void embree::TaskScheduler::TaskQueue::execute_local(Thread *param_1,Task *param_2)
...
/* embree::TaskScheduler::wait() [clone .cold] */
...

{
  ...
  if (plVar2 == plVar1) {
    ...
    uVar7 = uVar7 * 8;
LAB_00101dca:
    plVar6 = (long *)operator_new(uVar7);

...
/* EditorResourcePreviewGenerator::DrawRequester::_post_semaphore() */

void EditorResourcePreviewGenerator::DrawRequester::_post_semaphore(void)
...
/* EditorResourcePreview::_update_thumbnail_sizes() [clone .part.0] */

void __thiscall EditorResourcePreview::_update_thumbnail_sizes(EditorResourcePreview *this)

{
  ...
  if ((_update_thumbnail_sizes()::{lambda()#1}::operator()()::sname == '\0') &&
     (iVar5 = __cxa_guard_acquire(&_update_thumbnail_sizes()::{lambda()#1}::operator()()::sname),
     iVar5 != 0)) {
    _scs_create((char *)&_update_thumbnail_sizes()::{lambda()#1}::operator()()::sname,true);
    __cxa_atexit(StringName::~StringName,
                 &_update_thumbnail_sizes()::{lambda()#1}::operator()()::sname,&__dso_handle);
    __cxa_guard_release(&_update_thumbnail_sizes()::{lambda()#1}::operator()()::sname);
  }
  (*pcVar2)(&local_48,pOVar6,&_update_thumbnail_sizes()::{lambda()#1}::operator()()::sname,lVar1);
...
/* List<EditorResourcePreview::QueueItem,
   DefaultAllocator>::push_back(EditorResourcePreview::QueueItem const&) [clone .isra.0] */
...
EditorResourcePreviewGenerator::DrawRequester::request_and_wait
          (DrawRequester *this,undefined8 param_2)

{
  ...
  *(char **)(pCVar6 + 0x20) = "RS::viewport_set_update_mode";
  ...
  if (cVar3 == '\0') {
    ...
    _err_print_error("request_and_wait","editor/editor_resource_preview.cpp",0x6e,
                     "Parameter \"st\" is null.",
                     "Editor\'s MainLoop is not a SceneTree. This is a bug.",0,0);
    Callable::~Callable(local_c8);
    goto LAB_00100ae0;
  }
  plVar7 = (long *)RenderingServer::get_singleton();
  pcVar2 = *(code **)(*plVar7 + 0x108);
  if (request_and_wait(RID)::{lambda()#1}::operator()()::sname == '\0') {
    iVar4 = __cxa_guard_acquire(&request_and_wait(RID)::{lambda()#1}::operator()()::sname);
    if (iVar4 != 0) {
      _scs_create((char *)&request_and_wait(RID)::{lambda()#1}::operator()()::sname,true);
      __cxa_atexit(StringName::~StringName,&request_and_wait(RID)::{lambda()#1}::operator()()::sname
                   ,&__dso_handle);
      __cxa_guard_release(&request_and_wait(RID)::{lambda()#1}::operator()()::sname);
    }
  }
  (*pcVar2)(plVar7,&request_and_wait(RID)::{lambda()#1}::operator()()::sname,local_c8,4);
  plVar7 = (long *)RenderingServer::get_singleton();
  ...
  *(int *)(this + 0x1d4) = iVar4 + 1;
  if (*(int *)(this + 0x1d0) == 0) {
    ...
    *(int *)(this + 0x1d0) = *(int *)(this + 0x1d0) + -1;
LAB_00100ccf:
    if (local_b8 != (pthread_mutex_t *)0x0) {
...
void __thiscall EditorResourcePreviewGenerator::DrawRequester::abort(DrawRequester *this)
...
/* EditorResourcePreview::is_threaded() const */

void EditorResourcePreview::is_threaded(void)
      ...
      do {
        if (uVar23 == uVar22) {
          cVar21 = String::operator==((String *)
                                      (*(long *)(*(long *)(in_RSI + 0x4b8) + lVar25 * 8) + 0x10),
                                      in_RDX);
          if (cVar21 != '\0') {
            if ((*(long *)(in_RSI + 0x4b8) != 0) && (*(int *)(in_RSI + 0x4dc) != 0)) {
              uVar1 = *(uint *)(hash_table_size_primes + (ulong)*(uint *)(in_RSI + 0x4d8) * 4);
              ...
              if (uVar22 != 0) {
                ...
                do {
                  if (uVar23 == uVar22) {
                    cVar21 = String::operator==((String *)
                                                (*(long *)(*(long *)(in_RSI + 0x4b8) + lVar25 * 8) +
                                                0x10),in_RDX);
                    if (cVar21 != '\0') {
                      Dictionary::Dictionary
                                ((Dictionary *)param_1,
                                 (Dictionary *)
                                 (*(long *)(*(long *)(in_RSI + 0x4b8) + (ulong)uVar27 * 8) + 0x28));
                      return param_1;
                    }
                    lVar26 = *(long *)(in_RSI + 0x4c0);
                  }
                  ...
                  uVar27 = SUB164(auVar8 * auVar16,8);
                        ...
                        auVar18._8_8_ = 0, auVar18._0_8_ = uVar20,
        ...
        iVar24 = SUB164(auVar4 * auVar12,8);
              ...
              auVar14._8_8_ = 0, auVar14._0_8_ = uVar20, uVar27 <= SUB164(auVar6 * auVar14,8)));
    }
  }
  _err_print_error("get_preview_metadata","editor/editor_resource_preview.cpp",0x105,
                   "Condition \"!cache.has(p_path)\" is true. Returning: Dictionary()",0,0);
      ...
      do {
        if (uVar15 == uVar14) {
          cVar12 = String::operator==((String *)
                                      (*(long *)(*(long *)(in_RSI + 0x4b8) + lVar17 * 8) + 0x10),
                                      in_RDX);
          if (cVar12 != '\0') {
...
void __thiscall EditorResourcePreview::EditorResourcePreview(EditorResourcePreview *this)
...
void __thiscall EditorResourcePreview::start(EditorResourcePreview *this)

{
  ...
  if (cVar1 == '\0') {
    ...
    if (cVar1 == '\0') {
      ...
      _err_print_error("start","editor/editor_resource_preview.cpp",0x237,
                       "Parameter \"st\" is null.",
                       "Editor\'s MainLoop is not a SceneTree. This is a bug.",0,0);
    }
    else {
      ...
      if (cVar1 == '\0') {
        ...
        _err_print_error("start","editor/editor_resource_preview.cpp",0x233,
                         "Condition \"thread.is_started()\" is true.","Thread already started.",0,0)
        ;
      }
    }
  }
...
void __thiscall
EditorResourcePreview::_read_preview_cache
          (undefined8 param_1,undefined8 *param_2,undefined4 *param_3,undefined8 param_4,
          undefined8 *param_5,CowData<char32_t> *param_6,Dictionary *param_7,undefined8 param_8)
...
EditorResourcePreview::_preview_ready
          (EditorResourcePreview *this,String *param_1,undefined4 param_2,undefined8 *param_3,
          undefined8 *param_4,undefined8 param_6,undefined8 param_7,Variant *param_8,
          Dictionary *param_9)

{
  ...
  if (cVar5 == '\0') {
    ...
    local_1a8 = uVar7;
    if ((cVar5 != '\0') &&
       (local_1a8 = FileAccess::get_modified_time((String *)local_138), local_1a8 <= uVar7)) {
      local_1a8 = uVar7;
    }
  ...
  this_00 = (Ref<Texture2D> *)
            HashMap<String,EditorResourcePreview::Item,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorResourcePreview::Item>>>
            ::operator[]((HashMap<String,EditorResourcePreview::Item,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorResourcePreview::Item>>>
                          *)(this + 0x4b0),param_1);
  ...
  *(ulong *)(this_00 + 0x20) = local_118;
  Dictionary::~Dictionary(local_128);
  if ((local_138._8_8_ != 0) && (cVar5 = RefCounted::unreference(), cVar5 != '\0')) {
  ...
  if ((local_138._0_8_ != 0) && (cVar5 = RefCounted::unreference(), cVar5 != '\0')) {
...
EditorResourcePreview::queue_resource_preview
          (EditorResourcePreview *this,String *param_1,Object *param_2,StringName *param_3,
          Variant *param_4)

{
  ...
  *this_00;
  ...
  if (param_2 == (Object *)0x0) {
    if (local_40[0] == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error("queue_resource_preview","editor/editor_resource_preview.cpp",0x1e1,
                       "Parameter \"p_receiver\" is null.",0,0);
      return;
    }
LAB_001023c2:
                    /* WARNING: Subroutine does not return */
...
LAB_001023bb:
  ...
  this_00 = (HashMap<String,EditorResourcePreview::Item,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorResourcePreview::Item>>>
             *)(this + 0x4b0);
  local_158[0] = 0;
  cVar3 = HashMap<String,EditorResourcePreview::Item,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorResourcePreview::Item>>>
          ::_lookup_pos(this_00,param_1,local_158);
  if (cVar3 == '\0') {
    local_a8 = 0;
    ...
    List<EditorResourcePreview::QueueItem,DefaultAllocator>::push_back
              ((List<EditorResourcePreview::QueueItem,DefaultAllocator> *)(this + 0x408),
               (QueueItem *)local_b8);
    ...
    if ((local_b8._0_8_ != 0) && (cVar3 = RefCounted::unreference(), cVar3 != '\0')) {
    ...
    *(int *)(this + 0x490) = *(int *)(this + 0x490) + 1;
    ...
    lVar5 = HashMap<String,EditorResourcePreview::Item,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorResourcePreview::Item>>>
    ...
    (**(code **)(*(long *)param_2 + 0x68))
              ((Variant *)local_108,param_2,param_3,&local_e8,4,local_158);
    if (local_158[0] == 0) {
...
void __thiscall
HashMap<String,EditorResourcePreview::Item,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorResourcePreview::Item>>>
::erase(HashMap<String,EditorResourcePreview::Item,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorResourcePreview::Item>>>
        *this,String *param_1)
...
LAB_00102522:
  ...
  if ((plVar32[4] != 0) && (cVar27 = RefCounted::unreference(), cVar27 != '\0')) {
...
void __thiscall
EditorResourcePreview::check_for_invalidation(EditorResourcePreview *this,String *param_1)

{
  ...
  *this_00;
  ...
  cVar1 = HashMap<String,EditorResourcePreview::Item,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorResourcePreview::Item>>>
  ...
  if (cVar1 != '\0') {
    ...
    local_d0 = uVar3;
    if ((cVar1 != '\0') &&
       (local_d0 = FileAccess::get_modified_time((String *)&local_b8), local_d0 <= uVar3)) {
      local_d0 = uVar3;
    }
    lVar4 = HashMap<String,EditorResourcePreview::Item,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorResourcePreview::Item>>>
            ::operator[](this_00,param_1);
    if (*(ulong *)(lVar4 + 0x20) != local_d0) {
      ...
      if ((check_for_invalidation(String_const&)::{lambda()#1}::operator()()::sname == '\0') &&
         (iVar2 = __cxa_guard_acquire(&check_for_invalidation(String_const&)::{lambda()#1}::
                                       operator()()::sname), iVar2 != 0)) {
        _scs_create((char *)&check_for_invalidation(String_const&)::{lambda()#1}::operator()()::
                             sname,true);
        __cxa_atexit(StringName::~StringName,
                     &check_for_invalidation(String_const&)::{lambda()#1}::operator()()::sname,
                     &__dso_handle);
        __cxa_guard_release(&check_for_invalidation(String_const&)::{lambda()#1}::operator()()::
                             sname);
      }
                    /* WARNING: Subroutine does not return */
...
EditorResourcePreview::queue_edited_resource_preview
          (EditorResourcePreview *this,Ref *param_1,Object *param_2,StringName *param_3,
          Variant *param_4)
...
LAB_00102f49:
      _err_print_error("queue_edited_resource_preview","editor/editor_resource_preview.cpp",uVar10,
                       pcVar9,0,0);
      return;
    }
LAB_00102ffd:
  ...
  if (iVar5 == 0) {
    this_00 = (HashMap<String,EditorResourcePreview::Item,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorResourcePreview::Item>>>
               *)(this + 0x4b0);
    itos((long)local_158);
    operator+((char *)&local_178,(String *)&_LC66);
    CowData<char32_t>::_unref((CowData<char32_t> *)local_158);
    local_158[0] = 0;
    cVar4 = HashMap<String,EditorResourcePreview::Item,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorResourcePreview::Item>>>
            ::_lookup_pos(this_00,(String *)&local_178,(uint *)local_158);
    if (cVar4 != '\0') {
      lVar7 = HashMap<String,EditorResourcePreview::Item,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorResourcePreview::Item>>>
              ::operator[](this_00,(String *)&local_178);
      ...
      if (iVar5 == iVar6) {
        ...
        pVStack_d0 = local_70;
        (**(code **)(*(long *)param_2 + 0x68))
                  ((Variant *)local_108,param_2,param_3,&local_e8,4,(CowData<char32_t> *)local_158);
        if (local_158[0] == 0) {
          Variant::Variant((Variant *)local_128,(Variant *)local_108);
        }
        else {
    ...
    HashMap<String,EditorResourcePreview::Item,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorResourcePreview::Item>>>
    ::erase(this_00,(String *)&local_178);
    local_b8 = (undefined1  [16])0x0;
    local_a8 = 0;
    local_a0 = 0;
    local_98[0] = 0;
    ...
    if (pOVar2 != (Object *)local_b8._0_8_) {
      ...
      if ((((Object *)uVar10 != (Object *)0x0) && (cVar4 = RefCounted::unreference(), cVar4 != '\0')
          ) && (cVar4 = predelete_handler((Object *)uVar10), cVar4 != '\0')) {
    ...
    CowData<char32_t>::_unref((CowData<char32_t> *)(local_b8 + 8));
    if ((local_b8._0_8_ != 0) && (cVar4 = RefCounted::unreference(), cVar4 != '\0')) {
      uVar10 = local_b8._0_8_;
...

{
  ...
  local_68 = (char **)0x0;
  pMVar10 = create_method_bind<EditorResourcePreview,String_const&,Object*,StringName_const&,Variant_const&>
  ...
  auStack_60 = (undefined1  [16])0x0;
  local_68 = (char **)0x0;
  pMVar10 = create_method_bind<EditorResourcePreview,Ref<Resource>const&,Object*,StringName_const&,Variant_const&>
  ...
  auStack_60 = (undefined1  [16])0x0;
  local_68 = (char **)0x0;
  pMVar10 = create_method_bind<EditorResourcePreview,Ref<EditorResourcePreviewGenerator>const&>
  ...
  PropertyInfo::PropertyInfo
            (local_168,4,(StrRange *)&local_198,0,(StrRange *)&local_190,6,&local_188);
  local_180 = 0;
    ...
    *(undefined8 *)(this + 0x1d8) = 0;
    ...
    if (((pcVar5 == (code *)0x0) || (*(long *)(lVar3 + 0xe0) == 0)) &&
      ...
      if (local_f0[0] == 0) {
        ...
        if ((StringName::configured != '\0') && (lVar3 = 0, local_100 != 0)) goto LAB_00104038;
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_108);
LAB_0010404d:
        lVar3 = *(long *)(this + 8);
        pcVar5 = *(code **)(lVar3 + 200);
        if (((pcVar5 == (code *)0x0) || (*(long *)(lVar3 + 0xe0) == 0)) &&
           (pcVar5 = *(code **)(lVar3 + 0xc0), pcVar5 == (code *)0x0)) goto LAB_00103f90;
  ...
  if (pcVar5 != (code *)0x0) {
    if (*(code **)(*(long *)(this + 8) + 0xe0) == (code *)0x0) {
      ...
      (**(code **)(*(long *)(this + 8) + 0xe0))
                (*(undefined8 *)(this + 0x10),this + 0x1c8,pcVar5,0,local_c8);
      bVar6 = local_c8[0]._0_1_ != (String)0x0;
    }
  }
LAB_00103e07:
...
bool __thiscall
EditorResourcePreviewGenerator::can_generate_small_preview(EditorResourcePreviewGenerator *this)
  ...
  if ((*(long *)(this + 8) != 0) && (this[0x1e8] == (EditorResourcePreviewGenerator)0x0)) {
    ...
    *(undefined8 *)(this + 0x1f0) = 0;
    ...
    if (((pcVar5 == (code *)0x0) || (*(long *)(lVar3 + 0xe0) == 0)) &&
      ...
      if (local_f0[0] == 0) {
        CowData<unsigned_int>::_unref((CowData<unsigned_int> *)local_f0);
        if ((StringName::configured != '\0') && (lVar3 = 0, local_100 != 0)) goto LAB_00104418;
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_108);
LAB_0010442d:
        lVar3 = *(long *)(this + 8);
        pcVar5 = *(code **)(lVar3 + 200);
        if (((pcVar5 == (code *)0x0) || (*(long *)(lVar3 + 0xe0) == 0)) &&
           (pcVar5 = *(code **)(lVar3 + 0xc0), pcVar5 == (code *)0x0)) goto LAB_00104370;
...
LAB_00105983:
  ...
  local_100 = 0;
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_e8,0x18,(StrRange *)&local_100,0x11,
             (CowData<char32_t> *)&local_108,6,(StrRange *)&local_110);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_100);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_108);
...
String * EditorResourcePreviewGenerator::generate_from_path
...
LAB_00105cd5:
    ...
    if ((*(long *)(param_2 + 8) != 0) && (param_2[0x1b8] == (Vector2)0x0)) {
      ...
      GetTypeInfo<Ref<Texture2D>,void>::get_class_info
                ((GetTypeInfo<Ref<Texture2D>,void> *)&local_178);
...
LAB_00106330:
          ...
          if (((pcVar8 == (code *)0x0) || (*(long *)(lVar5 + 0xe0) == 0)) &&
             (pcVar8 = *(code **)(lVar5 + 0xc0), pcVar8 == (code *)0x0)) goto LAB_0010620b;
...
LAB_0010620b:
    ...
    if (*(long *)(param_2 + 0x1c0) != 0) {
      ...
      if (*(code **)(*(long *)(param_2 + 8) + 0xe0) == (code *)0x0) {
        (**(code **)(param_2 + 0x1c0))
                  (*(undefined8 *)(param_2 + 0x10),&local_88,(StrRange *)&local_178);
      }
      else {
        (**(code **)(*(long *)(param_2 + 8) + 0xe0))
                  (*(undefined8 *)(param_2 + 0x10),param_2 + 0x1b0,*(undefined8 *)(param_2 + 0x1c0),
                   &local_88,(StrRange *)&local_178);
      }
      local_148 = 0;
      uStack_144 = 0;
    ...
    if ((CONCAT44(uStack_144,local_148) == 0) || (cVar3 = RefCounted::unreference(), cVar3 == '\0'))
    goto LAB_00105da8;
    ...
    if ((lVar5 == 0) ||
       (pRVar6 = (Ref *)__dynamic_cast(lVar5,&Object::typeinfo,&Texture2D::typeinfo,0),
       pRVar6 == (Ref *)0x0)) {
      pRVar6 = (Ref *)0x0;
    }
    else {
...

{
  ...
  if (plVar7 == (long *)0x0) {
LAB_00106567:
    if ((*(long *)(param_2 + 8) != 0) && (param_2[0x1a0] == (Vector2)0x0)) {
      local_148 = 0;
      uStack_144 = 0;
      local_138 = (undefined1  [16])0x0;
      uStack_140 = 0;
...
LAB_00106bf2:
          ...
          if (((pcVar8 == (code *)0x0) || (*(long *)(lVar4 + 0xe0) == 0)) &&
             (pcVar8 = *(code **)(lVar4 + 0xc0), pcVar8 == (code *)0x0)) goto LAB_00106ab8;
...
LAB_00106ab8:
    ...
    if (*(long *)(param_2 + 0x1a8) == 0) {
      ...
      Dictionary::~Dictionary(local_190);
      _err_print_error("generate","editor/editor_resource_preview.cpp",0x3c,
                       "Method/function failed. Returning: Ref<Texture2D>()",
                       "EditorResourcePreviewGenerator::_generate needs to be overridden.",0,0);
      *(undefined8 *)param_1 = 0;
      pOVar9 = local_198;
      goto LAB_001065db;
    }
    if ((pOVar9 == (Object *)0x0) ||
       (local_188 = pOVar9, cVar2 = RefCounted::reference(), cVar2 == '\0')) {
      local_188 = (Object *)0x0;
    }
    local_a8[0] = local_d0;
    Dictionary::Dictionary((Dictionary *)&local_180,local_190);
    ...
    if (*(code **)(*(long *)(param_2 + 8) + 0xe0) == (code *)0x0) {
      (**(code **)(param_2 + 0x1a8))
                (*(undefined8 *)(param_2 + 0x10),&local_88,(Ref<Texture2D> *)&local_178);
    }
    else {
      (**(code **)(*(long *)(param_2 + 8) + 0xe0))
                (*(undefined8 *)(param_2 + 0x10),param_2 + 0x198,*(undefined8 *)(param_2 + 0x1a8),
                 &local_88,(Ref<Texture2D> *)&local_178);
    }
    local_148 = 0;
    uStack_144 = 0;
    ...
    if ((lVar4 == 0) ||
       (pRVar5 = (Ref *)__dynamic_cast(lVar4,&Object::typeinfo,&Texture2D::typeinfo,0),
       pRVar5 == (Ref *)0x0)) {
      pRVar5 = (Ref *)0x0;
    }
    else {
...
/* EditorResourcePreviewGenerator::handles(String const&) const */

ulong __thiscall
EditorResourcePreviewGenerator::handles(EditorResourcePreviewGenerator *this,String *param_1)

{
  ...
  if (plVar5 == (long *)0x0) {
LAB_00106d95:
    if ((*(long *)(this + 8) != 0) && (this[0x188] == (EditorResourcePreviewGenerator)0x0)) {
      unaff_R12 = local_128;
      local_f8[0] = 0;
      local_f8[1] = 0;
...
LAB_0010712e:
          ...
          if (((pcVar6 == (code *)0x0) || (*(long *)(lVar4 + 0xe0) == 0)) &&
             (pcVar6 = *(code **)(lVar4 + 0xc0), pcVar6 == (code *)0x0)) goto LAB_00107046;
...
LAB_00107046:
    ...
    if (*(long *)(this + 400) == 0) {
      uVar7 = 0;
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_140);
      _err_print_error("handles","editor/editor_resource_preview.cpp",0x34,
                       "Method/function failed. Returning: false",
                       "EditorResourcePreviewGenerator::_handles needs to be overridden.",0,0);
      goto LAB_00106de6;
    }
    local_f8[0] = 0;
    local_f8[1] = 0;
...
/* CowData<Ref<EditorResourcePreviewGenerator> >::_copy_on_write() [clone .isra.0] */

void __thiscall
CowData<Ref<EditorResourcePreviewGenerator>>::_copy_on_write
          (CowData<Ref<EditorResourcePreviewGenerator>> *this)
...
/* EditorResourcePreview::_generate_preview(Ref<ImageTexture>&, Ref<ImageTexture>&,
   EditorResourcePreview::QueueItem const&, String const&, Dictionary&) */

void __thiscall
EditorResourcePreview::_generate_preview
          (EditorResourcePreview *this,Ref *param_1,Ref *param_2,QueueItem *param_3,String *param_4,
          Dictionary *param_5)

{
  ...
  if ((local_80 == (Image *)0x0) || (*(uint *)(local_80 + -8) < 2)) {
    ...
    vformat<String,unsigned_long>
              ((String *)&local_68,(String *)&local_78,(CowData<char32_t> *)&local_70,lVar7 - lVar6)
    ;
...
LAB_00107bd3:
    ...
    pQVar12 = param_3 + 8;
LAB_001076e2:
    (*pcVar9)((CowData<char32_t> *)&local_60,plVar5,pQVar12);
...
LAB_00107d23:
      _err_print_index_error
                ("get","./core/templates/cowdata.h",0xdb,lVar16,lVar15,"p_index","size()","",false,
                 true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
      pcVar9 = (code *)invalidInstructionException();
    ...
    if ((lVar14 == 0) && (*(long *)param_1 != 0)) {
      ...
      if (local_68 == 0) {
        ...
        if (local_70 != pIVar10) {
          local_60 = local_70;
          local_70 = pIVar10;
          if ((pIVar10 != (Image *)0x0) && (cVar3 = RefCounted::reference(), cVar3 == '\0')) {
            local_70 = (Image *)0x0;
          }
LAB_00107b3b:
      ...
      if ((local_70 != (Image *)0x0) && (cVar3 = RefCounted::unreference(), cVar3 != '\0')) {
...
LAB_001077aa:
    ...
    Ref<Texture2D>::unref((Ref<Texture2D> *)&local_78);
LAB_00107c27:
    if ((*(long *)param_3 == 0) && (*(long *)param_1 != 0)) {
      local_70 = (Image *)0x0;
      lVar7 = *(long *)param_2;
      ...
      local_60 = (Image *)0x0;
      if ((*(long *)param_1 != 0) &&
         ((pIVar10 = (Image *)__dynamic_cast(*(long *)param_1,&Object::typeinfo,&Resource::typeinfo)
          , pIVar10 != (Image *)0x0 &&
          (local_60 = pIVar10, cVar3 = RefCounted::reference(), cVar3 == '\0')))) {
        local_60 = (Image *)0x0;
      }
      ...
      if (lVar7 != 0) {
        ...
        local_60 = (Image *)0x0;
        if (((*(long *)param_2 != 0) &&
            (pIVar10 = (Image *)__dynamic_cast(*(long *)param_2,&Object::typeinfo,
                                               &Resource::typeinfo), pIVar10 != (Image *)0x0)) &&
           (local_60 = pIVar10, cVar3 = RefCounted::reference(), cVar3 == '\0')) {
          local_60 = (Image *)0x0;
        }
        ResourceSaver::save((Ref *)&local_60,(String *)&local_68,0);
      ...
      if (local_78 == (Ref *)0x0) {
        ...
        operator+((char *)&local_70,(String *)"Cannot create file \'");
        pSVar13 = (String *)&local_70;
        String::operator+((String *)&local_60,(String *)&local_70);
        _err_print_error("_generate_preview","editor/editor_resource_preview.cpp",0xf3,
                         "Condition \"f.is_null()\" is true.",(CowData<char32_t> *)&local_60,0,0,
                         pSVar13);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_70);
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_68);
      ...
      local_f0 = uVar11;
      if ((cVar3 != '\0') &&
         (local_f0 = FileAccess::get_modified_time((String *)&local_70), local_f0 <= uVar11)) {
        local_f0 = uVar11;
      }
      ...
      _write_preview_cache
                (this,(CowData<char32_t> *)&local_60,iVar4,lVar7 != 0,local_f0,(String *)&local_68,
                 param_5);
...
void __thiscall EditorResourcePreview::_iterate(EditorResourcePreview *this)

{
  ...
  if (((long *)*plVar1 != (long *)0x0) &&
     (local_78 = (long *)*plVar1, cVar3 = RefCounted::reference(), cVar3 == '\0')) {
    local_78 = (long *)0x0;
  }
  local_70 = 0;
  ...
  cVar3 = HashMap<String,EditorResourcePreview::Item,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorResourcePreview::Item>>>
          ::_lookup_pos((HashMap<String,EditorResourcePreview::Item,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorResourcePreview::Item>>>
                         *)(this + 0x4b0),(String *)&local_70,(uint *)&local_c8);
  if (cVar3 == '\0') {
    pthread_mutex_unlock(__mutex);
    local_140 = (Ref *)0x0;
    ...
    if (local_78 != (long *)0x0) {
      ...
      local_c8 = (long *)0x0;
      _generate_preview(this,(Ref *)&local_140,(Ref *)&local_138,(QueueItem *)&local_78,
                        (String *)&local_c8,(Dictionary *)&local_d8);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_c8);
      pOVar8 = local_138;
      local_c8 = (long *)0x0;
      if (((local_138 != (Object *)0x0) &&
          (lVar6 = __dynamic_cast(local_138,&Object::typeinfo,&Texture2D::typeinfo,0), lVar6 != 0))
         && (local_c8 = (long *)lVar6, cVar3 = RefCounted::reference(), cVar3 == '\0')) {
        local_c8 = (long *)0x0;
      }
      local_d0 = 0;
      if (((local_140 != (Ref *)0x0) &&
          (lVar6 = __dynamic_cast(local_140,&Object::typeinfo,&Texture2D::typeinfo,0), lVar6 != 0))
         && (local_d0 = lVar6, cVar3 = RefCounted::reference(), cVar3 == '\0')) {
        local_d0 = 0;
      }
      uVar5 = (**(code **)(*local_78 + 0x1a8))();
      _preview_ready(this,(CowData<char32_t> *)&local_70,uVar5,(Ref<Texture2D> *)&local_d0,
                     (String *)&local_c8,local_68,local_60,local_58,(Dictionary *)&local_d8);
    ...
    String::md5_text();
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_c8);
    operator+((char *)&local_d0,(String *)"resthumb-");
...
LAB_001089cf:
      ...
      if ((cVar3 != '\0') && (uVar10 = FileAccess::get_modified_time(local_108), uVar7 < uVar10)) {
        uVar7 = uVar10;
      }
      local_f8 = 0;
      local_c8 = (long *)0x0;
      ...
      _read_preview_cache(this,(String *)&local_c8,&local_144,&local_146,&local_100,
                          (CowData<char32_t> *)&local_f8,local_130,&local_145);
...
LAB_00108960:
      ...
      if (local_100 == uVar7) {
        ...
        if (local_e0 == (String *)0x0) {
          ...
          operator+((char *)&local_d8,(String *)"Cannot create file \'");
          String::operator+((String *)&local_c8,(String *)&local_d8);
          _err_print_error("_iterate","editor/editor_resource_preview.cpp",0x15a,(String *)&local_c8
                           ,0,0);
          CowData<char32_t>::_unref((CowData<char32_t> *)&local_c8);
          ...
          _write_preview_cache
                    (this,(String *)&local_c8,(int)((float)iVar4 * fVar12),cVar3,uVar7,local_e8,
                     local_130);
          Ref<FileAccess>::unref((Ref<FileAccess> *)&local_c8);
        }
...
LAB_00108dca:
    ...
    local_d0 = 0;
    if (((local_170 != (Ref *)0x0) &&
        (lVar6 = __dynamic_cast(local_170,&Object::typeinfo,&Texture2D::typeinfo,0), lVar6 != 0)) &&
       (local_d0 = lVar6, cVar3 = RefCounted::reference(), cVar3 == '\0')) {
      local_d0 = 0;
    }
    _preview_ready(this,(CowData<char32_t> *)&local_70,0,(CowData<char32_t> *)&local_d0,
                   (String *)&local_c8,local_68,local_60,local_58,local_130);
    Ref<Texture2D>::unref((Ref<Texture2D> *)&local_d0);
    Ref<Texture2D>::unref((Ref<Texture2D> *)&local_c8);
    Ref<FileAccess>::unref((Ref<FileAccess> *)&local_110);
    ...
    puVar9 = (undefined8 *)
             HashMap<String,EditorResourcePreview::Item,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorResourcePreview::Item>>>
             ::operator[]((HashMap<String,EditorResourcePreview::Item,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorResourcePreview::Item>>>
                           *)(this + 0x4b0),(String *)&local_70);
    local_c8 = (long *)0x0;
    Ref<Texture2D>::operator=((Ref<Texture2D> *)&local_c8,(Ref *)*puVar9);
    local_c0 = 0;
    Ref<Texture2D>::operator=((Ref<Texture2D> *)&local_c0,(Ref *)puVar9[1]);
    Dictionary::Dictionary(local_b8,(Dictionary *)(puVar9 + 2));
    local_b0 = *(undefined4 *)(puVar9 + 3);
    local_a8 = puVar9[4];
    _preview_ready(this,(CowData<char32_t> *)&local_70,local_b0,(String *)&local_c8,
                   (Ref<Texture2D> *)&local_c0,local_68,local_60,local_58,local_b8);
    pthread_mutex_unlock(__mutex);
...
/* EditorResourcePreview::_thread() */

void __thiscall EditorResourcePreview::_thread(EditorResourcePreview *this)
...
/* EditorResourcePreview::_thread_func(void*) */

void EditorResourcePreview::_thread_func(void *param_1)
...
/* EditorResourcePreview::_idle_callback() */

void EditorResourcePreview::_idle_callback(void)
...
/* WARNING: Removing unreachable block (ram,0x00109307) */
/* WARNING: Removing unreachable block (ram,0x001092b0) */
/* WARNING: Removing unreachable block (ram,0x001092b5) */
/* WARNING: Removing unreachable block (ram,0x00109318) */
/* WARNING: Removing unreachable block (ram,0x001092bf) */
/* EditorResourcePreview::stop() */

void __thiscall EditorResourcePreview::stop(EditorResourcePreview *this)

{
  ...
  if ((cVar2 == '\0') || (cVar2 = Thread::is_started(), cVar2 == '\0')) {
    return;
  }
  ...
  *(int *)(this + 0x490) = *(int *)(this + 0x490) + 1;
  ...
  for (lVar6 = 0; (lVar4 != 0 && (lVar6 < *(long *)(lVar4 + -8))); lVar6 = lVar6 + 1) {
    CowData<Ref<EditorResourcePreviewGenerator>>::_copy_on_write
              ((CowData<Ref<EditorResourcePreviewGenerator>> *)(this + 0x4f0));
    lVar4 = *(long *)(this + 0x4f0);
...
/* EditorResourcePreview::_notification(int) */

void __thiscall EditorResourcePreview::_notification(EditorResourcePreview *this,int param_1)
...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_001139b8;
  stop(this);
  CowData<Ref<EditorResourcePreviewGenerator>>::_unref
            ((CowData<Ref<EditorResourcePreviewGenerator>> *)(this + 0x4f0));
...
/* EditorResourcePreview::remove_preview_generator(Ref<EditorResourcePreviewGenerator> const&) */

void __thiscall
EditorResourcePreview::remove_preview_generator(EditorResourcePreview *this,Ref *param_1)
  ...
  if ((lVar1 != 0) && (lVar6 = *(long *)(lVar1 + -8), 0 < lVar6)) {
    ...
    do {
      if (*(long *)param_1 == *(long *)(lVar1 + lVar5 * 8)) {
        ...
        CowData<Ref<EditorResourcePreviewGenerator>>::resize<false>
                  ((CowData<Ref<EditorResourcePreviewGenerator>> *)(this + 0x4f0),lVar6);
        return;
      }
      lVar5 = lVar5 + 1;
    } while (lVar6 != lVar5);
...
/* EditorResourcePreview::add_preview_generator(Ref<EditorResourcePreviewGenerator> const&) */

void __thiscall
EditorResourcePreview::add_preview_generator(EditorResourcePreview *this,Ref *param_1)

{
  ...
  iVar4 = CowData<Ref<EditorResourcePreviewGenerator>>::resize<false>
                    ((CowData<Ref<EditorResourcePreviewGenerator>> *)(this + 0x4f0),lVar6);
  if (iVar4 == 0) {
    if (*(long *)(this + 0x4f0) == 0) {
      lVar7 = -1;
        ...
        if (pOVar2 != pOVar5) {
          *puVar1 = pOVar5;
          if (pOVar5 == (Object *)0x0) {
            ...
            if (((pOVar2 == (Object *)0x0) || (cVar3 = RefCounted::unreference(), cVar3 == '\0')) ||
               (cVar3 = predelete_handler(pOVar2), cVar3 == '\0')) goto LAB_001099cd;
          }
          (**(code **)(*(long *)pOVar2 + 0x140))(pOVar2);
          Memory::free_static(pOVar2,false);
        }
...
{
  return (uint)CONCAT71(0x113e,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr) |
...
/* EditorResourcePreviewGenerator::is_class_ptr(void*) const */

uint __thiscall
EditorResourcePreviewGenerator::is_class_ptr(EditorResourcePreviewGenerator *this,void *param_1)

{
  return (uint)CONCAT71(0x113e,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x113e,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
...
/* EditorResourcePreviewGenerator::_getv(StringName const&, Variant&) const */

undefined8 EditorResourcePreviewGenerator::_getv(StringName *param_1,Variant *param_2)
...
/* EditorResourcePreviewGenerator::_setv(StringName const&, Variant const&) */

undefined8 EditorResourcePreviewGenerator::_setv(StringName *param_1,Variant *param_2)
...
/* EditorResourcePreviewGenerator::_validate_propertyv(PropertyInfo&) const */

void EditorResourcePreviewGenerator::_validate_propertyv(PropertyInfo *param_1)
...
/* EditorResourcePreviewGenerator::_property_can_revertv(StringName const&) const */

undefined8 EditorResourcePreviewGenerator::_property_can_revertv(StringName *param_1)
...
/* EditorResourcePreviewGenerator::_property_get_revertv(StringName const&, Variant&) const */

undefined8
EditorResourcePreviewGenerator::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* EditorResourcePreviewGenerator::_notificationv(int, bool) */

void EditorResourcePreviewGenerator::_notificationv(int param_1,bool param_2)
...
/* EditorResourcePreview::is_class_ptr(void*) const */

uint __thiscall EditorResourcePreview::is_class_ptr(EditorResourcePreview *this,void *param_1)

{
  return (uint)CONCAT71(0x113e,(undefined4 *)param_1 == &Node::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x113e,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x113e,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}
...
/* EditorResourcePreview::_getv(StringName const&, Variant&) const */

undefined8 EditorResourcePreview::_getv(StringName *param_1,Variant *param_2)
...
/* EditorResourcePreview::_setv(StringName const&, Variant const&) */

undefined8 EditorResourcePreview::_setv(StringName *param_1,Variant *param_2)
...
/* EditorResourcePreview::_property_can_revertv(StringName const&) const */

undefined8 EditorResourcePreview::_property_can_revertv(StringName *param_1)
...
/* EditorResourcePreview::_property_get_revertv(StringName const&, Variant&) const */

undefined8 EditorResourcePreview::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* CallableCustomMethodPointer<EditorResourcePreviewGenerator::DrawRequester,
   Variant>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<EditorResourcePreviewGenerator::DrawRequester,Variant>::
~CallableCustomMethodPointer
          (CallableCustomMethodPointer<EditorResourcePreviewGenerator::DrawRequester,Variant> *this)
...
/* CallableCustomMethodPointer<RenderingServer, void, RID,
   RenderingServer::ViewportUpdateMode>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<RenderingServer,void,RID,RenderingServer::ViewportUpdateMode>::
~CallableCustomMethodPointer
          (CallableCustomMethodPointer<RenderingServer,void,RID,RenderingServer::ViewportUpdateMode>
           *this)
...
/* MethodBindT<Ref<EditorResourcePreviewGenerator> const&>::_gen_argument_type(int) const */

byte __thiscall
MethodBindT<Ref<EditorResourcePreviewGenerator>const&>::_gen_argument_type
          (MethodBindT<Ref<EditorResourcePreviewGenerator>const&> *this,int param_1)
...
/* MethodBindT<Ref<EditorResourcePreviewGenerator> const&>::get_argument_meta(int) const */

undefined8 MethodBindT<Ref<EditorResourcePreviewGenerator>const&>::get_argument_meta(int param_1)
...
MethodBindT<Ref<Resource>const&,Object*,StringName_const&,Variant_const&>::_gen_argument_type
          (MethodBindT<Ref<Resource>const&,Object*,StringName_const&,Variant_const&> *this,
          int param_1)

{
  ...
  uVar1 = 0;
  if (((uint)param_1 < 4) && (uVar1 = 0x18, 1 < (uint)param_1)) {
    uVar1 = 0x15;
    if (param_1 != 2) {
      uVar1 = 0;
    }
...
undefined8
MethodBindT<Ref<Resource>const&,Object*,StringName_const&,Variant_const&>::get_argument_meta
          (int param_1)
...
undefined8 __thiscall
MethodBindT<String_const&,Object*,StringName_const&,Variant_const&>::_gen_argument_type
          (MethodBindT<String_const&,Object*,StringName_const&,Variant_const&> *this,int param_1)

{
  undefined8 uVar1;
  
  uVar1 = 0;
  if (((((uint)param_1 < 4) && (uVar1 = 4, param_1 != 0)) && (uVar1 = 0x18, param_1 != 1)) &&
     (uVar1 = 0x15, param_1 != 2)) {
    uVar1 = 0;
  }
  return uVar1;
}
...
undefined8
MethodBindT<String_const&,Object*,StringName_const&,Variant_const&>::get_argument_meta(int param_1)
...
/* CallableCustomMethodPointer<EditorResourcePreviewGenerator::DrawRequester,
   Variant>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<EditorResourcePreviewGenerator::DrawRequester,Variant>::
get_argument_count(CallableCustomMethodPointer<EditorResourcePreviewGenerator::DrawRequester,Variant>
                   *this,bool *param_1)
...
/* CallableCustomMethodPointer<RenderingServer, void, RID,
   RenderingServer::ViewportUpdateMode>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<RenderingServer,void,RID,RenderingServer::ViewportUpdateMode>::
get_argument_count(CallableCustomMethodPointer<RenderingServer,void,RID,RenderingServer::ViewportUpdateMode>
                   *this,bool *param_1)
...
/* MethodBindT<String const&, Object*, StringName const&, Variant const&>::~MethodBindT() */

void __thiscall
MethodBindT<String_const&,Object*,StringName_const&,Variant_const&>::~MethodBindT
          (MethodBindT<String_const&,Object*,StringName_const&,Variant_const&> *this)
...
/* MethodBindT<Ref<Resource> const&, Object*, StringName const&, Variant const&>::~MethodBindT() */

void __thiscall
MethodBindT<Ref<Resource>const&,Object*,StringName_const&,Variant_const&>::~MethodBindT
          (MethodBindT<Ref<Resource>const&,Object*,StringName_const&,Variant_const&> *this)
...
/* MethodBindT<Ref<EditorResourcePreviewGenerator> const&>::~MethodBindT() */

void __thiscall
MethodBindT<Ref<EditorResourcePreviewGenerator>const&>::~MethodBindT
          (MethodBindT<Ref<EditorResourcePreviewGenerator>const&> *this)
...
/* EditorResourcePreview::_validate_propertyv(PropertyInfo&) const */

void EditorResourcePreview::_validate_propertyv(PropertyInfo *param_1)
...
/* EditorResourcePreview::_update_thumbnail_sizes() [clone .part.0] [clone .cold] */

void EditorResourcePreview::_update_thumbnail_sizes(void)
...
/* EditorResourcePreview::_bind_methods() [clone .cold] */
...
/* CowData<Ref<EditorResourcePreviewGenerator> >::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<Ref<EditorResourcePreviewGenerator>>::_copy_on_write(void)
...
/* CallableCustomMethodPointer<RenderingServer, void, RID,
   RenderingServer::ViewportUpdateMode>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<RenderingServer,void,RID,RenderingServer::ViewportUpdateMode>::
get_object(CallableCustomMethodPointer<RenderingServer,void,RID,RenderingServer::ViewportUpdateMode>
           *this)
...
/* EditorResourcePreviewGenerator::_get_class_namev() const */

undefined8 * EditorResourcePreviewGenerator::_get_class_namev(void)
...
LAB_0010a933:
  ...
  StringName::assign_static_unique_class_name
            ((StringName *)&_get_class_namev()::_class_name_static,"EditorResourcePreviewGenerator")
  ;
LAB_0010a99e:
  return &_get_class_namev()::_class_name_static;
}
...
/* EditorResourcePreview::_get_class_namev() const */

undefined8 * EditorResourcePreview::_get_class_namev(void)
...
LAB_0010aa23:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      goto LAB_0010aa23;
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"EditorResourcePreview");
      goto LAB_0010aa8e;
    }
  }
  StringName::assign_static_unique_class_name
...
/* EditorResourcePreview::get_class() const */

void EditorResourcePreview::get_class(void)
...
/* EditorResourcePreviewGenerator::get_class() const */

void EditorResourcePreviewGenerator::get_class(void)
  ...
  if (cVar1 == '\0') {
    ...
    *(ImageTexture **)this = this_00;
    ...
    if (((pOVar3 == (Object *)0x0) || (cVar1 = RefCounted::unreference(), cVar1 == '\0')) ||
       (cVar1 = predelete_handler(pOVar3), cVar1 == '\0')) goto LAB_0010b555;
  }
  (**(code **)(*(long *)pOVar3 + 0x140))(pOVar3);
  Memory::free_static(pOVar3,false);
  pOVar2 = (Object *)this_00;
...
/* WARNING: Removing unreachable block (ram,0x0010c130) */
/* String vformat<String, unsigned long>(String const&, String const, unsigned long const) */

undefined8 *
vformat<String,unsigned_long>(undefined8 *param_1,bool *param_2,String *param_3,ulong param_4)
...
/* EditorResourcePreview::QueueItem::~QueueItem() */

void __thiscall EditorResourcePreview::QueueItem::~QueueItem(QueueItem *this)
...
void __thiscall
CallableCustomMethodPointer<EditorResourcePreviewGenerator::DrawRequester,Variant>::call
          (CallableCustomMethodPointer<EditorResourcePreviewGenerator::DrawRequester,Variant> *this,
...
void __thiscall
CallableCustomMethodPointer<RenderingServer,void,RID,RenderingServer::ViewportUpdateMode>::call
          (CallableCustomMethodPointer<RenderingServer,void,RID,RenderingServer::ViewportUpdateMode>
...
/* EditorResourcePreview::is_class(String const&) const */

undefined8 __thiscall EditorResourcePreview::is_class(EditorResourcePreview *this,String *param_1)
...
/* EditorResourcePreview::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall
EditorResourcePreview::_get_property_listv(EditorResourcePreview *this,List *param_1,bool param_2)
...
/* MethodBindT<Ref<EditorResourcePreviewGenerator> const&>::_gen_argument_type_info(int) const */

undefined4 *
MethodBindT<Ref<EditorResourcePreviewGenerator>const&>::_gen_argument_type_info(int param_1)
...
/* HashMap<String, EditorResourcePreview::Item, HashMapHasherDefault,
   HashMapComparatorDefault<String>, DefaultTypedAllocator<HashMapElement<String,
   EditorResourcePreview::Item> > >::_lookup_pos(String const&, unsigned int&) const */
...
/* HashMap<String, EditorResourcePreview::Item, HashMapHasherDefault,
   HashMapComparatorDefault<String>, DefaultTypedAllocator<HashMapElement<String,
   EditorResourcePreview::Item> > >::operator[](String const&) */
...
LAB_0010e81f:
  Dictionary::~Dictionary((Dictionary *)&local_a8);
  Ref<Texture2D>::unref((Ref<Texture2D> *)(local_b8 + 8));
...
MethodBind *
create_method_bind<EditorResourcePreview,String_const&,Object*,StringName_const&,Variant_const&>
          (_func_void_String_ptr_Object_ptr_StringName_ptr_Variant_ptr *param_1)
...
MethodBind *
create_method_bind<EditorResourcePreview,Ref<Resource>const&,Object*,StringName_const&,Variant_const&>
          (_func_void_Ref_ptr_Object_ptr_StringName_ptr_Variant_ptr *param_1)
...
/* MethodBind* create_method_bind<EditorResourcePreview, Ref<EditorResourcePreviewGenerator>
   const&>(void (EditorResourcePreview::*)(Ref<EditorResourcePreviewGenerator> const&)) */

MethodBind *
create_method_bind<EditorResourcePreview,Ref<EditorResourcePreviewGenerator>const&>
...
/* MethodBind* create_method_bind<EditorResourcePreview, String const&>(void
   (EditorResourcePreview::*)(String const&)) */

MethodBind * create_method_bind<EditorResourcePreview,String_const&>(_func_void_String_ptr *param_1)
...
/* EditorResourcePreview::_initialize_classv() */

void EditorResourcePreview::_initialize_classv(void)
...
/* EditorResourcePreviewGenerator::_initialize_classv() */

void EditorResourcePreviewGenerator::_initialize_classv(void)
...
/* EditorResourcePreview::_notificationv(int, bool) */

void __thiscall
EditorResourcePreview::_notificationv(EditorResourcePreview *this,int param_1,bool param_2)
...
/* CowData<Ref<EditorResourcePreviewGenerator> >::_realloc(long) */

undefined8 __thiscall
CowData<Ref<EditorResourcePreviewGenerator>>::_realloc
          (CowData<Ref<EditorResourcePreviewGenerator>> *this,long param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Error CowData<Ref<EditorResourcePreviewGenerator> >::resize<false>(long) */
...
void MethodBindT<String_const&,Object*,StringName_const&,Variant_const&>::validated_call
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    ...
    (*UNRECOVERED_JUMPTABLE)
              ((long *)((long)param_2 + *(long *)(param_1 + 0x60)),*(long *)param_3 + 8,
               *(undefined8 *)(*(long *)(param_3 + 8) + 0x10),*(long *)(param_3 + 0x10) + 8,
...
void MethodBindT<Ref<EditorResourcePreviewGenerator>const&>::validated_call
               (Object *param_1,Variant **param_2,Variant *param_3)
...
LAB_00110bc6:
      ...
      pOVar4 = (Object *)
               __dynamic_cast(pOVar4,&Object::typeinfo,&EditorResourcePreviewGenerator::typeinfo,0);
      if (pOVar2 != pOVar4) {
        local_58 = pOVar4;
        if (pOVar4 != (Object *)0x0) {
          cVar3 = RefCounted::reference();
...
void MethodBindT<Ref<EditorResourcePreviewGenerator>const&>::ptrcall
...
void MethodBindT<Ref<Resource>const&,Object*,StringName_const&,Variant_const&>::validated_call
               (Object *param_1,Variant **param_2,Variant *param_3)
...
void MethodBindT<String_const&,Object*,StringName_const&,Variant_const&>::ptrcall
               (Object *param_1,void **param_2,void *param_3)

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    ...
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
              ((long *)((long)param_2 + *(long *)(param_1 + 0x60)),*param_3,plVar1,
...
void MethodBindT<Ref<Resource>const&,Object*,StringName_const&,Variant_const&>::ptrcall
               (Object *param_1,void **param_2,void *param_3)
...
Object * MethodBindT<Ref<EditorResourcePreviewGenerator>const&>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
LAB_00111efd:
      ...
      pOVar8 = (Object *)
               __dynamic_cast(pOVar8,&Object::typeinfo,&EditorResourcePreviewGenerator::typeinfo,0);
      if (pOVar5 != pOVar8) {
        local_48 = pOVar8;
        if (pOVar8 != (Object *)0x0) {
          cVar6 = RefCounted::reference();
...
Object * MethodBindT<String_const&,Object*,StringName_const&,Variant_const&>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
LAB_0011216f:
      ...
      (*(code *)pVVar16)((Variant *)((long)plVar13 + (long)pVVar1),(Variant *)&local_98,pOVar8,
                         (Variant *)&local_a0,(Variant *)local_88);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_98);
      if ((StringName::configured != '\0') && (local_a0 != 0)) {
        StringName::unref();
      }
...
Object * MethodBindT<Ref<Resource>const&,Object*,StringName_const&,Variant_const&>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
LAB_00112695:
      ...
      (*(code *)pVVar17)((Variant *)((long)plVar14 + (long)pVVar1),&local_98,pOVar8,
                         (Variant *)&local_a0,(Variant *)local_88);
      if (((local_98 != (Object *)0x0) &&
          (cVar5 = RefCounted::unreference(), pOVar8 = local_98, cVar5 != '\0')) &&
...
PropertyInfo *
MethodBindT<String_const&,Object*,StringName_const&,Variant_const&>::_gen_argument_type_info
          (int param_1)
...
void call_get_argument_type_info<Ref<Resource>const&,Object*,StringName_const&,Variant_const&>
...
PropertyInfo *
MethodBindT<Ref<Resource>const&,Object*,StringName_const&,Variant_const&>::_gen_argument_type_info
          (int param_1)

{
  ...
  *(undefined4 *)(pPVar1 + 0x28) = 6;
  *(undefined1 (*) [16])(pPVar1 + 8) = (undefined1  [16])0x0;
  call_get_argument_type_info<Ref<Resource>const&,Object*,StringName_const&,Variant_const&>
            (in_EDX,pPVar1);
  return pPVar1;
}

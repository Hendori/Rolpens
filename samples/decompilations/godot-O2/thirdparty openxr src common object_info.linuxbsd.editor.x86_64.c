...
void vector_remove_if_and_erase<XrSdkLogObjectInfo,std::allocator<XrSdkLogObjectInfo>,ObjectInfoCollection::RemoveObject(unsigned_long,XrObjectType)::_lambda(XrSdkLogObjectInfo_const&)_1_>
               (vector *param_1,_lambda_XrSdkLogObjectInfo_const___1_ *param_2)
...
LAB_0010017e:
  if (plVar6 != plVar14) {
    if (plVar6 != plVar14 + 6) {
      plVar5 = plVar14 + 10;
      plVar3 = (long *)((long)plVar14 +
                       ((ulong)((long)plVar6 + (-0x60 - (long)plVar14)) & 0xfffffffffffffff0) + 0x80
                       );
      do {
        lVar4 = plVar5[-3];
        if (lVar13 == plVar5[-4]) {
                ...
                if (uVar7 < 8) {
                  if ((uVar12 & 4) == 0) {
                    if (uVar7 != 0) {
                      ...
                      *(undefined2 *)((long)plVar9 + (uVar8 - 2)) =
                           *(undefined2 *)((long)plVar5 + (uVar8 - 2));
                      plVar9 = (long *)plVar14[2];
                      uVar12 = plVar5[-1];
                    }
                  }
                    ...
                    *(undefined4 *)((long)plVar9 + (uVar8 - 4)) =
                         *(undefined4 *)((long)plVar5 + (uVar8 - 4));
                    plVar9 = (long *)plVar14[2];
                    uVar12 = plVar5[-1];
                  }
                }
                  ...
                  *(undefined8 *)((long)plVar9 + ((uVar12 & 0xffffffff) - 8)) =
                       *(undefined8 *)((long)plVar5 + ((uVar12 & 0xffffffff) - 8));
                  ...
                  if (7 < uVar7) {
                    ...
                    do {
                      uVar12 = (ulong)uVar11;
                      uVar11 = uVar11 + 8;
                      *(undefined8 *)(((ulong)(plVar9 + 1) & 0xfffffffffffffff8) + uVar12) =
                           *(undefined8 *)((long)plVar5 + (uVar12 - lVar4));
                    } while (uVar11 < uVar7);
                  }
LAB_00100293:
                  plVar9 = (long *)plVar14[2];
                  ...
                  if (uVar7 < 8) {
                    if ((uVar12 & 4) == 0) {
                      if (uVar7 != 0) {
                        ...
                        *(undefined2 *)((long)plVar10 + (uVar8 - 2)) =
                             *(undefined2 *)((long)plVar9 + (uVar8 - 2));
                        plVar10 = (long *)plVar3[2];
                        uVar12 = plVar5[-1];
                      }
                      ...
                      *(undefined4 *)((long)plVar10 + (uVar8 - 4)) =
                           *(undefined4 *)((long)plVar9 + (uVar8 - 4));
                      plVar10 = (long *)plVar3[2];
                      uVar12 = plVar5[-1];
                    }
                    ...
                    *plVar10 = *plVar9;
                    *(undefined8 *)((long)plVar10 + ((uVar12 & 0xffffffff) - 8)) =
                         *(undefined8 *)((long)plVar9 + ((uVar12 & 0xffffffff) - 8));
                    ...
                    if (7 < uVar7) {
                      ...
                      do {
                        uVar12 = (ulong)uVar11;
                        uVar11 = uVar11 + 8;
                        *(undefined8 *)(((ulong)(plVar10 + 1) & 0xfffffffffffffff8) + uVar12) =
                             *(undefined8 *)((long)plVar9 + (uVar12 - lVar4));
                      } while (uVar11 < uVar7);
                    }
LAB_0010058a:
                    plVar10 = (long *)plVar3[2];
...
/* std::_Hashtable<XrSession_T*, std::pair<XrSession_T* const,
   ...
   true>, XrSession_T* const&) [clone .isra.0] */
...
LAB_001006f1:
        ...
        else if ((lVar5 != 0) && (uVar7 = *(ulong *)(lVar5 + 8) % (ulong)param_1[1], uVar6 != uVar7)
                ) {
          *(long **)(lVar2 + uVar7 * 8) = plVar9;
          lVar5 = *plVar10;
        }
    ...
    if (plVar9 != (long *)0x0) {
      ...
      do {
        ...
        plVar3 = (long *)*plVar10;
              ...
              (uVar7 = plVar3[1], plVar9 = plVar10, plVar10 = plVar3,
              uVar6 == uVar7 % (ulong)param_1[1]));
    }
  }
  return;
}
...
/* XrSdkLogObjectInfo::ToString[abi:cxx11]() const */

void XrSdkLogObjectInfo::ToString_abi_cxx11_(void)
  ...
  *(undefined1 *)((long)local_1d8 + 1) = 0x78;
  ...
  if (in_RSI[3] != 0) {
    ...
    poVar3 = std::__ostream_insert<char,std::char_traits<char>>
                       ((ostream *)local_1b8,(char *)in_RSI[2],in_RSI[3]);
...
void __thiscall
ObjectInfoCollection::RemoveObject(ObjectInfoCollection *this,undefined8 param_1,undefined4 param_3)

{
  ...
  local_28 = param_1;
  local_20 = param_3;
  vector_remove_if_and_erase<XrSdkLogObjectInfo,std::allocator<XrSdkLogObjectInfo>,ObjectInfoCollection::RemoveObject(unsigned_long,XrObjectType)::_lambda(XrSdkLogObjectInfo_const&)_1_>
            ((vector *)this,(_lambda_XrSdkLogObjectInfo_const___1_ *)&local_28);
...
long * __thiscall
ObjectInfoCollection::LookUpStoredObjectInfo(ObjectInfoCollection *this,XrSdkLogObjectInfo *param_1)
...
bool __thiscall
ObjectInfoCollection::LookUpObjectName
          (ObjectInfoCollection *this,XrDebugUtilsObjectNameInfoEXT *param_1)
...
bool __thiscall
ObjectInfoCollection::LookUpObjectName(ObjectInfoCollection *this,XrSdkLogObjectInfo *param_1)
...
NamesAndLabels::PopulateCallbackData
          (NamesAndLabels *this,XrDebugUtilsMessengerCallbackDataEXT *param_1)
...
char * __thiscall
XrSdkSessionLabel::XrSdkSessionLabel
          (XrSdkSessionLabel *this,XrDebugUtilsLabelEXT *param_1,bool param_2)
...
void __thiscall DebugUtilsData::RemoveIndividualLabel(DebugUtilsData *this,vector *param_1)
    ...
    if (plVar4 != (undefined8 *)0x0) {
      ...
      do {
        ...
        puVar2 = (undefined8 *)*puVar3;
              ...
              (pXVar1 = (XrSession_T *)puVar2[1], plVar4 = puVar3, puVar3 = puVar2,
              uVar5 == (ulong)pXVar1 % *(ulong *)(this + 8)));
      plVar4 = (undefined8 *)0x0;
    }
  }
  return plVar4;
...
void __thiscall DebugUtilsData::EndLabelRegion(DebugUtilsData *this,XrSession_T *param_1)

{
  ...
  if ((plVar3 != (long *)0x0) && (lVar2 = plVar3[1], lVar2 != *plVar3)) {
...
void __thiscall DebugUtilsData::DeleteObject(DebugUtilsData *this,XrSession_T *param_1,int param_3)

{
  ...
  local_30 = param_3;
  vector_remove_if_and_erase<XrSdkLogObjectInfo,std::allocator<XrSdkLogObjectInfo>,ObjectInfoCollection::RemoveObject(unsigned_long,XrObjectType)::_lambda(XrSdkLogObjectInfo_const&)_1_>
            ((vector *)(this + 0x38),(_lambda_XrSdkLogObjectInfo_const___1_ *)&local_38);
  if (param_3 == 2) {
...
void DebugUtilsData::DeleteSessionLabels(XrSession_T *param_1)
...
/* ObjectInfoCollection::AddObjectName(unsigned long, XrObjectType, std::__cxx11::string const&) */

void __thiscall
ObjectInfoCollection::AddObjectName
          (ObjectInfoCollection *this,undefined8 param_1,undefined4 param_3,long param_4)

{
  ...
  if (*(long *)(param_4 + 8) == 0) {
    ...
    local_60 = param_3;
    vector_remove_if_and_erase<XrSdkLogObjectInfo,std::allocator<XrSdkLogObjectInfo>,ObjectInfoCollection::RemoveObject(unsigned_long,XrObjectType)::_lambda(XrSdkLogObjectInfo_const&)_1_>
              ((vector *)this,(_lambda_XrSdkLogObjectInfo_const___1_ *)&local_68);
  }
  else {
    local_40 = 0;
    local_38 = 0;
    ...
    if (lVar2 == 0) {
      ...
      if (puVar1 == *(undefined8 **)(this + 0x10)) {
        std::vector<XrSdkLogObjectInfo,std::allocator<XrSdkLogObjectInfo>>::
        _M_realloc_insert<XrSdkLogObjectInfo_const&>
                  ((vector<XrSdkLogObjectInfo,std::allocator<XrSdkLogObjectInfo>> *)this,puVar1,
...
/* DebugUtilsData::AddObjectName(unsigned long, XrObjectType, std::__cxx11::string const&) */

void DebugUtilsData::AddObjectName(long param_1)
...
DebugUtilsData::GetOrCreateSessionLabelList(DebugUtilsData *this,XrSession_T *param_1)
  ...
  if (pauVar3 == (undefined1 (*) [16])0x0) {
    ...
    *pauVar3 = (undefined1  [16])0x0;
    puVar4 = (undefined8 *)
             ...
             ::operator[]((_Map_base<XrSession_T*,std::pair<XrSession_T*const,std::unique_ptr<std::vector<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>,std::allocator<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>>>,std::default_delete<std::vector<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>,std::allocator<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>>>>>>,std::allocator<std::pair<XrSession_T*const,std::unique_ptr<std::vector<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>,std::allocator<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>>>,std::default_delete<std::vector<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>,std::allocator<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>>>>>>>,std::__detail::_Select1st,std::equal_to<XrSession_T*>,std::hash<XrSession_T*>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>
                           *)this,&local_30);
    plVar1 = (long *)*puVar4;
    *puVar4 = pauVar3;
    if (plVar1 != (long *)0x0) {
...
void __thiscall
DebugUtilsData::InsertLabel(DebugUtilsData *this,XrSession_T *param_1,XrDebugUtilsLabelEXT *param_2)

{
  long lVar1;
  undefined8 *puVar2;
  undefined8 *puVar3;
  vector<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>,std::allocator<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>>>
  *pvVar4;
  ...
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  pvVar4 = (vector<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>,std::allocator<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>>>
            *)GetOrCreateSessionLabelList(this,param_1);
  lVar1 = *(long *)(pvVar4 + 8);
  if ((lVar1 != *(long *)pvVar4) &&
     (puVar2 = *(undefined8 **)(lVar1 + -8), *(char *)(puVar2 + 7) != '\0')) {
    puVar3 = (undefined8 *)*puVar2;
...
void __thiscall
DebugUtilsData::BeginLabelRegion
          (DebugUtilsData *this,XrSession_T *param_1,XrDebugUtilsLabelEXT *param_2)
...
NamesAndLabels::NamesAndLabels
          (NamesAndLabels *this,undefined1 (*param_2) [16],undefined1 (*param_3) [16])
...
LAB_001018bf:
  for (; puVar9 != puVar7; puVar7 = puVar7 + 6) {
    while( true ) {
...
/* DebugUtilsData::LookUpSessionLabels(XrSession_T*, std::vector<XrDebugUtilsLabelEXT,
   std::allocator<XrDebugUtilsLabelEXT> >&) const */

void __thiscall
DebugUtilsData::LookUpSessionLabels(DebugUtilsData *this,XrSession_T *param_1,vector *param_2)

{
  ...
  if (*(long *)(this + 0x18) == 0) {
    for (puVar6 = *(undefined8 **)(this + 0x10); puVar6 != (undefined8 *)0x0;
    ...
    if (puVar6 != (undefined8 *)0x0) {
      ...
      while (pXVar3 != param_1) {
        ...
        if ((puVar4 == (undefined8 *)0x0) ||
           (pXVar3 = (XrSession_T *)puVar4[1], puVar6 = puVar5, puVar5 = puVar4,
           uVar7 != (ulong)pXVar3 % *(ulong *)(this + 8))) goto LAB_00101a98;
      }
      puVar6 = (undefined8 *)*puVar6;
...
LAB_00101a7e:
  ...
  for (lVar8 = ((long *)puVar6[2])[1]; lVar8 != lVar1; lVar8 = lVar8 + -8) {
    ...
    if (puVar6 == *(undefined8 **)(param_2 + 0x10)) {
      std::vector<XrDebugUtilsLabelEXT,std::allocator<XrDebugUtilsLabelEXT>>::
      _M_realloc_insert<XrDebugUtilsLabelEXT>
                ((vector<XrDebugUtilsLabelEXT,std::allocator<XrDebugUtilsLabelEXT>> *)param_2,puVar6
                 ,&local_48);
    }
    else {
      puVar6[2] = local_38;
...
DebugUtilsData::WrapCallbackData
          (DebugUtilsData *this,AugmentedCallbackData *param_1,
          XrDebugUtilsMessengerCallbackDataEXT *param_2)

{
  ...
  *(XrDebugUtilsMessengerCallbackDataEXT **)(param_1 + 0x78) = param_2;
  if ((*(long *)(this + 0x38) == *(long *)(this + 0x40)) || (*(int *)(param_2 + 0x28) == 0))
  goto LAB_00101d88;
  lVar7 = 0;
  bVar3 = false;
  do {
    while( true ) {
      ...
      local_78 = pXVar9;
      local_70 = iVar8;
      lVar4 = ObjectInfoCollection::LookUpStoredObjectInfo
                        ((ObjectInfoCollection *)(this + 0x38),(XrSdkLogObjectInfo *)&local_78);
...
LAB_00101c4a:
  if ((!bVar3) && (*(long *)param_1 == *(long *)(param_1 + 8))) goto LAB_00101d88;
  ...
  *(undefined8 *)(param_1 + 0x60) = *(undefined8 *)(param_2 + 0x30);
...
LAB_00101e00:
  ...
  for (; puVar11 != puVar6; puVar6 = puVar6 + 5) {
    ...
    local_60 = 0;
    local_58 = 0;
    lVar7 = ObjectInfoCollection::LookUpStoredObjectInfo
                      ((ObjectInfoCollection *)(this + 0x38),(XrSdkLogObjectInfo *)&local_78);
    if (lVar7 != 0) {
...
DebugUtilsData::PopulateNamesAndLabels
          (NamesAndLabels *param_1,DebugUtilsData *param_2,long *param_3)

{
  ...
  do {
    while( true ) {
      lVar6 = ObjectInfoCollection::LookUpStoredObjectInfo
                        ((ObjectInfoCollection *)(param_2 + 0x38),pXVar9);
      if (lVar6 != 0) {
...
LAB_00102140:
    puVar11 = (undefined8 *)std::__throw_bad_array_new_length();
LAB_00102148:
    local_68 = 0;
...
std::vector<XrSdkLogObjectInfo,std::allocator<XrSdkLogObjectInfo>>::
_M_realloc_insert<XrSdkLogObjectInfo_const&>
          (vector<XrSdkLogObjectInfo,std::allocator<XrSdkLogObjectInfo>> *this,undefined8 *param_2,
          undefined8 *param_3)
...
LAB_00102350:
  ...
  puVar12 = puVar9 + 6;
LAB_00102280:
  puVar10 = (undefined8 *)((long)puVar9 + ((long)param_2 - (long)puVar3));
  lVar7 = param_3[2];
  *puVar10 = *param_3;
          ...
          if (7 < uVar16) {
            ...
            do {
              ...
              *(undefined8 *)(((ulong)(puVar11 + 5) & 0xfffffffffffffff8) + uVar8) =
                   *(undefined8 *)((long)puVar4 + (uVar8 - lVar7));
            } while (uVar13 < uVar16);
          }
          goto LAB_001022cc;
        }
...
LAB_001022cc:
    ...
    puVar12 = (undefined8 *)
              ((long)puVar9 + ((long)param_2 + (-0x30 - (long)puVar3) & 0xfffffffffffffff0U) + 0x60)
    ;
  }
  puVar10 = param_2;
  puVar11 = puVar12;
      ...
      if (puVar6 == puVar10 + 4) {
        ...
        if (uVar16 < 8) {
          if ((uVar8 & 4) == 0) {
            ...
            {
              *(undefined2 *)((long)puVar11 + (uVar8 & 0xffffffff) + 0x1e) =
                   *(undefined2 *)((long)puVar6 + ((uVar8 & 0xffffffff) - 2));
            }
          }
          else {
            *(undefined4 *)puVar4 = *(undefined4 *)puVar6;
            *(undefined4 *)((long)puVar11 + (uVar8 & 0xffffffff) + 0x1c) =
                 *(undefined4 *)((long)puVar6 + ((uVar8 & 0xffffffff) - 4));
          }
        }
        else {
          *puVar4 = *puVar6;
          *(undefined8 *)((long)puVar11 + (uVar8 & 0xffffffff) + 0x18) =
               *(undefined8 *)((long)puVar6 + ((uVar8 & 0xffffffff) - 8));
          ...
          if (7 < uVar16) {
            ...
            do {
              ...
              uVar13 = uVar13 + 8;
              *(undefined8 *)(((ulong)(puVar11 + 5) & 0xfffffffffffffff8) + uVar8) =
                   *(undefined8 *)((long)puVar6 + (uVar8 - lVar14));
            } while (uVar13 < uVar16);
          }
        }
      }
...
/* std::__detail::_Map_base<XrSession_T*, std::pair<XrSession_T* const,
   std::unique_ptr<std::vector<std::unique_ptr<XrSdkSessionLabel,
   std::default_delete<XrSdkSessionLabel> >, std::allocator<std::unique_ptr<XrSdkSessionLabel,
   std::default_delete<XrSdkSessionLabel> > > >,
   std::default_delete<std::vector<std::unique_ptr<XrSdkSessionLabel,
   ...
   std::equal_to<XrSession_T*>, std::hash<XrSession_T*>, std::__detail::_Mod_range_hashing,
   std::__detail::_Default_ranged_hash, std::__detail::_Prime_rehash_policy,
   std::__detail::_Hashtable_traits<false, false, true>, true>::operator[](XrSession_T* const&) */

long * __thiscall
std::__detail::
_Map_base<XrSession_T*,std::pair<XrSession_T*const,std::unique_ptr<std::vector<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>,std::allocator<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>>>,std::default_delete<std::vector<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>,std::allocator<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>>>>>>,std::allocator<std::pair<XrSession_T*const,std::unique_ptr<std::vector<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>,std::allocator<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>>>,std::default_delete<std::vector<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>,std::allocator<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>>>>>>>,std::__detail::_Select1st,std::equal_to<XrSession_T*>,std::hash<XrSession_T*>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>
::operator[](_Map_base<XrSession_T*,std::pair<XrSession_T*const,std::unique_ptr<std::vector<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>,std::allocator<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>>>,std::default_delete<std::vector<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>,std::allocator<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>>>>>>,std::allocator<std::pair<XrSession_T*const,std::unique_ptr<std::vector<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>,std::allocator<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>>>,std::default_delete<std::vector<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>,std::allocator<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>>>>>>>,std::__detail::_Select1st,std::equal_to<XrSession_T*>,std::hash<XrSession_T*>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>
             *this,XrSession_T **param_1)
  ...
  *p_Var11;
  ...
  if (plVar6 != (long *)0x0) {
    ...
    while (pXVar2 != pXVar1) {
      plVar9 = (long *)*plVar8;
      if ((plVar9 == (long *)0x0) ||
         (pXVar2 = (XrSession_T *)plVar9[1], plVar6 = plVar8, plVar8 = plVar9,
         uVar7 != (ulong)pXVar2 % *(ulong *)(this + 8))) goto LAB_00102660;
    }
    if (*plVar6 != 0) {
...
LAB_00102763:
    if (*(_Map_base<XrSession_T*,std::pair<XrSession_T*const,std::unique_ptr<std::vector<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>,std::allocator<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>>>,std::default_delete<std::vector<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>,std::allocator<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>>>>>>,std::allocator<std::pair<XrSession_T*const,std::unique_ptr<std::vector<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>,std::allocator<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>>>,std::default_delete<std::vector<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>,std::allocator<std::unique_ptr<XrSdkSessionLabel,std::default_delete<XrSdkSessionLabel>>>>>>>>,std::__detail::_Select1st,std::equal_to<XrSession_T*>,std::hash<XrSession_T*>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>
          **)this != this + 0x30) {
...
std::vector<XrDebugUtilsObjectNameInfoEXT,std::allocator<XrDebugUtilsObjectNameInfoEXT>>::
_M_realloc_insert<XrDebugUtilsObjectNameInfoEXT>
          (vector<XrDebugUtilsObjectNameInfoEXT,std::allocator<XrDebugUtilsObjectNameInfoEXT>> *this
...
std::vector<XrDebugUtilsLabelEXT,std::allocator<XrDebugUtilsLabelEXT>>::
_M_realloc_insert<XrDebugUtilsLabelEXT>
          (vector<XrDebugUtilsLabelEXT,std::allocator<XrDebugUtilsLabelEXT>> *this,void *param_2,
          undefined8 *param_3)

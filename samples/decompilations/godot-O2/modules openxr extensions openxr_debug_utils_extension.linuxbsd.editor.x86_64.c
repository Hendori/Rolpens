...
void __thiscall
OpenXRDebugUtilsExtension::~OpenXRDebugUtilsExtension(OpenXRDebugUtilsExtension *this)
...
/* OpenXRDebugUtilsExtension::on_instance_destroyed() */

void __thiscall OpenXRDebugUtilsExtension::on_instance_destroyed(OpenXRDebugUtilsExtension *this)
...
LAB_001000b0:
    ...
    operator+((char *)&local_58,(String *)"OpenXR: Failed to destroy debug callback [");
    String::operator+((String *)&local_48,(String *)&local_58);
    _err_print_error("on_instance_destroyed",
                     "modules/openxr/extensions/openxr_debug_utils_extension.cpp",0x85,
                     (String *)&local_48,0,0);
    puVar3 = local_48;
...
/* OpenXRDebugUtilsExtension::get_singleton() */

undefined8 OpenXRDebugUtilsExtension::get_singleton(void)
...
/* OpenXRDebugUtilsExtension::get_active() */

OpenXRDebugUtilsExtension __thiscall
OpenXRDebugUtilsExtension::get_active(OpenXRDebugUtilsExtension *this)
...
/* OpenXRDebugUtilsExtension::set_object_name(XrObjectType, unsigned long, char const*) */

void __thiscall
OpenXRDebugUtilsExtension::set_object_name
          (OpenXRDebugUtilsExtension *this,undefined4 param_2,undefined8 param_3,undefined8 param_4)
...
LAB_00100472:
      _err_print_error("set_object_name",
                       "modules/openxr/extensions/openxr_debug_utils_extension.cpp",uVar6,pcVar5,0,0
                      );
      return;
    }
  }
    ...
    if (iVar4 < 0) {
      ...
      operator+((char *)&local_78,(String *)"OpenXR: Failed to set object name [");
      String::operator+((String *)&local_68,(String *)&local_78);
      _err_print_error("set_object_name",
                       "modules/openxr/extensions/openxr_debug_utils_extension.cpp",0xa6,
                       (String *)&local_68,0,0);
      puVar3 = local_68;
...
/* OpenXRDebugUtilsExtension::on_instance_created(XrInstance_T*) */

void __thiscall
OpenXRDebugUtilsExtension::on_instance_created
          (OpenXRDebugUtilsExtension *this,XrInstance_T *param_1)

{
  ...
  if (this[8] == (OpenXRDebugUtilsExtension)0x0) {
    _err_print_error("on_instance_created",
                     "modules/openxr/extensions/openxr_debug_utils_extension.cpp",0x48,
                     "OpenXR: The debug utils extension is not available on this runtime. Debug logging is not enabled!"
                     ,0,1);
    OVar7 = this[8];
LAB_00100644:
    if (OVar7 != (OpenXRDebugUtilsExtension)0x0) {
      ...
      StringName::StringName
                ((StringName *)&local_88,"xr/openxr/extensions/debug_message_types",false);
      ProjectSettings::get_setting_with_override((StringName *)local_58);
      ...
      iStack_78 = 0;
      if ((0 < iVar4) && (iStack_78 = 0x1000, iVar4 != 1)) {
        if (iVar4 == 2) {
          iStack_78 = 0x1100;
        }
        else {
...
LAB_001007d0:
        ...
        operator+((char *)&local_a8,(String *)"OpenXR: Failed to create debug callback [");
        String::operator+((String *)&local_98,(String *)&local_a8);
        _err_print_error("on_instance_created",
                         "modules/openxr/extensions/openxr_debug_utils_extension.cpp",0x7a,
                         (String *)&local_98,0,0);
        puVar3 = local_98;
    ...
    iVar4 = OpenXRAPI::get_instance_proc_addr
                      (OpenXRAPI::singleton,(_func_void *)"xrCreateDebugUtilsMessengerEXT");
    if (iVar4 < 0) {
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
        uVar6 = 0x3f;
LAB_00100909:
        _err_print_error("on_instance_created",
                         "modules/openxr/extensions/openxr_debug_utils_extension.cpp",uVar6,
    ...
    iVar4 = OpenXRAPI::get_instance_proc_addr
                      (OpenXRAPI::singleton,(_func_void *)"xrDestroyDebugUtilsMessengerEXT");
    if (iVar4 < 0) {
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
        uVar6 = 0x40;
        goto LAB_00100909;
    ...
    iVar4 = OpenXRAPI::get_instance_proc_addr
                      (OpenXRAPI::singleton,(_func_void *)"xrSetDebugUtilsObjectNameEXT");
    if (iVar4 < 0) {
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
        uVar6 = 0x41;
        goto LAB_00100909;
    ...
    iVar4 = OpenXRAPI::get_instance_proc_addr
                      (OpenXRAPI::singleton,(_func_void *)"xrSessionBeginDebugUtilsLabelRegionEXT");
    if (iVar4 < 0) {
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
        uVar6 = 0x42;
        goto LAB_00100909;
    ...
    iVar4 = OpenXRAPI::get_instance_proc_addr
                      (OpenXRAPI::singleton,(_func_void *)"xrSessionEndDebugUtilsLabelRegionEXT");
    if (iVar4 < 0) {
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
        uVar6 = 0x43;
        goto LAB_00100909;
    ...
    iVar4 = OpenXRAPI::get_instance_proc_addr
                      (OpenXRAPI::singleton,(_func_void *)"xrSessionInsertDebugUtilsLabelEXT");
    if (iVar4 < 0) {
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
        uVar6 = 0x44;
        goto LAB_00100909;
    ...
    if ((((*(long *)(this + 0x18) != 0) && (*(long *)(this + 0x20) != 0)) &&
        (*(long *)(this + 0x28) != 0)) &&
       ((*(long *)(this + 0x30) != 0 && (*(long *)(this + 0x38) != 0)))) {
...
/* OpenXRDebugUtilsExtension::begin_debug_label_region(char const*) */

void __thiscall
OpenXRDebugUtilsExtension::begin_debug_label_region(OpenXRDebugUtilsExtension *this,char *param_1)

{
  ...
  if (this[8] == (OpenXRDebugUtilsExtension)0x0) {
    if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
      ...
      pcVar5 = "Condition \"!debug_utils_ext\" is true.";
LAB_00100cc2:
      _err_print_error("begin_debug_label_region",
                       "modules/openxr/extensions/openxr_debug_utils_extension.cpp",uVar6,pcVar5,0,0
                      );
      return;
    }
    ...
    if (iVar4 < 0) {
      ...
      operator+((char *)&local_68,(String *)"OpenXR: Failed to begin label region [");
      String::operator+((String *)&local_58,(String *)&local_68);
      _err_print_error("begin_debug_label_region",
                       "modules/openxr/extensions/openxr_debug_utils_extension.cpp",0xb6,
                       (String *)&local_58,0,0);
      puVar3 = local_58;
...
void __thiscall OpenXRDebugUtilsExtension::end_debug_label_region(OpenXRDebugUtilsExtension *this)

{
  ...
  if (this[8] == (OpenXRDebugUtilsExtension)0x0) {
    if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
      ...
      pcVar5 = "Condition \"!debug_utils_ext\" is true.";
LAB_00100ef2:
      _err_print_error("end_debug_label_region",
                       "modules/openxr/extensions/openxr_debug_utils_extension.cpp",uVar6,pcVar5,0,0
                      );
      return;
    }
    ...
    if (iVar4 < 0) {
      ...
      String::parse_latin1((StrRange *)&local_50);
      OpenXRAPI::get_error_string(&local_60,OpenXRAPI::singleton,iVar4);
      operator+((char *)&local_58,(String *)"OpenXR: Failed to end label region [");
      String::operator+((String *)&local_48,(String *)&local_58);
      _err_print_error("end_debug_label_region",
                       "modules/openxr/extensions/openxr_debug_utils_extension.cpp",0xc0,
                       (String *)&local_48,0,0);
      puVar3 = local_48;
      if (local_48 != (undefined *)0x0) {
        LOCK();
...
/* OpenXRDebugUtilsExtension::insert_debug_label(char const*) */

void __thiscall
OpenXRDebugUtilsExtension::insert_debug_label(OpenXRDebugUtilsExtension *this,char *param_1)

{
  ...
  if (this[8] == (OpenXRDebugUtilsExtension)0x0) {
    if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
      ...
      pcVar5 = "Condition \"!debug_utils_ext\" is true.";
LAB_00101142:
      _err_print_error("insert_debug_label",
                       "modules/openxr/extensions/openxr_debug_utils_extension.cpp",uVar6,pcVar5,0,0
                      );
      return;
    }
    ...
    if (iVar4 < 0) {
      ...
      String::parse_latin1((StrRange *)&local_60);
      OpenXRAPI::get_error_string(&local_70,OpenXRAPI::singleton,iVar4);
      operator+((char *)&local_68,(String *)"OpenXR: Failed to insert label [");
      String::operator+((String *)&local_58,(String *)&local_68);
      _err_print_error("insert_debug_label",
                       "modules/openxr/extensions/openxr_debug_utils_extension.cpp",0xd0,
                       (String *)&local_58,0,0);
      puVar3 = local_58;
      if (local_58 != (undefined *)0x0) {
        LOCK();
...
/* OpenXRDebugUtilsExtension::debug_callback(unsigned long, unsigned long,
   XrDebugUtilsMessengerCallbackDataEXT const*, void*) */

undefined8
OpenXRDebugUtilsExtension::debug_callback
          (ulong param_1,ulong param_2,XrDebugUtilsMessengerCallbackDataEXT *param_3,void *param_4)

{
  ...
  local_88 = (char *)0x0;
  if (param_4 == (void *)0x0) {
    _err_print_error("debug_callback","modules/openxr/extensions/openxr_debug_utils_extension.cpp",
                     0xe1,"Parameter \"p_callback_data\" is null.",0,0);
    goto LAB_00101696;
  }
...
LAB_0010148f:
    ...
    operator+((char *)&local_78,(String *)", type: Unknown (");
    String::operator+((String *)&local_68,(String *)&local_78);
    pcVar2 = local_68;
    pcVar5 = local_88;
  ...
  if (pcVar5 != (char *)0x0) {
    ...
    local_68 = pcVar5;
    String::parse_latin1((StrRange *)&local_70);
    operator+((char *)&local_68,(String *)", function Name: ");
  ...
  if (*(int *)((long)param_4 + 0x28) != 0) {
    ...
    while( true ) {
      ...
      String::operator+=((String *)&local_70,
                         *(char **)(*(long *)((long)param_4 + 0x30) + lVar8 * 0x28 + 0x20));
...
LAB_00101659:
    if (param_2 != 0x1000) goto LAB_00101666;
LAB_00101830:
    operator+((char *)&local_68,(String *)"OpenXR: Severity: Error");
    uVar6 = 0;
    uVar4 = 0x114;
  }
  else {
    ...
    while( true ) {
      lVar7 = lVar8 + 1;
      String::operator+=((String *)&local_70,
                         *(char **)(*(long *)((long)param_4 + 0x40) + lVar8 * 0x18 + 0x10));
...
LAB_00101666:
    if (param_2 != 0x100) {
      ...
      if (param_2 != 0x10) {
        if ((param_2 != 1) || (cVar3 = is_print_verbose_enabled(), cVar3 == '\0'))
        goto LAB_00101696;
        pcVar5 = "OpenXR: Severity: Verbose";
      }
      operator+((char *)&local_70,(String *)pcVar5);
    ...
    operator+((char *)&local_68,(String *)"OpenXR: Severity: Warning");
    uVar4 = 0x116;
    uVar6 = 1;
  }
  _err_print_error("debug_callback","modules/openxr/extensions/openxr_debug_utils_extension.cpp",
                   uVar4,(Variant *)&local_68,0,uVar6);
  pcVar5 = local_68;
  if (local_68 != (char *)0x0) {
    LOCK();
    plVar1 = (long *)(local_68 + -0x10);
...
undefined8
OpenXRDebugUtilsExtension::_debug_callback
          (ulong param_1,ulong param_2,XrDebugUtilsMessengerCallbackDataEXT *param_3,void *param_4)
...
/* OpenXRDebugUtilsExtension::get_requested_extensions() */

void OpenXRDebugUtilsExtension::get_requested_extensions(void)
...
LAB_00102534:
    if ((float)uVar39 * __LC48 < (float)(iVar45 + 1)) goto LAB_0010255a;
  }
  local_58[0] = 0;
  if (*(long *)param_1 == 0) {

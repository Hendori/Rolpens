...
/* SphereShape3D::get_enclosing_radius() const */

undefined4 __thiscall SphereShape3D::get_enclosing_radius(SphereShape3D *this)
...
/* SphereShape3D::set_radius(float) */

undefined8 __thiscall SphereShape3D::set_radius(SphereShape3D *this,float param_1)

{
  ...
  _err_print_error("set_radius","scene/resources/3d/sphere_shape_3d.cpp",0x56,
                   "Condition \"p_radius < 0\" is true.","SphereShape3D radius cannot be negative.",
                   0);
  return 0;
}
...
void SphereShape3D::_bind_methods(void)

{
  ...
  local_58 = (char **)0x0;
  pMVar4 = create_method_bind<SphereShape3D,float>(set_radius);
  ...
  local_50 = (undefined1  [16])0x0;
  local_58 = (char **)0x0;
  pMVar4 = create_method_bind<SphereShape3D,float>(get_enclosing_radius);
  ClassDB::bind_methodfi(1,pMVar4,false,(MethodDefinition *)&local_98,(Variant **)0x0,0);
  if (Variant::needs_deinit[(int)local_58] != '\0') {
    Variant::_clear_internal();
  }
...
/* SphereShape3D::get_debug_mesh_lines() const */

void SphereShape3D::get_debug_mesh_lines(void)

{
  ...
  *(undefined8 *)(in_RDI + 8) = 0;
  ...
  while( true ) {
    ...
    local_38 = fVar4;
    Vector<Vector3>::push_back(local_40,fVar4);
    local_40 = (ulong)(uint)fVar5;
    local_38 = fVar6;
    Vector<Vector3>::push_back(local_40,fVar6);
    local_40 = (ulong)(uint)fVar3 << 0x20;
    local_38 = fVar4;
    Vector<Vector3>::push_back(local_40,fVar4);
    local_40 = (ulong)(uint)fVar5 << 0x20;
    local_38 = fVar6;
    Vector<Vector3>::push_back(local_40,fVar6);
    local_38 = 0.0;
    ...
    Vector<Vector3>::push_back(CONCAT44(fVar6,fVar5),0);
    if (iVar2 == 0x169) break;
    sincosf((_LC32._4_4_ + (float)iVar2) * _LC34,local_4c,&local_50);
    fVar5 = local_4c[0];
    fVar6 = local_50;
    sincosf(_LC34 * (float)iVar2,local_4c,&local_50);
    fVar3 = local_4c[0];
    fVar4 = local_50;
  }
...
/* SphereShape3D::get_debug_arraymesh_faces(Color const&) const */

Color * SphereShape3D::get_debug_arraymesh_faces(Color *param_1)

{
  ...
  iVar13 = (int)local_98;
  Array::resize(iVar13);
  fVar2 = *(float *)(in_RSI + 0x274);
  SphereMesh::create_mesh_array(local_98,fVar2,fVar2 + fVar2,0x20,0x20,false,false,_LC32._4_4_);
  local_70 = 0;
  Array::operator[](iVar13);
  Variant::operator_cast_to_Vector(local_68);
  if ((local_60 != 0) && (iVar6 = (int)*(undefined8 *)(local_60 + -8), 0 < iVar6)) {
    iVar11 = 0;
    do {
      uVar3 = *in_RDX;
      uVar4 = in_RDX[1];
      ...
      iVar7 = CowData<Color>::resize<false>((CowData<Color> *)&local_70,lVar12);
      if (iVar7 == 0) {
        if (local_70 == 0) {
          lVar9 = -1;
          lVar12 = 0;
          ...
          if (-1 < lVar9) {
            ...
            puVar10 = (undefined8 *)(lVar9 * 0x10 + local_70);
            *puVar10 = uVar3;
            puVar10[1] = uVar4;
            goto LAB_00100dd0;
          }
...
LAB_00100dd0:
  ...
  *(ArrayMesh **)param_1 = this;
  ...
  pVVar8 = (Variant *)Array::operator[](iVar13);
  ...
  ArrayMesh::add_surface_from_arrays(uVar3,3,local_98,local_90,local_88,0);
  Array::~Array(local_90);
  Dictionary::~Dictionary(local_88);
  lVar12 = local_60;
  if (local_60 != 0) {
...
void __thiscall SphereShape3D::_update_shape(SphereShape3D *this)

{
  ...
  Variant::Variant((Variant *)local_48,*(float *)(this + 0x274));
...
void __thiscall SphereShape3D::SphereShape3D(SphereShape3D *this)

{
  undefined8 uVar1;
  
  uVar1 = PhysicsServer3D::get_singleton();
  uVar1 = PhysicsServer3D::shape_create(uVar1,2);
  Shape3D::Shape3D((Shape3D *)this,uVar1);
  *(undefined4 *)(this + 0x274) = 0x3f000000;
  *(undefined ***)this = &PTR__initialize_classv_001059d0;
  _update_shape(this);
...
/* SphereShape3D::is_class_ptr(void*) const */

uint __thiscall SphereShape3D::is_class_ptr(SphereShape3D *this,void *param_1)

{
  return (uint)CONCAT71(0x105c,(undefined4 *)param_1 == &Shape3D::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x105c,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x105c,(undefined4 *)param_1 == &Resource::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x105c,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x105c,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}



/* SphereShape3D::_getv(StringName const&, Variant&) const */

undefined8 SphereShape3D::_getv(StringName *param_1,Variant *param_2)
...
/* SphereShape3D::_setv(StringName const&, Variant const&) */

undefined8 SphereShape3D::_setv(StringName *param_1,Variant *param_2)
...
/* SphereShape3D::_validate_propertyv(PropertyInfo&) const */

void SphereShape3D::_validate_propertyv(PropertyInfo *param_1)
...
/* SphereShape3D::_property_can_revertv(StringName const&) const */

undefined8 SphereShape3D::_property_can_revertv(StringName *param_1)
...
/* SphereShape3D::_property_get_revertv(StringName const&, Variant&) const */

undefined8 SphereShape3D::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* SphereShape3D::_notificationv(int, bool) */

void SphereShape3D::_notificationv(int param_1,bool param_2)
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00105bc8;
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00105c28;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
/* SphereShape3D::_bind_methods() [clone .cold] */
...
/* SphereShape3D::_get_class_namev() const */

undefined8 * SphereShape3D::_get_class_namev(void)
...
LAB_001016c3:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"SphereShape3D");
      goto LAB_0010172e;
    }
  }
  StringName::assign_static_unique_class_name
...
/* SphereShape3D::get_class() const */

void SphereShape3D::get_class(void)
...
LAB_00101af8:
    ...
    local_30 = 6;
    if (local_40 != 0x11) goto LAB_00101af8;
...
LAB_001020e8:
    ...
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_001020e8;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)pLVar6;
      local_68 = local_80;
      goto joined_r0x00102106;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
/* SphereShape3D::is_class(String const&) const */

undefined8 __thiscall SphereShape3D::is_class(SphereShape3D *this,String *param_1)
...
LAB_00102acf:
    ...
    if (cVar5 != '\0') goto LAB_00102b83;
  }
  cVar5 = String::operator==(param_1,"SphereShape3D");
  if (cVar5 == '\0') {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      uVar7 = Shape3D::is_class((Shape3D *)this,param_1);
      return uVar7;
    }
  }
  else {
...
LAB_00102d58:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_00102d58;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x00102d75;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
/* SphereShape3D::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall SphereShape3D::_get_property_listv(SphereShape3D *this,List *param_1,bool param_2)
...
LAB_001031a8:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_001031a8;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x001031c5;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
joined_r0x001031c5:
  ...
  *(int *)(plVar1 + 2) = (int)plVar1[2] + 1;
  ...
  StringName::StringName((StringName *)&local_78,"SphereShape3D",false);
  ClassDB::get_property_list((StringName *)&local_78,param_1,true,(Object *)this);
  if ((StringName::configured != '\0') && (local_78 != (char *)0x0)) {
    StringName::unref();
  }
...
/* MethodBind* create_method_bind<SphereShape3D, float>(void (SphereShape3D::*)(float)) */

MethodBind * create_method_bind<SphereShape3D,float>(_func_void_float *param_1)
...
/* MethodBind* create_method_bind<SphereShape3D, float>(float (SphereShape3D::*)() const) */

MethodBind * create_method_bind<SphereShape3D,float>(_func_float *param_1)
...
/* SphereShape3D::_initialize_classv() */

void SphereShape3D::_initialize_classv(void)
...
LAB_00103f2c:
    ...
    lVar3 = puVar9[-1];
    if (param_1 <= lVar3) goto LAB_00103ebb;
  }
  else {
    if (lVar8 != 0) {
...
LAB_0010427c:
    ...
    lVar4 = puVar10[-1];
    if (param_1 <= lVar4) goto LAB_00104210;
  }
  else {
    if (lVar12 != 0) {
  ...
  if (((param_1 - lVar4) * 0x10 & 0x10U) != 0) {
    *puVar7 = __LC35;
    puVar7[1] = uVar3;
    puVar6 = puVar7 + 2;
    if (puVar7 + (param_1 - lVar4) * 2 == puVar7 + 2) goto LAB_00104210;
  }
  do {
    *puVar6 = uVar9;
    puVar6[1] = uVar3;
...
/* WARNING: Removing unreachable block (ram,0x00104508) */
/* WARNING: Removing unreachable block (ram,0x00104638) */
/* WARNING: Removing unreachable block (ram,0x00104800) */
/* WARNING: Removing unreachable block (ram,0x00104644) */
/* WARNING: Removing unreachable block (ram,0x0010464e) */
/* WARNING: Removing unreachable block (ram,0x001047e0) */
/* WARNING: Removing unreachable block (ram,0x0010465a) */
/* WARNING: Removing unreachable block (ram,0x00104664) */
/* WARNING: Removing unreachable block (ram,0x001047c0) */
/* WARNING: Removing unreachable block (ram,0x00104670) */
/* WARNING: Removing unreachable block (ram,0x0010467a) */
/* WARNING: Removing unreachable block (ram,0x001047a0) */
/* WARNING: Removing unreachable block (ram,0x00104686) */
/* WARNING: Removing unreachable block (ram,0x00104690) */
/* WARNING: Removing unreachable block (ram,0x00104780) */
/* WARNING: Removing unreachable block (ram,0x0010469c) */
/* WARNING: Removing unreachable block (ram,0x001046a6) */
/* WARNING: Removing unreachable block (ram,0x00104760) */
/* WARNING: Removing unreachable block (ram,0x001046b2) */
/* WARNING: Removing unreachable block (ram,0x001046bc) */
...
/* WARNING: Removing unreachable block (ram,0x001046e6) */
...

{
  ...
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
    ...
    auVar5._0_4_ = (float)*(double *)(*(long *)param_3 + 8);
                    /* WARNING: Could not recover jumptable at 0x001050ee. Too many branches */
...

{
  ...
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
    ...
    auVar4._0_4_ = (float)**param_3;
                    /* WARNING: Could not recover jumptable at 0x0010530d. Too many branches */
                    /* WARNING: Treating indirect jump as call */

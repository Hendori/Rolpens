...
LAB_00100087:
  *(undefined1 *)(param_2 + (int)uVar6) = 0;
  return;
}
...
LAB_00100375:
      ...
      iVar4 = iVar4 + 1;
      bVar1 = false;
      if ((param_3 != 5) || (uVar3 = param_4 / 10, iVar4 != 5)) {
        if (pcVar6 <= param_1) {
          return pcVar6;
        }
...

{
  ...
  if ((7 < param_2 - 1U) ||
     (puVar4 = (undefined1 *)(param_1 + -0x20 + (long)param_2 * 0x20), puVar4 == (undefined1 *)0x0))
  {
    return;
  }
...

{
  ...
  if ((param_2 - 1U < 8) &&
     (puVar5 = (undefined1 *)(param_1 + -0x20 + (long)param_2 * 0x20), puVar5 != (undefined1 *)0x0))
  {
    if ((pcVar1 != (char *)0x0) && (cVar2 = *pcVar1, cVar2 != '\0')) {
      lVar4 = 0;
      do {
        lVar3 = lVar4 + 1;
        puVar5[lVar4] = cVar2;
...
LAB_001006e0:
      ...
      do {
        ...
        local_d8[lVar4] = cVar1;
        lVar4 = lVar3;
        if ((lVar3 == 0xbf) || (cVar1 = *pcVar2, param_2 + lVar5 <= pcVar2)) break;
      } while (cVar1 != '\0');
      param_3 = param_3 + 2;
    }
    if (lVar4 == 0xbf) {
...
void png_default_error(undefined8 param_1,char *param_2)
...
LAB_00100b07:
  *(undefined1 *)((long)&local_f8 + (ulong)((int)lVar1 + 0x18)) = 0;
                    /* WARNING: Subroutine does not return */
...

{
  ...
  *(uint *)(plVar2 + 4) = *(uint *)(plVar2 + 4) | 2;
  if ((*plVar2 != 0) && (lVar1 = *(long *)(*plVar2 + 0x10), lVar1 != 0)) {
                    /* WARNING: Subroutine does not return */

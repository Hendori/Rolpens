...
/* basisu::basisu_file::create_header(basisu::basisu_backend_output const&,
   basist::basis_texture_type, unsigned int, unsigned int, bool, unsigned int) */

void __thiscall
basisu::basisu_file::create_header
          (basisu_file *this,undefined4 *param_1,uint param_3,uint param_4,ulong param_5,
...

{
  ...
  *(uint *)(this + 0x17) =
       (((param_7 >> 0x10 & 0xff) << 8 | param_7 >> 8 & 0xff) << 8 | param_7 & 0xff) << 8 |
       param_3 & 0xff;
  *(ulong *)(this + 0x1f) =
       (((((((uVar10 >> 0x18) << 8 | uVar10 >> 0x10 & 0xff) << 8 | uVar10 >> 8 & 0xff) << 8 |
          param_5 & 0xff) << 8 | (ulong)(param_4 >> 0x18)) << 8 | (ulong)(param_4 >> 0x10) & 0xff)
        << 8 | (ulong)(byte)(param_4 >> 8)) << 8 | (ulong)(byte)param_4;
...
/* basisu::basisu_file::create_image_descs(basisu::basisu_backend_output const&) */

undefined8 __thiscall
basisu::basisu_file::create_image_descs(basisu_file *this,basisu_backend_output *param_1)

{
  ...
  if (uVar2 != uVar7) {
    ...
    if ((uVar7 <= uVar2) && (*(uint *)(this + 0x5c) < uVar2)) {
      basisu::elemental_vector::increase_capacity
                ((int)this + 0x50,SUB41(uVar2,0),(uint)(uVar7 + 1 == uVar2),
                 (_func_void_void_ptr_void_ptr_uint *)0x17,true);
  ...
  if (uVar7 != 0) {
    do {
      ...
      *(char *)(*(long *)(this + 0x50) + 3 + lVar5) =
           (char)*(undefined4 *)(*(long *)(param_1 + 0x30) + 0x28 + lVar8);
      ...
      *(undefined2 *)(*(long *)(this + 0x50) + 7 + lVar5) =
           *(undefined2 *)(*(long *)(param_1 + 0x30) + 8 + lVar8);
      *(undefined2 *)(*(long *)(this + 0x50) + 9 + lVar5) =
           *(undefined2 *)(*(long *)(param_1 + 0x30) + 0x14 + lVar8);
      *(undefined2 *)(*(long *)(this + 0x50) + 0xb + lVar5) =
           *(undefined2 *)(*(long *)(param_1 + 0x30) + 0x18 + lVar8);
      *(undefined2 *)(*(long *)(this + 0x50) + 0x15 + lVar5) =
           *(undefined2 *)(*(long *)(param_1 + 0x60) + lVar6 * 2);
...
/* basisu::basisu_file::create_comp_data(basisu::basisu_backend_output const&) */

void __thiscall
basisu::basisu_file::create_comp_data(basisu_file *this,basisu_backend_output *param_1)

{
  ...
  if (uVar6 + 0x4d >> 0x20 == 0) {
    ...
    if (*(uint *)(this + 0x6c) < uVar11) {
      basisu::elemental_vector::increase_capacity
                (uVar8,SUB41(uVar11,0),0,(_func_void_void_ptr_void_ptr_uint *)0x1,false);
  ...
  *puVar3 = *(undefined8 *)this;
  ...
  puVar3[2] = *(undefined8 *)(this + 0x10);
  puVar3[3] = uVar2;
  uVar2 = *(undefined8 *)(this + 0x28);
  puVar3[4] = *(undefined8 *)(this + 0x20);
  puVar3[5] = uVar2;
  uVar2 = *(undefined8 *)(this + 0x38);
  puVar3[6] = *(undefined8 *)(this + 0x30);
  puVar3[7] = uVar2;
      ...
      if (uVar11 != uVar13) {
        if (uVar11 <= uVar13) {
          ...
          if (*(uint *)(this + 0x6c) < uVar13) {
            basisu::elemental_vector::increase_capacity
                      (uVar8,SUB81(uVar6,0),(uint)(uVar11 + 1 == uVar13),
      ...
      if (uVar6 + uVar10 >> 0x20 == 0) {
        ...
        if (!CARRY4(uVar13,uVar11)) {
          ...
          if (*(uint *)(this + 0x6c) < uVar12) {
            basisu::elemental_vector::increase_capacity
                      (uVar8,SUB41(uVar12,0),(uint)(uVar11 == 1),
                       (_func_void_void_ptr_void_ptr_uint *)0x1,false);
...
/* basisu::basisu_file::fixup_crcs() */

void __thiscall basisu::basisu_file::fixup_crcs(basisu_file *this)

{
  ...
  uVar2 = basist::crc16((void *)(*(long *)(this + 0x60) + 0x4d),(ulong)*(uint *)(this + 0x88) - 0x4d
                        ,0);
...
char __thiscall
basisu::basisu_file::init
          (basisu_file *this,basisu_backend_output *param_1,undefined4 param_3,undefined4 param_4,
...

{
  ...
  *(undefined1 (*) [16])(this + 0x70) = (undefined1  [16])0x0;
  if (bVar2 == (basisu_backend_output)0x0) {
    if (0xfffeffff <
        (ulong)*(uint *)(param_1 + 0x18) + 0x4d + (ulong)*(uint *)(param_1 + 0x28) +
        (ulong)*(uint *)(param_1 + 0x48) + (ulong)*(uint *)(param_1 + 0x38) * 0x17)
    goto LAB_00100a40;
    iVar6 = *(int *)param_1;
...
LAB_00100948:
    uVar5 = *(int *)(param_1 + 0x38) * 0x17 + 0x4d;
  }
  else {
    if (0xfffeffff <
        (ulong)*(uint *)(param_1 + 0x38) * 0x17 + 0x4d + (ulong)*(uint *)(param_1 + 0x48))
    goto LAB_00100a40;
    iVar6 = *(int *)param_1;
    *(undefined4 *)(this + 0x74) = 0x4d;
...
LAB_00100a40:
  basisu::error_printf("basisu_file::init: File is too large!\n");
  return '\0';
}



/* basisu::vector<basist::basis_slice_desc>::object_mover(void*, void*, unsigned int) */

void basisu::vector<basist::basis_slice_desc>::object_mover
...

{
  ...
  if (param_3 != 0) {
    ...
    do {
      ...
      *(undefined2 *)((long)puVar1 + 5) = *(undefined2 *)((long)param_2 + 5);
      *(undefined2 *)((long)puVar1 + 7) = *(undefined2 *)((long)param_2 + 7);
      *(undefined2 *)((long)puVar1 + 9) = *(undefined2 *)((long)param_2 + 9);
      *(undefined2 *)((long)puVar1 + 0xb) = *(undefined2 *)((long)param_2 + 0xb);
...
void basisu::basisu_file::_GLOBAL__sub_I_create_header(void)

...
/* graphite2::Face::runGraphite(graphite2::Segment*, graphite2::Silf const*) const */

undefined8 __thiscall graphite2::Face::runGraphite(Face *this,Segment *param_1,Silf *param_2)

{
  ...
  cVar1 = graphite2::Silf::runGraphite
                    ((Segment *)param_2,(uchar)param_1,'\0',(uint)(byte)param_2[0x2b]);
  if ((cVar1 != '\0') &&
     ((graphite2::Segment::associateChars((int)param_1,0), ((byte)param_2[0x2e] & 0x20) == 0 ||
      (cVar1 = graphite2::Segment::initCollisions(), cVar1 != '\0')))) {
    uVar2 = graphite2::Silf::runGraphite
                      ((Segment *)param_2,(uchar)param_1,(uchar)param_2[0x2b],
...
void __thiscall graphite2::Face::~Face(Face *this)
...
/* graphite2::Face::Face(void const*, gr_face_ops const&) */

void __thiscall graphite2::Face::Face(Face *this,void *param_1,gr_face_ops *param_2)
  ...
  *(undefined8 *)(this + 0x60) = 0;
  ...
  if (uVar1 < 8) {
    if ((uVar2 & 4) != 0) {
      ...
      *(undefined4 *)(this + (uVar2 & 0xffffffff) + 0x4c) =
           *(undefined4 *)(param_2 + ((uVar2 & 0xffffffff) - 4));
      return;
    }
    if ((uVar1 != 0) && (*(gr_face_ops *)(this + 0x50) = *param_2, (uVar2 & 2) != 0)) {
      *(undefined2 *)(this + (uVar2 & 0xffffffff) + 0x4e) =
           *(undefined2 *)(param_2 + ((uVar2 & 0xffffffff) - 2));
      return;
    }
  }
  else {
    *(ulong *)(this + 0x50) = uVar4;
    *(undefined8 *)(this + (uVar2 & 0xffffffff) + 0x48) =
    ...
    if (7 < uVar1) {
      ...
      do {
        uVar4 = (ulong)uVar3;
        uVar3 = uVar3 + 8;
        *(undefined8 *)(((ulong)(this + 0x58) & 0xfffffffffffffff8) + uVar4) =
             *(undefined8 *)
              (param_2 +
              (uVar4 - (long)(this + (0x50 - ((ulong)(this + 0x58) & 0xfffffffffffffff8)))));
      } while (uVar3 < uVar1);
      return;
    }
  }
...
/* graphite2::Face::default_glyph_advance(void const*, unsigned short) */

float graphite2::Face::default_glyph_advance(void *param_1,ushort param_2)

{
  long lVar1;
  
  lVar1 = graphite2::GlyphCache::glyph
                    ((ushort)*(undefined8 *)(*(long *)((long)param_1 + 0x30) + 0x78));
  return *(float *)(lVar1 + 0x10) * *(float *)((long)param_1 + 0x38);
}



/* graphite2::Face::readGraphite(graphite2::Face::Table const&) */

undefined4 __thiscall graphite2::Face::readGraphite(Face *this,Table *param_1)
        ...
        *(Silf **)(this + 0xa0) = pSVar1;
        ...
        do {
          ...
          *(int *)(this + 0x9c) = (int)lVar12 * 0x100 + 3;
          ...
          uVar6 = graphite2::Silf::readGraphite
                            ((uchar *)(*(long *)(this + 0xa0) + lVar12 * 0x58),
                             (ulong)uVar5 + *(long *)(param_1 + 8),(Face *)(ulong)(uVar11 - uVar5),
                             (uint)this);
          if ((char)uVar6 == '\0') {
            return 0;
          }
...
/* graphite2::Face::readFeatures() */

void __thiscall graphite2::Face::readFeatures(Face *this)
...
/* graphite2::Face::setLogger(_IO_FILE*) */

void graphite2::Face::setLogger(_IO_FILE *param_1)
...
/* graphite2::Face::chooseSilf(unsigned int) const */

undefined8 graphite2::Face::chooseSilf(uint param_1)
...
/* graphite2::Face::findPseudo(unsigned int) const */

undefined8 graphite2::Face::findPseudo(uint param_1)

{
  ...
  uVar1 = graphite2::Silf::findPseudo
                    ((uint)*(undefined8 *)(CONCAT44(in_register_0000003c,param_1) + 0xa0));
  return uVar1;
}



/* graphite2::Face::getGlyphMetric(unsigned short, unsigned char) const */

ulong __thiscall graphite2::Face::getGlyphMetric(Face *this,ushort param_1,uchar param_2)
...
/* graphite2::Face::takeFileFace(graphite2::FileFace*) */

void graphite2::Face::takeFileFace(FileFace *param_1)
...
void __thiscall graphite2::Face::Table::release(Table *this)
...
/* graphite2::Face::Table::TEMPNAMEPLACEHOLDERVALUE(graphite2::Face::Table const&&) */

Table * __thiscall graphite2::Face::Table::operator=(Table *this,Table *param_1)
...
/* graphite2::Face::Table::decompress() */

undefined8 __thiscall graphite2::Face::Table::decompress(Table *this)
...
/* graphite2::Face::Table::Table(graphite2::Face const&, graphite2::TtfUtil::Tag, unsigned int) */

void __thiscall
graphite2::Face::Table::Table(Table *this,long param_1,undefined4 param_3,uint param_4)
...
/* graphite2::Face::nameTable() const [clone .part.0] */

NameTable * __thiscall graphite2::Face::nameTable(Face *this)
...
/* graphite2::Face::nameTable() const */

void __thiscall graphite2::Face::nameTable(Face *this)
...
/* graphite2::Face::languageForLocale(char const*) const */

undefined8 graphite2::Face::languageForLocale(char *param_1)
...
/* graphite2::Face::readGlyphs(unsigned int) */

undefined4 __thiscall graphite2::Face::readGlyphs(Face *this,uint param_1)
  ...
  *(GlyphCache **)(this + 0x78) = this_00;
  if (sVar1 == 0) {
    ...
    *(DirectCmap **)(this + 0x80) = this_01;
    if ((*(code **)(lVar2 + 0x18) != Cmap::operator_cast_to_bool) &&
       (uVar3 = (**(code **)(lVar2 + 0x18))(this_01), (char)uVar3 != '\0')) {
      if ((param_1 & 2) == 0) {
        return uVar3;
      }
      if (*(long *)(this + 0x88) != 0) {
...
/* graphite2::Cmap::operator bool() const */

bool __thiscall graphite2::Cmap::operator_cast_to_bool(Cmap *this)
...
void __thiscall graphite2::Cmap::~Cmap(Cmap *this)

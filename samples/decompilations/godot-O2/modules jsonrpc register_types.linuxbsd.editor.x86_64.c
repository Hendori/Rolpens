...
/* uninitialize_jsonrpc_module(ModuleInitializationLevel) */

void uninitialize_jsonrpc_module(void)
...
/* initialize_jsonrpc_module(ModuleInitializationLevel) */

void initialize_jsonrpc_module(int param_1)

{
  if (param_1 != 2) {
    return;
  }
  ClassDB::register_class<JSONRPC>(false);
  return;
}



/* Object* ClassDB::creator<JSONRPC>(bool) */

Object * ClassDB::creator<JSONRPC>(bool param_1)

{
  JSONRPC *this;
  
  this = (JSONRPC *)operator_new(0x1a8,"");
...
/* void ClassDB::register_class<JSONRPC>(bool) */

void ClassDB::register_class<JSONRPC>(bool param_1)

{
  ...
  if ((_unref != 0) && (_DAT_00101064 != 0)) {
    ...
    uVar17 = *(uint *)(_free_static + lVar15 * 4);
    ...
    if (uVar17 != 0) {
      ...
      do {
        if ((uVar13 == uVar17) && (*(char **)(*(long *)(_unref + lVar15 * 8) + 0x10) == local_58)) {
          ...
          if (local_60 == 0) goto LAB_0010028f;
          goto LAB_00100265;
        }
        uVar18 = uVar18 + 1;
        auVar5._8_8_ = 0;
...
LAB_0010028f:
        ...
        *(code **)(puVar16 + 0xa4) = creator<JSONRPC>;
        *(bool *)((long)puVar16 + 0x28b) = param_1;
        *(undefined4 **)(puVar16 + 4) = &JSONRPC::get_class_ptr_static()::ptr;
        *puVar16 = (undefined4)current_api;
        if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) goto LAB_00100487;
        goto LAB_001002d7;
      }
    }
  }

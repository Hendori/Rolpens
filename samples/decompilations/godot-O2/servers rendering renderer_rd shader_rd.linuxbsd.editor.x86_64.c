...
LAB_00106183:
      ...
      if (uVar10 + 1 == lVar9) {
        ...
        lVar13 = puVar7[-1];
LAB_001060d0:
        if (param_1 <= lVar13) goto LAB_00106079;
      }
      else {
        if (lVar13 != 0) {
          puVar4 = (undefined8 *)
...
LAB_00106079:
  ...
  pcVar11 = "resize";
LAB_00106170:
  _err_print_error(pcVar11,"./core/templates/cowdata.h",uVar8,pcVar6,0,0);
  return;
}
...
LAB_00108c5c:
  ...
  goto LAB_001088f7;
LAB_00108d86:
  if (uVar8 <= (uint)uVar22) goto LAB_00108e43;
  puVar10 = (uint *)HashMap<int,LocalVector<int,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,LocalVector<int,unsigned_int,false,false>>>>
                    ::operator[](this_00,local_7c);
  uVar16 = (ulong)*puVar10;
  if (*puVar10 <= (uint)uVar22) {
...
LAB_001088f7:
  ...
  if (lVar20 == 0) goto LAB_00108e0f;
  uVar22 = uVar22 + 1;
  if (*(long *)(lVar20 + -8) <= (long)uVar19) goto LAB_00108de8;
  ...
  if (lVar10 < 0) {
    ...
    if ((*(char *)(lVar11 + lVar10) == '\0') ||
       ((param_1[0x91] = (Version)0x0, this[0x140] != (ShaderRD)0x0 &&
        (cVar3 = _load_from_cache(this,param_1,param_2), cVar3 != '\0')))) goto LAB_0010905b;
...
LAB_00109c4a:
  ...
  (*pcVar2)();
LAB_00109cb2:
  if (*(long *)(lVar10 + -8) <= lVar9) goto LAB_00109d3f;
  lVar4 = *(long *)(this + 0x28);
  if (lVar4 == 0) goto LAB_00109b69;
  lVar13 = *(long *)(lVar4 + -8);
  if (lVar13 <= lVar9) goto LAB_00109b87;
...
LAB_0010a4ba:
    ...
    if (lVar8 < 0) {
      _err_print_error("resize","./core/templates/cowdata.h",0x157,
                       "Condition \"p_size < 0\" is true. Returning: ERR_INVALID_PARAMETER",0,0);
LAB_0010a1d8:
      if (*(long *)(this + 0x18) == 0) goto LAB_0010a4ba;
    ...
    if (*(int *)(pVVar12 + 0x98) == (int)(param_3 >> 0x20)) {
      ...
      *(undefined8 *)(param_1 + 8) = 0;
      ...
      if ((lVar16 * 0x10 == 0) ||
        ...
        puVar13 = *(undefined8 **)(param_1 + 8);
LAB_0010e269:
        if (puVar13 == (undefined8 *)0x0) goto LAB_0010e0d0;
      }
      else {
...
/* WARNING: Removing unreachable block (ram,0x0010f7e0) */
/* WARNING: Removing unreachable block (ram,0x0010f910) */
/* WARNING: Removing unreachable block (ram,0x0010fa89) */
/* WARNING: Removing unreachable block (ram,0x0010f91c) */
/* WARNING: Removing unreachable block (ram,0x0010f926) */
/* WARNING: Removing unreachable block (ram,0x0010fa6b) */
/* WARNING: Removing unreachable block (ram,0x0010f932) */
/* WARNING: Removing unreachable block (ram,0x0010f93c) */
/* WARNING: Removing unreachable block (ram,0x0010fa4d) */
/* WARNING: Removing unreachable block (ram,0x0010f948) */
/* WARNING: Removing unreachable block (ram,0x0010f952) */
/* WARNING: Removing unreachable block (ram,0x0010fa2f) */
/* WARNING: Removing unreachable block (ram,0x0010f95e) */
/* WARNING: Removing unreachable block (ram,0x0010f968) */
/* WARNING: Removing unreachable block (ram,0x0010fa11) */
/* WARNING: Removing unreachable block (ram,0x0010f974) */
/* WARNING: Removing unreachable block (ram,0x0010f97e) */
/* WARNING: Removing unreachable block (ram,0x0010f9f3) */
/* WARNING: Removing unreachable block (ram,0x0010f986) */
/* WARNING: Removing unreachable block (ram,0x0010f990) */
/* WARNING: Removing unreachable block (ram,0x0010f9d8) */
/* WARNING: Removing unreachable block (ram,0x0010f998) */
/* WARNING: Removing unreachable block (ram,0x0010f9ae) */
/* WARNING: Removing unreachable block (ram,0x0010f9ba) */
...
LAB_0010ff9d:
  ...
  if (uVar6 + 1 == lVar5) {
    ...
    lVar9 = puVar7[-1];
LAB_0010fe80:
    if (param_1 <= lVar9) goto LAB_0010fe35;
  }
  else {
    if (lVar9 != 0) {
      puVar4 = (undefined8 *)
...
LAB_0011017a:
  ...
  if (uVar4 + 1 == lVar3) {
    ...
    lVar7 = puVar5[-1];
LAB_00110260:
    if (param_1 <= lVar7) goto LAB_0011020d;
  }
  else {
    if (lVar7 != 0) {
      puVar2 = (undefined8 *)
...
LAB_00110bfa:
    if ((uint)uVar6 < (uint)uVar8) goto LAB_00110c3b;
    lVar12 = 0;
    while( true ) {
    ...
    if (local_58 == (char *)0x0) {
LAB_0011098b:
      if (local_60 == 0) goto LAB_001109a1;
LAB_00110995:
      lVar12 = local_60;
      LOCK();
...
LAB_00112065:
  ...
  if (uVar7 + 1 == lVar6) {
    ...
    lVar9 = puVar5[-1];
LAB_00111f40:
    if (param_1 <= lVar9) goto LAB_00111eef;
  }
  else {
    if (lVar9 != 0) {
      puVar4 = (undefined8 *)
...
LAB_001123a8:
    ...
    iVar35 = 0;
LAB_0011250c:
    if ((float)uVar43 * __LC88 < (float)(iVar35 + 1)) goto LAB_0011252e;
  }
...
LAB_00112c1d:
  ...
  if (uVar6 + 1 == lVar5) {
    ...
    lVar9 = puVar7[-1];
LAB_00112b00:
    if (param_1 <= lVar9) goto LAB_00112ab5;
  }
  else {
    if (lVar9 != 0) {
      puVar4 = (undefined8 *)
...
LAB_00113065:
  ...
  if (uVar7 + 1 == lVar6) {
    ...
    lVar9 = puVar5[-1];
LAB_00112f40:
    if (param_1 <= lVar9) goto LAB_00112ef3;
  }
  else {
    if (lVar9 != 0) {
      puVar4 = (undefined8 *)
...
LAB_00113add:
  ...
  if (uVar10 + 1 == lVar9) {
    ...
    lVar8 = puVar7[-1];
LAB_001139c1:
    if (param_1 <= lVar8) goto LAB_001138c8;
  }
  else {
    if (lVar8 != 0) {
      puVar4 = (undefined8 *)
...
LAB_00113c59:
    if ((float)uVar23 * __LC88 < (float)(iVar28 + 1)) goto LAB_00113c7b;
  }

  ...
  if (cVar3 == '\0') {
    ...
    if (((cVar3 == '\0') &&
       ...
       (((cVar3 = String::operator==(this_00,"glow_blend_mode"), cVar3 == '\0' &&
        ...
        (cVar3 = String::operator==(this_00,"glow_map"), cVar3 == '\0')))) goto LAB_001028ad;
  }
  *(undefined4 *)(param_1 + 0x28) = 2;
LAB_001028ad:
...
LAB_001113bd:
          _err_print_index_error
                    ("operator[]","./core/templates/vector.h",0x38,lVar13,lVar6,"p_index",
...
LAB_00111220:
  (*pcVar5)(uVar2,plVar8,*(undefined8 *)(this + 0x240),this[0x328],local_48,uVar4,uVar7);
  lVar14 = local_40;
  if (local_40 != 0) {
    LOCK();

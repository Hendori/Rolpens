...
void __thiscall
OpenXREyeGazeInteractionExtension::~OpenXREyeGazeInteractionExtension
          (OpenXREyeGazeInteractionExtension *this)
...
/* OpenXREyeGazeInteractionExtension::set_system_properties_and_get_next_pointer(void*) */

OpenXREyeGazeInteractionExtension * __thiscall
OpenXREyeGazeInteractionExtension::set_system_properties_and_get_next_pointer
          (OpenXREyeGazeInteractionExtension *this,void *param_1)

{
  OpenXREyeGazeInteractionExtension *pOVar1;
  
  pOVar1 = (OpenXREyeGazeInteractionExtension *)param_1;
  if (this[8] != (OpenXREyeGazeInteractionExtension)0x0) {
    *(undefined4 *)(this + 0x10) = 0x3b9b3f30;
    pOVar1 = this + 0x10;
...
/* OpenXREyeGazeInteractionExtension::on_register_metadata() */

void OpenXREyeGazeInteractionExtension::on_register_metadata(void)
  ...
  if (OpenXRInteractionProfileMetadata::singleton == (String *)0x0) {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error("on_register_metadata",
                       "modules/openxr/extensions/openxr_eye_gaze_interaction.cpp",0x65,
    ...
    local_60 = 0;
    local_50 = 0x1b;
    local_58 = "XR_EXT_eye_gaze_interaction";
    String::parse_latin1((StrRange *)&local_60);
    local_58 = "/user/eyes_ext";
    local_68 = 0;
    local_50 = 0xe;
    String::parse_latin1((StrRange *)&local_68);
    local_58 = "Eye gaze tracker";
    local_70 = 0;
    local_50 = 0x10;
    ...
    local_50 = 0x1b;
    String::parse_latin1((StrRange *)&local_60);
    local_58 = "/interaction_profiles/ext/eye_gaze_interaction";
    local_68 = 0;
    local_50 = 0x2e;
    String::parse_latin1((StrRange *)&local_68);
    local_58 = "Eye gaze";
    ...
    local_50 = 0;
    String::parse_latin1((StrRange *)&local_60);
    local_58 = "/user/eyes_ext/input/gaze_ext/pose";
    local_68 = 0;
    local_50 = 0x22;
    String::parse_latin1((StrRange *)&local_68);
    local_58 = "/user/eyes_ext";
...
long OpenXREyeGazeInteractionExtension::get_singleton(void)

{
  if (singleton != 0) {
    return singleton;
  }
  _err_print_error("get_singleton","modules/openxr/extensions/openxr_eye_gaze_interaction.cpp",0x2a,
...
{
  this[8] = (OpenXREyeGazeInteractionExtension)0x0;
  *(undefined ***)this = &PTR_get_requested_extensions_00101f10;
  this[0x28] = (OpenXREyeGazeInteractionExtension)0x0;
  singleton = this;
...
/* OpenXREyeGazeInteractionExtension::is_available() */

OpenXREyeGazeInteractionExtension __thiscall
OpenXREyeGazeInteractionExtension::is_available(OpenXREyeGazeInteractionExtension *this)
...
/* OpenXREyeGazeInteractionExtension::supports_eye_gaze_interaction() */
...

{
  ...
  if (this[8] != (OpenXREyeGazeInteractionExtension)0x0) {
    if (*(int *)(this + 0x20) == 0) {
      ...
      pSVar5 = (String *)OS::get_singleton();
      local_58 = 0;
      local_48 = "mobile";
      local_40 = 6;
      String::parse_latin1((StrRange *)&local_58);
      cVar3 = OS::has_feature(pSVar5);
      if (cVar3 != '\0') {
        pSVar5 = (String *)OS::get_singleton();
        local_50 = 0;
        local_40 = 0x26;
        local_48 = "PERMISSION_XR_EXT_eye_gaze_interaction";
        String::parse_latin1((StrRange *)&local_50);
        uVar4 = OS::has_feature(pSVar5);
        lVar2 = local_50;
        if (local_50 != 0) {
          LOCK();
...
/* OpenXREyeGazeInteractionExtension::get_eye_gaze_pose(double, Vector3&) */

undefined8 __thiscall
OpenXREyeGazeInteractionExtension::get_eye_gaze_pose
          (OpenXREyeGazeInteractionExtension *this,double param_1,Vector3 *param_2)

{
  ...
  pSVar3 = OpenXRAPI::singleton;
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (OpenXRAPI::singleton == (String *)0x0) {
    _err_print_error("get_eye_gaze_pose","modules/openxr/extensions/openxr_eye_gaze_interaction.cpp"
                     ,0x71,"Parameter \"openxr_api\" is null.",0,0);
  }
  else {
    if (this[0x28] == (OpenXREyeGazeInteractionExtension)0x0) {
      this[0x28] = (OpenXREyeGazeInteractionExtension)0x1;
      local_b0 = 0;
      local_a8 = "/user/eyes_ext";
      local_a0 = 0xe;
      String::parse_latin1((StrRange *)&local_b0);
      uVar5 = OpenXRAPI::find_tracker(pSVar3);
      lVar2 = local_b0;
...
LAB_001008bc:
        ...
        *plVar1 = *plVar1 + -1;
        UNLOCK();
        if (*plVar1 != 0) goto LAB_001008bc;
        local_b0 = 0;
        Memory::free_static((void *)(lVar2 + -0x10),false);
        lVar2 = *(long *)(this + 0x30);
      }
      if (lVar2 == 0) {
        _err_print_error("get_eye_gaze_pose",
                         "modules/openxr/extensions/openxr_eye_gaze_interaction.cpp",0x78,
                         "Couldn\'t obtain eye tracker",0,1);
      }
      local_b0 = 0;
      local_a8 = "eye_gaze_pose";
      local_b8 = 0;
      local_a0 = 0xd;
      String::parse_latin1((StrRange *)&local_b8);
      uVar5 = OpenXRAPI::find_action(pSVar3,(StrRange *)&local_b8);
      lVar2 = local_b8;
...
LAB_00100926:
      ...
      if (lVar2 == 0) {
        _err_print_error("get_eye_gaze_pose",
                         "modules/openxr/extensions/openxr_eye_gaze_interaction.cpp",0x7d,
                         "Couldn\'t obtain pose action for `eye_gaze_pose`, make sure to add this to your action map."
                         ,0,1);
        goto LAB_0010081a;
      }
      lVar2 = *(long *)(this + 0x30);
...
LAB_0010081a:
      if (*(long *)(this + 0x30) == 0) goto LAB_0010082c;
      lVar2 = *(long *)(this + 0x38);
    }
    if (lVar2 != 0) {
      local_78 = ZEXT416(_LC20);
      local_58 = 1.0;
      local_54 = 0;
      local_4c = 0.0;
      local_90 = 0;
      ...
      local_7c = 0;
      local_68 = local_78;
      iVar4 = OpenXRAPI::get_action_pose
                        (pSVar3,*(undefined8 *)(this + 0x38),*(undefined8 *)(this + 0x30),local_78,
                         &local_90,&local_84);
      if (iVar4 != 0) {
        uVar5 = 1;
        fVar6 = (float)param_1;
        *(float *)(param_2 + 8) = local_58 * fVar6 + local_4c;
        *(ulong *)param_2 =
             CONCAT44(fVar6 * local_68._12_4_ + (float)((ulong)local_54 >> 0x20),
                      fVar6 * local_68._8_4_ + (float)local_54);
        goto LAB_0010082e;
      }
    }
  }
...
/* OpenXREyeGazeInteractionExtension::get_requested_extensions() */

void OpenXREyeGazeInteractionExtension::get_requested_extensions(void)

{
  ...
  *(undefined1 (*) [16])(in_RDI + 0x18) = (undefined1  [16])0x0;
  ...
  StringName::StringName((StringName *)&local_80,"xr/openxr/extensions/eye_gaze_interaction",false);
  ProjectSettings::get_setting_with_override((StringName *)local_58);
  cVar2 = Variant::operator_cast_to_bool((Variant *)local_58);
  if ((bool)cVar2) {
    ...
    local_60 = 6;
    String::parse_latin1((StrRange *)&local_78);
    cVar3 = OS::has_feature(pSVar4);
    if (cVar3 != '\0') {
      pSVar4 = (String *)OS::get_singleton();
      local_68 = "XR_EXT_eye_gaze_interaction";
      local_70 = 0;
      local_60 = 0x1b;
      String::parse_latin1((StrRange *)&local_70);
      cVar2 = OS::has_feature(pSVar4);
      lVar1 = local_70;
      if (local_70 != 0) {
        LOCK();
    ...
    if (cVar2 != '\0') {
      ...
      local_60 = 0x1b;
      String::parse_latin1((StrRange *)&local_70);
      plVar5 = (long *)HashMap<String,bool*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,bool*>>>
...
/* OpenXREyeGazeInteractionExtension::get_suggested_tracker_names() */
...

{
  ...
  pcVar4 = "/user/eyes_ext";
  local_28 = 0;
  uVar5 = 0xe;
  String::parse_latin1((StrRange *)&local_28);
  *(undefined8 *)(this + 8) = 0;
  CowData<String>::_copy_on_write((CowData<String> *)(this + 8));
  puVar3 = (undefined8 *)Memory::alloc_static(0x18,false);
  if (puVar3 == (undefined8 *)0x0) {
    ...
    *(undefined8 **)(this + 8) = puVar3 + 2;
    ...
    puVar3[1] = 1;
    CowData<String>::_copy_on_write((CowData<String> *)(this + 8));
    if (*(long *)*(CowData<char32_t> **)(this + 8) != local_28) {
      CowData<char32_t>::_ref(*(CowData<char32_t> **)(this + 8),(CowData *)&local_28);
    }
  }
  lVar2 = local_28;
  if (local_28 != 0) {
...
LAB_00101ad6:
    ...
    iVar45 = *(int *)(this + 0x2c);
    if (pvVar43 == (void *)0x0) goto LAB_001015b4;
    if (iVar45 != 0) goto LAB_00101ad6;
LAB_001015da:
    ...
    *(void **)(this + 8) = __s_00;
    ...
    if (iVar45 != 0) {
      ...
      uVar55 = *(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x28) * 4);
      if (*(long *)(this + 8) == 0) goto LAB_00101c38;
LAB_00101aca:
      iVar45 = *(int *)(this + 0x2c);
      goto LAB_00101ace;
    }
LAB_001015b4:
    if ((float)uVar39 * __LC22 < (float)(iVar45 + 1)) goto LAB_001015da;
  }
  local_58[0] = 0;
  if (*(long *)param_1 == 0) {
...
LAB_00101863:
    ...
    if (puVar42 != (undefined8 *)0x0) goto LAB_00101870;
LAB_00101aa5:
    ...
    *plVar1 = *plVar1 + -1;
    UNLOCK();
    if (*plVar1 != 0) goto LAB_00101863;
    Memory::free_static((void *)(local_58[0] + -0x10),false);
    puVar42 = *(undefined8 **)(this + 0x20);
    if (puVar42 == (undefined8 *)0x0) goto LAB_00101aa5;
LAB_00101870:
    *puVar42 = pauVar41;

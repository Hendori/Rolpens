...
/* ResourceUID::text_to_id(String const&) const */

ulong __thiscall ResourceUID::text_to_id(ResourceUID *this,String *param_1)
  ...
  if (lVar8 != 0) {
    ...
    if (7 < (uint)lVar3) {
      ...
      do {
        ...
        else if ((lVar8 < 0) || (piVar6 = piVar10, lVar3 <= lVar8)) {
...
ulong __thiscall ResourceUID::create_id(ResourceUID *this)

{
  ...
  while( true ) {
    ...
    iVar10 = CryptoCore::RandomGenerator::get_random_bytes
                       (*(uchar **)(this + 0x178),(ulong)&local_48);
    if (iVar10 != 0) break;
    ...
    while ((uVar14 != (uint)uVar13 ||
           (uVar17 != *(ulong *)(*(long *)(*(long *)(this + 0x1b0) + lVar12 * 8) + 0x10)))) {
      uVar15 = uVar15 + 1;
      auVar3._8_8_ = 0;
      ...
      if ((uVar14 == 0) ||
         ...
         auVar5._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                          (ulong)*(uint *)(this + 0x1d0) * 4) + iVar10) -
                               SUB164(auVar4 * auVar8,8)) * lVar1, auVar9._8_8_ = 0,
         auVar9._0_8_ = uVar16, SUB164(auVar5 * auVar9,8) < uVar15)) goto LAB_001003f0;
    }
    pthread_mutex_unlock(__mutex);
  }
  uVar17 = 0xffffffffffffffff;
  _err_print_error("create_id","core/io/resource_uid.cpp",0x73,
                   "Condition \"err != OK\" is true. Returning: INVALID_ID",0,0);
LAB_001003f0:
  pthread_mutex_unlock(__mutex);
...
void __thiscall ResourceUID::~ResourceUID(ResourceUID *this)
...
/* ResourceUID::has_id(long) const */

undefined1 __thiscall ResourceUID::has_id(ResourceUID *this,long param_1)
    ...
    if (uVar15 != 0) {
      ...
      do {
        if ((uVar15 == (uint)uVar13) &&
           (*(long *)(*(long *)(*(long *)(this + 0x1b0) + lVar12 * 8) + 0x10) == param_1)) {
          uVar14 = 1;
          goto LAB_00100754;
        }
        uVar17 = uVar17 + 1;
...
/* ResourceUID::remove_id(long) */

void __thiscall ResourceUID::remove_id(ResourceUID *this,long param_1)
    ...
    if (uVar35 != 0) {
      ...
      do {
        ...
        uVar39 = SUB164(auVar11 * auVar23,8);
              ...
              (auVar12._8_8_ = 0, auVar12._0_8_ = (ulong)uVar44 * lVar8, auVar24._8_8_ = 0,
              auVar24._0_8_ = uVar45, auVar13._8_8_ = 0,
              auVar13._0_8_ = (ulong)((uVar5 + uVar39) - SUB164(auVar12 * auVar24,8)) * lVar8,
              auVar25._8_8_ = 0, auVar25._0_8_ = uVar45, uVar46 <= SUB164(auVar13 * auVar25,8)));
    }
  }
  _err_print_error("remove_id","core/io/resource_uid.cpp",0xb1,
                   "Condition \"!unique_ids.has(p_id)\" is true.",0,0);
  goto LAB_00100b4c;
  while( true ) {
    ...
    uVar44 = uVar44 + 1;
    if ((uVar35 == 0) ||
       (auVar14._8_8_ = 0, auVar14._0_8_ = (ulong)uVar35 * lVar8, auVar26._8_8_ = 0,
       auVar26._0_8_ = uVar45, auVar15._8_8_ = 0,
       auVar15._0_8_ = (ulong)((uVar5 + uVar39) - SUB164(auVar14 * auVar26,8)) * lVar8,
       auVar27._8_8_ = 0, auVar27._0_8_ = uVar45, uVar36 = uVar41,
       SUB164(auVar15 * auVar27,8) < uVar44)) break;
LAB_001009d2:
    auVar16._8_8_ = 0;
    ...
    if ((uVar37 == uVar35) && (*(long *)(*(long *)(lVar6 + uVar36 * 8) + 0x10) == param_1)) {
      ...
      uVar37 = *puVar43;
      if ((uVar37 != 0) &&
         (auVar17._8_8_ = 0, auVar17._0_8_ = (ulong)uVar37 * lVar8, auVar29._8_8_ = 0,
         auVar29._0_8_ = uVar45, auVar18._8_8_ = 0,
         auVar18._0_8_ = (ulong)((uVar5 + uVar39) - SUB164(auVar17 * auVar29,8)) * lVar8,
         auVar30._8_8_ = 0, auVar30._0_8_ = uVar45, uVar36 = (ulong)uVar39,
        ...
        while( true ) {
          ...
          *puVar4 = uVar9;
          ...
          uVar40 = uVar36;
          if ((uVar37 == 0) ||
             (auVar19._8_8_ = 0, auVar19._0_8_ = (ulong)uVar37 * lVar8, auVar31._8_8_ = 0,
             auVar31._0_8_ = uVar45, auVar20._8_8_ = 0,
             auVar20._0_8_ =
                  (ulong)((SUB164(auVar21 * auVar33,8) + uVar5) - SUB164(auVar19 * auVar31,8)) *
                  lVar8, auVar32._8_8_ = 0, auVar32._0_8_ = uVar45, SUB164(auVar20 * auVar32,8) == 0
             )) break;
...
/* ResourceUID::get_cache_file() */

ResourceUID * __thiscall ResourceUID::get_cache_file(ResourceUID *this)
...
/* ResourceUID::save_to_cache() */

undefined8 __thiscall ResourceUID::save_to_cache(ResourceUID *this)
...
LAB_00100eb6:
  ...
  FileAccess::open((String *)&local_38,(int)(ResourceUID *)&local_50,(Error *)0x2);
  if (local_38 == (Object *)0x0) {
    uVar10 = 0x13;
  }
  else {
    ...
    *(undefined4 *)(this + 0x1d8) = 0;
    while (puVar3 != (undefined8 *)0x0) {
      ...
      if ((puVar3[3] == 0) || (iVar8 = (int)*(undefined8 *)(puVar3[3] + -8), iVar8 == 0)) {
        iVar8 = 0;
      }
      else {
        iVar8 = iVar8 + -1;
    ...
    pthread_mutex_unlock((pthread_mutex_t *)(this + 0x180));
    if (((local_38 != (Object *)0x0) &&
        (cVar7 = RefCounted::unreference(), pOVar6 = local_38, cVar7 != '\0')) &&
       (cVar7 = predelete_handler(local_38), cVar7 != '\0')) {
...
/* ResourceUID::update_cache() */

undefined8 __thiscall ResourceUID::update_cache(ResourceUID *this)
...
LAB_0010119d:
              if (pOVar8 == (Object *)0x0) goto LAB_001012ab;
            }
            else {
          ...
          do {
            ...
            if ((plVar6[3] == 0) || (iVar5 = (int)*(undefined8 *)(plVar6[3] + -8), iVar5 == 0)) {
              iVar5 = 0;
            }
            else {
              iVar5 = iVar5 + -1;
...
LAB_001011e8:
      (**(code **)(*(long *)pOVar8 + 0x1b8))(pOVar8,0);
...
void __thiscall ResourceUID::clear(ResourceUID *this)
...

{
  ...
  *(undefined1 (*) [16])(this + 0x1c0) = (undefined1  [16])0x0;
  ...
  _err_print_error("ResourceUID","core/io/resource_uid.cpp",0x155,
...
/* ResourceUID::add_id(long, String const&) */

void ResourceUID::add_id(long param_1,String *param_2)

{
    ...
    if (uVar16 != 0) {
      ...
      do {
        if ((uVar16 == (uint)uVar15) &&
           (local_70[0] == *(String **)(*(long *)(*(long *)(param_1 + 0x1b0) + lVar14 * 8) + 0x10)))
        {
          _err_print_error("add_id","core/io/resource_uid.cpp",0x82,
                           "Condition \"unique_ids.has(p_id)\" is true.",0,0);
          goto LAB_001016a0;
        }
        uVar18 = uVar18 + 1;
        ...
        iVar11 = SUB164(auVar4 * auVar8,8);
              ...
              auVar6._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                               (ulong)*(uint *)(param_1 + 0x1d0) * 4) + iVar11) -
  ...
  String::utf8();
  if (local_60 == 0) {
    pCVar13 = (CowData<char> *)
              HashMap<long,ResourceUID::Cache,HashMapHasherDefault,HashMapComparatorDefault<long>,DefaultTypedAllocator<HashMapElement<long,ResourceUID::Cache>>>
              ::operator[]((HashMap<long,ResourceUID::Cache,HashMapHasherDefault,HashMapComparatorDefault<long>,DefaultTypedAllocator<HashMapElement<long,ResourceUID::Cache>>>
...
LAB_001016a0:
  pthread_mutex_unlock((pthread_mutex_t *)(param_1 + 0x180));
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
  }
...
/* ResourceUID::set_id(long, String const&) */

void ResourceUID::set_id(long param_1,String *param_2)

{
  ...
  *this;
  ...
  this = (HashMap<long,ResourceUID::Cache,HashMapHasherDefault,HashMapComparatorDefault<long>,DefaultTypedAllocator<HashMapElement<long,ResourceUID::Cache>>>
          *)(param_1 + 0x1a8);
  if ((*(long *)(param_1 + 0x1b0) != 0) && (*(int *)(param_1 + 0x1d4) != 0)) {
    ...
    if (uVar17 != 0) {
      ...
      do {
        if ((uVar17 == (uint)uVar16) &&
           (local_50 == *(String **)(*(long *)(*(long *)(param_1 + 0x1b0) + lVar15 * 8) + 0x10))) {
          String::utf8();
          __s1 = local_48;
          puVar13 = (undefined8 *)
                    HashMap<long,ResourceUID::Cache,HashMapHasherDefault,HashMapComparatorDefault<long>,DefaultTypedAllocator<HashMapElement<long,ResourceUID::Cache>>>
          ...
          if (pcVar2 != (char *)0x0 || __s1 != (char *)0x0) {
            ...
            this_00 = (CowData<char> *)
                      HashMap<long,ResourceUID::Cache,HashMapHasherDefault,HashMapComparatorDefault<long>,DefaultTypedAllocator<HashMapElement<long,ResourceUID::Cache>>>
                      ::operator[](this,(long *)&local_50);
            if (*(char **)this_00 != local_48) {
              CowData<char>::_ref(this_00,(CowData *)&local_48);
            }
            lVar14 = HashMap<long,ResourceUID::Cache,HashMapHasherDefault,HashMapComparatorDefault<long>,DefaultTypedAllocator<HashMapElement<long,ResourceUID::Cache>>>
                     ::operator[](this,(long *)&local_50);
...
LAB_001019a6:
        ...
        iVar11 = SUB164(auVar4 * auVar8,8);
              ...
              (auVar5._8_8_ = 0, auVar5._0_8_ = (ulong)uVar17 * lVar14, auVar9._8_8_ = 0,
  ...
  _err_print_error("set_id","core/io/resource_uid.cpp",0x8b,
                   "Condition \"!unique_ids.has(p_id)\" is true.",0,0);
LAB_001019b8:
  pthread_mutex_unlock((pthread_mutex_t *)(param_1 + 0x180));
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
/* ResourceUID::load_from_cache(bool) */

undefined8 __thiscall ResourceUID::load_from_cache(ResourceUID *this,bool param_1)
...
LAB_00101e5e:
          ...
          _err_print_error("load_from_cache","core/io/resource_uid.cpp",0xf8,
                           "Condition \"c.cs.size() != len + 1\" is true. Returning: ERR_FILE_CORRUPT"
                           ,0,0);
LAB_00101f0d:
          uVar9 = 0x10;
          goto LAB_00101f12;
...
LAB_00101d8f:
        ...
        if (uVar7 != uVar8) {
          _err_print_error("load_from_cache","core/io/resource_uid.cpp",0xfb,
                           "Condition \"rl != len\" is true. Returning: ERR_FILE_CORRUPT",0,0);
...
/* ResourceUID::id_to_text(long) const */

long ResourceUID::id_to_text(long param_1)
...
/* ResourceUID::get_id_path(long) const */

long ResourceUID::get_id_path(long param_1)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (in_RDX == -1) {
    _err_print_error("get_id_path","core/io/resource_uid.cpp",0x9a,
                     "Condition \"p_id == INVALID_ID\" is true. Returning: String()","Invalid UID.",
                     0,0);
    *(undefined8 *)param_1 = 0;
  }
  else {
    ...
    if ((lVar2 != 0) && (*(int *)(in_RSI + 0x1d4) != 0)) {
      ...
      if (uVar26 != 0) {
        uVar28 = 0;
        do {
          if (((uint)uVar25 == uVar26) &&
             (*(long *)(*(long *)(lVar2 + lVar24 * 8) + 0x10) == in_RDX)) {
          ...
          uVar23 = SUB164(auVar5 * auVar13,8);
                ...
                auVar7._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                                 (ulong)*(uint *)(in_RSI + 0x1d0) * 4) + uVar23) -
                                      SUB164(auVar6 * auVar14,8)) * lVar3, auVar15._8_8_ = 0,
                auVar15._0_8_ = uVar27, uVar28 <= SUB164(auVar7 * auVar15,8)));
      }
    }
...
LAB_0010264a:
          if (((uint)uVar25 != uVar26) ||
             (*(long *)(*(long *)(lVar2 + lVar24 * 8) + 0x10) != in_RDX)) goto LAB_00102608;
          lVar2 = *(long *)(lVar2 + (ulong)uVar23 * 8);
LAB_001024fc:
          String::utf8((char *)param_1,(int)*(undefined8 *)(lVar2 + 0x18));
          goto LAB_0010250d;
        }
      }
    }
LAB_00102668:
    id_to_text((long)&local_68);
    local_58 = "Unrecognized UID: \"%s\".";
    local_60 = 0;
    local_50 = 0x17;
    String::parse_latin1((StrRange *)&local_60);
    vformat<String>(&local_58,(StrRange *)&local_60,&local_68);
    _err_print_error("get_id_path","core/io/resource_uid.cpp",0xaa,
                     "Condition \"!cache\" is true. Returning: String()",&local_58,0,0);
    pcVar20 = local_58;
...
LAB_00102608:
  ...
  if ((uVar26 == 0) ||
     ...
     auVar11._0_8_ =
          (ulong)((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(in_RSI + 0x1d0) * 4) + uVar23
                  ) - SUB164(auVar10 * auVar18,8)) * lVar3, auVar19._8_8_ = 0,
     auVar19._0_8_ = uVar27, SUB164(auVar11 * auVar19,8) < uVar28)) goto LAB_00102668;
  goto LAB_0010264a;
}



/* ResourceUID::uid_to_path(String const&) */

ResourceUID * __thiscall ResourceUID::uid_to_path(ResourceUID *this,String *param_1)
...
/* ResourceUID::ensure_path(String const&) */

ResourceUID * __thiscall ResourceUID::ensure_path(ResourceUID *this,String *param_1)
...
/* ResourceUID::path_to_uid(String const&) */

ResourceUID * __thiscall ResourceUID::path_to_uid(ResourceUID *this,String *param_1)
...
/* ResourceUID::get_path_from_cache(Ref<FileAccess>&, String const&) */

ResourceUID * __thiscall
...
LAB_00102b6f:
        _err_print_error("get_path_from_cache","core/io/resource_uid.cpp",uVar9,pcVar8,0,0,uVar7);
        *(undefined8 *)this = 0;
        goto LAB_00102b8f;
      }
...
LAB_00102b19:
      _err_print_index_error
                ("set","./core/templates/cowdata.h",0xcf,lVar13,lVar11,"p_index","size()","",false,
                 false);
LAB_00102a4b:
      plVar1 = *(long **)param_1;
...
/* ResourceUID::_bind_methods() */

void ResourceUID::_bind_methods(void)
...
/* ResourceUID::is_class_ptr(void*) const */

uint __thiscall ResourceUID::is_class_ptr(ResourceUID *this,void *param_1)
...
/* ResourceUID::_getv(StringName const&, Variant&) const */

undefined8 ResourceUID::_getv(StringName *param_1,Variant *param_2)
...
/* ResourceUID::_setv(StringName const&, Variant const&) */

undefined8 ResourceUID::_setv(StringName *param_1,Variant *param_2)
...
/* ResourceUID::_validate_propertyv(PropertyInfo&) const */

void ResourceUID::_validate_propertyv(PropertyInfo *param_1)
...
/* ResourceUID::_property_can_revertv(StringName const&) const */

undefined8 ResourceUID::_property_can_revertv(StringName *param_1)
...
/* ResourceUID::_property_get_revertv(StringName const&, Variant&) const */

undefined8 ResourceUID::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* ResourceUID::_notificationv(int, bool) */

void ResourceUID::_notificationv(int param_1,bool param_2)
...
/* MethodBindT<long, String const&>::_gen_argument_type(int) const */

int __thiscall
MethodBindT<long,String_const&>::_gen_argument_type
          (MethodBindT<long,String_const&> *this,int param_1)
...
/* MethodBindT<long, String const&>::get_argument_meta(int) const */

long __thiscall
MethodBindT<long,String_const&>::get_argument_meta
          (MethodBindT<long,String_const&> *this,int param_1)
...
void __thiscall MethodBindT<long,String_const&>::~MethodBindT(MethodBindT<long,String_const&> *this)
...
/* ResourceUID::_bind_methods() [clone .cold] */
...
/* ResourceUID::_get_class_namev() const */

undefined8 * ResourceUID::_get_class_namev(void)
...
LAB_00103dc3:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"ResourceUID");
      goto LAB_00103e2e;
    }
  }
  StringName::assign_static_unique_class_name
...
/* ResourceUID::get_class() const */

void ResourceUID::get_class(void)
...
/* ResourceUID::is_class(String const&) const */

undefined8 __thiscall ResourceUID::is_class(ResourceUID *this,String *param_1)
...
/* ResourceUID::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void ResourceUID::_get_property_listv(List *param_1,bool param_2)
...
/* WARNING: Removing unreachable block (ram,0x00104fa8) */
/* WARNING: Removing unreachable block (ram,0x00105170) */
/* WARNING: Removing unreachable block (ram,0x00104fb4) */
/* WARNING: Removing unreachable block (ram,0x00104fbe) */
/* WARNING: Removing unreachable block (ram,0x00105150) */
/* WARNING: Removing unreachable block (ram,0x00104fca) */
/* WARNING: Removing unreachable block (ram,0x00104fd4) */
/* WARNING: Removing unreachable block (ram,0x00105130) */
/* WARNING: Removing unreachable block (ram,0x00104fe0) */
/* WARNING: Removing unreachable block (ram,0x00104fea) */
/* WARNING: Removing unreachable block (ram,0x00105110) */
/* WARNING: Removing unreachable block (ram,0x00104ff6) */
/* WARNING: Removing unreachable block (ram,0x00105000) */
/* WARNING: Removing unreachable block (ram,0x001050f0) */
/* WARNING: Removing unreachable block (ram,0x0010500c) */
/* WARNING: Removing unreachable block (ram,0x00105016) */
/* WARNING: Removing unreachable block (ram,0x001050d0) */
/* WARNING: Removing unreachable block (ram,0x00105022) */
/* WARNING: Removing unreachable block (ram,0x0010502c) */
/* WARNING: Removing unreachable block (ram,0x001050b0) */
/* WARNING: Removing unreachable block (ram,0x00105034) */
/* WARNING: Removing unreachable block (ram,0x0010504a) */
/* WARNING: Removing unreachable block (ram,0x00105056) */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashMap<long, ResourceUID::Cache, HashMapHasherDefault, HashMapComparatorDefault<long>,
   DefaultTypedAllocator<HashMapElement<long, ResourceUID::Cache> > >::operator[](long const&) */
  ...
  if (local_88 == (void *)0x0) {
    ...
    *(void **)(this + 8) = local_88;
    if (uVar46 == 0) {
      ...
      if ((pvVar3 < (void *)((long)local_88 + uVar38)) &&
         (local_88 < (void *)((long)pvVar3 + uVar39))) {
        uVar39 = 0;
        do {
      ...
      if (uVar43 != 0) {
        ...
        do {
          if ((uVar43 == (uint)uVar53) &&
             (lVar49 == *(long *)(*(long *)((long)local_88 + lVar44 * 8) + 0x10))) {
          ...
          uVar52 = SUB164(auVar5 * auVar21,8);
                ...
                (auVar6._8_8_ = 0, auVar6._0_8_ = (ulong)uVar43 * lVar45, auVar22._8_8_ = 0,
                auVar22._0_8_ = uVar48, auVar7._8_8_ = 0,
                auVar7._0_8_ = (ulong)((uVar52 + uVar46) - SUB164(auVar6 * auVar22,8)) * lVar45,
                auVar23._8_8_ = 0, auVar23._0_8_ = uVar48, uVar51 <= SUB164(auVar7 * auVar23,8)));
      }
      local_50 = 0;
      local_58 = 0;
LAB_00105796:
      uVar53 = CONCAT44(0,*(uint *)(hash_table_size_primes + uVar39 * 4));
      lVar45 = *(long *)(hash_table_size_primes_inv + uVar39 * 8);
      uVar38 = lVar49 * 0x3ffff - 1;
      uVar38 = (uVar38 ^ uVar38 >> 0x1f) * 0x15;
      uVar38 = (uVar38 ^ uVar38 >> 0xb) * 0x41;
      ...
      if (uVar46 != 0) {
        uVar52 = 0;
        do {
          if (((uint)uVar55 == uVar46) &&
             (*(long *)(*(long *)((long)local_88 + lVar44 * 8) + 0x10) == lVar49)) {
          ...
          uVar43 = SUB164(auVar17 * auVar33,8);
                ...
                (auVar18._8_8_ = 0, auVar18._0_8_ = (ulong)uVar46 * lVar45, auVar34._8_8_ = 0,
                auVar34._0_8_ = uVar53, auVar19._8_8_ = 0,
                auVar19._0_8_ =
                     (ulong)((*(uint *)(hash_table_size_primes + uVar39 * 4) + uVar43) -
                            SUB164(auVar18 * auVar34,8)) * lVar45, auVar35._8_8_ = 0,
                auVar35._0_8_ = uVar53, uVar52 <= SUB164(auVar19 * auVar35,8)));
      }
    }
  }
LAB_001053e1:
  if ((float)uVar48 * __LC28 < (float)(iVar42 + 1)) {
  ...
  lVar49 = *param_1;
  pauVar41 = (undefined1 (*) [16])operator_new(0x28,"");
  pauVar41[2][0] = 0;
  *(long *)pauVar41[1] = lVar49;
  ...
  *(undefined1 (**) [16])(this + 0x20) = pauVar41;
  ...
  auVar12._8_8_ = 0;
  auVar12._0_8_ = uVar48 * lVar49;
  auVar28._8_8_ = 0;
  auVar28._0_8_ = uVar39;
  lVar44 = SUB168(auVar12 * auVar28,8);
  lVar45 = *(long *)(this + 8);
  ...
  *(undefined1 (**) [16])(lVar45 + lVar44 * 8) = pauVar36;
  *puVar1 = uVar52;
  *(int *)(this + 0x2c) = *(int *)(this + 0x2c) + 1;
LAB_001053ab:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
/* MethodBind* create_method_bind<ResourceUID, String, long>(String (ResourceUID::*)(long) const) */

MethodBind * create_method_bind<ResourceUID,String,long>(_func_String_long *param_1)
...
MethodBind * create_method_bind<ResourceUID,long,String_const&>(_func_long_String_ptr *param_1)
...
/* MethodBind* create_method_bind<ResourceUID, long>(long (ResourceUID::*)()) */

MethodBind * create_method_bind<ResourceUID,long>(_func_long *param_1)
...
/* MethodBind* create_method_bind<ResourceUID, bool, long>(bool (ResourceUID::*)(long) const) */

MethodBind * create_method_bind<ResourceUID,bool,long>(_func_bool_long *param_1)
...
MethodBind * create_method_bind<ResourceUID,long,String_const&>(_func_void_long_String_ptr *param_1)
...
/* MethodBind* create_method_bind<ResourceUID, long>(void (ResourceUID::*)(long)) */

MethodBind * create_method_bind<ResourceUID,long>(_func_void_long *param_1)
...
/* ResourceUID::_initialize_classv() */

void ResourceUID::_initialize_classv(void)
...
/* WARNING: Removing unreachable block (ram,0x00106668) */
/* WARNING: Removing unreachable block (ram,0x00106830) */
/* WARNING: Removing unreachable block (ram,0x00106674) */
/* WARNING: Removing unreachable block (ram,0x0010667e) */
/* WARNING: Removing unreachable block (ram,0x00106810) */
/* WARNING: Removing unreachable block (ram,0x0010668a) */
/* WARNING: Removing unreachable block (ram,0x00106694) */
/* WARNING: Removing unreachable block (ram,0x001067f0) */
/* WARNING: Removing unreachable block (ram,0x001066a0) */
/* WARNING: Removing unreachable block (ram,0x001066aa) */
/* WARNING: Removing unreachable block (ram,0x001067d0) */
/* WARNING: Removing unreachable block (ram,0x001066b6) */
/* WARNING: Removing unreachable block (ram,0x001066c0) */
/* WARNING: Removing unreachable block (ram,0x001067b0) */
/* WARNING: Removing unreachable block (ram,0x001066cc) */
/* WARNING: Removing unreachable block (ram,0x001066d6) */
/* WARNING: Removing unreachable block (ram,0x00106790) */
/* WARNING: Removing unreachable block (ram,0x001066e2) */
/* WARNING: Removing unreachable block (ram,0x001066ec) */
...
/* WARNING: Removing unreachable block (ram,0x00106716) */
...
void MethodBindT<long,String_const&>::validated_call
...

{
  ...
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Load size is inaccurate */
                    /* WARNING: Could not recover jumptable at 0x00106fff. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
...
void call_with_variant_args_dv<__UnexistingClass,long,String_const&>
               (__UnexistingClass *param_1,_func_void_long_String_ptr *param_2,Variant **param_3,
...
Object * MethodBindT<long,String_const&>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)

{
  ...
  call_with_variant_args_dv<__UnexistingClass,long,String_const&>
            (p_Var4,(_func_void_long_String_ptr *)param_2[0xb],(Variant **)param_2[0xc],(int)param_4
             ,in_R8,in_R9);
  *(undefined4 *)param_1 = 0;
  *(undefined1 (*) [16])(param_1 + 8) = (undefined1  [16])0x0;
LAB_001098f6:

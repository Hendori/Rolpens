...
/* JoltShapeInstance3D::ShapeReference::ShapeReference(JoltShapedObject3D*, JoltShape3D*) */

void __thiscall
JoltShapeInstance3D::ShapeReference::ShapeReference
          (ShapeReference *this,JoltShapedObject3D *param_1,JoltShape3D *param_2)
...
void __thiscall
JoltShapeInstance3D::ShapeReference::ShapeReference(ShapeReference *this,ShapeReference *param_1)
...
void __thiscall JoltShapeInstance3D::ShapeReference::~ShapeReference(ShapeReference *this)
...
JoltShapeInstance3D::JoltShapeInstance3D
          (JoltShapeInstance3D *this,JoltShapedObject3D *param_1,JoltShape3D *param_2,
          Transform3D *param_3,Vector3 *param_4,bool param_5)
...
/* JoltShapeInstance3D::get_aabb() const */

void JoltShapeInstance3D::get_aabb(void)

{
  ...
  local_90[1] = 0.0;
  local_90[2] = 0.0;
  local_b0 = CONCAT44((float)((ulong)local_78 >> 0x20) + (float)((ulong)local_6c >> 0x20),
                      (float)local_78 + (float)local_6c);
  ...
  *(ulong *)((long)in_RDI + 0xc) =
       CONCAT44(SUB84(local_90._0_8_,4) - (float)((ulong)local_a0 >> 0x20),
                (float)local_90._0_8_ - (float)local_a0);
...
/* JoltShapeInstance3D::try_build() */

undefined1 __thiscall JoltShapeInstance3D::try_build(JoltShapeInstance3D *this)

{
  ...
  if (this[0x5c] != (JoltShapeInstance3D)0x0) {
    uVar3 = 0;
    _err_print_error("try_build","modules/jolt_physics/shapes/jolt_shape_instance_3d.cpp",0x56,
                     "Condition \"is_disabled()\" is true. Returning: false",0,0);
    goto LAB_001003a2;
  }
  ...
  if (local_30 == (long *)0x0) {
    ...
    *(undefined8 *)(this + 0x50) = 0;
LAB_00100391:
    if (local_30 == (long *)0x0) goto LAB_001003a2;
  }
  else {
...
void JoltShapeInstance3D::ShapeReference::_GLOBAL__sub_I_ShapeReference(void)

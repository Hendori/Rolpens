...
/* OT::_hb_ot_name_entry_cmp_key(void const*, void const*, bool) [clone .part.0] */

int OT::_hb_ot_name_entry_cmp_key(void *param_1,void *param_2,bool param_3)

{
  ...
  if (*(long *)((long)param_1 + 8) == 0) {
    ...
    if (*(long *)((long)param_2 + 8) != 0) {
      ...
      if (((!param_3) && (iVar1 != 0)) &&
         (iVar2 = hb_language_matches(*(undefined8 *)((long)param_2 + 8),
                                      *(undefined8 *)((long)param_1 + 8)), iVar2 != 0)) {
        return 0;
      }
    }
  }
...
LAB_001005e4:
  local_70 = (accelerator_t *)&_hb_NullPool;
LAB_001000ee:
  if (param_3 == 0) {
...
LAB_001002e1:
        iVar20 = uVar21 + 1;
LAB_001002e5:
        if (iVar19 < iVar20) goto LAB_00100320;
        goto LAB_001002e9;
      }
...
LAB_00100182:
      puVar12 = *(undefined **)(local_70 + 0x10);
      puVar5 = &_hb_NullPool;
      ...
      if (*(ushort *)((long)piVar13 + 6) <
          (ushort)(*(ushort *)(puVar16 + 2) << 8 | *(ushort *)(puVar16 + 2) >> 8)) {
            ...
            if (puVar6 < puVar18) {
              while (puVar7 < param_5 + (uVar21 - 1)) {
                ...
                if (uVar10 - 0xd800 < 0x800) {
                  if (((0xdbff < uVar10) || (puVar18 <= puVar17)) ||
                     (uVar15 = puVar6[1] << 8 | puVar6[1] >> 8, 0x3ff < uVar15 - 0xdc00)) {
                    uVar10 = 0xfffd;
                    goto LAB_00100421;
                  }
...
LAB_00100421:
                ...
                if ((puVar7 == puVar9) || (puVar6 = puVar17, puVar7 = puVar9, puVar18 <= puVar17))
                break;
              }
            }
        ...
        uVar21 = 0;
        if ((param_4 != (uint *)0x0) && (uVar21 = *param_4, uVar21 != 0)) {
          *param_4 = uVar21 - 1;
          if ((param_5 < param_5 + (uVar21 - 1)) && (puVar7 = param_5, puVar6 < puVar18)) {
            do {
              uVar10 = *puVar6;
              ...
              puVar17 = puVar7 + 1;
              *puVar7 = uVar15;
            } while ((puVar17 < param_5 + (uVar21 - 1)) && (puVar7 = puVar17, puVar6 < puVar18));
...
LAB_00100969:
        iVar20 = uVar21 + 1;
LAB_0010096d:
        if (iVar19 < iVar20) goto LAB_001009b0;
        goto LAB_00100971;
      }
...
LAB_00100802:
      puVar11 = *(undefined **)(local_70 + 0x10);
      puVar5 = &_hb_NullPool;
      ...
      if (*(ushort *)((long)piVar12 + 6) <
          (ushort)(*(ushort *)(puVar17 + 2) << 8 | *(ushort *)(puVar17 + 2) >> 8)) {
      ...
      if (*(ushort *)(piVar12 + 1) < 10) {
        ...
        if (param_4 != (uint *)0x0) {
          ...
          if (uVar21 != 0) {
            *param_4 = uVar21 - 1;
            if ((param_5 < param_5 + (uVar21 - 1)) &&
               (puVar7 = puVar6, puVar13 = param_5, puVar6 < puVar18)) {
              do {
                puVar6 = puVar7 + 1;
                ...
                if (uVar9 - 0xd800 < 0x800) {
                  if ((uVar9 < 0xdc00 && bVar22) &&
                     (uVar16 = puVar7[1] << 8 | puVar7[1] >> 8, bVar22 = uVar9 < 0xdc00 && bVar22,
                     uVar16 - 0xdc00 < 0x400)) {
                    puVar6 = puVar7 + 2;
                    bVar22 = puVar6 < puVar18;
                ...
                puVar14 = puVar13 + 1;
                *puVar13 = uVar10;
              } while ((puVar14 < param_5 + (uVar21 - 1)) &&
                      (puVar7 = puVar6, puVar13 = puVar14, bVar22));
          ...
          *param_4 = uVar21 - 1;
          if ((puVar6 < puVar18) && (puVar13 = param_5, param_5 < param_5 + (uVar21 - 1))) {
            do {
              ...
              puVar14 = puVar13 + 1;
              *puVar13 = uVar10;
            } while ((puVar14 < param_5 + (uVar21 - 1)) && (puVar13 = puVar14, puVar6 < puVar18));
...
LAB_00100f09:
        iVar20 = uVar21 + 1;
LAB_00100f0d:
        if (iVar19 < iVar20) goto LAB_00100f50;
        goto LAB_00100f11;
      }
      iVar4 = OT::_hb_ot_name_entry_cmp_key(local_58,piVar13,false);
      if (iVar4 < 0) {
          ...
          if (puVar6 < puVar14) {
            while (param_5 < pbVar12) {
              ...
              if (uVar16 - 0xd800 < 0x800) {
                if (((uVar21 < 0xdc00) && (puVar7 < puVar14)) &&
                   (uVar9 = puVar6[1] << 8 | puVar6[1] >> 8, uVar9 - 0xdc00 < 0x400)) {
                  if (3 < (long)pbVar12 - (long)param_5) {
                    puVar7 = puVar6 + 2;
                    pbVar18 = param_5 + 4;
                    uVar21 = uVar9 + 0xfca02400 + uVar21 * 0x400;
                    *(uint *)param_5 =
                         CONCAT13(((byte)uVar21 & 0x3f) + _LC1._3_1_,
                                  CONCAT12(((byte)(uVar21 >> 6) & 0x3f) + _LC1._2_1_,
                                           CONCAT11(((byte)(uVar21 >> 0xc) & 0x3f) + _LC1._1_1_,
                                                    (char)(uVar21 >> 0x12) + (char)_LC1)));
                    goto LAB_00101065;
                  }
                  break;
                }
LAB_0010122f:
                uVar21 = 0xfffd;
LAB_001011ce:
                if ((long)pbVar12 - (long)param_5 < 3) break;
                pbVar18 = param_5 + 3;
...
LAB_00101065:
              if ((param_5 == pbVar18) || (puVar6 = puVar7, param_5 = pbVar18, puVar14 <= puVar7))
              break;
            }
          }
          ...
          *param_4 = uVar21 - 1;
          ...
          if (puVar6 < puVar14) {
            while (pbVar12 < param_5 + (uVar21 - 1)) {
              ...
              if ((pbVar12 == pbVar18) || (puVar6 = puVar7, pbVar12 = pbVar18, puVar14 <= puVar7))
              break;
            }
          }
...
ulong OT::_hb_ot_name_entry_cmp(void *param_1,void *param_2)
    ...
    do {
      ...
      if (local_50 < p_Var15) {
        do {
          ...
          p_Var10 = p_Var8;
          if ((iVar7 == 0) && (p_Var10 = p_Var8 + 0x10, p_Var8 < p_Var12)) {
...
LAB_001014e0:
        ...
        if ((param_4 != (_func_int_void_ptr_void_ptr *)0x0) &&
...
/* OT::name::sanitize_records(hb_sanitize_context_t*) const */

undefined8 __thiscall OT::name::sanitize_records(name *this,hb_sanitize_context_t *param_1)

{
  ...
  if ((ulong)((long)(this + 6) - *(long *)(param_1 + 8)) <= (ulong)*(uint *)(param_1 + 0x18)) {
    ...
    if (((uint)(iVar5 * 4) <= (uint)((int)*(undefined8 *)(param_1 + 0x10) - (int)(this + 6))) &&
       (iVar5 = *(int *)(param_1 + 0x1c) + iVar5 * -4, *(int *)(param_1 + 0x1c) = iVar5, 0 < iVar5))
    {
      if (uVar3 != 0) {
        ...
        do {
          ...
          lVar6 = *(long *)(param_1 + 8);
          uVar4 = (ulong)*(uint *)(param_1 + 0x18);
          if (uVar4 < (ulong)((long)(this + (ulong)(ushort)(*(ushort *)(pnVar2 + -2) << 8 |
                                                           *(ushort *)(pnVar2 + -2) >> 8) +
                                            (ulong)(ushort)(uVar1 << 8 | uVar1 >> 8)) - lVar6)) {
            return 0;
          }
          uVar7 = (uint)(ushort)(*(ushort *)(pnVar2 + -4) << 8 | *(ushort *)(pnVar2 + -4) >> 8);
          if ((uint)((int)*(undefined8 *)(param_1 + 0x10) -
                    (int)(this + (ulong)(ushort)(*(ushort *)(pnVar2 + -2) << 8 |
                                                *(ushort *)(pnVar2 + -2) >> 8) +
                                 (ulong)(ushort)(uVar1 << 8 | uVar1 >> 8))) < uVar7) {
            return 0;
          }
...
long hb_table_lazy_loader_t<AAT::ltag,33u,false>::create(hb_face_t *param_1)
...
void __thiscall OT::name::accelerator_t::accelerator_t(accelerator_t *this,hb_face_t *param_1)

{
  ...
  *(undefined8 *)(this + 0x20) = 0;
  ...
  do {
    ...
    if (((ushort)(*(ushort *)this_00 << 8 | *(ushort *)this_00 >> 8) < 2) &&
       ((ulong)((long)pnVar1 - (long)this_00) <= (ulong)local_70)) {
      uVar19 = *(ushort *)(this_00 + 2) << 8 | *(ushort *)(this_00 + 2) >> 8;
      iVar20 = (uint)uVar19 + (uint)uVar19 * 2;
      iVar15 = (int)(this_00 + local_70);
      if (((uint)(iVar20 * 4) <= (uint)(iVar15 - (int)pnVar1)) &&
         (local_6c = local_6c + iVar20 * -4, 0 < (int)local_6c)) {
        uVar26 = (uint)(ushort)(*(ushort *)(this_00 + 4) << 8 | *(ushort *)(this_00 + 4) >> 8);
        if ((uVar26 <= (uint)(iVar15 - (int)this_00)) &&
           (local_6c = local_6c - uVar26, 0 < (int)local_6c)) {
          ...
          if (cVar3 != '\0') {
            ...
            if (local_5c == 0) {
              ...
              lVar5 = local_58;
              if (1 < (ushort)(*(ushort *)this_00 << 8 | *(ushort *)this_00 >> 8))
              goto LAB_00102343;
              if ((ulong)local_70 < (ulong)((long)pnVar1 - local_80._0_8_)) goto LAB_00102343;
              uVar19 = *(ushort *)(this_00 + 2) << 8 | *(ushort *)(this_00 + 2) >> 8;
              iVar15 = (uint)uVar19 + (uint)uVar19 * 2;
              if ((((((uint)(local_80._8_4_ - (int)pnVar1) < (uint)(iVar15 * 4)) ||
                    (local_6c = local_6c + iVar15 * -4, (int)local_6c < 1)) ||
                   ((ulong)local_70 < (ulong)((long)this_00 - local_80._0_8_))) ||
                  ((uVar26 = (uint)(ushort)(*(ushort *)(this_00 + 4) << 8 |
                                           *(ushort *)(this_00 + 4) >> 8),
                   (uint)(local_80._8_4_ - (int)this_00) < uVar26 ||
                   (local_6c = local_6c - uVar26, (int)local_6c < 1)))) ||
                 (cVar3 = sanitize_records(this_00,(hb_sanitize_context_t *)local_88),
                 lVar5 = local_58, local_5c != 0)) goto LAB_00102343;
              hb_blob_destroy(local_58);
              local_58 = 0;
              local_70 = 0;
...
LAB_0010238c:
    ...
    if (uVar13 < uVar26) {
      if (uVar26 < 0x10000000) {
        pvVar7 = *(void **)(this + 0x20);
LAB_00101dde:
        pvVar7 = realloc(pvVar7,(ulong)uVar26 << 4);
        if (pvVar7 == (void *)0x0) {
...
LAB_00101e8c:
          *(undefined8 *)(puVar16 + 2) = uVar9;
          ...
          bVar28 = uVar25 == 3;
          if ((uVar19 != 10) || (uVar22 = 0, !bVar28)) goto LAB_00101f8a;
        }
        else {
          if (uVar25 == 1) {
...
LAB_00101e2c:
            ...
            if (lVar5 == 0) {
              if (*(hb_face_t **)(param_1 + 0x70) == (hb_face_t *)0x0) {
                ...
                lVar5 = hb_table_lazy_loader_t<AAT::ltag,33u,false>::create
                                  (*(hb_face_t **)(param_1 + 0x70));
                if (lVar5 == 0) {
                  lVar5 = hb_blob_get_empty();
                  LOCK();
                  lVar11 = *(long *)phVar2;
            ...
            if (uVar13 < (uVar27 >> 0x18 | (uVar27 & 0xff0000) >> 8 | (uVar27 & 0xff00) << 8 |
                         uVar27 << 0x18)) {
              p_Var8 = p_Var12 + (ulong)(uVar13 + 1) * 4 + 8;
            }
            uVar9 = hb_language_from_string
                              (p_Var12 + (ushort)(*(ushort *)p_Var8 << 8 | *(ushort *)p_Var8 >> 8),
                               *(ushort *)(p_Var8 + 2) << 8 | *(ushort *)(p_Var8 + 2) >> 8);
            uVar25 = *puVar18 << 8 | *puVar18 >> 8;
            goto LAB_00101e8c;
          }
          uVar19 = puVar18[1];
...
LAB_00101f8a:
          ...
          if (((((uVar19 != 6) || (uVar22 = 1, bVar29)) && ((uVar19 != 4 || (uVar22 = 2, bVar29))))
              && ((!bVar28 || (uVar22 = 3, uVar19 != 1)))) &&
             ((uVar19 != 3 || (uVar22 = 4, bVar29)))) {
            if (uVar19 == 2) {
              uVar22 = 5;
              if (bVar29) {
LAB_00101fff:
                ...
                if (((uVar19 != 0 || uVar25 != 0) && ((!bVar28 || (uVar22 = 8, uVar19 != 0)))) &&
                   ((uVar25 != 1 || (uVar22 = 10, uVar19 != 0)))) {
                  uVar22 = 0x2a;
                }
              }
            }
            else if ((bVar29) || (uVar22 = 6, uVar19 != 1)) goto LAB_00101fff;
          }
        }
    ...
    pvVar7 = *(void **)(this + 0x20);
LAB_0010213c:
    sort_r_simple<>(pvVar7,uVar6,0x101320,p_Var12);
    ...
    piVar10 = __ptr;
    do {
      if ((((short)piVar10[1] != 0x2a) && (*(long *)(piVar10 + 2) != 0)) &&
         ((uVar14 == 0 ||
          ((__ptr[(ulong)(uVar14 - 1) * 4] != *piVar10 ||
           (*(long *)(piVar10 + 2) != *(long *)(__ptr + (ulong)(uVar14 - 1) * 4 + 2))))))) {

...
LAB_001016cd:
        if (param_3 == uVar13) goto LAB_00101200;
LAB_001016d6:
...
LAB_0010146d:
        if (uVar13 == param_3) goto LAB_00101200;
        uVar10 = (ulong)(param_3 - 1);
        uVar7 = (ulong)uVar13;
        uVar11 = *(uint *)(lVar4 + 8 + uVar7 * 0x14);
        uVar15 = *(uint *)(lVar4 + 8 + uVar10 * 0x14);
      ...
      if (pLVar9 + (6 - *(long *)(param_1 + 8)) <= (LigGlyph *)(ulong)*(uint *)(param_1 + 0x18)) {
        ...
        if ((ushort)((uVar5 << 8 | uVar5 >> 8) - 1) < 3) {
          ...
          if ((((LigGlyph *)(ulong)*(uint *)(param_1 + 0x18) < pLVar9 + -*(long *)(param_1 + 8)) ||
             ...
             (int)(iVar6 - uVar7) < 1)) goto LAB_00102060;
        }
        goto LAB_00101f30;
      }
LAB_00102060:
...
LAB_00102552:
                if ((uVar4 * 2 <= (uint)((int)*(undefined8 *)(param_1 + 0x10) - ((int)pMVar5 + 4)))
                   && (iVar3 = *(int *)(param_1 + 0x1c) + uVar4 * -2,
                      *(int *)(param_1 + 0x1c) = iVar3, 0 < iVar3)) goto LAB_001024d0;
              }
            }
            else {
...
LAB_00102ac9:
      ...
      if ((((ulong)((long)pGVar8 - *(long *)(param_1 + 8)) <= (ulong)*(uint *)(param_1 + 0x18)) &&
         ...
         uVar3 <= (uint)((int)*(undefined8 *)(param_1 + 0x10) - (int)pGVar8))) goto LAB_00102ac9;
    }
  }
  if (0x1f < *(uint *)(param_1 + 0x2c)) {
    return 0;
...
LAB_00103db0:
              ...
              if ((((1L << ((byte)(uVar5 >> 4) & 0x3f) & *local_1d8) == 0) ||
                 ...
                 ((1L << ((byte)(uVar5 >> 9) & 0x3f) & local_1d8[2]) == 0)) goto LAB_00103b44;

...
void __thiscall
RendererCompositorStorage::RendererCompositorStorage(RendererCompositorStorage *this)
...
/* RendererCompositorStorage::compositor_effect_initialize(RID) */

void __thiscall
RendererCompositorStorage::compositor_effect_initialize
          (RendererCompositorStorage *this,ulong param_2)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x2c))) {
    puVar1 = (undefined1 *)
             ...
             ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x28)) * 0x28);
...
LAB_00100364:
  Callable::~Callable((Callable *)&local_40);
...
void __thiscall
RendererCompositorStorage::compositor_effect_set_callback
          (RendererCompositorStorage *this,ulong param_2,undefined4 param_3,Callable *param_4)

{
  ...
  _err_print_error("compositor_effect_set_callback",
                   "servers/rendering/storage/compositor_storage.cpp",0x4f,
                   "Parameter \"effect\" is null.",0,0);
  return;
}



/* RendererCompositorStorage::compositor_effect_set_enabled(RID, bool) */

void __thiscall
RendererCompositorStorage::compositor_effect_set_enabled
          (RendererCompositorStorage *this,ulong param_2,char param_3)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x2c))) {
    pcVar1 = (char *)(*(long *)(*(long *)(this + 0x18) +
                               ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x28)) * 8) +
                     ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x28)) * 0x28);
  ...
  _err_print_error("compositor_effect_set_enabled",
                   "servers/rendering/storage/compositor_storage.cpp",0x57,
                   "Parameter \"effect\" is null.",0,0);
  return;
}
...
/* RendererCompositorStorage::compositor_effect_get_enabled(RID) const */

undefined1 __thiscall
RendererCompositorStorage::compositor_effect_get_enabled
          (RendererCompositorStorage *this,ulong param_2)

{
  ...
  _err_print_error("compositor_effect_get_enabled",
                   "servers/rendering/storage/compositor_storage.cpp",0x66,
                   "Parameter \"effect\" is null.",0,0);
  return 0;
}
...
/* RendererCompositorStorage::compositor_effect_get_callback_type(RID) const */

undefined4 __thiscall
RendererCompositorStorage::compositor_effect_get_callback_type
          (RendererCompositorStorage *this,ulong param_2)

{
  ...
  _err_print_error("compositor_effect_get_callback_type",
                   "servers/rendering/storage/compositor_storage.cpp",0x6d,
                   "Parameter \"effect\" is null.",0,0);
  return 5;
}
...
/* RendererCompositorStorage::compositor_effect_get_callback(RID) const */

Callable *
RendererCompositorStorage::compositor_effect_get_callback
          (Callable *param_1,long param_2,ulong param_3)

{
  ...
  if ((param_3 != 0) && ((uint)param_3 < *(uint *)(param_2 + 0x2c))) {
    lVar1 = *(long *)(*(long *)(param_2 + 0x18) +
                     ((param_3 & 0xffffffff) / (ulong)*(uint *)(param_2 + 0x28)) * 8) +
            ((param_3 & 0xffffffff) % (ulong)*(uint *)(param_2 + 0x28)) * 0x28;
    iVar2 = *(int *)(lVar1 + 0x20);
  ...
  _err_print_error("compositor_effect_get_callback",
                   "servers/rendering/storage/compositor_storage.cpp",0x74,
                   "Parameter \"effect\" is null.",0,0);
...
/* RendererCompositorStorage::compositor_effect_set_flag(RID,
   RenderingServer::CompositorEffectFlags, bool) */

void __thiscall
RendererCompositorStorage::compositor_effect_set_flag
          (RendererCompositorStorage *this,ulong param_2,uint param_3,byte param_4)
    ...
    if ((uint)param_2 < *(uint *)(this + 0x2c)) {
      ...
      if (*(int *)(pcVar1 + 0x20) == (int)(param_2 >> 0x20)) {
        ...
        if (((*pcVar1 == '\0') || (param_3 != 4)) || (param_4 == ((byte)(uVar2 >> 2) & 1))) {
          if (param_4 != 0) {
LAB_001008ae:
            *(ulong *)(pcVar1 + 0x18) = param_3 | uVar2;
            return;
          }
        }
        else {
  ...
  _err_print_error("compositor_effect_set_flag","servers/rendering/storage/compositor_storage.cpp",
                   0x7b,"Parameter \"effect\" is null.",0,0);
  return;
}
...
/* RendererCompositorStorage::compositor_effect_get_flag(RID,
   RenderingServer::CompositorEffectFlags) const */

undefined8 __thiscall
RendererCompositorStorage::compositor_effect_get_flag
          (RendererCompositorStorage *this,ulong param_2,uint param_3)

{
  ...
  _err_print_error("compositor_effect_get_flag","servers/rendering/storage/compositor_storage.cpp",
                   0x92,"Parameter \"effect\" is null.",0,0);
  return 0;
}
...
/* WARNING: Removing unreachable block (ram,0x00100acb) */
/* WARNING: Removing unreachable block (ram,0x00100af0) */
/* WARNING: Removing unreachable block (ram,0x00100b04) */
/* RendererCompositorStorage::compositor_initialize(RID) */

void __thiscall
RendererCompositorStorage::compositor_initialize(RendererCompositorStorage *this,ulong param_2)

{
  ...
  if ((uint)param_2 < *(uint *)(this + 0x84)) {
    lVar1 = *(long *)(*(long *)(this + 0x70) +
            ...
            ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x80)) * 0x18;
...
/* RendererCompositorStorage::compositor_free(RID) */

void __thiscall
RendererCompositorStorage::compositor_free(RendererCompositorStorage *this,ulong param_2)

{
  ...
  if ((uint)param_2 < *(uint *)(this + 0x84)) {
    ...
    if (*(int *)(lVar6 + 0x10) < 0) {
      ...
      _err_print_error(&_LC25,"./core/templates/rid_owner.h",0x16c,"Method/function failed.",
    ...
    if ((int)(param_2 >> 0x20) == *(int *)(lVar6 + 0x10)) {
      ...
      *(uint *)(*(long *)(*(long *)(this + 0x78) +
                         ((ulong)uVar5 / (ulong)*(uint *)(this + 0x80)) * 8) +
               ((ulong)uVar5 % (ulong)*(uint *)(this + 0x80)) * 4) = (uint)param_2;
      pthread_mutex_unlock(__mutex);
      return;
    }
    pthread_mutex_unlock(__mutex);
...

{
  ...
  *(undefined ***)this = &PTR__RendererCompositorStorage_00103ec0;
  singleton = 0;
  RID_Alloc<RendererCompositorStorage::Compositor,true>::~RID_Alloc
            ((RID_Alloc<RendererCompositorStorage::Compositor,true> *)(this + 0x68));
  *(undefined ***)(this + 0x10) = &PTR__RID_Alloc_00103e80;
...
LAB_00100eea:
    if ((uint)uVar5 < (uint)uVar8) goto LAB_00100f2b;
    lVar7 = 0;
    while( true ) {
...

{
  ...
  *(undefined ***)(this + 0x10) = &PTR__RID_Alloc_00103e80;
  ...
  if (uVar3 == 0) {
    ...
    puVar9 = *(undefined8 **)(this + 0x18);
LAB_0010114a:
    if ((uint)uVar5 < (uint)uVar8) goto LAB_0010118b;
    lVar7 = 0;
    while( true ) {
      Memory::free_static((void *)puVar9[lVar7],false);
      lVar2 = lVar7 * 8;
...
/* RendererCompositorStorage::compositor_effect_free(RID) */

void __thiscall
RendererCompositorStorage::compositor_effect_free(RendererCompositorStorage *this,ulong param_2)

{
  ...
  if ((param_2 != 0) && (uVar13 = (uint)param_2, uVar13 < *(uint *)(this + 0x2c))) {
    pcVar10 = (char *)(*(long *)(*(long *)(this + 0x18) +
                                ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x28)) * 8) +
                      ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x28)) * 0x28);
    ...
    if (iVar3 == (int)(param_2 >> 0x20)) {
      ...
      if (iVar6 == 0) {
        ...
        if (*(int *)(this + 0x84) == 0) {
          ...
          do {
            uVar7 = *(uint *)(*(long *)(*(long *)(this + 0x70) +
                                       (uVar18 / *(uint *)(this + 0x80)) * 8) +
                              (uVar18 % (ulong)*(uint *)(this + 0x80)) * 0x18 + 0x10);
            if (uVar7 != 0xffffffff) {
            ...
            for (puVar8 = *(ulong **)*pauVar9; puVar8 != (ulong *)0x0; puVar8 = (ulong *)puVar8[1])
            {
              if (*puVar8 != 0) {
                ...
                if ((uint)uVar18 < *(uint *)(this + 0x84)) {
                  lVar15 = *(long *)(*(long *)(this + 0x70) +
                                    ((uVar18 & 0xffffffff) / (ulong)*(uint *)(this + 0x80)) * 8) +
                           ((uVar18 & 0xffffffff) % (ulong)*(uint *)(this + 0x80)) * 0x18;
                        ...
                        if (param_2 == *(ulong *)(lVar17 + lVar19 * 8)) {
                          if (lVar19 < lVar11) {
                            ...
                            if (lVar17 == 0) {
                              ...
                              if (lVar19 < lVar11) {
                                memmove((void *)(lVar17 + lVar19 * 8),
                                        (void *)(lVar17 + 8 + lVar19 * 8),(lVar11 - lVar19) * 8);
                              }
                            }
                            ...
                            _err_print_index_error
                                      ("remove_at","./core/templates/cowdata.h",0xe4,lVar19,lVar11,
        ...
        if (iVar6 == 0) {
          if (uVar13 < *(uint *)(this + 0x2c)) {
            ...
            if (iVar6 < 0) {
              ...
              *(undefined4 *)(*(long *)(*(long *)(this + 0x18) + uVar18 * 8) + 0x20 + lVar17) =
                   0xffffffff;
              uVar7 = *(int *)(this + 0x30) - 1;
              *(uint *)(this + 0x30) = uVar7;
              *(uint *)(*(long *)(lVar15 + ((ulong)uVar7 / (ulong)*(uint *)(this + 0x28)) * 8) +
                       ((ulong)uVar7 % (ulong)*(uint *)(this + 0x28)) * 4) = uVar13;
              pthread_mutex_unlock(ppVar2);
            }
            else {
              pthread_mutex_unlock(ppVar2);
              _err_print_error(&_LC25,"./core/templates/rid_owner.h",0x171,"Method/function failed."
                               ,0,0);
            }
          }
          else {
            pthread_mutex_unlock(ppVar2);
            _err_print_error(&_LC25,"./core/templates/rid_owner.h",0x161,"Method/function failed.",0
                             ,0);
          }
          if (pauVar9 == (undefined1 (*) [16])0x0) {
            return;
...
LAB_001015d2:
  _err_print_error(pcVar16,pcVar14,uVar12,pcVar10,0,0);
  return;
}
...
/* RendererCompositorStorage::compositor_get_compositor_effects(RID,
   RenderingServer::CompositorEffectCallbackType, bool) const */

long RendererCompositorStorage::compositor_get_compositor_effects
               (long param_1,RendererCompositorStorage *param_2,ulong param_3,int param_4,
               char param_5)

{
  ...
  if ((param_3 != 0) && ((uint)param_3 < *(uint *)(param_2 + 0x84))) {
    lVar1 = *(long *)(*(long *)(param_2 + 0x70) +
                     ((param_3 & 0xffffffff) / (ulong)*(uint *)(param_2 + 0x80)) * 8) +
            ((param_3 & 0xffffffff) % (ulong)*(uint *)(param_2 + 0x80)) * 0x18;
        ...
        if (puVar5 == puVar7) {
          ...
          do {
            while( true ) {
              ...
              if ((param_4 != -1) &&
                 (iVar3 = compositor_effect_get_callback_type(param_2,uVar6), iVar3 != param_4))
              break;
              puVar7 = puVar7 + 1;
...
LAB_00101a9a:
  ...
  _err_print_error("compositor_get_compositor_effects",
                   "servers/rendering/storage/compositor_storage.cpp",0xb5,
                   "Parameter \"compositor\" is null.",0,0);
  *(undefined8 *)(param_1 + 8) = 0;
LAB_001019dd:
...
/* RendererCompositorStorage::compositor_set_compositor_effects(RID, Vector<RID> const&) */

void __thiscall
RendererCompositorStorage::compositor_set_compositor_effects
          (RendererCompositorStorage *this,ulong param_2,long param_3)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x84))) {
    ...
    if (*(int *)(pVVar1 + 0x10) == (int)(param_2 >> 0x20)) {
      ...
      if ((puVar5 != (ulong *)0x0) && (puVar2 = puVar5 + puVar5[-1], puVar2 != puVar5)) {
        ...
        do {
          while( true ) {
            ...
            if ((uVar3 >> 0x20 == 0x7fffffff) ||
               ((*(uint *)(*(long *)(*(long *)(this + 0x18) +
                                    ((uVar3 & 0xffffffff) / (ulong)*(uint *)(this + 0x28)) * 8) +
                           ((uVar3 & 0xffffffff) % (ulong)*(uint *)(this + 0x28)) * 0x28 + 0x20) &
                0x7fffffff) != (uint)(uVar3 >> 0x20))) {
              pthread_mutex_unlock(__mutex);
              goto LAB_00101bf5;
            }
            pthread_mutex_unlock(__mutex);
...
LAB_00101bf5:
  ...
  _err_print_error("compositor_set_compositor_effects",
                   "servers/rendering/storage/compositor_storage.cpp",0xa9,
                   "Parameter \"compositor\" is null.",0,0);
  return;
}
...
void __thiscall
RendererCompositorStorage::compositor_effect_allocate(RendererCompositorStorage *this)

{
  RID_Alloc<RendererCompositorStorage::CompositorEffect,true>::allocate_rid
            ((RID_Alloc<RendererCompositorStorage::CompositorEffect,true> *)(this + 0x10));
  return;
}
...
void __thiscall RendererCompositorStorage::compositor_allocate(RendererCompositorStorage *this)

{
  RID_Alloc<RendererCompositorStorage::Compositor,true>::allocate_rid
            ((RID_Alloc<RendererCompositorStorage::Compositor,true> *)(this + 0x68));
  return;
}
...
/* WARNING: Removing unreachable block (ram,0x00102360) */
/* WARNING: Removing unreachable block (ram,0x00102490) */
/* WARNING: Removing unreachable block (ram,0x00102609) */
/* WARNING: Removing unreachable block (ram,0x0010249c) */
/* WARNING: Removing unreachable block (ram,0x001024a6) */
/* WARNING: Removing unreachable block (ram,0x001025eb) */
/* WARNING: Removing unreachable block (ram,0x001024b2) */
/* WARNING: Removing unreachable block (ram,0x001024bc) */
/* WARNING: Removing unreachable block (ram,0x001025cd) */
/* WARNING: Removing unreachable block (ram,0x001024c8) */
...
/* WARNING: Removing unreachable block (ram,0x00102591) */
/* WARNING: Removing unreachable block (ram,0x001024f4) */
/* WARNING: Removing unreachable block (ram,0x001024fe) */
/* WARNING: Removing unreachable block (ram,0x00102573) */
/* WARNING: Removing unreachable block (ram,0x00102506) */
/* WARNING: Removing unreachable block (ram,0x00102510) */
/* WARNING: Removing unreachable block (ram,0x00102558) */
/* WARNING: Removing unreachable block (ram,0x00102518) */
/* WARNING: Removing unreachable block (ram,0x0010252e) */
/* WARNING: Removing unreachable block (ram,0x0010253a) */
...
/* RID_Alloc<RendererCompositorStorage::CompositorEffect, true>::~RID_Alloc() */

void __thiscall
RID_Alloc<RendererCompositorStorage::CompositorEffect,true>::~RID_Alloc
          (RID_Alloc<RendererCompositorStorage::CompositorEffect,true> *this)
...
LAB_0010279a:
    if ((uint)uVar5 < (uint)uVar8) goto LAB_001027db;
    lVar7 = 0;
    while( true ) {
      Memory::free_static((void *)puVar9[lVar7],false);
      lVar2 = lVar7 * 8;
...
void __thiscall
RID_Alloc<RendererCompositorStorage::Compositor,true>::~RID_Alloc
          (RID_Alloc<RendererCompositorStorage::Compositor,true> *this)

{
  ...
  *(undefined ***)this = &PTR__RID_Alloc_00103ea0;
  ...
  if (uVar2 == 0) {
    ...
    puVar9 = *(undefined8 **)(this + 8);
LAB_001029f2:
    if ((uint)uVar5 < (uint)uVar8) goto LAB_00102a33;
    lVar7 = 0;
    while( true ) {
      Memory::free_static((void *)puVar9[lVar7],false);
      lVar3 = lVar7 * 8;
...

{
  ...
  *(undefined ***)this = &PTR__RID_Alloc_00103e80;
  ...
  if (uVar3 == 0) {
    ...
    puVar9 = *(undefined8 **)(this + 8);
LAB_00102c4a:
    if ((uint)uVar5 < (uint)uVar8) goto LAB_00102c8b;
    lVar7 = 0;
    while( true ) {
      Memory::free_static((void *)puVar9[lVar7],false);
      lVar2 = lVar7 * 8;
...
/* WARNING: Removing unreachable block (ram,0x00103368) */
/* WARNING: Removing unreachable block (ram,0x00103530) */
/* WARNING: Removing unreachable block (ram,0x00103374) */
/* WARNING: Removing unreachable block (ram,0x0010337e) */
/* WARNING: Removing unreachable block (ram,0x00103510) */
/* WARNING: Removing unreachable block (ram,0x0010338a) */
/* WARNING: Removing unreachable block (ram,0x00103394) */
/* WARNING: Removing unreachable block (ram,0x001034f0) */
...
/* WARNING: Removing unreachable block (ram,0x001033cc) */
/* WARNING: Removing unreachable block (ram,0x001033d6) */
/* WARNING: Removing unreachable block (ram,0x00103490) */
/* WARNING: Removing unreachable block (ram,0x001033e2) */
/* WARNING: Removing unreachable block (ram,0x001033ec) */
/* WARNING: Removing unreachable block (ram,0x00103470) */
/* WARNING: Removing unreachable block (ram,0x001033f4) */
/* WARNING: Removing unreachable block (ram,0x0010340a) */
/* WARNING: Removing unreachable block (ram,0x00103416) */
...

{
  ...
  *(uint *)(*(long *)(*(long *)(this + 8) + ((ulong)uVar7 / (ulong)uVar2) * 8) +
            ((ulong)uVar7 % (ulong)uVar2) * 0x28 + 0x20) = uVar11 | 0x80000000;
...

{
  ...
  RID_AllocBase::base_id = RID_AllocBase::base_id + 1;
  *(uint *)(*(long *)(*(long *)(this + 8) + ((ulong)uVar7 / (ulong)uVar2) * 8) +
            ((ulong)uVar7 % (ulong)uVar2) * 0x18 + 0x10) = uVar11 | 0x80000000;
  *(int *)(this + 0x20) = *(int *)(this + 0x20) + 1;
  pthread_mutex_unlock(__mutex);
LAB_00103ac9:
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {

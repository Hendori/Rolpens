...
/* CowData<TriangleMesh::BVH>::_copy_on_write() [clone .isra.0] */

void __thiscall CowData<TriangleMesh::BVH>::_copy_on_write(CowData<TriangleMesh::BVH> *this)
...
/* CowData<TriangleMesh::Triangle>::_copy_on_write() [clone .isra.0] */

void __thiscall
CowData<TriangleMesh::Triangle>::_copy_on_write(CowData<TriangleMesh::Triangle> *this)
...
/* TriangleMesh::_create_bvh(TriangleMesh::BVH*, TriangleMesh::BVH**, int, int, int, int&, int&) */

int __thiscall
TriangleMesh::_create_bvh
          (TriangleMesh *this,BVH *param_1,BVH **param_2,int param_3,int param_4,int param_5,
...
LAB_00100f25:
            if (lVar20 <= lVar15) goto LAB_00100f48;
...
LAB_00100a15:
            if (lVar20 <= lVar16) goto LAB_00100a38;
            pBVar22 = ppBVar1[lVar16];
            fVar26 = *(float *)(pBVar18 + 0x20);
...
LAB_00100895:
            if (lVar20 <= lVar19) goto LAB_00100bb8;
...
LAB_00100f48:
  ...
  if (lVar15 < 4) {
    if ((lVar10 == lVar13) || (lVar16 = lVar13 + 1, lVar10 == lVar16)) goto LAB_00100603;
...
LAB_00100a38:
  ...
  lVar15 = lVar10 - lVar13;
  if (lVar15 < 4) {
    if ((lVar13 == lVar10) || (lVar16 = lVar13 + 1, lVar10 == lVar16)) goto LAB_00100603;
    ppBVar17 = ppBVar1 + lVar13;
    goto LAB_00101253;
  }
...
LAB_00100bb8:
  ...
  if (lVar15 < 4) {
    if ((lVar13 == lVar14) || (lVar19 = lVar13 + 1, lVar19 == lVar14)) goto LAB_00100603;
    ppBVar17 = ppBVar1 + lVar13;
    goto LAB_00101482;
  }
...
LAB_00100603:
  uVar4 = _create_bvh(this,param_1,param_2,param_3,iVar11,param_5 + 1,param_6,param_7);
  uVar5 = _create_bvh(this,param_1,param_2,param_3 + iVar11,param_4 - iVar11,param_5 + 1,param_6,
                      param_7);
  iVar3 = *param_7;
  ...
  *(ulong *)(pBVar22 + 0x18) =
       CONCAT44(fVar27 + (float)((ulong)local_58 >> 0x20),fVar25 + (float)local_58);
...
char __thiscall
TriangleMesh::intersect_segment
          (TriangleMesh *this,Vector3 *param_1,Vector3 *param_2,Vector3 *param_3,Vector3 *param_4,
          int *param_5)
        ...
        while( true ) {
          ...
          if (iVar19 == 0) {
            if (local_a9 != '\0') {
              ...
              if (0.0 < local_b0 * *(float *)local_e0 + local_d4 * fVar22 +
                        local_d8 * *(float *)(local_e0 + 8)) {
...
/* TriangleMesh::intersect_ray(Vector3 const&, Vector3 const&, Vector3&, Vector3&, int*) const */

char __thiscall
TriangleMesh::intersect_ray
          (TriangleMesh *this,Vector3 *param_1,Vector3 *param_2,Vector3 *param_3,Vector3 *param_4,
          int *param_5)
        ...
        while( true ) {
          ...
          if (iVar18 == 0) {
            if (local_a9 != '\0') {
              ...
              if (0.0 < local_100 * *(float *)local_e0 + local_fc * fVar21 +
                        local_b0 * *(float *)(local_e0 + 8)) {
...
/* TriangleMesh::inside_convex_shape(Plane const*, int, Vector3 const*, int, Vector3) const */

undefined8
TriangleMesh::inside_convex_shape
          (undefined8 param_1_00,undefined4 param_2,long param_1,float *param_4,int param_5,
...
LAB_0010265d:
    ...
    if (uVar8 < 3) {
      ...
      local_e8 = 0;
      local_e0 = 0.0;
      uVar6 = CONCAT44((float)((ulong)*(undefined8 *)((long)puVar13 + 0xc) >> 0x20) +
                       (float)((ulong)*puVar13 >> 0x20),
                       (float)*(undefined8 *)((long)puVar13 + 0xc) + (float)*puVar13);
      ...
      if (0 < local_134) {
        ...
        do {
          ...
          fVar23 = ((float)(~uVar8 & (uint)fVar28 | ((uint)fVar28 ^ _LC19) & uVar8) + fVar27) *
                   pfVar11[1] +
                   ((float)(~uVar22 & (uint)fVar24 | (_LC19 ^ (uint)fVar24) & uVar22) + fVar25) *
                   *pfVar11 +
                   ((float)(~uVar4 & (uint)local_f0 | ((uint)local_f0 ^ _LC19) & uVar4) + local_e0)
                   * pfVar11[2];
      ...
      if (0 < local_134) {
        pfVar11 = local_130;
LAB_00102bad:
        uVar4 = -(uint)(pfVar11[2] < 0.0);
        uVar8 = -(uint)(pfVar11[1] < 0.0);
        uVar22 = -(uint)(*pfVar11 < 0.0);
        fVar25 = ((float)(~uVar22 & (uint)fVar26 | (_LC19 ^ (uint)fVar26) & uVar22) + fVar26 + 0.0)
                 * *pfVar11 +
                 ((float)(~uVar8 & (uint)fVar24 | ((uint)fVar24 ^ _LC19) & uVar8) + fVar24 + 0.0) *
                 pfVar11[1] +
                 ((float)(~uVar4 & (uint)fVar28 | ((uint)fVar28 ^ _LC19) & uVar4) + fVar28 + 0.0) *
                 pfVar11[2];
        ...
        if (-1 < *(int *)((long)puVar13 + 0x2c)) {
          ...
          do {
            ...
            do {
              fVar25 = *pfVar11 *
                       (fVar28 * local_70 + fVar26 * local_78 + fVar24 * local_74 + local_54[0]) +
                       pfVar11[1] *
                       (fVar26 * local_6c + fVar24 * local_68 + fVar28 * local_64 + local_54[1]) +
                       pfVar11[2] *
                       (local_60 * fVar26 + local_5c * fVar24 + local_58 * fVar28 + local_54[2]);
...
/* TriangleMesh::is_valid() const */

TriangleMesh __thiscall TriangleMesh::is_valid(TriangleMesh *this)
...
void __thiscall TriangleMesh::TriangleMesh(TriangleMesh *this)
...
/* TriangleMesh::get_faces() const */

void TriangleMesh::get_faces(void)

{
  ...
  if ((long)uVar3 < 0) {
    ...
    lVar13 = uVar3 * 0x24;
    if ((lVar13 == 0) ||
       (uVar7 = lVar13 - 1U | lVar13 - 1U >> 1, uVar7 = uVar7 | uVar7 >> 2,
...
/* TriangleMesh::get_indices(Vector<int>*) const */

void __thiscall TriangleMesh::get_indices(TriangleMesh *this,Vector *param_1)
...
/* Error CowData<TriangleMesh::BVH>::resize<false>(long) [clone .isra.0] */

void __thiscall
CowData<TriangleMesh::BVH>::resize<false>(CowData<TriangleMesh::BVH> *this,long param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* TriangleMesh::create(Vector<Vector3> const&, Vector<int> const&) */

void TriangleMesh::create(Vector *param_1,Vector *param_2)

{
  ...
  if ((lVar20 == 0) || (lVar20 = *(long *)(lVar20 + -8), lVar20 == 0)) {
    if (lVar28 != 0) {
    ...
    if ((lVar28 == 0) || (lVar28 = *(long *)(lVar28 + -8), lVar20 != lVar28)) {
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
        uVar25 = 0x6e;
        pcVar22 = 
        "Condition \"p_surface_indices.size() && p_surface_indices.size() != p_faces.size()\" is true."
        ;
        goto LAB_001041e7;
      }
      goto LAB_00104743;
      ...
      if (iVar9 * 3 == iVar11) {
        ...
        if (iVar11 < -2) {
          _err_print_error("resize","./core/templates/cowdata.h",0x157,
                           "Condition \"p_size < 0\" is true. Returning: ERR_INVALID_PARAMETER",0,0)
          ;
          CowData<TriangleMesh::BVH>::resize<false>
                    ((CowData<TriangleMesh::BVH> *)(param_1 + 0x1a8),(long)(iVar9 * 3));
          CowData<TriangleMesh::BVH>::_copy_on_write
                    ((CowData<TriangleMesh::BVH> *)(param_1 + 0x1a8));
              ...
              while( true ) {
                ...
                cVar10 = HashMap<Vector3,int,HashMapHasherDefault,HashMapComparatorDefault<Vector3>,DefaultTypedAllocator<HashMapElement<Vector3,int>>>
                         ::_lookup_pos((HashMap<Vector3,int,HashMapHasherDefault,HashMapComparatorDefault<Vector3>,DefaultTypedAllocator<HashMapElement<Vector3,int>>>
                                        *)local_c8,(Vector3 *)&local_68,&local_cc);
                if (cVar10 == '\0') break;
...
LAB_00103d08:
              ...
              puVar16 = (uint *)HashMap<Vector3,int,HashMapHasherDefault,HashMapComparatorDefault<Vector3>,DefaultTypedAllocator<HashMapElement<Vector3,int>>>
...
LAB_00103a78:
              ...
              if (((fVar35 < 0.0) || (fVar33 = *(float *)(pBVar24 + 0x10), fVar33 < 0.0)) ||
                 (fVar34 = *(float *)(pBVar24 + 0x14), fVar34 < 0.0)) {
...
LAB_001041e7:
    _err_print_error("create","core/math/triangle_mesh.cpp",uVar25,pcVar22,0,0);
    return;
  }
  goto LAB_00104743;
code_r0x00103b45:
  ...
  *(ulong *)(pBVar24 + 0x18) =
       CONCAT44(fVar34 + (float)((ulong)uVar25 >> 0x20),fVar33 + (float)uVar25);
...
LAB_00104440:
      if (uVar21 != 0) {
        ...
        if (iVar12 == 0) {
LAB_00103e72:
          puVar26 = *(undefined8 **)(param_1 + 0x198);
...
LAB_00104512:
    ...
    *(undefined4 *)(param_1 + 0x1b0) = 0;
    _create_bvh((TriangleMesh *)param_1,local_f0,(BVH **)0x0,0,iVar9,1,(int *)(param_1 + 0x1b0),
                local_120);
...
LAB_001040d7:
    ...
    _create_bvh((TriangleMesh *)param_1,local_f0,ppBVar31,0,local_c8[0],1,(int *)(param_1 + 0x1b0),
                local_120);
    CowData<TriangleMesh::BVH>::resize<false>(local_e8,(long)local_c8[0]);
    param_1[0x1b4] = (Vector)0x1;
    ppBVar31 = ppBVar31 + -2;
...
{
  return (uint)CONCAT71(0x1072,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr) |
...
/* TriangleMesh::is_class_ptr(void*) const */

uint __thiscall TriangleMesh::is_class_ptr(TriangleMesh *this,void *param_1)

{
  return (uint)CONCAT71(0x1072,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1072,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
...
/* TriangleMesh::_getv(StringName const&, Variant&) const */

undefined8 TriangleMesh::_getv(StringName *param_1,Variant *param_2)
...
/* TriangleMesh::_setv(StringName const&, Variant const&) */

undefined8 TriangleMesh::_setv(StringName *param_1,Variant *param_2)
...
/* TriangleMesh::_validate_propertyv(PropertyInfo&) const */

void TriangleMesh::_validate_propertyv(PropertyInfo *param_1)
...
/* TriangleMesh::_property_can_revertv(StringName const&) const */

undefined8 TriangleMesh::_property_can_revertv(StringName *param_1)
...
/* TriangleMesh::_property_get_revertv(StringName const&, Variant&) const */

undefined8 TriangleMesh::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* TriangleMesh::_notificationv(int, bool) */

void TriangleMesh::_notificationv(int param_1,bool param_2)
...
/* CowData<TriangleMesh::BVH>::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<TriangleMesh::BVH>::_copy_on_write(void)
...
/* CowData<TriangleMesh::Triangle>::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<TriangleMesh::Triangle>::_copy_on_write(void)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* TriangleMesh::get_indices(Vector<int>*) const [clone .cold] */

void TriangleMesh::get_indices(Vector *param_1)
...
/* Error CowData<TriangleMesh::BVH>::resize<false>(long) [clone .isra.0] [clone .cold] */

void CowData<TriangleMesh::BVH>::resize<false>(long param_1)
...
/* TriangleMesh::create(Vector<Vector3> const&, Vector<int> const&) [clone .cold] */
...
/* TriangleMesh::_get_class_namev() const */

undefined8 * TriangleMesh::_get_class_namev(void)
...
LAB_00104ba3:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      goto LAB_00104ba3;
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"TriangleMesh");
      goto LAB_00104c0e;
    }
  }
  StringName::assign_static_unique_class_name
...
/* TriangleMesh::get_class() const */

void TriangleMesh::get_class(void)
...
/* TriangleMesh::is_class(String const&) const */

undefined8 __thiscall TriangleMesh::is_class(TriangleMesh *this,String *param_1)
...
/* TriangleMesh::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall TriangleMesh::_get_property_listv(TriangleMesh *this,List *param_1,bool param_2)
...
/* TriangleMesh::_initialize_classv() */

void TriangleMesh::_initialize_classv(void)

{
  ...
  if (initialize_class()::initialized != '\0') goto LAB_00105f14;
...
/* CowData<TriangleMesh::Triangle>::_realloc(long) */

undefined8 __thiscall
CowData<TriangleMesh::Triangle>::_realloc(CowData<TriangleMesh::Triangle> *this,long param_1)
...
/* CowData<TriangleMesh::BVH>::_realloc(long) */

undefined8 __thiscall
CowData<TriangleMesh::BVH>::_realloc(CowData<TriangleMesh::BVH> *this,long param_1)

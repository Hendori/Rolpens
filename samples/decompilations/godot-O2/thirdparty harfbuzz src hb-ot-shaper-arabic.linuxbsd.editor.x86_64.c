...

{
  ...
  if (param_1 < 0x1f000) {
    ...
    uVar1 = (*(code *)(&DAT_00107080 + *(int *)(&DAT_00107080 + (ulong)(param_1 >> 0xc) * 4)))
                      (param_1,in_RSI,
                       &DAT_00107080 + *(int *)(&DAT_00107080 + (ulong)(param_1 >> 0xc) * 4));
    return uVar1;
  }
  return 8;
}
...
LAB_00102ca8:
            if ((uVar3 < 2) || (((byte)param_2[0x18] & 0x40) == 0)) goto LAB_00102bdf;
            bVar14 = true;
            bVar12 = false;
            uVar4 = 0;
            uVar3 = 2;
...

{
  ...
  if ((*(int *)(param_2 + 0x2c) != 0) || (iVar4 = (int)puVar5, iVar4 == 0)) goto LAB_001030dc;
...
LAB_0010360e:
  ...
  *(hb_serialize_context_t **)(param_2 + 8) = phVar25;
  if (((pvVar15 == (void *)0x0) || (puVar3 == (undefined2 *)0x0)) ||
     (*puVar3 = 0x100, *(int *)(param_2 + 0x2c) != 0)) goto LAB_001035ed;
  pvVar15 = *(void **)(param_2 + 8);
  local_98 = puVar3 + 3;
...
LAB_00103f40:
          ...
          *(long *)(param_2 + 8) = lVar4 + 4;
          if ((lVar4 == 0) || (*(undefined2 *)puVar30 = uVar2, *(int *)(param_2 + 0x2c) != 0))
          goto LAB_00103a0e;
          pvVar15 = *(void **)(param_2 + 8);
          sVar20 = (long)puVar28 - (long)pvVar15;
          if ((0x7fffffff < sVar20) || (*(undefined4 **)(param_2 + 0x10) < puVar28))
          goto LAB_00103f40;
          if ((int)sVar20 != 0) {
            memset(pvVar15,0,sVar20);
            pvVar15 = *(void **)(param_2 + 8);
          ...
          *(ushort *)((long)puVar30 + 2) = uVar10 << 8 | uVar10 >> 8;
          ...
          lVar4 = *(long *)(param_2 + 8);
          if ((0x7fffffff < uVar26 - lVar4) || (*(ulong *)(param_2 + 0x10) < uVar26))
          goto LAB_00103f40;
...
/* WARNING: Removing unreachable block (ram,0x001045f2) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
...
/* WARNING: Removing unreachable block (ram,0x00104f7d) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
...
/* WARNING: Removing unreachable block (ram,0x0010578a) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
...
/* WARNING: Removing unreachable block (ram,0x001067d8) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
...
LAB_00106925:
    if (local_6e0._4_4_ != 0) goto LAB_001065c2;
LAB_00106940:
    puVar6 = puStack_6f8;
    pLVar5 = local_708;
...
LAB_001089dd:
        if (param_3 == uVar13) goto LAB_00108510;
LAB_001089e6:
...
LAB_0010877d:
        if (uVar13 == param_3) goto LAB_00108510;
        uVar10 = (ulong)(param_3 - 1);
        uVar7 = (ulong)uVar13;
        uVar11 = *(uint *)(lVar4 + 8 + uVar7 * 0x14);
        uVar15 = *(uint *)(lVar4 + 8 + uVar10 * 0x14);
      ...
      if (pLVar9 + (6 - *(long *)(param_1 + 8)) <= (LigGlyph *)(ulong)*(uint *)(param_1 + 0x18)) {
        ...
        if ((ushort)((uVar5 << 8 | uVar5 >> 8) - 1) < 3) {
          ...
          if ((((LigGlyph *)(ulong)*(uint *)(param_1 + 0x18) < pLVar9 + -*(long *)(param_1 + 8)) ||
             ...
             (int)(iVar6 - uVar7) < 1)) goto LAB_0010a260;
        }
        goto LAB_0010a130;
      }
LAB_0010a260:
...
LAB_0010a602:
                if ((uVar4 * 2 <= (uint)((int)*(undefined8 *)(param_1 + 0x10) - ((int)pMVar5 + 4)))
                   && (iVar3 = *(int *)(param_1 + 0x1c) + uVar4 * -2,
                      *(int *)(param_1 + 0x1c) = iVar3, 0 < iVar3)) goto LAB_0010a580;
              }
            }
            else {
...
LAB_0010d6b9:
      ...
      if ((((ulong)((long)pGVar8 - *(long *)(param_1 + 8)) <= (ulong)*(uint *)(param_1 + 0x18)) &&
         ...
         uVar3 <= (uint)((int)*(undefined8 *)(param_1 + 0x10) - (int)pGVar8))) goto LAB_0010d6b9;
    }
  }
  if (0x1f < *(uint *)(param_1 + 0x2c)) {
    return 0;
...
LAB_0010da10:
              if ((*(byte *)(plVar14 + 1) & 2) == 0) goto LAB_0010dac8;
...
LAB_0010e241:
          if ((*(byte *)(plVar19 + 1) & 2) == 0) goto LAB_0010e2d8;
    ...
    if (in_stack_00000010 != 1) {
      ...
      do {
        ...
        if (uVar8 != (ushort)((in_stack_00000018[uVar11 + 1] << 8 |
                             ...
                             in_stack_00000008[uVar11 + 1] >> 8))) goto LAB_0010fd67;
        uVar11 = uVar11 + 1;
...
LAB_00110d93:
                if ((uVar13 & 0x100) != 0) goto LAB_00110830;
              }
...
LAB_00110e79:
        if ((uVar13 & 0x100) != 0) goto LAB_0011099b;
      }
      if ((param_1[0x22] != (hb_ot_apply_context_t)0x0) || ((uVar13 & 0x40) == 0))
      goto LAB_00110d08;
    }
...
LAB_00112649:
                if ((uVar7 & 0x100) != 0) goto LAB_00112424;
              }

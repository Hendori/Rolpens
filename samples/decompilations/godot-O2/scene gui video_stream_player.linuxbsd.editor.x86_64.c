...
/* VideoStreamPlayer::get_minimum_size() const */

undefined8 __thiscall VideoStreamPlayer::get_minimum_size(VideoStreamPlayer *this)
...
/* VideoStreamPlayer::has_expand() const */

VideoStreamPlayer __thiscall VideoStreamPlayer::has_expand(VideoStreamPlayer *this)
...
/* VideoStreamPlayer::set_loop(bool) */

void __thiscall VideoStreamPlayer::set_loop(VideoStreamPlayer *this,bool param_1)
...
/* VideoStreamPlayer::has_loop() const */

VideoStreamPlayer __thiscall VideoStreamPlayer::has_loop(VideoStreamPlayer *this)
...
/* VideoStreamPlayer::is_playing() const */

undefined8 __thiscall VideoStreamPlayer::is_playing(VideoStreamPlayer *this)
...
/* VideoStreamPlayer::is_paused() const */

VideoStreamPlayer __thiscall VideoStreamPlayer::is_paused(VideoStreamPlayer *this)
...
/* VideoStreamPlayer::set_buffering_msec(int) */

void __thiscall VideoStreamPlayer::set_buffering_msec(VideoStreamPlayer *this,int param_1)
...
/* VideoStreamPlayer::get_buffering_msec() const */

undefined4 __thiscall VideoStreamPlayer::get_buffering_msec(VideoStreamPlayer *this)
...
/* VideoStreamPlayer::set_audio_track(int) */

void __thiscall VideoStreamPlayer::set_audio_track(VideoStreamPlayer *this,int param_1)
...
/* VideoStreamPlayer::get_audio_track() const */

undefined4 __thiscall VideoStreamPlayer::get_audio_track(VideoStreamPlayer *this)
...
/* VideoStreamPlayer::set_volume(float) */

void __thiscall VideoStreamPlayer::set_volume(VideoStreamPlayer *this,float param_1)
...
/* VideoStreamPlayer::get_volume() const */

undefined4 __thiscall VideoStreamPlayer::get_volume(VideoStreamPlayer *this)
...
/* VideoStreamPlayer::get_stream_length() const */

undefined8 __thiscall VideoStreamPlayer::get_stream_length(VideoStreamPlayer *this)
...
/* VideoStreamPlayer::get_stream_position() const */

undefined8 __thiscall VideoStreamPlayer::get_stream_position(VideoStreamPlayer *this)
...
/* VideoStreamPlayer::set_stream_position(double) */

void VideoStreamPlayer::set_stream_position(double param_1)
...
/* VideoStreamPlayer::get_video_texture() const */

void VideoStreamPlayer::get_video_texture(void)
...
/* VideoStreamPlayer::set_autoplay(bool) */

void __thiscall VideoStreamPlayer::set_autoplay(VideoStreamPlayer *this,bool param_1)
...
/* VideoStreamPlayer::has_autoplay() const */

VideoStreamPlayer __thiscall VideoStreamPlayer::has_autoplay(VideoStreamPlayer *this)
...
/* VideoStreamPlayer::_audio_mix_callback(void*, float const*, int) */

uint VideoStreamPlayer::_audio_mix_callback(void *param_1,float *param_2,int param_3)

{
  ...
  if (param_1 == (void *)0x0) {
    uVar8 = 0;
    _err_print_error("_audio_mix_callback","scene/gui/video_stream_player.cpp",0x3b,
                     "Parameter \"p_udata\" is null.",0,0);
  }
  else if (param_2 == (float *)0x0) {
    uVar8 = 0;
    _err_print_error("_audio_mix_callback","scene/gui/video_stream_player.cpp",0x3c,
                     "Parameter \"p_data\" is null.",0,0);
  }
  else {
    ...
    if (uVar8 < *(uint *)((long)param_1 + 0x9ec)) {
      ...
      if (uVar6 == 4) {
        ...
        if (uVar6 == 1) {
          ...
          do {
            ...
            *(undefined4 *)(lVar13 + 4 + (long)iVar9 * 4) =
                 *(undefined4 *)(lVar7 + (ulong)uVar1 * 4);
          } while (uVar8 != uVar16);
        }
      }
      ...
      *(uint *)((long)param_1 + 0xa08) = uVar10;
      ...
      _err_print_error("write","./servers/audio/audio_rb_resampler.h",0x76,
                       "Condition \"p_frames >= rb_len\" is true.",0,0);
    }
  }
  return uVar8;
}
...
/* VideoStreamPlayer::set_bus(StringName const&) */

void __thiscall VideoStreamPlayer::set_bus(VideoStreamPlayer *this,StringName *param_1)
...
/* VideoStreamPlayer::get_volume_db() const */

ulong __thiscall VideoStreamPlayer::get_volume_db(VideoStreamPlayer *this)
...
/* VideoStreamPlayer::set_expand(bool) */

void __thiscall VideoStreamPlayer::set_expand(VideoStreamPlayer *this,bool param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* VideoStreamPlayer::set_volume_db(float) */

void __thiscall VideoStreamPlayer::set_volume_db(VideoStreamPlayer *this,float param_1)
...
/* VideoStreamPlayer::set_paused(bool) */

void __thiscall VideoStreamPlayer::set_paused(VideoStreamPlayer *this,bool param_1)
...
/* VideoStreamPlayer::stop() [clone .part.0] */

void __thiscall VideoStreamPlayer::stop(VideoStreamPlayer *this)
...
/* VideoStreamPlayer::get_stream() const */

void VideoStreamPlayer::get_stream(void)
...
void __thiscall VideoStreamPlayer::~VideoStreamPlayer(VideoStreamPlayer *this)
...
/* VideoStreamPlayer::get_stream_name() const */

void VideoStreamPlayer::get_stream_name(void)
...
/* VideoStreamPlayer::get_bus() const */

void VideoStreamPlayer::get_bus(void)
...
/* VideoStreamPlayer::sp_get_channel_count() const */

undefined8 __thiscall VideoStreamPlayer::sp_get_channel_count(VideoStreamPlayer *this)
...
/* VideoStreamPlayer::mix(AudioFrame*, int) */

undefined8 __thiscall
VideoStreamPlayer::mix(VideoStreamPlayer *this,AudioFrame *param_1,int param_2)
...
/* VideoStreamPlayer::_mix_audio() */

void __thiscall VideoStreamPlayer::_mix_audio(VideoStreamPlayer *this)

{
  ...
  if ((((*(long *)(this + 0x9d0) != 0) && (*(long **)(this + 0x9c8) != (long *)0x0)) &&
      (cVar4 = (**(code **)(**(long **)(this + 0x9c8) + 0x1d8))(), cVar4 != '\0')) &&
     (cVar4 = (**(code **)(**(long **)(this + 0x9c8) + 0x1e8))(), cVar4 == '\0')) {
...
LAB_00101092:
                _err_print_error("_mix_audio","scene/gui/video_stream_player.cpp",uVar10,pcVar9,0,0)
                ;
                return;
              }
              goto LAB_001011f2;
            ...
            if (0 < (int)uVar12) {
              do {
                ...
                *(ulong *)(lVar13 + uVar11 * 8) =
                     CONCAT44((float)((ulong)uVar10 >> 0x20) * fVar1 + (float)((ulong)uVar2 >> 0x20)
                              ,(float)uVar10 * fVar1 + (float)uVar2);
                uVar11 = uVar11 + 1;
              } while (uVar12 != uVar11);
            }
            goto LAB_00100fb0;
          ...
          do {
            ...
            do {
              ...
              *(undefined8 *)(lVar8 + lVar14) =
                   CONCAT44((float)((ulong)uVar2 >> 0x20) + (float)((ulong)uVar10 >> 0x20) * fVar1,
                            (float)uVar2 + (float)uVar10 * fVar1);
...
/* VideoStreamPlayer::_mix_audios(void*) */

void VideoStreamPlayer::_mix_audios(void *param_1)

{
  ...
  _err_print_error("_mix_audios","scene/gui/video_stream_player.cpp",0x4e,
                   "Parameter \"p_self\" is null.",0,0);
  return;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* VideoStreamPlayer::_notification(int) */

void __thiscall VideoStreamPlayer::_notification(VideoStreamPlayer *this,int param_1)
...
switchD_00101285_caseD_e:
    if (((*(long **)(this + 0x9c8) != (long *)0x0) &&
        (cVar3 = (**(code **)(**(long **)(this + 0x9c8) + 0x1d8))(), cVar3 != '\0')) &&
       (this[0xa38] == (VideoStreamPlayer)0x0)) {
      plVar8 = *(long **)(this + 0x9c8);
      this[0xa39] = (VideoStreamPlayer)0x1;
      if (plVar8 != (long *)0x0) {
...
void __thiscall VideoStreamPlayer::play(VideoStreamPlayer *this)

{
  char cVar1;
  
  if (((byte)this[0x2fa] & 0x40) == 0) {
    _err_print_error(&_LC38,"scene/gui/video_stream_player.cpp",0x132,
...
/* VideoStreamPlayer::_validate_property(PropertyInfo&) const */

void __thiscall VideoStreamPlayer::_validate_property(VideoStreamPlayer *this,PropertyInfo *param_1)
...
/* VideoStreamPlayer::_bind_methods() */

void VideoStreamPlayer::_bind_methods(void)

{
  ...
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_d8,2,(String *)&local_110,1,(String *)&local_108,6,&local_100);
  local_118 = 0;
  ...
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_d8,0x18,(String *)&local_110,0x11,(String *)&local_108,6,
             &local_100);
  local_118 = 0;
  String::parse_latin1((String *)&local_118,"VideoStreamPlayer");
  StringName::StringName((StringName *)&local_e8,(String *)&local_118,false);
  ...
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_d8,3,(String *)&local_110,1,(String *)&local_108,6,&local_100);
  local_118 = 0;
  String::parse_latin1((String *)&local_118,"VideoStreamPlayer");
  StringName::StringName((StringName *)&local_e8,(String *)&local_118,false);
  ClassDB::add_property
  ...
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_d8,3,(String *)&local_110,1,(String *)&local_108,0,&local_100);
  local_118 = 0;
  String::parse_latin1((String *)&local_118,"VideoStreamPlayer");
  StringName::StringName((StringName *)&local_e8,(String *)&local_118,false);
  ClassDB::add_property
  ...
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_d8,1,(String *)&local_110,0,(String *)&local_108,6,&local_100);
  local_118 = 0;
  String::parse_latin1((String *)&local_118,"VideoStreamPlayer");
  StringName::StringName((StringName *)&local_e8,(String *)&local_118,false);
  ClassDB::add_property
  ...
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_d8,0x15,(String *)&local_110,2,(String *)&local_108,6,&local_100
            );
  local_118 = 0;
  String::parse_latin1((String *)&local_118,"VideoStreamPlayer");
  StringName::StringName((StringName *)&local_e8,(String *)&local_118,false);
...
/* VideoStreamPlayer::set_stream(Ref<VideoStream> const&) */

void __thiscall VideoStreamPlayer::set_stream(VideoStreamPlayer *this,Ref *param_1)

{
  ...
  if (pCVar2 != (Callable *)0x0) {
    create_custom_callable_function_pointer<VideoStreamPlayer,Ref<VideoStream>const&>
              ((VideoStreamPlayer *)local_98,(char *)this,
               (_func_void_Ref_ptr *)"&VideoStreamPlayer::set_stream");
...
LAB_00103ff9:
  ...
  if (pOVar13 == pOVar14) {
LAB_00103b63:
    if (pOVar14 == (Object *)0x0) goto LAB_00103fb0;
...
LAB_00103be3:
      if (((pOVar14 == (Object *)0x0) ||
          (cVar5 = RefCounted::unreference(), pOVar13 = local_98[0], cVar5 == '\0')) ||
         (cVar5 = predelete_handler(local_98[0]), cVar5 == '\0')) goto LAB_00103bf8;
      goto LAB_0010402d;
    }
...
joined_r0x00103f1b:
      pOVar14 = local_98[0];
      if ((cVar5 != '\0') &&
         (cVar5 = predelete_handler(pOVar13), pOVar14 = local_98[0], cVar5 != '\0')) {
...
LAB_00103bf8:
  ...
  if (pCVar3 != (Callable *)0x0) {
    create_custom_callable_function_pointer<VideoStreamPlayer,Ref<VideoStream>const&>
              (local_a8,(char *)this,(_func_void_Ref_ptr *)"&VideoStreamPlayer::set_stream");
  ...
  plVar8 = *(long **)(this + 0x9c8);
  if (plVar8 == (long *)0x0) {
    if ((*(long *)(this + 0x9e0) != 0) && (cVar5 = RefCounted::unreference(), cVar5 != '\0')) {
...
joined_r0x00103d6a:
    ...
    iVar6 = (**(code **)(**(long **)(this + 0x9c8) + 0x228))();
    plVar8 = (long *)AudioServer::get_singleton();
    (**(code **)(*plVar8 + 0x170))(plVar8);
    if (0 < iVar6) {
      ...
      plVar8 = (long *)AudioServer::get_singleton();
      (**(code **)(*plVar8 + 0x178))(plVar8);
      (**(code **)(**(long **)(this + 0x9c8) + 0x220))
                (*(long **)(this + 0x9c8),_audio_mix_callback,this);
      goto LAB_00103e82;
    }
  }
  AudioRBResampler::clear();
...
/* VideoStreamPlayer::is_class_ptr(void*) const */

uint __thiscall VideoStreamPlayer::is_class_ptr(VideoStreamPlayer *this,void *param_1)

{
  return (uint)CONCAT71(0x1118,(undefined4 *)param_1 == &Control::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1118,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1118,(undefined4 *)param_1 == &CanvasItem::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1118,(undefined4 *)param_1 == &Node::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1118,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}
...
void __thiscall
CallableCustomMethodPointer<VideoStreamPlayer,void,Ref<VideoStream>const&>::
~CallableCustomMethodPointer
          (CallableCustomMethodPointer<VideoStreamPlayer,void,Ref<VideoStream>const&> *this)
...
/* MethodBindTRC<Ref<VideoStream>>::_gen_argument_type(int) const */

undefined8 MethodBindTRC<Ref<VideoStream>>::_gen_argument_type(int param_1)
...
/* MethodBindTRC<Ref<VideoStream>>::get_argument_meta(int) const */

undefined8 MethodBindTRC<Ref<VideoStream>>::get_argument_meta(int param_1)
...
/* MethodBindT<Ref<VideoStream> const&>::_gen_argument_type(int) const */

byte __thiscall
MethodBindT<Ref<VideoStream>const&>::_gen_argument_type
          (MethodBindT<Ref<VideoStream>const&> *this,int param_1)
...
/* MethodBindT<Ref<VideoStream> const&>::get_argument_meta(int) const */

undefined8 MethodBindT<Ref<VideoStream>const&>::get_argument_meta(int param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<VideoStreamPlayer,void,Ref<VideoStream>const&>::get_argument_count
          (CallableCustomMethodPointer<VideoStreamPlayer,void,Ref<VideoStream>const&> *this,
          bool *param_1)
...
/* MethodBindT<Ref<VideoStream> const&>::~MethodBindT() */

void __thiscall
MethodBindT<Ref<VideoStream>const&>::~MethodBindT(MethodBindT<Ref<VideoStream>const&> *this)
...
/* MethodBindTRC<Ref<VideoStream>>::~MethodBindTRC() */

void __thiscall
MethodBindTRC<Ref<VideoStream>>::~MethodBindTRC(MethodBindTRC<Ref<VideoStream>> *this)
...
/* VideoStreamPlayer::_property_get_revertv(StringName const&, Variant&) const */

undefined8 VideoStreamPlayer::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* VideoStreamPlayer::_property_can_revertv(StringName const&) const */

undefined8 VideoStreamPlayer::_property_can_revertv(StringName *param_1)
...
/* VideoStreamPlayer::_bind_methods() [clone .cold] */
...
/* VideoStreamPlayer::set_stream(Ref<VideoStream> const&) [clone .cold] */

void VideoStreamPlayer::set_stream(Ref *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<VideoStreamPlayer,void,Ref<VideoStream>const&>::get_object
          (CallableCustomMethodPointer<VideoStreamPlayer,void,Ref<VideoStream>const&> *this)
...
/* VideoStreamPlayer::_setv(StringName const&, Variant const&) */

undefined8 VideoStreamPlayer::_setv(StringName *param_1,Variant *param_2)
...
/* VideoStreamPlayer::_getv(StringName const&, Variant&) const */

undefined8 VideoStreamPlayer::_getv(StringName *param_1,Variant *param_2)

{
  undefined8 uVar1;
  
  if (((code *)PTR__get_00116018 != CanvasItem::_get) &&
...
/* VideoStreamPlayer::_get_class_namev() const */

undefined8 * VideoStreamPlayer::_get_class_namev(void)
...
LAB_001053a3:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"VideoStreamPlayer");
      goto LAB_0010540e;
    }
  }
  StringName::assign_static_unique_class_name
...
/* VideoStreamPlayer::get_class() const */

void VideoStreamPlayer::get_class(void)
...
/* VideoStreamPlayer::_notificationv(int, bool) */

void __thiscall VideoStreamPlayer::_notificationv(VideoStreamPlayer *this,int param_1,bool param_2)
...
/* Callable create_custom_callable_function_pointer<VideoStreamPlayer, Ref<VideoStream>
   const&>(VideoStreamPlayer*, char const*, void (VideoStreamPlayer::*)(Ref<VideoStream> const&)) */

VideoStreamPlayer *
create_custom_callable_function_pointer<VideoStreamPlayer,Ref<VideoStream>const&>
          (VideoStreamPlayer *param_1,char *param_2,_func_void_Ref_ptr *param_3)
...
/* VideoStreamPlayer::_validate_propertyv(PropertyInfo&) const */

void __thiscall
VideoStreamPlayer::_validate_propertyv(VideoStreamPlayer *this,PropertyInfo *param_1)
...
/* MethodBindTRC<Ref<VideoStream>>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTRC<Ref<VideoStream>>::_gen_argument_type_info(int param_1)
...
void __thiscall
CallableCustomMethodPointer<VideoStreamPlayer,void,Ref<VideoStream>const&>::call
          (CallableCustomMethodPointer<VideoStreamPlayer,void,Ref<VideoStream>const&> *this,
...
/* VideoStreamPlayer::is_class(String const&) const */

undefined8 __thiscall VideoStreamPlayer::is_class(VideoStreamPlayer *this,String *param_1)
...
/* MethodBindT<Ref<VideoStream> const&>::_gen_argument_type_info(int) const */

undefined4 * MethodBindT<Ref<VideoStream>const&>::_gen_argument_type_info(int param_1)
...
/* VideoStreamPlayer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall
VideoStreamPlayer::_get_property_listv(VideoStreamPlayer *this,List *param_1,bool param_2)
...
/* MethodBind* create_method_bind<VideoStreamPlayer, Ref<VideoStream> const&>(void
   (VideoStreamPlayer::*)(Ref<VideoStream> const&)) */

MethodBind *
create_method_bind<VideoStreamPlayer,Ref<VideoStream>const&>(_func_void_Ref_ptr *param_1)
...
/* MethodBind* create_method_bind<VideoStreamPlayer, Ref<VideoStream>>(Ref<VideoStream>
   (VideoStreamPlayer::*)() const) */

MethodBind * create_method_bind<VideoStreamPlayer,Ref<VideoStream>>(_func_Ref *param_1)
...
/* MethodBind* create_method_bind<VideoStreamPlayer>(void (VideoStreamPlayer::*)()) */

MethodBind * create_method_bind<VideoStreamPlayer>(_func_void *param_1)
...
/* MethodBind* create_method_bind<VideoStreamPlayer, bool>(bool (VideoStreamPlayer::*)() const) */

MethodBind * create_method_bind<VideoStreamPlayer,bool>(_func_bool *param_1)
...
/* MethodBind* create_method_bind<VideoStreamPlayer, bool>(void (VideoStreamPlayer::*)(bool)) */

MethodBind * create_method_bind<VideoStreamPlayer,bool>(_func_void_bool *param_1)
...
/* MethodBind* create_method_bind<VideoStreamPlayer, float>(void (VideoStreamPlayer::*)(float)) */

MethodBind * create_method_bind<VideoStreamPlayer,float>(_func_void_float *param_1)
...
/* MethodBind* create_method_bind<VideoStreamPlayer, float>(float (VideoStreamPlayer::*)() const) */

MethodBind * create_method_bind<VideoStreamPlayer,float>(_func_float *param_1)
...
/* MethodBind* create_method_bind<VideoStreamPlayer, int>(void (VideoStreamPlayer::*)(int)) */

MethodBind * create_method_bind<VideoStreamPlayer,int>(_func_void_int *param_1)
...
/* MethodBind* create_method_bind<VideoStreamPlayer, int>(int (VideoStreamPlayer::*)() const) */

MethodBind * create_method_bind<VideoStreamPlayer,int>(_func_int *param_1)
...
/* MethodBind* create_method_bind<VideoStreamPlayer, double>(void (VideoStreamPlayer::*)(double)) */

MethodBind * create_method_bind<VideoStreamPlayer,double>(_func_void_double *param_1)
...
/* MethodBind* create_method_bind<VideoStreamPlayer, StringName const&>(void
   (VideoStreamPlayer::*)(StringName const&)) */

MethodBind *
create_method_bind<VideoStreamPlayer,StringName_const&>(_func_void_StringName_ptr *param_1)
...
MethodBind * create_method_bind<VideoStreamPlayer,StringName>(_func_StringName *param_1)
...
MethodBind * create_method_bind<VideoStreamPlayer,Ref<Texture2D>>(_func_Ref *param_1)
...
/* VideoStreamPlayer::_initialize_classv() */

void VideoStreamPlayer::_initialize_classv(void)
...
/* WARNING: Removing unreachable block (ram,0x00109ed8) */
...
Object * MethodBindTRC<Ref<VideoStream>>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
/* MethodBindTRC<Ref<VideoStream>>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTRC<Ref<VideoStream>>::ptrcall
          (MethodBindTRC<Ref<VideoStream>> *this,Object *param_1,void **param_2,void *param_3)
...
/* MethodBindT<Ref<VideoStream> const&>::validated_call(Object*, Variant const**, Variant*) const */

void MethodBindT<Ref<VideoStream>const&>::validated_call
               (Object *param_1,Variant **param_2,Variant *param_3)
...
/* MethodBindT<Ref<VideoStream> const&>::ptrcall(Object*, void const**, void*) const */

void MethodBindT<Ref<VideoStream>const&>::ptrcall(Object *param_1,void **param_2,void *param_3)
...
Object * MethodBindT<Ref<VideoStream>const&>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
/* MethodBindTRC<Ref<VideoStream>>::validated_call(Object*, Variant const**, Variant*) const */

void __thiscall
MethodBindTRC<Ref<VideoStream>>::validated_call
          (MethodBindTRC<Ref<VideoStream>> *this,Object *param_1,Variant **param_2,Variant *param_3)

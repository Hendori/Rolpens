...
/* tvg::Picture::type() const */

undefined8 tvg::Picture::type(void)
...
undefined8
std::
_Function_handler<bool(tvg::Paint_const*,void*),tvg::Picture::paint(unsigned_int)::{lambda(tvg::Paint_const*,void*)#1}>
...
{
  if (param_3 == 0) {
    *param_1 = &tvg::Picture::paint(unsigned_int)::{lambda(tvg::Paint_const*,void*)#1}::typeinfo;
    return 0;
  }
  if (param_3 != 1) {
    return 0;
...
void __thiscall tvg::Picture::~Picture(Picture *this)

{
  ...
  *(undefined ***)this = &PTR__Picture_00100a40;
  if (puVar1 != (undefined8 *)0x0) {
    ...
    if ((puVar1[2] != 0) &&
       (plVar2 = *(long **)(*(long *)(puVar1[5] + 0x10) + 0x18), plVar2 != (long *)0x0)) {
...
int tvg::Picture::Impl::load(void)
    ...
    if (in_RDI[1] == 0) {
      ...
      if (pcVar1 != ImageLoader::paint) {
        ...
        if (lVar3 != 0) {
          ...
          if ((*(float *)(in_RDI + 4) == fVar5) &&
             (*(float *)((long)in_RDI + 0x24) == *(float *)((long)plVar2 + 0x2c))) {
            return 0;
          }
          if (*(char *)((long)in_RDI + 0x31) == '\0') {
            *(float *)(in_RDI + 4) = fVar5;
            uVar4 = *(undefined4 *)((long)plVar2 + 0x2c);
            *(undefined4 *)((long)in_RDI + 0x24) = uVar4;
          }
          else {
            uVar4 = *(undefined4 *)((long)in_RDI + 0x24);
            fVar5 = *(float *)(in_RDI + 4);
          }
...
/* tvg::Picture::Impl::queryComposition(unsigned char) */

void __thiscall tvg::Picture::Impl::queryComposition(Impl *this,uchar param_1)

{
  ...
  if (param_1 == 0xff) {
    ...
    if (((iVar2 != 1) && (local_18 != 0)) &&
       ((byte)(*(char *)(*(long *)(local_18 + 0x10) + 0x77) - 1U) < 0xfe)) {
      this[0x30] = (Impl)0x1;
    }
  }
...
/* tvg::Picture::Impl::size(float, float) */

undefined8 __thiscall tvg::Picture::Impl::size(Impl *this,float param_1,float param_2)
...
/* tvg::Picture::Impl::bounds(tvg::RenderMethod*) */

undefined8 __thiscall tvg::Picture::Impl::bounds(Impl *this,RenderMethod *param_1)
...
/* tvg::Picture::Impl::render(tvg::RenderMethod*) */

ulong __thiscall tvg::Picture::Impl::render(Impl *this,RenderMethod *param_1)

{
  ...
  (**(code **)(*(long *)param_1 + 0x60))
            (param_1,*(undefined1 *)(*(long *)(*(long *)(this + 0x28) + 0x10) + 0x74));
  if (*(long *)(this + 0x10) == 0) {
    if (*(long *)(this + 8) == 0) {
      uVar5 = 0;
    }
...
/* tvg::Picture::Impl::load(ImageLoader*) */

undefined8 __thiscall tvg::Picture::Impl::load(Impl *this,ImageLoader *param_1)
...
Picture * __thiscall tvg::Picture::gen(Picture *this)
...
/* tvg::Picture::identifier() */

undefined8 tvg::Picture::identifier(void)
...
/* tvg::Picture::load(std::__cxx11::string const&) */

ulong __thiscall tvg::Picture::load(Picture *this,string *param_1)
...
/* tvg::Picture::load(char const*, unsigned int, std::__cxx11::string const&, bool) */

undefined8 __thiscall
tvg::Picture::load(Picture *this,char *param_1,uint param_2,string *param_3,bool param_4)
...
/* tvg::Picture::load(char const*, unsigned int, bool) */

undefined4 __thiscall tvg::Picture::load(Picture *this,char *param_1,uint param_2,bool param_3)
...
/* tvg::Picture::load(unsigned int*, unsigned int, unsigned int, bool) */

undefined8 __thiscall
tvg::Picture::load(Picture *this,uint *param_1,uint param_2,uint param_3,bool param_4)
...
/* tvg::Picture::size(float, float) */

undefined8 __thiscall tvg::Picture::size(Picture *this,float param_1,float param_2)
...
/* tvg::Picture::size(float*, float*) const */
...
/* tvg::Picture::paint(unsigned int) */

undefined8 __thiscall tvg::Picture::paint(Picture *this,uint param_1)

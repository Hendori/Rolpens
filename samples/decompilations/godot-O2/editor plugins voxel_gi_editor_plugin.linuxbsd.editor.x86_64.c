...
/* VoxelGIEditorPlugin::edit(Object*) */

void __thiscall VoxelGIEditorPlugin::edit(VoxelGIEditorPlugin *this,Object *param_1)
...
/* VoxelGIEditorPlugin::make_visible(bool) */

void __thiscall VoxelGIEditorPlugin::make_visible(VoxelGIEditorPlugin *this,bool param_1)
...
/* VoxelGIEditorPlugin::bake_func_step(int, String const&) */

undefined8 VoxelGIEditorPlugin::bake_func_step(int param_1,String *param_2)

{
  ...
  _err_print_error("bake_func_step","editor/plugins/voxel_gi_editor_plugin.cpp",0x9c,
...
/* VoxelGIEditorPlugin::bake_func_end() */

void VoxelGIEditorPlugin::bake_func_end(void)

{
  ...
  _err_print_error("bake_func_end","editor/plugins/voxel_gi_editor_plugin.cpp",0xa1,
                   "Parameter \"tmp_progress\" is null.",0,0);
  return;
}
...
/* VoxelGIEditorPlugin::_voxel_gi_save_path_and_bake(String const&) */

void __thiscall
VoxelGIEditorPlugin::_voxel_gi_save_path_and_bake(VoxelGIEditorPlugin *this,String *param_1)

{
  ...
  if (*(Node **)(this + 0x660) != (Node *)0x0) {
    ...
    if (local_30 == (Object *)0x0) {
      _err_print_error("_voxel_gi_save_path_and_bake","editor/plugins/voxel_gi_editor_plugin.cpp",
                       0xae,"Condition \"voxel_gi_data.is_null()\" is true.",0,0);
    }
    else {
      (**(code **)(*(long *)local_30 + 0x188))(local_30,param_1,0);
      local_28 = (Object *)0x0;
      if (((local_30 != (Object *)0x0) &&
          (pOVar2 = (Object *)__dynamic_cast(local_30,&Object::typeinfo,&Resource::typeinfo,0),
          pOVar2 != (Object *)0x0)) &&
         (local_28 = pOVar2, cVar1 = RefCounted::reference(), cVar1 == '\0')) {
        local_28 = (Object *)0x0;
      }
      ...
      if (((local_30 != (Object *)0x0) && (cVar1 = RefCounted::unreference(), cVar1 != '\0')) &&
         (cVar1 = predelete_handler(local_30), cVar1 != '\0')) {
...
/* VoxelGIEditorPlugin::handles(Object*) const */

undefined4 __thiscall VoxelGIEditorPlugin::handles(VoxelGIEditorPlugin *this,Object *param_1)
...
void __thiscall VoxelGIEditorPlugin::~VoxelGIEditorPlugin(VoxelGIEditorPlugin *this)
...
/* VoxelGIEditorPlugin::bake_func_begin() */

void VoxelGIEditorPlugin::bake_func_begin(void)

{
  ...
  if (tmp_progress == (EditorProgress *)0x0) {
    ...
    _err_print_error("bake_func_begin","editor/plugins/voxel_gi_editor_plugin.cpp",0x96,
...

{
  ...
  *(Button **)(this + 0x670) = this_01;
  ...
  if ((VoxelGIEditorPlugin()::{lambda()#1}::operator()()::sname == '\0') &&
     (iVar8 = __cxa_guard_acquire(&VoxelGIEditorPlugin()::{lambda()#1}::operator()()::sname),
     iVar8 != 0)) {
    _scs_create((char *)&VoxelGIEditorPlugin()::{lambda()#1}::operator()()::sname,true);
    __cxa_atexit(StringName::~StringName,&VoxelGIEditorPlugin()::{lambda()#1}::operator()()::sname,
                 &__dso_handle);
    __cxa_guard_release(&VoxelGIEditorPlugin()::{lambda()#1}::operator()()::sname);
  }
  (*pcVar3)((CowData<char32_t> *)local_58,pOVar11,
            &VoxelGIEditorPlugin()::{lambda()#1}::operator()()::sname,lVar1);
...
/* VoxelGIEditorPlugin::_notification(int) [clone .part.0] */

void VoxelGIEditorPlugin::_notification(int param_1)
...
/* VoxelGIEditorPlugin::_notification(int) */

void __thiscall VoxelGIEditorPlugin::_notification(VoxelGIEditorPlugin *this,int param_1)
...
void __thiscall VoxelGIEditorPlugin::_bake(VoxelGIEditorPlugin *this)
...
joined_r0x00101b32:
  if (((local_98 != (Object *)0x0) && (cVar2 = RefCounted::unreference(), cVar2 != '\0')) &&
...
uint __thiscall VoxelGIEditorPlugin::is_class_ptr(VoxelGIEditorPlugin *this,void *param_1)

{
  return (uint)CONCAT71(0x107a,(undefined4 *)param_1 == &EditorPlugin::get_class_ptr_static()::ptr)
         | (uint)CONCAT71(0x107a,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x107a,(undefined4 *)param_1 == &Node::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x107a,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}
...
void __thiscall
CallableCustomMethodPointer<VoxelGIEditorPlugin,void,String_const&>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<VoxelGIEditorPlugin,void,String_const&> *this)
...
void __thiscall
CallableCustomMethodPointer<VoxelGIEditorPlugin,void>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<VoxelGIEditorPlugin,void> *this)
...
CallableCustomMethodPointer<VoxelGIEditorPlugin,void,String_const&>::get_argument_count
          (CallableCustomMethodPointer<VoxelGIEditorPlugin,void,String_const&> *this,bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<VoxelGIEditorPlugin,void>::get_argument_count
          (CallableCustomMethodPointer<VoxelGIEditorPlugin,void> *this,bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<VoxelGIEditorPlugin,void,String_const&>::get_object
          (CallableCustomMethodPointer<VoxelGIEditorPlugin,void,String_const&> *this)
...
undefined8 __thiscall
CallableCustomMethodPointer<VoxelGIEditorPlugin,void>::get_object
          (CallableCustomMethodPointer<VoxelGIEditorPlugin,void> *this)
...
LAB_00103013:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      goto LAB_00103013;
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"VoxelGIEditorPlugin");
      goto LAB_0010307e;
    }
  }
  StringName::assign_static_unique_class_name
...
VoxelGIEditorPlugin * __thiscall VoxelGIEditorPlugin::get_plugin_name(VoxelGIEditorPlugin *this)
      ...
      if (Container::initialize_class()::initialized == '\0') {
        if (Control::initialize_class()::initialized == '\0') {
          if (CanvasItem::initialize_class()::initialized == '\0') {
            ...
            if ((code *)PTR__bind_compatibility_methods_0010a038 !=
                Object::_bind_compatibility_methods) {
...
void __thiscall
CallableCustomMethodPointer<VoxelGIEditorPlugin,void>::call
          (CallableCustomMethodPointer<VoxelGIEditorPlugin,void> *this,Variant **param_1,int param_2
...
void __thiscall
CallableCustomMethodPointer<VoxelGIEditorPlugin,void,String_const&>::call
          (CallableCustomMethodPointer<VoxelGIEditorPlugin,void,String_const&> *this,
...
undefined8 __thiscall VoxelGIEditorPlugin::is_class(VoxelGIEditorPlugin *this,String *param_1)
...
void __thiscall
VoxelGIEditorPlugin::_notificationv(VoxelGIEditorPlugin *this,int param_1,bool param_2)
...
void __thiscall
VoxelGIEditorPlugin::_get_property_listv(VoxelGIEditorPlugin *this,List *param_1,bool param_2)

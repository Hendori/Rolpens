...
/* FileAccessUnix::is_open() const */

bool __thiscall FileAccessUnix::is_open(FileAccessUnix *this)
...
/* FileAccessUnix::get_error() const */

undefined4 __thiscall FileAccessUnix::get_error(FileAccessUnix *this)
...
/* FileAccessUnix::_get_read_only_attribute(String const&) */

undefined8 FileAccessUnix::_get_read_only_attribute(String *param_1)
...
/* FileAccessUnix::_set_read_only_attribute(String const&, bool) */

undefined8 FileAccessUnix::_set_read_only_attribute(String *param_1,bool param_2)
...
/* FileAccessUnix::eof_reached() const */

bool __thiscall FileAccessUnix::eof_reached(FileAccessUnix *this)
...
/* FileAccessUnix::get_length() const */

__off64_t __thiscall FileAccessUnix::get_length(FileAccessUnix *this)

{
  ...
  if (*(FILE **)(this + 400) == (FILE *)0x0) {
    _err_print_error("get_length","drivers/unix/file_access_unix.cpp",0xfd,
                     "Parameter \"f\" is null.","File must be opened before use.",0,0);
    _Var2 = 0;
  }
  else {
    __off = ftello64(*(FILE **)(this + 400));
    if (__off < 0) {
      _err_print_error("get_length","drivers/unix/file_access_unix.cpp",0x100,
                       "Condition \"pos < 0\" is true. Returning: 0",0,0);
      _Var2 = 0;
    }
    else {
      ...
      if (iVar1 == 0) {
        ...
        if (_Var2 < 0) {
          _err_print_error("get_length","drivers/unix/file_access_unix.cpp",0x103,
                           "Condition \"size < 0\" is true. Returning: 0",0,0);
          _Var2 = 0;
        }
        else {
          iVar1 = fseeko64(*(FILE **)(this + 400),__off,0);
          if (iVar1 != 0) {
            _err_print_error("get_length","drivers/unix/file_access_unix.cpp",0x104,
                             "Condition \"fseeko(f, pos, 0)\" is true. Returning: 0",0,0);
            _Var2 = 0;
          }
        }
      }
      else {
        _err_print_error("get_length","drivers/unix/file_access_unix.cpp",0x101,
                         "Condition \"fseeko(f, 0, 2)\" is true. Returning: 0",0,0);
        _Var2 = 0;
      }
    }
  }
...
/* FileAccessUnix::resize(long) */

undefined8 __thiscall FileAccessUnix::resize(FileAccessUnix *this,long param_1)

{
  int iVar1;
  
  if (*(FILE **)(this + 400) == (FILE *)0x0) {
    _err_print_error("resize","drivers/unix/file_access_unix.cpp",0x11c,"Parameter \"f\" is null.",
...
void __thiscall FileAccessUnix::flush(FileAccessUnix *this)

{
  ...
  _err_print_error("flush","drivers/unix/file_access_unix.cpp",0x12d,"Parameter \"f\" is null.",
                   "File must be opened before use.",0,0);
  return;
}
...
/* FileAccessUnix::get_path() const */

void FileAccessUnix::get_path(void)
...
/* FileAccessUnix::get_path_absolute() const */

void FileAccessUnix::get_path_absolute(void)
...
bool __thiscall
FileAccessUnix::_set_unix_permissions(FileAccessUnix *this,undefined8 param_1,__mode_t param_3)
...
/* FileAccessUnix::_get_modified_time(String const&) */

__time_t __thiscall FileAccessUnix::_get_modified_time(FileAccessUnix *this,String *param_1)
...
/* FileAccessUnix::file_exists(String const&) */

ulong __thiscall FileAccessUnix::file_exists(FileAccessUnix *this,String *param_1)
...
/* FileAccessUnix::_get_unix_permissions(String const&) */

uint __thiscall FileAccessUnix::_get_unix_permissions(FileAccessUnix *this,String *param_1)

{
  ...
  if (iVar3 == 0) {
    ...
    operator+((char *)&local_e8,(String *)"Failed to get unix permissions for: ");
    String::operator+((String *)&local_d8,(String *)&local_e8);
    _err_print_error("_get_unix_permissions","drivers/unix/file_access_unix.cpp",0x16f,
                     "Method/function failed. Returning: 0",(String *)&local_d8,0,0);
    puVar2 = local_d8;
    if (local_d8 != (undefined *)0x0) {
      LOCK();
      plVar1 = (long *)(local_d8 + -0x10);
...
/* FileAccessUnix::check_errors(bool) const */

int __thiscall FileAccessUnix::check_errors(FileAccessUnix *this,bool param_1)

{
  int iVar1;
  
  if (*(FILE **)(this + 400) == (FILE *)0x0) {
    _err_print_error("check_errors","drivers/unix/file_access_unix.cpp",0x32,
                     "Parameter \"f\" is null.","File must be opened before use.",0);
    return 0;
  }
...
/* FileAccessUnix::seek(unsigned long) */

int __thiscall FileAccessUnix::seek(FileAccessUnix *this,ulong param_1)

{
  int iVar1;
  
  if (*(FILE **)(this + 400) == (FILE *)0x0) {
    _err_print_error(&_LC18,"drivers/unix/file_access_unix.cpp",0xe2,"Parameter \"f\" is null.",
...
/* FileAccessUnix::seek_end(long) */

int __thiscall FileAccessUnix::seek_end(FileAccessUnix *this,long param_1)

{
  int iVar1;
  
  if (*(FILE **)(this + 400) == (FILE *)0x0) {
    _err_print_error("seek_end","drivers/unix/file_access_unix.cpp",0xea,"Parameter \"f\" is null.",
                     "File must be opened before use.",0);
    return 0;
  }
...
/* FileAccessUnix::get_position() const */

__off64_t __thiscall FileAccessUnix::get_position(FileAccessUnix *this)

{
  __off64_t _Var1;
  
  if (*(FILE **)(this + 400) == (FILE *)0x0) {
    _err_print_error("get_position","drivers/unix/file_access_unix.cpp",0xf2,
                     "Parameter \"f\" is null.","File must be opened before use.",0,0);
  }
  else {
    ...
    _err_print_error("get_position","drivers/unix/file_access_unix.cpp",0xf7,
...
/* FileAccessUnix::get_buffer(unsigned char*, unsigned long) const */

size_t __thiscall FileAccessUnix::get_buffer(FileAccessUnix *this,uchar *param_1,ulong param_2)

{
  size_t sVar1;
  
  if (*(FILE **)(this + 400) == (FILE *)0x0) {
    _err_print_error("get_buffer","drivers/unix/file_access_unix.cpp",0x10e,
                     "Parameter \"f\" is null.","File must be opened before use.",0,0);
  }
  else {
    ...
    _err_print_error("get_buffer","drivers/unix/file_access_unix.cpp",0x10f,
...
/* FileAccessUnix::store_buffer(unsigned char const*, unsigned long) */

ulong __thiscall FileAccessUnix::store_buffer(FileAccessUnix *this,uchar *param_1,ulong param_2)

{
  ...
  if (*(FILE **)(this + 400) == (FILE *)0x0) {
    uVar2 = 0;
    _err_print_error("store_buffer","drivers/unix/file_access_unix.cpp",0x132,
                     "Parameter \"f\" is null.","File must be opened before use.",0,0);
  }
  else if ((param_1 == (uchar *)0x0) && (param_2 != 0)) {
    uVar2 = 0;
    _err_print_error("store_buffer","drivers/unix/file_access_unix.cpp",0x133,
...
/* FileAccessUnix::_close() */

void __thiscall FileAccessUnix::_close(FileAccessUnix *this)
    ...
    if ((*(long *)(this + 0x1a0) != 0) && (1 < *(uint *)(*(long *)(this + 0x1a0) + -8))) {
      ...
      if (iVar5 != 0) {
        ...
        if (lVar3 == *(long *)(in_FS_OFFSET + 0x28)) {
          _err_print_error("_close","drivers/unix/file_access_unix.cpp",0xbd,
                           "Condition \"rename_error != 0\" is true.",0,0);
          return;
        }
        goto LAB_00100ead;
      }
...
void __thiscall FileAccessUnix::close(FileAccessUnix *this)
...
void __thiscall FileAccessUnix::~FileAccessUnix(FileAccessUnix *this)
...
/* FileAccessUnix::get_real_path() const */

void FileAccessUnix::get_real_path(void)
...
/* FileAccessUnix::open_internal(String const&, int) */

int __thiscall FileAccessUnix::open_internal(FileAccessUnix *this,String *param_1,int param_2)
...
LAB_001012a3:
  ...
  if (lVar13 != 0) {
    _err_print_error("open_internal","drivers/unix/file_access_unix.cpp",0x48,
                     "Condition \"f\" is true. Returning: ERR_ALREADY_IN_USE",
                     "File is already in use.",0,0);
    iVar7 = 0x16;
    goto LAB_00101360;
  }
  if (param_2 == 3) {
...
LAB_00101698:
          local_100 = 0;
          local_e8 = 
          "Case mismatch opening requested file \'%s\', stored as \'%s\' in the filesystem. This file will not open when exported to other case-sensitive platforms."
          ;
          local_e0 = 0x95;
          String::parse_latin1((StrRange *)&local_100);
          vformat<String,String>
                    ((String *)&local_e8,(StrRange *)&local_100,&local_f8,(String *)&local_f0);
          _err_print_error("open_internal","drivers/unix/file_access_unix.cpp",0x71,
                           (String *)&local_e8,0,1);
          pcVar9 = local_e8;
          if (local_e8 != (char *)0x0) {
            LOCK();
...
{
  return (uint)CONCAT71(0x1039,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1039,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1039,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialize_class()::initialized != '\0') goto LAB_00102400;
...
/* WARNING: Removing unreachable block (ram,0x001035c9) */
/* WARNING: Removing unreachable block (ram,0x0010345c) */
/* WARNING: Removing unreachable block (ram,0x00103466) */
/* WARNING: Removing unreachable block (ram,0x001035ab) */
/* WARNING: Removing unreachable block (ram,0x00103472) */
/* WARNING: Removing unreachable block (ram,0x0010347c) */
/* WARNING: Removing unreachable block (ram,0x0010358d) */
/* WARNING: Removing unreachable block (ram,0x00103488) */
/* WARNING: Removing unreachable block (ram,0x00103492) */
/* WARNING: Removing unreachable block (ram,0x0010356f) */
/* WARNING: Removing unreachable block (ram,0x0010349e) */
/* WARNING: Removing unreachable block (ram,0x001034a8) */
/* WARNING: Removing unreachable block (ram,0x00103551) */
/* WARNING: Removing unreachable block (ram,0x001034b4) */
/* WARNING: Removing unreachable block (ram,0x001034be) */
/* WARNING: Removing unreachable block (ram,0x00103533) */
/* WARNING: Removing unreachable block (ram,0x001034c6) */
/* WARNING: Removing unreachable block (ram,0x001034d0) */
/* WARNING: Removing unreachable block (ram,0x00103518) */
/* WARNING: Removing unreachable block (ram,0x001034d8) */
/* WARNING: Removing unreachable block (ram,0x001034ee) */
...
/* FileAccessUnix::open_internal(String const&, int) [clone .cold] */

void FileAccessUnix::open_internal(String *param_1,int param_2)

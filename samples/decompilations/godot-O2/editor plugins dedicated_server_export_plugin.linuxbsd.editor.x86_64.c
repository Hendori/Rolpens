...
void __thiscall
DedicatedServerExportPlugin::_end_customize_resources(DedicatedServerExportPlugin *this)
...
ulong DedicatedServerExportPlugin::_begin_customize_scenes(Ref *param_1,Vector *param_2)

{
  ...
  if (local_28 == (Object *)0x0) {
    uVar4 = 0;
    _err_print_error("_begin_customize_scenes","editor/plugins/dedicated_server_export_plugin.cpp",
                     0x5b,"Condition \"preset.is_null()\" is true. Returning: false",0,0);
  }
  else {
    *(undefined4 *)(param_1 + 0x458) = 0;
    ...
    if ((cVar2 != '\0') && (cVar2 = predelete_handler(local_28), cVar2 != '\0')) {
...
ulong DedicatedServerExportPlugin::_begin_customize_resources(Ref *param_1,Vector *param_2)

{
  ...
  if (local_28 == (Object *)0x0) {
    uVar4 = 0;
    _err_print_error("_begin_customize_resources",
                     "editor/plugins/dedicated_server_export_plugin.cpp",100,
                     "Condition \"preset.is_null()\" is true. Returning: false",0,0);
  }
  else {
    *(undefined4 *)(param_1 + 0x458) = 0;
    iVar3 = EditorExportPreset::get_export_filter();
...
/* DedicatedServerExportPlugin::_get_customization_configuration_hash() const */

undefined4 DedicatedServerExportPlugin::_get_customization_configuration_hash(void)

{
  ...
  if (local_30 == (Object *)0x0) {
    _err_print_error("_get_customization_configuration_hash",
                     "editor/plugins/dedicated_server_export_plugin.cpp",0x50,
                     "Condition \"preset.is_null()\" is true. Returning: 0",0,0);
  }
  else {
...
/* DedicatedServerExportPlugin::_get_export_mode_for_path(String const&) */

int __thiscall
DedicatedServerExportPlugin::_get_export_mode_for_path
          (DedicatedServerExportPlugin *this,String *param_1)

{
  ...
  if (local_98 == (Object *)0x0) {
    iVar7 = 0;
    _err_print_error("_get_export_mode_for_path","editor/plugins/dedicated_server_export_plugin.cpp"
                     ,0x23,
                     "Condition \"preset.is_null()\" is true. Returning: EditorExportPreset::MODE_FILE_NOT_CUSTOMIZED"
                     ,0,0);
  }
  else {
...
LAB_00100501:
      cVar6 = String::begins_with((char *)&local_90);
      pcVar5 = local_90;
      if (cVar6 != '\0') {
...
/* DedicatedServerExportPlugin::_customize_scene(Node*, String const&) */

undefined8 __thiscall
DedicatedServerExportPlugin::_customize_scene
          (DedicatedServerExportPlugin *this,Node *param_1,String *param_2)
...
/* DedicatedServerExportPlugin::_customize_resource(Ref<Resource> const&, String const&) */

Ref * DedicatedServerExportPlugin::_customize_resource(Ref *param_1,String *param_2)
...

{
  ...
  *(undefined8 *)(param_1 + 8) = 0;
  ...
  if (local_58 == (Object *)0x0) {
    _err_print_error("_get_export_features","editor/plugins/dedicated_server_export_plugin.cpp",0x46
                     ,"Condition \"preset.is_null()\" is true. Returning: ret",0,0);
    goto LAB_00100c29;
  }
...
{
  return (uint)CONCAT71(0x103b,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x103b,(undefined4 *)param_1 == &get_class_ptr_static()::ptr);
}
...
{
  return (uint)CONCAT71(0x103b,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x103a,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x103b,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}
...
/* DedicatedServerExportPlugin::get_name() const */

DedicatedServerExportPlugin * __thiscall
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialize_class()::initialized != '\0') goto LAB_001028bb;
...
/* DedicatedServerExportPlugin::~DedicatedServerExportPlugin() */

void __thiscall
DedicatedServerExportPlugin::~DedicatedServerExportPlugin(DedicatedServerExportPlugin *this)
...
void DedicatedServerExportPlugin::_GLOBAL__sub_I__get_export_mode_for_path(void)

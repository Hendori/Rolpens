...

{
  ...
  if (local_38 == '\0') {
    _err_print_error("enet_address_set_host","thirdparty/enet/enet_godot.cpp",0x1a5,
                     "Condition \"!ip.is_valid()\" is true. Returning: -1",0,0);
    uVar4 = 0xffffffff;
  }
  else {
  ...
  *param_1 = (undefined1  [16])0x0;
  ...
  if (uVar4 < 8) {
    if ((param_3 & 4) != 0) {
      ...
      *(undefined4 *)(param_1[-1] + (param_3 & 0xffffffff) + 0xc) =
           *(undefined4 *)((long)param_2 + ((param_3 & 0xffffffff) - 4));
      return;
    }
    if ((uVar4 != 0) && ((*param_1)[0] = *(undefined1 *)param_2, (param_3 & 2) != 0)) {
      *(undefined2 *)(param_1[-1] + (param_3 & 0xffffffff) + 0xe) =
           *(undefined2 *)((long)param_2 + ((param_3 & 0xffffffff) - 2));
      return;
    }
  }
  else {
    *(undefined8 *)*param_1 = *param_2;
    *(undefined8 *)(param_1[-1] + (param_3 & 0xffffffff) + 8) =
...

{
  ...
  *(undefined1 *)((long)puVar2 + 0x24) = 0;
  ...
  if ((pOVar3 == (Object *)0x0) || (cVar1 = RefCounted::init_ref(), cVar1 == '\0')) {
...

{
  ...
  if (cVar2 == '\0') {
    _err_print_error("enet_host_dtls_server_setup","thirdparty/enet/enet_godot.cpp",0x1c0,
                     "Condition \"!DTLSServer::is_available()\" is true. Returning: -1",
                     "DTLS server is not available in this build.",0,0);
  }
  else {
    plVar1 = (long *)*param_1;
...

{
  ...
  if (cVar4 == '\0') {
    _err_print_error("enet_host_dtls_client_setup","thirdparty/enet/enet_godot.cpp",0x1cb,
                     "Condition \"!PacketPeerDTLS::is_available()\" is true. Returning: -1",
                     "DTLS is not available in this build.",0,0);
  }
  else {
    plVar2 = (long *)*param_1;
    ...
    if (cVar4 != '\0') {
      ...
      if ((param_3 != (Object *)0x0) && (cVar4 = RefCounted::init_ref(), cVar4 == '\0')) {
        param_3 = (Object *)0x0;
      }
      ...
      *(undefined1 (*) [16])(puVar5 + 4) = (undefined1  [16])0x0;
      ...
      if (pOVar6 != param_3) {
        puVar5[4] = param_3;
        if ((param_3 != (Object *)0x0) && (cVar4 = RefCounted::reference(), cVar4 == '\0')) {
          puVar5[4] = 0;
        }
...
LAB_00100777:
      pOVar6 = (Object *)PacketPeerDTLS::create(true);
...
joined_r0x0010098f:
      ...
      *param_1 = puVar5;
      ...
      if (((param_3 != (Object *)0x0) && (cVar4 = RefCounted::unreference(), cVar4 != '\0')) &&
         (cVar4 = predelete_handler(param_3), cVar4 != '\0')) {
        (**(code **)(*(long *)param_3 + 0x140))(param_3);
...
void enet_host_refuse_new_connections(long *param_1,int param_2)

{
  ...
  _err_print_error("enet_host_refuse_new_connections","thirdparty/enet/enet_godot.cpp",0x1d6,
                   "Parameter \"host->socket\" is null.",0,0);
  return;
}
...
undefined4
enet_socket_receive(long *param_1,undefined1 (*param_2) [16],undefined8 *param_3,long param_4)

{
  ...
  if (param_4 == 1) {
    ...
    iVar2 = (**(code **)(*param_1 + 0x18))
                      (param_1,*param_3,*(undefined4 *)(param_3 + 1),&local_4c,local_48,param_2 + 1)
    ;
    uVar4 = 0;
    ...
    _err_print_error("enet_socket_receive","thirdparty/enet/enet_godot.cpp",0x218,
                     "Condition \"bufferCount != 1\" is true. Returning: -1",0,0);
  }
  uVar4 = 0xffffffff;
LAB_00100d93:
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
...

{
  ...
  if (param_2 == 0) {
    uVar3 = 0xffffffff;
    _err_print_error("enet_socket_send","thirdparty/enet/enet_godot.cpp",0x1f0,
                     "Parameter \"address\" is null.",0,0);
    goto LAB_001010ac;
  }
  IPAddress::clear();
...
LAB_00101025:
  ...
  local_5c = 0;
  iVar9 = (**(code **)(*param_1 + 0x10))
                    (param_1,puVar8,iVar9,&local_5c,*(undefined2 *)(param_2 + 0x10));
  uVar3 = local_5c;
  if ((iVar9 != 0) && (uVar3 = 0, iVar9 != 0x2c)) {
...
/* ENetGodotSocket::set_refuse_new_connections(bool) */

void ENetGodotSocket::set_refuse_new_connections(bool param_1)
...
/* ENetGodotSocket::can_upgrade() */

undefined8 ENetGodotSocket::can_upgrade(void)
...
undefined8 ENetUDP::can_upgrade(void)
...
/* ENetUDP::bind(IPAddress, unsigned short) */

void ENetUDP::bind(long param_1,undefined2 param_2)
...
/* ENetUDP::get_socket_address(IPAddress*, unsigned short*) */

void ENetUDP::get_socket_address(IPAddress *param_1,ushort *param_2)
...
/* ENetUDP::sendto(unsigned char const*, int, int&, IPAddress, unsigned short) */

void ENetUDP::sendto(long param_1)
...
/* ENetUDP::set_option(_ENetSocketOption, int) */

undefined8 __thiscall ENetUDP::set_option(ENetUDP *this,uint param_2,int param_3)
...
/* ENetDTLSClient::set_option(_ENetSocketOption, int) */

undefined8 ENetDTLSClient::set_option(void)
...
/* ENetDTLSServer::set_option(_ENetSocketOption, int) */

undefined8 ENetDTLSServer::set_option(void)
...
void __thiscall ENetUDP::close(ENetUDP *this)
...
/* ENetDTLSServer::set_refuse_new_connections(bool) */

void ENetDTLSServer::set_refuse_new_connections(bool param_1)

{
  undefined7 in_register_00000039;
  
  UDPServer::set_max_pending_connections
            ((int)*(undefined8 *)(CONCAT71(in_register_00000039,param_1) + 0x10));
  return;
}



/* ENetDTLSClient::recvfrom(unsigned char*, int, int&, IPAddress&, unsigned short&) */

int __thiscall
ENetDTLSClient::recvfrom
          (ENetDTLSClient *this,uchar *param_1,int param_2,int *param_3,IPAddress *param_4,
          ushort *param_5)
...
LAB_00101630:
    ...
    if (iVar2 == 2) {
      ...
      if (-1 < iVar2) {
        iVar2 = (**(code **)(**(long **)(this + 0x18) + 0x158))
                          (*(long **)(this + 0x18),&local_60,param_3);
        if (iVar2 == 0) {
          if (param_2 < *param_3) {
            _err_print_error("recvfrom","thirdparty/enet/enet_godot.cpp",0xef,
                             "Condition \"p_len < r_read\" is true. Returning: ERR_OUT_OF_MEMORY",0,
                             0);
            iVar2 = 6;
          }
          else {
          ...
          _err_print_error("recvfrom","thirdparty/enet/enet_godot.cpp",0xee,
...
/* ENetDTLSServer::bind(IPAddress, unsigned short) */

void ENetDTLSServer::bind(long param_1,ushort param_2)
...
/* ENetDTLSClient::bind(IPAddress, unsigned short) */

void ENetDTLSClient::bind(long param_1,ushort param_2)

{
  ...
  *(undefined8 *)(param_1 + 0x38) = in_stack_00000010;
  PacketPeerUDP::bind((int)*(undefined8 *)(param_1 + 0x10),(IPAddress *)(ulong)param_2,
                      (int)&stack0x00000008);
  return;
}
...
/* ENetDTLSClient::close() */

void __thiscall ENetDTLSClient::close(ENetDTLSClient *this)
...
/* ENetUDP::recvfrom(unsigned char*, int, int&, IPAddress&, unsigned short&) */

void __thiscall
ENetUDP::recvfrom(ENetUDP *this,uchar *param_1,int param_2,int *param_3,IPAddress *param_4,
                 ushort *param_5)

{
  ...
  if (iVar1 == 0) {
    (**(code **)(**(long **)(this + 8) + 0x188))
              (*(long **)(this + 8),param_1,param_2,param_3,param_4,param_5,0);
  }
  return;
}
...
/* ENetDTLSClient::get_socket_address(IPAddress*, unsigned short*) */

undefined8 __thiscall
ENetDTLSClient::get_socket_address(ENetDTLSClient *this,IPAddress *param_1,ushort *param_2)
...
/* ENetDTLSServer::get_socket_address(IPAddress*, unsigned short*) */

undefined8 __thiscall
ENetDTLSServer::get_socket_address(ENetDTLSServer *this,IPAddress *param_1,ushort *param_2)
...
void __thiscall ENetUDP::~ENetUDP(ENetUDP *this)
...
/* ENetDTLSClient::sendto(unsigned char const*, int, int&, IPAddress, unsigned short) */

undefined8
ENetDTLSClient::sendto(long param_1,undefined8 param_2,undefined4 param_3,undefined4 *param_4)
...
/* ENetDTLSServer::close() */

void __thiscall ENetDTLSServer::close(ENetDTLSServer *this)

{
  ...
  for (puVar3 = *(undefined8 **)(this + 0x30); puVar3 != (undefined8 *)0x0;
...
/* ENetDTLSServer::~ENetDTLSServer() */

void __thiscall ENetDTLSServer::~ENetDTLSServer(ENetDTLSServer *this)
...
/* ENetDTLSClient::~ENetDTLSClient() */

void __thiscall ENetDTLSClient::~ENetDTLSClient(ENetDTLSClient *this)
...
/* ENetDTLSServer::ENetDTLSServer(ENetUDP*, Ref<TLSOptions>) */

void __thiscall ENetDTLSServer::ENetDTLSServer(ENetDTLSServer *this,long *param_1,long *param_3)
...
LAB_00102541:
  ...
  if (((Object *)*param_3 != (Object *)0x0) &&
     (local_60 = (Object *)*param_3, cVar4 = RefCounted::reference(), cVar4 == '\0')) {
    local_60 = (Object *)0x0;
  }
  (*pcVar1)(plVar6);
...
/* HashMap<String, Ref<PacketPeerDTLS>, HashMapHasherDefault, HashMapComparatorDefault<String>,
   DefaultTypedAllocator<HashMapElement<String, Ref<PacketPeerDTLS> > > >::operator[](String const&)
    */

undefined1 * __thiscall
HashMap<String,Ref<PacketPeerDTLS>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<PacketPeerDTLS>>>>
::operator[](HashMap<String,Ref<PacketPeerDTLS>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<PacketPeerDTLS>>>>
             *this,String *param_1)
...
LAB_00102c94:
    if ((float)uVar40 * __LC25 < (float)(iVar46 + 1)) goto LAB_00102cba;
  }
  local_58[0] = 0;
  if (*(long *)param_1 == 0) {
...
/* ENetDTLSServer::sendto(unsigned char const*, int, int&, IPAddress, unsigned short) */

undefined4
ENetDTLSServer::sendto(long param_1,undefined8 param_2,undefined4 param_3,undefined4 *param_4)
      ...
      do {
        if (uVar18 == uVar15) {
          cVar14 = String::operator==((String *)
                                      (*(long *)(*(long *)(param_1 + 0x20) + lVar19 * 8) + 0x10),
                                      (String *)&local_78);
          if (cVar14 != '\0') {
            plVar17 = (long *)HashMap<String,Ref<PacketPeerDTLS>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<PacketPeerDTLS>>>>
                              ::operator[]((HashMap<String,Ref<PacketPeerDTLS>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<PacketPeerDTLS>>>>
        ...
        iVar16 = SUB164(auVar4 * auVar8,8);
              ...
              auVar10._8_8_ = 0, auVar10._0_8_ = uVar12, uVar23 <= SUB164(auVar6 * auVar10,8)));
    }
  }
  uVar21 = 0;
  *param_4 = param_3;
...
/* ENetDTLSServer::recvfrom(unsigned char*, int, int&, IPAddress&, unsigned short&) */

undefined4 __thiscall
ENetDTLSServer::recvfrom
          (ENetDTLSServer *this,uchar *param_1,int param_2,int *param_3,IPAddress *param_4,
          ushort *param_5)

{
  ...
  if (cVar30 != '\0') {
    ...
    if (((local_68 != (Object *)0x0) &&
        (cVar30 = RefCounted::unreference(), pOVar46 = local_68, cVar30 != '\0')) &&
       (cVar30 = predelete_handler(local_68), cVar30 != '\0')) {
    ...
    if (iVar32 - 1U < 2) {
      ...
      puVar35 = (undefined8 *)
                HashMap<String,Ref<PacketPeerDTLS>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<PacketPeerDTLS>>>>
                ::operator[]((HashMap<String,Ref<PacketPeerDTLS>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<PacketPeerDTLS>>>>
                              *)(this + 0x18),(String *)&local_88);
      pOVar46 = (Object *)*puVar35;
      if (local_90 != pOVar46) {
        *puVar35 = local_90;
        if ((local_90 != (Object *)0x0) && (cVar30 = RefCounted::reference(), cVar30 == '\0')) {
          *puVar35 = 0;
        }
        if (((pOVar46 != (Object *)0x0) && (cVar30 = RefCounted::unreference(), cVar30 != '\0')) &&
           (cVar30 = predelete_handler(pOVar46), cVar30 != '\0')) {
          (**(code **)(*(long *)pOVar46 + 0x140))(pOVar46);
          Memory::free_static(pOVar46,false);
        }
      }
    ...
    if (((local_90 != (Object *)0x0) && (cVar30 = RefCounted::unreference(), cVar30 != '\0')) &&
       (cVar30 = predelete_handler(local_90), cVar30 != '\0')) {
      (**(code **)(*(long *)local_90 + 0x140))(local_90);
      Memory::free_static(local_90,false);
    }
    if (((local_98 != (Object *)0x0) && (cVar30 = RefCounted::unreference(), cVar30 != '\0')) &&
       (cVar30 = predelete_handler(local_98), cVar30 != '\0')) {
      (**(code **)(*(long *)local_98 + 0x140))(local_98);
      Memory::free_static(local_98,false);
    }
  }
  plVar42 = *(long **)(this + 0x30);
  uVar47 = 0x2c;
  local_78 = (undefined1 (*) [16])0x0;
  if (plVar42 != (long *)0x0) {
    do {
...
LAB_00103f4b:
        ...
        if ((iVar32 == 0) && (*param_3 <= param_2)) {
          ...
          if ((local_60 == (String *)0x0) || (*(long *)(local_60 + -8) != 2)) {
            _err_print_error("recvfrom","thirdparty/enet/enet_godot.cpp",0x16e,
                             "Condition \"s.size() != 2\" is true. Continuing.",0,0);
            ...
            if (local_60 == (String *)0x0) {
              ...
              if (1 < lVar44) {
                ...
                *param_5 = uVar31;
                CowData<String>::_unref((CowData<String> *)&local_60);
                cVar30 = RefCounted::unreference();
                if ((cVar30 != '\0') && (cVar30 = predelete_handler(pOVar46), cVar30 != '\0')) {
                  (**(code **)(*(long *)pOVar46 + 0x140))(pOVar46);
                  Memory::free_static(pOVar46,false);
                }
                break;
          ...
          _err_print_index_error
                    ("get","./core/templates/cowdata.h",0xdb,lVar36,lVar44,"p_index","size()","",
                     false,true);
          _err_flush_stdout();
                    /* WARNING: Does not return */
          pcVar27 = (code *)invalidInstructionException();
            ...
            do {
              if (uVar37 == uVar33) {
                cVar30 = String::operator==((String *)
                                            (*(long *)(*(long *)(this + 0x20) + lVar39 * 8) + 0x10),
                                            pSVar45);
              ...
              if ((uVar33 == 0) ||
                 (auVar9._8_8_ = 0, auVar9._0_8_ = (ulong)uVar33 * lVar44, auVar19._8_8_ = 0,
                 auVar19._0_8_ = uVar41, auVar10._8_8_ = 0,
                 auVar10._0_8_ = (ulong)((uVar5 + uVar38) - SUB164(auVar9 * auVar19,8)) * lVar44,
                 auVar20._8_8_ = 0, auVar20._0_8_ = uVar41, SUB164(auVar10 * auVar20,8) < uVar48)) {
...
LAB_00103e78:
  ...
  __stack_chk_fail();
LAB_00103cc6:
  lVar44 = *(long *)(this + 0x28);
  lVar36 = *(long *)(this + 0x20);
  uVar5 = *(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x40) * 4);
  uVar41 = CONCAT44(0,uVar5);
  lVar39 = *(long *)(hash_table_size_primes_inv + (ulong)*(uint *)(this + 0x40) * 8);
  auVar11._8_8_ = 0;
  auVar11._0_8_ = (ulong)(uVar38 + 1) * lVar39;
  auVar21._8_8_ = 0;
  auVar21._0_8_ = uVar41;
  lVar40 = SUB168(auVar11 * auVar21,8);
  puVar2 = (uint *)(lVar44 + lVar40 * 4);
  uVar33 = SUB164(auVar11 * auVar21,8);
  uVar37 = *puVar2;
  if (uVar37 != 0) {
    auVar12._8_8_ = 0;
  ...
  uVar41 = (ulong)uVar38;
  plVar42 = (long *)(lVar36 + uVar41 * 8);
  *(undefined4 *)(lVar44 + uVar41 * 4) = 0;
  plVar43 = (long *)*plVar42;
  if (*(long **)(this + 0x30) == plVar43) {
    *(long *)(this + 0x30) = *plVar43;
    plVar43 = (long *)*plVar42;
    if (plVar43 != *(long **)(this + 0x38)) goto LAB_00103de5;
  }
  else if (plVar43 != *(long **)(this + 0x38)) goto LAB_00103de5;
  *(long *)(this + 0x38) = plVar43[1];
  plVar43 = (long *)*plVar42;
LAB_00103de5:
  ...
  if ((plVar43[3] != 0) && (cVar30 = RefCounted::unreference(), cVar30 != '\0')) {
  ...
  *(undefined8 *)(*(long *)(this + 0x20) + uVar41 * 8) = 0;
  *(int *)(this + 0x44) = *(int *)(this + 0x44) + -1;
LAB_00103e65:
  pSVar45 = *(String **)(pSVar45 + 8);
  if (pSVar45 == (String *)0x0) goto LAB_00103e78;
  goto LAB_00103bc8;
}
...
void __thiscall ENetDTLSServer::ENetDTLSServer(void)

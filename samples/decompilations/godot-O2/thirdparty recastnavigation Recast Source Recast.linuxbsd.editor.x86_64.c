...
void rcContext::doResetLog(void)
...
/* calcTriNormal(float const*, float const*, float const*, float*) */

void calcTriNormal(float *param_1,float *param_2,float *param_3,float *param_4)

{
  ...
  fVar6 = ((float)((ulong)*(undefined8 *)(param_2 + 1) >> 0x20) - fVar2) * fVar3 -
          ((float)((ulong)*(undefined8 *)(param_3 + 1) >> 0x20) - fVar2) * fVar7;
...
void rcContext::log(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...
void __thiscall rcHeightfield::rcHeightfield(rcHeightfield *this)
...
void __thiscall rcCompactHeightfield::rcCompactHeightfield(rcCompactHeightfield *this)
...
{
  rcFree(*(void **)(this + 0x40));
  rcFree(*(void **)(this + 0x48));
  rcFree(*(void **)(this + 0x50));
  rcFree(*(void **)(this + 0x58));
  return;
}
...
void rcAllocHeightfieldLayerSet(void)
...
void __thiscall rcHeightfieldLayerSet::rcHeightfieldLayerSet(rcHeightfieldLayerSet *this)
...

{
  ...
  if (0 < *(int *)(this + 8)) {
    ...
    do {
      lVar1 = lVar2 + 1;
      lVar2 = lVar2 * 0x58;
      rcFree(*(void **)(*(long *)this + 0x40 + lVar2));
      rcFree(*(void **)(*(long *)this + 0x48 + lVar2));
      rcFree(*(void **)(*(long *)this + 0x50 + lVar2));
      lVar2 = lVar1;
...
void __thiscall rcContourSet::rcContourSet(rcContourSet *this)
...
void __thiscall rcPolyMesh::rcPolyMesh(rcPolyMesh *this)
...

{
  ...
  rcFree(*(void **)(this + 0x18));
  rcFree(*(void **)(this + 0x20));
  return;
}
...
void rcAllocPolyMeshDetail(void)
...
void __thiscall rcPolyMeshDetail::rcPolyMeshDetail(rcPolyMeshDetail *this)
...
/* rcGetHeightFieldSpanCount(rcContext*, rcHeightfield const&) */
...
/* rcBuildCompactHeightfield(rcContext*, int, int, rcHeightfield const&, rcCompactHeightfield&) */
...

{
  ...
  *(undefined4 *)(param_5 + 0x1c) = *(undefined4 *)(param_4 + 8);
  *(undefined4 *)(param_5 + 0x20) = *(undefined4 *)(param_4 + 0xc);
  *(undefined4 *)(param_5 + 0x24) = *(undefined4 *)(param_4 + 0x10);
    ...
    *(void **)(param_5 + 0x48) = pvVar16;
    if (pvVar16 == (void *)0x0) {
      ...
      *(void **)(param_5 + 0x58) = pvVar16;
      if (pvVar16 == (void *)0x0) {
        uVar23 = 0;
        rcContext::log(param_1,3,"rcBuildCompactHeightfield: Out of memory \'chf.areas\' (%d)",
                       iVar39);
      }
      else {
            ...
            if (0 < iVar7) {
              ...
              do {
                ...
                if (uVar11 < uVar25) {
                  ...
                  do {
                    iVar17 = 0;
                    piVar24 = &rcGetDirOffsetX(int)::offset;
                    piVar22 = &rcGetDirOffsetY(int)::offset;
                    ...
                    do {
                      ...
                      if (((-1 < (int)(uVar31 | uVar13)) && ((int)uVar31 < iVar7)) &&
                         ((int)uVar13 < iVar8)) {
                          ...
                          do {
                            ...
                            if (param_2 <= (int)(uVar14 - uVar28)) {
                              ...
                              if (iVar15 <= param_3) {
                                iVar34 = (int)uVar36;
                                if (uVar36 < 0x3f) {
                                  uVar26 = (~uVar12 & (uVar27 | uVar12) |
                                           iVar34 << ((byte)iVar17 & 0x1f)) & 0xffffff;
                                  break;
                                }
                                if (iVar34 <= local_5c) {
                                  iVar34 = local_5c;
                    ...
                    *(uint *)(puVar20 + 2) = *(uint *)(puVar20 + 2) & 0xff000000 | uVar26;
                    puVar20 = puVar33;
                           ...
                           (ushort *)(lVar30 + ((ulong)(uVar25 - uVar11) + (ulong)uVar11) * 8));
                }
                iVar29 = iVar29 + 1;
                puVar19 = puVar19 + 1;
              } while (iVar7 != iVar29);
...
void __thiscall rcContext::~rcContext(rcContext *this)
...
/* rcContext::doLog(rcLogCategory, char const*, int) */

void rcContext::doLog(void)
...
void rcContext::doResetTimers(void)
...
/* rcContext::doGetAccumulatedTime(rcTimerLabel) const */

undefined8 rcContext::doGetAccumulatedTime(void)

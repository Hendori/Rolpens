...
/* ParticleProcessMaterialMinMaxPropertyEditor::_set_mouse_inside(bool) */
...
/* CowData<Range*>::_copy_on_write() [clone .isra.0] */

void __thiscall CowData<Range*>::_copy_on_write(CowData<Range*> *this)
...
/* EditorInspectorParticleProcessMaterialPlugin::can_handle(Object*) */

bool __thiscall
EditorInspectorParticleProcessMaterialPlugin::can_handle
          (EditorInspectorParticleProcessMaterialPlugin *this,Object *param_1)
...
/* ParticleProcessMaterialMinMaxPropertyEditor::_notification(int) [clone .part.0] */

void ParticleProcessMaterialMinMaxPropertyEditor::_notification(int param_1)

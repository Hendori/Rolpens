...
/* NavRegion::set_use_edge_connections(bool) */

void __thiscall NavRegion::set_use_edge_connections(NavRegion *this,bool param_1)
...
/* NavRegion::set_navigation_layers(unsigned int) */

void __thiscall NavRegion::set_navigation_layers(NavRegion *this,uint param_1)
...
/* NavRegion::set_owner_id(ObjectID) */

void __thiscall NavRegion::set_owner_id(NavRegion *this,long param_2)
...
/* NavRegion::set_travel_cost(float) */

void __thiscall NavRegion::set_travel_cost(NavRegion *this,float param_1)
...
/* NavRegion::set_enter_cost(float) */

void __thiscall NavRegion::set_enter_cost(NavRegion *this,float param_1)
...
/* NavRegion::set_map(NavMap*) */

void __thiscall NavRegion::set_map(NavRegion *this,NavMap *param_1)
...
/* NavRegion::set_enabled(bool) */

void __thiscall NavRegion::set_enabled(NavRegion *this,bool param_1)
...
/* NavRegion::set_transform(Transform3D) */

void NavRegion::set_transform(long param_1)
  ...
  if (cVar5 == '\0') {
    ...
    *(undefined8 *)(param_1 + 0x98) = in_stack_00000030;
    if (pSVar6 != (SelfList *)0x0) {
      ...
      fVar8 = atan2f(SQRT(fVar9 * fVar9 + fVar7 * fVar7 + fVar10 * fVar10),
                     local_1c * fVar1 + fVar8 * fStack_18 + fVar2 * fVar3);
      if ((__LC2 <= fVar8 * __LC1) && (set_transform(Transform3D)::first_print != '\0')) {
        _err_print_error("set_transform","modules/navigation/nav_region.cpp",0x5b,
                         "Attempted to update a navigation region transform rotated 90 degrees or more away from the current navigation map UP orientation."
                         ,0,0);
        set_transform(Transform3D)::first_print = '\0';
      }
    }
  }
LAB_0010026e:
...
/* NavRegion::get_closest_point_to_segment(Vector3 const&, Vector3 const&, bool) const */

undefined1  [16] __thiscall
NavRegion::get_closest_point_to_segment
          (NavRegion *this,Vector3 *param_1,Vector3 *param_2,bool param_3)

{
  ...
  if (iVar3 != 0x23) {
    auVar2 = NavMeshQueries3D::polygons_get_closest_point_to_segment
                       ((LocalVector *)(this + 0xa8),param_1,param_2,param_3);
...
/* NavRegion::get_closest_point_info(Vector3 const&) const */

NavRegion * __thiscall NavRegion::get_closest_point_info(NavRegion *this,Vector3 *param_1)
...
/* NavRegion::get_random_point(unsigned int, bool) const */

undefined1  [16] __thiscall NavRegion::get_random_point(NavRegion *this,uint param_1,bool param_2)

{
  ...
  if (iVar2 != 0x23) {
    if (this[0xa0] == (NavRegion)0x0) {
      ...
      auVar4 = NavMeshQueries3D::polygons_get_random_point
                         ((LocalVector *)(this + 0xa8),param_1,param_2);
    }
    pthread_rwlock_unlock((pthread_rwlock_t *)(this + 0x30));
    if (lVar1 == *(long *)(in_FS_OFFSET + 0x28)) {
      auVar3._12_4_ = 0;
...
/* NavRegion::request_sync() */

void __thiscall NavRegion::request_sync(NavRegion *this)
...
/* NavRegion::cancel_sync_request() */

void __thiscall NavRegion::cancel_sync_request(NavRegion *this)
...
void __thiscall NavRegion::NavRegion(NavRegion *this)
...
/* NavRegion::get_iteration_update(NavRegionIteration&) */

void __thiscall NavRegion::get_iteration_update(NavRegion *this,NavRegionIteration *param_1)

{
  ...
  *(undefined4 *)(param_1 + 0x70) = *(undefined4 *)(this + 0xb8);
  LocalVector<gd::Polygon,unsigned_int,false,false>::resize
            ((LocalVector<gd::Polygon,unsigned_int,false,false> *)(param_1 + 0x60),0);
  LocalVector<gd::Polygon,unsigned_int,false,false>::resize
            ((LocalVector<gd::Polygon,unsigned_int,false,false> *)(param_1 + 0x60),
             *(uint *)(this + 0xa8));
  lVar21 = 0;
  uVar20 = 0;
  if (*(int *)(this + 0xa8) != 0) {
      ...
      *(NavRegionIteration **)(puVar23 + 2) = param_1;
      if (uVar19 <= (uint)uVar20) {
        _err_print_index_error
                  ("operator[]","./core/templates/local_vector.h",0xb2,uVar20,(ulong)uVar19,
        ...
        do {
          ...
          *(undefined4 *)(puVar12 + 1) = 0;
          ...
          puVar12 = puVar13;
                 ...
                 (undefined8 *)(lVar17 + 0x18 + ((ulong)(uVar22 - uVar9) + (ulong)uVar9) * 0x18));
        puVar24[4] = uVar19;
        uVar16 = (ulong)(uint)puVar23[4];
      }
LAB_001008fc:
      ...
      LocalVector<gd::Edge,unsigned_int,false,false>::resize
                ((LocalVector<gd::Edge,unsigned_int,false,false> *)(puVar24 + 8),puVar23[8]);
      if (puVar23[8] != 0) {
        do {
            ...
            do {
              ...
              *(undefined4 *)(puVar12 + 4) = 0;
              puVar12 = puVar13;
                     ...
                     (undefined8 *)(lVar14 + 0x28 + ((ulong)(uVar22 - uVar9) + (ulong)uVar9) * 0x28)
                    );
            *puVar18 = uVar19;
            uVar16 = (ulong)*puVar15;
          }
...
/* NavRegion::update_polygons() [clone .part.0] */

void __thiscall NavRegion::update_polygons(NavRegion *this)

{
  ...
  LocalVector<gd::Polygon,unsigned_int,false,false>::resize
            ((LocalVector<gd::Polygon,unsigned_int,false,false> *)(this + 0xa8),0);
  fStack_5c = 0.0;
  fStack_58 = 0.0;
  local_68 = 0;
  fStack_60 = 0.0;
  ...
  *(undefined4 *)(this + 200) = 0;
  if (*(long *)(this + 0x68) == 0) {
    ...
    if (((lVar12 == 0) || (*(long *)(this + 0x128) == 0)) ||
       (iVar22 = (int)*(undefined8 *)(lVar12 + -8), iVar22 == 0)) {
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) goto LAB_00100e97;
    }
    else {
      LocalVector<gd::Polygon,unsigned_int,false,false>::resize
                ((LocalVector<gd::Polygon,unsigned_int,false,false> *)(this + 0xa8),
                 *(uint *)(*(long *)(this + 0x128) + -8));
...
LAB_00101592:
            _err_print_index_error
                      ("get","./core/templates/cowdata.h",0xdb,lVar35,lVar34,"p_index","size()","",
                       false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_001014b3:
                      ...
                      do {
                        ...
                        *(undefined4 *)(puVar27 + 1) = 0;
                        ...
                        puVar27 = puVar28;
                               ...
                               (lVar29 + 0x18 + ((ulong)(uVar36 - uVar23) + (ulong)uVar23) * 0x18)
                               != puVar28);
                    }
                    *(uint *)(this_00 + -0x10) = uVar33;
                  }
                ...
                do {
                  ...
                  fVar4 = pfVar2[2];
                  fVar5 = pfVar2[1];
                  local_48 = *(float *)(this + 0x88) * fVar42 + *(float *)(this + 0x8c) * fVar43 +
                             fVar39 * fVar41 + *(float *)(this + 0x9c);
                  pfVar2 = (float *)(lVar12 + (long)*piVar14 * 0xc);
                  fVar6 = pfVar2[1];
                  fVar7 = *pfVar2;
                  fVar8 = pfVar2[2];
                  fVar9 = *(float *)(this + 0x78);
                  fStack_60 = fVar39 * fVar8 +
                              fVar7 * *(float *)(this + 0x88) + fVar6 * *(float *)(this + 0x8c) +
                              *(float *)(this + 0x9c);
                  fStack_5c = fVar9 * fVar4 + fVar3 * fVar17 + fVar5 * fVar18 + fStack_50;
                  local_68 = CONCAT44(*(float *)(this + 0x84) * fVar8 +
                                      fVar7 * fVar19 + fVar6 * fVar20 + fStack_4c,
                                      fVar9 * fVar8 + fVar7 * fVar17 + fVar6 * fVar18 + fStack_50);
                  fStack_58 = fStack_4c +
                              fVar19 * fVar3 + fVar5 * fVar20 + fVar4 * *(float *)(this + 0x84);
                  fStack_54 = *(float *)(this + 0x9c) +
                              *(float *)(this + 0x88) * fVar3 + fVar5 * *(float *)(this + 0x8c) +
                              fVar4 * fVar39;
                  fStack_50 = fStack_50 + fVar17 * fVar42 + fVar43 * fVar18 + fVar41 * fVar9;
                  fStack_4c = fStack_4c +
                              fVar19 * fVar42 + fVar43 * fVar20 + fVar41 * *(float *)(this + 0x84);
                ...
                *(float *)(this_00 + 0x10) = fVar40;
                do {
                  ...
                  if (iVar22 <= iVar11 || iVar11 < 0) {
                    ...
                    _err_print_error("update_polygons","modules/navigation/nav_region.cpp",0x11b,
                                     "Condition \"!valid\" is true. Breaking.",
                                     "The navigation mesh set in this region is not valid!",0,0);
                  ...
                  fStack_60 = *(float *)(this + 0x88) * fVar42 + *(float *)(this + 0x8c) * fVar43 +
                              *(float *)(this + 0x90) * fVar39 + *(float *)(this + 0x9c);
                  local_68 = CONCAT44(*(float *)(this + 0x80) * fVar43 +
                                      (float)((ulong)*(undefined8 *)(this + 0x78) >> 0x20) * fVar42
                                      + (float)((ulong)*(undefined8 *)(this + 0x80) >> 0x20) *
                                        fVar39 +
                                      (float)((ulong)*(undefined8 *)(this + 0x94) >> 0x20),
                                      *(float *)(this + 0x74) * fVar43 +
                                      (float)*(undefined8 *)(this + 0x70) * fVar42 +
                                      (float)*(undefined8 *)(this + 0x78) * fVar39 +
                                      (float)*(undefined8 *)(this + 0x94));
                  if (uVar33 <= (uint)uVar37) {
LAB_00101458:
                    _err_print_index_error
                              ("operator[]","./core/templates/local_vector.h",0xb2,uVar37,
                               (ulong)uVar33,"p_index","count","",false,true);
                    _err_flush_stdout();
                    /* WARNING: Does not return */
                    pcVar16 = (code *)invalidInstructionException();
                    (*pcVar16)();
...
NavRegion __thiscall NavRegion::sync(NavRegion *this)
...
/* NavRegion::set_navigation_mesh(Ref<NavigationMesh>) */

void __thiscall NavRegion::set_navigation_mesh(NavRegion *this,long *param_2)

{
  ...
  if ((*(long *)(this + 0x68) != 0) && (*param_2 != 0)) {
    ...
    if (fVar6 != *(float *)(lVar5 + 0x14)) {
      ...
      if ((dVar7 <= ABS(dVar2 - (double)fVar6)) &&
         (set_navigation_mesh(Ref<NavigationMesh>)::first_print != '\0')) {
        fVar6 = (float)NavigationMesh::get_cell_size();
        local_48 = 
        "Attempted to update a navigation region with a navigation mesh that uses a `cell_size` of %s while assigned to a navigation map set to a `cell_size` of %s. The cell size for navigation maps can be changed by using the NavigationServer map_set_cell_size() function. The cell size for default navigation maps can also be changed in the ProjectSettings."
        ;
        local_50 = 0;
        local_40 = 0x15e;
        String::parse_latin1((StrRange *)&local_50);
        vformat<double,double>((String_conflict *)&local_48,(double)fVar6,dVar2);
        _err_print_error("set_navigation_mesh","modules/navigation/nav_region.cpp",99,
    ...
    if (*param_2 != 0) {
      ...
      if (fVar6 != *(float *)(*(long *)(this + 0x68) + 0x18)) {
        ...
        if ((dVar7 <= ABS(dVar2 - (double)fVar6)) &&
          ...
          fVar6 = (float)NavigationMesh::get_cell_height();
          local_48 = 
          "Attempted to update a navigation region with a navigation mesh that uses a `cell_height` of %s while assigned to a navigation map set to a `cell_height` of %s. The cell height for navigation maps can be changed by using the NavigationServer map_set_cell_height() function. The cell height for default navigation maps can also be changed in the ProjectSettings."
          ;
          local_50 = 0;
          local_40 = 0x168;
          String::parse_latin1((StrRange *)&local_50);
          vformat<double,double>((String_conflict *)&local_48,(double)fVar6,dVar2);
          _err_print_error("set_navigation_mesh","modules/navigation/nav_region.cpp",0x67,
                           (String_conflict *)&local_48,0,0);
          pcVar3 = local_48;
          if (local_48 != (char *)0x0) {
            LOCK();
...
LAB_00101a40:
  iVar4 = pthread_rwlock_wrlock((pthread_rwlock_t *)(this + 0xd8));
  if (iVar4 == 0x23) {
                    /* WARNING: Subroutine does not return */
    std::__throw_system_error(0x23);
  }
...
/* WARNING: Removing unreachable block (ram,0x001026a9) */
/* WARNING: Removing unreachable block (ram,0x0010253c) */
/* WARNING: Removing unreachable block (ram,0x00102546) */
/* WARNING: Removing unreachable block (ram,0x0010268b) */
/* WARNING: Removing unreachable block (ram,0x00102552) */
/* WARNING: Removing unreachable block (ram,0x0010255c) */
/* WARNING: Removing unreachable block (ram,0x0010266d) */
/* WARNING: Removing unreachable block (ram,0x00102568) */
/* WARNING: Removing unreachable block (ram,0x00102572) */
...
/* WARNING: Removing unreachable block (ram,0x00102631) */
/* WARNING: Removing unreachable block (ram,0x00102594) */
/* WARNING: Removing unreachable block (ram,0x0010259e) */
/* WARNING: Removing unreachable block (ram,0x00102613) */
/* WARNING: Removing unreachable block (ram,0x001025a6) */
/* WARNING: Removing unreachable block (ram,0x001025b0) */
/* WARNING: Removing unreachable block (ram,0x001025f8) */
/* WARNING: Removing unreachable block (ram,0x001025b8) */
/* WARNING: Removing unreachable block (ram,0x001025ce) */
/* WARNING: Removing unreachable block (ram,0x001025da) */
/* String vformat<double, double>(String const&, double const, double const) */

String_conflict * vformat<double,double>(String_conflict *param_1,double param_2,double param_3)
  ...
  if (param_1 < uVar7) {
    ...
    do {
      ...
      if (*(long *)(lVar5 + 0x28) != 0) {
        LocalVector<gd::Edge,unsigned_int,false,false>::resize
                  ((LocalVector<gd::Edge,unsigned_int,false,false> *)(lVar5 + 0x20),0);

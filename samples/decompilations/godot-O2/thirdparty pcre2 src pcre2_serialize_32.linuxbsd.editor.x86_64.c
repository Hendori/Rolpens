...

{
  ...
  bVar12 = 0;
  puVar4 = (undefined8 *)&_pcre2_default_compile_context_32;
...
int pcre2_serialize_decode_32(undefined8 *param_1,int param_2,int *param_3,undefined8 *param_4)

{
  ...
  bVar10 = 0;
  puVar9 = (undefined8 *)&_pcre2_default_compile_context_32;
...
LAB_0010038b:
      ...
      if ((param_3[1] == 0x2b000a) && (param_3[2] == 0x80804)) {
        local_3c = param_2;
        if (iVar1 <= param_2) {
          local_3c = iVar1;
        }
...
LAB_001003ee:
          ...
          *puVar2 = *(undefined8 *)(param_3 + 4);
          ...
          do {
            ...
            lVar3 = _pcre2_memctl_malloc_32(uVar5,param_4);
            if (lVar3 == 0) {
...
int pcre2_serialize_get_number_of_codes_32(int *param_1)

{
  ...
  if (*param_1 == 0x50523253) {
    if ((param_1[1] == 0x2b000a) && (param_1[2] == 0x80804)) {
      return param_1[3];
    }
    return -0x20;
  }
...
void pcre2_serialize_free_32(long param_1)

...

{
  ...
  *(undefined8 *)((long)param_1 + 0x54) = 0;
  ...
  for (uVar1 = (ulong)(((int)param_1 -
                       (int)(undefined8 *)((ulong)(param_1 + 1) & 0xfffffffffffffff8)) + 0x5cU >> 3)
...
undefined8 mbedtls_sha1_starts(undefined8 *param_1)
...

{
  ...
  uVar13 = ((uVar1 ^ uVar2) & uVar32 ^ uVar2) +
           *(int *)(param_1 + 0x18) + 0x5a827999 + (uVar31 << 5 | uVar31 >> 0x1b) + uVar15;
  uVar23 = uVar31 >> 2 | uVar31 << 0x1e;
  uVar27 = uVar2 + 0x5a827999 + ((uVar1 ^ uVar18) & uVar31 ^ uVar1) + uVar3 +
           (uVar13 * 0x20 | uVar13 >> 0x1b);
  uVar14 = uVar13 >> 2 | uVar13 * 0x40000000;
  uVar13 = uVar11 + 0x5a827999 + uVar1 + ((uVar18 ^ uVar23) & uVar13 ^ uVar18) +
           (uVar27 * 0x20 | uVar27 >> 0x1b);
  uVar28 = uVar27 >> 2 | uVar27 * 0x40000000;
  uVar27 = uVar8 + 0x5a827999 + uVar18 + ((uVar23 ^ uVar14) & uVar27 ^ uVar23) +
           (uVar13 * 0x20 | uVar13 >> 0x1b);
  uVar18 = uVar13 >> 2 | uVar13 * 0x40000000;
  uVar13 = uVar9 + 0x5a827999 + uVar23 + ((uVar14 ^ uVar28) & uVar13 ^ uVar14) +
           (uVar27 * 0x20 | uVar27 >> 0x1b);
  uVar19 = uVar27 >> 2 | uVar27 * 0x40000000;
  uVar14 = uVar4 + 0x5a827999 + uVar14 + ((uVar28 ^ uVar18) & uVar27 ^ uVar28) +
           (uVar13 * 0x20 | uVar13 >> 0x1b);
  uVar23 = uVar13 >> 2 | uVar13 * 0x40000000;
  uVar13 = uVar5 + 0x5a827999 + uVar28 + ((uVar18 ^ uVar19) & uVar13 ^ uVar18) +
           (uVar14 * 0x20 | uVar14 >> 0x1b);
  uVar28 = uVar14 >> 2 | uVar14 * 0x40000000;
  uVar14 = uVar6 + 0x5a827999 + uVar18 + ((uVar19 ^ uVar23) & uVar14 ^ uVar19) +
           (uVar13 * 0x20 | uVar13 >> 0x1b);
  uVar18 = uVar7 + 0x5a827999 + uVar19 + ((uVar23 ^ uVar28) & uVar13 ^ uVar23) +
           (uVar14 * 0x20 | uVar14 >> 0x1b);
  uVar13 = uVar13 >> 2 | uVar13 * 0x40000000;
  uVar27 = uVar14 >> 2 | uVar14 * 0x40000000;
  uVar23 = uVar16 + 0x5a827999 + uVar23 + ((uVar28 ^ uVar13) & uVar14 ^ uVar28) +
           (uVar18 * 0x20 | uVar18 >> 0x1b);
  uVar14 = uVar18 >> 2 | uVar18 * 0x40000000;
  uVar18 = uVar21 + 0x5a827999 + uVar28 + ((uVar13 ^ uVar27) & uVar18 ^ uVar13) +
           (uVar23 * 0x20 | uVar23 >> 0x1b);
  uVar19 = uVar23 >> 2 | uVar23 * 0x40000000;
  uVar28 = uVar10 + 0x5a827999 + uVar13 + ((uVar27 ^ uVar14) & uVar23 ^ uVar27) +
           (uVar18 * 0x20 | uVar18 >> 0x1b);
  uVar23 = uVar18 >> 2 | uVar18 * 0x40000000;
  uVar13 = uVar26 + 0x5a827999 + uVar27 + ((uVar14 ^ uVar19) & uVar18 ^ uVar14) +
           (uVar28 * 0x20 | uVar28 >> 0x1b);
  uVar24 = uVar28 >> 2 | uVar28 * 0x40000000;
  uVar14 = uVar17 + 0x5a827999 + uVar14 + ((uVar19 ^ uVar23) & uVar28 ^ uVar19) +
           (uVar13 * 0x20 | uVar13 >> 0x1b);
  uVar18 = uVar13 >> 2 | uVar13 * 0x40000000;
  uVar13 = uVar22 + 0x5a827999 + uVar19 + ((uVar23 ^ uVar24) & uVar13 ^ uVar23) +
           (uVar14 * 0x20 | uVar14 >> 0x1b);
  uVar27 = uVar14 >> 2 | uVar14 * 0x40000000;
  uVar23 = uVar12 + 0x5a827999 + uVar23 + ((uVar24 ^ uVar18) & uVar14 ^ uVar24) +
           (uVar13 * 0x20 | uVar13 >> 0x1b);
  uVar14 = uVar15 ^ uVar11 ^ uVar7 ^ uVar17;
  uVar19 = uVar14 << 1 | (uint)((int)uVar14 < 0);
  uVar14 = uVar13 >> 2 | uVar13 * 0x40000000;
  uVar15 = uVar3 ^ uVar8 ^ uVar16 ^ uVar22;
  uVar3 = uVar24 + 0x5a827999 + uVar19 + ((uVar18 ^ uVar27) & uVar13 ^ uVar18) +
          (uVar23 * 0x20 | uVar23 >> 0x1b);
  uVar25 = uVar15 << 1 | (uint)((int)uVar15 < 0);
  uVar24 = uVar23 >> 2 | uVar23 * 0x40000000;
  uVar23 = uVar18 + 0x5a827999 + uVar25 + ((uVar27 ^ uVar14) & uVar23 ^ uVar27) +
           (uVar3 * 0x20 | uVar3 >> 0x1b);
  uVar13 = uVar11 ^ uVar9 ^ uVar21 ^ uVar12;
  uVar15 = uVar13 << 1 | (uint)((int)uVar13 < 0);
  uVar28 = uVar3 >> 2 | uVar3 * 0x40000000;
  uVar3 = uVar27 + 0x5a827999 + uVar15 + ((uVar14 ^ uVar24) & uVar3 ^ uVar14) +
          (uVar23 * 0x20 | uVar23 >> 0x1b);
  uVar13 = uVar8 ^ uVar4 ^ uVar10 ^ uVar19;
  uVar18 = uVar13 << 1 | (uint)((int)uVar13 < 0);
  uVar11 = uVar23 >> 2 | uVar23 * 0x40000000;
  uVar8 = uVar14 + 0x5a827999 + uVar18 + ((uVar24 ^ uVar28) & uVar23 ^ uVar24) +
          (uVar3 * 0x20 | uVar3 >> 0x1b);
  ...
  uVar14 = uVar3 + 0x8f1bbcdc + uVar22 + (uVar6 & uVar4 | (uVar6 | uVar4) & uVar11) +
           (uVar5 * 0x20 | uVar5 >> 0x1b);
  uVar3 = uVar24 ^ uVar13 ^ uVar19 ^ uVar17;
  uVar24 = uVar3 << 1 | (uint)((int)uVar3 < 0);
  uVar6 = uVar5 >> 2 | uVar5 * 0x40000000;
  uVar8 = ((uVar5 | uVar12) & uVar4 | uVar5 & uVar12) +
          uVar11 + 0x8f1bbcdc + uVar24 + (uVar14 * 0x20 | uVar14 >> 0x1b);
  uVar5 = uVar16 ^ uVar23 ^ uVar28 ^ uVar26;
  uVar10 = uVar5 << 1 | (uint)((int)uVar5 < 0);
  uVar5 = uVar14 >> 2 | uVar14 * 0x40000000;
  uVar14 = uVar4 + 0x8f1bbcdc + uVar10 + (uVar14 & uVar6 | (uVar14 | uVar6) & uVar12) +
           (uVar8 * 0x20 | uVar8 >> 0x1b);
  uVar13 = uVar13 ^ uVar9 ^ uVar18 ^ uVar22;
  uVar3 = uVar13 << 1 | (uint)((int)uVar13 < 0);
  uVar15 = uVar8 >> 2 | uVar8 * 0x40000000;
  uVar11 = ((uVar8 | uVar5) & uVar6 | uVar8 & uVar5) +
           uVar12 + 0x8f1bbcdc + uVar3 + (uVar14 * 0x20 | uVar14 >> 0x1b);
  uVar13 = uVar23 ^ uVar20 ^ uVar25 ^ uVar24;
  uVar4 = uVar13 << 1 | (uint)((int)uVar13 < 0);
  uVar12 = uVar14 >> 2 | uVar14 * 0x40000000;
  uVar14 = (uVar14 & uVar15 | (uVar14 | uVar15) & uVar5) + uVar6 + 0x8f1bbcdc + uVar4 +
           (uVar11 * 0x20 | uVar11 >> 0x1b);
  uVar13 = uVar9 ^ uVar7 ^ uVar21 ^ uVar10;
  uVar8 = uVar13 << 1 | (uint)((int)uVar13 < 0);
  uVar9 = uVar11 >> 2 | uVar11 * 0x40000000;
  uVar5 = ((uVar11 | uVar12) & uVar15 | uVar11 & uVar12) +
          uVar5 + 0x8f1bbcdc + uVar8 + (uVar14 * 0x20 | uVar14 >> 0x1b);
  uVar13 = uVar20 ^ uVar27 ^ uVar17 ^ uVar3;
  uVar13 = uVar13 << 1 | (uint)((int)uVar13 < 0);
  uVar6 = uVar14 >> 2 | uVar14 * 0x40000000;
  uVar14 = (uVar14 & uVar9 | (uVar14 | uVar9) & uVar12) + uVar15 + 0x8f1bbcdc + uVar13 +
           (uVar5 * 0x20 | uVar5 >> 0x1b);
  ...
  uVar5 = uVar5 + 0xca62c1d6 + local_94 + (uVar19 ^ uVar23 ^ uVar11) +
  ...
  uVar4 = uVar3 >> 2 | uVar3 * 0x40000000;
  uVar13 = uVar7 + 0xca62c1d6 + local_68 + (uVar6 ^ uVar8 ^ uVar3) +
           (uVar18 * 0x20 | uVar18 >> 0x1b);
  ...
  uVar18 = (uVar13 * 0x20 | uVar13 >> 0x1b) +
           uVar6 + 0xca62c1d6 + local_64 + (uVar8 ^ uVar4 ^ uVar18);
  ...
  uVar13 = (uVar18 * 0x20 | uVar18 >> 0x1b) +
           uVar8 + 0xca62c1d6 + local_60 + (uVar4 ^ uVar5 ^ uVar13);
  ...
  local_50 = (uVar5 ^ local_44 ^ uVar18) + uVar4 + 0xca62c1d6 + local_5c +
             (uVar13 * 0x20 | uVar13 >> 0x1b);
  *(uint *)(param_1 + 0x10) = local_4c + uVar1;
  local_54 = uVar5 + 0xca62c1d6 + local_58 + (local_44 ^ local_48 ^ uVar13) +
             (local_50 * 0x20 | local_50 >> 0x1b);
...
LAB_0010152e:
      uVar1 = mbedtls_internal_sha1_process(param_1,param_2);
      if ((int)uVar1 != 0) {
        return uVar1;
      }
      param_2 = param_2 + 8;
...
int mbedtls_sha1(undefined8 param_1,undefined8 param_2,undefined8 param_3)
...
int mbedtls_sha1_self_test(int param_1)
...
LAB_00101925:
    iVar1 = mbedtls_sha1_finish(local_4c8,&local_468);
    if (iVar1 != 0) goto LAB_00101954;
...
LAB_00101960:
  mbedtls_platform_zeroize(local_4c8,0x5c);
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
  }

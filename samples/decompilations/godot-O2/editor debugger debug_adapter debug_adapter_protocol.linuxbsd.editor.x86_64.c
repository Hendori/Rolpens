...
::_lookup_pos(HashMap<ObjectID,int,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,int>>>
...
/* DebugAdapterProtocol::on_debug_output(String const&, int) */

void __thiscall
DebugAdapterProtocol::on_debug_output(DebugAdapterProtocol *this,String *param_1,int param_2)
...
void __thiscall DebugAdapterProtocol::~DebugAdapterProtocol(DebugAdapterProtocol *this)
  ...
  if (pvVar10 != (void *)0x0) {
    if (*(int *)(this + 0x2e4) != 0) {
      if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x2e0) * 4) != 0) {
        memset(*(void **)(this + 0x2d8),0,
               (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x2e0) * 4) * 4);
          ...
          if (*(int *)(*(long *)(this + 0x2a0) + lVar8) != 0) {
            ...
            *(int *)(*(long *)(this + 0x2a0) + lVar8) = 0;
            ...
            if (*(long *)((long)pvVar10 + 0x20) != 0) {
              LOCK();
              plVar9 = (long *)(*(long *)((long)pvVar10 + 0x20) + -0x10);
              *plVar9 = *plVar9 + -1;
              UNLOCK();
              if (*plVar9 == 0) {
                lVar7 = *(long *)((long)pvVar10 + 0x20);
            ...
            if (*(long *)((long)pvVar10 + 0x10) != 0) {
              LOCK();
              plVar9 = (long *)(*(long *)((long)pvVar10 + 0x10) + -0x10);
              *plVar9 = *plVar9 + -1;
              UNLOCK();
              if (*plVar9 == 0) {
                lVar7 = *(long *)((long)pvVar10 + 0x10);
...
LAB_0010055b:
  pvVar10 = *(void **)(this + 0x268);
  if (pvVar10 != (void *)0x0) {
    if (*(int *)(this + 0x28c) != 0) {
      if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x288) * 4) != 0) {
        memset(*(void **)(this + 0x280),0,
               (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x288) * 4) * 4);
      }
...
/* DAPeer::format_output(Dictionary const&) const */

Dictionary * DAPeer::format_output(Dictionary *param_1)
...
int __thiscall DAPeer::send_data(DAPeer *this)
  ...
  do {
    if (local_88 == 0) {
      if (-1 < iVar9) {
        ...
        if ((plVar8 == (long *)0x0) ||
           (this_00 = (Dictionary *)*plVar8, this_00 == (Dictionary *)0x0)) goto LAB_001011e0;
        goto LAB_00101174;
      }
...
LAB_00101174:
    if (plVar8 == *(long **)(this_00 + 0x18)) {
      ...
      *(int *)(plVar8 + 2) = (int)plVar8[2] + -1;
      ...
      _err_print_error("erase","./core/templates/list.h",0xe7,
                       "Condition \"p_I->data != this\" is true. Returning: false",0,0,pDVar11);
    }
...
/* DebugAdapterProtocol::on_client_connected() */

undefined8 __thiscall DebugAdapterProtocol::on_client_connected(DebugAdapterProtocol *this)

{
  ...
  if ((*(long *)(this + 0x180) != 0) && (7 < *(int *)(*(long *)(this + 0x180) + 0x10))) {
    _err_print_error("on_client_connected",
                     "editor/debugger/debug_adapter/debug_adapter_protocol.cpp",0x95,
                     "Condition \"clients.size() >= 8\" is true. Returning: FAILED",
                     "Max client limits reached",0,0);
    uVar9 = 1;
    goto LAB_00101683;
  }
  ...
  *(undefined4 *)(this_00 + 0x4001b0) = 0;
  ...
  if (local_58 != pOVar1) {
    *(Object **)(this_00 + 0x180) = local_58;
    if ((local_58 != (Object *)0x0) && (cVar5 = RefCounted::reference(), cVar5 == '\0')) {
      *(undefined8 *)(this_00 + 0x180) = 0;
    }
  ...
  *(int *)(plVar2 + 2) = (int)plVar2[2] + 1;
  pbVar7 = (bool *)EditorDebuggerNode::get_default_debugger();
  local_48 = (char *)((ulong)local_48 & 0xffffffffffffff00);
  ScriptEditorDebugger::set_move_to_foreground(pbVar7);
  local_50 = 0;
  uVar9 = *(undefined8 *)(EditorNode::singleton + 0x5d0);
  local_40 = 0x16;
  local_48 = "[DAP] Connection Taken";
  String::parse_latin1((StrRange *)&local_50);
  EditorLog::add_message(uVar9,(StrRange *)&local_50,4);
  lVar3 = local_50;
  if (local_50 == 0) {
LAB_0010165f:
...
/* DebugAdapterProtocol::reset_current_info() */

void __thiscall DebugAdapterProtocol::reset_current_info(DebugAdapterProtocol *this)
...
/* DebugAdapterProtocol::reset_stack_info() */

void __thiscall DebugAdapterProtocol::reset_stack_info(DebugAdapterProtocol *this)
...
/* DebugAdapterProtocol::reset_ids() */

void __thiscall DebugAdapterProtocol::reset_ids(DebugAdapterProtocol *this)
...
/* DebugAdapterProtocol::on_client_disconnected(Ref<DAPeer> const&) */

void __thiscall
DebugAdapterProtocol::on_client_disconnected(DebugAdapterProtocol *this,Ref *param_1)
    ...
    for (plVar2 = (long *)*plVar1; plVar2 != (long *)0x0; plVar2 = (long *)plVar2[1]) {
      ...
      if (*(long *)param_1 == lVar3) {
        if (plVar1 == (long *)plVar2[3]) {
          ...
          if ((lVar3 != 0) && (cVar7 = RefCounted::unreference(), cVar7 != '\0')) {
...
/* DebugAdapterProtocol::search_object_id(int) */

undefined8 __thiscall DebugAdapterProtocol::search_object_id(DebugAdapterProtocol *this,int param_1)
...
void __thiscall DebugAdapterProtocol::notify_initialized(DebugAdapterProtocol *this)
...
void __thiscall DebugAdapterProtocol::notify_process(DebugAdapterProtocol *this)
...
/* DebugAdapterProtocol::notify_terminated() */

void __thiscall DebugAdapterProtocol::notify_terminated(DebugAdapterProtocol *this)

{
  ...
  if ((*(long **)(this + 0x180) != (long *)0x0) &&
     (plVar6 = (long *)**(long **)(this + 0x180), plVar6 != (long *)0x0)) {
    do {
      cVar4 = String::operator==((String *)(this + 0x1b0),"launch");
      if ((cVar4 == '\0') &&
         (cVar4 = String::operator==((String *)(this + 0x1b0),"restart"), cVar4 == '\0')) {
        lVar2 = *plVar6;
...
/* DebugAdapterProtocol::notify_exited(int const&) */

void DebugAdapterProtocol::notify_exited(int *param_1)

{
  ...
  if ((*(long **)(param_1 + 0x60) != (long *)0x0) &&
     (plVar6 = (long *)**(long **)(param_1 + 0x60), plVar6 != (long *)0x0)) {
    do {
      cVar4 = String::operator==((String *)(param_1 + 0x6c),"launch");
      if ((cVar4 == '\0') &&
         (cVar4 = String::operator==((String *)(param_1 + 0x6c),"restart"), cVar4 == '\0')) {
        lVar2 = *plVar6;
        lVar3 = *(long *)(lVar2 + 0x400198);
joined_r0x0010254c:
        if (lVar3 == 0) {
...
/* DebugAdapterProtocol::on_debug_stopped() */

void __thiscall DebugAdapterProtocol::on_debug_stopped(DebugAdapterProtocol *this)
...
void __thiscall DebugAdapterProtocol::notify_stopped_paused(DebugAdapterProtocol *this)
...
/* DebugAdapterProtocol::notify_stopped_exception(String const&) */

void DebugAdapterProtocol::notify_stopped_exception(String *param_1)
...
LAB_0010293c:
  Dictionary::~Dictionary((Dictionary *)aSStack_38);
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
                    /* WARNING: Subroutine does not return */
...
/* DebugAdapterProtocol::notify_stopped_breakpoint(int const&) */

void DebugAdapterProtocol::notify_stopped_breakpoint(int *param_1)
...
/* DebugAdapterProtocol::notify_stopped_step() */

void __thiscall DebugAdapterProtocol::notify_stopped_step(DebugAdapterProtocol *this)
...
void __thiscall DebugAdapterProtocol::notify_continued(DebugAdapterProtocol *this)

{
  ...
  if ((*(long **)(this + 0x180) != (long *)0x0) &&
     (plVar5 = (long *)**(long **)(this + 0x180), plVar5 != (long *)0x0)) {
    do {
...
void __thiscall DebugAdapterProtocol::on_debug_paused(DebugAdapterProtocol *this)
...
/* DebugAdapterProtocol::on_debug_breaked(bool const&, bool const&, String const&, bool const&) */

void __thiscall
DebugAdapterProtocol::on_debug_breaked
          (DebugAdapterProtocol *this,bool *param_1,bool *param_2,String *param_3,bool *param_4)
...
/* DebugAdapterProtocol::notify_output(String const&, RemoteDebugger::MessageType) */

void __thiscall
DebugAdapterProtocol::notify_output
          (DebugAdapterProtocol *this,undefined8 param_1,undefined4 param_3)
...
/* DebugAdapterProtocol::notify_custom_data(String const&, Array const&) */

void DebugAdapterProtocol::notify_custom_data(String *param_1,Array *param_2)

{
  ...
  if (*(undefined8 **)(param_1 + 0x180) != (undefined8 *)0x0) {
    for (plVar7 = (long *)**(undefined8 **)(param_1 + 0x180); plVar7 != (long *)0x0;
...
LAB_00103560:
  Dictionary::~Dictionary((Dictionary *)local_38);
  if (local_30 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
  }
...
/* DebugAdapterProtocol::notify_breakpoint(DAP::Breakpoint const&, bool const&) */

void DebugAdapterProtocol::notify_breakpoint(Breakpoint *param_1,bool *param_2)

{
  ...
  if ((*(long **)(param_1 + 0x180) != (long *)0x0) &&
     (plVar5 = (long *)**(long **)(param_1 + 0x180), plVar5 != (long *)0x0)) {
    do {
...
/* DebugAdapterProtocol::update_breakpoints(String const&, Array const&) */

String * DebugAdapterProtocol::update_breakpoints(String *param_1,Array *param_2)
  ...
  do {
    ...
    if (iVar11 <= local_104) {
      if ((*(undefined8 **)(param_2 + 0x1d0) != (undefined8 *)0x0) &&
         (puVar15 = (undefined4 *)**(undefined8 **)(param_2 + 0x1d0), puVar15 != (undefined4 *)0x0))
      {
        do {
          local_a8 = *puVar15;
...
LAB_00103e5e:
    ...
    if ((*(long **)(param_2 + 0x1d0) == (long *)0x0) ||
       (lVar14 = **(long **)(param_2 + 0x1d0), lVar14 == 0)) {
LAB_00103dd0:
      _err_print_error("update_breakpoints",
                       "editor/debugger/debug_adapter/debug_adapter_protocol.cpp",0x3f1,
                       "Condition \"!breakpoint_list.find(breakpoint)\" is true. Returning: Array()"
                       ,0,0);
    ...
    while ((cVar10 = String::operator==((String *)(lVar14 + 0x18),(String *)(local_98 + 8)),
           cVar10 == '\0' || (*(int *)(lVar14 + 0x20) != local_88[0]))) {
...
/* DebugAdapterProtocol::start(int, IPAddress const&) */

void DebugAdapterProtocol::start(int param_1,IPAddress *param_2)
...
void __thiscall DebugAdapterProtocol::stop(DebugAdapterProtocol *this)
...
/* DebugAdapterProtocol::request_remote_evaluate(String const&, int) */

undefined8 DebugAdapterProtocol::request_remote_evaluate(String *param_1,int param_2)
      ...
      do {
        if ((uint)uVar15 == uVar12) {
          cVar11 = String::operator==((String *)
                                      (*(long *)(param_1 + 0x2c0) +
                                      (ulong)*(uint *)(*(long *)(param_1 + 0x2c8) + lVar17 * 4) * 8)
                                      ,(String *)CONCAT44(in_register_00000034,param_2));
          if (cVar11 != '\0') {
            uVar14 = 0;
            goto LAB_001045e4;
          }
...
/* DebugAdapterProtocol::request_remote_object(ObjectID const&) */

undefined8 __thiscall
DebugAdapterProtocol::request_remote_object(DebugAdapterProtocol *this,ObjectID *param_1)
    ...
    if (uVar14 != 0) {
      ...
      do {
        if (((uint)uVar17 == uVar14) &&
           (*(long *)param_1 ==
            *(long *)(*(long *)(this + 0x268) +
                     (ulong)*(uint *)(*(long *)(this + 0x270) + lVar13 * 4) * 8))) {
          uVar11 = 0;
          goto LAB_001048b1;
        }
        uVar16 = uVar16 + 1;
        ...
        iVar12 = SUB164(auVar3 * auVar7,8);
              ...
              auVar5._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                               (ulong)*(uint *)(this + 0x288) * 4) + iVar12) -
    ...
    if (this_00 != (TCPServer *)pOVar4) {
      *(TCPServer **)(this + 0x188) = this_00;
      ...
      if (((pOVar4 != (Object *)0x0) && (cVar3 = RefCounted::unreference(), cVar3 != '\0')) &&
         (cVar3 = predelete_handler(pOVar4), cVar3 != '\0')) goto LAB_0010515b;
    }
  }
  cVar3 = RefCounted::unreference();
...
LAB_00104a5b:
  ...
  *(Object **)(this + 0x178) = pOVar4;
  ...
  create_custom_callable_function_pointer<DebugAdapterProtocol>
            (local_58,(char *)this,(_func_void *)"&DebugAdapterProtocol::on_debug_paused");
  ...
  *(char **)(pCVar5 + 0x20) = "DebugAdapterProtocol::on_debug_breakpoint_toggled";
  ...
  pcVar1 = *(code **)(*plVar6 + 0x108);
  create_custom_callable_function_pointer<DebugAdapterProtocol>
            (local_58,(char *)this,(_func_void *)"&DebugAdapterProtocol::on_debug_stopped");
  ...
  *(char **)(pCVar5 + 0x20) = "DebugAdapterProtocol::on_debug_breaked";
  ...
  plVar6 = (long *)EditorDebuggerNode::get_default_debugger();
  pcVar1 = *(code **)(*plVar6 + 0x108);
  create_custom_callable_function_pointer<DebugAdapterProtocol,Array_const&>
            (local_58,(char *)this,
             (_func_void_Array_ptr *)"&DebugAdapterProtocol::on_debug_stack_dump");
  ...
  *(char **)(pCVar5 + 0x20) = "DebugAdapterProtocol::on_debug_stack_frame_vars";
  ...
  create_custom_callable_function_pointer<DebugAdapterProtocol,Array_const&>
            (local_58,(char *)this,
             (_func_void_Array_ptr *)"&DebugAdapterProtocol::on_debug_stack_frame_var");
...
/* DebugAdapterProtocol::process_message(String const&) */

byte __thiscall DebugAdapterProtocol::process_message(DebugAdapterProtocol *this,String *param_1)
  ...
  if (iVar9 == 0) {
    ...
    if (*(ulong *)(this + 0x1a0) < (ulong)(lVar10 - *(long *)(*(long *)(this + 0x1b8) + 0x4001a8)))
    {
      ...
      DebugAdapterParser::prepare_error_response
                (local_2f0,uVar3,local_308,3,(Dictionary *)&local_2e8);
      Dictionary::~Dictionary((Dictionary *)&local_2e8);
      ...
      *(int *)(plVar1 + 2) = (int)plVar1[2] + 1;
      ...
      operator+((char *)&local_300,(String *)&_LC82);
      puVar4 = local_2e8;
      ...
      local_2e8 = &_LC29;
      String::parse_latin1((StrRange *)(this + 0x1b0));
      if ((*(long *)(this + 0x1b8) != 0) && (cVar8 = RefCounted::unreference(), cVar8 != '\0')) {
    ...
    _err_print_error("process_message","editor/debugger/debug_adapter/debug_adapter_protocol.cpp",
                     0x362,"Condition \"json.parse(p_text) != OK\" is true. Returning: true",
...
undefined8 __thiscall DAPeer::handle_data(DAPeer *this)
  ...
  if (this[0x40018c] == (DAPeer)0x0) {
    ...
    if (iVar2 != 0) {
      ...
      while (iVar2 < 0x400000) {
        while( true ) {
          iVar2 = (**(code **)(**(long **)(this + 0x180) + 0x168))
                            (*(long **)(this + 0x180),this + (iVar2 + 0x188),1,&local_34);
        ...
        if (((((this + 0x188)[iVar2] == (DAPeer)0xa) && (this[(long)iVar2 + 0x187] == (DAPeer)0xd))
            && (this[(long)iVar2 + 0x186] == (DAPeer)0xa)) &&
           (this[(long)iVar2 + 0x185] == (DAPeer)0xd)) {
      ...
      *(undefined4 *)(this + 0x400188) = 0;
      _err_print_error("handle_data","editor/debugger/debug_adapter/debug_adapter_protocol.cpp",0x37
...
LAB_00105b18:
    ...
    if (iVar2 < iVar5) {
      do {
        ...
        iVar2 = (**(code **)(**(long **)(this + 0x180) + 0x168))
                          (*(long **)(this + 0x180),this + lVar6,iVar5,&local_34);
        if (iVar2 != 0) goto LAB_00105c60;
        iVar5 = *(int *)(this + 0x400190);
    ...
    cVar1 = DebugAdapterProtocol::process_message
                      (DebugAdapterProtocol::singleton,(String *)&local_28);
    if (cVar1 != '\0') {
      *(undefined4 *)(this + 0x400188) = 0;
      this[0x40018c] = (DAPeer)0x0;
...
void __thiscall DebugAdapterProtocol::poll(DebugAdapterProtocol *this)

{
  ...
  if ((plVar11 != (long *)0x0) && (plVar11 = (long *)*plVar11, plVar11 != (long *)0x0)) {
    ...
    do {
      this_00 = (DAPeer *)*plVar11;
      if (this_00 == (DAPeer *)0x0) {
                    /* WARNING: Does not return */
      ...
      StreamPeerTCP::poll();
      iVar7 = StreamPeerTCP::get_status();
      if ((iVar7 == 0) || (iVar7 == 3)) {
LAB_00105f19:
...
LAB_00105f4d:
        ...
        *puVar8 = this_00;
        ...
        lVar9 = *(long *)*pauVar10;
        *(undefined8 **)(*pauVar10 + 8) = puVar8;
        if (lVar9 == 0) {
          *(undefined8 **)*pauVar10 = puVar8;
        }
        *(int *)pauVar10[1] = *(int *)pauVar10[1] + 1;
        ...
        pOVar2 = *(Object **)(this + 0x1b8);
        if (pOVar2 != (Object *)this_00) {
          *(DAPeer **)(this + 0x1b8) = this_00;
          cVar6 = RefCounted::reference();
          if (cVar6 == '\0') {
            *(undefined8 *)(this + 0x1b8) = 0;
          }
        ...
        iVar7 = DAPeer::handle_data(this_00);
        if ((iVar7 == 0) || (iVar7 == 0x2c)) {
          iVar7 = DAPeer::send_data(this_00);
          if ((iVar7 != 0) && (iVar7 != 0x2c)) goto LAB_00105f19;
        }
        else {
          if (pauVar10 == (undefined1 (*) [16])0x0) {
            pauVar10 = (undefined1 (*) [16])operator_new(0x18,DefaultAllocator::alloc);
          ...
          *(int *)pauVar10[1] = *(int *)pauVar10[1] + 1;
          iVar7 = DAPeer::send_data(this_00);
          if ((iVar7 != 0x2c) && (iVar7 != 0)) goto LAB_00105f4d;
        }
        cVar6 = RefCounted::unreference();
      }
...
joined_r0x00105ee3:
          ...
          *(long *)*pauVar10 = lVar9;
          ...
          if ((*plVar11 == 0) || (cVar6 = RefCounted::unreference(), cVar6 == '\0')) {
LAB_00105ed5:
...
/* DebugAdapterProtocol::on_debug_stack_dump(Array const&) */

void __thiscall DebugAdapterProtocol::on_debug_stack_dump(DebugAdapterProtocol *this,Array *param_1)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((this[0x191] != (DebugAdapterProtocol)0x0) && (cVar7 = Array::is_empty(), cVar7 == '\0')) {
...
LAB_001062b6:
  ...
  do {
    ...
    *pauVar11 = (undefined1  [16])0x0;
    ...
    ::insert((StackFrame *)&local_90,(List *)(this + 0x1d8),SUB81(&local_88,0));
    do {
      while( true ) {
...
LAB_001066cd:
    if (CONCAT44(uStack_64,iStack_68) != 0) {
      LOCK();
...
/* DebugAdapterProtocol::on_debug_stack_frame_vars(int const&) */

void __thiscall
DebugAdapterProtocol::on_debug_stack_frame_vars(DebugAdapterProtocol *this,int *param_1)

{
  ...
  *(int *)(this + 0x194) = *param_1;
  ...
  if ((lVar42 != 0) && (*(int *)(this + 0x204) != 0)) {
    ...
    uVar38 = (local_78 * 0x16a88000 | (uint)(local_78 * -0x3361d2af) >> 0x11) * 0x1b873593 ^
             0x7f07c65;
    ...
    if (uVar38 != 0) {
      ...
      uVar53 = uVar54;
LAB_00106cc2:
      if (((uint)uVar50 != uVar49) || (local_78 != *(int *)(*(long *)(lVar42 + lVar46 * 8) + 0x10)))
      goto LAB_00106c78;
      uVar52 = (ulong)uVar38;
      uVar38 = 0;
      while (((uint)uVar50 != (uint)uVar52 ||
             (local_78 != *(int *)(*(long *)(lVar42 + lVar45 * 8) + 0x10)))) {
        uVar38 = uVar38 + 1;
        auVar11._8_8_ = 0;
        ...
        if ((uVar49 == 0) ||
           (auVar12._8_8_ = 0, auVar12._0_8_ = uVar52 * lVar47, auVar26._8_8_ = 0,
           auVar26._0_8_ = uVar51, auVar13._8_8_ = 0,
           auVar13._0_8_ = (ulong)((uVar39 + uVar54) - SUB164(auVar12 * auVar26,8)) * lVar47,
           auVar27._8_8_ = 0, auVar27._0_8_ = uVar51, SUB164(auVar13 * auVar27,8) < uVar38)) {
                    /* WARNING: Does not return */
      ...
      if ((puVar5 == (undefined8 *)0x0) ||
         (puVar55 = (undefined4 *)*puVar5, puVar55 == (undefined4 *)0x0)) goto LAB_0010703b;
...
LAB_00106e10:
        ...
        if (uVar39 != 0) {
          ...
          do {
            ...
            iVar44 = SUB164(auVar15 * auVar29,8);
                  ...
                  (auVar16._8_8_ = 0, auVar16._0_8_ = uVar49 * uVar51, auVar30._8_8_ = 0,
                  auVar30._0_8_ = uVar52, auVar17._8_8_ = 0,
                  auVar17._0_8_ = ((uVar38 + iVar44) - SUB164(auVar16 * auVar30,8)) * uVar51,
                  auVar31._8_8_ = 0, auVar31._0_8_ = uVar52, uVar53 <= SUB164(auVar17 * auVar31,8)))
          ;
        }
      }
      ...
      ::insert(local_80,(Array *)(this + 0x208),SUB81(&local_8c,0));
      Array::~Array(local_88);
      goto LAB_00106fb8;
    }
  }
LAB_001071a0:
  _err_print_error("on_debug_stack_frame_vars",
                   "editor/debugger/debug_adapter/debug_adapter_protocol.cpp",0x46c,
                   "Condition \"!stackframe_list.has(frame)\" is true.",0,0);
...
LAB_00106c78:
  ...
  if ((uVar49 == 0) ||
     (auVar9._8_8_ = 0, auVar9._0_8_ = (ulong)uVar49 * lVar47, auVar23._8_8_ = 0,
     auVar23._0_8_ = uVar51, auVar10._8_8_ = 0,
     auVar10._0_8_ = (ulong)((uVar39 + uVar53) - SUB164(auVar9 * auVar23,8)) * lVar47,
     auVar24._8_8_ = 0, auVar24._0_8_ = uVar51, SUB164(auVar10 * auVar24,8) < uVar48))
  goto LAB_001071a0;
  goto LAB_00106cc2;
LAB_00106f97:
  if ((uVar39 == uVar54) && (local_8c == *(uint *)(*(long *)(lVar42 + lVar47 * 8) + 0x10)))
  goto LAB_00106faf;
  uVar49 = uVar49 + 1;
  auVar18._8_8_ = 0;
  ...
  if ((uVar39 == 0) ||
     (auVar19._8_8_ = 0, auVar19._0_8_ = uVar39 * uVar51, auVar33._8_8_ = 0, auVar33._0_8_ = uVar52,
     auVar20._8_8_ = 0, auVar20._0_8_ = ((uVar38 + iVar43) - SUB164(auVar19 * auVar33,8)) * uVar51,
     auVar34._8_8_ = 0, auVar34._0_8_ = uVar52, SUB164(auVar20 * auVar34,8) < uVar49))
  goto LAB_00106faf;
  goto LAB_00106f97;
LAB_00106faf:
  Array::clear();
...
LAB_00107026:
  if (*(int *)pauVar40[1] == 0) {
LAB_00107031:
    Memory::free_static(pauVar40,false);
  }
  else {
    _err_print_error("~List","./core/templates/list.h",0x316,
                     "Condition \"_data->size_cache\" is true.",0,0);
...
/* DebugAdapterProtocol::on_debug_breakpoint_toggled(String const&, int const&, bool const&) */

void __thiscall
DebugAdapterProtocol::on_debug_breakpoint_toggled
          (DebugAdapterProtocol *this,String *param_1,int *param_2,bool *param_3)

{
  ...
  if (*param_3 == false) {
    if ((*(undefined8 **)(this + 0x1d0) != (undefined8 *)0x0) &&
       (piVar6 = (int *)**(undefined8 **)(this + 0x1d0), piVar6 != (int *)0x0)) {
      do {
...
/* DebugAdapterProtocol::parse_variant(Variant const&) */

int DebugAdapterProtocol::parse_variant(Variant *param_1)
...
/* DebugAdapterProtocol::parse_object_variable(Pair<PropertyInfo, Variant> const&) */

Pair * DebugAdapterProtocol::parse_object_variable(Pair *param_1)
...
LAB_00110145:
  Variant::get_type_name((Variant *)&local_a0);
  lVar6 = local_88;
  lVar3 = local_a0;
...
/* DebugAdapterProtocol::parse_object(SceneDebuggerObject&) */

void __thiscall
DebugAdapterProtocol::parse_object(DebugAdapterProtocol *this,SceneDebuggerObject *param_1)

{
  ...
  cVar19 = HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>::erase
                     ((HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>> *)
                      (this + 0x268),(ObjectID *)&local_f8);
  if (cVar19 != '\0') {
    ...
    if ((*(undefined8 **)(param_1 + 0x10) != (undefined8 *)0x0) &&
       (piVar26 = (int *)**(undefined8 **)(param_1 + 0x10), piVar26 != (int *)0x0)) {
      do {
        while( true ) {
            ...
            if (cVar19 == '\0') {
              if (*piVar26 == 0) {
                ...
                if (cVar19 == '\0') {
                  ...
                  HashMap<int,Array,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Array>>>
                  ::insert((int *)local_98,(Array *)(this + 0x208),SUB81(local_a0,0));
...
LAB_001108e0:
    ...
    if (cVar19 == '\0') {
      ...
      *(int *)(this + 0x1c8) = local_80[0] + 1;
      HashMap<int,Array,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Array>>>
      ::insert((int *)&local_c8,(Array *)(this + 0x208),SUB81(local_80,0));
      ...
      if (uVar27 != 0) {
        ...
        do {
          if (((uint)uVar25 == uVar27) &&
             (local_f8 == *(long *)(*(long *)(*(long *)(this + 0x240) + lVar24 * 8) + 0x10))) {
            bVar20 = (bool)HashMap<ObjectID,int,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,int>>>
                           ::operator[]((HashMap<ObjectID,int,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,int>>>
                                         *)(this + 0x238),(ObjectID *)&local_f8);
            HashMap<int,Array,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Array>>>
            ::insert((int *)local_98,(Array *)(this + 0x208),bVar20);
            Array::~Array(local_d0);
            lVar2 = local_a8;
            if (local_a8 != 0) {
              LOCK();
          ...
          iVar23 = SUB164(auVar4 * auVar8,8);
                ...
                (auVar5._8_8_ = 0, auVar5._0_8_ = (ulong)uVar27 * lVar2, auVar9._8_8_ = 0,
                auVar9._0_8_ = uVar29, auVar6._8_8_ = 0,
                auVar6._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                                 (ulong)*(uint *)(this + 0x260) * 4) + iVar23) -
                                      SUB164(auVar5 * auVar9,8)) * lVar2, auVar10._8_8_ = 0,
                auVar10._0_8_ = uVar29, uVar30 <= SUB164(auVar6 * auVar10,8)));
      }
    }
    _err_print_error("parse_object","editor/debugger/debug_adapter/debug_adapter_protocol.cpp",0x31e
                     ,"Condition \"!object_list.has(object_id)\" is true.",0,0);
    Array::~Array(local_d0);
...
/* DebugAdapterProtocol::parse_evaluation(DebuggerMarshalls::ScriptStackVariable&) */

void __thiscall
DebugAdapterProtocol::parse_evaluation(DebugAdapterProtocol *this,ScriptStackVariable *param_1)
...
LAB_00112459:
  cVar6 = HashSet<String,HashMapHasherDefault,HashMapComparatorDefault<String>>::erase
                    ((HashSet<String,HashMapHasherDefault,HashMapComparatorDefault<String>> *)
                     (this + 0x2c0),(String *)&local_68);
  if (cVar6 != '\0') {
    local_48 = 0;
    local_40 = 0;
    local_58 = (undefined1  [16])0x0;
...
LAB_001124b9:
    ...
    HashMap<String,DAP::Variable,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,DAP::Variable>>>
    ::insert((String *)&local_60,(Variable *)(this + 0x290),SUB81(local_58,0));
    lVar2 = local_48;
    if (local_48 != 0) {
      LOCK();
      plVar1 = (long *)(local_48 + -0x10);
...
/* DebugAdapterProtocol::on_debug_data(String const&, Array const&) */

void DebugAdapterProtocol::on_debug_data(String *param_1,Array *param_2)
              ...
              if (cVar1 == '\0') {
                ...
                if (cVar1 == '\0') {
                  ...
                  if (cVar1 != '\0') {
                    ...
                    parse_evaluation((DebugAdapterProtocol *)param_1,
                                     (ScriptStackVariable *)&local_58);
                  ...
                  List<Pair<PropertyInfo,Variant>,DefaultAllocator>::~List
                            ((List<Pair<PropertyInfo,Variant>,DefaultAllocator> *)(local_70 + 8));
...
/* DebugAdapterProtocol::on_debug_stack_frame_var(Array const&) */

void DebugAdapterProtocol::on_debug_stack_frame_var(Array *param_1)

{
  ...
  if (*(int *)(param_1 + 0x204) == 0) {
    _err_print_error("on_debug_stack_frame_var",
                     "editor/debugger/debug_adapter/debug_adapter_protocol.cpp",0x47c,
                     "Condition \"stackframe_list.is_empty()\" is true.",0,0);
LAB_001133a5:
...
LAB_001131dd:
  ...
  if ((lVar31 != 0) && (*(int *)(param_1 + 0x204) != 0)) {
    ...
    uVar24 = (local_d8 * 0x16a88000 | (uint)(local_d8 * -0x3361d2af) >> 0x11) * 0x1b873593 ^
             0x7f07c65;
    ...
    if (uVar24 != 0) {
      uVar38 = 0;
LAB_00112aa9:
      if ((uVar24 != (uint)uVar35) || (local_d8 != *(int *)(*(long *)(lVar31 + lVar33 * 8) + 0x10)))
      goto LAB_00112a60;
      pauVar27 = *(undefined1 (**) [16])(*(long *)(lVar31 + (ulong)uVar26 * 8) + 0x40);
      if ((pauVar27 == (undefined1 (*) [16])0x0) ||
         (pauVar36 = *(undefined1 (**) [16])*pauVar27, pauVar27 = pauVar36,
         pauVar36 == (undefined1 (*) [16])0x0)) goto LAB_001133d0;
      ...
      *pauVar27 = (undefined1  [16])0x0;
      ...
      if ((uint)local_48 < 4) {
        if ((uint)local_48 == 3) {
          _err_print_index_error
                    ("get","./core/templates/list.h",0x21c,3,3,"p_index","size()","",false,true);
          _err_flush_stdout();
                    /* WARNING: Does not return */
        ...
        if (lVar31 == 0) {
          ...
          if (*(int *)(param_1 + 0x234) != 0) {
            ...
            if (uVar26 != 0) {
              uVar40 = 0;
              while ((uVar38 != uVar26 ||
                     (uVar24 != *(uint *)(*(long *)(lVar31 + lVar33 * 8) + 0x10)))) {
                uVar40 = uVar40 + 1;
                auVar9._8_8_ = 0;
                ...
                if ((uVar26 == 0) ||
                   (auVar10._8_8_ = 0, auVar10._0_8_ = uVar26 * uVar35, auVar18._8_8_ = 0,
                   auVar18._0_8_ = uVar39, auVar11._8_8_ = 0,
                   auVar11._0_8_ =
                        ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(param_1 + 0x230) * 4)
                         + uVar32) - SUB164(auVar10 * auVar18,8)) * uVar35, auVar19._8_8_ = 0,
                   auVar19._0_8_ = uVar39, SUB164(auVar11 * auVar19,8) < uVar40)) goto LAB_00112d96;
              }
...
LAB_001130ef:
        Memory::free_static(pauVar27,false);
LAB_001130f9:
        uVar23 = local_c0._8_8_;
        if (local_c0._8_8_ != 0) {
          LOCK();
      ...
      _err_print_index_error
                ("on_debug_stack_frame_var",
                 "editor/debugger/debug_adapter/debug_adapter_protocol.cpp",0x482,
                 (long)(int)(uint)local_48,4,"stack_var.type","4","",false,false);
      goto LAB_001133f5;
    }
  }
LAB_0011365e:
...
LAB_00112a60:
  ...
  if ((uVar24 == 0) ||
     (auVar6._8_8_ = 0, auVar6._0_8_ = (ulong)uVar24 * lVar37, auVar14._8_8_ = 0,
     auVar14._0_8_ = uVar39, auVar7._8_8_ = 0,
     auVar7._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                      (ulong)*(uint *)(param_1 + 0x200) * 4) + uVar26) -
                           SUB164(auVar6 * auVar14,8)) * lVar37, auVar15._8_8_ = 0,
     auVar15._0_8_ = uVar39, SUB164(auVar7 * auVar15,8) < uVar38)) goto LAB_0011365e;
  goto LAB_00112aa9;
LAB_001133d0:
  _err_print_error("on_debug_stack_frame_var",
                   "editor/debugger/debug_adapter/debug_adapter_protocol.cpp",0x481,
                   "Condition \"scope_ids.size() != 3\" is true.",0,0);
LAB_001133f5:
  if (pauVar27 != (undefined1 (*) [16])0x0) {
    do {
      while( true ) {
...
LAB_00113454:
  CowData<char32_t>::_unref((CowData<char32_t> *)(local_c0 + 8));
...
{
  return (uint)CONCAT71(0x11ef,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x11ef,(undefined4 *)param_1 == &get_class_ptr_static()::ptr);
}
...
{
  return (uint)CONCAT71(0x11ef,(undefined4 *)param_1 == &Resource::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x11ef,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x11ef,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x11ef,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}
...
/* DebugAdapterParser::is_class_ptr(void*) const */

uint __thiscall DebugAdapterParser::is_class_ptr(DebugAdapterParser *this,void *param_1)
...
/* DebugAdapterParser::_getv(StringName const&, Variant&) const */

undefined8 DebugAdapterParser::_getv(StringName *param_1,Variant *param_2)
...
/* DebugAdapterParser::_setv(StringName const&, Variant const&) */

undefined8 DebugAdapterParser::_setv(StringName *param_1,Variant *param_2)
...
/* DebugAdapterParser::_validate_propertyv(PropertyInfo&) const */

void DebugAdapterParser::_validate_propertyv(PropertyInfo *param_1)
...
/* DebugAdapterParser::_property_can_revertv(StringName const&) const */

undefined8 DebugAdapterParser::_property_can_revertv(StringName *param_1)
...
/* DebugAdapterParser::_property_get_revertv(StringName const&, Variant&) const */

undefined8 DebugAdapterParser::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* DebugAdapterParser::_notificationv(int, bool) */

void DebugAdapterParser::_notificationv(int param_1,bool param_2)
...
/* DebugAdapterProtocol::is_class_ptr(void*) const */

uint __thiscall DebugAdapterProtocol::is_class_ptr(DebugAdapterProtocol *this,void *param_1)
...
/* DebugAdapterProtocol::_getv(StringName const&, Variant&) const */

undefined8 DebugAdapterProtocol::_getv(StringName *param_1,Variant *param_2)
...
/* DebugAdapterProtocol::_setv(StringName const&, Variant const&) */

undefined8 DebugAdapterProtocol::_setv(StringName *param_1,Variant *param_2)
...
/* DebugAdapterProtocol::_validate_propertyv(PropertyInfo&) const */

void DebugAdapterProtocol::_validate_propertyv(PropertyInfo *param_1)
...
/* DebugAdapterProtocol::_property_can_revertv(StringName const&) const */

undefined8 DebugAdapterProtocol::_property_can_revertv(StringName *param_1)
...
/* DebugAdapterProtocol::_property_get_revertv(StringName const&, Variant&) const */

undefined8 DebugAdapterProtocol::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* DebugAdapterProtocol::_notificationv(int, bool) */

void DebugAdapterProtocol::_notificationv(int param_1,bool param_2)
...
void __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,Array_const&>::
~CallableCustomMethodPointer
          (CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,Array_const&> *this)
...
void __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void,int_const&>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<DebugAdapterProtocol,void,int_const&> *this)
...
void __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void,Array_const&>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<DebugAdapterProtocol,void,Array_const&> *this)
...
/* CallableCustomMethodPointer<DebugAdapterProtocol, void, bool const&, bool const&, String const&,
   bool const&>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void,bool_const&,bool_const&,String_const&,bool_const&>
::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<DebugAdapterProtocol,void,bool_const&,bool_const&,String_const&,bool_const&>
           *this)
...
void __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,int>::
~CallableCustomMethodPointer
          (CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,int> *this)
...
void __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,int_const&,bool_const&>::
~CallableCustomMethodPointer
          (CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,int_const&,bool_const&>
           *this)
...
/* CallableCustomMethodPointer<DebugAdapterProtocol, void>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<DebugAdapterProtocol,void> *this)
...
undefined8 __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,Array_const&>::
get_argument_count(CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,Array_const&>
                   *this,bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void,int_const&>::get_argument_count
          (CallableCustomMethodPointer<DebugAdapterProtocol,void,int_const&> *this,bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void,Array_const&>::get_argument_count
          (CallableCustomMethodPointer<DebugAdapterProtocol,void,Array_const&> *this,bool *param_1)
...
/* CallableCustomMethodPointer<DebugAdapterProtocol, void, bool const&, bool const&, String const&,
   bool const&>::get_argument_count(bool&) const */
...
undefined8 __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,int>::get_argument_count
          (CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,int> *this,
          bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,int_const&,bool_const&>::
get_argument_count(CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,int_const&,bool_const&>
                   *this,bool *param_1)
...
/* CallableCustomMethodPointer<DebugAdapterProtocol, void>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void>::get_argument_count
          (CallableCustomMethodPointer<DebugAdapterProtocol,void> *this,bool *param_1)
...
void __thiscall DebugAdapterParser::~DebugAdapterParser(DebugAdapterParser *this)
...
/* DebugAdapterParser::_get_class_namev() const */

undefined8 * DebugAdapterParser::_get_class_namev(void)
...
LAB_00113bc3:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"DebugAdapterParser");
      goto LAB_00113c2e;
    }
  }
  StringName::assign_static_unique_class_name
...
/* CallableCustomMethodPointer<DebugAdapterProtocol, void, bool const&, bool const&, String const&,
   bool const&>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void,bool_const&,bool_const&,String_const&,bool_const&>
::get_object(CallableCustomMethodPointer<DebugAdapterProtocol,void,bool_const&,bool_const&,String_const&,bool_const&>
             *this)
...
/* CallableCustomMethodPointer<DebugAdapterProtocol, void, Array const&>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void,Array_const&>::get_object
          (CallableCustomMethodPointer<DebugAdapterProtocol,void,Array_const&> *this)
...
/* CallableCustomMethodPointer<DebugAdapterProtocol, void, int const&>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void,int_const&>::get_object
          (CallableCustomMethodPointer<DebugAdapterProtocol,void,int_const&> *this)
...
undefined8 __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,int>::get_object
          (CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,int> *this)
...
undefined8 __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,Array_const&>::get_object
          (CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,Array_const&> *this)
...
/* CallableCustomMethodPointer<DebugAdapterProtocol, void>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void>::get_object
          (CallableCustomMethodPointer<DebugAdapterProtocol,void> *this)
...
undefined8 __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,int_const&,bool_const&>::
get_object(CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,int_const&,bool_const&>
           *this)
...
void __thiscall DAPeer::~DAPeer(DAPeer *this)
...
/* DebugAdapterProtocol::_get_class_namev() const */

undefined8 * DebugAdapterProtocol::_get_class_namev(void)
...
LAB_00114653:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      goto LAB_00114653;
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"DebugAdapterProtocol");
      goto LAB_001146be;
    }
  }
  StringName::assign_static_unique_class_name
...
/* DebugAdapterParser::get_class() const */

void DebugAdapterParser::get_class(void)
...
/* DebugAdapterProtocol::get_class() const */

void DebugAdapterProtocol::get_class(void)
...
/* DebugAdapterProtocol::_initialize_classv() */

void DebugAdapterProtocol::_initialize_classv(void)
...
/* DebugAdapterParser::_initialize_classv() */

void DebugAdapterParser::_initialize_classv(void)
...
/* DebugAdapterParser::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void DebugAdapterParser::_get_property_listv(List *param_1,bool param_2)
...
/* DebugAdapterProtocol::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void DebugAdapterProtocol::_get_property_listv(List *param_1,bool param_2)
...
/* DebugAdapterProtocol::is_class(String const&) const */

undefined8 __thiscall DebugAdapterProtocol::is_class(DebugAdapterProtocol *this,String *param_1)
...
/* DebugAdapterParser::is_class(String const&) const */

undefined8 __thiscall DebugAdapterParser::is_class(DebugAdapterParser *this,String *param_1)
...
/* DAP::Source::compute_checksums() */

void __thiscall DAP::Source::compute_checksums(Source *this)

{
  ...
  if ((*(long *)(this + 0x10) == 0) || (*(uint *)(*(long *)(this + 0x10) + -8) < 2)) {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error("compute_checksums","editor/debugger/debug_adapter/debug_adapter_types.h",
                       0x46,"Condition \"path.is_empty()\" is true.",0,0);
      return;
    }
  }
  else {
...
/* DebugAdapterProtocol::on_client_connected() [clone .cold] */

void DebugAdapterProtocol::on_client_connected(void)
...
/* DebugAdapterProtocol::notify_custom_data(String const&, Array const&) [clone .cold] */
...
/* DebugAdapterProtocol::poll() [clone .cold] */

void DebugAdapterProtocol::poll(void)
...
/* DebugAdapterProtocol::parse_variant(Variant const&) [clone .cold] */

void DebugAdapterProtocol::parse_variant(Variant *param_1)
...
void __thiscall DAP::Variable::~Variable(Variable *this)
...
/* CowData<char32_t>::TEMPNAMEPLACEHOLDERVALUE(CowData<char32_t>&&) */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashMap<int, Array, HashMapHasherDefault, HashMapComparatorDefault<int>,
   DefaultTypedAllocator<HashMapElement<int, Array> > >::insert(int const&, Array const&, bool) */

int * HashMap<int,Array,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Array>>>
      ::insert(int *param_1,Array *param_2,bool param_3)
  ...
  if (local_a8 == (void *)0x0) {
    ...
    *(void **)(param_2 + 8) = local_a8;
    if (uVar31 != 0) {
      ...
      if ((pvVar3 < (void *)((long)local_a8 + uVar38)) &&
...
LAB_001192a1:
    if (iVar36 != 0) {
      ...
      if (uVar30 != 0) {
        do {
          if ((uVar46 == uVar30) &&
             (*(uint *)(*(long *)((long)local_a8 + lVar39 * 8) + 0x10) == uVar32)) {
          ...
          uVar44 = SUB164(auVar6 * auVar18,8);
                ...
                auVar8._0_8_ = ((*(uint *)(hash_table_size_primes +
                                          (ulong)*(uint *)(param_2 + 0x28) * 4) + uVar44) -
...

{
  ...
  if ((*(long *)this != 0) && (*(int *)(this + 0x24) != 0)) {
    ...
    if (uVar30 != 0) {
      ...
      do {
        if (uVar31 == uVar30) {
          uVar30 = String::operator==((String *)
                                      (*(long *)this +
                                      (ulong)*(uint *)(*(long *)(this + 8) + lVar37 * 4) * 8),
                                      param_1);
          if ((char)uVar30 != '\0') {
            lVar44 = *(long *)(this + 8);
            ...
            if ((*puVar41 == 0) ||
               (auVar15._8_8_ = 0, auVar15._0_8_ = (ulong)*puVar41 * lVar37, auVar25._8_8_ = 0,
               auVar25._0_8_ = uVar46, auVar16._8_8_ = 0,
               auVar16._0_8_ = (ulong)((uVar31 + uVar36) - SUB164(auVar15 * auVar25,8)) * lVar37,
               auVar26._8_8_ = 0, auVar26._0_8_ = uVar46, SUB164(auVar16 * auVar26,8) == 0)) {
              uVar42 = (ulong)uVar45;
            }
            else {
              while( true ) {
                ...
                *puVar5 = uVar45;
                ...
                puVar41 = (uint *)(lVar9 + lVar33);
                if ((*puVar41 == 0) ||
                   (auVar17._8_8_ = 0, auVar17._0_8_ = (ulong)*puVar41 * lVar37, auVar27._8_8_ = 0,
                   auVar27._0_8_ = uVar46, auVar18._8_8_ = 0,
                   auVar18._0_8_ =
                        (ulong)((SUB164(auVar19 * auVar29,8) + uVar31) - SUB164(auVar17 * auVar27,8)
                               ) * lVar37, auVar28._8_8_ = 0, auVar28._0_8_ = uVar46,
            ...
            *(uint *)(*(long *)(this + 8) +
                     (ulong)*(uint *)(lVar33 + (ulong)*(uint *)(this + 0x24) * 4) * 4) = uVar6;
            return uVar31;
          }
          lVar44 = *(long *)(this + 0x18);
        }
        ...
        iVar35 = SUB164(auVar11 * auVar21,8);
              ...
              (auVar12._8_8_ = 0, auVar12._0_8_ = (ulong)uVar30 * lVar33, auVar22._8_8_ = 0,
              auVar22._0_8_ = uVar32, auVar13._8_8_ = 0,
              auVar13._0_8_ = (ulong)((uVar6 + iVar35) - SUB164(auVar12 * auVar22,8)) * lVar33,
              auVar23._8_8_ = 0, auVar23._0_8_ = uVar32, uVar45 <= SUB164(auVar13 * auVar23,8)));
    }
  }
  return 0;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashMap<String, DAP::Variable, HashMapHasherDefault, HashMapComparatorDefault<String>,
   DefaultTypedAllocator<HashMapElement<String, DAP::Variable> > >::insert(String const&,
   DAP::Variable const&, bool) */

String * HashMap<String,DAP::Variable,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,DAP::Variable>>>
      ...
      if (uVar45 != 0) {
        do {
          ...
          uVar44 = SUB164(auVar14 * auVar26,8);
                ...
                (auVar15._8_8_ = 0, auVar15._0_8_ = (ulong)uVar45 * lVar48, auVar27._8_8_ = 0,
                auVar27._0_8_ = uVar31, auVar16._8_8_ = 0,
                auVar16._0_8_ = (ulong)((uVar30 + uVar44) - SUB164(auVar15 * auVar27,8)) * lVar48,
                auVar28._8_8_ = 0, auVar28._0_8_ = uVar31, uVar49 <= SUB164(auVar16 * auVar28,8)));
      }
      iVar36 = *(int *)(param_2 + 0x2c);
    }
LAB_00119ffb:
    if ((float)uVar41 * __LC53 < (float)(iVar36 + 1)) goto LAB_0011a021;
  }
  local_68 = 0;
  if (*(long *)pSVar38 != 0) {
...
LAB_0011a371:
      CowData<char32_t>::_ref((CowData<char32_t> *)(plVar33 + 5),(CowData *)&local_50);
      *(undefined4 *)(plVar33 + 6) = uVar3;
      LOCK();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashMap<DAP::StackFrame, List<int, DefaultAllocator>, DAP::StackFrame,
...

{
  ...
  if (local_c8 == (void *)0x0) {
    ...
    *(void **)(param_2 + 8) = local_c8;
    if (uVar31 != 0) {
      pvVar3 = *(void **)(param_2 + 0x10);
      if ((pvVar3 < (void *)((long)local_c8 + uVar50)) &&
         (local_c8 < (void *)((long)pvVar3 + uVar33))) {
        uVar33 = 0;
        do {
          *(undefined4 *)((long)pvVar3 + uVar33 * 4) = 0;
...
LAB_0011afa1:
    if (iVar52 != 0) {
      ...
      if (uVar29 != 0) {
        do {
          if ((uVar29 == (uint)uVar50) &&
             (*(int *)(*(long *)((long)local_c8 + lVar42 * 8) + 0x10) == iVar40)) {
          ...
          uVar32 = SUB164(auVar6 * auVar18,8);
                ...
                (auVar7._8_8_ = 0, auVar7._0_8_ = (ulong)uVar29 * lVar38, auVar19._8_8_ = 0,
                auVar19._0_8_ = uVar33, auVar8._8_8_ = 0,
                auVar8._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                                 (ulong)*(uint *)(param_2 + 0x28) * 4) + uVar32) -
                                      SUB164(auVar7 * auVar19,8)) * lVar38, auVar20._8_8_ = 0,
                auVar20._0_8_ = uVar33, uVar49 <= SUB164(auVar8 * auVar20,8)));
      }
    }
  }
  ...
  if (((undefined8 *)*in_RCX != (undefined8 *)0x0) &&
     (puVar46 = *(undefined4 **)*in_RCX, puVar46 != (undefined4 *)0x0)) {
...
LAB_0011b53d:
  plVar36 = (long *)operator_new(0x48,"");
  *plVar36 = 0;
  plVar36[1] = 0;
  plVar36[3] = 0;
...
LAB_0011b1ab:
  plVar36 = *(long **)(*(long *)(param_2 + 8) + (ulong)uVar32 * 8);
  goto LAB_0011b886;
}
...
/* Callable create_custom_callable_function_pointer<DebugAdapterProtocol>(DebugAdapterProtocol*,
   char const*, void (DebugAdapterProtocol::*)()) */

DebugAdapterProtocol *
create_custom_callable_function_pointer<DebugAdapterProtocol>
          (DebugAdapterProtocol *param_1,char *param_2,_func_void *param_3)
...
/* Callable create_custom_callable_function_pointer<DebugAdapterProtocol, Array
   const&>(DebugAdapterProtocol*, char const*, void (DebugAdapterProtocol::*)(Array const&)) */

DebugAdapterProtocol *
create_custom_callable_function_pointer<DebugAdapterProtocol,Array_const&>
          (DebugAdapterProtocol *param_1,char *param_2,_func_void_Array_ptr *param_3)
...
void __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void>::call
          (CallableCustomMethodPointer<DebugAdapterProtocol,void> *this,Variant **param_1,
...
void __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void,Array_const&>::call
          (CallableCustomMethodPointer<DebugAdapterProtocol,void,Array_const&> *this,
...
void __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,Array_const&>::call
          (CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,Array_const&> *this,
          Variant **param_1,int param_2,Variant *param_3,CallError *param_4)
...
void __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void,int_const&>::call
          (CallableCustomMethodPointer<DebugAdapterProtocol,void,int_const&> *this,Variant **param_1
          ,int param_2,Variant *param_3,CallError *param_4)
...
void __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,int>::call
          (CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,int> *this,
          Variant **param_1,int param_2,Variant *param_3,CallError *param_4)
...
void __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,int_const&,bool_const&>::call
          (CallableCustomMethodPointer<DebugAdapterProtocol,void,String_const&,int_const&,bool_const&>
...
/* CallableCustomMethodPointer<DebugAdapterProtocol, void, bool const&, bool const&, String const&,
   bool const&>::call(Variant const**, int, Variant&, Callable::CallError&) const */

void __thiscall
CallableCustomMethodPointer<DebugAdapterProtocol,void,bool_const&,bool_const&,String_const&,bool_const&>
::call(CallableCustomMethodPointer<DebugAdapterProtocol,void,bool_const&,bool_const&,String_const&,bool_const&>
       *this,Variant **param_1,int param_2,Variant *param_3,CallError *param_4)
...
/* HashMap<ObjectID, int, HashMapHasherDefault, HashMapComparatorDefault<ObjectID>,
   DefaultTypedAllocator<HashMapElement<ObjectID, int> > >::_resize_and_rehash(unsigned int) */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashMap<ObjectID, int, HashMapHasherDefault, HashMapComparatorDefault<ObjectID>,
   DefaultTypedAllocator<HashMapElement<ObjectID, int> > >::operator[](ObjectID const&) */
...
void HashMap<ObjectID,int,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,int>>>
     ::insert(ObjectID *param_1,int *param_2,bool param_3)
...
LAB_0011d9a1:
  ...
  if ((float)uVar2 * __LC53 < (float)(iVar27 + 1)) {
    ...
    _resize_and_rehash((HashMap<ObjectID,int,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,int>>>
...
/* DebugAdapterProtocol::singleton */

void DebugAdapterProtocol::_GLOBAL__sub_I_singleton(void)

...
undefined4
EncodeCandidate(undefined4 *param_1,undefined8 *param_2,undefined8 *param_3,uint param_4,
               undefined8 *param_5)

{
  ...
  *param_5 = 0;
  ...
  for (uVar4 = (ulong)(((int)param_5 -
                       (int)(undefined8 *)((ulong)(param_5 + 1) & 0xfffffffffffffff8)) + 0x68U >> 3)
...
undefined8
ComparePixelsLossy(uint *param_1,int param_2,uint *param_3,int param_4,int param_5,int param_6)
...
void MinimizeChangeRectangle
               (float param_1,long param_2,long param_3,undefined1 (*param_4) [16],int param_5)

{
  ...
  if (0 < iVar5) {
    do {
      iVar5 = (*pcVar4)(*(long *)(param_2 + 0x48) +
                        (long)(*(int *)(*param_4 + 4) * *(int *)(param_2 + 0x50) + iVar1) * 4,
                        *(int *)(param_2 + 0x50),
                        *(long *)(param_3 + 0x48) +
                        (long)(*(int *)(*param_4 + 4) * *(int *)(param_3 + 0x50) + iVar1) * 4,
                        *(int *)(param_3 + 0x50),*(undefined4 *)(*param_4 + 0xc),iVar3);
      if (iVar5 == 0) {
        iVar5 = *(int *)(*param_4 + 8);
        break;
      }
  ...
  if (iVar5 != 0) {
    ...
    if (*(int *)*param_4 <= iVar5) {
      do {
        iVar2 = (*pcVar4)(*(long *)(param_2 + 0x48) +
                          (long)(*(int *)(*param_4 + 4) * *(int *)(param_2 + 0x50) + iVar5) * 4,
                          *(int *)(param_2 + 0x50),
                          *(long *)(param_3 + 0x48) +
                          (long)(*(int *)(*param_4 + 4) * *(int *)(param_3 + 0x50) + iVar5) * 4,
                          *(int *)(param_3 + 0x50),*(undefined4 *)(*param_4 + 0xc),iVar3);
        iVar1 = *(int *)(*param_4 + 8);
        if (iVar2 == 0) break;
        iVar1 = iVar1 + -1;
    ...
    if (0 < iVar5) {
      do {
        iVar5 = (*pcVar4)(*(long *)(param_2 + 0x48) +
                          (long)(*(int *)(param_2 + 0x50) * iVar1 + *(int *)*param_4) * 4,1,
                          *(long *)(param_3 + 0x48) +
                          (long)(*(int *)(param_3 + 0x50) * iVar1 + *(int *)*param_4) * 4,1,
                          *(undefined4 *)(*param_4 + 8),iVar3);
        if (iVar5 == 0) {
          iVar5 = *(int *)(*param_4 + 0xc);
          break;
        }
    ...
    if (iVar5 != 0) {
      ...
      if (*(int *)(*param_4 + 4) <= iVar5) {
        do {
          iVar2 = (*pcVar4)(*(long *)(param_2 + 0x48) +
                            (long)(*(int *)(param_2 + 0x50) * iVar5 + *(int *)*param_4) * 4,1,
                            *(long *)(param_3 + 0x48) +
                            (long)(*(int *)(param_3 + 0x50) * iVar5 + *(int *)*param_4) * 4,1,
                            *(undefined4 *)(*param_4 + 8),iVar3);
...
undefined8
GetSubRect(undefined8 param_1,undefined8 param_2,uint param_3,int param_4,int param_5,
...

{
  ...
  if ((uVar2 == 0) || (uVar4 = *(uint *)((long)param_7 + 0xc), uVar4 == 0)) {
    if (param_5 != 0) {
      return 1;
    }
    uVar4 = 1;
...
void GetSubRects(undefined4 param_1,undefined8 param_2,long param_3,undefined4 param_4,
  ...
  *(undefined8 *)(param_6 + 0x10) = *(undefined8 *)(param_3 + 8);
  ...
  if (iVar1 != 0) {
    ...
    *(undefined8 *)(param_6 + 0x120) = *(undefined8 *)(param_6 + 0x10);
    GetSubRect(param_1,param_2,param_3,param_4,param_5,*(undefined4 *)(param_6 + 4),0,
               param_6 + 0x118,param_6 + 0x128);
  }
  return;
}
...
undefined8 FlushFrames(long param_1)

{
  ...
  while( true ) {
    ...
    if (*(int *)(param_1 + 0x20) != 0) {
      __fprintf_chk(_stderr,2,"INFO: Added frame. offset:%d,%d dispose:%d blend:%d\n",
                    *(undefined4 *)(lVar16 + 0x10),*(undefined4 *)(lVar16 + 0x14),
                    *(undefined4 *)(lVar16 + 0x20),*(undefined4 *)(lVar16 + 0x24));
    }
  ...
  __snprintf_chk(param_1 + 0x4a8,100,2,0xffffffffffffffff,"%s: %d.",
                 "ERROR adding frame. WebPMuxError",uVar17);
  return 0;
}
...
undefined8 IncreasePreviousDuration_constprop_0(long param_1,int param_2)
...
void GenerateCandidates_constprop_0
               (long param_1,long param_2,int param_3,int param_4,int param_5,long param_6,
...

{
  ...
  if (param_5 == 0) {
    ...
    if (iVar8 < iVar26) {
LAB_00100be1:
      if (*(int *)(param_6 + 0x10) < 1) goto LAB_0010145a;
      do {
        lVar12 = (long)*(int *)(param_6 + 8);
        do {
          uVar9 = *(uint *)(*(long *)(param_1 + 0x180) +
                            (long)(*(int *)(param_1 + 0x188) * iVar8) * 4 + lVar12 * 4);
          if ((uVar9 >> 0x18 != 0xff) &&
             (*(uint *)(*(long *)(lVar1 + 0x48) + (long)(*(int *)(lVar1 + 0x50) * iVar8) * 4 +
                       lVar12 * 4) != uVar9)) {
            iVar8 = 0;
            goto LAB_00100c47;
          }
    ...
    if (iVar26 < iVar23) {
      ...
      do {
        if ((int)uVar22 < iVar21) {
          ...
          puVar18 = (uint *)(*(long *)(param_1 + 0x180) +
                            ((long)(*(int *)(param_1 + 0x188) * iVar26) + (long)iVar28) * 4);
    ...
    if (*(int *)(param_6 + 0x14) < 1) {
      ...
      do {
        ...
        if (0 < *(int *)(param_6 + 0x10)) {
          ...
          do {
            while ((iVar26 = *(int *)(lVar19 + lVar14 * 4),
                   *(int *)(lVar12 + (long)(iVar21 * iVar29) * 4 + lVar14 * 4) != iVar26 ||
                   (iVar26 == 0))) {
              lVar14 = lVar14 + 1;
          ...
          do {
            ...
            do {
              ...
              do {
                uVar25 = *local_a0;
                if ((uVar25 >> 0x18 == 0xff) &&
                   (uVar2 = *(uint *)(lVar14 + (long)iVar16 * 4), uVar2 >> 0x18 == 0xff)) {
...

{
  ...
  *(ulong *)(param_1 + 0x7c) = uVar18;
  uVar18 = param_2[9];
  *(ulong *)(param_1 + 0x84) = param_2[8];
  *(ulong *)(param_1 + 0x8c) = uVar18;
  uVar18 = param_2[0xb];
  *(ulong *)(param_1 + 0x94) = param_2[10];
  *(ulong *)(param_1 + 0x9c) = uVar18;
  uVar18 = param_2[0xd];
  *(ulong *)(param_1 + 0xa4) = param_2[0xc];
  *(ulong *)(param_1 + 0xac) = uVar18;
...
joined_r0x00101834:
          ...
          else if (((iVar2 != 0 || bVar20) && ((local_488 == 0 || (local_484 == 0)))) ||
                  ((iVar2 == 0 || bVar20 && ((local_378 == 0 || (local_374 == 0)))))) {
            *param_5 = 1;
            iVar10 = 0;
          }
          else {
...
LAB_00101a54:
            iVar10 = GetSubRects(param_1 + 0x340,param_1 + 0x138,param_3,iVar10,local_268);
            if (iVar10 == 0) goto LAB_00101820;
            if (*(int *)(param_1 + 0x10) == 0) {
              if (iVar2 == 0) {
                if ((uint)(local_378 * local_374) <= (uint)(local_148 * local_144)) {
LAB_0010187b:
                  if (local_498 != 0) goto LAB_00101aa2;
                  goto LAB_0010188c;
                }
              }
              else if ((uint)(local_488 * local_484) <= (uint)(local_258 * local_254))
              goto LAB_0010187b;
              local_268[0] = CONCAT44(local_268[0]._4_4_,1);
              local_498 = 0;
LAB_0010189f:
              iVar10 = GenerateCandidates_constprop_0
                                 (param_1,piVar17,1,iVar2,param_3,local_268,&local_738,&local_6b8);
...
LAB_00101aa2:
              iVar10 = GenerateCandidates_constprop_0
                                 (param_1,piVar17,0,iVar2,param_3,&local_498,&local_738,&local_6b8);
              if (iVar10 != 0) goto joined_r0x00101834;
LAB_0010188c:
              if ((int)local_268[0] != 0) goto LAB_0010189f;
            }
            uVar19 = 0xffffffff;
...
int WebPAnimEncoderOptionsInitInternal(undefined4 *param_1,int param_2)
...
int * WebPAnimEncoderNewInternal(int param_1,int param_2,undefined8 *param_3,int param_4)
...
LAB_00101f80:
          __fprintf_chk(_stderr,2,pcVar9);
      ...
      *(undefined8 *)(piVar7 + 5) = _LC19;
      iVar6 = 0x7fffffff;
LAB_00101ec0:
      if (0x1e < iVar6 - piVar7[5]) {
        iVar6 = iVar6 + -0x1e;
        piVar7[5] = iVar6;
        if (iVar4 != 0) {
LAB_00101edc:
          __fprintf_chk(_stderr,2,"WARNING: Setting kmin = %d, so that kmax - kmin <= %d.\n",iVar6,
                        0x1e);
        }
      }
    }
  ...
  if ((iVar4 == 0) || (iVar4 = WebPPictureInitInternal(piVar7 + 0xd0,0x20f), iVar4 == 0))
  goto LAB_00101e90;
  piVar7[0x50] = param_1;
  piVar7[0x51] = param_2;
  piVar7[0x4e] = 1;
  ...
  if ((iVar4 == 0) ||
     ((iVar4 = WebPPictureCopy(piVar1,piVar7 + 0x90), iVar4 == 0 ||
      (iVar4 = WebPPictureCopy(piVar1), iVar4 == 0)))) goto LAB_00101e90;
  iVar4 = piVar7[0x93];
  iVar6 = piVar7[0x92];
  if (0 < iVar4) {
...
LAB_00101e90:
  WebPAnimEncoderDelete_part_0(piVar7);
  return (int *)0x0;
LAB_00101dc0:
  do {
...
int WebPAnimEncoderRefineRect
              (int *param_1,int *param_2,undefined4 param_3,uint *param_4,uint *param_5,int *param_6
              ,int *param_7)
...
undefined8 WebPAnimEncoderAdd(long *param_1,int *param_2,int param_3,undefined8 *param_4)
...
LAB_00102490:
          __snprintf_chk(param_1 + 0x95,100,2,0xffffffffffffffff,&_LC25,pcVar10);
          goto LAB_001023ec;
        }
LAB_00102224:
          ...
          if (*(int *)((long)param_1 + 0x14) < iVar7) {
            ...
            if (lVar9 <= param_1[0x8d]) {
              if ((int)param_1[0x8e] != -1) {
                *(undefined4 *)
                 (param_1[0x88] + ((long)(int)param_1[0x8e] + param_1[0x8a]) * 0x68 + 0x60) = 0;
              }
...
LAB_0010273d:
          *(undefined4 *)(param_1[0x26] + 0x88) = 0;
        }
        else {
          iVar7 = SetFrame(param_1,&local_b8,1,lVar1,&local_bc);
          if (iVar7 != 0) {
...
LAB_001024d1:
          ...
          if (!bVar5) {
            __snprintf_chk(param_1 + 0x95,100,2,0xffffffffffffffff,"%s: %d.",
                           "ERROR adding frame. WebPEncodingError",iVar7);
    ...
    if ((uint)(param_3 - *(int *)((long)param_1 + 0x47c)) < 0x1000000) {
      ...
      if ((iVar7 == 0) ||
         ((param_1[0x8b] == param_1[0x89] && (iVar7 = FlushFrames(param_1), iVar7 == 0))))
      goto LAB_001023ec;
      goto LAB_001021da;
    }
    if (param_2 != (int *)0x0) {
    ...
    if (param_2 == (undefined8 *)0x0) {
      ...
      if (lVar6 != 0) {
        ...
        if (((param_1[0x122] == 0) && (lVar6 != 1)) && (lVar7 != 0)) {
          iVar5 = IncreasePreviousDuration_constprop_0
                            (param_1,(int)((double)(uint)(param_1[0x11f] - param_1[0x11e]) /
                                          (double)(lVar6 - 1)));
        ...
        *(long *)(param_1 + 0x118) = lVar7;
        ...
        if (((iVar5 == 1) && (iVar5 = WebPMuxSetAnimationParams(uVar3,param_1 + 2), iVar5 == 1)) &&
           (iVar5 = WebPMuxAssemble(uVar3,param_2), iVar5 == 1)) {
          uVar9 = 1;
              ...
              if (iVar5 == 1) {
                ...
                if (iVar5 != 0) {
                  ...
                  for (iVar10 = 0; iVar10 < iVar5; iVar10 = iVar10 + 1) {
                    if (0 < iVar2) {
                      memset((void *)(*(long *)(param_1 + 0x60) + (long)(param_1[0x62] * iVar10) * 4
                                     ),0,(ulong)(iVar2 - 1) * 4 + 4);
                    }
                  }
                      ...
                      if (iVar5 == 0) {
                        ...
                        *(undefined8 **)(param_1 + 0x68) = &local_2a8;
                        ...
                        if (iVar5 != 0) {
                          ...
                          if ((iVar5 == 1) && (iVar5 = WebPMuxAssemble(lVar6,local_2b8), iVar5 == 1)
                             ) {
...
LAB_00102b42:
        ...
        __snprintf_chk(param_1 + 0x12a,100,2,0xffffffffffffffff,"%s: %d.","ERROR assembling WebP",
                       iVar5);
        goto LAB_00102980;
      }
    }

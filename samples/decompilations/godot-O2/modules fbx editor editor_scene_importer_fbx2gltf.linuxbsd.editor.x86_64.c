...
void EditorSceneFormatImporterFBX2GLTF::get_import_options(String *param_1,List *param_2)
...
/* EditorSceneFormatImporterFBX2GLTF::get_extensions(List<String, DefaultAllocator>*) const */

void __thiscall
EditorSceneFormatImporterFBX2GLTF::get_extensions
          (EditorSceneFormatImporterFBX2GLTF *this,List *param_1)
...
void __thiscall
EditorSceneFormatImporterFBX2GLTF::handle_compatibility_options
          (EditorSceneFormatImporterFBX2GLTF *this,HashMap *param_1)

{
  ...
  local_54 = 0;
  cVar1 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
          ::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
                         *)param_1,(StringName *)&local_50,&local_54);
...
String * EditorSceneFormatImporterFBX2GLTF::get_option_visibility
  ...
  *in_R9;
  ...
  if (cVar2 != '\0') {
    ...
    if (cVar2 != '\0') {
      ...
      local_38 = 0;
      cVar2 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
              ::_lookup_pos(in_R9,(StringName *)&local_40,(uint *)&local_38);
      if (cVar2 == '\0') {
LAB_00100537:
...
LAB_00100544:
        ...
        local_44 = 0;
        cVar2 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
                ::_lookup_pos(in_R9,(StringName *)&local_38,&local_44);
        if (cVar2 == '\0') {
        ...
        iVar3 = Variant::operator_cast_to_int
                          ((Variant *)(*(long *)(*(long *)(in_R9 + 8) + (ulong)local_44 * 8) + 0x18)
                          );
        if (iVar3 == 1) {
          if (StringName::configured != '\0') {
...
EditorSceneFormatImporterFBX2GLTF::import_scene
          (EditorSceneFormatImporterFBX2GLTF *this,String *param_1,uint param_2,HashMap *param_3,
...

{
  ...
  cVar3 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
          ::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
                         *)param_3,(StringName *)&local_68,(uint *)&local_60);
  if (cVar3 == '\0') {
joined_r0x0010103b:
    if (StringName::configured != '\0') {
LAB_001006e4:
    ...
    cVar3 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
            ::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
                           *)param_3,(StringName *)&local_60,(uint *)&local_70);
    if (cVar3 == '\0') {
      _err_print_error("operator[]","./core/templates/hash_map.h",0x245,
                       "FATAL: Condition \"!exists\" is true.",0,0);
      _err_flush_stdout();
    ...
    iVar5 = Variant::operator_cast_to_int
                      ((Variant *)
                       (*(long *)(*(long *)(param_3 + 8) + (local_70 & 0xffffffff) * 8) + 0x18));
    if (iVar5 == 0) {
      if ((StringName::configured != '\0') &&
      ...
      *(code **)this_00 = stringify_variants;
      ...
      uVar8 = (**(code **)(*(long *)pOVar10 + 0x158))
                        (pOVar10,param_1,param_2,param_3,param_4,param_5);
  ...
  vformat<String,String>
            ((String *)&local_60,(StringName *)&local_68,(CowData<char32_t> *)&local_78,
  ...
  List<String,DefaultAllocator>::push_back
            ((List<String,DefaultAllocator> *)&local_90,(String *)&local_60);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
  local_60 = 0;
  ...
  (**(code **)(*plVar6 + 0x108))
            (plVar6,local_98,(List<String,DefaultAllocator> *)&local_90,
             (CowData<char32_t> *)&local_88,&local_b4,1,0,0);
    ...
    *(undefined8 *)(this_01 + 0x270) = 0;
    ...
    cVar3 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
            ::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
                          ...
                          (StringName *)
                          &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                           ::{lambda()#1}::operator()()::sname,(uint *)&local_60);
    if (cVar3 == '\0') {
LAB_00100e16:
      pOVar10 = local_80;
      cVar3 = is_print_verbose_enabled();
...
LAB_00100e23:
        ...
        vformat<String>((StringName *)&local_68,(CowData<char32_t> *)&local_78,
                        (CowData<char32_t> *)&local_70);
...
LAB_00100efe:
    ...
    iVar5 = (*local_110)(local_d8,(String *)&local_60,(StringName *)&local_68,param_2,
                         (CowData<char32_t> *)&local_70);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
    if (((local_68 != (Object *)0x0) &&
...
LAB_00101229:
    ...
    _err_print_error("import_scene","modules/fbx/editor/editor_scene_importer_fbx2gltf.cpp",0x5c,
                     (String *)&local_60,0,0);
    uVar8 = 0;
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_68);
...
/* EditorSceneFormatImporterFBX2GLTF::is_class_ptr(void*) const */

uint __thiscall
EditorSceneFormatImporterFBX2GLTF::is_class_ptr
          (EditorSceneFormatImporterFBX2GLTF *this,void *param_1)
...
/* EditorSceneFormatImporterFBX2GLTF::_getv(StringName const&, Variant&) const */

undefined8 EditorSceneFormatImporterFBX2GLTF::_getv(StringName *param_1,Variant *param_2)
...
/* EditorSceneFormatImporterFBX2GLTF::_setv(StringName const&, Variant const&) */

undefined8 EditorSceneFormatImporterFBX2GLTF::_setv(StringName *param_1,Variant *param_2)
...
/* EditorSceneFormatImporterFBX2GLTF::_validate_propertyv(PropertyInfo&) const */

void EditorSceneFormatImporterFBX2GLTF::_validate_propertyv(PropertyInfo *param_1)
...
/* EditorSceneFormatImporterFBX2GLTF::_property_can_revertv(StringName const&) const */

undefined8 EditorSceneFormatImporterFBX2GLTF::_property_can_revertv(StringName *param_1)
...
/* EditorSceneFormatImporterFBX2GLTF::_property_get_revertv(StringName const&, Variant&) const */

undefined8
EditorSceneFormatImporterFBX2GLTF::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* EditorSceneFormatImporterFBX2GLTF::_notificationv(int, bool) */

void EditorSceneFormatImporterFBX2GLTF::_notificationv(int param_1,bool param_2)
...
{
  return (uint)CONCAT71(0x1074,(undefined4 *)param_1 == &Resource::get_class_ptr_static()::ptr) |
...
void __thiscall
EditorSceneFormatImporterFBX2GLTF::~EditorSceneFormatImporterFBX2GLTF
          (EditorSceneFormatImporterFBX2GLTF *this)
...
/* EditorSceneFormatImporterFBX2GLTF::_get_class_namev() const */

undefined8 * EditorSceneFormatImporterFBX2GLTF::_get_class_namev(void)
  ...
  if (cVar2 == '\0') {
    ...
    *(Resource **)this = this_00;
    ...
    if (((pOVar6 == (Object *)0x0) || (cVar2 = RefCounted::unreference(), cVar2 == '\0')) ||
       (cVar2 = predelete_handler(pOVar6), cVar2 == '\0')) goto LAB_00102205;
  }
...
/* EditorSceneFormatImporterFBX2GLTF::_initialize_classv() */

void EditorSceneFormatImporterFBX2GLTF::_initialize_classv(void)
...
/* WARNING: Removing unreachable block (ram,0x00102a68) */
...
/* EditorSceneFormatImporterFBX2GLTF::get_class() const */

void EditorSceneFormatImporterFBX2GLTF::get_class(void)
...
/* EditorSceneFormatImporterFBX2GLTF::is_class(String const&) const */

undefined8 __thiscall
EditorSceneFormatImporterFBX2GLTF::is_class(EditorSceneFormatImporterFBX2GLTF *this,String *param_1)
...
void __thiscall
EditorSceneFormatImporterFBX2GLTF::_get_property_listv
          (EditorSceneFormatImporterFBX2GLTF *this,List *param_1,bool param_2)
...
/* EditorSceneFormatImporterFBX2GLTF::import_scene(String const&, unsigned int, HashMap<StringName,
   Variant, HashMapHasherDefault, HashMapComparatorDefault<StringName>,
   DefaultTypedAllocator<HashMapElement<StringName, Variant> > > const&, List<String,
   DefaultAllocator>*, Error*) [clone .cold] */

void EditorSceneFormatImporterFBX2GLTF::import_scene
               (String *param_1,uint param_2,HashMap *param_3,List *param_4,Error *param_5)
...
void EditorSceneFormatImporterFBX2GLTF::_GLOBAL__sub_I_get_extensions(void)

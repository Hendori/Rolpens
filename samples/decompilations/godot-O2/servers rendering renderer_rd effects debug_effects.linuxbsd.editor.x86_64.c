...
void CowData<RID>::_ref(CowData *param_1)
...
/* RendererRD::DebugEffects::~DebugEffects() */

void __thiscall RendererRD::DebugEffects::~DebugEffects(DebugEffects *this)
    ...
    if (lVar1 != 0) {
      do {
        ...
        *(undefined1 *)(puVar8 + 1) = *(undefined1 *)(puVar6 + 1);
        ...
        puVar8[2] = uVar2;
        if (lVar3 != 0) {
          CowData<RID>::_ref((CowData *)(puVar8 + 4));
        }
        lVar9 = lVar9 + 1;
        puVar8 = puVar8 + 5;
      } while (lVar1 != lVar9);
...
LAB_00101176:
    PipelineCacheRD::setup
              ((PipelineCacheRD *)(this + 0x1b8),uVar8,5,(StrRange *)&local_118,
               (StrRange *)&local_e8,&local_b8,local_68,0,local_128);
    lVar13 = local_d0;
    if (local_d0 != 0) {
      LOCK();
...
LAB_00101446:
      PipelineCacheRD::setup
                ((PipelineCacheRD *)(this + 0x2f0),uVar8,1,(StrRange *)&local_118,
                 (StrRange *)&local_e8,&local_b8,local_68,0,local_128);
      lVar13 = local_d0;
      if (local_d0 != 0) {
        LOCK();
        ...
        if (0 < lVar13) {
          ...
          if (0 < lVar13) {
            ...
            if ((uVar10 != 0) && ((uint)uVar10 < *(uint *)(this + 0x4fc))) {
              lVar11 = ((uVar10 & 0xffffffff) % (ulong)*(uint *)(this + 0x4f8)) * 0xa0 +
                       *(long *)(*(long *)(this + 0x4e8) +
                                ((uVar10 & 0xffffffff) / (ulong)*(uint *)(this + 0x4f8)) * 8);
...
LAB_0010186e:
      PipelineCacheRD::setup
                ((PipelineCacheRD *)(this + 0x5a8),uVar8,5,(StrRange *)&local_118,
                 (StrRange *)&local_e8,&local_b8,local_68,0,local_128);
      lVar13 = local_d0;
      if (local_d0 != 0) {
        LOCK();
...
LAB_00101da0:
      ...
      lVar14 = ((uVar10 & 0xffffffff) % (ulong)*(uint *)(this + 0x108)) * 0xa0 +
               *(long *)(*(long *)(this + 0xf8) +
...
LAB_00101b00:
      ...
      lVar11 = ((uVar10 & 0xffffffff) % (ulong)*(uint *)(this + 0x108)) * 0xa0 +
               *(long *)(*(long *)(this + 0xf8) +
                        ((uVar10 & 0xffffffff) / (ulong)*(uint *)(this + 0x108)) * 8);
      if (*(int *)(lVar11 + 0x98) != (int)(uVar10 >> 0x20)) {
        if (*(int *)(lVar11 + 0x98) + 0x80000000U < 0x7fffffff) {
...
LAB_00101a62:
  _err_print_index_error
            ("get","./core/templates/cowdata.h",0xdb,uVar10,lVar13,"p_index","size()","",false,true)
  ;
  _err_flush_stdout();
                    /* WARNING: Does not return */
...
/* RendererRD::DebugEffects::draw_motion_vectors(RID, RID, RID, Projection const&, Transform3D
   const&, Projection const&, Transform3D const&, Vector2i) */

void __thiscall
RendererRD::DebugEffects::draw_motion_vectors
          (DebugEffects *this,undefined8 param_2,undefined8 param_3,undefined8 param_4,
          undefined8 param_5,Transform3D *param_6,undefined8 param_7,undefined8 param_8,
          undefined8 param_9)

{
  ...
  if (lVar12 == 0) {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      uVar13 = 0x158;
      pcVar18 = "Parameter \"material_storage\" is null.";
LAB_001029d4:
      _err_print_error("draw_motion_vectors",
                       "servers/rendering/renderer_rd/effects/debug_effects.cpp",uVar13,pcVar18,0,0)
      ;
      return;
    }
    goto LAB_00102b0d;
  ...
  if (UniformSetCacheRD::singleton == (UniformSetCacheRD *)0x0) {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      uVar13 = 0x15b;
      pcVar18 = "Parameter \"uniform_set_cache\" is null.";
      goto LAB_001029d4;
    }
    goto LAB_00102b0d;
  }
  ...
  local_88[0] = uVar13;
  local_88[1] = param_2;
  iVar10 = CowData<RID>::resize<false>((CowData<RID> *)local_2e0,2);
  uVar17 = local_2e0[0];
  if (iVar10 == 0) {
    lVar12 = 0;
    do {
...
LAB_00102809:
        _err_print_index_error
                  ("set","./core/templates/cowdata.h",0xcf,lVar12,lVar19,"p_index","size()","",false
                   ,false);
      }
      else {
        lVar19 = *(long *)(uVar17 + -8);
        if (lVar19 <= lVar12) goto LAB_00102809;
        CowData<RID>::_copy_on_write((CowData<RID> *)local_2e0);
        *(undefined8 *)(local_2e0[0] + lVar12 * 8) = local_88[lVar12];
        uVar17 = local_2e0[0];
      }
      if (lVar12 != 0) break;
      lVar12 = 1;
  ...
  if (uVar17 != 0) {
    ...
    if (lVar19 != -1) {
      local_358 = local_2e0[0];
    }
LAB_00101fda:
    if (local_2e0[0] != 0) {
      LOCK();
      plVar1 = (long *)(local_2e0[0] + -0x10);
      *plVar1 = *plVar1 + -1;
      UNLOCK();
      if (*plVar1 == 0) {
        Memory::free_static((void *)(local_2e0[0] + -0x10),false);
      }
    }
  }
  lVar12 = 0;
...
LAB_001027c7:
        ...
        lVar19 = *(long *)(uVar17 + -8);
        if (lVar19 <= lVar12) goto LAB_001027c7;
        CowData<RID>::_copy_on_write((CowData<RID> *)local_2e0);
        *(undefined8 *)(local_2e0[0] + lVar12 * 8) =
             *(undefined8 *)((Projection *)local_88 + lVar12 * 8);
        uVar17 = local_2e0[0];
      }
      if (lVar12 != 0) break;
      lVar12 = 1;
...
LAB_001020a0:
  ...
  local_88[1] = 0;
  local_2e0[0] = 0;
  pvVar14 = (void *)RenderingDevice::draw_list_begin
                              (_LC65,uVar13,param_4,0,&local_2e8,0,(Projection *)local_88,0);
  uVar17 = local_2e0[0];
  if (local_2e0[0] != 0) {
    LOCK();
    plVar1 = (long *)(local_2e0[0] - 0x10);
  ...
  uVar11 = RenderingDevice::draw_list_get_current_pass();
  uVar15 = RenderingDevice::get_singleton();
  lVar12 = RenderingDevice::framebuffer_get_format(uVar15,param_4);
  if (*(long *)(this + 0x5e8) == 0) {
    ...
    while( true ) {
      ...
      local_2e8 = uVar17 << 8;
      do {
      } while (*pDVar2 != (DebugEffects)0x0);
    }
    if (*(uint *)(this + 0x6d8) != 0) {
      plVar16 = *(long **)(this + 0x6d0);
      plVar1 = plVar16 + (ulong)*(uint *)(this + 0x6d8) * 5;
      do {
        if ((((*plVar16 == -1) && (lVar12 == plVar16[1])) &&
            (this[0x5f6] == *(DebugEffects *)((long)plVar16 + 0x14))) &&
           ((uVar11 == *(uint *)(plVar16 + 2) && ((int)plVar16[3] == 0)))) {
          lVar12 = plVar16[4];
    ...
    lVar12 = PipelineCacheRD::_generate_version
                       ((long)pDVar2,-1,SUB81(lVar12,0),(uint)(byte)this[0x5f6],uVar11);
    this[0x5a8] = (DebugEffects)0x0;
  }
LAB_00102281:
  RenderingDevice::draw_list_bind_render_pipeline(uVar13,pvVar14,lVar12);
...
LAB_0010252d:
    ...
    lVar12 = *(long *)(*(long *)(this + 0x440) + -8);
    if (lVar12 < 1) goto LAB_00102a68;
    pcVar18 = *(char **)(this + 0x450);
    if (pcVar18 == (char *)0x0) {
LAB_001028cd:
      lVar12 = 0;
LAB_001028d0:
...
LAB_001028ed:
      _err_print_index_error
                ("get","./core/templates/cowdata.h",0xdb,uVar17,lVar12,"p_index","size()","",false,
                 true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
    ...
    if (lVar12 < 1) goto LAB_001028d0;
    if (*pcVar18 == '\0') {
      _err_print_error("version_get_shader","./servers/rendering/renderer_rd/shader_rd.h",0xa7,
                       "Condition \"!variants_enabled[p_variant]\" is true. Returning: RID()",0,0);
      goto LAB_0010252d;
    }
    if ((uVar17 == 0) || (*(uint *)(this + 0x4fc) <= (uint)uVar17)) {
LAB_001028a3:
      _err_print_error("version_get_shader","./servers/rendering/renderer_rd/shader_rd.h",0xaa,
                       "Parameter \"version\" is null.",0,0);
      goto LAB_0010252d;
    }
    lVar19 = ((uVar17 & 0xffffffff) % (ulong)*(uint *)(this + 0x4f8)) * 0xa0 +
             *(long *)(*(long *)(this + 0x4e8) +
                      ((uVar17 & 0xffffffff) / (ulong)*(uint *)(this + 0x4f8)) * 8);
    if (*(int *)(lVar19 + 0x98) != (int)(uVar17 >> 0x20)) {
    ...
    if (*(char *)(lVar19 + 0x91) != '\0') {
      ...
      lVar12 = *(long *)(this + 0x4a0);
      if (lVar12 != 0) {
        lVar20 = 0;
        do {
          if (*(long *)(lVar12 + -8) <= lVar20) break;
          if (*(char *)(lVar12 + lVar20) == '\0') {
            ShaderRD::_allocate_placeholders(pVVar3,iVar10);
          }
          else {
            ShaderRD::_compile_version_start(pVVar3,iVar10);
          }
          lVar12 = *(long *)(this + 0x4a0);
          lVar20 = lVar20 + 1;
        } while (lVar12 != 0);
    ...
    lVar12 = *(long *)(puVar5 + -2);
    if (lVar12 < 1) goto LAB_001028d0;
    uVar17 = (ulong)*puVar5;
    lVar20 = *(long *)(lVar19 + 0x68);
    if (lVar20 == 0) {
      lVar12 = 0;
      goto LAB_001028ed;
    }
    lVar12 = *(long *)(lVar20 + -8);
    if (lVar12 <= (long)uVar17) goto LAB_001028ed;
    if (*(long *)(lVar20 + uVar17 * 8) != 0) {
      ShaderRD::_compile_version_end(pVVar3,iVar10);
    }
    if (*(char *)(lVar19 + 0x90) == '\0') goto LAB_0010252d;
    puVar6 = *(undefined8 **)(lVar19 + 0x88);
  ...
  local_2c8[0] = 0;
  local_2e8 = uVar8;
  local_2e0[0] = local_2e0[0] & 0xffffffffffffff00;
  local_2e0[1] = 0;
  if (local_328 != 0) {
    CowData<RID>::_ref((CowData *)local_2c8);
  }
  local_2f8[0] = 0;
  local_318 = 1;
  local_310 = 0;
  ...
  if (local_358 == 0) {
    uVar13 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform,RenderingDevice::Uniform>
                       (pUVar9,uVar13,0,&local_318,&local_2e8);
    RenderingDevice::draw_list_bind_uniform_set(uVar15,pvVar14,uVar13,0);
  }
  else {
    CowData<RID>::_ref((CowData *)local_2f8);
    lVar12 = local_2f8[0];
    uVar13 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform,RenderingDevice::Uniform>
                       (pUVar9,uVar13,0,&local_318,&local_2e8);
    RenderingDevice::draw_list_bind_uniform_set(uVar15,pvVar14,uVar13,0);
  ...
  RenderingDevice::draw_list_set_push_constant(lVar12,pvVar14,(int)this + 0x6e0);
  lVar12 = RenderingDevice::get_singleton();
  RenderingDevice::draw_list_draw(lVar12,SUB81(pvVar14,0),0,1);
  RenderingDevice::get_singleton();
  ...
  if (local_328 != 0) {
    LOCK();
    plVar1 = (long *)(local_328 + -0x10);
    *plVar1 = *plVar1 + -1;
    UNLOCK();
    if (*plVar1 == 0) {
      Memory::free_static((void *)(local_328 + -0x10),false);
    }
  }
  if (local_358 != 0) {
    LOCK();
    plVar1 = (long *)(local_358 + -0x10);
    *plVar1 = *plVar1 + -1;
    UNLOCK();
    if (*plVar1 == 0) {
      Memory::free_static((void *)(local_358 + -0x10),false);
    }
  }
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* RendererRD::DebugEffects::_create_frustum_arrays() */

void __thiscall RendererRD::DebugEffects::_create_frustum_arrays(DebugEffects *this)

{
  ...
  if (*(long *)(this + 8) == 0) {
    ...
    *(undefined8 *)(this + 8) = uVar7;
    ...
    local_a0 = 0;
    local_90 = 0;
    iVar4 = CowData<RenderingDeviceCommons::VertexAttribute>::resize<false>
                      ((CowData<RenderingDeviceCommons::VertexAttribute> *)&local_a0,1);
    if (iVar4 == 0) {
      if (local_a0 == 0) {
        lVar9 = -1;
        lVar8 = 0;
...
void RendererRD::DebugEffects::draw_shadow_frustum
               (undefined8 param_1,undefined8 param_2,DebugEffects *param_3,ulong param_4,
               undefined8 param_5,Vector3 *param_6,undefined8 param_7,undefined8 param_8)
...
LAB_00104966:
  ...
  lVar29 = ((param_4 & 0xffffffff) % (ulong)*(uint *)(plVar20 + 0x10)) * 0x498 +
           *(long *)(plVar20[0xe] + ((param_4 & 0xffffffff) / (ulong)*(uint *)(plVar20 + 0x10)) * 8)
  ;
  ...
  if (iVar6 != (int)(param_4 >> 0x20)) {
    if (iVar6 + 0x80000000U < 0x7fffffff) {
      _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                       "Method/function failed. Returning: nullptr",
                       "Attempting to use an uninitialized RID",0,0,param_8);
    }
    goto LAB_00104966;
  }
  ...
  if (*(code **)(*plVar20 + 0xf8) == LightStorage::light_get_type) {
    if ((uVar9 != 0) && (uVar28 < *(uint *)((long)plVar20 + 0x2c))) {
      piVar30 = (int *)(((uVar9 & 0xffffffff) % (ulong)*(uint *)(plVar20 + 5)) * 0xe8 +
                       *(long *)(plVar20[3] +
                                ((uVar9 & 0xffffffff) / (ulong)*(uint *)(plVar20 + 5)) * 8));
      iVar19 = piVar30[0x38];
      if (iVar25 == iVar19) {
        iVar19 = *piVar30;
...
joined_r0x001041c6:
    if (iVar19 != 0) {
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
        _err_print_error("draw_shadow_frustum",
                         "servers/rendering/renderer_rd/effects/debug_effects.cpp",0xb8,
                         "Condition \"light_storage->light_get_type(base) != RenderingServer::LIGHT_DIRECTIONAL\" is true."
                         ,0,0);
        return;
      }
      goto LAB_0010438e;
  ...
  if (*(code **)(*RenderingServerGlobals::light_storage + 0x108) == LightStorage::light_get_param) {
    if ((uVar9 != 0) && (uVar28 < *(uint *)((long)RenderingServerGlobals::light_storage + 0x2c))) {
      lVar29 = ((uVar9 & 0xffffffff) % (ulong)*(uint *)(RenderingServerGlobals::light_storage + 5))
    ...
    auVar41._0_8_ =
         (**(code **)(*RenderingServerGlobals::light_storage + 0x108))
                   (RenderingServerGlobals::light_storage,uVar9,9);
    auVar41._8_8_ = extraout_XMM0_Qb_00;
    auVar44 = ZEXT416((uint)uVar40);
LAB_00103300:
    auVar42 = auVar44;
    if (((0.0 < auVar41._0_4_) && (cVar17 == '\0')) &&
       (auVar42 = auVar41, auVar44._0_4_ <= auVar41._0_4_)) {
  ...
  do {
    ...
    if (*(code **)(*RenderingServerGlobals::light_storage + 0x108) == LightStorage::light_get_param)
    {
      if ((uVar9 != 0) && (uVar28 < *(uint *)((long)RenderingServerGlobals::light_storage + 0x2c)))
      {
        lVar31 = ((uVar9 & 0xffffffff) % (ulong)*(uint *)(RenderingServerGlobals::light_storage + 5)
                 ) * 0xe8 +
      ...
      fVar39 = (float)(**(code **)(*RenderingServerGlobals::light_storage + 0x108))
                                (RenderingServerGlobals::light_storage,uVar9,iVar19);
      auVar42 = ZEXT416(auVar42._0_4_);
    }
LAB_001033fe:
    local_258[lVar33 + 1] = fVar39 * (fVar43 - fVar5) + auVar42._0_4_;
    lVar33 = lVar33 + 1;
  } while (lVar33 != lVar29);
  lVar33 = 0;
  local_1d8 = __LC83;
  ...
  do {
    ...
    if (cVar17 == '\0') {
      ...
      Projection::set_orthogonal
                (local_294 + local_294,fVar38,local_258[iVar25],local_258[lVar33 + 1],bVar27);
    }
    cVar18 = Projection::get_endpoints((Transform3D *)local_198,param_6);
    if (cVar18 == '\0') {
      _err_print_error("draw_shadow_frustum",
                       "servers/rendering/renderer_rd/effects/debug_effects.cpp",0xfd,
...
LAB_0010484e:
        puVar34 = (undefined4 *)((long)iVar19 * 0x9c + 4);
        puVar35 = &local_158;
      ...
      lVar21 = ((param_4 & 0xffffffff) % (ulong)*(uint *)(plVar20 + 0x10)) * 0x498 +
               *(long *)(plVar20[0xe] +
                        ((param_4 & 0xffffffff) / (ulong)*(uint *)(plVar20 + 0x10)) * 8);
      iVar25 = *(int *)(lVar21 + 0x490);
      if (iVar6 != iVar25) {
        if (iVar25 + 0x80000000U < 0x7fffffff) {
          _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                           "Method/function failed. Returning: nullptr",
                           "Attempting to use an uninitialized RID",0,0,lVar31);
        }
        goto LAB_0010484e;
      }
      ...
      local_268 = CONCAT44(fVar8 * uStack_260._4_4_ + local_268._4_4_,
                           fVar43 * (float)uStack_260 + (float)local_268);
      ...
      if (*(long *)(param_3 + 0x1f8) == 0) {
        ...
        if (*(uint *)(param_3 + 0x2e8) != 0) {
          ...
          do {
            if (((*(long *)param_3 == *plVar24) && (lVar21 == plVar24[1])) &&
               ((param_3[0x206] == *(DebugEffects *)((long)plVar24 + 0x14) &&
                (((int)plVar24[2] == 0 && ((int)plVar24[3] == 0)))))) {
              lVar31 = plVar24[4];
        ...
        lVar31 = PipelineCacheRD::_generate_version
                           ((long)pDVar2,*(long *)param_3,bVar27,(uint)(byte)param_3[0x206],0);
        param_3[0x1b8] = (DebugEffects)0x0;
      }
LAB_0010392c:
      uVar22 = RenderingDevice::get_singleton();
      ...
      if (*(long *)(param_3 + 0x330) == 0) {
        ...
        if (*(uint *)(param_3 + 0x420) != 0) {
          ...
          do {
            if ((((*(long *)param_3 == *plVar24) && (lVar21 == plVar24[1])) &&
                (param_3[0x33e] == *(DebugEffects *)((long)plVar24 + 0x14))) &&
               (((int)plVar24[2] == 0 && ((int)plVar24[3] == 0)))) {
              lVar31 = plVar24[4];
        ...
        lVar31 = PipelineCacheRD::_generate_version
                           ((long)pDVar3,*(long *)param_3,bVar27,(uint)(byte)param_3[0x33e],0);
        param_3[0x2f0] = (DebugEffects)0x0;
      }
LAB_00103a79:
      uVar22 = RenderingDevice::get_singleton();
      ...
      if (iVar19 < iVar25) {
        if (*(uint *)((long)plVar20 + 0x84) <= uVar32) {
LAB_00104904:
          puVar34 = (undefined4 *)((long)iVar25 * 0x9c + 4);
        ...
        lVar31 = ((param_4 & 0xffffffff) % (ulong)*(uint *)(plVar20 + 0x10)) * 0x498 +
                 *(long *)(plVar20[0xe] +
                          ((param_4 & 0xffffffff) / (ulong)*(uint *)(plVar20 + 0x10)) * 8);
        ...
        if (iVar6 != iVar19) {
          if (iVar19 + 0x80000000U < 0x7fffffff) {
            _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                             "Method/function failed. Returning: nullptr",
                             "Attempting to use an uninitialized RID",0,0,uVar22);
          }
          goto LAB_00104904;
        }
        ...
        if (*(uint *)((long)plVar20 + 0x84) <= uVar32) {
LAB_001048ad:
          puVar34 = (undefined4 *)((long)iVar25 * 0x9c + 0x44);
          pPVar36 = (Projection *)&local_d8;
        ...
        uVar40 = RenderingDevice::get_singleton();
        local_270 = 0;
        pvVar23 = (void *)RenderingDevice::draw_list_begin
                                    (uVar40,param_7,0,local_278,0,&local_268,0);
        lVar31 = local_270;
        if (local_270 != 0) {
          LOCK();
          plVar1 = (long *)(local_270 + -0x10);
...
/* ShadowFrustumShaderRD::~ShadowFrustumShaderRD() */

void __thiscall ShadowFrustumShaderRD::~ShadowFrustumShaderRD(ShadowFrustumShaderRD *this)
...
/* MotionVectorsShaderRD::~MotionVectorsShaderRD() */

void __thiscall MotionVectorsShaderRD::~MotionVectorsShaderRD(MotionVectorsShaderRD *this)
...
LAB_00104c83:
        ...
        *(undefined1 *)(puVar13 + 1) = *(undefined1 *)(puVar11 + 1);
        ...
        if (puVar13[4] != puVar11[4]) {
          CowData<RID>::_ref((CowData *)(puVar13 + 4));
        }
        lVar9 = lVar9 + 1;
    ...
    if (*(long *)(this + 8) == 0) {
      ...
      if (-1 < lVar4) {
        ...
        *(undefined1 *)(puVar1 + 1) = *(undefined1 *)(param_2 + 1);
        ...
        CowData<RID>::_ref((CowData *)(puVar1 + 4));
        return;
      }
    }
    _err_print_index_error
...

{
  ...
  local_58 = param_5[2];
  if (param_5[4] != 0) {
    CowData<RID>::_ref((CowData *)&local_48);
  }
  uVar6 = (*param_4 * 0x16a88000 | (uint)(*param_4 * -0x3361d2af) >> 0x11) * 0x1b873593 ^
          (uVar6 << 0xd | uVar6 >> 0x13) * 5 + 0xe6546b64;
  uVar6 = (uVar6 << 0xd | uVar6 >> 0x13) * 5 + 0xe6546b64 ^
          (param_4[1] * 0x16a88000 | (uint)(param_4[1] * -0x3361d2af) >> 0x11) * 0x1b873593;
  lVar12 = *(long *)(param_4 + 4);
  uVar8 = (ulong)((uVar6 << 0xd | uVar6 >> 0x13) * 5 + 0xe6546b64);
  if (lVar12 != 0) {
    uVar6 = 1;
LAB_0010651d:
    uVar20 = 0;
    do {
      ...
      if (lVar12 == 0) {
        ...
        if (lVar12 == 0) goto LAB_001065a0;
        lVar16 = *(long *)(lVar12 + -8);
        if (lVar16 <= (long)uVar20) goto LAB_001065c1;
        lVar12 = *(long *)(lVar12 + uVar20 * 8);
LAB_00106531:
        iVar7 = (int)((ulong)lVar12 >> 0x20);
        uVar14 = (iVar7 * 0x16a88000 | (uint)(iVar7 * -0x3361d2af) >> 0x11) * 0x1b873593;
        uVar13 = uVar13 ^ ((int)lVar12 * 0x16a88000 | (uint)((int)lVar12 * -0x3361d2af) >> 0x11) *
                          0x1b873593;
      }
      else {
        if (uVar20 == 0) goto LAB_00106531;
        _err_print_error("get_id","./servers/rendering/rendering_device.h",0x3ca,
                         "Condition \"p_idx != 0\" is true. Returning: RID()",0,0);
        uVar14 = 0;
      }
      uVar20 = uVar20 + 1;
      uVar14 = (uVar13 << 0xd | uVar13 >> 0x13) * 5 + 0xe6546b64 ^ uVar14;
      uVar8 = (ulong)((uVar14 << 0xd | uVar14 >> 0x13) * 5 + 0xe6546b64);
      if (uVar20 == uVar6) goto LAB_001063c0;
      lVar12 = *(long *)(param_4 + 4);
    } while( true );
  }
  if ((*(long *)(param_4 + 8) != 0) &&
     (uVar6 = (uint)*(undefined8 *)(*(long *)(param_4 + 8) + -8), uVar6 != 0)) goto LAB_0010651d;
LAB_001063c0:
  lVar18 = local_48;
  lVar12 = local_58;
  uVar6 = ((uint)(uVar8 >> 0x10) ^ (uint)uVar8) * -0x7a143595;
  uVar6 = (uVar6 ^ uVar6 >> 0xd) * -0x3d4d51cb;
  uVar13 = ((int)local_68 * 0x16a88000 | (uint)((int)local_68 * -0x3361d2af) >> 0x11) * 0x1b873593 ^
           uVar6;
  uVar6 = ((uVar6 >> 0x10 ^ uVar13) << 0xd | uVar13 >> 0x13) * 5 + 0xe6546b64 ^
          (local_68._4_4_ * 0x16a88000 | (uint)(local_68._4_4_ * -0x3361d2af) >> 0x11) * 0x1b873593;
  uVar6 = (uVar6 << 0xd | uVar6 >> 0x13) * 5 + 0xe6546b64;
  if (local_58 == 0) {
    if (local_48 != 0) {
      uVar8 = *(ulong *)(local_48 + -8) & 0xffffffff;
      if ((int)*(ulong *)(local_48 + -8) != 0) goto LAB_0010644f;
      uVar6 = (uVar6 >> 0x10 ^ uVar6) * -0x7a143595;
      uVar6 = (uVar6 >> 0xd ^ uVar6) * -0x3d4d51cb;
      uVar8 = (ulong)(uVar6 ^ uVar6 >> 0x10);
      goto LAB_00106656;
    }
    uVar6 = (uVar6 >> 0x10 ^ uVar6) * -0x7a143595;
    uVar6 = (uVar6 ^ uVar6 >> 0xd) * -0x3d4d51cb;
...
LAB_001065c1:
          _err_print_index_error
                    ("get","./core/templates/cowdata.h",0xdb,uVar20,lVar16,"p_index","size()","",
                     false,true);
          _err_flush_stdout();
                    /* WARNING: Does not return */
          pcVar4 = (code *)invalidInstructionException();
        ...
        if (lVar16 <= (long)uVar20) goto LAB_001065c1;
        uVar9 = *(undefined8 *)(lVar18 + uVar20 * 8);
        iVar10 = (int)uVar9;
        iVar11 = (int)((ulong)uVar9 >> 0x20);
        uVar6 = uVar6 ^ (iVar10 * 0x16a88000 | (uint)(iVar10 * -0x3361d2af) >> 0x11) * 0x1b873593;
        uVar13 = (iVar11 * 0x16a88000 | (uint)(iVar11 * -0x3361d2af) >> 0x11) * 0x1b873593;
      }
      else if (uVar20 == 0) {
        uVar6 = uVar6 ^ (iVar15 * 0x16a88000 | (uint)(iVar15 * -0x3361d2af) >> 0x11) * 0x1b873593;
        uVar13 = (iVar7 * 0x16a88000 | (uint)(iVar7 * -0x3361d2af) >> 0x11) * 0x1b873593;
      }
      else {
        _err_print_error("get_id","./servers/rendering/rendering_device.h",0x3ca,
                         "Condition \"p_idx != 0\" is true. Returning: RID()",0,0);
      ...
      uVar20 = uVar20 + 1;
      uVar13 = (uVar6 << 0xd | uVar6 >> 0x13) * 5 + 0xe6546b64 ^ uVar13;
      uVar6 = (uVar13 << 0xd | uVar13 >> 0x13) * 5 + 0xe6546b64;
    } while (uVar20 != uVar8);
    uVar6 = (uVar6 >> 0x10 ^ uVar6) * -0x7a143595;
    uVar6 = (uVar6 ^ uVar6 >> 0xd) * -0x3d4d51cb;
    uVar8 = (ulong)(uVar6 ^ uVar6 >> 0x10);
...
LAB_00106656:
  ...
  iVar7 = (int)(uVar8 * 0xc0091 >> 0x20);
  iVar15 = (int)uVar8;
  uVar6 = iVar15 + (iVar7 + ((uint)(iVar15 - iVar7) >> 1) >> 0xd) * -0x3ffd;
  uVar9 = local_68;
  uVar5 = local_60;
  for (lVar12 = *(long *)(this + (ulong)uVar6 * 8 + 0x1e0); lVar12 != 0;
      lVar12 = *(long *)(lVar12 + 8)) {
    local_68 = *param_5;
    local_60 = *(undefined1 *)(param_5 + 1);
    if ((((*(int *)(lVar12 + 0x10) == iVar15) && (*(int *)(lVar12 + 0x20) == param_3)) &&
        (param_2 == *(long *)(lVar12 + 0x18))) && (*(int *)(lVar12 + 0x30) == 2)) {
      local_58 = param_5[2];
      local_48 = 0;
      if (param_5[4] == 0) {
        piVar17 = *(int **)(lVar12 + 0x38);
        uVar9 = local_68;
        uVar5 = local_60;
        if (piVar17[1] != param_4[1]) goto LAB_001066c8;
LAB_0010675b:
        if (*piVar17 == *param_4) {
          lVar18 = *(long *)(param_4 + 4);
          if (*(long *)(piVar17 + 4) == 0) {
            if (*(long *)(piVar17 + 8) == 0) {
              if (lVar18 == 0) {
                if (*(long *)(param_4 + 8) != 0) {
...
joined_r0x00106f73:
                  if (local_e8 != 0) goto LAB_00106796;
                }
LAB_00106c5a:
                lVar18 = local_58;
                uVar20 = (ulong)*(uint *)(lVar12 + 0x30);
                if (*(uint *)(lVar12 + 0x30) < 2) {
                  lVar12 = 1;
LAB_00106b0d:
                  _err_print_index_error
                            ("operator[]","./core/templates/local_vector.h",0xae,lVar12,uVar20,
                ...
                if ((*(int *)(lVar2 + 0x2c) == local_68._4_4_) &&
                   (*(int *)(lVar2 + 0x28) == (int)local_68)) {
                  uVar13 = 1;
                  if (*(long *)(lVar2 + 0x38) == 0) {
                    if (*(long *)(lVar2 + 0x48) == 0) {
                      ...
                      uVar13 = (uint)*(undefined8 *)(*(long *)(lVar2 + 0x48) + -8);
                    }
                  }
                  uVar14 = 1;
                  if (local_58 == 0) {
                    if (local_48 == 0) {
                      ...
                      uVar14 = (uint)*(undefined8 *)(local_48 + -8);
                    }
                  }
                  if (uVar14 == uVar13) {
                    uVar20 = 0;
                    do {
                      if (uVar13 <= (uint)uVar20) {
                        if (local_48 != 0) {
                          LOCK();
...
LAB_00106fa9:
                          ...
                          if ((long)uVar20 < lVar16) {
                            lVar19 = *(long *)(local_48 + uVar20 * 8);
                            lVar16 = *(long *)(lVar2 + 0x38);
                            if (lVar16 == 0) goto LAB_00106d17;
                            if (uVar20 != 0) goto LAB_00106f0e;
                            goto LAB_00106d35;
                          }
                        }
                        goto LAB_001065c1;
...
LAB_00106d17:
                          ...
                          if (lVar3 == 0) goto LAB_00106fa9;
                          lVar16 = *(long *)(lVar3 + -8);
                          if (lVar16 <= (long)uVar20) goto LAB_001065c1;
                          lVar16 = *(long *)(lVar3 + uVar20 * 8);
                        }
                      }
                      else {
                        _err_print_error("get_id","./servers/rendering/rendering_device.h",0x3ca,
                                         "Condition \"p_idx != 0\" is true. Returning: RID()",0,0);
                        lVar19 = *(long *)(lVar2 + 0x38);
                        if (lVar19 == 0) goto LAB_00106d17;
                        lVar19 = 0;
LAB_00106f0e:
                        _err_print_error("get_id","./servers/rendering/rendering_device.h",0x3ca,
                                         "Condition \"p_idx != 0\" is true. Returning: RID()",0,0);
...
LAB_00106d35:
              ...
              local_e8 = (uint)*(undefined8 *)(*(long *)(piVar17 + 8) + -8);
              if (lVar18 == 0) {
...
LAB_00106b38:
                  ...
                  do {
                    ...
                    if (lVar18 == 0) {
                      ...
                      lVar16 = *(long *)(lVar18 + -8);
                      if (lVar16 <= (long)uVar21) goto LAB_001065c1;
                      lVar18 = *(long *)(lVar18 + uVar21 * 8);
                      lVar16 = *(long *)(piVar17 + 4);
                      if (lVar16 == 0) goto LAB_00106b6e;
                      if (uVar21 != 0) goto LAB_00106bf3;
                    }
                    else if (uVar21 == 0) {
                      lVar16 = *(long *)(piVar17 + 4);
                      uVar20 = 0;
...
LAB_00106bf3:
                    ...
                    uVar21 = uVar21 + 1;
                    if (local_e8 <= (uint)uVar21) goto LAB_00106c5a;
                    lVar18 = *(long *)(param_4 + 4);
                  } while( true );
                }
              }
        ...
        piVar17 = *(int **)(lVar12 + 0x38);
        if (piVar17[1] == param_4[1]) goto LAB_0010675b;
      }
LAB_00106796:
      uVar9 = local_68;
      uVar5 = local_60;
...
LAB_001066c8:
  ...
  if (param_5[4] != 0) {
    local_68 = uVar9;
    local_60 = uVar5;
    CowData<RID>::_ref((CowData *)local_78);
  }
...
LAB_0010699c:
  uVar9 = _allocate_from_uniforms<Vector<RenderingDevice::Uniform>>
                    (this,param_2,param_3,uVar8,uVar6,local_a8);

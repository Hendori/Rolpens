...
/* CompositeLogger::logv(char const*, __va_list_tag*, bool) */

void __thiscall
CompositeLogger::logv(CompositeLogger *this,char *param_1,__va_list_tag *param_2,bool param_3)

{
  ...
  if ((cVar3 != '\0') && (lVar4 = *(long *)(this + 0x10), lVar4 != 0)) {
    lVar5 = 0;
    do {
...
/* StdLogger::logv(char const*, __va_list_tag*, bool) */

void __thiscall StdLogger::logv(StdLogger *this,char *param_1,__va_list_tag *param_2,bool param_3)
...
CompositeLogger::log_error
          (CompositeLogger *this,undefined8 param_1,undefined8 param_2,undefined4 param_3,
          undefined8 param_4,undefined8 param_5,undefined1 param_6,undefined4 param_8)
...
void __thiscall CompositeLogger::~CompositeLogger(CompositeLogger *this)
...
/* RotatedFileLogger::logv(char const*, __va_list_tag*, bool) */

void __thiscall
RotatedFileLogger::logv(RotatedFileLogger *this,char *param_1,__va_list_tag *param_2,bool param_3)
...
/* Logger::should_log(bool) */

undefined1 __thiscall Logger::should_log(Logger *this,bool param_1)
...
/* Logger::set_flush_stdout_on_print(bool) */

void Logger::set_flush_stdout_on_print(bool param_1)
...
/* Logger::logf(char const*, ...) */

void Logger::logf(char *param_1,...)
...
/* Logger::logf_error(char const*, ...) */

void Logger::logf_error(char *param_1,...)
...
void __thiscall
Logger::log_error(Logger *this,undefined8 param_1,undefined8 param_2,uint param_3,char *param_4,
                 char *param_5,undefined8 param_6,uint param_8)
...
/* CompositeLogger::CompositeLogger(Vector<Logger*> const&) */

void __thiscall CompositeLogger::CompositeLogger(CompositeLogger *this,Vector *param_1)
...
/* RotatedFileLogger::clear_old_backups() */

void __thiscall RotatedFileLogger::clear_old_backups(RotatedFileLogger *this)
...
LAB_00100fde:
              ...
              RBSet<String,Comparator<String>,DefaultAllocator>::_insert_rb_fix
                        ((RBSet<String,Comparator<String>,DefaultAllocator> *)&local_58,pEVar5);
            }
          }
        }
LAB_00100c53:
        (**(code **)(*(long *)local_78 + 0x168))((String *)&local_60);
        lVar6 = local_60;
        lVar3 = local_70;
...
LAB_00100ad0:
    (**(code **)(*(long *)local_78 + 0x180))();
    if (((iVar10 + -1 < local_48) && (iVar10 = local_48 - (iVar10 + -1), local_58 != (Element *)0x0)
        ) && (pEVar8 = *(Element **)(local_58 + 0x10), *(Element **)(local_58 + 0x10) != local_50))
    {
      do {
        pEVar5 = pEVar8;
...
LAB_00100b6f:
  ...
  return;
LAB_00100cc0:
  if (local_60 == 0) goto LAB_00100ad0;
  LOCK();
  plVar1 = (long *)(local_60 + -0x10);
  *plVar1 = *plVar1 + -1;
  UNLOCK();
...
void __thiscall RotatedFileLogger::rotate_file(RotatedFileLogger *this)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((*(long *)(this + 0x18) != 0) && (cVar7 = RefCounted::unreference(), cVar7 != '\0')) {
  ...
  *(undefined8 *)(this + 0x18) = 0;
  ...
  if (cVar7 == '\0') {
    ...
    if (local_50 != (Object *)0x0) {
      ...
      if (((local_50 != (Object *)0x0) &&
          (cVar7 = RefCounted::unreference(), pOVar3 = local_50, cVar7 != '\0')) &&
    ...
    if (local_48 != (Object *)0x0) {
      ...
      if ((int)uVar4 == 0) {
        ...
        *(long *)pOVar9 = *(long *)pOVar9 + -1;
        ...
        if ((int)uVar4 != 1) {
          String::get_extension();
          operator+((char *)&local_48,(String *)&_LC20);
          String::operator+=((String *)&local_58,(String *)&local_48);
          pOVar3 = local_48;
          if (local_48 != (Object *)0x0) {
            LOCK();
  ...
  FileAccess::open((String *)&local_48,(int)pSVar1,(Error *)0x2);
  pOVar3 = *(Object **)(this + 0x18);
  pOVar9 = pOVar3;
  if (local_48 != pOVar3) {
...
LAB_001011b6:
  if (((pOVar9 != (Object *)0x0) &&
      (cVar7 = RefCounted::unreference(), pOVar3 = local_48, cVar7 != '\0')) &&
...
/* RotatedFileLogger::RotatedFileLogger(String const&, int) */

void __thiscall
RotatedFileLogger::RotatedFileLogger(RotatedFileLogger *this,String *param_1,int param_2)
...
/* CompositeLogger::add_logger(Logger*) */

void __thiscall CompositeLogger::add_logger(CompositeLogger *this,Logger *param_1)
...
void __thiscall StdLogger::~StdLogger(StdLogger *this)
...
void __thiscall RotatedFileLogger::~RotatedFileLogger(RotatedFileLogger *this)

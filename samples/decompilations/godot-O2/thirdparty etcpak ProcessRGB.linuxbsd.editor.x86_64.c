...
/* (anonymous namespace)::compressBlockTH(unsigned char*, Luma&, unsigned int&, unsigned int&,
   bool&) [clone .constprop.0] */

uint (anonymous_namespace)::compressBlockTH
               (uchar *param_1,Luma *param_2,uint *param_3,uint *param_4,bool *param_5)

{
  ...
  do {
    lVar41 = lVar48 + 5;
    uVar33 = (((ushort)(byte)compressBlockTH(unsigned_char*,Luma&,unsigned_int&,unsigned_int&,bool&)
                             ::diffBonus[lVar48] + ((ushort)(byte)LVar4 - (ushort)(byte)LVar5)) -
             (ushort)(byte)param_2[lVar41]) + uVar33;
    if (uVar33 < uVar16) {
      uVar17 = (uint)lVar48;
      uVar16 = uVar33;
    }
...
LAB_001006eb:
      ...
      uVar24 = (int)((((((((((((uint)uVar16 - (uint)uVar64) + (uint)uVar33) - (uint)uVar66) +
                           (uint)uVar6) - (uint)uVar67) + (uint)bVar58) - (uint)uVar7) +
                       (uint)bVar54) - (uint)uVar8) + (uint)bVar28) - (uint)uVar9) / 0xc;
      uVar23 = (uint)((local_158 + 8) / 0x11);
      uVar22 = (uint)((local_160 + 8) / 0x11);
      if (((0x10 < uVar24) && (uVar34 = 1, 0x17 < uVar24)) && (uVar34 = 2, 0x20 < uVar24)) {
...
LAB_001007c6:
    ...
    uVar36 = (int)(((((uint)uVar33 + ((uint)uVar16 - (uint)uVar64)) - (uint)uVar66) + (uint)uVar6) -
                  (uint)uVar67) / 6;
    if (0x10 < uVar36) {
    ...
    uVar34 = 0;
    uVar36 = (int)(((((uint)bVar54 + ((uint)bVar58 - (uint)uVar7)) - (uint)uVar8) + (uint)bVar28) -
                  (uint)uVar9) / 6;
    if ((0x10 < uVar36) && (uVar34 = 1, 0x17 < uVar36)) {
LAB_0010069f:
      uVar24 = uVar52;
      uVar34 = 2;
      if (0x20 < uVar36) {
...
joined_r0x0010047d:
  ...
  *param_3 = 0;
  ...
  do {
    ...
    uVar22 = 0;
    local_98 = (((((((ulong)(uVar14 & 0xff) << 8 | (ulong)(uVar25 & 0xff)) << 8 | (ulong)bVar46) <<
                   8 | (ulong)bVar42) << 8 | (ulong)bVar55) << 8 | (ulong)bVar31) << 8 |
               (ulong)bVar29) << 8 | (ulong)bVar50;
  ...
  if (bVar11) {
    uVar17 = uVar36 << 0x17 | uVar24 << 0x13 | uVar52 << 0xf | uVar17 << 0xb | uVar18 << 7 |
             uVar23 * 8 | local_13c & 7;
  }
  else {
    uVar22 = uVar36;
    uVar14 = uVar24;
    uVar34 = uVar52;
    uVar25 = (uint)bVar60;
    if (uVar17 * 0x100 + uVar18 * 0x10 + uVar23 <=
        (uint)local_f6 + uVar24 * 0x10 + (uint)bVar54 * 0x100 != (bool)((byte)local_13c & 1)) {
    ...
    uVar17 = uVar22 << 0x16 | uVar14 << 0x12 | (byte)local_13c >> 1 & 3 | uVar34 << 0xe |
             uVar17 << 10 | uVar18 << 6 | uVar25 << 2;
  }
  lVar48 = 0xc;
  iVar51 = 8;
  *param_3 = uVar17;
  ...
  do {
    ...
    do {
      ...
      lVar41 = lVar41 + 4;
      iVar26 = iVar61 + 1;
      uVar17 = uVar17 | *(int *)pbVar40 << ((byte)iVar61 + 0x10 & 0x1f) |
                        *piVar2 << ((byte)iVar61 & 0x1f);
    } while (iVar26 != iVar51);
    iVar51 = iVar61 + 5;
    lVar48 = lVar48 + 0x10;
  } while (iVar26 != 0x10);
...
/* CompressEtc1Rgb(unsigned int const*, unsigned long*, unsigned int, unsigned long) */

void CompressEtc1Rgb(uint *param_1,ulong *param_2,uint param_3,ulong param_4)
...
LAB_00100fa0:
  if (*puVar68 == local_248) goto code_r0x00100faf;
  iVar64 = 0;
  iVar70 = 0;
  ...
  while( true ) {
    ...
    *(uint *)(local_258 + uVar62 * 4) = (uint)*(byte *)((long)puVar68 + -2) + iVar64;
    ...
    do {
      ...
      *(uint *)(local_258 + lVar56 * 4) =
           *(int *)(local_258 + lVar56 * 4) + (uint)*(byte *)((long)puVar65 + 2);
      puVar65 = puVar65 + 1;
      iVar55 = iVar70;
    } while (iVar70 != 4);
    uVar67 = uVar67 + 1;
  ...
  uVar46 = (undefined2)
           ((uint)*(undefined4 *)(&g_avg2 + (long)(iVar81 + (iVar81 >> 8) >> 8) * 4) >> 0x10);
  ...
  uVar44 = (undefined2)
           ((uint)*(undefined4 *)(&g_avg2 + (long)(iVar64 + (iVar64 >> 8) >> 8) * 4) >> 0x10);
  ...
  puVar68 = &uStack_244;
  while( true ) {
    *(ulong *)(piVar66 + (ulong)(uVar75 & 2) * 4) =
         CONCAT44((uint)*(byte *)((long)puVar68 + -3) + iVar64,(uint)(byte)puVar68[-1] + iVar70);
    *(uint *)(local_148 + (ulong)(uVar75 & 2) * 0x10 + 8) =
         iVar55 + (uint)*(byte *)((long)puVar68 + -2);
    puVar65 = puVar68;
    iVar55 = 1;
    do {
      iVar70 = iVar55 + 1;
      ...
      *(ulong *)(piVar66 + lVar56 * 4) =
           CONCAT44((int)((ulong)uVar77 >> 0x20) + (uint)*(byte *)((long)puVar65 + 1),
                    (int)uVar77 + (uint)(byte)*puVar65);
  ...
  while( true ) {
    ...
    *(uint *)(local_268 + lVar56) =
         ((0x3fffffff - ((uint)uVar3 * iVar81 * 2 + (uint)uVar53 * iVar64 * 2)) -
         (uint)uVar4 * iVar83 * 2) +
         ((uint)(ushort)(uVar53 * uVar53) +
         (uint)(ushort)(uVar4 * uVar4) + (uint)(ushort)(uVar3 * uVar3)) * 8 + iVar55;
    uVar53 = (ushort)puVar68[8];
    *(uint *)(local_268 + lVar56 + 8) =
         ((((*(int *)(local_268 + lVar56 + 8) - (uint)uVar6 * iVar64 * 2) + 0x3fffffff) -
          (uint)uVar5 * iVar81 * 2) - (uint)uVar53 * iVar83 * 2) +
         ((uint)(ushort)(uVar53 * uVar53) + (uint)(ushort)(uVar5 * uVar5) +
         ((uint)uVar6 * (uint)uVar6 & 0xffff)) * 8;
    if (iVar70 == 4) break;
  ...
  if ((uVar62 & 2) == 0) {
    do {
      ...
      uVar60 = uVar60 + 2;
      uVar76 = uVar76 | (ulong)(*(ushort *)((long)&local_208 + lVar57) >> 4) << (bVar13 + 4 & 0x3f)
                        | (ulong)(*(ushort *)((long)auStack_210 + lVar72 + 0x210) >> 4) <<
                          (bVar13 & 0x3f);
    } while (uVar60 != 6);
  }
  else {
    ...
    do {
      ...
      cVar12 = (char)lVar57;
      lVar57 = lVar57 + 2;
      uVar76 = uVar76 | (ulong)((int)((*(ushort *)((long)auStack_210 + lVar72 + 0x210) & 0xf8) -
                                     (uVar53 & 0xf8)) >> 3 & 7U | uVar53 & 0xf8) <<
                        (cVar12 * '\x04' & 0x3fU);
    } while (lVar57 != 6);
  }
  piVar58 = (int *)local_1c8;
  ...
  do {
    ...
    lVar57 = 0;
    lVar56 = (long)(int)(((uint)*(ushort *)((long)&local_208 + uVar60 * 8 + 2) -
                         (uint)*(byte *)((long)puVar68 + 1)) * 0x97 +
                         ((uint)(ushort)(&local_208)[uVar60 * 2] -
                         (uint)*(byte *)((long)puVar68 + 2)) * 0x4d +
                        ((uint)(&uStack_204)[uVar60 * 4] - (uint)(byte)*puVar68) * 0x1c);
    do {
      uVar69 = 1;
      uVar60 = 0;
  ...
  do {
    ...
    uVar53 = *(ushort *)
              ((long)piVar66 +
              *(long *)(local_258 +
                       (ulong)(*(uint *)((long)(&g_id + uVar62 * 0x40) + lVar57 * 4) & 1) * 8) * 2);
    piVar66 = piVar66 + 4;
    lVar57 = lVar57 + 1;
    uVar60 = uVar60 | (ulong)(uVar53 & 1) << (cVar12 + 0x20U & 0x3f) |
                      (ulong)(uVar53 & 2) << (cVar12 + 0x2fU & 0x3f);
  } while (lVar57 != 0x10);
  uVar62 = (uVar60 & 0xff0000000000) << 8 |
           uVar60 >> 0x18 & 0xff00000000 | (uVar60 & 0xff00000000) << 0x18 | uVar60 & 0xffffffff |
           uVar60 >> 8 & 0xff0000000000;
  goto LAB_00100ff0;
code_r0x00100faf:
  puVar68 = puVar68 + 1;
  ...
  goto LAB_00100fa0;
code_r0x00100fb8:
  uVar62 = (ulong)((local_248 & 0xf8) << 0x10 | (local_248 >> 8 & 0xf8) << 8 |
                   local_248 >> 0x10 & 0xf8 | 0x2000000);
LAB_00100ff0:
  puVar2 = local_2b8 + 1;
  *local_2b8 = uVar62;
  param_1 = local_2b0;
...
/* CompressEtc1RgbDither(unsigned int const*, unsigned long*, unsigned int, unsigned long) */

void CompressEtc1RgbDither(uint *param_1,ulong *param_2,uint param_3,ulong param_4)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* CompressEtc2Rgb(unsigned int const*, unsigned long*, unsigned int, unsigned long, bool) */

void CompressEtc2Rgb(uint *param_1,ulong *param_2,uint param_3,ulong param_4,bool param_5)
...
LAB_00101d90:
  if (*(int *)puVar238 == CONCAT13(bStack_245,CONCAT12(bStack_246,CONCAT11(bStack_247,local_248))))
  goto code_r0x00101d9f;
  _local_268 = 0xff00;
  cVar253 = param_5;
  ...
  puVar238 = (ushort *)&local_248;
  do {
    uVar249 = (uint)*(byte *)((long)puVar238 + 1) * 0x96 + (uint)(byte)puVar238[1] * 0x4c +
              (uint)(byte)*puVar238 * 0x1c >> 1;
...
LAB_00101e41:
  ...
  uVar348 = CONCAT13(cVar3,CONCAT12((0 < sVar384) * (sVar384 < 0x100) * auVar356[4] -
                                    (0xff < sVar384),
                                    CONCAT11(bVar223,(0 < sVar346) * (sVar346 < 0x100) * auVar356[0]
                                                     - (0xff < sVar346))));
  sVar346 = auVar356._8_2_;
  sVar384 = auVar356._10_2_;
  cVar271 = (0 < sVar384) * (sVar384 < 0x100) * auVar356[10] - (0xff < sVar384);
  uVar351 = CONCAT15(cVar271,CONCAT14((0 < sVar346) * (sVar346 < 0x100) * auVar356[8] -
                                      (0xff < sVar346),uVar348));
  sVar346 = auVar356._12_2_;
  sVar384 = auVar356._14_2_;
  cVar4 = (0 < sVar384) * (sVar384 < 0x100) * auVar356[0xe] - (0xff < sVar384);
  uVar352 = CONCAT17(cVar4,CONCAT16((0 < sVar346) * (sVar346 < 0x100) * auVar356[0xc] -
                                    (0xff < sVar346),uVar351));
  sVar346 = auVar299._0_2_;
  sVar384 = auVar299._2_2_;
  cVar5 = (0 < sVar384) * (sVar384 < 0x100) * auVar299[2] - (0xff < sVar384);
  auVar353._0_10_ =
       CONCAT19(cVar5,CONCAT18((0 < sVar346) * (sVar346 < 0x100) * auVar299[0] - (0xff < sVar346),
                               uVar352));
  ...
  uVar287 = CONCAT13(cVar9,CONCAT12((0 < sVar384) * (sVar384 < 0x100) * auVar356[4] -
                                    (0xff < sVar384),
                                    CONCAT11(bVar8,(0 < sVar346) * (sVar346 < 0x100) * auVar356[0] -
                                                   (0xff < sVar346))));
  sVar346 = auVar356._8_2_;
  sVar384 = auVar356._10_2_;
  cVar10 = (0 < sVar384) * (sVar384 < 0x100) * auVar356[10] - (0xff < sVar384);
  uVar295 = CONCAT15(cVar10,CONCAT14((0 < sVar346) * (sVar346 < 0x100) * auVar356[8] -
                                     (0xff < sVar346),uVar287));
  sVar346 = auVar356._12_2_;
  sVar384 = auVar356._14_2_;
  cVar11 = (0 < sVar384) * (sVar384 < 0x100) * auVar356[0xe] - (0xff < sVar384);
  uVar296 = CONCAT17(cVar11,CONCAT16((0 < sVar346) * (sVar346 < 0x100) * auVar356[0xc] -
                                     (0xff < sVar346),uVar295));
  sVar346 = auVar328._0_2_;
  sVar384 = auVar328._2_2_;
  cVar12 = (0 < sVar384) * (sVar384 < 0x100) * auVar328[2] - (0xff < sVar384);
  auVar297._0_10_ =
       CONCAT19(cVar12,CONCAT18((0 < sVar346) * (sVar346 < 0x100) * auVar328[0] - (0xff < sVar346),
                                uVar296));
  ...
  uVar208 = CONCAT26(auVar79._13_2_,
                     CONCAT15((0 < sVar66) * (sVar66 < 0x100) * auVar356[0xc] - (0xff < sVar66),
                              uVar201));
  auVar203._4_8_ = 0;
  ...
  uVar352 = CONCAT44(uVar248,CONCAT13((0 < sVar62) * (sVar62 < 0x100) * auVar356[10] -
                                      (0xff < sVar62),uVar181));
  auVar118._10_5_ = (int5)((ulong)uVar352 >> 0x18);
  auVar118._0_10_ = (unkuint10)CONCAT11(bVar17,cVar16) << 0x38;
  uVar296 = CONCAT62(auVar118._9_6_,
                     CONCAT11((0 < sVar58) * (sVar58 < 0x100) * auVar356[8] - (0xff < sVar58),cVar16
                             ));
  auVar127._7_8_ = 0;
  auVar127._0_7_ = (uint7)((ulong)uVar296 >> 8);
  Var128 = CONCAT81(SUB158(auVar127 << 0x40,7),
                    (0 < sVar54) * (sVar54 < 0x100) * auVar356[6] - (0xff < sVar54));
  auVar183._9_6_ = 0;
  ...
  uVar210 = CONCAT26(auVar80._13_2_,
                     CONCAT15((0 < sVar66) * (sVar66 < 0x100) * auVar393[0xc] - (0xff < sVar66),
                              uVar201));
  auVar204._4_8_ = 0;
  ...
  uVar352 = CONCAT44(uVar276,CONCAT13((0 < sVar62) * (sVar62 < 0x100) * auVar393[10] -
                                      (0xff < sVar62),uVar181));
  auVar119._10_5_ = (int5)((ulong)uVar352 >> 0x18);
  auVar119._0_10_ = (unkuint10)CONCAT11(bVar32,cVar9) << 0x38;
  uVar296 = CONCAT62(auVar119._9_6_,
                     CONCAT11((0 < sVar58) * (sVar58 < 0x100) * auVar393[8] - (0xff < sVar58),cVar9)
                    );
  auVar132._7_8_ = 0;
  auVar132._0_7_ = (uint7)((ulong)uVar296 >> 8);
  Var128 = CONCAT81(SUB158(auVar132 << 0x40,7),
                    (0 < sVar54) * (sVar54 < 0x100) * auVar393[6] - (0xff < sVar54));
  auVar185._9_6_ = 0;
  ...
  uVar215 = CONCAT26(auVar81._13_2_,
                     CONCAT15((uVar387 != 0) * (uVar387 < 0x100) * cVar7 - (0xff < uVar387),uVar202)
                    );
  auVar205._4_8_ = 0;
  ...
  uVar352 = CONCAT44(uVar249,CONCAT13((uVar386 != 0) * (uVar386 < 0x100) * cVar6 - (0xff < uVar386),
                                      uVar182));
  auVar120._10_5_ = (int5)((ulong)uVar352 >> 0x18);
  auVar120._0_10_ = (unkuint10)CONCAT11(bVar25,cVar274) << 0x38;
  uVar296 = CONCAT62(auVar120._9_6_,
                     CONCAT11((uVar385 != 0) * (uVar385 < 0x100) * cVar5 - (0xff < uVar385),cVar274)
                    );
  auVar136._7_8_ = 0;
  auVar136._0_7_ = (uint7)((ulong)uVar296 >> 8);
  Var137 = CONCAT81(SUB158(auVar136 << 0x40,7),
                    (uVar383 != 0) * (uVar383 < 0x100) * cVar4 - (0xff < uVar383));
  auVar187._9_6_ = 0;
  ...
  iVar349 = (auVar126._0_4_ & 0xffff) + (uint)uVar321 + (uVar261 & 0xffff) + (uint)bVar28 +
            (int)uVar222 + (uVar249 >> 8 & 0xffff) + auVar115._8_4_ + (uint)bVar30 +
            auVar113._4_4_ + (uint)uVar322 + auVar116._4_4_ + (uint)bVar29 +
            (auVar83._10_4_ >> 0x10) + (uVar249 >> 0x18) + (uint)(uint3)(auVar114._10_3_ >> 0x10) +
            (uint)bVar31;
  iVar324 = (auVar125._0_4_ & 0xffff) + (uint)uVar323 + (uVar236 & 0xffff) + (uint)bVar36 +
            (int)uVar221 + (uVar276 >> 8 & 0xffff) + auVar111._8_4_ + (uint)bVar38 +
            auVar109._4_4_ + (uint)uVar388 + auVar112._4_4_ + (uint)bVar37 +
            (auVar82._10_4_ >> 0x10) + (uVar276 >> 0x18) + (uint)(uint3)(auVar110._10_3_ >> 0x10) +
            (uint)bVar39;
  iVar288 = (uint)uVar286 + (uint)uVar318 + (uVar267 & 0xffff) + (uint)bVar21 +
            (int)uVar220 + (uVar248 >> 8 & 0xffff) + auVar107._8_4_ + (uint)bVar23 +
            (int)CONCAT82(SUB148(auVar131 << 0x40,6),auVar130._0_2_) + (uint)uVar320 +
            auVar108._4_4_ + (uint)bVar22 +
            (auVar92._10_4_ >> 0x10) + (uVar248 >> 0x18) + (uint)(uint3)(auVar106._10_3_ >> 0x10) +
            (uint)bVar24;
  ...
  if (cVar253 != '\0') {
    ...
    uVar215 = CONCAT26(auVar84._13_2_,
                       CONCAT15((0 < sVar68) * (sVar68 < 0x100) * auVar341[0xc] - (0xff < sVar68),
                                uVar202));
    auVar207._4_8_ = 0;
    auVar207._0_4_ = uVar263;
    auVar102._12_3_ = (int3)((ulong)uVar215 >> 0x28);
    auVar102._0_12_ = auVar207 << 0x38;
    uVar208 = CONCAT44(auVar102._11_4_,
                       CONCAT13((0 < sVar64) * (sVar64 < 0x100) * auVar341[10] - (0xff < sVar64),
                                uVar182));
    auVar121._10_5_ = (int5)((ulong)uVar208 >> 0x18);
    auVar121._0_10_ = (unkuint10)uVar381 << 0x38;
    uVar296 = CONCAT62(auVar121._9_6_,
                       CONCAT11((0 < sVar60) * (sVar60 < 0x100) * auVar341[8] - (0xff < sVar60),
                                cVar271));
    auVar156._7_8_ = 0;
    auVar156._0_7_ = (uint7)((ulong)uVar296 >> 8);
    Var128 = CONCAT81(SUB158(auVar156 << 0x40,7),
                      (0 < sVar56) * (sVar56 < 0x100) * auVar341[6] - (0xff < sVar56));
    auVar190._9_6_ = 0;
    ...
    uVar218 = CONCAT26(auVar85._13_2_,
                       CONCAT15((0 < sVar67) * (sVar67 < 0x100) * auVar311[0xc] - (0xff < sVar67),
                                uVar201));
    auVar209._4_8_ = 0;
    auVar209._0_4_ = uVar262;
    auVar103._12_3_ = (int3)((ulong)uVar218 >> 0x28);
    auVar103._0_12_ = auVar209 << 0x38;
    uVar210 = CONCAT44(auVar103._11_4_,
                       CONCAT13((0 < sVar63) * (sVar63 < 0x100) * auVar311[10] - (0xff < sVar63),
                                uVar181));
    auVar122._10_5_ = (int5)((ulong)uVar210 >> 0x18);
    auVar122._0_10_ = (unkuint10)uVar347 << 0x38;
    uVar352 = CONCAT62(auVar122._9_6_,
                       CONCAT11((0 < sVar59) * (sVar59 < 0x100) * auVar311[8] - (0xff < sVar59),
                                cVar253));
    auVar159._7_8_ = 0;
    auVar159._0_7_ = (uint7)((ulong)uVar352 >> 8);
    Var137 = CONCAT81(SUB158(auVar159 << 0x40,7),
                      (0 < sVar55) * (sVar55 < 0x100) * auVar311[6] - (0xff < sVar55));
    auVar192._9_6_ = 0;
    ...
    auVar394._10_2_ =
         uStack_2de - (byte)((0 < sVar72) * (sVar72 < 0x100) * auVar471[10] - (0xff < sVar72));
    auVar394._12_2_ =
         uStack_2dc - (byte)((0 < sVar74) * (sVar74 < 0x100) * auVar471[0xc] - (0xff < sVar74));
    auVar394._14_2_ =
         uStack_2da - (byte)((0 < sVar77) * (sVar77 < 0x100) * auVar471[0xe] - (0xff < sVar77));
    auVar500._0_2_ =
         uVar317 - (byte)((0 < sVar53) * (sVar53 < 0x100) * auVar311[0] - (0xff < sVar53));
    ...
    auVar502._0_2_ =
         uVar316 - (byte)((0 < sVar54) * (sVar54 < 0x100) * auVar341[0] - (0xff < sVar54));
    ...
    auVar395._10_2_ =
         uStack_2fe - (byte)((0 < sVar71) * (sVar71 < 0x100) * auVar458[10] - (0xff < sVar71));
    auVar395._12_2_ =
         uStack_2fc - (byte)((0 < sVar73) * (sVar73 < 0x100) * auVar458[0xc] - (0xff < sVar73));
    auVar395._14_2_ =
         uStack_2fa - (byte)((0 < sVar76) * (sVar76 < 0x100) * auVar458[0xe] - (0xff < sVar76));
    auVar299 = psllw(auVar475,2);
    auVar443 = psllw(auVar395,2);
    auVar219._6_8_ = 0;
    auVar86[0xe] = cVar274;
    auVar86._0_14_ = auVar219 << 0x38;
    uVar208 = CONCAT26(auVar86._13_2_,
                       CONCAT15((0 < sVar69) * (sVar69 < 0x100) * auVar494[0xc] - (0xff < sVar69),
                                uVar206));
    auVar211._4_8_ = 0;
    auVar211._0_4_ = uVar264;
    auVar104._12_3_ = (int3)((ulong)uVar208 >> 0x28);
    auVar104._0_12_ = auVar211 << 0x38;
    uVar352 = CONCAT44(auVar104._11_4_,
                       CONCAT13((0 < sVar65) * (sVar65 < 0x100) * auVar494[10] - (0xff < sVar65),
                                uVar189));
    auVar123._10_5_ = (int5)((ulong)uVar352 >> 0x18);
    auVar123._0_10_ = (unkuint10)uVar382 << 0x38;
    uVar296 = CONCAT62(auVar123._9_6_,
                       CONCAT11((0 < sVar61) * (sVar61 < 0x100) * auVar494[8] - (0xff < sVar61),
                                cVar274));
    auVar162._7_8_ = 0;
    auVar162._0_7_ = (uint7)((ulong)uVar296 >> 8);
    Var128 = CONCAT81(SUB158(auVar162 << 0x40,7),
                      (0 < sVar57) * (sVar57 < 0x100) * auVar494[6] - (0xff < sVar57));
    auVar194._9_6_ = 0;
    ...
    auVar503._0_2_ =
         uVar286 - (byte)((0 < sVar58) * (sVar58 < 0x100) * auVar494[0] - (0xff < sVar58));
    ...
    auVar344._10_2_ =
         uStack_30e - (byte)((0 < sVar70) * (sVar70 < 0x100) * auVar431[10] - (0xff < sVar70));
    auVar344._12_2_ =
         uStack_30c - (byte)((0 < sVar75) * (sVar75 < 0x100) * auVar431[0xc] - (0xff < sVar75));
    auVar344._14_2_ =
         uStack_30a - (byte)((0 < sVar78) * (sVar78 < 0x100) * auVar431[0xe] - (0xff < sVar78));
    ...
    Var196 = CONCAT64(CONCAT42(uVar287,auVar328._4_2_),
                      CONCAT22(auVar476._4_2_ * auVar476._4_2_,auVar476._6_2_ * auVar476._6_2_));
    ...
    Var196 = CONCAT64(CONCAT42(uVar348,auVar443._4_2_),
                      CONCAT22(auVar314._4_2_ * auVar314._4_2_,auVar314._6_2_ * auVar314._6_2_));
    ...
    local_398 = CONCAT44(-(uint)(auVar328._0_2_ < 0),auVar345._0_4_) + auVar501._0_8_ +
                CONCAT44(-(uint)(auVar328._8_2_ < 0),uVar390) + auVar498._0_8_ +
                CONCAT44(-(uint)(auVar443._0_2_ < 0),uVar524) + auVar398._0_8_ +
                CONCAT44(-(uint)(auVar443._8_2_ < 0),uVar350) + auVar399._0_8_ +
                auVar315._8_8_ + auVar501._8_8_ + auVar397._8_8_ + auVar498._8_8_ +
                auVar433._8_8_ + auVar398._8_8_ + auVar361._8_8_ + auVar399._8_8_;
  }
  puVar270 = (uint *)(ulong)uVar268;
  uVar276 = uVar276 << 0x19 |
            *(uint *)(&g_flags +
                     (long)(int)((int)uVar236 >> 1 & 0xfU | (int)uVar272 >> 1 & 0x10U |
                                uVar248 & 0x20) * 4) |
            (uVar249 & 0x40) << 0x12 | uVar273 * 2 & 0x7c | uVar267 & 1 | (uVar261 & 7) << 7 |
            (uVar261 & 0x18) << 8 | (uVar261 & 0x20) << 0xb | (uVar249 & 0x3f) << 0x11 | 2;
  uVar249 = (uVar279 << 6 | uVar256) << 0x13;
  uVar248 = uVar259 << 6 | uVar281 << 0xd;
  uVar237 = uVar248 | uVar237;
  uVar239 = CONCAT44(uVar249 >> 0x18 | ((uVar237 | uVar249) & 0xff0000) >> 8 |
                     (uVar248 & 0xff00) << 8 | uVar237 << 0x18,
                     uVar276 >> 0x18 | (uVar276 & 0xff0000) >> 8 | (uVar276 & 0xff00) << 8 |
                     uVar276 << 0x18);
  auVar443 = __LC6;
  if (local_398 != 0) {
    iVar234 = 0;
    ...
    while( true ) {
      ...
      *(uint *)(local_278 + uVar240 * 4) = (uint)(byte)puVar238[-1] + iVar255;
      ...
      do {
        ...
        *(uint *)(local_148 + lVar241 * 4) =
             *(int *)(local_148 + lVar241 * 4) + (uint)(byte)*puVar250;
        local_1b8[lVar241 + -4] = local_1b8[lVar241 + -4] + (uint)*(byte *)((long)puVar250 + 1);
        *(uint *)(local_278 + lVar241 * 4) =
             *(int *)(local_278 + lVar241 * 4) + (uint)(byte)puVar250[1];
        puVar250 = puVar250 + 2;
        iVar234 = iVar235;
      } while (iVar235 != 4);
      uVar248 = uVar248 + 1;
    ...
    uVar226 = (undefined2)
              ((uint)*(undefined4 *)(&g_avg2 + (long)((iVar234 >> 8) + iVar234 >> 8) * 4) >> 0x10);
    ...
    uVar224 = (undefined2)
              ((uint)*(undefined4 *)(&g_avg2 + (long)((iVar275 >> 8) + iVar275 >> 8) * 4) >> 0x10);
    ...
    puVar238 = (ushort *)auStack_244;
    while( true ) {
      *(ulong *)(piVar257 + (ulong)(uVar276 & 2) * 4) =
           CONCAT44((uint)*(byte *)((long)puVar238 + -3) + iVar255,
                    (uint)(byte)puVar238[-2] + iVar235);
      *(uint *)(local_148 + (ulong)(uVar276 & 2) * 0x10 + 8) = iVar234 + (uint)(byte)puVar238[-1];
      ...
      do {
        ...
        *(ulong *)(piVar257 + lVar241 * 4) =
             CONCAT44((int)((ulong)uVar296 >> 0x20) + (uint)*(byte *)((long)puVar250 + 1),
                      (int)uVar296 + (uint)(byte)*puVar250);
    ...
    while( true ) {
      ...
      *(uint *)(local_288 + lVar241) =
           ((0x3fffffff - ((uint)uVar316 * iVar258 * 2 + (uint)uVar286 * iVar255 * 2)) -
           (uint)uVar317 * iVar275 * 2) +
           ((uint)(ushort)(uVar286 * uVar286) +
           (uint)(ushort)(uVar317 * uVar317) + (uint)(ushort)(uVar316 * uVar316)) * 8 + iVar234;
      uVar286 = puVar238[0x10];
      *(uint *)(local_288 + lVar241 + 8) =
           ((((*(int *)(local_288 + lVar241 + 8) - (uint)uVar318 * iVar255 * 2) + 0x3fffffff) -
            (uint)uVar320 * iVar258 * 2) - (uint)uVar286 * iVar275 * 2) +
           ((uint)(ushort)(uVar286 * uVar286) + (uint)(ushort)(uVar320 * uVar320) +
           ((uint)uVar318 * (uint)uVar318 & 0xffff)) * 8;
      if (iVar278 == 4) break;
    ...
    if ((uVar240 & 2) == 0) {
      do {
        ...
        uVar245 = uVar245 + 2;
        uVar283 = uVar283 | (ulong)(*(ushort *)((long)local_208 + lVar242) >> 4) <<
                            (bVar223 + 4 & 0x3f) |
                            (ulong)(*(ushort *)(local_218 + lVar269 + 0x218) >> 4) <<
                            (bVar223 & 0x3f);
      } while (uVar245 != 6);
    }
    else {
      ...
      do {
        ...
        lVar242 = lVar242 + 2;
        uVar283 = uVar283 | (ulong)((int)((*(ushort *)(local_218 + lVar269 + 0x218) & 0xf8) -
                                         (uVar248 & 0xf8)) >> 3 & 7U | uVar248 & 0xf8) <<
                            (cVar253 * '\x04' & 0x3fU);
      } while (lVar242 != 6);
    }
    piVar243 = (int *)local_1c8;
    ...
    do {
      ...
      lVar241 = 0;
      lVar242 = (long)(int)(((uint)local_208[uVar245 * 4] - (uint)(byte)puVar238[1]) * 0x4d +
                            ((uint)local_208[uVar245 * 4 + 1] - (uint)*(byte *)((long)puVar238 + 1))
                            * 0x97 + ((uint)local_208[uVar245 * 4 + 2] - (uint)(byte)*puVar238) *
                                     0x1c);
      do {
        uVar252 = 1;
        uVar245 = 0;
    ...
    if (param_5) {
      ...
      if (local_2ac == '\x02') {
        local_289 = false;
        uVar248 = (anonymous_namespace)::compressBlockTH
                            (&local_248,(Luma *)local_268,(uint *)local_278,(uint *)(local_278 + 4),
                             &local_289);
        ...
        if (local_289 == false) {
          ...
          uVar248 = (uVar248 & uVar273 << 0x14) >> 0x14 |
                    (uVar261 & ((uVar272 & uVar267 << 0x13) >> 0x13) << 0x10 & (uVar273 ^ 1) << 0x10
                    | uVar276) >> 0x10;
          uVar248 = (uVar249 >> 0x1e ^ 1) << 0x1f |
                    uVar261 | uVar249 | uVar272 | local_278._0_4_ & 1 | (-uVar248 & 7) << 0x15 |
                    (uVar248 ^ 1) << 0x12;
        }
        else {
          ...
          uVar276 = uVar248 & 0xe7ffffff & ((uVar249 & uVar261 << 0x1b) >> 0x1b) << 0x18 &
                    (uVar272 ^ 1) << 0x18;
          uVar236 = uVar276 >> 0x18;
          uVar276 = (uVar248 & 0x2000000 & uVar272 << 0x19) >> 0x19 |
                    (uVar248 & 0xe7ffffff & ((uVar249 & uVar272 << 0x1b) >> 0x1b) << 0x18 &
                     (uVar261 ^ 1) << 0x18 | uVar276) >> 0x18;
          uVar248 = uVar248 & 0x3ffffff | local_278._0_4_ & 1 | uVar249 | uVar276 * -0x20000000 |
                    (uVar276 ^ 1) << 0x1a;
        }
        puVar270 = (uint *)(ulong)uVar236;
        uVar239 = CONCAT44((uint)local_278._4_4_ >> 0x18 | (local_278._4_4_ & 0xff0000) >> 8 |
                           (local_278._4_4_ & 0xff00) << 8 | local_278._4_4_ << 0x18,
                           uVar248 >> 0x18 | (uVar248 & 0xff0000) >> 8 | (uVar248 & 0xff00) << 8 |
                           (uVar248 | 2) << 0x18);
      }
    }
    local_278._0_8_ = 0;
    lVar241 = 1;
    do {
      if (*(ulong *)((long)local_1c8 + lVar241 * 2 * 4) <
          *(ulong *)(local_1c8 + local_278._0_8_ * 8)) {
    ...
    if (auStack_188[local_278._8_8_] + *(long *)(local_1c8 + local_278._0_8_ * 8) < local_398) {
      ...
      do {
        ...
        uVar286 = *(ushort *)
                   ((long)piVar257 +
                   *(long *)(local_278 +
                            (ulong)(*(uint *)((long)(&g_id + uVar240 * 0x40) + lVar241 * 4) & 1) * 8
                            ) * 2);
        piVar257 = piVar257 + 4;
        lVar241 = lVar241 + 1;
        puVar270 = (uint *)((ulong)puVar270 |
                           (ulong)(uVar286 & 1) << (cVar253 + 0x20U & 0x3f) |
                           (ulong)(uVar286 & 2) << (cVar253 + 0x2fU & 0x3f));
      } while (lVar241 != 0x10);
      uVar239 = (ulong)puVar270 >> 0x18 & 0xff00000000 | ((ulong)puVar270 & 0xff00000000) << 0x18 |
                (ulong)puVar270 & 0xffffffff | (ulong)puVar270 >> 8 & 0xff0000000000 |
                ((ulong)puVar270 & 0xff0000000000) << 8;
    }
  }
  goto LAB_00101de5;
code_r0x00101d9f:
  ...
  goto LAB_00101d90;
code_r0x00101da8:
  uVar239 = (ulong)((local_248 & 0xf8) << 0x10 | (bStack_247 & 0xf8) << 8 | bStack_246 & 0xf8 |
                   0x2000000);
LAB_00101de5:
  puVar2 = local_388 + 1;
  *local_388 = uVar239;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* CompressEtc2Rgba(unsigned int const*, unsigned long*, unsigned int, unsigned long, bool) */

void CompressEtc2Rgba(uint *param_1,ulong *param_2,uint param_3,ulong param_4,bool param_5)
...
LAB_00103f65:
  do {
    ...
    *puVar263 = (((param_1[param_4 * 3] >> 0x18) << 8 | uVar250 >> 0x18) << 8 | uVar251 >> 0x18) <<
                8 | uVar275 >> 0x18;
...
LAB_00104240:
  pbVar246 = local_158 + (long)(int)local_38c * 0x10;
  ...
  uVar245 = uVar245 >> 0x38 | (uVar245 & 0xff000000000000) >> 0x28 |
            (uVar245 & 0xff0000000000) >> 0x18 | (uVar245 & 0xff00000000) >> 8 |
            (uVar245 & 0xff000000) << 8 | (uVar245 & 0xff0000) << 0x18 | (uVar245 & 0xff00) << 0x28
            | uVar245 << 0x38;
LAB_00104002:
  *local_3b8 = uVar245;
  puVar235 = (ushort *)auStack_254;
LAB_00104020:
  if (CONCAT13(bStack_255,CONCAT12(bStack_256,CONCAT11(bStack_257,local_258))) == *(int *)puVar235)
  goto code_r0x00104028;
  _local_278 = 0xff00;
  cVar40 = param_5;
  ...
  puVar235 = (ushort *)&local_258;
  do {
    uVar251 = (uint)*(byte *)((long)puVar235 + 1) * 0x96 + (uint)(byte)puVar235[1] * 0x4c +
              (uint)(byte)*puVar235 * 0x1c >> 1;
...
LAB_001042ae:
  ...
  uVar325 = CONCAT13(cVar3,CONCAT12((0 < sVar416) * (sVar416 < 0x100) * auVar334[4] -
                                    (0xff < sVar416),
                                    CONCAT11(bVar220,(0 < sVar318) * (sVar318 < 0x100) * auVar334[0]
                                                     - (0xff < sVar318))));
  sVar318 = auVar334._8_2_;
  sVar416 = auVar334._10_2_;
  cVar267 = (0 < sVar416) * (sVar416 < 0x100) * auVar334[10] - (0xff < sVar416);
  uVar329 = CONCAT15(cVar267,CONCAT14((0 < sVar318) * (sVar318 < 0x100) * auVar334[8] -
                                      (0xff < sVar318),uVar325));
  sVar318 = auVar334._12_2_;
  sVar416 = auVar334._14_2_;
  cVar4 = (0 < sVar416) * (sVar416 < 0x100) * auVar334[0xe] - (0xff < sVar416);
  uVar330 = CONCAT17(cVar4,CONCAT16((0 < sVar318) * (sVar318 < 0x100) * auVar334[0xc] -
                                    (0xff < sVar318),uVar329));
  sVar318 = auVar298._0_2_;
  sVar416 = auVar298._2_2_;
  cVar5 = (0 < sVar416) * (sVar416 < 0x100) * auVar298[2] - (0xff < sVar416);
  auVar332._0_10_ =
       CONCAT19(cVar5,CONCAT18((0 < sVar318) * (sVar318 < 0x100) * auVar298[0] - (0xff < sVar318),
                               uVar330));
  ...
  uVar286 = CONCAT13(cVar9,CONCAT12((0 < sVar416) * (sVar416 < 0x100) * auVar334[4] -
                                    (0xff < sVar416),
                                    CONCAT11(bVar242,(0 < sVar318) * (sVar318 < 0x100) * auVar334[0]
                                                     - (0xff < sVar318))));
  sVar318 = auVar334._8_2_;
  sVar416 = auVar334._10_2_;
  cVar10 = (0 < sVar416) * (sVar416 < 0x100) * auVar334[10] - (0xff < sVar416);
  uVar294 = CONCAT15(cVar10,CONCAT14((0 < sVar318) * (sVar318 < 0x100) * auVar334[8] -
                                     (0xff < sVar318),uVar286));
  sVar318 = auVar334._12_2_;
  sVar416 = auVar334._14_2_;
  cVar11 = (0 < sVar416) * (sVar416 < 0x100) * auVar334[0xe] - (0xff < sVar416);
  uVar295 = CONCAT17(cVar11,CONCAT16((0 < sVar318) * (sVar318 < 0x100) * auVar334[0xc] -
                                     (0xff < sVar318),uVar294));
  sVar318 = auVar364._0_2_;
  sVar416 = auVar364._2_2_;
  cVar12 = (0 < sVar416) * (sVar416 < 0x100) * auVar364[2] - (0xff < sVar416);
  auVar296._0_10_ =
       CONCAT19(cVar12,CONCAT18((0 < sVar318) * (sVar318 < 0x100) * auVar364[0] - (0xff < sVar318),
                                uVar295));
  ...
  uVar209 = CONCAT26(auVar79._13_2_,
                     CONCAT15((0 < sVar66) * (sVar66 < 0x100) * auVar334[0xc] - (0xff < sVar66),
                              uVar200));
  auVar202._4_8_ = 0;
  ...
  uVar330 = CONCAT44(uVar250,CONCAT13((0 < sVar63) * (sVar63 < 0x100) * auVar334[10] -
                                      (0xff < sVar63),uVar180));
  auVar118._10_5_ = (int5)((ulong)uVar330 >> 0x18);
  auVar118._0_10_ = (unkuint10)CONCAT11(bVar17,cVar16) << 0x38;
  uVar295 = CONCAT62(auVar118._9_6_,
                     CONCAT11((0 < sVar60) * (sVar60 < 0x100) * auVar334[8] - (0xff < sVar60),cVar16
                             ));
  auVar127._7_8_ = 0;
  auVar127._0_7_ = (uint7)((ulong)uVar295 >> 8);
  Var128 = CONCAT81(SUB158(auVar127 << 0x40,7),
                    (0 < sVar57) * (sVar57 < 0x100) * auVar334[6] - (0xff < sVar57));
  auVar182._9_6_ = 0;
  ...
  uVar211 = CONCAT26(auVar80._13_2_,
                     CONCAT15((0 < sVar66) * (sVar66 < 0x100) * auVar364[0xc] - (0xff < sVar66),
                              uVar200));
  auVar203._4_8_ = 0;
  ...
  uVar330 = CONCAT44(uVar275,CONCAT13((0 < sVar63) * (sVar63 < 0x100) * auVar364[10] -
                                      (0xff < sVar63),uVar180));
  auVar119._10_5_ = (int5)((ulong)uVar330 >> 0x18);
  auVar119._0_10_ = (unkuint10)CONCAT11(bVar32,cVar9) << 0x38;
  uVar295 = CONCAT62(auVar119._9_6_,
                     CONCAT11((0 < sVar60) * (sVar60 < 0x100) * auVar364[8] - (0xff < sVar60),cVar9)
                    );
  auVar132._7_8_ = 0;
  auVar132._0_7_ = (uint7)((ulong)uVar295 >> 8);
  Var128 = CONCAT81(SUB158(auVar132 << 0x40,7),
                    (0 < sVar57) * (sVar57 < 0x100) * auVar364[6] - (0xff < sVar57));
  auVar184._9_6_ = 0;
  ...
  uVar213 = CONCAT26(auVar82._13_2_,
                     CONCAT15((uVar357 != 0) * (uVar357 < 0x100) * cVar7 - (0xff < uVar357),uVar201)
                    );
  auVar204._4_8_ = 0;
  ...
  uVar330 = CONCAT44(uVar251,CONCAT13((uVar355 != 0) * (uVar355 < 0x100) * cVar6 - (0xff < uVar355),
                                      uVar181));
  auVar120._10_5_ = (int5)((ulong)uVar330 >> 0x18);
  auVar120._0_10_ = (unkuint10)CONCAT11(bVar25,cVar8) << 0x38;
  uVar295 = CONCAT62(auVar120._9_6_,
                     CONCAT11((uVar353 != 0) * (uVar353 < 0x100) * cVar5 - (0xff < uVar353),cVar8));
  auVar137._7_8_ = 0;
  auVar137._0_7_ = (uint7)((ulong)uVar295 >> 8);
  Var128 = CONCAT81(SUB158(auVar137 << 0x40,7),
                    (uVar350 != 0) * (uVar350 < 0x100) * cVar4 - (0xff < uVar350));
  auVar186._9_6_ = 0;
  ...
  iVar287 = (auVar126._0_4_ & 0xffff) + (uint)uVar322 + (uVar233 & 0xffff) + (uint)bVar28 +
            (int)uVar219 + (uVar251 >> 8 & 0xffff) + auVar114._8_4_ + (uint)bVar30 +
            auVar112._4_4_ + (uint)uVar359 + auVar115._4_4_ + (uint)bVar29 +
            (auVar83._10_4_ >> 0x10) + (uVar251 >> 0x18) + (uint)(uint3)(auVar113._10_3_ >> 0x10) +
            (uint)bVar31;
  iVar361 = (auVar125._0_4_ & 0xffff) + (uint)uVar317 + (uVar244 & 0xffff) + (uint)bVar36 +
            (int)uVar218 + (uVar275 >> 8 & 0xffff) + auVar110._8_4_ + (uint)bVar38 +
            auVar108._4_4_ + (uint)uVar319 + auVar111._4_4_ + (uint)bVar37 +
            (auVar81._10_4_ >> 0x10) + (uVar275 >> 0x18) + (uint)(uint3)(auVar109._10_3_ >> 0x10) +
            (uint)bVar39;
  iVar326 = (uint)uVar285 + (uint)uVar320 + (uVar234 & 0xffff) + (uint)bVar21 +
            (int)uVar217 + (uVar250 >> 8 & 0xffff) + auVar106._8_4_ + (uint)bVar23 +
            (int)CONCAT82(SUB148(auVar131 << 0x40,6),auVar130._0_2_) + (uint)uVar321 +
            auVar107._4_4_ + (uint)bVar22 +
            (auVar91._10_4_ >> 0x10) + (uVar250 >> 0x18) + (uint)(uint3)(auVar105._10_3_ >> 0x10) +
            (uint)bVar24;
  ...
  if (cVar40 != '\0') {
    ...
    uVar213 = CONCAT26(auVar92._13_2_,
                       CONCAT15((0 < sVar68) * (sVar68 < 0x100) * auVar459[0xc] - (0xff < sVar68),
                                uVar201));
    auVar205._4_8_ = 0;
    auVar205._0_4_ = uVar266;
    auVar116._12_3_ = (int3)((ulong)uVar213 >> 0x28);
    auVar116._0_12_ = auVar205 << 0x38;
    uVar330 = CONCAT44(auVar116._11_4_,
                       CONCAT13((0 < sVar65) * (sVar65 < 0x100) * auVar459[10] - (0xff < sVar65),
                                uVar181));
    auVar123._10_5_ = (int5)((ulong)uVar330 >> 0x18);
    auVar123._0_10_ = (unkuint10)uVar324 << 0x38;
    uVar295 = CONCAT62(auVar123._9_6_,
                       CONCAT11((0 < sVar62) * (sVar62 < 0x100) * auVar459[8] - (0xff < sVar62),
                                cVar267));
    auVar155._7_8_ = 0;
    auVar155._0_7_ = (uint7)((ulong)uVar295 >> 8);
    Var128 = CONCAT81(SUB158(auVar155 << 0x40,7),
                      (0 < sVar59) * (sVar59 < 0x100) * auVar459[6] - (0xff < sVar59));
    auVar188._9_6_ = 0;
    ...
    auVar492._0_2_ =
         uVar315 - (byte)((0 < sVar57) * (sVar57 < 0x100) * auVar459[0] - (0xff < sVar57));
    ...
    uVar211 = CONCAT26(auVar84._13_2_,
                       CONCAT15((0 < sVar67) * (sVar67 < 0x100) * auVar310[0xc] - (0xff < sVar67),
                                uVar200));
    auVar206._4_8_ = 0;
    auVar206._0_4_ = uVar252;
    auVar102._12_3_ = (int3)((ulong)uVar211 >> 0x28);
    auVar102._0_12_ = auVar206 << 0x38;
    uVar330 = CONCAT44(auVar102._11_4_,
                       CONCAT13((0 < sVar64) * (sVar64 < 0x100) * auVar310[10] - (0xff < sVar64),
                                uVar180));
    auVar121._10_5_ = (int5)((ulong)uVar330 >> 0x18);
    auVar121._0_10_ = (unkuint10)uVar323 << 0x38;
    uVar295 = CONCAT62(auVar121._9_6_,
                       CONCAT11((0 < sVar61) * (sVar61 < 0x100) * auVar310[8] - (0xff < sVar61),
                                cVar40));
    auVar158._7_8_ = 0;
    auVar158._0_7_ = (uint7)((ulong)uVar295 >> 8);
    Var128 = CONCAT81(SUB158(auVar158 << 0x40,7),
                      (0 < sVar58) * (sVar58 < 0x100) * auVar310[6] - (0xff < sVar58));
    auVar190._9_6_ = 0;
    auVar190._0_9_ = Var128;
    ...
    auVar499._0_2_ =
         uVar316 - (byte)((0 < sVar56) * (sVar56 < 0x100) * auVar310[0] - (0xff < sVar56));
    ...
    uVar209 = CONCAT26(auVar85._13_2_,
                       CONCAT15((0 < sVar69) * (sVar69 < 0x100) * auVar435[0xc] - (0xff < sVar69),
                                uVar201));
    auVar207._4_8_ = 0;
    auVar207._0_4_ = uVar266;
    auVar103._12_3_ = (int3)((ulong)uVar209 >> 0x28);
    auVar103._0_12_ = auVar207 << 0x38;
    uVar330 = CONCAT44(auVar103._11_4_,
                       CONCAT13((0 < sVar68) * (sVar68 < 0x100) * auVar435[10] - (0xff < sVar68),
                                uVar181));
    auVar122._10_5_ = (int5)((ulong)uVar330 >> 0x18);
    auVar122._0_10_ = (unkuint10)uVar324 << 0x38;
    uVar295 = CONCAT62(auVar122._9_6_,
                       CONCAT11((0 < sVar65) * (sVar65 < 0x100) * auVar435[8] - (0xff < sVar65),
                                cVar267));
    auVar161._7_8_ = 0;
    auVar161._0_7_ = (uint7)((ulong)uVar295 >> 8);
    Var128 = CONCAT81(SUB158(auVar161 << 0x40,7),
                      (0 < sVar62) * (sVar62 < 0x100) * auVar435[6] - (0xff < sVar62));
    auVar192._9_6_ = 0;
    ...
    auVar500._0_2_ =
         uVar285 - (byte)((0 < sVar60) * (sVar60 < 0x100) * auVar435[0] - (0xff < sVar60));
    ...
    auVar501._10_2_ =
         uStack_2ee - (byte)((0 < sVar72) * (sVar72 < 0x100) * auVar392[10] - (0xff < sVar72));
    auVar501._12_2_ =
         uStack_2ec - (byte)((0 < sVar74) * (sVar74 < 0x100) * auVar392[0xc] - (0xff < sVar74));
    auVar501._14_2_ =
         uStack_2ea - (byte)((0 < sVar77) * (sVar77 < 0x100) * auVar392[0xe] - (0xff < sVar77));
    ...
    auVar460._10_2_ =
         uStack_2ce - (byte)((0 < sVar71) * (sVar71 < 0x100) * auVar379[10] - (0xff < sVar71));
    auVar460._12_2_ =
         uStack_2cc - (byte)((0 < sVar73) * (sVar73 < 0x100) * auVar379[0xc] - (0xff < sVar73));
    auVar460._14_2_ =
         uStack_2ca - (byte)((0 < sVar76) * (sVar76 < 0x100) * auVar379[0xe] - (0xff < sVar76));
    ...
    auVar342._10_2_ =
         uStack_30e - (byte)((0 < sVar70) * (sVar70 < 0x100) * auVar491[10] - (0xff < sVar70));
    auVar342._12_2_ =
         uStack_30c - (byte)((0 < sVar75) * (sVar75 < 0x100) * auVar491[0xc] - (0xff < sVar75));
    auVar342._14_2_ =
         uStack_30a - (byte)((0 < sVar78) * (sVar78 < 0x100) * auVar491[0xe] - (0xff < sVar78));
    ...
    Var194 = CONCAT64(CONCAT42(uVar286,auVar334._4_2_),
                      CONCAT22(auVar495._4_2_ * auVar495._4_2_,auVar495._6_2_ * auVar495._6_2_));
    ...
    Var195 = CONCAT64(CONCAT42(uVar325,auVar516._4_2_),
                      CONCAT22(auVar313._4_2_ * auVar313._4_2_,auVar313._6_2_ * auVar313._6_2_));
    ...
    local_3d0 = CONCAT44(-(uint)(auVar334._0_2_ < 0),auVar343._0_4_) + auVar505._0_8_ +
                CONCAT44(-(uint)(auVar334._8_2_ < 0),uVar362) + auVar506._0_8_ +
                CONCAT44(-(uint)(auVar516._0_2_ < 0),auVar502._0_4_) + auVar462._0_8_ +
                CONCAT44(-(uint)(auVar516._8_2_ < 0),uVar420) + auVar463._0_8_ +
                auVar314._8_8_ + auVar505._8_8_ + auVar461._8_8_ + auVar506._8_8_ +
                auVar344._8_8_ + auVar462._8_8_ + auVar345._8_8_ + auVar463._8_8_;
  }
  uVar250 = uVar275 << 0x19 |
            *(uint *)(&g_flags +
                     (long)(int)((int)uVar234 >> 1 & 0xfU | (int)uVar268 >> 1 & 0x10U |
                                uVar250 & 0x20) * 4) |
            (uVar251 & 0x40) << 0x12 | uVar272 * 2 & 0x7c | uVar244 & 1 | (uVar233 & 7) << 7 |
            (uVar233 & 0x18) << 8 | (uVar233 & 0x20) << 0xb | (uVar251 & 0x3f) << 0x11 | 2;
  uVar275 = (uVar256 << 6 | uVar261) << 0x13;
  uVar251 = uVar277 << 6 | uVar281 << 0xd;
  uVar258 = uVar251 | uVar258;
  local_3d8 = CONCAT44(uVar275 >> 0x18 | ((uVar258 | uVar275) & 0xff0000) >> 8 |
                       (uVar251 & 0xff00) << 8 | uVar258 << 0x18,
                       uVar250 >> 0x18 | (uVar250 & 0xff0000) >> 8 | (uVar250 & 0xff00) << 8 |
                       uVar250 << 0x18);
  auVar516 = __LC6;
  if (local_3d0 != 0) {
    iVar231 = 0;
    ...
    while( true ) {
      ...
      *(uint *)(local_288 + uVar245 * 4) = (uint)(byte)puVar235[-1] + iVar255;
      ...
      do {
        ...
        *(uint *)(local_158 + lVar236 * 4) =
             *(int *)(local_158 + lVar236 * 4) + (uint)(byte)*puVar247;
        local_1c8[lVar236 + -4] = local_1c8[lVar236 + -4] + (uint)*(byte *)((long)puVar247 + 1);
        *(uint *)(local_288 + lVar236 * 4) =
             *(int *)(local_288 + lVar236 * 4) + (uint)(byte)puVar247[1];
        puVar247 = puVar247 + 2;
        iVar231 = iVar232;
      } while (iVar232 != 4);
      uVar250 = uVar250 + 1;
    ...
    uVar223 = (undefined2)
              ((uint)*(undefined4 *)(&g_avg2 + (long)((iVar231 >> 8) + iVar231 >> 8) * 4) >> 0x10);
    ...
    uVar221 = (undefined2)
              ((uint)*(undefined4 *)(&g_avg2 + (long)((iVar271 >> 8) + iVar271 >> 8) * 4) >> 0x10);
    ...
    puVar235 = (ushort *)auStack_254;
    while( true ) {
      *(ulong *)(piVar273 + (ulong)(uVar275 & 2) * 4) =
           CONCAT44((uint)*(byte *)((long)puVar235 + -3) + iVar255,
                    (uint)(byte)puVar235[-2] + iVar232);
      *(uint *)(local_158 + (ulong)(uVar275 & 2) * 0x10 + 8) = iVar231 + (uint)(byte)puVar235[-1];
      ...
      do {
        ...
        *(ulong *)(piVar273 + lVar236 * 4) =
             CONCAT44((int)((ulong)uVar295 >> 0x20) + (uint)*(byte *)((long)puVar247 + 1),
                      (int)uVar295 + (uint)(byte)*puVar247);
    ...
    while( true ) {
      ...
      *(uint *)(local_298 + lVar236) =
           ((0x3fffffff - ((uint)uVar285 * iVar257 * 2 + (uint)uVar316 * iVar255 * 2)) -
           (uint)uVar315 * iVar232 * 2) +
           (((uint)uVar315 * (uint)uVar315 & 0xffff) + (uint)(ushort)(uVar285 * uVar285) +
           (uint)(ushort)(uVar316 * uVar316)) * 8 + iVar231;
      uVar250 = (uint)uVar317;
      uVar285 = puVar235[0x10];
      *(uint *)(local_298 + lVar236 + 8) =
           ((((*(int *)(local_298 + lVar236 + 8) - iVar255 * 2 * uVar250) + 0x3fffffff) -
            iVar257 * 2 * (uint)uVar319) - iVar232 * 2 * (uint)uVar285) +
           ((uint)(ushort)(uVar285 * uVar285) + (uint)(ushort)(uVar319 * uVar319) +
           (uVar250 * uVar250 & 0xffff)) * 8;
      if (iVar271 == 4) break;
    ...
    if ((uVar245 & 2) == 0) {
      do {
        ...
        uVar265 = uVar265 + 2;
        uVar240 = uVar240 | (ulong)(*(ushort *)((long)local_218 + lVar237) >> 4) <<
                            (bVar220 + 4 & 0x3f) |
                            (ulong)(*(ushort *)(local_228 + lVar278 + 0x228) >> 4) <<
                            (bVar220 & 0x3f);
      } while (uVar265 != 6);
    }
    else {
      ...
      do {
        ...
        cVar40 = (char)lVar237;
        lVar237 = lVar237 + 2;
        uVar240 = uVar240 | (ulong)((int)((*(ushort *)(local_228 + lVar278 + 0x228) & 0xf8) -
                                         (uVar250 & 0xf8)) >> 3 & 7U | uVar250 & 0xf8) <<
                            (cVar40 * '\x04' & 0x3fU);
      } while (lVar237 != 6);
    }
    piVar238 = (int *)local_1d8;
    ...
    do {
      ...
      lVar236 = (long)(int)(((uint)local_218[uVar265 * 4] - (uint)(byte)puVar235[1]) * 0x4d +
                            ((uint)local_218[uVar265 * 4 + 1] - (uint)*(byte *)((long)puVar235 + 1))
                            * 0x97 + ((uint)local_218[uVar265 * 4 + 2] - (uint)(byte)*puVar235) *
                                     0x1c);
      do {
        uVar264 = 1;
        uVar265 = 0;
    ...
    if (param_5) {
      ...
      if (cVar283 == '\x02') {
        local_299 = false;
        uVar250 = (anonymous_namespace)::compressBlockTH
                            (&local_258,(Luma *)local_278,(uint *)local_288,(uint *)(local_288 + 4),
                             &local_299);
        ...
        if (local_299 == false) {
          ...
          uVar251 = (uVar268 & ((uVar250 & 0x80000 & uVar251 << 0x13) >> 0x13) << 0x10 &
                     ((uVar250 & 0x100000) >> 0x14 ^ 1) << 0x10 |
                    uVar268 & ((uVar250 & 0x180000 & ((uVar250 & 0x80000) >> 0x13) << 0x14) >> 0x14)
                              << 0x10 & (uVar251 ^ 1) << 0x10) >> 0x10 |
                    (uVar250 & 0x100000 & uVar251 << 0x14) >> 0x14;
          uVar250 = (uVar275 >> 0x1e ^ 1) << 0x1f |
                    uVar268 | uVar275 | uVar250 & 0x180000 | local_288._0_4_ & 1 |
                    (-uVar251 & 7) << 0x15 | (uVar251 ^ 1) << 0x12;
        }
        else {
          ...
          uVar251 = (uVar250 & 0x2000000 & uVar251 << 0x19) >> 0x19 |
                    (uVar250 & 0xe7ffffff & ((uVar275 & uVar251 << 0x1b) >> 0x1b) << 0x18 &
                     (uVar268 ^ 1) << 0x18 |
                    uVar250 & 0xe7ffffff & ((uVar275 & uVar268 << 0x1b) >> 0x1b) << 0x18 &
                    (uVar251 ^ 1) << 0x18) >> 0x18;
          uVar250 = uVar250 & 0x3ffffff | local_288._0_4_ & 1 | uVar275 | uVar251 * -0x20000000 |
                    (uVar251 ^ 1) << 0x1a;
        }
        local_3d8 = CONCAT44((uint)local_288._4_4_ >> 0x18 | (local_288._4_4_ & 0xff0000) >> 8 |
                             (local_288._4_4_ & 0xff00) << 8 | local_288._4_4_ << 0x18,
                             uVar250 >> 0x18 | (uVar250 & 0xff0000) >> 8 | (uVar250 & 0xff00) << 8 |
                             (uVar250 | 2) << 0x18);
      }
    }
    ...
    lVar236 = 1;
    do {
      if (*(ulong *)((long)local_1d8 + lVar236 * 2 * 4) <
          *(ulong *)(local_1d8 + local_288._0_8_ * 8)) {
    ...
    if (auStack_198[local_288._8_8_] + *(long *)(local_1d8 + local_288._0_8_ * 8) < local_3d0) {
      ...
      do {
        ...
        uVar285 = *(ushort *)
                   ((long)piVar273 +
                   *(long *)(local_288 +
                            (ulong)(*(uint *)((long)(&g_id + uVar245 * 0x40) + lVar236 * 4) & 1) * 8
                            ) * 2);
        piVar273 = piVar273 + 4;
        lVar236 = lVar236 + 1;
        uVar240 = uVar240 | (ulong)(uVar285 & 1) << (cVar40 + 0x20U & 0x3f) |
                            (ulong)(uVar285 & 2) << (cVar40 + 0x2fU & 0x3f);
      } while (lVar236 != 0x10);
      local_3d8 = uVar240 >> 0x18 & 0xff00000000 | (uVar240 & 0xff00000000) << 0x18 |
                  uVar240 & 0xffffffff | uVar240 >> 8 & 0xff0000000000 |
                  (uVar240 & 0xff0000000000) << 8;
    }
  }
  goto LAB_00104070;
code_r0x00104028:
  ...
  goto LAB_00104020;
code_r0x00104031:
  local_3d8 = (ulong)((local_258 & 0xf8) << 0x10 | (bStack_257 & 0xf8) << 8 | bStack_256 & 0xf8 |
                     0x2000000);
LAB_00104070:
  puVar2 = local_3b8 + 2;
...
/* CompressEacR(unsigned int const*, unsigned long*, unsigned int, unsigned long) */

void CompressEacR(uint *param_1,ulong *param_2,uint param_3,ulong param_4)

{
  ...
  do {
    do {
      pbVar9 = pbVar5 + 4;
      *(uint *)pbVar5 =
           CONCAT31(CONCAT21(CONCAT11(*(undefined1 *)((long)param_1 + param_4 * 0xc + 2),
                                      *(undefined1 *)((long)param_1 + param_4 * 8 + 2)),
                             *(undefined1 *)((long)param_1 + param_4 * 4 + 2)),
                    *(undefined1 *)((long)param_1 + 2));
      param_1 = param_1 + 1;
      pbVar5 = pbVar9;
...
LAB_00106515:
      if ((iVar17 < local_1b8) &&
         (local_1b0 = (uint)lVar11, in_R10 = (ulong)uVar15, local_1b8 = iVar17, iVar17 == 0)) break;
      lVar11 = lVar11 + 1;
      piVar16 = piVar16 + 8;
      pbVar5 = pbVar5 + 0x10;
    } while (lVar11 != 0x10);
    ...
    puVar19 = puVar18 + 1;
    *puVar18 = uVar10 >> 0x38 | (uVar10 & 0xff000000000000) >> 0x28 |
...
/* CompressEacRg(unsigned int const*, unsigned long*, unsigned int, unsigned long) */

void CompressEacRg(uint *param_1,ulong *param_2,uint param_3,ulong param_4)
...
LAB_001068d8:
    ...
    *puVar8 = uVar16 >> 0x38 | (uVar16 & 0xff000000000000) >> 0x28 |
...
LAB_00106ae8:
    ...
    puVar9 = puVar8 + 2;
    puVar8[1] = uVar16 >> 0x38 | (uVar16 & 0xff000000000000) >> 0x28 |
                (uVar16 & 0xff0000000000) >> 0x18 | (uVar16 & 0xff00000000) >> 8 |
                (uVar16 & 0xff000000) << 8 | (uVar16 & 0xff0000) << 0x18 | (uVar16 & 0xff00) << 0x28
                | uVar16 << 0x38;
    pbVar4 = local_68;

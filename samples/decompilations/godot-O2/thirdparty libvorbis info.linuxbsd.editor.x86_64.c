    ...
    if (0 < *(int *)((long)__ptr + 0x14)) {
      ...
      do {
        if (*(long *)((long)__ptr + lVar2 * 8 + 0x328) != 0) {
          (**(code **)(*(long *)(&_mapping_P + (long)*(int *)((long)__ptr + lVar2 * 4 + 0x228) * 8)
                      + 0x10))();
        }
        lVar2 = lVar2 + 1;
    ...
    if (0 < *(int *)((long)__ptr + 0x18)) {
      ...
      do {
        if (*(long *)((long)__ptr + lVar2 * 8 + 0x628) != 0) {
          (**(code **)(*(long *)(&_floor_P + (long)*(int *)((long)__ptr + lVar2 * 4 + 0x528) * 8) +
                      0x18))();
        }
        lVar2 = lVar2 + 1;
    ...
    if (0 < *(int *)((long)__ptr + 0x1c)) {
      ...
      do {
        if (*(long *)((long)__ptr + lVar2 * 8 + 0x928) != 0) {
          (**(code **)(*(long *)(&_residue_P + (long)*(int *)((long)__ptr + lVar2 * 4 + 0x828) * 8)
                      + 0x18))();
        }
        lVar2 = lVar2 + 1;
...

{
  ...
  if (((param_1 == (undefined8 *)0x0) ||
      (oggpack_readinit(auStack_58,*param_1,*(undefined4 *)(param_1 + 1)), param_1[2] == 0)) ||
     (lVar3 = oggpack_read(auStack_58,8), lVar3 != 1)) {
    uVar2 = 0;
  }
  else {
    local_26._0_4_ = 0;
    ...
    if ((local_26._0_4_ != 0x62726f76) || (uVar2 = 0, local_26._4_2_ != 0x7369)) {
      uVar2 = 1;
    }
    uVar2 = uVar2 ^ 1;
  }
...
undefined8 vorbis_synthesis_headerin(int *param_1,long *param_2,undefined8 *param_3)
            ...
            *param_2 = (long)pvVar10;
            ...
            if (iVar2 != 0) {
              ...
              do {
                iVar2 = oggpack_read(local_78,0x20);
                lVar7 = local_58;
                if ((iVar2 < 0) || (lVar9 = oggpack_bytes(local_78), lVar7 - lVar9 < (long)iVar2))
                goto LAB_00100f58;
              ...
              if (0 < iVar2 + 1) {
                ...
                do {
                  ...
                  *(uint *)(lVar8 + 0x528 + lVar7 * 4) = uVar4;
                  ...
                  lVar9 = (**(code **)(*(long *)(&_floor_P + (long)(int)uVar4 * 8) + 8))
                                    (param_1,local_78);
                ...
                if (0 < iVar2 + 1) {
                  ...
                  do {
                    ...
                    *(uint *)(lVar8 + 0x828 + lVar7 * 4) = uVar4;
                    ...
                    lVar9 = (**(code **)(*(long *)(&_residue_P + (long)(int)uVar4 * 8) + 8))
                                      (param_1,local_78);
                    ...
                    *(int *)(lVar8 + 0x10) = iVar2 + 1;
                    if (0 < iVar2 + 1) {
                      ...
                      do {
                        ...
                        *(int *)(lVar9 + 0xc) = iVar2;
                        if ((((0 < *(int *)(lVar9 + 4)) || (0 < *(int *)(lVar9 + 8))) ||
                            (*(int *)(lVar8 + 0x14) <= iVar2)) || (iVar2 < 0)) goto LAB_00100ac7;
                        lVar7 = lVar7 + 1;
...
LAB_00100f65:
      ...
      *(undefined8 *)(param_1 + 2) = uVar6;
      iVar2 = oggpack_read(local_78,0x20);
      *(long *)(param_1 + 4) = (long)iVar2;
      iVar2 = oggpack_read(local_78,0x20);
      *(long *)(param_1 + 6) = (long)iVar2;
      iVar2 = oggpack_read(local_78,0x20);
      *(long *)(param_1 + 8) = (long)iVar2;
      ...
      if (-1 < iVar2) {
        *plVar16 = (long)(1 << ((byte)iVar2 & 0x1f));
        ...
        if (-1 < iVar2) {
          ...
          plVar16[1] = lVar7;
          if (((0 < lVar8) && (0 < param_1[1])) &&
             ((lVar7 < 0x2001 && *plVar16 <= lVar7 && (0x3f < *plVar16)))) {
LAB_00100ab0:
            lVar8 = oggpack_read(local_78,1);
            if (lVar8 == 1) goto LAB_00100951;
          }
...
vorbis_analysis_headerout
          (long param_1,undefined8 param_2,undefined1 (*param_3) [16],undefined1 (*param_4) [16],
  ...
  if ((lVar4 == 0) || (0xff < *(int *)(lVar12 + 4) - 1U)) {
    ...
    *param_5 = (undefined1  [16])0x0;
    ...
    if (((plVar5 != (long *)0x0) && (0x3f < *plVar5)) && (*plVar5 <= plVar5[1])) {
      ...
      oggpack_write(local_68,*(undefined8 *)(lVar12 + 8),0x20);
      oggpack_write(local_68,*(undefined8 *)(lVar12 + 0x10),0x20);
      oggpack_write(local_68,*(undefined8 *)(lVar12 + 0x18),0x20);
      oggpack_write(local_68,*(undefined8 *)(lVar12 + 0x20),0x20);
      local_78 = (int)*plVar5;
        ...
        if (lVar6 != 0) {
          ...
          if (0 < *(int *)(lVar6 + 0x18)) {
            do {
              ...
              if ((code *)**(undefined8 **)
                            (&_floor_P + (long)*(int *)(lVar6 + 0x528 + lVar13 * 4) * 8) ==
                  (code *)0x0) goto LAB_00101404;
              (*(code *)**(undefined8 **)
                          (&_floor_P + (long)*(int *)(lVar6 + 0x528 + lVar13 * 4) * 8))
                        (*(undefined8 *)(lVar6 + 0x628 + lVar13 * 8),local_68);
              lVar13 = lVar13 + 1;
          ...
          if (0 < *(int *)(lVar6 + 0x1c)) {
            do {
              ...
              lVar2 = lVar13 * 8;
              lVar13 = lVar13 + 1;
              (*(code *)**(undefined8 **)(&_residue_P + (long)*(int *)(lVar6 + 0x828 + lVar1) * 8))
                        (*(undefined8 *)(lVar6 + 0x928 + lVar2),local_68);
          ...
          if (0 < *(int *)(lVar6 + 0x14)) {
            do {
              ...
              lVar2 = lVar13 * 8;
              lVar13 = lVar13 + 1;
              (*(code *)**(undefined8 **)(&_mapping_P + (long)*(int *)(lVar6 + 0x228 + lVar1) * 8))
                        (lVar12,*(undefined8 *)(lVar6 + 0x328 + lVar2),local_68);
...
double vorbis_granule_time(long param_1,long param_2)

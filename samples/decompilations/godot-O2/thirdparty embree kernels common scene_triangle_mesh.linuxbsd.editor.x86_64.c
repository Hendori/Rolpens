    ...
    if (lVar5 == 0) {
      if (lVar6 != 0) {
        ...
        do {
          ...
          *puVar25 = (uint)((float)(*puVar1 & uVar36) - (float)(uVar29 & uVar36)) & uVar36 |
                     ~uVar36 & *puVar25;
          puVar25[1] = (uint)((float)(uVar10 & uVar31) - (float)(uVar32 & uVar31)) & uVar31 |
                       ~uVar31 & puVar25[1];
          puVar25[2] = (uint)((float)(uVar11 & uVar34) - (float)(uVar35 & uVar34)) & uVar34 |
                       ~uVar34 & puVar25[2];
          puVar25[3] = (uint)((float)(uVar12 & uVar37) - (float)(uVar38 & uVar37)) & uVar37 |
                       ~uVar37 & puVar25[3];
          puVar1 = (uint *)(lVar21 + lVar20);
          *puVar1 = (uint)((float)(uVar13 & uVar36) - (float)(uVar29 & uVar36)) & uVar36 |
                    ~uVar36 & *puVar1;
          puVar1[1] = (uint)((float)(uVar28 & uVar31) - (float)(uVar32 & uVar31)) & uVar31 |
                      ~uVar31 & puVar1[1];
          puVar1[2] = (uint)((float)(uVar30 & uVar34) - (float)(uVar35 & uVar34)) & uVar34 |
                      ~uVar34 & puVar1[2];
          puVar1[3] = (uint)((float)(uVar33 & uVar37) - (float)(uVar38 & uVar37)) & uVar37 |
                      ~uVar37 & puVar1[3];
          if (lVar7 != 0) {
      ...
      do {
        ...
        *puVar1 = (uint)(fVar3 * (float)(uVar10 & uVar28) + fVar2 * (float)(uVar29 & uVar28) +
                        fVar39 * fVar40) & uVar28 | ~uVar28 & *puVar1;
        puVar1[1] = (uint)(fVar3 * (float)(uVar11 & uVar30) + fVar2 * (float)(uVar32 & uVar30) +
                          fVar39 * fVar41) & uVar30 | ~uVar30 & puVar1[1];
        puVar1[2] = (uint)(fVar3 * (float)(uVar12 & uVar33) + fVar2 * (float)(uVar35 & uVar33) +
                          fVar39 * fVar42) & uVar33 | ~uVar33 & puVar1[2];
        puVar1[3] = (uint)(fVar3 * (float)(uVar13 & uVar36) + fVar2 * (float)(uVar38 & uVar36) +
                          fVar39 * fVar43) & uVar36 | ~uVar36 & puVar1[3];
        if (lVar6 != 0) {
...
/* embree::RefCount::refDec() [clone .constprop.0] */
  ...
  if ((((uint)lVar6 | (uint)param_7) & 3) == 0) {
    if (param_2 == 1) {
      if ((((param_4 == 0x9003) && (uVar8 * param_7 < 0x400000001)) &&
         ...
         uVar8 * param_7 + param_6 <= (ulong)(*(long *)(lVar1 + 0x20) * param_7))) {
...
LAB_00100ddb:
      do {
        while (plVar2 = *(long **)(uVar11 * 0x30 + *(long *)(this + 0xd0) + 0x28),
              plVar2 == (long *)0x0) {
LAB_00100dce:
          uVar11 = uVar11 + 1;
...
LAB_00101600:
    do {
      ...
      if (((uVar17 < uVar16) && (uVar18 = (ulong)puVar12[1], uVar18 < uVar16)) &&
         (uVar19 = (ulong)puVar12[2], uVar19 < uVar16)) {
        if (*(uint *)(param_2 + 0x24) != 0) {
          ...
          do {
            ...
            if ((((~uVar14 & 7) != 0) ||
                ...
                uVar14 = movmskps(0,auVar23), (~uVar14 & 7) != 0)) ||
               (auVar22._0_4_ = -(uint)(*pfVar13 < fVar5 && fVar6 < *pfVar13),
               auVar22._4_4_ = -(uint)(pfVar13[1] < fVar5 && fVar6 < pfVar13[1]),
               auVar22._8_4_ = -(uint)(fVar6 < pfVar13[2] && pfVar13[2] < fVar5),
               auVar22._12_4_ = -(uint)(pfVar13[3] < fVar5 && fVar6 < pfVar13[3]),
               uVar14 = movmskps((int)pfVar13,auVar22), (~uVar14 & 7) != 0)) {
              uVar15 = uVar15 + 1;
              if (local_50 <= uVar15) {
                return param_1;
              }
      ...
      while( true ) {
        ...
        if ((float)(_LC21 & (uint)fVar25) < _LC16) {
          fVar25 = (float)((uint)((float)(int)fVar25 -
                                 (float)(-(uint)(fVar25 < (float)(int)fVar25) & (uint)_LC1)) |
                          ~_LC21 & (uint)fVar25);
        }
        uVar24 = 0;
        if (0.0 <= fVar25) {
        ...
        if ((float)(_LC21 & (uint)fVar25) < _LC16) {
          fVar25 = (float)((uint)((float)(int)fVar25 +
                                 (float)(-(uint)((float)(int)fVar25 < fVar25) & (uint)_LC1)) |
                          ~_LC21 & (uint)fVar25);
        }
...
LAB_00101ef0:
      ...
      if ((float)(_LC21 & (uint)fVar26) < _LC16) {
        fVar25 = (float)(~_LC21 & (uint)fVar26 |
                        (uint)((float)(int)fVar26 -
                              (float)(-(uint)(fVar26 < (float)(int)fVar26) & (uint)_LC1)));
      }
      fVar34 = fVar43;
      if ((float)(_LC21 & (uint)fVar43) < _LC16) {
        fVar34 = (float)(~_LC21 & (uint)fVar43 |
                        (uint)((float)(int)fVar43 +
                              (float)(-(uint)((float)(int)fVar43 < fVar43) & (uint)_LC1)));
      }
      iVar19 = (int)fVar25;
      if (fVar25 <= 0.0) {
        local_94 = 0;
      ...
      auVar46._4_4_ =
           _UNK_00103b04 * fVar43 + _UNK_00103b04 * fVar47 +
           _UNK_00103b04 * fVar53 + _UNK_00103b04 * fVar28;
      auVar46._8_4_ =
           _UNK_00103b08 * fVar34 + _UNK_00103b08 * fVar48 +
           _UNK_00103b08 * fVar54 + _UNK_00103b08 * fVar29;
      auVar46._12_4_ =
           _UNK_00103b0c * fVar20 + _UNK_00103b0c * (float)uVar22 +
           _UNK_00103b0c * fVar20 + _UNK_00103b0c * in_stack_00000008;
      ...
      while( true ) {
        ...
        if ((float)(_LC21 & (uint)fVar27) < _LC16) {
          fVar27 = (float)((uint)((float)(int)fVar27 -
                                 (float)(-(uint)(fVar27 < (float)(int)fVar27) & _LC1)) |
                          ~_LC21 & (uint)fVar27);
        }
        uVar23 = 0;
        if (0.0 <= fVar27) {
        ...
        if ((float)(_LC21 & (uint)fVar27) < _LC16) {
          fVar27 = (float)((uint)((float)(int)fVar27 +
                                 (float)(-(uint)((float)(int)fVar27 < fVar27) & _LC1)) |
                          ~_LC21 & (uint)fVar27);
        }
...
LAB_001027a9:
      ...
      if ((float)(_LC21 & (uint)fVar28) < _LC16) {
        fVar27 = (float)(~_LC21 & (uint)fVar28 |
                        (uint)((float)(int)fVar28 -
                              (float)(-(uint)(fVar28 < (float)(int)fVar28) & _LC1)));
      }
      fVar31 = fVar45;
      if ((float)(_LC21 & (uint)fVar45) < _LC16) {
        fVar31 = (float)(~_LC21 & (uint)fVar45 |
...

{
  ...
  if ((float)((uint)fVar15 & _LC21) < _LC16) {
    fVar12 = (float)((uint)((float)(int)fVar15 -
                           (float)(-(uint)(fVar15 < (float)(int)fVar15) & (uint)_LC1)) |
                    ~_LC21 & (uint)fVar15);
  }
  fVar20 = fVar40;
  if ((float)((uint)fVar40 & _LC21) < _LC16) {
    fVar20 = (float)((uint)((float)(-(uint)((float)(int)fVar40 < fVar40) & (uint)_LC1) +
                           (float)(int)fVar40) | ~_LC21 & (uint)fVar40);
  }
  iVar4 = (int)fVar12;
  if (fVar12 <= 0.0) {
    lVar9 = 0;

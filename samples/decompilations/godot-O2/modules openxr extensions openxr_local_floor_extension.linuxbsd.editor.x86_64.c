...
void __thiscall
OpenXRLocalFloorExtension::~OpenXRLocalFloorExtension(OpenXRLocalFloorExtension *this)
...
/* OpenXRLocalFloorExtension::get_singleton() */

undefined8 OpenXRLocalFloorExtension::get_singleton(void)
...
{
  this[8] = (OpenXRLocalFloorExtension)0x0;
  *(undefined ***)this = &PTR_get_requested_extensions_00100d08;
  singleton = this;
  return;
}
...
/* OpenXRLocalFloorExtension::is_available() */

OpenXRLocalFloorExtension __thiscall
OpenXRLocalFloorExtension::is_available(OpenXRLocalFloorExtension *this)
...
/* OpenXRLocalFloorExtension::get_requested_extensions() */

void OpenXRLocalFloorExtension::get_requested_extensions(void)
...
LAB_00100a06:
    ...
    iVar45 = *(int *)(this + 0x2c);
    if (pvVar43 == (void *)0x0) goto LAB_001004e4;
    if (iVar45 != 0) goto LAB_00100a06;
LAB_0010050a:
    ...
    *(void **)(this + 8) = __s_00;
    ...
    if (iVar45 != 0) {
      ...
      uVar55 = *(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x28) * 4);
      if (*(long *)(this + 8) == 0) goto LAB_00100b68;
LAB_001009fa:
      iVar45 = *(int *)(this + 0x2c);
      goto LAB_001009fe;
    }
LAB_001004e4:
    if ((float)uVar39 * __LC0 < (float)(iVar45 + 1)) goto LAB_0010050a;
  }
  local_58[0] = 0;
  if (*(long *)param_1 == 0) {
...
LAB_00100793:
    ...
    if (puVar42 != (undefined8 *)0x0) goto LAB_001007a0;
LAB_001009d5:
    ...
    *plVar1 = *plVar1 + -1;
    UNLOCK();
    if (*plVar1 != 0) goto LAB_00100793;
    Memory::free_static((void *)(local_58[0] + -0x10),false);
    puVar42 = *(undefined8 **)(this + 0x20);
    if (puVar42 == (undefined8 *)0x0) goto LAB_001009d5;
LAB_001007a0:
    *puVar42 = pauVar41;

...
LAB_00104411:
        ...
        *(double *)(this + 0x520) = param_3;
        ...
        uVar6 = (*UNRECOVERED_JUMPTABLE)
                          (*(undefined8 *)(lVar8 + 0x2c),*(undefined8 *)(lVar8 + 0x34),param_2,
...
LAB_0010b49d:
  if (param_2 != *piVar12) goto LAB_0010b490;
  if (*(int *)(this + 0x160) != 0) {
...
LAB_001135bf:
            if (this[0x180] != (OpenXRAPI)0x0) goto LAB_00113910;
          }
          else {
        ...
        if (*(code **)(this + 0x2f8) == (code *)0x0) {
          ...
          if (-1 < iVar3) {
            if (local_bc != 0) {
              uVar5 = 0;
LAB_0011433c:
              if (((uint)local_88 & 3) != 3) goto LAB_00114330;
...
LAB_00116043:
    if ((uint)uVar5 < (uint)uVar10) goto LAB_0011608c;
    lVar9 = 0;
    while( true ) {
      Memory::free_static((void *)puVar11[lVar9],false);
      lVar2 = lVar9 * 8;
...
LAB_0011937f:
          pcVar10 = local_398;
          _err_print_index_error
                    ("set","./core/templates/cowdata.h",0xcf,lVar16,lVar20,"p_index","size()","",
                     false,false);
        }
        else {
          CowData<OpenXRAPI::create_instance()::RequestExtension>::_copy_on_write
...
LAB_00118b00:
    ...
    for (; lVar20 != lVar16; lVar16 = lVar16 + 0x98) {
      ...
      if (cVar5 != '\0') {
        ...
        if ((lVar20 == 0) || (lVar16 = *(long *)(lVar20 + -8), lVar16 == 0)) goto LAB_00118b9a;
        lVar7 = 0;
        goto LAB_00118b74;
      }
    }
...
LAB_001195ad:
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,lVar7,lVar20,"p_index","size()","",false,
                   true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar4 = (code *)invalidInstructionException();
...
LAB_00118ef8:
      if (*(long *)(this + 0x30) == 0) goto LAB_001195aa;
      lVar20 = *(long *)(*(long *)(this + 0x30) + -8);
      if (lVar20 <= lVar7) goto LAB_001195ad;
...
LAB_00119738:
  ...
  return uVar12;
LAB_00118b74:
  if (lVar16 <= lVar7) goto LAB_00118b9a;
...
LAB_00118bef:
    iVar6 = CowData<CharString>::resize<false>(this_00,*(long *)(lVar20 + -8) + 1);
  }
  if (iVar6 == 0) {
    if (*(long *)(this + 0x30) == 0) {
      lVar16 = -1;
    ...
    _err_print_index_error
              ("set","./core/templates/cowdata.h",0xcf,lVar16,lVar20,"p_index","size()","",false,
               false);
  }
  else {
    _err_print_error("push_back","./core/templates/vector.h",0x142,
...
LAB_0011de7a:
      ...
      if (iVar2 == iVar13) {
        uVar15 = *puVar8;
        local_70 = *puVar10;
        if ((*puVar10 < uVar15) || (local_70 = uVar15, iVar1 < iVar13)) goto LAB_0011dc8e;
        local_70 = *puVar6;
      }
      else {
...
LAB_0011dcb6:
        ...
        do {
          ...
          goto joined_r0x0011dcd9;
          puVar6 = puVar7 + -2;
        } while (param_1 != lVar14);
        _err_print_error("partitioner","./core/templates/sort_array.h",0xb9,
                         "bad comparison function; sorting will be broken",0,0);
joined_r0x0011dcd9:
        if (lVar14 <= param_2) goto LAB_0011ddf8;
        uVar3 = puVar7[1];
        uVar15 = *puVar8;
        uVar4 = puVar8[1];
        *puVar8 = *puVar7;
...
/* WARNING: Removing unreachable block (ram,0x0011e708) */
/* WARNING: Removing unreachable block (ram,0x0011e838) */
/* WARNING: Removing unreachable block (ram,0x0011ea00) */
/* WARNING: Removing unreachable block (ram,0x0011e844) */
/* WARNING: Removing unreachable block (ram,0x0011e84e) */
/* WARNING: Removing unreachable block (ram,0x0011e9e0) */
/* WARNING: Removing unreachable block (ram,0x0011e85a) */
/* WARNING: Removing unreachable block (ram,0x0011e864) */
/* WARNING: Removing unreachable block (ram,0x0011e9c0) */
/* WARNING: Removing unreachable block (ram,0x0011e870) */
/* WARNING: Removing unreachable block (ram,0x0011e87a) */
/* WARNING: Removing unreachable block (ram,0x0011e9a0) */
/* WARNING: Removing unreachable block (ram,0x0011e886) */
/* WARNING: Removing unreachable block (ram,0x0011e890) */
/* WARNING: Removing unreachable block (ram,0x0011e980) */
/* WARNING: Removing unreachable block (ram,0x0011e89c) */
/* WARNING: Removing unreachable block (ram,0x0011e8a6) */
/* WARNING: Removing unreachable block (ram,0x0011e960) */
/* WARNING: Removing unreachable block (ram,0x0011e8b2) */
/* WARNING: Removing unreachable block (ram,0x0011e8bc) */
/* WARNING: Removing unreachable block (ram,0x0011e940) */
/* WARNING: Removing unreachable block (ram,0x0011e8c4) */
/* WARNING: Removing unreachable block (ram,0x0011e8da) */
/* WARNING: Removing unreachable block (ram,0x0011e8e6) */
...
/* WARNING: Removing unreachable block (ram,0x0011eb48) */
/* WARNING: Removing unreachable block (ram,0x0011ec78) */
/* WARNING: Removing unreachable block (ram,0x0011ee40) */
/* WARNING: Removing unreachable block (ram,0x0011ec84) */
/* WARNING: Removing unreachable block (ram,0x0011ec8e) */
/* WARNING: Removing unreachable block (ram,0x0011ee20) */
/* WARNING: Removing unreachable block (ram,0x0011ec9a) */
/* WARNING: Removing unreachable block (ram,0x0011eca4) */
/* WARNING: Removing unreachable block (ram,0x0011ee00) */
/* WARNING: Removing unreachable block (ram,0x0011ecb0) */
/* WARNING: Removing unreachable block (ram,0x0011ecba) */
/* WARNING: Removing unreachable block (ram,0x0011ede0) */
/* WARNING: Removing unreachable block (ram,0x0011ecc6) */
/* WARNING: Removing unreachable block (ram,0x0011ecd0) */
/* WARNING: Removing unreachable block (ram,0x0011edc0) */
/* WARNING: Removing unreachable block (ram,0x0011ecdc) */
/* WARNING: Removing unreachable block (ram,0x0011ece6) */
/* WARNING: Removing unreachable block (ram,0x0011eda0) */
/* WARNING: Removing unreachable block (ram,0x0011ecf2) */
/* WARNING: Removing unreachable block (ram,0x0011ecfc) */
/* WARNING: Removing unreachable block (ram,0x0011ed80) */
/* WARNING: Removing unreachable block (ram,0x0011ed04) */
/* WARNING: Removing unreachable block (ram,0x0011ed1a) */
/* WARNING: Removing unreachable block (ram,0x0011ed26) */
...
/* WARNING: Removing unreachable block (ram,0x0011efc0) */
/* WARNING: Removing unreachable block (ram,0x0011f0f0) */
/* WARNING: Removing unreachable block (ram,0x0011f269) */
/* WARNING: Removing unreachable block (ram,0x0011f0fc) */
/* WARNING: Removing unreachable block (ram,0x0011f106) */
/* WARNING: Removing unreachable block (ram,0x0011f24b) */
/* WARNING: Removing unreachable block (ram,0x0011f112) */
/* WARNING: Removing unreachable block (ram,0x0011f11c) */
/* WARNING: Removing unreachable block (ram,0x0011f22d) */
/* WARNING: Removing unreachable block (ram,0x0011f128) */
/* WARNING: Removing unreachable block (ram,0x0011f132) */
/* WARNING: Removing unreachable block (ram,0x0011f20f) */
/* WARNING: Removing unreachable block (ram,0x0011f13e) */
/* WARNING: Removing unreachable block (ram,0x0011f148) */
/* WARNING: Removing unreachable block (ram,0x0011f1f1) */
/* WARNING: Removing unreachable block (ram,0x0011f154) */
/* WARNING: Removing unreachable block (ram,0x0011f15e) */
/* WARNING: Removing unreachable block (ram,0x0011f1d3) */
/* WARNING: Removing unreachable block (ram,0x0011f166) */
/* WARNING: Removing unreachable block (ram,0x0011f170) */
/* WARNING: Removing unreachable block (ram,0x0011f1b8) */
/* WARNING: Removing unreachable block (ram,0x0011f178) */
/* WARNING: Removing unreachable block (ram,0x0011f18e) */
/* WARNING: Removing unreachable block (ram,0x0011f19a) */
...
/* WARNING: Removing unreachable block (ram,0x0011f8d0) */
/* WARNING: Removing unreachable block (ram,0x0011fa00) */
/* WARNING: Removing unreachable block (ram,0x0011fb79) */
/* WARNING: Removing unreachable block (ram,0x0011fa0c) */
/* WARNING: Removing unreachable block (ram,0x0011fa16) */
/* WARNING: Removing unreachable block (ram,0x0011fb5b) */
/* WARNING: Removing unreachable block (ram,0x0011fa22) */
/* WARNING: Removing unreachable block (ram,0x0011fa2c) */
/* WARNING: Removing unreachable block (ram,0x0011fb3d) */
/* WARNING: Removing unreachable block (ram,0x0011fa38) */
/* WARNING: Removing unreachable block (ram,0x0011fa42) */
/* WARNING: Removing unreachable block (ram,0x0011fb1f) */
/* WARNING: Removing unreachable block (ram,0x0011fa4e) */
/* WARNING: Removing unreachable block (ram,0x0011fa58) */
/* WARNING: Removing unreachable block (ram,0x0011fb01) */
/* WARNING: Removing unreachable block (ram,0x0011fa64) */
/* WARNING: Removing unreachable block (ram,0x0011fa6e) */
/* WARNING: Removing unreachable block (ram,0x0011fae3) */
/* WARNING: Removing unreachable block (ram,0x0011fa76) */
/* WARNING: Removing unreachable block (ram,0x0011fa80) */
/* WARNING: Removing unreachable block (ram,0x0011fac8) */
/* WARNING: Removing unreachable block (ram,0x0011fa88) */
/* WARNING: Removing unreachable block (ram,0x0011fa9e) */
/* WARNING: Removing unreachable block (ram,0x0011faaa) */
...
LAB_0011fd1a:
    if ((uint)uVar5 < (uint)uVar9) goto LAB_0011fd5b;
    lVar8 = 0;
    while( true ) {
...

{
  ...
  *(undefined ***)this = &PTR__RID_Alloc_00126478;
  ...
  if (uVar3 == 0) {
    ...
    puVar10 = *(undefined8 **)(this + 8);
LAB_0011ff6a:
    if ((uint)uVar5 < (uint)uVar9) goto LAB_0011ffab;
    lVar8 = 0;
    while( true ) {
      Memory::free_static((void *)puVar10[lVar8],false);
      lVar2 = lVar8 * 8;
...
LAB_001201fa:
    if ((uint)uVar5 < (uint)uVar8) goto LAB_0012023b;
    lVar7 = 0;
    while( true ) {
...

{
  ...
  *(undefined ***)this = &PTR__RID_Alloc_00126478;
  ...
  if (uVar3 == 0) {
    ...
    puVar10 = *(undefined8 **)(this + 8);
LAB_0012046a:
    if ((uint)uVar5 < (uint)uVar9) goto LAB_001204ab;
    lVar8 = 0;
    while( true ) {
      Memory::free_static((void *)puVar10[lVar8],false);
      lVar2 = lVar8 * 8;
...

{
  ...
  *(undefined ***)this = &PTR__RID_Alloc_00126458;
  ...
  if (uVar3 == 0) {
    ...
    puVar10 = *(undefined8 **)(this + 8);
LAB_0012069a:
    if ((uint)uVar5 < (uint)uVar9) goto LAB_001206db;
    lVar8 = 0;
    while( true ) {
      Memory::free_static((void *)puVar10[lVar8],false);
      lVar2 = lVar8 * 8;
...
LAB_001215cd:
  ...
  if (uVar6 + 1 == lVar5) {
    ...
    lVar9 = puVar7[-1];
LAB_001214b0:
    if (param_1 <= lVar9) goto LAB_00121465;
  }
  else {
    if (lVar9 != 0) {
      puVar4 = (undefined8 *)
...

{
  ...
  *(undefined ***)this = &PTR__RID_Alloc_001264b8;
  ...
  if (uVar4 == 0) {
    ...
    puVar10 = *(undefined8 **)(this + 8);
LAB_0012182a:
    if ((uint)uVar6 < (uint)uVar9) goto LAB_0012186b;
    lVar8 = 0;
    while( true ) {
      Memory::free_static((void *)puVar10[lVar8],false);
      lVar3 = lVar8 * 8;
...
LAB_001228d0:
  ...
  if (uVar5 + 1 == lVar4) {
    ...
    lVar4 = puVar8[-1];
LAB_001227d9:
    if (param_1 <= lVar4) goto LAB_0012274a;
  }
  else {
    if (lVar9 != 0) {
      puVar6 = (undefined8 *)
...
LAB_0012386d:
  ...
  if (uVar6 + 1 == lVar5) {
    ...
    lVar9 = puVar7[-1];
LAB_00123750:
    if (param_1 <= lVar9) goto LAB_00123705;
  }
  else {
    if (lVar9 != 0) {
      puVar4 = (undefined8 *)
...
LAB_00123e50:
  ...
  if (uVar4 + 1 == lVar3) {
    ...
    lVar3 = puVar7[-1];
LAB_00123d59:
    if (param_1 <= lVar3) goto LAB_00123cc8;
  }
  else {
    if (lVar9 != 0) {
      puVar5 = (undefined8 *)
...
LAB_001251e5:
  ...
  if (uVar8 + 1 == lVar7) {
    ...
    lVar10 = puVar6[-1];
LAB_001250c0:
    if (param_1 <= lVar10) goto LAB_00125071;
  }
  else {
    if (lVar10 != 0) {
      puVar4 = (undefined8 *)

...
LAB_0010a160:
    *(undefined8 *)(param_1 + 8) = 0;
    ...
    lVar10 = ((param_3 & 0xffffffff) % (ulong)*(uint *)(param_2 + 0x50)) * 0x80 +
...
LAB_0010a249:
        if (puVar11 == (undefined8 *)0x0) goto LAB_0010a190;
      }
      else {
...
LAB_00109c60:
      ...
      do {
        ...
        local_50 = 0;
        local_48 = 0;
        _build_variant_code(param_2,(StringBuilder *)&local_78,uVar13 & 0xffffffff,lVar10,0,
...
LAB_00109ccd:
        ...
        CowData<RenderingServer::ShaderNativeSourceCode::Version>::_copy_on_write(this);
        local_88 = (char *)0x0;
        pVVar8 = (Vector<RenderingServer::ShaderNativeSourceCode::Version::Stage> *)
        ...
        local_50 = 0;
        local_48 = 0;
        _build_variant_code(param_2,(StringBuilder *)&local_78,(int)uVar13,lVar10,1,
                            *(undefined8 *)(param_2 + 0x110));
        local_98 = (undefined1  [16])0x0;
        local_88 = "fragment";
        local_80 = 8;
...
LAB_0010a550:
        *(uint *)pVVar9 = uVar8;
        ...
        puVar3 = (undefined8 *)
                 (*(long *)(pVVar9 + 8) + 0x10 + ((ulong)(uVar1 - uVar11) + (ulong)uVar11) * 0x10);
      ...
      for (puVar3 = *(undefined8 **)(param_3 + 0x18); puVar3 != (undefined8 *)0x0;
        ...
        plVar5 = (long *)HashMap<StringName,CharString,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,CharString>>>
                         ::operator[]((HashMap<StringName,CharString,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,CharString>>>
                                       *)(pVVar9 + 0x28),(StringName_conflict *)&local_50);
        lVar14 = *plVar5;
        if (lVar14 != local_48) {
          if (lVar14 != 0) {
            LOCK();
      ...
      for (lVar12 = 0; (lVar14 != 0 && (lVar12 < *(long *)(lVar14 + -8))); lVar12 = lVar12 + 1) {
        ...
        if (iVar4 == 0) {
          ...
          _err_print_index_error
                    ("set","./core/templates/cowdata.h",0xcf,lVar13,lVar14,"p_index","size()","",
                     false,false);
        }
        else {
          _err_print_error("push_back","./core/templates/vector.h",0x142,
...
/* WARNING: Removing unreachable block (ram,0x0010bdcd) */
...
/* WARNING: Removing unreachable block (ram,0x0010c1b0) */
/* WARNING: Removing unreachable block (ram,0x0010c345) */
/* WARNING: Removing unreachable block (ram,0x0010c351) */
...
LAB_0010d613:
    if ((uint)uVar4 < uVar8) goto LAB_0010d65b;
    lVar7 = 0;
    while( true ) {
...

{
  ...
  *(undefined ***)this = &PTR__RID_Alloc_0010fce8;
  ...
  if (uVar8 == 0) {
    ...
    puVar5 = *(undefined8 **)(this + 8);
LAB_0010d853:
    if ((uint)uVar4 < uVar8) goto LAB_0010d89b;
    lVar7 = 0;
    while( true ) {
      Memory::free_static((void *)puVar5[lVar7],false);
      lVar2 = lVar7 * 8;
...
LAB_0010df2e:
    ...
    iVar33 = 0;
LAB_0010df0c:
    if ((float)uVar37 * __LC111 < (float)(iVar33 + 1)) goto LAB_0010df2e;
  }
  local_68 = (undefined1  [16])0x0;
...
LAB_0010efa9:
    if ((float)uVar23 * __LC111 < (float)(iVar28 + 1)) goto LAB_0010efcb;
  }
...

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0x1c))) {
    puVar10 = (uint *)(((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x18)) * 0x80 +
                      *(long *)(*(long *)(this + 8) +
...
LAB_0010f7e0:
        ...
        puVar10[5] = 0;
        if (*(long *)(param_3 + 4) != 0) {
          CowData<char>::_ref((CowData<char> *)(puVar10 + 4),(CowData *)(param_3 + 4));
        }
        puVar10[6] = 0;
        puVar10[7] = 0;
        if (*(long *)(param_3 + 6) != 0) {
          CowData<char>::_ref((CowData<char> *)(puVar10 + 6),(CowData *)(param_3 + 6));
        }
        puVar10[8] = 0;
        puVar10[9] = 0;
        if (*(long *)(param_3 + 8) != 0) {
          CowData<char>::_ref((CowData<char> *)(puVar10 + 8),(CowData *)(param_3 + 8));
        }
        uVar2 = param_3[0x14];
        puVar10[0x14] = 0;
        puVar10[0x15] = 0;
...
LAB_0010f580:
        if ((param_3[0x15] != 0) && (plVar7 = *(long **)(param_3 + 0x10), plVar7 != (long *)0x0)) {
          do {
            HashMap<StringName,CharString,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,CharString>>>
            ::insert(aSStack_38,(CharString *)(puVar10 + 10),(bool)((char)plVar7 + '\x10'));
            plVar7 = (long *)*plVar7;

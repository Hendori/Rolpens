...
JoltContactListener3D::OnSoftBodyContactValidate
          (JoltContactListener3D *this,Body *param_1,Body *param_2,SoftBodyContactSettings *param_3)
...
/* non-virtual thunk to JoltContactListener3D::OnSoftBodyContactValidate(JPH::Body const&, JPH::Body
   const&, JPH::SoftBodyContactSettings&) */
...
undefined8 __thiscall
JoltContactListener3D::_try_override_collision_response
          (JoltContactListener3D *this,Body *param_1,Body *param_2,ContactSettings *param_3)
...
undefined8 __thiscall
JoltContactListener3D::_try_apply_surface_velocities
          (JoltContactListener3D *this,Body *param_1,Body *param_2,ContactSettings *param_3)

{
  ...
  if ((((byte)param_1[0x79] & 1) == 0) && (((byte)param_2[0x79] & 1) == 0)) {
    ...
    if ((BVar1 != (Body)0x2) != (BVar2 != (Body)0x2)) {
      ...
      if (BVar1 == (Body)0x2) {
LAB_00100470:
        if (BVar2 == (Body)0x2) goto LAB_0010036d;
...
LAB_00100634:
          ...
          this = (JoltContactListener3D *)(ulong)uVar16;
...
LAB_001005da:
      ...
      *(float *)(param_3 + 0x20) =
           ((fVar20 * (fVar7 - fVar10) - (fVar8 - fVar11) * fStack_38) + local_48) - local_60;
      *(float *)(param_3 + 0x24) =
           ((local_3c * (fVar8 - fVar11) - (fVar6 - fVar9) * fVar20) + fStack_44) - fStack_5c;
...
undefined8 __thiscall
JoltContactListener3D::_try_add_debug_contacts
          (JoltContactListener3D *this,Body *param_1,Body *param_2,ContactManifold *param_3)

{
  ...
  if ((*(long *)(this + 0xf0) == 0) ||
     (lVar13 = *(long *)(*(long *)(this + 0xf0) + -8), lVar13 == 0)) {
    return 0;
  }
  ...
  uVar9 = CONCAT44(*(float *)(param_3 + 0x44) + *(float *)(param_3 + 4),
                   *(float *)(param_3 + 0x40) + *(float *)param_3);
  lVar14 = lVar11;
  if (lVar11 < 0) {
    if (lVar13 != 0) {
LAB_001008bd:
    ...
    lVar12 = (lVar11 * 3 + 3) * 4;
    uVar8 = CONCAT44(*(float *)(param_3 + 4) + *(float *)(param_3 + 0x454),
                     *(float *)param_3 + *(float *)(param_3 + 0x450));
    while (lVar13 != 0) {
...
LAB_0010090b:
        _err_print_index_error
                  ("operator[]","./core/templates/vector.h",0x38,lVar14 + 1,lVar13,"p_index",
      ...
      *(float *)(puVar2 + 1) = fVar16;
      ...
      uVar9 = CONCAT44(*(float *)(pCVar3 + 4) + *(float *)(param_3 + 4),
                       *(float *)pCVar3 + *(float *)param_3);
      uVar8 = CONCAT44(*(float *)(param_3 + 4) + *(float *)(pCVar4 + 4),
                       *(float *)param_3 + *(float *)pCVar4);
    }
  }
  lVar13 = 0;
LAB_001008c1:
  _err_print_index_error
            ("operator[]","./core/templates/vector.h",0x38,lVar14,lVar13,"p_index",
             "((Vector<T> *)(this))->_cowdata.size()","",false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar7 = (code *)invalidInstructionException();
...
/* JoltContactListener3D::_try_add_debug_contacts(JPH::Body const&, JPH::SoftBodyManifold const&) */

undefined8 __thiscall
JoltContactListener3D::_try_add_debug_contacts
          (JoltContactListener3D *this,Body *param_1,SoftBodyManifold *param_2)

{
  ...
  if ((*(long *)(this + 0xf0) == 0) ||
     (lVar11 = *(long *)(*(long *)(this + 0xf0) + -8), lVar11 == 0)) {
LAB_00100c88:
    uVar6 = 0;
  }
  else {
    ...
    for (; lVar5 != lVar11; lVar11 = lVar11 + 0x50) {
      if (*(char *)(lVar11 + 0x44) != '\0') {
        ...
        fVar16 = *(float *)(lVar11 + 0x18) * *(float *)(lVar11 + 0x38) +
                 *(float *)(lVar11 + 0x34) * *(float *)(lVar11 + 0x14) +
                 *(float *)(lVar11 + 0x10) * *(float *)(lVar11 + 0x30) + 0.0 +
                 *(float *)(lVar11 + 0x3c);
...
LAB_00100c3f:
          ...
          *puVar1 = CONCAT44((fVar24 * fVar23 + fVar20) * fVar17 +
                             (fVar21 - fVar10 * fVar23) * fVar18 +
                             (fVar7 * fVar25 - fVar23 * fVar22) * fVar19 + fStack_54,
                             (fVar28 - fVar27) * fVar17 + (fVar24 * fVar23 - fVar20) * fVar18 +
                             (fVar7 * fVar23 + fVar25 * fVar22) * fVar19 + local_58);
          *(float *)(puVar1 + 1) =
               (fVar7 * fVar23 - fVar25 * fVar22) * fVar17 +
               (fVar23 * fVar22 + fVar7 * fVar25) * fVar18 + (fVar16 - fVar24 * fVar25) * fVar19 +
               fVar3;
          goto LAB_00100a80;
        }
        lVar12 = 0;
...
void __thiscall
JoltContactListener3D::OnSoftBodyContactAdded
          (JoltContactListener3D *this,Body *param_1,SoftBodyManifold *param_2)
...
void __thiscall JoltContactListener3D::_flush_contacts(JoltContactListener3D *this)
  ...
  if (plVar8 != (long *)0x0) {
    do {
      ...
      if (((local_48 == 0) ||
        ...
        _err_print_error("_flush_contacts",
                         "modules/jolt_physics/spaces/jolt_contact_listener_3d.cpp",0x19c,
                         "Parameter \"body1\" is null.",0,0);
LAB_00101059:
        JoltBodyAccessor3D::release();
      ...
      local_48 = JoltBodyReader3D::try_get();
      if (((local_48 == 0) ||
          (pSVar3 = *(SubShapeID **)(local_48 + 0x50), pSVar3 == (SubShapeID *)0x0)) ||
         (pSVar3[0x3c] != (SubShapeID)0x1)) {
        JoltBodyAccessor3D::release();
        local_88[0] = JoltShapedObject3D::find_shape_index;
        JoltBodyAccessor3D::~JoltBodyAccessor3D((JoltBodyAccessor3D *)local_88);
        _err_print_error("_flush_contacts",
                         "modules/jolt_physics/spaces/jolt_contact_listener_3d.cpp",0x19f,
                         "Parameter \"body2\" is null.",0,0);
        goto LAB_00101059;
      }
      JoltBodyAccessor3D::release();
      local_88[0] = JoltShapedObject3D::find_shape_index;
      ...
      for (; pVVar1 != pVVar9; pVVar9 = pVVar9 + 0x48) {
        JoltBody3D::add_contact
                  ((JoltBody3D *)pSVar2,*(float *)(plVar8 + 8),(int)pSVar3,uVar5,
                   (Vector3 *)(ulong)uVar6,pVVar9 + 0x18,pVVar9,pVVar9 + 0xc,pVVar9 + 0x24,
                   pVVar9 + 0x30);
      }
      uVar7 = *(uint *)(plVar8 + 6);
      ...
      if (pVVar1 != pVVar9) {
        do {
          pVVar11 = pVVar9 + 0x48;
          JoltBody3D::add_contact
                    ((JoltBody3D *)pSVar3,*(float *)(plVar8 + 8),(int)pSVar2,uVar6,
                     (Vector3 *)(ulong)uVar5,pVVar9 + 0x18,pVVar9,pVVar9 + 0xc,pVVar9 + 0x24,
                     pVVar9 + 0x30);
          pVVar9 = pVVar11;
...
void __thiscall JoltContactListener3D::_flush_area_enters(JoltContactListener3D *this)
  ...
  if (iVar1 != 0) {
    ...
    while( true ) {
      ...
      if ((local_98 != 0) && (local_48 != 0)) {
        ...
        else if ((*(long *)(local_48 + 0x50) == 0) ||
                (*(char *)(*(long *)(local_48 + 0x50) + 0x3c) != '\x03')) {
    ...
    if ((*(long *)(this + 0x68) != 0) && (*(int *)(this + 0x8c) != 0)) {
      if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x88) * 4) != 0) {
        memset(*(void **)(this + 0x80),0,
               (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x88) * 4) * 4);
      }
...
void __thiscall JoltContactListener3D::_flush_area_exits(JoltContactListener3D *this)
...
LAB_001016b0:
        ...
        if (pBVar10 == (BodyID *)0x0) {
          if ((local_48 != 0) && (pBVar11 = *(BodyID **)(local_48 + 0x50), pBVar11 != (BodyID *)0x0)
            ...
            if (pBVar11[0x3c] != (BodyID)0x3) {
LAB_001017b0:
              if (pBVar10 == (BodyID *)0x0) goto LAB_00101889;
              bVar7 = 0;
              BVar3 = pBVar10[0x3c];
              bVar6 = false;
              pBVar15 = (BodyID *)0x0;
LAB_0010158c:
          ...
          if (BVar3 == (BodyID)0x3) {
            ...
            if (local_48 != 0) {
              ...
              if (pBVar11 != (BodyID *)0x0) {
LAB_0010157a:
                if (pBVar11[0x3c] != (BodyID)0x3) goto LAB_001017b0;
                bVar7 = 1;
                pBVar15 = pBVar11;
                bVar6 = bVar5;
                goto LAB_0010158c;
...
LAB_0010159f:
              if (pBVar11 != (BodyID *)0x0) goto LAB_001015a8;
              goto LAB_001016b0;
            }
            pBVar14 = (BodyID *)0x0;
            pBVar11 = (BodyID *)0x0;
  ...
  if ((*(long *)(this + 0x90) != 0) && (*(int *)(this + 0xb4) != 0)) {
    if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0xb0) * 4) != 0) {
      memset(*(void **)(this + 0xa8),0,
             (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0xb0) * 4) * 4);
    }
...
undefined4 __thiscall JoltContactListener3D::pre_step(JoltContactListener3D *this)
...
JoltContactListener3D::_try_remove_contacts(JoltContactListener3D *this,SubShapeIDPair *param_1)

{
  ...
  if (iVar1 == 0) {
    uVar2 = HashMap<JPH::SubShapeIDPair,JoltContactListener3D::Manifold,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>,DefaultTypedAllocator<HashMapElement<JPH::SubShapeIDPair,JoltContactListener3D::Manifold>>>
            ::erase((HashMap<JPH::SubShapeIDPair,JoltContactListener3D::Manifold,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>,DefaultTypedAllocator<HashMapElement<JPH::SubShapeIDPair,JoltContactListener3D::Manifold>>>
                     *)(this + 0x10),param_1);
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (((((byte)param_1[0x79] & 1) == 0) && (((byte)param_2[0x79] & 1) == 0)) &&
     ((*(int *)(*(long *)(param_1 + 0x50) + 0xd8) != 0 ||
      (*(int *)(*(long *)(param_2 + 0x50) + 0xd8) != 0)))) {
    ...
    puVar9 = (uint *)HashMap<JPH::SubShapeIDPair,JoltContactListener3D::Manifold,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>,DefaultTypedAllocator<HashMapElement<JPH::SubShapeIDPair,JoltContactListener3D::Manifold>>>
                     ::operator[]((HashMap<JPH::SubShapeIDPair,JoltContactListener3D::Manifold,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>,DefaultTypedAllocator<HashMapElement<JPH::SubShapeIDPair,JoltContactListener3D::Manifold>>>
                                   *)(this + 0x10),(SubShapeIDPair *)&local_3c8);
    pthread_mutex_unlock((pthread_mutex_t *)(this + 0xb8));
...
LAB_00101ed7:
    ...
    JPH::EstimateCollisionResponse
              (param_1,param_2,param_3,local_3b8,*(float *)param_4,*(float *)(param_4 + 4),fVar18,5)
    ;
    if (uVar4 != 0) {
      pfVar16 = local_354;
      pCVar17 = param_3;
...
LAB_00101d0a:
          ...
          auVar20 = SUB1612(*(undefined1 (*) [16])param_2,0);
          fVar21 = ((fVar35 - *(float *)(param_1 + 8)) * pfVar10[5] -
                   pfVar10[6] * (fVar34 - *(float *)(param_1 + 4))) + *pfVar10;
          fVar22 = ((fVar33 - *(float *)param_1) * pfVar10[6] -
                   pfVar10[4] * (fVar35 - *(float *)(param_1 + 8))) + pfVar10[1];
          fVar23 = ((fVar34 - *(float *)(param_1 + 4)) * pfVar10[4] -
                   pfVar10[5] * (fVar33 - *(float *)param_1)) + pfVar10[2];
          pfVar10 = *(float **)(param_2 + 0x48);
          if (param_2[0x78] == (Body)0x0) goto LAB_00101d0a;
LAB_00101b2c:
          fVar27 = fVar18 - auVar20._0_4_;
...
undefined4 __thiscall
JoltContactListener3D::_try_remove_area_overlap(JoltContactListener3D *this,SubShapeIDPair *param_1)

{
  ...
  uVar2 = HashSet<JPH::SubShapeIDPair,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>>
          ::erase((HashSet<JPH::SubShapeIDPair,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>>
                   *)(this + 0x40),param_1);
  if ((char)uVar2 != '\0') {
    HashSet<JPH::SubShapeIDPair,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>>
    ::insert(local_58);
  }
  uVar3 = HashSet<JPH::SubShapeIDPair,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>>
          ::erase((HashSet<JPH::SubShapeIDPair,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>>
                   *)(this + 0x40),(SubShapeIDPair *)&local_68);
  if ((char)uVar3 != '\0') {
    HashSet<JPH::SubShapeIDPair,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>>
    ::insert(local_58);
    uVar2 = uVar3;
...
void __thiscall
JoltContactListener3D::OnContactRemoved(JoltContactListener3D *this,SubShapeIDPair *param_1)
...
void __thiscall JoltContactListener3D::_flush_area_shifts(JoltContactListener3D *this)
...
LAB_001021fe:
  ...
  do {
    ...
    if (((local_48 == 0) || (lVar2 = *(long *)(local_48 + 0x50), lVar2 == 0)) ||
       (*(char *)(lVar2 + 0x3c) == '\x02')) {
      _err_print_error("operator()","modules/jolt_physics/spaces/jolt_contact_listener_3d.cpp",0x1d7
...
LAB_00102281:
      ...
      if (((local_48 == 0) || (lVar2 = *(long *)(local_48 + 0x50), lVar2 == 0)) ||
         (*(char *)(lVar2 + 0x3c) == '\x02')) {
        _err_print_error("operator()","modules/jolt_physics/spaces/jolt_contact_listener_3d.cpp",
                         0x1d7,"Parameter \"object\" is null.",0,0);
      }
      else {
...
LAB_001021f5:
    if (iVar1 <= local_a8) goto LAB_001021fe;
    local_a8 = local_a8 + 1;
    lVar7 = lVar7 + 0x10;
  } while( true );
}
...
void __thiscall JoltContactListener3D::post_step(JoltContactListener3D *this)
...
byte __thiscall
JoltContactListener3D::_try_evaluate_area_overlap
          (JoltContactListener3D *this,Body *param_1,Body *param_2,ContactManifold *param_3)

{
  ...
  if ((((byte)param_1[0x79] & 1) == 0) &&
     (bVar5 = (byte)param_2[0x79] & 1, ((byte)param_2[0x79] & 1) == 0)) goto LAB_00102535;
...
LAB_0010270e:
      ...
      if (cVar4 == '\0') {
        cVar4 = HashSet<JPH::SubShapeIDPair,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>>
                ::erase((HashSet<JPH::SubShapeIDPair,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>>
                         *)(this + 0x40),(SubShapeIDPair *)&local_78);
        if (cVar4 != '\0') {
          HashSet<JPH::SubShapeIDPair,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>>
          ::insert((SubShapeIDPair *)local_58);
        }
      }
      else {
        local_58[0] = 0;
        cVar4 = HashSet<JPH::SubShapeIDPair,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>>
                ::_lookup_pos((HashSet<JPH::SubShapeIDPair,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>>
                               *)(this + 0x40),(SubShapeIDPair *)&local_78,(uint *)local_58);
        if (cVar4 == '\0') {
          HashSet<JPH::SubShapeIDPair,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>>
          ::insert((SubShapeIDPair *)local_58);
          HashSet<JPH::SubShapeIDPair,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>>
...
LAB_00102611:
      ...
      cVar4 = HashSet<JPH::SubShapeIDPair,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>>
              ::_lookup_pos((HashSet<JPH::SubShapeIDPair,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>>
                             *)(this + 0x40),pSVar7,(uint *)local_58);
      if (cVar4 == '\0') {
        HashSet<JPH::SubShapeIDPair,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>>
        ::insert((SubShapeIDPair *)local_58);
        HashSet<JPH::SubShapeIDPair,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>>
...
void __thiscall
JoltContactListener3D::OnContactPersisted
          (JoltContactListener3D *this,Body *param_1,Body *param_2,ContactManifold *param_3,
          ContactSettings *param_4)
...

{
  ...
  if (lVar6 != 0) {
    ...
    uVar29 = (*(int *)param_1 * 0x16a88000 | (uint)(*(int *)param_1 * -0x3361d2af) >> 0x11) *
    ...
    uVar29 = (uVar29 << 0xd | uVar29 >> 0x13) * 5 + 0xe6546b64 ^
             (*(int *)(param_1 + 0xc) * 0x16a88000 |
             (uint)(*(int *)(param_1 + 0xc) * -0x3361d2af) >> 0x11) * 0x1b873593;
    uVar29 = (uVar29 << 0xd | uVar29 >> 0x13) * 5 + 0xe6546b64;
      ...
      do {
        ...
        if (uVar35 == uVar29) {
          ...
          if (iVar30 == 0xf) {
            ...
            uVar29 = *puVar39;
            if ((uVar29 != 0) &&
               (auVar15._8_8_ = 0, auVar15._0_8_ = uVar29 * uVar7, auVar24._8_8_ = 0,
               auVar24._0_8_ = uVar40, auVar16._8_8_ = 0,
               auVar16._0_8_ = ((uVar31 + uVar5) - SUB164(auVar15 * auVar24,8)) * uVar7,
               auVar25._8_8_ = 0, auVar25._0_8_ = uVar40, uVar32 = (ulong)uVar31, uVar37 = uVar36,
              ...
              while( true ) {
                ...
                *puVar3 = uVar10;
                ...
                uVar29 = *puVar39;
                if ((uVar29 == 0) ||
                   (auVar17._8_8_ = 0, auVar17._0_8_ = uVar29 * uVar7, auVar26._8_8_ = 0,
                   auVar26._0_8_ = uVar40, auVar18._8_8_ = 0,
                   auVar18._0_8_ =
                        ((SUB164(auVar19 * auVar28,8) + uVar5) - SUB164(auVar17 * auVar26,8)) *
                        uVar7, auVar27._8_8_ = 0, auVar27._0_8_ = uVar40,
        ...
        uVar38 = uVar38 + 1;
              ...
              (auVar12._8_8_ = 0, auVar12._0_8_ = uVar29 * uVar7, auVar21._8_8_ = 0,
              auVar21._0_8_ = uVar40, auVar13._8_8_ = 0,
              auVar13._0_8_ = ((uVar5 + uVar31) - SUB164(auVar12 * auVar21,8)) * uVar7,
              auVar22._8_8_ = 0, auVar22._0_8_ = uVar40, uVar32 = uVar33,
              uVar38 <= SUB164(auVar13 * auVar22,8)));
    }
  }
  return 0;
}
...
undefined8 __thiscall
HashMap<JPH::SubShapeIDPair,JoltContactListener3D::Manifold,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>,DefaultTypedAllocator<HashMapElement<JPH::SubShapeIDPair,JoltContactListener3D::Manifold>>>
::_lookup_pos(HashMap<JPH::SubShapeIDPair,JoltContactListener3D::Manifold,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>,DefaultTypedAllocator<HashMapElement<JPH::SubShapeIDPair,JoltContactListener3D::Manifold>>>
              *this,SubShapeIDPair *param_1,uint *param_2)

{
  ...
  if ((*(long *)(this + 8) != 0) && (*(int *)(this + 0x2c) != 0)) {
    ...
    uVar10 = (*(int *)param_1 * 0x16a88000 | (uint)(*(int *)param_1 * -0x3361d2af) >> 0x11) *
             0x1b873593 ^ 0x7f07c65;
      ...
      do {
        ...
        uVar12 = SUB164(auVar3 * auVar7,8);
              ...
              auVar5._0_8_ = ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x28) * 4)
                              + uVar12) - SUB164(auVar4 * auVar8,8)) * uVar1, auVar9._8_8_ = 0,
    ...
    if (uVar11 != 0) {
      ...
      do {
        ...
        iVar13 = SUB164(auVar4 * auVar8,8);
              ...
              auVar6._0_8_ = ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x20) * 4)
                              + iVar13) - SUB164(auVar5 * auVar9,8)) * uVar2, auVar10._8_8_ = 0,
...
/* HashSet<JPH::SubShapeIDPair, JoltContactListener3D::ShapePairHasher,
   HashMapComparatorDefault<JPH::SubShapeIDPair> >::erase(JPH::SubShapeIDPair const&) */
...

{
  ...
  if ((char)uVar26 != '\0') {
    ...
    if ((*puVar36 == 0) ||
       (auVar13._8_8_ = 0, auVar13._0_8_ = (ulong)*puVar36 * lVar10, auVar19._8_8_ = 0,
       auVar19._0_8_ = uVar33, auVar14._8_8_ = 0,
       auVar14._0_8_ = (ulong)((uVar27 + uVar31) - SUB164(auVar13 * auVar19,8)) * lVar10,
       auVar20._8_8_ = 0, auVar20._0_8_ = uVar33, SUB164(auVar14 * auVar20,8) == 0)) {
      ...
      while( true ) {
        ...
        *puVar1 = uVar31;
        ...
        puVar36 = (uint *)(lVar9 + lVar29);
        if ((*puVar36 == 0) ||
           (auVar15._8_8_ = 0, auVar15._0_8_ = (ulong)*puVar36 * lVar10, auVar21._8_8_ = 0,
           auVar21._0_8_ = uVar33, auVar16._8_8_ = 0,
           auVar16._0_8_ =
                (ulong)((SUB164(auVar17 * auVar23,8) + uVar27) - SUB164(auVar15 * auVar21,8)) *
                lVar10, auVar22._8_8_ = 0, auVar22._0_8_ = uVar33, SUB164(auVar16 * auVar22,8) == 0)
           ) break;
        uVar34 = uVar37;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashSet<JPH::SubShapeIDPair, JoltContactListener3D::ShapePairHasher,
   HashMapComparatorDefault<JPH::SubShapeIDPair> >::insert(JPH::SubShapeIDPair const&) */

SubShapeIDPair *
HashSet<JPH::SubShapeIDPair,JoltContactListener3D::ShapePairHasher,HashMapComparatorDefault<JPH::SubShapeIDPair>>
::insert(SubShapeIDPair *param_1)

{
  ...
  *in_RSI;
  ...
  if (cVar24 == '\0') {
    ...
    uVar34 = (ulong)uVar38;
    uVar25 = (*(int *)in_RDX * 0x16a88000 | (uint)(*(int *)in_RDX * -0x3361d2af) >> 0x11) *
             0x1b873593 ^ 0x7f07c65;
    uVar25 = (uVar25 << 0xd | uVar25 >> 0x13) * 5 + 0xe6546b64 ^
             (*(int *)(in_RDX + 4) * 0x16a88000 | (uint)(*(int *)(in_RDX + 4) * -0x3361d2af) >> 0x11
             ) * 0x1b873593;
    uVar25 = (uVar25 << 0xd | uVar25 >> 0x13) * 5 + 0xe6546b64 ^
             (*(int *)(in_RDX + 8) * 0x16a88000 | (uint)(*(int *)(in_RDX + 8) * -0x3361d2af) >> 0x11
             ) * 0x1b873593;
    uVar25 = (uVar25 << 0xd | uVar25 >> 0x13) * 5 + 0xe6546b64 ^
             (*(int *)(in_RDX + 0xc) * 0x16a88000 |
             (uint)(*(int *)(in_RDX + 0xc) * -0x3361d2af) >> 0x11) * 0x1b873593;
    uVar25 = (uVar25 << 0xd | uVar25 >> 0x13) * 5 + 0xe6546b64;
    uVar25 = (uVar25 >> 0x10 ^ uVar25) * -0x7a143595;
...
void JoltContactListener3D::_GLOBAL__sub_I_OnContactAdded(void)

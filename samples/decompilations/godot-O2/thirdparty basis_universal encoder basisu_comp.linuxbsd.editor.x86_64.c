  ...
  *piVar17 = 0;
  ...
  do {
    if (*(ushort *)(param_1 + lVar11 * 2 + (long)puVar29 * 0x240 + 0x81ca) != 0) {
      ...
      iVar24 = iVar24 + 1;
      local_1148[lVar19] =
           (uint)*(ushort *)(param_1 + lVar11 * 2 + (long)puVar29 * 0x240 + 0x81ca) |
           (int)lVar11 << 0x10;
    }
    lVar11 = lVar11 + 1;
  } while (lVar11 != lVar25);
    ...
    if (iVar24 != 1) {
      ...
      *(ushort *)puVar23 = uVar16;
      if (1 < (int)uVar12) {
        ...
        iVar10 = 2;
        do {
          if ((iVar10 < iVar24) && (uVar9 = (ushort)puVar23[iVar10], uVar9 <= uVar16)) {
            iVar10 = iVar10 + 1;
...
LAB_0010056c:
            ...
            uVar16 = (ushort)*puVar6;
LAB_00100578:
            *(ushort *)(puVar23 + lVar11) = uVar16 + uVar9;
            iVar4 = iVar4 + 1;
...
LAB_0010068d:
          ...
          uVar16 = (ushort)uVar3;
          if (((int)puVar6 -
               (int)(puVar23 + (((long)iVar27 + -1) - (ulong)(uint)((iVar4 + -1) - iVar15))) & 4U)
              == 0) goto LAB_001006c8;
          *(ushort *)puVar6 = uVar16;
          for (puVar6 = puVar6 + -1;
              puVar23 + (((long)iVar27 + -1) - (ulong)(uint)((iVar4 + -1) - iVar15)) != puVar6;
              puVar6 = puVar6 + -2) {
LAB_001006c8:
            *(ushort *)puVar6 = uVar16;
...
LAB_00100704:
  ...
  *(undefined8 *)(ptVar18 + 0x118) = 0;
  ...
  for (uVar12 = (ulong)(((int)ptVar18 -
                        (int)(undefined8 *)((ulong)(ptVar18 + 8) & 0xfffffffffffffff8)) + 0x120U >>
  ...
  *(undefined8 *)(ptVar18 + 0x238) = 0;
  puVar22 = (undefined8 *)((ulong)(ptVar18 + 8) & 0xfffffffffffffff8);
  for (uVar12 = (ulong)(((int)ptVar18 -
                        (int)(undefined8 *)((ulong)(ptVar18 + 8) & 0xfffffffffffffff8)) + 0x240U >>
                       3); uVar12 != 0; uVar12 = uVar12 - 1) {
    *puVar22 = 0;
    puVar22 = puVar22 + 1;
  }
                ...
                if (*(uint *)(p_Var38 + 0x24) == uVar14) {
                  ...
                  if ((uVar16 <= uVar5) &&
                     ((uVar16 != uVar5 ||
                      ((uVar10 <= *(uint *)(p_Var38 + 0x2c) &&
                       ((uVar10 != *(uint *)(p_Var38 + 0x2c) ||
                        (uVar11 <= *(uint *)(p_Var38 + 0x30))))))))) goto LAB_00103dc1;
                }
              }
              p_Var22 = p_Var38;
...
LAB_00104d58:
  ...
  puVar21 = (uchar *)0x0;
LAB_00104b19:
  if (param_5 < param_4) goto LAB_00104d58;
...
LAB_0011d43f:
          if (__ptr == (void *)0x0) goto LAB_0011d444;
        }
        else {
...
LAB_0011dbeb:
      if (iVar4 <= iVar7) goto LAB_0011dc68;
      local_58 = &local_48;
      std::__cxx11::string::_M_construct<char*>
                (&local_58,*(long *)param_1,*(long *)(param_1 + 8) + *(long *)param_1);
      if (iVar4 == -2) {
    ...
    *local_868 = (string)0x0;
    ...
    if (uVar8 != 0) {
      ...
      if ((local_860 == 0x3fffffffffffffff) ||
         (std::__cxx11::string::_M_append((char *)&local_868,0x11deeb),
      ...
      if (uVar3 < uVar2) {
        ...
        *(uint *)(this + 8) = uVar3;
        ...
        if (*(uint *)(this + 0xc) < uVar3) {
          ...
          basisu::elemental_vector::increase_capacity
                    ((uint)this,SUB81(param_1,0),(uint)param_2,
                     (_func_void_void_ptr_void_ptr_uint *)0x50,true);
          uVar2 = *(uint *)(this + 8);
        }

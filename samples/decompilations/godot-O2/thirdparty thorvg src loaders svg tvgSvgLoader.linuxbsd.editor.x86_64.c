...
undefined8 __thiscall SvgLoader::read(SvgLoader *this)
...
/* SvgLoader::resize(tvg::Paint*, float, float) */

bool SvgLoader::resize(Paint *param_1,float param_2,float param_3)
...
undefined8 __thiscall SvgLoader::paint(SvgLoader *this)
...
void __thiscall SvgLoader::SvgLoader(SvgLoader *this)
...
/* SvgLoader::clear(bool) */

void __thiscall SvgLoader::clear(SvgLoader *this,bool param_1)
...
/* non-virtual thunk to SvgLoader::~SvgLoader() */
...
undefined8 __thiscall SvgLoader::close(SvgLoader *this)
...
/* SvgLoader::run(unsigned int) [clone .part.0] */

void SvgLoader::run(uint param_1)

{
  ...
  cVar5 = simpleXmlParse(*(char **)(this + 0x128),*(uint *)(this + 0x130),true,_svgLoaderParser,
                         pSVar1);
  if (cVar5 == '\0') {
    return;
  }
...
LAB_00108f10:
        ...
        if ((pSVar13 != (SvgNode *)0x0) && (pSVar9 != pSVar13)) {
          do {
            if ((*(char **)(pSVar13 + 0x20) != (char *)0x0) &&
               (iVar6 = strcmp(*(char **)(pSVar13 + 0x20),__s2), iVar6 == 0)) goto LAB_00108ebb;
...
LAB_00108ea1:
        ...
        _cloneNode(local_40,pSVar4,0);
LAB_00108f27:
        if ((*(int *)local_40 == 0x15) && (*(int *)pSVar4 == 0x10)) {
...
LAB_00108ce1:
  uVar7 = svgSceneBuild(*(undefined8 *)(this + 0x1d8),*(undefined8 *)(this + 0x1e0),
                        *(undefined4 *)(this + 0x28),*(undefined4 *)(this + 0x2c),pSVar1,
                        *(undefined4 *)(this + 0x1d0),*(undefined4 *)(this + 0x1d4),this + 0x108,
...

{
  ...
  if ((*(byte *)(lVar2 + 0x1cc) & 4) != 0) {
    if (((float)(*(uint *)(lVar2 + 0x1e0) & _LC82) <= _LC57) ||
       ((float)(*(uint *)(lVar2 + 0x1e4) & _LC82) <= _LC57)) {
      tvg::Scene::gen();
...
/* non-virtual thunk to SvgLoader::run(unsigned int) */

void __thiscall SvgLoader::run(SvgLoader *this,uint param_1)

{
  ...
  if (((byte)this[0x15c] & 4) != 0) {
    if (((float)(*(uint *)(this + 0x170) & _LC82) <= _LC57) ||
       ((float)(*(uint *)(this + 0x174) & _LC82) <= _LC57)) {
      tvg::Scene::gen();
...
undefined8 __thiscall SvgLoader::header(SvgLoader *this)
  ...
  *(void **)(this + 0x178) = pvVar5;
  if (pvVar5 != (void *)0x0) {
    ...
    *(undefined4 *)(this + 0x1cc) = 0;
    simpleXmlParse(*(char **)(this + 0x128),*(uint *)(this + 0x130),true,
                   _svgLoaderParserForValidCheck,this + 0x138);
    ...
    if ((piVar3 != (int *)0x0) && (*piVar3 == 0)) {
      ...
      *(int *)(this + 0x1d4) = piVar3[0x1b];
      if ((uVar6 & 4) == 0) {
        ...
        *(int *)(this + 0x1d8) = piVar3[0x10];
        *(int *)(this + 0x1dc) = piVar3[0x11];
        *(int *)(this + 0x1e0) = piVar3[0x12];
        *(int *)(this + 0x1e4) = piVar3[0x13];
        if ((uVar6 & 1) == 0) {
...
/* SvgLoader::open(char const*, unsigned int, bool) */

undefined8 __thiscall SvgLoader::open(SvgLoader *this,char *param_1,uint param_2,bool param_3)
...
/* SvgLoader::open(std::__cxx11::string const&) */

undefined4 __thiscall SvgLoader::open(SvgLoader *this,string *param_1)
  ...
  *(undefined8 *)((long)local_248 + *(long *)(_vtable + -0x18)) = _init;
  ...
  if (cVar2 != '\0') {
    ...
    std::getline<char,std::char_traits<char>,std::allocator<char>>
              ((istream *)local_248,(string *)(this + 0xe8),'\0');
...
/* SvgStyleGradient::clear() */

void __thiscall SvgStyleGradient::clear(SvgStyleGradient *this)

...
/* JPH::StaticCompoundShapeSettings::sCreateRTTI(JPH::RTTI&) */

void JPH::StaticCompoundShapeSettings::sCreateRTTI(RTTI *param_1)
...
/* JPH::StaticCompoundShape::SaveBinaryState(JPH::StreamOut&) const */

void __thiscall
JPH::StaticCompoundShape::SaveBinaryState(StaticCompoundShape *this,StreamOut *param_1)

{
  ...
  if (cVar1 == '\0') {
    (**(code **)(*(long *)param_1 + 0x10))
              (param_1,*(undefined8 *)(this + 0x80),(ulong)local_24 << 6);
  }
...
/* JPH::StaticCompoundShape::sPartition(unsigned int*, JPH::AABox*, int, int&) [clone .part.0] */
...
LAB_00100258:
    ...
    while( true ) {
      ...
      while( true ) {
        local_58 = CONCAT44((*(float *)(pAVar11 + 0x14) + *(float *)(pAVar11 + 4)) * fVar10,
                            (*(float *)(pAVar11 + 0x10) + *(float *)pAVar11) * fVar10);
        uStack_50 = CONCAT44((*(float *)(pAVar11 + 0x1c) + *(float *)(pAVar11 + 0xc)) * fVar10,
                             (*(float *)(pAVar11 + 0x18) + *(float *)(pAVar11 + 8)) * fVar10);
      ...
      while( true ) {
        local_58 = CONCAT44((*(float *)(pAVar11 + -0xc) + *(float *)(pAVar11 + -0x1c)) * fVar10,
                            (*(float *)(pAVar11 + -0x10) + *(float *)(pAVar11 + -0x20)) * fVar10);
        uStack_50 = CONCAT44((*(float *)(pAVar11 + -4) + *(float *)(pAVar11 + -0x14)) * fVar10,
                             (*(float *)(pAVar11 + -8) + *(float *)(pAVar11 + -0x18)) * fVar10);
...
void JPH::StaticCompoundShape::sRegister()::{lambda()#1}::_FUN(void)

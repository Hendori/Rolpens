...
/* addVertex(unsigned short, unsigned short, unsigned short, unsigned short*, int*, int*, int&) */

void addVertex(ushort param_1,ushort param_2,ushort param_3,ushort *param_4,int *param_5,
...
/* intersectProp(int const*, int const*, int const*, int const*) */

uint intersectProp(int *param_1,int *param_2,int *param_3,int *param_4)
  ...
  if (iVar7 != iVar8) {
    ...
    if (iVar6 != iVar12) {
      ...
      if (iVar3 != iVar4) {
        ...
        if (iVar10 != iVar9) {
          uVar5 = (uint)((iVar10 - iVar9 ^ iVar3 - iVar4) & (iVar7 - iVar8 ^ iVar6 - iVar12)) >>
                  0x1f;
        }
      }
    }
...
/* diagonalie(int, int, int, int const*, int*) */

undefined8 diagonalie(int param_1,int param_2,int param_3,int *param_4,int *param_5)
  ...
  if (0 < param_3) {
    ...
    do {
      ...
      if (iVar1 < param_3) {
        ...
        lVar6 = 0;
LAB_0010029e:
        if ((param_2 != iVar3) && (param_2 != (int)lVar6)) {
          ...
          if (((*piVar11 != iVar3) || (piVar11[2] != piVar10[2])) &&
             ((iVar1 != iVar3 || (piVar5[2] != piVar10[2])))) {
...
/* inCone(int, int, int, int const*, int*) */

uint inCone(int param_1,int param_2,int param_3,int *param_4,int *param_5)

{
  ...
  if ((iVar6 - iVar7) * (iVar4 - iVar8) < (iVar5 - iVar8) * (iVar3 - iVar7)) {
    ...
    return CONCAT31((int3)((uint)(iVar3 - iVar1) >> 8),
                    (iVar7 - iVar1) * (iVar4 - iVar2) < (iVar8 - iVar2) * (iVar3 - iVar1));
  }
  return (uint)((iVar5 - iVar2) * (iVar3 - iVar1) - (iVar6 - iVar1) * (iVar4 - iVar2) &
               (iVar8 - iVar4) * (iVar1 - iVar3) - (iVar7 - iVar3) * (iVar2 - iVar4)) >> 0x1f;
}



/* getPolyMergeValue(unsigned short*, unsigned short*, unsigned short const*, int&, int&, int) */

int getPolyMergeValue(ushort *param_1,ushort *param_2,ushort *param_3,int *param_4,int *param_5,
                     int param_6)
...
LAB_00100672:
        iVar5 = *param_4;
        if ((iVar5 != -1) && (iVar2 = *param_5, iVar2 != -1)) {
          lVar8 = (long)(int)((uint)param_1[iVar5] + (uint)param_1[iVar5] * 2);
          uVar1 = param_3[lVar8];
          uVar14 = (uint)param_3[(int)((uint)param_1[(iVar5 + -1 + iVar6) % iVar6] +
                                      (uint)param_1[(iVar5 + -1 + iVar6) % iVar6] * 2)];
          uVar10 = (uint)(param_3 +
                         (int)((uint)param_1[(iVar5 + -1 + iVar6) % iVar6] +
                              (uint)param_1[(iVar5 + -1 + iVar6) % iVar6] * 2))[2];
          if (((int)(((param_3 +
                      (int)((uint)param_2[(iVar2 + 2) % iVar3] +
                           (uint)param_2[(iVar2 + 2) % iVar3] * 2))[2] - uVar10) * (uVar1 - uVar14))
               < (int)((param_3[(int)((uint)param_2[(iVar2 + 2) % iVar3] +
                                     (uint)param_2[(iVar2 + 2) % iVar3] * 2)] - uVar14) *
                      ((param_3 + lVar8)[2] - uVar10))) &&
             (uVar10 = (uint)param_3[(int)((uint)param_2[(iVar2 + -1 + iVar3) % iVar3] +
                                          (uint)param_2[(iVar2 + -1 + iVar3) % iVar3] * 2)],
             uVar14 = (uint)(param_3 +
                            (int)((uint)param_2[(iVar2 + -1 + iVar3) % iVar3] +
                                 (uint)param_2[(iVar2 + -1 + iVar3) % iVar3] * 2))[2],
             (int)((param_3[(int)((uint)param_2[iVar2] + (uint)param_2[iVar2] * 2)] - uVar10) *
                  ((param_3 +
                   (int)((uint)param_1[(iVar5 + 2) % iVar6] + (uint)param_1[(iVar5 + 2) % iVar6] * 2
                        ))[2] - uVar14)) <
             (int)((param_3[(int)((uint)param_1[(iVar5 + 2) % iVar6] +
                                 (uint)param_1[(iVar5 + 2) % iVar6] * 2)] - uVar10) *
                  ((param_3 + (int)((uint)param_2[iVar2] + (uint)param_2[iVar2] * 2))[2] - uVar14)))
             ) {
            lVar7 = (long)(int)((uint)param_1[(iVar5 + 1) % iVar6] +
                               (uint)param_1[(iVar5 + 1) % iVar6] * 2);
            iVar6 = (uint)uVar1 - (uint)param_3[lVar7];
            return ((uint)param_3[lVar8 + 2] - (uint)param_3[lVar7 + 2]) *
                   ((uint)param_3[lVar8 + 2] - (uint)param_3[lVar7 + 2]) + iVar6 * iVar6;
          }
        }
      }
    }
...
/* buildMeshAdjacency(unsigned short*, int, int, int) */

undefined8 buildMeshAdjacency(ushort *param_1,int param_2,int param_3,int param_4)
      ...
      do {
        ...
        if (0 < param_4) {
          ...
          do {
            ...
            if ((param_4 <= (int)lVar8 + 1) || (uVar5 = puVar10[lVar8 + 1], uVar5 == 0xffff)) {
              uVar5 = *puVar10;
            }
            if (uVar4 < uVar5) {
      ...
      do {
        ...
        do {
          ...
          if (uVar5 < uVar4) {
            ...
            while (uVar5 != 0xffff) {
              uVar9 = (ulong)uVar5;
              if ((uVar4 == *(ushort *)((long)pvVar7 + uVar9 * 0xc + 2)) &&
                 (*(short *)((long)pvVar7 + uVar9 * 0xc + 8) ==
                  *(short *)((long)pvVar7 + uVar9 * 0xc + 10))) {
...
LAB_0010096a:
      if (0 < iVar11) {
        ...
        do {
          uVar4 = puVar10[3];
          if (puVar10[2] != uVar4) {
            param_1[(long)(int)((uint)puVar10[2] * param_4 * 2) +
                    (long)(int)((uint)*puVar10 + param_4)] = uVar4;
            param_1[(long)(int)((uint)uVar4 * param_4 * 2) + (long)(int)((uint)puVar10[1] + param_4)
                   ] = puVar10[2];
          }
          puVar10 = puVar10 + 6;
...
/* mergePolyVerts(unsigned short*, unsigned short*, int, int, unsigned short*, int) */

void mergePolyVerts(ushort *param_1,ushort *param_2,int param_3,int param_4,ushort *param_5,
                   int param_6)
...
/* triangulate(int, int const*, int*, int*) */

int triangulate(int param_1,int *param_2,int *param_3,int *param_4)
  ...
  if (0 < param_1) {
    ...
    do {
      ...
      do {
        ...
        if ((cVar7 != '\0') &&
           (cVar7 = diagonalie(iVar26,iVar25,param_1,param_2,param_3), cVar7 != '\0')) {
  ...
  if (local_a8 == 0xffffffff) {
    ...
    do {
      ...
      if ((iVar3 - iVar4) * (iVar25 - iVar5) < (iVar26 - iVar4) * (iVar2 - iVar5)) {
        if (((iVar3 - iVar26) * (iVar12 - iVar25) < (iVar2 - iVar25) * (iVar23 - iVar26)) ||
           ((iVar4 - iVar23) * (iVar25 - iVar12) < (iVar5 - iVar12) * (iVar26 - iVar23))) {
LAB_001010fa:
          lVar20 = 1;
          do {
            uVar6 = (uint)lVar20;
            ...
            if ((int)uVar6 < param_1) {
              if ((uVar18 != uVar6) && (lVar14 = (long)(int)uVar6, uVar9 != uVar18))
              goto LAB_00101169;
            }
            else {
              ...
              lVar14 = 0;
LAB_00101169:
              if ((uVar9 != uVar22) && ((uint)lVar14 != uVar22)) {
                ...
                if ((iVar26 != *piVar17) || (iVar25 != piVar17[2])) {
                  ...
                  if ((((iVar26 != iVar2) || (iVar25 != piVar13[2])) &&
                      ((iVar2 != iVar23 || (piVar13[2] != iVar12)))) &&
                     (cVar7 = intersectProp(piVar15,piVar11,piVar17,piVar13), cVar7 != '\0'))
                  goto LAB_00101208;
                }
              }
            }
LAB_0010113c:
      ...
      else if (((iVar5 - iVar25) * (iVar23 - iVar26) <= (iVar4 - iVar26) * (iVar12 - iVar25)) &&
              ((iVar2 - iVar12) * (iVar26 - iVar23) <= (iVar3 - iVar23) * (iVar25 - iVar12)))
      goto LAB_001010fa;
LAB_00101208:
      local_48 = uVar8;
      local_a8 = uVar21;
...
LAB_00100e55:
  cVar7 = inCone(iVar26,iVar23,uVar18,param_2,param_3);
  uVar22 = *puVar10;
...
/* rcBuildPolyMesh(rcContext*, rcContourSet const&, int, rcPolyMesh&) */

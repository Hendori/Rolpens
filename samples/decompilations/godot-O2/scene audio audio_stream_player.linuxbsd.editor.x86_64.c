...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_00111e40;
...

{
  ...
  *(undefined ***)pCVar2 = &PTR_hash_00112098;
  ...
  *(undefined1 (*) [16])(pCVar2 + 0x30) = (undefined1  [16])0x0;
  *(undefined8 *)(pCVar2 + 0x40) = 0;
  *(undefined ***)pCVar2 = &PTR_hash_00112008;
  uVar1 = *(undefined8 *)(this + 0x60);
  *(undefined8 *)(pCVar2 + 0x10) = 0;
  *(undefined8 *)(pCVar2 + 0x30) = uVar1;
...

{
  ...
  *(undefined8 *)(in_RDI + 8) = 0;
  ...
  if (puVar6 != puVar4) {
    puVar5 = puVar6;
    if (((int)puVar4 - (int)puVar6 & 8U) != 0) {
      puVar5 = puVar6 + 1;
      *puVar6 = 0;
      if (puVar5 == puVar4) goto LAB_00102d38;
    }
    do {
      *puVar5 = 0;
      puVar6 = puVar5 + 2;
...
LAB_00102d38:
  fVar10 = expf(_LC0 * *(float *)(*(long *)(in_RSI + 0x408) + 0x1f8));
  uVar2 = CONCAT44(fVar10,fVar10);
  plVar7 = (long *)AudioServer::get_singleton();
  iVar3 = (**(code **)(*plVar7 + 0x180))(plVar7);
  if (iVar3 == 0) {
    if (*(long *)(in_RDI + 8) == 0) goto LAB_00102e86;
    lVar9 = *(long *)(*(long *)(in_RDI + 8) + -8);
    if (0 < lVar9) {
      CowData<AudioFrame>::_copy_on_write(this);
    ...
    if (iVar3 == 1) {
      if (*(long *)(in_RDI + 8) != 0) {
        lVar9 = *(long *)(*(long *)(in_RDI + 8) + -8);
        if (lVar9 < 1) goto LAB_00102e89;
        CowData<AudioFrame>::_copy_on_write(this);
        lVar9 = (*(undefined8 **)(in_RDI + 8))[-1];
        **(undefined8 **)(in_RDI + 8) = uVar2;
        if (1 < lVar9) {
          CowData<AudioFrame>::_copy_on_write(this);
          lVar8 = *(long *)(in_RDI + 8);
          lVar9 = *(long *)(lVar8 + -8);
          *(float *)(lVar8 + 8) = fVar10;
      ...
      if (iVar3 == 2) {
        if (*(long *)(in_RDI + 8) == 0) {
          ...
          if (1 < lVar9) {
            CowData<AudioFrame>::_copy_on_write(this);
            lVar9 = *(long *)(in_RDI + 8);
            *(float *)(lVar9 + 8) = fVar10;
            *(undefined4 *)(lVar9 + 0xc) = 0x3f800000;
            return;
          }
        }
LAB_00102f35:
...

{
  ...
  if (local_68 != (Object *)0x0) {
    ...
    if (*(code **)(*(long *)local_68 + 0x1a8) != AudioStreamPlayback::get_is_sample) {
      ...
      if (local_68 == (Object *)0x0) goto LAB_001030e4;
    }
    cVar5 = RefCounted::unreference();
...
{
  return (uint)CONCAT71(0x1128,(undefined4 *)param_1 == &Node::get_class_ptr_static()::ptr) |
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00112788;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  String::split(local_58,SUB81(param_1,0),0x105360);
  ...
  if (pvVar5 != (void *)0x0) {
    if (*(int *)(this + 0x3c) != 0) {
      ...
      if (uVar2 == 0) {
        ...
        *(undefined4 *)(this + 0x3c) = 0;
        *(undefined1 (*) [16])(this + 0x28) = (undefined1  [16])0x0;
        if (pvVar5 == (void *)0x0) goto LAB_00105844;
      }
    }
    Memory::free_static(pvVar5,false);
...

{
  ...
  if (uVar3 < (uint)ObjectDB::slot_max) {
    ...
    ObjectDB::spin_lock._0_1_ = '\0';
    if (puVar4[1] == 0) goto LAB_00105a8f;
    ...
    if (param_2 == 0) {
      *(undefined4 *)param_4 = 0;
      ...
      if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00105a68. Too many branches */
...

{
  ...
  if (uVar6 < (uint)ObjectDB::slot_max) {
    ...
    ObjectDB::spin_lock._0_1_ = '\0';
    if (puVar7[1] == 0) goto LAB_00105d16;
    lVar1 = *(long *)(this + 0x28);
    UNRECOVERED_JUMPTABLE = *(code **)(this + 0x38);
    lVar2 = *(long *)(this + 0x40);
    if ((uint)param_2 < 2) {
      if (param_2 != 0) {
        *(undefined4 *)param_4 = 0;
        ...
        if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00105cc5. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010a28c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010a46b. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010ac3c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
              ((long *)((long)param_2 + *(long *)(param_1 + 0x60)),
               *(undefined4 *)(*(long *)param_3 + 8));
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010ae1b. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)((long *)((long)param_2 + *(long *)(param_1 + 0x60)),**param_3);
    return;
  }
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010b5ec. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
              ((long *)((long)param_2 + *(long *)(param_1 + 0x60)),
               *(undefined4 *)(*(long *)param_3 + 8));
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010b7cb. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)((long *)((long)param_2 + *(long *)(param_1 + 0x60)),**param_3);
    return;
  }
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010b9ad. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
              ((long *)((long)param_2 + *(long *)(param_1 + 0x60)),
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010bb92. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010c3dd. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010c5b9. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)((long *)((long)param_2 + *(long *)(param_1 + 0x60)),*param_3);
    return;
  }
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010d676. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010d836. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)((long *)((long)param_2 + *(long *)(param_1 + 0x60)));
    return;
  }
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    ...
    auVar2._0_4_ = (float)*(double *)(*(long *)param_3 + 8);
                    /* WARNING: Could not recover jumptable at 0x0010e012. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    ...
    auVar2._0_4_ = (float)**param_3;
                    /* WARNING: Could not recover jumptable at 0x0010e1f1. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)(auVar2._0_8_,(long *)((long)param_2 + *(long *)(param_1 + 0x60)));
    return;
  }
...

{
  ...
  if (local_48 == (Object *)0x0) {
                    /* WARNING: Load size is inaccurate */
    pOVar5 = *param_3;
    if (pOVar5 == (Object *)0x0) goto LAB_0010ecf6;
  ...
  if (pOVar5 != pOVar3) {
    *(Object **)param_3 = pOVar3;
    if (pOVar3 == (Object *)0x0) {
      if (pOVar5 != (Object *)0x0) goto LAB_0010ed39;
    }
    else {
...
LAB_0010ed39:
      ...
      if (local_48 == (Object *)0x0) goto LAB_0010ecf6;
    }
  }
  cVar1 = RefCounted::unreference();
  pOVar5 = local_48;
...

{
  ...
  if (local_48 == (Object *)0x0) {
                    /* WARNING: Load size is inaccurate */
    pOVar5 = *param_3;
    if (pOVar5 == (Object *)0x0) goto LAB_0010f296;
    *(undefined8 *)param_3 = 0;
    goto LAB_0010f2d9;
  }
  pOVar3 = (Object *)__dynamic_cast(local_48,&Object::typeinfo,&RefCounted::typeinfo,0);
  ...
  if (pOVar5 != pOVar3) {
    *(Object **)param_3 = pOVar3;
    if (pOVar3 == (Object *)0x0) {
      if (pOVar5 != (Object *)0x0) goto LAB_0010f2d9;
    }
    else {
      cVar1 = RefCounted::reference();
      if (cVar1 == '\0') {
...
LAB_0010f2d9:
      ...
      if (local_48 == (Object *)0x0) goto LAB_0010f296;
    }
  }
  cVar1 = RefCounted::unreference();
  pOVar5 = local_48;
...
LAB_0010f556:
      ...
      if (pOVar2 != pOVar4) {
        ...
        if (pOVar2 != (Object *)0x0) goto LAB_0010f556;
      }
    }
  }
...
LAB_0011005d:
      ...
      if (pOVar5 != pOVar8) {
        ...
        if (pOVar5 != (Object *)0x0) goto LAB_0011005d;
      }
    }
  }
...
LAB_0011065b:
  *(undefined4 *)param_6 = 0;
  ...
  Variant::operator_cast_to_long(this);
                    /* WARNING: Could not recover jumptable at 0x001106b6. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
LAB_001109eb:
  *(undefined4 *)param_6 = 0;
  ...
  Variant::operator_cast_to_int(this);
                    /* WARNING: Could not recover jumptable at 0x00110a46. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
LAB_00110d7b:
  *(undefined4 *)param_6 = 0;
  ...
  Variant::operator_cast_to_long(this);
                    /* WARNING: Could not recover jumptable at 0x00110dd6. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*param_2)((char)(param_1 + (long)param_3));
  return;
}
...
LAB_0011110b:
  *(undefined4 *)param_6 = 0;
  ...
  Variant::operator_cast_to_bool(this);
                    /* WARNING: Could not recover jumptable at 0x00111167. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
LAB_0011149b:
  *(undefined4 *)param_6 = 0;
  ...
  fVar9 = Variant::operator_cast_to_float(this);
                    /* WARNING: Could not recover jumptable at 0x001114f4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*param_2)(fVar9);
  return;
}

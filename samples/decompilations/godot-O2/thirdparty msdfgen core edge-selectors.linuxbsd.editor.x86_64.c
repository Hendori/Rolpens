...
void msdfgen::PerpendicularDistanceSelector::addEdge
               (EdgeCache *param_1,EdgeSegment *param_2,EdgeSegment *param_3,EdgeSegment *param_4)

{
  ...
  cVar3 = PerpendicularDistanceSelectorBase::isEdgeRelevant
                    ((PerpendicularDistanceSelectorBase *)param_1,(EdgeCache *)param_2,param_4,
                     (Vector2 *)(param_1 + 0x30));
  if (cVar3 == '\0') goto LAB_0010099c;
  auVar16 = (**(code **)(*(long *)param_4 + 0x40))
                      (*(undefined8 *)(pEVar4 + 0x30),*(undefined8 *)(pEVar4 + 0x38),param_4,
                       &local_48);
  local_50 = auVar16._0_8_;
  dVar15 = (double)((ulong)local_50 & _LC4);
  if ((dVar15 < (double)(*(ulong *)param_1 & _LC4)) ||
     ((dVar15 == (double)(*(ulong *)param_1 & _LC4) && (auVar16._8_8_ < *(double *)(param_1 + 8)))))
  {
    *(EdgeSegment **)(param_1 + 0x20) = param_4;
    *(undefined1 (*) [16])param_1 = auVar16;
    *(undefined8 *)(param_1 + 0x28) = local_48;
  }
  uVar2 = *(undefined8 *)(param_1 + 0x38);
  lVar1 = *(long *)param_4;
  *(undefined8 *)param_2 = *(undefined8 *)(param_1 + 0x30);
  *(undefined8 *)(param_2 + 8) = uVar2;
  *(double *)(param_2 + 0x10) = dVar15;
  auVar16 = (**(code **)(lVar1 + 0x28))(0,param_4);
  dVar8 = *(double *)(param_1 + 0x38) - auVar16._8_8_;
  dVar5 = *(double *)(param_1 + 0x30) - auVar16._0_8_;
  auVar16 = (**(code **)(*(long *)param_4 + 0x28))(_LC7,param_4);
  dVar9 = *(double *)(param_1 + 0x38) - auVar16._8_8_;
  dVar6 = *(double *)(param_1 + 0x30) - auVar16._0_8_;
  ...
  auVar16 = (**(code **)(*(long *)param_4 + 0x30))(_LC7,param_4);
  ...
  auVar16 = (**(code **)(*in_R8 + 0x30))(0,in_R8);
  dVar7 = auVar16._8_8_;
...
LAB_00100a1a:
      ...
      if ((0.0 < dVar5 * (double)((ulong)local_90 ^ _LC3) + dVar8 * (double)((ulong)local_98 ^ _LC3)
        ...
        if (0.0 <= dVar5) {
          if (*(double *)(param_1 + 0x10) <= dVar13 && dVar13 != *(double *)(param_1 + 0x10)) {
            *(double *)(param_1 + 0x10) = dVar13;
          }
          if (dVar5 != 0.0) goto LAB_00100a87;
        }
        if (dVar13 < *(double *)(param_1 + 0x18)) {
...
LAB_00100a9a:
    if ((0.0 < dVar6 * local_68 + dVar9 * local_70) &&
      ...
      local_50 = dVar5;
      if (dVar5 <= 0.0) {
        if (*(double *)(param_1 + 0x10) <= dVar5 && dVar5 != *(double *)(param_1 + 0x10)) {
          *(double *)(param_1 + 0x10) = dVar5;
        }
        if (dVar5 != 0.0) goto LAB_00100af4;
      }
      if (dVar5 < *(double *)(param_1 + 0x18)) {
        *(double *)(param_1 + 0x18) = dVar5;
      }
    }
LAB_00100af4:
    *(double *)(param_2 + 0x30) = local_50;
  }
LAB_00100998:

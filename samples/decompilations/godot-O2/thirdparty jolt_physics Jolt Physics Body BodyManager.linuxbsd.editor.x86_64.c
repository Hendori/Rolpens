...
/* JPH::BodyManager::Init(unsigned int, unsigned int, JPH::BroadPhaseLayerInterface const&) */

void __thiscall
JPH::BodyManager::Init
          (BodyManager *this,uint param_1,uint param_2,BroadPhaseLayerInterface *param_3)
...
/* JPH::BodyManager::GetNumBodies() const */

undefined4 __thiscall JPH::BodyManager::GetNumBodies(BodyManager *this)
...
/* JPH::BodyManager::GetBodyStats() const */

void JPH::BodyManager::GetBodyStats(void)
...
/* JPH::BodyManager::AllocateBody(JPH::BodyCreationSettings const&) const */

long __thiscall JPH::BodyManager::AllocateBody(BodyManager *this,BodyCreationSettings *param_1)

{
  ...
  if ((param_1[0x62] == (BodyCreationSettings)0x0) && (param_1[0x60] == (BodyCreationSettings)0x0))
  {
    ...
    *(undefined4 *)(lVar25 + 0x20) = uVar5;
    *(undefined4 *)(lVar25 + 0x24) = uVar5;
    *(undefined4 *)(lVar25 + 0x28) = uVar5;
    *(undefined4 *)(lVar25 + 0x2c) = uVar5;
    uVar5 = _LC7;
    *(undefined8 *)(lVar25 + 0x58) = 0;
    *(undefined4 *)(lVar25 + 0x30) = uVar5;
    *(undefined4 *)(lVar25 + 0x34) = uVar5;
    *(undefined4 *)(lVar25 + 0x38) = uVar5;
    *(undefined4 *)(lVar25 + 0x3c) = uVar5;
...
LAB_00100462:
  ...
  *(undefined8 *)(lVar25 + 0x60) = *(undefined8 *)(param_1 + 0x58);
  ...
  JPH::Body::SetPositionAndRotationInternal
            (*(undefined8 *)param_1,*(undefined8 *)(param_1 + 8),*(undefined8 *)(param_1 + 0x10),
             *(undefined8 *)(param_1 + 0x18),lVar25,1);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* JPH::BodyManager::AllocateSoftBody(JPH::SoftBodyCreationSettings const&) const */

long __thiscall
JPH::BodyManager::AllocateSoftBody(BodyManager *this,SoftBodyCreationSettings *param_1)

{
  ...
  *(undefined4 *)(lVar10 + 0x2c) = uVar2;
  *(undefined8 *)(lVar10 + 0x58) = 0;
  *(undefined4 *)(lVar10 + 0x30) = uVar7;
  *(undefined4 *)(lVar10 + 0x34) = uVar7;
  ...
  *(undefined8 *)(lVar10 + 0x180) = 0;
  *(undefined8 *)(lVar10 + 0x198) = 0;
  *(undefined8 *)(lVar10 + 0x1b0) = 0;
  *(undefined8 *)(lVar10 + 0x170) = uVar13;
  *(undefined8 *)(lVar10 + 0x178) = uVar12;
  *(undefined1 (*) [16])(lVar10 + 0x188) = (undefined1  [16])0x0;
  *(undefined1 (*) [16])(lVar10 + 0x1a0) = (undefined1  [16])0x0;
  *(undefined1 (*) [16])(lVar10 + 0x1b8) = (undefined1  [16])0x0;
  ...
  *(undefined4 *)(lVar10 + 0x1f0) = uVar2;
  *(undefined4 *)(lVar10 + 500) = uVar2;
  *(undefined4 *)(lVar10 + 0x1f8) = uVar2;
  *(undefined4 *)(lVar10 + 0x1fc) = uVar2;
  *(undefined4 *)(lVar10 + 0x200) = uVar7;
  *(undefined4 *)(lVar10 + 0x204) = uVar7;
  *(undefined4 *)(lVar10 + 0x208) = uVar7;
  *(undefined4 *)(lVar10 + 0x20c) = uVar7;
  *(undefined4 *)(lVar10 + 0x210) = uVar2;
  *(undefined4 *)(lVar10 + 0x214) = uVar2;
  *(undefined4 *)(lVar10 + 0x218) = uVar2;
  *(undefined4 *)(lVar10 + 0x21c) = uVar2;
  *(undefined4 *)(lVar10 + 0x220) = uVar7;
  *(undefined4 *)(lVar10 + 0x224) = uVar7;
  *(undefined4 *)(lVar10 + 0x228) = uVar7;
  *(undefined4 *)(lVar10 + 0x22c) = uVar7;
  LOCK();
  ...
  *(undefined4 *)(lVar10 + 0xec) = uVar2;
  ...
  JPH::Body::SetPositionAndRotationInternal
            (*(undefined8 *)(param_1 + 0x10),*(undefined8 *)(param_1 + 0x18),uVar13,uVar12,lVar10,1)
  ;
  return lVar10;
}
...
/* JPH::BodyManager::AddBody(JPH::Body*) */

undefined8 __thiscall JPH::BodyManager::AddBody(BodyManager *this,Body *param_1)
...
/* JPH::BodyManager::AddBodyWithCustomID(JPH::Body*, JPH::BodyID const&) */

undefined8 __thiscall
JPH::BodyManager::AddBodyWithCustomID(BodyManager *this,Body *param_1,BodyID *param_2)
...
/* JPH::BodyManager::RemoveBodies(JPH::BodyID const*, int, JPH::Body**) */

void __thiscall
JPH::BodyManager::RemoveBodies(BodyManager *this,BodyID *param_1,int param_2,Body **param_3)
...
/* JPH::BodyManager::ActivateBodies(JPH::BodyID const*, int) */

void __thiscall JPH::BodyManager::ActivateBodies(BodyManager *this,BodyID *param_1,int param_2)

{
  ...
  if (param_2 < 1) {
    ...
    if (param_1 < pBVar1) {
      do {
        while ((uVar3 = *(uint *)param_1, uVar3 == 0xffffffff ||
               (this_00 = *(Body **)(*(long *)(this + 0x10) + (ulong)(uVar3 & 0x7fffff) * 8),
               local_7c = uVar3, this_00[0x78] == (Body)0x0))) {
LAB_00100de0:
          param_1 = param_1 + 4;
...
/* JPH::BodyManager::DeactivateBodies(JPH::BodyID const*, int) */

void __thiscall JPH::BodyManager::DeactivateBodies(BodyManager *this,BodyID *param_1,int param_2)
        ...
        if (uVar3 != 0xffffffff) {
          ...
          if ((lVar7 != 0) && (*(int *)(lVar7 + 0x70) != -1)) {
            ...
            if (*(int *)pBVar2 - 1U != uVar3) {
              uVar4 = *(uint *)(*(long *)(this + (ulong)*(byte *)(lVar6 + 0x76) * 8 + 0xa0) +
                               (ulong)(*(int *)pBVar2 - 1U) * 4);
              *(uint *)(*(long *)(this + (ulong)*(byte *)(lVar6 + 0x76) * 8 + 0xa0) +
                       (ulong)uVar3 * 4) = uVar4;
              *(uint *)(*(long *)(*(long *)(lVar5 + (ulong)(uVar4 & 0x7fffff) * 8) + 0x48) + 0x70) =
                   uVar3;
            }
...
/* JPH::BodyManager::SetMotionQuality(JPH::Body&, JPH::EMotionQuality) */

void __thiscall JPH::BodyManager::SetMotionQuality(BodyManager *this,long param_1,char param_3)
...
/* JPH::BodyManager::GetActiveBodies(JPH::EBodyType, JPH::Array<JPH::BodyID,
   JPH::STLAllocator<JPH::BodyID> >&) const */

void __thiscall JPH::BodyManager::GetActiveBodies(BodyManager *this,uint param_2,long *param_3)
...
/* JPH::BodyManager::GetBodyIDs(JPH::Array<JPH::BodyID, JPH::STLAllocator<JPH::BodyID> >&) const */

void __thiscall JPH::BodyManager::GetBodyIDs(BodyManager *this,Array *param_1)
...
/* JPH::BodyManager::SetBodyActivationListener(JPH::BodyActivationListener*) */

void __thiscall
JPH::BodyManager::SetBodyActivationListener(BodyManager *this,BodyActivationListener *param_1)
...
/* JPH::BodyManager::GetMutexMask(JPH::BodyID const*, int) const */

ulong __thiscall JPH::BodyManager::GetMutexMask(BodyManager *this,BodyID *param_1,int param_2)
...
/* JPH::BodyManager::LockRead(unsigned long) const */

void __thiscall JPH::BodyManager::LockRead(BodyManager *this,ulong param_1)
...
/* JPH::BodyManager::UnlockRead(unsigned long) const */

void __thiscall JPH::BodyManager::UnlockRead(BodyManager *this,ulong param_1)
...
/* JPH::BodyManager::LockWrite(unsigned long) const */

void __thiscall JPH::BodyManager::LockWrite(BodyManager *this,ulong param_1)
...
/* JPH::BodyManager::UnlockWrite(unsigned long) const */

void __thiscall JPH::BodyManager::UnlockWrite(BodyManager *this,ulong param_1)
...
/* JPH::BodyManager::LockAllBodies() const */

void __thiscall JPH::BodyManager::LockAllBodies(BodyManager *this)
...
/* JPH::BodyManager::UnlockAllBodies() const */

void __thiscall JPH::BodyManager::UnlockAllBodies(BodyManager *this)
...
/* JPH::BodyManager::SaveState(JPH::StateRecorder&, JPH::StateRecorderFilter const*) const */

void __thiscall
JPH::BodyManager::SaveState(BodyManager *this,StateRecorder *param_1,StateRecorderFilter *param_2)
...
LAB_001019a5:
  ...
  uVar12 = 0;
  do {
    while (((uVar3 = *puVar10, (uVar3 & 1) == 0 && ((*(byte *)(uVar3 + 0x79) & 4) != 0)) &&
           ((param_2 == (StateRecorderFilter *)0x0 ||
            ((*(code **)(*(long *)param_2 + 0x10) == StateRecorderFilter::ShouldSaveBody ||
             (cVar6 = (**(code **)(*(long *)param_2 + 0x10))(param_2,uVar3), cVar6 != '\0'))))))) {
      uVar13 = uVar12 + 1;
      if (uVar8 < uVar13) {
        uVar5 = uVar8 * 2;
        lVar1 = uVar8 * 8;
...
/* JPH::BodyManager::RestoreState(JPH::StateRecorder&) */

undefined1 __thiscall JPH::BodyManager::RestoreState(BodyManager *this,StateRecorder *param_1)

{
  ...
  if (param_1[0x10] == (StateRecorder)0x0) {
    ...
    do {
      ...
      if (((*(ulong *)this <= (ulong)(local_44 & 0x7fffff)) ||
          (pSVar7 = *(StateRecorder **)(*(long *)(this + 0x10) + (ulong)(local_44 & 0x7fffff) * 8),
          ((ulong)pSVar7 & 1) != 0)) || (local_44 != *(uint *)(pSVar7 + 0x70))) {
        pthread_mutex_unlock(__mutex);
        ppVar18 = *(pthread_rwlock_t **)(this + 0x50);
        ppVar19 = (pthread_rwlock_t *)((ulong)*(uint *)(this + 0x58) * 0x40 + (long)ppVar18);
  ...
  if (iVar12 == 0) {
    for (puVar14 = puVar15; puVar15 + local_98 != puVar14; puVar14 = puVar14 + 1) {
      ...
      if (((*(ulong *)this <= uVar16) ||
          (uVar16 = *(ulong *)(*(long *)(this + 0x10) + uVar16 * 8), (uVar16 & 1) != 0)) ||
         (*(uint *)(uVar16 + 0x70) != *puVar14)) goto JPH_BodyManager_RestoreState;
...
JPH_BodyManager_RestoreState:
      ...
      if (((uVar16 & 1) != 0) || (*(uint *)(uVar16 + 0x70) != *puVar14))
      goto JPH_BodyManager_RestoreState;
      pBVar2 = this + (long)(int)(*(byte *)(uVar16 + 0x76) + 0x2c) * 4;
      lVar8 = *(long *)(uVar16 + 0x48);
      uVar17 = *(uint *)(lVar8 + 0x70);
      if (*(int *)pBVar2 - 1U != uVar17) {
        uVar6 = *(uint *)(*(long *)(this + (ulong)*(byte *)(uVar16 + 0x76) * 8 + 0xa0) +
                         (ulong)(*(int *)pBVar2 - 1U) * 4);
        *(uint *)(*(long *)(this + (ulong)*(byte *)(uVar16 + 0x76) * 8 + 0xa0) + (ulong)uVar17 * 4)
             = uVar6;
        *(uint *)(*(long *)(*(long *)(lVar3 + (ulong)(uVar6 & 0x7fffff) * 8) + 0x48) + 0x70) =
             uVar17;
      }
...
/* JPH::BodyManager::SaveBodyState(JPH::Body const&, JPH::StateRecorder&) const */

void __thiscall
JPH::BodyManager::SaveBodyState(BodyManager *this,Body *param_1,StateRecorder *param_2)
...
/* JPH::BodyManager::RestoreBodyState(JPH::Body&, JPH::StateRecorder&) */

void __thiscall
JPH::BodyManager::RestoreBodyState(BodyManager *this,Body *param_1,StateRecorder *param_2)
  ...
  if ((bool)local_21 != bVar8) {
    ...
    if (local_21 == '\0') {
      ...
      if (*(uint *)pBVar1 - 1 != uVar2) {
        ...
        *(uint *)(*(long *)(*(long *)(*(long *)(this + 0x10) + (ulong)(uVar4 & 0x7fffff) * 8) + 0x48
                           ) + 0x70) = uVar2;
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* JPH::BodyManager::Draw(JPH::BodyManager::DrawSettings const&, JPH::PhysicsSettings const&,
   JPH::DebugRenderer*, JPH::BodyDrawFilter const*) */

void __thiscall
JPH::BodyManager::Draw
          (BodyManager *this,DrawSettings *param_1,PhysicsSettings *param_2,DebugRenderer *param_3,
          BodyDrawFilter *param_4)

{
  ...
  do {
    ...
    if (((((ulong)pauVar4 & 1) == 0) &&
        (pcVar10 = (code *)(ulong)(byte)pauVar4[7][9], (pauVar4[7][9] & 4) != 0)) &&
       ((param_4 == (BodyDrawFilter *)0x0 ||
        ((pcVar10 = *(code **)(*(long *)param_4 + 0x10), pcVar10 == BodyDrawFilter::ShouldDraw ||
         (pcVar10 = (code *)(*pcVar10)(param_4,pauVar4), (char)pcVar10 != '\0')))))) {
      iVar8 = (int)pcVar10;
      bVar2 = pauVar4[7][9];
      if ((bVar2 & 1) != 0) {
LAB_00102482:
        uVar11 = (ulong)(uint)Color::sYellow;
        goto LAB_00102488;
      }
      if (*(uint *)(param_1 + 8) < 6) {
        pcVar10 = (code *)((long)&switchD_001034df::switchdataD_00103d60 +
                          (long)(int)(&switchD_001034df::switchdataD_00103d60)
                                     [*(uint *)(param_1 + 8)]);
...
LAB_00103744:
      ...
      if (DVar18 != (DrawSettings)0x0) {
        ...
        if (pcVar10 != Shape::DrawGetSupportFunction) {
          ...
          iVar8 = (*pcVar10)(0x3f8000003f800000,*(long **)pauVar4[4],param_3,local_88,uVar11,
                             param_1[1],pcVar10,in_stack_fffffffffffffe78);
...
LAB_0010275d:
        if (param_1[0xd] != (DrawSettings)0x0) goto LAB_001030d1;
LAB_00102769:
        if (param_1[0xe] != (DrawSettings)0x0) goto LAB_00103220;
LAB_00102775:
        DVar18 = param_1[0xf];
      }
      else {
        ...
        local_68._12_4_ = 0;
        iVar8 = (**(code **)(**(long **)pauVar4[4] + 0x80))
                          (0x3f8000003f800000,*(long **)pauVar4[4],param_3,local_88,uVar11,
                           *(int *)(param_1 + 8) == 5,DVar18,in_stack_fffffffffffffe78);
        uVar11 = (ulong)in_stack_fffffffffffffe78._0_4_;
        if (param_1[0xc] == (DrawSettings)0x0) goto LAB_0010275d;
LAB_001030b5:
        iVar8 = JPH::DebugRenderer::DrawWireBox(param_3,pauVar4 + 2,uVar11);
...
LAB_00103220:
        ...
        local_58 = CONCAT44(fVar22 * fVar27 + fVar23 * fVar36 + fVar26 * fVar35 + local_148._4_4_,
                            fVar22 * auVar28._0_4_ + fVar23 * auVar24._0_4_ + fVar26 * fVar25 +
                            (float)local_148);
      ...
      if (DVar18 != (DrawSettings)0x0) {
        ...
        local_148 = CONCAT44(fVar22 + in_stack_fffffffffffffe78._4_4_,
                             fVar19 + in_stack_fffffffffffffe78._0_4_);
        uStack_140 = CONCAT44(fVar27 + in_stack_fffffffffffffe78._12_4_,
                              fVar23 + in_stack_fffffffffffffe78._8_4_);
        JPH::DebugRenderer::DrawArrow
                  (in_stack_fffffffffffffe78._0_8_,in_stack_fffffffffffffe78._8_8_,local_148,
                   uStack_140,param_3,(uint)Color::sGreen);
        fVar19 = 0.0;
        fVar22 = 0.0;
        fVar23 = 0.0;
        fVar27 = 0.0;
        ...
        uStack_140 = CONCAT44(fVar27 + in_stack_fffffffffffffe78._12_4_,
                              fVar23 + in_stack_fffffffffffffe78._8_4_);
        iVar8 = JPH::DebugRenderer::DrawArrow
                          (in_stack_fffffffffffffe78._0_8_,in_stack_fffffffffffffe78._8_8_,local_148
                           ,uStack_140,param_3,(uint)Color::sRed);
      }
      if (param_1[0x10] == (DrawSettings)0x0) {
LAB_00102d88:
        if (((param_1[0x11] != (DrawSettings)0x0) && (pauVar4[7][8] == '\x02')) &&
           (lVar16 = *(long *)(pauVar4[4] + 8), lVar16 != 0)) {
LAB_00102dac:
          if (*(int *)(lVar16 + 0x70) != -1) {
            JPH::StringFormat_abi_cxx11_(local_88,(double)*(float *)(lVar16 + 0xb0),"t: %.1f");
            fVar19 = (_LC30 * *(float *)(*(long *)(pauVar4[4] + 8) + 0xb0)) /
                     *(float *)(param_2 + 0x44);
            if (fVar19 < 0.0) {
              uVar9 = 0xffffffff;
              uVar12 = 0;
            ...
            local_f8 = uStack_80;
            local_f0 = _local_88;
            (**(code **)(*(long *)param_3 + 0x38))
                      (*(undefined8 *)*pauVar4,*(undefined8 *)(*pauVar4 + 8),param_3,&local_f8,
                       uVar9 | 0xff000000);
            do {
              lVar13 = lVar16 * 0x10;
              lVar16 = lVar16 + 1;
              in_stack_fffffffffffffe78 =
                   *(undefined1 (*) [16])(*(long *)(pauVar4[4] + 8) + 0x80 + lVar13);
              JPH::DebugRenderer::DrawWireSphere
                        (in_stack_fffffffffffffe78._0_8_,in_stack_fffffffffffffe78._8_8_,param_3,
                         uVar9 | 0xff000000,3);
            } while (lVar16 != 3);
        ...
        if (0.0 < *(float *)(lVar16 + 0x58)) {
          ...
          if ((uVar9 & 7) == 0) {
            ...
            do {
              ...
              *(float *)(local_88 + lVar16) =
                   fVar36 * (float)uVar6 +
                   fVar31 * (fVar23 * fVar25 - fVar26) +
                   fVar34 * ((_LC2 - fVar23 * fVar32) - fVar30) +
                   fVar35 * (fVar22 * fVar25 + fVar32 * fVar33);
              *(float *)(local_88 + lVar16 + 4) =
                   fVar36 * (float)((ulong)uVar6 >> 0x20) +
                   fVar31 * ((_LC2 - fVar30) - fVar27 * fVar25) +
                   fVar34 * (fVar23 * fVar25 + fVar26) +
                   fVar35 * (fVar22 * fVar32 - fVar25 * fVar33);
              *(float *)(local_88 + lVar16 + 8) =
                   fVar36 * fVar19 +
                   fVar31 * (fVar25 * fVar33 + fVar22 * fVar32) +
                   fVar34 * (fVar22 * fVar25 - fVar32 * fVar33) +
                   fVar35 * ((_LC2 - fVar27 * fVar25) - fVar23 * fVar32);
              *(float *)(local_88 + lVar16 + 0xc) =
                   fVar36 * 1.0 + fVar31 * 0.0 + fVar34 * 0.0 + fVar35 * 0.0;
              lVar16 = lVar16 + 0x10;
            } while (lVar16 != 0x40);
            ...
            local_f8 = uStack_80;
            local_f0 = _local_88;
            (*pcVar10)(*(undefined8 *)*pauVar4,*(undefined8 *)(*pauVar4 + 8),param_3,&local_f8,
      ...
      if (pauVar4[7][6] == '\x01') {
        ...
        if (param_1[0x14] != (DrawSettings)0x0) {
          JPH::SoftBodyMotionProperties::DrawEdgeConstraints
                    (pDVar5,param_3,local_88,*(undefined4 *)(param_1 + 0x1c));
        }
...
/* JPH::BodyManager::InvalidateContactCacheForBody(JPH::Body&) */

void __thiscall JPH::BodyManager::InvalidateContactCacheForBody(BodyManager *this,Body *param_1)
...
void __thiscall JPH::BodyManager::ValidateContactCacheForAllBodies(BodyManager *this)

{
  ...
  if (iVar2 == 0) {
    ...
    for (; puVar1 != puVar3; puVar3 = puVar3 + 1) {
      ...
      if (((uVar4 < *(ulong *)this) &&
          (uVar4 = *(ulong *)(*(long *)(this + 0x10) + uVar4 * 8), (uVar4 & 1) == 0)) &&
         (*puVar3 == *(uint *)(uVar4 + 0x70))) {
        LOCK();
...
void __thiscall JPH::BodyManager::~BodyManager(BodyManager *this)
...
/* JPH::BodyManager::FreeBody(JPH::Body*) const */

void __thiscall JPH::BodyManager::FreeBody(BodyManager *this,Body *param_1)
...
/* JPH::BodyManager::DestroyBodies(JPH::BodyID const*, int) */

void __thiscall JPH::BodyManager::DestroyBodies(BodyManager *this,BodyID *param_1,int param_2)
...
/* JPH::StateRecorderFilter::ShouldSaveBody(JPH::Body const&) const */

undefined8 JPH::StateRecorderFilter::ShouldSaveBody(Body *param_1)
...
/* JPH::BodyDrawFilter::ShouldDraw(JPH::Body const&) const */

undefined8 JPH::BodyDrawFilter::ShouldDraw(Body *param_1)
...
/* JPH::BodyManager::RestoreState(JPH::StateRecorder&) [clone .cold] */

void JPH::BodyManager::RestoreState(StateRecorder *param_1)
...
/* JPH::SoftBodyMotionProperties::~SoftBodyMotionProperties() */

void __thiscall
JPH::SoftBodyMotionProperties::~SoftBodyMotionProperties(SoftBodyMotionProperties *this)

{
  ...
  if (uVar4 != 0) {
    if ((*(long *)(this + 0x138) != 0) &&
       (uVar6 = *(long *)(this + 0x138) * 0x60 + uVar4, uVar4 < uVar6)) {
      do {
        uVar3 = *(ulong *)(uVar4 + 0x50);
        if (uVar3 != 0) {
          if ((*(long *)(uVar4 + 0x40) != 0) &&
             (uVar5 = *(long *)(uVar4 + 0x40) * 0x60 + uVar3, uVar3 < uVar5)) {
            do {
...
LAB_00104030:
  ...
  if (uVar4 != 0) {
    if ((*(long *)(this + 0x120) != 0) &&
       (uVar6 = *(long *)(this + 0x120) * 0x100 + uVar4, uVar4 < uVar6)) {
      do {
        uVar3 = *(ulong *)(uVar4 + 0x50);
        if (uVar3 != 0) {
          if ((*(long *)(uVar4 + 0x40) != 0) &&
...
/* JPH::BodyManager::sDeleteBody(JPH::Body*) */

void JPH::BodyManager::sDeleteBody(Body *param_1)

{
  ...
  if ((*(long *)(param_1 + 0x48) == 0) || (param_1[0x76] != (Body)0x1)) {
    ...
    SoftBodyMotionProperties::~SoftBodyMotionProperties
              ((SoftBodyMotionProperties *)(param_1 + 0x80));
    plVar2 = *(long **)(param_1 + 0x58);
  }
  if (plVar2 != (long *)0x0) {
    LOCK();
...
void JPH::BodyManager::_GLOBAL__sub_I__BodyManager(void)

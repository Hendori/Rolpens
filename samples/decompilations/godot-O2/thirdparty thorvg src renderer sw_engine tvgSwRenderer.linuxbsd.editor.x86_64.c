...
/* opBlendDifference(unsigned int, unsigned int, unsigned char) */

uint opBlendDifference(uint param_1,uint param_2,uchar param_3)
...
/* opBlendExclusion(unsigned int, unsigned int, unsigned char) */

uint opBlendExclusion(uint param_1,uint param_2,uchar param_3)

{
  ...
  uVar1 = (param_1 & 0xff) + (param_2 & 0xff) +
          ((int)((param_1 & 0xff) * (param_2 & 0xff) + 0xff) >> 8) * -2;
  if (0xff < (int)uVar1) {
    uVar1 = 0xff;
  }
  if ((int)uVar1 < 0) {
...
/* opBlendAdd(unsigned int, unsigned int, unsigned char) */

uint opBlendAdd(uint param_1,uint param_2,uchar param_3)
...
/* opBlendScreen(unsigned int, unsigned int, unsigned char) */

uint opBlendScreen(uint param_1,uint param_2,uchar param_3)

{
  ...
  return ((uVar2 + uVar1) - ((int)(uVar2 * uVar1 + 0xff) >> 8) & 0xff) << 8 |
         ((uVar3 + uVar4) - ((int)(uVar3 * uVar4 + 0xff) >> 8) & 0xff) << 0x10 |
         ((param_1 & 0xff) + (param_2 & 0xff)) -
         ((int)((param_1 & 0xff) * (param_2 & 0xff) + 0xff) >> 8) & 0xff | 0xff000000;
}



/* opBlendMultiply(unsigned int, unsigned int, unsigned char) */

uint opBlendMultiply(uint param_1,uint param_2,uchar param_3)

{
  return ((int)((param_1 >> 0x10 & 0xff) * (param_2 >> 0x10 & 0xff) + 0xff) >> 8) << 0x10 |
         (int)((param_1 & 0xff) * (param_2 & 0xff) + 0xff) >> 8 |
         (param_1 >> 8 & 0xff) * (param_2 >> 8 & 0xff) + 0xff & 0xffffff00 | 0xff000000;
}



/* opBlendOverlay(unsigned int, unsigned int, unsigned char) */

uint opBlendOverlay(uint param_1,uint param_2,uchar param_3)
...
/* opBlendDarken(unsigned int, unsigned int, unsigned char) */

uint opBlendDarken(uint param_1,uint param_2,uchar param_3)
...
/* opBlendLighten(unsigned int, unsigned int, unsigned char) */

uint opBlendLighten(uint param_1,uint param_2,uchar param_3)
...
/* opBlendColorDodge(unsigned int, unsigned int, unsigned char) */

uint opBlendColorDodge(uint param_1,uint param_2,uchar param_3)
...
/* opBlendColorBurn(unsigned int, unsigned int, unsigned char) */

undefined1  [16] opBlendColorBurn(uint param_1,uint param_2,uchar param_3)

{
  ...
  if ((param_1 & 0xff0000) == 0) {
    ...
    uVar3 = 0xff;
    uVar2 = (uint)((ulong)(long)(int)((uVar6 >> 0x10 & 0xff) * 0xff) /
                  (ulong)(long)(int)(param_1 >> 0x10 & 0xff));
    if (0xff < uVar2) {
      uVar2 = 0xff;
    }
    uVar2 = 0xff - uVar2;
...
/* opBlendHardLight(unsigned int, unsigned int, unsigned char) */

uint opBlendHardLight(uint param_1,uint param_2,uchar param_3)
...
/* opBlendSoftLight(unsigned int, unsigned int, unsigned char) */

uint opBlendSoftLight(uint param_1,uint param_2,uchar param_3)

{
  ...
  return (((int)(((int)(uVar5 * uVar5 + 0xff) >> 8) * (~uVar6 & 0xff) + 0xff) >> 8) +
          ((int)(uVar5 * uVar6 + 0xff) >> 8) & 0xffU) << 0x10 |
         (((int)(((int)(uVar2 * uVar2 + 0xff) >> 8) * (~uVar1 & 0xff) + 0xff) >> 8) +
          ((int)(uVar2 * uVar1 + 0xff) >> 8) & 0xffU) << 8 |
         ((int)(((int)(uVar4 * uVar4 + 0xff) >> 8) * (~uVar3 & 0xff) + 0xff) >> 8) +
         ((int)(uVar4 * uVar3 + 0xff) >> 8) & 0xffU | 0xff000000;
}
...
undefined8 tvg::SwRenderer::sync(void)
...
/* tvg::SwRenderer::viewport() */

undefined1  [16] __thiscall tvg::SwRenderer::viewport(SwRenderer *this)
...
/* tvg::SwRenderer::viewport(tvg::RenderRegion const&) */

undefined8 __thiscall tvg::SwRenderer::viewport(SwRenderer *this,RenderRegion *param_1)
...
/* tvg::SwRenderer::blend(tvg::BlendMethod) */

undefined8 __thiscall tvg::SwRenderer::blend(SwRenderer *this,char param_2)
...
/* tvg::SwRenderer::beginComposite(tvg::RenderCompositor*, tvg::CompositeMethod, unsigned char) */

undefined8 __thiscall
tvg::SwRenderer::beginComposite(SwRenderer *this,int *param_1,int param_3,undefined1 param_4)
...
/* tvg::SwRenderer::mainSurface() */

undefined8 __thiscall tvg::SwRenderer::mainSurface(SwRenderer *this)
...
/* tvg::SwRenderer::colorSpace() */

undefined1 __thiscall tvg::SwRenderer::colorSpace(SwRenderer *this)
...
/* tvg::SwRenderer::preRender() */

void __thiscall tvg::SwRenderer::preRender(SwRenderer *this)
...
/* tvg::SwRenderer::postRender() */

undefined8 __thiscall tvg::SwRenderer::postRender(SwRenderer *this)
...
/* tvg::SwRenderer::endComposite(tvg::RenderCompositor*) */

undefined8 __thiscall tvg::SwRenderer::endComposite(SwRenderer *this,RenderCompositor *param_1)

{
  ...
  if (param_1 == (RenderCompositor *)0x0) {
    ...
    *(undefined8 *)(pSVar2 + 0x70) = uVar3;
    if ((RVar1 == (RenderCompositor)0x0) &&
       (param_1[0x70] = (RenderCompositor)0x1, *(int *)param_1 == 0)) {
      local_18 = 0x3f800000;
      local_38 = (Matrix  [16])ZEXT416(_LC1);
      local_28 = ZEXT416(_LC1);
      uVar3 = rasterImage(pSVar2,(SwImage *)(param_1 + 0x18),local_38,(SwBBox *)(param_1 + 0x50),
                          (uchar)param_1[4]);
    }
    else {
      uVar3 = 1;
...
/* tvg::SwRenderer::prepare(tvg::RenderEffect*, tvg::Matrix const&) */

void __thiscall tvg::SwRenderer::prepare(SwRenderer *this,RenderEffect *param_1,Matrix *param_2)
...
/* tvg::SwRenderer::region(tvg::RenderEffect*) */

undefined8 __thiscall tvg::SwRenderer::region(SwRenderer *this,RenderEffect *param_1)
...
/* tvg::SwRenderer::renderShape(void*) */

undefined8 __thiscall tvg::SwRenderer::renderShape(SwRenderer *this,void *param_1)
  ...
  if (param_1 == (void *)0x0) {
    ...
    if (uVar1 != '\0') {
      ...
      if ((lVar3 == 0) || (*(char *)(lVar3 + 0x2c) == '\0')) {
        ...
        _renderStroke((SwShapeTask *)param_1,*(SwSurface **)(this + 0x38),
                      *(uchar *)((long)param_1 + 0xe1));
      }
      else {
        _renderStroke((SwShapeTask *)param_1,*(SwSurface **)(this + 0x38),uVar1);
        _renderFill((SwShapeTask *)param_1,*(SwSurface **)(this + 0x38),
                    *(uchar *)((long)param_1 + 0xe1));
      }
    }
    uVar5 = 1;
...
/* tvg::SwRenderer::clear() */

undefined8 __thiscall tvg::SwRenderer::clear(SwRenderer *this)
...
/* tvg::SwRenderer::prepareCommon(SwTask*, tvg::Matrix const&, tvg::Array<void*> const&, unsigned
   char, tvg::RenderUpdateFlag) [clone .part.0] */

void __thiscall
tvg::SwRenderer::prepareCommon
          (SwRenderer *this,Task *param_1,undefined8 *param_2,ulong *param_3,Task param_4,
          Task param_6)

{
  ...
  *(undefined4 *)(param_1 + 200) = *(undefined4 *)(param_2 + 4);
  if (((*(float *)(param_1 + 0xa8) == 0.0) && (*(float *)(param_1 + 0xac) == 0.0)) ||
     ((*(float *)(param_1 + 0xb4) == 0.0 && (*(float *)(param_1 + 0xb8) == 0.0)))) {
...
/* tvg::SwRenderer::renderImage(void*) */

undefined8 __thiscall tvg::SwRenderer::renderImage(SwRenderer *this,void *param_1)

{
  ...
  if (*(uchar *)((long)param_1 + 0xe1) == '\0') {
    ...
    uVar3 = rasterImage(*(SwSurface **)(this + 0x38),(SwImage *)((long)param_1 + 0xe8),
                        (Matrix *)((long)param_1 + 0xa8),(SwBBox *)((long)param_1 + 0x88),
                        *(uchar *)((long)param_1 + 0xe1));
    return uVar3;
  }
                    /* WARNING: Subroutine does not return */
...
/* tvg::SwRenderer::region(void*) */

ulong __thiscall tvg::SwRenderer::region(SwRenderer *this,void *param_1)
...
/* tvg::SwRenderer::dispose(void*) */

void __thiscall tvg::SwRenderer::dispose(SwRenderer *this,void *param_1)
...
/* tvg::SwRenderer::prepare(tvg::RenderSurface*, void*, tvg::Matrix const&, tvg::Array<void*>&,
   unsigned char, tvg::RenderUpdateFlag) */
...
/* tvg::SwRenderer::clearCompositors() */

void __thiscall tvg::SwRenderer::clearCompositors(SwRenderer *this)
...
/* tvg::SwRenderer::~SwRenderer() */

void __thiscall tvg::SwRenderer::~SwRenderer(SwRenderer *this)
...
undefined8 __thiscall
tvg::SwRenderer::target
          (SwRenderer *this,long param_1,uint param_2,uint param_3,int param_4,byte param_6)
...
/* tvg::SwRenderer::mempool(bool) */

bool __thiscall tvg::SwRenderer::mempool(SwRenderer *this,bool param_1)
...
/* tvg::SwRenderer::request(int, bool) */

undefined8 * __thiscall tvg::SwRenderer::request(SwRenderer *this,int param_1,bool param_2)

{
  ...
  uVar12 = uVar6;
  if ((param_2) && (uVar12 = uVar13, uVar13 <= uVar6)) {
    uVar12 = uVar6;
    uVar13 = uVar6;
  }
...
LAB_00101da6:
    ...
    lVar3 = puVar8[0xe];
    if ((((*(char *)(lVar3 + 0x70) != '\0') && ((uint)*(byte *)(lVar3 + 0x48) == param_1)) &&
        (*(uint *)((long)puVar8 + 0x34) == uVar12)) && (*(uint *)(puVar8 + 7) == uVar13)) {
...
/* tvg::SwRenderer::target(tvg::RenderRegion const&, tvg::ColorSpace, tvg::CompositionFlag) */

undefined8 __thiscall
tvg::SwRenderer::target(SwRenderer *this,uint *param_1,byte param_3,byte param_4)

{
  ...
  if ((((int)uVar7 < iVar2) && ((int)uVar10 < iVar3)) &&
     (-1 < (int)(uVar7 + uVar8 | uVar11 + uVar10))) {
    uVar9 = 4;
    if (3 < param_3) {
    ...
    if ((uVar8 != 0) && (uVar11 != 0)) {
      ...
      *(long *)(lVar5 + 0x68) = (long)(int)(uVar7 + uVar11);
      if ((lVar4 == 0) || (uVar10 = 0xffffff, lVar1 != 0)) {
        uVar10 = 0;
      }
...
/* tvg::SwRenderer::render(tvg::RenderCompositor*, tvg::RenderEffect const*, bool) */

undefined8 __thiscall
tvg::SwRenderer::render
          (SwRenderer *this,RenderCompositor *param_1,RenderEffect *param_2,bool param_3)
...
/* tvg::SwRenderer::prepareCommon(SwTask*, tvg::Matrix const&, tvg::Array<void*> const&, unsigned
   char, tvg::RenderUpdateFlag) */

undefined8 tvg::SwRenderer::prepareCommon(long param_1,undefined8 param_2)
...
/* tvg::SwRenderer::init(unsigned int) */

bool tvg::SwRenderer::init(uint param_1)
...
undefined4 tvg::SwRenderer::init(void)
...
undefined8 tvg::SwRenderer::term(void)
...
/* SwImageTask::clip(SwRle*) */

undefined8 SwImageTask::clip(SwRle *param_1)
...
void __thiscall SwImageTask::dispose(SwImageTask *this)
...
/* SwImageTask::run(unsigned int) */

void __thiscall SwImageTask::run(SwImageTask *this,uint param_1)
...
LAB_0010257b:
    ...
    pSVar3 = *(SwMpool **)(this + 0x80);
    if ((*(long *)(this + 0xf8) != 0) &&
       ((*(int *)(this + 0x100) != 0 && (*(int *)(this + 0x104) != 0)))) {
      cVar2 = imagePrepare(pSVar1,(Matrix *)(this + 0xa8),(SwBBox *)&local_58,
                           (SwBBox *)(this + 0x88),pSVar3,param_1);
      ...
      if ((cVar2 != '\0') && (*(long *)(this + 0xf0) != 0)) {
        ...
        if (puVar4 < puVar4 + *(uint *)(this + 0xd8)) {
          do {
            cVar2 = (**(code **)(*(long *)*puVar4 + 0x20))
                              ((long *)*puVar4,*(undefined8 *)(this + 0xf0));
            if (cVar2 == '\0') {
            ...
            puVar4 = puVar4 + 1;
                            ...
                            (*(long *)(this + 0xd0) + (ulong)*(uint *)(this + 0xd8) * 8));
        }
        goto LAB_0010258c;
      }
    }
...
void __thiscall SwShapeTask::dispose(SwShapeTask *this)
...
/* SwShapeTask::clip(SwRle*) */

undefined8 __thiscall SwShapeTask::clip(SwShapeTask *this,SwRle *param_1)
...
/* SwShapeTask::run(unsigned int) */

void __thiscall SwShapeTask::run(SwShapeTask *this,uint param_1)

{
  ...
  if (pfVar3 == (float *)0x0) {
    ...
    local_6c = 0.0;
    if ((_LC4 < (float)((uint)*pfVar3 & _LC3)) &&
       (((*(long *)(pfVar3 + 2) != 0 ||
         ((uint)(byte)this[0xe1] * (uint)*(byte *)((long)pfVar3 + 7) + 0xff >> 8 != 0)) &&
        (local_6c = 0.0, _LC4 < (float)((uint)(pfVar3[0xc] - pfVar3[0xd]) & _LC3))))) {
      local_6c = *pfVar3 * SQRT(*(float *)(this + 0xa8) * *(float *)(this + 0xa8) +
...
LAB_00102910:
      pFVar5 = *(Fill **)(*(long *)(this + 0x138) + 0x20);
      if (pFVar5 == (Fill *)0x0) {
        shapeDelFill(pSVar1);
      }
      else {
        ...
        cVar7 = shapeGenFillColors(pSVar1,pFVar5,(Matrix *)(this + 0xa8),
                                   *(SwSurface **)(this + 0x78),(uchar)this[0xe1],
                                   (bool)((byte)((int)(uint)(byte)SVar8 >> 2) & 1));
...
LAB_00102889:
    bVar10 = true;
    if (((_LC5 <= local_6c) &&
        (lVar4 = *(long *)(*(RenderShape **)(this + 0x138) + 0x28), *(int *)(lVar4 + 0x18) == 0)) &&
       (*(char *)(lVar4 + 0x2c) == '\0')) {
      if (((*(float *)(lVar4 + 0x30) == 0.0) && (*(float *)(lVar4 + 0x34) == _LC1)) ||
         (bVar10 = true,
         _LC1 <= (float)((uint)(*(float *)(lVar4 + 0x34) - *(float *)(lVar4 + 0x30)) & _LC3))) {
  ...
  if (((uint)(byte)this[0xe1] * (uint)*(byte *)(*(long *)(this + 0x138) + 0x33) + 0xff >> 8 == 0) &&
     (*(long *)(*(long *)(this + 0x138) + 0x20) == 0)) {
    shapeReset(pSVar1);
    if (this[0x140] != (SwShapeTask)0x0) {
      bVar10 = false;
      goto LAB_00102818;
  ...
  bVar10 = true;
LAB_00102818:
  cVar7 = shapePrepare(pSVar1,*(RenderShape **)(this + 0x138),(Matrix *)(this + 0xa8),
                       (SwBBox *)(this + 0x88),(SwBBox *)local_68,*(SwMpool **)(this + 0x80),param_1
                       ,*(int *)(this + 0xd8) != 0);
  if (cVar7 == '\0') {
    SVar8 = this[0xe0];
    local_68 = (undefined1  [16])0x0;
...
LAB_0010296e:
  if (((byte)SVar8 & 0x19) != 0) {
    if (local_6c <= 0.0) {
      ...
      cVar7 = shapeGenStrokeRle(pSVar1,*(RenderShape **)(this + 0x138),pMVar2,
                                (SwBBox *)(this + 0x88),(SwBBox *)local_68,
                                *(SwMpool **)(this + 0x80),param_1);
      if (cVar7 == '\0') {
LAB_00102b58:
        *(undefined1 (*) [16])(this + 0x88) = (undefined1  [16])0x0;
        *(undefined1 (*) [16])(this + 0x98) = (undefined1  [16])0x0;
      ...
      if ((*(long *)(*(long *)(this + 0x138) + 0x28) == 0) ||
         (pFVar5 = *(Fill **)(*(long *)(*(long *)(this + 0x138) + 0x28) + 8), pFVar5 == (Fill *)0x0)
         ) {
        ...
        cVar7 = shapeGenStrokeFillColors
                          (pSVar1,pFVar5,pMVar2,*(SwSurface **)(this + 0x78),(uchar)this[0xe1],
                           (bool)((byte)((int)(uint)(byte)SVar8 >> 6) & 1));
        if (cVar7 == '\0') goto LAB_00102b58;
      }
    }
  }
  ...
  if (puVar9 < puVar9 + *(uint *)(this + 0xd8)) {
    do {
      ...
      if (((*(long *)(this + 0x100) != 0) &&
          (cVar7 = (**(code **)(*plVar6 + 0x20))(plVar6), cVar7 == '\0')) ||
         ((*(long *)(this + 0x108) != 0 &&
          (cVar7 = (**(code **)(*plVar6 + 0x20))(plVar6), cVar7 == '\0')))) goto LAB_00102b58;
      puVar9 = puVar9 + 1;
...
/* SwImageTask::~SwImageTask() */

void __thiscall SwImageTask::~SwImageTask(SwImageTask *this)
...
/* SwShapeTask::~SwShapeTask() */

void __thiscall SwShapeTask::~SwShapeTask(SwShapeTask *this)

...
int connectToMiniSSDPD(char *param_1)
...
long * ssdpDiscoverDevices(long *param_1,uint param_2,char *param_3,int param_4,int param_5,
...
LAB_00100de6:
    __len = 0x10;
LAB_00100deb:
    iVar6 = bind(local_7f4,&local_6c8,__len);
    if (iVar6 != 0) {
      if (param_7 != (undefined4 *)0x0) {
        *param_7 = 0xffffff9b;
      }
...
LAB_00100e77:
      if (bVar4) {
        uVar7 = __snprintf_chk(local_648,0x600,2,0x600,
                               "M-SEARCH * HTTP/1.1\r\nHOST: %s:1900\r\nST: %s\r\nMAN: \"ssdp:discover\"\r\nMX: %u\r\n\r\n"
...
joined_r0x001010d1:
              if (lVar13 == 0) goto LAB_001010e0;
            }
            else {
              bVar22 = false;
              do {
                sVar8 = sendto(local_7f4,local_648,(long)(int)uVar7,0,*(sockaddr **)(lVar13 + 0x18),
                               *(socklen_t *)(lVar13 + 0x10));
                uVar7 = (uint)sVar8;
                if ((int)uVar7 < 0) {
                  perror("sendto");
                }
...
LAB_0010125e:
                  ...
                  if (local_7e8 != (long *)0x0) {
                    ...
                    do {
                      ...
                      if ((iVar6 == 0) && (pcVar12[__n] == '\0')) {
                        ...
                        if (((iVar6 == 0) && (pcVar12[local_7bc] == '\0')) &&
                           (((pcVar12 = (char *)plVar9[3], local_7c4 == 0 ||
                             (iVar6 = strncmp(pcVar12,local_7a8,(long)local_7c4), iVar6 == 0)) &&
                            (pcVar12[local_7c4] == '\0')))) goto LAB_0010115f;
                      }
                      plVar9 = (long *)*plVar9;
              ...
              } while ((local_790 - local_770) / 1000 + (local_798 - local_768) * 1000 <=
                       (long)(int)local_7c8);
            }
            if (param_5 == 0) {
...
LAB_00100e77:
      if (bVar4) {
        uVar6 = __snprintf_chk(&stack0x000001b0,0x600,2,0x600,
                               "M-SEARCH * HTTP/1.1\r\nHOST: %s:1900\r\nST: %s\r\nMAN: \"ssdp:discover\"\r\nMX: %u\r\n\r\n"
...
joined_r0x001010d1:
              if (lVar18 == 0) goto LAB_001010e0;
            }
            else {
              bVar20 = false;
              paVar17 = in_stack_000000b8;
              do {
                sVar7 = sendto(unaff_retaddr,&stack0x000001b0,(long)(int)uVar6,0,paVar17->ai_addr,
                               paVar17->ai_addrlen);
                uVar6 = (uint)sVar7;
                if ((int)uVar6 < 0) {
                  perror("sendto");
...
LAB_0010115f:
              do {
                iVar5 = receivedata(unaff_retaddr,&stack0x000001b0,0x600,in_stack_00000030,
                                    &stack0x000000b0);
                if (iVar5 < 0) {
                  if (in_stack_00000078 != (undefined4 *)0x0) {
                    *in_stack_00000078 = 0xffffff9b;
...
LAB_0010125e:
                pcVar14 = pcStack0000000000000020;
                if ((pcStack0000000000000008 != (char *)0x0) &&
                   (pcStack0000000000000020 != (char *)0x0)) {
                  ...
                  if (plStack0000000000000010 != (long *)0x0) {
                    ...
                    do {
                      ...
                      if ((iVar5 == 0) && (pcVar11[__n] == '\0')) {
                        ...
                        if (((iVar5 == 0) && (pcVar11[iStack000000000000003c] == '\0')) &&
                           (((pcVar11 = (char *)plVar8[3], iStack0000000000000034 == 0 ||
                             (iVar5 = strncmp(pcVar11,pcStack0000000000000050,
                                              (long)iStack0000000000000034), iVar5 == 0)) &&
                            (pcVar11[iStack0000000000000034] == '\0')))) goto LAB_0010115f;
                      }
                      plVar8 = (long *)*plVar8;
                  ...
                  *(undefined1 *)
                   ((long)plVar8 +
                   (long)(iStack000000000000003c + 1 + iStack0000000000000034) + 0x24) = 0;
              ...
              } while ((lStack0000000000000068 - lStack0000000000000088) / 1000 +
                       (lStack0000000000000060 - lStack0000000000000090) * 1000 <=
                       (long)(int)in_stack_00000030);
            }

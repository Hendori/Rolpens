...
void HUF_fillDTableX2ForWeight
               (undefined8 *param_1,byte *param_2,byte *param_3,int param_4,int param_5,uint param_6
               ,int param_7)
...
HUF_DecompressFastArgs_init
          (long *param_1,ulong param_2,long param_3,ushort *param_4,ulong param_5,
          undefined4 *param_6)

{
  ...
  if ((0 < param_3) || (uVar1 = param_2, param_3 != 0)) {
    if (param_5 < 10) {
    ...
    if ((char)((uint)*param_6 >> 0x10) == '\v') {
      ...
      param_1[0x12] = lVar3;
      if ((((7 < uVar12) && (7 < uVar9)) &&
          (uVar9 = (((param_5 - 6) - uVar12) - uVar9) - uVar6, 7 < uVar6)) && (7 < uVar9)) {
        if (param_5 < uVar9) {
          return 0xffffffffffffffec;
        }
        param_1[4] = param_2;
...

{
  ...
  while( true ) {
    ...
    if ((((puVar19 == local_88[3]) || (local_160 < puVar25)) || (local_158 < local_160)) ||
       (local_150 < local_158)) break;
    ...
    do {
      ...
      *puVar31 = uVar10;
      ...
      uVar26 = 0;
      for (uVar29 = uVar29 << ((ulong)bVar4 & 0x3f); (uVar29 & 1) == 0;
      ...
      *puVar28 = uVar12;
      ...
      bVar4 = *(byte *)((long)puVar3 + 3);
      uVar26 = 0;
      for (uVar20 = uVar20 << ((ulong)*(byte *)(puVar3 + 1) & 0x3f); (uVar20 & 1) == 0;
  ...
  *param_1 = local_a8;
  ...
  param_1[4] = local_138;
  param_1[5] = local_88[1];
  param_1[6] = local_88[2];
  param_1[7] = local_88[3];
...
ulong HUF_decompress4X2_usingDTable_internal_fast
                (undefined2 *param_1,ulong param_2,undefined8 param_3,undefined8 param_4,
...
LAB_00100f5d:
          ...
          lVar11 = *plVar9;
joined_r0x00100fe2:
          if ((long)uVar16 < 2) goto LAB_00100ea8;
        }
LAB_00100df3:
        do {
          uVar12 = (uint)uVar5;
...
LAB_00100e82:
        ...
        do {
          ...
          if (plVar9 < plVar1) {
            ...
            lVar11 = *plVar17;
LAB_00100d97:
            uVar16 = (long)param_1 - (long)puVar7;
            goto LAB_00100f5d;
          }
          uVar12 = uVar12 & 7;
          plVar17 = (long *)((long)plVar9 - (uVar5 >> 3));
...
LAB_00100c92:
          ...
          *puVar7 = *puVar8;
          ...
          puVar7 = (undefined2 *)((long)puVar7 + (ulong)*(byte *)((long)puVar8 + 3));
          puVar8 = (undefined2 *)
                   (param_5 + ((ulong)(lVar11 << ((ulong)(uVar12 + bVar2) & 0x3f)) >> 0x35) * 4);
          *puVar7 = *puVar8;
...
LAB_00100ea8:
      ...
      if (puVar7 < param_1) {
        ...
        *(undefined1 *)puVar7 =
             *(undefined1 *)(param_5 + ((ulong)(lVar11 << (uVar5 & 0x3f)) >> 0x35) * 4);
      }
...

{
  ...
  if (puStack_50 != local_d8) {
    ...
    local_e8 = puStack_70;
    do {
      if (((puVar15 < puVar24) || (local_108 < puVar15)) ||
         (puVar13 = puVar14, puVar21 = puVar22, local_e8 < local_108)) {
      ...
      do {
        ...
        *puVar19 = (char)(uVar1 >> 8);
        ...
        uVar1 = *(ushort *)(lVar6 + (uVar16 >> 0x35) * 2);
        uVar23 = 0;
        for (uVar16 = uVar16 << ((ulong)uVar1 & 0x3f); (uVar16 & 1) == 0;
        ...
        uVar25 = 0;
        for (uVar17 = uVar17 << ((ulong)uVar1 & 0x3f); (uVar17 & 1) == 0;
        ...
        puVar19 = puVar19 + 5;
        uVar23 = 0;
        for (uVar11 = uVar11 << ((ulong)uVar1 & 0x3f); (uVar11 & 1) == 0;
...
ulong HUF_decompress4X1_usingDTable_internal_fast
...
ulong HUF_decompress1X1_usingDTable_internal_default
                (byte *param_1,ulong param_2,ulong *param_3,ulong param_4,long param_5)
...
ulong HUF_decompress1X1_usingDTable_internal_bmi2
                (byte *param_1,ulong param_2,ulong *param_3,ulong param_4,long param_5)
...
ulong HUF_decompress1X2_usingDTable_internal_bmi2
                (undefined2 *param_1,ulong param_2,ulong *param_3,ulong param_4,long param_5)
...
LAB_0010209c:
  ...
  goto LAB_00102000;
LAB_00102220:
  uVar16 = (long)puVar17 - (long)param_1;
LAB_00102226:
  puVar14 = puVar17 + -1;
...
LAB_001022fb:
  ...
  if (param_1 < puVar17) {
    puVar3 = (undefined1 *)
             (param_5 + 4 + ((uVar9 << (uVar6 & 0x3f)) >> ((ulong)-uVar11 & 0x3f)) * 4);
    *(undefined1 *)param_1 = *puVar3;
    if (puVar3[3] == '\x01') {
      uVar12 = uVar12 + (byte)puVar3[2];
    }
    else if ((uVar12 < 0x40) && (uVar12 = uVar12 + (byte)puVar3[2], 0x40 < uVar12)) {
      if (param_3 != puVar10) {
        return 0xffffffffffffffec;
      }
      return param_2;
...
ulong HUF_decompress1X2_usingDTable_internal_default
                (undefined2 *param_1,ulong param_2,ulong *param_3,ulong param_4,long param_5)
...
LAB_0010268e:
  ...
  goto LAB_001025f0;
LAB_00102820:
  uVar8 = (long)puVar10 - (long)param_1;
LAB_00102826:
  puVar17 = puVar10 + -1;
...
LAB_00102834:
  do {
    ...
    puVar2 = (undefined2 *)
             (param_5 + 4 + ((uVar13 << ((byte)uVar6 & 0x3f)) >> (-bVar11 & 0x3f)) * 4);
    *param_1 = *puVar2;
...
LAB_001028fd:
  if (param_1 < puVar10) {
    ...
    *(undefined1 *)param_1 = *puVar3;
    ...
    else if ((uVar6 < 0x40) && (uVar6 = uVar6 + (byte)puVar3[2], 0x40 < uVar6)) {
      if (param_3 != puVar9) {
        return 0xffffffffffffffec;
      }
      return param_2;
...
ulong HUF_decompress4X1_usingDTable_internal_bmi2
                (byte *param_1,ulong param_2,ushort *param_3,ulong param_4,uint *param_5)
        ...
        if (uVar36 != 0) {
          ...
          if (uVar20 != 0) {
            ...
            if ((7 < (long)pbVar4 - (long)pbVar17) && (pbVar17 < pbVar3)) {
              ...
              pbVar37 = pbVar23;
              do {
                pbVar5 = (byte *)((long)puVar30 +
                                 ((uVar20 << ((ulong)local_f0 & 0x3f)) >> uVar14) * 2);
                param_1 = pbVar31 + 4;
                bVar7 = *pbVar5;
                pbVar38 = pbVar37 + 4;
                pbVar22 = pbVar39 + 4;
                ...
                *pbVar31 = pbVar5[1];
                pbVar5 = (byte *)((long)puVar30 +
                                 ((uVar18 << ((ulong)local_c0 & 0x3f)) >> uVar14) * 2);
                local_f0 = bVar7 + local_f0;
                bVar7 = *pbVar5;
                *pbVar37 = pbVar5[1];
                local_c0 = bVar7 + local_c0;
                pbVar5 = (byte *)((long)puVar30 +
                                 ((local_180 << ((ulong)local_90 & 0x3f)) >> uVar14) * 2);
                bVar7 = *pbVar5;
                *pbVar39 = pbVar5[1];
                pbVar5 = (byte *)((long)puVar30 +
                                 ((local_138 << ((ulong)local_60 & 0x3f)) >> uVar14) * 2);
                ...
                *pbVar25 = pbVar5[1];
                ...
                pbVar37[3] = pbVar6[1];
                local_c0 = bVar7 + local_c0;
                pbVar31 = (byte *)((long)puVar30 +
                                  ((local_180 << ((ulong)local_90 & 0x3f)) >> uVar14) * 2);
                local_90 = *pbVar31 + local_90;
                pbVar37 = (byte *)((long)puVar30 +
                                  ((local_138 << ((ulong)local_60 & 0x3f)) >> uVar14) * 2);
                pbVar39[3] = pbVar31[1];
                bVar7 = *pbVar37;
                pbVar25[3] = pbVar37[1];
...
LAB_001034fd:
            bVar27 = (pbVar16 < pbVar38 || pbVar23 < param_1) || pbVar17 < pbVar22;
            uVar20 = (ulong)bVar27;
            ...
            if ((long)pbVar23 - (long)param_1 < 4) {
              ...
              if (local_f0 < 0x41) {
                ...
                do {
                  ...
                  pbVar25 = (byte *)((long)puVar30 +
                                    ((uVar18 << ((ulong)uVar40 & 0x3f)) >> uVar34) * 2);
                  param_1 = pbVar39 + 4;
...
LAB_0010367e:
            ...
            if (pbVar39 < pbVar23) {
              do {
                pbVar25 = (byte *)((long)puVar30 +
                                  ((local_f8 << ((ulong)local_f0 & 0x3f)) >> (-uVar33 & 0x3f)) * 2);
                pbVar31 = pbVar39 + 1;
                bVar7 = *pbVar25;
                *pbVar39 = pbVar25[1];
...
LAB_0010383c:
            ...
            if (pbVar23 < pbVar16) {
              do {
                pbVar38 = (byte *)((long)puVar30 +
                                  ((local_c8 << ((ulong)local_c0 & 0x3f)) >> (-uVar33 & 0x3f)) * 2);
                pbVar39 = pbVar23 + 1;
                bVar7 = *pbVar38;
                *pbVar23 = pbVar38[1];
...
LAB_001039fd:
            ...
            if (pbVar23 < pbVar17) {
              do {
                pbVar16 = (byte *)((long)puVar30 +
                                  ((local_98 << ((ulong)local_90 & 0x3f)) >> (-uVar33 & 0x3f)) * 2);
                pbVar22 = pbVar23 + 1;
                bVar7 = *pbVar16;
                *pbVar23 = pbVar16[1];
...
LAB_00103bb3:
            ...
            if (pbVar23 < pbVar4) {
              do {
                pbVar16 = (byte *)((long)puVar30 +
                                  ((local_68 << ((ulong)local_60 & 0x3f)) >> (-uVar33 & 0x3f)) * 2);
                pbVar17 = pbVar23 + 1;
                bVar7 = *pbVar16;
                *pbVar23 = pbVar16[1];
            ...
            if ((((puVar12 == puVar32) && (puVar13 == puVar24)) &&
                ((local_90 == 0x40 && (puVar1 == puVar28 && local_f0 == 0x40)) &&
                 (puVar11 == puVar29 && local_c0 == 0x40))) && (uVar20 = param_2, local_60 == 0x40))
            goto LAB_00102beb;
            goto LAB_00102be4;
          }
        }
...
ulong HUF_decompress4X1_usingDTable_internal
                (byte *param_1,ulong param_2,ushort *param_3,ulong param_4,undefined4 *param_5,
                uint param_6)
          ...
          if (uVar25 != 0) {
            ...
            if (uVar11 != 0) {
              ...
              if ((7 < (long)pbVar4 - (long)pbVar34) && (pbVar34 < pbVar3)) {
                ...
                pbVar39 = pbVar20;
                do {
                  pbVar23 = (byte *)((long)param_5 +
                                    ((uVar11 << ((byte)uStack_f0 & 0x3f)) >> bVar14) * 2 + 4);
                  bVar7 = *pbVar23;
                  *pbVar36 = pbVar23[1];
                  iVar22 = bVar7 + uStack_f0;
                  pbVar23 = (byte *)((long)param_5 +
                                    ((uVar15 << ((byte)uStack_c0 & 0x3f)) >> bVar14) * 2 + 4);
                  bVar7 = *pbVar23;
                  *pbVar39 = pbVar23[1];
                  iVar35 = bVar7 + uStack_c0;
                  pbVar23 = (byte *)((long)param_5 +
                                    ((local_180 << ((byte)uStack_90 & 0x3f)) >> bVar14) * 2 + 4);
                  iVar27 = *pbVar23 + uStack_90;
                  *pbVar37 = pbVar23[1];
                  pbVar23 = (byte *)((long)param_5 +
                                    ((local_190 << ((byte)uStack_60 & 0x3f)) >> bVar14) * 2 + 4);
                  bVar7 = *pbVar23;
                  *pbVar12 = pbVar23[1];
                  iVar32 = bVar7 + uStack_60;
                  pbVar23 = (byte *)((long)param_5 +
                                    ((uVar11 << ((byte)iVar22 & 0x3f)) >> bVar14) * 2 + 4);
                  bVar7 = *pbVar23;
                  pbVar36[1] = pbVar23[1];
                  iVar22 = (uint)bVar7 + iVar22;
                  pbVar23 = (byte *)((long)param_5 +
                                    ((uVar15 << ((byte)iVar35 & 0x3f)) >> bVar14) * 2 + 4);
                  iVar35 = (uint)*pbVar23 + iVar35;
                  pbVar39[1] = pbVar23[1];
                  pbVar23 = (byte *)((long)param_5 +
                                    ((local_180 << ((byte)iVar27 & 0x3f)) >> bVar14) * 2 + 4);
                  iVar27 = (uint)*pbVar23 + iVar27;
                  pbVar37[1] = pbVar23[1];
                  pbVar23 = (byte *)((long)param_5 +
                                    ((local_190 << ((byte)iVar32 & 0x3f)) >> bVar14) * 2 + 4);
                  bVar7 = *pbVar23;
                  pbVar12[1] = pbVar23[1];
...
LAB_00105515:
                puStack_58 = local_188;
                uStack_68 = local_190;
              }
LAB_00104c53:
              bVar24 = (pbVar20 < param_1 || pbVar33 < pbStack_168) || pbVar34 < pbStack_128;
              uVar11 = (ulong)bVar24;
...
LAB_00104df8:
                    ...
                    uVar15 = *local_1b0;
LAB_00104cf7:
                    bVar24 = pbVar12 < pbVar20 + -3;
                    if (!bVar24) goto LAB_00104df8;
                    param_1 = pbVar12 + 4;
                    pbVar37 = (byte *)((long)param_5 +
                                      ((uVar15 << ((byte)uVar28 & 0x3f)) >> bVar14) * 2 + 4);
                    iVar27 = *pbVar37 + uVar28;
                    *pbVar12 = pbVar37[1];
                    pbVar37 = (byte *)((long)param_5 +
                                      ((uVar15 << ((byte)iVar27 & 0x3f)) >> bVar14) * 2 + 4);
...
LAB_00104e15:
              if (param_1 < pbVar20) {
                do {
                  pbVar37 = param_1 + 1;
                  pbVar12 = (byte *)((long)param_5 +
                                    ((local_f8 << ((byte)uStack_f0 & 0x3f)) >> (-cVar10 & 0x3fU)) *
                                    2 + 4);
                  bVar14 = *pbVar12;
                  *param_1 = pbVar12[1];
                ...
                if (uStack_c0 < 0x41) {
                  ...
                  do {
                    if (puVar38 < puVar13) {
                      ...
                      if (puVar16 < puVar5) {
                        puVar16 = (ulong *)((long)puVar38 -
                                           ((long)puVar38 - (long)puVar5 & 0xffffffffU));
                        uVar19 = *puVar16;
...
LAB_00104ff1:
              ...
              if (pbStack_168 < pbVar33) {
                do {
                  ...
                  pbVar20 = (byte *)((long)param_5 +
                                    ((uStack_c8 << ((byte)uStack_c0 & 0x3f)) >> (-cVar10 & 0x3fU)) *
                                    2 + 4);
                  bVar14 = *pbVar20;
                  *pbStack_168 = pbVar20[1];
                ...
                if (uStack_90 < 0x41) {
                  ...
                  do {
                    ...
                    if (puVar16 < puVar26) {
                      ...
                      if (puVar13 < puVar31) {
                        puVar13 = (ulong *)((long)puVar16 -
                                           ((long)puVar16 - (long)puVar31 & 0xffffffffU));
                        uVar19 = *puVar13;
...
LAB_001051d3:
              ...
              if (pbStack_128 < pbVar34) {
                do {
                  ...
                  pbVar20 = (byte *)((long)param_5 +
                                    ((uStack_98 << ((byte)uStack_90 & 0x3f)) >> (-cVar10 & 0x3fU)) *
                                    2 + 4);
                  bVar14 = *pbVar20;
                ...
                if (uStack_60 < 0x41) {
                  ...
                  do {
                    if (puVar26 < puVar2) {
                      ...
                      if (puVar13 < puVar30) {
                        puVar13 = (ulong *)((long)puVar26 -
                                           ((long)puVar26 - (long)puVar30 & 0xffffffffU));
                        uVar19 = *puVar13;
...
LAB_0010538f:
              ...
              if (pbVar20 < pbVar4) {
                do {
                  pbVar34 = pbVar20 + 1;
                  pbVar33 = (byte *)((long)param_5 +
                                    ((uStack_68 << ((byte)uStack_60 & 0x3f)) >> (-cVar10 & 0x3fU)) *
                                    2 + 4);
                  bVar14 = *pbVar33;
                  *pbVar20 = pbVar33[1];
              ...
              if (((puVar31 == puStack_88) && (puVar30 == puStack_58)) &&
                 (uVar11 = param_2,
                 ((uStack_60 == 0x40 && (puVar1 == local_e8 && uStack_f0 == 0x40)) &&
                 (puVar5 == puStack_b8 && uStack_c0 == 0x40)) && uStack_90 == 0x40))
              goto LAB_001042ad;
              goto LAB_00104374;
            }
          }
...
LAB_00104374:
    ...
    if (((param_6 & 0x20) != 0) ||
       (uVar11 = HUF_decompress4X1_usingDTable_internal_fast
                           (param_1,param_2,param_3,param_4,param_5,pcVar29), uVar11 == 0)) {
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
        uVar11 = HUF_decompress4X1_usingDTable_internal_bmi2
...
ulong HUF_decompress4X2_usingDTable_internal_bmi2
                (undefined2 *param_1,ulong param_2,ushort *param_3,ulong param_4,uint *param_5)
...
LAB_0010642a:
    bVar26 = (puVar17 < puVar19 || puVar5 < param_1) || puVar18 < puVar25;
    uVar24 = (ulong)bVar26;
...
LAB_00107bd6:
            ...
            uVar21 = *local_1b0;
LAB_00107aa2:
            bVar26 = param_1 < (undefined2 *)((long)puVar5 - 9U);
...
LAB_001065da:
          ...
          uVar21 = *local_1b0;
LAB_001064cc:
          bVar26 = param_1 < (undefined2 *)((long)puVar5 - 7U);
...
LAB_00106712:
    ...
    if (param_1 < puVar5) {
      ...
      *(char *)param_1 = (char)*puVar7;
      ...
      else if ((local_f0 < 0x40) &&
              (local_f0 = *(byte *)((long)puVar7 + 2) + local_f0, 0x40 < local_f0)) {
        local_f0 = 0x40;
      }
    }
...
LAB_00106a8e:
  if (puVar19 < puVar17) {
    ...
    *(char *)puVar19 = (char)*puVar7;
    ...
    else if ((local_c0 < 0x40) &&
            (local_c0 = *(byte *)((long)puVar7 + 2) + local_c0, 0x40 < local_c0)) {
      local_c0 = 0x40;
    }
  }
...
LAB_00106dad:
  if (puVar25 < puVar18) {
    ...
    *(char *)puVar25 = (char)*puVar7;
    ...
    else if ((local_90 < 0x40) &&
            (local_90 = *(byte *)((long)puVar7 + 2) + local_90, 0x40 < local_90)) {
      local_90 = 0x40;
    }
  }
...
LAB_00107ee2:
          ...
          uVar21 = *puVar33;
LAB_00107dca:
          bVar26 = puVar31 < (undefined2 *)((long)puVar4 - 9U);
...
LAB_00107073:
  ...
  if (puVar31 < puVar4) {
    ...
    *(char *)puVar31 = (char)*param_5;
    ...
    else if ((local_60 < 0x40) &&
            (local_60 = *(byte *)((long)param_5 + 2) + local_60, 0x40 < local_60)) {
      local_60 = 0x40;
    }
  }
  if ((((puVar9 != puVar20) || (puVar13 != puVar30)) ||
      ((local_90 != 0x40 || (puVar1 != local_188 || local_f0 != 0x40)) ||
       (puVar6 != local_1b0 || local_c0 != 0x40))) || (uVar24 = param_2, local_60 != 0x40)) {
LAB_00105abe:
    uVar24 = 0xffffffffffffffec;
  }
LAB_00105ac5:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return uVar24;
...
ulong HUF_decompress4X2_usingDTable_internal
                (undefined2 *param_1,ulong param_2,ushort *param_3,ulong param_4,uint *param_5,
                uint param_6)
...
LAB_00108bb8:
      bVar26 = (puVar22 < puStack_158 || puVar8 < param_1) || puVar23 < puStack_140;
      uVar14 = (ulong)bVar26;
  ...
  if (((param_6 & 0x20) != 0) ||
     (uVar14 = HUF_decompress4X2_usingDTable_internal_fast
                         (param_1,param_2,param_3,param_4,param_5,pcVar28), uVar14 == 0)) {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
LAB_00108d90:
  if (1 < (ulong)((long)puVar8 - (long)param_1)) {
    uVar17 = local_f8;
    uVar13 = uStack_f0;
    if (uStack_f0 < 0x41) {
      bVar26 = false;
...
LAB_00108edb:
  if (param_1 < puVar8) {
    ...
    *(char *)param_1 = (char)*puVar7;
    ...
    else if ((uStack_f0 < 0x40) &&
            (uStack_f0 = *(byte *)((long)puVar7 + 2) + uStack_f0, 0x40 < uStack_f0)) {
      uStack_f0 = 0x40;
    }
  }
...
LAB_001091cd:
  ...
  if (puStack_158 < puVar22) {
    ...
    *(char *)puStack_158 = (char)*puVar7;
    ...
    else if ((uStack_c0 < 0x40) &&
            (uStack_c0 = *(byte *)((long)puVar7 + 2) + uStack_c0, 0x40 < uStack_c0)) {
      uStack_c0 = 0x40;
    }
  }
...
LAB_0010953b:
  ...
  if (puStack_140 < puVar23) {
    ...
    *(char *)puStack_140 = (char)*puVar7;
    ...
    else if ((uStack_90 < 0x40) &&
            (uStack_90 = *(byte *)((long)puVar7 + 2) + uStack_90, 0x40 < uStack_90)) {
      uStack_90 = 0x40;
    }
  }
...
LAB_0010989f:
  ...
  if (puStack_150 < puVar5) {
    ...
    *(char *)puStack_150 = (char)*param_5;
    ...
    else if ((uStack_60 < 0x40) &&
            (uStack_60 = *(byte *)((long)param_5 + 2) + uStack_60, 0x40 < uStack_60)) {
      uStack_60 = 0x40;
    }
  }
  if (((puVar32 != puStack_88) || (puVar30 != puStack_58)) ||
     (uVar14 = param_2,
     ((uStack_60 != 0x40 || (puVar1 != local_e8 || uStack_f0 != 0x40)) ||
     (puVar6 != puStack_b8 || uStack_c0 != 0x40)) || uStack_90 != 0x40)) {
LAB_0010822d:
...
ulong HUF_readDTableX1_wksp
                (uint *param_1,undefined8 param_2,undefined8 param_3,int *param_4,ulong param_5,
                undefined8 param_6)

{
  ...
  local_44 = 0;
  if (0x5d3 < param_5) {
    uVar4 = HUF_readStats_wksp(param_4 + 0x135,0x100,param_4,&local_44,&local_48,param_2,param_3,
                               param_4 + 0x1a,0x36c,param_6);
    uVar2 = local_44;
    ...
    uVar9 = local_48;
    if ((local_48 <= uVar10) && (uVar9 = uVar10, local_48 < uVar10)) {
      ...
      do {
        ...
        if (iVar3 == 4) {
          if (0 < (int)uVar2) {
            uVar18 = 0;
            do {
              lVar11 = (long)(int)((uint)*(byte *)((long)param_4 + uVar18 + (long)iVar16 + 0x3d4) *
                                   0x100 + (uVar17 & 0xff)) * 0x10001;
              *(long *)((long)param_1 + uVar18 * 8 + (long)iVar22 * 2 + 4) =
                   lVar11 + (lVar11 << 0x20);
              uVar18 = uVar18 + 1;
            } while (uVar18 != uVar2);
          }
          ...
          if (iVar3 == 1) {
            if (0 < (int)uVar2) {
              uVar18 = 0;
              do {
                *(ushort *)((long)param_1 + uVar18 * 2 + (long)iVar22 * 2 + 4) =
                     CONCAT11(*(undefined1 *)((long)param_4 + uVar18 + 0x3d4 + (long)iVar16),
                              (char)uVar17);
                uVar18 = uVar18 + 1;
              } while (uVar2 != uVar18);
            }
            ...
            if (0 < (int)uVar2) {
              ...
              do {
                ...
                *(uint *)((long)param_1 + uVar18 * 4 + (long)iVar22 * 2) =
                     (((uint)bVar1 << 8 | uVar17 & 0xff) << 8 | (uint)bVar1) << 8 | uVar17 & 0xff;
                uVar18 = uVar18 + 1;
...
ulong HUF_readDTableX2_wksp
                (uint *param_1,undefined8 param_2,undefined8 param_3,uint *param_4,ulong param_5,
                undefined8 param_6)

{
  ...
  *(undefined1 (*) [16])(param_4 + 0xb4) = (undefined1  [16])0x0;
  local_51 = (byte)uVar1;
  if (local_51 < 0xd) {
    uVar24 = HUF_readStats_wksp(param_4 + 0xf8,0x100,param_4 + 0x9c,&local_44,&local_48,param_2,
                                param_3,param_4 + 0x138,0x36c,param_6);
    ...
    do {
      ...
      if (uVar25 < local_70) {
        HUF_fillDTableX2ForWeight
                  (param_1 + uVar13 + 1,(long)param_4 + lVar22 + 0x2e0,
                   (long)param_4 + (long)(int)uVar21 + 0x2e0,uVar15,local_d4,0,1);
      }
      else {
        iVar10 = 1;
        if (0 < iVar8) {
...
LAB_0010b370:
              do {
                iVar26 = iVar11 + -1;
                HUF_fillDTableX2ForWeight
                          (puVar4 + *puVar16,(long)param_4 + (long)(int)puVar17[0xa9] + 0x2e0,
                           (long)param_4 + (long)(int)puVar17[0xaa] + 0x2e0,iVar11,local_d4,bVar6,2)
                ;
                puVar16 = puVar16 + 1;
                puVar17 = puVar17 + 1;
                iVar11 = iVar26;
  ...
  *param_1 = CONCAT22((ushort)((uVar1 & 0xff00ffff) >> 0x10) | (ushort)local_51,
                      CONCAT11(1,(char)(uVar1 & 0xff00ffff)));
LAB_0010b3fb:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
...
ulong HUF_decompress1X2_DCtx_wksp
...

{
  ...
  if (uVar1 < 0xffffffffffffff89) {
    if (uVar1 < param_5) {
      ...
      uVar1 = HUF_decompress1X2_usingDTable_internal_bmi2
                        (param_2,param_3,param_4 + uVar1,param_5 - uVar1,param_1);
      return uVar1;
    }
...
ulong HUF_decompress1X1_DCtx_wksp
                (undefined8 param_1,undefined8 param_2,undefined8 param_3,long param_4,ulong param_5
                ,undefined8 param_6,undefined8 param_7,uint param_8)

{
  ...
  if (uVar1 < 0xffffffffffffff89) {
    if (uVar1 < param_5) {
      ...
      uVar1 = HUF_decompress1X1_usingDTable_internal_bmi2
                        (param_2,param_3,param_4 + uVar1,param_5 - uVar1,param_1);
      return uVar1;
    }
    uVar1 = 0xffffffffffffffb8;
...
size_t HUF_decompress1X_DCtx_wksp
                 (undefined8 param_1,void *param_2,size_t param_3,byte *param_4,ulong param_5)
...
ulong HUF_decompress4X_hufOnly_wksp
...

{
  ...
  if (iVar1 == 0) {
    ...
    if (uVar2 < param_5) {
      uVar2 = HUF_decompress4X1_usingDTable_internal
                        (param_2,param_3,param_4 + uVar2,param_5 - uVar2,param_1,param_8);
      return uVar2;
    }
  }
  else {
    ...
    if (uVar2 < param_5) {
      uVar2 = HUF_decompress4X2_usingDTable_internal
                        (param_2,param_3,param_4 + uVar2,param_5 - uVar2,param_1,param_8);
      return uVar2;
    }
  }

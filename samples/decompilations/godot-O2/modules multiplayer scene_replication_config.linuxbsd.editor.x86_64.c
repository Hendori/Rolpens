...
LAB_00101983:
  ...
  if (plVar10 == (long *)0x0) {
    if (uVar6 == 0) {
      ...
      plVar10 = *(long **)(this + 0x240);
LAB_00101ca8:
      if (plVar10 != (long *)0x0) goto LAB_00101a5f;
    }
LAB_00101ba9:
    lVar11 = 0;
LAB_00101bb0:
    uVar5 = 0;
    _err_print_index_error
              ("_set","modules/multiplayer/scene_replication_config.cpp",0x2f,(long)(int)uVar6,
               lVar11,"idx","properties.size()","",false,false);
  }
...
LAB_00101cf8:
    if (*(int *)param_2 == 0x16) {
      ...
      if ((cVar3 == '\0') && (iVar8 = NodePath::get_subname_count(), iVar8 != 0)) {
...
LAB_001021a3:
    uVar5 = 0;
    _err_print_index_error
              ("_get","modules/multiplayer/scene_replication_config.cpp",0x4f,(long)(int)uVar6,
               lVar12,"idx","properties.size()","",false,false);
  }
  else {
    if (plVar1 == (long *)0x0) {
LAB_001021a0:

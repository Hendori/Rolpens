...
/* (anonymous namespace)::_is_triangle_hole(JPH::Array<JPH::Float3, JPH::STLAllocator<JPH::Float3> >
   const&, int, int, int) [clone .isra.0] */

ulong (anonymous_namespace)::_is_triangle_hole(Array *param_1,int param_2,int param_3,int param_4)
...
/* JoltHeightMapShape3D::get_data() const */

void JoltHeightMapShape3D::get_data(void)
...
/* JoltHeightMapShape3D::_calculate_aabb() const */

void JoltHeightMapShape3D::_calculate_aabb(void)
...
LAB_001005f3:
          ...
          fVar18 = in_RDI[3];
          if (((fVar18 < 0.0) || (in_RDI[4] <= 0.0 && in_RDI[4] != 0.0)) ||
...
/* JoltHeightMapShape3D::set_data(Variant const&) */

void __thiscall JoltHeightMapShape3D::set_data(JoltHeightMapShape3D *this,Variant *param_1)

{
  ...
  if (*(int *)param_1 == 0x1b) {
    ...
    if (local_d8[0] == 0x20) {
      ...
      if (local_b8[0] == 2) {
        ...
        if (local_98[0] == 2) {
          ...
          *(undefined8 *)(this + 0x80) = local_108;
          ...
          _err_print_error("set_data","modules/jolt_physics/shapes/jolt_height_map_shape_3d.cpp",
                           0xdc,"Condition \"maybe_depth.get_type() != Variant::INT\" is true.",0,0)
          ;
          cVar2 = Variant::needs_deinit[local_98[0]];
        }
        if (cVar2 != '\0') {
        ...
        _err_print_error("set_data","modules/jolt_physics/shapes/jolt_height_map_shape_3d.cpp",0xd9,
                         "Condition \"maybe_width.get_type() != Variant::INT\" is true.",0,0);
      }
      ...
      _err_print_error("set_data","modules/jolt_physics/shapes/jolt_height_map_shape_3d.cpp",0xd5,
                       "Condition \"maybe_heights.get_type() != Variant::PACKED_FLOAT32_ARRAY\" is true."
                       ,0,0);
    }
    ...
    _err_print_error("set_data","modules/jolt_physics/shapes/jolt_height_map_shape_3d.cpp",0xcc,
...
/* JoltHeightMapShape3D::to_string() const */

void JoltHeightMapShape3D::to_string(void)
...
/* JoltHeightMapShape3D::_build_height_field() const */

void JoltHeightMapShape3D::_build_height_field(void)

{
  ...
  if ((lVar18 == 0) || (iVar14 = (int)*(undefined8 *)(lVar18 + -8), iVar14 == 0)) {
    pvVar9 = (void *)0x0;
  }
  else {
    uVar8 = iVar14 - 1;
    ...
    uVar8 = uVar8 | uVar8 >> 4;
    uVar8 = uVar8 | uVar8 >> 8;
    pvVar9 = (void *)Memory::realloc_static
                               ((void *)0x0,(ulong)((uVar8 | uVar8 >> 0x10) + 1) << 2,false);
    if (pvVar9 == (void *)0x0) {
  ...
  JPH::HeightFieldShapeSettings::HeightFieldShapeSettings
            (pHVar20._0_4_,CONCAT44(fVar19,fVar19),0x3f8000003f800000,0x3f8000003f800000,local_118,
             pvVar9,iVar16,0,&local_178);
...
joined_r0x00100da1:
        ...
        do {
          ...
          if (plVar4 != (long *)0x0) {
            ...
            *(int *)plVar1 = (int)*plVar1 + -1;
            UNLOCK();
            if ((int)*plVar1 == 0) {
              if (*(code **)(*plVar4 + 0x18) == JPH::PhysicsMaterial::~PhysicsMaterial)
              goto code_r0x00100ddf;
              (**(code **)(*plVar4 + 0x18))();
            }
          }
          plVar12 = plVar12 + 1;
  ...
  if (local_128 == '\x02') {
    ...
    local_180 = 0;
    local_178 = 
    "Failed to build Jolt Physics height map shape with %s. It returned the following error: \'%s\'. This shape belongs to %s."
    ;
    uStack_170 = 0x77;
    String::parse_latin1((StrRange *)&local_180);
    vformat<String,String,String>
              (&local_178,(StrRange *)&local_180,&local_198,&local_190,&local_188);
    _err_print_error("_build_height_field",
                     "modules/jolt_physics/shapes/jolt_height_map_shape_3d.cpp",0x70,
                     "Condition \"shape_result.HasError()\" is true. Returning: nullptr",&local_178,
                     0,0);
    pcVar7 = local_178;
    if (local_178 != (char *)0x0) {
      LOCK();
...
/* JoltHeightMapShape3D::_build_mesh() const */

undefined8 * JoltHeightMapShape3D::_build_mesh(void)
...
LAB_001013f7:
            _err_print_index_error
                      ("get","./core/templates/cowdata.h",0xdb,lVar16,lVar21,"p_index","size()","",
                       false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_0010162d:
  ...
  if (local_e8 == '\x02') {
    ...
    local_148 = 0;
    local_128 = 
    "Failed to build Jolt Physics height map shape (as polygon) with %s. It returned the following error: \'%s\'. This shape belongs to %s."
    ;
    uStack_120 = 0x84;
    String::parse_latin1((StrRange *)&local_148);
    vformat<String,String,String>
              (&local_128,(StrRange *)&local_148,&local_178,&local_170,&local_168);
    _err_print_error("_build_mesh","modules/jolt_physics/shapes/jolt_height_map_shape_3d.cpp",0xa6,
                     "Condition \"shape_result.HasError()\" is true. Returning: nullptr",&local_128,
                     0,0);
    pcVar11 = local_128;
    if (local_128 != (char *)0x0) {
      LOCK();
...
/* JoltHeightMapShape3D::_build() const */

void JoltHeightMapShape3D::_build(void)

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  if ((*(long *)(in_RSI + 0x90) != 0) &&
     (iVar6 = (int)*(undefined8 *)(*(long *)(in_RSI + 0x90) + -8), iVar6 != 0)) {
    ...
    _err_print_error("_build","modules/jolt_physics/shapes/jolt_height_map_shape_3d.cpp",uVar8,
                     pcVar7,&local_48,0,0);
    plVar2 = local_48;
    if (local_48 != (long *)0x0) {
      LOCK();
...
/* JoltHeightMapShape3D::get_type() const */

undefined8 JoltHeightMapShape3D::get_type(void)
...
/* JoltHeightMapShape3D::is_convex() const */

undefined8 JoltHeightMapShape3D::is_convex(void)
...
/* JoltHeightMapShape3D::get_margin() const */

undefined8 JoltHeightMapShape3D::get_margin(void)
...
/* JoltHeightMapShape3D::set_margin(float) */

void JoltHeightMapShape3D::set_margin(float param_1)
...
/* JoltHeightMapShape3D::get_aabb() const */

void JoltHeightMapShape3D::get_aabb(void)
...
/* JoltHeightMapShape3D::~JoltHeightMapShape3D() */

void __thiscall JoltHeightMapShape3D::~JoltHeightMapShape3D(JoltHeightMapShape3D *this)
...
/* WARNING: Removing unreachable block (ram,0x00102b19) */
/* WARNING: Removing unreachable block (ram,0x001029ac) */
/* WARNING: Removing unreachable block (ram,0x001029b6) */
/* WARNING: Removing unreachable block (ram,0x00102afb) */
/* WARNING: Removing unreachable block (ram,0x001029c2) */
/* WARNING: Removing unreachable block (ram,0x001029cc) */
/* WARNING: Removing unreachable block (ram,0x00102add) */
/* WARNING: Removing unreachable block (ram,0x001029d8) */
/* WARNING: Removing unreachable block (ram,0x001029e2) */
/* WARNING: Removing unreachable block (ram,0x00102abf) */
/* WARNING: Removing unreachable block (ram,0x001029ee) */
/* WARNING: Removing unreachable block (ram,0x001029f8) */
/* WARNING: Removing unreachable block (ram,0x00102aa1) */
/* WARNING: Removing unreachable block (ram,0x00102a04) */
/* WARNING: Removing unreachable block (ram,0x00102a0e) */
/* WARNING: Removing unreachable block (ram,0x00102a83) */
/* WARNING: Removing unreachable block (ram,0x00102a16) */
...
/* WARNING: Removing unreachable block (ram,0x00102a3e) */
/* WARNING: Removing unreachable block (ram,0x00102a4a) */
...
/* WARNING: Removing unreachable block (ram,0x00102c98) */
/* WARNING: Removing unreachable block (ram,0x00102dc8) */
/* WARNING: Removing unreachable block (ram,0x00102f40) */
/* WARNING: Removing unreachable block (ram,0x00102dd4) */
/* WARNING: Removing unreachable block (ram,0x00102dde) */
...
/* WARNING: Removing unreachable block (ram,0x00102e0a) */
/* WARNING: Removing unreachable block (ram,0x00102ee6) */
/* WARNING: Removing unreachable block (ram,0x00102e16) */
/* WARNING: Removing unreachable block (ram,0x00102e20) */
/* WARNING: Removing unreachable block (ram,0x00102ec8) */
/* WARNING: Removing unreachable block (ram,0x00102e2c) */
/* WARNING: Removing unreachable block (ram,0x00102e36) */
/* WARNING: Removing unreachable block (ram,0x00102eaa) */
/* WARNING: Removing unreachable block (ram,0x00102e3e) */
/* WARNING: Removing unreachable block (ram,0x00102e48) */
/* WARNING: Removing unreachable block (ram,0x00102e8f) */
/* WARNING: Removing unreachable block (ram,0x00102e50) */
/* WARNING: Removing unreachable block (ram,0x00102e65) */
/* WARNING: Removing unreachable block (ram,0x00102e71) */
...
/* WARNING: Removing unreachable block (ram,0x00103206) */
/* WARNING: Removing unreachable block (ram,0x0010334a) */
/* WARNING: Removing unreachable block (ram,0x00103212) */
/* WARNING: Removing unreachable block (ram,0x0010321c) */
...
/* WARNING: Removing unreachable block (ram,0x0010330e) */
...
/* WARNING: Removing unreachable block (ram,0x0010325e) */
...
/* WARNING: Removing unreachable block (ram,0x001032b7) */
/* WARNING: Removing unreachable block (ram,0x00103278) */
/* WARNING: Removing unreachable block (ram,0x0010328d) */
/* WARNING: Removing unreachable block (ram,0x00103299) */
/* String vformat<long, int, int>(String const&, long const, int const, int const) */

String_conflict *
vformat<long,int,int>(String_conflict *param_1,long param_2,int param_3,int param_4)
...
void JoltHeightMapShape3D::_GLOBAL__sub_I__build(void)

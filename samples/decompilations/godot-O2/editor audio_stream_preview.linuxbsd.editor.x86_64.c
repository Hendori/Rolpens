...
HashMap<ObjectID,AudioStreamPreviewGenerator::Preview,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,AudioStreamPreviewGenerator::Preview>>>
::_lookup_pos(HashMap<ObjectID,AudioStreamPreviewGenerator::Preview,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,AudioStreamPreviewGenerator::Preview>>>
...
/* AudioStreamPreviewGenerator::_update_emit(ObjectID) */

void __thiscall
AudioStreamPreviewGenerator::_update_emit(AudioStreamPreviewGenerator *this,undefined8 param_2)

{
  ...
  if ((_update_emit(ObjectID)::{lambda()#1}::operator()()::sname == '\0') &&
     (iVar2 = __cxa_guard_acquire(&_update_emit(ObjectID)::{lambda()#1}::operator()()::sname),
     iVar2 != 0)) {
    _scs_create((char *)&_update_emit(ObjectID)::{lambda()#1}::operator()()::sname,true);
    __cxa_atexit(StringName::~StringName,&_update_emit(ObjectID)::{lambda()#1}::operator()()::sname,
                 &__dso_handle);
  ...
  (**(code **)(*(long *)this + 0xd0))
            (this,&_update_emit(ObjectID)::{lambda()#1}::operator()()::sname,local_78,1);
...
/* AudioStreamPreviewGenerator::_notification(int) [clone .part.0] */

void AudioStreamPreviewGenerator::_notification(int param_1)
...
LAB_00100686:
      ...
      local_44 = 0;
      cVar19 = HashMap<ObjectID,AudioStreamPreviewGenerator::Preview,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,AudioStreamPreviewGenerator::Preview>>>
               ::_lookup_pos((HashMap<ObjectID,AudioStreamPreviewGenerator::Preview,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,AudioStreamPreviewGenerator::Preview>>>
                              *)(lVar29 + 0x408),(ObjectID *)*puVar28,&local_44);
      if (cVar19 != '\0') {
        ...
        if ((*puVar33 == 0) ||
           (auVar8._8_8_ = 0, auVar8._0_8_ = uVar30 * lVar3, auVar14._8_8_ = 0,
           auVar14._0_8_ = uVar34, auVar9._8_8_ = 0,
           auVar9._0_8_ = (ulong)((uVar24 + uVar25) - SUB164(auVar8 * auVar14,8)) * lVar3,
           auVar15._8_8_ = 0, auVar15._0_8_ = uVar34, SUB164(auVar9 * auVar15,8) == 0)) {
          ...
          while( true ) {
            ...
            *puVar1 = uVar5;
            ...
            uVar30 = (ulong)*puVar33;
            if ((*puVar33 == 0) ||
               (auVar10._8_8_ = 0, auVar10._0_8_ = uVar30 * lVar3, auVar16._8_8_ = 0,
               auVar16._0_8_ = uVar34, auVar11._8_8_ = 0,
               auVar11._0_8_ =
                    (ulong)((SUB164(auVar12 * auVar18,8) + uVar24) - SUB164(auVar10 * auVar16,8)) *
                    lVar3, auVar17._8_8_ = 0, auVar17._0_8_ = uVar34,
               SUB164(auVar11 * auVar17,8) == 0)) break;
        ...
        *(undefined4 *)(lVar23 + uVar31 * 4) = 0;
        ...
        if ((plVar21[5] != 0) && (cVar19 = RefCounted::unreference(), cVar19 != '\0')) {
          pOVar6 = (Object *)plVar21[5];
        ...
        if ((plVar21[4] != 0) && (cVar19 = RefCounted::unreference(), cVar19 != '\0')) {
          pOVar6 = (Object *)plVar21[4];
          cVar19 = predelete_handler(pOVar6);
          if (cVar19 != '\0') {
            (**(code **)(*(long *)pOVar6 + 0x140))(pOVar6);
            Memory::free_static(pOVar6,false);
        ...
        if ((plVar21[3] != 0) && (cVar19 = RefCounted::unreference(), cVar19 != '\0')) {
          pOVar6 = (Object *)plVar21[3];
          cVar19 = predelete_handler(pOVar6);
          if (cVar19 != '\0') {
            (**(code **)(*(long *)pOVar6 + 0x140))(pOVar6);
            Memory::free_static(pOVar6,false);
...
undefined4 __thiscall AudioStreamPreview::get_length(AudioStreamPreview *this)
...
undefined8 __thiscall
AudioStreamPreview::get_max(AudioStreamPreview *this,float param_1,float param_2)

{
  ...
  if ((fVar1 == 0.0) || (lVar2 = *(long *)(this + 0x188), lVar2 == 0)) {
    return 0;
  }
  lVar3 = *(long *)(lVar2 + -8);
  iVar6 = (int)(lVar3 / 2);
...
LAB_001009ec:
  _err_print_index_error
            ("get","./core/templates/cowdata.h",0xdb,lVar13,lVar3,"p_index","size()","",false,true);
  _err_flush_stdout();
...
undefined8 __thiscall
AudioStreamPreview::get_min(AudioStreamPreview *this,float param_1,float param_2)
...
LAB_00100ba4:
  _err_print_index_error
            ("get","./core/templates/cowdata.h",0xdb,lVar11,lVar3,"p_index","size()","",false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar4 = (code *)invalidInstructionException();
  (*pcVar4)();
...
void __thiscall AudioStreamPreview::AudioStreamPreview(AudioStreamPreview *this)
...
void __thiscall
AudioStreamPreviewGenerator::_notification(AudioStreamPreviewGenerator *this,int param_1)
...
void __thiscall
AudioStreamPreviewGenerator::AudioStreamPreviewGenerator(AudioStreamPreviewGenerator *this)
...

{
  ...
  local_58 = (char **)0x0;
  pMVar6 = create_method_bind<AudioStreamPreviewGenerator,Ref<AudioStreamPreview>,Ref<AudioStream>const&>
                     (generate_preview);
          ...
          if (1 < (ulong)puVar11[-2]) {
            ...
            if (puVar13 == (undefined8 *)0x0) {
              ...
              *puVar13 = 1;
              ...
              if (lVar15 != 0) {
                do {
                  *(undefined8 *)((long)puVar13 + lVar17 + 0x10) =
                       *(undefined8 *)((long)puVar11 + lVar17);
                  lVar17 = lVar17 + 8;
                } while (lVar17 != lVar12);
              }
              LOCK();
...
LAB_001016da:
              ...
              if (iVar18 < 0) {
                ...
                local_d8 = 0;
                if ((0.0 <= dVar27) && (local_d8 = 0xff, dVar27 <= _LC18)) {
...
LAB_00101a1d:
              _err_print_index_error
                        ("get","./core/templates/cowdata.h",0xdb,lVar12,lVar17,"p_index","size()",""
                         ,false,true);
              _err_flush_stdout();
                    /* WARNING: Does not return */
...

{
  ...
  *this;
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (*in_RDX == 0) {
    _err_print_error("generate_preview","editor/audio_stream_preview.cpp",0xac,
                     "Condition \"p_stream.is_null()\" is true. Returning: Ref<AudioStreamPreview>()"
                     ,0,0);
    *(undefined8 *)param_1 = 0;
    goto LAB_00101dc5;
  }
  pOVar1 = *(ObjectID **)(*in_RDX + 0x60);
  this = (HashMap<ObjectID,AudioStreamPreviewGenerator::Preview,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,AudioStreamPreviewGenerator::Preview>>>
          *)(in_RSI + 0x408);
  cVar6 = HashMap<ObjectID,AudioStreamPreviewGenerator::Preview,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,AudioStreamPreviewGenerator::Preview>>>
          ::_lookup_pos(this,pOVar1,(uint *)local_78);
  if (cVar6 != '\0') {
    local_78._0_8_ = pOVar1;
    plVar7 = (long *)HashMap<ObjectID,AudioStreamPreviewGenerator::Preview,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,AudioStreamPreviewGenerator::Preview>>>
                     ::operator[](this,(ObjectID *)local_78);
    *(undefined8 *)param_1 = 0;
    if (*plVar7 != 0) {
      *(long *)param_1 = *plVar7;
  ...
  if (pOVar13 != pOVar15) {
    *(Object **)(pSVar8 + 8) = pOVar13;
    if ((pOVar13 != (Object *)0x0) && (cVar6 = RefCounted::reference(), cVar6 == '\0')) {
...
uint __thiscall AudioStreamPreview::is_class_ptr(AudioStreamPreview *this,void *param_1)
...
uint __thiscall
AudioStreamPreviewGenerator::is_class_ptr(AudioStreamPreviewGenerator *this,void *param_1)

{
  return (uint)CONCAT71(0x107d,(undefined4 *)param_1 == &Node::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x107c,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x107d,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}
...
void __thiscall
CallableCustomMethodPointer<AudioStreamPreviewGenerator,void,ObjectID>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<AudioStreamPreviewGenerator,void,ObjectID> *this)
...
undefined8
MethodBindTR<Ref<AudioStreamPreview>,Ref<AudioStream>const&>::_gen_argument_type(int param_1)
...
undefined8
MethodBindTR<Ref<AudioStreamPreview>,Ref<AudioStream>const&>::get_argument_meta(int param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<AudioStreamPreviewGenerator,void,ObjectID>::get_argument_count
          (CallableCustomMethodPointer<AudioStreamPreviewGenerator,void,ObjectID> *this,
          bool *param_1)
...
void __thiscall
MethodBindTR<Ref<AudioStreamPreview>,Ref<AudioStream>const&>::~MethodBindTR
          (MethodBindTR<Ref<AudioStreamPreview>,Ref<AudioStream>const&> *this)
...
undefined8 __thiscall
CallableCustomMethodPointer<AudioStreamPreviewGenerator,void,ObjectID>::get_object
          (CallableCustomMethodPointer<AudioStreamPreviewGenerator,void,ObjectID> *this)
          ...
          if (*(int *)(*(long *)(this + 0x418) + lVar4) != 0) {
            ...
            *(int *)(*(long *)(this + 0x418) + lVar4) = 0;
            if (*(long *)((long)pvVar5 + 0x28) != 0) {
              ...
              if (cVar3 != '\0') {
                pOVar2 = *(Object **)((long)pvVar5 + 0x28);
...
void __thiscall
AudioStreamPreviewGenerator::_notificationv
          (AudioStreamPreviewGenerator *this,int param_1,bool param_2)
...
LAB_001031b3:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"AudioStreamPreviewGenerator"
                );
      goto LAB_0010321e;
    }
  }
...
LAB_001032a3:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      goto LAB_001032a3;
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"AudioStreamPreview");
      goto LAB_0010330e;
    }
  }
  StringName::assign_static_unique_class_name
...
void __thiscall AudioStreamPreviewGenerator::Preview::operator=(Preview *this,Preview *param_1)
...
void __thiscall AudioStreamPreviewGenerator::Preview::Preview(Preview *this,Preview *param_1)
...
Preview * __thiscall
HashMap<ObjectID,AudioStreamPreviewGenerator::Preview,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,AudioStreamPreviewGenerator::Preview>>>
::operator[](HashMap<ObjectID,AudioStreamPreviewGenerator::Preview,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,AudioStreamPreviewGenerator::Preview>>>
  ...
  if (cVar24 == '\0') {
    ...
    *puVar27 = local_88._0_8_;
    ...
    if (((local_60 != (Object *)0x0) && (cVar24 = RefCounted::unreference(), cVar24 != '\0')) &&
       (cVar24 = predelete_handler(local_60), cVar24 != '\0')) {
      (**(code **)(*(long *)local_60 + 0x140))(local_60);
      Memory::free_static(local_60,false);
    }
    if (((local_68 != (Object *)0x0) && (cVar24 = RefCounted::unreference(), cVar24 != '\0')) &&
       (cVar24 = predelete_handler(local_68), cVar24 != '\0')) {
      (**(code **)(*(long *)local_68 + 0x140))(local_68);
      Memory::free_static(local_68,false);
    }
    if (((local_70 != (Object *)0x0) && (cVar24 = RefCounted::unreference(), cVar24 != '\0')) &&
       (cVar24 = predelete_handler(local_70), cVar24 != '\0')) {
    ...
    *(int *)(this + 0x2c) = *(int *)(this + 0x2c) + 1;
    ...
    AudioStreamPreviewGenerator::Preview::operator=
              ((Preview *)(*(long *)(*(long *)(this + 8) + uVar25 * 8) + 0x18),(Preview *)local_b8);
    local_f8 = (Preview *)(*(long *)(*(long *)(this + 8) + uVar25 * 8) + 0x18);
  }
LAB_00103ddc:
  if (((local_a8 != (Object *)0x0) &&
      (cVar24 = RefCounted::unreference(), pOVar23 = local_a8, cVar24 != '\0')) &&
     (cVar24 = predelete_handler(local_a8), cVar24 != '\0')) {
    (**(code **)(*(long *)pOVar23 + 0x140))(pOVar23);
    Memory::free_static(pOVar23,false);
  }
  if ((local_b8._8_8_ != 0) && (cVar24 = RefCounted::unreference(), cVar24 != '\0')) {
  ...
  if ((local_b8._0_8_ != 0) && (cVar24 = RefCounted::unreference(), cVar24 != '\0')) {
...
/* AudioStreamPreviewGenerator::get_class() const */

void AudioStreamPreviewGenerator::get_class(void)
...
/* AudioStreamPreview::get_class() const */

void AudioStreamPreview::get_class(void)
...
void __thiscall
CallableCustomMethodPointer<AudioStreamPreviewGenerator,void,ObjectID>::call
          (CallableCustomMethodPointer<AudioStreamPreviewGenerator,void,ObjectID> *this,
...
/* AudioStreamPreviewGenerator::is_class(String const&) const */

undefined8 __thiscall
AudioStreamPreviewGenerator::is_class(AudioStreamPreviewGenerator *this,String *param_1)
...
/* AudioStreamPreview::_initialize_classv() */

void AudioStreamPreview::_initialize_classv(void)
...
/* AudioStreamPreview::is_class(String const&) const */

undefined8 __thiscall AudioStreamPreview::is_class(AudioStreamPreview *this,String *param_1)
...
void __thiscall
AudioStreamPreviewGenerator::_get_property_listv
          (AudioStreamPreviewGenerator *this,List *param_1,bool param_2)
...
/* AudioStreamPreview::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall
AudioStreamPreview::_get_property_listv(AudioStreamPreview *this,List *param_1,bool param_2)
...
/* MethodBind* create_method_bind<AudioStreamPreviewGenerator, Ref<AudioStreamPreview>,
   ...
   (AudioStreamPreviewGenerator::*)(Ref<AudioStream> const&)) */

MethodBind *
create_method_bind<AudioStreamPreviewGenerator,Ref<AudioStreamPreview>,Ref<AudioStream>const&>
          (_func_Ref_Ref_ptr *param_1)
...
/* AudioStreamPreviewGenerator::_bind_methods() [clone .cold] */
...
/* AudioStreamPreviewGenerator::_initialize_classv() */

void AudioStreamPreviewGenerator::_initialize_classv(void)
...
/* WARNING: Removing unreachable block (ram,0x00106268) */
...
void __thiscall
MethodBindTR<Ref<AudioStreamPreview>,Ref<AudioStream>const&>::ptrcall
          (MethodBindTR<Ref<AudioStreamPreview>,Ref<AudioStream>const&> *this,Object *param_1,
...
Object * MethodBindTR<Ref<AudioStreamPreview>,Ref<AudioStream>const&>::call
...
void __thiscall
MethodBindTR<Ref<AudioStreamPreview>,Ref<AudioStream>const&>::validated_call
          (MethodBindTR<Ref<AudioStreamPreview>,Ref<AudioStream>const&> *this,Object *param_1,
...
undefined4 *
MethodBindTR<Ref<AudioStreamPreview>,Ref<AudioStream>const&>::_gen_argument_type_info(int param_1)
...
void AudioStreamPreview::_GLOBAL__sub_I_get_length(void)

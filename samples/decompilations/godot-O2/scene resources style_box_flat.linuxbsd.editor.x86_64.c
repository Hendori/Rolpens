...
LAB_0010de83:
        _err_print_index_error
                  ("set","./core/templates/cowdata.h",0xcf,lVar18,lVar16,"p_index","size()","",false
                   ,false);
      }
      else {
...
LAB_0010decb:
  ...
  fVar27 = (float)((ulong)*(undefined8 *)(param_4 + 8) >> 0x20) * _LC135._4_4_ +
...
LAB_0010dc15:
    ...
    if (lVar17 <= lVar16) {
      lVar25 = uVar10 + 1;
LAB_0010e09c:
      if ((lVar25 == lVar18) || (iVar19 = CowData<Color>::_realloc(this,lVar18), iVar19 == 0)) {
        if (*(long *)(param_3 + 8) == 0) {
          _DAT_00000000 = 0;
                    /* WARNING: Does not return */
          pcVar3 = (code *)invalidInstructionException();
...
LAB_0010dd74:
    do {
      sincosf((float)(((double)iVar19 / (double)local_118 + (double)(int)lVar25) * __LC128 + __LC129
                     ),local_ac,&local_b0);
      if (lVar17 == 0) {
LAB_0010dff0:
        lVar23 = 0;
LAB_0010dff6:
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,lVar25,lVar23,"p_index","size()","",false
                   ,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar3 = (code *)invalidInstructionException();
      ...
      *(ulong *)(lVar16 + (long)(local_d8 + iVar24) * 8) =
           CONCAT44(fVar28 - (float)((ulong)*(undefined8 *)param_11 >> 0x20) * (fVar29 - fVar26),
                    fVar29 - (float)*(undefined8 *)param_11 * (fVar28 - fVar27));
      ...
      *puVar14 = uVar4;
      ...
      if (bVar7) {
        ...
        *(ulong *)(lVar16 + 8 + (long)(local_d8 + iVar24) * 8) =
             CONCAT44(fVar29 - (float)((ulong)*(undefined8 *)param_11 >> 0x20) * (fVar28 - fVar26),
                      fVar28 - (float)*(undefined8 *)param_11 * (fVar29 - fVar27));
...
/* WARNING: Removing unreachable block (ram,0x0010e80d) */
/* WARNING: Removing unreachable block (ram,0x0010e819) */

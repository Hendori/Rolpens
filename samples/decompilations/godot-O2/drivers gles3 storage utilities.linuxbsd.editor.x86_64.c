...
/* GLES3::Utilities::get_captured_timestamps_count() const */

undefined4 __thiscall GLES3::Utilities::get_captured_timestamps_count(Utilities *this)
...
/* GLES3::Utilities::get_captured_timestamps_frame() const */

undefined8 __thiscall GLES3::Utilities::get_captured_timestamps_frame(Utilities *this)
...
/* GLES3::Utilities::set_debug_generate_wireframes(bool) */

void __thiscall GLES3::Utilities::set_debug_generate_wireframes(Utilities *this,bool param_1)
...
/* GLES3::Utilities::update_memory_info() */

void GLES3::Utilities::update_memory_info(void)
...
/* GLES3::Utilities::get_video_adapter_type() const */

undefined8 GLES3::Utilities::get_video_adapter_type(void)
...
/* GLES3::Utilities::visibility_notifier_get_aabb(RID) const */

undefined8 *
GLES3::Utilities::visibility_notifier_get_aabb(undefined8 *param_1,long param_2,ulong param_3)

{
  ...
  _err_print_error("visibility_notifier_get_aabb","drivers/gles3/storage/utilities.cpp",0x123,
...
/* GLES3::Utilities::visibility_notifier_free(RID) */

long __thiscall GLES3::Utilities::visibility_notifier_free(Utilities *this,ulong param_2)
...
/* GLES3::Utilities::visibility_notifier_set_aabb(RID, AABB const&) */

void __thiscall
GLES3::Utilities::visibility_notifier_set_aabb(Utilities *this,ulong param_2,undefined8 *param_3)

{
  ...
  _err_print_error("visibility_notifier_set_aabb","drivers/gles3/storage/utilities.cpp",0x115,
                   "Parameter \"vn\" is null.",0,0);
  return;
}
...
/* GLES3::Utilities::visibility_notifier_set_callbacks(RID, Callable const&, Callable const&) */

void __thiscall
GLES3::Utilities::visibility_notifier_set_callbacks
...

{
  ...
  _err_print_error("visibility_notifier_set_callbacks","drivers/gles3/storage/utilities.cpp",0x11c,
                   "Parameter \"vn\" is null.",0,0);
  return;
}
...
/* GLES3::Utilities::get_captured_timestamp_gpu_time(unsigned int) const */

undefined8 __thiscall
GLES3::Utilities::get_captured_timestamp_gpu_time(Utilities *this,uint param_1)

{
  ...
  if (*(uint *)(this + (ulong)uVar1 * 0x468 + 0x570) <= param_1) {
    _err_print_index_error
              ("get_captured_timestamp_gpu_time","drivers/gles3/storage/utilities.cpp",0x176,
               (ulong)param_1,(ulong)*(uint *)(this + (ulong)uVar1 * 0x468 + 0x570),"p_index",
               "frames[frame].timestamp_result_count","",false,false);
    return 0;
  }
  ...
  _err_print_index_error
            ("operator[]","./core/templates/local_vector.h",0xae,(ulong)param_1,
             (ulong)*(uint *)(this + (ulong)uVar1 * 0x468 + 0x560),"p_index","count","",false,true);
  _err_flush_stdout();
...
/* GLES3::Utilities::get_captured_timestamp_cpu_time(unsigned int) const */

undefined8 __thiscall
GLES3::Utilities::get_captured_timestamp_cpu_time(Utilities *this,uint param_1)

{
  ...
  if (*(uint *)(this + (ulong)uVar1 * 0x468 + 0x570) <= param_1) {
    _err_print_index_error
              ("get_captured_timestamp_cpu_time","drivers/gles3/storage/utilities.cpp",0x17b,
               (ulong)param_1,(ulong)*(uint *)(this + (ulong)uVar1 * 0x468 + 0x570),"p_index",
               "frames[frame].timestamp_result_count","",false,false);
    return 0;
  }
  ...
  _err_print_index_error
            ("operator[]","./core/templates/local_vector.h",0xae,(ulong)param_1,
             (ulong)*(uint *)(this + (ulong)uVar1 * 0x468 + 0x550),"p_index","count","",false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar2 = (code *)invalidInstructionException();
  (*pcVar2)();
...
/* GLES3::Utilities::update_dirty_resources() */

void GLES3::Utilities::update_dirty_resources(void)
...
/* GLES3::Utilities::has_os_feature(String const&) const */

undefined1 __thiscall GLES3::Utilities::has_os_feature(Utilities *this,String *param_1)
...
/* GLES3::Utilities::get_video_adapter_api_version() const */

Utilities * __thiscall GLES3::Utilities::get_video_adapter_api_version(Utilities *this)
...
/* GLES3::Utilities::get_rendering_info(RenderingServer::RenderingInfo) */

long __thiscall GLES3::Utilities::get_rendering_info(Utilities *this,int param_2)
...
/* GLES3::Utilities::get_maximum_viewport_size() const */

undefined8 GLES3::Utilities::get_maximum_viewport_size(void)

{
  if (Config::singleton != 0) {
    return *(undefined8 *)(Config::singleton + 0x10);
  }
  _err_print_error("get_maximum_viewport_size","drivers/gles3/storage/utilities.cpp",0x1d3,
...
/* GLES3::Utilities::get_maximum_shader_varyings() const */

undefined4 GLES3::Utilities::get_maximum_shader_varyings(void)

{
  if (Config::singleton != 0) {
    return *(undefined4 *)(Config::singleton + 0x20);
  }
  _err_print_error("get_maximum_shader_varyings","drivers/gles3/storage/utilities.cpp",0x1d9,
                   "Parameter \"config\" is null.",0,0);
  return 0x1f;
}
...
/* GLES3::Utilities::get_maximum_uniform_buffer_size() const */

undefined8 GLES3::Utilities::get_maximum_uniform_buffer_size(void)

{
  if (Config::singleton != 0) {
    return *(undefined8 *)(Config::singleton + 0x18);
  }
  _err_print_error("get_maximum_uniform_buffer_size","drivers/gles3/storage/utilities.cpp",0x1df,
                   "Parameter \"config\" is null.",0,0);
  return 0x10000;
}
...
/* GLES3::Utilities::free(RID) */

undefined8 __thiscall GLES3::Utilities::free(Utilities *this,ulong param_2)

{
  ...
  if (((uVar5 < *(uint *)(lVar3 + 0x194)) && (param_2 >> 0x20 != 0x7fffffff)) &&
     ((*(uint *)(((param_2 & 0xffffffff) % (ulong)*(uint *)(lVar3 + 400)) * 0xf0 +
                 *(long *)(*(long *)(lVar3 + 0x180) +
                          ((param_2 & 0xffffffff) / (ulong)*(uint *)(lVar3 + 400)) * 8) + 0xe8) &
      0x7fffffff) == uVar6)) {
  ...
  if (iVar2 == 0) {
    if (((uVar5 < *(uint *)(lVar3 + 0xf4)) && (param_2 >> 0x20 != 0x7fffffff)) &&
       ((*(uint *)((uVar7 % (ulong)*(uint *)(lVar3 + 0xf0)) * 0xf0 +
                   *(long *)(*(long *)(lVar3 + 0xe0) + (uVar7 / *(uint *)(lVar3 + 0xf0)) * 8) + 0xe8
                  ) & 0x7fffffff) == uVar6)) {
    ...
    iVar2 = pthread_mutex_lock(ppVar1);
    if (iVar2 == 0) {
      if (((uVar5 < *(uint *)(lVar3 + 0x9c)) && (param_2 >> 0x20 != 0x7fffffff)) &&
         ((*(uint *)((uVar7 % (ulong)*(uint *)(lVar3 + 0x98)) * 0x40 +
                     *(long *)(*(long *)(lVar3 + 0x88) + (uVar7 / *(uint *)(lVar3 + 0x98)) * 8) +
                    0x38) & 0x7fffffff) == uVar6)) {
        pthread_mutex_unlock(ppVar1);
        plVar4 = (long *)GLES3::TextureStorage::get_singleton();
      ...
      iVar2 = pthread_mutex_lock(ppVar1);
      if (iVar2 == 0) {
        if (((uVar5 < *(uint *)(lVar3 + 0xec)) && (param_2 >> 0x20 != 0x7fffffff)) &&
           ((*(uint *)((uVar7 % (ulong)*(uint *)(lVar3 + 0xe8)) * 0x80 +
                       *(long *)(*(long *)(lVar3 + 0xd8) + (uVar7 / *(uint *)(lVar3 + 0xe8)) * 8) +
                      0x78) & 0x7fffffff) == uVar6)) {
          pthread_mutex_unlock(ppVar1);
        ...
        iVar2 = pthread_mutex_lock(ppVar1);
        if (iVar2 == 0) {
          if (((uVar5 < *(uint *)(lVar3 + 0x16c)) && (param_2 >> 0x20 != 0x7fffffff)) &&
             ((*(uint *)((uVar7 % (ulong)*(uint *)(lVar3 + 0x168)) * 0xc0 +
                         *(long *)(*(long *)(lVar3 + 0x158) + (uVar7 / *(uint *)(lVar3 + 0x168)) * 8
                                  ) + 0xb8) & 0x7fffffff) == uVar6)) {
            pthread_mutex_unlock(ppVar1);
            plVar4 = (long *)GLES3::MaterialStorage::get_singleton();
          ...
          iVar2 = pthread_mutex_lock(ppVar1);
          if (iVar2 == 0) {
            if (((uVar5 < *(uint *)(lVar3 + 0x19c)) && (param_2 >> 0x20 != 0x7fffffff)) &&
               ((*(uint *)(*(long *)(*(long *)(lVar3 + 0x188) +
                                    (uVar7 / *(uint *)(lVar3 + 0x198)) * 8) +
                           (uVar7 % (ulong)*(uint *)(lVar3 + 0x198)) * 0xd8 + 0xd0) & 0x7fffffff) ==
                uVar6)) {
              pthread_mutex_unlock(ppVar1);
            ...
            iVar2 = pthread_mutex_lock(ppVar1);
            if (iVar2 == 0) {
              if (((uVar5 < *(uint *)(lVar3 + 0x26c)) && (param_2 >> 0x20 != 0x7fffffff)) &&
                 ((*(uint *)((uVar7 % (ulong)*(uint *)(lVar3 + 0x268)) * 0x118 +
                             *(long *)(*(long *)(lVar3 + 600) +
                                      (uVar7 / *(uint *)(lVar3 + 0x268)) * 8) + 0x110) & 0x7fffffff)
                  == uVar6)) {
                pthread_mutex_unlock(ppVar1);
                plVar4 = (long *)GLES3::MeshStorage::get_singleton();
              ...
              pthread_mutex_unlock(ppVar1);
              lVar3 = GLES3::MeshStorage::get_singleton();
              if (((uVar5 < *(uint *)(lVar3 + 500)) && (param_2 >> 0x20 != 0x7fffffff)) &&
                 ((*(uint *)(*(long *)(*(long *)(lVar3 + 0x1e0) +
                                      (uVar7 / *(uint *)(lVar3 + 0x1f0)) * 8) +
                             (uVar7 % (ulong)*(uint *)(lVar3 + 0x1f0)) * 0xa8 + 0xa0) & 0x7fffffff)
                  == uVar6)) {
                plVar4 = (long *)GLES3::MeshStorage::get_singleton();
                (**(code **)(*plVar4 + 0xd8))(plVar4,param_2);
                return 1;
              ...
              iVar2 = pthread_mutex_lock(ppVar1);
              if (iVar2 == 0) {
                if (((uVar5 < *(uint *)(lVar3 + 0x24)) && (param_2 >> 0x20 != 0x7fffffff)) &&
                   ((*(uint *)((uVar7 % (ulong)*(uint *)(lVar3 + 0x20)) * 0xe8 +
                               *(long *)(*(long *)(lVar3 + 0x10) +
                                        (uVar7 / *(uint *)(lVar3 + 0x20)) * 8) + 0xe0) & 0x7fffffff)
                    == uVar6)) {
                  pthread_mutex_unlock(ppVar1);
                ...
                iVar2 = pthread_mutex_lock(ppVar1);
                if (iVar2 == 0) {
                  if (((uVar5 < *(uint *)(lVar3 + 0x1e4)) && (param_2 >> 0x20 != 0x7fffffff)) &&
                     ((*(uint *)((uVar7 % (ulong)*(uint *)(lVar3 + 0x1e0)) * 0xb8 +
                                 *(long *)(*(long *)(lVar3 + 0x1d0) +
                                          (uVar7 / *(uint *)(lVar3 + 0x1e0)) * 8) + 0xb0) &
                      0x7fffffff) == uVar6)) {
                    pthread_mutex_unlock(ppVar1);
                    plVar4 = (long *)GLES3::LightStorage::get_singleton();
                  ...
                  iVar2 = pthread_mutex_lock(ppVar1);
                  if (iVar2 == 0) {
                    if (((uVar5 < *(uint *)(lVar3 + 0xd4)) && (param_2 >> 0x20 != 0x7fffffff)) &&
                       ((*(uint *)((uVar7 % (ulong)*(uint *)(lVar3 + 0xd0)) * 0x90 +
                                   *(long *)(*(long *)(lVar3 + 0xc0) +
                                            (uVar7 / *(uint *)(lVar3 + 0xd0)) * 8) + 0x88) &
                        0x7fffffff) == uVar6)) {
                      pthread_mutex_unlock(ppVar1);
                      plVar4 = (long *)GLES3::LightStorage::get_singleton();
                    ...
                    if (uVar5 < *(uint *)(lVar3 + 300)) {
                      if (param_2 >> 0x20 == 0x7fffffff) {
                        ...
                        if ((*(uint *)((uVar7 % (ulong)*(uint *)(lVar3 + 0x128)) * 0x50 +
                                       *(long *)(*(long *)(lVar3 + 0x118) +
                                                (uVar7 / *(uint *)(lVar3 + 0x128)) * 8) + 0x48) &
                            0x7fffffff) == uVar6) {
                          plVar4 = (long *)GLES3::LightStorage::get_singleton();
...
LAB_00100fa5:
                        if ((*(uint *)(*(long *)(*(long *)(lVar3 + 0x170) +
                                                (uVar7 / *(uint *)(lVar3 + 0x180)) * 8) +
                                       (uVar7 % (ulong)*(uint *)(lVar3 + 0x180)) * 0x68 + 0x60) &
                            0x7fffffff) == uVar6) {
                          plVar4 = (long *)GLES3::LightStorage::get_singleton();
                    ...
                    if (iVar2 == 0) {
                      if (((uVar5 < *(uint *)(lVar3 + 0x184)) && (param_2 >> 0x20 != 0x7fffffff)) &&
                         ((*(uint *)((uVar7 % (ulong)*(uint *)(lVar3 + 0x180)) * 0x210 +
                                     *(long *)(*(long *)(lVar3 + 0x170) +
                                              (uVar7 / *(uint *)(lVar3 + 0x180)) * 8) + 0x208) &
                          0x7fffffff) == uVar6)) {
                        pthread_mutex_unlock(ppVar1);
                      ...
                      iVar2 = pthread_mutex_lock(ppVar1);
                      if (iVar2 == 0) {
                        if (((uVar5 < *(uint *)(lVar3 + 0x1dc)) && (param_2 >> 0x20 != 0x7fffffff))
                           && ((*(uint *)(*(long *)(*(long *)(lVar3 + 0x1c8) +
                                                   (uVar7 / *(uint *)(lVar3 + 0x1d8)) * 8) +
                                          (uVar7 % (ulong)*(uint *)(lVar3 + 0x1d8)) * 0x78 + 0x70) &
                               0x7fffffff) == uVar6)) {
                          pthread_mutex_unlock(ppVar1);
                          plVar4 = (long *)GLES3::ParticlesStorage::get_singleton();
                          (**(code **)(*plVar4 + 400))(plVar4,param_2);
                        ...
                        pthread_mutex_unlock(ppVar1);
                        lVar3 = GLES3::ParticlesStorage::get_singleton();
                        if (((uVar5 < *(uint *)(lVar3 + 0x234)) && (param_2 >> 0x20 != 0x7fffffff))
                           && ((*(uint *)(*(long *)(*(long *)(lVar3 + 0x220) +
                                                   (uVar7 / *(uint *)(lVar3 + 0x230)) * 8) +
                                          (uVar7 % (ulong)*(uint *)(lVar3 + 0x230)) * 0x48 + 0x40) &
                               0x7fffffff) == uVar6)) goto LAB_00101358;
                        lVar3 = GLES3::MeshStorage::get_singleton();
                        ...
                        if (iVar2 == 0) {
                          if (uVar5 < *(uint *)(lVar3 + 0x2cc)) {
                            ...
                            if ((*(uint *)((uVar7 % (ulong)*(uint *)(lVar3 + 0x2c8)) * 0x90 +
                                           *(long *)(*(long *)(lVar3 + 0x2b8) +
                                                    (uVar7 / *(uint *)(lVar3 + 0x2c8)) * 8) + 0x88)
                                & 0x7fffffff) == uVar6) {
                              pthread_mutex_unlock(ppVar1);
                              plVar4 = (long *)GLES3::MeshStorage::get_singleton();
                          ...
                          if ((*(uint *)((uVar7 % (ulong)*(uint *)(this + 0x28)) * 0x70 +
                                         *(long *)(*(long *)(this + 0x18) +
                                                  (uVar7 / *(uint *)(this + 0x28)) * 8) + 0x68) &
                              0x7fffffff) == uVar6) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::Utilities::get_base_type(RID) const */

char * __thiscall GLES3::Utilities::get_base_type(Utilities *this,ulong param_2)

{
  ...
  if (uVar3 == 0) {
    ...
    uVar6 = (uint)(param_2 >> 0x20);
    if (((uVar7 < *(uint *)(lVar5 + 0x19c)) && (param_2 >> 0x20 != 0x7fffffff)) &&
       ((*(uint *)(*(long *)(*(long *)(lVar5 + 0x188) +
                            ((param_2 & 0xffffffff) / (ulong)*(uint *)(lVar5 + 0x198)) * 8) +
                   ((param_2 & 0xffffffff) % (ulong)*(uint *)(lVar5 + 0x198)) * 0xd8 + 0xd0) &
        0x7fffffff) == uVar6)) {
      lStack_40 = 0x101548;
    ...
    uVar3 = pthread_mutex_lock(ppVar2);
    if (uVar3 == 0) {
      if (((uVar7 < *(uint *)(lVar5 + 0x26c)) && (param_2 >> 0x20 != 0x7fffffff)) &&
         ((*(uint *)((uVar9 % (ulong)*(uint *)(lVar5 + 0x268)) * 0x118 +
                     *(long *)(*(long *)(lVar5 + 600) + (uVar9 / *(uint *)(lVar5 + 0x268)) * 8) +
                    0x110) & 0x7fffffff) == uVar6)) {
        lStack_40 = 0x1016d8;
        pthread_mutex_unlock(ppVar2);
        return (char *)0x2;
      }
      ...
      if (uVar3 == 0) {
        ...
        uVar3 = pthread_mutex_lock(ppVar2);
        if (uVar3 == 0) {
          if (((uVar7 < *(uint *)(lVar5 + 0x1e4)) && (param_2 >> 0x20 != 0x7fffffff)) &&
             ((*(uint *)((uVar9 % (ulong)*(uint *)(lVar5 + 0x1e0)) * 0xb8 +
                         *(long *)(*(long *)(lVar5 + 0x1d0) + (uVar9 / *(uint *)(lVar5 + 0x1e0)) * 8
                                  ) + 0xb0) & 0x7fffffff) == uVar6)) {
            lStack_40 = 0x1017e8;
            pthread_mutex_unlock(ppVar2);
            return (char *)0x9;
          }
          ...
          uVar3 = pthread_mutex_lock(ppVar2);
          if (uVar3 == 0) {
            if (((uVar7 < *(uint *)(lVar5 + 0x184)) && (param_2 >> 0x20 != 0x7fffffff)) &&
               ((*(uint *)((uVar9 % (ulong)*(uint *)(lVar5 + 0x180)) * 0x210 +
                           *(long *)(*(long *)(lVar5 + 0x170) +
                                    (uVar9 / *(uint *)(lVar5 + 0x180)) * 8) + 0x208) & 0x7fffffff)
                == uVar6)) {
              lStack_40 = 0x101800;
              pthread_mutex_unlock(ppVar2);
              return (char *)0x3;
            ...
            uVar3 = pthread_mutex_lock(ppVar2);
            if (uVar3 == 0) {
              if (((uVar7 < *(uint *)(lVar5 + 0xd4)) && (param_2 >> 0x20 != 0x7fffffff)) &&
                 ((*(uint *)((uVar9 % (ulong)*(uint *)(lVar5 + 0xd0)) * 0x90 +
                             *(long *)(*(long *)(lVar5 + 0xc0) +
                                      (uVar9 / *(uint *)(lVar5 + 0xd0)) * 8) + 0x88) & 0x7fffffff)
                  == uVar6)) {
                lStack_40 = 0x1016c5;
                pthread_mutex_unlock(ppVar2);
                return (char *)0x6;
              ...
              if (uVar3 == 0) {
                if (uVar7 < *(uint *)(lVar5 + 0x1dc)) {
                  ...
                  if ((*(uint *)(*(long *)(*(long *)(lVar5 + 0x1c8) +
                                          (uVar9 / *(uint *)(lVar5 + 0x1d8)) * 8) +
                                 (uVar9 % (ulong)*(uint *)(lVar5 + 0x1d8)) * 0x78 + 0x70) &
                      0x7fffffff) == uVar6) {
                    lStack_40 = 0x101825;
                    pthread_mutex_unlock(ppVar2);
                    return (char *)0x4;
                ...
                if ((*(uint *)((uVar9 % (ulong)*(uint *)(this + 0x28)) * 0x70 +
                               *(long *)(*(long *)(this + 0x18) +
                                        (uVar9 / *(uint *)(this + 0x28)) * 8) + 0x68) & 0x7fffffff)
                    != uVar6) {
                  return (char *)0x0;
                }
                return (char *)0xb;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::Utilities::get_video_adapter_vendor() const */

Utilities * __thiscall GLES3::Utilities::get_video_adapter_vendor(Utilities *this)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::Utilities::get_video_adapter_name() const */

Utilities * __thiscall GLES3::Utilities::get_video_adapter_name(Utilities *this)
...
/* GLES3::Utilities::capture_timestamps_begin() */

void __thiscall GLES3::Utilities::capture_timestamps_begin(Utilities *this)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::Utilities::capture_timestamp(String const&) */

void __thiscall GLES3::Utilities::capture_timestamp(Utilities *this,String *param_1)

{
  ...
  if (*(uint *)(this + 0x110) <= *(uint *)(this + uVar4 * 0x468 + 0x538)) {
    _err_print_error("capture_timestamp","drivers/gles3/storage/utilities.cpp",0x145,
                     "Condition \"frames[frame].timestamp_count >= max_timestamp_query_elements\" is true."
                     ,0,0);
    return;
  }
  ...
  if ((uint)uVar7 < *(uint *)(this + uVar4 * 0x468 + 0x518)) {
    ...
    _err_print_index_error
              ("operator[]","./core/templates/local_vector.h",0xb2,(ulong)uVar2,
               (ulong)*(uint *)(this + (ulong)uVar1 * 0x468 + 0x528),"p_index","count","",false,true
              );
    _err_flush_stdout();
                    /* WARNING: Does not return */
  ...
  _err_print_index_error
            ("operator[]","./core/templates/local_vector.h",0xb2,uVar7,
             (ulong)*(uint *)(this + uVar4 * 0x468 + 0x518),"p_index","count","",false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar3 = (code *)invalidInstructionException();
  (*pcVar3)();
...
/* GLES3::Utilities::get_captured_timestamp_name(unsigned int) const */

CowData<char32_t> * GLES3::Utilities::get_captured_timestamp_name(uint param_1)

{
  ...
  if (*(uint *)(lVar3 + 0x570) <= in_EDX) {
    _err_print_index_error
              ("get_captured_timestamp_name","drivers/gles3/storage/utilities.cpp",0x180,
               (ulong)in_EDX,(ulong)*(uint *)(lVar3 + 0x570),"p_index",
               "frames[frame].timestamp_result_count","",false,false);
    *(undefined8 *)this = 0;
    return this;
  }
  ...
  _err_print_index_error
            ("operator[]","./core/templates/local_vector.h",0xae,(ulong)in_EDX,
             (ulong)*(uint *)(lVar3 + 0x540),"p_index","count","",false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar2 = (code *)invalidInstructionException();
  (*pcVar2)();
...
void __thiscall GLES3::Utilities::Utilities(Utilities *this)
...
LAB_00102037:
        memset((void *)(*(long *)(pUVar10 + 0x408) + (ulong)uVar14 * 8),0,
               (ulong)((uVar11 - 1) - uVar14) * 8 + 8);
      }
      uVar14 = *(uint *)(pUVar10 + 0x410);
      *(uint *)(pUVar10 + 0x400) = uVar11;
...
LAB_001020a7:
        memset((void *)(*(long *)(pUVar10 + 0x430) + (ulong)uVar14 * 8),0,
               (ulong)((uVar11 - 1) - uVar14) * 8 + 8);
      }
      uVar14 = *(uint *)(pUVar10 + 0x438);
      *(uint *)(pUVar10 + 0x428) = uVar11;
...
void __thiscall GLES3::Utilities::_capture_timestamps_begin(Utilities *this)

{
  ...
  if (iVar5 != 0) {
    if ((char)RasterizerGLES3::gles_over_gl != '\0') {
      ...
      do {
        local_58 = (char *)0x0;
        (*_glad_glGetQueryObjectui64v)
                  (*(undefined4 *)(this + ((uVar9 & 0xffffffff) + 0x44 + uVar8 * 0x11a) * 4 + 8),
                   0x8866,&local_58);
        uVar8 = (ulong)*(uint *)(this + 0xe50);
        if (*(uint *)(this + uVar8 * 0x468 + 0x560) <= (uint)uVar9) {
          _err_print_index_error
                    ("operator[]","./core/templates/local_vector.h",0xb2,uVar9,
                     (ulong)*(uint *)(this + uVar8 * 0x468 + 0x560),"p_index","count","",false,true)
          ;
          _err_flush_stdout();
                    /* WARNING: Does not return */
...
void __thiscall GLES3::Utilities::capture_timestamps_end(Utilities *this)
...
/* GLES3::Utilities::visibility_notifier_call(RID, bool, bool) */

void __thiscall
GLES3::Utilities::visibility_notifier_call(Utilities *this,ulong param_2,char param_3,char param_4)
...
LAB_00102710:
  ...
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
    _err_print_error("visibility_notifier_call","drivers/gles3/storage/utilities.cpp",0x129,
                     "Parameter \"vn\" is null.",0,0);
    return;
  }
LAB_001027c3:
  ...
  if (*(long *)(this + 0x108) != 0) {
    ...
    if (plVar10 != (long *)0x0) {
      ...
      do {
        ...
        itos((long)&local_58);
        operator+((char *)&local_78,(String *)"Texture with GL ID of ");
        ...
        _err_print_error("~Utilities","drivers/gles3/storage/utilities.cpp",0x4d,(String *)&local_90
                         ,0,0);
        lVar7 = local_90;
        if (local_90 != 0) {
          LOCK();
    ...
    operator+((char *)&local_68,
              (String *)"Texture cache is not empty. There may be an additional texture leak of ");
  ...
  if (*(long *)(this + 0x100) != 0) {
    ...
    if (plVar10 != (long *)0x0) {
      ...
      do {
        ...
        String::parse_latin1((StrRange *)&local_70);
        itos((long)&local_58);
        operator+((char *)&local_78,(String *)"Render buffer with GL ID of ");
        String::operator+((String *)&local_80,(String *)&local_78);
        String::operator+((String *)&local_88,(String *)&local_80);
        String::operator+((String *)&local_90,(String *)&local_88);
        _err_print_error("~Utilities","drivers/gles3/storage/utilities.cpp",0x5c,(String *)&local_90
                         ,0,0);
        lVar7 = local_90;
        if (local_90 != 0) {
          LOCK();
    ...
    operator+((char *)&local_68,
              (String *)
              "Render buffer cache is not empty. There may be an additional render buffer leak of ")
    ;
    String::operator+((String *)&local_70,(String *)&local_68);
  ...
  if (*(long *)(this + 0xf8) != 0) {
    ...
    if (plVar10 != (long *)0x0) {
      ...
      do {
        ...
        String::parse_latin1((StrRange *)&local_70);
        itos((long)&local_58);
        operator+((char *)&local_78,(String *)"Buffer with GL ID of ");
        String::operator+((String *)&local_80,(String *)&local_78);
        String::operator+((String *)&local_88,(String *)&local_80);
        String::operator+((String *)&local_90,(String *)&local_88);
        _err_print_error("~Utilities","drivers/gles3/storage/utilities.cpp",0x6c,(String *)&local_90
                         ,0,0);
        lVar7 = local_90;
        if (local_90 != 0) {
          LOCK();
    ...
    itos((long)&local_58);
    operator+((char *)&local_68,
              (String *)"Buffer cache is not empty. There may be an additional buffer leak of ");
    String::operator+((String *)&local_70,(String *)&local_68);
...
LAB_001034bf:
  ...
  RID_Alloc<GLES3::VisibilityNotifier,false>::~RID_Alloc
            ((RID_Alloc<GLES3::VisibilityNotifier,false> *)(this + 0x10));
  return;
}
...
/* GLES3::Utilities::visibility_notifier_allocate() */

void __thiscall GLES3::Utilities::visibility_notifier_allocate(Utilities *this)

{
  RID_Alloc<GLES3::VisibilityNotifier,false>::allocate_rid
            ((RID_Alloc<GLES3::VisibilityNotifier,false> *)(this + 0x10));
  return;
}
...
/* GLES3::Utilities::base_update_dependency(RID, DependencyTracker*) */

void __thiscall
GLES3::Utilities::base_update_dependency(Utilities *this,ulong param_2,Dependency *param_3)

{
  ...
  *this_00;
  ...
  if (iVar4 == 0) {
    ...
    if (((uVar9 < *(uint *)(lVar5 + 0x19c)) && (param_2 >> 0x20 != 0x7fffffff)) &&
       (uVar11 = *(uint *)(*(long *)(*(long *)(lVar5 + 0x188) +
                                    ((param_2 & 0xffffffff) / (ulong)*(uint *)(lVar5 + 0x198)) * 8)
                           + ((param_2 & 0xffffffff) % (ulong)*(uint *)(lVar5 + 0x198)) * 0xd8 +
                          0xd0) & 0x7fffffff, uVar11 == uVar8)) {
      pthread_mutex_unlock(ppVar1);
      lVar5 = GLES3::MeshStorage::get_singleton();
...
LAB_00104064:
      ...
      this_00 = (HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>
                 *)(lVar5 + 0xa0);
      goto LAB_00103e5f;
    }
    pthread_mutex_unlock(ppVar1);
    ...
    if (((uVar9 < *(uint *)(lVar5 + 0x26c)) && (param_2 >> 0x20 != 0x7fffffff)) &&
       (uVar11 = *(uint *)(((param_2 & 0xffffffff) % (ulong)*(uint *)(lVar5 + 0x268)) * 0x118 +
                           *(long *)(*(long *)(lVar5 + 600) +
                                    ((param_2 & 0xffffffff) / (ulong)*(uint *)(lVar5 + 0x268)) * 8)
                          + 0x110) & 0x7fffffff, uVar11 == uVar8)) {
      pthread_mutex_unlock(ppVar1);
      lVar5 = GLES3::MeshStorage::get_singleton();
...
LAB_001040e0:
        ...
        puVar6 = (undefined4 *)
                 ...
                 ::operator[]((HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>
                               *)0xe0,(DependencyTracker **)local_58);
        *puVar6 = uVar2;
                    /* WARNING: Does not return */
        pcVar3 = (code *)invalidInstructionException();
        (*pcVar3)();
      }
      plVar10 = (long *)(((param_2 & 0xffffffff) % (ulong)*(uint *)(lVar5 + 0x268)) * 0x118 +
                        *(long *)(*(long *)(lVar5 + 600) +
                                 ((param_2 & 0xffffffff) / (ulong)*(uint *)(lVar5 + 0x268)) * 8));
    ...
    iVar4 = pthread_mutex_lock(ppVar1);
    if (iVar4 != 0) goto LAB_00104194;
    if (((uVar9 < *(uint *)(lVar5 + 0xd4)) && (param_2 >> 0x20 != 0x7fffffff)) &&
       ((*(uint *)(((param_2 & 0xffffffff) % (ulong)*(uint *)(lVar5 + 0xd0)) * 0x90 +
                   *(long *)(*(long *)(lVar5 + 0xc0) +
                            ((param_2 & 0xffffffff) / (ulong)*(uint *)(lVar5 + 0xd0)) * 8) + 0x88) &
        0x7fffffff) == uVar8)) {
      pthread_mutex_unlock(ppVar1);
      uVar7 = GLES3::LightStorage::get_singleton();
      this_00 = (HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>
                 *)GLES3::LightStorage::reflection_probe_get_dependency(uVar7,param_2);
      goto LAB_00103e5f;
    }
    pthread_mutex_unlock(ppVar1);
    lVar5 = GLES3::LightStorage::get_singleton();
    ...
    iVar4 = pthread_mutex_lock(ppVar1);
    if (iVar4 != 0) goto LAB_00104194;
    if (((uVar9 < *(uint *)(lVar5 + 0x24)) && (param_2 >> 0x20 != 0x7fffffff)) &&
       (uVar11 = *(uint *)(((param_2 & 0xffffffff) % (ulong)*(uint *)(lVar5 + 0x20)) * 0xe8 +
                           *(long *)(*(long *)(lVar5 + 0x10) +
                                    ((param_2 & 0xffffffff) / (ulong)*(uint *)(lVar5 + 0x20)) * 8) +
                          0xe0) & 0x7fffffff, uVar11 == uVar8)) {
      pthread_mutex_unlock(ppVar1);
      lVar5 = GLES3::LightStorage::get_singleton();
...
LAB_00104050:
        ...
        lVar5 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(lVar5 + 0x20)) * 0xe8 +
                *(long *)(*(long *)(lVar5 + 0x10) +
                         ((param_2 & 0xffffffff) / (ulong)*(uint *)(lVar5 + 0x20)) * 8);
    ...
    iVar4 = pthread_mutex_lock(ppVar1);
    if (iVar4 != 0) goto LAB_00104194;
    if (((uVar9 < *(uint *)(lVar5 + 0x184)) && (param_2 >> 0x20 != 0x7fffffff)) &&
       ((*(uint *)(((param_2 & 0xffffffff) % (ulong)*(uint *)(lVar5 + 0x180)) * 0x210 +
                   *(long *)(*(long *)(lVar5 + 0x170) +
                            ((param_2 & 0xffffffff) / (ulong)*(uint *)(lVar5 + 0x180)) * 8) + 0x208)
        & 0x7fffffff) == uVar8)) {
      pthread_mutex_unlock(ppVar1);
      uVar7 = GLES3::ParticlesStorage::get_singleton();
      this_00 = (HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>
                 *)GLES3::ParticlesStorage::particles_get_dependency(uVar7,param_2);
      goto LAB_00103e5f;
    }
    pthread_mutex_unlock(ppVar1);
    lVar5 = GLES3::ParticlesStorage::get_singleton();
    ...
    if (uVar9 < *(uint *)(lVar5 + 0x1dc)) {
      ...
      if ((*(uint *)(*(long *)(*(long *)(lVar5 + 0x1c8) +
                              ((param_2 & 0xffffffff) / (ulong)*(uint *)(lVar5 + 0x1d8)) * 8) +
                     ((param_2 & 0xffffffff) % (ulong)*(uint *)(lVar5 + 0x1d8)) * 0x78 + 0x70) &
          0x7fffffff) == uVar8) {
        pthread_mutex_unlock(ppVar1);
        uVar7 = GLES3::ParticlesStorage::get_singleton();
        this_00 = (HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>
                   *)GLES3::ParticlesStorage::particles_collision_get_dependency(uVar7,param_2);
        goto LAB_00103e5f;
      }
      pthread_mutex_unlock(ppVar1);
      ...
      pthread_mutex_unlock(ppVar1);
      if ((uVar9 < *(uint *)(this + 0x2c)) &&
         (uVar9 = *(uint *)(this + 0x28), param_2 >> 0x20 != 0x7fffffff)) {
LAB_00103db2:
        lVar5 = ((param_2 & 0xffffffff) % (ulong)uVar9) * 0x70 +
                *(long *)(*(long *)(this + 0x18) + ((param_2 & 0xffffffff) / (ulong)uVar9) * 8);
...
LAB_00104194:
    lVar5 = std::__throw_system_error(iVar4);
LAB_0010419b:
    _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                     "Method/function failed. Returning: nullptr",
...
LAB_00103e5f:
    ...
    puVar6 = (undefined4 *)
             HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>
             ::operator[](this_00,(DependencyTracker **)local_58);
    *puVar6 = uVar2;
  }
LAB_00103e93:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::Utilities::buffer_get_data(unsigned int, unsigned int, unsigned int) */

Utilities * __thiscall
...
LAB_00104229:
    *(undefined8 *)(this + 8) = 0;
    ...
    if (puVar1 == (ulong *)0x0) {
      ...
      if (__src == (void *)0x0) {
        _err_print_error("buffer_get_data","drivers/gles3/storage/utilities.cpp",0x87,
...
/* GLES3::Utilities::visibility_notifier_initialize(RID) */

void __thiscall GLES3::Utilities::visibility_notifier_initialize(Utilities *this,ulong param_2)
...
/* WARNING: Removing unreachable block (ram,0x00105969) */
/* WARNING: Removing unreachable block (ram,0x001057fc) */
/* WARNING: Removing unreachable block (ram,0x00105806) */
/* WARNING: Removing unreachable block (ram,0x0010594b) */
/* WARNING: Removing unreachable block (ram,0x00105812) */
/* WARNING: Removing unreachable block (ram,0x0010581c) */
/* WARNING: Removing unreachable block (ram,0x0010592d) */
/* WARNING: Removing unreachable block (ram,0x00105828) */
/* WARNING: Removing unreachable block (ram,0x00105832) */
/* WARNING: Removing unreachable block (ram,0x0010590f) */
/* WARNING: Removing unreachable block (ram,0x0010583e) */
/* WARNING: Removing unreachable block (ram,0x00105848) */
/* WARNING: Removing unreachable block (ram,0x001058f1) */
/* WARNING: Removing unreachable block (ram,0x00105854) */
/* WARNING: Removing unreachable block (ram,0x0010585e) */
/* WARNING: Removing unreachable block (ram,0x001058d3) */
/* WARNING: Removing unreachable block (ram,0x00105866) */
/* WARNING: Removing unreachable block (ram,0x00105870) */
/* WARNING: Removing unreachable block (ram,0x001058b8) */
/* WARNING: Removing unreachable block (ram,0x00105878) */
/* WARNING: Removing unreachable block (ram,0x0010588e) */
...
void __thiscall
RID_Alloc<GLES3::VisibilityNotifier,false>::~RID_Alloc
          (RID_Alloc<GLES3::VisibilityNotifier,false> *this)
...
LAB_00105b0a:
    if ((uint)uVar5 < (uint)uVar7) goto LAB_00105b4b;
    lVar6 = 0;
    while( true ) {

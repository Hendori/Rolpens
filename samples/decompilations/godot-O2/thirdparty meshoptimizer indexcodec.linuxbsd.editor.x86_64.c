...
void meshopt::writeTriangle
               (void *param_1,ulong param_2,ulong param_3,uint param_4,uint param_5,uint param_6)
...
int meshopt::decodeIndex(uchar **param_1,uint param_2)
...
byte * meshopt_encodeIndexBuffer(byte *param_1,ulong param_2,long param_3,ulong param_4)

{
  ...
  if (param_4 / 3 + 0x11 <= param_2) {
    ...
    *param_1 = (byte)_gEncodeIndexVersion | 0xe0;
    ...
    local_108[4] = 0xffffffff;
    local_108[5] = 0xffffffff;
    local_108[6] = 0xffffffff;
    local_108[7] = 0xffffffff;
    local_108[8] = 0xffffffff;
    local_108[9] = 0xffffffff;
    local_108[10] = 0xffffffff;
...
LAB_00100643:
          ...
          if (iVar17 != 0xf) {
            ...
            iVar1 = *(int *)(param_3 +
                            ((ulong)*(uint *)(meshopt::kTriangleIndexOrder + lVar11 + 8) + lVar24) *
                            4);
            uVar3 = *(undefined4 *)
                     (param_3 +
                     ((ulong)*(uint *)(meshopt::kTriangleIndexOrder + lVar11 + 4) + lVar24) * 4);
            uVar4 = *(undefined4 *)
                     (param_3 +
                     ((ulong)*(uint *)(meshopt::kTriangleIndexOrder + lVar11) + lVar24) * 4);
            lVar11 = 0;
            goto LAB_001006a0;
          }
          break;
      ...
      iVar2 = *(int *)(param_3 +
                      ((ulong)*(uint *)(meshopt::kTriangleIndexOrder + lVar11 + 4) + lVar24) * 4);
      iVar17 = *(int *)(param_3 +
                       ((ulong)*(uint *)(meshopt::kTriangleIndexOrder + lVar11 + 8) + lVar24) * 4);
      bVar18 = iVar1 == 0 && iVar2 == 1;
      if ((iVar1 == 0 && iVar2 == 1) &&
         (bVar18 = (local_14c != 0 && iVar17 == 2) && 0 < iVar8, bVar18)) {
        local_14c = 0;
        local_108[0] = -1;
        local_108[1] = 0xffffffff;
        local_108[2] = 0xffffffff;
...
LAB_00100720:
  (&local_c8)[local_158] = CONCAT44(uVar3,iVar1);
  uVar15 = iVar6 + 1U & 0xf;
  (&local_c8)[uVar15] = CONCAT44(iVar1,uVar4);
joined_r0x00100754:
  if (param_4 <= lVar24 + 3U) goto LAB_0010075f;
...
void meshopt_encodeIndexVersion(undefined4 param_1)

...
/* ~TMergeBlockTraverser() */

void __thiscall
glslang::TIntermediate::
mergeBlockDefinitions(TInfoSink&,glslang::TIntermSymbol*,glslang::TIntermSymbol*,glslang::TIntermediate*)
::TMergeBlockTraverser::~TMergeBlockTraverser(TMergeBlockTraverser *this)
...

{
  ...
  puVar3 = (uint *)*param_3;
  *(undefined4 *)(p_Var4 + 0x24) = 0;
  uVar2 = *puVar3;
  *(uint *)(p_Var4 + 0x20) = uVar2;
  if (p_Var1 == param_2) {
    if ((*(long *)(param_1 + 0x28) == 0) ||
       (p_Var5 = *(_Rb_tree_node_base **)(param_1 + 0x20), uVar2 <= *(uint *)(p_Var5 + 0x20))) {
LAB_00100228:
      auVar7 = _M_get_insert_unique_pos(param_1,(uint *)(ulong)uVar2);
...
LAB_001001fd:
  ...
  bVar6 = uVar2 < *(uint *)(param_2 + 0x20);
LAB_00100202:
  std::_Rb_tree_insert_and_rebalance(bVar6,p_Var4,param_2,p_Var1);
...
/* std::vector<glslang::TTypeLoc, glslang::pool_allocator<glslang::TTypeLoc>
   ...
   glslang::pool_allocator<glslang::TTypeLoc> > const&) [clone .isra.0] */

void __thiscall
std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>::operator=
          (vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>> *this,
          vector *param_1)
...
/* glslang::getNameForIdMap(glslang::TIntermSymbol*) */

TIntermSymbol * glslang::getNameForIdMap(TIntermSymbol *param_1)

{
  ...
  if (((pTVar3[8] == (TIntermSymbol)0x10) && (bVar1 = ((byte)pTVar3[0x18] & 0x7f) - 3, bVar1 < 4))
     && (*(int *)(CSWTCH_1270 + (ulong)bVar1 * 4) != 3)) {
    if (*(code **)(lVar2 + 0xf0) == TIntermTyped::getType) {
      pTVar3 = param_1 + 0x20;
    }
    else {
...
bool glslang::isSameInterface(long *param_1,int param_2,long *param_3,int param_4)

{
  ...
  if (param_2 == param_4) {
    ...
    iVar5 = 3;
    if (((char)plVar3[1] == '\x10') && (bVar1 = (*(byte *)(plVar3 + 3) & 0x7f) - 3, bVar1 < 4)) {
...

{
  ...
  *(undefined4 *)p_Var5 = uVar1;
  if (p_Var3 != (_Rb_tree_node *)0x0) {
    p_Var3 = _M_copy<false,std::_Rb_tree<std::__cxx11::string,std::__cxx11::string,std::_Identity<std::__cxx11::string>,std::less<std::__cxx11::string>,std::allocator<std::__cxx11::string>>::_Reuse_or_alloc_node>
  ...
  if (puVar8 != (undefined4 *)0x0) {
    ...
    do {
      ...
      *(_Rb_tree_node_base **)(p_Var7 + 0x20) = p_Var7 + 0x30;
      __cxx11::string::_M_construct<char*>
                (p_Var7 + 0x20,*(long *)(puVar8 + 8),*(long *)(puVar8 + 10) + *(long *)(puVar8 + 8))
      ;
      p_Var4 = p_Var7;
      while( true ) {
        uVar1 = *puVar8;
...
LAB_00100cb5:
        p_Var4 = (_Rb_tree_node_base *)operator_new(0x40);
        lVar2 = *(long *)(puVar8 + 10);
        *(_Rb_tree_node_base **)(p_Var4 + 0x20) = p_Var4 + 0x30;
        __cxx11::string::_M_construct<char*>
                  (p_Var4 + 0x20,*(long *)(puVar8 + 8),lVar2 + *(long *)(puVar8 + 8));
      }
    } while( true );
  }
  return (_Rb_tree_node *)p_Var5;
...
/* std::_Rb_tree<std::__cxx11::basic_string<char, std::char_traits<char>,
   ...
   glslang::std::allocator<char> > const, long long> >*) [clone .isra.0] */
...
/* glslang::TIntermediate::mergeBlockDefinitions(TInfoSink&, glslang::TIntermSymbol*,
   ...
   glslang::TIntermediate*)::TMergeBlockTraverser::visitSymbol(glslang::TIntermSymbol*) */

void glslang::TIntermediate::mergeBlockDefinitions(TInfoSink&,glslang::TIntermSymbol*,glslang::
     TIntermSymbol*,glslang::TIntermediate*)::TMergeBlockTraverser::visitSymbol(glslang::
     TIntermSymbol__(long param_1,long *param_2)

{
  ...
  if (__n == *(size_t *)(lVar6 + 0x10)) {
    if ((__n != 0) && (iVar4 = memcmp(*(void **)(lVar7 + 8),*(void **)(lVar6 + 8),__n), iVar4 != 0))
    {
      return;
    }
...
/* glslang::TIntermediate::finalCheck(TInfoSink&,
   bool)::TFinalLinkTraverser::visitSymbol(glslang::TIntermSymbol*) */

void glslang::TIntermediate::finalCheck(TInfoSink&,bool)::TFinalLinkTraverser::visitSymbol(glslang::
     TIntermSymbol__(undefined8 param_1,long *param_2)
...
TIntermBinary__(long param_1,undefined8 param_2,long *param_3,long param_4)

{
  ...
  if ((((pTVar2 != (TType *)0x0) && (*(long *)(param_1 + 0x50) != 0)) &&
      (*(long *)(*(long *)(param_1 + 0x50) + 0x28) != 0)) && ((int)param_3[0x17] == 0xb8)) {
    ...
    if (cVar3 != '\0') {
      ...
      if (lVar6 != 0) {
        ...
        if ((lVar12 != lVar7) && (*(uint *)(lVar12 + 0x20) <= uVar1)) {
          ...
          lVar7 = glslang::TIntermediate::addConstantUnion
                            ((uint)uVar9,(TSourceLoc *)(ulong)uVar1,(bool)cVar3);
...
/* glslang::TIntermediate::error(TInfoSink&, char const*, EShLanguage) */

void __thiscall
glslang::TIntermediate::error(TIntermediate *this,char *param_1,undefined8 param_3,int param_4)
...
/* glslang::TIntermediate::warn(TInfoSink&, char const*, EShLanguage) */

void __thiscall
glslang::TIntermediate::warn(TIntermediate *this,char *param_1,undefined8 param_3,int param_4)
...
void __thiscall
glslang::TIntermediate::mergeCallGraphs
...
/* glslang::TIntermediate::remapIds(glslang::TIdMaps const&, long long, glslang::TIntermediate&) */

void __thiscall
glslang::TIntermediate::remapIds
          (TIntermediate *this,TIdMaps *param_1,longlong param_2,TIntermediate *param_3)
...
/* glslang::TIntermediate::mergeBodies(TInfoSink&, glslang::TVector<TIntermNode*>&,
   glslang::TVector<TIntermNode*> const&) */

void __thiscall
glslang::TIntermediate::mergeBodies
          (TIntermediate *this,TInfoSink *param_1,TVector *param_2,TVector *param_3)
      ...
      if (lVar8 - (long)puVar9 != 8) {
        do {
          ...
          if ((((plVar4 != (long *)0x0) && (plVar5 != (long *)0x0)) && ((int)plVar4[0x17] == 5)) &&
            ...
            if (__n == plVar5[2]) {
              if ((__n == 0) ||
                 (iVar3 = memcmp((void *)plVar4[1],(void *)plVar5[1],__n), iVar3 == 0)) {
                error(this,param_1,
                ...
                plVar5 = (long *)(**(code **)(**(long **)(*(long *)(param_2 + 8) + uVar11 * 8) +
                                             0x30))();
                if (*(code **)(*plVar5 + 0x1a8) != TIntermAggregate::getName_abi_cxx11_) {
...
void __thiscall
glslang::TIntermediate::mergeImplicitArraySizes(TIntermediate *this,TType *param_1,TType *param_2)
...
LAB_00101d01:
      if (**(int **)(*(long *)(lVar6 + 8) + 8) == 0) goto LAB_00101d13;
    }
    else {
...
LAB_00101d13:
  ...
  if (*(code **)(lVar7 + 0xf8) == TType::isUnsizedArray) {
    if (*(code **)(lVar7 + 0xe8) != TType::isArray) {
      ...
      lVar7 = *(long *)param_2;
LAB_00101e99:
      if (**(int **)(*(long *)(lVar6 + 8) + 8) != 0) goto LAB_00101eab;
      goto LAB_00101de1;
    }
    lVar6 = *(long *)(param_2 + 0x60);
...
LAB_00101d75:
    ...
    *(undefined1 *)(lVar7 + 0x14) = 0;
    ...
    if (cVar1 != '\0') {
LAB_00101de1:
      pcVar8 = *(code **)(*(long *)param_1 + 0x118);
...
LAB_00101d62:
      ...
      if (cVar1 != '\0') {
        lVar7 = *(long *)(param_2 + 0x60);
LAB_00101d67:
        if (**(int **)(*(long *)(lVar7 + 8) + 8) != 0) goto LAB_00101d75;
      }
    }
  }
LAB_00101dad:
  ...
  if ((lVar5 == *(long *)(*(long *)(param_1 + 0x68) + 0x10) - lVar7) && (0 < (int)(lVar5 >> 5))) {
    ...
    while( true ) {
      mergeImplicitArraySizes
                (this,*(TType **)(lVar7 + lVar5 * 0x20),*(TType **)(lVar6 + lVar5 * 0x20));
      lVar7 = *(long *)(*(long *)(param_1 + 0x68) + 8);
      if ((int)(*(long *)(*(long *)(param_1 + 0x68) + 0x10) - lVar7 >> 5) <= (int)(lVar5 + 1))
      break;
      lVar6 = *(long *)(*(long *)(param_2 + 0x68) + 8);
      lVar5 = lVar5 + 1;
    }
...
void __thiscall glslang::TIntermediate::checkCallGraphCycles(TIntermediate *this,TInfoSink *param_1)
...
LAB_00102070:
        ...
        if (pTVar6 != pTVar1) {
          do {
            if ((pTVar6[0x60] == (TIntermediate)0x0) &&
               (__n = ppppuVar7[7], __n == *(undefined8 ****)(pTVar6 + 0x20))) {
              if ((__n != (undefined8 ***)0x0) &&
                 (iVar3 = memcmp(ppppuVar7[6],*(void **)(pTVar6 + 0x18),(size_t)__n), iVar3 != 0))
              goto LAB_00102090;
...
/* glslang::TIntermediate::findLinkerObjects() const */

void glslang::TIntermediate::findLinkerObjects(void)

{
  long *plVar1;
  long in_RDI;
  
  plVar1 = (long *)(**(code **)(**(long **)(in_RDI + 0x80) + 0x30))();
...
/* glslang::TIntermediate::sharedBlockCheck(TInfoSink&) */

void __thiscall glslang::TIntermediate::sharedBlockCheck(TIntermediate *this,TInfoSink *param_1)
...
void __thiscall glslang::TIntermediate::inOutLocationCheck(TIntermediate *this,TInfoSink *param_1)

{
  ...
  if (lVar4 != plVar2[2]) {
    ...
    do {
      ...
      if ((((*(int *)this == 4) && ((short)plVar3[1] == 4)) &&
          (iVar6 = iVar6 + 1, (~*(ushort *)((long)plVar3 + 0x1c) & 0xfff) == 0)) &&
         (((*(byte *)((long)plVar3 + 0x1d) & 0x70) == 0x40 && (*(char *)((long)plVar3 + 0x22) == -1)
          ))) {
        bVar1 = true;
      }
      lVar4 = plVar2[1];
    ...
    if (((*(int *)(this + 0x60) == 8) && (1 < iVar6)) && (bVar1)) {
      error(this,param_1,
            "when more than one fragment shader output, all must have location qualifiers",0xe);
      return;
    }
  }
  return;
...
/* glslang::TIntermediate::seedIdMap(glslang::TIdMaps&, long long&) */

void __thiscall
glslang::TIntermediate::seedIdMap(TIntermediate *this,TIdMaps *param_1,longlong *param_2)
...
glslang::TIntermediate::checkLocationRange
          (TIntermediate *this,int param_1,TIoRange *param_2,TType *param_3,bool *param_4)
  ...
  if (*(long *)(this + lVar5 * 0x18 + 0x660) != lVar8) {
    ...
    do {
      ...
      if ((*(int *)(param_2 + 4) < iVar3) || (iVar2 = *(int *)param_2, piVar9[1] < iVar2)) {
        ...
        if (((piVar9[2] <= *(int *)(param_2 + 0xc)) && (*(int *)(param_2 + 8) <= piVar9[3])) &&
           (*(int *)(param_2 + 0x14) == piVar9[5])) {
          if (iVar2 <= iVar3) {
            return iVar3;
          }
          return iVar2;
...
LAB_001027b0:
          if (((byte)TVar1 >> 6 & 1) != *(byte *)((long)piVar9 + 0x19)) goto LAB_001029e0;
LAB_001027c0:
          pTVar7 = param_3 + 0x10;
        }
        else {
          ...
          lVar8 = *(long *)(this + lVar5 * 0x18 + 0x658);
          piVar9 = (int *)(lVar8 + lVar10);
          if ((*(byte *)(lVar6 + 0xb) >> 6 & 1) != *(byte *)((long)piVar9 + 0x19))
          goto LAB_001029e0;
...
LAB_001029e0:
      ...
      uVar11 = uVar11 + 1;
    } while (uVar11 < (ulong)((*(long *)(this + lVar5 * 0x18 + 0x660) - lVar8 >> 2) *
                             0x6db6db6db6db6db7));
  }
  if ((param_1 == 4) || (param_1 == 1)) {
    ...
    if (lVar8 != *(long *)(this + (long)iVar3 * 0x18 + 0x660)) {
      ...
      do {
        ...
        uVar11 = uVar11 + 1;
      } while (uVar11 < (ulong)((*(long *)(this + (long)iVar3 * 0x18 + 0x660) - lVar8 >> 2) *
                               0x6db6db6db6db6db7));
    }
  }
  return -1;
...
/* glslang::TIntermediate::checkLocationRT(int, int) */

int __thiscall glslang::TIntermediate::checkLocationRT(TIntermediate *this,int param_1,int param_2)
...
int __thiscall glslang::TIntermediate::addUsedConstantId(TIntermediate *this,int param_1)
  ...
  if (*(long *)(this + 0x620) == 0) {
    ...
    if (plVar11 != (long *)0x0) {
      ...
      while (iVar9 != param_1) {
        plVar2 = (long *)*plVar3;
        if ((plVar2 == (long *)0x0) ||
           (iVar9 = (int)plVar2[1], plVar20 = plVar3, plVar3 = plVar2,
           uVar16 != (ulong)(long)iVar9 % uVar17)) goto joined_r0x00102b9f;
      }
      if (*plVar20 != 0) {
        return 0;
      }
joined_r0x00102b9f:
      do {
        ...
        if ((plVar20 == (long *)0x0) ||
           (iVar22 = (int)plVar20[1], plVar11 = plVar10, plVar10 = plVar20,
           uVar16 != (ulong)(long)iVar22 % uVar17)) break;
      } while( true );
    }
  }
...
LAB_00102f9a:
        TType::TType(aTStack_100,(TType *)pTVar12,0,false);
        ...
        if (pcVar14 == TType::isSizedArray) {
          ...
          if (pcVar14 == TType::isArray) {
            ...
            if (lVar13 != 0) {
LAB_00102fdb:
              if (**(int **)(*(long *)(lVar13 + 8) + 8) != 0) goto LAB_00102fe9;
            }
          }
          else {
...
LAB_00102f30:
          iVar9 = 0;
          if (0 < (int)(*(long *)(*(long *)((TType *)pTVar12 + 0x68) + 0x10) -
                        *(long *)(*(long *)((TType *)pTVar12 + 0x68) + 8) >> 5)) {
            iVar22 = 0;
            do {
              ...
              iVar9 = iVar9 + iVar8;
            } while (iVar22 < (int)(*(long *)(*(long *)((TType *)pTVar12 + 0x68) + 0x10) -
                                    *(long *)(*(long *)((TType *)pTVar12 + 0x68) + 8) >> 5));
          }
          goto LAB_00102f00;
        }
...
LAB_0010314b:
        bVar5 = (byte)TVar6 >> 4 & 1;
LAB_001030e4:
        if (bVar5 != 0) goto LAB_00102e73;
...
LAB_00102e73:
        if ((int)uVar19 == 0) {
          ...
          if (((byte)((byte)pTVar15[8] & 0x7f) < 0x1c) &&
             ((0xe300008UL >> ((ulong)((byte)pTVar15[8] & 0x7f) & 0x3f) & 1) != 0))
          goto LAB_0010310d;
          lVar13 = *(long *)pTVar12;
        }
...
LAB_00102c36:
  pTVar1 = pTVar12 + uVar16 * 8;
  if (*(long **)pTVar1 == (long *)0x0) {
    lVar13 = *(long *)(this + 0x618);
    *(long **)(this + 0x618) = plVar11;
    *plVar11 = lVar13;
    if (lVar13 != 0) {
      *(long **)(pTVar12 + ((ulong)(long)*(int *)(lVar13 + 8) % *(ulong *)(this + 0x610)) * 8) =
           plVar11;
    }
    *(TIntermediate **)pTVar1 = this + 0x618;
  }
...
int glslang::TIntermediate::computeTypeLocationSize(TType *param_1,int param_2)
...
LAB_00102f9a:
    TType::TType(aTStack_c8,param_1,0,false);
    ...
    if (pcVar8 == TType::isSizedArray) {
      ...
      if (pcVar8 == TType::isArray) {
        ...
        if (lVar7 != 0) {
LAB_00102fdb:
          if (**(int **)(*(long *)(lVar7 + 8) + 8) != 0) goto LAB_00102fe9;
        }
      }
      else {
...
LAB_00102f30:
      iVar6 = 0;
      if (0 < (int)(*(long *)(*(long *)(param_1 + 0x68) + 0x10) -
                    *(long *)(*(long *)(param_1 + 0x68) + 8) >> 5)) {
        iVar10 = 0;
        do {
          ...
          iVar6 = iVar6 + iVar5;
        } while (iVar10 < (int)(*(long *)(*(long *)(param_1 + 0x68) + 0x10) -
                                *(long *)(*(long *)(param_1 + 0x68) + 8) >> 5));
      }
      goto LAB_00102f00;
    }
...
LAB_0010314b:
    bVar1 = (byte)TVar2 >> 4 & 1;
LAB_001030e4:
    if (bVar1 != 0) goto LAB_00102e73;
...
LAB_00102e73:
    if (param_2 == 0) {
      ...
      if (((byte)((byte)pTVar9[8] & 0x7f) < 0x1c) &&
         ((0xe300008UL >> ((ulong)((byte)pTVar9[8] & 0x7f) & 0x3f) & 1) != 0)) goto LAB_0010310d;
      lVar7 = *(long *)param_1;
    }
...
/* glslang::TIntermediate::computeTypeUniformLocationSize(glslang::TType const&) */

int glslang::TIntermediate::computeTypeUniformLocationSize(TType *param_1)
...
LAB_001033ba:
      ...
      if (pcVar1 == TType::isSizedArray) {
        ...
        if (pcVar1 == TType::isArray) {
          ...
          if (lVar4 != 0) {
LAB_001033fb:
            if (**(int **)(*(long *)(lVar4 + 8) + 8) != 0) goto LAB_00103409;
          }
        }
        else {
...
LAB_00103450:
        iVar5 = computeTypeUniformLocationSize(aTStack_c8);
      }
      else {
        cVar2 = (*pcVar1)(param_1);
...
LAB_00103351:
      ...
      if (0 < (int)(*(long *)(*(long *)(param_1 + 0x68) + 0x10) -
        ...
        do {
          ...
          iVar5 = iVar5 + iVar3;
        } while (iVar6 < (int)(*(long *)(*(long *)(param_1 + 0x68) + 0x10) -
                               *(long *)(*(long *)(param_1 + 0x68) + 8) >> 5));
      }
      goto LAB_0010331d;
    }
...
glslang::TIntermediate::computeTypeXfbSize
          (TIntermediate *this,TType *param_1,bool *param_2,bool *param_3,bool *param_4)
          ...
          if (0 < (int)(*(long *)(*(long *)(param_1 + 0x68) + 0x10) -
            ...
            do {
              ...
              uVar6 = uVar6 + 1;
                     ...
                     (int)(*(long *)(*(long *)(param_1 + 0x68) + 0x10) -
                           *(long *)(*(long *)(param_1 + 0x68) + 8) >> 5));
            if (cVar3 == '\0') {
              if (local_ea == '\0') {
                if (local_e9 != '\0') {
...
LAB_001038e0:
    ...
    lVar7 = *(long *)(param_1 + 0x60);
LAB_00103519:
    if (**(int **)(*(long *)(lVar7 + 8) + 8) == 0) goto LAB_001035bd;
  }
  else {
...
void glslang::TIntermediate::getBaseAlignmentScalar(TType *param_1,int *param_2)
...
ulong glslang::TIntermediate::getBaseAlignment
                (TType *param_1,uint *param_2,uint *param_3,int param_4,bool param_5)
...
LAB_00104085:
    TType::TType((TType *)local_d8,param_1,0,false);
    ...
    *param_3 = uVar5;
    ...
    if (*(code **)(lVar9 + 0xf8) == TType::isUnsizedArray) {
      if (*(code **)(lVar9 + 0xe8) == TType::isArray) {
        ...
        if (lVar11 != 0) {
LAB_00104118:
          if (**(int **)(*(long *)(lVar11 + 8) + 8) == 0) goto LAB_00104258;
        }
      }
      else {
    ...
    *param_2 = 0;
    ...
    if (lVar11 != *(long *)(lVar9 + 0x10)) {
      ...
      do {
        ...
        uVar5 = getBaseAlignment(*(undefined8 *)(lVar11 + uVar12 * 0x20),local_d8,local_dc,param_4,
                                 uVar14);
        lVar11 = *(long *)(lVar9 + 8);
...
LAB_00104205:
        if (bVar2 == 0) {
          if (*(code **)(*(long *)param_1 + 0xe0) == TType::isMatrix) {
            if (0xf < (byte)param_1[9]) {
LAB_00104340:
              TType::TType((TType *)local_d8,param_1,0,param_5);
              uVar7 = getBaseAlignment((TType *)local_d8,param_2,local_dc,param_4,param_5);
              uVar5 = 0x10;
              if (0xf < (int)uVar7) {
                uVar5 = uVar7;
...
/* glslang::TIntermediate::improperStraddle(glslang::TType const&, int, int, bool) */

bool glslang::TIntermediate::improperStraddle(TType *param_1,int param_2,int param_3,bool param_4)
...
ulong glslang::TIntermediate::getScalarAlignment
                (TType *param_1,int *param_2,int *param_3,bool param_4)
...
LAB_00104643:
      if (param_1[8] == (TType)0xf) goto LAB_001047ab;
LAB_00104650:
      lVar9 = *(long *)param_1;
      if (*(code **)(lVar9 + 0xc0) != TType::isScalar) {
...
LAB_001048ed:
          if (bVar1 == 0) {
            if (*(code **)(*(long *)param_1 + 0xe0) == TType::isMatrix) {
              if (0xf < (byte)param_1[9]) {
LAB_001049d5:
                TType::TType((TType *)local_d8,param_1,0,param_4);
...
void glslang::TIntermediate::getMemberAlignment
               (TType *param_1,int *param_2,int *param_3,int param_4,bool param_5)
...
/* glslang::TIntermediate::updateOffset(glslang::TType const&, glslang::TType const&, int&, int&) */

void glslang::TIntermediate::updateOffset(TType *param_1,TType *param_2,int *param_3,int *param_4)
...
int glslang::TIntermediate::getOffset(TType *param_1,int param_2)
...
int glslang::TIntermediate::getBlockSize(TType *param_1)

{
  ...
  pTVar5 = param_1 + 0x10;
LAB_00104de7:
  if (((byte)pTVar5[0x10] & 0xf) == 5) {
    getScalarAlignment(*(TType **)((long)iVar4 * 0x20 + *(long *)(lVar1 + 8)),&local_48,&local_44,
                       bVar6);
  }
  else {
    getBaseAlignment();
...
uint glslang::TIntermediate::computeBufferReferenceTypeSize(TType *param_1)
...
/* glslang::TIntermediate::isIoResizeArray(glslang::TType const&, EShLanguage) */

byte glslang::TIntermediate::isIoResizeArray(long *param_1,int param_2)
...
LAB_0010506d:
    ...
    param_1 = param_1 + 2;
LAB_00105078:
    return *(byte *)((long)param_1 + 0xd) >> 4 & 1 ^ 1;
  }
  ...
  if (param_2 != 4) {
    ...
    param_1 = param_1 + 2;
LAB_00105144:
    return *(byte *)((long)param_1 + 0xd) >> 3 & 1 ^ 1;
  }
  if (*(code **)(*param_1 + 0x58) == TType::getQualifier) {
...
LAB_001050fb:
  ...
  param_1 = param_1 + 2;
LAB_00105105:
  return *(byte *)((long)param_1 + 0xd) & 1;
}
...

{
  ...
  do {
    ...
    if (*(code **)(*plVar7 + 0xf0) == TIntermTyped::getType) {
      ...
      if ((ulong)(*(long *)(*(long *)(lVar5 + 0x68) + 0x10) - *(long *)(*(long *)(lVar5 + 0x68) + 8)
                 >> 5) <= uVar9) {
LAB_00105610:
        if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
          return;
    ...
    if (__n == *(size_t *)(lVar5 + 0x10)) {
      ...
      if ((~*(ushort *)((long)plVar6 + 0x1c) & 0xfff) == 0) {
        ...
        if ((~*(ushort *)((long)plVar7 + 0x1c) & 0xfff) == 0) {
          error(*(TIntermediate **)this,*(undefined8 *)(this + 0x10),
                "Anonymous member name used for global variable or other anonymous member: ",0xe);
          ...
          _M_construct<char_const*>(&local_98,&_LC2,&_LC2);
          local_c8 = glslang::GetThreadPoolAllocator();
          local_c0 = local_b0;
          std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
          _M_construct<char_const*>(&local_c8,&_LC2,&_LC2);
...
/* glslang::TIntermediate::mergeErrorCheck(TInfoSink&, glslang::TIntermSymbol const&,
   glslang::TIntermSymbol const&, EShLanguage) */

void __thiscall
glslang::TIntermediate::mergeErrorCheck
          (TIntermediate *this,basic_string *param_1,long *param_2,long *param_3,int param_5)

{
  ...
  code *pcVar18;
  char *pcVar19;
  basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *pbVar20;
  long lVar21;
  double *pdVar22;
  TType *pTVar23;
  long *plVar24;
  ...
  undefined1 *local_90;
  undefined1 local_80 [24];
  basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> local_68 [8];
  undefined8 local_60;
  long local_40;
  ...
  cVar14 = isIoResizeArray(plVar28,iVar4);
  if (cVar14 == '\0') {
    if (*(code **)(*param_3 + 0xf0) == TIntermTyped::getType) {
      plVar28 = param_3 + 4;
    }
...
LAB_00105fce:
      ...
      if (lVar21 == 0) goto LAB_00106100;
LAB_00105fdb:
      uVar33 = (uint)(*(long *)(lVar21 + 0x10) - *(long *)(lVar21 + 8) >> 4);
    }
    else {
...
LAB_00107150:
    ...
    if ((uVar33 != uVar17) && ((bool)cVar14)) {
      ...
      do {
        ...
        iVar16 = *(int *)((long)(int)((uVar17 - bVar31) + uVar32) * 0x10 +
                         *(long *)(*(long *)(lVar21 + 8) + 8));
        if (*(code **)(*param_3 + 0x120) == TIntermTyped::getArraySizes) {
          lVar21 = param_3[0x10];
        }
        else {
        ...
        if (iVar16 != *(int *)((long)(int)uVar32 * 0x10 + *(long *)(*(long *)(lVar21 + 8) + 8)))
        goto LAB_00106dd0;
        uVar38 = uVar38 + 1;
        uVar32 = uVar32 + 1;
...
LAB_0010577d:
  ...
  if (pTVar23[8] == pTVar26[8]) {
    if (pTVar23[8] == (TType)0xe) {
      if ((((*(short *)(pTVar23 + 0x80) == *(short *)(pTVar26 + 0x80)) &&
           (TVar1 = pTVar23[0x82], (((byte)pTVar26[0x82] ^ (byte)TVar1) & 3) == 0)) &&
          (TVar2 = pTVar26[0x82], ((byte)TVar1 >> 2 & 1) == ((byte)TVar2 >> 2 & 1))) &&
         (((((byte)TVar1 >> 3 & 1) == ((byte)TVar2 >> 3 & 1) &&
           (((byte)TVar1 >> 4 & 1) == ((byte)TVar2 >> 4 & 1))) &&
          (((byte)TVar1 >> 5 & 1) == ((byte)TVar2 >> 5 & 1))))) {
        if ((((byte)pTVar23[0x83] >> 5 & 1) == ((byte)pTVar26[0x83] >> 5 & 1)) &&
           (((byte)pTVar23[0x83] >> 6 & 1) == ((byte)pTVar26[0x83] >> 6 & 1))) goto LAB_001074d8;
      }
      goto LAB_001057e4;
    }
LAB_001074d8:
    bVar31 = (byte)pTVar23[9] ^ (byte)pTVar26[9];
    bVar42 = (bVar31 & 0xf) == 0;
    local_260 = bVar42 && bVar31 < 0x10;
    if ((!bVar42 || bVar31 >= 0x10) ||
       (((TVar1 = pTVar23[10], (((byte)pTVar26[10] ^ (byte)TVar1) & 0x1f) != 0 ||
         (((byte)TVar1 >> 5 & 1) != ((byte)pTVar26[10] >> 5 & 1))) ||
        (((byte)TVar1 >> 6 & 1) != ((byte)pTVar26[10] >> 6 & 1))))) goto LAB_001057e4;
    ...
    if ((cVar15 != '\0') && (cVar15 = TType::sameReferenceType(pTVar23,pTVar26), cVar15 != '\0')) {
      if (cVar14 == '\0') {
        ...
        else if ((piVar8 != (int *)0x0) && (iVar16 = *piVar7, iVar16 == *piVar8)) {
...
LAB_00109781:
              ...
              if (sVar29 == *(size_t *)(lVar34 + 0x10)) {
                if (((sVar29 == 0) ||
                    (iVar16 = memcmp(*(void **)(lVar21 + 8),*(void **)(lVar34 + 8),sVar29),
                    iVar16 == 0)) && (*(int *)(lVar21 + 0x28) == *(int *)(lVar34 + 0x28))) {
              ...
              if (piVar39 != piVar9) {
                do {
                  ...
                  if (plVar28 == (long *)0x0) {
                    ...
                    if (((plVar24 == (long *)0x0) ||
                        (lVar21 = (**(code **)(*plVar28 + 0x60))(plVar28), lVar21 == 0)) ||
                       (lVar21 = (**(code **)(*plVar24 + 0x60))(plVar24), lVar21 == 0))
                    goto LAB_0010961e;
...
LAB_0010961e:
        error(this,param_1,"Type parameters must match:");
      }
      goto LAB_001057fe;
    }
    iVar16 = local_1fc;
    ...
    if (local_1fc < 0) {
      if ((local_1fc != -1) || (lVar21 = (long)(int)local_1f8, (int)local_1f8 < 0))
      goto LAB_001057e4;
      local_1f0 = glslang::GetThreadPoolAllocator();
      pcVar19 = (char *)StageName(param_5);
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
      basic_string<glslang::std::allocator<char>>(local_68,pcVar19,(allocator *)&local_1f0);
      pbVar20 = (basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                std::__cxx11::
                basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::append
                          (local_68," block member has no corresponding member in ");
...
LAB_001086e7:
      ...
      if (-1 < (int)local_1f8) {
        ...
        local_1b0 = local_1a0;
        std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
        _M_construct<char_const*>(&local_1b8,&_LC2,&_LC2);
        if (*(code **)(*param_2 + 0xf0) == TIntermTyped::getType) {
          plVar28 = param_2 + 4;
        }
        else {
        ...
        if (uVar37 < 0x10) {
          ...
          local_1d0[0] = uVar37;
LAB_00108be1:
          memcpy(local_1e0,puVar6,uVar37);
        }
        *(undefined1 *)((long)local_1e0 + uVar37) = 0;
        ...
        local_150 = local_140;
        std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
        _M_construct<char_const*>(&local_158,&_LC2,&_LC2);
        if (*(code **)(*param_3 + 0xf0) == TIntermTyped::getType) {
          plVar28 = param_3 + 4;
        }
        else {
        ...
        if (uVar37 < 0x10) {
          ...
          local_170[0] = uVar37;
LAB_00108c21:
          memcpy(local_180,puVar6,uVar37);
        }
...
LAB_001057e4:
    error(this,param_1,"Types must match:");
LAB_001057fe:
    local_260 = false;
    bVar42 = true;
  }
    ...
    if (uVar17 == 0x10) {
      ...
      if (plVar28[0xd] != 0) {
        ...
        while( true ) {
          ...
          if ((ulong)(*(long *)(plVar24[0xd] + 0x10) - *(long *)(plVar24[0xd] + 8) >> 5) <= uVar37)
          goto LAB_0010584c;
          if (*(code **)(*param_3 + 0xf0) == TIntermTyped::getType) {
            plVar24 = param_3 + 4;
          }
          ...
          lVar21 = *param_2;
          if ((ulong)(*(long *)(plVar24[0xd] + 0x10) - *(long *)(plVar24[0xd] + 8) >> 5) <=
              local_268) break;
          plVar24 = plVar28;
          if (*(code **)(lVar21 + 0xf0) != TIntermTyped::getType) {
...
LAB_00106c07:
                ...
                if (((*(ushort *)((long)plVar24 + 0x1c) ^ *(ushort *)((long)plVar25 + 0x1c)) & 0xfff
                    ) == 0) {
                  if (((*(byte *)((long)plVar24 + 0x1d) ^ *(byte *)((long)plVar25 + 0x1d)) & 0x70)
                      != 0) {
LAB_0010873b:
                    error(this,param_1,
                          "Interface block member layout component qualifier must match:",param_5);
                    goto LAB_00108755;
                  }
                  if (cVar15 != '\0') goto LAB_00108755;
                }
                else {
                  error(this,param_1,"Interface block member layout location qualifier must match:",
                        param_5);
                  if (((*(byte *)((long)plVar24 + 0x1d) ^ *(byte *)((long)plVar25 + 0x1d)) & 0x70)
                      != 0) goto LAB_0010873b;
LAB_00108755:
                  ...
                  basic_string<glslang::std::allocator<char>>
                            ((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>
                              *)&local_98,"",(allocator *)&local_1f0);
                  local_1f8 = glslang::GetThreadPoolAllocator();
                  std::__cxx11::
                  basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
                  basic_string<glslang::std::allocator<char>>
                            ((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>
                              *)&local_c8,"",(allocator *)&local_1f8);
                  TType::getCompleteString
                            (local_68,uVar36,1,1,0,0,
                             (basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>
                              *)&local_c8);
                  glslang::TInfoSinkBase::append(param_1);
                  glslang::TInfoSinkBase::append((char *)param_1);
...
LAB_0010620a:
    lVar21 = (*pcVar18)(param_2);
    if ((*(byte *)(lVar21 + 8) & 0x7f) - 5 < 2) {
      lVar21 = *param_2;
LAB_00106226:
      if (*(code **)(lVar21 + 400) == TIntermSymbol::getName_abi_cxx11_) {
...
LAB_001058d8:
    if ((*(byte *)(param_2 + 7) & 0x7f) - 5 < 2) goto LAB_00106226;
LAB_001058ed:
    plVar28 = param_2 + 6;
  }
  bVar31 = *(byte *)(plVar28 + 1);
  if (*(code **)(*param_3 + 0x110) == TIntermTyped::getQualifier) {
    plVar28 = param_3 + 6;
  }
  else {
  ...
  if (((bVar31 ^ *(byte *)(plVar28 + 1)) & 0x7f) == 0) {
    ...
    if (local_268._0_1_ == bVar41) {
      ...
      if ((sVar29 == plVar28[2]) &&
         ((sVar29 == 0 ||
          (iVar16 = memcmp((void *)plVar24[1],(void *)plVar28[1],sVar29), iVar16 == 0))))
      goto LAB_00105a15;
    }
...
LAB_001069d8:
    plVar28 = (long *)(*pcVar18)(param_2);
  }
  bVar31 = *(byte *)((long)plVar28 + 0xe);
  if (*(code **)(*param_3 + 0x110) == TIntermTyped::getQualifier) {
    plVar28 = param_3 + 6;
  }
  else {
  ...
  bVar11 = false;
  if (((bVar31 ^ *(byte *)((long)plVar28 + 0xe)) & 2) == 0) {
    pcVar18 = *(code **)(*param_2 + 0x110);
...
LAB_00105cf2:
  ...
  bVar11 = false;
  if (((bVar31 ^ *(byte *)((long)plVar28 + 0xf)) & 0x70) == 0) {
    pcVar18 = *(code **)(*param_2 + 0x110);
...
LAB_00105d92:
    if ((~*(ushort *)((long)param_2 + 0x4c) & 0xfff) != 0) goto LAB_00105da0;
LAB_00105e1b:
    plVar28 = param_2 + 6;
  }
  else {
...
LAB_00106343:
    ...
    if ((((local_260 == '\0') && (lVar21 = param_2[0x1f], lVar21 != 0)) &&
        (lVar34 = param_3[0x1f], lVar21 != lVar34)) && (lVar34 != 0)) {
      pdVar22 = *(double **)(lVar21 + 8);
      pdVar30 = *(double **)(lVar34 + 8);
      if ((long)*(double **)(lVar21 + 0x10) - (long)pdVar22 !=
          *(long *)(lVar34 + 0x10) - (long)pdVar30) {
switchD_001080dc_caseD_0:
        error(this,param_1,"Initializers must match:",param_5);
        glslang::TInfoSinkBase::append((char *)param_1);
        if (*(code **)(*param_2 + 400) != TIntermSymbol::getName_abi_cxx11_) {
    ...
    if (uVar17 == 0x10) {
      ...
      if (bVar42) {
        ...
        basic_string((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                     &local_c8,pbVar27);
        TType::getCompleteString
                  (local_68,local_288,1,uVar12,local_268,1,
                   (basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                   &local_c8);
        glslang::TInfoSinkBase::append(param_1);
        glslang::TInfoSinkBase::append((char *)param_1);
        ...
        basic_string<glslang::std::allocator<char>>
                  ((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                   &local_c8,"",(allocator *)&local_1f8);
        TType::getCompleteString
                  (local_68,local_288,1,uVar12,local_268,0,
                   (basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                   &local_c8,
                   (basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                   &local_98);
...
LAB_00106385:
      if (bVar42) {
        ...
        local_f0 = local_e0;
        std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
        _M_construct<char_const*>(&local_f8,&_LC2,&_LC2);
        if (*(code **)(*param_2 + 400) == TIntermSymbol::getName_abi_cxx11_) {
        ...
        if (uVar37 < 0x10) {
          ...
          local_110[0] = uVar37;
LAB_00108008:
          memcpy(local_120,puVar6,uVar37);
        }
...
/* glslang::TIntermediate::mergeBlockDefinitions(TInfoSink&, glslang::TIntermSymbol*,
   glslang::TIntermSymbol*, glslang::TIntermediate*) */

void __thiscall
glslang::TIntermediate::mergeBlockDefinitions
          (TIntermediate *this,TInfoSink *param_1,TIntermSymbol *param_2,TIntermSymbol *param_3,
          TIntermediate *param_4)

{
  ...
  if (sVar4 == *(size_t *)(lVar19 + 0x10)) {
    if ((sVar4 == 0) ||
       (iVar15 = memcmp(*(void **)(lVar18 + 8),*(void **)(lVar19 + 8),sVar4), iVar15 == 0)) {
      if (*(code **)(*(long *)param_2 + 0xf0) == TIntermTyped::getType) {
        pTVar25 = param_2 + 0x20;
      }
      else {
      ...
      if (uVar28 == uVar16) {
        ...
        if ((((byte)TVar3 ^ (byte)pTVar25[8]) & 0x7f) == 0) {
          ...
          if (((uVar28 ^ *(uint *)(pTVar25 + 0x1c)) & 0x3f8000) == 0) {
            ...
            this_00 = *(vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>> **)
                       (pTVar25 + 0x68);
            local_250[0] = 0;
...
LAB_0010a491:
                    ...
                    p_Var17 = (_Rb_tree_node *)
                              std::
                              _Rb_tree<unsigned_int,std::pair<unsigned_int_const,unsigned_int>,std::_Select1st<std::pair<unsigned_int_const,unsigned_int>>,std::less<unsigned_int>,std::allocator<std::pair<unsigned_int_const,unsigned_int>>>
                              ::
                              _M_emplace_hint_unique<std::piecewise_construct_t_const&,std::tuple<unsigned_int_const&>,std::tuple<>>
                                        (local_258,p_Var17,&local_168);
                  }
                  else {
                    p_Var24 = local_248;
                    do {
...
LAB_0010a481:
                    if ((p_Var17 == (_Rb_tree_node *)local_250) ||
                       ((uint)local_1c8 < *(uint *)(p_Var17 + 0x20))) goto LAB_0010a491;
                  }
                  ...
                  *(int *)(p_Var17 + 0x24) = (int)((long)puVar27 - lVar21 >> 5) + -1;
                  ...
                  do {
                    ...
                    if (sVar4 == *(size_t *)(lVar21 + 0x10)) {
                      if ((sVar4 == 0) ||
                         (iVar15 = memcmp(*(void **)(lVar20 + 8),*(void **)(lVar21 + 8),sVar4),
                         iVar15 == 0)) {
...
LAB_00109ef9:
                          ...
                          do {
                            while( true ) {
                              ...
                              p_Var17 = p_Var23;
                              if (*(_Rb_tree_node **)(p_Var23 + 0x10) == (_Rb_tree_node *)0x0)
                              goto LAB_00109ee9;
                            }
...
LAB_00109ee9:
                          if ((p_Var17 == (_Rb_tree_node *)local_250) ||
                             ((uint)local_1c8 < *(uint *)(p_Var17 + 0x20))) goto LAB_00109ef9;
                        }
                        uVar22 = (ulong)(uint)local_1c8;
            ...
            local_160._0_3_ =
                 CONCAT12((byte)pTVar25[10] & 0xf | (byte)pTVar25[10] & 0x10 |
                          (byte)pTVar25[10] & 0x20 | (byte)pTVar25[10] & 0x40,(undefined2)local_160)
            ;
            ...
            local_160 = CONCAT13(local_160._3_1_ & 0xfb | (byte)pTVar25[0xb] & 4,
                                 (undefined3)local_160);
...
/* glslang::TIntermediate::mergeLinkerObjects(TInfoSink&, glslang::TVector<TIntermNode*>&,
   glslang::TVector<TIntermNode*> const&, EShLanguage) */
...

{
  ...
  local_78 = (long *)findLinkerObjects();
  ...
  if (*(long *)(param_2 + 0x80) != 0) {
    if (*(long **)(this + 0x80) == (long *)0x0) {
      ...
      *(int *)(this + 0x370) = *(int *)(this + 0x370) + *(int *)(param_2 + 0x370);
      ...
      local_1b0 = (long *)findLinkerObjects();

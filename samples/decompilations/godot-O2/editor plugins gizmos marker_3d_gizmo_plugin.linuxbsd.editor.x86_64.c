...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_00105f38;
...
LAB_00101220:
  ...
  local_b8 = CONCAT44((_UNK_00106244 - local_b8._4_4_) * _UNK_00106254 + local_b8._4_4_,
                      (__LC29 - (float)local_b8) * __LC37 + (float)local_b8);
  uStack_b0 = CONCAT44((_LC32._4_4_ - uStack_b0._4_4_) * _UNK_0010625c + uStack_b0._4_4_,
                       ((float)_LC32 - (float)uStack_b0) * _UNK_00106258 + (float)uStack_b0);
  ...
  *(undefined ***)this_01 = &PTR__initialize_classv_00105d38;
...
{
  *(undefined ***)this = &PTR__initialize_classv_00105d38;
...
LAB_00105b9c:
    ...
    lVar4 = puVar10[-1];
    if (param_1 <= lVar4) goto LAB_00105b30;
  }
  else {
    if (lVar12 != 0) {
  ...
  if (((param_1 - lVar4) * 0x10 & 0x10U) != 0) {
    *puVar7 = __LC29;
    puVar7[1] = uVar3;
    puVar6 = puVar7 + 2;
    if (puVar7 + (param_1 - lVar4) * 2 == puVar7 + 2) goto LAB_00105b30;
  }
  do {
    *puVar6 = uVar9;
    puVar6[1] = uVar3;

...
{
  *(undefined ***)this = &PTR__gen_argument_type_001075e8;
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00107648;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
LAB_00105bbc:
    ...
    lVar4 = puVar10[-1];
    if (param_1 <= lVar4) goto LAB_00105b50;
  }
  else {
    if (lVar12 != 0) {
  ...
  if (((param_1 - lVar4) * 0x10 & 0x10U) != 0) {
    *puVar7 = __LC47;
    puVar7[1] = uVar3;
    puVar6 = puVar7 + 2;
    if (puVar7 + (param_1 - lVar4) * 2 == puVar7 + 2) goto LAB_00105b50;
  }
  do {
    *puVar6 = uVar9;
    puVar6[1] = uVar3;
...
/* WARNING: Removing unreachable block (ram,0x00105e48) */
...
/* WARNING: Removing unreachable block (ram,0x00105ff2) */
/* WARNING: Removing unreachable block (ram,0x00105ffc) */
/* WARNING: Removing unreachable block (ram,0x00106080) */
/* WARNING: Removing unreachable block (ram,0x00106004) */
/* WARNING: Removing unreachable block (ram,0x0010601a) */
...

{
  ...
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00106aed. Too many branches */
...

{
  ...
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00106d05. Too many branches */
                    /* WARNING: Treating indirect jump as call */

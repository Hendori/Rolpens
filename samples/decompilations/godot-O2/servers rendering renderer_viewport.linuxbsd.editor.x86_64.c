      ...
      if (iVar22 != 0) {
        ...
        while( true ) {
          ...
          if (((*pbVar25 & 1) != 0) && (*(long *)(pbVar25 + 0x78) != 0)) {
            ...
            local_c8 = CONCAT44(*(float *)(pbVar25 + 0x84) - (float)_LC87 * fVar48,
                                *(float *)(pbVar25 + 0x80) - (float)_LC87 * fVar45);
              ...
              do {
                ...
                if ((*pbVar25 & 1) != 0) {
                  ...
                  if (0 < (int)uVar32) {
                    ...
                    local_218 = 0;
                    iVar33 = 0;
                    local_130 = (float)_LC87 * fVar45 + fVar46;
                    fStack_12c = _LC87._4_4_ * fVar48 + fVar47;
                    iVar37 = uVar32 - 1;
                    do {
                      lVar31 = (long)iVar37;
                      iVar37 = (int)lVar28;

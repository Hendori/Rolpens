...
int64_t all_badges()
{
    uint32_t rax_8 = data_14000806c - data_140008070 + data_140008055 - data_140008059 + data_14000803e - data_140008042 + data_140008010 - data_140008014 + data_140008027 - data_14000802b;
    return printf("We can open every door with badg…", data_140008083 - data_140008087 + rax_8);
}
...
int64_t __do_global_ctors()
{
    ...
    if (rcx)
    {
        ...
        do
        {
            (*i)();
            i -= 8;
        } while (i != ((rax_1 - (rcx - 1)) << 3) + 0x140007d78);
    }
...
int __pformat_wputchars(short unsigned int const* s, int count, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream)
{
    ...
    if (width > count_2)
    {
        ...
        {
            if (count_2 > 0)
                goto label_140002930;
            
            stream->width = rax_6 - 1;
            goto label_1400029d0;
        }
...
int __pformat_putchars(char const* s, int count, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream)
{
    ...
    if (width > count_3)
    {
        ...
        if (!(*flags[1] & 4))
        {
            ...
            goto label_140002a73;
        }
        
        if (!count_3)
        {
            stream->width = rax_2 - 1;
            goto label_140002af1;
        }
    }
    else
    {
...
int64_t __pformat_xint(int fmt, union value, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream, union value)
{
    ...
    if (fmt != 0x6f)
    {
        ...
        if (!(rdi & 0x1000))
        {
            ...
            goto label_140002ce1;
        }
        
        rcx = 4;
        
        if (stream_1[4])
            goto label_140002e82;
    ...
    if (rdi & 0x1000)
    {
        ...
        if (stream)
            goto label_140002d1f;
        
        goto label_140002ed6;
    }
    ...
    if (stream)
    {
        ...
        if (r15 <= 0)
            goto label_14000300c;
        
        goto label_140002d3c;
    }
    ...
    if (r15 <= 0)
    {
        ...
        if (rsi != r13 || !r15)
            goto label_140002d6a;
        
        goto label_140002f04;
    }
    ...
    if (fmt == 0x6f)
    {
        if (r15 < 0 && (rdi_1 & 0x600) == 0x200)
        {
            ...
            if (fmt == 0x6f || !(rdi_1 & 0x800))
                goto label_140002f5d;
            
            goto label_140002f52;
        }
    ...
    else
    {
        if (rdi_1 & 0x800)
        {
            ...
            *rsi = fmt;
            ...
            if (rdi_1 & 0x400)
                goto label_140003065;
            
            goto label_140002f75;
        }
...
int64_t __pformat_int(union value, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream, union value)
{
    ...
    if (stream < 0)
    {
        ...
        if (_Size_2 > 0)
        {
            ...
            if (_Size_1 <= 0)
                goto label_1400032b0;
            
            goto label_14000329a;
        }
        
        if (&var_68 - rax_3 + 0x20 == rdi_1)
            goto label_140003439;
    }
    else
    {
        r12 &= 0x7f;
        ...
        if (rsi_1 > 0)
        {
            if (!(r12 & 0x1c0))
            {
                if (_Size_2 < 0 && (r12 & 0x600) == 0x200)
                    goto label_14000347a;
                
                goto label_1400032e2;
            }
...
int __pformat_emit_float(int sign, char* value, int len, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream)
{
    ...
    if (len > 0)
    {
        ...
        if (*stream->flags[1] & 0x10 && stream->thousands_chr)
        {
            ...
            goto label_1400036d0;
        }
        
        label_14000371a:
        
        if (!sign)
            goto label_140003722;
        ...
        else
        {
            ...
            if (!sign)
            {
                ...
                if (flags & 0x1c0)
                {
                    ...
                    if (rax == 1 || *flags[1] & 6)
                        goto label_140003725;
                    
                    goto label_1400036fb;
                }
...
int64_t __pformat_emit_xfloat(union value, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream, union value)
{
    ...
    if (precision_1 <= 0xe)
    {
        ...
        if (stream_4 || stream_2)
            goto label_140004047;
        
        goto label_140003e5d;
    }
    ...
    if (cond:0 || stream_2)
    {
        ...
        do
        {
            ...
            {
                if (rax_17)
                    goto label_1400040b7;
                
                if (!precision_4)
                    goto label_14000407f;
        ...
        if (i_1 == &var_58)
        {
            if (stream_1->precision <= 0)
                goto label_140003e67;
            
            goto label_1400040f6;
        }
    }
    else
    {
                ...
                if (rax_4 - 0x20 > 0x5a)
                {
                    ...
                    switch (rax_4)
                    {
                        ...
                        case 0x41:
                        {
                            ...
                            if (rax_15 & 4)
                                goto label_1400045ad;
                            
                            goto label_140004932;
                        }
                        case 0x43:
                        {
                            stream.quota = 0xffffffff;
                        ...
                        case 0x45:
                        {
                            ...
                            if (stream.thousands_chr & 4)
                                goto label_1400046b3;
                            
                            goto label_140004a1a;
                        }
                        case 0x46:
                        {
                            rdx_11 = *argv_1;
                            ...
                            if (stream.thousands_chr & 4)
                                goto label_140004749;
                            
                            goto label_140004a52;
                        }
                        case 0x47:
                        {
                            rdx_13 = *argv_1;
                            ...
                            if (stream.thousands_chr & 4)
                                goto label_140004781;
                            
                            goto label_140004a8a;
                        }
                        case 0x49:
                        {
                            rax_4 = *(rsi_1 + 1);
        ...
        if (!rdi_2)
        {
            ...
            if (rax_7 - 1 <= 1)
            {
                ...
                if (mode_1 > 9)
                {
                    ...
                    if (be_1 < 0)
                    {
                        ...
                        if (k_7 <= 0)
                        {
                            ...
                            if (rdx_24 && fpi->emin + 1 < be)
                                goto label_14000644b;
                            
                            goto label_14000580b;
                        }
                        ...
                        if (!var_7c_1)
                        {
                            ...
                            if (i_1 <= 0 && rbp_3)
                                goto label_140005897;
                            
                            k_12 = k_11 + 1;
                            
                            if (!var_90_1)
                                goto label_140005ee4;
                            
                            goto label_140005b57;
                        }
                        
                        if (__cmp_D2A(r13_1, b_9) >= 0)
                            goto label_140005882;
                        ...
                        if (var_90_1)
                        {
                            ...
                            while (true)
                            {
                                ...
                                rdx_42 = 0x39;
                                *result_3 = 0x39;
                                goto label_140005f87;
                            }
                        }
                        else
                        {
                            if (rbp_5)
                                goto label_140006587;
                        ...
                        {
                            if (var_88_2 == 2)
                                goto label_1400061bd;
                            
                            if (*(r13_1 + 0x14) > 1 || r13_1[3])
                                goto label_140005f63;
                        }
                    ...
                    if (k_11 > fpi->int_max)
                    {
                        ...
                        if (be_1 - r12_1 >= emin || !((mode_1 - 3) & 0xfffffffd))
                            goto label_140005fa0;
                        
                        goto label_1400056c8;
                    }
                ...
                else
                {
                    ...
                    if (i_7 + 1 <= 0)
                    {
                        ...
                        if (!var_7c_1 || !(0x3ff0000000000000 > zmm0_3))
                        {
                            ...
                            if (!var_90_1)
                            {
                                ...
                                if (zmm1 > zmm2)
                                    goto label_1400055b6;
                                
                                zmm0_3 = zmm0_3 - zmm4_2;
                                
                                if (zmm0_3 <= zmm1)
                                    goto label_140005ab9;
                    ...
                    {
                        if (var_90_1)
                            goto label_140005695;
                        
                        k_5 = k;
                        e_11 = e_13;
                        r12_2 = nullptr;
                        goto label_140005736;
                    }
...
struct __Bigint* __i2b_D2A(int i)
{
    ...
    if (!pmem_next_1)
    {
        ...
        if (((pmem_next_1 - &private_mem) >> 3) + 5 <= 0x120)
        {
            ...
            if (cond:1_1)
                goto label_140006bad;
            
            goto label_140006c1f;
        }
        
        pmem_next_1 = malloc(0x28);
        
        if (pmem_next_1)
            goto label_140006c06;
    }
    else
    {
        bool cond:0_1 = dtoa_CS_init == 2;

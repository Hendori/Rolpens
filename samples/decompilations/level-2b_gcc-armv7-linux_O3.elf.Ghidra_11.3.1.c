...

{
  printf("We can open every door with badge #%d\n",
         ((uint)DAT_000210b3 - (uint)DAT_000210b7) +
         ((uint)DAT_0002109c - (uint)DAT_000210a0) +
         ((uint)DAT_00021085 - (uint)DAT_00021089) +
         ((uint)DAT_0002106e - (uint)DAT_00021072) +
         ((uint)DAT_00021040 - (uint)DAT_00021044) + ((uint)DAT_00021057 - (uint)DAT_0002105b));
  return;
}

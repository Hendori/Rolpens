...
undefined8 try_tempname_len_constprop_0(char *param_1,int param_2,undefined8 param_3,code *param_4)

{
  ...
  if ((long)param_2 + 6U <= sVar3) {
    ...
    sVar3 = strspn(param_1 + lVar4 + -6,"X");
    if (5 < sVar3) {
      local_70 = 0x3a2f8;
      iVar8 = 0;
      do {
        uVar7 = unaff_R12;
        pcVar10 = param_1 + lVar4 + -6;
        do {
          if (iVar8 == 0) {
            do {
              uVar7 = local_60;
              ...
              if (lVar5 != 8) {
                ...
                uVar7 = (uVar7 * 0x27bb2ee687b0b0fd + 0xb504f32d ^ local_58.tv_sec) *
                        0x27bb2ee687b0b0fd + 0xb504f32d ^ local_58.tv_nsec;
                local_60 = clock();
                local_60 = uVar7 * 0x27bb2ee687b0b0fd + 0xb504f32d ^ local_60;
                break;
              }
          ...
          pcVar9 = pcVar10 + 1;
          unaff_R12 = uVar7 / 0x3e;
          *pcVar10 = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789"[uVar7 % 0x3e];
          uVar7 = unaff_R12;
          pcVar10 = pcVar9;
        } while (pcVar9 != param_1 + lVar4);
...

{
  ...
  local_10 = *(long *)(in_FS_OFFSET + 0x28);
  local_14 = param_3;
  try_tempname_len_constprop_0
            (param_1,param_2,&local_14,*(undefined8 *)(tryfunc_0 + (long)param_4 * 8));
  if (local_10 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
                    /* WARNING: Subroutine does not return */

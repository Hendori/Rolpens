...

{
  ...
  bVar13 = false;
  do {
    while ((bVar8 != 0x2c && (ppuVar4 = __ctype_b_loc(), ((*ppuVar4)[bVar8] & 1) == 0))) {
      if (bVar8 == 0x2f) {
        if (bVar13) {
          bVar12 = false;
          uVar5 = quote(param_1);
          uVar7 = dcgettext(0,"\'/\' specifier not at start of number: %s",5);
        ...
        uVar9 = (int)(char)bVar8 - 0x30;
        if (9 < uVar9) {
          uVar5 = quote(param_1);
          uVar7 = dcgettext(0,"tab size contains invalid character(s): %s",5);
          error(0,0,uVar7,uVar5);
          goto LAB_001002bf;
        }
        if (!bVar13) {
        ...
        auVar1 = SEXT816(lVar10);
        lVar10 = lVar10 * 10;
        if ((SEXT816(lVar10) != auVar1 * SEXT816(10)) ||
           (bVar13 = SCARRY8((long)(int)uVar9,lVar10), lVar10 = (int)uVar9 + lVar10, bVar13)) {
          sVar6 = strspn((char *)local_48,"0123456789");
          __ptr = (void *)ximemdup0(local_48,sVar6);
          uVar5 = quote(__ptr);
          uVar7 = dcgettext(0,"tab stop is too large %s",5);
          error(0,0,uVar7,uVar5);
          free(__ptr);
          bVar3 = false;
          bVar2 = false;
...
LAB_00100168:
    ...
    if (increment_size != 0) goto LAB_00100334;
    bVar2 = false;
    bVar13 = false;
    bVar8 = param_1[1];
    param_1 = param_1 + 1;
    increment_size = lVar10;
  } while (bVar8 != 0);
LAB_001001c0:
  if (bVar2) {
    if (bVar11) {
...
LAB_001003d7:
      uVar5 = dcgettext(0,"\'/\' specifier only allowed with the last value",5);
      error(0,0,uVar5);
      extend_size = lVar10;
    }
    else {

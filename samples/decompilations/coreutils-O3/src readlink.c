...

{
  ...
  puVar6 = &switchD_00100b4d::switchdataD_00100e58;
      ...
      if (_optind < param_1) {
        ...
        if (iVar8 == -1) {
          do {
            ...
            __s = (char *)areadlink_with_size(uVar3,0x3f);
            if (__s == (char *)0x0) {
              if (verbose != '\0') {
          ...
          do {
            ...
            __s_00 = (undefined1 *)canonicalize_filename_mode(puVar6,iVar8);
            if (__s_00 == (char *)0x0) {
              if (verbose != '\0') {
LAB_00100dc9:

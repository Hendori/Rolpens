...

{
  ...
  if (param_2 == '\0') {
    ...
    if (cVar5 != '\x02') goto LAB_001004c4;
LAB_00100460:
    if ((param_1 & 0x49) == 0) goto LAB_00100503;
    uVar2 = uVar2 | 0x49;
    if (uVar7 == 0) goto LAB_0010050c;
LAB_00100480:
    cVar5 = *param_4;
    uVar2 = uVar2 & uVar7;
    if (cVar5 == '-') goto LAB_00100638;
    if (cVar5 == '=') {
      uVar8 = ~uVar7;
      goto LAB_0010052a;
    }
LAB_0010049a:
    ...
    while (cVar5 = param_4[0x11], pcVar1 = param_4, cVar5 != '\0') {
      while( true ) {
        param_4 = pcVar1 + 0x10;
        uVar7 = *(uint *)(pcVar1 + 0x14);
        uVar2 = *(uint *)(pcVar1 + 0x18);
        if (cVar5 == '\x02') goto LAB_00100460;
LAB_001004c4:
        if (cVar5 == '\x03') {
          uVar2 = uVar2 & param_1;
          uVar8 = (-(uint)((uVar2 & 0x124) == 0) & 0xfffffedc) + 0x1b6;
          if ((uVar2 & 0x92) == 0) {
            uVar8 = -(uint)((uVar2 & 0x124) != 0) & 0x124;
          }
          if ((uVar2 & 0x49) != 0) {
            uVar8 = uVar8 | 0x49;
          }
...
LAB_00100503:
        if (uVar7 != 0) goto LAB_00100480;
LAB_0010050c:
        cVar5 = *param_4;
        uVar2 = uVar2 & ~param_3;
        if (cVar5 == '-') break;
        if (cVar5 != '=') goto LAB_0010049a;
        uVar8 = uVar7;
        uVar7 = 0xffffffff;
LAB_0010052a:
        cVar5 = param_4[0x11];
        param_1 = uVar2 | uVar8 & param_1;
        uVar6 = uVar6 | uVar7 & 0xfff;
        pcVar1 = param_4;
        if (cVar5 == '\0') goto LAB_00100550;
      }
LAB_00100638:
      uVar6 = uVar6 | uVar2;
      param_1 = param_1 & ~uVar2;
    ...
    do {
      uVar7 = *(uint *)(param_4 + 4);
      uVar2 = *(uint *)(param_4 + 8);
      uVar4 = *(uint *)(param_4 + 0xc) | 0xfffff3ff;
      uVar8 = ~*(uint *)(param_4 + 0xc) & 0xc00;
      if (cVar5 == '\x02') {
        uVar3 = (uVar2 | 0x49) & uVar4;
      }
      else {
        uVar3 = uVar4 & uVar2;
        if (cVar5 == '\x03') {
          uVar2 = uVar2 & param_1;
          uVar3 = -(uint)((uVar2 & 0x124) != 0) & 0x124;
          if ((uVar2 & 0x92) != 0) {
            uVar3 = (-(uint)((uVar2 & 0x124) == 0) & 0xfffffedc) + 0x1b6;
          }
          if ((uVar2 & 0x49) != 0) {
            uVar3 = uVar3 | 0x49;
          }
...
LAB_00100648:
          ...
          if (cVar5 != '=') goto LAB_00100579;
LAB_0010061d:
          param_1 = uVar8 & param_1 | uVar3;
          uVar6 = uVar6 | uVar4 & 0xfff;
        }
      }
      else {
        cVar5 = *param_4;
        uVar3 = uVar3 & uVar7;
        if (cVar5 == '-') goto LAB_00100648;
        if (cVar5 == '=') {
          uVar8 = uVar8 | ~uVar7;
          uVar4 = ~uVar8;
          goto LAB_0010061d;

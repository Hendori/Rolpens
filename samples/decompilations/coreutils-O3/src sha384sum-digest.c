  ...
  while( true ) {
    ...
    if (iVar4 < 0x62) {
      if (iVar4 == -0x83) {
        ...
        version_etc(_stdout,"sha384sum","GNU coreutils",_Version,uVar7,uVar6,uVar14,0);
                    /* WARNING: Subroutine does not return */
        exit(0);
      }
      if (iVar4 == -0x82) {
...
LAB_0010179f:
                ...
                if (local_a3 != 0) goto LAB_00101834;
              }
              ...
              print_filename(__stream,local_a8);
            }
            else {
...
LAB_00101834:
            ...
            do {
              ...
              pFVar29 = pFVar15;
              if (local_100 <= pFVar15) goto LAB_001018b2;
              __stream = *(char **)pFVar15;
              puVar27 = (uint *)((ulong)pFVar12 & 0xffffffff);
LAB_0010175c:
              pFVar12 = (FILE *)digest_file_isra_0(__stream,param_2,local_108);
...
joined_r0x0010188b:
    ...
    if (local_a3 == 0) goto LAB_00101871;
  }
LAB_00101891:
...
LAB_0010201e:
      bVar24 = (byte)pFVar23;
      if ((ignore_missing != '\0') && (local_89 != '\0')) goto LAB_00101ca2;
      if (digest_hex_bytes == local_c8) {
        uVar25 = (ulong)local_c8 >> 1;
        if (uVar25 != 0) {
          uVar18 = 0;
          do {
            ...
            if ((int)(char)bin2hex_0[*(byte *)(local_e0 + uVar18) >> 4] != uVar5) {
LAB_00102168:
            ...
            if ((int)(char)bin2hex_0[*(byte *)(local_e0 + uVar18) & 0xf] != uVar5)
            goto LAB_00102168;
            uVar18 = uVar18 + 1;
          } while (uVar25 != uVar18);
        }
        local_a2 = status_only;
        if ((status_only != 0) || (local_a2 = quiet, quiet != 0)) goto LAB_00101ca2;
        local_a2 = bVar24;
        if ((int)pFVar29 != 0) goto LAB_001021a5;
        local_f8 = (FILE *)((ulong)pFVar23 & 0xff);
...
LAB_00101ceb:
          if (-1 < iVar4) {
            pFVar16 = (FILE *)quotearg_n_style_colon(0,3,local_e8);
            puVar19 = &_LC4;
            if (iVar4 == 0) goto LAB_00102479;
            goto LAB_0010243f;
          }
          if (bVar24 == 0) {
            pFVar17 = (FILE *)quotearg_n_style_colon(0,3,local_e8);
...
LAB_00101d43:
              if (local_d0 == (FILE *)0x0 && local_d8 == (FILE *)0x0) {
                bVar24 = strict ^ 1 | local_b8 == (FILE *)0x0;
                goto LAB_00101d67;
              }
            }
            else {
LAB_00101d8d:
              if (local_a2 != 0) goto LAB_00101d43;
            }
            bVar24 = 0;
          }
LAB_00101d67:
...
LAB_0010243f:
        ...
        while( true ) {
          ...
          local_e8 = *(FILE **)pFVar15;
LAB_0010190c:
          local_e0 = local_b0 & 0xfffffffffffffff8;
          local_a8 = strcmp((char *)local_e8,"-");
          if (local_a8 == 0) break;
        ...
        while (pFVar17 = (FILE *)__stream,
          ...
          *(undefined1 *)((long)local_88 + (long)pFVar29) = 0;
          ...
          if ((cVar3 == '\t') || (cVar3 == ' ')) {
            ...
            do {
              do {
                ...
                cVar3 = *(char *)((long)&((FILE *)puVar27)->_flags + (long)&local_88->_flags);
              } while (cVar3 == ' ');
            } while (cVar3 == '\t');
            pFVar15 = (FILE *)((long)&((FILE *)puVar27)->_flags + (long)&local_88->_flags);
          }
          else {
            puVar27 = (uint *)0x0;
            pFVar15 = local_88;
          ...
          if (cVar3 == '\\') {
            puVar27 = (uint *)((long)&((FILE *)puVar27)->_flags + 1);
            pFVar15 = (FILE *)((long)&((FILE *)puVar27)->_flags + (long)&local_88->_flags);
            local_f8 = (FILE *)(ulong)local_a3;
          }
          iVar4 = strncmp((char *)pFVar15,"SHA384",6);
            ...
            if (pFVar29 != (FILE *)0x0) {
              ...
              if ((*pcVar26 == ')') &&
                 ((bVar30 = (byte)local_f8 == '\0', bVar30 ||
                  (lVar9 = filename_unescape(pFVar17,pcVar21), local_f8 = pFVar17, lVar9 != 0)))) {
                *pcVar26 = '\0';
...
LAB_00101aa8:
          if (warn != '\0') {
            pFVar15 = (FILE *)quotearg_n_style_colon(0,3,local_e8);
...
LAB_00101acf:
          ...
          pFVar16 = (FILE *)puVar20;
          if (pFVar12 == (FILE *)0x0) {
            pFVar12 = (FILE *)quotearg_n_style_colon(0,3,local_e8);
...
LAB_0010223c:
                    ...
                    if (((local_a8 != 0) || ((char)pFVar17->_flags != '-')) ||
                      ...
                      uVar5 = digest_file_isra_0(pFVar17,local_e0,&local_89);

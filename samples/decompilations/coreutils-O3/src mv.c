  ...
  if (iVar6 == -1) {
    ...
    if ((int)(uint)(lVar7 == 0) < (int)uVar13) {
      ...
      if (bVar17) {
        ...
        if ((int)uVar13 < 3) goto LAB_00101b4c;
      }
      else {
        if (lVar7 == 0) {
          lVar7 = local_150[(long)(int)uVar13 + -1];
          iVar6 = local_f0;
          if (uVar13 == 2) goto LAB_00101c08;
          goto LAB_00101b87;
        }
        local_158 = target_directory_operand(lVar7,local_d8);
        if (local_158 != -1) goto LAB_001019c2;
        uVar12 = quotearg_style(4,lVar7);
        uVar9 = dcgettext(0,"target directory %s",5);
        piVar10 = __errno_location();
        error(1,*piVar10,uVar9,uVar12);
      }
      uVar12 = quotearg_style(4,local_150[2]);
    ...
    uVar11 = quotearg_style(4,*local_150);
...
LAB_00101c08:
  iVar6 = local_f0;
  if ((local_11e == '\0') &&
     (iVar6 = renameatu(0xffffff9c,*local_150,0xffffff9c,lVar7,1), iVar6 != 0)) {
    piVar10 = __errno_location();
    iVar6 = *piVar10;
  }
LAB_00101b87:
...
LAB_001019c9:
      ...
      } while (puVar16 != local_150 + (int)uVar11);
    }
  }
  else {
    local_158 = target_directory_operand(lVar7,local_d8);
...
LAB_00101c94:
      piVar10 = __errno_location();
      iVar6 = *piVar10;
      if ((int)uVar11 < 3) goto LAB_00101b4c;
      uVar12 = quotearg_style(4,lVar7);
    ...
    uVar13 = (int)uVar11 - 1;
    uVar11 = (ulong)uVar13;
    if ((bVar1) && (uVar13 != 0)) goto LAB_001019c9;
  }
  ...
  uVar12 = 5;
  if ((local_11e == '\0') && (1 < local_fc - 2U)) goto code_r0x00101a2b;
LAB_00101d04:
...
code_r0x00101a2b:
  ...
  local_138 = xget_version(uVar12,local_168);
LAB_00101a46:
  set_simple_backup_suffix(local_160);
  hash_init();
  if (lVar7 == 0) {
    local_f3 = 1;
    bVar5 = do_move(*local_150,local_150[1],0xffffff9c,local_150[1],&local_138);
  }
  else {
    iVar6 = (int)uVar11;
    if (iVar6 < 2) {

...
LAB_00100148:
  ...
  pbVar12 = delims;
  if (__stream_00 == (_IO_FILE *)0x0) goto LAB_00100287;
LAB_00100178:
...
LAB_001001e9:
  do {
    while( true ) {
      if (line_delim == uVar7) {
        if (uVar17 != uVar15) goto LAB_00100240;
        goto LAB_001002bd;
      }
...
LAB_00100240:
        ...
        bVar4 = true;
        uVar18 = uVar17;
        if (delim_end == pbVar12) goto LAB_001002ac;
        while( true ) {
          uVar17 = uVar18 + 1;
          if (uVar15 <= uVar18 || uVar16 == 0) goto LAB_0010033f;

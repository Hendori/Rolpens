...
{
    printf(&data_14000a017, 0);
    printf(&data_14000a017, 1);
    printf(&data_14000a017, 2);
    printf(&data_14000a029, 3);
    printf(&data_14000a017, 4);
    printf(&data_14000a017, 5);
    printf(&data_14000a017, 6);
    printf(&data_14000a029, 7);
    printf(&data_14000a017, 8);
    printf(&data_14000a017, 9);
    printf(&data_14000a017, 0xa);
    printf(&data_14000a029, 0xb);
    printf(&data_14000a017, 0xc);
    printf(&data_14000a017, 0xd);
    printf(&data_14000a017, 0xe);
    printf(&data_14000a029, 0xf);
    printf(&data_14000a017, 0x10);
    printf(&data_14000a017, 0x11);
    printf(&data_14000a017, 0x12);
...
int64_t __do_global_ctors()
{
    ...
    if (rcx)
    {
        ...
        do
        {
            (*i)();
            i -= 8;
        } while (i != ((rax_1 - (rcx - 1)) << 3) + 0x1400082c8);
    }
...
int __pformat_wputchars(short unsigned int const* s, int count, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream)
{
    ...
    if (width > count_2)
    {
        ...
        {
            if (count_2 > 0)
                goto label_140002e80;
            
            stream->width = rax_6 - 1;
            goto label_140002f20;
        }
...
int __pformat_putchars(char const* s, int count, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream)
{
    ...
    if (width > count_3)
    {
        ...
        if (!(*flags[1] & 4))
        {
            ...
            goto label_140002fc3;
        }
        
        if (!count_3)
        {
            stream->width = rax_2 - 1;
            goto label_140003041;
        }
    }
    else
    {
...
int64_t __pformat_xint(int fmt, union value, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream, union value)
{
    ...
    if (fmt != 0x6f)
    {
        ...
        if (!(rdi & 0x1000))
        {
            ...
            goto label_140003231;
        }
        
        rcx = 4;
        
        if (stream_1[4])
            goto label_1400033d2;
    ...
    if (rdi & 0x1000)
    {
        ...
        if (stream)
            goto label_14000326f;
        
        goto label_140003426;
    }
    ...
    if (stream)
    {
        ...
        if (r15 <= 0)
            goto label_14000355c;
        
        goto label_14000328c;
    }
    ...
    if (r15 <= 0)
    {
        ...
        if (rsi != r13 || !r15)
            goto label_1400032ba;
        
        goto label_140003454;
    }
    ...
    if (rsi != r13)
    {
        ...
        if (i < r12)
            goto label_140003470;
        
        goto label_1400032c6;
    }
    ...
    if (fmt == 0x6f)
    {
        if (r15 < 0 && (rdi_1 & 0x600) == 0x200)
        {
            ...
            if (fmt == 0x6f || !(rdi_1 & 0x800))
                goto label_1400034ad;
            
            goto label_1400034a2;
        }
    ...
    else
    {
        if (rdi_1 & 0x800)
        {
            ...
            *rsi = fmt;
            ...
            if (rdi_1 & 0x400)
                goto label_1400035b5;
            
            goto label_1400034c5;
        }
...
int64_t __pformat_int(union value, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream, union value)
{
    ...
    if (stream < 0)
    {
        ...
        if (_Size_2 > 0)
        {
            ...
            if (_Size_1 <= 0)
                goto label_140003800;
            
            goto label_1400037ea;
        }
        
        if (&var_68 - rax_3 + 0x20 == rdi_1)
            goto label_140003989;
    }
    else
    {
        r12 &= 0x7f;
        ...
        if (rsi_1 > 0)
        {
            if (!(r12 & 0x1c0))
            {
                if (_Size_2 < 0 && (r12 & 0x600) == 0x200)
                    goto label_1400039ca;
                
                goto label_140003832;
            }
...
int __pformat_emit_float(int sign, char* value, int len, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream)
{
    ...
    if (len > 0)
    {
        ...
        if (*stream->flags[1] & 0x10 && stream->thousands_chr)
        {
            ...
            goto label_140003c20;
        }
        
        label_140003c6a:
        
        if (!sign)
            goto label_140003c72;
        ...
        else
        {
            ...
            if (!sign)
            {
                ...
                if (flags & 0x1c0)
                {
                    ...
                    if (rax == 1 || *flags[1] & 6)
                        goto label_140003c75;
                    
                    goto label_140003c4b;
                }
...
int64_t __pformat_emit_xfloat(union value, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream, union value)
{
    ...
    if (precision_1 <= 0xe)
    {
        ...
        if (stream_4 || stream_2)
            goto label_140004597;
        
        goto label_1400043ad;
    }
    ...
    if (cond:0 || stream_2)
    {
        ...
        do
        {
            ...
            {
                if (rax_17)
                    goto label_140004607;
                
                if (!precision_4)
                    goto label_1400045cf;
        ...
        if (i_1 == &var_58)
        {
            if (stream_1->precision <= 0)
                goto label_1400043b7;
            
            goto label_140004646;
        }
    }
    else
    {
                ...
                if (rax_4 - 0x20 > 0x5a)
                {
                    ...
                    switch (rax_4)
                    {
                        ...
                        case 0x30:
                        {
                            ...
                            {
                                if (r14_1 > 3)
                                    goto label_1400050e5;
                                
                                rcx = 0x30;
                                label_14000508a:
                                
                                if (r14_1 != 2)
                                    goto label_14000490c;
                        ...
                        case 0x41:
                        {
                            ...
                            if (rax_15 & 4)
                                goto label_140004afd;
                            
                            goto label_140004e82;
                        }
                        case 0x43:
                        {
                            stream.quota = 0xffffffff;
                        ...
                        case 0x45:
                        {
                            ...
                            if (stream.thousands_chr & 4)
                                goto label_140004c03;
                            
                            goto label_140004f6a;
                        }
                        case 0x46:
                        {
                            rdx_11 = *argv_1;
                            ...
                            if (stream.thousands_chr & 4)
                                goto label_140004c99;
                            
                            goto label_140004fa2;
                        }
                        case 0x47:
                        {
                            rdx_13 = *argv_1;
                            ...
                            if (stream.thousands_chr & 4)
                                goto label_140004cd1;
                            
                            goto label_140004fda;
                        }
                        case 0x49:
                        {
                            rax_4 = *(rsi_1 + 1);
        ...
        if (!rdi_2)
        {
            ...
            if (rax_7 - 1 <= 1)
            {
                ...
                if (mode_1 > 9)
                {
                    ...
                    if (be_1 < 0)
                    {
                        ...
                        if (k_7 <= 0)
                        {
                            ...
                            if (rdx_24 && fpi->emin + 1 < be)
                                goto label_14000699b;
                            
                            goto label_140005d5b;
                        }
                        ...
                        if (!var_7c_1)
                        {
                            ...
                            if (i_1 <= 0 && rbp_3)
                                goto label_140005de7;
                            
                            k_12 = k_11 + 1;
                            
                            if (!var_90_1)
                                goto label_140006434;
                            
                            goto label_1400060a7;
                        }
                        
                        if (__cmp_D2A(r13_1, b_9) >= 0)
                            goto label_140005dd2;
                        ...
                        if (var_90_1)
                        {
                            ...
                            while (true)
                            {
                                ...
                                rdx_42 = 0x39;
                                *result_3 = 0x39;
                                goto label_1400064d7;
                            }
                        }
                        else
                        {
                            if (rbp_5)
                                goto label_140006ad7;
                        ...
                        {
                            if (var_88_2 == 2)
                                goto label_14000670d;
                            
                            if (*(r13_1 + 0x14) > 1 || r13_1[3])
                                goto label_1400064b3;
                        }
                    ...
                    if (k_11 > fpi->int_max)
                    {
                        ...
                        if (be_1 - r12_1 >= emin || !((mode_1 - 3) & 0xfffffffd))
                            goto label_1400064f0;
                        
                        goto label_140005c18;
                    }
                ...
                else
                {
                    ...
                    if (i_7 + 1 <= 0)
                    {
                        ...
                        if (!var_7c_1 || !(0x3ff0000000000000 > zmm0_3))
                        {
                            ...
                            if (!var_90_1)
                            {
                                ...
                                if (zmm1 > zmm2)
                                    goto label_140005b06;
                                
                                zmm0_3 = zmm0_3 - zmm4_2;
                                
                                if (zmm0_3 <= zmm1)
                                    goto label_140006009;
                    ...
                    {
                        if (var_90_1)
                            goto label_140005be5;
                        
                        k_5 = k;
                        e_11 = e_13;
                        r12_2 = nullptr;
                        goto label_140005c86;
                    }
...
struct __Bigint* __i2b_D2A(int i)
{
    ...
    if (!pmem_next_1)
    {
        ...
        if (((pmem_next_1 - &private_mem) >> 3) + 5 <= 0x120)
        {
            ...
            if (cond:1_1)
                goto label_1400070fd;
            
            goto label_14000716f;
        }
        
        pmem_next_1 = malloc(0x28);
        
        if (pmem_next_1)
            goto label_140007156;
    }
    else
    {
        bool cond:0_1 = dtoa_CS_init == 2;

...
LAB_00101862:
    ...
    if (((local_48 == (ENGINE **)0x0) && (local_40[0] != (ENGINE *)0x0)) &&
...
LAB_00101d6c:
    ...
    {
      if (((pkey->type == 0) || (pkey->save_type != 0)) || (*(long *)&pkey->references == 0))
      goto LAB_00101caa;
    }
    else {
...
LAB_00101caa:
      ...
      if ((str == (char *)0x0) ||
         (pEVar2 = EVP_PKEY_asn1_find_str(&local_28,str,len), pEVar2 == (EVP_PKEY_ASN1_METHOD *)0x0)
         ) goto LAB_00101d6c;
      iVar1 = *(int *)pEVar2;
...
LAB_00101e6e:
    ...
    if (((pkey->pkey).ptr == (char *)0x0) && (pkey[1].attributes == (stack_st_X509_ATTRIBUTE *)0x0))
    {
      if ((pkey->type == 0) || ((type != pkey->save_type || (*(long *)&pkey->references == 0))))
      goto LAB_00101e44;
    }
    else {
      evp_keymgmt_util_clear_operation_cache(pkey);
...
LAB_00101e44:
      ...
      pkey->engine = (ENGINE *)0x0;
      if ((type == 0) ||
         (pEVar2 = EVP_PKEY_asn1_find(&local_28,type), pEVar2 == (EVP_PKEY_ASN1_METHOD *)0x0))
      goto LAB_00101e6e;
      *(undefined8 *)&pkey[1].save_parameters = 0;
...
EVP_PKEY *
EVP_PKEY_new_raw_public_key(int param_1,long param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  if (param_2 == 0) {
    local_90 = (ENGINE *)0x0;
    if ((param_1 == 0) ||
       (pEVar4 = EVP_PKEY_asn1_find(&local_90,param_1), local_90 == (ENGINE *)0x0)) {
      ENGINE_finish((ENGINE *)0x0);
    }
    else {
...
EVP_PKEY_new_raw_private_key_ex
          (undefined8 param_1,char *param_2,undefined8 param_3,undefined8 param_4,undefined8 param_5
          )
...
EVP_PKEY *
EVP_PKEY_new_raw_private_key(int param_1,long param_2,undefined8 param_3,undefined8 param_4)
...
LAB_001035a8:
          if ((*(long *)(local_48 + 0xc0) == 0) ||
             (lVar3 = evp_pkey_export_to_provider(param_1,0,&local_48,0), lVar6 = local_50,
             lVar3 == 0)) {
LAB_00103620:
            lVar3 = lVar2;
...
LAB_00103409:
          if ((*(long *)(lVar6 + 0xc0) == 0) ||
             (lVar2 = evp_pkey_export_to_provider(param_2,0,&local_50,0), lVar6 = local_50,
             lVar2 == 0)) {
...
LAB_001036d7:
      if ((*(long *)(local_38 + 0xc0) != 0) &&
         (lVar2 = evp_pkey_export_to_provider(param_1,0,&local_38,0), lVar6 = local_40, lVar2 != 0))
      {
        bVar8 = false;
        local_40 = local_38;
        lVar6 = local_38;
...
LAB_00103713:
      if ((lVar6 == 0) || (bVar8)) goto LAB_00103869;
    ...
    if ((local_68 != 0x69662d656d697270) || (uVar2 = 0x196, local_60 != 0x646c65)) {
      if ((local_68 == 0x6574636172616863 && CONCAT44(uStack_5c,local_60) == 0x742d636974736972) &&
         (CONCAT17(uStack_58,CONCAT43(uStack_5c,local_60._1_3_)) == 0x77742d6369747369 &&
          local_57 == 0x646c6569662d6f)) goto LAB_0010533a;
      uVar2 = 0x197;
    }
  }
  if (local_10 == *(long *)(in_FS_OFFSET + 0x28)) {

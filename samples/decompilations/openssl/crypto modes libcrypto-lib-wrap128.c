...

{
  ...
  if ((param_5 & 7) == 0) {
    if (param_5 - 0x18 < 0x7ffffff1) {
      ...
      local_90 = (__n >> 3) * 6;
      do {
        uVar5 = local_90 - (param_5 - 9 >> 3);
        lVar1 = (param_5 - 0x10) + local_90 * -8;
        do {
          uVar3 = local_58;
          bVar2 = local_58._7_1_ ^ (byte)local_90;
          local_58 = CONCAT17(bVar2,(undefined7)local_58);
          if (0xff < local_90) {
            local_58._4_2_ = SUB82(uVar3,4);
            local_58._6_1_ = SUB81(uVar3,6);
            local_58._4_2_ =
                 local_58._4_2_ ^ CONCAT11((char)(local_90 >> 0x10),(char)(local_90 >> 0x18));
            local_58._0_4_ = (undefined4)uVar3;
            local_58 = CONCAT26(CONCAT11(bVar2,local_58._6_1_ ^ (byte)(local_90 >> 8)),
                                CONCAT24(local_58._4_2_,(undefined4)local_58));
          }
          local_50 = *(undefined8 *)((long)pvVar4 + local_90 * 8 + lVar1);
          (*param_6)(&local_58,&local_58,param_1);
          *(undefined8 *)((long)pvVar4 + local_90 * 8 + lVar1) = local_50;
          bVar6 = uVar5 != local_90;
          local_90 = local_90 - 1;
        } while (bVar6);
        local_78 = local_78 + -1;
        local_90 = uVar5 - 1;
      ...
      do {
        ...
        do {
          while( true ) {
            ...
            uVar5 = uVar5 + 1;
            if (uVar5 == uVar4) goto joined_r0x00100345;
          }
          param_3[(uVar5 + 1) - uVar3] = local_50;
          uVar5 = uVar5 + 1;
        } while (uVar4 != uVar5);
...
joined_r0x00100659:
      ...
      if (iVar1 == 0) {
        ...
        if ((((param_5 & 0xfffffffffffffff8) - 0x10 < uVar2) &&
           ...
           iVar1 == 0)) goto LAB_00100615;
      }
    }
    else {
      lVar3 = crypto_128_unwrap_raw(param_1,&local_50);
      if (param_5 - 8 == lVar3) goto joined_r0x00100659;
    }

...

{
  ...
  if (((a_00 == (BIGNUM *)0x0) || (r == (BIGNUM *)0x0)) ||
     ((local_60 = param_2, param_2 == (BN_CTX *)0x0 &&
      (local_60 = (BN_CTX *)BN_CTX_new_ex(0), local_60 == (BN_CTX *)0x0)))) {
    local_60 = (BN_CTX *)0x0;
  }
  else {
    ...
    if (0x7f < iVar2) {
      ...
      if ((lVar5 != 0) && (lVar5 = bn_wexpand(r,uVar4), lVar5 != 0)) {
        if (param_5 == 0) {
          do {
            iVar3 = ossl_bn_priv_rand_range_fixed_top
                              (a_00,*(undefined8 *)(param_1 + 0x10),0,local_60);
        ...
        if (((((*(byte *)(param_1 + 0x78) & 1) == 0) ||
             (pBVar6 = BN_MONT_CTX_set_locked
                                 ((BN_MONT_CTX **)(param_1 + 0x80),
                                  ...
                                  local_60), pBVar6 != (BN_MONT_CTX *)0x0)) &&
          ...
          if (pcVar1 == (code *)0x0) {
            iVar2 = BN_mod_exp_mont(param_4,*(BIGNUM **)(param_1 + 0x18),a_00,
                                    *(BIGNUM **)(param_1 + 8),local_60,
                                    *(BN_MONT_CTX **)(param_1 + 0x80));
          }
          else {
            iVar2 = (*pcVar1)(param_1,param_4,*(undefined8 *)(param_1 + 0x18),a_00,
                              *(undefined8 *)(param_1 + 8),local_60,*(undefined8 *)(param_1 + 0x80),
                              uVar7);
          }
          if ((iVar2 != 0) &&
             (iVar2 = BN_div((BIGNUM *)0x0,param_4,param_4,*(BIGNUM **)(param_1 + 0x10),local_60),
             iVar2 != 0)) {
            a = *(BIGNUM **)(param_1 + 0x10);
            a_01 = BN_new();
            if (a_01 != (BIGNUM *)0x0) {
              BN_CTX_start(local_60);
              r_00 = BN_CTX_get(local_60);
              if (((r_00 != (BIGNUM *)0x0) && (iVar2 = BN_set_word(a_01,2), iVar2 != 0)) &&
                 ((iVar2 = BN_sub(r_00,a,a_01), iVar2 != 0 &&
                  (iVar2 = BN_mod_exp_mont(a_01,a_00,r_00,a,local_60,(BN_MONT_CTX *)0x0), iVar2 != 0
                  )))) {
                uVar8 = 1;
                BN_CTX_end(local_60);
...
LAB_00100c06:
            ...
            if (pBVar3 == (BIGNUM *)0x0) goto LAB_00100c06;
            do {
              iVar1 = BN_num_bits(*(BIGNUM **)(param_3 + 0x10));
            ...
            if ((iVar1 == 0) && (iVar1 = BN_is_zero(a->s), iVar1 == 0)) goto LAB_00100c59;
            local_54 = local_54 + -1;
          } while (local_54 != 0);
          uVar5 = 0x74;
        }

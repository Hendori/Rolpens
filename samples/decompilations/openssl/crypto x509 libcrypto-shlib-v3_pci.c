...

{
  ...
  if (iVar6 == 0) {
    if (*param_2 == 0) {
      ...
      *param_2 = (long)pAVar8;
      if (pAVar8 != (ASN1_OBJECT *)0x0) goto LAB_00100218;
      ERR_new();
...
LAB_00100568:
          ...
          BIO_free_all(b);
          if (pvVar7 != (void *)0x0) goto LAB_00100218;
        }
      }
      else {
        ...
        if (iVar6 == 0) {
          ...
          pvVar7 = CRYPTO_realloc(pAVar10->data,(int)local_850 + 1 + pAVar10->length,
                                  "crypto/x509/v3_pci.c",0xc6);
          if (pvVar7 == (void *)0x0) {
            pvVar7 = *(void **)(*param_4 + 8);
            goto LAB_00100511;
          }

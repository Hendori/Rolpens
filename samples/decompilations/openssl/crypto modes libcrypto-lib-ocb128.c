...

{
  ...
  if (uVar10 < param_2) {
    ...
    while( true ) {
      ...
      bVar8 = pcVar1[0xb];
      bVar9 = pcVar1[8];
      *(undefined8 *)((long)local_60 + lVar12) =
           CONCAT71(CONCAT61(CONCAT51(CONCAT41(CONCAT31(CONCAT21(CONCAT11(pcVar1[7] * '\x02' |
                                                                          bVar9 >> 7,
                                                                          pcVar1[6] * '\x02' |
                                                                          (byte)pcVar1[7] >> 7),
                                                                 pcVar1[5] * '\x02' |
                                                                 (byte)pcVar1[6] >> 7),
                                                        (byte)pcVar1[5] >> 7 | pcVar1[4] * '\x02'),
                                               (byte)pcVar1[4] >> 7 | pcVar1[3] * '\x02'),
                                      (byte)pcVar1[3] >> 7 | pcVar1[2] * '\x02'),
                             (byte)pcVar1[2] >> 7 | pcVar1[1] * '\x02'),
                    (byte)pcVar1[1] >> 7 | *pcVar1 * '\x02');
      ((undefined8 *)((long)local_60 + lVar12))[1] =
           CONCAT71(CONCAT61(CONCAT51(CONCAT41(CONCAT31(CONCAT21(CONCAT11(bVar2 * '\x02' ^
                                                                          *pcVar1 >> 7 & 0x87U,
                                                                          bVar3 * '\x02' |
                                                                          bVar2 >> 7),
                                                                 bVar3 >> 7 | bVar4 * '\x02'),
                                                        bVar5 * '\x02' | bVar4 >> 7),
                                               bVar8 * '\x02' | bVar5 >> 7),
                                      bVar6 * '\x02' | bVar8 >> 7),bVar7 * '\x02' | bVar6 >> 7),
                    bVar7 >> 7 | bVar9 * '\x02');
      lVar12 = lVar12 + 0x10;
...
bool CRYPTO_ocb128_init(undefined8 *param_1,undefined8 param_2,undefined8 param_3,code *param_4,
  ...
  *param_1 = 0;
  ...
  if (pvVar6 != (void *)0x0) {
    ...
    *(byte *)((long)param_1 + 0x56) =
         *(byte *)((long)param_1 + 0x47) >> 7 | *(byte *)((long)param_1 + 0x46) * '\x02';
    *(byte *)((long)param_1 + 0x55) =
         *(byte *)((long)param_1 + 0x46) >> 7 | *(byte *)((long)param_1 + 0x45) * '\x02';
    *(byte *)((long)param_1 + 0x54) =
         *(byte *)((long)param_1 + 0x45) >> 7 | *(byte *)((long)param_1 + 0x44) * '\x02';
    *(byte *)((long)param_1 + 0x53) =
         *(byte *)((long)param_1 + 0x44) >> 7 | *(byte *)((long)param_1 + 0x43) * '\x02';
    *(byte *)((long)param_1 + 0x52) =
         *(byte *)((long)param_1 + 0x43) >> 7 | *(byte *)((long)param_1 + 0x42) * '\x02';
    *(byte *)((long)param_1 + 0x51) =
         *(byte *)((long)param_1 + 0x42) >> 7 | *(byte *)((long)param_1 + 0x41) * '\x02';
    *(byte *)(param_1 + 10) = *(byte *)((long)param_1 + 0x41) >> 7 | *(byte *)(param_1 + 8) * '\x02'
    ;
    *(byte *)((long)param_1 + 0x4f) =
         *(byte *)(param_1 + 8) >> 7 | *(byte *)((long)param_1 + 0x3f) * '\x02';
    *(byte *)((long)param_1 + 0x4e) =
         *(byte *)((long)param_1 + 0x3f) >> 7 | *(byte *)((long)param_1 + 0x3e) * '\x02';
    *(byte *)((long)param_1 + 0x4d) =
         *(byte *)((long)param_1 + 0x3e) >> 7 | *(byte *)((long)param_1 + 0x3d) * '\x02';
    *(byte *)((long)param_1 + 0x4c) =
         *(byte *)((long)param_1 + 0x3d) >> 7 | *(byte *)((long)param_1 + 0x3c) * '\x02';
    *(byte *)((long)param_1 + 0x4b) =
         *(byte *)((long)param_1 + 0x3c) >> 7 | *(byte *)((long)param_1 + 0x3b) * '\x02';
    *(byte *)((long)param_1 + 0x4a) =
         *(byte *)((long)param_1 + 0x3b) >> 7 | *(byte *)((long)param_1 + 0x3a) * '\x02';
    *(byte *)((long)param_1 + 0x49) =
         *(byte *)((long)param_1 + 0x3a) >> 7 | *(byte *)((long)param_1 + 0x39) * '\x02';
    ...
    *(byte *)((long)param_1 + 0x57) = bVar9;
    ...
    bVar1 = *(byte *)((long)param_1 + 0x4e);
    pbVar3[6] = bVar2 >> 7 | bVar1 * '\x02';
    bVar2 = *(byte *)((long)param_1 + 0x4d);
    pbVar3[5] = bVar1 >> 7 | bVar2 * '\x02';
    bVar1 = *(byte *)((long)param_1 + 0x4c);
    pbVar3[4] = bVar2 >> 7 | bVar1 * '\x02';
    bVar2 = *(byte *)((long)param_1 + 0x4b);
    pbVar3[3] = bVar1 >> 7 | bVar2 * '\x02';
    bVar1 = *(byte *)((long)param_1 + 0x4a);
    pbVar3[2] = bVar2 >> 7 | bVar1 * '\x02';
    bVar2 = *(byte *)((long)param_1 + 0x49);
    pbVar3[1] = bVar1 >> 7 | bVar2 * '\x02';
    *pbVar3 = bVar2 >> 7 | *(char *)(param_1 + 9) * '\x02';
    pbVar3[0xf] = (char)bVar7 >> 7 & 0x87U ^ bVar9 * '\x02';
    pcVar4 = (char *)param_1[0xb];
    pcVar4[0x1e] = (byte)pcVar4[0xf] >> 7 | pcVar4[0xe] * '\x02';
    pcVar4[0x1d] = (byte)pcVar4[0xe] >> 7 | pcVar4[0xd] * '\x02';
    pcVar4[0x1c] = (byte)pcVar4[0xd] >> 7 | pcVar4[0xc] * '\x02';
    pcVar4[0x1b] = (byte)pcVar4[0xc] >> 7 | pcVar4[0xb] * '\x02';
    pcVar4[0x1a] = (byte)pcVar4[0xb] >> 7 | pcVar4[10] * '\x02';
    pcVar4[0x19] = (byte)pcVar4[10] >> 7 | pcVar4[9] * '\x02';
    pcVar4[0x18] = (byte)pcVar4[9] >> 7 | pcVar4[8] * '\x02';
    pcVar4[0x17] = (byte)pcVar4[8] >> 7 | pcVar4[7] * '\x02';
    pcVar4[0x16] = (byte)pcVar4[7] >> 7 | pcVar4[6] * '\x02';
    pcVar4[0x15] = (byte)pcVar4[6] >> 7 | pcVar4[5] * '\x02';
    pcVar4[0x14] = (byte)pcVar4[5] >> 7 | pcVar4[4] * '\x02';
    pcVar4[0x13] = (byte)pcVar4[4] >> 7 | pcVar4[3] * '\x02';
    pcVar4[0x12] = (byte)pcVar4[3] >> 7 | pcVar4[2] * '\x02';
    pcVar4[0x11] = (byte)pcVar4[2] >> 7 | pcVar4[1] * '\x02';
    pcVar4[0x10] = (byte)pcVar4[1] >> 7 | *pcVar4 * '\x02';
    pcVar4[0x1f] = *pcVar4 >> 7 & 0x87U ^ pcVar4[0xf] * '\x02';
    lVar5 = param_1[0xb];
    *(byte *)(lVar5 + 0x2e) = *(byte *)(lVar5 + 0x1f) >> 7 | *(byte *)(lVar5 + 0x1e) * '\x02';
    *(byte *)(lVar5 + 0x2d) = *(byte *)(lVar5 + 0x1e) >> 7 | *(byte *)(lVar5 + 0x1d) * '\x02';
    *(byte *)(lVar5 + 0x2c) = *(byte *)(lVar5 + 0x1d) >> 7 | *(byte *)(lVar5 + 0x1c) * '\x02';
    *(byte *)(lVar5 + 0x2b) = *(byte *)(lVar5 + 0x1c) >> 7 | *(byte *)(lVar5 + 0x1b) * '\x02';
    *(byte *)(lVar5 + 0x2a) = *(byte *)(lVar5 + 0x1b) >> 7 | *(byte *)(lVar5 + 0x1a) * '\x02';
    *(byte *)(lVar5 + 0x29) = *(byte *)(lVar5 + 0x1a) >> 7 | *(byte *)(lVar5 + 0x19) * '\x02';
    *(byte *)(lVar5 + 0x28) = *(byte *)(lVar5 + 0x19) >> 7 | *(byte *)(lVar5 + 0x18) * '\x02';
    *(byte *)(lVar5 + 0x27) = *(byte *)(lVar5 + 0x18) >> 7 | *(byte *)(lVar5 + 0x17) * '\x02';
    *(byte *)(lVar5 + 0x26) = *(byte *)(lVar5 + 0x17) >> 7 | *(byte *)(lVar5 + 0x16) * '\x02';
    *(byte *)(lVar5 + 0x25) = *(byte *)(lVar5 + 0x16) >> 7 | *(byte *)(lVar5 + 0x15) * '\x02';
    *(byte *)(lVar5 + 0x24) = *(byte *)(lVar5 + 0x15) >> 7 | *(byte *)(lVar5 + 0x14) * '\x02';
    *(byte *)(lVar5 + 0x23) = *(byte *)(lVar5 + 0x14) >> 7 | *(byte *)(lVar5 + 0x13) * '\x02';
    *(byte *)(lVar5 + 0x22) = *(byte *)(lVar5 + 0x13) >> 7 | *(byte *)(lVar5 + 0x12) * '\x02';
    *(byte *)(lVar5 + 0x21) = *(byte *)(lVar5 + 0x12) >> 7 | *(byte *)(lVar5 + 0x11) * '\x02';
    *(byte *)(lVar5 + 0x20) = *(byte *)(lVar5 + 0x11) >> 7 | *(char *)(lVar5 + 0x10) * '\x02';
    *(byte *)(lVar5 + 0x2f) =
         *(char *)(lVar5 + 0x10) >> 7 & 0x87U ^ *(byte *)(lVar5 + 0x1f) * '\x02';
    lVar5 = param_1[0xb];
    *(byte *)(lVar5 + 0x3e) = *(byte *)(lVar5 + 0x2f) >> 7 | *(byte *)(lVar5 + 0x2e) * '\x02';
    *(byte *)(lVar5 + 0x3d) = *(byte *)(lVar5 + 0x2e) >> 7 | *(byte *)(lVar5 + 0x2d) * '\x02';
    *(byte *)(lVar5 + 0x3c) = *(byte *)(lVar5 + 0x2d) >> 7 | *(byte *)(lVar5 + 0x2c) * '\x02';
    *(byte *)(lVar5 + 0x3b) = *(byte *)(lVar5 + 0x2c) >> 7 | *(byte *)(lVar5 + 0x2b) * '\x02';
    *(byte *)(lVar5 + 0x3a) = *(byte *)(lVar5 + 0x2b) >> 7 | *(byte *)(lVar5 + 0x2a) * '\x02';
    *(byte *)(lVar5 + 0x39) = *(byte *)(lVar5 + 0x2a) >> 7 | *(byte *)(lVar5 + 0x29) * '\x02';
    *(byte *)(lVar5 + 0x38) = *(byte *)(lVar5 + 0x29) >> 7 | *(byte *)(lVar5 + 0x28) * '\x02';
    *(byte *)(lVar5 + 0x37) = *(byte *)(lVar5 + 0x28) >> 7 | *(byte *)(lVar5 + 0x27) * '\x02';
    *(byte *)(lVar5 + 0x36) = *(byte *)(lVar5 + 0x27) >> 7 | *(byte *)(lVar5 + 0x26) * '\x02';
    *(byte *)(lVar5 + 0x35) = *(byte *)(lVar5 + 0x26) >> 7 | *(byte *)(lVar5 + 0x25) * '\x02';
    *(byte *)(lVar5 + 0x34) = *(byte *)(lVar5 + 0x25) >> 7 | *(byte *)(lVar5 + 0x24) * '\x02';
    *(byte *)(lVar5 + 0x33) = *(byte *)(lVar5 + 0x24) >> 7 | *(byte *)(lVar5 + 0x23) * '\x02';
    *(byte *)(lVar5 + 0x32) = *(byte *)(lVar5 + 0x23) >> 7 | *(byte *)(lVar5 + 0x22) * '\x02';
    *(byte *)(lVar5 + 0x31) = *(byte *)(lVar5 + 0x22) >> 7 | *(byte *)(lVar5 + 0x21) * '\x02';
    *(byte *)(lVar5 + 0x30) = *(byte *)(lVar5 + 0x21) >> 7 | *(char *)(lVar5 + 0x20) * '\x02';
    *(byte *)(lVar5 + 0x3f) =
         *(char *)(lVar5 + 0x20) >> 7 & 0x87U ^ *(byte *)(lVar5 + 0x2f) * '\x02';
    lVar5 = param_1[0xb];
    *(byte *)(lVar5 + 0x4e) = *(byte *)(lVar5 + 0x3f) >> 7 | *(byte *)(lVar5 + 0x3e) * '\x02';
    *(byte *)(lVar5 + 0x4d) = *(byte *)(lVar5 + 0x3e) >> 7 | *(byte *)(lVar5 + 0x3d) * '\x02';
    *(byte *)(lVar5 + 0x4c) = *(byte *)(lVar5 + 0x3d) >> 7 | *(byte *)(lVar5 + 0x3c) * '\x02';
    *(byte *)(lVar5 + 0x4b) = *(byte *)(lVar5 + 0x3c) >> 7 | *(byte *)(lVar5 + 0x3b) * '\x02';
    *(byte *)(lVar5 + 0x4a) = *(byte *)(lVar5 + 0x3b) >> 7 | *(byte *)(lVar5 + 0x3a) * '\x02';
    *(byte *)(lVar5 + 0x49) = *(byte *)(lVar5 + 0x3a) >> 7 | *(byte *)(lVar5 + 0x39) * '\x02';
    *(byte *)(lVar5 + 0x48) = *(byte *)(lVar5 + 0x39) >> 7 | *(byte *)(lVar5 + 0x38) * '\x02';
    *(byte *)(lVar5 + 0x47) = *(byte *)(lVar5 + 0x38) >> 7 | *(byte *)(lVar5 + 0x37) * '\x02';
    *(byte *)(lVar5 + 0x46) = *(byte *)(lVar5 + 0x37) >> 7 | *(byte *)(lVar5 + 0x36) * '\x02';
    *(byte *)(lVar5 + 0x45) = *(byte *)(lVar5 + 0x36) >> 7 | *(byte *)(lVar5 + 0x35) * '\x02';
    *(byte *)(lVar5 + 0x44) = *(byte *)(lVar5 + 0x35) >> 7 | *(byte *)(lVar5 + 0x34) * '\x02';
    *(byte *)(lVar5 + 0x43) = *(byte *)(lVar5 + 0x34) >> 7 | *(byte *)(lVar5 + 0x33) * '\x02';
    *(byte *)(lVar5 + 0x42) = *(byte *)(lVar5 + 0x33) >> 7 | *(byte *)(lVar5 + 0x32) * '\x02';
    *(byte *)(lVar5 + 0x41) = *(byte *)(lVar5 + 0x32) >> 7 | *(byte *)(lVar5 + 0x31) * '\x02';
    *(byte *)(lVar5 + 0x40) = *(byte *)(lVar5 + 0x31) >> 7 | *(char *)(lVar5 + 0x30) * '\x02';
    *(byte *)(lVar5 + 0x4f) =
         *(char *)(lVar5 + 0x30) >> 7 & 0x87U ^ *(byte *)(lVar5 + 0x3f) * '\x02';
    param_1[5] = 4;
  }
...

{
  ...
  if ((param_3 - 1U < 0xf) && (param_4 - 1U < 0x10)) {
    ...
    *(undefined1 (*) [16])(param_1 + 0x14) = (undefined1  [16])0x0;
    ...
    param_1[0x12] =
         (((((((ulong)(((uint)local_59[uVar14 + 8] << bVar12 | (int)(uint)bVar9 >> (bVar13 & 0x1f))
                      & 0xff) << 8 |
              (ulong)(((uint)local_59[uVar14 + 7] << bVar12 |
                      (int)(uint)local_59[uVar14 + 8] >> (bVar13 & 0x1f)) & 0xff)) << 8 |
             (ulong)(byte)((byte)((int)(uint)local_59[uVar14 + 7] >> (bVar13 & 0x1f)) |
                          local_59[uVar14 + 6] << bVar12)) << 8 |
            (ulong)(byte)((byte)((int)(uint)local_59[uVar14 + 6] >> (bVar13 & 0x1f)) |
                         local_59[uVar14 + 5] << bVar12)) << 8 |
           (ulong)(((int)(uint)local_59[uVar14 + 5] >> (bVar13 & 0x1f) |
                   (uint)local_59[uVar14 + 4] << bVar12) & 0xff)) << 8 |
          (ulong)(byte)((byte)((int)(uint)local_59[uVar14 + 4] >> (bVar13 & 0x1f)) |
                       local_59[uVar14 + 3] << bVar12)) << 8 |
         (ulong)(((int)(uint)local_59[uVar14 + 3] >> (bVar13 & 0x1f) |
                 (uint)local_59[uVar14 + 2] << bVar12) & 0xff)) << 8 |
         (ulong)(byte)(local_59[uVar14 + 1] << bVar12 |
                      (byte)((int)(uint)local_59[uVar14 + 2] >> (bVar13 & 0x1f)));
    param_1[0x13] =
         (((((((ulong)(uVar10 & 0xff) << 8 |
              (ulong)(((int)(uint)bVar2 >> (bVar13 & 0x1f) | (uint)bVar5 << bVar12) & 0xff)) << 8 |
             (ulong)(((int)(uint)bVar5 >> (bVar13 & 0x1f) | (uint)bVar3 << bVar12) & 0xff)) << 8 |
            (ulong)(((uint)bVar6 << bVar12 | (int)(uint)bVar3 >> (bVar13 & 0x1f)) & 0xff)) << 8 |
           (ulong)(((int)(uint)bVar6 >> (bVar13 & 0x1f) | (uint)bVar7 << bVar12) & 0xff)) << 8 |
          (ulong)(((int)(uint)bVar7 >> (bVar13 & 0x1f) | (uint)bVar4 << bVar12) & 0xff)) << 8 |
         (ulong)(byte)(bVar8 << bVar12 | (byte)((int)(uint)bVar4 >> (bVar13 & 0x1f)))) << 8 |
         (ulong)(byte)((byte)((int)(uint)bVar8 >> (bVar13 & 0x1f)) | bVar9 << bVar12);
    *(byte *)((long)param_1 + 0x9f) =
         (byte)((int)(uint)((byte)(0xff << (bVar13 & 0x1f)) & bVar1) >> (bVar13 & 0x1f)) |
         (byte)uVar10;
    uVar11 = 1;
  }
  ...
  if ((param_4 & 0xf) != 0) {
    ...
    if (uVar11 - 1 < 3) {
      *(byte *)param_3 = (byte)*param_2 ^ local_58[0];
      if (((param_4 & 0xe) != 0) &&
         (*(byte *)((long)param_3 + 1) = *(byte *)((long)param_2 + 1) ^ local_58[1], uVar11 == 3)) {
LAB_00101406:
        *(byte *)((long)param_3 + 2) = *(byte *)((long)param_2 + 2) ^ local_58[2];
        if ((param_4 & 0xc) != 0) {
                      ...
                      *(byte *)((long)param_3 + 9) = *(byte *)((long)param_2 + 9) ^ local_58[9];
                      if (uVar11 != 10) {
                        *(byte *)((long)param_3 + 10) = *(byte *)((long)param_2 + 10) ^ local_58[10]
                        ;
                        if (uVar11 != 0xb) {
                          *(byte *)((long)param_3 + 0xb) =
                               *(byte *)((long)param_2 + 0xb) ^ local_58[0xb];
                          if (uVar11 != 0xc) {
                            *(byte *)((long)param_3 + 0xc) =
                                 *(byte *)((long)param_2 + 0xc) ^ local_58[0xc];
                            if (uVar11 != 0xd) {
                              *(byte *)((long)param_3 + 0xd) =
                                   *(byte *)((long)param_2 + 0xd) ^ local_58[0xd];
                              if (uVar11 == 0xf) {
                                *(byte *)((long)param_3 + 0xe) =
                                     *(byte *)((long)param_2 + 0xe) ^ local_58[0xe];
                              }
                            }
                          }
                        }
      ...
      *(byte *)param_3 = local_58[0] ^ (byte)*param_2;
      ...
      if (uVar11 - 1 < 7) {
        ...
        uVar7 = uVar11;
LAB_00101548:
        *(uint *)((long)param_3 + lVar5) =
             *(uint *)((long)param_2 + lVar5) ^ *(uint *)(local_58 + lVar5);
        lVar5 = lVar5 + 4;
      ...
      *(byte *)((long)param_3 + lVar5) = *(byte *)((long)param_2 + lVar5) ^ local_58[lVar5];
      if ((lVar5 + 1U < uVar11) &&
         (*(byte *)((long)param_3 + lVar5 + 1) =
               *(byte *)((long)param_2 + lVar5 + 1) ^ local_58[lVar5 + 1], lVar5 + 2U < uVar11)) {
        *(byte *)((long)param_3 + lVar5 + 2) =
             *(byte *)((long)param_2 + lVar5 + 2) ^ local_58[lVar5 + 2];
      }
    }
LAB_0010159f:
...
LAB_0010181b:
  ...
  if ((param_4 & 0xf) != 0) {
    ...
    if (uVar10 - 1 < 3) {
      *(byte *)param_3 = (byte)*param_2 ^ local_58[0];
      if (((param_4 & 0xe) != 0) &&
         (*(byte *)((long)param_3 + 1) = *(byte *)((long)param_2 + 1) ^ local_58[1], uVar10 == 3)) {
LAB_001018a0:
        *(byte *)((long)param_3 + 2) = *(byte *)((long)param_2 + 2) ^ local_58[2];
        if ((param_4 & 0xc) != 0) {
          *(byte *)((long)param_3 + 3) = *(byte *)((long)param_2 + 3) ^ local_58[3];
      ...
      *(byte *)param_3 = local_58[0] ^ (byte)*param_2;
      ...
      if (uVar10 - 1 < 7) {
        ...
        uVar6 = uVar10;
LAB_001019ef:
        *(uint *)((long)param_3 + lVar4) =
             *(uint *)((long)param_2 + lVar4) ^ *(uint *)(local_58 + lVar4);
        lVar4 = lVar4 + 4;
      ...
      *(byte *)((long)param_3 + lVar4) = *(byte *)((long)param_2 + lVar4) ^ local_58[lVar4];
      if ((lVar4 + 1U < uVar10) &&
         (*(byte *)((long)param_3 + lVar4 + 1) =
               *(byte *)((long)param_2 + lVar4 + 1) ^ local_58[lVar4 + 1], lVar4 + 2U < uVar10)) {
        *(byte *)((long)param_3 + lVar4 + 2) =
             *(byte *)((long)param_2 + lVar4 + 2) ^ local_58[lVar4 + 2];
      }
    }
LAB_00101a48:
    local_58 = (undefined1  [16])0x0;

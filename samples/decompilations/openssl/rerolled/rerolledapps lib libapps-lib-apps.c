...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */BIO *app_http_tls_cb(BIO *param_1, undefined8 *param_2, int param_3) {
   ...
   if (( ( uVar7 & 0x80000000 ) != 0 ) || ( (char)( uVar7 >> 0x17 ) != '\x14' )) {
      ...
      uVar2 = (uint)uVar7;
      if (( ( uVar7 & 0x80000000 ) != 0 ) || ( (char)( uVar7 >> 0x17 ) != '\x14' )) goto LAB_001002e8;
   }
   ...
   if (uVar2 == 0x10b) {
      ...
      if (uVar2 == 0x86) {
         ...
         if (uVar2 != 0xfc) goto LAB_001002e8;
      }
      ...
      if (uVar2 != 0x418) goto LAB_001002e8;
   }

   BIO_printf(_bio_err, "%s\n", pcVar8);
   LAB_001002e8:ERR_set_mark();
...
bool ctx_set_verify_locations(undefined8 param_1, long param_2, int param_3, long param_4, int param_5, long param_6, int param_7) {
   ...
   if (param_4 == 0 && param_2 == 0) {
      if (param_6 != 0) {
         LAB_00100523:iVar1 = SSL_CTX_load_verify_store(param_1, param_6);
         return iVar1 != 0;
      }
      ...
      if (( ( param_2 != 0 ) && ( iVar1 = iVar1 == 0 ) ) || ( ( param_4 != 0 && ( iVar1 = SSL_CTX_load_verify_dir(param_1, param_4) ),iVar1 == 0 ) )) {
         return false;
      }

      if (param_6 != 0) goto LAB_00100523;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */CONF *app_load_config_bio(BIO *param_1, long param_2) {
   ...
   iVar2 = NCONF_load_bio(conf, param_1, &local_38);
   lVar1 = local_38;
   pCVar4 = conf;
   if (0 < iVar2) goto LAB_00100740;
   if (local_38 < 1) {
      uVar3 = opt_getprog();
      BIO_printf(_bio_err, "%s: Can\'t load ", uVar3);
      if (param_2 == 0) goto LAB_001007ea;
      LAB_0010079e:BIO_printf(_bio_err, "config file \"%s\"\n", param_2);
   }
 else {
      uVar3 = opt_getprog();
      BIO_printf(_bio_err, "%s: Error on line %ld of ", uVar3, lVar1);
      if (param_2 != 0) goto LAB_0010079e;
      LAB_001007ea:BIO_printf(_bio_err, "config input");
   }

   pCVar4 = (CONF*)0x0;
   NCONF_free(conf);
   LAB_00100740:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return pCVar4;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 add_oid_section(CONF *param_1) {
   ...
   long lVar3;
   int iVar4;
   section = (char*)app_conf_try_string(param_1, 0, "oid_section");
   if (section != (char*)0x0) {
      iVar4 = 0;
...
undefined8 chopup_args(int *param_1, byte *param_2) {
   ...
   if (*param_1 == 0) {
      *param_1 = 0x14;
      addr = (void*)app_malloc(0xa0, "argv space");
...
void set_nameopt(undefined8 param_1) {
   int iVar1;
   iVar1 = set_name_ex(&nmflag, param_1);
   if (iVar1 != 0) {
      nmflag_set = 1;
   }
...
undefined8 set_ext_copy(undefined4 *param_1, undefined8 param_2) {
   int iVar1;
   iVar1 = OPENSSL_strcasecmp(param_2, &_LC19);
   if (iVar1 == 0) {
      *param_1 = 0;
   }
 else {
      iVar1 = OPENSSL_strcasecmp(param_2, &_LC20);
      if (iVar1 == 0) {
         *param_1 = 1;
      }
 else {
...
int copy_extensions(X509 *param_1, X509_REQ *param_2, int param_3) {
   ...
   if (0 < iVar1) {
      do {
         ...
         if (iVar1 == -1) {
            LAB_00100f27:iVar1 = X509_add_ext(param_1, ex, -1);
            if (iVar1 == 0) goto LAB_00100f55;
         }
 else if (param_3 != 1) {
            do {
 ...
 while ( iVar3 < iVar1 );
   ...
   iVar1 = 1;
   LAB_00100f55:OPENSSL_sk_pop_free(psVar2, X509_EXTENSION_free);
   return iVar1;
}
...
;
            if (iVar1 <= iVar6) goto LAB_00101126;
         }
 ...
 while ( (int)lVar5 < iVar1 );
   ...
   LAB_00101126:BIO_printf(param_1, "\n    };\n");
   return;
}
/* WARNING: Removing unreachable block (ram,0x0010128b) */void print_array(BIO *param_1, undefined8 param_2, uint param_3, byte *param_4) {
   uint uVar1;
   byte *pbVar2;
   long lVar3;
   int iVar4;
         ...
         do {
            ...
            while (true) {
               ...
               if ((int)( param_3 - 1 ) <= iVar4) {
                  if (iVar4 < (int)param_3) goto LAB_001012f6;
                  goto LAB_00101360;
               }
...
;
   ...
   LAB_00101360:BIO_printf(param_1, "\n};\n");
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */X509_STORE *setup_verify(long param_1, int param_2, char *param_3, int param_4, long param_5, int param_6) {
   ...
   if (v != (X509_STORE*)0x0) {
      if (( param_1 != 0 ) || ( param_2 == 0 )) {
         ...
         if (pXVar5 == (X509_LOOKUP*)0x0) goto LAB_00101490;
         if (param_1 == 0) {
   ...
   LAB_00101490:ERR_print_errors(_bio_err);
   X509_STORE_free(v);
...
void index_name_LHASH_COMP(void) {
   index_name_cmp();
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 save_serial(char *param_1, char *param_2, BIGNUM *param_3, undefined8 *param_4) {
   ...
   if (param_2 == (char*)0x0) {
      ...
      LAB_001017a0:BIO_printf(_bio_err, "File name too long\n");
      LAB_00101787:bp = (BIO*)0x0;
   }
 else {
      sVar2 = strlen(param_2);
      if (0xff < (int)sVar1 + 1 + (int)sVar2) goto LAB_001017a0;
      BIO_snprintf(acStack_138, 0x100, "%s.%s", param_1, param_2);
      LAB_001016ca:bp = BIO_new_file(acStack_138, "w");
      if (bp == (BIO*)0x0) goto LAB_00101787;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 rotate_serial(char *param_1, char *param_2, char *param_3) {
   ...
   LAB_00101901:ERR_print_errors(_bio_err);
   uVar5 = 0;
   LAB_001018be:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar5;
   }
...
uint rand_serial(BIGNUM *param_1, ASN1_INTEGER *param_2) {
   ...
   if (param_1 == (BIGNUM*)0x0) {
      ...
      if (rnd != (BIGNUM*)0x0) {
         ...
         if (( uVar2 != 0 ) && ( uVar2 = param_2 != (ASN1_INTEGER*)0x0 )) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */BIGNUM *load_serial(char *param_1, uint *param_2, int param_3, undefined8 *param_4) {
   ...
   if (bs == (ASN1_INTEGER*)0x0) {
      ...
      if (bp == (BIO*)0x0) {
         ...
         if (iVar1 == 0) {
            ...
            if (a != (BIGNUM*)0x0) {
               LAB_00101aee:if (param_4 != (undefined8*)0x0) {
                  *param_4 = bs;
                  bs = (ASN1_INTEGER*)0x0;
               }
   ...
   LAB_00101bd9:a = (BIGNUM*)0x0;
   ERR_print_errors(_bio_err);
   LAB_00101af8:BIO_free(bp);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 index_index(int *param_1) {
   ...
   if (iVar2 == 0) {
      ...
      LAB_00101cd0:ERR_print_errors(_bio_err);
      return 0;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 save_index(char *param_1, char *param_2, int *param_3) {
   ...
   ERR_print_errors(_bio_err);
   uVar5 = 0;
   LAB_00101e19:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 rotate_index(char *param_1, char *param_2, char *param_3) {
   ...
   if (iVar6 < 0xfa) {
      ...
      if (iVar6 < 0) {
         ...
         if (iVar6 < 0) {
            piVar4 = __errno_location();
            if (( *piVar4 == 0x14 ) || ( *piVar4 == 2 )) goto LAB_00101ff3;
            BIO_printf(_bio_err, "Unable to rename %s to %s\n", local_148, local_248);
            perror("reason");
         }
 else {
            LAB_00101ff3:iVar6 = rename(local_348, local_148);
            if (-1 < iVar6) {
               uVar5 = 1;
               goto LAB_0010200d;
            }
   ...
   LAB_00102059:ERR_print_errors(_bio_err);
   uVar5 = 0;
   LAB_0010200d:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar5;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */X509_NAME *parse_name(char *param_1, int param_2, int param_3, undefined8 param_4) {
   ...
   if (*param_1 == '/') {
      ...
      if (name == (X509_NAME*)0x0) {
         ...
         if (s != (uchar*)0x0) {
            ...
            iVar10 = 0;
            if (uVar1 == '\0') {
               LAB_00102507:CRYPTO_free(s);
               return name;
            }

            puVar11 = s;
            if (uVar1 == '=') goto LAB_001023cb;
            LAB_001022b0:puVar8 = puVar11;
            str = str + 1;
            puVar11 = puVar8 + 1;
            *puVar8 = uVar1;
            uVar1 = *str;
            if (uVar1 != '\0') goto code_r0x001022c7;
            goto LAB_001022cb;
         }

         uVar5 = opt_getprog();
         BIO_printf(_bio_err, "%s: Error copying %s name input\n", uVar5, param_4);
         LAB_0010247a:X509_NAME_free(name);
         CRYPTO_free(s);
      }
   ...
   code_r0x001022c7:if (uVar1 == '=') {
      LAB_001022cb:*puVar11 = '\0';
      puVar8 = puVar8 + 2;
      if (uVar1 != '\0') {
         do {
            uVar1 = str[1];
 ...
 while ( ( uVar1 != '\0' ) && ( puVar7 = puVar6 ),puVar3 = str,uVar1 != '/' );
            ...
            *puVar6 = '\0';
            ...
            puVar3 = str;
            if (uVar1 == '\0') {
               iVar2 = OBJ_txt2nid((char*)s);
               if (iVar2 != 0) goto LAB_00102369;
               LAB_001023fd:uVar5 = opt_getprog();
               ...
               LAB_001023e9:str = puVar3 + 1;
               iVar2 = OBJ_txt2nid((char*)s);
               if (iVar2 == 0) goto LAB_001023fd;
               LAB_00102369:if (puVar11[1] == '\0') {
                  uVar5 = opt_getprog();
                  ...
                  iVar2 = X509_NAME_add_entry_by_NID(name, iVar2, param_2, puVar8, (int)sVar4, -1, -iVar10);
                  iVar10 = iVar12;
                  if (iVar2 == 0) {
                     ERR_print_errors(_bio_err);
                     uVar5 = opt_getprog();
            ...
            uVar1 = *str;
            if (uVar1 == '\0') goto LAB_00102507;
            puVar11 = s;
            if (uVar1 != '=') goto LAB_001022b0;
            LAB_001023cb:*s = '\0';
            puVar8 = s + 1;
            puVar11 = s;
         }
...
ulong bio_to_mem(void *param_1, int param_2, BIO *param_3) {
   ...
   b = BIO_new(type);
   if (b != (BIO*)0x0) {
      LAB_0010263a:if (( param_2 == -1 ) || ( iVar1 = 0x3ff < param_2 )) {
         iVar1 = 0x400;
      }
      ...
      do {
         ...
         if (iVar1 < 0) {
            LAB_00102690:BIO_free(b);
            break;
         }

         if (iVar1 == 0) goto LAB_001026c8;
         iVar2 = BIO_write(b, auStack_448, iVar1);
         if (iVar2 != iVar1) goto LAB_00102690;
         if (param_2 != -1) goto LAB_00102630;
         iVar1 = 0x400;
      }
 while ( true );
   }
   ...
   uVar3 = 0xffffffff;
   LAB_0010269d:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

   return uVar3;
   LAB_00102630:param_2 = param_2 - iVar2;
   if (param_2 == 0) goto LAB_001026c8;
   goto LAB_0010263a;
   LAB_001026c8:uVar3 = BIO_ctrl(b, 3, 0, param_1);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 do_sign_init(long param_1, undefined8 param_2, undefined8 param_3, long param_4) {
   ...
   LAB_001027ff:uVar3 = 0;
   LAB_00102801:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
;
   ...
   BIO_printf(_bio_err, "%s Policies:", &_LC77);
   if (psVar3 != (stack_st_X509_POLICY_NODE*)0x0) {
      BIO_puts(_bio_err, "\n");
      iVar1 = 0;
      while (true) {
...
void *next_protos_parse(long *param_1, char *param_2) {
   ...
   sVar2 = strlen(param_2);
   if (sVar2 - 1 < 0xfffe) {
      ptr = (void*)app_malloc(sVar2 + 1, "NPN buffer");
      uVar5 = 1;
      uVar6 = 0;
      sVar4 = 0;
      sVar3 = 0;
      while (true) {
         if (( sVar2 == sVar3 ) || ( pcVar1 = param_2 + sVar3 * pcVar1 == ',' )) {
            if (sVar3 == sVar4) {
               sVar3 = sVar4 + 1;
               uVar6 = uVar6 + 1;
               sVar4 = sVar3;
               ...
               *(char*)( (long)ptr + ( sVar4 - uVar6 ) ) = (char)sVar3 - (char)sVar4;
               sVar3 = sVar3 + 1;
               sVar4 = uVar5;
            }
            ...
            sVar3 = sVar3 + 1;
            *(char*)( (long)ptr + ( uVar5 - uVar6 ) ) = *pcVar1;
         }
...
bool do_X509_sign(X509 *param_1, int param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6) {
   int iVar1;
   EVP_MD_CTX *ctx;
   bool bVar2;
   ...
   if (param_2 == 0) {
      ...
      if (( iVar1 != 0 ) && ( iVar1 = adapt_keyid_ext(param_1, param_6, "subjectKeyIdentifier", &_LC84, 1) ),iVar1 != 0) {
         iVar1 = cert_matches_key(param_1, param_3);
         iVar1 = adapt_keyid_ext(param_1, param_6, "authorityKeyIdentifier", "keyid, issuer", iVar1 == 0);
         if (iVar1 != 0) goto LAB_00102d13;
      }

   }
 else {
      LAB_00102d13:if (( ctx != (EVP_MD_CTX*)0x0 ) && ( iVar1= do_sign_init(ctx,param_3,param_4,param_5),0 < iVar1 )) {
   ...
   bVar2 = false;
   LAB_00102d33:EVP_MD_CTX_free(ctx);
   return bVar2;
}
...
void *app_http_get_asn1(long param_1, undefined8 param_2, undefined8 param_3, long param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7, ASN1_ITEM *param_8) {
   ...
   if (( param_1 == 0 ) || ( param_8 == (ASN1_ITEM*)0x0 )) {
      ...
      if (iVar1 != 0) {
         if (local_7c == 0) {
            if (param_4 == 0) goto LAB_001030e0;
            ERR_new();
            pvVar3 = (void*)0x0;
            ...
            LAB_001030e0:local_68 = local_78;
            pvStack_60 = local_70;
   ...
   pvVar3 = (void*)0x0;
   LAB_00103197:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return pvVar3;
   }
...
BIO *app_http_post_asn1(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, long param_6, undefined8 param_7, undefined8 param_8, undefined8 param_9, undefined8 param_10, undefined8 param_11, undefined8 param_12, ASN1_ITEM *param_13) {
   ...
   if (a != (BIO*)0x0) {
      ...
      local_48 = param_6;
      in = (BIO*)OSSL_HTTP_transfer(0, param_1, param_2, param_3, param_6 != 0, param_4, param_5, 0, 0, _GLOBAL_OFFSET_TABLE_, &local_68, 0, param_7, param_8, a, param_11, 1, 0x19000, (undefined4)param_12, 0);
      BIO_free(a);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 app_load_config_internal(char *param_1, int param_2) {
   ...
   char *pcVar4;
   if (param_1 == (char*)0x0) {
      LAB_001036ce:a = (BIO*)dup_bio_in(0x8001);
      if (param_2 == 0) {
         if (a == (BIO*)0x0) {
            piVar2 = __errno_location();
            pcVar4 = strerror(*piVar2);
            BIO_printf(_bio_err, "Can\'t open %s, %s\n", "stdin", pcVar4);
            LAB_0010375f:ERR_print_errors(_bio_err);
            return 0;
         }
      ...
      if (( *param_1 == '-' ) && ( param_1[1] == '\0' )) goto LAB_001036ce;
   ...
   LAB_001036e5:uVar3 = app_load_config_bio(a, param_1);
   BIO_free(a);
   return uVar3;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void app_load_config_verbose(char *param_1, int param_2) {
   if (param_2 != 0) {
      if (*param_1 != '\0') {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */CONF *app_load_config_modules(long param_1) {
   int iVar1;
   CONF *conf;
   if (( param_1 == 0 ) || ( conf = (CONF*)app_load_config_verbose(param_1, 1) ),conf == (CONF*)0x0) {
      return (CONF*)0x0;
   }

   if (( _default_config_file != param_1 ) && ( iVar1 = iVar1 == 0 )) {
      NCONF_free(conf);
      return (CONF*)0x0;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined4 *load_index(char *param_1, undefined4 *param_2) {
   int iVar1;
   undefined4 uVar2;
   BIO *bp;
   TXT_DB *pTVar3;
   ...
   if (bp != (BIO*)0x0) {
      ...
      if (iVar1 == -1) {
         ...
         if (pTVar3 != (TXT_DB*)0x0) {
            ...
            puVar4 = (undefined4*)app_malloc(0xa8, "new DB");
            *(TXT_DB**)( puVar4 + 2 ) = pTVar3;
            ...
            if (conf != (CONF*)0x0) {
               lVar5 = app_conf_try_string(conf, 0, "unique_subject");
               if (lVar5 != 0) {
                  uVar2 = parse_yesno(lVar5, 1);
                  *puVar4 = uVar2;
               }
   ...
   LAB_00103a77:ERR_print_errors(_bio_err);
   NCONF_free(conf);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */char *app_get_pass(char *param_1, int param_2) {
   ...
   if (iVar1 == 0) {
      if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
         pcVar3 = param_1 + 5;
         iVar1 = 0x107;
         LAB_00103d44:pcVar3 = CRYPTO_strdup(pcVar3, "apps/lib/apps.c", iVar1);
         return pcVar3;
      }
   ...
   if (iVar1 == 0) {
      ...
      if (iVar1 == 0) {
         ...
         if (pwdbio_5 != (BIO*)0x0) goto LAB_00103c70;
         ...
         if (iVar1 == 0) {
            unbuffer(_stdin);
            pwdbio_5 = (BIO*)dup_bio_in(0x8001);
            if (pwdbio_5 != (BIO*)0x0) goto LAB_00103c70;
      ...
      LAB_00103c70:iVar1 = BIO_gets(pwdbio_5, acStack_428, 0x400);
      if (param_2 != 1) {
         BIO_free_all(pwdbio_5);
         pwdbio_5 = (BIO*)0x0;
      }
...
bool app_passwd(char *param_1, char *param_2, long *param_3, long *param_4) {
   ...
   cVar3 = '\0';
   if (param_2 == (char*)0x0) {
      LAB_00103fd5:if (param_4 != (long*)0x0) {
         *param_4 = 0;
      }
   ...
   LAB_00103f9c:lVar2 = app_get_pass(param_2, cVar3);
   *param_4 = lVar2;
   return lVar2 != 0;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */char *get_passwd(char *param_1, char *param_2) {
   ...
   local_28 = (char*)0x0;
   iVar1 = app_passwd(param_1, 0, &local_28, 0);
   if (iVar1 == 0) {
      BIO_printf(_bio_err, "Error getting password for %s\n", param_2);
   }

   if (( param_1 != (char*)0x0 ) && ( local_28 == (char*)0x0 )) {
      BIO_printf(_bio_err, "Trying plain input string (better precede with \'pass:\')\n");
      local_28 = CRYPTO_strdup(param_1, "apps/lib/apps.c", 0xe2);
   ...
   if (param_7 == (long*)0x0) {
      if (param_8 != (long*)0x0) {
         ...
         *param_8 = 0;
         ...
         if (param_9 != (long*)0x0) goto LAB_001041ec;
         if (param_10 != (long*)0x0) goto LAB_00104200;
         if (param_11 != (long*)0x0) goto LAB_001049f4;
         if (param_12 != (long*)0x0) goto LAB_0010422c;
         if (param_13 == (long*)0x0) {
            local_e0 = 3;
            goto LAB_00104254;
         }

         if (*param_13 == 0) goto LAB_00104691;
         LAB_0010424c:local_e0 = 0;
         goto LAB_00104254;
      }
      ...
      if (param_9 != (long*)0x0) {
         ...
         *param_9 = 0;
         ...
         LAB_00104242:if (*param_13 == 0) {
            lVar6 = OPENSSL_sk_new_null();
            *param_13 = lVar6;
            goto joined_r0x001046a1;
         }
      ...
      if (param_10 != (long*)0x0) {
         ...
         *param_10 = 0;
         ...
         local_108 = "certificate";
         LAB_00104c61:if (param_12 == (long*)0x0) {
            if (param_13 == (long*)0x0) {
               local_e0 = 5;
               goto LAB_00104254;
            }
         ...
         LAB_0010422c:*param_12 = 0;
         goto joined_r0x00104240;
      }
      ...
      *param_7 = 0;
      if (param_8 == (long*)0x0) {
         if (param_9 != (long*)0x0) goto LAB_001041e0;
         if (param_10 != (long*)0x0) goto LAB_0010445d;
         if (param_11 != (long*)0x0) goto LAB_00104a1a;
         if (param_12 != (long*)0x0) goto LAB_00104c17;
         if (param_13 == (long*)0x0) {
            local_e0 = 4;
         ...
         LAB_00104d13:if (*param_13 != 0) goto LAB_00104d1d;
         local_108 = "private key";
         LAB_00104691:lVar6 = OPENSSL_sk_new_null();
         *param_13 = lVar6;
         joined_r0x001046a1:if (lVar6 != 0) goto LAB_0010424c;
         LAB_00104ad6:if (param_6 == 0) {
            BIO_printf(_bio_err, "Out of memory loading");
            OSSL_STORE_close(0);
            goto LAB_00104848;
         }

         LAB_001046ca:OSSL_STORE_close(0);
         LAB_00104411:uVar3 = 0;
         LAB_00104413:ERR_pop_to_mark();
         goto LAB_00104418;
      }

      *param_8 = 0;
      if (param_9 != (long*)0x0) {
         LAB_001041e0:local_108 = "private key";
         LAB_001041ec:*param_9 = 0;
         if (param_10 != (long*)0x0) {
            LAB_00104200:*param_10 = 0;
            if (( param_11 == (long*)0x0 ) || ( *param_11 != 0 )) goto LAB_00104220;
            lVar6 = OPENSSL_sk_new_null();
            *param_11 = lVar6;
            if (lVar6 != 0) goto LAB_00104220;
            goto LAB_00104ad6;
         }

         if (param_11 != (long*)0x0) {
            LAB_001049f4:lVar6 = *param_11;
            goto joined_r0x00104a2a;
         }

         LAB_00104220:if (param_12 != (long*)0x0) goto LAB_0010422c;
         joined_r0x00104240:if (param_13 != (long*)0x0) goto LAB_00104242;
         goto LAB_0010424c;
      }

      if (param_10 != (long*)0x0) {
         LAB_0010445d:local_108 = "private key";
         goto LAB_00104200;
      }

      if (param_11 != (long*)0x0) {
         LAB_00104a1a:lVar6 = *param_11;
         local_108 = "private key";
         joined_r0x00104a2a:if (lVar6 == 0) {
            lVar6 = OPENSSL_sk_new_null();
            *param_11 = lVar6;
            if (lVar6 == 0) goto LAB_00104ad6;
         }
      ...
      if (param_12 != (long*)0x0) {
         LAB_00104c17:local_108 = "private key";
         goto LAB_0010422c;
      }

      if (param_13 != (long*)0x0) goto LAB_00104d13;
      LAB_00104d1d:local_e0 = 0;
      local_108 = "private key";
      LAB_00104254:local_a8 = param_4;
      local_a0 = param_1;
      if (param_2 == 0xc) {
         pcVar11 = "PVK";
         LAB_00104290:puVar12 = &local_98;
         ...
         if (param_2 < 0xd) {
            if (param_2 == 4) {
               ...
               if (param_2 != 0xb) goto LAB_0010430e;
            }
         ...
         puVar12 = (undefined8*)0x0;
         pcVar11 = "PEM";
         if (param_2 == 0x8005) goto LAB_00104290;
      }

      LAB_0010430e:if (param_1 == (char*)0x0) {
         if (param_3 != 0) {
            unbuffer(_stdin);
            a = BIO_new_fp(_stdin, 0);
            if (a != (BIO*)0x0) {
               uVar5 = get_ui_method();
               lVar6 = OSSL_STORE_attach(a, &_LC133, uVar3, uVar4, uVar5, &local_a8, puVar12, 0, 0);
               BIO_free(a);
               local_110 = "<stdin>";
               goto LAB_0010434c;
            }
         ...
         if (param_6 != 0) goto LAB_001046ca;
         BIO_printf(_bio_err, "No filename or uri specified for loading\n");
         OSSL_STORE_close(0);
      }
 else {
         uVar5 = get_ui_method();
         lVar6 = OSSL_STORE_open_ex(param_1, uVar3, uVar4, uVar5, &local_a8, puVar12, 0, 0);
         LAB_0010434c:if (lVar6 == 0) {
            LAB_00104908:if (param_6 != 0) goto LAB_001046ca;
            BIO_printf(_bio_err, "Could not open file or uri for loading");
            OSSL_STORE_close(0);
         }
 else {
            ...
            local_f8 = 0;
            local_f0 = 0;
            LAB_00104378:if (param_7 != (long*)0x0 || param_8 != (long*)0x0) goto LAB_00104518;
            LAB_00104384:if (( ( ( param_11 != (long*)0x0 || param_13 != (long*)0x0 ) || param_9 != (long*)0x0 ) || local_130 != (long*)0x0 ) || local_128 != (long*)0x0) {
               do {
...
LAB_001044fa:
              ...
              break;
                     case 3:
switchD_001044b0_caseD_3:
              if (param_8 != (long *)0x0) {
                lVar9 = OSSL_STORE_INFO_get1_PUBKEY(lVar8);
                *param_8 = lVar9;
                if (lVar9 == 0) goto LAB_001045e8;
              }
              param_8 = (long *)0x0;
              break;
                     case 4:
              if (param_7 == (long *)0x0) goto switchD_001044b0_caseD_3;
...
LAB_001045f0:
              ...
              goto LAB_00104378;
                  ...
                  OSSL_STORE_INFO_free(lVar8);
                  if (param_7 == (long*)0x0 && param_8 == (long*)0x0) goto LAB_00104384;
                  LAB_00104518:do {
                     iVar1 = OSSL_STORE_eof(lVar6);
                     if (iVar1 != 0) goto LAB_001043c1;
                     lVar8 = OSSL_STORE_load(lVar6);
                  }
 while ( lVar8 == 0 );
               }
 while ( true );
            ...
            param_7 = (long*)0x0;
            local_128 = (long*)0x0;
            LAB_001043c1:OSSL_STORE_close(lVar6);
            LAB_001043c9:if (0 < local_f0) {
               param_11 = (long*)0x0;
            }
            ...
            LAB_00104405:if (param_6 != 0) goto LAB_00104411;
            BIO_printf(_bio_err, "Could not find");
         }

      }

      LAB_00104848:uVar10 = ERR_peek_last_error();
      if (param_5 == (char*)0x0) {
   ...
   uVar3 = 0;
   LAB_00104418:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */long load_cert_pass(char *param_1, undefined4 param_2, undefined4 param_3, undefined8 param_4, char *param_5) {
   ...
   if (param_1 != (char*)0x0) {
      ...
      if (iVar1 == 0) {
         local_38 = X509_load_http(param_1, 0, 0, 0);
         if (local_38 == 0) {
            ERR_print_errors(_bio_err);
   ...
   LAB_00104f71:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return local_38;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */long load_crl(char *param_1, undefined4 param_2, undefined4 param_3, undefined *param_4) {
   ...
   if (param_1 != (char*)0x0) {
      ...
      iVar1 = strncmp(param_1, "http://", 7);
      if (iVar1 == 0) {
         local_38 = X509_CRL_load_http(param_1, 0, 0, 0);
         if (local_38 == 0) {
            ERR_print_errors(_bio_err);
            BIO_printf(_bio_err, "Unable to load %s from %s\n", param_4, param_1);
         }
   ...
   LAB_001050bb:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return local_38;
   }
...
undefined8 load_crl_crldp(undefined8 param_1) {
 ...
 while ( iVar6 < iVar2 );
   ...
   LAB_001052a6:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* WARNING: Removing unreachable block (ram,0x001055fb) *//* WARNING: Removing unreachable block (ram,0x00105630) *//* WARNING: Removing unreachable block (ram,0x0010560a) *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 load_keyparams_suppress(void) {
   long lVar1;
   long in_FS_OFFSET;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int load_cert_certs(undefined8 param_1, undefined8 *param_2, undefined8 *param_3, int param_4, undefined8 param_5, char *param_6, undefined8 param_7) {
   ...
   if (( param_4 == 0 ) || ( ( iVar1 = OPENSSL_strncasecmp(param_1, "http://", 7) ),iVar1 != 0 && ( iVar1 = OPENSSL_strncasecmp(param_1, "https://", 8) ),iVar1 != 0 )) {
      uVar5 = get_passwd(param_5, param_6);
      iVar1 = load_key_certs_crls(param_1, 0, 0, uVar5, param_6, 0, 0, 0, 0, param_2, param_3, 0, 0);
      clear_free(uVar5);
      if (iVar1 != 0) {
         if (param_2 != (undefined8*)0x0) {
            pXVar9 = (X509*)*param_2;
            X509_get_extension_flags(pXVar9);
            uVar5 = X509_get0_notAfter(pXVar9);
            uVar6 = X509_get0_notBefore(pXVar9);
            iVar2 = X509_cmp_timeframe(param_7, uVar6, uVar5);
            if (iVar2 != 0) {
               pcVar11 = "not yet valid";
               if (0 < iVar2) {
                  pcVar11 = "has expired";
               }

               pXVar7 = X509_get_subject_name(pXVar9);
               pcVar8 = X509_NAME_oneline(pXVar7, (char*)0x0, 0);
               BIO_printf(_bio_err, "Warning: certificate from \'%s\' with subject \'%s\' %s\n", param_1, pcVar8, pcVar11);
               CRYPTO_free(pcVar8);
            }
         ...
         uVar5 = *param_3;
         for (iVar2 = 0; iVar3 = OPENSSL_sk_num(uVar5),iVar2 < iVar3; iVar2 = iVar2 + 1) {
            pXVar9 = (X509*)OPENSSL_sk_value(uVar5, iVar2);
            uVar4 = X509_get_extension_flags(pXVar9);
            uVar6 = X509_get0_notAfter(pXVar9);
            uVar10 = X509_get0_notBefore(pXVar9);
            iVar3 = X509_cmp_timeframe(param_7, uVar10, uVar6);
            if (iVar3 != 0) {
               pcVar11 = "has expired";
               if (iVar3 < 1) {
                  pcVar11 = "not yet valid";
            ...
            if (( uVar4 & 0x50 ) == 0) {
               pXVar7 = X509_get_subject_name(pXVar9);
               pcVar11 = X509_NAME_oneline(pXVar7, (char*)0x0, 0);
               BIO_printf(_bio_err, "Warning: certificate from \'%s\' with subject \'%s\' %s\n", param_1, pcVar11, "is not a CA cert");
               CRYPTO_free(pcVar11);
            }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */long load_certs_multifile(long param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4) {
   ...
   if (param_1 != 0) {
      if (lVar2 != 0) {
         do {
            ...
            if (iVar1 == 0) goto LAB_00105a43;
            iVar1 = X509_add_certs(lVar2, local_48, 5);
            if (iVar1 == 0) goto LAB_00105a80;
 ...
 while ( lVar3 != 0 );
      ...
      LAB_00105a80:BIO_printf(_bio_err, "out of memory\n");
   }

   LAB_00105a43:OSSL_STACK_OF_X509_free(local_48);
   OSSL_STACK_OF_X509_free(lVar2);
   lVar2 = 0;
   LAB_00105a57:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return lVar2;
   }
   ...
   if (param_1 == 0) {
      ...
      do {
         ...
         if (( v == (X509_STORE*)0x0 ) && ( v = X509_STORE_new() ),v == (X509_STORE*)0x0) {
            LAB_00105ba0:OSSL_STACK_OF_X509_free(local_48);
            goto LAB_00105baa;
         }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */BIO *bio_open_default(char *param_1, ulong param_2, undefined4 param_3) {
   int iVar1;
   BIO *pBVar2;
   int *piVar3;
   BIO *pBVar4;
   ...
   if (cVar6 == 'a') {
      ...
      pBVar2 = BIO_new_file(param_1, pcVar7);
      if (pBVar2 != (BIO*)0x0) {
         return pBVar2;
      }
      ...
      if (cVar6 != 'w') {
         ...
         iVar1 = (int)param_2;
         if (iVar1 == 0) {
            pBVar2 = (BIO*)bio_open_default();
            if (pBVar2 == (BIO*)0x0) {
               LAB_00105f90:pBVar2 = (BIO*)0x0;
               goto LAB_00105f54;
            }

            LAB_00105eea:pBVar4 = (BIO*)PEM_read_bio_X509_REQ(pBVar2, (X509_REQ**)0x0, (undefined1*)0x0, (void*)0x0);
         }
 else {
            pBVar2 = (BIO*)bio_open_default();
            if (pBVar2 == (BIO*)0x0) goto LAB_00105f90;
            if (iVar1 != 4) {
               if (iVar1 != 0x8005) {
                  print_format_error(param_2 & 0xffffffff, 6);
                  goto LAB_00105f54;
               }
            ...
            pBVar4 = (BIO*)d2i_X509_REQ_bio(pBVar2, (X509_REQ**)0x0);
         }
         ...
         LAB_00105f54:ERR_print_errors(_bio_err);
         if (extraout_RDX != 0) {
   ...
   BIO_printf(_bio_err, "Can\'t open \"%s\" for %s, %s\n", param_1, pcVar5, pcVar7);
   LAB_00105db5:ERR_print_errors(_bio_err);
   return (BIO*)0x0;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */X509_REQ *load_csr(undefined8 param_1, int param_2, long param_3) {
   BIO *bp;
   X509_REQ *pXVar1;
   if (param_2 == 0) {
      bp = (BIO*)bio_open_default(param_1, 0x72, 0x8005);
      if (bp == (BIO*)0x0) {
         LAB_00105f90:bp = (BIO*)0x0;
         goto LAB_00105f54;
      }

      LAB_00105eea:pXVar1 = PEM_read_bio_X509_REQ(bp, (X509_REQ**)0x0, (undefined1*)0x0, (void*)0x0);
   }
 else {
      bp = (BIO*)bio_open_default(param_1, 0x72, param_2);
      if (bp == (BIO*)0x0) goto LAB_00105f90;
      if (param_2 != 4) {
         if (param_2 != 0x8005) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */long load_csr_autofmt(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4) {
   BIO *pBVar1;
   int iVar2;
   long lVar3;
   long lVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */BIO *bio_open_owner(char *param_1, undefined4 param_2, int param_3) {
   ...
   pBVar3 = (BIO*)bio_open_default(param_1, 0x77, param_2);
   return pBVar3;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */BIO *bio_open_default_quiet(char *param_1, undefined8 param_2, ulong param_3, ulong param_4) {
   int iVar1;
   BIO *pBVar2;
   long lVar3;
   ...
   if (cVar4 == 'a') {
      ...
      LAB_001062b7:pBVar2 = BIO_new_file(param_1, mode);
      ERR_clear_error();
      return pBVar2;
   }
   ...
   plStack_30 = (long*)0x0;
   pcStack_20 = param_1;
   lVar3 = BIO_ctrl(pBVar2, 0x73, 0, &plStack_30);
   if ((int)lVar3 < 1) {
      pBVar2 = (BIO*)0x0;
      BIO_puts(_bio_err, "Error reading mem buffer\n");
   }
 else {
      pBVar2 = (BIO*)bio_open_owner(param_2, extraout_EDX, param_4 & 0xffffffff);
      if (pBVar2 == (BIO*)0x0) {
         pBVar2 = (BIO*)0x0;
      }
 else {
         iVar1 = BIO_write(pBVar2, (void*)plStack_30[1], (int)*plStack_30);
         if (( -1 < iVar1 ) && ( pBVar5 = (BIO*)0x1 ),(long)iVar1 == *plStack_30) goto LAB_0010640b;
   ...
   pBVar5 = (BIO*)0x0;
   ERR_print_errors(_bio_err);
   LAB_0010640b:BIO_free_all(pBVar2);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 mem_bio_to_file(BIO *param_1, undefined8 param_2, undefined4 param_3, undefined4 param_4) {
   ...
   if ((int)lVar2 < 1) {
      ...
      if (b == (BIO*)0x0) {
         ...
         if (( -1 < iVar1 ) && ( uVar3 = 1 ),(long)iVar1 == *local_28) goto LAB_0010640b;
         BIO_printf(_bio_err, "Error writing to output file: \'%s\'\n", param_2);
      }
...
void wait_for_async(undefined8 param_1) {
   ...
   bVar7 = 0;
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   iVar2 = SSL_get_all_async_fds(param_1, 0, &local_c0);
   if (( iVar2 != 0 ) && ( local_c0 != 0 )) {
      ptr = (void*)app_malloc(local_c0 << 2, "allocate async fds");
      iVar2 = SSL_get_all_async_fds(param_1, ptr, &local_c0);
      if (iVar2 == 0) {
         CRYPTO_free(ptr);
      }
 else {
         ...
         if (local_c0 == 0) {
            ...
            do {
               ...
               lVar4 = uVar5 * 4;
               uVar5 = uVar5 + 1;
               local_b8.fds_bits[lVar3] = local_b8.fds_bits[lVar3] | 1L << ( ( byte ) * (undefined4*)( (long)ptr + lVar4 ) & 0x3f );
            }
 while ( uVar5 < local_c0 );
         }

         select(iVar2, &local_b8, (fd_set*)0x0, (fd_set*)0x0, (timeval*)0x0);
         CRYPTO_free(ptr);
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 set_cert_times(undefined8 param_1, char *param_2, char *param_3, int param_4, int param_5) {
   ...
   if (( param_2 == (char*)0x0 ) || ( iVar1 = iVar1 == 0 )) {
      ...
      if (pAVar2 == (ASN1_TIME*)0x0) goto LAB_0010676b;
   }
 else {
      uVar3 = X509_getm_notBefore(param_1);
      iVar1 = ASN1_TIME_set_string_X509(uVar3, param_2);
      if (iVar1 == 0) {
         LAB_0010676b:BIO_printf(_bio_err, "Error setting notBefore certificate field\n");
         return 0;
      }

   }

   if (( param_3 == (char*)0x0 ) || ( param_4 = param_4 == 0 )) {
      pAVar2 = (ASN1_TIME*)X509_getm_notAfter(param_1);
      pAVar2 = X509_time_adj_ex(pAVar2, param_4, 0, (time_t*)0x0);
      if (pAVar2 == (ASN1_TIME*)0x0) goto LAB_001067ab;
   }
 else {
      uVar3 = X509_getm_notAfter(param_1);
      iVar1 = ASN1_TIME_set_string_X509(uVar3, param_3);
      if (iVar1 == 0) {
         LAB_001067ab:BIO_printf(_bio_err, "Error setting notAfter certificate field\n");
         return 0;
      }
...
bool set_crl_lastupdate(undefined8 param_1, long param_2) {
   ...
   if (s != (ASN1_TIME*)0x0) {
      if (param_2 == 0) {
         ...
         if (pAVar2 == (ASN1_TIME*)0x0) goto LAB_00106857;
      }
 else {
         iVar1 = ASN1_TIME_set_string_X509(s, param_2);
         if (iVar1 == 0) goto LAB_00106857;
      }
...
bool set_crl_nextupdate(undefined8 param_1, long param_2, int param_3, long param_4, long param_5) {
   ...
   s = ASN1_TIME_new();
   if (s == (ASN1_TIME*)0x0) {
      LAB_00106900:bVar3 = false;
   }
 else {
      if (param_2 == 0) {
         pAVar2 = X509_time_adj_ex(s, param_3, param_4 * 0xe10 + param_5, (time_t*)0x0);
         if (pAVar2 == (ASN1_TIME*)0x0) goto LAB_00106900;
      }
 else {
         iVar1 = ASN1_TIME_set_string_X509(s, param_2);
         if (iVar1 == 0) goto LAB_00106900;
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 *app_params_new_from_opts(long param_1, undefined8 param_2) {
   int iVar1;
   undefined8 *puVar2;
   size_t sVar3;
   char *str;
   ...
   if (param_1 != 0) {
      uVar8 = (ulong)iVar1;
      puVar2 = (undefined8*)CRYPTO_zalloc(( uVar8 * 5 + 5 ) * 8, "apps/lib/apps.c", 0xd84);
         ...
         if (uVar8 != 0) {
            ...
            do {
               ...
               if (( pcVar4 == (char*)0x0 ) || ( pcVar5 = strchr(pcVar4, 0x3a) ),pcVar5 == (char*)0x0) {
                  LAB_00106aee:CRYPTO_free(pcVar4);
                  pcVar4 = "unknown";
                  if (local_44 != 0) {
                     pcVar4 = "error";
                  }
                  ...
                  ERR_print_errors(_bio_err);
                  app_params_free(puVar2);
                  goto LAB_00106b4f;
               }

               *pcVar5 = '\0';
               sVar3 = strlen(pcVar5 + 1);
               iVar1 = OSSL_PARAM_allocate_from_text(puVar6, param_2, pcVar4, pcVar5 + 1, sVar3, &local_44);
               if (iVar1 == 0) goto LAB_00106aee;
               uVar7 = uVar7 + 1;
               CRYPTO_free(pcVar4);
               puVar6 = puVar6 + 5;
            }
 while ( uVar8 != uVar7 );
            puVar6 = puVar2 + uVar8 * 5;
         }
   ...
   LAB_00106b4f:puVar2 = (undefined8*)0x0;
   LAB_00106b52:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

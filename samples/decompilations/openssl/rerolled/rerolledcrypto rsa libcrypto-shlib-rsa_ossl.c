...
;
   for (int i = 0; i < 3; i++) {
      BN_MONT_CTX_free(*(BN_MONT_CTX**)( param_1 + ( 8*i + 168 ) ));
   }
...
undefined8 rsa_ossl_mod_exp(BIGNUM *param_1, BIGNUM *param_2, long param_3, BN_CTX *param_4) {
   ...
   if (( r_00 != (BIGNUM*)0x0 ) && ( ( iVar2 = 0 * (int*)( param_3 + 0x10 ) != 1 || ( iVar2 = OPENSSL_sk_num(*(undefined8*)( param_3 + 0x88 )) - 1U < 3 ) ) )) {
      if (( *(uint*)( param_3 + 0xa4 ) & 4 ) == 0) {
         if (( *(uint*)( param_3 + 0xa4 ) & 2 ) != 0) {
            LAB_00100480:pBVar8 = BN_MONT_CTX_set_locked((BN_MONT_CTX**)( param_3 + 0xa8 ), (int)*(undefined8*)( param_3 + 0xd0 ), *(BIGNUM**)( param_3 + 0x28 ), param_4);
            if (pBVar8 == (BN_MONT_CTX*)0x0) goto LAB_00100360;
         }

         LAB_00100139:mod = BN_new();
         if (mod != (BIGNUM*)0x0) {
            ...
            iVar1 = ( **(code**)( *(long*)( param_3 + 0x18 ) + 0x30 ) )(pBVar4, rem, pBVar5, *(undefined8*)( param_3 + 0x48 ), param_4, *(undefined8*)( param_3 + 0xb8 ));
            if (iVar1 == 0) {
               BN_free(mod);
               BN_free(pBVar5);
            }
               ...
               if (iVar1 != 0) {
                  ...
                  iVar1 = ( **(code**)( *(long*)( param_3 + 0x18 ) + 0x30 ) )(param_1, rem, mod, *(undefined8*)( param_3 + 0x40 ), param_4, *(undefined8*)( param_3 + 0xb0 ));
                  if (iVar1 != 0) {
                     BN_free(mod);
                     if (iVar2 == 0) {
                        LAB_00100500:iVar1 = BN_sub(param_1, param_1, pBVar4);
                        if (( ( iVar1 != 0 ) && ( ( ( iVar1 = BN_is_negative(param_1) ),iVar1 == 0 || ( iVar1 = BN_add(param_1, param_1, *(BIGNUM**)( param_3 + 0x40 )) ),iVar1 != 0 ) ) && ( iVar1 = BN_mul(rem, param_1, *(BIGNUM**)( param_3 + 0x60 ), param_4) ),iVar1 != 0 )) {
                           ...
                           if (( ( iVar1 == 0 ) || ( iVar1 = BN_add(param_1, param_1, *(BIGNUM**)( param_3 + 0x40 )) ),iVar1 != 0 )) {
                              if (iVar2 != 0) {
                                 pBVar4 = BN_new();
                                 if (pBVar4 == (BIGNUM*)0x0) goto LAB_00100360;
                                 uVar10 = 0;
                                 do {
                                    puVar6 = (undefined8*)OPENSSL_sk_value(*(undefined8*)( param_3 + 0x88 ), uVar10 & 0xffffffff);
                                    iVar1 = BN_sub(rem, (BIGNUM*)local_58[uVar10], param_1);
                                    if (( iVar1 == 0 ) || ( iVar1 = iVar1 == 0 )) {
                                       LAB_001009ce:BN_free(pBVar4);
                                       goto LAB_00100360;
                                    }

                                    BN_with_flags(pBVar4, r, 4);
                                    iVar1 = BN_div((BIGNUM*)0x0, rem, pBVar4, (BIGNUM*)*puVar6, param_4);
                                    if (( iVar1 == 0 ) || ( ( ( ( iVar1 = BN_is_negative(rem) ),iVar1 != 0 && ( iVar1 = BN_add(rem, rem, (BIGNUM*)*puVar6) ),iVar1 == 0 ) ) || ( iVar1 = BN_mul(rem, rem, (BIGNUM*)puVar6[3], param_4) ),iVar1 == 0 )) goto LAB_001009ce;
                                    uVar10 = uVar10 + 1;
                                 }
 while ( (int)uVar10 < iVar2 );
                              ...
                              LAB_0010060f:if (( *(BIGNUM**)( param_3 + 0x30 ) != (BIGNUM*)0x0 ) && ( *(BIGNUM**)( param_3 + 0x28 ) != (BIGNUM*)0x0 )) {
                                 if (*(code**)( *(long*)( param_3 + 0x18 ) + 0x30 ) == BN_mod_exp_mont) {
                                    iVar2 = BN_mod_exp_mont(r_00, param_1, *(BIGNUM**)( param_3 + 0x30 ), *(BIGNUM**)( param_3 + 0x28 ), param_4, *(BN_MONT_CTX**)( param_3 + 0xa8 ));
                                 }
 else {
                                    bn_correct_top(param_1);
                                    iVar2 = ( **(code**)( *(long*)( param_3 + 0x18 ) + 0x30 ) )(r_00, param_1, *(undefined8*)( param_3 + 0x30 ), *(undefined8*)( param_3 + 0x28 ), param_4, *(undefined8*)( param_3 + 0xa8 ));
                                 }

                                 if (( iVar2 == 0 ) || ( iVar2 = iVar2 == 0 )) goto LAB_00100360;
                                 iVar2 = BN_is_zero();
                                 if (iVar2 == 0) {
                                    iVar2 = BN_div((BIGNUM*)0x0, r_00, r_00, *(BIGNUM**)( param_3 + 0x28 ), param_4);
                                    if (( iVar2 == 0 ) || ( ( iVar2 = BN_is_negative(r_00) ),iVar2 != 0 && ( iVar2 = BN_add(r_00, r_00, *(BIGNUM**)( param_3 + 0x28 )) ),iVar2 == 0 )) goto LAB_00100360;
                                    iVar2 = BN_is_zero(r_00);
                                    if (iVar2 == 0) {
                                       mod = BN_new();
                                       if (mod == (BIGNUM*)0x0) goto LAB_00100360;
                                       BN_with_flags(mod, *(undefined8*)( param_3 + 0x38 ), 4);
                                       iVar2 = ( **(code**)( *(long*)( param_3 + 0x18 ) + 0x30 ) )(param_1, param_2, mod, *(undefined8*)( param_3 + 0x28 ), param_4, *(undefined8*)( param_3 + 0xa8 ));
                     ...
                     if (pBVar5 != (BIGNUM*)0x0) {
                        ...
                        if (mod != (BIGNUM*)0x0) {
                           do {
                              ...
                              if (( iVar1 == 0 ) || ( iVar1 = ( **(code**)( *(long*)( param_3 + 0x18 ) + 0x30 ) )(pBVar7, rem, mod, *puVar6, param_4, puVar6[4]) ),iVar1 == 0) goto LAB_00100344;
                              uVar10 = uVar10 + 1;
                           }
 while ( uVar10 != (long)iVar2 );
                     ...
                     LAB_00100344:BN_free(pBVar5);
                  }

               }

               LAB_00100358:BN_free(mod);
            }
         ...
         pBVar8 = BN_MONT_CTX_set_locked((BN_MONT_CTX**)( param_3 + 0xb0 ), (int)*(undefined8*)( param_3 + 0xd0 ), mod, param_4);
         if (pBVar8 != (BN_MONT_CTX*)0x0) {
            BN_with_flags(mod, *(undefined8*)( param_3 + 0x48 ), 4);
            pBVar8 = BN_MONT_CTX_set_locked((BN_MONT_CTX**)( param_3 + 0xb8 ), (int)*(undefined8*)( param_3 + 0xd0 ), mod, param_4);
            if (pBVar8 != (BN_MONT_CTX*)0x0) {
               iVar1 = 0;
               if (iVar2 != 0) {
                  do {
                     ...
                     pBVar8 = BN_MONT_CTX_set_locked((BN_MONT_CTX**)( puVar6 + 4 ), (int)*(undefined8*)( param_3 + 0xd0 ), mod, param_4);
                     if (pBVar8 == (BN_MONT_CTX*)0x0) goto LAB_00100457;
                     iVar1 = iVar1 + 1;
                  }
 while ( iVar2 != iVar1 );
                  BN_free(mod);
                  LAB_00100470:if (( *(byte*)( param_3 + 0xa4 ) & 2 ) != 0) goto LAB_00100480;
                  goto LAB_00100139;
               }
               ...
               if (( ( ( ( ( ( ( *(byte*)( param_3 + 0xa4 ) & 2 ) != 0 ) && ( pBVar8 = BN_MONT_CTX_set_locked((BN_MONT_CTX**)( param_3 + 0xa8 ), (int)*(undefined8*)( param_3 + 0xd0 ), *(BIGNUM**)( param_3 + 0x28 ), param_4) ),pBVar8 == (BN_MONT_CTX*)0x0 ) ) || ( iVar2 = bn_from_mont_fixed_top(pBVar4, param_2, *(undefined8*)( param_3 + 0xb8 ), param_4) ),iVar2 == 0 ) ) || ( ( iVar2 = bn_to_mont_fixed_top(pBVar4, pBVar4, *(undefined8*)( param_3 + 0xb8 ), param_4) ),iVar2 == 0 || ( iVar2 = bn_from_mont_fixed_top(rem, param_2, *(undefined8*)( param_3 + 0xb0 ), param_4) ),iVar2 == 0 ) )) ( ( iVar2 = bn_to_mont_fixed_top(rem, rem, *(undefined8*)( param_3 + 0xb0 ), param_4) ),iVar2 == 0 || ( ( iVar2 = BN_mod_exp_mont_consttime_x2(pBVar4, pBVar4, *(undefined8*)( param_3 + 0x58 ), *(undefined8*)( param_3 + 0x48 ), *(undefined8*)( param_3 + 0xb8 ), rem, rem, *(undefined8*)( param_3 + 0x50 ), *(undefined8*)( param_3 + 0x40 ), *(undefined8*)( param_3 + 0xb0 ), param_4) ),iVar2 == 0 || ( iVar2 = bn_mod_sub_fixed_top(rem, rem, pBVar4, *(undefined8*)( param_3 + 0x40 )) ),iVar2 == 0 ) ) || ( iVar2 = iVar2 == 0 ) || ( ( ( iVar2 = bn_mul_mont_fixed_top(rem, rem, *(undefined8*)( param_3 + 0x60 ), *(undefined8*)( param_3 + 0xb0 ), param_4) ),iVar2 == 0 || ( iVar2 = bn_mul_fixed_top(param_1, rem, *(undefined8*)( param_3 + 0x48 ), param_4) ),iVar2 == 0 ) ) || ( iVar2 = iVar2 == 0 );
               goto LAB_0010060f;
            }

         }

         LAB_00100457:BN_free(mod);
      }

   }

   LAB_00100360:uVar9 = 0;
   LAB_00100362:BN_CTX_end(param_4);
...
int rsa_ossl_public_decrypt(int param_1, uchar *param_2, uchar *param_3, long param_4, int param_5) {
   ...
   if (iVar1 < 1) {
      ERR_new();
      uVar6 = 0x2d0;
      LAB_00100c63:ERR_set_debug("crypto/rsa/rsa_ossl.c", uVar6, "rsa_ossl_public_decrypt");
      ERR_set_error(4, 0x65, 0);
      return -1;
   }

   iVar1 = BN_num_bits(*(BIGNUM**)( param_4 + 0x28 ));
   if (( 0xc00 < iVar1 ) && ( iVar1 = 0x40 < iVar1 )) {
      ERR_new();
      uVar6 = 0x2d7;
      goto LAB_00100c63;
   }
         ...
         if (pBVar3 != (BIGNUM*)0x0) {
            ...
            if (iVar1 < 0) {
               ...
               if (( *(byte*)( param_4 + 0xa4 ) & 2 ) != 0) {
                  pBVar4 = BN_MONT_CTX_set_locked((BN_MONT_CTX**)( param_4 + 0xa8 ), (int)*(undefined8*)( param_4 + 0xd0 ), pBVar3, ctx);
                  if (pBVar4 == (BN_MONT_CTX*)0x0) goto LAB_00100d0c;
                  pBVar3 = *(BIGNUM**)( param_4 + 0x28 );
               }

               iVar1 = ( **(code**)( *(long*)( param_4 + 0x18 ) + 0x30 ) )(r, ret, *(undefined8*)( param_4 + 0x30 ), pBVar3, ctx, *(undefined8*)( param_4 + 0xa8 ));
               if (iVar1 != 0) {
                  if (param_5 == 5) {
                     puVar5 = (undefined8*)bn_get_words(r);
                     if (( ( ( ( uint ) * puVar5 & 0xf ) == 0xc ) || ( iVar1 = BN_sub(r, *(BIGNUM**)( param_4 + 0x28 ), r) ),iVar1 != 0 )) {
                        iVar1 = RSA_padding_check_X931(param_3, iVar2, f, iVar1, iVar2);
                        LAB_00100dd8:if (iVar1 < 0) {
                           ERR_new();
   ...
   LAB_00100d0c:iVar1 = -1;
   LAB_00100ca2:BN_CTX_end(ctx);
   BN_CTX_free(ctx);
   CRYPTO_clear_free(f, lVar7, "crypto/rsa/rsa_ossl.c", 0x321);
   return iVar1;
}
undefined4 rsa_ossl_public_encrypt(int param_1, uchar *param_2, undefined8 param_3, long param_4, int param_5) {
   int iVar1;
   int iVar2;
   undefined4 uVar3;
   BN_CTX *ctx;
   ...
   if (iVar1 < 1) {
      ERR_new();
      uVar7 = 0x71;
      LAB_001010a3:ERR_set_debug("crypto/rsa/rsa_ossl.c", uVar7, "rsa_ossl_public_encrypt");
      ERR_set_error(4, 0x65, 0);
      return 0xffffffff;
   }
   ...
   if (( pBVar4 != (BIGNUM*)0x0 ) && ( to != (uchar*)0x0 )) {
      if (param_5 == 3) {
         ...
         iVar2 = ossl_rsa_padding_add_PKCS1_OAEP_mgf1_ex(*(undefined8*)( param_4 + 8 ), to, iVar1, param_2, param_1, 0, 0, 0, 0);
      }
 else {
         if (param_5 != 1) {
            ERR_new();
         ...
         iVar2 = ossl_rsa_padding_add_PKCS1_type_2_ex(*(undefined8*)( param_4 + 8 ), to, iVar1, param_2, param_1);
      }
      ...
      if (( 0 < iVar2 ) && ( pBVar5 = BN_bin2bn(to, iVar1, ret) ),pBVar5 != (BIGNUM*)0x0) {
         ...
         if (iVar2 < 0) {
            ...
            if (( *(byte*)( param_4 + 0xa4 ) & 2 ) != 0) {
               pBVar6 = BN_MONT_CTX_set_locked((BN_MONT_CTX**)( param_4 + 0xa8 ), (int)*(undefined8*)( param_4 + 0xd0 ), pBVar5, ctx);
               if (pBVar6 == (BN_MONT_CTX*)0x0) goto LAB_00101077;
               pBVar5 = *(BIGNUM**)( param_4 + 0x28 );
            }

            iVar2 = ( **(code**)( *(long*)( param_4 + 0x18 ) + 0x30 ) )(pBVar4, ret, *(undefined8*)( param_4 + 0x30 ), pBVar5, ctx, *(undefined8*)( param_4 + 0xa8 ));
            if (iVar2 != 0) {
   ...
   LAB_00101077:uVar3 = 0xffffffff;
   LAB_001010e2:BN_CTX_end(ctx);
   BN_CTX_free(ctx);
...
BIGNUM *rsa_get_blinding_constprop_0(RSA *param_1, undefined4 *param_2, BN_CTX *param_3) {
   ...
   if (pBVar2 == (BIGNUM*)0x0) {
      ...
      pBVar2 = (BIGNUM*)param_1[1].engine;
      if (pBVar2 != (BIGNUM*)0x0) goto LAB_001012af;
      pBVar2 = (BIGNUM*)RSA_setup_blinding(param_1, param_3);
      param_1[1].engine = (ENGINE*)pBVar2;
      if (pBVar2 != (BIGNUM*)0x0) goto LAB_001012af;
   }
 else {
      LAB_001012af:iVar1 = BN_BLINDING_is_current_thread(pBVar2);
      if (iVar1 != 0) {
         *param_2 = 1;
         pBVar3 = param_1[1].e;
         goto LAB_001012da;
      ...
      *param_2 = 0;
      pBVar3 = param_1[1].e;
      if (pBVar2 != (BIGNUM*)0x0) goto LAB_001012da;
   ...
   pBVar3 = param_1[1].e;
   LAB_001012da:CRYPTO_THREAD_unlock(pBVar3);
   return pBVar2;
}
ulong rsa_ossl_private_decrypt(int param_1, uchar *param_2, uchar *param_3, long param_4, int param_5) {
      ...
      if (iVar8 < param_1) {
         ...
         if (pBVar4 != (BIGNUM*)0x0) {
            ...
            if (iVar1 < 0) {
               ...
               if (( uVar2 & 2 ) != 0) {
                  pBVar5 = BN_MONT_CTX_set_locked((BN_MONT_CTX**)( param_4 + 0xa8 ), (int)*(undefined8*)( param_4 + 0xd0 ), *(BIGNUM**)( param_4 + 0x28 ), ctx);
                  if (pBVar5 == (BN_MONT_CTX*)0x0) goto LAB_0010187b;
                  uVar2 = *(uint*)( param_4 + 0xa4 );
               }
               ...
               if (( uVar2 & 0x80 ) == 0) {
                  local_a8 = (BIGNUM*)0x0;
                  b = (BN_BLINDING*)rsa_get_blinding_constprop_0(param_4, &local_90, ctx);
                  ...
                  if (local_90 != 0) {
                     iVar1 = BN_BLINDING_convert_ex(pBVar3, (BIGNUM*)0x0, b, ctx);
                     LAB_0010189c:if (iVar1 == 0) goto LAB_0010187b;
                     uVar2 = *(uint*)( param_4 + 0xa4 );
                     goto LAB_0010151b;
                  }

                  local_a8 = BN_CTX_get(ctx);
                  if (local_a8 != (BIGNUM*)0x0) {
                     iVar1 = BN_BLINDING_lock(b);
                     if (iVar1 == 0) goto LAB_0010187b;
                     iVar1 = BN_BLINDING_convert_ex(pBVar3, local_a8, b, ctx);
                  ...
                  ERR_new();
                  uVar7 = 0x26a;
                  LAB_00101da5:ERR_set_debug("crypto/rsa/rsa_ossl.c", uVar7, "rsa_ossl_private_decrypt");
                  ERR_set_error(4, 0x80003, 0);
               }
 else {
                  LAB_0010151b:if (( ( ( uVar2 & 0x20 ) == 0 ) && ( *(int*)( param_4 + 0x10 ) != 1 ) ) && ( ( ( *(long*)( param_4 + 0x40 ) == 0 || ( ( ( *(long*)( param_4 + 0x48 ) == 0 || ( *(long*)( param_4 + 0x50 ) == 0 ) ) || ( *(long*)( param_4 + 0x58 ) == 0 ) ) ) ) || ( *(long*)( param_4 + 0x60 ) == 0 ) ) )) {
                     pBVar4 = BN_new();
                     if (pBVar4 == (BIGNUM*)0x0) {
                        ERR_new();
                        uVar7 = 0x27c;
                     ...
                     if (*(long*)( param_4 + 0x38 ) == 0) {
                        ...
                        iVar1 = ( **(code**)( *(long*)( param_4 + 0x18 ) + 0x30 ) )(n, pBVar3, pBVar4, *(undefined8*)( param_4 + 0x28 ), ctx);
                        if (iVar1 != 0) {
                           BN_free(pBVar4);
                           goto LAB_00101542;
                        }
                     ...
                     if (iVar1 != 0) {
                        LAB_00101542:if (b != (BN_BLINDING*)0x0) {
                           BN_set_flags(n, 4);
                           iVar1 = BN_BLINDING_invert_ex(n, local_a8, b, ctx);
                           if (iVar1 == 0) goto LAB_0010187b;
                        }
                        ...
                        if (param_5 == 1) {
                           ...
                           if (pBVar3 == (BIGNUM*)0x0) {
                              ...
                              uVar7 = 0x8000f;
                              LAB_00101b6a:ERR_set_error(4, uVar7, 0);
                              HMAC_CTX_free(0);
                              EVP_MD_free(0);
                           }
 else {
                                       ...
                                       if (ctx_00 != (HMAC_CTX*)0x0) {
                                          ...
                                          if (iVar1 < 1) {
                                             ...
                                             if (iVar1 < 1) {
                                                ...
                                                local_8c = 0x20;
                                                iVar1 = HMAC_Final(ctx_00, local_88, &local_8c);
                                                if (0 < iVar1) {
                                                   HMAC_CTX_free(ctx_00);
                                                   EVP_MD_free(type);
                                                   iVar1 = BN_bn2binpad(n, data, iVar8);
                                                   if (-1 < iVar1) {
                                                      uVar2 = ossl_rsa_padding_check_PKCS1_type_2(*(undefined8*)( param_4 + 8 ), param_3, iVar8, data, iVar1, iVar8, local_88);
                                                      uVar6 = (ulong)uVar2;
                                                      goto LAB_001018d2;
                                                   }
                                          ...
                                          LAB_001017c0:ERR_set_debug("crypto/rsa/rsa_ossl.c", uVar7, "derive_kdk");
                                          ERR_set_error(4, 0xc0103, 0);
                                          HMAC_CTX_free(ctx_00);
                                          EVP_MD_free(type);
                                          goto LAB_0010187b;
                           ...
                           if (-1 < (int)uVar2) {
                              if (param_5 == 4) {
                                 uVar2 = RSA_padding_check_PKCS1_OAEP(param_3, iVar8, data, uVar2, iVar8, (uchar*)0x0, 0);
                                 uVar6 = (ulong)uVar2;
                              }
 else if (param_5 == 8) {
   ...
   LAB_0010187b:uVar6 = 0xffffffff;
   LAB_0010190d:BN_CTX_end(ctx);
   BN_CTX_free(ctx);
...
undefined4 rsa_ossl_private_encrypt(int param_1, uchar *param_2, undefined8 param_3, long param_4, int param_5) {
   int iVar1;
   int iVar2;
   uint uVar3;
   undefined4 uVar4;
   ...
   if (( n != (BIGNUM*)0x0 ) && ( to != (uchar*)0x0 )) {
      ...
      if (( 0 < iVar1 ) && ( pBVar5 = BN_bin2bn(to, iVar2, ret) ),pBVar5 != (BIGNUM*)0x0) {
         ...
         if (iVar1 < 0) {
            ...
            if (( uVar3 & 2 ) != 0) {
               pBVar6 = BN_MONT_CTX_set_locked((BN_MONT_CTX**)( param_4 + 0xa8 ), (int)*(undefined8*)( param_4 + 0xd0 ), *(BIGNUM**)( param_4 + 0x28 ), ctx);
               if (pBVar6 == (BN_MONT_CTX*)0x0) goto LAB_0010208e;
               uVar3 = *(uint*)( param_4 + 0xa4 );
            }
            ...
            if (( uVar3 & 0x80 ) == 0) {
               ...
               if (local_44 != 0) {
                  ...
                  LAB_00102164:if (iVar1 == 0) goto LAB_0010208e;
                  uVar3 = *(uint*)( param_4 + 0xa4 );
                  goto LAB_00101f2f;
               }
               ...
               if (local_60 != (BIGNUM*)0x0) {
                  iVar1 = BN_BLINDING_lock(b);
                  if (iVar1 == 0) goto LAB_0010208e;
                  iVar1 = BN_BLINDING_convert_ex(ret, local_60, b, ctx);
                  BN_BLINDING_unlock(b);
                  goto LAB_00102164;
               }
               ...
               ERR_new();
               uVar7 = 0x173;
               LAB_00102307:ERR_set_debug("crypto/rsa/rsa_ossl.c", uVar7, "rsa_ossl_private_encrypt");
               ERR_set_error(4, 0x80003, 0);
            }
 else {
               LAB_00101f2f:if (( ( ( uVar3 & 0x20 ) == 0 ) && ( *(int*)( param_4 + 0x10 ) != 1 ) ) && ( ( ( *(long*)( param_4 + 0x40 ) == 0 || ( ( ( *(long*)( param_4 + 0x48 ) == 0 || ( *(long*)( param_4 + 0x50 ) == 0 ) ) || ( *(long*)( param_4 + 0x58 ) == 0 ) ) ) ) || ( *(long*)( param_4 + 0x60 ) == 0 ) ) )) {
                  pBVar5 = BN_new();
                  if (pBVar5 == (BIGNUM*)0x0) {
                     ERR_new();
                     uVar7 = 0x184;
                  ...
                  if (*(long*)( param_4 + 0x38 ) == 0) {
                     ...
                     iVar1 = ( **(code**)( *(long*)( param_4 + 0x18 ) + 0x30 ) )(n, ret, pBVar5, *(undefined8*)( param_4 + 0x28 ), ctx, *(undefined8*)( param_4 + 0xa8 ));
                     if (iVar1 != 0) {
                        BN_free(pBVar5);
                        goto LAB_00101f8d;
                     }
                  ...
                  if (iVar1 != 0) {
                     LAB_00101f8d:if (b != (BN_BLINDING*)0x0) {
                        BN_set_flags(n, 4);
   ...
   LAB_0010208e:uVar4 = 0xffffffff;
   LAB_00101fd7:BN_CTX_end(ctx);
   BN_CTX_free(ctx);
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked */RSA_METHOD *RSA_get_default_method(void) {
   return (RSA_METHOD*)default_RSA_meth;
}
undefined1 *RSA_PKCS1_OpenSSL(void) {
   return rsa_pkcs1_ossl_meth;
}
/* WARNING: Unknown calling convention -- yet parameter storage is locked */RSA_METHOD *RSA_null_method(void) {

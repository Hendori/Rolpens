...
void tls_get_peer_pkey(long param_1) {
   long lVar1;
   if (( *(long*)( *(long*)( param_1 + 0x900 ) + 0x2b8 ) == 0 ) && ( lVar1 = lVar1 != 0 )) {
...
undefined8 tls_process_rpk(long param_1, long *param_2, undefined8 *param_3) {
   ...
   uVar9 = param_2[1];
   local_68 = (void*)0x0;
   if (( ( ( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) != 0 ) || ( iVar8 = iVar8 < 0x304 ) ) || ( iVar8 == 0x10000 )) goto LAB_00101a48;
   if (uVar9 == 0) {
      ...
      *param_2 = (long)( pbVar12 + uVar10 );
      ...
      if (*(void**)( param_1 + 0xbb0 ) != (void*)0x0) {
         if (( *(ulong*)( param_1 + 3000 ) != uVar10 ) || ( iVar8 = iVar8 != 0 )) {
            ERR_new();
            uVar11 = 0x4b9;
            goto LAB_00101cb1;
         }
         ...
         LAB_00101a48:if (uVar9 < 3) {
            ...
            *param_2 = (long)pbVar12;
            ...
            uVar13 = uVar14;
            if (( ( ( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) != 0 ) || ( iVar8 = iVar8 == 0x10000 ) ) || ( iVar8 < 0x304 )) {
               ...
               *param_2 = (long)( pbVar12 + uVar13 );
               ...
               if (( pkey == (EVP_PKEY*)0x0 ) || ( local_60 != pbVar12 + uVar13 )) {
                  ...
                  if (iVar8 == 0) {
                     if (( ( ( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) != 0 ) || ( iVar8 = iVar8 < 0x304 ) ) || ( iVar8 == 0x10000 )) {
                     ...
                     if (uVar13 == param_2[1]) {
                        ...
                        *param_2 = (long)local_58 + uVar13;
                        ...
                        if (( iVar8 != 0 ) && ( iVar8 = iVar8 != 0 )) goto LAB_00101e00;
                     }
 else {
                        ERR_new();
...
bool ssl_version_supported(long param_1, ulong param_2, undefined8 *param_3) {
   ...
   do {
      ...
      if (( pcVar9 != (code*)0x0 ) && ( iVar3 = iVar3 == 0 )) {
         uVar5 = ( *pcVar9 )();
         ...
         *param_3 = 0;
         ...
         LAB_00103908:do {
            if (*(code**)( piVar6 + 2 ) == (code*)0x0) {
               ...
               iVar3 = *piVar4;
               if (( ( ( ( *(int*)( param_1 + 0x9bc ) == 0 ) || ( iVar2 = ssl_version_cmp(param_1, iVar3) ),-1 < iVar2 ) ) && ( iVar2 = ssl_security(param_1, 9, 0, iVar3, 0) ),iVar2 != 0 )) &&( ( *(int*)( param_1 + 0x9c0 ) == 0 || ( iVar3 = iVar3 < 1 ) ) ) && ( ( ( *(ulong*)( param_1 + 0x9b0 ) & *(ulong*)( piVar4 + 2 ) ) == 0 && ( ( ( *(byte*)( piVar4 + 1 ) & 2 ) == 0 || ( ( *(uint*)( *(long*)( param_1 + 0x880 ) + 0x1c ) & 0x30000 ) == 0 ) ) ) ) )(bVar1);
               {
...
undefined8 ssl_set_client_hello_version(long param_1) {
 ...
 else if (( local_14 == 0x100 ) && ( iVar2 = iVar2 == 0 )) goto LAB_0010420e;

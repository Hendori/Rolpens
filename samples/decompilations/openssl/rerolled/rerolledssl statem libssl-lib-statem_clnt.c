bool tls_construct_client_hello(SSL *param_1, undefined8 param_2) {
 ...
 while ( iVar5 != iVar6 );
               ...
               if (( *(int*)&param_1[3].cipher_list_by_id == 0 ) && ( iVar5 = iVar5 < 1 )) {
                  ERR_new();
                  pcVar13 = "tls_construct_client_hello";
                  uVar15 = 0x4f7;
                  goto LAB_00100351;
                  ...
                  if (0 < iVar3) {
                     ...
                     if (iVar3 < 1) {
                        ...
                        if (0 < iVar3) {
                           ...
                           if (( ( iVar3 != 0 ) && ( ( local_170 < 0x80 || ( iVar3 = iVar3 != 0 ) ) ) ) && ( iVar3 = iVar3 != 0 )) {
   ...
   if (bVar7) {
      ...
      *param_2 = (long)( pbVar1 + 3 );
      ...
      if (lVar11 == 0) {
         ...
         if (( iVar9 == 0 ) || ( iVar9 = iVar9 == 0 )) goto LAB_0010284e;
      ...
      *(ulong*)( lVar10 + 0x330 ) = uVar18;
      if (( ( ( *(byte*)( lVar5 + 0x50 ) & 8 ) == 0 ) && ( iVar8 = *piVar3 ),iVar8 != 0x10000 )) {
         ...
         *param_2 = (long)local_58 + uVar13;
         ...
         if (( iVar8 == 0 ) || ( iVar8 = iVar8 == 0 )) goto LAB_00104676;
      }
      ...
      if (iVar8 != 0) {
         ...
         *(ulong*)( lVar10 + 0x250 ) = (ulong)local_58 & 0xffffffff;
         if (( ( ( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) != 0 ) || ( iVar8 = iVar8 < 0x304 ) ) || ( iVar8 == 0x10000 )) goto LAB_00104990;
                              ...
                              if (( ( ( local_88 == 0 ) || ( iVar11 = OSSL_PARAM_BLD_push_BN(local_88, &_LC5, pBVar14) ),iVar11 == 0 ) ) || ( iVar11 = iVar11 == 0 )) {
                                 ...
                                 if (local_78 == (EVP_PKEY_CTX*)0x0) {
                                    ...
                                    if (( iVar11 < 1 ) || ( iVar11 = iVar11 < 1 )) {
                                       ...
                                       if (( ( local_78 == (EVP_PKEY_CTX*)0x0 ) || ( iVar11 = iVar11 != 1 ) ) || ( iVar11 = EVP_PKEY_public_check(local_78) ),pEVar9 = local_48,iVar11 != 1) {
                                          ERR_new();

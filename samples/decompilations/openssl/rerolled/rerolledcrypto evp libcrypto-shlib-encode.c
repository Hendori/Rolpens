...
;
      ...
      if (param_4 == 4) {
         ...
         do {
            if ((char)*param_3 < '\0') {
               ...
               LAB_001001f9:uVar5 = (ulong)(byte)puVar9[bVar1];
               bVar1 = param_3[2];
               bVar2 = param_3[3];
            }
 else {
 ...
 while ( iVar7 != iVar10 );
   ...
   if (-1 < (char)param_3[2]) {
      if (( -1 < (char)param_3[3] ) && ( -1 < (char)( puVar9[param_3[3]] | puVar9[param_3[2]] | (byte)uVar6 | (byte)uVar5 ) )) {
         uVar6 = (ulong)(byte)puVar9[param_3[2]] << 6 | (ulong)(byte)puVar9[param_3[3]] | uVar6 << 0x12 | uVar5 << 0xc;
         if (param_5 == -1) {
...
void EVP_EncodeUpdate(EVP_ENCODE_CTX *ctx, uchar *out, int *outl, uchar *in, int inl) {
   ...
   *outl = 0;
   ...
   if (0x50 < iVar3) {
      ...
      OPENSSL_die("assertion failed: ctx->length <= (int)sizeof(ctx->enc_data)", "crypto/evp/encode.c", 0xab);
      if (*(int*)pcVar7 != 0) {
...
;
 ...
 while ( ( uVar10 < uVar9 ) && ( out = ctx.length <= inl ) );
      }

      LAB_00100550:if (0x7fffffff < uVar10) {
         *outl = 0;
         return;
      }
...
int EVP_DecodeUpdate(EVP_ENCODE_CTX *ctx, uchar *out, int *outl, uchar *in, int inl) {
   ...
   if (0 < inl) {
      pbVar4 = in + inl;
      inl = 0;
      LAB_0010077d:bVar5 = *in;
      in = in + 1;
      if (( (char)bVar5 < '\0' ) || ( bVar6 = bVar6 == 0xff )) {
         LAB_00100890:uVar7 = 0xffffffff;
         goto LAB_001007ee;
      }
      ...
      if (0 < iVar20) {
         ...
         LAB_00100af0:bVar22 = true;
         if (0 < (int)uVar13) goto LAB_001007dd;
         goto LAB_00100b02;
      }

      LAB_00100812:if (bVar6 == 0xf2) goto LAB_00100af0;
      if (( bVar6 | 0x13 ) != 0xf3) {
      ...
      if (uVar13 == 0x40) {
         if (iVar20 + 1U < 4) {
            LAB_00100848:puVar17 = srpdata_ascii2bin;
            puVar16 = puVar1;
            if (( ctx.expect_nl & 2 ) == 0) {
 ...
 while ( puVar16 != ctx.enc_data + 0x40 );
   ...
   inl = 0;
   LAB_00100b75:uVar7 = 1;
   LAB_001007ee:*outl = inl;
   ctx.num = uVar13;
   return uVar7;
   LAB_00100916:if (( (char)puVar16[uVar11 - 1] < '\0' ) || ( ( puVar17[puVar16[uVar11 - 1]] | 0x13 ) != 0xf3 )) goto LAB_0010091f;
   uVar11 = uVar11 - 1;
   if ((int)uVar11 < 4) goto LAB_001008d4;
   goto LAB_00100916;
   LAB_0010091f:if (( uVar11 & 3 ) != 0) goto LAB_001008d4;
   if ((int)uVar11 == 4) {
      iVar8 = 0;
      puVar18 = local_48;
      puVar21 = puVar16;
      ...
      do {
         if ((char)*puVar16 < '\0') {
            ...
            LAB_001009f8:uVar14 = 0xff;
         }
 else {
            uVar11 = (ulong)(byte)puVar17[*puVar16];
            bVar5 = puVar16[1];
            if ((char)bVar5 < '\0') goto LAB_001009f8;
            LAB_00100961:uVar14 = (ulong)(byte)puVar17[bVar5];
         }
         ...
         puVar16 = puVar16 + 4;
         if (( (char)*puVar3 < '\0' ) || ( (char)( puVar17[*puVar2] | puVar17[*puVar3] | (byte)uVar11 | (byte)uVar14 ) < '\0' )) goto LAB_001008d4;
         puVar18 = puVar19 + 3;
         iVar8 = iVar8 + 3;
 ...
 while ( puVar16 != puVar21 );
   ...
   if (( (char)puVar21[3] < '\0' ) || ( (char)( puVar17[puVar21[2]] | puVar17[puVar21[3]] | (byte)uVar11 | local_40 ) < '\0' )) goto LAB_001008d4;
   uVar11 = (ulong)(byte)puVar17[puVar21[2]] << 6 | (ulong)(byte)puVar17[puVar21[3]] | uVar11 << 0x12 | (ulong)local_40 << 0xc;
   iVar15 = iVar20;
   if (iVar20 == -1) {
   ...
   *puVar18 = ( uchar )(uVar11 >> 0x10);
   ...
   LAB_001007c9:if (in == pbVar4) goto code_r0x001007ce;
   goto LAB_0010077d;
   code_r0x001007ce:bVar22 = false;
   uVar7 = uVar13;
   if (0 < (int)uVar13) {
      LAB_001007dd:if (( uVar13 & 3 ) != 0) {
         uVar7 = -(uint)bVar22 | 1;
         goto LAB_001007ee;
      }

      LAB_00100b20:iVar8 = evp_decodeblock_int(ctx, local_48, puVar1, uVar13, iVar20);
      if (( iVar8 < 0 ) || ( ( iVar8 == 0 && ( 0 < iVar20 ) ) )) {
         LAB_001008d4:uVar13 = 0;
         uVar7 = 0xffffffff;
         goto LAB_001007ee;
      }
   ...
   uVar13 = uVar7;
   bVar22 = iVar20 == 0;
   LAB_00100b56:if (( uVar13 == 0 ) && ( !bVar22 )) {
      uVar13 = 0;
      uVar7 = 0;
      goto LAB_001007ee;
   }

...
/* WARNING: Control flow encountered bad instruction data *//* WARNING: Removing unreachable block (ram,0x00100fbb) *//* WARNING: Removing unreachable block (ram,0x001009a6) *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void ossl_aes_gcm_setiv_avx512(undefined1 (*param_1)[16], undefined1 (*param_2)[16], undefined1 (*param_3)[64], ulong param_4) {
      ...
      if (param_4 != 0) {
         ...
         if (1 < uVar34) {
            ...
            if (uVar34 == 2) {
               ...
               for (int i = 0; i < 27; i++) {
                  auVar42[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * SUB321(auVar43._0_32_, ( i + 2 ));
               }
            ...
            if (uVar34 < 4) {
               ...
               for (int i = 0; i < 54; i++) {
                  auVar44[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar42[( i + 2 )];
               }

               bVar5 = ( byte )(uVar3 >> 0x38);
               auVar44[0x38] = ( bVar5 & 1 ) * auVar42[0x38];
               for (int i = 0; i < 6; i++) {
                  auVar44[( i + 57 )] = ( bVar5 >> ( i + 1 ) & 1 ) * auVar42[( i + 57 )];
               }
            ...
            if (uVar34 == 4) {
               ...
               for (int i = 0; i < 54; i++) {
                  auVar45[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar42[( i + 2 )];
               }

               bVar5 = ( byte )(uVar3 >> 0x38);
               auVar45[0x38] = ( bVar5 & 1 ) * auVar42[0x38];
               for (int i = 0; i < 6; i++) {
                  auVar45[( i + 57 )] = ( bVar5 >> ( i + 1 ) & 1 ) * auVar42[( i + 57 )];
               }
            ...
            if (uVar34 < 6) {
               ...
               for (int i = 0; i < 14; i++) {
                  auVar35[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar36[( i + 2 )];
               }
            ...
            if (uVar34 == 6) {
               ...
               for (int i = 0; i < 27; i++) {
                  auVar57[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * SUB321(auVar56._0_32_, ( i + 2 ));
               }
            ...
            if (uVar34 < 8) {
               ...
               for (int i = 0; i < 54; i++) {
                  auVar55[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar43[( i + 2 )];
               }

               bVar5 = ( byte )(uVar3 >> 0x38);
               auVar55[0x38] = ( bVar5 & 1 ) * auVar43[0x38];
               for (int i = 0; i < 6; i++) {
                  auVar55[( i + 57 )] = ( bVar5 >> ( i + 1 ) & 1 ) * auVar43[( i + 57 )];
               }
            ...
            if (uVar34 == 8) {
               ...
               for (int i = 0; i < 54; i++) {
                  auVar54[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar43[( i + 2 )];
               }

               bVar5 = ( byte )(uVar3 >> 0x38);
               auVar54[0x38] = ( bVar5 & 1 ) * auVar43[0x38];
               for (int i = 0; i < 6; i++) {
                  auVar54[( i + 57 )] = ( bVar5 >> ( i + 1 ) & 1 ) * auVar43[( i + 57 )];
               }
            ...
            if (uVar34 < 10) {
               ...
               for (int i = 0; i < 14; i++) {
                  auVar39[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar35[( i + 2 )];
               }
            ...
            if (uVar34 == 10) {
               ...
               for (int i = 0; i < 27; i++) {
                  auVar53[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * SUB321(auVar52._0_32_, ( i + 2 ));
               }
            ...
            if (uVar34 < 0xc) {
               ...
               for (int i = 0; i < 54; i++) {
                  auVar51[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar44[( i + 2 )];
               }

               bVar5 = ( byte )(uVar3 >> 0x38);
               auVar51[0x38] = ( bVar5 & 1 ) * auVar44[0x38];
               for (int i = 0; i < 6; i++) {
                  auVar51[( i + 57 )] = ( bVar5 >> ( i + 1 ) & 1 ) * auVar44[( i + 57 )];
               }
            ...
            if (uVar34 == 0xc) {
               ...
               for (int i = 0; i < 54; i++) {
                  auVar50[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar44[( i + 2 )];
               }

               bVar5 = ( byte )(uVar3 >> 0x38);
               auVar50[0x38] = ( bVar5 & 1 ) * auVar44[0x38];
               for (int i = 0; i < 6; i++) {
                  auVar50[( i + 57 )] = ( bVar5 >> ( i + 1 ) & 1 ) * auVar44[( i + 57 )];
               }
            ...
            if (uVar34 < 0xe) {
               ...
               for (int i = 0; i < 14; i++) {
                  auVar36[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar35[( i + 2 )];
               }
            ...
            if (uVar34 == 0xe) {
               ...
               for (int i = 0; i < 27; i++) {
                  auVar49[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * SUB321(auVar48._0_32_, ( i + 2 ));
               }
            ...
            if (uVar34 == 0xf) {
               ...
               for (int i = 0; i < 54; i++) {
                  auVar47[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar45[( i + 2 )];
               }

               bVar5 = ( byte )(uVar3 >> 0x38);
               auVar47[0x38] = ( bVar5 & 1 ) * auVar45[0x38];
               for (int i = 0; i < 6; i++) {
                  auVar47[( i + 57 )] = ( bVar5 >> ( i + 1 ) & 1 ) * auVar45[( i + 57 )];
               }
            ...
            for (int i = 0; i < 54; i++) {
               auVar46[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar45[( i + 2 )];
            }

            bVar5 = ( byte )(uVar3 >> 0x38);
            auVar46[0x38] = ( bVar5 & 1 ) * auVar45[0x38];
            for (int i = 0; i < 6; i++) {
               auVar46[( i + 57 )] = ( bVar5 >> ( i + 1 ) & 1 ) * auVar45[( i + 57 )];
            }
         ...
         for (int i = 0; i < 14; i++) {
            auVar37[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar35[( i + 2 )];
         }
   ...
   if (iVar4 == 9) {
      ...
      for (int i = 0; i < 9; i++) {
         auVar35 = aesenc(auVar35, param_1[( i + 1 )]);
      }
   ...
   if (param_3 != 0) {
      ...
      if (1 < uVar19) {
         ...
         if (uVar19 == 2) {
            ...
            for (int i = 0; i < 27; i++) {
               auVar26[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * SUB321(auVar27._0_32_, ( i + 2 ));
            }
         ...
         if (uVar19 < 4) {
            ...
            for (int i = 0; i < 54; i++) {
               auVar28[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar27[( i + 2 )];
            }

            bVar4 = ( byte )(uVar3 >> 0x38);
            auVar28[0x38] = ( bVar4 & 1 ) * auVar27[0x38];
            for (int i = 0; i < 6; i++) {
               auVar28[( i + 57 )] = ( bVar4 >> ( i + 1 ) & 1 ) * auVar27[( i + 57 )];
            }
         ...
         if (uVar19 == 4) {
            ...
            for (int i = 0; i < 54; i++) {
               auVar29[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar27[( i + 2 )];
            }

            bVar4 = ( byte )(uVar3 >> 0x38);
            auVar29[0x38] = ( bVar4 & 1 ) * auVar27[0x38];
            for (int i = 0; i < 6; i++) {
               auVar29[( i + 57 )] = ( bVar4 >> ( i + 1 ) & 1 ) * auVar27[( i + 57 )];
            }
         ...
         if (uVar19 < 6) {
            ...
            for (int i = 0; i < 14; i++) {
               auVar21[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar22[( i + 2 )];
            }
         ...
         if (uVar19 == 6) {
            ...
            for (int i = 0; i < 27; i++) {
               auVar30[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * SUB321(auVar41._0_32_, ( i + 2 ));
            }
         ...
         if (uVar19 < 8) {
            ...
            for (int i = 0; i < 54; i++) {
               auVar40[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar28[( i + 2 )];
            }

            bVar4 = ( byte )(uVar3 >> 0x38);
            auVar40[0x38] = ( bVar4 & 1 ) * auVar28[0x38];
            for (int i = 0; i < 6; i++) {
               auVar40[( i + 57 )] = ( bVar4 >> ( i + 1 ) & 1 ) * auVar28[( i + 57 )];
            }
         ...
         if (uVar19 == 8) {
            ...
            for (int i = 0; i < 54; i++) {
               auVar39[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar28[( i + 2 )];
            }

            bVar4 = ( byte )(uVar3 >> 0x38);
            auVar39[0x38] = ( bVar4 & 1 ) * auVar28[0x38];
            for (int i = 0; i < 6; i++) {
               auVar39[( i + 57 )] = ( bVar4 >> ( i + 1 ) & 1 ) * auVar28[( i + 57 )];
            }
         ...
         if (9 < uVar19) {
            if (uVar19 == 10) {
               ...
               for (int i = 0; i < 27; i++) {
                  auVar38[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * SUB321(auVar37._0_32_, ( i + 2 ));
               }
            ...
            if (uVar19 < 0xc) {
               ...
               for (int i = 0; i < 54; i++) {
                  auVar36[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar29[( i + 2 )];
               }

               bVar4 = ( byte )(uVar3 >> 0x38);
               auVar36[0x38] = ( bVar4 & 1 ) * auVar29[0x38];
               for (int i = 0; i < 6; i++) {
                  auVar36[( i + 57 )] = ( bVar4 >> ( i + 1 ) & 1 ) * auVar29[( i + 57 )];
               }
            ...
            if (uVar19 == 0xc) {
               ...
               for (int i = 0; i < 54; i++) {
                  auVar35[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar29[( i + 2 )];
               }

               bVar4 = ( byte )(uVar3 >> 0x38);
               auVar35[0x38] = ( bVar4 & 1 ) * auVar29[0x38];
               for (int i = 0; i < 6; i++) {
                  auVar35[( i + 57 )] = ( bVar4 >> ( i + 1 ) & 1 ) * auVar29[( i + 57 )];
               }
            ...
            if (0xd < uVar19) {
               if (uVar19 == 0xe) {
                  ...
                  for (int i = 0; i < 27; i++) {
                     auVar34[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * SUB321(auVar33._0_32_, ( i + 2 ));
                  }
               ...
               if (uVar19 != 0xf) {
                  ...
                  for (int i = 0; i < 54; i++) {
                     auVar31[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar30[( i + 2 )];
                  }

                  bVar4 = ( byte )(uVar3 >> 0x38);
                  auVar31[0x38] = ( bVar4 & 1 ) * auVar30[0x38];
                  for (int i = 0; i < 6; i++) {
                     auVar31[( i + 57 )] = ( bVar4 >> ( i + 1 ) & 1 ) * auVar30[( i + 57 )];
                  }
               ...
               for (int i = 0; i < 54; i++) {
                  auVar32[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar30[( i + 2 )];
               }

               bVar4 = ( byte )(uVar3 >> 0x38);
               auVar32[0x38] = ( bVar4 & 1 ) * auVar30[0x38];
               for (int i = 0; i < 6; i++) {
                  auVar32[( i + 57 )] = ( bVar4 >> ( i + 1 ) & 1 ) * auVar30[( i + 57 )];
               }
            ...
            for (int i = 0; i < 14; i++) {
               auVar24[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar21[( i + 2 )];
            }
         ...
         for (int i = 0; i < 14; i++) {
            auVar22[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar21[( i + 2 )];
         }
      ...
      for (int i = 0; i < 14; i++) {
         auVar23[( i + 2 )] = ( ( byte )(uVar3 >> ( i + 2 )) & 1 ) * auVar21[( i + 2 )];
      }
   ...
   if (iVar89 == 9) {
      if (param_5 != 0) {
         ...
         if (uVar95 != 0) {
            ...
            for (int i = 0; i < 6; i++) {
               auVar105[( i + 2 )] = ( ( byte )(uVar1 >> ( i + 2 )) & 1 ) * auVar103[( i + 2 )];
            }

            bVar3 = ( byte )(uVar1 >> 8);
            auVar105[8] = ( bVar3 & 1 ) * auVar103[8];
            for (int i = 0; i < 6; i++) {
               auVar105[( i + 9 )] = ( bVar3 >> ( i + 1 ) & 1 ) * auVar103[( i + 9 )];
            }
         ...
         if (param_5 != 0) {
            ...
            if (7 < uVar96) {
               ...
               if (uVar96 == 0x10) {
                  ...
                  *(undefined4*)*param_1 = uVar2;
                  ...
                  vmovdqu8_avx512bw(*(undefined1(*) [64])( *param_4 + uVar95 ));
                  for (int i = 0; i < 3; i++) {
                     vmovdqu8_avx512bw(*(undefined1(*) [64])( param_4[( 4*i + 4 )] + uVar95 ));
                  }
            ...
            for (int i = 0; i < 6; i++) {
               auVar107[( i + 2 )] = ( ( byte )(uVar94 >> ( i + 2 )) & 1 ) * auVar108[( i + 2 )];
            }

            bVar3 = ( byte )(uVar94 >> 8);
            auVar107[8] = ( bVar3 & 1 ) * auVar108[8];
            for (int i = 0; i < 7; i++) {
               auVar107[( i + 9 )] = ( ( byte )(uVar94 >> ( i + 9 )) & 1 ) * auVar108[( i + 9 )];
            }
            ...
            for (int i = 0; i < 4; i++) {
               auVar103 = aesenc(auVar103, auVar117._0_16_);
               auVar117 = vbroadcastf64x2_avx512dq(*(undefined1(*) [16])( param_1[( i + 1 )] + 8 ));
               auVar103 = aesenc(auVar103, auVar117._0_16_);
               auVar117 = vbroadcastf64x2_avx512dq(param_1[( i + 2 )]);
            }
            ...
            *(undefined1(*) [16])( *param_6 + uVar95 ) = auVar103;
            ...
            for (int i = 0; i < 6; i++) {
               auVar103[( i + 2 )] = ( ( byte )(uVar94 >> ( i + 2 )) & 1 ) * auVar117[( i + 2 )];
            }

            auVar103[8] = ( bVar3 & 1 ) * auVar117[8];
            for (int i = 0; i < 7; i++) {
               auVar103[( i + 9 )] = ( ( byte )(uVar94 >> ( i + 9 )) & 1 ) * auVar117[( i + 9 )];
            }
      ...
      if (param_5 != 0) {
         ...
         if (uVar95 != 0) {
            ...
            for (int i = 0; i < 6; i++) {
               auVar99[( i + 2 )] = ( ( byte )(uVar1 >> ( i + 2 )) & 1 ) * auVar103[( i + 2 )];
            }

            bVar3 = ( byte )(uVar1 >> 8);
            auVar99[8] = ( bVar3 & 1 ) * auVar103[8];
            for (int i = 0; i < 6; i++) {
               auVar99[( i + 9 )] = ( bVar3 >> ( i + 1 ) & 1 ) * auVar103[( i + 9 )];
            }
         ...
         if (param_5 != 0) {
            ...
            for (int i = 0; i < 6; i++) {
               auVar100[( i + 2 )] = ( ( byte )(uVar94 >> ( i + 2 )) & 1 ) * auVar107[( i + 2 )];
            }

            bVar3 = ( byte )(uVar94 >> 8);
            auVar100[8] = ( bVar3 & 1 ) * auVar107[8];
            for (int i = 0; i < 7; i++) {
               auVar100[( i + 9 )] = ( ( byte )(uVar94 >> ( i + 9 )) & 1 ) * auVar107[( i + 9 )];
            }
            ...
            *(undefined1(*) [16])( *param_6 + uVar95 ) = auVar103;
            ...
            for (int i = 0; i < 6; i++) {
               auVar101[( i + 2 )] = ( ( byte )(uVar94 >> ( i + 2 )) & 1 ) * auVar117[( i + 2 )];
            }

            auVar101[8] = ( bVar3 & 1 ) * auVar117[8];
            for (int i = 0; i < 7; i++) {
               auVar101[( i + 9 )] = ( ( byte )(uVar94 >> ( i + 9 )) & 1 ) * auVar117[( i + 9 )];
            }
      ...
      if (param_5 != 0) {
         ...
         if (uVar95 != 0) {
            ...
            for (int i = 0; i < 6; i++) {
               auVar104[( i + 2 )] = ( ( byte )(uVar1 >> ( i + 2 )) & 1 ) * auVar103[( i + 2 )];
            }

            bVar3 = ( byte )(uVar1 >> 8);
            auVar104[8] = ( bVar3 & 1 ) * auVar103[8];
            for (int i = 0; i < 6; i++) {
               auVar104[( i + 9 )] = ( bVar3 >> ( i + 1 ) & 1 ) * auVar103[( i + 9 )];
            }
         ...
         if (param_5 != 0) {
            ...
            for (int i = 0; i < 6; i++) {
               auVar109[( i + 2 )] = ( ( byte )(uVar94 >> ( i + 2 )) & 1 ) * auVar107[( i + 2 )];
            }

            bVar3 = ( byte )(uVar94 >> 8);
            auVar109[8] = ( bVar3 & 1 ) * auVar107[8];
            for (int i = 0; i < 7; i++) {
               auVar109[( i + 9 )] = ( ( byte )(uVar94 >> ( i + 9 )) & 1 ) * auVar107[( i + 9 )];
            }
            ...
            *(undefined1(*) [16])( *param_6 + uVar95 ) = auVar103;
            ...
            for (int i = 0; i < 6; i++) {
               auVar110[( i + 2 )] = ( ( byte )(uVar94 >> ( i + 2 )) & 1 ) * auVar117[( i + 2 )];
            }

            auVar110[8] = ( bVar3 & 1 ) * auVar117[8];
            for (int i = 0; i < 7; i++) {
               auVar110[( i + 9 )] = ( ( byte )(uVar94 >> ( i + 9 )) & 1 ) * auVar117[( i + 9 )];
            }
   ...
   if (iVar89 == 9) {
      if (param_5 != 0) {
         ...
         if (param_5 != 0) {
            ...
            for (int i = 0; i < 14; i++) {
               auVar99[( i + 2 )] = ( ( byte )(uVar94 >> ( i + 2 )) & 1 ) * auVar107[( i + 2 )];
            }
            ...
            for (int i = 0; i < 4; i++) {
               auVar103 = aesenc(auVar103, auVar116._0_16_);
               auVar116 = vbroadcastf64x2_avx512dq(*(undefined1(*) [16])( param_1[( i + 1 )] + 8 ));
               auVar103 = aesenc(auVar103, auVar116._0_16_);
               auVar116 = vbroadcastf64x2_avx512dq(param_1[( i + 2 )]);
            }
      ...
      if (param_5 != 0) {
         ...
         if (uVar95 != 0) {
            ...
            for (int i = 0; i < 6; i++) {
               auVar100[( i + 2 )] = ( ( byte )(uVar1 >> ( i + 2 )) & 1 ) * auVar103[( i + 2 )];
            }

            bVar3 = ( byte )(uVar1 >> 8);
            auVar100[8] = ( bVar3 & 1 ) * auVar103[8];
            for (int i = 0; i < 6; i++) {
               auVar100[( i + 9 )] = ( bVar3 >> ( i + 1 ) & 1 ) * auVar103[( i + 9 )];
            }
         ...
         if (param_5 != 0) {
            ...
            for (int i = 0; i < 14; i++) {
               auVar101[( i + 2 )] = ( ( byte )(uVar94 >> ( i + 2 )) & 1 ) * auVar107[( i + 2 )];
            }

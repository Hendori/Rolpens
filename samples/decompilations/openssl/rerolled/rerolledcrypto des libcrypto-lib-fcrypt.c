char *DES_fcrypt(char *buf, char *salt, char *ret) {
      ...
      if ((int)cVar1 - 1U < 0x7f) {
         ...
         if (uVar6 < 8) {
            ...
            *(undefined8*)( (long)local_c8.ks + (ulong)uVar6 + lVar8 + 0x78 ) = 0;
            uVar6 = uVar6 + ( (int)puVar7 - (int)( ( ulong )(abStack_40 + lVar8) & 0xfffffffffffffff8 ) ) & 0xfffffff8;
            if (7 < uVar6) {
               uVar5 = 0;
               do {
                  uVar3 = (ulong)uVar5;
 ...
 while ( uVar5 < uVar6 );
         ...
         LAB_00100115:DES_set_key_unchecked(&local_48, &local_c8);
 ...
 while ( true );
   ...
   ret = (char*)0x0;
   goto LAB_00100377;
   LAB_00100370:ret[0xd] = '\0';
   LAB_00100377:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {

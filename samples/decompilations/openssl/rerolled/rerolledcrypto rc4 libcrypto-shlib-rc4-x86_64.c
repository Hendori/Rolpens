/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void RC4(RC4_KEY *key, size_t len, uchar *indata, uchar *outdata) {
   undefined2 uVar1;
   uint uVar2;
   undefined4 uVar3;
   undefined4 uVar4;
      ...
      if (( len & 0xfffffffffffffff8 ) != 0) {
         do {
            ...
            *(char*)( (long)key.data + uVar28 ) = cVar21;
            ...
            uVar7 = ( uint3 )(( ( uint )(byte)((byte)uVar3 ^ *(byte*)( (long)key.data + ( ulong )(byte)(cVar21 + cVar15) )) << 0x18 ) >> 8);
            ...
            *(char*)( (long)key.data + uVar17 ) = cVar15;
            ...
            uVar7 = uVar7 >> 8 | ( uint3 )(( uint )(CONCAT31(uVar7, ( byte )((uint)uVar3 >> 8) ^ *(byte*)( (long)key.data + ( ulong )(byte)(cVar15 + cVar22) )) << 0x18) >> 8);
            ...
            *(char*)( (long)key.data + uVar28 ) = cVar15;
            ...
            uVar7 = uVar7 >> 8 | ( uint3 )(( uint )(CONCAT31(uVar7, ( byte )((uint)uVar3 >> 0x10) ^ *(byte*)( (long)key.data + ( ulong )(byte)(cVar15 + cVar21) )) << 0x18) >> 8);
            bVar18 = bVar18 + cVar22;
            uVar19 = (ulong)bVar18;
            cVar15 = *(char*)( (long)key.data + uVar19 );
            uVar28 = uVar17 + 1 & 0xff;
            ...
            *(char*)( (long)key.data + uVar28 ) = cVar15;
            ...
            uVar8 = ( uint3 )(( ( uint )(byte)((byte)uVar4 ^ *(byte*)( (long)key.data + ( ulong )(byte)(cVar15 + cVar21) )) << 0x18 ) >> 8);
            bVar18 = bVar18 + cVar22;
            uVar19 = (ulong)bVar18;
            cVar15 = *(char*)( (long)key.data + uVar19 );
            uVar28 = uVar17 + 1 & 0xff;
            ...
            *(char*)( (long)key.data + uVar17 ) = cVar15;
            ...
            uVar8 = uVar8 >> 8 | ( uint3 )(( uint )(CONCAT31(uVar8, ( byte )((uint)uVar4 >> 8) ^ *(byte*)( (long)key.data + ( ulong )(byte)(cVar15 + cVar22) )) << 0x18) >> 8);
            bVar18 = bVar18 + cVar21;
            uVar19 = (ulong)bVar18;
            cVar15 = *(char*)( (long)key.data + uVar19 );
            uVar17 = uVar28 + 1 & 0xff;
            ...
            *(char*)( (long)key.data + uVar28 ) = cVar15;
            ...
            uVar8 = uVar8 >> 8 | ( uint3 )(( uint )(CONCAT31(uVar8, ( byte )((uint)uVar4 >> 0x10) ^ *(byte*)( (long)key.data + ( ulong )(byte)(cVar15 + cVar21) )) << 0x18) >> 8);
            ...
            *(char*)( (long)key.data + uVar17 ) = cVar21;
            ...
            len = len - 8;
            *(uint*)outdata = (uint)uVar7 | CONCAT31(uVar7, ( byte )((uint)uVar3 >> 0x18) ^ bVar20) << 0x18;
            indata = indata + 8;
            *(uint*)( (long)outdata + 4 ) = (uint)uVar8 | CONCAT31(uVar8, ( byte )((uint)uVar4 >> 0x18) ^ bVar18) << 0x18;
            outdata = (uchar*)( (long)outdata + 8 );
         }
 while ( ( len & 0xfffffffffffffff8 ) != 0 );
         if (len == 0) goto LAB_00100650;
      }
 ...
 while ( len != 0 );
   ...
   if (( len & 0xfffffffffffffff0 ) != 0) {
      if (( _OPENSSL_ia32cap_P >> 0x1e & 1 ) == 0) {
         uVar24 = -uVar28 & 7;
         lVar25 = uVar28 + 1;
         if (uVar24 != 0) {
            len = len - uVar24;
            do {
               ...
               *(byte*)( (long)indata + lVar29 ) = (byte)key.data[CONCAT71((int7)uVar5, cVar15 + (char)uVar16)] ^ ( byte ) * (ulong*)indata;
 ...
 while ( uVar24 != 0 );
         ...
         do {
            ...
            for (int i = 0; i < 5; i++) {
               ...
               uVar16 = key.data[bVar18];
               key.data[bVar18] = uVar2;
               uVar2 = key.data[lVar25 + ( i + 2 )];
               uVar27 = uVar27 >> 8 | ( uint7 )(( ulong )(CONCAT71(uVar27, (char)uVar23) << 56) >> 8);
               key.data[uVar28 + ( i + 2 )] = uVar16;
               uVar23 = key.data[CONCAT31(( int3 )(uVar16 >> 8), (char)uVar16 + cVar15)];
            }
            ...
            len = len - 8;
            *(ulong*)( (long)indata + lVar29 ) = ( (ulong)uVar27 | CONCAT71(uVar27, (char)key.data[CONCAT31(( int3 )(uVar16 >> 8), (char)uVar16 + cVar15)]) << 0x38 ) ^ *(ulong*)indata;
            indata = (uchar*)( (long)indata + 8 );
         }
 while ( ( len & 0xfffffffffffffff8 ) != 0 );
      }
 else {
         if (( len & 0xffffffffffffffe0 ) == 0) goto LAB_00100430;
         uVar24 = -uVar28 & 0xf;
         if (uVar24 != 0) {
            len = len - uVar24;
            do {
               ...
               uVar16 = key.data[uVar28];
               uVar17 = (ulong)uVar16;
               *(byte*)( (long)indata + lVar29 ) = (byte)key.data[CONCAT71((int7)uVar5, cVar15 + (char)uVar2)] ^ ( byte ) * (ulong*)indata;
               indata = (uchar*)( (long)indata + 1 );
               uVar24 = uVar24 - 1;
            }
 while ( uVar24 != 0 );
         ...
         *puVar26 = uVar2;
         ...
         while (true) {
            ...
            bVar18 = bVar18 + cVar21;
            uVar24 = CONCAT26((short)key.data[( byte )(cVar15 + (char)uVar16)], CONCAT24((short)uVar12, CONCAT22((short)uVar23, uVar1)));
            uVar16 = key.data[bVar18];
            key.data[bVar18] = puVar26[7];
            puVar26[7] = uVar16;
            cVar15 = (char)puVar26[8];
            bVar18 = bVar18 + cVar15;
            lVar25 = CONCAT26((short)key.data[( byte )(cVar21 + (char)uVar16)], CONCAT24((short)uVar13, CONCAT22((short)uVar11, (short)uVar2)));
            uVar16 = key.data[bVar18];
            ...
            bVar18 = bVar18 + cVar21;
            uVar5 = CONCAT26((short)key.data[( byte )(cVar15 + (char)uVar16)], CONCAT24((short)uVar13, CONCAT22((short)uVar11, (short)uVar2)));
            ...
            puVar26[0xf] = uVar16;
            puVar26 = key.data + uVar28;
            lVar6 = CONCAT26((short)key.data[( byte )(cVar21 + (char)uVar16)], CONCAT24((short)uVar14, CONCAT22((short)uVar12, (short)uVar23)));
            uVar16 = *puVar26;
            uVar17 = (ulong)uVar16;
            len = len - 0x10;
            uVar19 = (ulong)bVar18;
...
;
   ...
   LAB_00100430:do {
      ...
      uVar28 = ( ulong )(byte)((char)uVar28 + 1);
      uVar17 = (ulong)key.data[uVar28];
      *(byte*)( (long)indata + lVar29 ) = (byte)key.data[CONCAT71((int7)uVar24, cVar15 + (char)uVar16)] ^ ( byte ) * (ulong*)indata;
      indata = (uchar*)( (long)indata + 1 );
      len = len - 1;
   }
 while ( len != 0 );
   LAB_00100650:key.x = ( uint )(byte)((char)uVar28 - 1);
   key.y = (uint)uVar19;
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void RC4_set_key(RC4_KEY *key, int len, uchar *data) {
   undefined1 uVar1;
   uint uVar2;
   char cVar3;
   ...
   lVar5 = -lVar4;
   uVar7 = 0;
   if (( _OPENSSL_ia32cap_P >> 0x14 & 1 ) == 0) {
      do {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WARNING: Unknown calling convention -- yet parameter storage is locked */char *RC4_options(void) {
   char *pcVar1;
   pcVar1 = "rc4(8x,int)";
   if (( _OPENSSL_ia32cap_P >> 0x14 & 1 ) == 0) {
      if (( _OPENSSL_ia32cap_P >> 0x1e & 1 ) != 0) {

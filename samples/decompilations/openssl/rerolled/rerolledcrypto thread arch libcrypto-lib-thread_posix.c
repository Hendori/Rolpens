undefined8 ossl_crypto_thread_native_spawn(void *param_1) {
   ...
   *(undefined8*)( (long)param_1 + 0x20 ) = 0;
   ...
   uVar2 = 0;
   LAB_00100085:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
...
bool ossl_crypto_thread_native_perform_join(long param_1) {
   ...
   bVar2 = false;
   LAB_0010012a:if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return bVar2;
   }
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked */int ossl_crypto_condvar_wait(pthread_cond_t *__cond, pthread_mutex_t *__mutex) {
   int iVar1;
   iVar1 = pthread_cond_wait(__cond, __mutex);
   return iVar1;
}
void ossl_crypto_condvar_wait_timeout(pthread_cond_t *param_1, pthread_mutex_t *param_2, ulong param_3) {
   long in_FS_OFFSET;
   timespec local_28;
   long local_10;
   local_10 = *(long*)( in_FS_OFFSET + 0x28 );
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked */int ossl_crypto_condvar_broadcast(pthread_cond_t *__cond) {
   int iVar1;
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked */int ossl_crypto_condvar_signal(pthread_cond_t *__cond) {
   int iVar1;

      ...
      if (uVar22 <= (ulong)length) {
         ...
         if (numbits != 0x20) {
          ...
          goto switchD_0010087d_caseD_8;
            ...
            LAB_00100681:uVar16 = (uint)uVar20;
            uStack_50 = ( ( ( ( ( ( uVar2 << 8 | uVar15 & 0xff ) << 8 | local_b8 ) << 8 | uVar19 ) << 8 | uVar18 ) << 8 | uVar7 & 0xff ) << 8 | (ulong)(byte)local_94 ) << 8 | local_88;
            local_58 = ( ( ( ( ( ( ( uVar11 >> 0x18 ) << 8 | uVar11 >> 0x10 & 0xff ) << 8 | uVar11 >> 8 & 0xff ) << 8 | uVar11 & 0xff ) << 8 | uVar14 >> 0x18 ) << 8 | uVar14 >> 0x10 & 0xff ) << 8 | uVar14 >> 8 & 0xff ) << 8 | uVar14 & 0xff;
            if (uVar8 != 0) goto LAB_00100bd0;
            local_58 = *puVar10;
            LAB_00100789:uVar11 = local_58 >> 0x20;
            uVar17 = (uint)local_58;
            LAB_00100797:uVar14 = (ulong)uVar17;
            puVar24 = out + uVar22;
...
switchD_001007c8_caseD_1:
          ...
          *puVar25 = (uchar)(uVar16 >> 0x10);
          ...
          puVar25[-1] = (uchar)(uVar16 >> 8);
            ...
            puVar24 = puVar24 + -1;
            LAB_001007fd:puVar25 = puVar24 + -1;
            puVar24[-1] = ( uchar )(uVar9 >> 0x18);
            switchD_001007c8_caseD_3:puVar24 = puVar25 + -1;
         ...
         while (true) {
            ...
            for (int i = 0; i < 3; i++) {
               puVar21[( -1 - i )] = ( uchar )(uVar16 >> ( -8*i + 24 ));
            }
            ...
            local_5c = uVar9;
            DES_encrypt3(&local_60, ks1, ks2, ks3);
            uVar9 = (uint)pbVar23[2] << 0x10 | (uint)pbVar23[3] << 0x18 | ( uint ) * pbVar23 | (uint)pbVar23[1] << 8;
            uVar16 = local_60 ^ uVar9;
            uVar14 = uVar11;
            pbVar23 = pbVar23 + 4;
         }
;
      ...
      LAB_00100cf0:uVar14 = (ulong)uVar16;
      uVar20 = local_58;
      uVar15 = uStack_50;
   }
 else {
      ...
      if (numbits != 0x20) {
        ...
        goto switchD_00100ee1_caseD_8;
         ...
         LAB_00100df2:uVar13 = uVar13 ^ local_60;
         uVar14 = (ulong)uVar13;
         puVar21 = puVar21 + uVar22;
...
LAB_00100f1f:
        ...
        *puVar25 = (uchar)(uVar9 >> 0x18);
        ...
        puVar25[-1] = (uchar)(uVar9 >> 0x10);
         ...
         puVar24[-1] = ( uchar )(uVar9 >> 8);
         puVar24 = puVar24 + -1;
         switchD_00100e31_caseD_5:puVar24[-1] = (uchar)uVar9;
         puVar24 = puVar24 + -1;
         goto LAB_00100e60;
      }
      ...
      while (true) {
         ...
         local_5c = uVar9;
         DES_encrypt3(&local_60, ks1, ks2, ks3);
         uVar9 = ( ( uint ) * pbVar23 | (uint)pbVar23[1] << 8 | (uint)pbVar23[2] << 0x10 | (uint)pbVar23[3] << 0x18 ) ^ local_60;
         uVar3 = ( uchar )(uVar9 >> 8);
         uVar14 = uVar11;
         pbVar23 = pbVar23 + 4;
      }
;
   ...
   LAB_001003f8:uStack_50 = uVar15;
   local_58 = uVar20;
   *ivec = ( DES_cblock )(( ( ( ( ( ( ( uVar11 >> 0x18 ) << 8 | uVar11 >> 0x10 & 0xff ) << 8 | uVar11 >> 8 & 0xff ) << 8 | uVar11 & 0xff ) << 8 | uVar14 >> 0x18 & 0xff ) << 8 | uVar14 >> 0x10 & 0xff ) << 8 | ( uVar14 & 0xffffffff ) >> 8 & 0xff ) << 8 | uVar14 & 0xff);
   LAB_00100461:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   switchD_0010087d_caseD_8:pbVar23 = puVar21 + -1;
   puVar21 = puVar21 + -1;
   uVar9 = ( uint ) * pbVar23 << 0x18;
   LAB_00100895:pbVar23 = puVar21 + -1;
   puVar21 = puVar21 + -1;
   uVar9 = uVar9 | ( uint ) * pbVar23 << 0x10;
   LAB_001008a9:pbVar23 = puVar21 + -1;
   puVar21 = puVar21 + -1;
   uVar9 = ( uint ) * pbVar23 << 8 | uVar9;
   LAB_001008b9:pbVar23 = puVar21 + -1;
   puVar21 = puVar21 + -1;
   uVar20 = ( ulong )(*pbVar23 | uVar9);
   LAB_001008c3:pbVar23 = puVar21 + -1;
   puVar21 = puVar21 + -1;
   uVar9 = ( uint ) * pbVar23 << 0x18;
   LAB_001008d1:uVar9 = (uint)puVar21[-1] << 0x10 | uVar9;
   puVar21 = puVar21 + -1;
   LAB_001008de:pbVar23 = puVar21 + -2;
   pbVar1 = puVar21 + -1;
   ...
   if (numbits != 0x40) {
      uVar11 = (ulong)uVar13;
      uVar14 = (ulong)uVar16;
      LAB_0010090c:local_88 = (ulong)(byte)uVar9;
   ...
   goto LAB_00100797;
   switchD_0010087d_caseD_6:uVar9 = 0;
   goto LAB_001008a9;
   switchD_0010087d_caseD_0:puVar21 = puVar21 + uVar22;
   uVar16 = 0;
   uVar9 = 0;
   local_58 = ( ( ( ( ( ( ( uVar11 >> 0x18 ) << 8 | uVar11 >> 0x10 & 0xff ) << 8 | uVar11 >> 8 & 0xff ) << 8 | uVar11 & 0xff ) << 8 | uVar14 >> 0x18 & 0xff ) << 8 | uVar14 >> 0x10 & 0xff ) << 8 | ( uVar14 & 0xffffffff ) >> 8 & 0xff ) << 8 | uVar14 & 0xff;
   uStack_50 = 0;
   if (uVar8 != 0) goto LAB_00100bd0;
   uVar14 = *puVar10;
   out = out + uVar22 * 2;
   ...
   DES_encrypt3(&local_60, ks1, ks2, ks3);
   goto switchD_0010087d_caseD_0;
   LAB_00100bd0:memmove(&local_58, puVar10, 9);
   uVar14 = local_58;
   uVar20 = (ulong)uVar16;
   sVar5 = (sbyte)uVar8;
   local_58._0_2_ = CONCAT11(local_58._1_1_ << sVar5 | ( byte )((int)(uint)local_58._2_1_ >> ( bVar4 & 0x1f )), (char)local_58 << sVar5 | ( byte )((int)(uint)local_58._1_1_ >> ( bVar4 & 0x1f )));
   local_58._3_1_ = SUB81(uVar14, 3);
   local_58._0_3_ = CONCAT12(local_58._2_1_ << sVar5 | ( byte )((int)(uint)local_58._3_1_ >> ( bVar4 & 0x1f )), (undefined2)local_58);
   local_58._4_1_ = SUB81(uVar14, 4);
   local_58._0_4_ = CONCAT13(local_58._3_1_ << sVar5 | ( byte )((int)(uint)local_58._4_1_ >> ( bVar4 & 0x1f )), (undefined3)local_58);
   local_58._5_1_ = SUB81(uVar14, 5);
   local_58._0_5_ = CONCAT14(local_58._4_1_ << sVar5 | ( byte )((int)(uint)local_58._5_1_ >> ( bVar4 & 0x1f )), (uint)local_58);
   local_58._6_1_ = SUB81(uVar14, 6);
   local_58._7_1_ = SUB81(uVar14, 7);
   local_58._0_6_ = CONCAT15(local_58._5_1_ << sVar5 | ( byte )((int)(uint)local_58._6_1_ >> ( bVar4 & 0x1f )), (undefined5)local_58);
   local_58._0_7_ = CONCAT16(( byte )((int)(uint)local_58._7_1_ >> ( bVar4 & 0x1f )) | local_58._6_1_ << sVar5, (undefined6)local_58);
   local_58 = CONCAT17(( byte )((int)(uint)(byte)uStack_50 >> ( bVar4 & 0x1f )) | local_58._7_1_ << sVar5, (undefined7)local_58);
   goto LAB_00100789;
   switchD_00100ee1_caseD_8:pbVar23 = puVar21 + -1;
   local_b8 = (ulong)uVar13;
   puVar21 = puVar21 + -1;
   uVar9 = ( uint ) * pbVar23 << 0x18;
   LAB_00100d93:pbVar23 = puVar21 + -1;
   puVar21 = puVar21 + -1;
   uVar9 = ( uint ) * pbVar23 << 0x10 | uVar9;
   LAB_00100da1:pbVar23 = puVar21 + -1;
   puVar21 = puVar21 + -1;
   uVar9 = ( uint ) * pbVar23 << 8 | uVar9;
   LAB_00100db1:pbVar23 = puVar21 + -1;
   puVar21 = puVar21 + -1;
   uVar9 = *pbVar23 | uVar9;
   LAB_00100dbc:pbVar23 = puVar21 + -1;
   puVar21 = puVar21 + -1;
   uVar13 = ( uint ) * pbVar23 << 0x18;
   puVar24 = out;
   LAB_00100dca:pbVar23 = puVar21 + -1;
   puVar21 = puVar21 + -1;
   uVar13 = ( uint ) * pbVar23 << 0x10 | uVar13;
   out = puVar24;
   LAB_00100dd8:uVar13 = (uint)puVar21[-1] << 8 | uVar13;
   puVar21 = puVar21 + -1;
   LAB_00100de5:pbVar23 = puVar21 + -1;
   puVar21 = puVar21 + -1;
   uVar13 = *pbVar23 | uVar13;
   goto LAB_00100df2;
   switchD_00100ee1_caseD_4:uVar11 = (ulong)local_5c;
   uVar9 = ( (uint)puVar21[-4] | (uint)puVar21[-3] << 8 | (uint)puVar21[-2] << 0x10 | (uint)puVar21[-1] << 0x18 ) ^ local_60;
   puVar24 = out + 4;
   uVar17 = uVar9 >> 8 & 0xff;
   uVar20 = ( ulong )(uVar9 & 0xff);
   uVar14 = (ulong)uVar9;
   bVar6 = ( byte )(uVar9 >> 0x10);
   LAB_00100e60:puVar24[-3] = (uchar)uVar17;
   ...
   goto LAB_00100e88;
   switchD_00100ee1_caseD_3:puVar24 = out + 3;
   uVar13 = ( (uint)puVar21[-3] | (uint)puVar21[-1] << 0x10 | (uint)puVar21[-2] << 8 ) ^ local_60;
   uVar17 = uVar13 >> 8 & 0xff;
   uVar20 = ( ulong )(uVar13 & 0xff);
   bVar6 = ( byte )(uVar13 >> 0x10);
   LAB_0010124b:puVar24[-1] = bVar6;
   puVar24[-2] = (uchar)uVar17;
   puVar24[-3] = (uchar)uVar20;
   local_58 = ( ( ( ( ( ( ( uVar11 >> 0x18 ) << 8 | uVar11 >> 0x10 & 0xff ) << 8 | uVar11 >> 8 & 0xff ) << 8 | uVar11 & 0xff ) << 8 | ( ulong )(uVar16 >> 0x18) ) << 8 | ( ulong )(uVar16 >> 0x10 & 0xff) ) << 8 | ( ulong )(byte)(uVar16 >> 8) ) << 8 | ( ulong )(uVar16 & 0xff);
   uStack_50 = ( ( ( ( ( ( ( ulong )(uVar9 >> 0x18) << 8 | ( ulong )(uVar9 >> 0x10 & 0xff) ) << 8 | ( ulong )(byte)(uVar9 >> 8) ) << 8 | ( ulong )(uVar9 & 0xff) ) << 8 | ( ulong )(uVar13 >> 0x18) ) << 8 | (ulong)bVar6 ) << 8 | (ulong)uVar17 ) << 8 | uVar20;
   if (uVar8 != 0) {
      memmove(&local_58, puVar10, 9);
      uVar14 = local_58;
      local_58._0_2_ = CONCAT11(local_58._1_1_ << sVar5 | ( byte )((int)(uint)local_58._2_1_ >> ( bVar4 & 0x1f )), (char)local_58 << sVar5 | ( byte )((int)(uint)local_58._1_1_ >> ( bVar4 & 0x1f )));
      ...
      local_58._0_6_ = CONCAT15(local_58._5_1_ << sVar5 | ( byte )((int)(uint)local_58._6_1_ >> ( bVar4 & 0x1f )), (undefined5)local_58);
      local_58._7_1_ = SUB81(uVar14, 7);
      local_58._0_7_ = CONCAT16(local_58._6_1_ << sVar5 | ( byte )((int)(uint)local_58._7_1_ >> ( bVar4 & 0x1f )), (undefined6)local_58);
      local_58 = CONCAT17(( byte )((int)(uint)(byte)uStack_50 >> ( bVar4 & 0x1f )) | local_58._7_1_ << sVar5, (undefined7)local_58);

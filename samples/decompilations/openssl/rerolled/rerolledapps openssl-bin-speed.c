...
;
   ...
   LAB_001001d0:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
;
   ...
   LAB_00100407:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
;
   ...
   LAB_001004e7:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */uint SIG_verify_loop(long *param_1) {
   long lVar1;
   EVP_PKEY_CTX *ctx;
   size_t siglen;
   uchar *sig;
...
;
   ...
   LAB_001005c2:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int SM2_verify_loop(long *param_1) {
   long lVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   if (run != 0) {
      ...
      while (true) {
         ...
         type = (EVP_MD*)EVP_sm3();
         iVar5 = EVP_DigestVerifyInit(*(EVP_MD_CTX**)( lVar1 + 0x3a8 + (ulong)testnum * 8 ), (EVP_PKEY_CTX**)0x0, type, (ENGINE*)0x0, pkey);
         if (iVar5 == 0) break;
         iVar5 = EVP_DigestVerify(*(undefined8*)( lVar1 + 0x3a8 + (ulong)testnum * 8 ), uVar3, uVar4, uVar2, 0x14);
         if (iVar5 != 1) {
...
;
      ...
      ERR_print_errors(_bio_err);
      LAB_0010073f:testmoderesult = 1;
      iVar6 = -1;
   }

   return iVar6;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int SM2_sign_loop(long *param_1) {
   long lVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   EVP_PKEY *pkey;
   ...
   if (run != 0) {
      ...
      while (true) {
         ...
         local_48 = (long)iVar4;
         type = (EVP_MD*)EVP_sm3();
         iVar5 = EVP_DigestSignInit(*(EVP_MD_CTX**)( lVar1 + 0x3a0 + (ulong)testnum * 8 ), (EVP_PKEY_CTX**)0x0, type, (ENGINE*)0x0, pkey);
         if (iVar5 == 0) break;
         iVar5 = EVP_DigestSign(*(undefined8*)( lVar1 + 0x3a0 + (ulong)testnum * 8 ), uVar3, &local_48, uVar2, 0x14);
         if (iVar5 == 0) {
...
;
      ...
      ERR_print_errors(_bio_err);
      LAB_001008cf:testmoderesult = 1;
      iVar6 = -1;
   }

   LAB_0010087c:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int EdDSA_verify_loop(long *param_1) {
   long lVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   int iVar4;
   ...
   if (run != 0) {
      iVar5 = 0;
      do {
         iVar4 = EVP_DigestVerifyInit(*(EVP_MD_CTX**)( lVar1 + 0x390 + (ulong)testnum * 8 ), (EVP_PKEY_CTX**)0x0, (EVP_MD*)0x0, (ENGINE*)0x0, (EVP_PKEY*)0x0);
         if (iVar4 == 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int EdDSA_sign_loop(long *param_1) {
   long lVar1;
   undefined8 uVar2;
   int iVar3;
   int iVar4;
   ...
   if (run != 0) {
      iVar4 = 0;
      do {
         iVar3 = EVP_DigestSignInit(*(EVP_MD_CTX**)( lVar1 + 0x380 + (ulong)testnum * 8 ), (EVP_PKEY_CTX**)0x0, (EVP_MD*)0x0, (ENGINE*)0x0, (EVP_PKEY*)0x0);
         if (iVar3 == 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int EVP_Update_loop_aead_enc(long *param_1) {
   long lVar1;
   uchar *out;
   uchar *key;
   EVP_CIPHER_CTX *ctx;
   ...
   if (run != 0) {
      ...
      do {
         if (mode_op != 0x10004) {
            ...
            if (( ( 1 < mode_op - 0x10004U ) && ( mode_op != 6 ) ) && ( iVar2 = iVar2 == 0 )) {
         ...
         if (iVar2 == 0) {
            ...
            LAB_00100d0f:BIO_printf(_bio_err, format);
            ERR_print_errors(_bio_err);
            testmoderesult = 1;
            /* WARNING: Subroutine does not return */
            exit(1);
         ...
         if (( mode_op == 7 ) && ( iVar2 = EVP_EncryptUpdate(ctx, (uchar*)0x0, &local_44, (uchar*)0x0, *(int*)( lengths + (ulong)testnum * 4 )) ),iVar2 == 0) {
            format = "\nCouldn\'t set input text length\n";
            goto LAB_00100d0f;
         }

         if (( aead != 0 ) && ( iVar2 = iVar2 == 0 )) {
 ...
 while ( ( ( run != 0 ) && ( testmode == 0 ) ) && ( iVar4 = iVar4 != 0x7fffffff ) );
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */uint SIG_sign_loop(long *param_1) {
   long lVar1;
   EVP_PKEY_CTX *ctx;
   int iVar2;
   uchar *sig;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int EVP_Update_loop(long *param_1) {
   uchar *out;
   EVP_CIPHER_CTX *ctx;
   int iVar1;
   int iVar2;
 ...
 while ( iVar2 != 0x7fffffff );
      ...
      LAB_00100fff:iVar1 = EVP_EncryptFinal_ex(ctx, out, &local_34);
   }
 else {
      iVar2 = run;
      if (run != 0) {
 ...
 while ( iVar2 != 0x7fffffff );
         LAB_00101074:iVar2 = 0x7fffffff;
         LAB_00100ff5:if (decrypt == 0) goto LAB_00100fff;
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int EVP_Update_loop_aead_dec(long *param_1) {
   long lVar1;
   uchar *in;
   uchar *out;
   EVP_CIPHER_CTX *ctx;
   ...
   if (run != 0) {
      ...
      do {
         ...
         if (iVar2 == 0) {
            format = "\nFailed to set key and iv\n";
            LAB_00101347:BIO_printf(_bio_err, format);
            ERR_print_errors(_bio_err);
            testmoderesult = 1;
            /* WARNING: Subroutine does not return */
            exit(1);
         ...
         if (( mode_op != 0x10004 ) && ( iVar2 = EVP_DecryptInit_ex(ctx, (EVP_CIPHER*)0x0, (ENGINE*)0x0, (uchar*)0x0, aead_iv) ),iVar2 == 0) {
            format = "\nFailed to set iv\n";
            goto LAB_00101347;
         }
         ...
         if (( mode_op == 7 ) && ( iVar2 = EVP_DecryptUpdate(ctx, (uchar*)0x0, &local_5c, (uchar*)0x0, *(int*)( lengths + (ulong)testnum * 4 )) ),iVar2 == 0) {
...
int EVP_Cipher_loop(long *param_1) {
   ...
   if (run != 0) {
      iVar3 = 0;
      do {
         iVar2 = EVP_Cipher(*(EVP_CIPHER_CTX**)( lVar1 + 0x4c0 ), out, out, *(uint*)( lengths + (ulong)testnum * 4 ));
         if (iVar2 < 1) {
            return -1;
         }
...
EVP_CIPHER_CTX *init_evp_cipher_ctx(undefined8 param_1, uchar *param_2, int param_3) {
   ...
   LAB_00101594:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return ctx;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void pkey_print_message(undefined8 param_1, undefined8 param_2, undefined8 param_3, uint param_4) {
   char *format;
   format = "+DTP:%d:%s:%s:%d\n";
   if (mr == 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void kskey_print_message(undefined8 param_1, undefined8 param_2, uint param_3) {
   char *format;
   format = "+DTP:%s:%s:%d\n";
   if (mr == 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */EVP_PKEY *get_ecdsa(long param_1) {
   int iVar1;
   uint uVar2;
   ulong uVar3;
   EVP_PKEY_CTX *pEVar4;
   ...
   if (pEVar4 == (EVP_PKEY_CTX*)0x0) {
      ...
      if (( ( ( uVar5 == uVar3 ) && ( ( uVar5 & 0x80000000 ) == 0 ) ) && ( (char)( uVar5 >> 0x17 ) == '\x06' ) ) && ( ( uVar2 = (uint)uVar5 & 0x7fffff ),uVar2 == 0x8010c || ( uVar2 == 0x9c ) )) {
         ERR_get_error();
      }
      ...
      if (( ( pEVar4 == (EVP_PKEY_CTX*)0x0 ) || ( iVar1 = iVar1 < 1 ) ) || ( ( iVar1 = EVP_PKEY_CTX_set_ec_paramgen_curve_nid(pEVar4, *(undefined4*)( param_1 + 8 )) ),iVar1 < 1 || ( iVar1 = iVar1 < 1 ) )) {
      ...
      LAB_001017f4:BIO_printf(_bio_err, "EC key generation failure.\n");
      ERR_print_errors(_bio_err);
      testmoderesult = 1;
      local_30 = (EVP_PKEY*)0x0;
   }
 else {
      LAB_001017e8:iVar1 = EVP_PKEY_keygen_init(pEVar4);
      if (( iVar1 < 1 ) || ( iVar1 = iVar1 < 1 )) goto LAB_001017f4;
   }

   EVP_PKEY_CTX_free(pEVar4);
   pEVar6 = local_30;
   LAB_00101835:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int run_benchmark(int param_1, code *param_2, long param_3) {
   bool bVar1;
   BIO *bio;
   uint uVar2;
   int iVar3;
   ...
   if (param_1 == 0) {
      ...
      do {
         while (true) {
            ...
            if (uVar2 != 2) break;
            iVar9 = iVar9 + 1;
            LAB_00101e04:lVar10 = lVar10 + 0x3560;
...
;
         if ((int)uVar2 < 3) {
            ...
            ERR_print_errors(_bio_err);
            testmoderesult = 1;
            LAB_00101afa:if (iVar9 < 1) goto LAB_00101df1;
            bVar1 = true;
            goto LAB_00101b10;
         }
         ...
         LAB_00101b10:do {
            ...
            do {
               ...
               if (*(long*)( local_f0[0] + lVar10 ) != 0) {
                  ...
                  ASYNC_WAIT_CTX_get_all_fds(*(undefined8*)( local_f0[0] + 8 + lVar10 ), &local_dc, &local_d8);
                  lVar5 = __fdelt_chk((long)(int)local_dc);
                  *(ulong*)( local_c8 + lVar5 * 8 ) = *(ulong*)( local_c8 + lVar5 * 8 ) | 1L << ( (byte)local_dc & 0x3f );
 ...
 while ( lVar10 != lVar8 );
            if (0x3ff < iVar4) {
               BIO_printf(_bio_err, "Error: max_fd (%d) must be smaller than FD_SETSIZE (%d). Decrease the value of async_jobs\n", uVar7, 0x400);
               ERR_print_errors(_bio_err);
               goto LAB_00101de7;
            }
               ...
               if (iVar4 != 0) {
                  ...
                  do {
                     while (true) {
                        ...
                        ASYNC_WAIT_CTX_get_all_fds(*(undefined8*)( local_f0[0] + 8 + lVar10 ), &local_dc, &local_d8);
                        if (( local_d8 != 1 ) || ( lVar5 = __fdelt_chk((long)(int)local_dc)(1L << ( (byte)local_dc & 0x3f ) & *(ulong*)( local_c8 + lVar5 * 8 )) != 0 )) break;
                        LAB_00101c50:lVar10 = lVar10 + 0x3560;
                        if (lVar10 == lVar8) goto joined_r0x00101ed3;
                     }
;
                     lVar5 = local_f0[0] + lVar10;
                     iVar4 = ASYNC_start_job(lVar5, *(undefined8*)( lVar5 + 8 ), &local_e0, param_2, lVar5, 0x3560);
                     bio = _bio_err;
                     if (iVar4 < 2) {
                        if (-1 < iVar4) {
                           iVar9 = iVar9 + -1;
 ...
 while ( *piVar6 == 4 );
         ...
         ERR_print_errors(_bio_err);
         LAB_00101de7:testmoderesult = 1;
         LAB_00101df1:local_f4 = -1;
      }

   }

   LAB_00101d53:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return local_f4;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int ECDSA_verify_loop(long *param_1) {
   long lVar1;
   uchar *tbs;
   uchar *sig;
   size_t siglen;
   ...
   if (run != 0) {
      iVar3 = 0;
      do {
         iVar2 = EVP_PKEY_verify(*(EVP_PKEY_CTX**)( lVar1 + 0x210 + (ulong)testnum * 8 ), sig, siglen, tbs, 0x14);
         if (iVar2 < 1) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int ECDSA_sign_loop(long *param_1) {
   long lVar1;
   uchar *tbs;
   uchar *sig;
   int iVar2;
   ...
   if (run != 0) {
      ...
      while (true) {
         *(undefined8*)( lVar1 + 0x50 ) = *(undefined8*)( lVar1 + 0x48 );
         iVar2 = EVP_PKEY_sign(*(EVP_PKEY_CTX**)( lVar1 + 0x160 + (ulong)testnum * 8 ), sig, (size_t*)( lVar1 + 0x50 ), tbs, 0x14);
         if (iVar2 < 1) break;
         iVar3 = iVar3 + 1;
         if (run == 0) {
            return iVar3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int DSA_verify_loop(long *param_1) {
   long lVar1;
   uchar *tbs;
   uchar *sig;
   size_t siglen;
   ...
   if (run != 0) {
      iVar3 = 0;
      do {
         iVar2 = EVP_PKEY_verify(*(EVP_PKEY_CTX**)( lVar1 + 0x150 + (ulong)testnum * 8 ), sig, siglen, tbs, 0x14);
         if (iVar2 < 1) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int DSA_sign_loop(long *param_1) {
   long lVar1;
   uchar *tbs;
   uchar *sig;
   int iVar2;
   ...
   if (run != 0) {
      ...
      while (true) {
         *(undefined8*)( lVar1 + 0x50 ) = *(undefined8*)( lVar1 + 0x48 );
         iVar2 = EVP_PKEY_sign(*(EVP_PKEY_CTX**)( lVar1 + 0x140 + (ulong)testnum * 8 ), sig, (size_t*)( lVar1 + 0x50 ), tbs, 0x14);
         if (iVar2 < 1) break;
         iVar3 = iVar3 + 1;
         if (run == 0) {
            return iVar3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int RSA_decrypt_loop(long *param_1) {
   long lVar1;
   uchar *out;
   uchar *in;
   int iVar2;
   ...
   if (run != 0) {
      ...
      while (true) {
         ...
         iVar2 = EVP_PKEY_decrypt(*(EVP_PKEY_CTX**)( lVar1 + 0x108 + (ulong)testnum * 8 ), out, &local_48, in, *(size_t*)( lVar1 + 0x58 ));
         if (iVar2 < 1) break;
         iVar3 = iVar3 + 1;
...
;
   ...
   LAB_001022e7:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int RSA_encrypt_loop(long *param_1) {
   long lVar1;
   uchar *in;
   uchar *out;
   int iVar2;
   ...
   if (run != 0) {
      ...
      while (true) {
         *(undefined8*)( lVar1 + 0x58 ) = *(undefined8*)( lVar1 + 0x48 );
         iVar2 = EVP_PKEY_encrypt(*(EVP_PKEY_CTX**)( lVar1 + 0xd0 + (ulong)testnum * 8 ), out, (size_t*)( lVar1 + 0x58 ), in, 0x24);
         if (iVar2 < 1) break;
         iVar3 = iVar3 + 1;
         if (run == 0) {
            return iVar3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int RSA_verify_loop(long *param_1) {
   long lVar1;
   uchar *tbs;
   uchar *sig;
   size_t siglen;
   ...
   if (run != 0) {
      iVar3 = 0;
      do {
         iVar2 = EVP_PKEY_verify(*(EVP_PKEY_CTX**)( lVar1 + 0x98 + (ulong)testnum * 8 ), sig, siglen, tbs, 0x24);
         if (iVar2 < 1) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int RSA_sign_loop(long *param_1) {
   long lVar1;
   uchar *tbs;
   uchar *sig;
   int iVar2;
   ...
   if (run != 0) {
      ...
      while (true) {
         *(undefined8*)( lVar1 + 0x50 ) = *(undefined8*)( lVar1 + 0x48 );
         iVar2 = EVP_PKEY_sign(*(EVP_PKEY_CTX**)( lVar1 + 0x60 + (ulong)testnum * 8 ), sig, (size_t*)( lVar1 + 0x50 ), tbs, 0x24);
         if (iVar2 < 1) break;
         iVar3 = iVar3 + 1;
         if (run == 0) {
            return iVar3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void print_result(double param_1, int param_2, int param_3, int param_4) {
   char *format;
   if (param_4 != -1) {
      ...
      ( &results )[(long)param_3 + (long)param_2 * 6] = (double)*(int*)( lengths + (long)param_3 * 4 ) * ( (double)param_4 / param_1 );
      return;
   }
...
int EVP_MAC_loop_isra_0(long *param_1) {
   ...
   if (run != 0) {
      iVar4 = 0;
      while (( ( iVar3 = EVP_MAC_init(uVar2, 0, 0, 0) ),iVar3 != 0 && ( iVar3 = EVP_MAC_update(uVar2, uVar1, (long)*(int*)( lengths + (ulong)testnum * 4 )) ),iVar3 != 0 )) {
         iVar4 = iVar4 + 1;
...
;
   ...
   LAB_00102882:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
      ...
      if (iVar1 == 0) {
         ...
         if (run != 0) {
            ...
            do {
               ...
               iVar2 = EVP_Digest(d, (long)*(int*)( lengths + (ulong)testnum * 4 ), local_78, (uint*)0x0, local_80, (ENGINE*)0x0);
               if (iVar2 == 0) goto LAB_00102ac0;
               iVar1 = iVar1 + 1;
            }
 while ( ( run != 0 ) && ( iVar2 = testmode == 0 ) );
         }
         ...
         if (ctx == (EVP_MD_CTX*)0x0) {
            LAB_00102ac0:ctx = (EVP_MD_CTX*)0x0;
            iVar1 = -1;
         }
 else {
            iVar1 = run;
            if (run != 0) {
               ...
               while (iVar1 < iVar2) {
                  ...
                  if (( ( iVar2 == 0 ) || ( iVar2 = EVP_DigestUpdate(ctx, d, (long)*(int*)( lengths + (ulong)testnum * 4 )) ),iVar2 == 0 )) {
                     iVar1 = -1;
                     break;
                  }

                  iVar1 = iVar1 + 1;
                  if (( run == 0 ) || ( iVar2 = testmode != 0 )) break;
               }
;
            }
      ...
      LAB_001029c9:EVP_MD_free(local_80);
      EVP_MD_CTX_free(ctx);
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void multiblock_speed(EVP_CIPHER *param_1, uint param_2, uint *param_3) {
   int iVar1;
   uint uVar2;
   uchar *buf;
   uchar *out;
   ...
   if ((int)uVar2 < 0) {
      ...
      do {
         ...
         if (run != 0) {
            ...
            do {
               while (true) {
                  if (( run == 0 ) || ( (int)( ( -(uint)(testmode == 0) & 0x7ffffffe ) + 1 ) <= (int)uVar2 )) goto LAB_00102f95;
...
;
 ...
 while ( run != 0 );
         ...
         LAB_00102f95:dVar12 = (double)app_tminterval(1, usertime);
         alarm(0);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WARNING: Restarted to delay deadcode elimination for space: stack */undefined4 do_multi(int param_1, int param_2) {
   byte bVar1;
   char cVar2;
   undefined1 uVar3;
   int iVar4;
   ...
   if (param_1 < 1) {
      ...
      do {
         ...
         if (iVar5 == -1) {
            ...
            LAB_001057e6:BIO_printf(_bio_err, pcVar18);
            /* WARNING: Subroutine does not return */
            exit(1);
         }
         ...
         while (pcVar18 = fgets((char*)&local_448, 0x400, __stream),pcVar18 != (char*)0x0) {
            ...
            if ((char)local_448 == '+') {
               ...
               if (( (short)local_448 == 0x462b ) && ( local_448._2_1_ == ':' )) {
                  ...
                  for (uVar11 = ( ulong )(( iVar5 - (int)( local_547 + 7 ) ) + 0xffU >> 3); uVar11 != 0; uVar11 = uVar11 - 1) {
                     *puVar19 = 0;
...
;
 ...
 while ( ( &local_548 )[local_448._3_1_] == '\0' );
                  ...
                  *piVar7 = 0;
                  ...
                  if (( ( *piVar7 == 0 ) && ( local_558 != (byte*)( (long)&local_448 + 3 ) ) ) && ( ( *local_558 == 0 && ( uVar11 < 0x1f ) ) )) {
                     local_547._0_8_ = 0;
                     local_450 = 0;
                     puVar19 = (undefined8*)( local_547 + 7 );
                     for (uVar12 = ( ulong )(( iVar5 - (int)( local_547 + 7 ) ) + 0xffU >> 3); uVar12 != 0; uVar12 = uVar12 - 1) {
                        *puVar19 = 0;
                        puVar19 = puVar19 + (ulong)bVar23 * -2 + 1;
                     }
...
;
                     ...
                     if (0 < param_2) {
                        ...
                        while (true) {
                           ...
                           local_450 = 0;
                           puVar19 = (undefined8*)( local_547 + 7 );
                           for (uVar10 = ( ulong )(( iVar5 - (int)( local_547 + 7 ) ) + 0xffU >> 3); uVar10 != 0; uVar10 = uVar10 - 1) {
                              *puVar19 = 0;
                              puVar19 = puVar19 + (ulong)bVar23 * -2 + 1;
                           }
...
;
                  ...
                  *piVar7 = 0;
                  ...
                  if (( ( ( *piVar7 == 0 ) && ( local_558 != &local_444 ) ) && ( *local_558 == 0 ) ) && ( uVar11 < 7 )) {
                     ...
                     local_450 = 0;
                     puVar19 = (undefined8*)( local_547 + 7 );
                     for (uVar12 = ( ulong )(( iVar5 - (int)( local_547 + 7 ) ) + 0xffU >> 3); bVar14 = sep_1,uVar12 != 0; uVar12 = uVar12 - 1) {
                        *puVar19 = 0;
                        puVar19 = puVar19 + (ulong)bVar23 * -2 + 1;
                     }
...
;
                  ...
                  *piVar7 = 0;
                  uVar11 = strtol((char*)&local_444, (char**)&local_558, 10);
                  if (( ( *piVar7 == 0 ) && ( local_558 != &local_444 ) ) && ( ( *local_558 == 0 && ( uVar11 < 0x16 ) ) )) {
                     local_547._0_8_ = 0;
                     local_450 = 0;
                     puVar19 = (undefined8*)( local_547 + 7 );
                     for (uVar12 = ( ulong )(( iVar5 - (int)( local_547 + 7 ) ) + 0xffU >> 3); bVar14 = sep_1,uVar12 != 0; uVar12 = uVar12 - 1) {
...
;
                  ...
                  *piVar7 = 0;
                  uVar11 = strtol((char*)&local_444, (char**)&local_558, 10);
                  if (( ( ( *piVar7 == 0 ) && ( local_558 != &local_444 ) ) && ( *local_558 == 0 ) ) && ( uVar11 < 0x18 )) {
                     local_547._0_8_ = 0;
                     local_450 = 0;
                     puVar19 = (undefined8*)( local_547 + 7 );
                     for (uVar12 = ( ulong )(( iVar5 - (int)( local_547 + 7 ) ) + 0xffU >> 3); bVar14 = sep_1,uVar12 != 0; uVar12 = uVar12 - 1) {
...
;
                  ...
                  *piVar7 = 0;
                  ...
                  if (( ( *piVar7 == 0 ) && ( local_558 != &local_444 ) ) && ( ( *local_558 == 0 && ( lVar17 == 0 ) ) )) {
                     local_547._0_8_ = 0;
                     local_450 = 0;
                     puVar19 = (undefined8*)( local_547 + 7 );
                     for (uVar11 = ( ulong )(( iVar5 - (int)( local_547 + 7 ) ) + 0xffU >> 3); bVar14 = sep_1,uVar11 != 0; uVar11 = uVar11 - 1) {
                        *puVar19 = 0;
                        puVar19 = puVar19 + (ulong)bVar23 * -2 + 1;
                     }
...
;
                  ...
                  *piVar7 = 0;
                  uVar11 = strtol((char*)&local_444, (char**)&local_558, 10);
                  if (( ( *piVar7 == 0 ) && ( local_558 != &local_444 ) ) && ( ( *local_558 == 0 && ( uVar11 < 0x6f ) ) )) {
                     local_547._0_8_ = 0;
                     local_450 = 0;
                     puVar19 = (undefined8*)( local_547 + 7 );
                     for (uVar12 = ( ulong )(( iVar5 - (int)( local_547 + 7 ) ) + 0xffU >> 3); uVar12 != 0; uVar12 = uVar12 - 1) {
...
;
                  ...
                  *piVar7 = 0;
                  ...
                  if (( ( ( *piVar7 == 0 ) && ( local_558 != local_443 ) ) && ( *local_558 == 0 ) ) && ( uVar11 < 0x6f )) {
                     local_547._0_8_ = 0;
                     local_450 = 0;
                     puVar19 = (undefined8*)( local_547 + 7 );
                     for (uVar12 = ( ulong )(( iVar5 - (int)( local_547 + 7 ) ) + 0xffU >> 3); uVar12 != 0; uVar12 = uVar12 - 1) {
...
;
         if (( ( (ulong)local_558 & 0x7f ) == 0 ) && ( bVar23 = bVar23 != 0 )) {
 ...
 while ( param_1 != iVar5 );
   ...
   LAB_001053f5:uVar9 = 1;
   LAB_001034f4:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 get_dsa(int param_1) {
   ...
   if (param_1 == 0x400) {
      ...
      s_01 = dsa1024_pub;
      s = dsa1024_priv;
      LAB_001058d7:ctx = (EVP_PKEY_CTX*)EVP_PKEY_CTX_new_from_name(0, &_LC108, 0);
      if (ctx != (EVP_PKEY_CTX*)0x0) {
         ...
         if (( ( ( a == (BIGNUM*)0x0 ) || ( a_00 == (BIGNUM*)0x0 ) ) || ( a_01 == (BIGNUM*)0x0 || a_02 == (BIGNUM*)0x0 ) ) || ( ( a_03 == (BIGNUM*)0x0 || ( lVar2 = OSSL_PARAM_BLD_new() ),lVar2 == 0 ) )) {
            lVar4 = 0;
            lVar2 = 0;
         }
 else {
            ...
            if (( iVar1 == 0 ) || ( iVar1 = iVar1 == 0 )) {
               ...
               if (iVar1 != 0) {
                  ...
                  if (( ( iVar1 == 0 ) || ( iVar1 = OSSL_PARAM_BLD_push_BN(lVar2, &_LC113, a_00) ),iVar1 == 0 )) goto LAB_0010599b;
                  iVar1 = EVP_PKEY_fromdata_init(ctx);
                  if (( iVar1 < 1 ) || ( iVar1 = iVar1 < 1 )) {
                     local_48 = 0;
                  }
   ...
   uVar3 = 0;
   LAB_00105a2b:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WARNING: Restarted to delay deadcode elimination for space: stack */int speed_main(undefined8 param_1, undefined8 param_2) {
   size_t *psVar1;
   size_t *psVar2;
   char cVar3;
   int iVar4;
   ...
   local_3f0 = 0;
   local_3e0 = (CONF*)0x0;
   LAB_00105d50:iVar70 = opt_next();
   joined_r0x00105d57:if (iVar70 == 0) {
      uVar106 = 0;
...
code_r0x00106641:
   ...
   local_3f0 = 0;
   goto LAB_00105e75;
   LAB_0010653c:uVar71 = OPENSSL_sk_num(local_420);
   ...
   if (iVar70 == 0) {
      if (0x6e < kems_algs_len + 7) {
         LAB_00107b6a:BIO_printf(_bio_err, "Too many KEMs registered. Change MAX_KEM_NUM.\n");
         LAB_00107b87:local_3e4 = 0;
         __s = (void*)0x0;
         local_400 = (void*)0x0;
         local_418 = 0;
         local_3f0 = 0;
   ...
   while (uVar71 = OPENSSL_sk_num(local_418),uVar106 < uVar71) {
      ...
      if (iVar70 == 0) {
         if (0x6e < sigs_algs_len + 7) {
            LAB_00107e74:BIO_printf(_bio_err, "Too many signatures registered. Change MAX_SIG_NUM.\n");
            goto LAB_00107c4a;
         }
 ...
 while ( ppuVar113 != (undefined**)&DAT_0011b4d0 );
         ...
         if (iVar70 == 0) {
            ...
            if (( ( ( ( ( iVar70 != 0 ) && ( iVar70 = strcmp(pcVar82, "ED448") ),iVar70 != 0 ) ) && ( iVar70 = strcmp(pcVar82, "ECDSA") ),iVar70 != 0 ) ) && ( ( iVar70 = strcmp(pcVar82, "HMAC") ),iVar70 != 0 && ( iVar70 = strcmp(pcVar82, "SIPHASH") ),iVar70 != 0 )) {
...
;
 ...
 while ( ppuVar113 != (undefined**)0x11b750 );
            bVar5 = false;
            LAB_00106dd0:iVar73 = strcmp(pcVar82, "des");
            if (iVar73 == 0) {
               bVar5 = true;
            ...
            LAB_00106f0d:iVar73 = strncmp(pcVar82, "ffdh", 4);
            if (iVar73 == 0) {
               if (pcVar82[4] == '\0') {
                  local_220 = 1;
                  bVar5 = true;
            ...
            LAB_00106f29:if (( ( cVar3 == 'd' ) && ( pcVar82[1] == 's' ) ) && ( pcVar82[2] == 'a' )) {
               if (pcVar82[3] == '\0') {
                  bVar5 = true;
                  local_228 = 0x101;
               }
            ...
            LAB_00106f73:iVar73 = strcmp(pcVar82, "aes");
            if (iVar73 == 0) {
               cStack_1c3 = '\x01';
               bVar5 = true;
               uStack_1c5 = 0x101;
 ...
 while ( ppuVar113 != &ecdsa_choices );
            ...
            if (iVar73 == 0) {
               lVar84 = 0;
               LAB_00107ee0:*(undefined1*)( (long)&local_226 + lVar84 ) = 2;
               bVar5 = true;
            }
 else {
 ...
 while ( uVar112 != uVar107 );
            ...
            iVar73 = strcmp(pcVar82, "cmac");
            if (iVar73 == 0) {
               LAB_0010717d:acStack_1c2[6] = '\x01';
            }

            LAB_00107185:local_420 = local_420 + 1;
            pcVar82 = (char*)*local_420;
         }
 while ( pcVar82 != (char*)0x0 );
      ...
      LAB_001071c9:if (kems_algs_len != 0) {
         if (kems_algs_len - 1 < 0xf) {
            uVar106 = 0;
            uVar112 = 0;
            LAB_001072e2:if ((int)uVar106 <= (int)(uint)(byte)local_128[uVar112]) {
                                          ...
                                          if (uVar112 + 0xb < kems_algs_len) {
                                             ...
                                             if (uVar112 + 0xc < kems_algs_len) {
                                                ...
                                                if (uVar112 + 0xd < kems_algs_len) {
                                                   ...
                                                   if (( uVar112 + 0xe < kems_algs_len ) && ( (int)uVar106 < (int)(uint)(byte)local_128[uVar112 + 0xe] )) {
 ...
 while ( pauVar83 != (undefined1(*) [16])( puVar104 + uVar112 ) );
            ...
            LAB_00107456:uVar112 = kems_algs_len >> 4;
            local_128[1] = local_128[1] + -1;
            local_128[0] = local_128[0] + -1;
            for (int i = 0; i < 4; i++) {
               local_128[( 3*i + 2 )] = local_128[( 3*i + 2 )] + -1;
               local_128[( 3*i + 3 )] = local_128[( 3*i + 3 )] + -1;
               local_128[( 3*i + 4 )] = local_128[( 3*i + 4 )] + -1;
            }
            ...
            if (uVar112 != 1) {
               ...
               for (int i = 0; i < 4; i++) {
                  local_118[( 3*i + 2 )] = local_118[( 3*i + 2 )] + -1;
                  local_118[( 3*i + 3 )] = local_118[( 3*i + 3 )] + -1;
                  local_118[( 3*i + 4 )] = local_118[( 3*i + 4 )] + -1;
               }
               ...
               if (uVar112 != 2) {
                  ...
                  for (int i = 0; i < 4; i++) {
                     local_108[( 3*i + 2 )] = local_108[( 3*i + 2 )] + -1;
                     local_108[( 3*i + 3 )] = local_108[( 3*i + 3 )] + -1;
                     local_108[( 3*i + 4 )] = local_108[( 3*i + 4 )] + -1;
                  }
                  ...
                  if (uVar112 != 3) {
                     ...
                     for (int i = 0; i < 4; i++) {
                        local_f8[( 3*i + 2 )] = local_f8[( 3*i + 2 )] + -1;
                        local_f8[( 3*i + 3 )] = local_f8[( 3*i + 3 )] + -1;
                        local_f8[( 3*i + 4 )] = local_f8[( 3*i + 4 )] + -1;
                     }
                     ...
                     if (uVar112 != 4) {
                        ...
                        for (int i = 0; i < 4; i++) {
                           local_e8[( 3*i + 2 )] = local_e8[( 3*i + 2 )] + -1;
                           local_e8[( 3*i + 3 )] = local_e8[( 3*i + 3 )] + -1;
                           local_e8[( 3*i + 4 )] = local_e8[( 3*i + 4 )] + -1;
                        }
            ...
            if (( kems_algs_len & 0xf ) != 0) {
               LAB_0010750b:uVar107 = kems_algs_len - uVar96;
               if (6 < uVar107 - 1) {
                  uVar79 = *(undefined8*)( local_128 + uVar96 );
                  *(ulong*)( local_128 + uVar96 ) = CONCAT17((char)( (ulong)uVar79 >> 0x38 ) + _LC212._7_1_, CONCAT16((char)( (ulong)uVar79 >> 0x30 ) + _LC212._6_1_, CONCAT15((char)( (ulong)uVar79 >> 0x28 ) + _LC212._5_1_, CONCAT14((char)( (ulong)uVar79 >> 0x20 ) + _LC212._4_1_, CONCAT13((char)( (ulong)uVar79 >> 0x18 ) + _LC212._3_1_, CONCAT12((char)( (ulong)uVar79 >> 0x10 ) + _LC212._2_1_, CONCAT11((char)( (ulong)uVar79 >> 8 ) + _LC212._1_1_, (char)uVar79 + (char)_LC212)))))));
      ...
      LAB_001075af:if (sigs_algs_len != 0) {
         if (sigs_algs_len - 1 < 0xf) {
            uVar106 = 0;
            uVar112 = 0;
            LAB_001076c4:if ((int)uVar106 <= (int)(uint)(byte)local_b8[uVar112]) {
                                          ...
                                          if (uVar112 + 0xb < sigs_algs_len) {
                                             ...
                                             if (uVar112 + 0xc < sigs_algs_len) {
                                                ...
                                                if (uVar112 + 0xd < sigs_algs_len) {
                                                   ...
                                                   if (( uVar112 + 0xe < sigs_algs_len ) && ( (int)uVar106 < (int)(uint)(byte)local_b8[uVar112 + 0xe] )) {
 ...
 while ( pauVar83 != (undefined1(*) [16])( puVar104 + uVar112 ) );
            ...
            LAB_00107838:uVar112 = sigs_algs_len >> 4;
            local_b8[1] = local_b8[1] + -1;
            local_b8[0] = local_b8[0] + -1;
            for (int i = 0; i < 4; i++) {
               local_b8[( 3*i + 2 )] = local_b8[( 3*i + 2 )] + -1;
               local_b8[( 3*i + 3 )] = local_b8[( 3*i + 3 )] + -1;
               local_b8[( 3*i + 4 )] = local_b8[( 3*i + 4 )] + -1;
            }
            ...
            if (uVar112 != 1) {
               ...
               for (int i = 0; i < 4; i++) {
                  local_a8[( 3*i + 2 )] = local_a8[( 3*i + 2 )] + -1;
                  local_a8[( 3*i + 3 )] = local_a8[( 3*i + 3 )] + -1;
                  local_a8[( 3*i + 4 )] = local_a8[( 3*i + 4 )] + -1;
               }
               ...
               if (uVar112 != 2) {
                  ...
                  for (int i = 0; i < 4; i++) {
                     local_98[( 3*i + 2 )] = local_98[( 3*i + 2 )] + -1;
                     local_98[( 3*i + 3 )] = local_98[( 3*i + 3 )] + -1;
                     local_98[( 3*i + 4 )] = local_98[( 3*i + 4 )] + -1;
                  }
                  ...
                  if (uVar112 != 3) {
                     ...
                     for (int i = 0; i < 4; i++) {
                        local_88[( 3*i + 2 )] = local_88[( 3*i + 2 )] + -1;
                        local_88[( 3*i + 3 )] = local_88[( 3*i + 3 )] + -1;
                        local_88[( 3*i + 4 )] = local_88[( 3*i + 4 )] + -1;
                     }
                     ...
                     if (uVar112 != 4) {
                        ...
                        for (int i = 0; i < 4; i++) {
                           local_78[( 3*i + 2 )] = local_78[( 3*i + 2 )] + -1;
                           local_78[( 3*i + 3 )] = local_78[( 3*i + 3 )] + -1;
                           local_78[( 3*i + 4 )] = local_78[( 3*i + 4 )] + -1;
                        }
            ...
            if (( sigs_algs_len & 0xf ) != 0) {
               LAB_001078ed:uVar107 = sigs_algs_len - uVar96;
               if (6 < uVar107 - 1) {
                  uVar79 = *(undefined8*)( local_b8 + uVar96 );
                  *(ulong*)( local_b8 + uVar96 ) = CONCAT17((char)( (ulong)uVar79 >> 0x38 ) + _LC212._7_1_, CONCAT16((char)( (ulong)uVar79 >> 0x30 ) + _LC212._6_1_, CONCAT15((char)( (ulong)uVar79 >> 0x28 ) + _LC212._5_1_, CONCAT14((char)( (ulong)uVar79 >> 0x20 ) + _LC212._4_1_, CONCAT13((char)( (ulong)uVar79 >> 0x18 ) + _LC212._3_1_, CONCAT12((char)( (ulong)uVar79 >> 0x10 ) + _LC212._2_1_, CONCAT11((char)( (ulong)uVar79 >> 8 ) + _LC212._1_1_, (char)uVar79 + (char)_LC212)))))));
                  uVar112 = ( ulong )((int)uVar112 + ( (uint)uVar107 & 0xfffffff8 ));
 ...
 while ( plVar105 != (long*)( (long)__s + 8 ) + uVar112 * 0x6ac );
         LAB_00108108:if (( iVar75 != 0 ) && ( iVar77 = iVar77 != 0 )) {
            if (mr == 0) {
                  ...
                  if (uVar58 != 0) {
                     do {
                        if (__LC81 < (double)( &results )[uVar96 + ( uVar112 & 0xffffffff ) * 6]) {
                           ...
                           __printf_chk((double)( &results )[uVar96 + ( uVar112 & 0xffffffff ) * 6] / __LC82, 2, " %11.2fk");
                        }
 else {
                           pcVar82 = ":%.2f";
                           if (mr == 0) {
                           ...
                           LAB_0010d89b:__printf_chk(2, pcVar82);
                        }
 ...
 while ( uVar112 != 0x1f );
            ...
            do {
               if (*(char*)( (long)&local_21f + uVar112 ) != '\0') {
                  if (testnum == 0) {
                     LAB_0010e21a:if (mr == 0) {
                        __printf_chk(_LC330 / *pdVar116, _LC330 / pdVar116[1], _LC330 / pdVar116[2], _LC330 / pdVar116[3], 2, "rsa %5u bits %8.6fs %8.6fs %8.6fs %8.6fs %8.1f %8.1f %8.1f %8.1f\n", *puVar103);
                        goto LAB_0010d98f;
                     }

                  }
 else if (mr == 0) {
                     __printf_chk(2, "%19ssign    verify    encrypt   decrypt   sign/s verify/s  encr./s  decr./s\n", &_LC328);
                     testnum = 0;
                     goto LAB_0010e21a;
                  }
               ...
               LAB_0010d98f:uVar112 = uVar112 + 1;
               pdVar116 = pdVar116 + 4;
               puVar103 = puVar103 + 4;
            }
 while ( uVar112 != 7 );
            ...
            do {
               if (cVar3 != '\0') {
                  if (testnum == 0) {
                     LAB_0010dab2:if (mr == 0) {
                        __printf_chk(_LC330 / *pdVar116, _LC330 / pdVar116[1], 2, "dsa %4u bits %8.6fs %8.6fs %8.1f %8.1f\n", ( &dsa_bits_3 )[lVar84]);
                        goto LAB_0010da6f;
                     }
               ...
               LAB_0010da6f:pdVar116 = pdVar116 + 2;
 ...
 while ( puVar111 != puVar101 + (long)local_438 * 0x6ac );
         ...
         if (( iVar70 == 0 ) && ( ( ( ( acStack_1c2[3] == '\0' && local_1d8[9] == '\0' ) && acStack_1c2[6] == '\0' ) && !bVar62 ) && !bVar61 )) {
            lVar84 = 0;
            local_1d8[0] = (char)_LC181;
            local_1d8[1] = (char)( (ushort)_LC181 >> 8 );
            local_1d8[2] = (char)_UNK_0011bc32;
            for (int i = 0; i < 5; i++) {
               local_1d8[( i + 3 )] = (char)( (uint6)_UNK_0011bc32 >> ( 8*i + 8 ) );
            }

            local_1d8[8] = (char)_UNK_0011bc38;
            for (int i = 0; i < 6; i++) {
               local_1d8[( i + 9 )] = (char)( (ulong)_UNK_0011bc38 >> ( 8*i + 8 ) );
            }
            ...
            do {
               ...
               if (iVar77 == 0) {
                  LAB_001088cc:local_1d8[lVar84] = '\0';
               }
 else {
                  pEVar85 = (EVP_MD_CTX*)EVP_MD_CTX_new();
                  if (pEVar85 == (EVP_MD_CTX*)0x0) {
 ...
 while ( lVar84 != 9 );
            ...
            do {
               ...
               if (iVar77 == 0) {
                  LAB_0010fdbf:local_1d8[lVar84] = '\0';
               }
 else {
                  pEVar87 = EVP_CIPHER_CTX_new();
                  if (pEVar87 == (EVP_CIPHER_CTX*)0x0) {
                  ...
                  iVar77 = EVP_CipherInit_ex(pEVar87, (EVP_CIPHER*)local_300, (ENGINE*)0x0, (uchar*)0x0, (uchar*)0x0, 1);
                  if (iVar77 < 1) {
                     EVP_CIPHER_CTX_free(pEVar87);
                     EVP_CIPHER_free(local_300);
                     goto LAB_0010fdbf;
 ...
 while ( lVar84 != 0x19 );
         ...
         Var56 = CONCAT72(CONCAT61(uVar59, -(local_1d8[4] != '\0')), CONCAT11(-(local_1d8[4] != '\0'), cVar142));
         ...
         auVar127._0_10_ = CONCAT19(-(local_1d8[0xc] != '\0'), CONCAT18(-(local_1d8[0xc] != '\0'), uVar79));
         ...
         Var38 = CONCAT91(CONCAT81((long)( CONCAT72(auVar185._9_7_, CONCAT11(cVar163, bVar167)) >> 8 ), cVar138), -bVar8);
         ...
         uVar71 = ( ( ( ( ( ( ( ( ( ( ( ( ( ( ( auVar174._12_4_ - auVar178._12_4_ ) - auVar182._12_4_ ) - auVar137._12_4_ ) + ( ( ( auVar174._4_4_ - (int)( (ulong)auVar175._0_8_ >> 0x20 ) ) - auVar179._4_4_ ) - (int)( (ulong)auVar128._0_8_ >> 0x20 ) ) ) - auVar51._0_4_ ) - auVar192._12_4_ ) - auVar194._4_4_ ) - auVar160._12_4_ ) + ( ( ( ( ( ( ( ( auVar174._8_4_ - auVar175._8_4_ ) - auVar181._8_4_ ) - auVar128._8_4_ ) + ( ( ( auVar174._0_4_ - iVar70 ) - CONCAT22(-(ushort)bVar6, CONCAT11(-bVar6, -bVar6)) ) - iVar77 ) ) - CONCAT22(-(ushort)bVar5, auVar184._0_2_) ) - auVar191._8_4_ ) - CONCAT22(-(ushort)(sVar144 < 0), sVar144) ) - auVar159._8_4_ ) ) - ( uint )(acStack_1c2[2] == '\0') ) - ( uint )(acStack_1c2[3] == '\0') ) - ( uint )(acStack_1c2[4] == '\0') ) - ( uint )(acStack_1c2[5] == '\0') ) - ( uint )(acStack_1c2[6] == '\0') ) - ( uint )(acStack_1c2[7] == '\0') ) + 7;
         if (usertime == 0 && mr == 0) {
         ...
         if (local_1d8[0] == '\0') {
            if (local_1d8[1] == '\0') {
               if (local_1d8[2] == '\0') {
                  LAB_0010faf2:if (local_1d8[3] != '\0') {
                     if (uVar58 != 0) goto LAB_001098cb;
                     goto LAB_0010fb1c;
                  }

                  LAB_0010895b:if (local_1d8[4] == '\0') goto LAB_0010851f;
         ...
         if (uVar58 == 0) {
            if (local_1d8[1] == '\0') {
               if (local_1d8[2] == '\0') {
                  ...
                  LAB_0010fab5:testnum = 0;
                  if (local_1d8[3] == '\0') {
                     if (( ( local_1d8[4] == '\0' ) && ( local_1d8[6] == '\0' ) ) && ( local_1d8[7] == '\0' )) goto LAB_00109a78;
                     goto LAB_00109cde;
                  }
            ...
            LAB_0010fb1c:testnum = 0;
            if (( ( ( local_1d8[4] == '\0' ) && ( local_1d8[6] == '\0' ) ) && ( local_1d8[7] == '\0' ) ) && ( local_1d8[8] == '\0' )) goto LAB_00108b5f;
         }
 else {
            ...
            do {
               ...
               ( &results )[(int)uVar78] = (double)*(int*)( lengths + (long)(int)uVar78 * 4 ) * ( (double)(int)uVar74 / dVar126 );
            }
 while ( ( -1 < (int)uVar74 ) && ( testnum = testnum < uVar58 ) );
            if (local_1d8[1] == '\0') {
               if (local_1d8[2] == '\0') goto LAB_0010faf2;
            }
 else {
               LAB_00108375:testnum = 0;
               uVar109 = (uint)local_2f8;
               do {
                  pcVar82 = "+DT:%s:%d:%d\n";
                  if (mr == 0) {
                  ...
                  ( &DAT_00117c70 )[(int)uVar78] = (double)*(int*)( lengths + (long)(int)uVar78 * 4 ) * ( (double)(int)uVar74 / dVar126 );
               }
 while ( ( -1 < (int)uVar74 ) && ( testnum = testnum < uVar58 ) );
               if (local_1d8[2] == '\0') {
            ...
            do {
               ...
               ( &DAT_00117ca0 )[(int)uVar78] = (double)*(int*)( lengths + (long)(int)uVar78 * 4 ) * ( (double)(int)uVar74 / dVar126 );
            }
 while ( ( -1 < (int)uVar74 ) && ( testnum = testnum < uVar58 ) );
            if (local_1d8[3] != '\0') goto LAB_001098cb;
            if (local_1d8[4] != '\0') goto LAB_00108983;
            LAB_0010851f:if (local_1d8[6] == '\0') goto LAB_00109ca4;
      ...
      LAB_001079ce:__s = (void*)app_malloc(0x3560);
      memset(__s, 0, 0x3560);
      iVar73 = *(int*)( lengths + ( ulong )(uVar58 - 1) * 4 );
      if (iVar73 < 0x24) {
         iVar73 = 100;
         LAB_00107a19:sVar97 = (size_t)iVar73;
 ...
 while ( plVar105 != (long*)( (long)__s + 0x3570 ) );
      ...
      local_3e4 = 0;
      uVar106 = 1;
      LAB_00109781:BIO_printf(_bio_err, "Error: buffer size too large\n");
      local_400 = (void*)0x0;
      local_418 = 0;
      local_420 = (long*)0x0;
      local_3f0 = 0;
   ...
   goto LAB_00105e6a;
   LAB_00109d9e:testmoderesult = 1;
   goto LAB_00109ad4;
   LAB_00109d88:testmoderesult = 1;
   LAB_001098cb:testnum = 0;
   uVar109 = (uint)local_2f8;
   do {
      pcVar82 = "+DT:%s:%d:%d\n";
      if (mr == 0) {
      ...
      ( &DAT_00117cd0 )[(int)uVar78] = (double)*(int*)( lengths + (long)(int)uVar78 * 4 ) * ( (double)(int)uVar74 / dVar126 );
   }
 while ( ( -1 < (int)uVar74 ) && ( testnum = testnum < uVar58 ) );
   if (local_1d8[4] == '\0') {
      if (local_1d8[6] == '\0') {
         LAB_00109ca4:if (local_1d8[7] != '\0') {
   ...
   do {
      ...
      ( &DAT_00117d00 )[(int)uVar78] = (double)*(int*)( lengths + (long)(int)uVar78 * 4 ) * ( (double)(int)uVar74 / dVar126 );
   }
 while ( ( -1 < (int)uVar74 ) && ( testnum = testnum < uVar58 ) );
   if (local_1d8[6] != '\0') goto LAB_00108547;
   if (local_1d8[7] != '\0') goto LAB_001086e9;
   LAB_00109a78:if (local_1d8[8] != '\0') {
      if (uVar58 != 0) goto LAB_00109098;
      LAB_00109cde:testnum = 0;
      if (local_1d8[5] != '\0') {
         testnum = 0;
      }
   ...
   goto LAB_00108b5f;
   LAB_00108b2d:testmoderesult = 1;
   goto LAB_00108983;
   LAB_001086d8:testmoderesult = 1;
   goto LAB_001086e9;
   LAB_001086f8:pcVar82 = "%d %s ops in %.2fs\n";
   if (mr != 0) {
      pcVar82 = "+R:%d:%s:%f\n";
   }

   BIO_printf(_bio_err, pcVar82, dVar126, (ulong)uVar74, PTR__LC54_0011b7b8);
   ( &DAT_00117d90 )[(int)uVar78] = (double)*(int*)( lengths + (long)(int)uVar78 * 4 ) * ( (double)(int)uVar74 / dVar126 );
   if (( (int)uVar74 < 0 ) || ( testnum = uVar58 <= testnum )) goto LAB_00109080;
   goto LAB_0010878a;
   LAB_00109080:if (local_1d8[8] != '\0') goto LAB_00109098;
   joined_r0x00109247:if (local_1d8[5] != '\0') goto LAB_00108b89;
   goto LAB_00108d0a;
   LAB_001090a7:pcVar82 = "%d %s ops in %.2fs\n";
   if (mr != 0) {
      pcVar82 = "+R:%d:%s:%f\n";
   }

   BIO_printf(_bio_err, pcVar82, dVar126, (ulong)uVar74, PTR__LC55_0011b7c0);
   ( &DAT_00117dc0 )[(int)uVar78] = (double)*(int*)( lengths + (long)(int)uVar78 * 4 ) * ( (double)(int)uVar74 / dVar126 );
   if (( (int)uVar74 < 0 ) || ( testnum = uVar58 <= testnum )) goto joined_r0x00109247;
   goto LAB_0010913b;
   LAB_0010a2db:uVar79 = *(undefined8*)( (long)__s + 0x4c0 );
   plVar105 = local_3d0;
   ...
   goto LAB_0010a2db;
   LAB_0010abe8:pcVar82 = "\nCouldn\'t init the context\n";
   goto LAB_0010a811;
   LAB_0010b45e:pEVar80 = EVP_PKEY_CTX_new((EVP_PKEY*)local_308, (ENGINE*)0x0);
   psVar115[uVar112 + 0xf] = (size_t)pEVar80;
   *psVar115 = psVar115[-2];
   if (( ( (EVP_PKEY_CTX*)psVar115[(ulong)testnum + 0xf] == (EVP_PKEY_CTX*)0x0 ) || ( iVar77 = EVP_PKEY_encrypt_init((EVP_PKEY_CTX*)psVar115[(ulong)testnum + 0xf]) ),iVar77 < 1 )) goto LAB_0010ad20;
   ...
   if ((size_t*)( (long)__s + 0x58 ) + (long)local_438 * 0x6ac == psVar115) {
      ...
      BIO_printf(_bio_err, pcVar82, dVar126, (long)iVar77, ( ulong ) * (uint*)( &DAT_0011ae6c + (ulong)testnum * 0x10 ));
      uVar112 = (ulong)testnum;
   ...
   uVar112 = (ulong)testnum;
   goto LAB_0010b45e;
   LAB_0010b626:pEVar80 = EVP_PKEY_CTX_new((EVP_PKEY*)local_308, (ENGINE*)0x0);
   *(EVP_PKEY_CTX**)( (long)pvVar102 + uVar112 * 8 + 0x108 ) = pEVar80;
   ...
   if (( ( pEVar80 == (EVP_PKEY_CTX*)0x0 ) || ( iVar77 = iVar77 < 1 ) ) || ( iVar77 = EVP_PKEY_decrypt(*(EVP_PKEY_CTX**)( (long)pvVar102 + (ulong)testnum * 8 + 0x108 ), *(uchar**)( (long)pvVar102 + 0x10 ), &local_328, *(uchar**)( (long)pvVar102 + 0x18 ), *(size_t*)( (long)pvVar102 + 0x58 )) ),iVar77 < 1) goto LAB_0010ad4b;
   ...
   while (psVar115 = psVar115 + 0x6ac,psVar2 != psVar115) {
      LAB_0010ed53:sVar97 = psVar115[(ulong)testnum + 0x66];
...
;
   pkey_print_message(&_LC262, ( &ed_curves_11 )[(ulong)testnum * 3], ( &DAT_0011b14c )[(ulong)testnum * 6], local_2e8._4_4_);
   app_tminterval(0, usertime);
   ...
   BIO_printf(_bio_err, pcVar82, dVar126, lVar84, ( ulong )(uint)(&DAT_0011b14c)[(ulong)testnum * 6], ( &ed_curves_11 )[(ulong)testnum * 3]);
   uVar112 = (ulong)testnum;
   ( &eddsa_results )[uVar112 * 2] = (double)iVar77 / dVar126;
   LAB_0010f411:do {
      iVar77 = EVP_DigestVerify(*(undefined8*)( (long)pvVar102 + uVar112 * 8 + 0x390 ), *(undefined8*)( (long)pvVar102 + 0x18 ), *(undefined8*)( (long)pvVar102 + 0x50 ), *(undefined8*)( (long)pvVar102 + 0x10 ), 0x14);
      if (iVar77 != 1) {
 ...
 while ( pvVar102 != pvVar114 );
   pkey_print_message("verify", ( &ed_curves_11 )[uVar112 * 3], ( &DAT_0011b14c )[uVar112 * 6], local_2e8._4_4_);
   app_tminterval(0, usertime);
   ...
   BIO_printf(_bio_err, pcVar82, dVar126, (long)iVar77, ( ulong )(uint)(&DAT_0011b14c)[(ulong)testnum * 6], ( &ed_curves_11 )[(ulong)testnum * 3]);
   uVar112 = (ulong)testnum;
   ( &DAT_001178c8 )[uVar112 * 2] = (double)iVar77 / dVar126;
   LAB_0010f550:if (lVar84 < 2) {
      uVar96 = 2;
      if (1 < uVar112) {
         uVar96 = uVar112;
      }
   ...
   LAB_0010c8a0:testnum = testnum + 1;
   if (1 < testnum) goto LAB_0010c9f6;
   goto LAB_0010c8b2;
   LAB_0010c9f6:testnum = 0;
   LAB_0010ca00:if (cVar118 == '\0') goto LAB_0010ca0b;
   do {
      local_300 = (EVP_MD*)0x0;
      uVar112 = 0;
      pvVar102 = __s;
      while (true) {
         ...
         *(long*)( (long)pvVar102 + uVar96 * 8 + 0x3a8 ) = lVar84;
         if (( *(long*)( (long)pvVar102 + uVar112 * 8 + 0x3a0 ) == 0 ) || ( lVar84 == 0 )) goto LAB_0010e431;
         local_300 = (EVP_MD*)0x0;
         pEVar80 = EVP_PKEY_CTX_new_id(0x494, (ENGINE*)0x0);
         if (pEVar80 == (EVP_PKEY_CTX*)0x0) break;
         iVar77 = EVP_PKEY_keygen_init(pEVar80);
         if (( ( iVar77 < 1 ) || ( iVar77 = EVP_PKEY_CTX_set_ec_paramgen_curve_nid(pEVar80, *(undefined4*)( &DAT_0011aed8 + (ulong)testnum * 0x18 )) ),iVar77 < 1 )) {
            LAB_0010e42c:EVP_PKEY_CTX_free(pEVar80);
            goto LAB_0010e431;
         }
         ...
         *(long*)( (long)pvVar102 + 0x50 ) = (long)iVar77;
         ...
         if (( iVar77 != 1 ) || ( iVar77 = EVP_PKEY_CTX_set1_id(pEVar80, "TLSv1.3+GM+Cipher+Suite", 0x17) ),pEVar63 = local_300,iVar77 != 1) goto LAB_0010e431;
         pEVar95 = (EVP_MD*)EVP_sm3();
         iVar77 = EVP_DigestSignInit(*(EVP_MD_CTX**)( (long)pvVar102 + (ulong)testnum * 8 + 0x3a0 ), (EVP_PKEY_CTX**)0x0, pEVar95, (ENGINE*)0x0, (EVP_PKEY*)pEVar63);
         pEVar63 = local_300;
         if (iVar77 == 0) goto LAB_0010e431;
         pEVar95 = (EVP_MD*)EVP_sm3();
         iVar77 = EVP_DigestVerifyInit(*(EVP_MD_CTX**)( (long)pvVar102 + (ulong)testnum * 8 + 0x3a8 ), (EVP_PKEY_CTX**)0x0, pEVar95, (ENGINE*)0x0, (EVP_PKEY*)pEVar63);
         if (iVar77 == 0) goto LAB_0010e431;
         pvVar102 = (void*)( (long)pvVar102 + 0x3560 );
         pvVar93 = __s;
...
;
      ...
      LAB_0010e431:BIO_printf(_bio_err, "SM2 init failure.\n");
      ERR_print_errors(_bio_err);
      testnum = testnum + 1;
      testmoderesult = 1;
   }
 while ( testnum == 0 );
   ...
   while (pvVar93 = (void*)( (long)pvVar93 + 0x3560 ),pvVar93 != pvVar114) {
      LAB_0010e655:iVar77 = EVP_DigestSign(*(undefined8*)( (long)pvVar93 + (ulong)testnum * 8 + 0x3a0 ), *(undefined8*)( (long)pvVar93 + 0x18 ), (long)pvVar93 + 0x50, *(undefined8*)( (long)pvVar93 + 0x10 ), 0x14);
      pvVar102 = __s;
      if (iVar77 == 0) {
         lVar84 = 1;
...
;
   pkey_print_message(&_LC262, ( &sm2_curves_9 )[(ulong)testnum * 3], ( &DAT_0011aedc )[(ulong)testnum * 6], uStack_2e0 & 0xffffffff);
   app_tminterval(0, usertime);
   ...
   BIO_printf(_bio_err, pcVar82, dVar126, lVar84, ( ulong )(uint)(&DAT_0011aedc)[(ulong)testnum * 6], ( &sm2_curves_9 )[(ulong)testnum * 3]);
   uVar112 = (ulong)testnum;
   ( &sm2_results )[uVar112 * 2] = (double)iVar77 / dVar126;
   LAB_0010e820:do {
      iVar77 = EVP_DigestVerify(*(undefined8*)( (long)pvVar102 + uVar112 * 8 + 0x3a8 ), *(undefined8*)( (long)pvVar102 + 0x18 ), *(undefined8*)( (long)pvVar102 + 0x50 ), *(undefined8*)( (long)pvVar102 + 0x10 ), 0x14);
      if (iVar77 != 1) {
 ...
 while ( pvVar102 != pvVar114 );
   pkey_print_message("verify", ( &sm2_curves_9 )[uVar112 * 3], ( &DAT_0011aedc )[uVar112 * 6], uStack_2e0 & 0xffffffff);
   app_tminterval(0, usertime);
   ...
   BIO_printf(_bio_err, pcVar82, dVar126, (long)iVar77, ( ulong )(uint)(&DAT_0011aedc)[(ulong)testnum * 6], ( &sm2_curves_9 )[(ulong)testnum * 3]);
   ( &DAT_001178a8 )[(ulong)testnum * 2] = (double)iVar77 / dVar126;
   LAB_0010e94c:uVar109 = testnum + 1;
   if (lVar84 < 2) {
      if (uVar109 == 0) {
         LAB_0010ca0b:cVar118 = '\0';
         goto LAB_0010ca10;
      }
   ...
   do {
      ...
      if (*(char*)( (long)&local_224 + uVar112 ) != '\0') {
         ...
         do {
            ...
            if (( local_318 == (EVP_PKEY*)0x0 ) || ( local_310 = (EVP_MD*)EVP_PKEY_new() ),local_310 == (EVP_MD*)0x0) {
               pcVar82 = "Error while initialising EVP_PKEY (out of memory?).\n";
               LAB_0010e602:BIO_printf(_bio_err, pcVar82);
               ERR_print_errors(_bio_err);
               testmoderesult = 1;
               uVar109 = testnum;
               goto LAB_0010cda4;
            ...
            if (pEVar80 == (EVP_PKEY_CTX*)0x0) {
               LAB_0010e709:pcVar82 = "Error while allocating EVP_PKEY_CTX.\n";
               goto LAB_0010e602;
            }
            ...
            iVar77 = EVP_PKEY_CTX_set_dh_nid(pEVar80, *(undefined4*)( ffdh_params_2 + (ulong)testnum * 0x10 + 8 ));
            if (iVar77 < 1) {
            ...
            if (( iVar77 < 1 ) || ( iVar77 = iVar77 < 1 )) {
               LAB_0010e5d2:BIO_printf(_bio_err, "FFDH computation failure.\n");
               uVar109 = testnum;
               goto LAB_0010cda4;
            }

            iVar77 = EVP_PKEY_derive(pEVar90, (uchar*)0x0, (size_t*)&local_300);
            if (( iVar77 < 1 ) || ( ( iVar77 = EVP_PKEY_derive(pEVar90, *(uchar**)( (long)pvVar102 + 0x4b8 ), (size_t*)&local_300) ),iVar77 < 1 || ( local_300 != local_308 ) )) goto LAB_0010e5d2;
            iVar77 = CRYPTO_memcmp(*(void**)( (long)pvVar102 + 0x4b0 ), *(void**)( (long)pvVar102 + 0x4b8 ), (size_t)local_308);
            if (iVar77 != 0) {
 ...
 while ( pvVar102 != pvVar114 );
         pkey_print_message(&_LC269, &_LC191, *(undefined4*)( ffdh_params_2 + (ulong)testnum * 0x10 + 0xc ), uStack_2e0._4_4_);
         app_tminterval(0, usertime);
         ...
         BIO_printf(_bio_err, pcVar82, dVar126, (long)iVar77, ( ulong ) * (uint*)( ffdh_params_2 + (ulong)testnum * 0x10 + 0xc ));
         uVar109 = testnum;
         ( &ffdh_results )[testnum] = (double)iVar77 / dVar126;
         if ((long)iVar77 < 2) {
            LAB_0010cda4:uVar96 = (ulong)uVar109;
            uVar112 = 5;
            if (4 < uVar96) {
               uVar112 = uVar96;
            }
         ...
         if (( local_128[uVar96] != '\0' ) && ( bVar62 )) {
            ...
            do {
               ...
               if (sVar97 < 0x68) {
                  ...
                  LAB_0010ce99:if (( *pcVar82 == 'E' ) && ( pcVar82[1] == 'C' )) {
                     uVar112 = ERR_peek_error();
                     if (uVar112 != 0) {
                        BIO_printf(_bio_err, "WARNING: the error queue contains previous unhandled errors.\n");
                        ERR_print_errors(_bio_err);
               ...
               if (( ( pEVar80 == (EVP_PKEY_CTX*)0x0 ) || ( iVar75 = iVar75 < 1 ) ) || ( (bVar122&&(iVar75 = EVP_PKEY_CTX_set_params(pEVar80, local_2c8), iVar75<1)) )) {
                  BIO_printf(_bio_err, "Error initializing keygen ctx for %s.\n", pcVar82);
                  LAB_0010d196:ERR_print_errors(_bio_err);
                  testmoderesult = 1;
                  EVP_PKEY_free(local_318);
                  uVar109 = testnum;
                  goto LAB_0010d1bf;
               ...
               if (( lVar84 == 0 ) || ( iVar75 = iVar75 < 1 )) {
                  LAB_0010f12d:BIO_printf(_bio_err, "Error while initializing encaps data structs for %s.\n", pcVar82);
                  goto LAB_0010d196;
               }
               ...
               if (( lVar92 == 0 ) || ( iVar75 = iVar75 < 1 )) {
                  LAB_0010f099:BIO_printf(_bio_err, "Error while initializing decaps data structs for %s.\n", pcVar82);
                  goto LAB_0010d196;
               }

               if (iVar77 == 1) {
                  iVar77 = EVP_PKEY_CTX_set_kem_op(lVar92, "RSASVE");
                  joined_r0x0010f093:if (iVar77 < 1) goto LAB_0010f099;
               }
 else if (uVar109 < 3) {
               ...
               pEVar63 = local_310;
               if (( ( iVar77 < 1 ) || ( local_300 != local_310 ) ) || ( iVar77 = memcmp(pvVar102, pvVar93, (size_t)local_310) ),uVar109 = testnum,iVar77 != 0) {
 ...
 while ( local_400 != pvVar114 );
            ...
            uVar112 = kems_algs_len;
            if ((long)iVar77 < 2) {
               LAB_0010d1bf:uVar96 = (ulong)uVar109;
               uVar112 = 0x6f;
               if (0x6e < uVar96) {
                  uVar112 = uVar96;
               }
      ...
      do {
         ...
         if (( local_b8[uVar96] != '\0' ) && ( !(bool)(bVar61 ^ 1) )) {
            ...
            do {
               ...
               sVar97 = strlen(pcVar82);
               if (0x67 < sVar97) {
                  LAB_0010d2ea:if (( ( *pcVar82 != 'd' ) || ( pcVar82[1] != 's' ) ) || ( iVar77 = iVar77 != 0 )) {
                     uVar79 = app_get0_propq();
                     iVar77 = 0;
                     pcVar108 = pcVar82;
                     goto LAB_0010d301;
                  ...
                  LAB_0010f624:pEVar80 = EVP_PKEY_CTX_new_id(0x74, (ENGINE*)0x0);
                  if (( pEVar80 != (EVP_PKEY_CTX*)0x0 ) && ( iVar75= EVP_PKEY_paramgen_init(pEVar80),0 < iVar75 )) {
                     uVar112 = strtol(pcVar82 + 3, (char**)0x0, 10);
                     iVar75 = EVP_PKEY_CTX_set_dsa_paramgen_bits(pEVar80, uVar112 & 0xffffffff);
                     if (( iVar75 < 1 ) || ( ( ( iVar75 = EVP_PKEY_paramgen(pEVar80, (EVP_PKEY**)&local_310) ),iVar75<1 || ( pEVar80 = EVP_PKEY_CTX_new((EVP_PKEY*)local_310, (ENGINE*)0x0) ),pEVar80 == (EVP_PKEY_CTX*)0x0 ) ) || ( iVar75 = iVar75 < 1 )) goto LAB_0010f69d;
                     goto LAB_0010d320;
                  }

                  LAB_0010f69d:BIO_printf(_bio_err, "Error initializing classic keygen ctx for %s.\n", pcVar82);
                  goto LAB_0010f5a5;
               }
               ...
               pcVar108 = "RSA";
               iVar77 = 1;
               LAB_0010d301:uVar81 = app_get0_libctx();
               pEVar80 = (EVP_PKEY_CTX*)EVP_PKEY_CTX_new_from_name(uVar81, pcVar108, uVar79);
               if (pEVar80 == (EVP_PKEY_CTX*)0x0) {
                  LAB_0010f589:BIO_printf(_bio_err, "Error initializing keygen ctx for %s.\n", pcVar82);
                  LAB_0010f5a5:ERR_print_errors(_bio_err);
                  testmoderesult = 1;
                  EVP_PKEY_free(local_318);
                  uVar109 = testnum;
                  goto LAB_0010f5ce;
               ...
               LAB_0010d320:iVar75 = EVP_PKEY_keygen_init(pEVar80);
               if (( iVar75 < 1 ) || ( ( iVar77 != 0 && ( iVar75 = EVP_PKEY_CTX_set_params(pEVar80, local_2c8) ),iVar75 < 1 ) )) goto LAB_0010f589;
               iVar75 = EVP_PKEY_keygen(pEVar80, &local_318);
               if (iVar75 < 1) {
               ...
               if (( ( pEVar90 == (EVP_PKEY_CTX*)0x0 ) || ( iVar75 = iVar75 < 1 ) ) || ( ( ( iVar77 == 1 && ( iVar75 = EVP_PKEY_CTX_set_rsa_padding(pEVar90) ),iVar75 < 1 ) ) || ( iVar75 = EVP_PKEY_sign(pEVar90, (uchar*)0x0, (size_t*)&local_308, local_1b8, 0x20) ),iVar75 < 1 )) {
               ...
               if (( ( ctx == (EVP_PKEY_CTX*)0x0 ) || ( iVar75 = iVar75 < 1 ) ) || ( ( iVar77 == 1 && ( iVar77 = EVP_PKEY_CTX_set_rsa_padding(ctx, 1) ),iVar77 < 1 ) )) {
 ...
 while ( pvVar102 != pvVar114 );
            ...
            uVar112 = sigs_algs_len;
            if ((long)iVar77 < 2) {
               LAB_0010f5ce:uVar96 = (ulong)uVar109;
               uVar112 = 0x6f;
               if (0x6e < uVar96) {
                  uVar112 = uVar96;
               }
 ...
 while ( uVar96 < uVar112 );
   ...
   if (mr == 0) {
      ...
      if (uVar71 == bVar121) goto LAB_0010d7fe;
      LAB_0010d783:__printf_chk(2, &_LC73);
   }
 ...
 while ( testnum < uVar58 );
   ...
   putchar(10);
   goto LAB_0010d7fe;
   LAB_0010db08:puVar117 = &DAT_0011af0c;
   ...
   do {
      if (*(char*)( (long)&local_218 + uVar112 ) != '\0') {
         if (testnum == 0) {
            LAB_0010db8f:if (mr == 0) {
               __printf_chk(_LC330 / *pdVar116, _LC330 / pdVar116[1], 2, "%4u bits ecdsa (%s) %8.4fs %8.4fs %8.1f %8.1f\n", *puVar103, *(undefined8*)( puVar103 + -3 ));
               goto LAB_0010db58;
            }
      ...
      LAB_0010db58:uVar112 = uVar112 + 1;
      pdVar116 = pdVar116 + 2;
      puVar103 = puVar103 + 6;
   }
 while ( uVar112 != 0x16 );
   ...
   do {
      if (local_1f8[uVar112] != '\0') {
         if (testnum == 0) {
            LAB_0010dc83:if (mr == 0) {
               __printf_chk(_LC330 / (double)( &ecdh_results )[uVar112], ( &ecdh_results )[uVar112], 2, "%4u bits ecdh (%s) %8.4fs %8.1f\n", *puVar117, *(undefined8*)( puVar117 + -3 ));
               goto LAB_0010dc52;
            }
         ...
         __printf_chk(( &ecdh_results )[uVar112], _LC330 / (double)( &ecdh_results )[uVar112], 2, "+F5:%u:%u:%f:%f\n", uVar112 & 0xffffffff, *puVar117);
      }

      LAB_0010dc52:uVar112 = uVar112 + 1;
      puVar117 = puVar117 + 6;
   }
 while ( uVar112 != 0x18 );
   testnum = 1;
   ...
   do {
      if (cVar3 != '\0') {
         if (testnum == 0) {
            LAB_0010dda8:if (mr == 0) {
               __printf_chk(_LC330 / *pdVar116, _LC330 / pdVar116[1], 2, "%4u bits EdDSA (%s) %8.4fs %8.4fs %8.1f %8.1f\n", *(undefined4*)( (long)ppuVar113 + 0xc ), *ppuVar113);
               goto LAB_0010dd64;
            }
         ...
         __printf_chk(*pdVar116, pdVar116[1], 2, "+F6:%u:%u:%s:%f:%f\n", lVar91, *(undefined4*)( (long)ppuVar113 + 0xc ), *ppuVar113);
      }

      LAB_0010dd64:pdVar116 = pdVar116 + 2;
 ...
 while ( true );
   ...
   if (cVar118 != '\0') {
      if (mr == 0) {
         ...
         testnum = 0;
         if (mr == 0) {
            __printf_chk(_LC330 / sm2_results, _LC330 / DAT_001178a8, 2, "%4u bits SM2 (%s) %8.4fs %8.4fs %8.1f %8.1f\n", 0x100, "CurveSM2");
            goto LAB_0010de54;
         }
   ...
   LAB_0010de54:testnum = 1;
   puVar104 = ffdh_params_2;
   uVar112 = 0;
   do {
      if (*(char*)( (long)&local_224 + uVar112 ) != '\0') {
         if (testnum == 0) {
            LAB_0010e2b2:if (mr == 0) {
               __printf_chk(_LC330 / (double)( &ffdh_results )[uVar112], ( &ffdh_results )[uVar112], 2, "%4u bits ffdh %8.4fs %8.1f\n", *(undefined4*)( puVar104 + 0xc ));
               goto LAB_0010dea7;
            }
         ...
         __printf_chk(( &ffdh_results )[uVar112], _LC330 / (double)( &ffdh_results )[uVar112], 2, "+F8:%u:%u:%f:%f\n", uVar112 & 0xffffffff, *(undefined4*)( puVar104 + 0xc ));
      }

      LAB_0010dea7:uVar112 = uVar112 + 1;
   ...
   if (kems_algs_len != 0) {
      ...
      do {
         if (( local_128[uVar96] != '\0' ) && ( bVar62 )) {
            ...
            if (testnum == 0) {
               LAB_0010e329:if (mr == 0) {
                  __printf_chk(_LC330 / *pdVar116, _LC330 / pdVar116[1], _LC330 / pdVar116[2], 2, "%27s %8.6fs %8.6fs %8.6fs %9.1f %9.1f %9.1f\n", uVar79);
                  uVar112 = kems_algs_len;
                  goto LAB_0010dfce;
               }
 ...
 while ( uVar96 < uVar112 );
   ...
   goto LAB_00106386;
   code_r0x001063fe:ERR_pop_to_mark();
   acStack_1c2[3] = '\x01';
   iVar70 = opt_next();
   goto joined_r0x00105d57;
   LAB_0010aa4b:pcVar82 = "\nFailed to set the key\n";
   LAB_0010a811:BIO_printf(_bio_err, pcVar82);
   ERR_print_errors(_bio_err);
   testmoderesult = 1;
   /* WARNING: Subroutine does not return */
   exit(1);
   LAB_00109c76:testmoderesult = 1;
   LAB_00108547:testnum = 0;
   uVar109 = (uint)local_2f8;
   do {
      pcVar82 = "+DT:%s:%d:%d\n";
      if (mr == 0) {
      ...
      ( &DAT_00117d60 )[(int)uVar78] = (double)*(int*)( lengths + (long)(int)uVar78 * 4 ) * ( (double)(int)uVar74 / dVar126 );
   }
 while ( ( -1 < (int)uVar74 ) && ( testnum = testnum < uVar58 ) );
   if (local_1d8[7] != '\0') {
      LAB_001086e9:testnum = 0;
      uVar109 = (uint)local_2f8;
      LAB_0010878a:pcVar82 = "+DT:%s:%d:%d\n";
      if (mr == 0) {
         pcVar82 = "Doing %s ops for %ds on %d size blocks: ";
      }
      ...
      BIO_printf(_bio_err, "%s error!\n", PTR__LC54_0011b7b8);
      ERR_print_errors(_bio_err);
      LAB_00108868:if (local_1d8[8] != '\0') {
         LAB_00108876:testmoderesult = 1;
         goto LAB_00109098;
      }
   ...
   if (local_1d8[8] != '\0') {
      LAB_00109098:testnum = 0;
      uVar109 = (uint)local_2f8;
      LAB_0010913b:pcVar82 = "+DT:%s:%d:%d\n";
      if (mr == 0) {
         pcVar82 = "Doing %s ops for %ds on %d size blocks: ";
      }
      ...
      BIO_printf(_bio_err, "%s error!\n", PTR__LC55_0011b7c0);
      ERR_print_errors(_bio_err);
      LAB_0010921b:testmoderesult = 1;
      goto joined_r0x00109247;
   }

   LAB_00108b5f:if (( local_1d8[5] != '\0' ) && ( testnum = uVar58 != 0 )) {
      LAB_00108b89:testnum = 0;
      uVar109 = (uint)local_2f8;
      while (true) {
         pcVar82 = "+DT:%s:%d:%d\n";
         if (mr == 0) {
         ...
         ( &DAT_00117d30 )[(int)uVar78] = (double)*(int*)( lengths + (long)(int)uVar78 * 4 ) * ( (double)(int)uVar74 / dVar126 );
         if (( (int)uVar74 < 0 ) || ( testnum = uVar58 <= testnum )) goto LAB_00108d0a;
      }
;
   ...
   LAB_00108d0a:if (cVar3 == '\0') {
      LAB_00108d13:if (local_1d8[10] != '\0') {
 ...
 while ( plVar99 != plVar105 );
         ...
         while (uVar79 = *(undefined8*)( (long)__s + 0x4c0 ),(uint)uVar112 < uVar58) {
            ...
            if (uVar78 == 0xffffffff) {
               ...
               ( &DAT_00117e20 )[(int)uVar109] = (double)*(int*)( lengths + (long)(int)uVar109 * 4 ) * ( (double)(int)uVar78 / dVar126 );
            }
...
;
 ...
 while ( plVar98 != local_3d0 + (long)local_438 * 0x6ac );
         ...
         testnum = 0;
         uVar112 = 0;
         while (uVar79 = *(undefined8*)( (long)__s + 0x4c0 ),plVar98 = local_3d0,(uint)uVar112 < uVar58) {
            iVar77 = *(int*)( lengths + uVar112 * 4 );
            lVar84 = EVP_CIPHER_CTX_get0_cipher();
            iVar75 = EVP_CIPHER_CTX_get_block_size(uVar79);
            if (( lVar84 == 0 ) || ( iVar75 < 1 )) {
            ...
            if (uVar78 == 0xffffffff) {
               ...
               ( &DAT_00117e50 )[(int)uVar109] = (double)*(int*)( lengths + (long)(int)uVar109 * 4 ) * ( (double)(int)uVar78 / dVar126 );
            }
...
;
 ...
 while ( plVar98 != plVar105 );
            testnum = 0;
            uVar112 = 0;
            while (uVar79 = *(undefined8*)( (long)__s + 0x4c0 ),plVar105 = local_3d0,(uint)uVar112 < uVar58) {
               iVar77 = *(int*)( lengths + uVar112 * 4 );
 ...
 while ( algindex < 0x13 );
      if (cVar65 != '\0') {
         ...
         do {
            ...
            *plVar119 = lVar84;
            if (( lVar84 == 0 ) || ( iVar77 = iVar77 == 0 )) goto LAB_001096d4;
 ...
 while ( plVar120 != plVar99 );
         ...
         if (uVar58 != 0) {
            ...
            while (true) {
               ...
               ( &DAT_00118120 )[(int)uVar78] = (double)*(int*)( lengths + (long)(int)uVar78 * 4 ) * ( (double)iVar77 / dVar126 );
               if (( iVar77 < 0 ) || ( testnum = uVar58 <= testnum )) goto LAB_001109e5;
            }
;
      ...
      if (( cVar66 != '\0' ) && ( testnum = uVar58 != 0 )) {
         ...
         do {
            ...
            if (uVar74 == 0xffffffff) {
               ...
               ( &DAT_00118150 )[(int)uVar78] = (double)*(int*)( lengths + (long)(int)uVar78 * 4 ) * ( (double)(int)uVar74 / dVar126 );
            }
            ...
            if (evp_md_name != (undefined*)0x0) {
               ...
               if (uVar58 != 0) {
                  ...
                  do {
                     ...
                     BIO_printf(_bio_err, pcVar82, PTR__LC71_0011b848, uVar112 & 0xffffffff, ( ulong ) * (uint*)( puVar94 + uVar96 * 4 ));
                     BIO_ctrl(_bio_err, 0xb, 0, (void*)0x0);
                     run = 1;
                     alarm(uVar109);
                     app_tminterval(0, usertime);
                     ...
                     puVar94 = lengths;
                     ( &DAT_001180f0 )[lVar84] = (double)*(int*)( lengths + lVar84 * 4 ) * ( (double)(int)uVar78 / dVar126 );
 ...
 while ( testnum < uVar58 );
            ...
            if (( bVar122 ) && ( uVar112 = EVP_CIPHER_get_flags()(uVar112 & 0x400000) != 0 )) {
               ...
               local_400 = (void*)local_330;
               LAB_00106386:local_380 = testmode;
               if (testmode == 0) {
                  local_418 = 0;
                  local_420 = (long*)0x0;
               }
            ...
            if (( aead == 0 ) || ( (undefined4*)lengths != &lengths_list )) {
               if (mode_op - 6U < 2) {
                  LAB_0010a45d:pcVar86 = EVP_Update_loop_aead_enc;
                  bVar122 = true;
                  if (decrypt != 0) {
               ...
               if (bVar122) {
                  do {
                     ...
                     *(EVP_CIPHER_CTX**)( (long)pvVar114 + 0x488 ) = pEVar87;
                     if (pEVar87 == (EVP_CIPHER_CTX*)0x0) {
                        LAB_0010ab30:BIO_printf(_bio_err, "\nEVP_CIPHER_CTX_new failure\n");
                        /* WARNING: Subroutine does not return */
                        exit(1);
                     }
                     ...
                     *(uchar**)( (long)pvVar114 + -8 ) = puVar88;
                     ...
                     if (mode_op - 0x10004U < 2) {
                        ...
                        if (decrypt != 0) {
                           ...
                           LAB_0010a651:pEVar87 = *(EVP_CIPHER_CTX**)( (long)pvVar114 + 0x488 );
                           LAB_0010a658:iVar77 = EVP_CipherInit_ex(pEVar87, (EVP_CIPHER*)0x0, (ENGINE*)0x0, *(uchar**)( (long)pvVar114 + -8 ), aead_iv, -1);
                           if (iVar77 == 0) goto LAB_0010aa4b;
                           pEVar87 = *(EVP_CIPHER_CTX**)( (long)pvVar114 + 0x488 );
                           if (mode_op == 7) {
                              iVar77 = EVP_EncryptUpdate(pEVar87, (uchar*)0x0, (int*)&local_300, (uchar*)0x0, *(int*)( lengths + (ulong)testnum * 4 ));
                              if (iVar77 == 0) {
                                 pcVar82 = "\nCouldn\'t set input text length\n";
                                 goto LAB_0010a811;
                              }
                           ...
                           iVar77 = EVP_EncryptUpdate(pEVar87, *(uchar**)( (long)pvVar114 + -0x28 ), (int*)&local_300, *(uchar**)( (long)pvVar114 + -0x28 ), *(int*)( lengths + (ulong)testnum * 4 ));
                           if (iVar77 == 0) {
                              pcVar82 = "\nFailed to to encrypt the data\n";
                              goto LAB_0010a811;
                           }

                           iVar77 = EVP_EncryptFinal_ex(*(EVP_CIPHER_CTX**)( (long)pvVar114 + 0x488 ), *(uchar**)( (long)pvVar114 + -0x28 ), (int*)&local_300);
                           if (iVar77 == 0) {
                              pcVar82 = "\nFailed finalize the encryption\n";
                              goto LAB_0010a811;
                           }

                           iVar77 = EVP_CIPHER_CTX_ctrl(*(EVP_CIPHER_CTX**)( (long)pvVar114 + 0x488 ), 0x10, 0x10, pvVar114);
                           if (iVar77 == 0) {
                           ...
                           *(EVP_CIPHER_CTX**)( (long)pvVar114 + 0x488 ) = pEVar87;
                           ...
                           iVar77 = EVP_CipherInit_ex(pEVar87, local_338, (ENGINE*)0x0, (uchar*)0x0, (uchar*)0x0, 0);
                           if (iVar77 == 0) {
                        ...
                        LAB_0010a7ac:iVar77 = EVP_CIPHER_CTX_ctrl(*(EVP_CIPHER_CTX**)( (long)pvVar114 + 0x488 ), 9, 0xc, (void*)0x0);
                        if (iVar77 == 0) {
                           pcVar82 = "\nFailed to set iv length\n";
                        }
 else {
 ...
 while ( (void*)( (long)__s + 0x38 + (long)local_438 * 0x3560 ) != pvVar114 );
                  ...
                  do {
                     ...
                     *plVar105 = (long)pEVar87;
                     if (pEVar87 == (EVP_CIPHER_CTX*)0x0) goto LAB_0010ab30;
                     iVar77 = EVP_CipherInit_ex(pEVar87, local_338, (ENGINE*)0x0, (uchar*)0x0, (uchar*)0x0, ( uint )(decrypt == 0));
                     if (iVar77 == 0) goto LAB_0010abe8;
                     ...
                     iVar77 = EVP_CipherInit_ex((EVP_CIPHER_CTX*)*plVar105, (EVP_CIPHER*)0x0, (ENGINE*)0x0, (uchar*)plVar105[-0x92], iv, -1);
                     if (iVar77 == 0) goto LAB_0010aa4b;
                     plVar105 = plVar105 + 0x6ac;
                  }
 while ( plVar105 != plVar98 );
 ...
 while ( testnum < uVar58 );
      ...
      LAB_0010a9b8:if (cVar67 == '\0') {
         LAB_0010a9c6:if (cVar68 == '\0') {
            LAB_0010a9d4:if (cVar69 == '\0') {
               LAB_0010a9e2:puVar101 = (undefined8*)( (long)__s + 0x10 );
               ...
               do {
                  ...
                  if (*(char*)( (long)&local_21f + uVar112 ) != '\0') {
                     if (iVar72 < 3) {
                        ...
                        local_308 = (EVP_MD*)d2i_PrivateKey(6, (EVP_PKEY**)0x0, (uchar**)&local_300, ( ulong )(uint)(&DAT_0011ae68)[uVar112 * 4]);
                        bVar122 = local_308 != (EVP_MD*)0x0;
                        LAB_0010b0cd:psVar115 = psVar1;
                        ...
                        do {
                           ...
                           *psVar115 = psVar115[-1];
                           if (( ( (EVP_PKEY_CTX*)psVar115[(ulong)testnum + 2] == (EVP_PKEY_CTX*)0x0 ) || ( iVar77 = EVP_PKEY_sign_init((EVP_PKEY_CTX*)psVar115[(ulong)testnum + 2]) ),iVar77 < 1 )) goto LAB_0010acbc;
                           psVar115 = psVar115 + 0x6ac;
                        }
 while ( psVar2 != psVar115 );
                        ...
                        while (true) {
                           ...
                           *(EVP_PKEY_CTX**)( (long)pvVar102 + uVar112 * 8 + 0x98 ) = pEVar80;
                           ...
                           if (( ( pEVar80 == (EVP_PKEY_CTX*)0x0 ) || ( iVar77 = iVar77 < 1 ) ) || ( iVar77 = EVP_PKEY_verify(*(EVP_PKEY_CTX**)( (long)pvVar102 + (ulong)testnum * 8 + 0x98 ), *(uchar**)( (long)pvVar102 + 0x18 ), *(size_t*)( (long)pvVar102 + 0x50 ), *(uchar**)( (long)pvVar102 + 0x10 ), 0x24) ),iVar77 < 1) break;
                           pvVar102 = (void*)( (long)pvVar102 + 0x3560 );
...
;
                        ...
                        if (a == (BIGNUM*)0x0) {
                           ...
                           if (( ( ( iVar77 != 0 ) && ( iVar77 = init_gen_str(&local_320, &_LC140, 0, 0, 0, 0) ),iVar77 != 0 ) ) && ( iVar77 = EVP_PKEY_CTX_set_rsa_keygen_bits(local_320, *(undefined4*)( &DAT_0011ae6c + (ulong)testnum * 0x10 )) ),0 < iVar77) {
                        ...
                        LAB_0010acbc:BIO_printf(_bio_err, "RSA sign setup failure.  No RSA sign will be done.\n");
                        ERR_print_errors(_bio_err);
                        testmoderesult = 1;
                     }
                     ...
                     *(undefined1*)( (long)&local_21f + (ulong)testnum ) = 0;
                     LAB_0010ad20:BIO_printf(_bio_err, "RSA encrypt setup failure.  No RSA encrypt will be done.\n");
                     ERR_print_errors(_bio_err);
                     testmoderesult = 1;
                     LAB_0010ad4b:BIO_printf(_bio_err, "RSA decrypt setup failure.  No RSA decrypt will be done.\n");
                     ERR_print_errors(_bio_err);
                     uVar112 = (ulong)testnum;
                     testmoderesult = 1;
                     LAB_0010ad7c:__memset_chk((long)&local_21f + uVar112, 0, 7 - uVar112);
                     LAB_0010ada9:EVP_PKEY_free((EVP_PKEY*)local_308);
                  }
                  ...
                  if (*(char*)( (long)&local_228 + (ulong)testnum ) != '\0') {
                     ...
                     if (pEVar89 == (EVP_PKEY*)0x0) {
                        ...
                        do {
                           ...
                           *psVar115 = psVar115[-1];
                           if (( ( (EVP_PKEY_CTX*)psVar115[(ulong)testnum + 0x1e] == (EVP_PKEY_CTX*)0x0 ) || ( iVar77 = EVP_PKEY_sign_init((EVP_PKEY_CTX*)psVar115[(ulong)testnum + 0x1e]) ),iVar77 < 1 )) ( iVar77 = EVP_PKEY_sign((EVP_PKEY_CTX*)psVar115[(ulong)testnum + 0x1e], (uchar*)psVar115[-7], psVar115, (uchar*)psVar115[-8], 0x14) ),uVar112 = uStack_2f0,iVar77<1))
                  goto LAB_0010ae65;psVar115 = psVar115 + 0x6ac;
                        }
 while ( psVar115 != psVar2 );
                        ...
                        BIO_printf(_bio_err, pcVar82, ( ulong )(uint)(&dsa_bits_3)[testnum], &_LC262, &_LC261, uStack_2f0 & 0xffffffff);
                        BIO_ctrl(_bio_err, 0xb, 0, (void*)0x0);
                        run = 1;
                        alarm(uVar109);
                        app_tminterval(0, usertime);
                        ...
                        while (true) {
                           ...
                           *(EVP_PKEY_CTX**)( (long)pvVar102 + uVar96 * 8 + 0x150 ) = pEVar80;
                           ...
                           if (( ( pEVar80 == (EVP_PKEY_CTX*)0x0 ) || ( iVar77 = iVar77 < 1 ) ) || ( iVar77 = EVP_PKEY_verify(*(EVP_PKEY_CTX**)( (long)pvVar102 + (ulong)testnum * 8 + 0x150 ), *(uchar**)( (long)pvVar102 + 0x18 ), *(size_t*)( (long)pvVar102 + 0x50 ), *(uchar**)( (long)pvVar102 + 0x10 ), 0x24) ),iVar77 < 1) break;
                           pvVar102 = (void*)( (long)pvVar102 + 0x3560 );
                           if (pvVar102 == pvVar114) {
                              pcVar82 = "+DTP:%d:%s:%s:%d\n";
                              if (mr == 0) {
                              ...
                              BIO_printf(_bio_err, pcVar82, ( ulong )(uint)(&dsa_bits_3)[testnum], "verify", &_LC261, uVar112 & 0xffffffff);
                              BIO_ctrl(_bio_err, 0xb, 0, (void*)0x0);
                              run = 1;
                              alarm(uVar109);
                              app_tminterval(0, usertime);
                              ...
                              BIO_printf(_bio_err, pcVar82, dVar126, (long)iVar77, ( ulong )(uint)(&dsa_bits_3)[testnum]);
                              uVar112 = (ulong)testnum;
                  ...
                  if (*(char*)( (long)&local_218 + (ulong)testnum ) != '\0') {
                     ...
                     if (pEVar89 == (EVP_PKEY*)0x0) {
                        ...
                        do {
                           ...
                           *psVar115 = psVar115[-1];
                           if (( ( (EVP_PKEY_CTX*)psVar115[(ulong)testnum + 0x22] == (EVP_PKEY_CTX*)0x0 ) || ( iVar77 = EVP_PKEY_sign_init((EVP_PKEY_CTX*)psVar115[(ulong)testnum + 0x22]) ),iVar77 < 1 )) goto LAB_0010af88;
                           psVar115 = psVar115 + 0x6ac;
                        }
 while ( psVar2 != psVar115 );
                        pcVar82 = "+DTP:%d:%s:%s:%d\n";
                        ...
                        BIO_printf(_bio_err, pcVar82, ( ulong )(uint)(&DAT_0011af0c)[(ulong)testnum * 6], &_LC262, "ecdsa", (ulong)uStack_2f0._4_4_);
                        BIO_ctrl(_bio_err, 0xb, 0, (void*)0x0);
                        run = 1;
                        alarm(uVar109);
                        app_tminterval(0, usertime);
                        ...
                        BIO_printf(_bio_err, pcVar82, dVar126, lVar84, ( ulong )(uint)(&DAT_0011af0c)[(ulong)testnum * 6]);
                        uVar112 = (ulong)testnum;
                        ...
                        while (true) {
                           ...
                           *(EVP_PKEY_CTX**)( (long)pvVar102 + uVar112 * 8 + 0x210 ) = pEVar80;
                           ...
                           if (( ( pEVar80 == (EVP_PKEY_CTX*)0x0 ) || ( iVar77 = iVar77 < 1 ) ) || ( iVar77 = EVP_PKEY_verify(*(EVP_PKEY_CTX**)( (long)pvVar102 + (ulong)testnum * 8 + 0x210 ), *(uchar**)( (long)pvVar102 + 0x18 ), *(size_t*)( (long)pvVar102 + 0x50 ), *(uchar**)( (long)pvVar102 + 0x10 ), 0x14) ),iVar77 < 1) break;
                           pvVar102 = (void*)( (long)pvVar102 + 0x3560 );
                           if (pvVar102 == pvVar114) {
                              pcVar82 = "+DTP:%d:%s:%s:%d\n";
                              if (mr == 0) {
                              ...
                              BIO_printf(_bio_err, pcVar82, ( ulong )(uint)(&DAT_0011af0c)[(ulong)testnum * 6], "verify", "ecdsa", (ulong)uVar109);
                              BIO_ctrl(_bio_err, 0xb, 0, (void*)0x0);
                              run = 1;
                              alarm(uVar109);
                              app_tminterval(0, usertime);
                              ...
                              BIO_printf(_bio_err, pcVar82, dVar126, (long)iVar77, ( ulong )(uint)(&DAT_0011af0c)[(ulong)testnum * 6]);
                              uVar112 = (ulong)testnum;
...
;
 ...
 while ( testnum < 0x16 );
               ...
               do {
                  ...
                  if (local_1f8[uVar112] != '\0') {
                     pvVar102 = __s;
                     while (( ( ( pEVar89 = (EVP_PKEY*)get_ecdsa(&ec_curves_10 + uVar112 * 3) ),pEVar89 != (EVP_PKEY*)0x0 && ( peer = (EVP_PKEY*)get_ecdsa(&ec_curves_10 + (ulong)testnum * 3) ),peer != (EVP_PKEY*)0x0 ) ) && ( ( pEVar80 = EVP_PKEY_CTX_new(pEVar89, (ENGINE*)0x0) ),pEVar80 != (EVP_PKEY_CTX*)0x0 && ( ( iVar77 = EVP_PKEY_derive_init(pEVar80) ),0 < iVar77 && ( iVar77 = EVP_PKEY_derive_set_peer(pEVar80, peer) ),0 < iVar77 ) )) {
                        pEVar90 = EVP_PKEY_CTX_new(peer, (ENGINE*)0x0);
                        if (( ( pEVar90 == (EVP_PKEY_CTX*)0x0 ) || ( iVar77 = iVar77 < 1 ) ) || ( iVar77 = iVar77 < 1 )) {
                           LAB_0010eccd:pcVar82 = "ECDH computation failure.\n";
                           goto LAB_0010eca1;
                        }

                        iVar77 = EVP_PKEY_derive(pEVar90, (uchar*)0x0, (size_t*)&local_300);
                        if (( ( iVar77 < 1 ) || ( iVar77 = EVP_PKEY_derive(pEVar80, *(uchar**)( (long)pvVar102 + 0x3b8 ), (size_t*)&local_308) ),iVar77 < 1 )) goto LAB_0010eccd;
                        iVar77 = CRYPTO_memcmp(*(void**)( (long)pvVar102 + 0x3b8 ), *(void**)( (long)pvVar102 + 0x3c0 ), (size_t)local_308);
                        if (iVar77 != 0) {
                        ...
                        *(EVP_MD**)( (long)pvVar102 + uVar112 * 8 + 0x3c8 ) = local_308;
                        ...
                        EVP_PKEY_CTX_free(pEVar90);
                        if (pvVar102 == pvVar114) {
                           pkey_print_message(&_LC269, &_LC201, ( &DAT_0011af0c )[(ulong)testnum * 6], local_2e8 & 0xffffffff);
                           app_tminterval(0, usertime);
...
;
                     ...
                     LAB_0010eca1:BIO_printf(_bio_err, pcVar82);
                     ERR_print_errors(_bio_err);
                     testmoderesult = 1;
                     uVar109 = testnum;
                     LAB_0010ec5e:uVar96 = (ulong)uVar109;
                     uVar112 = 0x18;
                     if (0x17 < uVar96) {
                        uVar112 = uVar96;
                     }
                  ...
                  LAB_0010c320:testnum = uVar109 + 1;
                  uVar112 = (ulong)testnum;
               }
 while ( testnum < 0x18 );
               testnum = 0;
               LAB_0010c8b2:local_300 = (EVP_MD*)0x0;
               uVar112 = (ulong)testnum;
               if (*(char*)( (long)&local_226 + uVar112 ) != '\0') {
                  ...
                  while (true) {
                     ...
                     *(undefined8*)( (long)pvVar102 + uVar112 * 8 + 0x390 ) = uVar79;
                     ...
                     if (( ( pEVar80 == (EVP_PKEY_CTX*)0x0 ) || ( iVar77 = iVar77 < 1 ) ) || ( iVar77 = iVar77 < 1 )) {
                        EVP_PKEY_CTX_free(pEVar80);
                        break;
                     }

                     EVP_PKEY_CTX_free(pEVar80);
                     iVar77 = EVP_DigestSignInit(*(EVP_MD_CTX**)( (long)pvVar102 + (ulong)testnum * 8 + 0x380 ), (EVP_PKEY_CTX**)0x0, (EVP_MD*)0x0, (ENGINE*)0x0, (EVP_PKEY*)local_300);
                     if (iVar77 == 0) {
                        EVP_PKEY_free((EVP_PKEY*)local_300);
                        break;
                     }

                     iVar77 = EVP_DigestVerifyInit(*(EVP_MD_CTX**)( (long)pvVar102 + (ulong)testnum * 8 + 0x390 ), (EVP_PKEY_CTX**)0x0, (EVP_MD*)0x0, (ENGINE*)0x0, (EVP_PKEY*)local_300);
                     if (iVar77 == 0) {
                        EVP_PKEY_free((EVP_PKEY*)local_300);
                        break;
                     }
...
;
            ...
            if (local_400 != (void*)0x0) {
               do {
                  lVar84 = EVP_MAC_CTX_new(local_400);
                  *plVar98 = lVar84;
                  if (( lVar84 == 0 ) || ( iVar77 = EVP_MAC_CTX_set_params(lVar84, local_2c8) ),uVar112 = local_2f8,iVar77 == 0) goto LAB_0010bc39;
                  plVar98 = plVar98 + 0x6ac;
               }
 while ( plVar98 != plVar105 );
               testnum = 0;
               if (uVar58 != 0) {
                  ...
                  do {
                     ...
                     BIO_printf(_bio_err, pcVar82, PTR_s_kmac256_0011b870, uVar112 & 0xffffffff, ( ulong ) * (uint*)( puVar94 + uVar96 * 4 ));
                     BIO_ctrl(_bio_err, 0xb, 0, (void*)0x0);
                     run = 1;
                     alarm(uVar109);
                     app_tminterval(0, usertime);
                     ...
                     puVar94 = lengths;
                     ( &DAT_001181e0 )[(int)uVar78] = (double)*(int*)( lengths + (long)(int)uVar78 * 4 ) * ( (double)(int)uVar74 / dVar126 );
 ...
 while ( plVar98 != plVar105 );
               ...
               if (uVar58 != 0) {
                  ...
                  do {
                     ...
                     BIO_printf(_bio_err, pcVar82, PTR_s_kmac128_0011b868, uVar112 & 0xffffffff, ( ulong ) * (uint*)( puVar94 + uVar96 * 4 ));
                     BIO_ctrl(_bio_err, 0xb, 0, (void*)0x0);
                     run = 1;
                     alarm(uVar109);
                     app_tminterval(0, usertime);
                     ...
                     puVar94 = lengths;
                     ( &DAT_001181b0 )[(int)uVar78] = (double)*(int*)( lengths + (long)(int)uVar78 * 4 ) * ( (double)(int)uVar74 / dVar126 );
                     if ((int)uVar74 < 0) break;
                     testnum = testnum + 1;
                     uVar96 = (ulong)testnum;
                  }
               ...
               if (0 < iVar77) {
                  ...
                  if (uVar58 != 0) {
                     ...
                     do {
                        ...
                        BIO_printf(_bio_err, pcVar82, PTR__LC208_0011b860, uVar112 & 0xffffffff, ( ulong ) * (uint*)( puVar94 + uVar96 * 4 ));
                        BIO_ctrl(_bio_err, 0xb, 0, (void*)0x0);
                        run = 1;
                        alarm(uVar109);
                        app_tminterval(0, usertime);
                        ...
                        puVar94 = lengths;
                        ( &DAT_00118180 )[(int)uVar78] = (double)*(int*)( lengths + (long)(int)uVar78 * 4 ) * ( (double)(int)uVar74 / dVar126 );
                        if ((int)uVar74 < 0) break;
                        testnum = testnum + 1;
                        uVar96 = (ulong)testnum;
                     }
 ...
 while ( plVar99 != plVar105 );
         ...
         if (uVar58 != 0) {
            ...
            while (true) {
               ...
               ( &DAT_00117df0 )[lVar84] = (double)*(int*)( lengths + lVar84 * 4 ) * ( (double)(int)uVar78 / dVar126 );
               if (( (int)uVar78 < 0 ) || ( testnum = uVar58 <= testnum )) goto LAB_001101fe;
            }
;
 ...
 while ( plVar98 != plVar105 );
      ...
      LAB_001096d4:local_418 = 0;
      local_420 = (long*)0x0;
   }

   LAB_00105e6a:local_380 = 1;
   LAB_00105e75:ERR_print_errors(_bio_err);
   local_438 = (undefined8*)(ulong)uVar106;
   if (uVar106 != 0) {
      LAB_00105e91:local_428 = (undefined8*)( (long)__s + 0x98 );
      ...
      do {
         ...
         do {
            ...
            for (int i = 0; i < 3; i++) {
               EVP_PKEY_CTX_free((EVP_PKEY_CTX*)puVar111[( 7*i + 7 )]);
            }
 ...
 while ( puVar100 != puVar111 );
         ...
         if (kems_algs_len != 0) {
            do {
               ...
               for (int i = 0; i < 3; i++) {
                  CRYPTO_free((void*)puVar111[( 111*i + 555 )]);
               }
 ...
 while ( uVar112 < kems_algs_len );
         ...
         if (sigs_algs_len != 0) {
            do {
               for (int i = 0; i < 3; i++) {
                  EVP_PKEY_CTX_free((EVP_PKEY_CTX*)puVar100[uVar112 + ( 111*i + 930 )]);
               }
 ...
 while ( puVar100 != puVar101 );
   ...
   code_r0x0010631e:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return local_380;
   }

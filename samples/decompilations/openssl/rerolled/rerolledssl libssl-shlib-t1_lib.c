...
undefined8 add_provider_groups(undefined8 param_1, long *param_2) {
   ...
   if (( lVar6 == 0 ) || ( *(int*)( lVar6 + 8 ) != 4 )) {
      ...
      *(char**)( *pauVar1 + 8 ) = pcVar7;
      ...
      if (( ( lVar6 == 0 ) || ( iVar3 = iVar3 == 0 ) ) || ( 0xffff < local_38 )) {
         ERR_new();
         uVar9 = 0x114;
...
undefined8 add_provider_sigalgs(undefined8 param_1, long *param_2) {
   ...
   if (pcVar8 == (char*)0x0) {
      ...
      *puVar12 = pcVar8;
      ...
      if (( ( lVar7 == 0 ) || ( iVar4 = iVar4 == 0 ) ) || ( 0xffff < local_44 )) {
         ERR_new();
         uVar13 = 0x1af;
      ...
      if (( *param_3 != 0x3e ) && ( param_2 < 0x28 )) {
         ...
         if (pcVar4 == (char*)0x0) {
            ...
            if (lVar6 == 0) {
               ...
               do {
                  puVar2 = *ppuVar12;
                  if (( ( ppuVar12[1] != (undefined*)0x0 ) && ( iVar3 = iVar3 == 0 ) ) || ( iVar3 = iVar3 == 0 )) {
                     lVar6 = *param_3;
 ...
 while ( ppuVar12 != (undefined**)&DAT_00109698 );
               ...
               if (*(long*)( lVar6 + 0x650 ) != 0) {
                  do {
                     ...
                     uVar1 = *puVar9;
                     if (( ( puVar9[1] != 0 ) && ( iVar3 = iVar3 == 0 ) ) || ( iVar3 = iVar3 == 0 )) {
...
undefined8 ssl_setup_sigalgs(undefined8 *param_1) {
   ...
   if (param_1 != (undefined8*)0x0) {
      ...
      if (( ( ptr == (undefined8*)0x0 ) || ( pkey == (EVP_PKEY*)0x0 ) ) || ( lVar16 = lVar16 == 0 )) {
         uVar21 = 0;
      }
 else {
         ERR_set_mark();
         ...
         do {
            ...
            *puVar18 = *ppuVar23;
            ...
            puVar18[6] = puVar12;
            puVar18[7] = puVar13;
            if (( ( iVar14 == 0 ) || ( param_1[(long)*(int*)( ppuVar23 + 3 ) + 0xae] != 0 ) ) && ( iVar14 = iVar14 != 0 )) {
...
uint tls_decrypt_ticket(long param_1, long *param_2, ulong param_3, void *param_4, size_t param_5, undefined8 *param_6) {
   ...
   if (pcVar3 == (code*)0x0) {
      ...
      LAB_00105d88:if (( ( ( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) != 0 ) || ( iVar4 = iVar4 == 0x10000 ) ) || ( iVar4 < 0x304 )) goto LAB_00105db0;
      if (local_b4 < 5) {
...
uint tls1_check_chain(SSL *param_1, X509 *param_2, long param_3, long param_4, uint param_5) {
   ...
   if (param_5 == 0xffffffff) {
      if (( ( param_2 == (X509*)0x0 ) || ( param_3 == 0 ) ) || ( lVar13 = lVar13 == 0 )) goto LAB_00107814;

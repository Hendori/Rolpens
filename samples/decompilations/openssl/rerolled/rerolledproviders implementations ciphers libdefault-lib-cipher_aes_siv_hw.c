bool aes_siv_dupctx(undefined8 *param_1, undefined8 *param_2) {
   undefined8 uVar1;
   int iVar2;
   if (( param_1[0xc] != 0 ) && ( iVar2 = iVar2 == 0 )) {
      return false;
   }

   if (( param_1[0xb] != 0 ) && ( iVar2 = iVar2 == 0 )) {
...
undefined1[16];aes_siv_initkey(long param_1, undefined8 param_2, ulong param_3) {
   ...
   *(long*)( param_1 + 0x58 ) = lVar3;
   if (( *(long*)( param_1 + 0x60 ) != 0 ) && ( lVar3 != 0 )) {
      auVar7._0_8_ = ossl_siv128_init(param_1 + 0x18, param_2, param_3 & 0xffffffff, *(long*)( param_1 + 0x60 ), lVar3, uVar1);
      auVar7._8_8_ = 0;
      return auVar7;
   }

   LAB_00100290:auVar6._8_8_ = 0;
   auVar6._0_8_ = uVar4;
   return auVar6 << 0x40;
}

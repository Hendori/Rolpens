undefined8 MOD_EXP_CTIME_COPY_FROM_PREBUF(long *param_1, int param_2, ulong *param_3, uint param_4, int param_5) {
   ulong *puVar1;
   ulong *puVar2;
   ulong *puVar3;
   ulong *puVar4;
   ...
   if (param_5 < 4) {
      if (0 < param_2) {
         ...
         uVar9 = *param_3;
         while (true) {
            uVar9 = param_3[1] & -(ulong)(((param_4 ^ 1) - 1 & (param_4 ^ 0xfffffffe)) >> 0x1f) | uVar9 & -(ulong)((param_4 - 1 & ~param_4) >> 0x1f);
            if (( param_5 != 1 ) && ( uVar9 = param_3[3] & -(ulong)(((param_4 ^ 3) - 1 & (param_4 ^ 0xfffffffc)) >> 0x1f) | param_3[2] & -(ulong)(((param_4 ^ 2) - 1 & (param_4 ^ 0xfffffffd)) >> 0x1f) | uVar9 ),param_5 != 2) {
               uVar9 = param_3[7] & -(ulong)(((param_4 ^ 7) - 1 & (param_4 ^ 0xfffffff8)) >> 0x1f) | param_3[6] & -(ulong)(((param_4 ^ 6) - 1 & (param_4 ^ 0xfffffff9)) >> 0x1f) | param_3[5] & -(ulong)(((param_4 ^ 5) - 1 & (param_4 ^ 0xfffffffa)) >> 0x1f) | param_3[4] & -(ulong)(((param_4 ^ 4) - 1 & (param_4 ^ 0xfffffffb)) >> 0x1f) | uVar9;
            }
      ...
      if (0 < param_2) {
         ...
         do {
            ...
            do {
               ...
               uVar14 = uVar14 + 1;
               uVar9 = uVar9 | ( uVar5 & -(ulong)((~uVar6 & uVar6 - 1) >> 0x1f) | *puVar4 & -(ulong)(((uVar6 ^ 2) - 1 & (uVar6 ^ 0xfffffffd)) >> 0x1f) | *puVar2 & -(ulong)(((uVar6 ^ 1) - 1 & (uVar6 ^ 0xfffffffe)) >> 0x1f) | *puVar3 & -(ulong)(((uVar6 ^ 3) - 1 & (uVar6 ^ 0xfffffffc)) >> 0x1f) ) & -(ulong)((~uVar11 & uVar11 - 1) >> 0x1f);
            }
 while ( uVar13 != uVar14 );
            param_3 = param_3 + iVar15;
            *puVar12 = uVar9;
...
int BN_mod_exp_recp_part_0(BIGNUM *param_1, BIGNUM *param_2, BIGNUM *param_3, BIGNUM *param_4, BN_CTX *param_5) {
   uint uVar1;
   int iVar2;
   int iVar3;
   int iVar4;
   ...
   if (iVar2 == 0) {
      ...
      if (pBVar6 == (BIGNUM*)0x0) {
         ...
         LAB_001003e9:iVar3 = BN_nnmod(pBVar6, param_2, param_4, param_5);
         ...
         if (iVar3 == 0) {
            if (iVar2 < 0x2a0) {
               ...
               local_198 = 0x20;
               local_190 = 6;
               LAB_00100502:iVar3 = BN_mod_mul_reciprocal(pBVar5, pBVar6, pBVar6, &local_188, param_5);
               if (iVar3 == 0) goto LAB_00100404;
               lVar9 = 1;
               do {
                  pBVar6 = BN_CTX_get(param_5);
                  local_148[lVar9] = pBVar6;
                  if (( pBVar6 == (BIGNUM*)0x0 ) || ( iVar3 = BN_mod_mul_reciprocal(pBVar6, local_148[lVar9 + -1], pBVar5, &local_188, param_5) ),iVar3 == 0) goto LAB_00100404;
                  lVar9 = lVar9 + 1;
               }
 while ( (int)lVar9 < local_198 );
            ...
            pBVar5 = param_3;
            if (( ( param_3 == param_1 ) && ( ( pBVar5 = BN_CTX_get(param_5) ),pBVar5 == (BIGNUM*)0x0 || ( pBVar6 = BN_copy(pBVar5, param_3) ),pBVar6 == (BIGNUM*)0x0 ) )) goto LAB_00100404;
            local_18c = 1;
            do {
               iVar2 = iVar2 + -1;
               ...
               if (iVar3 != 0) {
                  ...
                  iVar3 = 0;
                  LAB_00100723:iVar8 = BN_mod_mul_reciprocal(param_1, param_1, local_148[(int)local_18c >> 1], &local_188, param_5);
               ...
               if (local_18c == 0) {
                  LAB_00100681:iVar3 = BN_mod_mul_reciprocal(param_1, param_1, param_1, &local_188, param_5);
                  if (iVar3 == 0) goto LAB_00100404;
                  local_18c = 0;
               }
 ...
 while ( iVar2 != 0 );
   ...
   LAB_001007e8:/* WARNING: Subroutine does not return */__stack_chk_fail();
   code_r0x0010077f:local_18c = 0;
   LAB_001006c0:uVar1 = 1;
   iVar3 = 0;
   iVar8 = 1;
   do {
...
int BN_exp(BIGNUM *r, BIGNUM *a, BIGNUM *p, BN_CTX *ctx) {
   ...
   uVar6 = 0;
   if (( ( local_48 != (BIGNUM*)0x0 ) && ( pBVar4 != (BIGNUM*)0x0 ) ) && ( pBVar5 = BN_copy(pBVar4, a) ),pBVar5 != (BIGNUM*)0x0) {
      iVar1 = BN_num_bits(p);
      iVar2 = BN_is_odd(p);
      if (iVar2 == 0) {
      ...
      if (1 < iVar1) {
         do {
            ...
            if (( iVar3 == 0 ) || ( ( iVar3 = BN_is_bit_set(p, iVar2) ),iVar3 != 0 && ( iVar3 = BN_mul(local_48, local_48, pBVar4, ctx) ),iVar3 == 0 )) goto LAB_00100970;
            iVar2 = iVar2 + 1;
         }
 while ( iVar1 != iVar2 );
      }
...
int BN_mod_exp_mont(BIGNUM *r, BIGNUM *a, BIGNUM *p, BIGNUM *m, BN_CTX *ctx, BN_MONT_CTX *m_ctx) {
   ...
   if (iVar8 == 0) {
      ...
      if (( m.top < 0x100000 ) && ( ( ( iVar8 = BN_get_flags(p, 4) ),iVar8 != 0 || ( iVar8 = BN_get_flags(a, 4) ),iVar8 != 0 ) ) || ( iVar8 = iVar8 != 0 )) {
         if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      ...
      if (r_00 == (BIGNUM*)0x0) {
         ...
         LAB_00100e22:if (m_ctx == (BN_MONT_CTX*)0x0) goto LAB_00100e45;
      }
 else {
         local_190 = m_ctx;
         if (m_ctx != (BN_MONT_CTX*)0x0) {
            LAB_00100b75:if (( ( ( a.neg == 0 ) && ( iVar9 = BN_ucmp(a, m) ),iVar9 < 0 ) ) || ( iVar9 = BN_nnmod(r_00, a, m, ctx) ),a = r_00,iVar9 != 0) {
               if (iVar8 < 0x2a0) {
                  if (0xef < iVar8) {
                     local_160 = 0x10;
                     iVar9 = 5;
                  ...
                  local_160 = 0x20;
                  iVar9 = 6;
                  LAB_00100bf7:iVar10 = bn_mul_mont_fixed_top(pBVar12, r_00, r_00, local_190, ctx);
                  ...
                  do {
                     ...
                     if (( pBVar13 == (BIGNUM*)0x0 ) || ( iVar10 = bn_mul_mont_fixed_top(pBVar13, local_150[lVar18], pBVar12, local_190, ctx) ),iVar10 == 0) goto LAB_00100c8d;
                     lVar18 = lVar18 + 1;
                     m = local_150[0];
                  }
 ...
 while ( iVar15 != iVar10 + 1 );
                              LAB_00101101:do {
                                 iVar15 = bn_mul_mont_fixed_top(a_00, a_00, local_150[(long)( (int)local_184 >> 1 ) + 1], local_190, ctx);
 ...
 while ( true );
                        ...
                        if (local_184 == 0) {
                           LAB_00101046:iVar10 = bn_mul_mont_fixed_top(a_00, a_00, a_00, local_190, ctx);
                           if (iVar10 == 0) goto LAB_00100c8d;
                           local_184 = 0;
                        }
 ...
 while ( iVar8 != 0 );
                     LAB_00100f86:iVar8 = BN_from_montgomery(r, a_00, local_190, ctx);
                     uVar16 = ( uint )(iVar8 != 0);
                     goto LAB_00100e22;
                  }
         ...
         LAB_00100e45:BN_MONT_CTX_free(local_190);
      }

      BN_CTX_end(ctx);
   }

   LAB_00100d46:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar16;
   }

   LAB_0010128b:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* WARNING: Removing unreachable block (ram,0x00101657) *//* WARNING: Removing unreachable block (ram,0x00101644) *//* WARNING: Removing unreachable block (ram,0x0010166a) */int bn_mod_exp_mont_fixed_top(BIGNUM *param_1, BIGNUM *param_2, BIGNUM *param_3, BIGNUM *param_4, BN_CTX *param_5, BN_MONT_CTX *param_6) {
   uint *puVar1;
   uint *puVar2;
   uint uVar3;
   ulong *puVar4;
   ...
   if (local_90 == (BN_MONT_CTX*)0x0) {
      ...
      LAB_00101345:if (( ( param_2.neg == 0 ) && ( iVar10 = iVar10 < 0 ) ) || ( ( pBVar13 = BN_CTX_get(local_80) ),pBVar13 != (BIGNUM*)0x0 && ( iVar10 = BN_nnmod(pBVar13, param_2, param_4, local_80) ),param_2 = pBVar13,iVar10 != 0 )) {
         iVar10 = param_2.top;
         if (iVar10 == 0x10) {
            if (local_88.top == 0x10) {
               ...
               RSAZ_1024_mod_exp_avx2(pBVar13.d, param_2.d, local_88.d, param_4.d, ( local_b0.RR ).d, local_b0.n0[0]);
               pBVar13.top = 0x10;
               LAB_0010173e:pBVar13.neg = 0;
            ...
            LAB_0010138d:if (( ( iVar10 == 8 ) && ( local_88.top == 8 ) ) && ( iVar10 = iVar10 == 0x200 )) {
               lVar31 = bn_wexpand(local_a8, 8);
               pBVar13 = local_a8;
               if (lVar31 != 0) {
                  RSAZ_512_mod_exp(local_a8.d, param_2.d, local_88.d, param_4.d, local_b0.n0[0], ( local_b0.RR ).d);
                  pBVar13.top = 8;
                  goto LAB_0010173e;
               }
         ...
         if ((int)local_dc < 0x3aa) {
            ...
            if ((int)local_dc < 0x5a) {
               ...
               local_b8 = (long**)CONCAT44(local_b8._4_4_, ( 0x16 < (int)local_dc ) + 1 + ( uint )(0x16 < (int)local_dc));
            }
 else {
            ...
            ppplVar26 = &local_e8;
            while (ppplVar24 != (long***)( (long)&local_e8 - ( (long)iVar10 + 0x17U & 0xfffffffffffff000 ) )) {
...
;
            ...
            local_a0 = (long*)( ( ( ( ulong )((long)ppplVar23 + lVar30 + 0xf) & 0xfffffffffffffff0 ) - ( ulong )((uint)(undefined1*)( (long)ppplVar23 + lVar30 + 0xf ) & 0x30) ) + 0x40 );
            if (7 < local_c8) {
               plVar17 = local_a0;
            ...
            LAB_0010155a:if ((int)uVar3 < 0x201) {
               local_98 = (ulong*)CONCAT44(local_98._4_4_, 0x20);
               iVar9 = uVar3 * 8;
               lVar31 = 0x20;
               local_b8 = (long**)CONCAT44(local_b8._4_4_, 5);
            ...
            iVar10 = iVar9 + 0x40;
            LAB_0010177f:local_d8 = "crypto/bn/bn_exp.c";
 ...
 while ( iVar9 < (int)(uint)local_98 );
               ...
               if (-0x40 < (int)uVar27) {
                  ...
                  if (iVar10 < local_88.top) {
                     ...
                     if (( ( uVar27 & 0x3f ) == 0 ) || ( uVar14 = uVar14 >> ( sbyte )(uVar27 & 0x3f) ),local_88.top <= iVar10 + 1) {
                        uVar19 = uVar19 & (uint)uVar14;
                     }
 else {
                        bVar33 = ( byte )((int)uVar27 >> 0x1f);
                        uVar19 = uVar19 & ( ( uint )(local_88.d[(long)iVar10 + 1] << ( ( ( bVar33 >> 2 ) - ( (char)uVar27 + ( bVar33 >> 2 ) & 0x3f ) ) + 0x40 & 0x3f )) | (uint)uVar14 );
                     }
               ...
               *(undefined8*)( (long)ppplVar25 + -8 ) = 0x101fe2;
               iVar9 = MOD_EXP_CTIME_COPY_FROM_PREBUF(&local_78, uVar3, local_a0, uVar19, (ulong)local_b8 & 0xffffffff);
               pBVar8 = local_80;
               pBVar7 = local_b0;
               pplVar28 = local_b8;
               if (iVar9 == 0) goto LAB_001020a5;
 ...
 while ( iVar10 != iVar9 );
                  ...
                  if (iVar10 < local_88.top) {
                     ...
                     if (( ( uVar27 & 0x3f ) == 0 ) || ( uVar14 = uVar14 >> ( sbyte )(uVar27 & 0x3f) ),local_88.top <= iVar10 + 1) {
                        ...
                        bVar33 = ( byte )((int)uVar27 >> 0x1f);
                        uVar19 = ( ( uint )(local_88.d[(long)iVar10 + 1] << ( ( ( bVar33 >> 2 ) - ( (char)uVar27 + ( bVar33 >> 2 ) & 0x3f ) ) + 0x40 & 0x3f )) | (uint)uVar14 ) & (uint)local_e8;
                     }
                  ...
                  *(undefined8*)( (long)ppplVar25 + -8 ) = 0x102266;
                  iVar10 = MOD_EXP_CTIME_COPY_FROM_PREBUF(local_c0, local_dc, local_a0, uVar19, (ulong)pplVar28 & 0xffffffff);
                  if (iVar10 == 0) break;
 ...
 while ( iVar10 != 0 );
               LAB_00102055:if (local_90 != (BN_MONT_CTX*)0x0) {
                  iVar9 = 0;
                  goto LAB_001020b5;
               }
            ...
            if (( uVar3 - 1 < 3 ) || ( puVar29 == puVar4 + 1 )) {
               pplVar15 = (long**)0x0;
               do {
                  *(undefined8*)( (long)puVar29 + (long)pplVar15 ) = *(undefined8*)( (long)puVar4 + (long)pplVar15 );
                  pplVar15 = pplVar15 + 1;
               }
               ...
               *(undefined8*)( (long)ppplVar25 + -8 ) = 0x1022bf;
               ...
               if (iVar10 < local_88.top) {
                  ...
                  if (( ( uVar27 & 0x3f ) == 0 ) || ( uVar14 = uVar14 >> ( sbyte )(uVar27 & 0x3f) ),local_88.top <= iVar10 + 1) {
                     ...
                     bVar33 = ( byte )((int)uVar27 >> 0x1f);
                     lVar31 = (long)(int)( uVar19 & ( ( uint )(local_88.d[(long)iVar10 + 1] << ( ( ( bVar33 >> 2 ) - ( (char)uVar27 + ( bVar33 >> 2 ) & 0x3f ) ) + 0x40 & 0x3f )) | (uint)uVar14 ) );
                  }
...
;
                  ...
                  while (0 < (int)uVar27) {
                     uVar27 = uVar27 - 5;
                     for (int i = 0; i < 5; i++) {
                        *(undefined8*)( (long)ppplVar25 + -8 ) = ( 24*i + 1055932 );
...
;
            ...
            *(undefined8*)( (long)ppplVar25 + -8 ) = 0x101d74;
            ...
            LAB_00101d90:*(undefined8*)( (long)ppplVar25 + -8 ) = 0x101d9c;
            BN_MONT_CTX_free(local_b0);
         }
 else {
            ...
            *(undefined8*)( (long)ppplVar25 + -8 ) = 0x102096;
            ...
            LAB_001020a5:iVar9 = 0;
            if (local_90 == (BN_MONT_CTX*)0x0) {
               LAB_001021c0:iVar9 = 0;
               goto LAB_00101d90;
            }

         }

         LAB_001020b5:*(undefined8*)( (long)ppplVar25 + -8 ) = 0x1020c8;
         ...
         *(undefined8*)( (long)ppplVar25 + -8 ) = 0x1020e0;
         ...
         LAB_001014f8:if (local_90 == (BN_MONT_CTX*)0x0) goto LAB_001016bc;
         iVar9 = 0;
         ppplVar26 = &local_e8;
      }
   ...
   LAB_001020e0:*(undefined8*)( (long)ppplVar26 + -8 ) = 0x1020e9;
   BN_CTX_end(local_80);
   ppplVar22 = ppplVar26;
   LAB_00101462:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar9;
   }
...
int BN_mod_exp_mont_word(BIGNUM *r, ulong a, BIGNUM *p, BIGNUM *m, BN_CTX *ctx, BN_MONT_CTX *m_ctx) {
   ...
   if (m_ctx == (BN_MONT_CTX*)0x0) {
      ...
      LAB_001024e4:iVar6 = iVar6 + -2;
      if (iVar6 < 0) {
         if (local_70 == 1) {
            LAB_00102761:iVar6 = BN_set_word(r, 1);
            uVar9 = ( uint )(iVar6 != 0);
         }
 else {
            LAB_00102717:iVar6 = BN_set_word(a_00, local_70);
            if (( iVar6 != 0 ) && ( iVar6 = BN_to_montgomery(a_00, a_00, local_68, ctx) ),rem = a_00,iVar6 != 0) goto LAB_001025ae;
         }
         ...
         do {
            ...
            if (SUB168(auVar1 * auVar3, 8) == 0) {
               ...
               LAB_00102788:iVar7 = BN_mod_mul_montgomery(pBVar8, pBVar8, pBVar8, local_68, ctx);
               if (iVar7 == 0) goto LAB_001025d0;
               bVar5 = false;
            }
            ...
            a_00 = pBVar8;
            w_00 = w;
            if (( iVar7 != 0 ) && ( auVar2._8_8_ = 0 ),auVar2._0_8_ = local_70,auVar4._8_8_ = 0,auVar4._0_8_ = w,w_00 = SUB168(auVar2 * auVar4, 0),SUB168(auVar2 * auVar4, 8) != 0) {
               if (bVar5) {
                  iVar7 = BN_set_word(pBVar8, w);
                  if (( iVar7 == 0 ) || ( iVar7 = iVar7 == 0 )) goto LAB_001025d0;
                  bVar5 = false;
                  w_00 = local_70;
               }
 else {
                  iVar7 = BN_mul_word(pBVar8, w);
                  if (( iVar7 == 0 ) || ( iVar7 = BN_div((BIGNUM*)0x0, rem, pBVar8, m, ctx) ),a_00 = rem,w_00 = local_70,rem = pBVar8,iVar7 == 0) goto LAB_001025d0;
               }
 ...
 while ( bVar10 );
         if (w_00 == 1) {
            ...
            if (( iVar6 == 0 ) || ( iVar6 = iVar6 == 0 )) goto LAB_001025d0;
         }

         LAB_001025ae:iVar6 = BN_from_montgomery(r, rem, local_68, ctx);
         uVar9 = ( uint )(iVar6 != 0);
      }

      LAB_001025d0:if (m_ctx != (BN_MONT_CTX*)0x0) goto LAB_001025dc;
   }

   BN_MONT_CTX_free(local_68);
   LAB_001025dc:BN_CTX_end(ctx);
   return uVar9;
}
...
int BN_mod_exp_simple(BIGNUM *r, BIGNUM *a, BIGNUM *p, BIGNUM *m, BN_CTX *ctx) {
   ...
   if (( ( iVar2 == 0 ) && ( iVar2 = BN_get_flags(a, 4) ),iVar2 == 0 )) {
      ...
      if (n == 0) {
         ...
         iVar2 = 0;
         local_148[0] = pBVar6;
         if (( pBVar6 != (BIGNUM*)0x0 ) && ( iVar3 = iVar3 != 0 )) {
            iVar3 = BN_is_zero();
            if (iVar3 == 0) {
               if ((int)n < 0x2a0) {
                  if (0xef < (int)n) {
                  ...
                  local_160 = 0x20;
                  uVar1 = 6;
                  LAB_00102b90:iVar3 = BN_mod_mul(pBVar5, pBVar6, pBVar6, m, ctx);
                  ...
                  do {
                     ...
                     if (( pBVar6 == (BIGNUM*)0x0 ) || ( iVar3 = BN_mod_mul(pBVar6, *(BIGNUM**)( local_150 + lVar10 * 2 ), pBVar5, m, ctx) ),iVar3 == 0) goto LAB_00102abd;
                     lVar10 = lVar10 + 1;
                     n = local_150[0];
                  }
 while ( (int)lVar10 < local_160 );
               ...
               pBVar5 = p;
               if (( ( p == r ) && ( ( pBVar5 = BN_CTX_get(ctx) ),pBVar5 == (BIGNUM*)0x0 || ( pBVar6 = BN_copy(pBVar5, p) ),pBVar6 == (BIGNUM*)0x0 ) )) goto LAB_00102abd;
               uVar8 = 1;
               do {
                  n = n - 1;
 ...
 while ( ( uVar1 != uVar11 ) && ( uVar9 = uVar11 != n + 1 ) );
                        uVar9 = uVar8;
                        if (local_150[0] == 0) goto LAB_00102e9f;
                        LAB_00102e43:while (true) {
...
;
 ...
 while ( true );
                  ...
                  if (uVar8 == 0) {
                     LAB_00102d8f:iVar3 = BN_mod_mul(r, r, r, m, ctx);
                     if (iVar3 == 0) goto LAB_00102abd;
                     uVar8 = 0;
                  }
 ...
 while ( n != 0 );
            ...
            LAB_00102cad:iVar2 = 1;
         }

         LAB_00102abd:BN_CTX_end(ctx);
      }
   ...
   LAB_00102f14:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
ulong BN_mod_exp_mont_consttime_x2(BIGNUM *param_1, BIGNUM *param_2, BIGNUM *param_3, BIGNUM *param_4, BN_MONT_CTX *param_5, BIGNUM *param_6, BIGNUM *param_7, BIGNUM *param_8, BIGNUM *param_9, BN_MONT_CTX *param_10, BN_CTX *param_11) {
   int iVar1;
   uint uVar2;
   uint uVar3;
   int iVar4;
   ...
   if (iVar1 == 0) {
      ...
      LAB_00102f97:uVar2 = BN_mod_exp_mont_consttime(param_1, param_2, param_3, param_4, param_11, param_5);
      ...
      LAB_00102fe1:if (param_10 == (BN_MONT_CTX*)0x0) goto LAB_001030f0;
   }
 else {
      iVar1 = param_2.top;
      if (iVar1 == 0x10) {
         LAB_00103050:if (param_3.top != 0x10) goto LAB_00102f97;
         iVar1 = BN_num_bits(param_4);
         if (( ( ( iVar1 != 0x400 ) || ( param_7.top != 0x10 ) ) || ( param_8.top != 0x10 ) ) || ( iVar1 = iVar1 != 0x400 )) {
            iVar1 = param_2.top;
            goto LAB_00102f7d;
         }
         ...
         LAB_00102f7d:if (iVar1 == 0x18) {
            if (param_3.top != 0x18) goto LAB_00102f97;
            iVar1 = BN_num_bits(param_4);
            if (( ( iVar1 == 0x600 ) && ( param_7.top == 0x18 ) ) && ( ( param_8.top == 0x18 && ( iVar1 = BN_num_bits(param_9) ),iVar1 == 0x600 ) )) goto LAB_00103156;
            iVar1 = param_2.top;
         }

         if (( ( iVar1 != 0x20 ) || ( param_3.top != 0x20 ) ) || ( ( iVar1 = BN_num_bits(param_4) ),iVar1 != 0x800 || ( ( ( param_7.top != 0x20 || ( param_8.top != 0x20 ) ) || ( iVar1 = BN_num_bits(param_9) ),iVar1 != 0x800 ) ) )) goto LAB_00102f97;
      }

      LAB_00103156:iVar1 = param_2.top;
      iVar4 = BN_num_bits(param_4);
      lVar5 = bn_wexpand(param_1, iVar1);
      if (( lVar5 == 0 ) || ( uVar6 = uVar6 == 0 )) {
         mont = (BN_MONT_CTX*)0x0;
         mont_00 = (BN_MONT_CTX*)0x0;
         uVar6 = 0;
         goto LAB_00102fe1;
      ...
      LAB_0010319c:mont = param_10;
      if (param_10 != (BN_MONT_CTX*)0x0) {
         LAB_001031aa:uVar2 = ossl_rsaz_mod_exp_avx512_x2(param_1.d, param_2.d, param_3.d, param_4.d, ( mont_00.RR ).d, mont_00.n0[0], param_6.d, param_7.d, param_8.d, param_9.d, ( mont.RR ).d, mont.n0[0], iVar4, uVar6);
         param_1.neg = 0;
         param_1.top = iVar1;
      ...
      LAB_001030f0:BN_MONT_CTX_free(mont);
   }
   ...
   LAB_00103085:BN_MONT_CTX_free(mont_00);
   return uVar6;
}

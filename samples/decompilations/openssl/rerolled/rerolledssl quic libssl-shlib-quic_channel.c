...
undefined8 ch_generate_transport_params(long param_1) {
   ...
   if (( ( *(long*)( param_1 + 0x50 ) != 0 ) || ( ( *(byte*)( param_1 + 0x621 ) & 1 ) != 0 ) ) || ( a = BUF_MEM_new() ),a == (BUF_MEM*)0x0) {
      a = (BUF_MEM*)0x0;
      uVar4 = 0;
      goto LAB_001000d2;
   }
   ...
   if (iVar2 != 0) {
      ...
      if (lVar3 != 0) {
         if (( *(byte*)( param_1 + 0x623 ) & 2 ) == 0) {
            ...
            joined_r0x001003ac:if (iVar2 != 0) {
               LAB_00100179:iVar2 = ossl_quic_wire_encode_transport_param_int(local_d8, 1, *(undefined8*)( param_1 + 0x568 ));
               if (( ( iVar2 != 0 ) && ( iVar2 = ossl_quic_wire_encode_transport_param_int(local_d8, 3, 0x4b0) ),iVar2 != 0 )) {
                  uVar4 = ossl_quic_rxfc_get_cwm(param_1 + 0x110);
                  iVar2 = ossl_quic_wire_encode_transport_param_int(local_d8, 4, uVar4);
                  if (( iVar2 != 0 ) && ( ( ( iVar2 = ossl_quic_wire_encode_transport_param_int(local_d8, 5, *(undefined8*)( param_1 + 0x508 )) ),iVar2 != 0 && ( iVar2 = ossl_quic_wire_encode_transport_param_int(local_d8, 6, *(undefined8*)( param_1 + 0x510 )) ),iVar2 != 0 ) ) && ( iVar2 = ossl_quic_wire_encode_transport_param_int(local_d8, 7, *(undefined8*)( param_1 + 0x518 )) ),iVar2 != 0) {
                           ...
                           if (iVar2 != 0) {
                              ...
                              *(char**)( param_1 + 0x50 ) = pcVar1;
                              ...
                              if (iVar2 != 0) {
                                 ...
                                 if (( ( lVar5 == 0 ) && ( ( *(byte*)( param_1 + 0x625 ) & 2 ) != 0 ) ) && ( ( ( *(byte*)( param_1 + 0x623 ) & 2 ) == 0 || ( *(char*)( param_1 + 0x478 ) != '\0' ) ) )) {
                                 ...
                                 iVar2 = ossl_qlog_event_try_begin(lVar5, 4, "transport", "parameters_set", "transport:parameters_set");
                                 if (iVar2 != 0) {
                                    ...
                                    if (( *(byte*)( param_1 + 0x623 ) & 2 ) == 0) {
                                       ...
                                       ossl_qlog_bin(lVar5, "original_destination_connection_id", param_1 + 0x479, *(undefined1*)( param_1 + 0x478 ));
                                       ossl_qlog_bin(lVar5, "initial_source_connection_id", param_1 + 0x4cd, *(undefined1*)( param_1 + 0x4cc ));
                                    }
                                    ...
                                    ossl_qlog_u64(lVar5, "initial_max_stream_data_bidi_local", *(undefined8*)( param_1 + 0x508 ));
                                    ossl_qlog_u64(lVar5, "initial_max_stream_data_bidi_remote", *(undefined8*)( param_1 + 0x510 ));
                                    ossl_qlog_u64(lVar5, "initial_max_stream_data_uni", *(undefined8*)( param_1 + 0x518 ));
                                    uVar4 = ossl_quic_rxfc_get_cwm(param_1 + 0x290);
            ...
            if (( iVar2 != 0 ) && ( iVar2 = ossl_quic_wire_encode_transport_param_cid(local_d8, 0xf, param_1 + 0x4cc) ),iVar2 != 0) {
               if (*(char*)( param_1 + 0x48d ) != '\0') {
   ...
   LAB_001003c0:uVar4 = 0;
   LAB_001000d2:BUF_MEM_free(a);
...
void ch_cleanup(long *param_1) {
   ...
   if (param_1[0x83] != 0) {
      for (int i = 0; i < 3; i++) {
         ossl_ackm_on_pkt_space_discarded(param_1[131], i);
      }
...
void ch_discard_el_isra_0(long param_1, uint param_2) {
   ...
   if (( *(long*)( lVar1 + 0x448 ) != 0 ) && ( *(long*)( lVar1 + 0x460 ) != 0 )) {
      ...
      *(byte*)( param_1 + 0x622 ) = *(byte*)( param_1 + 0x622 ) & 0xf | ( byte )(( ( uint )(*(byte*)( param_1 + 0x622 ) >> 4) | 1 << ( (byte)param_2 & 0x1f ) ) << 4);
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 ch_init(long *param_1) {
                           ...
                           if (iVar3 != 0) {
                              *(byte*)( (long)param_1 + 0x621 ) = *(byte*)( (long)param_1 + 0x621 ) | 0x10;
                              ...
                              if (lVar8 != 0) {
                                 ...
                                 param_1[0x83] = lVar8;
                                 if (lVar8 != 0) {
                                    iVar3 = ossl_quic_stream_map_init(param_1 + 0x6a, 0x100000, param_1, plVar10, plVar9, *(byte*)( (long)param_1 + 0x623 ) >> 1 & 1);
                                    if (( iVar3 != 0 ) && ( ( *(byte*)( (long)param_1 + 0x621 ) = *(byte*)( (long)param_1 + 0x621 ) | 0x20(*(byte*)( (long)param_1 + 0x623 ) & 2) != 0 || ( iVar3 = ossl_quic_lcidm_generate_initial(param_1[7], param_1, (long)param_1 + 0x4a2) != 0 ) ) )) {
                                       ...
                                       uStack_168 = ( undefined5 )(( ulong ) * (undefined8*)( (long)param_1 + 0x4af ) >> 0x18);
                                       ...
                                       uStack_153 = ( undefined5 )(( ulong ) * (undefined8*)( (long)param_1 + 0x485 ) >> 0x18);
                                       local_dc = 3;
 ...
 while ( lVar8 != 0x18 );
                                       ...
                                       if (lVar8 != 0) {
                                          ...
                                          ossl_quic_tx_packetiser_set_ack_tx_cb(param_1[0x1b], ch_on_txp_ack_tx, param_1);
                                          if (param_1[0x85] == 0) {
                                             ...
                                             LAB_00100f0c:iVar2 = ossl_qrx_set_late_validation_cb(param_1[0x85], rx_late_validate, param_1);
                                             if (( iVar2 == 0 ) || ( iVar2 = ossl_qrx_set_key_update_cb(param_1[0x85], rxku_detected, param_1) ),iVar2 == 0) goto LAB_00101178;
                                          }
 ...
 while ( param_1 + 0x8f != plVar10 );
   ...
   LAB_00101178:ch_cleanup(param_1);
   uVar7 = 0;
   LAB_00101182:if (local_58[3] != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
void ch_get_qlog_cb(long param_1) {
   ...
   if (( ( *(long*)( param_1 + 0x48 ) == 0 ) && ( ( *(byte*)( param_1 + 0x625 ) & 2 ) != 0 ) ) && ( ( ( *(byte*)( param_1 + 0x623 ) & 2 ) == 0 || ( *(char*)( param_1 + 0x478 ) != '\0' ) ) )) {
...
void ch_record_state_transition(long param_1, undefined4 param_2) {
   ...
   *(byte*)( param_1 + 0x620 ) = bVar1 & 0xf8 | (byte)param_2 & 7;
   ...
   if (( ( lVar3 == 0 ) && ( ( *(byte*)( param_1 + 0x625 ) & 2 ) != 0 ) ) && ( ( ( *(byte*)( param_1 + 0x623 ) & 2 ) == 0 || ( *(char*)( param_1 + 0x478 ) != '\0' ) ) )) {
...
void ch_start_terminating(undefined8 *param_1, undefined8 *param_2, int param_3) {
   ...
   if (( bVar1 & 0x20 ) == 0) {
         ...
         if (bVar4 < 4) {
            if (bVar4 == 1) {
               ...
               *(byte*)( param_1 + 0xbc ) = bVar1 & 0xfc | bVar4 & 1 | bVar2 & 2;
               ...
               lVar7 = param_1[9];
               if (( ( lVar7 == 0 ) && ( ( *(byte*)( (long)param_1 + 0x625 ) & 2 ) != 0 ) ) && ( ( ( *(byte*)( (long)param_1 + 0x623 ) & 2 ) == 0 || ( *(char*)( param_1 + 0x8f ) != '\0' ) ) )) {
            ...
            LAB_00101670:if (( bVar1 & 7 ) == 4) goto LAB_00101500;
            LAB_00101678:uVar9 = param_2[1];
            bVar1 = *(byte*)( param_1 + 0xbc );
            param_1[0xb8] = *param_2;
            param_1[0xb9] = uVar9;
      ...
      if (bVar4 == 3) {
         if (param_3 == 0) {
            LAB_00101500:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
               return;
            }
   ...
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      uVar9 = 4;
      LAB_001014ba:ch_record_state_transition(param_1, uVar9);
      return;
   }

   LAB_0010182d:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
undefined8 *ossl_quic_channel_alloc(undefined8 *param_1) {
   ...
   if (ptr != (undefined8*)0x0) {
      ...
      *ptr = *param_1;
      ...
      ptr[0xc4] = ( ulong )(uVar4 & 1) << 0x29 | ( ulong )(uVar3 & 1) << 0x19 | ( ulong )(*(uint*)( (long)param_1 + 0x34 ) & 1) << 0x2a | ptr[0xc4] & 0xfffff9fffdffffff;
      if (( ulong )(uVar4 & 1) == 0) {
         return ptr;
      }
...
undefined8 ch_on_crypto_release_record(undefined8 param_1, long param_2) {
   ...
   uVar5 = 0;
   LAB_00101ba2:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar5;
   }
...
undefined8 ossl_quic_channel_schedule_new_token(long param_1, undefined8 param_2, undefined8 param_3) {
   ...
   if (a != (BUF_MEM*)0x0) {
      ...
      if (iVar1 != 0) {
         ...
         if (iVar1 == 0) {
            ...
            if (iVar1 != 0) {
               lVar2 = ossl_quic_cfq_add_frame(*(undefined8*)( param_1 + 0xe8 ), 1, 2, 7, 0, a.data, local_70, free_buf_mem, a);
               if (lVar2 != 0) {
                  uVar3 = 1;
                  goto LAB_00101c4d;
               }
   ...
   BUF_MEM_free(a);
   uVar3 = 0;
   LAB_00101c4d:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar3;
   }
...
void ossl_quic_channel_local_close(undefined8 *param_1, undefined8 param_2, char *param_3) {
   ...
   if (bVar3 == 3) {
      ...
      if (bVar3 == 1) {
         ...
         *(byte*)( param_1 + 0xbc ) = *(byte*)( param_1 + 0xbc ) & 0xfd | 1 | (byte)local_c8 & 2;
         ...
         lVar8 = param_1[9];
         if (( ( lVar8 == 0 ) && ( ( *(byte*)( (long)param_1 + 0x625 ) & 2 ) != 0 ) ) && ( ( ( *(byte*)( (long)param_1 + 0x623 ) & 2 ) == 0 || ( *(char*)( param_1 + 0x8f ) != '\0' ) ) )) {
            local_88 = param_1[0x8f];
            local_58 = *(byte*)( (long)param_1 + 0x623 ) >> 1 & 1;
            uStack_80 = (undefined5)param_1[0x90];
            uStack_7b = ( undefined3 ) * (undefined8*)( (long)param_1 + 0x485 );
   ...
   LAB_00101f70:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
void ossl_quic_channel_on_remote_conn_close(undefined8 *param_1, byte *param_2) {
   ...
   if (bVar5 == 3) {
      ...
      if (bVar5 == 1) {
         ...
         *(byte*)( param_1 + 0xbc ) = *(byte*)( param_1 + 0xbc ) & 0xfe | bVar11 | 2;
         ...
         lVar9 = param_1[9];
         if (( ( lVar9 == 0 ) && ( ( *(byte*)( (long)param_1 + 0x625 ) & 2 ) != 0 ) ) && ( ( ( *(byte*)( (long)param_1 + 0x623 ) & 2 ) == 0 || ( *(char*)( param_1 + 0x8f ) != '\0' ) ) )) {
      ...
      LAB_001024b8:param_1[0xb8] = uVar3;
      param_1[0xb9] = uVar4;
      param_1[0xba] = 0;
      param_1[0xbb] = 0;
      *(byte*)( param_1 + 0xbc ) = *(byte*)( param_1 + 0xbc ) & 0xfe | bVar11 | 2;
   ...
   ch_record_state_transition(param_1, 4);
   LAB_001022e7:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
void ossl_quic_channel_on_stateless_reset(undefined8 *param_1) {
   ...
   if (bVar2 == 3) {
      ...
      if (bVar2 == 1) {
         ...
         *(byte*)( param_1 + 0xbc ) = *(byte*)( param_1 + 0xbc ) & 0xfc | 2;
         ...
         lVar5 = param_1[9];
         if (( ( lVar5 == 0 ) && ( ( *(byte*)( (long)param_1 + 0x625 ) & 2 ) != 0 ) ) && ( ( ( *(byte*)( (long)param_1 + 0x623 ) & 2 ) == 0 || ( *(char*)( param_1 + 0x8f ) != '\0' ) ) )) {
   ...
   ch_record_state_transition(param_1, 4);
   LAB_00102700:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void ossl_quic_channel_raise_net_error(long param_1) {
   undefined8 uVar1;
   undefined8 uVar2;
   byte bVar3;
   long lVar4;
   ...
   *(byte*)( param_1 + 0x624 ) = *(byte*)( param_1 + 0x624 ) | 0x20;
   ...
   if (bVar3 < 4) {
      if (bVar3 < 2) {
         if (bVar3 == 1) {
            ...
            *(long*)( param_1 + 0x5d0 ) = lVar4;
            ...
            if (( ( lVar4 == 0 ) && ( ( *(byte*)( param_1 + 0x625 ) & 2 ) != 0 ) ) && ( ( ( *(byte*)( param_1 + 0x623 ) & 2 ) == 0 || ( *(char*)( param_1 + 0x478 ) != '\0' ) ) )) {
      ...
      LAB_00102aa8:*(byte*)( param_1 + 0x5e0 ) = *(byte*)( param_1 + 0x5e0 ) & 0xfc;
      uVar2 = _UNK_001080c8;
      uVar1 = __LC24;
      *(undefined8*)( param_1 + 0x5d0 ) = 0;
      *(undefined8*)( param_1 + 0x5d8 ) = 0;
   ...
   ch_record_state_transition(param_1, 4);
   LAB_00102988:if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
void ossl_quic_channel_raise_protocol_error_loc(long param_1, long param_2, long param_3, char *param_4, long param_5, long param_6, undefined4 param_7, undefined8 param_8) {
   undefined4 uVar1;
   undefined *puVar2;
   undefined *puVar3;
   undefined *puVar4;
   ...
   if (param_3 == 0) {
      ...
      ERR_set_error(0x14, uVar1, "QUIC error code: 0x%llx%s%s%s, reason: \"%s\"", param_2, local_88, puVar2, local_80);
   }
 else {
      ...
      ERR_set_error(0x14, uVar1, "QUIC error code: 0x%llx%s%s%s (triggered by frame type: 0x%llx%s%s%s), reason: \"%s\"", param_2, local_88, puVar2, local_80, param_3, puVar7, puVar3, puVar4, param_4);
   }
   ...
   if (lVar6 == 0) {
      ...
      *(long*)( param_1 + 0x628 ) = lVar6;
      ...
      LAB_00102d71:OSSL_ERR_STATE_save(lVar6);
   }
   ...
   *(byte*)( param_1 + 0x624 ) = *(byte*)( param_1 + 0x624 ) | 0x40;
   ...
   LAB_00102da8:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 ch_on_handshake_alert(long param_1, byte param_2) {
   ...
   undefined8 uVar3;
   if (param_2 == 10) {
      if (( ( *(byte*)( param_1 + 0x621 ) & 2 ) != 0 ) && ( iVar1 = ossl_quic_tls_is_cert_request(*(undefined8*)( param_1 + 0x28 )) ),iVar1 != 0) {
 ...
 else if (( ( param_2 == 0x2f ) && ( ( *(byte*)( param_1 + 0x621 ) & 2 ) != 0 ) ) && ( iVar1 = ossl_quic_tls_has_bad_max_early_data(*(undefined8*)( param_1 + 0x28 )) ),iVar1 != 0) {
      pcVar2 = "Bad max_early_data received";
      uVar3 = 0x4cd;
      LAB_00102f4f:ossl_quic_channel_raise_protocol_error_loc(param_1, 10, 0, pcVar2, 0, "ssl/quic/quic_channel.c", uVar3, "ch_on_handshake_alert");
      return 1;
   }

   ossl_quic_channel_raise_protocol_error_loc(param_1, (ulong)param_2 + 0x100, 0, "handshake alert", 0, "ssl/quic/quic_channel.c", 0x4d2, "ch_on_handshake_alert");
   return 1;
}
int ch_on_transport_params(undefined8 param_1, long param_2, undefined8 *param_3) {
   ...
   if (param_2 < 0) {
      ...
      uVar26 = 0x53c;
      LAB_0010383e:ossl_quic_channel_raise_protocol_error_loc(param_3, 1, 0, pcVar23, 0, "ssl/quic/quic_channel.c", uVar26, "ch_on_transport_params");
   }
 else {
      local_108 = param_1;
      local_100 = param_2;
      if (param_2 == 0) {
         LAB_00103b00:pcVar23 = "INITIAL_SCID was not sent but is required";
      }
 else {
         local_150 = 0;
         bVar3 = false;
         ...
         do {
            ...
            if (iVar18 == 0) {
               LAB_00103870:pcVar23 = "bad transport parameter";
               goto LAB_001030a7;
            }
 ...
 while ( local_100 != 0 );
         ...
         if (( bVar1 & 2 ) != 0) {
            ...
            *(byte*)( param_3 + 0xc4 ) = *(byte*)( param_3 + 0xc4 ) | 0x80;
            ...
            if (( ( lVar21 == 0 ) && ( ( *(byte*)( (long)param_3 + 0x625 ) & 2 ) != 0 ) ) && ( ( ( bVar1 & 2 ) == 0 || ( *(char*)( param_3 + 0x8f ) != '\0' ) ) )) {
            ...
            iVar18 = ossl_qlog_event_try_begin(lVar21, 4, "transport", "parameters_set", "transport:parameters_set");
            if (iVar18 != 0) {
               ossl_qlog_str(lVar21, "owner", "remote");
               if (bVar6) {
                  ossl_qlog_bin(lVar21, "original_destination_connection_id", (long)param_3 + 0x479, *(undefined1*)( param_3 + 0x8f ));
               }

               ossl_qlog_bin(lVar21, "original_source_connection_id", (long)param_3 + 0x479, *(undefined1*)( param_3 + 0x8f ));
               if (bVar4) {
                  ossl_qlog_bin(lVar21, "retry_source_connection_id", param_3 + 0x97, *(undefined1*)( (long)param_3 + 0x4b7 ));
               }
            ...
            if (( ( *(byte*)( (long)param_3 + 0x623 ) & 2 ) == 0 ) || ( iVar18 = iVar18 != 0 )) goto LAB_001030d2;
      ...
      LAB_001030a7:ossl_quic_channel_raise_protocol_error_loc(param_3, 8, 0, pcVar23, 0, "ssl/quic/quic_channel.c", 0x72b);
   }

   local_144 = 0;
   LAB_001030d2:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 ch_on_handshake_yield_secret(uint param_1, int param_2, undefined4 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, long param_7) {
   long lVar1;
   uint uVar2;
   int iVar3;
   undefined8 uVar4;
            ...
            while (true) {
               ...
               if (lVar1 != 0) {
                  ...
                  if (( iVar3 == 0 ) || ( local_48 != 0 )) {
                     ossl_quic_channel_raise_protocol_error_loc(param_7, 10, 6, "crypto stream data in wrong EL", 0, "ssl/quic/quic_channel.c", 0x45a, "ch_on_handshake_yield_secret");
                     goto LAB_00103fb7;
                  }
...
;
            iVar3 = ossl_qrx_provide_secret(*(undefined8*)( param_7 + 0x428 ), param_1, param_3, param_4, param_5, param_6);
            if (iVar3 != 0) {
               *(ushort*)( param_7 + 0x622 ) = (short)param_1 * 2 & 0x40eU | 0x400 | *(ushort*)( param_7 + 0x622 ) & 0xfbf1;
               LAB_001040fb:uVar4 = 1;
               goto LAB_00103fb9;
            }
   ...
   LAB_00103fb7:uVar4 = 0;
   LAB_00103fb9:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
...
undefined8 ch_on_crypto_recv_record(undefined8 param_1, undefined8 param_2, long param_3) {
   ...
   if (( bVar1 & 7 ) != 0) {
      uVar6 = 0;
      lVar5 = 0;
      LAB_001041b0:lVar5 = *(long*)( param_3 + 0x460 + lVar5 * 8 );
      local_3c = 0;
      local_38 = 0;
      if (lVar5 != 0) {
         iVar3 = ossl_quic_rstream_available(lVar5, &local_38, &local_3c);
         if (( iVar3 == 0 ) || ( local_38 != 0 )) {
            ossl_quic_channel_raise_protocol_error_loc(param_3, 10, 6, "crypto stream data in wrong EL", 0, "ssl/quic/quic_channel.c", 0x3f9, "ch_on_crypto_recv_record");
            goto LAB_001042b2;
         }
   ...
   lVar5 = 0;
   LAB_00104245:lVar5 = *(long*)( param_3 + 0x460 + lVar5 * 8 );
   if (lVar5 == 0) {
      LAB_001042b2:uVar4 = 0;
   }
 else {
   ...
   return uVar4;
   LAB_00104220:lVar5 = 2;
   if (uVar6 == 2) {
      LAB_00104218:lVar5 = 1;
   }
...
undefined8 ossl_quic_channel_on_handshake_confirmed(long param_1) {
   ...
   if (( *(byte*)( param_1 + 0x621 ) & 4 ) == 0) {
      if (( *(byte*)( param_1 + 0x621 ) & 2 ) == 0) {
         ossl_quic_channel_raise_protocol_error_loc(param_1, 10, 0x1e, "handshake cannot be confirmed before it is completed", 0, "ssl/quic/quic_channel.c", 0xc08, "ossl_quic_channel_on_handshake_confirmed");
         uVar2 = 0;
         goto LAB_0010437f;
      }
   ...
   uVar2 = 1;
   LAB_0010437f:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
      ...
      if (*(char*)( param_1 + 0x620 ) < '\0') {
         ...
         *(byte*)( param_1 + 0x621 ) = *(byte*)( param_1 + 0x621 ) | 2;
         if (*(long*)( param_1 + 0x58 ) != 0) {
            ossl_quic_channel_schedule_new_token(param_1, *(long*)( param_1 + 0x58 ), *(undefined8*)( param_1 + 0x60 ));
         ...
         ossl_qlog_event_connectivity_connection_state_updated(lVar3, bVar5, bVar5, bVar1 >> 1 & 1, bVar1 >> 2 & 1);
         uVar2 = 1;
         goto LAB_0010462f;
      }

      ossl_quic_channel_raise_protocol_error_loc(param_1, 0x16d, 6, "no transport parameters received", 0, "ssl/quic/quic_channel.c", 0x482, "ch_on_handshake_complete");
   }

   uVar2 = 0;
   LAB_0010462f:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
...
void ossl_quic_channel_on_new_conn_id(long param_1, ulong *param_2) {
   ...
   if (*(char*)( param_1 + 0x4e1 ) == '\0') {
      ossl_quic_channel_raise_protocol_error_loc(param_1, 10, 0x18, "zero length connection id in use", 0, "ssl/quic/quic_channel.c", 0xd07, "ossl_quic_channel_on_new_conn_id");
      goto LAB_001048c0;
   }
   ...
   if (uVar7 - uVar6 < 2) {
      ...
      if (uVar6 - uVar1 < 0xb) {
         if (*(ulong*)( param_1 + 0x4f8 ) < uVar7) {
            iVar3 = ossl_quic_srtm_add(*(undefined8*)( param_1 + 0x40 ), param_1, uVar7, (long)param_2 + 0x25);
            if (iVar3 == 0) {
         ...
         while (uVar1 < uVar6) {
            ...
            a = BUF_MEM_new();
            if (a == (BUF_MEM*)0x0) {
               LAB_001048f0:ossl_quic_channel_raise_protocol_error_loc(param_1, 1, 0x18, "internal error enqueueing retire conn id", 0, "ssl/quic/quic_channel.c", 0xcf3, "ch_enqueue_retire_conn_id");
               BUF_MEM_free(a);
               break;
            }
            ...
            if (( iVar3 == 0 ) || ( lVar4 = ossl_quic_cfq_add_frame(*(undefined8*)( param_1 + 0xe8 ), 1, 2, 0x19, 0, a.data, local_80, free_frame_data, 0) ),lVar4 == 0) goto LAB_001048f0;
            a.data = (char*)0x0;
            BUF_MEM_free(a);
...
;
   ...
   LAB_0010494e:ossl_quic_channel_raise_protocol_error_loc(param_1, 9, 0x18, pcVar5, 0, "ssl/quic/quic_channel.c", uVar8, "ossl_quic_channel_on_new_conn_id");
   LAB_001048c0:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
void rxku_detected(undefined8 param_1, undefined8 *param_2) {
   ...
   if (( param_2[0xc4] & 0x400000400 ) != 0x400) {
      ossl_quic_channel_raise_protocol_error_loc(param_2, 0xe, 0, "RX key update again too soon", 0, "ssl/quic/quic_channel.c", 0x379, "rxku_detected");
      return;
   }
   ...
   if (( ~(int)cVar1 >> 0x1f ) * -2 == 2) {
      ...
      if (uVar3 >> 0x3e == 0) {
         ...
         if (iVar2 != 0) {
            ...
            *(byte*)( (long)param_2 + 0x624 ) = ( *(byte*)( (long)param_2 + 0x623 ) >> 7 ) << 4 | 1 | (byte)uVar5;
            goto LAB_00104afe;
         }
      ...
      ossl_quic_channel_raise_protocol_error_loc(param_2, 1, 0, "key update", 0, "ssl/quic/quic_channel.c", 0x2e5);
   }

   LAB_00104afe:ossl_quic_tx_packetiser_schedule_ack(param_2[0x1b], 2, pcVar7);
   return;
}
undefined8 ossl_quic_channel_start(long *param_1) {
   ...
   if (( *(byte*)( (long)param_1 + 0x623 ) & 2 ) == 0) {
      ...
      if (iVar1 != 0) {
         ...
         if (( bVar4 & 2 ) == 0) {
            ...
            if (iVar1 != 0) {
               iVar1 = ossl_quic_tx_packetiser_set_initial_token(param_1[0x1b], *(undefined8*)( local_98 + 0x18 ), *(undefined8*)( local_98 + 0x20 ), free_peer_token);
               if (iVar1 == 0) {
         ...
         iVar1 = ossl_quic_provide_initial_secret(*(undefined8*)*plVar3, ( (undefined8*)*plVar3 )[1], param_1 + 0x8f, bVar4 >> 1 & 1, param_1[0x85], param_1[0x84]);
         if (iVar1 != 0) {
            ...
            *(byte*)( (long)param_1 + 0x623 ) = *(byte*)( (long)param_1 + 0x623 ) | 8;
            ...
            ossl_quic_channel_raise_protocol_error_loc(param_1, local_90, 0, local_88, local_80, "ssl/quic/quic_channel.c", 0x876, "ch_tick_tls");
         }
   ...
   LAB_00104e60:uVar2 = 0;
   LAB_00104c3b:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void ossl_quic_channel_subtick(long *param_1, ulong *param_2, uint param_3) {
   byte bVar1;
   long lVar2;
   undefined1 auVar3[16];
   ...
   bVar32 = 0;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( ( *(byte*)( param_1 + 0xc4 ) & 7 ) == 0 ) || ( iVar12 = iVar12 != 0 )) {
      uVar11 = 0;
   }
 else {
      iVar12 = ossl_quic_channel_is_closing(param_1);
      if (( ( iVar12 == 0 ) && ( ( *(byte*)( param_1 + 0xc4 ) & 7 ) != 3 ) ) || ( uVar16 = ossl_quic_port_get_time(*param_1) ),uVar16 < (ulong)param_1[0xbd]) {
         plVar21 = (long*)*param_1;
         bVar28 = false;
         if (( *(byte*)( *plVar21 + 0xa0 ) & 1 ) == 0) {
            if (( ( *(byte*)( (long)param_1 + 0x624 ) & 2 ) != 0 ) && ( uVar16 = ossl_quic_port_get_time() ),(ulong)param_1[0xc1] <= uVar16) {
               *(byte*)( (long)param_1 + 0x624 ) = *(byte*)( (long)param_1 + 0x624 ) & 0xfd;
               param_1[0xc1] = -1;
               iVar12 = ossl_qrx_key_update_timeout(param_1[0x85], 1);
               if (iVar12 == 0) {
                  ossl_quic_channel_raise_protocol_error_loc(param_1, 1, 0, "RXKU cooldown internal error", 0, "ssl/quic/quic_channel.c", 0x3a9);
               }
               ...
               *(byte*)( (long)param_1 + 0x623 ) = *(byte*)( (long)param_1 + 0x623 ) & 0xf3;
               ...
               if (( *(uint*)( param_1 + 0xc4 ) & 0x2000020 ) != 0) {
                  while (iVar14 = ossl_qrx_read_pkt(param_1[0x85], param_1 + 0xaa),iVar14 != 0) {
                     if (iVar12 != 0) {
                        ossl_quic_tx_packetiser_record_received_closing_bytes(param_1[0x1b], *(undefined8*)( *(long*)param_1[0xaa] + 0x48 ));
                     }
                     ...
                     LAB_00105078:bVar25 = *(byte*)( param_1 + 0xc4 );
                     ...
                     if (( bVar30 & 0xfd ) != 4) {
                        ...
                        if (( bVar30 - 1 < 5 ) && ( ( ( *(byte*)( (long)param_1 + 0x622 ) >> 4 ) >> ( *(uint*)( CSWTCH_72 + ( ulong )(bVar30 - 1) * 4 ) & 0x1f ) & 1 ) != 0 )) goto switchD_0010532b_caseD_0;
                     }

                     if (( ( *(byte*)( (long)param_1 + 0x623 ) & 2 ) == 0 ) && ( plVar21[1] != 0 )) {
                        plVar21 = param_1 + 0xd;
                        iVar14 = BIO_ADDR_family(plVar21);
                        if (( iVar14 != 2 ) && ( iVar14 = iVar14 != 10 )) {
                           plVar21 = (long*)param_1[0xaa];
                           pbVar29 = (byte*)*plVar21;
                           bVar30 = *pbVar29;
                           goto LAB_00105270;
 ...
 else if (( iVar14 == 10 ) && ( *(long*)( lVar19 + 8 ) == param_1[0xe] && *(long*)( lVar19 + 0x10 ) == param_1[0xf] )) {
                              LAB_001057fb:if (*(short*)( lVar19 + 2 ) == *(short*)( (long)param_1 + 0x6a )) {
                                 pbVar29 = (byte*)*plVar21;
                                 bVar30 = *pbVar29;
                                 goto LAB_00105270;
                              }
                        ...
                        LAB_0010538a:plVar21 = (long*)param_1[0xaa];
                     }
 else {
                        LAB_00105270:if (( *(uint*)( param_1 + 0xc4 ) & 0x2000008 ) != 8) {
                           if (1 < bVar30 - 5) goto LAB_00105295;
                           if (bVar30 != 6) goto LAB_001056da;
                           LAB_00105628:if (( *(int*)( pbVar29 + 4 ) == 0 ) && ( bVar25 == 0 )) {
                              *(byte*)( param_1 + 0xc4 ) = *(byte*)( param_1 + 0xc4 ) | 0x10;
                              ...
                              do {
                                 if (piVar17 == piVar27) {
                                    ossl_quic_channel_raise_protocol_error_loc(param_1, 2, 0, "unsupported protocol version", 0, "ssl/quic/quic_channel.c", 0x990, "ch_rx_handle_packet");
                                    plVar21 = (long*)param_1[0xaa];
                                    goto switchD_0010532b_caseD_0;
                                 }
 ...
 while ( iVar14 != 1 );
                              ...
                              uVar33 = 0x985;
                              LAB_00105482:ossl_quic_channel_raise_protocol_error_loc(param_1, 1, 0, pcVar23, 0, "ssl/quic/quic_channel.c", uVar33, "ch_rx_handle_packet");
                              plVar21 = (long*)param_1[0xaa];
                           }
                        ...
                        if (bVar30 == 5) {
                           LAB_001056da:*(byte*)( param_1 + 0xc4 ) = *(byte*)( param_1 + 0xc4 ) | 0x10;
                           LAB_001056e2:if (( pbVar29[2] & 0x30 ) == 0) goto LAB_001052b2;
                           pcVar23 = "packet header reserved bits";
                           uVar33 = 0x99e;
                           LAB_0010570b:ossl_quic_channel_raise_protocol_error_loc(param_1, 10, 0, pcVar23, 0, "ssl/quic/quic_channel.c", uVar33, "ch_rx_handle_packet");
                           plVar21 = (long*)param_1[0xaa];
                        }
 else {
                           bVar1 = pbVar29[0x1d];
                           if (( ( *(byte*)( (long)param_1 + 0x4a2 ) != bVar1 ) || ( 0x14 < bVar1 ) ) || ( iVar14 = memcmp(pbVar29 + 0x1e, (void*)( (long)param_1 + 0x4a3 ), (ulong)bVar1) ),iVar14 != 0) goto switchD_0010532b_caseD_0;
                           if (bVar30 == 6) goto LAB_00105628;
                           LAB_00105295:if (*(int*)( pbVar29 + 4 ) != 1) goto switchD_0010532b_caseD_0;
                           *(byte*)( param_1 + 0xc4 ) = *(byte*)( param_1 + 0xc4 ) | 0x10;
                           if (bVar30 != 4) goto LAB_001056e2;
                           LAB_001052b2:local_d8 = *(undefined8*)( pbVar29 + 0x50 );
                           lVar19 = plVar21[8];
                           lVar2 = plVar21[4];
                           ...
                           lVar22 = param_1[9];
                           if (( ( lVar22 == 0 ) && ( ( *(byte*)( (long)param_1 + 0x625 ) & 2 ) != 0 ) ) && ( ( ( *(byte*)( (long)param_1 + 0x623 ) & 2 ) == 0 || ( (char)param_1[0x8f] != '\0' ) ) )) {
...
LAB_00105359:
                    ...
                    if (bVar25 == 0) {
                     ...
                     switchD_0010532b_caseD_0:bVar31 = true;
...
;
 ...
 while ( uVar15 != 4 );
                  ...
                  if (uVar16 <= uVar18) {
                     ossl_quic_channel_raise_protocol_error_loc(param_1, 0xf, 0, "forgery limit", 0, "ssl/quic/quic_channel.c", 0x89d, "ch_rx_check_forged_pkt_limit");
                  }

                  if (( bVar31 ) && ( bVar28 = iVar12 != 0 )) {
                     *(byte*)( (long)param_1 + 0x623 ) = *(byte*)( (long)param_1 + 0x623 ) | 1;
                  }
               ...
               if (( ( bVar25 & 8 ) == 0 ) && ( local_c8 = 0(param_3 & 1) == 0 )) {
                  *(byte*)( (long)param_1 + 0x623 ) = bVar25 | 8;
                  ...
                  if (iVar12 == 0) {
                     ...
                     ossl_quic_channel_raise_protocol_error_loc(param_1, local_e0, 0, local_d8, local_c8, "ssl/quic/quic_channel.c", 0x876, "ch_tick_tls");
                     bVar28 = true;
                     bVar25 = *(byte*)( (long)param_1 + 0x623 );
                  }
            ...
            if (( *(byte*)( *(long*)*param_1 + 0xa0 ) & 1 ) == 0) {
               ...
               if (( *(byte*)( param_1 + 0xc4 ) & 7 ) != 3) {
                  ...
                  if (( *(uint*)( param_1 + 0xc4 ) & 0x1c400 ) == 0xc400) {
                     ...
                     uVar16 = ossl_quic_port_get_time(*param_1);
                     if (( uVar16 < (ulong)param_1[0xc0] ) || ( ( *(byte*)( (long)param_1 + 0x624 ) & 6 ) != 0 )) goto LAB_00105cf9;
                     ...
                     if (uVar16 <= uVar18) {
                        *(byte*)( (long)param_1 + 0x623 ) = *(byte*)( (long)param_1 + 0x623 ) | 0x80;
                        ...
                        if (( uVar16 >> 0x3e == 0 ) && ( iVar12 = iVar12 != 0 )) {
                           param_1[0xc2] = uVar16;
                           *(byte*)( (long)param_1 + 0x624 ) = ( *(byte*)( (long)param_1 + 0x623 ) >> 7 ) << 4 | 1 | *(byte*)( (long)param_1 + 0x624 ) & 0xee;
                           goto LAB_00105cf9;
                        }

                        ossl_quic_channel_raise_protocol_error_loc(param_1, 1, 0, "key update", 0, "ssl/quic/quic_channel.c", 0x2e5, "ch_trigger_txku");
                        lVar19 = param_1[0x1b];
                     }

                  }
 else {
                     LAB_00105cf9:lVar19 = param_1[0x1b];
                  }
...
;
                  if (iVar12 == 0) {
                     LAB_00105e1d:ossl_quic_channel_raise_protocol_error_loc(param_1, 1, 0, "internal error (txp generate)", 0, "ssl/quic/quic_channel.c", 0xab1, "ch_tx");
                  }

                  LAB_00105e4c:iVar12 = ossl_qtx_flush_net(param_1[0x84]);
 ...
 while ( iVar12 != 4 );
         ...
         LAB_00104fb1:ch_record_state_transition(param_1, 4);
      }
...
undefined8 ossl_quic_channel_on_new_conn(undefined8 *param_1, undefined8 param_2, undefined8 *param_3, undefined8 *param_4) {
   undefined8 uVar1;
   int iVar2;
   ...
   if (iVar2 != 0) {
      ...
      if (iVar2 != 0) {
         ...
         *(undefined8*)( (long)param_1 + 0x4ee ) = uVar1;
         ...
         if (( ( iVar2 != 0 ) && ( iVar2 = ossl_quic_tx_packetiser_set_cur_dcid(param_1[0x1b], (long)param_1 + 0x4e1) ),iVar2 != 0 )) {
            ...
            iVar2 = ossl_quic_provide_initial_secret(**(undefined8**)*param_1, ( *(undefined8**)*param_1 )[1], param_1 + 0x8f, 1, 0, param_1[0x84]);
            if (( iVar2 != 0 ) && ( iVar2 = ossl_quic_lcidm_enrol_odcid(param_1[7], param_1, param_1 + 0x8f) ),iVar2 != 0) {
               ch_record_state_transition(param_1, 1);
               *(byte*)( param_1 + 0xc4 ) = *(byte*)( param_1 + 0xc4 ) & 0xbf;
               return 1;
            }
...
undefined8 ossl_quic_bind_channel(undefined8 *param_1, undefined8 param_2, undefined8 *param_3, undefined8 *param_4, undefined8 *param_5) {
   undefined8 uVar1;
   int iVar2;
...
void ossl_quic_channel_is_new_local_stream_admissible(long param_1, int param_2) {
   if (param_2 != 0) {
      ossl_quic_stream_map_is_local_allowed_by_stream_limit(param_1 + 0x350, *(undefined8*)( param_1 + 0x598 ), param_2);
      return;
   }

   ossl_quic_stream_map_is_local_allowed_by_stream_limit(param_1 + 0x350, *(undefined8*)( param_1 + 0x590 ), 0);
   return;
}
...
long ossl_quic_channel_new_stream_local(long param_1, int param_2) {
   ...
   *(long*)( lVar3 + 0x70 ) = lVar4;
      ...
      *(long*)( lVar3 + 0x78 ) = lVar4;
      ...
      if (iVar2 != 0) {
         ...
         if (*(char*)( param_1 + 0x620 ) < '\0') {
            ...
            if (bVar10 == 0) {
               if (bVar1 == bVar7) {
                  LAB_00106975:lVar4 = *(long*)( param_1 + 0x508 );
                  lVar5 = lVar4 * 0xc;
               }
 else {
                  LAB_0010684e:lVar4 = *(long*)( param_1 + 0x510 );
                  lVar5 = lVar4 * 0xc;
               }

            }
 else {
               LAB_001068ea:lVar4 = *(long*)( param_1 + 0x518 );
               lVar5 = lVar4 * 0xc;
            }
   ...
   LAB_0010686c:ossl_quic_sstream_free(lVar4);
...
long ossl_quic_channel_new_stream_remote(long param_1, ulong param_2) {
   ...
   *(long*)( lVar4 + 0x78 ) = lVar5;
      ...
      if (iVar3 != 0) {
         ...
         if (( *(char*)( param_1 + 0x620 ) < '\0' ) && ( ( param_2 & 2 ) == 0 )) {
            if (bVar8 == 0) {
               ...
               LAB_00106af4:lVar5 = *(long*)( param_1 + 0x510 );
            }
 else {
               ossl_quic_txfc_bump_cwm(lVar5, *(undefined8*)( param_1 + 0x538 ));
               LAB_00106bce:lVar5 = *(long*)( param_1 + 0x518 );
            }
            ...
            LAB_00106bf0:lVar5 = *(long*)( param_1 + 0x508 );
         }
   ...
   LAB_00106b44:ossl_quic_sstream_free(uVar7);

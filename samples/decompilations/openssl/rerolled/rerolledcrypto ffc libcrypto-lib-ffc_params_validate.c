undefined8 ossl_ffc_params_validate_unverifiable_g(BN_CTX *param_1, BN_MONT_CTX *param_2, BIGNUM *param_3, BIGNUM *param_4, BIGNUM *param_5, BIGNUM *param_6, uint *param_7) {
   int iVar1;
   BIGNUM *pBVar2;
   pBVar2 = BN_value_one();
...
undefined1[16];ossl_ffc_params_FIPS186_4_validate(undefined8 param_1, undefined8 *param_2, ulong param_3, ulong param_4, undefined8 param_5) {
   ...
   if (param_2 != (undefined8*)0x0) {
      ...
      if (( (BIGNUM*)*param_2 != (BIGNUM*)0x0 ) && ( param_2[1] != 0 )) {
         ...
         param_3 = param_4;
         uVar4 = ossl_ffc_params_FIPS186_4_gen_verify(param_1, param_2, 0, uVar5, (long)iVar2, (long)iVar3, param_4, param_5);
      }
...
undefined1[16];ossl_ffc_params_FIPS186_2_validate(undefined8 param_1, undefined8 *param_2, ulong param_3, undefined4 *param_4, undefined8 param_5) {
   undefined1 auVar1[16];
   int iVar2;
   int iVar3;
   ...
   if (( ( param_2 != (undefined8*)0x0 ) && ( (BIGNUM*)*param_2 != (BIGNUM*)0x0 ) ) && ( param_2[1] != 0 )) {
      iVar2 = BN_num_bits((BIGNUM*)*param_2);
      iVar3 = BN_num_bits((BIGNUM*)param_2[1]);
      auVar4._0_8_ = ossl_ffc_params_FIPS186_2_gen_verify(param_1, param_2, 0, param_3 & 0xffffffff, (long)iVar2, (long)iVar3, param_4, param_5);
...
bool ossl_ffc_params_simple_validate(undefined8 param_1, long param_2, undefined4 param_3, byte *param_4) {
   int iVar1;
   long lVar2;
   undefined8 *puVar3;
   long in_FS_OFFSET;
   ...
   bVar4 = false;
   LAB_00100259:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return bVar4;
   }
...
int ossl_ffc_params_full_validate(undefined8 param_1, undefined8 *param_2) {
   ...
   if (iVar3 == 1) {
      ...
      LAB_001003c3:iVar2 = 0;
   }

   BN_CTX_free(c);
   LAB_0010031f:if (lVar1 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar2;
   }

void RC2_set_key(RC2_KEY *key, int len, uchar *data, int bits) {
 ...
 while ( (int)lVar8 < (int)uVar14 );
         LAB_00100097:cVar3 = *(char*)( (long)key.data + (long)(int)uVar14 + -1 );
      }
 else {
         lVar8 = 0;
         ...
         if (len < 0x10) {
            ...
            uVar9 = 0;
            uVar5 = uVar14;
            LAB_001001df:*(undefined8*)( (long)key.data + uVar9 ) = *(undefined8*)( data + uVar9 );
      ...
      LAB_001002c4:cVar3 = *(char*)( (long)key.data + (long)(int)uVar14 + -1 );
   }
 ...
 while ( pRVar11 != (RC2_KEY*)( (long)key.data + ( ulong )(0x7f - uVar14) + 1 ) );
   LAB_001000d6:bVar4 = key_table[bVar4 & (byte)pRVar17.data[0]];
 ...
 while ( (byte*)( (long)key + ( ( (long)(int)uVar16 + -1 ) - (ulong)uVar16 ) ) != pbVar13 );
   ...
   lVar8 = 0x7f;
   do {
      *(uint*)( (long)key.data + lVar8 * 2 + -2 ) = (uint)CONCAT11(*(undefined1*)( (long)key.data + lVar8 ), *(undefined1*)( (long)key.data + lVar8 + -1 ));
      lVar8 = lVar8 + -2;
   }
 while ( lVar8 != -1 );
   return;

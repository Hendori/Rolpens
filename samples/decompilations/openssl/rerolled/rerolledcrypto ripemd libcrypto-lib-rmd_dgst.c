/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int RIPEMD160_Init(RIPEMD160_CTX *c) {
   undefined4 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   c.E = 0xc3d2e1f0;
   ...
   *(undefined1(*) [16])( c.data + 0xd ) = (undefined1[16])0x0;
   ...
   uVar3 = _UNK_00101788;
   c.B = uVar1;
   _UNK_00101788 = (undefined4)uVar2;
   _UNK_0010178c = SUB84(uVar2, 4);
   uVar1 = _UNK_0010178c;
   c.C = _UNK_00101788;
   _UNK_00101788 = uVar3;
   c.D = uVar1;
...
int RIPEMD160_Update(RIPEMD160_CTX *c, void *data, size_t len) {
   ...
   if (uVar3 == 0) {
      ...
      LAB_00101517:ripemd160_block_data_order(c, data, len >> 6);
...
int RIPEMD160_Final(uchar *md, RIPEMD160_CTX *c) {
 ...
 while ( uVar6 < uVar3 );
   ...
   LAB_0010172c:ripemd160_block_data_order(c, ptr, 1);
   uVar6 = 0x38;
   puVar4 = ptr;
   LAB_00101633:uVar5 = (uint)uVar6;
   if (uVar5 < 8) {
      if (( uVar6 & 4 ) == 0) {

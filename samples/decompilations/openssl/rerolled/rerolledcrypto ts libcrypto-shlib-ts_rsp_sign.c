                                    ...
                                    if (iVar6 != 0) {
                                       ...
                                       if (iVar6 == 0) {
                                          ...
                                          if (( ( param_1[8] == 0 ) && ( param_1[9] == 0 ) ) && ( param_1[10] == 0 )) {
                                             lVar9 = 0;
                                             LAB_00101246:if (( ( ( *(byte*)( (long)param_1 + 0x5c ) & 2 ) == 0 ) || ( iVar6 = TS_TST_INFO_set_ordering(lVar8, 1) ),iVar6 != 0 )) &&( ( *(long*)( param_1[0x12] + 0x18 ) == 0 || ( iVar6 = iVar6 != 0 ) ) )(( *(byte*)( (long)param_1 + 0x5c ) & 1 ) == 0);
                                             {
                                                a_01 = (GENERAL_NAME*)0x0;

...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void helper_destroy(long *param_1) {
   ulong uVar1;
   ulong uVar2;
   void *ptr;
   if (*param_1 != 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 helper_init(undefined1 (*param_1)[16], long param_2) {
   undefined4 uVar1;
   int iVar2;
   undefined8 uVar3;
   *param_1 = (undefined1[16])0x0;
   ...
   if (iVar2 != 0) {
      ...
      *(undefined8*)( param_1[1] + 8 ) = uVar3;
      ...
      if (iVar2 != 0) {
         uVar3 = ossl_ackm_new(0x100000, 0, param_1 + 2, &ossl_cc_dummy_method, *(undefined8*)( param_1[1] + 8 ));
   ...
   LAB_001001d9:helper_destroy(param_1);
   return 0;
}
/* WARNING: Type propagation algorithm not settling */undefined8 test_rx_ack(uint param_1) {
   char cVar1;
   ulong uVar2;
   undefined4 uVar3;
   int iVar4;
 ...
 while ( iVar4 != 0 );
      ...
      if (iVar4 == 0) {
         ...
         local_168 = (void*)CRYPTO_zalloc(lVar11 * 0x18, "test/quic_ackm_test.c", 0x3ad);
         ...
         if (iVar4 != 0) {
            ...
            if (iVar4 != 0) {
               ...
               LAB_001004fe:bVar13 = CARRY8(fake_time, *(ulong*)( piVar8 + 2 ));
            ...
            if (iVar4 != 0) {
              ...
              if (iVar4 != 0) {
                uVar12 = 0;
                do {
                  if (uVar12 != (long)iVar7) {
                    lVar10 = ossl_ackm_get_ack_deadline(local_a8[0],uVar12 & 0xffffffff);
                    iVar4 = test_true("test/quic_ackm_test.c",0x3e1,
                                      "ossl_time_is_infinite(ossl_ackm_get_ack_deadline(h.ackm, i))"
                                      ,lVar10 == -1);
                    if (iVar4 == 0) goto switchD_00100531_default;
                  }
                  uVar6 = ossl_ackm_get_ack_deadline(local_a8[0],uVar12 & 0xffffffff);
                  iVar4 = 1;
                  uVar2 = *(ulong *)((long)&local_58 + uVar12 * 2 * 4);
                  if (uVar6 <= uVar2) {
                ...
                goto LAB_001005e7;
                  ...
                  default:
switchD_00100531_default:
            local_150 = local_150 + 1;
            goto LAB_0010036c;
                  case 1:
                  case 3:
            if (iVar7 != piVar8[4]) goto LAB_001005e7;
               }

            }

            LAB_001005fe:uVar9 = 1;
            goto LAB_00100389;
         }
   ...
   LAB_0010036c:uVar9 = 0;
   test_error("test/quic_ackm_test.c", 0x432, "error in ACKM RX script %d, op %zu", ( param_1 & 3 ) + 1, local_150);
   LAB_00100389:helper_destroy(local_a8);
   ...
   return uVar9;
   LAB_001005e7:iVar4 = piVar8[0x10];
   piVar8 = piVar8 + 0x10;
   local_150 = local_150 + 1;
   if (iVar4 == 0) goto LAB_001005fe;
   goto LAB_001004fe;
}
 ...
 while ( lVar11 != lVar8 );
      ...
      do {
         while (iVar4 == 2) {
            ...
            iVar4 = test_int_eq("test/quic_ackm_test.c", 0x244, "ossl_ackm_on_rx_ack_frame(h.ackm, &ack, QUIC_PN_SPACE_INITIAL, fake_time)", &_LC1, uVar5, 1);
            if (iVar4 == 0) goto LAB_00100bfd;
            LAB_00100e21:iVar4 = *(int*)( (long)puVar6 + 0x28 );
            puVar6 = (undefined1*)( (long)puVar6 + 0x28 );
            if (iVar4 == 0) goto LAB_00100e31;
         }
;
         if (iVar4 == 3) {
            lVar8 = 0;
            if (lVar11 != 0) {
               do {
                  lVar9 = lVar8 * 0x18;
                  iVar4 = test_int_eq("test/quic_ackm_test.c", 0x24d, "h.pkts[i].acked", "(s->expect[i] & 1) != 0 ? 1 : 0", *(undefined4*)( local_90 + 0xc + lVar9 ), *(byte*)( *(long*)( (long)puVar6 + 0x20 ) + lVar8 ) & 1);
                  if (( ( iVar4 == 0 ) || ( iVar4 = test_int_eq("test/quic_ackm_test.c", 0x250, "h.pkts[i].lost", "(s->expect[i] & 2) != 0 ? 1 : 0", *(undefined4*)( local_90 + 8 + lVar9 ), *(char*)( *(long*)( (long)puVar6 + 0x20 ) + lVar8 ) >> 1 & 1) ),iVar4 == 0 )) goto LAB_00100bfd;
                  lVar8 = lVar8 + 1;
               }
 while ( lVar11 != lVar8 );
            }
         ...
         if (( iVar4 != 1 ) || ( *(long*)( (long)puVar6 + 0x18 ) == 0 )) goto LAB_00100e21;
         uVar10 = 0;
         ...
         do {
            ...
            *(byte*)( plVar2 + 4 ) = *(byte*)( plVar2 + 4 ) & 0xf0 | 0xc;
            ...
            iVar4 = test_int_eq("test/quic_ackm_test.c", 0x233, "ossl_ackm_on_tx_packet(h.ackm, tx)", &_LC1, uVar5, 1);
            if (iVar4 == 0) goto LAB_00100bfd;
 ...
 while ( iVar4 != 0 );
      LAB_00100e31:uVar3 = 1;
   }

   LAB_00100bfd:helper_destroy(&local_98);
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
bool test_probe_counts_constprop_0(undefined4 *param_1, undefined4 param_2, undefined4 param_3, undefined4 param_4) {
   int iVar1;
   iVar1 = test_uint_eq("test/quic_ackm_test.c", 0x13e, "p->anti_deadlock_handshake", "anti_deadlock_handshake", param_1[1], 0);
   if (( ( ( iVar1 != 0 ) && ( iVar1 = test_uint_eq("test/quic_ackm_test.c", 0x140, "p->anti_deadlock_initial", "anti_deadlock_initial", *param_1, 0) ),iVar1 != 0 ) ) && ( iVar1 = test_uint_eq("test/quic_ackm_test.c", 0x142, "p->pto[QUIC_PN_SPACE_INITIAL]", "pto_initial", param_1[2], param_2) ),iVar1 != 0) {
      iVar1 = test_uint_eq("test/quic_ackm_test.c", 0x146, "p->pto[QUIC_PN_SPACE_APP]", "pto_app", param_1[4], param_4);
      return iVar1 != 0;
   }
...
undefined8 test_tx_ack_case(int param_1) {
   ...
   if (iVar3 == 0) {
      LAB_001011a8:uVar7 = 0;
   }
 else {
      uVar9 = 0;
      ossl_ackm_set_loss_detection_deadline_callback(local_a8, on_loss_detection_deadline_callback, &local_f0);
      if (plVar1[1] != 0) {
         do {
            ...
            *(byte*)( puVar5 + 4 ) = *(byte*)( puVar5 + 4 ) & 0xf0 | (byte)iVar10 & 3 | 0xc;
            ...
            iVar3 = test_int_eq("test/quic_ackm_test.c", 0x17b, "ossl_ackm_on_tx_packet(h.ackm, tx)", &_LC1, uVar2, 1);
            if (iVar3 == 0) goto LAB_001011a8;
            uVar9 = uVar9 + 1;
         }
 while ( uVar9 < (ulong)plVar1[1] );
      ...
      if (iVar4 != 1) {
         if (iVar4 == 0) {
            ...
            iVar4 = test_int_eq("test/quic_ackm_test.c", 0x191, "ossl_ackm_on_rx_ack_frame(h.ackm, &ack, space, fake_time)", &_LC1, uVar2, 1);
            if (iVar4 != 0) {
               if (plVar1[1] != 0) {
                  uVar9 = 0;
                  do {
                     lVar8 = uVar9 * 0x18;
                     iVar4 = test_int_eq("test/quic_ackm_test.c", 0x196, "h.pkts[i].acked", "(c->expect_ack[i] & 1) != 0 ? 1 : 0", *(undefined4*)( local_a0 + 0xc + lVar8 ), *(byte*)( plVar1[4] + uVar9 ) & 1);
                     if (( ( iVar4 == 0 ) || ( iVar4 = test_int_eq("test/quic_ackm_test.c", 0x199, "h.pkts[i].lost", "(c->expect_ack[i] & 2) != 0 ? 1 : 0", *(undefined4*)( local_a0 + 8 + lVar8 ), *(char*)( plVar1[4] + uVar9 ) >> 1 & 1) ),iVar4 == 0 )) goto LAB_001011a8;
                     uVar9 = uVar9 + 1;
                  }
 while ( uVar9 < (ulong)plVar1[1] );
               }
            ...
            iVar4 = test_int_eq("test/quic_ackm_test.c", 0x1a4, "ossl_time_compare(deadline, loss_detection_deadline)", &_LC18, iVar4, 0);
            if (iVar4 != 0) {
               iVar4 = 1;
               if (uVar9 <= fake_time) {
               ...
               iVar4 = test_int_gt("test/quic_ackm_test.c", 0x1a8, "ossl_time_compare(deadline, fake_time)", &_LC18, iVar4, 0);
               if (iVar4 != 0) {
                  ...
                  iVar4 = test_int_eq("test/quic_ackm_test.c", 0x1ad, "test_probe_counts(&probe, 0, 0, 0, 0, 0)", &_LC1, uVar2, 1);
                  if (iVar4 != 0) {
                     if (iVar10 == 2) {
                        uVar2 = ossl_ackm_on_handshake_confirmed(local_a8);
                        iVar4 = test_int_eq("test/quic_ackm_test.c", 0x1b5, "ossl_ackm_on_handshake_confirmed(h.ackm)", &_LC1, uVar2, 1);
                        if (iVar4 == 0) goto LAB_001011a8;
                     }
                     ...
                     iVar4 = test_int_eq("test/quic_ackm_test.c", 0x1bb, "ossl_ackm_on_timeout(h.ackm)", &_LC1, uVar2, 1);
                     if (iVar4 != 0) {
                        lVar8 = 0;
                        do {
                           puVar5 = (undefined8*)ossl_ackm_get0_probe_request(local_a8);
                           ...
                           if (lVar8 != 0) {
                              ...
                              *pauVar6 = (undefined1[16])0x0;
                              if (lVar8 == 2) {
                                 uVar2 = test_probe_counts_constprop_0(&local_58, 0, 0, 0);
                                 iVar4 = test_int_eq("test/quic_ackm_test.c", 0x1c5, "test_probe_counts(&probe, 0, 0, 0, 0, 0)", &_LC1, uVar2, 1);
                                 if (iVar4 != 0) goto LAB_00101584;
                                 break;
                              }

                           }

                           uVar2 = test_probe_counts_constprop_0(&local_58, iVar10 == 0, iVar10 == 1, iVar10 == 2);
                           iVar4 = test_int_eq("test/quic_ackm_test.c", 0x1c8, "test_probe_counts(&probe, 0, 0, space == QUIC_PN_SPACE_INITIAL, space == QUIC_PN_SPACE_HANDSHAKE, space == QUIC_PN_SPACE_APP)", &_LC1, uVar2, 1);
                           if (iVar4 == 0) break;
                           lVar8 = lVar8 + 1;
                        }
 while ( true );
      ...
      iVar4 = test_int_eq("test/quic_ackm_test.c", 0x181, "ossl_ackm_on_pkt_space_discarded(h.ackm, space)", &_LC1, uVar2, 1);
      if (iVar4 == 0) goto LAB_001011a8;
      uVar9 = 0;
      if (plVar1[1] != 0) {
         do {
            lVar8 = uVar9 * 0x18;
            iVar4 = test_int_eq("test/quic_ackm_test.c", 0x186, "h.pkts[i].acked", &_LC18, *(undefined4*)( local_a0 + 0xc + lVar8 ), 0);
            if (( ( iVar4 == 0 ) || ( iVar4 = test_int_eq("test/quic_ackm_test.c", 0x188, "h.pkts[i].lost", &_LC18, *(undefined4*)( local_a0 + 8 + lVar8 ), 0) ),iVar4 == 0 )) goto LAB_001011a8;
            uVar9 = uVar9 + 1;
         }
 while ( uVar9 < (ulong)plVar1[1] );
      }

      LAB_00101584:uVar7 = 1;
   }

   helper_destroy(&local_a8);
   LAB_001011b4:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

...
undefined8 SSL_set_alpn_protos(uint *param_1, long param_2, uint param_3) {
 ...
 while ( uVar2 < param_3 );
         if (( param_3 == uVar2 ) && ( lVar1 = lVar1 != 0 )) {
...
void ssl_update_cache(long param_1, uint param_2) {
   ...
   if (*(int*)( param_1 + 0x508 ) == 0) {
      ...
      if (( ( ( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) != 0 ) || ( iVar3 = iVar3 == 0x10000 ) ) || ( iVar3 < 0x304 )) goto LAB_00106450;
      if (( uVar1 & 0x200 ) == 0) {
...
int SSL_set_ssl_method(SSL *s, SSL_METHOD *method) {
   ...
   if (( method != pSVar4 ) && ( pSVar4 = method != pSVar4 )) {
...
void ssl_set_masks(SSL *param_1) {
   ...
   uVar4 = (uint)uVar13;
   if (( ( uVar13 & 8 ) != 0 ) || ( iVar5 = iVar5 < 8 )) goto LAB_00107798;
   if (*(int*)&param_1.s2 == 0) {
      pBVar9 = param_1[8].wbio;
      pBVar7 = param_1[8].bbio;
   }
   ...
   if (8 < iVar5) {
      ...
      if (( ( lVar1 != 0 ) && ( ( *(byte*)( (long)puVar2 + 0x21 ) & 1 ) != 0 ) ) && ( iVar5 = iVar5 >> 8 == 3 )) {
         iVar5 = SSL_version(param_1);
         if (iVar5 == 0x303) {
            uVar4 = uVar4 | 8;
         }
...
int ssl_get_max_send_fragment(long param_1) {
   byte bVar1;
   if (( *(long*)( param_1 + 0x900 ) != 0 ) && ( bVar1 = bVar1 < 4 )) {

...
int DES_check_key_parity(const_DES_cblock *key) {
   ...
   bVar8 = ( *key )[7] >> 4 ^ ( *key )[7];
   bVar8 = bVar8 >> 2 ^ bVar8;
   return ( ~(uint)(byte)(bVar8 >> 1 ^ bVar8) & 1 ) - 1 & ( ~(uint)(byte)(bVar1 >> 1 ^ bVar1) & 1 ) - 1 & ( ~(uint)(byte)(bVar2 >> 1 ^ bVar2) & 1 ) - 1 & ( ~(uint)(byte)(bVar3 ^ bVar3 >> 1) & 1 ) - 1 & ( ~(uint)(byte)(bVar4 ^ bVar4 >> 1) & 1 ) - 1 & ( ~(uint)(byte)(bVar5 ^ bVar5 >> 1) & 1 ) - 1 & ( ~(uint)(byte)(bVar6 ^ bVar6 >> 1) & 1 ) - 1 & ( ~(uint)(byte)(bVar7 ^ bVar7 >> 1) & 1 ) - 1 & 1;
}
...
void DES_set_key_unchecked(const_DES_cblock *key, DES_key_schedule *schedule) {
   ...
   do {
      ...
      uVar5 = *(uint*)( des_skb + ( ulong )(uVar1 >> 6 & 3 | uVar1 >> 7 & 0x3c) * 4 + 0x100 ) | *(uint*)( des_skb + ( ulong )(uVar1 >> 0xd & 0xf | uVar1 >> 0xe & 0x30) * 4 + 0x200 ) | *(uint*)( des_skb + ( ulong )(uVar5 & 0x3f) * 4 ) | *(uint*)( des_skb + ( ulong )(uVar1 >> 0x14 & 1 | uVar1 >> 0x15 & 6 | uVar1 >> 0x16 & 0x38) * 4 + 0x300 );
      piVar4 = piVar4 + 1;
      uVar3 = *(uint*)( des_skb + ( ulong )(uVar2 >> 0xf & 0x3f) * 4 + 0x600 ) | *(uint*)( des_skb + ( ulong )(uVar3 & 0x3f) * 4 + 0x400 ) | *(uint*)( des_skb + ( ulong )(uVar2 >> 7 & 3 | uVar2 >> 8 & 0x3c) * 4 + 0x500 ) | *(uint*)( des_skb + ( ulong )(uVar2 >> 0x15 & 0xf | uVar2 >> 0x16 & 0x30) * 4 + 0x700 );

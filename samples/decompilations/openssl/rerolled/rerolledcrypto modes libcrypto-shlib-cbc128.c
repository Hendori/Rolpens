void CRYPTO_cbc128_encrypt(ulong *param_1, ulong *param_2, ulong param_3, undefined8 param_4, ulong *param_5, code *param_6) {
 ...
 while ( puVar8 != puVar1 );
   ...
   if (( ( ulong )((long)puVar5 - ( (long)param_1 + 1 )) < 7 ) || ( ( ulong )((long)puVar5 - ( (long)puVar2 + 1 )) < 7 )) {
      ...
      *(undefined1*)( (long)puVar5 + param_3 ) = *(undefined1*)( (long)puVar2 + param_3 );
      if (( param_3 != 0xf ) && ( *(undefined1*)( (long)puVar5 + param_3 + 1 ) = param_3 != 0xe )) {
...
LAB_00100518:
      ...
      lVar3 = 8;
      uVar6 = param_3 - 8;
      if (2 < param_3 - 9) goto LAB_00100121;LAB_00100140:*(byte*)( (long)puVar5 + lVar3 ) = *(byte*)( (long)param_1 + lVar3 ) ^ *(byte*)( (long)puVar2 + lVar3 )(( lVar3 + 1U < param_3 ) && ( *(byte*)( (long)puVar5 + lVar3 + 1 ) = *(byte*)( (long)param_1 + lVar3 + 1 ) ^ *(byte*)( (long)puVar2 + lVar3 + 1 ) ), lVar3 + 2U < param_3) * (byte*)( (long)puVar5 + lVar3 + 2 ) = *(byte*)( (long)param_1 + lVar3 + 2 ) ^ *(byte*)( (long)puVar2 + lVar3 + 2 );}};uVar6 = 0xf - param_3;if (2 < uVar6) goto LAB_001001f0;LAB_00100188:*(undefined1*)( (long)puVar5 + param_3 ) = *(undefined1*)( (long)puVar2 + param_3 );if (( param_3 != 0xf ) && ( *(undefined1*)( (long)puVar5 + param_3 + 1 ) = param_3 != 0xe )) {
   param_3 = 0xd;
   lVar3 = 0xf;
   goto LAB_0010021f;
}
 ...
 while ( puVar4 + 2 != (ulong*)( (long)param_1 + ( param_3 - 0x10 & 0xfffffffffffffff0 ) + 0x10 ) );
   ...
   *(char*)param_5 = (char)uVar6;
   if (param_3 == 1) {
      ...
      *(undefined1*)( (long)param_5 + param_3 ) = *(undefined1*)( (long)puVar5 + param_3 );
      if (( param_3 == 0xf ) || ( *(undefined1*)( (long)param_5 + param_3 + 1 ) = param_3 == 0xe )) goto LAB_00100860;
      param_3 = 0xd;
      lVar3 = 0xf;
   }

...
void Poly1305_Init(long param_1, long param_2) {
   ...
   int iVar2;
   for (int i = 0; i < 4; i++) {
      *(undefined4*)( param_1 + ( 4*i + 192 ) ) = *(undefined4*)( param_2 + ( 4*i + 16 ) );
   }
...
void Poly1305_Update(long param_1, undefined8 *param_2, ulong param_3) {
   ...
   if (uVar7 != 0) {
      if (uVar5 < 8) {
         if (( param_3 & 4 ) == 0) {
            if (( ( param_3 & 0xf ) != 0 ) && ( *(undefined1*)( param_1 + 0xd0 ) = *(undefined1*)puVar8(param_3 & 2) != 0 )) {
 ...
 while ( uVar3 < uVar5 );
   ...
   LAB_001000fa:*(ulong*)( param_1 + 0xe0 ) = uVar7;
   return;
}

...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void rcidm_tick(byte *param_1) {
   ...
   long lVar7;
   long lVar8;
   if (( ( ( param_1[0x88] & 4 ) != 0 ) && ( ( ( *(long*)( param_1 + 0x48 ) == 0 || ( 9999 < *(ulong*)( param_1 + 0x40 ) ) ) || ( ( param_1[0x88] & 0x40 ) != 0 ) ) ) ) && ( lVar7 = lVar7 != 0 )) {
   ...
   joined_r0x0010019f:if (lVar7 == 0) {
      ...
      if (( lVar7 == 0 ) || ( bVar1 = *(byte*)( lVar7 + 0x38 )(bVar1 & 3) == 1 )) {
         ...
         if (lVar7 == 0) {
            ...
            if (( bVar1 & 0x14 ) == 0x10) {
               bVar1 = *param_1;
               if (( ( param_1[0x2a] == bVar1 ) && ( bVar1 < 0x15 ) ) && ( iVar6 = iVar6 == 0 )) {
                  return;
               }
            ...
            bVar1 = *param_1;
            if (( ( param_1[0x15] == bVar1 ) && ( bVar1 < 0x15 ) ) && ( iVar6 = iVar6 == 0 )) {
               return;
            }
   ...
   bVar1 = *param_1;
   if (( ( *(byte*)( lVar7 + 0x10 ) != bVar1 ) || ( 0x14 < bVar1 ) ) || ( iVar6 = iVar6 != 0 )) {
   ...
   if (ptr != (byte*)0x0) {
      ...
      *(long*)( ptr + 0x58 ) = lVar9;
      if (lVar9 != 0) {
         ...
         bVar1 = *ptr;
         if (( ( *(byte*)( lVar10 + 0x10 ) == bVar1 ) && ( bVar1 < 0x15 ) ) && ( iVar8 = iVar8 == 0 )) {
            return ptr;
         }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void ossl_quic_rcidm_on_handshake_complete(byte *param_1) {
   ...
   if (( ( ( *(long*)( param_1 + 0x48 ) == 0 ) || ( 9999 < *(ulong*)( param_1 + 0x40 ) ) ) || ( ( bVar1 & 0x40 ) != 0 ) ) && ( lVar7 = lVar7 != 0 )) {
      bVar1 = *(byte*)( lVar7 + 0x38 );
      if (( bVar1 & 3 ) != 1) {
         puVar3 = *(undefined8**)( param_1 + 0x60 );
         if (puVar3 != (undefined8*)0x0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void ossl_quic_rcidm_on_packet_sent(byte *param_1, long param_2) {
   ...
   *(long*)( param_1 + 0x40 ) = param_2 + lVar7;
   if (( ( ( param_1[0x88] & 4 ) != 0 ) && ( ( ( *(long*)( param_1 + 0x48 ) == 0 || ( 9999 < ( ulong )(param_2 + lVar7) ) ) || ( ( param_1[0x88] & 0x40 ) != 0 ) ) ) ) && ( lVar7 = lVar7 != 0 )) {
      bVar1 = *(byte*)( lVar7 + 0x38 );
      if (( bVar1 & 3 ) != 1) {
   ...
   bVar1 = *param_1;
   if (( ( *(byte*)( lVar7 + 0x10 ) == bVar1 ) && ( bVar1 < 0x15 ) ) && ( iVar6 = iVar6 == 0 )) {
      return;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 ossl_quic_rcidm_add_from_server_retry(byte *param_1, undefined8 *param_2) {
   ...
   *(undefined8*)( param_1 + 0x37 ) = uVar3;
   if (( ( ( bVar1 & 4 ) != 0 ) && ( ( ( *(long*)( param_1 + 0x48 ) == 0 || ( 9999 < *(ulong*)( param_1 + 0x40 ) ) ) || ( ( bVar1 & 0x40 ) != 0 ) ) ) ) && ( lVar7 = lVar7 != 0 )) {
      bVar1 = *(byte*)( lVar7 + 0x38 );
      if (( bVar1 & 3 ) != 1) {
         puVar4 = *(undefined8**)( param_1 + 0x60 );
         if (puVar4 != (undefined8*)0x0) {

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 ossl_sm3_init(undefined8 *param_1) {
   undefined8 uVar1;
...
void ossl_sm3_block_data_order(uint *param_1, uint *param_2, long param_3) {
   ...
   if (param_3 != 0) {
      ...
      do {
         ...
         uVar37 = ( uVar12 << 0xf | uVar12 >> 0x11 ) ^ ( uVar5 << 7 | ( uVar13 << 0x18 ) >> 0x19 ) ^ uVar21 ^ uVar12 ^ ( uVar12 >> 9 | uVar12 << 0x17 );
         ...
         uVar39 = ( uVar12 << 0xf | uVar12 >> 0x11 ) ^ ( uVar1 << 7 | ( uVar7 << 0x18 ) >> 0x19 ) ^ uVar41 ^ uVar12 ^ ( uVar12 >> 9 | uVar12 << 0x17 );
         ...
         uVar34 = ( uVar12 << 0xf | uVar12 >> 0x11 ) ^ ( uVar17 << 7 | ( uVar35 << 0x18 ) >> 0x19 ) ^ uVar27 ^ uVar12 ^ ( uVar12 >> 9 | uVar12 << 0x17 );
         ...
         uVar28 = ( uVar12 << 0xf | uVar12 >> 0x11 ) ^ ( uVar18 << 7 | ( uVar3 << 0x18 ) >> 0x19 ) ^ uVar22 ^ uVar12 ^ ( uVar12 >> 9 | uVar12 << 0x17 );
         ...
         uVar25 = ( uVar35 << 0xf | uVar35 >> 0x11 ) ^ ( uVar19 << 7 | ( uVar4 << 0x18 ) >> 0x19 ) ^ uVar23 ^ uVar35 ^ ( uVar35 >> 9 | uVar35 << 0x17 );
         ...
         uVar10 = ( uVar12 << 0xf | uVar12 >> 0x11 ) ^ ( uVar20 << 7 | ( uVar8 << 0x18 ) >> 0x19 ) ^ uVar24 ^ uVar12 ^ ( uVar12 >> 9 | uVar12 << 0x17 );
         ...
         uVar3 = ( uVar12 << 0xf | uVar12 >> 0x11 ) ^ ( uVar40 << 7 | ( uVar15 << 0x18 ) >> 0x19 ) ^ uVar37 ^ uVar12 ^ ( uVar12 >> 9 | uVar12 << 0x17 );
         ...
         uVar14 = ( uVar12 << 0xf | uVar12 >> 0x11 ) ^ ( uVar21 << 7 | ( uVar26 << 0x18 ) >> 0x19 ) ^ uVar39 ^ uVar12 ^ ( uVar12 >> 9 | uVar12 << 0x17 );
         ...
         uVar33 = ( uVar35 << 0xf | uVar35 >> 0x11 ) ^ ( uVar41 << 7 | ( uVar9 << 0x18 ) >> 0x19 ) ^ uVar34 ^ uVar35 ^ ( uVar35 >> 9 | uVar35 << 0x17 );
         ...
         uVar1 = ( uVar35 << 0xf | uVar35 >> 0x11 ) ^ ( uVar27 << 7 | ( uVar6 << 0x18 ) >> 0x19 ) ^ uVar28 ^ uVar35 ^ ( uVar35 >> 9 | uVar35 << 0x17 );
         ...
         uVar31 = ( uVar12 << 0xf | uVar12 >> 0x11 ) ^ ( uVar22 << 7 | ( uVar16 << 0x18 ) >> 0x19 ) ^ uVar25 ^ uVar12 ^ ( uVar12 >> 9 | uVar12 << 0x17 );
         ...
         uVar9 = ( uVar12 << 0xf | uVar12 >> 0x11 ) ^ ( uVar23 << 7 | ( uVar36 << 0x18 ) >> 0x19 ) ^ uVar10 ^ uVar12 ^ ( uVar12 >> 9 | uVar12 << 0x17 );
         ...
         uVar20 = ( uVar12 << 0xf | uVar12 >> 0x11 ) ^ ( uVar24 << 7 | ( uVar30 << 0x18 ) >> 0x19 ) ^ uVar3 ^ uVar12 ^ ( uVar12 >> 9 | uVar12 << 0x17 );
         ...
         uVar5 = ( uVar35 << 0xf | uVar35 >> 0x11 ) ^ ( uVar37 << 7 | uVar37 >> 0x19 ) ^ uVar14 ^ uVar35 ^ ( uVar35 >> 9 | uVar35 << 0x17 );
         ...
         uVar36 = ( uVar35 << 0xf | uVar35 >> 0x11 ) ^ ( uVar39 << 7 | uVar39 >> 0x19 ) ^ uVar33 ^ uVar35 ^ ( uVar35 >> 9 | uVar35 << 0x17 );
         ...
         uVar18 = ( uVar12 << 0xf | uVar12 >> 0x11 ) ^ ( uVar34 << 7 | uVar34 >> 0x19 ) ^ uVar1 ^ uVar12 ^ ( uVar12 >> 9 | uVar12 << 0x17 );
         ...
         uVar11 = ( uVar35 ^ uVar12 ) + ( uVar37 ^ uVar25 ) + uVar16 + ( uVar7 & uVar15 | ( uVar7 | uVar15 ) & uVar17 );
         ...
         uVar16 = ( uVar35 << 0xf | uVar35 >> 0x11 ) ^ ( uVar28 << 7 | uVar28 >> 0x19 ) ^ uVar31 ^ uVar35 ^ ( uVar35 >> 9 | uVar35 << 0x17 );
         ...
         uVar8 = ( uVar4 ^ uVar35 ) + ( uVar39 ^ uVar10 ) + uVar17 + ( uVar15 & uVar11 | ( uVar15 | uVar11 ) & uVar2 );
         uVar15 = ( ( uVar26 ^ uVar13 ) & uVar12 ^ uVar13 ) + uVar6 + uVar39 + uVar35;
         uVar15 = ( uVar15 * 0x200 | uVar15 >> 0x17 ) ^ ( uVar15 >> 0xf | uVar15 * 0x20000 ) ^ uVar15;
         uVar35 = uVar39 ^ uVar33 ^ ( uVar36 << 0xf | uVar36 >> 0x11 );
         uVar21 = ( uVar35 << 0xf | uVar35 >> 0x11 ) ^ ( uVar25 << 7 | uVar25 >> 0x19 ) ^ uVar9 ^ uVar35 ^ ( uVar35 >> 9 | uVar35 << 0x17 );
         uVar6 = uVar8 * 0x1000 | uVar8 >> 0x14;
         uVar35 = uVar15 + 0x7629ea1e + uVar6;
         uVar4 = uVar35 * 0x80 | uVar35 >> 0x19;
         uVar17 = uVar11 * 0x200 | uVar11 >> 0x17;
         uVar35 = ( uVar3 ^ uVar34 ) + uVar2 + ( uVar11 & uVar8 | ( uVar11 | uVar8 ) & uVar7 ) + ( uVar6 ^ uVar4 );
         ...
         uVar27 = ( uVar4 >> 9 | uVar4 << 0x17 ) ^ ( uVar4 << 0xf | uVar4 >> 0x11 ) ^ ( uVar10 << 7 | uVar10 >> 0x19 ) ^ uVar20 ^ uVar4;
         uVar2 = uVar35 * 0x1000 | uVar35 >> 0x14;
         uVar4 = uVar12 + 0xec53d43c + uVar2;
         uVar4 = uVar4 * 0x80 | uVar4 >> 0x19;
         uVar6 = uVar8 * 0x200 | uVar8 >> 0x17;
         uVar13 = uVar15 >> 0xd | uVar15 << 0x13;
         uVar8 = ( uVar14 ^ uVar28 ) + uVar7 + ( uVar8 & uVar35 | ( uVar8 | uVar35 ) & uVar17 ) + ( uVar2 ^ uVar4 );
         uVar15 = ( ( uVar15 ^ uVar26 ) & uVar12 ^ uVar26 ) + uVar30 + uVar28 + uVar4;
         uVar15 = ( uVar15 * 0x200 | uVar15 >> 0x17 ) ^ ( uVar15 >> 0xf | uVar15 * 0x20000 ) ^ uVar15;
         uVar4 = uVar28 ^ uVar31 ^ ( uVar16 << 0xf | uVar16 >> 0x11 );
         uVar28 = ( uVar4 >> 9 | uVar4 << 0x17 ) ^ ( uVar4 << 0xf | uVar4 >> 0x11 ) ^ ( uVar3 << 7 | uVar3 >> 0x19 ) ^ uVar5 ^ uVar4;
         ...
         uVar30 = ( uVar7 ^ uVar2 ) + ( uVar33 ^ uVar25 ) + uVar17 + ( uVar35 & uVar8 | ( uVar35 | uVar8 ) & uVar6 );
         uVar12 = ( ( uVar12 ^ uVar13 ) & uVar15 ^ uVar13 ) + uVar26 + uVar25 + uVar2;
         uVar12 = ( uVar12 * 0x200 | uVar12 >> 0x17 ) ^ ( uVar12 >> 0xf | uVar12 * 0x20000 ) ^ uVar12;
         uVar35 = uVar25 ^ uVar9 ^ ( uVar21 << 0xf | uVar21 >> 0x11 );
         uVar23 = ( uVar35 >> 9 | uVar35 << 0x17 ) ^ ( uVar35 << 0xf | uVar35 >> 0x11 ) ^ ( uVar14 << 7 | uVar14 >> 0x19 ) ^ uVar36 ^ uVar35;
         uVar26 = uVar30 * 0x1000 | uVar30 >> 0x14;
         uVar35 = uVar12 + 0xb14f50f3 + uVar26;
         uVar35 = uVar35 * 0x80 | uVar35 >> 0x19;
         uVar2 = uVar8 * 0x200 | uVar8 >> 0x17;
         uVar7 = uVar15 >> 0xd | uVar15 << 0x13;
         uVar17 = ( uVar26 ^ uVar35 ) + ( uVar10 ^ uVar1 ) + uVar6 + ( uVar8 & uVar30 | ( uVar8 | uVar30 ) & uVar19 );
         ...
         uVar6 = ( uVar13 << 0xf | uVar13 >> 0x11 ) ^ ( uVar33 << 7 | uVar33 >> 0x19 ) ^ uVar18 ^ uVar13 ^ ( uVar13 >> 9 | uVar13 << 0x17 );
         uVar15 = uVar15 * 0x80 | uVar15 >> 0x19;
         uVar11 = uVar30 * 0x200 | uVar30 >> 0x17;
         uVar26 = ( uVar8 ^ uVar15 ) + ( uVar3 ^ uVar31 ) + uVar19 + ( uVar30 & uVar17 | ( uVar30 | uVar17 ) & uVar2 );
         ...
         uVar30 = ( uVar12 << 0xf | uVar12 >> 0x11 ) ^ ( uVar1 << 7 | uVar1 >> 0x19 ) ^ uVar16 ^ uVar12 ^ ( uVar12 >> 9 | uVar12 << 0x17 );
         uVar4 = uVar26 * 0x1000 | uVar26 >> 0x14;
         uVar12 = uVar15 + 0xc53d43ce + uVar4;
         uVar13 = uVar12 * 0x80 | uVar12 >> 0x19;
         uVar19 = uVar17 * 0x200 | uVar17 >> 0x17;
         uVar8 = uVar35 >> 0xd | uVar35 << 0x13;
         uVar12 = ( uVar14 ^ uVar9 ) + uVar2 + ( uVar17 & uVar26 | ( uVar17 | uVar26 ) & uVar11 ) + ( uVar4 ^ uVar13 );
         uVar35 = ( ( uVar35 ^ uVar10 ) & uVar15 ^ uVar10 ) + uVar7 + uVar14 + uVar13;
         uVar35 = ( uVar35 * 0x200 | uVar35 >> 0x17 ) ^ ( uVar35 >> 0xf | uVar35 * 0x20000 ) ^ uVar35;
         uVar4 = uVar14 ^ uVar36 ^ ( uVar23 << 0xf | uVar23 >> 0x11 );
         uVar2 = ( uVar4 << 0xf | uVar4 >> 0x11 ) ^ ( uVar31 << 7 | uVar31 >> 0x19 ) ^ uVar21 ^ uVar4 ^ ( uVar4 >> 9 | uVar4 << 0x17 );
         uVar7 = uVar12 * 0x1000 | uVar12 >> 0x14;
         uVar4 = uVar35 + 0x8a7a879d + uVar7;
         uVar4 = uVar4 * 0x80 | uVar4 >> 0x19;
         uVar3 = uVar26 * 0x200 | uVar26 >> 0x17;
         uVar13 = uVar15 >> 0xd | uVar15 << 0x13;
         uVar26 = ( uVar33 ^ uVar20 ) + uVar11 + ( uVar26 & uVar12 | ( uVar26 | uVar12 ) & uVar19 ) + ( uVar7 ^ uVar4 );
         uVar15 = ( ( uVar15 ^ uVar8 ) & uVar35 ^ uVar8 ) + uVar10 + uVar33 + uVar4;
         uVar15 = ( uVar15 * 0x200 | uVar15 >> 0x17 ) ^ ( uVar15 >> 0xf | uVar15 * 0x20000 ) ^ uVar15;
         uVar4 = uVar33 ^ uVar18 ^ ( uVar6 << 0xf | uVar6 >> 0x11 );
         uVar11 = ( uVar4 << 0xf | uVar4 >> 0x11 ) ^ ( uVar9 << 7 | uVar9 >> 0x19 ) ^ uVar27 ^ uVar4 ^ ( uVar4 >> 9 | uVar4 << 0x17 );
         ...
         uVar4 = ( uVar7 ^ uVar33 ) + ( uVar1 ^ uVar5 ) + uVar19 + ( uVar12 & uVar26 | ( uVar12 | uVar26 ) & uVar3 );
         ...
         uVar17 = ( uVar35 << 0xf | uVar35 >> 0x11 ) ^ ( uVar20 << 7 | uVar20 >> 0x19 ) ^ uVar28 ^ uVar35 ^ ( uVar35 >> 9 | uVar35 << 0x17 );
         uVar35 = uVar12 + 0x29ea1e76 + uVar7;
         uVar35 = uVar35 * 0x80 | uVar35 >> 0x19;
         uVar33 = uVar26 * 0x200 | uVar26 >> 0x17;
         uVar10 = uVar15 >> 0xd | uVar15 << 0x13;
         uVar1 = ( uVar7 ^ uVar35 ) + ( uVar31 ^ uVar36 ) + uVar3 + ( uVar26 & uVar4 | ( uVar26 | uVar4 ) & uVar22 );
         ...
         uVar36 = ( uVar35 << 0xf | uVar35 >> 0x11 ) ^ ( uVar21 << 7 | uVar21 >> 0x19 ) ^ uVar11 ^ uVar35 ^ ( uVar35 >> 9 | uVar35 << 0x17 );
         uVar4 = uVar8 * 0x1000 | uVar8 >> 0x14;
         uVar35 = uVar12 + 0x3d43cec5 + uVar4;
         uVar35 = uVar35 * 0x80 | uVar35 >> 0x19;
         uVar33 = uVar3 * 0x200 | uVar3 >> 0x17;
         uVar7 = uVar15 >> 0xd | uVar15 << 0x13;
         uVar1 = ( uVar4 ^ uVar35 ) + ( uVar18 ^ uVar28 ) + uVar9 + ( uVar3 & uVar8 | ( uVar3 | uVar8 ) & uVar20 );
         uVar35 = ( ( uVar15 ^ uVar10 ) & uVar12 ^ uVar10 ) + uVar14 + uVar18 + uVar35;
         uVar35 = ( uVar35 * 0x200 | uVar35 >> 0x17 ) ^ ( uVar35 >> 0xf | uVar35 * 0x20000 ) ^ uVar35;
         uVar15 = uVar18 ^ uVar30 ^ ( uVar19 << 0xf | uVar19 >> 0x11 );
         uVar24 = ( uVar15 << 0xf | uVar15 >> 0x11 ) ^ ( uVar27 << 7 | uVar27 >> 0x19 ) ^ uVar17 ^ uVar15 ^ ( uVar15 >> 9 | uVar15 << 0x17 );
         uVar4 = uVar1 * 0x1000 | uVar1 >> 0x14;
         uVar15 = uVar35 + 0x7a879d8a + uVar4;
         uVar15 = uVar15 * 0x80 | uVar15 >> 0x19;
         uVar14 = uVar8 * 0x200 | uVar8 >> 0x17;
         uVar8 = ( uVar4 ^ uVar15 ) + ( uVar16 ^ uVar23 ) + uVar20 + ( uVar8 & uVar1 | ( uVar8 | uVar1 ) & uVar33 );
         ...
         uVar9 = ( uVar12 << 0xf | uVar12 >> 0x11 ) ^ ( uVar28 << 7 | uVar28 >> 0x19 ) ^ uVar26 ^ uVar12 ^ ( uVar12 >> 9 | uVar12 << 0x17 );
         uVar15 = uVar8 * 0x1000 | uVar8 >> 0x14;
         uVar12 = uVar4 + 0xf50f3b14 + uVar15;
         uVar3 = uVar12 * 0x80 | uVar12 >> 0x19;
         uVar10 = uVar1 * 0x200 | uVar1 >> 0x17;
         uVar12 = ( uVar21 ^ uVar6 ) + uVar33 + ( uVar1 & uVar8 | ( uVar1 | uVar8 ) & uVar14 ) + ( uVar15 ^ uVar3 );
         ...
         uVar25 = ( uVar15 << 0xf | uVar15 >> 0x11 ) ^ ( uVar23 << 7 | uVar23 >> 0x19 ) ^ uVar22 ^ uVar15 ^ ( uVar15 >> 9 | uVar15 << 0x17 );
         uVar7 = uVar12 * 0x1000 | uVar12 >> 0x14;
         uVar15 = uVar35 + 0xea1e7629 + uVar7;
         uVar33 = uVar15 * 0x80 | uVar15 >> 0x19;
         uVar3 = uVar8 * 0x200 | uVar8 >> 0x17;
         uVar15 = ( uVar30 ^ uVar27 ) + uVar14 + ( uVar8 & uVar12 | ( uVar8 | uVar12 ) & uVar10 ) + ( uVar7 ^ uVar33 );
         ...
         uVar27 = ( uVar13 << 0xf | uVar13 >> 0x11 ) ^ ( uVar6 << 7 | uVar6 >> 0x19 ) ^ uVar19 ^ uVar13 ^ ( uVar13 >> 9 | uVar13 << 0x17 );
         uVar7 = uVar15 * 0x1000 | uVar15 >> 0x14;
         uVar13 = uVar4 + 0xd43cec53 + uVar7;
         uVar13 = uVar13 * 0x80 | uVar13 >> 0x19;
         uVar8 = uVar12 * 0x200 | uVar12 >> 0x17;
         uVar12 = ( uVar2 ^ uVar28 ) + uVar10 + ( uVar12 & uVar15 | ( uVar12 | uVar15 ) & uVar3 ) + ( uVar7 ^ uVar13 );
         ...
         uVar28 = ( uVar35 << 0xf | uVar35 >> 0x11 ) ^ ( uVar30 << 7 | uVar30 >> 0x19 ) ^ uVar5 ^ uVar35 ^ ( uVar35 >> 9 | uVar35 << 0x17 );
         uVar13 = uVar12 * 0x1000 | uVar12 >> 0x14;
         uVar35 = uVar7 + 0xa879d8a7 + uVar13;
         uVar35 = uVar35 * 0x80 | uVar35 >> 0x19;
         uVar10 = uVar15 * 0x200 | uVar15 >> 0x17;
         uVar16 = ( uVar13 ^ uVar35 ) + ( uVar11 ^ uVar23 ) + uVar3 + ( uVar15 & uVar12 | ( uVar15 | uVar12 ) & uVar8 );
         uVar13 = uVar4 >> 0xd | uVar4 << 0x13;
         ...
         uVar20 = ( uVar15 << 0xf | uVar15 >> 0x11 ) ^ ( uVar2 << 7 | uVar2 >> 0x19 ) ^ uVar36 ^ uVar15 ^ ( uVar15 >> 9 | uVar15 << 0x17 );
         uVar15 = uVar35 + 0x50f3b14f + uVar4;
         uVar15 = uVar15 * 0x80 | uVar15 >> 0x19;
         uVar1 = uVar12 * 0x200 | uVar12 >> 0x17;
         uVar3 = ( uVar4 ^ uVar15 ) + ( uVar6 ^ uVar17 ) + uVar8 + ( uVar12 & uVar16 | ( uVar12 | uVar16 ) & uVar10 );
         ...
         uVar14 = ( uVar15 << 0xf | uVar15 >> 0x11 ) ^ ( uVar11 << 7 | uVar11 >> 0x19 ) ^ uVar24 ^ uVar15 ^ ( uVar15 >> 9 | uVar15 << 0x17 );
         uVar4 = uVar3 * 0x1000 | uVar3 >> 0x14;
         uVar15 = uVar12 + 0xa1e7629e + uVar4;
         uVar7 = uVar15 * 0x80 | uVar15 >> 0x19;
         uVar6 = uVar16 * 0x200 | uVar16 >> 0x17;
         uVar15 = ( uVar30 ^ uVar26 ) + uVar10 + ( uVar16 & uVar3 | ( uVar16 | uVar3 ) & uVar1 ) + ( uVar4 ^ uVar7 );
         uVar33 = uVar35 >> 0xd | uVar35 << 0x13;
         uVar35 = ( ( uVar35 ^ uVar8 ) & uVar12 ^ uVar8 ) + uVar13 + uVar30 + uVar7;
         uVar35 = ( uVar35 * 0x200 | uVar35 >> 0x17 ) ^ ( uVar35 >> 0xf | uVar35 * 0x20000 ) ^ uVar35;
         uVar4 = uVar30 ^ uVar5 ^ ( uVar28 << 0xf | uVar28 >> 0x11 );
         uVar23 = ( uVar4 << 0xf | uVar4 >> 0x11 ) ^ ( uVar17 << 7 | uVar17 >> 0x19 ) ^ uVar9 ^ uVar4 ^ ( uVar4 >> 9 | uVar4 << 0x17 );
         uVar13 = uVar15 * 0x1000 | uVar15 >> 0x14;
         uVar4 = uVar35 + 0x43cec53d + uVar13;
         uVar4 = uVar4 * 0x80 | uVar4 >> 0x19;
         uVar16 = ( uVar2 ^ uVar22 ) + uVar1 + ( uVar3 & uVar15 | ( uVar3 | uVar15 ) & uVar6 ) + ( uVar13 ^ uVar4 );
         ...
         uVar18 = ( uVar4 << 0xf | uVar4 >> 0x11 ) ^ ( uVar26 << 7 | uVar26 >> 0x19 ) ^ uVar25 ^ uVar4 ^ ( uVar4 >> 9 | uVar4 << 0x17 );
         uVar13 = uVar16 * 0x1000 | uVar16 >> 0x14;
         uVar4 = uVar12 + 0x879d8a7a + uVar13;
         uVar4 = uVar4 * 0x80 | uVar4 >> 0x19;
         uVar10 = uVar15 * 0x200 | uVar15 >> 0x17;
         uVar6 = ( uVar13 ^ uVar4 ) + ( uVar11 ^ uVar19 ) + uVar6 + ( uVar15 & uVar16 | ( uVar15 | uVar16 ) & uVar3 );
         uVar15 = ( ( uVar35 ^ uVar7 ) & uVar12 ^ uVar7 ) + uVar33 + uVar11 + uVar4;
         uVar13 = uVar35 >> 0xd | uVar35 << 0x13;
         uVar15 = ( uVar15 * 0x200 | uVar15 >> 0x17 ) ^ ( uVar15 >> 0xf | uVar15 * 0x20000 ) ^ uVar15;
         uVar35 = uVar11 ^ uVar24 ^ ( uVar14 << 0xf | uVar14 >> 0x11 );
         uVar1 = ( uVar35 << 0xf | uVar35 >> 0x11 ) ^ ( uVar22 << 7 | uVar22 >> 0x19 ) ^ uVar27 ^ uVar35 ^ ( uVar35 >> 9 | uVar35 << 0x17 );
         uVar4 = uVar6 * 0x1000 | uVar6 >> 0x14;
         uVar35 = uVar15 + 0xf3b14f5 + uVar4;
         uVar35 = uVar35 * 0x80 | uVar35 >> 0x19;
         uVar30 = uVar16 * 0x200 | uVar16 >> 0x17;
         uVar16 = ( uVar4 ^ uVar35 ) + ( uVar17 ^ uVar5 ) + uVar3 + ( uVar16 & uVar6 | ( uVar16 | uVar6 ) & uVar10 );
         uVar8 = uVar12 >> 0xd | uVar12 << 0x13;
         uVar4 = ( ( uVar12 ^ uVar13 ) & uVar15 ^ uVar13 ) + uVar7 + uVar17 + uVar35;
         uVar4 = ( uVar4 * 0x200 | uVar4 >> 0x17 ) ^ ( uVar4 >> 0xf | uVar4 * 0x20000 ) ^ uVar4;
         uVar12 = uVar17 ^ uVar9 ^ ( uVar23 << 0xf | uVar23 >> 0x11 );
         uVar17 = ( uVar12 << 0xf | uVar12 >> 0x11 ) ^ ( uVar19 << 7 | uVar19 >> 0x19 ) ^ uVar28 ^ uVar12 ^ ( uVar12 >> 9 | uVar12 << 0x17 );
         uVar35 = uVar16 * 0x1000 | uVar16 >> 0x14;
         uVar12 = uVar4 + 0x1e7629ea + uVar35;
         uVar12 = uVar12 * 0x80 | uVar12 >> 0x19;
         uVar3 = ( uVar35 ^ uVar12 ) + ( uVar26 ^ uVar36 ) + uVar10 + ( uVar6 & uVar16 | ( uVar6 | uVar16 ) & uVar30 );
         ...
         uVar21 = ( uVar35 << 0xf | uVar35 >> 0x11 ) ^ ( uVar5 << 7 | uVar5 >> 0x19 ) ^ uVar20 ^ uVar35 ^ ( uVar35 >> 9 | uVar35 << 0x17 );
         uVar15 = uVar3 * 0x1000 | uVar3 >> 0x14;
         uVar35 = uVar12 + 0x3cec53d4 + uVar15;
         uVar13 = uVar35 * 0x80 | uVar35 >> 0x19;
         uVar35 = ( uVar22 ^ uVar24 ) + uVar30 + ( uVar16 & uVar3 | ( uVar16 | uVar3 ) & uVar6 ) + ( uVar15 ^ uVar13 );
         ...
         uVar10 = ( uVar4 << 0xf | uVar4 >> 0x11 ) ^ ( uVar36 << 7 | uVar36 >> 0x19 ) ^ uVar14 ^ uVar4 ^ ( uVar4 >> 9 | uVar4 << 0x17 );
         uVar13 = uVar35 * 0x1000 | uVar35 >> 0x14;
         uVar4 = uVar15 + 0x79d8a7a8 + uVar13;
         uVar4 = uVar4 * 0x80 | uVar4 >> 0x19;
         uVar16 = ( uVar19 ^ uVar9 ) + uVar6 + ( uVar3 & uVar35 | ( uVar3 | uVar35 ) & uVar26 ) + ( uVar13 ^ uVar4 );
         ...
         uVar6 = ( uVar4 << 0xf | uVar4 >> 0x11 ) ^ ( uVar24 << 7 | uVar24 >> 0x19 ) ^ uVar23 ^ uVar4 ^ ( uVar4 >> 9 | uVar4 << 0x17 );
         uVar3 = uVar16 * 0x1000 | uVar16 >> 0x14;
         uVar4 = uVar12 + 0xf3b14f50 + uVar3;
         uVar30 = uVar4 * 0x80 | uVar4 >> 0x19;
         uVar33 = ( uVar3 ^ uVar30 ) + ( uVar5 ^ uVar25 ) + uVar26 + ( uVar35 & uVar16 | ( uVar35 | uVar16 ) & uVar8 );
         ...
         uVar2 = ( uVar15 << 0xf | uVar15 >> 0x11 ) ^ ( uVar9 << 7 | uVar9 >> 0x19 ) ^ uVar18 ^ uVar15 ^ ( uVar15 >> 9 | uVar15 << 0x17 );
         uVar7 = uVar33 * 0x1000 | uVar33 >> 0x14;
         uVar15 = uVar35 + 0xe7629ea1 + uVar7;
         uVar15 = uVar15 * 0x80 | uVar15 >> 0x19;
         uVar26 = uVar16 * 0x200 | uVar16 >> 0x17;
         uVar30 = ( uVar7 ^ uVar15 ) + ( uVar36 ^ uVar27 ) + uVar8 + ( uVar16 & uVar33 | ( uVar16 | uVar33 ) & uVar31 );
         ...
         uVar3 = ( uVar15 << 0xf | uVar15 >> 0x11 ) ^ ( uVar25 << 7 | uVar25 >> 0x19 ) ^ uVar1 ^ uVar15 ^ ( uVar15 >> 9 | uVar15 << 0x17 );
         uVar13 = uVar30 * 0x1000 | uVar30 >> 0x14;
         uVar15 = uVar12 + 0xcec53d43 + uVar13;
         uVar15 = uVar15 * 0x80 | uVar15 >> 0x19;
         uVar8 = ( uVar13 ^ uVar15 ) + ( uVar24 ^ uVar28 ) + uVar31 + ( uVar33 & uVar30 | ( uVar33 | uVar30 ) & uVar26 );
         ...
         uVar11 = ( uVar15 << 0xf | uVar15 >> 0x11 ) ^ ( uVar27 << 7 | uVar27 >> 0x19 ) ^ uVar17 ^ uVar15 ^ ( uVar15 >> 9 | uVar15 << 0x17 );
         uVar13 = uVar8 * 0x1000 | uVar8 >> 0x14;
         uVar15 = uVar35 + 0x9d8a7a87 + uVar13;
         uVar4 = uVar15 * 0x80 | uVar15 >> 0x19;
         uVar15 = ( uVar9 ^ uVar20 ) + uVar26 + ( uVar30 & uVar8 | ( uVar30 | uVar8 ) & uVar33 ) + ( uVar13 ^ uVar4 );
         ...
         uVar5 = ( uVar4 << 0xf | uVar4 >> 0x11 ) ^ ( uVar28 << 7 | uVar28 >> 0x19 ) ^ uVar21 ^ uVar4 ^ ( uVar4 >> 9 | uVar4 << 0x17 );
         uVar9 = uVar15 * 0x1000 | uVar15 >> 0x14;
         uVar4 = uVar12 + 0x3b14f50f + uVar9;
         uVar4 = uVar4 * 0x80 | uVar4 >> 0x19;
         uVar26 = ( uVar25 ^ uVar14 ) + uVar33 + ( uVar8 & uVar15 | ( uVar8 | uVar15 ) & uVar36 ) + ( uVar9 ^ uVar4 );
         uVar9 = uVar8 * 0x200 | uVar8 >> 0x17;
         uVar8 = uVar35 >> 0xd | uVar35 << 0x13;
         ...
         uVar4 = uVar4 * 0x80 | uVar4 >> 0x19;
         uVar7 = ( uVar7 ^ uVar4 ) + ( uVar23 ^ uVar27 ) + uVar36 + ( uVar15 & uVar26 | ( uVar15 | uVar26 ) & uVar9 );
         ...
         uVar9 = ( uVar4 ^ uVar13 ) + ( uVar18 ^ uVar28 ) + uVar9 + ( uVar26 & uVar7 | ( uVar26 | uVar7 ) & uVar33 );
         ...
         uVar35 = uVar35 * 0x80 | uVar35 >> 0x19;
         uVar7 = ( uVar20 ^ uVar1 ) + uVar33 + ( uVar7 & uVar9 | ( uVar7 | uVar9 ) & uVar36 ) + ( uVar13 ^ uVar35 );
         uVar13 = uVar12 >> 0xd | uVar12 << 0x13;
         ...
         uVar35 = ( uVar14 ^ uVar17 ) + uVar36 + ( uVar9 & uVar7 | ( uVar9 | uVar7 ) & uVar31 ) + ( uVar8 ^ uVar30 );
         ...
         uVar33 = uVar4 * 0x80 | uVar4 >> 0x19;
         uVar30 = uVar12 >> 0xd | uVar12 << 0x13;
         uVar4 = ( uVar23 ^ uVar21 ) + uVar31 + ( uVar7 & uVar35 | ( uVar7 | uVar35 ) & uVar26 ) + ( uVar36 ^ uVar33 );
         ...
         uVar12 = uVar12 * 0x80 | uVar12 >> 0x19;
         uVar7 = uVar15 >> 0xd | uVar15 << 0x13;
         uVar26 = ( uVar33 ^ uVar12 ) + ( uVar10 ^ uVar18 ) + uVar26 + ( uVar35 & uVar4 | ( uVar35 | uVar4 ) & uVar8 );
         ...
         uVar9 = ( uVar15 ^ uVar12 ) + ( uVar6 ^ uVar1 ) + uVar8 + ( uVar4 & uVar26 | ( uVar4 | uVar26 ) & uVar36 );
         ...
         uVar12 = uVar12 * 0x80 | uVar12 >> 0x19;
         uVar13 = ( uVar4 ^ uVar12 ) + ( uVar2 ^ uVar17 ) + uVar36 + ( uVar26 & uVar9 | ( uVar26 | uVar9 ) & uVar33 );
         ...
         uVar26 = uVar9 * 0x200 | uVar9 >> 0x17;
         uVar12 = uVar12 * 0x80 | uVar12 >> 0x19;
         uVar33 = ( uVar7 ^ uVar12 ) + ( uVar3 ^ uVar21 ) + uVar33 + ( uVar9 & uVar13 | ( uVar9 | uVar13 ) & uVar30 );
         ...
         uVar7 = ( uVar10 ^ uVar11 ) + uVar30 + ( uVar13 & uVar33 | ( uVar13 | uVar33 ) & uVar26 ) + ( uVar7 ^ uVar12 );
         uVar13 = uVar4 >> 0xd | uVar4 << 0x13;
         ...
         uVar35 = ( uVar5 ^ uVar6 ) + uVar26 + ( uVar33 & uVar7 | ( uVar33 | uVar7 ) & uVar8 ) + ( uVar4 ^ uVar9 );
         uVar33 = uVar33 * 0x200 | uVar33 >> 0x17;
         ...
         uVar15 = uVar15 * 0x80 | uVar15 >> 0x19;
         uVar26 = ( uVar4 ^ uVar15 ) + ( ( uVar7 | uVar35 ) & uVar33 | uVar7 & uVar35 ) + ( ( uVar16 << 0xf | uVar16 >> 0x11 ) ^ ( uVar20 << 7 | uVar20 >> 0x19 ) ^ uVar10 ^ uVar2 ^ uVar16 ^ ( uVar16 >> 9 | uVar16 << 0x17 ) ) + uVar8;
         ...
         uVar13 = uVar15 * 0x80 | uVar15 >> 0x19;
         uVar15 = ( ( uVar35 | uVar26 ) & uVar4 | uVar35 & uVar26 ) + ( ( uVar22 << 0xf | uVar22 >> 0x11 ) ^ ( uVar14 << 7 | uVar14 >> 0x19 ) ^ uVar6 ^ uVar3 ^ uVar22 ^ ( uVar22 >> 9 | uVar22 << 0x17 ) ) + uVar33 + ( uVar8 ^ uVar13 );
         ...
         local_a4 = local_a4 ^ ( ( uVar19 << 0xf | uVar19 >> 0x11 ) ^ ( uVar23 << 7 | uVar23 >> 0x19 ) ^ uVar2 ^ uVar11 ^ uVar19 ^ ( uVar19 >> 9 | uVar19 << 0x17 ) ) + uVar4 + ( ( uVar26 | uVar15 ) & uVar7 | uVar26 & uVar15 ) + ( uVar13 ^ uVar35 );
         param_1[1] = local_6c;
         *param_1 = local_a4;
         ...
         local_48 = local_48 + -1;
         param_1[5] = local_64;
         local_74 = local_74 ^ uVar8 ^ ( uVar8 * 0x200 | uVar8 >> 0x17 ) ^ ( uVar8 >> 0xf | uVar8 * 0x20000 );
         param_1[6] = local_60;
         param_1[7] = local_4c;
         param_1[4] = local_74;
...
undefined8 ossl_sm3_update(long param_1, undefined8 *param_2, ulong param_3) {
   ...
   *(uint*)( param_1 + 0x24 ) = *(int*)( param_1 + 0x24 ) + (uint)CARRY4(iVar9 * 8, uVar2) + (int)( param_3 >> 0x1d );
   if (uVar3 == 0) {
      if (param_3 < 0x40) goto LAB_00102a58;
      LAB_00102b07:ossl_sm3_block_data_order(param_1, param_2, param_3 >> 6);
      ...
      if (uVar8 < 8) {
         if (( uVar8 & 4 ) == 0) {
            if (( uVar8 != 0 ) && ( *(undefined1*)puVar4 = *(undefined1*)param_2(uVar8 & 2) != 0 )) {
               *(undefined2*)( (long)puVar4 + lVar5 + 0x3e ) = *(undefined2*)( (long)param_2 + lVar5 + 0x3e );
            }
         ...
         *(undefined8*)( (long)puVar4 + lVar5 + 0x38 ) = *(undefined8*)( (long)param_2 + lVar5 + 0x38 );
         ...
         if (7 < uVar6) {
            uVar7 = 0;
            do {
               *(undefined8*)( ( ( ulong )(puVar4 + 1) & 0xfffffffffffffff8 ) + uVar7 ) = *(undefined8*)( (long)param_2 + ( uVar7 - lVar5 ) );
               uVar7 = uVar7 + 8;
            }
 while ( uVar7 < uVar6 );
         }
      ...
      *(undefined4*)( param_1 + 0x68 ) = 0;
      for (int i = 0; i < 4; i++) {
         *(undefined1(*) [16])( param_1 + ( 16*i + 40 ) ) = (undefined1[16])0;
      }
   ...
   iVar9 = (int)param_3;
   LAB_00102a58:*(int*)( param_1 + 0x68 ) = iVar9;
...
undefined8 ossl_sm3_final(uint *param_1, uint *param_2) {
 ...
 while ( uVar6 < uVar3 );
   ...
   LAB_00102d44:ossl_sm3_block_data_order(param_2, ptr, 1);
   uVar6 = 0x38;
   puVar4 = ptr;
   LAB_00102c23:uVar5 = (uint)uVar6;
   if (uVar5 < 8) {
      if (( uVar6 & 4 ) == 0) {
 ...
 while ( uVar2 < uVar5 );
   ...
   *(ulong*)( param_2 + 0x18 ) = uVar3 >> 0x38 | ( uVar3 & 0xff000000000000 ) >> 0x28 | ( uVar3 & 0xff0000000000 ) >> 0x18 | ( uVar3 & 0xff00000000 ) >> 8 | ( uVar3 & 0xff000000 ) << 8 | ( uVar3 & 0xff0000 ) << 0x18 | ( uVar3 & 0xff00 ) << 0x28 | uVar3 << 0x38;
   ...
   *param_1 = uVar5 >> 0x18 | ( uVar5 & 0xff0000 ) >> 8 | ( uVar5 & 0xff00 ) << 8 | uVar5 << 0x18;
   for (int i = 0; i < 7; i++) {
      uVar5 = param_2[( i + 1 )];
      param_1[( i + 1 )] = uVar5 >> 24 | ( uVar5 & 16711680 ) >> 8 | ( uVar5 & 65280 ) << 8 | uVar5 << 24;
   }

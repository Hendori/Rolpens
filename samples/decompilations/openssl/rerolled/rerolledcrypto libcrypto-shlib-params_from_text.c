...
undefined8 OSSL_PARAM_allocate_from_text(undefined8 *param_1, long param_2, char *param_3, char *param_4, ulong param_5, uint *param_6) {
   undefined8 uVar1;
   bool bVar2;
   BIGNUM *pBVar3;
   int iVar4;
      ...
      if (puVar6 != (undefined8*)0x0) {
         ...
         if (uVar5 == 4) {
            if (bVar2) {
               ...
               param_5 = sVar8 + 1;
               LAB_00100475:__dest = (uint*)CRYPTO_zalloc(param_5, "crypto/params_from_text.c", 0x145);
               if (__dest != (uint*)0x0) {
                  LAB_001004a2:pBVar3 = local_50;
                  uVar5 = *(uint*)( puVar6 + 1 );
                  pBVar10 = pBVar3;
                  if (uVar5 == 4) {
                     ...
                     if (( ( uVar5 - 1 < 2 ) && ( BN_bn2nativepad(local_50, __dest, param_5 & 0xffffffff),pBVar10 = local_50,*(int*)( puVar6 + 1 ) == 1 ) ) && ( iVar4 = BN_is_negative(pBVar3) ),pBVar10 = local_50,iVar4 != 0) {
                        uVar12 = param_5 - 1;
                        if (uVar12 < 0xf) {
                           uVar11 = 0;
                           puVar9 = __dest;
                           ...
                           do {
                              ...
                              *puVar9 = *puVar9 ^ 0xffffffff;
                              for (int i = 0; i < 3; i++) {
                                 puVar9[( i + 1 )] = puVar9[( i + 1 )] ^ 4294967295;
                              }
 ...
 while ( uVar11 < uVar13 );
                        ...
                        *(byte*)puVar9 = ~(byte) * puVar9;
                        if (( ( ( ( uVar12 != 0 ) && ( *(byte*)( (long)puVar9 + 1 ) = ~*(byte *)((long)puVar9 + 1) ),uVar12 != 1 ) ) && ( *(byte*)( (long)puVar9 + 2 ) = ~*(byte *)((long)puVar9 + 2) ),uVar12 != 2 )) &&( ( *(byte*)( (long)puVar9 + 3 ) = ~*(byte *)((long)puVar9 + 3) ),uVar12 != 3 && ( *(byte*)( puVar9 + 1 ) = uVar12 != 4 ) ) && ( *(byte*)( (long)puVar9 + 5 ) = uVar12 != 5 ) * (byte*)( (long)puVar9 + 6 ) = ~*(byte *)((long)puVar9 + 6);
                     }
         ...
         if (( iVar4 != 0 ) && ( local_50 != (BIGNUM*)0x0 )) {
            ...
            if (( ( iVar4 != 1 ) || ( iVar4 = iVar4 == 0 ) ) || ( iVar4 = iVar4 != 0 )) {
         ...
         LAB_0010038e:__dest = (uint*)CRYPTO_zalloc(uVar12, "crypto/params_from_text.c", 0x145);
         if (__dest != (uint*)0x0) {
            pBVar10 = local_50;
         ...
         LAB_00100410:__dest = (uint*)CRYPTO_zalloc(1, "crypto/params_from_text.c", 0x145);
         if (__dest != (uint*)0x0) {
            param_5 = 0;
            pBVar10 = local_50;
            goto LAB_00100435;
   ...
   LAB_001003bd:BN_free(local_50);
}
LAB_001003c2:uVar7 = 0;LAB_001003c4:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return uVar7;}

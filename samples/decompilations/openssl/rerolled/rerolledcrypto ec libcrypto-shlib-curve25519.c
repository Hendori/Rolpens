void fe_tobytes(undefined2 *param_1, int *param_2) {
   ...
   iVar9 = param_2[7];
   iVar10 = param_2[8];
   uVar11 = ( ( ( ( ( ( ( ( ( ( ( iVar2 * 0x13 + 0x1000000 >> 0x19 ) + *param_2 >> 0x1a ) + iVar3 >> 0x19 ) + iVar4 >> 0x1a ) + iVar5 >> 0x19 ) + iVar6 >> 0x1a ) + iVar7 >> 0x19 ) + iVar8 >> 0x1a ) + iVar9 >> 0x19 ) + iVar10 >> 0x1a ) + iVar2 >> 0x19 ) * 0x13 + *param_2;
...
void fe_mul(int *param_1, int *param_2, int *param_3) {
   ...
   lVar5 = lVar9 * lVar40 + lVar43 * lVar15 + lVar16 * lVar14 + lVar38 * lVar39 + lVar20 * lVar35 + lVar36 * lVar13 + lVar30 * lVar8 + lVar17 * lVar18 + lVar21 * lVar33 + ( param_3[1] * 0x13 ) * lVar41;
   lVar6 = lVar35 * lVar9 + lVar43 * lVar13 + lVar8 * lVar16 + lVar38 * lVar18 + lVar21 * lVar20 + lVar22 * lVar36 + lVar23 * lVar30 + lVar24 * lVar17 + lVar25 * lVar33 + lVar39 * lVar41;
   uVar1 = lVar5 + 0x2000000;
   lVar11 = ( (long)uVar1 >> 0x1a ) + lVar40 * lVar10 + lVar15 * lVar9 + lVar42 * lVar14 + lVar39 * lVar16 + lVar37 * lVar35 + lVar13 * lVar20 + lVar19 * lVar8 + lVar18 * lVar30 + lVar21 * lVar29 + lVar22 * lVar33;
   uVar2 = lVar6 + 0x2000000;
   lVar40 = lVar11 + 0x1000000;
   lVar31 = ( (long)uVar2 >> 0x1a ) + lVar13 * lVar9 + lVar42 * lVar8 + lVar18 * lVar16 + lVar21 * lVar37 + lVar22 * lVar20 + lVar23 * lVar19 + lVar24 * lVar30 + lVar25 * lVar29 + lVar26 * lVar33 + lVar35 * lVar10;
   lVar3 = lVar31 + 0x1000000;
   lVar34 = ( lVar40 >> 0x19 ) + lVar15 * lVar41 + lVar14 * lVar9 + lVar43 * lVar39 + lVar35 * lVar16 + lVar38 * lVar13 + lVar8 * lVar20 + lVar36 * lVar18 + lVar21 * lVar30 + lVar22 * lVar17 + lVar23 * lVar33;
   lVar15 = lVar34 + 0x2000000;
   lVar12 = ( lVar3 >> 0x19 ) + lVar8 * lVar9 + lVar43 * lVar18 + lVar21 * lVar16 + lVar22 * lVar38 + lVar23 * lVar20 + lVar24 * lVar36 + lVar25 * lVar30 + lVar26 * lVar17 + lVar27 * lVar33 + lVar13 * lVar41;
   lVar4 = lVar12 + 0x2000000;
   lVar32 = ( lVar15 >> 0x1a ) + lVar39 * lVar9 + lVar42 * lVar35 + lVar13 * lVar16 + lVar37 * lVar8 + lVar18 * lVar20 + lVar21 * lVar19 + lVar22 * lVar30 + lVar23 * lVar29 + lVar24 * lVar33 + lVar14 * lVar10;
   lVar13 = lVar32 + 0x1000000;
   lVar35 = lVar18 * lVar9 + lVar21 * lVar42 + lVar22 * lVar16 + lVar23 * lVar37 + lVar24 * lVar20 + lVar25 * lVar19 + lVar26 * lVar30 + lVar27 * lVar29 + lVar28 * lVar33 + lVar8 * lVar10 + ( lVar4 >> 0x1a );
   lVar39 = ( lVar13 >> 0x19 ) + ( lVar6 - ( uVar2 & 0xfffffffffc000000 ) );
   lVar6 = lVar35 + 0x1000000;
   lVar8 = lVar39 + 0x2000000;
   lVar17 = ( lVar6 >> 0x19 ) + lVar43 * lVar22 + lVar23 * lVar16 + lVar38 * lVar24 + lVar25 * lVar20 + lVar36 * lVar26 + lVar27 * lVar30 + lVar17 * lVar28 + iVar7 * lVar33 + lVar21 * lVar9 + lVar18 * lVar41;
   lVar14 = lVar17 + 0x2000000;
   lVar10 = ( lVar14 >> 0x1a ) + lVar23 * lVar42 + lVar27 * lVar19 + lVar28 * lVar30 + lVar33 * param_3[9] + iVar7 * lVar29 + lVar20 * lVar26 + lVar25 * lVar37 + lVar16 * lVar24 + lVar9 * lVar22 + lVar21 * lVar10;
...
void fe_sq(int *param_1, int *param_2) {
   ...
   lVar6 = lVar19 * lVar20 + lVar27 * lVar25 + lVar35 * lVar33 + lVar24 * lVar15 + (long)iVar11 * (long)iVar11 + ( iVar7 * 0x26 ) * lVar21;
   lVar30 = ( iVar8 * 2 ) * lVar33 + lVar37 * lVar15 + lVar32 * lVar32 + lVar24 * lVar27 + lVar18 * lVar14 + lVar25 * lVar36;
   uVar1 = lVar6 + 0x2000000;
   uVar2 = lVar30 + 0x2000000;
   lVar16 = ( (long)uVar1 >> 0x1a ) + lVar14 * lVar25 + lVar27 * lVar33 + lVar32 * lVar15 + iVar9 * lVar18 + lVar37 * lVar20;
   lVar3 = lVar16 + 0x1000000;
   lVar28 = ( (long)uVar2 >> 0x1a ) + lVar22 * lVar15 + lVar13 * lVar35 + lVar14 * lVar24 + lVar21 * lVar18 + lVar34 * lVar33;
   lVar4 = lVar28 + 0x1000000;
   lVar31 = ( lVar3 >> 0x19 ) + lVar20 * iVar8 + lVar37 * lVar25 + lVar19 * lVar33 + iVar9 * lVar24 + lVar18 * lVar32 + lVar27 * lVar15;
   lVar20 = lVar31 + 0x2000000;
   lVar17 = ( lVar4 >> 0x19 ) + lVar33 * lVar23 + lVar34 * lVar15 + lVar14 * lVar35 + lVar24 * lVar37 + lVar22 * lVar18 + lVar13 * lVar27;
   lVar5 = lVar17 + 0x2000000;
   lVar29 = ( lVar20 >> 0x1a ) + lVar37 * lVar33 + lVar14 * lVar15 + lVar32 * lVar24 + lVar13 * lVar18 + iVar8 * lVar25;
   lVar13 = lVar29 + 0x1000000;
   lVar33 = ( lVar5 >> 0x1a ) + lVar14 * lVar27 + lVar21 * lVar35 + lVar22 * lVar24 + lVar36 * lVar18 + lVar23 * lVar15;
   lVar26 = ( lVar13 >> 0x19 ) + ( lVar30 - ( uVar2 & 0xfffffffffc000000 ) );
   lVar25 = lVar33 + 0x1000000;
   lVar30 = lVar26 + 0x2000000;
   lVar32 = ( lVar25 >> 0x19 ) + lVar14 * lVar14 + lVar37 * lVar27 + lVar22 * lVar35 + lVar34 * lVar24 + lVar23 * lVar18 + lVar15 * iVar12;
   lVar14 = lVar32 + 0x2000000;
   lVar18 = ( lVar14 >> 0x1a ) + lVar36 * lVar35 + lVar18 * iVar12 + lVar23 * lVar24 + lVar22 * lVar27 + lVar19 * lVar21;
...
void ge_p2_dbl(int *param_1, int *param_2) {
   ...
   lVar16 = ( lVar32 * lVar28 + lVar35 * lVar33 + lVar27 * lVar25 + (long)iVar15 * (long)iVar15 + lVar37 * lVar36 + ( param_2[0x19] * 0x26 ) * lVar22 ) * 2;
   lVar6 = ( lVar28 * lVar31 + ( param_2[0x1a] * 2 ) * lVar33 + lVar24 * lVar25 + lVar30 * lVar30 + lVar27 * lVar32 + lVar26 * lVar21 ) * 2;
   uVar1 = lVar16 + 0x2000000;
   uVar2 = lVar6 + 0x2000000;
   lVar7 = ( (long)uVar1 >> 0x1a ) + ( lVar24 * lVar36 + lVar21 * lVar28 + lVar32 * lVar33 + lVar30 * lVar25 + iVar47 * lVar26 ) * 2;
   lVar3 = lVar7 + 0x1000000;
   lVar8 = ( (long)uVar2 >> 0x1a ) + ( lVar29 * lVar33 + lVar34 * lVar25 + lVar20 * lVar35 + lVar21 * lVar27 + lVar22 * lVar26 ) * 2;
   lVar4 = lVar8 + 0x1000000;
   lVar9 = ( lVar3 >> 0x19 ) + ( lVar24 * lVar28 + lVar37 * lVar33 + iVar47 * lVar27 + lVar26 * lVar30 + lVar32 * lVar25 + lVar36 * lVar34 ) * 2;
   lVar36 = lVar9 + 0x2000000;
   lVar10 = ( lVar4 >> 0x19 ) + ( lVar29 * lVar25 + lVar20 * lVar32 + lVar35 * lVar21 + lVar27 * lVar24 + lVar26 * lVar34 + lVar33 * lVar23 ) * 2;
   lVar5 = lVar10 + 0x2000000;
   lVar28 = ( lVar36 >> 0x1a ) + ( lVar24 * lVar33 + lVar21 * lVar25 + lVar30 * lVar27 + lVar20 * lVar26 + lVar34 * lVar28 ) * 2;
   lVar30 = ( lVar5 >> 0x1a ) + ( lVar21 * lVar32 + lVar22 * lVar35 + lVar34 * lVar27 + lVar31 * lVar26 + lVar23 * lVar25 ) * 2;
   lVar11 = lVar28 + 0x1000000;
   lVar33 = ( lVar11 >> 0x19 ) + ( lVar6 - ( uVar2 & 0xfffffffffc000000 ) );
   lVar6 = lVar30 + 0x1000000;
   lVar24 = ( lVar6 >> 0x19 ) + ( lVar21 * lVar21 + lVar24 * lVar32 + lVar35 * lVar34 + lVar29 * lVar27 + lVar23 * lVar26 + lVar25 * iVar14 ) * 2;
   lVar20 = lVar33 + 0x2000000;
   lVar21 = lVar24 + 0x2000000;
   lVar23 = ( lVar21 >> 0x1a ) + ( lVar26 * iVar14 + lVar23 * lVar27 + lVar31 * lVar35 + lVar34 * lVar32 + lVar37 * lVar22 ) * 2;
   ...
   if (( ulong )((long)param_1 + ( 0x28 - (long)( param_2 + 1 ) )) < 0x31) {
      ...
      *(ulong*)( param_1 + 0x12 ) = CONCAT44((int)( ( ulong ) * (undefined8*)( param_2 + 8 ) >> 0x20 ) + (int)( ( ulong ) * (undefined8*)( param_2 + 0x12 ) >> 0x20 ), (int)*(undefined8*)( param_2 + 8 ) + (int)*(undefined8*)( param_2 + 0x12 ));
   }
   ...
   for (int i = 0; i < 3; i++) {
      param_1[( i + 11 )] = param_1[( i + 21 )] + param_1[( i + 1 )];
   }
   ...
   *param_1 = local_68 - ( param_1[0x14] + *param_1 );
   ...
   for (int i = 0; i < 4; i++) {
      param_1[( i + 14 )] = param_1[( i + 24 )] + param_1[( i + 4 )];
   }
   ...
   *(ulong*)( param_1 + 0x26 ) = CONCAT44((int)( ( ulong ) * (undefined8*)( param_1 + 0x26 ) >> 0x20 ) - iVar39, (int)*(undefined8*)( param_1 + 0x26 ) - iVar38);
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
void ge_madd(int *param_1, int *param_2, long param_3) {
   ...
   if (( ulong )((long)param_1 - (long)( param_2 + 1 )) < 0x31) {
      *param_1 = *param_2 + param_2[10];
      for (int i = 0; i < 9; i++) {
         param_1[( i + 1 )] = param_2[( i + 1 )] + param_2[( i + 11 )];
      }
      ...
      *(ulong*)( param_1 + 8 ) = CONCAT44((int)( ( ulong ) * (undefined8*)( param_2 + 0x12 ) >> 0x20 ) + (int)( ( ulong ) * (undefined8*)( param_2 + 8 ) >> 0x20 ), (int)*(undefined8*)( param_2 + 0x12 ) + (int)*(undefined8*)( param_2 + 8 ));
   }

   if (( ulong )((long)param_1 + ( 0x28 - (long)( param_2 + 1 ) )) < 0x31) {
      param_1[10] = param_2[10] - *param_2;
      for (int i = 0; i < 9; i++) {
         param_1[( i + 11 )] = param_2[( i + 11 )] - param_2[( i + 1 )];
      }
      ...
      *(ulong*)( param_1 + 0x12 ) = CONCAT44((int)( ( ulong ) * (undefined8*)( param_2 + 0x12 ) >> 0x20 ) - (int)( ( ulong ) * (undefined8*)( param_2 + 8 ) >> 0x20 ), (int)*(undefined8*)( param_2 + 0x12 ) - (int)*(undefined8*)( param_2 + 8 ));
   }
   ...
   *param_1 = param_1[0x14] - param_1[10];
   for (int i = 0; i < 3; i++) {
      param_1[( i + 1 )] = param_1[( i + 21 )] - param_1[( i + 11 )];
   }

   iVar10 = (int)uVar1 * 2;
   iVar11 = (int)( (ulong)uVar1 >> 0x20 ) * 2;
   for (int i = 0; i < 4; i++) {
      param_1[( i + 4 )] = param_1[( i + 24 )] - param_1[( i + 14 )];
   }
...
void cmov(uint *param_1, uint *param_2, byte param_3) {
   ...
   if (( ulong )((long)param_1 - (long)( param_2 + 1 )) < 9) {
      *param_1 = ( *param_2 ^ *param_1 ) & uVar4 ^ *param_1;
      for (int i = 0; i < 9; i++) {
         param_1[( i + 1 )] = ( param_2[( i + 1 )] ^ param_1[( i + 1 )] ) & uVar4 ^ param_1[( i + 1 )];
      }
      ...
      *(ulong*)( param_1 + 8 ) = ( *(ulong*)( param_2 + 8 ) ^ *(ulong*)( param_1 + 8 ) ) & CONCAT44(uVar4, uVar4) ^ *(ulong*)( param_1 + 8 );
   }

   if (( ulong )((long)param_1 + ( -4 - (long)param_2 )) < 9) {
      for (int i = 0; i < 10; i++) {
         param_1[( i + 10 )] = ( param_2[( i + 10 )] ^ param_1[( i + 10 )] ) & uVar4 ^ param_1[( i + 10 )];
      }
      ...
      *(ulong*)( param_1 + 0x12 ) = ( *(ulong*)( param_2 + 0x12 ) ^ *(ulong*)( param_1 + 0x12 ) ) & CONCAT44(uVar4, uVar4) ^ *(ulong*)( param_1 + 0x12 );
   }
   ...
   if (8 < ( ulong )((long)param_1 + ( -4 - (long)param_2 ))) {
      ...
      *(ulong*)( param_1 + 0x1c ) = CONCAT44(uVar4, uVar4) & ( *(ulong*)( param_2 + 0x1c ) ^ *(ulong*)( param_1 + 0x1c ) ) ^ *(ulong*)( param_1 + 0x1c );
      return;
   }

   for (int i = 0; i < 10; i++) {
      param_1[( i + 20 )] = ( param_2[( i + 20 )] ^ param_1[( i + 20 )] ) & uVar4 ^ param_1[( i + 20 )];
   }
...
void slide(long param_1, long param_2) {
   ...
   lVar3 = 0;
   do {
      *(byte*)( param_1 + lVar3 ) = ( byte )((int)( uint ) * (byte*)( param_2 + ( (int)lVar3 >> 3 ) ) >> ( (byte)lVar3 & 7 )) & 1;
      lVar3 = lVar3 + 1;
   }
 while ( lVar3 != 0x100 );
   iVar9 = 0;
 ...
 while ( pcVar7 + ( ulong )(uint)(( 0xff - iVar9 ) - iVar5) + 1 != pcVar4 );
      ...
      iVar5 = iVar5 + 1;
      if (( iVar5 == 7 ) || ( pcVar7 = iVar5 == 0x101 - iVar8 )) goto LAB_001022b0;
   }
 while ( true );
}
void x25519_sc_reduce(byte *param_1) {
   ...
   long lVar33;
   char local_80;
   uVar20 = ( ulong )(( uint )(( (ulong)param_1[0x31] << 0x10 | (ulong)param_1[0x30] << 8 | (ulong)param_1[0x2f] ) >> 2) & 0x1fffff);
   uVar22 = ( ulong )(*(uint*)( param_1 + 0x31 ) >> 7 & 0x1fffff);
   uVar18 = ( ulong )(*(uint*)( param_1 + 0x3c ) >> 3);
   uVar9 = ( ulong )(*(uint*)( param_1 + 0x34 ) >> 4 & 0x1fffff);
   uVar3 = ( ulong )(( uint )(( (ulong)param_1[0x39] << 0x10 | (ulong)param_1[0x38] << 8 | (ulong)param_1[0x37] ) >> 1) & 0x1fffff);
   uVar1 = ( ulong )(*(uint*)( param_1 + 0x39 ) >> 6 & 0x1fffff);
   lVar19 = uVar18 * -0xa6f7d + ( ulong )((uint)param_1[0x2b] << 8 | ( param_1[0x2c] & 0x1f ) << 0x10 | (uint)param_1[0x2a]);
   lVar4 = uVar3 * -0xa6f7d + uVar1 * 0x215d1 + uVar18 * -0xf39ad + ( ulong )(*(uint*)( param_1 + 0x24 ) >> 6 & 0x1fffff);
   lVar5 = uVar22 * -0xa6f7d + uVar9 * 0x215d1 + uVar18 * 0x72d18 + ( ulong )(*(uint*)( param_1 + 0x1f ) >> 4 & 0x1fffff) + uVar1 * 0x9fb67 + uVar3 * -0xf39ad;
   lVar23 = uVar20 * 0xa2c13 + ( ulong )(*(uint*)( param_1 + 0xf ) >> 6 & 0x1fffff);
   lVar30 = uVar20 * 0x215d1 + uVar22 * -0xf39ad + uVar3 * 0x72d18 + uVar1 * 0xa2c13 + ( ulong )(( uint )(( (ulong)param_1[0x1b] << 8 | (ulong)param_1[0x1c] << 0x10 | (ulong)param_1[0x1a] ) >> 2) & 0x1fffff) + uVar9 * 0x9fb67;
   lVar10 = uVar20 * 0x9fb67 + uVar22 * 0x72d18 + uVar9 * 0xa2c13 + ( ulong )((uint)param_1[0x16] << 8 | ( param_1[0x17] & 0x1f ) << 0x10 | (uint)param_1[0x15]);
   lVar21 = lVar23 + 0x100000 >> 0x15;
   lVar32 = uVar20 * 0x72d18 + ( ( (ulong)param_1[0x14] << 0x10 | (ulong)param_1[0x13] << 8 | (ulong)param_1[0x12] ) >> 3 ) + uVar22 * 0xa2c13 + lVar21;
   lVar11 = lVar30 + 0x100000 >> 0x15;
   lVar24 = lVar10 + 0x100000 >> 0x15;
   lVar8 = uVar20 * -0xa6f7d + uVar22 * 0x215d1 + uVar1 * 0x72d18 + uVar18 * 0xa2c13 + ( ulong )(*(uint*)( param_1 + 0x1c ) >> 7 & 0x1fffff) + uVar3 * 0x9fb67 + uVar9 * -0xf39ad + lVar11;
   lVar7 = uVar20 * -0xf39ad + uVar22 * 0x9fb67 + uVar3 * 0xa2c13 + ( ulong )(*(uint*)( param_1 + 0x17 ) >> 5 & 0x1fffff) + uVar9 * 0x72d18 + lVar24;
   lVar12 = lVar5 + 0x100000 >> 0x15;
   lVar26 = uVar9 * -0xa6f7d + uVar3 * 0x215d1 + uVar18 * 0x9fb67 + ( ulong )(( uint )(( (ulong)param_1[0x23] << 8 | (ulong)param_1[0x24] << 0x10 | (ulong)param_1[0x22] ) >> 1) & 0x1fffff) + uVar1 * -0xf39ad + lVar12;
   lVar13 = lVar4 + 0x100000 >> 0x15;
   lVar2 = uVar1 * -0xa6f7d + uVar18 * 0x215d1 + ( ( (ulong)param_1[0x29] << 0x10 | (ulong)param_1[0x28] << 8 | (ulong)param_1[0x27] ) >> 3 ) + lVar13;
   ...
   lVar29 = lVar2 * -0xa6f7d + lVar4 * 0x215d1 + lVar10 + lVar24 * -0x200000 + lVar15 + lVar27 * -0xf39ad;
   lVar5 = lVar26 * -0xa6f7d + lVar12 * 0x215d1 + lVar2 * -0xf39ad + lVar4 * 0x9fb67 + lVar23 + lVar21 * -0x200000 + lVar27 * 0x72d18;
   lVar23 = lVar6 * 0xa2c13 + ( ulong )((uint)param_1[1] << 8 | ( param_1[2] & 0x1f ) << 0x10 | ( uint ) * param_1);
   lVar30 = lVar6 * 0x9fb67 + lVar26 * 0x72d18 + lVar12 * 0xa2c13 + ( ulong )(( uint )(( (ulong)param_1[6] << 8 | (ulong)param_1[7] << 0x10 | (ulong)param_1[5] ) >> 2) & 0x1fffff);
   lVar33 = lVar6 * 0x215d1 + lVar26 * -0xf39ad + lVar2 * 0x72d18 + lVar4 * 0xa2c13 + ( ulong )(*(uint*)( param_1 + 10 ) >> 4 & 0x1fffff) + lVar12 * 0x9fb67;
   lVar10 = lVar23 + 0x100000 >> 0x15;
   lVar24 = lVar6 * 0x72d18 + lVar26 * 0xa2c13 + ( ulong )(*(uint*)( param_1 + 2 ) >> 5 & 0x1fffff) + lVar10;
   lVar11 = lVar30 + 0x100000 >> 0x15;
   lVar31 = lVar6 * -0xf39ad + lVar26 * 0x9fb67 + lVar2 * 0xa2c13 + ( ulong )(*(uint*)( param_1 + 7 ) >> 7 & 0x1fffff) + lVar12 * 0x72d18 + lVar11;
   lVar13 = lVar33 + 0x100000 >> 0x15;
   lVar21 = lVar6 * -0xa6f7d + lVar26 * 0x215d1 + lVar12 * -0xf39ad + lVar2 * 0x9fb67 + lVar4 * 0x72d18 + lVar27 * 0xa2c13 + ( ulong )(( uint )(( (ulong)param_1[0xe] << 8 | (ulong)param_1[0xf] << 0x10 | (ulong)param_1[0xd] ) >> 1) & 0x1fffff) + lVar13;
   lVar6 = lVar5 + 0x100000 >> 0x15;
   lVar2 = lVar12 * -0xa6f7d + lVar2 * 0x215d1 + lVar4 * -0xf39ad + lVar32 + lVar15 * -0x200000 + lVar27 * 0x9fb67 + lVar6;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */bool hash_init_with_dom(EVP_MD_CTX *param_1, EVP_MD *param_2, char param_3, char param_4, void *param_5, ulong param_6) {
   int iVar1;
   long in_FS_OFFSET;
   bool bVar2;
   undefined1 local_5a;
   ...
   bVar2 = false;
   LAB_00102f3d:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return bVar2;
   }
...
void table_select(undefined8 *param_1, int param_2, uint param_3) {
   ...
   *(undefined1(*) [16])( param_1 + 0xc ) = (undefined1[16])0x0;
   ...
   for (int i = 0; i < 5; i++) {
      cmov(param_1, puVar6 + lVar5 + ( 120*i + 120 ), ( ( uVar3 ^ ( i + 2 ) ) & 255 ) - 1 >> 31);
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void x25519_scalar_mult(undefined4 *param_1, ulong *param_2, ulong *param_3) {
   byte bVar1;
   int iVar2;
   uint uVar3;
   ulong uVar4;
   ...
   if (iVar2 == 0) {
      ...
      local_1e8 = ( ulong ) * (byte*)( (long)param_3 + 4 ) << 0x20 | ( ulong ) * (byte*)( (long)param_3 + 5 ) << 0x28 | ( ulong )(uint) * param_3 | uVar4 & 0x7ffffffffffff;
      uStack_200 = 0;
      uStack_1e0 = uVar4 >> 0x33 | ( ( ulong ) * (byte*)( (long)param_3 + 0xb ) << 0x20 | ( ( ulong ) * (byte*)( (long)param_3 + 0xc ) & 0x3f ) << 0x28 | ( ulong ) * (uint*)( (long)param_3 + 7 ) ) << 5;
      local_1d8 = ( ( ulong ) * (byte*)( (long)param_3 + 0xc ) << 0x2d ) >> 0x33 | ( ( ( ulong ) * (byte*)( (long)param_3 + 0x13 ) & 1 ) << 0x30 | ( ulong ) * (byte*)( (long)param_3 + 0x11 ) << 0x20 | ( ulong ) * (byte*)( (long)param_3 + 0x12 ) << 0x28 | ( ulong ) * (uint*)( (long)param_3 + 0xd ) ) << 2;
      local_1c8 = ( ( ulong ) * (byte*)( (long)param_3 + 0x19 ) << 0x2f ) >> 0x33 | ( ( ulong ) * (byte*)( (long)param_3 + 0x1e ) << 0x20 | ( ( ulong ) * (byte*)( (long)param_3 + 0x1f ) & 0x7f ) << 0x28 | ( ulong ) * (uint*)( (long)param_3 + 0x1a ) ) << 4;
      uStack_1d0 = ( ( ulong ) * (byte*)( (long)param_3 + 0x13 ) << 0x32 ) >> 0x33 | ( (ulong)(byte)param_3[3] << 0x20 | ( ( ulong ) * (byte*)( (long)param_3 + 0x19 ) & 0xf ) << 0x28 | ( ulong ) * (uint*)( (long)param_3 + 0x14 ) ) << 7;
      uStack_210 = 0;
      local_248 = 1;
      local_2c0 = 0xfe;
      uStack_1b0 = 0;
...
;
 ...
 while ( iVar2 != 0 );
      ...
      uVar4 = ( ( ( ( ( local_248 + 0x13 >> 0x33 ) + uStack_240 >> 0x33 ) + local_238 >> 0x33 ) + local_230 >> 0x33 ) + local_228 >> 0x33 ) * 0x13 + local_248;
      ...
      *(char*)( param_1 + 2 ) = (char)( uVar9 >> 0xd );
      for (int i = 0; i < 3; i++) {
         *(char*)( (long)param_1 + ( i + 9 ) ) = (char)( uVar9 >> ( 8*i + 21 ) );
      }

      *(byte*)( param_1 + 3 ) = ( byte )(uint)(uVar9 >> 0x2d) | ( byte )((int)uVar4 << 6);
      for (int i = 0; i < 3; i++) {
         *(char*)( (long)param_1 + ( i + 13 ) ) = (char)( uVar5 >> ( 8*i + 2 ) );
      }
      ...
      *(char*)( param_1 + 5 ) = (char)( uVar8 >> 7 );
      for (int i = 0; i < 3; i++) {
         *(char*)( (long)param_1 + ( i + 21 ) ) = (char)( uVar8 >> ( 8*i + 15 ) );
      }
      ...
      *(char*)( param_1 + 7 ) = (char)( uVar7 >> 0x14 );
      for (int i = 0; i < 3; i++) {
         *(char*)( (long)param_1 + ( i + 29 ) ) = (char)( uVar7 >> ( 8*i + 28 ) );
      }
...
undefined8 ge_frombytes_vartime(int *param_1, uint *param_2) {
   ...
   lVar31 = ( ( ulong ) * (byte*)( (long)param_2 + 5 ) << 8 | ( ulong ) * (byte*)( (long)param_2 + 6 ) << 0x10 | (ulong)(byte)param_2[1] ) * 0x40;
   bVar17 = *(byte*)( (long)param_2 + 0xf );
   bVar18 = *(byte*)( (long)param_2 + 0xd );
   uVar27 = param_2[4];
   lVar38 = ( ( ulong ) * (byte*)( (long)param_2 + 0xb ) << 8 | (ulong)(byte)param_2[3] << 0x10 | ( ulong ) * (byte*)( (long)param_2 + 10 ) ) * 8;
   uVar29 = param_2[5];
   ...
   uVar30 = param_2[7];
   lVar37 = ( (ulong)(byte)param_2[6] << 8 | ( ulong ) * (byte*)( (long)param_2 + 0x19 ) << 0x10 | ( ulong ) * (byte*)( (long)param_2 + 0x17 ) ) * 0x20;
   ...
   *(undefined1(*) [16])( param_1 + 0x18 ) = (undefined1[16])0x0;
   ...
   lVar40 = ( lVar2 >> 0x19 ) + ( (ulong)(byte)uVar28 << 8 | (ulong)bVar15 << 0x10 | (ulong)bVar16 ) * 0x20;
   lVar4 = (ulong)uVar27 + 0x1000000;
   lVar11 = ( lVar3 >> 0x19 ) + ( (ulong)bVar14 << 8 | (ulong)bVar17 << 0x10 | (ulong)bVar18 ) * 4;
   lVar5 = lVar37 + 0x1000000;
   lVar39 = ( lVar4 >> 0x19 ) + ( (ulong)bVar19 << 8 | (ulong)bVar20 << 0x10 | (ulong)(byte)uVar29 ) * 0x80;
   lVar6 = lVar34 + 0x2000000;
   lVar7 = lVar40 + 0x2000000;
   lVar36 = ( lVar5 >> 0x19 ) + ( (ulong)bVar21 << 8 | (ulong)(byte)uVar30 << 0x10 | (ulong)bVar23 ) * 0x10;
 ...
 while ( iVar35 != 0 );
   ...
   if (*(byte*)( (long)param_2 + 0x1f ) >> 7 != ( local_68[0] & 1 )) {
      *param_1 = -*param_1;
      for (int i = 0; i < 7; i++) {
         param_1[( i + 1 )] = -param_1[1];
      }

      *(ulong*)( param_1 + 8 ) = CONCAT44(-(int)((ulong)*(undefined8 *)(param_1 + 8) >> 0x20), -(int)*(undefined8 *)(param_1 + 8));
   }

   fe_mul(param_1 + 0x1e, param_1, param_1 + 10);
   uVar32 = 0;
   LAB_00104bc4:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar32;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void ge_scalarmult_base(undefined1 (*param_1)[16], undefined1 (*param_2)[16]) {
   undefined1 *puVar1;
   ...
   for (int i = 0; i < 3; i++) {
      local_88[( -2*i + 7 )] = auVar10[( 3 - i )];
      local_88[( -2*i + 6 )] = auVar12[( 3 - i )];
   }
   ...
   for (int i = 0; i < 3; i++) {
      local_68[( -2*i + 7 )] = auVar12[( 3 - i )];
      local_68[( -2*i + 6 )] = auVar11[( 3 - i )];
   }
...
void ge_p3_tobytes(ulong *param_1, long param_2) {
   ...
   uVar3 = ( ( ( ( ( ( ( ( ( ( ( local_74 * 0x13 + 0x1000000 >> 0x19 ) + local_98 >> 0x1a ) + local_94 >> 0x19 ) + local_90 >> 0x1a ) + local_8c >> 0x19 ) + local_88 >> 0x1a ) + local_84 >> 0x19 ) + local_80 >> 0x1a ) + local_7c >> 0x19 ) + local_78 >> 0x1a ) + local_74 >> 0x19 ) * 0x13 + local_98;
   ...
   *param_1 = ( ( ( ( ( ( ( ulong )((int)uVar14 >> 5 & 0xff) << 8 | ( ulong )(uVar11 * 8 & 0xff | (int)uVar15 >> 0x16) ) << 8 | ( ulong )((int)uVar15 >> 0xe & 0xff) ) << 8 | ( ulong )((int)uVar15 >> 6 & 0xff) ) << 8 | ( ulong )(uVar10 * 4 & 0xff | (int)uVar4 >> 0x18) ) << 8 | (ulong)local_108 ) << 8 | ( ulong )(uVar4 >> 8 & 0xff) ) << 8 | ( ulong )(uVar3 & 0xff);
   param_1[1] = ( ( ( ( ( ( (ulong)local_fc << 8 | ( ulong )((int)uVar1 >> 10 & 0xff) ) << 8 | ( ulong )((int)uVar1 >> 2 & 0xff) ) << 8 | ( ulong )(uVar2 * 0x40 & 0xff | (int)uVar13 >> 0x13) ) << 8 | (ulong)local_100 ) << 8 | ( ulong )((int)uVar13 >> 3 & 0xff) ) << 8 | ( ulong )((int)uVar14 >> 0x15 | uVar12 * 0x20 & 0xff) ) << 8 | (ulong)local_104;
   param_1[2] = ( ( ( ( ( ( ( ulong )((int)uVar16 >> 5 & 0xff) << 8 | ( ulong )(( uVar17 & 0xff ) * 8 & 0xff | (int)uVar19 >> 0x17) ) << 8 | ( ulong )((int)uVar19 >> 0xf & 0xff) ) << 8 | ( ulong )((int)uVar19 >> 7 & 0xff) ) << 8 | ( ulong )(( uVar20 & 0xff ) + ( uVar20 & 0xff ) & 0xff | (int)uVar6 >> 0x18) ) << 8 | ( ulong )((int)uVar6 >> 0x10 & 0xff) ) << 8 | ( ulong )(uVar6 >> 8 & 0xff) ) << 8 | ( ulong )(uVar5 & 0xff);
   *(uint*)( param_1 + 3 ) = ( ( uVar8 >> 4 & 0xff00 | (int)uVar8 >> 4 & 0xffU ) << 8 | ( uVar18 & 0xf ) << 4 | (int)uVar16 >> 0x15 ) << 8 | (int)uVar16 >> 0xd & 0xffU;
...
undefined8 ossl_ed25519_sign(void *param_1, void *param_2, size_t param_3, void *param_4, void *param_5, char param_6, undefined1 param_7, char param_8, long param_9, long param_10, undefined8 param_11, undefined8 param_12) {
   int iVar1;
   EVP_MD *type;
   EVP_MD_CTX *ctx;
   ulong uVar2;
   ...
   if (param_9 == 0) {
      ...
      LAB_00105601:if (( ( ( type != (EVP_MD*)0x0 ) && ( ctx != (EVP_MD_CTX*)0x0 ) ) && ( iVar1 = EVP_DigestInit_ex(ctx, type, (ENGINE*)0x0) ),iVar1 != 0 )) {
         ...
         if (iVar1 != 0) {
            ...
            if (( ( iVar1 != 0 ) && ( iVar1 = EVP_DigestUpdate(ctx, local_e8, 0x20) ),iVar1 != 0 )) {
               ...
               iVar1 = hash_init_with_dom(ctx, type, param_6, param_7, param_9, param_10);
               if (( ( ( iVar1 != 0 ) && ( iVar1 = EVP_DigestUpdate(ctx, param_1, 0x20) ),iVar1 != 0 ) ) && ( iVar1 = iVar1 != 0 )) {
                  ...
                  if (iVar1 != 0) {
                     ...
                     uVar31 = ( ulong )(( uint )(( (ulong)local_82 << 8 | (ulong)local_81 << 0x10 | (ulong)local_86._3_1_ ) >> 2) & 0x1fffff);
                     uVar2 = ( ulong )(CONCAT13(local_7b, CONCAT21(uStack_7d, uStack_7e)) >> 4 & 0x1fffff);
                     uVar3 = ( ulong )(( uint )(( (ulong)local_7a << 8 | (ulong)(byte)local_79 << 0x10 | (ulong)local_7b ) >> 1) & 0x1fffff);
                     ...
                     uVar8 = ( ulong )(( uint )(( (ulong)(byte)local_6c << 0x10 | (ulong)local_6d << 8 | (ulong)local_71._3_1_ ) >> 2) & 0x1fffff);
                     ...
                     uVar9 = ( ulong )(( uint )(( (ulong)local_101 << 0x10 | (ulong)local_102 << 8 | (ulong)local_106._3_1_ ) >> 2) & 0x1fffff);
                     uVar71 = ( ulong )(CONCAT13(uStack_fe, CONCAT21(uStack_100, local_101)) >> 7 & 0x1fffff);
                     uVar60 = ( ulong )(( uint )(( (ulong)(byte)local_f9 << 0x10 | (ulong)local_fa << 8 | (ulong)bStack_fb ) >> 1) & 0x1fffff);
                     ...
                     uVar48 = ( ulong )(( uint )(( (ulong)(byte)local_ec << 0x10 | (ulong)local_ed << 8 | (ulong)local_f1._3_1_ ) >> 2) & 0x1fffff);
                     uVar49 = ( ulong )(local_ec >> 7);
                     lVar50 = ( ulong )((uint)local_c7 << 8 | ( local_c6 & 0x1f ) << 0x10 | (uint)local_c8) + uVar28 * uVar57;
                     lVar53 = uVar31 * uVar57 + uVar69 * uVar67 + uVar28 * uVar9 + ( ulong )(( uint )(( (ulong)local_c1 << 0x10 | (ulong)local_c2 << 8 | (ulong)local_c6._3_1_ ) >> 2) & 0x1fffff);
                     lVar54 = uVar2 * uVar57 + uVar63 * uVar67 + uVar31 * uVar9 + uVar69 * uVar71 + uVar43 * uVar28 + ( ulong )(CONCAT13(local_bb, CONCAT21(uStack_bd, uStack_be)) >> 4 & 0x1fffff);
                     lVar55 = uVar4 * uVar57 + uVar3 * uVar67 + uVar2 * uVar9 + uVar63 * uVar71 + uVar43 * uVar31 + uVar60 * uVar69 + uVar44 * uVar28 + ( ulong )(local_b9 >> 6 & 0x1fffff);
                     lVar66 = uVar5 * uVar67 + uVar4 * uVar9 + uVar3 * uVar71 + uVar2 * uVar43 + uVar60 * uVar63 + uVar44 * uVar31 + uVar45 * uVar69 + uVar46 * uVar28 + ( ulong )((uint)local_b2 << 8 | ( local_b1 & 0x1f ) << 0x10 | (uint)local_b3) + uVar6 * uVar57;
                     lVar56 = uVar8 * uVar57 + uVar7 * uVar67 + uVar6 * uVar9 + uVar5 * uVar71 + uVar4 * uVar43 + uVar60 * uVar3 + uVar2 * uVar44 + uVar45 * uVar63 + uVar46 * uVar31 + uVar47 * uVar69 + uVar48 * uVar28 + ( ulong )(( uint )(( (ulong)(byte)local_ac << 0x10 | (ulong)local_ad << 8 | (ulong)local_b1._3_1_ ) >> 2) & 0x1fffff);
                     lVar29 = uVar8 * uVar9 + uVar7 * uVar71 + uVar6 * uVar43 + uVar5 * uVar60 + uVar4 * uVar44 + uVar45 * uVar3 + uVar2 * uVar46 + uVar47 * uVar63 + uVar48 * uVar31 + uVar69 * uVar49 + uVar67 * uVar59;
                     lVar62 = uVar8 * uVar43 + uVar7 * uVar60 + uVar6 * uVar44 + uVar5 * uVar45 + uVar4 * uVar46 + uVar47 * uVar3 + uVar2 * uVar48 + uVar63 * uVar49 + uVar71 * uVar59;
                     lVar23 = uVar8 * uVar44 + uVar7 * uVar45 + uVar6 * uVar46 + uVar5 * uVar47 + uVar4 * uVar48 + uVar3 * uVar49 + uVar60 * uVar59;
                     lVar10 = uVar8 * uVar46 + uVar7 * uVar47 + uVar5 * uVar49 + uVar6 * uVar48 + uVar45 * uVar59;
                     lVar41 = uVar8 * uVar48 + uVar7 * uVar49 + uVar47 * uVar59;
                     lVar11 = lVar50 + 0x100000 >> 0x15;
                     lVar70 = uVar69 * uVar57 + ( ulong )(local_c6 >> 5 & 0x1fffff) + uVar28 * uVar67 + lVar11;
                     lVar12 = lVar53 + 0x100000 >> 0x15;
                     lVar51 = uVar63 * uVar57 + uVar31 * uVar67 + uVar69 * uVar9 + ( ulong )(CONCAT13(uStack_be, CONCAT21(uStack_c0, local_c1)) >> 7 & 0x1fffff) + uVar28 * uVar71 + lVar12;
                     lVar13 = lVar54 + 0x100000 >> 0x15;
                     lVar64 = uVar2 * uVar67 + uVar63 * uVar9 + uVar31 * uVar71 + uVar43 * uVar69 + ( ulong )(( uint )(( (ulong)(byte)local_b9 << 0x10 | (ulong)local_ba << 8 | (ulong)local_bb ) >> 1) & 0x1fffff) + uVar60 * uVar28 + uVar3 * uVar57 + lVar13;
                     lVar14 = lVar55 + 0x100000 >> 0x15;
                     lVar42 = uVar5 * uVar57 + uVar4 * uVar67 + uVar3 * uVar9 + uVar2 * uVar71 + uVar43 * uVar63 + uVar60 * uVar31 + uVar44 * uVar69 + ( ( (ulong)local_b4 << 0x10 | (ulong)local_b5 << 8 | (ulong)local_b9._3_1_ ) >> 3 ) + uVar45 * uVar28 + lVar14;
                     lVar15 = lVar66 + 0x100000 >> 0x15;
                     lVar24 = uVar6 * uVar67 + uVar5 * uVar9 + uVar4 * uVar71 + uVar43 * uVar3 + uVar2 * uVar60 + uVar44 * uVar63 + uVar45 * uVar31 + uVar46 * uVar69 + ( ulong )(local_b1 >> 5 & 0x1fffff) + uVar47 * uVar28 + uVar7 * uVar57 + lVar15;
                     lVar16 = lVar56 + 0x100000 >> 0x15;
                     lVar25 = uVar57 * uVar59 + uVar8 * uVar67 + uVar7 * uVar9 + uVar6 * uVar71 + uVar5 * uVar43 + uVar4 * uVar60 + uVar44 * uVar3 + uVar2 * uVar45 + uVar46 * uVar63 + uVar47 * uVar31 + uVar48 * uVar69 + uVar28 * uVar49 + ( ulong )(local_ac >> 7) + lVar16;
                     lVar17 = lVar29 + 0x100000 >> 0x15;
                     lVar26 = uVar8 * uVar71 + uVar7 * uVar43 + uVar6 * uVar60 + uVar5 * uVar44 + uVar4 * uVar45 + uVar46 * uVar3 + uVar2 * uVar47 + uVar48 * uVar63 + uVar31 * uVar49 + uVar9 * uVar59 + lVar17;
                     lVar18 = lVar62 + 0x100000 >> 0x15;
                     lVar27 = uVar8 * uVar60 + uVar7 * uVar44 + uVar6 * uVar45 + uVar5 * uVar46 + uVar4 * uVar47 + uVar48 * uVar3 + uVar2 * uVar49 + uVar43 * uVar59 + lVar18;
                     lVar19 = lVar23 + 0x100000 >> 0x15;
                     lVar30 = uVar44 * uVar59 + uVar8 * uVar45 + uVar7 * uVar46 + uVar6 * uVar47 + uVar5 * uVar48 + uVar4 * uVar49 + lVar19;
                     ...
                     lVar10 = lVar65 * -0xa6f7d + lVar20 * 0x215d1 + lVar22 * -0xf39ad + lVar62 + lVar18 * -0x200000 + lVar38;
                     lVar29 = lVar61 * -0xa6f7d + lVar29 + lVar17 * -0x200000 + lVar37 + lVar22 * 0x72d18 + lVar20 * 0x9fb67 + lVar65 * -0xf39ad + lVar68 * 0x215d1;
                     lVar17 = lVar58 * 0xa2c13 + lVar55 + lVar14 * -0x200000 + lVar34;
                     lVar21 = lVar58 * 0x9fb67 + lVar61 * 0x72d18 + lVar68 * 0xa2c13 + lVar66 + lVar15 * -0x200000 + lVar35;
                     lVar55 = lVar58 * 0x215d1 + lVar61 * -0xf39ad + lVar56 + lVar16 * -0x200000 + lVar36 + lVar20 * 0xa2c13 + lVar65 * 0x72d18 + lVar68 * 0x9fb67;
                     lVar15 = lVar17 + 0x100000 >> 0x15;
                     lVar56 = lVar58 * 0x72d18 + lVar42 + lVar35 * -0x200000 + lVar61 * 0xa2c13 + lVar15;
                     lVar18 = lVar21 + 0x100000 >> 0x15;
                     lVar14 = lVar58 * -0xf39ad + lVar24 + lVar36 * -0x200000 + lVar65 * 0xa2c13 + lVar68 * 0x72d18 + lVar61 * 0x9fb67 + lVar18;
                     lVar19 = lVar55 + 0x100000 >> 0x15;
                     lVar16 = lVar58 * -0xa6f7d + lVar68 * -0xf39ad + lVar25 + lVar37 * -0x200000 + lVar22 * 0xa2c13 + lVar20 * 0x72d18 + lVar65 * 0x9fb67 + lVar61 * 0x215d1 + lVar19;
                     lVar62 = lVar29 + 0x100000 >> 0x15;
                     lVar66 = lVar68 * -0xa6f7d + lVar26 + lVar38 * -0x200000 + lVar22 * 0x9fb67 + lVar20 * -0xf39ad + lVar65 * 0x215d1 + lVar62;
                     ...
                     lVar23 = lVar65 * -0xa6f7d + lVar21 + lVar18 * -0x200000 + lVar24 + lVar30 * -0xf39ad + lVar62 * 0x215d1;
                     lVar41 = lVar66 * -0xa6f7d + lVar29 * 0x215d1 + lVar17 + lVar15 * -0x200000 + lVar30 * 0x72d18 + lVar62 * 0x9fb67 + lVar65 * -0xf39ad;
                     lVar11 = lVar61 * 0xa2c13 + lVar50 + lVar11 * -0x200000;
                     lVar17 = lVar61 * 0x9fb67 + lVar29 * 0xa2c13 + lVar53 + lVar12 * -0x200000 + lVar32 + lVar66 * 0x72d18;
                     lVar35 = lVar61 * 0x215d1 + lVar62 * 0xa2c13 + lVar54 + lVar13 * -0x200000 + lVar33 + lVar65 * 0x72d18 + lVar29 * 0x9fb67 + lVar66 * -0xf39ad;
                     lVar10 = lVar11 + 0x100000 >> 0x15;
                     lVar42 = lVar70 + lVar32 * -0x200000 + lVar66 * 0xa2c13 + lVar61 * 0x72d18 + lVar10;
                     lVar12 = lVar17 + 0x100000 >> 0x15;
                     lVar18 = lVar61 * -0xf39ad + lVar65 * 0xa2c13 + lVar51 + lVar33 * -0x200000 + lVar29 * 0x72d18 + lVar66 * 0x9fb67 + lVar12;
                     lVar19 = lVar35 + 0x100000 >> 0x15;
                     lVar61 = lVar61 * -0xa6f7d + lVar65 * 0x9fb67 + lVar62 * 0x72d18 + lVar30 * 0xa2c13 + lVar64 + lVar34 * -0x200000 + lVar29 * -0xf39ad + lVar66 * 0x215d1 + lVar19;
                     lVar21 = lVar41 + 0x100000 >> 0x15;
                     lVar66 = lVar29 * -0xa6f7d + lVar56 + lVar24 * -0x200000 + lVar30 * 0x9fb67 + lVar62 * -0xf39ad + lVar65 * 0x215d1 + lVar21;
                     ...
                     *(byte*)( (long)param_1 + 0x22 ) = ( byte )((int)lVar20 << 5) | ( byte )((ulong)lVar41 >> 0x10);
   ...
   uVar52 = 0;
   LAB_00105596:OPENSSL_cleanse(&local_c8, 0x40);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */bool ossl_ed25519_verify(void *param_1, size_t param_2, void *param_3, void *param_4, char param_5, undefined1 param_6, char param_7, long param_8, long param_9, undefined8 param_10, undefined8 param_11) {
   char cVar1;
   int iVar2;
   long lVar3;
   EVP_MD_CTX *ctx;
   ...
   if (param_8 == 0) {
      ...
      LAB_00107427:if (( *(byte*)( (long)param_3 + 0x3f ) < 0x11 ) && ( ( *(byte*)( (long)param_3 + 0x3f ) != 0x10 || ( ( ( *(long*)( (long)param_3 + 0x30 ) == CONCAT17(allzeroes._7_1_, (undefined7)allzeroes) && ( *(long*)( (long)param_3 + 0x37 ) == CONCAT71(_UNK_00108828, allzeroes._7_1_) ) ) && ( ( *(byte*)( (long)param_3 + 0x2f ) < 0x14 || ( ( *(byte*)( (long)param_3 + 0x2f ) == 0x14 && ( ( *(byte*)( (long)param_3 + 0x2e ) < 0xde || ( ( *(byte*)( (long)param_3 + 0x2e ) == 0xde && ( ( *(byte*)( (long)param_3 + 0x2d ) < 0xf9 || ( ( *(byte*)( (long)param_3 + 0x2d ) == 0xf9 && ( ( *(byte*)( (long)param_3 + 0x2c ) < 0xde || ( ( *(byte*)( (long)param_3 + 0x2c ) == 0xde && ( ( *(byte*)( (long)param_3 + 0x2b ) < 0xa2 || ( ( *(byte*)( (long)param_3 + 0x2b ) == 0xa2 && ( ( *(byte*)( (long)param_3 + 0x2a ) < 0xf7 || ( ( *(byte*)( (long)param_3 + 0x2a ) == 0xf7 && ( ( *(byte*)( (long)param_3 + 0x29 ) < 0x9c || ( ( *(byte*)( (long)param_3 + 0x29 ) == 0x9c && ( ( *(byte*)( (long)param_3 + 0x28 ) < 0xd6 || ( ( *(byte*)( (long)param_3 + 0x28 ) == 0xd6 && ( ( *(byte*)( (long)param_3 + 0x27 ) < 0x58 || ( ( *(byte*)( (long)param_3 + 0x27 ) == 0x58 && ( ( *(byte*)( (long)param_3 + 0x26 ) < 0x12 || ( ( *(byte*)( (long)param_3 + 0x26 ) == 0x12 && ( ( *(byte*)( (long)param_3 + 0x25 ) < 99 || ( ( *(byte*)( (long)param_3 + 0x25 ) == 99 && ( ( *(byte*)( (long)param_3 + 0x24 ) < 0x1a || ( ( *(byte*)( (long)param_3 + 0x24 ) == 0x1a && ( ( *(byte*)( (long)param_3 + 0x23 ) < 0x5c || ( ( *(byte*)( (long)param_3 + 0x23 ) == 0x5c && ( ( *(byte*)( (long)param_3 + 0x22 ) < 0xf5 || ( ( *(byte*)( (long)param_3 + 0x22 ) == 0xf5 && ( ( *(byte*)( (long)param_3 + 0x21 ) < 0xd3 || ( ( *(byte*)( (long)param_3 + 0x21 ) == 0xd3 && ( *(byte*)( (long)param_3 + 0x20 ) < 0xed ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )) {
         ...
         if (iVar2 == 0) {
            ...
            if (lVar3 != 0) {
               ctx = (EVP_MD_CTX*)EVP_MD_CTX_new();
               bVar7 = false;
               if (( ( ( ctx != (EVP_MD_CTX*)0x0 ) && ( iVar2 = hash_init_with_dom(ctx, lVar3, param_5, param_6, param_8, param_9) ),iVar2 != 0 ) ) && ( iVar2 = iVar2 != 0 )) {
                  ...
                  if (iVar2 != 0) {
                     ...
                     LAB_00107c11:if (( local_248[lVar4] == '\0' ) && ( local_148[lVar4] == '\0' )) goto code_r0x00107c07;
 ...
 while ( (int)lVar4 != -1 );
                     LAB_00108468:local_af8 = local_a88;
   ...
   bVar7 = false;
   LAB_001073ec:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

   return bVar7;
   code_r0x00107c07:bVar7 = lVar4 == 0;
   lVar4 = lVar4 + -1;
   if (bVar7) goto LAB_00108468;
   goto LAB_00107c11;
}
undefined8 ossl_ed25519_public_from_private(undefined8 param_1, long param_2, void *param_3, undefined8 param_4) {
   int iVar1;
   EVP_MD *type;
   undefined8 uVar2;
   long in_FS_OFFSET;
   ...
   uVar2 = 0;
   LAB_001085e4:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }

...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */OCSP_BASICRESP *make_dummy_resp(void) {
   int iVar1;
   OCSP_BASICRESP *rsp;
   time_t tVar2;
   ASN1_TIME *thisupd;
   ...
   if (iVar1 == 0) {
      LAB_00100390:local_f0 = (OCSP_CERTID*)0x0;
   }
 else {
      ...
      iVar1 = test_true("test/ocspapitest.c", 0x54, "X509_NAME_add_entry_by_NID(name, NID_commonName, MBSTRING_ASC, namestr, -1, -1, 1)", iVar1 != 0);
      if (iVar1 == 0) goto LAB_00100390;
      iVar1 = ASN1_BIT_STRING_set(a, local_c8, 0x80);
      iVar1 = test_true("test/ocspapitest.c", 0x57, "ASN1_BIT_STRING_set(key, keybytes, sizeof(keybytes))", iVar1 != 0);
      if (iVar1 == 0) goto LAB_00100390;
      iVar1 = ASN1_INTEGER_set_uint64(serialNumber, 1);
      iVar1 = test_true("test/ocspapitest.c", 0x58, "ASN1_INTEGER_set_uint64(serial, (uint64_t)1)", iVar1 != 0);
      if (iVar1 == 0) goto LAB_00100390;
      dgst = EVP_sha256();
         ...
         if (iVar1 != 0) {
            ...
            if (iVar1 != 0) {
               ...
               if (iVar1 != 0) {
                  ...
                  iVar1 = test_true("test/ocspapitest.c", 0x5f, "OCSP_basic_add1_status(bs, cid, V_OCSP_CERTSTATUS_UNKNOWN, 0, NULL, thisupd, nextupd)", pOVar3 != (OCSP_SINGLERESP*)0x0);
                  if (iVar1 != 0) {
                     pOVar4 = rsp;
   ...
   LAB_0010039c:ASN1_TIME_free(thisupd);
...
undefined8 test_ocsp_url_svcloc_new(void) {
   ...
   a_00 = (X509*)0x0;
   uVar2 = 0;
   LAB_00100459:iVar1 = test_true("test/ocspapitest.c", 199, "get_cert(&issuer)", uVar2);
   if (iVar1 != 0) {
...
uint test_resp_signer(void) {
   ...
   if (iVar2 == 0) {
      LAB_00100630:pkey = (EVP_PKEY*)0x0;
      a = (X509*)0x0;
      uVar6 = 0;
   }
 else {
   ...
   if (iVar2 != 0) {
      ...
      if (iVar2 != 0) {
         ...
         iVar2 = test_true("test/ocspapitest.c", 0x82, "OCSP_basic_sign(bs, signer, key, EVP_sha1(), NULL, OCSP_NOCERTS)", iVar2 != 0);
         if (iVar2 != 0) {
            iVar2 = OCSP_resp_get0_signer(brsp, &local_48, uVar3);
            uVar1 = test_true("test/ocspapitest.c", 0x85, "OCSP_resp_get0_signer(bs, &tmp, extra_certs)", iVar2 != 0);
            ...
            if (iVar2 != 0) {
               ...
               if (iVar2 != 0) {
                  ...
                  iVar2 = test_true("test/ocspapitest.c", 0x8e, "OCSP_basic_sign(bs, signer, key, EVP_sha1(), NULL, 0)", iVar2 != 0);
                  if (iVar2 != 0) {
                     iVar2 = OCSP_resp_get0_signer(brsp, &local_48, 0);
                     iVar2 = test_true("test/ocspapitest.c", 0x91, "OCSP_resp_get0_signer(bs, &tmp, NULL)", iVar2 != 0);
                     if (iVar2 != 0) {
   ...
   uVar1 = 0;
   LAB_0010058d:OCSP_BASICRESP_free(brsp);

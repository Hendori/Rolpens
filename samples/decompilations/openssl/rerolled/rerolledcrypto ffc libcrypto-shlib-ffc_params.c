...
void ossl_ffc_params_get0_pqg(undefined8 *param_1, undefined8 *param_2, undefined8 *param_3, undefined8 *param_4) {
...
undefined8 ossl_ffc_params_set_validate_params(long param_1, undefined8 param_2, undefined8 param_3, undefined4 param_4) {
   undefined8 uVar1;
...
void ossl_ffc_params_get_validate_params(long param_1, undefined8 *param_2, undefined8 *param_3, undefined4 *param_4) {
   if (param_2 != (undefined8*)0x0) {
...
undefined8 ossl_ffc_params_copy(undefined8 *param_1, undefined8 *param_2) {
   ...
   if (( pBVar3 == (BIGNUM*)0x0 ) || ( ( ( iVar2 = BN_get_flags(pBVar3, 2) ),iVar2 != 0 && ( iVar2 = BN_get_flags(pBVar3, 1) ),iVar2 == 0 ) ) || ( pBVar3 = BN_dup(pBVar3) ),pBVar3 != (BIGNUM*)0x0) {
      ...
      *param_1 = pBVar3;
      ...
      if (( pBVar3 == (BIGNUM*)0x0 ) || ( ( ( iVar2 = BN_get_flags(pBVar3, 2) ),iVar2 != 0 && ( iVar2 = BN_get_flags(pBVar3, 1) ),iVar2 == 0 ) ) || ( pBVar3 = BN_dup(pBVar3) ),pBVar3 != (BIGNUM*)0x0) {
         ...
         if (( ( pBVar3 == (BIGNUM*)0x0 ) || ( ( iVar2 = BN_get_flags(pBVar3, 2) ),iVar2 != 0 && ( iVar2 = BN_get_flags(pBVar3, 1) ),iVar2 == 0 ) )) {
...
bool ossl_ffc_params_todata(long *param_1, undefined8 param_2, undefined8 param_3) {
   ...
   undefined8 uVar2;
   long lVar3;
   if (( ( ( ( ( *param_1 == 0 ) || ( iVar1 = ossl_param_build_set_bn(param_2, param_3, &_LC1) ),iVar1 != 0 ) ) && ( ( param_1[1] == 0 || ( iVar1 = ossl_param_build_set_bn(param_2, param_3, &_LC2) ),iVar1 != 0 ) ) ) ) && ( ( param_1[2] == 0 || ( iVar1 = ossl_param_build_set_bn(param_2, param_3, &_LC3) ),iVar1 != 0 ) )) ( ( param_1[3] == 0 || ( iVar1 = ossl_param_build_set_bn(param_2, param_3, &_LC5) ),iVar1 != 0 ) ) && ( ( ( ( iVar1 = ossl_param_build_set_int(param_2, param_3, "gindex", (int)param_1[7]) ),iVar1 != 0 && ( iVar1 = ossl_param_build_set_int(param_2, param_3, "pcounter", (int)param_1[6]) ),iVar1 != 0 ) ) && ( iVar1 = ossl_param_build_set_int(param_2, param_3, "hindex", *(undefined4*)( (long)param_1 + 0x3c )) ),iVar1 != 0 ) && ( ( param_1[4] == 0 || ( iVar1 = ossl_param_build_set_octet_string(param_2, param_3, &_LC8, param_1[4], param_1[5]) ),iVar1 != 0 ) )(*(int*)( (long)param_1 + 0x34 ) != 0);
   {
   ...
   if (( ( iVar1 != 0 ) && ( iVar1 = ossl_param_build_set_int(param_2, param_3, "validate-g", *(uint*)( param_1 + 8 ) >> 1 & 1) ),iVar1 != 0 )) &&( ( iVar1 = ossl_param_build_set_int(param_2, param_3, "validate-legacy", *(uint*)( param_1 + 8 ) >> 2 & 1) ),iVar1 != 0 && ( ( param_1[9] == 0 || ( iVar1 = ossl_param_build_set_utf8_string(param_2, param_3, "digest") ),iVar1 != 0 ) ) )(param_1[10] != 0);
   {
...
}return false;}bool ossl_ffc_params_print(BIO *param_1, undefined8 *param_2, int param_3) {
   int iVar1;
   ulong uVar2;
   undefined *puVar3;
   ulong uVar4;
   ...
   if (( (BIGNUM*)param_2[1] != (BIGNUM*)0x0 ) && ( iVar1 = ASN1_bn_print(param_1, "subgroup order Q:", (BIGNUM*)param_2[1], (uchar*)0x0, param_3) ),iVar1 == 0) {
      return false;
   }

   if (( (BIGNUM*)param_2[3] != (BIGNUM*)0x0 ) && ( iVar1 = ASN1_bn_print(param_1, "subgroup factor:", (BIGNUM*)param_2[3], (uchar*)0x0, param_3) ),iVar1 == 0) {
      return false;
   }

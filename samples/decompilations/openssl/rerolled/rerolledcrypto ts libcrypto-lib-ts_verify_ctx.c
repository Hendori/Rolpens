...
/* WARNING: Control flow encountered bad instruction data *//* WARNING: Instruction at (ram,0x00100477) overlaps instruction at (ram,0x00100476)
   ...
   *(X509_ALGOR**)( puVar10 + 8 ) = pXVar7;
   ...
   LAB_00100370:if (param_2 == (uint*)0x0) {

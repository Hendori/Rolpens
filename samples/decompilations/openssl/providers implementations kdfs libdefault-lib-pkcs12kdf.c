...

{
  ...
  if ((iVar2 != 0) &&
     (ptr = (undefined1 (*) [16])
            CRYPTO_zalloc(0x50,"providers/implementations/kdfs/pkcs12kdf.c",0x90),
     ptr != (undefined1 (*) [16])0x0)) {
    *(undefined8 *)*ptr = uVar1;
    iVar2 = ossl_prov_memdup(param_1[6],param_1[7],ptr + 3,ptr[3] + 8);
    if ((iVar2 != 0) &&
       ((iVar2 = ossl_prov_memdup(param_1[4],param_1[5],ptr + 2,ptr[2] + 8), iVar2 != 0 &&
        (iVar2 = ossl_prov_digest_copy(*ptr + 8,param_1 + 1), iVar2 != 0)))) {
    ...
    CRYPTO_clear_free(*(undefined8 *)ptr[2],*(undefined8 *)(ptr[2] + 8),
      ...
      if (lVar1 == 0) {
        ...
        if (pvVar5 == (void *)0x0) {
          return false;
              ...
              (iVar2 = OSSL_PARAM_get_octet_string(lVar4,param_1 + 4,0,param_1 + 5), iVar2 == 0)) {
        return false;
      }
    }
      ...
      if (lVar1 == 0) {
        ...
        if (pvVar5 == (void *)0x0) {
          return false;
              ...
              (iVar2 = OSSL_PARAM_get_octet_string(lVar4,param_1 + 6,0,param_1 + 7), iVar2 == 0)) {
        return false;
      }
    }
    lVar4 = OSSL_PARAM_locate_const(param_2,&_LC4);
    if ((lVar4 != 0) && (iVar2 = OSSL_PARAM_get_int(lVar4,param_1 + 9), iVar2 == 0)) {
      return false;
    }
        ...
        while (iVar5 = EVP_DigestInit_ex(ctx,type,(ENGINE *)0x0), iVar5 != 0) {
          ...
          if (1 < uVar3) {
            do {
              ...
              if (((iVar5 == 0) || (iVar5 = EVP_DigestUpdate(ctx,md,cnt_00), iVar5 == 0)) ||
                 (iVar5 = EVP_DigestFinal_ex(ctx,md,(uint *)0x0), iVar5 == 0)) goto LAB_0010083b;
              uVar10 = uVar10 + 1;
            } while (uVar3 != uVar10);
          }
          uVar10 = local_a8;

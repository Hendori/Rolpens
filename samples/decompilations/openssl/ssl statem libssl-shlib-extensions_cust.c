...
LAB_001000c5:
      ...
      do {
        if ((param_3 == *puVar2) &&
           ((*(int *)(puVar2 + 2) == 2 || (param_2 == *(int *)(puVar2 + 2))))) goto LAB_001000c5;
        lVar3 = lVar3 + 1;
        puVar2 = puVar2 + 0x1c;
      } while (lVar1 != lVar3);
    }
      ...
      do {
        ...
        if (iVar5 != 0) {
          ...
          if (uVar4 == 0) {
            ...
            if (pcVar2 != (code *)0x0) {
LAB_00100331:
              iVar5 = (*pcVar2)(*(undefined8 *)(param_1 + 0x40),*puVar7,param_2,&local_50,&local_48,
                                param_4,param_5,&local_54,*(undefined8 *)(puVar7 + 0x10));
            ...
            if (((iVar5 == 0) || (iVar5 = WPACKET_start_sub_packet_len__(param_3,2), iVar5 == 0)) ||
               (((local_48 != 0 && (iVar5 = WPACKET_memcpy(param_3,local_50), iVar5 == 0)) ||
                (iVar5 = WPACKET_close(param_3), iVar5 == 0)))) goto LAB_001005c8;
            if (uVar4 != 0) {
            ...
            if (*(code **)(puVar7 + 0xc) != (code *)0x0) {
              (**(code **)(puVar7 + 0xc))
                        (*(undefined8 *)(param_1 + 0x40),*puVar7,param_2,local_50,
...
ulong SSL_CTX_add_client_custom_ext
  ...
  if ((ptr == (undefined8 *)0x0) || (ptr_00 == (undefined8 *)0x0)) {
    ...
    *ptr_00 = param_7;
    ...
    uVar1 = ossl_tls_add_custom_ext_intern
                      (param_1,0,0,param_2,0x1d0,0x100000,custom_ext_free_old_cb_wrap,ptr,
...
ulong SSL_CTX_add_server_custom_ext
                (undefined8 param_1,undefined4 param_2,undefined8 param_3,undefined8 param_4,
                undefined8 param_5,undefined8 param_6,undefined8 param_7)

{
  ...
  if ((ptr == (undefined8 *)0x0) || (ptr_00 == (undefined8 *)0x0)) {
    ...
    *ptr_00 = param_7;
    ...
    ptr_00[1] = param_6;
    uVar1 = ossl_tls_add_custom_ext_intern
                      (param_1,0,1,param_2,0x1d0,0x100000,custom_ext_free_old_cb_wrap,ptr,
                       custom_ext_parse_old_cb_wrap,ptr_00);
    if ((int)uVar1 == 0) {
      CRYPTO_free(ptr);
      CRYPTO_free(ptr_00);

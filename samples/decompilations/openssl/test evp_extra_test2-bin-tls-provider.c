    ...
    *param_3 = 0x20;
    if (param_2 != (byte *)0x0) {
      ...
      *param_2 = *(byte *)(lVar2 + 0x20) ^ *pbVar1;
      do {
        param_2[lVar3] =
             *(byte *)(*param_1 + (long)(int)lVar3) ^
             *(byte *)(param_1[1] + 0x20 + (long)(int)lVar3);
        lVar3 = lVar3 + 1;
      } while (lVar3 != 0x20);
    }
    return 1;
...

{
  ...
  if ((lVar4 != 0) && (iVar3 = OSSL_PARAM_set_int(lVar4,_DAT_00107344), iVar3 == 0)) {
    return 0;
  }
...
LAB_0010365c:
      ...
      if (*param_3 < 0x40) {
        ...
        lVar2 = EVP_Q_mac(*param_1,&_LC13,0,&_LC12,0,lVar2,0x20,local_68,local_74,param_2,0x40,
                          &local_70);
        if (lVar2 != 0) {
          *param_3 = local_70;
          goto LAB_0010365c;
  ...
  else if (((param_1 != (undefined8 *)0x0) && ((EVP_MD_CTX *)param_1[0xd] != (EVP_MD_CTX *)0x0)) &&
          (iVar1 = EVP_DigestFinal_ex((EVP_MD_CTX *)param_1[0xd],local_68,&local_74), iVar1 != 0)) {
...
int xorhmacsha2sig_to_SubjectPublicKeyInfo_pem_encode
              (undefined8 *param_1,undefined8 param_2,long param_3,long param_4,ulong param_5,
              undefined8 param_6,undefined8 param_7)
...
int xorhmacsig_to_SubjectPublicKeyInfo_pem_encode
              (undefined8 *param_1,undefined8 param_2,long param_3,long param_4,ulong param_5,
              undefined8 param_6,undefined8 param_7)
...
undefined8
xor_encapsulate(long *param_1,ulong *param_2,undefined8 *param_3,ulong *param_4,undefined8 *param_5)
...
LAB_00104800:
        ...
        *ptr_01 = ptr_00;
        ...
        ptr_01[1] = lVar2;
        *param_5 = 0x20;
        if (((ulong)((long)param_4 - (lVar2 + 0x21)) < 0xf) ||
           ((ulong)((long)param_4 - ((long)ptr_00 + 1)) < 0xf)) {
          lVar5 = 0;
          do {
            *(byte *)((long)param_4 + lVar5) =
                 *(byte *)((long)ptr_00 + lVar5) ^ *(byte *)(lVar2 + 0x20 + lVar5);
            lVar5 = lVar5 + 1;
          } while (lVar5 != 0x20);
        }
        else {
...
undefined8
xor_decapsulate(long *param_1,ulong *param_2,undefined8 *param_3,undefined8 *param_4,long param_5)
...
LAB_00104b60:
    ...
    *ptr_00 = (long)puVar3;
    ...
    if ((ulong)((long)param_2 - ((long)puVar3 + 1)) < 0xf) {
      lVar10 = 0;
      do {
        *(byte *)((long)param_2 + lVar10) =
             *(byte *)((long)puVar3 + lVar10) ^ *(byte *)((long)ptr + lVar10 + 0x20);
        lVar10 = lVar10 + 1;
      } while (lVar10 != 0x20);
    }
    else {
...
int xorhmacsha2sig_to_EncryptedPrivateKeyInfo_der_encode
              (undefined8 *param_1,undefined8 param_2,long param_3,long param_4,ulong param_5,
              undefined8 param_6,undefined8 param_7)
    ...
    if ((param_3 != 0) && (0 < iVar1)) {
      ...
      if (bp != (BIO *)0x0) {
        ...
        if ((*(int *)((long)param_1 + 0xc) == 0) ||
           (iVar2 = prepare_xorx_params(param_3,iVar1,*(undefined4 *)(param_1 + 1),&local_50),
           iVar2 == 0)) {
          iVar2 = 0;
        }
        else {
...
/* WARNING: Removing unreachable block (ram,0x00105139) */

int xorhmacsha2sig_to_EncryptedPrivateKeyInfo_pem_encode
              (undefined8 *param_1,undefined8 param_2,long param_3,long param_4,ulong param_5,
              undefined8 param_6,undefined8 param_7)
...
/* WARNING: Removing unreachable block (ram,0x00105409) */

int xorhmacsig_to_EncryptedPrivateKeyInfo_der_encode
              (undefined8 *param_1,undefined8 param_2,long param_3,long param_4,ulong param_5,
              undefined8 param_6,undefined8 param_7)
...
/* WARNING: Removing unreachable block (ram,0x001056d9) */

int xorhmacsig_to_EncryptedPrivateKeyInfo_pem_encode
              (undefined8 *param_1,undefined8 param_2,long param_3,long param_4,ulong param_5,
              undefined8 param_6,undefined8 param_7)
...
LAB_00105970:
    ...
    uVar8 = 0x4c9;
LAB_00105981:
    ERR_set_debug("test/tls-provider.c",uVar8,"xor_key_op");
...
int xorhmacsig_to_PrivateKeyInfo_pem_encode
              (undefined8 *param_1,undefined8 param_2,long param_3,long param_4,ulong param_5,
              undefined8 param_6,undefined8 param_7)
      ...
      if (bp != (BIO *)0x0) {
        ...
        if (*(int *)((long)param_1 + 0xc) == 0) {
          ...
          if ((pPVar4 == (PKCS8_PRIV_KEY_INFO *)0x0) ||
             (iVar3 = xorx_pki_priv_to_der(param_3,&local_48), puVar1 = local_48, iVar3 < 1)) {
LAB_00105f08:
            ERR_new();
            ERR_set_debug("test/tls-provider.c",0x556,"key_to_p8info");
            ERR_set_error(0x80,0xc0100,0);
...
/* WARNING: Removing unreachable block (ram,0x00106448) */
/* WARNING: Removing unreachable block (ram,0x001064ab) */
/* WARNING: Removing unreachable block (ram,0x0010634c) */
/* WARNING: Removing unreachable block (ram,0x001064c0) */

int xorhmacsha2sig_to_PrivateKeyInfo_der_encode
              (undefined8 *param_1,undefined8 param_2,long param_3,long param_4,ulong param_5,
              undefined8 param_6,undefined8 param_7)
...
/* WARNING: Removing unreachable block (ram,0x0010688b) */
/* WARNING: Removing unreachable block (ram,0x0010672c) */
/* WARNING: Removing unreachable block (ram,0x001068a0) */

int xorhmacsig_to_PrivateKeyInfo_der_encode
              (undefined8 *param_1,undefined8 param_2,long param_3,long param_4,ulong param_5,
              undefined8 param_6,undefined8 param_7)
...
/* WARNING: Removing unreachable block (ram,0x00106b0c) */
/* WARNING: Removing unreachable block (ram,0x00106c80) */

int xorhmacsha2sig_to_PrivateKeyInfo_pem_encode
              (undefined8 *param_1,undefined8 param_2,long param_3,long param_4,ulong param_5,
              undefined8 param_6,undefined8 param_7)
            ...
            ((local_44 == mem_1 ||
             ((in_mem_0 != 1 &&
              ((local_44 == DAT_00107384 ||
               ((in_mem_0 != 2 &&
                ((local_44 == DAT_00107388 ||
                 ((in_mem_0 != 3 &&
                  ((local_44 == DAT_0010738c ||
                   ((in_mem_0 != 4 &&
                    ((local_44 == DAT_00107390 ||
                     ((in_mem_0 != 5 &&
                      ((local_44 == DAT_00107394 ||
                       ((in_mem_0 != 6 &&
                        ((local_44 == DAT_00107398 ||
                         ((in_mem_0 != 7 &&
                          ((local_44 == DAT_0010739c ||
                           ((in_mem_0 != 8 &&
                            ((local_44 == DAT_001073a0 ||
                             ((in_mem_0 != 9 && (local_44 == DAT_001073a4)))))))))))))))))))))))))))
                 )))))))))));
    in_mem_0 = in_mem_0 + 1;
                       ...
                       ((in_mem_0 != 6 &&
                        ((uVar3 == DAT_00107398 ||
                         ((in_mem_0 != 7 &&
                          ((uVar3 == DAT_0010739c ||
                           ((in_mem_0 != 8 &&
                            ((uVar3 == DAT_001073a0 || ((in_mem_0 != 9 && (uVar3 == DAT_001073a4))))
                            ))))))))))))))))))))))))))))))))));
    in_mem_0 = in_mem_0 + 1;
    (&mem_1)[lVar6] = uVar3;
LAB_00107100:
    ...
    if (iVar2 == 0) {
      ...
      if (iVar2 == 0) {
        ...
        if (iVar2 == 0) {
          ...
          iVar2 = (*pcVar7)(param_1,"1.3.6.1.4.1.16604.998888.2","SHA256",

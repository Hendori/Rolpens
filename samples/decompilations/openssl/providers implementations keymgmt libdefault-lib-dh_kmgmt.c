...
LAB_00100b80:
    lVar4 = OSSL_PARAM_locate_const(param_2,"gindex");
    if ((((lVar4 == 0) || (iVar2 = OSSL_PARAM_get_int(lVar4,param_1 + 0x38), iVar2 != 0)) &&
        ((lVar4 = OSSL_PARAM_locate_const(param_2,"pcounter"), lVar4 == 0 ||
         (iVar2 = OSSL_PARAM_get_int(lVar4,param_1 + 0x44), iVar2 != 0)))) &&
       ((lVar4 = OSSL_PARAM_locate_const(param_2,"hindex"), lVar4 == 0 ||
        (iVar2 = OSSL_PARAM_get_int(lVar4,param_1 + 0x48), iVar2 != 0)))) {
      ...
      if (lVar4 != 0) {
        ...
        *(undefined8 *)(param_1 + 0x30) = 0;
        if ((lVar5 != 0) && (lVar4 != 0)) {
          lVar5 = CRYPTO_memdup(lVar5,lVar4,"providers/implementations/keymgmt/dh_kmgmt.c",0x206);
      ...
      lVar4 = OSSL_PARAM_locate_const(param_2,"qbits");
      if ((lVar4 == 0) || (iVar2 = OSSL_PARAM_get_size_t(lVar4,param_1 + 0x20), iVar2 != 0)) {
        ...
        if (lVar4 != 0) {
          ...
          pcVar6 = CRYPTO_strdup(*(char **)(lVar4 + 0x10),
                                 "providers/implementations/keymgmt/dh_kmgmt.c",0x27b);
          *(char **)(param_1 + 0x50) = pcVar6;
          if (pcVar6 == (char *)0x0) {
            return 0;
          }
        }
        ...
        if (lVar4 != 0) {
          ...
          *(char **)(param_1 + 0x58) = pcVar6;
          if (pcVar6 == (char *)0x0) {
            return 0;
          }
        }
        lVar4 = OSSL_PARAM_locate_const(param_2,"safeprime-generator");
        if (lVar4 == 0) {
          return 1;
        }
        ERR_new();
...
LAB_00100b26:
        ...
        if ((lVar4 != 0) && (iVar2 = OSSL_PARAM_get_int(lVar4,param_1 + 0x4c), iVar2 == 0)) {
          return 0;
        }
        goto LAB_00100b80;
      }
      ...
      if (*(int *)(lVar4 + 8) == 4) {
        ...
        iVar1 = strcmp(pcVar6,"default");
        if (iVar1 == 0) {
          uVar3 = (uint)(iVar2 == 0x1000);
        }
        else {
          uVar3 = ossl_dh_gen_type_name2id(pcVar6,iVar2);
          if (uVar3 == 0xffffffff) goto LAB_00100d88;
        }
...
LAB_00100d88:
    ...
    ERR_set_debug("providers/implementations/keymgmt/dh_kmgmt.c",uVar7,"dh_gen_common_set_params");
...
LAB_001011f0:
        ERR_new();
        pcVar5 = "dh_gen_common_set_params";
        uVar6 = 0x21e;
        goto LAB_001011a5;
      }
      ...
      if (iVar1 == 0) {
        ...
        uVar3 = ossl_dh_gen_type_name2id(pcVar5,iVar2);
        if (uVar3 == 0xffffffff) goto LAB_001011f0;
      }
      *(uint *)(param_1 + 0x3c) = uVar3;
    }
    lVar4 = OSSL_PARAM_locate_const(param_2,"group");
...
LAB_00101108:
  ...
  lVar4 = OSSL_PARAM_locate_const(param_2,"safeprime-generator");
  if ((lVar4 != 0) && (iVar2 = OSSL_PARAM_get_int(lVar4,param_1 + 0x40), iVar2 == 0)) {
    return 0;
  }
  lVar4 = OSSL_PARAM_locate_const(param_2,"gindex");
  if (((((lVar4 == 0) && (lVar4 = OSSL_PARAM_locate_const(param_2,"pcounter"), lVar4 == 0)) &&
       (lVar4 = OSSL_PARAM_locate_const(param_2,"hindex"), lVar4 == 0)) &&
      ((lVar4 = OSSL_PARAM_locate_const(param_2,&_LC17), lVar4 == 0 &&
       (lVar4 = OSSL_PARAM_locate_const(param_2,"qbits"), lVar4 == 0)))) &&
     ((lVar4 = OSSL_PARAM_locate_const(param_2,"digest"), lVar4 == 0 &&
      (lVar4 = OSSL_PARAM_locate_const(param_2,"properties"), lVar4 == 0)))) {
    return 1;
  }
  ERR_new();
  pcVar5 = "dh_gen_set_params";
  uVar6 = 0x2a7;
LAB_001011a5:
  ERR_set_debug("providers/implementations/keymgmt/dh_kmgmt.c",uVar6,pcVar5);
  ERR_set_error(0x39,0x80106,0);
  return 0;
}
...
undefined8 * dhx_gen_init(undefined8 param_1,uint param_2,undefined8 param_3)
...
undefined8 * dh_gen_init(undefined8 param_1,uint param_2,undefined8 param_3)

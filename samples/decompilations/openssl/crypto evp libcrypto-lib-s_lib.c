...
long EVP_SKEY_import(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined4 param_4,
                    undefined8 param_5)
...
LAB_00100630:
    ...
    if ((**(int **)(param_1 + 0x18) == *piVar2) &&
       (*(long *)(*(int **)(param_1 + 0x18) + 6) == *(long *)(piVar2 + 6))) goto LAB_001006b0;

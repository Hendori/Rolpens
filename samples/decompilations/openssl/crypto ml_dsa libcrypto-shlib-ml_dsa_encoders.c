...

{
  ...
  while( true ) {
    ...
    *param_1 = uVar6 & uVar5 | uVar7 & ~uVar5;
    uVar7 = 4 - uVar3;
    uVar3 = 0x7fe005 - uVar3;
    uVar5 = (int)((uVar3 ^ 0x7fe001 | uVar7 ^ 0x7fe001) ^ uVar3) >> 0x1f;
    uVar6 = uVar4 >> 8 & 0xf;
    param_1[1] = uVar3 & uVar5 | uVar7 & ~uVar5;
    uVar7 = 4 - uVar6;
    uVar6 = 0x7fe005 - uVar6;
    uVar5 = (int)((uVar6 ^ 0x7fe001 | uVar7 ^ 0x7fe001) ^ uVar6) >> 0x1f;
    uVar3 = uVar4 >> 0xc & 0xf;
    param_1[2] = uVar6 & uVar5 | uVar7 & ~uVar5;
    uVar7 = 4 - uVar3;
    uVar3 = 0x7fe005 - uVar3;
    uVar5 = (int)((uVar3 ^ 0x7fe001 | uVar7 ^ 0x7fe001) ^ uVar3) >> 0x1f;
    uVar6 = uVar4 >> 0x10 & 0xf;
    param_1[3] = uVar3 & uVar5 | uVar7 & ~uVar5;
    uVar7 = 4 - uVar6;
    uVar6 = 0x7fe005 - uVar6;
    uVar5 = (int)((uVar6 ^ 0x7fe001 | uVar7 ^ 0x7fe001) ^ uVar6) >> 0x1f;
    uVar3 = uVar4 >> 0x14 & 0xf;
    param_1[4] = uVar6 & uVar5 | uVar7 & ~uVar5;
    uVar7 = 4 - uVar3;
    uVar3 = 0x7fe005 - uVar3;
    uVar5 = (int)((uVar3 ^ 0x7fe001 | uVar7 ^ 0x7fe001) ^ uVar3) >> 0x1f;
    uVar6 = uVar4 >> 0x18 & 0xf;
    param_1[5] = uVar3 & uVar5 | uVar7 & ~uVar5;
    uVar3 = 4 - uVar6;
    uVar6 = 0x7fe005 - uVar6;
    uVar5 = (int)((uVar6 ^ 0x7fe001 | uVar3 ^ 0x7fe001) ^ uVar6) >> 0x1f;
    param_1[6] = uVar6 & uVar5 | uVar3 & ~uVar5;
    uVar3 = 4 - (uVar4 >> 0x1c);
...

{
  ...
  do {
    ...
    *param_2 = (long)puVar2 + 10;
    ...
    uVar9 = 0x80000 - uVar3;
    uVar3 = 0x87e001 - uVar3;
    uVar4 = (int)((uVar3 ^ 0x7fe001 | uVar9 ^ 0x7fe001) ^ uVar3) >> 0x1f;
    uVar5 = (uVar6 & 0xff) << 0xc | *puVar2 >> 0x14;
    *param_1 = uVar3 & uVar4 | uVar9 & ~uVar4;
    uVar4 = 0x80000 - uVar5;
    ...
    uVar4 = 0x80000 - uVar3;
    uVar3 = 0x87e001 - uVar3;
    uVar5 = (uint)(ushort)uVar7 << 4 | uVar6 >> 0x1c;
    uVar6 = (int)((uVar3 ^ 0x7fe001 | uVar4 ^ 0x7fe001) ^ uVar3) >> 0x1f;
    param_1[2] = uVar3 & uVar6 | uVar4 & ~uVar6;
    uVar7 = 0x80000 - uVar5;
    uVar5 = 0x87e001 - uVar5;
    uVar6 = (int)((uVar5 ^ 0x7fe001 | uVar7 ^ 0x7fe001) ^ uVar5) >> 0x1f;
    param_1[3] = uVar5 & uVar6 | uVar7 & ~uVar6;
    if (param_1 + 4 == puVar1) {
      return 1;
    }
    param_1 = param_1 + 4;
...

{
  ...
  do {
    ...
    *param_1 = uVar3 & uVar4 | uVar9 & ~uVar4;
    ...
    uVar4 = 0x20000 - uVar3;
    uVar3 = 0x81e001 - uVar3;
    uVar5 = (uint)(byte)uVar7 << 10 | uVar6 >> 0x16;
    uVar6 = (int)((uVar3 ^ 0x7fe001 | uVar4 ^ 0x7fe001) ^ uVar3) >> 0x1f;
    param_1[2] = uVar3 & uVar6 | uVar4 & ~uVar6;
    uVar7 = 0x20000 - uVar5;
    uVar5 = 0x81e001 - uVar5;
...
LAB_00100a88:
    ...
    *param_2 = (long)puVar3 + 3;
    uVar4 = *puVar3;
    if ((((uVar4 & 0x924924) >> 2 | (uVar4 & 0x924924) >> 1) & (uint)uVar4) != 0) goto LAB_00100a88;
    uVar6 = 2 - (uVar4 & 7);
    ...
    *param_1 = uVar10 & uVar8 | uVar6 & ~uVar8;
    uVar6 = 2 - uVar9;
    uVar9 = 0x7fe003 - uVar9;
    uVar8 = (int)((uVar9 ^ 0x7fe001 | uVar6 ^ 0x7fe001) ^ uVar9) >> 0x1f;
    uVar10 = (uVar4 & 0x1c0) >> 6;
    param_1[1] = uVar9 & uVar8 | uVar6 & ~uVar8;
    uVar6 = 2 - uVar10;
    uVar10 = 0x7fe003 - uVar10;
    uVar8 = (int)((uVar10 ^ 0x7fe001 | uVar6 ^ 0x7fe001) ^ uVar10) >> 0x1f;
    uVar9 = (uVar4 & 0xe00) >> 9;
    ...
    uVar9 = 0x7fe003 - uVar9;
    uVar8 = (int)((uVar9 ^ 0x7fe001 | uVar6 ^ 0x7fe001) ^ uVar9) >> 0x1f;
    uVar10 = (uVar4 & 0x7000) >> 0xc;
    param_1[3] = uVar9 & uVar8 | uVar6 & ~uVar8;
    uVar6 = 2 - uVar10;
    uVar10 = 0x7fe003 - uVar10;
    uVar8 = (int)((uVar10 ^ 0x7fe001 | uVar6 ^ 0x7fe001) ^ uVar10) >> 0x1f;
    ...
    uVar9 = 0x7fe003 - uVar9;
    uVar8 = (int)((uVar9 ^ 0x7fe001 | uVar6 ^ 0x7fe001) ^ uVar9) >> 0x1f;
    uVar10 = (uVar4 & 0x1c0000) >> 0x12;
    param_1[5] = uVar9 & uVar8 | uVar6 & ~uVar8;
    uVar6 = 2 - uVar10;
    uVar10 = 0x7fe003 - uVar10;
    uVar8 = (int)((uVar10 ^ 0x7fe001 | uVar6 ^ 0x7fe001) ^ uVar10) >> 0x1f;
    param_1[6] = uVar10 & uVar8 | uVar6 & ~uVar8;
    uVar9 = 2 - (uVar4 >> 0x15);
    uVar8 = 0x7fe003 - (uVar4 >> 0x15);
    uVar6 = (int)((uVar8 ^ 0x7fe001 | uVar9 ^ 0x7fe001) ^ uVar8) >> 0x1f;
    param_1[7] = uVar8 & uVar6 | uVar9 & ~uVar6;
    param_1 = param_1 + 8;
  } while (uVar7 != uVar1);
  uVar5 = 1;
LAB_00100a8a:
...

{
  ...
  if ((int)uVar9 != 0) {
    ...
    do {
      ...
      uVar8 = 2 - *piVar1;
      uVar6 = (int)((uVar8 ^ 0x7fe001 | uVar5 ^ 0x7fe001) ^ uVar5) >> 0x1f;
...

{
  ...
  piVar13 = param_1;
  do {
    uVar1 = WPACKET_allocate_bytes(param_2,9,&local_48);
    if ((int)uVar1 == 0) goto LAB_00100e87;
    uVar7 = 0x20000 - *piVar13;
    uVar6 = 0x81e001 - *piVar13;
    uVar8 = 0x20000 - piVar13[1];
    uVar4 = 0x81e001 - piVar13[1];
    uVar3 = (int)((uVar6 ^ 0x7fe001 | uVar7 ^ 0x7fe001) ^ uVar6) >> 0x1f;
    uVar2 = (int)((uVar4 ^ 0x7fe001 | uVar8 ^ 0x7fe001) ^ uVar4) >> 0x1f;
    uVar5 = uVar4 & uVar2 | uVar8 & ~uVar2;
    uVar9 = 0x20000 - piVar13[2];
    uVar11 = 0x81e001 - piVar13[2];
    uVar4 = (int)((uVar11 ^ 0x7fe001 | uVar9 ^ 0x7fe001) ^ uVar11) >> 0x1f;
    piVar12 = piVar13 + 4;
    uVar2 = 0x81e001 - piVar13[3];
    uVar10 = 0x20000 - piVar13[3];
    uVar8 = (int)((uVar10 ^ 0x7fe001 | uVar2 ^ 0x7fe001) ^ uVar2) >> 0x1f;
    uVar2 = uVar2 & uVar8 | uVar10 & ~uVar8;
    *local_48 = uVar5 << 0x12 | uVar6 & uVar3 | uVar7 & ~uVar3;
    *(char *)(local_48 + 2) = (char)(uVar2 >> 10);
    local_48[1] = uVar2 << 0x16 | (uVar11 & uVar4 | uVar9 & ~uVar4) << 4 | uVar5 >> 0xe;
    piVar13 = piVar12;
  } while (param_1 + 0x100 != piVar12);
  uVar1 = 1;
LAB_00100e87:
...

{
  ...
  piVar13 = param_1;
  do {
    uVar1 = WPACKET_allocate_bytes(param_2,10,&local_48);
    if ((int)uVar1 == 0) goto LAB_00101028;
    uVar7 = 0x80000 - *piVar13;
    uVar6 = 0x87e001 - *piVar13;
    uVar8 = 0x80000 - piVar13[1];
    uVar4 = 0x87e001 - piVar13[1];
    uVar3 = (int)((uVar6 ^ 0x7fe001 | uVar7 ^ 0x7fe001) ^ uVar6) >> 0x1f;
    uVar2 = (int)((uVar4 ^ 0x7fe001 | uVar8 ^ 0x7fe001) ^ uVar4) >> 0x1f;
    uVar5 = uVar4 & uVar2 | uVar8 & ~uVar2;
    uVar9 = 0x80000 - piVar13[2];
    uVar11 = 0x87e001 - piVar13[2];
    uVar4 = (int)((uVar11 ^ 0x7fe001 | uVar9 ^ 0x7fe001) ^ uVar11) >> 0x1f;
    piVar12 = piVar13 + 4;
    uVar2 = 0x87e001 - piVar13[3];
    uVar10 = 0x80000 - piVar13[3];
    uVar8 = (int)((uVar10 ^ 0x7fe001 | uVar2 ^ 0x7fe001) ^ uVar2) >> 0x1f;
    uVar2 = uVar2 & uVar8 | uVar10 & ~uVar8;
    *local_48 = uVar5 << 0x14 | uVar6 & uVar3 | uVar7 & ~uVar3;
    *(short *)(local_48 + 2) = (short)(uVar2 >> 4);
    local_48[1] = uVar2 << 0x1c | (uVar11 & uVar4 | uVar9 & ~uVar4) << 8 | uVar5 >> 0xc;
    piVar13 = piVar12;
  } while (param_1 + 0x100 != piVar12);
  uVar1 = 1;
LAB_00101028:
...

{
  ...
  pvVar5 = CRYPTO_malloc((int)lVar3,"crypto/ml_dsa/ml_dsa_encoders.c",0x2cc);
  if (pvVar5 != (void *)0x0) {
    pcVar31 = poly_encode_signed_2;
    if (*(int *)(lVar29 + 0x30) == 4) {
      pcVar31 = poly_encode_signed_4;
    }
    iVar4 = WPACKET_init_static_len(local_78,pvVar5,lVar3,0);
    if ((((iVar4 != 0) && (iVar4 = WPACKET_memcpy(local_78,param_1 + 0x20,0x20), iVar4 != 0)) &&
      ...
      if (lVar1 != 0) {
        lVar29 = 0;
        do {
          iVar4 = (*pcVar31)(lVar29 * 0x400 + *(long *)(param_1 + 0xe0));
          if (iVar4 == 0) goto LAB_001014ef;
          lVar29 = lVar29 + 1;
        } while (lVar1 != lVar29);
        lVar29 = 0;
        do {
          ...
          do {
            ...
            if (iVar4 == 0) goto LAB_001014ef;
            uVar8 = 0x1000 - *piVar33;
            uVar23 = 0x7ff001 - *piVar33;
            uVar12 = (int)((uVar23 ^ 0x7fe001 | uVar8 ^ 0x7fe001) ^ uVar23) >> 0x1f;
            uVar34 = 0x7ff001 - piVar33[1];
            uVar28 = 0x1000 - piVar33[1];
            uVar26 = 0x1000 - piVar33[2];
            uVar19 = 0x7ff001 - piVar33[2];
            uVar9 = (int)((uVar34 ^ 0x7fe001 | uVar28 ^ 0x7fe001) ^ uVar34) >> 0x1f;
            uVar13 = (int)((uVar19 ^ 0x7fe001 | uVar26 ^ 0x7fe001) ^ uVar19) >> 0x1f;
            uVar10 = 0x1000 - piVar33[3];
            uVar18 = 0x7ff001 - piVar33[3];
            uVar14 = (int)((uVar18 ^ 0x7fe001 | uVar10 ^ 0x7fe001) ^ uVar18) >> 0x1f;
            uVar11 = 0x7ff001 - piVar33[4];
            uVar20 = 0x1000 - piVar33[4];
            uVar15 = (int)((uVar11 ^ 0x7fe001 | uVar20 ^ 0x7fe001) ^ uVar11) >> 0x1f;
            uVar15 = uVar11 & uVar15 | uVar20 & ~uVar15;
            piVar32 = piVar33 + 8;
            uVar21 = 0x1000 - piVar33[5];
            uVar24 = 0x7ff001 - piVar33[5];
            uVar20 = (int)((uVar24 ^ 0x7fe001 | uVar21 ^ 0x7fe001) ^ uVar24) >> 0x1f;
            uVar27 = 0x1000 - piVar33[6];
            uVar22 = 0x7ff001 - piVar33[6];
            uVar16 = (int)((uVar22 ^ 0x7fe001 | uVar27 ^ 0x7fe001) ^ uVar22) >> 0x1f;
            uVar25 = 0x1000 - piVar33[7];
            uVar11 = 0x7ff001 - piVar33[7];
            uVar17 = (int)((uVar11 ^ 0x7fe001 | uVar25 ^ 0x7fe001) ^ uVar11) >> 0x1f;
            *local_80 = (ulong)uVar15 << 0x34 |
                        (ulong)(uVar18 & uVar14 | uVar10 & ~uVar14) << 0x27 |
                        (ulong)(uVar9 & uVar34 | uVar28 & ~uVar9) << 0xd |
                        (ulong)(uVar26 & ~uVar13 | uVar19 & uVar13) << 0x1a |
                        (ulong)(uVar23 & uVar12 | uVar8 & ~uVar12);
            uVar6 = (ulong)(uVar11 & uVar17 | uVar25 & ~uVar17) << 0x1b |
                    (ulong)(uVar22 & uVar16 | uVar27 & ~uVar16) << 0xe |
                    (ulong)(uVar24 & uVar20 | uVar21 & ~uVar20) * 2 | (ulong)(uVar15 >> 0xc);
            *(int *)(local_80 + 1) = (int)uVar6;
            *(char *)((long)local_80 + 0xc) = (char)(uVar6 >> 0x20);
            piVar33 = piVar32;
...
LAB_001014ef:
    WPACKET_finish(local_78);
    CRYPTO_clear_free(pvVar5,lVar3,"crypto/ml_dsa/ml_dsa_encoders.c",0x2ee);
  }
  uVar7 = 0;
LAB_00101512:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
      ...
      if (0x1f < local_90) {
        ...
        *(ulong *)(param_1 + 0x98) = uVar5;
        if (0x3f < local_90) {
          ...
          if (lVar4 != 0) {
            do {
              iVar7 = (*pcVar13)(lVar18 * 0x400 + *(long *)(param_1 + 0xf0),&local_98);
              if (iVar7 == 0) goto LAB_0010197b;
              lVar18 = lVar18 + 1;
            } while (lVar4 != lVar18);
          }
          lVar18 = 0;
          if (lVar3 != 0) {
            do {
              iVar7 = (*pcVar13)(lVar18 * 0x400 + *(long *)(param_1 + 0xe0),&local_98);
              if (iVar7 == 0) goto LAB_0010197b;
              lVar18 = lVar18 + 1;
            } while (lVar3 != lVar18);
            lVar18 = 0;
            ...
            do {
              puVar14 = puVar6;
              do {
                if (local_90 < 0xd) goto LAB_0010197b;
                ...
                uVar16 = 0x1000 - uVar8;
                uVar8 = 0x7ff001 - uVar8;
                uVar9 = (int)((uVar8 ^ 0x7fe001 | uVar16 ^ 0x7fe001) ^ uVar8) >> 0x1f;
                uVar10 = (uint)(uVar5 >> 0xd) & 0x1fff;
                *puVar14 = uVar8 & uVar9 | uVar16 & ~uVar9;
                uVar16 = 0x1000 - uVar10;
                uVar10 = 0x7ff001 - uVar10;
                uVar8 = (int)((uVar10 ^ 0x7fe001 | uVar16 ^ 0x7fe001) ^ uVar10) >> 0x1f;
                uVar9 = (uint)(uVar5 >> 0x1a) & 0x1fff;
                puVar14[1] = uVar10 & uVar8 | uVar16 & ~uVar8;
                uVar17 = 0x1000 - uVar9;
                uVar9 = 0x7ff001 - uVar9;
                uVar10 = (int)((uVar9 ^ 0x7fe001 | uVar17 ^ 0x7fe001) ^ uVar9) >> 0x1f;
                uVar8 = (uint)(uVar5 >> 0x20);
                uVar16 = uVar8 >> 7 & 0x1fff;
                puVar14[2] = uVar9 & uVar10 | uVar17 & ~uVar10;
                uVar10 = 0x1000 - uVar16;
                uVar16 = 0x7ff001 - uVar16;
                uVar9 = (int)((uVar16 ^ 0x7fe001 | uVar10 ^ 0x7fe001) ^ uVar16) >> 0x1f;
                uVar17 = uVar8 >> 0x14 | (uVar11 & 1) << 0xc;
                puVar14[3] = uVar16 & uVar9 | uVar10 & ~uVar9;
                uVar10 = 0x1000 - uVar17;
                uVar17 = 0x7ff001 - uVar17;
                uVar8 = (int)((uVar17 ^ 0x7fe001 | uVar10 ^ 0x7fe001) ^ uVar17) >> 0x1f;
                uVar9 = uVar11 >> 1 & 0x1fff;
                puVar14[4] = uVar17 & uVar8 | uVar10 & ~uVar8;
                uVar16 = 0x1000 - uVar9;
                uVar9 = 0x7ff001 - uVar9;
                uVar8 = (int)((uVar9 ^ 0x7fe001 | uVar16 ^ 0x7fe001) ^ uVar9) >> 0x1f;
                uVar10 = uVar11 >> 0xe & 0x1fff;
                puVar14[5] = uVar9 & uVar8 | uVar16 & ~uVar8;
                uVar16 = 0x1000 - uVar10;
                uVar10 = 0x7ff001 - uVar10;
                uVar8 = (int)((uVar10 ^ 0x7fe001 | uVar16 ^ 0x7fe001) ^ uVar10) >> 0x1f;
                uVar9 = (uint)bVar2 << 5 | uVar11 >> 0x1b;
                puVar15 = puVar14 + 8;
                puVar14[6] = uVar10 & uVar8 | uVar16 & ~uVar8;
                uVar8 = 0x1000 - uVar9;
                uVar9 = 0x7ff001 - uVar9;
          ...
          if (local_90 == 0) {
            if (*(long *)(param_1 + 0xa8) == 0) {
              lVar18 = CRYPTO_memdup(param_2,param_3,"crypto/ml_dsa/ml_dsa_encoders.c",0x329);
              *(long *)(param_1 + 0xa8) = lVar18;
              if (lVar18 == 0) goto LAB_0010197b;
            }
            iVar7 = ossl_ml_dsa_key_public_from_private(param_1);
            if (iVar7 != 0) {
              iVar7 = memcmp(&local_88,(void *)(param_1 + 0x40),0x40);
              uVar12 = 1;
              if (iVar7 == 0) goto LAB_0010197d;
            }
            ERR_new();
    ...
    if (__n <= param_3) {
      ...
      if ((uVar12 <= param_3 - __n) && (uVar6 = (param_3 - __n) - uVar12, uVar10 <= uVar6)) {
        ...
        do {
          ...
          uVar13 = (ulong)bVar2;
          pbVar14 = pbVar14 + 1;
          if ((uVar3 < bVar2) || (uVar13 < uVar7)) goto LAB_00102079;
          if (uVar7 < uVar13) {
            uVar8 = 0xffffffff;
            do {
              uVar7 = uVar7 + 1;
              uVar9 = (uint)*(byte *)((long)param_2 + uVar7 + (__n - 1));
              if ((int)uVar9 <= (int)uVar8) goto LAB_00102079;
        ...
        if (uVar7 < uVar12) {
          do {
            if (*pbVar14 != 0) goto LAB_00102079;
            pbVar14 = pbVar14 + 1;

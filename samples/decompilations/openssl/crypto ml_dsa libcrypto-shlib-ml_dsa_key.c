...

{
  ...
  if (ptr == (void *)0x0) {
    ...
    iVar5 = ossl_ml_dsa_matrix_expand_A
                      (param_2,*(undefined8 *)(param_1 + 0x10),param_1 + 0x20,&local_58);
    if (iVar5 != 0) {
        ...
        if (local_60 != 0) {
          ...
          if (local_60 < 3) {
            ...
            do {
              lVar11 = 0x400 - lVar15;
              do {
                uVar8 = *(int *)((long)local_68 + lVar11 + -0x400) +
                        *(int *)(lVar11 + -0x400 + lVar13);
                uVar6 = (int)((uVar8 ^ 0x7fe001 | uVar8 - 0x7fe001 ^ 0x7fe001) ^ uVar8) >> 0x1f;
                *(uint *)((long)local_68 + lVar11 + -0x400) =
                     uVar6 & uVar8 | uVar8 - 0x7fe001 & ~uVar6;
          ...
          do {
            ...
            do {
              ...
              ossl_ml_dsa_key_compress_power2_round
                        (*(undefined4 *)((long)pvVar12 + lVar4),lVar2,lVar1);
            } while (lVar11 != 0x400);
            uVar10 = uVar10 + 1;
          } while (uVar10 < local_60);
        }
...
LAB_0010065c:
    ...
    if (((iVar3 != 1) || (iVar3 = EVP_DigestUpdate(ctx,&local_f8,0x22), iVar3 != 1)) ||
       (iVar3 = EVP_DigestSqueeze(ctx,&local_c8,0x80), iVar3 != 1)) goto LAB_0010065c;
    ...
    *(undefined8 *)(param_1 + 0x98) = uStack_50;
    ...
    if (((iVar3 == 0) ||
       ...
       (iVar3 = ossl_ml_dsa_pk_encode(param_1), iVar3 == 0)) goto LAB_0010065c;
    d = *(void **)(param_1 + 0xa0);
    cnt = *(size_t *)(*(long *)(param_1 + 8) + 0x48);
    iVar3 = EVP_DigestInit_ex2(ctx,*(undefined8 *)(param_1 + 0x18),0);
    if (((iVar3 != 1) || (iVar3 = EVP_DigestUpdate(ctx,d,cnt), iVar3 != 1)) ||
       (iVar3 = EVP_DigestSqueeze(ctx,param_1 + 0x40,0x40), iVar3 != 1)) goto LAB_0010065c;
...
LAB_00100ea5:
    ...
    if ((iVar2 != 1) || (iVar2 = EVP_DigestUpdate(ctx,pvVar3,cnt), iVar2 != 1)) goto LAB_00100ea5;

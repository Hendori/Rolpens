...
LAB_001006d9:
  ...
  iVar1 = tls13_derive_key(param_1,param_2,param_10,param_11,*param_12);
  if (iVar1 == 0) {
    return false;
  }
  iVar1 = tls13_derive_iv(param_1,param_2,param_10,*param_13,*param_14);
  return iVar1 != 0;
}



void tls13_derive_finishedkey(void)
  ...
  *puVar6 = local_158;
  ...
  if (iVar2 != 0) {
    if (*(long *)(*(long *)(*(long *)(param_1 + 0x18) + 0xd8) + 0x30) == param_2) {
      ...
      puVar5 = local_88;
      iVar2 = tls13_derive_finishedkey(param_1,lVar3,param_1 + 0x77c,puVar5);
      if (iVar2 == 0) goto LAB_00100dd0;
    }
  ...
  if (((~param_2 & 0x12) == 0) || ((~param_2 & 0x21) == 0)) {
    if ((param_2 & 0x40) == 0) {
      ...
      if ((param_2 & 0x80) == 0) {
        ...
        local_170 = "CLIENT_TRAFFIC_SECRET_0";
        goto LAB_00101283;
      }
      local_188 = param_1 + 0x5bc;
      pcVar10 = "c hs traffic";
      local_178 = param_1 + 0x67c;
      uVar9 = ssl_handshake_md(param_1);
      local_168 = EVP_MD_get_size(uVar9);
      local_180 = (uchar *)(param_1 + 0x73c);
      local_170 = "CLIENT_HANDSHAKE_TRAFFIC_SECRET";
      if (0 < (int)local_168) goto LAB_00101283;
      ERR_new();
...
LAB_00101434:
      ...
      EVP_MD_CTX_free(ctx);
      iVar3 = tls13_hkdf_expand(param_1,local_190,local_188,"e exp master",0xc,local_180,local_148,
      ...
      if (iVar3 == 0) goto LAB_00101471;
      uVar9 = 0xb;
      pcVar10 = "c e traffic";
      local_168 = 0;
      local_170 = "CLIENT_EARLY_TRAFFIC_SECRET";
      local_178 = 0;
      bVar2 = true;
LAB_001010e5:
      uVar6 = local_148;
      if (pcVar10 == "c ap traffic") {
        ...
        iVar3 = tls13_hkdf_expand(param_1,uVar7,local_188,"res master",10,local_88,uVar6,
                                  param_1 + 0x63c,uVar6,1);
        if (iVar3 == 0) goto LAB_001015f0;
      }
      goto LAB_001010f5;
    }
    ERR_new();
...
LAB_0010148d:
    ...
    if ((param_2 & 0x80) != 0) {
      ...
      local_178 = param_1 + 0x6bc;
      uVar9 = ssl_handshake_md();
      local_168 = EVP_MD_get_size(uVar9);
      local_170 = "SERVER_HANDSHAKE_TRAFFIC_SECRET";
      if (0 < (int)local_168) goto LAB_00101097;
      ERR_new();
      ERR_set_debug("ssl/tls13_enc.c",0x271,"tls13_change_cipher_state");
      ossl_statem_fatal(param_1,0x50,0xc0103,0);
LAB_001015f0:
      if ((param_2 & 0x40) == 0) goto LAB_001012c8;
      goto LAB_00101471;
    }
    local_188 = param_1 + 0x5fc;
    pcVar10 = "s ap traffic";
    local_178 = 0;
    local_170 = "SERVER_TRAFFIC_SECRET_0";
LAB_00101097:
    if ((param_2 & 0x40) == 0) {
      local_180 = local_88;
LAB_00101283:
    ...
    if (pcVar10 == "s ap traffic") {
      ...
      bVar2 = false;
      uVar9 = 0xc;
      if (pcVar10 != "s hs traffic") goto LAB_001010e5;
      memcpy((void *)(param_1 + 0x73c),local_88,local_148);
    }
LAB_001010f5:
    if (local_138 == 0) goto LAB_001015f0;
    ...
    if (iVar3 == 0) {
      ...
      uVar9 = ssl_handshake_md(param_1);
      iVar3 = tls13_hkdf_expand(param_1,uVar9,local_188,"exp master",10,local_180,uVar6,
                                param_1 + 0x7fc,uVar6,1);
      if (iVar3 != 0) {
...
LAB_001011a5:
      uVar4 = ssl_log_secret(param_1,local_170,local_c8,uVar6);
      if (uVar4 != 0) {
        if (local_178 != 0) {
          uVar9 = ssl_handshake_md(param_1);
          iVar3 = tls13_derive_finishedkey(param_1,uVar9,local_c8,local_178,(long)(int)local_168);
          if (iVar3 == 0) goto LAB_001017ae;
        }
        if ((param_2 & 2) != 0) {
...
LAB_0010132a:
    if ((param_2 & 0x40) != 0) goto LAB_0010148d;
  }
  local_1a0 = local_108;

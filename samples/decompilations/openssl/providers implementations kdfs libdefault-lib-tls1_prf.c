        ...
        if ((CARRY8(uVar1,local_48._0_8_)) ||
           (lVar6 = CRYPTO_clear_realloc
                              (param_1[5],uVar1,lVar7,"providers/implementations/kdfs/tls1_prf.c",
                               0x174), lVar6 == 0)) goto LAB_001004b5;
        param_1[5] = lVar6;
        if (local_48._0_8_ != 0) {
...

{
  ...
  if (param_3 - 1 < 0xf) {
    ...
    do {
      ...
      *(ulong *)(param_2 + uVar12) =
           *(ulong *)(param_2 + uVar12) ^ *(ulong *)((long)pvVar11 + uVar12);
...
LAB_001008e6:
  CRYPTO_clear_free(pvVar11,param_3,"providers/implementations/kdfs/tls1_prf.c",0x240);
  return true;
}

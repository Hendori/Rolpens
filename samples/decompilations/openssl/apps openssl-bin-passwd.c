...
LAB_001000f2:
    ...
    if ((((iVar2 == 0) || (iVar2 = EVP_DigestUpdate(ctx,param_1,cnt), iVar2 == 0)) ||
        ((sVar3 != 0 &&
         (((iVar2 = EVP_DigestUpdate(ctx,&ascii_dollar,1), iVar2 == 0 ||
           (iVar2 = EVP_DigestUpdate(ctx,local_66,sVar3), iVar2 == 0)) ||
          (iVar2 = EVP_DigestUpdate(ctx,&ascii_dollar,1), iVar2 == 0)))))) ||
       ((iVar2 = EVP_DigestUpdate(ctx,local_61,cnt_00), iVar2 == 0 ||
      ...
      if (((iVar2 != 0) && (iVar2 = EVP_DigestUpdate(ctx_00,param_1,cnt), iVar2 != 0)) &&
         ((iVar2 = EVP_DigestUpdate(ctx_00,local_61,cnt_00), iVar2 != 0 &&
          (iVar2 = EVP_DigestUpdate(ctx_00,param_1,cnt), iVar2 != 0)))) {
          ...
          if (iVar2 != 0) {
            ...
            if (iVar2 != 0) {
              ...
              do {
                ...
                if (((iVar2 == 0) ||
                    ((0x55555555 < uVar10 * -0x55555555 &&
                     (iVar2 = EVP_DigestUpdate(ctx_00,local_61,cnt_00), iVar2 == 0)))) ||
                   ((0x24924924 < uVar10 * -0x49249249 &&
                    (iVar2 = EVP_DigestUpdate(ctx_00,param_1,cnt), iVar2 == 0)))) goto LAB_001003f2;
                sVar3 = cnt;
                pbVar7 = param_1;
                if ((uVar10 & 1) != 0) {
                  sVar3 = 0x10;
                ...
                iVar2 = EVP_DigestUpdate(ctx_00,pbVar7,sVar3);
                if ((iVar2 == 0) ||
                   (iVar2 = EVP_DigestFinal_ex(ctx_00,&local_58,(uint *)0x0), iVar2 == 0))
                goto LAB_001003f2;
                uVar10 = uVar10 + 1;
              } while (uVar10 != 1000);
              ...
              cVar1 = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
                      [local_4c & 0x3f];
              *puVar6 = 0x24;
              puVar6[1] = cVar1;
              puVar6[2] = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
                          [(int)((uint)(local_4c >> 6) | (uint)local_52 * 4 & 0x3c)];
              puVar6[4] = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
                          [local_58 >> 2];
              cVar1 = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
                      [local_4b & 0x3f];
              puVar6[3] = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
                          [(int)((uint)(local_52 >> 4) | (local_58 & 3) << 4)];
              puVar6[5] = cVar1;
              cVar1 = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
                      [(int)((uint)(local_4b >> 6) | (uint)local_51 * 4 & 0x3c)];
              puVar6[8] = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
                          [local_57 >> 2];
              puVar6[6] = cVar1;
              puVar6[9] = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
                          [local_4a & 0x3f];
              puVar6[7] = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
                          [(int)((uint)(local_51 >> 4) | (local_57 & 3) << 4)];
              puVar6[10] = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
                           [(int)((uint)(local_4a >> 6) | (uint)local_50 * 4 & 0x3c)];
              cVar1 = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
                      [(int)((uint)(local_50 >> 4) | (local_56 & 3) << 4)];
              puVar6[0xc] = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
                            [local_56 >> 2];
              puVar6[0xb] = cVar1;
              puVar6[0xd] = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
                            [local_49 & 0x3f];
              puVar6[0xe] = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
                            [(int)((uint)(local_49 >> 6) | (uint)local_4f * 4 & 0x3c)];
              puVar6[0xf] = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
                            [(int)((uint)(local_4f >> 4) | (local_55 & 3) << 4)];
              puVar6[0x10] = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
                             [local_55 >> 2];
              puVar6[0x11] = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
                             [local_53 & 0x3f];
              puVar6[0x12] = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
                             [(int)((uint)local_4e * 4 & 0x3c | (uint)(local_53 >> 6))];
              puVar6[0x13] = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
                             [(int)((uint)(local_4e >> 4) | (local_54 & 3) << 4)];
              puVar6[0x14] = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
                             [local_54 >> 2];
              puVar6[0x17] = 0;
              puVar6[0x15] = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
                             [local_4d & 0x3f];
              puVar6[0x16] = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
                             [local_4d >> 6];
              puVar6 = out_buf_2;
              goto LAB_00100417;
            }
    ...
    if (lVar8 != 0) {
      ...
      *(char *)(*param_2 + 7) =
      ...
      if (lVar8 != 8) {
        ...
        *(char *)(*param_2 + 10) =
             "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
             [*(byte *)(*param_2 + 10) & 0x3f];
        *(char *)(*param_2 + 0xb) =
             "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
             [*(byte *)(*param_2 + 0xb) & 0x3f];
        *(char *)(*param_2 + 0xc) =
             "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
             [*(byte *)(*param_2 + 0xc) & 0x3f];
        *(char *)(*param_2 + 0xd) =
             "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
             [*(byte *)(*param_2 + 0xd) & 0x3f];
        *(char *)(*param_2 + 0xe) =
             "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
             [*(byte *)(*param_2 + 0xe) & 0x3f];
        *(char *)(*param_2 + 0xf) =
             "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzapps/passwd.c"
             [*(byte *)(*param_2 + 0xf) & 0x3f];
      }
    }
...
LAB_00100ec7:
        ...
        if ((iVar1 == 0) ||
           ((iVar1 = EVP_DigestUpdate(ctx,param_4,sVar2), iVar1 == 0 ||
            (iVar1 = EVP_DigestUpdate(ctx,local_148,local_150), iVar1 == 0)))) {
          local_148 = (uchar *)0x0;
          ctx_00 = (EVP_MD_CTX *)0x0;
          local_138 = (byte *)0x0;
        }
...
LAB_00100f28:
            ...
            if (((iVar1 != 0) && (iVar1 = EVP_DigestUpdate(ctx_00,local_148,local_150), iVar1 != 0))
               && (iVar1 = EVP_DigestUpdate(ctx_00,param_4,sVar2), iVar1 != 0)) {
...
switchD_00101cda_caseD_ffffffff:

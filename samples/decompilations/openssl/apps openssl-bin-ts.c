...
ASN1_INTEGER * next_serial(char *param_1)
...
uint create_digest_constprop_0(BIO *param_1,undefined8 param_2,EVP_MD *param_3,long *param_4)
...
LAB_001002e8:
  ...
  if (param_1 == (BIO *)0x0) {
    ...
    *param_4 = lVar3;
    for (iVar2 = EVP_DigestInit(ctx,param_3); iVar2 != 0;
        iVar2 = EVP_DigestUpdate(ctx,local_1038,(long)iVar2)) {
...
ASN1_INTEGER * serial_cb(undefined8 param_1,char *param_2)
...
bool ts_main(undefined4 param_1,undefined8 param_2)
...
switchD_00100556_caseD_0:
    ...
    do {
      ...
      if (iVar6 == 0) {
        ...
        if (iVar8 == 0) {
switchD_00100556_caseD_ffffffff:
          conf = (CONF *)0x0;
        }
        else {
          if (iVar10 == -1) {
          ...
          if (((iVar10 == 0x10) && (local_c0 != 0)) &&
             (iVar8 = app_passwd(local_c0,0,&local_70), iVar8 == 0)) {
          ...
          if (iVar10 == 5) {
            ...
            if (local_110 == (BIO *)0x0) {
              local_f8 = (BIO *)0x0;
              if ((local_108 != 0) ||
                 (local_f8 = (BIO *)bio_open_default(local_118,0x72,4), local_f8 != (BIO *)0x0)) {
                local_60 = (void *)0x0;
                if (((pEVar22 == (EVP_MD *)0x0) &&
                    (pEVar22 = EVP_get_digestbyname("sha256"), pEVar22 == (EVP_MD *)0x0)) ||
                   (lVar13 = TS_REQ_new(), lVar13 == 0)) {
                  a = (ASN1_INTEGER *)0x0;
                  lVar13 = 0;
                ...
                if (local_118 != (BIO *)0x0) {
                  ...
                  if (pAVar20 != (ASN1_OBJECT *)0x0) {
                    ...
                    if ((((iVar10 != 0) &&
                         (iVar10 = create_digest_constprop_0(local_f8,local_108,pEVar22),
                         iVar10 != 0)) &&
                        (iVar10 = TS_MSG_IMPRINT_set_msg(local_100,local_60,iVar10), iVar10 != 0))
                       && (iVar10 = TS_REQ_set_msg_imprint(lVar13), iVar10 != 0)) {
...
LAB_00100fe7:
                if (!bVar5) {
                  ...
                  if (((pBVar12 == (BIO *)0x0) ||
                      (lVar14 = TS_CONF_get_tsa_section(conf,local_a0), lVar14 == 0)) ||
                     (lVar13 = TS_RESP_CTX_new(), lVar13 == 0)) {
                    lVar13 = 0;
                  }
                  else {
                    iVar10 = TS_CONF_set_serial(conf,lVar14,serial_cb,lVar13);
                    if (((iVar10 != 0) &&
                        (iVar10 = TS_CONF_set_crypto_device(conf,lVar14,local_a8), iVar10 != 0)) &&
                       ((iVar10 = TS_CONF_set_signer_cert(conf,lVar14,local_90,lVar13), iVar10 != 0
                        && ((iVar10 = TS_CONF_set_certs(conf,lVar14,local_88,lVar13), iVar10 != 0 &&
                            (iVar10 = TS_CONF_set_signer_key(conf,lVar14,local_98,pvVar7,lVar13),
                            iVar10 != 0)))))) {
                      if (pEVar22 == (EVP_MD *)0x0) {
                        iVar10 = TS_CONF_set_signer_digest(conf,lVar14,0,lVar13);
                      }
                      else {
                        iVar10 = TS_RESP_CTX_set_signer_digest(lVar13,pEVar22);
                      }
                      if ((((((iVar10 != 0) &&
                             (iVar10 = TS_CONF_set_ess_cert_id_digest(conf,lVar14,lVar13),
                             iVar10 != 0)) &&
                            (iVar10 = TS_CONF_set_def_policy(conf,lVar14,local_d8,lVar13),
                            iVar10 != 0)) &&
                           ((iVar10 = TS_CONF_set_policies(conf,lVar14,lVar13), iVar10 != 0 &&
                            (iVar10 = TS_CONF_set_digests(conf,lVar14,lVar13), iVar10 != 0)))) &&
                          ((iVar10 = TS_CONF_set_accuracy(conf,lVar14,lVar13), iVar10 != 0 &&
                           ((iVar10 = TS_CONF_set_clock_precision_digits(conf,lVar14,lVar13),
                            iVar10 != 0 &&
                            (iVar10 = TS_CONF_set_ordering(conf,lVar14,lVar13), iVar10 != 0)))))) &&
                         ((iVar10 = TS_CONF_set_tsa_name(conf,lVar14,lVar13), iVar10 != 0 &&
                          ((iVar10 = TS_CONF_set_ess_cert_id_chain(conf,lVar14,lVar13), iVar10 != 0
                           && (lVar14 = TS_RESP_create_response(lVar13,pBVar12), lVar14 != 0)))))) {
...
LAB_00100ed7:
                ...
                if (local_110 != (BIO *)0x0) {
                  ...
                  if ((pPVar19 == (PKCS7 *)0x0) ||
                     (lVar13 = PKCS7_to_TS_TST_INFO(pPVar19), lVar13 == 0)) {
                    lVar18 = 0;
                    lVar14 = 0;
                    lVar13 = 0;
                  }
                    ...
                    if (lVar14 == 0) {
                      ...
                      if (((lVar18 != 0) &&
                          (iVar10 = TS_STATUS_INFO_set_status(lVar18,0), iVar10 != 0)) &&
                         (iVar10 = TS_RESP_set_status_info(lVar14,lVar18), iVar10 != 0)) {
...
LAB_00100f67:
              if ((local_100 == (char *)0x0 && local_118 == (BIO *)0x0) && (local_108 != 0))
              goto LAB_00100720;
            }
            else {
              if (local_118 != (BIO *)0x0) {
LAB_00100f5b:
                if (local_100 != (char *)0x0) goto LAB_00100f67;
              }
              if (local_108 == 0) {
LAB_00100720:
                pm = (X509_VERIFY_PARAM *)0x0;
                if (iVar25 != 0) {
                  pm = param;
                }
...
LAB_001017c5:
                  ...
                  uVar9 = 0x4a;
LAB_001007e3:
                  TS_VERIFY_CTX_add_flags(lVar14,uVar9 | 1);
...
LAB_00100867:
                  ...
                  if ((iVar10 == 0) ||
                     ((local_b0 != 0 &&
                      ((lVar18 = load_certs_multifile(local_b0,0,"extra untrusted certs",pm),
                       lVar18 == 0 ||
                       (iVar10 = TS_VERIFY_CTX_set0_certs(lVar14,lVar18), iVar10 == 0))))))
                  goto LAB_001017cf;
                  BIO_free_all(local_118);
                  TS_REQ_free(lVar13);
                  if (bVar5) {
...
LAB_00100caa:
      ...
      if (0x1b < iVar6) {
        if (0x644 < iVar6) {
          if (iVar6 - 0x7d1U < 0x1e) {
            iVar8 = opt_verify(iVar6,param);
            if (iVar8 == 0) break;
            iVar25 = iVar25 + 1;
          }
        ...
        if (iVar6 < 0x641) {
          if (1 < iVar6 - 0x5ddU) goto switchD_00100556_caseD_0;
          iVar8 = opt_rand(iVar6);
        }
        else {
          iVar8 = opt_provider(iVar6);
        }
        if (iVar8 == 0) break;
        goto switchD_00100556_caseD_0;
      }
      if (iVar6 < -1) goto switchD_00100556_caseD_0;
      switch(iVar6) {
      default:
        goto switchD_00100556_caseD_0;
      case 1:
...
LAB_0010150a:
    iVar10 = TS_REQ_set_cert_req(lVar13,local_7c);
    lVar14 = lVar13;
    if (iVar10 == 0) goto LAB_00101670;
  }

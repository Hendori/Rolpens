...
LAB_00100768:
    ...
    if (param_1 == 0x72) {
      if (__n_00 != 0x24) {
        ...
        uVar8 = 0x179;
LAB_001008a9:
        ERR_set_debug("crypto/rsa/rsa_sign.c",uVar8,"ossl_rsa_verify");
...
LAB_00100643:
        local_70 = (long *)((__n_00 - __n) + (long)to);
      }
      else {
        if (param_4 != (long *)0x0) {
          if (param_1 == 0x2a3) {
switchD_0010086c_caseD_448:
            __n = 0x1c;
          }
          else if (param_1 < 0x2a4) {
            if (param_1 == 0x2a0) {
switchD_0010086c_caseD_447:
              __n = 0x20;
            }
...
LAB_00100950:
      ...
      else if ((local_50 == __n_00) && (iVar5 = memcmp(local_48,to,__n_00), iVar5 == 0)) {
        if (param_4 != (long *)0x0) {

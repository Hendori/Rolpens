    ...
    if (iVar2 != 0) {
      do {
        if (param_1 < 1) {
          ...
          lVar8 = 0;
          do {
            iVar3 = SSL_write(local_60,(void *)((long)&local_54 + lVar8),10 - iVar2);
            if (iVar3 < 1) {
              uVar4 = SSL_get_error(local_60,iVar3);
              if ((uVar4 & 0xfffffffb) == 1) goto LAB_001007cb;
            }
            else {
              iVar2 = iVar2 + iVar3;
              lVar8 = (long)iVar2;
          ...
          iVar2 = test_size_t_eq("test/sslbuffertest.c",0x8d,&_LC29,"sizeof(testdata)",lVar8);
          if (iVar2 == 0) goto LAB_00100807;
LAB_00100b3c:
          iVar2 = 0;
          uVar6 = 0;
          lVar7 = 0;
          do {
            iVar3 = SSL_read(local_68,local_4a + lVar7,10 - iVar2);
            if (iVar3 < 1) {
              uVar4 = SSL_get_error(local_68,iVar3);
              if ((uVar4 & 0xfffffffb) == 1) goto LAB_00100bad;
            }
            else {
              iVar2 = iVar2 + iVar3;
              lVar7 = (long)iVar2;
          ...
          do {
            ...
            if (*(long *)(local_60[4].max_cert_list + 0x6a0) == 0) {
              bVar9 = *(long *)(*(long *)&local_60[4].first_packet + 0x60) == 0;
            }
            iVar3 = test_true("test/sslbuffertest.c",0x72,"checkbuffers(clientssl, 0)",bVar9);
            if (iVar3 == 0) goto LAB_00100807;
            if (param_1 != 1) {
              ...
              iVar3 = test_true("test/sslbuffertest.c",0x75,"checkbuffers(clientssl, 1)",bVar9);
              if (iVar3 == 0) goto LAB_00100807;
              if (param_1 != 2) {
                iVar3 = SSL_alloc_buffers();
                ...
                iVar3 = test_true("test/sslbuffertest.c",0x79,"checkbuffers(clientssl, 1)",bVar9);
                if (iVar3 == 0) goto LAB_00100807;
                if (param_1 != 3) {
                  ...
                  iVar3 = test_true("test/sslbuffertest.c",0x7c,"checkbuffers(clientssl, 0)",bVar9);
                  if (iVar3 == 0) goto LAB_00100807;
                }
              }
            }
            iVar3 = SSL_write(local_60,(void *)((long)&local_54 + (long)iVar2),10 - iVar2);
            if (iVar3 < 1) {
              uVar4 = SSL_get_error(local_60,iVar3);
              if ((uVar4 & 0xfffffffb) == 1) goto LAB_001007cb;
            }
          ...
          iVar2 = test_size_t_eq("test/sslbuffertest.c",0x8d,&_LC29,"sizeof(testdata)",(long)iVar2);
          if (iVar2 == 0) goto LAB_00100807;
          if (param_1 < 5) goto LAB_00100b3c;
          uVar6 = 0;
          iVar2 = 0;
          do {
            iVar3 = SSL_free_buffers(local_68);
            ...
            if (*(long *)(local_68[4].max_cert_list + 0x6a0) == 0) {
              bVar9 = *(long *)(*(long *)&local_68[4].first_packet + 0x60) == 0;
            }
            iVar3 = test_true("test/sslbuffertest.c",0x97,"checkbuffers(serverssl, 0)",bVar9);
            if (iVar3 == 0) goto LAB_00100807;
            if (param_1 != 5) {
              iVar3 = SSL_free_buffers();
              ...
              iVar3 = test_true("test/sslbuffertest.c",0x9b,"checkbuffers(serverssl, 0)",bVar9);
              if (iVar3 == 0) goto LAB_00100807;
              if (param_1 != 6) {
                iVar3 = SSL_alloc_buffers();
                ...
                iVar3 = test_true("test/sslbuffertest.c",0x9e,"checkbuffers(serverssl, 1)",bVar9);
                if (iVar3 == 0) goto LAB_00100807;
                if (param_1 != 7) {
                  iVar3 = SSL_free_buffers();
                  ...
                  iVar3 = test_true("test/sslbuffertest.c",0xa1,"checkbuffers(serverssl, 0)",bVar9);
                  if (iVar3 == 0) goto LAB_00100807;
                }
              }
            }
        ...
        iVar2 = test_mem_eq("test/sslbuffertest.c",0xb1,&_LC35,"testdata",local_4a,lVar7,&local_54,
                            10);
        if (iVar2 == 0) goto LAB_00100807;
        if (local_70 == 1) goto LAB_00100ee8;
        local_70 = 1;
      } while( true );
    }

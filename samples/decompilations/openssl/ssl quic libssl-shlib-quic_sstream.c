...
undefined8 * ossl_quic_sstream_new(ulong param_1)

{
  ...
  ptr_00 = (undefined8 *)CRYPTO_zalloc(0x58,"ssl/quic/quic_sstream.c",0x40);
  if (ptr_00 != (undefined8 *)0x0) {
    *ptr_00 = 0;
    ptr_00[3] = 0;
    *(undefined1 (*) [16])(ptr_00 + 1) = (undefined1  [16])0x0;
    if (param_1 == 0) {
LAB_0010013a:
      ossl_uint_set_init(ptr_00 + 4);
      ossl_uint_set_init(ptr_00 + 7);
      goto LAB_0010014c;
    }
    ptr_01 = CRYPTO_malloc((int)param_1,"include/internal/ring_buf.h",0xf4);
    if (ptr_01 != (void *)0x0) {
      uVar2 = ptr_00[3];
      uVar3 = ptr_00[2];
      ptr = (void *)*ptr_00;
...
LAB_00100111:
        ...
        uVar9 = uVar2;
        do {
          uVar5 = uVar4 - uVar9 % uVar4;
          uVar7 = uVar3 - uVar9;
          if (uVar5 < uVar3 - uVar9) {
            uVar7 = uVar5;
          }
          __src = (void *)((long)ptr + uVar9 % uVar4);
          if (uVar7 == 0) goto LAB_00100111;
          uVar9 = (param_1 + uVar2) - uStack_58;
          if (uVar7 < uVar9) {
            uVar9 = uVar7;
          }
...
LAB_001002d0:
          ...
          uVar5 = 0;
          do {
            __n = param_1 - uStack_58 % param_1;
            if (uVar9 < __n) {
              __n = uVar9;
            }
            memcpy((void *)((long)ptr_01 + uStack_58 % param_1),__src,__n);
            uStack_58 = uStack_58 + __n;
            __src = (void *)((long)__src + __n);
            uVar5 = uVar5 + __n;
            uVar6 = (param_1 + uVar2) - uStack_58;
          ...
          if (uVar7 != uVar5) goto LAB_001002d0;
          uVar8 = uVar8 + uVar7;
          uVar9 = uVar2 + uVar8;
        } while ((!CARRY8(uVar2,uVar8)) && (uVar9 <= uVar3));
      }
      CRYPTO_free(ptr_01);
    }
LAB_001000cc:
...
LAB_00100410:
    ...
    do {
      uVar8 = uVar8 + 1;
      plVar6 = (long *)*plVar6;
      if (param_2 <= uVar8) goto LAB_00100410;
...
LAB_001009a9:
    ...
    if (local_90 == 0) goto LAB_001009a9;
    lStack_50 = (uVar4 - 1) + local_90;
    local_58 = uVar4;
...
undefined8 ossl_quic_sstream_set_buffer_size(undefined8 *param_1,ulong param_2)
...
LAB_00100b32:
          if ((bVar1 >> 3 & 1) == 0) {
            ...
            CRYPTO_clear_free(ptr,uVar5,"include/internal/ring_buf.h",0x3a);
          }
          *param_1 = ptr_00;
          param_1[1] = param_2;
          param_1[2] = local_58;
        ...
        do {
          ...
          uVar11 = uVar4 - uVar9;
          if (uVar7 < uVar4 - uVar9) {
            uVar11 = uVar7;
          }
          __src = (void *)((long)ptr + uVar9 % uVar5);
          if (uVar11 == 0) goto LAB_00100b32;
          uVar9 = (param_2 + uVar3) - local_58;
          if (uVar11 < uVar9) {
            uVar9 = uVar11;
          }
...
LAB_00100ce0:
          ...
          do {
            ...
            __src = (void *)((long)__src + __n);
            uVar7 = uVar7 + __n;
            uVar8 = (param_2 + uVar3) - local_58;
            if (0x4000000000000000 - local_58 < uVar8) {
              uVar8 = 0x4000000000000000 - local_58;
            }
            uVar9 = uVar9 - __n;
            if (uVar8 <= uVar9) {
              uVar9 = uVar8;
          ...
          if (uVar11 != uVar7) goto LAB_00100ce0;
          uVar10 = uVar10 + uVar11;
          uVar9 = uVar3 + uVar10;
        } while ((uVar9 <= uVar4) && (!CARRY8(uVar3,uVar10)));
      }
      CRYPTO_free(ptr_00);
    }
LAB_00100a90:
  ...
  if (param_3 != 0) {
    ...
    do {
      while (uVar3 = uVar2 + *(long *)(param_2 + 8), uVar2 < param_1) {
        if (uVar3 <= param_1) goto LAB_00100de0;
        lVar4 = param_2 + 0x10;

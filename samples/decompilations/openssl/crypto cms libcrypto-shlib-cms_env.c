...

{
  ...
  iVar2 = EVP_PKEY_is_a(pEVar3,&_LC1);
  if ((iVar2 != 0) || (iVar2 = EVP_PKEY_is_a(pEVar3,&_LC2), iVar2 != 0)) {
    uVar4 = ossl_cms_dh_envelope(param_1,param_2);
    return uVar4;
  }
  iVar2 = EVP_PKEY_is_a(pEVar3,&_LC3);
  if (iVar2 != 0) {
...
LAB_001004b7:
      ...
      else if (iVar1 == 3) goto LAB_001004b7;
    }
    iVar7 = iVar7 + 1;
  } while( true );
}
...
LAB_00100e99:
      ...
      if (keylen == (long)nid * 8 - 0x1890U) goto LAB_00100c93;
      ERR_new();
      uVar8 = 0x2df;
LAB_00100c34:
      ERR_set_debug("crypto/cms/cms_env.c",uVar8,"CMS_add0_recipient_key");
...

{
  ...
  if (potherid == (ASN1_OBJECT **)0x0) {
    ...
    if (puVar1 == (undefined8 *)0x0) goto LAB_00100f4e;
  }
  else {
    puVar1 = (undefined8 *)puVar1[2];
    if (puVar1 == (undefined8 *)0x0) {
...
LAB_00101232:
            ...
            if (lVar13 != 0x18) {
              if (lVar13 == 0x20) {
                pcVar11 = "AES-256-WRAP";
                goto LAB_00101427;
              }
              pcVar11 = "AES-128-WRAP";
              if (lVar13 == 0x10) goto LAB_00101427;
LAB_001011f2:
              ERR_new();
            ...
            pcVar11 = "AES-192-WRAP";
LAB_00101427:
            uVar4 = ossl_cms_ctx_get0_propq(uVar8);
            uVar8 = ossl_cms_ctx_get0_libctx(uVar8);
            pEVar12 = (EVP_CIPHER *)EVP_CIPHER_fetch(uVar8,pcVar11,uVar4);
            if (pEVar12 == (EVP_CIPHER *)0x0) goto LAB_001011f2;
...
LAB_00101540:
            ...
            iVar3 = EVP_DecryptInit_ex(ctx,pEVar12,(ENGINE *)0x0,*(uchar **)(lVar6 + 0x20),
                                       (uchar *)0x0);
            if (iVar3 == 0) {
LAB_00101520:
              ERR_new();
    ...
    if (*(long *)(lVar9 + 0x28) == 0) {
      ...
      if ((*(int *)(*(long *)(*(long *)(cms + 8) + 0x18) + 0x44) != 0) &&
        ...
        if (pEVar10 == (EVP_CIPHER *)0x0) {
          ...
          pEVar12 = EVP_get_cipherbyname(pcVar11);
        ...
        ERR_pop_to_mark();
        iVar2 = EVP_CIPHER_get_key_length(pEVar12);
        lVar13 = (long)iVar2;
  ...
  if (uVar1 == 2) {
    ...
    if (lVar5 != 0) {
      ...
      if (*(long *)(lVar8 + 0x20) != 0) {
        ...
        if (lVar2 == 0x18) {
          pcVar10 = "AES-192-WRAP";
LAB_00101800:
          uVar6 = ossl_cms_ctx_get0_propq(uVar7);
          uVar7 = ossl_cms_ctx_get0_libctx(uVar7);
          cipher = (EVP_CIPHER *)EVP_CIPHER_fetch(uVar7,pcVar10,uVar6);
          if (cipher == (EVP_CIPHER *)0x0) goto LAB_00101a28;
          puVar11 = (uchar *)CRYPTO_malloc((int)*(undefined8 *)(lVar5 + 0x28) + 8,
...
LAB_001018cb:
          ...
          iVar3 = EVP_EncryptInit_ex(ctx,cipher,(ENGINE *)0x0,*(uchar **)(lVar8 + 0x20),(uchar *)0x0
                                    );
          if (iVar3 == 0) {
LAB_001018ab:
            ERR_new();
            uVar7 = 0x392;
LAB_001018bc:
            ERR_set_debug("crypto/cms/cms_env.c",uVar7,"cms_RecipientInfo_kekri_encrypt");
            uVar7 = 0x9f;
            goto LAB_001018cb;
          }
          iVar3 = EVP_EncryptUpdate(ctx,puVar11,&local_4c,*(uchar **)(lVar5 + 0x20),
                                    *(int *)(lVar5 + 0x28));
          if (iVar3 == 0) goto LAB_001018ab;
          iVar3 = EVP_EncryptFinal_ex(ctx,puVar11 + local_4c,local_48);
          if (iVar3 == 0) goto LAB_001018ab;
          ...
          ASN1_STRING_set0(*(ASN1_STRING **)(lVar8 + 0x18),puVar11,local_4c);
          uVar4 = 1;
          EVP_CIPHER_free(cipher);
        }
        else {
          if (lVar2 == 0x20) {
            pcVar10 = "AES-256-WRAP";
            goto LAB_00101800;
          }
          pcVar10 = "AES-128-WRAP";
          if (lVar2 == 0x10) goto LAB_00101800;
LAB_00101a28:
          ERR_new();
...
LAB_00101748:
    ...
    if (ctx_00 == (EVP_PKEY_CTX *)0x0) {
      uVar9 = ossl_cms_ctx_get0_propq(uVar7);
      uVar6 = *(undefined8 *)(lVar5 + 0x28);
      uVar7 = ossl_cms_ctx_get0_libctx(uVar7);
      ctx_00 = (EVP_PKEY_CTX *)EVP_PKEY_CTX_new_from_pkey(uVar7,uVar6,uVar9);
      if (ctx_00 == (EVP_PKEY_CTX *)0x0) goto LAB_00101778;
      iVar3 = EVP_PKEY_encrypt_init(ctx_00);
      if (0 < iVar3) goto LAB_00101948;
      puVar11 = (uchar *)0x0;
    }
    else {
      ...
      if (iVar3 != 0) {
LAB_00101948:
        iVar3 = EVP_PKEY_encrypt(ctx_00,(uchar *)0x0,(size_t *)local_48,*(uchar **)(lVar8 + 0x20),
                                 *(size_t *)(lVar8 + 0x28));
        puVar11 = (uchar *)0x0;
        if (0 < iVar3) {
          ...
          puVar11 = out;
          if (out != (uchar *)0x0) {
            iVar3 = EVP_PKEY_encrypt(ctx_00,out,(size_t *)local_48,*(uchar **)(lVar8 + 0x20),
                                     *(size_t *)(lVar8 + 0x28));
            if (0 < iVar3) {
              uVar4 = 1;
              puVar11 = (uchar *)0x0;
  ...
  if (*(long *)(lVar2 + 0x18) == 0) {
    ...
    if (bp != (BIO *)0x0) {
      ...
      if (local_48 != (EVP_CIPHER_CTX *)0x0) {
        ...
        if ((uVar6 & 0x2000000) == 0) goto LAB_00101c95;
        iVar7 = EVP_CIPHER_CTX_ctrl(local_48,0x28,0,*(void **)(*(long *)(param_1 + 8) + 0x20));
        if (0 < iVar7) goto LAB_00101c95;
      }
      BIO_free(bp);
    }
  }
...

{
  ...
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  iVar2 = EVP_PKEY_is_a(param_1,&_LC2);
  if (iVar2 == 0) {
    iVar2 = EVP_PKEY_is_a(param_1,&_LC1);
    if (iVar2 == 0) {
      ...
      iVar2 = EVP_PKEY_is_a(param_1,&_LC3);
      if (iVar2 == 0) {
    ...
    if (val != (ASN1_VALUE *)0x0) {
      ...
      if (iVar2 == 0) {
        ...
        *(ASN1_VALUE **)(val + 8) = pAVar7;
        if (pAVar7 == (ASN1_VALUE *)0x0) goto LAB_00102392;
        *(undefined4 *)val = 0;
        ...
        *(uint *)pAVar7 = -(uint)((param_5 & 0x10000) != 0) & 2;
        ...
        if ((iVar2 == 0) || (iVar2 = X509_up_ref(param_2), iVar2 == 0)) goto LAB_00102392;
        ...
        *(X509 **)(pAVar7 + 0x20) = param_2;
        ...
        if (iVar2 == 0) goto LAB_00102392;
        iVar2 = OPENSSL_sk_push(psVar4,val,uVar3,0x102355);
      }
      if (iVar2 != 0) {
        return val;
      }

...

{
  ...
  if ((lVar3 == 0) || (lVar1 = *(long *)(param_2 + 0x388), lVar1 == 0)) {
    ...
    if (uVar2 < *(ulong *)(lVar3 + 0x2e8)) {
      ...
      if (uVar2 < *(ulong *)(lVar1 + 0x2e8)) {
        ...
        *(long *)(param_1 + 0x48) = param_2;
        ...
        for (lVar3 = *(long *)(lVar3 + 0x390); lVar3 != param_1 + 0x48;
            lVar3 = *(long *)(lVar3 + 0x390)) {
...

{
  ...
  if ((c->tlsext_tick_lifetime_hint != 0) &&
     (uVar1._0_4_ = param_1[1].quiet_shutdown, uVar1._4_4_ = param_1[1].max_send_fragment,
     iVar6 = CRYPTO_THREAD_write_lock(uVar1), iVar6 != 0)) {
    ...
    if (lVar7 != 0) {
      ...
      if ((puVar2 != (undefined1 *)0x0) &&
         (puVar3 = *(undefined1 **)(ses[1].krb5_client_princ + 0xa0), puVar3 != (undefined1 *)0x0))
      {
      ...
      c[1].session_id[0x11] = '\0';
      c[1].session_id[0x12] = '\0';
      c[1].session_id[0x13] = '\0';
...
LAB_001012a0:
    lVar9 = OPENSSL_LH_retrieve(s->session_cache_head,c);
...
LAB_00101014:
    ...
    if ((puVar2 != (undefined1 *)0x0) &&
       (puVar3 = *(undefined1 **)(pSVar6[1].krb5_client_princ + 0xa0), puVar3 != (undefined1 *)0x0))
    {
...
LAB_001010a2:
  ...
  if (0 < lVar9) {
    while( true ) {
      ...
      if (((lVar9 < lVar7) || (lVar9 = s->session_timeout, lVar9 == 0)) ||
         (*(long *)(lVar9 + 0x250) == 0)) goto LAB_0010110e;
  ...
  if (ses != (SSL_SESSION *)0x0) {
    if (param_2 == 0) {
      do {
        ...
        if ((lVar1 != 0) && (lVar2 = *(long *)(ses[1].krb5_client_princ + 0xa0), lVar2 != 0)) {
        ...
        if ((lVar4 == 0) || (iVar3 = OPENSSL_sk_push(lVar4,ses), iVar3 == 0)) {
          SSL_SESSION_free(ses);
        }
        ses = *(SSL_SESSION **)(param_1 + 0x48);
      ...
      do {
        while( true ) {
          if ((ulong)(param_2 * 1000000000) <= *(ulong *)ses[1].krb5_client_princ)
          goto LAB_0010226e;
          OPENSSL_LH_delete(*(undefined8 *)(param_1 + 0x30),ses);
          lVar1 = *(long *)(ses[1].krb5_client_princ + 0xa8);
          if ((lVar1 != 0) && (lVar2 = *(long *)(ses[1].krb5_client_princ + 0xa0), lVar2 != 0)) {
...
LAB_0010226e:
  OPENSSL_LH_set_down_load(*(undefined8 *)(param_1 + 0x30),uVar5);
...
LAB_001026a4:
      ...
      ssl_clear_bad_session(pSVar2);
      if (((SSL_METHOD *)to->rbio != (SSL_METHOD *)to->wbio) &&
         (iVar1 = SSL_set_ssl_method(to,(SSL_METHOD *)to->rbio), iVar1 == 0)) goto LAB_001026a4;

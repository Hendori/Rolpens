...

{
  ...
  if ((byte *)*param_2 != (byte *)0x0) {
    ...
    if (bVar2 - 1 < 5) {
      ...
      if ((iVar12 == 4) ||
         (iVar11 = ossl_qrl_enc_level_set_have_el(param_1 + 0x10,iVar12), iVar11 != 1))
      goto LAB_0010049c;
    }
    else {
...
LAB_00100a30:
    ...
    if (iVar11 == 0) {
      if ((pvVar7 != (void *)0x0) && (iVar11 = BIO_ADDR_family(pvVar7), iVar11 != 0))
      goto LAB_00100c11;
LAB_00100c30:
      __s2 = (void *)param_2[4];
      ...
      if (iVar11 == 0) {
        if ((__s2 != (void *)0x0) && (iVar11 = BIO_ADDR_family(__s2), iVar11 != 0))
        goto LAB_00100c6a;
LAB_00100c82:
        bVar9 = true;
        pauVar18 = *(undefined1 (**) [16])(param_1 + 0x3b0);
      ...
      if (__s2 != (void *)0x0) {
LAB_00100c6a:
        iVar11 = memcmp(pvVar7,__s2,0x70);
        if (iVar11 == 0) goto LAB_00100c82;
      }
    }
    else if (pvVar7 != (void *)0x0) {
LAB_00100c11:
      iVar11 = memcmp(pauVar18 + 2,pvVar7,0x70);
...
LAB_00100466:
    ...
    do {
      if (pauVar18 == (undefined1 (*) [16])0x0) {
        ...
        if (pauVar18 == (undefined1 (*) [16])0x0) {
          if ((0xfffffffffffffefe < uVar23) ||
             (pauVar18 = (undefined1 (*) [16])
                         CRYPTO_malloc((int)uVar23 + 0x100,"ssl/quic/quic_record_tx.c",0xe0),
             pauVar18 == (undefined1 (*) [16])0x0)) break;
...
LAB_00100a9e:
        ...
        iVar11 = (**(code **)(param_1 + 0x3d0))
                           (pbVar24,lVar21,uVar23,&local_e0,&local_d8,&local_d0,
...
LAB_0010057f:
      ...
      if (uVar20 <= uVar22) {
        ...
        *(long *)(pbVar24 + 0x48) = local_c8;
        ...
        if (((*pbVar24 & 0xfd) != 4) &&
           (iVar11 = ossl_quic_wire_encode_pkt_hdr_pn
                               (param_2[5],pbVar24 + 0x32,pbVar24[1] >> 2 & 0xf), iVar11 == 0))
        goto LAB_00100a53;
            ...
            if (7 < iVar12) {
              ...
              *(ulong *)((long)&uStack_60 + lVar25) =
              ...
              if (iVar12 == 1) {
                ...
                lVar13 = 0;
                iVar12 = EVP_CipherUpdate(ctx,(uchar *)0x0,(int *)&local_c0,in,
                                          (int)lVar14 - local_108);
                uVar20 = 0;
...
LAB_00100e96:
    ...
    iVar12 = EVP_CipherUpdate(ctx,pauVar18[0x10] + *(long *)pauVar18[1],(int *)&local_c0,
                              (uchar *)(lVar13 + *plVar15),(int)lVar25);
    if (iVar12 != 1) {
      ERR_new();
      uVar17 = 0x230;
      goto LAB_00100e03;
...
LAB_00100efa:
  iVar12 = EVP_CipherFinal_ex(ctx,(uchar *)0x0,local_98);
  if (iVar12 == 1) {
    iVar12 = EVP_CIPHER_CTX_ctrl(ctx,0x10,*(int *)(lVar26 + 100),
                                 pauVar18[0x10] + *(long *)pauVar18[1]);
    if (iVar12 != 1) {
      ERR_new();
      uVar17 = 0x245;
      goto LAB_00100e03;

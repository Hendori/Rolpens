...

{
  ...
  if (((param_1 == 0) || (param_2 == (ASN1_STRING *)0x0)) ||
     (puVar2 = (undefined8 *)OSSL_CRMF_ATTRIBUTETYPEANDVALUE_new(), puVar2 == (undefined8 *)0x0)) {
    puVar2 = (undefined8 *)0x0;
    goto LAB_00100922;
  }
  pAVar3 = OBJ_nid2obj(0x141);
  *puVar2 = pAVar3;
  if (pAVar3 == (ASN1_OBJECT *)0x0) goto LAB_00100922;
  pAVar4 = ASN1_STRING_dup(param_2);
  puVar2[1] = pAVar4;
  if (pAVar4 == (ASN1_STRING *)0x0) goto LAB_00100922;
  if (*(long *)(param_1 + 0x10) == 0) {
    lVar5 = OPENSSL_sk_new_null();
    *(long *)(param_1 + 0x10) = lVar5;
    if (lVar5 == 0) goto LAB_00100938;
    iVar1 = OPENSSL_sk_push(lVar5,puVar2);
    if (iVar1 != 0) {
      return 1;
    }
    *(undefined8 *)(param_1 + 0x10) = 0;
    ...
    iVar1 = OPENSSL_sk_push(*(long *)(param_1 + 0x10),puVar2);
    if (iVar1 != 0) {
      return 1;
    }
LAB_00100938:
...

{
  ...
  *puVar2 = pAVar3;
  if (pAVar3 == (ASN1_OBJECT *)0x0) goto LAB_00100a62;
  lVar4 = OSSL_CRMF_CERTREQUEST_dup(param_2);
  puVar2[1] = lVar4;
  if (lVar4 == 0) goto LAB_00100a62;
  if (*(long *)(param_1 + 0x10) == 0) {
    lVar4 = OPENSSL_sk_new_null();
    *(long *)(param_1 + 0x10) = lVar4;
    if (lVar4 == 0) goto LAB_00100a78;
    iVar1 = OPENSSL_sk_push(lVar4,puVar2);
    if (iVar1 != 0) {
      return 1;
    }
    *(undefined8 *)(param_1 + 0x10) = 0;
...

{
  ...
  if ((param_1 == (long *)0x0) || ((undefined8 *)*param_1 == (undefined8 *)0x0)) {
    ...
    if (iVar1 == 0) {
      ...
      if (local_18 < 0x80000000) goto LAB_00100c60;
      ERR_new();
...
LAB_00101a51:
    ...
    *param_5 = 0;
    ...
    if (cipher == (EVP_CIPHER *)0x0) {
      ...
      if (cipher != (EVP_CIPHER *)0x0) goto LAB_00101875;
...
LAB_00101fa0:
    ...
    if (pvVar3 == (void *)0x0) goto LAB_00101fa0;

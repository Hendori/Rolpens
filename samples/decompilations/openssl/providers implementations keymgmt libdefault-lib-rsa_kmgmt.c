...
undefined8 * rsapss_gen_init(undefined8 param_1,ulong param_2,undefined8 param_3)
      ...
      *ptr = uVar2;
      ...
      if (a != (BIGNUM *)0x0) {
        ...
        if (iVar1 != 0) {
          ptr[3] = 0x800;
          ptr[5] = 2;
          *(undefined4 *)(ptr + 2) = 0x1000;
          iVar1 = rsa_gen_set_params(ptr,param_3);
          if (iVar1 != 0) {
            return ptr;
          }
        }
...
undefined8 * rsa_gen_init(undefined8 param_1,ulong param_2,undefined8 param_3)

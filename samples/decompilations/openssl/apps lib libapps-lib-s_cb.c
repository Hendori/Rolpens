...

{
  ...
  if (param_2 != 0) {
    ...
    do {
      local_44 = local_44 + 1;
      uVar1 = SSL_check_chain(param_1,*(undefined8 *)(lVar5 + 0x28),*(undefined8 *)(lVar5 + 0x30),
...
LAB_00100684:
      if ((param_3 & 0xffff0000) == 0x50000) goto LAB_00100378;
...
void hexencode_part_0(undefined8 param_1)
...
LAB_00101620:
            BIO_puts(param_1,", ");
LAB_00101632:
            BIO_printf(param_1,"UNKNOWN (%d),",(ulong)uVar7);
            uVar1 = uVar6;
          }
        } while( true );
      }
  ...
  if (local_4c != 0x390) {
    if (local_4c < 0x391) {
      ...
      if (local_4c != 0x198) {
        if (local_4c < 0x199) {
          pcVar5 = "RSA";
          if ((local_4c != 6) && (pcVar5 = "DSA", local_4c != 0x74)) {
LAB_001016d2:
            pcVar5 = OBJ_nid2sn(local_4c);
          }
        }
      ...
      if (local_4c != 0x43f) {
        if (local_4c < 0x440) {
          pcVar5 = "gost2012_256";
          if ((local_4c != 0x3d3) && (pcVar5 = "gost2012_512", local_4c != 0x3d4))
          goto LAB_001016d2;
        }
        else {
          pcVar5 = "ed448";
...
bool args_excert(undefined4 param_1,undefined8 *param_2)
...

{
  ...
  if (-1 < iVar5) {
    ...
    if (lVar7 == 0) {
      ...
      if ((local_58 == 0) && (pcVar8 = "matched the EE", uVar6 != 0)) {
...
LAB_001037df:
      ...
      if (iVar1 != 0) {
LAB_001037ee:
        if (param_4 != (X509_STORE *)0x0) goto LAB_001036d6;
        goto LAB_001036e9;
      }
    }
    else {

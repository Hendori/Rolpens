...

{
  ...
  lVar1 = (-(ulong)(*(int *)(param_1 + 0x10) == 0) & 0xfffffffffffffff7) + 0x15 +
...

{
  ...
  lVar4 = (ulong)(*(int *)(param_1 + 0x104c) + 0x140) +
...
LAB_00101ba7:
          uVar6 = (**(code **)(*(long *)(param_1 + 0x1148) + 0x20))
                            (param_1,lVar7,lVar7,1,0,local_90);
          if ((int)uVar6 < 1) goto LAB_00101da8;
          uVar2 = *puVar11;
      ...
      *(undefined4 *)(param_1 + 0x10d4) = 0;
      if ((((local_c8 == lVar16) || (puVar11[1] != 0x17)) ||
          ((uVar2 = *(uint *)(param_1 + 0x14), (uVar2 & 0xfffffffd) != 0xfefd && uVar2 != 0x100 &&
           (1 < uVar2 - 0x302)))) || (*(long *)(param_1 + 0x1020) == 0)) goto LAB_00101c9a;
      ...
      if ((((uVar8 & 0x800000) == 0) || (*(long *)(param_1 + 0x6a0) == 0)) ||
         ((*(ulong *)(param_1 + 0x6c0) < 5 ||
           ...
           *pcVar9 != '\x17' ||
           (uVar1 = *(ushort *)(pcVar9 + 3), puVar17 = puVar11 + 0x12,
           *(ulong *)(param_1 + 0x6c0) < (ulong)(ushort)(uVar1 << 8 | uVar1 >> 8) + 5))))))
      goto LAB_00101c9a;
    } while( true );
  }
LAB_00101d9f:

...
LAB_001002ed:
              ...
              if (*(long *)((long)pvVar7 + uVar9 * 0x40 + 0x28) == 0) {
                lVar12 = 2;
                goto LAB_001002ed;
              }
              if (*(long *)((long)pvVar7 + uVar9 * 0x40 + 0x38) == 0) {
                lVar12 = 3;
                goto LAB_001002ed;
              }
LAB_001002b8:
...
undefined8 ossl_ht_flush(long param_1)

{
  ...
  if (plVar1 != (long *)0x0) {
    puVar2 = (undefined8 *)
             CRYPTO_aligned_alloc(0x400,0x40,plVar1 + 1,"crypto/hashtable/hashtable.c",0x9d);
...
LAB_00100818:
      *puVar2 = 0;
      ...
      for (uVar5 = (ulong)(((int)puVar2 -
                           (int)(undefined8 *)((ulong)(puVar2 + 1) & 0xfffffffffffffff8)) + 0x400U
...

{
  ...
  if (plVar2 != (long *)0x0) {
    puVar3 = (undefined8 *)
             CRYPTO_aligned_alloc(0x400,0x40,plVar2 + 1,"crypto/hashtable/hashtable.c",0x9d);
...
LAB_00100988:
      *puVar3 = 0;
      ...
      for (uVar5 = (ulong)(((int)puVar3 -
                           (int)(undefined8 *)((ulong)(puVar3 + 1) & 0xfffffffffffffff8)) + 0x400U
                          >> 3); uVar5 != 0; uVar5 = uVar5 - 1) {
        *puVar6 = 0;
        puVar6 = puVar6 + (ulong)bVar7 * -2 + 1;
      }
...
LAB_00100d6a:
      ...
      if (*(int *)(param_1 + 0x24) == 0) {
        ...
        do {
          ...
          if (lVar6 == 0) {
            ...
            if (uVar5 == local_48) {
              if (((*(void **)(lVar6 + 0x18) == (void *)0x0) || ((void *)local_50[3] == (void *)0x0)
                  ) || ((local_50[2] != *(size_t *)(lVar6 + 0x10) ||
                        (iVar3 = memcmp((void *)local_50[3],*(void **)(lVar6 + 0x18),local_50[2]),
                        iVar3 == 0)))) goto LAB_00100ffe;
            }
      ...
      do {
        ...
        while( true ) {
          ...
          if (iVar3 == 0) goto LAB_00101010;
          if (uVar5 == local_48) {
            if (((((void *)local_50[3] == (void *)0x0) || (*(void **)(lVar6 + 0x18) == (void *)0x0))
                || (local_50[2] != *(size_t *)(lVar6 + 0x10))) ||
               (iVar3 = memcmp((void *)local_50[3],*(void **)(lVar6 + 0x18),local_50[2]), iVar3 == 0
               )) goto LAB_00100ffe;
          }
          lVar9 = lVar9 + 1;
          lVar11 = lVar11 + 0x10;
...
LAB_00100ffe:
  ...
  if ((param_4 == (undefined8 *)0x0) ||
     (iVar3 = CRYPTO_atomic_store(lVar12 + lVar10 + *plVar2,uVar5,*(undefined8 *)(param_1 + 0x30)),
     iVar3 == 0)) goto LAB_00101010;
  lVar6 = *plVar2;
...
LAB_00100ece:
    local_6c = local_6c + -1;
    if ((local_6c == 0) ||
       (iVar3 = grow_hashtable(param_1,*(undefined8 *)(param_1 + 0x40)), iVar3 == 0))
    goto LAB_00100ef0;
    goto LAB_00100d6a;
  }
LAB_0010116e:
  ...
  if (iVar1 != 0) {
    ...
    do {
      ...
      while( true ) {
        ...
        if ((lVar4 == 0) ||
           (iVar1 = CRYPTO_atomic_load(local_60 * 0x40 + -8 + lVar6 + *plVar3,&local_48,
                                       *(undefined8 *)(param_1 + 0x30)), iVar1 == 0))
        goto LAB_00101278;
        if (local_48 == uVar2) {
          if ((((void *)param_2[1] == (void *)0x0) || (*(void **)(lVar4 + 0x18) == (void *)0x0)) ||
             ((*(size_t *)(lVar4 + 0x10) != *param_2 ||
              (iVar1 = memcmp(*(void **)(lVar4 + 0x18),(void *)param_2[1],*(size_t *)(lVar4 + 0x10))
              , iVar1 == 0)))) goto LAB_0010127b;
        }
        lVar6 = lVar6 + 0x10;
        if (lVar6 == 0x48) break;
        lVar4 = *plVar3;
...
LAB_0010127b:
  ...
  do {
    ...
    if (lVar4 != 0) {
      iVar1 = CRYPTO_atomic_load(uVar5 * 0x40 + -8 + lVar6 + *plVar3,&local_48,
...
LAB_00101439:
    ...
    if ((uVar6 != 0) && (puVar7[6] == uVar2)) {
      if ((*(void **)(uVar6 + 0x18) == (void *)0x0) ||
         ((((void *)param_2[1] == (void *)0x0 || (*param_2 != *(size_t *)(uVar6 + 0x10))) ||
          (iVar1 = memcmp((void *)param_2[1],*(void **)(uVar6 + 0x18),*param_2), iVar1 == 0)))) {
        lVar4 = 3;
        goto LAB_001014b0;
      }
    }
...
LAB_001014b0:
    iVar1 = CRYPTO_atomic_store(puVar7 + lVar4 * 2,0,*(undefined8 *)(param_1 + 0x30));
    if (iVar1 != 0) {
      *(long *)(param_1 + 0x48) = *(long *)(param_1 + 0x48) + -1;

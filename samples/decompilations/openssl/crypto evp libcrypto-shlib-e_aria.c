...

{
  ...
  case 0x11:
    ...
    if (param_3 < 8) {
      ...
      *(undefined8 *)((long)puVar10 + (uVar13 - 8)) = *(undefined8 *)((long)param_4 + (uVar13 - 8));
      ...
      uVar6 = (int)lVar11 + param_3 & 0xfffffff8;
      if (7 < uVar6) {
        uVar13 = 0;
        do {
          uVar12 = (int)uVar13 + 8;
          *(undefined8 *)(((ulong)(puVar10 + 1) & 0xfffffffffffffff8) + uVar13) =
               *(undefined8 *)((long)param_4 + (uVar13 - lVar11));
          uVar13 = (ulong)uVar12;
        } while (uVar12 < uVar6);
      }
    }
  ...
  case 0x13:
    ...
    memcpy(param_4,(void *)(((long)(int)uVar6 - (long)(int)uVar12) + *(long *)(lVar7 + 0x2e0)),
           (long)(int)uVar12);
    lVar11 = *(long *)(lVar7 + 0x2e0);
    lVar9 = (long)*(int *)(lVar7 + 0x2e8);
    pcVar1 = (char *)(lVar11 + -1 + lVar9);
    *pcVar1 = *pcVar1 + '\x01';
    if (*pcVar1 == '\0') {
      pcVar1 = (char *)(lVar11 + -2 + lVar9);
      *pcVar1 = *pcVar1 + '\x01';
      if (*pcVar1 == '\0') {
        pcVar1 = (char *)(lVar11 + -3 + lVar9);
        *pcVar1 = *pcVar1 + '\x01';
        if (*pcVar1 == '\0') {
          pcVar1 = (char *)(lVar11 + -4 + lVar9);
          *pcVar1 = *pcVar1 + '\x01';
          if (*pcVar1 == '\0') {
            pcVar1 = (char *)(lVar11 + -5 + lVar9);
            *pcVar1 = *pcVar1 + '\x01';
            if (*pcVar1 == '\0') {
              pcVar1 = (char *)(lVar11 + -6 + lVar9);
              *pcVar1 = *pcVar1 + '\x01';
              if (*pcVar1 == '\0') {
                pcVar1 = (char *)(lVar11 + -7 + lVar9);
                *pcVar1 = *pcVar1 + '\x01';
                if (*pcVar1 == '\0') {
                  pcVar1 = (char *)(lVar11 + -8 + lVar9);
                  *pcVar1 = *pcVar1 + '\x01';
                }
              }
            }
...
undefined8 aria_192_ecb_cipher(undefined8 param_1,long param_2,long param_3,ulong param_4)
...
undefined8 aria_256_ecb_cipher(undefined8 param_1,long param_2,long param_3,ulong param_4)
...
undefined8 aria_192_cfb128_cipher(long param_1,long param_2,long param_3,ulong param_4)
...
undefined8 aria_256_cfb128_cipher(long param_1,long param_2,long param_3,ulong param_4)
...
undefined8 aria_192_cfb8_cipher(long param_1,long param_2,long param_3,ulong param_4)
...
undefined8 aria_256_cfb8_cipher(long param_1,long param_2,long param_3,ulong param_4)

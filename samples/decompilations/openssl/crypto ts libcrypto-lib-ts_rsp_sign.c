...

{
  if (param_1 != (undefined8 *)0x0) {
    ...
    ASN1_INTEGER_free((ASN1_INTEGER *)param_1[9]);
    ASN1_INTEGER_free((ASN1_INTEGER *)param_1[10]);
    CRYPTO_free(param_1);
    return;
  }
  return;
...
LAB_00100610:
    ...
    *(ASN1_INTEGER **)(param_1 + 0x48) = pAVar2;
    if ((pAVar2 != (ASN1_INTEGER *)0x0) &&
       (iVar1 = ASN1_INTEGER_set(pAVar2,(long)param_3), iVar1 != 0)) goto LAB_0010052d;
  }
  else {
    pAVar2 = ASN1_INTEGER_new();
...
LAB_0010052d:
    ...
    *(ASN1_INTEGER **)(param_1 + 0x50) = pAVar2;
    if ((pAVar2 != (ASN1_INTEGER *)0x0) &&
       (iVar1 = ASN1_INTEGER_set(pAVar2,(long)param_4), iVar1 != 0)) {
      return 1;
    }
  }
LAB_00100568:
  pAVar2 = *(ASN1_INTEGER **)(param_1 + 0x40);
LAB_0010056c:
...
LAB_00100702:
            iVar1 = OPENSSL_sk_push(lVar4,str);
...

{
  ...
  *(undefined1 (*) [16])(param_1 + 0x12) = (undefined1  [16])0x0;
  ...
  if (lVar8 == 0) {
    ...
    if (lVar8 == 0) {
LAB_00100f60:
      TS_RESP_CTX_set_status_info(param_1,2,pcVar19);
...
LAB_00100e09:
              lVar8 = TS_TST_INFO_new();
              if ((lVar8 == 0) ||
                 ((((iVar6 = TS_TST_INFO_set_version(lVar8,1), iVar6 == 0 ||
                    (iVar6 = TS_TST_INFO_set_policy_id(lVar8,pAVar10), iVar6 == 0)) ||
                   (iVar6 = TS_TST_INFO_set_msg_imprint(lVar8,*(undefined8 *)(param_1[0x12] + 8)),
                   iVar6 == 0)) ||
                  (a_00 = (ASN1_INTEGER *)(*(code *)param_1[0xc])(param_1,param_1[0xd]),
                ...
                if (iVar6 != 0) {
                  ...
                  if (uVar1 < 7) {
                    ...
                    if (puVar11 != (uint *)0x0) {
                      iVar6 = BIO_snprintf(local_78,0x17,"%04d%02d%02d%02d%02d%02d",
                                           (ulong)(puVar11[5] + 0x76c),(ulong)(puVar11[4] + 1),
                                           (ulong)puVar11[3],(ulong)puVar11[2],(ulong)puVar11[1],
                                           (ulong)*puVar11);
...
LAB_00101692:
                            ...
                            if (((param_1[8] == 0) && (param_1[9] == 0)) && (param_1[10] == 0)) {
                              lVar9 = 0;
LAB_00101246:
                              if ((((*(byte *)((long)param_1 + 0x5c) & 2) == 0) ||
                                  (iVar6 = TS_TST_INFO_set_ordering(lVar8,1), iVar6 != 0)) &&
                                 ((*(long *)(param_1[0x12] + 0x18) == 0 ||
                                  (iVar6 = TS_TST_INFO_set_nonce(lVar8), iVar6 != 0)))) {
                                if ((*(byte *)((long)param_1 + 0x5c) & 1) == 0) {
                                  a_01 = (GENERAL_NAME *)0x0;
LAB_0010127c:
                                  ...
                                  iVar6 = 0;
LAB_001012db:
                                  iVar7 = OPENSSL_sk_num(uVar20);
                                  if (iVar6 < iVar7) goto LAB_001012b8;
                                  iVar6 = X509_check_private_key
                                                    ((X509 *)*param_1,(EVP_PKEY *)param_1[1]);
                                  if (iVar6 == 0) {
                                    ERR_new();
...
LAB_00101641:
                                    ...
                                    if ((iVar6 == 0) ||
                                       (iVar6 = ASN1_INTEGER_set(((p7->d).sign)->version,3),
                                       iVar6 == 0)) {
                                      dgst = (EVP_MD *)0x0;
                                      bio = (BIO *)0x0;
                                      lVar8 = 0;
                                      ...
                                      if (*(int *)(param_1[0x12] + 0x20) != 0) {
                                        ...
                                        lVar8 = param_1[4];
                                        if (lVar8 != 0) {
                                          for (; iVar7 = OPENSSL_sk_num(lVar8), iVar6 < iVar7;
                                              iVar6 = iVar6 + 1) {
                                      ...
                                      if (param_1[2] == 0) {
                                        dgst = (EVP_MD *)
                                               EVP_MD_fetch(param_1[0x15],"SHA256",param_1[0x16]);
                                      }
                                      else {
                                      ...
                                      p7si = PKCS7_add_signature(p7,(X509 *)*param_1,
                                                                 (EVP_PKEY *)param_1[1],dgst);
                                      if (p7si != (PKCS7_SIGNER_INFO *)0x0) {
                                        ...
                                        if (iVar6 == 0) {
                                          ...
                                          lVar8 = 0;
                                          ERR_new();
                                          ERR_set_debug("crypto/ts/ts_rsp_sign.c",0x2dc,
                                                        "ts_RESP_sign");
                                        ...
                                        if ((param_1[3] == 0) ||
                                          ...
                                          if (pvVar12 != (void *)0x0) {
                                            ...
                                            if ((pAVar13 == (ASN1_STRING *)0x0) ||
                                               (iVar6 = ASN1_STRING_set(pAVar13,pvVar12,iVar6),
                                               iVar6 == 0)) {
                                              ...
                                              CRYPTO_free(pvVar12);
                                              iVar6 = PKCS7_add_signed_attribute
                                                                (p7si,0xdf,0x10,pAVar13);
                                              local_f8 = 0;
                                          ...
                                          ERR_new();
                                          bio = (BIO *)0x0;
                                          ERR_set_debug("crypto/ts/ts_rsp_sign.c",0x2e8,
                                                        "ts_RESP_sign");
                                          ERR_set_error(0x2f,0x74,0);
                                          local_f8 = 0;
                                          goto LAB_001015bf;
                                        }
                                        local_f8 = OSSL_ESS_signing_cert_v2_new_init
                                                             (param_1[3],*param_1,uVar20,0);
                                        if (local_f8 == 0) {
LAB_0010193a:
                                          lVar8 = 0;
                                          bio = (BIO *)0x0;
...
LAB_0010190e:
                                          ERR_new();
                                          ERR_set_debug("crypto/ts/ts_rsp_sign.c",0x2f2,
                                                        "ts_RESP_sign");
...
LAB_0010170d:
                                        ...
                                        if (bio == (BIO *)0x0) {
                                          ERR_new();
                                          ERR_set_debug("crypto/ts/ts_rsp_sign.c",0x2fa,
                                                        "ts_RESP_sign");
                                        ...
                                        if (iVar6 == 0) {
                                          ...
                                          uVar20 = 0x2fe;
LAB_00101a4e:
                                          ERR_set_debug("crypto/ts/ts_rsp_sign.c",uVar20,
                                                        "ts_RESP_sign");
...
LAB_001015cd:
                                  TS_RESP_CTX_set_status_info_cond
                                            (param_1,2,"Error during signature generation.");
                                  BIO_free_all(bio);
                                  ESS_SIGNING_CERT_V2_free(local_f8);
                                  ESS_SIGNING_CERT_free(lVar8);
                                  PKCS7_free(pPVar14);
                                ...
                                if (a_01 != (GENERAL_NAME *)0x0) {
                                  ...
                                  if ((pXVar18 != (X509_NAME *)0x0) &&
                                     (iVar6 = TS_TST_INFO_set_tsa(lVar8,a_01), iVar6 != 0))
                                  goto LAB_0010127c;
                                  goto LAB_00100e3d;
                                }
                              }
                              ...
                              lVar9 = TS_ACCURACY_new();
                              if (lVar9 == 0) goto LAB_00101692;
                              if ((((param_1[8] == 0) ||
                                   (iVar6 = TS_ACCURACY_set_seconds(lVar9), iVar6 != 0)) &&
                                  (((param_1[9] == 0 ||
                                    (iVar6 = TS_ACCURACY_set_millis(lVar9), iVar6 != 0)) &&
                                   ((param_1[10] == 0 ||
                                    (iVar6 = TS_ACCURACY_set_micros(lVar9), iVar6 != 0)))))) &&
                                 ((lVar9 == 0 ||
                                  (iVar6 = TS_TST_INFO_set_accuracy(lVar8,lVar9), iVar6 != 0))))
                              goto LAB_00101246;
                            }
                            a_01 = (GENERAL_NAME *)0x0;
                          }
...
LAB_00100bfc:
  ERR_new();
  ERR_set_debug("crypto/ts/ts_rsp_sign.c",0x198,"TS_RESP_create_response");
  ERR_set_error(0x2f,0x79,0);
  if (param_1[0x13] != 0) {
...
LAB_00100c55:
  param_1[0x13] = 0;
  TS_REQ_free(param_1[0x12]);
  param_1[0x12] = 0;
  TS_RESP_free(param_1[0x13]);
  param_1[0x13] = 0;
  TS_TST_INFO_free(param_1[0x14]);
  param_1[0x14] = 0;
  ...
  return uVar20;
LAB_001012b8:
  uVar16 = OPENSSL_sk_value(uVar20,iVar6);
  iVar7 = (*(code *)param_1[0x10])(param_1,uVar16,0);
  iVar6 = iVar6 + 1;
  if (iVar7 == 0) goto LAB_00100bfc;
  goto LAB_001012db;
}



undefined8 TS_RESP_CTX_set_ess_cert_id_digest(long param_1,undefined8 param_2)

...
void BN_consttime_swap(ulong param_1,long *param_2,undefined8 *param_3,uint param_4)

{
  ...
  uVar5 = (uint)uVar10;
  uVar4 = (*(uint *)(param_3 + 1) ^ *(uint *)(param_2 + 1)) & uVar5;
  *(uint *)(param_2 + 1) = *(uint *)(param_2 + 1) ^ uVar4;
  uVar1 = *(uint *)(param_2 + 2);
  *(uint *)(param_3 + 1) = *(uint *)(param_3 + 1) ^ uVar4;
  uVar4 = (*(uint *)(param_3 + 2) ^ uVar1) & uVar5;
  *(uint *)(param_2 + 2) = uVar1 ^ uVar4;
  uVar1 = *(uint *)((long)param_2 + 0x14);
  *(uint *)(param_3 + 2) = *(uint *)(param_3 + 2) ^ uVar4;
  uVar5 = (*(uint *)((long)param_3 + 0x14) ^ uVar1) & uVar5 & 4;
  *(uint *)((long)param_2 + 0x14) = uVar1 ^ uVar5;
  *(uint *)((long)param_3 + 0x14) = *(uint *)((long)param_3 + 0x14) ^ uVar5;
  if (0 < (int)param_4) {
    puVar2 = (ulong *)*param_2;
    puVar7 = (ulong *)*param_3;
    if ((param_4 == 1) || ((ulong)((long)puVar2 + (0xf - (long)puVar7)) < 0x1f)) {
      puVar3 = puVar2;
      do {
        puVar8 = puVar3 + 1;
        uVar6 = (*puVar7 ^ *puVar3) & uVar10;
        *puVar3 = *puVar3 ^ uVar6;
        *puVar7 = *puVar7 ^ uVar6;
        puVar7 = puVar7 + 1;
        puVar3 = puVar8;
      } while (puVar2 + (int)param_4 != puVar8);
    }
    else {
      puVar3 = puVar7;
      puVar8 = puVar2;
      do {
        puVar9 = puVar8 + 2;
        uVar6 = (*puVar3 ^ *puVar8) & uVar10;
        uVar11 = (puVar3[1] ^ puVar8[1]) & uVar10;
        *puVar8 = *puVar8 ^ uVar6;
        puVar8[1] = puVar8[1] ^ uVar11;
        *puVar3 = uVar6 ^ *puVar3;
        puVar3[1] = uVar11 ^ puVar3[1];
        puVar3 = puVar3 + 2;
        puVar8 = puVar9;
      } while (puVar2 + (ulong)(param_4 >> 1) * 2 != puVar9);
      if ((param_4 & 1) != 0) {
        puVar7 = puVar7 + (param_4 & 0xfffffffe);
        uVar6 = puVar2[param_4 & 0xfffffffe];
        uVar10 = (*puVar7 ^ uVar6) & uVar10;
        puVar2[param_4 & 0xfffffffe] = uVar6 ^ uVar10;
...

{
  ...
  if (lVar6 == 0) {
    ...
    if ((long)iVar4 != 0) {
      uVar5 = 0;
      pbVar2 = to + (long)iVar4 + -1;
      do {
        pbVar3 = pbVar2 + -1;
        *pbVar2 = (byte)(*(ulong *)((long)a->d + (uVar5 & 0xfffffffffffffff8)) >>
                        (sbyte)(((uint)uVar5 & 7) << 3)) &
                  (byte)((long)(to + (long)iVar4 + -1 + ((long)iVar1 * -8 - (long)pbVar2)) >> 0x3f);
        uVar5 = uVar5 - ((long)(uVar5 - (lVar6 + -1)) >> 0x3f);
        pbVar2 = pbVar3;
      } while (to + -1 != pbVar3);
    }
  }
...

{
  ...
  if (a->top < 1) {
    if (a->d == (ulong *)0x0) goto LAB_00100b90;
  }
  else {
  ...
  lVar2 = (long)a->dmax << 3;
  if (iVar1 == 0) {
    CRYPTO_clear_free(a->d,lVar2,"crypto/bn/bn_lib.c",0xd0);
  }
  else {
    CRYPTO_secure_clear_free(a->d,lVar2,"crypto/bn/bn_lib.c",0xce);
  }
LAB_00100b90:
  a->d = __dest;
  a->dmax = words;
...

{
  ...
  if (iVar2 == 0) {
    iVar2 = BN_get_flags(a,8);
    if (iVar2 == 0) {
      CRYPTO_free(a->d);
      bVar1 = (byte)a->flags;
      goto joined_r0x00100e79;
    }
    CRYPTO_secure_clear_free(a->d,(long)a->dmax << 3,"crypto/bn/bn_lib.c",0xce);
  }
  bVar1 = (byte)a->flags;
joined_r0x00100e79:
  if ((bVar1 & 1) == 0) {
...

{
  ...
  pbVar1 = param_1 + (long)param_2 + -1;
  if (param_4 == 1) {
    bVar5 = *pbVar1;
    lVar14 = 1;
    lVar7 = -1;
    pbVar4 = pbVar1;
    if (param_5 != 0) goto LAB_001013f3;
LAB_001012a4:
    uVar12 = (uint)(int)(char)bVar5 >> 0x1f;
    uVar13 = (int)(char)bVar5 >> 0x1f & 0xff;
    if (lVar7 == 1) goto LAB_001012c1;
LAB_00101403:
    do {
      if (*pbVar4 != uVar13) goto LAB_001012cd;
      pbVar4 = pbVar4 + -1;
      param_2 = param_2 + -1;
    } while (param_2 != 0);
  }
    ...
    pbVar4 = param_1;
    param_1 = pbVar1;
    if (param_5 == 0) goto LAB_001012a4;
LAB_001013f3:
    uVar13 = 0;
    uVar12 = 0;
    if (lVar7 != 1) goto LAB_00101403;
LAB_001012c1:
    do {
      if (uVar13 != *pbVar4) goto LAB_001012cd;
      pbVar4 = pbVar4 + 1;
      param_2 = param_2 + -1;
    } while (param_2 != 0);
  }
...
LAB_001012e5:
  ...
  if (lVar14 == 1) {
    do {
      ...
      uVar8 = 0;
      do {
        uVar3 = (ulong)((*param_1 ^ uVar13) + uVar12 & 0xff);
        uVar12 = (uint)(uVar3 < (ulong)(long)(int)(*param_1 ^ uVar13));
        bVar5 = (byte)uVar6;
        uVar6 = uVar6 + 8;
        param_2 = param_2 + -1;
        uVar8 = uVar8 | uVar3 << (bVar5 & 0x3f);
        param_1 = param_1 + 1;
        if (0x3f < uVar6) break;
      } while (0 < param_2);
      puVar2[uVar11] = uVar8;
      if (iVar10 == -1) goto LAB_001013c0;
      iVar10 = iVar10 + -1;
    ...
    do {
      ...
      uVar8 = 0;
      do {
        uVar3 = (ulong)(uVar12 + (*param_1 ^ uVar13) & 0xff);
        uVar12 = (uint)(uVar3 < (ulong)(long)(int)(*param_1 ^ uVar13));
        param_2 = param_2 + -1;
        param_1 = param_1 + -1;
        uVar8 = uVar8 | uVar3 << ((byte)uVar6 & 0x3f);
        uVar6 = uVar6 + 8;
        if (param_2 < 1) break;
      } while (uVar6 < 0x40);
      puVar2[uVar11] = uVar8;
...
int bn2binpad(BIGNUM *param_1,void *param_2,int param_3,int param_4,int param_5)

{
  ...
  iVar2 = iVar12;
  if ((param_3 != -1) && (iVar2 = param_3, param_3 < iVar12)) {
    ...
    if (param_3 < (int)((iVar12 >> 3) + uVar7)) {
      iVar2 = -1;
      goto LAB_001016f8;
    }
  }
  lVar10 = (long)(param_1->dmax * 8);
  if (lVar10 == 0) {
    if (iVar2 != 0) {
      ...
      if (iVar2 != 0) {
        ...
        do {
          bVar1 = (byte)(*(ulong *)((long)param_1->d + (uVar5 & 0xfffffffffffffff8)) >>
                        (sbyte)(((uint)uVar5 & 7) << 3)) & (byte)(lVar9 >> 0x3f) ^ bVar13;
          *(byte *)((long)param_2 + lVar9 + lVar8) = bVar1 + (byte)uVar6;
          lVar9 = lVar9 + 1;
          uVar6 = (uint)CARRY1(bVar1,(byte)uVar6);
          uVar5 = uVar5 - ((long)(uVar5 - (lVar10 + -1)) >> 0x3f);
        } while (lVar4 + (long)iVar12 * -8 != lVar9);
      }
    }
    else if (iVar2 != 0) {
      iVar12 = param_1->top;
      pcVar11 = (char *)((long)param_2 + lVar4 + -1);
      uVar5 = 0;
      lVar8 = -(long)(iVar12 * 8);
      do {
        bVar1 = (byte)(*(ulong *)((long)param_1->d + (uVar5 & 0xfffffffffffffff8)) >>
                      (sbyte)(((uint)uVar5 & 7) << 3)) & (byte)(lVar8 >> 0x3f) ^ bVar13;
        *pcVar11 = bVar1 + (byte)uVar6;
        lVar8 = lVar8 + 1;
        uVar6 = (uint)CARRY1(bVar1,(byte)uVar6);
        pcVar11 = pcVar11 + -1;
        uVar5 = uVar5 - ((long)(uVar5 - (lVar10 + -1)) >> 0x3f);
      } while (lVar4 + (long)iVar12 * -8 != lVar8);
    }
  }
LAB_001016f8:

  ...
  *(undefined4 *)(param_1 + 0x4b) = 0;
  if (param_3 == 0) {
    if (*param_1 == 0) {
      ...
      if (iVar1 != 0) {
        param_3 = *param_1;
        if (param_3 != 0) goto LAB_00100510;
        ERR_new();
...
LAB_001005d5:
    if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
      uVar2 = ml_dsa_set_ctx_params(param_1,param_4);
      return uVar2;
    }
  }
  else {
    ...
    if (iVar1 != 0) {
      *param_1 = param_3;
LAB_00100510:
      iVar1 = ossl_ml_dsa_key_matches(param_3,(int)param_1[0x29]);
      if (iVar1 != 0) {
        param_1[0x4a] = 0;
...
undefined4
ml_dsa_digest_sign(undefined8 *param_1,long param_2,undefined8 param_3,undefined8 param_4,
                  undefined8 param_5,undefined8 param_6)
...
undefined8 ml_dsa_sign_msg_init(long *param_1,long param_2,undefined8 param_3)
...
undefined8 ml_dsa_verify_msg_init(long *param_1,long param_2,undefined8 param_3)

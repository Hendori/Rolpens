...
LAB_00100040:
      ...
      *pbVar2 = bVar8;
      ...
      puVar5[-1] = puVar5[-1] & (byte)(0xff << bVar8);
      goto LAB_00100077;
    }
    lVar6 = (long)iVar3;
    do {
      ...
      if (*(char *)(*(long *)(param_1 + 2) + -1 + lVar6) != '\0') {
        bVar1 = *(byte *)(*(long *)(param_1 + 2) + lVar7);
        bVar8 = 0;
        if (((((bVar1 & 1) == 0) && (bVar8 = 1, (bVar1 & 2) == 0)) && (bVar8 = 2, (bVar1 & 4) == 0))
           && (((bVar8 = 3, (bVar1 & 8) == 0 && (bVar8 = 4, (bVar1 & 0x10) == 0)) &&
               ((bVar8 = 5, (bVar1 & 0x20) == 0 && (bVar8 = 6, (bVar1 & 0x40) == 0)))))) {
          bVar8 = -(bVar1 != 0) & 7;
        }
        goto LAB_00100040;
      }

...

{
  ...
  if (UNRECOVERED_JUMPTABLE_00 == (code *)0x0) {
    if ((param_3 == 2) && (0x7ff < iVar17)) {
      if ((param_4 == (BIGNUM *)0x0) || (iVar1 = BN_num_bits(param_4), 0x10 < iVar1)) {
        if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
LAB_00100933:
      iVar1 = ossl_rsa_multip_cap(iVar17);
      if (iVar1 < param_3) {
LAB_00100c8d:
        ERR_new();
        uVar5 = 0;
...
LAB_00100f1b:
                ...
                if (pBVar13 == (BIGNUM *)0x0) {
                  ...
                  if ((((uVar14 & 0x80000000) != 0) || ((char)(uVar14 >> 0x17) != '\x03')) ||
                     (((uint)uVar14 & 0x7fffff) != 0x6c)) goto LAB_00100b78;
                  ERR_pop_to_mark();
                ...
                if (iVar17 == 1) {
                  iVar2 = BN_mul(pBVar9,*(BIGNUM **)(param_1 + 0x40),*(BIGNUM **)(param_1 + 0x48),
                                 local_c8);
                }
                else {
                  if (iVar17 == 0) {
                    iVar17 = BN_GENCB_call(param_5,3,0);
                    if ((iVar17 == 0) || (pBVar11 = BN_dup(pBVar11), pBVar11 == (BIGNUM *)0x0))
                    goto LAB_00100b78;
                ...
                if ((iVar2 == 0) || (iVar2 = BN_rshift(r,pBVar9,local_7c + -4), iVar2 == 0))
                goto LAB_00100b78;
                ...
                if (uVar14 - 9 < 7) {
                  ...
                  if (((pBVar13 == (BIGNUM *)0x0) ||
                      (iVar1 = BN_GENCB_call(param_5,3,iVar17), iVar1 == 0)) ||
                     (pBVar11 = BN_dup(pBVar11), pBVar11 == (BIGNUM *)0x0)) goto LAB_00100b78;
                  uVar4 = OPENSSL_sk_num(local_d0);
                  ...
                  if ((iVar17 == 0) || (iVar17 = BN_mul(pBVar8,pBVar9,r,local_c8), iVar17 == 0))
                  goto LAB_00100b78;
                  iVar17 = 2;
                  goto LAB_00101382;
                }
...
LAB_00100cfb:
  ...
  goto LAB_00100871;
LAB_00101382:
  if (param_3 <= iVar17) goto code_r0x00101387;
  puVar10 = (undefined8 *)OPENSSL_sk_value(local_c0,iVar17 + -2);
  pBVar9 = BN_value_one();
  iVar1 = BN_sub((BIGNUM *)puVar10[1],(BIGNUM *)*puVar10,pBVar9);
  if ((iVar1 == 0) || (iVar1 = BN_mul(pBVar8,pBVar8,(BIGNUM *)puVar10[1],local_c8), iVar1 == 0))
  goto LAB_00100b78;
  iVar17 = iVar17 + 1;
  goto LAB_00101382;
LAB_001011b5:
...
code_r0x00101387:
  ...
  if ((pBVar8 == (BIGNUM *)0x0) ||
     ...
     iVar17 = ossl_rsa_multiprime_derive
                        (param_1,param_2 & 0xffffffff,param_3,param_4,local_d0,lVar6), iVar17 == 0))
  goto LAB_00100b78;

...
joined_r0x00100177:
    if (pBVar4 == (BIGNUM *)0x0) goto LAB_00100129;
  }
  else {
    pBVar2 = a->s;
...
ossl_dsa_sign_int(undefined8 param_1,uchar *param_2,int param_3,uchar *param_4,int *param_5,
                 DSA *param_6,undefined4 param_7,undefined8 param_8,undefined8 param_9,
                 undefined8 param_10)

{
  ...
  if ((param_6[1].pub_key == (BIGNUM *)0x0) ||
     (pDVar1 = (DSA_METHOD *)param_6[1].p, pDVar3 = DSA_get_default_method(), pDVar1 != pDVar3)) {

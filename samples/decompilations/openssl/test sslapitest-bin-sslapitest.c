...
undefined8
yield_secret_cb(SSL *param_1,int param_2,int param_3,void *param_4,size_t param_5,long param_6)

{
  ...
  if ((iVar1 != 0) && (uVar4 = param_2 - 1, uVar4 < 3)) {
    if (param_3 == 0) {
    ...
    if (iVar3 != 0) {
      ...
      if (iVar3 != 0) {
        ...
        if (iVar3 != 0) {
          ...
          if (local_5c[0] == 0) {
            iVar3 = test_mem_eq("test/sslapitest.c",0x3113,&_LC14,"fooprot + 1",local_28,local_4c,
                                0x13b392,3);
          }
          else {
            if (local_5c[0] != 1) {
...

{
  ...
  if (iVar2 != 0) {
    if (*(long *)(next_proto_tests + lVar3 + 0x60) != 0) {
      iVar2 = test_mem_eq("test/sslapitest.c",0x303f,&_LC22,"np->selected",local_38,local_39,
                          lVar3 + 0x1258a8,*(long *)(next_proto_tests + lVar3 + 0x60));
      bVar4 = iVar2 != 0;
      goto LAB_00100c75;
    }
...

{
  ...
  if (param_1 == 4) {
    ...
    iVar3 = test_true("test/sslapitest.c",0x2f63,
...
LAB_00100f42:
        ...
        do {
          ...
          iVar4 = test_true("test/sslapitest.c",0x2f7f,
                            "create_ssl_objects(sctx, cctx, &serverssl, &clientssl, NULL, NULL)",
                            iVar4 != 0);
          ...
          iVar4 = test_true("test/sslapitest.c",0x2f97,
      ...
      if (iVar3 != 0) {
        ...
        if (iVar3 != 0) {
          ...
          if (iVar3 != 0) {
            ...
            iVar3 = test_int_eq("test/sslapitest.c",0x22ab,"SSL_shutdown(serverssl)",&_LC45,iVar3,
                                0xffffffff);
            if (iVar3 != 0) {
              ...
              if (iVar3 != 0) {
                iVar3 = SSL_shutdown(local_48);
                iVar3 = test_int_eq("test/sslapitest.c",0x22b0,"SSL_shutdown(serverssl)",&_LC45,
                                    iVar3,0xffffffff);
                if (iVar3 != 0) {
                  a = (BIO *)0x0;
                  iVar3 = SSL_get_error(local_48,-1);
                  ...
                  iVar3 = SSL_shutdown(local_48);
                  iVar3 = test_int_eq("test/sslapitest.c",0x22b8,"SSL_shutdown(serverssl)",&_LC15,
                                      iVar3,0);
                  if (iVar3 != 0) {
                    iVar3 = SSL_shutdown(local_48);
                    iVar3 = test_int_eq("test/sslapitest.c",0x22bc,"SSL_shutdown(serverssl)",&_LC49,
                                        iVar3,1);
                    if (iVar3 != 0) {
                      iVar3 = SSL_shutdown(local_50);
      ...
      if (iVar3 != 0) {
        ...
        if (iVar3 != 0) {
          ...
          if (iVar3 != 0) {
            ...
            iVar3 = test_int_eq("test/sslapitest.c",0x2e9b,"SSL_connect(clientssl)",&_LC45,iVar3,
                                0xffffffff);
            if (iVar3 != 0) {
              iVar3 = SSL_accept(local_48);
              iVar3 = test_int_eq("test/sslapitest.c",0x2e9e,"SSL_accept(serverssl)",&_LC45,iVar3,
                                  0xffffffff);
              if (iVar3 != 0) {
                iVar3 = SSL_get_error(local_48,-1);
...

{
  ...
  if (iVar2 != 0) {
    ...
    if (iVar2 != 0) {
      ...
      iVar2 = test_str_eq("test/sslapitest.c",0x2e2b,"SSL_rstate_string(serverssl)",&_LC56,pcVar5,
                          &_LC55);
      if (iVar2 != 0) {
        ...
        if (iVar2 != 0) {
          ...
          if (iVar2 != 0) {
            pcVar5 = SSL_rstate_string(local_50);
            iVar2 = test_str_eq("test/sslapitest.c",0x2e32,"SSL_rstate_string(serverssl)",&_LC56,
                                pcVar5,&_LC55);
            if (iVar2 != 0) {
              pcVar5 = SSL_rstate_string_long(local_50);
...
LAB_00102748:
          ...
          if (uVar5 != 0) {
            ...
            local_a8 = 5;
LAB_001027c0:
            SSL_ctrl(local_d8,0x7e,lVar11,(void *)0x0);
            iVar4 = test_true("test/sslapitest.c",0x2d1e,"SSL_set_max_pipelines(peera, numpipes)");
            if (iVar4 != 0) {
              lVar11 = SSL_ctrl(local_d8,0x7d,larg,(void *)0x0);
              iVar4 = test_true("test/sslapitest.c",0x2d1f,
                                "SSL_set_split_send_fragment(peera, fragsize)",lVar11 != 0);
              if (iVar4 != 0) {
                iVar4 = create_ssl_connection(local_60,local_68,0);
                iVar4 = test_true("test/sslapitest.c",0x2d22,
                                  "create_ssl_connection(serverssl, clientssl, SSL_ERROR_NONE)",
                                  iVar4 != 0);
                if (iVar4 != 0) {
                  iVar4 = SSL_write_ex(local_d8,local_e0,local_d0,&local_58);
                  iVar4 = test_true("test/sslapitest.c",0x2d26,
                                    "SSL_write_ex(peera, msg, msglen, &written)",iVar4 != 0);
                  if ((iVar4 != 0) &&
                     (iVar4 = test_size_t_eq("test/sslapitest.c",0x2d27,"written","msglen",local_58,
                                             local_d0), iVar4 != 0)) {
                    uVar10 = 0;
                    iVar4 = 0;
                    do {
                      iVar6 = SSL_read_ex(local_c8,(long)ptr + uVar10,local_d0 - uVar10,&local_50);
                      iVar6 = test_true("test/sslapitest.c",0x2d36,
                    ...
                    if ((param_1 != 4) && (local_b8 = local_a8, param_1 == 3)) {
                      local_b8 = local_b0;
                    }
                    iVar6 = test_mem_eq("test/sslapitest.c",0x2d3d,&_LC72,&_LC80,local_e0,local_d0,
                                        ptr,uVar10);
                    if ((iVar6 != 0) &&
                       (iVar4 = test_int_eq("test/sslapitest.c",0x2d3e,"numreads","expectedreads",
                                            iVar4,local_b8), iVar4 != 0)) {
                      uVar12 = 0;
                      uVar10 = local_d0;
                      do {
                        uVar14 = uVar13;
                        ...
                        if ((iVar4 == 0) ||
                           (iVar4 = test_size_t_eq("test/sslapitest.c",0x2d4b,"written","sendlen",
                                                   local_58,uVar14), iVar4 == 0)) goto LAB_001027f5;
                      ...
                      if ((iVar4 != 0) &&
                         (iVar4 = test_size_t_le("test/sslapitest.c",0x2d57,"readbytes","msglen",
                                                 local_50,local_d0), iVar4 != 0)) {
                        if (param_1 != 4) {
LAB_00102ded:
                          iVar4 = test_mem_eq("test/sslapitest.c",0x2d65,&_LC72,&_LC80,local_e0,
                                              local_d0,ptr,local_50);
                          uVar5 = (uint)(iVar4 != 0);
                          goto LAB_00102639;
                        }
                        iVar4 = SSL_read_ex(local_d8,(long)ptr + local_50,local_d0 - local_50,
                                            &local_48);
        ...
        if (iVar3 != 0) {
          ...
          if (iVar3 != 0) {
            ...
            if (iVar3 != 0) {
              ...
              iVar3 = test_int_eq("test/sslapitest.c",0x198c,"SSL_do_handshake(clientssl)",&_LC49,
                                  iVar3,1);
              if (iVar3 != 0) {
          ...
          do {
            ...
            if ((iVar3 == 0) ||
               (iVar3 = test_size_t_eq("test/sslapitest.c",0x2c9e,"written","readbytes",local_a8,
                                       local_a0), iVar3 == 0)) goto LAB_001036c0;
            local_98[local_a0] = 0;
              ...
              if (iVar2 != 0) {
                ...
                if (iVar2 != 0) {
                  ...
                  while( true ) {
                    ...
                    if (iVar3 == 0) break;
                    local_98[local_a0] = 0;
                    iVar3 = test_str_eq("test/sslapitest.c",0x2c1b,&_LC80,&_LC72,local_98,
                                        "Hello World");
                    if (iVar3 == 0) break;
                    if (iVar2 == 1) {
                      uVar6 = 1;
      ...
      if (iVar2 != 0) {
        ...
        if (iVar2 != 0) {
          ...
          iVar2 = test_int_gt("test/sslapitest.c",0x26ae,
                              "SSL_CTX_set1_groups_list(ctx, \"DEFAULT:-?P-256\")",&_LC15,
                              uVar4 & 0xffffffff,0);
          if (iVar2 != 0) {
            ...
            if (iVar2 != 0) {
              ...
              iVar2 = test_int_gt("test/sslapitest.c",0x26b8,
                                  "SSL_CTX_set1_groups_list(ctx, \"?P-256:?P-521:-?P-256\")",&_LC15,
                                  uVar4 & 0xffffffff,0);
              if (iVar2 != 0) {
                iVar2 = test_size_t_eq("test/sslapitest.c",0x26b9,"ctx->ext.supportedgroups_len",
                                       &_LC49,ctx[1].session_cache_head,1);
                if (iVar2 != 0) {
      ...
      if (uVar10 != 0) {
        ...
        if (iVar9 != 0) {
          ...
          *(undefined8 *)(c_01[1].master_key + 4) = uVar7;
          ...
          iVar9 = test_int_eq("test/sslapitest.c",0x24f5,"SSL_CTX_add_session(ctx, early)",&_LC49,
                              iVar9,1);
          if (iVar9 != 0) {
            iVar9 = SSL_CTX_add_session(s,c_00);
            iVar9 = test_int_eq("test/sslapitest.c",0x24f6,"SSL_CTX_add_session(ctx, middle)",&_LC49
                                ,iVar9,1);
            if (iVar9 != 0) {
              iVar9 = SSL_CTX_add_session(s,c_01);
              iVar9 = test_int_eq("test/sslapitest.c",0x24f7,"SSL_CTX_add_session(ctx, late)",&_LC49
                                  ,iVar9,1);
              if (iVar9 != 0) {
                                            ...
                                            if (iVar9 != 0) {
                                              ...
                                              if (iVar9 != 0) {
                                                ...
                                                if (iVar9 != 0) {
                                                  ...
                                                  "SSL_CTX_add_session(ctx, early)",&_LC49,iVar9,1);
                                                  if (iVar9 != 0) {
                                                    iVar9 = SSL_CTX_add_session(s,c_00);
                                                    iVar9 = test_int_eq("test/sslapitest.c",0x252e,
                                                                                                                                                
                                                  "SSL_CTX_add_session(ctx, middle)",&_LC49,iVar9,1)
                                                  ;
                                                  if (iVar9 != 0) {
                                                    iVar9 = SSL_CTX_add_session(s,c_01);
                                                    iVar9 = test_int_eq("test/sslapitest.c",0x252f,
                                                                                                                                                
                                                  "SSL_CTX_add_session(ctx, late)",&_LC49,iVar9,1);
                                                  if (iVar9 != 0) {
                                                  ...
                                                  if (iVar9 != 0) {
                                                    ...
                                                    if (iVar9 != 0) {
                                                      ...
                                                      iVar9 = test_time_t_ne("test/sslapitest.c",
                                                                             0x2544,
                                                  "SSL_SESSION_set_time_ex(early, now)",&_LC15,
                                                  uVar12,0);
                                                  if (iVar9 != 0) {
                                                    iVar9 = SSL_CTX_add_session(s,c);
                                                  ...
                                                  if (iVar9 != 0) {
                                                    ...
                                                    iVar9 = test_time_t_ne("test/sslapitest.c",
                                                                           0x2546,
                                                  "SSL_SESSION_get_time_ex(early)",&_LC172,uVar12,
                                                  lVar1);
                                                  uVar10 = (uint)(iVar9 != 0);
                                                  goto LAB_00104dbf;
                                                  }
...

{
  ...
  if (iVar1 != 0) {
    ...
    if (iVar1 != 0) {
      ...
      iVar1 = test_int_eq("test/sslapitest.c",0x2bad,"X509_VERIFY_PARAM_get_hostflags(cp)",&_LC15,
                          uVar2,0);
      if (iVar1 != 0) {
...

{
  ...
  if (iVar1 != 0) {
    ...
    iVar1 = test_int_gt("test/sslapitest.c",0x266c,
                        ...
                        &_LC15,uVar3 & 0xffffffff,0);
    if (iVar1 != 0) {
      iVar1 = test_size_t_eq("test/sslapitest.c",0x2670,"ctx->cert->conf_sigalgslen",&_LC223,
          ...
          if (iVar1 != 0) {
            ...
            if (iVar1 != 0) {
              iVar1 = test_size_t_eq("test/sslapitest.c",0x2679,"ctx->cert->client_sigalgslen",
                                     &_LC223,*(undefined8 *)(*(long *)ctx->sid_ctx + 0x58),2);
              if (iVar1 != 0) {
                ...
                if (iVar1 != 0) {
                  ...
                  if (iVar1 != 0) {
                    ...
                    iVar1 = test_int_le("test/sslapitest.c",0x267e,
                                        "SSL_CTX_set1_groups_list(ctx, \"nonexistent\")",&_LC15,
                                        uVar3 & 0xffffffff,0);
                    if (iVar1 != 0) {
                        ...
                        if (iVar1 != 0) {
                          ...
                          if (iVar1 != 0) {
                            iVar1 = test_size_t_eq("test/sslapitest.c",0x2692,
                                                   "ctx->ext.supportedgroups_len",&_LC223,
...

{
  ...
  if ((iVar1 != 0) &&
     (iVar1 = test_ptr("test/sslapitest.c",0x29cf,&_LC246,local_58), uVar5 = cert1024,
            ...
            if (iVar1 != 0) {
              ...
              if (iVar1 != 0) {
                ...
                if (iVar1 != 0) {
                  ...
                  iVar1 = test_int_le("test/sslapitest.c",0x2a1e,"SSL_connect(clientssl)",&_LC15,
                                      iVar1,0);
                  if (iVar1 != 0) {
                    iVar1 = SSL_accept(local_40);
                    iVar1 = test_int_le("test/sslapitest.c",0x2a1f,"SSL_accept(serverssl)",&_LC15,
                                        iVar1,0);
                    if (iVar1 != 0) {
                      uVar4 = SSL_ctrl(local_40,0x85,0,&local_38);
                      iVar1 = test_int_gt("test/sslapitest.c",0x2a22,
                                          "SSL_get_tmp_key(serverssl, &tmpkey)",&_LC15,
                                          uVar4 & 0xffffffff,0);
                      if (iVar1 != 0) {
...
LAB_001085b6:
      ...
      if ((iVar2 != 0) &&
         (iVar2 = test_ptr("test/sslapitest.c",0x2709,&_LC113,local_60), iVar2 != 0)) {
...
LAB_00108858:
                      ...
                      if (iVar2 != 0) {
                        ...
                        if ((int)uVar5 != 0) {
                          ...
                          if (((iVar2 != 0) &&
                              (iVar2 = test_int_eq("test/sslapitest.c",0x2766,&_LC337,
                                                   "hash_expected",local_6c,iVar11), iVar2 != 0)) &&
                             (iVar2 = test_int_eq("test/sslapitest.c",0x2767,&_LC339,"sig_expected",
                      ...
                      if (iVar2 != 0) {
                        ...
                        if (iVar2 != 0) {
                          ...
                          iVar2 = test_int_eq("test/sslapitest.c",0x2746,
                                              "SSL_CTX_check_private_key(sctx)",&_LC49,iVar2,1);
          ...
          if (iVar2 != 0) {
            ...
            if (iVar2 != 0) {
              ...
              if (iVar2 != 0) {
                ...
                iVar2 = test_int_eq("test/sslapitest.c",0x2609,"SSL_shutdown(clientssl)",&_LC15,
                                    iVar2,0);
                if (iVar2 != 0) {
                  session = SSL_get1_session(local_50);
                  iVar2 = test_ptr_ne("test/sslapitest.c",0x260a,
                                      "sess = SSL_get1_session(clientssl)",&_LC352,session,0);
                  if (iVar2 != 0) {
        ...
        if (iVar1 != 0) {
          ...
          if ((param_1 == 0x304) && (param_2 < 2)) {
            ...
            if (iVar1 != 0) {
              ...
              iVar1 = test_int_eq("test/sslapitest.c",0x243e,"sk_X509_NAME_num(sktmp)",&_LC223,uVar2
                                  ,2);
              if (iVar1 != 0) {
                ...
                iVar1 = test_int_eq("test/sslapitest.c",0x243f,
                                    "X509_NAME_cmp(sk_X509_NAME_value(sktmp, 0), name[0])",&_LC15,
                                    iVar1,0);
                if (iVar1 != 0) {
                  ...
                  iVar1 = test_int_eq("test/sslapitest.c",0x2441,
                                      "X509_NAME_cmp(sk_X509_NAME_value(sktmp, 1), name[1])",&_LC15,
                                      iVar1,0);
...
joined_r0x00109f67:
            if (iVar1 != 0) {
              ...
              if (iVar1 != 0) {
                ...
                iVar1 = test_int_eq("test/sslapitest.c",0x244f,"sk_X509_NAME_num(sktmp)",&_LC223,
                                    uVar2,2);
                if (iVar1 != 0) {
...
LAB_0010a469:
  ...
  if ((uVar2 != 0) && (uVar2 = 1, 0 < param_2)) {
    iVar1 = test_int_eq("test/sslapitest.c",0x237a,"(cert_cb_cnt - 2) * (cert_cb_cnt - 3)",&_LC15,
...
LAB_0010b8be:
        ...
        if (iVar2 != 0) {
          ...
          iVar2 = test_ptr_ne("test/sslapitest.c",0x2218,"sess = SSL_get_session(clientssl)",&_LC352
                              ,pSVar5,0);
          if (iVar2 != 0) {
            ...
            if (iVar2 != 0) {
              ...
              iVar2 = test_int_eq("test/sslapitest.c",0x221d,"SSL_shutdown(clientssl)",&_LC15,iVar2,
                                  0);
              if (iVar2 != 0) {
                if (param_1 < 4) {
LAB_0010bc1c:
                  ...
                  if (iVar2 != 0) {
                    ...
                    iVar2 = test_int_eq("test/sslapitest.c",0x2256,"SSL_shutdown(serverssl)",&_LC15,
                                        iVar2,0);
                    if (iVar2 != 0) {
                      ...
                      if (iVar2 != 0) {
                        ...
                        if (iVar2 != 0) {
                          ...
                          iVar2 = test_ptr_ne("test/sslapitest.c",0x225d,
                                              "sess = SSL_get_session(clientssl)",&_LC352,pSVar5,0);
                          if (iVar2 != 0) {
                            iVar2 = SSL_SESSION_is_resumable(pSVar5);
                            ...
                            if (iVar2 != 0) {
                              ...
                              if (iVar2 != 0) {
                                ...
                                iVar2 = test_int_eq("test/sslapitest.c",0x223c,
                                                    "SSL_shutdown(serverssl)",&_LC49,iVar2,1);
                                if (iVar2 != 0) {
                                  ...
                                  if ((iVar2 != 0) &&
                                    ...
                                    iVar2 = test_int_eq("test/sslapitest.c",0x2243,
                                                        "memcmp(msg, buf, readbytes)",&_LC15,iVar2,0
                                                       );
                                    if (iVar2 != 0) {
                                      iVar2 = SSL_read_ex(local_c8,local_98,0x50,&local_b0);
                                      ...
                                      if ((iVar2 != 0) &&
                                        ...
                                        iVar2 = test_int_eq("test/sslapitest.c",0x2247,
                                                            "memcmp(msg, buf, readbytes)",&_LC15,
                                                            iVar2,0);
...
joined_r0x0010bff5:
                              ...
                              if (iVar2 != 0) {
                                if (param_1 - 4U < 2) {
                                  ...
                                  iVar2 = test_int_eq("test/sslapitest.c",0x2267,
                                                      "SSL_shutdown(clientssl)",&_LC49,iVar2,1);
                                  if (iVar2 != 0) {
                                    pSVar5 = SSL_get_session(local_c8);
                                    iVar2 = test_ptr_ne("test/sslapitest.c",0x2268,
                                                        "sess = SSL_get_session(clientssl)",&_LC352,
                                                        pSVar5,0);
                                    if (iVar2 != 0) {
                                      iVar2 = SSL_SESSION_is_resumable(pSVar5);
                                  ...
                                  iVar2 = test_int_eq("test/sslapitest.c",0x2273,
                                                      "SSL_shutdown(clientssl)",&_LC45,iVar2,
                                                      0xffffffff);
                                  if (iVar2 != 0) {
    ...
    if (iVar2 != 0) {
      ...
      if (iVar2 != 0) {
        ...
        if (iVar2 != 0) {
          pSVar5 = SSL_get_session(local_c8);
          iVar2 = test_ptr_ne("test/sslapitest.c",0x2213,"sess = SSL_get_session(clientssl)",&_LC352
                              ,pSVar5,0);
          if (iVar2 != 0) {
            iVar2 = SSL_SESSION_is_resumable(pSVar5);
...
joined_r0x0010c4b9:
        ...
        if (iVar7 != 0) {
          ...
          if (((iVar7 != 0) &&
              (iVar7 = test_int_eq("test/sslapitest.c",0x2176,"gen_tick_called",&_LC49,
                                   gen_tick_called,1), iVar7 != 0)) &&
             (iVar7 = test_int_eq("test/sslapitest.c",0x2177,"dec_tick_called",
                                  "((tst % 2) == 0) ? 1 : 0",dec_tick_called,uVar6), iVar7 != 0)) {
            dec_tick_called = 0;
            gen_tick_called = 0;
            session = SSL_get1_session(local_50);
            SSL_shutdown(local_50);
  ...
  if (iVar1 != 0) {
    ...
    if (iVar1 != 0) {
      ...
      if (iVar1 != 0) {
        ...
        iVar1 = test_int_ne("test/sslapitest.c",0x1ed8,"state[++info_cb_this_state].where",&_LC15,
                            *(undefined4 *)
                ...
                if (iVar1 != 0) {
                  ...
                  if (iVar1 != 0) {
                    ...
                    iVar1 = test_true("test/sslapitest.c",0x1212,
                                      ...
                                      iVar1 != 0);
                    if (iVar1 != 0) {
                      iVar1 = test_mem_eq("test/sslapitest.c",0x1213,&_LC80,&_LC534,local_48,
                                          local_58,"World.",6);
                      bVar3 = iVar1 != 0;
                      goto LAB_0010e3e2;
                    }
...
LAB_0010ec06:
  ...
  if (iVar2 != 0) {
    ...
    if (iVar2 != 0) {
      ...
      iVar2 = create_ssl_ctx_pair(libctx,uVar3,uVar4,local_80,local_80,&local_68,&local_70,cert,
                                  privkey);
      iVar2 = test_true("test/sslapitest.c",0x66c,
      ...
      if (iVar2 != 0) {
        if (bVar1) {
          ...
          iVar2 = test_true("test/sslapitest.c",0x672,
        ...
        if (iVar2 != 0) {
          ...
          if ((param_1 & 2) != 0) {
            ...
            iVar2 = test_true("test/sslapitest.c",0x68a,
                              "SSL_set_options(serverssl, SSL_OP_NO_ENCRYPT_THEN_MAC)",lVar5 != 0);
            if (iVar2 == 0) goto LAB_0010e8e0;
            lVar5 = SSL_set_options(local_60,0x80000);
            iVar2 = test_true("test/sslapitest.c",0x68b,
                              "SSL_set_options(clientssl, SSL_OP_NO_ENCRYPT_THEN_MAC)",lVar5 != 0);
            if (iVar2 == 0) goto LAB_0010e8e0;
          }
          iVar2 = create_ssl_connection(local_58,local_60,0);
          iVar2 = test_true("test/sslapitest.c",0x690,
                            "create_ssl_connection(serverssl, clientssl, SSL_ERROR_NONE)",iVar2 != 0
                           );
          if (iVar2 != 0) {
            iVar2 = SSL_write_ex(local_60,ptr,0x4000,&local_50);
            iVar2 = test_true("test/sslapitest.c",0x693,
                              "SSL_write_ex(clientssl, msg, SSL3_RT_MAX_PLAIN_LENGTH, &written)",
                              iVar2 != 0);
            if ((iVar2 != 0) &&
               (iVar2 = test_size_t_eq("test/sslapitest.c",0x695,"written",
                                       "SSL3_RT_MAX_PLAIN_LENGTH",local_50,0x4000), iVar2 != 0)) {
              iVar2 = SSL_read_ex(local_58,__s,0x4001,&local_48);
              iVar2 = test_true("test/sslapitest.c",0x699,
...
LAB_0010ef87:
        ...
        if ((((iVar11 == 2) || (iVar3 == 2)) || (uVar10 == 2)) || (uVar4 == 2)) {
          ...
          if (iVar5 == 0) goto LAB_0010f0ed;
          if (iVar11 != 3) {
            if ((bVar13) || (local_88 = a, iVar11 == 2)) goto LAB_0010f250;
            goto LAB_0010efc5;
          }
LAB_0010efe8:
          local_78 = (BIO *)0x0;
...
LAB_0010f03b:
          ...
          if ((uVar10 == 1) || (a_00 = a, uVar10 == 2)) {
            if ((uVar4 == 1) || (pBVar12 = a, uVar4 == 2)) {
              ...
              pBVar12 = (BIO *)0x0;
              if ((a_00 != (BIO *)0x0) && (bVar13 = true, local_88 != a_00)) {
LAB_0010f410:
                iVar3 = BIO_up_ref(a_00);
                  ...
                  if (iVar1 != 0) {
                    ...
                    if (iVar1 != 0) {
                      ...
                      iVar1 = test_true("test/sslapitest.c",0x1259,
                                        ...
                                        iVar1 != 0);
                      if (iVar1 != 0) {
                        iVar1 = test_mem_eq("test/sslapitest.c",0x125a,&_LC80,&_LC569,local_58,
                                            local_68,"Hello",5);
                        if (iVar1 != 0) {
                          ...
                          if (iVar1 != 0) {
                            ...
                            if (iVar1 != 0) {
                              ...
                              if (iVar1 != 0) {
                                iVar1 = test_mem_eq("test/sslapitest.c",0x125e,&_LC80,&_LC534,
              ...
              if (iVar1 != 0) {
                ...
                if (iVar1 != 0) {
                  ...
                  iVar1 = test_true("test/sslapitest.c",0x1075,
                                    ...
                                    iVar1 != 0);
                  if (iVar1 != 0) {
                    iVar1 = test_mem_eq("test/sslapitest.c",0x1076,&_LC80,&_LC569,local_58,local_68,
                                        "Hello",5);
                    if (iVar1 != 0) {
                      ...
                      if (iVar1 != 0) {
                        ...
                        if (iVar1 != 0) {
                          ...
                          iVar1 = test_true("test/sslapitest.c",0x107b,
                                            ...
                                            iVar1 != 0);
                          if (iVar1 != 0) {
                            iVar1 = test_mem_eq("test/sslapitest.c",0x107c,&_LC80,&_LC534,local_58,
                                                local_68,"World.",6);
                            bVar3 = iVar1 != 0;
                            goto LAB_0010fee6;
                          }
              ...
              if (iVar3 != 0) {
                ...
                if (iVar3 != 0) {
                  ...
                  if (iVar3 != 0) {
                    ...
                    iVar3 = test_int_eq("test/sslapitest.c",0x1c23,"SSL_do_handshake(local)",&_LC49,
                                        iVar3,1);
                    if (iVar3 != 0) {
                      iVar3 = SSL_write(s,&local_248,0x203);
            ...
            if (iVar3 != 0) {
              ...
              if (iVar3 != 0) {
                ...
                iVar3 = test_int_eq("test/sslapitest.c",0x1b78,
                                    "SSL_read(peer, prbuf, sizeof(prbuf))",&_LC45,iVar3,0xffffffff);
                if (iVar3 != 0) {
                  iVar3 = SSL_get_error(s_00,-1);
    ...
    if (iVar3 != 0) {
      ...
      if (iVar3 != 0) {
        ...
        if (iVar3 != 0) {
          ...
          if (iVar3 != 0) {
            iVar3 = SSL_do_handshake(s);
            iVar3 = test_int_eq("test/sslapitest.c",0x1b07,"SSL_do_handshake(peerupdate)",&_LC49,
                                iVar3,1);
            if (iVar3 != 0) {
              ...
              if (iVar3 != 0) {
                ...
                if (iVar3 != 0) {
                  ...
                  iVar3 = test_int_eq("test/sslapitest.c",0x1b14,
                                      "SSL_write(peerwrite, mess, strlen(mess))",&_LC45,iVar3,
                                      0xffffffff);
                  if (iVar3 != 0) {
                    a = (BIO *)0x0;
                    ...
                    if (iVar3 != 0) {
                      ...
                      if (iVar3 != 0) {
                        ...
                        iVar3 = test_int_eq("test/sslapitest.c",0x1b1f,
                                            "SSL_read(peerwrite, buf, sizeof(buf))",&_LC45,iVar3,
                                            0xffffffff);
                        if (iVar3 != 0) {
                          iVar3 = SSL_get_error(s_00,0);
  ...
  if (iVar2 != 0) {
    ...
    if (iVar2 != 0) {
      ...
      if (iVar2 != 0) {
        ...
        iVar2 = test_int_eq("test/sslapitest.c",0x1778,"SSL_stateless(serverssl)",&_LC45,uVar3,
                            0xffffffff);
        if (iVar2 != 0) {
          SSL_free(local_48);
          local_48 = (SSL *)0x0;
          ...
          if (iVar2 != 0) {
            ...
            if (iVar2 != 0) {
              uVar3 = SSL_stateless(local_50);
              iVar2 = test_int_eq("test/sslapitest.c",0x178d,"SSL_stateless(serverssl)",&_LC15,uVar3
                                  ,0);
              if (iVar2 != 0) {
                SSL_free(local_48);
                local_48 = (SSL *)0x0;
                ...
                if (iVar2 != 0) {
                  ...
                  if (iVar2 != 0) {
                    uVar3 = SSL_stateless(local_50);
                    iVar2 = test_int_eq("test/sslapitest.c",0x179e,"SSL_stateless(serverssl)",&_LC15
                                        ,uVar3,0);
                    if (iVar2 != 0) {
                      iVar2 = create_ssl_connection(local_50,local_48,2);
...
LAB_00112a47:
                                        ...
                                        goto LAB_0011210e;
                                            ...
                                            (srvaddnewcb == 8)) goto LAB_00112a47;
                                  }
                                }
                              }
                              uVar7 = 0;
                          ...
                          if ((((clntaddnewcb == 1) && (clntparsenewcb == 1)) && (srvaddnewcb == 1))
                            ...
                            goto LAB_0011210e;
                                ...
                                (uVar1 = srvparsenewcb, srvaddnewcb == 5)) goto joined_r0x00112a0b;
                      }
                    }
                  }
                }
      ...
      iVar3 = test_int_eq("test/sslapitest.c",0x1866,
                          "SSL_CTX_use_certificate_file(cctx, cert, SSL_FILETYPE_PEM)",&_LC49,iVar3,
                          1);
      if (iVar3 != 0) {
        iVar3 = SSL_CTX_use_PrivateKey_file(local_68,privkey,1);
        iVar3 = test_int_eq("test/sslapitest.c",0x1868,
                            "SSL_CTX_use_PrivateKey_file(cctx, privkey, SSL_FILETYPE_PEM)",&_LC49,
                            iVar3,1);
        if (iVar3 != 0) {
          iVar3 = SSL_CTX_check_private_key(local_68);
          iVar3 = test_int_eq("test/sslapitest.c",0x186a,"SSL_CTX_check_private_key(cctx)",&_LC49,
                              iVar3,1);
          if (iVar3 != 0) {
            uVar4 = 0x5000;
            goto LAB_0011204d;
            ...
            if (iVar2 != 0) {
              ...
              if (iVar2 != 0) {
                if (puStack0000000000000010 == (undefined4 *)0x0) {
                  ...
                  lVar6 = SSL_ctrl(in_stack_00000038,0x5b,lStack0000000000000018,
                              ...
                              if (iVar2 != 0) {
                                ...
                                if (iVar2 != 0) {
                                  ...
                                  if (iVar2 != 0) {
                                    ...
                                    iVar2 = test_int_eq("test/sslapitest.c",0x144f,
                                                        "SSL_get_negotiated_group(serverssl)",
                                                        "shared_group0",uVar9 & 0xffffffff,
                                                        uVar7 & 0xffffffff);
                                    if (iVar2 != 0) {
...
LAB_00112f2b:
                        iVar2 = test_int_eq("test/sslapitest.c",uVar8,pcVar11,pcVar10,uVar9,uVar12);
                        uVar7 = (ulong)(iVar2 != 0);
                        goto LAB_00112f40;
                      }
                    }
...

{
    ...
    if ((is_fips == 0) || (*(int *)(ppuVar12 + 1) != 0)) {
      ...
      if (bVar2) {
        ...
        if (str != (char *)0x0) {
          ...
          iVar4 = test_true("test/sslapitest.c",0x1595,"SSL_CTX_set_cipher_list(sctx, t12_cipher)",
                            iVar4 != 0);
          if (iVar4 == 0) goto LAB_00115050;
          iVar4 = SSL_CTX_set_cipher_list(local_58,str);
          iVar4 = test_true("test/sslapitest.c",0x1596,"SSL_CTX_set_cipher_list(cctx, t12_cipher)",
                            iVar4 != 0);
          if (iVar4 == 0) goto LAB_00115050;
        }
      }
      ...
      if (bVar13) {
        ...
        iVar4 = test_true("test/sslapitest.c",0x15a1,"SSL_set_ciphersuites(serverssl, t13_cipher)",
                          iVar4 != 0);
        if (iVar4 == 0) goto LAB_00115050;
        iVar4 = SSL_set_ciphersuites(local_48,puVar1);
        iVar4 = test_true("test/sslapitest.c",0x15a2,"SSL_set_ciphersuites(clientssl, t13_cipher)",
                          iVar4 != 0);
        if (iVar4 == 0) goto LAB_00115050;
        if (str != (char *)0x0) {
          iVar4 = SSL_set_cipher_list(local_50,str);
          iVar4 = test_true("test/sslapitest.c",0x15a5,"SSL_set_cipher_list(serverssl, t12_cipher)",
                            iVar4 != 0);
          if (iVar4 == 0) goto LAB_00115050;
          iVar4 = SSL_set_cipher_list(local_48,str);
          iVar4 = test_true("test/sslapitest.c",0x15a6,"SSL_set_cipher_list(clientssl, t12_cipher)",
                            iVar4 != 0);
          if (iVar4 == 0) goto LAB_00115050;
        }
      }
      ...
      iVar4 = test_str_eq("test/sslapitest.c",0x15b4,"negotiated_scipher","negotiated_ccipher",
                          pcVar8,pcVar9);
      if ((iVar4 == 0) ||
         ((str != (char *)0x0 &&
          (iVar4 = test_str_eq("test/sslapitest.c",0x15c3,"t12_cipher","negotiated_scipher",str,
                               pcVar8), iVar4 == 0)))) goto LAB_00115050;
      SSL_free(local_50);
      local_50 = (SSL *)0x0;
      SSL_free(local_48);
      local_48 = (SSL *)0x0;
  ...
  do {
    ...
    if ((is_fips == 0) || (*(int *)(local_70 + 1) != 0)) {
      ...
      iVar4 = test_strn_eq("test/sslapitest.c",0x15bc,"t13_cipher","negotiated_scipher",puVar1,
                           sVar10,pcVar8,sVar10);
      if (iVar4 == 0) goto LAB_00115050;
      SSL_free(local_50);
      local_50 = (SSL *)0x0;
      SSL_free(local_48);
...

{
  ...
  if ((is_fips != 0) && (uVar3 = 1, 3 < (int)uVar12)) goto LAB_00115b63;
...
LAB_00115aba:
        ...
        if (iVar2 != 0) {
          ...
          if ((iVar2 != 0) &&
             (iVar2 = test_size_t_eq("test/sslapitest.c",0xfbd,"readbytes",&_LC15,local_70,0),
             iVar2 != 0)) {
                ...
                if ((iVar2 != 0) &&
                  ...
                  if (iVar2 != 0) {
                    ...
                    iVar2 = test_true("test/sslapitest.c",0x100a,
                                      ...
                                      iVar2 != 0);
                    if ((iVar2 != 0) &&
                       (iVar2 = test_mem_eq("test/sslapitest.c",0x100b,&_LC80,&_LC534,local_58,
                                            local_70,"World.",6), iVar2 != 0)) {
                      uVar10 = ERR_peek_error();
                      iVar2 = test_long_eq("test/sslapitest.c",0x1012,"ERR_peek_error()",&_LC15,
                                           uVar10,0);
                      uVar3 = (uint)(iVar2 != 0);
                      goto LAB_00115b05;
                    }
...
joined_r0x0011685d:
                      ...
                      iVar6 = test_mem_eq("test/sslapitest.c",0xf2b,&_LC569,&_LC80,"Hello",5,
                                          local_58,local_68);
                      if (iVar6 != 0) {
...
LAB_0011626e:
        ...
        if (iVar6 != 0) {
          ...
          iVar6 = test_int_eq("test/sslapitest.c",0xeef,
                              "SSL_CONF_cmd(confctx, \"Options\", \"-AntiReplay\")",&_LC223,uVar7,2)
          ;
          if (iVar6 != 0) {
...

{
  ...
  *param_3 = iVar1 + 1;
  ...
  if (iVar1 != 0) {
    ...
    puVar3 = &local_24;
    iVar1 = test_mem_eq("test/sslapitest.c",0x2e1,&_LC257,"expected_ciphers",local_60,local_50,
                        puVar3);
    if (iVar1 != 0) {
      uVar2 = SSL_client_hello_get0_compression_methods(param_1,&local_60,puVar3,4);
      iVar1 = test_size_t_eq("test/sslapitest.c",0x2e2,
                             "SSL_client_hello_get0_compression_methods(s, &p)",&_LC49,uVar2,1);
      if (iVar1 != 0) {
...

{
  ...
  if (iVar1 != 0) {
    ...
    iVar1 = test_int_eq("test/sslapitest.c",0x2b8,
                        "SSL_CTX_use_certificate_chain_file(ctx, leaf_chain)",&_LC49,iVar1,1);
    if (iVar1 != 0) {
      iVar1 = SSL_CTX_use_PrivateKey_file(ctx,file,1);
      iVar1 = test_int_eq("test/sslapitest.c",0x2b9,
                          "SSL_CTX_use_PrivateKey_file(ctx, skey, SSL_FILETYPE_PEM)",&_LC49,iVar1,1)
      ;
      if (iVar1 != 0) {
  ...
  if (uVar1 != 0) {
    ...
    if (iVar2 != 0) {
      ...
      iVar2 = test_int_eq("test/sslapitest.c",0x292,
                          "SSL_use_certificate_chain_file(ssl, leaf_chain)",&_LC49,uVar3,1);
      if (iVar2 != 0) {
        iVar2 = SSL_use_PrivateKey_file(ssl,file,1);
        iVar2 = test_int_eq("test/sslapitest.c",0x293,
                            "SSL_use_PrivateKey_file(ssl, skey, SSL_FILETYPE_PEM)",&_LC49,iVar2,1);
        if (iVar2 != 0) {
  ...
  if (iVar1 != 0) {
    ...
    if (iVar1 != 0) {
      ...
      iVar1 = test_int_eq("test/sslapitest.c",0x249,
                          "SSL_CTX_use_PrivateKey_file(sctx, skey, SSL_FILETYPE_PEM)",&_LC49,iVar1,1
                         );
      if (iVar1 != 0) {
        iVar1 = SSL_CTX_check_private_key(local_58);
        iVar1 = test_int_eq("test/sslapitest.c",0x24b,"SSL_CTX_check_private_key(sctx)",&_LC49,iVar1
                            ,1);
        if (iVar1 != 0) {
            ...
            if (iVar2 != 0) {
              ...
              if (iVar2 != 0) {
                ...
                if (iVar2 != 0) {
                  ...
                  if (iVar2 != 0) {
                    iVar2 = test_size_t_eq("test/sslapitest.c",0xacf,&_LC49,"nbytes",1,
                        ...
                        if (iVar2 != 0) {
                          ...
                          if (iVar2 != 0) {
                            iVar2 = test_int_eq("test/sslapitest.c",0xad3,"sizeof(buf)","nbytes",1,
                                                local_50);
                            if (iVar2 != 0) {
                              iVar2 = test_int_eq("test/sslapitest.c",0xad4,&_LC801,"buf[0]",
                                                  local_71,local_41);
                              if (iVar2 != 0) {
                                iVar2 = SSL_read_ex(local_58,&local_41,1,&local_50);
                                ...
                                if (iVar2 != 0) {
                                  ...
                                  if (iVar2 != 0) {
                                    ...
                                    if (iVar2 != 0) {
                                      ...
                                      if (iVar2 != 0) {
                                        iVar2 = test_int_eq("test/sslapitest.c",0xade,&_LC49,
                                        ...
                                        if (iVar2 != 0) {
                                          ...
                                          iVar2 = test_true("test/sslapitest.c",0xadf,
                                                  ...
                                                  ,iVar2 != 0);
                                          if (iVar2 != 0) {
                                            iVar2 = test_int_eq("test/sslapitest.c",0xae0,&_LC223,
        ...
        if (iVar1 != 0) {
          ...
          if (iVar1 != 0) {
            ...
            iVar1 = test_true("test/sslapitest.c",0xa8c,
                              ...
                              iVar1 != 0);
            if (iVar1 != 0) {
              iVar1 = test_int_eq("test/sslapitest.c",0xa8e,&_LC49,"find_session_cb_cnt",1,
                                  find_session_cb_cnt);
              if (iVar1 != 0) {
                iVar1 = test_int_eq("test/sslapitest.c",0xa8f,&_LC49,"use_session_cb_cnt",1,
                                    use_session_cb_cnt);
                if (iVar1 != 0) {
  ...
  if (0 < param_1) {
    if (param_4 == 0) {
      ...
      do {
        ...
        if ((iVar1 == 0) ||
           (iVar1 = test_int_eq("test/sslapitest.c",0x9db,"new_called",&_LC809), iVar1 == 0))
        goto LAB_00119710;
        puVar3 = puVar4 + 1;
        new_called = 0;
        SSL_shutdown(local_48);
      ...
      do {
        ...
        if ((iVar1 == 0) ||
           (iVar1 = test_int_eq("test/sslapitest.c",0x9d7,"new_called",&_LC49,new_called,1),
           iVar1 == 0)) goto LAB_00119710;
        new_called = 0;
        iVar1 = post_handshake_verify(local_50,local_48);
        if ((iVar1 == 0) ||
           (iVar1 = test_int_eq("test/sslapitest.c",0x9e3,"new_called",&_LC49), iVar1 == 0))
        goto LAB_00119710;
        puVar3 = puVar4 + 1;
        SSL_shutdown(local_48);
        SSL_shutdown(local_50);
  ...
  if (iVar1 != 0) {
    ...
    if (iVar1 != 0) {
      ...
      iVar1 = test_true("test/sslapitest.c",0xa0a,
                        "create_ssl_connection(serverssl, clientssl, SSL_ERROR_NONE)",iVar1 != 0);
      if (iVar1 != 0) {
        iVar1 = test_int_eq("test/sslapitest.c",0xa0d,&_LC809,"new_called",param_2 & 0xffffffff,
                            new_called);
        if (iVar1 != 0) {
          SSL_shutdown(local_48);
          SSL_shutdown(local_50);
              ...
              if (iVar1 != 0) {
                ...
                if (iVar1 != 0) {
                  ...
                  iVar1 = test_true("test/sslapitest.c",0xa38,
                                    ...
                                    iVar1 != 0);
                  if (iVar1 != 0) {
                    iVar1 = test_int_eq("test/sslapitest.c",0xa3b,&_LC809,"new_called",
...
LAB_0011a310:
      ...
      if ((param_3 != 0) &&
         ((iVar2 = test_int_eq("test/sslapitest.c",0x84a,"new_called","numnewsesstick",new_called,
                               iVar1), iVar2 == 0 ||
          (iVar2 = test_int_eq("test/sslapitest.c",0x84c,"remove_called",&_LC15,remove_called,0),
          iVar2 == 0)))) goto LAB_0011a310;
      remove_called = 0;
      new_called = 0;
      ...
      if (param_1 == 0x304) {
        if ((param_3 == 0) ||
           ((iVar2 = test_int_eq("test/sslapitest.c",0x85f,"new_called",&_LC49,new_called,1),
            iVar2 != 0 &&
            (iVar2 = test_int_eq("test/sslapitest.c",0x860,"remove_called",&_LC49,remove_called,1),
            iVar2 != 0)))) goto LAB_0011a13b;
        goto LAB_0011a310;
      }
      if ((param_3 != 0) &&
         ((iVar2 = test_int_eq("test/sslapitest.c",0x868,"new_called",&_LC15,new_called,0),
          iVar2 == 0 ||
          (iVar2 = test_int_eq("test/sslapitest.c",0x869,"remove_called",&_LC15,remove_called,0),
          iVar2 == 0)))) goto LAB_0011a310;
LAB_0011a13b:
      SSL_SESSION_free(c);
...
LAB_0011a595:
                  ...
                  if ((iVar2 != 0) &&
                     ((param_3 == 0 ||
                      ((iVar2 = test_int_eq("test/sslapitest.c",0x89c,"new_called",&_LC15,new_called
                                            ,0), iVar2 != 0 &&
...
LAB_0011aaaf:
                                              ...
                                              if (iVar1 != 0) {
                                                ...
                                                if (iVar1 != 0) {
                                                  ...
                                                  "SSL_CTX_sess_set_cache_size(sctx, 1)",&_LC15,
                                                  lVar10,0);
                                                  if (iVar1 != 0) {
...
LAB_0011aa9a:
                                    ...
                                    if (((iVar1 != 0) &&
                                        (iVar1 = test_int_eq("test/sslapitest.c",0x8f2,
                                                             "remove_called",&_LC15,remove_called,0)
                                        , iVar1 != 0)) &&
                                       (iVar1 = test_int_eq("test/sslapitest.c",0x8f3,"get_called",
                                                            &_LC15,get_called,0), iVar1 != 0)) {
                          ...
                          iVar2 = test_int_eq("test/sslapitest.c",0x8ad,"new_called",&_LC15,
                                              new_called,0);
                          if ((iVar2 != 0) &&
...
LAB_0011a71b:
            ...
            iVar2 = test_int_eq("test/sslapitest.c",0x87e,"new_called","numnewsesstick",new_called,
                                iVar1);
            if ((iVar2 != 0) &&
               (iVar2 = test_int_eq("test/sslapitest.c",0x87f,"remove_called",&_LC15,remove_called,0
                                   ), iVar2 != 0)) {
              remove_called = 0;
              new_called = 0;
              iVar2 = SSL_set_session(local_58,c);
              iVar2 = test_true("test/sslapitest.c",0x887,"SSL_set_session(clientssl2, sess1)",
                                iVar2 != 0);
              if ((iVar2 != 0) &&
                 (iVar2 = test_int_eq("test/sslapitest.c",0x88a,"new_called",&_LC15,new_called,0),
                 iVar2 != 0)) {
...

{
  ...
  if (lVar7 == -1) {
    ...
    iVar4 = test_int_eq("test/sslapitest.c",0x781,"SSL_get_tlsext_status_type(clientssl)",&_LC45,
...

{
  ...
  if (*param_2 == 2) {
    ...
    if ((((local_28 != 0) && (iVar1 = OPENSSL_sk_num(), iVar1 == 1)) &&
       ...
       (iVar1 = OCSP_RESPID_match_ex(lVar2,ocspcert,libctx,0), iVar1 != 0)) goto LAB_0011b7fb;
  }
  else if (*param_2 == 1) {
LAB_0011b7fb:
...
LAB_0011bce1:
  ...
  bVar11 = false;
LAB_0011bb31:
  *(undefined8 *)(puVar8 + -0x1410) = 0x11bb39;
  SSL_SESSION_free(session);
...
LAB_0011c52f:
  *(undefined8 *)(puVar6 + -0x1410) = 0x11c539;
        ...
        if (iVar41 != 0) {
          ...
          if (iVar41 != 0) {
            ...
            iVar41 = test_int_eq("test/sslapitest.c",0x6e7,
                                 ...
                                 16000);
            if (iVar41 != 0) {
              iVar41 = test_mem_eq("test/sslapitest.c",0x6ea,&_LC923,&_LC922,cbuf_1,16000,sbuf_0,
                                   16000);
              if (iVar41 != 0) {
                pSVar45 = local_48;
                ...
                if (iVar41 != 0) {
                  ...
                  ;
                  if (iVar41 != 0) {
                    iVar41 = test_mem_eq("test/sslapitest.c",0x6fe,&_LC923,&_LC926,cbuf_1,16000,
                    ...
                    if (iVar41 != 0) {
                      ...
                      iVar41 = test_int_eq("test/sslapitest.c",0x702,
                                           ...
                                           ,iVar41,16000);
                      if (iVar41 != 0) {
                        iVar41 = test_mem_eq("test/sslapitest.c",0x705,&_LC923,&_LC922,cbuf_1,16000,
                                             sbuf_0,16000);
                        if (iVar41 != 0) {
                          memset(cbuf_1,0,16000);
                          iVar41 = test_mem_eq("test/sslapitest.c",0x70a,&_LC923,&_LC926,cbuf_1,
    ...
    if (uVar1 != 0) {
      ...
      if (uVar1 != 0) {
        ...
        iVar3 = test_int_eq("test/sslapitest.c",0x2bda,
                            "SSL_CONF_cmd(cctx, \"DHParameters\", dhfile)",&_LC223,uVar2,2);
        uVar1 = (uint)(iVar3 != 0);
      }
    }
...
LAB_0011e526:
    ...
    if (iVar2 != 0) {
      ...
      local_88 = "xorhmacsig";
LAB_0011e40d:
      ctx = (EVP_PKEY_CTX *)EVP_PKEY_CTX_new_from_name(libctx,pcVar11,0);
...
LAB_0011e452:
        ...
        if (((iVar2 == 0) || (iVar2 = test_ptr("test/sslapitest.c",0x27c6,&_LC943), iVar2 == 0)) ||
           (iVar2 = test_ptr("test/sslapitest.c",0x27c7,&_LC944), iVar2 == 0)) goto LAB_0011e452;
      ...
      if (iVar2 != 0) {
        ...
        if (iVar2 != 0) {
          if (iVar12 == 0) {
            ...
            iVar12 = test_int_eq("test/sslapitest.c",0x2823,
            ...
            if (iVar12 != 0) {
              ...
              iVar12 = test_int_eq("test/sslapitest.c",0x2825,
                                   "SSL_CTX_use_PrivateKey_file(sctx, privkeyfilename, SSL_FILETYPE_PEM)"
                                   ,&_LC49,iVar12,1);
              if (iVar12 != 0) {
LAB_0011eb53:
                iVar12 = SSL_CTX_check_private_key(local_68);
                iVar12 = test_int_eq("test/sslapitest.c",0x282a,"SSL_CTX_check_private_key(sctx)",
                                     &_LC49,iVar12,1);
                if (iVar12 != 0) {
                  iVar12 = create_ssl_objects(local_68,local_70,&local_58,&local_60,0,0);
                  iVar12 = test_true("test/sslapitest.c",0x282d,
                                     "create_ssl_objects(sctx, cctx, &serverssl, &clientssl, NULL, NULL)"
                                     ,iVar12 != 0);
                  if (iVar12 != 0) {
...
LAB_0011ec50:
            ...
            if (iVar12 != 0) {
              ...
              iVar12 = test_int_gt("test/sslapitest.c",0x281b,
                                   "SSL_CONF_cmd(confctx, \"Certificate\", certfilename)",&_LC15,
                                   uVar3,0);
              if (iVar12 != 0) {
                uVar3 = SSL_CONF_cmd(uVar7,"PrivateKey","tls-prov-key.pem");
                iVar12 = test_int_gt("test/sslapitest.c",0x281c,
                                     "SSL_CONF_cmd(confctx, \"PrivateKey\", privkeyfilename)",&_LC15
                                     ,uVar3,0);
                if (iVar12 != 0) {
                  iVar12 = SSL_CONF_CTX_finish(uVar7);
                  iVar12 = test_true("test/sslapitest.c",0x281d,"SSL_CONF_CTX_finish(confctx)",
                                     iVar12 != 0);
                  if (iVar12 != 0) {
...
LAB_0011f1fe:
        ...
        iVar4 = SRP_create_verifier_BN_ex
                          (&_LC985,"password",&local_48,&local_50,*(undefined8 *)(lVar8 + 0x10),
...
LAB_0011f2c8:
          ...
          pcVar10 = (char *)SRP_create_verifier_ex
                                      (&_LC985,"password",value + 2,value + 1,0,0,libctx,0);
    ...
    if (iVar4 != 0) {
      ...
      if (iVar4 != 0) {
        ...
        iVar4 = test_int_gt("test/sslapitest.c",0x1e1f,
                            "SSL_CTX_set_srp_username_callback(sctx, ssl_srp_cb)",&_LC15,uVar5,0);
        if (iVar4 != 0) {
...

{
  ...
  uVar6 = test_true("test/sslapitest.c",0x1d09,
  ...
  s = (SSL *)0x0;
  uVar6 = test_true("test/sslapitest.c",0x1d0e,
    ...
    if (iVar5 != 0) {
      ...
      if ((iVar5 == 0) || (iVar5 = test_ptr("test/sslapitest.c",0x1d18,&_LC286,wbio), iVar5 == 0)) {
        ...
        if (iVar5 != 0) {
          ...
          iVar5 = test_uint_gt("test/sslapitest.c",0x1ccc,
                               "len = BIO_get_mem_data(bio, (char **) &data)",&_LC15,
                               uVar9 & 0xffffffff,0);
          if (iVar5 == 0) {
LAB_0011fc00:
            cVar12 = '\0';
            ...
            if (uVar13 < 4) {
              iVar5 = test_true("test/sslapitest.c",0x1cd8,
...
LAB_0011f936:
            iVar5 = test_true("test/sslapitest.c",0x1cda,
                              "PACKET_forward(&pkt, CLIENT_VERSION_LEN + SSL3_RANDOM_SIZE)",uVar7);
            if (iVar5 == 0) goto LAB_0011fc00;
            uVar7 = 0;
            if (uVar13 != 0) {
              uVar9 = (ulong)*pbVar11;
            ...
            iVar5 = test_true("test/sslapitest.c",0x1cdd,"PACKET_get_length_prefixed_1(&pkt, &pkt2)"
                              ,uVar7);
            if (iVar5 == 0) goto LAB_0011fc00;
...
LAB_0011fc8d:
            ...
            iVar5 = test_true("test/sslapitest.c",0x1cdf,"PACKET_get_length_prefixed_2(&pkt, &pkt2)"
                              ,uVar7);
            if (iVar5 == 0) goto LAB_0011fc00;
            if (local_78._8_8_ == 0) {
LAB_0011fc94:
            ...
            iVar5 = test_true("test/sslapitest.c",0x1ce1,"PACKET_get_length_prefixed_1(&pkt, &pkt2)"
                              ,uVar7);
            if (iVar5 == 0) goto LAB_0011fc00;
            if ((ulong)local_78._8_8_ < 2) {
              uVar7 = 0;
            ...
            iVar5 = test_true("test/sslapitest.c",0x1ce3,"PACKET_as_length_prefixed_2(&pkt, &pkt2)",
                              uVar7);
            if (iVar5 == 0) goto LAB_0011fc00;
            uVar3 = 0;
...
LAB_0011fb96:
              iVar5 = test_true("test/sslapitest.c",0x1ce9,
                                "PACKET_get_length_prefixed_2(&pkt2, &pkt3)",uVar7);
              if (iVar5 == 0) goto LAB_0011fc00;
              uVar9 = uVar13;
            } while (uVar3 != 1);
            uVar7 = local_58._8_8_;
            iVar5 = test_uint_ne("test/sslapitest.c",0x1ced,"PACKET_remaining(&pkt3)",&_LC15,
          ...
          iVar5 = test_true("test/sslapitest.c",0x1d25,"get_MFL_from_client_hello(wbio, &MFL_mode)",
                            uVar7);
          if (iVar5 != 0) {
            iVar5 = test_true("test/sslapitest.c",0x1d28,
                              "max_fragment_len_test[idx_tst] == MFL_mode",cVar1 == cVar12);
            uVar6 = (uint)(iVar5 != 0);
            goto LAB_0011f738;
          }
        }
    ...
    if (param_3 != 0) {
      do {
        ...
        iVar1 = test_int_eq("test/sslapitest.c",0xc4,"hexed[0]","hex_encoded[j]",(int)local_43,
                            (int)*(char *)(param_1 + lVar3 * 2));
        if ((iVar1 == 0) ||
           (iVar1 = test_int_eq("test/sslapitest.c",0xc5,"hexed[1]","hex_encoded[j + 1]",
                                (int)local_42,(int)*(char *)(param_1 + 1 + lVar3 * 2)), iVar1 == 0))
        goto LAB_0012006f;
        lVar3 = lVar3 + 1;
    ...
    do {
      ...
      if (iVar1 == 0) {
        ...
        if (iVar1 == 0) {
          ...
          if (iVar1 == 0) goto LAB_00120398;
          sVar4 = strlen(pcVar2);
          iVar1 = test_size_t_eq("test/sslapitest.c",0xbf,"raw_length * 2","hex_length",uVar7 * 2,
                                 sVar4);
          if (iVar1 == 0) {
LAB_00120730:
            uVar6 = 1;
            ...
            if ((uVar7 != 0) && (1 < sVar4)) {
              ...
              do {
                ...
                iVar1 = test_int_eq("test/sslapitest.c",0xc4,"hexed[0]","hex_encoded[j]",
                                    (int)local_9b,(int)pcVar2[uVar5 * 2]);
                if ((iVar1 == 0) ||
                   (iVar1 = test_int_eq("test/sslapitest.c",0xc5,"hexed[1]","hex_encoded[j + 1]",
                                        (int)local_9a,(int)pcVar2[uVar5 * 2 + 1]), iVar1 == 0))
                goto LAB_00120730;
              } while ((uVar7 != uVar5 + 1) &&
                      (bVar8 = uVar5 != sVar4 - 2 >> 1, uVar5 = uVar5 + 1, bVar8));
            }
          }
...
LAB_00120398:
    ...
    iVar1 = test_size_t_eq("test/sslapitest.c",0x157,"exporter_secret_count",
                           "expected->exporter_secret_count",local_ac,param_4[8]);
    bVar8 = iVar1 != 0;
  }
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
...
LAB_001211f5:
    ...
    if (iVar4 == 0) goto LAB_001211f5;
    iVar4 = test_int_gt("test/sslapitest.c",0x18d,"client_log_buffer_index",&_LC15,
                        _client_log_buffer_index & 0xffffffff,0);
    if (iVar4 == 0) goto LAB_001211f5;
    iVar4 = test_int_gt("test/sslapitest.c",0x18e,"server_log_buffer_index",&_LC15,
...

{
  ...
  if (iVar1 != 0) {
    ...
    if ((iVar1 != 0) &&
       (iVar1 = test_size_t_gt("test/sslapitest.c",0x3188,"bytes_read",&_LC15,param_2,0), iVar1 != 0
       )) {
                    ...
                    if (iVar1 != 0) {
                      ...
                      if (iVar1 != 0) {
                        ...
                        iVar1 = test_int_eq("test/sslapitest.c",0xe19,
                                            ...
                                            ,"SSL_READ_EARLY_DATA_SUCCESS",uVar2,1);
                        if (iVar1 != 0) {
                          iVar1 = test_mem_eq("test/sslapitest.c",0xe1c,&_LC80,&_LC1105,local_468,
                                              local_488,&_LC1102,4);
                          if (iVar1 != 0) {
                            ...
                            if (iVar1 != 0) {
                              ...
                              if (iVar1 != 0) {
                                ...
                                iVar1 = test_true("test/sslapitest.c",0xe23,
                                                  ...
                                                  ,iVar1 != 0);
                                if (iVar1 != 0) {
                                  iVar1 = test_mem_eq("test/sslapitest.c",0xe24,&_LC80,&_LC1109,
                                                      local_468,local_488,&_LC1106,2);
                                  if (iVar1 != 0) {
                                            ...
                                            if (iVar1 != 0) {
                                              ...
                                              if (iVar1 != 0) {
                                                ...
                                                if (iVar1 != 0) {
                                                    ...
                                                    if (iVar1 != 0) {
                                                      ...
                                                      if (iVar1 != 0) {
                                                        ...
                                                        iVar1 = test_int_gt("test/sslapitest.c",
                                                                            0xe99,
                                                  "SSL_accept(serverssl)",&_LC15,iVar1,0);
                                                  if (iVar1 != 0) {
                                                    iVar1 = SSL_write_early_data
                                                                      (local_4a0,&_LC985,4,
                                                                       &local_480);
                                                  ...
                                                  if (iVar1 != 0) {
                                                    ERR_clear_error();
                                                    iVar1 = SSL_write_ex(local_4a0,&_LC1110,1,
                                                                         &local_480);
...
LAB_00122f8e:
        ...
        if ((int)uVar1 < 0x305) {
          if ((int)uVar1 < 0x300) {
            pcVar6 = (char *)0x0;
LAB_0012365b:
            pcVar5 = SSL_get_version(local_38);
            iVar2 = test_str_eq("test/sslapitest.c",0x2d95,"verstr","SSL_get_version(s)",pcVar6,
                                pcVar5);
            ...
            if (iVar2 != 0) {
              ...
              ;
              iVar2 = test_true("test/sslapitest.c",0x2df1,
                                "check_version_string(clientssl, version)",iVar2 != 0);
              if (iVar2 != 0) {
...
switchD_001236eb_default:
            pcVar5 = SSL_get_version(local_40);
            iVar2 = test_str_eq("test/sslapitest.c",0x2d95,"verstr","SSL_get_version(s)",pcVar6,
                                pcVar5);
...
LAB_0012325c:
              ...
              if (iVar2 != 0) {
                ...
                if (iVar2 != 0) {
                  ...
                  if (iVar2 != 0) {
                    ...
                    iVar2 = test_false("test/sslapitest.c",0x2e00,"SSL_is_dtls(clientssl)",
                                       iVar2 != 0);
                    if (iVar2 != 0) {
                      iVar2 = SSL_is_quic(local_38);
                      iVar2 = test_false("test/sslapitest.c",0x2e01,"SSL_is_quic(serverssl)",
                                         iVar2 != 0);
                      if (iVar2 != 0) {
        ...
        if (uVar1 == 0xfefd) {
          pcVar6 = SSL_get_version(local_38);
          iVar2 = test_str_eq("test/sslapitest.c",0x2d95,"verstr","SSL_get_version(s)","DTLSv1.2",
                              pcVar6);
          iVar2 = test_true("test/sslapitest.c",0x2df0,"check_version_string(serverssl, version)",
                            iVar2 != 0);
          if (iVar2 == 0) goto LAB_00122f8e;
LAB_00123746:
          ...
          pcVar6 = SSL_get_version(local_38);
          iVar2 = test_str_eq("test/sslapitest.c",0x2d95,"verstr","SSL_get_version(s)","DTLSv1",
                              pcVar6);
          iVar2 = test_true("test/sslapitest.c",0x2df0,"check_version_string(serverssl, version)",
                            iVar2 != 0);
          if (iVar2 == 0) goto LAB_00122f8e;
...

{
  ...
  if (((param_1 - 5U < 2) || (param_1 == 2)) && (uVar2 = is_fips, is_fips == 1)) goto LAB_00124300;
      ...
      if (iVar1 != 0) {
        ...
        if (iVar1 != 0) {
          ...
          if (iVar1 != 0) {
            ...
            pcVar7 = "Hello";
            iVar1 = test_mem_eq("test/sslapitest.c",0x11c8,&_LC80,&_LC569,local_58,local_e8,"Hello",
                                5);
            if (iVar1 != 0) {
              ...
              if (iVar1 != 0) {
                ...
                iVar1 = test_int_eq("test/sslapitest.c",0x11cb,"SSL_connect(clientssl)",&_LC49,iVar1
                                    ,1);
                if (iVar1 != 0) {
                  iVar1 = SSL_accept(local_f8);
                  iVar1 = test_int_eq("test/sslapitest.c",0x11cc,"SSL_accept(serverssl)",&_LC49,
                                      iVar1,1);
                  if (iVar1 != 0) {
                    ...
                    if (iVar1 != 0) {
                      ...
                      if (iVar1 != 0) {
                        ...
                        iVar1 = test_true("test/sslapitest.c",0x11d4,
                                          ...
                                          iVar1 != 0);
                        if (iVar1 != 0) {
                          iVar1 = test_mem_eq("test/sslapitest.c",0x11d5,&_LC80,&_LC534,local_58,
                                              local_e8,"World.",6);
                          uVar2 = (uint)(iVar1 != 0);
                          goto LAB_00124284;
                        }

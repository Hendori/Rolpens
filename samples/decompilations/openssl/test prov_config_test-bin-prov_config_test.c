  ...
  if (iVar1 != 0) {
    ...
    if (iVar1 != 0) {
      ...
      *(undefined8 *)(pcVar3 + 8) = uVar5;
      ...
      CRYPTO_free(__dest);
      if (iVar1 == -1) {
        uVar7 = test_skip("test/prov_config_test.c",0x5e,
      ...
      if (iVar1 != 0) {
        ...
        if (iVar1 != 0) {
          ...
          iVar1 = test_true("test/prov_config_test.c",0x67,
                            "OSSL_LIB_CTX_load_config(ctx, pathedconfig)",iVar1 != 0);
          if (iVar1 == 0) {
LAB_00100200:
            uVar2 = 0;
          }
            ...
            iVar1 = test_ptr("test/prov_config_test.c",0x6b,
                             "prov = OSSL_PROVIDER_load(ctx, \"test\")",uVar6);
...

{
  ...
  iVar1 = test_true("test/prov_config_test.c",0x20,"OSSL_LIB_CTX_load_config(ctx, configfile)",
                    iVar1 != 0);
  if (iVar1 != 0) {
    iVar1 = OSSL_LIB_CTX_load_config(uVar2,configfile);
    iVar1 = test_true("test/prov_config_test.c",0x22,"OSSL_LIB_CTX_load_config(ctx, configfile)",
                      iVar1 != 0);
    if (iVar1 != 0) {
...

{
  ...
  if (iVar1 != 0) {
    ...
    iVar1 = test_false("test/prov_config_test.c",0x3a,
                       "OSSL_LIB_CTX_load_config(ctx, recurseconfigfile)",iVar1 != 0);
    if (iVar1 != 0) {
...

{
  ...
  if (iVar1 == 0) {
    ...
    if (iVar1 != 0) {
      ...
      iVar1 = test_ptr("test/prov_config_test.c",0x82,"recurseconfigfile = test_get_argument(1)",
                       recurseconfigfile);
      if (iVar1 != 0) {
        pathedconfig = test_get_argument(2);
        iVar1 = test_ptr("test/prov_config_test.c",0x85,"pathedconfig = test_get_argument(2)",
                         pathedconfig);
        if (iVar1 != 0) {

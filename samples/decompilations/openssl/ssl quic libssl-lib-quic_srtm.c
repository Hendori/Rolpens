...

{
  ...
  if (((*(byte *)(param_1 + 0x18) & 1) == 0) &&
     (local_58 = param_2, ptr = (long *)OPENSSL_LH_retrieve(*(undefined8 *)(param_1 + 8),auStack_68)
     , ptr != (long *)0x0)) {
    plVar2 = (long *)0x0;
    do {
      if (param_3 == ptr[3]) {
        if (plVar2 == (long *)0x0) {
          ...
          plVar2[1] = ptr[1];
LAB_001005fa:
          plVar2 = (long *)OPENSSL_LH_retrieve(*(undefined8 *)(param_1 + 0x10),ptr);
    ...
    } while ((param_3 <= (ulong)ptr[3]) &&
            (plVar3 = ptr + 1, plVar2 = ptr, ptr = (long *)*plVar3, (long *)*plVar3 != (long *)0x0))
    ;
  }
  uVar4 = 0;
LAB_00100588:

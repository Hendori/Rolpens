...
ulong aesni_cbc_hmac_sha1_cipher
...
LAB_0010014c:
  ...
  if ((int)uVar15 == 0) {
    if (puVar32 != (undefined8 *)0xffffffffffffffff) {
      if (CONCAT11(*(undefined1 *)(lVar14 + 0x21c + (long)puVar32),
                   *(undefined1 *)(lVar14 + 0x21d + (long)puVar32)) < 0x302) {
...
LAB_001004d2:
        ...
        do {
          ...
          *(byte *)(lVar14 + 0x1d0 + (ulong)uVar13) =
               ~((byte)((ulong)-lVar22 >> 0x38) | bVar3) & 0x80 |
               *(byte *)((long)local_c8 + lVar22 + lVar16) & bVar3;
          uVar33 = uVar15;
          if (uVar13 == 0x3f) {
      ...
      lVar22 = (ulong)(0x40 - *(int *)(lVar14 + 0x210)) +
               ((long)param_4 - 0x154U & 0xffffffffffffffc0);
...
LAB_00100777:
      ...
      if (uVar29 < 0x40) {
LAB_00100784:
        puVar32 = (undefined8 *)(lVar14 + 0x1d0 + uVar28);
        uVar17 = 0x40 - uVar28;
        uVar13 = (uint)uVar17;
        if (uVar13 < 8) {
          if ((uVar17 & 4) == 0) {
          ...
          *(undefined8 *)((long)puVar32 + ((uVar17 & 0xffffffff) - 8)) = 0;
          uVar13 = uVar13 + ((int)puVar32 - (int)((ulong)(puVar32 + 1) & 0xfffffffffffffff8)) &
                   0xfffffff8;
          if (7 < uVar13) {
            uVar17 = 0;
            do {
...
LAB_001009c8:
    ...
    if (puVar32 == (undefined8 *)0xffffffffffffffff) {
      if (puVar18 < param_4) {
        ...
        puVar32 = param_4;
LAB_001005e6:
        uVar15 = (long)puVar32 - (long)puVar27;
        if (0x3f < uVar15) {
          puStack_d0 = (undefined8 *)0x10061d;
          sha1_update(lVar14 + 0x1b4,puVar24,puVar18);
          aesni_cbc_sha1_enc(param_3,param_2,uVar15 >> 6,lVar14,param_1 + 0x28,lVar14 + 0x1b4,
                             (long)puVar27 + (long)param_3);
...
LAB_001001ff:
      ...
      if (puVar32 != param_4) {
        ...
        *(undefined8 *)(lVar14 + 0x20c) = *(undefined8 *)(lVar14 + 0x1ac);
        ...
        if (puVar19 < param_4) {
          memset((void *)((long)param_2 + (long)puVar19),((uint)param_4 - 1) - (int)puVar19 & 0xff,
                 (long)param_4 + (-0x14 - (long)puVar32));
        }
...
LAB_00101eac:
    ...
    do {
      ...
      *(uchar *)((long)puVar27 + 0xc) = (uchar)uVar8;
      ...
      uVar1 = (uVar28 | uVar18 >> 0x28 | uVar20 >> 0x18 | uVar9 >> 8 | uVar10 << 8 | uVar11 << 0x18
               | uVar12 << 0x28 | uVar13) + lVar16;
      *puVar27 = uVar1 >> 0x38 | (uVar1 & 0xff000000000000) >> 0x28 |
                 (uVar1 & 0xff0000000000) >> 0x18 | (uVar1 & 0xff00000000) >> 8 |
                 (uVar1 & 0xff000000) << 8 | (uVar1 & 0xff0000) << 0x18 | (uVar1 & 0xff00) << 0x28 |
                 uVar1 << 0x38;
      *(uint *)(puVar27 + 1) =
           ((uVar8 & 0xff00 | (uint)bVar19) << 8 | (uint)bVar3) << 8 | (uint)bVar4;
      puVar23 = *ppuVar25;
      uVar1 = puVar23[1];
...
LAB_0010113c:
    ...
    while( true ) {
      ...
      lVar17 = __memcpy_chk(puVar27,(ulong)(uint)(*(int *)((long)local_740 + lVar16) * 0x40) +
                                    *(long *)((long)local_740 + lVar16 + -8),(ulong)uVar29,
                            lVar16 * -8 + 0x400);
    ...
    local_508[0] = CONCAT44(uVar24 | uVar6 >> 8 | uVar8 << 8 | uVar22,
    ...
    while( true ) {
      ...
      *puVar26 = CONCAT44(uVar6 >> 0x18 | (uVar6 & 0xff0000) >> 8 | (uVar6 & 0xff00) << 8 |
                          uVar6 << 0x18,
                          uVar29 >> 0x18 | (uVar29 & 0xff0000) >> 8 | (uVar29 & 0xff00) << 8 |
                          uVar29 << 0x18);
      puVar26[1] = CONCAT44(uVar8 >> 0x18 | (uVar8 & 0xff0000) >> 8 | (uVar8 & 0xff00) << 8 |
                            uVar8 << 0x18,

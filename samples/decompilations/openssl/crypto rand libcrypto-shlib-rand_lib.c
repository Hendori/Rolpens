...

{
  ...
  if (lVar4 != 0) {
    ...
    if (lVar7 != 0) {
LAB_00100cb5:
      iVar1 = EVP_RAND_generate(lVar7,param_2,param_3,param_4,0,0,0);
      return iVar1;
    }
    lVar7 = rand_get0_primary(param_1,lVar4);
    if (((lVar7 != 0) && (lVar5 = ossl_lib_ctx_get_concrete(param_1), lVar5 != 0)) &&
       ((lVar6 = CRYPTO_THREAD_get_local(lVar4 + 0x28), lVar6 != 0 ||
        (iVar1 = ossl_init_thread_start(0,lVar5,rand_delete_thread_state), iVar1 != 0)))) {
...
LAB_00100e95:
    ...
    lVar7 = rand_get0_primary(param_1,lVar4);
    if (((lVar7 != 0) && (lVar5 = ossl_lib_ctx_get_concrete(param_1), lVar5 != 0)) &&
       ((lVar6 = CRYPTO_THREAD_get_local(lVar4 + 0x2c), lVar6 != 0 ||
        (iVar1 = ossl_init_thread_start(0,lVar5,rand_delete_thread_state), iVar1 != 0)))) {
      lVar7 = rand_new_drbg(lVar5,lVar7,0x10000,0x1a4);
...

{
  ...
  if (lVar2 != 0) {
    ...
    if ((lVar3 != 0) && (lVar4 = ossl_lib_ctx_get_concrete(param_1), lVar4 != 0)) {

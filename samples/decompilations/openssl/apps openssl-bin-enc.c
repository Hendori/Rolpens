...
LAB_001003b0:
  ...
  if (iVar13 != 0) {
    if ((local_1a8 == (EVP_CIPHER *)0x0) || (iVar13 = EVP_CIPHER_get_mode(), iVar13 != 0x10002)) {
      bVar3 = false;
      bVar9 = true;
      bVar2 = false;
      bVar8 = true;
    ...
    if ((local_240 == (BIO *)0x0) || (iVar13 = opt_md(local_240,&local_1a0), iVar13 != 0)) {
      ...
      if (((int)len < 0x50) && ((uVar12 & 1) != 0)) {
        ...
        len = 0x50;
LAB_001004b8:
        iVar28 = (-(uint)(local_21c == 0) & 0xffff7fff) + 0x8003;
...
LAB_00100527:
        if (local_240 != (BIO *)0x0) {
          ...
          if ((local_1d8 != 0) &&
             (iVar11 = app_passwd(local_1d8,0,&local_198), puVar29 = local_198, iVar11 == 0)) {
            lVar24 = 0;
            lVar26 = 0;
            pBVar22 = (BIO *)0x0;
            uVar12 = 1;
          ...
          if (((puVar29 != (uchar *)0x0) || (local_1a8 == (EVP_CIPHER *)0x0)) ||
             (local_258 != 0 || local_1f8 != 0)) goto LAB_00100614;
          pcVar17 = "decryption";
          if (local_21c != 0) {
            pcVar17 = "encryption";
          }
  ...
  while (-1 < iVar11) {
LAB_001005c8:
    uVar16 = EVP_CIPHER_get0_name(local_1a8);
...
LAB_0010146d:
  ...
  goto LAB_001008f9;
LAB_00100614:
  local_238 = (BIO *)bio_open_default(local_230,0x77,iVar28);
  if (local_238 == (BIO *)0x0) {
    lVar24 = 0;
    lVar26 = 0;
    pBVar22 = (BIO *)0x0;
    ...
    if (bVar8) {
      do {
        ...
        if ((((int)lVar19 == 0) && (lVar19 = BIO_ctrl(local_218,2,0,(void *)0x0), (int)lVar19 != 0))
           || (iVar11 = BIO_read(local_218,local_248,len), iVar11 < 1)) goto LAB_0010109c;
...
LAB_00100ffd:
    ...
    lVar19 = BIO_ctrl(local_218,10,0,(void *)0x0);
    if ((((int)lVar19 != 0) || (lVar19 = BIO_ctrl(local_218,2,0,(void *)0x0), (int)lVar19 == 0)) &&
       (iVar11 = BIO_read(local_218,local_248,len), 0 < iVar11)) {
...
LAB_0010109c:
    lVar19 = BIO_ctrl(local_1e0,0xb,0,(void *)0x0);
    if ((int)lVar19 != 0) {
      uVar12 = uVar30;
      if (uVar30 != 0) {
...
LAB_00101335:
            ...
            if (local_20c != 0) {
              ...
              if (0 < iVar11) {
                ...
                for (lVar19 = 0; iVar11 = EVP_CIPHER_get_key_length(local_1a8), (int)lVar19 < iVar11
                    ; lVar19 = lVar19 + 1) {
              ...
              if (0 < iVar11) {
                ...
                for (lVar19 = 0; iVar11 = EVP_CIPHER_get_iv_length(local_1a8), (int)lVar19 < iVar11;
                    lVar19 = lVar19 + 1) {
...
LAB_0010175d:
          BIO_printf(_bio_err,pcVar17,local_1f0);
...
LAB_0010164f:
        ...
        if (lVar24 != 0) {
          ...
          if (lVar19 != 0) {
            ...
            if (lVar26 == 0) {
              ...
              iVar11 = EVP_CIPHER_get_iv_length(local_1a8);
              if ((local_200 != (uchar *)0x0) || (puVar27 = (uchar *)0x0, bVar9)) {
                puVar27 = local_168;
              }
              iVar11 = EVP_CipherInit_SKEY(local_1b0,local_1a8,lVar26,puVar27,(long)iVar11,local_21c
                                           ,0,in_R9);
      ...
      if (bVar5) {
        if (bVar1) {
          ...
          puVar27 = (uchar *)0x0;
LAB_00100700:
          uVar20 = (ulong)(uint)(iVar28 + iVar14);
          in_R9 = local_1a0;
          puVar31 = local_108;
          iVar11 = PKCS5_PBKDF2_HMAC(puVar29,(int)local_1d8,puVar27,iVar11,iVar13,local_1a0,
                                     iVar28 + iVar14,local_108);
          if (iVar11 == 0) {
...
LAB_0010120e:
          ...
          in_R9 = (EVP_MD *)0x1;
          iVar11 = EVP_BytesToKey(local_1a8,local_1a0,puVar27,puVar29,(int)local_1d8,1,local_148,
                                  local_168);
          if (iVar11 == 0) {
...
LAB_001007c6:
        if (local_1f8 != 0) {
LAB_001007ce:
          uVar15 = EVP_CIPHER_get_key_length(local_1a8);
        ...
        if (local_21c == 0) {
          ...
          if ((local_20c == 2) ||
             ((iVar11 = BIO_write(local_1e0,"Salted__",8), iVar11 == 8 &&
              (iVar11 = BIO_write(local_1e0,local_158,local_1b4), iVar11 == local_1b4))))
          goto LAB_001006cb;
          BIO_printf(_bio_err,"error writing output file\n");
        }
      }
...
LAB_00100351:
  while (0x1e < iVar13) {
    ...
    if (0x5de < iVar13) {
      if ((3 < iVar13 - 0x641U) || (iVar13 = opt_provider(iVar13), iVar13 != 0))
      goto switchD_0010036a_caseD_0;
      goto LAB_001008c4;
    }
...
switchD_0010036a_caseD_ffffffff:
  pcVar17 = "%s: Use -help for summary.\n";
LAB_001008b6:
  BIO_printf(_bio_err,pcVar17,uVar16);
LAB_001008c4:
  uVar12 = 1;
LAB_001008d9:
  local_248 = (void *)0x0;

...
LAB_001001f8:
  ...
  if (*(X509 **)(param_1 + 0x10) == (X509 *)0x0) {
    if (*(long *)(param_1 + 0x18) == 0) goto LAB_001001f8;
  ...
  if (param_3 == 0) {
    do {
      ...
      pXVar3 = X509_NAME_get_entry(name,iVar2);
      pAVar4 = X509_NAME_ENTRY_get_data(pXVar3);
      pAVar4 = ASN1_STRING_dup(pAVar4);
      if (pAVar4 == (ASN1_STRING *)0x0) goto LAB_00100150;
      a = GENERAL_NAME_new();
      if (a == (GENERAL_NAME *)0x0) goto LAB_00100152;
      (a->d).rfc822Name = pAVar4;
      a->type = 1;
    ...
    do {
      ...
      pAVar4 = X509_NAME_ENTRY_get_data(pXVar3);
      pAVar4 = ASN1_STRING_dup(pAVar4);
      X509_NAME_delete_entry(name,iVar2);
      iVar2 = iVar2 + -1;
  ...
  case 0:
    ...
    if (iVar2 == 0x4b9) {
      ...
      if (iVar2 == 0x289) {
        ...
        if (iVar2 != 0x4b8) goto LAB_00100510;
        pAVar4 = ((gen->d).ediPartyName)->partyName;
        if (pAVar4->length == 0xc) {
          piVar1 = (int *)pAVar4->data;
          iVar2 = x509v3_add_len_value_uchar
      ...
      if (pOVar6 != (OTHERNAME *)0x0) {
        ...
        if (pAVar7 == (ASN1_TYPE *)0x0) {
          ...
          if (pcVar5 == (char *)0x0) {
            ...
            CRYPTO_free(pcVar5);
            pOVar6 = (a->d).otherName;
            if (pOVar6->type_id != (ASN1_OBJECT *)0x0) goto LAB_00100a32;
          }
        }
...
LAB_00101219:
      ...
      if ((param_2->flags & 1U) == 0) {
        if (param_2->issuer_cert == (X509 *)0x0) goto LAB_001011e0;
        iVar2 = X509_get_ext_by_NID(param_2->issuer_cert,0x55,-1);
        if (iVar2 < 0) goto LAB_001010c4;
...
LAB_00101338:
          ...
          if (((iVar2 == 0) && (cnf->value != (char *)0x0)) &&
            ...
            goto joined_r0x001013d8;
          }
          pGVar4 = v2i_GENERAL_NAME(param_1,param_2,cnf);
          if (pGVar4 == (GENERAL_NAME *)0x0) goto LAB_001013e0;

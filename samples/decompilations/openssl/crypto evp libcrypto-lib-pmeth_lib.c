...
LAB_00100890:
      ...
      if ((iVar3 != 0) && (param_6 = iVar3, iVar3 != -1)) goto LAB_001005b3;
...
LAB_0010068c:
      if (*(long *)(param_2 + 0x18) == 0) goto LAB_00100978;
    ...
    if (local_158 != 0) {
      ...
      if (((iVar2 == 0) || (iVar1 = iVar2, iVar3 == -1)) || (iVar1 = iVar3, iVar2 == iVar3)) {
        ...
        if ((ctx == (EVP_PKEY_CTX *)0x0) ||
           ((pEVar4 == (EVP_PKEY_METHOD *)0x0 && (ctx == (EVP_PKEY_CTX *)0x0)))) goto LAB_00100627;
        param_3 = (ENGINE *)0x0;
        goto LAB_00100713;
      }
      ERR_new();
...
LAB_0010081f:
        if (pEVar4 == (EVP_PKEY_METHOD *)0x0) goto LAB_001008cd;
      }
LAB_00100830:
      ctx = (EVP_PKEY_CTX *)CRYPTO_zalloc(0xb0,"crypto/evp/pmeth_lib.c",0x129);
      if (ctx == (EVP_PKEY_CTX *)0x0) {
        ...
        *(int **)(ctx + 0x88) = param_2;
        if ((pEVar4 == (EVP_PKEY_METHOD *)0x0) ||
           ((*(code **)(pEVar4 + 8) == (code *)0x0 ||
            (iVar3 = (**(code **)(pEVar4 + 8))(ctx), 0 < iVar3)))) goto LAB_0010079e;
...
LAB_00100d5b:
    ...
    if (1 < iVar1 + 1U) {
      ...
      if (e == (ENGINE *)0x0) {
        if (((app_pkey_methods == 0) ||
            (local_148[0] = iVar1, iVar3 = OPENSSL_sk_find(app_pkey_methods,local_148), iVar3 < 0))
           || (pEVar6 = (EVP_PKEY_METHOD *)OPENSSL_sk_value(app_pkey_methods,iVar3),
...
LAB_00100bef:
        ...
        *(undefined8 *)(ctx + 0x88) = 0;
        if (((pEVar6 != (EVP_PKEY_METHOD *)0x0) && (*(code **)(pEVar6 + 8) != (code *)0x0)) &&
           (iVar1 = (**(code **)(pEVar6 + 8))(ctx), iVar1 < 1)) {
          *(undefined8 *)(ctx + 0x78) = 0;
          EVP_PKEY_CTX_free(ctx);
          ctx = (EVP_PKEY_CTX *)0x0;
        }
    ...
    iVar3 = -1;
LAB_00100b95:
    lVar4 = EVP_KEYMGMT_fetch(param_1,param_2,param_3);
    if (lVar4 != 0) {
...
/* WARNING: Removing unreachable block (ram,0x001011d8) */
...
LAB_001011e0:
        ...
        if (ctx != (EVP_PKEY_CTX *)0x0) {
          ...
          *(undefined8 *)(ctx + 0x88) = 0;
          ...
          if ((*(code **)(pEVar2 + 8) != (code *)0x0) &&
             (iVar1 = (**(code **)(pEVar2 + 8))(ctx), iVar1 < 1)) {
            *(undefined8 *)(ctx + 0x78) = 0;
            pEVar5 = (EVP_PKEY_CTX *)0x0;
            EVP_PKEY_CTX_free(ctx);
          }
    ...
    if (((app_pkey_methods != 0) &&
        (local_148[0] = id, iVar1 = OPENSSL_sk_find(app_pkey_methods,local_148), -1 < iVar1)) &&
       (pEVar2 = (EVP_PKEY_METHOD *)OPENSSL_sk_value(app_pkey_methods,iVar1),
       pEVar2 != (EVP_PKEY_METHOD *)0x0)) goto LAB_001011e0;
...
LAB_001019a7:
                    /* WARNING: Could not recover jumptable at 0x001019b4. Too many branches */
...
LAB_00101a57:
    if (((uVar1 & 0x600) == 0) || (lVar4 = *(long *)(param_1 + 10), lVar4 == 0)) goto LAB_00101a00;
  }
  else {
    lVar4 = *(long *)(param_1 + 10);
    if (lVar4 == 0) {
...
LAB_001019f1:
    if ((uVar1 & 0x600) == 0) goto LAB_00101a00;
  }
...
LAB_00101b0c:
      if ((uVar1 & 0x3000) == 0) goto LAB_00101b78;
    }
    lVar4 = *(long *)(param_1 + 10);
...
LAB_00101aed:
                    /* WARNING: Could not recover jumptable at 0x00101afa. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (cmd == 0xf) {
    ...
    if ((optype != -1) && ((optype & *(uint *)ctx) == 0)) {
      ...
      uVar4 = 0x5d6;
LAB_00102262:
      ERR_set_debug("crypto/evp/pmeth_lib.c",uVar4,"evp_pkey_ctx_store_cached_data");
      ERR_set_error(6,0x94,0);
      ERR_clear_last_mark();
      return -1;
    }
...

{
  ...
  if ((*(uint *)param_1 & 0x800) == 0) {
    ...
    uVar6 = 0x40f;
LAB_00102a91:
    ERR_set_debug("crypto/evp/pmeth_lib.c",uVar6,pcVar5);
    ERR_set_error(6,0x93,0);
    iVar2 = -2;
  }
  else {
      ...
      if (param_3 != 0) {
        ...
        if (lVar3 != 0) {
          ...
          if (lVar3 != 0) {
            ...
            if (((iVar2 != 0) && (local_78 != -1)) && (lVar3 = local_78 + param_3, lVar3 != 0)) {
              ...
              if (lVar4 != 0) {
                ...
                if (lVar1 == 0) {
LAB_00102a2b:
                  memcpy((void *)(lVar1 + lVar4),param_2,(long)param_3);
...
LAB_00104240:
    ...
    if ((iVar1 != 0) && (iVar1 = strcmp(type,"hexdistid"), iVar1 != 0)) goto LAB_00104240;
    CRYPTO_free(*(void **)(ctx + 0x40));
    CRYPTO_free(*(void **)(ctx + 0x38));
    *(undefined1 (*) [16])(ctx + 0x38) = (undefined1  [16])0x0;
...
LAB_0010422d:
  ...
  if ((*(long *)(ctx + 0x78) != 0) &&
     (UNRECOVERED_JUMPTABLE = *(code **)(*(long *)(ctx + 0x78) + 200),
  ...
  uVar5 = 0x571;
LAB_00104292:
  ERR_set_debug("crypto/evp/pmeth_lib.c",uVar5,"evp_pkey_ctx_ctrl_str_int");
  ERR_set_error(6,0x93,0);
  return -2;
}
...

{
    ...
    if (iVar1 < 2) {
      if (-1 < iVar1) {
        if ((*(long *)(param_1 + 0x1e) != 0) &&
           (UNRECOVERED_JUMPTABLE = *(code **)(*(long *)(param_1 + 0x1e) + 200),
           UNRECOVERED_JUMPTABLE != (code *)0x0)) {
  ...
  uVar2 = evp_pkey_ctx_ctrl_int
                    (param_1,0xffffffff,*param_1,0xf,*(undefined8 *)(param_1 + 0x12),uVar2);
  return uVar2;
}

...

{
  ...
  if (x == (stack_st_X509_EXTENSION *)0x0) {
    if (idx == (int *)0x0) goto LAB_001004b7;
  }
  else {
    if (idx == (int *)0x0) {
      ex = (X509_EXTENSION *)0x0;
      for (iVar4 = 0; iVar1 = OPENSSL_sk_num(x), iVar4 < iVar1; iVar4 = iVar4 + 1) {
        ex_00 = (X509_EXTENSION *)OPENSSL_sk_value(x,iVar4);
        pAVar2 = X509_EXTENSION_get_object(ex_00);
        iVar1 = OBJ_obj2nid(pAVar2);
        if ((nid == iVar1) && (bVar5 = ex != (X509_EXTENSION *)0x0, ex = ex_00, bVar5)) {
          if (crit == (int *)0x0) {
            return (void *)0x0;
          }
          *crit = -2;
...
LAB_00100485:
    ...
    for (; iVar1 = OPENSSL_sk_num(x), iVar4 < iVar1; iVar4 = iVar4 + 1) {
      ex = (X509_EXTENSION *)OPENSSL_sk_value(x,iVar4);
      pAVar2 = X509_EXTENSION_get_object(ex);
      iVar1 = OBJ_obj2nid(pAVar2);
      if (iVar1 == nid) {
        *idx = iVar4;
        if (ex != (X509_EXTENSION *)0x0) goto LAB_00100485;
        break;
      }
    }
  }
...
LAB_00100616:
    ...
    uVar2 = 0x66;
    if ((uVar6 - 3 & 0xfffffffffffffffd) == 0) goto LAB_00100616;
  }
  pXVar3 = X509V3_EXT_i2d(nid,crit,value);
  if (pXVar3 != (X509_EXTENSION *)0x0) {
    psVar5 = *x;

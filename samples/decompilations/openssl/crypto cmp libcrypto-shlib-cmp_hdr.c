...

{
  ...
  if (param_1 != (undefined8 *)0x0) {
    ...
    if ((iVar1 != 0) && (local_18 < 0x80000000)) goto LAB_00100058;
  }
  local_18 = 0xffffffff;
LAB_00100058:
...
undefined8 ossl_cmp_hdr_set_transactionID(undefined8 *param_1,long param_2)

{
  ...
  if (lVar3 == 0) {
    ...
    if ((ptr == (void *)0x0) || (iVar1 = RAND_bytes_ex(*param_1,ptr,0x10,0), iVar1 < 1)) {
      ERR_new();
    ...
    iVar1 = ossl_cmp_asn1_octet_string_set1_bytes(param_1 + 0x23,ptr,0x10);
    CRYPTO_free(ptr);
    if (iVar1 == 0) {
      return 0;
    }
    ptr_00 = i2s_ASN1_OCTET_STRING((X509V3_EXT_METHOD *)0x0,(ASN1_OCTET_STRING *)param_1[0x23]);
    if (ptr_00 != (char *)0x0) {
      ossl_cmp_print_log(7,param_1,"ossl_cmp_hdr_set_transactionID","crypto/cmp/cmp_hdr.c",0x107,
                         "DEBUG","Starting new transaction with ID=%s",ptr_00);
    }
    CRYPTO_free(ptr_00);
    lVar3 = param_1[0x23];
  }
...
bool ossl_cmp_hdr_init(undefined8 *param_1,long param_2)

{
  ...
  if ((param_2 != 0) && (iVar1 = ossl_cmp_hdr_set_pvno(param_2,2), iVar1 != 0)) {
    pXVar3 = (X509 *)param_1[0x19];
    if ((pXVar3 == (X509 *)0x0) && (pXVar3 = (X509 *)param_1[0x36], pXVar3 == (X509 *)0x0)) {
      if (param_1[0x37] == 0) {
        pXVar2 = (X509_NAME *)param_1[0x30];
      }
      else {
    ...
    if (iVar1 != 0) {
      pXVar3 = (X509 *)param_1[0x21];
      if (pXVar3 == (X509 *)0x0) {
        if ((X509 *)param_1[0x12] == (X509 *)0x0) {
          pXVar3 = (X509 *)param_1[0x2d];
          if ((pXVar3 == (X509 *)0x0) &&
             ((pXVar3 = (X509 *)param_1[0x36], pXVar3 != (X509 *)0x0 ||
              (pXVar3 = (X509 *)param_1[0x19], pXVar3 != (X509 *)0x0)))) {
            pXVar3 = (X509 *)X509_get_issuer_name(pXVar3);
          }
        }
        else {
          pXVar3 = (X509 *)X509_get_subject_name((X509 *)param_1[0x12]);
        }
      }
      ...
      if ((((iVar1 != 0) && (iVar1 = ossl_cmp_hdr_update_messageTime(param_2), iVar1 != 0)) &&
        ...
        if ((ptr == (void *)0x0) || (iVar1 = RAND_bytes_ex(*param_1,ptr,0x10,0), iVar1 < 1)) {
          ...
          iVar1 = ossl_cmp_asn1_octet_string_set1_bytes(param_2 + 0x40,ptr,0x10);
          CRYPTO_free(ptr);
          if ((iVar1 != 0) &&

...

{
  ...
  *param_4 = lVar6;
  if (lVar6 != 0) {
    ...
    if (iVar4 == -1) {
LAB_001005e0:
      iVar4 = BIO_get_line(param_1,&local_448,0x400);
      local_44c = iVar4;
      if (0 < iVar4) {
        sVar5 = strlen(param_3);
        ...
        if (cVar9 != '\0') {
          ...
          if (bVar1) {
            if ((b != (BIO *)0x0) && (iVar2 = OPENSSL_sk_push(lVar6,b), iVar2 == 0))
            goto LAB_001005b8;
            pBVar7 = BIO_s_mem();
            b = BIO_new(pBVar7);
      ...
      while (local_44c = BIO_get_line(param_1,&local_448,0x400), 0 < local_44c) {
        if (((iVar4 + 1 < local_44c) && (local_448 == 0x2d2d)) &&
           (iVar2 = strncmp(local_446,param_3,sVar5), iVar2 == 0)) {
          if ((local_446[sVar5] == '-') && (local_446[sVar5 + 1] == '-')) goto LAB_00100522;
          bVar1 = true;
          cVar9 = cVar9 + '\x01';
        }
          ...
          if (bVar1) {
            if ((b != (BIO *)0x0) && (iVar3 = OPENSSL_sk_push(lVar6,b), iVar3 == 0)) break;
            pBVar7 = BIO_s_mem();
            b = BIO_new(pBVar7);
            if (b == (BIO *)0x0) goto LAB_001005c0;
            BIO_ctrl(b,0x82,0,(void *)0x0);
...
LAB_00100930:
    ...
    if (0 < iVar4) {
      if ((ptr == (undefined8 *)0x0) || (iVar4 = ossl_ctype_check((int)local_448[0],8), iVar4 == 0))
      {
        iVar4 = 1;
      }
      else {
...
LAB_00101080:
  pcVar10 = (char *)0x0;
LAB_00100fda:
  ptr = (undefined8 *)mime_hdr_new(__s,pcVar10);
  if (ptr != (undefined8 *)0x0) {
    ...
    if (iVar4 != 0) {
      ...
      if (cVar3 != '\0') {
LAB_00100b29:
        if ((cVar3 != '\r') && (__s = pcVar9, cVar3 != '\n')) {
joined_r0x00100b45:
          while (pcVar10 = pcVar9 + 1, cVar3 != '=') {
            cVar3 = *pcVar10;
            pcVar9 = pcVar10;
            if (((cVar3 == '\0') || (cVar3 == '\r')) || (cVar3 == '\n')) goto LAB_00100e40;
          }
...
LAB_00101070:
  pcVar10 = (char *)0x0;
LAB_00100b0f:
  mime_hdr_addparam_isra_0(ptr,__s,pcVar10);
  cVar3 = *pcVar9;
...
LAB_00100e2c:
  mime_hdr_addparam_isra_0(ptr,__s,pcVar10);
LAB_00100e40:
  if (pcVar9 == local_448) goto LAB_00100e4d;
  goto LAB_00100930;
LAB_00100e4d:
...
undefined8
SMIME_write_ASN1_ex(BIO *param_1,ASN1_VALUE *param_2,BIO *param_3,uint param_4,int param_5,
                   int param_6,undefined8 param_7,ASN1_ITEM *param_8,undefined8 param_9)
...
LAB_00102056:
    ...
    if (0 < iVar6) {
      ...
      auVar20[0] = -(SUB161(__LC26,0) < (char)local_68[0]);
      auVar20[1] = -(SUB161(__LC26,1) < (char)local_68[1]);
      auVar20[2] = -(SUB161(__LC26,2) < (char)local_68[2]);
      auVar20[3] = -(SUB161(__LC26,3) < (char)local_68[3]);
      auVar20[4] = -(SUB161(__LC26,4) < (char)local_68[4]);
      auVar20[5] = -(SUB161(__LC26,5) < (char)local_68[5]);
      auVar20[6] = -(SUB161(__LC26,6) < (char)local_68[6]);
      auVar20[7] = -(SUB161(__LC26,7) < (char)local_68[7]);
      auVar20[8] = -(SUB161(__LC26,8) < (char)local_68[8]);
      auVar20[9] = -(SUB161(__LC26,9) < (char)local_68[9]);
      auVar20[10] = -(SUB161(__LC26,10) < (char)local_68[10]);
      auVar20[0xb] = -(SUB161(__LC26,0xb) < (char)local_68[0xb]);
      auVar20[0xc] = -(SUB161(__LC26,0xc) < (char)local_68[0xc]);
      auVar20[0xd] = -(SUB161(__LC26,0xd) < (char)local_68[0xd]);
      auVar20[0xe] = -(SUB161(__LC26,0xe) < (char)local_68[0xe]);
      auVar20[0xf] = -(SUB161(__LC26,0xf) < (char)local_68[0xf]);
      ...
      auVar19[0] = -(SUB161(__LC26,0) < (char)local_58[0]);
      auVar19[1] = -(SUB161(__LC26,1) < (char)local_58[1]);
      auVar19[2] = -(SUB161(__LC26,2) < (char)local_58[2]);
      auVar19[3] = -(SUB161(__LC26,3) < (char)local_58[3]);
      auVar19[4] = -(SUB161(__LC26,4) < (char)local_58[4]);
      auVar19[5] = -(SUB161(__LC26,5) < (char)local_58[5]);
      auVar19[6] = -(SUB161(__LC26,6) < (char)local_58[6]);
      auVar19[7] = -(SUB161(__LC26,7) < (char)local_58[7]);
      auVar19[8] = -(SUB161(__LC26,8) < (char)local_58[8]);
      auVar19[9] = -(SUB161(__LC26,9) < (char)local_58[9]);
      auVar19[10] = -(SUB161(__LC26,10) < (char)local_58[10]);
      auVar19[0xb] = -(SUB161(__LC26,0xb) < (char)local_58[0xb]);
      auVar19[0xc] = -(SUB161(__LC26,0xc) < (char)local_58[0xc]);
      auVar19[0xd] = -(SUB161(__LC26,0xd) < (char)local_58[0xd]);
      auVar19[0xe] = -(SUB161(__LC26,0xe) < (char)local_58[0xe]);
      auVar19[0xf] = -(SUB161(__LC26,0xf) < (char)local_58[0xf]);

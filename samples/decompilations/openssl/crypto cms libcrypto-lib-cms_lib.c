...

{
  ...
  uVar4 = ossl_cms_ctx_get0_libctx(uVar3);
  ...
  if ((iVar1 == 0x17) || (iVar1 == 0x423)) {
    ...
    puVar6 = (undefined8 *)(param_1[1] + 0x18);
  }
  for (iVar1 = 0; iVar2 = OPENSSL_sk_num(*puVar6), iVar1 < iVar2; iVar1 = iVar1 + 1) {
    piVar5 = (int *)OPENSSL_sk_value(*puVar6,iVar1);
    if (*piVar5 == 0) {
      ossl_x509_set0_libctx(*(undefined8 *)(piVar5 + 2),uVar4,uVar3);
    }
  }
  return;
}
...

{
  ...
  if (iVar1 < 0x1b) {
    if (0x14 < iVar1) {
      ...
      case 0x17:
        goto switchD_00100344_caseD_17;
      case 0x1a:
...

{
  ...
  iVar1 = OBJ_obj2nid(*(ASN1_OBJECT **)cms);
  if (iVar1 < 0x1b) {
    if (iVar1 < 0x15) goto switchD_001004c3_caseD_18;
    pBVar2 = pBVar3;
    switch(iVar1) {
    case 0x15:
      goto switchD_001004c3_caseD_15;
    case 0x16:
    ...
    case 0x17:
      ...
      break;
    default:
      goto switchD_001004c3_caseD_18;
    case 0x19:
...
LAB_00100818:
    ...
    iVar1 = OBJ_obj2nid(*(ASN1_OBJECT **)param_1);
    if (iVar1 < 0x1b) goto LAB_0010063e;
LAB_001006e2:
    if (iVar1 != 0x312) {
      if (iVar1 == 0x423) {
      ...
      goto switchD_00100661_caseD_18;
    }
switchD_00100661_caseD_15:
    uVar4 = 1;
  }
  else {
    ...
    if (bp != (BIO *)0x0) {
      ...
      iVar1 = OBJ_obj2nid(o);
      if (0x1a < iVar1) goto LAB_001006e2;
LAB_0010063e:
      if (0x14 < iVar1) {
        switch(iVar1) {
        case 0x15:
        case 0x1a:
          goto switchD_00100661_caseD_15;
        case 0x16:
          if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...

{
  ...
  iVar1 = OBJ_obj2nid(*(ASN1_OBJECT **)cms);
  if (iVar1 == 0x1a) {
    puVar2 = *(undefined8 **)(*(long *)(cms + 8) + 8);
  }
  else {
    if (iVar1 < 0x1b) {
      if (iVar1 != 0x17) {
...
LAB_0010089a:
        ...
        puVar2 = *(undefined8 **)(*(long *)(cms + 8) + 0x10);
        goto LAB_001008f8;
      }
    }
    else if ((iVar1 != 0x312) && (iVar1 != 0x423)) {
      if (iVar1 != 0xcd) goto LAB_0010089a;
      puVar2 = *(undefined8 **)(*(long *)(cms + 8) + 0x28);
      goto LAB_001008f8;
    }
    puVar2 = *(undefined8 **)(*(long *)(cms + 8) + 0x18);
  }
LAB_001008f8:
  if (puVar2 == (undefined8 *)0x0) {
    return (ASN1_OBJECT *)0x0;
  }
  return (ASN1_OBJECT *)*puVar2;
}
...
LAB_00100968:
      ...
      if (iVar1 != 0xcd) goto LAB_00100968;
...

{
  ...
  if (pEVar4 == (EVP_MD *)0x0) {
    ...
    if (parg != (EVP_MD *)0x0) goto LAB_00100bc0;
    ERR_clear_last_mark();
    bp = (BIO *)0x0;
    ERR_new();
...
LAB_00100cd0:
      ...
      if (iVar1 == 0) {
        ...
        if (iVar1 == 0) {
          if (local_b8 == 0) goto LAB_00100cd0;
        }
        else {
          local_b8 = 0x40;
        }
...
LAB_00100ed8:
    ...
    if (iVar2 == iVar1) goto LAB_00100ed8;
    param_2 = BIO_next(bp);
  } while( true );
}
...

{
  ...
  pAVar2 = (ASN1_ITEM *)CMS_CertificateChoices_it();
  val = ASN1_item_new(pAVar2);
  if (val != (ASN1_VALUE *)0x0) {
    iVar1 = OPENSSL_sk_push(*plVar4,val);
    if (iVar1 != 0) {
...

{
  ...
  while( true ) {
    ...
    if ((*piVar3 == 0) && (iVar2 = X509_cmp(*(X509 **)(piVar3 + 2),cert), iVar2 == 0)) break;
    iVar1 = iVar1 + 1;
  }
  X509_free(cert);
  return 1;
...

{
  ...
  iVar1 = OBJ_obj2nid(*(ASN1_OBJECT **)cms);
  if (iVar1 == 0x17) {
    plVar4 = (long *)(*(long *)(*(long *)(cms + 8) + 8) + 8);
...
joined_r0x001011ab:
  ...
  pAVar2 = (ASN1_ITEM *)CMS_RevocationInfoChoice_it();
  val = ASN1_item_new(pAVar2);
  if (val != (ASN1_VALUE *)0x0) {
    iVar1 = OPENSSL_sk_push(*plVar4,val);
    if (iVar1 != 0) {
...

{
  ...
  *param_2 = lVar3;
  ...
  if (0 < iVar1) {
    do {
      piVar4 = (int *)OPENSSL_sk_value(*puVar6,iVar5);
      if ((*piVar4 == 0) &&
         (iVar2 = X509_add_cert(*param_2,*(undefined8 *)(piVar4 + 2),1), iVar2 == 0)) {
...

{
  ...
  *param_2 = 0;
  ...
  if ((iVar1 == 0x17) || (iVar1 == 0x423)) {
    ...
    puVar6 = (undefined8 *)(*(long *)(param_1[1] + 8) + 8);
  }
  else {
    if (iVar1 != 0x16) {
      ERR_new();
    ...
    puVar6 = (undefined8 *)(param_1[1] + 0x20);
  }
  iVar1 = OPENSSL_sk_num(*puVar6);
  lVar3 = OPENSSL_sk_new_reserve(0,iVar1);
  *param_2 = lVar3;
  ...
  if (0 < iVar1) {
    do {
      piVar4 = (int *)OPENSSL_sk_value(*puVar6,iVar5);
      if ((*piVar4 == 0) &&
         ((iVar2 = X509_CRL_up_ref(*(undefined8 *)(piVar4 + 2)), iVar2 == 0 ||
          (iVar2 = OPENSSL_sk_push(*param_2,*(undefined8 *)(piVar4 + 2)), iVar2 == 0)))) {

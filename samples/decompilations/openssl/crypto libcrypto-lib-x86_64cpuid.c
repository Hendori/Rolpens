...
/* WARNING: Removing unreachable block (ram,0x001001ef) */
/* WARNING: Removing unreachable block (ram,0x001001aa) */
/* WARNING: Removing unreachable block (ram,0x001000d2) */
/* WARNING: Removing unreachable block (ram,0x001000c4) */
/* WARNING: Removing unreachable block (ram,0x00100120) */
/* WARNING: Removing unreachable block (ram,0x0010010b) */
/* WARNING: Removing unreachable block (ram,0x001000aa) */
/* WARNING: Removing unreachable block (ram,0x00100099) */
/* WARNING: Removing unreachable block (ram,0x0010003d) */

undefined1  [16] OPENSSL_ia32_cpuid(uint param_1,long param_2)
...
LAB_0010018a:
  uVar18 = (ulong)(uVar17 & 0x800 | uVar12 & 0xfffff7ff);
  uVar16 = uVar15;
  if (6 < *puVar1) {
  ...
  if (((uVar12 & 0x8000000) == 0) ||
     ((uVar16 = (ulong)in_register_00000604, (in_XCR0 & 0xe6) != 0xe6 &&

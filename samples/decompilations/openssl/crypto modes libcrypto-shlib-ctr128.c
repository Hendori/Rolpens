...

{
  ...
  if (0xf < param_3) {
    ...
    do {
      ...
      *param_5 = (((((((ulong)(uVar2 & 0xff) << 8 | (ulong)(uVar18 & 0xff)) << 8 |
                     (ulong)(uVar9 & 0xff)) << 8 | (ulong)(uVar16 & 0xff)) << 8 |
                   (ulong)(uVar15 & 0xff)) << 8 | (ulong)(uVar14 & 0xff)) << 8 |
                 (ulong)(uVar13 & 0xff)) << 8 | (ulong)(byte)((char)(uVar13 >> 8) + (char)*param_5);
      param_5[1] = (((((((ulong)(byte)(*(char *)((long)param_5 + 0xf) + 1) << 8 |
                        (ulong)(uVar11 & 0xff)) << 8 | (ulong)(uVar10 & 0xff)) << 8 |
                      (ulong)(uVar4 & 0xff)) << 8 | (ulong)local_88) << 8 | (ulong)local_6c) << 8 |
                   (ulong)local_68) << 8 | (ulong)local_64;
  ...
  if (param_3 != 0) {
    ...
    local_58 = (byte)uVar4;
    uVar3 = (ulong)uVar17;
    *param_5 = (((((((ulong)(uVar10 & 0xff) << 8 | (ulong)(uVar18 & 0xff)) << 8 |
                   (ulong)(uVar16 & 0xff)) << 8 | (ulong)(uVar15 & 0xff)) << 8 |
                 (ulong)(uVar14 & 0xff)) << 8 | (ulong)(uVar13 & 0xff)) << 8 |
               (ulong)(uVar12 & 0xff)) << 8 | (ulong)(byte)((char)(uVar12 >> 8) + (char)*param_5);
    param_5[1] = (((((ulong)CONCAT21(CONCAT11(*(char *)((long)param_5 + 0xf) + '\x01',local_88),
                                     local_6c) << 8 | (ulong)uVar1 & 0xff) << 8 |
                   (ulong)(uVar20 & 0xff)) << 8 | (ulong)local_68) << 8 | (ulong)local_64) << 8 |
                 (ulong)local_58;
    *(byte *)((long)param_2 + uVar3) =
         *(byte *)((long)param_6 + uVar3) ^ *(byte *)((long)local_60 + uVar3);
    lVar7 = param_3 - 1;
    if (lVar7 != 0) {
      *(byte *)((long)param_2 + uVar5) =
           *(byte *)((long)param_6 + uVar5) ^ *(byte *)((long)local_60 + uVar5);
      uVar3 = (ulong)(uVar17 + 2);
      if (lVar7 != 1) {
        *(byte *)((long)param_2 + uVar3) =
             *(byte *)((long)local_60 + uVar3) ^ *(byte *)((long)param_6 + uVar3);
                        ...
                        *(byte *)((long)param_2 + uVar3) =
                        ...
                        if (param_3 != 0xb) {
                          *(byte *)((long)param_2 + uVar3) =
                          ...
                          if (param_3 != 0xc) {
                            *(byte *)((long)param_2 + uVar3) =
                                 *(byte *)((long)local_60 + uVar3) ^
                                 *(byte *)((long)param_6 + uVar3);
...
void CRYPTO_ctr128_encrypt_ctr32
               (byte *param_1,byte *param_2,ulong param_3,undefined8 param_4,ulong *param_5,
      ...
      if (param_3 != 0) {
        ...
        *(uint *)((long)param_5 + 0xc) =
        ...
        if (uVar9 == 0) {
          ...
          *(uint *)(param_5 + 1) =
               (((*(byte *)((long)param_5 + 0xb) + 1 & 0xff) << 8 | uVar10 & 0xff) << 8 |
               uVar9 & 0xff) << 8 | uVar5 & 0xff;
          ...
          *param_5 = (((((((ulong)(uVar9 & 0xff) << 8 | (ulong)(uVar14 & 0xff)) << 8 |
                         (ulong)(uVar13 & 0xff)) << 8 | (ulong)(uVar12 & 0xff)) << 8 |
                       (ulong)(uVar11 & 0xff)) << 8 | (ulong)(uVar10 & 0xff)) << 8 |
                     (ulong)(uVar5 & 0xff)) << 8 |
                     (ulong)(byte)((char)(uVar5 >> 8) + (char)*param_5);
        }
LAB_00100a5f:
        uVar9 = uVar15 + 1;
...
LAB_001008c1:
    ...
    while( true ) {
      ...
      while( true ) {
        ...
        uVar5 = (uint)(byte)param_5[1] + (uVar9 >> 8);
        *(uint *)(param_5 + 1) =
             (((bVar2 + 1 & 0xff) << 8 | uVar10 & 0xff) << 8 | uVar9 & 0xff) << 8 | uVar5 & 0xff;
        uVar9 = (uint)*(byte *)((long)param_5 + 7) + (uVar5 >> 8);
        uVar14 = (uint)*(byte *)((long)param_5 + 6) + (uVar9 >> 8);
        uVar13 = (uint)*(byte *)((long)param_5 + 5) + (uVar14 >> 8);
        uVar12 = (uint)*(byte *)((long)param_5 + 4) + (uVar13 >> 8);
        ...
        *param_5 = (((((((ulong)(uVar9 & 0xff) << 8 | (ulong)(uVar14 & 0xff)) << 8 |
                       (ulong)(uVar13 & 0xff)) << 8 | (ulong)(uVar12 & 0xff)) << 8 |
                     (ulong)(uVar11 & 0xff)) << 8 | (ulong)(uVar10 & 0xff)) << 8 |
                   (ulong)(uVar5 & 0xff)) << 8 | (ulong)(byte)((char)(uVar5 >> 8) + (char)*param_5);
        if (param_3 < 0x10) {

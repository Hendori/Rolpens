...
long slh_dsa_sha2_192s_gen(long param_1)
  ...
  if (((iVar1 != 0) &&
      (lVar2 = ossl_slh_dsa_key_new
                         (*(undefined8 *)(param_1 + 8),*(undefined8 *)(param_1 + 0x10),
                          "SLH-DSA-SHA2-192s"), lVar2 != 0)) &&
     (lVar3 = ossl_slh_dsa_hash_ctx_new(lVar2), lVar3 != 0)) {
...

{
  ...
  lVar3 = OSSL_PARAM_locate(param_2,&_LC5);
  if (lVar3 != 0) {
  ...
  if ((lVar3 != 0) && (lVar4 = OSSL_PARAM_locate(param_2,&_LC10), lVar4 != 0)) {
  ...
  iVar1 = OSSL_PARAM_set_utf8_string(lVar3,&_LC11);
  return iVar1 != 0;
}
...

{
  ...
  if (lVar4 != 0) {
    if (((param_2 & 1) == 0) || (lVar4 = ossl_slh_dsa_key_get_priv(param_1), lVar4 == 0)) {
      ...
      iVar1 = ossl_param_build_set_octet_string(lVar3,0,&_LC10,uVar6,uVar5);
    }
    else {
      uVar5 = ossl_slh_dsa_key_get_priv_len(param_1);
      uVar6 = ossl_slh_dsa_key_get_priv(param_1);
      iVar1 = ossl_param_build_set_octet_string(lVar3,0,&_LC8,uVar6,uVar5);
    }
...
long slh_dsa_shake_128f_gen(long param_1)
...
long slh_dsa_shake_192s_gen(long param_1)
...
long slh_dsa_sha2_256f_gen(long param_1)
...
long slh_dsa_shake_128s_gen(long param_1)
...
long slh_dsa_shake_192f_gen(long param_1)
...
long slh_dsa_shake_256s_gen(long param_1)
...
long slh_dsa_shake_256f_gen(long param_1)
...
long slh_dsa_sha2_128s_gen(long param_1)
...
long slh_dsa_sha2_192f_gen(long param_1)
...
long slh_dsa_sha2_256s_gen(long param_1)
...
long slh_dsa_sha2_128f_gen(long param_1)

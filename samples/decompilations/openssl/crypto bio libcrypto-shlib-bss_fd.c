...
ulong fd_puts(BIO *param_1,char *param_2)

{
  ...
  *piVar3 = 0;
  ...
  BIO_clear_flags(param_1,0xf);
  if ((int)uVar4 < 1) {
    iVar1 = BIO_fd_should_retry((int)uVar4);
    if (iVar1 != 0) {
      BIO_set_flags(param_1,10);
    }
  }
...

{
  ...
  pcVar6 = param_2;
  if (param_2 < param_2 + (long)param_3 + -1) {
    __buf = param_2;
    if (param_2 == (char *)0x0) {
      DAT_00000000 = 0;
    ...
    while( true ) {
      piVar3 = __errno_location();
      *piVar3 = 0;
      sVar4 = read(*(int *)&param_1->next_bio,__buf,1);
      BIO_clear_flags(param_1,0xf);
      i = (int)sVar4;
      if (i < 1) break;
      pcVar6 = __buf + 1;
      if ((*__buf == '\n') || (__buf = pcVar6, param_2 + (long)param_3 + -1 <= pcVar6))
      goto LAB_001004d5;
    }
    iVar2 = BIO_fd_should_retry(i);
    pcVar6 = __buf;
    if (iVar2 == 0) {
      if (i == 0) {
        *(uint *)&param_1->ptr = *(uint *)&param_1->ptr | 0x800;

...
LAB_00100650:
    ...
    if ((bVar1 & 1) == 0) {
      if ((bVar1 & 2) == 0) {
        if (param_3 != (size_t *)0x0) goto LAB_00100669;
      }
      else if (param_3 != (size_t *)0x0) goto LAB_00100650;
    }
    else {
      if ((param_3 == (size_t *)0x0) || ((bVar1 & 2) != 0)) goto LAB_00100650;
LAB_00100669:
      *param_3 = 0x100;
      if (param_2 != (void *)0x0) {
...

{
  ...
  if ((iVar1 != 0) &&
     (iVar1 = test_int_eq("test/fake_rsaprov.c",0x153,"*sigctx",&_LC30,*param_1,1), iVar1 != 0)) {
    *param_3 = 0x100;
    if (param_2 != (void *)0x0) {
...
undefined8 fake_rsa_dgstsgn_init(byte *param_1,undefined8 param_2,long param_3,long param_4)
...
undefined8 fake_rsa_dgstvfy_init(byte *param_1,undefined8 param_2,long param_3,long param_4)
...

{
  ...
  iVar1 = test_ptr("test/fake_rsaprov.c",0xfe,&_LC33,param_1);
  if (iVar1 != 0) {
    iVar1 = test_mem_eq("test/fake_rsaprov.c",0xff,&_LC33,"inited",param_1,1,&inited_0);
    if (iVar1 != 0) {
...
undefined8 fake_rsa_st_open(undefined8 param_1,char *param_2)

{
  ...
  iVar1 = strncmp(param_2,"fake_rsa:",9);
  if ((iVar1 == 0) && (iVar1 = strncmp(param_2,"fake_rsa:openpwtest",0x13), iVar1 != 0)) {
    uVar2 = CRYPTO_zalloc(1,"test/fake_rsaprov.c",0x241);
    iVar1 = test_ptr("test/fake_rsaprov.c",0x242,"storectx",uVar2);
    if (iVar1 != 0) {
      test_info("test/fake_rsaprov.c",0x245,"fake_rsa_open_ex called");
        ...
        *(undefined4 *)((long)local_e0 + 4) = 1;
        ...
        if (iVar1 != 0) {
          ...
          *param_1 = '\x01';
          ...
          if (iVar1 != 0) goto LAB_00100c8f;
          goto joined_r0x00100d03;
        }
      }
      goto LAB_00100c66;
    }
...
undefined8 fake_rsa_dgstvfy(byte *param_1)

{
  ...
  if (((iVar2 != 0) && (bVar1 = *param_1, bVar1 != 0)) && ((bVar1 & 8) == 0)) {
    *param_1 = bVar1 | 4;
    iVar2 = test_ptr("test/fake_rsaprov.c",0x1b9,"sigctx",param_1);
    if (((iVar2 != 0) && (bVar1 = *param_1, bVar1 != 0)) && ((bVar1 & 9) == 0)) {
      if ((bVar1 & 0xa0) != 0) {
        *param_1 = bVar1 | 8;
      }
      return 1;
...
undefined8 fake_rsa_dgstsgn(byte *param_1,void *param_2,size_t *param_3,undefined4 param_4)

{
  ...
  *param_1 = bVar1 | 4;
  ...
  if ((bVar1 & 1) == 0) {
    ...
    if (param_3 == (size_t *)0x0) goto LAB_0010107d;
  }
  else {
    if (param_3 == (size_t *)0x0) {
      return 0;

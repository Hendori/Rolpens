...

{
  ...
  local_1150 = 0;
  if (param_1 == (code *)0x0) {
    while (uVar3 = ERR_get_error_all(&local_1160,&local_1168,&local_1158,&local_1150,local_1164),
          uVar3 != 0) {
      pcVar4 = ERR_lib_error_string(uVar3);
      pcVar2 = local_1158;
      if (pcVar4 == (char *)0x0) {
...
LAB_001005e5:
        if ((uVar3 & 0x80000000) != 0) goto LAB_001006dc;
LAB_001005f1:
        pcVar2 = ERR_reason_error_string(uVar3);
        if (pcVar2 == (char *)0x0) {
          uVar3 = (ulong)((uint)uVar3 & 0x7fffff);
          goto LAB_001006fd;
        }
      }
      else {
        if (local_1158 == (char *)0x0) goto LAB_001005e5;
        if (*local_1158 != '\0') {
          iVar1 = strcmp(local_1158,"(unknown function)");
          if (iVar1 != 0) {
            pcVar4 = pcVar2;
          }
          goto LAB_001005e5;
        }
        if ((uVar3 & 0x80000000) == 0) goto LAB_001005f1;
LAB_001006dc:
...
LAB_001006fd:
          BIO_snprintf(local_1148,0x100,"reason(%lu)",uVar3);
        }
        pcVar2 = local_1148;
      }
      if ((local_1150 == 0) || ((local_1164[0] & 2) == 0)) {
        BIO_snprintf(local_1048,0x1000,"%s",pcVar2);
      }
      else {
        BIO_snprintf(local_1048,0x1000,"%s:%s",pcVar2);
      }
      a = BIO_new_fp(_stderr,0);
      if (a != (BIO *)0x0) {
        OSSL_CMP_print_to_bio(a,pcVar4,local_1160,local_1168,3,local_1048);
        BIO_free(a);
      }
    }
  }
    ...
    do {
      uVar3 = ERR_get_error_all(&local_1160,&local_1168,&local_1158,&local_1150,local_1164);
      if (uVar3 == 0) break;
      pcVar4 = ERR_lib_error_string(uVar3);
      pcVar2 = local_1158;
      if (pcVar4 == (char *)0x0) {
...
LAB_0010072e:
      ...
      iVar1 = (*param_1)(pcVar4,local_1160,local_1168,3,local_1048);
    } while (0 < iVar1);
  }
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
...

{
  ...
  if (param_2 != 0) {
    if (param_3 == 0) {
      for (; iVar3 = OPENSSL_sk_num(param_2), param_3 < iVar3; param_3 = param_3 + 1) {
        pXVar2 = (X509 *)OPENSSL_sk_value(param_2,param_3);
        iVar3 = X509_STORE_add_cert(param_1,pXVar2);
        if (iVar3 == 0) {
          return 0;
        }
      }
      ...
      for (iVar3 = 0; iVar1 = OPENSSL_sk_num(param_2), iVar3 < iVar1; iVar3 = iVar3 + 1) {
        pXVar2 = (X509 *)OPENSSL_sk_value(param_2,iVar3);
        iVar1 = X509_self_signed(pXVar2,0);
        if ((iVar1 == 1) && (iVar1 = X509_STORE_add_cert(param_1,pXVar2), iVar1 == 0)) {
          return 0;
        }
      }
    }
...
LAB_00100a10:
    ...
    if (a != param_2) {
      if (param_2 != (ASN1_OCTET_STRING *)0x0) {
        ...
        if (param_2 == (ASN1_OCTET_STRING *)0x0) goto LAB_00100a10;
        a = (ASN1_OCTET_STRING *)*param_1;
      }

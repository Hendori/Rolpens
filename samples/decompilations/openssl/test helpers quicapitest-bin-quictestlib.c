...
undefined8
packet_plain_mutate(undefined8 *param_1,undefined8 *param_2,ulong param_3,long *param_4,
...

{
  ...
  *(long *)(param_7 + 0x68) = lVar9;
  lVar9 = (int)((iVar7 - (uint)*(byte *)(param_1 + 1)) - (uint)*(byte *)((long)param_1 + 0x1d)) +
          lVar9;
  ...
  *(void **)(param_7 + 0x60) = pvVar4;
  if (pvVar4 == (void *)0x0) {
    ...
    *(undefined8 *)(param_7 + 0x10) = uVar6;
    uVar6 = param_1[3];
    *(undefined8 *)(param_7 + 0x18) = param_1[2];
    *(undefined8 *)(param_7 + 0x20) = uVar6;
    uVar6 = param_1[5];
    *(undefined8 *)(param_7 + 0x28) = param_1[4];
    *(undefined8 *)(param_7 + 0x30) = uVar6;
    uVar6 = param_1[7];
    *(undefined8 *)(param_7 + 0x38) = param_1[6];
    *(undefined8 *)(param_7 + 0x40) = uVar6;
    uVar6 = param_1[9];
    ...
    *(undefined8 *)(param_7 + 0x58) = param_1[10];
    if (*(code **)(param_7 + 0x78) != (code *)0x0) {
      (**(code **)(param_7 + 0x78))
                (param_7,param_7 + 8,pvVar4,*(undefined8 *)(param_7 + 0x68),
  ...
  if (__dest != (char *)0x0) {
    ...
    *(size_t *)(param_5 + 0x90) = param_2 + 0x400;
    ...
    if (((0 < (long)param_2) && (2 < param_2 - 1)) &&
       (uVar3 = (ulong)(byte)__dest[1] << 0x10 | (ulong)(byte)__dest[2] << 8 |
                (ulong)(byte)__dest[3], uVar3 == param_2 - 4)) {
      if ((*__dest == '\b') && (*(code **)(param_5 + 0xb0) != (code *)0x0)) {
        local_58 = __dest + 4;
        local_50 = uVar3;
        iVar1 = (**(code **)(param_5 + 0xb0))
                          (param_5,&local_58,uVar3,*(undefined8 *)(param_5 + 0xb8));
        if (iVar1 == 0) goto LAB_00100451;
        param_2 = *(size_t *)(param_5 + 0x98);
      }
      if (*(code **)(param_5 + 0xa0) != (code *)0x0) {
        iVar1 = (**(code **)(param_5 + 0xa0))
  ...
  if (param_2 == (SSL *)0x0) {
    ...
    if (iVar2 != 0) {
      ...
      if (0 < iVar3) {
        ...
        iVar2 = test_true("test/helpers/quictestlib.c",0x207,"run_thread(&t, run_server_thread)",
                          iVar2 == 0);
...
LAB_00101bb0:
  if ((param_1 == 0) && (0 < iVar2)) {
    ...
    if ((iVar2 == 0) ||
       ...
       iVar2 == 0)) goto LAB_00101c00;
  }
LAB_00101f60:
  bVar10 = !bVar10 && iVar3 == 0;
  goto LAB_00101c02;
LAB_00101f59:
  iVar3 = 0;
  goto LAB_00101f60;
...

{
  ...
  if (iVar1 < 1) {
    ...
    iVar1 = test_true("test/helpers/quictestlib.c",0x285,
                      "run_thread(&t, run_server_shutdown_thread)",iVar1 == 0);
    if (iVar1 != 0) {
      do {
        iVar1 = SSL_shutdown(param_2);
        if (iVar1 == 1) {
...

{
  ...
  iVar2 = test_true("test/helpers/quictestlib.c",0x366,
                    "qtest_fault_resize_plain_packet(fault, old_len + frame_len)",uVar3);
  if (iVar2 != 0) {
...
bool qtest_fault_delete_extension
               (long param_1,uint param_2,ushort *param_3,long *param_4,undefined8 *param_5)

...

{
  ...
  uVar5 = (uVar5 >> 0x18 | (uVar5 & 0xff0000) >> 8 | (uVar5 & 0xff00) << 8 | uVar5 << 0x18) ^
          0x56aa3350;
  uVar1 = (uVar8 >> 0x18 | (uVar8 & 0xff0000) >> 8 | (uVar8 & 0xff00) << 8 | uVar8 << 0x18) ^
          0x677d9197;
  uVar8 = (uVar2 >> 0x18 | (uVar2 & 0xff0000) >> 8 | (uVar2 & 0xff00) << 8 | uVar2 << 0x18) ^
          0xb27022dc;
  do {
    uVar4 = uVar5 ^ uVar1 ^ uVar8 ^ *puVar6;
    uVar2 = (uint)(byte)SM4_S[uVar4 >> 0x18] << 0x18 | (uint)(byte)SM4_S[uVar4 & 0xff] |
            (uint)(byte)SM4_S[uVar4 >> 0x10 & 0xff] << 0x10;
    uVar4 = uVar2 | (uint)(byte)SM4_S[uVar4 >> 8 & 0xff] << 8;
    uVar7 = uVar7 ^ uVar4 ^ (uVar4 << 0xd | uVar2 >> 0x13) ^ (uVar4 >> 9 | uVar4 << 0x17);
    uVar4 = uVar1 ^ uVar8 ^ puVar6[1] ^ uVar7;
    uVar2 = (uint)(byte)SM4_S[uVar4 >> 0x18] << 0x18 | (uint)(byte)SM4_S[uVar4 & 0xff] |
            (uint)(byte)SM4_S[uVar4 >> 0x10 & 0xff] << 0x10;
    uVar4 = uVar2 | (uint)(byte)SM4_S[uVar4 >> 8 & 0xff] << 8;
    uVar5 = uVar5 ^ uVar4 ^ (uVar4 << 0xd | uVar2 >> 0x13) ^ (uVar4 >> 9 | uVar4 << 0x17);
    uVar2 = puVar6[2] ^ uVar8 ^ uVar7 ^ uVar5;
    uVar4 = (uint)(byte)SM4_S[uVar2 >> 0x18] << 0x18 | (uint)(byte)SM4_S[uVar2 & 0xff] |
            (uint)(byte)SM4_S[uVar2 >> 0x10 & 0xff] << 0x10;
    uVar3 = uVar4 | (uint)(byte)SM4_S[uVar2 >> 8 & 0xff] << 8;
    uVar2 = puVar6[3];
    *param_2 = uVar7;
    uVar1 = uVar1 ^ uVar3 ^ (uVar3 << 0xd | uVar4 >> 0x13) ^ (uVar3 >> 9 | uVar3 << 0x17);
    param_2[1] = uVar5;
    param_2[2] = uVar1;
    uVar4 = uVar2 ^ uVar7 ^ uVar5 ^ uVar1;
    uVar2 = (uint)(byte)SM4_S[uVar4 >> 0x18] << 0x18 | (uint)(byte)SM4_S[uVar4 & 0xff] |
            (uint)(byte)SM4_S[uVar4 >> 0x10 & 0xff] << 0x10;
    uVar4 = uVar2 | (uint)(byte)SM4_S[uVar4 >> 8 & 0xff] << 8;
    uVar8 = uVar8 ^ uVar4 ^ (uVar4 << 0xd | uVar2 >> 0x13) ^ (uVar4 >> 9 | uVar4 << 0x17);
    puVar6 = puVar6 + 4;
    param_2[3] = uVar8;
    param_2 = param_2 + 4;

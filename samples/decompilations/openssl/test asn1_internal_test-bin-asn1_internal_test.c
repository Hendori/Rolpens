    ...
    if (uVar2 != 0) {
      ...
      if (iVar1 != 0) {
        ...
        if (iVar1 != 0) {
          ...
          iVar1 = test_int_le("test/asn1_internal_test.c",0x8f,"i2d_RSAPrivateKey(rsa, NULL)",&_LC8,
                              iVar1,0);
          uVar2 = (uint)(iVar1 != 0);
          a_01 = (BIGNUM *)0x0;
          a_00 = (BIGNUM *)0x0;
...

{
  ...
  do {
    while( true ) {
      ...
      lVar6 = lVar6 + 1;
      ppuVar8 = ppuVar9;
      if (ppuVar9 == (undefined **)0x1012d8) goto LAB_00100300;
    }
    ppuVar8 = ppuVar8 + 1;
    lVar6 = lVar6 + 1;
  } while (ppuVar8 != (undefined **)0x1012d8);
LAB_00100300:
  iVar4 = test_int_ne("test/asn1_internal_test.c",0x66,"last_pkey_id",&_LC8,iVar10,0);
  if (iVar4 == 0) {
...

{
  ...
  do {
    ...
    piVar2 = piVar2 + 10;
    iVar1 = iVar6;
  } while (piVar2 != (int *)&_LC21);
  iVar1 = test_int_ne("test/asn1_internal_test.c",0x31,"last_nid",&_LC8,iVar6,0);
  if (iVar1 == 0) {
...

{
  ...
  local_78 = __LC21;
  uStack_70 = _UNK_00101748;
  local_58 = __LC22;
  uStack_50 = (undefined5)_UNK_00101758;
  uStack_4b = 0;
...

{
  ...
  ERR_set_mark();
  iVar1 = OBJ_create((char *)0x0,"custom1",(char *)0x0);
  if (iVar1 == 0) {
    uVar2 = ERR_peek_last_error();
    if ((((uVar2 & 0x80000000) == 0) && ((char)(uVar2 >> 0x17) == '\b')) &&
       (((uint)uVar2 & 0x7fffff) == 0x66)) goto LAB_0010067a;
    ERR_clear_last_mark();
    uVar3 = 0;
  }
  else {
LAB_0010067a:
  ...
  iVar1 = test_true("test/asn1_internal_test.c",0xe7,
                    "test_obj_create_once(NULL, sn_prefix \"1\", NULL)",uVar3);
  if (iVar1 == 0) {
    return false;
  }
  ...
  ERR_set_mark();
  iVar1 = OBJ_create((char *)0x0,(char *)0x0,"custom2");
  if (iVar1 == 0) {
    uVar2 = ERR_peek_last_error();
    if ((((uVar2 & 0x80000000) == 0) && ((char)(uVar2 >> 0x17) == '\b')) &&
       (((uint)uVar2 & 0x7fffff) == 0x66)) goto LAB_00100734;
    ERR_clear_last_mark();
    uVar3 = 0;
  }
  else {
LAB_00100734:
  ...
  iVar1 = test_true("test/asn1_internal_test.c",0xe9,
                    "test_obj_create_once(NULL, NULL, ln_prefix \"2\")",uVar3);
  if (iVar1 == 0) {
    return false;
  }
  iVar1 = OBJ_ln2nid("custom2");
  iVar1 = test_int_ne("test/asn1_internal_test.c",0xea,"OBJ_ln2nid(ln_prefix \"2\")","NID_undef",
                      iVar1,0);
  if (iVar1 == 0) {
    return false;
  }
  ERR_set_mark();
  iVar1 = OBJ_create((char *)0x0,"custom3","custom3");
  if (iVar1 == 0) {
    uVar2 = ERR_peek_last_error();
    if ((((uVar2 & 0x80000000) == 0) && ((char)(uVar2 >> 0x17) == '\b')) &&
       (((uint)uVar2 & 0x7fffff) == 0x66)) goto LAB_001007e8;
    ERR_clear_last_mark();
    uVar3 = 0;
  }
  else {
LAB_001007e8:
  ...
  iVar1 = test_true("test/asn1_internal_test.c",0xeb,
                    "test_obj_create_once(NULL, sn_prefix \"3\", ln_prefix \"3\")",uVar3);
  if (iVar1 == 0) {
    return false;
  }
  iVar1 = OBJ_sn2nid("custom3");
  iVar1 = test_int_ne("test/asn1_internal_test.c",0xec,"OBJ_sn2nid(sn_prefix \"3\")","NID_undef",
                      iVar1,0);
  if (iVar1 == 0) {
    return false;
  }
  iVar1 = OBJ_ln2nid("custom3");
  iVar1 = test_int_ne("test/asn1_internal_test.c",0xed,"OBJ_ln2nid(ln_prefix \"3\")","NID_undef",
                      iVar1,0);
  if (iVar1 == 0) {
    return false;
  }
  ERR_set_mark();
  iVar1 = OBJ_create("1.3.6.1.4.1.16604.998866.4",(char *)0x0,(char *)0x0);
  if (iVar1 == 0) {
    uVar2 = ERR_peek_last_error();
    if ((((uVar2 & 0x80000000) == 0) && ((char)(uVar2 >> 0x17) == '\b')) &&
       (((uint)uVar2 & 0x7fffff) == 0x66)) goto LAB_001008b3;
    ERR_clear_last_mark();
    uVar3 = 0;
  }
  else {
LAB_001008b3:
  ...
  iVar1 = test_true("test/asn1_internal_test.c",0xee,"test_obj_create_once(arc \"4\", NULL, NULL)",
                    uVar3);
  if (iVar1 == 0) {
    return false;
  }
  ERR_set_mark();
  iVar1 = OBJ_create("1.3.6.1.4.1.16604.998866.5","custom5",(char *)0x0);
  if (iVar1 == 0) {
    uVar2 = ERR_peek_last_error();
    if ((((uVar2 & 0x80000000) != 0) || ((char)(uVar2 >> 0x17) != '\b')) ||
       (((uint)uVar2 & 0x7fffff) != 0x66)) {
...
LAB_00100936:
  iVar1 = test_true("test/asn1_internal_test.c",0xef,
                    "test_obj_create_once(arc \"5\", sn_prefix \"5\", NULL)",uVar3);
  if (iVar1 != 0) {
    iVar1 = OBJ_sn2nid("custom5");
    iVar1 = test_int_ne("test/asn1_internal_test.c",0xf0,"OBJ_sn2nid(sn_prefix \"5\")","NID_undef",
                        iVar1,0);
    if (iVar1 != 0) {
      iVar1 = test_obj_create_once("1.3.6.1.4.1.16604.998866.6",0,"custom6");
      iVar1 = test_true("test/asn1_internal_test.c",0xf1,
                        "test_obj_create_once(arc \"6\", NULL, ln_prefix \"6\")",iVar1 != 0);
      if (iVar1 != 0) {
        iVar1 = OBJ_ln2nid("custom6");
        iVar1 = test_int_ne("test/asn1_internal_test.c",0xf2,"OBJ_ln2nid(ln_prefix \"6\")",
                            "NID_undef",iVar1,0);
        if (iVar1 != 0) {
          iVar1 = test_obj_create_once("1.3.6.1.4.1.16604.998866.7","custom7","custom7");
          iVar1 = test_true("test/asn1_internal_test.c",0xf3,
                            "test_obj_create_once(arc \"7\", sn_prefix \"7\", ln_prefix \"7\")",
                            iVar1 != 0);
          if (iVar1 != 0) {
            iVar1 = OBJ_sn2nid("custom7");
            iVar1 = test_int_ne("test/asn1_internal_test.c",0xf5,"OBJ_sn2nid(sn_prefix \"7\")",
                                "NID_undef",iVar1,0);
            if (iVar1 != 0) {
              iVar1 = OBJ_ln2nid("custom7");
              iVar1 = test_int_ne("test/asn1_internal_test.c",0xf6,"OBJ_ln2nid(ln_prefix \"7\")",
                                  "NID_undef",iVar1,0);
              if (iVar1 != 0) {
                iVar1 = test_obj_create_once(0,0,0);
                iVar1 = test_false("test/asn1_internal_test.c",0xf9,
                                   "test_obj_create_once(NULL, NULL, NULL)",iVar1 != 0);
                if (iVar1 != 0) {
                  iVar1 = test_obj_create_once(&_LC51,"custom8","custom8");

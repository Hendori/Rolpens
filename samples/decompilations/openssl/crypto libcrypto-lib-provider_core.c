...

{
  ...
  if (lVar1 == 0) {
    ...
    if ((*param_1 & 1) != 0) {
      ...
      uVar13 = 0x3b7;
LAB_00100971:
      ERR_set_debug("crypto/provider_core.c",uVar13,pcVar11);
      ...
      if (pDVar10 == (DSO *)0x0) {
        ...
        *(DSO **)(param_1 + 0x38) = pDVar10;
        if (pDVar10 != (DSO *)0x0) {
          ...
          ptr = (char *)0x0;
          if ((filespec1 == (char *)0x0) &&
             (filespec1 = DSO_convert_filename(*(DSO **)(param_1 + 0x38),*(char **)(param_1 + 0x28))
             , ptr = filespec1, filespec1 == (char *)0x0)) {
            ptr = (char *)0x0;
            local_68 = (char *)0x0;
LAB_00100b36:
            ...
            if ((local_68 == (char *)0x0) ||
               (pDVar10 = DSO_load(*(DSO **)(param_1 + 0x38),local_68,(DSO_METHOD *)0x0,0),
               pDVar10 == (DSO *)0x0)) goto LAB_00100b36;
          }
...
LAB_0010088d:
        pDVar9 = DSO_bind_func(pDVar10,"OSSL_provider_init");
...
LAB_001006a0:
      iVar4 = (*pDVar9)(param_1,core_dispatch_,&local_50,&local_48);
      if (iVar4 == 0) {
        ERR_new();
          ...
          if (pcVar15 != (code *)0x0) {
            ...
            *(ERR_STRING_DATA **)(param_1 + 0x68) = str;
            ...
            do {
              ...
              *(undefined8 *)((long)&str[1].string + lVar14) =
                   *(undefined8 *)((long)puVar7 + lVar14 + 8);
              lVar14 = lVar14 + 0x10;
        ...
        *param_1 = *param_1 | 1;
        ...
        if ((((param_1[0xd0] & 1) == 0) || (param_3 == 0)) ||
           (iVar4 = ossl_provider_up_ref_parent(param_1,1), iVar4 != 0)) goto LAB_001005d8;
      }
    }
  }
  else {
...
LAB_001005d8:
      ...
      iVar4 = local_54;
      if (((iVar5 == 0) || (*param_1 = *param_1 | 2, local_54 != 1)) || (lVar1 == 0))
      goto LAB_001004e4;
...
LAB_00100473:
        iVar4 = CRYPTO_THREAD_read_lock(*(undefined8 *)(lVar1 + 0x20));
        if (iVar4 != 0) {
...

{
  ...
  *ptr = param_1;
  ...
  if (iVar4 < 1) {
LAB_00100f1b:
    if (iVar4 == iVar3) goto LAB_00100fd8;
  }
  else {
    do {
      ...
      if ((iVar8 == 0) ||
         ((bVar1 = *pbVar6, CRYPTO_THREAD_unlock(*(undefined8 *)(pbVar6 + 8)), (bVar1 >> 1 & 1) != 0
          && (iVar8 = (*param_2)(pbVar6,param_5), iVar8 == 0)))) goto LAB_00100f1b;
      iVar3 = iVar3 + 1;
    } while (iVar3 != iVar4);
LAB_00100fd8:
  ...
  if (lVar2 == 0) {
    ...
    if (iVar1 != 0) {
      ...
      if (iVar1 == -1) {
        ...
        CRYPTO_THREAD_unlock(*(undefined8 *)(lVar2 + 0x20));
        if ((lVar3 != 0) && (iVar1 = ossl_provider_up_ref(lVar3), iVar1 != 0)) goto LAB_00102185;
      }
    }
  }
  lVar3 = 0;
...
LAB_001025c1:
    ...
    if (param_4 != (long *)0x0) {
LAB_0010240b:
      plVar5 = (long *)OPENSSL_sk_new_null();
...
LAB_0010241a:
      ...
      if (lVar4 != 0) {
        ...
        do {
          if (((int)param_4[-4] == 4) &&
             (iVar3 = ossl_provider_info_add_parameter(local_68,lVar4,param_4[-3]), iVar3 < 1)) {
...
LAB_00102475:
    lVar6 = provider_new(param_2,local_58._0_8_,plVar5);
    if (local_58._8_8_ != 0) {
      OPENSSL_sk_pop_free(local_58._8_8_,infopair_free);
    }
    if (lVar6 != 0) {

...
joined_r0x001006a8:
    if (param_3 == 0) goto LAB_00100648;
    param_2 = *(BIGNUM **)(param_1 + 0x30);
  }
  BN_free(param_2);
...
joined_r0x00100765:
      if (param_3 == 0) goto LAB_0010071b;
      goto LAB_00100767;
    }
    if (param_3 == 0) {
      return 0;
...
LAB_00100804:
      if (param_3 != (BIGNUM *)0x0) {
LAB_00100860:
        param_2 = *(BIGNUM **)(param_1 + 0x58);
        goto LAB_00100864;
      }
joined_r0x00100880:
      if (param_4 == 0) goto LAB_0010080e;
      goto LAB_00100882;
    }
    if (param_4 == 0) {
      return 0;
      ...
      if (iVar2 != 2) {
        ...
        do {
          ...
          if (((lVar7 == 0 || lVar8 == 0) || (lVar9 == 0)) ||
             ...
             plVar10 == (long *)0x0)) goto LAB_00100f83;
          *plVar10 = lVar7;
          plVar10[2] = lVar9;
          plVar10[1] = lVar8;
...

{
  ...
  if ((param_1 == (uint *)0x0) || ((*param_1 & 0x600) == 0)) {
    ...
    if (iVar1 != 0) {
      ...
      if ((iVar1 != 0) && (uVar2 = local_58, local_58 < 0x80000000)) goto LAB_0010205c;
    }
    uVar2 = 0xffffffff;
  }
LAB_0010205c:

...
LAB_00100a30:
          if ((((uVar1 & 0x40) == 0) || (lVar2 == 0)) ||
            ...
            if (((uVar1 & 0x80) == 0) ||
               (iVar3 = ts_check_signer_name(*(undefined8 *)(param_1 + 0x12),local_58), iVar3 != 0))
            {
              uVar4 = 1;
              goto LAB_00100a5b;
            }

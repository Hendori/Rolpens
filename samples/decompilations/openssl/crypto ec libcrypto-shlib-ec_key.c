  ...
  if (lVar5 != 0) {
    ...
    dst_00 = (EC_GROUP *)
             ossl_ec_group_new_ex
                       (*(undefined8 *)(src + 0x50),*(undefined8 *)(src + 0x58),
                        **(undefined8 **)(src + 0x18));
...

{
  ...
  if ((lVar2 != 0) && (iVar1 = BN_is_one(lVar2), iVar1 != 0)) {
    return 1;
  }
...

{
  ...
  uVar2 = 0x420;
LAB_001016ec:
  ERR_set_debug("crypto/ec/ec_key.c",uVar2,"ossl_ec_key_simple_oct2priv");
...

{
  ...
  if ((lVar1 != 0) &&
     (ptr = CRYPTO_malloc((int)lVar1,"crypto/ec/ec_key.c",0x42f), ptr != (void *)0x0)) {

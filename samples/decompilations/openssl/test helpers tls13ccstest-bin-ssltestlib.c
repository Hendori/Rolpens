...
LAB_001013fd:
          *(undefined4 *)((long)puVar5 + 0x1c) = 1;
          ...
          for (lVar8 = 0; iVar4 = (int)lVar8, iVar4 < iVar12; lVar8 = lVar8 + 1) {
            ...
            iVar12 = test_ptr("test/helpers/ssltestlib.c",0x23e,
                              "allpkts[i] = OPENSSL_malloc(sizeof(*thispkt))",puVar6);
            if (iVar12 == 0) goto LAB_00101355;
            pvVar7 = CRYPTO_malloc(param_3,"test/helpers/ssltestlib.c",0x242);
            *puVar6 = pvVar7;
            iVar12 = test_ptr("test/helpers/ssltestlib.c",0x242,
                              "thispkt->data = OPENSSL_malloc(inl)",pvVar7);
            if (iVar12 == 0) goto LAB_00101355;
            if ((iVar4 == 2) || (!bVar3)) {
...
LAB_001012ba:
  iVar12 = 1;
LAB_001012c0:
  for (iVar10 = 0; iVar4 = OPENSSL_sk_num(*puVar5), iVar10 < iVar4; iVar10 = iVar10 + 1) {
    lVar8 = OPENSSL_sk_value(*puVar5,iVar10);
    iVar4 = test_ptr("test/helpers/ssltestlib.c",599,"looppkt = sk_MEMPACKET_value(ctx->pkts, i)",
                     lVar8);
...
LAB_00101bd4:
        if (param_6 != (long *)0x0) goto LAB_00101bd9;
        goto LAB_00101bdc;
      }
LAB_00101ac0:
    ...
    if (param_6 != (long *)0x0) {
LAB_00101b40:
      if (*param_6 == 0) goto LAB_00101ee8;
    }
  }
  else {
...
LAB_00101e91:
      ...
      if (0 < param_4) goto LAB_00101d20;
joined_r0x00102091:
      if (0 < param_5) goto LAB_00101b9a;
LAB_00101bd9:
      *param_6 = (long)pSVar4;
LAB_00101bdc:
      if (param_7 == (long *)0x0) {
...
LAB_00101ed8:
    if (*param_6 != 0) goto LAB_00101b4f;
LAB_00101ee8:
    SSL_CTX_free(pSVar4);
  }
  if (param_7 == (long *)0x0) {
...
LAB_00102ccd:
    if (((param_3 == iVar11) && (bVar14)) || ((bool)(bVar4 & bVar5))) goto LAB_00102f46;
    if (bVar7) {
      if (((0 < ret_code) && (bVar2)) && (iVar11 = SSL_read(param_1,local_58,0x14), 0 < iVar11))
      goto LAB_00103187;
      if (((0 < iVar10) && (bVar1)) && (iVar11 = SSL_read(param_2,local_58,0x14), 0 < iVar11))
      goto LAB_0010314c;
    }
    iVar9 = iVar9 + 1;
    if (iVar9 == 1000000) goto LAB_00102f2c;
    if (((iVar9 < 0x33) && (bVar13)) &&
       (((uint)(iVar9 * -0x33333333) >> 1 | (uint)((iVar9 * -0x33333333 & 1U) != 0) << 0x1f) <
        0x1999999a)) {
      OSSL_sleep(0x32);
    }
...
LAB_00102fb0:
    if ((bool)(bVar4 & bVar5)) goto LAB_00102f46;
    if (bVar7) {
      if ((ret_code < 1) || (0 < iVar10)) {
        if ((0 < iVar10) && ((bVar2 && (iVar11 = SSL_read(param_2,local_58,0x14), 0 < iVar11))))
        goto LAB_0010314c;
      }
      else {

...

{
  evp_generic_fetch_from_prov
            (param_1,10,param_2,param_3,keymgmt_from_algorithm,evp_keymgmt_up_ref,evp_keymgmt_free);
  return;
}
...
{
  evp_generic_fetch(param_1,10,param_2,param_3,keymgmt_from_algorithm,evp_keymgmt_up_ref,
                    evp_keymgmt_free);
  return;
}
...

{
  ...
  if (lVar2 != 0) {
    ...
    *(undefined8 *)(lVar2 + 0x18) = *(undefined8 *)(param_2 + 0x18);
      ...
      do {
        ...
        case 0x15:
          if (*(long *)(lVar2 + 0xb0) == 0) {
            *(undefined8 *)(lVar2 + 0xb0) = *(undefined8 *)(piVar5 + 2);
          }
          break;
        case 0x16:
          if (*(long *)(lVar2 + 0xb8) == 0) {
            *(undefined8 *)(lVar2 + 0xb8) = *(undefined8 *)(piVar5 + 2);
          }
          break;
        case 0x17:
          if (*(long *)(lVar2 + 0xc0) == 0) {
            *(undefined8 *)(lVar2 + 0xc0) = *(undefined8 *)(piVar5 + 2);
          }
          break;
        case 0x28:
          if (*(long *)(lVar2 + 200) == 0) {
    ...
    if (((lVar3 != 0) &&
        ((((*(long *)(lVar2 + 0x30) != 0 || (*(long *)(lVar2 + 0x90) != 0)) ||
          (*(long *)(lVar2 + 0xa0) != 0)) &&
         ((*(long *)(lVar2 + 0xb0) != 0 &&
          (((uVar4 | uVar10 | uVar9 | uVar8 | uVar7 | uVar6) & 0xfffffffd) == 0)))))) &&
       ((*(long *)(lVar2 + 0x90) == 0 ||
        ((*(long *)(lVar2 + 0x60) != 0 && (*(long *)(lVar2 + 0x98) != 0)))))) {
...
undefined8
evp_keymgmt_validate(long param_1,undefined8 param_2,undefined4 param_3,undefined4 param_4)

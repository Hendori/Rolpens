...
void evp_skeymgmt_export(long param_1,undefined8 param_2,undefined4 param_3,undefined8 param_4,
                        undefined8 param_5)
...

{
  evp_generic_fetch_from_prov
            (param_1,0xf,param_2,param_3,skeymgmt_from_algorithm,0x100000,_GLOBAL_OFFSET_TABLE_);
  return;
}
...
{
  evp_generic_fetch(param_1,0xf,param_2,param_3,skeymgmt_from_algorithm,0x100000,
...
{
  evp_generic_do_all(param_1,10,param_2,param_3,skeymgmt_from_algorithm,0x100000,
                     _GLOBAL_OFFSET_TABLE_);
  return;
}

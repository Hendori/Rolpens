...

{
  ...
  if (param_1 != -1) {
    ...
    uVar4 = test_ptr("test/quic_client_test.c",0x43,
                     "c_net_bio = c_net_bio_own = BIO_new_dgram(c_fd, 0)",bp);
    uVar7 = (ulong)uVar4;
    if (uVar4 == 0) {
      SSL_free((SSL *)0x0);
...
LAB_0010046e:
      ...
      uVar4 = test_true("test/quic_client_test.c",0x3c,
...
LAB_00100089:
        ...
        uVar4 = test_ptr("test/quic_client_test.c",0x4a,
                         "c_ctx = SSL_CTX_new(OSSL_QUIC_client_method())",ctx);
        ssl = (SSL *)0x0;
        uVar7 = (ulong)uVar4;
        if (uVar4 != 0) {
          ssl = SSL_new(ctx);
          ...
          if (uVar4 != 0) {
            ...
            uVar4 = test_false("test/quic_client_test.c",0x51,
                               "SSL_set_alpn_protos(c_ssl, alpn, sizeof(alpn))",iVar5 != 0);
            uVar7 = (ulong)uVar4;
            if (uVar4 != 0) {
              ...
              if (iVar5 != 0) {
                ...
                bp = (BIO *)0x0;
                uVar4 = test_true("test/quic_client_test.c",0x60,"SSL_set_blocking_mode(c_ssl, 0)",
                                  iVar5 != 0);
                uVar7 = (ulong)uVar4;
...
LAB_001002f0:
                      if (!bVar3) {
                        ...
                        iVar5 = test_int_eq("test/quic_client_test.c",0x78,
                                            "SSL_write(c_ssl, msg1, sizeof(msg1) - 1)",
                                            "(int)sizeof(msg1) - 1",iVar5,0x11);
                        if (iVar5 == 0) goto LAB_001003ff;
                        iVar5 = SSL_stream_conclude(ssl,0);
                        iVar5 = test_true("test/quic_client_test.c",0x7c,
                                          "SSL_stream_conclude(c_ssl, 0)",iVar5 != 0);
                        if (iVar5 == 0) goto LAB_001003ff;
                      }
                      bVar1 = true;
                      bVar3 = true;
                      ...
                      if (iVar5 == 1) {
                        iVar5 = test_true("test/quic_client_test.c",0x6e,
                      ...
                      iVar5 = test_true("test/quic_client_test.c",0x6e,
                                        "ret == 1 || is_want(c_ssl, ret)",iVar5 - 2U < 2);
                      if (iVar5 == 0) goto LAB_001003ff;
                    }
                    if (((bool)(bVar3 & (bVar2 ^ 1U))) && (local_78 < 15999)) {
                      ...
                      if (iVar5 == 1) {
                        ...
                        iVar5 = test_size_t_lt("test/quic_client_test.c",0x8f,"c_total_read",
                                               "sizeof(msg2) - 1",local_78,15999);
joined_r0x00100655:
                        if (iVar5 != 0) goto LAB_0010038e;
                        goto LAB_001003ff;
                      }
                      iVar6 = SSL_get_error(ssl,iVar5);
                      if (iVar6 != 6) {
                        iVar5 = SSL_get_error(ssl,iVar5);
                        iVar5 = test_true("test/quic_client_test.c",0x89,"is_want(c_ssl, ret)",
                                          iVar5 - 2U < 2);
                        goto joined_r0x00100655;
                      }
                      test_info("test/quic_client_test.c",0x88,"Message:\n%s\n",msg2);
LAB_00100392:
                      iVar5 = SSL_shutdown(ssl);
                      if (iVar5 == 1) {
                        uVar7 = 1;
                        bp = (BIO *)0x0;
                        goto LAB_001000be;
...
LAB_001003c5:
                ...
                test_error("test/quic_client_test.c",0x68,
                           "timeout while attempting QUIC client test");
              }
LAB_001003ff:
              bp = (BIO *)0x0;
              uVar7 = 0;
...

{
  ...
  if (iVar1 != 0) {
    ...
    iVar1 = test_int_eq("test/quic_client_test.c",0xc3,
                        "connect(c_fd, (const struct sockaddr *)&sin, sizeof(sin))",&_LC22,iVar1,0);
    if (iVar1 != 0) {

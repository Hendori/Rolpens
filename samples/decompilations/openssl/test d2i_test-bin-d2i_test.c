...

{
  ...
  if (((*__s2 == 'O') && (__s2[1] == 'K')) && (__s2[2] == '\0')) {
    lVar4 = 0;
  }
  else {
    iVar1 = strcmp("BIO",__s2);
    if (iVar1 == 0) {
      lVar4 = 1;
    }
    else {
      iVar1 = strcmp("decode",__s2);
      if (iVar1 == 0) {
        lVar4 = 2;
      }
      else {
        iVar1 = strcmp("encode",__s2);
        if (iVar1 == 0) {
          lVar4 = 3;
        }
        else {
          iVar1 = strcmp("compare",__s2);
          if (iVar1 != 0) goto LAB_0010042b;
          lVar4 = 4;
        }
      }
    }
  }
  expected_error = *(int *)(expected_errors_0 + lVar4 * 0x10 + 8);
LAB_0010042b:
  if (expected_error == 0) {

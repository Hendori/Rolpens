...
LAB_00100362:
    ...
    if (((-1 < iVar1) || (iVar1 = ASN1_INTEGER_cmp(pAVar4,y), 0 < iVar1)) ||
       (iVar1 = ASN1_INTEGER_cmp(y_00,local_40), 0 < iVar1)) goto LAB_00100360;
...
LAB_001004f7:
    ...
    if (*piVar1 == 1) {
      for (iVar6 = 0; iVar2 = OPENSSL_sk_num(*(undefined8 *)(piVar1 + 2)), iVar6 < iVar2;
          iVar6 = iVar6 + 1) {
        ...
        if (*piVar3 == 0) {
          ...
          if ((*piVar3 != 1) ||
             (pcVar4 = i2s_ASN1_INTEGER((X509V3_EXT_METHOD *)0x0,
                                        (ASN1_INTEGER *)**(undefined8 **)(piVar3 + 2)),
             pcVar4 == (char *)0x0)) goto LAB_001004c7;
          BIO_printf(param_3,"%*s%s-",(ulong)(param_4 + 2),&_LC2,pcVar4);
          CRYPTO_free(pcVar4);
          pcVar4 = i2s_ASN1_INTEGER((X509V3_EXT_METHOD *)0x0,
                                    *(ASN1_INTEGER **)(*(long *)(piVar3 + 2) + 8));
...

{
  ...
  while( true ) {
    ...
    if (((0 < iVar2) || (iVar2 = ASN1_INTEGER_cmp(local_58,local_60), 0 < iVar2)) ||
       (iVar2 = ASN1_INTEGER_cmp(y,local_40), 0 < iVar2)) goto LAB_00100b20;
    ...
    if ((((bn == (BIGNUM *)0x0) && (bn = BN_new(), bn == (BIGNUM *)0x0)) ||
        (pBVar4 = ASN1_INTEGER_to_BN(local_60,bn), pBVar4 == (BIGNUM *)0x0)) ||
...

{
  ...
  if ((param_2 == 0) || (iVar3 = OPENSSL_sk_num(param_2), iVar3 < 1)) {
    if (param_1 == 0) {
      return 0;
    }
    goto LAB_001011a5;

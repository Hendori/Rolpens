      ...
      if (iVar3 == 0) {
        ...
        while (lVar10 != 0) {
          ...
          if (((param_1[5] == 0) || (iVar3 = OPENSSL_strcasecmp(uVar13), iVar3 == 0)) ||
             ((iVar3 = OPENSSL_strcasecmp(param_1[5],&_LC12), iVar3 == 0 &&
              (iVar3 = OPENSSL_strcasecmp(uVar13,&_LC13), iVar3 == 0)))) {
...

{
  ...
  lVar6 = 0;
  do {
    if (((local_f0[lVar6 * 0x10] & 1) != 0) &&
       (pcVar3 = *(char **)(local_f0 + lVar6 * 0x10 + -8), *pcVar3 != '/')) {
      ERR_clear_last_mark();
      ERR_new();

...

{
  ...
  if ((param_1 != (BIGNUM *)0x0) && (iVar2 = BN_num_bits(param_2), iVar2 != 0)) {
    iVar3 = iVar2 + 0xe;
    if (-1 < iVar2 + 7) {
      iVar3 = iVar2 + 7;
    }
      ...
      if (-1 < iVar4) {
        ...
        if (pBVar7 == (BIGNUM *)0x0) {
          ...
          if (((pBVar8 == (BIGNUM *)0x0) ||
              ((iVar4 = param_5 * 8 - iVar2, 0 < iVar4 &&
               (iVar4 = BN_rshift(pBVar7,pBVar7,iVar4), iVar4 == 0)))) ||
             ((iVar4 = BN_cmp(pBVar7,param_2), -1 < iVar4 &&
              (iVar4 = BN_usub(pBVar7,pBVar7,param_2), iVar4 == 0)))) {
            BN_free(pBVar7);
          }
          else {
                ...
                if (0 < iVar4) {
                  ...
                  if (iVar4 - iVar2 < 1) {
                    do {
                      ...
                      if ((iVar2 == 0) ||
                         (pBVar7 = BN_bin2bn(s,iVar3 + 8,param_1), pBVar7 == (BIGNUM *)0x0))
                      goto LAB_001003b5;
                      BN_set_flags(param_1,4);
                      ossl_bn_mask_bits_fixed_top(param_1,iVar4);
                      iVar2 = ossl_bn_is_word_fixed_top(param_1,0);
                    } while (((iVar2 != 0) ||
                             (iVar2 = ossl_bn_is_word_fixed_top(param_1,1), iVar2 != 0)) ||
                            (iVar2 = BN_ucmp(param_1,param_2), -1 < iVar2));
                  }
                  else {
                    do {
                      ...
                      iVar5 = ossl_bn_is_word_fixed_top(param_1,0);
                             ...
                             (iVar5 = ossl_bn_is_word_fixed_top(param_1,1), iVar5 != 0)) ||
                            (iVar5 = BN_ucmp(param_1,param_2), -1 < iVar5));
                  }
                  iVar5 = 1;
                  goto LAB_001003c0;
                }

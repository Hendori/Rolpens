...

{
  ...
  ptr = (long *)CRYPTO_zalloc(0x30,"crypto/x509/x_pubkey.c",0x74);
  if (ptr == (long *)0x0) {
    return 0;
  }
  if (*ptr == 0) {
    a = X509_ALGOR_new();
    *ptr = (long)a;
    if (a == (X509_ALGOR *)0x0) goto LAB_001002b0;
  }
  if (ptr[1] == 0) {
    pAVar2 = ASN1_BIT_STRING_new();
    ptr[1] = (long)pAVar2;
    if (pAVar2 != (ASN1_BIT_STRING *)0x0) goto LAB_0010024b;
  }
  else {
LAB_0010024b:
    ptr[3] = param_3;
...
LAB_0010028a:
    ...
    pcVar1 = CRYPTO_strdup(param_4,"crypto/x509/x_pubkey.c",0x37);
    ptr[4] = (long)pcVar1;
    if (pcVar1 != (char *)0x0) goto LAB_0010028a;
  }
  a = (X509_ALGOR *)*ptr;
LAB_001002b0:
  X509_ALGOR_free(a);
...

{
  ...
  if (pAVar6 == (ASN1_VALUE *)0x0) {
    ...
    if (iVar1 != 0) {
      pAVar6 = *param_1;
      if (*(long *)pAVar6 == 0) goto LAB_001005bb;
      goto LAB_001003bb;
    }
  }
  else {
      ...
      *(undefined8 *)(pAVar6 + 0x10) = 0;
      ...
      if (iVar1 == -1) {
        ...
        if (param_6 == 0) {
          ...
          if (ptr == (uchar *)0x0) goto LAB_00100618;
          *ptr = '0';
          puVar7 = ptr;
        }
        local_88 = puVar7;
...
LAB_001005bb:
    ...
    *(X509_ALGOR **)pAVar6 = pXVar4;
    if (pXVar4 != (X509_ALGOR *)0x0) goto LAB_001003bb;
LAB_001005e8:
    ERR_new();
...

{
  ...
  ptr = (undefined8 *)CRYPTO_zalloc(0x30,"crypto/x509/x_pubkey.c",0x11d);
  if (ptr != (undefined8 *)0x0) {
    ...
    ptr[4] = 0;
    if (pcVar2 != (char *)0x0) {
      pcVar2 = CRYPTO_strdup(pcVar2,"crypto/x509/x_pubkey.c",0x37);
      ptr[4] = pcVar2;
      if (pcVar2 == (char *)0x0) {
        ERR_new();
    ...
    a = X509_ALGOR_dup((X509_ALGOR *)*param_1);
    *ptr = a;
    if (a != (X509_ALGOR *)0x0) {
      a_00 = ASN1_BIT_STRING_new();
      ptr[1] = a_00;
      if ((a_00 != (ASN1_BIT_STRING *)0x0) &&
         (iVar1 = ASN1_BIT_STRING_set(a_00,*(uchar **)((int *)param_1[1] + 2),*(int *)param_1[1]),
         iVar1 != 0)) {
        if (param_1[2] != 0) {
          ERR_set_mark();
          lVar3 = EVP_PKEY_dup(param_1[2]);
          ptr[2] = lVar3;
          if (lVar3 == 0) {
            *(byte *)(ptr + 5) = *(byte *)(ptr + 5) | 1;
            iVar1 = x509_pubkey_decode(ptr + 2,ptr);
            if (iVar1 < 1) {
              X509_ALGOR_free((X509_ALGOR *)*ptr);
              ASN1_BIT_STRING_free((ASN1_BIT_STRING *)ptr[1]);
              EVP_PKEY_free((EVP_PKEY *)ptr[2]);
  ...
  if (*(long *)&pkey->references == 0) {
    if (*(long *)&pkey[1].save_parameters != 0) {
      ...
      if (iVar2 == 0) {
        ...
        OSSL_ENCODER_CTX_free(uVar3);
        CRYPTO_free(local_48);
        if (a != (X509_PUBKEY *)0x0) goto LAB_00100b73;
      }
    }
    ERR_new();
...
EVP_PKEY * ossl_d2i_PUBKEY_legacy(EVP_PKEY *param_1,undefined8 *param_2,long param_3)

{
  ...
  if (pEVar1 != (EVP_PKEY *)0x0) {
    ...
    *(byte *)&local_40->save_parameters = (byte)local_40->save_parameters | 1;
    key = d2i_X509_PUBKEY((X509_PUBKEY **)&local_40,&local_38,param_3);
    if (key == (X509_PUBKEY *)0x0) {
      pEVar1 = (EVP_PKEY *)0x0;
      X509_PUBKEY_free((X509_PUBKEY *)local_40);
    }
    else {
...
EVP_PKEY *
d2i_PUBKEY_ex(EVP_PKEY *param_1,undefined8 *param_2,long param_3,ENGINE *param_4,char *param_5)
...
LAB_0010107a:
    ...
    if (key == (X509_PUBKEY *)0x0) goto LAB_00101198;
    pEVar1 = X509_PUBKEY_get(key);
    X509_PUBKEY_free(key);
    local_50 = (EVP_PKEY *)0x0;
    if (pEVar1 == (EVP_PKEY *)0x0) {
    ...
    pEVar1 = (EVP_PKEY *)CRYPTO_zalloc(0x30,"crypto/x509/x_pubkey.c",0x1fb);
    local_50 = pEVar1;
    if (pEVar1 == (EVP_PKEY *)0x0) goto LAB_001010e0;
...
LAB_0010117e:
      a = &local_50;
      *(byte *)&local_50->save_parameters = (byte)local_50->save_parameters & 0xfe;
      goto LAB_0010107a;
    }
    pcVar2 = CRYPTO_strdup(param_5,"crypto/x509/x_pubkey.c",0x37);
    (pEVar1->pkey).ptr = pcVar2;
    if (pcVar2 != (char *)0x0) goto LAB_0010117e;
LAB_00101198:
    pEVar1 = (EVP_PKEY *)0x0;
    param_1 = local_50;
  }
...

{
  ...
  if (*(long *)&a->references == 0) {
    if (*(long *)&a[1].save_parameters == 0) goto LAB_0010135e;
...
LAB_001012ba:
      ...
      if (iVar2 == 0) goto LAB_001012ba;
      lVar4 = BIO_ctrl(bp,0x73,0,&local_38);
      if (lVar4 < 1) goto LAB_001012ba;
      iVar2 = (int)*local_38;
      if (pp != (uchar **)0x0) {
        if (*pp == (uchar *)0x0) {
          *pp = (uchar *)local_38[1];

...
LAB_00100e90:
        ...
        local_258 = EVP_KDF_CTX_new(lVar3);
        EVP_KDF_free(lVar3);
        if (local_258 == 0) goto LAB_00100e90;
        uVar4 = EVP_MD_get0_name(lVar2);
        OSSL_PARAM_construct_utf8_string(&local_248,"digest",uVar4,0);
        local_1e8 = local_228;
        local_208 = local_248;
        uStack_200 = uStack_240;
        local_1f8 = local_238;
        uStack_1f0 = uStack_230;
        OSSL_PARAM_construct_octet_string(&local_248,"secret",param_3,param_4);
        local_1c0 = local_228;
        local_1e0 = local_248;
        uStack_1d8 = uStack_240;
        local_1d0 = local_238;
        uStack_1c8 = uStack_230;
        OSSL_PARAM_construct_octet_string(&local_248,&_LC4,"master secret",0xd);
        local_198 = local_228;
        local_1b8 = local_248;
        uStack_1b0 = uStack_240;
        local_1a8 = local_238;
        uStack_1a0 = uStack_230;
        OSSL_PARAM_construct_octet_string(&local_248,&_LC4,param_1 + 0x188,0x20);
        local_190 = local_248;
        uStack_188 = uStack_240;
        local_180 = local_238;
        uStack_178 = uStack_230;
        local_170 = local_228;
        OSSL_PARAM_construct_octet_string(&local_248,&_LC4,0,0);
        local_148 = local_228;
        local_168 = local_248;
        uStack_160 = uStack_240;
        local_158 = local_238;
        uStack_150 = uStack_230;
        OSSL_PARAM_construct_octet_string(&local_248,&_LC4,param_1 + 0x168,0x20);
        local_140 = local_248;
        ...
        OSSL_PARAM_construct_end(&local_248);
        local_f0 = local_248;
        uStack_e8 = uStack_240;
        local_d0 = local_228;
        local_e0 = local_238;
        uStack_d8 = uStack_230;
        iVar1 = EVP_KDF_derive(local_258,param_2,0x30,&local_208);
        if (iVar1 != 0) {
          EVP_KDF_CTX_free(local_258);
          goto LAB_00100e38;
        }
      }
      ERR_new();
    ...
    if (iVar1 != 0) {
      iVar1 = ssl_handshake_hash(param_1,local_c8,0x80,&local_210);
      if (iVar1 != 0) {
        iVar1 = tls1_PRF_constprop_0
                          (param_1,"extended master secret",0x16,local_c8,local_210,0,0,0,0,param_3,
                           param_4,param_2,0x30,1);
        if (iVar1 != 0) {
          OPENSSL_cleanse(local_c8,local_210);
LAB_00100e38:
          *param_5 = 0x30;
          uVar4 = 1;
          goto LAB_00100af9;
...
joined_r0x001010e2:
      if ((lVar2 != 0x6620746e65696c63) || (*(long *)((long)__dest + 7) != 0x64656873696e6966)) {
        if (*__dest == 0x6620726576726573) {
          if (*(long *)((long)__dest + 7) == 0x64656873696e6966) goto LAB_00101104;
          lVar2 = *__dest;
        }
        else {
          lVar2 = *__dest;
...
LAB_00101104:
    ...
    if (__dest != (long *)0x0) {
      ...
      *(undefined1 *)((long)__dest + param_5 + 0x41) = (undefined1)param_7;
      if (param_6 == (void *)0x0 && param_7 == 0) goto LAB_00100f69;
      memcpy((void *)((long)__dest + param_5 + 0x42),param_6,param_7);
      lVar2 = *__dest;
      goto joined_r0x001010e2;
    }
  }
  uVar10 = 0;
LAB_00101132:

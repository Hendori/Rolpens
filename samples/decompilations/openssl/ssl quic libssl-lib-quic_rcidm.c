...

{
  ...
  if ((((param_1[0x88] & 4) != 0) &&
      (((*(long *)(param_1 + 0x48) == 0 || (9999 < *(ulong *)(param_1 + 0x40))) ||
       ((param_1[0x88] & 0x40) != 0)))) &&
     (lVar7 = ossl_pqueue_peek(*(undefined8 *)(param_1 + 0x58)), lVar7 != 0)) {
...
joined_r0x0010019f:
  if (lVar7 == 0) {
    ...
    if ((lVar7 == 0) || (bVar1 = *(byte *)(lVar7 + 0x38), (bVar1 & 3) == 1)) {
      ...
      if (lVar7 == 0) {
        ...
        if ((bVar1 & 0x14) == 0x10) {
          bVar1 = *param_1;
          if (((param_1[0x2a] == bVar1) && (bVar1 < 0x15)) &&
             (iVar6 = memcmp(param_1 + 1,param_1 + 0x2b,(ulong)bVar1), iVar6 == 0)) {
            return;
          }
        ...
        bVar1 = *param_1;
        if (((param_1[0x15] == bVar1) && (bVar1 < 0x15)) &&
           (iVar6 = memcmp(param_1 + 1,param_1 + 0x16,(ulong)bVar1), iVar6 == 0)) {
          return;
        }
        param_1[0x88] = param_1[0x88] | 3;
  ...
  bVar1 = *param_1;
  if (((*(byte *)(lVar7 + 0x10) != bVar1) || (0x14 < bVar1)) ||
     (iVar6 = memcmp(param_1 + 1,(void *)(lVar7 + 0x11),(ulong)bVar1), iVar6 != 0)) {
...
byte * ossl_quic_rcidm_new(undefined8 *param_1)
  ...
  if (ptr != (byte *)0x0) {
    ...
    *(long *)(ptr + 0x58) = lVar9;
    if (lVar9 != 0) {
      ...
      if (lVar10 == 0) {
        ...
        if ((lVar10 == 0) || (bVar1 = *(byte *)(lVar10 + 0x38), (bVar1 & 3) == 1)) {
          ...
          if (lVar10 == 0) {
            ...
            if ((bVar1 & 0x14) == 0x10) {
              bVar1 = *ptr;
              if (((ptr[0x2a] == bVar1) && (bVar1 < 0x15)) &&
                 (iVar8 = memcmp(ptr + 1,ptr + 0x2b,(ulong)bVar1), iVar8 == 0)) {
                return ptr;
              }
              ptr[0x88] = ptr[0x88] | 3;
            ...
            bVar1 = *ptr;
            if (((ptr[0x15] == bVar1) && (bVar1 < 0x15)) &&
               (iVar8 = memcmp(ptr + 1,ptr + 0x16,(ulong)bVar1), iVar8 == 0)) {
              return ptr;
            }
            ptr[0x88] = ptr[0x88] | 3;
      ...
      bVar1 = *ptr;
      if (((*(byte *)(lVar10 + 0x10) == bVar1) && (bVar1 < 0x15)) &&
         (iVar8 = memcmp(ptr + 1,(void *)(lVar10 + 0x11),(ulong)bVar1), iVar8 == 0)) {
        return ptr;
      }
...
void ossl_quic_rcidm_on_handshake_complete(byte *param_1)

{
  ...
  if ((((*(long *)(param_1 + 0x48) == 0) || (9999 < *(ulong *)(param_1 + 0x40))) ||
      ((bVar1 & 0x40) != 0)) &&
     (lVar7 = ossl_pqueue_peek(*(undefined8 *)(param_1 + 0x58)), lVar7 != 0)) {
    bVar1 = *(byte *)(lVar7 + 0x38);
    if ((bVar1 & 3) != 1) {
...
void ossl_quic_rcidm_on_packet_sent(byte *param_1,long param_2)

{
  ...
  *(long *)(param_1 + 0x40) = param_2 + lVar7;
  if ((((param_1[0x88] & 4) != 0) &&
      (((*(long *)(param_1 + 0x48) == 0 || (9999 < (ulong)(param_2 + lVar7))) ||
       ((param_1[0x88] & 0x40) != 0)))) &&
     (lVar7 = ossl_pqueue_peek(*(undefined8 *)(param_1 + 0x58)), lVar7 != 0)) {
    bVar1 = *(byte *)(lVar7 + 0x38);
    if ((bVar1 & 3) != 1) {
  ...
  bVar1 = *param_1;
  if (((*(byte *)(lVar7 + 0x10) == bVar1) && (bVar1 < 0x15)) &&
     (iVar6 = memcmp(param_1 + 1,(void *)(lVar7 + 0x11),(ulong)bVar1), iVar6 == 0)) {
    return;
  }
...
void ossl_quic_rcidm_request_roll(byte *param_1)
...
undefined8 ossl_quic_rcidm_add_from_initial(long param_1,char *param_2)
...
undefined8 ossl_quic_rcidm_add_from_server_retry(byte *param_1,undefined8 *param_2)
...
undefined8 ossl_quic_rcidm_add_from_ncid(long param_1,ulong *param_2)

{
  ...
  uVar2 = *param_2;
  if ((((0x13 < (byte)((char)param_2[2] - 1U)) || (uVar2 >> 0x3e != 0)) ||
      (lVar7 = ossl_pqueue_num(*(undefined8 *)(param_1 + 0x58)),
      lVar7 + *(long *)(param_1 + 0x80) < 0)) ||
     (puVar8 = (undefined8 *)CRYPTO_zalloc(0x40,"ssl/quic/quic_rcidm.c",0x161),

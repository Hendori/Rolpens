...
undefined8 cookie_gen(undefined8 param_1,undefined8 *param_2,undefined4 *param_3)
...

{
  ...
  iVar1 = test_int_ge("test/dtlsv1listentest.c",0x140,"ret = DTLSv1_listen(ssl, peer)",&_LC8,uVar2,0
                     );
  if (iVar1 == 0) goto LAB_00100094;
  lVar4 = BIO_ctrl(bp,3,0,&local_48);
  if (*(int *)(testpackets + lVar3 + 0xc) == 1) {
    iVar1 = test_int_eq("test/dtlsv1listentest.c",0x145,&_LC10,&_LC8,uVar2,0);
    if (iVar1 != 0) {
      iVar1 = test_mem_eq("test/dtlsv1listentest.c",0x146,&_LC12,"verify",local_48,lVar4,verify,0x30
                         );

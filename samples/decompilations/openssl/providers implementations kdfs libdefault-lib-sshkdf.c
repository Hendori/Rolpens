...
LAB_001004e1:
    ...
    if ((iVar2 == 0) ||
       ((iVar2 = EVP_DigestUpdate(ctx,&local_8d,1), iVar2 == 0 ||
        (iVar2 = EVP_DigestUpdate(ctx,d_01,cnt), iVar2 == 0)))) goto LAB_001004e1;
      ...
      while (__n < param_3) {
        ...
        if ((((iVar2 == 0) || (iVar2 = EVP_DigestUpdate(ctx,d,cnt_01), iVar2 == 0)) ||
           ...
           ((iVar2 = EVP_DigestUpdate(ctx,param_2,__n), iVar2 == 0 ||
            (iVar2 = EVP_DigestFinal_ex(ctx,local_88,&local_8c), iVar2 == 0)))) goto LAB_001004e1;
        uVar1 = __n + local_8c;
        if (param_3 < uVar1) {
  ...
  if ((iVar2 != 0) &&
    ...
    *ptr = uVar1;
    ...
    if ((iVar2 != 0) &&
      ...
      if ((iVar2 != 0) && (iVar2 = ossl_prov_digest_copy(ptr + 1,param_1 + 1), iVar2 != 0)) {
    ...
    *(undefined1 (*) [16])(ptr + 7) = (undefined1  [16])0x0;
    *(undefined1 (*) [16])(ptr + 9) = (undefined1  [16])0x0;
    *ptr = uVar1;
    CRYPTO_free(ptr);
  }

...

{
  ...
  if ((iVar1 == 0) || (iVar1 = ossl_pw_enable_passphrase_caching(local_78), iVar1 == 0)) {
    pEVar7 = (EVP_PKEY *)0x0;
  }
  else {
    ERR_set_mark();
...
LAB_001005e0:
      ...
      if (iVar1 != 0) {
        ...
        while( true ) {
          iVar1 = (int)lVar4;
          iVar2 = OSSL_DECODER_from_bio(lVar5,param_1);
          if ((iVar2 != 0) && (local_80 != (EVP_PKEY *)0x0)) {
            ERR_pop_to_mark();
            uVar3 = param_7 & 0xfffffffd;
            if ((param_7 & 1) == 0) {
              uVar3 = param_7;
            }
            iVar1 = evp_keymgmt_util_has(local_80,uVar3);
            if (iVar1 == 0) {

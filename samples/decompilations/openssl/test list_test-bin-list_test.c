  ...
  if (iVar3 != 0) {
    ...
    do {
      ...
      *pauVar4 = (undefined1  [16])0x0;
      ...
      if ((uint)(iVar3 * -0x33333333) < 0x33333334) {
...

{
  ...
  if (iVar2 != 0) {
    ...
    if ((iVar2 != 0) && (iVar2 = test_ptr_null("test/list_test.c",0x80,&_LC35,puVar7), iVar2 != 0))
    {
      ...
      puVar8 = local_248;
      puVar9 = (undefined4 *)local_178._8_8_;
      puStack_240 = (undefined4 *)local_178._8_8_;
      puVar7 = puVar9;
      puVar6 = local_248;
      if ((undefined4 *)local_178._8_8_ == (undefined4 *)0x0) {
        if ((undefined4 *)local_178._0_8_ != (undefined4 *)0x0) goto LAB_0010092c;
LAB_00100a02:
...
LAB_0010092c:
        ...
        local_238 = 4;
        local_178._0_16_ = (undefined1  [16])0x0;
        if ((local_248 == (undefined4 *)0x0) || (puVar9 == (undefined4 *)0x0)) goto LAB_00100a02;
        iVar2 = 2;
        do {
      ...
      if ((iVar2 != 0) && (iVar2 = test_ptr_null("test/list_test.c",0x91,&_LC35,puVar7), iVar2 != 0)
        ...
        if (puVar8 == local_1f8) {
          puVar8 = (undefined4 *)local_1f0._0_8_;
          local_248 = (undefined4 *)local_1f0._0_8_;
        }
        if (puVar9 == local_1f8) {
          puVar9 = (undefined4 *)local_1f0._8_8_;
        ...
        if (puVar8 == local_1c8) {
          puVar8 = (undefined4 *)local_1c0._0_8_;
          local_248 = (undefined4 *)local_1c0._0_8_;
        }
        if (puVar9 == local_1c8) {
          puVar9 = (undefined4 *)local_1c0._8_8_;
        ...
        if (puVar8 == local_1e0) {
          puVar8 = (undefined4 *)local_1d8._0_8_;
          local_248 = (undefined4 *)local_1d8._0_8_;
        }
        if (puVar9 == local_1e0) {
          puVar9 = (undefined4 *)local_1d8._8_8_;
        ...
        local_238 = 1;
        iVar2 = test_ptr("test/list_test.c",0x98,"ossl_list_int_head(&l)",puVar8);
        if ((((iVar2 != 0) &&
             (iVar2 = test_ptr("test/list_test.c",0x99,"ossl_list_int_tail(&l)",puVar9), iVar2 != 0)
             ) && (iVar2 = test_int_eq("test/list_test.c",0x9a,"ossl_list_int_head(&l)->n",&_LC16,
                                       *puVar8,5), iVar2 != 0)) &&
           (iVar2 = test_int_eq("test/list_test.c",0x9b,"ossl_list_int_tail(&l)->n",&_LC16,*puVar9,5
                               ), iVar2 != 0)) {
          local_238 = 2;
          *(undefined4 **)(puVar8 + 4) = local_228;
          uStack_218 = 0;
          local_248 = local_228;
          local_220 = puVar8;

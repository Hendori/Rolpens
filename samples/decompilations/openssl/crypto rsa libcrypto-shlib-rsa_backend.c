...

{
  ...
  if (param_1 != 0) {
    ...
    if ((((lVar6 == 0) || (iVar2 = OSSL_PARAM_get_BN(lVar6,&local_60), iVar2 == 0)) || (lVar7 == 0))
       || (iVar2 = OSSL_PARAM_get_BN(lVar7,&local_58), iVar2 == 0)) {
      ERR_new();
      uVar11 = 0x53;
LAB_00100151:
...
LAB_00100170:
      ...
      if ((lVar6 != 0) && (iVar2 = OSSL_PARAM_get_int(lVar6,&local_74), iVar2 == 0))
      goto LAB_00100170;
      local_88 = OSSL_PARAM_locate_const(param_2,&_LC4);
      if ((local_88 != 0) && (iVar2 = OSSL_PARAM_get_BN(local_88,&local_50), iVar2 == 0)) {
        ERR_new();
        uVar11 = 0x61;
        goto LAB_00100151;
      }
...
LAB_00100330:
                ...
                if (lVar8 != 0) {
                  ...
                  if (((local_74 == 0) || (iVar2 = OPENSSL_sk_num(lVar7), iVar2 != 0)) ||
                     (iVar2 = OPENSSL_sk_num(lVar8), iVar2 != 0)) {
                    iVar2 = OPENSSL_sk_num(lVar6);
                    if ((iVar2 == 0) ||
                       (iVar2 = ossl_rsa_set0_all_params(param_1,lVar6,lVar7,lVar8), iVar2 != 0))
                    goto LAB_001003ec;
                  }
                  else {
                    iVar2 = OPENSSL_sk_num(lVar6);
...
LAB_001003ec:
                              iVar2 = OPENSSL_sk_num(lVar6);
                              if (((iVar2 == 0) && (iVar2 = OPENSSL_sk_num(lVar7), iVar2 == 0)) &&
                                 (iVar2 = OPENSSL_sk_num(lVar8), iVar2 == 0)) goto LAB_00100420;
                              ERR_new();
...
LAB_0010053a:
        ...
        if (((lVar6 != 0) && (iVar2 = OSSL_PARAM_get_BN(lVar6,&local_70), lVar7 != 0)) &&
           ((iVar2 != 0 && (iVar2 = OSSL_PARAM_get_BN(lVar7,&local_68), iVar2 != 0))))
        goto LAB_001001ff;
        ERR_new();
        lVar8 = 0;
        lVar7 = 0;
...

{
  ...
  if (lVar4 == 0) {
LAB_00100cca:
    if (*param_2 != 0) goto LAB_00100d20;
LAB_00100cd1:
    if (lVar5 != 0 || lVar6 != 0) {

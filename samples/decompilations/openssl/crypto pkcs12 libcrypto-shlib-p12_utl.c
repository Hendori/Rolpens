...
LAB_001000bf:
  (puVar3 + (long)(int)num + -2)[0] = '\0';
  (puVar3 + (long)(int)num + -2)[1] = '\0';
  if (unilen != (int *)0x0) {
    *unilen = num;
  }
  if (uni != (uchar **)0x0) {
...

{
  ...
  if (param_2 < 1) {
    ...
    do {
      ...
      if (0x10ffff < local_48) goto LAB_001002b0;
      iVar7 = local_4c + 4;
      local_4c = local_4c + 2;
      if (0xffff < local_48) {
        local_4c = iVar7;
...

{
  ...
  if ((int)param_2 < 1) {
    iVar7 = 0;
    if (param_2 != 0) goto LAB_0010048d;
LAB_0010049c:
    iVar7 = iVar7 + 1;
  }
  else {
...
LAB_0010048d:
  ...
  if ((int)param_2 < 1) {
    if (param_2 == 0) goto LAB_0010058d;
    iVar7 = 0;
  }
  else {
    iVar7 = 0;
...
LAB_001004d0:
        iVar6 = iVar6 + 2;
        iVar7 = iVar7 + iVar8;
        if ((int)param_2 <= iVar6) goto LAB_00100568;
      }
      if (4 < iVar8) {
        iVar8 = 4;
      }
      iVar8 = UTF8_putc((uchar *)(pcVar2 + iVar7),iVar8,uVar5);
      if (iVar8 != 4) goto LAB_001004d0;
      iVar6 = iVar6 + 4;
      iVar7 = iVar7 + 4;
    } while (iVar6 < (int)param_2);
  }

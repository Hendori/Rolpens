    ...
    *(undefined4 *)(param_1 + 100) = uVar2;
    if (lVar8 == 0) {
      ...
      if ((((iVar7 == 0x1a) || (iVar7 == 0x13)) ||
          ...
          iVar3 != 0)) &&
         (iVar3 = ossl_cmp_msg_check_update(param_1,*param_3,0x100000,param_4), iVar3 != 0)) {
        if (param_4 == iVar7) {
LAB_00100628:
          uVar4 = 1;
          goto LAB_00100532;
        ...
        if (param_4 == 0x1a) {
          if (iVar7 != 0x17) goto LAB_00100628;
          ERR_new();
...

{
  ...
  local_48 = 0;
  if (param_3 != 0) goto LAB_001008f1;
...

{
  ...
  if ((param_1 == 0) || (param_3 == 0)) goto LAB_00100caa;
  uVar1 = ossl_cmp_pkisi_get_status(*(undefined8 *)(param_3 + 8));
  switch(uVar1) {
  case 0:
    goto switchD_00100b2b_caseD_0;
  case 1:
    uVar3 = 0x20a;
...
bool save_senderNonce_if_waiting(long param_1,long param_2,undefined4 param_3)

{
  ...
  if ((((uVar1 & 0xfffffffd) == 1) || (uVar1 == 8)) &&
     (lVar3 = ossl_cmp_certrepmessage_get0_certresponse
                        (*(undefined8 *)(*(long *)(param_2 + 8) + 8),param_3), lVar3 != 0)) {
    iVar2 = ossl_cmp_pkisi_get_status(*(undefined8 *)(lVar3 + 8));
    if ((iVar2 != 3) && (iVar2 = ossl_cmp_is_error_with_waiting(param_2), iVar2 == 0)) {
      return true;
    }
  }
  else {
    iVar2 = ossl_cmp_is_error_with_waiting(param_2);
    if (iVar2 == 0) {
      return true;
    }
  }
...
poll_for_response_constprop_0
          (long param_1,int param_2,undefined4 param_3,long *param_4,undefined4 *param_5)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  local_458 = 0;
  ossl_cmp_print_log(6,param_1,"poll_for_response","crypto/cmp/cmp_client.c",0x120,&_LC11);
  *param_4 = 0;
  if (param_2 == 0) {
    lVar5 = ossl_cmp_pollReq_new(param_1,param_3);
    if (lVar5 == 0) goto LAB_00101420;
    iVar1 = send_receive_check(param_1,lVar5,&local_458,0x1a);
    lVar10 = local_458;
    if (iVar1 == 0) goto LAB_00101248;
    iVar1 = OSSL_CMP_MSG_get_bodytype(local_458);
    if (iVar1 == 0x1a) {
      uVar8 = *(undefined8 *)(*(long *)(lVar10 + 8) + 8);
      iVar1 = OPENSSL_sk_num();
      if (iVar1 < 2) {
        lVar6 = ossl_cmp_pollrepcontent_get0_pollrep(uVar8,param_3);
        if (lVar6 != 0) {
          iVar1 = ASN1_INTEGER_get_int64(&local_450,*(undefined8 *)(lVar6 + 8));
          if (iVar1 == 0) {
LAB_00101528:
            ERR_new();
            ...
            if ((-1 < (long)local_450) && (local_450 < 0x80000000)) {
              if ((*(long *)(lVar6 + 0x10) == 0) ||
                ...
                lVar9 = (long)iVar1;
                pvVar7 = (void *)ossl_sk_ASN1_UTF8STRING2text
                                           (*(undefined8 *)(lVar6 + 0x10),&_LC18,0x3fe - lVar9);
                if ((pvVar7 == (void *)0x0) ||
                   (iVar1 = BIO_snprintf(local_448 + lVar9,0x400 - lVar9,"%s\'",pvVar7), iVar1 < 0))
                {
                  local_448[0] = '\0';
                }
                CRYPTO_free(pvVar7);
              }
              ossl_cmp_print_log(6,param_1,"poll_for_response","crypto/cmp/cmp_client.c",0x155,
                                 &_LC11,"received polling response%s; checkAfter = %ld seconds",
                                 local_448,local_450);
              if (*(int *)(param_1 + 0x68) != 0) {
...
LAB_00101651:
                ...
                if ((long)uVar4 < (long)local_450) {
                  local_450 = uVar4;
                }
              }
              OSSL_CMP_MSG_free(lVar5);
              OSSL_CMP_MSG_free(lVar10);
...
LAB_00101445:
    uVar2 = OSSL_CMP_MSG_get_bodytype(lVar10);
    if ((((((uVar2 & 0xfffffffd) == 1) || (uVar2 == 8)) &&
         (lVar6 = ossl_cmp_certrepmessage_get0_certresponse
                            (*(undefined8 *)(*(long *)(lVar10 + 8) + 8),param_3), lVar6 != 0)) &&
        (iVar1 = ossl_cmp_pkisi_get_status(*(undefined8 *)(lVar6 + 8)), iVar1 == 3)) ||
       (iVar1 = ossl_cmp_is_error_with_waiting(lVar10), iVar1 != 0)) {
    ...
    while (lVar5 = ossl_cmp_pollReq_new(param_1,param_3), lVar5 != 0) {
      iVar1 = send_receive_check(param_1,lVar5,&local_458,0x1a);
      lVar10 = local_458;
      if (iVar1 == 0) goto LAB_00101248;
      iVar1 = OSSL_CMP_MSG_get_bodytype(local_458);
      if (iVar1 != 0x1a) goto LAB_00101445;
      uVar8 = *(undefined8 *)(*(long *)(lVar10 + 8) + 8);
      iVar1 = OPENSSL_sk_num(uVar8);
      if (1 < iVar1) goto LAB_001014f0;
      lVar6 = ossl_cmp_pollrepcontent_get0_pollrep(uVar8,param_3);
      if (lVar6 == 0) goto LAB_00101248;
      iVar1 = ASN1_INTEGER_get_int64(&local_450,*(undefined8 *)(lVar6 + 8));
      if (iVar1 == 0) goto LAB_00101528;
      if (((long)local_450 < 0) || (0x4189374bc6a7ef < local_450)) goto LAB_001011f0;
      if ((*(long *)(lVar6 + 0x10) == 0) ||
         (iVar1 = BIO_snprintf(local_448,0x400," with reason = \'"), iVar1 < 0)) {
        local_448[0] = '\0';
      }
      ...
      if (*(int *)(param_1 + 0x68) != 0) {
        ...
        tVar3 = time((time_t *)0x0);
        uVar4 = (lVar6 + -2) - tVar3;
        if ((long)uVar4 < 1) goto LAB_00101651;
        if ((long)uVar4 < (long)local_450) {
          local_450 = uVar4;
        }
      }
...
undefined8
send_receive_also_delayed(undefined8 param_1,undefined8 param_2,long *param_3,int param_4)
...
LAB_001016b5:
    ...
    if (iVar1 != 0) {
      iVar1 = save_senderNonce_if_waiting(param_1,*param_3,0xffffffff);
      if (iVar1 == 0) goto LAB_001016b5;
      lVar3 = *param_3;
      if (param_4 != 0x13) {
...
LAB_00101a06:
      ...
      if (local_58 == (undefined8 *)0x0) goto LAB_00101a28;
      uVar5 = local_58[1];
...
LAB_001018d1:
      ...
      if (iVar3 != 3) {
        ...
        if (((plVar6 != (long *)0x0) && (*plVar6 != 0)) &&
           (iVar3 = ossl_cmp_ctx_set1_caPubs(param_1), iVar3 == 0)) goto LAB_00101a28;
...
ulong OSSL_CMP_try_certreq(long param_1,int param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  local_48 = 0;
  if (param_2 == 4) {
    if (param_1 == 0) goto LAB_00101f30;
...
LAB_00101ef3:
    uVar2 = poll_for_response_constprop_0(param_1,0,uVar6,&local_48,param_4);
    uVar3 = (ulong)uVar2;
    if (0 < (int)uVar2) {
LAB_00101f11:
      uVar2 = cert_response_isra_0(param_1,0,uVar6,&local_48,param_4,iVar5);
LAB_00101f29:
      uVar3 = (ulong)uVar2;
      uVar6 = local_48;
      goto LAB_00101ebc;
...
LAB_00101f30:
      ...
      if (*(int *)(param_1 + 0x1d0) == 3) {
        if (param_2 < 0) {
          if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
            uVar3 = ossl_cmp_exchange_error(param_1,2,0,"polling aborted",0,"by application");
            return uVar3;
          }
          goto LAB_00101f67;
        }
...
LAB_00101e36:
      *(undefined4 *)(param_1 + 0x1d0) = 0xfffffffd;
      ...
      if (iVar1 != 0) {
        lVar4 = ossl_cmp_certreq_new(param_1,param_2,param_3);
        if (lVar4 != 0) {
          *(undefined4 *)(param_1 + 0x1d0) = 0xfffffffe;
          uVar2 = send_receive_check(param_1,lVar4,&local_48,iVar5);
          OSSL_CMP_MSG_free(lVar4);
          if (uVar2 == 0) goto LAB_00101f29;
          iVar1 = save_senderNonce_if_waiting(param_1,local_48,uVar6);
          if (iVar1 != 0) goto LAB_00101f11;
          uVar3 = 0;
          goto LAB_00101ec1;
        }
      }
...
undefined8 OSSL_CMP_exec_certreq(long param_1,int param_2,undefined8 param_3)
...
LAB_00101fd3:
    ...
    lVar2 = ossl_cmp_certreq_new(param_1,param_2,param_3);
    if (lVar2 == 0) goto LAB_00101fd3;
    *(undefined4 *)(param_1 + 0x1d0) = 0xfffffffe;
    iVar1 = send_receive_check(param_1,lVar2,&local_48,iVar5);
    OSSL_CMP_MSG_free(lVar2);
    if (iVar1 == 0) {
LAB_001020e0:
      uVar4 = 0;
      ...
      iVar1 = save_senderNonce_if_waiting(param_1,local_48,uVar4);
      if (iVar1 == 0) goto LAB_001020d8;
      iVar5 = cert_response_isra_0(param_1,1,uVar4,&local_48,0,iVar5);
      if (iVar5 < 1) goto LAB_001020e0;

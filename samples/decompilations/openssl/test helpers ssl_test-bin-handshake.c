...

{
  ...
  if (iVar1 - 0x300U < 4) {
    ...
    if ((((local_48 == 0) || (lVar2 = SSL_client_hello_get0_random(param_1,&local_48), lVar2 == 0))
        || (lVar2 = SSL_client_hello_get0_ciphers(param_1,&local_48), lVar2 == 0)) ||
       (lVar2 = SSL_client_hello_get0_compression_methods(param_1,&local_48), lVar2 == 0)) {
      *param_2 = 0x50;
    }
    else {
      ...
      if ((iVar1 != 0) && (2 < local_38)) {
        ...
        __s1 = local_40 + 2;
        if ((local_38 == uVar5 + 2) &&
           ((__s1 = local_40 + 3, uVar6 = uVar5, local_40[2] == 0 && (uVar6 = uVar5 - 1, 2 < uVar6))
           )) {
          __s1 = local_40 + 5;
          local_38 = (ulong)local_40[4] + (long)(int)((uint)local_40[3] << 8);
          if ((local_38 + 2 <= uVar6) && (uVar6 = local_38, local_38 == 7)) {
            local_40 = __s1;
    ...
    if (local_38 == uVar4 + 2) {
      ...
      if (local_40[2] == 0) {
        ...
        if (2 < uVar5) {
          __s1 = local_40 + 5;
          local_38 = (ulong)local_40[4] + (long)(int)((uint)local_40[3] << 8);
          if ((local_38 + 2 <= uVar5) && (uVar5 = local_38, local_38 == 7)) {
            local_40 = __s1;
            iVar1 = strncmp((char *)__s1,"server2",7);
            if (iVar1 == 0) {
              SSL_set_SSL_CTX(param_1,param_3);
...

{
  ...
  iVar11 = test_int_eq("test/helpers/handshake.c",0x1f7,
                       "SSL_CTX_set_max_send_fragment(server_ctx, test->max_fragment_size)",&_LC20,
                       uVar14 & 0xffffffff,1);
  ...
  if (param_2 != (SSL_CTX *)0x0) {
    ...
    iVar11 = test_int_eq("test/helpers/handshake.c",0x1fb,
                         "SSL_CTX_set_max_send_fragment(server2_ctx, test->max_fragment_size)",
                         &_LC20,uVar14 & 0xffffffff,1);
    if (iVar11 == 0) goto LAB_001018b0;
    lVar27 = (long)*(int *)(param_4 + 0xc);
  }
  uVar14 = SSL_CTX_ctrl(param_3,0x34,lVar27,(void *)0x0);
  iVar11 = test_int_eq("test/helpers/handshake.c",0x200,
                       "SSL_CTX_set_max_send_fragment(client_ctx, test->max_fragment_size)",&_LC20,
                       uVar14 & 0xffffffff,1);
  if (iVar11 == 0) goto LAB_001018b0;
  iVar11 = *param_5;
  if (iVar11 == 2) {
...
LAB_00101847:
    ...
    if (*(long *)(param_5 + 0x16) != 0) {
      ...
      iVar11 = test_true("test/helpers/handshake.c",0x26b,
...
LAB_00101b02:
        if (*(char **)(param_5 + 0x20) != (char *)0x0) {
          ...
          iVar11 = test_ptr("test/helpers/handshake.c",0x28b,
                            "server_ctx_data->session_ticket_app_data",local_e8);
          if (iVar11 == 0) goto LAB_001018b0;
...
LAB_00101bde:
          lVar27 = SSL_CTX_ctrl(param_1,0x3b,0,(void *)0x0);
          pvVar15 = (void *)CRYPTO_zalloc(lVar27,"test/helpers/handshake.c",0x2a0);
          iVar11 = test_ptr("test/helpers/handshake.c",0x2a0,
                            "ticket_keys = OPENSSL_zalloc(ticket_key_len)",pvVar15);
          if (iVar11 != 0) {
            uVar14 = SSL_CTX_ctrl(param_1,0x3b,lVar27,pvVar15);
            iVar11 = test_int_eq("test/helpers/handshake.c",0x2a1,
                                 "SSL_CTX_set_tlsext_ticket_keys(server_ctx, ticket_keys, ticket_key_len)"
                                 ,&_LC20,uVar14 & 0xffffffff,1);
            if (iVar11 != 0) {
              CRYPTO_free(pvVar15);
              iVar11 = SSL_CTX_set_default_ctlog_list_file(param_3);
              iVar11 = test_true("test/helpers/handshake.c",0x2ab,
                                 "SSL_CTX_set_default_ctlog_list_file(client_ctx)",iVar11 != 0);
              if (iVar11 == 0) goto LAB_001018b0;
              if (param_5[8] == 1) {
                iVar11 = SSL_CTX_enable_ct(param_3,0);
                iVar11 = test_true("test/helpers/handshake.c",0x2af,
...
joined_r0x00102e7d:
                ...
                iVar11 = test_true("test/helpers/handshake.c",0x2b4,
                                   "SSL_CTX_enable_ct(client_ctx, SSL_CT_VALIDATION_STRICT)",
                                   iVar11 != 0);
                goto joined_r0x00102e7d;
              }
              iVar11 = configure_handshake_ctx_for_srp
                                 (param_1,param_2,param_3,param_5,local_118,local_d8,local_158);
              if (iVar11 == 0) goto LAB_001018b0;
...
LAB_00101e40:
                    ...
                    *puVar13 = 3;
                    ...
                    if ((iVar11 != 0) &&
                       (iVar11 = test_ptr("test/helpers/handshake.c",0x5e9,"server_to_client"),
                       iVar11 != 0)) {
                      ...
                      if (*(int *)(param_4 + 0x210) == 0) {
                        ...
                        iVar11 = test_int_gt("test/helpers/handshake.c",0x5f9,
                                             "BIO_up_ref(server_to_client)",&_LC31,uVar12);
                        if (iVar11 != 0) {
                          BIO_up_ref(local_268);
                          iVar11 = test_int_gt("test/helpers/handshake.c",0x5fa,
...
LAB_00101f1d:
                        ex_data_idx = CRYPTO_get_ex_new_index
                                                (0,0,"ex data",(undefined1 *)0x0,(undefined1 *)0x0,
                                                 (undefined1 *)0x0);
                        iVar11 = test_int_ge("test/helpers/handshake.c",0x600,"ex_data_idx",&_LC31,
                                             ex_data_idx,0);
                        if (iVar11 != 0) {
                          iVar11 = SSL_set_ex_data(s,ex_data_idx,local_1f8);
                          iVar11 = test_int_eq("test/helpers/handshake.c",0x601,
                                               "SSL_set_ex_data(server.ssl, ex_data_idx, &server_ex_data)"
                                               ,&_LC20,iVar11,1);
                          if (iVar11 != 0) {
                            iVar11 = SSL_set_ex_data(ssl,ex_data_idx,local_1d8);
                            iVar11 = test_int_eq("test/helpers/handshake.c",0x602,
                            ...
                            if (iVar11 != 0) {
                              ...
                              iVar11 = 0;
LAB_00102caa:
                              do_connect_step(param_4,local_188,iVar31);
...
LAB_00102d1c:
                    ...
                    if (local_228 == 0) {
LAB_00101e08:
                      SSL_set_session(ssl,param_6);
                      iVar11 = test_true("test/helpers/handshake.c",0x5d3,
                      ...
                      iVar11 = test_true("test/helpers/handshake.c",0x5d1,
                                         "SSL_CTX_add_session(server_ctx, serv_sess_in)");
...
LAB_00102910:
                ...
                iVar11 = test_size_t_eq("test/helpers/handshake.c",0x4e9,
                                        "OPENSSL_strnlen((const char*)(in), len)",&_LC8,uVar19,
                                        uVar26);
                if (iVar11 == 0) goto LAB_00102910;
                uVar19 = CRYPTO_strndup(puVar17,uVar26,"test/helpers/handshake.c",0x4ea);
                test_ptr("test/helpers/handshake.c",0x4ea,
                         "ret = OPENSSL_strndup((const char*)(in), len)",uVar19);
              }
...
LAB_001028d0:
              ...
              *(undefined8 *)(puVar13 + 0x26) = uVar19;
              ...
              if ((param_9 != (undefined8 *)0x0) &&
                 (pSVar16 = SSL_get_session(s), pSVar16 != (SSL_SESSION *)0x0)) {
          ...
          if (iVar11 != 0) {
            ...
            iVar11 = test_ptr("test/helpers/handshake.c",0x295,
                              "server2_ctx_data->session_ticket_app_data",local_a8);
            if (iVar11 != 0) {
        ...
        iVar11 = test_true("test/helpers/handshake.c",0x27f,
        ...
        if (iVar11 != 0) {
          ...
          iVar11 = test_int_eq("test/helpers/handshake.c",0x282,
      ...
      if (iVar11 != 0) {
        ...
        iVar11 = test_true("test/helpers/handshake.c",0x273,
    ...
    iVar11 = test_true("test/helpers/handshake.c",0x251,

...
undefined8
hash_df_isra_0(size_t param_1,long param_2,uchar *param_3,char param_4,void *param_5,size_t param_6,
...

{
  ...
  if (param_7 == (void *)0x0) {
    if (param_9 == (void *)0x0) {
      while( true ) {
        ...
        if (((iVar2 == 0) || (iVar2 = EVP_DigestUpdate(ctx,&local_46,cnt), iVar2 == 0)) ||
           (iVar2 = EVP_DigestUpdate(ctx,param_5,param_6), iVar2 == 0)) break;
      ...
      while( true ) {
        ...
        if (((iVar2 == 0) || (iVar2 = EVP_DigestUpdate(ctx,&local_46,cnt), iVar2 == 0)) ||
           ((iVar2 = EVP_DigestUpdate(ctx,param_5,param_6), iVar2 == 0 ||
            (iVar2 = EVP_DigestUpdate(ctx,param_9,param_10), iVar2 == 0)))) break;
        if (param_1 < *(ulong *)(param_2 + 0x20)) goto LAB_001008a8;
        iVar2 = EVP_DigestFinal(ctx,param_3,(uint *)0x0);
        if (iVar2 == 0) break;
        param_1 = param_1 - *(long *)(param_2 + 0x20);
    ...
    while( true ) {
      ...
      if ((((iVar2 == 0) || (iVar2 = EVP_DigestUpdate(ctx,&local_46,cnt), iVar2 == 0)) ||
          (iVar2 = EVP_DigestUpdate(ctx,param_5,param_6), iVar2 == 0)) ||
         ((iVar2 = EVP_DigestUpdate(ctx,param_7,param_8), iVar2 == 0 ||
...

{
  ...
  if (((((iVar4 != 0) && (iVar4 = EVP_DigestUpdate(ctx,local_3c,1), iVar4 != 0)) &&
       (iVar4 = EVP_DigestUpdate(ctx,(void *)(lVar2 + 0x28),*(size_t *)(param_1 + 0xe0)), iVar4 != 0
       )) && ((param_3 == (void *)0x0 || (iVar4 = EVP_DigestUpdate(ctx,param_3,param_4), iVar4 != 0)
              ))) && (iVar4 = EVP_DigestFinal(ctx,(uchar *)(lVar2 + 0x106),(uint *)0x0), iVar4 != 0)
     ) {
  ...
  if (*(long *)(lVar2 + 0x18) != 0) {
    ...
    if (param_3 != 0) {
      ...
      do {
        ...
        bVar1 = *pbVar9;
        *pbVar9 = bVar1 + 1;
        if ((bVar1 + 1 >> 8 != 0) && (lVar3 = *(long *)(param_1 + 0xe0), lVar3 != 1)) {
          pbVar12 = pbVar9 + -1;
          do {
            *pbVar12 = *pbVar12 + 1;
            if (*pbVar12 != 0) break;
    ...
    if (iVar4 != 0) {
      ...
      *(uint *)(pbVar9 + -3) =
           (((uVar7 & 0xff) << 8 | uVar13 & 0xff) << 8 | uVar11 & 0xff) << 8 | uVar6 & 0xff;
      if ((uVar6 >> 8 != 0) && (lVar2 = *(long *)(param_1 + 0xe0), lVar2 != 4)) {
        pbVar12 = pbVar9 + -4;
        do {
          *pbVar12 = *pbVar12 + 1;
          if (*pbVar12 != 0) {

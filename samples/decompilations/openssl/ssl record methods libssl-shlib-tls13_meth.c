...
LAB_00100486:
        uVar5 = EVP_MAC_CTX_get_mac_size();
      }
      if (param_4 == 0) {
...
LAB_001004b1:
      ...
      puVar2 = (ulong *)(iv + __n);
      if (((ulong)((long)puVar2 - (param_1 + 0x1001)) < 7) ||
         ((ulong)((long)puVar2 - (long)pbVar1) < 7)) {
        *(byte *)puVar2 = *(byte *)((long)__src + __n) ^ *(byte *)(param_1 + 0x1000);
        iv[uVar5 - 7] = *pbVar1 ^ *(byte *)(param_1 + 0x1001);
        iv[uVar5 - 6] = *(byte *)((long)__src + (uVar5 - 6)) ^ *(byte *)(param_1 + 0x1002);
        iv[uVar5 - 5] = *(byte *)((long)__src + (uVar5 - 5)) ^ *(byte *)(param_1 + 0x1003);
        iv[uVar5 - 4] = *(byte *)((long)__src + (uVar5 - 4)) ^ *(byte *)(param_1 + 0x1004);
        iv[uVar5 - 3] = *(byte *)((long)__src + (uVar5 - 3)) ^ *(byte *)(param_1 + 0x1005);
        iv[uVar5 - 2] = *(byte *)((long)__src + (uVar5 - 2)) ^ *(byte *)(param_1 + 0x1006);
        iv[uVar5 - 1] = *(byte *)((long)__src + (uVar5 - 1)) ^ *(byte *)(param_1 + 0x1007);
      }
      else {
      ...
      if (iVar3 != 0) {
        ...
        if (iVar3 != 0) {
          ...
          if (iVar3 != 0) {
            iVar3 = WPACKET_put_bytes__(local_c8,*(long *)(param_1 + 0x10d8) +
                                                 *(long *)(param_2 + 2),2);
            if (iVar3 != 0) {
              ...
              if ((iVar3 != 0) && (local_d8 == 5)) {
                ...
                if (iVar3 != 0) {
                  if (*(long *)(param_1 + 0x1028) == 0) {
                    ...
                    iVar4 = EVP_CipherInit_ex(ctx,(EVP_CIPHER *)0x0,(ENGINE *)0x0,(uchar *)0x0,iv,
                                              param_4);
                    if (iVar4 < 1) {
LAB_00100a1d:
                      ERR_new();
                    ...
                    if (param_4 == 0) {
                      iVar4 = EVP_CIPHER_CTX_ctrl(ctx,0x11,*(int *)(param_1 + 0x10d8),
                                                  (void *)(*(long *)(param_2 + 2) +
                                                          *(long *)(param_2 + 8)));
                    ...
                    if (0 < iVar3) {
                      iVar3 = EVP_CipherUpdate(ctx,*(uchar **)(param_2 + 8),&local_dc,
                                               *(uchar **)(param_2 + 10),param_2[2]);
                      if (0 < iVar3) {
                        iVar3 = EVP_CipherFinal_ex(ctx,(uchar *)((long)local_dc +
                                                                *(long *)(param_2 + 8)),local_d0);
                        if ((0 < iVar3) &&
                           ((long)(local_d0[0] + local_dc) == *(long *)(param_2 + 2))) {
                          if (param_4 != 0) {
                            iVar3 = EVP_CIPHER_CTX_ctrl(ctx,0x10,*(int *)(param_1 + 0x10d8),
...
LAB_00100896:
                    ...
                    if (iVar3 == 0) goto LAB_00100896;
                    iVar3 = EVP_MAC_update(lVar6,*(undefined8 *)(param_2 + 10),
                    ...
                    if (iVar3 == 0) goto LAB_00100896;
                    if (param_4 == 0) {
                      iVar3 = CRYPTO_memcmp(local_88,(void *)(*(long *)(param_2 + 2) +
                                                             *(long *)(param_2 + 8)),
...
LAB_001005b9:
  ERR_set_debug("ssl/record/methods/tls13_meth.c",uVar7,"tls13_cipher");
  ossl_rlayer_fatal(param_1,0x50,0xc0103,0);
  bVar8 = false;
LAB_00100538:

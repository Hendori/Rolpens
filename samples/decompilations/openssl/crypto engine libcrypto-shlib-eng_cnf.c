              ...
              if (iVar3 == 0) {
                ...
                if (e != (ENGINE *)0x0) {
                  ...
                  if (((iVar3 == 0) ||
                     ...
                     (iVar3 = ENGINE_ctrl_cmd_string(e,"LOAD",(char *)0x0,0), pcVar7 = local_70,
                     iVar3 == 0)) goto LAB_001002c7;
                  goto LAB_001001c8;
                }
LAB_001003fb:
                e = (ENGINE *)0x0;
                    ...
                    if (local_48 == 1) {
                      ...
                      if (iVar3 != 0) {
                        if (((initialized_engines != 0) ||
                           ...
                           && (iVar3 = OPENSSL_sk_push(initialized_engines,e), pcVar7 = local_70,
                              iVar3 != 0)) goto LAB_001001c8;
                        ENGINE_finish(e);
                      }
                    }
                    else {
                      pcVar7 = local_70;
                      if (local_48 == 0) goto LAB_001001c8;
                      ERR_new();
...
LAB_001001c8:
        ...
        if ((e != (ENGINE *)0x0) && (local_48 == -1)) {
          iVar2 = ENGINE_init(e);
          if (iVar2 != 0) {
            if (((initialized_engines != 0) ||
                (initialized_engines = OPENSSL_sk_new_null(), initialized_engines != 0)) &&
               (iVar2 = OPENSSL_sk_push(initialized_engines,e), iVar2 != 0)) goto LAB_00100433;
            ENGINE_finish(e);
          }
          ERR_new();

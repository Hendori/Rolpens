...

{
  ...
  if ((param_2 != (long *)0x0) && (*param_2 != 0)) {
    ...
    if ((lVar1 != 0) && (*(int *)(lVar1 + 8) == 5)) {
      uVar2 = ossl_md5_sha1_ctrl(param_1,0x1d,*(undefined4 *)(lVar1 + 0x18),
...

{
  ...
  if (iVar17 != 0) {
    puVar18 = (undefined8 *)
              CRYPTO_malloc(0xbc,"providers/implementations/digests/md5_sha1_prov.c",0x3a);
...

{
  ...
  iVar1 = ossl_prov_is_running();
  if (((iVar1 == 0) || (iVar1 = ossl_md5_sha1_init(param_1), iVar1 == 0)) || (param_1 == 0)) {
    return false;
  }
  if (((param_2 != (long *)0x0) && (*param_2 != 0)) &&
     ((lVar2 = OSSL_PARAM_locate_const(param_2,"ssl3-ms"), lVar2 != 0 && (*(int *)(lVar2 + 8) == 5))
     )) {
    iVar1 = ossl_md5_sha1_ctrl(param_1,0x1d,*(undefined4 *)(lVar2 + 0x18),

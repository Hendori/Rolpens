  ...
  if (param_2 == 0 && param_4 == (EVP_CIPHER *)0x0) {
    ...
    if (param_4 != (EVP_CIPHER *)0x0) {
      *(undefined4 *)(param_1 + 0x11) = 0xffffffff;
      if (param_5 == (ENGINE *)0x0) {
        ...
        iVar3 = EVP_EncryptInit_ex((EVP_CIPHER_CTX *)*param_1,param_4,param_5,(uchar *)0x0,
                                   (uchar *)0x0);
      }
      if (iVar3 == 0) {
        return 0;
    ...
    if (param_2 != 0) {
      *(undefined4 *)(param_1 + 0x11) = 0xffffffff;
      ...
      if (((lVar4 != 0) &&
          (iVar3 = EVP_CIPHER_CTX_set_key_length((EVP_CIPHER_CTX *)*param_1,(int)param_3), 0 < iVar3
          )) && (iVar3 = EVP_EncryptInit_ex2(*param_1,0,param_2,zero_iv_0,param_6), iVar3 != 0)) {
      ...
      if (inl == uVar8) {
        if (0 < (int)inl) {
          if ((inl - 1 < 7) || ((ulong)((long)out - (long)(ctx + 9)) < 0x6f)) {
            ...
            uVar4 = inl;
LAB_00100995:
            *(ulong *)(out + uVar6) = *(ulong *)(ctx + uVar6 + 0x68) ^ *(ulong *)(ctx + uVar6 + 8);
            uVar9 = uVar9 + (uVar4 & 0xfffffff8);
            if ((uVar4 & 7) != 0) {
LAB_001009bb:
              out[(int)uVar9] = (byte)ctx[(long)(int)uVar9 + 0x68] ^ (byte)ctx[(long)(int)uVar9 + 8]
              ;
              iVar3 = uVar9 + 1;
              if (iVar3 < (int)uVar8) {
...
LAB_001007cc:
            *(ulong *)(out + uVar6) =
                 *(ulong *)(ctx + uVar6 + 0x68) ^ *(ulong *)(ctx + uVar6 + 0x28);
            uVar4 = uVar4 + (uVar8 & 0xfffffff8);
            if ((uVar8 & 7) != 0) {
LAB_001007f2:
              out[(int)uVar4] =
                   (byte)ctx[(long)(int)uVar4 + 0x68] ^ (byte)ctx[(long)(int)uVar4 + 0x28];
              iVar3 = uVar4 + 1;
              if (iVar3 < (int)inl) {

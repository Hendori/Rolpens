...
LAB_00100598:
              if (lVar7 == 0) goto LAB_0010059d;
              iVar1 = EVP_RAND_generate(lVar7,local_148,0x100,0,0,0,0);
LAB_0010052d:
              if (iVar1 < 1) goto LAB_0010059d;
            }
            else {
...
LAB_0010059d:
            ...
            if (pRVar8 == (RAND_METHOD *)0x0) {
LAB_001005b0:
              if (lVar7 == 0) goto LAB_001005b5;
              iVar1 = EVP_RAND_generate(lVar7,local_148,0x100,0,0,0,0);
LAB_00100565:
              if (iVar1 < 1) goto LAB_001005b5;
            }
            else {
              pRVar5 = (RAND_METHOD *)RAND_OpenSSL();
...
LAB_0010085d:
    ...
    if (uVar2 != 0) {
      ...
      uVar2 = test_true("test/drbgtest.c",0x330,"EVP_RAND_instantiate(y, 0, 0, NULL, 0, NULL)",
                        iVar1 != 0);
      uVar14 = (ulong)uVar2;
      if (uVar2 != 0) {
            ...
            if (iVar3 != 0) {
              ...
              if (iVar3 != 0) {
                ...
                if (iVar3 != 0) {
                  ...
                  iVar1 = test_int_gt("test/drbgtest.c",0x340,"reseed_counter(z)","zreseed",uVar5,
                                      iVar1);
                  if (iVar1 != 0) {
                    uVar2 = query_rand_uint_constprop_0(uVar12);
                    iVar1 = EVP_RAND_reseed(uVar12,1,0,0,0,0);
                    iVar1 = test_true("test/drbgtest.c",0x348,
                                      "EVP_RAND_reseed(z, 1, NULL, 0, NULL, 0)",iVar1 != 0);
                    if (iVar1 != 0) {
                      uVar5 = query_rand_uint_constprop_0(uVar10);
                      uVar6 = test_int_gt("test/drbgtest.c",0x349,"reseed_counter(x)","xreseed",
                                          uVar5,local_158);
                      uVar14 = (ulong)uVar6;
                            ...
                            if (iVar1 != 0) {
                              ...
                              if (iVar1 != 0) {
                                ...
                                if (iVar1 != 0) {
                                  ...
                                  if (iVar1 != 0) {
                                    uVar9 = query_rand_uint_constprop_0(uVar10);
                                    iVar1 = test_int_gt("test/drbgtest.c",0x360,"reseed_counter(x)",
                                                        "xreseed",uVar9,uVar5);
                                    if (iVar1 != 0) {
                                      uVar5 = query_rand_uint_constprop_0(lVar11);
                                      iVar1 = test_int_gt("test/drbgtest.c",0x361,
                                                          "reseed_counter(y)","yreseed",uVar5,uVar7)
                                      ;
                                      if (iVar1 != 0) {
                                        uVar5 = query_rand_uint_constprop_0(uVar12);
                                        iVar1 = test_int_gt("test/drbgtest.c",0x362,
                                                            ...
                                                            uVar8);
                                        if (iVar1 != 0) {
                                          iVar1 = test_mem_ne("test/drbgtest.c",0x363,&_LC38,&_LC37,
                                                              local_b8,0x33);
                                          if (iVar1 != 0) {
                                            inc_reseed_counter(lVar11);
                                            uVar5 = query_rand_uint_constprop_0(uVar10);
...
bool test_drbg_reseed_constprop_0
               ...
               uchar *param_5,int param_6,undefined8 param_7,undefined8 param_8,time_t param_9)
...
LAB_00101c1d:
    ...
    if (iVar1 == 0) goto LAB_00101c1d;
    iVar1 = test_ptr_eq("test/drbgtest.c",0x23e,"prov_rand(public)->parent","prov_rand(primary)",
                        *(undefined8 *)(*(long *)(lVar5 + 8) + 0x30),*(undefined8 *)(lVar4 + 8));
    if (iVar1 == 0) goto LAB_00101c1d;
    uVar2 = *(undefined8 *)(*(long *)(lVar6 + 8) + 0x30);
    iVar1 = test_ptr_eq("test/drbgtest.c",0x23f,"prov_rand(private)->parent","prov_rand(primary)",
...
LAB_001028e3:
      ...
      if ((iVar8 == 0) ||
         (iVar8 = test_int_eq("test/drbgtest.c",0x162,"status",&_LC39,local_4dc), iVar8 == 0)) {
LAB_0010226d:
        uVar22 = 0;
      }
      else {
        sVar11 = read(local_4d0,local_188,0x20);
        iVar8 = test_true("test/drbgtest.c",0x163,
                          "read(fd[0], &random[0], sizeof(random)) == sizeof(random)",sVar11 == 0x20
                         );
    ...
    iVar8 = test_true("test/drbgtest.c",0x1a8,
                      "test_drbg_reseed_in_child(primary, public, private, presult)",uVar22);
  ...
  iVar8 = test_true("test/drbgtest.c",0x1b2,
...
LAB_001023dc:
    ...
    do {
      while( true ) {
        ...
        test_note("    random: %s, pid: %d (%s, %s)",ptr,*(undefined4 *)((long)__base + 0x14),
                  (long)__base + 0x1c,"private");
        __base = __base + 5;
        CRYPTO_free(ptr);
        if (__base == &local_1a8) goto LAB_001023de;
      }
      test_note("    random: %s, pid: %d (%s, %s)",ptr,*(undefined4 *)((long)__base + 0x14),
                (long)__base + 0x1c,"public");
      __base = __base + 5;
      CRYPTO_free(ptr);

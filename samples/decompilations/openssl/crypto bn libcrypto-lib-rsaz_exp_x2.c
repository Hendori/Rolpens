...
LAB_00100121:
    ...
    *(char *)puVar1 = (char)uVar2;
    if ((((param_2 != 1) && (*(char *)((long)puVar1 + 1) = (char)(uVar2 >> 8), param_2 != 2)) &&
        (*(char *)((long)puVar1 + 2) = (char)(uVar2 >> 0x10), param_2 != 3)) &&
       (((*(char *)((long)puVar1 + 3) = (char)(uVar2 >> 0x18), param_2 != 4 &&
         (*(char *)((long)puVar1 + 4) = (char)(uVar2 >> 0x20), param_2 != 5)) &&
        (*(char *)((long)puVar1 + 5) = (char)(uVar2 >> 0x28), param_2 != 6)))) {
      *(char *)((long)puVar1 + 6) = (char)(uVar2 >> 0x30);
      return;
    }
  }
  else {
    puVar1 = (ulong *)memset(param_1,0,(ulong)uVar4 << 3);
    if (param_2 < 0x68) {
      if (param_2 < 0x35) {
        param_2 = param_2 + 7;
        uVar2 = *param_3;
    ...
    uVar2 = *param_3;
    iVar6 = param_2 + -0x2d >> 3;
    *(int *)puVar1 = (int)*param_3;
    *(char *)((long)puVar1 + 4) = (char)(uVar2 >> 0x20);
    *(char *)((long)puVar1 + 6) = (char)(uVar2 >> 0x30);
    *(char *)((long)puVar1 + 5) = (char)(uVar2 >> 0x28);
    uVar2 = param_3[1] << 4;
    uVar3 = uVar2 | *param_3 >> 0x30;
    *(char *)((long)puVar1 + 6) = (char)uVar3;
    if (((iVar6 != 1) && (*(char *)((long)puVar1 + 7) = (char)(uVar3 >> 8), iVar6 != 2)) &&
       ((*(char *)(puVar1 + 1) = (char)(uVar2 >> 0x10), iVar6 != 3 &&
        (((*(char *)((long)puVar1 + 9) = (char)(uVar2 >> 0x18), iVar6 != 4 &&
          (*(char *)((long)puVar1 + 10) = (char)(uVar2 >> 0x20), iVar6 != 5)) &&
         (*(char *)((long)puVar1 + 0xb) = (char)(uVar2 >> 0x28), iVar6 != 6)))))) {
      *(char *)((long)puVar1 + 0xc) = (char)(uVar2 >> 0x30);
    }
  }
  return;
}
...

{
  ...
  if (param_4 < 0x35) {
        ...
        if (iVar3 + -2 != 0) {
          ...
          if (iVar3 + -3 != 0) {
            ...
            if (iVar3 + -4 != 0) {
              ...
              if ((iVar3 + -5 != 0) &&
                 (uVar2 = uVar2 * 0x100 + (ulong)*(byte *)((long)param_3 + (long)(iVar3 + -5) + -1),
                 iVar3 != 6)) {
    ...
    *param_1 = (ulong)(byte)*param_3 +
               ((ulong)*(byte *)((long)param_3 + 1) +
               ((ulong)*(byte *)((long)param_3 + 2) +
               ((ulong)*(byte *)((long)param_3 + 3) +
               ((ulong)*(byte *)((long)param_3 + 4) + (ulong)*(ushort *)((long)param_3 + 5) * 0x100)
               * 0x100) * 0x100) * 0x100) * 0x100 & 0xfffffffffffff;
    bVar1 = *(byte *)((long)param_3 + (long)(iVar3 + 5));
    uVar2 = (ulong)bVar1;
    if ((((iVar3 != 1) &&
         (uVar2 = (ulong)CONCAT11(bVar1,*(byte *)((long)param_3 + (long)(iVar3 + 4))), iVar3 != 2))
        && (uVar2 = uVar2 * 0x100 + (ulong)*(byte *)((long)param_3 + (long)(iVar3 + 3)), iVar3 != 3)
        ) && (((uVar2 = uVar2 * 0x100 + (ulong)*(byte *)((long)param_3 + (long)(iVar3 + 2)),
               iVar3 != 4 &&
               (uVar2 = uVar2 * 0x100 + (ulong)*(byte *)((long)param_3 + (long)(iVar3 + 1)),
               iVar3 != 5)) &&
              (uVar2 = uVar2 * 0x100 + (ulong)*(byte *)((long)param_3 + (long)iVar3), iVar3 != 6))))
    {
    ...
    if (rp != (ulong *)0x0) {
      ...
      *puVar4 = 0;
      ...
      if (param_13 == 0x600) {
        ...
        local_a0 = 0x45d0;
LAB_00100787:
        lVar11 = (long)(int)((iVar8 + -3) - (uint)(iVar10 == 0));
        ...
        *(undefined8 *)((long)puVar21 + local_70) = 0;
        ...
        uVar27 = iVar10 - 5;
        (*pcVar6)(lVar11,lVar20,(ulong)puVar21[iVar10 >> 6] >> ((byte)iVar10 & 0x3f),
                  (ulong)puVar21[(iVar10 >> 6) + local_110] >> ((byte)iVar10 & 0x3f));
        do {
          while( true ) {
            iVar10 = (int)uVar27 >> 6;
            ...
            (*pcVar6)(puVar4,lVar20,
                      ((uint)(puVar21[(long)iVar10 + 1] << (bVar9 & 0x3f)) ^ uVar14) & 0x1f,
                      ((uint)(puVar21[iVar10 + 1 + local_110] << (bVar9 & 0x3f)) ^ uVar7) & 0x1f);

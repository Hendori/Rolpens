...

{
  ...
  uVar3 = new_pkcs12_builder("multi_contents.p12");
  iVar2 = sec_nid_1;
  if (sec_nid_1 == -1) {
    iVar1 = OBJ_create("1.3.5.7.9","CustomSecretOID","My custom secret OID");
    iVar1 = test_true("test/pkcs12_format_test.c",0x144,
                      "OBJ_create(\"1.3.5.7.9\", \"CustomSecretOID\", \"My custom secret OID\")",
                      iVar1 != 0);
    if (iVar1 != 0) {
      iVar2 = OBJ_txt2nid("CustomSecretOID");
      sec_nid_1 = iVar2;
    }
  }
  start_pkcs12(uVar3);
  start_contentinfo(uVar3);
  add_certbag(uVar3,CERT1,0x1f1,ATTRS1);
  add_certbag(uVar3,CERT2,0x1f1,ATTRS2);
  add_keybag(uVar3,KEY1,0x261,ATTRS1,enc_default);
  add_keybag(uVar3,KEY2,0x260,ATTRS2,enc_default);
  end_contentinfo(uVar3);
  start_contentinfo(uVar3);
  add_secretbag(uVar3,iVar2,"VeryVerySecretMessage",ATTRS1);
  end_contentinfo_encrypted(uVar3,enc_default);
  end_pkcs12_with_mac(uVar3,mac_default);
  start_check_pkcs12_with_mac(uVar3,mac_default);
  start_check_contentinfo(uVar3);
  check_certbag(uVar3,CERT1,0x1f1,ATTRS1);
  check_certbag(uVar3,CERT2,0x1f1,ATTRS2);
  check_keybag(uVar3,KEY1,0x261,ATTRS1,enc_default);
  check_keybag(uVar3,KEY2,0x260,ATTRS2,enc_default);
  end_check_contentinfo(uVar3);
  start_check_contentinfo_encrypted(uVar3,enc_default);
  check_secretbag(uVar3,iVar2,"VeryVerySecretMessage",ATTRS1);
  end_check_contentinfo(uVar3);
  end_check_pkcs12(uVar3);
  end_pkcs12_builder(uVar3);
  return;
...

{
  ...
  if (sec_nid_1 == -1) {
    ...
    iVar2 = test_true("test/pkcs12_format_test.c",0x144,
                      ...
                      iVar2 != 0);
    if (iVar2 != 0) {
      iVar3 = OBJ_txt2nid("CustomSecretOID");
      sec_nid_1 = iVar3;
    }
  }
  start_pkcs12(uVar1);
  start_contentinfo(uVar1);
  add_secretbag(uVar1,iVar3,"VerySecretMessage",ATTRS1);
  end_contentinfo_encrypted(uVar1,enc_default);
  end_pkcs12_with_mac(uVar1,mac_default);
  start_check_pkcs12_with_mac(uVar1,mac_default);
  start_check_contentinfo_encrypted(uVar1,enc_default);
  check_secretbag(uVar1,iVar3,"VerySecretMessage",ATTRS1);
  end_check_contentinfo(uVar1);
  end_check_pkcs12(uVar1);
  end_pkcs12_builder(uVar1);
  return;
...

{
  ...
  local_b0 = "Password1";
  local_a8 = 1000;
  pcVar3 = OBJ_nid2sn(local_b8[0]);
  BIO_snprintf(local_98,0x50,"1secret_ciph-%s_iter-%d.p12",pcVar3,1000);
  uVar4 = new_pkcs12_builder(local_98);
  iVar2 = sec_nid_1;
  if (sec_nid_1 == -1) {
    iVar1 = OBJ_create("1.3.5.7.9","CustomSecretOID","My custom secret OID");
    iVar1 = test_true("test/pkcs12_format_test.c",0x144,
  ...
  start_pkcs12(uVar4);
  start_contentinfo(uVar4);
  add_secretbag(uVar4,iVar2,"VerySecretMessage",ATTRS1);
  end_contentinfo_encrypted(uVar4,local_b8);
  end_pkcs12_with_mac(uVar4,mac_default);
  start_check_pkcs12_with_mac(uVar4,mac_default);
  start_check_contentinfo_encrypted(uVar4,local_b8);
  check_secretbag(uVar4,iVar2,"VerySecretMessage",ATTRS1);
  end_check_contentinfo(uVar4);
  end_check_pkcs12(uVar4);
  end_pkcs12_builder(uVar4);
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
                    /* WARNING: Subroutine does not return */

...

{
  ...
  iVar2 = (**(code **)(*(long *)(*(long *)(param_1 + 0x18) + 0xd8) + 0x10))
...

{
  ...
  if (((((*(byte *)(lVar1 + 0x50) & 8) == 0) && (iVar2 = **(int **)(param_1 + 0x18), 0x303 < iVar2))
      && (iVar2 != 0x10000)) ||
     ((*(int *)(param_1 + 0xf0) - 1U < 4 || (*(int *)(param_1 + 0x8d0) == 1)))) {
...

{
  ...
  if ((param_1 != (SSL *)0x0) &&
     ((pSVar7 = param_1, param_1->version == 0 ||
      (((param_1->version & 0x80U) != 0 &&
       (pSVar7 = (SSL *)ossl_quic_obj_get0_handshake_layer(), pSVar7 != (SSL *)0x0)))))) {
    if (pSVar7[4].mode == 0) {
LAB_001002d0:
    ...
    if ((((iVar5 == 0xd) && (*(int *)&pSVar7[4].expand == 0)) &&
        (iVar5 = SSL_version(param_1), iVar5 >> 8 == 3)) &&
       ((iVar5 = SSL_version(param_1), 0x301 < iVar5 && (*(int *)&pSVar7[3].cipher_list_by_id == 0))
       )) {
      local_44 = 0x301;
    }
    ...
    if (iVar5 == 0) {
      ...
      if (iVar5 < 1) {
        ...
        *(undefined4 *)((long)&pSVar7->max_cert_list + 4) = 0;
        if (pcVar4 != (code *)0x0) {
          (*pcVar4)(1,pSVar7->state,0x15,&pSVar7->first_packet,2,param_1,
                    pSVar7[1].tlsext_session_ticket);
        }
        p_Var8 = (_func_3059 *)pSVar7[3].info_callback;
        if ((p_Var8 != (_func_3059 *)0x0) ||
           (p_Var8 = param_1->method[1].ssl_peek, p_Var8 != (_func_3059 *)0x0)) {

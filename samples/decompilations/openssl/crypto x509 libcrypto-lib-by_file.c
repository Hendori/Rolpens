...
bool by_file_ctrl(undefined8 param_1,int param_2,undefined8 param_3,long param_4)

{
  ...
  if (param_4 != 3) {
    ...
    iVar1 = X509_load_cert_crl_file_ex(param_1,param_3,1,0,0);
    return iVar1 != 0;
  }
  pcVar2 = X509_get_default_cert_file_env();
  pcVar2 = (char *)ossl_safe_getenv(pcVar2);
  ...
  iVar1 = X509_load_cert_crl_file_ex(param_1,pcVar2,1,0,0);
  if (iVar1 != 0) {
    return true;
  }
  ERR_new();

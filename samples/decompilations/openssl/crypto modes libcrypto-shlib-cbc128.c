...

{
  ...
  if (((ulong)((long)puVar5 - ((long)param_1 + 1)) < 7) ||
     ((ulong)((long)puVar5 - ((long)puVar2 + 1)) < 7)) {
    *(byte *)puVar5 = (byte)*param_1 ^ (byte)*puVar2;
    *(byte *)((long)puVar5 + 1) = *(byte *)((long)puVar2 + 1) ^ *(byte *)((long)param_1 + 1);
LAB_001003b4:
    *(byte *)((long)puVar5 + 2) = *(byte *)((long)param_1 + 2) ^ *(byte *)((long)puVar2 + 2);
    if (param_3 < 4) {
      param_3 = 3;
      uVar6 = 0xc;
    }
      ...
      *(byte *)((long)puVar5 + 3) = *(byte *)((long)param_1 + 3) ^ *(byte *)((long)puVar2 + 3);
      if (param_3 != 4) {
        ...
        *(byte *)((long)puVar5 + 5) = *(byte *)((long)param_1 + 5) ^ *(byte *)((long)puVar2 + 5);
        if (param_3 == 6) {
          uVar6 = 9;
          goto LAB_001001f0;
        }
        *(byte *)((long)puVar5 + 6) = *(byte *)((long)param_1 + 6) ^ *(byte *)((long)puVar2 + 6);
        if (param_3 == 7) {
          uVar6 = 8;
          goto LAB_001001f0;
        }
        *(byte *)((long)puVar5 + 7) = *(byte *)((long)param_1 + 7) ^ *(byte *)((long)puVar2 + 7);
        ...
        *(byte *)((long)puVar5 + 9) = *(byte *)((long)param_1 + 9) ^ *(byte *)((long)puVar2 + 9);
        if (param_3 == 10) {
          uVar6 = 5;
          goto LAB_001001f0;
        }
        *(byte *)((long)puVar5 + 10) = *(byte *)((long)param_1 + 10) ^ *(byte *)((long)puVar2 + 10);
        if (param_3 == 0xb) {
          uVar6 = 4;
          goto LAB_001001f0;
        }
        *(byte *)((long)puVar5 + 0xb) =
             *(byte *)((long)param_1 + 0xb) ^ *(byte *)((long)puVar2 + 0xb);
        if (param_3 == 0xc) {
          uVar6 = 3;
          goto LAB_001001f0;
        }
        *(byte *)((long)puVar5 + 0xc) =
             *(byte *)((long)param_1 + 0xc) ^ *(byte *)((long)puVar2 + 0xc);
        if ((param_3 != 0xd) &&
           (*(byte *)((long)puVar5 + 0xd) =
                 *(byte *)((long)param_1 + 0xd) ^ *(byte *)((long)puVar2 + 0xd), param_3 == 0xf)) {
          *(byte *)((long)puVar5 + 0xe) =
               *(byte *)((long)param_1 + 0xe) ^ *(byte *)((long)puVar2 + 0xe);
        }
        goto LAB_00100188;
      }
      uVar6 = 0xb;
...
LAB_001001f0:
    if ((long)((long)puVar5 + param_3) - ((long)puVar2 + param_3 + 1) < 7) {
      ...
      *(undefined1 *)((long)puVar5 + param_3 + 1) = *(undefined1 *)((long)puVar2 + param_3 + 1);
      lVar3 = param_3 + 2;
LAB_0010021f:
      *(undefined1 *)((long)puVar5 + lVar3) = *(undefined1 *)((long)puVar2 + lVar3);
      if (((((param_3 != 0xd) &&
            (*(undefined1 *)((long)puVar5 + param_3 + 3) =
                  *(undefined1 *)((long)puVar2 + param_3 + 3), param_3 != 0xc)) &&
           (*(undefined1 *)((long)puVar5 + param_3 + 4) =
                 *(undefined1 *)((long)puVar2 + param_3 + 4), param_3 != 0xb)) &&
          ((((*(undefined1 *)((long)puVar5 + param_3 + 5) =
                   *(undefined1 *)((long)puVar2 + param_3 + 5), param_3 != 10 &&
             (*(undefined1 *)((long)puVar5 + param_3 + 6) =
                   *(undefined1 *)((long)puVar2 + param_3 + 6), param_3 != 9)) &&
            ((*(undefined1 *)((long)puVar5 + param_3 + 7) =
                   *(undefined1 *)((long)puVar2 + param_3 + 7), param_3 != 8 &&
             ((*(undefined1 *)((long)puVar5 + param_3 + 8) =
                    *(undefined1 *)((long)puVar2 + param_3 + 8), param_3 != 7 &&
              (*(undefined1 *)((long)puVar5 + param_3 + 9) =
                    *(undefined1 *)((long)puVar2 + param_3 + 9), param_3 != 6)))))) &&
           (*(undefined1 *)((long)puVar5 + param_3 + 10) =
                 *(undefined1 *)((long)puVar2 + param_3 + 10), param_3 != 5)))) &&
         (((*(undefined1 *)((long)puVar5 + param_3 + 0xb) =
                 *(undefined1 *)((long)puVar2 + param_3 + 0xb), param_3 != 4 &&
           (*(undefined1 *)((long)puVar5 + param_3 + 0xc) =
                 *(undefined1 *)((long)puVar2 + param_3 + 0xc), param_3 != 3)) &&
          (*(undefined1 *)((long)puVar5 + param_3 + 0xd) =
                *(undefined1 *)((long)puVar2 + param_3 + 0xd), param_3 == 1)))) {
        *(undefined1 *)((long)puVar5 + 0xf) = *(undefined1 *)((long)puVar2 + 0xf);
      }
    }
    else {
      uVar7 = 0x10 - param_3;
      if (uVar6 < 7) {
LAB_0010034e:
        *(undefined4 *)((long)puVar5 + param_3) = *(undefined4 *)((long)puVar2 + param_3);
...
LAB_00100518:
      ...
      lVar3 = 8;
      uVar6 = param_3 - 8;
      if (2 < param_3 - 9) goto LAB_00100121;
LAB_00100140:
      *(byte *)((long)puVar5 + lVar3) =
           *(byte *)((long)param_1 + lVar3) ^ *(byte *)((long)puVar2 + lVar3);
      if ((lVar3 + 1U < param_3) &&
         (*(byte *)((long)puVar5 + lVar3 + 1) =
               *(byte *)((long)param_1 + lVar3 + 1) ^ *(byte *)((long)puVar2 + lVar3 + 1),
         lVar3 + 2U < param_3)) {
        *(byte *)((long)puVar5 + lVar3 + 2) =
             *(byte *)((long)param_1 + lVar3 + 2) ^ *(byte *)((long)puVar2 + lVar3 + 2);
      }
    }
    uVar6 = 0xf - param_3;
    if (2 < uVar6) goto LAB_001001f0;
LAB_00100188:
    *(undefined1 *)((long)puVar5 + param_3) = *(undefined1 *)((long)puVar2 + param_3);
    if ((param_3 != 0xf) &&
       (*(undefined1 *)((long)puVar5 + param_3 + 1) = *(undefined1 *)((long)puVar2 + param_3 + 1),
...
LAB_00100695:
  ...
  *(char *)param_5 = (char)uVar6;
  if (param_3 == 1) {
LAB_00100888:
    if (6 < (long)((long)param_5 + param_3) - ((long)puVar5 + param_3 + 1)) {
      lVar3 = 0x10 - param_3;
      if (0xf - param_3 < 7) {
LAB_00100a99:
        uVar6 = param_3 + 4;
      ...
      *(undefined1 *)((long)param_5 + uVar6) = *(undefined1 *)((long)puVar5 + uVar6);
      if ((uVar6 != 0xf) &&
         (*(undefined1 *)((long)param_5 + uVar6 + 1) = *(undefined1 *)((long)puVar5 + uVar6 + 1),
         uVar6 != 0xe)) {
    ...
    *(undefined1 *)((long)param_5 + param_3) = *(undefined1 *)((long)puVar5 + param_3);
    if ((param_3 == 0xf) ||
       (*(undefined1 *)((long)param_5 + param_3 + 1) = *(undefined1 *)((long)puVar5 + param_3 + 1),
       param_3 == 0xe)) goto LAB_00100860;
    param_3 = 0xd;
    lVar3 = 0xf;
  }
  *(undefined1 *)((long)param_5 + lVar3) = *(undefined1 *)((long)puVar5 + lVar3);
  if (((((param_3 != 0xd) &&
        (*(undefined1 *)((long)param_5 + param_3 + 3) = *(undefined1 *)((long)puVar5 + param_3 + 3),
        param_3 != 0xc)) &&
       (*(undefined1 *)((long)param_5 + param_3 + 4) = *(undefined1 *)((long)puVar5 + param_3 + 4),
       param_3 != 0xb)) &&
      ((((*(undefined1 *)((long)param_5 + param_3 + 5) = *(undefined1 *)((long)puVar5 + param_3 + 5)
         , param_3 != 10 &&
         (*(undefined1 *)((long)param_5 + param_3 + 6) = *(undefined1 *)((long)puVar5 + param_3 + 6)
         , param_3 != 9)) &&
        ((*(undefined1 *)((long)param_5 + param_3 + 7) = *(undefined1 *)((long)puVar5 + param_3 + 7)
         , param_3 != 8 &&
         ((*(undefined1 *)((long)param_5 + param_3 + 8) =
                *(undefined1 *)((long)puVar5 + param_3 + 8), param_3 != 7 &&
          (*(undefined1 *)((long)param_5 + param_3 + 9) =
                *(undefined1 *)((long)puVar5 + param_3 + 9), param_3 != 6)))))) &&
       (*(undefined1 *)((long)param_5 + param_3 + 10) = *(undefined1 *)((long)puVar5 + param_3 + 10)
       , param_3 != 5)))) &&
     (((*(undefined1 *)((long)param_5 + param_3 + 0xb) =
             *(undefined1 *)((long)puVar5 + param_3 + 0xb), param_3 != 4 &&
       (*(undefined1 *)((long)param_5 + param_3 + 0xc) =
             *(undefined1 *)((long)puVar5 + param_3 + 0xc), param_3 != 3)) &&
      (*(undefined1 *)((long)param_5 + param_3 + 0xd) =
            *(undefined1 *)((long)puVar5 + param_3 + 0xd), param_3 == 1)))) {
    *(undefined1 *)((long)param_5 + 0xf) = *(undefined1 *)((long)puVar5 + 0xf);
  }
LAB_00100860:

...

{
  ...
  if (param_2 != (byte *)0x0) {
    *puVar1 = (uint)param_2[1] << 8 | (uint)param_2[2] << 0x10 | (uint)*param_2 |
              (uint)param_2[3] << 0x18;
    puVar1[1] = (uint)param_2[5] << 8 | (uint)param_2[6] << 0x10 | (uint)param_2[4] |
                (uint)param_2[7] << 0x18;
    puVar1[2] = (uint)param_2[9] << 8 | (uint)param_2[10] << 0x10 | (uint)param_2[8] |
                (uint)param_2[0xb] << 0x18;
    puVar1[3] = (uint)param_2[0xd] << 8 | (uint)param_2[0xe] << 0x10 | (uint)param_2[0xc] |
                (uint)param_2[0xf] << 0x18;
    puVar1[4] = (uint)param_2[0x11] << 8 | (uint)param_2[0x12] << 0x10 | (uint)param_2[0x10] |
                (uint)param_2[0x13] << 0x18;
    puVar1[5] = (uint)param_2[0x15] << 8 | (uint)param_2[0x16] << 0x10 | (uint)param_2[0x14] |
                (uint)param_2[0x17] << 0x18;
    puVar1[6] = (uint)param_2[0x19] << 8 | (uint)param_2[0x1a] << 0x10 | (uint)param_2[0x18] |
                (uint)param_2[0x1b] << 0x18;
    puVar1[7] = (uint)param_2[0x1f] << 0x18 |
                (uint)param_2[0x1d] << 8 | (uint)param_2[0x1e] << 0x10 | (uint)param_2[0x1c];
  }
  if (param_3 != (byte *)0x0) {
    puVar1[8] = (uint)param_3[1] << 8 | (uint)param_3[2] << 0x10 | (uint)*param_3 |
                (uint)param_3[3] << 0x18;
    puVar1[9] = (uint)param_3[6] << 0x10 | (uint)param_3[5] << 8 | (uint)param_3[4] |
                (uint)param_3[7] << 0x18;
    puVar1[10] = (uint)param_3[10] << 0x10 | (uint)param_3[9] << 8 | (uint)param_3[8] |
                 (uint)param_3[0xb] << 0x18;
    puVar1[0xb] = (uint)param_3[0xd] << 8 | (uint)param_3[0xe] << 0x10 | (uint)param_3[0xc] |
...
LAB_001002a8:
      ChaCha20_ctr32(param_2,param_3,uVar3 * 0x40,lVar1,lVar1 + 0x20);
...
LAB_001002e5:
  ...
  *(undefined1 (*) [16])(lVar1 + 0x30) = (undefined1  [16])0x0;
  *(undefined1 (*) [16])(lVar1 + 0x40) = (undefined1  [16])0x0;
  *(undefined1 (*) [16])(lVar1 + 0x50) = (undefined1  [16])0x0;
  *(undefined1 (*) [16])(lVar1 + 0x60) = (undefined1  [16])0x0;
  ChaCha20_ctr32(lVar1 + 0x30,lVar1 + 0x30,0x40,lVar1,lVar1 + 0x20);
  if (((uVar2 - 1 < 7) || ((ulong)((long)param_2 - (long)((long)param_3 + 1)) < 0xf)) ||
     ((ulong)((long)param_2 - (lVar1 + 0x31)) < 0xf)) {
    uVar10 = 0;
    do {
      *(byte *)((long)param_2 + uVar10) =
           *(byte *)(lVar1 + 0x30 + uVar10) ^ *(byte *)((long)param_3 + uVar10);
      uVar10 = uVar10 + 1;
    } while (uVar2 != uVar10);
    *(uint *)(lVar1 + 0x70) = uVar2;
    return 1;
...
LAB_0010044e:
    uVar10 = (ulong)uVar5;
    *(ulong *)((long)param_2 + uVar10) =
         *(ulong *)((long)param_3 + uVar10) ^ *(ulong *)(lVar1 + 0x30 + uVar10);
  ...
  uVar10 = (ulong)uVar5;
  *(byte *)((long)param_2 + uVar10) =
       *(byte *)((long)param_3 + uVar10) ^ *(byte *)(lVar1 + 0x30 + uVar10);
...
LAB_00100ea0:
    ...
    *(undefined4 *)(lVar1 + 0xbc) = 0;
    if (bVar4) {
      ...
      iVar5 = EVP_CIPHER_CTX_is_encrypting(param_1);
      if ((iVar5 == 0) &&
         (iVar5 = CRYPTO_memcmp(local_58,(undefined1 *)(lVar1 + 0x84),(long)*(int *)(lVar1 + 0xc0)),
         iVar5 != 0)) {
LAB_00100f7b:
        param_4 = 0xffffffff;
        goto LAB_00100e3d;
...
LAB_00100e3b:
    ...
    if (param_2 != (undefined8 *)0x0) {
      ...
      *(undefined8 *)(lVar1 + 200) = 0xffffffffffffffff;
      uVar8 = param_4;
      if ((uVar6 != 0xffffffffffffffff) && (uVar8 = uVar6, uVar6 + 0x10 != param_4))
      goto LAB_00100f7b;
      iVar5 = EVP_CIPHER_CTX_is_encrypting(param_1);
      if (iVar5 == 0) {
...

{
  ...
  if (param_2 != (byte *)0x0 || param_3 != 0) {
    ...
    *(undefined1 (*) [16])(puVar1 + 0x2a) = (undefined1  [16])0x0;
    if (param_3 == 0) {
      if (param_2 != (byte *)0x0) {
        *puVar1 = (uint)param_2[2] << 0x10 | (uint)param_2[1] << 8 | (uint)*param_2 |
                  (uint)param_2[3] << 0x18;
        puVar1[1] = (uint)param_2[5] << 8 | (uint)param_2[6] << 0x10 | (uint)param_2[4] |
                    (uint)param_2[7] << 0x18;
        puVar1[2] = (uint)param_2[9] << 8 | (uint)param_2[10] << 0x10 | (uint)param_2[8] |
        ...
        puVar1[6] = (uint)param_2[0x19] << 8 | (uint)param_2[0x1a] << 0x10 | (uint)param_2[0x18] |
                    (uint)param_2[0x1b] << 0x18;
        puVar1[7] = (uint)param_2[0x1d] << 8 | (uint)param_2[0x1e] << 0x10 | (uint)param_2[0x1c] |

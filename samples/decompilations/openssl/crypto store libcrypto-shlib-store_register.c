...
void lh_OSSL_STORE_LOADER_cfn_thunk
...
void lh_OSSL_STORE_LOADER_doall_arg_thunk
               (undefined8 param_1,undefined8 param_2,code *UNRECOVERED_JUMPTABLE)
...
void lh_OSSL_STORE_LOADER_doall_void_thunk
               (undefined8 param_1,undefined8 param_2,code *UNRECOVERED_JUMPTABLE)
  ...
  if (loader_register == 0) {
    ...
    loader_register =
         OPENSSL_LH_set_thunks
                   (uVar4,0x100000,lh_OSSL_STORE_LOADER_cfn_thunk,lh_OSSL_STORE_LOADER_doall_thunk,
  ...
  if ((iVar1 == 0) || (do_registry_init_ossl_ret_ == 0)) {
    ...
    if (iVar1 != 0) {
      if (loader_register == 0) {
        ...
        loader_register =
             OPENSSL_LH_set_thunks
                       (uVar3,0x100000,lh_OSSL_STORE_LOADER_cfn_thunk,
                        lh_OSSL_STORE_LOADER_doall_thunk,lh_OSSL_STORE_LOADER_doall_arg_thunk);
...
LAB_001004e3:
        lVar2 = OPENSSL_LH_retrieve(loader_register,local_f8);
        if (lVar2 == 0) {
          ERR_new();
...

{
  ...
  if (loader_register == 0) {
    ...
    loader_register =
         OPENSSL_LH_set_thunks
                   (uVar1,0x100000,lh_OSSL_STORE_LOADER_cfn_thunk,lh_OSSL_STORE_LOADER_doall_thunk,
                    lh_OSSL_STORE_LOADER_doall_arg_thunk);
    if (loader_register == 0) {
      return 1;
    }

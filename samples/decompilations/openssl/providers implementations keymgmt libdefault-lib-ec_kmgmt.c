...

{
  ...
  if (((param_1 != (EC_KEY *)0x0) && (iVar1 != 0)) && ((param_2 & 4) != 0)) {
    ...
    if ((group != (EC_GROUP *)0x0) && (iVar2 = EC_GROUP_get_curve_name(group), iVar2 != 0x494)) {
      if ((param_2 & 3) == 0) {
        if ((param_2 & 0x80) == 0) {
          return iVar1 != 0;
        }
  ...
  if (((param_1[2] == 0) ||
    ...
    if (param_1[1] == 0) {
      if ((((((((param_1[5] == 0) ||
            ...
            ((param_1[9] == 0 ||
             ((iVar1 = OSSL_PARAM_BLD_push_BN(lVar2,&_LC8), iVar1 == 0 ||
              (iVar1 = OSSL_PARAM_BLD_push_BN(lVar2,&_LC9,param_1[7]), iVar1 == 0)))))) ||
           (iVar1 = OSSL_PARAM_BLD_push_BN(lVar2,&_LC10,param_1[8]), iVar1 == 0)) ||
          (((iVar1 = OSSL_PARAM_BLD_push_BN(lVar2,"order",param_1[9]), iVar1 == 0 ||
           ...
           || ((param_1[0xc] != 0 &&
               (iVar1 = OSSL_PARAM_BLD_push_octet_string(lVar2,&_LC13,param_1[0xc],param_1[0xe]),
               iVar1 == 0)))))) || (param_1[0xb] == 0)) goto LAB_001006ea;
...

{
  ...
  if (pEVar5 == (EC_GROUP *)0x0) {
    ...
    if (ctx != (BN_CTX *)0x0) {
      ...
      if (lVar8 == 0) {
LAB_001010e3:
        lVar8 = OSSL_PARAM_locate(param_2,&_LC22);
        if (lVar8 != 0) {
        ...
        if (lVar8 != 0) {
          ...
          iVar18 = 0x100;
          if ((((iVar1 < 0x200) && (iVar18 = 0xc0, iVar1 < 0x180)) && (iVar18 = 0x80, iVar1 < 0x100)
              ) && ((iVar18 = 0x70, iVar1 < 0xe0 && (iVar18 = 0x50, iVar1 < 0xa0)))) {
            iVar18 = iVar1 / 2;
          }
        ...
        if ((lVar8 != 0) &&
           ((iVar1 = EC_KEY_decoded_from_explicit_params(param_1), iVar1 < 0 ||
            (iVar1 = OSSL_PARAM_set_int(lVar8,iVar1), iVar1 == 0)))) goto LAB_001014ff;
        if (param_3 == 0) {
          lVar8 = OSSL_PARAM_locate(param_2,"default-digest");
          if ((lVar8 != 0) && (iVar1 = OSSL_PARAM_set_utf8_string(lVar8,"SHA256"), iVar1 == 0))
          goto LAB_001014ff;
...
joined_r0x001014f9:
        ...
        if (lVar8 != 0) {
          ...
          if (pEVar9 == (EC_POINT *)0x0) {
            ...
            sVar10 = EC_POINT_point2oct(pEVar5,pEVar9,POINT_CONVERSION_UNCOMPRESSED,
                                        *(uchar **)(lVar8 + 0x10),*(size_t *)(lVar8 + 0x18),ctx);
...
LAB_00101290:
        ...
        if (iVar1 == 0x197) {
          ...
          if ((iVar18 != 0) &&
             (iVar18 = ossl_param_build_set_utf8_string(0,param_2,"basis-type",local_88),
             iVar18 != 0)) {
            if (iVar1 == 0x2aa) {
              ...
              if (((iVar1 != 0) &&
                  (iVar1 = ossl_param_build_set_int(0,param_2,&_LC31,local_5c), iVar1 != 0)) &&
                 (iVar1 = ossl_param_build_set_int(0,param_2,&_LC32,local_58), iVar1 != 0)) {
                puVar17 = &_LC33;
                uVar2 = local_54;
LAB_00101623:
                iVar1 = ossl_param_build_set_int(0,param_2,puVar17,uVar2);
...
LAB_001012bb:
        iVar1 = ossl_ec_group_todata(pEVar5,0,param_2,uVar6,uVar7,ctx,&local_48);
        if (((iVar1 == 0) || (param_1 == (EC_KEY *)0x0)) ||
           (pEVar5 = EC_KEY_get0_group(param_1), pEVar5 == (EC_GROUP *)0x0)) goto LAB_001014ff;
        ...
        if (pEVar12 != (EC_POINT *)0x0) {
          ...
          if (lVar8 != 0) {
            ...
            if ((lVar15 != 0) &&
               (iVar1 = ossl_param_build_set_octet_string(0,lVar8,&_LC34,local_50,lVar15),
               iVar1 != 0)) goto LAB_00101385;
            goto LAB_00101753;
          }
LAB_00101385:
          if (lVar14 == 0 && lVar13 == 0) goto LAB_0010139b;
          if (lVar13 == 0) {
            local_88 = (BIGNUM *)0x0;
LAB_001017ae:
            pBVar16 = BN_CTX_get((BN_CTX *)pEVar9);
            if ((pBVar16 != (BIGNUM *)0x0) &&
               (iVar1 = EC_POINT_get_affine_coordinates(pEVar5,pEVar12,local_88,pBVar16,pEVar9),
               iVar1 != 0)) {
              if (lVar13 != 0) {
...
LAB_001013af:
        ...
        if ((lVar8 != 0) &&
           (iVar1 = ossl_param_build_set_utf8_string(0,param_2,"point-format",lVar8), iVar1 == 0))
        goto LAB_001014ff;
        uVar3 = EC_KEY_get_flags(param_1);
        lVar8 = ossl_ec_check_group_type_id2name(uVar3 & 0x6000);
        if (((lVar8 != 0) &&
            (iVar1 = ossl_param_build_set_utf8_string(0,param_2,"group-check",lVar8), iVar1 == 0))
...
LAB_00101c3d:
    ...
    if (param_1[3] != 0) {
      form = ossl_ec_pt_format_name2id();
joined_r0x00101cb2:
      if ((int)form < 0) goto LAB_00101c88;
      EC_GROUP_set_point_conversion_form((EC_GROUP *)param_1[0x10],form);
      goto LAB_00101c3d;
    }
  }
...

{
  ...
  local_48 = (void *)0x0;
  iVar1 = ossl_prov_is_running();
  if ((((iVar1 == 0) || (param_1 == (EC_KEY *)0x0)) || ((param_2 & 4) == 0)) ||
      ...
      if ((param_2 & 3) != 0) {
        ...
        if (pEVar10 != (EC_POINT *)0x0) {
          ...
          if (c != (EC_POINT *)0x0) {
            ...
            if ((lVar11 == 0) ||
               (iVar1 = ossl_param_build_set_octet_string(lVar5,0,&_LC34,local_50,lVar11),
               iVar1 == 0)) {
...
LAB_00102162:
      ...
      if ((param_2 & 0x80) == 0) {
LAB_00102289:
        lVar11 = OSSL_PARAM_BLD_to_param(lVar5);
        if (lVar11 != 0) {
        ...
        if ((lVar11 == 0) ||
           (iVar1 = ossl_param_build_set_utf8_string(lVar5,0,"point-format",lVar11), iVar1 != 0)) {
          uVar3 = EC_KEY_get_flags(param_1);
          lVar11 = ossl_ec_check_group_type_id2name(uVar3 & 0x6000);
          if (((lVar11 == 0) ||
              (iVar1 = ossl_param_build_set_utf8_string(lVar5,0,"group-check",lVar11), iVar1 != 0))
             && ((uVar3 = EC_KEY_get_enc_flags(param_1), (uVar3 & 2) == 0 ||

...
ossl_quic_hdr_protector_decrypt_fields
          (long param_1,uchar *param_2,ulong param_3,byte *param_4,uint *param_5)

{
  ...
  if (*(int *)(param_1 + 0x20) - 1U < 2) {
    if (0xf < param_3) {
      iVar2 = EVP_CipherInit_ex(*(EVP_CIPHER_CTX **)(param_1 + 0x10),(EVP_CIPHER *)0x0,(ENGINE *)0x0
                                ,(uchar *)0x0,(uchar *)0x0,1);
      if (iVar2 != 0) {
        iVar2 = EVP_CipherUpdate(*(EVP_CIPHER_CTX **)(param_1 + 0x10),local_48,&local_54,param_2,
                                 0x10);
        if (iVar2 != 0) {
          local_50 = local_48[0];
...
LAB_0010039f:
          ...
          *param_4 = bVar1;
          if (bVar3 == 3) {
            *param_5 = *param_5 ^
                       CONCAT13(uStack_4c,CONCAT12(bStack_4d,CONCAT11(bStack_4e,bStack_4f)));
          }
          else {
            *(byte *)param_5 = (byte)*param_5 ^ bStack_4f;
            if ((bVar3 != 0) &&
               (*(byte *)((long)param_5 + 1) = *(byte *)((long)param_5 + 1) ^ bStack_4e, bVar3 == 2)
               ) {
    ...
    uVar4 = 0x58;
LAB_00100499:
    ERR_set_debug("ssl/quic/quic_wire_pkt.c",uVar4,"hdr_generate_mask");
...
LAB_00100650:
          ...
          if (bVar1 == 3) {
            ...
            *(byte *)param_5 = (byte)*param_5 ^ bStack_4f;
            if ((bVar1 != 0) &&
               (*(byte *)((long)param_5 + 1) = *(byte *)((long)param_5 + 1) ^ bStack_4e, bVar1 == 2)
               ) {
              *(byte *)((long)param_5 + 2) = *(byte *)((long)param_5 + 2) ^ bStack_4d;
            }
          }
    ...
    uVar3 = 0x58;
LAB_00100701:
    ERR_set_debug("ssl/quic/quic_wire_pkt.c",uVar3,"hdr_generate_mask");
    ERR_set_error(0x14,0x80106,0);
  }
  else if (*(int *)(param_1 + 0x20) == 3) {
    if (param_3 < 0x10) {
...

{
  ...
  if ((uVar9 < 7) || (lVar13 = param_1[1], lVar13 == 0)) goto LAB_001008e0;
          ...
          if (uVar7 < 8) {
            ...
            *(undefined8 *)((long)param_5 + uVar19 + 1) = *(undefined8 *)(pbVar17 + (uVar19 - 2));
            ...
            if (7 < uVar7) {
              ...
              do {
                uVar18 = (int)uVar12 + 8;
                *(undefined8 *)(uVar14 + uVar12) =
                     *(undefined8 *)(pbVar17 + 6 + (uVar12 - (long)pcVar15));
                uVar12 = (ulong)uVar18;
              } while (uVar18 < uVar7);
            ...
            *param_1 = (long)(pbVar17 + 1);
            ...
            if ((bVar3 < 0x15) && (uVar19 <= lVar13 - 1U)) {
              ...
              if (local_60 < 8) {
                if ((bVar3 & 4) == 0) {
                  if ((local_60 != 0) &&
                     (*(byte *)((long)param_5 + 0x1e) = pbVar17[1], (bVar3 & 2) != 0)) {
                    *(undefined2 *)((long)param_5 + uVar19 + 0x1c) =
                         *(undefined2 *)(pbVar17 + (uVar19 - 1));
                  }
                }
                else {
                  *(undefined4 *)((long)param_5 + 0x1e) = *(undefined4 *)(pbVar17 + 1);
                  *(undefined4 *)((long)param_5 + uVar19 + 0x1a) =
                       *(undefined4 *)(pbVar17 + (uVar19 - 3));
                }
              }
              else {
                *(undefined8 *)((long)param_5 + 0x1e) = *(undefined8 *)(pbVar17 + 1);
                *(undefined8 *)((long)param_5 + uVar19 + 0x16) =
                     *(undefined8 *)(pbVar17 + (uVar19 - 7));
                ...
                if (7 < (local_60 & 0xfffffff8)) {
                  ...
                  do {
                    uVar11 = (ulong)uVar7;
                    uVar7 = uVar7 + 8;
                    *(undefined8 *)(uVar14 + uVar11) =
                         *(undefined8 *)(pbVar17 + 1 + (uVar11 - (long)pcVar15));
...
LAB_00100eee:
                    ...
                    *(ushort *)param_5 = (ushort)*param_5 & 0x4000 | 0x8001;
                    ...
                    if ((iVar5 == 0) || (uVar9 = param_1[1], uVar9 < local_48)) goto LAB_001008e0;
                    lVar13 = *param_1;
...
LAB_0010098d:
                        if ((param_6 != (long *)0x0) && (param_6[3] = lVar13, lVar13 != 0)) {
                          lVar10 = param_1[1];
                          lVar8 = *param_1;
                          param_6[1] = lVar13 + 4;
    ...
    *(byte *)((long)param_5 + 1) =
         *(byte *)((long)param_5 + 1) & 0xc1 | (char)uVar20 * '\x04' | bVar21 * '\x02';

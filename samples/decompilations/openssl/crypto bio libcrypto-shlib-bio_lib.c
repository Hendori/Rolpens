...
LAB_00100481:
        uVar1 = (*pcVar4)(b,2,data,uVar6,0,0,1,0);
      }
...
LAB_001004d1:
        uVar3 = (*pcVar4)(b,0x82,data,len,0);
        uVar1 = uVar3;
...
LAB_0010041c:
          uVar3 = (*pcVar5)(b,0x82,data,uVar6,0,0,uVar2);
          goto LAB_0010043b;
        }
        uVar1 = local_38;
        if (pcVar5 != (code *)0x0) goto LAB_0010041c;
...

{
  ...
  if (*(code **)(param_1 + 0x10) == (code *)0x0) {
    if (pcVar4 != (code *)0x0) {
LAB_00100685:
      iVar1 = (*pcVar4)(param_1,2,param_2,param_3,0,0,1,0);
...
LAB_00100725:
    uVar3 = (*pcVar4)(param_1,0x82,param_2,param_3,0,0,uVar2,param_4);
LAB_00100741:
    if ((int)uVar3 < 1) {
      return false;
    }
...
LAB_00100702:
      uVar3 = (*pcVar5)(param_1,0x82,param_2,param_3 & 0xffffffff,0,uVar3);
      if (0 < (long)uVar3) {
        *param_4 = uVar3;
        goto LAB_0010074d;
      }
...
LAB_0010093d:
      uVar2 = (*pcVar5)(b,3,data,lVar7,0,0,1,0);
    }
...
LAB_00100a05:
    uVar4 = (*pcVar5)(b,0x83,data,len,0);
    uVar2 = uVar4;
...
LAB_001009a6:
      uVar4 = (*pcVar6)(b,0x83,data,lVar7,0,0,uVar3,&local_38);
      goto LAB_001009c5;
    }
    uVar2 = local_38;
    if (pcVar6 != (code *)0x0) goto LAB_001009a6;
...
LAB_00100b95:
        iVar2 = (*pcVar1)(param_1,3,param_2,param_3,0,0,1,0);
      }
...
LAB_00100c61:
        ...
        if (pcVar1 != (code *)0x0) {
LAB_00100c45:
          uVar3 = (*pcVar1)(param_1,0x83,param_2,param_3,0,0,uVar3,&local_38);
          goto LAB_00100c61;
        }
        if (0x7fffffff < param_3) {
          if (param_4 != (ulong *)0x0) {
        ...
        uVar3 = (long)iVar2;
        if ((0 < (long)iVar2) && (uVar3 = local_38, 0x7fffffff < local_38)) {
          if (param_4 != (ulong *)0x0) {
            *param_4 = local_38;
          }
          goto LAB_00100b5f;
...
long BIO_sendmmsg(long param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...
LAB_00100e3d:
    ...
    if (*(int *)(param_1 + 0x28) != 0) {
      lVar2 = (**(code **)(*(long *)(param_1 + 8) + 0x60))
...
long BIO_recvmmsg(long param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
                 undefined8 param_5,undefined8 *param_6)
...
LAB_001010dd:
    ...
    if (*(int *)(param_1 + 0x28) != 0) {
      lVar2 = (**(code **)(*(long *)(param_1 + 8) + 0x68))
                        (param_1,param_2,param_3,param_4,param_5,param_6);
      pcVar1 = *(code **)(param_1 + 0x18);
      if (*(code **)(param_1 + 0x10) == (code *)0x0) {
...
LAB_00101391:
        uVar4 = (*pcVar7)(bp,4,buf,0,0,0,1,0);
      }
...
LAB_00101332:
        uVar4 = (*pcVar6)(bp,0x84,buf,0,0,0,uVar5,&local_28);
LAB_00101352:
        uVar5 = uVar4 & 0xffffffff;
        uVar2 = local_28;
        if ((int)uVar4 < 1) goto LAB_00101368;
...
LAB_001013d1:
        uVar4 = (*pcVar7)(bp,0x84,buf,0,0,(long)iVar3);
        uVar2 = uVar4;
...
LAB_0010168c:
        uVar2 = (*pcVar6)(bp,5,buf,(long)size,0,0,1,0);
      }
      uVar3 = uVar2 & 0xffffffff;
...
LAB_001015eb:
        uVar4 = (*pcVar5)(bp,0x85,buf,(long)size,0,0,uVar3,&local_38);
LAB_0010160c:
        uVar3 = uVar4 & 0xffffffff;
        uVar2 = local_38;
...
LAB_00101660:
          uVar4 = (*pcVar6)(bp,0x85,buf,size,0,(long)iVar1);
          uVar2 = uVar4;
...
LAB_001018dd:
    lVar2 = (*pcVar1)(bp,6,parg,0,cmd,larg,1,0);
  }
  else {
...
LAB_00101c95:
    lVar2 = (*pcVar1)(b,6,&local_10,0,0xe,0,1,0);
  }
  else {
...
LAB_00102460:
        ...
        iVar1 = BIO_test_flags(param_1,8);
        if (((ulong)(long)(int)uVar2 >> 0x17 == 0x20) &&
           (((uVar6 = uVar2 & 0x7fffff, uVar6 == 0x6e || (uVar6 == 0x80002)) || (uVar6 == 0x67)))) {

...
LAB_001000f0:
      ...
      if (((ctx != (SSL_CTX *)0x0) &&
          (lVar14 = SSL_CTX_ctrl(ctx,0x7b,larg,(void *)0x0), lVar14 != 0)) &&
         (lVar14 = SSL_CTX_ctrl(ctx,0x7c,larg,(void *)0x0), lVar14 != 0)) {
        if (bVar2) {
        ...
        if ((local_260 == 0) || (iVar8 = SSL_CTX_set_ciphersuites(ctx,local_260), iVar8 != 0)) {
          if ((pcVar17 == (char *)0x0) || (iVar8 = SSL_CTX_set_cipher_list(ctx,pcVar17), iVar8 != 0)
             ) {
            s = SSL_new(ctx);
            if (s != (SSL *)0x0) {
              if (bVar1) {
              ...
              if (bVar5) {
                if (local_268 == 0) {
                  if (bVar4) {
                    for (; iVar8 = OPENSSL_sk_num(psVar15), local_268 < iVar8;
                      ...
                      if (pSVar16 != (SSL_CIPHER *)0x0) {
                        ...
                        if (((uint)uVar18 & 0xff000000) == 0x3000000) {
                          BIO_printf(_bio_out,"          0x%02X,0x%02X - ",(ulong)bVar19,
                                     uVar18 & 0xff);
                        }
                        else {
                          BIO_printf(_bio_out,"0x%02X,0x%02X,0x%02X,0x%02X - ",
                                     (uVar18 & 0xffffffff) >> 0x18,
                                     (uVar18 & 0xffffffff) >> 0x10 & 0xff,(ulong)bVar19);
                        }
                    ...
                    for (iVar8 = 0; iVar9 = OPENSSL_sk_num(psVar15), iVar8 < iVar9;
                        iVar8 = iVar8 + 1) {
    ...
    if ((iVar7 - 0x641U < 4) && (iVar7 = opt_provider(iVar7), iVar7 == 0)) {
      iVar7 = 1;
      psVar15 = (stack_st_SSL_CIPHER *)0x0;
      s = (SSL *)0x0;
      ctx = (SSL_CTX *)0x0;

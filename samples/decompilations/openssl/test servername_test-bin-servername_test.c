...

{
  ...
  iVar4 = test_long_ge("test/servername_test.c",0x37,"len = BIO_get_mem_data(bio, (char **)&data)",
                       &_LC6,uVar5,0);
...
LAB_0010060a:
  ...
  iVar4 = test_true("test/servername_test.c",0x3e,
                    "PACKET_forward(&pkt, CLIENT_VERSION_LEN + SSL3_RANDOM_SIZE)",uVar10);
  if (iVar4 == 0) goto LAB_001005c0;
  if (uVar6 == 0) {
LAB_00100618:
    uVar5 = 0;
  ...
  if (iVar4 != 0) {
    ...
    iVar4 = test_true("test/servername_test.c",0x43,"PACKET_get_length_prefixed_2(&pkt, &pkt2)",
                      uVar10);
    if (iVar4 != 0) {
      uVar10 = 0;
      if (uVar6 != 0) {
      ...
      iVar4 = test_true("test/servername_test.c",0x45,"PACKET_get_length_prefixed_1(&pkt, &pkt2)",
                        uVar10);
      if (iVar4 != 0) {
        uVar10 = 0;
        ...
        uVar2 = 0;
        iVar4 = test_true("test/servername_test.c",0x47,"PACKET_as_length_prefixed_2(&pkt, &pkt2)",
                          uVar10);
        if (iVar4 != 0) {
          while (uVar5 != 0) {
            if (uVar5 == 1) {
...
LAB_00100598:
            ...
            iVar4 = test_true("test/servername_test.c",0x4d,
                              "PACKET_get_length_prefixed_2(&pkt2, &pkt3)",uVar10);
            if (iVar4 == 0) break;
            if (uVar2 == 0) {
...
LAB_00100850:
              ...
              iVar4 = test_true("test/servername_test.c",0x50,
                                "PACKET_get_length_prefixed_2(&pkt3, &pkt4)",uVar10);
              if ((iVar4 != 0) &&
                 (iVar4 = test_uint_ne("test/servername_test.c",0x51,"PACKET_remaining(&pkt4)",&_LC6
                                       ,uVar2,0), iVar4 != 0)) {
                uVar11 = 0;
                if (uVar5 != 0) {
                ...
                iVar4 = test_true("test/servername_test.c",0x52,
                                  "PACKET_get_1(&pkt4, &servname_type)",uVar5 != 0);
                if ((iVar4 != 0) &&
                   (iVar4 = test_uint_eq("test/servername_test.c",0x53,"servname_type",
                                         "TLSEXT_NAMETYPE_host_name",uVar11,0), iVar4 != 0)) {
...
LAB_00100865:
                  ...
                  iVar4 = test_true("test/servername_test.c",0x54,
                                    "PACKET_get_length_prefixed_2(&pkt4, &pkt5)",uVar10);
                  if (iVar4 != 0) {
                    uVar10 = local_58._8_8_;
                    iVar4 = test_uint_le("test/servername_test.c",0x55,"PACKET_remaining(&pkt5)",
                                         "TLSEXT_MAXLEN_host_name",local_58._8_8_ & 0xffffffff,0xff)
                    ;
                    if (iVar4 != 0) {
                      uVar1 = local_58._0_8_;
                      pvVar8 = memchr((void *)local_58._0_8_,0,uVar10);
                      iVar4 = test_false("test/servername_test.c",0x56,
                                         "PACKET_contains_zero_byte(&pkt5)",pvVar8 != (void *)0x0);
                      if (iVar4 != 0) {
                        CRYPTO_free((void *)*param_2);
                        lVar9 = CRYPTO_strndup(uVar1,uVar10,"include/internal/packet.h",0x1e6);
                        *param_2 = lVar9;
                        iVar4 = test_true("test/servername_test.c",0x57,"PACKET_strndup(&pkt5, sni)"
                                          ,lVar9 != 0);
                        bVar13 = iVar4 != 0;
                        goto LAB_001005c2;
                      }

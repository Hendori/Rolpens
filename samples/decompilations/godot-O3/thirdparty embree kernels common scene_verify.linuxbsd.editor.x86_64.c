  ...
  if (uVar1 == 0) {
    ...
    if (local_2118[0] != 0) {
      ...
      if ((local_2118[0] & 1) != 0) {
        ...
        pbVar2 = local_c0 + 1;
        if (local_c0 + 1 == local_c0 + local_2118[0]) goto LAB_001006f8;
      }
      do {
        pbVar3 = pbVar2 + 2;
        bVar4 = bVar4 | *pbVar2 | pbVar2[1];
        pbVar2 = pbVar3;
      } while (pbVar3 != local_c0 + local_2118[0]);
    }
  }
LAB_001006f8:
...

{
  ...
  *(long *)pRVar1 = *(long *)pRVar1 + -1;
  ...
  if ((this != (RefCount *)0x0) && (*(long *)pRVar1 == 0)) {
                    /* WARNING: Could not recover jumptable at 0x001009e9. Too many branches */

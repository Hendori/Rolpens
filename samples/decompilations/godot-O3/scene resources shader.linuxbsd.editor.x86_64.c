...
/* Shader::get_mode() const */

undefined4 __thiscall Shader::get_mode(Shader *this)
...
/* Shader::is_text_shader() const */

undefined8 Shader::is_text_shader(void)
...
/* Shader::_update_shader() const */

void Shader::_update_shader(void)
...
/* ResourceFormatLoaderShader::handles_type(String const&) const */

void __thiscall
ResourceFormatLoaderShader::handles_type(ResourceFormatLoaderShader *this,String *param_1)
...
/* ResourceFormatSaverShader::recognize(Ref<Resource> const&) const */

void __thiscall ResourceFormatSaverShader::recognize(ResourceFormatSaverShader *this,Ref *param_1)
...
/* Shader::set_path(String const&, bool) */

void Shader::set_path(String *param_1,bool param_2)

{
  ...
  (**(code **)(*plVar1 + 600))
            (plVar1,*(undefined8 *)(param_1 + 0x240),CONCAT71(in_register_00000031,param_2));
  return;
}
...
::_lookup_pos(HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>
...
/* Shader::get_default_texture_parameter_list(List<StringName, DefaultAllocator>*) const */

void __thiscall Shader::get_default_texture_parameter_list(Shader *this,List *param_1)
...
/* ResourceFormatLoaderShader::get_resource_type(String const&) const */

String * ResourceFormatLoaderShader::get_resource_type(String *param_1)
...
void __thiscall
ResourceFormatSaverShader::get_recognized_extensions
          (ResourceFormatSaverShader *this,Ref *param_1,List *param_2)

{
  ...
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  if (((*(long *)param_1 != 0) &&
      (plVar3 = (long *)__dynamic_cast(*(long *)param_1,&Object::typeinfo,&Shader::typeinfo,0),
      plVar3 != (long *)0x0)) &&
     ((*(code **)(*plVar3 + 0x1d8) == Shader::is_text_shader ||
      (cVar2 = (**(code **)(*plVar3 + 0x1d8))(plVar3), cVar2 != '\0')))) {
    local_40 = 0;
    local_38 = "gdshader";
    local_30 = 8;
...
/* ResourceFormatSaverShader::save(Ref<Resource> const&, String const&, unsigned int) */

int ResourceFormatSaverShader::save(Ref *param_1,String *param_2,uint param_3)

{
    ...
    if (pOVar3 != (Object *)0x0) {
      ...
      if (cVar1 != '\0') {
        ...
        if (local_5c == 0) {
          ...
          operator+((char *)local_48,(String *)"Cannot save shader \'");
          String::operator+(local_38,(String *)local_48);
          _err_print_error(&_LC22,"scene/resources/shader.cpp",0x165,
  ...
  local_5c = 0x1f;
  _err_print_error(&_LC22,"scene/resources/shader.cpp",0x15e,
                   "Condition \"shader.is_null()\" is true. Returning: ERR_INVALID_PARAMETER",0,0);
LAB_001006ae:
...
/* Shader::set_include_path(String const&) */

void __thiscall Shader::set_include_path(Shader *this,String *param_1)
...
/* Shader::get_code() const */

void Shader::get_code(void)
...
/* ResourceFormatLoaderShader::get_recognized_extensions(List<String, DefaultAllocator>*) const */

void __thiscall
ResourceFormatLoaderShader::get_recognized_extensions
          (ResourceFormatLoaderShader *this,List *param_1)
...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_00113350;
  if (*(long *)(this + 0x240) != 0) {
    ...
    if (lVar5 == 0) {
      _err_print_error("~Shader","scene/resources/shader.cpp",0x129,
...
LAB_00100d50:
  ...
  if (*(int *)(this + 0x2a4) != 0) {
    if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x2a0) * 4) != 0) {
      memset(*(void **)(this + 0x298),0,
             (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x2a0) * 4) * 4);
...
/* Shader::set_code(String const&) */

void __thiscall Shader::set_code(Shader *this,String *param_1)

{
  ...
  if (iVar7 != 0) {
    ...
    while( true ) {
      ...
      create_custom_callable_function_pointer<Shader>
                ((Shader *)local_68,(char *)this,(_func_void *)"&Shader::_dependency_changed");
  ...
  iVar7 = ShaderPreprocessor::preprocess
                    ((String *)local_88,param_1,(String *)&local_90,(String *)this_00,(List *)0x0,
                     (List *)0x0,(HashSet *)0x0,(List *)local_68,(List *)0x0,
                     (_func_void_List_ptr *)0x0);
  if (iVar7 == 0) {
    HashSet<Ref<ShaderInclude>,HashMapHasherDefault,HashMapComparatorDefault<Ref<ShaderInclude>>>::
    operator=((HashSet<Ref<ShaderInclude>,HashMapHasherDefault,HashMapComparatorDefault<Ref<ShaderInclude>>>
               *)(this + 0x280),(HashSet *)local_68);
  }
  ShaderPreprocessor::~ShaderPreprocessor(local_88);
...
void __thiscall Shader::_recompile(Shader *this)
...
/* ResourceFormatLoaderShader::load(String const&, String const&, Error*, bool, float*,
   ResourceFormatLoader::CacheMode) */

long * ResourceFormatLoaderShader::load
                 (long *param_1,undefined8 param_2,Error *param_3,undefined8 param_4,
                 undefined4 *param_5)

{
  ...
  if (local_50 != 0) {
    if ((0 < *(long *)(local_50 + -8)) &&
       (iVar4 = String::parse_utf8((char *)&local_68,(int)local_50,SUB81(*(long *)(local_50 + -8),0)
                                  ), iVar4 != 0)) {
      operator+((char *)local_60,(String *)"Cannot parse shader: ");
      _err_print_error(&_LC35,"scene/resources/shader.cpp",0x13c,
                       "Condition \"error\" is true. Returning: nullptr",local_60,0,0);
...
/* Shader::_check_shader_rid() const */

ulong __thiscall Shader::_check_shader_rid(Shader *this)

{
  ...
  if (((*(long *)(this + 0x240) == 0) && (*(long *)(this + 0x248) != 0)) &&
     (1 < *(uint *)(*(long *)(this + 0x248) + -8))) {
...
/* Shader::get_rid() const */

undefined8 __thiscall Shader::get_rid(Shader *this)
...
void __thiscall Shader::inspect_native_shader_code(Shader *this)

{
  ...
  if ((lVar2 != 0) && (lVar3 != 0)) {
    ...
    SceneTree::call_group_flagsp
              ((uint)lVar2,(StringName *)0x2,(StringName *)&local_90,(Variant **)&local_88,
               (int)local_78);
...
/* Shader::_dependency_changed() */

void __thiscall Shader::_dependency_changed(Shader *this)
...
/* Shader::_bind_compatibility_methods() */
...

{
  ...
  pMVar4 = create_method_bind<Shader,StringName_const&,Ref<Texture2D>const&,int>
                     (_set_default_texture_parameter_bind_compat_95126);
  ...
  local_60 = 0;
  local_98 = (Variant *)&local_78;
  pMVar4 = create_method_bind<Shader,Ref<Texture2D>,StringName_const&,int>
                     (_get_default_texture_parameter_bind_compat_95126);
  ClassDB::bind_methodfi(1,pMVar4,true,(MethodDefinition *)local_d8,&local_98,1);
  if (Variant::needs_deinit[(int)local_60] != '\0') {
    Variant::_clear_internal();
  }
...
/* Shader::get_default_texture_parameter(StringName const&, int) const */

StringName * Shader::get_default_texture_parameter(StringName *param_1,int param_2)

{
  ...
  *this;
  ...
  this = (HashMap<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>>>>
          *)(lVar3 + 0x2b8);
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  local_44 = 0;
  cVar2 = HashMap<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>>>>
          ::_lookup_pos(this,in_RDX,&local_44);
  if (cVar2 != '\0') {
    local_4c = 0;
    cVar2 = HashMap<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>>>>
            ::_lookup_pos(this,in_RDX,&local_4c);
    if (cVar2 == '\0') goto LAB_001020f8;
    cVar2 = HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>
            ::_lookup_pos((HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>
                           *)(*(long *)(*(long *)(lVar3 + 0x2c0) + (ulong)local_4c * 8) + 0x18),
                          (int *)(ulong)in_ECX,&local_44);
    if (cVar2 != '\0') {
      local_44 = 0;
      cVar2 = HashMap<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>>>>
              ::_lookup_pos(this,in_RDX,&local_44);
...
LAB_001020f8:
      ...
      cVar2 = HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>
              ::_lookup_pos((HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>
                             *)(lVar3 + 0x18),(int *)(ulong)in_ECX,&local_48);
      if (cVar2 == '\0') goto LAB_001020f8;
...
/* Shader::_get_default_texture_parameter_bind_compat_95126(StringName const&, int) const */

StringName *
Shader::_get_default_texture_parameter_bind_compat_95126(StringName *param_1,int param_2)
...

{
  ...
  local_60 = 0;
  local_98 = (Variant *)&local_78;
  pMVar6 = create_method_bind<Shader,StringName_const&,Ref<Texture>const&,int>
  ...
  local_60 = 0;
  local_98 = (Variant *)&local_78;
  pMVar6 = create_method_bind<Shader,Ref<Texture>,StringName_const&,int>
  ...
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_f8,4,(String *)&local_128,0,(String *)&local_120,2,
  ...
  local_120 = 0;
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_f8,2,(String *)&local_120,0,(CowData<char32_t> *)&local_118,
             0x10006,(StringName *)&local_100);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_120);
  ...
  StringName::StringName((StringName *)&local_f8,(String *)&local_108,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_f8,(StringName *)&local_100,(StringName *)&local_128,3,false);
  if ((StringName::configured != '\0') && (local_f8 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_108);
  ...
  StringName::StringName((StringName *)&local_f8,(String *)&local_108,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_f8,(StringName *)&local_100,(StringName *)&local_128,4,false);
  if ((StringName::configured != '\0') && (local_f8 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_108);
    ...
    if (lVar2 != 0) {
      do {
        ...
        *(undefined8 *)(this_01 + 0x28) = 0;
        CowData<char32_t>::_ref(this_01 + 0x28,pCVar5 + 0x28);
        *(undefined8 *)(this_01 + 0x30) = 0;
        CowData<char32_t>::_ref(this_01 + 0x30,pCVar5 + 0x30);
        *(undefined8 *)(this_01 + 0x38) = 0;
        CowData<char32_t>::_ref(this_01 + 0x38,pCVar5 + 0x38);
        CVar1 = *(CowData<char32_t> *)(pCVar5 + 0x40);
        *(undefined8 *)(this_01 + 0x48) = 0;
        this_01[0x40] = CVar1;
        CowData<char32_t>::_ref(this_01 + 0x48,pCVar5 + 0x48);
        CVar1 = *(CowData<char32_t> *)(pCVar5 + 0x50);
        *(undefined8 *)(this_01 + 0x58) = 0;
        this_01[0x50] = CVar1;
        CowData<char32_t>::_ref(this_01 + 0x58,pCVar5 + 0x58);
        CVar1 = *(CowData<char32_t> *)(pCVar5 + 0x60);
        *(undefined8 *)(this_01 + 0x68) = 0;
        this_01[0x60] = CVar1;
        CowData<char32_t>::_ref(this_01 + 0x68,pCVar5 + 0x68);
...
/* Shader::set_default_texture_parameter(StringName const&, Ref<Texture> const&, int) */

void __thiscall
Shader::set_default_texture_parameter(Shader *this,StringName *param_1,Ref *param_2,int param_3)

{
  ...
  *pHVar39;
  ...
  uVar36 = local_4c[0];
  if (*(long *)param_2 == 0) {
    pHVar1 = (HashMap<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>>>>
              *)(this + 0x2b8);
    local_44 = 0;
    cVar37 = HashMap<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>>>>
             ::_lookup_pos(pHVar1,param_1,&local_44);
    if (cVar37 != '\0') {
      pHVar39 = (HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>
                 *)HashMap<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>>>>
                   ::operator[](pHVar1,param_1);
      cVar37 = HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>
               ::_lookup_pos(pHVar39,(int *)(ulong)uVar36,&local_44);
      if (cVar37 != '\0') {
        pHVar39 = (HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>
                   *)HashMap<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>>>>
                     ::operator[](pHVar1,param_1);
        ...
        lVar47 = HashMap<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>>>>
                 ::operator[](pHVar1,param_1);
                  ...
                  do {
                    if (*(int *)(plVar49[5] + lVar47) != 0) {
                      ...
                      *(int *)(plVar49[5] + lVar47) = 0;
                      if ((*(long *)((long)pvVar48 + 0x18) != 0) &&
                         (cVar37 = RefCounted::unreference(), cVar37 != '\0')) {
...
LAB_00103a56:
      if (0x16 < uVar38) goto LAB_0010396e;
    }
    else {
      lVar47 = 0;
      if (uVar38 != 0) {
          ...
          if (uVar38 != uVar43) {
            if (*(long *)(pHVar39 + 8) == 0) {
              *(uint *)(pHVar39 + 0x28) = uVar38;
              ...
              HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>
              ::_resize_and_rehash(pHVar39,uVar38);
            }
          }
          goto LAB_0010396e;
        }
...
LAB_0010396e:
  pHVar39 = (HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>
             *)HashMap<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>>>>
               ::operator[](pHVar1,param_1);
  plVar40 = (long *)HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>
                    ::operator[](pHVar39,(int *)local_4c);
  ...
  if (pOVar6 != pOVar7) {
    *plVar40 = (long)pOVar6;
    ...
    if (((pOVar7 != (Object *)0x0) && (cVar37 = RefCounted::unreference(), cVar37 != '\0')) &&
       (cVar37 = predelete_handler(pOVar7), cVar37 != '\0')) {
      (**(code **)(*(long *)pOVar7 + 0x140))(pOVar7);
      Memory::free_static(pOVar7,false);
    }
  }
  plVar40 = (long *)RenderingServer::get_singleton();
  pcVar8 = *(code **)(*plVar40 + 0x278);
  uVar41 = (**(code **)(**(long **)param_2 + 0x1c0))();
  (*pcVar8)(plVar40,*(undefined8 *)(this + 0x240),param_1,uVar41,uVar36);
LAB_001039f8:
  Resource::emit_changed();
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
...
void __thiscall
Shader::_set_default_texture_parameter_bind_compat_95126
          (Shader *this,StringName *param_1,Ref *param_2,int param_3)
...
/* Shader::get_shader_uniform_list(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall Shader::get_shader_uniform_list(Shader *this,List *param_1,bool param_2)

{
  ...
  plVar6 = (long *)RenderingServer::get_singleton();
  (**(code **)(*plVar6 + 0x268))
            (plVar6,*(undefined8 *)(this + 0x240),(List<PropertyInfo,DefaultAllocator> *)&local_780)
  ;
  local_638 = 0;
  local_628 = 0;
  local_618 = 0;
  ...
  if ((local_780 != (long *)0x0) &&
     (pPVar10 = (PropertyInfo *)*local_780, pPVar10 != (PropertyInfo *)0x0)) {
    do {
      while (*(int *)(pPVar10 + 0x28) == 0x40 || *(int *)(pPVar10 + 0x28) == 0x100) {
        if (param_2) goto LAB_00104557;
LAB_00104588:
        pPVar10 = *(PropertyInfo **)(pPVar10 + 0x30);
      ...
      cVar4 = HashMap<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>>>>
              ::_lookup_pos((HashMap<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,HashMap<int,Ref<Texture>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,Ref<Texture>>>>>>>
                             *)(this + 0x2b8),(StringName *)&local_6d8,(uint *)local_758);
...
LAB_00104557:
        if (param_1 != (List *)0x0) {
          ...
          if (*(char *)(lVar7 + 0xc0) != '\0') {
            ...
            local_728[0] = (CowData)0x0;
            local_728[1] = (CowData)0x0;
            local_728[2] = (CowData)0x0;
            local_728[3] = (CowData)0x0;
            local_728[4] = (CowData)0x0;
            local_728[5] = (CowData)0x0;
            local_728[6] = (CowData)0x0;
            local_728[7] = (CowData)0x0;
            local_728[8] = (CowData)0x0;
            local_728[9] = (CowData)0x0;
            local_728[10] = (CowData)0x0;
            local_728[0xb] = (CowData)0x0;
            local_728[0xc] = (CowData)0x0;
            local_728[0xd] = (CowData)0x0;
            local_728[0xe] = (CowData)0x0;
            local_728[0xf] = (CowData)0x0;
            local_6f0[0] = (CowData)0x0;
            local_6f0[1] = (CowData)0x0;
            local_6f0[2] = (CowData)0x0;
            local_6f0[3] = (CowData)0x0;
            local_6f0[4] = (CowData)0x0;
            local_6f0[5] = (CowData)0x0;
            local_6f0[6] = (CowData)0x0;
            local_6f0[7] = (CowData)0x0;
            local_6f0[8] = (CowData)0x0;
            local_6f0[9] = (CowData)0x0;
            local_6f0[10] = (CowData)0x0;
            local_6f0[0xb] = (CowData)0x0;
            local_6f0[0xc] = (CowData)0x0;
            local_6f0[0xd] = (CowData)0x0;
            local_6f0[0xe] = (CowData)0x0;
            local_6f0[0xf] = (CowData)0x0;
            operator+((char *)&local_6d8,(String *)"shader_parameter/");
            ...
            if (local_778 != (Object *)0x0) {
              ...
              RegEx::sub((String *)&local_6d8,(String *)local_1d8,SUB81(local_768,0),
                         (int)(StrRange *)&local_760,1);
              ...
              if (((local_770 != (Object *)0x0) &&
                  (cVar4 = RefCounted::unreference(), pOVar2 = local_770, cVar4 != '\0')) &&
                 (cVar4 = predelete_handler(local_770), cVar4 != '\0')) {
                (**(code **)(*(long *)pOVar2 + 0x140))(pOVar2);
                Memory::free_static(pOVar2,false);
              }
            ...
            iVar5 = CowData<DocData::PropertyDoc>::resize<false>
                              ((CowData<DocData::PropertyDoc> *)local_598,lVar7);
            if (iVar5 == 0) {
              if (local_598[0] == 0) {
                lVar9 = -1;
                lVar7 = 0;
                ...
                if (-1 < lVar9) {
                  CowData<DocData::PropertyDoc>::_copy_on_write
                            ((CowData<DocData::PropertyDoc> *)local_598);
...
LAB_00104e6e:
            CowData<char32_t>::_unref((CowData<char32_t> *)local_668);
            ...
            CowData<char32_t>::_unref((CowData<char32_t> *)&local_6d8);
            if (((local_778 != (Object *)0x0) &&
                (cVar4 = RefCounted::unreference(), pOVar2 = local_778, cVar4 != '\0')) &&
               (cVar4 = predelete_handler(local_778), cVar4 != '\0')) {
              (**(code **)(*(long *)pOVar2 + 0x140))(pOVar2);
              Memory::free_static(pOVar2,false);
            }
          ...
          List<PropertyInfo,DefaultAllocator>::push_back
                    ((List<PropertyInfo,DefaultAllocator> *)param_1,pPVar10);
        }
        goto LAB_00104588;
      }
      pPVar10 = *(PropertyInfo **)(pPVar10 + 0x30);
...
LAB_00104618:
  lVar7 = EditorHelp::get_doc_data();
  if (((lVar7 != 0) && (lVar7 = Engine::get_singleton(), *(char *)(lVar7 + 0xc0) != '\0')) &&
     ((local_658._0_8_ != 0 && ((1 < *(uint *)(local_658._0_8_ + -8) && (param_1 != (List *)0x0)))))
     ) {
...
/* Shader::_get_shader_uniform_list(bool) */

Array * Shader::_get_shader_uniform_list(bool param_1)

{
  ...
  Array::Array(this);
  if ((local_68 != (long *)0x0) && (lVar1 = *local_68, lVar1 != 0)) {
    do {
...
{
  return (uint)CONCAT71(0x113f,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr) |
...
{
  return (uint)CONCAT71(0x113f,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x113f,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x113f,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}
...
/* Shader::is_class_ptr(void*) const */

uint __thiscall Shader::is_class_ptr(Shader *this,void *param_1)

{
  return (uint)CONCAT71(0x113f,(undefined4 *)param_1 == &Resource::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x113e,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x113f,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x113f,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}



/* Shader::_getv(StringName const&, Variant&) const */

undefined8 Shader::_getv(StringName *param_1,Variant *param_2)
...
/* Shader::_setv(StringName const&, Variant const&) */

undefined8 Shader::_setv(StringName *param_1,Variant *param_2)
...
/* Shader::_validate_propertyv(PropertyInfo&) const */

void Shader::_validate_propertyv(PropertyInfo *param_1)
...
/* Shader::_property_can_revertv(StringName const&) const */

undefined8 Shader::_property_can_revertv(StringName *param_1)
...
/* Shader::_property_get_revertv(StringName const&, Variant&) const */

undefined8 Shader::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* Shader::_notificationv(int, bool) */

void Shader::_notificationv(int param_1,bool param_2)
...
/* MethodBindTR<Array, bool>::_gen_argument_type(int) const */

int __thiscall
MethodBindTR<Array,bool>::_gen_argument_type(MethodBindTR<Array,bool> *this,int param_1)
...
/* MethodBindTR<Array, bool>::get_argument_meta(int) const */

undefined8 MethodBindTR<Array,bool>::get_argument_meta(int param_1)
...
/* MethodBindTRC<Ref<Texture>, StringName const&, int>::_gen_argument_type(int) const */

char __thiscall
MethodBindTRC<Ref<Texture>,StringName_const&,int>::_gen_argument_type
          (MethodBindTRC<Ref<Texture>,StringName_const&,int> *this,int param_1)
...
/* MethodBindTRC<Ref<Texture>, StringName const&, int>::get_argument_meta(int) const */

char __thiscall
MethodBindTRC<Ref<Texture>,StringName_const&,int>::get_argument_meta
          (MethodBindTRC<Ref<Texture>,StringName_const&,int> *this,int param_1)
...
/* MethodBindT<StringName const&, Ref<Texture> const&, int>::get_argument_meta(int) const */

char __thiscall
MethodBindT<StringName_const&,Ref<Texture>const&,int>::get_argument_meta
          (MethodBindT<StringName_const&,Ref<Texture>const&,int> *this,int param_1)
...
/* MethodBindTRC<Shader::Mode>::_gen_argument_type(int) const */

undefined8 MethodBindTRC<Shader::Mode>::_gen_argument_type(int param_1)
...
/* MethodBindTRC<Shader::Mode>::get_argument_meta(int) const */

undefined8 MethodBindTRC<Shader::Mode>::get_argument_meta(int param_1)
...
/* MethodBindT<StringName const&, Ref<Texture2D> const&, int>::get_argument_meta(int) const */

char __thiscall
MethodBindT<StringName_const&,Ref<Texture2D>const&,int>::get_argument_meta
          (MethodBindT<StringName_const&,Ref<Texture2D>const&,int> *this,int param_1)
...
/* CallableCustomMethodPointer<Shader, void>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<Shader,void>::get_argument_count
          (CallableCustomMethodPointer<Shader,void> *this,bool *param_1)
...
/* MethodBindT<StringName const&, Ref<Texture> const&, int>::_gen_argument_type(int) const */

undefined8 __thiscall
MethodBindT<StringName_const&,Ref<Texture>const&,int>::_gen_argument_type
          (MethodBindT<StringName_const&,Ref<Texture>const&,int> *this,int param_1)

{
  ...
  uVar1 = 0;
  if ((((uint)param_1 < 3) && (uVar1 = 0x15, param_1 != 0)) && (uVar1 = 2, param_1 == 1)) {
    uVar1 = 0x18;
  }
  return uVar1;
}
...
/* CallableCustomMethodPointer<Shader, void>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<Shader,void>::get_object(CallableCustomMethodPointer<Shader,void> *this)
...
/* MethodBindT<StringName const&, Ref<Texture2D> const&, int>::_gen_argument_type(int) const */

undefined8 __thiscall
MethodBindT<StringName_const&,Ref<Texture2D>const&,int>::_gen_argument_type
          (MethodBindT<StringName_const&,Ref<Texture2D>const&,int> *this,int param_1)
...
/* Shader::get_save_class() const */

Shader * __thiscall Shader::get_save_class(Shader *this)
...
/* Shader::_get_class_namev() const */

undefined8 * Shader::_get_class_namev(void)
...
LAB_00106403:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      goto LAB_00106403;
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"Shader");
      goto LAB_0010646e;
    }
  }
  StringName::assign_static_unique_class_name
...
Shader * create_custom_callable_function_pointer<Shader>
                   (Shader *param_1,char *param_2,_func_void *param_3)

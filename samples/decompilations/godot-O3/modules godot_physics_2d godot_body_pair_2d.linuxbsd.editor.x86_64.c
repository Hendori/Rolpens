...
/* GodotBodyPair2D::_add_contact(Vector2 const&, Vector2 const&, void*) */

void GodotBodyPair2D::_add_contact(Vector2 *param_1,Vector2 *param_2,void *param_3)

{
  ...
  if (iVar10 < 3) {
    ...
    uStack_50 = 0;
    uStack_4c = 0;
    local_98 = CONCAT44((float)((ulong)uVar13 >> 0x20) * fVar12 +
                        (float)((ulong)uVar3 >> 0x20) * fVar17,
                        (float)uVar13 * fVar12 + (float)uVar3 * fVar17);
    uStack_90 = CONCAT44((float)((ulong)uVar4 >> 0x20) * fVar16 +
                         fVar15 * (float)((ulong)uVar5 >> 0x20),
                         (float)uVar4 * fVar16 + fVar15 * (float)uVar5);
    ...
    if (0 < iVar9) {
      ...
      do {
        ...
        if ((fVar12 < fVar15) &&
           (fVar12 = (float)Vector2::distance_squared_to(pVVar11 + 8), fVar12 < fVar15)) {
          ...
          *(ulong *)((long)param_3 + lVar1 * 0x20 + 0x50) =
               CONCAT44(uStack_5c,CONCAT22(uStack_5e,CONCAT11(uStack_5f,uStack_60)));
          goto LAB_00100291;
        }
        iVar9 = *(int *)((long)param_3 + 0x128);
        iVar8 = iVar8 + 1;
    ...
    if (iVar10 == 2) {
      ...
      local_b0 = CONCAT44(((float)((ulong)*(undefined8 *)(lVar1 + 0x50) >> 0x20) * fVar15 +
                          (float)((ulong)*(undefined8 *)(lVar1 + 0x48) >> 0x20) * (float)local_98) -
                          ((float)uStack_90 * (float)((ulong)*(undefined8 *)(lVar6 + 0x48) >> 0x20)
                           + fVar12 * (float)((ulong)*(undefined8 *)(lVar6 + 0x50) >> 0x20) +
                          (float)((ulong)*(undefined8 *)((long)param_3 + 0x58) >> 0x20)),
                          ((float)*(undefined8 *)(lVar1 + 0x50) * fVar15 +
                          (float)*(undefined8 *)(lVar1 + 0x48) * (float)local_98) -
                          ((float)uStack_90 * (float)*(undefined8 *)(lVar6 + 0x48) +
                           fVar12 * (float)*(undefined8 *)(lVar6 + 0x50) +
                          (float)*(undefined8 *)((long)param_3 + 0x58)));
      ...
      if (0 < *(int *)((long)param_3 + 0x128)) {
        ...
        do {
          ...
          local_b0 = CONCAT44((fVar15 * (float)((ulong)*(undefined8 *)(lVar1 + 0x48) >> 0x20) +
                              fVar12 * (float)((ulong)*(undefined8 *)(lVar1 + 0x50) >> 0x20)) -
                              (fVar16 * (float)((ulong)*(undefined8 *)(lVar6 + 0x48) >> 0x20) +
                               fVar17 * (float)((ulong)*(undefined8 *)(lVar6 + 0x50) >> 0x20) +
                              (float)((ulong)*(undefined8 *)((long)param_3 + 0x58) >> 0x20)),
                              (fVar15 * (float)*(undefined8 *)(lVar1 + 0x48) +
                              fVar12 * (float)*(undefined8 *)(lVar1 + 0x50)) -
                              (fVar16 * (float)*(undefined8 *)(lVar6 + 0x48) +
                               fVar17 * (float)*(undefined8 *)(lVar6 + 0x50) +
                              (float)*(undefined8 *)((long)param_3 + 0x58)));
    ...
    _err_print_error("_contact_added_callback","modules/godot_physics_2d/godot_body_pair_2d.cpp",
                     0x35,"Condition \"new_index >= (MAX_CONTACTS + 1)\" is true.",0,0);
  }
LAB_00100291:
...
/* GodotBodyPair2D::solve(float) */

void __thiscall GodotBodyPair2D::solve(GodotBodyPair2D *this,float param_1)
    ...
    if (0 < *(int *)(this + 0x128)) {
      ...
      do {
        if (pGVar4[0x40] != (GodotBodyPair2D)0x0) {
          ...
          local_78 = CONCAT44(((*(float *)(lVar3 + 0xc0) * *(float *)(pGVar4 + 0x4c) +
                               (float)((ulong)*(undefined8 *)(lVar3 + 0xb8) >> 0x20)) -
                              (float)((ulong)*(undefined8 *)(lVar6 + 0xb8) >> 0x20)) -
                              *(float *)(pGVar4 + 0x44) * *(float *)(lVar6 + 0xc0),
                              (((float)((uint)*(float *)(lVar3 + 0xc0) ^ __LC6) *
                                *(float *)(pGVar4 + 0x50) + (float)*(undefined8 *)(lVar3 + 0xb8)) -
                              (float)*(undefined8 *)(lVar6 + 0xb8)) -
                              (float)((uint)*(float *)(lVar6 + 0xc0) ^ __LC6) *
                              *(float *)(pGVar4 + 0x48));
          local_70 = CONCAT44(((*(float *)(lVar3 + 0xb4) * (float)*(undefined8 *)(pGVar4 + 0x4c) +
                               (float)((ulong)*(undefined8 *)(lVar3 + 0xac) >> 0x20)) -
                              (float)((ulong)*(undefined8 *)(lVar6 + 0xac) >> 0x20)) -
                              *(float *)(lVar6 + 0xb4) * (float)*(undefined8 *)(pGVar4 + 0x44),
                              (((float)((uint)*(float *)(lVar3 + 0xb4) ^ __LC6) *
                                (float)((ulong)*(undefined8 *)(pGVar4 + 0x4c) >> 0x20) +
                               (float)*(undefined8 *)(lVar3 + 0xac)) -
                              (float)*(undefined8 *)(lVar6 + 0xac)) -
                              (float)((uint)*(float *)(lVar6 + 0xb4) ^ __LC6) *
                              (float)((ulong)*(undefined8 *)(pGVar4 + 0x44) >> 0x20));
          ...
          *(float *)(pGVar4 + 0x28) = fVar8;
          ...
          if (this[0x48] != (GodotBodyPair2D)0x0) {
            ...
            *(ulong *)(lVar6 + 0xac) =
                 CONCAT44(fVar11 * fVar8 + (float)((ulong)*(undefined8 *)(lVar6 + 0xac) >> 0x20),
                          fVar11 * fVar10 + (float)*(undefined8 *)(lVar6 + 0xac));
            if (fVar13 != 0.0) {
              fVar8 = (float)*(undefined8 *)(lVar6 + 0x118);
              fVar11 = (float)((ulong)*(undefined8 *)(lVar6 + 0x118) >> 0x20);
              fVar10 = *(float *)(lVar6 + 0x10c);
              local_48 = CONCAT44(((float)((ulong)uVar1 >> 0x20) + fVar11) - fVar11,
                                  ((float)uVar1 + fVar8) - fVar8);
              fVar8 = (float)Vector2::cross((Vector2 *)&local_48);
              fVar8 = fVar8 * fVar10;
              fVar10 = fVar8;
              if ((0.0 < fVar13) && (fVar10 = fVar13, fVar8 <= fVar13)) {
                fVar10 = fVar8;
              }
          ...
          if (this[0x49] != (GodotBodyPair2D)0x0) {
            ...
            *(ulong *)(lVar6 + 0xac) =
                 CONCAT44(fVar10 * (float)((ulong)local_60 >> 0x20) +
                          (float)((ulong)*(undefined8 *)(lVar6 + 0xac) >> 0x20),
                          fVar10 * (float)local_60 + (float)*(undefined8 *)(lVar6 + 0xac));
            if (fVar13 != 0.0) {
              fVar8 = (float)*(undefined8 *)(lVar6 + 0x118);
              fVar11 = (float)((ulong)*(undefined8 *)(lVar6 + 0x118) >> 0x20);
              fVar10 = *(float *)(lVar6 + 0x10c);
          ...
          local_70 = CONCAT44(((*(float *)(lVar6 + 0xb4) * *(float *)(pGVar4 + 0x4c) +
                               (float)((ulong)*(undefined8 *)(lVar6 + 0xac) >> 0x20)) -
                              (float)((ulong)uVar1 >> 0x20)) - fVar10 * *(float *)(pGVar4 + 0x44),
                              (((float)((uint)*(float *)(lVar6 + 0xb4) ^ __LC6) *
                                *(float *)(pGVar4 + 0x50) + (float)*(undefined8 *)(lVar6 + 0xac)) -
                              (float)uVar1) -
                              (float)((uint)fVar10 ^ __LC6) * *(float *)(pGVar4 + 0x48));
          ...
          if (__LC8 < (double)ABS(*(float *)(pGVar4 + 0x38) - fVar10)) {
            ...
            *(float *)(pGVar4 + 0x2c) = fVar10;
            ...
            if (GVar2 != (GodotBodyPair2D)0x0) {
              *(ulong *)(lVar6 + 0xac) =
                   CONCAT44((float)((ulong)*(undefined8 *)(lVar6 + 0xac) >> 0x20) -
                            *(float *)(lVar6 + 0x104) * fVar10,
                            (float)*(undefined8 *)(lVar6 + 0xac) - *(float *)(lVar6 + 0x104) * fVar8
                           );
            }
            lVar3 = *(long *)(this + 0x38);
            if (this[0x49] != (GodotBodyPair2D)0x0) {
              *(ulong *)(lVar3 + 0xac) =
                   CONCAT44(*(float *)(lVar3 + 0x104) * fVar10 +
                            (float)((ulong)*(undefined8 *)(lVar3 + 0xac) >> 0x20),
                            *(float *)(lVar3 + 0x104) * fVar8 + (float)*(undefined8 *)(lVar3 + 0xac)
                           );
            }
          }
          else {
          ...
          *(float *)(pGVar4 + 0x20) = fVar7;
          ...
          if (((float)((uint)fVar8 ^ __LC6) <= fVar12) && (fVar9 = fVar8, fVar12 <= fVar8)) {
            fVar9 = fVar12;
          }
          *(float *)(pGVar4 + 0x24) = fVar9;
          ...
          if (GVar2 != (GodotBodyPair2D)0x0) {
            ...
            local_48 = CONCAT44(((float)((ulong)*(undefined8 *)(pGVar4 + 0x44) >> 0x20) + fVar11) -
                                fVar11,((float)*(undefined8 *)(pGVar4 + 0x44) + fVar9) - fVar9);
            fVar9 = (float)((ulong)*(undefined8 *)(lVar6 + 0x100) >> 0x20);
            *(ulong *)(lVar6 + 0xb8) =
                 CONCAT44((float)((ulong)*(undefined8 *)(lVar6 + 0xb8) >> 0x20) + fVar9 * fVar7,
                          (float)*(undefined8 *)(lVar6 + 0xb8) + fVar9 * fVar10);
          ...
          if (this[0x49] != (GodotBodyPair2D)0x0) {
            ...
            local_48 = CONCAT44(((float)((ulong)*(undefined8 *)(pGVar4 + 0x4c) >> 0x20) + fVar8) -
                                fVar8,((float)*(undefined8 *)(pGVar4 + 0x4c) + fVar7) - fVar7);
            fVar7 = (float)((ulong)*(undefined8 *)(lVar6 + 0x100) >> 0x20);
            *(ulong *)(lVar6 + 0xb8) =
                 CONCAT44((float)((ulong)*(undefined8 *)(lVar6 + 0xb8) >> 0x20) +
                          fVar7 * (float)((ulong)local_58 >> 0x20),
                          (float)*(undefined8 *)(lVar6 + 0xb8) + fVar7 * (float)local_58);
            fVar7 = (float)Vector2::cross((Vector2 *)&local_48);
            *(float *)(lVar6 + 0xc0) = fVar7 * fVar10 + *(float *)(lVar6 + 0xc0);
          }
          *(ulong *)(pGVar4 + 0x18) =
               CONCAT44((float)((ulong)*(undefined8 *)(pGVar4 + 0x18) >> 0x20) -
                        (float)((ulong)local_58 >> 0x20),
                        (float)*(undefined8 *)(pGVar4 + 0x18) - (float)local_58);
        }
        iVar5 = iVar5 + 1;
        pGVar4 = pGVar4 + 0x60;
...
/* CowData<GodotBody2D::Contact>::_copy_on_write() [clone .isra.0] */

void __thiscall CowData<GodotBody2D::Contact>::_copy_on_write(CowData<GodotBody2D::Contact> *this)
...
void __thiscall GodotBodyPair2D::~GodotBodyPair2D(GodotBodyPair2D *this)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GodotBodyPair2D::_validate_contacts() */

void __thiscall GodotBodyPair2D::_validate_contacts(GodotBodyPair2D *this)
...
LAB_00101070:
    do {
      ...
      if (this[lVar9 + 0xb1] != (GodotBodyPair2D)0x0) {
        ...
        ;
        fVar14 = fVar12 * (float)((ulong)uVar5 >> 0x20) + fVar14 * (float)((ulong)uVar4 >> 0x20) +
        ...
        if ((float)((uint)fVar3 ^ __LC6) <= fVar12) {
          local_a8 = CONCAT44((fVar12 * (float)((ulong)*(undefined8 *)
                                                        (this + (lVar11 * 3 + 3) * 0x20 + 0x10) >>
                                               0x20) + fVar14) - fVar16,
                              (fVar12 * (float)*(undefined8 *)
                                                (this + (lVar11 * 3 + 3) * 0x20 + 0x10) + fVar13) -
                              fVar15);
      ...
      if (iVar2 < *(int *)(this + 0x128)) {
        ...
        *(undefined8 *)(this + lVar9 * 0x20 + 0x20) = uVar4;
        uVar4 = *(undefined8 *)(this + lVar11 * 0x20 + 0x30);
        *(undefined8 *)(this + lVar9 * 0x20 + 0x28) = *(undefined8 *)(this + lVar11 * 0x20 + 0x28);
        *(undefined8 *)(this + lVar9 * 0x20 + 0x30) = uVar4;
        uVar4 = *(undefined8 *)(this + lVar11 * 0x20 + 0x40);
        *(undefined8 *)(this + lVar9 * 0x20 + 0x38) = *(undefined8 *)(this + lVar11 * 0x20 + 0x38);
        *(undefined8 *)(this + lVar9 * 0x20 + 0x40) = uVar4;
        uVar4 = *(undefined8 *)(this + lVar11 * 0x20 + 0x50);
        *(undefined8 *)(this + lVar9 * 0x20 + 0x48) = *(undefined8 *)(this + lVar11 * 0x20 + 0x48);
        *(undefined8 *)(this + lVar9 * 0x20 + 0x50) = uVar4;
        uVar4 = *(undefined8 *)(this + lVar11 * 0x20 + 0x60);
        *(undefined8 *)(this + lVar9 * 0x20 + 0x58) = *(undefined8 *)(this + lVar11 * 0x20 + 0x58);
        *(undefined8 *)(this + lVar9 * 0x20 + 0x60) = uVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GodotBodyPair2D::setup(float) */

undefined8 GodotBodyPair2D::setup(float param_1)

{
  ...
  if (((*(uint *)(lVar12 + 0x78) & *(uint *)(lVar9 + 0x7c)) == 0) &&
     ((*(uint *)(lVar9 + 0x78) & *(uint *)(lVar12 + 0x7c)) == 0)) {
LAB_00101671:
...
LAB_001016c0:
      _err_print_index_error
                ("get","./core/templates/cowdata.h",0xdb,0,lVar14,"p_index","size()","",false,true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_0010137f:
  ...
  if (iVar10 < 2) {
    ...
    GVar16 = (GodotBodyPair2D)
             ((*(uint *)(*(long *)(in_RDI + 0x30) + 0x78) &
              *(uint *)(*(long *)(in_RDI + 0x38) + 0x7c)) != 0);
  }
  in_RDI[0x48] = GVar16;
  iVar10 = GodotBody2D::get_mode();
  ...
  if ((iVar10 < 2) || ((*(uint *)(lVar9 + 0x78) & *(uint *)(lVar12 + 0x7c)) == 0)) {
    ...
    if (in_RDI[0x48] == (GodotBodyPair2D)0x0) {
      if (((*(long *)(lVar12 + 0x1f8) == 0) || (*(int *)(*(long *)(lVar12 + 0x1f8) + -8) < 1)) &&
         ((*(long *)(lVar9 + 0x1f8) == 0 || (*(int *)(*(long *)(lVar9 + 0x1f8) + -8) < 1))))
      goto LAB_00101671;
  ...
  *(ulong *)(in_RDI + 0x58) =
       CONCAT44((float)((ulong)*(undefined8 *)(lVar9 + 0x58) >> 0x20) -
                (float)((ulong)*(undefined8 *)(lVar12 + 0x58) >> 0x20),
                (float)*(undefined8 *)(lVar9 + 0x58) - (float)*(undefined8 *)(lVar12 + 0x58));
  ...
  if (*(int *)(in_RDI + 0x40) < 0) {
    ...
    local_68 = CONCAT44((float)((ulong)*(undefined8 *)(lVar12 + 0x58) >> 0x20) -
                        (float)((ulong)*(undefined8 *)(lVar9 + 0x58) >> 0x20),
                        (float)*(undefined8 *)(lVar12 + 0x58) - (float)*(undefined8 *)(lVar9 + 0x58)
                       );
    if (iVar10 < 0) {
...
LAB_0010187b:
              ...
              if (*(int *)(lVar9 + 0x1b8) == 2) {
                if (*(int *)(lVar9 + 0xa8) < 2) {
                  local_d0 = 0;
                  if (*(int *)(lVar9 + 0xa8) == 1) {
                    local_d0 = CONCAT44((float)((ulong)*(undefined8 *)(lVar9 + 0x58) >> 0x20) -
                                        (float)((ulong)*(undefined8 *)(lVar9 + 0x1d0) >> 0x20),
                                        (float)*(undefined8 *)(lVar9 + 0x58) -
                                        (float)*(undefined8 *)(lVar9 + 0x1d0));
                  }
                }
                else {
                  local_d0 = CONCAT44((float)((ulong)*(undefined8 *)(lVar9 + 0x1d0) >> 0x20) -
                                      (float)((ulong)*(undefined8 *)(lVar9 + 0x58) >> 0x20),
                                      (float)*(undefined8 *)(lVar9 + 0x1d0) -
                                      (float)*(undefined8 *)(lVar9 + 0x58));
                }
              ...
              if (*(int *)(lVar14 + 0x1b8) == 2) {
                if (*(int *)(lVar14 + 0xa8) < 2) {
                  ...
                  if (*(int *)(lVar14 + 0xa8) == 1) {
                    local_c8 = CONCAT44((float)((ulong)*(undefined8 *)(lVar14 + 0x58) >> 0x20) -
                                        (float)((ulong)*(undefined8 *)(lVar14 + 0x1d0) >> 0x20),
                                        (float)*(undefined8 *)(lVar14 + 0x58) -
                                        (float)*(undefined8 *)(lVar14 + 0x1d0));
                  }
                }
                else {
                  local_c8 = CONCAT44((float)((ulong)*(undefined8 *)(lVar14 + 0x1d0) >> 0x20) -
                                      (float)((ulong)*(undefined8 *)(lVar14 + 0x58) >> 0x20),
                                      (float)*(undefined8 *)(lVar14 + 0x1d0) -
                                      (float)*(undefined8 *)(lVar14 + 0x58));
                }
              }
              GVar16 = in_RDI[300];
              GVar5 = (GodotBodyPair2D)
                      GodotCollisionSolver2D::solve
                                (pGVar2,local_98,(Vector2 *)&local_d0,pGVar3,local_58,
                                 (Vector2 *)&local_c8,_add_contact,in_RDI,(Vector2 *)(in_RDI + 0x60)
                                 ,0.0,0.0);
              in_RDI[300] = GVar5;
              if (GVar5 == (GodotBodyPair2D)0x0) {
                in_RDI[0x12e] = (GodotBodyPair2D)0x0;
                if (((*(int *)(*(long *)(in_RDI + 0x30) + 0x1b8) == 1) &&
                    (in_RDI[0x48] != (GodotBodyPair2D)0x0)) ||
                   ((*(int *)(*(long *)(in_RDI + 0x38) + 0x1b8) == 1 &&
                    (in_RDI[0x49] != (GodotBodyPair2D)0x0)))) {
...
LAB_0010193c:
                    _err_print_index_error
                              ("is_shape_set_as_one_way_collision",
                               "modules/godot_physics_2d/godot_collision_object_2d.h",0x95,lVar12,
                               lVar9,"p_idx","shapes.size()","",false,true);
                    _err_flush_stdout();
                    /* WARNING: Does not return */
                    pcVar4 = (code *)invalidInstructionException();
                    (*pcVar4)();
...
LAB_00101616:
                  cVar6 = (**(code **)(*(long *)pGVar2 + 8))(pGVar2);
                  if (cVar6 != '\0') {
                    lVar12 = (long)*(int *)(in_RDI + 0x44);
...
LAB_00101838:
        _err_print_index_error
                  ("get_shape","modules/godot_physics_2d/godot_collision_object_2d.h",0x75,lVar12,
...
LAB_001017cd:
  _err_print_index_error
            ("get_shape_transform","modules/godot_physics_2d/godot_collision_object_2d.h",0x79,
             lVar11,lVar12,"p_index","shapes.size()","",false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar4 = (code *)invalidInstructionException();
  (*pcVar4)();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GodotBodyPair2D::_test_ccd(float, GodotBody2D*, int, Transform2D const&, GodotBody2D*, int,
   Transform2D const&) */

undefined4
GodotBodyPair2D::_test_ccd
          (float param_1,GodotBody2D *param_2,int param_3,Transform2D *param_4,GodotBody2D *param_5,
          int param_6,Transform2D *param_7)

{
  ...
  local_c8 = CONCAT44((float)((ulong)*(undefined8 *)(lVar6 + 0xb8) >> 0x20) * param_1,
                      (float)*(undefined8 *)(lVar6 + 0xb8) * param_1);
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
...
LAB_00101e90:
  ...
  if ((int)param_4 < 0) {
    ...
    local_58[0] = CONCAT44(param_1 * (float)((ulong)*(undefined8 *)(lVar7 + 0xb8) >> 0x20),
                           param_1 * (float)*(undefined8 *)(lVar7 + 0xb8));
    ...
    if (lVar9 != 0) {
      ...
      fVar14 = (float)*(undefined8 *)param_5 * (float)local_88 +
               fVar16 * (float)*(undefined8 *)(param_5 + 8) + (float)*(undefined8 *)(param_5 + 0x10)
      ;
      fVar16 = (float)((ulong)*(undefined8 *)param_5 >> 0x20) * (float)local_88 +
               fVar16 * (float)((ulong)*(undefined8 *)(param_5 + 8) >> 0x20) +
      ...
      local_a8 = CONCAT44(fVar14 * fVar22 + fVar20 * fVar16 + fVar21,
                          fVar14 * (float)local_58[0] + (float)local_58[1] * fVar16 +
                          (float)local_58[2]);
      local_b0 = CONCAT44(fVar17 * fVar22 + fVar19 * fVar20 + fVar21,
                          fVar17 * (float)local_58[0] + fVar19 * (float)local_58[1] +
                          (float)local_58[2]);
      lVar5 = lVar11;
      if ((int)param_7 < 0) {
        if (lVar9 != 0) {
...
LAB_00101fae:
              _err_print_index_error
                        ("is_shape_set_as_one_way_collision",
                         "modules/godot_physics_2d/godot_collision_object_2d.h",0x95,lVar11,lVar9,
                         "p_idx","shapes.size()","",false,true);
              _err_flush_stdout();
                    /* WARNING: Does not return */
          ...
          local_90 = CONCAT44((float)local_a0 * SUB84(local_78._0_8_,4) +
                              fVar14 * SUB84(local_78._8_8_,4) + SUB84(local_78._16_8_,4),
                              (float)local_a0 * (float)local_78._0_8_ +
                              fVar14 * (float)local_78._8_8_ + (float)local_78._16_8_);
          fVar14 = (float)Vector2::distance_to((Vector2 *)&local_90);
          fVar14 = (float)((double)(local_d0 - local_d4) * __LC32 + (double)fVar14) / param_1;
          *(ulong *)(lVar6 + 0xb8) =
               CONCAT44((float)((ulong)local_c0 >> 0x20) * fVar14,(float)local_c0 * fVar14);
          goto LAB_00101e90;
        }
        goto LAB_00101f10;
      }
...
LAB_00101ee7:
  _err_print_index_error
            ("get_shape","modules/godot_physics_2d/godot_collision_object_2d.h",0x75,lVar5,lVar8,
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GodotBodyPair2D::pre_solve(float) */

GodotBodyPair2D __thiscall GodotBodyPair2D::pre_solve(GodotBodyPair2D *this,float param_1)
...
LAB_00102132:
        ...
        if (0 < *(int *)(this + 0x128)) {
          ...
          do {
            ...
            fVar43 = fVar24 * (float)*(undefined8 *)(lVar10 + 0x48) +
                     (float)*(undefined8 *)(lVar10 + 0x50) * fVar41;
            fVar44 = fVar24 * (float)((ulong)*(undefined8 *)(lVar10 + 0x48) >> 0x20) +
                     (float)((ulong)*(undefined8 *)(lVar10 + 0x50) >> 0x20) * fVar41;
            fVar24 = (float)*(undefined8 *)((Vector2 *)pGVar23 + -0x34);
            fVar41 = (float)((ulong)*(undefined8 *)((Vector2 *)pGVar23 + -0x34) >> 0x20);
            fVar39 = (float)*(undefined8 *)(lVar11 + 0x50) * fVar41 +
                     (float)*(undefined8 *)(lVar11 + 0x48) * fVar24 +
                     (float)*(undefined8 *)(this + 0x58);
            fVar41 = (float)((ulong)*(undefined8 *)(lVar11 + 0x50) >> 0x20) * fVar41 +
                     (float)((ulong)*(undefined8 *)(lVar11 + 0x48) >> 0x20) * fVar24 +
                     (float)((ulong)*(undefined8 *)(this + 0x58) >> 0x20);
...
LAB_00102e38:
                    _err_print_index_error
                              ("operator[]","./core/templates/vector.h",0x38,lVar19,lVar17,"p_index"
                  ...
                  *(ulong *)(*(long *)(lVar16 + 0x6100) + lVar19 * 8) =
                       CONCAT44((float)((ulong)uVar33 >> 0x20) + fVar44,(float)uVar33 + fVar43);
                  ...
                  if (lVar17 == 0) {
                    ...
                    if (lVar19 < lVar17) {
                      ...
                      *(ulong *)(*(long *)(lVar2 + 0x6100) + lVar19 * 8) =
                           CONCAT44((float)((ulong)uVar33 >> 0x20) + fVar41,(float)uVar33 + fVar39);
                    }
                  }
                }
              }
              ...
              *(float *)((Vector2 *)pGVar23 + 8) =
                   (fVar39 - *(float *)(lVar16 + 0x118)) - *(float *)(this + 0x58);
              ...
              *(float *)((Vector2 *)pGVar23 + -0x14) =
                   _LC33 / ((fVar28 - fVar26 * fVar26) * fVar34 +
                            (fVar27 - fVar25 * fVar25) * fVar32 + fVar42 + fVar31);
              ...
              *(ulong *)((Vector2 *)pGVar23 + -0x2c) =
                   CONCAT44((float)((ulong)*(undefined8 *)((Vector2 *)pGVar23 + -0x2c) >> 0x20) -
                            fVar26,(float)*(undefined8 *)((Vector2 *)pGVar23 + -0x2c) - fVar25);
              if ((lVar19 != 0) || (*(long *)(lVar17 + 0x1f8) != 0)) {
                fVar25 = (float)*(undefined8 *)(lVar17 + 0xb8) +
                         (float)((ulong)*(undefined8 *)((Vector2 *)pGVar23 + 8) >> 0x20) *
                         (float)((uint)*(float *)(lVar17 + 0xc0) ^ __LC6);
                fVar26 = (float)((ulong)*(undefined8 *)(lVar17 + 0xb8) >> 0x20) +
                         (float)*(undefined8 *)((Vector2 *)pGVar23 + 8) * *(float *)(lVar17 + 0xc0);
                uVar33 = CONCAT44(*(float *)(lVar16 + 0xc0) * (float)*(undefined8 *)pGVar23 +
                                  (float)((ulong)*(undefined8 *)(lVar16 + 0xb8) >> 0x20),
                                  (float)((uint)*(float *)(lVar16 + 0xc0) ^ __LC6) *
                                  (float)((ulong)*(undefined8 *)pGVar23 >> 0x20) +
                                  (float)*(undefined8 *)(lVar16 + 0xb8));
                if ((lVar19 != 0) && (iVar18 = (int)*(undefined8 *)(lVar19 + -8), iVar18 != 0)) {
                  ...
                  CowData<GodotBody2D::Contact>::_copy_on_write
                            ((CowData<GodotBody2D::Contact> *)(lVar16 + 0x1f8));
...
LAB_00102726:
                      if (fVar40 < fVar24) goto LAB_00102cad;
                    }
                  }
                }
...
LAB_00102820:
                      if (fVar28 < fVar24) goto LAB_00102d4b;
                    }
                  }
                }
              }
              if (this[0x12f] == (GodotBodyPair2D)0x0) {
                if (this[0x48] != (GodotBodyPair2D)0x0) {
                  ...
                  local_58[0] = CONCAT44(((float)((ulong)*(undefined8 *)pGVar23 >> 0x20) + fVar39) -
                                         fVar39,((float)*(undefined8 *)pGVar23 + fVar41) - fVar41);
                  fVar41 = (float)((ulong)*(undefined8 *)(lVar16 + 0x100) >> 0x20);
                  *(ulong *)(lVar16 + 0xb8) =
                       CONCAT44((float)((ulong)*(undefined8 *)(lVar16 + 0xb8) >> 0x20) +
                                fVar41 * fVar44,
                                (float)*(undefined8 *)(lVar16 + 0xb8) + fVar41 * fVar43);
                ...
                if (this[0x49] != (GodotBodyPair2D)0x0) {
                  ...
                  fVar41 = (float)*(undefined8 *)(lVar16 + 0x118);
                  fVar39 = (float)((ulong)*(undefined8 *)(lVar16 + 0x118) >> 0x20);
                  local_58[0] = CONCAT44(((float)((ulong)*(undefined8 *)((Vector2 *)pGVar23 + 8) >>
                                                 0x20) + fVar39) - fVar39,
                                         ((float)*(undefined8 *)((Vector2 *)pGVar23 + 8) + fVar41) -
                                         fVar41);
                  fVar41 = (float)((ulong)*(undefined8 *)(lVar16 + 0x100) >> 0x20);
                  *(ulong *)(lVar16 + 0xb8) =
                       CONCAT44((float)((ulong)*(undefined8 *)(lVar16 + 0xb8) >> 0x20) +
                                fVar41 * (float)((ulong)local_98[0] >> 0x20),
                                (float)*(undefined8 *)(lVar16 + 0xb8) + fVar41 * (float)local_98[0])
                  ;
                  fVar41 = (float)Vector2::cross((Vector2 *)local_58);
                  *(float *)(lVar16 + 0xc0) = fVar41 * fVar24 + *(float *)(lVar16 + 0xc0);
                }
                ...
                if (fVar24 < 0.0) {
                  *(undefined4 *)((Vector2 *)pGVar23 + 0x10) = 0;
                  ...
                  local_58[0] = CONCAT44(((*(float *)(lVar16 + 0xcc) *
                                           (float)*(undefined8 *)((Vector2 *)pGVar23 + 8) +
                                          (float)((ulong)*(undefined8 *)(lVar16 + 0xc4) >> 0x20)) -
                                         (float)((ulong)*(undefined8 *)(lVar17 + 0xc4) >> 0x20)) -
                                         *(float *)(lVar17 + 0xcc) * (float)*(undefined8 *)pGVar23,
                                         (((float)((uint)*(float *)(lVar16 + 0xcc) ^ __LC6) *
                                           (float)((ulong)*(undefined8 *)((Vector2 *)pGVar23 + 8) >>
                                                  0x20) + (float)*(undefined8 *)(lVar16 + 0xc4)) -
                                         (float)*(undefined8 *)(lVar17 + 0xc4)) -
                                         (float)((uint)*(float *)(lVar17 + 0xcc) ^ __LC6) *
                                         (float)((ulong)*(undefined8 *)pGVar23 >> 0x20));
                  fVar41 = (float)Vector2::dot((Vector2 *)local_58);
                  *(float *)((Vector2 *)pGVar23 + 0x10) = fVar41 * fVar24;
                }
LAB_00102926:
                ((Vector2 *)pGVar23)[-4] = (Vector2)0x1;
                local_e6 = GVar7;
              }
              else {
...
LAB_00102db5:
      _err_print_index_error
                ("get_shape","modules/godot_physics_2d/godot_collision_object_2d.h",0x75,lVar17,
                 lVar19,"p_index","shapes.size()","",false,true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
      pcVar12 = (code *)invalidInstructionException();
      (*pcVar12)();
...
LAB_00102e88:
        ...
        local_68 = CONCAT44((float)((ulong)*(undefined8 *)(lVar19 + 0x58) >> 0x20) -
                            (float)((ulong)*(undefined8 *)(lVar10 + 0x58) >> 0x20),
                            (float)*(undefined8 *)(lVar19 + 0x58) -
                            (float)*(undefined8 *)(lVar10 + 0x58));
        if (*(int *)(this + 0x44) < 0) goto LAB_00102e88;
        if (lVar16 != 0) {
          lVar16 = *(long *)(lVar16 + -8);
          if (lVar16 <= lVar17) goto LAB_00102e95;
          Transform2D::operator*((Transform2D *)local_58,(Transform2D *)&local_78);
          if ((*(int *)(*(long *)(this + 0x30) + 0x1b8) == 1) &&
             (this[0x48] != (GodotBodyPair2D)0x0)) {
            _test_ccd(param_1,(GodotBody2D *)this,(int)*(long *)(this + 0x30),
                      (Transform2D *)(ulong)*(uint *)(this + 0x40),(GodotBody2D *)local_98,
                      (int)*(undefined8 *)(this + 0x38),(Transform2D *)(ulong)*(uint *)(this + 0x44)
                     );
          }
          if ((*(int *)(*(long *)(this + 0x38) + 0x1b8) == 1) &&
             (this[0x49] != (GodotBodyPair2D)0x0)) {
            _test_ccd(param_1,(GodotBody2D *)this,(int)*(long *)(this + 0x38),
                      (Transform2D *)(ulong)*(uint *)(this + 0x44),(GodotBody2D *)local_58,
                      (int)*(undefined8 *)(this + 0x30),(Transform2D *)(ulong)*(uint *)(this + 0x40)
                     );
          }
          goto LAB_0010296f;
        }
...
LAB_00102e95:
      _err_print_index_error
                ("get_shape_transform","modules/godot_physics_2d/godot_collision_object_2d.h",0x79,
                 lVar17,lVar16,"p_index","shapes.size()","",false,true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
      pcVar12 = (code *)invalidInstructionException();
      (*pcVar12)();
...
/* combine_bounce(GodotBody2D*, GodotBody2D*) */

float combine_bounce(GodotBody2D *param_1,GodotBody2D *param_2)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* combine_friction(GodotBody2D*, GodotBody2D*) */

ulong combine_friction(GodotBody2D *param_1,GodotBody2D *param_2)
...
/* GodotBodyPair2D::GodotBodyPair2D(GodotBody2D*, int, GodotBody2D*, int) */

void __thiscall
GodotBodyPair2D::GodotBodyPair2D
          (GodotBodyPair2D *this,GodotBody2D *param_1,int param_2,GodotBody2D *param_3,int param_4)

{
  ...
  *(undefined ***)this = &PTR_setup_001034b0;
  ...
  do {
    *(undefined8 *)pGVar4 = 0;
    pGVar5 = pGVar4 + 0x60;
    *(undefined8 *)(pGVar4 + 8) = 0;
    *(undefined8 *)(pGVar4 + 0x10) = 0;
    *(undefined8 *)(pGVar4 + 0x18) = 0;
...
/* CowData<GodotBody2D::Contact>::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<GodotBody2D::Contact>::_copy_on_write(void)

...
LAB_00103a9f:
  ...
  goto LAB_00101d0c;
switchD_00103141_caseD_80:
  local_c0 = (ushort *)0x0;
  uVar20 = 1;
  goto switchD_00100677_caseD_23;
  while (uVar30 = *(ulong *)(lVar23 + 0x78), uVar30 != 0xffffffffffffffff) {
LAB_00104584:
    lVar23 = (uVar30 + param_5[6]) - param_4;
    if (*(uint *)(uVar30 + param_5[6] + 0x34) == (uVar20 | 0x40000)) {
      if (puVar31[10] == *(ulong *)(lVar23 + 0x50)) {
        uVar30 = *(ulong *)(param_6 + 0xa8);
        if ((uVar30 != *(ulong *)(lVar23 + 0x68)) || ((*(byte *)(param_6 + 0xd6) & 4) != 0))
        goto LAB_001045ab;
        uVar20 = 0xffffffcc;
        goto LAB_00101d0c;
      }
...
LAB_001045ab:
  puVar31[0xd] = uVar30;
  puVar31[1] = uVar9;
  *(uint *)(puVar31 + 7) = uVar20 | 0x40000;
LAB_00100e40:
  uVar20 = (uint)puVar31[7];
  uVar17 = *(ushort *)puVar31[1];
  *(undefined1 *)(puVar31 + 9) = 0xb;
  param_2 = (ushort *)puVar31[1] + (byte)(&_pcre2_OP_lengths_16)[uVar17];
  puVar21 = puVar31;
LAB_00101cc8:
  puVar31 = (ulong *)((long)puVar21 + param_4);
  if (param_4 + (long)puVar31 < local_e0) {
LAB_00105227:
    memcpy(puVar31 + 10,puVar21 + 10,param_4 - 0x50);
    *(int *)(puVar31 + 6) = (int)puVar21[6] + 1;
    local_d8 = puVar31;
    goto LAB_00100550;
  }
  uVar9 = param_5[7];
  sVar32 = (long)puVar31 - param_5[6];
...
LAB_00109996:
  sVar2 = *(short *)(param_6 + 0x60);
  if ((sVar2 != 0) && ((*(ushort **)(param_6 + 0xa0) < puVar8 || (*(int *)(param_6 + 0x30) != 0))))
  {
    *(undefined4 *)(param_6 + 0x28) = 1;
    goto joined_r0x001099c4;
  }
switchD_001005dc_caseD_a3:
  uVar20 = 0;
switchD_00100677_caseD_23:
  if (*(ulong *)(param_6 + 0xa8) < puVar31[10]) {
    *(ulong *)(param_6 + 0xa8) = puVar31[10];
  }
  if ((int)puVar31[6] == 0) goto LAB_00101d0c;
  puVar31 = (ulong *)((long)puVar31 - puVar31[4]);
  puVar14 = (uint *)(*(long *)(param_6 + 0xf8) + 0x68);
  *puVar14 = *puVar14 | 2;
  switch((char)puVar31[9]) {
  default:
    goto switchD_001005dc_caseD_62;
  case '\x01':
    if (uVar20 == 0) {
...
switchD_00102926_caseD_d:
  ...
  case -0x23:
    ...
    goto switchD_00100677_caseD_23;
  case -0x22:
    goto switchD_00100677_caseD_de;
  case -0x21:
    if (uVar20 != 0) goto switchD_00100677_caseD_23;
    uVar9 = puVar31[7];
    *(uint *)(puVar31 + 7) = (uint)uVar9 + 1;

...
/* tvg::Shape::type() const */

undefined8 tvg::Shape::type(void)
...
void __thiscall tvg::Shape::~Shape(Shape *this)
...
Shape * __thiscall tvg::Shape::gen(Shape *this)
...
/* tvg::Shape::identifier() */

undefined8 tvg::Shape::identifier(void)
...
undefined8 __thiscall tvg::Shape::reset(Shape *this)
...
/* tvg::Shape::pathCommands(tvg::PathCommand const**) const */

undefined4 __thiscall tvg::Shape::pathCommands(Shape *this,PathCommand **param_1)
...
/* tvg::Shape::pathCoords(tvg::Point const**) const */

undefined4 __thiscall tvg::Shape::pathCoords(Shape *this,Point **param_1)
...
/* tvg::Shape::appendPath(tvg::PathCommand const*, unsigned int, tvg::Point const*, unsigned int) */

undefined8 __thiscall
tvg::Shape::appendPath(Shape *this,PathCommand *param_1,uint param_2,Point *param_3,uint param_4)
...
/* tvg::Shape::moveTo(float, float) */

undefined8 __thiscall tvg::Shape::moveTo(Shape *this,float param_1,float param_2)
...
/* tvg::Shape::lineTo(float, float) */

undefined8 __thiscall tvg::Shape::lineTo(Shape *this,float param_1,float param_2)
...
/* tvg::Shape::cubicTo(float, float, float, float, float, float) */

undefined8 __thiscall
tvg::Shape::cubicTo(Shape *this,float param_1,float param_2,float param_3,float param_4,
...
undefined8 __thiscall tvg::Shape::close(Shape *this)
...
/* tvg::Shape::appendCircle(float, float, float, float) */

undefined8 __thiscall
tvg::Shape::appendCircle(Shape *this,float param_1,float param_2,float param_3,float param_4)
...
/* tvg::Shape::appendArc(float, float, float, float, float, bool) */

undefined8 __thiscall
tvg::Shape::appendArc
          (Shape *this,float param_1,float param_2,float param_3,float param_4,float param_5,
          bool param_6)
...
LAB_00100a3a:
    ...
    do {
      ...
      Impl::cubicTo(*(Impl **)(this + 0x18),(fVar11 - fVar12 * fVar15) + param_1,
                    fVar12 * fVar11 + fVar15 + param_2,fVar14 * fVar12 + fVar16 + param_1,
                    (fVar14 - fVar16 * fVar12) + param_2,param_1 + fVar16,param_2 + fVar14);
      fVar11 = fVar16;
      fVar15 = fVar14;
    } while (iVar7 < iVar9);
    puVar8 = *(undefined8 **)(this + 0x18);
...
/* tvg::Shape::appendRect(float, float, float, float, float, float) */
...
/* tvg::Shape::fill(unsigned char, unsigned char, unsigned char, unsigned char) */

undefined8 __thiscall
tvg::Shape::fill(Shape *this,uchar param_1,uchar param_2,uchar param_3,uchar param_4)

{
  ...
  if ((((*(uchar *)(lVar2 + 0x30) != param_1) || (*(uchar *)(lVar2 + 0x31) != param_2)) ||
      (*(uchar *)(lVar2 + 0x32) != param_3)) || (*(uchar *)(lVar2 + 0x33) != param_4)) {
...
/* tvg::Shape::fill(std::unique_ptr<tvg::Fill, std::default_delete<tvg::Fill> >) */

undefined8 __thiscall tvg::Shape::fill(Shape *this,long *param_2)
...
/* tvg::Shape::fillColor(unsigned char*, unsigned char*, unsigned char*, unsigned char*) const */

undefined8 __thiscall
tvg::Shape::fillColor(Shape *this,uchar *param_1,uchar *param_2,uchar *param_3,uchar *param_4)
...
/* tvg::Shape::fill() const */

undefined8 __thiscall tvg::Shape::fill(Shape *this)
...
/* tvg::Shape::order(bool) */

undefined8 __thiscall tvg::Shape::order(Shape *this,bool param_1)
...
/* tvg::Shape::stroke(float) */

undefined8 __thiscall tvg::Shape::stroke(Shape *this,float param_1)
...
/* tvg::Shape::strokeWidth() const */

undefined4 __thiscall tvg::Shape::strokeWidth(Shape *this)
...
/* tvg::Shape::stroke(unsigned char, unsigned char, unsigned char, unsigned char) */

undefined8 __thiscall
tvg::Shape::stroke(Shape *this,uchar param_1,uchar param_2,uchar param_3,uchar param_4)
...
/* tvg::Shape::strokeColor(unsigned char*, unsigned char*, unsigned char*, unsigned char*) const */

undefined8 __thiscall
tvg::Shape::strokeColor(Shape *this,uchar *param_1,uchar *param_2,uchar *param_3,uchar *param_4)
...
/* tvg::Shape::stroke(std::unique_ptr<tvg::Fill, std::default_delete<tvg::Fill> >) */

undefined8 __thiscall tvg::Shape::stroke(Shape *this,long *param_2)
...
/* tvg::Shape::strokeFill() const */

long __thiscall tvg::Shape::strokeFill(Shape *this)
...
/* tvg::Shape::stroke(float const*, unsigned int) */

undefined8 __thiscall tvg::Shape::stroke(Shape *this,float *param_1,uint param_2)
...
/* tvg::Shape::strokeDash(float const**) const */

undefined4 __thiscall tvg::Shape::strokeDash(Shape *this,float **param_1)
...
/* tvg::Shape::stroke(tvg::StrokeCap) */

undefined8 __thiscall tvg::Shape::stroke(Shape *this,undefined4 param_2)
...
/* tvg::Shape::stroke(tvg::StrokeJoin) */
...
/* tvg::Shape::strokeMiterlimit(float) */

undefined8 __thiscall tvg::Shape::strokeMiterlimit(Shape *this,float param_1)
...
/* tvg::Shape::strokeCap() const */

undefined4 __thiscall tvg::Shape::strokeCap(Shape *this)
...
/* tvg::Shape::strokeJoin() const */

undefined4 __thiscall tvg::Shape::strokeJoin(Shape *this)
...
/* tvg::Shape::strokeMiterlimit() const */

undefined4 __thiscall tvg::Shape::strokeMiterlimit(Shape *this)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* tvg::Shape::strokeTrim(float, float, bool) */

undefined8 __thiscall tvg::Shape::strokeTrim(Shape *this,float param_1,float param_2,bool param_3)

{
  ...
  if (((_LC12 < (float)((uint)(fVar3 - param_1) & _LC5)) ||
      (_LC12 < (float)((uint)(*(float *)(pauVar2[3] + 4) - param_2) & _LC5))) ||
     (param_3 != (bool)pauVar2[3][8])) {
    pauVar2[3][8] = param_3;
...
/* tvg::Shape::fill(tvg::FillRule) */

undefined8 __thiscall tvg::Shape::fill(Shape *this,undefined4 param_2)
...
/* tvg::Shape::fillRule() const */

undefined4 __thiscall tvg::Shape::fillRule(Shape *this)
...
/* tvg::Shape::Impl::cubicTo(float, float, float, float, float, float) */

void __thiscall
tvg::Shape::Impl::cubicTo

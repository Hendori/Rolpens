    ...
    do {
      ...
      if (lVar3 != 0) {
        while (*(int *)(lVar3 + uVar25 * 4) == 0) {
          uVar25 = uVar25 + 1;
          if (uVar25 == uVar2) goto LAB_00100465;
          uVar19 = uVar25 & 0xffffffff;
        }
      }
      ...
      if (lVar13 == 0) {
        if (lVar5 == 0) {
          if ((lVar7 != 0) && (uVar1 != 0)) goto LAB_001003f6;
        }
...

{
  ...
  *(undefined ***)this = &PTR__Geometry_00100d20;
  plVar2 = *(long **)(this + 0x10);
  if (*(code **)(*plVar2 + 0x18) != RefCount::refDec) {
                    /* WARNING: Could not recover jumptable at 0x00100598. Too many branches */
  ...
  *plVar1 = *plVar1 + -1;
  ...
  if ((plVar2 != (long *)0x0) && (*plVar1 == 0)) {
                    /* WARNING: Could not recover jumptable at 0x0010058a. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(*plVar2 + 8))();
    return;
  }
  ...
  *(float *)(this + 0x28) = (float)(param_5 - 1);
  if (UNRECOVERED_JUMPTABLE == RefCount::refInc) {
    ...
    return;
                    ...
                    /* WARNING: Could not recover jumptable at 0x001006a3. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (*(code **)(param_2 + 0x20) == (code *)0x0) {
    ...
    uVar12 = 0;
    if (pcVar14 != (code *)0x0) goto LAB_00100771;
  }
  else {
...

{
  ...
  *(long *)pRVar1 = *(long *)pRVar1 + -1;
  ...
  if ((this != (RefCount *)0x0) && (*(long *)pRVar1 == 0)) {
                    /* WARNING: Could not recover jumptable at 0x00100c99. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(*(long *)this + 8))();
    return;
  }

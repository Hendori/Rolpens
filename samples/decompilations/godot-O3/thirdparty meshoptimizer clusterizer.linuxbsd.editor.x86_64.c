...
LAB_0010119d:
  pKVar9 = (KDNode *)(*(code *)meshopt_Allocator::StorageT<void>::allocate)((long)puVar19 << 4);
  local_108[local_48] = (long)pKVar9;
  local_48 = local_48 + 1;
  meshopt::kdtreeBuild
            (0,pKVar9,(ulong)pCVar7,pfVar8,(ulong)puVar19,puVar29,in_stack_fffffffffffffdd8,
             (ulong)pCVar7);
...
LAB_001014b0:
      ...
      uVar23 = (ulong)uVar13;
      if ((param_10 <
           (uint)(__s_00[uVar23] == 0xff) +
           (uint)(__s_00[uVar30] == 0xff) + (uint)(__s_00[uVar20] == 0xff) + (int)pmVar26) ||
         (param_11 <= uVar18)) {
        fVar36 = (float)meshopt::getNeighborTriangle

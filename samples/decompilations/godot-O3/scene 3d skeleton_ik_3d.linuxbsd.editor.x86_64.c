  ...
  if (lVar6 < 0) {
    ...
    if (puVar11 != (undefined8 *)0x0) {
      ...
      *puVar11 = 1;
      ...
      if ((lVar6 != 0) && (iVar4 = *(int *)(lVar6 + -8) + -1, -1 < iVar4)) goto LAB_00104a3a;
      uVar7 = 1;
LAB_00104e92:
      plVar1 = puVar8 + -2;
      LOCK();
...
LAB_00104e07:
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,lVar17,lVar15,"p_index","size()","",false
                   ,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar3 = (code *)invalidInstructionException();
...
LAB_00104e8b:
        uVar7 = 0;
LAB_00104e8d:
        if (puVar8 != (undefined8 *)0x0) goto LAB_00104e92;
        goto LAB_00104ead;
      }
...
LAB_00104b46:
        _err_print_index_error
                  ("operator[]","./core/templates/vector.h",0x38,lVar17,lVar6,"p_index",
                   "((Vector<T> *)(this))->_cowdata.size()","",false,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar3 = (code *)invalidInstructionException();

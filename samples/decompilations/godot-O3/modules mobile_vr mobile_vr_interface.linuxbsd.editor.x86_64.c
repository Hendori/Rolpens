...
/* MobileVRInterface::get_view_count() */

undefined8 MobileVRInterface::get_view_count(void)
...
/* MobileVRInterface::set_eye_height(double) */

void __thiscall MobileVRInterface::set_eye_height(MobileVRInterface *this,double param_1)
...
/* MobileVRInterface::get_eye_height() const */

undefined8 __thiscall MobileVRInterface::get_eye_height(MobileVRInterface *this)
...
/* MobileVRInterface::set_offset_rect(Rect2 const&) */

void __thiscall MobileVRInterface::set_offset_rect(MobileVRInterface *this,Rect2 *param_1)
...
/* MobileVRInterface::get_offset_rect() const */

undefined1  [16] __thiscall MobileVRInterface::get_offset_rect(MobileVRInterface *this)
...
/* MobileVRInterface::set_iod(double) */

void __thiscall MobileVRInterface::set_iod(MobileVRInterface *this,double param_1)
...
/* MobileVRInterface::get_iod() const */

undefined8 __thiscall MobileVRInterface::get_iod(MobileVRInterface *this)
...
/* MobileVRInterface::set_display_width(double) */

void __thiscall MobileVRInterface::set_display_width(MobileVRInterface *this,double param_1)
...
/* MobileVRInterface::get_display_width() const */

undefined8 __thiscall MobileVRInterface::get_display_width(MobileVRInterface *this)
...
/* MobileVRInterface::set_display_to_lens(double) */

void __thiscall MobileVRInterface::set_display_to_lens(MobileVRInterface *this,double param_1)
...
/* MobileVRInterface::get_display_to_lens() const */

undefined8 __thiscall MobileVRInterface::get_display_to_lens(MobileVRInterface *this)
...
/* MobileVRInterface::set_oversample(double) */

void __thiscall MobileVRInterface::set_oversample(MobileVRInterface *this,double param_1)
...
/* MobileVRInterface::get_oversample() const */

undefined8 __thiscall MobileVRInterface::get_oversample(MobileVRInterface *this)
...
/* MobileVRInterface::set_k1(double) */

void __thiscall MobileVRInterface::set_k1(MobileVRInterface *this,double param_1)
...
/* MobileVRInterface::get_k1() const */

undefined8 __thiscall MobileVRInterface::get_k1(MobileVRInterface *this)
...
/* MobileVRInterface::set_k2(double) */

void __thiscall MobileVRInterface::set_k2(MobileVRInterface *this,double param_1)
...
/* MobileVRInterface::get_k2() const */

undefined8 __thiscall MobileVRInterface::get_k2(MobileVRInterface *this)
...
/* MobileVRInterface::get_tracking_status() const */

undefined4 __thiscall MobileVRInterface::get_tracking_status(MobileVRInterface *this)
...
/* MobileVRInterface::is_initialized() const */

MobileVRInterface __thiscall MobileVRInterface::is_initialized(MobileVRInterface *this)
...
/* MobileVRInterface::set_play_area_mode(XRInterface::PlayAreaMode) */

bool __thiscall MobileVRInterface::set_play_area_mode(undefined8 param_1,int param_2)
...
/* MobileVRInterface::get_play_area_mode() const */

undefined8 MobileVRInterface::get_play_area_mode(void)
...
/* MobileVRInterface::get_name() const */

MobileVRInterface * __thiscall MobileVRInterface::get_name(MobileVRInterface *this)
...
/* MobileVRInterface::get_vrs_min_radius() const */

void MobileVRInterface::get_vrs_min_radius(void)
...
/* MobileVRInterface::set_vrs_min_radius(float) */

void MobileVRInterface::set_vrs_min_radius(float param_1)
...
/* MobileVRInterface::get_vrs_strength() const */

void MobileVRInterface::get_vrs_strength(void)
...
/* MobileVRInterface::set_vrs_strength(float) */

void MobileVRInterface::set_vrs_strength(float param_1)
...
/* MobileVRInterface::get_projection_for_view(unsigned int, double, double, double) */

MobileVRInterface * __thiscall
  ...
  if (iVar1 == 0) {
    ...
    *(double *)(lVar2 + 0x208) = param_2;
    Projection::set_for_hmd
              ((int)this,(float)param_2,(float)*(double *)(lVar2 + 0x1c8),
               (float)*(double *)(lVar2 + 0x1d0),(float)*(double *)(lVar2 + 0x1d8),
               (float)*(double *)(lVar2 + 0x1e0),(float)param_3,(float)param_4);
...
/* MobileVRInterface::get_render_target_size() */

undefined8 __thiscall MobileVRInterface::get_render_target_size(MobileVRInterface *this)

{
  ...
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
    return CONCAT44((float)(dVar1 * (double)(float)((ulong)uVar3 >> 0x20)),
                    (float)(dVar4 * (double)(float)uVar3));
  }
                    /* WARNING: Subroutine does not return */
  __stack_chk_fail();
}
...
/* MobileVRInterface::get_camera_transform() */

void MobileVRInterface::get_camera_transform(void)

{
  ...
  *(undefined1 (*) [16])(in_RDI + 0x10) = ZEXT416(uVar1);
  ...
  if (lVar3 == 0) {
    _err_print_error("get_camera_transform","modules/mobile_vr/mobile_vr_interface.cpp",0x1c5,
...
/* MobileVRInterface::get_transform_for_view(unsigned int, Transform3D const&) */

undefined1 (*) [16] MobileVRInterface::get_transform_for_view(uint param_1,Transform3D *param_2)

{
  ...
  *pauVar10 = ZEXT416(uVar7);
  ...
  if (lVar9 == 0) {
    _err_print_error("get_transform_for_view","modules/mobile_vr/mobile_vr_interface.cpp",0x1da,
                     "Parameter \"xr_server\" is null.",0,0);
  }
    ...
    *(undefined8 *)(pauVar10[2] + 8) = uVar6;
    ...
    if (in_EDX == 0) {
      *(uint *)(pauVar10[2] + 4) =
           (uint)(float)(_LC13 * *(double *)(param_2 + 0x1c8) * _LC6 * (double)fVar11) ^ _LC25;
    }
    else if (in_EDX == 1) {
      *(float *)(pauVar10[2] + 4) =
           (float)(_LC13 * *(double *)(param_2 + 0x1c8) * _LC6 * (double)fVar11);
    }
...
/* WARNING: Removing unreachable block (ram,0x00100a95) */
/* MobileVRInterface::uninitialize() [clone .part.0] */

void __thiscall MobileVRInterface::uninitialize(MobileVRInterface *this)
  ...
  if (pRVar3 != (Ref *)0x0) {
    if (*(long *)(this + 0x210) != 0) {
      ...
      if ((pOVar4 != (Object *)0x0) &&
         (cVar2 = RefCounted::reference(), local_38 = pOVar4, cVar2 == '\0')) {
        local_38 = (Object *)0x0;
      }
...
/* MobileVRInterface::uninitialize() */
...
/* MobileVRInterface::get_system_info() */

MobileVRInterface * __thiscall MobileVRInterface::get_system_info(MobileVRInterface *this)

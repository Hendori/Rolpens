...
LAB_0011bd2b:
  ...
  if ((_render_uv2(PagedArray<RenderGeometryInstance*>const&,RID,Rect2i_const&)::uv_offsets == '\0')
    ...
    DAT_0011bfc8 = _UNK_0012a158;
    _DAT_0011bfd0 = __LC285;
    uRam000000000011bfd8 = _UNK_0012a168;
    _DAT_0011bfe0 = __LC286;
    uRam000000000011bfe8 = _UNK_0012a178;
    _DAT_0011bff0 = __LC287;
    uRam000000000011bff8 = _UNK_0012a188;
...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_001294e8;
  Object::~Object((Object *)this);
  return;
}
...

{
  ...
  *(undefined ***)pGVar1 = &PTR__GeometryInstanceForwardMobile_00129ac0;
...

{
  ...
  GeometryInstanceLightmapSH *pGVar8;
  undefined8 uVar9;
  ulong uVar10;
  long lVar11;
  long *plVar12;
  ...
  if (iVar6 == 0) {
    uVar5 = *(uint *)(this + 0x10) + 1;
    lVar14 = (ulong)*(uint *)(this + 0x10) * 8;
    *(uint *)(this + 0x10) = uVar5;
    uVar9 = Memory::realloc_static(*(void **)this,(ulong)uVar5 * 8,false);
    *(undefined8 *)this = uVar9;
    uVar9 = Memory::realloc_static(*(void **)(this + 8),(ulong)*(uint *)(this + 0x10) << 3,false);
    lVar2 = *(long *)this;
    *(undefined8 *)(this + 8) = uVar9;
    uVar9 = Memory::alloc_static((ulong)*(uint *)(this + 0x20) * 0x90,false);
    uVar5 = *(uint *)(this + 0x20);
    *(undefined8 *)(lVar2 + lVar14) = uVar9;
    lVar2 = *(long *)(this + 8);
    uVar9 = Memory::alloc_static((ulong)uVar5 << 3,false);
    *(undefined8 *)(lVar2 + lVar14) = uVar9;
    uVar5 = *(uint *)(this + 0x20);
    if (uVar5 == 0) {
      plVar15 = *(long **)(this + 8);
      ...
      do {
        plVar13 = plVar12 + 1;
        lVar17 = *(long *)(lVar2 + lVar14) + lVar11;
        lVar11 = lVar11 + 0x90;
        *plVar12 = lVar17;
        plVar12 = plVar13;
      } while (plVar13 != plVar3 + uVar5);
    }
    iVar6 = uVar5 + *(int *)(this + 0x14);
  }
  else {
  ...
  *(uint *)(this + 0x14) = uVar5;
  pGVar1 = *(GeometryInstanceLightmapSH **)
            (plVar15[uVar5 >> ((byte)*(undefined4 *)(this + 0x18) & 0x1f)] +
            (ulong)(uVar5 & *(uint *)(this + 0x1c)) * 8);
  *(undefined8 *)pGVar1 = 0;
  *(undefined8 *)(pGVar1 + 0x88) = 0;
  puVar16 = (undefined8 *)((ulong)(pGVar1 + 8) & 0xfffffffffffffff8);
  for (uVar10 = (ulong)(((int)pGVar1 - (int)(undefined8 *)((ulong)(pGVar1 + 8) & 0xfffffffffffffff8)
                        ) + 0x90U >> 3); pGVar7 = pGVar1, uVar10 != 0; uVar10 = uVar10 - 1) {
    *puVar16 = 0;
    puVar16 = puVar16 + (ulong)bVar18 * -2 + 1;
  }
  do {
    *(undefined8 *)pGVar7 = uVar9;
    *(undefined8 *)(pGVar7 + 8) = uVar4;
    pGVar8 = pGVar7 + 0x30;
    *(undefined8 *)(pGVar7 + 0x10) = uVar9;
    *(undefined8 *)(pGVar7 + 0x18) = uVar4;
    *(undefined8 *)(pGVar7 + 0x20) = uVar9;
    *(undefined8 *)(pGVar7 + 0x28) = uVar4;
    pGVar7 = pGVar8;
  } while (pGVar1 + 0x90 != pGVar8);
  return pGVar1;
}
...

{
  ...
  if (iVar2 == 0) {
    ...
    if (pvVar4 == (void *)0x0) goto LAB_0012563f;
  }
  else {
...
LAB_00125a08:
  ...
  if (uVar4 == 0xffffffffffffffff) goto LAB_00125a08;
  if (param_1 <= lVar7) {
...
LAB_00125a40:
  ...
  if (uVar4 + 1 == lVar3) {
    ...
    lVar3 = puVar6[-1];
LAB_00125949:
    if (param_1 <= lVar3) goto LAB_001258c1;
  }
  else {
    if (lVar7 != 0) {
      puVar5 = (undefined8 *)
               Memory::realloc_static((void *)(*(long *)this + -0x10),uVar4 + 0x11,false);
      if (puVar5 == (undefined8 *)0x0) goto LAB_00125a40;
      puVar6 = puVar5 + 2;
      *puVar5 = 1;
      *(undefined8 **)this = puVar6;
      lVar3 = puVar5[1];
          ...
          if (uVar14 != 0) {
            ...
            while ((uVar14 != uVar19 || (uVar13 != *(uint *)(*(long *)(lVar20 + lVar24 * 8) + 0x10))
              ...
              if ((uVar14 == 0) ||
                 ...
                 auVar11._0_8_ = uVar21, SUB164(auVar7 * auVar11,8) < uVar22)) goto LAB_00128b39;
            }

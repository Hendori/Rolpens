...
/* realign_weights_undecimated(astcenc_profile, block_size_descriptor const&, image_block const&,
   symbolic_compressed_block&) */

undefined8 realign_weights_undecimated(undefined4 param_1,long param_2,long param_3,long param_4)

{
  ...
  if (bVar1 < 2) {
    ...
    lVar14 = ((ulong)((bVar1 - 2) * 0x400) +
             (ulong)*(ushort *)
                     (param_2 +
                     ((ulong)*(ushort *)(param_4 + 6) + 0x703cd8 + (ulong)(bVar1 - 2) * 0x400) * 2))
             * 0x450;
  }
  lVar21 = param_2 + (ulong)*(ushort *)(param_2 + 0xac7560 + (ulong)*(ushort *)(param_4 + 4) * 2) *
                     6;
  ...
  do {
    if (bVar1 != 0) {
      ...
      do {
        ...
        auVar29._4_4_ =
             *(int *)((long)local_108 + lVar15 + 4) - *(int *)((long)local_148 + lVar15 + 4);
        auVar29._8_4_ =
             *(int *)((long)local_108 + lVar15 + 8) - *(int *)((long)local_148 + lVar15 + 8);
        auVar29._12_4_ =
             *(int *)((long)local_108 + lVar15 + 0xc) - *(int *)((long)local_148 + lVar15 + 0xc);
    ...
    do {
      ...
      uVar18 = (uint)bVar5;
      fVar26 = (float)uVar18;
      bVar16 = (byte)*(undefined2 *)
                      (&quant_and_xfer_tables + ((ulong)bVar5 + 0x30 + (ulong)bVar2 * 0x71) * 2);
      bVar17 = (byte)((ushort)*(undefined2 *)
                               (&quant_and_xfer_tables +
                               ((ulong)bVar5 + 0x30 + (ulong)bVar2 * 0x71) * 2) >> 8);
      ...
      fVar30 = (fVar26 * fVar34 + local_c8[uVar25 * 4 + 1]) -
               *(float *)(param_3 + 0x370 + lVar15 * 4);
      fVar31 = (fVar26 * fVar42 + local_c8[uVar25 * 4 + 2]) -
               *(float *)(param_3 + 0x6e0 + lVar15 * 4);
      fVar26 = (fVar26 * fVar43 + local_c8[uVar25 * 4 + 3]) -
               *(float *)(param_3 + 0xa50 + lVar15 * 4);
      ...
      fVar28 = fVar27 * fVar27 * fVar40 + fVar31 * fVar31 * fVar10 +
               fVar30 * fVar30 * fVar9 + fVar26 * fVar26 * fVar11;
      fVar34 = fVar33 * fVar33 * fVar40 + fVar36 * fVar36 * fVar10 +
               fVar35 * fVar35 * fVar9 + fVar32 * fVar32 * fVar11;
      fVar40 = fVar39 * fVar39 * fVar40 + fVar42 * fVar42 * fVar10 +
               fVar41 * fVar41 * fVar9 + fVar43 * fVar43 * fVar11;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* realign_weights_decimated(astcenc_profile, block_size_descriptor const&, image_block const&,
   symbolic_compressed_block&) */

undefined8 realign_weights_decimated(undefined4 param_1,long param_2,long param_3,long param_4)

{
  ...
  if (uVar14 < 2) {
    ...
    lVar16 = ((ulong)(uVar20 * 0x400) +
             (ulong)*(ushort *)
                     (param_2 +
                     ((ulong)*(ushort *)(param_4 + 6) + 0x703cd8 + (ulong)uVar20 * 0x400) * 2)) *
             0x450;
  }
  lVar29 = param_2 + (ulong)*(ushort *)(param_2 + 0xac7560 + (ulong)*(ushort *)(param_4 + 4) * 2) *
                     6;
  ...
  do {
    if (uVar14 != 0) {
      ...
      do {
        ...
        auVar33._4_4_ =
             *(int *)((long)local_208 + lVar22 + 4) - *(int *)((long)local_248 + lVar22 + 4);
        auVar33._8_4_ =
             *(int *)((long)local_208 + lVar22 + 8) - *(int *)((long)local_248 + lVar22 + 8);
        auVar33._12_4_ =
             *(int *)((long)local_208 + lVar22 + 0xc) - *(int *)((long)local_248 + lVar22 + 0xc);
    ...
    do {
      ...
      bVar18 = (byte)*(undefined2 *)
                      (&quant_and_xfer_tables + ((ulong)bVar5 + 0x30 + (ulong)bVar3 * 0x71) * 2);
      fVar38 = local_148[local_2c0];
      fVar49 = (float)bVar18;
      fVar55 = (float)(byte)((ushort)*(undefined2 *)
                                      (&quant_and_xfer_tables +
                                      ((ulong)bVar5 + 0x30 + (ulong)bVar3 * 0x71) * 2) >> 8);
      ...
      do {
        ...
        fVar36 = local_148[*(byte *)(lVar2 + 0x340)] * *(float *)(lVar1 + 0xa00) +
                 local_148[*(byte *)(lVar2 + 0x418)] * *(float *)(lVar1 + 0xd60) +
                 local_148[*(byte *)(lVar2 + 0x4f0)] * *(float *)(lVar1 + 0x10c0) +
                 local_148[*(byte *)(lVar2 + 0x5c8)] * *(float *)(lVar1 + 0x1420);
...
LAB_001009e4:
          if (fVar50 <= fVar45) goto LAB_0010096f;
        }
        local_278 = 1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* compress_symbolic_block_for_partition_1plane(astcenc_config const&, block_size_descriptor const&,
   image_block const&, bool, float, unsigned int, unsigned int, symbolic_compressed_block&,
   compression_working_buffers&, int) */

void compress_symbolic_block_for_partition_1plane
               (astcenc_config *param_1,block_size_descriptor *param_2,image_block *param_3,
               bool param_4,float param_5,uint param_6,uint param_7,
               symbolic_compressed_block *param_8,compression_working_buffers *param_9,int param_10)

{
  ...
  if (param_6 == 1) {
    ...
    local_370 = compute_symbolic_block_difference_1plane;
    lVar12 = ((ulong)((param_6 - 2) * 0x400) +
             (ulong)*(ushort *)
                     (param_2 + ((ulong)param_7 + 0x703cd8 + (ulong)(param_6 - 2) * 0x400) * 2)) *
             0x450;
  }
  ...
  do {
    if (((short)(1 << ((char)uVar11 + 1U & 0x1f)) - 1U & *(ushort *)pbVar21) != 0) {
      compute_ideal_weights_for_decimation
                ((endpoints_and_weights *)param_9,pdVar16,(float *)pcVar20);
    }
    pbVar21 = pbVar21 + 6;
  ...
  psVar22 = psVar1;
  do {
    if (((int)uVar11 < (int)(uint)(byte)pbVar21[1]) ||
       (iVar15 = (int)*(char *)((long)&compress_symbolic_block_for_partition_1plane(astcenc_config_const&,block_size_descriptor_const&,image_block_const&,bool,float,unsigned_int,unsigned_int,symbolic_compressed_block&,compression_working_buffers&,int)
                                       ::free_bits_for_partition_count + (ulong)(param_6 - 1)) -
                 (uint)(byte)pbVar21[2], iVar15 < 1)) {
      *(float *)pcVar13 = 1e+38;
    }
    else {
      ...
      *psVar22 = SUB41(iVar15,0);
      compute_quantized_weights_for_decimation
                ((decimation_info *)(param_2 + (ulong)(byte)bVar4 * 0x1fb70 + 0x250),
                 pcVar18 + (ulong)(byte)bVar4 * 0x100,&local_148,pcVar20,pbVar21[1]);
      fVar28 = (float)compute_error_of_weight_set_1plane
                                ((endpoints_and_weights *)param_9,
                                 (decimation_info *)(param_2 + (ulong)(byte)bVar4 * 0x1fb70 + 0x250)
                                 ,(float *)&local_148);
  ...
  uVar11 = compute_ideal_endpoint_formats
                     (ppVar3,param_3,(endpoints *)(param_9 + 0x10),psVar1,
                      (float *)(param_9 + 0x2bdc0),*(uint *)(param_1 + 0x44),0,uVar30,local_2e8,
                      local_2c8,(quant_method *)local_2a8,(quant_method *)local_288,param_9);
      ...
      if (*(int *)(param_1 + 0x40) != 0) {
        ...
        do {
          recompute_ideal_colors_1plane
                    (param_3,ppVar3,
                     (decimation_info *)(param_2 + (ulong)(byte)bVar4 * 0x1fb70 + 0x250),
                     (uchar *)&local_188,(endpoints *)&local_148,local_248,local_208);
          ...
          if ((bVar25) && (1 < param_6)) {
            ...
            uVar17 = 0;
            do {
              cVar10 = pack_color_endpoints
                                 (local_2e8[uVar17 + uVar24 * 4],local_268 + uVar17,
                                  local_288[uVar24]);
...
LAB_0010115f:
            ...
            if (fVar28 < local_380) {
              ...
              *(ulong *)param_8 =
                   CONCAT26(uStack_1c2,
                            CONCAT24(uStack_1c4,
                                     CONCAT13(uStack_1c5,
                                              CONCAT12(cStack_1c6,CONCAT11(uStack_1c7,local_1c8)))))
              ;
          ...
          uVar34 = uVar30;
          local_398 = fVar39;
          if (((float)(~uVar35 + *(int *)(param_1 + 0x40)) * __LC13 + _LC7) * local_380 < fVar28)
          break;
          if (fVar28 < local_380) {
            local_1b8 = fVar28;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* compress_block(astcenc_contexti const&, image_block const&, unsigned char*,
   compression_working_buffers&) */

void compress_block(astcenc_contexti *param_1,image_block *param_2,uchar *param_3,
...
LAB_001016db:
  ...
  local_3a0[1] = _LC7;
  local_2c8 = 1e+30;
  fVar32 = (*(float *)(param_2 + 0xe08) + *(float *)(param_2 + 0xe00) +
           *(float *)(param_2 + 0xe0c) + *(float *)(param_2 + 0xe04)) * (float)(byte)pbVar8[3] *
           *(float *)(param_1 + 0x54) * fVar78 * fVar32;
  ...
  if ((compress_block(astcenc_contexti_const&,image_block_const&,unsigned_char*,compression_working_buffers&)
       ::errorval_overshoot == '\0') &&
     (iVar20 = __cxa_guard_acquire(&compress_block(astcenc_contexti_const&,image_block_const&,unsigned_char*,compression_working_buffers&)
                                    ::errorval_overshoot), iVar20 != 0)) {
    compress_block(astcenc_contexti_const&,image_block_const&,unsigned_char*,compression_working_buffers&)
    ::errorval_overshoot = fVar7 / *(float *)(param_1 + 0x58);
  ...
  do {
    ...
    fVar33 = (float)compress_symbolic_block_for_partition_1plane
                              ((astcenc_config *)param_1,pbVar8,param_2,(bool)((byte)uVar22 ^ 1),
                               fVar32 * fVar78 *
                               compress_block(astcenc_contexti_const&,image_block_const&,unsigned_char*,compression_working_buffers&)
                               ::errorval_overshoot,1,0,(symbolic_compressed_block *)&local_2d8,
                               param_4,0xb);
    if (fVar33 <= fVar27) {
      fVar27 = fVar33;
    }
    bVar4 = pbVar8[(ulong)*(ushort *)(pbVar8 + (local_2d8 >> 0x20 & 0xffff) * 2 + 0xac7560) * 6 +
                   0xac8563];
  ...
  local_4b0 = 0.0;
  fVar78 = 0.0;
  fVar59 = _LC24 * (*(float *)(param_2 + 0xe08) + *(float *)(param_2 + 0xe00) +
                   *(float *)(param_2 + 0xe0c) + *(float *)(param_2 + 0xe04));
  fVar33 = fVar73;
  fVar75 = fVar73;
  fVar76 = fVar73;
  fVar77 = fVar73;
...
LAB_00102c07:
    fVar78 = (float)((uint)fVar78 & __LC26);
    if (!NAN(fVar75)) goto LAB_00102bee;
LAB_00101db2:
    fVar75 = fVar7;
    if (NAN(fVar77)) goto LAB_00101dbe;
LAB_00102bd6:
    fVar77 = (float)((uint)fVar77 & __LC26);
  ...
  do {
    if ((fVar33 <= fVar78) && ((param_2[0xe10] == (image_block)0x0 || (uVar16 == 3)))) {
      ...
      auVar38._0_4_ =
           -(uint)(*(float *)(param_2 + 0xdd0) == *(float *)(param_2 + 0xdf0) && uVar16 == __LC0);
      auVar38._4_4_ =
           -(uint)(*(float *)(param_2 + 0xdd4) == *(float *)(param_2 + 0xdf4) &&
                  uVar16 == _UNK_00103084);
      auVar38._8_4_ =
           -(uint)(*(float *)(param_2 + 0xdd8) == *(float *)(param_2 + 0xdf8) &&
                  uVar16 == _UNK_00103088);
      auVar38._12_4_ =
           -(uint)(*(float *)(param_2 + 0xddc) == *(float *)(param_2 + 0xdfc) &&
                  uVar16 == _UNK_0010308c);
      iVar20 = movmskps((int)param_2,auVar38);
      if (iVar20 == 0) {
        fVar75 = fVar32 * compress_block(astcenc_contexti_const&,image_block_const&,unsigned_char*,compression_working_buffers&)
                          ::errorval_overshoot;
        uVar15 = 0xb;
        if (uVar14 < 0xc) {
          uVar15 = uVar14;
        ...
        compute_ideal_colors_and_weights_2planes
                  (pbVar8,param_2,uVar16,(endpoints_and_weights *)param_4,peVar1);
        ...
        if (*(int *)(pbVar8 + 8) != 0) {
          ...
          pcVar23 = pcVar25;
          do {
            if (((short)(1 << ((char)uVar15 + 1U & 0x1f)) - 1U &
                *(ushort *)(pbVar8 + lVar17 * 6 + 0x44)) != 0) {
              compute_ideal_weights_for_decimation
                        ((endpoints_and_weights *)param_4,(decimation_info *)pbVar30,
                         (float *)pcVar23);
              compute_ideal_weights_for_decimation
                        (peVar1,(decimation_info *)pbVar30,(float *)(pcVar23 + 0x80));
            }
            lVar17 = lVar17 + 1;
          ...
          do {
            ...
            if ((byte)pbVar30[1] <= uVar15) {
              ...
              *pcVar23 = (compression_working_buffers)('m' - (char)pbVar30[2]);
              ...
              compute_quantized_weights_for_decimation
                        (pdVar2,pcVar25 + lVar17,&local_148,param_4 + (ulong)uVar44 + 0x65c0,
                         pbVar30[1]);
              compute_quantized_weights_for_decimation
                        (pdVar2,param_4 + lVar17 + 0xf40,local_c8,param_4 + (ulong)uVar44 + 0x65e0,
                         pbVar30[1]);
              uVar36 = compute_error_of_weight_set_2planes
                                 ((endpoints_and_weights *)param_4,peVar1,pdVar2,(float *)&local_148
                                  ,(float *)local_c8);
            }
            pbVar30 = pbVar30 + 6;
            uVar44 = uVar44 + 0x40;
        ...
        uVar55 = compute_ideal_endpoint_formats
                           ((partition_info *)(pbVar8 + 0xe07560),param_2,(endpoints *)&local_1d8,
                            (signed *)(param_4 + 0x2b5c0),(float *)(param_4 + 0x2bdc0),
                            *(uint *)(param_1 + 0x44),uVar35,uVar43,local_358,local_338,
                            (quant_method *)local_318,local_2f8,param_4);
        local_4c8 = _LC5;
        if (uVar55 != 0) {
          uVar56 = 0;
          local_4a8 = local_2c8;
            ...
            if (*(int *)(param_1 + 0x40) != 0) {
              ...
              while( true ) {
                recompute_ideal_colors_2planes
                          (param_2,pbVar8,(decimation_info *)(pbVar8 + lVar17 + 0x250),local_218,
                           local_1f8,(endpoints *)&local_148,local_3c8,local_3b8,uVar16);
                ...
                if (uVar57 == 0) break;
LAB_0010280d:
                if (pbVar8[(ulong)(byte)bVar4 * 0x1fb70 + 0x252] == pbVar8[3]) {
                  cVar10 = realign_weights_undecimated();
                }
                else {
                  cVar10 = realign_weights_decimated
                                     (*(undefined4 *)param_1,pbVar8,param_2,&local_258);
                }
                auVar42._0_8_ =
                     compute_symbolic_block_difference_2plane
                               ((astcenc_config *)param_1,pbVar8,&local_258,param_2);
                ...
                if (((float)((*(uint *)(param_1 + 0x40) - 1) - uVar57) * __LC13 + fVar7) * local_4a8
                    < fVar76) goto LAB_00102977;
                if (fVar76 < local_4a8) {
                  local_248 = fVar76;
                  local_2a8 = local_228;
                  uStack_2a0 = uStack_220;
                  local_2d8 = CONCAT26(uStack_252,
                                       CONCAT24(uStack_254,
                                                CONCAT13(uStack_255,
                                                         CONCAT12(uStack_256,
                                                                  CONCAT11(uStack_257,local_258)))))
                  ;
                ...
                if ((cVar10 == '\0') || (uVar57 = uVar57 + 1, *(uint *)(param_1 + 0x40) <= uVar57))
                goto LAB_00102977;
              }
              auVar42._0_8_ =
                   compute_symbolic_block_difference_2plane
...
LAB_00102977:
  ...
  if (1 < iVar6) {
    ...
    do {
      ...
      uVar16 = find_best_partition_candidates
                         (pbVar8,param_2,(uint)lVar17,(uint)fVar7,(uint *)&local_148,(uint)fVar27);
      fVar7 = *pfVar29;
      if (uVar16 == 0) {
        ...
        do {
          fVar33 = (float)compress_symbolic_block_for_partition_1plane
                                    ((astcenc_config *)param_1,pbVar8,param_2,false,
                                     fVar32 * compress_block(astcenc_contexti_const&,image_block_const&,unsigned_char*,compression_working_buffers&)
                                              ::errorval_overshoot,(uint)lVar17,*puVar28,
                                     (symbolic_compressed_block *)&local_2d8,param_4,uVar14);
          fVar27 = *(float *)(puVar24 + 4);
          fVar78 = pfVar29[1];
          if (fVar33 <= pfVar29[1]) {
            fVar78 = fVar33;
...
LAB_00101928:
  if (local_2d8._0_1_ == (symbolic_compressed_block)0x0) {
    local_2d8 = CONCAT71(local_2d8._1_7_,2);

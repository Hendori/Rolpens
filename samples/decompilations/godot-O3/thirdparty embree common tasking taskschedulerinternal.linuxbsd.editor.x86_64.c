...
/* embree::TaskScheduler::~TaskScheduler() */

void __thiscall embree::TaskScheduler::~TaskScheduler(TaskScheduler *this)

{
  void *pvVar1;
  
  *(undefined ***)this = &PTR__TaskScheduler_00101908;
...
/* embree::TaskScheduler::TaskQueue::steal(embree::TaskScheduler::Thread&) */

undefined8 __thiscall embree::TaskScheduler::TaskQueue::steal(TaskQueue *this,Thread *param_1)
...
/* embree::TaskScheduler::TaskQueue::getTaskSizeAtLeft() */

undefined8 __thiscall embree::TaskScheduler::TaskQueue::getTaskSizeAtLeft(TaskQueue *this)
...
/* embree::TaskScheduler::ThreadPool::ThreadPool(bool) */

void __thiscall embree::TaskScheduler::ThreadPool::ThreadPool(ThreadPool *this,bool param_1)
...
/* embree::TaskScheduler::ThreadPool::~ThreadPool() */

void __thiscall embree::TaskScheduler::ThreadPool::~ThreadPool(ThreadPool *this)
...
/* embree::TaskScheduler::ThreadPool::add(embree::Ref<embree::TaskScheduler> const&) */

void __thiscall embree::TaskScheduler::ThreadPool::add(ThreadPool *this,Ref *param_1)
...
/* embree::TaskScheduler::ThreadPool::remove(embree::Ref<embree::TaskScheduler> const&) */

void __thiscall embree::TaskScheduler::ThreadPool::remove(ThreadPool *this,Ref *param_1)

{
  ...
  embree::MutexSys::lock();
  pTVar3 = *(ThreadPool **)(this + 0x40);
  if (pTVar3 != this + 0x40) {
    do {
      if (*(long *)param_1 == *(long *)(pTVar3 + 0x10)) {
        *(long *)(this + 0x50) = *(long *)(this + 0x50) + -1;
        std::__detail::_List_node_base::_M_unhook();
        plVar2 = *(long **)(pTVar3 + 0x10);
        if (plVar2 != (long *)0x0) {
      ...
      pTVar3 = *(ThreadPool **)pTVar3;
    } while (pTVar3 != this + 0x40);
  }
  embree::MutexSys::unlock();
  return;
}
...
/* embree::TaskScheduler::threadID() */

undefined8 embree::TaskScheduler::threadID(void)
...
/* embree::TaskScheduler::threadIndex() */

undefined8 embree::TaskScheduler::threadIndex(void)
...
undefined8 embree::TaskScheduler::threadCount(void)
...
void embree::TaskScheduler::destroy(void)
...
/* embree::TaskScheduler::allocThreadIndex() */

long __thiscall embree::TaskScheduler::allocThreadIndex(TaskScheduler *this)
...
/* embree::TaskScheduler::reset() */

TaskScheduler __thiscall embree::TaskScheduler::reset(TaskScheduler *this)
...
/* embree::TaskScheduler::wait_for_threads(unsigned long) */

void __thiscall embree::TaskScheduler::wait_for_threads(TaskScheduler *this,ulong param_1)

{
  do {
  } while (*(ulong *)(this + 0x28) < param_1 - 1);
  return;
}



/* embree::TaskScheduler::thread() */

undefined8 embree::TaskScheduler::thread(void)
...
/* embree::TaskScheduler::swapThread(embree::TaskScheduler::Thread*) */

undefined8 embree::TaskScheduler::swapThread(Thread *param_1)
...
/* embree::TaskScheduler::steal_from_other_threads(embree::TaskScheduler::Thread&) */

undefined8 __thiscall
embree::TaskScheduler::steal_from_other_threads(TaskScheduler *this,Thread *param_1)

{
  ...
  if (1 < uVar2) {
    do {
      ...
      if ((lVar3 != 0) &&
         (uVar5 = TaskQueue::steal((TaskQueue *)(lVar3 + 0x40),param_1), (char)uVar5 != '\0')) {
        return uVar5;
      }
      uVar6 = uVar6 + 1;
...
/* embree::TaskScheduler::Task::run_internal(embree::TaskScheduler::Thread&) */

void __thiscall embree::TaskScheduler::Task::run_internal(Task *this,Thread *param_1)
  ...
  do {
    ...
    do {
      while( true ) {
        ...
        uVar6 = uVar6 + uVar4;
        cVar5 = steal_from_other_threads(*(TaskScheduler **)(param_1 + 0xc0108),param_1);
        if (cVar5 == '\0') break;
        do {
          cVar5 = TaskQueue::execute_local_internal((TaskQueue *)(param_1 + 0x40),param_1,this);
        } while (cVar5 != '\0');
        uVar6 = uVar4;
        if (0x3ff < uVar4) goto LAB_0010067e;
      }
    } while (uVar6 < 0x400);
LAB_0010067e:
    embree::yield();
...
/* embree::TaskScheduler::Task::run(embree::TaskScheduler::Thread&) */

void __thiscall embree::TaskScheduler::Task::run(Task *this,Thread *param_1)
...
/* embree::TaskScheduler::TaskQueue::execute_local_internal(embree::TaskScheduler::Thread&,
   embree::TaskScheduler::Task*) */

undefined8 __thiscall
embree::TaskScheduler::TaskQueue::execute_local_internal
          (TaskQueue *this,Thread *param_1,Task *param_2)
    ...
    if (*(long *)(this + 0x40040) == lVar1) {
      ...
      *(long *)(this + 0x40040) = *(long *)(this + 0x40040) + -1;
      ...
      if (*(long *)(this + *(long *)(this + 0x40040) * 0x40 + 0x28) != -1) {
        *(undefined8 *)(this + 0xc0080) =
             *(undefined8 *)(this + *(long *)(this + 0x40040) * 0x40 + 0x28);
      }
      if (*(ulong *)(this + 0x40040) <= *(ulong *)(this + 0x40000)) {
        LOCK();
...
void __thiscall
embree::TaskScheduler::TaskQueue::execute_local(TaskQueue *this,Thread *param_1,Task *param_2)

{
  execute_local_internal(this,param_1,param_2);
  return;
}
...
void embree::TaskScheduler::wait(void)

{
  ...
  pTVar1 = (Thread *)*in_FS_OFFSET;
  if (pTVar1 != (Thread *)0x0) {
    do {
      cVar2 = TaskQueue::execute_local_internal
                        ((TaskQueue *)(pTVar1 + 0x40),pTVar1,*(Task **)(pTVar1 + 0xc0100));
    } while (cVar2 != '\0');
  }
  return;
}
...
/* embree::TaskScheduler::thread_loop(unsigned long) */

void __thiscall embree::TaskScheduler::thread_loop(TaskScheduler *this,ulong param_1)

{
  ...
  pTVar7 = (Thread *)embree::alignedMalloc(0xc0140,0x40);
  ...
  *(ulong *)pTVar7 = param_1;
  pTVar8 = (TaskQueue *)(pTVar7 + 0x40);
  do {
    *(undefined4 *)pTVar8 = 0;
    pTVar9 = pTVar8 + 0x80;
    *(undefined4 *)(pTVar8 + 0x40) = 0;
    pTVar8 = pTVar9;
  } while (pTVar9 != (TaskQueue *)(pTVar7 + 0x40040));
  *(undefined8 *)(pTVar7 + 0x40040) = 0;
  *(undefined8 *)(pTVar7 + 0x40080) = 0;
  *(undefined8 *)(pTVar7 + 0xc00c0) = 0;
  *(undefined8 *)(pTVar7 + 0xc0100) = 0;
  *(TaskScheduler **)(pTVar7 + 0xc0108) = this;
  if (this != (TaskScheduler *)0x0) {
    if (*(code **)(*(long *)this + 0x10) == RefCount::refInc) {
      LOCK();
      *(long *)(this + 8) = *(long *)(this + 8) + 1;
  ...
  LOCK();
  *(Thread **)(*(long *)(this + 0x10) + param_1 * 8) = pTVar7;
  UNLOCK();
  uVar3 = *in_FS_OFFSET;
  pTVar1 = this + 0x30;
  *in_FS_OFFSET = pTVar7;
  ...
  if (*(long *)pTVar1 == 0) {
    ...
    *(long *)(this + 0x28) = *(long *)(this + 0x28) + -1;
    ...
    if (pTVar7 != (Thread *)0x0) {
      ...
      embree::alignedFree(pTVar7);
      return;
    }
    return;
  }
  do {
    uVar4 = *(ulong *)(*(long *)(pTVar7 + 0xc0108) + 0x28);
    uVar10 = 0;
    do {
      while( true ) {
        if (*(long *)pTVar1 == 0) goto LAB_00100918;
        uVar10 = uVar10 + uVar4;
        cVar6 = steal_from_other_threads(*(TaskScheduler **)(pTVar7 + 0xc0108),pTVar7);
        if (cVar6 == '\0') break;
        LOCK();
        *(long *)pTVar1 = *(long *)pTVar1 + 1;
        UNLOCK();
        do {
          cVar6 = TaskQueue::execute_local_internal((TaskQueue *)(pTVar7 + 0x40),pTVar7,(Task *)0x0)
          ;
        } while (cVar6 != '\0');
        LOCK();
        *(long *)pTVar1 = *(long *)pTVar1 + -1;
        UNLOCK();
        uVar10 = uVar4;
        if (0x3ff < uVar4) goto LAB_00100993;
      }
    } while (uVar10 < 0x400);
LAB_00100993:
    embree::yield();
...
/* embree::TaskScheduler::ThreadPool::thread_loop(unsigned long) */

void __thiscall embree::TaskScheduler::ThreadPool::thread_loop(ThreadPool *this,ulong param_1)
...
LAB_00100a8c:
  do {
    ...
    while( true ) {
      ...
      embree::MutexSys::lock();
      while ((uVar3 = _DAT_00000028, param_1 < *(ulong *)pTVar1 &&
             (*(ThreadPool **)(this + 0x40) == this + 0x40))) {
      ...
      *(ulong *)pTVar2 = *(ulong *)pTVar2 + 1;
      ...
      if (this_00 == (TaskScheduler *)0x0) goto LAB_00100a8c;
      ...
      *(long *)pTVar2 = *(long *)pTVar2 + -1;
      UNLOCK();
      if (*(long *)pTVar2 != 0) goto LAB_00100a8c;
...
/* embree::threadPoolFunction(std::pair<embree::TaskScheduler::ThreadPool*, unsigned long>*) */

void embree::threadPoolFunction(pair *param_1)
...
void __thiscall embree::TaskScheduler::join(TaskScheduler *this)
...
/* embree::TaskScheduler::addScheduler(embree::Ref<embree::TaskScheduler> const&) */

void embree::TaskScheduler::addScheduler(Ref *param_1)

{
  ThreadPool::add(threadPool,param_1);
  return;
}



/* embree::TaskScheduler::removeScheduler(embree::Ref<embree::TaskScheduler> const&) */

void embree::TaskScheduler::removeScheduler(Ref *param_1)

{
  ThreadPool::remove(threadPool,param_1);
  return;
}
...

{
  ...
  *(undefined8 *)(this + 0x30) = 0;
  ...
  if (uVar2 < uVar4) {
    std::
    vector<embree::atomic<embree::TaskScheduler::Thread*>,std::allocator<embree::atomic<embree::TaskScheduler::Thread*>>>
    ::_M_default_append((ulong)(this + 0x10));
    lVar5 = *(long *)(this + 0x18);
    lVar3 = *(long *)(this + 0x10);
  }
  else {
    lVar5 = lVar1;
    if ((uVar4 < uVar2) && (lVar5 = *threadPool * 0x10 + lVar3, lVar1 != lVar5)) {
...
/* embree::TaskScheduler::ThreadPool::setNumThreads(unsigned long, bool) */

void __thiscall
embree::TaskScheduler::ThreadPool::setNumThreads(ThreadPool *this,ulong param_1,bool param_2)
    ...
    *(ulong *)pTVar1 = param_1;
    ...
    while (uVar7 = uVar7 - 1, (long)*(ulong *)pTVar1 <= (long)uVar7) {
      while (uVar7 != 0) {
        ...
        *(long *)(this + 0x20) = *(long *)(this + 0x20) + -8;
        if ((long)uVar7 < (long)*(ulong *)pTVar1) goto LAB_00100f11;
      }
    }
  }
LAB_00100f11:
...
/* embree::TaskScheduler::ThreadPool::startThreads() */

void __thiscall embree::TaskScheduler::ThreadPool::startThreads(ThreadPool *this)
...
/* embree::TaskScheduler::create(unsigned long, bool, bool) */

void embree::TaskScheduler::create(ulong param_1,bool param_2,bool param_3)
...
void embree::TaskScheduler::startThreads(void)
...
/* embree::TaskScheduler::instance() */

long embree::TaskScheduler::instance(void)

{
  ...
  if (lVar1 == 0) {
    embree::MutexSys::lock();
    pTVar2 = (TaskScheduler *)embree::alignedMalloc(0x50,0x40);
    TaskScheduler(pTVar2);
    *in_FS_OFFSET = (long)pTVar2;
    if (pTVar2 != (TaskScheduler *)0x0) {
      LOCK();
    ...
    if (g_instance_vector._8_8_ == g_instance_vector._16_8_) {
      std::
      vector<embree::Ref<embree::TaskScheduler>,std::allocator<embree::Ref<embree::TaskScheduler>>>
      ::_M_realloc_insert<embree::Ref<embree::TaskScheduler>>
                ((vector<embree::Ref<embree::TaskScheduler>,std::allocator<embree::Ref<embree::TaskScheduler>>>
                  *)g_instance_vector,g_instance_vector._8_8_,&local_28);
      ...
      *(TaskScheduler **)g_instance_vector._8_8_ = pTVar2;
...

{
  ...
  *(long *)pRVar1 = *(long *)pRVar1 + -1;
  ...
  if ((this != (RefCount *)0x0) && (*(long *)pRVar1 == 0)) {
                    /* WARNING: Could not recover jumptable at 0x001011e9. Too many branches */
...
void __thiscall
std::vector<embree::Ref<embree::TaskScheduler>,std::allocator<embree::Ref<embree::TaskScheduler>>>::
~vector(vector<embree::Ref<embree::TaskScheduler>,std::allocator<embree::Ref<embree::TaskScheduler>>>
        *this)

{
  ...
  if (puVar2 != puVar4) {
    do {
      while (plVar3 = (long *)*puVar4, plVar3 == (long *)0x0) {
LAB_0010123e:
        puVar4 = puVar4 + 1;
        if (puVar2 == puVar4) goto LAB_00101270;
      }
      if (*(code **)(*plVar3 + 0x18) == embree::RefCount::refDec) {
        LOCK();
        plVar1 = plVar3 + 1;
        *plVar1 = *plVar1 + -1;
        UNLOCK();
...
/* embree::TaskScheduler::TaskQueue::execute_local_internal(embree::TaskScheduler::Thread&,
   embree::TaskScheduler::Task*) [clone .cold] */

void embree::TaskScheduler::TaskQueue::execute_local_internal(Thread *param_1,Task *param_2)
...
/* std::vector<embree::atomic<embree::TaskScheduler::Thread*>,
   std::allocator<embree::atomic<embree::TaskScheduler::Thread*> > >::_M_default_append(unsigned
   long) */

void std::
     vector<embree::atomic<embree::TaskScheduler::Thread*>,std::allocator<embree::atomic<embree::TaskScheduler::Thread*>>>
     ::_M_default_append(ulong param_1)

{
  ...
  if (!bVar12) {
    ...
    if ((in_RSI <= uVar3) && (uVar11 = uVar3 * 2, 0xfffffffffffffff < uVar11)) {
      uVar11 = 0xfffffffffffffff;
    }
  ...
  if (bVar12 || bVar13) {
    ...
    if (__src != unaff_R12) goto LAB_0010145e;
    if (0xfffffffffffffffe < uVar3) goto LAB_001014f0;
...

{
  ...
  if (__src == pvVar2) {
    if (0xfffffffffffffffe < uVar1) goto LAB_001014f0;
...

{
  ...
  plVar1 = *(long **)(this + 8);
  plVar2 = *(long **)this;
  uVar4 = (long)plVar1 - (long)plVar2 >> 3;
  ...
  if (plVar2 == plVar1) {
    uVar7 = uVar4 + 1;
    if (0xfffffffffffffffe < uVar4) goto LAB_00101750;
...
LAB_0010175a:
    ...
    local_48 = (long)plVar5 + uVar7;
    uVar3 = *param_3;
    *param_3 = 0;
    *(undefined8 *)((long)plVar5 + ((long)param_2 - (long)plVar2)) = uVar3;
    local_58 = plVar5;
    if (param_2 == plVar2) {
      plVar6 = plVar5 + 1;
      if (plVar2 == plVar1) {
...
LAB_00101750:
    ...
    *(undefined8 *)((long)param_2 - (long)plVar2) = uVar3;
    ...
    plVar6 = (long *)0x8;
    plVar5 = local_58;
    if (param_2 == plVar2) goto LAB_0010168b;
  }
  while( true ) {
    plVar6 = (long *)*plVar8;
    *plVar5 = (long)plVar6;
    if (plVar6 != (long *)0x0) {
      if (*(code **)(*plVar6 + 0x10) == embree::RefCount::refInc) {
        LOCK();
        plVar6[1] = plVar6[1] + 1;
        UNLOCK();
      }
    ...
    if (param_2 == plVar8 + 1) break;
    plVar5 = plVar5 + 1;
    plVar8 = plVar8 + 1;
  }
  plVar6 = plVar5 + 2;
  if (param_2 == plVar1) goto LAB_001016e7;
LAB_0010168b:
  do {
    while( true ) {
      plVar5 = plVar6;
...
LAB_0010167e:
      param_2 = param_2 + 1;
      plVar6 = plVar5 + 1;
      if (plVar1 == param_2) goto LAB_001016b8;
    }
...
LAB_001016e7:
    do {
      plVar8 = (long *)*plVar9;
      if (plVar8 != (long *)0x0) {
        if (*(code **)(*plVar8 + 0x18) != embree::RefCount::refDec) goto code_r0x001016fb;
        LOCK();
        plVar5 = plVar8 + 1;
        *plVar5 = *plVar5 + -1;
        UNLOCK();
...
code_r0x001016fb:
  (**(code **)(*plVar8 + 0x18))();
  plVar9 = plVar9 + 1;
  goto joined_r0x001016bb;
}



/* embree::TaskScheduler::g_numThreads */

void embree::TaskScheduler::_GLOBAL__sub_I_g_numThreads(void)

{
  ...
  __cxa_atexit(std::
               vector<embree::Ref<embree::TaskScheduler>,std::allocator<embree::Ref<embree::TaskScheduler>>>
               ::~vector,g_instance_vector,&__dso_handle);
  return;
}

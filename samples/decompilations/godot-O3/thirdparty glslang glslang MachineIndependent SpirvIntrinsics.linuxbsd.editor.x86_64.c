...
void glslang::TIntermediate::insertSpirvExecutionMode(int param_1,TIntermAggregate *param_2)

{
  ...
  local_7c[0] = (int)param_2;
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (*(long *)(lVar10 + 0x520) == 0) {
    uVar5 = glslang::GetThreadPoolAllocator();
    puVar6 = (undefined8 *)glslang::TPoolAllocator::allocate(uVar5);
    uVar7 = glslang::GetThreadPoolAllocator();
    *(undefined4 *)(puVar6 + 2) = 0;
    ...
    *(undefined4 *)(puVar6 + 9) = 0;
    ...
    puVar6[0xc] = puVar6 + 9;
    puVar6[0xd] = 0;
    *(undefined8 **)(lVar10 + 0x520) = puVar6;
  }
  local_68 = glslang::GetThreadPoolAllocator();
  local_60 = 0;
  local_58 = (long *)0x0;
  local_50 = (long *)0x0;
  if (in_RDX != (long *)0x0) {
    if (*(code **)(*in_RDX + 0x198) == TIntermAggregate::getSequence) {
      plVar8 = in_RDX + 0x18;
    }
    else {
      plVar8 = (long *)(**(code **)(*in_RDX + 0x198))();
    }
  ...
  if (*(long *)(lVar2 + 0x18) != 0) {
    do {
      while( true ) {
        lVar9 = lVar3;
        if (*(int *)(lVar9 + 0x20) < local_7c[0]) break;
        lVar3 = *(long *)(lVar9 + 0x10);
        lVar4 = lVar9;
        if (*(long *)(lVar9 + 0x10) == 0) goto LAB_00101540;
      }
...
LAB_00101540:
    bVar12 = lVar10 != lVar4;
    lVar10 = lVar4;
    if ((bVar12) && (*(int *)(lVar4 + 0x20) <= local_7c[0])) goto LAB_0010154a;
  }
  local_70 = local_7c;
  lVar4 = std::
          _Rb_tree<int,std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>,std::_Select1st<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TVector<glslang::TIntermConstantUnion_const*>>>>

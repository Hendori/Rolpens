...
/* initialize_raycast_module(ModuleInitializationLevel) */

void initialize_raycast_module(int param_1)
...
/* uninitialize_raycast_module(ModuleInitializationLevel) */

void uninitialize_raycast_module(int param_1)

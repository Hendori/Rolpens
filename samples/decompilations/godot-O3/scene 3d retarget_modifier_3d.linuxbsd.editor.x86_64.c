...
undefined8 CowData<RetargetModifier3D::RetargetBoneInfo>::_realloc(long param_1)
...
LAB_0010b430:
  ...
  uVar7 = lVar13 - 1U >> 1 | lVar13 - 1U;
  uVar7 = uVar7 | uVar7 >> 2;
  uVar7 = uVar7 | uVar7 >> 4;
  uVar7 = uVar7 | uVar7 >> 8;
  uVar7 = uVar7 | uVar7 >> 0x10;
  uVar7 = uVar7 | uVar7 >> 0x20;
  if (uVar7 == 0xffffffffffffffff) goto LAB_0010b430;
  if (param_1 <= lVar14) {
    if ((uVar7 + 1 != lVar6) && (uVar11 = _realloc((long)this), (int)uVar11 != 0)) {
      return uVar11;
    }
    if (*(long *)this != 0) {
      *(long *)(*(long *)this + -8) = param_1;
...
LAB_0010b3bc:
    ...
    lVar14 = puVar12[-1];
    if (param_1 <= lVar14) goto LAB_0010b363;
  }
  else {
    if (lVar14 != 0) {
      uVar11 = _realloc((long)this);
      if ((int)uVar11 != 0) {
        return uVar11;
      }
      goto LAB_0010b3bc;
  ...
  uVar11 = __LC65;
  uVar2 = _LC68;
  puVar9 = (undefined4 *)((long)puVar12 + lVar14 * 0x4c);
  do {
    *puVar9 = 0xffffffff;
    puVar10 = puVar9 + 0x13;
    ...
    *(undefined8 *)(puVar9 + 0x11) = uVar4;
    puVar9 = puVar10;
  } while ((undefined4 *)(lVar13 + (long)puVar12) != puVar10);
LAB_0010b363:
  puVar12[-1] = param_1;
  return 0;
}

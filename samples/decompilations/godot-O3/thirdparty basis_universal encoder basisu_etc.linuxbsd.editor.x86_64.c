...

{
  ...
  *param_1 = cVar7;
  ...
  param_1[6] = cVar7;
  iVar6 = *(int *)(&DAT_0010d2c8 + uVar5 * 0x10);
  param_1[0xb] = (color_rgba)0xff;
  iVar2 = uVar3 + iVar6;
  if (0xff < iVar2) {
    iVar2 = 0xff;
  ...
  param_1[10] = cVar7;
  iVar2 = *(int *)(&DAT_0010d2cc + uVar5 * 0x10);
  param_1[0xf] = (color_rgba)0xff;
  iVar6 = uVar3 + iVar2;
  if (0xff < iVar6) {
    iVar6 = 0xff;
...

{
  ...
  *param_1 = cVar6;
  ...
  param_1[6] = cVar6;
  iVar4 = *(int *)(&DAT_0010d2c8 + uVar5 * 0x10);
  param_1[0xb] = (color_rgba)0xff;
  iVar7 = iVar3 + iVar4;
  if (0xff < iVar7) {
    iVar7 = 0xff;
  ...
  param_1[10] = cVar6;
  iVar7 = *(int *)(&DAT_0010d2cc + uVar5 * 0x10);
  param_1[0xf] = (color_rgba)0xff;
  iVar3 = iVar3 + iVar7;
  if (0xff < iVar3) {
    iVar3 = 0xff;
...

{
  ...
  *(params **)this = param_1;
  uVar18 = *(uint *)(this + 0x78);
  uVar6 = *(uint *)(param_1 + 0xc);
  *(results **)(this + 8) = param_2;
  iVar14 = (int)this;
  bVar25 = SUB41(uVar6,0);
  if (uVar6 != uVar18) {
    if (uVar6 < uVar18) {
      *(uint *)(this + 0x78) = uVar6;
      ...
      if (*(uint *)(this + 0x7c) < uVar6) {
        basisu::elemental_vector::increase_capacity
                  (iVar14 + 0x70,bVar25,(uint)(uVar18 + 1 == uVar6),
                   (_func_void_void_ptr_void_ptr_uint *)0x1,false);
        uVar18 = *(uint *)(this + 0x78);
      }
      memset((void *)((ulong)uVar18 + *(long *)(this + 0x70)),0,(ulong)(uVar6 - uVar18));
      *(uint *)(this + 0x78) = uVar6;
    }
  }
  uVar18 = *(uint *)(this + 0x88);
  if (uVar6 != uVar18) {
    if (uVar6 < uVar18) {
      *(uint *)(this + 0x88) = uVar6;
      ...
      if (*(uint *)(this + 0x8c) < uVar6) {
        basisu::elemental_vector::increase_capacity
                  (iVar14 + 0x80,bVar25,(uint)(uVar18 + 1 == uVar6),
                   (_func_void_void_ptr_void_ptr_uint *)0x1,false);
        uVar18 = *(uint *)(this + 0x88);
      }
      memset((void *)((ulong)uVar18 + *(long *)(this + 0x80)),0,(ulong)(uVar6 - uVar18));
      *(uint *)(this + 0x88) = uVar6;
    }
  }
    ...
    if (uVar6 < uVar18) {
      *(uint *)(this + 0xf8) = uVar6;
      ...
      if (*(uint *)(this + 0xfc) < uVar6) {
        basisu::elemental_vector::increase_capacity
                  (iVar14 + 0xf0,bVar25,(uint)(uVar18 + 1 == uVar6),
                   (_func_void_void_ptr_void_ptr_uint *)0x1,false);
        uVar18 = *(uint *)(this + 0xf8);
      }
      memset((void *)((ulong)uVar18 + *(long *)(this + 0xf0)),0,(ulong)(uVar6 - uVar18));
      *(uint *)(this + 0xf8) = uVar6;
    }
  }
  uVar18 = *(uint *)(this + 0xd8);
  if (uVar6 != uVar18) {
    if (uVar6 < uVar18) {
      *(uint *)(this + 0xd8) = uVar6;
      ...
      if (*(uint *)(this + 0xdc) < uVar6) {
        basisu::elemental_vector::increase_capacity
                  (iVar14 + 0xd0,bVar25,(uint)(uVar18 + 1 == uVar6),
                   (_func_void_void_ptr_void_ptr_uint *)0x1,false);
        uVar18 = *(uint *)(this + 0xd8);
      }
      memset((void *)((ulong)uVar18 + *(long *)(this + 0xd0)),0,(ulong)(uVar6 - uVar18));
      *(uint *)(this + 0xd8) = uVar6;
    }
  }
    ...
    if (uVar6 < uVar18) {
      *(uint *)(this + 0xa8) = uVar6;
      ...
      if (*(uint *)(this + 0xac) < uVar6) {
        basisu::elemental_vector::increase_capacity
                  (iVar14 + 0xa0,bVar25,(uint)(uVar18 + 1 == uVar6),
                   (_func_void_void_ptr_void_ptr_uint *)0x1,false);
        uVar18 = *(uint *)(this + 0xa8);
      }
      memset((void *)((ulong)uVar18 + *(long *)(this + 0xa0)),0,(ulong)(uVar6 - uVar18));
      *(uint *)(this + 0xa8) = uVar6;
    }
  }
  *(uint *)(this + 0x10) = (-(uint)(*(char *)(*(long *)this + 0x18) == '\0') & 0x10) + 0xf;
  uVar18 = *(uint *)(this + 0x38);
  if (uVar6 != uVar18) {
    if (uVar6 < uVar18) {
      *(uint *)(this + 0x38) = uVar6;
      ...
      if (*(uint *)(this + 0x3c) < uVar6) {
        basisu::elemental_vector::increase_capacity
                  (iVar14 + 0x30,bVar25,(uint)(uVar18 + 1 == uVar6),
                   (_func_void_void_ptr_void_ptr_uint *)0x2,false);
        uVar18 = *(uint *)(this + 0x38);
      }
      memset((void *)(*(long *)(this + 0x30) + (ulong)uVar18 * 2),0,(ulong)(uVar6 - uVar18) * 2);
      *(uint *)(this + 0x38) = uVar6;
    }
  }
  uVar18 = *(uint *)(this + 0x58);
  if (uVar6 != uVar18) {
    if (uVar6 < uVar18) {
      *(uint *)(this + 0x58) = uVar6;
      ...
      if (*(uint *)(this + 0x5c) < uVar6) {
        basisu::elemental_vector::increase_capacity
                  (iVar14 + 0x50,bVar25,(uint)(uVar18 + 1 == uVar6),
                   (_func_void_void_ptr_void_ptr_uint *)0x4,false);
        uVar18 = *(uint *)(this + 0x58);
      }
      memset((void *)(*(long *)(this + 0x50) + (ulong)uVar18 * 4),0,(ulong)(uVar6 - uVar18) << 2);
      *(uint *)(this + 0x58) = uVar6;
    }
  }
    ...
    if (uVar6 < uVar18) {
      *(uint *)(this + 0x48) = uVar6;
      ...
      if (*(uint *)(this + 0x4c) < uVar6) {
        basisu::elemental_vector::increase_capacity
                  (iVar14 + 0x40,bVar25,(uint)(uVar18 + 1 == uVar6),
                   (_func_void_void_ptr_void_ptr_uint *)0x4,false);
        uVar18 = *(uint *)(this + 0x48);
      }
      memset((void *)(*(long *)(this + 0x40) + (ulong)uVar18 * 4),0,(ulong)(uVar6 - uVar18) << 2);
      *(uint *)(this + 0x48) = uVar6;
    }
  }
  piVar9 = *(int **)this;
  if (uVar6 == 0) {
    ...
    do {
      fVar37 = local_50;
      bVar2 = *(byte *)(lVar11 + uVar19 * 4);
      bVar3 = *(byte *)(lVar11 + 1 + uVar19 * 4);
      bVar4 = *(byte *)(lVar11 + 2 + uVar19 * 4);
      uVar26 = (uint)bVar2;
      if (uVar26 < uVar18) {
        uVar18 = uVar26;
      }
      ...
      *(ushort *)(lVar12 + uVar19 * 2) =
           (ushort)bVar3 + (ushort)*(byte *)(lVar11 + uVar19 * 4) + (ushort)bVar4;
      fVar40 = fVar40 + (float)bVar4;
      *(int *)(lVar10 + uVar19 * 4) = (int)uVar19;
      uVar19 = uVar19 + 1;
      local_50 = fVar37 + (float)bVar2;
    } while (uVar19 != local_70);
    auVar36._0_4_ = (float)bVar2 + fVar37;
    iVar23 = uVar29 - uVar33;
    if ((int)(uVar29 - uVar33) < (int)(uVar31 - uVar32)) {
      iVar23 = uVar31 - uVar32;
    }
    auVar35._0_12_ = ZEXT812(0);
    auVar35._12_4_ = fStack_4c;
    auVar36._8_8_ = auVar35._8_8_;
    auVar36._4_4_ = fStack_4c;
    if (iVar23 < (int)(uVar30 - uVar18)) {
      iVar23 = uVar30 - uVar18;
    }
  }
  fVar37 = _LC0;
  iVar17 = *(int *)(this + 0x10);
  iVar7 = *piVar9;
  fVar41 = (float)local_70;
  *(int *)(this + 0x2c) = iVar23;
  fVar16 = _LC1;
  ...
  fVar38 = (float)iVar17;
  *(float *)(this + 0x1c) = fVar40 / fVar41;
  *(long *)(this + 0x14) = auVar36._0_8_;
  iVar27 = (int)(long)((auVar36._0_4_ * fVar38) / fVar37 + fVar16);
  iVar23 = iVar27;
  if (iVar17 <= iVar27) {
    iVar23 = iVar17;
  }
  ...
  *(int *)(this + 0x20) = iVar23;
  iVar27 = (int)(long)((auVar36._4_4_ * fVar38) / fVar37 + fVar16);
  iVar23 = iVar27;
  if (iVar17 <= iVar27) {
    iVar23 = iVar17;
  }
  ...
  *(int *)(this + 0x24) = iVar23;
  iVar23 = (int)(long)((fVar38 * (fVar40 / fVar41)) / fVar37 + fVar16);
  if (iVar23 < iVar17) {
    iVar17 = iVar23;
  }
  if (iVar23 < 0) {
  ...
  *(int *)(this + 0x28) = iVar17;
  if (iVar7 != 0) goto LAB_0010413a;
  lVar10 = *(long *)(this + 0x30);
  uVar19 = 0;
  puVar13 = *(undefined4 **)(this + 0x50);
  if (uVar6 == 0) {
    *(undefined4 **)(this + 0x60) = puVar13;
...
LAB_00104456:
    do {
      puVar13[uVar19] = (int)uVar19;
      lVar11 = uVar19 + 1;
      uVar19 = uVar19 + 2;
      puVar13[lVar11] = (int)lVar11;
    } while (local_70 != uVar19);
  }
  else {
    *puVar13 = 0;
    uVar19 = 1;
    if (local_70 != 1) goto LAB_00104456;
  }
  uVar19 = local_70 * 4;
  puVar1 = puVar13 + local_70;
  lVar11 = 0x3f;
  if ((long)uVar19 >> 2 != 0) {
    for (; (ulong)((long)uVar19 >> 2) >> lVar11 == 0; lVar11 = lVar11 + -1) {
    }
  }
  std::
  __introsort_loop<unsigned_int*,long,__gnu_cxx::__ops::_Iter_comp_iter<basisu::indirect_sort<unsigned_short>(unsigned_int,unsigned_int*,unsigned_short_const*)::_lambda(unsigned_int,unsigned_int)_1_>>
            (puVar13,puVar1,(long)(int)lVar11 * 2,lVar10);
  if (uVar19 < 0x41) {
    std::
    __insertion_sort<unsigned_int*,__gnu_cxx::__ops::_Iter_comp_iter<basisu::indirect_sort<unsigned_short>(unsigned_int,unsigned_int*,unsigned_short_const*)::_lambda(unsigned_int,unsigned_int)_1_>>
              (puVar13,puVar1,lVar10);
  }
  else {
    puVar24 = puVar13 + 0x10;
    std::
    __insertion_sort<unsigned_int*,__gnu_cxx::__ops::_Iter_comp_iter<basisu::indirect_sort<unsigned_short>(unsigned_int,unsigned_int*,unsigned_short_const*)::_lambda(unsigned_int,unsigned_int)_1_>>
              (puVar13,puVar24,lVar10);
    for (; puVar1 != puVar24; puVar24 = puVar24 + 1) {
      while( true ) {
        uVar18 = *puVar24;
        uVar21 = (ulong)puVar24[-1];
        uVar5 = *(ushort *)(lVar10 + (ulong)uVar18 * 2);
        puVar15 = puVar24;
        if (*(ushort *)(lVar10 + uVar21 * 2) <= uVar5) break;
        do {
          puVar20 = puVar15 + -1;
          *puVar15 = (uint)uVar21;
          uVar21 = (ulong)puVar15[-2];
          puVar15 = puVar20;
        } while (uVar5 < *(ushort *)(lVar10 + uVar21 * 2));
        puVar24 = puVar24 + 1;
        *puVar20 = uVar18;
        if (puVar1 == puVar24) goto LAB_00104530;
      }
      *puVar24 = uVar18;
    }
  }
LAB_00104530:
  ...
  *(long *)(this + 0x68) = lVar11;
  do {
    *(uint *)(lVar11 + uVar21) = (uint)*(ushort *)(lVar12 + (ulong)*(uint *)(lVar10 + uVar21) * 2);
    uVar21 = uVar21 + 4;
  } while (uVar19 != uVar21);
LAB_0010413a:
  ...
  *(undefined8 *)(this + 0x178) = 0;
  puVar28 = (undefined8 *)((ulong)(this + 0x108) & 0xfffffffffffffff8);
  for (uVar19 = (ulong)((iVar14 - (int)(undefined8 *)((ulong)(this + 0x108) & 0xfffffffffffffff8)) +
                        0x180U >> 3); uVar19 != 0; uVar19 = uVar19 - 1) {
    *puVar28 = 0;
...

{
  ...
  if (param_2 < lVar8) {
    ...
    if ((param_3 & 1) == 0) goto LAB_0010c790;
  }
  else {
    puVar4 = (uint *)(param_1 + param_2 * 4);
    lVar3 = param_2;
    if ((param_3 & 1) != 0) goto LAB_0010c775;
LAB_0010c790:
...
LAB_0010c936:
          ...
          *puVar6 = uVar13;
          ...
          if (uVar2 <= uVar7) goto LAB_0010c86c;
LAB_0010c8e8:
        ...
        if (uVar2 <= uVar7) {
          if (uVar3 < uVar2) goto LAB_0010c8e8;
          goto LAB_0010c936;
        }
LAB_0010c86c:

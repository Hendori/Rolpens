...
/* OS_LinuxBSD::get_main_loop() const */

undefined8 __thiscall OS_LinuxBSD::get_main_loop(OS_LinuxBSD *this)
...
/* OS_LinuxBSD::set_main_loop(MainLoop*) */

void __thiscall OS_LinuxBSD::set_main_loop(OS_LinuxBSD *this,MainLoop *param_1)
...
/* OS_LinuxBSD::is_disable_crash_handler() const */

OS_LinuxBSD __thiscall OS_LinuxBSD::is_disable_crash_handler(OS_LinuxBSD *this)
...
/* OS_LinuxBSD::initialize_joypads() */

void __thiscall OS_LinuxBSD::initialize_joypads(OS_LinuxBSD *this)
...
/* OS_LinuxBSD::disable_crash_handler() */

void OS_LinuxBSD::disable_crash_handler(void)
...
/* OS_LinuxBSD::_test_create_rendering_device_and_gl(String const&) const */

undefined8 __thiscall
OS_LinuxBSD::_test_create_rendering_device_and_gl(OS_LinuxBSD *this,String *param_1)
...
/* OS_LinuxBSD::get_name() const */

OS_LinuxBSD * __thiscall OS_LinuxBSD::get_name(OS_LinuxBSD *this)
...
/* OS_LinuxBSD::get_identifier() const */

OS_LinuxBSD * __thiscall OS_LinuxBSD::get_identifier(OS_LinuxBSD *this)
...
/* OS_LinuxBSD::delete_main_loop() */

void __thiscall OS_LinuxBSD::delete_main_loop(OS_LinuxBSD *this)
...
/* OS_LinuxBSD::initialize() */

void __thiscall OS_LinuxBSD::initialize(OS_LinuxBSD *this)
...
/* OS_LinuxBSD::_weight_to_fc(int) const */

long __thiscall OS_LinuxBSD::_weight_to_fc(OS_LinuxBSD *this,int param_1)

{
  long lVar1;
  
  lVar1 = 0;
  if ((((((0x95 < param_1) && (lVar1 = 0x28, 0xf9 < param_1)) && (lVar1 = 0x32, 0x144 < param_1)) &&
       ((lVar1 = 0x37, 0x176 < param_1 && (lVar1 = 0x4b, 0x185 < param_1)))) &&
      ((lVar1 = 0x50, 0x1c1 < param_1 &&
       ((lVar1 = 100, 0x225 < param_1 && (lVar1 = 0xb4, 0x289 < param_1)))))) &&
     ((lVar1 = 200, 0x2ed < param_1 && (lVar1 = 0xcd, 0x351 < param_1)))) {
...
/* OS_LinuxBSD::_stretch_to_fc(int) const */

undefined8 __thiscall OS_LinuxBSD::_stretch_to_fc(OS_LinuxBSD *this,int param_1)

{
  ...
  if (((((0x37 < param_1) && (uVar1 = 0x3f, 0x44 < param_1)) && (uVar1 = 0x4b, 0x50 < param_1)) &&
      ((uVar1 = 0x57, 0x5c < param_1 && (uVar1 = 100, 0x69 < param_1)))) &&
     ((uVar1 = 0x71, 0x88 < param_1 &&
      ((uVar1 = 0x7d, 0x8f < param_1 && (uVar1 = 200, param_1 < 0xa2)))))) {
    uVar1 = 0x96;
  }
  return uVar1;
}
...
void __thiscall OS_LinuxBSD::run(OS_LinuxBSD *this)
...
/* OS_LinuxBSD::is_sandboxed() const */

undefined8 __thiscall OS_LinuxBSD::is_sandboxed(OS_LinuxBSD *this)
...
/* OS_LinuxBSD::_check_internal_feature_support(String const&) */

uint __thiscall OS_LinuxBSD::_check_internal_feature_support(OS_LinuxBSD *this,String *param_1)
...
/* OS_LinuxBSD::get_config_path() const */

void OS_LinuxBSD::get_config_path(void)

{
  ...
  if (cVar2 == '\0') {
    ...
    if (get_config_path()::first_print != '\0') {
      _err_print_error("get_config_path","platform/linuxbsd/os_linuxbsd.cpp",0x36f,
                       "`XDG_CONFIG_HOME` is a relative path. Ignoring its value and falling back to `$HOME/.config` or `.` per the XDG Base Directory specification."
                       ,0,1);
      get_config_path()::first_print = '\0';
    }
...
/* OS_LinuxBSD::get_data_path() const */

void OS_LinuxBSD::get_data_path(void)

{
  ...
  if (cVar2 == '\0') {
    ...
    if (get_data_path()::first_print != '\0') {
      _err_print_error("get_data_path","platform/linuxbsd/os_linuxbsd.cpp",0x37e,
                       "`XDG_DATA_HOME` is a relative path. Ignoring its value and falling back to `$HOME/.local/share` or `get_config_path()` per the XDG Base Directory specification."
                       ,0,1);
      get_data_path()::first_print = '\0';
    }
    this = (StrRange *)&local_78;
    local_78 = 0;
    pcVar1 = *(code **)(*in_RSI + 0x168);
...
/* OS_LinuxBSD::get_cache_path() const */

void OS_LinuxBSD::get_cache_path(void)

{
  ...
  if (cVar2 == '\0') {
    ...
    if (get_cache_path()::first_print != '\0') {
      _err_print_error("get_cache_path","platform/linuxbsd/os_linuxbsd.cpp",0x38d,
                       "`XDG_CACHE_HOME` is a relative path. Ignoring its value and falling back to `$HOME/.cache` or `get_config_path()` per the XDG Base Directory specification."
                       ,0,1);
      get_cache_path()::first_print = '\0';
    }
    this = (StrRange *)&local_78;
    local_78 = 0;
    pcVar1 = *(code **)(*in_RSI + 0x168);
...
/* OS_LinuxBSD::get_system_font_path(String const&, int, int, bool) const */

String * OS_LinuxBSD::get_system_font_path(String *param_1,int param_2,int param_3,bool param_4)

{
  ...
  if (OVar2 == (OS_LinuxBSD)0x0) {
    _err_print_error("get_system_font_path","platform/linuxbsd/os_linuxbsd.cpp",0x335,
                     "Method/function failed. Returning: String()",
                     "Unable to load fontconfig, system font support is disabled.",0,0);
    *(undefined8 *)param_1 = 0;
    ...
    do {
      ...
      if (lVar8 != 0) {
        ...
        uVar6 = _weight_to_fc((OS_LinuxBSD *)CONCAT44(in_register_00000034,param_2),
                              (int)CONCAT71(in_register_00000009,param_4));
        ...
        if (((((0x37 < in_R8D) && (uVar9 = 0x3f, 0x44 < in_R8D)) && (uVar9 = 0x4b, 0x50 < in_R8D))
            && ((uVar9 = 0x57, 0x5c < in_R8D && (uVar9 = 100, 0x69 < in_R8D)))) &&
           ((uVar9 = 0x71, 0x88 < in_R8D &&
            ((uVar9 = 0x7d, 0x8f < in_R8D && (uVar9 = 200, in_R8D < 0xa2)))))) {
          uVar9 = 0x96;
        }
        (*_FcPatternAddInteger_dylibloader_wrapper_fontconfig)(lVar8,"width",uVar9);
        (*_FcPatternAddInteger_dylibloader_wrapper_fontconfig)
                  (lVar8,"slant",-(in_R9B != '\0') & 100);
        ...
        if (lVar10 != 0) {
          if (OVar4 == (OS_LinuxBSD)0x0) {
            local_60 = 0;
            iVar7 = (*_FcPatternGetString_dylibloader_wrapper_fontconfig)
                              (lVar10,"family",0,&local_60);
...
/* OS_LinuxBSD::get_unique_id() const */

OS_LinuxBSD * __thiscall OS_LinuxBSD::get_unique_id(OS_LinuxBSD *this)

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  if ((get_unique_id()::machine_id == '\0') &&
     (iVar5 = __cxa_guard_acquire(&get_unique_id()::machine_id), iVar5 != 0)) {
    get_unique_id()::machine_id = (char *)0x0;
    __cxa_atexit(String::~String,&get_unique_id()::machine_id,&__dso_handle);
    __cxa_guard_release(&get_unique_id()::machine_id);
  }
  if ((get_unique_id()::machine_id == (char *)0x0) ||
     (*(uint *)(get_unique_id()::machine_id + -8) < 2)) {
    local_50 = 0;
    local_40 = 0xf;
    ...
    if (local_58 != (Object *)0x0) {
      while (((get_unique_id()::machine_id == (char *)0x0 ||
              (*(uint *)(get_unique_id()::machine_id + -8) < 2)) &&
             (cVar4 = (**(code **)(*(long *)local_58 + 0x1d8))(), cVar4 == '\0'))) {
        (**(code **)(*(long *)local_58 + 0x228))((StrRange *)&local_50);
        String::strip_edges(SUB81(&local_48,0),SUB81((StrRange *)&local_50,0));
        pcVar2 = local_48;
        if (get_unique_id()::machine_id == local_48) {
          if (get_unique_id()::machine_id != (char *)0x0) {
            LOCK();
            plVar1 = (long *)(get_unique_id()::machine_id + -0x10);
            *plVar1 = *plVar1 + -1;
            UNLOCK();
            if (*plVar1 == 0) {
              local_48 = (char *)0x0;
          ...
          get_unique_id()::machine_id = local_48;
        }
        lVar3 = local_50;
        if (local_50 != 0) {
          LOCK();
...
ulong __thiscall OS_LinuxBSD::get_embedded_pck_offset(OS_LinuxBSD *this)
...
OS_LinuxBSD * __thiscall OS_LinuxBSD::get_system_ca_certificates(OS_LinuxBSD *this)
  ...
  if ((local_80 == 0) || (*(uint *)(local_80 + -8) < 2)) {
    *(undefined8 *)this = 0;
    ...
    if (local_70 == (Object *)0x0) {
      ...
      _err_print_error("get_system_ca_certificates","platform/linuxbsd/os_linuxbsd.cpp",0x4ac,
                       "Condition \"f.is_null()\" is true. Returning: \"\"",(String *)&local_58,0,0)
      ;
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_68);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
...
OS_LinuxBSD * __thiscall OS_LinuxBSD::get_system_dir(OS_LinuxBSD *this,long *param_2,int param_3)
...
switchD_001026d2_default:
  ...
  *(int *)local_68[1] = *(int *)local_68[1] + 1;
  ...
  String::parse_latin1((StrRange *)&local_60);
  iVar3 = (*pcVar2)(param_2,(StrRange *)&local_60,(List<String,DefaultAllocator> *)&local_68,
                    (CowData<char32_t> *)&local_70,0,0,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
  if (iVar3 == 0) {
...
void __thiscall OS_LinuxBSD::OS_LinuxBSD(OS_LinuxBSD *this)
  ...
  *(undefined1 (*) [16])(this + 0x4f8) = (undefined1  [16])0x0;
  ...
  if (iVar2 - 20000U < 10000) {
    ...
    if (iVar2 < 30000) {
      ...
      cVar1 = '\0';
      uVar4 = (uint)((long)((ulong)(uint)((int)((long)iVar2 / 100) >> 0x1f) << 0x20 |
                           (long)iVar2 / 100 & 0xffffffffU) % 100);
LAB_00102a66:
      local_70 = 0;
...
undefined4 __thiscall OS_LinuxBSD::shell_open(OS_LinuxBSD *this,String *param_1)

{
  ...
  *(int *)local_68[1] = *(int *)local_68[1] + 1;
  ...
  local_58 = "xdg-open";
  String::parse_latin1((StrRange *)&local_60);
  iVar4 = (*pcVar1)(this,(StrRange *)&local_60,(List<String,DefaultAllocator> *)&local_68,0,
                    &local_6c,0,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
...
LAB_00103020:
    ...
    *(int *)local_68[1] = *(int *)local_68[1] + 1;
    ...
    if (iVar4 != 0 || local_6c != 0) {
      ...
      if ((local_68 != (undefined1 (*) [16])0x0) &&
         (pCVar6 = *(CowData<char32_t> **)*local_68, pCVar6 != (CowData<char32_t> *)0x0)) {
      ...
      if (iVar4 != 0 || local_6c != 0) {
        ...
        if (iVar4 != 0 || local_6c != 0) {
          ...
          local_50 = 8;
          String::parse_latin1((StrRange *)&local_60);
          uVar5 = (*pcVar1)(this,(StrRange *)&local_60,(List<String,DefaultAllocator> *)&local_68,0,
                            &local_6c,0,0,0);
          CowData<char32_t>::_unref((CowData<char32_t> *)&local_60);
          if (local_6c != 0) {
            uVar5 = 1;
...

{
  ...
  List<String,DefaultAllocator>::push_back
            ((List<String,DefaultAllocator> *)&local_590,(String *)&local_598);
  local_510 = 0;
  ...
  *(int *)local_590[1] = *(int *)local_590[1] + 1;
  ...
  local_500 = (char *)0x3;
  String::parse_latin1((StrRange *)&local_510);
  iVar9 = (*pcVar2)(param_1,(StrRange *)&local_510,(List<String,DefaultAllocator> *)&local_590,0,
                    &local_5a0,0,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_510);
  pauVar3 = local_590;
  if (iVar9 != 0 || local_5a0 != 0) {
    if ((local_590 != (undefined1 (*) [16])0x0) &&
       (pCVar11 = *(CowData<char32_t> **)*local_590, pCVar11 != (CowData<char32_t> *)0x0)) {
    ...
    *(int *)local_590[1] = *(int *)local_590[1] + 1;
    ...
    String::parse_latin1((StrRange *)&local_510);
    List<String,DefaultAllocator>::push_back
              ((List<String,DefaultAllocator> *)&local_590,(String *)&local_510);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_510);
    pcVar2 = *(code **)(*(long *)param_1 + 0x108);
    local_510 = 0;
          ...
          if (1 < *(uint *)(local_588 + -8)) {
            ...
            if (iVar9 == 0) {
              ...
              if (iVar9 == 0) {
                ...
                CowData<char32_t>::_unref((CowData<char32_t> *)&local_510);
                if (iVar9 == 0) {
                  if (((local_520 != (Object *)0x0) &&
                      (cVar8 = RefCounted::unreference(), pOVar4 = local_520, cVar8 != '\0')) &&
                     (cVar8 = predelete_handler(local_520), cVar8 != '\0')) {
                  ...
                  do {
                    ...
                    if (iVar9 != 0) {
                      ...
                      if (local_548[0] == 0) {
                        ...
                        local_530 = 0;
                        String::parse_latin1((String *)&local_530,"/info/");
                        operator+((char *)local_538,(String *)"Can\'t create trashinfo file: \"");
                        String::operator+((String *)&local_528,(String *)local_538);
                        String::operator+((String *)&local_520,(String *)&local_528);
                        String::operator+((String *)&local_510,(String *)&local_520);
                        uVar16 = 0x470;
LAB_00104aff:
                        _err_print_error(_LC94,"platform/linuxbsd/os_linuxbsd.cpp",uVar16,
                                         "Condition \"err != OK\" is true. Returning: err",
                                         (StrRange *)&local_510,0,0);
                        CowData<char32_t>::_unref((CowData<char32_t> *)&local_510);
                        CowData<char32_t>::_unref((CowData<char32_t> *)&local_520);
                ...
                local_510 = 0;
                String::parse_latin1((String *)&local_510,"/info\"");
                operator+((char *)&local_518,(String *)"Could not create the trash path \"");
                String::operator+((String *)&local_508,(String *)&local_518);
                uVar16 = 0x448;
              }
              else {
            ...
            _err_print_error(_LC94,"platform/linuxbsd/os_linuxbsd.cpp",uVar16,
                             "Condition \"err != OK\" is true. Returning: err",(String *)&local_508,
                             0,0);
            CowData<char32_t>::_unref((CowData<char32_t> *)&local_508);
            CowData<char32_t>::_unref((CowData<char32_t> *)&local_518);
            CowData<char32_t>::_unref((CowData<char32_t> *)&local_510);
        ...
        iVar9 = 1;
        _err_print_error(_LC94,"platform/linuxbsd/os_linuxbsd.cpp",0x43c,
                         "Condition \"trash_path.is_empty()\" is true. Returning: FAILED",
                         "Could not determine the trash can location",0,0);
        goto LAB_001038cb;
      }
    }
  }
...
code_r0x00103de9:
  iVar9 = 1;
  _err_print_error(_LC94,"platform/linuxbsd/os_linuxbsd.cpp",0x45f,
                   "Condition \"id_number > 99\" is true. Returning: FAILED",
                   "Too many identically named resources already in the trash can.",0,0);
LAB_00103e22:
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_568);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_570);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_578);
LAB_001038cb:
  CowData<char32_t>::_unref((CowData<char32_t> *)local_5e8);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_588);
LAB_001038eb:
  List<String,DefaultAllocator>::~List((List<String,DefaultAllocator> *)&local_590);
...
/* OS_LinuxBSD::get_processor_name() const */

OS_LinuxBSD * __thiscall OS_LinuxBSD::get_processor_name(OS_LinuxBSD *this)

{
  ...
  if (local_58 == (Object *)0x0) {
    local_50 = 0;
    local_48 = 
    "Couldn\'t open `/proc/cpuinfo` to get the CPU model name. Returning an empty string.";
    local_40[0] = 0x53;
    String::parse_latin1((StrRange *)&local_50);
    ...
    while (cVar3 = (**(code **)(*(long *)local_58 + 0x1d8))(), cVar3 == '\0') {
      ...
      if (iVar4 != -1) {
        ...
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,1,lVar7,"p_index","size()","",false,true)
        ;
        _err_flush_stdout();
  ...
  _err_print_error("get_processor_name","platform/linuxbsd/os_linuxbsd.cpp",uVar6,pcVar5,
                   (StrRange *)&local_50,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_50);
  *(undefined8 *)this = 0;
  local_40[0] = 0;
  local_48 = "";
...
/* OS_LinuxBSD::get_systemd_os_release_info_value(String const&) const */

String * OS_LinuxBSD::get_systemd_os_release_info_value(String *param_1)
...
/* OS_LinuxBSD::get_distribution_name() const */

OS_LinuxBSD * __thiscall OS_LinuxBSD::get_distribution_name(OS_LinuxBSD *this)

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  if (get_distribution_name()::distribution_name == '\0') {
  ...
  if ((get_distribution_name()::distribution_name == 0) ||
     (*(uint *)(get_distribution_name()::distribution_name + -8) < 2)) {
    uname(&local_1b8);
  ...
  *(undefined8 *)this = 0;
  if (get_distribution_name()::distribution_name != 0) {
    CowData<char32_t>::_ref
              ((CowData<char32_t> *)this,(CowData *)&get_distribution_name()::distribution_name);
  }
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    return this;
  }
...
/* OS_LinuxBSD::get_version() const */

OS_LinuxBSD * __thiscall OS_LinuxBSD::get_version(OS_LinuxBSD *this)

{
  ...
  if ((get_version()::release_version == 0) || (*(uint *)(get_version()::release_version + -8) < 2))
  {
    uname(&local_1b8);
...
/* OS_LinuxBSD::alert(String const&, String const&) */

void __thiscall OS_LinuxBSD::alert(OS_LinuxBSD *this,String *param_1,String *param_2)
...
LAB_00105823:
      ...
      if (((local_b8 != (char *)0x0) && (1 < *(uint *)(local_b8 + -8))) ||
         (lVar8 = lVar8 + 1, local_a0 == 0)) break;
    }
  }
  local_b0 = 0;
  ...
  if (cVar4 != '\0') {
    ...
    List<String,DefaultAllocator>::push_back
              ((List<String,DefaultAllocator> *)&local_b0,(String *)&local_98);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_98);
    local_98 = (char *)0x0;
  ...
  if ((local_b8 == (char *)0x0) || (*(uint *)(local_b8 + -8) < 2)) {
    ...
    (**(code **)(*(long *)this + 0x108))
              (this,(CowData<char32_t> *)&local_b8,(List<String,DefaultAllocator> *)&local_b0,0,0,0,
               0,0);
  }
...
/* OS_LinuxBSD::lspci_get_device_value(Vector<String>, String, String) const */

long OS_LinuxBSD::lspci_get_device_value
               (long param_1,long *param_2,long param_3,String *param_4,long *param_5)
    ...
    do {
      while( true ) {
        ...
        *(int *)local_90[1] = *(int *)local_90[1] + 1;
        ...
        local_50[0] = 5;
        String::parse_latin1((StrRange *)&local_68);
        iVar5 = (*pcVar2)(param_2,(StrRange *)&local_68,(List<String,DefaultAllocator> *)&local_90,
                          (CowData<char32_t> *)&local_98,0,0,0,0);
        lVar9 = local_68;
        if (local_68 != 0) {
          LOCK();
          plVar1 = (long *)(local_68 + -0x10);
            ...
            if (local_50[0] == 0) {
              ...
              if (1 < lVar9) {
                String::strip_edges(SUB81((CowData<char32_t> *)&local_88,0),
                                    (bool)((char)local_50[0] + '\b'));
                if (((*param_5 == 0) || (*(uint *)(*param_5 + -8) < 2)) ||
                   (iVar5 = String::find((String *)&local_88,(int)param_5), iVar5 == -1)) {
                  local_80 = 0;
                  if (local_88 != 0) {
...
/* OS_LinuxBSD::lspci_device_filter(Vector<String>, String, String, String) const */

long OS_LinuxBSD::lspci_device_filter
               (long param_1,long *param_2,long param_3,undefined8 param_4,String *param_5,
               long *param_6)
    ...
    do {
      while( true ) {
        ...
        *(int *)local_88[1] = *(int *)local_88[1] + 1;
        ...
        local_50[0] = 5;
        String::parse_latin1((StrRange *)&local_68);
        iVar6 = (*pcVar2)(param_2,(String *)&local_68,(List<String,DefaultAllocator> *)&local_88,
                          (CowData<char32_t> *)&local_90,0,0,0,0);
        lVar10 = local_68;
        if (local_68 != 0) {
          LOCK();
          plVar1 = (long *)(local_68 + -0x10);
...
LAB_00106f42:
                _err_print_index_error
                          ("get","./core/templates/cowdata.h",0xdb,1,lVar10,"p_index","size()","",
                           false,true);
                _err_flush_stdout();
                    /* WARNING: Does not return */
                pcVar2 = (code *)invalidInstructionException();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* OS_LinuxBSD::get_system_font_path_for_text(String const&, String const&, String const&, String
   const&, int, int, bool) const */

String * OS_LinuxBSD::get_system_font_path_for_text
...

{
  ...
  if (param_2[0x160] == (String)0x0) {
    _err_print_error("get_system_font_path_for_text","platform/linuxbsd/os_linuxbsd.cpp",0x2ff,
                     "Method/function failed. Returning: Vector<String>()",
                     "Unable to load fontconfig, system font support is disabled.",0,0);
    *(undefined8 *)(param_1 + 8) = 0;
  }
  else {
    ...
    do {
      while (lVar6 = (*_FcPatternCreate_dylibloader_wrapper_fontconfig)(), lVar6 != 0) {
        ...
        uVar7 = 0x32;
        if (((((0x37 < in_stack_00000010) && (uVar7 = 0x3f, 0x44 < in_stack_00000010)) &&
             (uVar7 = 0x4b, 0x50 < in_stack_00000010)) &&
            ((uVar7 = 0x57, 0x5c < in_stack_00000010 && (uVar7 = 100, 0x69 < in_stack_00000010))))
           && ((uVar7 = 0x71, 0x88 < in_stack_00000010 &&
               ((uVar7 = 0x7d, 0x8f < in_stack_00000010 && (uVar7 = 200, in_stack_00000010 < 0xa2)))
               ))) {
          uVar7 = 0x96;
        }
        (*_FcPatternAddInteger_dylibloader_wrapper_fontconfig)(lVar6,"width",uVar7);
        (*_FcPatternAddInteger_dylibloader_wrapper_fontconfig)
                  (lVar6,"slant",-(in_stack_00000018 != '\0') & 100);
        uVar7 = (*_FcCharSetCreate_dylibloader_wrapper_fontconfig)();
        lVar10 = *(long *)param_4;
        for (lVar12 = 0; (lVar10 != 0 && (lVar2 = *(long *)(lVar10 + -8), (int)lVar12 < (int)lVar2))
            ; lVar12 = lVar12 + 1) {
          if (lVar12 == lVar2) {
            puVar8 = &String::_null;
          }
            ...
            if (lVar2 <= lVar12) {
              _err_print_index_error
                        ("get","./core/templates/cowdata.h",0xdb,lVar12,lVar2,"p_index","size()","",
                         false,true);
              _err_flush_stdout();
                    /* WARNING: Does not return */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* OS_LinuxBSD::get_system_fonts() const */

long OS_LinuxBSD::get_system_fonts(void)

{
  ...
  if (*(char *)(in_RSI + 0x160) == '\0') {
    _err_print_error("get_system_fonts","platform/linuxbsd/os_linuxbsd.cpp",0x2a3,
                     "Method/function failed. Returning: Vector<String>()",
                     "Unable to load fontconfig, system font support is disabled.",0,0);
    *(undefined8 *)(in_RDI + 8) = 0;
    ...
    do {
      ...
      if (lVar3 == 0) {
        _err_print_error("get_system_fonts","platform/linuxbsd/os_linuxbsd.cpp",0x2ab,
                         "Condition \"!pattern\" is true. Continuing.",0,0);
      }
      else {
        ...
        piVar4 = (int *)(*_FcFontList_dylibloader_wrapper_fontconfig)
                                  (*(undefined8 *)(in_RSI + 0x168),lVar3,
                                   *(undefined8 *)(in_RSI + 0x170));
        if (piVar4 != (int *)0x0) {
          lVar9 = 0;
          if (0 < *piVar4) {
            do {
              local_98 = 0;
              iVar2 = (*_FcPatternGetString_dylibloader_wrapper_fontconfig)
                                (*(undefined8 *)(*(long *)(piVar4 + 2) + lVar9 * 8),"family",0,
                                 &local_98);
...
/* OS_LinuxBSD::finalize() */

void __thiscall OS_LinuxBSD::finalize(OS_LinuxBSD *this)
...
/* OS_LinuxBSD::get_video_adapter_driver_info() const */

long OS_LinuxBSD::get_video_adapter_driver_info(void)

{
  ...
  if ((get_video_adapter_driver_info()::info == '\0') &&
     (iVar6 = __cxa_guard_acquire(&get_video_adapter_driver_info()::info), iVar6 != 0)) {
    get_video_adapter_driver_info()::info._8_8_ = 0;
  ...
  if (get_video_adapter_driver_info()::info._8_8_ != 0) {
    *(undefined8 *)(in_RDI + 8) = 0;
    if (get_video_adapter_driver_info()::info._8_8_ != 0) {
      CowData<String>::_ref
                ((CowData<String> *)(in_RDI + 8),
                 (CowData *)(get_video_adapter_driver_info()::info + 8));
    }
    goto LAB_001079a3;
  }
  ...
  List<String,DefaultAllocator>::push_back
            ((List<String,DefaultAllocator> *)&local_2c8,(String *)&local_1e8);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_1e8);
      ...
      if ((local_1e0 != 0) && (2 < *(long *)(local_1e0 + -8))) {
        ...
        if (local_1e0 == 0) {
          ...
          if (2 < lVar12) {
            ...
            pOVar3 = local_1f8;
            if ((cVar5 != '\0') && (cVar5 = predelete_handler(local_1f8), cVar5 != '\0')) {
            ...
            if (cVar5 == '\0') {
              ...
              pVVar11 = local_268;
LAB_00107ddb:
              Vector<String>::push_back(pVVar11,(StrRange *)&local_1f8);
              CowData<char32_t>::_unref((CowData<char32_t> *)&local_1f8);
            }
            CowData<char32_t>::_unref((CowData<char32_t> *)&local_208);
...
LAB_00107e08:
    ...
    lspci_device_filter((String *)&local_1e8,in_RSI,(StrRange *)&local_1f8,
                        (CowData<char32_t> *)&local_228,(CowData<char32_t> *)&local_218,
                        (String *)&local_208);
    lVar9 = local_1e0;
    if (lVar7 != local_1e0) {
    ...
    lspci_get_device_value
              ((CowData<char32_t> *)&local_228,in_RSI,(String *)&local_1e8,(String *)&local_208,
               (StrRange *)&local_1f8);
    CowData<String>::_unref((CowData<String> *)&local_1e0);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_208);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_1f8);
    ...
    lspci_get_device_value
              ((CowData<char32_t> *)&local_218,in_RSI,(String *)&local_1e8,(String *)&local_208,
               (StrRange *)&local_1f8);
    CowData<String>::_unref((CowData<String> *)&local_1e0);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_208);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_1f8);
    ...
    lspci_get_device_value
              ((String *)&local_208,in_RSI,(String *)&local_1e8,(CowData<char32_t> *)&local_270,
               (StrRange *)&local_1f8);
    CowData<String>::_unref((CowData<String> *)&local_1e0);
    ...
    if (((pCVar1 == local_200 + lVar7 * 8) || (*(long *)pCVar1 == 0)) ||
       (CowData<char32_t>::_ref((CowData<char32_t> *)&local_290,pCVar1), local_290 == 0)) {
      lVar7 = 0;
LAB_0010861f:
    ...
    Vector<String>::push_back
              ((Vector<String> *)get_video_adapter_driver_info()::info,(String *)&local_1e8);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_1e8);
    local_280 = 0;
    local_278 = 0;
    List<String,DefaultAllocator>::push_back
              ((List<String,DefaultAllocator> *)&local_278,(String *)&local_290);
    pcVar2 = *(code **)(*in_RSI + 0x108);
    local_1e8 = (char *)0x0;
    String::parse_latin1((String *)&local_1e8,"modinfo");
    iVar6 = (*pcVar2)(in_RSI,(String *)&local_1e8,(List<String,DefaultAllocator> *)&local_278,
                      (CowData<char32_t> *)&local_280,0,0,0,0);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_1e8);
...
LAB_00108956:
            _err_print_index_error
                      ("get","./core/templates/cowdata.h",0xdb,lVar7,lVar12,"p_index","size()","",
                       false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
            pcVar2 = (code *)invalidInstructionException();
...

{
  ...
  *(code **)(this + 0x2c0) = MIDIDriverALSAMidi::~MIDIDriverALSAMidi;
  ...
  CowData<char32_t>::_unref((CowData<char32_t> *)(this + 0x488));
  CowData<char32_t>::_unref((CowData<char32_t> *)(this + 0x480));
  CowData<char32_t>::_unref((CowData<char32_t> *)(this + 0x478));
  CowData<char32_t>::_unref((CowData<char32_t> *)(this + 0x470));
  CowData<char32_t>::_unref((CowData<char32_t> *)(this + 0x468));
  CowData<char32_t>::_unref((CowData<char32_t> *)(this + 0x460));
...
/* OS_LinuxBSD::_test_create_rendering_device(String const&) const */

ulong __thiscall OS_LinuxBSD::_test_create_rendering_device(OS_LinuxBSD *this,String *param_1)
...
void __thiscall MainLoop::~MainLoop(MainLoop *this)
...
/* WARNING: Removing unreachable block (ram,0x0010addd) */
/* WARNING: Removing unreachable block (ram,0x0010ade9) */
...
/* WARNING: Removing unreachable block (ram,0x0010afd0) */
/* WARNING: Removing unreachable block (ram,0x0010b15e) */
/* WARNING: Removing unreachable block (ram,0x0010b16a) */
/* String vformat<long, int, unsigned char, unsigned char, unsigned char>(String const&, long const,
   int const, unsigned char const, unsigned char const, unsigned char const) */

String * vformat<long,int,unsigned_char,unsigned_char,unsigned_char>
                   (String *param_1,long param_2,int param_3,uchar param_4,uchar param_5,
                   uchar param_6)
...
/* WARNING: Removing unreachable block (ram,0x0010b485) */
/* WARNING: Removing unreachable block (ram,0x0010b491) */
/* String vformat<String, unsigned char>(String const&, String const, unsigned char const) */

undefined8 *
vformat<String,unsigned_char>(undefined8 *param_1,bool *param_2,String *param_3,uchar param_4)
...
/* WARNING: Removing unreachable block (ram,0x0010b7b5) */
/* WARNING: Removing unreachable block (ram,0x0010b7c1) */

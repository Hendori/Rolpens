...
LAB_00100960:
    ...
    goto LAB_00100a40;
LAB_00100992:
    puVar8 = (uint *)(lVar4 + 8 + uVar9 * 0x14);
    do {
      param_2 = (uint)uVar9;
      uVar2 = *puVar8;
...
LAB_00100a40:
  if (param_1 < param_2) {
    ...
    do {
      ...
      puVar8[1] = uVar12;
      puVar8 = puVar8 + 5;
    } while ((uint *)(lVar4 + 0x18 + ((ulong)((param_2 - 1) - param_1) + (ulong)param_1) * 0x14) !=
             puVar8);
  }
  return;
LAB_00100a3b:
  if (*(uint *)(lVar7 + 8) != uVar10) goto LAB_00100a40;
  if (uVar10 != uVar11) {
...
LAB_00100bad:
    if (uVar3 != param_2) goto LAB_00100bb2;
  }
...
LAB_00100bb2:
  ...
  do {
    ...
    puVar7[1] = uVar8;
    puVar7 = puVar7 + 5;
  } while ((uint *)(lVar4 + 0x18 + ((ulong)((param_2 - uVar10) - 1) + (ulong)uVar10) * 0x14) !=
           puVar7);
  return;
}
...
LAB_001041ad:
        if (param_3 == uVar13) goto LAB_00103ce0;
LAB_001041b6:
...
LAB_00103f4d:
        if (uVar13 == param_3) goto LAB_00103ce0;
        uVar10 = (ulong)(param_3 - 1);
        uVar7 = (ulong)uVar13;
        uVar11 = *(uint *)(lVar4 + 8 + uVar7 * 0x14);
        uVar15 = *(uint *)(lVar4 + 8 + uVar10 * 0x14);

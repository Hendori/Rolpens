...

{
  ...
  *(undefined ***)this = &PTR__Scene_00105c88;
...
/* WARNING: Removing unreachable block (ram,0x00101f5b) */
...

{
  ...
  if (lVar9 == 0) {
    pTVar11 = (Thread *)embree::TaskScheduler::instance();
    ...
    *(long *)pTVar12 = lVar9;
    pTVar15 = pTVar12 + 0x40;
    pTVar14 = pTVar15;
    do {
      *(undefined4 *)pTVar14 = 0;
      pTVar13 = pTVar14 + 0x80;
      *(undefined4 *)(pTVar14 + 0x40) = 0;
      pTVar14 = pTVar13;
    ...
    *(Thread **)(pTVar12 + 0xc0108) = pTVar11;
    if (pTVar11 != (Thread *)0x0) {
      if (*(code **)(*(long *)pTVar11 + 0x10) == RefCount::refInc) {
        LOCK();
        *(long *)(pTVar11 + 8) = *(long *)(pTVar11 + 8) + 1;
    ...
    LOCK();
    *(Thread **)(*(long *)(pTVar11 + 0x10) + lVar9 * 8) = pTVar12;
    UNLOCK();
    local_48 = pTVar12;
    pTVar14 = (Thread *)embree::TaskScheduler::swapThread(pTVar12);
    ...
    *(ulong *)(pTVar12 + 0xc00c0) = uVar3;
    pTVar13 = pTVar12 + uVar3 + 0x40090;
    *(undefined ***)pTVar13 = &PTR_execute_00105cf0;
    *(ulong *)(pTVar13 + 8) = param_2;
    *(ulong *)(pTVar13 + 0x10) = param_1;
    *(ulong *)(pTVar13 + 0x18) = param_3;
    *(_lambda_embree__range<unsigned_long>_const___1_ **)(pTVar13 + 0x20) = param_4;
    *(TaskGroupContext **)(pTVar13 + 0x28) = param_5;
    lVar10 = *(long *)(pTVar12 + 0x40080) * 0x40;
    lVar6 = *(long *)(pTVar12 + 0xc0100);
    *(undefined4 *)(pTVar12 + lVar10 + 0x44) = 1;
    pTVar12[lVar10 + 0x48] = (Thread)0x1;
    *(long *)(pTVar12 + lVar10 + 0x68) = lVar5;
    *(Thread **)(pTVar12 + lVar10 + 0x50) = pTVar13;
    *(long *)(pTVar12 + lVar10 + 0x58) = lVar6;
    ...
    *(ulong *)(pTVar12 + lVar10 + 0x70) = param_2 - param_1;
    ...
    LOCK();
    if (*(int *)(pTVar15 + lVar10) == 0) {
      *(undefined4 *)(pTVar15 + lVar10) = 1;
    }
    UNLOCK();
    LOCK();
    *(long *)(pTVar12 + 0x40080) = *(long *)(pTVar12 + 0x40080) + 1;
    ...
    LOCK();
    *(long *)(pTVar11 + 0x30) = *(long *)(pTVar11 + 0x30) + 1;
    UNLOCK();
    LOCK();
    pTVar11[0x38] = (Thread)0x1;
    UNLOCK();
    ...
    do {
      cVar8 = embree::TaskScheduler::TaskQueue::execute_local(pTVar15,(Task *)pTVar12);
    } while (cVar8 != '\0');
    LOCK();
    *(long *)(pTVar11 + 0x30) = *(long *)(pTVar11 + 0x30) + -1;
    UNLOCK();
    ...
    local_48 = (Thread *)0x0;
    LOCK();
    *(undefined8 *)(lVar9 * 8 + *(long *)(pTVar11 + 0x10)) = 0;
    UNLOCK();
    ...
    LOCK();
    *(long *)(pTVar11 + 0x28) = *(long *)(pTVar11 + 0x28) + -1;
    UNLOCK();
    while (*(long *)(pTVar11 + 0x28) != 0) {
      embree::yield();
    }
    ...
    *(long *)(lVar10 + 0x58) = lVar6;
    *(long *)(lVar10 + 0x68) = lVar5;
...
/* WARNING: Removing unreachable block (ram,0x0010260b) */
/* void embree::TaskScheduler::spawn<unsigned long, embree::parallel_for<unsigned long,
...

{
  ...
  if (lVar9 == 0) {
    ...
    *(ulong *)(pTVar12 + 0xc00c0) = uVar3;
    pTVar13 = pTVar12 + uVar3 + 0x40090;
    *(undefined ***)pTVar13 = &PTR_execute_00105d08;
    *(ulong *)(pTVar13 + 8) = param_2;
    *(ulong *)(pTVar13 + 0x10) = param_1;
    *(ulong *)(pTVar13 + 0x18) = param_3;
    *(_lambda_embree__range<unsigned_long>_const___1_ **)(pTVar13 + 0x20) = param_4;
...

{
  ...
  *(undefined ***)(this + 600) = &PTR_operator___00105c70;
...

{
  ...
  if (lVar2 == 7) {
    ...
    if (iVar4 == 2) goto LAB_00102d00;
    if (iVar4 != 3) {
      if (iVar4 == 1) goto LAB_00102e20;
      uVar5 = 2;
      if (*(int *)(this + 0x234) == 2) goto LAB_00102c99;
      goto LAB_00102c97;
    }
    uVar5 = 1;
  }
...

{
  ...
  if (*(long *)(lVar1 + 0x78) == 7) {
    if ((**(int **)(lVar1 + 0x70) != 0x61666564) ||
       (*(int *)((long)*(int **)(lVar1 + 0x70) + 3) != 0x746c7561)) goto code_r0x00105288;
...
LAB_001031f7:
      ...
      if (*(long *)(this + 0x290) != 0) goto LAB_00103728;
    }
    else {
      local_30 = 0;
      TaskScheduler::
      ...
      embree::TaskScheduler::wait();
      if (local_30 == 0) goto LAB_001031f7;
      this = (Scene *)&local_28;
      local_28 = local_30;
      std::__exception_ptr::exception_ptr::_M_addref();
    ...
    if (plVar1 != (long *)0x0) {
      ...
      if (plVar1 != (long *)0x0) {
        ...
        if (*(long *)(this + 0x70) != 0) {
          ...
          plVar1 = *(long **)(*(long *)(std::cout + -0x18) + 0x107230);
          if (plVar1 == (long *)0x0) goto LAB_0010396e;
          if ((char)plVar1[7] == '\0') {
            std::ctype<char>::_M_widen_init();
            if (*(code **)(*plVar1 + 0x30) != std::ctype<char>::do_widen) {
              (**(code **)(*plVar1 + 0x30))(plVar1,10);
        ...
        if (*(long *)(this + 0x138) == 0) goto LAB_00103260;
        std::__ostream_insert<char,std::char_traits<char>>((ostream *)&std::cout," ",1);
        std::__ostream_insert<char,std::char_traits<char>>((ostream *)&std::cout," ",1);
        std::__ostream_insert<char,std::char_traits<char>>
      ...
      if (param_1) {
        ...
        if (*(code **)(*plVar4 + 0x18) == RefCount::refDec) {
          ...
          *plVar1 = *plVar1 + -1;
          ...
          if (*plVar1 == 0) {
            if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00103ac9. Too many branches */
            ...
            return;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00103fd0. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  ...
  *(Thread **)(*(long *)(this_00 + 0x10) + lVar9 * 8) = pTVar10;
  ...
  if (*(ulong *)(pTVar10 + 0x40080) < 0x1000) {
    ...
    if (uVar3 < 0x80001) {
      ...
      *(undefined ***)pTVar11 = &PTR_execute_00105cd8;
...

{
  ...
  do {
    while( true ) {
      ...
      this_00 = pvVar11;
      if (local_48 == pvVar11) goto LAB_001041db;
    }
    ...
    if (plVar1 != (long *)0x0) {
      ...
      do {
        ...
        if (sVar8 < 0x10) {
          ...
          else if (sVar8 != 0) goto LAB_00104573;
        }
        else {
          local_368 = (size_t *)
        ...
        *(undefined1 *)((long)psVar10 + local_370) = 0;
        ...
        if (local_370 == 0) {
          ...
          *(undefined8 *)(std::ostream::put + *(long *)(std::cout + -0x18)) = 0x17;
          ...
          plVar1 = *(long **)(*(long *)(std::cout + -0x18) + 0x107230);
          if (plVar1 == (long *)0x0) goto LAB_00104657;
          if ((char)plVar1[7] == '\0') {
            std::ctype<char>::_M_widen_init();
            if (*(code **)(*plVar1 + 0x30) != std::ctype<char>::do_widen) {
              (**(code **)(*plVar1 + 0x30))(plVar1,10);
...

{
  ...
  if (param_1 == 0xffffffff) {
    ...
    uVar15 = (ulong)param_1;
    if (0xfffffffe < uVar15 + 1) goto code_r0x0010529a;
...
LAB_00104c40:
      if ((p_Var2 == p_Var20) || (param_1 < *(uint *)(p_Var20 + 0x20))) goto code_r0x0010529a;
...
LAB_001050f4:
  ...
  if (uVar15 < uVar18) goto LAB_00104f13;
...
LAB_00104d77:
    ...
    *(ulong *)(this + 0x1d0) = uVar22;
    if (uVar18 < uVar22) goto LAB_00104dbb;
LAB_0010508f:
    ...
    *(ulong *)(this + 0x210) = uVar22;
    ...
    uVar21 = uVar19;
    if (uVar22 < uVar18) goto LAB_0010501c;
    if (uVar18 < uVar22) {
      do {
...
LAB_00105078:
    uVar18 = *(ulong *)(this + 0x218);
    *(ulong *)(this + 0x1d0) = uVar22;
    if (uVar22 <= uVar18) goto LAB_0010508f;
LAB_00104dbb:
    if (uVar18 == 0) {
      uVar18 = uVar22;
...

{
  ...
  *(long *)pRVar1 = *(long *)pRVar1 + -1;
  ...
  if ((this != (RefCount *)0x0) && (*(long *)pRVar1 == 0)) {
                    /* WARNING: Could not recover jumptable at 0x001052c9. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(*(long *)this + 8))();
    return;
  }
...

{
  ...
  if (uVar2 < param_1) {
    ...
    *puVar5 = 0;
    if (param_1 - 1 != 0) goto LAB_00105525;
LAB_00105539:
    if (sVar4 == 0) goto LAB_00105542;
  }
  else {
    uVar2 = uVar2 * 2;
...

{
  ...
  if (p_Var5 == (_Rb_tree_node_base *)0x0) {
    ...
    p_Var5 = p_Var6;
    if (uVar2 < uVar3) {
      if (*(_Rb_tree_node_base **)(this + 0x18) == p_Var6) goto LAB_001056c1;

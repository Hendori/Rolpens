...

{
  ...
  bVar8 = PTR__editor_translation_ar_compressed_00105730 != (undefined *)0x0;
...

{
  ...
  puVar5 = PTR__extractable_translation_af_compressed_00105250;
joined_r0x00100807:
...

{
  ...
  puVar5 = PTR__doc_translation_de_compressed_00105b30;
joined_r0x00100d27:
  if (puVar5 == (undefined *)0x0) {
LAB_00100f00:
    if (((local_88 != (Object *)0x0) && (cVar8 = RefCounted::unreference(), cVar8 != '\0')) &&
...

{
  ...
  puVar5 = PTR__property_translation_ar_compressed_00105010;
joined_r0x00101247:
  if (puVar5 == (undefined *)0x0) {
LAB_00101420:
    if (((local_88 != (Object *)0x0) && (cVar8 = RefCounted::unreference(), cVar8 != '\0')) &&
...

{
  ...
  ppuVar7 = &_editor_translations;
  puVar5 = PTR__editor_translation_ar_compressed_00105730;
joined_r0x00101767:
  if (puVar5 == (undefined *)0x0) {
LAB_00101940:
    if (((local_88 != (Object *)0x0) && (cVar8 = RefCounted::unreference(), cVar8 != '\0')) &&
...

{
  ...
  puVar12 = PTR__extractable_translation_af_compressed_00105250;
  if (PTR__extractable_translation_af_compressed_00105250 != (undefined *)0x0) {
    local_120 = &PTR_DAT_00105258;
LAB_00101ec1:
    do {
...
LAB_00104ff6:
    ...
    lVar5 = puVar6[-1];
    if (param_1 <= lVar5) goto LAB_00104e79;
  }
  else {
    if (lVar5 != 0) {
      uVar4 = _realloc(this,lVar10);
  ...
  if (((int)puVar11 - (int)puVar2 & 0x10U) != 0) {
    puVar2[1] = 0;
    puVar2 = puVar2 + 2;
    if (puVar2 == puVar11) goto LAB_00104e79;
  }
  do {
    puVar2[1] = 0;
    puVar3 = puVar2 + 4;

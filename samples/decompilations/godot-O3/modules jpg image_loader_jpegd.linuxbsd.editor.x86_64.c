...
/* ImageLoaderJPG::get_recognized_extensions(List<String, DefaultAllocator>*) const */

void __thiscall ImageLoaderJPG::get_recognized_extensions(ImageLoaderJPG *this,List *param_1)
...
void __thiscall ImageLoaderJPG::ImageLoaderJPG(ImageLoaderJPG *this)

{
  RefCounted::RefCounted((RefCounted *)this);
  *(undefined ***)this = &PTR__initialize_classv_00103778;
...
/* jpeg_load_image_from_buffer(Image*, unsigned char const*, int) */

undefined8 jpeg_load_image_from_buffer(Image *param_1,uchar *param_2,int param_3)

{
  ...
  code *local_3538;
  uchar *local_3530;
  undefined4 local_3528;
  int local_3524;
  jpeg_decoder local_3518 [216];
  int local_3440;
  int local_343c;
  uint local_337c;
  int local_50;
  ...
  local_3528 = 0;
  local_3538 = jpgd::jpeg_decoder::begin_decoding;
  local_3530 = param_2;
  local_3524 = param_3;
  jpgd::jpeg_decoder::jpeg_decoder(local_3518,(jpeg_decoder_stream *)&local_3538,0);
  if (local_50 == 0) {
    if (((local_337c & 0xfffffffd) == 1) &&
       (iVar3 = jpgd::jpeg_decoder::begin_decoding(), iVar3 == 0)) {
      local_3540 = (undefined1 *)0x0;
      iVar3 = local_3440 * local_337c;
      CowData<unsigned_char>::resize<false>
                ((CowData<unsigned_char> *)&local_3540,(long)(iVar3 * local_343c));
      CowData<unsigned_char>::_copy_on_write((CowData<unsigned_char> *)&local_3540);
      if (0 < local_343c) {
        iVar9 = 0;
        puVar8 = local_3540;
        do {
          while( true ) {
            iVar4 = jpgd::jpeg_decoder::decode((void **)local_3518,(uint *)&local_3550);
            if (iVar4 != 0) {
              uVar7 = 0x10;
              goto LAB_00100fe6;
            }
            if (local_337c == 1) break;
            lVar5 = 1;
            puVar6 = puVar8;
            if (0 < local_3440) {
              do {
                *puVar6 = *(undefined1 *)((long)local_3550 + lVar5 + -1);
                puVar6[1] = *(undefined1 *)((long)local_3550 + lVar5);
                lVar2 = lVar5 + 1;
                lVar5 = lVar5 + 4;
                puVar6[2] = *(undefined1 *)((long)local_3550 + lVar2);
                puVar6 = puVar6 + 3;
              } while ((long)local_3440 * 4 + 1 != lVar5);
            }
            iVar9 = iVar9 + 1;
            puVar8 = puVar8 + iVar3;
            if (iVar9 == local_343c) goto LAB_00100fbb;
          }
          iVar9 = iVar9 + 1;
          memcpy(puVar8,local_3550,(long)local_3440);
          puVar8 = puVar8 + iVar3;
        } while (iVar9 != local_343c);
      }
LAB_00100fbb:
      uVar7 = 0;
      Image::set_data(param_1,local_3440,local_343c,0,(local_337c != 1) * '\x04',local_3548);
LAB_00100fe6:
      puVar8 = local_3540;
      if (local_3540 != (undefined1 *)0x0) {
        LOCK();
        plVar1 = (long *)(local_3540 + -0x10);
        *plVar1 = *plVar1 + -1;
        UNLOCK();
        if (*plVar1 == 0) {
          local_3540 = (undefined1 *)0x0;
  ...
  jpgd::jpeg_decoder::~jpeg_decoder(local_3518);
...
/* ImageLoaderJPG::load_image(Ref<Image>, Ref<FileAccess>, BitField<ImageFormatLoader::LoaderFlags>,
   float) */

undefined4 ImageLoaderJPG::load_image(undefined8 param_1,undefined8 *param_2,undefined8 *param_3)

{
  ...
  lVar4 = (**(code **)(*(long *)*param_3 + 0x1d0))();
  if (lVar4 == 0) {
    uVar3 = 0x10;
    _err_print_error("load_image","modules/jpg/image_loader_jpegd.cpp",0x6c,
                     "Condition \"src_image_len == 0\" is true. Returning: ERR_FILE_CORRUPT",0,0);
  }
  else {
    CowData<unsigned_char>::resize<false>((CowData<unsigned_char> *)local_40,lVar4);
    CowData<unsigned_char>::_copy_on_write((CowData<unsigned_char> *)local_40);
    puVar2 = local_40[0];
    (**(code **)(*(long *)*param_3 + 0x220))((long *)*param_3,local_40[0],lVar4);
    uVar3 = jpeg_load_image_from_buffer((Image *)*param_2,puVar2,(int)lVar4);
    if (puVar2 != (uchar *)0x0) {
      LOCK();
      ...
      *plVar1 = *plVar1 + -1;
      UNLOCK();
      if (*plVar1 == 0) {
        Memory::free_static(local_40[0] + -0x10,false);
      }
    }
  }
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
...
/* ImageLoaderJPGOSFile::put_buf(void const*, int) */

undefined8 __thiscall
ImageLoaderJPGOSFile::put_buf(ImageLoaderJPGOSFile *this,void *param_1,int param_2)

{
  (**(code **)(**(long **)(this + 8) + 0x2d0))(*(long **)(this + 8),param_1,(long)param_2);
  return 1;
}



/* ImageLoaderJPGOSBuffer::~ImageLoaderJPGOSBuffer() */

void __thiscall ImageLoaderJPGOSBuffer::~ImageLoaderJPGOSBuffer(ImageLoaderJPGOSBuffer *this)
...
{
  *(undefined ***)this = &PTR__initialize_classv_00103618;
...
/* ImageLoaderJPGOSFile::~ImageLoaderJPGOSFile() */

void __thiscall ImageLoaderJPGOSFile::~ImageLoaderJPGOSFile(ImageLoaderJPGOSFile *this)

{
  Object *pOVar1;
  char cVar2;
  
  *(undefined ***)this = &PTR__ImageLoaderJPGOSFile_001038e8;
  if (*(long *)(this + 8) != 0) {
...
LAB_001022a8:
    ...
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_001022a8;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)pLVar6;
      local_68 = local_80;
      goto joined_r0x001022c6;
    }
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialize_class()::initialized != '\0') goto LAB_00102aeb;
...
LAB_00102c0a:
      ...
      *plVar1 = *plVar1 + -1;
      UNLOCK();
      if (*plVar1 != 0) goto LAB_00102bfa;
      local_68 = 0;
      Memory::free_static((void *)(lVar2 + -0x10),false);
      if ((code *)PTR__bind_methods_00106010 != RefCounted::_bind_methods) goto LAB_00102c0a;
    }
...
/* WARNING: Removing unreachable block (ram,0x00102e78) */
/* WARNING: Removing unreachable block (ram,0x00102fa8) */
/* WARNING: Removing unreachable block (ram,0x00103170) */
/* WARNING: Removing unreachable block (ram,0x00102fb4) */
/* WARNING: Removing unreachable block (ram,0x00102fbe) */
/* WARNING: Removing unreachable block (ram,0x00103150) */
/* WARNING: Removing unreachable block (ram,0x00102fca) */
/* WARNING: Removing unreachable block (ram,0x00102fd4) */
/* WARNING: Removing unreachable block (ram,0x00103130) */
/* WARNING: Removing unreachable block (ram,0x00102fe0) */
/* WARNING: Removing unreachable block (ram,0x00102fea) */
/* WARNING: Removing unreachable block (ram,0x00103110) */
...
/* WARNING: Removing unreachable block (ram,0x0010300c) */
/* WARNING: Removing unreachable block (ram,0x00103016) */
/* WARNING: Removing unreachable block (ram,0x001030d0) */
/* WARNING: Removing unreachable block (ram,0x00103022) */
/* WARNING: Removing unreachable block (ram,0x0010302c) */
/* WARNING: Removing unreachable block (ram,0x001030b0) */
/* WARNING: Removing unreachable block (ram,0x00103034) */
/* WARNING: Removing unreachable block (ram,0x0010304a) */
/* WARNING: Removing unreachable block (ram,0x00103056) */
...
/* ImageLoaderJPGOSBuffer::put_buf(void const*, int) */

undefined8 __thiscall
ImageLoaderJPGOSBuffer::put_buf(ImageLoaderJPGOSBuffer *this,void *param_1,int param_2)

{
  ...
  CowData<unsigned_char>::resize<false>
            ((CowData<unsigned_char> *)(*(long *)(this + 8) + 8),(ulong)(uint)(param_2 + iVar2));
  lVar1 = *(long *)(this + 8);
  CowData<unsigned_char>::_copy_on_write((CowData<unsigned_char> *)(lVar1 + 8));
  memcpy((void *)(*(long *)(lVar1 + 8) + uVar3),param_1,(long)param_2);
  return 1;
}

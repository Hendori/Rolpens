...
ulong lerp_color_int(ulong param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  iVar2 = (int)((ulong)param_2 >> 0x20) * (_UNK_00101cb4 - iVar2) +
          (int)((ulong)param_3 >> 0x20) * iVar2 + _UNK_00101cc4;
  return param_1 & CONCAT44((iVar2 >> 0xe) * _UNK_00101cd4,(iVar1 >> 0xe) * _LC3) |
         ~param_1 & CONCAT44(iVar2 >> 6,iVar1 >> 6);
}



/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* unpack_weights(block_size_descriptor const&, symbolic_compressed_block const&, decimation_info
   const&, bool, int*, int*) */

void unpack_weights(block_size_descriptor *param_1,symbolic_compressed_block *param_2,
                   decimation_info *param_3,bool param_4,int *param_5,int *param_6)
  ...
  if (param_4) {
    if (param_1[3] != (block_size_descriptor)0x0) {
      ...
      do {
        ...
        do {
          ...
          uVar60 = (int)(((ulong)CONCAT14(bVar3,(uint)*(byte *)((long)&local_78 +
                                                               (long)auVar20._8_4_)) & 0xffffffff) *
                        ((ulong)uVar16 & 0xffffffff)) + uVar60;
          ...
          uVar50 = (int)(((ulong)uVar16 & 0xffffffff) *
                        ((ulong)CONCAT14(bVar4,(uint)*(byte *)((long)&local_78 + (long)auVar20._8_4_
                                                              )) & 0xffffffff)) + uVar50;
    ...
    do {
      ...
      do {
        ...
        uVar50 = (int)(((ulong)CONCAT14(bVar3,(uint)*(byte *)((long)&local_78 + (long)auVar12._8_4_)
                                       ) & 0xffffffff) * ((ulong)uVar16 & 0xffffffff)) + uVar50;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* decompress_symbolic_block(astcenc_profile, block_size_descriptor const&, int, int, int,
   symbolic_compressed_block const&, image_block&) */

void decompress_symbolic_block
               (undefined8 param_1,uint param_2,block_size_descriptor *param_3,undefined4 param_4,
               undefined4 param_5,undefined4 param_6,symbolic_compressed_block *param_7,long param_8
               )

{
  ...
  *(undefined1 (*) [16])(param_8 + 0xdd0) = (undefined1  [16])0x0;
  *(undefined1 (*) [16])(param_8 + 0xde0) = (undefined1  [16])0x0;
  *(undefined1 (*) [16])(param_8 + 0xdf0) = (undefined1  [16])0x0;
  uVar28 = _LC7;
  sVar2 = *param_7;
  if (sVar2 == (symbolic_compressed_block)0x0) {
    if (param_3[3] != (block_size_descriptor)0x0) {
      ...
      do {
        ...
        *(undefined4 *)(param_8 + 0x370 + lVar23 * 4) = uVar28;
        *(undefined4 *)(param_8 + 0x6e0 + lVar23 * 4) = uVar28;
        *(undefined4 *)(param_8 + 0xa50 + lVar23 * 4) = uVar28;
    ...
    if (sVar2 == (symbolic_compressed_block)0x2) {
      ...
      uVar42 = _UNK_00101d08 &
               (uint)((auVar36._8_8_ & 0xffffffff) *
                     (ulong)(uint)(int)(float)((_UNK_00101d38 + uVar56) * 0x800000));
      sVar17 = (short)__LC15;
      ...
      in_XMM0_Dd = sf16_to_float(-(ushort)((int)uVar62 < _UNK_00101d1c) & (ushort)(uVar62 << 8) |
                                 ~-(ushort)((int)uVar62 < _UNK_00101d1c) &
                                 (-(ushort)(uVar62 == _UNK_00101d0c) & (ushort)_UNK_00101d5c |
                                 ~-(ushort)(uVar62 == _UNK_00101d0c) &
                                 ((ushort)((_UNK_00101d0c &
                                           uVar62 * (int)(float)((_UNK_00101d3c + uVar63) * 0x800000
                                                                )) >> 6) |
                                 ((short)_UNK_00101d4c - (short)uVar63) * 0x400)));
      in_XMM0_Dc = sf16_to_float(-(ushort)bVar10 & (ushort)(uVar34 << 8) |
                                 ~-(ushort)bVar10 &
                                 (-(ushort)bVar7 & uVar13 |
                                 ~-(ushort)bVar7 &
                                 ((ushort)(uVar42 >> 6) | (sVar14 - (short)uVar56) * 0x400)));
      uVar29 = sf16_to_float(-(ushort)bVar9 & (ushort)(uVar33 << 8) |
                             ~-(ushort)bVar9 &
                             (-(ushort)bVar6 & uVar15 |
                             ~-(ushort)bVar6 &
                             ((ushort)(uVar40 >> 6) | (sVar16 - (short)uVar60) * 0x400)));
      uVar28 = sf16_to_float(-(ushort)bVar8 & (ushort)(uVar25 << 8) |
                             ~-(ushort)bVar8 &
                             (-(ushort)bVar5 & uVar35 |
                             ~-(ushort)bVar5 &
                             ((ushort)(uVar21 >> 6) | (sVar17 - (short)uVar50) * 0x400)));
      uVar20 = 0;
    }
    else if (param_2 < 2) {
      uVar20 = 0;
    ...
    if (uVar25 < 2) {
      ...
      lVar23 = ((ulong)(uVar21 * 0x400) +
               (ulong)*(ushort *)
                       (param_3 +
                       ((ulong)*(ushort *)(param_7 + 6) + 0x703cd8 + (ulong)uVar21 * 0x400) * 2)) *
               0x450;
    }
    unpack_weights(param_3,param_7,
                   (decimation_info *)
                   (param_3 +
                   (ulong)(byte)param_3[(ulong)*(ushort *)
                                                (param_3 +
                                                (ulong)*(ushort *)(param_7 + 4) * 2 + 0xac7560) * 6
                                        + 0xac8562] * 0x1fb70 + 0x250),
                   (bool)((byte)param_3[(ulong)*(ushort *)
                                                (param_3 +
                                                (ulong)*(ushort *)(param_7 + 4) * 2 + 0xac7560) * 6
                                        + 0xac8565] & 1),local_708,local_3a8);
    ...
    if (uVar25 != 0) {
      ...
      do {
        unpack_color_endpoints
                  (param_2,param_7[lVar27 + 8],psVar24,&local_72a,&local_729,local_728,local_718);
...
LAB_0010076c:
              ...
              uVar47 = -(ushort)((int)uVar40 < _LC22) & (ushort)(uVar40 << 8) |
                       ~-(ushort)((int)uVar40 < _LC22) &
                       (-(ushort)(uVar40 == __LC14) & (ushort)__LC16 |
                       ~-(ushort)(uVar40 == __LC14) &
                       ((ushort)(((uint)((auVar32._0_8_ & 0xffffffff) *
                                        (ulong)(uint)(int)(float)((__LC13 + uVar62) * 0x800000)) &
                                 __LC14) >> 6) | ((short)__LC15 - (short)uVar62) * 0x400));
              uVar48 = -(ushort)((int)uVar33 < _UNK_00101d14) & (ushort)(uVar33 << 8) |
                       ~-(ushort)((int)uVar33 < _UNK_00101d14) &
                       (-(ushort)(uVar33 == _UNK_00101d04) & (ushort)_UNK_00101d54 |
                       ~-(ushort)(uVar33 == _UNK_00101d04) &
                       ((ushort)((uVar33 * (int)(float)((_UNK_00101d34 + uVar63) * 0x800000) &
                                 _UNK_00101d04) >> 6) |
                       ((short)_UNK_00101d44 - (short)uVar63) * 0x400));
              uVar49 = -(ushort)((int)uVar34 < (int)DAT_00101d18) & (ushort)(uVar34 << 8) |
                       ~-(ushort)((int)uVar34 < (int)DAT_00101d18) &
                       (-(ushort)(uVar34 == _UNK_00101d08) & (ushort)_UNK_00101d58 |
                       ~-(ushort)(uVar34 == _UNK_00101d08) &
                       ((ushort)(((uint)((extraout_XMM0_Qb & 0xffffffff) *
                                        (ulong)(uint)(int)(float)((_UNK_00101d38 + uVar50) *
                                                                 0x800000)) & _UNK_00101d08) >> 6) |
                       ((short)_UNK_00101d48 - (short)uVar50) * 0x400));
              uVar51 = -(ushort)((int)uVar42 < _UNK_00101d1c) & (ushort)(uVar42 << 8) |
                       ~-(ushort)((int)uVar42 < _UNK_00101d1c) &
                       (-(ushort)(uVar42 == _UNK_00101d0c) & (ushort)_UNK_00101d5c |
                       ~-(ushort)(uVar42 == _UNK_00101d0c) &
                       ((ushort)(((uint)((extraout_XMM0_Qb >> 0x20) *
                                        (ulong)(uint)(int)(float)((_UNK_00101d3c + uVar60) *
                                                                 0x800000)) & _UNK_00101d0c) >> 6) |
                       ((short)_UNK_00101d4c - (short)uVar60) * 0x400));
            }
            else {
              ...
              uVar62 = (uVar40 >> 0xb) << 10 |
                       (-(uint)(iVar54 < __LC21) & iVar54 * _LC20 |
                       ~-(uint)(iVar54 < __LC21) &
                       (iVar54 * _LC22 + __LC27 & -(uint)(iVar54 < __LC23) |
                       ~-(uint)(iVar54 < __LC23) & iVar54 * _LC25 + __LC26)) >> 3;
              uVar63 = (uVar33 >> 0xb) << 10 |
                       (-(uint)(iVar52 < _UNK_00101d94) & iVar18 * iVar52 |
                       ~-(uint)(iVar52 < _UNK_00101d94) &
                       (_UNK_00101d14 * iVar52 + _UNK_00101dd4 & -(uint)(iVar52 < _UNK_00101da4) |
                       ~-(uint)(iVar52 < _UNK_00101da4) & iVar52 * _UNK_00101db4 + _UNK_00101dc4))
                       >> 3;
              uVar50 = (uVar34 >> 0xb) << 10 |
                       (uVar50 & (uint)((uVar55 & 0xffffffff) * (ulong)DAT_00101d88) |
                       ~uVar50 & ((int)((uVar55 & 0xffffffff) * (ulong)DAT_00101d18) + _UNK_00101dd8
                                  & uVar60 |
                                 ~uVar60 & (int)((uVar55 & 0xffffffff) * (ulong)DAT_00101db8) +
                                           _UNK_00101dc8)) >> 3;
              uVar60 = (uVar42 >> 0xb) << 10 |
                       (-(uint)(iVar53 < _UNK_00101d9c) & iVar19 * iVar53 |
                       ~-(uint)(iVar53 < _UNK_00101d9c) &
                       (_UNK_00101d1c * iVar53 + _UNK_00101ddc & -(uint)(iVar53 < _UNK_00101dac) |
                       ~-(uint)(iVar53 < _UNK_00101dac) & iVar53 * _UNK_00101dbc + _UNK_00101dcc))
                       >> 3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* compute_symbolic_block_difference_2plane(astcenc_config const&, block_size_descriptor const&,
   symbolic_compressed_block const&, image_block const&) */

void compute_symbolic_block_difference_2plane
               (astcenc_config *param_1,block_size_descriptor *param_2,
               symbolic_compressed_block *param_3,image_block *param_4)

{
  ...
  if (*param_3 != (symbolic_compressed_block)0x0) {
    unpack_weights(param_2,param_3,
                   (decimation_info *)
                   (param_2 +
                   (ulong)(byte)param_2[(ulong)*(ushort *)
                                                (param_2 +
                                                (ulong)*(ushort *)(param_3 + 4) * 2 + 0xac7560) * 6
                                        + 0xac8562] * 0x1fb70 + 0x250),true,local_708,local_3a8);
    unpack_color_endpoints
              (*(undefined4 *)param_1,param_3[8],param_3 + 0x14,&local_72a,&local_729,local_728,
               local_718);
    ...
    if (param_2[3] != (block_size_descriptor)0x0) {
      ...
      do {
        ...
        auVar9._0_4_ = auVar8._0_4_ * auVar8._0_4_ * *(float *)(param_4 + 0xe00) +
                       auVar8._8_4_ * auVar8._8_4_ * *(float *)(param_4 + 0xe08) +
                       auVar8._4_4_ * auVar8._4_4_ * *(float *)(param_4 + 0xe04) +
                       auVar8._12_4_ * auVar8._12_4_ * *(float *)(param_4 + 0xe0c);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* compute_symbolic_block_difference_1plane(astcenc_config const&, block_size_descriptor const&,
   symbolic_compressed_block const&, image_block const&) */
...

{
  ...
  if (*param_3 != (symbolic_compressed_block)0x0) {
    ...
    if (uVar11 < 2) {
      ...
      lVar4 = ((ulong)(uVar6 * 0x400) +
              (ulong)*(ushort *)
                      (param_2 +
                      ((ulong)*(ushort *)(param_3 + 6) + 0x703cd8 + (ulong)uVar6 * 0x400) * 2)) *
              0x450;
    }
    unpack_weights(param_2,param_3,
                   (decimation_info *)
                   ...
                   (ulong)(byte)param_2[(ulong)*(ushort *)
                                                (param_2 +
                                                (ulong)*(ushort *)(param_3 + 4) * 2 + 0xac7560) * 6
                                        + 0xac8562] * 0x1fb70 + 0x250),false,local_3a8,(int *)0x0);
    ...
    if (uVar11 != 0) {
      ...
      while( true ) {
        unpack_color_endpoints
                  (uVar26,param_3[lVar13 + 8],psVar7,&local_3ca,&local_3c9,local_3c8,local_3b8);
        ...
        if (bVar2 != (block_size_descriptor)0x0) {
          ...
          do {
            ...
            auVar17._0_4_ =
                 auVar16._0_4_ * auVar16._0_4_ * *(float *)(param_4 + 0xe00) +
                 auVar16._8_4_ * auVar16._8_4_ * *(float *)(param_4 + 0xe08) +
                 auVar16._4_4_ * auVar16._4_4_ * *(float *)(param_4 + 0xe04) +
                 auVar16._12_4_ * auVar16._12_4_ * *(float *)(param_4 + 0xe0c);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* compute_symbolic_block_difference_1plane_1partition(astcenc_config const&, block_size_descriptor
   const&, symbolic_compressed_block const&, image_block const&) */
  ...
  if (*param_3 != (symbolic_compressed_block)0x0) {
    ...
    unpack_weights(param_2,param_3,
                   ...
                   (ulong)(byte)param_2[(ulong)*(ushort *)
                                                (param_2 +
                                                (ulong)*(ushort *)(param_3 + 4) * 2 + 0xac7560) * 6
                                        + 0xac8562] * 0x1fb70 + 0x250),false,piVar6,(int *)0x0);
    unpack_color_endpoints
              (*(undefined4 *)param_1,param_3[8],param_3 + 0x14,&local_3ba,&local_3b9,&local_3b8,
               &local_3a8);
    fVar7 = -NAN;
    fVar13 = -NAN;
    fVar15 = -NAN;
    ...
    if (param_2[3] != (block_size_descriptor)0x0) {
      ...
      do {
        ...
        iVar16 = (int)((auVar9._8_8_ & 0xffffffff) * (ulong)uStack_3ac) + iStack_39c * iVar23 +
                 _UNK_00101cc8;
        ...
        auVar39._0_4_ =
             *(float *)(param_4 + 0x6e0) -
             (float)(int)(auVar41._0_4_ * _LC3 & uVar4 | ~uVar4 & iVar19 >> 6);
        auVar39._4_4_ =
             *(float *)(param_4 + 0x6e4) -
             (float)(int)(auVar41._4_4_ * _UNK_00101cd4 & uVar4 | ~uVar4 & iVar22 >> 6);
        auVar39._8_4_ =
             *(float *)(param_4 + 0x6e8) -
             (float)(int)((uint)((auVar41._8_8_ & 0xffffffff) * (ulong)DAT_00101cd8) & uVar4 |
                         ~uVar4 & iVar23 >> 6);
        auVar39._12_4_ =
             *(float *)(param_4 + 0x6ec) -
             (float)(int)(auVar41._12_4_ * _UNK_00101cdc & uVar4 | ~uVar4 & iVar24 >> 6);
        auVar10._0_4_ =
             *(float *)param_4 - (float)(int)(auVar38._0_4_ * _LC3 & uVar2 | ~uVar2 & iVar30 >> 6);
        auVar10._4_4_ =
             *(float *)(param_4 + 4) -
             (float)(int)(auVar38._4_4_ * _UNK_00101cd4 & uVar2 | ~uVar2 & iVar33 >> 6);
        auVar10._8_4_ =
             *(float *)(param_4 + 8) -
             (float)(int)((uint)((auVar38._8_8_ & 0xffffffff) * (ulong)DAT_00101cd8) & uVar2 |
                         ~uVar2 & iVar34 >> 6);
        auVar10._12_4_ =
             *(float *)(param_4 + 0xc) -
             (float)(int)(auVar38._12_4_ * _UNK_00101cdc & uVar2 | ~uVar2 & iVar35 >> 6);
        auVar26._0_4_ =
             *(float *)(param_4 + 0xa50) -
             (float)(int)(auVar42._0_4_ * _LC3 & uVar5 | ~uVar5 & iVar8 >> 6);
        auVar26._4_4_ =
             *(float *)(param_4 + 0xa54) -
             (float)(int)(auVar42._4_4_ * _UNK_00101cd4 & uVar5 | ~uVar5 & iVar14 >> 6);
        auVar26._8_4_ =
             *(float *)(param_4 + 0xa58) -
             (float)(int)((uint)((auVar42._8_8_ & 0xffffffff) * (ulong)DAT_00101cd8) & uVar5 |
                         ~uVar5 & iVar16 >> 6);
        auVar26._12_4_ =
             *(float *)(param_4 + 0xa5c) -
             (float)(int)(auVar42._12_4_ * _UNK_00101cdc & uVar5 | ~uVar5 & iVar18 >> 6);
        ...
        auVar11._0_4_ =
             *(float *)(param_4 + 0x370) -
             (float)(int)(auVar40._0_4_ * _LC3 & uVar3 | ~uVar3 & iVar25 >> 6);
        auVar11._4_4_ =
             *(float *)(param_4 + 0x374) -
             (float)(int)(auVar40._4_4_ * _UNK_00101cd4 & uVar3 | ~uVar3 & iVar27 >> 6);
        auVar11._8_4_ =
             *(float *)(param_4 + 0x378) -
             (float)(int)((uint)((auVar40._8_8_ & 0xffffffff) * (ulong)DAT_00101cd8) & uVar3 |
                         ~uVar3 & iVar28 >> 6);
        auVar11._12_4_ =
             *(float *)(param_4 + 0x37c) -
             (float)(int)(auVar40._12_4_ * _UNK_00101cdc & uVar3 | ~uVar3 & iVar29 >> 6);
        auVar32._4_4_ = _LC36;
        auVar32._0_4_ = _LC36;
        auVar32._8_4_ = _LC36;

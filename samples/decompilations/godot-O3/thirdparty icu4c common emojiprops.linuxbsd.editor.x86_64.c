...
/* icu_76_godot::EmojiProps::isAcceptable(void*, char const*, char const*, UDataInfo const*) */

bool icu_76_godot::EmojiProps::isAcceptable
               (void *param_1,char *param_2,char *param_3,UDataInfo *param_4)

{
  if ((((0x13 < *(ushort *)param_4) && (*(short *)(param_4 + 4) == 0)) &&
      (param_4[8] == (UDataInfo)0x45)) &&
     (((param_4[9] == (UDataInfo)0x6d && (param_4[10] == (UDataInfo)0x6f)) &&
      (param_4[0xb] == (UDataInfo)0x6a)))) {
...
/* icu_76_godot::(anonymous namespace)::emojiprops_cleanup() */

undefined8 icu_76_godot::(anonymous_namespace)::emojiprops_cleanup(void)
...
/* icu_76_godot::EmojiProps::~EmojiProps() */

void __thiscall icu_76_godot::EmojiProps::~EmojiProps(EmojiProps *this)
...
/* icu_76_godot::EmojiProps::load(UErrorCode&) */

void __thiscall icu_76_godot::EmojiProps::load(EmojiProps *this,UErrorCode *param_1)

{
  ...
  *(undefined8 *)this = uVar2;
  if (iVar1 < 1) {
    ...
    uVar2 = ucptrie_openFromBinary_76_godot
                      (0,2,(long)iVar1 + (long)piVar3,piVar3[1] - iVar1,0,param_1);
...
/* icu_76_godot::(anonymous namespace)::initSingleton(UErrorCode&) [clone .part.0] */

void __thiscall
icu_76_godot::(anonymous_namespace)::initSingleton(_anonymous_namespace_ *this,UErrorCode *param_1)
...
/* icu_76_godot::EmojiProps::getSingleton(UErrorCode&) */

undefined8 __thiscall icu_76_godot::EmojiProps::getSingleton(EmojiProps *this,UErrorCode *param_1)
...
/* icu_76_godot::EmojiProps::addPropertyStarts(USetAdder const*, UErrorCode&) const */

void icu_76_godot::EmojiProps::addPropertyStarts(USetAdder *param_1,UErrorCode *param_2)
...
/* icu_76_godot::EmojiProps::hasBinaryProperty(int, UProperty) */

bool icu_76_godot::EmojiProps::hasBinaryProperty(uint param_1,UErrorCode *param_2)

{
  ...
  if ((anonymous_namespace)::emojiInitOnce == 2) {
LAB_00100363:
    if (DAT_00100844 < 1) goto LAB_001003c7;
  }
  else {
    pUVar7 = param_2;
...
/* icu_76_godot::EmojiProps::hasBinaryPropertyImpl(int, UProperty) const */

bool __thiscall
icu_76_godot::EmojiProps::hasBinaryPropertyImpl(EmojiProps *this,uint param_1,int param_3)

{
  ...
  if (param_3 - 0x39U < 0xf) {
    ...
    if (-1 < cVar1) {
      ...
      lVar3 = plVar2[1];
      if (param_1 < 0x10000) {
        lVar5 = (long)(int)((uint)*(ushort *)(*plVar2 + (long)((int)param_1 >> 6) * 2) +
                           (param_1 & 0x3f));
      }
      else if (param_1 < 0x110000) {
...
/* icu_76_godot::EmojiProps::hasBinaryPropertyImpl(char16_t const*, int, UProperty) const */

undefined8 __thiscall
icu_76_godot::EmojiProps::hasBinaryPropertyImpl
          (EmojiProps *this,short *param_1,int param_2,int param_4)

{
  ...
  if ((((param_1 != (short *)0x0) || (param_2 == 0)) &&
      ((0 < param_2 || ((param_2 != 0 && (*param_1 != 0)))))) && (param_4 - 0x41U < 7)) {
    iVar5 = param_4;
    if (param_4 == 0x47) {
      iVar5 = 0x46;
      param_4 = 0x41;
...
/* icu_76_godot::EmojiProps::hasBinaryProperty(char16_t const*, int, UProperty) */

bool icu_76_godot::EmojiProps::hasBinaryProperty
               (undefined8 param_1,UErrorCode *param_2,undefined4 param_3)

{
  ...
  if ((anonymous_namespace)::emojiInitOnce == 2) {
LAB_00100688:
    if (DAT_00100844 < 1) goto LAB_001006e7;
  }
  else {
    cVar1 = icu_76_godot::umtx_initImplPreInit((UInitOnce *)&(anonymous_namespace)::emojiInitOnce);
...
/* icu_76_godot::EmojiProps::addStrings(USetAdder const*, UProperty, UErrorCode&) const */

void __thiscall
icu_76_godot::EmojiProps::addStrings(EmojiProps *this,undefined8 *param_1,int param_3,int *param_4)

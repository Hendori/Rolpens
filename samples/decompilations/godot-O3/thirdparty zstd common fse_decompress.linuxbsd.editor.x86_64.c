...

{
  ...
  if ((!bVar27 && 0xff >= param_3) && (uVar14 = 0xffffffffffffffd4, param_4 < 0xd)) {
    uVar18 = param_3 + 1;
...

{
  ...
  if ((param_7 < 0x200) ||
     ...
     0xffffffffffffff88 < uVar15)) goto LAB_00100737;
  if ((param_5 < local_48) ||
                  ...
                  while( true ) {
                    ...
                    *puVar21 = (char)puVar5[1];
                    ...
                    if (puVar22 + ((ulong)(param_1 + ((param_2 + -1) - (long)puVar22)) &
                                  0xfffffffffffffffe) == puVar21) goto LAB_00101950;

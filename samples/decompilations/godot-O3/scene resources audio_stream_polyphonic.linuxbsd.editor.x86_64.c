...
uint AudioStreamPlaybackPolyphonic::mix(AudioFrame *param_1,float param_2,int param_3)
      ...
      if ((pcVar15[2] == '\0') || (fVar17 = 0.0, pcVar15[1] == '\0')) {
        ...
        if (in_EDX != 0) {
          ...
          do {
            ...
            iVar5 = (**(code **)(**(long **)(pcVar15 + 0x18) + 0x198))
                              (*(long **)(pcVar15 + 0x18),param_1 + 0x280);
            if (0 < (int)uVar14) {
              lVar9 = 0;
              ...
              do {
                ...
                *puVar7 = CONCAT44(fVar19 * (float)((ulong)*(undefined8 *)(param_1 + lVar2 + 0x280)
                                                   >> 0x20) + (float)((ulong)*puVar7 >> 0x20),
                                   fVar19 * (float)*(undefined8 *)(param_1 + lVar2 + 0x280) +
                                   (float)*puVar7);
                puVar7 = puVar7 + 1;
                fVar19 = fVar18;
  ...
  if (cVar2 == '\0') {
    ...
    *(AudioStreamPlaybackPolyphonic **)(lVar1 + 0x188) = this;
    ...
    if (((pOVar4 == (Object *)0x0) || (cVar2 = RefCounted::unreference(), cVar2 == '\0')) ||
       (cVar2 = predelete_handler(pOVar4), cVar2 == '\0')) goto LAB_00100af1;
  }
        ...
        if (*(char *)(*(long *)(this + 0x278) + lVar19) == '\0') {
          ...
          *(undefined1 *)(*(long *)(this + 0x278) + lVar19) = 1;
          if (((param_6 != 2) ||
             ...
             (cVar6 = (**(code **)(*(long *)*param_1 + 0x210))(), cVar6 == '\0')) goto LAB_001025d7;
...
/* WARNING: Removing unreachable block (ram,0x00108828) */

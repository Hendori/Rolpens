    ...
    if (-1 < iVar5) {
      ...
      do {
        while( true ) {
          ...
          iVar6 = uVar2 + 1;
          if (iVar5 < iVar6) goto LAB_00100447;
        }
        iVar5 = uVar2 - 1;
      } while (iVar6 <= iVar5);
    }
      ...
      if (uStack_1c0 != 0) {
        ...
        while( true ) {
          ...
          while (phVar18[0x12] == (hb_buffer_t)0x6) {
            ...
            if (*local_1a0 +
                ((ulong)((*(uint *)(*pphStack_1a8 + 0x60) - 2) - iVar17) + (ulong)uVar3) * 0x14 +
                0x14 == phVar18) goto LAB_0010223f;
          }
          if ((0x1c00U >> (*(ushort *)(phVar18 + 0x10) & 0x1f) & 1) == 0) break;
        }
LAB_0010223f:
...
LAB_00101806:
        ...
        while( true ) {
          do {
            uVar7 = uVar7 - 1;
            if (uVar7 == 0) {
              if ((int)puStack_d0 == 0) goto LAB_00101940;
              goto LAB_00101806;
            }
            phVar18 = phVar9 + 0x26;
            phVar9 = phVar9 + 0x14;
          ...
          while (phVar18[0x12] == (hb_buffer_t)0x6) {
            ...
            if (*local_1a0 +
                ...
                0x14 == phVar18) goto LAB_00101930;
          }
          if ((0x1c00U >> (*(ushort *)(phVar18 + 0x10) & 0x1f) & 1) == 0) break;
        }
LAB_00101930:
        ...
        while( true ) {
          ...
          while (phVar18[0x12] == (hb_buffer_t)0x6) {
            ...
            if (*local_1a0 +
                ...
                0x14 == phVar18) goto LAB_00101431;
          }
          if ((0x1c00U >> (*(ushort *)(phVar18 + 0x10) & 0x1f) & 1) == 0) break;
        }
LAB_00101431:
...
LAB_00101df9:
        ...
        while( true ) {
          do {
            uVar7 = uVar7 - 1;
            if (uVar7 == 0) {
              if ((int)puStack_d0 == 0) goto LAB_00101f33;
              goto LAB_00101df9;
            }
            phVar18 = phVar9 + 0x26;
            phVar9 = phVar9 + 0x14;
          ...
          while (phVar18[0x12] == (hb_buffer_t)0x6) {
            ...
            if (*local_1a0 +
                ((ulong)((*(uint *)(*pphStack_1a8 + 0x60) - uVar3) - 2) + (ulong)uVar1) * 0x14 +
                0x14 == phVar18) goto LAB_00101f23;
          }
          if ((0x1c00U >> (*(ushort *)(phVar18 + 0x10) & 0x1f) & 1) == 0) break;
        }
LAB_00101f23:
...
LAB_0010103a:
    ...
    if (uStack_1c0 == 0) {
      ...
      ___stack_chk_fail = uVar22;
      _message_impl = uVar12;
      if (iVar11 == 0) goto LAB_0010317b;
      if (uVar20 != uVar4) goto LAB_00101096;
LAB_001010c5:
      __hb_CrapPool = __hb_NullPool;
      ___stack_chk_fail = uVar22;
      _message_impl = uVar12;
...
LAB_0010317b:
        ...
        if (uVar20 == uVar4) {
          iVar11 = 0;
          if (uStack_1c0 == 0) goto LAB_001010c5;
          goto LAB_001010d6;
        }
        goto LAB_00101096;
      }
    ...
    iVar13 = iVar11;
    if (uVar20 != uVar7) goto LAB_00100f25;
LAB_00100f90:
    uVar20 = uVar7;
    iVar11 = iVar13;
    if (*(short *)(_use_syllable_machine_eof_trans + lVar10 * 2) < 1) goto LAB_00100f25;
    uVar7 = (int)*(short *)(_use_syllable_machine_eof_trans + lVar10 * 2) - 1;
  } while( true );
LAB_00100d08:
  if ((hVar16 != (hb_buffer_t)0xe) || (uVar4 = uStack_1d0 + 1, uVar7 <= uVar4)) goto LAB_00100a90;
  ...
  phVar18 = local_1c8;
  if ((0x1c00U >> (*(ushort *)(phVar9 + 0x10) & 0x1f) & 1) == 0) goto LAB_00100a90;
  while( true ) {
    uStack_1d0 = uVar4;
    uVar20 = uVar20 - 1;
    local_1c8 = phVar18 + 0x14;
    if (uVar20 == 0) goto LAB_00100a90;
    hVar16 = phVar18[0x26];
...
LAB_00101096:
  ...
  uVar3 = uStack_1c0;
  if (_use_syllable_machine_from_state_actions[lVar15] == '\x03') goto LAB_00100c50;
  goto LAB_00100c90;
}
...

{
  ...
  if (uVar3 == 0) {
    ...
    do {
      ...
      lVar21 = lVar4 + (ulong)(uVar9 + 1) * 0x14;
      uVar18 = uVar9;
      do {
        uVar18 = uVar18 + 1;
        if (uVar8 <= uVar18) break;
        pcVar10 = (char *)(lVar21 + 0xf);
        lVar21 = lVar21 + 0x14;
...
LAB_00103a34:
          ...
          puVar15 = (uint *)(lVar4 + 0x18 + (((uVar6 - uVar7) - 1) + uVar12) * 0x14);
          if (((int)puVar15 - (int)puVar11 & 4U) == 0) goto LAB_00103a68;
          *puVar11 = *puVar11 | uVar3;
          for (puVar11 = puVar11 + 5; puVar15 != puVar11; puVar11 = puVar11 + 10) {
LAB_00103a68:
            *puVar11 = *puVar11 | uVar3;
            puVar11[5] = puVar11[5] | uVar3;
          }
          ...
          uVar6 = uVar6 + uVar7;
          if (uVar7 < uVar6) goto LAB_00103a34;
        }
        uVar12 = uVar14;
        lVar21 = lVar4 + (ulong)(uVar9 + 1) * 0x14;
        do {
  ...
  if (*(long *)(puVar16 + 2) == 0) {
    ...
    do {
      if (-1 < iVar19 + -1) {
        ...
        do {
          while( true ) {
            uVar8 = (uint)(iVar17 + iVar20) >> 1;
            puVar16 = (uint *)(lVar4 + (ulong)uVar8 * 0x24);
            uVar7 = *puVar16;
            if (*(uint *)("lositiniidemaniffrkrfvbafwlbflahftsputavtcjc" + lVar21) < uVar7) break;
            if (*(uint *)("lositiniidemaniffrkrfvbafwlbflahftsputavtcjc" + lVar21) <= uVar7) {
              uVar7 = puVar16[7];
              if (uVar3 != uVar7) goto LAB_00103b6e;
              goto LAB_00103c46;
            }
            iVar17 = uVar8 + 1;
            if (iVar20 < iVar17) goto LAB_00103c3b;
          }
          iVar20 = uVar8 - 1;
        } while (iVar17 <= iVar20);
      }
...
LAB_00103b6e:
      ...
      *(uint *)((long)local_58 + lVar21) = uVar7;
      lVar21 = lVar21 + 4;
    } while (lVar21 != 0x10);
    if (uVar18 != 0) {
      uVar3 = *(uint *)(param_3 + 0x60);
...
LAB_00103c50:
            if ((iVar19 == 3) || (iVar19 == 0)) {
              if ((uint)uVar12 < uVar7) {
                uVar9 = local_58[(int)((iVar19 == 3) + 1)];
                puVar16 = (uint *)(lVar4 + 4 + uVar12 * 0x14);
                do {
                  puVar15 = puVar16 + 5;
                  *puVar16 = *puVar16 & ~uVar18 | uVar9;
                  puVar16 = puVar15;
            ...
            if (uVar7 < uVar8) {
              uVar9 = local_58[iVar19];
              puVar16 = (uint *)(lVar4 + 4 + (ulong)uVar7 * 0x14);
              do {
                puVar15 = puVar16 + 5;
                *puVar16 = *puVar16 & ~uVar18 | uVar9;
                puVar16 = puVar15;
          ...
          lVar21 = lVar4 + (ulong)(uVar8 + 1) * 0x14;
          do {
            uVar9 = (int)uVar14 + 1;
            uVar14 = (ulong)uVar9;
            if (*(uint *)(param_3 + 0x60) <= uVar9) break;
            pbVar13 = (byte *)(lVar21 + 0xf);
            lVar21 = lVar21 + 0x14;
          } while (bVar2 == *pbVar13);
          uVar12 = (ulong)uVar7;
          if (uVar3 <= uVar8) break;
...
LAB_0010406d:
          ...
          else if (uVar15 <= uVar9) goto LAB_00103eac;
          while( true ) {
            uVar9 = uVar9 + 1;
  ...
  if ((param_5) || (!param_4)) {
    *(uint *)(this + 0xc0) = *(uint *)(this + 0xc0) | 0x20;
    if ((param_5) && (this[0x5a] != (hb_buffer_t)0x0)) {
      ...
      if (!param_4) {
        ...
        if (uVar11 < param_3) {
          ...
          if (((int)puVar1 - (int)puVar5 & 4U) != 0) {
            *puVar5 = *puVar5 | param_1;
            puVar5 = puVar5 + 5;
            if (puVar1 == puVar5) goto LAB_00106de0;
          }
          do {
            *puVar5 = *puVar5 | param_1;
      ...
      if (uVar13 == param_3) {
        local_44 = 0xffffffff;
        if (param_2 == uVar11) goto LAB_00106de0;
        if (iVar2 != 2) goto LAB_00106f85;
LAB_001071ef:
        uVar7 = (ulong)param_2;
        uVar8 = local_44;
        if (param_2 < uVar11) {
          ...
          if (((int)puVar1 - (int)puVar5 & 4U) == 0) goto LAB_00107238;
          if (*puVar5 < local_44) {
            uVar8 = *puVar5;
          }
...
LAB_00107238:
          ...
          if (param_2 != uVar11) goto LAB_0010725c;
        }
        else {
LAB_0010725c:
          local_50 = uVar7 * 0x14;
...
LAB_001072ad:
        if (param_3 == uVar13) goto LAB_00106de0;
LAB_001072b6:
        ...
        if (iVar2 == 2) {
          if (uVar13 < param_3) {
            ...
            if (((int)puVar1 - (int)puVar5 & 4U) != 0) {
              ...
              puVar5 = puVar5 + 5;
              if (puVar5 == puVar1) goto LAB_001071e2;
            }
            do {
              if (*puVar5 < local_44) {
                local_44 = *puVar5;
...
LAB_001071e2:
          uVar8 = local_44;
          if (param_2 != uVar11) goto LAB_001071ef;
          goto LAB_001072b6;
        }
        uVar10 = (ulong)(param_3 - 1);
        uVar7 = (ulong)uVar13;
        ...
        local_44 = uVar8;
        if (param_2 == uVar11) goto LAB_001072bd;
LAB_00106f85:
        ...
        uVar8 = *puVar5;
        if (param_2 == uVar11) goto LAB_001072ad;
        local_50 = uVar7 * 0x14;
        ...
        if (uVar8 != uVar15) {
          if (uVar8 == uVar3) {
            if (uVar8 == uVar15) goto LAB_0010712d;
            if (param_2 < uVar11) {
              puVar5 = (uint *)(lVar9 + 4 + local_50);
              do {
...
LAB_0010704d:
        if (uVar13 == param_3) goto LAB_00106de0;
        uVar10 = (ulong)(param_3 - 1);
        uVar7 = (ulong)uVar13;
        uVar11 = *(uint *)(lVar4 + 8 + uVar7 * 0x14);
        uVar15 = *(uint *)(lVar4 + 8 + uVar10 * 0x14);
LAB_00107073:
        if (uVar11 != uVar8) {
          if (uVar15 != uVar8) goto LAB_001072de;
          if (uVar11 != uVar8) {
            if (uVar13 < param_3) {
              puVar5 = (uint *)(lVar4 + 4 + uVar7 * 0x14);
              do {
    ...
    if (!param_4) {
      if (param_2 < param_3) {
        ...
        if (((int)puVar1 - (int)puVar5 & 4U) != 0) {
          *puVar5 = *puVar5 | param_1;
          puVar5 = puVar5 + 5;
          if (puVar5 == puVar1) goto LAB_00106de0;
        }
        do {
          *puVar5 = *puVar5 | param_1;
          puVar5[5] = puVar5[5] | param_1;
    ...
    if (param_3 - param_2 < 2) goto LAB_00106de0;
    *(uint *)(this + 0xc0) = *(uint *)(this + 0xc0) | 0x20;
  }
  lVar4 = *(long *)(this + 0x70);
  if (param_2 != param_3) {
    if (*(int *)(this + 0x1c) == 2) {
      if (param_2 < param_3) {
        ...
        uVar11 = 0xffffffff;
        if (((int)puVar1 - (int)puVar5 & 4U) == 0) goto LAB_00107380;
        uVar11 = 0xffffffff;
        if (*puVar5 != 0xffffffff) {
          uVar11 = *puVar5;
        }

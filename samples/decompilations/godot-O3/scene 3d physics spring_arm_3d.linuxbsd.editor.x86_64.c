...
/* SpringArm3D::get_length() const */

undefined4 SpringArm3D::get_length(void)

{
  long in_RDI;
  
  return *(undefined4 *)(in_RDI + 0x558);
}



/* SpringArm3D::set_mask(unsigned int) */

void __thiscall SpringArm3D::set_mask(SpringArm3D *this,uint param_1)
...
/* SpringArm3D::get_mask() */

undefined4 __thiscall SpringArm3D::get_mask(SpringArm3D *this)
...
undefined4 __thiscall SpringArm3D::get_margin(SpringArm3D *this)
...
/* SpringArm3D::set_margin(float) */

void __thiscall SpringArm3D::set_margin(SpringArm3D *this,float param_1)
...
undefined4 __thiscall SpringArm3D::get_hit_length(SpringArm3D *this)
...
/* SpringArm3D::set_length(float) */

void __thiscall SpringArm3D::set_length(SpringArm3D *this,float param_1)
...
void __thiscall SpringArm3D::clear_excluded_objects(SpringArm3D *this)
    ...
    if (*(int *)(this + 0x554) != 0) {
      if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x550) * 4) != 0) {
        memset(*(void **)(this + 0x548),0,
               (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x550) * 4) << 2);
      }
...
/* SpringArm3D::set_shape(Ref<Shape3D>) */

void __thiscall SpringArm3D::set_shape(SpringArm3D *this,long *param_2)
...
/* SpringArm3D::get_shape() const */

void SpringArm3D::get_shape(void)
...
/* SpringArm3D::add_excluded_object(RID) */

void SpringArm3D::add_excluded_object(void)
...
/* SpringArm3D::remove_excluded_object(RID) */

void __thiscall SpringArm3D::remove_excluded_object(SpringArm3D *this,undefined8 param_2)

{
  ...
  HashSet<RID,HashMapHasherDefault,HashMapComparatorDefault<RID>>::erase
            ((HashSet<RID,HashMapHasherDefault,HashMapComparatorDefault<RID>> *)(this + 0x530),
             (RID *)local_10);
  return;
}
...
void __thiscall SpringArm3D::process_spring(SpringArm3D *this)
  ...
  if (plVar7 == (long *)0x0) {
    ...
    if (-1 < iVar6) {
      do {
        ...
        if ((lVar8 != 0) &&
           (lVar8 = __dynamic_cast(lVar8,&Object::typeinfo,&Camera3D::typeinfo,0), lVar8 != 0)) {
          Node3D::get_global_transform();
          Node3D::get_global_transform();
    ...
    HashSet<RID,HashMapHasherDefault,HashMapComparatorDefault<RID>>::operator=
              ((HashSet<RID,HashMapHasherDefault,HashMapComparatorDefault<RID>> *)&fStack_a0,
               (HashSet *)(this + 0x530));
    uStack_e0 = 0;
    local_d8 = 0.0;
    fStack_d4 = 0.0;
    ...
    if (((local_130 != (Object *)0x0) && (cVar5 = RefCounted::unreference(), cVar5 != '\0')) &&
       (cVar5 = predelete_handler(local_130), cVar5 != '\0')) {
      (**(code **)(*(long *)local_130 + 0x140))(local_130);
      Memory::free_static(local_130,false);
    }
    if (cVar4 != '\0') {
      Node3D::get_global_transform();
      local_138[0] = (SQRT(((float)local_f8 - local_104) * ((float)local_f8 - local_104) +
                           (local_f8._4_4_ - local_100) * (local_f8._4_4_ - local_100) +
                           (fStack_f0 - local_fc) * (fStack_f0 - local_fc)) -
                     *(float *)(this + 0x568)) / *(float *)(this + 0x558);
    }
    ...
    if (pvVar1 != (void *)0x0) {
      if (local_80._4_4_ != 0.0) {
        if (*(uint *)(hash_table_size_primes + (ulong)(uint)(float)local_80 * 4) != 0) {
          memset((void *)CONCAT44(fStack_84,uStack_88),0,
                 (ulong)*(uint *)(hash_table_size_primes + (ulong)(uint)(float)local_80 * 4) * 4);
        }
        local_80._4_4_ = 0.0;
      }
    ...
    fStack_98 = 0.0;
    fStack_94 = 0.0;
    if (*(code **)(*plVar7 + 0x1c0) == Shape3D::get_rid) {
    ...
    auStack_b0 = (undefined1  [8])local_168;
    fStack_a0 = (float)local_158;
    fStack_9c = (float)((ulong)local_158 >> 0x20);
    fStack_98 = (float)uStack_150;
    fStack_94 = (float)((ulong)uStack_150 >> 0x20);
    local_90 = (float)local_148;
    fStack_8c = (float)((ulong)local_148 >> 0x20);
    uStack_88 = (undefined4)uStack_140;
    fStack_84 = (float)((ulong)uStack_140 >> 0x20);
LAB_00100582:
    local_78 = CONCAT44(local_78._4_4_,fVar11);
    local_80._0_4_ = fVar12;
    local_80._4_4_ = fVar13;
    HashSet<RID,HashMapHasherDefault,HashMapComparatorDefault<RID>>::operator=
              ((HashSet<RID,HashMapHasherDefault,HashMapComparatorDefault<RID>> *)local_70,
               (HashSet *)(this + 0x530));
    local_48 = *(undefined4 *)(this + 0x564);
    Node3D::get_world_3d();
    plVar7 = (long *)World3D::get_direct_space_state();
    (**(code **)(*plVar7 + 0x168))(plVar7,&local_b8,local_138,local_138 + 1,0);
    if (((local_130 != (Object *)0x0) && (cVar4 = RefCounted::unreference(), cVar4 != '\0')) &&
       (cVar4 = predelete_handler(local_130), cVar4 != '\0')) {
      (**(code **)(*(long *)local_130 + 0x140))(local_130);
      Memory::free_static(local_130,false);
    }
    auVar3 = local_70;
  ...
  fVar13 = *(float *)(this + 0x558) * local_138[0];
  local_d8 = 1.0;
  local_f8 = local_188._0_8_;
  fStack_f0 = local_188._8_4_;
  uStack_ec = local_188._12_4_;
  uStack_e8 = local_188._0_4_;
  uStack_e4 = 0;
  uStack_e0 = local_188._8_8_;
  fStack_d4 = 0.0;
  fStack_d0 = 0.0;
  fStack_cc = 0.0;
  *(float *)(this + 0x55c) = fVar13;
  Node3D::get_global_transform();
  fStack_cc = fVar13 * fVar16 + fStack_8c;
  fStack_d4 = fStack_94 + fVar14 * fVar13;
  fStack_d0 = local_90 + fVar15 * fVar13;
  iVar6 = Node::get_child_count(SUB81(this,0));
  iVar6 = iVar6 + -1;
  if (-1 < iVar6) {
    do {
      lVar8 = Node::get_child((int)this,SUB41(iVar6,0));
      if ((lVar8 != 0) &&
         (pTVar9 = (Transform3D *)__dynamic_cast(lVar8,&Object::typeinfo,&Node3D::typeinfo,0),
         pTVar9 != (Transform3D *)0x0)) {
        Node3D::get_global_transform();
...
/* SpringArm3D::_notification(int) */

void __thiscall SpringArm3D::_notification(SpringArm3D *this,int param_1)
...
/* SpringArm3D::_bind_methods() */

void SpringArm3D::_bind_methods(void)

{
  ...
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_98,2,(String *)&local_d0,0xb,(String *)&local_c8,6,&local_c0);
  local_d8 = 0;
  ...
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_98,0x18,(String *)&local_d0,0x11,(String *)&local_c8,6,&local_c0
            );
  local_d8 = 0;
  String::parse_latin1((String *)&local_d8,"SpringArm3D");
  StringName::StringName((StringName *)&local_a8,(String *)&local_d8,false);
  ...
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_98,3,(String *)&local_d0,0,(String *)&local_c8,6,&local_c0);
  local_d8 = 0;
  String::parse_latin1((String *)&local_d8,"SpringArm3D");
  StringName::StringName((StringName *)&local_a8,(String *)&local_d8,false);
  ClassDB::add_property
...
/* MethodBindTR<bool, RID>::_gen_argument_type(int) const */

char __thiscall MethodBindTR<bool,RID>::_gen_argument_type(MethodBindTR<bool,RID> *this,int param_1)
...
/* MethodBindTR<bool, RID>::get_argument_meta(int) const */

undefined8 MethodBindTR<bool,RID>::get_argument_meta(int param_1)
...
/* MethodBindT<Ref<Shape3D> >::_gen_argument_type(int) const */

byte __thiscall
MethodBindT<Ref<Shape3D>>::_gen_argument_type(MethodBindT<Ref<Shape3D>> *this,int param_1)
...
/* MethodBindT<Ref<Shape3D> >::get_argument_meta(int) const */

undefined8 MethodBindT<Ref<Shape3D>>::get_argument_meta(int param_1)
...
/* MethodBindT<Ref<Shape3D> >::~MethodBindT() */

void __thiscall MethodBindT<Ref<Shape3D>>::~MethodBindT(MethodBindT<Ref<Shape3D>> *this)
...
/* MethodBindTR<bool, RID>::~MethodBindTR() */

void __thiscall MethodBindTR<bool,RID>::~MethodBindTR(MethodBindTR<bool,RID> *this)
...
/* HashSet<RID, HashMapHasherDefault, HashMapComparatorDefault<RID> >::erase(RID const&) */
...
/* MethodBindT<Ref<Shape3D> >::_gen_argument_type_info(int) const */

undefined4 * MethodBindT<Ref<Shape3D>>::_gen_argument_type_info(int param_1)
...
/* MethodBind* create_method_bind<SpringArm3D, float>(float (SpringArm3D::*)()) */

MethodBind * create_method_bind<SpringArm3D,float>(_func_float *param_1)
...
/* MethodBind* create_method_bind<SpringArm3D, float>(void (SpringArm3D::*)(float)) */

MethodBind * create_method_bind<SpringArm3D,float>(_func_void_float *param_1)
...
/* MethodBind* create_method_bind<SpringArm3D, float>(float (SpringArm3D::*)() const) */
...
/* MethodBind* create_method_bind<SpringArm3D, RID>(void (SpringArm3D::*)(RID)) */

MethodBind * create_method_bind<SpringArm3D,RID>(_func_void_RID *param_1)
...
/* MethodBind* create_method_bind<SpringArm3D, bool, RID>(bool (SpringArm3D::*)(RID)) */

MethodBind * create_method_bind<SpringArm3D,bool,RID>(_func_bool_RID *param_1)
...
/* MethodBind* create_method_bind<SpringArm3D>(void (SpringArm3D::*)()) */

MethodBind * create_method_bind<SpringArm3D>(_func_void *param_1)
...
/* MethodBind* create_method_bind<SpringArm3D, unsigned int>(void (SpringArm3D::*)(unsigned int)) */

MethodBind * create_method_bind<SpringArm3D,unsigned_int>(_func_void_uint *param_1)
...
/* MethodBind* create_method_bind<SpringArm3D, unsigned int>(unsigned int (SpringArm3D::*)()) */

MethodBind * create_method_bind<SpringArm3D,unsigned_int>(_func_uint *param_1)
...
/* SpringArm3D::_bind_methods() [clone .cold] */
...
/* WARNING: Removing unreachable block (ram,0x00104e58) */
...
/* MethodBindTR<bool, RID>::validated_call(Object*, Variant const**, Variant*) const */

void __thiscall
MethodBindTR<bool,RID>::validated_call
          (MethodBindTR<bool,RID> *this,Object *param_1,Variant **param_2,Variant *param_3)
...
/* MethodBindTR<bool, RID>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTR<bool,RID>::ptrcall
          (MethodBindTR<bool,RID> *this,Object *param_1,void **param_2,void *param_3)
...
/* MethodBindT<Ref<Shape3D> >::validated_call(Object*, Variant const**, Variant*) const */

void MethodBindT<Ref<Shape3D>>::validated_call(Object *param_1,Variant **param_2,Variant *param_3)
...
/* MethodBindT<Ref<Shape3D> >::ptrcall(Object*, void const**, void*) const */

void MethodBindT<Ref<Shape3D>>::ptrcall(Object *param_1,void **param_2,void *param_3)
...
/* MethodBindTR<bool, RID>::call(Object*, Variant const**, int, Callable::CallError&) const */

Object * MethodBindTR<bool,RID>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
/* MethodBindT<Ref<Shape3D> >::call(Object*, Variant const**, int, Callable::CallError&) const */

Object * MethodBindT<Ref<Shape3D>>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
/* void call_get_argument_type_info_helper<RID>(int, int&, PropertyInfo&) */

void call_get_argument_type_info_helper<RID>(int param_1,int *param_2,PropertyInfo *param_3)
...
PropertyInfo * MethodBindT<RID>::_gen_argument_type_info(int param_1)
...
/* MethodBindTR<bool, RID>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTR<bool,RID>::_gen_argument_type_info(int param_1)

...
/* icu_76_godot::ResourceDataValue::getType() const */

int __thiscall icu_76_godot::ResourceDataValue::getType(ResourceDataValue *this)
...
/* icu_76_godot::ResourceDataValue::isNoInheritanceMarker() const */

bool __thiscall icu_76_godot::ResourceDataValue::isNoInheritanceMarker(ResourceDataValue *this)

{
  ...
  if (uVar4 != 0) {
    ...
    if (uVar2 < 0x10000000) {
      ...
      bVar7 = bVar6;
      if (((*piVar1 == 3) && ((short)piVar1[1] == 0x2205)) &&
         (*(short *)((long)piVar1 + 6) == 0x2205)) {
...
undefined4 isAcceptable(void *param_1,char *param_2,char *param_3,UDataInfo *param_4)

{
  *(undefined4 *)param_1 = *(undefined4 *)(param_4 + 0xc);
  if ((((0x13 < *(ushort *)param_4) && (*(short *)(param_4 + 4) == 0)) &&
      (param_4[6] == (UDataInfo)0x2)) &&
     ((*(short *)(param_4 + 8) == 0x6552 && (*(short *)(param_4 + 10) == 0x4273)))) {
...
void res_init(ResourceData *param_1,uchar *param_2,void *param_3,int param_4,UErrorCode *param_5)

{
  ...
  *(uint *)(param_1 + 0x20) = uVar1;
  ...
  if ((0x34UL >> (uVar1 >> 0x1c) & 1) != 0) {
    ...
    if ((4 < uVar4) &&
       ((param_4 < 0 ||
        (((int)((uVar4 + 1) * 4) <= param_4 && (*(int *)((long)param_3 + 0x10) * 4 <= param_4))))))
    {
        ...
        *(uint *)(param_1 + 0x30) = *(uint *)(param_1 + 0x30) | (uVar2 & 0xf000) << 0xc;
        if (((*(uint *)(param_1 + 0x38) & 0xffff00) == 0) || ((uVar1 & 0xf8) != 0)) {
          if ((uVar4 != 6) && (*(int *)((long)param_3 + 8) < *(int *)((long)param_3 + 0x1c))) {
            *(void **)(param_1 + 0x10) =
                 (void *)((long)param_3 + (long)*(int *)((long)param_3 + 8) * 4);
          }
LAB_001002b1:
          param_1[0x3b] = (ResourceData)0x1;
          return;
        }
      }
    }
...
void __thiscall icu_76_godot::ResourceDataValue::~ResourceDataValue(ResourceDataValue *this)
...
void ures_compareRows(void *param_1,void *param_2,void *param_3)
...
/* icu_76_godot::ResourceDataValue::getTable(UErrorCode&) const */

void icu_76_godot::ResourceDataValue::getTable(UErrorCode *param_1)
...
/* icu_76_godot::ResourceDataValue::getUInt(UErrorCode&) const */

uint __thiscall
icu_76_godot::ResourceDataValue::getUInt(ResourceDataValue *this,UErrorCode *param_1)
...
/* icu_76_godot::ResourceDataValue::getInt(UErrorCode&) const */

int __thiscall icu_76_godot::ResourceDataValue::getInt(ResourceDataValue *this,UErrorCode *param_1)
...
/* ures_swapResource(UDataSwapper const*, unsigned int const*, unsigned int*, unsigned int, char
   const*, TempTable*, UErrorCode*) [clone .isra.0] */

void ures_swapResource(UDataSwapper *param_1,uint *param_2,uint *param_3,uint param_4,char *param_5,
                      TempTable *param_6,UErrorCode *param_7)
...
/* icu_76_godot::ResourceDataValue::getAliasString(int&, UErrorCode&) const */

int * __thiscall
icu_76_godot::ResourceDataValue::getAliasString
          (ResourceDataValue *this,int *param_1,UErrorCode *param_2)
...
/* icu_76_godot::ResourceDataValue::getIntVector(int&, UErrorCode&) const */

int * __thiscall
icu_76_godot::ResourceDataValue::getIntVector
          (ResourceDataValue *this,int *param_1,UErrorCode *param_2)
...
/* icu_76_godot::ResourceDataValue::getBinary(int&, UErrorCode&) const */

int * __thiscall
icu_76_godot::ResourceDataValue::getBinary(ResourceDataValue *this,int *param_1,UErrorCode *param_2)
...
/* icu_76_godot::ResourceDataValue::getArray(UErrorCode&) const */

void icu_76_godot::ResourceDataValue::getArray(UErrorCode *param_1)
...
void res_read_76_godot(ResourceData *param_1,UDataInfo *param_2,void *param_3,int param_4,
                      UErrorCode *param_5)
...
void res_load_76_godot(ResourceData *param_1,undefined8 param_2,undefined8 param_3,
                      UErrorCode *param_4)
...
/* (anonymous namespace)::getStringArray(ResourceData const*, icu_76_godot::ResourceArray const&,
   icu_76_godot::UnicodeString*, int, UErrorCode&) */

int (anonymous_namespace)::getStringArray
              (ResourceData *param_1,ResourceArray *param_2,UnicodeString *param_3,int param_4,
              UErrorCode *param_5)
...
void __thiscall
icu_76_godot::ResourceDataValue::getStringArray
          (ResourceDataValue *this,UnicodeString *param_1,int param_2,UErrorCode *param_3)
...
LAB_001014ff:
  (anonymous_namespace)::getStringArray(pRVar5,(ResourceArray *)local_48,param_1,param_2,param_3);
...
icu_76_godot::ResourceDataValue::getStringArrayOrStringAsArray
          (ResourceDataValue *this,UnicodeString *param_1,int param_2,UErrorCode *param_3)

{
  ...
  if (*(int *)(this + 0x18) - 8U < 2) {
    ...
    uVar2 = (anonymous_namespace)::getStringArray
                      (*(ResourceData **)(this + 8),(ResourceArray *)local_48,param_1,param_2,
                       param_3);
    goto LAB_00101671;
  }
  if (0 < *(int *)param_3) {
...
/* icu_76_godot::ResourceDataValue::getStringOrFirstOfArray(UErrorCode&) const */

UErrorCode * icu_76_godot::ResourceDataValue::getStringOrFirstOfArray(UErrorCode *param_1)
...
/* icu_76_godot::ResourceDataValue::getString(int&, UErrorCode&) const */

long __thiscall
icu_76_godot::ResourceDataValue::getString(ResourceDataValue *this,int *param_1,UErrorCode *param_2)

{
  ...
  lVar1 = res_getStringNoTrace_76_godot
                    (*(undefined8 *)(this + 8),*(undefined4 *)(this + 0x18),param_1);
  if (lVar1 != 0) {
    return lVar1;
  }
  *(undefined4 *)param_2 = 0x11;
...
undefined8 __thiscall
icu_76_godot::ResourceTable::getKeyAndValue
          (ResourceTable *this,int param_1,char **param_2,ResourceValue *param_3)
...
/* icu_76_godot::ResourceTable::findValue(char const*, icu_76_godot::ResourceValue&) const */

undefined8 __thiscall
icu_76_godot::ResourceTable::findValue(ResourceTable *this,char *param_1,ResourceValue *param_2)
...

{
  ...
  if (-1 < param_3) {
    if (param_2 >> 0x1c == 8) {
      if ((uVar4 != 0) &&
         (piVar2 = (int *)(*(long *)(param_1 + 8) + (ulong)uVar4 * 4), param_3 < *piVar2)) {
        return piVar2[param_3 + 1];
      }
    }
    else if ((param_2 >> 0x1c == 9) &&
            (puVar1 = (ushort *)(*(long *)(param_1 + 0x10) + (ulong)uVar4 * 2),
            param_3 < (int)(uint)*puVar1)) {
...
/* icu_76_godot::ResourceArray::internalGetResource(ResourceData const*, int) const */

uint __thiscall
icu_76_godot::ResourceArray::internalGetResource
          (ResourceArray *this,ResourceData *param_1,int param_2)
...
/* icu_76_godot::ResourceArray::getValue(int, icu_76_godot::ResourceValue&) const */

undefined8 __thiscall
icu_76_godot::ResourceArray::getValue(ResourceArray *this,int param_1,ResourceValue *param_2)
...

{
  ...
  if (*__s != '\0') {
    ...
    if ((((0x24UL >> (param_2 >> 0x1c & 0xf) & 1) == 0) && ((int)uVar6 != 4)) &&
       (1 < (int)uVar6 - 8U)) {
LAB_0010202b:
      uVar2 = 0xffffffff;
    }
...
int ures_swap_76_godot(UDataSwapper *param_1,long param_2,int param_3,long param_4,
                      TempTable *param_5)
  ...
  if ((param_5 != (TempTable *)0x0) && (*(int *)param_5 < 1)) {
    ...
    if ((*(short *)(param_2 + 0xc) == 0x6552) && (*(short *)(param_2 + 0xe) == 0x4273)) {
      ...
      if (param_3 < 0) {
        ...
        if (iVar9 < 0x18) {
          udata_printError_76_godot
                    (param_1,"ures_swap(): too few bytes (%d after header) for a resource bundle\n")
          ;
      ...
      if (bVar2 < 5) {
        udata_printError_76_godot
                  (param_1,"ures_swap(): too few indexes for a 1.1+ resource bundle\n");
        *(undefined4 *)param_5 = 8;
      }
      else {
        iVar9 = bVar2 + 1;
          ...
          if (-1 < param_3) {
            ...
            if ((int)uVar8 < 0x321) {
              ...
              if (local_ce0 == (undefined1 *)0x0) {
                udata_printError_76_godot
                          (param_1,"ures_swap(): unable to allocate memory for tracking resources\n"
                          );
            ...
            if (0 < *(int *)param_5) {
LAB_001025f7:
              udata_printError_76_godot(param_1,pcVar10,iVar11);
joined_r0x00102609:
            ...
            if (iVar5 < local_d00) {
              (**(code **)(param_1 + 0x30))
                        (param_1,__src + iVar5,(local_d00 - iVar5) * 4,__dest + iVar5,param_5);
              if (0 < *(int *)param_5) {
            ...
            ures_swapResource(param_1,__src,__dest,uVar4,(char *)&local_cf8,param_5,
                              (UErrorCode *)__dest);
            if (0 < *(int *)param_5) {
        ...
        udata_printError_76_godot
                  (param_1,"ures_swap(): resource top %d exceeds bundle length %d\n",iVar6);
        *(undefined4 *)param_5 = 8;
      }
    }
    else {
...
LAB_001021f4:
      udata_printError_76_godot
                 ...
                 *(undefined1 *)(param_2 + 0xe),*(undefined1 *)(param_2 + 0xf),bVar2,cVar1);

...
/* ENetPacketPeer::get_max_packet_size() const */

undefined8 ENetPacketPeer::get_max_packet_size(void)
...
/* ENetPacketPeer::get_available_packet_count() const */

undefined4 __thiscall ENetPacketPeer::get_available_packet_count(ENetPacketPeer *this)
...
/* ENetPacketPeer::is_active() const */

bool __thiscall ENetPacketPeer::is_active(ENetPacketPeer *this)
...
/* ENetPacketPeer::get_state() const */

undefined4 __thiscall ENetPacketPeer::get_state(ENetPacketPeer *this)
...
/* ENetPacketPeer::get_statistic(ENetPacketPeer::PeerStatistic) */

double __thiscall ENetPacketPeer::get_statistic(ENetPacketPeer *this,undefined4 param_2)

{
  ...
  if (lVar1 == 0) {
    _err_print_error("get_statistic","modules/enet/enet_packet_peer.cpp",0x84,
                     "Parameter \"peer\" is null.",0,0);
LAB_0010020d:
    dVar2 = 0.0;
  }
  else {
...
/* ENetPacketPeer::get_remote_port() const */

undefined2 __thiscall ENetPacketPeer::get_remote_port(ENetPacketPeer *this)

{
  if (*(long *)(this + 0x198) != 0) {
    return *(undefined2 *)(*(long *)(this + 0x198) + 0x32);
  }
  _err_print_error("get_remote_port","modules/enet/enet_packet_peer.cpp",0x7b,
                   "Parameter \"peer\" is null.",0,0);
  return 0;
}
...
/* ENetPacketPeer::peer_disconnect(int) */

void ENetPacketPeer::peer_disconnect(int param_1)

{
  ...
  _err_print_error("peer_disconnect","modules/enet/enet_packet_peer.cpp",0x22,
                   "Parameter \"peer\" is null.",0,0);
  return;
}
...
/* ENetPacketPeer::peer_disconnect_later(int) */

void ENetPacketPeer::peer_disconnect_later(int param_1)

{
  ...
  _err_print_error("peer_disconnect_later","modules/enet/enet_packet_peer.cpp",0x27,
                   "Parameter \"peer\" is null.",0,0);
  return;
}
...
void __thiscall ENetPacketPeer::ping(ENetPacketPeer *this)
...
/* ENetPacketPeer::ping_interval(int) */

void ENetPacketPeer::ping_interval(int param_1)

{
  ...
  _err_print_error("ping_interval","modules/enet/enet_packet_peer.cpp",0x37,
                   "Parameter \"peer\" is null.",0,0);
  return;
}
...
/* ENetPacketPeer::get_channels() const */

undefined4 __thiscall ENetPacketPeer::get_channels(ENetPacketPeer *this)

{
  if (*(long *)(this + 0x198) != 0) {
    return *(undefined4 *)(*(long *)(this + 0x198) + 0x50);
  }
  _err_print_error("get_channels","modules/enet/enet_packet_peer.cpp",0xae,
                   "Parameter \"peer\" is null.",
...
/* ENetPacketPeer::throttle_configure(int, int, int) */

void ENetPacketPeer::throttle_configure(int param_1,int param_2,int param_3)

{
  ...
  if (lVar1 != 0) {
    enet_peer_throttle_configure
              (lVar1,CONCAT44(in_register_00000034,param_2),CONCAT44(in_register_00000014,param_3));
    return;
  }
  _err_print_error("throttle_configure","modules/enet/enet_packet_peer.cpp",0x49,
                   "Parameter \"peer\" is null.","Peer not connected.",0,0);
  return;
}



/* ENetPacketPeer::set_timeout(int, int, int) */

undefined8 __thiscall
ENetPacketPeer::set_timeout(ENetPacketPeer *this,int param_1,int param_2,int param_3)

{
  undefined8 uVar1;
  
  if (*(long *)(this + 0x198) == 0) {
    uVar1 = _err_print_error("set_timeout","modules/enet/enet_packet_peer.cpp",0x4e,
                             "Parameter \"peer\" is null.","Peer not connected.",0,0);
  }
  else {
    ...
    uVar1 = 0;
    _err_print_error("set_timeout","modules/enet/enet_packet_peer.cpp",0x4f,
                     "Condition \"p_timeout > p_timeout_min || p_timeout_min > p_timeout_max\" is true."
                     ,
                     "Timeout limit must be less than minimum timeout, which itself must be less than maximum timeout"
                     ,0);
  }
  return uVar1;
}
...
/* ENetPacketPeer::get_remote_address() const */

void ENetPacketPeer::get_remote_address(void)

{
  ...
  if (*(long *)(in_RSI + 0x198) == 0) {
    _err_print_error("get_remote_address","modules/enet/enet_packet_peer.cpp",0x70,
                     "Parameter \"peer\" is null.",0,0);
    IPAddress::clear();
  }
  else {
...
/* ENetPacketPeer::peer_disconnect_now(int) */

void ENetPacketPeer::peer_disconnect_now(int param_1)

{
  ...
  _err_print_error("peer_disconnect_now","modules/enet/enet_packet_peer.cpp",0x2c,
                   "Parameter \"peer\" is null.",0,0);
  return;
}
...
long __thiscall ENetPacketPeer::reset(ENetPacketPeer *this)

{
  ...
  _err_print_error("reset","modules/enet/enet_packet_peer.cpp",0x43,"Parameter \"peer\" is null.",
                   "Peer not connected.",0);
  return 0;
}



/* ENetPacketPeer::get_packet_flags() const */

undefined4 __thiscall ENetPacketPeer::get_packet_flags(ENetPacketPeer *this)

{
  ...
  _err_print_error("get_packet_flags","modules/enet/enet_packet_peer.cpp",0xb3,
                   "Condition \"packet_queue.is_empty()\" is true. Returning: 0",0,0);
  return 0;
}



/* ENetPacketPeer::get_packet(unsigned char const**, int&) */

undefined8 __thiscall ENetPacketPeer::get_packet(ENetPacketPeer *this,uchar **param_1,int *param_2)

{
  ...
  if (*(long *)(this + 0x198) == 0) {
    _err_print_error("get_packet","modules/enet/enet_packet_peer.cpp",0x5c,
                     "Parameter \"peer\" is null.",0,0);
    return 3;
  }
  plVar6 = *(long **)(this + 0x1a0);
  if ((plVar6 == (long *)0x0) || ((int)plVar6[2] == 0)) {
    _err_print_error("get_packet","modules/enet/enet_packet_peer.cpp",0x5d,
                     "Condition \"packet_queue.is_empty()\" is true. Returning: ERR_UNAVAILABLE",0,0
                    );
    uVar4 = 2;
  }
  else {
...
void __thiscall ENetPacketPeer::~ENetPacketPeer(ENetPacketPeer *this)
...
void __thiscall ENetPacketPeer::_on_disconnect(ENetPacketPeer *this)
...
/* ENetPacketPeer::_queue_packet(_ENetPacket*) */

void __thiscall ENetPacketPeer::_queue_packet(ENetPacketPeer *this,_ENetPacket *param_1)

{
  ...
  if (*(long *)(this + 0x198) == 0) {
    _err_print_error("_queue_packet","modules/enet/enet_packet_peer.cpp",0xbf,
                     "Parameter \"peer\" is null.",0,0);
    return;
  }
  if (*(long *)(this + 0x1a0) == 0) {
...
/* ENetPacketPeer::ENetPacketPeer(_ENetPeer*) */

void __thiscall ENetPacketPeer::ENetPacketPeer(ENetPacketPeer *this,_ENetPeer *param_1)
...
/* ENetPacketPeer::send(unsigned char, _ENetPacket*) */

undefined8 __thiscall ENetPacketPeer::send(ENetPacketPeer *this,uchar param_1,_ENetPacket *param_2)

{
  ...
  if (lVar2 == 0) {
    _err_print_error(&_LC48,"modules/enet/enet_packet_peer.cpp",0x3c,"Parameter \"peer\" is null.",0
                     ,0);
  }
  else if (param_2 == (_ENetPacket *)0x0) {
    _err_print_error(&_LC48,"modules/enet/enet_packet_peer.cpp",0x3d,
                     "Parameter \"p_packet\" is null.",0,0);
  }
  else {
    ...
    _err_print_error(&_LC48,"modules/enet/enet_packet_peer.cpp",0x3e,
                     "Condition \"p_channel >= peer->channelCount\" is true. Returning: -1",
                     (String *)&local_48,0);
    pcVar3 = local_48;
...
/* ENetPacketPeer::put_packet(unsigned char const*, int) */

uint __thiscall ENetPacketPeer::put_packet(ENetPacketPeer *this,uchar *param_1,int param_2)

{
  ...
  _err_print_error("put_packet","modules/enet/enet_packet_peer.cpp",0x6a,
                   "Parameter \"peer\" is null.",0,0);
  return 3;
}
...
/* ENetPacketPeer::_send(int, Vector<unsigned char>, int) */

undefined1 __thiscall
ENetPacketPeer::_send(ENetPacketPeer *this,int param_1,long param_3,uint param_4)

{
  ...
  if (*(long *)(this + 0x198) == 0) {
    _err_print_error("_send","modules/enet/enet_packet_peer.cpp",0xc4,"Parameter \"peer\" is null.",
                     "Peer not connected.",0,0);
    return 3;
  }
  if ((param_1 < 0) || (*(int *)(*(long *)(this + 0x198) + 0x50) < param_1)) {
    _err_print_error("_send","modules/enet/enet_packet_peer.cpp",0xc5,
                     "Condition \"p_channel < 0 || p_channel > (int)peer->channelCount\" is true. Returning: ERR_INVALID_PARAMETER"
                     ,"Invalid channel",0,0);
  }
  else {
    ...
    _err_print_error("_send","modules/enet/enet_packet_peer.cpp",0xc6,
                     "Condition \"p_flags & ~FLAG_ALLOWED\" is true. Returning: ERR_INVALID_PARAMETER"
                     ,"Invalid flags",0,0);
  }
  return 0x1f;
}
...
void ENetPacketPeer::_bind_methods(void)

{
  ...
  StringName::StringName((StringName *)&local_108,(String *)&local_128,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_108,(StringName *)&local_118,(StringName *)&local_110,4,false);
  if ((StringName::configured != '\0') && (local_108 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_128);
  ...
  StringName::StringName((StringName *)&local_108,(String *)&local_128,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_108,(StringName *)&local_118,(StringName *)&local_110,5,false);
  if ((StringName::configured != '\0') && (local_108 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_128);
  ...
  StringName::StringName((StringName *)&local_108,(String *)&local_128,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_108,(StringName *)&local_118,(StringName *)&local_110,6,false);
  if ((StringName::configured != '\0') && (local_108 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_128);
  ...
  StringName::StringName((StringName *)&local_108,(String *)&local_128,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_108,(StringName *)&local_118,(StringName *)&local_110,7,false);
  if ((StringName::configured != '\0') && (local_108 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_128);
  ...
  StringName::StringName((StringName *)&local_108,(String *)&local_128,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_108,(StringName *)&local_118,(StringName *)&local_110,8,false);
  if ((StringName::configured != '\0') && (local_108 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_128);
  ...
  StringName::StringName((StringName *)&local_108,(String *)&local_128,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_108,(StringName *)&local_118,(StringName *)&local_110,9,false);
  if ((StringName::configured != '\0') && (local_108 != (char *)0x0)) {
    StringName::unref();
  }
  lVar3 = local_128;
  ...
  StringName::StringName((StringName *)&local_108,(String *)&local_128,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_108,(StringName *)&local_118,(StringName *)&local_110,10,false);
  if ((StringName::configured != '\0') && (local_108 != (char *)0x0)) {
    StringName::unref();
  }
  lVar3 = local_128;
  ...
  StringName::StringName((StringName *)&local_108,(String *)&local_128,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_108,(StringName *)&local_118,(StringName *)&local_110,0xb,false);
  if ((StringName::configured != '\0') && (local_108 != (char *)0x0)) {
    StringName::unref();
  }
  lVar3 = local_128;
  ...
  StringName::StringName((StringName *)&local_108,(String *)&local_128,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_108,(StringName *)&local_118,(StringName *)&local_110,0xc,false);
  if ((StringName::configured != '\0') && (local_108 != (char *)0x0)) {
    StringName::unref();
  }
  lVar3 = local_128;
  ...
  StringName::StringName((StringName *)&local_108,(String *)&local_128,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_108,(StringName *)&local_118,(StringName *)&local_110,0xd,false);
  if ((StringName::configured != '\0') && (local_108 != (char *)0x0)) {
    StringName::unref();
  }
  lVar3 = local_128;
  ...
  ClassDB::bind_integer_constant
            ((StringName *)&local_108,(StringName *)&local_118,(StringName *)&local_110,0x10000,
             false);
  if ((StringName::configured != '\0') && (local_108 != (char *)0x0)) {
    StringName::unref();
  }
  ...
  StringName::StringName((StringName *)&local_108,(String *)&local_120,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_108,(StringName *)&local_118,(StringName *)&local_110,0x20,false);
  if ((StringName::configured != '\0') && (local_108 != (char *)0x0)) {
    StringName::unref();
  }
  lVar3 = local_120;
...
{
  return (uint)CONCAT71(0x10ec,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr) |
...
/* ENetPacketPeer::is_class_ptr(void*) const */

uint __thiscall ENetPacketPeer::is_class_ptr(ENetPacketPeer *this,void *param_1)

{
  return (uint)CONCAT71(0x10ec,(undefined4 *)param_1 == &PacketPeer::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x10ec,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
...
/* ENetPacketPeer::_getv(StringName const&, Variant&) const */

undefined8 ENetPacketPeer::_getv(StringName *param_1,Variant *param_2)
...
/* ENetPacketPeer::_setv(StringName const&, Variant const&) */

undefined8 ENetPacketPeer::_setv(StringName *param_1,Variant *param_2)
...
/* ENetPacketPeer::_validate_propertyv(PropertyInfo&) const */

void ENetPacketPeer::_validate_propertyv(PropertyInfo *param_1)
...
/* ENetPacketPeer::_property_can_revertv(StringName const&) const */

undefined8 ENetPacketPeer::_property_can_revertv(StringName *param_1)
...
/* ENetPacketPeer::_property_get_revertv(StringName const&, Variant&) const */

undefined8 ENetPacketPeer::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* ENetPacketPeer::_notificationv(int, bool) */

void ENetPacketPeer::_notificationv(int param_1,bool param_2)
...
/* MethodBindTRC<ENetPacketPeer::PeerState>::_gen_argument_type(int) const */

undefined8 MethodBindTRC<ENetPacketPeer::PeerState>::_gen_argument_type(int param_1)
...
/* MethodBindTRC<ENetPacketPeer::PeerState>::get_argument_meta(int) const */

undefined8 MethodBindTRC<ENetPacketPeer::PeerState>::get_argument_meta(int param_1)
...
/* MethodBindTR<double, ENetPacketPeer::PeerStatistic>::_gen_argument_type(int) const */

int __thiscall
MethodBindTR<double,ENetPacketPeer::PeerStatistic>::_gen_argument_type
          (MethodBindTR<double,ENetPacketPeer::PeerStatistic> *this,int param_1)
...
/* MethodBindTR<double, ENetPacketPeer::PeerStatistic>::get_argument_meta(int) const */

uint __thiscall
MethodBindTR<double,ENetPacketPeer::PeerStatistic>::get_argument_meta
          (MethodBindTR<double,ENetPacketPeer::PeerStatistic> *this,int param_1)
...
/* MethodBindTRC<IPAddress>::_gen_argument_type(int) const */

undefined8 MethodBindTRC<IPAddress>::_gen_argument_type(int param_1)
...
/* MethodBindTRC<IPAddress>::get_argument_meta(int) const */

undefined8 MethodBindTRC<IPAddress>::get_argument_meta(int param_1)
...
/* MethodBindT<int, int, int>::get_argument_meta(int) const */

byte __thiscall
MethodBindT<int,int,int>::get_argument_meta(MethodBindT<int,int,int> *this,int param_1)
...
/* MethodBindTR<Error, int, Vector<unsigned char>, int>::_gen_argument_type(int) const */

undefined8 __thiscall
MethodBindTR<Error,int,Vector<unsigned_char>,int>::_gen_argument_type
          (MethodBindTR<Error,int,Vector<unsigned_char>,int> *this,int param_1)
...
/* MethodBindTR<Error, int, Vector<unsigned char>, int>::get_argument_meta(int) const */

byte __thiscall
MethodBindTR<Error,int,Vector<unsigned_char>,int>::get_argument_meta
          (MethodBindTR<Error,int,Vector<unsigned_char>,int> *this,int param_1)
...
/* MethodBindT<int, int, int>::_gen_argument_type(int) const */

char __thiscall
MethodBindT<int,int,int>::_gen_argument_type(MethodBindT<int,int,int> *this,int param_1)
...
/* ENetPacketPeer::_get_class_namev() const */

undefined8 * ENetPacketPeer::_get_class_namev(void)
...
LAB_00105713:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"ENetPacketPeer");
      goto LAB_0010577e;
    }
  }
  StringName::assign_static_unique_class_name
...
/* ENetPacketPeer::get_class() const */

void ENetPacketPeer::get_class(void)
...
/* ENetPacketPeer::is_class(String const&) const */

undefined8 __thiscall ENetPacketPeer::is_class(ENetPacketPeer *this,String *param_1)
...
/* MethodBindTRC<IPAddress>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTRC<IPAddress>::_gen_argument_type_info(int param_1)
...
/* MethodBindTRC<ENetPacketPeer::PeerState>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTRC<ENetPacketPeer::PeerState>::_gen_argument_type_info(int param_1)
...
/* ENetPacketPeer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall ENetPacketPeer::_get_property_listv(ENetPacketPeer *this,List *param_1,bool param_2)
...
GetTypeInfo<ENetPacketPeer::PeerStatistic,void> * __thiscall
GetTypeInfo<ENetPacketPeer::PeerStatistic,void>::get_class_info
...
/* MethodBindTR<double, ENetPacketPeer::PeerStatistic>::_gen_argument_type_info(int) const */

undefined4 *
MethodBindTR<double,ENetPacketPeer::PeerStatistic>::_gen_argument_type_info(int param_1)

{
  ...
  if (in_EDX == 0) {
    ...
    GetTypeInfo<ENetPacketPeer::PeerStatistic,void>::get_class_info
              ((GetTypeInfo<ENetPacketPeer::PeerStatistic,void> *)&local_68);
...
/* WARNING: Removing unreachable block (ram,0x00107c70) */
/* WARNING: Removing unreachable block (ram,0x00107da0) */
/* WARNING: Removing unreachable block (ram,0x00107f19) */
/* WARNING: Removing unreachable block (ram,0x00107dac) */
/* WARNING: Removing unreachable block (ram,0x00107db6) */
/* WARNING: Removing unreachable block (ram,0x00107efb) */
/* WARNING: Removing unreachable block (ram,0x00107dc2) */
/* WARNING: Removing unreachable block (ram,0x00107dcc) */
/* WARNING: Removing unreachable block (ram,0x00107edd) */
/* WARNING: Removing unreachable block (ram,0x00107dd8) */
/* WARNING: Removing unreachable block (ram,0x00107de2) */
/* WARNING: Removing unreachable block (ram,0x00107ebf) */
/* WARNING: Removing unreachable block (ram,0x00107dee) */
/* WARNING: Removing unreachable block (ram,0x00107df8) */
/* WARNING: Removing unreachable block (ram,0x00107ea1) */
/* WARNING: Removing unreachable block (ram,0x00107e04) */
/* WARNING: Removing unreachable block (ram,0x00107e0e) */
/* WARNING: Removing unreachable block (ram,0x00107e83) */
/* WARNING: Removing unreachable block (ram,0x00107e16) */
/* WARNING: Removing unreachable block (ram,0x00107e20) */
/* WARNING: Removing unreachable block (ram,0x00107e68) */
/* WARNING: Removing unreachable block (ram,0x00107e28) */
/* WARNING: Removing unreachable block (ram,0x00107e3e) */
/* WARNING: Removing unreachable block (ram,0x00107e4a) */
...
/* MethodBind* create_method_bind<ENetPacketPeer, int>(void (ENetPacketPeer::*)(int)) */

MethodBind * create_method_bind<ENetPacketPeer,int>(_func_void_int *param_1)
...
/* MethodBind* create_method_bind<ENetPacketPeer>(void (ENetPacketPeer::*)()) */

MethodBind * create_method_bind<ENetPacketPeer>(_func_void *param_1)
...
/* MethodBind* create_method_bind<ENetPacketPeer, Error, int, Vector<unsigned char>, int>(Error
   (ENetPacketPeer::*)(int, Vector<unsigned char>, int)) */

MethodBind *
create_method_bind<ENetPacketPeer,Error,int,Vector<unsigned_char>,int>
          (_func_Error_int_Vector_int *param_1)
...
MethodBind * create_method_bind<ENetPacketPeer,int,int,int>(_func_void_int_int_int *param_1)
...
/* MethodBind* create_method_bind<ENetPacketPeer, int>(int (ENetPacketPeer::*)() const) */

MethodBind * create_method_bind<ENetPacketPeer,int>(_func_int *param_1)
...
/* MethodBind* create_method_bind<ENetPacketPeer, double, ENetPacketPeer::PeerStatistic>(double
   (ENetPacketPeer::*)(ENetPacketPeer::PeerStatistic)) */

MethodBind *
create_method_bind<ENetPacketPeer,double,ENetPacketPeer::PeerStatistic>
          (_func_double_PeerStatistic *param_1)
...
/* MethodBind* create_method_bind<ENetPacketPeer,
   ENetPacketPeer::PeerState>(ENetPacketPeer::PeerState (ENetPacketPeer::*)() const) */

MethodBind * create_method_bind<ENetPacketPeer,ENetPacketPeer::PeerState>(_func_PeerState *param_1)
...
/* MethodBind* create_method_bind<ENetPacketPeer, bool>(bool (ENetPacketPeer::*)() const) */

MethodBind * create_method_bind<ENetPacketPeer,bool>(_func_bool *param_1)
...
/* ENetPacketPeer::_bind_methods() [clone .cold] */
...
/* ENetPacketPeer::_initialize_classv() */

void ENetPacketPeer::_initialize_classv(void)

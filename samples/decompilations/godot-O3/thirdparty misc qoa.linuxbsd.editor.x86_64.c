...

{
  ...
  param_1[5] = (~-(uint)(param_1[1] < 0) & uVar2 | uVar1 & -(uint)(param_1[1] < 0)) + param_1[5];
  param_1[6] = (~-(uint)(param_1[2] < 0) & uVar2 | uVar1 & -(uint)(param_1[2] < 0)) + param_1[6];
  param_1[7] = (~-(uint)(param_1[3] < 0) & uVar2 | uVar1 & -(uint)(param_1[3] < 0)) + param_1[7];
...

{
  ...
  *param_4 = uVar6 >> 0x38 | ((ulong)param_2[1] << 0x20 & 0xff000000000000) >> 0x28 |
             (uVar7 & 0xff0000000000) >> 0x18 | (uVar7 & 0xff00000000) >> 8 |
             ((uVar7 | uVar14) & 0xff000000) << 8 | ((uVar7 | uVar14) & 0xff0000) << 0x18 |
  ...
  if (uVar2 == 0) {
    ...
    do {
      ...
      iVar26 = (int)uVar6;
      *(ulong *)((long)param_4 + uVar6) =
           uVar13 >> 0x38 | (uVar13 & 0xff000000000000) >> 0x28 | (uVar13 & 0xff0000000000) >> 0x18
           | (uVar13 & 0xff00000000) >> 8 | (uVar13 & 0xff000000) << 8 | (uVar13 & 0xff0000) << 0x18
           | (uVar32 & 0xff00) << 0x28 | uVar32 << 0x38;
      puVar27 = puVar21 + 9;
      uVar6 = (ulong)(iVar26 + 0x10);
      *(ulong *)((long)param_4 + (ulong)(iVar26 + 8)) =
          ...
          do {
            ...
            if (local_d4 < iVar31) {
              ...
              do {
                ...
                iVar17 = (int)((local_68 & 0xffffffff) * (local_58 & 0xffffffff)) +
                         (int)((uStack_60 & 0xffffffff) * (uStack_50 & 0xffffffff)) +
                         (int)((local_68 >> 0x20) * (local_58 >> 0x20)) +
                         (int)((uStack_60 >> 0x20) * (uStack_50 >> 0x20)) >> 0xd;
                iVar18 = iVar12 - iVar17;
                iVar9 = iVar18 * iVar3 + 0x8000;
                iVar10 = iVar9 >> 0x10;
                iVar9 = ((uint)(0 < iVar18) + (iVar18 >> 0x1f) + iVar10) -
                        ((uint)(0 < iVar10) + (iVar9 >> 0x1f));
                if (8 < iVar9) {
                  iVar9 = 8;
                }
                if (iVar9 < -8) {
                ...
                iVar9 = iVar17;
                if ((0xffff < iVar17 + 0x8000U) && (iVar9 = 0x7fff, iVar17 < -0x8000)) {
                  iVar9 = -0x8000;
                }
                iVar10 = ((int)uStack_50 * (int)uStack_50 +
                          local_58._4_4_ * local_58._4_4_ + (int)local_58 * (int)local_58 +
                          uStack_50._4_4_ * uStack_50._4_4_ >> 0x12) + -0x8ff;
                if (iVar10 < 0) {
                  iVar10 = 0;
                }
...
LAB_00100478:
          ...
          *piVar16 = local_c4;
          ...
          uVar25 = uVar25 + 8;
          *(ulong *)((long)param_4 + uVar6) =
               local_d0 >> 0x38 | (local_d0 & 0xff000000000000) >> 0x28 |
               (local_d0 & 0xff0000000000) >> 0x18 | (local_d0 & 0xff00000000) >> 8 |
               (local_d0 & 0xff000000) << 8 | (local_d0 & 0xff0000) << 0x18 |
               (local_d0 & 0xff00) << 0x28 | local_d0 << 0x38;
          piVar16 = piVar16 + 1;
          uVar6 = uVar33;
          uVar7 = uVar34;
          uVar14 = uVar35;
...
undefined4 * qoa_encode(long param_1,uint *param_2,uint *param_3)

{
  ...
  if (uVar1 == 0) {
    ...
    if (param_2[1] - 1 < 0xffffff) {
      ...
      if (uVar2 - 1 < 8) {
        puVar7 = (undefined4 *)
                 malloc((ulong)(((uVar1 + 0x13ff) / 0x1400 + 1 +
                                ((uVar1 + 0x13) / 0x14 + ((uVar1 + 0x13ff) / 0x1400) * 2) * uVar2) *
                               8));
        uVar4 = _UNK_00100db8;
        uVar3 = __LC1;
...

{
  ...
  if (0xf < param_2) {
    uVar1 = *param_1;
    uVar2 = (uint)(byte)(uVar1 >> 0x38) | ((uint)(uVar1 >> 0x20) & 0xff0000) >> 8 |
            (uint)(uVar1 >> 0x18) & 0xff0000 | (uint)(uVar1 >> 8) & 0xff000000;
    if ((((uVar1 & 0xff000000) << 8 | (uVar1 & 0xff0000) << 0x18 | (uVar1 & 0xff00) << 0x28 |
         uVar1 << 0x38) == 0x716f616600000000) && (param_3[2] = uVar2, uVar2 != 0)) {
      uVar1 = param_1[1];
      uVar2 = (uint)(uVar1 >> 0x18) & 0xff | (uint)(uVar1 >> 8) & 0xff00 |
              (uint)(((uVar1 & 0xff00) << 0x28) >> 0x20);
  ...
  *param_5 = 0;
  ...
  if (uVar16 <= param_2) {
    ...
    if (iVar5 == iVar4) {
      ...
      if (((uVar17 & 0xff | (uint)(uVar14 >> 8) & 0xff00 |
           (uint)(((uVar14 & 0xff00) << 0x28) >> 0x20)) == param_3[1]) && (uVar11 <= param_2)) {
            ...
            do {
              ...
              if (uVar6 != 0) {
                ...
                do {
                  ...
                  uVar15 = (uVar12 >> 0x38 | (uVar12 & 0xff000000000000) >> 0x28 |
                            (uVar12 & 0xff0000000000) >> 0x18 | (uVar12 & 0xff00000000) >> 8 |
                            (uVar12 & 0xff000000) << 8 | (uVar12 & 0xff0000) << 0x18 |
                            (uVar12 & 0xff00) << 0x28 | uVar12 << 0x38) << 4;
                  if ((int)uVar11 < iVar8) {
                    lVar18 = (ulong)((byte)(uVar12 >> 4) & 0xf) << 3;
                    do {
                      iVar10 = ((int)((*puVar13 & 0xffffffff) * (puVar13[2] & 0xffffffff)) +
                                (int)((puVar13[1] & 0xffffffff) * (puVar13[3] & 0xffffffff)) +
                                (int)((*puVar13 >> 0x20) * (puVar13[2] >> 0x20)) +
                                (int)((puVar13[1] >> 0x20) * (puVar13[3] >> 0x20)) >> 0xd) +
                               *(int *)(qoa_dequant_tab + ((uVar15 >> 0x3d) + lVar18) * 4);
...

{
  ...
  if (uVar1 != 0) {
    ...
    while( true ) {
      iVar2 = qoa_decode_frame((ulong)uVar1 + param_1,param_2 - uVar1,param_3,
                               (void *)((long)pvVar3 + (ulong)(iVar2 * uVar4) * 2),&local_44);
      uVar1 = uVar1 + iVar2;

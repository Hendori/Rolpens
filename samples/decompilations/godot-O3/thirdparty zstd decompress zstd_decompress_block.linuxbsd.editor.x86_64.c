    ...
    if (bVar14 != 3) {
      if (bVar14 == 1) {
        ...
        if (bVar14 == 1) {
          ...
          lVar13 = 3;
          uVar10 = (ulong)((uint)*(byte *)((long)param_2 + 2) * 0x10000 + (uint)(ushort)*param_2 >>
                          4);
        }
        else {
          lVar13 = 1;
  ...
  if (4 < param_3) {
    ...
    if (uVar10 <= uVar8) {
      ...
      if (uVar1 <= param_3) {
        ...
        if (bVar14 == 3) {
          if (uVar12 == 0) {
            uVar8 = HUF_decompress4X_usingDTable
                              (uVar4,uVar10,pbVar6,uVar15,*(undefined8 *)(param_1 + 0x18));
          }
          else {
          ...
          uVar8 = HUF_decompress4X_hufOnly_wksp
                            (param_1 + 0x2838,uVar4,uVar10,pbVar6,uVar15,param_1 + 0x6abc,0xa00,
                             uVar7);
        }
        else {
          uVar8 = HUF_decompress1X1_DCtx_wksp
                            (param_1 + 0x2838,uVar4,uVar10,pbVar6,uVar15,param_1 + 0x6abc,0xa00,
                             uVar7);
        }
        if (*(int *)(param_1 + 0x76a0) == 2) {
                  ...
                  if ((undefined8 *)param_1[0xed3] < puVar51) {
                    ...
                    *(undefined4 *)(param_1 + 0xed4) = 0;
                    ...
                    if ((local_2a8 + -4 < (undefined8 *)((long)puVar46 + uVar29)) ||
                       (local_2b0 < local_240)) goto LAB_0010267d;
...
LAB_00102106:
                if (0xffffffffffffff88 < uVar29) goto LAB_001016d6;
                  ...
                  if ((undefined8 *)param_1[0xed3] < puVar50) {
                    ...
                    *(undefined4 *)(param_1 + 0xed4) = 0;
                    ...
                    if ((local_2a8 + -4 < (undefined8 *)((long)puVar50 + uVar29)) ||
                       (local_2b0 < local_240)) goto LAB_00103224;
                    uVar16 = *(undefined8 *)((long)param_1 + 0x76ac);
...
LAB_00103c5e:
            if (0xffffffffffffff88 < uVar26) goto LAB_00103787;
...
LAB_00104696:
            if (uVar34 < 0xffffffffffffff89) goto code_r0x001046a0;
            goto LAB_001041c0;
          }
...
LAB_00104c3e:
          if (0xffffffffffffff88 < uVar34) goto LAB_001041c0;
...
LAB_001046b2:
          if ((local_a8 != local_a0) || (local_b0[0] != 0x40)) goto LAB_001041b9;
                  ...
                  if ((undefined8 *)param_1[0xed3] < puVar47) {
                    ...
                    *(undefined4 *)(param_1 + 0xed4) = 0;
                    ...
                    if ((local_2a8 + -4 < (undefined8 *)((long)puVar41 + uVar46)) ||
                       (local_2b0 < local_240)) goto LAB_001067f5;
...
LAB_00106266:
                if (0xffffffffffffff88 < uVar46) goto LAB_001057b6;
                  ...
                  if ((undefined8 *)param_1[0xed3] < puVar45) {
                    ...
                    *(undefined4 *)(param_1 + 0xed4) = 0;
                    ...
                    if ((local_2a8 + -4 < (undefined8 *)((long)puVar45 + uVar46)) ||
                       (local_2b0 < local_240)) goto LAB_001073d0;
                    uVar11 = *(undefined8 *)((long)param_1 + 0x76ac);
                    *puVar45 = *(undefined8 *)((long)param_1 + 0x76a4);
                    puVar45[1] = uVar11;
                    if (0x10 < uVar34) {
  ...
  if (uVar10 < 0xffffffffffffff89) {
    ...
    if (uVar10 < 0xffffffffffffff89) {
      if ((((param_2 == (undefined8 *)0x0) || (param_3 == 0)) && (0 < local_13c)) ||
         ((undefined8 *)0xffffffffffefffff < param_2)) goto LAB_0010823f;
...
LAB_00108c96:
                  if (uVar10 < 0xffffffffffffff89) goto code_r0x00108ca0;
                  goto LAB_00108200;
                }
...
LAB_00109380:
                if (0xffffffffffffff88 < uVar10) goto LAB_00108200;
...
LAB_00108cb2:
                if ((local_a8 != local_a0) || (auStack_b0[0] != 0x40)) goto LAB_00108370;
                *(int *)((long)param_1 + 0x683c) = (int)local_60[0];

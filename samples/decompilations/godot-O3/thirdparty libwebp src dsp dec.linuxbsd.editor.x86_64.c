...

{
  ...
  do {
    lVar2 = lVar1 + 1;
    iVar3 = iVar3 + (uint)*(byte *)((long)param_1 + lVar1 * 0x20 + -1) +
                    (uint)*(byte *)((long)param_1 + lVar1 + -0x20);
    lVar1 = lVar2;
  } while (lVar2 != 0x10);
...

{
  ...
  do {
    lVar1 = lVar3 + 1;
    iVar2 = iVar2 + (uint)*(byte *)((long)param_1 + lVar3 * 0x20 + -1) +
                    (uint)*(byte *)((long)param_1 + lVar3 + -0x20);
    lVar3 = lVar1;
  } while (lVar1 != 8);
...

{
  ...
  uVar26 = (undefined1)
           ((int)((uint)auVar13._8_2_ + (auVar15._0_4_ & 0xffff) + (uVar29 & 0xffff) +
                  (uint)auVar1[0xc] +
                  (uVar6 >> 8 & 0xffff) + (int)uVar23 + auVar10._8_4_ + (uint)auVar1[0xe] +
                  (uint)auVar7._10_2_ + auVar8._4_4_ + auVar11._4_4_ + (uint)auVar1[0xd] +
                  (uVar6 >> 0x18) + (auVar3._10_4_ >> 0x10) + (uint)(uint3)(auVar9._10_3_ >> 0x10) +
                  (uint)auVar1[0xf] + 8) >> 4);
...

{
  ...
  auVar17[0xc] = uVar42;
  lVar35 = (ulong)((int)((auVar21._0_4_ & 0xffff) + (int)CONCAT42(auVar3._10_4_,auVar24._0_2_) +
                         (uint)auVar15._8_2_ + (int)CONCAT32(auVar17._10_3_,auVar6._12_2_) + 4 +
                        auVar11._4_4_ + (auVar3._10_4_ >> 0x10) +
                        (int)CONCAT72(SUB137(auVar31 << 0x40,6),auVar10._10_2_) +
                        (uint)(uint3)(auVar17._10_3_ >> 0x10)) >> 3 & 0xff) * 0x101010101010101;
  plVar36 = param_1;
  do {
    *plVar36 = lVar35;
    plVar37 = plVar36 + 8;

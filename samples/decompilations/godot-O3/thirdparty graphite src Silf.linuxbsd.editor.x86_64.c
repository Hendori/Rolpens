...
void __thiscall graphite2::Silf::Silf(Silf *this)
...
/* graphite2::Silf::releaseBuffers() */

void __thiscall graphite2::Silf::releaseBuffers(Silf *this)
...
/* graphite2::Silf::findPseudo(unsigned int) const */

ushort __thiscall graphite2::Silf::findPseudo(Silf *this,uint param_1)
...
/* graphite2::Silf::findClassIndex(unsigned short, unsigned short) const */

ulong __thiscall graphite2::Silf::findClassIndex(Silf *this,ushort param_1,ushort param_2)

{
  ...
  if (param_1 < *(ushort *)(this + 0x3e)) {
    ...
    do {
      puVar2 = (ushort *)
               ((((long)puVar3 - (long)puVar5 >> 1) - ((long)puVar3 - (long)puVar5 >> 0x3f) &
                0xfffffffffffffffcU) + (long)puVar5);
      if (*puVar2 <= param_2) {
        puVar5 = puVar2;
        puVar2 = puVar3;
      }
...
/* graphite2::Silf::getClassGlyph(unsigned short, unsigned int) const */

undefined2 __thiscall graphite2::Silf::getClassGlyph(Silf *this,ushort param_1,uint param_2)
...
/* graphite2::Silf::runGraphite(graphite2::Segment*, unsigned char, unsigned char, int) const */

undefined8 __thiscall
graphite2::Silf::runGraphite(Silf *this,Segment *param_1,uchar param_2,uchar param_3,int param_4)
...
LAB_00100530:
      if (param_3 + 1 != (uint)(byte)SVar7) goto LAB_00100406;
    }
LAB_001003ed:
    param_3 = param_3 + '\x01';
  }
  ...
  while (SVar6 = (Silf)param_3, uVar4 < (byte)SVar6) {
    if ((byte)SVar7 != uVar4) {
      do {
        ...
        if (((((0x1f < uVar4) || (((byte)param_1[0xc6] >> ((uint)uVar4 & 0x1f) & 1) == 0)) ||
             (pMVar5[0x48] != (Machine)0x0)) &&
            (cVar2 = graphite2::Pass::runGraphite
                               (pMVar5,(FiniteStateMachine *)&local_1068,SUB81(&local_1888,0)),
            cVar2 == '\0')) ||
           ((local_50 != 0 || ((ulong)(lVar1 << 6) < *(ulong *)(param_1 + 0xb0))))) {
          uVar3 = 0;
          goto LAB_0010039e;
        }
        uVar4 = uVar4 + 1;
...
ulong __thiscall
graphite2::Silf::readClassMap(Silf *this,uchar *param_1,ulong param_2,uint param_3,Error *param_4)

{
  ...
  *(undefined4 *)param_4 = 0;
  ...
  if (param_3 < 0x40000) {
    ...
    uVar15 = (ulong)(long)(int)((uint)(ushort)(puVar11[uVar4] << 8 | puVar11[uVar4] >> 8) -
                               (uint)uVar2) >> 1;
    uVar5 = (uint)uVar15;
    if (uVar14 != uVar2) {
    ...
    *(undefined4 *)param_4 = 0;
    ...
    do {
      uVar14 = *puVar11;
      puVar11 = puVar11 + 1;
      uVar6 = (uint)((ulong)(long)(int)((uint)(ushort)(uVar14 << 8 | uVar14 >> 8) - (uint)uVar2) >>
                    1);
      *puVar8 = uVar6;
...
LAB_00100850:
    ...
    *(undefined4 *)param_4 = 0;
    if (uVar15 != 0) {
      sVar10 = 0;
      do {
        *(ushort *)((long)pvVar9 + sVar10) =
             *(ushort *)((long)local_40[0] + sVar10) << 8 |
             *(ushort *)((long)local_40[0] + sVar10) >> 8;
        sVar10 = sVar10 + 2;
    ...
    while( true ) {
      ...
      uVar12 = *puVar11;
      if (((uVar12 == 0) || (uVar5 < uVar6 + 4 + (uint)uVar12 * 2)) ||
         ((uint)uVar12 != (uint)puVar11[3] + (uint)puVar11[1])) {
...
LAB_00100741:
    *(undefined4 *)param_4 = 0x1f;
    return 0xffffffff;
  }
LAB_00100689:
  *(undefined4 *)param_4 = 0x1d;
  return 0xffffffff;
}
...
undefined8 __thiscall
graphite2::Silf::readGraphite(Silf *this,uchar *param_1,ulong param_2,Face *param_3,uint param_4)
    ...
    *(ushort *)(this + 0x46) = puVar24[2] << 8 | puVar24[2] >> 8;
    ...
    if ((ushort)(uVar27 << 8 | uVar27 >> 8) < *(ushort *)(lVar26 + 0x28)) {
      ...
      *(ushort *)(this + 0x38) = uVar27;
      ...
      puVar29 = puVar29 + (ulong)bVar11 +
                          (ulong)*(byte *)((long)puVar29 + (ulong)bVar11 * 2 + 1) * 2 + 1;
      ...
      *(void **)(this + 8) = pvVar20;
      ...
      uVar21 = readClassMap(this,(uchar *)local_50,(ulong)(param_1 + lVar26),param_4,
                            (Error *)&local_54);
      ...
      if (local_54 == 0) {
        if (uVar21 <= ((ulong)(param_1 + lVar26) & 0xffffffff)) {
          for (uVar21 = 0; uVar21 < (byte)this[0x28]; uVar21 = uVar21 + 1) {
            ...
            uVar16 = *local_48;
            *(uint *)(param_3 + 0x9c) =
                 (*(uint *)(param_3 + 0x98) & 0xff00) + 3 + (int)uVar21 * 0x10000;
            uVar16 = uVar16 >> 0x18 | (uVar16 & 0xff0000) >> 8 | (uVar16 & 0xff00) << 8 |
                     uVar16 << 0x18;
            if ((uVar16 < uVar15) || (local_54 = 0, uVar15 < uVar28)) {
              iVar31 = 0x22;
              goto LAB_001009bc;
            }
            if (param_2 < uVar16) {
            ...
            *puVar30 = this;
            cVar14 = graphite2::Pass::readPass
                               (puVar30,param_1 + uVar15,uVar16 - uVar15,(ulong)uVar15,param_3,
                                iVar31,param_4,(Error *)&local_54);
            if (cVar14 == '\0') {
              releaseBuffers(this);
              goto LAB_001008bf;
            }
          ...
          *(undefined2 *)(this + 0x48) = *(undefined2 *)(*(long *)(param_3 + 0x78) + 0x2c);
          ...
          this[0x50] = (Silf)((char)this[0x2e] * '\x02' & 2U | (byte)(uVar28 << 2) |
                             (byte)this[0x50] & 0xf9);
...
/* unsigned int be::read<unsigned int>(unsigned char const*&) */

uint be::read<unsigned_int>(uchar **param_1)
...
/* unsigned int graphite2::Silf::readClassOffsets<unsigned int>(unsigned char const*&, unsigned
   long, graphite2::Error&) */

uint __thiscall
graphite2::Silf::readClassOffsets<unsigned_int>
          (Silf *this,uchar **param_1,ulong param_2,Error *param_3)

{
  ...
  uVar5 = *puVar6;
  uVar7 = (uVar7 >> 0x18 | (uVar7 & 0xff0000) >> 8 | (uVar7 & 0xff00) << 8 | uVar7 << 0x18) - uVar8
          >> 1;

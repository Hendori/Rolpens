...

{
  ...
  iVar7 = *(int *)(this + 0x1c);
  iVar2 = *(int *)(this + 0x20);
  if ((iVar7 != iVar2) && (uVar15 = iVar2 - iVar7, iVar2 < iVar7)) {
    ...
    if (uVar13 == 4) {
      ...
      if (0 < iVar7) {
        ...
        do {
          ...
          uVar17 = CONCAT44(((float)((ulong)uVar1 >> 0x20) - fVar25) * fVar16 + fVar25,
                            ((float)uVar1 - fVar23) * fVar16 + fVar23);
      ...
      if (uVar13 == 1) {
        ...
        if (0 < iVar7) {
          ...
          do {
            ...
            fVar16 = fVar16 + (*(float *)(*(long *)(this + 0x30) +
                                         (ulong)(uVar8 + 1 & *(uint *)(this + 8)) * 4) - fVar16) *
                              (float)(uVar13 & 0x1fff) * fVar5;
            uVar17 = CONCAT44(fVar16,fVar16);
            *(undefined8 *)pAVar9 = uVar17;
            pAVar10 = pAVar9 + 8;
          } while (param_1 + (long)iVar7 * 8 != pAVar9 + 8);
LAB_00100390:
          *(uint *)(this + 0x24) = uVar13;
          *(undefined8 *)pAVar9 = uVar17;
        }
      }
      else {
...

{
  ...
  if (pvVar8 != (void *)0x0) {
LAB_001005ef:
    if ((*(uint *)this == uVar10) && (param_1 == *(int *)(this + 0x10))) goto LAB_00100681;

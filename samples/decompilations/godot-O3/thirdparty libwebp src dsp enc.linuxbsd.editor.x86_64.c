  ...
  do {
    ...
    do {
      *(undefined *)(lVar24 + lVar19) =
           (&DAT_0010271f)[(ulong)param_2[lVar19] + ((ulong)bVar54 - (ulong)bVar49)];
      lVar19 = lVar19 + 1;
    } while (lVar19 != 4);
    pbVar21 = pbVar21 + -1;
    lVar24 = lVar24 + 0x20;
...

{
  ...
  if (param_3 == (undefined1 (*) [16])0x0) {
    ...
    if (param_2 != (undefined1 (*) [16])0x0) {
      ...
      uVar69 = (undefined1)
               ((int)(((uint)auVar36._8_2_ + (auVar40._0_4_ & 0xffff) + (uVar77 & 0xffff) +
                       (uint)auVar1[0xc] +
                       (uVar19 >> 8 & 0xffff) + (int)uVar63 + auVar27._8_4_ + (uint)auVar1[0xe] +
    ...
    iVar74 = (uint)auVar35._8_2_ + (auVar39._0_4_ & 0xffff) + (uVar77 & 0xffff) + (uint)auVar1[0xc]
             + (uVar19 >> 8 & 0xffff) + (int)uVar63 + auVar17._8_4_ + (uint)auVar1[0xe] +
    ...
    if (param_2 != (undefined1 (*) [16])0x0) {
      ...
      iVar70 = (uint)uVar76 + (uint)auVar33._8_2_ + (uVar77 & 0xffff) + (uint)auVar1[0xc] +
               (int)uVar63 + (uVar19 >> 8 & 0xffff) + auVar22._8_4_ + (uint)auVar1[0xe] +
...
LAB_00101a89:
  ...
  do {
    ...
    lVar66 = 0;
    do {
      *(undefined *)((long)param_1 + lVar66) =
           (&DAT_0010271f)[(ulong)(byte)(*param_3)[lVar66] + ((ulong)bVar3 - (ulong)bVar2)];
      lVar66 = lVar66 + 1;
    } while (lVar66 != 0x10);
    param_1 = param_1 + 4;
    param_2 = (undefined1 (*) [16])(*param_2 + 1);
...

{
  ...
  if (param_3 == (ulong *)0x0) {
    ...
    if (param_2 != (ulong *)0x0) {
      ...
      uVar235 = (int)(((auVar36._10_4_ >> 0x10) + auVar69._4_4_ +
                       (int)CONCAT72(SUB137(auVar189 << 0x40,6),auVar68._10_2_) +
                       (uint)(uint3)(auVar109._10_3_ >> 0x10) +
                      (int)CONCAT42(auVar36._10_4_,auVar182._0_2_) + (auVar143._0_4_ & 0xffff) +
                      (uint)auVar107._8_2_ + (int)CONCAT32(auVar109._10_3_,auVar35._12_2_)) * 2 + 8)
                >> 4;
    }
  }
  else {
    ...
    auVar93[0xc] = uVar244;
    iVar232 = (int)CONCAT42(auVar26._10_4_,auVar146._0_2_) + (auVar141._0_4_ & 0xffff) +
              (uint)auVar91._8_2_ + (int)CONCAT32(auVar93._10_3_,auVar25._12_2_) +
              (auVar26._10_4_ >> 0x10) + auVar57._4_4_ +
              (int)CONCAT72(SUB137(auVar153 << 0x40,6),auVar56._10_2_) +
              (uint)(uint3)(auVar93._10_3_ >> 0x10);
    iVar234 = iVar232 * 2;
    if (param_2 != (ulong *)0x0) {
      uVar236 = *param_2;
      uVar244 = (undefined1)(uVar236 >> 0x38);
      ...
      auVar98[0xc] = uVar244;
      iVar234 = (int)CONCAT42(auVar6._10_4_,auVar155._0_2_) + (auVar130._0_4_ & 0xffff) +
                (auVar95._8_4_ & 0xffff) + (int)CONCAT32(auVar98._10_3_,auVar28._12_2_) +
                (auVar6._10_4_ >> 0x10) + auVar60._4_4_ + auVar97._4_4_ +
                (uint)(uint3)(auVar98._10_3_ >> 0x10) + iVar232;
    }
    uVar235 = iVar234 + 8 >> 4;
  }
...
LAB_00101db8:
  ...
  if (param_2 == (ulong *)0x0) {
    ...
    if (param_3 != (ulong *)0x0) {
      ...
      iVar234 = ((auVar138._0_4_ & 0xffff) + (int)CONCAT42(auVar18._10_4_,auVar196._0_2_) +
                 (uint)auVar110._8_2_ + (int)CONCAT32(auVar113._10_3_,auVar37._12_2_) +
                auVar72._4_4_ + (auVar18._10_4_ >> 0x10) +
                (int)CONCAT72(SUB137(auVar198 << 0x40,6),auVar70._10_2_) +
                (uint)(uint3)(auVar113._10_3_ >> 0x10)) * 2;
      goto LAB_00101f0d;
    }
...
LAB_001022fc:
    ...
    if (param_3 == (ulong *)0x0) {
      ...
      uVar235 = (int)(((auVar140._0_4_ & 0xffff) + (int)CONCAT42(auVar22._10_4_,auVar205._0_2_) +
                       (uint)auVar114._8_2_ + (int)CONCAT32(auVar117._10_3_,auVar39._12_2_) +
                      auVar75._4_4_ + (auVar22._10_4_ >> 0x10) +
                      (int)CONCAT72(SUB137(auVar207 << 0x40,6),auVar73._10_2_) +
                      (uint)(uint3)(auVar117._10_3_ >> 0x10)) * 2 + 8) >> 4;
    }
    else {
      ...
      do {
        ...
        lVar229 = 0;
        do {
          *(undefined *)((long)puVar231 + lVar229) =
               (&DAT_0010271f)
               [(ulong)*(byte *)((long)param_3 + lVar229) + ((ulong)(byte)uVar236 - (ulong)bVar1)];
          lVar229 = lVar229 + 1;
        } while (lVar229 != 8);
        puVar231 = puVar231 + 4;
        puVar233 = (ulong *)((long)puVar233 + 1);
      ...
      iVar234 = auVar66._4_4_ + (auVar13._10_4_ >> 0x10) + auVar104._4_4_ +
                (uint)(uint3)(auVar105._10_3_ >> 0x10) +
                (auVar134._0_4_ & 0xffff) + (int)CONCAT42(auVar13._10_4_,auVar178._0_2_) +
                (auVar101._8_4_ & 0xffff) + (int)CONCAT32(auVar105._10_3_,auVar32._12_2_) +
                (auVar31._10_4_ >> 0x10) + auVar63._4_4_ +
                (int)CONCAT72(SUB137(auVar171 << 0x40,6),auVar80._10_2_) +
                (uint)(uint3)(auVar121._10_3_ >> 0x10) +
                (int)CONCAT42(auVar31._10_4_,auVar169._0_2_) + (auVar132._0_4_ & 0xffff) +
                (uint)auVar119._8_2_ + (int)CONCAT32(auVar121._10_3_,auVar45._12_2_);
LAB_00101f0d:
      param_3 = param_3 + 1;
      uVar235 = iVar234 + 8 >> 4;
    }
  ...
  if (puVar238 == (ulong *)0x0) {
    ...
    if (param_3 == (ulong *)0x0) {
      ...
      do {
        ...
        lVar229 = 0;
        do {
          *(undefined *)((long)puVar233 + lVar229) =
               (&DAT_0010271f)
               [(ulong)*(byte *)((long)param_3 + lVar229) + ((ulong)(byte)uVar236 - (ulong)bVar1)];
          lVar229 = lVar229 + 1;
        } while (lVar229 != 8);

                ...
                while( true ) {
                  ...
                  *(uint *)(pAVar25 + 0x10) = uVar36;
                  ...
                  sVar3 = *(short *)(do_resample<signed_char,true,true,false>(signed_const*,AudioFrame*,long&,int&,unsigned_int,AudioStreamPlaybackWAV::IMA_ADPCM_State*,AudioStreamPlaybackWAV::QOA_State*)
                                     ::_ima_adpcm_step_table + (long)*(short *)pAVar25 * 2);
                  sVar30 = (short)(char)do_resample<signed_char,true,true,false>(signed_const*,AudioFrame*,long&,int&,unsigned_int,AudioStreamPlaybackWAV::IMA_ADPCM_State*,AudioStreamPlaybackWAV::QOA_State*)
                                        ::_ima_adpcm_index_table[uVar15] + *(short *)pAVar25;
                  if (sVar30 < 0) {
                    sVar30 = 0;
                  }
                  else if (0x58 < sVar30) {
          ...
          if (uVar36 == 0) {
            ...
            if (cVar1 == '\0') {
              ...
              do {
                ...
                auVar42._0_8_ =
                     (double)(((int)((*(short *)(lVar6 + 0x14 + lVar22 * 4) - iVar24) * uVar36) >>
                              0xd) + iVar24);
                auVar42._8_8_ =
                     (double)(((int)((*(short *)(lVar6 + 0x16 + lVar22 * 4) - iVar28) * uVar36) >>
                              0xd) + iVar28);
...
LAB_0010123d:
                    _err_print_index_error
                              ("operator[]","./core/templates/local_vector.h",0xb2,uVar29,uVar26,
  ...
  if (cVar2 == '\0') {
    ...
    *(AudioStreamPlaybackWAV **)(lVar1 + 0x188) = this;
    ...
    if (((pOVar4 == (Object *)0x0) || (cVar2 = RefCounted::unreference(), cVar2 == '\0')) ||
       (cVar2 = predelete_handler(pOVar4), cVar2 == '\0')) goto LAB_00101931;
  }
  (**(code **)(*(long *)pOVar4 + 0x140))(pOVar4);
  Memory::free_static(pOVar4,false);
...
LAB_0010246b:
    if (*(int *)(in_RSI + 0x348) != 3) goto LAB_0010247a;
LAB_00102560:
...
LAB_00105688:
      if (local_50 != 0) goto LAB_00105626;
    }
    uVar10 = 0;
  }
...
LAB_001067b1:
  ...
  if ((uVar19 == 2) && (bVar11)) {
    ...
    for (lVar37 = 0; (int)lVar37 < local_230; lVar37 = lVar37 + 1) {
      ...
      lVar35 = *(long *)(lVar6 + -8);
      if ((lVar35 <= lVar34) || (lVar34 = lVar32, lVar35 <= lVar32)) goto LAB_001069a9;
...
{
  return (uint)CONCAT71(0x117a,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr) |
...

{
  return (uint)CONCAT71(0x1179,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1179,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x117a,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}
  ...
  if (cVar1 == '\0') {
    ...
    *(AudioStreamWAV **)this = this_00;
    ...
    if (((pOVar3 == (Object *)0x0) || (cVar1 = RefCounted::unreference(), cVar1 == '\0')) ||
       (cVar1 = predelete_handler(pOVar3), cVar1 == '\0')) goto LAB_0010b4a5;
  }
  (**(code **)(*(long *)pOVar3 + 0x140))(pOVar3);
  Memory::free_static(pOVar3,false);
  pOVar2 = (Object *)this_00;
...
/* WARNING: Removing unreachable block (ram,0x0010ba50) */
/* WARNING: Removing unreachable block (ram,0x0010bbe5) */
...
/* WARNING: Removing unreachable block (ram,0x0010c078) */
/* WARNING: Removing unreachable block (ram,0x0010c20d) */
/* WARNING: Removing unreachable block (ram,0x0010c219) */
...
/* WARNING: Removing unreachable block (ram,0x00110b08) */
/* WARNING: Removing unreachable block (ram,0x00110c9d) */
/* WARNING: Removing unreachable block (ram,0x00110ca9) */

...
LAB_00108fe4:
  ...
  do {
    ...
    if (uVar13 <= uVar7) {
      ...
      if ((uint)uVar2 == uVar5) {
LAB_001091d3:
        lVar8 = *(long *)(lStack_60 + uVar6 * 0x10) - *(long *)(local_68 + uVar6 * 0x10);
        if (lVar8 != 0) {
          if (uVar13 < uVar5) {
            plVar3 = (long *)((ulong)uVar13 * 0x10 + lStack_60);
            plVar4 = (long *)(lStack_60 + 0x10 +
                             ((ulong)((uVar5 - uVar13) - 1) + (ulong)uVar13) * 0x10);
...
LAB_00109240:
          plVar4 = (long *)((ulong)uVar10 * 0x10 + lStack_60);
...
LAB_0010c0e8:
  if (lVar11 < iVar8 + lVar17) goto LAB_0010c560;
...
LAB_0010f2eb:
        if (*(long *)(lVar6 + 0x308) != 0) goto LAB_0010fb90;
        lVar21 = param_2[0x1d];
      }
      else {

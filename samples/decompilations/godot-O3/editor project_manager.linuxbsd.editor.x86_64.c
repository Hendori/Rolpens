...
LAB_00116893:
  if ((float)uVar52 * __LC28 < (float)(iVar45 + 1)) {
...
LAB_00119fdc:
  ...
  if ((float)uVar28 * __LC28 < (float)(iVar35 + 1)) {
...
LAB_001228c4:
    if ((float)uVar39 * __LC28 < (float)(iVar44 + 1)) goto LAB_001228ea;
  }
  local_58 = 0;
  local_68 = (undefined1  [16])0x0;
  if (*(long *)param_1 == 0) {

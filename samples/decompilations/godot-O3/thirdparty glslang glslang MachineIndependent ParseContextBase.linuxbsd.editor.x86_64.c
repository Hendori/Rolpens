...
/* glslang::TParseContextBase::parseSwizzleSelector(glslang::TSourceLoc const&,
   ...
   int, glslang::TSwizzleSelectors<int>&) */

void __thiscall
glslang::TParseContextBase::parseSwizzleSelector
          (TParseContextBase *this,TSourceLoc *param_1,basic_string *param_2,int param_3,
          TSwizzleSelectors *param_4)

{
  ...
  if (4 < uVar2) {
    (**(code **)(*(long *)this + 0x158))
              (this,param_1,"vector swizzle too long",*(undefined8 *)(param_2 + 8),&_LC0,
               *(long *)this,this,param_1);
    uVar2 = *(ulong *)(param_2 + 0x10);
  }
  piVar6 = local_58;
  iVar1 = (int)uVar2;
...
LAB_00100156:
    ...
    do {
      ...
      if (param_3 <= *(int *)(param_4 + lVar5 * 4 + 4)) {
        (**(code **)(*(long *)this + 0x158))
                  (this,param_1,"vector swizzle selection out of range",*(undefined8 *)(param_2 + 8)
                   ,&_LC0);
        *(int *)param_4 = iVar3;
        goto LAB_00100156;
      }
      if ((lVar5 != 0) && (local_58[lVar5] != *(int *)(&stack0xffffffffffffffa4 + lVar5 * 4))) {
        (**(code **)(*(long *)this + 0x158))
                  (this,param_1,"vector swizzle selectors not from the same set",
                   *(undefined8 *)(param_2 + 8),&_LC0);
        *(int *)param_4 = iVar3;
        break;
      }
      lVar5 = lVar5 + 1;
...
void glslang::TParseContextBase::ppWarn
               (TSourceLoc *param_1,char *param_2,char *param_3,char *param_4,...)
...
void glslang::TParseContextBase::error
               (TSourceLoc *param_1,char *param_2,char *param_3,char *param_4,...)

{
  ...
  lVar1 = *(long *)(in_FS_OFFSET + 0x28);
  if (((*(uint *)(param_1 + 0xd0) & 0x20) == 0) &&
     ((((*(uint *)(param_1 + 0xd0) & 0x8000) == 0 || (*(int *)(param_1 + 0xd4) < 1)) &&
      ((**(code **)(*(long *)param_1 + 0x250))(param_1), ((byte)param_1[0xd0] & 0x80) == 0)))) {
...
void glslang::TParseContextBase::ppError
               (TSourceLoc *param_1,char *param_2,char *param_3,char *param_4,...)
...
void glslang::TParseContextBase::warn
               (TSourceLoc *param_1,char *param_2,char *param_3,char *param_4,...)
...
std::
_Rb_tree<int,std::pair<int_const,int>,std::_Select1st<std::pair<int_const,int>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,int>>>
...
/* std::_Rb_tree<int, std::pair<int const, glslang::TVariable*>, std::_Select1st<std::pair<int
   ...
   glslang::TVariable*> > >::_M_get_insert_unique_pos(int const&) [clone .isra.0] */

undefined1  [16] __thiscall
std::
_Rb_tree<int,std::pair<int_const,glslang::TVariable*>,std::_Select1st<std::pair<int_const,glslang::TVariable*>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TVariable*>>>
::_M_get_insert_unique_pos
          (_Rb_tree<int,std::pair<int_const,glslang::TVariable*>,std::_Select1st<std::pair<int_const,glslang::TVariable*>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TVariable*>>>
           *this,int *param_1)
...
/* glslang::TParseContextBase::trackLinkage(glslang::TSymbol&) [clone .part.0] */

void __thiscall glslang::TParseContextBase::trackLinkage(TParseContextBase *this,TSymbol *param_1)

{
  ...
  if (puVar1 == puVar2) {
    ...
    lVar7 = uVar6 * 8;
LAB_0010093f:
    lVar4 = glslang::TPoolAllocator::allocate(*(ulong *)(this + 0x1c8));
...
glslang::TParseContextBase::rValueErrorCheck
          (TParseContextBase *this,TSourceLoc *param_1,char *param_2,TIntermTyped *param_3)
      ...
      if (plVar6 != (long *)0x0) {
        ...
        if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
          ...
          (*UNRECOVERED_JUMPTABLE)
                    (this,param_1,"can\'t read from writeonly object: ",param_2,plVar6[1]);
          return;
        }
        goto LAB_00100dbd;
      }
...
LAB_00100be5:
        if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
                    ...
                    /* WARNING: Treating indirect jump as call */
          (**(code **)(*(long *)this + 0x158))
                    (this,param_1,"can\'t read from writeonly object: ",param_2,&_LC0,
                     *(code **)(*(long *)this + 0x158));
          return;
        }
      }
        ...
        if (*(code **)(*plVar5 + 0x20) == TIntermOperator::getAsOperator) {
          ...
          if (iVar4 != 0xb8) {
LAB_00100bda:
            if (iVar4 != 0xb6) goto LAB_00100be5;
          }
        }
        else {
...
LAB_00100d24:
                    ...
                    /* WARNING: Treating indirect jump as call */
          (*UNRECOVERED_JUMPTABLE)(this,param_1,"can\'t read from writeonly object: ",param_2,lVar9)
          ;
          return;
        }
      }
...
long * __thiscall
glslang::TParseContextBase::getEditableVariable(TParseContextBase *this,char *param_1)

{
  ...
  _M_construct<char_const*>(&local_68,param_1,param_1 + sVar7);
  __s2 = local_60;
  lVar2 = *plVar1;
...
LAB_00100fea:
      ...
      do {
        while( true ) {
          ...
          if ((uVar8 != 0) && (iVar5 = memcmp((void *)plVar9[5],__s2,uVar8), iVar5 != 0)) break;
...
LAB_00100f96:
      if (plVar1 == plVar11) goto LAB_00100fea;
      uVar3 = plVar11[6];
      uVar8 = local_58;
      if (uVar3 <= local_58) {
        uVar8 = uVar3;
...
LAB_00100fe1:
        if ((int)uVar8 < 0) goto LAB_00100fea;
      }
...
glslang::TParseContextBase::lValueErrorCheck
          (TParseContextBase *this,TSourceLoc *param_1,char *param_2,TIntermTyped *param_3)
...
LAB_00101577:
        ...
        (*UNRECOVERED_JUMPTABLE)
                  (this,param_1," l-value required",param_2,"\"%s\" (%s)",lVar12,local_78);
        goto LAB_0010122c;
      }
    }
    lVar12 = *(long *)this;
    puVar13 = &_LC25;
LAB_001012fd:
    (**(code **)(lVar12 + 0x158))(this,param_1," l-value required",param_2,puVar13,local_78);
  }
  else {
    (**(code **)(*(long *)this + 0x158))
              (this,param_1," l-value required",param_2,"\"%s\" (%s)",lVar12,local_78);
...
/* glslang::TParseContextBase::selectFunction(glslang::TVector<glslang::TFunction const*>,
   ...
   glslang::TType const&)>, bool&) */

long * __thiscall
glslang::TParseContextBase::selectFunction
...
LAB_0010170b:
  ...
  if (0 < iVar19) {
    do {
      ...
      lVar8 = *plVar15;
      if (((*(byte *)(plVar11 + 1) & 0x7f) == 0x10) ||
         (((*(byte *)(plVar11 + 1) & 0x7f) + 0x6e & 0x7f) < 2)) {
...
LAB_00102708:
  ...
  lVar4 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsBasicType(glslang::TBasicType)const::_lambda(glslang::TType_const*)_1_>(glslang::TType::containsBasicType(glslang::TBasicType)const::_lambda(glslang::TType_const*)_1_)const::_lambda(glslang::TTypeLoc_const&)_1_>>
                    (*(undefined8 *)(plVar6[0xd] + 8),lVar5,param_3);
  if (lVar5 == lVar4) {
    return param_2;
  }
  return param_1;
...
LAB_00103090:
    if (*(code **)(lVar6 + 0xd8) == TType::isVector) {
...
LAB_001030b6:
      ...
      (**(code **)(*(long *)this + 0x158))
                (this,param_1,&_LC0,&_LC222,"vector index out of range \'%d\'",*param_3);
...
LAB_00103192:
      ...
      (**(code **)(*(long *)this + 0x158))
                (this,param_1,&_LC0,&_LC222,"matrix index out of range \'%d\'",*param_3);
...
LAB_00102fc5:
    ...
    if (*(code **)(lVar6 + 0x1d0) == TType::containsSpecializationSize) {
      if (*(code **)(lVar6 + 0xe8) == TType::isArray) {
        ...
        if (lVar9 != 0) {
LAB_00102ffc:
          if (*(long *)(*(long *)(*(long *)(lVar9 + 8) + 8) + 8) != 0) goto LAB_0010300f;
        }
      }
      else {
        cVar3 = (**(code **)(lVar6 + 0xe8))(param_2);
...
LAB_00103328:
        lVar9 = *(long *)(*(long *)(param_2 + 0x68) + 0x10);
        lVar7 = std::
                __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsSpecializationSize()const::_lambda(glslang::TType_const*)_1_>(glslang::TType::containsSpecializationSize()const::_lambda(glslang::TType_const*)_1_)const::_lambda(glslang::TTypeLoc_const&)_1_>>
                          (*(undefined8 *)(*(long *)(param_2 + 0x68) + 8),lVar9);
        lVar6 = *(long *)param_2;
...
LAB_00103287:
    ...
    (**(code **)(*(long *)this + 0x158))
              (this,param_1,&_LC0,&_LC222,"array index out of range \'%d\'",*param_3);
...
void __thiscall glslang::TParseContextBase::makeEditable(TParseContextBase *this,TSymbol **param_1)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  lVar5 = (**(code **)(*(long *)pTVar1 + 0x48))(pTVar1);
  if (lVar5 == 0) {
    plVar7 = (long *)(*(code *)(*(undefined8 **)pTVar1)[0xb])(pTVar1);
    if (*(code **)(*plVar7 + 0xb0) == TAnonMember::getAnonContainer) {
      puVar9 = (undefined8 *)plVar7[5];
    }
    else {
      puVar9 = (undefined8 *)(**(code **)(*plVar7 + 0xb0))(plVar7);
    }
    pTVar6 = (TSymbol *)(**(code **)*puVar9)();
    pcVar15 = *(code **)(*(long *)pTVar6 + 0x20);
    ...
    *puVar9 = uVar10;
    puVar9[1] = puVar9 + 3;
    std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
    _M_construct<char_const*>(puVar9,&_LC0,&_LC0);
    if (pcVar15 == TSymbol::changeName) {
    ...
    lVar5 = plVar7[2];
    if (pcVar15 == TSymbol::setUniqueId) goto LAB_001034a5;
LAB_00103749:
    (*pcVar15)(pTVar6);
  }
  else {
...
LAB_00103495:
    if (pcVar15 != TSymbol::setUniqueId) goto LAB_00103749;
LAB_001034a5:
    *(long *)(pTVar6 + 0x10) = lVar5;
  }
  this_00 = *(TSymbolTableLevel **)(*plVar2 + 0x18);
  local_68 = glslang::GetThreadPoolAllocator();
  local_60 = local_50;
  local_58 = 0;
  local_50[0] = 0;
  TSymbolTableLevel::insert(this_00,pTVar6,*(bool *)((long)plVar2 + 0x21),(basic_string *)&local_68)
  ;
  lVar5 = (**(code **)(*(long *)pTVar1 + 0x48))(pTVar1);
  if (lVar5 == 0) {
    ...
    if (lVar14 != 0) {
      ...
      do {
        while( true ) {
          ...
          if ((uVar13 != 0) && (iVar4 = memcmp(*(void **)(lVar14 + 0x28),__s2,uVar13), iVar4 != 0))
          break;
          lVar12 = uVar3 - uVar8;
...
LAB_00103658:
    ...
    *param_1 = pTVar6;
LAB_001034fa:
    if (*(code **)(*(long *)this + 600) != trackLinkage) {
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
/* glslang::TParseContextBase::growAtomicCounterBlock(int, glslang::TSourceLoc const&,
   glslang::TType&, std::__cxx11::basic_string<char, std::char_traits<char>,
   glslang::std::allocator<char> > const&, glslang::TVector<glslang::TTypeLoc>*) */

void __thiscall
glslang::TParseContextBase::growAtomicCounterBlock
          (TParseContextBase *this,int param_1,TSourceLoc *param_2,TType *param_3,
          basic_string *param_4,TVector *param_5)
...
LAB_00103d00:
    local_2e8 = (undefined **)CONCAT44(local_2e8._4_4_,param_1);
    uStack_2e0 = 0;
    std::
    _Rb_tree<int,std::pair<int_const,glslang::TVariable*>,std::_Select1st<std::pair<int_const,glslang::TVariable*>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TVariable*>>>
    ::_M_insert_unique<std::pair<int_const,glslang::TVariable*>>
              ((_Rb_tree<int,std::pair<int_const,glslang::TVariable*>,std::_Select1st<std::pair<int_const,glslang::TVariable*>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TVariable*>>>
                *)(this + 0x488),(pair_conflict *)&local_2e8);
    local_2e8 = (undefined **)(ulong)(uint)param_1;
    std::
    _Rb_tree<int,std::pair<int_const,int>,std::_Select1st<std::pair<int_const,int>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,int>>>
    ::_M_insert_unique<std::pair<int_const,int>>
              ((_Rb_tree<int,std::pair<int_const,int>,std::_Select1st<std::pair<int_const,int>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,int>>>
                *)(this + 0x4c8),(pair_conflict *)&local_2e8);
    p_Var18 = *(_Rb_tree_node_base **)(this + 0x4a0);
...
LAB_00103d4f:
    ...
    *(undefined8 *)(p_Var18 + 0x28) = 0;
    if ((lVar25 != 0) &&
       (p_Var20 = *(_Rb_tree_node_base **)(this + 0x4b0), *(int *)(p_Var20 + 0x20) < param_1)) {
LAB_00104068:
      bVar34 = false;
LAB_00103dbb:
      if ((p_Var1 == p_Var20) || (p_Var30 = p_Var20, bVar34)) {
        bVar34 = true;
        p_Var30 = p_Var18;
      }
      else {
...
LAB_00103d90:
    ...
    do {
      while( true ) {
        ...
        p_Var19 = p_Var29;
        if (*(_Rb_tree_node_base **)(p_Var29 + 0x10) == (_Rb_tree_node_base *)0x0)
        goto LAB_001038d1;
      }
      p_Var20 = *(_Rb_tree_node_base **)(p_Var29 + 0x18);
    } while (*(_Rb_tree_node_base **)(p_Var29 + 0x18) != (_Rb_tree_node_base *)0x0);
LAB_001038d1:
    if ((p_Var1 == p_Var19) || (param_1 < *(int *)(p_Var19 + 0x20))) goto LAB_00103d00;
LAB_001038f8:
    do {
      while( true ) {
        p_Var20 = p_Var18;
...
LAB_00103911:
    if (p_Var1 == p_Var30) goto LAB_00103d4f;
...
LAB_00103f0b:
    ...
    p_Var30 = p_Var18;
LAB_00103f16:
    std::_Rb_tree_insert_and_rebalance(bVar34,p_Var30,p_Var20,p_Var1);
    *(long *)(this + 0x4b8) = *(long *)(this + 0x4b8) + 1;
  }
LAB_00103924:
  p_Var1 = (_Rb_tree_node_base *)(this + 0x4d8);
...
LAB_001040a0:
    ...
    *(undefined4 *)(p_Var18 + 0x24) = 0;
    if ((lVar25 != 0) &&
       (p_Var19 = *(_Rb_tree_node_base **)(this + 0x4f0), *(int *)(p_Var19 + 0x20) < param_1)) {
LAB_001040e9:
      bVar34 = false;
LAB_00104006:
      if ((p_Var1 == p_Var19) || (p_Var20 = p_Var19, bVar34)) {
        bVar34 = true;
      }
      else {
LAB_0010449d:
...
LAB_00103fd8:
    local_328 = (_Rb_tree<int,std::pair<int_const,int>,std::_Select1st<std::pair<int_const,int>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,int>>>
                 *)(this + 0x4c8);
    auVar35 = std::
              _Rb_tree<int,std::pair<int_const,int>,std::_Select1st<std::pair<int_const,int>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,int>>>
              ::_M_get_insert_unique_pos(local_328,piVar33);
...
LAB_00103e88:
    ...
    p_Var19 = p_Var20;
LAB_00103e93:
    std::_Rb_tree_insert_and_rebalance(bVar34,p_Var18,p_Var19,p_Var1);
...
LAB_00103975:
  ...
  if (*(long *)(p_Var30 + 0x28) == 0) {
    ...
    *puVar15 = uVar16;
    ...
    std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
    _M_construct<char_const*>(puVar15,local_248,local_248 + sVar17);
    uVar13 = glslang::GetThreadPoolAllocator();
    ...
    *puVar15 = uVar22;
    ...
    std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
    _M_construct<char_const*>(puVar15,pcVar6,pcVar6 + sVar17);
    local_270 = puVar15;
    ...
    *(basic_string **)(pbVar24 + 8) = pbVar24 + 0x18;
    std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
    _M_construct<char_const*>(pbVar24,&_LC0,&_LC0);
  ...
  *(uint *)(ppuVar14 + 1) =
       CONCAT22((short)((uint)*(undefined4 *)(ppuVar14 + 1) >> 0x10),0x100) & 0xf800ffff;
  *(undefined8 *)((long)ppuVar14 + 0x44) = 0xfffff800;
  *(undefined2 *)(ppuVar14 + 0xb) = 0;
  *(undefined8 *)((long)ppuVar14 + 0x24) = uVar16;
  *(ulong *)((long)ppuVar14 + 0x2d) =
       *(ulong *)((long)ppuVar14 + 0x2d) & 0xffffff0000ffc07f | 0xffff001f80;
  ...
  *(ulong *)((long)ppuVar14 + 0x2c) =
       *(ulong *)((long)ppuVar14 + 0x2c) & 0xffffffff8000 | 0xffff000000004fff;
  ...
  *(TType *)(ppuVar14 + 1) = TVar2;
  puVar32 = *(undefined **)(param_3 + 0x18);
  ppuVar14[2] = *(undefined **)(param_3 + 0x10);
  ppuVar14[3] = puVar32;
  puVar32 = *(undefined **)(param_3 + 0x28);
  ppuVar14[4] = *(undefined **)(param_3 + 0x20);
  ppuVar14[5] = puVar32;
  puVar32 = *(undefined **)(param_3 + 0x38);
  ppuVar14[6] = *(undefined **)(param_3 + 0x30);
  ppuVar14[7] = puVar32;
  puVar32 = *(undefined **)(param_3 + 0x48);
  ppuVar14[8] = *(undefined **)(param_3 + 0x40);
  ppuVar14[9] = puVar32;
  puVar32 = *(undefined **)(param_3 + 0x58);
  ppuVar14[10] = *(undefined **)(param_3 + 0x50);
  ppuVar14[0xb] = puVar32;
  TVar2 = param_3[9];
  ...
  *(byte *)((long)ppuVar14 + 10) =
       bVar3 & 0x80 | bVar27 | bVar28 | (byte)TVar2 & 0x20 | (byte)param_3[10] & 0x40;
  *(ushort *)((long)ppuVar14 + 10) =
       *(ushort *)((long)ppuVar14 + 10) & 0xfc7f | *(ushort *)(param_3 + 10) & 0x380;
...
LAB_00104588:
  ...
  if (pcVar7 == TVariable::getType) {
    pvVar31 = (vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>> *)
              (*(long **)(p_Var30 + 0x28))[0x12];
    puVar15 = *(undefined8 **)(pvVar31 + 0x10);
    if (puVar15 == *(undefined8 **)(pvVar31 + 0x18)) {
LAB_0010408f:
      std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>::
      _M_realloc_insert<glslang::TTypeLoc_const&>(pvVar31,puVar15,&local_2e8);
      goto LAB_00103c6a;
    }
  }
  else {
...
LAB_00103c6a:
  ...
  if (iVar5 == 0) {
    ...
    if (cVar11 == '\0') {
      (**(code **)(*(long *)this + 0x158))
                (this,param_2,"failed to insert the global constant buffer","buffer",&_LC0);
    }
    ...
    this_01 = *(TSymbolTableLevel **)
               (*(long *)this_00 +
               (long)((int)(*(long *)(this_00 + 8) - *(long *)this_00 >> 3) + -1) * 8);
...
/* glslang::TParseContextBase::outputMessage(glslang::TSourceLoc const&, char const*, char const*,
   char const*, glslang::TPrefixType, __va_list_tag*) */

void __thiscall
glslang::TParseContextBase::outputMessage
          (TParseContextBase *this,long *param_1,undefined8 param_2,undefined8 param_3,
          undefined8 param_4,int param_6,undefined8 param_7)

{
  ...
  __snprintf_chk(local_5f8,0x18,2,0x18,&_LC240,*(undefined4 *)((long)param_1 + 0xc),param_2,param_3,
                 local_5f8);
  lVar4 = *param_1;
  if (lVar4 == 0) {
...
LAB_00104c55:
      ...
      if (uVar10 < 100) {
        ...
        acStack_517[0] = _LC220[8];
        acStack_517[1] = _LC220[9];
        acStack_517[2] = _LC220[10];
        acStack_517[3] = _LC220[0xb];
        acStack_517[4] = _LC220[0xc];
        acStack_517[5] = _LC220[0xd];
        acStack_517[6] = _LC220[0xe];
        acStack_517[7] = _LC220[0xf];
      }
      else {
        if (uVar10 < 1000) {
          uVar5 = 2;
...
LAB_00104acb:
        ...
        do {
          ...
          uVar10 = (uVar7 >> 2) / 0x19;
          lVar4 = (uVar7 + ((SUB168(auVar2 * ZEXT816(0x28f5c28f5c28f5c3),8) & 0xfffffffffffffffc) +
                           uVar10) * -0x14) * 2;
    ...
    *pcVar12 = cVar13;
    ...
    if (((*(long *)(lVar4 + 8) == 0) && (*(long *)(psVar11 + 0x28) != 0)) &&
       ((uVar5 & 0x10000) != 0)) goto LAB_001047ab;
...
void __thiscall
glslang::TParseContextBase::growGlobalUniformBlock
          (TParseContextBase *this,TSourceLoc *param_1,TType *param_2,basic_string *param_3,
          TVector *param_4)

{
  ...
  if (pTVar34 == (TVariable *)0x0) {
    ...
    std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
    _M_construct<char_const*>(puVar16,pcVar35,pcVar30);
    uVar20 = glslang::GetThreadPoolAllocator();
    ...
    *puVar16 = uVar14;
    ...
    sVar22 = strlen(pcVar35);
    std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
    _M_construct<char_const*>(puVar16,pcVar35,pcVar35 + sVar22);
    local_180 = puVar16;
    if (*(code **)(*(long *)this + 0x220) != setUniformBlockDefaults) {
    ...
    *(basic_string **)(pbVar19 + 8) = pbVar19 + 0x18;
    std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
    _M_construct<char_const*>(pbVar19,&_LC0,&_LC0);
...
LAB_0010541d:
  ...
  *(uint *)((long)plVar18 + 0x1c) =
       *(uint *)((long)plVar18 + 0x1c) & 0xffc07fff | ((byte)TVar1 & 0x7f) << 0xf;
...
LAB_001050e1:
      ...
      do {
        while( true ) {
          ...
          if ((uVar29 != 0) && (iVar11 = memcmp((void *)plVar36[5],__s2,uVar29), iVar11 != 0))
          break;
...
LAB_00105075:
      ...
      if (plVar23 != plVar37) {
        ...
        if ((uVar29 == 0) || (iVar11 = memcmp(__s2,(void *)plVar37[5],uVar29), iVar11 == 0)) {
...
LAB_001050dd:
  ...
  if (plVar18 == (long *)0x0) {
    ...
    *(uint *)(ppuVar21 + 1) =
         CONCAT22((short)((uint)*(undefined4 *)(ppuVar21 + 1) >> 0x10),0x100) & 0xf800ffff;
    *(undefined8 *)((long)ppuVar21 + 0x44) = 0xfffff800;
    *(undefined2 *)(ppuVar21 + 0xb) = 0;
    *(undefined1 (*) [16])(ppuVar21 + 0xe) = (undefined1  [16])0x0;
    *(ulong *)((long)ppuVar21 + 0x2d) =
         *(ulong *)((long)ppuVar21 + 0x2d) & 0xffffff0000ffc07f | 0xffff001f80;
    ...
    *(ulong *)((long)ppuVar21 + 0x2c) =
         *(ulong *)((long)ppuVar21 + 0x2c) & 0xffffffff8000 | 0xffff000000004fff;
    ...
    *(TType *)(ppuVar21 + 1) = TVar2;
    ...
    ppuVar21[2] = *(undefined **)(param_2 + 0x10);
    ppuVar21[3] = puVar5;
    puVar5 = *(undefined **)(param_2 + 0x28);
    ppuVar21[4] = *(undefined **)(param_2 + 0x20);
    ppuVar21[5] = puVar5;
    puVar5 = *(undefined **)(param_2 + 0x38);
    ppuVar21[6] = *(undefined **)(param_2 + 0x30);
    ppuVar21[7] = puVar5;
    puVar5 = *(undefined **)(param_2 + 0x48);
    ppuVar21[8] = *(undefined **)(param_2 + 0x40);
    ppuVar21[9] = puVar5;
    puVar5 = *(undefined **)(param_2 + 0x58);
    ppuVar21[10] = *(undefined **)(param_2 + 0x50);
    ppuVar21[0xb] = puVar5;
    TVar2 = param_2[9];
    ...
    *(byte *)((long)ppuVar21 + 10) =
         bVar3 & 0x80 | bVar25 | bVar26 | (byte)TVar2 & 0x20 | (byte)param_2[10] & 0x40;
    *(ushort *)((long)ppuVar21 + 10) =
         *(ushort *)((long)ppuVar21 + 10) & 0xfc7f | *(ushort *)(param_2 + 10) & 0x380;
    *(byte *)((long)ppuVar21 + 0xb) =
         *(byte *)((long)ppuVar21 + 0xb) & 0xfb | (byte)param_2[0xb] & 4;
...
LAB_00105cbd:
    ...
    if (puVar16 == *(undefined8 **)(pvVar6 + 0x18)) {
      std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>::
      _M_realloc_insert<glslang::TTypeLoc_const&>(pvVar6,puVar16,&local_1f8);
    }
    else {
      *puVar16 = local_1f8;
    ...
    if (iVar11 == 0) {
      ...
      if (cVar10 == '\0') {
        (**(code **)(*(long *)this + 0x158))
                  (this,param_1,"failed to insert the global constant buffer","uniform",&_LC0);
      }
      else if (*(code **)(*(long *)this + 600) == trackLinkage) {
        if (this[0x1c1] == (TParseContextBase)0x0) {
  ...
  local_f0 = local_e0;
  std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
  _M_construct<char_const*>(&local_f8,&_LC0,&_LC0);
  local_128 = glslang::GetThreadPoolAllocator();
  local_120 = local_110;
  std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
  _M_construct<char_const*>(&local_128,&_LC0,&_LC0);
  TType::getCompleteString(local_c8,uVar14,0,1,1,1,&local_128,&local_f8);
  puVar15 = (undefined8 *)
            std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
            _M_replace(local_c8,0,0,"Redeclaration: already declared as \"",0x24);
  local_90 = local_80;
  local_98 = *puVar15;
  puVar16 = puVar15 + 3;
  if ((undefined8 *)puVar15[1] == puVar16) {
    ...
    uVar28 = (uint)uVar20;
    if (7 < uVar28) {
      *(undefined8 *)((long)local_80 + ((uVar20 & 0xffffffff) - 8)) =
           *(undefined8 *)((long)puVar15 + (uVar20 & 0xffffffff) + 0x10);
      if (7 < uVar28 - 1) {
        uVar33 = 0;
        do {
          uVar20 = (ulong)uVar33;
    ...
    if ((uVar20 & 4) == 0) {
      if (uVar28 != 0) {
        ...
        *(undefined2 *)((long)local_80 + ((uVar20 & 0xffffffff) - 2)) =
             *(undefined2 *)((long)puVar15 + (uVar20 & 0xffffffff) + 0x16);
        local_88 = puVar15[2];
      }
    }
    else {
      local_80[0] = CONCAT44(local_80[0]._4_4_,*(undefined4 *)(puVar15 + 3));
      *(undefined4 *)((long)local_80 + ((uVar20 & 0xffffffff) - 4)) =
           *(undefined4 *)((long)puVar15 + (uVar20 & 0xffffffff) + 0x14);
      local_88 = puVar15[2];
    }
  }
  else {
...
LAB_001052a0:
  ...
  *(undefined1 *)(puVar15 + 3) = 0;
  ...
  if ((long *)puVar16[1] == plVar23) {
    ...
    uVar28 = (uint)uVar20;
    if (7 < uVar28) {
      *(undefined8 *)((long)local_50 + ((uVar20 & 0xffffffff) - 8)) =
           *(undefined8 *)((long)puVar16 + (uVar20 & 0xffffffff) + 0x10);
      if (7 < uVar28 - 1) {
        uVar33 = 0;
        do {
          uVar20 = (ulong)uVar33;
    ...
    if ((uVar20 & 4) == 0) {
      if (uVar28 != 0) {
        ...
        *(undefined2 *)((long)local_50 + ((uVar20 & 0xffffffff) - 2)) =
             *(undefined2 *)((long)puVar16 + (uVar20 & 0xffffffff) + 0x16);
        local_58 = puVar16[2];
      }
    }
    else {
      local_50[0] = CONCAT44(local_50[0]._4_4_,*(undefined4 *)(puVar16 + 3));
      *(undefined4 *)((long)local_50 + ((uVar20 & 0xffffffff) - 4)) =
           *(undefined4 *)((long)puVar16 + (uVar20 & 0xffffffff) + 0x14);
      local_58 = puVar16[2];
    }
  }
  else {
  ...
  *(undefined1 *)(puVar16 + 3) = 0;
  ...
  if (uVar31 < uVar20) {
    std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_mutate
              ((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)&local_158
               ,local_148,0,(char *)local_60,local_58);
  }
  else if (local_58 != 0) {
    if (local_58 == 1) {
...
LAB_00105e62:
          ...
          do {
            while( true ) {
              ...
              if ((uVar7 != 0) && (iVar5 = memcmp((void *)plVar15[5],__s2,uVar7), iVar5 != 0))
              break;
              lVar14 = uVar3 - uVar8;
...
LAB_00105df5:
          ...
          if (plVar1 != plVar18) {
            ...
            if ((uVar7 == 0) || (iVar5 = memcmp(__s2,(void *)plVar18[5],uVar7), iVar5 == 0)) {
              lVar14 = uVar8 - uVar3;
              if (lVar14 < 0x80000000) {
...
LAB_001063e1:
            ...
            if (uVar7 < uVar3) {
              ...
              ::_M_mutate((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *
                          )&local_68,local_58,0,__src,uVar8);
            }
            else if (uVar8 != 0) {
              if (uVar8 == 1) {
            ...
            *(undefined1 *)((long)local_60 + uVar3 + 2) = 0;
            ...
            if (*(code **)(*plVar18 + 0x20) == TType::setFieldName) {
              ...
              *puVar9 = uVar10;
              ...
              std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>
              ::_M_construct<char_const*>(puVar9,__s,(long)__s + sVar11);
              plVar18[0xe] = (long)puVar9;
            }
            else {
              (**(code **)(*plVar18 + 0x20))
                        (plVar18,(basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>
                                  *)&local_68);
            }
          }
        }
    ...
    *(ulong *)((long)puVar9 + 0x4d) =
         (ulong)((uint)*(undefined8 *)((long)puVar9 + 0x4d) & 0xffc00f) | 0xffffffffff001fc0;
    *(undefined4 *)((long)puVar9 + 100) = 0xfffff800;
    *(ulong *)((long)puVar9 + 0x55) =
         *(ulong *)((long)puVar9 + 0x55) & 0xfe000000800000 | 0x1ffffff7fffff;
    ...
    if (lVar16 != *(long *)(this + 0x1d8)) {
      do {
        ...
        glslang::TIntermediate::addSymbolLinkageNode
                  (*(TIntermAggregate ***)(this + 0x38),(TSymbol *)&local_70);
      } while (*(long *)(this + 0x1d8) != lVar16);
    }
    glslang::TIntermediate::addSymbolLinkageNodes
              (*(undefined8 *)(this + 0x38),(TSymbol *)&local_70,*(undefined4 *)(this + 0x1c),
               *(undefined8 *)(this + 0xe8));
  }
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
...
undefined * glslang::TParseContextBase::getGlobalUniformBlockName(void)
...
void glslang::TParseContextBase::setUniformBlockDefaults(TType *param_1)
...
void glslang::TParseContextBase::finalizeGlobalUniformBlockLayout(TVariable *param_1)
...
/* glslang::TParseContextBase::getAtomicCounterBlockName() const */

undefined * glslang::TParseContextBase::getAtomicCounterBlockName(void)
...
/* glslang::TParseContextBase::setAtomicCounterBlockDefaults(glslang::TType&) const */

void glslang::TParseContextBase::setAtomicCounterBlockDefaults(TType *param_1)
...
/* glslang::TParseContextBase::setInvariant(glslang::TSourceLoc const&, char const*) */

void glslang::TParseContextBase::setInvariant(TSourceLoc *param_1,char *param_2)
...
/* glslang::TParseContextBase::finalizeAtomicCounterBlockLayout(glslang::TVariable&) */

void glslang::TParseContextBase::finalizeAtomicCounterBlockLayout(TVariable *param_1)
...
LAB_00108295:
        ...
        cVar2 = (**(code **)(lVar5 + 0x128))(plVar1);
        if (cVar2 != '\0') goto LAB_00108295;
      }
      plVar1 = (long *)param_1[4];
      lVar5 = *plVar1;
      if (*(code **)(lVar5 + 0x140) == glslang::TType::isOpaque) {
        if ((*(byte *)(plVar1 + 1) < 0x15) &&
           ((0x1a6000UL >> ((ulong)*(byte *)(plVar1 + 1) & 0x3f) & 1) != 0)) goto LAB_0010814c;
      }
      else {
        cVar2 = (**(code **)(lVar5 + 0x140))(plVar1);
        if (cVar2 != '\0') goto LAB_0010814c;
        lVar5 = *plVar1;
      }
      if (*(code **)(lVar5 + 0x128) == glslang::TType::isStruct) {
        if ((byte)((char)plVar1[1] - 0xfU) < 2) {
...
LAB_0010814c:
        ...
        cVar2 = (**(code **)(lVar5 + 0x128))(plVar1);
        if (cVar2 != '\0') goto LAB_001082cd;
      }
      plVar1 = (long *)param_1[8];
      lVar5 = *plVar1;
      if (*(code **)(lVar5 + 0x140) == glslang::TType::isOpaque) {
        if ((*(byte *)(plVar1 + 1) < 0x15) &&
           ((0x1a6000UL >> ((ulong)*(byte *)(plVar1 + 1) & 0x3f) & 1) != 0)) goto LAB_001081ac;
      }
      else {
        cVar2 = (**(code **)(lVar5 + 0x140))(plVar1);
        if (cVar2 != '\0') goto LAB_001081ac;
        lVar5 = *plVar1;
      }
      if (*(code **)(lVar5 + 0x128) == glslang::TType::isStruct) {
        if ((byte)((char)plVar1[1] - 0xfU) < 2) {
...
LAB_001081ac:
        ...
        cVar2 = (**(code **)(lVar5 + 0x128))(plVar1);
        if (cVar2 != '\0') goto LAB_001082fd;
      }
      plVar1 = (long *)param_1[0xc];
      lVar5 = *plVar1;
      if (*(code **)(lVar5 + 0x140) == glslang::TType::isOpaque) {
        if ((*(byte *)(plVar1 + 1) < 0x15) &&
           ((0x1a6000UL >> ((ulong)*(byte *)(plVar1 + 1) & 0x3f) & 1) != 0)) goto LAB_0010820c;
      }
      else {
        cVar2 = (**(code **)(lVar5 + 0x140))(plVar1);
        if (cVar2 != '\0') goto LAB_0010820c;
        lVar5 = *plVar1;
      }
      if (*(code **)(lVar5 + 0x128) == glslang::TType::isStruct) {
        if ((byte)((char)plVar1[1] - 0xfU) < 2) {
...
LAB_0010872d:
      ...
      if (*(code **)(lVar5 + 0xf8) == glslang::TType::isUnsizedArray) {
        ...
        if (lVar4 != 0) {
LAB_001085b8:
          if (**(int **)(*(long *)(lVar4 + 8) + 8) == 0) goto LAB_001085c6;
          goto LAB_001085d9;
        }
      }
      else {
        cVar2 = (**(code **)(lVar5 + 0xf8))(plVar1);
        if (cVar2 != '\0') goto LAB_001085c6;
LAB_001085d9:
        lVar5 = *plVar1;
      }
      if (*(code **)(lVar5 + 0x128) == glslang::TType::isStruct) {
...
LAB_001085c6:
      ...
      if (*(code **)(lVar5 + 0xf8) == glslang::TType::isUnsizedArray) {
        ...
        if (lVar4 != 0) {
LAB_00108628:
          if (**(int **)(*(long *)(lVar4 + 8) + 8) == 0) goto LAB_00108636;
          goto LAB_00108649;
        }
      }
      else {
        cVar2 = (**(code **)(lVar5 + 0xf8))(plVar1);
        if (cVar2 != '\0') goto LAB_00108636;
LAB_00108649:
        lVar5 = *plVar1;
      }
      if (*(code **)(lVar5 + 0x128) == glslang::TType::isStruct) {
...
LAB_00108636:
      ...
      if (*(code **)(lVar5 + 0xf8) == glslang::TType::isUnsizedArray) {
        ...
        if (lVar4 != 0) {
LAB_00108698:
          if (**(int **)(*(long *)(lVar4 + 8) + 8) == 0) goto LAB_001086a6;
          goto LAB_001086b9;
        }
      }
      else {
        cVar2 = (**(code **)(lVar5 + 0xf8))(plVar1);
        if (cVar2 != '\0') goto LAB_001086a6;
LAB_001086b9:
        lVar5 = *plVar1;
      }
      if (*(code **)(lVar5 + 0x128) == glslang::TType::isStruct) {
...
LAB_00108bad:
        ...
        if (cVar3 != '\0') goto LAB_00108bad;
      }
      plVar2 = (long *)param_1[4];
      bVar1 = *(byte *)(plVar2 + 1);
      if ((bVar1 < 0xd) || (bVar1 == 0x12)) goto LAB_00108aaf;
      if (*(code **)(*plVar2 + 0x128) == glslang::TType::isStruct) {
        if ((byte)(bVar1 - 0xf) < 2) {
LAB_00108bed:
          lVar5 = *(long *)(plVar2[0xd] + 0x10);
...
LAB_00108aaf:
        ...
        cVar3 = (**(code **)(*plVar2 + 0x128))(plVar2);
        if (cVar3 != '\0') goto LAB_00108bed;
      }
      plVar2 = (long *)param_1[8];
      bVar1 = *(byte *)(plVar2 + 1);
      if ((bVar1 < 0xd) || (bVar1 == 0x12)) goto LAB_00108aef;
      if (*(code **)(*plVar2 + 0x128) == glslang::TType::isStruct) {
        if ((byte)(bVar1 - 0xf) < 2) {
LAB_00108c1d:
          lVar5 = *(long *)(plVar2[0xd] + 0x10);
...
LAB_00108aef:
        ...
        cVar3 = (**(code **)(*plVar2 + 0x128))(plVar2);
        if (cVar3 != '\0') goto LAB_00108c1d;
      }
      plVar2 = (long *)param_1[0xc];
      bVar1 = *(byte *)(plVar2 + 1);
      if ((bVar1 < 0xd) || (bVar1 == 0x12)) goto LAB_00108b2f;
      if (*(code **)(*plVar2 + 0x128) == glslang::TType::isStruct) {
        if ((byte)(bVar1 - 0xf) < 2) {
LAB_00108c4d:
          lVar5 = *(long *)(plVar2[0xd] + 0x10);
...
LAB_00109065:
        ...
        cVar3 = (**(code **)(lVar5 + 0x128))(plVar1);
        if (cVar3 != '\0') goto LAB_00109065;
      }
      plVar1 = (long *)param_1[4];
      lVar5 = *plVar1;
      if (*(code **)(lVar5 + 0xe8) == glslang::TType::isArray) {
        if (plVar1[0xc] != 0) goto LAB_00108fea;
      }
      else {
        cVar3 = (**(code **)(lVar5 + 0xe8))(plVar1);
        if (cVar3 != '\0') goto LAB_00108fea;
        lVar5 = *plVar1;
      }
      if (*(code **)(lVar5 + 0x128) == glslang::TType::isStruct) {
        if ((byte)((char)plVar1[1] - 0xfU) < 2) {
...
LAB_00108fea:
        ...
        cVar3 = (**(code **)(lVar5 + 0x128))(plVar1);
        if (cVar3 != '\0') goto LAB_00108fcd;
      }
      plVar1 = (long *)param_1[8];
      lVar5 = *plVar1;
      if (*(code **)(lVar5 + 0xe8) == glslang::TType::isArray) {
        if (plVar1[0xc] != 0) goto LAB_0010901a;
      }
      else {
        cVar3 = (**(code **)(lVar5 + 0xe8))(plVar1);
        if (cVar3 != '\0') goto LAB_0010901a;
        lVar5 = *plVar1;
      }
      if (*(code **)(lVar5 + 0x128) == glslang::TType::isStruct) {
        if ((byte)((char)plVar1[1] - 0xfU) < 2) {
...
LAB_0010901a:
        ...
        cVar3 = (**(code **)(lVar5 + 0x128))(plVar1);
        if (cVar3 != '\0') goto LAB_00108ffd;
      }
      plVar1 = (long *)param_1[0xc];
      lVar5 = *plVar1;
      if (*(code **)(lVar5 + 0xe8) == glslang::TType::isArray) {
        if (plVar1[0xc] != 0) goto LAB_0010904a;
      }
      else {
        cVar3 = (**(code **)(lVar5 + 0xe8))(plVar1);
        if (cVar3 != '\0') goto LAB_0010904a;
        lVar5 = *plVar1;
      }
      if (*(code **)(lVar5 + 0x128) == glslang::TType::isStruct) {
        if ((byte)((char)plVar1[1] - 0xfU) < 2) {
...
LAB_0010915c:
  ...
  if (*(code **)(lVar5 + 0x128) == glslang::TType::isStruct) {
    if (1 < (byte)((char)plVar6[1] - 0xfU)) {
      return param_2;
    }
  }
  else {
    cVar3 = (**(code **)(lVar5 + 0x128))(plVar6);
    if (cVar3 == '\0') {
      return param_2;
    }
  }
...
LAB_0010a98c:
    ...
    if (uVar11 == 0x12) goto LAB_0010a98c;
  }
...
LAB_0010ad60:
          ...
          if (plVar14 != (long *)0x0) {
            if (((plVar13 != (long *)0x0) &&
              ...
              if (lVar12 == lVar16) goto LAB_0010ad6e;
            }
            goto LAB_0010ad60;
          }
          if (plVar13 != (long *)0x0) goto LAB_0010ad60;
LAB_0010ad6e:
          piVar20 = piVar20 + 4;
        }
        goto LAB_0010aa28;
...
LAB_0010b2ff:
          ...
          if (lVar12 == 0x16) {
            ...
            if ((*plVar14 != 0x6e6f6365535f6c67 || plVar14[1] != 0x69736f5079726164) ||
               (*(long *)((long)plVar14 + 0xe) != 0x564e6e6f69746973)) goto LAB_0010b340;
          }
          else if ((lVar12 != 0x14) ||
                  ((plVar14 = *(long **)(lVar9 + 8),
...
LAB_0010b660:
        ...
        if (*(long *)(lVar9 + 0x10) == 0x16) {
          plVar14 = *(long **)(lVar9 + 8);
          if ((*plVar14 == 0x6e6f6365535f6c67 && plVar14[1] == 0x69736f5079726164) &&
             (*(long *)((long)plVar14 + 0xe) == 0x564e6e6f69746973)) goto LAB_0010b3ea;
LAB_0010b168:
          lVar12 = *(long *)(param_1 + 0x68);
          lVar8 = *(long *)(lVar12 + 8);
          pcVar6 = *(code **)(**(long **)(lVar8 + lVar16) + 0x30);
          ...
          if (*(long *)(lVar15 + 0x10) == 0x16) {
            ...
            if ((*plVar14 == 0x6e6f6365535f6c67 && plVar14[1] == 0x69736f5079726164) &&
               (*(long *)((long)plVar14 + 0xe) == 0x564e6e6f69746973)) goto LAB_0010b020;
          }
          else if ((*(long *)(lVar15 + 0x10) == 0x14) &&
                  ((plVar14 = *(long **)(lVar15 + 8),
                   *plVar14 == 0x7469736f505f6c67 && plVar14[1] == 0x69567265506e6f69 &&
                   ((int)plVar14[2] == 0x564e7765)))) goto LAB_0010b020;
          uVar11 = uVar11 + 1;
          goto LAB_0010b020;
        }
        if (((*(long *)(lVar9 + 0x10) != 0x14) ||
            (plVar14 = *(long **)(lVar9 + 8),
            *plVar14 != 0x7469736f505f6c67 || plVar14[1] != 0x69567265506e6f69)) ||
           ((int)plVar14[2] != 0x564e7765)) goto LAB_0010b168;
      }
      else {
        if (uVar13 <= uVar10) {
          return 1;
...
LAB_0010b271:
        ...
        if (lVar12 == 0x16) {
          plVar14 = *(long **)(lVar9 + 8);
          if ((*plVar14 != 0x6e6f6365535f6c67 || plVar14[1] != 0x69736f5079726164) ||
             (*(long *)((long)plVar14 + 0xe) != 0x564e6e6f69746973)) goto LAB_0010b2b8;
        }
        else if ((lVar12 != 0x14) ||
                ((plVar14 = *(long **)(lVar9 + 8),
                 *plVar14 != 0x7469736f505f6c67 || plVar14[1] != 0x69567265506e6f69 ||
...
LAB_0010bfd0:
    ...
    pcVar5 = *(code **)(lVar2 + 0x158);
    if (pcVar5 == isImage) {
      if ((char)param_1[1] != '\x0e') goto LAB_0010bf3f;
      if (*(code **)(lVar2 + 0x40) == getSampler) {
        plVar4 = param_1 + 0x10;
      }
      else {
...

{
  ...
  if (*(code **)(lVar2 + 0x168) == isTexture) {
    ...
    pcVar5 = *(code **)(lVar2 + 0x158);
    if (pcVar5 != isImage) goto LAB_0010c170;
  }
  else {
    cVar1 = (**(code **)(lVar2 + 0x168))();
    if (cVar1 != '\0') {
...
LAB_0010c120:
    ...
    pcVar5 = *(code **)(lVar2 + 0x158);
    if (pcVar5 == isImage) {
      if (this[8] != (TType)0xe) goto LAB_0010c08f;
      if (*(code **)(lVar2 + 0x40) == getSampler) {
        pTVar4 = this + 0x80;
      }
      else {
...

{
  ...
  if (lVar10 == lVar2) {
    if (0xfffffffffffffffe < uVar4) goto LAB_0010c3e0;
...
LAB_0010c365:
    ...
    if (param_2 == lVar2) goto LAB_0010c3c0;
  }
  else {
    uVar7 = uVar4 * 2;
    if (uVar7 < uVar4) {
LAB_0010c3e0:
    ...
    *puVar9 = *param_3;
    ...
    puVar9[2] = param_3[2];
    puVar9[3] = uVar3;
    if (param_2 != lVar10) goto LAB_0010c365;
  }
  lVar10 = 0;
  do {
...

{
  ...
  *(ulong *)(auVar12._0_8_ + 0x20) = uVar3;
  if (uVar11 < 0x10) {
    ...
    else if (uVar11 != 0) goto LAB_0010c6a1;
  }
  else {
    if ((long)uVar11 < 0) {
                    /* WARNING: Subroutine does not return */
...
LAB_0010c595:
      if ((uVar7 == 0) || (iVar2 = memcmp(__s2,local_58,uVar7), iVar2 == 0)) {
        lVar9 = uVar3 - uVar11;
        if (0x7fffffff < lVar9) goto LAB_0010c630;
        if (lVar9 < -0x80000000) goto LAB_0010c5d6;
        iVar2 = (int)lVar9;
      }
      if (-1 < iVar2) {
LAB_0010c630:
...
LAB_0010c55b:
        ...
        if ((long)uVar5 < 0x80000000) {
          if (-0x80000001 < (long)uVar5) goto LAB_0010c57a;
          goto LAB_0010c520;
        }
LAB_0010c57e:
        ...
        uVar5 = (ulong)uVar1;
        if (uVar1 == 0) goto LAB_0010c55b;
LAB_0010c57a:
        if (-1 < (int)uVar5) goto LAB_0010c57e;
LAB_0010c520:
    ...
    p_Var6 = p_Var10;
    if (!bVar8) goto LAB_0010c595;
    if (*(_Rb_tree_node_base **)(this + 0x20) != p_Var10) goto LAB_0010c653;
LAB_0010c5d6:
    bVar8 = true;
    if (p_Var4 == p_Var10) goto LAB_0010c5e6;
    uVar3 = *(ulong *)(p_Var10 + 0x30);
    uVar7 = uVar3;
    if (uVar11 <= uVar3) {
      uVar7 = uVar11;
    ...
    if ((uVar7 == 0) || (iVar2 = memcmp(local_58,*(void **)(p_Var10 + 0x28),uVar7), iVar2 == 0)) {
      bVar8 = false;
      lVar9 = uVar11 - uVar3;
      if (0x7fffffff < lVar9) goto LAB_0010c5e6;
      if (lVar9 < -0x80000000) goto LAB_0010c741;
      iVar2 = (int)lVar9;
    }
...
glslang::TSymbolTableLevel::insertAnonymousMembers
          (TSymbolTableLevel *this,TSymbol *param_1,int param_2)
    ...
    do {
      ...
      *(int *)(puVar5 + 6) = (int)uVar9;
      ...
      if (uVar8 < 0x10) {
        ...
        else if (uVar8 != 0) goto LAB_0010c92e;
      }
      else {
        if ((long)uVar8 < 0) {
                    /* WARNING: Subroutine does not return */
...
LAB_0010c92e:
      ...
      *(undefined1 *)((long)local_70 + uVar8) = 0;
      ...
      _M_emplace_unique<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,glslang::TSymbol*>const>
                ((_Rb_tree<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,glslang::TSymbol*>,std::_Select1st<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,glslang::TSymbol*>>,std::less<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,glslang::TSymbol*>>>
                  *)this,(pair_conflict *)&local_78);
      uVar8 = extraout_RDX & 0xffffffff;
      if ((char)extraout_RDX == '\0') goto LAB_0010c98d;
...

{
  ...
  if (*(long *)(param_3 + 0x10) != 0) {
    ...
    if (uVar12 < 0x10) {
      ...
      else if (uVar12 != 0) goto LAB_0010cd82;
    }
    else {
...
LAB_0010cd82:
  ...
  if (*(long *)(lVar13 + 0x10) == 0) {
    ...
    *puVar9 = uVar10;
    ...
    std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
    _M_construct<char_const*>(puVar9,local_58,local_58 + sVar11);
    ...
    if (*(TSymbolTableLevel **)(this + 0x18) != (TSymbolTableLevel *)0x0) {
      ...
      do {
        while( true ) {
          ...
          if ((uVar14 != 0) && (iVar5 = memcmp(*(void **)(pTVar16 + 0x28),__s2,uVar14), iVar5 != 0))
          break;
          lVar13 = uVar2 - uVar12;
...
LAB_0010ca90:
        pTVar16 = *(TSymbolTableLevel **)(pTVar16 + 0x18);
      } while (pTVar16 != (TSymbolTableLevel *)0x0);
LAB_0010caef:
      if (this + 0x10 != pTVar15) {
...
undefined8 __thiscall glslang::TSymbolTable::insert(TSymbolTable *this,TSymbol *param_1)
  ...
  *(long *)(this + 0x18) = lVar5 + 1;
  ...
  if (this[0x21] == (TSymbolTable)0x0) {
    ...
    pTVar2 = *(TSymbolTableLevel **)
              (*(long *)this + (long)((int)(*(long *)(this + 8) - *(long *)this >> 3) + -1) * 8);
    if (*(code **)(*(long *)param_1 + 0x18) == TSymbol::getName_abi_cxx11_) {
...
/* std::pair<std::_Rb_tree_iterator<std::pair<int const, glslang::TVariable*> >, bool>
   ...
   >(std::pair<int const, glslang::TVariable*>&&) */
    ...
    if (((*(byte *)((long)param_2 + 0x1f) & 0x70) == 0) && ((*(byte *)(param_2 + 4) & 0xf) == 0)) {
      if ((((*(int *)((long)param_2 + 0x24) != -1) ||
        ...
        if (((((*(char *)((long)param_2 + 0x3c) == '\0') &&
              (((short)param_2[6] == -1 &&
               (uStack_100._4_4_ = (uint)((ulong)lVar11 >> 0x20),
               uVar7 = uStack_100._4_4_ & 0x3f8000, uVar7 == 0x1f8000)))) &&
             ((*(uint *)(param_2 + 5) & *(uint *)((long)param_2 + 0x24)) == 0xffffffff)) &&
            (((uStack_100._4_2_ = (ushort)((ulong)lVar11 >> 0x20), uVar6 = ~uStack_100._4_2_,
              (uVar6 & 0xfff) == 0 &&
              (uStack_100._5_1_ = (byte)((ulong)lVar11 >> 0x28), bVar5 = uStack_100._5_1_ & 0x70,
              bVar5 == 0x40)) &&
          ...
          local_f8 = uVar1;
          if (((uVar7 & 0x3fff0) == 0) &&
             (local_f8._6_2_ = (ushort)(uVar15 >> 0x30), uVar6 = ~local_f8._6_2_,
             (uVar6 & 0x7ffc) == 0)) goto LAB_0010fce4;
        }
        goto LAB_0010ebb0;
      }
    }
...
LAB_0010ebb0:
      ...
      if ((*(uint *)((long)param_2 + 0x2c) & 0x3f8000) != 0x1f8000) {
        ...
        append(param_1," set=");
        const::{lambda(unsigned_int)#2}::operator()
                  ((_lambda_unsigned_int__2_ *)&local_128,
      ...
      if ((*(byte *)((long)param_2 + 0x1f) & 0x70) != 0) {
        ...
        if ((bVar5 != 1) && (pcVar13 = "column_major", bVar5 != 2)) {
          pcVar13 = "none";
        }
        std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
        append(param_1,pcVar13);
      }
      ...
      if ((int)param_2[5] != -1) {
        ...
        const::{lambda(int)#3}::operator()((_lambda_int__3_ *)&local_120,(int)param_2[5]);
      }
      if (*(char *)((long)param_2 + 0x3c) != '\0') {
        std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
        append(param_1," ");
...
LAB_0010f2a9:
              ...
              const::{lambda(int)#3}::operator()((_lambda_int__3_ *)&local_120,iVar12);
              goto LAB_0010f2d0;
            }
            std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
            ...
            if (iVar12 == 0) {
              ...
              ::append(param_1," ");
              const::{lambda(int)#3}::operator()
                        ((_lambda_int__3_ *)&local_120,
                         *(int *)(*(long *)(*(long *)(param_2[0xc] + 8) + 8) + lVar16 * 0x10));
            }
LAB_0010f2d0:
            std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
...
LAB_0010f61e:
        ...
        if (lVar11 != 0) {
          while( true ) {
            ...
            lVar11 = *(long *)(*(long *)(param_2[0x11] + 8) + 8);
            if ((lVar11 == 0) ||
               ((int)(*(long *)(lVar11 + 0x10) - *(long *)(lVar11 + 8) >> 4) + -1 != (int)lVar17)) {
              std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>
              ::append(param_1,", ");
              lVar11 = *(long *)(*(long *)(param_2[0x11] + 8) + 8);
              if (lVar11 == 0) break;
...
LAB_0010f781:
    ...
    if ((char)param_2[1] == '\x0e') {
      ...
      local_60 = local_50;
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
      _M_construct<char_const*>(&local_68,pcVar13,pcVar13 + lVar11);
    }
    ...
    if (uVar9 < uVar1) {
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
      _M_mutate(param_1,uVar15,0,(char *)local_60,local_58);
      pbVar14 = *(basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> **)
                 (param_1 + 8);
    }
    else if (local_58 != 0) {
...
LAB_0010ef7f:
              ...
              local_90 = local_80;
              std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>
              ::_M_construct<char_const*>(&local_98,&_LC0);
              local_c8 = glslang::GetThreadPoolAllocator();
              local_c0 = local_b0;
              std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>
              ::_M_construct<char_const*>(&local_c8,&_LC0);
              ...
              std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>
              ::append(param_1,*(char **)(lVar11 + 8),*(ulong *)(lVar11 + 0x10));
              param_6 = '\0';
              goto LAB_0010f08c;
            }
          }
...
LAB_0010f374:
    if (*(code **)(lVar11 + 0x128) == isStruct) {
      if (1 < (byte)((char)param_2[1] - 0xfU)) goto LAB_0010f560;
LAB_0010f39c:
      if (param_2[0xd] == 0) goto LAB_0010f560;
      uVar15 = 0;
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::append
                (param_1," ");
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::append
...
LAB_0010f430:
              ...
              ::basic_string((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>
                              *)&local_c8,pbVar10);
              getCompleteString(&local_68,uVar8,1,param_4,param_5,1,
                                (basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>
                                 *)&local_c8,&local_98);
              std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>
              ::append(param_1,(char *)local_60,local_58);

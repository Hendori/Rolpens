...
void __thiscall hb_ot_map_t::collect_lookups(hb_ot_map_t *this,uint param_1,hb_set_t *param_2)
      ...
      if (param_2[0x40] == (hb_set_t)0x0) {
        if (param_2[0x10] != (hb_set_t)0x0) {
          *(undefined4 *)(param_2 + 0x14) = 0xffffffff;
          puVar2 = (undefined4 *)
                   hb_bit_set_t::page_for((hb_bit_set_t *)(param_2 + 0x10),(uint)uVar1,true);
          if (puVar2 != (undefined4 *)0x0) {
            *(ulong *)(puVar2 + (ulong)(uVar1 >> 6 & 7) * 2 + 2) =
                 *(ulong *)(puVar2 + (ulong)(uVar1 >> 6 & 7) * 2 + 2) | 1L << ((byte)uVar1 & 0x3f);
            *puVar2 = 0xffffffff;
          }
        }
      }
        ...
        puVar2 = (undefined4 *)
                 hb_bit_set_t::page_for((hb_bit_set_t *)(param_2 + 0x10),(uint)uVar1,false);
        if (puVar2 != (undefined4 *)0x0) {
          *(undefined4 *)(param_2 + 0x14) = 0xffffffff;
          *(ulong *)(puVar2 + (ulong)(uVar1 >> 6 & 7) * 2 + 2) =
               *(ulong *)(puVar2 + (ulong)(uVar1 >> 6 & 7) * 2 + 2) & ~(1L << ((byte)uVar1 & 0x3f));
...
hb_ot_map_builder_t::hb_ot_map_builder_t
          (hb_ot_map_builder_t *this,hb_face_t *param_1,hb_segment_properties_t *param_2)

{
  ...
  *(undefined8 *)(this + 0x78) = 0;
  ...
  for (uVar5 = (ulong)(((int)this - (int)(undefined8 *)((ulong)(this + 0x10) & 0xfffffffffffffff8))
                       + 0x80U >> 3); uVar5 != 0; uVar5 = uVar5 - 1) {
    *puVar6 = 0;
    puVar6 = puVar6 + 1;
  }
  ...
  *(undefined8 *)(this + 0x20) = uVar3;
  hb_ot_tags_from_script_and_language
            (*(undefined4 *)(this + 0xc),*(undefined8 *)(this + 0x10),&local_40,local_38,&local_3c,
             local_2c);
  iVar4 = hb_ot_layout_table_select_script
                    (*(undefined8 *)this,0x47535542,local_40,local_38,this + 0x38,this + 0x2c);
  this[0x34] = (hb_ot_map_builder_t)(iVar4 != 0);
  hb_ot_layout_script_select_language
            (*(undefined8 *)this,0x47535542,*(undefined4 *)(this + 0x38),local_3c,local_2c,
             this + 0x40);
  iVar4 = hb_ot_layout_table_select_script
                    (*(undefined8 *)this,0x47504f53,local_40,local_38,this + 0x3c,this + 0x30);
  this[0x35] = (hb_ot_map_builder_t)(iVar4 != 0);
  hb_ot_layout_script_select_language
            (*(undefined8 *)this,0x47504f53,*(undefined4 *)(this + 0x3c),local_3c,local_2c,
             this + 0x44);
...
void __thiscall hb_ot_map_builder_t::~hb_ot_map_builder_t(hb_ot_map_builder_t *this)
...
void __thiscall
hb_ot_map_builder_t::add_feature(hb_ot_map_builder_t *this,int param_1,uint param_3,uint param_4)
...
bool __thiscall hb_ot_map_builder_t::has_feature(hb_ot_map_builder_t *this,uint param_1)

{
  int iVar1;
  bool bVar2;
  
  iVar1 = hb_ot_layout_language_find_feature
                    (*(undefined8 *)this,0x47535542,*(undefined4 *)(this + 0x38),
                     *(undefined4 *)(this + 0x40),param_1,0);
  if (iVar1 == 0) {
    iVar1 = hb_ot_layout_language_find_feature
                      (*(undefined8 *)this,0x47504f53,*(undefined4 *)(this + 0x3c),
                       *(undefined4 *)(this + 0x44),param_1,0);
    bVar2 = iVar1 != 0;
  }
  else {
    bVar2 = true;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* hb_ot_map_builder_t::add_lookups(hb_ot_map_t&, unsigned int, unsigned int, unsigned int, unsigned
   int, bool, bool, bool, bool, unsigned int) */

void __thiscall
hb_ot_map_builder_t::add_lookups
          (hb_ot_map_builder_t *this,hb_ot_map_t *param_1,uint param_2,uint param_3,uint param_4,
          uint param_5,bool param_6,bool param_7,bool param_8,bool param_9,uint param_10)

{
  ...
  do {
    ...
    hb_ot_layout_feature_with_variations_get_lookups
              (*(undefined8 *)this,uVar1,param_3,param_4,local_104,&local_cc,local_c8);
    if (local_cc == 0) break;
    lVar9 = 0;
    do {
      if (local_c8[lVar9] < uVar3) {
        ...
        if ((int)uVar5 < 0) {
LAB_00100c3e:
          puVar7 = (undefined2 *)&_hb_CrapPool;
          __hb_CrapPool = (undefined4)__hb_NullPool;
          _hb_ot_layout_language_find_feature = __hb_CrapPool;
...
hb_ot_map_builder_t::add_pause
          (hb_ot_map_builder_t *this,uint param_1,
          _func_bool_hb_ot_shape_plan_t_ptr_hb_font_t_ptr_hb_buffer_t_ptr *param_2)

{
  ...
  piVar2 = (int *)hb_vector_t<hb_ot_map_builder_t::stage_info_t,false>::push
                            ((hb_vector_t<hb_ot_map_builder_t::stage_info_t,false> *)
                             (this + ((ulong)param_1 + 6) * 0x10));
...
hb_ot_map_builder_t::compile
          (hb_ot_map_builder_t *this,hb_ot_map_t *param_1,hb_ot_shape_plan_key_t *param_2)
...
LAB_00100e8e:
      pvVar15 = realloc(pvVar15,(long)(int)uVar11 * 0x1c);
      if (pvVar15 != (void *)0x0) {
LAB_00100ebb:
...
LAB_001011e2:
    if (this[0x28] != (hb_ot_map_builder_t)0x0) {
      if (*(uint *)(param_1 + 0x14) != 0) {
        sort_r_simple<>(*(void **)(param_1 + 0x18),(ulong)*(uint *)(param_1 + 0x14),0x24,
                        hb_ot_map_t::feature_map_t::cmp);
      }
    }
    lVar24 = 0;
    piVar18 = (int *)hb_vector_t<hb_ot_map_builder_t::stage_info_t,false>::push
                               ((hb_vector_t<hb_ot_map_builder_t::stage_info_t,false> *)
                                (this + 0x60));
      ...
      if (*(int *)(this + lVar24 * 4 + 0x48) != 0) {
        do {
          if (((&local_c0)[lVar24] != 0xffff) && (*(uint *)((long)&local_c8 + lVar24 * 4) == uVar27)
            ...
            add_lookups(this,param_1,(uint)lVar24,(&local_c0)[lVar24],
                        *(uint *)(param_2 + lVar24 * 4),0x80000000,true,true,false,false,0x20202020)
            ;
          }
          ...
          for (; puVar33 != puVar31; puVar31 = puVar31 + 9) {
            ...
            add_lookups(this,param_1,(uint)lVar24,puVar31[lVar24 + 1],
                        *(uint *)(param_2 + lVar24 * 4),puVar31[6],(bool)(bVar34 >> 1 & 1),
                        (bool)(bVar34 >> 2 & 1),(bool)(bVar34 >> 3 & 1),(bool)(bVar34 >> 4 & 1),
                        *puVar31);
          }
LAB_00101330:
          uVar35 = (uint)uVar29;
...
LAB_00101445:
              psVar2 = (short *)(lVar32 + 0xc +
                                ((ulong)((uVar11 - uVar35) - 2) + (ulong)uVar28) * 0xc);
              ...
              do {
                while (psVar19 = (short *)(lVar32 + uVar29 * 0xc), *psVar20 == *psVar19) {
                  ...
                  *(byte *)(psVar19 + 1) =
                       bVar34 & 0xfc | bVar26 |
                       (bVar34 >> 1 & *(byte *)(psVar20 + 1) >> 1 & 1) * '\x02';
                  psVar20 = psVar21;
              ...
              sort_r_simple<>((void *)(lVar32 + uVar29 * 0xc),(ulong)(uVar11 - uVar35),0xc,
                              hb_ot_map_t::lookup_map_t::cmp);
              uVar11 = *(uint *)(phStack_100 + -0x1c);
              if (uVar28 < uVar11) {
                lVar32 = *(long *)(phStack_100 + -0x18);
                goto LAB_00101445;
...
LAB_0010170f:
                  pvVar15 = realloc(pvVar15,(long)(int)uVar35 * 0xc);
                  if (pvVar15 == (void *)0x0) {
...
LAB_00101345:
          ...
          if ((uVar12 < *(uint *)local_f8) &&
             (*(uint *)(*(long *)(local_f8 + 4) + (ulong)uVar12 * 0x10) == uVar27)) {
...
LAB_001016ee:
  ...
  uVar27 = 4;
LAB_00100f9b:
  uVar5 = _hb_ot_layout_language_find_feature;
  uVar4 = _DAT_0010304c;
  uVar3 = __hb_CrapPool;
  ...
  uVar12 = puVar33[3];
  uVar11 = puVar33[2];
  if (((uVar12 & 1) == 0) || (uVar35 = uVar27, uVar11 != 1)) {
    if (uVar11 != 0) {
      iVar30 = 0x1f;
      if (uVar11 != 0) {
...
LAB_001010c3:
  if (bVar34 == 0) {
    if ((uVar12 & 0x10) != 0) {
      ...
      cVar10 = hb_ot_layout_table_find_feature
                         (*(hb_face_t **)this,0x47504f53,*puVar33,auStack_b0 + 1);
...
LAB_001013e1:
  ...
  puVar17 = (undefined8 *)
            hb_vector_t<hb_ot_map_t::feature_map_t,true>::push
                      ((hb_vector_t<hb_ot_map_t::feature_map_t,true> *)(param_1 + 0x10));
  uVar12 = puVar33[3];
  uVar11 = puVar33[5];
  ...
  *(byte *)(puVar17 + 4) =
       (((byte)(uVar12 >> 2) ^ 1) & 1) * '\x02' | (byte)(((uVar12 >> 3 ^ 1) & 1) << 2) |
       (byte)((uVar12 >> 5 & 1) << 3) | (byte)((uVar12 >> 6 & 1) << 4) |
       *(byte *)(puVar17 + 4) & 0xe1;
...
joined_r0x00100f91:
  if (uVar29 == lVar24 + 1U) goto LAB_001011e2;
  lVar24 = lVar24 + 1;
  uVar12 = *(uint *)(this + 0x54);
  goto LAB_00100f9b;
}
...
ulong hb_ot_map_t::feature_map_t::cmp(void *param_1,void *param_2)
...
ulong hb_ot_map_t::lookup_map_t::cmp(void *param_1,void *param_2)
...
uint hb_ot_map_builder_t::feature_info_t::cmp(void *param_1,void *param_2)
...
LAB_00101b46:
    ...
    if (uVar5 < uVar9) {
LAB_00101ad0:
      if (0x38e38e3 < (uint)uVar6) goto LAB_00101a47;
      pvVar2 = *(void **)(this + 0x28);
LAB_00101ae1:
      uVar8 = (uint)uVar6;
...
LAB_00101fdd:
  ...
  *(uint *)this = ~uVar4;
LAB_0010205c:
  uVar2 = _hb_ot_layout_table_get_lookup_count;

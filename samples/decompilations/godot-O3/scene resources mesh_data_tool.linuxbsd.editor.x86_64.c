...
LAB_00104ce6:
  _err_print_index_error
            ("get","./core/templates/cowdata.h",0xdb,uVar17,lVar18,"p_index","size()","",false,true)
  ;
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar2 = (code *)invalidInstructionException();
...
LAB_00106e66:
            ...
            if (local_1a0._0_8_ == 0) {
              ...
              CowData<int>::_unref((CowData<int> *)local_1a0);
LAB_00105d00:
              if (piVar10 != (int *)0x0) goto LAB_00105d09;
            }
LAB_0010634a:

...

{
  ...
  if (iVar3 == iVar5) {
    ...
    if (uVar7 != 0) {
      puVar2 = param_1 + (int)uVar7;
      if (((int)(param_1 + (ulong)(0x3f - uVar7) + (long)(int)uVar7 + 1) - (int)puVar2 & 4U) == 0)
      goto LAB_00100080;
      *puVar2 = *puVar2 | uVar6;
      for (puVar2 = puVar2 + 1; puVar2 != param_1 + (ulong)(0x3f - uVar7) + (long)(int)uVar7 + 1;
          puVar2 = puVar2 + 2) {
LAB_00100080:
        *puVar2 = *puVar2 | uVar6;
        puVar2[1] = puVar2[1] | uVar6;
...
LAB_00100607:
  ...
  do {
    ...
    if ((int)uVar7 < (int)uVar5) {
      ...
      if ((uVar5 & 0x3f) != 0) {
LAB_0010068c:
        *(uint *)(this + (ulong)(uVar12 & 0x3f) * 4 + 0x20c) =
             *(uint *)(this + (ulong)(uVar12 & 0x3f) * 4 + 0x20c) |
...
LAB_00101268:
    ...
    if (bVar3 < 0xf0) {
      ...
      if (((0x3f < bVar1) || (0x3f < (byte)(param_1[2] + 0x80))) ||
         (0x3f < (byte)(param_1[3] + 0x80))) goto LAB_00101268;

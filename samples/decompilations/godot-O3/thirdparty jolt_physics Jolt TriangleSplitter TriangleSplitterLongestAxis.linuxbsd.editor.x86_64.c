...
void JPH::TriangleSplitterLongestAxis::Split(Range *param_1,Range *param_2,Range *param_3)

{
  ...
  if (uVar5 < *(uint *)(param_2 + 4)) {
    ...
    do {
      ...
      puVar7 = puVar7 + 1;
    } while ((uint *)(*(long *)(param_1 + 0x40) + 4 +
                     ((ulong)((*(uint *)(param_2 + 4) - 1) - uVar5) + (ulong)uVar5) * 4) != puVar7);
  ...
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
    JPH::TriangleSplitter::SplitInternal
              (param_1,(uint)param_2,local_38[(long)(ulong)uVar5],(Range *)(ulong)uVar5,param_3);
    return;
  }
...
void __thiscall
JPH::TriangleSplitterLongestAxis::TriangleSplitterLongestAxis
          (TriangleSplitterLongestAxis *this,Array *param_1,Array *param_2)
...
/* JPH::TriangleSplitterLongestAxis::GetStats(JPH::TriangleSplitter::Stats&) const */

void __thiscall
JPH::TriangleSplitterLongestAxis::GetStats(TriangleSplitterLongestAxis *this,Stats *param_1)
...
void __thiscall
JPH::TriangleSplitterLongestAxis::~TriangleSplitterLongestAxis(TriangleSplitterLongestAxis *this)
...
void JPH::TriangleSplitterLongestAxis::_GLOBAL__sub_I_TriangleSplitterLongestAxis(void)

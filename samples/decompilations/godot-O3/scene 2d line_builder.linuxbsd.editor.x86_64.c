...
LAB_00101fa3:
                  ...
                  local_84 = (((((local_114 + local_114) - _LC85 * local_b0) + _LC86 * local_140) -
                             ...
                             fVar45) * _LC65;
                  local_fc = (((((fVar35 + fVar35) - _UNK_0010607c * local_fc) +
                               _UNK_00106084 * local_f8) - fStack_80) * fVar48 +
                              (local_f8 - fVar35) * fVar40 + local_fc + local_fc +
                             (((local_fc * _UNK_0010608c - fVar35) - local_f8 * _UNK_0010608c) +
                             fStack_80) * fVar45) * _UNK_0010605c;
...
LAB_00105e9c:
    ...
    lVar4 = puVar10[-1];
    if (param_1 <= lVar4) goto LAB_00105e30;
  }
  else {
    if (lVar12 != 0) {
  ...
  if (((param_1 - lVar4) * 0x10 & 0x10U) != 0) {
    *puVar7 = __LC50;
    puVar7[1] = uVar3;
    puVar6 = puVar7 + 2;
    if (puVar7 + (param_1 - lVar4) * 2 == puVar7 + 2) goto LAB_00105e30;
  }
  do {
    *puVar6 = uVar9;
    puVar6[1] = uVar3;

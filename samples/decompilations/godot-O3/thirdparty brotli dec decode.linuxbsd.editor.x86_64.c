...

{
  ...
  if (param_1[0x20] < 0) {
    ...
    if (*param_4 == 0) {
      ...
      if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) goto LAB_00106379;
      iVar7 = -0x14;
...
LAB_0010508c:
      if ((*(long *)(param_1 + 0x22) == 0) ||
        ...
        lVar14 = *(long *)(param_1 + 0x14);
        puVar31 = *(undefined1 **)(param_1 + 6);
        if (lVar14 == 0) {
          *param_3 = (long)puVar31;
          lVar14 = *(long *)(param_1 + 10) - (long)puVar31;
          *param_2 = lVar14;
          while (lVar14 != 0) {
            lVar14 = *(long *)(param_1 + 0x14);
            uVar4 = *puVar31;
...
LAB_001050e0:
        ...
        if (*(undefined1 **)(param_1 + 10) == puVar31) {
          param_1[0x14] = 0;
          param_1[0x15] = 0;
          lVar14 = *param_3;
          lVar30 = *param_2;
          *(long *)(param_1 + 6) = lVar14;
          if (lVar30 == 0) {
            ...
            *(long *)(param_1 + 10) = lVar14 + lVar30;
            if (0x1c < lVar30 + 1U) {
              *(long *)(param_1 + 8) = lVar14 + -0x1b + lVar30;
          ...
          *(long *)(param_1 + 8) = lVar14;
          ...
          if (lVar30 != 0) {
            ...
            piVar32 = (int *)((long)piVar12 + lVar30);
            if (lVar14 + 2U < 0x1d) {
              piVar21 = piVar12;
            }
          }
          *(undefined1 *)((long)param_1 + lVar14 + 0x48) = *(undefined1 *)*param_3;
          *(long *)(param_1 + 0x14) = lVar30;
          *(int **)(param_1 + 6) = piVar12;
          *(int **)(param_1 + 10) = piVar32;
...
LAB_00105e5c:
        ...
        case 1:
          ...
          *(ushort *)(param_1 + 0xc1) =
          ...
          if (0x14 < (bVar18 + 0x36 & 0x3f)) goto LAB_0010615c;
          *param_1 = 2;
          break;
        case 2:
...
LAB_00105cfa:
          ...
          if (iVar7 < (int)lVar14) {
            ...
            do {
              ...
              *(byte *)(*(long *)(param_1 + 0xc6) + lVar30) = (byte)uVar28 & 3;
              lVar14 = *(long *)(param_1 + 0x4e);
              lVar30 = lVar30 + 1;
...
LAB_001059bb:
          ...
          if (iVar7 < (int)(uint)*(ushort *)((long)plVar29 + 0x14)) {
            lVar14 = *(long *)(param_1 + 0x29c);
            do {
              iVar7 = ReadHuffmanCode((short)plVar29[2],*(undefined2 *)((long)plVar29 + 0x12),lVar14
                                      ,&local_48);
              if (iVar7 != 1) goto LAB_00105083;
              iVar7 = param_1[0x29b];
              lVar14 = *(long *)(param_1 + 0x29c);
              *(long *)(*plVar29 + (long)iVar7 * 8) = lVar14;
              iVar7 = iVar7 + 1;
              param_1[0x29b] = iVar7;
              lVar14 = lVar14 + local_48 * 4;
              uVar5 = *(ushort *)((long)plVar29 + 0x14);
              *(long *)(param_1 + 0x29c) = lVar14;
...
LAB_001053b0:
                do {
                  lVar14 = sVar13 + 1;
                  sVar13 = sVar13 + 2;
                  *(long *)(param_1 + lVar14 * 2 + 0x17a) = lVar14;
            ...
            if (uVar28 < uVar5) {
              ...
              lVar30 = 1;
              do {
                lVar27 = ((uVar33 + 2 << ((byte)lVar30 & 0x3f)) + -4 << ((byte)uVar11 & 0x3f)) +
                         __n + 1;
                memset((void *)((long)param_1 + uVar28 + 0x350),(uint)lVar30 & 0xff,uVar15);
                lVar3 = uVar15 + lVar27;
                lVar2 = lVar14 + lVar27 * -8;
                if ((uVar20 & 1) == 0) goto LAB_001054a0;
                *(long *)((long)param_1 + lVar27 * 8 + lVar2 + 0x570) = lVar27;
                for (lVar27 = lVar27 + 1; lVar27 != lVar3; lVar27 = lVar27 + 2) {
LAB_001054a0:
                  *(long *)((long)param_1 + lVar27 * 8 + lVar2 + 0x570) = lVar27;
                  *(long *)((long)param_1 + (lVar27 + 1) * 8 + lVar2 + 0x570) = lVar27 + 1;
                }
...
LAB_00105b79:
            ...
            *(ulong *)(param_1 + 2) = uVar33;
            if (uVar15 < 0x40) {
              *(ulong *)(param_1 + 2) = ~(-1L << ((byte)uVar15 & 0x3f)) & uVar33;
              if (uVar28 == 0) goto LAB_00105b5e;
            }
            else if (uVar28 == 0) goto LAB_001062e9;
            iVar7 = -0xf;
            goto LAB_0010551f;
          }
          *param_1 = 3;
        ...
        case 0x12:
          iVar8 = param_1[1];
          if (2 < iVar8) goto code_r0x001057e4;
        ...
        case 0x18:
          iVar7 = param_1[1];
          if (iVar7 == 1) {
            plVar29 = (long *)(param_1 + 0x34);
            goto LAB_001059bb;
          }
          if (iVar7 == 2) {
            plVar29 = (long *)(param_1 + 0x3a);
            goto LAB_001059bb;
          }
          if (iVar7 == 0) goto LAB_001059b8;
          if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) goto LAB_00106379;
          iVar7 = -0x1f;
          lVar22 = lVar22 - *param_2;
          goto LAB_00105101;

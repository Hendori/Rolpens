...
LAB_001146a1:
        if ((pBVar2 == pBVar9) || (uVar8 < *(uint *)(pBVar9 + 0x20))) goto LAB_001146ac;
      }
...
LAB_00117528:
          if ((pBVar1 == pBVar9) || (local_98 < *(uint *)(pBVar9 + 0x20))) goto LAB_00117532;
        }
...
LAB_001175a9:
          if ((pBVar9 == pBVar1) || (uVar6 < *(uint *)(pBVar9 + 0x20))) goto LAB_001175b7;
        }
...
LAB_00119d55:
        if (-1 < (int)uVar5) goto LAB_00119d59;
LAB_00119d00:
...
LAB_00119dc0:
    if (p_Var4 == p_Var14) goto LAB_00119dcb;
    uVar15 = *(ulong *)(p_Var14 + 0x28);
    uVar7 = uVar15;
    if (uVar13 <= uVar15) {
      uVar7 = uVar13;

...
/* RVO2D::Agent2D::Agent2D() */

void __thiscall RVO2D::Agent2D::Agent2D(Agent2D *this)
...
/* RVO2D::Agent2D::computeNeighbors(RVO2D::RVOSimulator2D*) */

void __thiscall RVO2D::Agent2D::computeNeighbors(Agent2D *this,RVOSimulator2D *param_1)
...
/* RVO2D::Agent2D::update(RVO2D::RVOSimulator2D*) */

void __thiscall RVO2D::Agent2D::update(Agent2D *this,RVOSimulator2D *param_1)

{
  ...
  *(ulong *)(this + 0x60) =
       CONCAT44((float)((ulong)*(undefined8 *)(this + 0x60) >> 0x20) +
                *(float *)(param_1 + 0x48) * (float)((ulong)uVar1 >> 0x20),
                (float)*(undefined8 *)(this + 0x60) + *(float *)(param_1 + 0x48) * (float)uVar1);
  return;
}
...
/* RVO2D::linearProgram1(std::vector<RVO2D::Line, std::allocator<RVO2D::Line> > const&, unsigned
   long, float, RVO2D::Vector2 const&, bool, RVO2D::Vector2&) */

undefined8
RVO2D::linearProgram1
          (vector *param_1,ulong param_2,float param_3,Vector2 *param_4,bool param_5,
          Vector2 *param_6)

{
  ...
  if (param_5) {
    ...
    if (fVar8 < fVar16) {
LAB_00100340:
      uVar10 = CONCAT44(fVar12 + fVar16 * fVar13,fVar9 + fVar16 * fVar11);
      goto LAB_001002d0;
    }
    if (fVar8 <= fVar6) {
...
/* RVO2D::linearProgram2(std::vector<RVO2D::Line, std::allocator<RVO2D::Line> > const&, float,
   RVO2D::Vector2 const&, bool, RVO2D::Vector2&) */

ulong RVO2D::linearProgram2
                (vector *param_1,float param_2,Vector2 *param_3,bool param_4,Vector2 *param_5)
  ...
  *(undefined8 *)param_5 = uVar9;
  ...
  if (uVar5 != 0) {
    ...
    do {
      ...
      if ((0.0 < (pfVar4[1] - fVar8) * pfVar4[2] - (*pfVar4 - fVar7) * pfVar4[3]) &&
         (cVar2 = linearProgram1(param_1,uVar3,param_2,param_3,param_4,param_5), cVar2 == '\0')) {
        *(float *)param_5 = fVar7;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* RVO2D::linearProgram3(std::vector<RVO2D::Line, std::allocator<RVO2D::Line> > const&, unsigned
   long, unsigned long, float, RVO2D::Vector2&) */

void RVO2D::linearProgram3
               (vector *param_1,ulong param_2,ulong param_3,float param_4,Vector2 *param_5)

{
  ...
  if (param_3 < (ulong)(lVar4 - lVar5 >> 4)) {
    ...
    do {
      ...
      if ((pfVar10[1] - *(float *)(param_5 + 4)) * pfVar10[2] -
          (*pfVar10 - *(float *)param_5) * pfVar10[3] <= fVar15) {
        lVar5 = *(long *)param_1;
      }
      else {
...
LAB_0010068e:
              local_68 = CONCAT44(fVar19,fVar18);
              uStack_60 = CONCAT44((fVar1 - fVar20) * (_LC4 / SQRT(fVar17)),
                                   (fVar2 - fVar15) * (_LC4 / SQRT(fVar17)));
              if (puVar8 == puVar11) {
                std::vector<RVO2D::Line,std::allocator<RVO2D::Line>>::
                _M_realloc_insert<RVO2D::Line_const&>
                          ((vector<RVO2D::Line,std::allocator<RVO2D::Line>> *)&local_58,puVar8,
                           &local_68);
                lVar5 = *(long *)param_1;
                pfVar10 = (float *)(lVar5 + lVar12);
                puVar11 = local_48;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* RVO2D::Agent2D::computeNewVelocity(RVO2D::RVOSimulator2D*) */

void __thiscall RVO2D::Agent2D::computeNewVelocity(Agent2D *this,RVOSimulator2D *param_1)
  ...
  if (*(long *)(this + 0x38) == lVar8) {
    ...
    do {
      ...
      if (pfVar17 != pfVar14) {
        ...
        pfVar7 = pfVar14;
        do {
          if ((__LC9 <= ((fVar39 * fVar24 - *pfVar7) * pfVar7[3] -
                        (fVar39 * fVar31 - pfVar7[1]) * pfVar7[2]) - fVar39 * fVar2) &&
             (__LC9 <= ((fVar39 * fVar21 - *pfVar7) * pfVar7[3] -
                       (fVar39 * fVar26 - pfVar7[1]) * pfVar7[2]) - fVar39 * fVar2))
          goto LAB_00100d1b;
          uVar12 = uVar12 + 1;
          pfVar7 = pfVar7 + 4;
        } while (uVar12 < uVar10);
      ...
      fVar19 = ((float)((uint)fVar24 ^ __LC1) * fVar37 + fVar25 * fVar38) /
...
LAB_001011ee:
          std::vector<RVO2D::Line,std::allocator<RVO2D::Line>>::
          _M_realloc_insert<RVO2D::Line_const&>(pvVar1,pfVar17,local_58);
          ...
          fVar21 = fVar24;
LAB_00100c46:
          lVar8 = *(long *)(pcVar13 + 0x18);
          pcVar15 = pcVar13;
          fVar24 = fVar21;
          fVar26 = fVar31;
          cVar11 = '\x01';
LAB_00101709:
          fVar33 = (float)(*(uint *)(lVar8 + 0x24) ^ __LC1);
...
LAB_0010114f:
              ...
              if (0.0 <= fVar38) {
LAB_00100cbf:
                fVar19 = fVar19 - (local_a4 * fVar38 + fVar26);
                ...
                if (fVar33 < fVar34) {
LAB_00100d06:
                  if (fVar33 <= fVar22) goto LAB_00100d0f;
                  goto LAB_001013db;
                }
              }
LAB_001011a4:
              uVar20 = CONCAT44(fVar2 * fVar39 * (float)(*(uint *)(pcVar13 + 0x20) ^ __LC1) + fVar31
                                ,fVar2 * fVar39 * *(float *)(pcVar13 + 0x24) + fVar24);
              uVar23 = CONCAT44((uint)*(float *)(pcVar13 + 0x24) ^ __LC1,
                                *(uint *)(pcVar13 + 0x20) ^ __LC1);
              uStack_50 = uVar23;
...
LAB_001013db:
            if (!bVar5) {
              ...
              uVar20 = CONCAT44(fVar2 * fVar39 * (float)((uint)local_a0 ^ __LC1) + fVar26,
                                local_a4 * fVar2 * fVar39 + fVar21);
              uStack_50 = uVar23;
              local_58 = (undefined1  [8])uVar20;
              pfVar7 = *(float **)(this + 0x58);
              goto joined_r0x001018d5;
            ...
            if (0.0 <= fVar30) {
              if (_LC4 < fVar30) {
                if (fVar38 < 0.0) {
                  ...
                  uVar20 = CONCAT44(fVar2 * fVar39 * fVar35 + fVar26,
                                    fVar2 * fVar39 * fVar31 + fVar21);
                  uStack_50 = uVar23;
                  local_58 = (undefined1  [8])uVar20;
                  pfVar7 = *(float **)(this + 0x58);
                  goto joined_r0x001018d5;
...
LAB_00100d0f:
              ...
              if (0.0 <= fVar33) goto LAB_0010114f;
LAB_00101781:
              fVar21 = _LC4 / SQRT(fVar28 * fVar28 + fVar32 * fVar32);
...
LAB_0010164a:
        ...
        uVar10 = CONCAT44((uint)((ulong)*(undefined8 *)(pcVar13 + 0x20) >> 0x20) ^ _LC10._4_4_,
                          (uint)*(undefined8 *)(pcVar13 + 0x20) ^ (uint)_LC10);
        pfVar7 = *(float **)(this + 0x58);
joined_r0x00101909:
        auVar6._8_8_ = 0;
        auVar6._0_8_ = uVar10;
...
LAB_00101564:
        ...
        *(float **)(this + 0x50) = pfVar17;
        ...
        if ((*pcVar15 != '\0') &&
           (0.0 <= *(float *)(pcVar15 + 0x24) * fVar21 - *(float *)(pcVar15 + 0x20) * fVar26)) {
          uVar10 = CONCAT44((_LC4 / SQRT(fVar22)) * fVar21,
                            (_LC4 / SQRT(fVar22)) * (float)((uint)fVar26 ^ __LC1));
          pfVar7 = *(float **)(this + 0x58);
...
LAB_00100d1b:
  ...
  if (*(long *)(this + 8) != lVar8) {
    do {
      ...
      if (fVar24 < fVar33) {
        ...
        if ((0.0 <= fVar37) ||
           (fVar35 = fVar38 * fVar38 + fVar25 * fVar25, fVar37 * fVar37 <= fVar24 * fVar35)) {
      ...
      if (pfVar14 == *(float **)(this + 0x58)) {
        std::vector<RVO2D::Line,std::allocator<RVO2D::Line>>::_M_realloc_insert<RVO2D::Line_const&>
                  (pvVar1,pfVar14,local_58);
      }
      else {
  ...
  uVar16 = linearProgram2((vector *)pvVar1,fVar39,(Vector2 *)(this + 0x68),false,
                          (Vector2 *)(this + 0x28));
...
/* RVO2D::Agent2D::insertAgentNeighbor(RVO2D::Agent2D const*, float&) */

void __thiscall RVO2D::Agent2D::insertAgentNeighbor(Agent2D *this,Agent2D *param_1,float *param_2)

{
  ...
  if ((this != param_1) && ((*(uint *)(this + 0x90) & *(uint *)(param_1 + 0x8c)) != 0)) {
    if ((*(float *)(this + 0x88) <= *(float *)(param_1 + 0x84) + *(float *)(param_1 + 0x88)) &&
       (((*(float *)(param_1 + 0x88) <= *(float *)(this + 0x88) + *(float *)(this + 0x84) &&
         (*(float *)(this + 0x94) < *(float *)(param_1 + 0x94) ||
          *(float *)(this + 0x94) == *(float *)(param_1 + 0x94))) &&
        (fVar9 = (*(float *)(this + 100) - *(float *)(param_1 + 100)) *
                 (*(float *)(this + 100) - *(float *)(param_1 + 100)) +
                 (*(float *)(this + 0x60) - *(float *)(param_1 + 0x60)) *
                 (*(float *)(this + 0x60) - *(float *)(param_1 + 0x60)), fVar9 < *param_2)))) {
      ...
      if (uVar5 < uVar7) {
        ...
        if (puVar1 == *(undefined8 **)(this + 0x10)) {
          std::
          vector<std::pair<float,RVO2D::Agent2D_const*>,std::allocator<std::pair<float,RVO2D::Agent2D_const*>>>
          ::_M_realloc_insert<std::pair<float,RVO2D::Agent2D_const*>>
                    ((vector<std::pair<float,RVO2D::Agent2D_const*>,std::allocator<std::pair<float,RVO2D::Agent2D_const*>>>
...
/* RVO2D::Agent2D::insertObstacleNeighbor(RVO2D::Obstacle2D const*, float) */

void __thiscall
RVO2D::Agent2D::insertObstacleNeighbor(Agent2D *this,Obstacle2D *param_1,float param_2)

{
  ...
  if ((*(uint *)(this + 0x90) & *(uint *)(lVar6 + 0x30)) != 0) {
    if ((*(float *)(this + 0x88) <= *(float *)(param_1 + 0x28) + *(float *)(param_1 + 0x2c)) &&
       (*(float *)(param_1 + 0x2c) <= *(float *)(this + 0x88) + *(float *)(this + 0x84))) {
      ...
      if (fVar11 < param_2) {
        ...
        if (puVar2 == *(undefined8 **)(this + 0x40)) {
          std::
          vector<std::pair<float,RVO2D::Obstacle2D_const*>,std::allocator<std::pair<float,RVO2D::Obstacle2D_const*>>>
          ::_M_realloc_insert<std::pair<float,RVO2D::Obstacle2D_const*>>
                    ((vector<std::pair<float,RVO2D::Obstacle2D_const*>,std::allocator<std::pair<float,RVO2D::Obstacle2D_const*>>>
                      *)(this + 0x30),puVar2,&local_38);
...
/* void std::vector<RVO2D::Line, std::allocator<RVO2D::Line> >::_M_realloc_insert<RVO2D::Line
   ...
   std::allocator<RVO2D::Line> > >, RVO2D::Line const&) */

void __thiscall
std::vector<RVO2D::Line,std::allocator<RVO2D::Line>>::_M_realloc_insert<RVO2D::Line_const&>
          (vector<RVO2D::Line,std::allocator<RVO2D::Line>> *this,void *param_2,undefined8 *param_3)
...
LAB_00102167:
    if (param_2 != pvVar1) goto LAB_001020b7;
LAB_001020eb:
    if (pvVar2 == (void *)0x0) goto LAB_00102107;
  }
  else {
    uVar8 = uVar4 * 2;
    if (uVar8 < uVar4) {
LAB_00102128:
      uVar8 = 0x7ffffffffffffff0;
      goto LAB_00102132;
    }
    if (uVar8 != 0) {
...
/* void std::vector<std::pair<float, RVO2D::Agent2D const*>, std::allocator<std::pair<float,
   ...
   RVO2D::Agent2D const*> > > >, std::pair<float, RVO2D::Agent2D const*>&&) */
...
/* void std::vector<std::pair<float, RVO2D::Obstacle2D const*>, std::allocator<std::pair<float,
   ...
   RVO2D::Obstacle2D const*> > > >, std::pair<float, RVO2D::Obstacle2D const*>&&) */

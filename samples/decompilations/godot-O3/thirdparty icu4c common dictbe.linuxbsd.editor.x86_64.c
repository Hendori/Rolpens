...
/* icu_76_godot::DictionaryBreakEngine::DictionaryBreakEngine() */
...
/* icu_76_godot::PossibleWord::candidates(UText*, icu_76_godot::DictionaryMatcher*, int) */

void __thiscall
icu_76_godot::PossibleWord::candidates
          (PossibleWord *this,UText *param_1,DictionaryMatcher *param_2,int param_3)
...
LAB_001000b3:
    ...
    *(int *)(this + 8) = iVar1;
    iVar2 = (**(code **)(*(long *)param_2 + 0x10))
                      (param_2,param_1,param_3 - iVar1,0x14,this + 0x14,this + 100);
    *(int *)this = iVar2;
    uVar3 = 0;
    if (iVar2 < 1) {
  ...
  utext_setNativeIndex_76_godot
            (param_1,(long)(iVar1 + *(int *)(this + (long)(iVar2 + -1) * 4 + 0x14)),uVar3);
  iVar2 = *(int *)this;
LAB_001000b9:
  *(ulong *)(this + 0xc) = CONCAT44(iVar2 + -1,iVar2 + -1);
  return;
}



/* icu_76_godot::PossibleWord::acceptMarked(UText*) */

undefined4 __thiscall icu_76_godot::PossibleWord::acceptMarked(PossibleWord *this,UText *param_1)

{
  utext_setNativeIndex_76_godot
            (param_1,(long)(*(int *)(this + 8) +
                           *(int *)(this + (long)*(int *)(this + 0xc) * 4 + 0x14)));
  return *(undefined4 *)(this + (long)*(int *)(this + 0xc) * 4 + 0x14);
}



/* icu_76_godot::PossibleWord::backUp(UText*) */

undefined8 __thiscall icu_76_godot::PossibleWord::backUp(PossibleWord *this,UText *param_1)

{
  ...
  *(int *)(this + 0x10) = iVar1;
  utext_setNativeIndex_76_godot
            (param_1,(long)(*(int *)(this + (long)iVar1 * 4 + 0x14) + *(int *)(this + 8)));
  return 1;
}
...
void __thiscall icu_76_godot::LaoBreakEngine::~LaoBreakEngine(LaoBreakEngine *this)
...
void __thiscall icu_76_godot::BurmeseBreakEngine::~BurmeseBreakEngine(BurmeseBreakEngine *this)
...
void __thiscall icu_76_godot::KhmerBreakEngine::~KhmerBreakEngine(KhmerBreakEngine *this)
...
void __thiscall icu_76_godot::ThaiBreakEngine::~ThaiBreakEngine(ThaiBreakEngine *this)

{
  *(undefined ***)this = &PTR__ThaiBreakEngine_00104bd8;
  ...
  icu_76_godot::UnicodeSet::~UnicodeSet((UnicodeSet *)(this + 0x328));
  icu_76_godot::UnicodeSet::~UnicodeSet((UnicodeSet *)(this + 0x260));
  icu_76_godot::UnicodeSet::~UnicodeSet((UnicodeSet *)(this + 0x198));
  icu_76_godot::UnicodeSet::~UnicodeSet((UnicodeSet *)(this + 0xd0));
  *(undefined **)this = &DAT_00104b90;
...
/* icu_76_godot::CjkBreakEngine::~CjkBreakEngine() */

void __thiscall icu_76_godot::CjkBreakEngine::~CjkBreakEngine(CjkBreakEngine *this)
...
/* icu_76_godot::DictionaryBreakEngine::handles(int, char const*) const */

void icu_76_godot::DictionaryBreakEngine::handles(int param_1,char *param_2)
...
/* icu_76_godot::DictionaryBreakEngine::findBreaks(UText*, int, int, icu_76_godot::UVector32&,
   signed char, UErrorCode&) const */

undefined1  [16] __thiscall
icu_76_godot::DictionaryBreakEngine::findBreaks
          (DictionaryBreakEngine *this,undefined8 param_1,undefined8 param_3_00,int param_3,
...

{
  ...
  if (*param_7 < 1) {
    ...
    uVar4 = (**(code **)(*(long *)this + 0x30))
                      (this,param_1,uVar2,iVar3,param_4,(int)param_6,param_7);
    uVar5 = (ulong)uVar4;
...
/* icu_76_godot::ThaiBreakEngine::divideUpDictionaryRange(UText*, int, int,
   icu_76_godot::UVector32&, signed char, UErrorCode&) const */

uint __thiscall
icu_76_godot::ThaiBreakEngine::divideUpDictionaryRange
          (ThaiBreakEngine *this,UText *param_1,int param_2,int param_3,long param_4,
...
LAB_001006f0:
        ...
        if (iVar2 < param_3) {
          ...
          iVar3 = PossibleWord::candidates
                            (pPVar9,param_1,*(DictionaryMatcher **)(this + 0x3f0),param_3);
          if (iVar3 == 1) {
            utext_setNativeIndex_76_godot
                      (param_1,(long)(aiStack_264[uVar14 * 0x2d + 1] +
                                     aiStack_264
                                     [(long)aiStack_264[uVar14 * 0x2d + 2] + 4 + uVar14 * 0x2d]));
          ...
          if (1 < iVar3) {
            ...
            if (iVar3 < param_3) {
              ...
              do {
                iVar3 = PossibleWord::candidates
                                  (local_268 + uVar11 * 0xb4,param_1,
                                   *(DictionaryMatcher **)(this + 0x3f0),param_3);
                if (iVar3 < 1) {
                  ...
                  while( true ) {
                    iVar3 = PossibleWord::candidates
                                      (local_268 + (ulong)((uVar16 + 2) % 3) * 0xb4,param_1,
                                       *(DictionaryMatcher **)(this + 0x3f0),param_3);
                    if (iVar3 != 0) {
                    ...
                    utext_setNativeIndex_76_godot
                              (param_1,(long)(aiStack_264[(long)iVar3 + 4 + uVar11 * 0x2d] +
                                             aiStack_264[uVar11 * 0x2d + 1]));
                  }
                  iVar3 = aiStack_264[uVar14 * 0x2d + 3];
                }
                ...
                utext_setNativeIndex_76_godot
                          (param_1,(long)(aiStack_264[(long)(iVar3 + -1) + 4 + uVar14 * 0x2d] +
                                         aiStack_264[uVar14 * 0x2d + 1]));
              } while( true );
            }
...
LAB_0010093e:
  utext_setNativeIndex_76_godot
            (param_1,(long)(aiStack_264[lVar8 + 4 + uVar14 * 0x2d] + aiStack_264[uVar14 * 0x2d + 1])
            );
  lVar8 = (long)aiStack_264[uVar14 * 0x2d + 2] + uVar14 * 0x2d;
  iVar3 = aiStack_264[lVar8 + 4];
  iVar4 = aiStack_204[lVar8];
LAB_00100988:
  ...
  if ((iVar4 < 3) && (iVar5 < param_3)) {
    iVar4 = PossibleWord::candidates
                      (local_268 + ((ulong)uVar16 % 3) * 0xb4,param_1,
                       *(DictionaryMatcher **)(this + 0x3f0),param_3);
      ...
      do {
        do {
          ...
          cVar1 = icu_76_godot::UnicodeSet::contains(iVar12 + 0xd0);
                ...
                (cVar1 = icu_76_godot::UnicodeSet::contains(iVar12 + 0x198), cVar1 == '\0'));
        iVar6 = PossibleWord::candidates
                          (local_268 + (ulong)((uVar16 + 1) % 3) * 0xb4,param_1,
                           *(DictionaryMatcher **)(this + 0x3f0),param_3);
...
LAB_00100795:
      utext_setNativeIndex_76_godot(param_1,(long)local_2a0);
    }
  }
LAB_001007d3:
  while (iVar4 = utext_getNativeIndex_76_godot(param_1), iVar4 < param_3) {
    utext_current32_76_godot(param_1);
...
LAB_001007fa:
  if (0 < *param_7) goto LAB_0010080c;
  goto LAB_001006f0;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* icu_76_godot::LaoBreakEngine::divideUpDictionaryRange(UText*, int, int, icu_76_godot::UVector32&,
   signed char, UErrorCode&) const */

uint __thiscall
icu_76_godot::LaoBreakEngine::divideUpDictionaryRange
          (LaoBreakEngine *this,UText *param_1,int param_2,int param_3,long param_4,
          undefined8 param_6,int *param_7)
...
LAB_00100f20:
      ...
      if (iVar2 < param_3) {
        ...
        iVar3 = PossibleWord::candidates
                          (pPVar8,param_1,*(DictionaryMatcher **)(this + 0x328),param_3);
        if (iVar3 == 1) {
          utext_setNativeIndex_76_godot
                    (param_1,(long)(aiStack_264[uVar13 * 0x2d + 1] +
                                   aiStack_264
                                   [(long)aiStack_264[uVar13 * 0x2d + 2] + 4 + uVar13 * 0x2d]));
        ...
        if (1 < iVar3) {
          ...
          if (lVar10 < param_3) {
            ...
            do {
              iVar3 = PossibleWord::candidates
                                (local_268 + uVar11 * 0xb4,param_1,
                                 *(DictionaryMatcher **)(this + 0x328),param_3);
              if (iVar3 < 1) {
                ...
                while( true ) {
                  iVar3 = PossibleWord::candidates
                                    (local_268 + (ulong)((uVar15 + 2) % 3) * 0xb4,param_1,
                                     *(DictionaryMatcher **)(this + 0x328),param_3);
                  if (iVar3 != 0) {
              ...
              utext_setNativeIndex_76_godot
                        (param_1,(long)(aiStack_264[(long)(iVar3 + -1) + 4 + uVar13 * 0x2d] +
                                       aiStack_264[uVar13 * 0x2d + 1]));
            } while( true );
          }
...
LAB_001010f5:
  utext_setNativeIndex_76_godot
            (param_1,(long)(aiStack_264[lVar10 + 4 + uVar13 * 0x2d] + aiStack_264[uVar13 * 0x2d + 1]
                           ));
  lVar10 = (long)aiStack_264[uVar13 * 0x2d + 2] + uVar13 * 0x2d;
  iVar3 = aiStack_264[lVar10 + 4];
  iVar4 = aiStack_204[lVar10];
LAB_0010113f:
  ...
  if ((iVar4 < 3) && (iVar5 < param_3)) {
    iVar4 = PossibleWord::candidates
                      (local_268 + ((ulong)uVar15 % 3) * 0xb4,param_1,
                       *(DictionaryMatcher **)(this + 0x328),param_3);
    local_2a0 = iVar2 + iVar3;
      ...
      do {
        do {
          ...
          cVar1 = icu_76_godot::UnicodeSet::contains(iVar12 + 0xd0);
                ...
                (cVar1 = icu_76_godot::UnicodeSet::contains(iVar12 + 0x198), cVar1 == '\0'));
        iVar6 = PossibleWord::candidates
                          (local_268 + (ulong)((uVar15 + 1) % 3) * 0xb4,param_1,
                           *(DictionaryMatcher **)(this + 0x328),param_3);
        utext_setNativeIndex_76_godot(param_1,(long)(iVar4 + local_2a0));
      } while (iVar6 < 1);
LAB_001012a9:
...
LAB_00101016:
  if (0 < *param_7) goto LAB_0010102d;
  goto LAB_00100f20;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* icu_76_godot::BurmeseBreakEngine::divideUpDictionaryRange(UText*, int, int,
   icu_76_godot::UVector32&, signed char, UErrorCode&) const */

uint __thiscall
icu_76_godot::BurmeseBreakEngine::divideUpDictionaryRange
          (BurmeseBreakEngine *this,UText *param_1,int param_2,int param_3,long param_4,
          undefined8 param_6,int *param_7)
...
LAB_001016e6:
  if (0 < *param_7) goto LAB_001016fd;
  goto LAB_001015f0;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* icu_76_godot::KhmerBreakEngine::divideUpDictionaryRange(UText*, int, int,
   icu_76_godot::UVector32&, signed char, UErrorCode&) const */

uint __thiscall
icu_76_godot::KhmerBreakEngine::divideUpDictionaryRange
          (KhmerBreakEngine *this,UText *param_1,int param_2,int param_3,long param_4,
          undefined8 param_6,int *param_7)
...
LAB_00101db6:
  if (0 < *param_7) goto LAB_00101dcd;
  goto LAB_00101cc0;
}



/* icu_76_godot::DictionaryBreakEngine::setCharacters(icu_76_godot::UnicodeSet const&) */

void __thiscall
icu_76_godot::DictionaryBreakEngine::setCharacters(DictionaryBreakEngine *this,UnicodeSet *param_1)
...
/* icu_76_godot::ThaiBreakEngine::ThaiBreakEngine(icu_76_godot::DictionaryMatcher*, UErrorCode&) */

void __thiscall
icu_76_godot::ThaiBreakEngine::ThaiBreakEngine
          (ThaiBreakEngine *this,DictionaryMatcher *param_1,UErrorCode *param_2)
...
/* icu_76_godot::LaoBreakEngine::LaoBreakEngine(icu_76_godot::DictionaryMatcher*, UErrorCode&) */

void __thiscall
icu_76_godot::LaoBreakEngine::LaoBreakEngine
          (LaoBreakEngine *this,DictionaryMatcher *param_1,UErrorCode *param_2)
...
void __thiscall
icu_76_godot::BurmeseBreakEngine::BurmeseBreakEngine
          (BurmeseBreakEngine *this,DictionaryMatcher *param_1,UErrorCode *param_2)
...
void __thiscall
icu_76_godot::KhmerBreakEngine::KhmerBreakEngine
          (KhmerBreakEngine *this,DictionaryMatcher *param_1,UErrorCode *param_2)
...
/* icu_76_godot::CjkBreakEngine::divideUpDictionaryRange(UText*, int, int, icu_76_godot::UVector32&,
   signed char, UErrorCode&) const [clone .part.0] */

int __thiscall
icu_76_godot::CjkBreakEngine::divideUpDictionaryRange
          (CjkBreakEngine *this,long param_1,int param_2,int param_3,long param_4,char param_6,
          UErrorCode *param_7)

{
  ...
  if (((((*(byte *)(param_1 + 8) & 4) == 0) ||
       (lVar12 = *(long *)(param_1 + 0x20), (long)uVar17 < lVar12)) ||
      (*(long *)(param_1 + 0x10) < lVar13)) || ((long)*(int *)(param_1 + 0x1c) < lVar13 - lVar12)) {
...
joined_r0x00102c13:
        ...
        if (((int)uVar16 < 0) || (*(int *)(local_2a8 + 0xc) < (int)uVar16)) {
          cVar3 = icu_76_godot::UVector32::expandCapacity
                            ((int)local_2a8,(UErrorCode *)(ulong)uVar16);
...
LAB_001034fc:
  ...
  local_2a8 = (UVector32 *)0x0;
LAB_00102ca7:
  pUVar18 = (UnicodeString *)&local_148;
  cVar3 = (**(code **)(**(long **)(this + 0x330) + 0x58))
                    (*(long **)(this + 0x330),(UnicodeString *)&local_148,param_7);
        ...
        if (iVar6 < local_140 >> 5) {
          do {
            ...
            do {
              ...
              cVar3 = (**(code **)(**(long **)(this + 0x330) + 0x78))
                                (*(long **)(this + 0x330),uVar5);
            } while (cVar3 == '\0');
            (**(code **)(**(long **)(this + 0x330) + 0x18))
                      (*(long **)(this + 0x330),(UnicodeString *)&local_c8,
                       (UnicodeString *)&local_88,param_7);
            icu_76_godot::UnicodeString::doAppend
                      ((UnicodeString *)&local_108,(int)(UnicodeString *)&local_88,0);
            iVar11 = param_2 + iVar7;
            if ((((local_2a8 != (UVector32 *)0x0) && (iVar11 = 0, -1 < iVar7)) &&
                (0 < *(int *)(local_2a8 + 8))) && (iVar7 < *(int *)(local_2a8 + 8))) {
            ...
            do {
              ...
              if (((int)uVar16 < 0) || (*(int *)(this_00 + 0xc) < (int)uVar16)) {
                cVar3 = icu_76_godot::UVector32::expandCapacity
                                  ((int)this_00,(UErrorCode *)(ulong)uVar16);
                if (cVar3 != '\0') {
                  iVar7 = *(int *)(this_00 + 8);
                  goto LAB_0010353c;
                }
...
LAB_0010353c:
                *(int *)(*(long *)(this_00 + 0x18) + (long)iVar7 * 4) = iVar11;
...
LAB_00102f34:
            lVar12 = (long)local_13c;
            if (local_13c <= iVar7) break;
          } while( true );
        }
        iVar6 = param_2 + (int)lVar12;
        if ((local_2a8 != (UVector32 *)0x0) && ((-1 < local_140 || (iVar6 = 0, -1 < local_13c)))) {
          iVar6 = 0;
...
LAB_00103ccf:
          *(int *)(*(long *)(this_00 + 0x18) + (long)iVar7 * 4) = iVar6;
          *(int *)(this_00 + 8) = *(int *)(this_00 + 8) + 1;
        }
        if (local_2a8 != (UVector32 *)0x0) {
...
LAB_001038a7:
      *(undefined4 *)(local_260 + (long)local_270 * 4) = 0;
...
LAB_001039d8:
        uVar16 = local_1f0 + 1;
        if (((-1 < (int)uVar16) && ((int)uVar16 <= local_1ec)) ||
           (cVar3 = icu_76_godot::UVector32::expandCapacity
                              ((int)local_1f8,(UErrorCode *)(ulong)uVar16), cVar3 != '\0')) {
          *(int *)(local_1e0 + (long)local_1f0 * 4) = iVar6;
          local_1f0 = local_1f0 + 1;
        }
        if (*(int *)param_7 < 1) {
          if (((iVar6 < 0) || (local_250 < 1)) ||
             ((local_250 <= iVar6 || (iVar6 = *(int *)(local_240 + (long)iVar6 * 4), iVar6 < 1))))
          goto LAB_001036e5;
          iVar7 = 1;
          do {
            local_2d8 = local_1f8;
            ...
            if (cVar3 == '\0') {
              ...
              if ((((iVar11 - 0x30a1U < 0x5e) && (iVar11 != 0x30fb)) || (iVar11 - 0xff66U < 0x3a))
                 && (((iVar11 = icu_76_godot::UnicodeString::char32At(iVar15),
                      iVar11 - 0x30a1U < 0x5e && (iVar11 != 0x30fb)) || (iVar11 - 0xff66U < 0x3a))))
              goto LAB_00103e4c;
              icu_76_godot::UnicodeString::~UnicodeString((UnicodeString *)&local_88);
              uVar16 = local_1f0 + 1;
              if (((-1 < (int)uVar16) && ((int)uVar16 <= local_1ec)) ||
                 (cVar3 = icu_76_godot::UVector32::expandCapacity
                                    ((int)local_2d8,(UErrorCode *)(ulong)uVar16), cVar3 != '\0')) {
                *(int *)(local_1e0 + (long)local_1f0 * 4) = iVar6;
                local_1f0 = local_1f0 + 1;
              }
              iVar7 = iVar7 + 1;
...
LAB_00103e4c:
          ...
          } while (((0 < local_250) && (iVar6 < local_250)) &&
                  (iVar6 = *(int *)(local_240 + (long)iVar6 * 4), 0 < iVar6));
          goto LAB_00103a18;
        }
      }
LAB_00103a11:
...
LAB_001036a0:
        if (*(int *)(local_260 + (long)iVar6 * 4) == -1) {
          uVar16 = local_1f0 + 1;
          if (((-1 < (int)uVar16) && ((int)uVar16 <= local_1ec)) ||
             (cVar3 = icu_76_godot::UVector32::expandCapacity
                                ((int)local_1f8,(UErrorCode *)(ulong)uVar16), cVar3 != '\0')) {
...
LAB_001036e5:
        ...
        do {
          if (((local_270 < 1) || (local_270 <= iVar23)) || (*(int *)(local_260 + lVar12) != -1)) {
            ...
            iVar9 = (**(code **)(**(long **)(this + 0x328) + 0x10))
                              (*(long **)(this + 0x328),&local_1d8,0x14,iVar6,0,local_200,local_220,
                               0);
            if (iVar9 == 0) {
              icu_76_godot::UnicodeString::char32At(iVar15);
              ...
              if (0 < iVar9) {
                ...
                do {
                  while( true ) {
                    ...
                    iVar24 = iVar23;
                    if (((((local_210 < 1) || (local_210 <= (int)lVar14)) ||
                         (iVar24 = iVar23 + local_200[lVar14], -1 < iVar23 + local_200[lVar14])) &&
                        ((0 < local_270 && (iVar24 < local_270)))) &&
                       (uVar16 < *(uint *)(local_260 + (long)iVar24 * 4))) break;
                    lVar14 = lVar14 + 1;
...
LAB_0010344e:
            iVar9 = icu_76_godot::UnicodeString::char32At(iVar15);
            if ((iVar9 - 0x30a1U < 0x5e && iVar9 != 0x30fb) || (iVar9 - 0xff66U < 0x3a)) {
              if (!bVar1) {
                ...
                while( true ) {
                  ...
                  if (((0x5d < iVar10 - 0x30a1U) || (iVar10 == 0x30fb)) && (0x39 < iVar10 - 0xff66U)
                     ) goto LAB_00103828;
                  iVar24 = iVar24 + 1;
...
LAB_00103828:
                if (0 < local_270) {
                  if (iVar23 < local_270) {
                    if (iVar24 < 9) {
                      uVar16 = *(int *)(local_260 + lVar12) +
                               *(int *)(getKatakanaCost(int)::katakanaCost + (long)iVar24 * 4);
                    }
                    else {
                    ...
                    uVar16 = 0x2000;
                    if (iVar24 < 9) {
                      uVar16 = *(uint *)(getKatakanaCost(int)::katakanaCost + (long)iVar24 * 4);
                    }
                  }
                  if ((iVar24 + iVar23 < local_270) &&
                     (uVar16 < *(uint *)(local_260 + (long)(iVar24 + iVar23) * 4))) {
                    icu_76_godot::UVector32::setElementAt(iVar11,uVar16);
                    icu_76_godot::UVector32::setElementAt(iVar19,iVar23);
                  }
                }
    ...
    if (iVar7 < 0) {
      ...
      do {
        if ((local_1f0 < 1) || (local_1f0 <= iVar7)) {
          ...
          if (local_2a8 != (UVector32 *)0x0) {
            iVar11 = 0;
            if (((-1 < iVar22) && (0 < *(int *)(local_2a8 + 8))) &&
               (iVar11 = 0, iVar22 < *(int *)(local_2a8 + 8))) {
              lVar14 = (long)iVar22 << 2;
LAB_00103bd5:
              iVar11 = *(int *)(*(long *)(local_2a8 + 0x18) + lVar14);
            }
          }
LAB_00103ac7:
          bVar1 = iVar6 < iVar11;
...
LAB_00103ad4:
              ...
              if (((int)uVar16 < 0) || (*(int *)(param_4 + 0xc) < (int)uVar16)) {
                cVar3 = icu_76_godot::UVector32::expandCapacity
                                  ((int)param_4,(UErrorCode *)(ulong)uVar16);
                if (cVar3 != '\0') {
                  iVar11 = *(int *)(param_4 + 8);
                  goto LAB_00103c6b;
                }
...
LAB_00103c6b:
                *(int *)(*(long *)(param_4 + 0x18) + (long)iVar11 * 4) = iVar6;
                *(int *)(param_4 + 8) = *(int *)(param_4 + 8) + 1;
              }
              iVar15 = iVar15 + 1;
            }
...
LAB_00103fe8:
          cVar3 = icu_76_godot::UnicodeSet::contains(iVar2 + 0x198);
...
LAB_00103b70:
    icu_76_godot::UVector32::~UVector32(local_1f8);
...
LAB_00102c2d:
  ...
  if (cVar3 != '\0') {
LAB_00102c40:
    *(undefined4 *)(*(long *)(local_2a8 + 0x18) + (long)iVar6 * 4) = uVar5;
...
icu_76_godot::CjkBreakEngine::divideUpDictionaryRange
          (undefined8 param_1,undefined8 param_2_00,int param_2,int param_3,undefined8 param_5,
          undefined8 param_6,int *param_7)
...
/* icu_76_godot::CjkBreakEngine::loadJapaneseExtensions(UErrorCode&) */

void __thiscall
icu_76_godot::CjkBreakEngine::loadJapaneseExtensions(CjkBreakEngine *this,UErrorCode *param_1)

{
  ...
  if (*(int *)param_1 < 1) {
    ...
    iVar1 = *(int *)param_1;
    while ((iVar1 < 1 && (cVar2 = icu_76_godot::ResourceBundle::hasNext(), cVar2 != '\0'))) {
      pRVar3 = local_148;
...
/* icu_76_godot::CjkBreakEngine::loadHiragana(UErrorCode&) */

void __thiscall icu_76_godot::CjkBreakEngine::loadHiragana(CjkBreakEngine *this,UErrorCode *param_1)
...
/* icu_76_godot::CjkBreakEngine::initJapanesePhraseParameter(UErrorCode&) */

void __thiscall
icu_76_godot::CjkBreakEngine::initJapanesePhraseParameter(CjkBreakEngine *this,UErrorCode *param_1)
...
/* icu_76_godot::CjkBreakEngine::CjkBreakEngine(icu_76_godot::DictionaryMatcher*,
   icu_76_godot::LanguageType, UErrorCode&) */

void __thiscall
icu_76_godot::CjkBreakEngine::CjkBreakEngine
          (CjkBreakEngine *this,undefined8 param_1,int param_3,UErrorCode *param_4)

{
  ...
  *(undefined8 *)(this + 0x348) = 0;
  local_14c = 0;
  uhash_init_76_godot(pCVar1,&uhash_hashUnicodeString_76_godot,&uhash_compareUnicodeString_76_godot,
                      0,&local_14c);
  if (local_14c < 1) {
  ...
  *(undefined8 *)(this + 0x330) = uVar3;
  ...
  if (param_3 == 0) {
    ...
    icu_76_godot::UnicodeSet::UnicodeSet
              ((UnicodeSet *)&local_108,(UnicodeString *)&local_148,param_4);
    icu_76_godot::UnicodeString::~UnicodeString((UnicodeString *)&local_148);
    iVar2 = *(int *)param_4;

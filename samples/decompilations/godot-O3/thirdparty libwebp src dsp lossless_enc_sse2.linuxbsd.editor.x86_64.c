...
void PredictorSub0_SSE2(long param_1,undefined8 param_2,int param_3,long param_4)
...
void PredictorSub1_SSE2(long param_1,long param_2,int param_3,long param_4)
...
void PredictorSub2_SSE2(long param_1,long param_2,int param_3,long param_4)
...
void PredictorSub3_SSE2(long param_1,long param_2,int param_3,long param_4)
...
void PredictorSub4_SSE2(long param_1,long param_2,int param_3,long param_4)
...
void PredictorSub13_SSE2(long param_1,long param_2,int param_3,long param_4)

{
  ...
  if (param_3 < 2) {
    ...
    do {
      ...
      *(ulong *)(param_4 + lVar44) =
           CONCAT17((char)((ulong)uVar5 >> 0x38) -
                    ((0 < sVar53) * (sVar53 < 0x100) * (char)sVar53 - (0xff < sVar53)),
                    CONCAT16((char)((ulong)uVar5 >> 0x30) -
                             ((0 < sVar52) * (sVar52 < 0x100) * (char)sVar52 - (0xff < sVar52)),
                             CONCAT15((char)((ulong)uVar5 >> 0x28) -
                                      ((0 < sVar51) * (sVar51 < 0x100) * (char)sVar51 -
                                      (0xff < sVar51)),
                                      CONCAT14((char)((ulong)uVar5 >> 0x20) -
                                               ((0 < sVar50) * (sVar50 < 0x100) * (char)sVar50 -
                                               (0xff < sVar50)),
                                               CONCAT13((char)((ulong)uVar5 >> 0x18) -
                                                        ((0 < sVar49) * (sVar49 < 0x100) *
                                                         (char)sVar49 - (0xff < sVar49)),
                                                        CONCAT12((char)((ulong)uVar5 >> 0x10) -
                                                                 ((0 < sVar48) * (sVar48 < 0x100) *
                                                                  (char)sVar48 - (0xff < sVar48)),
...
void PredictorSub12_SSE2(long param_1,long param_2,int param_3,long param_4)

{
  ...
  if (param_3 != iVar58) {
    lVar59 = (long)iVar58 * 4;
                    ...
                    /* WARNING: Treating indirect jump as call */
    (*_VP8LCollectColorRedTransforms)
              (param_1 + lVar59,param_2 + lVar59,param_3 - iVar58,param_4 + lVar59);
    return;
  }
  return;
}
...
void PredictorSub11_SSE2(long param_1,long param_2,int param_3,long param_4)

{
  ...
  if (param_3 != iVar20) {
    lVar21 = (long)iVar20 * 4;
                    ...
                    /* WARNING: Treating indirect jump as call */
    (*_VP8LCollectColorBlueTransforms)
              (param_1 + lVar21,param_2 + lVar21,param_3 - iVar20,param_4 + lVar21);
    return;
  }
  return;
}
...
void PredictorSub5_SSE2(long param_1,long param_2,int param_3,long param_4)
...
void PredictorSub6_SSE2(long param_1,long param_2,int param_3,long param_4)

{
  ...
  if (param_3 != iVar69) {
    lVar70 = (long)iVar69 * 4;
                    ...
                    /* WARNING: Treating indirect jump as call */
    (*_VP8LSubtractGreenFromBlueAndRed_C)
              (param_1 + lVar70,param_2 + lVar70,param_3 - iVar69,param_4 + lVar70);
    return;
  }
  return;
}
...
void PredictorSub7_SSE2(long param_1,long param_2,int param_3,long param_4)
...
void PredictorSub8_SSE2(long param_1,long param_2,int param_3,long param_4)
...
void PredictorSub9_SSE2(long param_1,long param_2,int param_3,long param_4)

{
  ...
  if (param_3 != iVar69) {
    lVar70 = (long)iVar69 * 4;
                    ...
                    /* WARNING: Treating indirect jump as call */
    (*_VP8LSubtractGreenFromBlueAndRed)
              (param_1 + lVar70,param_2 + lVar70,param_3 - iVar69,param_4 + lVar70);
    return;
  }
  return;
...
void PredictorSub10_SSE2(long param_1,long param_2,int param_3,long param_4)
...

{
  ...
  if (param_3 < 0xc) {
    ...
    if ((ushort)((ushort)(SUB161(auVar8 >> 7,0) & 1) | (ushort)(SUB161(auVar8 >> 0xf,0) & 1) << 1 |
                ...
                (ushort)(byte)(auVar8._12_4_ >> 0x1f) << 0xf) != 0xffff) goto LAB_00100b5f;
    uVar5 = 4;
    if (7 < param_3) {
...
void BundleColorMap_SSE2(undefined1 *param_1,int param_2,int param_3,undefined1 (*param_4) [16])
...
LAB_00100e40:
    ...
    if (param_3 == 2) {
        ...
        if (0xf < param_2) {
          ...
          do {
            ...
            *param_4 = auVar5 << 8;
            ...
            auVar55._8_8_ =
                 (undefined8)
                 (CONCAT63(auVar56._10_6_,CONCAT21((short)((uint6)uVar40 >> 0x20),bVar15)) >> 8);
      ...
      do {
        ...
        uVar34 = (uint)(ushort)((ushort)(SUB161(auVar43 >> 7,0) & 1) |
                                ...
                                (ushort)((byte)lVar37 & 1) << 8 |
                                (ushort)((byte)(auVar43._8_8_ >> 0xf) & 1) << 9 |
                                (ushort)((byte)(auVar43._8_8_ >> 0x17) & 1) << 10 |
                                (ushort)((byte)(auVar43._8_8_ >> 0x1f) & 1) << 0xb |
                                (ushort)((byte)(auVar43._8_8_ >> 0x27) & 1) << 0xc |
                                (ushort)((byte)(auVar43._8_8_ >> 0x2f) & 1) << 0xd |
                                (ushort)((byte)(auVar43._8_8_ >> 0x37) & 1) << 0xe |
                               (ushort)(byte)(auVar43._8_8_ >> 0x3f) << 0xf);
...
void CollectColorRedTransforms_SSE2
               (undefined1 (*param_1) [16],int param_2,uint param_3,int param_4,int param_5,
               long param_6)

{
      ...
      if (7 < (int)param_3) {
        do {
          ...
          do {
            ...
            auVar10[0] = auVar13[2] - auVar12[0];
            auVar10[1] = auVar13[3] - auVar12[1];
            auVar10[2] = -auVar12[2];
            auVar10[3] = -auVar12[3];
            auVar10[4] = auVar13[6] - auVar12[4];
            auVar10[5] = auVar13[7] - auVar12[5];
            auVar10[6] = -auVar12[6];
            auVar10[7] = -auVar12[7];
            auVar10[8] = auVar13[10] - auVar12[8];
            auVar10[9] = auVar13[0xb] - auVar12[9];
            auVar10[10] = -auVar12[10];
            auVar10[0xb] = -auVar12[0xb];
            auVar10[0xc] = auVar13[0xe] - auVar12[0xc];
            auVar10[0xd] = auVar13[0xf] - auVar12[0xd];
            auVar10[0xe] = -auVar12[0xe];
            auVar10[0xf] = -auVar12[0xf];
            auVar13[0] = auVar2[2] - auVar11[0];
            auVar13[1] = auVar2[3] - auVar11[1];
            auVar13[2] = -auVar11[2];
            auVar13[3] = -auVar11[3];
            auVar13[4] = auVar2[6] - auVar11[4];
            auVar13[5] = auVar2[7] - auVar11[5];
            auVar13[6] = -auVar11[6];
            auVar13[7] = -auVar11[7];
            auVar13[8] = auVar2[10] - auVar11[8];
            auVar13[9] = auVar2[0xb] - auVar11[9];
            auVar13[10] = -auVar11[10];
            auVar13[0xb] = -auVar11[0xb];
            auVar13[0xc] = auVar2[0xe] - auVar11[0xc];
            auVar13[0xd] = auVar2[0xf] - auVar11[0xd];
  ...
  if ((param_3 & 7) == 0) {
    ...
    VP8LCollectColorRedTransforms_C
              ((long)param_1 + ((long)(int)param_3 - (long)(int)(param_3 & 7)) * 4,param_2,
               param_3 & 7,param_4,param_5);
    return;
  }
...

{
      ...
      if (7 < (int)param_3) {
        do {
          ...
          do {
            ...
            auVar12[0] = auVar11[0] - (auVar14[2] + auVar18[0]);
            auVar12[1] = auVar11[1] - (auVar14[3] + auVar18[1]);
            auVar12[2] = auVar11[2] - auVar18[2];
            auVar12[3] = auVar11[3] - auVar18[3];
            auVar12[4] = auVar11[4] - (auVar14[6] + auVar18[4]);
            auVar12[5] = auVar11[5] - (auVar14[7] + auVar18[5]);
            auVar12[6] = auVar11[6] - auVar18[6];
            auVar12[7] = auVar11[7] - auVar18[7];
            auVar12[8] = auVar11[8] - (auVar14[10] + auVar18[8]);
            auVar12[9] = auVar11[9] - (auVar14[0xb] + auVar18[9]);
            auVar12[10] = auVar11[10] - auVar18[10];
            auVar12[0xb] = auVar11[0xb] - auVar18[0xb];
            auVar12[0xc] = auVar11[0xc] - (auVar14[0xe] + auVar18[0xc]);
            auVar12[0xd] = auVar11[0xd] - (auVar14[0xf] + auVar18[0xd]);
            auVar12[0xe] = auVar11[0xe] - auVar18[0xe];
            auVar12[0xf] = auVar11[0xf] - auVar18[0xf];
            auVar11[0] = auVar2[0] - (auVar13[2] + auVar17[0]);
            auVar11[1] = auVar2[1] - (auVar13[3] + auVar17[1]);
            auVar11[2] = auVar2[2] - auVar17[2];
            auVar11[3] = auVar2[3] - auVar17[3];
            auVar11[4] = auVar2[4] - (auVar13[6] + auVar17[4]);
            auVar11[5] = auVar2[5] - (auVar13[7] + auVar17[5]);
            auVar11[6] = auVar2[6] - auVar17[6];
            auVar11[7] = auVar2[7] - auVar17[7];
            auVar11[8] = auVar2[8] - (auVar13[10] + auVar17[8]);
            auVar11[9] = auVar2[9] - (auVar13[0xb] + auVar17[9]);
            auVar11[10] = auVar2[10] - auVar17[10];
            auVar11[0xb] = auVar2[0xb] - auVar17[0xb];
            auVar11[0xc] = auVar2[0xc] - (auVar13[0xe] + auVar17[0xc]);
            auVar11[0xd] = auVar2[0xd] - (auVar13[0xf] + auVar17[0xd]);
            auVar11[0xe] = auVar2[0xe] - auVar17[0xe];
            auVar11[0xf] = auVar2[0xf] - auVar17[0xf];
  ...
  if (uVar6 == 0) {
    ...
    VP8LCollectColorBlueTransforms_C
              ((long)param_1 + ((long)(int)param_3 - (long)(int)uVar6) * 4,param_2,uVar6,param_4,
               param_5,param_6);
    return;
  }
                    /* WARNING: Subroutine does not return */
...
void TransformColor_SSE2(char *param_1,undefined1 (*param_2) [16],int param_3)
...

{
  ...
  if (param_2 < 4) {
    ...
    do {
      ...
      (*pauVar3)[0] = auVar1[0] - auVar6[0];
      (*pauVar3)[1] = auVar1[1] - auVar6[1];
      (*pauVar3)[2] = auVar1[2] - auVar6[2];
      (*pauVar3)[3] = auVar1[3] - auVar6[3];
      (*pauVar3)[4] = auVar1[4] - auVar6[4];
      (*pauVar3)[5] = auVar1[5] - auVar6[5];
      (*pauVar3)[6] = auVar1[6] - auVar6[6];
      (*pauVar3)[7] = auVar1[7] - auVar6[7];
      (*pauVar3)[8] = auVar1[8] - auVar6[8];
      (*pauVar3)[9] = auVar1[9] - auVar6[9];
      (*pauVar3)[10] = auVar1[10] - auVar6[10];
      (*pauVar3)[0xb] = auVar1[0xb] - auVar6[0xb];
      (*pauVar3)[0xc] = auVar1[0xc] - auVar6[0xc];
      (*pauVar3)[0xd] = auVar1[0xd] - auVar6[0xd];
      (*pauVar3)[0xe] = auVar1[0xe] - auVar6[0xe];
      (*pauVar3)[0xf] = auVar1[0xf] - auVar6[0xf];
      pauVar3 = pauVar4;
...
undefined8 CombinedShannonEntropy_SSE2(long param_1,long param_2)

{
  ...
  local_44 = 0;
  do {
    auVar10 = packssdw(*(undefined1 (*) [16])(param_1 + 0x20 + lVar6 * 4),
                       *(undefined1 (*) [16])(param_1 + 0x30 + lVar6 * 4));
    auVar13 = packssdw(*(undefined1 (*) [16])(param_1 + lVar6 * 4),
                       *(undefined1 (*) [16])(param_1 + 0x10 + lVar6 * 4));
    auVar13 = packsswb(auVar13,auVar10);
    auVar14 = packssdw(*(undefined1 (*) [16])(param_2 + 0x20 + lVar6 * 4),
                       *(undefined1 (*) [16])(param_2 + 0x30 + lVar6 * 4));
    auVar10 = packssdw(*(undefined1 (*) [16])(param_2 + lVar6 * 4),
                       *(undefined1 (*) [16])(param_2 + 0x10 + lVar6 * 4));
    auVar10 = packsswb(auVar10,auVar14);
    auVar14[0] = -('\0' < auVar13[0]);
    auVar14[1] = -('\0' < auVar13[1]);
    auVar14[2] = -('\0' < auVar13[2]);
    auVar14[3] = -('\0' < auVar13[3]);
    auVar14[4] = -('\0' < auVar13[4]);
    auVar14[5] = -('\0' < auVar13[5]);
    auVar14[6] = -('\0' < auVar13[6]);
    auVar14[7] = -('\0' < auVar13[7]);
    auVar14[8] = -('\0' < auVar13[8]);
    auVar14[9] = -('\0' < auVar13[9]);
    auVar14[10] = -('\0' < auVar13[10]);
    auVar14[0xb] = -('\0' < auVar13[0xb]);
    auVar14[0xc] = -('\0' < auVar13[0xc]);
    auVar14[0xd] = -('\0' < auVar13[0xd]);
    auVar14[0xe] = -('\0' < auVar13[0xe]);
    auVar14[0xf] = -('\0' < auVar13[0xf]);
    auVar13[0] = -('\0' < auVar10[0]);
    auVar13[1] = -('\0' < auVar10[1]);
    auVar13[2] = -('\0' < auVar10[2]);
    auVar13[3] = -('\0' < auVar10[3]);
    auVar13[4] = -('\0' < auVar10[4]);
    auVar13[5] = -('\0' < auVar10[5]);
    auVar13[6] = -('\0' < auVar10[6]);
    auVar13[7] = -('\0' < auVar10[7]);
    auVar13[8] = -('\0' < auVar10[8]);
    auVar13[9] = -('\0' < auVar10[9]);
    auVar13[10] = -('\0' < auVar10[10]);
    auVar13[0xb] = -('\0' < auVar10[0xb]);
    auVar13[0xc] = -('\0' < auVar10[0xc]);
    auVar13[0xd] = -('\0' < auVar10[0xd]);
    auVar13[0xe] = -('\0' < auVar10[0xe]);
    auVar13[0xf] = -('\0' < auVar10[0xf]);
    ...
    for (uVar7 = (uint)(ushort)((ushort)(SUB161(auVar13 >> 7,0) & 1) |
                                (ushort)(SUB161(auVar13 >> 0xf,0) & 1) << 1 |
                                (ushort)(SUB161(auVar13 >> 0x17,0) & 1) << 2 |
                                (ushort)(SUB161(auVar13 >> 0x1f,0) & 1) << 3 |
                                (ushort)(SUB161(auVar13 >> 0x27,0) & 1) << 4 |
                                ...
                                (ushort)(auVar13[0xf] >> 7) << 0xf | uVar2); uVar7 != 0;
        uVar7 = uVar7 & uVar7 - 1) {
      while( true ) {
        uVar3 = 0;

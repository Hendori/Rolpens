...
/* icu_76_godot::StringTrieBuilder::Node::markRightEdgesFirst(int) */

int __thiscall icu_76_godot::StringTrieBuilder::Node::markRightEdgesFirst(Node *this,int param_1)
...
/* icu_76_godot::StringTrieBuilder::FinalValueNode::write(icu_76_godot::StringTrieBuilder&) */

void __thiscall
icu_76_godot::StringTrieBuilder::FinalValueNode::write
          (FinalValueNode *this,StringTrieBuilder *param_1)
...
void __thiscall
icu_76_godot::StringTrieBuilder::IntermediateValueNode::write
          (IntermediateValueNode *this,StringTrieBuilder *param_1)
...
/* icu_76_godot::StringTrieBuilder::BranchHeadNode::write(icu_76_godot::StringTrieBuilder&) */

void __thiscall
icu_76_godot::StringTrieBuilder::BranchHeadNode::write
          (BranchHeadNode *this,StringTrieBuilder *param_1)

{
  ...
  if (iVar1 <= iVar2) {
    uVar3 = (**(code **)(*(long *)param_1 + 0x90))
                      (param_1,(int)(char)this[0x10],*(undefined4 *)(this + 0x14),
                       *(int *)(this + 0x18) + -1);
  ...
  uVar3 = (**(code **)(*(long *)param_1 + 0x90))
                    (param_1,(int)(char)this[0x10],*(undefined4 *)(this + 0x14),0);
  *(undefined4 *)(this + 0xc) = uVar3;
  return;
}
...
/* icu_76_godot::StringTrieBuilder::IntermediateValueNode::markRightEdgesFirst(int) */

ulong __thiscall
icu_76_godot::StringTrieBuilder::IntermediateValueNode::markRightEdgesFirst
          (IntermediateValueNode *this,int param_1)
...
/* icu_76_godot::StringTrieBuilder::LinearMatchNode::markRightEdgesFirst(int) */

ulong __thiscall
icu_76_godot::StringTrieBuilder::LinearMatchNode::markRightEdgesFirst
          (LinearMatchNode *this,int param_1)
...
/* icu_76_godot::StringTrieBuilder::ListBranchNode::markRightEdgesFirst(int) */

void __thiscall
icu_76_godot::StringTrieBuilder::ListBranchNode::markRightEdgesFirst
          (ListBranchNode *this,int param_1)
...
/* icu_76_godot::StringTrieBuilder::SplitBranchNode::markRightEdgesFirst(int) */

ulong __thiscall
icu_76_godot::StringTrieBuilder::SplitBranchNode::markRightEdgesFirst
          (SplitBranchNode *this,int param_1)
...
/* icu_76_godot::StringTrieBuilder::BranchHeadNode::markRightEdgesFirst(int) */

ulong __thiscall
icu_76_godot::StringTrieBuilder::BranchHeadNode::markRightEdgesFirst
          (BranchHeadNode *this,int param_1)
...
/* icu_76_godot::StringTrieBuilder::SplitBranchNode::write(icu_76_godot::StringTrieBuilder&) */

void __thiscall
icu_76_godot::StringTrieBuilder::SplitBranchNode::write
          (SplitBranchNode *this,StringTrieBuilder *param_1)
...
/* icu_76_godot::StringTrieBuilder::registerFinalValue(int, UErrorCode&) [clone .part.0] */

long * __thiscall
icu_76_godot::StringTrieBuilder::registerFinalValue
          (StringTrieBuilder *this,int param_1,UErrorCode *param_2)
...
LAB_00100346:
  local_58 = (undefined **)&DAT_00101f00;
...
bool __thiscall icu_76_godot::StringTrieBuilder::Node::operator==(Node *this,Node *param_1)
...
icu_76_godot::StringTrieBuilder::ListBranchNode::operator==(ListBranchNode *this,Node *param_1)

{
  ...
  if (((char)uVar1 != '\0') && (0 < *(int *)(this + 0x40))) {
    lVar2 = 0;
    do {
      if (((*(short *)(this + lVar2 + 0x58) != *(short *)(param_1 + lVar2 + 0x58)) ||
          (*(int *)(this + lVar2 * 2 + 0x44) != *(int *)(param_1 + lVar2 * 2 + 0x44))) ||
         (*(long *)(this + lVar2 * 4 + 0x18) != *(long *)(param_1 + lVar2 * 4 + 0x18))) {
        return 0;
      }
      lVar2 = lVar2 + 2;
...
/* icu_76_godot::StringTrieBuilder::ListBranchNode::write(icu_76_godot::StringTrieBuilder&) */

void __thiscall
icu_76_godot::StringTrieBuilder::ListBranchNode::write
          (ListBranchNode *this,StringTrieBuilder *param_1)

{
  ...
  do {
    plVar2 = *(long **)(this + lVar6 * 8 + 0x10);
    if (((plVar2 != (long *)0x0) && (iVar5 = *(int *)((long)plVar2 + 0xc), iVar5 < 0)) &&
       ((*(int *)(this + 0x10) < iVar5 || (iVar5 < iVar7)))) {
      (**(code **)(*plVar2 + 0x28))(plVar2,param_1);
    }
    lVar6 = lVar6 + -1;
  } while (0 < (int)lVar6);
  ...
  uVar4 = (**(code **)(*(long *)param_1 + 0x78))
                    (param_1,*(undefined2 *)(this + (long)iVar7 * 2 + 0x58));
...
bool __thiscall
icu_76_godot::StringTrieBuilder::FinalValueNode::operator==(FinalValueNode *this,Node *param_1)
...
bool __thiscall
icu_76_godot::StringTrieBuilder::ValueNode::operator==(ValueNode *this,Node *param_1)

{
  ...
  if (*(int *)(this + 8) == *(int *)(param_1 + 8)) {
    bVar3 = false;
    if ((*(Node *)(this + 0x10) == param_1[0x10]) &&
       (bVar3 = true, *(Node *)(this + 0x10) != (Node)0x0)) {
...
bool __thiscall
icu_76_godot::StringTrieBuilder::SplitBranchNode::operator==(SplitBranchNode *this,Node *param_1)

{
  ...
  bVar3 = false;
  if (((*(int *)(this + 8) == *(int *)(param_1 + 8)) &&
      (bVar3 = false, *(short *)(this + 0x14) == *(short *)(param_1 + 0x14))) &&
...
bool __thiscall
icu_76_godot::StringTrieBuilder::IntermediateValueNode::operator==
          (IntermediateValueNode *this,Node *param_1)

{
  ...
  if (((*(int *)(this + 8) == *(int *)(param_1 + 8)) && (*(Node *)(this + 0x10) == param_1[0x10]))
     && ((*(Node *)(this + 0x10) == (Node)0x0 || (*(int *)(this + 0x14) == *(int *)(param_1 + 0x14))
         ))) {
...
bool __thiscall
icu_76_godot::StringTrieBuilder::LinearMatchNode::operator==(LinearMatchNode *this,Node *param_1)
...
bool __thiscall
icu_76_godot::StringTrieBuilder::BranchHeadNode::operator==(BranchHeadNode *this,Node *param_1)
...
/* icu_76_godot::StringTrieBuilder::StringTrieBuilder() */

void __thiscall icu_76_godot::StringTrieBuilder::StringTrieBuilder(StringTrieBuilder *this)
...
/* icu_76_godot::StringTrieBuilder::createCompactBuilder(int, UErrorCode&) */

void __thiscall
icu_76_godot::StringTrieBuilder::createCompactBuilder
          (StringTrieBuilder *this,int param_1,UErrorCode *param_2)
...
/* icu_76_godot::StringTrieBuilder::deleteCompactBuilder() */

void __thiscall icu_76_godot::StringTrieBuilder::deleteCompactBuilder(StringTrieBuilder *this)
...
/* icu_76_godot::StringTrieBuilder::writeBranchSubNode(int, int, int, int) */

void __thiscall
icu_76_godot::StringTrieBuilder::writeBranchSubNode
          (StringTrieBuilder *this,int param_1,int param_2,int param_3,int param_4)
...
/* icu_76_godot::StringTrieBuilder::writeNode(int, int, int) */

void __thiscall
icu_76_godot::StringTrieBuilder::writeNode
          (StringTrieBuilder *this,int param_1,int param_2,int param_3)
...
/* icu_76_godot::StringTrieBuilder::makeBranchSubNode(int, int, int, int, UErrorCode&) */

long __thiscall
icu_76_godot::StringTrieBuilder::makeBranchSubNode
          (StringTrieBuilder *this,int param_1,int param_2,int param_3,int param_4,
          UErrorCode *param_5)
      ...
      if (pNVar8 != (Node *)0x0) {
        ...
        *(undefined4 *)(pNVar8 + 0x40) = 0;
        do {
          ...
          uVar14 = uVar5 - 1;
          if ((uVar14 == param_1) &&
             (iVar6 = (**(code **)(*(long *)this + 0x18))(this,uVar14), iVar6 == iVar3)) {
        ...
        if ((param_2 - 1U == uVar5) &&
           (iVar13 = (**(code **)(*(long *)this + 0x18))(this,uVar5), iVar13 == iVar3)) {
...
/* icu_76_godot::StringTrieBuilder::makeNode(int, int, int, UErrorCode&) */

undefined8 __thiscall
icu_76_godot::StringTrieBuilder::makeNode
          (StringTrieBuilder *this,int param_1,int param_2,int param_3,UErrorCode *param_4)
...
LAB_00101634:
  ...
  pNVar11 = (Node *)0x0;
LAB_0010166a:
  uVar10 = registerNode(this,pNVar11,param_4);
  return uVar10;
}



/* icu_76_godot::StringTrieBuilder::build(UStringTrieBuildOption, int, UErrorCode&) */

void __thiscall
icu_76_godot::StringTrieBuilder::build
          (StringTrieBuilder *this,int param_2,int param_3,UErrorCode *param_4)
...
/* icu_76_godot::StringTrieBuilder::registerFinalValue(int, UErrorCode&) */
...
/* icu_76_godot::StringTrieBuilder::hashNode(void const*) */

undefined4 icu_76_godot::StringTrieBuilder::hashNode(void *param_1)
...
/* icu_76_godot::StringTrieBuilder::equalNodes(void const*, void const*) */

void icu_76_godot::StringTrieBuilder::equalNodes(void *param_1,void *param_2)

{
                    /* WARNING: Load size is inaccurate */
                    /* WARNING: Could not recover jumptable at 0x00101947. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(*param_1 + 0x18))();
  return;
}
...
/* icu_76_godot::StringTrieBuilder::FinalValueNode::~FinalValueNode() */

void __thiscall
icu_76_godot::StringTrieBuilder::FinalValueNode::~FinalValueNode(FinalValueNode *this)
...
/* icu_76_godot::StringTrieBuilder::BranchHeadNode::~BranchHeadNode() */

void __thiscall
icu_76_godot::StringTrieBuilder::BranchHeadNode::~BranchHeadNode(BranchHeadNode *this)
...
/* icu_76_godot::StringTrieBuilder::IntermediateValueNode::~IntermediateValueNode() */
...
/* icu_76_godot::StringTrieBuilder::SplitBranchNode::~SplitBranchNode() */

void __thiscall
icu_76_godot::StringTrieBuilder::SplitBranchNode::~SplitBranchNode(SplitBranchNode *this)
...
/* icu_76_godot::StringTrieBuilder::ListBranchNode::~ListBranchNode() */

void __thiscall
icu_76_godot::StringTrieBuilder::ListBranchNode::~ListBranchNode(ListBranchNode *this)

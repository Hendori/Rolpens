...
/* (anonymous namespace)::_addVariantToList((anonymous namespace)::VariantListEntry**,
   icu_76_godot::LocalPointer<(anonymous namespace)::VariantListEntry>) */

undefined8 (anonymous_namespace)::_addVariantToList(long *param_1,long *param_2)
...
/* (anonymous namespace)::_addAttributeToList((anonymous namespace)::AttributeListEntry**,
   (anonymous namespace)::AttributeListEntry*) */

undefined8
(anonymous_namespace)::_addAttributeToList(AttributeListEntry **param_1,AttributeListEntry *param_2)
...
/* (anonymous namespace)::_addExtensionToList((anonymous namespace)::ExtensionListEntry**,
   (anonymous namespace)::ExtensionListEntry*, bool) */

bool (anonymous_namespace)::_addExtensionToList
               (ExtensionListEntry **param_1,ExtensionListEntry *param_2,bool param_3)
  ...
  if (param_3) {
    do {
      ...
      if (iVar9 == 1 && iVar3 == 1) {
        ...
        if ((iVar3 != 0) && ((iVar3 = strcmp(__s1,"attribute"), iVar4 < 0 || (iVar3 == 0))))
        goto LAB_001001f0;
      }
...
joined_r0x0010017b:
    if (-1 < iVar3) {
      ...
      if (pEVar10 == (ExtensionListEntry *)0x0) {
LAB_00100310:
        *(ExtensionListEntry **)(pEVar8 + 0x10) = param_2;
        *(undefined8 *)(param_2 + 0x10) = 0;
        return true;
      }
      goto LAB_00100190;
...
LAB_001001f0:
  if (pEVar7 == (ExtensionListEntry *)0x0) {
    *param_1 = param_2;
  }
  else {
...
/* (anonymous namespace)::_isExtensionSingleton(char const*, int) */

bool (anonymous_namespace)::_isExtensionSingleton(char *param_1,int param_2)
...
/* (anonymous namespace)::ultag_close((anonymous namespace)::ULanguageTag*) */

void __thiscall
(anonymous_namespace)::ultag_close(_anonymous_namespace_ *this,ULanguageTag *param_1)
...
ulong (anonymous_namespace)::_isAlphaNumericStringLimitedLength
...
/* (anonymous namespace)::_isVariantSubtag(char const*, int) */

undefined4 (anonymous_namespace)::_isVariantSubtag(char *param_1,int param_2)
...
/* (anonymous namespace)::_isPrivateuseValueSubtag(char const*, int) */

void (anonymous_namespace)::_isPrivateuseValueSubtag(char *param_1,int param_2)
...
/* ultag_isLanguageSubtag_76_godot(char const*, int) */

undefined8 ultag_isLanguageSubtag_76_godot(char *param_1,int param_2)
...
/* ultag_isScriptSubtag_76_godot(char const*, int) */

undefined8 ultag_isScriptSubtag_76_godot(char *param_1,int param_2)
...
/* ultag_isRegionSubtag_76_godot(char const*, int) */

bool ultag_isRegionSubtag_76_godot(char *param_1,int param_2)
...
/* (anonymous namespace)::_isTransformedExtensionSubtag(int&, char const*, int) */

undefined8 __thiscall
(anonymous_namespace)::_isTransformedExtensionSubtag
          (_anonymous_namespace_ *this,int *param_1,char *param_2,int param_3)
...
/* ultag_isVariantSubtags_76_godot(char const*, int) */

undefined8 ultag_isVariantSubtags_76_godot(char *param_1,int param_2)
...
/* ultag_isExtensionSubtags_76_godot(char const*, int) */

undefined8 ultag_isExtensionSubtags_76_godot(char *param_1,int param_2)
  ...
  if (0 < param_2) {
    do {
      while (iVar4 = (int)pcVar5, *pcVar5 == '-') {
        ...
        cVar1 = (anonymous_namespace)::_isAlphaNumericStringLimitedLength
                          (pcVar6,iVar4 - (int)pcVar6,2,in_ECX);
        if (cVar1 == '\0') {
          return 0;
        }
        pcVar5 = pcVar5 + 1;
...
LAB_0010097b:
    if (pcVar6 != (char *)0x0) {
      uVar3 = (anonymous_namespace)::_isAlphaNumericStringLimitedLength
                        (pcVar6,(iVar4 + 1) - (int)pcVar6,2,in_ECX);
      return uVar3;
    }
  }
  return 0;
...
/* ultag_isPrivateuseValueSubtags_76_godot(char const*, int) */

undefined8 ultag_isPrivateuseValueSubtags_76_godot(char *param_1,int param_2)
  ...
  if (0 < param_2) {
    do {
      while (iVar4 = (int)pcVar5, *pcVar5 == '-') {
        ...
        cVar1 = (anonymous_namespace)::_isAlphaNumericStringLimitedLength
                          (pcVar6,iVar4 - (int)pcVar6,1,in_ECX);
        if (cVar1 == '\0') {
          return 0;
        }
        pcVar5 = pcVar5 + 1;
...
LAB_00100a0b:
    if (pcVar6 != (char *)0x0) {
      uVar3 = (anonymous_namespace)::_isAlphaNumericStringLimitedLength
                        (pcVar6,(iVar4 + 1) - (int)pcVar6,1,in_ECX);
      return uVar3;
    }
  }
  return 0;
...
/* ultag_isUnicodeLocaleAttribute_76_godot(char const*, int) */

void ultag_isUnicodeLocaleAttribute_76_godot(char *param_1,int param_2)
...
/* ultag_isUnicodeLocaleAttributes_76_godot(char const*, int) */

undefined8 ultag_isUnicodeLocaleAttributes_76_godot(char *param_1,int param_2)
  ...
  if (0 < param_2) {
    do {
      while (iVar4 = (int)pcVar5, *pcVar5 == '-') {
        ...
        cVar1 = (anonymous_namespace)::_isAlphaNumericStringLimitedLength
                          (pcVar6,iVar4 - (int)pcVar6,3,in_ECX);
        if (cVar1 == '\0') {
          return 0;
        }
        pcVar5 = pcVar5 + 1;
...
LAB_00100aab:
    if (pcVar6 != (char *)0x0) {
      uVar3 = (anonymous_namespace)::_isAlphaNumericStringLimitedLength
                        (pcVar6,(iVar4 + 1) - (int)pcVar6,3,in_ECX);
      return uVar3;
    }
  }
  return 0;
...
/* ultag_isUnicodeLocaleKey_76_godot(char const*, int) */

bool ultag_isUnicodeLocaleKey_76_godot(char *param_1,int param_2)
...
/* (anonymous namespace)::_isUnicodeExtensionSubtag(int&, char const*, int) */

undefined8 __thiscall
(anonymous_namespace)::_isUnicodeExtensionSubtag
          (_anonymous_namespace_ *this,int *param_1,char *param_2,int param_3)
...
/* ulocimp_forLanguageTag_76_godot(char const*, int, icu_76_godot::ByteSink&, int*, UErrorCode&)
   [clone .part.0] */

void ulocimp_forLanguageTag_76_godot
               (char *param_1,int param_2,ByteSink *param_3,int *param_4,UErrorCode *param_5)

{
  ...
  if (*(int *)param_5 < 1) {
    ...
    if (pUVar15 != (ULanguageTag *)0x0) {
      ...
      *(undefined8 *)(local_278 + 0x10) = 0;
      *(undefined8 *)(local_278 + 0x18) = 0;
      *(undefined8 *)(local_278 + 0x20) = 0;
      ...
      *(ULanguageTag **)local_278 = pUVar15;
      if (1 < param_2) {
        ...
        while( true ) {
          ...
          iVar13 = param_2;
          if ((iVar12 <= param_2) &&
             (((param_2 <= iVar12 || (pUVar15[iVar12] == (ULanguageTag)0x2d)) &&
              (iVar11 = uprv_strnicmp_76_godot
                                  ((&(anonymous_namespace)::LEGACY)[lVar48],pUVar15,
                                   uVar16 & 0xffffffff), iVar11 == 0)))) {
...
LAB_00100d2c:
        pUVar40 = pUVar15;
        iVar12 = uprv_strnicmp_76_godot
                           ((&(anonymous_namespace)::REDUNDANT)[lVar48],pUVar15,sVar49 & 0xffffffff)
        ;
        if (iVar12 != 0) {
LAB_00100d58:
          lVar48 = lVar48 + 2;
        ...
        if (((ULanguageTag)*pcVar41 != (ULanguageTag)0x0) &&
           ((ULanguageTag)*pcVar41 != (ULanguageTag)0x2d)) goto LAB_00100d58;
...
LAB_00100dc6:
        ...
        if ((bVar52) &&
           ...
           cVar6 = ultag_isLanguageSubtag_76_godot((char *)pUVar40,iVar12), cVar6 != '\0')) {
...
LAB_00100dda:
        if (((bVar38 & 4) != 0) &&
           (pcVar41 = (char *)pUVar42, cVar6 = ultag_isScriptSubtag_76_godot((char *)pUVar40,iVar12)
           , cVar6 != '\0')) {
          *pUVar45 = (ULanguageTag)0x0;
...
LAB_001023b8:
        ...
        if (((bVar38 & 8) != 0) &&
           (pcVar41 = (char *)pUVar42, cVar6 = ultag_isRegionSubtag_76_godot((char *)pUVar40,iVar12)
           , cVar6 != '\0')) {
          *pUVar45 = (ULanguageTag)0x0;
...
LAB_001012a1:
        ...
        if (((bVar38 & 0x10) == 0) ||
           ((pcVar41 = (char *)pUVar42,
            cVar6 = (anonymous_namespace)::_isVariantSubtag((char *)pUVar40,iVar12), cVar6 == '\0'
            && ((!bVar30 ||
                (pcVar41 = (char *)pUVar42,
                cVar6 = (anonymous_namespace)::_isAlphaNumericStringLimitedLength
                                  ((char *)pUVar40,iVar12,1,(int)p_Var29), cVar6 == '\0')))))) {
          pUVar36 = pUVar15;
          if (((bVar38 & 0x20) != 0) &&
             (pcVar41 = (char *)pUVar42,
             cVar6 = (anonymous_namespace)::_isExtensionSingleton((char *)pUVar40,iVar12),
             cVar6 != '\0')) {
            pUVar42 = pUVar15;
...
LAB_00102f2a:
              ...
              *(undefined8 *)(local_270 + 8) = uVar17;
              ...
              cVar6 = (anonymous_namespace)::_addExtensionToList
                                ((ExtensionListEntry **)(local_278 + 0x40),
                                 (ExtensionListEntry *)local_270,false);
              pUVar42 = local_250;
              if (cVar6 == '\0') {
LAB_00102364:
                icu_76_godot::UMemory::operator_delete(local_270,pcVar41);
            ...
            pUVar15 = local_250;
            local_270 = (UMemory *)
                        icu_76_godot::UMemory::operator_new((UMemory *)0x18,(ulong)pcVar41);
            ...
            else if ((local_270 != (UMemory *)0x0) &&
                    (icu_76_godot::UMemory::operator_delete(local_270,param_5), *(int *)param_5 < 1)
                    ) {
              ulocimp_forLanguageTag_76_godot
                        ((char *)local_270,(int)pUVar42,extraout_RDX,(int *)p_Var29,pUVar43);
              return;
            }
          ...
          if (((bVar38 & 0x40) == 0) ||
             (cVar6 = (anonymous_namespace)::_isAlphaNumericStringLimitedLength
                                ((char *)pUVar40,iVar12,2,(int)p_Var29), pcVar41 = (char *)pUVar42,
             cVar6 == '\0')) {
            if ((bVar38 & 0x80) != 0) {
...
LAB_00100ee7:
                    ...
                    cVar6 = (anonymous_namespace)::_isAlphaNumericStringLimitedLength
                                      ((char *)pUVar15,(int)pUVar42,1,(int)p_Var29);
                    if ((cVar6 == '\0') ||
                       (pUVar36 = pUVar45, pUVar15 = pUVar40, pUVar40 == (ULanguageTag *)0x0)) {
                      pcVar41 = (char *)pUVar42;
        ...
        pUVar23 = (UMemory *)
                  icu_76_godot::UMemory::operator_new((UMemory *)&DAT_00000010,(ulong)pcVar41);
...
LAB_00101ed0:
        if (0 < *(int *)param_5) goto LAB_00101de7;
...
LAB_00102326:
    *param_4 = local_238 + (iVar13 - (int)*(undefined8 *)local_278);
    pcVar41 = (char *)local_278;
    if (*(int *)param_5 < 1) {
      pEVar22 = *(ExtensionListEntry **)(local_278 + 0x10);
LAB_0010234f:
      bVar52 = *(long *)(local_278 + 0x10) != 0;
LAB_00100f55:
      if (((*(long *)(local_278 + 0x18) == 0) && (*(long *)(local_278 + 0x20) == 0)) && (!bVar52)) {
...
LAB_001013dd:
        if (*(long *)(local_278 + 0x40) == 0) {
LAB_00101124:
          if (**(char **)(local_278 + 0x48) == '\0') goto LAB_00101140;
        }
        else if (bVar52) {
          pcVar41 = (char *)&(anonymous_namespace)::LANG_UND;
...
LAB_001010c8:
            do {
              ...
              puVar5 = puVar50;
                    ...
                    (puVar18 = (undefined8 *)puVar50[1], puVar5 = puVar18, puVar35 = puVar50,
...
LAB_00102746:
              ...
              *(char **)((ExtensionListEntry *)pcVar41 + 8) = pcVar34;
              cVar6 = (anonymous_namespace)::_addExtensionToList
                                (&local_208,(ExtensionListEntry *)pcVar41,false);
              if (cVar6 == '\0') {
LAB_00102af2:
...
LAB_001014d8:
          pEVar21 = *(ExtensionListEntry **)(pcVar34 + 8);
          pEVar22 = pEVar21;
          iVar11 = iVar13;
...
LAB_001015a0:
              ...
              iVar46 = local_1a8 * 2;
              if ((0 < iVar46) &&
                 (pEVar22 = (ExtensionListEntry *)uprv_malloc_76_godot((long)iVar46 << 3),
                 pEVar22 != (ExtensionListEntry *)0x0)) {
...
LAB_001015f5:
            ...
            *(ExtensionListEntry **)((ExtensionListEntry *)pcVar41 + 8) = pEVar21;
            cVar6 = (anonymous_namespace)::_addExtensionToList
                              ((ExtensionListEntry **)&local_208,(ExtensionListEntry *)pcVar41,false
                              );
            if (cVar6 != '\0') {
              do {
                iVar13 = iVar11 + 1;
...
LAB_001018c1:
                        ...
                        pEVar21 = (ExtensionListEntry *)
                                  __memcpy_chk(pEVar21,local_90,(long)iVar13 << 3,lVar48);
joined_r0x001018fb:
                        if (local_84 != '\0') {
...
LAB_00101919:
                  local_260 = (ULanguageTag *)
                              icu_76_godot::UMemory::operator_new
                                        ((UMemory *)&DAT_00000010,(ulong)pcVar41);
                  iVar13 = local_e8;
                  if (local_260 == (ULanguageTag *)0x0) {
...
LAB_001019db:
                  plVar20 = (long *)icu_76_godot::UMemory::operator_new
                                              ((UMemory *)0x40,(ulong)pcVar41);
                  if (plVar20 == (long *)0x0) {
                  ...
                  *(long *)local_260 = *plVar20;
                  (anonymous_namespace)::_addAttributeToList
                            (&local_1f8,(AttributeListEntry *)local_260);
                  if (*pEVar24 == (ExtensionListEntry)0x0) break;
                  pEVar22 = pEVar24 + 1;
                }
                pEVar22 = (ExtensionListEntry *)0x0;
                  ...
                  if (0 < local_98) {
                    do {
                      if (*(UMemory **)(local_90 + lVar48 * 8) != (UMemory *)0x0) {
                        icu_76_godot::UMemory::operator_delete
                                  (*(UMemory **)(local_90 + lVar48 * 8),pcVar41);
                      }
                      lVar48 = lVar48 + 1;
...
LAB_0010257a:
                    ...
                    do {
                      ...
                      bVar3 = bVar38;
LAB_00102591:
                      if ((int)pEVar28 != 2) goto LAB_00102af2;
                      pcVar41 = (char *)0x2;
...
LAB_00102ebb:
                            ...
                            pEVar21 = (ExtensionListEntry *)
                                      __memcpy_chk(pEVar21,local_150,lVar32 << 3,lVar48);
                          }
                          else {
                            iVar46 = local_148 * 2;
                        ...
                        if (plVar20 != (long *)0x0) {
                          ...
                          *(undefined2 *)((long)plVar20 + 0xc) = 0;
                          icu_76_godot::CharString::append
                                    ((char *)plVar20,(int)pEVar25,(UErrorCode *)0x2);
...
LAB_00102f8d:
                              ...
                              pcVar41 = (char *)local_150;
                              pEVar26 = (ExtensionListEntry *)
                                        __memcpy_chk(pEVar26,local_150,lVar32 << 3,lVar48);
                            }
                            else {
                              iVar46 = local_148 * 2;
                              if (iVar46 < 1) goto LAB_00102746;
                          ...
                          *(undefined2 *)((long)plVar20 + 0xc) = 0;
                          icu_76_godot::CharString::append
                                    ((char *)plVar20,(int)local_248,(UErrorCode *)(ulong)uVar47);
                          lVar48 = (long)local_158;
                          local_158 = local_158 + 1;
                          *(long **)(local_150 + lVar48 * 8) = plVar20;
                      ...
                      if ((((cVar6 == '\0') && (*pEVar21 == (ExtensionListEntry)0x76)) &&
                          (pEVar21[1] == (ExtensionListEntry)0x61)) &&
                         (pEVar21[2] == (ExtensionListEntry)0x0)) {
                        pcVar41 = "posix";
...
LAB_0010277c:
                            ...
                            pcVar41 = (char *)local_1b0;
                            pEVar25 = (ExtensionListEntry *)
                                      __memcpy_chk(pEVar25,local_1b0,lVar44 << 3);
                          }
                          else {
                            iVar46 = local_1a8 * 2;
                            if ((iVar46 < 1) ||
                               (pEVar25 = (ExtensionListEntry *)
                                          uprv_malloc_76_godot((long)iVar46 << 3),
                               pEVar25 == (ExtensionListEntry *)0x0)) goto LAB_00102746;
                            lVar48 = (long)iVar46;
                        ...
                        pcVar41 = (char *)icu_76_godot::UMemory::operator_new
                                                    ((UMemory *)0x18,(ulong)pcVar41);
                        if ((ExtensionListEntry *)pcVar41 == (ExtensionListEntry *)0x0)
                        goto LAB_00103126;
                        *(undefined8 *)((ExtensionListEntry *)pcVar41 + 0x10) = 0;
                        lVar48 = (long)local_1b8;
                        ...
                        *(ExtensionListEntry **)((ExtensionListEntry *)pcVar41 + 8) = pEVar26;
                        (anonymous_namespace)::_addExtensionToList
                                  (&local_200,(ExtensionListEntry *)pcVar41,false);
                        bVar38 = bVar3;
                      }
                      pEVar21 = (ExtensionListEntry *)0x0;
...
LAB_001026a6:
                    if (EVar10 == (ExtensionListEntry)0x2d) {
                      pEVar21 = (ExtensionListEntry *)0x0;
                      pEVar22 = pEVar26;
                    }
                    else {
                      ...
                      pEVar21 = (ExtensionListEntry *)
                                (ulong)(uint)((1 - (int)(pEVar26 + 1)) + (int)pEVar22);
                    }
                    uVar33 = (uint)pEVar21;
...
LAB_00102b2d:
                        ...
                        iVar46 = local_148 * 2;
                        if ((0 < iVar46) &&
                           (pEVar24 = (ExtensionListEntry *)uprv_malloc_76_godot((long)iVar46 << 3),
                           pEVar24 != (ExtensionListEntry *)0x0)) {
                    ...
                    *(long **)(local_150 + lVar48 * 8) = plVar20;
                    ...
                    do {
                      ...
                      icu_76_godot::StringPiece::StringPiece
                                ((StringPiece *)&local_1d8,*(char **)pAVar39);
                      icu_76_godot::CharString::append
                                ((char *)plVar20,(int)local_1d8,(UErrorCode *)(ulong)local_1d0);
                      pAVar39 = pAVar1;
...
LAB_00101530:
    ...
    if ((local_248 != (ULanguageTag *)0x0) && (local_250 != (ULanguageTag *)0x0)) {
      ...
      *(undefined8 *)(local_270 + 8) = uVar17;
      pcVar41 = (char *)local_270;
      cVar6 = (anonymous_namespace)::_addExtensionToList
                        ((ExtensionListEntry **)(local_278 + 0x40),(ExtensionListEntry *)local_270,
                         false);
      pUVar36 = local_250;
...
/* ultag_isUnicodeLocaleType_76_godot(char const*, int) */

undefined8 ultag_isUnicodeLocaleType_76_godot(char *param_1,int param_2)
...
/* ultag_getTKeyStart_76_godot(char const*) */

char * ultag_getTKeyStart_76_godot(char *param_1)

{
  ...
  while (pcVar2 = strchr(param_1,0x2d), pcVar2 != (char *)0x0) {
    ...
    if (((iVar4 == 2) && (cVar1 = uprv_isASCIILetter_76_godot((int)*param_1), cVar1 != '\0')) &&
       ((byte)(param_1[1] - 0x30U) < 10)) goto LAB_001032ca;
    param_1 = pcVar2 + 1;
  }
  sVar3 = strlen(param_1);
  pcVar2 = (char *)0x0;
  if ((((int)sVar3 == 2) && (cVar1 = uprv_isASCIILetter_76_godot((int)*param_1), cVar1 != '\0')) &&
     ((byte)(param_1[1] - 0x30U) < 10)) {
LAB_001032ca:
    pcVar2 = param_1;
  }
  return pcVar2;
...
/* ultag_isTransformedExtensionSubtags_76_godot(char const*, int) */

uint ultag_isTransformedExtensionSubtags_76_godot(char *param_1,int param_2)
  ...
  if (param_2 < 1) {
    ...
    do {
      while (piVar7 = piVar2, *(char *)((long)piVar7 + -1) == '-') {
        cVar3 = (anonymous_namespace)::_isTransformedExtensionSubtag
                          ((_anonymous_namespace_ *)&local_34,(int *)param_1,pcVar6,in_ECX);
...
/* ultag_isUnicodeExtensionSubtags_76_godot(char const*, int) */

uint ultag_isUnicodeExtensionSubtags_76_godot(char *param_1,int param_2)

{
  ...
  if (param_2 < 1) {
    ...
    do {
      while (piVar7 = piVar2, *(char *)((long)piVar7 + -1) == '-') {
        cVar3 = (anonymous_namespace)::_isUnicodeExtensionSubtag
                          ((_anonymous_namespace_ *)&local_34,(int *)param_1,pcVar6,in_ECX);
...
/* ulocimp_toLanguageTag_76_godot(char const*, icu_76_godot::ByteSink&, bool, UErrorCode&) */

void ulocimp_toLanguageTag_76_godot
...

{
  ...
  if (local_2d0 < 1) {
    ...
    if (pEVar11 == local_278) {
      ...
      if ((local_2d0 < 1) && (iVar8 = uenum_count_76_godot(lVar12,&local_2d0), iVar8 == 1)) {
        ...
        if (((int)local_298 == 1) && (*pEVar11 == (ExtensionListEntry)0x78)) {
          ...
          if (local_2d0 < 1) {
            ...
            while( true ) {
              ...
              if (*pcVar32 == '-') {
                if ((pcVar31 == (char *)0x0) ||
                   (cVar23 = (anonymous_namespace)::_isPrivateuseValueSubtag
                                       (pcVar31,(int)pcVar32 - (int)pcVar31), cVar23 == '\0'))
                goto LAB_0010547d;
                pcVar31 = (char *)0x0;
              }
          ...
          if (cVar23 != '\0') {
            ...
            do {
              ...
              if (iVar10 == 0) {
                ...
                (**(code **)(pEVar20 + 0x10))
                          (param_2,(anonymous_namespace)::DEPRECATEDLANGS + (long)(iVar9 + 1) * 4,
                           sVar14 & 0xffffffff);
                goto LAB_001035ef;
              }
              iVar9 = iVar9 + 2;
            ...
            if (local_60 != 0) {
              ...
              do {
                ...
                if (iVar9 == 0) {
                  ...
                  pEVar20 = *(ExtensionListEntry **)param_2;
                  (**(code **)(pEVar20 + 0x10))
                            (param_2,(anonymous_namespace)::DEPRECATEDREGIONS +
                                     (long)(iVar8 + 1) * 3,sVar14 & 0xffffffff);
                  goto LAB_0010369f;
                }
                iVar8 = iVar8 + 2;
                puVar27 = puVar27 + 6;
...
LAB_00103e10:
    ...
    if (cVar6 == '\0') {
      ...
      if ((iVar8 != 0) || (local_60 != 5)) {
        pUVar16 = (UMemory *)
                  icu_76_godot::UMemory::operator_new((UMemory *)&DAT_00000010,(ulong)pcVar29);
...
joined_r0x0010445c:
    while (pUVar16 != (UMemory *)0x0) {
LAB_00104468:
      pUVar1 = *(UMemory **)(pUVar16 + 8);
      icu_76_godot::UMemory::operator_delete(pUVar16,pcVar29);
      pUVar16 = pUVar1;
    }
  }
...
LAB_001049b2:
                        ...
                        pEVar17 = (ExtensionListEntry *)
                                  __memcpy_chk(pEVar17,local_1b0,(long)iVar8 << 3);
LAB_001049e4:
                        if (local_1a4 != '\0') {
                          uprv_free_76_godot(local_1b0);
                        }
...
LAB_00104a0a:
                  pAVar18 = (AttributeListEntry *)
                            icu_76_godot::UMemory::operator_new
                                      ((UMemory *)&DAT_00000010,(ulong)pcVar29);
                  iVar8 = local_e8;
...
LAB_00104acc:
                  plVar19 = (long *)icu_76_godot::UMemory::operator_new
                                              ((UMemory *)0x40,(ulong)pcVar29);
                  if (plVar19 == (long *)0x0) {
                  ...
                  *(undefined4 *)(plVar19 + 7) = 0;
                  ...
                  icu_76_godot::CharString::append
                            ((char *)plVar19,(int)local_1f8,(UErrorCode *)(ulong)local_1c0);
                  lVar25 = (long)local_f8;
                  local_f8 = local_f8 + 1;
...
LAB_00104199:
                  ...
                  pEVar17 = (ExtensionListEntry *)pcVar29;
                  if (0 < iVar9) {
                    pEVar13 = (ExtensionListEntry *)
                              uprv_malloc_76_godot((ExtensionListEntry *)((long)iVar9 << 3));
                    pEVar22 = pEVar20;
                    pEVar17 = (ExtensionListEntry *)pcVar29;
                    if (pEVar13 != (ExtensionListEntry *)0x0) {
                      pEVar21 = (ExtensionListEntry *)((long)iVar9 << 3);
...
LAB_001041bf:
                pEVar17 = (ExtensionListEntry *)
                          icu_76_godot::UMemory::operator_new((UMemory *)0x18,(ulong)pcVar29);
                if (pEVar17 != (ExtensionListEntry *)0x0) {
                  ...
                  if (0 < (int)uVar33) {
                    do {
                      if (*pEVar35 == (ExtensionListEntry)0x2d) {
                        ...
                        cVar5 = (anonymous_namespace)::_isAlphaNumericStringLimitedLength
                                          ((char *)pEVar15,uVar28,1,(int)pEVar20);
                    ...
                    if (pEVar15 != (ExtensionListEntry *)0x0) {
                      iVar8 = 1;
LAB_00104f73:
                      uVar33 = (int)pEVar35 - (int)pEVar15;
                      pEVar17 = (ExtensionListEntry *)(ulong)uVar33;
                      cVar5 = (anonymous_namespace)::_isAlphaNumericStringLimitedLength
                                        ((char *)pEVar15,uVar33,iVar8,(int)pEVar20);
                      iVar8 = local_88;
...
LAB_00105117:
                              ...
                              pEVar17 = local_90;
                              pEVar15 = (ExtensionListEntry *)
                                        __memcpy_chk(pEVar15,local_90,(long)iVar10 << 3);
LAB_00104fe8:
                              if (local_84 != '\0') {
                                uprv_free_76_godot(local_90);
                              }
...
LAB_0010500e:
                          ...
                          if (plVar19 != (long *)0x0) {
                            ...
                            *(undefined2 *)((long)plVar19 + 0xc) = 0;
                            icu_76_godot::CharString::append
                                      ((char *)plVar19,(int)pcVar29,(UErrorCode *)(ulong)uVar4);
                    ...
                    if (0 < (int)uVar33) {
                      do {
                        if (*pEVar35 == (ExtensionListEntry)0x2d) {
                          ...
                          pEVar17 = (ExtensionListEntry *)(ulong)uVar28;
                          cVar5 = (anonymous_namespace)::_isAlphaNumericStringLimitedLength
                                            ((char *)pEVar15,uVar28,2,(int)pEVar20);
                          if (cVar5 == '\0') goto joined_r0x0010427d;
                          pEVar15 = (ExtensionListEntry *)0x0;
                        }
                        else if (pEVar15 == (ExtensionListEntry *)0x0) {
...
LAB_00104855:
                ...
                ulocimp_toBcpTypeWithFallback_76_godot
                          ((UErrorCode *)&local_298,pcVar29,pEVar13,pEVar20,local_238);
                iVar8 = local_88;
...
LAB_001051ed:
                ...
                *(undefined4 *)(plVar19 + 7) = 0;
                pcVar29 = (char *)local_238;
                icu_76_godot::CharString::append
                          ((char *)plVar19,(int)local_238,(UErrorCode *)(ulong)local_200);
                lVar25 = (long)local_98;
                local_98 = local_98 + 1;
                *(long **)(local_90 + lVar25 * 8) = plVar19;
                iVar8 = local_2cc;
...
LAB_0010422d:
        ...
        if (cVar23 == '\0') {
LAB_001038de:
          if ((*(int *)param_4 < 1) && (local_2c8 != (ExtensionListEntry *)0x0)) {
            local_318 = "attribute";
            bVar2 = false;
            pEVar11 = local_2c8;
            do {
              pcVar31 = *(char **)pEVar11;
              if ((!bVar2) && (sVar14 = strlen(pcVar31), 1 < sVar14)) {
              ...
              pAVar18 = local_2c0;
              if (iVar8 == 0) {
                for (; pAVar18 != (AttributeListEntry *)0x0;
                    pAVar18 = *(AttributeListEntry **)(pAVar18 + 8)) {
                  (**(code **)(*(long *)param_2 + 0x10))(param_2,&_LC6,1);
                  pcVar29 = *(char **)pAVar18;
                  sVar14 = strlen(pcVar29);
                  pEVar20 = *(ExtensionListEntry **)param_2;
...
LAB_0010452b:
            ...
            iVar9 = local_148 * 2;
            if ((0 < iVar9) &&
               (pEVar11 = (ExtensionListEntry *)uprv_malloc_76_godot((long)iVar9 * 8),
               pEVar11 != (ExtensionListEntry *)0x0)) {
...
LAB_00104580:
          pcVar29 = (char *)icu_76_godot::UMemory::operator_new((UMemory *)0x18,(ulong)pcVar29);
          if ((ExtensionListEntry *)pcVar29 != (ExtensionListEntry *)0x0) {
            ...
            *(char **)((ExtensionListEntry *)pcVar29 + 8) = "posix";
            (anonymous_namespace)::_addExtensionToList
                      (&local_2c8,(ExtensionListEntry *)pcVar29,true);
            goto LAB_001038de;
          }
          lVar25 = (long)local_158;
          pEVar20 = (ExtensionListEntry *)0x0;
...
LAB_00103beb:
                  ...
                  if (local_339 == '\0') {
                    ...
                    (**(code **)(*(long *)param_2 + 0x10))
                              (param_2,&(anonymous_namespace)::PRIVATEUSE_KEY,1);
                    (**(code **)(*(long *)param_2 + 0x10))(param_2,&_LC6,1);
...
undefined4
uloc_toLanguageTag_76_godot
          (char *param_1,char *param_2,int param_3,char param_4,UErrorCode *param_5)
...
undefined4
uloc_forLanguageTag_76_godot
          (char *param_1,char *param_2,int param_3,int *param_4,UErrorCode *param_5)
...
/* ulocimp_toLanguageTag_76_godot(char const*, bool, UErrorCode&) */

char * ulocimp_toLanguageTag_76_godot(char *param_1,bool param_2,UErrorCode *param_3)

{
  ...
  if (*(int *)in_RCX < 1) {
    ...
    ulocimp_toLanguageTag_76_godot
              ((char *)CONCAT71(in_register_00000031,param_2),(ByteSink *)aCStack_98,
               SUB81(param_3,0),in_RCX);
...
/* ulocimp_forLanguageTag_76_godot(char const*, int, int*, UErrorCode&) */

char * ulocimp_forLanguageTag_76_godot(char *param_1,int param_2,int *param_3,UErrorCode *param_4)

{
  ...
  if (*(int *)in_R8 < 1) {
    ...
    if (*(int *)in_R8 < 1) {
      ulocimp_forLanguageTag_76_godot
                ((char *)CONCAT44(in_register_00000034,param_2),(int)param_3,(ByteSink *)local_98,
                 (int *)param_4,in_R8);
    }
    icu_76_godot::CharString::CharString((CharString *)param_1,(CharString *)&local_88);

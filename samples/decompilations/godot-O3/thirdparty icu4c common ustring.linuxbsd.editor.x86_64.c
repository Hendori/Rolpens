...
void u_memset_76_godot(undefined2 *param_1,undefined2 param_2,int param_3)

{
  ...
  if ((0 < param_3) && (puVar1 = param_1 + param_3, param_1 < puVar1)) {
    *param_1 = param_2;
    ...
    puVar2 = param_1 + 1;
    if ((~(ulong)param_1 + (long)puVar1 >> 1 & 1) != 0) {
      puVar2 = param_1 + 2;
      param_1[1] = param_2;
      if (puVar1 <= puVar2) {
        return;
  ...
  if ((iVar1 < param_3) && (-1 < iVar1)) {
    *param_2 = iVar1 + 1;
    ...
    if (uVar3 == 0x75) {
      ...
      if (param_3 <= *param_2) goto LAB_00101be0;
    ...
    if (iVar9 < param_3) {
      do {
        ...
        uVar8 = (uint)uVar3;
        if (sVar7 == 3) {
          if (7 < (ushort)(uVar3 - 0x30)) goto LAB_00101ac0;
LAB_00101a64:
          uVar5 = uVar8 - 0x30;
        }
        else {
          if ((ushort)(uVar3 - 0x30) < 10) goto LAB_00101a64;
          if ((ushort)(uVar3 - 0x41) < 6) {
            uVar5 = uVar8 - 0x37;
          }
          else {
            if (5 < (ushort)(uVar3 - 0x61)) goto LAB_00101ac0;
            uVar5 = uVar8 - 0x57;
          }
        }
        bVar10 = bVar10 + 1;
        ...
        iVar9 = *param_2 + 1;
        *param_2 = iVar9;
        if ((param_3 <= iVar9) || (local_4f <= (char)bVar10)) goto LAB_00101ac0;
      } while( true );
    }
    if ((local_4d <= bVar10) && (!bVar2)) goto LAB_00101b08;
  }
LAB_00101be0:
  uVar11 = 0xffffffff;
  *param_2 = iVar1;
...
LAB_00101ac0:
  if ((char)local_4d <= (char)bVar10) {
    if (bVar2) {
      if (uVar8 != 0x7d) goto LAB_00101be0;
      *param_2 = *param_2 + 1;
    }
    if (uVar11 < 0x110000) {
      iVar1 = *param_2;
      if ((iVar1 < param_3) && ((uVar11 & 0xfffffc00) == 0xd800)) {
        ...
        uVar8 = (uint)uVar3;
        if (uVar3 == 0x5c) {
          if (param_3 <= iVar1 + 1) goto LAB_00101b08;
...
LAB_00101e39:
    ...
    if (pcVar7 != __s) {
      ...
      uVar4 = uVar8 + iVar2;
      uVar6 = (ulong)uVar4;
      if (param_2 == (undefined2 *)0x0) goto LAB_00101e88;
      uVar5 = param_3 - uVar8;
      if ((int)uVar5 < 0) {
        uVar5 = 0;
      }

...
undefined8 cid_driver_init(long param_1)
...
int cid_compute_fd_and_offsets
              (long param_1,int param_2,ulong *param_3,ulong *param_4,ulong *param_5)

{
  ...
  iVar5 = FT_Stream_Seek(lVar4,*(long *)(param_1 + 0x220) + *(long *)(param_1 + 0x248) +
                               (ulong)(uint)(param_2 *
                                            (*(int *)(param_1 + 0x22c) + *(int *)(param_1 + 0x228)))
                        );
  if (iVar5 == 0) {
    ...
    if (iVar5 == 0) {
      ...
      if (((*(uint *)(param_1 + 0x238) <= uVar8) || (*(ulong *)(lVar4 + 8) < uVar10)) ||
         (uVar10 < uVar11)) {
        iVar5 = 9;
      }
...

{
  ...
  if (plVar9 == (long *)0x0) {
    local_a3c = cid_compute_fd_and_offsets
                          (lVar18,param_2 & 0xffffffff,&local_a38,&local_a30,&local_a28);
    __dest = (void *)0x0;
    if ((((local_a3c == 0) && (local_a78 = (long)local_a28 - local_a30, local_a78 != 0)) &&
        (__dest = (void *)ft_mem_qalloc(uVar7,local_a78,&local_a3c), local_a3c == 0)) &&
       (local_a3c = FT_Stream_ReadAt(uVar6,local_a30 + *(long *)(lVar18 + 0x248),__dest,local_a78),
       local_a3c == 0)) {
      local_a3c = 0;
      uVar20 = local_a38;
LAB_001006d9:
      puVar16 = (undefined4 *)(uVar20 * 0x10 + *(long *)(lVar18 + 600));
      uVar4 = *puVar16;
      ...
      *(undefined8 *)(param_1 + 0xae0) = uVar14;
      ...
      if (local_a78 < uVar20) {
        ...
        if (*(char *)(param_1 + 0x86) == '\0') {
          ...
          local_118 = local_a08;
          local_a3c = (**(code **)(*(long *)(lVar8 + 0x18) + 0x18))
                                (local_538,lVar1,local_a78 - uVar20);
          uVar21 = 0;
          ...
          uVar21 = 0;
          local_a3c = (**(code **)(*(long *)(lVar8 + 0x18) + 0x10))
                                (param_1,lVar1,(int)local_a78 - iVar19);
        }
...
LAB_00100ea1:
  ...
  *(undefined4 *)(param_1 + 0x90) = 0x6f75746c;
  iVar9 = (*(code *)**(undefined8 **)(local_c70 + 0x18))
                    (local_bf8,lVar11,param_2,param_1,0,0,uVar14,(int)param_4 >> 0x10 & 0xf,
                     cid_load_glyph);
  if (iVar9 == 0) {
        ...
        *(long *)(param_1 + 0x78) = lVar11;
        ...
        if ((cVar2 != '\0') || (local_c44 == 0)) {
          ...
          if (((cVar1 == '\0') || (local_b70 == 0)) &&
             (sVar4 = *(short *)(local_bd8 + 2), 0 < sVar4)) {
...

{
  ...
  if (puVar2 != (undefined8 *)0x0) {
    lVar1 = *param_1;
    uVar3 = (*(code *)*puVar2)(*(undefined8 *)(lVar1 + 0xb8),
                               *(long *)(lVar1 + 8) * 0x150 + *(long *)(lVar1 + 0x240),&local_18);
    if ((int)uVar3 == 0) {
...
LAB_00101532:
      local_290 = (byte *)FT_Stream_Pos(lVar33);
      uVar36 = 0x109;
      local_298 = 0;
      pbVar18 = local_158;
      do {
        ...
        if (local_158 < pbVar18 + (uVar31 - 6)) {
          do {
            if ((*pbVar27 == 0x53) && (iVar10 = strncmp((char *)pbVar27,"StartData",9), iVar10 == 0)
               ) {
              lVar29 = ((long)local_290 + 10) - (long)local_158;
LAB_00101601:
              local_290 = pbVar27 + lVar29;
            ...
            if ((pbVar27[1] == 0x73) && (iVar10 = strncmp((char *)pbVar27,"/sfnts",6), iVar10 == 0))
            {
...
joined_r0x001016dd:
  ...
  if (((*pcVar32 == 'S') && (pcVar32 <= pcVar13)) &&
     (iVar10 = strncmp(pcVar32,"StartData",9), iVar10 == 0)) {
    local_228[0] = pcVar17;
    (*local_1b8)(local_228,&local_248);
    uVar36 = local_178;
    if (((local_240 - (long)local_248 == 5) && (*local_248 == 0x78654828)) &&
       (((char)local_248[1] == ')' &&
        (local_228[0] = pcVar8, uVar36 = (*local_1e0)(local_228), (long)uVar36 < 0))))
    goto LAB_00101d40;
    local_178 = uVar36;
    local_24c = 0;
    local_210 = 0;
  ...
  if ((pcVar32[1] == 's') && (iVar10 = strncmp(pcVar32,"/sfnts",6), iVar10 == 0)) {
    iVar10 = 2;
    goto LAB_001019f5;
  }
  (*local_1e8)(local_228);
  ...
  goto joined_r0x001016dd;
LAB_00101b0e:
  FT_Stream_ReleaseFrame(lVar33,&local_190);
...
LAB_00101b5a:
    if (*(int *)(param_1 + 0x238) == 0) goto LAB_00101d40;
    local_24c = local_210;
    iVar10 = local_210;
    if ((local_210 == 0) && (iVar10 = local_24c, -1 < param_2)) {
...
LAB_00101821:
    do {
      while (((*pcVar17 != '%' || (iVar10 = strncmp(pcVar17,"%ADOBeginFontDict",0x11), iVar10 != 0))
             || (*(int *)(param_1 + 0x238) == 0))) {
        pcVar17 = pcVar17 + 1;
...
LAB_00101860:
    if (pcVar30 <= pcVar32) goto LAB_00101b5a;
  }
  (*local_1e8)(local_228);
  pcVar17 = local_228[0];
...
LAB_00101954:
            if (*(int *)(puVar38 + 0xc) == 0xb) {
              ...
              if (uVar24 == 3) {
                ...
                if (uVar24 != 5) {
LAB_00101fe3:
                  if (*(uint *)(param_1 + 0x238) <= local_168) {
                    local_210 = 0xa0;
                    local_24c = 0xa0;
                    iVar10 = local_24c;
                    goto LAB_001019f5;
...
LAB_0010200f:
    ...
    if ((uVar31 & 0x3ff000000000000) == 0) {
      ...
      cVar23 = (char)iVar10;
joined_r0x00101f60:
      if (bVar6) goto LAB_00101ecd;
LAB_00101f66:
      cVar23 = cVar23 + *pcVar30;
      bVar6 = true;
      pcVar32 = pcVar30 + 1;
LAB_00101ed6:
      *pcVar30 = cVar23;
...
LAB_00101d1f:
  ...
  *(byte **)(param_1 + 0x248) = pbVar18;
  if (((uVar24 != 0) && (*(uint *)(param_1 + 0x228) < 5)) && (uVar24 < 5)) {
    ...
    if (((*(ulong *)(param_1 + 0x220) <= uVar36) && (*(ulong *)(param_1 + 0x230) >> 0x3d == 0)) &&
       ((ulong)(uVar24 + *(uint *)(param_1 + 0x228)) * *(ulong *)(param_1 + 0x230) <=
        uVar36 - *(ulong *)(param_1 + 0x220))) {
      ...
      if (*(uint *)(param_1 + 0x238) == 0) {
        ...
        do {
          ...
          else if (((uVar3 == 0) || (4 < uVar3)) ||
                  ((uVar36 < *(ulong *)(lVar25 + 0x140) ||
                   ((0x3fffffff < uVar24 ||
                    (uVar36 - *(ulong *)(lVar25 + 0x140) < (ulong)(uVar24 * uVar3)))))))
          goto LAB_00101d40;
          lVar25 = lVar25 + 0x150;
        } while (lVar29 != lVar25);
      }
...
LAB_00102150:
              iVar11 = FT_Stream_Seek(lVar33,*(long *)(lVar29 + 0x140) + *(long *)(param_1 + 0x248))
              ;
              ...
              if (iVar11 == 0) {
                ...
                if (iVar11 == 0) {
                  ...
                  {
LAB_0010220b:
                    local_248 = (int *)CONCAT44(local_248._4_4_,3);
                  }
                  else {
                          ...
                          if (iVar11 == 0) {
                            ...
                            if (-1 < iVar10) {
                              ...
                              while( true ) {
                                ...
                                lVar29 = lVar29 + 1;
                                (**(code **)(lVar25 + 0x20))
                                          (*plVar26,puVar20[lVar12] - *puVar21,0x10ea);
...
LAB_00102392:
          local_290 = (byte *)((long)local_290 + 1);
          puVar19 = puVar19 + 4;
...
int cid_face_init(undefined8 param_1,undefined8 *param_2,int param_3)

{
  ...
  *param_2 = 1;
  ...
  if (((iVar5 == 0) && (iVar5 = cid_face_open(param_2,param_3), iVar5 == 0)) && (-1 < param_3)) {
    if ((short)param_3 == 0) {
...
LAB_00102570:
      ...
      if ((pcVar11 != (char *)0x0) &&
         ((iVar5 = strcmp(pcVar11,"Bold"), iVar5 == 0 ||
          (iVar5 = strcmp(pcVar11,"Black"), iVar5 == 0)))) {

...

{
  ...
  uVar2 = 0xffffffff;
  if ((uVar1 < param_2) && (uVar2 = 0, param_1 != 0)) {
    if (param_2 < 0xff7f) {
    ...
    uVar2 = ((param_1 & 0x7fff) * (uint)(byte)(&png_sRGB_delta)[param_1 >> 0xf] >> 0xc) +
            (uint)*(ushort *)(&png_sRGB_base + (ulong)(param_1 >> 0xf) * 2) >> 8 & 0xff;
  }
  return uVar2;
}
...

{
  ...
  if ((uVar2 & 0x20000) != 0) {
    png_write_cICP(param_1,*(undefined1 *)(param_2 + 0x20),*(undefined1 *)((long)param_2 + 0x81),
                   *(undefined1 *)((long)param_2 + 0x82),*(undefined1 *)((long)param_2 + 0x83));
  }
...
LAB_001007d9:
          ...
          *(undefined1 *)puVar19 = uVar5;
          ...
          if (uVar8 < 3) {
            ...
            uVar5 = (undefined1)
                    (((int)((uVar8 & 0x7fff) * (uint)(byte)(&png_sRGB_delta)[lVar10]) >> 0xc) +
                     (uint)*(ushort *)(&png_sRGB_base + lVar10 * 2) >> 8);
            goto LAB_001006b9;
          }
          uVar8 = (uint)puVar1[uVar14] * 0x100 - (uint)puVar1[uVar14];
          lVar10 = (long)((int)uVar8 >> 0xf);
          *(char *)((long)puVar19 + 2) =
               (char)(((int)((uVar8 & 0x7fff) * (uint)(byte)(&png_sRGB_delta)[lVar10]) >> 0xc) +
                      (uint)*(ushort *)(&png_sRGB_base + lVar10 * 2) >> 8);
...
LAB_0010064e:
      ...
      if (uVar8 == 3) {
LAB_00100767:
        *(undefined1 *)((long)puVar19 + 2) = *(undefined1 *)(lVar10 + (int)uVar7);
      ...
      if ((uVar8 == 2) &&
         (cVar2 = *(char *)(lVar10 + (ulong)(uVar13 != 0x21)), (&local_149)[uVar18] = cVar2,
         cVar2 != -1)) {
        local_458 = iVar17;
      }
...
LAB_001006d7:
    png_set_PLTE(*(undefined8 *)*param_1,((undefined8 *)*param_1)[1],local_448,uVar6);
    if (0 < local_458) {
...

{
  ...
  if ((uVar3 & 0x100) != 0) {
    png_write_oFFs(param_1,*(undefined4 *)(param_2 + 0xdc),*(undefined4 *)(param_2 + 0xe0),
                   *(undefined1 *)(param_2 + 0xe4));
    uVar3 = *(uint *)(param_2 + 8);
  }
  if ((uVar3 & 0x400) != 0) {
    png_write_pCAL(param_1,*(undefined8 *)(param_2 + 0x110),*(undefined4 *)(param_2 + 0x118),
                   *(undefined4 *)(param_2 + 0x11c),*(undefined1 *)(param_2 + 0x130),
                   *(undefined1 *)(param_2 + 0x131),*(undefined8 *)(param_2 + 0x120),
                   *(undefined8 *)(param_2 + 0x128));
    uVar3 = *(uint *)(param_2 + 8);
  }
  if ((uVar3 & 0x4000) != 0) {
    png_write_sCAL_s(param_1,*(undefined1 *)(param_2 + 0x154),*(undefined8 *)(param_2 + 0x158),
                     *(undefined8 *)(param_2 + 0x160));
    uVar3 = *(uint *)(param_2 + 8);
  }
  if ((uVar3 & 0x80) != 0) {
    png_write_pHYs(param_1,*(undefined4 *)(param_2 + 0xe8),*(undefined4 *)(param_2 + 0xec),
                   *(undefined1 *)(param_2 + 0xf0));
    uVar3 = *(uint *)(param_2 + 8);
  }
  if ((uVar3 & 0x200) != 0) {
  ...
  if (0 < *(int *)(param_2 + 0x9c)) {
    ...
    do {
      ...
      if (iVar2 < 1) {
        ...
        png_write_iTXt(param_1,iVar2,*(undefined8 *)(piVar1 + 2),*(undefined8 *)(piVar1 + 10),
...

{
  ...
  *(uint *)(param_1 + 1) =
       CONCAT31(CONCAT21(CONCAT11(*(undefined1 *)(param_2 + 1),*(undefined1 *)(param_2 + 2)),
                         *(undefined1 *)(param_2 + 3)),*(char *)(param_2 + 4) + '\x01');
...

{
  ...
  if (ptVar3 == (tm *)0x0) {
    ...
    *(uint *)(param_1 + 1) =
         CONCAT31(CONCAT21(CONCAT11((char)ptVar3->tm_min,(char)iVar2),(char)ptVar3->tm_mday),
                  (char)iVar1 + '\x01');
...
switchD_001010de_default:
  local_38[0] = *(uint *)(param_1 + 0x204);
  uVar2 = (uint)*(byte *)(param_1 + 0x26c) * (uint)*(byte *)(param_1 + 0x269);
  local_28 = (((uVar2 & 0xff) << 8 | (uint)*(byte *)(param_1 + 0x26c)) << 8 |
             (uint)*(byte *)(param_1 + 0x269)) << 8 | (uint)*(byte *)(param_1 + 0x267);
  if ((byte)uVar2 < 8) {
...
LAB_001012b8:
  ...
  if ((local_28._3_1_ != *(char *)(param_1 + 0x26a)) ||
     (local_28._3_1_ != *(char *)(param_1 + 0x26f))) {
                    /* WARNING: Subroutine does not return */
...
LAB_001011cc:
    if (((char)local_28 == '\x03') && (-1 < *(int *)(param_1 + 0x25c))) {
    ...
    for (; local_48 != 0; local_48 = local_48 + -1) {
      ...
      if (uVar16 < uVar16 + uVar12) {
        do {
          ...
          *(char *)(uVar16 + uVar14) =
               (char)(((uVar9 & 0x7fff) * (uint)(byte)(&png_sRGB_delta)[uVar10] >> 0xc) +
                      (uint)*(ushort *)(&png_sRGB_base + uVar10 * 2) >> 8);
          uVar14 = uVar14 + 1;
        } while (uVar12 != uVar14);
      }
            ...
            do {
              ...
              if (uVar8 < uVar9) {
                ...
                if (uVar1 != 0) {
                  ...
                  uVar4 = (undefined1)
                          (((uVar8 & 0x7fff) * (uint)(byte)(&png_sRGB_delta)[uVar8 >> 0xf] >> 0xc) +
                           (uint)*(ushort *)(&png_sRGB_base + (ulong)(uVar8 >> 0xf) * 2) >> 8);
                }
              }
    ...
    if (*(int *)(param_1 + 0x1fc) == 1) {
      ...
      if ((uVar5 & 0xe0) != 0) {
        if (*(long *)(param_1 + 0x220) == 0) {
          ...
          uVar7 = (((uVar7 - ((uVar5 & 0x20) == 0)) - (uint)((uVar5 & 0x40) == 0)) + 3) -
                  (uint)((uVar5 & 0x80) == 0);
        }
      }
    }
...

{
  ...
  if (uVar14 == 0) {
    png_set_IHDR(lVar4,lVar5,uVar2,uVar11,(-(uint)!bVar15 & 0xfffffff8) + 0x10,
                 uVar1 * 4 & 4 | uVar1 & 2,0,0,0);
  }
  else {
    if ((param_1[3] == 0) || (uVar10 = *(uint *)((long)plVar3 + 0x1c), uVar10 == 0)) {
                    /* WARNING: Subroutine does not return */
      png_error(*(undefined8 *)*plVar3,"no color-map for color-mapped image");
    }
    cVar13 = '\b';
    if ((uVar10 < 0x11) && (cVar13 = '\x04', uVar10 < 5)) {
      cVar13 = (2 < uVar10) + '\x01';
    }
...
LAB_00102016:
    if ((uVar1 & 0x10) == 0) goto LAB_0010209d;
LAB_00102021:
    uVar10 = uVar1 & 0xffffffef;
    if (uVar14 == 0) {
      if ((uVar1 & 2) != 0) {
        png_set_bgr(lVar4);
      }
...
LAB_0010288b:
        uVar3 = png_image_error(param_1,pcVar4);
        return uVar3;
      }
      goto LAB_0010296d;
    }
...
ulong png_image_write_to_stdio
                (undefined8 *param_1,long param_2,undefined4 param_3,long param_4,undefined4 param_5
                ,undefined8 param_6)

...
{
  return CONCAT31((int3)((uint)*(int *)(param_1 + 0x14) >> 8),
...

{
  ...
  if (iVar1 < *(int *)((long)param_1 + 0x14)) {
    *(int *)(param_1 + 2) = iVar1 + 1;
    return (ulong)CONCAT11(*(undefined1 *)(*param_1 + (long)(iVar1 * 2)),
                           *(undefined1 *)(*param_1 + 1 + (long)(iVar1 * 2)));
  }
  return 0xffffffff;
}
...
LAB_00101123:
          ...
          if (bVar6 < 0x40) {
            ...
            *(int *)((long)param_1 + 0xc) = iVar8;
            ...
            if (iVar3 < 0) {
              if ((iVar2 == iVar8) && (iVar7 = (int)param_1[1], -1 < iVar7)) {
                if (0xffff < (int)uVar5) {
...
LAB_00101110:
        ...
        uVar5 = uVar5 - 0xf0;
        if (((int)uVar5 < 5) &&
           (bVar1 = *(byte *)(lVar4 + iVar8),
           ((uint)(int)(char)(&DAT_00102060)[bVar1 >> 4] >> (uVar5 & 0x1f) & 1) != 0)) {
          iVar8 = iVar7 + 2;
          *(int *)((long)param_1 + 0xc) = iVar8;
          if (iVar2 == iVar8) goto LAB_00101170;
          bVar6 = *(char *)(lVar4 + iVar8) + 0x80;
...

{
  ...
  if (uVar6 < 0xe0) {
    ...
    if (uVar6 < 0xf0) {
      ...
      lVar8 = (long)iVar7;
      if (((uint)(int)(char)(&DAT_00102060)[*(byte *)(lVar3 + lVar8) >> 4] >> (uVar6 & 0x1f) & 1) ==
          0) {
        return 0xfffd;
      }
      iVar7 = iVar1 + 2;

...

{
  ...
  if (cVar3 == '\0') {
    ...
    if (cVar3 == '\0') {
      ...
      if (((local_30 == 0) || (iVar4 = (int)*(undefined8 *)(local_30 + -8), iVar4 == 0)) ||
         (iVar4 == 1)) {
        BaseButton::set_disabled(bVar5);
      }
      else {
...

{
  ...
  if (cVar3 == '\0') {
    ...
    if (cVar3 != '\0') {
      ...
      String::strip_edges(bVar6,SUB81(&local_a0,0));
  ...
  if (iVar3 == 0) {
    ...
    if (local_50 != (long *)0x0) {
      for (pRVar5 = (Ref *)*local_50; pRVar5 != (Ref *)0x0; pRVar5 = *(Ref **)(pRVar5 + 8)) {
        while( true ) {
          local_48 = (Object *)0x0;
          ItemList::add_item(*(String **)(this + 0xdc0),pRVar5,SUB81(&local_48,0));

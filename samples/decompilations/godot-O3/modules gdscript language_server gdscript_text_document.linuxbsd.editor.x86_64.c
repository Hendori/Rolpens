...
/* GDScriptTextDocument::didClose(Variant const&) */

void GDScriptTextDocument::didClose(Variant *param_1)
...
/* GDScriptTextDocument::foldingRange(Dictionary const&) */

Dictionary * GDScriptTextDocument::foldingRange(Dictionary *param_1)
...
/* GDScriptTextDocument::codeLens(Dictionary const&) */

Dictionary * GDScriptTextDocument::codeLens(Dictionary *param_1)
...
/* GDScriptTextDocument::colorPresentation(Dictionary const&) */

Dictionary * GDScriptTextDocument::colorPresentation(Dictionary *param_1)
...
void __thiscall Ref<GDScriptWorkspace>::operator=(Ref<GDScriptWorkspace> *this,Ref *param_1)
...
void __thiscall GDScriptTextDocument::GDScriptTextDocument(GDScriptTextDocument *this)
...
/* GDScriptTextDocument::show_native_symbol_in_editor(String const&) */

void __thiscall
GDScriptTextDocument::show_native_symbol_in_editor(GDScriptTextDocument *this,String *param_1)
...
/* GDScriptTextDocument::notify_client_show_symbol(lsp::DocumentSymbol const*) */

void __thiscall
GDScriptTextDocument::notify_client_show_symbol(GDScriptTextDocument *this,DocumentSymbol *param_1)

{
  ...
  if (param_1 == (DocumentSymbol *)0x0) {
    if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error("notify_client_show_symbol",
                       "modules/gdscript/language_server/gdscript_text_document.cpp",0x89,
                       "Parameter \"symbol\" is null.",0,0);
      return;
    }
  }
  else {
...
/* GDScriptTextDocument::sync_script_content(String const&, String const&) */

void GDScriptTextDocument::sync_script_content(String *param_1,String *param_2)
...
/* GDScriptTextDocument::reload_script(Ref<GDScript>) */

void __thiscall GDScriptTextDocument::reload_script(undefined8 param_1,long *param_2)
...
/* GDScriptTextDocument::documentLink(Dictionary const&) */

Dictionary * GDScriptTextDocument::documentLink(Dictionary *param_1)

{
  ...
  local_88 = (long *)0x0;
  pSVar3 = *(String **)(GDScriptLanguageProtocol::singleton + 0x1f8);
  if ((pSVar3 != (String *)0x0) && (cVar2 = RefCounted::reference(), cVar2 == '\0')) {
    pSVar3 = (String *)0x0;
  }
  ...
  List<lsp::DocumentLink,DefaultAllocator>::~List
            ((List<lsp::DocumentLink,DefaultAllocator> *)&local_88);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_90);
...
/* GDScriptTextDocument::nativeSymbol(Dictionary const&) */

Dictionary * GDScriptTextDocument::nativeSymbol(Dictionary *param_1)
...
/* GDScriptTextDocument::load_document_item(Variant const&) */

Variant * GDScriptTextDocument::load_document_item(Variant *param_1)
...
/* GDScriptTextDocument::willSaveWaitUntil(Variant const&) */

void GDScriptTextDocument::willSaveWaitUntil(Variant *param_1)
...
/* GDScriptTextDocument::didOpen(Variant const&) */

void GDScriptTextDocument::didOpen(Variant *param_1)
...
/* GDScriptTextDocument::didSave(Variant const&) */

void GDScriptTextDocument::didSave(Variant *param_1)
...
LAB_00101642:
      ...
      cVar3 = RefCounted::reference();
      if (cVar3 == '\0') {
        if ((local_b8 != (String *)0x0) && (cVar3 = RefCounted::unreference(), cVar3 != '\0'))
        goto LAB_00101640;
        goto LAB_00101502;
      }
      if ((local_b8 != (String *)0x0) && (cVar3 = RefCounted::unreference(), cVar3 != '\0'))
    ...
    if (iVar5 == 0) {
      ...
      if (SVar4 == (String)0x0) {
        ...
        if ((pSVar8 != (String *)0x0) &&
           (local_b8 = pSVar8, cVar3 = RefCounted::reference(), cVar3 == '\0')) {
          local_b8 = (String *)0x0;
        }
        (*pcVar2)(plVar7,(Callable *)&local_b8,1);
        if (((local_b8 != (String *)0x0) &&
            (cVar3 = RefCounted::unreference(), pSVar8 = local_b8, cVar3 != '\0')) &&
           (cVar3 = predelete_handler((Object *)local_b8), cVar3 != '\0')) {
...
/* GDScriptTextDocument::rename(Dictionary const&) */

Dictionary * GDScriptTextDocument::rename(Dictionary *param_1)
...
/* GDScriptTextDocument::didChange(Variant const&) */

void GDScriptTextDocument::didChange(Variant *param_1)

{
  ...
  while( true ) {
    ...
    local_78[0] = (TextDocumentContentChangeEvent)0x0;
    local_78[1] = (TextDocumentContentChangeEvent)0x0;
    local_78[2] = (TextDocumentContentChangeEvent)0x0;
    local_78[3] = (TextDocumentContentChangeEvent)0x0;
    local_78[4] = (TextDocumentContentChangeEvent)0x0;
    local_78[5] = (TextDocumentContentChangeEvent)0x0;
    local_78[6] = (TextDocumentContentChangeEvent)0x0;
    local_78[7] = (TextDocumentContentChangeEvent)0x0;
    local_78[8] = (TextDocumentContentChangeEvent)0x0;
    local_78[9] = (TextDocumentContentChangeEvent)0x0;
    local_78[10] = (TextDocumentContentChangeEvent)0x0;
    local_78[0xb] = (TextDocumentContentChangeEvent)0x0;
    local_78[0xc] = (TextDocumentContentChangeEvent)0x0;
    local_78[0xd] = (TextDocumentContentChangeEvent)0x0;
    local_78[0xe] = (TextDocumentContentChangeEvent)0x0;
    local_78[0xf] = (TextDocumentContentChangeEvent)0x0;
    local_68 = 0;
    local_60 = 0;
...
/* GDScriptTextDocument::signatureHelp(Dictionary const&) */

Dictionary * GDScriptTextDocument::signatureHelp(Dictionary *param_1)
...
/* GDScriptTextDocument::references(Dictionary const&) */

Dictionary * GDScriptTextDocument::references(Dictionary *param_1)

{
  ...
  pTVar12 = *(TextDocumentPositionParams **)(GDScriptLanguageProtocol::singleton + 0x1f8);
  if ((pTVar12 == (TextDocumentPositionParams *)0x0) ||
     (local_d0 = pTVar12, cVar4 = RefCounted::reference(), cVar4 == '\0')) {
  ...
  lVar7 = GDScriptWorkspace::resolve_symbol
                    (pTVar12,(String *)&local_b8,SUB81((Variant *)&local_c8,0));
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_c8);
  Ref<GDScriptWorkspace>::unref((Ref<GDScriptWorkspace> *)&local_d0);
  if (lVar7 != 0) {
    local_98 = *(undefined **)(GDScriptLanguageProtocol::singleton + 0x1f8);
    if ((local_98 == (undefined *)0x0) || (cVar4 = RefCounted::reference(), cVar4 == '\0')) {
...
LAB_0010298f:
        local_90 = *(long *)(pCVar2 + 8);
        uStack_88 = *(long *)(pCVar2 + 0x10);
        if ((((local_a8 == '\0') && ((int)local_90 == *(int *)(lVar7 + 0x28))) &&
            (local_90._4_4_ = (int)((ulong)local_90 >> 0x20),
            local_90._4_4_ == *(int *)(lVar7 + 0x2c))) &&
           (((int)uStack_88 == *(int *)(lVar7 + 0x30) &&
            (uStack_88._4_4_ = (int)((ulong)uStack_88 >> 0x20),
            uStack_88._4_4_ == *(int *)(lVar7 + 0x34))))) {
          local_fc = local_fc + 1;
          CowData<char32_t>::_unref((CowData<char32_t> *)&local_98);
        }
        else {
...
LAB_00102aeb:
            _err_print_index_error
                      ("get","./core/templates/cowdata.h",0xdb,lVar13,lVar10,"p_index","size()","",
                       false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
...
GDScriptTextDocument::find_symbols(TextDocumentPositionParams *param_1,List *param_2)

{
  ...
  if ((pTVar9 == (TextDocumentPositionParams *)0x0) ||
     (local_a8 = pTVar9, cVar3 = RefCounted::reference(), cVar3 == '\0')) {
  ...
  if (lVar4 == 0) {
    ...
    if (cVar3 != '\0') {
      ...
      Ref<GDScriptWorkspace>::operator=
                ((Ref<GDScriptWorkspace> *)&local_98,
                 *(Ref **)(GDScriptLanguageProtocol::singleton + 0x1f8));
      ...
      List<lsp::DocumentSymbol_const*,DefaultAllocator>::~List
                ((List<lsp::DocumentSymbol_const*,DefaultAllocator> *)&local_b8);
    }
  }
  else {
    local_98 = (TextDocumentPositionParams *)0x0;
    ...
    if ((local_a0 == 0) || (cVar3 = RefCounted::reference(), cVar3 == '\0')) {
      local_a0 = 0;
    }
    GDScriptWorkspace::get_file_path((String *)&local_b8);
    Ref<GDScriptWorkspace>::unref((Ref<GDScriptWorkspace> *)&local_a0);
    cVar3 = (**(code **)(**(long **)(param_2 + 0x180) + 0x2e0))
                      (*(long **)(param_2 + 0x180),(String *)&local_b8);
    if (cVar3 != '\0') {
      Dictionary::Dictionary(local_b0);
      Variant::Variant((Variant *)local_58,(String *)&local_98);
      Variant::Variant((Variant *)local_78,"uri");
...
/* GDScriptTextDocument::definition(Dictionary const&) */

Dictionary * GDScriptTextDocument::definition(Dictionary *param_1)
...
/* WARNING: Removing unreachable block (ram,0x00104039) */
/* WARNING: Removing unreachable block (ram,0x001040d0) */
/* WARNING: Removing unreachable block (ram,0x001040d8) */
/* WARNING: Removing unreachable block (ram,0x00104045) */
/* WARNING: Removing unreachable block (ram,0x00104110) */
/* WARNING: Removing unreachable block (ram,0x00104141) */
/* WARNING: Removing unreachable block (ram,0x0010404f) */
...
/* WARNING: Removing unreachable block (ram,0x00104071) */
/* WARNING: Removing unreachable block (ram,0x00104076) */
/* WARNING: Removing unreachable block (ram,0x0010407a) */
/* WARNING: Removing unreachable block (ram,0x00104088) */
/* WARNING: Removing unreachable block (ram,0x0010400f) */
/* WARNING: Removing unreachable block (ram,0x0010401b) */
/* WARNING: Removing unreachable block (ram,0x00104150) */
/* WARNING: Removing unreachable block (ram,0x00104168) */
/* WARNING: Removing unreachable block (ram,0x00104172) */
/* WARNING: Removing unreachable block (ram,0x001041fd) */
/* WARNING: Removing unreachable block (ram,0x00104187) */
/* WARNING: Removing unreachable block (ram,0x0010419f) */
/* WARNING: Removing unreachable block (ram,0x001044af) */
/* WARNING: Removing unreachable block (ram,0x001044f0) */
/* WARNING: Removing unreachable block (ram,0x0010446e) */
/* WARNING: Removing unreachable block (ram,0x0010420f) */
/* WARNING: Removing unreachable block (ram,0x0010442d) */
/* WARNING: Removing unreachable block (ram,0x0010424b) */
/* WARNING: Removing unreachable block (ram,0x00104295) */
/* WARNING: Removing unreachable block (ram,0x001042b3) */
/* WARNING: Removing unreachable block (ram,0x00104531) */
/* WARNING: Removing unreachable block (ram,0x0010455a) */
/* WARNING: Removing unreachable block (ram,0x00104578) */
/* WARNING: Removing unreachable block (ram,0x001042e3) */
/* WARNING: Removing unreachable block (ram,0x0010439b) */
/* WARNING: Removing unreachable block (ram,0x001043aa) */
/* WARNING: Removing unreachable block (ram,0x0010459c) */
/* WARNING: Removing unreachable block (ram,0x001043f9) */
/* WARNING: Removing unreachable block (ram,0x0010458f) */
/* WARNING: Removing unreachable block (ram,0x0010440c) */
/* WARNING: Recovered jumptable eliminated as dead code */
/* GDScriptTextDocument::declaration(Dictionary const&) */

Dictionary * GDScriptTextDocument::declaration(Dictionary *param_1)
...
void GDScriptTextDocument::_bind_methods(void)
...
/* lsp::marked_documentation(String const&) */

lsp * __thiscall lsp::marked_documentation(lsp *this,String *param_1)
...
LAB_00105109:
    iVar6 = String::find((char *)&local_78,0x10dd13);
    if (iVar6 == -1) {
      if (bVar4) {
        String::substr((int)local_70,(int)(StrRange *)&local_78);
        operator+((char *)&local_58,(String *)&_LC103);
...
LAB_001051dd:
      String::strip_edges(SUB81((CowData<char32_t> *)&local_58,0),SUB81((StrRange *)&local_78,0));
      if (local_78 != local_58) {
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_78);
        local_78 = local_58;
        local_58 = (undefined *)0x0;
...
LAB_00105030:
      iVar6 = String::find((char *)&local_78,0x10dd21);
      if (iVar6 != -1) {
        local_50 = 1;
        local_58 = &_LC101;
        String::parse_latin1((StrRange *)&local_78);
...
/* GDScriptTextDocument::hover(Dictionary const&) */

Dictionary * GDScriptTextDocument::hover(Dictionary *param_1)
...
LAB_001058d2:
  ...
  lVar9 = GDScriptWorkspace::resolve_symbol
                    (pTVar10,(String *)&local_b8,SUB81((Variant *)local_a8,0));
  CowData<char32_t>::_unref((CowData<char32_t> *)local_a8);
  ...
  if (lVar9 == 0) {
    ...
    if (cVar6 == '\0') {
      ...
      *(undefined1 (*) [16])(param_1 + 8) = (undefined1  [16])0x0;
        ...
        for (plVar1 = (long *)*local_e8; plVar1 != (long *)0x0; plVar1 = (long *)plVar1[1]) {
          ...
          if (lVar9 != 0) {
            ...
            CowData<char32_t>::_ref
                      ((CowData<char32_t> *)&local_98,(CowData *)&lsp::MarkupKind::Markdown);
            if ((*(long *)(lVar9 + 8) != 0) && (1 < *(uint *)(*(long *)(lVar9 + 8) + -8))) {
              local_c0 = (TextDocumentPositionParams *)0x0;
              String::parse_latin1((String *)&local_c0,"\n\n");
              operator+((char *)&local_c8,(String *)&_LC103);
            ...
            if ((*(long *)(lVar9 + 0x50) != 0) && (1 < *(uint *)(*(long *)(lVar9 + 0x50) + -8))) {
              ...
              operator+((char *)&local_e0,(String *)"Defined in [");
      ...
      List<lsp::DocumentSymbol_const*,DefaultAllocator>::~List
                ((List<lsp::DocumentSymbol_const*,DefaultAllocator> *)&local_e8);
      Array::~Array(local_f0);
      Dictionary::~Dictionary(local_f8);
    }
  }
    ...
    if ((*(long *)(lVar9 + 8) != 0) && (1 < *(uint *)(*(long *)(lVar9 + 8) + -8))) {
      ...
      operator+((char *)local_d0,(String *)&_LC103);
    ...
    if ((*(long *)(lVar9 + 0x50) != 0) && (1 < *(uint *)(*(long *)(lVar9 + 0x50) + -8))) {
      ...
      operator+((char *)&local_e8,(String *)"Defined in [");
...
/* GDScriptTextDocument::resolve(Dictionary const&) */

Dictionary * GDScriptTextDocument::resolve(Dictionary *param_1)

{
  ...
  if (local_158[0] == 0x1b) {
    ...
    Ref<GDScriptWorkspace>::operator=
              ((Ref<GDScriptWorkspace> *)local_228,
               *(Ref **)(GDScriptLanguageProtocol::singleton + 0x1f8));
    lVar38 = GDScriptWorkspace::resolve_symbol
                       ((TextDocumentPositionParams *)local_188._0_8_,(String *)&local_178,
                        SUB81((CompletionItem *)&local_f8,0));
...
LAB_00106d4a:
    ...
    if (lVar38 != 0) {
      ...
      if ((*(long *)(lVar38 + 8) != 0) && (1 < *(uint *)(*(long *)(lVar38 + 8) + -8))) {
        ...
        operator+((char *)&local_1a0,(String *)&_LC103);
      ...
      if ((*(long *)(lVar38 + 0x50) != 0) && (1 < *(uint *)(*(long *)(lVar38 + 0x50) + -8))) {
        ...
        operator+((char *)local_1b8,(String *)"Defined in [");
...
LAB_00107b7d:
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,lVar39,lVar38,"p_index","size()","",false
                   ,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        ...
        if (uVar35 != 0) {
          ...
          do {
            ...
            uVar40 = SUB164(auVar4 * auVar16,8);
                  ...
                  (auVar5._8_8_ = 0, auVar5._0_8_ = (ulong)uVar35 * lVar39, auVar17._8_8_ = 0,
                  auVar17._0_8_ = uVar44, auVar6._8_8_ = 0,
                  auVar6._0_8_ = (ulong)((uVar2 + uVar40) - SUB164(auVar5 * auVar17,8)) * lVar39,
                  auVar18._8_8_ = 0, auVar18._0_8_ = uVar44, uVar45 <= SUB164(auVar6 * auVar18,8)));
        }
      }
      Ref<GDScriptWorkspace>::unref((Ref<GDScriptWorkspace> *)&local_198);
LAB_00107717:
      local_1e8 = (Ref<GDScriptWorkspace> *)&local_198;
      lVar38 = *(long *)(GDScriptLanguageProtocol::singleton + 0x1f8);
          ...
          do {
            if (uVar36 == uVar35) {
              cVar33 = String::operator==((String *)
                                          (*(long *)(*(long *)(lVar38 + 0x1c8) + lVar42 * 8) + 0x10)
                                          ,local_200);
              if (cVar33 != '\0') {
            ...
            uVar40 = SUB164(auVar12 * auVar24,8);
                  ...
                  (auVar13._8_8_ = 0, auVar13._0_8_ = (ulong)uVar35 * lVar39, auVar25._8_8_ = 0,
                  auVar25._0_8_ = uVar44, auVar14._8_8_ = 0,
                  auVar14._0_8_ = (ulong)((uVar2 + uVar40) - SUB164(auVar13 * auVar25,8)) * lVar39,
                  auVar26._8_8_ = 0, auVar26._0_8_ = uVar44, uVar45 <= SUB164(auVar14 * auVar26,8)))
          ;
        }
      }
      CowData<char32_t>::_unref((CowData<char32_t> *)local_200);
...
LAB_001079d1:
  ...
  iVar32 = local_168;
  if ((local_f0 == 2) &&
     (((cVar33 = String::operator==((String *)&local_160,"\""), cVar33 != '\0' ||
       (cVar33 = String::operator==((String *)&local_160,"\'"), cVar33 != '\0')) && (iVar32 == 2))))
  {
...
LAB_00107179:
  if (uVar35 == uVar36) {
    cVar33 = String::operator==((String *)(*(long *)(*(long *)(lVar38 + 0x20) + lVar42 * 8) + 0x10),
                                pSVar1);
    if (cVar33 != '\0') {
  ...
  if ((uVar35 == 0) ||
     (auVar9._8_8_ = 0, auVar9._0_8_ = (ulong)uVar35 * lVar39, auVar21._8_8_ = 0,
     auVar21._0_8_ = uVar44, auVar10._8_8_ = 0,
     auVar10._0_8_ = (ulong)((uVar2 + uVar40) - SUB164(auVar9 * auVar21,8)) * lVar39,
     auVar22._8_8_ = 0, auVar22._0_8_ = uVar44, SUB164(auVar10 * auVar22,8) < uVar45))
  goto LAB_00107717;
  goto LAB_00107179;
}
...
void __thiscall GDScriptTextDocument::initialize(GDScriptTextDocument *this)

{
  ...
  if (cVar20 != '\0') {
    ...
    if ((pcVar26 == (char *)0x0) ||
       (local_148 = pcVar26, cVar20 = RefCounted::reference(), cVar20 == '\0')) {
      local_148 = (char *)0x0;
      pcVar26 = (char *)0x0;
    }
    Ref<GDScriptWorkspace>::unref((Ref<GDScriptWorkspace> *)&local_148);
    for (puVar3 = *(undefined8 **)(pcVar26 + 0x238); puVar3 != (undefined8 *)0x0;
        puVar3 = (undefined8 *)*puVar3) {
      local_198 = (long *)puVar3[6];
      if (local_198 != (long *)0x0) {
LAB_00107cb0:
        if ((puVar3[4] != 0) && (*(int *)((long)puVar3 + 0x44) != 0)) {
          ...
          if (uVar21 != 0) {
            ...
            do {
              if (uVar21 == uVar23) {
                cVar20 = String::operator==((String *)(*(long *)(puVar3[4] + lVar25 * 8) + 0x10),
                                            (String *)(local_198 + 2));
              ...
              if ((uVar21 == 0) ||
                 (auVar9._8_8_ = 0, auVar9._0_8_ = (ulong)uVar21 * lVar4, auVar13._8_8_ = 0,
                 auVar13._0_8_ = uVar16, auVar10._8_8_ = 0,
                 auVar10._0_8_ = (ulong)((uVar2 + uVar24) - SUB164(auVar9 * auVar13,8)) * lVar4,
                 auVar14._8_8_ = 0, auVar14._0_8_ = uVar16, SUB164(auVar10 * auVar14,8) < uVar29))
              break;
            } while( true );
          }
        }
        _err_print_error(&_LC69,"./core/templates/hash_map.h",0x147,
...
LAB_00107df6:
  ...
  if (lsp::MarkupKind::Markdown != 0) {
    CowData<char32_t>::_ref
              ((CowData<char32_t> *)(local_e8 + 8),(CowData *)&lsp::MarkupKind::Markdown);
  }
  local_d0 = 0;
  local_c8 = (undefined1  [16])0x0;
  local_78 = (undefined1  [16])0x0;
...
/* GDScriptTextDocument::completion(Dictionary const&) */

Dictionary * GDScriptTextDocument::completion(Dictionary *param_1)

{
  ...
  if ((pCVar8 != (CompletionParams *)0x0) && (cVar6 = RefCounted::reference(), cVar6 == '\0')) {
  ...
  if ((local_168 != (undefined8 *)0x0) && (*(int *)(local_168 + 2) != 0)) {
    ...
    if ((local_168 != (undefined8 *)0x0) &&
       (puVar11 = (undefined4 *)*local_168, puVar11 != (undefined4 *)0x0)) {
      do {
        local_f8 = 0;
        local_e8[0] = (CowData<char32_t>)0x0;
        local_e8[1] = (CowData<char32_t>)0x0;
        local_e8[2] = (CowData<char32_t>)0x0;
        local_e8[3] = (CowData<char32_t>)0x0;
        local_e8[4] = (CowData<char32_t>)0x0;
        local_e8[5] = (CowData<char32_t>)0x0;
        local_e8[6] = (CowData<char32_t>)0x0;
        local_e8[7] = (CowData<char32_t>)0x0;
        local_e8[8] = (CowData<char32_t>)0x0;
        local_e8[9] = (CowData<char32_t>)0x0;
        local_e8[10] = (CowData<char32_t>)0x0;
        local_e8[0xb] = (CowData<char32_t>)0x0;
        local_e8[0xc] = (CowData<char32_t>)0x0;
        local_e8[0xd] = (CowData<char32_t>)0x0;
        local_e8[0xe] = (CowData<char32_t>)0x0;
        local_e8[0xf] = (CowData<char32_t>)0x0;
        local_f0 = 0;
        local_d8 = 0;
        if (lsp::MarkupKind::Markdown != 0) {
        ...
        local_88 = 0;
        local_68 = 0;
        local_c8[0] = (CowData<char32_t>)0x0;
        local_c8[1] = (CowData<char32_t>)0x0;
        local_c8[2] = (CowData<char32_t>)0x0;
        local_c8[3] = (CowData<char32_t>)0x0;
        local_c8[4] = (CowData<char32_t>)0x0;
        local_c8[5] = (CowData<char32_t>)0x0;
        local_c8[6] = (CowData<char32_t>)0x0;
        local_c8[7] = (CowData<char32_t>)0x0;
        local_c8[8] = (CowData<char32_t>)0x0;
        local_c8[9] = (CowData<char32_t>)0x0;
        local_c8[10] = (CowData<char32_t>)0x0;
        local_c8[0xb] = (CowData<char32_t>)0x0;
        local_c8[0xc] = (CowData<char32_t>)0x0;
        local_c8[0xd] = (CowData<char32_t>)0x0;
        local_c8[0xe] = (CowData<char32_t>)0x0;
        local_c8[0xf] = (CowData<char32_t>)0x0;
  ...
  List<ScriptLanguage::CodeCompletionOption,DefaultAllocator>::~List
            ((List<ScriptLanguage::CodeCompletionOption,DefaultAllocator> *)&local_168);
...
/* GDScriptTextDocument::documentSymbol(Dictionary const&) */

Dictionary * GDScriptTextDocument::documentSymbol(Dictionary *param_1)

{
  ...
  if ((pOVar18 != (Object *)0x0) && (cVar13 = RefCounted::reference(), cVar13 == '\0')) {
    pOVar18 = (Object *)0x0;
  }
      ...
      do {
        if (uVar15 == uVar14) {
          cVar13 = String::operator==((String *)
                                      (*(long *)(*(long *)(pOVar18 + 0x1c8) + lVar17 * 8) + 0x10),
                                      local_d8);
          if (cVar13 != '\0') {
        ...
        uVar16 = SUB164(auVar4 * auVar8,8);
              ...
              auVar6._0_8_ = (ulong)((uVar2 + uVar16) - SUB164(auVar5 * auVar9,8)) * lVar19,
              auVar10._8_8_ = 0, auVar10._0_8_ = uVar12, uVar21 <= SUB164(auVar6 * auVar10,8)));
      cVar13 = RefCounted::unreference();
...
LAB_001094d7:
        lsp::DocumentSymbol::to_json(SUB81(local_d0,0));
...
/* GDScriptTextDocument::prepareRename(Dictionary const&) */

Dictionary * GDScriptTextDocument::prepareRename(Dictionary *param_1)

{
  ...
  _local_e8 = (undefined1  [16])0x0;
  local_d8[0] = (CowData<char32_t>)0x0;
  local_d8[1] = (CowData<char32_t>)0x0;
  local_d8[2] = (CowData<char32_t>)0x0;
  local_d8[3] = (CowData<char32_t>)0x0;
  local_d8[4] = (CowData<char32_t>)0x0;
  local_d8[5] = (CowData<char32_t>)0x0;
  local_d8[6] = (CowData<char32_t>)0x0;
  local_d8[7] = (CowData<char32_t>)0x0;
  local_d8[8] = (CowData<char32_t>)0x0;
  local_d8[9] = (CowData<char32_t>)0x0;
  local_d8[10] = (CowData<char32_t>)0x0;
  local_d8[0xb] = (CowData<char32_t>)0x0;
  local_d8[0xc] = (CowData<char32_t>)0x0;
  local_d8[0xd] = (CowData<char32_t>)0x0;
  local_d8[0xe] = (CowData<char32_t>)0x0;
  local_d8[0xf] = (CowData<char32_t>)0x0;
  local_c0 = (undefined1  [16])0x0;
  local_b0 = (undefined1  [16])0x0;
  local_a0[0] = (CowData<char32_t>)0x0;
  local_a0[1] = (CowData<char32_t>)0x0;
  local_a0[2] = (CowData<char32_t>)0x0;
  local_a0[3] = (CowData<char32_t>)0x0;
  local_a0[4] = (CowData<char32_t>)0x0;
  local_a0[5] = (CowData<char32_t>)0x0;
  local_a0[6] = (CowData<char32_t>)0x0;
  local_a0[7] = (CowData<char32_t>)0x0;
  local_a0[8] = (CowData<char32_t>)0x0;
  local_a0[9] = (CowData<char32_t>)0x0;
  local_a0[10] = (CowData<char32_t>)0x0;
  local_a0[0xb] = (CowData<char32_t>)0x0;
  local_a0[0xc] = (CowData<char32_t>)0x0;
  local_a0[0xd] = (CowData<char32_t>)0x0;
  local_a0[0xe] = (CowData<char32_t>)0x0;
  local_a0[0xf] = (CowData<char32_t>)0x0;
...
{
  return (uint)CONCAT71(0x1156,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1156,(undefined4 *)param_1 == &get_class_ptr_static()::ptr);
}
...
/* GDScriptTextDocument::is_class_ptr(void*) const */

uint __thiscall GDScriptTextDocument::is_class_ptr(GDScriptTextDocument *this,void *param_1)

{
  return (uint)CONCAT71(0x1156,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1156,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1156,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}



/* GDScriptTextDocument::_getv(StringName const&, Variant&) const */

undefined8 GDScriptTextDocument::_getv(StringName *param_1,Variant *param_2)
...
/* GDScriptTextDocument::_setv(StringName const&, Variant const&) */

undefined8 GDScriptTextDocument::_setv(StringName *param_1,Variant *param_2)
...
/* GDScriptTextDocument::_validate_propertyv(PropertyInfo&) const */

void GDScriptTextDocument::_validate_propertyv(PropertyInfo *param_1)
...
/* GDScriptTextDocument::_property_can_revertv(StringName const&) const */

undefined8 GDScriptTextDocument::_property_can_revertv(StringName *param_1)
...
/* GDScriptTextDocument::_property_get_revertv(StringName const&, Variant&) const */

undefined8 GDScriptTextDocument::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* GDScriptTextDocument::_notificationv(int, bool) */

void GDScriptTextDocument::_notificationv(int param_1,bool param_2)
...
/* CallableCustomMethodPointer<ScriptEditor, void, String const&>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<ScriptEditor,void,String_const&>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<ScriptEditor,void,String_const&> *this)
...
void __thiscall
CallableCustomMethodPointer<GDScriptTextDocument,void,String_const&>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<GDScriptTextDocument,void,String_const&> *this)
...
void __thiscall
CallableCustomMethodPointer<GDScriptTextDocument,void,Ref<GDScript>>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<GDScriptTextDocument,void,Ref<GDScript>> *this)
...
/* MethodBindTR<Array, Dictionary const&>::_gen_argument_type(int) const */

int __thiscall
MethodBindTR<Array,Dictionary_const&>::_gen_argument_type
          (MethodBindTR<Array,Dictionary_const&> *this,int param_1)
...
/* MethodBindTR<Array, Dictionary const&>::get_argument_meta(int) const */

undefined8 MethodBindTR<Array,Dictionary_const&>::get_argument_meta(int param_1)
...
/* MethodBindTR<Variant, Dictionary const&>::_gen_argument_type(int) const */

byte __thiscall
MethodBindTR<Variant,Dictionary_const&>::_gen_argument_type
          (MethodBindTR<Variant,Dictionary_const&> *this,int param_1)
...
/* MethodBindTR<Variant, Dictionary const&>::get_argument_meta(int) const */

undefined8 MethodBindTR<Variant,Dictionary_const&>::get_argument_meta(int param_1)
...
CallableCustomMethodPointer<ScriptEditor,void,String_const&>::get_argument_count
          (CallableCustomMethodPointer<ScriptEditor,void,String_const&> *this,bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<GDScriptTextDocument,void,String_const&>::get_argument_count
          (CallableCustomMethodPointer<GDScriptTextDocument,void,String_const&> *this,bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<GDScriptTextDocument,void,Ref<GDScript>>::get_argument_count
          (CallableCustomMethodPointer<GDScriptTextDocument,void,Ref<GDScript>> *this,bool *param_1)
...
/* MethodBindTR<Array, Dictionary const&>::~MethodBindTR() */

void __thiscall
MethodBindTR<Array,Dictionary_const&>::~MethodBindTR(MethodBindTR<Array,Dictionary_const&> *this)
...
/* MethodBindTR<Variant, Dictionary const&>::~MethodBindTR() */

void __thiscall
MethodBindTR<Variant,Dictionary_const&>::~MethodBindTR
          (MethodBindTR<Variant,Dictionary_const&> *this)
...
/* ScriptEditor::goto_help(String const&) */

void ScriptEditor::goto_help(String *param_1)
...
/* CallableCustomMethodPointer<GDScriptTextDocument, void, String const&>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<GDScriptTextDocument,void,String_const&>::get_object
          (CallableCustomMethodPointer<GDScriptTextDocument,void,String_const&> *this)
...
/* CallableCustomMethodPointer<GDScriptTextDocument, void, Ref<GDScript> >::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<GDScriptTextDocument,void,Ref<GDScript>>::get_object
          (CallableCustomMethodPointer<GDScriptTextDocument,void,Ref<GDScript>> *this)
...
/* CallableCustomMethodPointer<ScriptEditor, void, String const&>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<ScriptEditor,void,String_const&>::get_object
          (CallableCustomMethodPointer<ScriptEditor,void,String_const&> *this)
...
/* GDScriptTextDocument::_get_class_namev() const */

undefined8 * GDScriptTextDocument::_get_class_namev(void)
...
LAB_0010aa23:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      goto LAB_0010aa23;
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"GDScriptTextDocument");
      goto LAB_0010aa8e;
    }
  }
  StringName::assign_static_unique_class_name
...
/* GDScriptTextDocument::get_class() const */

void GDScriptTextDocument::get_class(void)
...
/* lsp::DocumentLink::to_json() const */

Dictionary * lsp::DocumentLink::to_json(void)
...
/* lsp::Command::to_json() const */

void lsp::Command::to_json(void)
...
/* lsp::MarkupContent::to_json() const */

void lsp::MarkupContent::to_json(void)
...
/* lsp::DocumentSymbol::to_json(bool) const */

Dictionary * lsp::DocumentSymbol::to_json(bool param_1)
...
Dictionary * lsp::CompletionParams::to_json(void)
...
/* lsp::SignatureInformation::to_json() const */

Dictionary * lsp::SignatureInformation::to_json(void)
...
/* lsp::SignatureHelp::to_json() const */

Dictionary * lsp::SignatureHelp::to_json(void)
...
/* List<lsp::DocumentSymbol const*, DefaultAllocator>::~List() */

undefined8 __thiscall
List<lsp::DocumentSymbol_const*,DefaultAllocator>::~List
          (List<lsp::DocumentSymbol_const*,DefaultAllocator> *this)
...
void __thiscall
CallableCustomMethodPointer<GDScriptTextDocument,void,Ref<GDScript>>::call
          (CallableCustomMethodPointer<GDScriptTextDocument,void,Ref<GDScript>> *this,
...
LAB_0010e63d:
  ...
  _err_print_error(&_LC49,"./core/object/callable_method_pointer.h",0x67,
...
/* CallableCustomMethodPointer<GDScriptTextDocument, void, String const&>::call(Variant const**,
   int, Variant&, Callable::CallError&) const */

void __thiscall
CallableCustomMethodPointer<GDScriptTextDocument,void,String_const&>::call
          (CallableCustomMethodPointer<GDScriptTextDocument,void,String_const&> *this,
          Variant **param_1,int param_2,Variant *param_3,CallError *param_4)
...
void __thiscall
CallableCustomMethodPointer<ScriptEditor,void,String_const&>::call
          (CallableCustomMethodPointer<ScriptEditor,void,String_const&> *this,Variant **param_1,
...
/* GDScriptTextDocument::is_class(String const&) const */

undefined8 __thiscall GDScriptTextDocument::is_class(GDScriptTextDocument *this,String *param_1)
...
/* lsp::TextDocumentItem::load(Dictionary const&) */

void __thiscall lsp::TextDocumentItem::load(TextDocumentItem *this,Dictionary *param_1)
...
/* lsp::CompletionParams::load(Dictionary const&) */

void __thiscall lsp::CompletionParams::load(CompletionParams *this,Dictionary *param_1)
...
/* lsp::TextDocumentContentChangeEvent::load(Dictionary const&) */

void __thiscall
lsp::TextDocumentContentChangeEvent::load(TextDocumentContentChangeEvent *this,Dictionary *param_1)
...
/* GDScriptTextDocument::signatureHelp(Dictionary const&) [clone .cold] */

void GDScriptTextDocument::signatureHelp(Dictionary *param_1)
...
/* GDScriptTextDocument::references(Dictionary const&) [clone .cold] */

void GDScriptTextDocument::references(Dictionary *param_1)
...
/* GDScriptTextDocument::initialize() [clone .cold] */

void GDScriptTextDocument::initialize(void)
...
/* GDScriptTextDocument::completion(Dictionary const&) [clone .cold] */

void GDScriptTextDocument::completion(Dictionary *param_1)
...
/* GDScriptTextDocument::documentSymbol(Dictionary const&) [clone .cold] */

void GDScriptTextDocument::documentSymbol(Dictionary *param_1)
...
/* GDScriptTextDocument::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall
GDScriptTextDocument::_get_property_listv(GDScriptTextDocument *this,List *param_1,bool param_2)
...
/* lsp::CompletionItem::load(Dictionary const&) */

void __thiscall lsp::CompletionItem::load(CompletionItem *this,Dictionary *param_1)
...
/* Ref<GDScriptWorkspace>::unref() */

void __thiscall Ref<GDScriptWorkspace>::unref(Ref<GDScriptWorkspace> *this)
...
/* MethodBind* create_method_bind<GDScriptTextDocument, Variant const&>(void
   (GDScriptTextDocument::*)(Variant const&)) */

MethodBind *
create_method_bind<GDScriptTextDocument,Variant_const&>(_func_void_Variant_ptr *param_1)
...
/* MethodBind* create_method_bind<GDScriptTextDocument, Variant, Dictionary const&>(Variant
   (GDScriptTextDocument::*)(Dictionary const&)) */

MethodBind *
create_method_bind<GDScriptTextDocument,Variant,Dictionary_const&>
          (_func_Variant_Dictionary_ptr *param_1)
...
MethodBind *
create_method_bind<GDScriptTextDocument,Array,Dictionary_const&>
          (_func_Array_Dictionary_ptr *param_1)
...
MethodBind *
create_method_bind<GDScriptTextDocument,Dictionary,Dictionary_const&>
...
/* MethodBind* create_method_bind<GDScriptTextDocument, String const&>(void
   (GDScriptTextDocument::*)(String const&)) */

MethodBind * create_method_bind<GDScriptTextDocument,String_const&>(_func_void_String_ptr *param_1)
...
/* GDScriptTextDocument::_initialize_classv() */

void GDScriptTextDocument::_initialize_classv(void)
...
void __thiscall lsp::CompletionItem::~CompletionItem(CompletionItem *this)
...
/* WARNING: Removing unreachable block (ram,0x00111a18) */
...
void __thiscall
MethodBindTR<Array,Dictionary_const&>::validated_call
          (MethodBindTR<Array,Dictionary_const&> *this,Object *param_1,Variant **param_2,
          Variant *param_3)
...
/* MethodBindTR<Array, Dictionary const&>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTR<Array,Dictionary_const&>::ptrcall
          (MethodBindTR<Array,Dictionary_const&> *this,Object *param_1,void **param_2,void *param_3)
...
void __thiscall
MethodBindTR<Variant,Dictionary_const&>::validated_call
          (MethodBindTR<Variant,Dictionary_const&> *this,Object *param_1,Variant **param_2,
          Variant *param_3)
...
/* MethodBindTR<Variant, Dictionary const&>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTR<Variant,Dictionary_const&>::ptrcall
          (MethodBindTR<Variant,Dictionary_const&> *this,Object *param_1,void **param_2,
          void *param_3)
  ...
  *(undefined1 (*) [16])(param_1 + 8) = (undefined1  [16])0x0;
  if (((plVar9 != (long *)0x0) && (plVar9[1] != 0)) && (*(char *)(plVar9[1] + 0x2e) != '\0')) {
    ...
    if (local_68 == (char *)*plVar7) {
      ...
      _err_print_error(&_LC49,"./core/object/method_bind.h",0x207,
...
Object * MethodBindTR<Array,Dictionary_const&>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
Object * MethodBindTR<Variant,Dictionary_const&>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
LAB_00113d60:
    ...
    *in_R9 = 0;
    ...
    Variant::operator_cast_to_Dictionary((Variant *)&local_68);
    (*(code *)pVVar11)((Variant *)local_58,(Variant *)((long)plVar9 + (long)pVVar1),
                       (Variant *)&local_68);
    Variant::operator=((Variant *)param_1,(Variant *)local_58);
    if (Variant::needs_deinit[local_58[0]] != '\0') {
      Variant::_clear_internal();
...
/* MethodBindTR<Array, Dictionary const&>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTR<Array,Dictionary_const&>::_gen_argument_type_info(int param_1)
...
/* MethodBindTR<Variant, Dictionary const&>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTR<Variant,Dictionary_const&>::_gen_argument_type_info(int param_1)
...
void GDScriptTextDocument::_GLOBAL__sub_I__bind_methods(void)

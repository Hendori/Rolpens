...
/* NavMapBuilder3D::get_point_key(Vector3 const&, Vector3 const&) */

ulong NavMapBuilder3D::get_point_key(Vector3 *param_1,Vector3 *param_2)

{
  ...
  if ((float)((uint)fVar2 & _LC1) < _LC0) {
    fVar2 = (float)((uint)((float)(int)fVar2 - (float)(-(uint)(fVar2 < (float)(int)fVar2) & _LC2)) |
                   ~_LC1 & (uint)fVar2);
  }
  fVar3 = *(float *)(param_1 + 4) / *(float *)(param_2 + 4);
  if ((float)((uint)fVar3 & _LC1) < _LC0) {
    fVar3 = (float)((uint)((float)(int)fVar3 - (float)(-(uint)(fVar3 < (float)(int)fVar3) & _LC2)) |
                   ~_LC1 & (uint)fVar3);
  }
  fVar1 = *(float *)(param_1 + 8) / *(float *)(param_2 + 8);
  if ((float)((uint)fVar1 & _LC1) < _LC0) {
    fVar1 = (float)((uint)((float)(int)fVar1 - (float)(-(uint)(fVar1 < (float)(int)fVar1) & _LC2)) |
                   ~_LC1 & (uint)fVar1);
  }
...
/* NavMapBuilder3D::_build_update_map_iteration(NavMapIterationBuild&) */

void NavMapBuilder3D::_build_update_map_iteration(NavMapIterationBuild *param_1)

{
  ...
  *(ulong *)(lVar16 + 0x80) =
       CONCAT44(*(undefined4 *)(lVar16 + 0x50),*(undefined4 *)(param_1 + 0x3c));
...
LAB_00100251:
          ...
          do {
            ...
            *(undefined4 *)((long)puVar10 + 0x34) = 0;
            puVar10[7] = 0;
            puVar10 = puVar11;
          } while ((undefined8 *)(lVar12 + 0x40 + ((ulong)(uVar1 - uVar7) + (ulong)uVar7) * 0x40) !=
                   puVar11);
        }
        *puVar18 = uVar6;
      }
  ...
  if (puVar17 != puVar18) {
    do {
      piVar13 = (int *)HashMap<unsigned_int,LocalVector<gd::Edge::Connection,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,LocalVector<gd::Edge::Connection,unsigned_int,false,false>>>>
                       ::operator[]((HashMap<unsigned_int,LocalVector<gd::Edge::Connection,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,LocalVector<gd::Edge::Connection,unsigned_int,false,false>>>>
                                     *)(lVar16 + 0x88),puVar18);
      if (*piVar13 != 0) {
        *piVar13 = 0;
      }
...
/* NavMapBuilder3D::_build_step_gather_region_polygons(NavMapIterationBuild&) */

void NavMapBuilder3D::_build_step_gather_region_polygons(NavMapIterationBuild *param_1)

{
  ...
  if (puVar8 != puVar9) {
    do {
      piVar4 = (int *)HashMap<unsigned_int,LocalVector<gd::Edge::Connection,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,LocalVector<gd::Edge::Connection,unsigned_int,false,false>>>>
                      ::operator[]((HashMap<unsigned_int,LocalVector<gd::Edge::Connection,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,LocalVector<gd::Edge::Connection,unsigned_int,false,false>>>>
                                    *)(lVar7 + 0x88),puVar9);
      if (*piVar4 != 0) {
        *piVar4 = 0;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* NavMapBuilder3D::_build_step_edge_connection_margin_connections(NavMapIterationBuild&) */

void NavMapBuilder3D::_build_step_edge_connection_margin_connections(NavMapIterationBuild *param_1)
...
LAB_00100c22:
    _err_print_index_error
              ("operator[]","./core/templates/local_vector.h",0xb2,(ulong)uVar9,(ulong)uVar10,
    ...
    do {
      ...
      if ((int)lVar18 != (int)lVar21) {
        ...
        if (*(long *)(lVar13 + 8) != *(long *)(lVar17 + 8)) {
          ...
          fVar24 = ((fVar37 - fVar31) * fVar39 +
                   (fVar36 - fVar19) * fVar38 + (fVar7 - fVar5) * fVar26) / fVar25;
          fVar25 = ((fVar32 - fVar31) * fVar39 +
                   (fVar33 - fVar5) * fVar26 + (fVar30 - fVar19) * fVar38) / fVar25;
          if (0.0 <= fVar24) {
            if (fVar24 <= _LC2) {
...
LAB_00100708:
            ...
            if ((local_f4 - fVar27) * (local_f4 - fVar27) + (fVar28 - fVar35) * (fVar28 - fVar35) +
                (fVar29 - fVar34) * (fVar29 - fVar34) <= fVar23) {
              if (0.0 <= fVar25) {
                if (_LC2 < fVar25) {
                  fVar26 = fVar26 + fVar5;
...
LAB_001007cd:
                fVar25 = (0.0 - fVar24) / (fVar25 - fVar24);
                fVar33 = (fVar33 - fVar7) * fVar25 + fVar7;
                fVar30 = (fVar30 - fVar36) * fVar25 + fVar36;
                fVar32 = (fVar32 - fVar37) * fVar25 + fVar37;
              }
              if ((fVar38 - fVar30) * (fVar38 - fVar30) + (fVar26 - fVar33) * (fVar26 - fVar33) +
                  (fVar39 - fVar32) * (fVar39 - fVar32) <= fVar23) {
                uStack_a8 = plVar4[4];
                ...
                *plVar4 = local_68;
                ...
                puVar22 = (uint *)HashMap<unsigned_int,LocalVector<gd::Edge::Connection,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,LocalVector<gd::Edge::Connection,unsigned_int,false,false>>>>
                                  ::operator[]((HashMap<unsigned_int,LocalVector<gd::Edge::Connection,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,LocalVector<gd::Edge::Connection,unsigned_int,false,false>>>>
                                                *)(lVar11 + 0x88),&local_cc);
                local_98 = local_c8;
                uStack_90 = uStack_c0;
                local_78 = uStack_a8;
                uVar20 = *puVar22;
...
/* NavMapBuilder3D::_build_step_merge_edge_connection_pairs(NavMapIterationBuild&) */

void NavMapBuilder3D::_build_step_merge_edge_connection_pairs(NavMapIterationBuild *param_1)
  ...
  do {
    while( true ) {
      ...
      if (*(int *)(puVar5 + 0xe) != 1) {
        ...
        _err_print_error("_build_step_merge_edge_connection_pairs",
                         "modules/navigation/3d/nav_map_builder_3d.cpp",0xb6,
                         "FATAL: Condition \"pair.size != 1\" is true.",(String_conflict *)&local_c8
                         ,0,0);
        pcVar7 = local_c8;
      ...
      if ((NVar3 != (NavMapIterationBuild)0x0) &&
         (*(char *)(*(long *)(puVar5[4] + 8) + 0x28) != '\0')) {
        local_58 = puVar5[4];
        uStack_50 = puVar5[5];
        local_48 = puVar5[6];
        uStack_40 = puVar5[7];
...
LAB_00101080:
      _err_print_index_error
                ("operator[]","./core/templates/local_vector.h",0xb2,uVar10,(ulong)uVar8,"p_index",
                 "count","",false,true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
      pcVar6 = (code *)invalidInstructionException();
...
/* NavMapBuilder3D::_build_step_navlink_connections(NavMapIterationBuild&) */

void NavMapBuilder3D::_build_step_navlink_connections(NavMapIterationBuild *param_1)
  ...
  if (uVar36 < uVar43) {
    ...
    do {
      ...
      if (*(long *)(lVar38 + 0x28) != 0) {
        LocalVector<gd::Edge,unsigned_int,false,false>::resize
                  ((LocalVector<gd::Edge,unsigned_int,false,false> *)(lVar38 + 0x20),0);
...
LAB_00101ddf:
    ...
    do {
      ...
      *(undefined8 *)(puVar28 + 6) = 0;
      *(undefined8 *)(puVar28 + 8) = 0;
      *(undefined8 *)(puVar28 + 10) = 0;
      puVar28[0xc] = 0;
      puVar28 = puVar29;
    } while ((undefined4 *)(lVar39 + 0x38 + ((ulong)(uVar37 - uVar43) + (ulong)uVar43) * 0x38) !=
             puVar29);
  }
  *(uint *)(lVar7 + 0x50) = uVar36;
  uVar32 = (ulong)uVar41;
            ...
            if (*(char *)(lVar45 + 4) != '\0') {
              ...
              if (local_1cc < 0.0) {
                _err_print_error("has_point","./core/math/aabb.h",0x13c,
                                 ...
                                 ,0,0);
                if ((((float)local_250 < fVar47) || (local_250._4_4_ < fVar20)) ||
                   (local_248 < fVar21)) goto LAB_00101ad2;
LAB_00101c57:
                if ((fVar22 + fVar47 < (float)local_250) || (fVar20 + fVar23 < local_250._4_4_)) {
LAB_00101c74:
                  if ((0.0 <= fVar22) && (0.0 <= fVar23)) goto LAB_00101ab4;
                  goto LAB_00101ad2;
                }
LAB_00101563:
                if (fVar24 + fVar21 < local_248) goto LAB_00101c74;
              }
              else {
...
LAB_00101ad2:
                ...
                else if ((local_1d8 <= (float)local_250) &&
                        ((local_1d4 <= local_250._4_4_ && (local_1d0 <= local_248)))) {
                  if (((float)local_250 <= local_1cc + local_1d8) &&
                     (local_250._4_4_ <= local_1d4 + local_1c8)) goto LAB_00101563;
LAB_00101ab4:
                  if (fVar24 < 0.0) goto LAB_00101ad2;
                }
                ...
                auVar49._8_4_ = uStack_1a4;
                auVar49._0_8_ = auStack_1a0._0_8_;
                if ((((((float)local_244 < fVar47) || (auVar49 = auVar15, local_244._4_4_ < fVar20))
                     || (auVar49 = auVar16, local_23c < fVar21)) ||
                    ((auVar49 = auVar17, fVar22 + fVar47 < (float)local_244 ||
                     (auVar49 = auVar18, fVar20 + fVar23 < local_244._4_4_)))) ||
                   (auVar49 = auVar19, fVar24 + fVar21 < local_23c)) goto LAB_001017d0;
              }
              auVar49._8_4_ = uStack_1a4;
              auVar49._0_8_ = auStack_1a0._0_8_;
              ...
              for (; lVar1 != lVar46; lVar46 = lVar46 + 0x38) {
                ...
                if (2 < *(uint *)(lVar46 + 0x10)) {
                  do {
                    ...
                    local_48 = CONCAT44((int)((ulong)local_48 >> 0x20),
                                        *(undefined4 *)((long)plVar8 + lVar44 + 8));
                    ...
                    fVar47 = ((float)local_250 - (float)local_98._0_4_) *
                             ((float)local_250 - (float)local_98._0_4_) +
                             (local_250._4_4_ - (float)local_98._4_4_) *
                             (local_250._4_4_ - (float)local_98._4_4_) + fVar47 * fVar47;
                    if (fVar47 < fVar13) {
                      local_2d0 = lVar46;
                      fVar13 = fVar47;
                      local_238 = auVar48;
                    ...
                    fVar47 = ((float)local_244 - (float)local_98._0_4_) *
                             ((float)local_244 - (float)local_98._0_4_) +
                             (local_244._4_4_ - (float)local_98._4_4_) *
                             (local_244._4_4_ - (float)local_98._4_4_) + fVar47 * fVar47;
                    if (fVar47 < local_2d4) {
                      local_2d4 = fVar47;
                      local_2c8 = lVar46;
                      local_22c = auVar48;
...
LAB_001017d0:
          ...
          if ((local_2d0 != 0) && (local_2c8 != 0)) {
            ...
            *piVar2 = local_274;
            LocalVector<gd::Edge,unsigned_int,false,false>::resize
                      ((LocalVector<gd::Edge,unsigned_int,false,false> *)(piVar2 + 8),0);
            LocalVector<gd::Edge,unsigned_int,false,false>::resize
                      ((LocalVector<gd::Edge,unsigned_int,false,false> *)(piVar2 + 8),4);
            uVar36 = piVar2[4];
            if (uVar36 < 5) {
...
LAB_00101d7c:
                  pauVar26 = pauVar31 + (ulong)uVar36 * 2;
                  do {
...
LAB_001020f5:
            ...
            auStack_1a0._0_8_ = auVar49._0_8_;
            _err_print_index_error
                      ("operator[]","./core/templates/local_vector.h",0xb2,uVar35,uVar32,"p_index",
                       "count","",false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
            pcVar10 = (code *)invalidInstructionException();
...
/* NavMapBuilder3D::_build_step_find_edge_connection_pairs(NavMapIterationBuild&) */

void NavMapBuilder3D::_build_step_find_edge_connection_pairs(NavMapIterationBuild *param_1)
    ...
    if (uVar16 != uVar21) {
      if (*(long *)(param_1 + 0x50) == 0) {
        *(uint *)(param_1 + 0x70) = uVar16;
        ...
        HashMap<gd::EdgeKey,gd::EdgeConnectionPair,gd::EdgeKey,HashMapComparatorDefault<gd::EdgeKey>,DefaultTypedAllocator<HashMapElement<gd::EdgeKey,gd::EdgeConnectionPair>>>
        ::_resize_and_rehash
                  ((HashMap<gd::EdgeKey,gd::EdgeConnectionPair,gd::EdgeKey,HashMapComparatorDefault<gd::EdgeKey>,DefaultTypedAllocator<HashMapElement<gd::EdgeKey,gd::EdgeConnectionPair>>>
                    *)(param_1 + 0x48),uVar16);
      }
          ...
          do {
            ...
            if ((lVar19 != 0) && (*(int *)(param_1 + 0x74) != 0)) {
              ...
              if (uVar16 != 0) {
                uVar26 = 0;
                while (((uVar24 != uVar16 ||
                        (lVar22 = *(long *)(lVar19 + lVar22 * 8),
                        *(ulong *)(lVar22 + 0x10) != local_a8)) ||
                       (*(ulong *)(lVar22 + 0x18) != local_a0))) {
                  uVar26 = uVar26 + 1;
                  auVar8._8_8_ = 0;
                  ...
                  if ((uVar16 == 0) ||
                     (auVar9._8_8_ = 0, auVar9._0_8_ = uVar16 * uVar17, auVar13._8_8_ = 0,
                     auVar13._0_8_ = uVar27, auVar10._8_8_ = 0,
                     auVar10._0_8_ =
                          ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(param_1 + 0x70) * 4)
                           + uVar21) - SUB164(auVar9 * auVar13,8)) * uVar17, auVar14._8_8_ = 0,
                     auVar14._0_8_ = uVar27, SUB164(auVar10 * auVar14,8) < uVar26))
                  goto LAB_00102940;
                }
...
LAB_00102940:
            ...
            local_68 = 0xffffffff;
            HashMap<gd::EdgeKey,gd::EdgeConnectionPair,gd::EdgeKey,HashMapComparatorDefault<gd::EdgeKey>,DefaultTypedAllocator<HashMapElement<gd::EdgeKey,gd::EdgeConnectionPair>>>
            ::insert((EdgeKey *)&local_b0,(EdgeConnectionPair *)(param_1 + 0x48),SUB81(&local_a8,0))
            ;
            local_dc = local_dc + 1;
            *(int *)(param_1 + 0x28) = *(int *)(param_1 + 0x28) + 1;
            lVar19 = local_b0;
LAB_001027db:
            if (*(int *)(lVar19 + 0x70) < 2) {
              local_78 = 0;
              uStack_80 = 0;
...
LAB_001029d3:
                _err_print_index_error
                          ("operator[]","./core/templates/local_vector.h",0xb2,uVar20,uVar17,
                           "p_index","count","",false,true);
                _err_flush_stdout();
                    /* WARNING: Does not return */
              ...
              *(int *)(lVar19 + 0x70) = iVar1;
              ...
              if (_build_step_find_edge_connection_pairs(NavMapIterationBuild&)::first_print != '\0'
                ...
                _err_print_error("_build_step_find_edge_connection_pairs",
                                 "modules/navigation/3d/nav_map_builder_3d.cpp",0x97,
                                 ...
                                 ,0,0);
                _build_step_find_edge_connection_pairs(NavMapIterationBuild&)::first_print = '\0';
              }
              uVar17 = (ulong)*(uint *)(lVar5 + 0x10);
            }
            uVar28 = uVar28 + 1;
...
/* NavMapBuilder3D::build_navmap_iteration(NavMapIterationBuild&) */

void NavMapBuilder3D::build_navmap_iteration(NavMapIterationBuild *param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashMap<unsigned int, LocalVector<gd::Edge::Connection, unsigned int, false, false>,
   ...
   int, false, false> > > >::operator[](unsigned int const&) */

undefined1  [16] __thiscall
HashMap<unsigned_int,LocalVector<gd::Edge::Connection,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,LocalVector<gd::Edge::Connection,unsigned_int,false,false>>>>
::operator[](HashMap<unsigned_int,LocalVector<gd::Edge::Connection,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,LocalVector<gd::Edge::Connection,unsigned_int,false,false>>>>
             *this,uint *param_1)
  ...
  if (local_68 == (void *)0x0) {
    ...
    *(void **)(this + 8) = local_68;
    if (uVar39 == 0) {
      ...
      if ((pvVar3 < (void *)((long)local_68 + uVar48)) &&
         (local_68 < (void *)((long)pvVar3 + uVar40))) {
        uVar40 = 0;
        do {
    ...
    if (iVar44 != 0) {
      ...
      if (uVar37 != 0) {
        ...
        do {
          if ((uVar53 == uVar37) &&
             (uVar38 == *(uint *)(*(long *)((long)local_68 + lVar46 * 8) + 0x10))) {
...
LAB_001034c4:
      ...
      if (uVar39 != 0) {
        ...
        do {
          if ((uVar37 == uVar39) &&
             (*(uint *)(*(long *)((long)local_68 + lVar46 * 8) + 0x10) == uVar38)) {
          ...
          uVar53 = SUB164(auVar17 * auVar33,8);
                ...
                auVar35._0_8_ = uVar45, lStack_98 = SUB168(auVar19 * auVar35,8),
                uVar54 <= SUB164(auVar19 * auVar35,8)));
      }
    }
  }
LAB_00103070:
  if ((float)uVar51 * __LC11 < (float)(iVar44 + 1)) {
...
/* WARNING: Removing unreachable block (ram,0x00103828) */
/* WARNING: Removing unreachable block (ram,0x00103958) */
/* WARNING: Removing unreachable block (ram,0x00103b20) */
/* WARNING: Removing unreachable block (ram,0x00103964) */
/* WARNING: Removing unreachable block (ram,0x0010396e) */
/* WARNING: Removing unreachable block (ram,0x00103b00) */
/* WARNING: Removing unreachable block (ram,0x0010397a) */
/* WARNING: Removing unreachable block (ram,0x00103984) */
...
/* WARNING: Removing unreachable block (ram,0x001039bc) */
...
/* WARNING: Removing unreachable block (ram,0x001039dc) */
/* WARNING: Removing unreachable block (ram,0x00103a60) */
/* WARNING: Removing unreachable block (ram,0x001039e4) */
/* WARNING: Removing unreachable block (ram,0x001039fa) */
/* WARNING: Removing unreachable block (ram,0x00103a06) */
...
/* LocalVector<gd::Edge, unsigned int, false, false>::resize(unsigned int) */

void __thiscall
LocalVector<gd::Edge,unsigned_int,false,false>::resize
          (LocalVector<gd::Edge,unsigned_int,false,false> *this,uint param_1)
...
/* HashMap<gd::EdgeKey, gd::EdgeConnectionPair, gd::EdgeKey, HashMapComparatorDefault<gd::EdgeKey>,
   ...
   const&, gd::EdgeConnectionPair const&, bool) */

EdgeKey * HashMap<gd::EdgeKey,gd::EdgeConnectionPair,gd::EdgeKey,HashMapComparatorDefault<gd::EdgeKey>,DefaultTypedAllocator<HashMapElement<gd::EdgeKey,gd::EdgeConnectionPair>>>
...
LAB_00103f52:
    if (iVar39 != 0) {
      ...
      if (uVar37 != 0) {
        ...
        do {
          if (((uVar37 == uVar43) &&
              (lVar41 = *(long *)((long)local_f8 + lVar41 * 8), *(long *)(lVar41 + 0x10) == local_e0
              )) && (local_d0 == *(long *)(lVar41 + 0x18))) {
            uVar36 = in_RCX[1];
            pauVar34 = *(undefined1 (**) [16])((long)local_f8 + (ulong)uVar38 * 8);
            *(undefined8 *)pauVar34[2] = *in_RCX;
            *(undefined8 *)(pauVar34[2] + 8) = uVar36;
            uVar36 = in_RCX[3];
            *(undefined8 *)pauVar34[3] = in_RCX[2];
            *(undefined8 *)(pauVar34[3] + 8) = uVar36;
            uVar36 = in_RCX[5];
            *(undefined8 *)pauVar34[4] = in_RCX[4];
            *(undefined8 *)(pauVar34[4] + 8) = uVar36;
            uVar36 = in_RCX[7];
            *(undefined8 *)pauVar34[5] = in_RCX[6];
            *(undefined8 *)(pauVar34[5] + 8) = uVar36;
            uVar36 = in_RCX[9];
            *(undefined8 *)pauVar34[6] = in_RCX[8];
            *(undefined8 *)(pauVar34[6] + 8) = uVar36;
          ...
          uVar38 = SUB164(auVar7 * auVar15,8);
                ...
                (auVar8._8_8_ = 0, auVar8._0_8_ = uVar37 * uVar35, auVar16._8_8_ = 0,
                auVar16._0_8_ = uVar46, auVar9._8_8_ = 0,
                auVar9._0_8_ = ((*(uint *)(hash_table_size_primes +
                                          (ulong)*(uint *)(param_2 + 0x28) * 4) + uVar38) -
                               SUB164(auVar8 * auVar16,8)) * uVar35, auVar17._8_8_ = 0,
                auVar17._0_8_ = uVar46, uVar44 <= SUB164(auVar9 * auVar17,8)));
      }
    }
  }
  if ((float)uVar45 * __LC11 < (float)(iVar39 + 1)) {
    ...
    _resize_and_rehash((HashMap<gd::EdgeKey,gd::EdgeConnectionPair,gd::EdgeKey,HashMapComparatorDefault<gd::EdgeKey>,DefaultTypedAllocator<HashMapElement<gd::EdgeKey,gd::EdgeConnectionPair>>>

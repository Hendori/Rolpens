            ...
            if (0 < *(int *)(param_1 + 8)) {
              do {
                ...
                *(int *)(lVar14 + lVar13 * 4) = iVar17;
                if ((lVar13 != 0) && (iVar9 = *(int *)(lVar14 + -4 + lVar13 * 4), iVar17 != iVar9))
                {
                ...
                if ((iVar16 != 0) && (iVar9 = *(int *)(lVar7 + lVar13 * 4), iVar17 != iVar9)) {
                  piVar12 = (int *)(lVar2 + (ulong)(param_3 * iVar17 + iVar9) * 4);
                  *piVar12 = *piVar12 + 1;
                  piVar12 = (int *)(lVar2 + (ulong)(iVar9 * param_3 + iVar17) * 4);
                  *piVar12 = *piVar12 + 1;
          ...
          do {
            if ((uVar18 != uVar6) && (uVar10 != uVar18)) {
              *(char *)(local_948 + uVar15 * 2) = (char)uVar18;
              uVar1 = *(int *)(lVar2 + uVar8 * 4) +
                      *(int *)(lVar2 + (ulong)((uVar10 - uVar6) + (int)uVar8) * 4);
...
LAB_001005fb:
              ...
              iVar9 = 0;
              do {
                iVar17 = iVar17 + (((uVar19 - 2) - uVar18) + iVar9 * -2) *
                                  *(int *)(lVar2 + (ulong)((uint)local_148[uVar8] + bVar23 * uVar5)
                                                   * 4);
            ...
            *(undefined8 *)local_d80 = *(undefined8 *)puVar20;
            ...
            do {
              uVar1 = puVar4[1] +
                      *(int *)(lVar2 + (ulong)((uint)(byte)*puVar4 + bVar23 * uVar5) * 4);
              puVar4[1] = uVar1;
              if (local_d80[1] < uVar1) {
                local_d80 = puVar4;
              }
...
LAB_00100360:
  ...
  *param_4 = *(undefined4 *)(param_2 + (ulong)bVar23 * 4);
  do {
    param_4[uVar8] =
         *(undefined4 *)
          (param_2 + (ulong)local_148[(ulong)(uVar10 + (int)uVar8) % (ulong)uVar5] * 4);
    uVar8 = uVar8 + 1;
  } while (uVar5 != uVar8);
LAB_001003a1:
  uVar3 = 1;

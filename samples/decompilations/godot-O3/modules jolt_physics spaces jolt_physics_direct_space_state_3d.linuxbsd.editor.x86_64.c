          ...
          while( true ) {
            ...
            fVar16 = JPH::GJKClosestPoint::
                     GetClosestPoints<JPH::ConvexShape::Support,JPH::PointConvexSupport>
                               (local_1998,pPVar5,(float)_LC92,_LC0,(Vec3 *)&local_1ae8,local_1ad8,
                                local_1ac8);
...
{
  return (uint)CONCAT71(0x10f1,(undefined4 *)param_1 ==
...
float JPH::GJKClosestPoint::GetClosestPoints<JPH::ConvexShape::Support,JPH::PointConvexSupport>
                (Support *param_1,PointConvexSupport *param_2,float param_3,float param_4,
                Vec3 *param_5,Vec3 *param_6,Vec3 *param_7)

{
  ...
  *(undefined4 *)(param_1 + 0xc0) = 0;
  local_88 = *(float *)(param_6 + 8) * *(float *)(param_6 + 8) +
             *(float *)(param_6 + 4) * *(float *)(param_6 + 4) + fVar11 * fVar11 + 0.0;
LAB_0010d4b8:
  auVar26 = (**(code **)(*(long *)param_2 + 0x10))
                      (*(undefined8 *)param_6,*(undefined8 *)(param_6 + 8),param_2);
  fVar11 = *(float *)param_5;
  fVar16 = *(float *)(param_5 + 4);
  fVar12 = *(float *)(param_5 + 8);
  fVar13 = *(float *)(param_5 + 0xc);
  ...
  fVar10 = (float)uStack_a0 * *(float *)(param_6 + 8) +
           local_a8._4_4_ * *(float *)(param_6 + 4) + *(float *)param_6 * (float)local_a8 + 0.0;
  if ((fVar10 < 0.0) && (fVar14 = _LC0, param_4 * local_88 < fVar10 * fVar10)) goto LAB_0010d712;
  iVar1 = *(int *)(param_1 + 0xc0);
  iVar9 = iVar1 + 1;
  pSVar8 = param_1 + (long)iVar1 * 0x10;
  *(float *)pSVar8 = (float)local_a8;
  *(float *)(pSVar8 + 4) = local_a8._4_4_;
  *(float *)(pSVar8 + 8) = (float)uStack_a0;
  *(float *)(pSVar8 + 0xc) = uStack_a0._4_4_ - fVar13;
  *(undefined1 (*) [16])(pSVar8 + 0x40) = auVar26;
  pSVar8 = param_1 + (long)iVar1 * 0x10 + 0x80;
  *(float *)pSVar8 = fVar11;
  *(float *)(pSVar8 + 4) = fVar16;
  *(float *)(pSVar8 + 8) = fVar12;
  *(float *)(pSVar8 + 0xc) = fVar13;
  *(int *)(param_1 + 0xc0) = iVar9;
  if (iVar9 == 3) {
    auVar26 = ClosestPoint::GetClosestPointOnTriangle<true>
                         ...
                         *(undefined8 *)(param_1 + 0x20),*(undefined8 *)(param_1 + 0x28),&local_44);
    uStack_a0._0_4_ = auVar26._8_4_;
  }
  else if (iVar9 < 4) {
    if (iVar9 == 1) {
      local_44 = 1;
      auVar26 = *(undefined1 (*) [16])param_1;
      uStack_a0._0_4_ = *(float *)(param_1 + 8);
    }
    else {
...
LAB_0010de90:
    ...
    auVar26 = ClosestPoint::GetClosestPointOnTetrahedron<true>
                         ...
                         *(undefined8 *)(param_1 + 0x30),*(undefined8 *)(param_1 + 0x38),&local_44);
    uStack_a0._0_4_ = auVar26._8_4_;
  }
  fVar14 = (float)uStack_a0 * (float)uStack_a0 +
           auVar26._0_4_ * auVar26._0_4_ + 0.0 + auVar26._4_4_ * auVar26._4_4_;
  if (fVar14 < fVar19) {
    *(long *)param_6 = auVar26._0_8_;
    *(ulong *)(param_6 + 8) = auVar26._8_8_ & 0xffffffff00000000 | (ulong)(uint)(float)uStack_a0;
    if (local_44 == 0xf) {
      fVar14 = 0.0;
...
LAB_0010d776:
    ...
    iVar9 = iVar9 + 1;
    pSVar7 = param_1 + lVar6 * 0x10;
    *(undefined8 *)pSVar7 = *(undefined8 *)pSVar8;
    *(undefined8 *)(pSVar7 + 8) = uVar2;
    uVar2 = *(undefined8 *)(pSVar8 + 0x48);
    *(undefined8 *)(pSVar7 + 0x40) = *(undefined8 *)(pSVar8 + 0x40);
    *(undefined8 *)(pSVar7 + 0x48) = uVar2;
    uVar2 = *(undefined8 *)(pSVar8 + 0x88);
    *(undefined8 *)(pSVar7 + 0x80) = *(undefined8 *)(pSVar8 + 0x80);
    *(undefined8 *)(pSVar7 + 0x88) = uVar2;
    iVar4 = iVar5;
joined_r0x0010d7ad:
    if (iVar4 < iVar1) goto LAB_0010d7af;
    *(int *)(param_1 + 0xc0) = iVar9;
    if (fVar14 <= param_3 * param_3) {
      *(undefined1 (*) [16])param_6 = (undefined1  [16])0x0;
      goto LAB_0010dea7;
    }
    fVar11 = *(float *)(param_1 + 8) * *(float *)(param_1 + 8) +
             *(float *)(param_1 + 4) * *(float *)(param_1 + 4) +
             *(float *)param_1 * *(float *)param_1 + 0.0;
    if (1 < iVar9) {
      pSVar8 = param_1 + 0x10;
      fVar16 = fVar11;
      do {
        pSVar7 = pSVar8 + 0x10;
        fVar11 = *(float *)(pSVar8 + 8) * *(float *)(pSVar8 + 8) +
                 *(float *)pSVar8 * *(float *)pSVar8 + 0.0 +
                 *(float *)(pSVar8 + 4) * *(float *)(pSVar8 + 4);
        if (fVar11 <= fVar16) {
          fVar11 = fVar16;
        }
        pSVar8 = pSVar7;
        fVar16 = fVar11;
      } while (param_1 + (ulong)(iVar9 - 2) * 0x10 + 0x20 != pSVar7);
    }
...
LAB_0010dea7:
    ...
    *(float *)param_6 = 0.0 - *(float *)param_6;
    *(float *)(param_6 + 4) = 0.0 - *(float *)(param_6 + 4);
    *(float *)(param_6 + 8) = 0.0 - *(float *)(param_6 + 8);
    *(float *)(param_6 + 0xc) = 0.0 - *(float *)(param_6 + 0xc);
    fVar16 = fVar19 * _LC25;
...
LAB_0010d6d5:
  if (iVar9 == 2) {
    local_98 = (float)*(undefined8 *)(param_1 + 0x10);
    fStack_94 = (float)((ulong)*(undefined8 *)(param_1 + 0x10) >> 0x20);
    fStack_90 = (float)*(undefined8 *)(param_1 + 0x18);
    local_a8._0_4_ = (float)*(undefined8 *)param_1;
    local_a8._4_4_ = (float)((ulong)*(undefined8 *)param_1 >> 0x20);
    uStack_a0._0_4_ = (float)*(undefined8 *)(param_1 + 8);
    ...
    *(float *)param_7 = *(float *)(param_1 + 0x50) * fVar11 + *(float *)(param_1 + 0x40) * fVar19;
    *(float *)(param_7 + 4) = fVar16 * fVar11 + fVar10 * fVar19;
    *(float *)(param_7 + 8) = fVar12 * fVar11 + fVar15 * fVar19;
    *(float *)(param_7 + 0xc) = fVar13 * fVar11 + fVar17 * fVar19;
    fVar16 = *(float *)(param_1 + 0x94);
    fVar12 = *(float *)(param_1 + 0x98);
    fVar13 = *(float *)(param_1 + 0x9c);
    fVar10 = *(float *)(param_1 + 0x84);
    fVar15 = *(float *)(param_1 + 0x88);
    fVar17 = *(float *)(param_1 + 0x8c);
    *in_R9 = fVar11 * *(float *)(param_1 + 0x90) + fVar19 * *(float *)(param_1 + 0x80);
    in_R9[1] = fVar11 * fVar16 + fVar19 * fVar10;
    in_R9[2] = fVar11 * fVar12 + fVar19 * fVar15;
    in_R9[3] = fVar11 * fVar13 + fVar19 * fVar17;
    goto LAB_0010d712;
  }
  if (iVar9 != 3) {
    if (iVar9 == 1) {
      uVar2 = *(undefined8 *)(param_1 + 0x48);
      *(undefined8 *)param_7 = *(undefined8 *)(param_1 + 0x40);
      *(undefined8 *)(param_7 + 8) = uVar2;
      uVar2 = *(undefined8 *)(param_1 + 0x88);
      *(undefined8 *)in_R9 = *(undefined8 *)(param_1 + 0x80);
      *(undefined8 *)(in_R9 + 2) = uVar2;
    }
    goto LAB_0010d712;
  }
  local_88 = (float)*(undefined8 *)(param_1 + 0x10);
  fStack_84 = (float)((ulong)*(undefined8 *)(param_1 + 0x10) >> 0x20);
  fStack_80 = (float)*(undefined8 *)(param_1 + 0x18);
  local_a8._0_4_ = (float)*(undefined8 *)param_1;
  local_a8._4_4_ = (float)((ulong)*(undefined8 *)param_1 >> 0x20);
  uStack_a0._0_4_ = (float)*(undefined8 *)(param_1 + 8);
  ...
  local_98 = (float)*(undefined8 *)(param_1 + 0x20);
  fStack_94 = (float)((ulong)*(undefined8 *)(param_1 + 0x20) >> 0x20);
  fStack_90 = (float)*(undefined8 *)(param_1 + 0x28);
    ...
    if (fVar13 < _LC99) {
      if (fVar25 <= fVar17) {
        ...
        if (fStack_90 * fStack_90 + fStack_94 * fStack_94 + local_98 * local_98 + 0.0 <=
            ...
            (float)uStack_a0 * (float)uStack_a0) goto LAB_0010e21a;
LAB_0010e127:
        fVar11 = 0.0;
        goto LAB_0010dfc0;
      }
...
LAB_0010dfc0:
  ...
  *(float *)param_7 =
       *(float *)(param_1 + 0x50) * fVar19 + *(float *)(param_1 + 0x40) * fVar16 +
       *(float *)(param_1 + 0x60) * fVar11;
  *(float *)(param_7 + 4) = fVar12 * fVar19 + fVar15 * fVar16 + fVar20 * fVar11;
  *(float *)(param_7 + 8) = fVar13 * fVar19 + fVar17 * fVar16 + fVar21 * fVar11;
  *(float *)(param_7 + 0xc) = fVar10 * fVar19 + fVar18 * fVar16 + fVar22 * fVar11;
  ...
  *in_R9 = fVar11 * *(float *)(param_1 + 0xa0) +
           fVar19 * *(float *)(param_1 + 0x90) + fVar16 * *(float *)(param_1 + 0x80);
  in_R9[1] = fVar11 * fVar20 + fVar19 * fVar12 + fVar16 * fVar15;
  in_R9[2] = fVar11 * fVar21 + fVar19 * fVar13 + fVar16 * fVar17;
  in_R9[3] = fVar11 * fVar22 + fVar19 * fVar10 + fVar16 * fVar18;
LAB_0010d712:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return fVar14;
  }

...
/* EditorHTTPServer::_clear_client() */

void __thiscall EditorHTTPServer::_clear_client(EditorHTTPServer *this)

{
  ...
  *(undefined8 *)(this + 0x11e8) = 0;
  ...
  for (uVar3 = (ulong)(((int)this - (int)(undefined8 *)((ulong)(this + 0x1f8) & 0xfffffffffffffff8))
                       + 0x11f0U >> 3); uVar3 != 0; uVar3 = uVar3 - 1) {
    *puVar4 = 0;
...
/* EditorHTTPServer::_set_internal_certs(Ref<Crypto>) */

void __thiscall EditorHTTPServer::_set_internal_certs(EditorHTTPServer *this,undefined8 *param_2)
...
LAB_001002e2:
  ...
  if ((cVar4 != '\0') && (cVar4 = FileAccess::exists((String *)&local_80), cVar4 != '\0')) {
    ...
    if ((local_a8 == (Object *)0x0) || (cVar4 = RefCounted::init_ref(), cVar4 == '\0')) {
...
LAB_001009c2:
      ...
      local_a8 = pOVar7;
      cVar4 = RefCounted::unreference();
      if ((cVar4 != '\0') && (cVar4 = predelete_handler(local_a8), cVar4 != '\0')) {
...
joined_r0x00100a15:
    ...
    iVar5 = (**(code **)(**(long **)(this + 0x1d0) + 0x1c8))
                      (*(long **)(this + 0x1d0),(String *)&local_88,0);
    if ((iVar5 == 0) && (iVar5 = (**(code **)(**(long **)(this + 0x1d8) + 0x1c8))(), iVar5 == 0))
    goto LAB_00100534;
  }
  (**(code **)(*(long *)*param_2 + 0x158))(&local_58,(long *)*param_2,0x800);
  pOVar6 = *(Object **)(this + 0x1d0);
  pOVar7 = pOVar6;
  if (local_58 == pOVar6) {
LAB_00100356:
...
joined_r0x0010034b:
  ...
  (**(code **)(*(long *)pOVar6 + 0x1d0))(pOVar6,(String *)&local_88,0);
  plVar1 = (long *)*param_2;
  pcVar2 = *(code **)(*plVar1 + 0x160);
  local_60 = 0;
  local_50 = 0xe;
  local_58 = (Object *)0x103b87;
  String::parse_latin1((StrRange *)&local_60);
  local_58 = (Object *)0x103b96;
  local_68 = 0;
  local_50 = 0xe;
  String::parse_latin1((StrRange *)&local_68);
  local_70 = 0;
  local_58 = (Object *)0x103d28;
  local_50 = 0x27;
  String::parse_latin1((StrRange *)&local_70);
  local_78 = (Object *)0x0;
  if ((*(Object **)(this + 0x1d0) != (Object *)0x0) &&
     (local_78 = *(Object **)(this + 0x1d0), cVar4 = RefCounted::reference(), cVar4 == '\0')) {
    local_78 = (Object *)0x0;
  }
  (*pcVar2)(&local_58,plVar1,&local_78,(StrRange *)&local_70,(StrRange *)&local_68,
            (StrRange *)&local_60);
  pOVar6 = *(Object **)(this + 0x1d8);
  pOVar7 = pOVar6;
  if (local_58 == pOVar6) {
...
void __thiscall EditorHTTPServer::stop(EditorHTTPServer *this)
...
void __thiscall EditorHTTPServer::~EditorHTTPServer(EditorHTTPServer *this)
...
/* EditorHTTPServer::listen(int, IPAddress, bool, String, String) */

int EditorHTTPServer::listen
              (Settings *param_1,ulong param_2,Settings param_3,long *param_4,long *param_5)
...
LAB_00100f60:
      iVar4 = TCPServer::listen((ushort)*(undefined8 *)(param_1 + 0x180),
                                (IPAddress *)(param_2 & 0xffff));
      if (iVar4 == 0) {
      ...
      if (pOVar5 != (Object *)0x0) {
        ...
        if (cVar3 != '\0') {
          if ((((*param_4 != 0) && (1 < *(uint *)(*param_4 + -8))) && (*param_5 != 0)) &&
             (1 < *(uint *)(*param_5 + -8))) {
            pOVar6 = (Object *)CryptoKey::create(true);
            if (pOVar6 == (Object *)0x0) {
LAB_0010102c:
              pOVar6 = *(Object **)(param_1 + 0x1d0);
              plVar7 = (long *)0x0;
              if (pOVar6 != (Object *)0x0) {
...
LAB_001010da:
              ...
              _err_print_error("listen","platform/web/export/editor_http_server.cpp",0xdf,
                               "Condition \"err != OK\" is true. Returning: err",0,0);
            }
            else {
              _err_print_error("listen","platform/web/export/editor_http_server.cpp",0xdc,
                               "Condition \"err != OK\" is true. Returning: err",0,0);
            }
            cVar3 = RefCounted::unreference();
            if (cVar3 != '\0') {
...
LAB_00100f7b:
  pthread_mutex_unlock((pthread_mutex_t *)(param_1 + 0x11f8));
...
/* EditorHTTPServer::is_listening() const */

ulong __thiscall EditorHTTPServer::is_listening(EditorHTTPServer *this)

{
  ...
  *(undefined1 (*) [16])(this_02 + 0x11f8) = (undefined1  [16])0x0;
  ...
  pSVar5 = (StrRange *)
           HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>
           ::operator[](this_00,(StrRange *)&lStack_68);
  uStack_58 = 9;
    ...
    if (this_01 != (TCPServer *)pOVar8) {
      *(TCPServer **)(this_02 + 0x180) = this_01;
      ...
      if (((pOVar8 != (Object *)0x0) && (cVar3 = RefCounted::unreference(), cVar3 != '\0')) &&
         (cVar3 = predelete_handler(pOVar8), cVar3 != '\0')) goto LAB_00101943;
    }
  }
  cVar3 = RefCounted::unreference();
...

{
  ...
  *(undefined1 (*) [16])(this + 0x11f8) = (undefined1  [16])0x0;
  ...
  pSVar4 = (StrRange *)
           HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>
           ::operator[](this_00,(StrRange *)&local_50);
  local_40 = 9;
  local_48 = "text/html";
    ...
    if (this_01 != (TCPServer *)pOVar6) {
      *(TCPServer **)(this + 0x180) = this_01;
      ...
      if (((pOVar6 != (Object *)0x0) && (cVar3 = RefCounted::unreference(), cVar3 != '\0')) &&
         (cVar3 = predelete_handler(pOVar6), cVar3 != '\0')) goto LAB_00101943;
    }
  }
  cVar3 = RefCounted::unreference();
...
/* EditorHTTPServer::_send_response() */

void __thiscall EditorHTTPServer::_send_response(EditorHTTPServer *this)

{
  ...
  if ((local_1070 == 0) || (lVar23 = *(long *)(local_1070 + -8), (int)lVar23 < 4)) {
    ...
    operator+((char *)&local_1080,(String *)"Not enough response headers, got: ");
    String::operator+((String *)&local_1058,(String *)&local_1080);
    _err_print_error("_send_response","platform/web/export/editor_http_server.cpp",0x4c,
                     "Condition \"len < 4\" is true.",(String *)&local_1058,0,0);
    pEVar13 = local_1058;
  ...
  if ((local_1060 == (String *)0x0) || (*(long *)(local_1060 + -8) < 2)) {
    _err_print_error("_send_response","platform/web/export/editor_http_server.cpp",0x4f,
                     "Condition \"req.size() < 2\" is true.","Invalid protocol or status code.",0,0)
    ;
  }
  else {
                    ...
                    do {
                      if (uVar21 == uVar16) {
                        cVar14 = String::operator==((String *)
                                                    (*(long *)(*(long *)(this + 400) + lVar22 * 8) +
                                                    0x10),(String *)&local_10b8);
                        if (cVar14 != '\0') {
                          cVar14 = FileAccess::exists((String *)&local_10a8);
                          if (cVar14 != '\0') {
                            plVar18 = (long *)HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>
                                              ::operator[]((
                                                  HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>
                                                  *)(this + 0x188),(String *)&local_10b8);
                            local_10a0 = 0;
                      ...
                      if ((uVar16 == 0) ||
                         (auVar7._8_8_ = 0, auVar7._0_8_ = (ulong)uVar16 * lVar23, auVar11._8_8_ = 0
                         , auVar11._0_8_ = uVar19, auVar8._8_8_ = 0,
                         auVar8._0_8_ = (ulong)((uVar3 + iVar15) - SUB164(auVar7 * auVar11,8)) *
                                        lVar23, auVar12._8_8_ = 0, auVar12._0_8_ = uVar19,
                         SUB164(auVar8 * auVar12,8) < uVar24)) break;
                    } while( true );
                  }
                }
                local_1080 = 0;
...
LAB_0010201b:
      _err_print_index_error
                ("get","./core/templates/cowdata.h",0xdb,lVar20,lVar23,"p_index","size()","",false,
                 true);
      _err_flush_stdout();
...
LAB_001023b0:
    _err_print_error("_send_response","platform/web/export/editor_http_server.cpp",0x52,
                     "Condition \"req[0] != \"GET\" || req[2] != \"HTTP/1.1\"\" is true.",
                     "Invalid method or HTTP version.",0,0);
  }
LAB_00101d67:
  CowData<String>::_unref((CowData<String> *)&local_1060);
LAB_00101d74:
  CowData<String>::_unref((CowData<String> *)&local_1070);
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
  }
...
LAB_001020a6:
  FileAccess::open((String *)&local_1098,(int)(String *)&local_10a8,(Error *)0x1);
  if (local_1098 == (Object *)0x0) {
    _err_print_error("_send_response","platform/web/export/editor_http_server.cpp",0x67,
    ...
    local_1050 = 2;
    String::parse_latin1((StrRange *)&local_1080);
    operator+((char *)&local_1088,(String *)"Content-Type: ");
    ...
    if (iVar15 == 0) {
      do {
        ...
        iVar15 = (**(code **)(**(long **)(this + 0x1c8) + 0x150))
                           (*(long **)(this + 0x1c8),local_1048,uVar19 & 0xffffffff);
      } while (iVar15 == 0);
      _err_print_error("_send_response","platform/web/export/editor_http_server.cpp",0x7e,
                       "Method/function failed.",0,0);
    }
    else {
      _err_print_error("_send_response","platform/web/export/editor_http_server.cpp",0x73,
                       "Method/function failed.",0,0);
    }
LAB_00102298:
    pEVar13 = local_1058;
  ...
  if (((local_1098 != (Object *)0x0) && (cVar14 = RefCounted::unreference(), cVar14 != '\0')) &&
     (cVar14 = predelete_handler(local_1098), cVar14 != '\0')) {
    (**(code **)(*(long *)local_1098 + 0x140))(local_1098);
...
/* EditorHTTPServer::_poll() [clone .part.0] */

void __thiscall EditorHTTPServer::_poll(EditorHTTPServer *this)
...
LAB_001029e4:
        ...
        pOVar9 = (Object *)
                 __dynamic_cast(*(long *)(this + 0x1b8),&Object::typeinfo,&StreamPeer::typeinfo,0);
        if (pOVar9 != pOVar8) {
...
LAB_001027fb:
    ...
    if ((ulong)(lVar6 - *(long *)(this + 0x1e8)) < 0xf4241) {
      ...
      if (plVar5 == (long *)0x0) {
        ...
        if ((pOVar8 == (Object *)0x0) || (cVar3 = RefCounted::init_ref(), cVar3 == '\0')) {
...
joined_r0x00102e01:
        ...
        if ((*(Object **)(this + 0x1d8) != (Object *)0x0) &&
           (local_40 = *(Object **)(this + 0x1d8), cVar3 = RefCounted::reference(), cVar3 == '\0'))
        {
          local_40 = (Object *)0x0;
        }
        local_48 = (Object *)0x0;
        if ((*(Object **)(this + 0x1d0) != (Object *)0x0) &&
           (local_48 = *(Object **)(this + 0x1d0), cVar3 = RefCounted::reference(), cVar3 == '\0'))
        {
          local_48 = (Object *)0x0;
        }
        ...
        if (((*(long *)(this + 0x1b8) != 0) &&
            (pOVar8 = (Object *)
                      __dynamic_cast(*(long *)(this + 0x1b8),&Object::typeinfo,&StreamPeer::typeinfo
                                     ,0), pOVar8 != (Object *)0x0)) &&
        ...
        if (((local_50 != (Object *)0x0) &&
            (cVar3 = RefCounted::unreference(), pOVar8 = local_50, cVar3 != '\0')) &&
        ...
        if (((local_48 != (Object *)0x0) &&
            (cVar3 = RefCounted::unreference(), pOVar8 = local_48, cVar3 != '\0')) &&
           (cVar3 = predelete_handler(local_48), cVar3 != '\0')) {
          (**(code **)(*(long *)pOVar8 + 0x140))(pOVar8);
          Memory::free_static(pOVar8,false);
        }
        if (((local_40 != (Object *)0x0) &&
            (cVar3 = RefCounted::unreference(), pOVar8 = local_40, cVar3 != '\0')) &&
           (cVar3 = predelete_handler(local_40), cVar3 != '\0')) {
          (**(code **)(*(long *)pOVar8 + 0x140))(pOVar8);
          Memory::free_static(pOVar8,false);
        }
        if (iVar4 != 0) goto LAB_00102940;
        plVar5 = *(long **)(this + 0x1c0);
      }
      (**(code **)(*plVar5 + 0x178))();
      iVar4 = (**(code **)(**(long **)(this + 0x1c0) + 400))();
      if (iVar4 == 1) goto LAB_00102830;
      iVar4 = (**(code **)(**(long **)(this + 0x1c0) + 400))();
      if (iVar4 == 2) {
LAB_0010285d:
        iVar4 = *(int *)(this + 0x11f0);
        do {
          iVar1 = iVar4 + -1;
          if (3 < iVar1) {
            if (((this[(long)iVar1 + 0x1f0] == (EditorHTTPServer)0xa) &&
                (this[(long)iVar1 + 0x1ef] == (EditorHTTPServer)0xd)) &&
               ((this[(long)iVar1 + 0x1ee] == (EditorHTTPServer)0xa &&
                (this[(long)iVar1 + 0x1ed] == (EditorHTTPServer)0xd)))) {
              _send_response(this);
              break;
            }
            local_38 = 0;
            if (0xfff < iVar4) {
              _err_print_error("_poll","platform/web/export/editor_http_server.cpp",0xb5,
                               "Condition \"req_pos >= 4096\" is true.",0,0);
              goto LAB_00102830;
            }
          }
          local_38 = 0;
          iVar4 = (**(code **)(**(long **)(this + 0x1c8) + 0x168))
                            (*(long **)(this + 0x1c8),this + (long)iVar4 + 0x1f0,1,&local_38);
          if (iVar4 != 0) {
            _clear_client(this);
            goto LAB_00102830;
          }
...
/* EditorHTTPServer::_server_thread_poll(void*) */

void EditorHTTPServer::_server_thread_poll(void *param_1)
...
LAB_001040c6:
    ...
    *(void **)(this + 8) = __s_00;
    ...
    iVar42 = 0;
LAB_001040a0:
    if ((float)uVar45 * __LC10 < (float)(iVar42 + 1)) goto LAB_001040c6;
  }
  local_58[0] = 0;

...

{
  ...
  if (iVar5 == 0) {
    ...
    uVar3 = *param_2;
    *(ushort *)(param_1 + 1) =
         ((short)param_1[1] + 1U & ~uVar4 | *(short *)(param_2 + 1) + 1U & uVar4) - 1;
...
LAB_00101510:
    if (local_6c == -1) goto LAB_0010155d;
LAB_00101517:
    uVar5 = 0;
  }
  else {
...
LAB_0010139b:
        if ((ulong)(long)param_2 <= uVar8) goto LAB_00101520;
...
LAB_00101552:
    if (local_6c != -1) goto LAB_00101469;
LAB_0010155d:
          ...
          if (iVar5 == 0) {
            ...
            if ((ulong)(uVar16 & 0x3f) == 0x3f) {
              ...
              if ((iVar5 != 0) ||
                 ...
                 lVar19 = local_98, iVar5 != 0)) goto LAB_00101911;
              local_120 = (ulong)local_90._2_2_;
              uVar4 = local_90._2_2_;
            }
...
LAB_001022f2:
      ...
      mbedtls_zeroize_and_free(pvVar7,lVar1);
LAB_0010244d:
      if (*param_6 != 0) goto LAB_00102454;
    }
...
LAB_001047a9:
            ...
            do {
              ...
              if (((iVar2 != 0) ||
                 ...
                 lVar6 = local_78, lVar8 = local_68, iVar2 != 0)) goto joined_r0x00104461;

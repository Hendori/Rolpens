...
/* ResourceFormatDDS::handles_type(String const&) const */

undefined4 __thiscall ResourceFormatDDS::handles_type(ResourceFormatDDS *this,String *param_1)
...
/* ResourceFormatDDS::get_resource_type(String const&) const */

String * ResourceFormatDDS::get_resource_type(String *param_1)
...
/* ResourceFormatDDS::get_recognized_extensions(List<String, DefaultAllocator>*) const */

void __thiscall ResourceFormatDDS::get_recognized_extensions(ResourceFormatDDS *this,List *param_1)
...
LAB_00100b92:
      if ((uVar15 & 0x40) == 0) {
        if ((((uVar15 & 2) != 0) && (iVar7 == 8)) && (uVar13 = 0x1b, iVar18 == 0xff))
        goto LAB_00100f10;
        goto LAB_00100dea;
      }
      if ((uVar15 & 1) == 0) {
        if ((iVar7 != 0x18) || (iVar8 != 0xff0000)) {
          if ((iVar7 == 0x18) && (iVar8 == 0xff)) {
            if ((iVar37 == 0xff00) && (uVar13 = 0x10, iVar17 == 0xff0000)) goto LAB_00100f10;
            goto LAB_00100e18;
          }
          if ((iVar7 == 0x10) && (iVar8 == 0xf800)) {
            if ((iVar37 == 0x7e0) && (uVar13 = 0x15, iVar17 == 0x1f)) goto LAB_00100f10;
            goto LAB_00100e18;
          }
          if (iVar7 != 8) goto LAB_00100e18;
          if (iVar8 == 0xe0) {
            if ((iVar37 == 0x1c) && (uVar13 = 0x16, iVar17 == 3)) goto LAB_00100f10;
            goto LAB_00100e18;
          }
          goto LAB_00100dff;
        }
        if ((iVar37 == 0xff00) && (uVar13 = 0x12, iVar17 == 0xff)) goto LAB_00100f10;
      }
      else {
        bVar46 = iVar7 != 0x20;
        if ((bVar46) || (iVar8 != 0xff0000)) {
          if ((iVar8 != 0xff) || (bVar46)) {
            ...
            if ((iVar8 == 0x7c00) && (bVar6)) {
              ...
              if ((iVar37 != 0xffc00 || iVar17 != 0x3ff) || (iVar18 != -0x40000000))
              goto LAB_00100c23;
              uVar13 = 0x18;
            }
            goto LAB_00100f10;
...
LAB_00102422:
            if ((iVar8 != 0xe0) || (!bVar35)) goto LAB_0010225f;
...
LAB_00100c23:
        if ((iVar7 == 8 && iVar8 == 0xf) && (iVar18 == 0xf0)) {
          uVar13 = 0x1d;
          goto LAB_00100f10;
        }
      }
...
LAB_00100b3f:
    ...
    if (uVar16 == 0x30315844) {
      ...
      uVar22 = (ulong)uVar16;
      if ((0x71 < iVar37 - 2U) || (uVar13 = (uint)(byte)CSWTCH_1408[iVar37 - 2U], uVar13 == 0x1e)) {
LAB_00100dea:
        if ((uVar15 & 1) == 0) {
LAB_00100dff:
          if ((iVar7 != 8) || (uVar13 = 0x1b, iVar8 != 0xff)) {
LAB_00100e18:
            local_68 = 0;
            plVar36 = (long *)(*param_3 + -0x10);
            if (*param_3 != 0) {
...
LAB_0010225f:
          if ((iVar8 != 0xff) || (iVar7 != 0x10)) goto LAB_00100c23;
      ...
      do {
        ...
        if (dds_format_info[lVar28 + 8] == '\0') {
          ...
          if ((1L << ((byte)uVar13 & 0x3f) & 0x24900000U) == 0) {
            ...
            pbVar45 = local_70;
            (**(code **)(*(long *)pOVar38 + 0x220))(pOVar38,local_70,uVar44);
switchD_001018ca_caseD_15:
            iVar7 = (int)(uVar44 / 3) + -1;
            if ((int)(uVar44 / 3) != 0) {
              lVar30 = (long)iVar7;
...
switchD_001018ca_caseD_1b:
          pOVar26 = (Object *)operator_new(0x268,"");
          ...
          if (uVar11 != uVar15) {
            ...
            vformat<String,unsigned_int,unsigned_int>
                      (local_e8,(StrRange *)&local_88,local_c8,uVar11,uVar16);
            _err_print_error("_dds_load_layer","modules/dds/texture_loader_dds.cpp",0x127,local_e8,0
                             ,1);
            pOVar26 = local_58;
          ...
          if (uVar10 != uVar19) {
            ...
            String::parse_latin1((StrRange *)&local_88);
            vformat<String,unsigned_int,unsigned_int>
                      (local_e8,(StrRange *)&local_88,local_c8,uVar10,uVar16);
            _err_print_error("_dds_load_layer","modules/dds/texture_loader_dds.cpp",0x12a,local_e8,0
                             ,1);
            pOVar26 = local_58;
            if (local_58 != (Object *)0x0) {
              LOCK();
          ...
          uVar15 = (((int)(uVar25 / uVar16) * uVar15) / uVar16) *
                   *(int *)(dds_format_info + lVar28 + 0x10);
          if ((uVar9 & 0x80000) == 0) {
            if (uVar12 == 0) goto LAB_00101399;
            pOVar26 = (Object *)0x0;
            _err_print_error("_dds_load_layer","modules/dds/texture_loader_dds.cpp",0x132,
                             "Condition \"p_pitch != 0\" is true. Returning: Ref<Resource>()",
                             "DDS header flags specify that no linear size will given for the top-level image, but a non-zero linear size value is present in the header."
                             ,0,0);
          }
          else {
            if (uVar12 == uVar15) {
LAB_00101399:
              ...
              if (1 < uVar14) {
                do {
                  ...
                  uVar41 = uVar41 + 1;
                  uVar15 = uVar15 + (((uVar43 / uVar16) * uVar32) / uVar16) *
                                    *(int *)(dds_format_info + lVar28 + 0x10);
                } while (uVar14 != uVar41);
              }
              CowData<unsigned_char>::resize<false>
                        ((CowData<unsigned_char> *)&local_70,(ulong)uVar15);
              CowData<unsigned_char>::_copy_on_write((CowData<unsigned_char> *)&local_70);
              (**(code **)(*(long *)pOVar38 + 0x220))(pOVar38,local_70,(ulong)uVar15);
              goto switchD_001018ca_caseD_1b;
            }
            pOVar26 = (Object *)0x0;
            _err_print_error("_dds_load_layer","modules/dds/texture_loader_dds.cpp",0x130,
                             "Condition \"size != p_pitch\" is true. Returning: Ref<Resource>()",
                             "DDS header flags specify that a linear size of the top-level image is present, but the specified size does not match the expected value."
                             ,0,0);
          }
        }
...
LAB_00101d53:
          _err_print_index_error
                    ("operator[]","./core/templates/vector.h",0x38,uVar23,lVar30,"p_index",
        ...
        if (pOVar26 == (Object *)pIVar3) {
          ...
          *plVar36 = (long)pOVar26;
          if (pOVar26 == (Object *)0x0) {
            if ((pIVar3 != (Image *)0x0) && (cVar5 = RefCounted::unreference(), cVar5 != '\0')) {
...
joined_r0x00101d0b:
        ...
        if (((pOVar38 != (Object *)0x0) && (cVar5 = RefCounted::unreference(), cVar5 != '\0')) &&
           (cVar5 = predelete_handler(pOVar38), cVar5 != '\0')) {
      ...
      _err_print_error(&_LC23,"modules/dds/texture_loader_dds.cpp",0x310,
                       "Condition \"layer_count % 6 != 0\" is true. Returning: Ref<Resource>()",0,0)
      ;
      *param_1 = 0;
      goto LAB_00101659;
    }
...
LAB_00102665:
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,0,lVar28,"p_index","size()","",false,true
                  );
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar4 = (code *)invalidInstructionException();
...
LAB_00101f29:
      pOVar38 = (Object *)operator_new(0x2f0,"");
...
LAB_00102036:
      cVar5 = predelete_handler(pOVar38);
joined_r0x00102142:
      if (cVar5 != '\0') {
        (**(code **)(*(long *)pOVar38 + 0x140))(pOVar38);
        Memory::free_static(pOVar38,false);
...
LAB_00100d3e:
    ...
    uVar33 = 0x232;
LAB_00100930:
    _err_print_error(&_LC23,"modules/dds/texture_loader_dds.cpp",uVar33,pcVar29,&local_58,0,0);
    pOVar38 = local_58;
    if (local_58 != (Object *)0x0) {
      LOCK();
  ...
  if (((pOVar21 != (Object *)0x0) && (cVar5 = RefCounted::unreference(), cVar5 != '\0')) &&
     (cVar5 = predelete_handler(pOVar21), cVar5 != '\0')) {
...
/* ResourceFormatDDS::load(String const&, String const&, Error*, bool, float*,
   ResourceFormatLoader::CacheMode) [clone .cold] */

void ResourceFormatDDS::load(void)
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialize_class()::initialized != '\0') goto LAB_00103f2b;
...
/* WARNING: Removing unreachable block (ram,0x001047a8) */
/* WARNING: Removing unreachable block (ram,0x0010463c) */
/* WARNING: Removing unreachable block (ram,0x00104646) */
/* WARNING: Removing unreachable block (ram,0x0010478a) */
/* WARNING: Removing unreachable block (ram,0x00104652) */
/* WARNING: Removing unreachable block (ram,0x0010465c) */
/* WARNING: Removing unreachable block (ram,0x0010476c) */
/* WARNING: Removing unreachable block (ram,0x00104668) */
/* WARNING: Removing unreachable block (ram,0x00104672) */
/* WARNING: Removing unreachable block (ram,0x0010474e) */
/* WARNING: Removing unreachable block (ram,0x0010467e) */
/* WARNING: Removing unreachable block (ram,0x00104688) */
/* WARNING: Removing unreachable block (ram,0x00104730) */
/* WARNING: Removing unreachable block (ram,0x00104694) */
/* WARNING: Removing unreachable block (ram,0x0010469e) */
/* WARNING: Removing unreachable block (ram,0x00104712) */
/* WARNING: Removing unreachable block (ram,0x001046a6) */
/* WARNING: Removing unreachable block (ram,0x001046b0) */
/* WARNING: Removing unreachable block (ram,0x001046f7) */
/* WARNING: Removing unreachable block (ram,0x001046b8) */
/* WARNING: Removing unreachable block (ram,0x001046cd) */
/* WARNING: Removing unreachable block (ram,0x001046d9) */
...
/* WARNING: Removing unreachable block (ram,0x001048e8) */
/* WARNING: Removing unreachable block (ram,0x00104a18) */
/* WARNING: Removing unreachable block (ram,0x00104be0) */
/* WARNING: Removing unreachable block (ram,0x00104a24) */
/* WARNING: Removing unreachable block (ram,0x00104a2e) */
/* WARNING: Removing unreachable block (ram,0x00104bc0) */
/* WARNING: Removing unreachable block (ram,0x00104a3a) */
/* WARNING: Removing unreachable block (ram,0x00104a44) */
/* WARNING: Removing unreachable block (ram,0x00104ba0) */
/* WARNING: Removing unreachable block (ram,0x00104a50) */
/* WARNING: Removing unreachable block (ram,0x00104a5a) */
/* WARNING: Removing unreachable block (ram,0x00104b80) */
/* WARNING: Removing unreachable block (ram,0x00104a66) */
/* WARNING: Removing unreachable block (ram,0x00104a70) */
/* WARNING: Removing unreachable block (ram,0x00104b60) */
/* WARNING: Removing unreachable block (ram,0x00104a7c) */
/* WARNING: Removing unreachable block (ram,0x00104a86) */
/* WARNING: Removing unreachable block (ram,0x00104b40) */
/* WARNING: Removing unreachable block (ram,0x00104a92) */
/* WARNING: Removing unreachable block (ram,0x00104a9c) */
/* WARNING: Removing unreachable block (ram,0x00104b20) */
/* WARNING: Removing unreachable block (ram,0x00104aa4) */
/* WARNING: Removing unreachable block (ram,0x00104aba) */
/* WARNING: Removing unreachable block (ram,0x00104ac6) */

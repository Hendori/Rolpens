...
void __thiscall ThemeOwner::_owner_context_changed(ThemeOwner *this)
...
/* ThemeOwner::set_owner_node(Node*) */

void __thiscall ThemeOwner::set_owner_node(ThemeOwner *this,Node *param_1)
...
/* ThemeOwner::get_owner_node() const */

long __thiscall ThemeOwner::get_owner_node(ThemeOwner *this)
...
/* ThemeOwner::has_owner_node() const */

bool __thiscall ThemeOwner::has_owner_node(ThemeOwner *this)
...
/* ThemeOwner::_get_active_owner_context() const */

void __thiscall ThemeOwner::_get_active_owner_context(ThemeOwner *this)
...
ThemeOwner::propagate_theme_changed
          (ThemeOwner *this,Node *param_1,Node *param_2,bool param_3,bool param_4)
...
/* ThemeOwner::assign_theme_on_parented(Node*) */

void __thiscall ThemeOwner::assign_theme_on_parented(ThemeOwner *this,Node *param_1)
...
LAB_001004a0:
        propagate_theme_changed(this,param_1,pNVar4,false,true);
        return;
      }
    }
  }
...
/* ThemeOwner::clear_theme_on_unparented(Node*) */

void __thiscall ThemeOwner::clear_theme_on_unparented(ThemeOwner *this,Node *param_1)

{
  ...
  if (lVar3 != 0) {
    ...
    if (lVar3 != 0) {
      ...
      if (cVar2 != '\0') {
LAB_00100550:
        propagate_theme_changed(this,param_1,(Node *)0x0,false,true);
        return;
      }
    }
  }
...
/* ThemeOwner::_get_owner_node_theme(Node*) const */

Node * ThemeOwner::_get_owner_node_theme(Node *param_1)
...
/* ThemeOwner::_get_next_owner_node(Node*) const */

undefined8 ThemeOwner::_get_next_owner_node(Node *param_1)
...
/* ThemeOwner::set_owner_context(ThemeContext*, bool) */

void __thiscall ThemeOwner::set_owner_context(ThemeOwner *this,ThemeContext *param_1,bool param_2)
...
LAB_00100850:
    ...
    create_custom_callable_function_pointer<ThemeOwner>
              (local_58,(char *)this,(_func_void *)"&ThemeOwner::_owner_context_changed");
...
void ThemeOwner::get_theme_type_dependencies(Node *param_1,StringName *param_2,Vector *param_3)
...
LAB_00100d41:
          if ((StringName::configured != '\0') && (local_58 != (StringName *)0x0)) {
            StringName::unref();
          }
        }
        else {
        ...
        if ((*(long *)(param_1 + 0x180) != 0) || (*(long *)(param_1 + 0x188) != 0)) {
          do {
            while( true ) {
              ...
              if (((local_68 != (StringName *)0x0) &&
                  (cVar2 = RefCounted::unreference(), pSVar5 = local_68, cVar2 != '\0')) &&
                 (cVar2 = predelete_handler((Object *)local_68), cVar2 != '\0')) break;
...
LAB_00100c30:
        ...
        if ((local_50[0] != (long *)0x0) &&
           (lVar3 = local_50[0][-1], local_50[0] + lVar3 != local_50[0])) {
          plVar6 = local_50[0];
          do {
            if (*plVar6 != 0) {
              local_60 = (StringName *)0x0;
              ...
              pSVar5 = local_68;
              if ((StringName::configured != '\0') &&
                 (((local_68 == (StringName *)0x0 ||
                   (StringName::unref(), StringName::configured != '\0')) &&
                  (local_60 != (StringName *)0x0)))) {
                StringName::unref();
              }
              if (pSVar5 != pSVar1) {
                Theme::get_type_dependencies
                          ((StringName *)*plVar6,(StringName *)&local_78,(Vector *)&local_70);
...
joined_r0x00100e0e:
      if (((StringName::configured != '\0') &&
          ((local_70 == (StringName *)0x0 || (StringName::unref(), StringName::configured != '\0')))
          ) && (local_78 != (StringName *)0x0)) {
        StringName::unref();
      }
      goto LAB_00100ace;
    }
  }
  _err_print_error("get_theme_type_dependencies","scene/theme/theme_owner.cpp",0xcd,
                   "Condition \"!for_c && !for_w\" is true.",
                   "Only Control and Window nodes and derivatives can be polled for theming.",0,0);
LAB_00100ace:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
...
undefined4 *
ThemeOwner::get_theme_item_in_types
          (undefined4 *param_1,Node *param_2,undefined4 param_3,undefined8 param_4,long param_5)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (lVar4 == 0) {
    _err_print_error("get_theme_item_in_types","scene/theme/theme_owner.cpp",0xfd,
                     "Condition \"p_theme_types.is_empty()\" is true. Returning: Variant()",
                     "At least one theme type must be specified.",0,0);
    *param_1 = 0;
            ...
            while (_get_owner_node_theme((Node *)&local_58), local_58 != (Object *)0x0) {
              ...
              if (cVar3 != '\0') {
                ...
                if (((local_58 == (Object *)0x0) ||
                    (cVar3 = RefCounted::unreference(), local_60 = local_58, cVar3 == '\0')) ||
                   (cVar3 = predelete_handler(local_58), cVar3 == '\0')) goto LAB_00100fd7;
                goto LAB_00101105;
              }
              if (((local_58 == (Object *)0x0) ||
                  (cVar3 = RefCounted::unreference(), pOVar2 = local_58, cVar3 == '\0')) ||
                 (cVar3 = predelete_handler(local_58), cVar3 == '\0')) break;
              lVar4 = lVar4 + 8;
...
LAB_00100f80:
        lVar4 = _get_next_owner_node(param_2);
        if (lVar4 == 0) break;
        lVar4 = *(long *)(param_5 + 8);
      } while( true );
    }
    ...
    if (local_50[0] != (long *)0x0) {
      ...
      for (plVar5 = local_50[0]; local_50[0] + lVar4 != plVar5; plVar5 = plVar5 + 1) {
        ...
        if (((lVar6 != 0) && (lVar7 = *(long *)(param_5 + 8), lVar7 != 0)) &&
           (lVar1 = lVar7 + *(long *)(lVar7 + -8) * 8, lVar1 != lVar7)) {
          while( true ) {
...
ThemeOwner::has_theme_item_in_types
          (ThemeOwner *this,undefined4 param_2,undefined8 param_3,long param_4)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (lVar4 == 0) {
    _err_print_error("has_theme_item_in_types","scene/theme/theme_owner.cpp",0x121,
                     "Condition \"p_theme_types.is_empty()\" is true. Returning: false",
                     "At least one theme type must be specified.",0,0);
    uVar5 = 0;
  }
  else {
    ...
    if (local_50[0] != (long *)0x0) {
      ...
      for (plVar6 = local_50[0]; local_50[0] + lVar4 != plVar6; plVar6 = plVar6 + 1) {
        ...
        if (((lVar7 != 0) && (lVar8 = *(long *)(param_4 + 8), lVar8 != 0)) &&
           (lVar1 = lVar8 + *(long *)(lVar8 + -8) * 8, lVar1 != lVar8)) {
          do {
...
/* ThemeOwner::get_theme_default_base_scale() */

void __thiscall ThemeOwner::get_theme_default_base_scale(ThemeOwner *this)
...
/* ThemeOwner::get_theme_default_font() */

void ThemeOwner::get_theme_default_font(void)
...
/* ThemeOwner::get_theme_default_font_size() */

ulong __thiscall ThemeOwner::get_theme_default_font_size(ThemeOwner *this)
...
/* CallableCustomMethodPointer<ThemeOwner, void>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<ThemeOwner,void>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<ThemeOwner,void> *this)
...
/* CallableCustomMethodPointer<ThemeOwner, void>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<ThemeOwner,void>::get_argument_count
          (CallableCustomMethodPointer<ThemeOwner,void> *this,bool *param_1)
...
/* CallableCustomMethodPointer<ThemeOwner, void>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<ThemeOwner,void>::get_object
          (CallableCustomMethodPointer<ThemeOwner,void> *this)
...
void __thiscall
CallableCustomMethodPointer<ThemeOwner,void>::call
          (CallableCustomMethodPointer<ThemeOwner,void> *this,Variant **param_1,int param_2,
...
LAB_00101ecf:
    ...
    _err_print_error(&_LC7,"./core/object/callable_method_pointer.h",0x67,
...
ThemeOwner *
create_custom_callable_function_pointer<ThemeOwner>
          (ThemeOwner *param_1,char *param_2,_func_void *param_3)

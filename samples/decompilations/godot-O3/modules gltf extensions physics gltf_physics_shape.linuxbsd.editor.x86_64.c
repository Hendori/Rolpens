...
/* GLTFPhysicsShape::get_size() const */

undefined1  [16] __thiscall GLTFPhysicsShape::get_size(GLTFPhysicsShape *this)
...
/* GLTFPhysicsShape::set_size(Vector3) */

void GLTFPhysicsShape::set_size(undefined8 param_1,undefined4 param_2,long param_3)
...
/* GLTFPhysicsShape::get_radius() const */

undefined4 __thiscall GLTFPhysicsShape::get_radius(GLTFPhysicsShape *this)
...
/* GLTFPhysicsShape::set_radius(float) */

void __thiscall GLTFPhysicsShape::set_radius(GLTFPhysicsShape *this,float param_1)
...
/* GLTFPhysicsShape::get_height() const */

undefined4 __thiscall GLTFPhysicsShape::get_height(GLTFPhysicsShape *this)
...
/* GLTFPhysicsShape::set_height(float) */

void __thiscall GLTFPhysicsShape::set_height(GLTFPhysicsShape *this,float param_1)
...
/* GLTFPhysicsShape::get_is_trigger() const */

GLTFPhysicsShape __thiscall GLTFPhysicsShape::get_is_trigger(GLTFPhysicsShape *this)
...
/* GLTFPhysicsShape::set_is_trigger(bool) */

void __thiscall GLTFPhysicsShape::set_is_trigger(GLTFPhysicsShape *this,bool param_1)
...
/* GLTFPhysicsShape::get_mesh_index() const */

undefined4 __thiscall GLTFPhysicsShape::get_mesh_index(GLTFPhysicsShape *this)
...
/* GLTFPhysicsShape::set_mesh_index(int) */

void __thiscall GLTFPhysicsShape::set_mesh_index(GLTFPhysicsShape *this,int param_1)
...
/* Ref<Shape3D>::TEMPNAMEPLACEHOLDERVALUE(Ref<Shape3D> const&) [clone .isra.0] */

void __thiscall Ref<Shape3D>::operator=(Ref<Shape3D> *this,Ref *param_1)
...
/* GLTFPhysicsShape::set_importer_mesh(Ref<ImporterMesh>) */

void __thiscall GLTFPhysicsShape::set_importer_mesh(GLTFPhysicsShape *this,long *param_2)
...
/* GLTFPhysicsShape::get_importer_mesh() const */

void GLTFPhysicsShape::get_importer_mesh(void)
...
/* Ref<ImporterMesh>::TEMPNAMEPLACEHOLDERVALUE(Ref<ImporterMesh> const&) [clone .isra.0] */

void __thiscall Ref<ImporterMesh>::operator=(Ref<ImporterMesh> *this,Ref *param_1)
...
/* GLTFPhysicsShape::set_shape_type(String) */

void __thiscall GLTFPhysicsShape::set_shape_type(GLTFPhysicsShape *this,CowData *param_2)
...
/* GLTFPhysicsShape::get_shape_type() const */

void GLTFPhysicsShape::get_shape_type(void)
...
/* GLTFPhysicsShape::to_dictionary() const */

void GLTFPhysicsShape::to_dictionary(void)
    ...
    if (cVar1 == '\0') {
      ...
      if (cVar1 == '\0') {
        ...
        if (cVar1 == '\0') {
          ...
          if ((cVar1 == '\0') && (cVar1 = String::operator==(this,"convex"), cVar1 == '\0'))
          goto LAB_00100766;
...
/* GLTFPhysicsShape::from_dictionary(Dictionary) */

GLTFPhysicsShape * __thiscall
...

{
  ...
  if (cVar2 == '\0') {
    _err_print_error("from_dictionary","modules/gltf/extensions/physics/gltf_physics_shape.cpp",
                     0x10f,
                     "Condition \"!p_dictionary.has(\"type\")\" is true. Returning: Ref<GLTFPhysicsShape>()"
                     ,"Failed to parse GLTFPhysicsShape, missing required field \'type\'.",0,0);
    *(undefined8 *)this = 0;
    goto LAB_00100ee4;
  }
  local_90 = (Object *)0x0;
  ...
  if (((((cVar2 != '\0') &&
        (cVar2 = String::operator!=((String *)&local_88,"capsule"), cVar2 != '\0')) &&
       (cVar2 = String::operator!=((String *)&local_88,"cylinder"), cVar2 != '\0')) &&
      ((cVar2 = String::operator!=((String *)&local_88,"sphere"), cVar2 != '\0' &&
       (cVar2 = String::operator!=((String *)&local_88,"convex"), cVar2 != '\0')))) &&
     (cVar2 = String::operator!=((String *)&local_88,"trimesh"), cVar2 != '\0')) {
    local_70 = 0;
    String::parse_latin1
              ((String *)&local_70,
               "\'. Only box, capsule, cylinder, sphere, convex, and trimesh are supported.");
    operator+((char *)local_78,(String *)"GLTFPhysicsShape: Error parsing unknown shape type \'");
    String::operator+((String *)&local_68,local_78);
    _err_print_error("from_dictionary","modules/gltf/extensions/physics/gltf_physics_shape.cpp",
                     0x118,(String *)&local_68,0,0);
  ...
  if (cVar2 != '\0') {
    ...
    if (iVar4 == 3) {
      ...
      *(ulong *)(pOVar1 + 0x248) = CONCAT44(fVar7,fVar8);
      ...
      _err_print_error("from_dictionary","modules/gltf/extensions/physics/gltf_physics_shape.cpp",
                       299,
                       "GLTFPhysicsShape: Error parsing the size, it must have exactly 3 numbers.",0
                       ,0);
    }
...
LAB_00100e9a:
  ...
  if ((iVar4 < 0) &&
    ...
    operator+((char *)local_78,
              (String *)"Error parsing GLTFPhysicsShape: The mesh-based shape type \'");
    String::operator+((String *)&local_68,local_78);
    _err_print_error("from_dictionary","modules/gltf/extensions/physics/gltf_physics_shape.cpp",
                     0x135,(String *)&local_68,0,0);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_68);
    CowData<char32_t>::_unref((CowData<char32_t> *)local_78);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_70);
  }
      ...
      if (cVar2 == '\0') {
        ...
        if (cVar2 == '\0') {
          ...
          operator+((char *)&local_48,
                    (String *)
                    "GLTFPhysicsShape: Error converting to a shape resource: Shape type \'");
          String::operator+((String *)&local_38,(String *)&local_48);
          _err_print_error("to_resource","modules/gltf/extensions/physics/gltf_physics_shape.cpp",
                           0x108,(String *)&local_38,0,0);
        ...
        if (*(long *)(in_RSI + 0x268) == 0) {
          pcVar6 = 
          "GLTFPhysicsShape: Error converting concave mesh shape to a shape resource: The mesh resource is null."
          ;
          uVar5 = 0x104;
          goto LAB_0010381c;
        }
...
LAB_001036bb:
        ...
        if (*(long *)(in_RSI + 0x268) == 0) {
          pcVar6 = 
          "GLTFPhysicsShape: Error converting convex hull shape to a shape resource: The mesh resource is null."
          ;
          uVar5 = 0x100;
LAB_0010381c:
          _err_print_error("to_resource","modules/gltf/extensions/physics/gltf_physics_shape.cpp",
                           uVar5,
                           "Condition \"importer_mesh.is_null()\" is true. Returning: _shape_cache",
                           pcVar6,0,0);
        ...
        if (((local_40 != (SphereShape3D *)0x0) &&
            (cVar2 = RefCounted::unreference(), pSVar4 = local_40, cVar2 != '\0')) &&
...
LAB_00103110:
    ...
    if (cVar2 != '\0') {
LAB_00103120:
      cVar2 = predelete_handler((Object *)pBVar7);
      if (cVar2 != '\0') {
...
/* GLTFPhysicsShape::to_node(bool) */

CollisionShape3D * GLTFPhysicsShape::to_node(bool param_1)
...
/* GLTFPhysicsShape::from_resource(Ref<Shape3D> const&) */

GLTFPhysicsShape * __thiscall GLTFPhysicsShape::from_resource(GLTFPhysicsShape *this,Ref *param_1)

{
  ...
  *(undefined8 *)this = 0;
  ...
  lVar8 = *(long *)param_1;
  if (lVar8 == 0) {
    _err_print_error("from_resource","modules/gltf/extensions/physics/gltf_physics_shape.cpp",0xbb,
                     "Condition \"p_shape_resource.is_null()\" is true. Returning: gltf_shape",
                     "Tried to create a GLTFPhysicsShape from a Shape3D resource, but the given resource was null."
                     ,0,0);
    goto LAB_00104426;
  }
  ...
  if (lVar6 == 0) {
    ...
    if (lVar6 != 0) {
      ...
      if (((pOVar7 != (Object *)0x0) &&
          (pOVar7 = (Object *)__dynamic_cast(pOVar7,&Object::typeinfo,&CapsuleShape3D::typeinfo,0),
...
joined_r0x00104771:
    ...
    if (lVar6 != 0) {
      ...
      pOVar7 = *(Object **)param_1;
      if (((pOVar7 != (Object *)0x0) &&
          (pOVar7 = (Object *)__dynamic_cast(pOVar7,&Object::typeinfo,&CylinderShape3D::typeinfo,0),
          pOVar7 != (Object *)0x0)) && (cVar5 = RefCounted::reference(), cVar5 == '\0')) {
        pOVar7 = (Object *)0x0;
      }
      lVar8 = *(long *)this;
    ...
    if (lVar6 != 0) {
      ...
      pOVar7 = *(Object **)param_1;
      if (((pOVar7 != (Object *)0x0) &&
          (pOVar7 = (Object *)__dynamic_cast(pOVar7,&Object::typeinfo,&SphereShape3D::typeinfo,0),
          pOVar7 != (Object *)0x0)) && (cVar5 = RefCounted::reference(), cVar5 == '\0')) {
        pOVar7 = (Object *)0x0;
      }
      lVar8 = *(long *)this;
    ...
    if (lVar6 == 0) {
      ...
      if (lVar8 != 0) {
        ...
        if (((pOVar7 != (Object *)0x0) &&
            (pOVar7 = (Object *)
                      __dynamic_cast(pOVar7,&Object::typeinfo,&ConcavePolygonShape3D::typeinfo,0),
            pOVar7 != (Object *)0x0)) && (cVar5 = RefCounted::reference(), cVar5 == '\0')) {
          pOVar7 = (Object *)0x0;
        }
        local_b0 = (Ref *)0x0;
        ...
        ImporterMesh::add_surface
                  (pRVar3,3,local_a8,local_98,local_90,&local_88,(CowData<char32_t> *)&local_80,0);
        Array::~Array(local_98);
        Array::~Array(local_a0);
        Dictionary::~Dictionary(local_90);
        if (((local_88 != (Ref *)0x0) &&
            (cVar5 = RefCounted::unreference(), pRVar4 = local_88, cVar5 != '\0')) &&
           (cVar5 = predelete_handler((Object *)local_88), cVar5 != '\0')) {
      ...
      _err_print_error("from_resource","modules/gltf/extensions/physics/gltf_physics_shape.cpp",0xe0
                       ,(String *)&local_78,0,0);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_78);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_88);
    ...
    if (((pOVar7 != (Object *)0x0) &&
        (pOVar7 = (Object *)
                  __dynamic_cast(pOVar7,&Object::typeinfo,&ConvexPolygonShape3D::typeinfo,0),
        pOVar7 != (Object *)0x0)) && (cVar5 = RefCounted::reference(), cVar5 == '\0')) {
      pOVar7 = (Object *)0x0;
    }
    ...
    _err_print_error("from_resource","modules/gltf/extensions/physics/gltf_physics_shape.cpp",0xd3,
                     "Condition \"importer_mesh.is_null()\" is true. Returning: gltf_shape",
                     "GLTFPhysicsShape: Failed to convert convex hull points to a mesh.",0,0);
    Ref<ImporterMesh>::unref((Ref<ImporterMesh> *)&local_88);
    CowData<Vector3>::_unref((CowData<Vector3> *)&local_70);
    cVar5 = RefCounted::unreference();
  }
    ...
    pOVar7 = *(Object **)param_1;
    if (((pOVar7 != (Object *)0x0) &&
        (pOVar7 = (Object *)__dynamic_cast(pOVar7,&Object::typeinfo,&BoxShape3D::typeinfo,0),
        pOVar7 != (Object *)0x0)) && (cVar5 = RefCounted::reference(), cVar5 == '\0')) {
      pOVar7 = (Object *)0x0;
    }
    lVar8 = *(long *)this;
    local_64 = BoxShape3D::get_size();
    local_58 = local_64._0_8_;
    local_50._0_4_ = local_64._8_4_;
    *(undefined1 (*) [12])(lVar8 + 0x248) = local_64;
    cVar5 = RefCounted::unreference();
    auVar2 = local_64;
joined_r0x001045ec:
    if (cVar5 != '\0') {
...
LAB_001043e4:
    ...
    pOVar7 = *(Object **)(lVar8 + 0x270);
    local_64 = auVar2;
    if (pOVar1 == pOVar7) goto LAB_00104426;
    *(Object **)(lVar8 + 0x270) = pOVar1;
    if (pOVar1 != (Object *)0x0) {
    ...
    if (pOVar7 == (Object *)0x0) goto LAB_00104426;
    cVar5 = RefCounted::unreference();
  }
  if (cVar5 != '\0') {
    cVar5 = predelete_handler(pOVar7);
...
/* GLTFPhysicsShape::from_node(CollisionShape3D const*) */
...

{
  ...
  *(undefined8 *)this = 0;
  if (param_1 == (CollisionShape3D *)0x0) {
    _err_print_error("from_node","modules/gltf/extensions/physics/gltf_physics_shape.cpp",0xa5,
                     "Parameter \"p_godot_shape_node\" is null.",
                     "Tried to create a GLTFPhysicsShape from a CollisionShape3D node, but the given node was null."
                     ,0,0);
    goto LAB_00104d56;
  }
  CollisionShape3D::get_shape();
  if (local_40 == (Object *)0x0) {
    _err_print_error("from_node","modules/gltf/extensions/physics/gltf_physics_shape.cpp",0xa7,
                     "Condition \"shape_resource.is_null()\" is true. Returning: gltf_shape",
                     "Tried to create a GLTFPhysicsShape from a CollisionShape3D node, but the given node had a null shape."
                     ,0,0);
  }
  else {
...
LAB_00104cff:
      ...
      *(Object **)this = local_38;
      if (local_38 != (Object *)0x0) {
        ...
        if (((pOVar1 != (Object *)0x0) && (cVar2 = RefCounted::unreference(), cVar2 != '\0')) &&
           (cVar2 = predelete_handler(pOVar1), cVar2 != '\0')) goto LAB_00104ce3;
        goto LAB_00104cff;
      }
      if (((pOVar1 != (Object *)0x0) && (cVar2 = RefCounted::unreference(), cVar2 != '\0')) &&
         (cVar2 = predelete_handler(pOVar1), cVar2 != '\0')) {
LAB_00104ce3:
    ...
    if ((lVar3 != 0) &&
       (lVar3 = __dynamic_cast(lVar3,&Object::typeinfo,&Area3D::typeinfo,0), lVar3 != 0)) {
...
{
  return (uint)CONCAT71(0x1159,(undefined4 *)param_1 == &Resource::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1158,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1159,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1159,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}
...
/* MethodBindTRC<Ref<ImporterMesh>>::_gen_argument_type(int) const */

undefined8 MethodBindTRC<Ref<ImporterMesh>>::_gen_argument_type(int param_1)
...
/* MethodBindTRC<Ref<ImporterMesh>>::get_argument_meta(int) const */

undefined8 MethodBindTRC<Ref<ImporterMesh>>::get_argument_meta(int param_1)
...
/* MethodBindTRS<Ref<GLTFPhysicsShape>, Dictionary>::_gen_argument_type(int) const */

char __thiscall
MethodBindTRS<Ref<GLTFPhysicsShape>,Dictionary>::_gen_argument_type
          (MethodBindTRS<Ref<GLTFPhysicsShape>,Dictionary> *this,int param_1)
...
/* MethodBindTRS<Ref<GLTFPhysicsShape>, Dictionary>::get_argument_meta(int) const */

undefined8 MethodBindTRS<Ref<GLTFPhysicsShape>,Dictionary>::get_argument_meta(int param_1)
...
/* MethodBindTR<Ref<Shape3D>, bool>::_gen_argument_type(int) const */

int __thiscall
MethodBindTR<Ref<Shape3D>,bool>::_gen_argument_type
          (MethodBindTR<Ref<Shape3D>,bool> *this,int param_1)
...
/* MethodBindTR<Ref<Shape3D>, bool>::get_argument_meta(int) const */

undefined8 MethodBindTR<Ref<Shape3D>,bool>::get_argument_meta(int param_1)
...
/* MethodBindTRS<Ref<GLTFPhysicsShape>, Ref<Shape3D> const&>::_gen_argument_type(int) const */

undefined8 MethodBindTRS<Ref<GLTFPhysicsShape>,Ref<Shape3D>const&>::_gen_argument_type(int param_1)
...
/* MethodBindTRS<Ref<GLTFPhysicsShape>, Ref<Shape3D> const&>::get_argument_meta(int) const */

undefined8 MethodBindTRS<Ref<GLTFPhysicsShape>,Ref<Shape3D>const&>::get_argument_meta(int param_1)
...
/* MethodBindTR<CollisionShape3D*, bool>::_gen_argument_type(int) const */

int __thiscall
MethodBindTR<CollisionShape3D*,bool>::_gen_argument_type
          (MethodBindTR<CollisionShape3D*,bool> *this,int param_1)
...
/* MethodBindTR<CollisionShape3D*, bool>::get_argument_meta(int) const */

undefined8 MethodBindTR<CollisionShape3D*,bool>::get_argument_meta(int param_1)
...
/* MethodBindTRS<Ref<GLTFPhysicsShape>, CollisionShape3D const*>::_gen_argument_type(int) const */

undefined8
MethodBindTRS<Ref<GLTFPhysicsShape>,CollisionShape3D_const*>::_gen_argument_type(int param_1)
...
/* MethodBindTRS<Ref<GLTFPhysicsShape>, CollisionShape3D const*>::get_argument_meta(int) const */

undefined8
MethodBindTRS<Ref<GLTFPhysicsShape>,CollisionShape3D_const*>::get_argument_meta(int param_1)
...
/* MethodBindTRS<Ref<GLTFPhysicsShape>, CollisionShape3D const*>::~MethodBindTRS() */

void __thiscall
MethodBindTRS<Ref<GLTFPhysicsShape>,CollisionShape3D_const*>::~MethodBindTRS
          (MethodBindTRS<Ref<GLTFPhysicsShape>,CollisionShape3D_const*> *this)
...
/* MethodBindTR<CollisionShape3D*, bool>::~MethodBindTR() */

void __thiscall
MethodBindTR<CollisionShape3D*,bool>::~MethodBindTR(MethodBindTR<CollisionShape3D*,bool> *this)
...
/* MethodBindTRS<Ref<GLTFPhysicsShape>, Ref<Shape3D> const&>::~MethodBindTRS() */

void __thiscall
MethodBindTRS<Ref<GLTFPhysicsShape>,Ref<Shape3D>const&>::~MethodBindTRS
          (MethodBindTRS<Ref<GLTFPhysicsShape>,Ref<Shape3D>const&> *this)
...
/* MethodBindTR<Ref<Shape3D>, bool>::~MethodBindTR() */

void __thiscall
MethodBindTR<Ref<Shape3D>,bool>::~MethodBindTR(MethodBindTR<Ref<Shape3D>,bool> *this)
...
/* MethodBindTRS<Ref<GLTFPhysicsShape>, Dictionary>::~MethodBindTRS() */

void __thiscall
MethodBindTRS<Ref<GLTFPhysicsShape>,Dictionary>::~MethodBindTRS
          (MethodBindTRS<Ref<GLTFPhysicsShape>,Dictionary> *this)
...
/* MethodBindTRC<Ref<ImporterMesh>>::~MethodBindTRC() */

void __thiscall
MethodBindTRC<Ref<ImporterMesh>>::~MethodBindTRC(MethodBindTRC<Ref<ImporterMesh>> *this)
...
void __thiscall
MethodBindTRS<Ref<GLTFPhysicsShape>,CollisionShape3D_const*>::validated_call
          (MethodBindTRS<Ref<GLTFPhysicsShape>,CollisionShape3D_const*> *this,Object *param_1,
...
void __thiscall
MethodBindTRS<Ref<GLTFPhysicsShape>,Dictionary>::validated_call
          (MethodBindTRS<Ref<GLTFPhysicsShape>,Dictionary> *this,Object *param_1,Variant **param_2,
          Variant *param_3)
...
void __thiscall
MethodBindTRS<Ref<GLTFPhysicsShape>,CollisionShape3D_const*>::ptrcall
          (MethodBindTRS<Ref<GLTFPhysicsShape>,CollisionShape3D_const*> *this,Object *param_1,
...
/* MethodBindTRS<Ref<GLTFPhysicsShape>, Dictionary>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTRS<Ref<GLTFPhysicsShape>,Dictionary>::ptrcall
          (MethodBindTRS<Ref<GLTFPhysicsShape>,Dictionary> *this,Object *param_1,void **param_2,
          void *param_3)
...
void __thiscall
MethodBindTRS<Ref<GLTFPhysicsShape>,Ref<Shape3D>const&>::validated_call
          (MethodBindTRS<Ref<GLTFPhysicsShape>,Ref<Shape3D>const&> *this,Object *param_1,
          Variant **param_2,Variant *param_3)
...
void __thiscall
MethodBindTRS<Ref<GLTFPhysicsShape>,Ref<Shape3D>const&>::ptrcall
          (MethodBindTRS<Ref<GLTFPhysicsShape>,Ref<Shape3D>const&> *this,Object *param_1,
          void **param_2,void *param_3)
...
Object * MethodBindTRS<Ref<GLTFPhysicsShape>,Dictionary>::call
...
Object * MethodBindTRS<Ref<GLTFPhysicsShape>,CollisionShape3D_const*>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
LAB_00107681:
    ...
    *(undefined8 *)(in_R9 + 1) = uVar3;
    ...
    if (((pOVar7 == (Object *)0x0) ||
        (lVar8 = __dynamic_cast(pOVar7,&Object::typeinfo,&CollisionShape3D::typeinfo,0), lVar8 == 0)
        ) && (pOVar6 != (Object *)0x0)) goto LAB_00107681;
  }
  pOVar6 = Variant::operator_cast_to_Object_(pVVar10);
...
Object * MethodBindTRS<Ref<GLTFPhysicsShape>,Ref<Shape3D>const&>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
LAB_00107b00:
  ...
  *(undefined8 *)(param_1 + 0x10) = uStack_38;
  ...
  if (((local_50 != (Object *)0x0) &&
      (cVar6 = RefCounted::unreference(), pOVar5 = local_50, cVar6 != '\0')) &&
  ...
  if (cVar1 == '\0') {
    ...
    *(Resource **)this = this_00;
    ...
    if (((pOVar5 == (Object *)0x0) || (cVar1 = RefCounted::unreference(), cVar1 == '\0')) ||
       (cVar1 = predelete_handler(pOVar5), cVar1 == '\0')) goto LAB_00108a35;
  }
  (**(code **)(*(long *)pOVar5 + 0x140))(pOVar5);
  Memory::free_static(pOVar5,false);
  pOVar4 = (Object *)this_00;
...
/* void Ref<GLTFPhysicsShape>::instantiate<>() */

void __thiscall Ref<GLTFPhysicsShape>::instantiate<>(Ref<GLTFPhysicsShape> *this)
  ...
  if (cVar3 == '\0') {
    ...
    *(Resource **)this = this_00;
    ...
    if (((pOVar7 == (Object *)0x0) || (cVar3 = RefCounted::unreference(), cVar3 == '\0')) ||
       (cVar3 = predelete_handler(pOVar7), cVar3 == '\0')) goto LAB_00108bb5;
  }
  (**(code **)(*(long *)pOVar7 + 0x140))(pOVar7);
  Memory::free_static(pOVar7,false);
  pOVar6 = (Object *)this_00;
...
/* MethodBindTRC<Ref<ImporterMesh>>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTRC<Ref<ImporterMesh>>::_gen_argument_type_info(int param_1)
...
/* MethodBindTR<CollisionShape3D*, bool>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTR<CollisionShape3D*,bool>::_gen_argument_type_info(int param_1)
...
undefined4 *
MethodBindTRS<Ref<GLTFPhysicsShape>,CollisionShape3D_const*>::_gen_argument_type_info(int param_1)
...
/* MethodBindTRS<Ref<GLTFPhysicsShape>, Dictionary>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTRS<Ref<GLTFPhysicsShape>,Dictionary>::_gen_argument_type_info(int param_1)
...
/* MethodBindTRS<Ref<GLTFPhysicsShape>, Ref<Shape3D> const&>::_gen_argument_type_info(int) const */

undefined4 *
MethodBindTRS<Ref<GLTFPhysicsShape>,Ref<Shape3D>const&>::_gen_argument_type_info(int param_1)
...
/* MethodBindTR<Ref<Shape3D>, bool>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTR<Ref<Shape3D>,bool>::_gen_argument_type_info(int param_1)
...
/* MethodBind* create_method_bind<GLTFPhysicsShape, CollisionShape3D*, bool>(CollisionShape3D*
   (GLTFPhysicsShape::*)(bool)) */

MethodBind *
create_method_bind<GLTFPhysicsShape,CollisionShape3D*,bool>
          (_func_CollisionShape3D_ptr_bool *param_1)
...
MethodBind * create_method_bind<GLTFPhysicsShape,Ref<Shape3D>,bool>(_func_Ref_bool *param_1)
...
MethodBind * create_method_bind<GLTFPhysicsShape,Dictionary>(_func_Dictionary *param_1)
...
/* MethodBind* create_method_bind<GLTFPhysicsShape, String>(String (GLTFPhysicsShape::*)() const) */

MethodBind * create_method_bind<GLTFPhysicsShape,String>(_func_String *param_1)
...
/* MethodBind* create_method_bind<GLTFPhysicsShape, String>(void (GLTFPhysicsShape::*)(String)) */

MethodBind * create_method_bind<GLTFPhysicsShape,String>(_func_void_String *param_1)
...
/* MethodBind* create_method_bind<GLTFPhysicsShape, Vector3>(void (GLTFPhysicsShape::*)(Vector3)) */

MethodBind * create_method_bind<GLTFPhysicsShape,Vector3>(_func_void_Vector3 *param_1)
...
/* MethodBind* create_method_bind<GLTFPhysicsShape, float>(float (GLTFPhysicsShape::*)() const) */

MethodBind * create_method_bind<GLTFPhysicsShape,float>(_func_float *param_1)
...
/* MethodBind* create_method_bind<GLTFPhysicsShape, float>(void (GLTFPhysicsShape::*)(float)) */

MethodBind * create_method_bind<GLTFPhysicsShape,float>(_func_void_float *param_1)
...
/* MethodBind* create_method_bind<GLTFPhysicsShape, bool>(bool (GLTFPhysicsShape::*)() const) */

MethodBind * create_method_bind<GLTFPhysicsShape,bool>(_func_bool *param_1)
...
/* MethodBind* create_method_bind<GLTFPhysicsShape, bool>(void (GLTFPhysicsShape::*)(bool)) */

MethodBind * create_method_bind<GLTFPhysicsShape,bool>(_func_void_bool *param_1)
...
/* MethodBind* create_method_bind<GLTFPhysicsShape, int>(int (GLTFPhysicsShape::*)() const) */

MethodBind * create_method_bind<GLTFPhysicsShape,int>(_func_int *param_1)
...
/* MethodBind* create_method_bind<GLTFPhysicsShape, int>(void (GLTFPhysicsShape::*)(int)) */

MethodBind * create_method_bind<GLTFPhysicsShape,int>(_func_void_int *param_1)
...
/* MethodBind* create_method_bind<GLTFPhysicsShape, Ref<ImporterMesh>>(Ref<ImporterMesh>
   (GLTFPhysicsShape::*)() const) */

MethodBind * create_method_bind<GLTFPhysicsShape,Ref<ImporterMesh>>(_func_Ref *param_1)
...
/* MethodBind* create_method_bind<GLTFPhysicsShape, Ref<ImporterMesh> >(void
   (GLTFPhysicsShape::*)(Ref<ImporterMesh>)) */

MethodBind * create_method_bind<GLTFPhysicsShape,Ref<ImporterMesh>>(_func_void_Ref *param_1)
...
/* Ref<SphereShape3D>::unref() */

void __thiscall Ref<SphereShape3D>::unref(Ref<SphereShape3D> *this)
...
Object * MethodBindTRC<Ref<ImporterMesh>>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
/* MethodBindTRC<Ref<ImporterMesh>>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTRC<Ref<ImporterMesh>>::ptrcall
          (MethodBindTRC<Ref<ImporterMesh>> *this,Object *param_1,void **param_2,void *param_3)
...
/* MethodBindTR<Ref<Shape3D>, bool>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTR<Ref<Shape3D>,bool>::ptrcall
          (MethodBindTR<Ref<Shape3D>,bool> *this,Object *param_1,void **param_2,void *param_3)
...
void __thiscall
MethodBindTR<CollisionShape3D*,bool>::validated_call
          (MethodBindTR<CollisionShape3D*,bool> *this,Object *param_1,Variant **param_2,
          Variant *param_3)
...
/* MethodBindTR<CollisionShape3D*, bool>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTR<CollisionShape3D*,bool>::ptrcall
          (MethodBindTR<CollisionShape3D*,bool> *this,Object *param_1,void **param_2,void *param_3)
...
LAB_001128df:
        Ref<ImporterMesh>::unref((Ref<ImporterMesh> *)&local_48);
      }
    }
  }
...
Object * MethodBindTR<CollisionShape3D*,bool>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
Object * MethodBindTR<Ref<Shape3D>,bool>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
/* MethodBindTRC<Ref<ImporterMesh>>::validated_call(Object*, Variant const**, Variant*) const */

void __thiscall
MethodBindTRC<Ref<ImporterMesh>>::validated_call
          (MethodBindTRC<Ref<ImporterMesh>> *this,Object *param_1,Variant **param_2,Variant *param_3
          )
...
/* MethodBindTR<Ref<Shape3D>, bool>::validated_call(Object*, Variant const**, Variant*) const */

void __thiscall
MethodBindTR<Ref<Shape3D>,bool>::validated_call
          (MethodBindTR<Ref<Shape3D>,bool> *this,Object *param_1,Variant **param_2,Variant *param_3)
...
void GLTFPhysicsShape::_GLOBAL__sub_I__bind_methods(void)

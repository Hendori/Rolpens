...
bool ExtractAlpha_SSE2(long param_1,int param_2,int param_3,int param_4,long param_5,int param_6)

{
  ...
  if (param_4 < 1) {
    ...
    do {
      ...
      if (0 < (int)uVar22) {
        do {
          auVar23 = packssdw(*(undefined1 (*) [16])(param_1 + lVar19 * 4) & auVar25,
                             *(undefined1 (*) [16])(param_1 + 0x10 + lVar19 * 4) & auVar25);
  ...
  return (((ushort)(SUB161(auVar25 >> 7,0) & 1) | (ushort)(SUB161(auVar25 >> 0xf,0) & 1) << 1 |
           (ushort)(SUB161(auVar25 >> 0x17,0) & 1) << 2 |
           (ushort)(SUB161(auVar25 >> 0x1f,0) & 1) << 3 |
           (ushort)(SUB161(auVar25 >> 0x27,0) & 1) << 4 |
           (ushort)(SUB161(auVar25 >> 0x2f,0) & 1) << 5 |
           (ushort)(SUB161(auVar25 >> 0x37,0) & 1) << 6 |
          (ushort)(SUB161(auVar25 >> 0x3f,0) & 1) << 7) & uVar20) == 0xff;
}
...

{
  ...
  if (param_2 < 0x10) {
    ...
    do {
      ...
      auVar6[8] = -(pcVar1[8] == -1);
      auVar6[9] = -(pcVar1[9] == -1);
      auVar6[10] = -(pcVar1[10] == -1);
      auVar6[0xb] = -(pcVar1[0xb] == -1);
      auVar6[0xc] = -(pcVar1[0xc] == -1);
      auVar6[0xd] = -(pcVar1[0xd] == -1);
      auVar6[0xe] = -(pcVar1[0xe] == -1);
      auVar6[0xf] = -(pcVar1[0xf] == -1);
...
undefined8 HasAlpha32b_SSE2(long param_1,int param_2)

{
  ...
  if (iVar1 < 0x40) {
    ...
    do {
      lVar20 = lVar21;
      auVar22 = packssdw(*(undefined1 (*) [16])(param_1 + -0x40 + lVar20) & __LC1,
                         *(undefined1 (*) [16])(param_1 + -0x30 + lVar20) & __LC1);
      auVar24 = packssdw(*(undefined1 (*) [16])(param_1 + -0x20 + lVar20) & __LC1,
                         *(undefined1 (*) [16])(param_1 + -0x10 + lVar20) & __LC1);
      sVar2 = auVar22._0_2_;
      sVar3 = auVar22._2_2_;
      sVar4 = auVar22._4_2_;
      sVar5 = auVar22._6_2_;
  ...
  if (iVar19 < iVar1) {
    ...
    do {
      auVar22 = packssdw(*(undefined1 (*) [16])(param_1 + -0x20 + lVar21) & __LC1,
                         *(undefined1 (*) [16])(param_1 + -0x10 + lVar21) & __LC1);
      sVar2 = auVar22._0_2_;
      sVar3 = auVar22._2_2_;
      sVar4 = auVar22._4_2_;
      sVar5 = auVar22._6_2_;
...
void ExtractGreen_SSE2(uint *param_1,char *param_2,int param_3)

{
  ...
  if (iVar18 < param_3) {
    ...
    *(ulong *)(param_2 + lVar21) =
         CONCAT17((0 < sVar9) * (sVar9 < 0x100) * auVar25[0xe] - (0xff < sVar9),
                  CONCAT16((0 < sVar8) * (sVar8 < 0x100) * auVar25[0xc] - (0xff < sVar8),
                           CONCAT15((0 < sVar7) * (sVar7 < 0x100) * auVar25[10] - (0xff < sVar7),
                                    CONCAT14((0 < sVar6) * (sVar6 < 0x100) * auVar25[8] -
                                             (0xff < sVar6),
                                             CONCAT13((0 < sVar5) * (sVar5 < 0x100) * auVar25[6] -
                                                      (0xff < sVar5),
                                                      CONCAT12((0 < sVar4) * (sVar4 < 0x100) *
                                                               auVar25[4] - (0xff < sVar4),
                                                               CONCAT11((0 < sVar3) *
                                                                        (sVar3 < 0x100) * auVar25[2]
                                                                        - (0xff < sVar3),
                                                                        (0 < sVar2) *
                                                                        (sVar2 < 0x100) * auVar25[0]
                                                                        - (0xff < sVar2))))))));
  }
  lVar21 = (long)iVar22;
...
bool DispatchAlpha_SSE2(ulong *param_1,int param_2,int param_3,int param_4,
...

{
  ...
  return (((ushort)(SUB161(auVar30 >> 7,0) & 1) | (ushort)(SUB161(auVar30 >> 0xf,0) & 1) << 1 |
           (ushort)(SUB161(auVar30 >> 0x17,0) & 1) << 2 |
           (ushort)(SUB161(auVar30 >> 0x1f,0) & 1) << 3 |
           (ushort)(SUB161(auVar30 >> 0x27,0) & 1) << 4 |
           (ushort)(SUB161(auVar30 >> 0x2f,0) & 1) << 5 |
           (ushort)(SUB161(auVar30 >> 0x37,0) & 1) << 6 |
          (ushort)(SUB161(auVar30 >> 0x3f,0) & 1) << 7) & uVar22) != 0xff;
}



void DispatchAlphaToGreen_SSE2
               (long param_1,int param_2,uint param_3,int param_4,long param_5,int param_6)
    ...
    do {
      ...
      if (0 < (int)uVar17) {
        do {
          ...
          auVar11._6_8_ = 0;
          auVar11._0_6_ =
               (uint6)(CONCAT43(auVar3._10_4_,
                                CONCAT21((short)(CONCAT15(puVar1[10],iVar19) >> 0x20),bVar9)) >> 8);
          uVar15 = (uint)iVar19;
          ...
          auVar23._14_2_ = 0;
          *(undefined1 (*) [16])(param_5 + 0x10 + lVar16 * 4) =
               ZEXT616(CONCAT24(auVar12._10_2_,(uint)auVar14._8_2_));
...
void ApplyAlphaMultiply_SSE2
               (undefined1 (*param_1) [16],int param_2,int param_3,int param_4,int param_5)
...
void MultRow_SSE2(long param_1,long param_2,int param_3,int param_4)

{
  ...
  sVar36 = __LC6;
  iVar45 = 0;
  if ((param_4 == 0) && (iVar45 = 0, 7 < param_3)) {
    ...
    do {
      ...
      *(ulong *)(param_1 + lVar46) =
           CONCAT17((0 < sVar11) * (sVar11 < 0x100) * auVar47[0xe] - (0xff < sVar11),
                    CONCAT16((0 < sVar10) * (sVar10 < 0x100) * auVar47[0xc] - (0xff < sVar10),
                             CONCAT15((0 < sVar9) * (sVar9 < 0x100) * auVar47[10] - (0xff < sVar9),
                                      CONCAT14((0 < sVar8) * (sVar8 < 0x100) * auVar47[8] -
                                               (0xff < sVar8),
                                               CONCAT13((0 < sVar7) * (sVar7 < 0x100) * auVar47[6] -
                                                        (0xff < sVar7),
                                                        CONCAT12((0 < sVar6) * (sVar6 < 0x100) *
                                                                 auVar47[4] - (0xff < sVar6),
                                                                 CONCAT11((0 < sVar5) *
                                                                          (sVar5 < 0x100) *
                                                                          auVar47[2] -
                                                                          (0xff < sVar5),
...
void MultARGBRow_SSE2(ulong *param_1,int param_2,int param_3)

{
  ...
  sVar22 = __LC6;
  iVar32 = 0;
  if ((param_3 == 0) && (iVar32 = 0, 1 < param_2)) {
    uVar35 = param_2 - 2U >> 1;
    puVar33 = param_1;
    do {
      uVar1 = *puVar33;
      ...
      *puVar33 = CONCAT17((0 < sVar9) * (sVar9 < 0x100) * auVar36[0xe] - (0xff < sVar9),
                          CONCAT16((0 < sVar8) * (sVar8 < 0x100) * auVar36[0xc] - (0xff < sVar8),
                                   CONCAT15((0 < sVar7) * (sVar7 < 0x100) * auVar36[10] -
                                            (0xff < sVar7),
                                            CONCAT14((0 < sVar6) * (sVar6 < 0x100) * auVar36[8] -
                                                     (0xff < sVar6),
                                                     CONCAT13((0 < sVar5) * (sVar5 < 0x100) *
                                                              auVar36[6] - (0xff < sVar5),
                                                              CONCAT12((0 < sVar4) * (sVar4 < 0x100)
                                                                       * auVar36[4] - (0xff < sVar4)
                                                                       ,CONCAT11((0 < sVar3) *
                                                                                 (sVar3 < 0x100) *
                                                                                 auVar36[2] -
                                                                                 (0xff < sVar3),

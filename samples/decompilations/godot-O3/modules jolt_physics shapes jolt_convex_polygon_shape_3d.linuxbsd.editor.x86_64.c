...
/* JoltConvexPolygonShape3D::get_data() const */

void JoltConvexPolygonShape3D::get_data(void)
...
/* JoltConvexPolygonShape3D::set_margin(float) */

void __thiscall JoltConvexPolygonShape3D::set_margin(JoltConvexPolygonShape3D *this,float param_1)
...
/* JoltConvexPolygonShape3D::_calculate_aabb() const */

void JoltConvexPolygonShape3D::_calculate_aabb(void)
...
/* JoltConvexPolygonShape3D::set_data(Variant const&) */

void __thiscall JoltConvexPolygonShape3D::set_data(JoltConvexPolygonShape3D *this,Variant *param_1)

{
  ...
  if (*(int *)param_1 == 0x24) {
    ...
    *(undefined8 *)(this + 0x80) = local_38;
    ...
    _err_print_error("set_data","modules/jolt_physics/shapes/jolt_convex_polygon_shape_3d.cpp",0x56,
                     "Condition \"p_data.get_type() != Variant::PACKED_VECTOR3_ARRAY\" is true.",0,0
                    );
    return;
  }
...
/* JoltConvexPolygonShape3D::to_string() const */

void JoltConvexPolygonShape3D::to_string(void)
...
/* JoltConvexPolygonShape3D::_build() const */

undefined8 * JoltConvexPolygonShape3D::_build(void)

{
  ...
  if ((*(long *)(in_RSI + 0x90) != 0) &&
     (iVar18 = (int)*(undefined8 *)(*(long *)(in_RSI + 0x90) + -8), iVar18 != 0)) {
    if (2 < iVar18) {
      uVar19 = (ulong)iVar18;
...
LAB_00100963:
      ...
      if (local_c8 == '\x02') {
        ...
        to_string();
        local_f8 = 
        "Failed to build Jolt Physics convex polygon shape with %s. It returned the following error: \'%s\'. This shape belongs to %s."
        ;
        local_100 = 0;
        local_f0 = 0x7b;
        String::parse_latin1((StrRange *)&local_100);
        vformat<String,String,String>
                  (&local_f8,(StrRange *)&local_100,&local_118,&local_110,&local_108);
        _err_print_error("_build","modules/jolt_physics/shapes/jolt_convex_polygon_shape_3d.cpp",
                         0x3e,"Condition \"shape_result.HasError()\" is true. Returning: nullptr",
                         &local_f8,0,0);
        pcVar9 = local_f8;
...
LAB_00100658:
    ...
    to_string();
    local_f8 = 
    "Failed to build Jolt Physics convex polygon shape with %s. It must have a vertex count of at least 3. This shape belongs to %s."
    ;
    local_100 = 0;
    local_f0 = 0x7f;
    String::parse_latin1((StrRange *)&local_100);
    vformat<String,String>(&local_f8,(StrRange *)&local_100,&local_110,&local_108);
    _err_print_error("_build","modules/jolt_physics/shapes/jolt_convex_polygon_shape_3d.cpp",0x2d,
                     "Condition \"vertex_count < 3\" is true. Returning: nullptr",&local_f8,0,0);
    pcVar9 = local_f8;
    if (local_f8 != (char *)0x0) {
      LOCK();
      plVar1 = (long *)(local_f8 + -0x10);
...
/* JoltConvexPolygonShape3D::get_type() const */

undefined8 JoltConvexPolygonShape3D::get_type(void)
...
/* JoltConvexPolygonShape3D::is_convex() const */

undefined8 JoltConvexPolygonShape3D::is_convex(void)
...
/* JoltConvexPolygonShape3D::get_margin() const */

undefined4 __thiscall JoltConvexPolygonShape3D::get_margin(JoltConvexPolygonShape3D *this)
...
/* JoltConvexPolygonShape3D::get_aabb() const */

void JoltConvexPolygonShape3D::get_aabb(void)
...
/* JoltConvexPolygonShape3D::~JoltConvexPolygonShape3D() */

void __thiscall JoltConvexPolygonShape3D::~JoltConvexPolygonShape3D(JoltConvexPolygonShape3D *this)
...
/* WARNING: Removing unreachable block (ram,0x00101300) */
/* WARNING: Removing unreachable block (ram,0x00101479) */
/* WARNING: Removing unreachable block (ram,0x0010130c) */
/* WARNING: Removing unreachable block (ram,0x00101316) */
/* WARNING: Removing unreachable block (ram,0x0010145b) */
/* WARNING: Removing unreachable block (ram,0x00101322) */
/* WARNING: Removing unreachable block (ram,0x0010132c) */
/* WARNING: Removing unreachable block (ram,0x0010143d) */
/* WARNING: Removing unreachable block (ram,0x00101338) */
/* WARNING: Removing unreachable block (ram,0x00101342) */
/* WARNING: Removing unreachable block (ram,0x0010141f) */
/* WARNING: Removing unreachable block (ram,0x0010134e) */
/* WARNING: Removing unreachable block (ram,0x00101358) */
/* WARNING: Removing unreachable block (ram,0x00101401) */
...
/* WARNING: Removing unreachable block (ram,0x00101388) */
/* WARNING: Removing unreachable block (ram,0x0010139e) */
...
/* WARNING: Removing unreachable block (ram,0x00101728) */
/* WARNING: Removing unreachable block (ram,0x001018a0) */
/* WARNING: Removing unreachable block (ram,0x00101734) */
/* WARNING: Removing unreachable block (ram,0x0010173e) */
...
/* WARNING: Removing unreachable block (ram,0x00101864) */
/* WARNING: Removing unreachable block (ram,0x00101760) */
/* WARNING: Removing unreachable block (ram,0x0010176a) */
/* WARNING: Removing unreachable block (ram,0x00101846) */
/* WARNING: Removing unreachable block (ram,0x00101776) */
/* WARNING: Removing unreachable block (ram,0x00101780) */
/* WARNING: Removing unreachable block (ram,0x00101828) */
/* WARNING: Removing unreachable block (ram,0x0010178c) */
/* WARNING: Removing unreachable block (ram,0x00101796) */
/* WARNING: Removing unreachable block (ram,0x0010180a) */
/* WARNING: Removing unreachable block (ram,0x0010179e) */
/* WARNING: Removing unreachable block (ram,0x001017a8) */
/* WARNING: Removing unreachable block (ram,0x001017ef) */
/* WARNING: Removing unreachable block (ram,0x001017b0) */
/* WARNING: Removing unreachable block (ram,0x001017c5) */
/* WARNING: Removing unreachable block (ram,0x001017d1) */
...
/* WARNING: Removing unreachable block (ram,0x00101a28) */
/* WARNING: Removing unreachable block (ram,0x00101b58) */
/* WARNING: Removing unreachable block (ram,0x00101cd1) */
/* WARNING: Removing unreachable block (ram,0x00101b64) */
/* WARNING: Removing unreachable block (ram,0x00101b6e) */
/* WARNING: Removing unreachable block (ram,0x00101cb3) */
/* WARNING: Removing unreachable block (ram,0x00101b7a) */
/* WARNING: Removing unreachable block (ram,0x00101b84) */
/* WARNING: Removing unreachable block (ram,0x00101c95) */
/* WARNING: Removing unreachable block (ram,0x00101b90) */
/* WARNING: Removing unreachable block (ram,0x00101b9a) */
/* WARNING: Removing unreachable block (ram,0x00101c77) */
/* WARNING: Removing unreachable block (ram,0x00101ba6) */
/* WARNING: Removing unreachable block (ram,0x00101bb0) */
/* WARNING: Removing unreachable block (ram,0x00101c59) */
/* WARNING: Removing unreachable block (ram,0x00101bbc) */
/* WARNING: Removing unreachable block (ram,0x00101bc6) */
/* WARNING: Removing unreachable block (ram,0x00101c3b) */
/* WARNING: Removing unreachable block (ram,0x00101bce) */
/* WARNING: Removing unreachable block (ram,0x00101bd8) */
/* WARNING: Removing unreachable block (ram,0x00101c20) */
...
/* String vformat<long, float>(String const&, long const, float const) */

String_conflict * vformat<long,float>(String_conflict *param_1,long param_2,float param_3)
...
void JoltConvexPolygonShape3D::_GLOBAL__sub_I__build(void)

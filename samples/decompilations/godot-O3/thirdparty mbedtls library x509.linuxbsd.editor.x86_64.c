...
LAB_00100470:
  ...
  if (local_b8 != lVar5) {
    ...
    if (iVar2 == 0) {
      ...
      if ((iVar3 != 0) && (iVar3 = iVar3 + -0x2300, iVar3 != 0)) goto LAB_00100210;
...
LAB_00100169:
    iVar2 = mbedtls_asn1_get_tag(&local_b8,lVar5,&local_b0,0xa1);
    if (iVar2 == 0) {
      lVar4 = local_b0 + local_b8;
    ...
    if (lVar5 != lVar4) {
      ...
      if (lVar5 != lVar4) {
        ...
        if (iVar3 == 0) {
          ...
          if (iVar3 != 0) goto LAB_00100320;
          iVar3 = -0x2366;
          if ((local_b8 != lVar4) || (iVar3 = -0x2300, local_58[0] != 1)) goto LAB_00100210;
        }
        else if (iVar3 != -0x62) {
LAB_00100320:
          iVar3 = iVar3 + -0x2300;
...

{
  ...
  puVar6 = param_3;
LAB_00100527:
  iVar4 = mbedtls_asn1_get_tag(param_1,param_2,&local_50,0x31);
  if (iVar4 == 0) {
...
LAB_00100690:
        ...
        *param_1 = (long)pbVar5;
        ...
        bVar2 = *pbVar5;
        if (((bVar2 != 0x1e) && (bVar2 != 0xc)) &&
           ((0x1c < bVar2 || ((0x10580008UL >> ((ulong)bVar2 & 0x3f) & 1) == 0)))) {
          iVar4 = -0x23e2;
          goto LAB_00100695;
        }
...
LAB_001006e6:
    iVar4 = -0x2880;
LAB_00100695:
    mbedtls_asn1_free_named_data_list_shallow(*(undefined8 *)(param_3 + 0xc));
    param_3[0xc] = 0;
    param_3[0xd] = 0;
LAB_001006ab:
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    ...
    if ((*pbVar4 - 0x30 < 10) && (pbVar4[1] - 0x30 < 10)) {
      ...
      *param_3 = uVar8;
      ...
      if (uVar3 < 0xd) {
        ...
        if ((((uVar10 - 1 < uVar3) && (uVar12 < 0x18)) && (uVar11 < 0x3c)) &&
           (iVar2 = 0, uVar9 < 0x3c)) goto LAB_0010097e;
      }
    }
    else {
LAB_00100a00:
  ...
  else if ((local_28 == lVar13 + 0xb) && (pbVar4 = (byte *)*param_1, pbVar4[local_28 + -1] == 0x5a))
  goto LAB_00100799;
LAB_00100930:
  iVar2 = -0x2400;
LAB_0010097e:
...
int mbedtls_x509_get_sig_alg
              (undefined8 param_1,int *param_2,undefined8 param_3,int *param_4,long *param_5)
...
LAB_00100d82:
          ...
          if ((-1 < iVar2) && (uVar4 = (ulong)iVar2, uVar4 < local_198)) {
            ...
            if (uVar6 != 0) {
              do {
                while( true ) {
                  ...
                  if ((pcVar5 != (char *)0x0) ||
                     ((uVar18 == 0 && (pcVar5 = strchr("# ",(uint)bVar14), pcVar5 != (char *)0x0))))
                  break;
                  uVar9 = uVar15;
...
LAB_00100f48:
                ...
                uVar9 = uVar15 + 1;
LAB_00100e5b:
                if ((byte)(bVar14 - 0x20) < 0x5f) goto LAB_00100f48;
                uVar15 = uVar9 + 3;
                if (0xfe < uVar15) goto LAB_00100f6f;
                bVar12 = bVar14 >> 4;
...
LAB_00100ebb:
            ...
            if ((-1 < iVar2) && (uVar6 = (ulong)iVar2, uVar6 < local_198)) {
...
LAB_001012a2:
  return (int)param_2 - (int)uVar6;
}



int mbedtls_x509_sig_alg_gets
              (char *param_1,ulong param_2,undefined8 param_3,int param_4,undefined4 param_5,
              undefined4 *param_6)

{
  ...
  if ((iVar1 < 0) || (uVar4 = (ulong)iVar1, param_2 <= uVar4)) {
LAB_00101610:
    iVar1 = -0x2980;
  }
  else {
...
LAB_001014c0:
      iVar1 = __snprintf_chk(param_1 + uVar4,uVar6,2,0xffffffffffffffff," (%s, MGF1-%s, 0x%02X)",
                             pcVar5,pcVar2,uVar3);
...

{
  ...
  iVar1 = (*param_1 << 9 | param_1[1] << 5 | param_1[2]) -
          (*param_2 << 9 | param_2[1] << 5 | param_2[2]);
  if (iVar1 == 0) {
    iVar1 = (param_1[3] << 0xc | param_1[4] << 6 | param_1[5]) -
            (param_2[3] << 0xc | param_2[4] << 6 | param_2[5]);
  }
  return iVar1;
}
  ...
  if (param_3 != 0) {
    do {
      while( true ) {
        ...
        if ((iVar1 < 0) || (uVar3 = (ulong)iVar1, uVar6 <= uVar3)) {
LAB_00102559:
          uVar2 = 0xffffd680;
          goto LAB_001021c7;
        }
...
LAB_001020c2:
      ...
      if ((iVar1 < 0) || (uVar3 = (ulong)iVar1, uVar6 <= uVar3)) goto LAB_00102559;
      uVar6 = uVar6 - uVar3;
      puVar5 = puVar5 + uVar3;
...
LAB_00102659:
    if ((param_3 & 0x40) != 0) {
      ...
      if ((iVar1 < 0) || (uVar2 = (ulong)iVar1, uVar4 <= uVar2)) goto LAB_001028e8;
      uVar4 = uVar4 - uVar2;
      lVar6 = lVar6 + uVar2;
      puVar5 = &_LC2;
    }
...
joined_r0x001029d4:
    if ((param_3 & 0x40) != 0) {
      ...
      if ((iVar1 < 0) || (uVar2 = (ulong)iVar1, uVar4 <= uVar2)) goto LAB_00102c10;
      uVar4 = uVar4 - uVar2;
      lVar6 = lVar6 + uVar2;
      puVar5 = &_LC2;
    }

...
void __thiscall JPH::Body::Body(Body *this,bool param_1)
...
/* JPH::Body::SetMotionType(JPH::EMotionType) */

void __thiscall JPH::Body::SetMotionType(Body *this,Body param_2)
...
/* JPH::Body::SetAllowSleeping(bool) */

void __thiscall JPH::Body::SetAllowSleeping(Body *this,bool param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* JPH::Body::MoveKinematic(JPH::Vec3, JPH::Quat, float) */

void JPH::Body::MoveKinematic
...

{
  ...
  auVar9._0_4_ = (((fVar21 * fVar20 + fVar16 * fVar8 + fVar30 * fVar19) - fVar12 * fVar18) +
                 local_38) - *param_6;
  auVar9._4_4_ = (fVar12 * fVar16 + (fVar18 * fVar8 - fVar21 * fVar19) + fVar30 * fVar20 + fStack_34
                 ) - param_6[1];
  auVar9._8_4_ = (fVar12 * fVar20 + ((fVar21 * fVar18 + fVar19 * fVar8) - fVar30 * fVar16) +
                 fStack_30) - param_6[2];
  auVar9._12_4_ =
       ((((fVar20 * fVar8 - fVar21 * fVar16) - fVar30 * fVar18) - fVar12 * fVar19) + fStack_2c) -
       param_6[3];
  ...
  *puVar2 = auVar9._0_4_ & -(uint)(auVar14._0_4_ == __LC13);
  ...
  fVar8 = (float)((uint)fVar29 & uVar7 ^
                 (uint)((fVar27 * fStack_44 + fStack_3c * fVar24 + fVar28 * local_48) -
                       fVar26 * fVar10));
  fVar12 = (float)((uint)fVar29 & uVar7 ^
                  (uint)(fVar24 * fVar10 +
                        fVar28 * fStack_44 + (fStack_3c * fVar26 - fVar27 * local_48)));
  auVar23._4_4_ = fVar12;
  auVar23._0_4_ = fVar8;
  fVar10 = (float)((uint)fVar29 & uVar7 ^
                  (uint)(fVar28 * fVar10 +
                        ((fStack_3c * fVar27 + fVar26 * local_48) - fVar24 * fStack_44)));
  fVar29 = (float)((uint)fVar29 & uVar7 ^ (uint)fVar29);
  fVar16 = 0.0;
  if (fVar29 < _LC46._4_4_) {
    auVar15._0_8_ =
         CONCAT44((uint)fVar29 ^ uVar7 & (uint)fVar29,(uint)fVar29 ^ uVar7 & (uint)fVar29);
    ...
    fVar16 = ((((_LC18 * fVar18 + _LC20) * fVar18 + _LC22) * fVar18 + _LC24) * fVar18 + _LC26) *
             fVar18 * fVar16 + fVar16;
    fVar16 = _LC28 - (float)(((uint)(_LC28 - (fVar16 + fVar16)) & uVar25 | ~uVar25 & (uint)fVar16) ^
                            uVar7 & (uint)fVar29);
...
void __thiscall JPH::Body::CalculateWorldSpaceBoundsInternal(Body *this)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* JPH::Body::SetPositionAndRotationInternal(JPH::Vec3, JPH::Quat, bool) */

void JPH::Body::SetPositionAndRotationInternal
               (undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
               Body *param_5,char param_6)

{
  ...
  *(float *)param_5 =
       ((fVar10 * fVar2 + fVar14 * fVar13 + fVar8 * fVar12) - fVar5 * fVar11) + local_78;
  *(float *)(param_5 + 4) =
       fVar5 * fVar10 + (fVar11 * fVar2 - fVar14 * fVar12) + fVar8 * fVar13 + fStack_74;
  *(float *)(param_5 + 8) =
       fVar5 * fVar13 + ((fVar12 * fVar2 + fVar14 * fVar11) - fVar8 * fVar10) + (float)param_2;
  *(float *)(param_5 + 0xc) =
       (((fVar13 * fVar2 - fVar14 * fVar10) - fVar8 * fVar11) - fVar5 * fVar12) +
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* JPH::Body::UpdateCenterOfMassInternal(JPH::Vec3, bool) */

void JPH::Body::UpdateCenterOfMassInternal
               (undefined8 param_1,float param_2,float *param_3,char param_4)

{
  ...
  *param_3 = ((fVar15 * fVar9 + fVar16 * fVar10 + fVar5 * fVar7) - fVar14 * fVar8) + *param_3;
  ...
  if ((param_4 != '\0') && (lVar4 = *(long *)(param_3 + 0x12), lVar4 != 0)) {
    (**(code **)(**(long **)(param_3 + 0x10) + 0x40))(local_78);
    JPH::MotionProperties::SetMassProperties
              (lVar4,*(undefined1 *)(*(long *)(param_3 + 0x12) + 0x7a),local_78);
  }
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
...
/* JPH::Body::SetShapeInternal(JPH::Shape const*, bool) */

void __thiscall JPH::Body::SetShapeInternal(Body *this,Shape *param_1,bool param_2)
...
LAB_00100ca2:
  UpdateCenterOfMassInternal(auVar3._0_8_,auVar3._8_8_,this,param_2);
...
/* JPH::Body::UpdateSleepStateInternal(float, float, float) */

bool __thiscall
JPH::Body::UpdateSleepStateInternal(Body *this,float param_1,float param_2,float param_3)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* JPH::Body::GetSubmergedVolume(JPH::Vec3, JPH::Vec3, float&, float&, JPH::Vec3&) const */

void JPH::Body::GetSubmergedVolume
               (undefined8 param_1,float param_2,undefined8 param_3,float param_4,float *param_5,
               undefined4 *param_6,undefined4 *param_7,undefined1 (*param_8) [16])

{
  ...
  uStack_60 = CONCAT44((uint)((param_2 - param_5[2]) * param_4 +
                             ((float)((ulong)param_1 >> 0x20) - param_5[1]) *
                             (float)((ulong)param_3 >> 0x20) +
                             ((float)param_1 - *param_5) * (float)param_3 + 0.0) ^ __LC32,param_4);
  local_68 = param_3;
  if (pcVar1 == EmptyShape::GetSubmergedVolume) {
    ...
    *param_8 = (undefined1  [16])0x0;
    ...
    (*pcVar1)(0x3f8000003f800000,0x3f8000003f800000,*(undefined8 *)param_5,
              *(undefined8 *)(param_5 + 2),*(long **)(param_5 + 0x10),local_58,&local_68,param_6,
              param_7,param_8,param_1);
  }
  if (local_10 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* JPH::Body::ApplyBuoyancyImpulse(float, float, JPH::Vec3, float, float, float, JPH::Vec3,
   JPH::Vec3, float) */

undefined8
JPH::Body::ApplyBuoyancyImpulse
  ...
  if (0.0 < param_2) {
    ...
    if ((char)Shape::sDrawSubmergedVolumes != '\0') {
      ...
      JPH::DebugRenderer::DrawMarker
                (local_1a8,uStack_1a0,DebugRenderer::sInstance,(undefined4)Color::sWhite);
    ...
    fStack0000000000000008 =
         fStack0000000000000008 -
         ((local_1a8._4_4_ * fVar23 - (float)uStack_1a0 * fVar21) + local_188);
    fStack000000000000000c =
         fStack000000000000000c -
         (((float)uStack_1a0 * fVar22 - (float)local_1a8 * fVar23) + fStack_184);
    ...
    fVar13 = fStack0000000000000010 * fStack0000000000000010 +
             fStack000000000000000c * fStack000000000000000c +
             fStack0000000000000008 * fStack0000000000000008 + 0.0;
    fVar32 = SQRT(fVar13);
    if (fVar13 <= __LC36) {
      fVar13 = 0.0;
    }
      ...
      fVar33 = (fVar14 * 0.0 + fStack0000000000000008 * fVar20 + fVar18 * fStack0000000000000010) -
               fStack000000000000000c * fVar19;
      fVar34 = fVar18 * 0.0 + (fStack000000000000000c * fVar20 - fVar14 * fStack0000000000000010) +
               fStack0000000000000008 * fVar19;
      fVar35 = ((fVar20 * fStack0000000000000010 + fVar14 * fStack000000000000000c) -
               fStack0000000000000008 * fVar18) + fVar19 * 0.0;
      fVar14 = ((fVar20 * 0.0 - fVar14 * fStack0000000000000008) - fStack000000000000000c * fVar18)
               - fVar19 * fStack0000000000000010;
      ...
      fVar13 = (auVar40._4_4_ * auVar40._0_4_ * auVar16._8_4_ +
               auVar40._0_4_ * auVar40._8_4_ * auVar16._4_4_ +
               auVar16._0_4_ * auVar40._8_4_ * auVar40._4_4_ + 0.0) / fVar32;
    }
    ...
    fVar12 = fVar15 * fVar27 * fVar15 * fVar27 +
             fVar15 * fVar26 * fVar15 * fVar26 + fVar15 * fVar24 * fVar15 * fVar24 + 0.0;
    if (fVar13 < fVar12) {
    ...
    *pfVar10 = (float)((uint)(fVar15 * fVar24 + *pfVar10) & -(uint)(auVar17._0_4_ == __LC13));
    ...
    pfVar10[3] = (float)((uint)(fVar15 * (fVar32 + fVar11 * fStack0000000000000024 * param_8) +
                               pfVar10[3]) & -(uint)bVar6);
    ...
    do {
      ...
      *(float *)((long)local_c8 + lVar8) =
           fVar18 * (fVar14 * fVar34 + fVar38 * fVar35) +
           fVar13 * ((_LC46._4_4_ - fVar11 * fVar38) - fVar41) + fVar32 * (fVar11 * fVar34 - fVar33)
      ;
      *(float *)((long)local_c8 + lVar8 + 4) =
           fVar18 * (fVar14 * fVar38 - fVar34 * fVar35) +
           fVar13 * (fVar11 * fVar34 + fVar33) + fVar32 * ((_LC46._4_4_ - fVar41) - fVar12 * fVar34)
      ;
      *(float *)((long)local_c8 + lVar8 + 8) =
           fVar18 * ((_LC46._4_4_ - fVar12 * fVar34) - fVar11 * fVar38) +
           fVar13 * (fVar14 * fVar34 - fVar38 * fVar35) +
           fVar32 * (fVar34 * fVar35 + fVar14 * fVar38);
    ...
    fVar41 = (float)((uint)(fVar18 * local_c8[4] + fVar32 * local_c8[0] + fVar34 * local_c8[8]) &
                    uVar28);
    fVar42 = (float)((uint)(fVar18 * local_c8[5] + fVar32 * local_c8[1] + fVar34 * local_c8[9]) &
                    uVar28 & uVar29);
    fVar43 = (float)((uint)(fVar18 * local_c8[6] + fVar32 * local_c8[2] + fVar34 * local_c8[10]) &
                    uVar28 & uVar30);
    fVar44 = (float)((uint)(fVar18 * local_c8[7] + fVar32 * local_c8[3] + fVar34 * local_c8[0xb]) &
                    uVar28 & uVar31);
    fVar35 = (float)((uint)(fVar33 * local_c8[4] + fVar14 * local_c8[0] + fVar39 * local_c8[8]) &
                    uVar29 & uVar28);
    fVar36 = (float)((uint)(fVar33 * local_c8[5] + fVar14 * local_c8[1] + fVar39 * local_c8[9]) &
                    uVar29);
    fVar38 = (float)((uint)(fVar33 * local_c8[6] + fVar14 * local_c8[2] + fVar39 * local_c8[10]) &
                    uVar29 & uVar30);
    fVar39 = (float)((uint)(fVar33 * local_c8[7] + fVar14 * local_c8[3] + fVar39 * local_c8[0xb]) &
                    uVar29 & uVar31);
    fVar14 = (float)((uint)(fVar12 * local_c8[4] + fVar11 * local_c8[0] + fVar13 * local_c8[8]) &
                    uVar28 & uVar30);
    fVar18 = (float)((uint)(fVar12 * local_c8[5] + fVar11 * local_c8[1] + fVar13 * local_c8[9]) &
                    uVar29 & uVar30);
    fVar33 = (float)((uint)(fVar12 * local_c8[6] + fVar11 * local_c8[2] + fVar13 * local_c8[10]) &
                    uVar30);
    fVar34 = (float)((uint)(fVar12 * local_c8[7] + fVar11 * local_c8[3] + fVar13 * local_c8[0xb]) &
                    uVar31 & uVar30);
    ...
    fVar32 = local_1a8._4_4_ * local_1a8._4_4_ + (float)local_1a8 * (float)local_1a8 + 0.0 +
...
void JPH::Body::ApplyBuoyancyImpulse(undefined8 param_1)
...
/* JPH::Body::SaveState(JPH::StateRecorder&) const */

void __thiscall JPH::Body::SaveState(Body *this,StateRecorder *param_1)
...
/* JPH::Body::RestoreState(JPH::StateRecorder&) */

void __thiscall JPH::Body::RestoreState(Body *this,StateRecorder *param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* JPH::Body::GetBodyCreationSettings() const */

void JPH::Body::GetBodyCreationSettings(void)
...
LAB_00101f36:
  ...
  puVar9 = *(undefined8 **)(in_RSI + 0x48);
LAB_00101f48:
  *(undefined8 *)(in_RDI[5] + 8) = *(undefined8 *)(in_RSI + 0x60);
  *(Body *)(in_RDI + 6) = in_RSI[0x78];
  ...
  if (puVar9 == (undefined8 *)0x0) {
    ...
    *(float *)in_RDI[10] = fVar30;
    auVar41._0_4_ =
         (fVar29 * fVar22 - fVar28 * fVar19) * fVar18 +
         (fVar19 * fVar12 - fVar22 * fVar23) * fVar33 +
         (fVar23 * fVar28 - fVar12 * fVar29) * fVar31 + 0.0;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* JPH::Body::GetSoftBodyCreationSettings() const */

void JPH::Body::GetSoftBodyCreationSettings(void)
...
void __thiscall JPH::Body::~Body(Body *this)
...
void JPH::Body::_GLOBAL__sub_I_sFixedToWorld(void)

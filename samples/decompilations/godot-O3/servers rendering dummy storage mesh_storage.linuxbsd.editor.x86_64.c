...
/* RendererDummy::MeshStorage::_multimesh_get_buffer(RID) const */

long RendererDummy::MeshStorage::_multimesh_get_buffer(long param_1,long param_2,ulong param_3)

{
  long lVar1;
  
  if ((param_3 != 0) && ((uint)param_3 < *(uint *)(param_2 + 0xbc))) {
    lVar1 = *(long *)(*(long *)(param_2 + 0xa8) +
                     ((param_3 & 0xffffffff) / (ulong)*(uint *)(param_2 + 0xb8)) * 8) +
            ((param_3 & 0xffffffff) % (ulong)*(uint *)(param_2 + 0xb8)) * 0x18;
  ...
  _err_print_error("_multimesh_get_buffer","servers/rendering/dummy/storage/mesh_storage.cpp",99,
...
/* RendererDummy::MeshStorage::_multimesh_initialize(RID) */

void __thiscall RendererDummy::MeshStorage::_multimesh_initialize(MeshStorage *this,ulong param_2)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 0xbc))) {
    lVar1 = *(long *)(*(long *)(this + 0xa8) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0xb8)) * 8) +
            ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0xb8)) * 0x18;
...
/* RendererDummy::MeshStorage::_multimesh_free(RID) */

undefined1  [16] __thiscall
RendererDummy::MeshStorage::_multimesh_free(MeshStorage *this,ulong param_2)

{
  ...
  if (param_2 != 0) {
    if ((uint)param_2 < *(uint *)(this + 0xbc)) {
      ...
      if (iVar2 == (int)(param_2 >> 0x20)) {
        if (iVar2 < 0) {
          lVar6 = 0;
          _err_print_error(&_LC23,"./core/templates/rid_owner.h",0x16c,"Method/function failed.",
          ...
          *(uint *)(this + 0xc0) = uVar5;
          ...
          lVar6 = *(long *)(*(long *)(this + 0xb0) +
                           ((ulong)uVar5 / (ulong)*(uint *)(this + 0xb8)) * 8);
  ...
  auVar8 = _err_print_error("_multimesh_free","servers/rendering/dummy/storage/mesh_storage.cpp",
                            0x54,"Parameter \"multimesh\" is null.",0,0);
  return auVar8;
}
...
/* RendererDummy::MeshStorage::MeshStorage() */

void __thiscall RendererDummy::MeshStorage::MeshStorage(MeshStorage *this)
...
/* RendererDummy::MeshStorage::mesh_allocate() */

void __thiscall RendererDummy::MeshStorage::mesh_allocate(MeshStorage *this)

{
  RID_Alloc<RendererDummy::DummyMesh,false>::allocate_rid
            ((RID_Alloc<RendererDummy::DummyMesh,false> *)(this + 0x48));
  return;
}



/* RendererDummy::MeshStorage::_multimesh_allocate() */

void __thiscall RendererDummy::MeshStorage::_multimesh_allocate(MeshStorage *this)

{
  RID_Alloc<RendererDummy::MeshStorage::DummyMultiMesh,false>::allocate_rid
            ((RID_Alloc<RendererDummy::MeshStorage::DummyMultiMesh,false> *)(this + 0xa0));
  return;
}
...
void __thiscall
CowData<RenderingServer::SurfaceData::LOD>::_ref
          (CowData<RenderingServer::SurfaceData::LOD> *this,CowData *param_1)
...
/* RendererDummy::MeshStorage::mesh_free(RID) */

long __thiscall RendererDummy::MeshStorage::mesh_free(MeshStorage *this,ulong param_2)

{
  ...
  if ((param_2 != 0) && (uVar7 = (uint)param_2, uVar7 < *(uint *)(this + 100))) {
    lVar8 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x60)) * 0x60 +
            *(long *)(*(long *)(this + 0x50) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x60)) * 8);
    ...
    if (iVar2 == iVar6) {
      ...
      if (uVar7 < *(uint *)(this + 100)) {
        ...
        if (*(int *)(lVar8 + 0x58) < 0) {
          ...
          CowData<RenderingServer::SurfaceData>::_unref
                    ((CowData<RenderingServer::SurfaceData> *)(lVar8 + 8));
          ...
          *(uint *)(lVar8 + ((ulong)uVar5 % (ulong)*(uint *)(this + 0x60)) * 4) = uVar7;
          ...
          lVar8 = _err_print_error(&_LC23,"./core/templates/rid_owner.h",0x171,
                                   "Method/function failed.",0,0);
        }
      }
      else {
        lVar8 = _err_print_error(&_LC23,"./core/templates/rid_owner.h",0x161,
                                 "Method/function failed.",0,0);
      }
      return lVar8;
    }
  ...
  lVar8 = _err_print_error("mesh_free","servers/rendering/dummy/storage/mesh_storage.cpp",0x37,
...
/* CowData<RenderingServer::SurfaceData>::_copy_on_write() [clone .isra.0] */

void __thiscall
CowData<RenderingServer::SurfaceData>::_copy_on_write(CowData<RenderingServer::SurfaceData> *this)
  ...
  if (lVar2 != 0) {
    do {
      ...
      *(undefined8 *)(this_00 + -0x6c) = uVar7;
      if (lVar4 != 0) {
        CowData<RenderingServer::SurfaceData::LOD>::_ref
                  ((CowData<RenderingServer::SurfaceData::LOD> *)(this_00 + -0x50),
                   (CowData *)(pCVar12 + 0x80));
      }
...

{
  *(undefined ***)this = &PTR__MeshStorage_00104d60;
  singleton = 0;
  RID_Alloc<RendererDummy::MeshStorage::DummyMultiMesh,false>::~RID_Alloc
            ((RID_Alloc<RendererDummy::MeshStorage::DummyMultiMesh,false> *)(this + 0xa0));
  RID_Alloc<RendererDummy::DummyMesh,false>::~RID_Alloc
            ((RID_Alloc<RendererDummy::DummyMesh,false> *)(this + 0x48));
...
/* RendererDummy::MeshStorage::mesh_clear(RID) */

void __thiscall RendererDummy::MeshStorage::mesh_clear(MeshStorage *this,ulong param_2)

{
  long lVar1;
  
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 100))) {
    lVar1 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x60)) * 0x60 +
            *(long *)(*(long *)(this + 0x50) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x60)) * 8);
    if (*(int *)(lVar1 + 0x58) == (int)(param_2 >> 0x20)) {
      if ((*(long *)(lVar1 + 8) != 0) && (*(long *)(*(long *)(lVar1 + 8) + -8) != 0)) {
        CowData<RenderingServer::SurfaceData>::_unref
                  ((CowData<RenderingServer::SurfaceData> *)(lVar1 + 8));
        return;
      }
      return;
    }
  ...
  _err_print_error("mesh_clear","servers/rendering/dummy/storage/mesh_storage.cpp",0x45,
...
/* RendererDummy::MeshStorage::_multimesh_set_buffer(RID, Vector<float> const&) */

void __thiscall
RendererDummy::MeshStorage::_multimesh_set_buffer(MeshStorage *this,ulong param_2,long param_3)
...
LAB_00101098:
    _err_print_error("_multimesh_set_buffer","servers/rendering/dummy/storage/mesh_storage.cpp",0x5b
                     ,"Parameter \"multimesh\" is null.",0,0);
    return;
  }
  lVar2 = *(long *)(*(long *)(this + 0xa8) +
                   ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0xb8)) * 8) +
          ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0xb8)) * 0x18;
...
LAB_00101070:
  ...
  _err_print_error("resize","./core/templates/cowdata.h",0x16a,
                   ...
                   ,0,0);
LAB_00100fd0:
  CowData<float>::_copy_on_write((CowData<float> *)(lVar2 + 8));
...
/* RendererDummy::MeshStorage::mesh_surface_remove(RID, int) */

void __thiscall
RendererDummy::MeshStorage::mesh_surface_remove(MeshStorage *this,ulong param_2,int param_3)

{
  Vector<RenderingServer::SurfaceData> *this_00;
  
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 100))) {
    this_00 = (Vector<RenderingServer::SurfaceData> *)
              (((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x60)) * 0x60 +
              *(long *)(*(long *)(this + 0x50) +
                       ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x60)) * 8));
  ...
  _err_print_error("mesh_surface_remove","servers/rendering/dummy/storage/mesh_storage.cpp",0x3e,
                   "Parameter \"m\" is null.",0,0);
  return;
}
...
/* RendererDummy::MeshStorage::mesh_initialize(RID) */

void __thiscall RendererDummy::MeshStorage::mesh_initialize(MeshStorage *this,ulong param_2)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 100))) {
    lVar4 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x60)) * 0x60 +
            *(long *)(*(long *)(this + 0x50) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x60)) * 8);
...
LAB_001013d1:
        if ((local_28._4_4_ != 0) && ((long *)local_38._0_8_ != (long *)0x0)) {
          ...
          do {
            ...
            ::insert(local_80,(uint *)(lVar4 + 0x28),(bool)((char)plVar3 + '\x10'));
            plVar3 = (long *)*plVar3;
...
/* RendererDummy::MeshStorage::mesh_set_blend_shape_count(RID, int) */

void RendererDummy::MeshStorage::mesh_set_blend_shape_count(void)
...
/* RendererDummy::MeshStorage::mesh_needs_instance(RID, bool) */

undefined8 RendererDummy::MeshStorage::mesh_needs_instance(void)
...
/* RendererDummy::MeshStorage::mesh_get_blend_shape_count(RID) const */

undefined8 RendererDummy::MeshStorage::mesh_get_blend_shape_count(void)
...
/* RendererDummy::MeshStorage::mesh_set_blend_shape_mode(RID, RenderingServer::BlendShapeMode) */

void RendererDummy::MeshStorage::mesh_set_blend_shape_mode(void)
...
/* RendererDummy::MeshStorage::mesh_get_blend_shape_mode(RID) const */

undefined8 RendererDummy::MeshStorage::mesh_get_blend_shape_mode(void)
...
void RendererDummy::MeshStorage::mesh_surface_update_vertex_region(void)
...
void RendererDummy::MeshStorage::mesh_surface_update_attribute_region(void)
...
void RendererDummy::MeshStorage::mesh_surface_update_skin_region(void)
...
/* RendererDummy::MeshStorage::mesh_surface_set_material(RID, int, RID) */

void RendererDummy::MeshStorage::mesh_surface_set_material(void)
...
/* RendererDummy::MeshStorage::mesh_surface_get_material(RID, int) const */

undefined8 RendererDummy::MeshStorage::mesh_surface_get_material(void)
...
/* RendererDummy::MeshStorage::mesh_set_custom_aabb(RID, AABB const&) */

void RendererDummy::MeshStorage::mesh_set_custom_aabb(void)
...
/* RendererDummy::MeshStorage::mesh_get_custom_aabb(RID) const */

undefined8 * RendererDummy::MeshStorage::mesh_get_custom_aabb(undefined8 *param_1)
...
/* RendererDummy::MeshStorage::mesh_get_aabb(RID, RID) */

undefined8 * RendererDummy::MeshStorage::mesh_get_aabb(undefined8 *param_1)
...
/* RendererDummy::MeshStorage::mesh_set_path(RID, String const&) */

void RendererDummy::MeshStorage::mesh_set_path(void)
...
/* RendererDummy::MeshStorage::mesh_get_path(RID) const */

undefined8 * RendererDummy::MeshStorage::mesh_get_path(undefined8 *param_1)
...
/* RendererDummy::MeshStorage::mesh_set_shadow_mesh(RID, RID) */

void RendererDummy::MeshStorage::mesh_set_shadow_mesh(void)
...
/* RendererDummy::MeshStorage::mesh_instance_create(RID) */

undefined8 RendererDummy::MeshStorage::mesh_instance_create(void)
...
/* RendererDummy::MeshStorage::mesh_instance_free(RID) */

void RendererDummy::MeshStorage::mesh_instance_free(void)
...
/* RendererDummy::MeshStorage::mesh_instance_set_skeleton(RID, RID) */

void RendererDummy::MeshStorage::mesh_instance_set_skeleton(void)
...
/* RendererDummy::MeshStorage::mesh_instance_set_blend_shape_weight(RID, int, float) */

void RendererDummy::MeshStorage::mesh_instance_set_blend_shape_weight(void)
...
/* RendererDummy::MeshStorage::mesh_instance_check_for_update(RID) */

void RendererDummy::MeshStorage::mesh_instance_check_for_update(void)
...
/* RendererDummy::MeshStorage::mesh_instance_set_canvas_item_transform(RID, Transform2D const&) */

void RendererDummy::MeshStorage::mesh_instance_set_canvas_item_transform(void)
...
/* RendererDummy::MeshStorage::update_mesh_instances() */

void RendererDummy::MeshStorage::update_mesh_instances(void)
...
void RendererDummy::MeshStorage::_multimesh_allocate_data(void)
...
/* RendererDummy::MeshStorage::_multimesh_get_instance_count(RID) const */

undefined8 RendererDummy::MeshStorage::_multimesh_get_instance_count(void)
...
/* RendererDummy::MeshStorage::_multimesh_set_mesh(RID, RID) */

void RendererDummy::MeshStorage::_multimesh_set_mesh(void)
...
/* RendererDummy::MeshStorage::_multimesh_instance_set_transform(RID, int, Transform3D const&) */

void RendererDummy::MeshStorage::_multimesh_instance_set_transform(void)
...
/* RendererDummy::MeshStorage::_multimesh_instance_set_transform_2d(RID, int, Transform2D const&) */

void RendererDummy::MeshStorage::_multimesh_instance_set_transform_2d(void)
...
/* RendererDummy::MeshStorage::_multimesh_instance_set_color(RID, int, Color const&) */

void RendererDummy::MeshStorage::_multimesh_instance_set_color(void)
...
/* RendererDummy::MeshStorage::_multimesh_instance_set_custom_data(RID, int, Color const&) */

void RendererDummy::MeshStorage::_multimesh_instance_set_custom_data(void)
...
/* RendererDummy::MeshStorage::_multimesh_set_custom_aabb(RID, AABB const&) */

void RendererDummy::MeshStorage::_multimesh_set_custom_aabb(void)
...
/* RendererDummy::MeshStorage::_multimesh_get_custom_aabb(RID) const */

undefined8 * RendererDummy::MeshStorage::_multimesh_get_custom_aabb(undefined8 *param_1)
...
/* RendererDummy::MeshStorage::_multimesh_get_mesh(RID) const */

undefined8 RendererDummy::MeshStorage::_multimesh_get_mesh(void)
...
/* RendererDummy::MeshStorage::_multimesh_get_aabb(RID) */

undefined8 * RendererDummy::MeshStorage::_multimesh_get_aabb(undefined8 *param_1)
...
/* RendererDummy::MeshStorage::_multimesh_instance_get_transform(RID, int) const */

undefined1 (*) [16]
RendererDummy::MeshStorage::_multimesh_instance_get_transform(undefined1 (*param_1) [16])
...
/* RendererDummy::MeshStorage::_multimesh_instance_get_transform_2d(RID, int) const */

undefined8 * RendererDummy::MeshStorage::_multimesh_instance_get_transform_2d(undefined8 *param_1)
...
/* RendererDummy::MeshStorage::_multimesh_instance_get_color(RID, int) const */

undefined1  [16] RendererDummy::MeshStorage::_multimesh_instance_get_color(void)
...
/* RendererDummy::MeshStorage::_multimesh_instance_get_custom_data(RID, int) const */

undefined1  [16] RendererDummy::MeshStorage::_multimesh_instance_get_custom_data(void)
...
/* RendererDummy::MeshStorage::_multimesh_get_command_buffer_rd_rid(RID) const */

undefined8 RendererDummy::MeshStorage::_multimesh_get_command_buffer_rd_rid(void)
...
/* RendererDummy::MeshStorage::_multimesh_get_buffer_rd_rid(RID) const */

undefined8 RendererDummy::MeshStorage::_multimesh_get_buffer_rd_rid(void)
...
/* RendererDummy::MeshStorage::_multimesh_set_visible_instances(RID, int) */

void RendererDummy::MeshStorage::_multimesh_set_visible_instances(void)
...
/* RendererDummy::MeshStorage::_multimesh_get_visible_instances(RID) const */

undefined8 RendererDummy::MeshStorage::_multimesh_get_visible_instances(void)
...
/* RendererDummy::MeshStorage::_multimesh_get_interpolator(RID) const */

undefined8 RendererDummy::MeshStorage::_multimesh_get_interpolator(void)
...
/* RendererDummy::MeshStorage::skeleton_allocate() */

undefined8 RendererDummy::MeshStorage::skeleton_allocate(void)
...
/* RendererDummy::MeshStorage::skeleton_initialize(RID) */

void RendererDummy::MeshStorage::skeleton_initialize(void)
...
/* RendererDummy::MeshStorage::skeleton_free(RID) */

void RendererDummy::MeshStorage::skeleton_free(void)
...
/* RendererDummy::MeshStorage::skeleton_allocate_data(RID, int, bool) */

void RendererDummy::MeshStorage::skeleton_allocate_data(void)
...
/* RendererDummy::MeshStorage::skeleton_set_base_transform_2d(RID, Transform2D const&) */

void RendererDummy::MeshStorage::skeleton_set_base_transform_2d(void)
...
/* RendererDummy::MeshStorage::skeleton_get_bone_count(RID) const */

undefined8 RendererDummy::MeshStorage::skeleton_get_bone_count(void)
...
/* RendererDummy::MeshStorage::skeleton_bone_set_transform(RID, int, Transform3D const&) */

void RendererDummy::MeshStorage::skeleton_bone_set_transform(void)
...
/* RendererDummy::MeshStorage::skeleton_bone_get_transform(RID, int) const */

undefined1 (*) [16]
RendererDummy::MeshStorage::skeleton_bone_get_transform(undefined1 (*param_1) [16])
...
/* RendererDummy::MeshStorage::skeleton_bone_set_transform_2d(RID, int, Transform2D const&) */

void RendererDummy::MeshStorage::skeleton_bone_set_transform_2d(void)
...
/* RendererDummy::MeshStorage::skeleton_bone_get_transform_2d(RID, int) const */

undefined8 * RendererDummy::MeshStorage::skeleton_bone_get_transform_2d(undefined8 *param_1)
...
/* RendererDummy::MeshStorage::skeleton_update_dependency(RID, DependencyTracker*) */

void RendererDummy::MeshStorage::skeleton_update_dependency(void)
...
/* RendererDummy::MeshStorage::mesh_get_surface_count(RID) const */

undefined4 __thiscall
RendererDummy::MeshStorage::mesh_get_surface_count(MeshStorage *this,ulong param_2)

{
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 100))) {
    lVar3 = ((param_2 & 0xffffffff) % (ulong)*(uint *)(this + 0x60)) * 0x60 +
            *(long *)(*(long *)(this + 0x50) +
                     ((param_2 & 0xffffffff) / (ulong)*(uint *)(this + 0x60)) * 8);
  ...
  _err_print_error("mesh_get_surface_count","servers/rendering/dummy/storage/mesh_storage.h",0x79,
                   "Parameter \"m\" is null.",0,0);
  return 0;
}
...
/* CowData<RenderingServer::SurfaceData>::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<RenderingServer::SurfaceData>::_copy_on_write(void)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* RendererDummy::MeshStorage::_multimesh_set_buffer(RID, Vector<float> const&) [clone .cold] */

void RendererDummy::MeshStorage::_multimesh_set_buffer(void)
...
/* WARNING: Removing unreachable block (ram,0x00102150) */
/* WARNING: Removing unreachable block (ram,0x001022c9) */
/* WARNING: Removing unreachable block (ram,0x0010215c) */
/* WARNING: Removing unreachable block (ram,0x00102166) */
/* WARNING: Removing unreachable block (ram,0x001022ab) */
/* WARNING: Removing unreachable block (ram,0x00102172) */
/* WARNING: Removing unreachable block (ram,0x0010217c) */
/* WARNING: Removing unreachable block (ram,0x0010228d) */
/* WARNING: Removing unreachable block (ram,0x00102188) */
/* WARNING: Removing unreachable block (ram,0x00102192) */
/* WARNING: Removing unreachable block (ram,0x0010226f) */
/* WARNING: Removing unreachable block (ram,0x0010219e) */
/* WARNING: Removing unreachable block (ram,0x001021a8) */
/* WARNING: Removing unreachable block (ram,0x00102251) */
/* WARNING: Removing unreachable block (ram,0x001021b4) */
/* WARNING: Removing unreachable block (ram,0x001021be) */
/* WARNING: Removing unreachable block (ram,0x00102233) */
/* WARNING: Removing unreachable block (ram,0x001021c6) */
/* WARNING: Removing unreachable block (ram,0x001021d0) */
/* WARNING: Removing unreachable block (ram,0x00102218) */
/* WARNING: Removing unreachable block (ram,0x001021d8) */
/* WARNING: Removing unreachable block (ram,0x001021ee) */
/* WARNING: Removing unreachable block (ram,0x001021fa) */
...
void __thiscall
RID_Alloc<RendererDummy::MeshStorage::DummyMultiMesh,false>::~RID_Alloc
          (RID_Alloc<RendererDummy::MeshStorage::DummyMultiMesh,false> *this)
...
LAB_00102472:
    if ((uint)uVar5 < (uint)uVar8) goto LAB_001024b3;
    lVar7 = 0;
    while( true ) {
...
ulong __thiscall
RID_Alloc<RendererDummy::DummyMesh,false>::allocate_rid
          (RID_Alloc<RendererDummy::DummyMesh,false> *this)

{
  ...
  if (uVar10 != 0x7fffffff) {
    ...
    *(uint *)(((ulong)uVar3 % (ulong)uVar8) * 0x60 +
              *(long *)(*(long *)(this + 8) + ((ulong)uVar3 / (ulong)uVar8) * 8) + 0x58) =
         uVar10 | 0x80000000;
...
/* RendererDummy::MeshStorage::mesh_get_surface(RID, int) const */

undefined8 *
RendererDummy::MeshStorage::mesh_get_surface
...

{
  ...
  if ((param_3 != 0) && ((uint)param_3 < *(uint *)(param_2 + 100))) {
    lVar6 = ((param_3 & 0xffffffff) % (ulong)*(uint *)(param_2 + 0x60)) * 0x60 +
            *(long *)(*(long *)(param_2 + 0x50) +
                     ((param_3 & 0xffffffff) / (ulong)*(uint *)(param_2 + 0x60)) * 8);
...
LAB_00103160:
        ...
        if (lVar8 < lVar10) {
          ...
          if (*(long *)(puVar7 + 6) != 0) {
            CowData<unsigned_char>::_ref
                      ((CowData<unsigned_char> *)local_100,(CowData *)(puVar7 + 6));
          }
          local_f0[0] = 0;
          if (*(long *)(puVar7 + 10) != 0) {
            CowData<unsigned_char>::_ref
                      ((CowData<unsigned_char> *)local_f0,(CowData *)(puVar7 + 10));
          }
          local_e0 = 0;
          if (*(long *)(puVar7 + 0xe) != 0) {
            CowData<unsigned_char>::_ref
                      ((CowData<unsigned_char> *)&local_e0,(CowData *)(puVar7 + 0xe));
          }
          local_d8 = puVar7[0x10];
          local_c8 = 0;
          if (*(long *)(puVar7 + 0x14) != 0) {
            CowData<unsigned_char>::_ref
                      ((CowData<unsigned_char> *)&local_c8,(CowData *)(puVar7 + 0x14));
          }
          ...
          if (*(long *)(puVar7 + 0x20) != 0) {
            CowData<RenderingServer::SurfaceData::LOD>::_ref
                      ((CowData<RenderingServer::SurfaceData::LOD> *)local_98,
                       (CowData *)(puVar7 + 0x20));
          }
          local_88 = 0;
          ...
          if (*(long *)(puVar7 + 0x34) != 0) {
            CowData<unsigned_char>::_ref
                      ((CowData<unsigned_char> *)&local_48,(CowData *)(puVar7 + 0x34));
            lVar6 = local_48;
          }
          uVar5 = local_98[0];
      ...
      _err_print_index_error
                ("mesh_get_surface","servers/rendering/dummy/storage/mesh_storage.h",0x72,lVar8,
                 lVar10,"p_surface","m->surfaces.size()","",false,false);
      puVar9 = param_1;
  ...
  _err_print_error("mesh_get_surface","servers/rendering/dummy/storage/mesh_storage.h",0x71,
                   "Parameter \"m\" is null.",0,0);
  puVar9 = param_1;
  for (lVar6 = 0x1e; lVar6 != 0; lVar6 = lVar6 + -1) {
    *puVar9 = 0;
...
void __thiscall
CowData<RenderingServer::SurfaceData>::_unref(CowData<RenderingServer::SurfaceData> *this)
      ...
      *(undefined8 *)this = 0;
      if (lVar3 != 0) {
        ...
        do {
          ...
          CowData<RenderingServer::SurfaceData::LOD>::_unref
                    ((CowData<RenderingServer::SurfaceData::LOD> *)(lVar6 + 0x80));
...
LAB_001034ba:
    if ((uint)uVar5 < (uint)uVar7) goto LAB_001034fb;
    lVar6 = 0;
    while( true ) {
    ...
    if (*(int *)(this + 0x1c) != 0) {
      ...
      do {
        ...
        if (-1 < *(int *)(lVar6 + 0x58)) {
          ...
          CowData<RenderingServer::SurfaceData>::_unref
                    ((CowData<RenderingServer::SurfaceData> *)(lVar6 + 8));
          uVar7 = (ulong)*(uint *)(this + 0x18);
          puVar8 = *(undefined8 **)(this + 8);
        }
        uVar5 = (ulong)*(uint *)(this + 0x1c);
...
/* CowData<RenderingServer::SurfaceData>::_realloc(long) */

undefined8 __thiscall
CowData<RenderingServer::SurfaceData>::_realloc
          (CowData<RenderingServer::SurfaceData> *this,long param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Error CowData<RenderingServer::SurfaceData>::resize<false>(long) */

undefined8 __thiscall
CowData<RenderingServer::SurfaceData>::resize<false>
          (CowData<RenderingServer::SurfaceData> *this,long param_1)
...
LAB_00103b60:
  ...
  if (param_1 <= lVar9) {
    while (lVar9 = *(long *)this, lVar9 != 0) {
      ...
      CowData<RenderingServer::SurfaceData::LOD>::_unref
                ((CowData<RenderingServer::SurfaceData::LOD> *)(lVar9 + 0x80));
...
/* Vector<RenderingServer::SurfaceData>::remove_at(long) */

void __thiscall
Vector<RenderingServer::SurfaceData>::remove_at
          (Vector<RenderingServer::SurfaceData> *this,long param_1)

{
  ...
  if (param_1 < 0) {
    ...
    lVar3 = *(long *)(lVar3 + -8);
    if (param_1 < lVar3) {
      CowData<RenderingServer::SurfaceData>::_copy_on_write
                ((CowData<RenderingServer::SurfaceData> *)(this + 8));
      lVar3 = *(long *)(this + 8);
      if (lVar3 == 0) {
        lVar5 = -1;
      }
        ...
        if (param_1 < lVar5) {
          ...
          do {
            ...
            *(undefined8 *)(this_00 + -0x24) = *(undefined8 *)(this_00 + 0xcc);
            *(undefined8 *)(this_00 + -0x1c) = *(undefined8 *)(this_00 + 0xd4);
            *(undefined8 *)(this_00 + -0x14) = *(undefined8 *)(this_00 + 0xdc);
            ...
            *(undefined8 *)(this_00 + 0x18) = *(undefined8 *)(this_00 + 0x108);
            *(undefined8 *)(this_00 + 0x20) = *(undefined8 *)(this_00 + 0x110);
            *(undefined8 *)(this_00 + 0x28) = *(undefined8 *)(this_00 + 0x118);
            *(undefined8 *)(this_00 + 0x30) = *(undefined8 *)(this_00 + 0x120);
            *(undefined8 *)(this_00 + 0x38) = *(undefined8 *)(this_00 + 0x128);
            *(undefined8 *)(this_00 + 0x40) = *(undefined8 *)(this_00 + 0x130);
            if (lVar3 != lVar4) {
              if (lVar3 != 0) {
                LOCK();
                plVar1 = (long *)(lVar3 + -0x10);
            ...
            param_1 = param_1 + 1;
            *(undefined8 *)(this_00 + 0x58) = *(undefined8 *)(this_00 + 0x148);
            *(undefined8 *)(this_00 + 0x60) = *(undefined8 *)(this_00 + 0x150);
            *(undefined8 *)(this_00 + 0x68) = *(undefined8 *)(this_00 + 0x158);
            this_00 = this_00 + 0xf0;
          } while (lVar5 != param_1);
        }
      }
      CowData<RenderingServer::SurfaceData>::resize<false>
                ((CowData<RenderingServer::SurfaceData> *)(this + 8),lVar5);
      return;
    }
    goto LAB_00103ef9;
  }
...
LAB_00103ef9:
  _err_print_index_error
            ("remove_at","./core/templates/cowdata.h",0xe4,param_1,lVar3,"p_index","size()","",false
             ,false);
  return;
}
...
/* RendererDummy::MeshStorage::mesh_add_surface(RID, RenderingServer::SurfaceData const&) */

void __thiscall
RendererDummy::MeshStorage::mesh_add_surface(MeshStorage *this,ulong param_2,undefined4 *param_3)
  ...
  if ((param_2 != 0) && ((uint)param_2 < *(uint *)(this + 100))) {
    ...
    if (*(int *)(lVar8 + 0x58) == (int)(param_2 >> 0x20)) {
      ...
      if (iVar5 == 0) {
        if (*(long *)(lVar8 + 8) == 0) {
          ...
          if (-1 < lVar10) {
            ...
            *(undefined8 *)(puVar7 + 2) = 0x800000000;
            if (*(long *)(puVar7 + 6) != 0) {
              CowData<unsigned_char>::_ref
                        ((CowData<unsigned_char> *)(puVar7 + 6),(CowData *)local_110);
            }
            if (*(long *)(puVar7 + 10) != 0) {
              CowData<unsigned_char>::_ref
                        ((CowData<unsigned_char> *)(puVar7 + 10),(CowData *)local_100);
            }
            if (*(long *)(puVar7 + 0xe) != 0) {
              CowData<unsigned_char>::_ref
                        ((CowData<unsigned_char> *)(puVar7 + 0xe),(CowData *)local_f0);
            }
            puVar7[0x10] = 0;
            if (*(long *)(puVar7 + 0x14) != 0) {
              CowData<unsigned_char>::_ref
                        ((CowData<unsigned_char> *)(puVar7 + 0x14),(CowData *)&local_d8);
            }
            puVar7[0x16] = 0;
            ...
            *(undefined8 *)(puVar7 + 0x19) = uStack_c4;
            if (*(long *)(puVar7 + 0x20) != 0) {
              CowData<RenderingServer::SurfaceData::LOD>::_ref
                        ((CowData<RenderingServer::SurfaceData::LOD> *)(puVar7 + 0x20),
                         (CowData *)local_a8);
            }
            if (*(long *)(puVar7 + 0x24) != 0) {
            ...
            *(ulong *)(puVar7 + 0x30) = CONCAT44(uStack_64,uStack_68);
            if (*(long *)(puVar7 + 0x34) != 0) {
              CowData<unsigned_char>::_ref
                        ((CowData<unsigned_char> *)(puVar7 + 0x34),(CowData *)&local_58);
            }
        ...
        _err_print_index_error
                  ("set","./core/templates/cowdata.h",0xcf,lVar10,lVar6,"p_index","size()","",false,
                   false);
      }
      else {
...
LAB_00104288:
      CowData<RenderingServer::SurfaceData::LOD>::_unref
                ((CowData<RenderingServer::SurfaceData::LOD> *)local_a8);
      if (local_d8 != 0) {
        LOCK();
...
LAB_001045b2:
        _err_print_index_error
                  ("operator[]","./core/templates/vector.h",0x38,lVar10,lVar6,"p_index",
      ...
      *puVar7 = *param_3;
      if (*(long *)(puVar7 + 6) != *(long *)(param_3 + 6)) {
        CowData<unsigned_char>::_ref
                  ((CowData<unsigned_char> *)(puVar7 + 6),(CowData *)(param_3 + 6));
      }
      if (*(long *)(puVar7 + 10) != *(long *)(param_3 + 10)) {
        CowData<unsigned_char>::_ref
                  ((CowData<unsigned_char> *)(puVar7 + 10),(CowData *)(param_3 + 10));
      }
      puVar7[0x10] = param_3[0x10];
      if (*(long *)(puVar7 + 0x14) != *(long *)(param_3 + 0x14)) {
        CowData<unsigned_char>::_ref
                  ((CowData<unsigned_char> *)(puVar7 + 0x14),(CowData *)(param_3 + 0x14));
      }
      ...
      *(undefined8 *)(puVar7 + 0x1b) = *(undefined8 *)(param_3 + 0x1b);
      if (*(long *)(puVar7 + 0xe) != *(long *)(param_3 + 0xe)) {
        CowData<unsigned_char>::_ref
                  ((CowData<unsigned_char> *)(puVar7 + 0xe),(CowData *)(param_3 + 0xe));
      }
      if (*(long *)(puVar7 + 0x20) != *(long *)(param_3 + 0x20)) {
        CowData<RenderingServer::SurfaceData::LOD>::_ref
                  ((CowData<RenderingServer::SurfaceData::LOD> *)(puVar7 + 0x20),
                   (CowData *)(param_3 + 0x20));
      }
      ...
      *(undefined8 *)(puVar7 + 0x30) = uVar3;
      if (*(long *)(puVar7 + 0x34) != lVar6) {
        CowData<unsigned_char>::_ref
                  ((CowData<unsigned_char> *)(puVar7 + 0x34),(CowData *)(param_3 + 0x34));
      }
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    _err_print_error("mesh_add_surface","servers/rendering/dummy/storage/mesh_storage.h",0x4e,
                     "Parameter \"m\" is null.",0,0);
    return;
  }
LAB_00104696:

...
/* VHACD::ICHull::AddPoints(VHACD::Vec3<double> const*, unsigned long) [clone .part.0] */

undefined8 __thiscall VHACD::ICHull::AddPoints(ICHull *this,Vec3 *param_1,ulong param_2)
...

{
  ...
  *(undefined8 *)(this + 0x458) = uVar1;
  *(undefined8 *)(this + 0x460) = uVar2;
  *(undefined8 *)(this + 0x670) = uVar1;
...
void __thiscall VHACD::ICHull::AddPoint(ICHull *this,Vec3 *param_1,int param_2)
...
undefined8 __thiscall VHACD::ICHull::DoubleTriangle(ICHull *this)
...
LAB_00100662:
      pCVar4[0x31] = (CircularListElement)0x1;
      pCVar16[0x31] = (CircularListElement)0x1;
      pCVar17[0x31] = (CircularListElement)0x1;
      pCVar14 = (CircularListElement *)
                MakeFace(this,pCVar17,pCVar16,pCVar4,(CircularListElement *)0x0);
      ...
      *(double **)(this + 8) = pdVar5;
      ...
      pdVar18 = pdVar5;
      if ((double)((ulong)(((dVar31 - dVar20) * (dVar24 - dVar30) -
                           (dVar27 - dVar22) * (dVar21 - dVar30)) * (dVar2 - pdVar5[2]) +
                          (*(double *)(pCVar17 + 8) - pdVar5[1]) *
                          ((dVar26 - dVar1) * (dVar21 - dVar30) -
                          (dVar23 - dVar28) * (dVar24 - dVar30)) +
                          ((dVar23 - dVar28) * (dVar27 - dVar22) -
                          (dVar31 - dVar20) * (dVar26 - dVar1)) * (dVar9 - dVar30)) & _LC2) < _LC3)
      goto LAB_00100899;
      goto LAB_00100a2f;
    }
    dVar20 = *(double *)pCVar4 - *(double *)pCVar17;
    dVar22 = *(double *)pCVar16 - *(double *)pCVar17;
    if (((dVar24 - dVar23) * dVar20 - dVar21 * dVar22 != 0.0) ||
       (dVar22 * dVar30 - dVar28 * dVar20 != 0.0)) goto LAB_00100662;
    pCVar17 = pCVar16;
    dVar23 = dVar24;
    dVar24 = *(double *)(pCVar4 + 0x10);
    dVar21 = *(double *)(pCVar4 + 8);
  ...
  goto LAB_00100a3d;
LAB_00100899:
  pdVar18 = (double *)pdVar18[7];
  if (*(char *)((long)pdVar18 + 0x31) == '\0') goto LAB_001007d0;
  auVar19._0_8_ = dVar9 + 0.0;
  auVar19._8_8_ = dVar10 + 0.0;
  dVar30 = dVar2 + 0.0;
  for (pCVar14 = *(CircularListElement **)(pCVar17 + 0x38); pCVar17 != pCVar14;
      pCVar14 = *(CircularListElement **)(pCVar14 + 0x38)) {
  ...
  *(CircularListElement **)(this + 8) = pCVar4;
  ...
  goto LAB_00100a2f;
LAB_001007d0:
  if (_LC3 <= (double)((ulong)(((dVar24 - *pdVar18) * (dVar31 - pdVar18[1]) -
                               (dVar21 - *pdVar18) * (dVar27 - pdVar18[1])) * (dVar2 - pdVar18[2]) +
                              ((dVar26 - pdVar18[2]) * (dVar21 - *pdVar18) -
                              (dVar23 - pdVar18[2]) * (dVar24 - *pdVar18)) *
                              (*(double *)(pCVar17 + 8) - pdVar18[1]) +
                              (dVar9 - *pdVar18) *
                              ((dVar23 - pdVar18[2]) * (dVar27 - pdVar18[1]) -
                              (dVar31 - pdVar18[1]) * (dVar26 - pdVar18[2]))) & _LC2))
  goto LAB_00100a60;
  goto LAB_00100899;
LAB_00100a60:
  if (pdVar18 == pdVar5) {
  ...
  *param_1 = 0.0;
  ...
  do {
    while( true ) {
      ...
      dVar16 = ((pdVar5[2] - dVar1) * (*pdVar4 - dVar3) - (pdVar4[2] - dVar1) * (*pdVar5 - dVar3)) *
               (pdVar6[1] - dVar2) +
               ((pdVar4[2] - dVar1) * (pdVar5[1] - dVar2) -
               (pdVar4[1] - dVar2) * (pdVar5[2] - dVar1)) * (*pdVar6 - dVar3) +
               ((pdVar4[1] - dVar2) * (*pdVar5 - dVar3) - (*pdVar4 - dVar3) * (pdVar5[1] - dVar2)) *
               (pdVar6[2] - dVar1);
...
char __thiscall VHACD::ICHull::FindMaxVolumePoint(ICHull *this,double param_1)
...

{
  ...
  if ((lVar1 != *(long *)(lVar4 + 0x20)) &&
     (bVar6 = lVar2 == lVar1, lVar2 = *(long *)(lVar4 + 0x20), bVar6)) {
...
CircularListElement * __thiscall
...

{
  ...
  *(long *)(this_00 + 0x10) = local_58[0];
  ...
  if (*(long *)(local_58[0] + 8) == 0) {
    lVar5 = 0;
LAB_001012aa:
    *(CircularListElement **)(local_58[0] + 8 + lVar5 * 8) = this_00;
  }
  else {
    lVar5 = 1;
...
/* VHACD::ICHull::ProcessPoint() [clone .part.0] */

undefined8 __thiscall VHACD::ICHull::ProcessPoint(ICHull *this)
...
LAB_0010132e:
      uVar4 = MakeConeFace(this,pCVar9,pCVar2);
...
undefined8 __thiscall VHACD::ICHull::CleanEdges(ICHull *this)
...
undefined8 __thiscall VHACD::ICHull::CleanTriangles(ICHull *this)
  ...
  do {
    ...
    *(undefined8 *)(pTVar7 + 0x28) = 0;
    ...
    while( true ) {
      ...
      pTVar8 = *(TMMVertex **)(pTVar7 + 0x40);
LAB_001018ce:
      if (pTVar7[0x30] != (TMMVertex)0x0) break;
      if (*(ulong *)(this + 0x10) < 2) {
        if (*(ulong *)(this + 0x10) == 1) {
          pTVar7 = *(TMMVertex **)(this + 8);
          lVar5 = 1;
...
byte __thiscall VHACD::ICHull::CleanUp(ICHull *this,uint *param_1)
...
undefined8 __thiscall VHACD::ICHull::Process(ICHull *this)

{
  ...
  if (*(ulong *)(this + 0x10) == 3) {
    ...
    *(long *)(this + 0x30) = *(long *)(this + 0x30) + 1;
    ...
    auVar27._0_8_ =
         (pdVar4[2] - dVar24) * (pdVar3[1] - pdVar2[1]) -
         (pdVar3[2] - dVar24) * (pdVar4[1] - pdVar2[1]);
    auVar27._8_8_ =
         (*pdVar4 - *pdVar2) * (pdVar3[2] - pdVar2[2]) - (pdVar4[2] - dVar24) * (*pdVar3 - *pdVar2);
    dVar25 = (pdVar4[1] - pdVar2[1]) * (*pdVar3 - *pdVar2) -
             (*pdVar4 - *pdVar2) * (pdVar3[1] - pdVar2[1]);
...
LAB_00101a58:
  ...
  while (*(char *)(lVar11 + 0x31) == '\0') {
    *(undefined1 *)(lVar11 + 0x31) = 1;
    ...
    if ((cVar5 != '\0') && (cVar5 = ProcessPoint(this), cVar5 != '\0')) {
  ...
  if (this[0x698] != (ICHull)0x0) {
    ...
    if (lVar11 == 0) {
      ...
      do {
        ...
        puVar10 = puVar8;
        if (((*(int *)(*(long *)(lVar20 + 0x20) + 0x18) == 0x7fffffff) ||
            (*(int *)(*(long *)(lVar20 + 0x28) + 0x18) == 0x7fffffff)) ||
           (*(int *)(*(long *)(lVar20 + 0x30) + 0x18) == 0x7fffffff)) {
...
LAB_00101df3:
              lVar18 = 0;
LAB_00101df5:
              *(undefined8 *)(lVar19 + 8 + lVar18 * 8) = 0;
            }
          } while( true );
        }
        if (uVar23 == uStack_48) {
...
undefined8 __thiscall VHACD::ICHull::Process(ICHull *this,uint param_1,double param_2)
...
LAB_001027e0:
        ...
        *(undefined1 *)(*(long *)(this + 8) + 0x31) = 1;
        ...
        if ((cVar7 == '\0') || (cVar7 = ProcessPoint(this), cVar7 == '\0')) {
          pTVar23 = *(TMMVertex **)(this + 8);
        }
        else {
          local_264 = uVar6 + 1;
      ...
      if (this[0x698] != (ICHull)0x0) {
        ...
        if (lVar12 == 0) {
          ...
          do {
            ...
            puVar11 = puVar9;
            if (((*(int *)(*(long *)(lVar21 + 0x20) + 0x18) == 0x7fffffff) ||
                (*(int *)(*(long *)(lVar21 + 0x28) + 0x18) == 0x7fffffff)) ||
               (*(int *)(*(long *)(lVar21 + 0x30) + 0x18) == 0x7fffffff)) {
...
LAB_00102953:
                  lVar19 = 0;
LAB_00102955:
                  *(undefined8 *)(lVar20 + 8 + lVar19 * 8) = 0;
                }
              } while( true );
            }
            if (uVar26 == uStack_48) {
...
void __thiscall VHACD::ICHull::Clear(ICHull *this)
...

{
  ...
  if (param_1 != this) {
    ...
    *(ulong *)(this + 0x240) = uVar2;
    pIVar3 = param_1 + 0x38;
    if (*(long *)(param_1 + 0x248) != 0x40) {
      pIVar3 = *(ICHull **)(param_1 + 0x238);
    }
    pIVar5 = this + 0x38;
    if (uVar4 != 0x40) {
      pIVar5 = *(ICHull **)(this + 0x238);
    }
    memcpy(pIVar5,pIVar3,uVar2 << 3);
    uVar4 = *(ulong *)(this + 0x460);
    uVar2 = *(ulong *)(param_1 + 0x458);
    if (uVar4 < uVar2) {
      if (*(void **)(this + 0x450) != (void *)0x0) {
        operator_delete__(*(void **)(this + 0x450));
      }
      uVar2 = *(ulong *)(param_1 + 0x460);
      *(ulong *)(this + 0x460) = uVar2;
      uVar4 = uVar2 * 8;
      if (0xfffffffffffffff < uVar2) {
        uVar4 = 0xffffffffffffffff;
      }
      pvVar1 = operator_new__(uVar4);
      uVar2 = *(ulong *)(param_1 + 0x458);
      *(void **)(this + 0x450) = pvVar1;
      uVar4 = *(ulong *)(this + 0x460);
    }
    *(ulong *)(this + 0x458) = uVar2;
    pIVar3 = param_1 + 0x250;
    if (*(long *)(param_1 + 0x460) != 0x40) {
      pIVar3 = *(ICHull **)(param_1 + 0x450);
    }
    pIVar5 = this + 0x250;
    if (uVar4 != 0x40) {
      pIVar5 = *(ICHull **)(this + 0x450);
    }
    memcpy(pIVar5,pIVar3,uVar2 << 3);
    uVar4 = *(ulong *)(this + 0x678);
    uVar2 = *(ulong *)(param_1 + 0x670);
    if (uVar4 < uVar2) {
      if (*(void **)(this + 0x668) != (void *)0x0) {
        operator_delete__(*(void **)(this + 0x668));
      }
      uVar2 = *(ulong *)(param_1 + 0x678);
      *(ulong *)(this + 0x678) = uVar2;
      uVar4 = uVar2 * 8;
      if (0xfffffffffffffff < uVar2) {
        uVar4 = 0xffffffffffffffff;
      }
      pvVar1 = operator_new__(uVar4);
      uVar2 = *(ulong *)(param_1 + 0x670);
      *(void **)(this + 0x668) = pvVar1;
      uVar4 = *(ulong *)(this + 0x678);
    }
    *(ulong *)(this + 0x670) = uVar2;
    pIVar3 = param_1 + 0x468;
    if (*(long *)(param_1 + 0x678) != 0x40) {
      pIVar3 = *(ICHull **)(param_1 + 0x668);
    }
    pIVar5 = this + 0x468;
    if (uVar4 != 0x40) {
      pIVar5 = *(ICHull **)(this + 0x668);
    }
    memcpy(pIVar5,pIVar3,uVar2 << 3);
...
undefined8 __thiscall VHACD::ICHull::IsInside(ICHull *this,Vec3 *param_1,double param_2)

{
  ...
  if (this[0x698] == (ICHull)0x0) {
    if (lVar6 != 0) {
      ...
      do {
        ...
        if (((pdVar8[2] - dVar1) * (*pdVar7 - dVar3) - (pdVar7[2] - dVar1) * (*pdVar8 - dVar3)) *
            (pdVar9[1] - dVar2) +
            ((pdVar7[2] - dVar1) * (pdVar8[1] - dVar2) - (pdVar7[1] - dVar2) * (pdVar8[2] - dVar1))
            * (*pdVar9 - dVar3) +
            ((pdVar7[1] - dVar2) * (*pdVar8 - dVar3) - (*pdVar7 - dVar3) * (pdVar8[1] - dVar2)) *
            (pdVar9[2] - dVar1) < param_2) {
          return 0;
        }
  ...
  if (lVar6 != 0) {
    ...
    do {
      ...
      dVar13 = (*pdVar7 - dVar14) * (dVar3 - dVar14) + (pdVar7[1] - dVar4) * (dVar2 - dVar4) +
               (pdVar7[2] - dVar5) * (dVar1 - dVar5);
      if ((((0.0 <= dVar13) && (dVar13 <= dVar10)) &&
          (dVar14 = (pdVar8[1] - dVar4) * (dVar2 - dVar4) + (*pdVar8 - dVar14) * (dVar3 - dVar14) +
                    (pdVar8[2] - dVar5) * (dVar1 - dVar5), 0.0 <= dVar14)) &&

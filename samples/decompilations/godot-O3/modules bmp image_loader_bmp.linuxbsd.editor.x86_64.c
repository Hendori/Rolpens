...
/* ImageLoaderBMP::get_recognized_extensions(List<String, DefaultAllocator>*) const */

void __thiscall ImageLoaderBMP::get_recognized_extensions(ImageLoaderBMP *this,List *param_1)
...
void __thiscall ImageLoaderBMP::ImageLoaderBMP(ImageLoaderBMP *this)
...
/* ImageLoaderBMP::convert_to_image(Ref<Image>, unsigned char const*, unsigned char const*, unsigned
   int, ImageLoaderBMP::bmp_header_s const&) */

undefined4
ImageLoaderBMP::convert_to_image
          (undefined8 *param_1,long param_2,long param_3,uint param_4,long param_5)

{
  ...
  if (param_2 != 0) {
    ...
    if (uVar25 == 0) {
      _err_print_error("convert_to_image","modules/bmp/image_loader_bmp.cpp",0x47,
                       "Condition \"data_len == 0\" is true. Returning: ERR_BUG",
                       "Couldn\'t parse the BMP image data.",0,0);
      local_ac = 0x2f;
    }
    else {
      local_ac = CowData<unsigned_char>::resize<false>
                           ((CowData<unsigned_char> *)local_70,(long)(int)uVar25);
      ...
      if ((byte *)(param_2 + ((ulong)*(uint *)(param_5 + 4) - (ulong)*(uint *)(param_5 + 0xc))) <
          (byte *)((long)puVar30 + uVar17)) {
        _err_print_error("convert_to_image","modules/bmp/image_loader_bmp.cpp",0x52,
                         "Condition \"line + line_width > end_buffer\" is true. Returning: ERR_FILE_CORRUPT"
                         ,0,0);
        local_ac = 0x10;
      }
      else {
...
joined_r0x001007c3:
        ...
        if ((param_3 == 0) || (param_4 == 0)) {
          ...
          CowData<unsigned_char>::resize<false>
                    ((CowData<unsigned_char> *)&local_60,(ulong)(param_4 * 4));
          ...
          do {
            uVar25 = uVar25 + 1;
            *(undefined1 *)(local_60 + (uVar19 & 0xffffffff)) =
                 *(undefined1 *)(param_3 + 2 + uVar19);
            iVar12 = (int)uVar19;
          ...
          if (0 < (int)uVar16) {
            ...
            do {
              ...
              *puVar20 = *(undefined1 *)(lVar26 + (int)((uint)*pbVar27 << 2));
              puVar20[1] = *(undefined1 *)(lVar26 + 1 + (ulong)*pbVar27 * 4);
              puVar20[2] = *(undefined1 *)(lVar26 + 2 + (ulong)*pbVar27 * 4);
              puVar20[3] = *(undefined1 *)(lVar26 + 3 + (ulong)*pbVar27 * 4);
              puVar20 = puVar21;
              pbVar27 = pbVar27 + 1;
...
/* ImageLoaderBMP::load_image(Ref<Image>, Ref<FileAccess>, BitField<ImageFormatLoader::LoaderFlags>,
   float) */

int ImageLoaderBMP::load_image(undefined8 param_1,undefined8 *param_2,undefined8 *param_3)

{
  ...
  if ((uVar16 < 0x37) ||
     (local_98[0] = (**(code **)(*(long *)*param_3 + 0x1e8))(), local_98[0] != 0x4d42)) {
    iVar15 = 0x1e;
  }
  else {
    ...
    if (uVar14 < 0x28) {
      ...
      pcVar19 = 
      "Condition \"bmp_header.bmp_info_header.bmp_header_size < BITMAP_INFO_HEADER_MIN_SIZE\" is true. Returning: ERR_FILE_CORRUPT"
      ;
      uVar20 = 0xe1;
    }
    else {
      ...
      if (sVar5 == 1) {
        ...
        if (uVar14 == 3) {
          ...
          if (uVar14 < 2) {
            ...
            String::parse_latin1((StrRange *)&local_b8);
            vformat<String>(&local_a8,(StrRange *)&local_b8,&local_c0);
            _err_print_error("load_image","modules/bmp/image_loader_bmp.cpp",0x10c,
                             "Method/function failed. Returning: ERR_UNAVAILABLE",&local_a8,0,0);
            pcVar19 = local_a8;
        ...
        local_a0 = 0;
        iVar15 = CowData<unsigned_char>::resize<false>
                           ((CowData<unsigned_char> *)&local_a0,(ulong)(uint)(iVar11 - iVar13));
        lVar24 = local_a0;
        if (iVar15 == 0) {
          CowData<unsigned_char>::_copy_on_write((CowData<unsigned_char> *)&local_a0);
          lVar24 = local_a0;
          (**(code **)(*(long *)*param_3 + 0x220))
                    ((long *)*param_3,local_a0,(ulong)(uint)(iVar11 - iVar13));
          pIVar3 = (Image *)*param_2;
          if ((pIVar3 == (Image *)0x0) ||
             (local_c0 = pIVar3, cVar4 = RefCounted::reference(), cVar4 == '\0')) {
            local_c0 = (Image *)0x0;
      ...
      vformat<String>(&local_a8,(StrRange *)&local_b8,&local_c0);
      pcVar19 = 
      "Condition \"bmp_header.bmp_info_header.bmp_planes != 1\" is true. Returning: ERR_FILE_CORRUPT"
      ;
      uVar20 = 0xe8;
    }
...
{
  return (uint)CONCAT71(0x1040,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr) |
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialize_class()::initialized != '\0') goto LAB_00102ecb;
...
/* WARNING: Removing unreachable block (ram,0x00103388) */
/* WARNING: Removing unreachable block (ram,0x00103550) */
/* WARNING: Removing unreachable block (ram,0x00103394) */
/* WARNING: Removing unreachable block (ram,0x0010339e) */
/* WARNING: Removing unreachable block (ram,0x00103530) */
/* WARNING: Removing unreachable block (ram,0x001033aa) */
/* WARNING: Removing unreachable block (ram,0x001033b4) */
/* WARNING: Removing unreachable block (ram,0x00103510) */
/* WARNING: Removing unreachable block (ram,0x001033c0) */
/* WARNING: Removing unreachable block (ram,0x001033ca) */
...
/* WARNING: Removing unreachable block (ram,0x001033f6) */
/* WARNING: Removing unreachable block (ram,0x001034b0) */
/* WARNING: Removing unreachable block (ram,0x00103402) */
/* WARNING: Removing unreachable block (ram,0x0010340c) */
/* WARNING: Removing unreachable block (ram,0x00103490) */
/* WARNING: Removing unreachable block (ram,0x00103414) */
/* WARNING: Removing unreachable block (ram,0x0010342a) */
/* WARNING: Removing unreachable block (ram,0x00103436) */

...
/* symbolic_to_physical(block_size_descriptor const&, symbolic_compressed_block const&, unsigned
   char*) */

void symbolic_to_physical
               (block_size_descriptor *param_1,symbolic_compressed_block *param_2,uchar *param_3)
  ...
  if (((byte)bVar3 & 1) == 0) {
    ...
    if (uVar16 != 0) {
      ...
      do {
        local_88[lVar8] =
             decode_ise
             [(long)(int)((float)(byte)param_2[lVar8 + 0x40] * _LC2 * (fVar24 - __LC1) + _LC3) +
              (long)(int)uVar15 * 0xe2];
        lVar8 = lVar8 + 1;
    ...
    if (uVar16 == 0) {
      ...
      lVar8 = 0;
      do {
        *(ushort *)(local_88 + lVar8 * 2) =
             CONCAT11(decode_ise
                      [(long)(int)((float)(byte)param_2[lVar8 + 0x60] * _LC2 * (fVar24 - __LC1) +
                                  _LC3) + (long)(int)uVar15 * 0xe2],
                      decode_ise
                      [(long)(int)((float)(byte)param_2[lVar8 + 0x40] * _LC2 * (fVar24 - __LC1) +
                                  _LC3) + (long)(int)uVar15 * 0xe2]);
        lVar8 = lVar8 + 1;
  ...
  *param_3 = (uchar)(*(ushort *)(param_2 + 4) & 0x7ff);
  ...
  if ((byte)sVar10 < 2) {
    ...
    if (param_2[2] == (symbolic_compressed_block)0x0) {
      ...
      bVar11 = (byte)iVar6 & 7;
      *(ushort *)(param_3 + (iVar6 >> 3)) =
           ~(ushort)(uVar7 << bVar11) & *(ushort *)(param_3 + (iVar6 >> 3)) |
           (ushort)(((int)uVar16 >> 6 & uVar7) << bVar11);
    }
    else {
      sVar10 = param_2[8];
  ...
  if (((byte)bVar3 & 1) != 0) {
    ...
    *(ushort *)(param_3 + (iVar6 + -2 >> 3)) =
         ~(ushort)(3 << bVar11) & *(ushort *)(param_3 + (iVar6 + -2 >> 3)) |
         (ushort)(((byte)param_2[3] & 3) << bVar11);
  }
...
LAB_00100511:
    ...
    do {
      ...
      do {
        local_a8[lVar9 + iVar12] =
             (&color_uquant_to_scrambled_pquant_tables)
             [(ulong)(byte)psVar21[lVar9 + 0x14] + (long)(iVar6 + -4) * 0x100];
        lVar9 = lVar9 + 1;
...
void physical_to_symbolic
               (block_size_descriptor *param_1,uchar *param_2,symbolic_compressed_block *param_3)
  ...
  *param_3 = (symbolic_compressed_block)0x3;
  ...
  if ((uVar11 & 0x1ff) == 0x1fc) {
    ...
    *param_3 = (symbolic_compressed_block)(((uVar11 & 0x200) == 0) + '\x01');
    lVar15 = 0;
    do {
      *(uint *)(param_3 + lVar15 * 2 + 0x14) =
           (uint)CONCAT11(param_2[lVar15 + 9],param_2[lVar15 + 8]);
      lVar15 = lVar15 + 2;
    } while (lVar15 != 8);
    ...
    if (param_1[2] == (block_size_descriptor)0x1) {
      if ((~(uint)uVar11 & 0xc) == 0) {
        ...
        uVar10 = (uint)*(ushort *)(param_2 + 5) * 4 & 0x1f00 |
                 (int)(uint)*(ushort *)(param_2 + 4) >> 6 & 0xffU;
        uVar28 = (int)(uint)*(ushort *)(param_2 + 3) >> 1 & 0x1fff;
        if ((uVar12 == 0x1fff) && (uVar28 == 0x1fff)) {
          if ((uVar10 == 0x1fff) && ((int)(uint)*(ushort *)(param_2 + 6) >> 3 == 0x1fff))
          goto LAB_001007af;
        }
        else if ((uVar12 < uVar28) && (uVar10 < (uint)((int)(uint)*(ushort *)(param_2 + 6) >> 3)))
        goto LAB_001007af;
      }
    }
    else {
      ...
      if ((uVar12 == 0x1ff) && (uVar28 == 0x1ff)) {
        if ((uVar14 == 0x1ff) &&
           (((uVar10 == 0x1ff && (uVar22 == 0x1ff)) &&
            ((int)(uint)*(ushort *)(param_2 + 6) >> 7 == 0x1ff)))) goto LAB_001007af;
      }
      else if ((uVar12 < uVar28 && uVar14 < uVar10) &&
              (uVar22 < (uint)((int)(uint)*(ushort *)(param_2 + 6) >> 7))) goto LAB_001007af;
    }
  }
    ...
    *(ushort *)(param_3 + 4) = uVar11 & 0x7ff;
    ...
    if (((byte)bVar1 & 1) == 0) {
      do {
        param_3[lVar15 + 0x40] =
             *(symbolic_compressed_block *)((ulong)local_88[lVar15] + lVar27 + 0x101048);
        lVar15 = lVar15 + 1;
      ...
      do {
        param_3[lVar15 + 0x40] =
             *(symbolic_compressed_block *)((ulong)local_88[lVar15 * 2] + lVar27 + 0x101048);
        param_3[lVar15 + 0x60] =
             *(symbolic_compressed_block *)(lVar27 + 0x101048 + (ulong)local_88[lVar15 * 2 + 1]);
        lVar15 = lVar15 + 1;
      } while ((int)lVar15 < (int)(uint)(byte)bVar3);
    ...
    if (iVar25 == 1) {
      ...
      uVar12 = ((1 << ((byte)iVar13 & 0x1f)) - 1U &
               (int)(uint)*(ushort *)(param_2 + (iVar26 >> 3)) >> ((byte)iVar26 & 7)) << 6 |
               (int)(uint)*(ushort *)(param_2 + 2) >> 7 & 0x3fU;
    ...
    *(ushort *)(param_3 + 6) = uVar11;
    ...
    if (iVar26 < 0x13) {
      iVar13 = (*(int *)(physical_to_symbolic(block_size_descriptor_const&,unsigned_char_const*,symbolic_compressed_block&)
                         ::color_bits_arr + (long)iVar25 * 4) - iVar7) - iVar13;
      if (((byte)bVar1 & 1) != 0) {
        iVar13 = iVar13 + -2;
      }
      if (iVar13 < 0) {
      ...
      if ('\x03' < cVar4) {
        *(int *)(param_3 + 0xc) = (int)cVar4;
        ...
        iVar25 = 0;
        lVar15 = *(long *)(&color_scrambled_pquant_to_uquant_tables +
                          (long)(*(int *)(param_3 + 0xc) + -4) * 8);
        psVar20 = param_3;
        do {
          ...
          if (0 < iVar7) {
            do {
              psVar20[lVar27 + 0x14] =
                   *(symbolic_compressed_block *)(lVar15 + (ulong)local_a8[lVar27 + iVar25]);
              lVar27 = lVar27 + 1;
        ...
        if (((byte)bVar1 & 1) != 0) {
          param_3[3] = (symbolic_compressed_block)
                       ((byte)((int)(uint)*(ushort *)(param_2 + (iVar21 + -2 >> 3)) >>
                              ((byte)(iVar21 + -2) & 7)) & 3);
        }
        goto LAB_001007af;
      }
...
LAB_001007ac:
  *param_3 = (symbolic_compressed_block)0x0;
LAB_001007af:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();

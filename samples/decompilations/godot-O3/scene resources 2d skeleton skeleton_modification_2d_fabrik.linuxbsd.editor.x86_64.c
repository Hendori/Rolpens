...
SkeletonModification2DFABRIK::get_fabrik_data_chain_length(SkeletonModification2DFABRIK *this)
...
/* SkeletonModification2DFABRIK::get_target_node() const */

void SkeletonModification2DFABRIK::get_target_node(void)
...
/* SkeletonModification2DFABRIK::get_fabrik_joint_bone2d_node(int) const */

NodePath * SkeletonModification2DFABRIK::get_fabrik_joint_bone2d_node(int param_1)
...
LAB_00100089:
  _err_print_index_error
            ("get_fabrik_joint_bone2d_node",
             "scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp",0x17b,lVar2,lVar3,
             "p_joint_idx","fabrik_data_chain.size()","FABRIK joint out of range!",false,false);
  *(undefined8 *)this = 0;
  return this;
}
...
/* SkeletonModification2DFABRIK::get_fabrik_joint_bone_index(int) const */

undefined4 __thiscall
SkeletonModification2DFABRIK::get_fabrik_joint_bone_index
          (SkeletonModification2DFABRIK *this,int param_1)
...
LAB_00100119:
  _err_print_index_error
            ("get_fabrik_joint_bone_index",
             "scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp",0x195,lVar2,lVar3,
             "p_joint_idx","fabrik_data_chain.size()","FABRIK joint out of range!",false,false);
  return 0xffffffff;
}
...
/* SkeletonModification2DFABRIK::get_fabrik_joint_magnet_position(int) const */
...
LAB_001001a9:
  _err_print_index_error
            ("get_fabrik_joint_magnet_position",
             "scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp",0x19f,lVar2,lVar3,
             "p_joint_idx","fabrik_data_chain.size()","FABRIK joint out of range!",false,false);
  return 0;
}
...
/* SkeletonModification2DFABRIK::get_fabrik_joint_use_target_rotation(int) const */
...
LAB_00100239:
  _err_print_index_error
            ("get_fabrik_joint_use_target_rotation",
             "scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp",0x1a9,lVar2,lVar3,
             "p_joint_idx","fabrik_data_chain.size()","FABRIK joint out of range!",false,false);
  return 0;
}
...
/* CowData<Transform2D>::_copy_on_write() [clone .isra.0] */

void __thiscall CowData<Transform2D>::_copy_on_write(CowData<Transform2D> *this)
...
/* SkeletonModification2DFABRIK::chain_backwards() */

void __thiscall SkeletonModification2DFABRIK::chain_backwards(SkeletonModification2DFABRIK *this)

{
  ...
  if (lVar6 != 0) {
    ...
    if (uVar13 != 0) {
      ...
      local_88 = CONCAT44((float)((ulong)local_88 >> 0x20) + (float)((ulong)uVar3 >> 0x20),
                          (float)local_88 + (float)uVar3);
    }
    ...
    if (lVar6 != 0) {
      ...
      if (lVar7 < lVar11) {
        ...
        local_88 = CONCAT44((float)((ulong)*(undefined8 *)(this + 0x2ec) >> 0x20) -
                            fVar17 * fVar16 * local_cc,
                            (float)*(undefined8 *)(this + 0x2ec) - fVar17 * fVar16 * local_d0);
              ...
              do {
                ...
                if (uVar13 != 0) {
                  ...
                  local_48 = CONCAT44((float)((ulong)local_48 >> 0x20) +
                                      (float)((ulong)uVar3 >> 0x20),(float)local_48 + (float)uVar3);
                }
                fVar17 = (float)Bone2D::get_length();
                Node2D::get_global_scale();
                fVar16 = (float)Node2D::get_global_scale();
                ...
                local_48 = CONCAT44(((float)((ulong)local_48 >> 0x20) - fVar16) * fVar18 + fVar16,
                                    ((float)local_48 - (float)local_68) * fVar18 + (float)local_68);
...
/* SkeletonModification2DFABRIK::chain_forwards() */

void __thiscall SkeletonModification2DFABRIK::chain_forwards(SkeletonModification2DFABRIK *this)
...
LAB_00100e5f:
          _err_print_index_error
                    ("operator[]","./core/templates/vector.h",0x38,lVar12,lVar10,"p_index",
                     "((Vector<T> *)(this))->_cowdata.size()","",false,true);
          _err_flush_stdout();
                    /* WARNING: Does not return */
          pcVar5 = (code *)invalidInstructionException();
        ...
        *puVar1 = uVar6;
        puVar1[1] = uVar7;
        *(ulong *)(lVar10 + 0x10 + lVar11) =
             CONCAT44(((float)uVar3 - fVar17) * fVar16 + fVar17,(fVar15 - fVar14) * fVar16 + fVar14)
        ;
        lVar10 = *(long *)(this + 0x2a8);
        lVar11 = lVar11 + 0x18;
      }
...
LAB_00100e03:
  _err_print_index_error
            ("get","./core/templates/cowdata.h",0xdb,lVar12,lVar10,"p_index","size()","",false,true)
  ;
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar5 = (code *)invalidInstructionException();
...
/* SkeletonModification2DFABRIK::update_target_cache() */

long __thiscall
SkeletonModification2DFABRIK::update_target_cache(SkeletonModification2DFABRIK *this)
        ...
        if ((char)lVar2 != '\0') {
          ...
          if ((lVar2 == 0) || (*(long *)(*(long *)(this + 0x240) + 0x240) == lVar2)) {
            ...
            _err_print_error("update_target_cache",
                             "scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp",0x139
...
/* SkeletonModification2DFABRIK::set_target_node(NodePath const&) */

void __thiscall
SkeletonModification2DFABRIK::set_target_node(SkeletonModification2DFABRIK *this,NodePath *param_1)
...
void __thiscall
SkeletonModification2DFABRIK::SkeletonModification2DFABRIK(SkeletonModification2DFABRIK *this)
...
/* SkeletonModification2DFABRIK::_get(StringName const&, Variant&) const */

undefined4 __thiscall
SkeletonModification2DFABRIK::_get
          (SkeletonModification2DFABRIK *this,StringName *param_1,Variant *param_2)
...
LAB_00101420:
      _err_print_index_error
                ("_get","scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp",0x42,
                 (long)iVar6,lVar10,"which","fabrik_data_chain.size()","",false,false);
    }
    else {
      if (*(long *)(this + 0x2a8) == 0) {
LAB_001014b0:
...
/* SkeletonModification2DFABRIK::_get_property_list(List<PropertyInfo, DefaultAllocator>*) const */

void __thiscall
SkeletonModification2DFABRIK::_get_property_list(SkeletonModification2DFABRIK *this,List *param_1)
...
/* SkeletonModification2DFABRIK::_bind_methods() */

void SkeletonModification2DFABRIK::_bind_methods(void)

{
  ...
  auStack_50 = (undefined1  [16])0x0;
  local_58 = (char **)0x0;
  pMVar5 = create_method_bind<SkeletonModification2DFABRIK,int,NodePath_const&>
  ...
  auStack_50 = (undefined1  [16])0x0;
  local_58 = (char **)0x0;
  pMVar5 = create_method_bind<SkeletonModification2DFABRIK,NodePath,int>
                     (get_fabrik_joint_bone2d_node);
  ClassDB::bind_methodfi(1,pMVar5,false,(MethodDefinition *)&local_118,(Variant **)0x0,0);
  if (Variant::needs_deinit[(int)local_58] != '\0') {
    Variant::_clear_internal();
  ...
  auStack_50 = (undefined1  [16])0x0;
  local_58 = (char **)0x0;
  pMVar5 = create_method_bind<SkeletonModification2DFABRIK,int,Vector2>
  ...
  auStack_50 = (undefined1  [16])0x0;
  local_58 = (char **)0x0;
  pMVar5 = create_method_bind<SkeletonModification2DFABRIK,Vector2,int>
                     (get_fabrik_joint_magnet_position);
  ClassDB::bind_methodfi(1,pMVar5,false,(MethodDefinition *)&local_118,(Variant **)0x0,0);
  if (Variant::needs_deinit[(int)local_58] != '\0') {
    Variant::_clear_internal();
  ...
  auStack_50 = (undefined1  [16])0x0;
  local_58 = (char **)0x0;
  pMVar5 = create_method_bind<SkeletonModification2DFABRIK,int,bool>
  ...
  auStack_50 = (undefined1  [16])0x0;
  local_58 = (char **)0x0;
  pMVar5 = create_method_bind<SkeletonModification2DFABRIK,bool,int>
                     (get_fabrik_joint_use_target_rotation);
  ClassDB::bind_methodfi(1,pMVar5,false,(MethodDefinition *)&local_118,(Variant **)0x0,0);
  if (Variant::needs_deinit[(int)local_58] != '\0') {
    Variant::_clear_internal();
...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_00111e00;
  ...
  CowData<SkeletonModification2DFABRIK::FABRIK_Joint_Data2D>::_unref
            ((CowData<SkeletonModification2DFABRIK::FABRIK_Joint_Data2D> *)(this + 0x2a8));
...
void __thiscall
CowData<SkeletonModification2DFABRIK::FABRIK_Joint_Data2D>::_copy_on_write
          (CowData<SkeletonModification2DFABRIK::FABRIK_Joint_Data2D> *this)
...
/* SkeletonModification2DFABRIK::set_fabrik_joint_use_target_rotation(int, bool) */

void __thiscall
SkeletonModification2DFABRIK::set_fabrik_joint_use_target_rotation
          (SkeletonModification2DFABRIK *this,int param_1,bool param_2)
...
LAB_00103ef1:
  _err_print_index_error
            ("set_fabrik_joint_use_target_rotation",
             "scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp",0x1a4,lVar2,lVar1,
             "p_joint_idx","fabrik_data_chain.size()","FABRIK joint out of range!",false,false);
  return;
}
...
/* SkeletonModification2DFABRIK::set_fabrik_joint_magnet_position(int, Vector2) */

void __thiscall
SkeletonModification2DFABRIK::set_fabrik_joint_magnet_position
          (undefined8 param_1_00,SkeletonModification2DFABRIK *this,int param_1)
...
LAB_00103fa1:
  _err_print_index_error
            ("set_fabrik_joint_magnet_position",
             "scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp",0x19a,lVar2,lVar1,
             "p_joint_idx","fabrik_data_chain.size()","FABRIK joint out of range!",false,false);
  return;
}
...
/* SkeletonModification2DFABRIK::set_fabrik_joint_bone_index(int, int) */

void __thiscall
SkeletonModification2DFABRIK::set_fabrik_joint_bone_index
          (SkeletonModification2DFABRIK *this,int param_1,int param_2)
...
LAB_001042a5:
    _err_print_index_error
              ("set_fabrik_joint_bone_index",
               "scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp",0x180,lVar6,lVar4,
               "p_joint_idx","fabrik_data_chain.size()","FABRIK joint out of range!",false,false);
  }
  else {
    if (lVar4 == 0) {
...
LAB_00104272:
        ...
        *(int *)(*(long *)(this + 0x2a8) + lVar6 * 0x28) = param_2;
        ...
        if (*(long *)(*(long *)(this + 0x240) + 0x240) == 0) {
          ...
          itos((long)local_70);
          operator+((char *)local_68,(String *)"Cannot verify the FABRIK joint ");
          String::operator+((String *)&local_58,local_68);
          _err_print_error("set_fabrik_joint_bone_index",
                           "scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp",0x18a,
                           (String *)&local_58,0,1);
          CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
        ...
        if (iVar3 <= param_2) {
          ...
          _err_print_index_error
                    ("set_fabrik_joint_bone_index",
                     "scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp",0x185,
...
LAB_0010430b:
    ...
    _err_print_error("set_fabrik_joint_bone_index",
                     "scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp",0x181,
...
/* SkeletonModification2DFABRIK::fabrik_joint_update_bone2d_cache(int) */

void __thiscall
SkeletonModification2DFABRIK::fabrik_joint_update_bone2d_cache
          (SkeletonModification2DFABRIK *this,int param_1)
    ...
    if (lVar8 < lVar5) {
      ...
      if (*(long *)(this + 0x240) == 0) {
        if (fabrik_joint_update_bone2d_cache(int)::first_print != '\0') {
          _err_print_error("fabrik_joint_update_bone2d_cache",
                           "scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp",0x145,
                           "Cannot update FABRIK Bone2D cache: modification is not properly setup!",
                           0,0);
          fabrik_joint_update_bone2d_cache(int)::first_print = '\0';
        }
        goto LAB_001045d8;
      }
      this_00 = (CowData<SkeletonModification2DFABRIK::FABRIK_Joint_Data2D> *)(this + 0x2a8);
      ...
      if (lVar5 != 0) {
        ...
        if (*(long *)(this + 0x2a8) != 0) {
          ...
          if ((lVar5 == 0) || (*(long *)(*(long *)(this + 0x240) + 0x240) == lVar5)) {
            ...
            itos((long)local_60);
            operator+((char *)local_58,(String *)"Cannot update FABRIK joint ");
              ...
              if (*(long *)(this + 0x2a8) != 0) {
                ...
                *(undefined8 *)(*(long *)(this + 0x2a8) + 0x10 + lVar10) = uVar7;
                ...
                if (lVar5 == 0) {
                  ...
                  itos((long)local_60);
                  operator+((char *)local_58,(String *)"FABRIK joint ");
                  String::operator+(local_48,local_58);
...
LAB_0010474b:
          _err_print_error("fabrik_joint_update_bone2d_cache",
                           "scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp",uVar7,
...
LAB_0010469b:
  ...
  _err_print_index_error
            ("fabrik_joint_update_bone2d_cache",
             "scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp",0x142,lVar8,lVar5,
             "p_joint_idx","fabrik_data_chain.size()",
...
/* SkeletonModification2DFABRIK::_setup_modification(SkeletonModificationStack2D*) */

void __thiscall
SkeletonModification2DFABRIK::_setup_modification
          (SkeletonModification2DFABRIK *this,SkeletonModificationStack2D *param_1)
...
/* SkeletonModification2DFABRIK::set_fabrik_joint_bone2d_node(int, NodePath const&) */

void __thiscall
SkeletonModification2DFABRIK::set_fabrik_joint_bone2d_node
          (SkeletonModification2DFABRIK *this,int param_1,NodePath *param_2)
...
LAB_001049c9:
  _err_print_index_error
            ("set_fabrik_joint_bone2d_node",
             "scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp",0x173,lVar2,lVar1,
             "p_joint_idx","fabrik_data_chain.size()","FABRIK joint out of range!",false,false);
  return;
}
...
/* SkeletonModification2DFABRIK::_set(StringName const&, Variant const&) */

undefined4 __thiscall
SkeletonModification2DFABRIK::_set
          (SkeletonModification2DFABRIK *this,StringName *param_1,Variant *param_2)
...
LAB_00104cb3:
      _err_print_index_error
                ("_set","scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp",0x28,
                 (long)iVar6,lVar9,"which","fabrik_data_chain.size()","",false,false);
    }
    else {
      if (*(long *)(this + 0x2a8) == 0) {
LAB_00104d20:
...
/* SkeletonModification2DFABRIK::_execute(float) */

void SkeletonModification2DFABRIK::_execute(float param_1)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (((*(long *)(in_RDI + 0x240) == 0) || (in_RDI[0x24d] == (SkeletonModification2DFABRIK)0x0)) ||
     (*(long *)(*(long *)(in_RDI + 0x240) + 0x240) == 0)) {
    _err_print_error("_execute","scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp",
                     0x66,"Condition \"!stack || !is_setup || stack->skeleton == nullptr\" is true."
    ...
    if (uVar9 == 0) {
      if (_execute(float)::first_print != '\0') {
        _err_print_error("_execute",
                         "scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp",0x6d,
    ...
    if ((*(long *)(in_RDI + 0x2a8) == 0) || (*(long *)(*(long *)(in_RDI + 0x2a8) + -8) < 2)) {
      if (_execute(float)::first_print != '\0') {
        _err_print_error("_execute",
                         "scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp",0x73,
                         "FABRIK requires at least two joints to operate! Cannot execute modification!"
                         ,0,0);
        _execute(float)::first_print = '\0';
      }
      goto LAB_00105311;
    ...
    if (uVar15 < (uint)ObjectDB::slot_max) {
      ...
      if ((*puVar16 & 0x7fffffffff) == (uVar9 >> 0x18 & 0x7fffffffff)) {
        ...
        ObjectDB::spin_lock._0_1_ = '\0';
        if (((uVar9 != 0) &&
            (plVar7 = (long *)__dynamic_cast(uVar9,&Object::typeinfo,&Node2D::typeinfo),
            param_1 = extraout_XMM0_Da, plVar7 != (long *)0x0)) &&
           ((*(byte *)((long)plVar7 + 0x2fa) & 0x40) != 0)) {
          (**(code **)(*plVar7 + 0x298))(&local_e8);
            ...
            if (0 < lVar14) {
              if (*(long *)(lVar8 + 0x10) == 0) {
                ...
                if (cVar5 == '\0') {
                  ...
                  _err_print_error("_execute",
                                   "scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp"
                                   ,0x80,"Bone2D cache for origin joint is out of date. Updating..."
                                   ,0,1);
                }
                lVar8 = *(long *)(in_RDI + 0x2a8);
              ...
              if (uVar15 < (uint)ObjectDB::slot_max) {
                ...
                if ((*(ulong *)(lVar8 + 0x10) >> 0x18 & 0x7fffffffff) == (*puVar16 & 0x7fffffffff))
                {
                  ...
                  ObjectDB::spin_lock._0_1_ = '\0';
                  if (((uVar9 != 0) &&
                      (plVar7 = (long *)__dynamic_cast(uVar9,&Object::typeinfo,&Bone2D::typeinfo,0),
                      plVar7 != (long *)0x0)) && ((*(byte *)((long)plVar7 + 0x2fa) & 0x40) != 0)) {
                    (**(code **)(*plVar7 + 0x298))(&local_e8);
...
LAB_00104fc6:
                        this = (CowData<Transform2D> *)(in_RDI + 0x2b8);
                        ...
                        if (lVar14 * 0x18 != 0) {
                          ...
                          if (lVar18 < lVar14) {
                            if (lVar17 == lVar8) {
LAB_00105b8c:
                              puVar13 = *(undefined8 **)(in_RDI + 0x2b8);
...
LAB_001050f0:
                          ...
                          if ((lVar17 == lVar8) ||
                             (iVar6 = CowData<Transform2D>::_realloc(this,lVar17), iVar6 == 0)) {
                      ...
                      if (*(long *)(lVar17 + lVar8 * 0x28 + 0x10) == 0) {
                        ...
                        if (cVar5 == '\0') {
                          if (_execute(float)::first_print != '\0') {
                            ...
                            String::parse_latin1
                                      ((String *)&local_b0,
                                       " is out of date.. Attempting to update...");
                            itos((long)local_c0);
                            operator+((char *)local_b8,(String *)"Bone2D cache for joint ");
...
LAB_0010561e:
                        if (_execute(float)::first_print != '\0') {
                          ...
                          String::parse_latin1
                                    ((String *)&local_b0,
                                     " does not have a Bone2D node set! Cannot execute modification!"
                                    );
                          itos((long)local_c0);
                          operator+((char *)local_b8,(String *)"FABRIK Joint ");
                          String::operator+(local_a8,(String *)local_b8);
                          _err_print_error("_execute",
                                           "scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp"
                                           ,0x97,local_a8,0,0);
                      ...
                      ObjectDB::spin_lock._0_1_ = '\0';
                      if ((uVar9 == 0) ||
                         (plVar7 = (long *)__dynamic_cast(uVar9,&Object::typeinfo,&Bone2D::typeinfo,
                                                          0), plVar7 == (long *)0x0))
                      goto LAB_0010561e;
...
LAB_00105708:
                        _err_print_index_error
                                  ("operator[]","./core/templates/vector.h",0x38,lVar8,lVar14,
                    ...
                    local_98 = CONCAT44(fVar24 * fVar21 + (float)((ulong)uVar23 >> 0x20),
                                        fVar20 * fVar21 + (float)uVar23);
                    local_58[0] = Node2D::get_global_position();
                    fVar20 = (float)Vector2::distance_to((Vector2 *)&local_98);
                    *(undefined4 *)(in_RDI + 0x2d8) = 0;
                    do {
                      if (fVar20 < *(float *)(in_RDI + 0x2d0) ||
                          fVar20 == *(float *)(in_RDI + 0x2d0)) break;
                      ...
                      uVar23 = Node2D::get_global_position();
                      local_98 = CONCAT44(fVar24 + (float)((ulong)uVar23 >> 0x20),
                                          fVar20 + (float)uVar23);
                      local_58[0] = Node2D::get_global_position();
                      fVar20 = (float)Vector2::distance_to((Vector2 *)&local_98);
                    ...
                    do {
                      ...
                      if (uVar15 < (uint)ObjectDB::slot_max) {
                        ...
                        if ((uVar9 == 0) ||
                           (pTVar12 = (Transform2D *)
                                      __dynamic_cast(uVar9,&Object::typeinfo,&Bone2D::typeinfo,0),
                           pTVar12 == (Transform2D *)0x0)) goto LAB_00105eab;
...
LAB_00105f81:
                        ...
                        Skeleton2D::set_bone_local_pose_override
                                  (uVar1,uVar23,*(undefined4 *)(lVar2 + local_118 * 0x28),1);
                      }
                      else {
                        _err_print_error("get_instance","./core/object/object.h",0x418,
                                         "Condition \"slot >= slot_max\" is true. Returning: nullptr"
...
LAB_00105eab:
                        if (_execute(float)::first_print != '\0') {
                          local_b0 = 0;
                          String::parse_latin1
                                    ((String *)&local_b0," does not have a Bone2D node set!");
                          itos((long)local_c0);
                          operator+((char *)local_b8,(String *)"FABRIK Joint ");
                          String::operator+(local_a8,(String *)local_b8);
                          _err_print_error("_execute",
              ...
              if (_execute(float)::first_print != '\0') {
                _err_print_error("_execute",
                                 "scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp",
                                 0x85,
                                 "Origin joint\'s Bone2D node is not in the scene tree. Cannot execute modification!"
                                 ,0,0);
                _execute(float)::first_print = '\0';
              }
              goto LAB_00105311;
...
LAB_001052bd:
    ...
    if (_execute(float)::first_print != '\0') {
      _err_print_error(param_1,"_execute",
                       "scene/resources/2d/skeleton/skeleton_modification_2d_fabrik.cpp",0x79,
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* SkeletonModification2DFABRIK::set_fabrik_data_chain_length(int) */
...
/* SkeletonModification2DFABRIK::is_class_ptr(void*) const */

uint __thiscall
SkeletonModification2DFABRIK::is_class_ptr(SkeletonModification2DFABRIK *this,void *param_1)

{
  return (uint)CONCAT71(0x1124,(undefined4 *)param_1 ==
         ...
         (uint)CONCAT71(0x1124,(undefined4 *)param_1 == &Resource::get_class_ptr_static()::ptr) |
...
/* SkeletonModification2DFABRIK::_validate_propertyv(PropertyInfo&) const */

void SkeletonModification2DFABRIK::_validate_propertyv(PropertyInfo *param_1)
...
/* SkeletonModification2DFABRIK::_property_can_revertv(StringName const&) const */

undefined8 SkeletonModification2DFABRIK::_property_can_revertv(StringName *param_1)
...
/* SkeletonModification2DFABRIK::_property_get_revertv(StringName const&, Variant&) const */

undefined8 SkeletonModification2DFABRIK::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* SkeletonModification2DFABRIK::_notificationv(int, bool) */

void SkeletonModification2DFABRIK::_notificationv(int param_1,bool param_2)
...
/* CowData<Transform2D>::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<Transform2D>::_copy_on_write(void)
...
/* SkeletonModification2DFABRIK::_bind_methods() [clone .cold] */
...
void CowData<SkeletonModification2DFABRIK::FABRIK_Joint_Data2D>::_copy_on_write(void)
...
/* SkeletonModification2DFABRIK::_execute(float) [clone .cold] */
...
/* SkeletonModification2DFABRIK::set_fabrik_data_chain_length(int) [clone .cold] */

void SkeletonModification2DFABRIK::set_fabrik_data_chain_length(int param_1)
...
/* SkeletonModification2DFABRIK::_get_class_namev() const */

undefined8 * SkeletonModification2DFABRIK::_get_class_namev(void)
...
LAB_00107853:
  ...
  StringName::assign_static_unique_class_name
            ((StringName *)&_get_class_namev()::_class_name_static,"SkeletonModification2DFABRIK");
LAB_001078be:
  return &_get_class_namev()::_class_name_static;
}
...
/* SkeletonModification2DFABRIK::get_class() const */

void SkeletonModification2DFABRIK::get_class(void)
...
/* SkeletonModification2DFABRIK::_getv(StringName const&, Variant&) const */

void __thiscall
SkeletonModification2DFABRIK::_getv
          (SkeletonModification2DFABRIK *this,StringName *param_1,Variant *param_2)
...
/* SkeletonModification2DFABRIK::is_class(String const&) const */

undefined8 __thiscall
SkeletonModification2DFABRIK::is_class(SkeletonModification2DFABRIK *this,String *param_1)
...
void __thiscall
SkeletonModification2DFABRIK::_get_property_listv
          (SkeletonModification2DFABRIK *this,List *param_1,bool param_2)
...
/* MethodBind* create_method_bind<SkeletonModification2DFABRIK, NodePath const&>(void
   (SkeletonModification2DFABRIK::*)(NodePath const&)) */

MethodBind *
create_method_bind<SkeletonModification2DFABRIK,NodePath_const&>(_func_void_NodePath_ptr *param_1)
...
/* MethodBind* create_method_bind<SkeletonModification2DFABRIK, NodePath>(NodePath
   (SkeletonModification2DFABRIK::*)() const) */

MethodBind * create_method_bind<SkeletonModification2DFABRIK,NodePath>(_func_NodePath *param_1)
...
/* MethodBind* create_method_bind<SkeletonModification2DFABRIK, int>(void
   (SkeletonModification2DFABRIK::*)(int)) */

MethodBind * create_method_bind<SkeletonModification2DFABRIK,int>(_func_void_int *param_1)
...
MethodBind * create_method_bind<SkeletonModification2DFABRIK,int>(_func_int *param_1)
...
/* MethodBind* create_method_bind<SkeletonModification2DFABRIK, int, NodePath const&>(void
   (SkeletonModification2DFABRIK::*)(int, NodePath const&)) */

MethodBind *
create_method_bind<SkeletonModification2DFABRIK,int,NodePath_const&>
...
/* MethodBind* create_method_bind<SkeletonModification2DFABRIK, NodePath, int>(NodePath
   (SkeletonModification2DFABRIK::*)(int) const) */

MethodBind *
create_method_bind<SkeletonModification2DFABRIK,NodePath,int>(_func_NodePath_int *param_1)
...
/* MethodBind* create_method_bind<SkeletonModification2DFABRIK, int, int>(void
   (SkeletonModification2DFABRIK::*)(int, int)) */

MethodBind * create_method_bind<SkeletonModification2DFABRIK,int,int>(_func_void_int_int *param_1)
...
MethodBind * create_method_bind<SkeletonModification2DFABRIK,int,int>(_func_int_int *param_1)
...
/* MethodBind* create_method_bind<SkeletonModification2DFABRIK, int, Vector2>(void
   (SkeletonModification2DFABRIK::*)(int, Vector2)) */

MethodBind *
create_method_bind<SkeletonModification2DFABRIK,int,Vector2>(_func_void_int_Vector2 *param_1)
...
MethodBind *
create_method_bind<SkeletonModification2DFABRIK,Vector2,int>(_func_Vector2_int *param_1)
...
/* MethodBind* create_method_bind<SkeletonModification2DFABRIK, int, bool>(void
   (SkeletonModification2DFABRIK::*)(int, bool)) */

MethodBind * create_method_bind<SkeletonModification2DFABRIK,int,bool>(_func_void_int_bool *param_1)
...
MethodBind * create_method_bind<SkeletonModification2DFABRIK,bool,int>(_func_bool_int *param_1)
...
/* SkeletonModification2DFABRIK::_initialize_classv() */

void SkeletonModification2DFABRIK::_initialize_classv(void)
...
/* SkeletonModification2DFABRIK::_setv(StringName const&, Variant const&) */

void __thiscall
SkeletonModification2DFABRIK::_setv
          (SkeletonModification2DFABRIK *this,StringName *param_1,Variant *param_2)
...
/* CowData<SkeletonModification2DFABRIK::FABRIK_Joint_Data2D>::_realloc(long) */

undefined8 __thiscall
CowData<SkeletonModification2DFABRIK::FABRIK_Joint_Data2D>::_realloc
          (CowData<SkeletonModification2DFABRIK::FABRIK_Joint_Data2D> *this,long param_1)
...
/* WARNING: Removing unreachable block (ram,0x0010ad9d) */
/* WARNING: Removing unreachable block (ram,0x0010ada9) */

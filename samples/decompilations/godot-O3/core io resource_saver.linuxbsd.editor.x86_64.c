...
/* ResourceSaver::set_uid(String const&, long) */

ulong ResourceSaver::set_uid(String *param_1,long param_2)

{
  ...
  if (*(long *)param_1 == 0) {
LAB_00100500:
    _err_print_error("set_uid","core/io/resource_saver.cpp",0x9f,
                     "Condition \"path.is_empty()\" is true. Returning: ERR_INVALID_PARAMETER",
                     "Can\'t update UID to empty path. Provide non-empty path.",0,0);
    uVar3 = 0x1f;
joined_r0x0010053e:
    if (local_38 == 0) goto LAB_001004e0;
  }
  else {
    plVar1 = (long *)(*(long *)param_1 + -0x10);
    do {
...
LAB_00100483:
    if ((local_38 == 0) || (*(uint *)(local_38 + -8) < 2)) goto LAB_00100500;
    lVar4 = 0;
    uVar3 = 0xf;
    if (0 < saver_count) {
      do {
        uVar3 = (**(code **)(*(long *)(&saver)[lVar4] + 0x158))
                          ((long *)(&saver)[lVar4],&local_38,param_2);
...
/* ResourceSaver::set_save_callback(void (*)(Ref<Resource>, String const&)) */

void ResourceSaver::set_save_callback(_func_void_Ref_String_ptr *param_1)
...

{
  ...
  _err_print_error("get_recognized_extensions","core/io/resource_saver.cpp",0xb2,
                   "Condition \"p_resource.is_null()\" is true.",
                   "It\'s not a reference to a valid Resource object.",0);
  auVar2._8_8_ = 0;
...
/* ResourceSaver::add_resource_format_saver(Ref<ResourceFormatSaver>, bool) */

ulong ResourceSaver::add_resource_format_saver(long *param_1,char param_2)

{
  ...
  if (pOVar1 == (Object *)0x0) {
    _err_print_error("add_resource_format_saver","core/io/resource_saver.cpp",0xb9,
                     "Condition \"p_format_saver.is_null()\" is true.",
                     "It\'s not a reference to a valid ResourceFormatSaver object.",0);
    return 0;
  }
  uVar4 = (ulong)saver_count;
  if (0x3f < (int)saver_count) {
    uVar4 = _err_print_error("add_resource_format_saver","core/io/resource_saver.cpp",0xba,
                             "Condition \"saver_count >= MAX_SAVERS\" is true.",0,0);
    return uVar4;
  }
  if (param_2 == '\0') {
    ...
    if (*(code **)(*(long *)pOVar7 + 0x140) == ResourceFormatSaver::~ResourceFormatSaver) {
      ...
      *(undefined ***)pOVar7 = &PTR__initialize_classv_0010e450;
      if (((((bVar8) &&
           ...
           ((*(long *)(pOVar7 + 0x1c8) == 0 || (StringName::unref(), StringName::configured != '\0')
            ))) && (((*(long *)(pOVar7 + 0x1b0) == 0 ||
                     (StringName::unref(), StringName::configured != '\0')) &&
                    ((*(long *)(pOVar7 + 0x198) == 0 ||
                     (StringName::unref(), StringName::configured != '\0')))))) &&
...
LAB_00100690:
      ...
      *plVar6 = (long)pOVar1;
      ...
      if (((pOVar7 == (Object *)0x0) || (cVar2 = RefCounted::unreference(), cVar2 == '\0')) ||
         (cVar2 = predelete_handler(pOVar7), cVar2 == '\0')) goto LAB_00100690;
      if (*(code **)(*(long *)pOVar7 + 0x140) == ResourceFormatSaver::~ResourceFormatSaver) {
        bVar8 = StringName::configured != '\0';
        *(undefined ***)pOVar7 = &PTR__initialize_classv_0010e450;
        if ((((bVar8) &&
...
LAB_001007d0:
  ...
  if (((pOVar7 != (Object *)0x0) && (cVar2 = RefCounted::unreference(), cVar2 != '\0')) &&
    ...
    if (*(code **)(*(long *)pOVar7 + 0x140) == ResourceFormatSaver::~ResourceFormatSaver) {
      ...
      *(undefined ***)pOVar7 = &PTR__initialize_classv_0010e450;
      if ((((bVar8) &&
           ((*(long *)(pOVar7 + 0x1e0) == 0 || (StringName::unref(), StringName::configured != '\0')
            ))) && ((*(long *)(pOVar7 + 0x1c8) == 0 ||
                    (StringName::unref(), StringName::configured != '\0')))) &&
         (((*(long *)(pOVar7 + 0x1b0) == 0 || (StringName::unref(), StringName::configured != '\0'))
          && (((*(long *)(pOVar7 + 0x198) == 0 ||
               (StringName::unref(), StringName::configured != '\0')) &&
              (*(long *)(pOVar7 + 0x180) != 0)))))) {
        StringName::unref();
...
/* ResourceSaver::remove_resource_format_saver(Ref<ResourceFormatSaver>) */

ulong ResourceSaver::remove_resource_format_saver(long *param_1)

{
  ...
  if (*param_1 == 0) {
    _err_print_error("remove_resource_format_saver","core/io/resource_saver.cpp",200,
                     "Condition \"p_format_saver.is_null()\" is true.",
                     "It\'s not a reference to a valid ResourceFormatSaver object.",0);
    return 0;
  }
  ...
  uVar4 = _err_print_error("remove_resource_format_saver","core/io/resource_saver.cpp",0xd2,
                           "Condition \"i >= saver_count\" is true.",0,0);
  return uVar4;
LAB_00100b9f:
  pOVar1 = (Object *)plVar6[1];
  this = (Object *)*plVar6;
...
LAB_00100b90:
    ...
    if (cVar3 != '\0') {
      if (*(code **)(*(long *)this + 0x140) == ResourceFormatSaver::~ResourceFormatSaver) {
        ...
        *(undefined ***)this = &PTR__initialize_classv_0010e450;
        if ((((bVar8) &&
             ((*(long *)(this + 0x1e0) == 0 || (StringName::unref(), StringName::configured != '\0')
              ))) && ((*(long *)(this + 0x1c8) == 0 ||
                      (StringName::unref(), StringName::configured != '\0')))) &&
           ((((*(long *)(this + 0x1b0) == 0 || (StringName::unref(), StringName::configured != '\0')
              ) && ((*(long *)(this + 0x198) == 0 ||
                    (StringName::unref(), StringName::configured != '\0')))) &&
            (*(long *)(this + 0x180) != 0)))) {
          StringName::unref();
  ...
  if (iVar5 <= (int)uVar7) {
LAB_00100d00:
    if (((&saver)[iVar5] != 0) && (uVar4 = RefCounted::unreference(), (char)uVar4 != '\0')) {
...
/* ResourceSaver::_find_custom_resource_format_saver(String const&) */

ResourceSaver * __thiscall
...
/* ResourceSaver::get_resource_id_for_path(String const&, bool) */

undefined8 ResourceSaver::get_resource_id_for_path(String *param_1,bool param_2)
...
/* ResourceSaver::set_get_resource_id_for_path(long (*)(String const&, bool)) */

void ResourceSaver::set_get_resource_id_for_path(_func_long_String_ptr_bool *param_1)
...
/* ResourceSaver::save(Ref<Resource> const&, String const&, unsigned int) */

int ResourceSaver::save(Ref *param_1,String *param_2,uint param_3)
...
LAB_001014ea:
    ...
    _err_print_error(&_LC35,"core/io/resource_saver.cpp",0x65,
...
LAB_00101158:
    ...
    if (local_78 == local_58) {
      ...
      local_78 = local_58;
LAB_001011bb:
      if ((local_78 != (Object *)0x0) && (1 < *(uint *)(local_78 + -8))) goto LAB_00101268;
    }
    iVar6 = 0x1f;
    _err_print_error(&_LC35,"core/io/resource_saver.cpp",0x6a,
                     "Condition \"path.is_empty()\" is true. Returning: ERR_INVALID_PARAMETER",
...
LAB_00101145:
    if ((local_78 == (Object *)0x0) || (*(uint *)(local_78 + -8) < 2)) goto LAB_00101158;
LAB_00101268:
    iVar9 = 0;
    iVar6 = 0xf;
    puVar10 = &saver;
    ...
    if (0 < saver_count) {
      do {
        ...
        if ((cVar5 != '\0') &&
           (cVar5 = (**(code **)(*(long *)*puVar10 + 0x170))
                              ((long *)*puVar10,param_1,(String *)&local_78), cVar5 != '\0')) {
          Resource::get_path();
          ...
          iVar6 = (**(code **)(*(long *)*puVar10 + 0x150))
                            ((long *)*puVar10,param_1,(String *)&local_78,param_3);
          lVar8 = local_60;
          if (iVar6 == 0) {
            ...
            if ((save_callback != (code *)0x0) &&
               (cVar5 = String::begins_with((char *)&local_78), pcVar4 = save_callback,
               cVar5 != '\0')) {
              local_58 = (Object *)0x0;
              if ((*(Object **)param_1 != (Object *)0x0) &&
                 (local_58 = *(Object **)param_1, cVar5 = RefCounted::reference(), cVar5 == '\0')) {
                local_58 = (Object *)0x0;
              }
              (*pcVar4)(&local_58);
              if (((local_58 != (Object *)0x0) &&
...
/* ResourceSaver::add_custom_resource_format_saver(String const&) [clone .part.0] */

uint ResourceSaver::add_custom_resource_format_saver(String *param_1)

{
  ...
  if (local_70 == 0) {
LAB_00101742:
    if (local_88 != (Object *)0x0) goto LAB_00101750;
LAB_0010199f:
    _err_print_error("add_custom_resource_format_saver","core/io/resource_saver.cpp",0xeb,
...
LAB_00101750:
    ...
    if (cVar4 != '\0') {
      if ((local_88 == (Object *)0x0) ||
         (pOVar6 = (Object *)__dynamic_cast(local_88,&Object::typeinfo,&Script::typeinfo,0),
         pOVar6 == (Object *)0x0)) {
                    /* WARNING: Does not return */
        pcVar3 = (code *)invalidInstructionException();
        (*pcVar3)();
...
LAB_00101b06:
        ...
        _err_print_error("add_custom_resource_format_saver","core/io/resource_saver.cpp",0xf1,
                         "Condition \"!valid_type\" is true. Returning: false",
...
LAB_00101915:
        ...
        if (lVar7 != 0) {
          pRVar8 = (ResourceFormatSaver *)
                   __dynamic_cast(lVar7,&Object::typeinfo,&ResourceFormatSaver::typeinfo,0);
        ...
        _err_print_error("add_custom_resource_format_saver","core/io/resource_saver.cpp",0xf4,
    ...
    _err_print_error("add_custom_resource_format_saver","core/io/resource_saver.cpp",0xec,
...
/* ResourceSaver::add_custom_resource_format_saver(String const&) */

undefined8 ResourceSaver::add_custom_resource_format_saver(String *param_1)
...
LAB_00101e99:
        *(undefined ***)local_28 = &PTR__initialize_classv_0010e2f0;
...
void ResourceSaver::add_custom_savers(void)
...
/* CowData<Ref<ResourceFormatSaver> >::_copy_on_write() [clone .isra.0] */

void __thiscall
CowData<Ref<ResourceFormatSaver>>::_copy_on_write(CowData<Ref<ResourceFormatSaver>> *this)
...
/* ResourceFormatSaver::recognize_path(Ref<Resource> const&, String const&) const */

ulong __thiscall
ResourceFormatSaver::recognize_path(ResourceFormatSaver *this,Ref *param_1,String *param_2)
...
LAB_00102930:
    if ((*(long *)(this + 8) != 0) && (this[0x1e8] == (ResourceFormatSaver)0x0)) {
      ...
      *(int *)local_d8[0][1] = *(int *)local_d8[0][1] + 1;
      ...
      List<PropertyInfo,DefaultAllocator>::push_back
                ((List<PropertyInfo,DefaultAllocator> *)local_d8,(PropertyInfo *)this_00);
      lVar9 = local_128;
      if (local_128 != 0) {
        LOCK();
        plVar10 = (long *)(local_128 + -0x10);
...
LAB_001032c9:
          ...
          if (((pcVar11 == (code *)0x0) || (*(long *)(lVar9 + 0xe0) == 0)) &&
             (pcVar11 = *(code **)(lVar9 + 0xc0), pcVar11 == (code *)0x0)) goto LAB_0010318f;
...
LAB_0010318f:
    ...
    if (*(long *)(this + 0x1f0) != 0) {
      if ((pOVar12 == (Object *)0x0) ||
         (local_148 = pOVar12, cVar4 = RefCounted::reference(), cVar4 == '\0')) {
...
LAB_00102af0:
      ...
      if (*(code **)(*(long *)(this + 8) + 0xe0) == (code *)0x0) {
        ...
        (**(code **)(*(long *)(this + 8) + 0xe0))
                  (*(undefined8 *)(this + 0x10),this + 0x1e0,*(code **)(this + 0x1f0),&local_78,
                   &local_150);
      }
      ...
      if (((local_148 != (Object *)0x0) &&
          (cVar4 = RefCounted::unreference(), pOVar1 = local_148, cVar4 != '\0')) &&
         (cVar4 = predelete_handler(local_148), cVar4 != '\0')) {
        (**(code **)(*(long *)pOVar1 + 0x140))(pOVar1);
    ...
    (**(code **)(*(long *)this_00 + 0x60))
              ((Variant *)local_98,this_00,this + 0x1e0,&local_a8,2,&local_118);
    if (local_118 != 0) {
    ...
    bVar14 = Variant::operator_cast_to_bool((Variant *)local_98);
    uVar13 = CONCAT71(extraout_var,bVar14) & 0xffffffff;
    if (Variant::needs_deinit[local_98[0]] != '\0') {
      Variant::_clear_internal();
    }
    if (Variant::needs_deinit[local_60[0]] != '\0') {
...
LAB_00102954:
    ...
    if (bVar14) goto LAB_0010297f;
  }
  String::get_extension();
  local_118 = 0;
  uStack_114 = 0;
  (**(code **)(*(long *)this + 0x168))(this,param_1,(List<String,DefaultAllocator> *)&local_118);
  if ((undefined8 *)CONCAT44(uStack_114,local_118) != (undefined8 *)0x0) {
    for (pSVar2 = *(String **)CONCAT44(uStack_114,local_118); pSVar2 != (String *)0x0;
        pSVar2 = *(String **)(pSVar2 + 8)) {
...
void ResourceFormatSaver::_bind_methods(void)
...
void __thiscall
ResourceFormatSaver::get_recognized_extensions(ResourceFormatSaver *this,Ref *param_1,List *param_2)

{
  ...
  if (plVar11 == (long *)0x0) {
LAB_00106a3b:
    if ((*(long *)(this + 8) != 0) && (this[0x1d0] == (ResourceFormatSaver)0x0)) {
      local_f8 = 0;
      ...
      *(undefined8 *)(this + 0x1d8) = 0;
      ...
      if (((pcVar6 == (code *)0x0) || (*(long *)(lVar10 + 0xe0) == 0)) &&
         (pcVar6 = *(code **)(lVar10 + 0xd0), pcVar6 == (code *)0x0)) {
        local_148 = 0;
...
LAB_001072a1:
          ...
          if (((pcVar6 == (code *)0x0) || (*(long *)(lVar10 + 0xe0) == 0)) &&
             (pcVar6 = *(code **)(lVar10 + 0xc0), pcVar6 == (code *)0x0)) goto LAB_00107196;
...
LAB_00106d76:
      ...
      (**(code **)(*(long *)(this + 8) + 0xe0))
                (*(undefined8 *)(this + 0x10),this + 0x1c8,pcVar6,local_58,local_128);
      lVar10 = CONCAT44(uStack_11c,uStack_120);
...
LAB_00106b24:
    ...
    if (((local_140[0] != (Object *)0x0) &&
        (cVar4 = RefCounted::unreference(), pOVar3 = local_140[0], cVar4 != '\0')) &&
       (cVar4 = predelete_handler(local_140[0]), cVar4 != '\0')) {
  ...
  lVar10 = local_130;
  if ((local_130 != 0) && (lVar13 = 0, 0 < *(long *)(local_130 + -8))) {
    do {
      if (*(long *)param_2 == 0) {
...
/* ResourceFormatSaver::recognize(Ref<Resource> const&) const */

ulong __thiscall ResourceFormatSaver::recognize(ResourceFormatSaver *this,Ref *param_1)
...
LAB_00107b0a:
        ...
        if (((pcVar7 == (code *)0x0) || (*(long *)(lVar10 + 0xe0) == 0)) &&
           (pcVar7 = *(code **)(lVar10 + 0xc0), pcVar7 == (code *)0x0)) goto LAB_00107a0b;
...
LAB_00107a0b:
  ...
  if (pcVar7 != (code *)0x0) {
    ...
    if (*(code **)(*(long *)(this + 8) + 0xe0) == (code *)0x0) {
      ...
      (**(code **)(*(long *)(this + 8) + 0xe0))
                (*(undefined8 *)(this + 0x10),this + 0x1b0,pcVar7,local_58,&local_128);
    }
...
/* ResourceFormatSaver::save(Ref<Resource> const&, String const&, unsigned int) */

ulong __thiscall
ResourceFormatSaver::save(ResourceFormatSaver *this,Ref *param_1,String *param_2,uint param_3)
...
LAB_00108559:
        ...
        if (((pcVar10 == (code *)0x0) || (*(long *)(lVar8 + 0xe0) == 0)) &&
           (pcVar10 = *(code **)(lVar8 + 0xc0), pcVar10 == (code *)0x0)) goto LAB_00108462;
...
LAB_00108462:
  ...
  if (*(long *)(this + 400) != 0) {
    if ((pOVar11 == (Object *)0x0) ||
       (local_178 = pOVar11, cVar4 = RefCounted::reference(), cVar4 == '\0')) {
      local_178 = (Object *)0x0;
    }
    local_170 = 0;
...
LAB_00107e98:
    ...
    if (*(code **)(*(long *)(this + 8) + 0xe0) == (code *)0x0) {
      ...
      (**(code **)(*(long *)(this + 8) + 0xe0))
                (*(undefined8 *)(this + 0x10),this + 0x180,*(code **)(this + 400),&local_88,
                 &local_138);
    }
    lVar8 = local_170;
    ...
    if (((local_178 != (Object *)0x0) &&
        (cVar4 = RefCounted::unreference(), pOVar3 = local_178, cVar4 != '\0')) &&
       (cVar4 = predelete_handler(local_178), cVar4 != '\0')) {
      (**(code **)(*(long *)pOVar3 + 0x140))(pOVar3);
      Memory::free_static(pOVar3,false);
    }
  }
...
/* ResourceFormatSaver::set_uid(String const&, long) */

ulong __thiscall
ResourceFormatSaver::set_uid(ResourceFormatSaver *this,String *param_1,long param_2)
...
LAB_001086c4:
  ...
  if ((*(long *)(this + 8) != 0) && (this[0x1a0] == (ResourceFormatSaver)0x0)) {
    ...
    *(undefined8 *)(this + 0x1a8) = 0;
    ...
    if (((pcVar4 == (code *)0x0) || (*(long *)(lVar7 + 0xe0) == 0)) &&
       (pcVar4 = *(code **)(lVar7 + 0xd0), pcVar4 == (code *)0x0)) {
      local_158 = 0;
      String::parse_latin1((String *)&local_158,"ResourceFormatSaver");
...
LAB_00108f8d:
        ...
        if (((pcVar4 == (code *)0x0) || (*(long *)(lVar7 + 0xe0) == 0)) &&
           (pcVar4 = *(code **)(lVar7 + 0xc0), pcVar4 == (code *)0x0)) goto LAB_00108e85;
...
LAB_0010885a:
    ...
    if (*(code **)(*(long *)(this + 8) + 0xe0) == (code *)0x0) {
      ...
      (**(code **)(*(long *)(this + 8) + 0xe0))
                (*(undefined8 *)(this + 0x10),this + 0x198,pcVar4,&local_78,local_118);
    }
    lVar7 = local_150;
...
void ResourceSaver::remove_custom_savers(void)
  ...
  if (0 < saver_count) {
    ...
    do {
      ...
      if (*(long *)(pOVar4 + 0x98) != 0) {
        ...
        iVar3 = CowData<Ref<ResourceFormatSaver>>::resize<false>
                          ((CowData<Ref<ResourceFormatSaver>> *)local_50,lVar5);
        if (iVar3 == 0) {
          if (local_50[0] == 0) {
            lVar7 = -1;
            lVar5 = 0;
LAB_00109672:
          ...
          CowData<Ref<ResourceFormatSaver>>::_copy_on_write
                    ((CowData<Ref<ResourceFormatSaver>> *)local_50);
          lVar5 = local_50[0];
          ...
          *puVar1 = pOVar4;
          if (pOVar4 == (Object *)0x0) {
            if (((this == (Object *)0x0) || (cVar2 = RefCounted::unreference(), cVar2 == '\0')) ||
               (cVar2 = predelete_handler(this), cVar2 == '\0')) goto LAB_00109213;
LAB_00109539:
            if (*(code **)(*(long *)this + 0x140) == ResourceFormatSaver::~ResourceFormatSaver) {
              bVar8 = StringName::configured != '\0';
              *(undefined ***)this = &PTR__initialize_classv_0010e450;
          ...
          if (cVar2 == '\0') {
            *puVar1 = 0;
            ...
            cVar2 = RefCounted::unreference();
joined_r0x0010964a:
            if ((cVar2 != '\0') && (cVar2 = predelete_handler(this), cVar2 != '\0'))
            goto LAB_00109539;
          }
          cVar2 = RefCounted::unreference();
          lVar5 = local_50[0];
...
joined_r0x001093f8:
        ...
        local_50[0] = lVar5;
        if ((cVar2 != '\0') &&
           (cVar2 = predelete_handler(pOVar4), lVar5 = local_50[0], cVar2 != '\0')) {
...
LAB_00109213:
    ...
    if ((lVar5 != 0) && (0 < *(long *)(lVar5 + -8))) {
      lVar6 = 0;
      do {
        while ((pOVar4 = *(Object **)(lVar5 + lVar6 * 8), pOVar4 == (Object *)0x0 ||
               (local_60[0] = pOVar4, cVar2 = RefCounted::reference(), cVar2 == '\0'))) {
...
LAB_001093a0:
  CowData<Ref<ResourceFormatSaver>>::_unref((CowData<Ref<ResourceFormatSaver>> *)local_50);
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
  }
...
{
  return (uint)CONCAT71(0x10e5,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x10e5,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
...
void __thiscall ResourceFormatSaver::~ResourceFormatSaver(ResourceFormatSaver *this)
...
/* ResourceSaver::add_custom_resource_format_saver(String const&) [clone .part.0] [clone .cold] */

void ResourceSaver::add_custom_resource_format_saver(String *param_1)
...
/* CowData<Ref<ResourceFormatSaver> >::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<Ref<ResourceFormatSaver>>::_copy_on_write(void)
...
/* ResourceFormatSaver::_bind_methods() [clone .cold] */
...
/* WARNING: Removing unreachable block (ram,0x0010c6c8) */
/* WARNING: Removing unreachable block (ram,0x0010c890) */
/* WARNING: Removing unreachable block (ram,0x0010c6d4) */
/* WARNING: Removing unreachable block (ram,0x0010c6de) */
/* WARNING: Removing unreachable block (ram,0x0010c870) */
/* WARNING: Removing unreachable block (ram,0x0010c6ea) */
/* WARNING: Removing unreachable block (ram,0x0010c6f4) */
/* WARNING: Removing unreachable block (ram,0x0010c850) */
/* WARNING: Removing unreachable block (ram,0x0010c700) */
/* WARNING: Removing unreachable block (ram,0x0010c70a) */
/* WARNING: Removing unreachable block (ram,0x0010c830) */
/* WARNING: Removing unreachable block (ram,0x0010c716) */
/* WARNING: Removing unreachable block (ram,0x0010c720) */
/* WARNING: Removing unreachable block (ram,0x0010c810) */
/* WARNING: Removing unreachable block (ram,0x0010c72c) */
/* WARNING: Removing unreachable block (ram,0x0010c736) */
/* WARNING: Removing unreachable block (ram,0x0010c7f0) */
/* WARNING: Removing unreachable block (ram,0x0010c742) */
/* WARNING: Removing unreachable block (ram,0x0010c74c) */
/* WARNING: Removing unreachable block (ram,0x0010c7d0) */
/* WARNING: Removing unreachable block (ram,0x0010c754) */
/* WARNING: Removing unreachable block (ram,0x0010c76a) */
/* WARNING: Removing unreachable block (ram,0x0010c776) */
...
/* WARNING: Removing unreachable block (ram,0x0010cb08) */
/* WARNING: Removing unreachable block (ram,0x0010ccd0) */
/* WARNING: Removing unreachable block (ram,0x0010cb14) */
/* WARNING: Removing unreachable block (ram,0x0010cb1e) */
/* WARNING: Removing unreachable block (ram,0x0010ccb0) */
/* WARNING: Removing unreachable block (ram,0x0010cb2a) */
/* WARNING: Removing unreachable block (ram,0x0010cb34) */
/* WARNING: Removing unreachable block (ram,0x0010cc90) */
/* WARNING: Removing unreachable block (ram,0x0010cb40) */
/* WARNING: Removing unreachable block (ram,0x0010cb4a) */
/* WARNING: Removing unreachable block (ram,0x0010cc70) */
/* WARNING: Removing unreachable block (ram,0x0010cb56) */
/* WARNING: Removing unreachable block (ram,0x0010cb60) */
/* WARNING: Removing unreachable block (ram,0x0010cc50) */
/* WARNING: Removing unreachable block (ram,0x0010cb6c) */
/* WARNING: Removing unreachable block (ram,0x0010cb76) */
/* WARNING: Removing unreachable block (ram,0x0010cc30) */
/* WARNING: Removing unreachable block (ram,0x0010cb82) */
/* WARNING: Removing unreachable block (ram,0x0010cb8c) */
/* WARNING: Removing unreachable block (ram,0x0010cc10) */
/* WARNING: Removing unreachable block (ram,0x0010cb94) */
/* WARNING: Removing unreachable block (ram,0x0010cbaa) */
/* WARNING: Removing unreachable block (ram,0x0010cbb6) */
...
/* void memdelete<ResourceFormatSaver>(ResourceFormatSaver*) */

void memdelete<ResourceFormatSaver>(ResourceFormatSaver *param_1)
...
LAB_0010ce18:
  *(undefined ***)param_1 = &PTR__initialize_classv_0010e2f0;
...
/* CowData<Ref<ResourceFormatSaver> >::_unref() */

void __thiscall CowData<Ref<ResourceFormatSaver>>::_unref(CowData<Ref<ResourceFormatSaver>> *this)
...

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialize_class()::initialized != '\0') goto LAB_0010dc59;
...
/* CowData<Ref<ResourceFormatSaver> >::_realloc(long) */

undefined8 __thiscall
CowData<Ref<ResourceFormatSaver>>::_realloc(CowData<Ref<ResourceFormatSaver>> *this,long param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Error CowData<Ref<ResourceFormatSaver> >::resize<false>(long) */

undefined8 __thiscall
CowData<Ref<ResourceFormatSaver>>::resize<false>
          (CowData<Ref<ResourceFormatSaver>> *this,long param_1)
...
void ResourceSaver::_GLOBAL__sub_I_saver(void)

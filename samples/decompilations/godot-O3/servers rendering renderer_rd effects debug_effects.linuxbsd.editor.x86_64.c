...
LAB_001029d4:
      _err_print_error("draw_motion_vectors",
                       "servers/rendering/renderer_rd/effects/debug_effects.cpp",uVar12,pcVar17,0,0)
      ;
      return;
    }
    goto LAB_00102b0d;
...
LAB_00102809:
        _err_print_index_error
                  ("set","./core/templates/cowdata.h",0xcf,lVar18,lVar19,"p_index","size()","",false
                   ,false);
      }
      else {
...
LAB_001027c7:
        ...
        CowData<RID>::_copy_on_write((CowData<RID> *)&local_2e0);
        *(undefined8 *)(local_2e0 + lVar18 * 8) =
             *(undefined8 *)((Projection *)local_88 + lVar18 * 8);
        lVar11 = local_2e0;
      }
      if (lVar18 != 0) break;
      lVar18 = 1;
...
LAB_001020a0:
  ...
  local_88[1] = 0;
  local_2e0 = 0;
  pvVar13 = (void *)RenderingDevice::draw_list_begin
                              (_LC65,uVar12,param_4,0,&local_2e8,0,(Projection *)local_88,0);
  lVar11 = local_2e0;
  if (local_2e0 != 0) {
    LOCK();
    plVar1 = (long *)(local_2e0 + -0x10);
  ...
  if (*(long *)(this + 0x5e8) == 0) {
    ...
    if (*(uint *)(this + 0x6d8) != 0) {
      ...
      do {
        if ((((*plVar15 == -1) && (lVar11 == plVar15[1])) &&
            (this[0x5f6] == *(DebugEffects *)((long)plVar15 + 0x14))) &&
           ((uVar10 == *(uint *)(plVar15 + 2) && ((int)plVar15[3] == 0)))) {
          lVar11 = plVar15[4];
    ...
    lVar11 = PipelineCacheRD::_generate_version
                       ((long)pDVar2,-1,SUB81(lVar11,0),(uint)(byte)this[0x5f6],uVar10);
    this[0x5a8] = (DebugEffects)0x0;
  }
LAB_00102281:
  RenderingDevice::draw_list_bind_render_pipeline(uVar12,pvVar13,lVar11);
...
LAB_00102a68:
    _err_print_index_error
              ("version_get_shader","./servers/rendering/renderer_rd/shader_rd.h",0xa6,0,lVar11,
               "p_variant","variant_defines.size()","",false,false);
LAB_0010252d:
    uVar12 = 0;
  }
...
LAB_001028ed:
      _err_print_index_error
                ("get","./core/templates/cowdata.h",0xdb,uVar16,lVar11,"p_index","size()","",false,
                 true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_001028a3:
    ...
    lVar18 = ((uVar16 & 0xffffffff) % (ulong)*(uint *)(this + 0x4f8)) * 0xa0 +
             *(long *)(*(long *)(this + 0x4e8) +
                      ((uVar16 & 0xffffffff) / (ulong)*(uint *)(this + 0x4f8)) * 8);
  ...
  if (local_358[0] == 0) {
    uVar12 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform,RenderingDevice::Uniform>
                       (pUVar8,uVar12,0,&local_318,&local_2e8);
...
LAB_00106531:
  ...
  if ((*(long *)(param_4 + 8) != 0) &&
     (uVar7 = (uint)*(undefined8 *)(*(long *)(param_4 + 8) + -8), uVar7 != 0)) goto LAB_0010651d;
LAB_001063c0:
  lVar19 = local_48;
  lVar13 = local_58;

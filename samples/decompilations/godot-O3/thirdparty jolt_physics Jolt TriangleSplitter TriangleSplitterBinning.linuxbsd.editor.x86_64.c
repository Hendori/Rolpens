...
/* JPH::TriangleSplitterBinning::Split(JPH::TriangleSplitter::Range const&,
   JPH::TriangleSplitter::Range&, JPH::TriangleSplitter::Range&) */

undefined8 JPH::TriangleSplitterBinning::Split(Range *param_1,Range *param_2,Range *param_3)

{
  ...
  if (uVar26 < uVar4) {
    ...
    do {
      ...
      auVar51 = maxps(auVar51,auVar45);
             ...
             (uint *)(*(long *)(param_1 + 0x40) + 4 +
                     ((ulong)((uVar4 - 1) - uVar26) + (ulong)uVar26) * 4));
  }
  else {
    local_88._4_4_ = _LC2;
    local_88._0_4_ = _LC2;
  ...
  if (uVar26 < uVar4) {
    ...
    do {
      ...
      lVar23 = 0;
      auVar44._0_8_ =
           CONCAT44(*(undefined4 *)(lVar8 + 4 + uVar22 * 0xc),*(undefined4 *)(lVar8 + uVar22 * 0xc))
      ;
      auVar44._8_4_ = uVar2;
  ...
  fVar48 = _LC2;
  do {
    if ((fVar3 < local_68[uVar25 - 4]) &&
       (pauVar18 = (undefined1 (*) [16])((ulong)uVar26 * 0x80 + lVar5), uVar9 != 0)) {
      ...
      do {
        ...
        fVar32 = (fVar33 + fVar33) * (float)*(uint *)(pauVar20[5] + 4) +
                 (fVar32 + fVar32) * (float)*(uint *)pauVar20[5];
        if (fVar32 < fVar48) {
...
JPH::TriangleSplitterBinning::TriangleSplitterBinning
          (TriangleSplitterBinning *this,Array *param_1,Array *param_2,uint param_3,uint param_4,
          uint param_5)
...
/* JPH::TriangleSplitterBinning::GetStats(JPH::TriangleSplitter::Stats&) const */

void __thiscall JPH::TriangleSplitterBinning::GetStats(TriangleSplitterBinning *this,Stats *param_1)
...
void __thiscall
JPH::TriangleSplitterBinning::~TriangleSplitterBinning(TriangleSplitterBinning *this)
...
void JPH::TriangleSplitterBinning::_GLOBAL__sub_I_TriangleSplitterBinning(void)

...
{
  *(undefined ***)this = &PTR__initialize_classv_0010fcc8;
  clear(this);
  CowData<NavigationMeshSourceGeometryData2D::ProjectedObstruction>::_unref
            ((CowData<NavigationMeshSourceGeometryData2D::ProjectedObstruction> *)(this + 0x2b8));
  CowData<Vector<Vector2>>::_unref((CowData<Vector<Vector2>> *)(this + 0x290));
...
LAB_00109622:
      ...
      while( true ) {
        ...
        uVar10 = uVar10 + 1;
        if (*(ulong *)(lVar7 + -8) <= uVar10) goto LAB_00109622;
      }
      LOCK();
...
LAB_001097e6:
    ...
    lVar7 = puVar8[-1];
    if (param_1 <= lVar7) goto LAB_001096e9;
  }
  else {
    if (lVar7 != 0) {
      uVar4 = _realloc(this,lVar11);
  ...
  if (((int)puVar12 - (int)puVar5 & 0x10U) != 0) {
    puVar5[1] = 0;
    puVar6 = puVar5 + 2;
    if (puVar5 + 2 == puVar12) goto LAB_001096e9;
  }
  do {
    puVar6[1] = 0;
    puVar5 = puVar6 + 4;
...
LAB_001098b6:
        ...
        lVar5 = *(long *)(lVar2 + -8);
        if (lVar5 <= lVar6) goto LAB_001098b6;
...
LAB_00109b61:
      ...
      while (puVar6[uVar8 * 3 + 1] == 0) {
        uVar8 = uVar8 + 1;
        if ((ulong)puVar6[-1] <= uVar8) goto LAB_00109b61;
      }
      LOCK();
...
LAB_00109cf6:
    ...
    lVar10 = puVar6[-1];
    if (param_1 <= lVar10) goto LAB_00109c05;
  }
  else {
    if (lVar10 != 0) {
      uVar3 = _realloc(this,lVar9);
...
LAB_00109dd8:
        ...
        lVar6 = *(long *)(lVar2 + -8);
        if (lVar6 <= lVar4) goto LAB_00109dd8;
...
/* WARNING: Removing unreachable block (ram,0x0010a058) */
/* WARNING: Removing unreachable block (ram,0x0010a1ed) */
/* WARNING: Removing unreachable block (ram,0x0010a1f9) */
...

{
  ...
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010b229. Too many branches */
...

{
  ...
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010b445. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010b677. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
...

{
  ...
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Load size is inaccurate */
                    /* WARNING: Could not recover jumptable at 0x0010b8a4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
...

{
  ...
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010bacd. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
              ((long *)((long)param_2 + *(long *)(param_1 + 0x60)),
...

{
  ...
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010bce5. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)((long *)((long)param_2 + *(long *)(param_1 + 0x60)),*param_3);
    return;
  }
...

{
  ...
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010cbf2. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010cde2. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)((long *)((long)param_2 + *(long *)(param_1 + 0x60)));
    return;
  }
...
LAB_0010e638:
      ...
      if (uVar11 == 0) {
        lVar9 = (long)(iVar12 + -2);
        if (lVar2 <= lVar9) goto LAB_0010e6a8;
        puVar10 = (undefined4 *)(lVar1 + lVar9 * 0x18);
      }
      else {
        puVar10 = (undefined4 *)*plVar8;
        if (uVar11 == 2) goto LAB_0010e68d;
      }
...

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  iVar7 = *param_2;
  if (iVar7 != param_1) goto LAB_0010e985;
  local_78 = 0;
  local_68 = &_LC4;
  local_80 = 0;
  auVar2._8_8_ = 0;
...
LAB_0010ea78:
    ...
    local_40 = 6;
    if (local_50 != 0x11) goto LAB_0010ea78;
...

{
  ...
  *(undefined1 (*) [16])(pPVar7 + 8) = (undefined1  [16])0x0;
  ...
  if (in_EDX != local_74) goto LAB_0010ece2;
  local_68 = 0;
  local_58 = &_LC4;
  local_70 = 0;
  auVar2._8_8_ = 0;
...
LAB_0010edd5:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_38,(CowData *)&local_70);
    local_30 = 6;
    if (local_40 != 0x11) goto LAB_0010edd5;
    StringName::StringName((StringName *)&local_60,(String *)&local_38,false);
    if (local_50._8_8_ == local_60) {
      if ((StringName::configured != '\0') && (local_60 != 0)) {
        StringName::unref();
...

{
  ...
  if (*(code **)(*(long *)param_1 + 0x140) ==
      NavigationMeshSourceGeometryData2D::~NavigationMeshSourceGeometryData2D) {
    *(undefined ***)param_1 = &PTR__initialize_classv_0010fcc8;
...

{
  ...
  if (((param_2 != (Variant **)0x0) && (param_2[1] != (Variant *)0x0)) &&
    ...
    if (local_58 == (NavigationMeshSourceGeometryData2D *)*(long *)pVVar6) {
      ...
      MethodBind::get_name();
      local_58 = (NavigationMeshSourceGeometryData2D *)0x10a248;
      local_60 = 0;
      local_50 = 0x35;
      String::parse_latin1((StrRange *)&local_60);
      vformat<StringName>((StringName *)&local_58,(StrRange *)&local_60,&local_68);
...
LAB_0010f086:
      ...
      if (pNVar3 != pNVar5) {
        ...
        if (pNVar3 != (NavigationMeshSourceGeometryData2D *)0x0) goto LAB_0010f086;
      }
    }
  }
...

{
  ...
  if (((param_2 != (void **)0x0) && (param_2[1] != (void *)0x0)) &&
    ...
    if (local_48 == (NavigationMeshSourceGeometryData2D *)*plVar5) {
      ...
      MethodBind::get_name();
      local_48 = (NavigationMeshSourceGeometryData2D *)0x10a248;
      local_50 = 0;
      local_40 = 0x35;
      String::parse_latin1((StrRange *)&local_50);
      vformat<StringName>((StringName *)&local_48,(StrRange *)&local_50,&local_58);
...
LAB_0010f85d:
      ...
      if (pNVar5 != pNVar8) {
        ...
        if (pNVar5 != (NavigationMeshSourceGeometryData2D *)0x0) goto LAB_0010f85d;
      }
    }
  }

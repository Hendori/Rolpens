...
/* JPH::EstimateCollisionResponse(JPH::Body const&, JPH::Body const&, JPH::ContactManifold const&,
   JPH::CollisionEstimationResult&, float, float, float, unsigned int) */

void JPH::EstimateCollisionResponse
               (Body *param_1,Body *param_2,ContactManifold *param_3,
               CollisionEstimationResult *param_4,float param_5,float param_6,float param_7,
               uint param_8)
...
LAB_0010058e:
  ...
  if (uVar3 == 0) {
LAB_00100ccf:
    if ((int)param_8 < 1) goto LAB_00100edd;
  }
  else {
    ...
    do {
      ...
      *pfVar6 = fVar29;
      ...
      pfVar6[6] = fVar15;
      pfVar6[7] = fVar15;
      pfVar6[8] = fVar31 * (float)local_3cc8._0_4_ + fVar29 * (float)local_3cd8._0_4_ +
                  fVar26 * (float)local_3ca8._0_4_;
      pfVar6[9] = fVar31 * (float)local_3cc8._4_4_ + fVar29 * (float)local_3cd8._4_4_ +
                  fVar26 * (float)local_3ca8._4_4_;
      pfVar6[10] = fVar31 * (float)uStack_3cc0 + fVar29 * (float)uStack_3cd0 +
                   fVar26 * (float)uStack_3ca0;
      pfVar6[0xb] = fVar31 * uStack_3cc0._4_4_ + fVar29 * uStack_3cd0._4_4_ +
                    fVar26 * uStack_3ca0._4_4_;
      ...
      pfVar6[0x10] = _LC0 / (pfVar6[10] * pfVar6[2] + fVar31 * pfVar6[9] + fVar29 * pfVar6[8] + 0.0
                             + fVar33 + fVar44 +
                            fVar24 * pfVar6[0xd] + fVar23 * pfVar6[0xc] + 0.0 +
                            pfVar6[0xe] * pfVar6[6]);
      if ((0.0 < param_6) &&
         (fVar15 = ((((*(float *)(param_4 + 0x30) * fVar36 - *(float *)(param_4 + 0x34) * fVar32) +
                     *(float *)(param_4 + 0x28)) - *(float *)(param_4 + 8)) -
                   (*(float *)(param_4 + 0x10) * fVar39 - *(float *)(param_4 + 0x14) * fVar38)) *
                   *(float *)(param_3 + 0x18) +
                   ((((*(float *)(param_4 + 0x38) * fVar32 - *(float *)(param_4 + 0x30) * fVar37) +
                     *(float *)(param_4 + 0x24)) - *(float *)(param_4 + 4)) -
                   (*(float *)(param_4 + 0x18) * fVar38 - *(float *)(param_4 + 0x10) * fVar41)) *
                   *(float *)(param_3 + 0x14) +
                   *(float *)(param_3 + 0x10) *
                   ((((*(float *)(param_4 + 0x34) * fVar37 - *(float *)(param_4 + 0x38) * fVar36) +
                     *(float *)(param_4 + 0x20)) - *(float *)param_4) -
                   (*(float *)(param_4 + 0x14) * fVar41 - *(float *)(param_4 + 0x18) * fVar39)) +
                   0.0, fVar15 < (float)((uint)param_7 ^ uVar14))) {
      ...
      if (0.0 < param_5) {
        ...
        pfVar6[0x1a] = fVar26;
        pfVar6[0x1b] = fVar26;
        pfVar6[0x1c] = fVar30 * (float)local_3cc8._0_4_ + fVar31 * (float)local_3cd8._0_4_ +
                       fVar29 * (float)local_3ca8._0_4_;
        pfVar6[0x1d] = fVar30 * (float)local_3cc8._4_4_ + fVar31 * (float)local_3cd8._4_4_ +
                       fVar29 * (float)local_3ca8._4_4_;
        pfVar6[0x1e] = fVar30 * (float)uStack_3cc0 + fVar31 * (float)uStack_3cd0 +
                       fVar29 * (float)uStack_3ca0;
        pfVar6[0x1f] = fVar30 * uStack_3cc0._4_4_ + fVar31 * uStack_3cd0._4_4_ +
                       fVar29 * uStack_3ca0._4_4_;
        pfVar6[0x20] = fVar15 * (float)local_3cb8._0_4_ + fVar23 * local_3c48[0] +
                       fVar26 * local_3c28;
        pfVar6[0x21] = fVar15 * (float)local_3cb8._4_4_ + fVar23 * local_3c48[1] +
                       fVar26 * fStack_3c24;
        ...
        pfVar6[0x24] = _LC0 / (pfVar6[0x1e] * pfVar6[0x16] +
                               fVar30 * pfVar6[0x1d] + fVar31 * pfVar6[0x1c] + 0.0 + fVar33 + fVar44
                              + fVar15 * pfVar6[0x21] + fVar23 * pfVar6[0x20] + 0.0 +
                                pfVar6[0x22] * pfVar6[0x1a]);
        ...
        pfVar6[0x2a] = fVar32;
        pfVar6[0x2b] = fVar32;
        pfVar6[0x30] = fVar15 * (float)local_3cc8._0_4_ + fVar23 * (float)local_3cd8._0_4_ +
                       fVar32 * (float)local_3ca8._0_4_;
        pfVar6[0x31] = fVar15 * (float)local_3cc8._4_4_ + fVar23 * (float)local_3cd8._4_4_ +
                       fVar32 * (float)local_3ca8._4_4_;
        pfVar6[0x32] = fVar15 * (float)uStack_3cc0 + fVar23 * (float)uStack_3cd0 +
                       fVar32 * (float)uStack_3ca0;
        pfVar6[0x33] = fVar15 * uStack_3cc0._4_4_ + fVar23 * uStack_3cd0._4_4_ +
                       fVar32 * uStack_3ca0._4_4_;
        pfVar6[0x34] = fVar26 * local_3c28 +
                       fVar31 * (float)local_3cb8._0_4_ + fVar29 * local_3c48[0];
        pfVar6[0x35] = fVar26 * fStack_3c24 +
                       fVar31 * (float)local_3cb8._4_4_ + fVar29 * local_3c48[1];
        ...
        pfVar6[0x39] = 0.0;
        pfVar6[0x38] = _LC0 / (pfVar6[0x32] * pfVar6[0x2a] +
                               fVar15 * pfVar6[0x31] + fVar23 * pfVar6[0x30] + 0.0 + fVar33 + fVar44
                              + fVar31 * pfVar6[0x35] + fVar29 * pfVar6[0x34] + 0.0 +
                                pfVar6[0x36] * pfVar6[0x2e]);
      }
  ...
  do {
    ...
    if ((uVar14 == 0) || (param_5 <= 0.0)) {
      ...
      do {
        ...
        fVar26 = (((*(float *)(param_4 + 0x48) * fVar24 +
                    *(float *)(param_4 + 0x44) * fVar23 + *(float *)(param_4 + 0x40) * fVar15 + 0.0
                   + pfVar7[2] * *(float *)(param_4 + 0x18) +
                     pfVar7[1] * fVar29 + *pfVar7 * fVar19 + 0.0) -
                  (fVar11 * pfVar7[5] + pfVar7[4] * fVar20 + 0.0 +
                  pfVar7[6] * *(float *)(param_4 + 0x38))) - pfVar7[0x11]) * pfVar7[0x10] +
                 *(float *)(pCVar10 + 4);
        fVar31 = param_5 * *(float *)pCVar10;
        fVar19 = (((fVar24 * *(float *)(param_4 + 0x58) +
                    fVar23 * *(float *)(param_4 + 0x54) + fVar15 * *(float *)(param_4 + 0x50) + 0.0
                   + pfVar7[0x16] * *(float *)(param_4 + 0x18) +
                     fVar29 * pfVar7[0x15] + pfVar7[0x14] * fVar19 + 0.0) -
                  (pfVar7[0x1a] * *(float *)(param_4 + 0x38) +
                  fVar11 * pfVar7[0x19] + pfVar7[0x18] * fVar20 + 0.0)) - pfVar7[0x25]) *
                 pfVar7[0x24] + *(float *)(pCVar10 + 8);
        ...
        fVar48 = (fVar48 - fVar39 * *(float *)(param_4 + 0x40)) -
                 fVar38 * *(float *)(param_4 + 0x50);
        fVar49 = (fVar49 - fVar39 * *(float *)(param_4 + 0x44)) -
                 fVar38 * *(float *)(param_4 + 0x54);
        fVar50 = (fVar50 - fVar39 * *(float *)(param_4 + 0x48)) -
                 fVar38 * *(float *)(param_4 + 0x58);
        fVar51 = (fVar51 - fVar39 * *(float *)(param_4 + 0x4c)) -
                 fVar38 * *(float *)(param_4 + 0x5c);
        ...
        *(float *)(param_4 + 0x20) =
             fVar18 * *(float *)(param_4 + 0x40) + *(float *)(param_4 + 0x20) +
             fVar35 * *(float *)(param_4 + 0x50);
        *(float *)(param_4 + 0x24) =
             fVar18 * *(float *)(param_4 + 0x44) + *(float *)(param_4 + 0x24) +
             fVar35 * *(float *)(param_4 + 0x54);
        *(float *)(param_4 + 0x28) =
             fVar18 * *(float *)(param_4 + 0x48) + *(float *)(param_4 + 0x28) +
             fVar35 * *(float *)(param_4 + 0x58);
        *(float *)(param_4 + 0x2c) =
             fVar18 * *(float *)(param_4 + 0x4c) + *(float *)(param_4 + 0x2c) +
             fVar35 * *(float *)(param_4 + 0x5c);
...
LAB_00100dd3:
      do {
        ...
        fVar25 = ((((*(float *)(param_4 + 8) - *(float *)(param_4 + 0x28)) * fVar43 +
                    (*(float *)(param_4 + 4) - *(float *)(param_4 + 0x24)) * fVar42 +
                    (*(float *)param_4 - *(float *)(param_4 + 0x20)) * fVar40 + 0.0 +
                   pfVar6[2] * *(float *)(param_4 + 0x18) +
                   (float)((ulong)*(undefined8 *)(param_4 + 0x10) >> 0x20) * pfVar6[1] +
                   (float)*(undefined8 *)(param_4 + 0x10) * *pfVar6 + 0.0) -
                  (pfVar6[6] * *(float *)(param_4 + 0x38) +
                  (float)((ulong)*(undefined8 *)(param_4 + 0x30) >> 0x20) * pfVar6[5] +
                  (float)*(undefined8 *)(param_4 + 0x30) * pfVar6[4] + 0.0)) - pfVar6[0x11]) *
                 pfVar6[0x10] + *(float *)pCVar13;
        if (0.0 <= fVar25) {
          if (_LC5 < fVar25) {
            fVar25 = _LC5;
          }
...
void JPH::_GLOBAL__sub_I_EstimateCollisionResponse(void)

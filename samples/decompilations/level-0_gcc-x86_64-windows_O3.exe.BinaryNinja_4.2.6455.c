...
int64_t printf.constprop.0(int64_t arg1, int64_t arg2)
{
    ...
    arg_20 = r9;
    int64_t* var_10 = &argv;
    return __mingw_vfprintf(__imp___acrt_iob_func(), "Some calculation returned %d.\n", &argv);
}
...
uint64_t some_calculation(int64_t arg1) __pure
{
    ...
    int32_t rcx_3 = rax_1 * rax_1 + rdx + rax_1;
    int32_t rax_5 = rcx_3 * rcx_3 + rdx + rcx_3;
    int32_t rcx_7 = rax_5 * rax_5 + rdx + rax_5;
    int32_t rax_9 = rcx_7 * rcx_7 + rdx + rcx_7;
    int32_t rcx_11 = rax_9 * rax_9 + rdx + rax_9;
    return rcx_11 * rcx_11 + rdx + rcx_11;
}
...
int __pformat_wputchars(short unsigned int const* s, int count, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream)
{
    ...
    if (width > count_2)
    {
        ...
        {
            if (count_2 > 0)
                goto label_1400028b0;
            
            stream->width = rax_6 - 1;
            goto label_140002950;
        }
...
int __pformat_putchars(char const* s, int count, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream)
{
    ...
    if (width > count_3)
    {
        ...
        if (!(*flags[1] & 4))
        {
            ...
            goto label_1400029f3;
        }
        
        if (!count_3)
        {
            stream->width = rax_2 - 1;
            goto label_140002a71;
        }
    }
    else
    {
...
int64_t __pformat_xint(int fmt, union value, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream, union value)
{
    ...
    if (fmt != 0x6f)
    {
        ...
        if (!(rdi & 0x1000))
        {
            ...
            goto label_140002c61;
        }
        
        rcx = 4;
        
        if (stream_1[4])
            goto label_140002e02;
    ...
    if (rdi & 0x1000)
    {
        ...
        if (stream)
            goto label_140002c9f;
        
        goto label_140002e56;
    }
    ...
    if (stream)
    {
        ...
        if (r15 <= 0)
            goto label_140002f8c;
        
        goto label_140002cbc;
    }
    ...
    if (r15 <= 0)
    {
        ...
        if (rsi != r13 || !r15)
            goto label_140002cea;
        
        goto label_140002e84;
    }
    ...
    if (rsi != r13)
    {
        ...
        if (i < r12)
            goto label_140002ea0;
        
        goto label_140002cf6;
    }
    ...
    if (fmt == 0x6f)
    {
        if (r15 < 0 && (rdi_1 & 0x600) == 0x200)
        {
            ...
            if (fmt == 0x6f || !(rdi_1 & 0x800))
                goto label_140002edd;
            
            goto label_140002ed2;
        }
    ...
    else
    {
        if (rdi_1 & 0x800)
        {
            ...
            *rsi = fmt;
            ...
            if (rdi_1 & 0x400)
                goto label_140002fe5;
            
            goto label_140002ef5;
        }
...
int64_t __pformat_int(union value, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream, union value)
{
    ...
    if (stream < 0)
    {
        ...
        if (_Size_2 > 0)
        {
            ...
            if (_Size_1 <= 0)
                goto label_140003230;
            
            goto label_14000321a;
        }
        
        if (&var_68 - rax_3 + 0x20 == rdi_1)
            goto label_1400033b9;
    }
    else
    {
        r12 &= 0x7f;
        ...
        if (rsi_1 > 0)
        {
            if (!(r12 & 0x1c0))
            {
                if (_Size_2 < 0 && (r12 & 0x600) == 0x200)
                    goto label_1400033fa;
                
                goto label_140003262;
            }
...
int __pformat_emit_float(int sign, char* value, int len, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream)
{
    ...
    if (len > 0)
    {
        ...
        if (*stream->flags[1] & 0x10 && stream->thousands_chr)
        {
            ...
            goto label_140003650;
        }
        
        label_14000369a:
        
        if (!sign)
            goto label_1400036a2;
        ...
        else
        {
            ...
            if (!sign)
            {
                ...
                if (flags & 0x1c0)
                {
                    ...
                    if (rax == 1 || *flags[1] & 6)
                        goto label_1400036a5;
                    
                    goto label_14000367b;
                }
...
int64_t __pformat_emit_xfloat(union value, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream, union value)
{
    ...
    if (precision_1 <= 0xe)
    {
        ...
        if (stream_4 || stream_2)
            goto label_140003fc7;
        
        goto label_140003ddd;
    }
    ...
    if (cond:0 || stream_2)
    {
        ...
        do
        {
            ...
            {
                if (rax_17)
                    goto label_140004037;
                
                if (!precision_4)
                    goto label_140003fff;
        ...
        if (i_1 == &var_58)
        {
            if (stream_1->precision <= 0)
                goto label_140003de7;
            
            goto label_140004076;
        }
    }
    else
    {
                ...
                if (rax_4 - 0x20 > 0x5a)
                {
                    ...
                    switch (rax_4)
                    {
                        ...
                        case 0x30:
                        {
                            ...
                            {
                                if (r14_1 > 3)
                                    goto label_140004b15;
                                
                                rcx = 0x30;
                                label_140004aba:
                                
                                if (r14_1 != 2)
                                    goto label_14000433c;
                        ...
                        case 0x41:
                        {
                            ...
                            if (rax_15 & 4)
                                goto label_14000452d;
                            
                            goto label_1400048b2;
                        }
                        case 0x43:
                        {
                            stream.quota = 0xffffffff;
                        ...
                        case 0x45:
                        {
                            ...
                            if (stream.thousands_chr & 4)
                                goto label_140004633;
                            
                            goto label_14000499a;
                        }
                        case 0x46:
                        {
                            rdx_11 = *argv_1;
                            ...
                            if (stream.thousands_chr & 4)
                                goto label_1400046c9;
                            
                            goto label_1400049d2;
                        }
                        case 0x47:
                        {
                            rdx_13 = *argv_1;
                            ...
                            if (stream.thousands_chr & 4)
                                goto label_140004701;
                            
                            goto label_140004a0a;
                        }
                        case 0x49:
                        {
                            rax_4 = *(rsi_1 + 1);
        ...
        if (!rdi_2)
        {
            ...
            if (rax_7 - 1 <= 1)
            {
                ...
                if (mode_1 > 9)
                {
                    ...
                    if (be_1 < 0)
                    {
                        ...
                        if (k_7 <= 0)
                        {
                            ...
                            if (rdx_24 && fpi->emin + 1 < be)
                                goto label_1400063cb;
                            
                            goto label_14000578b;
                        }
                        ...
                        if (!var_7c_1)
                        {
                            ...
                            if (i_1 <= 0 && rbp_3)
                                goto label_140005817;
                            
                            k_12 = k_11 + 1;
                            
                            if (!var_90_1)
                                goto label_140005e64;
                            
                            goto label_140005ad7;
                        }
                        
                        if (__cmp_D2A(r13_1, b_9) >= 0)
                            goto label_140005802;
                        ...
                        if (var_90_1)
                        {
                            ...
                            while (true)
                            {
                                ...
                                rdx_42 = 0x39;
                                *result_3 = 0x39;
                                goto label_140005f07;
                            }
                        }
                        else
                        {
                            if (rbp_5)
                                goto label_140006507;
                        ...
                        {
                            if (var_88_2 == 2)
                                goto label_14000613d;
                            
                            if (*(r13_1 + 0x14) > 1 || r13_1[3])
                                goto label_140005ee3;
                        }
                    ...
                    if (k_11 > fpi->int_max)
                    {
                        ...
                        if (be_1 - r12_1 >= emin || !((mode_1 - 3) & 0xfffffffd))
                            goto label_140005f20;
                        
                        goto label_140005648;
                    }
                ...
                else
                {
                    ...
                    if (i_7 + 1 <= 0)
                    {
                        ...
                        if (!var_7c_1 || !(0x3ff0000000000000 > zmm0_3))
                        {
                            ...
                            if (!var_90_1)
                            {
                                ...
                                if (zmm1 > zmm2)
                                    goto label_140005536;
                                
                                zmm0_3 = zmm0_3 - zmm4_2;
                                
                                if (zmm0_3 <= zmm1)
                                    goto label_140005a39;
                    ...
                    {
                        if (var_90_1)
                            goto label_140005615;
                        
                        k_5 = k;
                        e_11 = e_13;
                        r12_2 = nullptr;
                        goto label_1400056b6;
                    }
...
struct __Bigint* __i2b_D2A(int i)
{
    ...
    if (!pmem_next_1)
    {
        ...
        if (((pmem_next_1 - &private_mem) >> 3) + 5 <= 0x120)
        {
            ...
            if (cond:1_1)
                goto label_140006b2d;
            
            goto label_140006b9f;
        }
        
        pmem_next_1 = malloc(0x28);
        
        if (pmem_next_1)
            goto label_140006b86;
    }
    else
    {
        bool cond:0_1 = dtoa_CS_init == 2;
...
int64_t main()
{
    __main();
    it_crowd();
    printf.constprop.0("Some calculation returned %d.\n", 0x937c862f);
    return 0;
}

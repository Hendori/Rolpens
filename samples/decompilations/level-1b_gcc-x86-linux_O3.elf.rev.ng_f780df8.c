...
_ABI(SystemV_x86)
void function_0x4010b8_Code_x86(void) {
}
...
void all_badges(void) {
  ...
  artificial_struct_returned_by_rawfunction_31 _var_2;
  unreserved___x86_get_pc_thunk_bx();
  _stack.offset_4 = (*((generic16_t *) NULL) - *((generic8_t *) NULL) + ((*((generic16_t *) NULL) - (*((generic16_t *) NULL) & 0xFF)) << 1)) << 1;
  _var_2 = printf_();
  _var_1 = _var_2.register_eax;
  _var_0 = _var_2.register_edx;
}
